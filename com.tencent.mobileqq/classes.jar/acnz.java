...
public class acnz
{
  private static volatile acnz jdField_a_of_type_Acnz;
  public static final String a;
  public static final String b = jdField_a_of_type_JavaLangString + "eggs.xml";
  private ArrayList<acob> jdField_a_of_type_JavaUtilArrayList;
  ...
  {
    if (jdField_a_of_type_Acnz == null) {}
    try
    {
      if (jdField_a_of_type_Acnz == null) {
        jdField_a_of_type_Acnz = new acnz();
      }
      return jdField_a_of_type_Acnz;
    }
    finally {}
  }
  
  private ArrayList<acob> a(XmlPullParser paramXmlPullParser)
  {
    ...
    if (i != 1) {
      if (i == 2)
      {
        ...
        if (str1.equalsIgnoreCase("Item"))
        {
          ...
          localObject2 = new acob();
          ((acob)localObject2).jdField_a_of_type_Int = Integer.valueOf((String)localObject3).intValue();
    ...
    for (;;)
    {
      ...
      localObject2 = new acod();
      if (str1 != null) {
        ((acod)localObject2).jdField_b_of_type_Int = acod.a(str1);
      }
      ((acod)localObject2).jdField_a_of_type_JavaLangString = str2;
      if (localObject4 != null)
      {
      ...
      localObject4.jdField_a_of_type_Acoc = new acoc();
      ...
      localObject4.jdField_a_of_type_Acoc.jdField_a_of_type_Int = Integer.parseInt((String)localObject2);
      localObject4.jdField_a_of_type_Acoc.jdField_b_of_type_Int = Integer.parseInt((String)localObject3);
      localObject4.jdField_a_of_type_Acoc.c = Integer.parseInt(str1);
      localObject4.jdField_a_of_type_Acoc.e = Integer.parseInt(str3);
      localObject4.jdField_a_of_type_Acoc.d = Integer.parseInt(str2);
      localObject2 = localObject4;
      localObject3 = localObject1;
      break;
      localObject2 = localObject4;
  ...
  private boolean a(String paramString)
  {
    ...
    //   163: aload_0
    //   164: aload_2
    //   165: invokespecial 277	acnz:a	(Lorg/xmlpull/v1/XmlPullParser;)Ljava/util/ArrayList;
    //   168: astore_2
    //   169: aload_1
    //   170: ifnull +7 -> 177
    //   173: aload_1
    ...
    //   181: aload_0
    //   182: aload_2
    //   183: putfield 281	acnz:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   186: iconst_1
    //   187: ireturn
    //   188: astore_2
    //   189: aload_3
  ...
  private void b(Context paramContext)
  {
    ...
    paramContext = paramContext.getResources().getXml(2131820545);
