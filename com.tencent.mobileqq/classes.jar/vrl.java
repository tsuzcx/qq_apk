...
public class vrl
{
  ...
  private static volatile vrl jdField_a_of_type_Vrl;
  ...
  private vrl()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new vrm(this, localHandlerThread.getLooper());
  }
  
  public static vrl a()
  {
    if (jdField_a_of_type_Vrl == null) {}
    try
    {
      if (jdField_a_of_type_Vrl == null) {
        jdField_a_of_type_Vrl = new vrl();
      }
      return jdField_a_of_type_Vrl;
    }
    finally {}
  }
  ...
  private void c(List<QQCircleReport.SingleDcData> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      VSNetworkHelper.a().a(paramList, new vrn(this, paramList));
    }
  }
  ...
  private void d(List<APP_REPORT_TRANSFER.SingleDcData> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      VSNetworkHelper.a().a(paramList, new vro(this, paramList));
    }
  }
