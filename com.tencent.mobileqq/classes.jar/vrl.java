  ...
  implements Runnable
{
  ...
  public vrl(String paramString, MqqHandler paramMqqHandler, int paramInt)
  {
    this(paramString, paramMqqHandler, paramInt, 2, 0);
  }
  
  public vrl(String paramString, MqqHandler paramMqqHandler, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  private Bitmap a(String paramString, Resources paramResources)
  {
    ...
    //   157: aload_2
    //   158: aload_0
    //   159: getfield 25	vrl:jdField_a_of_type_Int	I
    //   162: iconst_0
    //   163: iconst_1
