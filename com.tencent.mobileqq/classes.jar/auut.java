...
{
  private auuu jdField_a_of_type_Auuu;
  private auuv jdField_a_of_type_Auuv;
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Auuv != null))
    {
      Context localContext = a();
      if (localContext != null) {
        localContext.getContentResolver().unregisterContentObserver(this.jdField_a_of_type_Auuv);
      }
    }
  ...
  private void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          if (this.jdField_a_of_type_Auuu == null) {
            this.jdField_a_of_type_Auuu = new auuu(this);
          }
          if (this.jdField_a_of_type_Auuv == null) {
            this.jdField_a_of_type_Auuv = new auuv(this.jdField_a_of_type_Auuu, (Context)localObject, paramString, str);
          }
          this.jdField_a_of_type_Boolean = true;
          ((Context)localObject).getContentResolver().registerContentObserver(Uri.parse("content://sms/"), true, this.jdField_a_of_type_Auuv);
          this.jdField_a_of_type_Auuu.removeMessages(2);
          this.jdField_a_of_type_Auuu.sendEmptyMessageDelayed(2, i * 1000);
          return;
        }
      }
      ...
      if (this.jdField_a_of_type_Auuv != null) {
        this.jdField_a_of_type_Auuv.a(paramString, str);
      }
    }
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Auuv != null)
    {
      ...
      this.jdField_a_of_type_Auuv = null;
    }
    if (this.jdField_a_of_type_Auuu != null)
    {
      this.jdField_a_of_type_Auuu.a();
      this.jdField_a_of_type_Auuu = null;
    }
    super.onDestroy();
  }
}
