...
public class auut
{
  ...
  private static void a(auun paramauun)
  {
    boolean bool = a(paramauun.jdField_a_of_type_JavaLangCharSequence);
    if (((paramauun.jdField_b_of_type_Boolean) && (paramauun.jdField_a_of_type_JavaLangCharSequence.length() <= 5)) || (!bool))
    {
      paramauun.jdField_c_of_type_Int = 0;
      return;
    }
    paramauun.jdField_c_of_type_Int = 4;
  }
  
  public static void a(List<auun> paramList, PersonalityLabel paramPersonalityLabel, float paramFloat)
  {
    ...
    Collections.sort(localArrayList, new auuu());
    ...
    auun localauun = new auun();
    localauun.jdField_a_of_type_JavaLangCharSequence = str;
    boolean bool = a(str);
    label398:
    int i4;
    label420:
    ...
    {
      localauun.jdField_b_of_type_Int = ((PersonalityLabelInfo)localObject2).bgColor;
      localauun.jdField_e_of_type_Int = 2;
      localauun.jdField_a_of_type_Int = ((PersonalityLabelInfo)localObject2).fgColor;
      if (localauun.jdField_e_of_type_Int != 2) {
        break label886;
      }
      i4 = 1;
      ...
      {
        localauun.jdField_b_of_type_Boolean = true;
        localauun.jdField_e_of_type_Boolean = true;
        i2 = n + 1;
      }
      i1 = i2;
      n = i;
      if (!localauun.jdField_e_of_type_Boolean)
      {
        if ((i5 > 1) && (i < 2) && (i != i5 - 1) && (str.length() <= 6)) {
          break label892;
        }
        localauun.jdField_b_of_type_Boolean = true;
        if (localauun.jdField_b_of_type_Boolean) {
          break label905;
        }
        n = i + 1;
        i1 = i2;
    ...
    for (;;)
    {
      ...
      for (j = m + 1;; j = m)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            localauun.jdField_a_of_type_Float = (m * paramFloat);
            localauun.jdField_a_of_type_AndroidTextTextPaint.setTextSize(localauun.jdField_a_of_type_Float);
            if (QLog.isColorLevel()) {
              QLog.i("TagUtil", 2, "getTags " + localauun.jdField_a_of_type_JavaLangCharSequence + " sizeLevel:" + i + " size:" + localauun.jdField_a_of_type_Float / paramFloat);
            }
            paramList.add(localauun);
            m = j;
            j = i2;
            i = n;
            break label265;
            ...
            localauun.d = true;
            localauun.jdField_a_of_type_AndroidTextTextPaint.setFakeBoldText(true);
            break label398;
            label886:
            i4 = 0;
            break label420;
            label892:
            localauun.jdField_b_of_type_Boolean = ((Random)localObject1).nextBoolean();
            break label544;
            label905:
            i1 = i2 + 1;
            n = i;
            ...
            if (n == 0)
            {
              paramPersonalityLabel = (auun)paramList.get(0);
            ...
            if ((i == 0) && (i5 > 1))
            {
              ...
              if (j < paramList.size())
              {
                paramPersonalityLabel = (auun)paramList.get(j);
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                j += 1;
                break label1033;
                localObject2 = new auun();
                ((auun)localObject2).jdField_a_of_type_JavaLangCharSequence = ((CharSequence)localObject1);
                ((auun)localObject2).jdField_c_of_type_Boolean = true;
                ((auun)localObject2).jdField_b_of_type_Boolean = false;
                ((auun)localObject2).jdField_a_of_type_Float = paramPersonalityLabel.jdField_a_of_type_Float;
                ((auun)localObject2).jdField_a_of_type_AndroidTextTextPaint.setTextSize(paramPersonalityLabel.jdField_a_of_type_Float);
