...
public class ascu
{
  ...
  private static LruCache<String, ascv> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bfcj.a(ascj.jdField_a_of_type_JavaLangString + "combo" + File.separator);
    ...
    jdField_b_of_type_JavaLangString = ascj.jdField_a_of_type_JavaLangString;
  ...
  public static ascv a()
  {
    return a(jdField_a_of_type_JavaLangString + "dui.png", 2);
  }
  
  public static ascv a(int paramInt)
  {
    return a(jdField_a_of_type_JavaLangString + jdField_a_of_type_ArrayOfJavaLangString[paramInt], 2);
  }
  
  public static ascv a(String paramString, int paramInt)
  {
    int i = 0;
    Object localObject1 = (ascv)jdField_a_of_type_AndroidUtilLruCache.get(paramString);
    ...
    for (;;)
    {
      ...
      localascv.jdField_a_of_type_Int = i;
      localascv.b = paramInt;
      localascv.jdField_a_of_type_AndroidGraphicsDrawableDrawable = ((Drawable)localObject2);
      jdField_a_of_type_AndroidUtilLruCache.put(paramString, localascv);
      return localascv;
      i = agej.a(k / jdField_a_of_type_Float, localascv);
      paramInt = agej.a(j / jdField_a_of_type_Float, localascv);
      continue;
      paramInt = agej.a(32.0F, localascv);
      i = (int)(paramInt / j * k);
      continue;
      paramInt = agej.a(24.0F, localascv);
      i = (int)(paramInt / j * k);
    }
  }
