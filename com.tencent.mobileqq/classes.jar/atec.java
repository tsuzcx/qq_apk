  ...
  extends WebViewPlugin
{
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Atee != null))
    {
      Context localContext = a();
      if (localContext != null) {
        localContext.getContentResolver().unregisterContentObserver(this.jdField_a_of_type_Atee);
      }
    }
  ...
  private void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          if (this.jdField_a_of_type_Ated == null) {
            this.jdField_a_of_type_Ated = new ated(this);
          }
          if (this.jdField_a_of_type_Atee == null) {
            this.jdField_a_of_type_Atee = new atee(this.jdField_a_of_type_Ated, (Context)localObject, paramString, str);
          }
          this.jdField_a_of_type_Boolean = true;
          ((Context)localObject).getContentResolver().registerContentObserver(Uri.parse("content://sms/"), true, this.jdField_a_of_type_Atee);
          this.jdField_a_of_type_Ated.removeMessages(2);
          this.jdField_a_of_type_Ated.sendEmptyMessageDelayed(2, i * 1000);
          return;
        }
      }
      ...
      if (this.jdField_a_of_type_Atee != null) {
        this.jdField_a_of_type_Atee.a(paramString, str);
      }
    }
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Atee != null)
    {
      ...
      this.jdField_a_of_type_Atee = null;
    }
    if (this.jdField_a_of_type_Ated != null)
    {
      this.jdField_a_of_type_Ated.a();
      this.jdField_a_of_type_Ated = null;
    }
    super.onDestroy();
  }
}
