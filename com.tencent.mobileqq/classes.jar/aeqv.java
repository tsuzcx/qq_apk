  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public aeqv(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity)
  {
  ...
  protected Integer a(Void... arg1)
  {
    ...
    {
      localObject1 = aweg.a(0, this.jdField_b_of_type_Int);
      awfo localawfo = aweg.a(this.jdField_a_of_type_AndroidContentIntent, (awey)localObject1);
      if (localawfo == null) {
        return Integer.valueOf(5);
      }
      localawfo.d = true;
      localawfo.a = false;
      if ((localawfo.r != null) && (localawfo.r.length() == 39)) {
        localawfo.r = localawfo.r.substring(0, 28);
      }
      ((awey)localObject1).a(localawfo);
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo = ((MessageForShortVideo)new awdq(???.app).a(localawfo));
      ...
      ((aeqd)((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getManager(138)).a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo);
