...
public class aigr
{
  public static int a(String paramString1, String paramString2, PublishVideoEntry paramPublishVideoEntry)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          j = bhqf.a(new String[] { "-threads", "1", "-ss", "0.0", "-accurate_seek", "-i", paramString1, "-t", String.valueOf(d), "-vf", "null", "-metadata:s", "rotate=0", "-acodec", "aac", "-vcodec", "libx264", "-movflags", "faststart", "-preset", "veryfast", "-tune", "psnr", "-profile:v", "high", "-level", "3.0", "-b:v", String.valueOf(j), "-y", paramString2 });
          return j;
        }
  ...
  public static aigs a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
      try
      {
        Object localObject = new File(paramString);
        aigs localaigs = new aigs();
        if ((((File)localObject).exists()) && (((File)localObject).isDirectory()))
        {
          ...
          localaigs.a = str;
          localaigs.b = ((String)localObject);
          localaigs.c = paramString;
          return localaigs;
        }
      }
