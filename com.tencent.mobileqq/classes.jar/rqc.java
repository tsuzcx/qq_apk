...
{
  public int a;
  private ajpe jdField_a_of_type_Ajpe = new rqe(this);
  public View a;
  ...
  private rpp jdField_a_of_type_Rpp = new rqd(this);
  rpq jdField_a_of_type_Rpq;
  rpv jdField_a_of_type_Rpv;
  public boolean a;
  int b = 0;
  int c = 0;
  private int d;
  
  public rqc(Activity paramActivity, QQAppInterface paramQQAppInterface, rpq paramrpq)
  {
    ...
    this.d = ((int)paramActivity.getResources().getDimension(2131166726));
    i();
  ...
  private void i()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Rpp);
  ...
  private void j()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Rpp);
    }
  }
  ...
  private void k()
  {
    ...
    localAnimation.setAnimationListener(new rqj(this));
    a(0);
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidViewViewStub == null) {
      if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null))
      {
        this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131309889));
        if (this.jdField_a_of_type_AndroidViewViewStub != null)
        {
          this.jdField_a_of_type_AndroidViewViewStub.setOnInflateListener(new rqf(this));
  ...
  void a(int paramInt)
  {
    ...
    {
      return;
      localView = ((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131303596);
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      ((rpo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(64)).a(paramString);
    }
  }
  
  void a(List<rpu> paramList)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference == null) || (this.jdField_a_of_type_JavaLangRefWeakReference.get() == null)) {
      return;
    }
    if (this.jdField_a_of_type_Rpv == null) {
      this.jdField_a_of_type_Rpv = new rpv((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Rpq);
    }
    this.jdField_a_of_type_Rpv.a();
    this.jdField_a_of_type_Rpv.a(paramList);
  }
  ...
  public boolean a()
  {
    ...
    View localView = localActivity.findViewById(2131300060);
    ...
    int k = (int)localActivity.getResources().getDimension(2131167766);
    int m = (int)localActivity.getResources().getDimension(2131167772);
    int n = this.d;
  ...
  public void b()
  {
    ...
    if (bool)
    {
      ...
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new rqg(this));
      Object localObject2 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131310871);
      ...
      localObject2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131311534);
      if (!bool) {
        break label270;
      }
      i = ((Resources)localObject1).getColor(2131100375);
      label126:
      ((TextView)localObject2).setTextColor(i);
      if (this.jdField_a_of_type_ComTencentWidgetHorizontalListView == null)
      {
        this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131309884));
        this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setDividerWidth((int)((Resources)localObject1).getDimension(2131166727));
        this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setAdapter(this.jdField_a_of_type_Rpv);
      ...
      {
        this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131298701));
    ...
    label270:
    label281:
    for (int i = 2130842546;; i = 2130842548)
    {
      ((ImageButton)localObject1).setImageResource(i);
      this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new rqh(this));
      return;
      i = 2131100376;
      break;
      i = 2131100635;
      break label93;
      i = ((Resources)localObject1).getColor(2131100374);
      break label126;
    }
  }
  ...
  public void c()
  {
    ...
    int i = azvv.a((Context)localObject, 100.0F);
    Object localObject = (ImageView)((Activity)localObject).findViewById(2131306405);
  ...
  void e()
  {
    ...
    localAnimation.setFillAfter(true);
    localAnimation.setAnimationListener(new rqi(this));
  ...
  {
    if (this.jdField_a_of_type_Rpv != null) {
      this.jdField_a_of_type_Rpv.notifyDataSetChanged();
    }
