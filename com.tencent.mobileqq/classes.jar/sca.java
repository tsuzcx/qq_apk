...
public class sca
{
  private static int a(boolean paramBoolean1, int paramInt1, boolean paramBoolean2, int paramInt2, List<BaseData> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean1)
      {
        ...
        if (((ProteusItemData)localObject).v != paramInt2)
        {
          i = k;
          if (paramInt2 != 0) {
            break label149;
  ...
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, List<BaseData> paramList, List<oidb_cmd0xc6d.ModuleInfo> paramList1, ItemShowDispatcher paramItemShowDispatcher, SparseArray<Float> paramSparseArray)
  {
    ...
    for (;;)
    {
      ...
      while (paramList1.hasNext())
      {
        ...
        try
        {
          ProteusItemData localProteusItemData = scl.a(new JSONObject(paramSparseArray.bytes_json.get().toStringUtf8()), paramArticleInfo, paramFastWebArticleInfo);
          localProteusItemData.w = -99;
          localProteusItemData.b = paramSparseArray.bytes_weight.get();
          sdi.a(paramList, localProteusItemData, paramItemShowDispatcher);
        }
  ...
  private static boolean a(List<BaseData> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (((localBaseData instanceof ProteusItemData)) && (((ProteusItemData)localBaseData).w == -99)) {
        return true;
      }
    }
    return false;
  ...
  public static void b(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, List<BaseData> paramList, List<oidb_cmd0xc6d.TextCardInfo> paramList1, ItemShowDispatcher paramItemShowDispatcher, SparseArray<Float> paramSparseArray)
  {
    ...
    for (;;)
    {
      ...
      while (paramList1.hasNext())
      {
        ...
        try
        {
          ProteusItemData localProteusItemData = scl.a(new JSONObject(paramItemShowDispatcher.bytes_card_json.get().toStringUtf8()), paramArticleInfo, paramFastWebArticleInfo);
          localProteusItemData.w = 1;
          localProteusItemData.v = -1;
          localProteusItemData.b = scl.a(paramSparseArray);
  ...
  private static boolean b(List<BaseData> paramList)
  {
    ...
    {
      BaseData localBaseData = (BaseData)paramList.next();
      if (((localBaseData instanceof ProteusItemData)) && (((ProteusItemData)localBaseData).v == -1)) {
        return true;
      }
    }
    return false;
