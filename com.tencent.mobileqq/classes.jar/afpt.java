  ...
  implements View.OnClickListener
{
  ...
  private List<aiqm> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  
  public afpt(Context paramContext, QQAppInterface paramQQAppInterface, ListView paramListView, int paramInt, boolean paramBoolean, PhoneContactFragment paramPhoneContactFragment)
  {
    ...
    do
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (!localPhoneContact.isHiden) {
          ((List)localObject1).add(aiqh.a(1, localPhoneContact, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
        }
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (a())
    {
      if (this.jdField_a_of_type_AndroidViewView == null)
      {
        ...
        this.jdField_a_of_type_AndroidViewView.findViewById(2131368567).setVisibility(8);
        this.jdField_a_of_type_AndroidViewView.findViewById(2131368648).setVisibility(8);
        paramView = (SingleLineTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367211);
        paramView.setText(ajya.a(2131708004));
        paramViewGroup = (ViewGroup.MarginLayoutParams)paramView.getLayoutParams();
        paramViewGroup.leftMargin /= 2;
        paramView.setLayoutParams(paramViewGroup);
        ((SimpleTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364630)).setText("0");
      }
      return this.jdField_a_of_type_AndroidViewView;
    }
    paramView = ((aiqm)this.jdField_a_of_type_JavaUtilList.get(paramInt)).a(0, paramInt, paramView, paramViewGroup, this);
    if (paramView != null)
    {
      paramViewGroup = (aiqp)paramView.getTag();
      ...
      if ((paramViewGroup instanceof aiqr)) {
        ((aiqr)paramViewGroup).a.setOnClickListener(this);
      }
    }
    return paramView;
  }
  ...
  {
    int i = 17;
    if ((paramView != null) && (paramView.getId() == 2131375183) && ((paramView.getTag() instanceof PhoneContact)))
    {
    ...
    for (;;)
    {
      ...
      paramView = AddFriendLogicActivity.a(this.jdField_a_of_type_AndroidContentContext, 2, paramView.unifiedCode, null, 3006, i, paramView.name, null, null, ajya.a(2131707999), null);
      this.jdField_a_of_type_AndroidContentContext.startActivity(paramView);
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "contact", "", "addbook", "add_friend", 0, 0, "", "", "", "");
      do
      {
        do
        {
          return;
        } while ((paramView == null) || (!(paramView.getTag() instanceof aiqp)));
      ...
      for (;;)
      {
        ...
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80053DF", "0X80053DF", 0, 0, "1", "", "", "");
        return;
