...
public class apqg
  extends ajuc
{
  public apqg(TroopRobotFragment paramTroopRobotFragment) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong, azkq paramazkq)
  {
    String str = String.valueOf(paramLong);
    if ((str != null) && (str.equals(TroopRobotFragment.a(this.a))))
    {
      if ((paramBoolean) && (paramazkq != null) && (this.a.getActivity() != null))
      {
        QLog.d("TroopRobotFragment", 2, "onGetAllRobots");
        this.a.getActivity().runOnUiThread(new TroopRobotFragment.1.1(this, paramazkq));
        return;
      }
