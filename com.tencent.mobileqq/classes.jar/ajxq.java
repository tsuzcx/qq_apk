...
public class ajxq
{
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      Object localObject1 = bbdj.a(new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), bbnq.f.a));
      Object localObject2 = "";
      String str = "";
      j = 1;
      i = j;
  ...
  public static void a(boolean paramBoolean, Context paramContext, List<CustomEmotionData> paramList, AppInterface paramAppInterface, IPicDownloadListener paramIPicDownloadListener)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localbbwl = ((bbwi)paramAppInterface.getManager(47)).a(1);
      } while (localbbwl == null);
      ansr localansr = (ansr)paramAppInterface.getManager(149);
      antv localantv = (antv)paramAppInterface.getManager(141);
      ...
      for (;;)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          {
            if (localbbwl.a(localCustomEmotionData.url) != null)
            {
            ...
            boolean bool1 = false;
            File localFile;
            if ((localantv != null) && (localantv.a(localCustomEmotionData))) {
              if ((!TextUtils.isEmpty(localCustomEmotionData.emoPath)) && (localCustomEmotionData.emoPath.startsWith(ajsf.bh)))
              {
                ...
                if (paramBoolean) {
                  localansr.b(localCustomEmotionData);
                }
            ...
            for (;;)
            {
              ...
              {
                paramList = localantv.a(localCustomEmotionData.md5);
                break label234;
              }
              if (!TextUtils.isEmpty(localCustomEmotionData.resid))
              {
                paramList = paramList + akvu.a(localCustomEmotionData.resid);
                break label234;
              }
              ...
              break label234;
              bbwg localbbwg = new bbwg(localCustomEmotionData.url, localFile);
              localbbwg.p = false;
              localbbwg.f = "emotion_pic";
              localbbwg.b = 1;
              paramList = "";
              if (localCustomEmotionData.url.contains("qto_"))
              {
              ...
              localbbwl.a(localbbwg, new ajxr(paramList, localFile, localCustomEmotionData, bool1, paramBoolean, localansr, paramIPicDownloadListener, localArrayList1, localArrayList2, paramContext, localAtomicInteger2, localAtomicInteger1), null);
            }
            continue;
          }
          if (paramIPicDownloadListener != null) {
