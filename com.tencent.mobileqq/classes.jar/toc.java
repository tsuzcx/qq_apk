...
public class toc
{
  ...
  public toc(FragmentActivity paramFragmentActivity, FragmentManager paramFragmentManager, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup.setId(2131364880);
  ...
  private void a(VVideoView paramVVideoView, View paramView, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    rwv.a(this.jdField_a_of_type_AndroidViewView, 0, 300);
    rwv.a(this.jdField_a_of_type_AndroidViewViewGroup, 0, 300);
    if (paramView != null)
    {
      ...
      b(paramVVideoView, paramView);
      paramInt = rwv.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[0];
      ...
      rwv.a(paramView, this.jdField_a_of_type_ArrayOfInt, this.jdField_b_of_type_ArrayOfInt, new int[] { 0, ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity) }, new int[] { paramInt, i }, 300L, true);
      ...
      arrayOfInt1 = this.c;
      j = rwv.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1];
      int k = this.c[1];
      int[] arrayOfInt2 = this.c;
      rwv.a(paramVVideoView, new int[] { 0, paramInt + i }, arrayOfInt1, new int[] { 0, j - k }, arrayOfInt2, 300L, true);
      paramView.addOnLayoutChangeListener(new tod(this));
      return;
    }
    paramVVideoView = this.jdField_a_of_type_AndroidViewViewGroup;
    paramInt = rwv.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1];
    paramView = this.c;
    int i = rwv.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1];
    int j = this.c[1];
    int[] arrayOfInt1 = this.c;
    rwv.a(paramVVideoView, new int[] { 0, paramInt }, paramView, new int[] { 0, i - j }, arrayOfInt1, 300L, true);
  }
  ...
  private void a(VVideoView paramVVideoView, View paramView, boolean paramBoolean)
  {
    ...
    rwv.a(this.jdField_a_of_type_AndroidViewView, 8, 300);
    rwv.a(this.jdField_a_of_type_AndroidViewViewGroup, 8, 300);
    ...
    if ((paramBoolean) || (paramView == null))
    {
      ...
      localObject[0] = 0;
      localObject[1] = rwv.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1];
    }
    for (;;)
    {
      rwv.a(this.jdField_a_of_type_AndroidViewViewGroup, new int[] { 0, rwv.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1] - this.jdField_a_of_type_AndroidViewViewGroup.getHeight() }, arrayOfInt, (int[])localObject, arrayOfInt, 300L, true);
      if (paramView == null) {
        break;
      }
      ...
      localObject = rwv.a(paramView, new int[] { 0, i }, new int[] { j, k }, (int[])localObject, arrayOfInt, 300L, false);
      ((Animator)localObject).addListener(new toe(this, paramVVideoView, paramView));
  ...
  private void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Toi != null) {
        this.jdField_a_of_type_Toi.a(false);
      }
    }
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = rwv.c(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    ...
    b();
    this.c = new int[] { rwv.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[0], this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height };
  }
  ...
  public void a(View paramView, float paramFloat)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams != null)
    {
      if (paramView != null)
      {
        ...
        i = (int)(rwv.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[0] * f);
      }
      this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = ((int)(rwv.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1] - i - paramFloat - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)));
  ...
  public void a(VVideoView paramVVideoView, View paramView, ArticleInfo paramArticleInfo, AnchorData paramAnchorData, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_AndroidViewViewGroup.getWidth() <= 0) || (this.jdField_a_of_type_AndroidViewViewGroup.getHeight() != this.c[1]))
    {
      ...
      this.jdField_a_of_type_AndroidViewViewGroup.addOnLayoutChangeListener(new tog(this, paramVVideoView, paramView, paramArticleInfo, paramAnchorData, paramInt));
    }
    do
    {
      do
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment == null)
      {
        Fragment localFragment = this.jdField_a_of_type_AndroidSupportV4AppFragmentManager.findFragmentById(2131364880);
    ...
    } while (this.jdField_a_of_type_Toi == null);
    this.jdField_a_of_type_Toi.a(true);
  }
  
  public void a(toi paramtoi)
  {
    this.jdField_a_of_type_Toi = paramtoi;
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment == null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a((Bundle)localObject, new tof(this), this.jdField_a_of_type_AndroidViewViewGroup);
      localObject = this.jdField_a_of_type_AndroidSupportV4AppFragmentManager.beginTransaction();
      ((FragmentTransaction)localObject).add(2131364880, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment);
  ...
  public void b(VVideoView paramVVideoView, View paramView, ArticleInfo paramArticleInfo, AnchorData paramAnchorData, int paramInt)
  {
    if (paramArticleInfo != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment == null)
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a(new toh(this));
      }
    }
    else
    {
