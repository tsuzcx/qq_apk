...
public class bcsa
{
  ...
  public static String a(String paramString)
  {
    ...
    if (i < paramString.length())
    {
      ...
      {
        int k = asle.a(paramString.charAt(i + 1));
        j = i;
        if (k >= 0)
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      {
        i = j;
        if (adak.a((MessageRecord)paramString.get(paramString.size() - 1), localMessageRecord, false))
        {
  ...
  public static String b(String paramString)
  {
    ...
    if (i < paramString.length())
    {
      if ((paramString.charAt(i) == '\024') && (i + 2 < paramString.length()))
      {
        ...
        j = i;
        if (k >= 0) {
          localStringBuilder.append(String.valueOf(new char[] { '\024', (char)asle.b(k) }));
        }
      }
      for (int j = i + 1 + 1;; j = i)
      {
