...
public class bcsa
{
  private static acob a = new acoc();
  ...
  public static MessageForApollo a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, ApolloMessage paramApolloMessage)
  {
    ...
    try
    {
      ...
      localMessageForApollo.msgData = apab.a(paramApolloMessage);
  ...
  public static MessageForHiBoom a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, HiBoomMessage paramHiBoomMessage)
  {
    ...
    try
    {
      localMessageForHiBoom.msgData = apab.a(paramHiBoomMessage);
  ...
  public static MessageForLightVideo a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    MessageForLightVideo localMessageForLightVideo = new MessageForLightVideo();
    localMessageForLightVideo.msgtype = -2071;
    a(paramQQAppInterface, localMessageForLightVideo, paramString1, paramString2, paramInt);
    localMessageForLightVideo.longMsgCount = 1;
    localMessageForLightVideo.longMsgIndex = 0;
    localMessageForLightVideo.longMsgId = ((short)(int)localMessageForLightVideo.shmsgseq);
    return localMessageForLightVideo;
  }
  ...
  public static MessageForMarketFace a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, MarkFaceMessage paramMarkFaceMessage)
  {
    ...
    try
    {
      localMessageForMarketFace.msgData = apab.a(paramMarkFaceMessage);
  ...
  public static MessageForReplyText a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      localMessageForReplyText.msgUid = bcsc.a(bcsc.a());
      paramString1 = paramQQAppInterface.getMessageFacade().getAIOList(localMessageForReplyText.senderuin, paramInt);
      if ((paramString1 != null) && (!paramString1.isEmpty()))
      {
        localMessageForReplyText.shmsgseq = ((ChatMessage)paramString1.get(paramString1.size() - 1)).shmsgseq;
        localMessageForReplyText.time = bcrg.a();
      ...
      try
      {
        localMessageForReplyText.saveExtInfoToExtStr("sens_msg_source_msg_info", HexUtil.bytes2HexStr(apab.a(localMessageForReplyText.mSourceMsgInfo)));
        paramString1 = localMessageForReplyText;
        if (!localMessageForReplyText.isSend()) {
          continue;
        }
        ((aocy)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).a(localMessageForReplyText);
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        ahcs.a().a(paramQQAppInterface, paramString1, -1, 0, -1);
        if (QLog.isColorLevel()) {
      ...
      paramMessageRecord.msgUid = bcsc.a(i);
      paramMessageRecord.shmsgseq = bcsc.a(l, paramInt);
      paramMessageRecord.issend = 1;
      return;
      if (paramInt == 1006)
      {
        paramString2 = ((awyz)paramQQAppInterface.getManager(QQManagerFactory.CONTACT_MANAGER)).a();
        if (paramString2 != null)
        {
  ...
  private static void a(MessageRecord paramMessageRecord1, MessageRecord paramMessageRecord2)
  {
    ...
    if (nty.a(paramMessageRecord2)) {
      paramMessageRecord1.vipBubbleID = paramMessageRecord2.vipBubbleID;
    }
    paramMessageRecord1.time = ((int)bcrg.a());
  }
  ...
  private static MessageRecord b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      break;
      localObject1 = new MessageForLocationShare();
      break;
      localObject1 = new MessageForAutoReply();
      break;
      ...
      break;
      localObject1 = new MessageForCmGameTips();
      break;
      ...
      break;
      localObject1 = new MessageForDarenAssistant();
      break;
      localObject1 = new MessageForLimitChatTopic();
      break;
      localObject1 = new MessageForLimitChatConfirm();
      break;
      localObject1 = new MessageForStarLeague();
      break;
      localObject1 = new MessageForYanZhi();
      break;
      localObject1 = new MessageForLightVideo();
      break;
      localObject1 = new MessageForFuDai();
      break;
      localObject1 = new MessageForBirthdayNotice();
      break;
      localObject1 = new MessageForAIOStoryVideo();
      break;
      localObject1 = new MessageForQCircleFeed();
      break;
      label1935:
  ...
  {
    acoa localacoa = (acoa)a.a(Integer.valueOf(paramInt));
    if (localacoa != null) {
      return localacoa.a(paramInt);
    }
    return null;
  }
