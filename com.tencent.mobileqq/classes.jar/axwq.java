  ...
  extends axun
{
  ...
  public axwq()
  {
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new axwr(this);
    this.jdField_a_of_type_JavaLangString = "picture";
    this.jdField_a_of_type_Int = 16;
  }
  
  public axwq(String paramString)
  {
    this();
    this.S = paramString;
  }
  
  public axwq(String paramString1, String paramString2)
  {
    this();
    this.S = paramString1;
    this.T = paramString2;
  ...
  public static Bitmap a(Drawable paramDrawable)
  {
    try
    {
      ...
      for (Object localObject = Bitmap.Config.ARGB_8888;; localObject = Bitmap.Config.RGB_565)
      {
        ...
        paramDrawable = bbdr.a((Bitmap)localObject, i, i, i);
  ...
  public View a(Context paramContext, View paramView, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        Drawable localDrawable1 = nqb.a().a((Resources)localObject3, 2130849344);
        ...
        else
        {
          try
          {
            ...
            ((PAHighLightImageView)localObject1).setImageDrawable(baxt.a(((BaseActivity)paramContext).app, 4, paramBundle.optString("groupcode")));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          ((PAHighLightImageView)localObject1).setImageDrawable(bbdr.a());
          return localObject2;
        }
        ...
        paramContext.setTag(bavi.b(j, j, j));
      ...
      if ("StructMsgItemCover createView ,exception  = " + paramContext != null)
      {
        ...
        if (localObject2 != null)
        {
          ...
          if ((localObject3 instanceof BaseActivity))
          {
            ...
            for (;;)
            {
              ...
              {
                paramContext = baxt.b(localQQAppInterface, paramBundle, (byte)3);
              }
              else
              {
                paramContext = baxt.a(11, 3);
                continue;
                paramContext = baxt.a(localQQAppInterface, 1, paramBundle, 3, paramContext, paramContext);
              }
            }
          }
        }
        ...
        {
          ((PAHighLightImageView)localObject1).setImageResource(2130843256);
          return localObject2;
        }
        if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          for (;;)
          {
            try
            {
              if (this.p == m)
              {
                j = actn.a(70.0F, (Resources)localObject3);
                i = j;
              }
            }
            catch (MalformedURLException paramContext) {}
          ...
          j = actn.a(140.0F, (Resources)localObject3);
          i = j;
          continue;
          paramBundle = null;
          if (paramView.startsWith("http://p.qlogo.cn/gh/"))
          {
            ...
            if ((paramView instanceof BaseActivity))
            {
              ...
              paramBundle = baxt.a(4, 3);
              ((PAHighLightImageView)localObject1).setImageDrawable(baxt.a(paramView, 4, paramContext, 3, paramBundle, paramBundle));
              return localObject2;
            }
            ((PAHighLightImageView)localObject1).setImageDrawable(bbdr.a());
            return localObject2;
      ...
      for (;;)
      {
        ...
        {
          ((PAHighLightImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER_CROP);
          i = actn.a(70.0F, (Resources)localObject3);
          if (!bool1) {
            break label1943;
          }
          ((PAHighLightImageView)localObject1).setBackgroundColor(Color.parseColor("#dddfe2"));
        ...
        for (;;)
        {
          ...
          paramContext.restartDownload();
          break label2045;
          if ((paramView.startsWith(xbl.b)) || (paramView.startsWith(xbl.c)) || (paramView.startsWith(xbl.d)))
          {
            ((PAHighLightImageView)localObject1).setBackgroundDrawable(null);
            i = paramView.lastIndexOf("&uin=");
            paramContext = paramView.substring("&uin=".length() + i);
          ...
          if ((paramView.startsWith("http://imgplat.store.qq.com/bqq_qfpic/520520")) || (paramView.contains(wva.jdField_a_of_type_JavaLangString)))
          {
            paramBoolean = true;
          ...
          if (this.p == n)
          {
            ...
            i = actn.a(140.0F, (Resources)localObject3);
            break label1367;
          }
          ((PAHighLightImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER);
          break label1367;
  ...
  StructMsgForGeneralShare a(View paramView)
  {
    for (paramView = paramView.getParent(); paramView != null; paramView = paramView.getParent())
    {
      ...
      if (paramView.getId() == 2131376583) {
        return (StructMsgForGeneralShare)paramView.getTag(2131376583);
      }
    }
    return null;
  }
  ...
  public void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    for (localObject2 = null;; localObject2 = ((ChatFragment)localObject2).a())
    {
      ...
      catch (Exception localException)
      {
        ...
        axqw.b((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D93", "0X8005D93", paramInt2, 1, paramInt1, str, String.valueOf(paramView.msgId), "1", "");
        return;
      }
  ...
  public boolean a(axwe paramaxwe)
  {
    ...
    do
    {
      ...
      {
        return true;
        str = paramaxwe.a("cover");
        if (str == null) {
          break;
        }
        this.S = str;
      } while (this.jdField_a_of_type_Int <= 3);
      this.c = paramaxwe.a("action");
    ...
    for (;;)
    {
      ...
      this.T = paramaxwe.a("needRoundView");
      return true;
      str = "";
      break label18;
