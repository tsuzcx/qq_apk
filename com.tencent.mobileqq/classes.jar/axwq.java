...
public class axwq
{
  ...
  public static aylx a(List<ilive_feeds_read.TopicCfg> paramList, aylx paramaylx)
  {
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      paramList = (ilive_feeds_read.TopicCfg)paramList.get(0);
      paramaylx.a = new axwq();
      paramaylx.a.d(paramList.jump_url.get());
      paramaylx.a.b(paramList.topic_name.get());
      paramaylx.a.a(paramList.topic_desc.get());
      paramaylx.a.b(paramList.topic_parti_num.get());
      paramaylx.a.c(paramList.topic_pic_url.get());
      paramaylx.a.a(paramList.topic_tag.get());
      paramaylx.a.c(paramList.topic_type.get());
    }
    return paramaylx;
  }
