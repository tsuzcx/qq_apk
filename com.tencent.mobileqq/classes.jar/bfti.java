  ...
  implements IEventReceiver
{
  ...
  public bfti(MiniAppActivity paramMiniAppActivity, String paramString, int paramInt)
  {
  ...
  private String a(String paramString)
  {
    ...
    try
    {
      paramString = new JSONObject(bdcs.b(paramString)).optString("version");
      return paramString;
    }
  ...
  private void a(int paramInt)
  {
    ...
    localatzv.jdField_a_of_type_Int = 4;
    localatzv.jdField_a_of_type_Atzw = this.jdField_a_of_type_Atzw;
  ...
  private boolean a(boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      ...
      bdcs.b(str2);
      paramBoolean = bool;
    } while (bdcs.a(str1, str2, false) < 0);
    return bdcs.d(a(paramString, "", "libsconfig.json"), a(this.jdField_a_of_type_ComTencentMobileqqMiniappUiMiniAppActivity, "qgamelibs", "libsconfig.json"));
  }
  
  private String[] a()
  {
    String str3 = this.jdField_a_of_type_Atzw.a.getString("unzipped_path");
    String str2 = a(this.jdField_a_of_type_ComTencentMobileqqMiniappUiMiniAppActivity, "qgamelibs", "ejecta.js");
    String str1 = null;
    if (!TextUtils.isEmpty(str3)) {
      str1 = a(str3, this.jdField_a_of_type_Atzw.h, "index.js");
    }
  ...
  private boolean b()
  {
    ...
    if (!jdField_a_of_type_Boolean)
    {
      ...
      {
        return false;
        localObject = ((File)localObject).listFiles(new bftj(this));
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Bftk = new bftk(this);
      uht.a().registerSubscriber(this.jdField_a_of_type_Bftk);
      atzu localatzu = auab.a().a("ak:3214");
      if (localatzu != null) {
        localatzu.a("ak:3214", "QGameApp", this.jdField_a_of_type_Atzw.h);
      }
    }
  }
  ...
  {
    super.c();
    if (this.jdField_a_of_type_Bftk != null) {
      uht.a().unRegisterSubscriber(this.jdField_a_of_type_Bftk);
    }
  }
