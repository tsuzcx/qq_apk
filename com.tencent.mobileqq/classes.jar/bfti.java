...
public class bfti
{
  ...
  public static bfti a()
  {
    ...
    {
      if (jdField_a_of_type_Bfti == null) {
        jdField_a_of_type_Bfti = new bfti();
      }
  ...
  {
    paramString = bftj.a().a(paramString);
  ...
  public String a(String paramString, bftj parambftj)
  {
    String str1 = paramString;
    if (parambftj.c != null) {
      str1 = paramString.replace("<$FROM>", parambftj.c);
    }
    paramString = str1;
    if (parambftj.a != null) {
      paramString = str1.replace("<$GC>", parambftj.a);
    }
    str1 = paramString;
    if (parambftj.e != null) {
      str1 = paramString.replace("<$NICK>", parambftj.e);
    }
    paramString = str1;
    if (parambftj.d != null) {
      paramString = str1.replace("<$TYPE>", parambftj.d);
    }
    str1 = paramString;
    if (parambftj.b != null) {
      str1 = paramString.replace("<$UIN>", parambftj.b);
    }
    paramString = str1;
    if (parambftj.f != null) {
      paramString = str1.replace("<$CATEID>", parambftj.f);
    }
    str1 = paramString;
    if (parambftj.g != null) {
      str1 = paramString.replace("<$SUBID>", parambftj.g);
    }
    paramString = str1;
    if (parambftj.j != null) {
      paramString = str1.replace("<$GRAY>", parambftj.j);
    }
    str1 = paramString;
    if (parambftj.h != null) {}
    try
    {
      str1 = paramString.replace("<$TITLE>", URLEncoder.encode(parambftj.h, "UTF-8").replaceAll("\\+", "%20"));
      paramString = str1;
      if (parambftj.i == null) {}
    }
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
      ...
      for (;;)
      {
        try
        {
          paramString = str1.replace("<$CONTENT>", URLEncoder.encode(parambftj.i, "UTF-8").replaceAll("\\+", "%20"));
          return paramString;
        }
  ...
  {
    paramString1 = bftj.a().b(paramString2).a(paramString1);
  ...
  {
    paramString3 = bftj.a().a(paramString1).b(paramString2).e(paramString3).d("3").c("aio");
  ...
  {
    Object localObject = bftj.a().a(paramString);
    if (paramBoolean) {}
    for (paramString = "1";; paramString = "0")
    {
      paramString = ((bftj)localObject).f(paramString);
  ...
  public String b(String paramString, bftj parambftj)
  {
