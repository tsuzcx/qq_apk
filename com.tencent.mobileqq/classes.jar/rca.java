...
class rca
  implements URLDrawable.URLDrawableListener, rce
{
  private static rcc jdField_a_of_type_Rcc = new rcc(null);
  ...
  rca(ReadInJoyCapsuleView paramReadInJoyCapsuleView)
  {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = rbu.a();
    localURLDrawableOptions.mFailedDrawable = rbu.a();
  ...
  private void c()
  {
    ...
    int i = rbu.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelCoverInfo.mChannelCoverId, false);
    if (i != 0) {
  ...
  private void d()
  {
    ...
    a(true);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setColorFilter(rbu.a());
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setTextColor(-1);
    int i = rbu.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelCoverInfo.mChannelCoverId, true);
    if (i != 0) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setDrawableLeft(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.getContext().getResources().getDrawable(i));
    }
  }
  ...
  void a(ChannelCoverInfo paramChannelCoverInfo, View.OnClickListener paramOnClickListener)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setOnClickListener(new rcb(this, paramOnClickListener));
    if ((TextUtils.isEmpty(paramChannelCoverInfo.externalExposureBackgroundUrl)) || (bgmq.c(paramChannelCoverInfo.mChannelCoverId)))
    {
      c();
      return;
    }
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    jdField_a_of_type_Rcc.a(this, paramURLDrawable);
  }
}
