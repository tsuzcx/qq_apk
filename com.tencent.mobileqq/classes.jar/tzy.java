...
import com.tencent.biz.pubaccount.readinjoyAd.ad.view.ReadInjoyDoubleImageView.1;
import com.tencent.biz.pubaccount.readinjoyAd.ad.view.ReadInjoyDoubleImageView.5;
  ...
  extends ViewBase
{
  ...
  private ReadInjoyCutImageView jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView;
  ...
  private txb jdField_a_of_type_Txb = new txb();
  ...
  private tzx jdField_b_of_type_Tzx;
  private int c = -1;
  private int d;
  private int e;
  private int f;
  ...
  public tzy(VafContext paramVafContext)
  {
  ...
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.a())))
    {
      int i = 0;
      while (i < paramArrayList.size())
      {
        if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.a().equals(paramArrayList.get(i))) {
          return i;
        }
        i += 1;
      }
  ...
  private Boolean a(float paramFloat1, float paramFloat2)
  {
    ...
    boolean bool3 = true;
    boolean bool1 = true;
    float f1 = this.jdField_a_of_type_Tzx.d;
    float f2 = this.jdField_a_of_type_Tzx.c;
    float f3 = this.jdField_b_of_type_Tzx.d;
    float f4 = this.jdField_b_of_type_Tzx.c;
    if (f1 == f3)
    {
      if (paramFloat2 <= f1) {}
      for (;;)
  ...
  private tzx a(String paramString)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131560050, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369149));
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369151));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView = ((ReadInjoyCutImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369150));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.setVisibility(8);
  ...
  private void a(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_Pvc != null) && (this.jdField_a_of_type_Pvc.a() != null) && (this.jdField_a_of_type_Pvc.a().a() != null))
    {
      ...
      this.c = this.jdField_a_of_type_Pvc.a().a().getTop();
  ...
  private void a(String paramString)
  {
    ...
    if (localObject.length == 2)
    {
      ...
      this.jdField_a_of_type_Tzx = a(paramString);
      this.jdField_b_of_type_Tzx = a((String)localObject);
    }
  }
  ...
  private void a(String paramString, Drawable paramDrawable)
  {
    ...
    do
    {
      ...
      if ((paramDrawable != null) && (paramDrawable.getStatus() == 1))
      {
        ...
        this.jdField_a_of_type_Tzw = new tzw(paramDrawable.getCurrDrawable(), this.d, this.jdField_a_of_type_Int - (this.jdField_b_of_type_Int + this.c));
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Tzw);
        this.jdField_a_of_type_JavaLangString = paramString;
        return;
      }
    } while (paramDrawable == null);
    paramDrawable.setURLDrawableListener(new tzz(this, paramString));
  }
  
  private void a(ArrayList<String> paramArrayList)
  {
    if ((twr.k(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo)) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
      a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView, (String)paramArrayList.get(this.e), this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.setIsShowSrc(true);
  ...
  private void c()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) {
      if (!twr.h(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))
      {
    ...
    for (Object localObject = ((URL)localObject).getFile();; localObject = null)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.i == 1009) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdImgList != null))
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.post(new ReadInjoyDoubleImageView.1(this));
      }
      return;
    }
  }
  ...
  private void e()
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.c)) || (this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdMaterialWidth == 0) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdMaterialHeight == 0) || (this.jdField_a_of_type_JavaLangRunnable != null) || (this.jdField_a_of_type_Txb.a() != null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView == null)) {
      return;
    }
    a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.c);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.setOnTouchListener(new uaa(this));
    if ((this.jdField_a_of_type_Tzx != null) && (this.jdField_b_of_type_Tzx != null)) {
      this.jdField_a_of_type_Txb.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView, this.jdField_a_of_type_Tzx, this.jdField_b_of_type_Tzx, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.k, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.l, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.o);
    }
    this.jdField_a_of_type_Txb.a(new uab(this));
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.getVisibility() == 0)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.setVisibility(8);
      b();
    }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, double paramDouble)
  {
    ...
    } while (this.jdField_a_of_type_Tzw == null);
    if (this.jdField_a_of_type_Tzw.getCallback() == null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Tzw);
    }
    ...
    this.jdField_a_of_type_Tzw.a(paramInt1, paramInt2);
  }
  ...
  public void a(pvc parampvc)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (twr.h(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      d();
    }
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (twr.k(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.getHeight() != 0) && (this.jdField_a_of_type_JavaLangRunnable != null))
    {
      this.jdField_a_of_type_JavaLangBoolean = a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView, paramBoolean);
      if (!this.jdField_a_of_type_JavaLangBoolean.booleanValue()) {
        break label90;
      }
      if (!this.jdField_b_of_type_JavaLangBoolean.booleanValue())
      {
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.post(this.jdField_a_of_type_JavaLangRunnable);
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView != null)
    {
      this.jdField_a_of_type_Txb.a();
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
      this.jdField_b_of_type_JavaLangBoolean = Boolean.valueOf(false);
    }
  }
  ...
  public void onParseValueFinished()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.setPadding(this.mPaddingLeft, this.mPaddingTop, this.mPaddingRight, this.mPaddingBottom);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.setScaleType((ImageView.ScaleType)ImageBase.IMAGE_SCALE_TYPE.get(2, ImageView.ScaleType.CENTER_CROP));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.setCorner(this.mBorderTopLeftRadius, this.mBorderTopRightRadius, this.mBorderBottomLeftRadius, this.mBorderBottomRightRadius);
    c();
    refresh();
  }
  ...
  public void reset()
  {
    ...
    {
      this.jdField_a_of_type_Txb.a();
      this.jdField_a_of_type_Txb.a(null);
      this.jdField_a_of_type_Txb = null;
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.setImageSrc(null);
    }
    if (this.jdField_a_of_type_Tzw != null)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(null);
      this.jdField_a_of_type_Tzw.a();
      this.jdField_a_of_type_Tzw = null;
    }
  }
