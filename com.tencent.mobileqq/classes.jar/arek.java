...
public class arek
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (i < j)
        {
          ...
          {
            localObject1 = bkyp.b(localObject2.split("=")[1]);
            return localObject1;
          }
          i += 1;
        }
  ...
  private static String a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      for (;;)
      {
        paramString2 = str + bkyp.a(new StringBuilder().append(paramString2).append('=').append(paramString3).toString());
        if (j != -1) {
          break;
        }
  ...
  public boolean a(String paramString, Context paramContext, int paramInt, QQAppInterface paramQQAppInterface)
  {
    if ((a(paramString)) && (!TextUtils.isEmpty(this.b)))
    {
      ...
      return MiniAppLauncher.startMiniApp(paramContext, str2, paramInt, new arel(this, paramQQAppInterface, paramString));
    }
    return false;
  }
