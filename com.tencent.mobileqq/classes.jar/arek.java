...
public class arek
{
  ...
  aren jdField_a_of_type_Aren = new aren(this);
  List<areo> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    {
      areo localareo = (areo)localIterator.next();
      if (localareo != null) {
        localareo.a(paramString, paramBoolean, paramInt);
      }
    }
  ...
  public aren a()
  {
    return this.jdField_a_of_type_Aren;
  }
  
  public void a()
  {
    this.jdField_a_of_type_Aren = new aren(this);
  }
  
  public void a(AppInterface paramAppInterface, String paramString1, Context paramContext, String paramString2, areo paramareo)
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Aren.b))
    {
      if (paramareo != null) {
        paramareo.a(paramString1, true, 0);
      }
      return;
    }
    arem localarem = new arem(this, paramareo, paramString1);
    ...
    paramString2 = bdjl.a(paramContext);
    ...
    for (;;)
    {
      ...
      paramContext = new NewIntent(paramContext, mxe.class);
      ...
      try
      {
        ...
        paramContext.setObserver(localarem);
      ...
      catch (Exception paramString2)
      {
        for (;;)
        {
          paramareo.a(paramString1, false, -10001);
        }
      }
    }
  }
  
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, areo paramareo, boolean paramBoolean, String paramString5)
  {
    QLog.i("XProxy", 2, "开始拉取A1，uin = " + paramString1 + " appid = " + paramString4);
    if ((this.jdField_a_of_type_Aren.a != null) && (!paramBoolean) && (System.currentTimeMillis() - this.jdField_a_of_type_Long < 43200000L))
    {
      if (paramareo != null) {
        paramareo.a(paramString2, true, 0);
      }
      return true;
    }
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramareo);
      return true;
    }
    ...
    for (;;)
    {
      this.jdField_a_of_type_OicqWlogin_sdkRequestWtloginHelper.SetListener(new arel(this, paramString2));
      this.jdField_a_of_type_JavaUtilList.add(paramareo);
      ...
      {
        paramString5 = bbea.a(paramString5);
      }
    }
  }
}
