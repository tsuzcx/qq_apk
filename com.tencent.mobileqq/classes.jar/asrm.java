...
public class asrm
  implements atxf
{
  public asrm(FilePreviewActivity paramFilePreviewActivity) {}
  ...
  public void openFile(String paramString1, String paramString2, long paramLong, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      ((Intent)localObject1).putExtra("offline_file_domain_key", this.a.f);
      ...
      if (!TextUtils.isEmpty(this.a.jdField_g_of_type_JavaLangString)) {
        ((Intent)localObject1).putExtra("COOKIE", this.a.jdField_g_of_type_JavaLangString);
      }
    ...
    do
    {
      ...
      do
      {
        ...
        if (!TextUtils.isEmpty(this.a.jdField_g_of_type_JavaLangString)) {
          localBundle.putString("COOKIE", this.a.jdField_g_of_type_JavaLangString);
        }
        if (QLog.isColorLevel()) {
          QLog.i("<FileAssistant>FilePreviewActivity", 1, "set cookies:" + this.a.jdField_g_of_type_JavaLangString);
        }
        ((Bundle)localObject3).putBundle("_user_data", localBundle);
        bglp.a(this.a, 233, this.a.getString(2131717434), "是否下载文件:\n" + paramString1 + "(" + atwl.a(paramLong) + ")", new asrn(this, paramString2, (atzj)localObject2, (Bundle)localObject3), new asro(this)).show();
        return;
      ...
      localObject1 = localObject2;
    } while (!atwl.b(((FileManagerEntity)localObject3).getFilePath()));
    paramString1 = new atvn();
    paramString1.jdField_b_of_type_JavaLangString = "file_viewer_in";
    paramString1.jdField_a_of_type_Int = 73;
    paramString1.c = atwl.a(((FileManagerEntity)localObject3).fileName);
    paramString1.jdField_a_of_type_Long = ((FileManagerEntity)localObject3).fileSize;
    atvm.a(this.a.app.getCurrentAccountUin(), paramString1);
    atvm.a("0X8004AE4");
