  ...
  extends bnle
{
  ...
  public bnln(@NonNull String paramString)
  {
    super(paramString);
  ...
  public int a(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((bnlp)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  public int a(String paramString)
  {
    if ((!StringUtil.isEmpty(paramString)) && (this.jdField_a_of_type_JavaUtilList != null))
    {
      ...
      {
        bnlp localbnlp = (bnlp)localIterator.next();
        if (paramString.equals(localbnlp.jdField_a_of_type_JavaLangString)) {
          return localbnlp.jdField_a_of_type_Int;
        }
      }
    }
    return 0;
  ...
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((bnlp)this.jdField_a_of_type_JavaUtilList.get(paramInt)).b;
    }
    return null;
  }
  ...
  public List<bnlp> a()
  {
    ...
    {
      File[] arrayOfFile = ((File)localObject).listFiles(new bnlo(this));
      if (arrayOfFile != null)
      {
    ...
    for (;;)
    {
      ...
      {
        localArrayList.add(new bnlp(str, localFile1.toURI().toString(), i, (String)localObject));
        j += 1;
        break;
        if (!str.endsWith(".gif")) {
          break label293;
  ...
  public void a(List<bnlp> paramList)
  {
    if (paramList == null) {
      return;
    }
  ...
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((bnlp)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_c_of_type_JavaLangString;
    }
    return null;
  }
