...
{
  bbfi(String paramString1, int paramInt, String paramString2) {}
  
  protected Void a(Void... paramVarArgs)
  {
    paramVarArgs = bbio.a(ServerConfigManager.ConfigType.common, bbfh.p());
    ...
    for (;;)
    {
      try
      {
        ...
        l1 = bbfh.a();
        paramVarArgs = bbio.a(ServerConfigManager.ConfigType.common, bbfh.q());
    ...
    if ((l2 != 0L) && (SystemClock.uptimeMillis() >= l2))
    {
      ...
      localHashMap.put("param_DeviceType", String.valueOf(agqf.a()));
      paramVarArgs = null;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localHashMap.put("param_NetType", String.valueOf(bbev.a(BaseApplication.getContext())));
      if (i != 0)
      {
        paramVarArgs = this.jdField_a_of_type_JavaLangString;
        axrl.a(BaseApplication.getContext()).a(bbio.a(), paramVarArgs, bbfh.a(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Int, 0L, localHashMap, bbfh.o());
        if (i == 0) {
          break label631;
        }
