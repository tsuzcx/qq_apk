  ...
  extends voe
{
  ...
  voa jdField_a_of_type_Voa;
  vok jdField_a_of_type_Vok = null;
  ...
  static VideoFilterBase b(VideoMaterial paramVideoMaterial)
  {
    ...
    if (localDoodleItem != null) {
      localvoj = new voj(localDoodleItem, paramVideoMaterial.getDataPath());
    }
    return localvoj;
  }
  ...
  {
    return new voi(paramVideoMaterial.getDoodleItem(), paramVideoMaterial.getDataPath());
  }
  ...
  public Bitmap a(int paramInt1, int paramInt2)
  {
    ...
    if (localBitmap != null)
    {
      ...
      localBitmap.recycle();
      return vxv.a((Bitmap)localObject, this.jdField_c_of_type_Int, this.jdField_d_of_type_Int, true);
    }
    return null;
  }
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Vok.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localPointF);
    this.jdField_a_of_type_Vok.jdField_d_of_type_Boolean = paramBoolean;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((this.jdField_c_of_type_Boolean) && ((this.jdField_a_of_type_Voa instanceof voc)))
    {
      ((voc)this.jdField_a_of_type_Voa).h();
      a(true);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, vok paramvok)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() < 1)) {
      return;
    }
    ...
    this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(paramvok.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), 1.0D, localFrame);
    GlUtil.setBlendMode(false);
    paramvok.jdField_a_of_type_Boolean = true;
  }
  
  public void a(Frame paramFrame, int paramInt1, int paramInt2, vok paramvok)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() < 1)) {
      return;
    }
    ...
    boolean bool = paramvok.jdField_d_of_type_Boolean;
    localArrayList.addAll(paramvok.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
    Object localObject = (VideoFilterBase)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramvok.jdField_a_of_type_JavaLangString);
    if ((localObject instanceof voj))
    {
      localObject = (voj)localObject;
      ((voj)localObject).a(localArrayList);
      ((voj)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
      if (bool)
      {
        ...
        GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        ((voj)localObject).a(paramvok.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
        ((voj)localObject).renderTexture(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2);
        paramvok.b();
      }
    }
    for (;;)
    {
      GlUtil.setBlendMode(false);
      if ((!paramvok.jdField_d_of_type_Boolean) || (!paramvok.jdField_c_of_type_Boolean)) {
        break;
      }
      paramFrame = paramvok.a(paramInt1, paramInt2);
      a(paramFrame.getFBO(), paramFrame.getTextureId(), paramInt1, paramInt2);
      return;
      if ((localObject instanceof voh))
      {
        localObject = (voh)localObject;
        ((voh)localObject).a();
        ((voh)localObject).a(localArrayList, bool, paramvok);
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        GLES20.glBindFramebuffer(36160, paramFrame.getFBO());
        ((voh)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
        if (bool)
        {
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
          GLES20.glViewport(0, 0, paramInt1, paramInt2);
          ((voh)localObject).a(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId());
          paramvok.b();
        }
      }
      else if ((localObject instanceof voi))
      {
        localObject = (voi)localObject;
        ((voi)localObject).a(localArrayList);
        vom.a(this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2, true);
        ((voi)localObject).a();
        vom.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, paramFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
        if (bool)
        {
          ((voi)localObject).a(paramvok.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          vom.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
          paramvok.b();
        }
      }
    }
  ...
  public void a(VideoMaterial paramVideoMaterial)
  {
    if (paramVideoMaterial != null)
    {
      ...
      if (this.jdField_a_of_type_Voa != null) {
        this.jdField_a_of_type_Voa.a(paramVideoMaterial);
      }
      return;
    }
    ved.b("PersonalityOperator", "material is null!");
  }
  ...
  public void a(vok paramvok)
  {
    if ((paramvok.jdField_d_of_type_Boolean) && (paramvok.jdField_a_of_type_Boolean)) {}
    do
    {
      do
      {
      ...
      if ((!paramvok.jdField_a_of_type_Boolean) && (paramvok.jdField_b_of_type_Boolean))
      {
        if (paramvok.jdField_c_of_type_Boolean) {
          a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramvok);
        }
        this.jdField_f_of_type_Boolean = true;
        return;
      }
    } while (paramvok.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() <= 1);
    a(this.jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramvok);
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    {
      return true;
      if ((this.jdField_f_of_type_Int + 1 <= 50) || (this.jdField_a_of_type_Vok == null) || (!this.jdField_a_of_type_Vok.jdField_d_of_type_Boolean)) {
        break;
      }
    } while (paramMotionEvent.getAction() != 0);
    QQStoryContext.a();
    bcql.a(QQStoryContext.a().getApp(), ajya.a(2131707977), 0).a();
    return true;
    float f1 = paramMotionEvent.getX();
    float f2 = paramMotionEvent.getY();
    if (paramMotionEvent.getAction() == 2) {
      if (this.jdField_a_of_type_Vok != null)
      {
        a(f1, f2, false);
    ...
    for (;;)
    {
      ...
      if (paramMotionEvent.getAction() == 0)
      {
        ...
        {
          this.jdField_a_of_type_Vok = new vok(102, this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial.getId());
          this.jdField_f_of_type_Int += 1;
          this.jdField_a_of_type_Vok.jdField_c_of_type_Boolean = true;
          if (this.jdField_a_of_type_Voa != null) {
            this.jdField_a_of_type_Voa.a(this.jdField_a_of_type_Vok);
          }
          a(f1, f2, false);
          this.jdField_e_of_type_Int = 0;
        }
      }
      else if (((paramMotionEvent.getAction() == 1) || (paramMotionEvent.getAction() == 3)) && (this.jdField_a_of_type_Vok != null)) {
        a(f1, f2, true);
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    try
    {
      ...
      if (localBitmap == null)
      {
        ...
        ved.e("PersonalityOperator", "saveTextureToBitmap failed, bitmapFromTexture is null");
        return;
      }
      localBitmap = vxv.a(localBitmap, 1.0F * this.jdField_g_of_type_Int / this.jdField_c_of_type_Int, true);
      this.jdField_d_of_type_Boolean = false;
      if (this.jdField_a_of_type_Voa != null)
      {
        this.jdField_a_of_type_Voa.a(localBitmap);
        return;
      }
    }
  ...
  public void e()
  {
    ...
    if ((this.jdField_a_of_type_Voa != null) && ((this.jdField_a_of_type_Voa instanceof voc))) {
      ((voc)this.jdField_a_of_type_Voa).f();
    }
    Object localObject4;
    Object localObject5;
    Bitmap localBitmap1;
    ...
    try
    {
      ...
      if (localBitmap2 != null)
      {
        localObject3 = localObject4;
        localObject2 = localObject5;
        localBitmap1 = vxv.a(localBitmap2, 1.0F * this.jdField_g_of_type_Int / this.jdField_c_of_type_Int, true);
      }
      localObject3 = localBitmap1;
      localObject2 = localBitmap1;
      this.jdField_d_of_type_Boolean = false;
      if (this.jdField_a_of_type_Voa != null) {
        this.jdField_a_of_type_Voa.a(localBitmap1);
      }
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Voa != null) {
          this.jdField_a_of_type_Voa.a((Bitmap)localObject3);
        }
      }
    }
    finally
    {
      ...
      this.jdField_a_of_type_Voa.a((Bitmap)localObject2);
    }
