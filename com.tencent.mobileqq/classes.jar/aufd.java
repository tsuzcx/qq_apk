...
public class aufd
{
  ...
  public static Intent a(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity)
  {
    ...
    paramActivity.putExtra("forward_text", anvx.a(2131709170) + auea.d(paramFileManagerEntity.fileName) + anvx.a(2131709182) + FileUtil.filesizeToString(paramFileManagerEntity.fileSize) + "。");
    paramActivity.putExtra("k_favorites", auea.c(paramFileManagerEntity));
  ...
  public static Intent a(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    ...
    bfjs localbfjs = bgke.a(paramQQAppInterface, localFileManagerEntity);
    ...
    if (!TextUtils.isEmpty(localFileManagerEntity.getFilePath())) {
      localForwardFileInfo.a(localbfjs.jdField_a_of_type_JavaLangString);
    }
    localForwardFileInfo.d(localbfjs.g);
    localForwardFileInfo.d(localbfjs.jdField_c_of_type_Long);
    localForwardFileInfo.a(localFileManagerEntity.TroopUin);
    paramFileManagerEntity = localbfjs.d;
    ...
    for (;;)
    {
      ...
      paramFileManagerEntity.putExtra("forward_text", localbfjs.g);
      paramFileManagerEntity.putExtra("forward_from_troop_file", true);
      return paramFileManagerEntity;
      if (localbfjs.jdField_a_of_type_JavaUtilUUID != null) {
        localForwardFileInfo.e(localbfjs.jdField_a_of_type_JavaUtilUUID.toString());
      }
  ...
  public static SpannableString a(String paramString1, String paramString2, aueo paramaueo)
  {
    ...
    for (int i = Color.parseColor("#A3CCEF");; i = j)
    {
      ...
      paramString1.setSpan(new aufs(new aufe(paramaueo), paramString2), k, k + m, 33);
      return paramString1;
    }
  }
  
  public static bfjs a(QQAppInterface paramQQAppInterface, long paramLong, bfif parambfif)
  {
    bfjs localbfjs2 = TroopFileTransferManager.a(paramQQAppInterface, paramLong).a(parambfif.b);
    bfjs localbfjs1 = localbfjs2;
    if (localbfjs2 == null)
    {
      localbfjs1 = bgke.a(paramQQAppInterface, paramLong, parambfif.jdField_a_of_type_JavaUtilUUID.toString(), parambfif.b, parambfif.jdField_c_of_type_JavaLangString, parambfif.jdField_a_of_type_Long, parambfif.jdField_a_of_type_Int);
  ...
  public static String a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      if (localStringBuilder.length() > 0) {
        localStringBuilder.append(paramContext.getString(2131692282));
      }
  ...
  public static String a(Bitmap paramBitmap)
  {
    ...
    localFile = new File(audf.a().b() + ".video_frame/");
  ...
  private static String a(AppInterface paramAppInterface, MessageForTroopFile paramMessageForTroopFile)
  {
    ...
    for (;;)
    {
      if ((!TextUtils.isEmpty((CharSequence)localObject)) && (auea.b((String)localObject)))
      {
        if (QLog.isDebugVersion()) {
      ...
      for (;;)
      {
        ...
        paramAppInterface = audf.a().c() + bkwk.a(paramAppInterface);
        if (!auea.b(paramAppInterface)) {
          break;
        }
        if (QLog.isDebugVersion()) {
  ...
  public static String a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2)
  {
    ...
    if (localObject != null)
    {
      if (((bgkf)localObject).a(String.valueOf(paramLong1), String.valueOf(paramLong2))) {
        return anvx.a(2131709171);
      }
      localObject = ((bgkf)localObject).a(String.valueOf(paramLong1));
      paramQQAppInterface = (TroopManager)paramQQAppInterface.getManager(QQManagerFactory.TROOP_MANAGER);
      if ((localObject != null) && (((bgkm)localObject).jdField_a_of_type_Long != 0L))
      {
        if (paramQQAppInterface != null)
        {
  ...
  public static void a(int paramInt1, int paramInt2, atyk paramatyk)
  {
  ...
  public static void a(Context paramContext, Rect paramRect, ChatMessage paramChatMessage, SessionInfo paramSessionInfo, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, MessageForReplyText paramMessageForReplyText)
  {
    ...
    for (;;)
    {
      ...
      paramBoolean1 = ayrg.a(BaseApplicationImpl.sApplication.getRuntime().getAccount(), 1);
      localBundle.putBoolean("extra.OCR", paramBoolean1);
      if (paramBoolean1)
      {
        paramMessageForReplyText = ayrg.a(BaseApplicationImpl.sApplication.getRuntime().getAccount());
      ...
      try
      {
        ...
        if ((paramChatMessage instanceof MessageForFile))
        {
          if ((paramContext instanceof SplashActivity))
          {
            ...
            blvp.a(paramContext, localBundle, new AIOImageProviderService(paramRect, paramChatMessage.frienduin, paramChatMessage.istroop, paramChatMessage), ahsl.a(paramChatMessage, paramMessageForReplyText), -1, i);
            return;
          }
        ...
        {
          localBundle.putBoolean("extra.ENTER_NEW_GALLERY", true);
          blvp.a(paramContext, localBundle, new AIOImageProviderService(paramRect, paramChatMessage.frienduin, paramChatMessage.istroop, paramChatMessage), ahsl.a(paramChatMessage, paramMessageForReplyText), -1, paramSessionInfo.entrance);
          return;
        }
      }
  ...
  public static void a(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, aueo paramaueo)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(paramString2))) {
      if (paramTextView.getWidth() == 0) {
        paramTextView.post(new QFileUtils.2(paramContext, paramTextView, paramString1, paramString2, paramString3, paramString4, paramString5, paramBoolean, paramaueo));
      }
    }
    while (TextUtils.isEmpty(str.replace(" ", "")))
    {
      return;
      b(paramContext, paramTextView, paramString1, paramString2, paramString3, paramString4, paramString5, paramBoolean, paramaueo);
      return;
    }
  ...
  public static void a(Context paramContext, String paramString1, int paramInt1, boolean paramBoolean, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt2, String paramString6, String paramString7, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      localIntent.putExtra("report_params", zmk.a(paramString3, paramString1, paramString5, paramString2, paramString6, paramInt1));
  ...
  public static void a(Context paramContext, String paramString, atvq paramatvq)
  {
    if (!FileUtils.fileExistsAndNotEmpty(paramString)) {
      return;
    }
    ThreadManagerV2.executeOnSubThread(new QFileUtils.5(paramContext, paramString, paramatvq));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity, boolean paramBoolean, String paramString, int paramInt)
  {
    if (NetworkUtil.getSystemNetwork(paramActivity) == 0) {
      bgjc.a(paramActivity, paramActivity.getString(2131697356));
    }
    ...
    aupt.a(paramActivity, paramQQAppInterface, ForwardRecentTranslucentActivity.class, 103);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong1, String paramString1, String paramString2, String paramString3, long paramLong2, int paramInt)
  {
    ...
    {
      return;
      paramString2 = bgke.a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramString3, paramLong2, paramInt);
    ...
    for (;;)
    {
      paramQQAppInterface = (ansr)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DATALINE_HANDLER);
      paramString2 = new aufl(paramContext);
      ...
      return;
      paramString3 = auea.a(paramString2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ChatMessage paramChatMessage, long paramLong1, bfjs parambfjs, String paramString, long paramLong2, int paramInt1, int paramInt2, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2)
  {
    a(paramQQAppInterface, paramContext, paramSessionInfo, paramChatMessage, paramLong1, parambfjs, paramString, paramLong2, paramInt1, paramInt2, paramRect, paramBoolean1, paramBoolean2, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ChatMessage paramChatMessage, long paramLong1, bfjs parambfjs, String paramString, long paramLong2, int paramInt1, int paramInt2, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      parambfjs = new atyo(paramQQAppInterface, (Context)localObject, paramLong1, parambfjs, paramInt1);
      Bundle localBundle = new Bundle();
      if (paramBoolean2)
      {
        paramInt1 = 106;
        localBundle.putInt("FromChatHistoryTab", 106);
        parambfjs.a(localBundle);
        parambfjs.a(paramLong2);
        parambfjs.a(paramString);
        parambfjs.a(paramSessionInfo);
        parambfjs.a(paramChatMessage);
        parambfjs.a(paramBoolean1);
        parambfjs.b(paramBoolean3);
        a(paramBoolean2, paramQQAppInterface, paramSessionInfo, parambfjs, (Context)localObject, paramInt2, paramRect, paramInt1, paramChatMessage);
        return;
      }
  ...
  {
    paramQQAppInterface = new atyi(paramQQAppInterface, paramContext, paramFileManagerEntity, paramInt2);
    new Bundle();
    ...
    paramQQAppInterface = new atyk(paramContext, paramQQAppInterface);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, FileManagerEntity paramFileManagerEntity)
  {
    ...
    do
    {
      ...
      paramFileManagerEntity = (ansr)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DATALINE_HANDLER);
      localaufj = new aufj(paramContext);
      i = paramFileManagerEntity.a().b(AppConstants.DATALINE_PC_UIN, localBundle, localaufj);
    } while ((localaufj.a) && (i != 0));
    dc.b(paramContext, i);
    bdla.b(paramQQAppInterface, "CliOper", "", "", "0X800644B", "0X800644B", 0, 0, "6", "", "", "");
  }
  ...
  {
    if ((paramMessageRecord1 == null) || (!auea.a(paramMessageRecord1))) {}
    int i;
    do
    {
      String str;
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<bfif> paramList, Activity paramActivity, long paramLong)
  {
    ...
    {
      bfjs localbfjs = a(paramQQAppInterface, paramLong, (bfif)paramList.next());
      FileManagerEntity localFileManagerEntity = auea.a(localbfjs);
      localFileManagerEntity.status = 2;
      ...
      {
        localForwardFileInfo.f(localbfjs.jdField_c_of_type_JavaLangString);
        label209:
        ...
        localArrayList2.add(Uri.parse(localbfjs.jdField_a_of_type_JavaLangString));
      }
      for (;;)
      {
        long l2 = localbfjs.jdField_c_of_type_Long;
        localArrayList1.add(localForwardFileInfo);
        l1 = l2 + l1;
        break;
        if (TextUtils.isEmpty(localbfjs.d)) {
          break label209;
        }
        localForwardFileInfo.f(localbfjs.d);
        break label209;
        label295:
    ...
    paramQQAppInterface = anvx.a(2131709172);
    if (localArrayList1.size() == 1) {
      paramQQAppInterface = anvx.a(2131709180) + auea.d(((ForwardFileInfo)localArrayList1.get(0)).d()) + anvx.a(2131709181) + FileUtil.filesizeToString(((ForwardFileInfo)localArrayList1.get(0)).d()) + "。";
    }
    for (;;)
    {
      paramList.putExtra("forward_text", paramQQAppInterface);
      paramList.putExtra("k_favorites", false);
      aupt.a(paramActivity, paramList, 103);
      return;
      if (localArrayList1.size() > 1) {
        paramQQAppInterface = anvx.a(2131709176) + auea.d(((ForwardFileInfo)localArrayList1.get(0)).d()) + anvx.a(2131709175) + localArrayList1.size() + anvx.a(2131709178) + FileUtil.filesizeToString(l1) + "。";
      }
    }
  }
  
  public static void a(boolean paramBoolean, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, atyo paramatyo, Context paramContext, int paramInt1, Rect paramRect, int paramInt2, ChatMessage paramChatMessage)
  {
    if ((paramBoolean) && ((ChatMessage)paramQQAppInterface.getMessageFacade().queryMsgItemByShmsgseq(paramSessionInfo.curFriendUin, paramSessionInfo.curType, paramChatMessage.shmsgseq) == null)) {
      paramatyo.c(false);
    }
    paramSessionInfo = new atyk(paramContext, paramatyo);
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    String str1 = auea.a(paramString);
  ...
  public static boolean a(Context paramContext, String paramString, Uri paramUri)
  {
    ...
    //   10: istore 4
    //   12: aload_1
    //   13: invokestatic 791	com/tencent/mobileqq/utils/FileUtils:fileExistsAndNotEmpty	(Ljava/lang/String;)Z
    //   16: ifne +10 -> 26
    //   19: iload 4
    //   21: istore 5
    //   23: iload 5
    ...
    //   91: astore_0
    //   92: aload_0
    //   93: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   96: iconst_0
    //   97: ireturn
    //   98: astore_0
    //   99: aload_0
    //   100: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   103: goto -38 -> 65
    //   106: astore_0
    //   107: aload_0
    //   108: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   111: goto -34 -> 77
    ...
    //   217: astore_0
    //   218: aload_0
    //   219: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   222: iconst_0
    //   223: ireturn
    ...
    //   277: astore_0
    //   278: aload_0
    //   279: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   282: iload 4
    //   284: ireturn
    //   285: astore_0
    //   286: aload_0
    //   287: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   290: iconst_0
    //   291: istore 4
    //   293: goto -41 -> 252
    //   296: astore_0
    //   297: aload_0
    //   298: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   301: iload 6
    //   303: istore 4
    //   305: goto -43 -> 262
    //   308: astore_1
    //   309: aload_1
    //   310: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   313: goto -118 -> 195
    //   316: astore_0
    //   317: aload_0
    //   318: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   321: goto -118 -> 203
    //   324: astore_0
    //   325: aconst_null
    //   326: astore_2
    ...
    //   331: ifnull +8 -> 339
    //   334: aload 8
    //   336: invokevirtual 1434	java/io/FileInputStream:close	()V
    //   339: aload_1
    //   340: ifnull +7 -> 347
    //   343: aload_1
    //   344: invokevirtual 1435	java/io/FileOutputStream:close	()V
    //   347: aload_2
    //   348: ifnull +7 -> 355
    //   351: aload_2
    //   352: invokevirtual 1402	android/os/ParcelFileDescriptor:close	()V
    //   355: aload_0
    //   356: athrow
    //   357: astore 7
    //   359: aload 7
    //   361: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   364: goto -25 -> 339
    //   367: astore_1
    //   368: aload_1
    //   369: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   372: goto -25 -> 347
    //   375: astore_1
    //   376: aload_1
    //   377: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   380: goto -25 -> 355
    //   383: astore_0
    //   384: aconst_null
    //   385: astore_1
  ...
  public static boolean a(Context paramContext, boolean paramBoolean, auey paramauey)
  {
    int j = 2;
    boolean bool1;
    ...
    do
    {
      ...
      i = 3;
      bool2 = bhyk.a(localActivity, i, new auff(paramauey), "");
      bool1 = bool2;
    } while (!bool2);
    ...
    for (int i = j;; i = 1)
    {
      return bixr.a(paramContext, i, new aufg(paramauey));
      i = 2;
      break;
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (atix)paramQQAppInterface.getManager(QQManagerFactory.QFILE_CONFIG_MANAGER);
    if (i >> 8 == 2)
    {
  ...
  private static boolean a(File paramFile1, File paramFile2)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokevirtual 1495	java/io/File:isFile	()Z
    //   7: ifeq +12 -> 19
    //   10: aload_0
    //   11: invokevirtual 490	java/io/File:exists	()Z
    //   14: istore_3
    //   15: iload_3
    //   16: ifne +43 -> 59
    //   19: iconst_0
    ...
    //   45: astore_0
    //   46: aload_0
    //   47: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   50: iconst_0
    //   51: ireturn
    //   52: astore_0
    //   53: aload_0
    //   54: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   57: iconst_0
    //   58: ireturn
    //   59: new 1404	java/io/FileOutputStream
    //   62: dup
    //   63: aload_1
    //   64: invokespecial 1498	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   67: astore 4
    //   69: new 1413	java/io/FileInputStream
    //   72: dup
    //   73: aload_0
    //   74: invokespecial 1499	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   77: astore_0
    ...
    //   142: astore_0
    //   143: aload_0
    //   144: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   147: iconst_0
    //   148: ireturn
    ...
    //   181: astore_0
    //   182: aload_0
    //   183: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   186: iconst_0
    //   187: ireturn
    //   188: astore_0
    //   189: aload_0
    //   190: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   193: iconst_0
    //   194: ireturn
    //   195: astore_0
    //   196: aload_0
    //   197: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   200: iconst_0
    //   201: ireturn
    //   202: astore_1
    //   203: aconst_null
    ...
    //   235: astore_0
    //   236: aload_0
    //   237: invokevirtual 521	java/io/IOException:printStackTrace	()V
    //   240: iconst_0
    //   241: ireturn
    //   242: astore_1
    //   243: aconst_null
  ...
  public static String b(long paramLong)
  {
    ...
    if (paramLong > 1048576L)
    {
      ...
      return anvx.a(2131709174) + str + "MB/s";
    }
    if (paramLong > 1024L)
    {
      f = (float)paramLong / 1024.0F;
      str = new DecimalFormat("0.00").format(f);
      return anvx.a(2131709173) + str + "KB/s";
    }
    return anvx.a(2131709179) + paramLong + "KB/s";
  }
  
  public static void b(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, aueo paramaueo)
  {
    String str = a(paramContext, paramString1, paramString2, paramString3, paramString4);
    paramString2 = auea.a(paramTextView, 2, paramString5 + str, paramString2);
    if (!TextUtils.isEmpty(paramString2))
    {
      paramContext = a(paramContext, paramString1, paramString2, paramString3, paramString4);
      paramContext = auea.a(paramTextView, paramString5 + paramContext);
      paramString1 = a(paramContext, paramString2, anvx.a(2131709177));
      if (paramBoolean) {
        paramContext = a(paramContext, paramString1, paramaueo);
      }
    }
    for (;;)
    {
      if (arlt.c().a())
      {
        ...
        arlt.c().a(paramContext, paramString4, paramString1);
      }
  ...
  public static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity, boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if (aucx.a(localFileManagerEntity).a(false))
    {
      audn.a(paramActivity, 2131692476, 2131692481, new aufh(paramActivity, paramQQAppInterface));
      return;
    }
    aupt.a(paramActivity, paramQQAppInterface, ForwardRecentTranslucentActivity.class, 103);
  }
  ...
  {
    if ((paramMessageRecord1 == null) || (!auea.a(paramMessageRecord1))) {}
    while ((paramMessageRecord2 == null) || (!auea.a(paramMessageRecord2))) {
      return;
    }
  ...
  public static boolean b(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      bheg.a(paramContext, (String)localObject);
      return true;
      if (i == 2)
      {
  ...
  public static boolean c(Context paramContext, String paramString)
  {
    ...
    audn.a(paramContext, "", 2131697912, new aufi(paramContext, paramString));
    return false;
  }
}
