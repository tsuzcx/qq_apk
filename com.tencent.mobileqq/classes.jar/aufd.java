...
class aufd
  extends awkg
{
  aufd(aufc paramaufc, MessageForMixedMsg paramMessageForMixedMsg, QQAppInterface paramQQAppInterface, String paramString, int paramInt) {}
  ...
  private boolean a(MessageForPic paramMessageForPic, awjm paramawjm)
  {
    ...
    for (;;)
    {
      ...
      paramMessageForPic.md5 = bdhb.c(aufc.a());
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.e("MixedMsgManager", 2, "WTF, picResult.mExtraObj is " + paramawjm.jdField_a_of_type_JavaLangObject.getClass().getSimpleName());
        }
        i = 0;
        break label227;
        if (QLog.isColorLevel())
  ...
  private boolean a(ArrayList<awjm> paramArrayList)
  {
    ...
    if (localMessageForMixedMsg.msgElemList != null)
    {
      ...
      if (!a((MessageForPic)localObject, (awjm)paramArrayList.get(i))) {
        bool1 = false;
      }
      i += 1;
    }
  ...
  public void a(int paramInt, ArrayList<awjm> paramArrayList)
  {
    if ((paramInt == 0) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      if (!bool)
      {
        ...
        aufc.a(this.jdField_a_of_type_Aufc, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, false, "picUpload fail");
        return;
      }
      ...
      aufc.a(this.jdField_a_of_type_Aufc, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, bool);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.e("MixedMsgManager", 2, "onForwardMultiMsgPicsUpload failed");
    }
    aufc.a(this.jdField_a_of_type_Aufc, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, false, "picUpload fail : result = " + paramInt);
  }
}
