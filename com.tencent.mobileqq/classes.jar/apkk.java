...
public class apkk
{
  ...
  private static LruCache<String, apkl> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bbck.a(apjy.jdField_a_of_type_JavaLangString + "combo" + File.separator);
    ...
    jdField_b_of_type_JavaLangString = apjy.jdField_a_of_type_JavaLangString;
  ...
  public static apkl a()
  {
    return a(jdField_a_of_type_JavaLangString + "dui.png", 2);
  }
  
  public static apkl a(int paramInt)
  {
    return a(jdField_a_of_type_JavaLangString + jdField_a_of_type_ArrayOfJavaLangString[paramInt], 2);
  }
  
  public static apkl a(String paramString, int paramInt)
  {
    int i = 0;
    Object localObject1 = (apkl)jdField_a_of_type_AndroidUtilLruCache.get(paramString);
    ...
    for (;;)
    {
      apkl localapkl = new apkl();
      localapkl.jdField_a_of_type_Int = i;
      localapkl.b = paramInt;
      localapkl.jdField_a_of_type_AndroidGraphicsDrawableDrawable = ((Drawable)localObject2);
      jdField_a_of_type_AndroidUtilLruCache.put(paramString, localapkl);
      return localapkl;
      i = aepi.a(k / jdField_a_of_type_Float, localapkl);
      paramInt = aepi.a(j / jdField_a_of_type_Float, localapkl);
      continue;
      paramInt = aepi.a(32.0F, localapkl);
      i = (int)(paramInt / j * k);
      continue;
      paramInt = aepi.a(24.0F, localapkl);
      i = (int)(paramInt / j * k);
    }
  }
