...
public class aijn
{
  ...
  private Comparator<CmGamePushItem> jdField_a_of_type_JavaUtilComparator = new aijo(this);
  ...
  private void a(CmGamePushItem paramCmGamePushItem1, CmGamePushItem paramCmGamePushItem2)
  {
    ...
    do
    {
      ...
      localatmp = ((QQAppInterface)localObject).getEntityManagerFactory().createEntityManager();
    } while (localatmp == null);
    localObject = localatmp.a();
    ((atmr)localObject).a();
    ...
    for (;;)
    {
      try
      {
        localatmp.b(paramCmGamePushItem2);
        localatmp.a(paramCmGamePushItem1);
        ((atmr)localObject).c();
        return;
      }
  ...
  private void a(List<CmGamePushItem> paramList)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 18	aijn:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   18: astore_2
    //   19: aload_2
    //   20: monitorenter
    //   21: aload_0
    //   22: getfield 23	aijn:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: aload_1
    ...
    //   33: monitorexit
    //   34: aload_0
    //   35: getfield 43	aijn:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   46: ifnull -33 -> 13
    //   49: aload_2
    //   50: invokevirtual 55	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Latmq;
    //   53: invokevirtual 61	atmq:createEntityManager	()Latmp;
    //   56: astore_3
    //   57: aload_3
    //   58: ifnull -45 -> 13
    //   61: aload_3
    //   62: invokevirtual 66	atmp:a	()Latmr;
    //   65: astore_2
    //   66: aload_2
    //   67: invokevirtual 70	atmr:a	()V
    //   70: aload_1
    ...
    //   96: invokevirtual 74	atmp:b	(Latmo;)Z
    //   99: pop
    //   100: goto -23 -> 77
    //   103: astore_1
    ...
    //   128: athrow
    //   129: aload_2
    //   130: invokevirtual 80	atmr:c	()V
    //   133: aload_2
    //   134: invokevirtual 82	atmr:b	()V
    //   137: return
    //   138: astore_1
    //   139: aload_2
    //   140: invokevirtual 82	atmr:b	()V
    //   143: aload_1
    //   144: athrow
  ...
  public void a(CmGamePushItem paramCmGamePushItem)
  {
    ...
    if ((localObject1 != null) && (paramCmGamePushItem.msg_type == 1)) {
      ((auqh)((QQAppInterface)localObject1).getManager(36)).c(String.valueOf("103100.103200.103240.103248"));
    }
