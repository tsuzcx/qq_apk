...
public class thy
{
  ...
  public static String a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("osVersion", bhlo.e());
        localJSONObject.put("appName", bhlo.c());
        localJSONObject.put("appVersion", "8.4.5.4745");
        ...
        localJSONObject.put("appVersionId", "8.4.5");
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramString2 = nmj.d(paramString2);
  ...
  public static String c(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      localSharedPreferences = bnrf.a(BaseApplicationImpl.getApplication().getRuntime(), true, true);
