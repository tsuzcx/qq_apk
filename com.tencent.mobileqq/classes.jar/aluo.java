  ...
  extends aado
{
  ...
  private alus jdField_a_of_type_Alus = new alus(null);
  ...
  private aabi jdField_b_of_type_Aabi;
  ...
  private bcfg a(int paramInt)
  {
    if (this.jdField_a_of_type_Aadp != null)
    {
      WebViewFragment localWebViewFragment = this.jdField_a_of_type_Aadp.a();
      if (localWebViewFragment != null) {
        return (bcfg)localWebViewFragment.b().a(paramInt);
      }
      if ((this.jdField_a_of_type_Aadp.a() instanceof bcek)) {
        return (bcfg)((bcek)this.jdField_a_of_type_Aadp.a()).b().a(paramInt);
      }
    }
    return null;
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    AppInterface localAppInterface = this.jdField_a_of_type_Aadp.a();
    ...
    catch (Exception paramString4)
    {
      ...
      localawzl.a(localAppInterface, localActivity, paramString1, paramString2, paramString3, i);
      return;
      QLog.e("ArkWebModule", 1, "launchAppWithTokens fail for context is null");
    }
    axqy.b(null, "CliOper", "", "", "Game", "Launch_game", 0, 0, paramString1, "", "", "");
    localActivity = this.jdField_a_of_type_Aadp.a();
    ...
    {
      paramString4 = "";
      if (this.jdField_a_of_type_Aadp.a() != null)
      {
        paramString2 = this.jdField_a_of_type_Aadp.a().getUrl();
        localawzl.a(str, localActivity, paramString2, localAppInterface, paramString1, paramString3, i, paramString6);
        return;
      }
    }
    label402:
  ...
  private void a(JSONObject paramJSONObject, @NonNull aabi paramaabi)
  {
    ...
    {
      aaep.a(this.jdField_a_of_type_Aabi, -1, "no auth");
      return;
    }
    ...
    try
    {
      ...
      aaep.a(paramaabi, paramJSONObject);
      return;
    }
  ...
  private void b(JSONObject paramJSONObject, @NonNull aabi paramaabi)
  {
    ...
    {
      aaep.a(this.jdField_a_of_type_Aabi, -5, "other");
      return;
    }
    try
    {
      this.jdField_a_of_type_Alus.jdField_a_of_type_JavaLangString = paramJSONObject.optString("appID");
      this.jdField_a_of_type_Alus.jdField_b_of_type_JavaLangString = paramJSONObject.optString("paramsStr");
      this.jdField_a_of_type_Alus.c = paramJSONObject.optString("packageName");
      this.jdField_a_of_type_Alus.d = paramJSONObject.optString("flags");
      this.jdField_a_of_type_Alus.g = paramJSONObject.optString("url");
      if (TextUtils.isEmpty(this.jdField_a_of_type_Alus.jdField_a_of_type_JavaLangString))
      {
        QLog.e("ArkWebModule", 1, "mOpenAppinfo.appId is null");
        aaep.a(this.jdField_a_of_type_Aabi, -2, "param error");
        return;
      }
    }
    catch (Exception paramJSONObject)
    {
      ...
      if (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(this.jdField_a_of_type_Alus.jdField_a_of_type_JavaLangString))
      {
        paramJSONObject = (Integer)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(this.jdField_a_of_type_Alus.jdField_a_of_type_JavaLangString);
        if (paramJSONObject != null)
        {
          if (paramJSONObject.intValue() == 1)
          {
            paramJSONObject = this.jdField_a_of_type_Aadp.a();
            if (!bbfr.a(paramJSONObject, this.jdField_a_of_type_Alus.c))
            {
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Alus.g))
              {
                paramaabi = new Intent(paramJSONObject, QQBrowserActivity.class);
                paramaabi.putExtra("url", this.jdField_a_of_type_Alus.g);
                paramaabi.putExtra("fromArkAppDownload", true);
                paramJSONObject.startActivity(paramaabi);
              }
              aaep.a(this.jdField_a_of_type_Aabi, -4, "need to download");
              return;
            }
            a(this.jdField_a_of_type_Alus.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Alus.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Alus.c, this.jdField_a_of_type_Alus.d, this.jdField_a_of_type_Alus.e, this.jdField_a_of_type_Alus.f);
            aaep.a(this.jdField_a_of_type_Aabi, aabk.a);
            return;
          }
          if (paramJSONObject.intValue() == 0)
          {
            d();
            aaep.a(this.jdField_a_of_type_Aabi, -3, "user canceled");
            return;
          }
        }
      }
    ...
    do
    {
      ...
      paramaabi = (String)paramJSONObject.next();
    } while ((TextUtils.isEmpty(this.c)) || (!paramaabi.equals(this.c)));
    label802:
    for (paramJSONObject = (String)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramaabi);; paramJSONObject = "ask")
    {
      ...
      if (paramJSONObject.equals("ask"))
      {
        ...
        paramaabi = this.jdField_a_of_type_Aadp.a();
        if (paramaabi == null) {
          break;
        }
        try
        {
          long l = Long.parseLong(this.jdField_a_of_type_Alus.jdField_a_of_type_JavaLangString);
          xmq.a(paramaabi, this.jdField_a_of_type_Aadp.a(), paramaabi.getAccount(), l, 2000L, new alup(this, paramJSONObject));
          return;
        }
        catch (NumberFormatException paramaabi)
        {
          QLog.e("ArkWebModule", 1, String.format("mOpenAppinfo appid to Long error, err=%s", new Object[] { paramaabi.getMessage() }));
          paramaabi = paramJSONObject.getString(2131690235);
          a(String.format(paramJSONObject.getString(2131690236), new Object[] { paramaabi }));
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      {
        ArkAppCenter.b(true);
        Object localObject = this.jdField_a_of_type_Aadp.a();
        if (localObject == null) {
          continue;
        }
  ...
  private void c(JSONObject paramJSONObject, @NonNull aabi paramaabi)
  {
    if (!this.jdField_b_of_type_Boolean)
    {
      aaep.a(this.jdField_a_of_type_Aabi, -1, "no auth");
    ...
    if (localObject == null)
    {
      aaep.a(paramaabi, -3, "other");
      return;
    }
    bcfh localbcfh = (bcfh)((WebViewFragment)localObject).a.a(4);
    if (localbcfh == null)
    {
      aaep.a(paramaabi, -3, "other");
      return;
    ...
    try
    {
      ...
      {
        aaep.a(this.jdField_b_of_type_Aabi, -2, "param error");
        return;
      }
    }
    catch (Exception paramJSONObject)
    ...
    localObject = bbgo.a(str1, str2, paramJSONObject, str4, alsz.a(), null, null);
    ...
    paramJSONObject.setClass(localbcfh.a, ForwardRecentActivity.class);
    ...
    if (paramJSONObject != null) {
      aqbe.a(localbcfh.a, paramJSONObject);
    }
    if (QLog.isColorLevel()) {
      QLog.i("ArkWebModule", 2, "buildForwardIntent: " + localObject);
    }
    bdes.a().a("", "", "", "1000", "101", "0", false);
    axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_38", "qq_ark_share", 0, 1, 0, "", "", "", "");
  ...
  private void d()
  {
    ...
    bcql.a(localActivity, ajya.a(2131700726), 0).a();
  }
  
  private void d(JSONObject paramJSONObject, @NonNull aabi paramaabi)
  {
    if (!this.jdField_b_of_type_Boolean)
    {
      aaep.a(this.jdField_a_of_type_Aabi, -1, "no auth");
    ...
    this.jdField_b_of_type_Aabi = paramaabi;
    Object localObject;
    String str1;
    String str2;
    String str3;
    ...
    for (;;)
    {
      try
      {
        localObject = this.jdField_a_of_type_Aadp.a();
        paramaabi = new Intent();
        str1 = paramJSONObject.optString("appName");
        ...
        {
          paramaabi.setClass((Context)localObject, DirectForwardActivity.class);
          paramaabi.putExtra("toUin", str2);
          paramaabi.putExtra("uinType", i);
          paramaabi.putExtra("nickName", str3);
          paramaabi.putExtra("shareQQType", paramJSONObject.optInt("shareQQType", 13));
          paramaabi.putExtra("forward_type", 27);
          paramaabi.putExtra("openerProc", MobileQQ.getMobileQQ().getQQProcessName());
          paramaabi.putExtra("k_back", paramJSONObject.optBoolean("k_back", paramJSONObject.optBoolean("back", false)));
      ...
      {
        aaep.a(this.jdField_b_of_type_Aabi, -4, "other");
        QLog.e("ArkWebModule", 1, "shareArkMsg error: " + paramJSONObject.toString());
        return;
      }
      paramaabi.putExtra("isWebCompShare", true);
      paramaabi.setClass((Context)localObject, ForwardRecentActivity.class);
    }
    String str7 = a();
    paramaabi.putExtra("forward_ark_app_name", str1);
    paramaabi.putExtra("forward_ark_app_view", str3);
    paramaabi.putExtra("forward_ark_app_desc", (String)localObject);
    paramaabi.putExtra("forward_ark_app_ver", str2);
    paramaabi.putExtra("forward_ark_app_prompt", str6);
    paramaabi.putExtra("forward_ark_app_meta", str5);
    paramaabi.putExtra("forward_ark_app_config", str4);
    paramaabi.putExtra("forward_ark_app_compat", paramJSONObject);
    paramaabi.putExtra("is_ark_display_share", true);
    paramaabi.putExtra("appName", str1);
    paramaabi.putExtra("appView", str3);
    paramaabi.putExtra("appMinVersion", str2);
    paramaabi.putExtra("metaData", str5);
    paramaabi.putExtra("scale", alsz.a());
    if (!TextUtils.isEmpty(str7)) {
      paramaabi.putExtra("forward_ark_h5_from_js", str7);
    }
    a(paramaabi, (byte)0);
  }
  
  private void e(JSONObject paramJSONObject, @NonNull aabi paramaabi)
  {
    boolean bool1 = true;
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      for (;;)
      {
        try
        {
          if (paramJSONObject.has("enable"))
          {
            ...
            paramJSONObject = this.jdField_a_of_type_Aadp.a();
            if ((paramJSONObject == null) || (!(paramJSONObject instanceof bcic))) {
              break;
            }
            paramJSONObject = (bcic)paramJSONObject;
            if (bool2) {
              break label94;
            }
        ...
        {
          aaep.a(paramaabi, -2, "param error");
          return;
        }
        bool1 = false;
      }
  ...
  private void f(JSONObject paramJSONObject, @NonNull aabi paramaabi)
  {
    boolean bool1 = true;
    if (!this.jdField_b_of_type_Boolean)
    {
  ...
  {
    super.a();
    if ((this.jdField_a_of_type_Aadp.a() instanceof ArkBrowserFragment)) {
  ...
  {
    if ((paramByte == 0) && (this.jdField_b_of_type_Aabi != null))
    {
      if (paramInt == -1) {
        aaep.a(this.jdField_b_of_type_Aabi, aabk.a);
      }
    }
    else {
      return;
    }
    aaep.a(this.jdField_b_of_type_Aabi, -3, "user cancel");
  }
  ...
  protected void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_AndroidAppDialog == null)
    {
      ...
      localTextView4.setOnClickListener(new aluq(this));
      localTextView3.setOnClickListener(new alur(this));
  ...
  public boolean a(int paramInt, String paramString, JSONObject paramJSONObject, @NonNull aabi paramaabi)
  {
    ...
    {
      return true;
      c(paramJSONObject, paramaabi);
      continue;
      d(paramJSONObject, paramaabi);
      continue;
      b(paramJSONObject, paramaabi);
      continue;
      e(paramJSONObject, paramaabi);
      continue;
      f(paramJSONObject, paramaabi);
    }
  }
}
