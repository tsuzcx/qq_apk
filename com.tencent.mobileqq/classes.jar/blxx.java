...
public class blxx
  extends Handler
{
  public blxx(CropVideoActivity paramCropVideoActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      do
      {
        ...
        if ((CropVideoActivity.a(this.a) >= CropVideoActivity.b(this.a)) && (CropVideoActivity.b(this.a) >= 0L))
        {
          ...
          QQToast.a(this.a.getApplicationContext(), alpo.a(2131703007), 1).a();
          return;
        }
      } while (CropVideoActivity.a(this.a, CropVideoActivity.a(this.a)) != 0);
      if (Build.VERSION.SDK_INT >= 18) {
        blya.a(CropVideoActivity.a(this.a), CropVideoActivity.b(this.a), CropVideoActivity.a(this.a), CropVideoActivity.b(this.a), CropVideoActivity.c(this.a), CropVideoActivity.d(this.a), CropVideoActivity.e(this.a), CropVideoActivity.f(this.a), CropVideoActivity.a(this.a), CropVideoActivity.b(this.a), new blxy(this));
      }
      for (;;)
      {
        this.a.a();
    ...
    case 4: 
      ...
      QQToast.a(this.a.getApplicationContext(), 1, alpo.a(2131703005), 1).a();
      this.a.finish();
      return;
    }
    if (QLog.isColorLevel()) {
