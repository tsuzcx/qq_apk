  ...
  extends DynamicTextItem
{
  ...
  private String jdField_a_of_type_JavaLangString = alud.a(2131706274);
  ...
  public blxx(int paramInt, List<String> paramList, Bitmap paramBitmap1, Bitmap paramBitmap2)
  {
    ...
    d();
    this.m = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(alud.a(2131706275)));
    this.n = ((int)(this.jdField_b_of_type_AndroidTextTextPaint.measureText(alud.a(2131706273)) * 10.0F));
    if (paramList == null) {}
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new blya(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    String str2 = a(paramInt, new blxy(this));
    ...
    for (;;)
    {
      ...
      break label173;
      label965:
      this.jdField_a_of_type_AndroidTextStaticLayout = blyu.a(str2, 0, str2.length(), this.jdField_b_of_type_AndroidTextTextPaint, this.n, Layout.Alignment.ALIGN_NORMAL, 1.5F, 0.0F, false, null, 0, 2);
