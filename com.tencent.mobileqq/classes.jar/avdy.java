...
public class avdy
  implements begw
{
  public avdy(SignatureHistoryFragment paramSignatureHistoryFragment, CommentItem paramCommentItem, String paramString, begr parambegr) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (!badq.d(this.jdField_a_of_type_ComTencentMobileqqRichstatusSignatureHistoryFragment.getActivity()))
      {
        bbmy.a(this.jdField_a_of_type_ComTencentMobileqqRichstatusSignatureHistoryFragment.getActivity(), 2131627672, 0).a();
      }
      else
      {
