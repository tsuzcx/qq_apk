  ...
  implements wjx
{
  ...
  public wjz(wjy paramwjy)
  {
    this.jdField_a_of_type_Wjy = paramwjy;
    this.jdField_a_of_type_Wjy.setPresenter(this);
  }
  
  private List<wkl> a(CertifiedAccountRead.StGetRecommendUserListRsp paramStGetRecommendUserListRsp)
  {
    ...
    if (paramStGetRecommendUserListRsp.expType.get() == 0)
    {
      if (paramStGetRecommendUserListRsp.vecUser.has())
      {
        ...
        while (paramStGetRecommendUserListRsp.hasNext()) {
          localArrayList.add(new wkl((CertifiedAccountMeta.StUser)paramStGetRecommendUserListRsp.next()));
        }
      }
    }
    else if ((paramStGetRecommendUserListRsp.expType.get() == 1) && (paramStGetRecommendUserListRsp.vecUserWithFeed.has()))
    {
      ...
      while (paramStGetRecommendUserListRsp.hasNext()) {
        localArrayList.add(new wkl((CertifiedAccountMeta.StFeed)paramStGetRecommendUserListRsp.next()));
      }
    }
  ...
  public void a()
  {
    ...
    VSNetworkHelper.a().a((VSBaseRequest)localObject, new wka(this, l));
  }
  ...
  public void c()
  {
    ...
    {
      this.jdField_a_of_type_Wjy.setPresenter(null);
