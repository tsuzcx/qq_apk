  ...
  extends aruz
{
  ...
  public aruy(QQAppInterface paramQQAppInterface, aruq paramaruq)
  {
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    if (((Iterator)localObject3).hasNext())
    {
      ...
      arui localarui = new arui(str, new LatLng(((RoomOperate.UserData)localObject4).lat.get(), ((RoomOperate.UserData)localObject4).lon.get()), ((RoomOperate.UserData)localObject4).direction.get());
      if (QLog.isColorLevel()) {
        if (j != 1) {
          break label651;
        }
  ...
  protected void b(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Aruq.a(new aruk(localInteger.intValue(), str), (LocationRoom.Venue)localObject, paramObject.intValue(), paramBoolean, i);
      if (paramBoolean)
      {
        if (QLog.isColorLevel()) {
          QLog.d("LocationObserver", 2, new Object[] { "[venue] onVenueOpt: invoked. success ", " uin: ", str, " uinType: ", localInteger, " optType: ", paramObject });
        }
        this.jdField_a_of_type_Aruq.a.a(localInteger.intValue(), str);
        return;
      }
  ...
  protected void c(boolean paramBoolean, Object paramObject)
  {
    ...
    paramObject = new aruk(paramObject.intValue(), str);
    this.jdField_a_of_type_Aruq.a(paramObject, ((Integer)localObject).intValue());
  }
  ...
  protected void d(boolean paramBoolean, Object paramObject)
  {
    ...
    paramObject = new aruk(paramObject.intValue(), (String)localObject);
    this.jdField_a_of_type_Aruq.b(paramObject, -1);
  }
  ...
  protected void e(boolean paramBoolean, Object paramObject)
  {
    ...
    case 2: 
    case 3: 
      arun.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject);
      return;
    }
    arun.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, i);
  }
  ...
  protected void f(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      arve.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject);
    }
    label80:
    do
    {
      ...
      if (i == 101)
      {
        arve.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, i);
        return;
      }
      if (i == 102)
      {
  ...
  protected void g(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Aruq.a.a(localInteger.intValue(), (String)localObject);
      this.jdField_a_of_type_Aruq.a.b(localInteger.intValue(), (String)localObject);
      if (QLog.isColorLevel()) {
      ...
      {
        this.jdField_a_of_type_Aruq.b(localInteger.intValue(), (String)localObject);
        axqw.b(null, "CliOper", "", "", "0X800A764", "0X800A764", 0, 0, "", "0", "0", "");
      }
      for (;;)
      {
        ...
        {
          this.jdField_a_of_type_Aruq.b(localInteger.intValue(), (String)localObject);
          if (this.jdField_a_of_type_Aruq.a()) {
            axqw.b(null, "CliOper", "", "", "0X800A76B", "0X800A76B", aruq.a(this.jdField_a_of_type_Aruq.a()), 0, "", "0", "0", "");
          }
        }
      }
    }
    ...
    aruk localaruk = new aruk(localInteger.intValue(), (String)localObject);
    this.jdField_a_of_type_Aruq.a(localaruk, true);
    this.jdField_a_of_type_Aruq.a(localaruk, j, paramObject.intValue());
    int i = 0;
    if (j == 10101) {}
    for (i = 3;; i = 2) {
      do
      {
        this.jdField_a_of_type_Aruq.a(localInteger.intValue(), (String)localObject, this.jdField_a_of_type_Aruq.a(), i);
        return;
