...
public class wsq
{
  ...
  private static void b(String paramString, Bitmap paramBitmap, ImageView paramImageView)
  {
    ...
    if (paramBitmap != null)
    {
      localBitmap = bbef.a(paramImageView.getContext(), paramBitmap, 0.25F, 20.0F);
      if (localBitmap != null)
      {
    ...
    for (Object localObject = localBitmap;; localObject = localBitmap.copy(localBitmap.getConfig(), true))
    {
      ...
      localObject = vzu.a(paramBitmap.getWidth(), paramBitmap.getHeight(), paramImageView.getWidth(), paramImageView.getHeight());
      paramBitmap = vxv.a(vxv.a(localBitmap, ((Integer)((Pair)localObject).first).intValue(), ((Integer)((Pair)localObject).second).intValue(), true), paramBitmap);
      b(paramBitmap, paramImageView);
      bbcw.a(paramString, paramBitmap);
      return;
    }
  }
}
