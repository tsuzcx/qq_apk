...
public class bajn
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageForPoke paramMessageForPoke)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = ((anmw)paramQQAppInterface.getManager(51)).b(paramString);
        if (localObject != null) {
          break;
        }
      ...
      Object localObject = String.format(Locale.getDefault(), anni.a(2131704484), new Object[] { ((Friends)localObject).getFriendNickWithAlias() });
      paramMessageForPoke = new auxc(paramString, paramQQAppInterface.c(), (String)localObject, paramInt, -5040, 655379, l);
      ...
      bcst.b(paramQQAppInterface, "dc00898", "", "", "0X8009891", "0X8009891", 0, 0, "", "", "", "");
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((paramString.length() < 5) || (bbzj.a(paramMessageRecord.msgtype)) || (acwh.j(paramMessageRecord.msgtype)) || (a(paramMessageRecord.msgtype)));
        paramQQAppInterface = (bajk)paramQQAppInterface.getManager(285);
        if (paramInt == 1)
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      localObject = (bajk)paramQQAppInterface.getManager(285);
      localFriends = localanmw.b(paramString);
    } while ((localFriends == null) || (!localFriends.isFriend()));
    if (aijp.a(paramQQAppInterface).b()) {
      if (((bajk)localObject).a(true))
      {
        if (!((bajk)localObject).c(paramString)) {
          break label227;
        }
        ((bajk)localObject).a(paramString);
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      localObject = localanmw.a(paramString, true);
      ...
      return;
      label227:
      ((bajk)localObject).a(paramString, true);
      break;
      if (QLog.isColorLevel()) {
  ...
  {
    if (((b(paramInt)) || (c(paramInt)) || (d(paramInt)) || (e(paramInt))) && (!bgjw.b(paramString)) && (!bfpx.b(paramQQAppInterface, paramString))) {}
  ...
  private static void b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        bajk localbajk = (bajk)paramQQAppInterface.getManager(285);
        if (!localbajk.a(false))
        {
          if (QLog.isColorLevel()) {
        ...
        else
        {
          ...
          else if (localbajk.f(paramString))
          {
            if (QLog.isColorLevel()) {
          ...
          {
            float f = localbajk.a();
            Object localObject2 = localanmw.a(paramString, true);
