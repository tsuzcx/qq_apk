  ...
  implements owa
{
  ...
  public static pjt a(ArticleInfo paramArticleInfo, int paramInt)
  {
    if (paramInt == 0) {
      return new pju().a();
    }
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    JSONObject localJSONObject = new osn().a(paramBaseArticleInfo).b(paramBaseArticleInfo).a(paramBaseArticleInfo, l).e(paramBaseArticleInfo).f(paramBaseArticleInfo).h(paramBaseArticleInfo).i(paramBaseArticleInfo).j(paramBaseArticleInfo).o(paramBaseArticleInfo).q(paramBaseArticleInfo).u(paramBaseArticleInfo).v(paramBaseArticleInfo).w(paramBaseArticleInfo).z(paramBaseArticleInfo).A(paramBaseArticleInfo).C(paramBaseArticleInfo).B(paramBaseArticleInfo).a("ReadInjoy_original_cell").D(paramBaseArticleInfo).H(paramBaseArticleInfo).a(paramBaseArticleInfo, ajjy.a(2131634474)).a();
    if (!nzr.a(paramBaseArticleInfo)) {
      a(paramBaseArticleInfo, ajjy.a(2131634473), localJSONObject);
    }
  ...
  public void a(int paramInt1, Container paramContainer, opw paramopw, int paramInt2)
  {
    ...
    otv localotv = new otv(this, paramopw, paramContainer);
    Object localObject2;
    if (localObject1 != null)
    {
      ...
      if (localObject2 != null)
      {
        ...
        ((ozt)localObject1).setOnClickListener(localotv);
      }
    }
    ...
    if (paramContainer != null)
    {
      ...
      paramContainer.setOnClickListener(localotv);
    }
    ...
    for (;;)
    {
      paramContainer.setPicClickListener(new otw(this, paramopw));
      break;
