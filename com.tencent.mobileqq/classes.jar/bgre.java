...
public class bgre
  extends bgrm
{
  public bgre(QzoneHuangzuanVipIconShow paramQzoneHuangzuanVipIconShow, VipResourcesListener paramVipResourcesListener, int paramInt1, bgrb parambgrb, int paramInt2, int paramInt3, boolean paramBoolean1, String paramString, int paramInt4, boolean paramBoolean2, int paramInt5) {}
  ...
  public void onDownloaded(String paramString1, int paramInt, String paramString2, Drawable paramDrawable)
  {
    ...
    for (;;)
    {
      ...
      if (paramDrawable != null)
      {
        ...
        this.jdField_a_of_type_Bgrb.a(paramDrawable);
        continue;
        if (paramDrawable != null)
        {
          ...
          this.jdField_a_of_type_Bgrb.d(paramDrawable);
          continue;
          if (paramDrawable != null)
          {
            paramDrawable.setBounds(0, 0, QzoneHuangzuanVipIconShow.access$000(QzoneHuangzuanVipIconShow.ICON_DEFAULT_SIZE, this.jdField_a_of_type_Int), QzoneHuangzuanVipIconShow.access$000(QzoneHuangzuanVipIconShow.ICON_DEFAULT_SIZE, this.jdField_a_of_type_Int));
            this.jdField_a_of_type_Bgrb.b(paramDrawable);
            continue;
            if (paramDrawable != null)
            {
              ...
              if (paramDrawable != null)
              {
                ...
                this.jdField_a_of_type_Bgrb.c(paramDrawable);
                continue;
                if (paramDrawable != null)
                {
                  ...
                  this.jdField_a_of_type_Bgrb.c(paramDrawable);
                  bgrh.b("@vipIcon", "left" + QzoneHuangzuanVipIconShow.ICON_DEFAULT_SIZE / 2 + " width = " + paramDrawable.getIntrinsicWidth() + " defualt_width =" + QzoneHuangzuanVipIconShow.ICON_DEFAULT_SIZE + " height = " + paramDrawable.getIntrinsicHeight());
                  continue;
                  if (paramDrawable != null)
                  {
                    ...
                    if (paramDrawable != null)
                    {
                      ...
                      if (paramDrawable != null)
                      {
                        ...
                        this.jdField_a_of_type_Bgrb.e(paramDrawable);
                        continue;
                        if (paramDrawable != null)
                        {
                          paramDrawable.setBounds(QzoneHuangzuanVipIconShow.access$000((QzoneHuangzuanVipIconShow.ICON_DEFAULT_SIZE - paramDrawable.getIntrinsicWidth()) / 2, this.jdField_a_of_type_Int), QzoneHuangzuanVipIconShow.access$000(QzoneHuangzuanVipIconShow.ICON_DEFAULT_SIZE - paramDrawable.getIntrinsicHeight(), this.jdField_a_of_type_Int), QzoneHuangzuanVipIconShow.access$000((QzoneHuangzuanVipIconShow.ICON_DEFAULT_SIZE + paramDrawable.getIntrinsicWidth()) / 2, this.jdField_a_of_type_Int), QzoneHuangzuanVipIconShow.access$000(QzoneHuangzuanVipIconShow.ICON_DEFAULT_SIZE, this.jdField_a_of_type_Int));
                          this.jdField_a_of_type_Bgrb.f(paramDrawable);
                          bgrh.b("@vipIcon KINGBG", "left=" + (QzoneHuangzuanVipIconShow.ICON_DEFAULT_SIZE - paramDrawable.getIntrinsicWidth()) / 2 + " width = " + paramDrawable.getIntrinsicWidth() + " defualt_width =" + QzoneHuangzuanVipIconShow.ICON_DEFAULT_SIZE + " height = " + paramDrawable.getIntrinsicHeight() + " bitmapwith =" + (int)(((BitmapDrawable)paramDrawable).getBitmap().getWidth() / 2 * bajq.a()) + "bitmapheight =" + (int)(((BitmapDrawable)paramDrawable).getBitmap().getHeight() / 2 * bajq.a()));
                          continue;
                          if (paramDrawable != null)
                          {
                            ...
                            this.jdField_a_of_type_Bgrb.g(paramDrawable);
                          }
                        }
                      }
                    }
