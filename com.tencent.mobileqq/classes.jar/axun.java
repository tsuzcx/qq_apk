...
public class axun
  extends axuw
{
  public axun(AbsShareMsg paramAbsShareMsg, QQAppInterface paramQQAppInterface, View paramView)
  {
  ...
  public boolean a(String paramString)
  {
    ...
    sgg.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.message, localIntent, paramString);
    this.jdField_a_of_type_AndroidContentContext.startActivity(localIntent);
    axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_msg_url", "aio_url_clickqq", 0, 1, 0, paramString, "", "", "");
    return true;
  }
  ...
  public boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      if (paramString2.getPackageInfo(paramString1[0], 1) != null)
      {
        ...
        try
        {
          paramString3 = (akgr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(23);
