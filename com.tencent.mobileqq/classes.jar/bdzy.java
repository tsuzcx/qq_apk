...
public class bdzy
{
  private static bdzy jdField_a_of_type_Bdzy;
  ...
  static String g = alud.a(2131700528);
  static String h = alud.a(2131700526);
  static String i = alud.a(2131700527);
  static String j = alud.a(2131700525);
  public int a;
  public long a;
  ...
  public static bdzy a()
  {
    if (jdField_a_of_type_Bdzy == null) {}
    try
    {
      if (jdField_a_of_type_Bdzy == null) {
        jdField_a_of_type_Bdzy = new bdzy();
      }
      return jdField_a_of_type_Bdzy;
    }
    finally {}
  }
  ...
  public void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    bdhb.a(paramContext.getFilesDir() + File.separator + "vipKerwordJson", paramString1);
  }
  ...
  void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      paramInt1 = ayxz.jdField_a_of_type_Int;
      ayxz.jdField_a_of_type_Int = paramInt1 + 1;
      ...
      localMessageRecord.msgUid = arrr.b();
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord == null) {
        break label249;
      }
    }
    ...
    label230:
    label249:
    for (long l1 = this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time;; l1 = ayzl.a())
    {
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    ...
    if (localObject1 != null) {
      apvt.a(((JSONObject)localObject1).optLong("interval", 86400L));
    }
    ...
    {
      arws.jdField_a_of_type_Boolean = bool1;
      QLog.i("AioVipKeywordHelper", 1, "lottieConfig.switch is " + bool1);
      localObject1 = paramAppRuntime.optJSONObject("ipProductGrayTips");
      if (localObject1 != null)
      {
        aufm.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("leftText", aufm.jdField_a_of_type_JavaLangString);
        aufm.jdField_b_of_type_JavaLangString = ((JSONObject)localObject1).optString("linkText", aufm.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
      ...
      if (localObject1 != null)
      {
        bdfp.jdField_a_of_type_Int = ((JSONObject)localObject1).optInt("interval", 5000);
        QLog.d("AioVipKeywordHelper", 1, "getStrangerInterval is " + bdfp.jdField_a_of_type_Int);
      }
      localObject1 = paramAppRuntime.optJSONObject("downloadTimeoutConfig");
      if (localObject1 != null)
      {
        apro.jdField_b_of_type_Int = ((JSONObject)localObject1).optInt("emotion", apro.jdField_b_of_type_Int);
        bool1 = bool2;
        if (((JSONObject)localObject1).optInt("emoTryReadNoLen", 0) == 1) {
          bool1 = true;
        }
        apro.jdField_b_of_type_Boolean = bool1;
      ...
      if (localObject1 != null) {
        bdvn.a().a((JSONArray)localObject1);
      }
      aptb.a(paramAppRuntime.optJSONArray("h5MagicTips"));
      return;
    }
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((azmk.b()) || (this.jdField_d_of_type_Int == 0));
      l1 = 86400L;
      int i1;
      switch (paramSessionInfo.jdField_a_of_type_Int)
      {
