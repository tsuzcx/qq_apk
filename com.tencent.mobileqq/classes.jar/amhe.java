  ...
  extends aksu
{
  ...
  public amhe(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public ColorNote a(String paramString1, String paramString2, String paramString3, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((Modifier.isStatic(((Field)localObject).getModifiers())) || (((Field)localObject).isAnnotationPresent(aulz.class))) {
          break label381;
        }
  ...
  public ArrayList<ColorNote> a(String paramString, aktd paramaktd)
  {
    return a(paramString, paramaktd, 0);
  }
  
  public ArrayList<ColorNote> a(String paramString, aktd paramaktd, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    synchronized (jdField_a_of_type_JavaLangObject)
    {
    ...
    while (((Iterator)???).hasNext()) {
      c(paramString, (ColorNote)((Iterator)???).next(), paramaktd);
    }
    return localArrayList;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localColorNote.getServiceType() == 16973824) {
          if ((localArrayList.size() > 0) && (amhh.b((ColorNote)localArrayList.get(0)))) {
  ...
  protected void a()
  {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      ...
      amkf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), false, false);
    }
    localObject = amgl.a();
    if ((localObject != null) && (((amgk)localObject).a() != -1))
    {
      jdField_a_of_type_Int = ((amgk)localObject).a();
      if (QLog.isColorLevel()) {
  ...
  protected void a(String paramString, ColorNote paramColorNote, aktd paramaktd)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(paramString, 0, paramColorNote.getTableName(), paramColorNote, 0, paramaktd);
  }
  
  public void a(String paramString, ColorNote paramColorNote, aktd paramaktd, boolean paramBoolean)
  {
    if ((!a(paramColorNote)) && (amkf.a())) {
      if (paramColorNote.getServiceType() == 16973824) {
        axqy.b(null, "dc00898", "", "", "0X800A746", "0X800A746", 0, 0, "", "", "", "");
      }
    }
    while (!QLog.isColorLevel()) {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        if (amhh.b(paramColorNote))
        {
          ...
          if (paramColorNote.getServiceType() != 16973824) {
            b(paramString, paramColorNote, paramaktd, paramBoolean);
          }
          return;
        }
    ...
    QLog.e("ColorNoteProxy", 2, "addColorNote error! isAfterSyncMsg = " + amkf.a());
  }
  ...
  protected void b(String paramString, ColorNote paramColorNote, aktd paramaktd)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(paramString, 0, paramColorNote.getTableName(), paramColorNote, 0, paramaktd);
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.d();
  }
  
  protected void b(String paramString, ColorNote paramColorNote, aktd paramaktd, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      b(paramString, paramColorNote, paramaktd);
      return;
    }
    a(paramString, paramColorNote, paramaktd);
  }
  
  public void c(String paramString, ColorNote paramColorNote, aktd paramaktd)
  {
    if (paramColorNote != null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_JavaUtilList.remove(paramColorNote);
      a(paramString, 0, paramColorNote.getTableName(), "mUniKey=?", new String[] { String.valueOf(paramColorNote.getUniKey()) }, paramaktd);
      if (paramColorNote.mExtra == 0)
      {
        ??? = paramColorNote.getServiceType() + paramColorNote.getSubType();
        a(paramString, 0, paramColorNote.getTableName(), "mUniKey=?", new String[] { ??? }, paramaktd);
      }
      return;
    }
  }
