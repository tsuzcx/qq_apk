...
public class ogs
{
  ...
  private final View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ogt(this);
  private View jdField_a_of_type_AndroidViewView;
  private ViewGroup jdField_a_of_type_AndroidViewViewGroup;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private final apck jdField_a_of_type_Apck = new ogz(this, "readinjoy_weather");
  ...
  private final pfh jdField_a_of_type_Pfh = new oha(this);
  private int jdField_b_of_type_Int = -1;
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new ogv(this);
  private final View.OnClickListener c = new ogw(this);
  private final View.OnClickListener d = new ogx(this);
  private View.OnClickListener e;
  
  public ogs(@NonNull VafContext paramVafContext)
  {
  ...
  private static Container a(VafContext paramVafContext, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = suz.a("daily_dynamic_header", true);
        if (localObject != null)
        {
          paramJSONObject = ((suz)localObject).getTemplateBean(paramJSONObject);
          if (paramJSONObject != null)
          {
            paramVafContext = paramVafContext.getViewFactory().inflate(paramVafContext, paramJSONObject);
            oyj.a(paramVafContext, null, paramJSONObject);
  ...
  private Container a(JSONObject paramJSONObject, View.OnClickListener paramOnClickListener)
  {
    if ((this.jdField_b_of_type_Int == -1) || (this.jdField_b_of_type_Int == 0))
    {
      ...
      {
        Drawable localDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130843155);
    ...
    for (;;)
    {
      ...
      if (paramJSONObject != null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843155);
  ...
  private static URLDrawable.URLDrawableOptions a(Context paramContext)
  {
    ...
    paramContext = paramContext.getResources().getDrawable(2130843155);
  ...
  private void a(int paramInt)
  {
    ...
    bnrf.a("sp_key_daily_dynamic_header_state", Integer.valueOf(this.jdField_a_of_type_Int));
  ...
  private void a(@NonNull View paramView, @NonNull Container paramContainer, @NonNull Drawable paramDrawable, JSONObject paramJSONObject)
  {
    ...
    ((DailyTitleBar)paramView.findViewById(2131371909)).setVisibility(8);
    DailyTitleBarSwitcher localDailyTitleBarSwitcher = (DailyTitleBarSwitcher)paramView.findViewById(2131365257);
    ...
    ReadInJoyDailyPullToZoomHeaderXListView localReadInJoyDailyPullToZoomHeaderXListView = (ReadInJoyDailyPullToZoomHeaderXListView)paramView.findViewById(2131378246);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(paramView.getContext()).inflate(2131560149, localReadInJoyDailyPullToZoomHeaderXListView, false));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363247));
    ogq.a(paramDrawable);
    ogq.a(this.jdField_a_of_type_AndroidWidgetImageView);
  ...
  private static void a(Container paramContainer, String paramString, JSONObject paramJSONObject)
  {
    ...
    ViewFactory.findClickableViewListener(paramContainer.getVirtualView(), new ohc(paramString, paramJSONObject));
  }
  ...
  private void a(@NonNull BaseActivity paramBaseActivity, @NonNull Runnable paramRunnable)
  {
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      {
        paramBaseActivity.requestPermissions(new ohb(this, paramRunnable), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
      paramRunnable.run();
      return;
  ...
  private void a(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2131166863);
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher == null) {
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher = ((DailyTitleBarSwitcher)this.jdField_a_of_type_AndroidViewView.findViewById(2131365257));
      }
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher.setOnTitleClickWeatherListener(new ogu(this, paramJSONObject));
      return;
    }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    long l1 = ((Long)bnrf.a("sp_key_daily_dynamic_header_last_refresh_time", Long.valueOf(0L))).longValue();
  ...
  private static boolean a(Container paramContainer, JSONObject paramJSONObject)
  {
    ...
    if ((localObject instanceof TemplateBean))
    {
      ...
      try
      {
        suz localsuz = suz.a("daily_dynamic_header", true);
        if (localsuz != null) {}
        for (paramJSONObject = localsuz.getTemplateBean(paramJSONObject); (paramJSONObject != null) && (TextUtils.equals(paramJSONObject.getStyleName(), ((TemplateBean)localObject).getStyleName())) && (((TemplateBean)localObject).getId() == paramJSONObject.getId()); paramJSONObject = null)
        {
          QLog.i("DailyHeaderViewController", 1, "[bindDataForProteusHeader] template match, bind data");
          oyj.a(paramContainer, (TemplateBean)localObject, paramJSONObject);
          return true;
        }
        return false;
      }
  ...
  private void b()
  {
    ...
    DailyTitleBar localDailyTitleBar = (DailyTitleBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131371909);
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131365257).setVisibility(8);
    if (this.jdField_a_of_type_AndroidViewViewGroup != null)
    {
      ((ReadInJoyDailyPullToZoomHeaderXListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378246)).removeHeaderView(this.jdField_a_of_type_AndroidViewViewGroup);
  ...
  private void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localJSONObject.putOpt("error_reason", anzj.a(2131701609)).putOpt("operation_text", anzj.a(2131701614));
      View.OnClickListener localOnClickListener = this.c;
      for (;;)
      {
        a(localJSONObject, localOnClickListener);
        return;
        localJSONObject.putOpt("error_reason", anzj.a(2131701615)).putOpt("operation_text", anzj.a(2131701612));
        localOnClickListener = this.d;
        continue;
        localJSONObject.putOpt("error_reason", anzj.a(2131701616)).putOpt("operation_text", anzj.a(2131701613));
  ...
  private void b(View paramView)
  {
    ...
    a(((Integer)bnrf.a("sp_key_daily_dynamic_header_state", Integer.valueOf(0))).intValue());
  }
  ...
  private static void b(String paramString, JSONObject paramJSONObject)
  {
    ...
    localpaa.b("model_type", a(paramString));
    localpaa.b("topic_id", paramJSONObject.optString("topic_id", ""));
    ocd.a(null, "CliOper", "", "", "0X8009D12", "0X8009D12", 0, 0, "", "", "", localpaa.a(), false);
  }
  ...
  private void c()
  {
    JSONObject localJSONObject = pfa.a().a();
    Object localObject;
    ...
    if (localContainer != null)
    {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          Drawable localDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2131166863);
        }
      }
    }
    a(0);
  ...
  private static void c(String paramString, JSONObject paramJSONObject)
  {
    ...
    localpaa.b("model_type", a(paramString));
    localpaa.b("topic_id", paramJSONObject.optString("topic_id", ""));
    ocd.a(null, "CliOper", "", "", "0X8009D13", "0X8009D13", 0, 0, "", "", "", localpaa.a(), false);
  }
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      ((JSONObject)localObject).putOpt("error_reason", anzj.a(2131701607));
      for (;;)
      {
        ((JSONObject)localObject).putOpt("operation_text", anzj.a(2131701608));
        break;
        ((JSONObject)localObject).putOpt("error_reason", anzj.a(2131701611));
        continue;
        ((JSONObject)localObject).putOpt("error_reason", anzj.a(2131701610));
      }
    }
  }
