  ...
  implements atsx
{
  ...
  protected atsj(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, bfol parambfol)
  {
    super(paramLong, paramItem, paramBundle, parambfol);
  }
  
  public static bfoo a(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, bfol parambfol)
  {
    if (paramLong == 0L)
    {
      bfmf.a("ExcitingTransfer.TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "getWoker. troopuin=0");
      return null;
    }
    if (paramItem == null)
    {
      bfmf.a("ExcitingTransfer.TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "getWoker. item=null");
      return null;
    }
    if (paramItem.Id == null) {
      bfmf.a("ExcitingTransfer.TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "getWoker. item.id=null");
    }
    return new atsj(paramLong, paramItem, paramBundle, parambfol);
  }
  ...
  private ExcitingTransferUploadResultRp a()
  {
    ...
    if (this.jdField_a_of_type_Bfnz != null)
    {
      ...
      if ((this.jdField_a_of_type_Bfnz instanceof atsu)) {
        localObject1 = ((atsu)this.jdField_a_of_type_Bfnz).a();
      }
    }
    return localObject1;
  }
  ...
  private void c(int paramInt)
  {
    ...
    atsi localatsi = new atsi(bfmd.a());
    localatsi.c(paramInt);
    int i = f();
    if (localObject != null) {
      if (((ExcitingTransferUploadResultRp)localObject).m_nResult == 0L)
      {
        localatsi.a((ExcitingTransferUploadResultRp)localObject);
        paramInt = aufd.b(((ExcitingTransferUploadResultRp)localObject).m_strServerIp);
        localatsi.c(this.jdField_a_of_type_Long);
        localObject = auea.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
        localatsi.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, (String)localObject, this.jdField_c_of_type_Long);
        localatsi.c(this.jdField_a_of_type_Bflq.jdField_a_of_type_Boolean);
        long l = System.currentTimeMillis() - this.jdField_a_of_type_Bflq.jdField_d_of_type_Long;
        if (l <= 0L) {
          break label380;
        }
        localatsi.b(l);
        label152:
        l = this.jdField_a_of_type_Bflq.g;
        if (l <= 0L) {
          break label389;
        }
        localatsi.a(l);
    ...
    {
      localatsi.a(i);
      localatsi.b(paramInt);
      localatsi.d(this.jdField_b_of_type_Boolean);
      localatsi.a(bool);
      return;
      bool = false;
      break;
      ...
      if (paramInt == 0)
      {
        ...
        if (this.jdField_a_of_type_Bflq.jdField_a_of_type_Long > 0L) {
          ((ExcitingTransferUploadResultRp)localObject).m_u64StartSize = this.jdField_a_of_type_Bflq.jdField_a_of_type_Long;
        }
        if (this.jdField_a_of_type_Bflq.jdField_b_of_type_Long > 0L) {
          ((ExcitingTransferUploadResultRp)localObject).m_u64TransferSize = this.jdField_a_of_type_Bflq.jdField_b_of_type_Long;
        }
  ...
  private int f()
  {
    if ((this.jdField_a_of_type_Bfnz != null) && ((this.jdField_a_of_type_Bfnz instanceof atsu))) {
      return ((atsu)this.jdField_a_of_type_Bfnz).g();
    }
    return 0;
  }
  ...
  private void s()
  {
    ...
    localatsi.c(33);
    localatsi.c(this.jdField_a_of_type_Long);
    Object localObject = auea.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
    localatsi.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, (String)localObject, this.jdField_c_of_type_Long);
    localatsi.c(false);
    long l = System.currentTimeMillis() - this.jdField_a_of_type_Bflq.jdField_d_of_type_Long;
    label119:
  ...
  protected bfnz a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    ...
    paramString = new atsw(localArrayList1, localArrayList2, paramBoolean2, paramString, null);
    paramQQAppInterface = atsu.a(paramQQAppInterface, paramLong, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, localatsv, paramString);
    if (paramQQAppInterface != null)
    {
      ((atsu)paramQQAppInterface).a(this);
  ...
  public void a(int paramInt, ExcitingTransferUploaderRp paramExcitingTransferUploaderRp)
  {
    ...
    if (paramInt != 0)
    {
      this.jdField_a_of_type_Bflq.e = 0;
      ...
      localatsk = new atsk(bfmd.a());
      localatsk.c(this.jdField_a_of_type_Long);
      String str = auea.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
      localatsk.c(paramInt);
      localatsk.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, str, this.jdField_c_of_type_Long);
      localatsk.a(paramExcitingTransferUploaderRp);
      localatsk.a(f());
      localatsk.b(aufd.b(paramExcitingTransferUploaderRp.m_strServerIp));
      localatsk.c(this.jdField_b_of_type_Boolean);
      if (paramInt != 0) {
        break label206;
      }
    }
  ...
  protected void c()
  {
    ...
    if (b())
    {
      if ((this.jdField_a_of_type_Bflq.jdField_c_of_type_Int == 8) || (this.jdField_a_of_type_Bflq.jdField_c_of_type_Int == 11) || (this.jdField_a_of_type_Bflq.jdField_c_of_type_Int == 12)) {
        s();
      }
    }
    else {
    ...
    for (;;)
    {
      c(j);
      return;
      j = this.jdField_a_of_type_Bflq.jdField_d_of_type_Int;
      int i = j;
      if (j == 0) {
        i = this.jdField_a_of_type_Bflq.jdField_c_of_type_Int;
      }
      j = i;
      if (this.g != 0L) {
        j = d(i);
