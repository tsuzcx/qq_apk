...
public class aeit
  extends alox
{
  public aeit(ActivateFriendView paramActivateFriendView) {}
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (i < ActivateFriendView.a(this.a).size())
      {
        ...
        {
          paramString = bdbt.b(ActivateFriendView.a(this.a), str, false);
  ...
  protected void onUpdateFriendList(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      String str = bdbt.j(ActivateFriendView.a(this.a), String.valueOf(((ActivateFriendItem)ActivateFriendView.a(this.a).get(i)).uin));
