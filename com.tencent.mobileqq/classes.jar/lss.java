...
public class lss
{
  ...
  private lsh jdField_a_of_type_Lsh;
  private lst jdField_a_of_type_Lst;
  ...
  public void b()
  {
    ...
    synchronized (this.jdField_a_of_type_Lsh.a())
    {
      this.jdField_a_of_type_Lsh.a().remove(this);
      if (this.jdField_a_of_type_Lst != null)
      {
        this.jdField_a_of_type_Lst.a();
