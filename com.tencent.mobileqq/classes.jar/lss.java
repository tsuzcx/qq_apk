  ...
  extends lsr
{
  ...
  private final lst jdField_a_of_type_Lst;
  private PointF b;
  private PointF c;
  private PointF d = new PointF();
  private PointF e = new PointF();
  
  public lss(Context paramContext, lst paramlst)
  {
    super(paramContext);
    this.jdField_a_of_type_Lst = paramlst;
  }
  ...
  protected void a(int paramInt, MotionEvent paramMotionEvent)
  {
    ...
    this.jdField_a_of_type_Boolean = this.jdField_a_of_type_Lst.b(this);
  }
  ...
  protected void b(int paramInt, MotionEvent paramMotionEvent)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Lst.a(this);
      a();
      return;
      a(paramMotionEvent);
    } while ((this.jdField_a_of_type_Float / this.jdField_b_of_type_Float <= 0.67F) || (!this.jdField_a_of_type_Lst.a(this)) || (this.jdField_a_of_type_AndroidViewMotionEvent == null));
