...
public class swl
{
  private static Bundle a(sdg paramsdg, BaseArticleInfo paramBaseArticleInfo)
  {
  ...
  public static String a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    pay.a(paramString1, paramString3, paramString2, paramString4, new swm());
    return str;
  }
  ...
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo)
  {
    ...
    for (String str = null;; str = paramArticleInfo.mVideoCoverUrl.getFile())
    {
      ...
      a(paramActivity, localsdg, paramArticleInfo);
      return;
    }
  }
  
  public static void a(Activity paramActivity, sdg paramsdg, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      sgi.a(paramActivity, paramsdg, i);
  ...
  public static void a(JSONObject paramJSONObject, Activity paramActivity, ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo)
  {
    try
    {
      ...
      localArticleInfo.mVideoCoverUrl = pay.a(paramJSONObject);
      ...
      {
        paramJSONObject = pay.a(paramActivity, paramArticleInfo, 0, paramJSONObject);
        paramJSONObject.put("vedio_rowkey", str);
        swy.a(paramArticleInfo, "0X800898F", paramJSONObject.toString());
