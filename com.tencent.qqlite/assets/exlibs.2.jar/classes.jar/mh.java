...
{
  public mh(EnterpriseDetailActivity paramEnterpriseDetailActivity, mobileqq_mp.ConfigInfo paramConfigInfo, Switch paramSwitch, View paramView) {}
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqMpMobileqq_mp$ConfigInfo.confirm_flag.get() == 1)
    {
      ...
      str = this.jdField_a_of_type_ComTencentBizEqqEnterpriseDetailActivity.getString(2131362463);
    ...
    label396:
    label398:
    for (paramCompoundButton = this.jdField_a_of_type_ComTencentBizEqqEnterpriseDetailActivity.getString(2131363615);; paramCompoundButton = this.jdField_a_of_type_ComTencentBizEqqEnterpriseDetailActivity.getString(2131363616))
    {
