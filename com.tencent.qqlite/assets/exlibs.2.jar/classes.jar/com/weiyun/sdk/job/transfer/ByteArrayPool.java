...
public class ByteArrayPool
{
  ...
  public ByteArrayBuffer createBuffer()
  {
    ...
    for (;;)
    {
      ...
      ByteArrayBuffer localByteArrayBuffer = (ByteArrayBuffer)((SoftReference)this.list.remove(i - 1)).get();
      if (localByteArrayBuffer == null) {
        i -= 1;
      }
    }
  ...
  public void freeBuffer(ByteArrayBuffer paramByteArrayBuffer, boolean paramBoolean)
  {
    ...
    //   14: ldc 17
    //   16: ldc 107
    //   18: invokestatic 97	com/weiyun/sdk/log/Log:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   21: aload_0
    //   22: monitorexit
    //   23: return
    //   24: aload_0
    //   25: getfield 40	com/weiyun/sdk/job/transfer/ByteArrayPool:list	Ljava/util/ArrayList;
    //   28: new 62	java/lang/ref/SoftReference
    //   31: dup
    //   32: aload_1
    //   33: invokespecial 110	java/lang/ref/SoftReference:<init>	(Ljava/lang/Object;)V
    //   36: invokevirtual 114	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   39: pop
    //   40: goto -19 -> 21
    //   43: astore_1
    //   44: aload_0
