  ...
  extends DownloadAddressFetcher
{
  ...
  protected int sendRequest()
  {
    ...
    if (SdkContext.getInstance().getSender().sendRequest("OfflineFilleHandleSvr.pb_weiyun_CMD_REQ_DOWN_LOAD_FILE-6", localReqBody.toByteArray(), new DownloadFileRequestCallback())) {
      return 0;
    }
    return -10011;
  }
