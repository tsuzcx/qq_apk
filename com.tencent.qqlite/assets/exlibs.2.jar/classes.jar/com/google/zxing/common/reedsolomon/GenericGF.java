...
public final class GenericGF
{
  ...
  private ea jdField_a_of_type_Ea;
  private boolean jdField_a_of_type_Boolean = false;
  private int[] jdField_a_of_type_ArrayOfInt;
  private final int jdField_b_of_type_Int;
  private ea jdField_b_of_type_Ea;
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_Ea = new ea(this, new int[] { 0 });
    this.jdField_b_of_type_Ea = new ea(this, new int[] { 1 });
  ...
  {
    b();
    return this.jdField_a_of_type_Ea;
  }
  ...
  {
    b();
    return this.jdField_b_of_type_Ea;
  }
