...
public final class Encoder
{
  ...
  private static int a(BitArray paramBitArray, ErrorCorrectionLevel paramErrorCorrectionLevel, Version paramVersion, ByteMatrix paramByteMatrix)
  {
    ...
    if (i < 8)
    {
      ee.a(paramBitArray, paramErrorCorrectionLevel, paramVersion, i, paramByteMatrix);
  ...
  {
    return ed.a(paramByteMatrix) + ed.b(paramByteMatrix) + ed.c(paramByteMatrix) + ed.d(paramByteMatrix);
  }
  ...
  public static int a(String paramString, ErrorCorrectionLevel paramErrorCorrectionLevel, Map paramMap)
  {
    ...
    for (paramMap = null;; paramMap = (String)paramMap.get(EncodeHintType.CHARACTER_SET))
    {
      ...
      return a(localBitArray.a() + paramMap.getCharacterCountBits(Version.a(40)) + ((BitArray)localObject2).a(), paramErrorCorrectionLevel).a();
    }
  }
  ...
  static BitArray a(BitArray paramBitArray, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (int j = 0; k < paramInt3; j = n + j)
    {
      ...
      localArrayList.add(new eb(arrayOfByte, (byte[])localObject2));
      m = Math.max(m, n);
    ...
    while (paramInt2 < m)
    {
      ...
      {
        arrayOfByte = ((eb)((Iterator)localObject1).next()).a();
        if (paramInt2 < arrayOfByte.length) {
          paramBitArray.b(arrayOfByte[paramInt2], 8);
        }
      }
      paramInt2 += 1;
    }
    ...
    while (paramInt2 < i)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        arrayOfByte = ((eb)((Iterator)localObject1).next()).b();
        if (paramInt2 < arrayOfByte.length) {
          paramBitArray.b(arrayOfByte[paramInt2], 8);
        }
      }
  ...
  public static QRCode a(String paramString, ErrorCorrectionLevel paramErrorCorrectionLevel, Map paramMap)
  {
    ...
    for (int i = ((BitArray)localObject3).b();; i = paramString.length())
    {
      ...
      ee.a(paramString, paramErrorCorrectionLevel, paramMap, i, (ByteMatrix)localObject1);
  ...
  {
    paramBitArray.b(Mode.ECI.getBits(), 4);
    paramBitArray.b(paramCharacterSetECI.getValue(), 8);
  }
  
  static void a(Mode paramMode, BitArray paramBitArray)
  {
    paramBitArray.b(paramMode.getBits(), 4);
  }
  ...
  static void a(CharSequence paramCharSequence, BitArray paramBitArray)
  {
    ...
    while (i < j)
    {
      ...
      if (i + 2 < j)
      {
        paramBitArray.b(k * 100 + (paramCharSequence.charAt(i + 1) - '0') * 10 + (paramCharSequence.charAt(i + 2) - '0'), 10);
        i += 3;
      }
      else if (i + 1 < j)
      {
        paramBitArray.b(k * 10 + (paramCharSequence.charAt(i + 1) - '0'), 7);
        i += 2;
      }
      else
      {
  ...
  static void a(String paramString, BitArray paramBitArray)
  {
    for (;;)
    {
      ...
      if ((i >= 57408) && (i <= 60351))
      {
        ...
        continue;
        label109:
        paramBitArray.b((i & 0xFF) + (i >> 8) * 192, 13);
        j += 2;
      }
      else
      {
  ...
  static void a(String paramString1, BitArray paramBitArray, String paramString2)
  {
    try
    {
      ...
      while (i < j)
      {
        paramBitArray.b(paramString1[i], 8);
        i += 1;
      }
      return;
    }
