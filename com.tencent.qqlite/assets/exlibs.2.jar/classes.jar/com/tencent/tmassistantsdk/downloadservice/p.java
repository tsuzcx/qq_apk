  ...
  extends e
{
  ...
  {
    k.b("TMAssistantDownloadSDKService", "startDownloadTask，clientkey:" + paramString1 + ",url:" + paramString2 + ",manager:" + this.a.c + ",fileName:" + paramString4);
    if (this.a.c != null)
    {
  ...
  {
    k.b("TMAssistantDownloadSDKService", "getDownloadTaskInfo");
    if (this.a.c != null) {
  ...
  {
    k.b("TMAssistantDownloadSDKService", "registerDownloadTaskCallback,clientKey:" + paramString);
  ...
  {
    k.b("TMAssistantDownloadSDKService", "unregisterDownloadTaskCallback,clientKey:" + paramString);
    if ((paramString != null) && (parama != null)) {
  ...
  {
    k.b("TMAssistantDownloadSDKService", "pauseDownloadTask");
    try
    {
      if (this.a.c != null) {
        this.a.c.a(paramString1, paramString2);
      }
      k.b("TMAssistantDownloadSDKService", "pauseDownloadTask end");
      return;
    }
