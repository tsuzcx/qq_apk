...
public class a
{
      ...
      try
      {
        ...
        if (localResponse.head.ret == 0)
        {
          if ((localResponse.head.encryptWithPack & 0x2) == 2)
          {
            ...
            localResponse.body = new e().a(paramArrayOfByte, arrayOfByte);
          }
  ...
  {
    // Byte code:
    //   0: new 228	java/io/ByteArrayOutputStream
    //   3: dup
    //   4: invokespecial 229	java/io/ByteArrayOutputStream:<init>	()V
    //   7: astore_1
    //   8: new 231	java/io/DataOutputStream
    //   11: dup
    //   12: aload_1
    //   13: invokespecial 234	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   16: astore 4
    //   18: aload 4
    //   20: astore_3
    //   21: aload_1
    ...
    //   67: aload 5
    //   69: arraylength
    //   70: invokevirtual 253	java/io/DataOutputStream:writeInt	(I)V
    //   73: aload 4
    //   75: astore_3
    //   76: aload_1
    //   77: astore_2
    //   78: aload 4
    //   80: aload 5
    //   82: invokevirtual 256	java/io/DataOutputStream:write	([B)V
    //   85: goto -55 -> 30
    //   88: astore_2
    //   89: aload 4
    //   91: astore_0
    ...
    //   98: astore_2
    //   99: aload 4
    //   101: invokevirtual 127	java/lang/Exception:printStackTrace	()V
    //   104: aload_1
    //   105: ifnull +7 -> 112
    //   108: aload_1
    //   109: invokevirtual 259	java/io/ByteArrayOutputStream:close	()V
    //   112: aload_0
    //   113: ifnull +7 -> 120
    //   116: aload_0
    //   117: invokevirtual 260	java/io/DataOutputStream:close	()V
    //   120: aconst_null
    //   121: astore_1
    //   122: aload_1
    //   123: areturn
    ...
    //   128: astore_2
    //   129: aload_1
    //   130: invokevirtual 263	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   133: astore_0
    //   134: aload_1
    //   135: ifnull +7 -> 142
    //   138: aload_1
    //   139: invokevirtual 259	java/io/ByteArrayOutputStream:close	()V
    //   142: aload_0
    //   143: astore_1
    //   144: aload 4
    //   146: ifnull -24 -> 122
    //   149: aload 4
    //   151: invokevirtual 260	java/io/DataOutputStream:close	()V
    //   154: aload_0
    //   155: areturn
    //   156: astore_1
    //   157: aload_1
    //   158: invokevirtual 264	java/io/IOException:printStackTrace	()V
    //   161: aload_0
    //   162: areturn
    //   163: astore_0
    //   164: aconst_null
    ...
    //   169: ifnull +7 -> 176
    //   172: aload_1
    //   173: invokevirtual 259	java/io/ByteArrayOutputStream:close	()V
    //   176: aload_3
    //   177: ifnull +7 -> 184
    //   180: aload_3
    //   181: invokevirtual 260	java/io/DataOutputStream:close	()V
    //   184: aload_0
    //   185: athrow
    //   186: astore_1
    //   187: aload_1
    //   188: invokevirtual 264	java/io/IOException:printStackTrace	()V
    //   191: goto -15 -> 176
    //   194: astore_1
    //   195: aload_1
    //   196: invokevirtual 264	java/io/IOException:printStackTrace	()V
    //   199: goto -15 -> 184
    //   202: astore_1
    //   203: aload_1
    //   204: invokevirtual 264	java/io/IOException:printStackTrace	()V
    //   207: goto -95 -> 112
    //   210: astore_0
    //   211: aload_0
    //   212: invokevirtual 264	java/io/IOException:printStackTrace	()V
    //   215: goto -95 -> 120
    //   218: astore_1
    //   219: aload_1
    //   220: invokevirtual 264	java/io/IOException:printStackTrace	()V
    //   223: goto -81 -> 142
    //   226: astore_0
    //   227: aconst_null
    //   228: astore_3
  ...
  {
    // Byte code:
    //   0: new 293	java/util/zip/Deflater
    //   3: dup
    //   4: invokespecial 294	java/util/zip/Deflater:<init>	()V
    //   7: astore_2
    //   8: new 228	java/io/ByteArrayOutputStream
    //   11: dup
    //   12: aload_0
    //   13: arraylength
    //   14: invokespecial 296	java/io/ByteArrayOutputStream:<init>	(I)V
    //   17: astore_1
    //   18: aload_2
    //   19: bipush 9
    //   21: invokevirtual 299	java/util/zip/Deflater:setLevel	(I)V
    //   24: aload_2
    //   25: aload_0
    //   26: invokevirtual 302	java/util/zip/Deflater:setInput	([B)V
    //   29: aload_2
    //   30: invokevirtual 305	java/util/zip/Deflater:finish	()V
    //   33: sipush 1024
    //   36: newarray byte
    //   38: astore_0
    //   39: aload_2
    //   40: invokevirtual 308	java/util/zip/Deflater:finished	()Z
    //   43: ifne +32 -> 75
    //   46: aload_1
    //   47: aload_0
    //   48: iconst_0
    //   49: aload_2
    //   50: aload_0
    //   51: invokevirtual 312	java/util/zip/Deflater:deflate	([B)I
    //   54: invokevirtual 315	java/io/ByteArrayOutputStream:write	([BII)V
    //   57: goto -18 -> 39
    //   60: astore_0
    //   61: aload_2
    //   62: invokevirtual 318	java/util/zip/Deflater:end	()V
    //   65: aload_1
    //   66: ifnull +7 -> 73
    //   69: aload_1
    //   70: invokevirtual 259	java/io/ByteArrayOutputStream:close	()V
    //   73: aload_0
    //   74: athrow
    //   75: aload_2
    //   76: invokevirtual 318	java/util/zip/Deflater:end	()V
    //   79: aload_1
    //   80: ifnull +7 -> 87
    //   83: aload_1
    //   84: invokevirtual 259	java/io/ByteArrayOutputStream:close	()V
    //   87: aload_1
    //   88: invokevirtual 263	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   91: areturn
    //   92: astore_1
    //   93: aload_1
    //   94: invokevirtual 264	java/io/IOException:printStackTrace	()V
    //   97: goto -24 -> 73
    //   100: astore_0
    //   101: aload_0
    //   102: invokevirtual 264	java/io/IOException:printStackTrace	()V
    //   105: goto -18 -> 87
    //   108: astore_0
    //   109: aconst_null
    //   110: astore_1
  ...
  {
    // Byte code:
    //   0: new 359	java/util/zip/Inflater
    //   3: dup
    //   4: invokespecial 360	java/util/zip/Inflater:<init>	()V
    //   7: astore 4
    //   9: aconst_null
    //   10: astore_2
    //   11: new 228	java/io/ByteArrayOutputStream
    //   14: dup
    //   15: aload_0
    //   16: arraylength
    //   17: invokespecial 296	java/io/ByteArrayOutputStream:<init>	(I)V
    //   20: astore_1
    //   21: aload_1
    //   22: astore_2
    //   23: sipush 1024
    ...
    //   31: aload 4
    //   33: aload_0
    //   34: invokevirtual 361	java/util/zip/Inflater:setInput	([B)V
    //   37: aload_1
    //   38: astore_2
    //   39: aload 4
    //   41: invokevirtual 362	java/util/zip/Inflater:finished	()Z
    //   44: ifne +77 -> 121
    //   47: aload_1
    //   48: astore_2
    //   49: aload_1
    ...
    //   52: aload 4
    //   54: aload_3
    //   55: invokevirtual 365	java/util/zip/Inflater:inflate	([B)I
    //   58: invokevirtual 315	java/io/ByteArrayOutputStream:write	([BII)V
    //   61: goto -24 -> 37
    //   64: astore_3
    //   65: aload_1
    //   66: astore_0
    ...
    //   68: astore_2
    //   69: aload_3
    //   70: invokevirtual 366	java/util/zip/DataFormatException:printStackTrace	()V
    //   73: aload 4
    //   75: invokevirtual 367	java/util/zip/Inflater:end	()V
    //   78: aload_0
    //   79: astore_2
    //   80: aload_0
    //   81: ifnull +11 -> 92
    ...
    //   85: astore_2
    //   86: aload_0
    //   87: invokevirtual 259	java/io/ByteArrayOutputStream:close	()V
    //   90: aload_0
    //   91: astore_2
    //   92: aload_2
    //   93: invokevirtual 263	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   96: areturn
    //   97: astore_0
    //   98: aload 4
    //   100: invokevirtual 367	java/util/zip/Inflater:end	()V
    //   103: aload_2
    //   104: ifnull +7 -> 111
    //   107: aload_2
    //   108: invokevirtual 259	java/io/ByteArrayOutputStream:close	()V
    //   111: aload_0
    //   112: athrow
    //   113: astore_1
    //   114: goto -3 -> 111
    ...
    //   118: goto -26 -> 92
    //   121: aload 4
    //   123: invokevirtual 367	java/util/zip/Inflater:end	()V
    //   126: aload_1
    //   127: astore_2
    //   128: aload_1
    //   129: ifnull -37 -> 92
    ...
    //   133: astore_2
    //   134: aload_1
    //   135: invokevirtual 259	java/io/ByteArrayOutputStream:close	()V
    //   138: aload_1
    //   139: astore_2
    //   140: goto -48 -> 92
    //   143: astore_0
