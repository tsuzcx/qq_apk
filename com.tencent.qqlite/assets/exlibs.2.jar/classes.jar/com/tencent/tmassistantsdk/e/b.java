...
public final class b
{
  ...
  private boolean a(FileOutputStream paramFileOutputStream, byte[] paramArrayOfByte, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    if (paramLong != this.e)
    {
      k.b("TMAssistantFile", "writeData0 failed,filelen:" + this.e + ",offset:" + paramLong + ",filename:" + this.a);
      return false;
    }
    if (paramInt2 >= 16384) {}
    for (;;)
  ...
  {
    String str = b(this.a);
    k.b("TMAssistantFile", "deleteFile 1 tmpFilePathString: " + str);
    if (!TextUtils.isEmpty(str))
    {
      File localFile = new File(str);
      k.b("TMAssistantFile", "deleteFile 2 file: " + localFile);
      if (localFile.exists())
      {
        boolean bool = localFile.delete();
        k.b("TMAssistantFile", "deleteFile result:" + bool + ",filename:" + str);
      }
    }
    else
    {
