  ...
  extends ProfileActivity
{
  ...
  private static final int bP = 18;
  private static final int bQ = 19;
  private static final int bR = 20;
  private static final int bS = 21;
  private static final int bT = 22;
  private static final int bU = 23;
  private static final int bV = 24;
  private static final int bW = 25;
  private static final int bX = 26;
  private static final int bY = 27;
  private static final int bZ = 28;
  ...
  private static final int ca = 29;
  ...
  public Handler a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new lg(this);
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout;
  public RelativeLayout a;
  public TextView a;
  private BmqqBusinessObserver jdField_a_of_type_ComTencentBizBmqqAppBmqqBusinessObserver = new ku(this);
  private ProfileActivity.AllInOne jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne;
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new kx(this);
  ...
  private ActionSheet.OnButtonClickListener jdField_a_of_type_ComTencentWidgetActionSheet$OnButtonClickListener = new lh(this);
  ...
  public TextView b;
  private ActionSheet.OnButtonClickListener jdField_b_of_type_ComTencentWidgetActionSheet$OnButtonClickListener = new kv(this);
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new kw(this);
  }
  ...
  private void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      a(this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(0), 29, 2131363895, 2130838782, 2131361812);
      ...
      paramInt = 1;
      continue;
      a(this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(0), 30, 2131363894, 2130838779, 2131361810);
      localObject = this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(1);
      if (localObject != null) {
        ((View)localObject).setVisibility(0);
      }
      a(this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(2), 32, 2131363077, 2130838792, 2131361811);
      paramInt = 3;
      continue;
      a(this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(0), 30, 2131363894, 2130838779, 2131361810);
      localObject = this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(1);
      ...
      paramInt = 3;
      continue;
      a(this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(0), 32, 2131363077, 2130838792, 2131361811);
      paramInt = 1;
      continue;
      a(this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(0), 30, 2131363894, 2130838779, 2131361810);
      paramInt = 1;
  ...
  private void a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramView != null)
    {
      ...
      localTextView = (TextView)paramView.findViewById(2131298383);
      ...
      localTextView.setTextColor(getResources().getColor(2131427498));
    }
    for (;;)
    {
      ...
      try
      {
        paramView.setBackgroundResource(2130838776);
        localTextView.setTextColor(getResources().getColorStateList(2131427496));
        return;
      }
      ...
      localTextView.setTextColor(getResources().getColor(2131427496));
    }
  }
  ...
  private void a(LinearLayout paramLinearLayout)
  {
    ...
    int k = getResources().getColor(2131427451);
    View localView = View.inflate(this, 2130903530, null);
    ...
    localView = View.inflate(this, 2130903530, null);
  ...
  private void a(String paramString)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentExecutorService.execute(new lc(this));
  }
  ...
  private void m()
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_g_of_type_AndroidWidgetTextView.setVisibility(0);
        this.jdField_g_of_type_AndroidWidgetTextView.setBackgroundResource(2130837641);
      ...
      for (int i1 = 1;; i1 = 0)
      {
        ...
        for (int i2 = 1;; i2 = 0)
        {
          if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataBmqqUserSimpleInfo.mBmqqEmail))
          {
            ...
            this.jdField_a_of_type_AndroidWidgetRelativeLayout.getViewTreeObserver().addOnPreDrawListener(new ky(this));
          }
          for (int i3 = 1;; i3 = 0)
          {
            if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataBmqqUserSimpleInfo.mBmqqCompany))
            {
              ...
              this.jdField_c_of_type_AndroidWidgetRelativeLayout.getViewTreeObserver().addOnPreDrawListener(new kz(this));
            }
            for (int i4 = 1;; i4 = 0)
            {
              int m = -1;
              ...
              if (i5 == 0)
              {
                this.jdField_g_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130837648);
                if (i5 != 1) {
                  break label754;
                }
                this.jdField_h_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130837648);
                label666:
                if (i5 != 2) {
                  break label767;
                }
                this.jdField_i_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130837648);
                label682:
                if (i5 != 3) {
                  break label780;
                }
                this.jdField_b_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130837648);
              }
              for (;;)
              {
                ...
                this.jdField_j_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString);
                return;
                this.jdField_g_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130837649);
                break;
                label754:
                this.jdField_h_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130837649);
                break label666;
                label767:
                this.jdField_i_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130837649);
                break label682;
                label780:
                this.jdField_b_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130837649);
              }
              label791:
              break;
            }
  ...
  private void o()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0)
    {
      ...
      a();
      this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(new lb(this));
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_d_of_type_AndroidWidgetTextView.setText(2131363871);
      break;
      label175:
      this.jdField_c_of_type_AndroidWidgetTextView.setText(getString(2131363110));
      break label75;
      label192:
      k = m;
  ...
  private void p()
  {
    ...
    //   3: aconst_null
    //   4: astore 10
    //   6: invokestatic 384	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   9: ifeq +13 -> 22
    //   12: ldc_w 386
    //   15: iconst_2
    //   16: ldc_w 929
    //   19: invokestatic 523	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   22: aload_0
    //   23: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   26: getfield 552	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:h	Ljava/lang/String;
    //   29: astore 5
    //   31: aload_0
    //   32: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   35: getfield 485	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:jdField_i_of_type_JavaLangString	Ljava/lang/String;
    //   38: astore_2
    //   39: aload_0
    //   40: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   43: getfield 487	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:m	Ljava/lang/String;
    //   46: astore 4
    //   48: aload_0
    //   49: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   52: getfield 931	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:l	Ljava/lang/String;
    //   55: astore 11
    //   57: aload_0
    //   58: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   61: getfield 933	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:n	Ljava/lang/String;
    //   64: astore 12
    //   66: aload_0
    //   67: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   70: getfield 935	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:k	Ljava/lang/String;
    //   73: astore 9
    //   75: aload_0
    //   76: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   79: getfield 937	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:jdField_j_of_type_JavaLangString	Ljava/lang/String;
    //   82: astore 13
    //   84: aload 5
    //   86: astore 6
    //   88: aload 5
    //   90: astore 7
    //   92: aload_0
    //   93: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   96: invokestatic 918	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:b	(Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;)Z
    //   99: ifeq +453 -> 552
    //   102: aload 5
    //   104: astore 6
    //   106: aload 5
    //   108: astore 7
    //   110: aload_0
    //   111: getfield 212	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   114: bipush 8
    //   116: invokevirtual 218	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   119: checkcast 220	com/tencent/mobileqq/model/FriendManager
    //   122: astore_3
    //   123: aload_3
    ...
    //   145: astore 7
    //   147: aload 10
    //   149: getfield 231	com/tencent/mobileqq/data/Friends:name	Ljava/lang/String;
    //   152: invokestatic 208	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   155: ifne +17 -> 172
    //   158: aload 5
    //   160: astore 6
    //   162: aload 5
    //   164: astore 7
    //   166: aload 10
    //   168: getfield 231	com/tencent/mobileqq/data/Friends:name	Ljava/lang/String;
    //   171: astore_3
    //   172: aload_3
    //   173: astore 6
    //   175: aload_3
    ...
    //   179: astore 8
    //   181: aload 10
    //   183: getfield 228	com/tencent/mobileqq/data/Friends:remark	Ljava/lang/String;
    //   186: invokestatic 208	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   189: ifne +684 -> 873
    //   192: aload_3
    //   193: astore 6
    //   195: aload_3
    //   196: astore 7
    //   198: aload 10
    //   200: getfield 228	com/tencent/mobileqq/data/Friends:remark	Ljava/lang/String;
    //   203: astore 5
    //   205: aload_3
    //   206: astore_2
    //   207: aload 5
    //   209: astore_3
    //   210: aload_0
    //   211: getfield 212	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   214: bipush 8
    //   216: invokevirtual 218	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   219: checkcast 939	com/tencent/mobileqq/app/FriendsManagerImp
    //   222: astore 7
    //   224: aload_0
    //   225: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   228: getfield 500	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:c	Ljava/lang/String;
    //   231: astore 6
    //   233: aload 6
    //   235: astore 5
    //   237: aload 6
    //   239: invokestatic 208	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   242: ifeq +43 -> 285
    //   245: aload 6
    //   247: astore 5
    //   249: aload_0
    //   250: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   253: getfield 496	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   256: invokestatic 208	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   259: ifne +26 -> 285
    //   262: aload 6
    //   264: astore 5
    //   266: aload 7
    ...
    //   271: aload 7
    //   273: aload_0
    //   274: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   277: getfield 496	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   280: invokevirtual 941	com/tencent/mobileqq/app/FriendsManagerImp:f	(Ljava/lang/String;)Ljava/lang/String;
    //   283: astore 5
    //   285: aload 5
    //   287: invokestatic 208	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   290: ifne +569 -> 859
    //   293: aload 7
    //   295: ifnull +564 -> 859
    //   298: aload 7
    //   300: aload 5
    //   302: aload_0
    //   303: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   306: getfield 410	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   309: invokevirtual 944	com/tencent/mobileqq/app/FriendsManagerImp:b	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   312: astore 5
    //   314: aload 5
    //   316: astore 4
    //   318: aload 9
    //   320: invokestatic 208	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   323: ifeq +529 -> 852
    //   326: aload_0
    //   327: invokespecial 676	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:a	()Lcom/tencent/mobileqq/activity/ProfileActivity$CardContactInfo;
    //   330: astore 5
    //   332: aload 5
    //   334: ifnull +518 -> 852
    //   337: aload 5
    //   339: getfield 945	com/tencent/mobileqq/activity/ProfileActivity$CardContactInfo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   342: astore 5
    //   344: aload 4
    //   346: astore 8
    //   348: aload 5
    ...
    //   356: astore 5
    //   358: aload_0
    //   359: getfield 131	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   362: iconst_0
    //   363: aload 4
    //   365: aastore
    //   366: aload_0
    //   367: getfield 131	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   370: iconst_4
    //   371: aload 5
    //   373: aastore
    //   374: aload_0
    //   375: getfield 131	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   378: iconst_3
    //   379: aload 10
    //   381: aastore
    //   382: aload_0
    //   383: getfield 131	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   386: iconst_2
    //   387: aload 12
    //   389: aastore
    //   390: aload_0
    //   391: getfield 131	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   394: iconst_5
    //   395: aload 11
    //   397: aastore
    //   398: aload_0
    //   399: getfield 131	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   402: iconst_1
    //   403: aload 8
    //   405: aastore
    //   406: aload_0
    //   407: getfield 131	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   410: bipush 6
    //   412: aload 13
    //   414: aastore
    //   415: invokestatic 384	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   418: ifeq +107 -> 525
    //   421: new 388	java/lang/StringBuilder
    //   424: dup
    //   425: invokespecial 389	java/lang/StringBuilder:<init>	()V
    //   428: astore_2
    //   429: aload_2
    //   430: ldc_w 947
    //   433: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   436: ldc_w 949
    //   439: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   442: aload 4
    //   444: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   447: ldc_w 951
    //   450: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   453: aload 5
    //   455: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   458: ldc_w 953
    //   461: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   464: aload 10
    //   466: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   469: ldc_w 955
    //   472: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   475: aload 12
    //   477: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   480: ldc_w 957
    //   483: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   486: aload 11
    //   488: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   491: ldc_w 959
    //   494: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   497: aload 8
    ...
    //   508: aload 11
    //   510: invokevirtual 395	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   513: pop
    //   514: ldc_w 386
    //   517: iconst_2
    //   518: aload_2
    //   519: invokevirtual 403	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   522: invokestatic 406	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   525: return
    //   526: aload 5
    //   528: astore 6
    //   530: aload 5
    ...
    //   534: aload_3
    //   535: aload_0
    //   536: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   539: getfield 410	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   542: invokeinterface 223 2 0
    //   547: astore 10
    //   549: goto -422 -> 127
    //   552: aload 5
    //   554: astore 6
    ...
    //   558: astore 7
    //   560: aload_0
    //   561: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   564: getfield 408	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:jdField_a_of_type_Int	I
    //   567: ifne +35 -> 602
    //   570: aload 5
    //   572: astore 6
    //   574: aload 5
    //   576: astore 7
    //   578: aload_0
    //   579: getfield 212	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   582: aload_0
    //   583: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   586: getfield 410	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   589: invokestatic 963	com/tencent/mobileqq/utils/ContactUtils:g	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   592: astore 5
    //   594: aload_2
    //   595: astore_3
    //   596: aload 5
    ...
    //   612: astore_3
    //   613: aload 5
    //   615: invokestatic 208	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   618: ifeq +244 -> 862
    //   621: aload 5
    //   623: astore 6
    //   625: aload 5
    ...
    //   631: astore_3
    //   632: aload_0
    //   633: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   636: invokestatic 655	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:f	(Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;)Z
    //   639: ifeq +223 -> 862
    //   642: aload 5
    //   644: astore 6
    //   646: aload 5
    //   648: astore 7
    //   650: aload_0
    //   651: getfield 212	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   654: aload_0
    //   655: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   658: getfield 410	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   661: iconst_0
    //   662: invokestatic 966	com/tencent/mobileqq/utils/ContactUtils:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;I)Ljava/lang/String;
    //   665: astore_3
    //   666: aload_3
    //   667: astore 6
    //   669: aload_3
    ...
    //   672: aload_3
    //   673: aload_0
    //   674: getfield 176	com/tencent/biz/bmqq/profile/BmqqProfileCardActivity:jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne	Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;
    //   677: getfield 410	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   680: invokestatic 971	com/tencent/mobileqq/util/Utils:a	(Ljava/lang/Object;Ljava/lang/Object;)Z
    //   683: istore_1
    //   684: iload_1
    //   685: ifeq +177 -> 862
    //   688: aload_2
    ...
    //   713: aload 9
    //   715: astore 10
    //   717: invokestatic 384	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   720: ifeq -362 -> 358
    //   723: ldc_w 386
    //   726: iconst_2
    //   727: aload 7
    //   729: invokevirtual 608	java/lang/Exception:toString	()Ljava/lang/String;
    //   732: invokestatic 406	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   735: aload_2
    //   736: astore 8
    //   738: aload_3
    //   739: astore 5
    ...
    //   769: aload 9
    //   771: astore 10
    //   773: invokestatic 384	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   776: ifeq -418 -> 358
    //   779: ldc_w 386
    //   782: iconst_2
    //   783: aload 6
    //   785: invokevirtual 972	java/lang/Error:toString	()Ljava/lang/String;
    //   788: invokestatic 406	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   791: aload_2
    //   792: astore 8
    //   794: aload_3
    //   795: astore 5
  ...
  private void t()
  {
    ...
    for (;;)
    {
      startActivity(AddFriendLogicActivity.a(this, 2, str3, null, k, m, str1, null, FriendProfileCardActivity.class.getName(), a_()));
      return;
      k = 3004;
      m = n;
      break;
    ...
    {
      startActivity(AddFriendLogicActivity.a(this, 1, this.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString, str1, k, m, str2, null, AddContactsActivity.class.getName(), a_()));
      return;
    }
    startActivityForResult(AddFriendLogicActivity.a(this, 1, this.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString, str1, k, m, str2, null, BmqqProfileCardActivity.class.getName(), a_()), 1000);
  }
  ...
  void a()
  {
    ...
    if (localQQMessageFacade != null)
    {
      ...
      if (k > 99) {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(getString(2131362946) + "(" + "99+" + ")");
      }
    }
    else
    {
    ...
    this.jdField_c_of_type_AndroidWidgetTextView.setText(getString(2131362946) + "(" + k + ")");
    return;
    label117:
    getIntent().putExtra("leftViewText", getString(2131362946));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(getString(2131362946));
  }
  ...
  public void a(ProfileActivity.AllInOne paramAllInOne, int paramInt, String paramString)
  {
    ...
    ThreadManager.b(new le(this, paramInt, paramAllInOne, paramString));
  }
