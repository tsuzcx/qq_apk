  ...
  implements View.OnClickListener, InputMethodRelativeLayout.onSizeChangedListenner
{
  ...
  private SearchProtocol.SearchObserver jdField_a_of_type_ComTencentBizLebasearchSearchProtocol$SearchObserver = new nl(this);
  private ViewPluginManager jdField_a_of_type_ComTencentBizViewpluginViewPluginManager;
  private ActiveSearchTipsContainer.OnTipClickListener jdField_a_of_type_ComTencentBizWidgetsActiveSearchTipsContainer$OnTipClickListener = new nm(this);
  private ActiveSearchTipsContainer jdField_a_of_type_ComTencentBizWidgetsActiveSearchTipsContainer;
  private GameCenterObserver jdField_a_of_type_ComTencentMobileqqObserverGameCenterObserver = new nk(this);
  private ExtendInputMethodRelativeLayout jdField_a_of_type_ComTencentMobileqqTroopWidgetExtendInputMethodRelativeLayout;
  AdapterView.OnItemClickListener jdField_a_of_type_ComTencentWidgetAdapterView$OnItemClickListener = new no(this);
  private XListView jdField_a_of_type_ComTencentWidgetXListView;
  private List jdField_a_of_type_JavaUtilList = new ArrayList();
  private nq jdField_a_of_type_Nq = new nq(this, null);
  private RelativeLayout jdField_b_of_type_AndroidWidgetRelativeLayout;
  AdapterView.OnItemClickListener jdField_b_of_type_ComTencentWidgetAdapterView$OnItemClickListener = new np(this);
  ...
  private void b(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131362790);
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(getString(2131362642));
      return;
    }
  ...
  private void d()
  {
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetExtendInputMethodRelativeLayout = ((ExtendInputMethodRelativeLayout)findViewById(2131297547));
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetExtendInputMethodRelativeLayout.setOnSizeChangedListenner(this);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131297548));
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(getString(2131362642));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131297553));
    this.c = ((RelativeLayout)findViewById(2131296869));
    ...
    this.jdField_a_of_type_ComTencentBizWidgetsActiveSearchTipsContainer = ((ActiveSearchTipsContainer)findViewById(2131297084));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131297549));
    this.d = ((RelativeLayout)findViewById(2131297551));
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131297552));
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(this.jdField_a_of_type_Nq);
    this.jdField_a_of_type_AndroidWidgetEditText.setOnEditorActionListener(new nn(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setContentDescription(getString(2131362641));
  }
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.removeTextChangedListener(this.jdField_a_of_type_Nq);
  ...
  public void b(String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetButton.setText(2131362641);
    this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(getString(2131362641));
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131298453: 
      ...
      {
        return;
        if (this.jdField_a_of_type_AndroidWidgetButton.getText().toString().equals(getString(2131362790)))
        {
          ReportController.b(this.app, "CliOper", "", "", "0X8004B23", "0X8004B23", 0, 0, null, null, null, null);
          finish();
          return;
        }
      } while ((!this.jdField_a_of_type_AndroidWidgetButton.getText().toString().equals(getString(2131362641))) || (TextUtils.isEmpty(this.jdField_a_of_type_AndroidWidgetEditText.getText())));
      this.k = 2;
