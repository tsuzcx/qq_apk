  ...
  implements View.OnClickListener
{
  ...
  Runnable jdField_a_of_type_JavaLangRunnable = new rw(this);
  ...
  public Ad(QQBrowserActivity paramQQBrowserActivity, AppInterface paramAppInterface)
  {
    ...
    this.jdField_b_of_type_JavaLangRunnable = new rx(this);
  ...
  private void k()
  {
    ...
    localWebSettings.setUserAgentString((String)localObject + " " + QZoneHelper.a() + " " + "QQ/" + "3.3.0" + "." + "544");
  ...
  private void l()
  {
    ...
    this.jdField_b_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new rs(this));
    this.jdField_d_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new rt(this));
    ...
    this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new ru(this));
    this.jdField_c_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new rv(this));
  }
  ...
  public void e()
  {
    ...
    if (this.jdField_a_of_type_MqqAppNewIntent == null)
    {
      ...
      this.jdField_a_of_type_MqqObserverBusinessObserver = new rr(this);
