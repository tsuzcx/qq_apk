  ...
  extends LinearLayout
{
  ...
  public CustomMenuBar(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_JavaLangRunnable = new rl(this);
    super.setFocusable(true);
    super.setOrientation(0);
    super.setGravity(16);
    this.jdField_a_of_type_AndroidWidgetImageView = new ImageView(paramContext);
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839217);
    this.jdField_a_of_type_AndroidWidgetImageView.setClickable(true);
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(paramContext.getText(2131362459));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramContext.findViewById(2131297094));
  ...
  public void a(MenuItem paramMenuItem, String paramString)
  {
    ...
    ImageView localImageView2 = (ImageView)localView.findViewById(2131297095);
    TextView localTextView = (TextView)localView.findViewById(2131297096);
    ImageView localImageView1 = (ImageView)localView.findViewById(2131297097);
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      localImageView1.setImageResource(2130838363);
    ...
    ((PopupMenu)localObject).a(new rh(this, localImageView1, localTextView));
    ((PopupMenu)localObject).a(this.jdField_a_of_type_ComTencentBizUiCustomMenuBar$OnMenuItemClickListener);
    localView.setOnTouchListener(new ri(this, localImageView1, localTextView));
    localView.setOnClickListener(new rj(this, localImageView1, localTextView, (PopupMenu)localObject, paramString, j, str));
    for (;;)
    {
      ...
      return;
      label348:
      localView.setOnClickListener(new rk(this, (String)localObject, j));
    }
  }
