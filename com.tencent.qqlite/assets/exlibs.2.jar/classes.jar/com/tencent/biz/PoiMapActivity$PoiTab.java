...
public class PoiMapActivity$PoiTab
{
  ...
  public PoiMapActivity$PoiTab(PoiMapActivity paramPoiMapActivity, Context paramContext, String paramString, int paramInt)
  {
    ...
    this.d = paramInt;
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((PoiMapActivity)paramContext).findViewById(2131298599));
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setBackgroundDrawable(paramContext.getResources().getDrawable(2130837633));
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new kk(this, paramPoiMapActivity));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new kl(this, paramPoiMapActivity));
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentBizPoiMapActivity.getString(2131364334));
      continue;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentBizPoiMapActivity.getString(2131364333));
      continue;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentBizPoiMapActivity.getString(2131364382));
    }
  }
