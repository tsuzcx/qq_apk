  ...
  implements View.OnClickListener
{
  ...
  private void a(ViewGroup paramViewGroup, mobileqq_mp.ConfigInfo paramConfigInfo, int paramInt)
  {
    ...
    if (paramConfigInfo.type.get() == 3)
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        ((View)localObject2).setOnClickListener(new md(this));
    ...
    {
      label116:
      ((TextView)((View)localObject1).findViewById(2131296936)).setText(paramConfigInfo.title.get());
      ...
      default: 
        ...
        {
          ((View)localObject1).setBackgroundResource(2130839350);
          label216:
          if (paramConfigInfo.state_id.get() != 5) {
            break label1218;
          }
          paramViewGroup.addView((View)localObject3);
          localObject2 = getString(2131362463);
          if (paramConfigInfo.state.get() != 1) {
            break label1207;
          }
          paramViewGroup = getString(2131363615);
          label259:
      ...
      for (;;)
      {
        ...
        if (paramConfigInfo.event_id.get() == 8)
        {
          ...
          if (Pattern.compile("[\\d-]+?").matcher((CharSequence)localObject1).matches()) {
            ((View)localObject2).setOnClickListener(new me(this, paramConfigInfo));
          }
        ...
        ((View)localObject2).setOnClickListener(new mf(this));
        localObject1 = localObject2;
        localObject3 = localObject4;
        break label116;
        if (paramConfigInfo.type.get() == 1)
        {
          ...
          for (;;)
          {
            ...
            ((View)localObject1).setOnClickListener(new mg(this, paramConfigInfo.url.get()));
            localObject3 = localObject4;
            break;
        ...
        if (paramConfigInfo.type.get() == 2)
        {
          if (paramConfigInfo.state_id.get() == 5)
          {
            localObject1 = ((LayoutInflater)localObject2).inflate(2130903672, null);
            localObject2 = ((View)localObject1).findViewById(2131298886);
            ((TextView)((View)localObject1).findViewById(2131298887)).setVisibility(0);
            label642:
            localObject3 = (Switch)((View)localObject2).findViewById(2131296958);
          ...
          for (;;)
          {
            ((Switch)localObject3).setOnCheckedChangeListener(new mh(this, paramConfigInfo, (Switch)localObject3, (View)localObject2));
            localObject3 = localObject1;
            localObject1 = localObject2;
            break;
            localObject2 = ((LayoutInflater)localObject2).inflate(2130903672, null);
            localObject1 = null;
            break label642;
            label730:
        ...
        if (paramConfigInfo.type.get() == 5)
        {
          ...
          {
            ((View)localObject1).findViewById(2131297437).setVisibility(0);
            ((View)localObject1).setOnClickListener(new mi(this, (String)localObject2));
          }
          for (boolean bool = true;; bool = false)
          {
            try
            {
              ...
              a(bool, (LinearLayout)((View)localObject1).findViewById(2131297436), (JSONArray)localObject3, (JSONArray)localObject2);
              localObject3 = localObject4;
            }
            ...
            break;
            ((View)localObject1).findViewById(2131297437).setVisibility(8);
          }
        }
        ...
        if (paramConfigInfo.type.get() == 5)
        {
          ((View)localObject1).setBackgroundResource(2130839355);
          break label216;
        }
        ...
        break label216;
        label1207:
        paramViewGroup = getString(2131363616);
        break label259;
        label1218:
  ...
  private void a(mobileqq_mp.ConfigInfo paramConfigInfo, Switch paramSwitch, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        this.jdField_d_of_type_MqqObserverBusinessObserver = new mw(this, paramConfigInfo, paramSwitch, j, paramBoolean);
  ...
  {
    this.jdField_a_of_type_AndroidWidgetButton.postDelayed(new mb(this, paramInt), 500L);
  }
  ...
  private void b(mobileqq_mp.ConfigInfo paramConfigInfo, Switch paramSwitch, boolean paramBoolean)
  {
    ...
    {
      str = String.format(getString(2131361935), new Object[] { this.jdField_a_of_type_ComTencentMobileqqDataEqqDetail.name });
      localQQCustomDialog.setOnCancelListener(new mx(this, paramConfigInfo, paramSwitch));
    }
    localQQCustomDialog.setTitle("温馨提示");
    localQQCustomDialog.setMessage(str);
    paramConfigInfo = new my(this, paramConfigInfo, paramSwitch, paramBoolean);
  ...
  private void b(String paramString)
  {
    ...
    paramString = new mc(this, paramString);
  ...
  private void c()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131297564));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297562));
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131297561);
    this.jdField_c_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(2130838792, 0, 0, 0);
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131297568));
    super.setTitle(2131362441);
    this.jdField_c_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131296956));
    ...
    this.p.setContentDescription(getResources().getString(2131362579));
    if (QLog.isColorLevel()) {
  ...
  private void f()
  {
    ...
    this.jdField_c_of_type_MqqObserverBusinessObserver = new mm(this);
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton.postDelayed(new mr(this), 3000L);
    b(2131362452);
    ...
    this.jdField_b_of_type_MqqObserverBusinessObserver = new ms(this);
  ...
  private void h()
  {
    ...
    {
      str = String.format(localResources.getString(2131362445, new Object[] { str }), new Object[0]);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(str);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(2131362442, 3);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.d(2131362790);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.setOnDismissListener(new mu(this));
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(new mv(this));
  ...
  private void j()
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_c_of_type_JavaLangString = String.format(super.getResources().getString(2131362440), new Object[] { this.jdField_a_of_type_ComTencentMobileqqDataEqqDetail.displayNumber });
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new mo(this);
        addObserver(this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver);
      }
      k();
      return;
      localObject = getResources().getDrawable(2130838349);
  ...
  private void k()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131362442);
  ...
  private void o()
  {
    ...
    try
    {
      for (;;)
      {
        ...
        this.jdField_a_of_type_MqqObserverBusinessObserver = new mp(this);
  ...
  public void a(boolean paramBoolean, LinearLayout paramLinearLayout, JSONArray paramJSONArray1, JSONArray paramJSONArray2)
  {
    ...
    if (paramBoolean) {}
    for (int j = getWindow().getWindowManager().getDefaultDisplay().getWidth() - getResources().getDimensionPixelSize(2131493043); n == 1; j = getWindow().getWindowManager().getDefaultDisplay().getWidth() - getResources().getDimensionPixelSize(2131493044))
    {
      ...
      ((ImageView)localObject).setOnClickListener(new mj(this, paramJSONArray1));
      try
      {
        ...
        paramJSONArray1.setURLDrawableListener(new mk(this, (ImageView)localObject));
        return;
      }
    ...
    if (n == 4)
    {
      ...
      ((GridView)localObject).setAdapter(new ml(this, n, paramJSONArray2, m));
      ((GridView)localObject).setOnItemClickListener(new mn(this, paramJSONArray1));
      k = j;
      if (n == 4) {
        k = m * 2 + i1;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetButton.postDelayed(new mq(this), 1000L);
        return;
        h();
