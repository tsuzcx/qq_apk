  ...
  extends BaseActivity
{
  ...
  private void c()
  {
    try
    {
      ...
      this.jdField_a_of_type_Jv = new jv(this);
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    c();
    this.jdField_a_of_type_ComTencentBizJoinGroupHandler = new JoinGroupHandler(this, this.app, this.jdField_a_of_type_Int, this.d, new ju(this));
    this.jdField_a_of_type_ComTencentBizJoinGroupHandler.a();
    this.jdField_a_of_type_Jv.sendEmptyMessage(0);
    return true;
  }
