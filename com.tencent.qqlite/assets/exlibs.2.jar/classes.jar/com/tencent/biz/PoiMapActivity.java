  ...
  implements View.OnClickListener
{
  ...
  View.OnKeyListener jdField_a_of_type_AndroidViewView$OnKeyListener = new ki(this);
  View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new jw(this);
  protected View a;
  public EditText a;
  ...
  private AbsListView.OnScrollListener jdField_a_of_type_ComTencentWidgetAbsListView$OnScrollListener = new jx(this);
  public XListView a;
  ...
  public PoiMapActivity()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new jz(this);
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131298581));
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131297524);
    this.jdField_b_of_type_AndroidViewView = super.findViewById(2131298595);
    this.jdField_c_of_type_AndroidViewView = super.findViewById(2131298590);
    this.jdField_c_of_type_AndroidViewView.setVisibility(4);
    Object localObject = super.findViewById(2131298585);
    ((View)localObject).setContentDescription(getString(2131362629));
    ...
    if (this.jdField_h_of_type_Boolean)
    {
      ...
      this.jdField_f_of_type_AndroidViewView.findViewById(2131297247).setVisibility(0);
      this.jdField_f_of_type_AndroidViewView.findViewById(2131297248).setVisibility(0);
    ...
    for (;;)
    {
      this.jdField_d_of_type_AndroidViewView = super.findViewById(2131296936);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131298596));
      localObject = (EditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131297994);
      ...
      this.jdField_a_of_type_AndroidViewView.findViewById(2131298453).setVisibility(8);
      g();
    }
  }
  ...
  protected void a(LBSShare.LocationResp paramLocationResp, Bundle paramBundle)
  {
    ...
    if (paramLocationResp.is_foreign.get() == 1)
    {
      ...
      if (i1 != 0)
      {
        ...
        QQToast.a(this, super.getString(2131364334), 0).a();
      }
      i = 0;
      j = 0;
      paramBundle = null;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramBundle.jdField_a_of_type_JavaLangString = super.getResources().getString(2131364340);
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (paramLocationResp.mylbs.has())
          {
            ...
            for (;;)
            {
              ...
              i = 1;
              break;
              paramBundle = super.getResources().getString(2131364340);
              break label907;
              label1104:
              paramBundle = "";
              break label933;
              ...
              break label1011;
              label1126:
              localPOI.jdField_a_of_type_JavaLangString = super.getResources().getString(2131364340);
    ...
    for (;;)
    {
      ...
      {
        runOnUiThread(new jy(this, bool1, str2, str1, paramLocationResp, i, k, m, n, bool2));
        return;
        i = 0;
        break;
      }
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(getString(2131364333));
  ...
  public void a(String paramString, List paramList, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_JavaUtilList == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(getString(2131363152));
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
  ...
  public void b()
  {
    ...
    ka localka = new ka(this, localTranslateAnimation, localDialog, i, (TranslateAnimation)localObject);
    localTranslateAnimation.setAnimationListener(localka);
    ((TranslateAnimation)localObject).setAnimationListener(localka);
    localDialog.setOnDismissListener(new kb(this, (TranslateAnimation)localObject, localInputMethodManager));
    this.jdField_e_of_type_AndroidViewView = localDialog.findViewById(2131296564);
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)localDialog.findViewById(2131297994));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new km(this, null));
    ...
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new kd(this));
    ((Button)localDialog.findViewById(2131298453)).setOnClickListener(new ke(this, localDialog));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localDialog.findViewById(2131296871));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localDialog.findViewById(2131296869));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new kf(this, localDialog));
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)localDialog.findViewById(2131298755));
    this.jdField_a_of_type_ComTencentWidgetXListView.setBackgroundDrawable(super.getResources().getDrawable(2130837633));
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new kg(this, localInputMethodManager));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new kh(this, localDialog));
  ...
  public void g()
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131298597));
    ...
    Object localObject = (FrameLayout)super.findViewById(2131298598);
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Int = super.getResources().getColor(2131427498);
    this.jdField_b_of_type_Int = super.getResources().getColor(2131427471);
