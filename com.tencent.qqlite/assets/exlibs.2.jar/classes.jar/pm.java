...
{
  pm(pl parampl, String paramString1, String paramString2) {}
  ...
  public void onUpdateSid(String paramString)
  {
    ...
    for (;;)
    {
      localObject = new Intent(this.jdField_a_of_type_Pl.a, QQBrowserDelegationActivity.class);
      ((Intent)localObject).putExtra("url", paramString);
      ((Intent)localObject).putExtra("key_isReadModeEnabled", true);
      ((Intent)localObject).putExtra("injectrecommend", false);
      this.jdField_a_of_type_Pl.a.startActivity((Intent)localObject);
      return;
      label141:
