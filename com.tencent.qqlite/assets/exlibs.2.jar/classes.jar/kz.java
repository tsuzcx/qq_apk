...
{
  public kz(BmqqProfileCardActivity paramBmqqProfileCardActivity) {}
  ...
  public boolean onPreDraw()
  {
    if (BmqqSegmentUtil.b(this.a.getApplicationContext(), this.a.a.mBmqqUin))
    {
      ...
      localImageView.setBackgroundResource(2130837634);
      ...
      if (this.a.a.isCertified())
      {
        ...
        ((ImageView)localObject1).setBackgroundResource(2130838349);
      ...
      this.a.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new la(this));
    }
