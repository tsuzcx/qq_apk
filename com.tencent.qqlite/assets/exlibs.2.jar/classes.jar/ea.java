...
public final class ea
{
  ...
  public ea(GenericGF paramGenericGF, int[] paramArrayOfInt)
  {
  ...
  public ea a(int paramInt1, int paramInt2)
  {
    if (paramInt1 < 0) {
      throw new IllegalArgumentException();
    }
    ...
    return new ea(this.jdField_a_of_type_ComGoogleZxingCommonReedsolomonGenericGF, arrayOfInt);
  }
  
  ea a(ea paramea)
  {
    if (!this.jdField_a_of_type_ComGoogleZxingCommonReedsolomonGenericGF.equals(paramea.jdField_a_of_type_ComGoogleZxingCommonReedsolomonGenericGF)) {
    ...
    int[] arrayOfInt = paramea.jdField_a_of_type_ArrayOfInt;
    ...
    for (;;)
    {
      ...
      int j = localObject.length - paramea.length;
      System.arraycopy(localObject, 0, arrayOfInt, 0, j);
      int i = j;
      while (i < localObject.length)
      {
        arrayOfInt[i] = GenericGF.a(paramea[(i - j)], localObject[i]);
        i += 1;
      }
      return new ea(this.jdField_a_of_type_ComGoogleZxingCommonReedsolomonGenericGF, arrayOfInt);
      paramea = (ea)localObject;
  ...
  public ea[] a(ea paramea)
  {
    ...
    ea localea2 = this.jdField_a_of_type_ComGoogleZxingCommonReedsolomonGenericGF.a();
    int i = paramea.a(paramea.a());
    i = this.jdField_a_of_type_ComGoogleZxingCommonReedsolomonGenericGF.c(i);
    ea localea3;
    for (ea localea1 = this; (localea1.a() >= paramea.a()) && (!localea1.a()); localea1 = localea1.a(localea3))
    {
      int j = localea1.a() - paramea.a();
      int k = this.jdField_a_of_type_ComGoogleZxingCommonReedsolomonGenericGF.b(localea1.a(localea1.a()), i);
      localea3 = paramea.a(j, k);
      localea2 = localea2.a(this.jdField_a_of_type_ComGoogleZxingCommonReedsolomonGenericGF.a(j, k));
    }
    return new ea[] { localea2, localea1 };
  }
  
  public ea b(ea paramea)
  {
    if (!this.jdField_a_of_type_ComGoogleZxingCommonReedsolomonGenericGF.equals(paramea.jdField_a_of_type_ComGoogleZxingCommonReedsolomonGenericGF)) {
      throw new IllegalArgumentException("GenericGFPolys do not have same GenericGF field");
    }
    ...
    paramea = paramea.jdField_a_of_type_ArrayOfInt;
    int m = paramea.length;
    ...
    while (i < k)
    {
      ...
      while (j < m)
      {
        arrayOfInt2[(i + j)] = GenericGF.a(arrayOfInt2[(i + j)], this.jdField_a_of_type_ComGoogleZxingCommonReedsolomonGenericGF.b(n, paramea[j]));
        j += 1;
      }
      i += 1;
    }
    return new ea(this.jdField_a_of_type_ComGoogleZxingCommonReedsolomonGenericGF, arrayOfInt2);
  }
