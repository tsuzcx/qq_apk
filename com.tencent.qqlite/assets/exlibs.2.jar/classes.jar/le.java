...
public class le
  implements Runnable
{
  public le(BmqqProfileCardActivity paramBmqqProfileCardActivity, int paramInt, ProfileActivity.AllInOne paramAllInOne, String paramString) {}
  
  public void run()
  {
    Object localObject1 = null;
    int i = this.jdField_a_of_type_ComTencentBizBmqqProfileBmqqProfileCardActivity.getResources().getDimensionPixelSize(2131492946);
    ...
    for (;;)
    {
      ...
      if (localObject1 != null)
      {
        ...
        this.jdField_a_of_type_ComTencentBizBmqqProfileBmqqProfileCardActivity.app.runOnUiThread(new lf(this, (Drawable)localObject1));
      }
      return;
      label224:
      ...
      else
      {
        ...
        {
          localObject1 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentBizBmqqProfileBmqqProfileCardActivity.getResources(), 2130838053);
          continue;
        }
