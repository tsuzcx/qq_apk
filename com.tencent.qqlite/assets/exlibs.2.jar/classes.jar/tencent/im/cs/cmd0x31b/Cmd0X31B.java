...
public final class Cmd0X31B
{
    ...
    extends MessageMicro<ApplyOfflineFileDownloadRsp>
  {
    ...
    static
    {
      ...
      __fieldMap__ = MessageMicro.initFieldMap(new int[] { 242 }, new String[] { "msg_of_download_info" }, arrayOfObject, ApplyOfflineFileDownloadRsp.class);
    }
  }
    ...
    extends MessageMicro<GetLibListRspBody>
  {
    ...
    static
    {
      ...
      arrayOfObject[3] = Long.valueOf(0L);
      __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32 }, new String[] { "str_libtype", "uint32_file_total_num", "rpt_msg_file_info", "uint64_time_stamp" }, arrayOfObject, GetLibListRspBody.class);
    }
  }
    ...
    extends MessageMicro<GetLibTypeRspBody>
  {
    ...
    {
      Object[] arrayOfObject = new Object[1];
      __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10 }, new String[] { "rpt_msg_lib_type_info" }, arrayOfObject, GetLibTypeRspBody.class);
    }
  }
    ...
    extends MessageMicro<GetOfflineFileRspBody>
  {
    ...
    static
    {
      ...
      arrayOfObject[4] = Long.valueOf(0L);
      arrayOfObject[5] = Long.valueOf(0L);
      arrayOfObject[6] = Integer.valueOf(0);
      arrayOfObject[7] = Integer.valueOf(0);
      __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32, 40, 48, 56, 64 }, new String[] { "rpt_msg_recv_offline_file", "uint32_recv_file_total", "rpt_msg_send_offline_file", "uint32_send_file_total", "uint64_tot_limit", "uint64_used_limit", "uint32_recv_list_end", "uint32_send_list_end" }, arrayOfObject, GetOfflineFileRspBody.class);
    }
  }
    ...
    extends MessageMicro<QCloud2FtnReqBody>
  {
    ...
    static
    {
      ...
      arrayOfObject[5] = Long.valueOf(0L);
      arrayOfObject[6] = Integer.valueOf(0);
      arrayOfObject[7] = ByteStringMicro.EMPTY;
      __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42, 48, 56, 66, 802 }, new String[] { "uint64_dst_id", "uint32_dst_bid", "str_dst_path", "str_file_id", "str_file_name", "uint64_file_size", "uint32_file_resource", "bytes_file_md5", "extension_req" }, arrayOfObject, QCloud2FtnReqBody.class);
    }
  }
    ...
    extends MessageMicro<ReqBody>
  {
    ...
    static
    {
      ...
      arrayOfObject[1] = "";
      __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 58, 66, 74, 98, 106, 122, 138, 146, 810, 818 }, new String[] { "uint32_sub_cmd", "str_app_id", "msg_get_lib_type_req_body", "msg_get_lib_list_req_body", "msg_upload2qcloud_req_body", "msg_download_file_req_body", "msg_delete_file_req_body", "msg_resume_file_upload_req_body", "msg_file_preview_req_body", "msg_qcloud2ftn_req_body", "msg_querypwd_req_body", "msg_verifypwd_req_body", "msg_get_offline_file_req_body", "msg_apply_offline_file_download_req" }, arrayOfObject, ReqBody.class);
    }
  }
    ...
    extends MessageMicro<RspBody>
  {
    ...
    static
    {
      ...
      arrayOfObject[14] = "";
      arrayOfObject[15] = "";
      __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 58, 66, 74, 98, 106, 122, 138, 146, 810, 818, 8002, 8010 }, new String[] { "uint32_sub_cmd", "uint32_return_code", "msg_get_lib_type_rsp_body", "msg_get_lib_list_rsp_body", "msg_upload2qcloud_rsp_body", "msg_download_file_rsp_body", "msg_delete_file_rsp_body", "msg_resume_file_upload_rsp_body", "msg_file_preview_rsp_body", "msg_qcloud2ftn_rsp_body", "msg_querypwd_rsp_body", "msg_verifypwd_rsp_body", "msg_get_offline_file_rsp_body", "msg_apply_offline_file_download_rsp", "str_error_msg", "str_client_wording" }, arrayOfObject, RspBody.class);
    }
  }
