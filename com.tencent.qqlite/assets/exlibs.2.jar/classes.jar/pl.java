...
{
  public pl(QRCardActivity paramQRCardActivity, boolean[] paramArrayOfBoolean, String paramString1, Context paramContext, String paramString2) {}
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ArrayOfBoolean[0] == 1)
      {
        ...
        for (;;)
        {
          ...
          {
            ((AccountManager)this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.app.getManager(0)).updateSid(new pm(this, paramView, (String)localObject));
          }
