  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      QRUtils.a(this.a.app, this.a, str, i, (String)localObject1, (String)localObject2, new pz(this, str, i));
    }
    label739:
    ...
    for (i = 1;; i = 0)
    {
      this.a.findViewById(2131297825).setOnClickListener(this.a);
      if ((this.a.i == null) || (this.a.j == null) || (i == 0)) {
        break label1059;
      }
      ((TextView)this.a.findViewById(2131297824)).setText(this.a.i);
