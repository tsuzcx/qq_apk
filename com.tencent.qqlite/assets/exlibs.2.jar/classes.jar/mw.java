...
{
  public mw(EnterpriseDetailActivity paramEnterpriseDetailActivity, mobileqq_mp.ConfigInfo paramConfigInfo, Switch paramSwitch, int paramInt, boolean paramBoolean) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      ...
      this.jdField_a_of_type_ComTencentBizEqqEnterpriseDetailActivity.a(2131362453);
