...
{
  public fco(AuthorityActivity paramAuthorityActivity) {}
    ...
    for (str = "s_a_a_emp";; str = "s_a_a")
    {
      ...
      for (;;)
      {
        ...
        catch (Exception paramBundle)
        {
          ...
          ((Message)localObject1).obj = this.a.getResources().getString(2131363836);
        ...
        paramBundle.obj = this.a.getResources().getString(2131363836);
        this.a.jdField_a_of_type_AndroidOsHandler.sendMessage(paramBundle);
        paramBundle = this.a.getResources().getString(2131363836);
        try
        {
