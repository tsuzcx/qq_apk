...
{
  public ezz(AuthorityActivity paramAuthorityActivity) {}
    ...
    for (str = "g_a_a_l_emp";; str = "g_a_a_l")
    {
      ...
      for (;;)
      {
        ...
        catch (Exception paramBundle)
        {
          ...
          ((Message)localObject).obj = this.a.getResources().getString(2131363837);
          this.a.jdField_a_of_type_AndroidOsHandler.sendMessage((Message)localObject);
        ...
        paramBundle.obj = this.a.getResources().getString(2131363837);
        this.a.jdField_a_of_type_AndroidOsHandler.sendMessage(paramBundle);
        paramBundle = this.a.getResources().getString(2131363837);
        try
        {
