  ...
  implements DownCallBack
{
  ...
  public bzp(MultiForwardChatPie paramMultiForwardChatPie)
  {
  ...
  public void a(DownCallBack.DownResult paramDownResult)
  {
    ...
    do
    {
      ...
      MultiForwardChatPie.a(localMultiForwardChatPie).runOnUiThread(new bzq(this, localMultiForwardChatPie, paramDownResult));
      return;
      if (QLog.isColorLevel()) {
    ...
    MultiForwardChatPie.b(localMultiForwardChatPie).runOnUiThread(new bzr(this, localMultiForwardChatPie));
  }
}
