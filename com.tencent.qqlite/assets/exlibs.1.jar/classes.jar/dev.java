  ...
  extends EmoticonLinearLayout.EmoticonAdapter
{
  ...
  public dev(EmoticonPanelViewBinder paramEmoticonPanelViewBinder, int paramInt)
  {
  ...
  public void a(int paramInt, RelativeLayout paramRelativeLayout, ViewGroup paramViewGroup)
  {
    ...
    if (localObject1 != null) {
      if ((((EmoticonInfo)localObject1).c == 1) || (((EmoticonInfo)localObject1).c == 2) || (((EmoticonInfo)localObject1).c == 7))
      {
        ...
        if ((this.k == 2006) || (this.k == 2009))
        {
          ...
          ((ImageView)localObject2).setImageResource(2130839379);
        }
        label395:
        if (this.k == 2008)
        {
          ...
          if (((EmoticonInfo)localObject1).c == 9)
          {
            ...
            ((ImageView)localObject3).setImageResource(2130838983);
    ...
    while ((localObject3 == null) || (localObject2 == null) || (paramRelativeLayout == null))
    {
      do
      {
        ...
        {
          paramViewGroup.setImageResource(2130837974);
          break label164;
        }
        if ("setting".equals(((EmoticonInfo)localObject1).a))
        {
          paramViewGroup.setImageDrawable(this.a.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839000));
          break label164;
        }
        if ("add".equals(((EmoticonInfo)localObject1).a))
        {
          paramViewGroup.setImageDrawable(this.a.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838999));
          break label164;
        }
      ...
      for (;;)
      {
        if (!((EmoticonPackage)localObject3).valid) {
          ((ImageView)localObject2).setImageResource(2130839001);
        }
        ((ImageView)localObject2).setVisibility(0);
        break;
