  ...
  implements View.OnClickListener
{
  ...
  private bk(LiteMutiPicViewerActivity paramLiteMutiPicViewerActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (!LiteMutiPicViewerActivity.a(this.jdField_a_of_type_ComDatalineActivitiesLiteMutiPicViewerActivity).isTimeOut())
      {
        ...
        paramView = String.format(this.jdField_a_of_type_ComDatalineActivitiesLiteMutiPicViewerActivity.app.a().getString(2131361898), new Object[] { Integer.valueOf(i), Integer.valueOf(i - paramInt) });
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131297964));
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131296967);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131297965));
