...
public class eca
  extends BaseAdapter
{
  private eca(EditActivity paramEditActivity) {}
  ...
  {
    paramView = this.a.getLayoutInflater().inflate(2130903488, null);
    ImageView localImageView;
    TextView localTextView;
    if (paramInt == 3)
    {
      paramView.setBackgroundResource(2130837749);
      ...
      localImageView = (ImageView)paramView.findViewById(2131298195);
      ...
      localTextView = (TextView)paramView.findViewById(2131298196);
    ...
    for (;;)
    {
      ...
      if (paramInt == 5)
      {
        paramView.setBackgroundResource(2130837750);
        break;
      }
      paramView.setBackgroundResource(2130838710);
      break;
      label203:
      localTextView.setCompoundDrawablesWithIntrinsicBounds(null, null, this.a.getResources().getDrawable(2130837716), null);
