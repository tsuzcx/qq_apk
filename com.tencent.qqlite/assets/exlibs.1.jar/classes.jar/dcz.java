...
public class dcz
  implements Runnable
{
  public dcz(DebugActivity paramDebugActivity) {}
  ...
  public void run()
  {
    for (;;)
    {
      ...
      DebugActivity.a(this.a, DebugActivity.a(this.a).setTitle("内存信息").setItems((CharSequence[])localException.toArray(new String[0]), new dda(this.a, null)).create());
