  ...
  extends AutoCompleteTextView
{
  ...
  public eyi(DropdownView paramDropdownView, Context paramContext)
  {
    super(paramContext);
    setId(526);
  ...
  public eyi(DropdownView paramDropdownView, Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public eyi(DropdownView paramDropdownView, Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  public void showDropDown()
  {
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        ((PopupWindow)localObject2).setAnimationStyle(2130968636);
        return;
      }
