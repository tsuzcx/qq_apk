...
public class arm
  extends BaseAdapter
{
  private arm(JobSelectionActivity paramJobSelectionActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.a.getLayoutInflater().inflate(2130903498, paramViewGroup, false);
      paramView = new arn(null);
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131298219));
      paramView.b = ((TextView)localView.findViewById(2131296458));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131298220));
      localView.setTag(paramView);
    }
    paramView = (arn)localView.getTag();
    int i = paramInt;
    if (!JobSelectionActivity.a(this.a)) {
      i = paramInt + 1;
    }
