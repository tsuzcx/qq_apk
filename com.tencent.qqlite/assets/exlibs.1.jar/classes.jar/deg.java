  ...
  implements EmoticonLinearLayout.DataObserver
{
  ...
  public deg(EmoticonLinearLayout paramEmoticonLinearLayout) {}
      ...
      while (paramInt2 < this.jdField_a_of_type_Int)
      {
        ...
        if (i < this.b)
        {
          ...
          for (;;)
          {
            ...
            ((ProgressBar)localObject3).setIndeterminateDrawable(this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonLinearLayout.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837910));
