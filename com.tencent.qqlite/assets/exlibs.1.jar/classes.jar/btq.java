...
public class btq
  implements Runnable
{
  public btq(PressToSpeakPanel paramPressToSpeakPanel, MotionEvent paramMotionEvent) {}
  ...
  public void run()
  {
    ...
    if (!FileUtils.a())
    {
      QQToast.a(BaseApplication.getContext(), 2131363002, 0).b(i);
      return;
    }
    if (!QQRecorder.d())
    {
      QQToast.a(BaseApplication.getContext(), 2131363003, 0).b(i);
      return;
    }
    if (!QQRecorder.c())
    {
      QQToast.a(BaseApplication.getContext(), 2131363004, 0).b(i);
      return;
    }
    ...
    {
      QQToast.a(BaseApplication.getContext(), 2131363137, 0).b(i);
      return;
    }
    if (AudioHelper.a(1))
    {
    ...
    PressToSpeakPanel.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelPressToSpeakPanel).setBackgroundResource(2130839199);
