  ...
  extends TroopObserver
{
  ...
  protected void a(int paramInt, byte paramByte)
  {
    if (paramInt == 9)
    {
      ...
      if (paramByte == 8)
      {
        ...
        ((QQCustomDialog)localObject).setTitle(this.a.getString(2131362596));
        ((QQCustomDialog)localObject).setMessage(this.a.getString(2131362597));
        ((QQCustomDialog)localObject).setNegativeButton(this.a.getString(2131362594), new bmo(this, (QQCustomDialog)localObject));
        ((QQCustomDialog)localObject).setPositiveButton(this.a.getString(2131363671), new bmp(this, (QQCustomDialog)localObject));
  ...
  protected void a(int paramInt, byte paramByte, String paramString)
  {
    ...
    if (paramByte == 0)
    {
      ...
      paramString.putExtra("fin_tip_msg", this.a.getString(2131363685));
    ...
    do
    {
      do
      {
        ...
        case 4: 
          ...
          paramList = (TroopHandler)this.a.app.a(17);
      ...
      paramList.putExtra("leftViewText", this.a.getString(2131363438));
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131363639, 1500);
        return;
      }
      paramList = this.a;
      paramList.jdField_d_of_type_Int &= 0xFFFFFFFD;
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131363642, 1500);
      return;
    } while (!paramBoolean);
    label419:
    label564:
