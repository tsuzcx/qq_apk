  ...
  extends BaseAdapter
{
  ...
  public bct(QQLSActivity paramQQLSActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2130903511, null);
      paramView = new bcv();
      localObject = (TextView)paramViewGroup.findViewById(2131298281);
    ...
    bcv localbcv = (bcv)paramViewGroup.getTag();
    ...
    for (;;)
    {
      localbcv.a.setText(new QQText(paramView, 5, 16, QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a()));
      return paramViewGroup;
      ...
      break;
      label270:
      localbcv.a.setTextColor(-4210755);
    }
  }
}
