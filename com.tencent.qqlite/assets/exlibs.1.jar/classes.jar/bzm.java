...
{
  public bzm(FriendChatPie paramFriendChatPie) {}
  ...
  public void a(boolean paramBoolean, PBRepeatMessageField paramPBRepeatMessageField)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        QQToast.a(FriendChatPie.b(this.a), 2, FriendChatPie.c(this.a).getResources().getString(2131364296), 0).a();
        if (this.a.g) {
          FriendChatPie.d(this.a).setResult(-1);
        }
        this.a.t();
        return;
        QQToast.a(FriendChatPie.e(this.a), FriendChatPie.f(this.a).getResources().getString(2131364297), 0).a();
        return;
      }
    }
  }
