...
{
  public cen(NotificationView paramNotificationView) {}
  ...
  protected void a(String paramString)
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog != null) && (this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.isShowing()))
    {
      ...
      paramString = NotificationView.a(this.a).getResources().getString(2131362903);
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1 = NotificationView.a(this.a).getResources().getString(2131363399);
      ...
      paramString1 = NotificationView.a(this.a).getResources().getString(2131362833);
      if (paramInt1 == 1) {
        paramString1 = NotificationView.a(this.a).getResources().getString(2131362832);
      }
      for (;;)
      {
        ...
        try
        {
          ...
          return;
          if (paramInt1 == 2) {
            paramString1 = NotificationView.a(this.a).getResources().getString(2131362831);
          }
        }
        catch (Exception paramString1)
        {
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      {
        String str = NotificationView.a(this.a).getResources().getString(2131362904);
