...
{
  public bmi(TroopDisbandActivity paramTroopDisbandActivity) {}
  ...
  protected void a(int paramInt, byte paramByte)
  {
    if (paramInt == 9)
    {
      ...
      if (paramByte == 8)
      {
        ...
        ((QQCustomDialog)localObject).setTitle(this.a.getString(2131362594));
        ((QQCustomDialog)localObject).setMessage(this.a.getString(2131362595));
        ((QQCustomDialog)localObject).setNegativeButton(this.a.getString(2131362592), new bmj(this, (QQCustomDialog)localObject));
        ((QQCustomDialog)localObject).setPositiveButton(this.a.getString(2131363660), new bmk(this, (QQCustomDialog)localObject));
    ...
    this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131363675, 1500);
  }
  ...
  protected void a(int paramInt, byte paramByte, String paramString)
  {
    ...
    if (paramByte == 0)
    {
      ...
      paramString.putExtra("fin_tip_msg", this.a.getString(2131363674));
  ...
  protected void a(boolean paramBoolean, long paramLong1, int paramInt1, List paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      paramList.putExtra("leftViewText", this.a.getString(2131363427));
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131363628, 1500);
        return;
      }
      paramList = this.a;
      paramList.jdField_d_of_type_Int &= 0xFFFFFFFD;
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131363631, 1500);
      return;
    } while (!paramBoolean);
    label419:
    label564:
