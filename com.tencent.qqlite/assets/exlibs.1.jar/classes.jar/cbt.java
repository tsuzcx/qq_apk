  ...
  extends BaseAdapter
{
  ...
  private cbt(ClassificationSearchActivity paramClassificationSearchActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      do
      {
        ...
        if (paramView == null)
        {
          paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchActivity.getLayoutInflater().inflate(2130903466, null);
        ...
        localcbs = (cbs)paramViewGroup.getTag();
        ...
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchActivity.jdField_a_of_type_Boolean)
        {
          ...
          localcbs.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
          localcbs.jdField_a_of_type_AndroidWidgetTextView.setText("获取失败，请稍后再试");
          return paramViewGroup;
        }
      ...
      localcbs.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      localcbs.jdField_a_of_type_AndroidWidgetTextView.setText("载入中，请稍候...");
    ...
    localcbs.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
    localcbs.jdField_a_of_type_AndroidWidgetTextView.setText("获取失败，请检查网络连接");
    return paramViewGroup;
  }
