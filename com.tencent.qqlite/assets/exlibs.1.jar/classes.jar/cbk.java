...
{
  public cbk(TroopChatPie paramTroopChatPie) {}
  ...
  {
    if (ChatActivityUtils.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, TroopChatPie.h(this.a).a()) != null) {}
    do
    {
      return;
    ...
    paramList.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramString);
  }
        ...
        if (l1 == l2)
        {
          ...
          if (paramObject.bool_show_tips.get())
          {
            try
            {
              ...
              this.a.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioTips.a(TroopChatPie.g(this.a), TroopChatPie.f(this.a), this.a.jdField_a_of_type_ComTencentMobileqqActivityAioAIOTipsController, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, (String)localObject, paramObject);
              return;
            }
