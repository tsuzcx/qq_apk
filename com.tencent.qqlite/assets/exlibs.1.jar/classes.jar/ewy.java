  ...
  implements INetInfoHandler, DownloaderInterface
{
  ...
  Runnable jdField_a_of_type_JavaLangRunnable = new ewz(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ewy.class.getSimpleName();
  }
  
  public ewy(AppInterface paramAppInterface, DownloaderFactory.DownloadConfig paramDownloadConfig)
  {
