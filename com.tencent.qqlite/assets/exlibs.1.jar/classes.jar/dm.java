  ...
  extends BaseAdapter
{
  ...
  private void b()
  {
    ...
    while (i < 3)
    {
      ...
      this.jdField_a_of_type_ArrayOfComDatalineUtilWidgetAsyncImageView[i].setDefaultImage(2130839481);
  ...
  public void a()
  {
    ...
    if (i < 3)
    {
      ...
      if (localDataLineMsgRecord == null) {
        localAsyncImageView.setImageResource(2130839481);
      }
      for (;;)
      {
        i += 1;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (localDataLineMsgRecord == null)
      {
        paramViewGroup.setImageResource(2130839481);
