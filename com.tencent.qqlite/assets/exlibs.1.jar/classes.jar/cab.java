...
{
  public cab(TroopChatPie paramTroopChatPie) {}
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    ...
    {
      paramString = ((FriendManager)TroopChatPie.c(this.a).getManager(8)).a(TroopChatPie.s(this.a).jdField_a_of_type_JavaLangString);
      if (paramString != null)
      {
  ...
  protected void a(boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      {
        return;
        paramString = ChatActivityUtils.a(TroopChatPie.v(this.a).jdField_a_of_type_JavaLangString, TroopChatPie.d(this.a).a());
  ...
  protected void b(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      StatisticCollector.a(BaseApplication.getContext()).a(TroopChatPie.e(this.a).a(), "multiMsgNickTimeoutR", false, 30000L, 0L, localHashMap, "");
      return;
      if (!paramBoolean)
      {
        i = 1;
        ...
        {
          QQToast.a(TroopChatPie.c(this.a), 2131362996, 0).b(TroopChatPie.b(this.a).getTitleBarHeight());
          return;
          if (QLog.isDevelopLevel()) {
