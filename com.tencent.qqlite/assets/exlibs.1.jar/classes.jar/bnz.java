...
{
  public bnz(TroopMemberCardActivity paramTroopMemberCardActivity) {}
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.D == 2)
        {
          if (paramInt == 0) {
            if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.p == 3)
            {
              ...
              paramView.putExtra("leftViewText", 2131363676);
              this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.startActivityForResult(paramView, 4);
            }
            else
            {
              localObject = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131363439);
              ...
              {
                paramView = String.format(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131363435), new Object[] { paramView });
                ...
                paramView.setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131363052), new boa(this, paramView));
                ...
                paramView.setNegativeButton(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131362801), new bob(this, paramView));
