  ...
  implements Runnable
{
  ...
  public void run()
  {
    DownloadTask localDownloadTask = ezd.a(this.a);
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(ezd.jdField_a_of_type_JavaLangString, 2, "doTask | run() downloadLimitCount=" + this.a.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() + ",task=" + localDownloadTask);
      }
    ...
    QLog.d(ezd.jdField_a_of_type_JavaLangString, 2, "doTask | run() task is limit of failTime, task=" + localDownloadTask);
    return;
    int i = DownloaderFactory.a(localDownloadTask, this.a.jdField_a_of_type_ComTencentCommonAppAppInterface);
    if (QLog.isColorLevel()) {
      QLog.d(ezd.jdField_a_of_type_JavaLangString, 2, "doTask | run() download task result=" + i + ",task=" + localDownloadTask);
    }
    this.a.a(localDownloadTask);
    this.a.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.addAndGet(-1);
    this.a.c();
