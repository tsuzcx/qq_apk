...
public class boq
  extends Handler
{
  public boq(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      case 6: 
        ...
        QQToast.a(this.a, this.a.getString(2131362856), 0).b(this.a.jdField_a_of_type_AndroidViewView.getHeight());
        return;
      case 7: 
        if ((this.a.jdField_a_of_type_AndroidAppDialog != null) && (this.a.jdField_a_of_type_AndroidAppDialog.isShowing())) {
          this.a.jdField_a_of_type_AndroidAppDialog.dismiss();
        }
        QQToast.a(this.a, this.a.getString(2131362858), 0).b(this.a.jdField_a_of_type_AndroidViewView.getHeight());
        return;
      case 8: 
        paramMessage = (Object[])paramMessage.obj;
