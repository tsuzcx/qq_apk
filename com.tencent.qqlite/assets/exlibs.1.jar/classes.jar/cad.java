  ...
  extends BizTroopObserver
{
  ...
  {
    if (ChatActivityUtils.a(TroopChatPie.C(this.a).jdField_a_of_type_JavaLangString, TroopChatPie.g(this.a).a()) != null) {}
    do
    {
      return;
      ...
      paramList = (TroopHandler)TroopChatPie.h(this.a).a(17);
  ...
  {
    if (!TroopChatPie.e(this.a).isResume()) {}
  }
        ...
        if (l1 == l2)
        {
          ...
          if (paramObject.bool_show_tips.get())
          {
            try
            {
              ...
              this.a.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioTips.a(TroopChatPie.f(this.a), TroopChatPie.d(this.a), this.a.jdField_a_of_type_ComTencentMobileqqActivityAioAIOTipsController, TroopChatPie.B(this.a).jdField_a_of_type_JavaLangString, (String)localObject, paramObject);
              return;
            }
