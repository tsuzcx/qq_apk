  ...
  extends BaseAdapter
{
  ...
  public dxv(RoamSearchDialog paramRoamSearchDialog) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    case 0: 
      ...
      {
        paramView = View.inflate(this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.jdField_a_of_type_AndroidContentContext, 2130903596, null);
        paramViewGroup = new dxu(null);
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131296936));
        paramViewGroup.b = ((TextView)paramView.findViewById(2131298680));
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (dxu)paramView.getTag();
      }
    }
    if ((paramView == null) || (!(paramView instanceof LinearLayout)))
    {
      ...
      paramViewGroup = new dxu(null);
      paramView.setTag(paramViewGroup);
      paramViewGroup.c = ((TextView)paramView.findViewById(2131297315));
      paramViewGroup.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131296558));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131297314));
      if ((paramView != null) && ((paramView instanceof LinearLayout))) {
