...
{
  public bmv(TroopInfoActivity paramTroopInfoActivity) {}
  ...
  protected void a(boolean paramBoolean, long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        break;
      case 1281: 
        paramString = this.a.getString(2131362644);
        break;
      case 1282: 
        paramString = this.a.getString(2131362645);
        break;
      case 1283: 
        paramString = this.a.getString(2131362646);
        continue;
        if ((this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.r == 3) || (this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.r == 2))
        {
          ...
          paramString.setMessage(this.a.getString(2131362656));
          paramString.setPositiveButton(this.a.getString(2131362655), new bmw(this, paramString));
          paramString.setPositiveButtonContentDescription(this.a.getString(2131362655));
          paramString.show();
          return;
        }
        paramString = this.a.getString(2131363886);
      }
    }
  }
}
