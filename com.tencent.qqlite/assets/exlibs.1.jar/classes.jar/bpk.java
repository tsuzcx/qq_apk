...
{
  public bpk(TroopPrivilegeActivity paramTroopPrivilegeActivity, ActionSheet paramActionSheet) {}
  
  public void a(View paramView, int paramInt)
  {
    Object localObject1;
    boolean bool;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.jdField_a_of_type_JavaLangObject != null) && ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.jdField_a_of_type_JavaLangObject instanceof bpl)))
    {
      localObject1 = (bpl)this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.jdField_a_of_type_JavaLangObject;
      if (((bpl)localObject1).jdField_a_of_type_Int - 1 == paramInt) {
        return;
      }
      paramView = (BizTroopHandler)this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.app.a(19);
      if (((bpl)localObject1).jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.getString(2131362364)))
      {
        ...
        String str = this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.getString(2131362364);
        if (paramInt != 0) {
          break label355;
        }
        i = 1;
      ...
      if (((bpl)localObject1).jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.getString(2131362363)))
      {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.getString(2131362363);
        if (paramInt != 0) {
          break label366;
        }
      }
