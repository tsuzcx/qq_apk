...
public class cxl
  extends Handler
{
  public cxl(StartAppCheckHandler paramStartAppCheckHandler, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 1: 
      ...
      if ((this.a.jdField_a_of_type_AndroidAppActivity != null) && (this.a.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface != null))
      {
        ...
        ((NewIntent)localObject).putExtra("data", ((cxq)paramMessage.obj).a.toByteArray());
      ...
      for (;;)
      {
        ...
        this.a.jdField_a_of_type_Cxq = null;
        return;
        localObject = this.a.a("SecCheckSigSvc.UploadReq");
        ((ToServiceMsg)localObject).putWupBuffer(((cxq)paramMessage.obj).a.toByteArray());
