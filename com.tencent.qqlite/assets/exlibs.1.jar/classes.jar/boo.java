...
{
  public boo(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    for (int i = paramInt + 1;; i = paramInt)
    {
      ...
      case 4: 
        ...
        if (i == 1)
        {
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.a(0).setText(2131362882);
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.a(1).setText(2131362883);
      ...
      for (;;)
      {
        ...
        if (i == 2)
        {
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.a(0).setText(2131362884);
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.a(1).setText(2131362885);
        ...
        else
        {
          if (i == 4)
          {
            this.a.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.a(0).setText(2131362886);
            this.a.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.a(1).setText(2131362887);
            ...
            this.a.n();
            break;
            this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new bop(this), 320L);
            break;
            this.a.b = true;
            this.a.q = "";
