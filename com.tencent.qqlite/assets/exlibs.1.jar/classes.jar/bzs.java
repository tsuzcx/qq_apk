...
{
  public bzs(StrangerChatPie paramStrangerChatPie) {}
  ...
  protected void a(String paramString1, int paramInt1, int paramInt2, SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    if (paramInt1 == 1005) {
      ...
      {
      default: 
        QQToast.a(StrangerChatPie.f(this.a), StrangerChatPie.g(this.a).getString(2131362967), 0).b(StrangerChatPie.e(this.a).getTitleBarHeight());
      }
    }
    for (;;)
    {
      this.a.a(196608);
      return;
      QQToast.a(StrangerChatPie.c(this.a), StrangerChatPie.d(this.a).getString(2131362966), 0).b(StrangerChatPie.b(this.a).getTitleBarHeight());
      continue;
      if (paramInt1 == 1004) {
        switch (paramInt2)
        {
        ...
        case 103: 
        case 104: 
          paramString1 = String.format(StrangerChatPie.h(this.a).getString(2131362969), new Object[] { StrangerChatPie.k(this.a).d });
        ...
        case 103: 
        case 104: 
          paramString1 = String.format(StrangerChatPie.k(this.a).getString(2131362970), new Object[] { StrangerChatPie.l(this.a).d });
        ...
        case 103: 
        case 104: 
          paramString1 = String.format(StrangerChatPie.n(this.a).getString(2131362172), new Object[] { StrangerChatPie.m(this.a).d });
        ...
        case 28: 
        case 48: 
          QQToast.a(StrangerChatPie.r(this.a), StrangerChatPie.s(this.a).getString(2131362968), 0).b(StrangerChatPie.q(this.a).getTitleBarHeight());
          break;
        }
        ...
        default: 
          break;
        case 1600: 
          QQToast.a(StrangerChatPie.u(this.a), StrangerChatPie.v(this.a).getString(2131363004), 0).b(StrangerChatPie.t(this.a).getTitleBarHeight());
          break;
        case 1601: 
          QQToast.a(StrangerChatPie.x(this.a), StrangerChatPie.y(this.a).getString(2131363004), 0).b(StrangerChatPie.w(this.a).getTitleBarHeight());
          break;
        case 1602: 
          QQToast.a(StrangerChatPie.A(this.a), StrangerChatPie.B(this.a).getString(2131363005), 0).b(StrangerChatPie.z(this.a).getTitleBarHeight());
          break;
        }
