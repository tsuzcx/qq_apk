...
{
  public dri(BaseActionBarDataLineFile paramBaseActionBarDataLineFile) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.cloudType == 6) {
      ...
      {
        paramView = new drj(this);
        localdrk = new drk(this);
    ...
    for (int i = 2131362016;; i = 2131362017)
    {
      ...
      DialogUtil.a(this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser.getActivity(), 230, this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser.getActivity().getString(j), str, 2131362794, 2131361835, paramView, localdrk).show();
      return;
