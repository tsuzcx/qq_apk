...
public class cvr
  extends Handler
{
  public cvr(SaveTrafficHandler paramSaveTrafficHandler, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject = (cvt)((Map.Entry)localObject).getValue();
        if (localObject == null) {
          continue;
        }
        if (((cvt)localObject).a == bool) {
          break label152;
        }
    ...
    {
      int i = this.a.a();
      paramMessage = new cvt(this.a, i, bool);
