...
public class ExtendLruCache
{
  ...
  {
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache = new flq(this, paramInt);
  }
  
  private void b()
  {
    for (flr localflr = (flr)this.jdField_a_of_type_JavaLangRefReferenceQueue.poll(); localflr != null; localflr = (flr)this.jdField_a_of_type_JavaLangRefReferenceQueue.poll()) {
      this.jdField_a_of_type_JavaUtilHashMap.remove(localflr.a);
    }
  }
  ...
  public final Object a(Object paramObject)
  {
    for (;;)
    {
      try
      {
        ...
        paramObject = (flr)this.jdField_a_of_type_JavaUtilHashMap.get(paramObject);
        if (paramObject != null)
        {
  ...
  public final Object a(Object paramObject1, Object paramObject2)
  {
    ...
    //   31: invokespecial 112	flr:<init>	(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/ref/ReferenceQueue;)V
    ...
    //   50: areturn
    //   51: aload_1
    //   52: invokevirtual 64	flr:get	()Ljava/lang/Object;
    //   55: astore_1
    //   56: goto -9 -> 47
    //   59: astore_1
    //   60: aload_0
  ...
  public final Object b(Object paramObject)
  {
    ...
    //   43: goto -10 -> 33
    //   46: aload_1
    //   47: invokevirtual 64	flr:get	()Ljava/lang/Object;
    //   50: astore_1
    //   51: goto -18 -> 33
    //   54: astore_1
    //   55: aload_0
  ...
  public final Object b(Object paramObject, ExtendLruCache.Matcher paramMatcher)
  {
    ...
    for (;;)
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        localObject1 = (flr)this.jdField_a_of_type_JavaUtilHashMap.remove(paramMatcher);
        if (paramObject == null) {
          if (localObject1 == null) {
            paramObject = null;
          } else {
            paramObject = ((flr)localObject1).get();
          }
        }
      }
      else
