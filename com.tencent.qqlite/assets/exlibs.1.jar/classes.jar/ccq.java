...
{
  public ccq(AddContactsActivity paramAddContactsActivity) {}
  ...
  public void a()
  {
    ...
    AddContactsActivity.a(this.a, 2130837660);
    ...
    localTranslateAnimation.setAnimationListener(new ccr(this));
  ...
  public void b()
  {
    ...
    localTranslateAnimation.setDuration(250L);
    localTranslateAnimation.setFillAfter(true);
    localTranslateAnimation.setAnimationListener(new ccs(this));
    this.a.jdField_a_of_type_AndroidWidgetLinearLayout.startAnimation(localTranslateAnimation);
  }
}
