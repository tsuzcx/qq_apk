  ...
  implements View.OnTouchListener
{
  ...
  public bbv(QQBrowserActivity paramQQBrowserActivity) {}
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.f = k;
      this.h = k;
      paramView.setBackgroundResource(2130838225);
      continue;
      if (QQBrowserActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity).getVisibility() != 0)
      {
        ...
        paramView.setBackgroundResource(2130838224);
        ...
        else
        {
          ...
          if (this.jdField_a_of_type_Int + paramView.getWidth() / 2 < this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.z / 2)
          {
            ...
            QQBrowserActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity).setBackgroundResource(2130838223);
          ...
          else
          {
            ...
            QQBrowserActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity).setBackgroundResource(2130838222);
            paramView = (FrameLayout.LayoutParams)QQBrowserActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity).getLayoutParams();
    ...
    for (;;)
    {
      ...
      paramMotionEvent.setAnimationListener(new bbw(this, paramView));
