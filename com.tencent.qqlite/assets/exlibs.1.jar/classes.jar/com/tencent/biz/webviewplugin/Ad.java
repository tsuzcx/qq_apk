  ...
  implements View.OnClickListener
{
  ...
  Runnable jdField_a_of_type_JavaLangRunnable = new rs(this);
  ...
  public Ad(QQBrowserActivity paramQQBrowserActivity, AppInterface paramAppInterface)
  {
    ...
    this.jdField_b_of_type_JavaLangRunnable = new rt(this);
  ...
  private void l()
  {
    ...
    this.jdField_b_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new ro(this));
    this.jdField_d_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new rp(this));
    ...
    this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new rq(this));
    this.jdField_c_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new rr(this));
  }
  ...
  public void e()
  {
    ...
    if (this.jdField_a_of_type_MqqAppNewIntent == null)
    {
      ...
      this.jdField_a_of_type_MqqObserverBusinessObserver = new rn(this);
  ...
  public void i()
  {
    ...
    for (;;)
    {
      ...
      this.h = true;
      ReportController.b(null, "P_CliOper", "Pb_account_lifeservice", "", "msg_webview_bottom", "msg_webview_pvqq", 0, 1, 0, Util.b(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.d(), new String[0]), "", "", "");
      return;
