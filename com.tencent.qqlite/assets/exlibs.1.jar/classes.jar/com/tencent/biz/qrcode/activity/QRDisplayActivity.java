  ...
  implements View.OnClickListener, AdapterView.OnItemClickListener, CodeMaskManager.Callback
{
  ...
  QRDisplayActivity.GetNicknameObserver jdField_a_of_type_ComTencentBizQrcodeActivityQRDisplayActivity$GetNicknameObserver = new pq(this);
  public DiscussionHandler a;
  DiscussionObserver jdField_a_of_type_ComTencentMobileqqAppDiscussionObserver = new pt(this);
  ...
  public QRDisplayActivity()
  {
    ...
    this.jdField_a_of_type_JavaLangRunnable = new pu(this);
    this.jdField_b_of_type_JavaLangRunnable = new pw(this);
    this.jdField_c_of_type_JavaLangRunnable = new px(this);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (int n = 0;; n = 1)
        {
          ...
          Collections.sort(this.jdField_b_of_type_JavaUtilList, new qd(this));
  ...
  public void onItemClick(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqWxapiWXShareHelper$WXShareListener == null)
      {
        this.jdField_a_of_type_ComTencentMobileqqWxapiWXShareHelper$WXShareListener = new ps(this);
