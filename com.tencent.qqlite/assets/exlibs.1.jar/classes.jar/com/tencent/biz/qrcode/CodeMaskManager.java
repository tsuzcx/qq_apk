...
public class CodeMaskManager
{
  ...
  private void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_JavaLangThread = new op(this, localSharedPreferences, localDisplay.getWidth(), i, paramInt);
  ...
  private boolean a(String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   106: ifnull -21 -> 85
    //   109: aload_1
    //   110: invokevirtual 420	java/io/FileOutputStream:close	()V
    //   113: iconst_0
    //   114: ireturn
    //   115: astore_1
    //   116: iconst_0
  ...
  public void a(CodeMaskManager.Callback paramCallback, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    localObject = new os(this, paramCallback, (Bundle)localObject);
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new or(this, (os)localObject, paramCallback), 10000L);
    ((os)localObject).start();
  }
}
