  ...
  implements Camera.PreviewCallback, SurfaceHolder.Callback, Comparator
{
  ...
  private sv jdField_a_of_type_Sv;
  sx jdField_a_of_type_Sx;
  private td jdField_a_of_type_Td;
  ...
  public ScannerView(Context paramContext)
  {
    ...
    this.d = false;
    this.jdField_b_of_type_AndroidOsHandler = new su(this);
    a(paramContext, null);
  }
  ...
  private void a(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if ((paramAttributeSet != null) && (paramAttributeSet.getAttributeBooleanValue(0, true)))
    {
      ...
      this.jdField_a_of_type_Td = new td(paramContext);
      addView(this.jdField_a_of_type_Td);
    }
  ...
  private boolean c()
  {
    ...
    //   29: ifeq +34 -> 63
    //   32: aload_0
    //   33: getfield 402	com/tencent/biz/widgets/ScannerView:jdField_a_of_type_Sv	Lsv;
    //   36: ifnull +20 -> 56
    //   39: aload_0
    //   40: getfield 402	com/tencent/biz/widgets/ScannerView:jdField_a_of_type_Sv	Lsv;
    //   43: invokevirtual 407	sv:isAlive	()Z
    //   46: ifeq +10 -> 56
    //   49: aload_0
    //   50: getfield 402	com/tencent/biz/widgets/ScannerView:jdField_a_of_type_Sv	Lsv;
    //   53: invokevirtual 410	sv:interrupt	()V
    //   56: aload_0
    ...
    //   438: invokespecial 499	sv:<init>	(Landroid/hardware/Camera;)V
    //   441: putfield 402	com/tencent/biz/widgets/ScannerView:jdField_a_of_type_Sv	Lsv;
    //   444: aload_0
    //   445: getfield 402	com/tencent/biz/widgets/ScannerView:jdField_a_of_type_Sv	Lsv;
    //   448: invokevirtual 502	sv:start	()V
    //   451: aload_0
  ...
  private void e()
  {
    ...
    //   23: return
    //   24: aload_0
    //   25: getfield 402	com/tencent/biz/widgets/ScannerView:jdField_a_of_type_Sv	Lsv;
    //   28: ifnull +20 -> 48
    //   31: aload_0
    //   32: getfield 402	com/tencent/biz/widgets/ScannerView:jdField_a_of_type_Sv	Lsv;
    //   35: invokevirtual 407	sv:isAlive	()Z
    //   38: ifeq +10 -> 48
    //   41: aload_0
    //   42: getfield 402	com/tencent/biz/widgets/ScannerView:jdField_a_of_type_Sv	Lsv;
    //   45: invokevirtual 410	sv:interrupt	()V
    //   48: aload_0
  ...
  public void a()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      if ((b()) && (c()))
      {
        if (this.jdField_a_of_type_Td != null) {
          this.jdField_a_of_type_Td.a();
        }
  ...
  public void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Sx == null) {}
    try
    {
      if (this.jdField_a_of_type_Sx == null)
      {
        this.jdField_a_of_type_Sx = new sx("ScannerDecodeThread");
        this.jdField_a_of_type_Sx.start();
        this.jdField_a_of_type_AndroidOsHandler = new sw(this, this.jdField_a_of_type_Sx.getLooper());
      }
      if (this.jdField_a_of_type_Sx.jdField_a_of_type_Boolean) {
        return;
      }
    }
    finally {}
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Sv != null) && (this.jdField_a_of_type_Sv.isAlive())) {
      this.jdField_a_of_type_Sv.interrupt();
    }
    for (;;)
    {
      try
      ...
      {
        this.jdField_a_of_type_Sv = new sv(this.jdField_a_of_type_AndroidHardwareCamera);
        this.jdField_a_of_type_Sv.start();
      }
      this.d = paramBoolean;
      return paramBoolean;
      str = "off";
  ...
  protected void onDetachedFromWindow()
  {
    ...
    try
    {
      if ((this.jdField_a_of_type_Sx != null) && (!this.jdField_a_of_type_Sx.jdField_a_of_type_Boolean))
      {
        this.jdField_a_of_type_Sx.quit();
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.jdField_a_of_type_Td != null)
    {
      this.jdField_a_of_type_Td.layout(0, 0, paramInt3 - paramInt1, paramInt4 - paramInt2);
      if (this.A != -1) {
        break label167;
      }
      int i1 = this.x;
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidGraphicsRect = null;
      this.jdField_a_of_type_Td.a(paramInt3, paramInt4, paramInt1, paramInt2);
      return;
      label167:
      if ((this.C & 0x3) == 3)
      {
  ...
  public void setViewFinder(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.jdField_a_of_type_Td == null)
    {
      this.jdField_a_of_type_Td = new td(getContext());
      addView(this.jdField_a_of_type_Td);
      return;
    }
    this.jdField_a_of_type_AndroidGraphicsRect = new Rect(paramInt1, paramInt2, paramInt3, paramInt4);
    this.jdField_b_of_type_AndroidGraphicsRect = null;
    this.jdField_a_of_type_Td.a(paramInt1, paramInt2, paramInt3, paramInt4);
  }
