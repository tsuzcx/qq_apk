...
public class ViewPluginManager
{
  ...
  public void a()
  {
    ...
    if ((!HtmlOffline.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getApplicationContext(), str, new rl(this, l))) && (QLog.isColorLevel())) {
  ...
  public void b()
  {
    ...
    HtmlOffline.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getApplicationContext(), str, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppRuntime().getAccount(), new rm(this));
  }
}
