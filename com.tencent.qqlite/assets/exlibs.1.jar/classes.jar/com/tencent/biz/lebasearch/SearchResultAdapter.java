  ...
  extends BaseAdapter
{
  ...
  public void a(JSONArray paramJSONArray)
  {
    ...
    if (i < this.jdField_a_of_type_OrgJsonJSONArray.length())
    {
      ...
      {
        localnw.jdField_a_of_type_JavaLangObject = paramJSONArray.optString("result_name");
        localnw.jdField_a_of_type_JavaLangString = paramJSONArray.optString("result_name");
      }
      Object localObject;
      ...
      for (;;)
      {
        i += 1;
        break;
        this.jdField_a_of_type_JavaUtilList.add(localnw);
        int j = 0;
        while (j < ((JSONArray)localObject).length())
        {
          localnw = new nw(this);
          localnw.d = 2;
          localnw.jdField_a_of_type_JavaLangObject = ((JSONArray)localObject).optJSONObject(j);
          localnw.jdField_a_of_type_JavaLangString = paramJSONArray.optString("result_name");
          this.jdField_a_of_type_JavaUtilList.add(localnw);
          j += 1;
        }
        ...
        {
          localObject = new nw(this);
          ((nw)localObject).d = 3;
          ((nw)localObject).jdField_a_of_type_JavaLangObject = paramJSONArray.optString("more_url");
          ((nw)localObject).jdField_a_of_type_JavaLangString = paramJSONArray.optString("result_name");
          ((nw)localObject).b = paramJSONArray.optString("more_name");
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    nw localnw = (nw)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    if (localnw.d == 1)
    {
      paramView = new TextView((Context)localObject2);
      paramView.setBackgroundColor(((Context)localObject2).getResources().getColor(2131427417));
      ...
      paramView.setText((String)localnw.jdField_a_of_type_JavaLangObject);
    ...
    if (localnw.d == 2)
    {
      localObject1 = (JSONObject)localnw.jdField_a_of_type_JavaLangObject;
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        paramViewGroup = (URLImageView)paramView.findViewById(2131297552);
        localObject2 = (TextView)paramView.findViewById(2131297553);
      ...
      if (localnw.d == 3)
      {
        ...
        localObject1 = (TextView)paramView.findViewById(2131297551);
        if (!TextUtils.isEmpty(localnw.b)) {
          ((TextView)localObject1).setText(localnw.b);
        }
