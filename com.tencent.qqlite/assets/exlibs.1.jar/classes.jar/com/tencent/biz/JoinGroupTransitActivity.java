  ...
  extends BaseActivity
{
  ...
  private jr jdField_a_of_type_Jr;
  ...
  private void c()
  {
    try
    {
      ...
      this.jdField_a_of_type_Jr = new jr(this);
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    c();
    this.jdField_a_of_type_ComTencentBizJoinGroupHandler = new JoinGroupHandler(this, this.app, this.jdField_a_of_type_Int, this.d, new jq(this));
    this.jdField_a_of_type_ComTencentBizJoinGroupHandler.a();
    this.jdField_a_of_type_Jr.sendEmptyMessage(0);
    return true;
  }
