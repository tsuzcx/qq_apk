  ...
  extends AgentBaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      paramViewGroup = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903628, paramViewGroup, false);
    ...
    paramView.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130838119);
