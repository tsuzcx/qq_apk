  ...
  implements TextWatcher, View.OnClickListener, HttpCgiAsyncTask.Callback, HttpImageDownloadAsyncTask.TaskCompleteCallback
{
  ...
  protected void c()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentOpenWidgetCursorEditText.setText(this.f);
  ...
  protected boolean c()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("description")) {
        this.f = StringAddition.a(this.jdField_a_of_type_AndroidOsBundle.getString("description"), 80, false, false);
      }
      ...
      this.h = ServerSetting.a().a("http://fusion.qq.com/cgi-bin/qzapps/mapp_getuserinfo.cgi");
      this.i = ServerSetting.a().a("http://fusion.qq.com/cgi-bin/appstage/mapp_sendstory.cgi");
      return true;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      return;
    } while (paramView != this.jdField_e_of_type_AndroidWidgetTextView);
