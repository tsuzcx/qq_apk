  ...
  extends InnerFrame
{
  ...
  {
    super.a(paramBundle);
    this.jdField_a_of_type_ComTencentOpenAgentSocialFriendChooser = ((SocialFriendChooser)super.a());
    ...
    this.jdField_a_of_type_AndroidViewLayoutInflater = this.jdField_a_of_type_ComTencentOpenAgentSocialFriendChooser.getLayoutInflater();
