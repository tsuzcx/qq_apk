  ...
  implements View.OnClickListener, HttpImageDownloadAsyncTask.TaskCompleteCallback
{
  ...
  protected static final String C = AppConstants.as + "coupon/";
  ...
  public static final String p = AppConstants.as + "qqconnect/";
  ...
  public AuthorityActivity()
  {
    ...
    this.jdField_a_of_type_MqqObserverSSOAccountObserver = new fci(this);
    this.jdField_a_of_type_JavaLangRunnable = new fcl(this);
    this.jdField_a_of_type_AndroidOsHandler = new fcp(this);
    this.jdField_b_of_type_JavaLangRunnable = new fcj(this);
  }
  ...
  public void a(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    ReportCenter.a().a(this.m, "", A, "1", "3", "0", true);
  }
  ...
  public void a(long paramLong)
  {
    ...
    for (Object localObject1 = "";; localObject1 = Build.VERSION.RELEASE)
    {
      ...
      localNewIntent.setObserver(new fcn(this));
  ...
  public void a(SdkAuthorize.GetAuthApiListRequest paramGetAuthApiListRequest)
  {
    ...
    if (!this.i)
    {
      if ((this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity$AccountInfo.jdField_a_of_type_ArrayOfByte == null) || (this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity$AccountInfo.jdField_a_of_type_ArrayOfByte.length == 0))
      {
        ...
        paramGetAuthApiListRequest.obj = getResources().getString(2131363839);
    ...
    this.w = 0;
    localNewIntent.setObserver(new fck(this));
    super.getAppRuntime().startServlet(localNewIntent);
    this.jdField_a_of_type_AndroidOsHandler.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(this.jdField_a_of_type_JavaLangRunnable, 30000L);
  ...
  protected void a(String paramString)
  {
    ...
    localObject = this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.a(paramString, (int)(58.0F * this.jdField_a_of_type_Float), true);
    paramString = null;
    if (localObject != null)
    {
      paramString = AuthorityUtil.a(this, (Bitmap)localObject, 63, 63);
      ((Bitmap)localObject).recycle();
    }
    this.jdField_a_of_type_ComTencentOpenAgentCardContainer.a(this.m, str, paramString, false);
  }
  
  public void a(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    paramString = DialogUtil.b(this, 230).setMessageWithUrl(paramString).setTitle(super.getString(2131363284)).setPositiveButton(17039370, paramOnClickListener);
  ...
  public void a(String paramString, Bitmap paramBitmap)
  {
    ...
    {
      paramString = AuthorityUtil.a(this, paramBitmap, 63, 63);
      if (paramString == null) {}
    }
    try
    {
      ...
      runOnUiThread(new fcu(this, paramString));
      return;
    }
  ...
  public void a(String paramString1, String paramString2, long paramLong, byte[] paramArrayOfByte)
  {
    ...
    //   0: aconst_null
    //   1: astore 8
    //   3: new 663	java/io/File
    //   6: dup
    //   7: getstatic 152	com/tencent/open/agent/AuthorityActivity:p	Ljava/lang/String;
    //   10: invokespecial 664	java/io/File:<init>	(Ljava/lang/String;)V
    //   13: astore 9
    //   15: aload 9
    //   17: invokevirtual 667	java/io/File:exists	()Z
    //   20: ifne +118 -> 138
    //   23: aload 9
    //   25: invokevirtual 670	java/io/File:mkdirs	()Z
    //   28: pop
    //   29: new 132	java/lang/StringBuilder
    //   32: dup
    //   33: invokespecial 135	java/lang/StringBuilder:<init>	()V
    //   36: aload_1
    ...
    //   50: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   53: invokestatic 675	com/tencent/mobileqq/utils/HexUtil:b	(Ljava/lang/String;)Ljava/lang/String;
    //   56: astore_2
    //   57: new 663	java/io/File
    //   60: dup
    //   61: aload 9
    //   63: aload_2
    //   64: invokespecial 678	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   67: astore_1
    //   68: aload_1
    //   69: invokevirtual 667	java/io/File:exists	()Z
    //   72: ifeq +8 -> 80
    //   75: aload_1
    //   76: invokevirtual 681	java/io/File:delete	()Z
    //   79: pop
    //   80: invokestatic 687	java/lang/System:currentTimeMillis	()J
    //   83: ldc2_w 306
    //   86: ldiv
    //   87: lstore 6
    //   89: new 689	java/io/DataOutputStream
    //   92: dup
    //   93: new 440	java/io/FileOutputStream
    //   96: dup
    //   97: aload_1
    //   98: invokespecial 443	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   101: invokespecial 692	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   104: astore_1
    //   105: aload_1
    //   106: lload 6
    //   108: lload_3
    //   109: ladd
    //   110: invokevirtual 695	java/io/DataOutputStream:writeLong	(J)V
    //   113: aload_1
    //   114: aload 5
    //   116: aload_2
    //   117: ldc_w 697
    //   120: invokevirtual 701	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   123: invokestatic 706	com/tencent/util/ThreeDes:a	([B[B)[B
    //   126: invokevirtual 709	java/io/DataOutputStream:write	([B)V
    //   129: aload_1
    //   130: ifnull +7 -> 137
    //   133: aload_1
    //   134: invokevirtual 710	java/io/DataOutputStream:close	()V
    //   137: return
    //   138: aload 9
    //   140: invokevirtual 713	java/io/File:isFile	()Z
    //   143: ifeq -114 -> 29
    //   146: aload 9
    //   148: invokevirtual 681	java/io/File:delete	()Z
    //   151: pop
    //   152: aload 9
    //   154: invokevirtual 670	java/io/File:mkdirs	()Z
    //   157: pop
    //   158: goto -129 -> 29
    //   161: astore_1
    //   162: aload 8
    ...
    //   166: ifnull -29 -> 137
    //   169: aload_1
    //   170: invokevirtual 710	java/io/DataOutputStream:close	()V
    //   173: return
    //   174: astore_1
    //   175: aload_1
    //   176: invokevirtual 255	java/io/IOException:printStackTrace	()V
    //   179: return
    //   180: astore_1
    //   181: aload_1
    //   182: invokevirtual 255	java/io/IOException:printStackTrace	()V
    //   185: return
    //   186: astore_2
    //   187: aconst_null
    //   188: astore_1
    ...
    //   190: ifnull +7 -> 197
    //   193: aload_1
    //   194: invokevirtual 710	java/io/DataOutputStream:close	()V
    //   197: aload_2
    //   198: athrow
    //   199: astore_1
    //   200: aload_1
    //   201: invokevirtual 255	java/io/IOException:printStackTrace	()V
    //   204: goto -7 -> 197
    //   207: astore_2
    //   208: goto -19 -> 189
    //   211: astore_2
  ...
  public byte[] a(String paramString1, String paramString2)
  {
    ...
    //   0: aconst_null
    //   1: astore 5
    //   3: new 132	java/lang/StringBuilder
    //   6: dup
    ...
    //   27: invokestatic 675	com/tencent/mobileqq/utils/HexUtil:b	(Ljava/lang/String;)Ljava/lang/String;
    //   30: astore_2
    //   31: new 663	java/io/File
    //   34: dup
    //   35: new 132	java/lang/StringBuilder
    //   38: dup
    //   39: invokespecial 135	java/lang/StringBuilder:<init>	()V
    //   42: getstatic 152	com/tencent/open/agent/AuthorityActivity:p	Ljava/lang/String;
    ...
    //   55: invokespecial 664	java/io/File:<init>	(Ljava/lang/String;)V
    //   58: astore_1
    //   59: aload_1
  ...
  public void b(int paramInt, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      a(String.format(super.getString(2131363837), new Object[] { Integer.valueOf(paramInt) }), new fcv(this));
    }
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(true);
    this.jdField_a_of_type_AndroidWidgetButton.setText(2131363839);
  ...
  public void b(String paramString)
  {
    ...
    if ((TextUtils.isEmpty(A)) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity$AccountInfo.jdField_a_of_type_JavaLangString))) {
      return;
    }
    localEditor.putString(A + ":" + this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity$AccountInfo.jdField_a_of_type_JavaLangString, paramString);
    localEditor.commit();
  }
  
  public void b(String paramString1, String paramString2)
  {
    StatisticCollector.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface, paramString1, A + "|" + paramString2 + "|" + this.G);
  }
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_z_of_type_JavaLangString != null))
    {
      String str2 = this.jdField_z_of_type_JavaLangString;
      String str1 = str2;
      if (this.jdField_z_of_type_JavaLangString != null)
      {
        str1 = str2;
        if (this.jdField_z_of_type_JavaLangString.length() > 12) {
          str1 = this.jdField_z_of_type_JavaLangString.substring(0, 12) + "...";
        }
      }
      this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(getResources().getString(2131363835), new Object[] { str1 }));
    }
    c(str3);
  }
  ...
  public void c(int paramInt, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {}
    for (paramString = String.format(super.getString(2131363837), new Object[] { Integer.valueOf(paramInt) });; paramString = String.format(super.getString(2131363841), new Object[] { paramString, Integer.valueOf(paramInt) }))
    {
      a(paramString, new fcw(this, paramInt, localJSONObject));
      return;
    }
  }
  ...
  protected void f()
  {
    this.jdField_h_of_type_AndroidWidgetTextView.setText(2131363834);
    ...
    this.x = ((String)super.getText(2131363829));
    this.jdField_y_of_type_JavaLangString = ((String)super.getText(2131363833));
  ...
  public void h()
  {
    ...
    if (!this.jdField_a_of_type_MqqManagerWtloginManager.IsNeedLoginWithPasswd(str, 16))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.a(getResources().getString(2131363840));
  ...
  protected void i()
  {
    ...
    if ((this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("firstlogin", true)) && (this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.getAccount() == null))
    {
      ...
      ((HashMap)localObject).put("appid", A);
  ...
  public void l()
  {
    ...
    ((NewIntent)localObject5).setObserver(new fco(this));
  ...
  public void onClick(View paramView)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.removeCallbacks(this.jdField_b_of_type_JavaLangRunnable);
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
    if ((this.jdField_j_of_type_Boolean) || (this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity$AccountInfo == null))
    {
      h();
      return;
    }
    if (this.w == 0)
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.a(super.getString(2131363840));
      if ((!super.isFinishing()) && (!this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.isShowing())) {
        this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.show();
      }
      k();
    ...
    if (this.jdField_a_of_type_AndroidWidgetButton.getText().equals(super.getString(2131363839)))
    {
      h();
      return;
    }
    ...
    for (;;)
    {
      ReportCenter.a().a(this.m, "", A, "1", "2", "0", false);
      return;
      if (QLog.isColorLevel()) {
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidOsBundle = super.getIntent().getBundleExtra("key_params");
    A = this.jdField_a_of_type_AndroidOsBundle.getString("client_id");
    f();
    this.jdField_z_of_type_JavaLangString = this.jdField_a_of_type_AndroidOsBundle.getString("oauth_app_name");
    ...
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.show();
      if (this.jdField_z_of_type_JavaLangString != null) {
        this.jdField_a_of_type_ComTencentOpenAgentCardContainer.a(this.jdField_z_of_type_JavaLangString, null);
      }
    ...
    for (;;)
    {
      ...
      ReportCenter.a().a(this.m, "", A, "1", "1", "0", false);
      return;
      d();
      if (!TextUtils.isEmpty(this.m)) {
        a("" + this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.a(this.jdField_a_of_type_MqqManagerWtloginManager, this.m));
