  ...
  extends RelativeLayout
{
  ...
  public CardContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new fdj(this, Looper.getMainLooper());
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new fdk(this);
    new DisplayMetrics();
  ...
  public void a(String paramString1, String paramString2, Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      paramString1 = String.format(super.getContext().getString(2131362149), new Object[] { paramString1 });
  ...
  protected void onFinishInflate()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131297470));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131297458));
    this.jdField_a_of_type_ComTencentOpenAgentCardLargeView = ((CardLargeView)super.findViewById(2131297459));
    this.jdField_a_of_type_ComTencentMobileqqWidgetAnyScaleTypeImageView = ((AnyScaleTypeImageView)super.findViewById(2131297475));
    this.jdField_b_of_type_ComTencentMobileqqWidgetAnyScaleTypeImageView = ((AnyScaleTypeImageView)super.findViewById(2131297463));
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131297460);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131297473));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131297477));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297474));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297478));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297479));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131297461));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131297465));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297462));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297467));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297468));
    this.g = ((TextView)super.findViewById(2131297469));
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)super.findViewById(2131297482));
  }
  
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    super.onMeasure(paramInt1, paramInt2);
    float f1 = super.getResources().getDimension(2131493113);
