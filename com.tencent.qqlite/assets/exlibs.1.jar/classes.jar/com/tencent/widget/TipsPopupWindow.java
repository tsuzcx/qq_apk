  ...
  implements TipsLinearLayout.TipsLayoutAnimListener
{
  ...
  private fle jdField_a_of_type_Fle;
  ...
  {
    float f = this.jdField_a_of_type_AndroidWidgetFrameLayout.getResources().getDimension(2131492868);
  ...
  {
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2130903116, null));
    this.jdField_a_of_type_ComTencentWidgetTipsLinearLayout = ((TipsLinearLayout)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131296838));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131296840));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131296839));
    Display localDisplay = ((WindowManager)paramContext.getSystemService("window")).getDefaultDisplay();
    localDisplay.getMetrics(new DisplayMetrics());
    int i = localDisplay.getWidth();
    int j = localDisplay.getHeight();
    int k = (int)paramContext.getResources().getDimension(2131492867);
    ...
    j = (int)paramContext.getResources().getDimension(2131492869);
    ((FrameLayout.LayoutParams)this.jdField_a_of_type_ComTencentWidgetTipsLinearLayout.getLayoutParams()).width = (i - j * 2);
    paramContext = paramContext.getResources().getDrawable(2130839480);
    ...
    setAnimationStyle(2131624079);
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentWidgetTipsLinearLayout.setmTipsLayoutAnimListener(this);
    this.jdField_a_of_type_Fle = new fle(this);
  }
  
  private void d()
  {
    if (this.jdField_c_of_type_Boolean) {
      this.jdField_a_of_type_AndroidWidgetFrameLayout.postDelayed(this.jdField_a_of_type_Fle, 1000L);
    }
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.removeCallbacks(this.jdField_a_of_type_Fle);
  }
  ...
  public void a(Activity paramActivity, boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean) {
      this.jdField_a_of_type_AndroidWidgetFrameLayout.postDelayed(new flc(this), paramInt);
    }
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_AndroidWidgetFrameLayout.post(new fld(this));
  }
  ...
  public void dismiss()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.removeCallbacks(this.jdField_a_of_type_Fle);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.postDelayed(this.jdField_a_of_type_Fle, 300L);
  }
