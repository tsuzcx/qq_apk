  ...
  implements PageIndicator
{
  ...
  {
    this(paramContext, paramAttributeSet, 2130772015);
  }
  ...
  public CirclePageIndicator(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    int i = ((Resources)localObject).getColor(2131427402);
    int j = ((Resources)localObject).getColor(2131427401);
    int k = ((Resources)localObject).getColor(2131427403);
    float f1 = ((Resources)localObject).getDimension(2131493047);
    float f2 = ((Resources)localObject).getDimension(2131493046);
    paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.b, paramInt, 0);
    ...
    this.g = ViewConfigurationCompat.getScaledPagingTouchSlop(ViewConfiguration.get(paramContext));
  }
  ...
  public float a()
  {
    return this.jdField_b_of_type_AndroidGraphicsPaint.getStrokeWidth();
  }
  ...
  public int c()
  {
    return this.jdField_c_of_type_AndroidGraphicsPaint.getColor();
  }
  ...
  {
    if ((this.jdField_b_of_type_Boolean) || (this.d == 0))
    {
  ...
  public void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    this.jdField_b_of_type_Int = paramParcelable.a;
    this.jdField_c_of_type_Int = paramParcelable.a;
    requestLayout();
  }
  ...
  public Parcelable onSaveInstanceState()
  {
    ...
    localSavedState.a = this.jdField_b_of_type_Int;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      do
      {
        ...
        do
        {
          do
          {
            do
            {
              ...
              case 0: 
                ...
                return true;
              case 2: 
                f1 = MotionEventCompat.getX(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, this.h));
                f2 = f1 - this.jdField_c_of_type_Float;
                if ((!this.jdField_c_of_type_Boolean) && (Math.abs(f2) > this.g)) {
          ...
          f1 = k / 2.0F;
          f2 = k / 6.0F;
          if ((this.jdField_b_of_type_Int <= 0) || (paramMotionEvent.getX() >= f1 - f2)) {
            break;
          }
        } while (j == 3);
        this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setCurrentItem(this.jdField_b_of_type_Int - 1);
        return true;
        if ((this.jdField_b_of_type_Int >= i - 1) || (paramMotionEvent.getX() <= f2 + f1)) {
          break;
        }
      } while (j == 3);
      this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setCurrentItem(this.jdField_b_of_type_Int + 1);
    ...
    this.h = MotionEventCompat.getPointerId(paramMotionEvent, i);
    return true;
    int j = MotionEventCompat.getActionIndex(paramMotionEvent);
    if (MotionEventCompat.getPointerId(paramMotionEvent, j) == this.h)
    {
      if (j == 0) {
        i = 1;
      }
    ...
    this.jdField_c_of_type_Float = MotionEventCompat.getX(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, this.h));
    return true;
  }
