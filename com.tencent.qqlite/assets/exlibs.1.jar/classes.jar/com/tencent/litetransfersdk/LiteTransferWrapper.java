...
public class LiteTransferWrapper
{
  ...
  private void _PbMsgRecive(MsgCSBody paramMsgCSBody)
  {
    ...
    {
      new Handler(localLooper).post(new uj(this, paramMsgCSBody));
      return;
    }
    SetProxyToJni();
  ...
  public void CancelAll(int paramInt)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new up(this, paramInt));
      return;
    }
  ...
  public void CancelGroup(int paramInt1, long paramLong, int paramInt2, boolean paramBoolean)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new ud(this, paramInt1, paramLong, paramInt2, paramBoolean));
      return;
    }
  ...
  public void OnFileComing210_0x2(long paramLong1, long paramLong2, long paramLong3, String paramString1, long paramLong4, byte[] paramArrayOfByte1, String paramString2, byte[] paramArrayOfByte2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong5, long paramLong6, long paramLong7, boolean paramBoolean)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new ul(this, paramLong1, paramLong2, paramLong3, paramString1, paramLong4, paramArrayOfByte1, paramString2, paramArrayOfByte2, paramInt1, paramInt2, paramInt3, paramInt4, paramLong5, paramLong6, paramLong7, paramBoolean));
      return;
    }
  ...
  public void RecvGroup(Session[] paramArrayOfSession, NFCInfo[] paramArrayOfNFCInfo, FTNInfo[] paramArrayOfFTNInfo, boolean paramBoolean)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new us(this, paramArrayOfSession, paramArrayOfNFCInfo, paramArrayOfFTNInfo, paramBoolean));
      return;
    }
    SetProxyToJni();
  ...
  public void SendGroup(ArrayList paramArrayList, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new ur(this, paramArrayList, paramBoolean1, paramBoolean2));
      return;
    }
    SetProxyToJni();
  ...
  public void SetDefaultPath(String paramString)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new ue(this, paramString));
      return;
    }
  ...
  public void SetServicePath(String paramString1, String paramString2)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new ug(this, paramString1, paramString2));
      return;
    }
  ...
  public void SetTempPath(String paramString)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new uh(this, paramString));
      return;
    }
  ...
  public void SetThumbPath(String paramString)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new uf(this, paramString));
      return;
    }
  ...
  public void SyncGroup(Session[] paramArrayOfSession)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new uq(this, paramArrayOfSession));
      return;
    }
  ...
  public void beginLiteTransfer()
  {
    Looper localLooper = Looper.getMainLooper();
    if (Thread.currentThread() != localLooper.getThread()) {
      new Handler(localLooper).post(new un(this));
    }
  ...
  public void doPbMsgReply(int paramInt, MsgSCBody paramMsgSCBody)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new uk(this, paramInt, paramMsgSCBody));
      return;
    }
  ...
  public void endLiteTransfer(boolean paramBoolean)
  {
    Looper localLooper = Looper.getMainLooper();
    if (Thread.currentThread() != localLooper.getThread()) {
      new Handler(localLooper).post(new uo(this, paramBoolean));
    }
    do
    {
      return;
  ...
  public void onFileComing210_0xa(long paramLong1, long paramLong2, long paramLong3, String paramString, long paramLong4, byte[] paramArrayOfByte1, long paramLong5, long paramLong6, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong7, long paramLong8, long paramLong9, boolean paramBoolean)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new um(this, paramLong1, paramLong2, paramLong3, paramString, paramLong4, paramArrayOfByte1, paramLong5, paramLong6, paramArrayOfByte2, paramArrayOfByte3, paramArrayOfByte4, paramInt1, paramInt2, paramInt3, paramInt4, paramLong7, paramLong8, paramLong9, paramBoolean));
      return;
    }
  ...
  public void onFileOperate0x210(long paramLong1, long paramLong2, int paramInt1, int paramInt2, short paramShort)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new uc(this, paramLong1, paramLong2, paramInt1, paramInt2, paramShort));
      return;
    }
