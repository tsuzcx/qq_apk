  ...
  extends b
{
  ...
  {
    k.b("TMAssistantDownloadSDKClient", "OnDownloadStateChanged,clientKey:" + paramString1 + ",state:" + paramInt1 + ", errorcode" + paramInt2 + ",url:" + paramString2);
    ...
    while (paramString1.hasNext())
    {
      ...
      if (localITMAssistantDownloadSDKClientListener == null) {
        k.b("TMAssistantDownloadSDKClient", " listener = " + localITMAssistantDownloadSDKClientListener + "   linstenerWeakReference :" + localWeakReference);
      }
      g.a();
  ...
  {
    k.b("TMAssistantDownloadSDKClient", "OnDownloadProgressChanged,clientKey:" + paramString1 + ",receivedLen:" + paramLong1 + ",totalLen:" + paramLong2 + ",url:" + paramString2);
    paramString1 = this.a.mWeakListenerArrayList.iterator();
    while (paramString1.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)paramString1.next();
