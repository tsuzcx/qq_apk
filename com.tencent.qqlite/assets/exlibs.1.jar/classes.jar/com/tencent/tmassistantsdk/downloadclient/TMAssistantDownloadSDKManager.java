...
public class TMAssistantDownloadSDKManager
{
  ...
  public static void closeAllService(Context paramContext)
  {
    for (;;)
    {
      try
      {
        k.b("TMAssistantDownloadSDKManager", "closeAllService method!");
        if (mInstance == null)
        {
          k.b("TMAssistantDownloadSDKManager", "manager minstance == null");
          return;
        }
  ...
  public TMAssistantDownloadSDKClient getDownloadSDKClient(String paramString)
  {
    ...
    //   3: ifnull +12 -> 15
    //   6: aload_1
    //   7: invokevirtual 113	java/lang/String:length	()I
    //   10: istore_2
    //   11: iload_2
    //   12: ifgt +9 -> 21
    //   15: aconst_null
    ...
    //   49: astore_3
    //   50: aload_3
    //   51: getfield 114	com/tencent/tmassistantsdk/downloadclient/TMAssistantDownloadSDKClient:mClientKey	Ljava/lang/String;
    //   54: aload_1
    //   55: invokevirtual 97	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   58: iconst_1
    //   59: if_icmpne -30 -> 29
    //   62: aload_3
    //   63: astore_1
    ...
    //   75: aload_1
    //   76: invokespecial 117	com/tencent/tmassistantsdk/downloadclient/TMAssistantDownloadSDKClient:<init>	(Landroid/content/Context;Ljava/lang/String;)V
    //   79: astore_1
    //   80: aload_1
    //   81: invokevirtual 118	com/tencent/tmassistantsdk/downloadclient/TMAssistantDownloadSDKClient:initTMAssistantDownloadSDK	()Z
    //   84: pop
    ...
    //   88: aload_1
    //   89: invokevirtual 108	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   92: pop
    //   93: goto -76 -> 17
    //   96: astore_1
    //   97: aload_0
  ...
  public boolean releaseDownloadSDKClient(String paramString)
  {
    ...
    //   31: ifnull -22 -> 9
    //   34: aload 4
    //   36: getfield 114	com/tencent/tmassistantsdk/downloadclient/TMAssistantDownloadSDKClient:mClientKey	Ljava/lang/String;
    //   39: aload_1
    //   40: invokevirtual 97	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   43: iconst_1
    //   44: if_icmpne -35 -> 9
    //   47: aload 4
    ...
    //   73: getfield 128	com/tencent/tmassistantsdk/downloadclient/TMAssistantDownloadSDKSettingClient:mClientKey	Ljava/lang/String;
    //   76: aload_1
    //   77: invokevirtual 97	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   80: iconst_1
    //   81: if_icmpne +18 -> 99
    ...
    //   87: invokevirtual 79	com/tencent/tmassistantsdk/downloadclient/TMAssistantDownloadSDKSettingClient:unInitTMAssistantDownloadSDK	()V
    //   90: aconst_null
