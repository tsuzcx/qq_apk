  ...
  extends f
{
  ...
  public void cancelDownloadTask(String paramString)
  {
    try
    {
      k.b("TMAssistantDownloadSDKClient", "cancelDownloadTask,clientKey:" + this.mClientKey + ",url:" + paramString);
      if (paramString == null) {
  ...
  public TMAssistantDownloadTaskInfo getDownloadTaskState(String paramString)
  {
    try
    {
      k.b("TMAssistantDownloadSDKClient", "getDownloadTaskState,clientKey:" + this.mClientKey + ",url:" + paramString);
      if (paramString == null) {
  ...
  public void pauseDownloadTask(String paramString)
  {
    try
    {
      k.b("TMAssistantDownloadSDKClient", "pauseDownloadTask,clientKey:" + this.mClientKey + ",url:" + paramString);
      if (paramString == null) {
        throw new IllegalArgumentException("TMAssistantDownloadSDKClient.startDownloadTask url is null");
      }
    }
    ...
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          k.b("TMAssistantDownloadSDKClient", "registerDownloadTaskListener removed listener!!!!");
  ...
  public int startDownloadTask(String paramString1, int paramInt, String paramString2, String paramString3, Map paramMap)
  {
    try
    {
      k.b("TMAssistantDownloadSDKClient", "startDownloadTask,clientKey:" + this.mClientKey + ",url:" + paramString1);
