  ...
  implements Handler.Callback, View.OnClickListener, IIconListener, ISameStatusListener, FaceDecoder.DecodeTaskCompletionListener, AbsListView.OnScrollListener, AdapterView.OnItemClickListener, OverScrollViewListener
{
  ...
  private ecd jdField_a_of_type_Ecd;
  ...
  private void a(List paramList)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppCardObserver = new ecb(this);
  ...
  private void f()
  {
    ...
    b(this.g);
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131298865));
    this.jdField_a_of_type_ComTencentWidgetXListView.setContentBackground(2130837633);
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this).inflate(2130903659, this.jdField_a_of_type_ComTencentWidgetXListView, false);
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131297907));
    ...
    this.jdField_a_of_type_Ecd = new ecd(this, null);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ecd);
  }
  ...
  private void j()
  {
    ...
    ((TextView)localView.findViewById(2131297134)).setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131297136));
    this.c = ((TextView)localView.findViewById(2131297135));
    this.d = ((TextView)localView.findViewById(2131297137));
  ...
  public void a(AbsListView paramAbsListView, int paramInt)
  {
    if (this.r != paramInt)
    {
      ...
      if (this.r != 2)
      {
        ...
        this.jdField_a_of_type_Ecd.notifyDataSetChanged();
      }
    }
    else
    {
