  ...
  extends IphoneTitleBarActivity
{
  ...
  private void c()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131298936));
    ...
    this.jdField_a_of_type_ComTencentWidgetProtectedWebView.setWebViewClient(new ecl(this, null));
    this.jdField_a_of_type_ComTencentWidgetProtectedWebView.setWebChromeClient(new eck(this, null));
