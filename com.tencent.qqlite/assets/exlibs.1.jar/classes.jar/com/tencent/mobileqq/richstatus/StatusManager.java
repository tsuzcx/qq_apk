  ...
  implements ebd, Manager
{
  ...
  private ebb jdField_a_of_type_Ebb;
  ...
  private int a()
  {
    ...
    this.jdField_a_of_type_AndroidOsAsyncTask = new eco(this).execute(new Void[0]);
    return 100;
  }
  ...
  public static StatusManager a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (StatusManager localStatusManager1 = (StatusManager)jdField_a_of_type_JavaLangRefWeakReference.get();; localStatusManager1 = null)
    {
      ...
      for (;;)
      {
        ...
        if (localStatusManager1.jdField_a_of_type_Ebb != null)
        {
          localStatusManager1.jdField_a_of_type_Ebb.a();
          localStatusManager2 = localStatusManager1;
        }
      }
    }
  ...
  private void c()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppConfigObserver = new ecp(this);
  ...
  private void d()
  {
    this.jdField_a_of_type_ComTencentMobileqqRichstatusStatusObserver = new ecr(this);
  ...
  public int a(RichStatus paramRichStatus, int paramInt)
  {
    ...
    for (int i1 = paramRichStatus.b;; i1 = -1)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver == null) {
        this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new ecq(this);
      }
  ...
  public int a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        this.jdField_b_of_type_AndroidOsAsyncTask = new ecs(this);
  ...
  {
    localObject7 = null;
    if (this.jdField_a_of_type_Ebb == null) {
      this.jdField_a_of_type_Ebb = new ebb("StatusIcon_", this);
    }
    ...
    Object localObject6 = this.jdField_a_of_type_Ebb;
    Object localObject1;
    if (localObject3 != null) {
      if (paramInt2 == 201)
      {
        localObject1 = ((ActionInfo)localObject3).jdField_a_of_type_JavaLangString;
        localObject6 = ((ebb)localObject6).a((String)localObject5, null, (String)localObject1);
    ...
    try
    {
      localObject5 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getResources(), 2130839112);
      localObject1 = localObject5;
    ...
    while (paramInt2 == 201)
    {
      ...
      localObject1 = null;
      break;
      localObject1 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getResources(), 2130839112);
      localObject3 = localObject7;
      break label208;
      if (paramInt2 != 200) {
        break label381;
      ...
      if (BaseApplicationImpl.a != null)
      {
        ...
        localObject3 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getResources(), 2130839114);
  ...
  public ArrayList a()
  {
    ...
    //   439: dup
    //   440: aload_0
    //   441: invokespecial 808	ect:<init>	(Lcom/tencent/mobileqq/richstatus/StatusManager;)V
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localObject1 != null)
      {
        localObject2 = this.jdField_a_of_type_Ebb.a(str, null, (String)localObject1);
        if (localObject2 == null) {
          break label50;
        }
  ...
  public Object[] a(int paramInt1, int paramInt2)
  {
    ...
    Object localObject1 = this.jdField_a_of_type_Ebb.a(str2);
    String str1;
    if (localObject1 == null)
    {
      ...
      if ((localObject3 != null) && (((ActionInfo)localObject3).g != null))
      {
        ...
        localObject3 = this.jdField_a_of_type_Ebb.a(str1);
        ebb localebb = this.jdField_a_of_type_Ebb;
        if (localObject3 != null)
        {
          label201:
          localebb.a(str2, (String)localObject2, (String)localObject1);
          if (localObject3 != null) {
            break label324;
          }
          if (BaseApplicationImpl.a == null) {
