  ...
  implements View.OnClickListener, AdapterView.OnItemClickListener
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new ebg(this);
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new ebo(this);
  private View jdField_a_of_type_AndroidViewView;
  private GridView jdField_a_of_type_AndroidWidgetGridView;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private IActionListener jdField_a_of_type_ComTencentMobileqqRichstatusIActionListener = new ebf(this);
  private IIconListener jdField_a_of_type_ComTencentMobileqqRichstatusIIconListener = new ebm(this);
  private IStatusListener jdField_a_of_type_ComTencentMobileqqRichstatusIStatusListener = new ebn(this);
  private RichStatus jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus;
  private RichStatusEditText.RichStatusEditListener jdField_a_of_type_ComTencentMobileqqRichstatusRichStatusEditText$RichStatusEditListener = new ebp(this);
  private RichStatusEditText jdField_a_of_type_ComTencentMobileqqRichstatusRichStatusEditText;
  private StatusManager jdField_a_of_type_ComTencentMobileqqRichstatusStatusManager;
  private StatusObserver jdField_a_of_type_ComTencentMobileqqRichstatusStatusObserver = new ebh(this);
  private ClickableImageSpan.ClickableImageSpanListener jdField_a_of_type_ComTencentMobileqqWidgetClickableImageSpan$ClickableImageSpanListener = new ebq(this);
  ...
  private ebu jdField_a_of_type_Ebu;
  ...
  private Drawable a(boolean paramBoolean)
  {
    ...
    ImageView localImageView = (ImageView)localView.findViewById(2131297237);
    TextView localTextView = (TextView)localView.findViewById(2131297238);
    ...
    if (paramBoolean) {
      localView.setBackgroundResource(2130839111);
    }
    for (;;)
    {
      return a(localView);
      localView.setBackgroundResource(2130839110);
    }
  }
  ...
  private void d(boolean paramBoolean)
  {
    ...
    {
      this.jdField_b_of_type_AndroidWidgetTextView.setText(2131364147);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839479);
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(getResources().getColorStateList(2131427499));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130838120);
    this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(getResources().getColorStateList(2131427476));
  ...
  private void h()
  {
    ...
    a(2131364153, this);
    c(true);
    ((MaxHeightRelativelayout)findViewById(2131298853)).setMaxHeight((int)(getResources().getDisplayMetrics().heightPixels * 0.31D));
    this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatusEditText = ((RichStatusEditText)findViewById(2131298854));
    ...
    this.jdField_a_of_type_AndroidViewView = findViewById(2131298856);
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
    if (!this.jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    }
    this.jdField_h_of_type_AndroidWidgetTextView.setContentDescription(getString(2131364541));
    this.j.setContentDescription(this.j.getText() + "按钮");
    this.jdField_a_of_type_AndroidViewView.setContentDescription("做什么按钮");
    this.jdField_b_of_type_AndroidViewView = findViewById(2131298855);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130839119);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131297237));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131297238));
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131298857));
      this.jdField_a_of_type_AndroidWidgetGridView = ((GridView)findViewById(2131298859));
      this.jdField_a_of_type_AndroidWidgetGridView.setOnItemClickListener(this);
      this.jdField_a_of_type_Ebu = new ebu(this, null);
      this.jdField_a_of_type_AndroidWidgetGridView.setAdapter(this.jdField_a_of_type_Ebu);
  ...
  {
    this.d = false;
    this.jdField_a_of_type_Ebu.notifyDataSetChanged();
    this.jdField_a_of_type_AndroidWidgetGridView.postDelayed(new ebi(this), 200L);
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidViewView = findViewById(2131298856);
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131297084));
  ...
  void e()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetActionSheet.a(2131364148, 0);
    this.jdField_a_of_type_ComTencentWidgetActionSheet.a(2131364149, 3);
    this.jdField_a_of_type_ComTencentWidgetActionSheet.d(2131362790);
    this.jdField_a_of_type_ComTencentWidgetActionSheet.a(new ebr(this));
    this.jdField_a_of_type_ComTencentWidgetActionSheet.setOnDismissListener(new ebs(this));
  }
  
  public void f()
  {
    new Handler().postDelayed(new ebt(this), 500L);
  }
