  ...
  extends BusinessHandler
{
  ...
  public void a(ReqCheckPayAuth paramReqCheckPayAuth)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QWalletOpenHandler", 2, "sendCheckSignatureReq: on send--cmd=OpenPayServer.checkPayAuth");
    }
  }
  ...
  public void a(ReqGetApiList paramReqGetApiList)
  {
    ...
    super.a(localToServiceMsg);
    if (QLog.isColorLevel()) {
      QLog.d("QWalletOpenHandler", 2, "sendGetOpenApisReq: on send--cmd=OpenPayServer.getApiList");
    }
  }
  ...
  public void a(ReqGetOpenId paramReqGetOpenId)
  {
    ...
    if (localTicketManager != null)
    {
      ...
      super.a(localToServiceMsg);
      if (QLog.isColorLevel()) {
        QLog.d("QWalletOpenHandler", 2, "sendGetOpenIdReq: on send--cmd=OpenPayServer.getOpenId");
      }
    }
  }
