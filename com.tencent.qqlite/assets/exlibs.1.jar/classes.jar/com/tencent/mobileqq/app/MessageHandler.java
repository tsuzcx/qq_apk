  ...
  implements ProcessorDispatcherInterface, ProcessorObserver
{
  ...
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new cuz(this);
  private EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = null;
  public MessageCache a;
  cvh jdField_a_of_type_Cvh;
  ...
  private cve[] jdField_a_of_type_ArrayOfCve = null;
  ...
  private cvh a()
  {
    if (this.jdField_a_of_type_Cvh == null) {
      this.jdField_a_of_type_Cvh = new cvh(this, ThreadManager.b());
    }
    return this.jdField_a_of_type_Cvh;
  }
  ...
  {
    g();
    paramToServiceMsg = new cvf(paramInt, paramToServiceMsg, ???, paramObject);
    if (paramInt == 1) {
  ...
  private boolean c()
  {
    for (;;)
    {
      ...
      {
        if ((this.jdField_a_of_type_ArrayOfCve != null) && (this.jdField_a_of_type_ArrayOfCve.length > 1)) {
          break label77;
        }
        return true;
        if (i1 >= this.jdField_a_of_type_ArrayOfCve.length) {
          break label73;
        }
        if ((this.jdField_a_of_type_ArrayOfCve[i1] != null) && (this.jdField_a_of_type_ArrayOfCve[i1].b())) {
          return false;
        }
      }
      i1 += 1;
  ...
  private void n()
  {
    ...
    Object localObject2 = ((Context)localObject1).getString(2131364254);
    String str = ((Context)localObject1).getString(2131364254);
    Bitmap localBitmap = BitmapManager.a(((Context)localObject1).getResources(), 2130838529);
    ...
    for (;;)
    {
      if (Build.VERSION.SDK_INT < 11) {
        ((NotificationCompat.Builder)localObject2).setSmallIcon(2130838529);
      }
      ...
      this.jdField_a_of_type_JavaLangThread = new Thread(new cuv(this, localNotificationManager));
      this.jdField_a_of_type_JavaLangThread.start();
      return;
      ((NotificationCompat.Builder)localObject2).setLargeIcon(BitmapManager.a(((Context)localObject1).getResources(), 2130838529));
    }
  }
    ...
    for (;;)
    {
      ...
      if ((!MsgProxyUtils.i(paramMessageRecord.msgtype)) && (MsgProxyUtils.b(paramMessageRecord.msgtype)))
      {
        ...
        for (;;)
        {
          ...
          while (i2 < 12)
          {
            localSendMessageHandler.a(new cux(this, localMessageRecord, l1));
            i2 += 1;
          }
          i2 = 0;
          if (i2 < 6)
  ...
  public void a(MessageRecord paramMessageRecord, BusinessObserver paramBusinessObserver, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localSendMessageHandler.a(new cuu(this, paramMessageRecord, localPbSendMsgReq, paramBusinessObserver, paramBoolean));
      i1 += 1;
    }
    label148:
    if (i2 < 3) {
  ...
  public void a(String paramString1, int paramInt1, long paramLong, int paramInt2, boolean paramBoolean1, String paramString2, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 1)
      {
        localMessageForGrayTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramString1, paramString1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131362812), paramLong, -1013, paramInt1, paramLong);
      ...
      for (;;)
      {
        ...
        localMessageForGrayTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramString1, paramString1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131362811), paramLong, -1013, paramInt1, paramLong);
  ...
  public void a(String paramString1, String paramString2, byte paramByte, String paramString3, long paramLong1, long paramLong2)
  {
    ...
    for (long l1 = 0L; l1 < 3L; l1 += 1L) {
      localSendMessageHandler.postDelayed(new cuw(this, l1, paramString1, paramString2, paramByte, paramString3, paramLong1, paramLong2), 30000L * l1);
    }
  ...
  public void a(ArrayList paramArrayList1, ArrayList paramArrayList2)
  {
    ...
    if ((paramArrayList1 != null) && (paramArrayList1.size() > 0))
    {
      ...
      {
        arrayOfLong[i1] = ((cvc)paramArrayList1.get(i1)).jdField_a_of_type_Long;
        localObject[i1] = ((cvc)paramArrayList1.get(i1)).jdField_a_of_type_Int;
        arrayOfShort[i1] = ((cvc)paramArrayList1.get(i1)).jdField_a_of_type_Short;
        if (QLog.isColorLevel()) {
  ...
  public void b(String paramString, int paramInt)
  {
    ...
    while (paramInt < 9)
    {
      localSendMessageHandler.a(new cvb(this, paramString, l2, l1));
      paramInt += 1;
    }
    paramInt = 0;
    label95:
  ...
  public void e(String paramString)
  {
    ...
    localAccountManager.changeToken(localHashMap, new cuy(this, paramString));
  }
  ...
  public void g()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_c_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_ArrayOfCve != null) {
          break label193;
        }
        this.jdField_c_of_type_JavaUtilArrayList = new ArrayList(20);
        this.jdField_d_of_type_JavaUtilArrayList = new ArrayList(10);
        this.jdField_a_of_type_ArrayOfCve = new cve[6];
        break label193;
        if (i1 < this.jdField_a_of_type_ArrayOfCve.length)
        {
          if ((this.jdField_a_of_type_ArrayOfCve[i1] != null) && (!this.jdField_a_of_type_ArrayOfCve[i1].a())) {
            break label198;
          }
          if (i1 == 0)
          {
            this.jdField_a_of_type_ArrayOfCve[i1] = new cve(this, this.jdField_d_of_type_JavaUtilArrayList);
            this.jdField_a_of_type_ArrayOfCve[i1].setName("MessageHandleThread" + (i1 + 1));
            this.jdField_a_of_type_ArrayOfCve[i1].setPriority(5);
            this.jdField_a_of_type_ArrayOfCve[i1].start();
            break label198;
          }
          this.jdField_a_of_type_ArrayOfCve[i1] = new cve(this, this.jdField_c_of_type_JavaUtilArrayList);
        }
      }
      return;
      label193:
  ...
  public void h()
  {
    synchronized (this.jdField_c_of_type_JavaLangObject)
    {
      ...
      {
        int i1 = 0;
        while (i1 < this.jdField_a_of_type_ArrayOfCve.length)
        {
          this.jdField_a_of_type_ArrayOfCve[i1].a();
          i1 += 1;
        }
      }
      synchronized (this.jdField_c_of_type_JavaUtilArrayList)
      {
        ...
        this.jdField_a_of_type_ArrayOfCve = null;
        return;
      }
    }
  }
  ...
  public void k()
  {
    ...
    while (i1 < 9)
    {
      localSendMessageHandler.a(new cva(this, localPbMsgReadedReportReq, l2, l1));
      i1 += 1;
    }
    i1 = 0;
    label88:
