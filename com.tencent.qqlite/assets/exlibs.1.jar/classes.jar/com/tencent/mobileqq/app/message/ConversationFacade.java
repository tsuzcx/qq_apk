  ...
  implements Manager
{
  ...
  public void a()
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      {
        if ((MsgProxyUtils.k(localConversationInfo.type)) && (!MsgProxyUtils.a(localConversationInfo.uin, localConversationInfo.type)) && (!a(localConversationInfo.uin, localConversationInfo.type))) {
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          else
          {
            ...
            if (!AppConstants.Z.equals(localMessageRecord.frienduin)) {
              break label278;
            }
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 1009) {
      localObject = a(paramInt).a(AppConstants.S, 1009);
    }
    while ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      ...
      return true;
      if (paramInt == 1001) {
        localObject = a(paramInt).a(AppConstants.Z, 1001);
      }
    }
    return false;
  }
  ...
  protected void b(String paramString, int paramInt, long paramLong)
  {
    ...
    if (paramString != null)
    {
      paramInt = paramString.e();
      BadgeUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramInt);
    }
  }
