  ...
  extends BusinessHandler
{
  ...
  {
    paramString = DialogUtil.a(paramActivity, 230, null, paramString, 2131362801, 2131363090, paramOnClickListener1, paramOnClickListener2);
    if (paramString != null)
    {
  ...
  public void e()
  {
    ...
    localRoamReqHead.client_ver.set("3.5.0");
    ...
    for (long l1 = Long.parseLong(str);; l1 = 0L)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("LBSHandler", 2, "getRoamQualify client_ver=3.5.0,os_ver=" + Build.VERSION.RELEASE + ",uin=" + str);
      }
      b(localToServiceMsg);
      return;
    }
