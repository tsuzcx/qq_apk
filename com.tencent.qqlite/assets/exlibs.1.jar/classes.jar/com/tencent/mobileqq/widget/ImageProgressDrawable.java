  ...
  extends Drawable
{
  ...
  public ImageProgressDrawable(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.g = paramContext.getColor(0, 2131427345);
    this.f = paramContext.getColor(1, 2131427354);
    this.jdField_e_of_type_Int = paramContext.getColor(2, 2131427353);
    this.h = paramContext.getColor(3, 2131427353);
