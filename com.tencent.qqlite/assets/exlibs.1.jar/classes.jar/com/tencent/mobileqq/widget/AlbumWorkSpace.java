  ...
  private void c(int paramInt)
  {
    ...
    if (i < j)
    {
      ...
      if (Math.abs(i - paramInt) <= 1)
      {
        ...
        int k = CardHandler.b(this.jdField_a_of_type_AndroidContentContext);
  ...
  public void setFileKeyList(LinkedList paramLinkedList, int paramInt)
  {
    if (paramLinkedList.size() - this.jdField_a_of_type_JavaUtilLinkedList.size() > 0)
    {
      ...
      if (i < paramLinkedList.size())
      {
        ...
        {
          localObject = new AlbumImageProxy(localQQAppInterface, localContext, (String)localObject, 2130837969, bool);
