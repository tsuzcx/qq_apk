  ...
  extends LinearLayout
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new ezl(this);
  ...
  public TabBarView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    setBackgroundDrawable(getResources().getDrawable(2130839366));
  }
  ...
  public static int a(Context paramContext, int paramInt)
  {
    ...
    {
    default: 
      return paramContext.getResources().getColor(2131427474);
    case 1: 
      return paramContext.getResources().getColor(2131427474);
    }
    return paramContext.getResources().getColor(2131427498);
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    localRedDotTextView.setOnClickListener(new ezm(this, paramInt));
