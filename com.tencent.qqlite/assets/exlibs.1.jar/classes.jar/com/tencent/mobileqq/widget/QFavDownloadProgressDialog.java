  ...
  extends Dialog
{
  ...
  private fba jdField_a_of_type_Fba = new fba(this, null);
  private int b = 0;
  private int c = 0;
  ...
  public QFavDownloadProgressDialog(Context paramContext, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903405, null);
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131297959));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131297960));
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new faz(this));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131297958));
    paramContext = String.format(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131364524), new Object[] { Integer.valueOf(this.b), Integer.valueOf(269202) });
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_Fba.sendEmptyMessage(1001);
  }
