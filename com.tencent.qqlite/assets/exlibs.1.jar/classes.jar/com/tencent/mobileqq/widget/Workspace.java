  ...
  extends FrameLayout
{
  ...
  public Workspace(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    setBackgroundDrawable(getResources().getDrawable(2130837660));
  }
    ...
    for (paramInt1 = 1;; paramInt1 = 0)
    {
      if (this.jdField_d_of_type_Int != i1)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqWidgetWorkspace$OnScreenChangeListener != null) {
          this.jdField_a_of_type_ComTencentMobileqqWidgetWorkspace$OnScreenChangeListener.a(i1);
        }
      }
  ...
  public void computeScroll()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetWorkspace$OnScreenChangeListener.b(this.jdField_c_of_type_Int);
  }
