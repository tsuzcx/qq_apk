  ...
  extends BaseAdapter
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new cpc(this);
  ...
  public FriendProfileImageAdapter(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130839480);
    this.b = paramContext.getResources().getDrawable(2130839481);
  }
  ...
  {
    paramView = (ImageProgressCircle)paramView.findViewById(2131296282);
  ...
  public void a(FriendProfileImageModel.ProfileImageInfo paramProfileImageInfo, View paramView)
  {
    ...
    ((ImageView)paramView.findViewById(2131296283)).setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
  }
  ...
  public void b(FriendProfileImageModel.ProfileImageInfo paramProfileImageInfo, View paramView)
  {
    ...
    try
    {
      ...
      paramView.setTag(paramProfileImageInfo.c);
      ((ImageView)paramView.findViewById(2131296283)).setImageDrawable((Drawable)localObject1);
      return;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2130903212, null);
      paramViewGroup = (ImageProgressCircle)paramView.findViewById(2131296282);
      paramViewGroup.setVisibility(4);
      localImageView = (ImageView)paramView.findViewById(2131296283);
    ...
    a(paramViewGroup);
    return paramView;
    localImageView.setImageResource(2130839481);
    return paramView;
  }
}
