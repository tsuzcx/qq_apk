  ...
  extends BaseAdapter
{
      ...
      if (paramRespEncounterInfo.tiny_id > 0L)
      {
        ...
        if (this.c)
        {
          ...
          if ((localBoolean == null) || (!localBoolean.booleanValue()))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new cpf(this, str, paramRespEncounterInfo));
          }
        }
    ...
    if (paramRespEncounterInfo.lEctID > 0L)
    {
      ...
      if (this.c)
      {
        ...
        if ((localBoolean == null) || (!localBoolean.booleanValue()))
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new cpg(this, str, paramRespEncounterInfo));
        }
      }
  ...
  public static void a(VipBaseInfo paramVipBaseInfo, ImageView paramImageView, TextView paramTextView)
  {
    ...
    paramTextView.setTextColor(paramTextView.getResources().getColorStateList(2131427493));
    if ((paramVipBaseInfo != null) && (paramVipBaseInfo.mOpenInfo != null))
    {
      ...
      paramImageView.setImageResource(2130839406);
      paramTextView.setTextColor(paramTextView.getResources().getColorStateList(2131427517));
    }
    label83:
    do
    {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131296851));
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131297354));
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297355));
      paramViewGroup.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131297356));
      paramViewGroup.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297357));
      paramViewGroup.e = ((TextView)paramView.findViewById(2131297256));
      paramViewGroup.f = ((TextView)paramView.findViewById(2131297358));
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131297359));
      paramViewGroup.g = ((TextView)paramView.findViewById(2131296275));
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131297254));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297257));
    }
    label290:
    label328:
    label345:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (localRespEncounterInfo.cAge != 0)
        {
          ...
          {
          default: 
            paramViewGroup.jdField_d_of_type_AndroidWidgetTextView.setBackgroundResource(2130838759);
            int k = 0;
            i = paramInt;
            paramInt = k;
        ...
        for (;;)
        {
          ...
          paramViewGroup.jdField_d_of_type_AndroidWidgetTextView.setBackgroundResource(2130838758);
          localObject2 = paramViewGroup.jdField_d_of_type_AndroidWidgetTextView;
          ...
          paramViewGroup.e.setBackgroundResource(2130838761);
