  ...
  extends MSFServlet
{
  ...
  private static final String b = "OidbSvc.0x826_0";
  private static final String c = "k_uin";
  
  public static void a(QQAppInterface paramQQAppInterface)
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.a(), QQLevelACCServlet.class);
    localNewIntent.putExtra("k_uin", paramQQAppInterface.a());
    paramQQAppInterface.startServlet(localNewIntent);
    if (QLog.isColorLevel()) {
      QLog.d(a, 2, "getLevelACCInfo:--startServlet--");
    }
  }
