...
public class NearbyProfileUtil
{
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfInt = new int[] { 2130838924, 2130838645, 2130838645, 2130838645, 2130838762, 2130838762, 2130838931, 2130838931, 2130838726, 2130838726, 2130838726, 2130838924, 2130838924, 2130838767, 2130838924 };
  }
  ...
  {
    paramQQAppInterface.a(new esc(paramQQAppInterface, paramLong, paramString, paramCardHandler));
  }
