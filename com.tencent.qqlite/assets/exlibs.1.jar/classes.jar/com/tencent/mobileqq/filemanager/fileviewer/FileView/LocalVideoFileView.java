  ...
  implements IFileViewMusicEvent
{
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838599);
      m();
      return;
    }
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838598);
    n();
  }
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131298111));
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(new dtb(this));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131297866));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new dtc(this));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131298112));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new dte(this));
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new dtf(this));
  }
  ...
  private void j()
  {
    ...
    new Handler().postDelayed(new dtg(this), 100L);
    this.jdField_a_of_type_AndroidViewSurfaceView = ((SurfaceView)this.jdField_a_of_type_AndroidViewView.findViewById(2131298110));
  ...
  private void m()
  {
    ...
    this.jdField_a_of_type_JavaUtilTimer.scheduleAtFixedRate(new dtj(this), 0L, 1000L);
  }
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)BaseApplicationImpl.getContext().getSystemService("layout_inflater")).inflate(2130903453, paramViewGroup, false);
    g();
  ...
  public void d()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerFileViewMusicService != null) && (this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerFileViewMusicService.b(this.jdField_b_of_type_JavaLangString)))
    {
      ...
      FileManagerUtil.a(this.jdField_b_of_type_JavaLangString, false, i, j, this.jdField_a_of_type_Int * 1000, new dsz(this));
    }
  }
  ...
  public void f()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130838597);
      if (this.jdField_a_of_type_Boolean) {
        break label56;
      }
    }
