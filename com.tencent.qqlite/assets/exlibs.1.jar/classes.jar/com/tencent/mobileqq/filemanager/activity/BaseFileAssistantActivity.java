  ...
  implements View.OnClickListener
{
  ...
  public TextView a;
  FMObserver jdField_a_of_type_ComTencentMobileqqFilemanagerAppFMObserver = new dfs(this);
  ...
  private void o()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetSendBottomBar == null) {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetSendBottomBar = ((SendBottomBar)findViewById(2131298062));
    }
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfileEditBottomBar == null) {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfileEditBottomBar = ((QfileEditBottomBar)findViewById(2131298006));
    }
  ...
  private void p()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131298072));
    }
    if ((g()) || (i())) {
  ...
  {
    super.setContentViewNoTitle(2130903437);
    ((RelativeLayout)findViewById(2131298070)).addView(((LayoutInflater)getSystemService("layout_inflater")).inflate(paramInt, null));
    this.j = ((TextView)findViewById(2131298036));
    h();
    l();
  }
  ...
  public void g()
  {
    ...
    new Handler().postDelayed(new dfq(this), 1500L);
  }
  ...
  protected void h()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131298071));
      i();
    }
    n();
  ...
  public void k()
  {
    ...
    {
      this.j.setVisibility(0);
      this.j.setText(getString(2131361967));
    }
    for (;;)
    {
      this.j.setOnClickListener(new dfr(this));
      return;
      this.j.setVisibility(0);
      this.j.setText(2131361940);
    }
  }
