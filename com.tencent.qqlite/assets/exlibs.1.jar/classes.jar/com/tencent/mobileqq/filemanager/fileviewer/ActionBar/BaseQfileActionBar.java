  ...
  extends BaseActionBar
{
  ...
  public void h()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.b.findViewById(2131297973));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new dts(this));
    }
    if (this.jdField_a_of_type_AndroidWidgetProgressBar == null)
    {
      this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.b.findViewById(2131297972));
      this.jdField_a_of_type_AndroidWidgetProgressBar.setProgress(0);
    }
    if (this.jdField_a_of_type_AndroidWidgetTextView == null)
    {
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.b.findViewById(2131297971));
