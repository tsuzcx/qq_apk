  ...
  extends FilePreViewControllerBase
{
  ...
  private FavoritesRemoteCommand.IRemoteCommandHandler jdField_a_of_type_CooperationQqfavIpcFavoritesRemoteCommand$IRemoteCommandHandler = new dpp(this);
  ...
  public QfavFilePreviewController(Bundle paramBundle)
  {
    ...
    this.e = 2;
    new Handler(Looper.getMainLooper()).postDelayed(new dpr(this), 300000L);
  }
  ...
  public boolean a()
  {
    ...
    new Handler(Looper.getMainLooper()).postDelayed(new dps(this), 2000L);
    return true;
  }
