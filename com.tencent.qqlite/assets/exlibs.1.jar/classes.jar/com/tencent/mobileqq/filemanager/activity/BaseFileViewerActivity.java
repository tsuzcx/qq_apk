  ...
  extends IphoneTitleBarActivity
{
  ...
  {
    super.setContentViewNoTitle(2130903433);
    ((RelativeLayout)findViewById(2131298041)).addView(((LayoutInflater)getSystemService("layout_inflater")).inflate(paramInt, null));
    b(getIntent());
  }
