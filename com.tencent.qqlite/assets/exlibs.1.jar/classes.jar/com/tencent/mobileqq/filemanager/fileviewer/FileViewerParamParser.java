...
public class FileViewerParamParser
{
  ...
  {
    if (1 != paramInt1) {}
    while ((1 == paramInt2) || (paramInt2 == 0) || (2 == paramInt2) || (-1 == paramInt2)) {
      return false;
    }
    return true;
  }
  ...
  private boolean c(Intent paramIntent, ForwardFileInfo paramForwardFileInfo)
  {
    ...
    default: 
      if (QLog.isDevelopLevel()) {
        QLog.w("FileViewerParamParser", 4, "parseAudioGallery: type[" + paramForwardFileInfo.a() + "] is not implemented");
      }
      bool = false;
      label101:
      this.f = 2;
      if (!bool) {
        QLog.e("FileViewerParamParser", 1, "parseAudioGallery type[" + paramForwardFileInfo.a() + "] return false");
      }
      break;
    }
    ...
    QLog.e("FileViewerParamParser", 1, "parseAudioGallery type[" + paramForwardFileInfo.a() + "] list is empty");
    return false;
  }
  ...
  private boolean d(Intent paramIntent, ForwardFileInfo paramForwardFileInfo)
  {
    ...
    default: 
      if (QLog.isDevelopLevel()) {
        QLog.w("FileViewerParamParser", 4, "parseImageGallery: type[" + paramForwardFileInfo.a() + "] is not implemented");
      }
      bool = false;
      label101:
      this.f = 1;
      if (!bool) {
        QLog.e("FileViewerParamParser", 1, "parseImageGallery type[" + paramForwardFileInfo.a() + "] return false");
      }
      break;
    }
    while (this.jdField_a_of_type_JavaUtilList.size() != 0)
    ...
    QLog.e("FileViewerParamParser", 1, "parseImageGallery type[" + paramForwardFileInfo.a() + "] list is empty");
    return false;
  }
  ...
  public boolean a(Intent paramIntent)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid != null) && (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid.length() > 0) && (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.cloudType == 3) && (!FileUtil.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFilePath)))
    {
