  ...
  extends BaseFileAssistantActivity
{
  ...
  public FMLocalFileActivity()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new dhg(this);
  }
  ...
  private void p()
  {
    ...
    {
      if (bool4) {
        a(2130903417, 2130838742, 2, null, 0, false, 0, 1);
      }
      if (bool2) {
        a(2130903415, 2130838548, 0, str1, FileCategoryUtil.a(this), true, 10, 2);
      }
      if (bool8) {
        a(2130903415, 2130838546, 0, str2, FileCategoryUtil.b(this), true, 1, 3);
      }
      if (bool7) {
        a(2130903415, 2130838551, 0, str3, FileCategoryUtil.c(this), true, 2, 3);
      }
      if (bool6) {
        a(2130903415, 2130838541, 0, str4, 0, true, 4, 4);
      }
      if (bool3) {
        a(2130903415, 2130838544, 0, str9, 0, false, 20, 2);
      }
      if (bool1) {
        a(2130903409, 2130838742, 1, null, 0, false, 0, 1);
      }
      if (bool5) {
        a(2130903415, 2130838543, 0, str5, 0, false, 6, 2);
      }
      a(2130903415, 2130838549, 0, str6, 0, false, 7, 3);
      if (FileManagerUtil.a(this).containsKey("externalSdCard"))
      {
        a(2130903415, 2130838550, 0, str7, 0, false, 8, 3);
        a(2130903415, 2130838550, 0, str8, 0, false, 11, 4);
      }
      while (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileCategoryAdapter == null)
      {
        return;
        a(2130903415, 2130838550, 0, str7, 0, false, 8, 4);
      }
  ...
  public void n()
  {
    new dhf(this).execute(new Void[0]);
  }
}
