  ...
  extends GroupAreaWrapper.BaseInfo
{
  ...
  {
    ((NearbyTroops.ActivityAndTopicViewHolder)paramView.getTag()).a.setTextColor(paramView.getContext().getResources().getColor(2131427433));
    paramView.findViewById(2131297684).setBackgroundResource(2130838307);
  }
  ...
  protected void a(TextView paramTextView)
  {
    ...
    paramTextView.setCompoundDrawablesWithIntrinsicBounds(2130838346, 0, 0, 0);
  }
