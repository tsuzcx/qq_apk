  ...
  implements View.OnClickListener
{
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity.i == 10) {
      ReportController.b(this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity.app, "P_CliOper", "Grp_nearby", "", "nearbygrp_map", "Clk_data", 0, 0, String.valueOf(((GroupInfo)localObject).lCode), "", "", "");
    }
    if (this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity.i == 11) {
      ReportController.b(this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity.app, "P_CliOper", "Grp_set", "", "Grp_data_place", "Clk_data", 0, 0, String.valueOf(((GroupInfo)localObject).lCode), "", "", "");
    }
  ...
  public void a(AbsListView paramAbsListView, int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if ((paramAbsListView.r() == paramAbsListView.b() - 1) && (!this.b) && (this.jdField_a_of_type_Boolean))
      {
        this.b = true;
        notifyDataSetChanged();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramInt < this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      if (paramInt == this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity.jdField_a_of_type_JavaUtilArrayList.size() - 1) {
        paramView = NearbyTroops.a(this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity.jdField_a_of_type_AndroidContentContext, paramViewGroup, true);
      }
    }
    label238:
    label240:
    for (;;)
    {
      NearbyTroops.a(paramView, (GroupInfo)this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity.jdField_a_of_type_JavaUtilArrayList.get(paramInt), this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity.jdField_a_of_type_AndroidContentContext, false, 0L);
      ...
      for (;;)
      {
        ...
        if ((paramView instanceof NearbyTroops.CustomViewHolder))
        {
          ...
          paramViewGroup.a.setImageBitmap(a(4, String.valueOf(localGroupInfo.lCode)));
        }
        ...
        return localView;
        paramView = NearbyTroops.a(this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity.jdField_a_of_type_AndroidContentContext, paramViewGroup, false);
        break;
        if (paramInt != this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity.jdField_a_of_type_JavaUtilArrayList.size()) {
          break label238;
        }
        ...
        {
          localView = NearbyTroops.e(this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity.jdField_a_of_type_AndroidContentContext, paramViewGroup);
        }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView instanceof NearbyTroops.CustomViewHolder)) {
      a(((NearbyTroops.CustomViewHolder)paramView).b);
    }
  }
}
