  ...
  implements OverScrollViewListener
{
  ...
  public TroopLocationActivity()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppLBSObserver = new ene(this);
  }
  ...
  public void a(Intent paramIntent)
  {
    ...
    this.jdField_h_of_type_Int = localIntent.getIntExtra("lon", 0);
  ...
  public void a(String paramString)
  {
    ...
    //   7: return
    //   8: aload_0
    //   9: getfield 84	com/tencent/mobileqq/troop/activity/TroopLocationActivity:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   12: bipush 8
    //   14: invokevirtual 175	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   17: checkcast 177	com/tencent/mobileqq/model/FriendManager
    //   20: astore 10
    //   22: aconst_null
    //   23: astore 9
    //   25: aload 10
    ...
    //   30: aload 10
    //   32: aload_1
    //   33: invokeinterface 180 2 0
    //   38: astore 9
    //   40: aload 9
    //   42: ifnull -35 -> 7
    //   45: aload 9
    //   47: getfield 185	com/tencent/mobileqq/data/TroopInfo:strLocation	Ljava/lang/String;
    //   50: aload_0
    //   51: getfield 152	com/tencent/mobileqq/troop/activity/TroopLocationActivity:jdField_g_of_type_JavaLangString	Ljava/lang/String;
    //   54: invokevirtual 191	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   57: ifeq -50 -> 7
    //   60: aload_0
    ...
    //   64: invokevirtual 195	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   67: astore 10
    //   69: aload 10
    //   71: invokeinterface 200 1 0
    //   76: ifeq +27 -> 103
    //   79: aload 10
    //   81: invokeinterface 204 1 0
    //   86: checkcast 206	NearbyGroup/GroupInfo
    //   89: getfield 210	NearbyGroup/GroupInfo:lCode	J
    //   92: invokestatic 216	java/lang/Long:toString	(J)Ljava/lang/String;
    //   95: aload_1
    //   96: invokevirtual 191	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   99: ifeq -30 -> 69
    //   102: return
    //   103: aload 9
    //   105: getfield 219	com/tencent/mobileqq/data/TroopInfo:troopcode	Ljava/lang/String;
    //   108: invokestatic 223	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   111: lstore_3
    //   112: aload 9
    //   114: getfield 226	com/tencent/mobileqq/data/TroopInfo:troopuin	Ljava/lang/String;
    //   117: invokestatic 223	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   120: lstore 5
    //   122: aload 9
    //   124: getfield 229	com/tencent/mobileqq/data/TroopInfo:troopowneruin	Ljava/lang/String;
    //   127: invokestatic 223	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   130: lstore 7
    //   132: lload 5
    //   134: lconst_0
    //   135: lcmp
    //   136: ifeq -129 -> 7
    //   139: new 206	NearbyGroup/GroupInfo
    //   142: dup
    //   143: invokespecial 230	NearbyGroup/GroupInfo:<init>	()V
    //   146: astore_1
    //   147: aload_1
    //   148: lload 5
    //   150: putfield 210	NearbyGroup/GroupInfo:lCode	J
    //   153: aload_1
    //   154: lload_3
    //   155: putfield 233	NearbyGroup/GroupInfo:lUin	J
    //   158: aload_1
    //   159: aload 9
    //   161: getfield 236	com/tencent/mobileqq/data/TroopInfo:troopname	Ljava/lang/String;
    //   164: putfield 239	NearbyGroup/GroupInfo:strName	Ljava/lang/String;
    //   167: aload_1
    //   168: aload 9
    //   170: getfield 185	com/tencent/mobileqq/data/TroopInfo:strLocation	Ljava/lang/String;
    //   173: putfield 240	NearbyGroup/GroupInfo:strLocation	Ljava/lang/String;
    //   176: aload 9
    //   178: getfield 243	com/tencent/mobileqq/data/TroopInfo:wMemberNum	I
    //   181: ifne +49 -> 230
    //   184: iconst_1
    //   185: istore_2
    //   186: aload_1
    //   187: iload_2
    //   188: putfield 246	NearbyGroup/GroupInfo:iMemberCnt	I
    //   191: aload_1
    //   192: aload 9
    //   194: getfield 249	com/tencent/mobileqq/data/TroopInfo:mRichFingerMemo	Ljava/lang/String;
    //   197: putfield 252	NearbyGroup/GroupInfo:strIntro	Ljava/lang/String;
    //   200: aload_1
    //   201: lload 7
    //   203: putfield 255	NearbyGroup/GroupInfo:lCreator	J
    //   206: aload_0
    ...
    //   210: iconst_0
    //   211: aload_1
    //   212: invokevirtual 259	java/util/ArrayList:add	(ILjava/lang/Object;)V
    //   215: aload_0
    //   216: getfield 261	com/tencent/mobileqq/troop/activity/TroopLocationActivity:jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity$TroopsAdapter	Lcom/tencent/mobileqq/troop/activity/TroopLocationActivity$TroopsAdapter;
    //   219: ifnull -212 -> 7
    //   222: aload_0
    //   223: getfield 261	com/tencent/mobileqq/troop/activity/TroopLocationActivity:jdField_a_of_type_ComTencentMobileqqTroopActivityTroopLocationActivity$TroopsAdapter	Lcom/tencent/mobileqq/troop/activity/TroopLocationActivity$TroopsAdapter;
    //   226: invokevirtual 266	com/tencent/mobileqq/troop/activity/TroopLocationActivity$TroopsAdapter:notifyDataSetChanged	()V
    //   229: return
    //   230: aload 9
    //   232: getfield 243	com/tencent/mobileqq/data/TroopInfo:wMemberNum	I
    //   235: istore_2
    //   236: goto -50 -> 186
    //   239: astore_1
    //   240: return
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppLBSHandler.a(this.jdField_g_of_type_JavaLangString, this.jdField_g_of_type_Int, this.jdField_h_of_type_Int, k, 30);
      return true;
      this.jdField_a_of_type_Boolean = true;
      k = 0;
    }
  ...
  public void c()
  {
    ...
    if (this.jdField_h_of_type_AndroidWidgetTextView != null) {
      this.jdField_h_of_type_AndroidWidgetTextView.setText(2131362848);
    }
    setRightButton(2131362849, new end(this));
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130903342, this.jdField_a_of_type_ComTencentWidgetXListView, false);
