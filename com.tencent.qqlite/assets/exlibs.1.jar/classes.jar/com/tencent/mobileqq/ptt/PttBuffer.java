...
public final class PttBuffer
{
  ...
  private static void a(PttBuffer.BufferTask paramBufferTask, boolean paramBoolean)
  {
    ...
    {
      Object localObject = paramBufferTask.jdField_a_of_type_JavaIoByteArrayOutputStream.toByteArray();
      if ((localObject != null) && (localObject.length > 0))
      {
        if (paramBufferTask.jdField_a_of_type_JavaIoFile == null)
        {
          File localFile = new File(paramBufferTask.jdField_a_of_type_JavaLangString + "~tmp");
          if (!localFile.exists()) {
        ...
        paramBufferTask.jdField_a_of_type_JavaIoFileOutputStream.write((byte[])localObject);
      }
      if (paramBoolean)
      {
        ...
        if (paramBufferTask.jdField_a_of_type_JavaIoFile != null)
        {
          ...
          paramBufferTask.jdField_a_of_type_JavaIoFile.renameTo((File)localObject);
