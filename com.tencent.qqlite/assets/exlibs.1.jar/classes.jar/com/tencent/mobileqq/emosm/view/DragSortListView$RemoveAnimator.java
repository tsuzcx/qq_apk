  ...
  extends DragSortListView.SmoothAnimator
{
  ...
  public void onUpdate(float paramFloat1, float paramFloat2)
  {
    ...
    do
    {
      do
      {
        ...
        if (localView != null)
        {
          ...
          {
            this.mFirstChildHeight = DragSortListView.access$200(this.this$0, this.mFirstPos, localView, false);
    ...
    {
      this.mSecondChildHeight = DragSortListView.access$200(this.this$0, this.mSecondPos, localView, false);
