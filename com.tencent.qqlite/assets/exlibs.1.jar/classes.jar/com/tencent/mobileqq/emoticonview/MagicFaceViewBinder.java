  ...
  extends EmoticonPanelViewBinder
{
  ...
  {
    Drawable localDrawable = paramContext.getResources().getDrawable(2130839028);
    paramContext = paramContext.getResources().getDrawable(2130839029);
  ...
  protected void a(View paramView, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonLinearLayout$EmoticonAdapter = new dev(this, 2008);
