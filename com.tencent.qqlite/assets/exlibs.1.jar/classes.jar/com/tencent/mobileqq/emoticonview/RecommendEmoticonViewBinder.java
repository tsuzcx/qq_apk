  ...
  implements URLDrawableDownListener
{
  ...
  {
    Drawable localDrawable = paramContext.getResources().getDrawable(2130839038);
    paramContext = paramContext.getResources().getDrawable(2130839039);
  ...
  protected void a(View paramView, int paramInt)
  {
    ...
    Object localObject1 = (URLImageView)paramView.findViewById(2131298658);
    Object localObject2 = (Button)paramView.findViewById(2131298657);
    TextView localTextView = (TextView)paramView.findViewById(2131298656);
    if (jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) {
      jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839015);
    }
    if (b == null) {
      b = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839014);
    }
    ...
    ((Button)localObject2).setOnClickListener(new dgr(this, localPromotionEmoticonPkg));
