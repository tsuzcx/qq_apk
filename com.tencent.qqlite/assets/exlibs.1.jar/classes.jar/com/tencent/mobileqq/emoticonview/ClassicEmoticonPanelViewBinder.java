  ...
  extends EmoticonPanelViewBinder
{
  ...
  {
    Drawable localDrawable = paramContext.getResources().getDrawable(2130839023);
    paramContext = paramContext.getResources().getDrawable(2130839024);
  ...
  protected void a(View paramView, int paramInt)
  {
    ...
    do
    {
      ...
      if (i == 2007)
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonLinearLayout$EmoticonAdapter = new dev(this, 2007);
