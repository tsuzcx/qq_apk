  ...
  implements Manager
{
  ...
  public PicPreDownloader(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new dzq(paramQQAppInterface.a());
  ...
  private void a(MessageForPic paramMessageForPic)
  {
    ...
    label152:
    ThreadManager.a().post(new dzn(this, localPicReq));
  ...
  {
    ThreadManager.a().postDelayed(new dzm(this, paramMessageRecord, paramInt1, paramInt2, paramInt3), 100L);
  }
  ...
  private void e()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      ThreadManager.a().post(new dzo(this, (PicReq)localObject));
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_JavaUtilTimer.schedule(new dzl(this), 60000L);
  }
  ...
  public void d()
  {
    ...
    for (String str = " big";; str = " thumb")
    {
      ...
      ThreadManager.a().post(new dzp(this, localPicReq));
      label605:
