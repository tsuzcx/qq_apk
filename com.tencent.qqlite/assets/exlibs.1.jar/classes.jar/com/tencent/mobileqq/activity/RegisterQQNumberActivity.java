  ...
  implements View.OnClickListener
{
  ...
  ContactBindObserver jdField_a_of_type_ComTencentMobileqqPhonecontactContactBindObserver = new bhy(this);
  private QQProgressDialog jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog;
  private MenuPopupDialog jdField_a_of_type_ComTencentWidgetMenuPopupDialog = null;
  WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new bhx(this);
  ...
  private void e()
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131298642));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131298644));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131298643));
    String str = String.format(getString(2131363344), new Object[] { this.c });
    this.jdField_b_of_type_AndroidWidgetTextView.setText(str);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_b_of_type_JavaLangString + "");
    this.jdField_a_of_type_AndroidWidgetTextView.setClickable(true);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnLongClickListener(new bht(this));
  }
  ...
  private void j()
  {
    this.jdField_b_of_type_AndroidOsHandler.post(new bhz(this));
  }
  
  private void k()
  {
    this.jdField_b_of_type_AndroidOsHandler.post(new bia(this));
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)setContentViewB(2130903585));
    setTitle(2131363328);
