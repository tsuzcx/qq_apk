  ...
  implements GrayTipsTask, Runnable
{
  ...
  private boolean a(Context paramContext)
  {
    ...
    boolean bool = a(paramContext).contains("搜狗输入法");
    long l2 = System.currentTimeMillis();
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "hasInstallSougouInput ret = " + bool + ", cost:" + (l2 - l1) + " ms");
    }
    return bool;
  }
  ...
  {
    paramVarArgs = MessageRecordFactory.a(-1043);
  ...
  public void run()
  {
    ...
    if (this.b) {
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "hasInstallSougouInput, just return");
      }
    }
    long l1;
    Object localObject1;
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        if ((((ChatMessage)localObject2).msgtype == -1041) || (((ChatMessage)localObject2).msgtype == -1043) || ((((ChatMessage)localObject2).msgtype == -1013) && (((ChatMessage)localObject2).istroop == 0)))
        {
          bool = true;
          continue;
        }
