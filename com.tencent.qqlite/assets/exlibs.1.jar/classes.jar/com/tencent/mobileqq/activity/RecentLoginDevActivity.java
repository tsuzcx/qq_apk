  ...
  extends IphoneTitleBarActivity
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new bgg(this);
  private LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout = null;
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new bgj(this);
  ...
  private void a(String paramString1, ArrayList paramArrayList, String paramString2, int paramInt)
  {
    ...
    paramString1 = getString(2131364157, new Object[] { str });
    this.jdField_a_of_type_ComTencentWidgetActionSheet.a(paramString1);
    this.jdField_a_of_type_ComTencentWidgetActionSheet.a(getResources().getString(2131364158), 3, false);
    this.jdField_a_of_type_ComTencentWidgetActionSheet.d(2131362794);
    this.jdField_a_of_type_ComTencentWidgetActionSheet.a(new bgi(this, paramString2, paramArrayList, paramInt));
  ...
  private void a(List paramList)
  {
    ...
    if (TextUtils.isEmpty(((SvcDevLoginInfo)localObject1).strDeviceName)) {
      ((TextView)localObject3).setText(2131364159);
    }
    for (;;)
    {
      ...
      localRelativeLayout.setOnClickListener(new bgh(this, localRelativeLayout, i));
  ...
  private void c()
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new bgk(this));
  }
  
  private void d()
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new bgl(this));
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    setTitle(2131364162);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131298184));
    try
    {
