...
public class MultiForwardChatPie
  extends BaseChatPie
{
  public static final String H = "MultiForwardActivity";
  String I;
  public String J;
  ...
  protected boolean a(boolean paramBoolean)
  {
    ...
    this.I = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getIntent().getStringExtra("multi_url");
    ...
    this.J = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getIntent().getStringExtra("multi_source");
    if (QLog.isDevelopLevel()) {
      QLog.d("MultiMsg", 4, "MultiForwardActivity.doOnCreate ResID = " + this.I + "  msg.uniseq = " + this.jdField_e_of_type_Long);
    }
    ...
    a(false);
    this.jdField_e_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.findViewById(2131296548));
    this.jdField_f_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.findViewById(2131296550));
    this.jdField_f_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.findViewById(2131296551));
    this.g = ((TextView)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.findViewById(2131296552));
    this.jdField_b_of_type_ComTencentMobileqqBubbleChatXListView = ((ChatXListView)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.findViewById(2131296549));
    ...
    if (localObject != null)
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqBubbleChatXListView.b(this.jdField_c_of_type_AndroidViewView);
      ...
      this.jdField_b_of_type_ComTencentMobileqqWidgetScrollerRunnable = new ScrollerRunnable(this.jdField_b_of_type_ComTencentMobileqqBubbleChatXListView);
      this.jdField_b_of_type_ComTencentMobileqqActivityAioChatAdapter1 = new ChatAdapter1(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
      ...
      this.jdField_b_of_type_ComTencentMobileqqBubbleChatXListView.setOverscrollHeader(a().getResources().getDrawable(2130838616));
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(this.J);
  ...
  protected boolean j()
  {
    ...
    {
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130837910);
      ...
      this.bN = this.jdField_b_of_type_AndroidWidgetTextView.getCompoundDrawablePadding();
  ...
  public boolean k()
  {
    if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(this.bN);
