    ...
    if (paramView.getId() == 2131298172)
    {
      ...
      do
      {
        do
        {
          ...
          } while ((!this.jdField_a_of_type_Boolean) || (!this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.h()));
          a(paramMotionEvent);
          return true;
        } while ((i != 3) && (i != 1));
      ...
      } while (!this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.h());
      a(paramMotionEvent);
      return true;
