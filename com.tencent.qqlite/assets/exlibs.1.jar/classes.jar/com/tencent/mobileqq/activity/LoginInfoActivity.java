  ...
  implements View.OnClickListener
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new atz(this);
  private View jdField_a_of_type_AndroidViewView;
  private CompoundButton.OnCheckedChangeListener jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new aui(this);
  ...
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new aug(this);
  private FormSimpleItem jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem;
  private FormSwitchItem jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem;
  private QQProgressDialog jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog;
  private List jdField_a_of_type_JavaUtilList = null;
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new auh(this);
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new aua(this, paramInt));
  }
  ...
  private void a(List paramList)
  {
    ...
    for (;;)
    {
      ...
      Object localObject3 = (RelativeLayout)((View)localObject2).findViewById(2131296449);
      getResources().getString(2131364171);
      Object localObject4 = getResources().getString(2131364170);
      TextView localTextView1 = (TextView)((View)localObject2).findViewById(2131297278);
      Button localButton = (Button)((View)localObject2).findViewById(2131297279);
      localTextView1.setContentDescription(getString(2131364170));
      localButton.setContentDescription(getString(2131364171));
      TextView localTextView2 = (TextView)((View)localObject2).findViewById(2131296455);
      localObject3 = (TextView)((View)localObject2).findViewById(2131296957);
      ...
      if (i == 0)
      {
        ...
        localImageView.setImageResource(2130838131);
        label261:
        if (!TextUtils.isEmpty(((SvcDevLoginInfo)localObject1).strDeviceName)) {
          break label543;
        }
        localTextView2.setText(2131364174);
      }
      for (;;)
      {
        localObject4 = new StringBuffer();
        if (((SvcDevLoginInfo)localObject1).iLoginTime > 0L) {
          ((StringBuffer)localObject4).append(TimeFormatterUtils.a(((SvcDevLoginInfo)localObject1).iLoginTime * 1000L, "MM-dd HH:mm"));
        }
        if (!TextUtils.isEmpty(((SvcDevLoginInfo)localObject1).strLoginLocation))
        {
          ((StringBuffer)localObject4).append(" ");
          ((StringBuffer)localObject4).append(((SvcDevLoginInfo)localObject1).strLoginLocation);
        }
        if (!TextUtils.isEmpty(((SvcDevLoginInfo)localObject1).strDeviceTypeInfo))
        {
          ((StringBuffer)localObject4).append(" ");
          ((StringBuffer)localObject4).append(((SvcDevLoginInfo)localObject1).strDeviceTypeInfo);
        }
        if (((StringBuffer)localObject4).length() > 0) {
          ((TextView)localObject3).setText(((StringBuffer)localObject4).toString());
        }
        ...
        localButton.setOnClickListener(new auc(this, localButton, i));
        break label261;
        label543:
        localTextView2.setText(((SvcDevLoginInfo)localObject1).strDeviceName);
      }
      label556:
  ...
  private void a(DevlockInfo paramDevlockInfo)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        ...
        this.d.setText(getString(2131364209));
      ...
      else
      {
        ...
        this.d.setText(getString(2131364208));
  ...
  private void d()
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new aub(this));
  }
  
  private void e()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setClickable(true);
    this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(getResources().getColorStateList(2131427473));
    this.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(4);
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    setTitle(2131364298);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131297273));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131297272));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131297267));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131297274));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131297268));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem = ((FormSimpleItem)findViewById(2131297275));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)findViewById(2131297271));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setContentDescription(getString(2131363030));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131297276);
    ...
    paramBundle = new SpannableString(getResources().getString(2131364169));
    this.d = ((TextView)findViewById(2131297270));
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131297063));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131297269));
    int i = paramBundle.length();
    paramBundle.setSpan(new auj(this, null), 0, i, 33);
    paramBundle.setSpan(new ForegroundColorSpan(getResources().getColor(2131427477)), 0, i, 33);
