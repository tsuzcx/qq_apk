  ...
  implements Handler.Callback, UpgradeController.OnStateChangedListener
{
  ...
  private void c()
  {
    this.jdField_a_of_type_AndroidViewView = findViewById(2131298923);
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_ComTencentSmttSdkWebView = ((ProtectedWebView)findViewById(2131298922));
    ...
    this.jdField_a_of_type_ComTencentSmttSdkWebView.setWebViewClient(new brt(this, null));
    this.jdField_a_of_type_ComTencentSmttSdkWebView.setWebChromeClient(new brs(this, null));
    ...
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131298925));
  }
