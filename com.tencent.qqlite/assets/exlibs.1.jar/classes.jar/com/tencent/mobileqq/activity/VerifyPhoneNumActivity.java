  ...
  implements View.OnClickListener
{
  ...
  public Dialog a;
  private Handler jdField_a_of_type_AndroidOsHandler = new bsa(this);
  private ViewGroup jdField_a_of_type_AndroidViewViewGroup;
  private Button jdField_a_of_type_AndroidWidgetButton;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private ContactBindObserver jdField_a_of_type_ComTencentMobileqqPhonecontactContactBindObserver = new bsf(this);
  private QQProgressDialog jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog;
  protected QQToastNotifier a;
  WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new bse(this);
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131298947));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131298948));
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131298946));
    try
    {
      if ((this.d != null) && (this.d.length() > 4))
      {
        String str = "***" + this.d.substring(this.d.length() - 4, this.d.length());
        str = getString(2131363345, new Object[] { this.jdField_b_of_type_JavaLangString, str, this.e });
  ...
  private void j()
  {
    this.jdField_b_of_type_AndroidOsHandler.post(new bsg(this));
  }
  
  private void k()
  {
    this.jdField_b_of_type_AndroidOsHandler.post(new bsh(this));
  }
  ...
  protected void a(int paramInt)
  {
    try
    {
      this.jdField_a_of_type_AndroidOsHandler.post(new bsc(this, paramInt));
      return;
    }
    catch (Exception localException)
    {
  ...
  public void c()
  {
    try
    {
      this.jdField_a_of_type_AndroidOsHandler.post(new bsb(this));
      return;
    }
    catch (Exception localException)
    {
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)setContentViewB(2130903699));
    setTitle(2131363344);
