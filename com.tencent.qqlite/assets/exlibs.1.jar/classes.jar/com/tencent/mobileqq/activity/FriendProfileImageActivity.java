  ...
  implements View.OnClickListener
{
  ...
  public AsyncTask a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new apg(this);
  public View a;
  ...
  public Gallery a;
  Runnable jdField_a_of_type_JavaLangRunnable = new apd(this);
  public boolean a;
  public int b;
  View b;
  ...
  private void a(Rect paramRect1, Rect paramRect2)
  {
    ...
    for (;;)
    {
      ...
      paramRect1.setDuration(this.jdField_a_of_type_Long);
      paramRect1.setInterpolator(new AccelerateDecelerateInterpolator());
      paramRect1.setAnimationListener(new ape(this));
  ...
  private void a(TextView paramTextView)
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setAnimationListener(new apb(this, paramTextView));
    this.jdField_b_of_type_AndroidViewAnimationAlphaAnimation.setAnimationListener(new apc(this, paramTextView));
  }
  ...
  private void e()
  {
    ...
    localActionSheet.a(new app(this, localProfileImageInfo, localActionSheet));
  ...
  void a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.b(2131363261);
    }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      return;
      DialogUtil.a(this, 230).setTitle(getString(2131363454)).setMessage(getString(2131363456)).setPositiveButton(getString(2131363455), new apr(this, paramString1, paramString2)).setNegativeButton(getString(2131362798), new apq(this)).show();
    }
  }
  ...
  public void b(FriendProfileImageModel.ProfileImageInfo paramProfileImageInfo)
  {
    if (!NetworkUtil.e(this)) {
      QQToast.a(this, getString(2131363457), 0).a();
    }
    Card localCard;
    do
    {
  ...
  public void b(String paramString1, String paramString2)
  {
    ...
    {
      QQToast.a(this, getString(2131363451) + " " + AppConstants.au, 0).a();
      return;
    }
    QQToast.a(this, getString(2131363452), 0).a();
  }
  ...
  public void d()
  {
    ...
    localAnimationSet.setAnimationListener(new apf(this));
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_b_of_type_AndroidViewView = findViewById(2131296448);
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)findViewById(2131297182));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)findViewById(2131296443));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131297185));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new apa(this));
    ...
    for (this.jdField_a_of_type_Boolean = true;; this.jdField_a_of_type_Boolean = false)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileImageModel.a(new api(this));
      ...
      this.jdField_a_of_type_ComTencentWidgetGallery.setOnItemClickListener(new apk(this));
      this.jdField_a_of_type_ComTencentWidgetGallery.setOnItemSelectedListener(new apl(this));
      a(this.jdField_a_of_type_AndroidWidgetTextView);
      this.jdField_a_of_type_ComTencentWidgetGallery.setOnItemLongClickListener(new apm(this));
      this.jdField_a_of_type_AndroidOsAsyncTask = new apn(this, localProfileImageInfo);
      return true;
    ...
    for (;;)
    {
      try
      {
        if (((FriendProfileImageModel.ProfileImageInfo)localObject2).h == 6)
        {
          ...
          localObject3 = ImageUtil.a((Rect)localObject2, (int)getResources().getDimension(2131492904), f1);
