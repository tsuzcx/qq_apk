  ...
  implements ProGallery.OnProGalleryListener
{
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (!"I:E".equals(localAIOImageData.e))
      {
        ...
        {
          paramViewGroup = new URLDrawable.URLDrawableOptions();
        ...
        {
          paramView = new URLDrawable.URLDrawableOptions();
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    {
      paramView.setImageDrawable(BaseApplicationImpl.a().getResources().getDrawable(2130837552));
      a(paramInt, false);
    }
    while (((AIOImageData)localObject).a(2) == null) {
      return;
    }
    localObject = ((AIOImageData)localObject).a(2);
    URLDrawable.URLDrawableOptions localURLDrawableOptions = new URLDrawable.URLDrawableOptions();
    localURLDrawableOptions.mPlayGifImage = true;
    if (URLDrawable.getDrawable((String)localObject, localURLDrawableOptions).getStatus() == 1) {
  ...
  public void a(int paramInt, View paramView, ViewGroup paramViewGroup, boolean paramBoolean)
  {
    ...
    if ((URLImageView.class.isInstance(paramView)) && (URLDrawable.class.isInstance(((URLImageView)paramView).getDrawable()))) {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localGalleryURLImageView.b)
        {
          ...
          AIOGalleryActivity.a().a(paramViewGroup.getURL().toString());
      ...
      localGalleryURLImageView.setImageDrawable(BaseApplicationImpl.a().getResources().getDrawable(2130837552));
      a(paramInt, false);
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        AIOGalleryActivity.a().a(((URLDrawable)localObject).getURL().toString());
        break;
        bool1 = false;
        break label482;
        label731:
