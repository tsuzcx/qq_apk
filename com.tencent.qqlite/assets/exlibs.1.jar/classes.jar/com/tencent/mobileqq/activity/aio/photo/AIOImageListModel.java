  ...
  implements AbstractImageListModel
{
  ...
  public int a(long paramLong, int paramInt1, int paramInt2, String paramString)
  {
    ...
    while (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      if ((localAIOImageInfo.a.a == paramLong) && (localAIOImageInfo.a.jdField_d_of_type_Int == paramInt1))
      {
        switch (paramInt2)
        {
        case 3: 
        default: 
          return i;
        case 2: 
          localAIOImageInfo.a.e = paramString;
          return i;
        case 4: 
          localAIOImageInfo.a.f = paramString;
          return i;
        }
        localAIOImageInfo.a.jdField_d_of_type_JavaLangString = paramString;
        return i;
      }
      i += 1;
    }
  ...
  public void a(AIOImageData[] paramArrayOfAIOImageData, int paramInt)
  {
    ...
    if (i < paramArrayOfAIOImageData.length)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageInfo.a.a == localAIOImageData.a) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageInfo.a.jdField_d_of_type_Int == localAIOImageData.jdField_d_of_type_Int))
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageInfo.a = localAIOImageData;
      ...
      for (;;)
      {
        i += 1;
        break;
        if ((this.jdField_b_of_type_ComTencentMobileqqActivityAioPhotoAIOImageInfo.a.a == localAIOImageData.a) && (this.jdField_b_of_type_ComTencentMobileqqActivityAioPhotoAIOImageInfo.a.jdField_d_of_type_Int == localAIOImageData.jdField_d_of_type_Int))
        {
          this.jdField_b_of_type_ComTencentMobileqqActivityAioPhotoAIOImageInfo.a = localAIOImageData;
