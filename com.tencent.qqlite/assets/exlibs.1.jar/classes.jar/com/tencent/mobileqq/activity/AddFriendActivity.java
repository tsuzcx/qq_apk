  ...
  implements TextWatcher, View.OnClickListener
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new wj(this);
  public View a;
  ...
  public GridView a;
  public TextView a;
  ContactSearchFacade.ISearchListener jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactContactSearchFacade$ISearchListener = new wf(this);
  private ContactSearchFacade jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactContactSearchFacade;
  FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new we(this);
  ...
  {
    this.e = false;
    this.jdField_a_of_type_ComTencentMobileqqAppLBSObserver = new wc(this);
    this.jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new wg(this);
    this.jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new wk(this);
  }
  ...
  private void d()
  {
    Button localButton = (Button)findViewById(2131296524);
    TextView localTextView = (TextView)findViewById(2131296522);
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131296512));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(this);
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131296525));
    if (this.jdField_b_of_type_Boolean)
    {
      setTitle(2131363513);
      localTextView.setText(2131363515);
    ...
    for (;;)
    {
      ...
      return;
      setTitle(2131363512);
      localTextView.setText(2131363514);
    }
  ...
  private void e()
  {
    ...
    Object localObject = findViewById(2131296526);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131296527));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131296528));
    this.jdField_a_of_type_AndroidViewView = ((View)localObject).findViewById(2131296529);
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131296531));
    this.jdField_a_of_type_AndroidWidgetGridView = ((GridView)((View)localObject).findViewById(2131296532));
    ...
    {
      localObject = getResources().getDrawable(2130837924);
    ...
    this.jdField_c_of_type_AndroidWidgetTextView.setText(2131363389);
  }
  ...
  private void f()
  {
    ...
    for (int i = 0;; i = 4)
    {
      ...
      this.jdField_a_of_type_Wl = new wl(this);
      this.jdField_a_of_type_AndroidWidgetGridView.setAdapter(this.jdField_a_of_type_Wl);
      return;
    }
  }
  ...
  {
    runOnUiThread(new wh(this, paramInt));
  }
  ...
  {
    runOnUiThread(new wi(this, paramString));
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      {
        e();
        paramBundle.setOnTouchListener(new wb(this));
      }
      return true;
