...
public class LinkShareActionSheetBuilder
{
  ...
  {
    ActionSheet localActionSheet = (ActionSheet)ActionSheetHelper.a(this.a, null, 2131624120);
    GridView localGridView = (GridView)View.inflate(this.a, 2130903693, null);
    localGridView.setBackgroundDrawable(this.a.getResources().getDrawable(2130837508));
    localGridView.setAdapter(new cfl(this, null));
