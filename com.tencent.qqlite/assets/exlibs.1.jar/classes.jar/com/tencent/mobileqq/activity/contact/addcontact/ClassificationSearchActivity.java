  ...
  extends SearchBaseActivity
{
  ...
  private cbt jdField_a_of_type_Cbt;
  ...
  protected void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Cbt.notifyDataSetChanged();
  }
  ...
  {
    super.c();
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new cbr(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setContentDescription("搜索栏" + this.jdField_d_of_type_JavaLangString);
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      this.jdField_a_of_type_AndroidViewView = getLayoutInflater().inflate(2130903468, this.jdField_a_of_type_ComTencentWidgetXListView, false);
  ...
  protected void d()
  {
    ...
    if (jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactSearchResult != null) {
      if (!jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactSearchResult.jdField_a_of_type_Boolean)
      {
        ...
        ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131298137)).setText(ViewFactory.a(jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactSearchResult.jdField_a_of_type_Int));
  ...
  protected void doOnResume()
  {
    ...
    {
      Looper.myQueue().addIdleHandler(new cbq(this));
  ...
  protected void e()
  {
    ...
    if (this.jdField_a_of_type_Cbt == null)
    {
      this.jdField_a_of_type_Cbt = new cbt(this, null);
      this.jdField_a_of_type_Cbt.a(this.jdField_a_of_type_JavaUtilList);
      ...
      if (this.f == 0)
      {
        ...
        this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Cbt);
        this.a = this.jdField_a_of_type_Cbt;
      }
    }
    else
    {
      ...
      this.jdField_a_of_type_Cbt.a().addAll(this.jdField_a_of_type_JavaUtilList);
    }
    for (;;)
    {
      this.jdField_a_of_type_Cbt.notifyDataSetChanged();
  ...
  public void onClick(View paramView)
  {
    ...
    label34:
    while ((!(paramView instanceof cbs)) || ((this.jdField_a_of_type_Int != 3) && (this.jdField_a_of_type_Int != 4))) {
      return;
    }
    if (NetworkUtil.e(this)) {}
