...
public class ChatLayoutFactory
{
  public static View a(Context paramContext)
  {
    ...
    localXPanelContainer.setId(2131296567);
    ...
    ((InputLinearLayout)localObject3).setId(2131296667);
    ...
    ((InputLinearLayout)localObject3).setBackgroundResource(2130839217);
    ((RelativeLayout)localObject1).addView((View)localObject3);
    localObject4 = new View(paramContext);
    ((View)localObject4).setId(2131296668);
    ...
    ((ImageButton)localObject4).setId(2131296930);
    ...
    ((ImageButton)localObject4).setBackgroundResource(2130839516);
    ((ImageButton)localObject4).setImageResource(2130839068);
    ...
    ((XEditTextEx)localObject4).setId(2131296669);
    localLayoutParams = new LinearLayout.LayoutParams(-1, -1);
    ...
    ((XEditTextEx)localObject4).setBackgroundResource(2130839218);
    ...
    ((InputLinearLayout)localObject3).addView((View)localObject4);
    localObject4 = new ImageButton(paramContext);
    ((ImageButton)localObject4).setId(2131296670);
    localLayoutParams = new LinearLayout.LayoutParams(-1, -1);
    localLayoutParams.width = AIOUtils.a(57.0F, (Resources)localObject2);
    localLayoutParams.height = ((Resources)localObject2).getDimensionPixelSize(2131492982);
    localLayoutParams.gravity = 80;
    ...
    ((ImageButton)localObject4).setLayoutParams(localLayoutParams);
    ((ImageButton)localObject4).setBackgroundResource(2130837595);
    ((ImageButton)localObject4).setImageResource(2130837599);
    ((InputLinearLayout)localObject3).addView((View)localObject4);
    localObject2 = new LinearLayout(paramContext);
    ((LinearLayout)localObject2).setId(2131296671);
    ...
    ((RelativeLayout)localObject1).setId(2131296672);
