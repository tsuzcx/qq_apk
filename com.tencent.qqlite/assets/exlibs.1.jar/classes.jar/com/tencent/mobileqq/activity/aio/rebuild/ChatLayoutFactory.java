...
public class ChatLayoutFactory
{
  public static View a(Context paramContext)
  {
    ...
    ((InputLinearLayout)localObject3).setBackgroundResource(2130839181);
    ((RelativeLayout)localObject1).addView((View)localObject3);
    ...
    ((ImageButton)localObject4).setBackgroundResource(2130839451);
    ((ImageButton)localObject4).setImageResource(2130839035);
    ...
    ((XEditTextEx)localObject4).setBackgroundResource(2130839184);
    ...
    ((XEditTextEx)localObject4).setTextColor(((Resources)localObject2).getColor(2131427503));
    ...
    ((ImageView)localObject4).setBackgroundResource(2130839451);
    ((ImageView)localObject4).setScaleType(ImageView.ScaleType.CENTER);
    ((ImageView)localObject4).setVisibility(8);
    ((InputLinearLayout)localObject3).addView((View)localObject4);
    localObject4 = new ImageButton(paramContext);
    ((ImageButton)localObject4).setId(2131296669);
    localLayoutParams = new LinearLayout.LayoutParams(-1, -1);
    ...
    ((ImageButton)localObject4).setLayoutParams(localLayoutParams);
    ((ImageButton)localObject4).setBackgroundResource(2130837581);
    ((ImageButton)localObject4).setImageResource(2130837585);
    ((InputLinearLayout)localObject3).addView((View)localObject4);
