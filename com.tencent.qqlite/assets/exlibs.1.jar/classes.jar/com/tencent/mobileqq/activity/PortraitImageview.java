  ...
  extends View
{
  ...
  private void a(Context paramContext)
  {
    ...
    this.jdField_c_of_type_JavaLangRunnable = new bas(this);
    this.jdField_a_of_type_AndroidViewScaleGestureDetector = new ScaleGestureDetector(paramContext, new bax(this));
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(paramContext, new baw(this, null));
  ...
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    float f1 = a();
    post(new bau(this, paramFloat4, System.currentTimeMillis(), f1, paramFloat1, paramFloat2, paramFloat3));
  }
  ...
  {
    this.jdField_a_of_type_JavaLangRunnable = new bav(this, paramFloat3, System.currentTimeMillis(), paramFloat1, paramFloat2);
  ...
  public void setImageBitmap(Bitmap paramBitmap)
  {
    ...
    if (getWidth() <= 0)
    {
      this.jdField_b_of_type_JavaLangRunnable = new bat(this, paramBitmap);
      return;
    }
    if (paramBitmap != null) {
