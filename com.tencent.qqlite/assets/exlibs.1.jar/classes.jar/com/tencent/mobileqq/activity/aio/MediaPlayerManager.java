  ...
  implements SensorEventListener, AudioPlayer.AudioPlayerListener, Manager
{
  ...
  private MediaPlayer.OnCompletionListener jdField_a_of_type_AndroidMediaMediaPlayer$OnCompletionListener = new bsw(this);
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  private bsz jdField_a_of_type_Bsz;
          ...
          try
          {
            ...
            if (!bool)
            {
              ...
              if (j != 0)
              {
                ...
                this.jdField_a_of_type_Bsz = new bsz(this);
              }
  ...
  public void a(AudioPlayer paramAudioPlayer, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new bsx(this, paramAudioPlayer, paramInt));
  }
      ...
      if (a(false))
      {
        ...
        for (this.jdField_d_of_type_Boolean = true;; this.jdField_d_of_type_Boolean = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.u())
        {
          ...
          if ((this.jdField_b_of_type_AndroidHardwareSensor != null) && (this.jdField_a_of_type_AndroidHardwareSensor != null))
          {
            ...
            this.jdField_a_of_type_AndroidHardwareSensorManager.registerListener(this.jdField_a_of_type_Bsz, this.jdField_b_of_type_AndroidHardwareSensor, 3);
          }
          if (this.jdField_a_of_type_AndroidHardwareSensor != null) {
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new bsy(this, paramInt));
  }
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_AndroidHardwareSensorManager.unregisterListener(this.jdField_a_of_type_Bsz);
