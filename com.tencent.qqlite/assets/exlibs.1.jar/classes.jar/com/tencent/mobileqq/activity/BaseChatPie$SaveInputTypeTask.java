  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    do
    {
      ...
      localObject = (FriendsManager)((QQAppInterface)localObject).getManager(43);
    ...
    ((FriendsManager)localObject).a((NoC2CExtensionInfo)this.jdField_a_of_type_ComTencentMobileqqPersistenceEntity);
  }
}
