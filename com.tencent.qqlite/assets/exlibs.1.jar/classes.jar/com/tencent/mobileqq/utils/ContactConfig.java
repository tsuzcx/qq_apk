...
public class ContactConfig
{
  ...
  {
    return paramContext.getSharedPreferences("QQLite", 0).getLong("pref_req_self_level_time" + paramString, 0L);
  }
  ...
  {
    int i = 0;
    paramContext = paramContext.getSharedPreferences(String.valueOf(AppConstants.Y), 0).edit();
  ...
  {
    paramContext.getSharedPreferences("QQLite", 0).edit().putLong("pref_req_self_level_time" + paramString, System.currentTimeMillis()).commit();
  }
  ...
  {
    paramContext.getSharedPreferences("QQLite", 0).edit().putBoolean("save_qqhead_to_app_storage", paramBoolean).commit();
  }
  
  public static boolean a(Context paramContext)
  {
    return paramContext.getSharedPreferences("QQLite", 0).getBoolean("save_qqhead_to_app_storage", false);
  }
  ...
  {
    return paramContext.getSharedPreferences("QQLite", 0).getLong("pref_req_x_man_prefix" + paramString, 0L);
  }
  
  public static void b(Context paramContext, String paramString, int paramInt)
  {
    paramContext.getSharedPreferences(String.valueOf(AppConstants.Y), 0).edit().putInt(paramString, paramInt).commit();
  }
  
  public static void b(Context paramContext, String paramString, long paramLong)
  {
    paramContext.getSharedPreferences("QQLite", 0).edit().putLong("pref_req_x_man_prefix" + paramString, paramLong).commit();
  }
