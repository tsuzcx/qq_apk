  ...
  extends AppActivity
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfJavaLangString = new String[20];
  ...
  private void e()
  {
    ...
    if (DownloaderFactory.jdField_a_of_type_Boolean)
    {
      ...
      if (!new File(AppConstants.aq + "/Tencent/com/tencent/mobileqq/testserver").exists()) {
        break label422;
      }
      jdField_a_of_type_ArrayOfJavaLangString[10] = "测试环境";
      localObject = BaseApplicationImpl.a().getSharedPreferences("QQLite", 0);
    ...
    {
      arrayOfString[16] = str;
      AppSetting.k = ((SharedPreferences)localObject).getBoolean("autoDumpLeak", false);
      if (!AppSetting.k) {
        break label521;
      }
      jdField_a_of_type_ArrayOfJavaLangString[19] = "自动生成内存泄漏dump[ON]";
      return;
    ...
    label521:
    jdField_a_of_type_ArrayOfJavaLangString[19] = "自动生成内存泄漏dump[OFF]";
  }
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_JavaLangRunnable = new dcz(this);
  ...
  private void h()
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: new 75	java/io/File
    //   6: dup
    //   7: getstatic 98	com/tencent/mobileqq/debug/DebugActivity:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   10: invokespecial 176	java/io/File:<init>	(Ljava/lang/String;)V
    //   13: astore_3
    //   14: aload_3
    //   15: invokevirtual 180	java/io/File:exists	()Z
    //   18: ifne +54 -> 72
    //   21: aload_3
    //   22: invokevirtual 370	java/io/File:createNewFile	()Z
    //   25: pop
    //   26: new 372	java/io/BufferedWriter
    //   29: dup
    //   30: new 374	java/io/FileWriter
    //   33: dup
    //   34: getstatic 98	com/tencent/mobileqq/debug/DebugActivity:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   37: invokespecial 375	java/io/FileWriter:<init>	(Ljava/lang/String;)V
    //   40: invokespecial 378	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   43: astore_3
    //   44: aload_3
    //   45: ldc_w 380
    //   48: invokevirtual 383	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   51: invokestatic 388	java/lang/Thread:activeCount	()I
    //   54: istore_2
    //   55: iload_2
    //   56: ifne +39 -> 95
    //   59: aload_3
    //   60: invokevirtual 391	java/io/BufferedWriter:close	()V
    //   63: aload_3
    //   64: ifnull +7 -> 71
    //   67: aload_3
    //   68: invokevirtual 391	java/io/BufferedWriter:close	()V
    //   71: return
    //   72: aload_3
    //   73: invokevirtual 394	java/io/File:delete	()Z
    //   76: pop
    //   77: goto -51 -> 26
    //   80: astore_3
    //   81: aload 4
    ...
    //   85: ifnull -14 -> 71
    //   88: aload_3
    //   89: invokevirtual 391	java/io/BufferedWriter:close	()V
    //   92: return
    //   93: astore_3
    //   94: return
    //   95: iload_2
    //   96: anewarray 385	java/lang/Thread
    //   99: astore 4
    //   101: aload 4
    //   103: invokestatic 398	java/lang/Thread:enumerate	([Ljava/lang/Thread;)I
    //   106: pop
    //   107: iconst_0
    //   108: istore_1
    //   109: goto +161 -> 270
    //   112: aload 5
    //   114: invokevirtual 401	java/lang/Thread:isAlive	()Z
    //   117: ifeq +169 -> 286
    //   120: aload_3
    //   121: new 64	java/lang/StringBuilder
    //   124: dup
    //   125: invokespecial 67	java/lang/StringBuilder:<init>	()V
    //   128: ldc_w 403
    //   131: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   134: aload 5
    //   136: invokevirtual 406	java/lang/Thread:getName	()Ljava/lang/String;
    ...
    //   151: invokevirtual 383	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   154: aload_3
    //   155: new 64	java/lang/StringBuilder
    //   158: dup
    //   159: invokespecial 67	java/lang/StringBuilder:<init>	()V
    //   162: ldc_w 410
    //   165: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   168: aload_0
    //   169: aload 5
    //   171: invokevirtual 414	java/lang/Thread:getStackTrace	()[Ljava/lang/StackTraceElement;
    //   174: invokespecial 416	com/tencent/mobileqq/debug/DebugActivity:a	([Ljava/lang/StackTraceElement;)Ljava/lang/String;
    ...
    //   186: invokevirtual 88	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   189: invokevirtual 383	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   192: goto +94 -> 286
    //   195: astore 4
    //   197: goto -113 -> 84
    //   200: aload_3
    //   201: ldc_w 420
    //   204: invokevirtual 383	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   207: aload_3
    //   208: invokevirtual 423	java/io/BufferedWriter:flush	()V
    //   211: aload_3
    //   212: invokevirtual 391	java/io/BufferedWriter:close	()V
    //   215: aload_3
    //   216: ifnull -145 -> 71
    //   219: aload_3
    //   220: invokevirtual 391	java/io/BufferedWriter:close	()V
    //   223: return
    //   224: astore_3
    //   225: return
    //   226: astore 4
    //   228: aload 4
    //   230: invokevirtual 424	java/io/IOException:printStackTrace	()V
    //   233: goto -26 -> 207
    //   236: astore 5
    //   238: aload_3
    //   239: astore 4
    ...
    //   246: ifnull +8 -> 254
    //   249: aload 4
    //   251: invokevirtual 391	java/io/BufferedWriter:close	()V
    //   254: aload_3
    //   255: athrow
    //   256: astore_3
    //   257: return
  ...
  public void a()
  {
    ...
    if ((localObject1 instanceof QQAppInterface))
    {
      ...
      this.jdField_a_of_type_AndroidAppAlertDialog = this.jdField_a_of_type_AndroidAppAlertDialog$Builder.setTitle("图片预下载信息").setItems((CharSequence[])localObject2, new dda(this, null)).create();
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetListView.setOnItemClickListener(new dcx(this));
    return true;
  }
