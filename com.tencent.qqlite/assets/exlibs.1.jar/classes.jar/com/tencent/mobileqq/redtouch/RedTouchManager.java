  ...
  implements Manager
{
  ...
  private BusinessInfoCheckUpdate.TimeRspBody jdField_a_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$TimeRspBody;
  ...
  public static int a(String paramString)
  {
    ...
    try
    {
      j = Integer.parseInt(paramString[(paramString.length - 1)]);
      return j;
    }
  ...
  public int a(int paramInt, boolean paramBoolean, long paramLong)
  {
    ...
    if ((localTimeRspBody != null) && ((localTimeRspBody.has()) || (localTimeRspBody.rptSetting.has())))
    {
      ...
      for (;;)
      {
        if (j < k)
        {
          if (paramInt == ((BusinessInfoCheckUpdate.AppSetting)((BusinessInfoCheckUpdate.AppSetting)localList.get(j)).get()).appid.get()) {
            localList.set(j, localAppSetting);
          }
        }
        else
        {
  ...
  public int a(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    for (;;)
    {
      if (j < k)
      {
        if (paramAppInfo.path.get().equals(((BusinessInfoCheckUpdate.AppInfo)localList.get(j)).path.get()))
        {
          a("path is same = " + paramAppInfo.path);
          localList.set(j, paramAppInfo);
        }
      }
      else
      {
  ...
  public RedTouchInfo a(int paramInt)
  {
    ...
    {
      BusinessInfoCheckUpdate.AppInfo localAppInfo = (BusinessInfoCheckUpdate.AppInfo)localList1.get(n);
      int i1;
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          for (;;)
          {
            if ((i1 >= localList2.size()) || (localAppInfo.uiAppId.get() == ((BusinessInfoCheckUpdate.AppSetting)localList2.get(i1)).appid.get()))
            {
              if ((i1 >= localList2.size()) || (((BusinessInfoCheckUpdate.AppSetting)localList2.get(i1)).setting.get())) {
                break label270;
              }
              i1 = paramInt;
              paramInt = m;
    ...
    localRedTouchInfo.h = paramInt;
    localRedTouchInfo.g = k;
    localRedTouchInfo.i = j;
    localRedTouchInfo.j = m;
    localRedTouchInfo.b = str;
  ...
  public BusinessInfoCheckUpdate.TimeRspBody a()
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$TimeRspBody != null)) {
      return this.jdField_a_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$TimeRspBody;
    }
    try
    {
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      j = localRedTouchInfo.h;
      k = localRedTouchInfo.g;
      m = localRedTouchInfo.j;
    } while (localRedTouchInfo.i + (j + k + m) <= 0);
    switch (paramInt)
    {
    default: 
      return;
