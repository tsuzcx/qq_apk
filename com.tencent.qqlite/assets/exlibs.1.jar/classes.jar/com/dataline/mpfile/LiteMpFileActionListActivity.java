  ...
  implements View.OnClickListener, AdapterView.OnItemClickListener, Observer
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new by(this);
  ...
  private void e()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetTextView != null)
    {
      ...
      if (localQQMessageFacade != null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setText(getString(2131362946) + "(99+)");
      }
    }
    return;
    label66:
    this.jdField_a_of_type_AndroidWidgetTextView.setText(getString(2131362946) + "(" + m + ")");
    return;
    label107:
    this.jdField_a_of_type_AndroidWidgetTextView.setText(getString(2131362946));
  }
  ...
  protected void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        ...
        Toast.makeText(this, String.format("你选择了 %d 个文件", new Object[] { Integer.valueOf(jdField_a_of_type_JavaUtilArrayList.size()) }), 0).show();
        return;
      } while (paramInt2 != -1);
      return;
  ...
  public void onClick(View paramView)
  {
    if (paramView == this.jdField_b_of_type_AndroidWidgetButton)
    {
      ...
      paramView.putExtra("targetUin", AppConstants.T);
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)findViewById(2131298120));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.d = ((Button)findViewById(2131298121));
    this.c = ((Button)findViewById(2131298122));
