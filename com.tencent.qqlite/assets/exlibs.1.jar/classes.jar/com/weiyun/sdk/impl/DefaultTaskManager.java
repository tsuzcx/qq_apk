  ...
  implements IWyTaskManager
{
  ...
  public void init(int paramInt, String paramString)
  {
    ...
    //   33: dup
    //   34: aload_2
    //   35: invokestatic 50	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   38: invokespecial 53	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   41: ldc 55
    ...
    //   55: iload_1
    //   56: aload_3
    //   57: invokespecial 65	com/weiyun/sdk/job/schedule/WyTaskManager:<init>	(ILjava/lang/String;)V
    //   60: putfield 17	com/weiyun/sdk/impl/DefaultTaskManager:mTaskManager	Lcom/weiyun/sdk/job/schedule/WyTaskManager;
    //   63: invokestatic 71	com/weiyun/sdk/context/SdkContext:getInstance	()Lcom/weiyun/sdk/context/SdkContext;
    //   66: invokevirtual 75	com/weiyun/sdk/context/SdkContext:getContext	()Landroid/content/Context;
    //   69: invokestatic 81	com/weiyun/sdk/util/NetworkUtils:setContext	(Landroid/content/Context;)V
    //   72: aload_0
    //   73: monitorexit
    //   74: return
    //   75: iconst_1
