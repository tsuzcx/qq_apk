  ...
  extends DownloadAddressFetcher
{
  ...
  protected int sendRequest()
  {
    ...
    if (SdkContext.getInstance().getSender().sendRequest("OfflineFilleHandleSvr.pb_weiyun_CMD_REQ_OFFLINE_FILE_DOWNLOAD-258", localReqBody.toByteArray(), new OfflineFileDownloadRequestCallback(null))) {
      return 0;
    }
    return -10011;
  }
