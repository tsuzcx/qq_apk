  ...
  extends WtloginObserver
{
  ...
  public void OnCloseCode(String paramString, byte[] paramArrayOfByte1, long paramLong, WUserSigInfo paramWUserSigInfo, byte[] paramArrayOfByte2, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    try
    {
      ...
      if (paramInt == 0)
      {
        QQToast.a(this.a.getApplicationContext(), 2, 2131364237, 0).b(DevlockQuickLoginActivity.a(this.a));
      ...
      if (paramInt == 21)
      {
        paramString = this.a.getString(2131364242);
        paramArrayOfByte1 = this.a.getString(2131364125);
        this.a.a(null, paramString, paramArrayOfByte1, new aik(this));
        return;
      }
      paramString = DevlockQuickLoginActivity.a(this.a, 2131364238);
  ...
  public void OnException(String paramString, int paramInt)
  {
    ...
    DevlockQuickLoginActivity.a(this.a);
    QQToast.a(DevlockQuickLoginActivity.b(this.a), 1, this.a.getString(2131364241), 0).b(DevlockQuickLoginActivity.d(this.a));
  }
  ...
  public void OnVerifyCode(String paramString, byte[] paramArrayOfByte1, long paramLong, ArrayList paramArrayList, byte[] paramArrayOfByte2, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt == 21)
    {
      paramString = this.a.getString(2131364242);
      paramArrayOfByte1 = this.a.getString(2131364125);
      this.a.a(null, paramString, paramArrayOfByte1, new ail(this));
      return;
    }
