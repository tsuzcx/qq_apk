  ...
  extends AsyncTask
{
  ...
  public abl(ChatActivity paramChatActivity) {}
  ...
  protected void a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      if (i == this.b)
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131364533), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getTitleBarHeight());
        return;
      }
      if (i == this.jdField_a_of_type_Int)
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131364534), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getTitleBarHeight());
        return;
      }
    }
    catch (Exception paramJSONObject)
    {
      ...
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131364536), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getTitleBarHeight());
      paramJSONObject.printStackTrace();
      return;
    }
    if ((i == this.c) || (i == this.d)) {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131364535), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getTitleBarHeight());
    }
  }
  ...
  protected void onPreExecute()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.a.b(2131364532);
