  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public ajr(DiscussionMemberActivity paramDiscussionMemberActivity)
  {
  ...
  private void a()
  {
    ...
    {
      ajq localajq = (ajq)((Iterator)localObject2).next();
      if ((localajq.c == null) || (localajq.c.length() == 0))
      {
        localObject1 = "#";
      ...
      for (localObject1 = ((String)localObject1).toUpperCase();; localObject1 = "#")
      {
        ...
        ((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject1)).add(localajq);
        break;
        localObject1 = localajq.c.substring(0, 1);
        break label66;
      }
    }
  ...
  {
    ajq localajq = (ajq)getItem(paramInt);
    CharDividedFacePreloadBaseAdapter.FaceInfo localFaceInfo = new CharDividedFacePreloadBaseAdapter.FaceInfo(this);
    if (localajq != null) {
      localFaceInfo.jdField_a_of_type_JavaLangString = localajq.jdField_a_of_type_JavaLangString;
    }
  ...
  public Object getItem(int paramInt)
  {
    ...
    i = -(i + 1) - 1;
    return (ajq)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionMemberActivity.getLayoutInflater().inflate(2130903177, paramViewGroup, false);
      paramView = new TroopMemberListActivity.ViewHolder();
      localView.setTag(paramView);
      paramView.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131297014));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131297013));
      paramView.b = ((ImageView)localView.findViewById(2131297015));
      paramView.c = ((TextView)localView.findViewById(2131296879));
    }
    paramView = (TroopMemberListActivity.ViewHolder)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      paramViewGroup = (ajq)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
      ...
      paramView.b.setImageBitmap(a(paramViewGroup.jdField_a_of_type_JavaLangString));
      paramView.c.setText(paramViewGroup.b);
