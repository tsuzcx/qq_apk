...
public class aut
  implements Runnable
{
  public aut(LoginVerifyCodeActivity2 paramLoginVerifyCodeActivity2) {}
  
  public void run()
  {
    if (LoginVerifyCodeActivity2.a(this.a) == 1)
    {
      LoginVerifyCodeActivity2.a(this.a).setText(2131363328);
    ...
    LoginVerifyCodeActivity2.a(this.a).setText(this.a.getString(2131363328) + "(" + LoginVerifyCodeActivity2.a(this.a) + ")");
