  ...
  extends AsyncTask
{
  ...
  public abj(ChatActivity paramChatActivity) {}
  ...
  protected void a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      if (i == this.b)
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131364508), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getTitleBarHeight());
        return;
      }
      if (i == this.jdField_a_of_type_Int)
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131364509), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getTitleBarHeight());
        return;
      }
    }
    catch (Exception paramJSONObject)
    {
      ...
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131364511), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getTitleBarHeight());
      paramJSONObject.printStackTrace();
      return;
    }
    if ((i == this.c) || (i == this.d)) {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131364510), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getTitleBarHeight());
    }
  }
  ...
  protected void onPreExecute()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.a.b(2131364507);
