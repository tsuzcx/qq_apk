...
public class pu
  implements Runnable
{
  public pu(QRDisplayActivity paramQRDisplayActivity) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      QRUtils.a(this.a.app, this.a, str, i, (String)localObject1, (String)localObject2, new pv(this, str, i));
    }
    label739:
    ...
    for (i = 1;; i = 0)
    {
      this.a.findViewById(2131297813).setOnClickListener(this.a);
      if ((this.a.i == null) || (this.a.j == null) || (i == 0)) {
        break label1059;
      }
      ((TextView)this.a.findViewById(2131297812)).setText(this.a.i);
