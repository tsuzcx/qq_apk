...
public final class dx
{
  ...
  static
  {
    ...
    arrayOfInt4 = new int[] { 6, 30, -1, -1, -1, -1, -1 };
    int[] arrayOfInt5 = { 6, 34, -1, -1, -1, -1, -1 };
    ...
    int[] arrayOfInt15 = { 6, 28, 50, 72, 94, -1, -1 };
    int[] arrayOfInt16 = { 6, 28, 54, 80, 106, -1, -1 };
    int[] arrayOfInt17 = { 6, 32, 58, 84, 110, -1, -1 };
    int[] arrayOfInt18 = { 6, 30, 58, 86, 114, -1, -1 };
    int[] arrayOfInt19 = { 6, 30, 54, 78, 102, 126, -1 };
    int[] arrayOfInt20 = { 6, 34, 60, 86, 112, 138, -1 };
    ...
    int[] arrayOfInt25 = { 6, 30, 58, 86, 114, 142, 170 };
    c = new int[][] { arrayOfInt1, arrayOfInt2, { 6, 22, -1, -1, -1, -1, -1 }, arrayOfInt3, arrayOfInt4, arrayOfInt5, arrayOfInt6, { 6, 24, 42, -1, -1, -1, -1 }, arrayOfInt7, { 6, 28, 50, -1, -1, -1, -1 }, { 6, 30, 54, -1, -1, -1, -1 }, arrayOfInt8, arrayOfInt9, arrayOfInt10, arrayOfInt11, { 6, 26, 50, 74, -1, -1, -1 }, { 6, 30, 54, 78, -1, -1, -1 }, arrayOfInt12, arrayOfInt13, arrayOfInt14, arrayOfInt15, { 6, 26, 50, 74, 98, -1, -1 }, { 6, 30, 54, 78, 102, -1, -1 }, arrayOfInt16, arrayOfInt17, arrayOfInt18, { 6, 34, 62, 90, 118, -1, -1 }, { 6, 26, 50, 74, 98, 122, -1 }, arrayOfInt19, { 6, 26, 52, 78, 104, 130, -1 }, { 6, 30, 56, 82, 108, 134, -1 }, arrayOfInt20, { 6, 30, 58, 86, 114, 142, -1 }, arrayOfInt21, { 6, 30, 54, 78, 102, 126, 150 }, arrayOfInt22, arrayOfInt23, arrayOfInt24, { 6, 26, 54, 82, 110, 138, 166 }, arrayOfInt25 };
    ...
    arrayOfInt9 = new int[] { 2, 8 };
    arrayOfInt10 = new int[] { 1, 8 };
    arrayOfInt11 = new int[] { 0, 8 };
    d = new int[][] { { 8, 0 }, arrayOfInt1, { 8, 2 }, { 8, 3 }, arrayOfInt2, arrayOfInt3, { 8, 7 }, arrayOfInt4, arrayOfInt5, arrayOfInt6, arrayOfInt7, arrayOfInt8, arrayOfInt9, arrayOfInt10, arrayOfInt11 };
  }
  ...
  static void a(ErrorCorrectionLevel paramErrorCorrectionLevel, int paramInt, BitArray paramBitArray)
  {
    ...
    paramBitArray.b(paramInt, 5);
    paramBitArray.b(a(paramInt, 1335), 10);
    paramErrorCorrectionLevel = new BitArray();
    paramErrorCorrectionLevel.b(21522, 15);
