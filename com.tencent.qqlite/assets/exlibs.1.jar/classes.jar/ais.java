...
public class ais
  extends Handler
{
  public ais(DiscussionInfoCardActivity paramDiscussionInfoCardActivity) {}
      ...
      do
      {
        do
        {
          ...
          if (i + 1 > DiscussionInfoCardActivity.b(this.a) * 3)
          {
            ...
            DiscussionInfoCardActivity.a(this.a).setOnClickListener(new ait(this));
            ...
            DiscussionInfoCardActivity.a(this.a, new ajc(this.a));
