  ...
  extends BaseAdapter
{
  ...
  public ayw(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity, int paramInt1, int paramInt2)
  {
  ...
  {
    paramView = this.jdField_a_of_type_ComTencentMobileqqActivityNearbyPeopleProfileActivity.getLayoutInflater().inflate(2130903512, paramViewGroup, false);
    ...
    Object localObject = (ayx)getItem(paramInt);
    ...
    {
      paramViewGroup.setBackgroundResource(2130838775);
    ...
    do
    {
      do
      {
        ...
        if ((this.jdField_a_of_type_Int == 0) && (this.b == 0) && (paramInt == 0)) {
          paramView.findViewById(2131298272).setVisibility(0);
        }
        if (this.b == 0) {
        ...
        for (;;)
        {
          try
          {
            if ((((ayx)localObject).a == null) || (((ayx)localObject).a.length() <= 0)) {
              break label354;
            }
            LocalMediaInfo localLocalMediaInfo = new LocalMediaInfo();
            localLocalMediaInfo.a = ((ayx)localObject).a;
      ...
      } while (StringUtil.b(((ayx)localObject).b));
      localObject = new URL(((ayx)localObject).b);
