  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (2131297303 == i)
      {
        ...
        paramView.putExtra("title", 2131363613).putExtra("limit", 96).putExtra("canPostNull", true).putExtra("hint", this.a.getResources().getString(2131363616)).putExtra("multiLine", false);
