...
public class crs
  implements Runnable
{
  public crs(ConditionSearchManager paramConditionSearchManager, File paramFile) {}
  ...
  public void run()
  {
    ...
    ConditionSearchManager.a(this.jdField_a_of_type_ComTencentMobileqqAppConditionSearchManager).runOnUiThread(new crt(this));
  }
}
