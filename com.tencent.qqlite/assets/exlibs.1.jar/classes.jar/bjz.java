  ...
  extends View
{
  ...
  public bjz(SnapScreenActivity paramSnapScreenActivity, Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidGraphicsRect = new Rect();
    setOnLongClickListener(new bka(this, paramSnapScreenActivity));
  }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidGraphicsRect.isEmpty())
      {
        ...
        paramCanvas.drawText(this.jdField_a_of_type_ComTencentMobileqqActivitySnapScreenActivity.jdField_a_of_type_AndroidContentContext.getString(2131363194), getWidth() / 2, i2 + 26.0F * f1, this.jdField_b_of_type_AndroidGraphicsPaint);
      }
