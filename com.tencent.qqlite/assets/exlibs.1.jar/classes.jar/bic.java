...
public class bic
  implements Runnable
{
  public bic(RegisterSendUpSms paramRegisterSendUpSms, String paramString) {}
  ...
  public void run()
  {
    try
    {
      ...
      RegisterSendUpSms.a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterSendUpSms).setOnKeyListener(new bid(this));
