...
public class bhs
  implements Runnable
{
  public bhs(RegisterPhoneNumActivity paramRegisterPhoneNumActivity, Bundle paramBundle) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      } while ((!bool1) || (TextUtils.isEmpty(str2)) || (TextUtils.isEmpty(str3)) || (RegisterPhoneNumActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterPhoneNumActivity, "3.3.0", str1) < 0));
