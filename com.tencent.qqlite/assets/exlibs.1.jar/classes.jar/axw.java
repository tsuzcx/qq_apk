  ...
  extends CardObserver
{
        ...
        if ((paramArrayList != null) && (paramArrayList.size() > 0))
        {
          ...
          for (paramInt1 = 12;; paramInt1 = paramArrayList.size())
          {
            ...
            while (paramInt2 < paramInt1)
            {
              ...
              localays.a = localHeadInfo.uint32_headid.get();
              localays.c = localHeadInfo.str_headurl.get();
              localays.b = (localays.c + "250");
              localArrayList.add(localays);
              paramInt2 += 1;
            }
          }
          ...
          if (paramInt4 > 0)
          {
            ...
            paramArrayList.setPositiveButton(2131362795, new aya(this, paramArrayList));
            paramArrayList.show();
          }
        }
  ...
  protected void onNearbyCardDownload(boolean paramBoolean, NearbyPeopleCard paramNearbyPeopleCard)
  {
    ...
    for (Object localObject1 = new GetPhotoList.RspBody();; localObject1 = null)
    {
      try
      {
        ...
        if (((GetPhotoList.RspBody)localObject1).rpt_msg_uin_heads.has())
        {
          ...
          else
          {
            ...
            localObject1 = (ays)NearbyPeopleProfileActivity.a(this.a).get(NearbyPeopleProfileActivity.a(this.a).size() - 1);
            ...
            for (;;)
            {
              if (i < j)
              {
                ...
                ays localays = new ays(null);
                localays.a = ((GetPhotoList.HeadInfo)localObject3).uint32_headid.get();
                localays.c = ((GetPhotoList.HeadInfo)localObject3).str_headurl.get();
                localays.b = (localays.c + "250");
                NearbyPeopleProfileActivity.a(this.a).add(localays);
                if (QLog.isColorLevel()) {
                  QLog.d("Q.nearby_people_card.", 2, "photo_id = " + localays.a + ", big_pic_url = " + localays.c);
                }
                i += 1;
                continue;
      ...
      for (;;)
      {
        this.a.app.a(new axx(this, paramNearbyPeopleCard));
        return;
        label1386:
        ...
        localObject1 = (ImageView)this.a.findViewById(2131298258);
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ...
        if ((paramArrayList != null) && (paramArrayList.size() > 0))
        {
          ...
          {
            paramArrayList = DialogUtil.a(this.a, "最多可同步12张照片，精选照片，展示最好的自己吧。", 0, 0, null, null);
            paramArrayList.setPositiveButton(2131362795, new ayb(this, paramArrayList));
            paramArrayList.show();
          }
        }
        ReportController.b(this.a.app, "CliOper", "", "", "0X800481C", "0X800481C", 0, 0, "", "", "", "");
  ...
  protected void onReqFavoriteResult(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    QQToast.a(this.a, 2131363891, 0).b(this.a.getTitleBarHeight());
  ...
  protected void onUpdateNearbyProfile(boolean paramBoolean, NearbyPeopleCard paramNearbyPeopleCard)
  {
    ...
    if ((paramBoolean) && (paramNearbyPeopleCard != null))
    {
      ...
      if (this.a.getIntent().getIntExtra("param_mode", 0) == 1)
      {
        ...
        if ((NearbyPeopleProfileActivity.a(this.a).size() <= 0) || (!((ays)NearbyPeopleProfileActivity.a(this.a).get(NearbyPeopleProfileActivity.a(this.a).size() - 1)).equals(NearbyPeopleProfileActivity.b(this.a)))) {
          break label525;
        }
