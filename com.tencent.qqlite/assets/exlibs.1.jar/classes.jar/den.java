...
{
  public den(EmojiJsHandler paramEmojiJsHandler, BaseActivity paramBaseActivity, IndividuationSetActivity.EmojiJsBridgeListener paramEmojiJsBridgeListener, String paramString, int paramInt) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    try
    {
      ...
      if ((localTransFileController != null) && (localTransFileController.e(this.jdField_a_of_type_JavaLangString, str, this.jdField_a_of_type_Int)))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqEmojiEmojiJsHandler.b.setOnDismissListener(new deo(this));
        this.jdField_a_of_type_ComTencentMobileqqEmojiEmojiJsHandler.b.b(2131364513);
