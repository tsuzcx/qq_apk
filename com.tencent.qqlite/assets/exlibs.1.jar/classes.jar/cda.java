  ...
  extends BaseAdapter
{
  ...
  private cda(ClassificationSearchActivity paramClassificationSearchActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      do
      {
        ...
        if (paramView == null)
        {
          paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchActivity.getLayoutInflater().inflate(2130903459, null);
        ...
        localccz = (ccz)paramViewGroup.getTag();
        ...
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchActivity.jdField_a_of_type_Boolean)
        {
          ...
          localccz.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
          localccz.jdField_a_of_type_AndroidWidgetTextView.setText("获取失败，请稍后再试");
          return paramViewGroup;
        }
      ...
      localccz.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      localccz.jdField_a_of_type_AndroidWidgetTextView.setText("载入中，请稍候...");
    ...
    localccz.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
    localccz.jdField_a_of_type_AndroidWidgetTextView.setText("获取失败，请检查网络连接");
    return paramViewGroup;
  }
