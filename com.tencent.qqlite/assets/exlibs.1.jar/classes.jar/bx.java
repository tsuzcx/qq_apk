...
{
  public bx(MoloHandler paramMoloHandler) {}
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    case 2: 
      do
      {
        do
        {
          ...
          {
            return;
            QLog.d("dataline.MoloHandler", 1, "OnDownloadListener.START(" + paramString + ")");
            if (localObject != null)
            {
              ...
              while (paramString.hasNext())
              {
                ...
                this.a.a.a.a().a().c(((DataLineMsgRecord)localObject).msgId);
              ...
              continue;
              QLog.d("dataline.MoloHandler", 1, "OnDownloadListener.CANCEL(" + paramString + ")");
              if (localObject != null)
              {
                paramString = ((List)localObject).iterator();
                while (paramString.hasNext())
          ...
          QLog.d("dataline.MoloHandler", 1, "OnDownloadListener.FINISH(" + paramString + ")");
        ...
        if (paramString.hasNext())
        {
          ...
          QLog.d("dataline.MoloHandler", 1, "PCPushProxy.getDownloadPath(" + ((DataLineMsgRecord)localObject).strMoloKey + ") \"" + ((DataLineMsgRecord)localObject).path + "'");
        }
        for (;;)
        {
          ...
          this.a.a.a().a().a().a(((DataLineMsgRecord)localObject).msgId);
          break label417;
          break;
          QLog.d("dataline.MoloHandler", 1, "PCPushProxy.getDownloadPath(" + ((DataLineMsgRecord)localObject).strMoloKey + ") NULL");
        }
        QLog.d("dataline.MoloHandler", 1, "OnDownloadListener.PAUSE(" + paramString + ")");
      } while (localObject == null);
      paramString = ((List)localObject).iterator();
      while (paramString.hasNext())
      {
    ...
    case 6: 
      label417:
      label634:
      QLog.d("dataline.MoloHandler", 1, "OnDownloadListener.INSTALLED(" + paramString + ")");
      DataLineReportUtil.i(this.a.a.a);
      this.a.a.b(9, true, new Object[] { paramString });
      return;
    }
    QLog.d("dataline.MoloHandler", 1, "OnDownloadListener.WAIT(" + paramString + ")");
  }
  ...
  public void a(PCPushProxy.PkgEntry paramPkgEntry, int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      QLog.d("dataline.MoloHandler", 1, "onDownloadError( tm exit)");
    ...
    else
    {
      while (paramPkgEntry.hasNext())
      {
        ...
        continue;
        QLog.d("dataline.MoloHandler", 1, "onDownloadError(" + paramPkgEntry.toString() + "), key[" + paramPkgEntry.a + "], errorCode" + paramInt1 + "], state[" + paramInt2);
  ...
  public void a(List paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      QLog.d("dataline.MoloHandler", 1, "onDownloadUpdatem key[" + localPkgEntry.a + "], appName[" + localPkgEntry.e + "], progress[" + localPkgEntry.f);
