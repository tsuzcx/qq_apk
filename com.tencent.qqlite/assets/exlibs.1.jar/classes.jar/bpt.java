...
{
  public bpt(TroopRequestActivity paramTroopRequestActivity, TextView paramTextView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (!NetworkUtil.e(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity)) {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity, this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity.getString(2131362923), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity.getTitleBarHeight());
    }
    String str2;
    label386:
    label593:
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  TroopRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity).b(2131363392);
