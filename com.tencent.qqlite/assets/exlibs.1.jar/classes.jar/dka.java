...
{
  dka(djz paramdjz, View paramView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView instanceof QfileLocalImageExpandableListAdapter.ImageHolder))
    {
      ...
      if ((!FileUtil.a(paramView.d())) || (FileUtil.c(paramView.d())))
      {
        ...
        this.jdField_a_of_type_Djz.a.a(paramView);
        MediaScannerConnection.scanFile(this.jdField_a_of_type_Djz.a.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFMActivity, new String[] { paramView.d() }, null, null);
        QfileBaseLocalFileTabView.a(this.jdField_a_of_type_Djz.a);
      }
    }
    else
    {
