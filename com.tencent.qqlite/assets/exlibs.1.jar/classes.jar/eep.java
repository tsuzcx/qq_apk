  ...
  extends Thread
{
  ...
  public eep(HttpService paramHttpService, HttpServerConnection paramHttpServerConnection, HttpNotify paramHttpNotify, HttpRequestHandlerRegistry paramHttpRequestHandlerRegistry, eeo parameeo)
  {
    ...
    this.jdField_a_of_type_Eeo = parameeo;
  ...
  public void run()
  {
    ...
    //   10: ldc 38
    //   12: aload_0
    //   13: getfield 17	eep:jdField_a_of_type_ComTencentMobileqqServiceHttpNotify	Lcom/tencent/mobileqq/service/HttpNotify;
    //   16: invokeinterface 44 3 0
    //   21: aload_0
    //   22: getfield 19	eep:jdField_a_of_type_Eeo	Leeo;
    //   25: invokevirtual 50	eeo:c	()Z
    //   28: ifeq +89 -> 117
    //   31: invokestatic 53	java/lang/Thread:interrupted	()Z
    //   34: ifne +83 -> 117
    //   37: aload_0
    //   38: getfield 25	eep:jdField_a_of_type_OrgApacheHttpHttpServerConnection	Lorg/apache/http/HttpServerConnection;
    //   41: invokeinterface 58 1 0
    //   46: ifeq +71 -> 117
    //   49: aload_0
    //   50: getfield 23	eep:jdField_a_of_type_OrgApacheHttpProtocolHttpService	Lorg/apache/http/protocol/HttpService;
    //   53: aload_0
    //   54: getfield 25	eep:jdField_a_of_type_OrgApacheHttpHttpServerConnection	Lorg/apache/http/HttpServerConnection;
    //   57: aload_1
    ...
    //   64: astore_1
    //   65: aload_0
    //   66: getfield 21	eep:jdField_a_of_type_OrgApacheHttpProtocolHttpRequestHandlerRegistry	Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
    //   69: ifnull +30 -> 99
    //   72: aload_0
    //   73: getfield 21	eep:jdField_a_of_type_OrgApacheHttpProtocolHttpRequestHandlerRegistry	Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
    //   76: ldc 66
    ...
    //   81: ifnull +18 -> 99
    //   84: aload_0
    //   85: getfield 21	eep:jdField_a_of_type_OrgApacheHttpProtocolHttpRequestHandlerRegistry	Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
    //   88: ldc 66
    ...
    //   99: aload_0
    //   100: getfield 19	eep:jdField_a_of_type_Eeo	Leeo;
    //   103: aload_0
    //   104: invokevirtual 79	eeo:a	(Ljava/lang/Thread;)V
    //   107: aload_0
    //   108: getfield 25	eep:jdField_a_of_type_OrgApacheHttpHttpServerConnection	Lorg/apache/http/HttpServerConnection;
    //   111: invokeinterface 82 1 0
    //   116: return
    //   117: aload_0
    //   118: getfield 21	eep:jdField_a_of_type_OrgApacheHttpProtocolHttpRequestHandlerRegistry	Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
    //   121: ifnull +30 -> 151
    //   124: aload_0
    //   125: getfield 21	eep:jdField_a_of_type_OrgApacheHttpProtocolHttpRequestHandlerRegistry	Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
    //   128: ldc 66
    ...
    //   133: ifnull +18 -> 151
    //   136: aload_0
    //   137: getfield 21	eep:jdField_a_of_type_OrgApacheHttpProtocolHttpRequestHandlerRegistry	Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
    //   140: ldc 66
    ...
    //   151: aload_0
    //   152: getfield 19	eep:jdField_a_of_type_Eeo	Leeo;
    //   155: aload_0
    //   156: invokevirtual 79	eeo:a	(Ljava/lang/Thread;)V
    //   159: aload_0
    //   160: getfield 25	eep:jdField_a_of_type_OrgApacheHttpHttpServerConnection	Lorg/apache/http/HttpServerConnection;
    ...
    //   171: astore_1
    //   172: aload_0
    //   173: getfield 21	eep:jdField_a_of_type_OrgApacheHttpProtocolHttpRequestHandlerRegistry	Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
    //   176: ifnull +30 -> 206
    //   179: aload_0
    //   180: getfield 21	eep:jdField_a_of_type_OrgApacheHttpProtocolHttpRequestHandlerRegistry	Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
    //   183: ldc 66
    ...
    //   188: ifnull +18 -> 206
    //   191: aload_0
    //   192: getfield 21	eep:jdField_a_of_type_OrgApacheHttpProtocolHttpRequestHandlerRegistry	Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
    //   195: ldc 66
    ...
    //   206: aload_0
    //   207: getfield 19	eep:jdField_a_of_type_Eeo	Leeo;
    //   210: aload_0
    //   211: invokevirtual 79	eeo:a	(Ljava/lang/Thread;)V
    //   214: aload_0
    //   215: getfield 25	eep:jdField_a_of_type_OrgApacheHttpHttpServerConnection	Lorg/apache/http/HttpServerConnection;
