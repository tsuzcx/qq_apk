...
public class dxy
  implements Runnable
{
  public dxy(RoamSearchDialog paramRoamSearchDialog, List paramList, int paramInt) {}
  ...
  public void run()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.jdField_a_of_type_Dyb.b = true;
      ...
      this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.jdField_a_of_type_Dyb.a = false;
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.jdField_a_of_type_Dyb.b = false;
      break;
      label209:
