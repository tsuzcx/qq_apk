...
public class bng
  extends Thread
{
  public bng(TroopInfoActivity paramTroopInfoActivity) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        ((FriendManager)this.a.app.getManager(8)).a(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.c);
