  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public void onItemClick(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if ((localChatBackgroundInfo != null) && (localChatBackgroundInfo.type.equals("1")) && (this.a.jdField_a_of_type_ComTencentMobileqqAppSVIPHandler.c() < 1)) {
      DialogUtil.a(this.a, 230).setTitle(this.a.getString(2131362939)).setMessage(this.a.getString(2131364068)).setPositiveButton(this.a.getString(2131364293), new ace(this, localChatBackgroundInfo, paramView, paramInt)).setNegativeButton(this.a.getString(2131362794), new acd(this)).show();
    }
    int i;
    do
    {
    ...
    if (localChatBackgroundInfo == null)
    {
      ...
      if ((this.a.jdField_b_of_type_Int != paramInt) && (paramAdapterView != null) && (this.a.jdField_b_of_type_Int < paramAdapterView.getCount()))
      {
        if (this.a.jdField_b_of_type_Int != -1) {
          paramAdapterView.getChildAt(this.a.jdField_b_of_type_Int).findViewById(2131296791).setContentDescription(paramView.getResources().getString(2131364361, new Object[] { Integer.valueOf(this.a.jdField_b_of_type_Int + 1) }));
        }
      }
      else
      {
        ...
        paramView.findViewById(2131296791).setContentDescription(paramView.getResources().getString(2131364360, new Object[] { Integer.valueOf(this.a.jdField_b_of_type_Int + 1) }));
    ...
    for (paramAdapterView = "null";; paramAdapterView = str1)
    {
      ...
      this.a.jdField_b_of_type_AndroidViewView.findViewById(2131296792).setVisibility(8);
      this.a.jdField_b_of_type_AndroidViewView.findViewById(2131296791).setContentDescription(paramView.getResources().getString(2131364361, new Object[] { Integer.valueOf(paramInt + 1) }));
      break label351;
      ...
      {
        this.a.d = str2;
        paramView.findViewById(2131296793).setVisibility(8);
        paramView.findViewById(2131296795).setVisibility(8);
        paramView.findViewById(2131296792).setVisibility(0);
        if ((this.a.jdField_b_of_type_Int != paramInt) && (paramAdapterView != null) && (this.a.jdField_b_of_type_Int < paramAdapterView.getCount()))
        {
          if (this.a.jdField_b_of_type_Int == -1) {
        ...
        for (;;)
        {
          paramView.findViewById(2131296791).setContentDescription(paramView.getResources().getString(2131364360, new Object[] { Integer.valueOf(paramInt + 1) }));
          this.a.jdField_b_of_type_Int = paramInt;
      ...
      if (this.a.jdField_b_of_type_Int == -1)
      {
        paramAdapterView = this.a.jdField_b_of_type_AndroidViewView.findViewById(2131296792);
        if (paramAdapterView == null) {
          break;
        }
        paramAdapterView.setVisibility(0);
        paramAdapterView.setContentDescription(paramView.getResources().getString(2131364360, new Object[] { Integer.valueOf(paramInt + 1) }));
        return;
      }
      paramAdapterView = paramAdapterView.getChildAt(this.a.jdField_b_of_type_Int).findViewById(2131296792);
      if (paramAdapterView == null) {
        break;
      }
      paramAdapterView.setVisibility(0);
      paramAdapterView.setContentDescription(paramView.getResources().getString(2131364360, new Object[] { Integer.valueOf(this.a.jdField_b_of_type_Int + 1) }));
      return;
    }
  }
}
