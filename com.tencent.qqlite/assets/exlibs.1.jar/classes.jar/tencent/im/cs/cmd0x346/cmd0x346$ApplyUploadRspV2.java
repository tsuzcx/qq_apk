  ...
  extends MessageMicro
{
  ...
  public static final int BYTES_SHA_FIELD_NUMBER = 141;
  ...
  public static final int UINT32_HTTPSVR_API_VER_FIELD_NUMBER = 140;
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 80, 162, 240, 320, 400, 482, 562, 640, 722, 802, 880, 960, 1042, 1120, 1130 }, new String[] { "int32_ret_code", "str_ret_msg", "uint64_total_space", "uint64_used_space", "uint64_uploaded_size", "str_upload_ip", "str_upload_domain", "uint32_upload_port", "bytes_uuid", "bytes_upload_key", "bool_file_exist", "uint32_pack_size", "rpt_str_uploadip_list", "uint32_httpsvr_api_ver", "bytes_sha" }, new Object[] { Integer.valueOf(0), "", Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), "", "", Integer.valueOf(0), localByteStringMicro1, localByteStringMicro2, Boolean.valueOf(false), Integer.valueOf(0), "", Integer.valueOf(0), localByteStringMicro3 }, ApplyUploadRspV2.class);
  }
}
