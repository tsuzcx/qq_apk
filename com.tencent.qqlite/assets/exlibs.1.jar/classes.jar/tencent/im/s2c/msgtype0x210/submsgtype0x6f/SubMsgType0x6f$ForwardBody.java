  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 16002 }, new String[] { "uint32_notify_type", "uint32_op_type", "msg_fanpanzi_notify" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), null }, ForwardBody.class);
