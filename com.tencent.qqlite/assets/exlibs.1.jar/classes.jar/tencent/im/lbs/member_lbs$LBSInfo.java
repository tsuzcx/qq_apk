  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 37, 42 }, new String[] { "msg_gps", "rpt_msg_wifis", "rpt_msg_cells", "uint32_ip", "msg_attr" }, new Object[] { null, null, null, Integer.valueOf(0), null }, LBSInfo.class);
