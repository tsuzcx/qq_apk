  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint64_group_code", "uint64_neighbour_number" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L) }, NeighbourNumber.class);
