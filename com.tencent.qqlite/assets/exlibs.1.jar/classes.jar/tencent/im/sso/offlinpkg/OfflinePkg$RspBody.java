  ...
  extends MessageMicro
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26 }, new String[] { "int32_ret", "str_err_desc", "str_expire_pkg" }, new Object[] { Integer.valueOf(0), localByteStringMicro1, localByteStringMicro2 }, RspBody.class);
  }
}
