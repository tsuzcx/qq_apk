...
{
  public aag(BaseChatPie paramBaseChatPie) {}
  ...
  protected void a(boolean paramBoolean, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new aah(this, paramLong));
  }
  ...
  protected void a(boolean paramBoolean, Map paramMap)
  {
    if ((!paramBoolean) && (this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.isResume())) {
      QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), 2130837979, this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363416), 0).b(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
    }
  }
  ...
  protected void b(boolean paramBoolean, Object paramObject)
  {
    ...
    int j = this.a.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getChildCount();
    int i = 0;
    label45:
    if (i < j)
    {
      ...
      {
        BaseBubbleBuilder.ViewHolder localViewHolder = (BaseBubbleBuilder.ViewHolder)AIOUtils.a(paramObject);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (MultiMsgManager.a().b.size() == 0) {
          QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), 2131362996, 0).b(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        }
