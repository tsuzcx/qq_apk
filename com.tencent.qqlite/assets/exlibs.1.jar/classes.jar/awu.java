  ...
  protected void a(boolean paramBoolean, RespHeader paramRespHeader, RespGetEncounterV2 paramRespGetEncounterV2, ToServiceMsg paramToServiceMsg)
  {
    ...
    if ((paramBoolean) && (paramRespGetEncounterV2 != null))
    {
      ...
      if (i == this.a.b())
      {
        ...
        if ((!this.a.jdField_a_of_type_JavaUtilList.isEmpty()) && (bool) && (this.a.i != 4))
        {
          ...
          this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new awv(this, (String)localObject, paramRespHeader));
        }
        ...
        {
          paramRespHeader = this.a.a(2131298145);
          ...
          paramToServiceMsg.setText(this.a.a(2131364433));
          paramToServiceMsg.setTextColor(NearbyPeopleListFrame.d(this.a).getResources().getColor(2131427493));
        ...
        if ((!StringUtil.b(paramRespGetEncounterV2.strSecurityTips)) && (!StringUtil.b(paramRespGetEncounterV2.strSecurityDetailUrl)))
        {
          ...
          paramRespHeader.setNegativeButton(2131362795, new awx(this, paramRespHeader));
    ...
    while ((paramRespHeader == null) || (paramRespHeader.eReplyCode != 7)) {
      for (;;)
      {
        ...
        paramToServiceMsg.setTextColor(NearbyPeopleListFrame.e(this.a).getResources().getColor(2131427466));
        paramRespHeader.findViewById(2131296424).setVisibility(0);
        paramRespHeader.setOnClickListener(new aww(this));
        continue;
        this.a.c = false;
