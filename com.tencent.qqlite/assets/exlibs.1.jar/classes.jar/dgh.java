  ...
  implements FileWebView.TitilebarEventInterface
{
  ...
  public dgh(FilePreviewActivity paramFilePreviewActivity, Handler paramHandler) {}
  ...
  public void b()
  {
    ...
    if (!NetworkUtil.e(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity.getActivity()))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity.c.setText(2131363576);
    ...
    new Handler().postDelayed(new dgi(this), 1500L);
  }
  ...
  public void d()
  {
    dgj localdgj = new dgj(this);
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(localdgj, 3000L);
    QLog.i("<FileAssistant>FilePreviewActivity", 1, "postDelayed(newRunnable, 3000)");
  }
  
  public void e()
  {
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity.runOnUiThread(new dgk(this));
  }
  
  public void f()
  {
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity.runOnUiThread(new dgl(this));
  }
}
