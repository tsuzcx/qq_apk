  ...
  extends BaseAdapter
{
  ...
  private edo(SameStatusActivity paramSameStatusActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramView == null)
      {
        paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqRichstatusSameStatusActivity).inflate(2130903655, null);
        paramView = new SameStatusActivity.ItemViewHolder();
        paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131298842));
        paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131298844));
        paramView.jdField_a_of_type_AndroidViewView = paramViewGroup.findViewById(2131298843);
        paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131298845));
        paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131297397));
        paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131298847));
        paramView.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131298839));
        paramView.d = ((TextView)paramViewGroup.findViewById(2131298840));
      ...
      if ((localItemViewHolder.jdField_a_of_type_PersonalStateUserProfile != paramView) || (SameStatusActivity.a(this.jdField_a_of_type_ComTencentMobileqqRichstatusSameStatusActivity).contains(Long.valueOf(paramView.lEctID))))
      {
        ...
        localItemViewHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839123);
      ...
      for (;;)
      {
        ...
        if (paramView.bSex == 1)
        {
          localItemViewHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839116);
          break;
        }
