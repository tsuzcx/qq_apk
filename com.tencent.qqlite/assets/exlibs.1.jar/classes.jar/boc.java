...
{
  public boc(TroopMemberCardActivity paramTroopMemberCardActivity) {}
  ...
  protected void a(int paramInt)
  {
    ...
    case 6: 
    default: 
      localObject = this.a.getString(2131362860);
    ...
    for (paramInt = ((TroopInfo)localObject).maxAdminNum;; paramInt = 0)
    {
      if (paramInt > 0)
      {
        localObject = String.format(this.a.getString(2131362864), new Object[] { Integer.valueOf(paramInt) });
        break;
      }
      localObject = this.a.getString(2131362865);
      break;
      localObject = this.a.getString(2131362866);
      break;
    }
  }
  ...
  protected void a(String paramString1, String paramString2, byte paramByte)
  {
    ...
    if ((this.a.c.equals(paramString1)) && (this.a.e.equals(paramString2)))
    {
      ...
      this.a.a(2, this.a.getString(2131362862));
      this.a.jdField_a_of_type_ComTencentMobileqqDataTroopMemberCard.memberRole = 1;
      label289:
      paramString1 = "";
      paramString2 = (TextView)this.a.jdField_a_of_type_AndroidViewView.findViewById(2131298927);
      if (this.a.jdField_a_of_type_ComTencentMobileqqDataTroopMemberCard.memberRole != 2) {
        break label526;
      }
      paramString1 = this.a.getString(2131362840);
      paramString2.setBackgroundResource(2130839468);
      label338:
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        this.a.a(2, this.a.getString(2131362859));
      ...
      paramString1 = this.a.getString(2131362841);
      paramString2.setBackgroundResource(2130839469);
      break label338;
      label559:
