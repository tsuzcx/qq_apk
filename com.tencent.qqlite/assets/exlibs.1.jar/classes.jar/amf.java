  ...
  extends BaseAdapter
{
  ...
  public amf(EmosmDetailActivity paramEmosmDetailActivity, ArrayList paramArrayList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if ((paramViewGroup instanceof URLDrawable)) {
        ((URLDrawable)paramViewGroup).setURLDrawableListener(new amg(this, paramView));
      }
