...
{
  private eas(ActionGridActivity paramActionGridActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = this.a.getLayoutInflater().inflate(2130903669, null);
      paramView = new eat(null);
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131298235));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131298236));
      paramViewGroup.setTag(paramView);
    }
    paramView = (eat)paramViewGroup.getTag();
