...
{
  public bnv(TroopMemberCardActivity paramTroopMemberCardActivity) {}
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.D == 2)
        {
          if (paramInt == 0) {
            if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.p == 3)
            {
              ...
              paramView.putExtra("leftViewText", 2131363671);
              this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.startActivityForResult(paramView, 4);
            }
            else
            {
              localObject = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131363425);
              ...
              {
                paramView = String.format(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131363421), new Object[] { paramView });
                ...
                paramView.setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131363039), new bnw(this, paramView));
                ...
                paramView.setNegativeButton(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131362790), new bnx(this, paramView));
