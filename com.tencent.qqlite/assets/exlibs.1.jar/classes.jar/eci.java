...
public class eci
  extends BaseAdapter
{
  private eci(StatusHistoryActivity paramStatusHistoryActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramView == null)
      {
        paramView = LayoutInflater.from(this.a).inflate(2130903660, null);
        paramView.setFocusable(true);
        paramViewGroup = new StatusHistoryActivity.ItemViewHolder();
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131298863));
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetClickableColorSpanTextView = ((ClickableColorSpanTextView)paramView.findViewById(2131298864));
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131298862));
        paramViewGroup.b = paramView.findViewById(2131298861);
        ...
        paramViewGroup.jdField_a_of_type_AndroidViewView = paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout.findViewById(2131297127);
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839395);
        label240:
      ...
      for (;;)
      {
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetClickableColorSpanTextView.setText(localRichStatus.a(null, this.a.getResources().getColor(2131427474)));
        ...
        if (paramInt == 0) {
          paramViewGroup.b.setBackgroundResource(2130839398);
        } else if (paramInt == StatusHistoryActivity.a(this.a).size() - 1) {
          paramViewGroup.b.setBackgroundResource(2130839396);
        } else {
          paramViewGroup.b.setBackgroundResource(2130839397);
        }
      }
    }
