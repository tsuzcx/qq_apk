...
public class dfb
  implements Runnable
{
  public dfb(FastImagePreviewLayout paramFastImagePreviewLayout) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject = this.a.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839066);
        ...
        this.a.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new dfc(this));
        return;
      }
