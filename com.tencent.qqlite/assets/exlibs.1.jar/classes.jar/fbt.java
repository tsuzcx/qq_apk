...
{
  public fbt(QuickLoginAuthorityActivity paramQuickLoginAuthorityActivity) {}
  ...
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    if (paramInt2 == -1000)
    {
      this.a.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.a(this.a, this.a.getResources().getString(2131363825));
      return;
    }
    ...
    if (paramBundle == null) {}
    for (paramBundle = this.a.getString(2131363831);; paramBundle = paramBundle.getMessage())
    {
