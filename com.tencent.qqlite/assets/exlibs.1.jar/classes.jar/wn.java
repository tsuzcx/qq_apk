...
public class wn
  extends BaseAdapter
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new wo(this);
  
  public wn(AddFriendActivity paramAddFriendActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendActivity.getLayoutInflater().inflate(2130903608, null);
      paramView = new wp(null);
    ...
    paramView = (wp)paramViewGroup.getTag();
