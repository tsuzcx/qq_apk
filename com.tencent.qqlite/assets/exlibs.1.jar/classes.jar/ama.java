  ...
  extends BaseAdapter
{
  ...
  public ama(EmosmDetailActivity paramEmosmDetailActivity, ArrayList paramArrayList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if ((paramViewGroup instanceof URLDrawable)) {
        ((URLDrawable)paramViewGroup).setURLDrawableListener(new amb(this, paramView));
      }
