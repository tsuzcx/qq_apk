  ...
  extends PinnedDividerListView.DividerAdapter
{
  ...
  private dcf(CountrySelectActivity paramCountrySelectActivity) {}
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    if ((localObject instanceof dcg)) {
      paramView.setText(((dcg)localObject).jdField_a_of_type_JavaLangString);
    }
  ...
  {
    if ((this.a.a.get(paramInt) instanceof dcg)) {
      return 0;
    }
    return 1;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (getItemViewType(paramInt) == 0)
    {
      ...
      ((TextView)paramViewGroup.findViewById(2131297009)).setText(((dcg)getItem(paramInt)).jdField_a_of_type_JavaLangString);
    ...
    paramView = (dch)paramViewGroup.getTag();
