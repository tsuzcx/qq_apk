  ...
  extends FriendListObserver
{
  ...
  void a(String paramString)
  {
    ...
    this.a.runOnUiThread(new blx(this));
  }
  ...
  protected void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      new Thread(new bly(this, paramString)).start();
      return;
    }
    this.a.d();
  }
  ...
  protected void a(boolean paramBoolean, Map paramMap)
  {
    ...
    if (paramBoolean)
    {
      QQToast.a(this.a.app.a(), 2130837989, this.a.getString(2131363415), 0).b(this.a.getTitleBarHeight());
      return;
    }
    QQToast.a(this.a.app.a(), 2130837979, this.a.getString(2131363416), 0).b(this.a.getTitleBarHeight());
  }
  
  protected void a(boolean paramBoolean, String[] paramArrayOfString)
  {
    if (paramBoolean) {
      new Thread(new blz(this)).start();
    }
  }
