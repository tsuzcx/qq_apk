  ...
  extends TroopObserver
{
  ...
  protected void a(int paramInt, byte paramByte)
  {
    if (paramInt == 9)
    {
      ...
      if (paramByte == 8)
      {
        ...
        ((QQCustomDialog)localObject).setTitle(this.a.getString(2131362598));
        ((QQCustomDialog)localObject).setMessage(this.a.getString(2131362599));
        ((QQCustomDialog)localObject).setNegativeButton(this.a.getString(2131362596), new bml(this, (QQCustomDialog)localObject));
        ((QQCustomDialog)localObject).setPositiveButton(this.a.getString(2131363666), new bmm(this, (QQCustomDialog)localObject));
  ...
  protected void a(int paramInt, byte paramByte, String paramString)
  {
    ...
    if (paramByte == 0)
    {
      ...
      paramString.putExtra("fin_tip_msg", this.a.getString(2131363680));
  ...
  protected void a(boolean paramBoolean, long paramLong1, int paramInt1, List paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      paramList.putExtra("leftViewText", this.a.getString(2131363424));
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131363634, 1500);
        return;
      }
      paramList = this.a;
      paramList.jdField_d_of_type_Int &= 0xFFFFFFFD;
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131363637, 1500);
      return;
    } while (!paramBoolean);
    label419:
    label564:
