  ...
  extends BaseAdapter
{
  ...
  public acn(ChatBackgroundSettingActivity paramChatBackgroundSettingActivity, ArrayList paramArrayList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      ...
      paramViewGroup = (ImageView)paramView.findViewById(2131296797);
      localURLImageView = (URLImageView)paramView.findViewById(2131296795);
      localView1 = paramView.findViewById(2131296796);
      localView2 = paramView.findViewById(2131296799);
      ...
      localObject1 = (ProgressBar)paramView.findViewById(2131296800);
      localView1.setVisibility(8);
      paramViewGroup.setVisibility(8);
      localObject2 = (ImageView)paramView.findViewById(2131296798);
      if (paramInt != 0) {
        break label417;
      }
      ...
      i = 1;
      label212:
      localURLImageView.setImageResource(2130837670);
      ...
      localURLImageView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqActivityChatBackgroundSettingActivity.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131364376, new Object[] { Integer.valueOf(paramInt + 1) }));
    ...
    for (;;)
    {
      paramViewGroup.setOnClickListener(new aco(this));
      return paramView;
      ...
      label374:
      localView1.setVisibility(8);
      localURLImageView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqActivityChatBackgroundSettingActivity.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131364377, new Object[] { Integer.valueOf(paramInt + 1) }));
      break label334;
      ...
      for (;;)
      {
        ...
        localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityChatBackgroundSettingActivity.getResources().getDrawable(2130837670);
        try
        {
      ...
      for (;;)
      {
        ...
        if ((localHttpDownloadFileProcessor == null) || (localHttpDownloadFileProcessor.f()))
        {
          ...
          localView2.setVisibility(8);
          paramViewGroup.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqActivityChatBackgroundSettingActivity.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131364378, new Object[] { Integer.valueOf(paramInt + 1) }));
        }
        else
        {
          localView2.setVisibility(0);
          paramViewGroup.setVisibility(8);
          localView2.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqActivityChatBackgroundSettingActivity.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131364379, new Object[] { Integer.valueOf(paramInt + 1) }));
