...
{
  public boi(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    for (int i = paramInt + 1;; i = paramInt)
    {
      ...
      case 4: 
        ...
        if (i == 1)
        {
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.a(0).setText(2131362871);
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.a(1).setText(2131362872);
      ...
      for (;;)
      {
        ...
        if (i == 2)
        {
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.a(0).setText(2131362873);
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.a(1).setText(2131362874);
        ...
        else
        {
          if (i == 4)
          {
            ...
            continue;
            label433:
            this.a.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setSelectionFromTop(0, -this.a.getResources().getDimensionPixelSize(2131492952));
            break;
            this.a.n();
            break;
            this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new boj(this), 320L);
            break;
            this.a.b = true;
            this.a.q = "";
