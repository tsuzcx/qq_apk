  ...
  extends BitmapDrawable
{
  ...
  public eal(Resources paramResources, Bitmap paramBitmap)
  {
    super(paramResources, paramBitmap);
  }
  
  public static eal[] a(int paramInt, Resources paramResources, Bitmap paramBitmap)
  {
    if ((paramBitmap != null) && (paramResources != null))
    {
      eal[] arrayOfeal2 = new eal[paramInt];
      i = paramBitmap.getWidth() / 2;
      h = paramBitmap.getHeight() / 2;
      int j = 0;
      for (;;)
      {
        arrayOfeal1 = arrayOfeal2;
        if (j >= paramInt) {
          break;
        }
        arrayOfeal2[j] = new eal(paramResources, paramBitmap);
        j += 1;
      }
    }
    eal[] arrayOfeal1 = null;
    return arrayOfeal1;
  }
