  ...
  implements Runnable
{
  ...
  public fii(Gallery paramGallery)
  {
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetGallery.jdField_a_of_type_ComTencentWidgetGallery$OnScollListener != null) {
      this.jdField_a_of_type_ComTencentWidgetGallery.jdField_a_of_type_ComTencentWidgetGallery$OnScollListener.b(this.jdField_a_of_type_ComTencentWidgetGallery.az);
    }
    if (Gallery.c(this.jdField_a_of_type_ComTencentWidgetGallery) == 2)
    {
      this.jdField_a_of_type_ComTencentWidgetGallery.a(this.jdField_a_of_type_ComTencentWidgetGallery.az, this.jdField_a_of_type_ComTencentWidgetGallery.getChildAt(0), this.jdField_a_of_type_ComTencentWidgetGallery);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetGallery.jdField_a_of_type_ComTencentWidgetGallery$OnScollListener.a(this.jdField_a_of_type_ComTencentWidgetGallery.az);
  }
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetGallery.aA == 0)
    {
      b(true);
      return;
    }
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if ((Gallery.b(this.jdField_a_of_type_ComTencentWidgetGallery)) && (this.jdField_b_of_type_Float > 0.0F)) {
