...
public class cwy
  extends Handler
{
  public cwy(SaveTrafficHandler paramSaveTrafficHandler, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject = (cxa)((Map.Entry)localObject).getValue();
        if (localObject == null) {
          continue;
        }
        if (((cxa)localObject).a == bool) {
          break label152;
        }
    ...
    {
      int i = this.a.a();
      paramMessage = new cxa(this.a, i, bool);
