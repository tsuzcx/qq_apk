...
{
  public can(FriendChatPie paramFriendChatPie) {}
  ...
  public void a(boolean paramBoolean, PBRepeatMessageField paramPBRepeatMessageField)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        {
          if (!String.valueOf(((oidb_0x5d4.DelResult)paramPBRepeatMessageField.next()).uin.get()).equalsIgnoreCase(this.a.a.jdField_a_of_type_JavaLangString)) {
            break label325;
          }
          paramBoolean = true;
        }
      ...
      for (;;)
      {
        ...
        QQToast.a(FriendChatPie.b(this.a), 2, FriendChatPie.c(this.a).getResources().getString(2131364307), 0).a();
        if (this.a.h) {
          FriendChatPie.d(this.a).setResult(-1);
        }
        this.a.t();
        return;
        QQToast.a(FriendChatPie.e(this.a), FriendChatPie.f(this.a).getResources().getString(2131364308), 0).a();
        return;
      }
    }
  }
