  ...
  extends Thread
{
  ...
  public eeo(String paramString, HttpNotify paramHttpNotify, QQAppInterface paramQQAppInterface)
  {
  ...
  public void run()
  {
    for (;;)
    {
      ...
      localHttpRequestHandlerRegistry.register("*", new een(this.jdField_a_of_type_JavaLangString, (Socket)localObject2));
      ...
      localObject1 = new eep((HttpService)localObject2, (HttpServerConnection)localObject1, this.jdField_a_of_type_ComTencentMobileqqServiceHttpNotify, localHttpRequestHandlerRegistry, this);
      ((eep)localObject1).setDaemon(true);
      ((eep)localObject1).start();
