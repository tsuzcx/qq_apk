  ...
  extends BaseAdapter
{
  ...
  public dze(RoamSearchDialog paramRoamSearchDialog) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    case 0: 
      ...
      {
        paramView = View.inflate(this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.jdField_a_of_type_AndroidContentContext, 2130903592, null);
        paramViewGroup = new dzd(null);
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131296934));
        paramViewGroup.b = ((TextView)paramView.findViewById(2131298662));
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (dzd)paramView.getTag();
      }
    }
    if ((paramView == null) || (!(paramView instanceof LinearLayout)))
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131296561));
