...
{
  public vo(AccountManageActivity paramAccountManageActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (!this.a.jdField_a_of_type_Boolean)
    {
      ...
      AccountManageActivity.c(this.a).setText(2131363430);
    ...
    for (;;)
    {
      ...
      this.a.b = false;
      AccountManageActivity.a(this.a).postDelayed(new vp(this), 400L);
      ...
      AccountManageActivity.f(this.a).setText(2131363433);
