  ...
  extends BitmapDrawable
{
  ...
  public eaf(Resources paramResources, Bitmap paramBitmap)
  {
    super(paramResources, paramBitmap);
  }
  
  public static eaf[] a(int paramInt, Resources paramResources, Bitmap paramBitmap)
  {
    if ((paramBitmap != null) && (paramResources != null))
    {
      eaf[] arrayOfeaf2 = new eaf[paramInt];
      i = paramBitmap.getWidth() / 2;
      h = paramBitmap.getHeight() / 2;
      int j = 0;
      for (;;)
      {
        arrayOfeaf1 = arrayOfeaf2;
        if (j >= paramInt) {
          break;
        }
        arrayOfeaf2[j] = new eaf(paramResources, paramBitmap);
        j += 1;
      }
    }
    eaf[] arrayOfeaf1 = null;
    return arrayOfeaf1;
  }
