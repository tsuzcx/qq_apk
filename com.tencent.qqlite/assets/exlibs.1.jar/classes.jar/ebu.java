...
public class ebu
  extends BaseAdapter
{
  private ebu(EditActivity paramEditActivity) {}
  ...
  {
    paramView = this.a.getLayoutInflater().inflate(2130903500, null);
    ...
    if (paramInt == 3)
    {
      ...
      localImageView = (ImageView)paramView.findViewById(2131298235);
      ...
      localTextView = (TextView)paramView.findViewById(2131298236);
    ...
    for (;;)
    {
      ...
      paramView.setBackgroundResource(2130838735);
      break;
      label203:
      localTextView.setCompoundDrawablesWithIntrinsicBounds(null, null, this.a.getResources().getDrawable(2130837718), null);
