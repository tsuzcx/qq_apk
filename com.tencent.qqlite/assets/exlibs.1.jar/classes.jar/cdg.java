...
{
  public cdg(NotificationView paramNotificationView) {}
  ...
  protected void a(String paramString)
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog != null) && (this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.isShowing()))
    {
      ...
      paramString = NotificationView.a(this.a).getResources().getString(2131362892);
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1 = NotificationView.a(this.a).getResources().getString(2131363385);
      ...
      paramString1 = NotificationView.a(this.a).getResources().getString(2131362822);
      if (paramInt1 == 1) {
        paramString1 = NotificationView.a(this.a).getResources().getString(2131362821);
      }
      for (;;)
      {
        ...
        try
        {
          if (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
            this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(AppConstants.ae, 0, l2, paramString1.toByteArray());
          }
          this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1012);
          return;
          if (paramInt1 == 2) {
            paramString1 = NotificationView.a(this.a).getResources().getString(2131362820);
          }
        }
        catch (Exception paramString1)
        {
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        NotificationView.a(this.a, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(AppConstants.ae, 0));
        ...
        if (this.a.b)
        {
          ...
          ((NewFriendManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(31)).a(new TroopSystemMessage(0));
          this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(AppConstants.aj, 9000, 0 - GroupSystemMsgController.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      ...
      {
        String str = NotificationView.a(this.a).getResources().getString(2131362893);
