...
{
  public djj(QfileBaseCloudFileTabView paramQfileBaseCloudFileTabView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (paramView != null) {
      if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 1)
      {
        ...
        if ((FileManagerUtil.a()) && (paramView.fileSize > 5242880L)) {
          FMDialogUtil.a(this.a.getContext(), 2131362018, 2131362016, new djk(this, paramView));
        }
      }
    }
    for (;;)
    {
      ...
      if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 3)
      {
        ...
        if ((FileManagerUtil.a()) && (paramView.fileSize > 5242880L)) {
          FMDialogUtil.a(this.a.getContext(), 2131362018, 2131362016, new djl(this, paramView));
        } else {
      ...
      else if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 2)
      {
        ...
        {
          FMDialogUtil.a(this.a.getContext(), 2131362018, 2131362016, new djm(this, localWeiYunFileInfo));
        }
        else
        {
