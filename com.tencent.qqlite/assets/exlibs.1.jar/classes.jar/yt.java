  ...
  extends WtloginObserver
{
  ...
  public void OnCheckDevLockSms(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    do
    {
      ...
      AuthDevActivity.b(this.a).setText(this.a.getString(2131364206));
      AuthDevActivity.b(this.a).setContentDescription(this.a.getString(2131364206));
      QQToast.a(this.a.getApplicationContext(), 2, this.a.getString(2131364209), 0).b(this.a.getTitleBarHeight());
    ...
    QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131364233), 0).b(this.a.getTitleBarHeight());
  }
  ...
  public void OnCloseDevLock(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt == 0)
    {
      ...
      AuthDevActivity.b(this.a).setText(this.a.getString(2131364207));
      AuthDevActivity.b(this.a).setContentDescription(this.a.getString(2131364207));
      QQToast.a(this.a.getApplicationContext(), 2, this.a.getString(2131364231), 0).b(this.a.getTitleBarHeight());
      paramWUserSigInfo = this.a.app.a(LoginInfoActivity.class);
      if (paramWUserSigInfo != null) {
    ...
    QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131364232), 0).b(this.a.getTitleBarHeight());
  }
}
