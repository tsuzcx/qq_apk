...
{
  public bat(PermisionPrivacyActivity paramPermisionPrivacyActivity) {}
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (paramCompoundButton == this.a.jdField_a_of_type_AndroidWidgetCompoundButton)
      {
        ...
        {
          QQToast.a(this.a.getApplicationContext(), 2131363527, 1).a();
        ...
        if (paramBoolean)
        {
          ...
          this.a.a(this.a.getApplication().getResources().getString(2131364084));
          if (!paramBoolean) {
            break label455;
          }
        }
