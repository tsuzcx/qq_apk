...
{
  public bmt(TroopGagActivity paramTroopGagActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramInt > 0)
    {
      ...
      {
        paramView = ((LayoutInflater)this.a.getSystemService("layout_inflater")).inflate(2130903318, paramViewGroup, false);
        paramViewGroup = new bmu(this, null);
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (bmu)paramView.getTag();
      }
