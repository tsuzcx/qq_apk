  ...
  implements FileWebView.TitilebarEventInterface
{
  ...
  public dhp(FilePreviewActivity paramFilePreviewActivity, Handler paramHandler) {}
  ...
  public void b()
  {
    ...
    if (!NetworkUtil.e(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity.getActivity()))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity.c.setText(2131363581);
    ...
    new Handler().postDelayed(new dhq(this), 1500L);
  }
  ...
  public void d()
  {
    dhr localdhr = new dhr(this);
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(localdhr, 3000L);
    QLog.i("<FileAssistant>FilePreviewActivity", 1, "postDelayed(newRunnable, 3000)");
  }
  
  public void e()
  {
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity.runOnUiThread(new dhs(this));
  }
  
  public void f()
  {
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity.runOnUiThread(new dht(this));
  }
}
