...
{
  public nr(Handler paramHandler, SharedPreferences paramSharedPreferences) {}
    ...
    if (paramBoolean)
    {
      ...
      if (paramBundle != null)
      {
        ...
        try
        {
          ...
          {
            ((SearchProtocol.WordItem)localObject).a = ((mobileqq_dynamic_search.ResultItem)((mobileqq_dynamic_search.ResultItemGroup)localResponseBody.item_groups.get(0)).result_items.get(0)).word.get().toStringUtf8();
            ((SearchProtocol.WordItem)localObject).b = ((mobileqq_dynamic_search.ResultItem)((mobileqq_dynamic_search.ResultItemGroup)localResponseBody.item_groups.get(0)).result_items.get(0)).result_id.get().toStringUtf8();
            ...
            this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString("active_search_home_hot_word", ((SearchProtocol.WordItem)localObject).a).commit();
            this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString("active_search_home_hot_word_id", ((SearchProtocol.WordItem)localObject).b).commit();
