  ...
  implements INetInfoHandler, DownloaderInterface
{
  ...
  Runnable jdField_a_of_type_JavaLangRunnable = new ewu(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ewt.class.getSimpleName();
  }
  
  public ewt(AppInterface paramAppInterface, DownloaderFactory.DownloadConfig paramDownloadConfig)
  {
