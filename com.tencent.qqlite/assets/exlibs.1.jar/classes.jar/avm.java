...
{
  public avm(MayKnowManActivity paramMayKnowManActivity, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramView = (avl)paramViewGroup.getTag();
    if (paramView == null)
    {
      paramView = new avl(this.a, null);
    ...
    for (;;)
    {
      ...
      String str = String.format(this.a.getString(2131363445), new Object[] { Integer.valueOf(localVisitor.weight) });
      ...
      paramView.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new avn(this, localVisitor));
