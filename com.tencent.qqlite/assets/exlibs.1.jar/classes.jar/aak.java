...
public class aak
  implements Runnable
{
  public aak(BaseChatPie paramBaseChatPie, Activity paramActivity) {}
  ...
  public void run()
  {
    ...
    BaseChatPie.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).setOnTouchListener(new aal(this));
    ...
    localAnimationSet.setAnimationListener(new aam(this));
