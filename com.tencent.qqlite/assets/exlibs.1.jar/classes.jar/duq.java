...
public class duq
  implements Runnable
{
  public duq(PreviewingOfflineFileViewBase paramPreviewingOfflineFileViewBase, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (PreviewingOfflineFileViewBase.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerFileViewPreviewingOfflineFileViewBase) == null) {
      PreviewingOfflineFileViewBase.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerFileViewPreviewingOfflineFileViewBase, (LinearLayout)PreviewingOfflineFileViewBase.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerFileViewPreviewingOfflineFileViewBase).findViewById(2131298041));
    }
