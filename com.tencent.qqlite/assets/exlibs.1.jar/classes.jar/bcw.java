  ...
  extends BaseAdapter
{
  ...
  public bcw(QQLSActivity paramQQLSActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2130903507, null);
      paramView = new bcy();
      localObject = (TextView)paramViewGroup.findViewById(2131298263);
    ...
    bcy localbcy = (bcy)paramViewGroup.getTag();
    ...
    for (;;)
    {
      localbcy.a.setText(new QQText(paramView, 5, 16, QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a()));
      return paramViewGroup;
      if (AnonymousChatHelper.a(localMessageRecord))
      {
        paramView = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getResources().getString(2131362568) + QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a().a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity, localMessageRecord, false);
        break;
      }
      ...
      break;
      label330:
      localbcy.a.setTextColor(-4210755);
    }
  }
}
