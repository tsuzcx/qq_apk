  ...
  implements View.OnTouchListener
{
  ...
  public bbt(QQBrowserActivity paramQQBrowserActivity) {}
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.f = k;
      this.h = k;
      paramView.setBackgroundResource(2130838219);
      continue;
      if (QQBrowserActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity).getVisibility() != 0)
      {
        ...
        paramView.setBackgroundResource(2130838218);
        ...
        else
        {
          ...
          if (this.jdField_a_of_type_Int + paramView.getWidth() / 2 < this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.z / 2)
          {
            ...
            QQBrowserActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity).setBackgroundResource(2130838217);
          ...
          else
          {
            ...
            QQBrowserActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity).setBackgroundResource(2130838216);
            paramView = (FrameLayout.LayoutParams)QQBrowserActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity).getLayoutParams();
    ...
    for (;;)
    {
      ...
      paramMotionEvent.setAnimationListener(new bbu(this, paramView));
