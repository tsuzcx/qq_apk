...
public class evf
  extends BaseAdapter
{
  public evf(QQCustomSingleChoiceDialog paramQQCustomSingleChoiceDialog) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = new evh(this.a, null);
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131296916));
      paramView.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramViewGroup.findViewById(2131296917));
      paramViewGroup.setTag(paramView);
    }
    paramView = (evh)paramViewGroup.getTag();
