  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 3: 
      ...
      do
      {
        ...
        else
        {
          for (;;)
          {
            try
            {
              ...
              paramMessage = String.format(this.a.getResources().getString(2131363835), new Object[] { Integer.valueOf(i) });
              this.a.a(paramMessage, new faf(this));
            ...
            this.a.l();
            return;
            paramMessage = String.format(this.a.getResources().getString(2131363839), new Object[] { ((SdkAuthorize.GetAuthApiListResponse)localObject1).msg.get(), Integer.valueOf(i) });
          }
        }
        ...
        if (TextUtils.isEmpty(((SdkAuthorize.GetAuthApiListResponse)localObject1).msg.get())) {}
        for (paramMessage = String.format(this.a.getResources().getString(2131363835), new Object[] { Integer.valueOf(i) });; paramMessage = String.format(this.a.getResources().getString(2131363839), new Object[] { ((SdkAuthorize.GetAuthApiListResponse)localObject1).msg.get(), Integer.valueOf(i) }))
        {
          this.a.a(paramMessage, new fag(this, (SdkAuthorize.GetAuthApiListResponse)localObject1, (JSONObject)localObject2));
          break;
        }
        ...
        if (i != 0)
        {
          ...
          try
          {
            ...
            paramMessage = String.format(this.a.getResources().getString(2131363835), new Object[] { Integer.valueOf(i) });
            this.a.a(paramMessage, new fah(this));
            this.a.b(i, paramMessage);
            return;
          }
          catch (JSONException paramMessage) {}
        ...
        for (paramMessage = "1";; paramMessage = "0")
        {
          ...
          return;
          paramMessage = String.format(this.a.getResources().getString(2131363839), new Object[] { localObject2, Integer.valueOf(i) });
          break;
          if (i != 110503) {
            break label970;
          }
    ...
    for (;;)
    {
      try
      {
        ...
        if (k >= 100)
        {
          ...
          ThreadManager.a(new fai(this, paramMessage));
          return;
        }
      }
      ...
      return;
      this.a.c();
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.a(this.a.getResources().getString(2131363838));
