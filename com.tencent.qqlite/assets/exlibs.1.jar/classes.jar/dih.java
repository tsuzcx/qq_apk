...
{
  public dih(QfileBaseCloudFileTabView paramQfileBaseCloudFileTabView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (paramView != null) {
      if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 1)
      {
        ...
        if ((FileManagerUtil.a()) && (paramView.fileSize > 5242880L)) {
          FMDialogUtil.a(this.a.getContext(), 2131362018, 2131362016, new dii(this, paramView));
        }
      }
    }
    for (;;)
    {
      ...
      if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 3)
      {
        ...
        if ((FileManagerUtil.a()) && (paramView.fileSize > 5242880L)) {
          FMDialogUtil.a(this.a.getContext(), 2131362018, 2131362016, new dij(this, paramView));
        } else {
      ...
      else if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 2)
      {
        ...
        {
          FMDialogUtil.a(this.a.getContext(), 2131362018, 2131362016, new dik(this, localWeiYunFileInfo));
        }
        else
        {
