...
{
  public bjh(SetTroopAdminsActivity paramSetTroopAdminsActivity) {}
  ...
  protected void a(int paramInt)
  {
    ...
    case 6: 
    default: 
      str = this.a.getString(2131362864);
    }
    for (;;)
    {
      ...
      {
        str = String.format(this.a.getString(2131362868), new Object[] { Integer.valueOf(SetTroopAdminsActivity.a(this.a)) });
      }
      else
      {
        str = this.a.getString(2131362869);
        continue;
        str = this.a.getString(2131362870);
      }
    }
  }
  ...
  protected void a(String paramString1, String paramString2, byte paramByte)
  {
    ...
    if (paramByte == 0) {
      QQToast.a(this.a, 2, 2131362866, 0).b(this.a.getTitleBarHeight());
    }
    for (;;)
    {
      this.a.setResult(-1);
