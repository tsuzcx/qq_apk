...
{
  public bpr(TroopPrivilegeActivity paramTroopPrivilegeActivity, ActionSheet paramActionSheet) {}
  
  public void a(View paramView, int paramInt)
  {
    Object localObject1;
    boolean bool;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.jdField_a_of_type_JavaLangObject != null) && ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.jdField_a_of_type_JavaLangObject instanceof bps)))
    {
      localObject1 = (bps)this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.jdField_a_of_type_JavaLangObject;
      if (((bps)localObject1).jdField_a_of_type_Int - 1 == paramInt) {
        return;
      }
      paramView = (BizTroopHandler)this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.app.a(19);
      if (((bps)localObject1).jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.getString(2131362362)))
      {
        ...
        String str = this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.getString(2131362362);
        if (paramInt != 0) {
          break label355;
        }
        i = 1;
      ...
      if (((bps)localObject1).jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.getString(2131362361)))
      {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityTroopPrivilegeActivity.getString(2131362361);
        if (paramInt != 0) {
          break label366;
        }
      }
