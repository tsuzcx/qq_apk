...
{
  public ayf(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity, AdapterView paramAdapterView, int paramInt, ayu paramayu, ActionSheet paramActionSheet) {}
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        NearbyPeopleProfileActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityNearbyPeopleProfileActivity).add(0, this.jdField_a_of_type_Ayu);
