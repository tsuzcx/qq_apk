  ...
  implements HttpNotify
{
  ...
  public eei(HttpNotify paramHttpNotify)
  {
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    {
      new Handler(localLooper).post(new eej(this, paramLong1, paramLong2));
      return;
    }
  ...
  public void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new eek(this, paramLong1, paramLong2, paramLong3));
      return;
    }
  ...
  public void a(long paramLong1, boolean paramBoolean, long paramLong2)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new eel(this, paramLong1, paramBoolean, paramLong2));
      return;
    }
