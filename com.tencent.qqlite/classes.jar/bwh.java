...
{
  public bwh(PATextItemBuilder paramPATextItemBuilder) {}
  
  public void onClick(View paramView)
  {
    paramView = (bwi)AIOUtils.a(paramView);
    ...
    for (;;)
    {
      ...
      if ((paramView.b == null) || (!paramView.b.equals("open_local")))
      {
        ...
        localIntent.putExtra("assignBackText", PATextItemBuilder.c(this.a).getResources().getString(2131363110));
