...
public class ckj
  extends AsyncTask
{
  private ckj(PhotoListActivity paramPhotoListActivity) {}
  ...
  protected void a(List paramList)
  {
    ...
    if (paramList == null)
    {
      this.a.jdField_a_of_type_Ckh.a(paramList);
      this.a.jdField_a_of_type_Ckh.notifyDataSetChanged();
    ...
    for (;;)
    {
      ...
      {
        label249:
        j = this.a.jdField_a_of_type_Ckh.getCount();
        if (j == 0) {
          j = k;
        }
        for (;;)
