...
public class dwe
  implements Runnable
{
  public dwe(DataApiPlugin paramDataApiPlugin, String paramString1, String paramString2, Bundle paramBundle1, Bundle paramBundle2, String paramString3) {}
  ...
  public void run()
  {
    ...
    if ((!TextUtils.isEmpty(this.c)) && (localObject2 != null)) {
      ((Activity)localObject2).runOnUiThread(new dwf(this, (Activity)localObject2, localObject1, i));
    }
  }
}
