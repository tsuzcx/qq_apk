...
{
  public dzz(PicTypeNormal paramPicTypeNormal, PicType paramPicType)
  {
    super(paramPicType);
  }
  ...
  protected boolean b()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqPicCompressPicTypeNormal.a.e = Utils.a(this.jdField_a_of_type_ComTencentMobileqqPicCompressPicTypeNormal.a.c, this.jdField_a_of_type_ComTencentMobileqqPicCompressPicTypeNormal.a.g);
    ...
    if (!Utils.a((BitmapFactory.Options)localObject1, this.jdField_a_of_type_ComTencentMobileqqPicCompressPicTypeNormal.a.c, i, i1))
    {
    ...
    try
    {
      localBitmap = BitmapFactory.decodeFile(this.jdField_a_of_type_ComTencentMobileqqPicCompressPicTypeNormal.a.c, (BitmapFactory.Options)localObject1);
      if (localBitmap == null)
      {
    ...
    for (int k = 1;; k = 0) {
      ...
      {
        if (i > j) {}
        i1 = ImageUtil.b(this.jdField_a_of_type_ComTencentMobileqqPicCompressPicTypeNormal.a.c);
        m = n;
        if (this.jdField_a_of_type_ComTencentMobileqqPicCompressPicTypeNormal.a.d)
        {
          m = n;
          if (i1 != 0)
          {
        ...
        catch (NullPointerException localNullPointerException)
        {
          for (;;)
          {
            Logger.b(this.jdField_a_of_type_JavaLangString, "compress()", this.jdField_a_of_type_ComTencentMobileqqPicCompressPicTypeNormal.a.jdField_a_of_type_JavaLangString + " scale or rotate createBitmap NullPointerException");
