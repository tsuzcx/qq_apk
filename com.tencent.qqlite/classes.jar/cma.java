  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public cma(ContactsInnerFrame paramContactsInnerFrame, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903629, paramViewGroup, false);
      paramView = new cmb(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame, null);
      ...
      paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131296456));
      paramView.c = ((TextView)localView.findViewById(2131296458));
    }
    paramView = (cmb)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
