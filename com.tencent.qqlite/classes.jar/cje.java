  ...
  implements MediaScannerConnection.MediaScannerConnectionClient
{
  ...
  public cje(PhotoListActivity paramPhotoListActivity, Context paramContext, String paramString1, String paramString2, boolean paramBoolean)
  {
  ...
  public void onScanCompleted(String paramString, Uri paramUri)
  {
    if (this.jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.runOnUiThread(new cjf(this));
    }
