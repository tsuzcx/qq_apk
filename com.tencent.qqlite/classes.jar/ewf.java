...
public class ewf
  extends BaseAdapter
{
  public ewf(QQCustomDialog paramQQCustomDialog) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView.a != null)
    {
      ...
      paramView.a.setOnClickListener(new ewl(this.a, paramInt));
