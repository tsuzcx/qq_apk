...
public final class byg
  extends AsyncTask
{
  public byg(File paramFile1, File paramFile2, Activity paramActivity) {}
  ...
  protected String a(Void... paramVarArgs)
  {
    ...
    try
    {
      if (FileUtil.a(this.b, this.jdField_a_of_type_JavaIoFile))
      {
        ...
        return this.jdField_a_of_type_AndroidAppActivity.getString(2131363440) + " " + paramVarArgs;
      }
      paramVarArgs = this.jdField_a_of_type_AndroidAppActivity.getString(2131363441);
      return paramVarArgs;
    }
