  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public clm(DiscussionMemberListInnerFrame paramDiscussionMemberListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903636, paramViewGroup, false);
      paramView = new cln(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame, null);
    ...
    paramView = (cln)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
