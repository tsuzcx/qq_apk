  ...
  implements RichProtoProc.RichProtoCallback
{
  ...
  private im_msg_body.CustomFace a(im_msg_body.NotOnlineImage paramNotOnlineImage)
  {
    ...
    try
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c() != null) {
        localCustomFace.bytes_signature.set(ByteStringMicro.copyFrom(this.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()));
      }
      ...
      for (;;)
      {
        ...
        Logger.a(this.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.convert2CustomFace", dzc.a(this.a, localCustomFace));
  ...
  private im_msg_body.NotOnlineImage a(im_msg_body.CustomFace paramCustomFace)
  {
    ...
    try
    {
      ...
      Logger.a(this.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.createNotOnlineImage", "OK, " + dzc.a(this.a, localNotOnlineImage));
  ...
  private void b()
  {
    new dze(this).execute(new Void[0]);
  }
