...
public class eek
  implements Runnable
{
  public eek(MainAcitivityReportHelper paramMainAcitivityReportHelper) {}
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (Exception localException)
        {
          ...
          if (!Boolean.valueOf(SettingCloneUtil.readValue(MainAcitivityReportHelper.a(this.a), localQQAppInterface.a(), MainAcitivityReportHelper.a(this.a).getString(2131363745), "qqsetting_lock_screen_whenexit_key", true)).booleanValue()) {}
        }
