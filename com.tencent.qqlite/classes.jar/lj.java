...
public class lj
{
  ...
  lj(Context paramContext, String paramString1, String paramString2, LoadedBack paramLoadedBack, boolean paramBoolean)
  {
  ...
  private boolean a(String paramString, int paramInt)
  {
    ...
    OfflineDownloader.a(this.jdField_a_of_type_AndroidContentContext, paramString, paramInt, this.jdField_a_of_type_JavaLangString, str, new lk(this, l));
    return true;
  }
