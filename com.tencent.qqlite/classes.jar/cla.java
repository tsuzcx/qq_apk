...
public class cla
  extends Handler
{
  public cla(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity) {}
  
  public void handleMessage(Message paramMessage)
  {
    if (paramMessage.what == 0)
    {
      this.a.app.a(new clb(this));
    ...
    this.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130838719);
    this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130838719);
    this.a.c.setImageResource(2130838719);
    this.a.d.setImageResource(2130838719);
