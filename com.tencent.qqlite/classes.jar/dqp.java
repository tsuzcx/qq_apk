...
public class dqp
  extends dpp
{
  public dqp(OnlineFileSessionWorker paramOnlineFileSessionWorker)
  {
  ...
  protected void a(int paramInt, String paramString)
  {
    ...
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "] state change :(" + this.jdField_a_of_type_Dpp.a() + "->StateExcepInvalidWhenChangeToOff");
    this.jdField_a_of_type_Dpp = new dpy(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker);
  }
  ...
  protected boolean a(int paramInt, String paramString, long paramLong)
  {
    ...
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "] state change :(" + this.jdField_a_of_type_Dpp.a() + "->StateUploadoneWhenChangeToOff)");
    ...
    this.jdField_a_of_type_Dpp = new dqs(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker);
    return true;
  }
