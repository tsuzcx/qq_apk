...
public class dqv
  extends dpp
{
  public dqv(OnlineFileSessionWorker paramOnlineFileSessionWorker)
  {
  ...
  protected void a(int paramInt)
  {
    ...
    while (paramInt != 0)
    {
      ...
      QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "] state change :(" + this.jdField_a_of_type_Dpp.a() + "->StateAcceptByPC)");
      this.jdField_a_of_type_Dpp = new dpm(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker);
      paramInt = i;
      continue;
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Dpp = new dpu(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker);
  ...
  protected void c()
  {
    ...
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "] state change :(" + this.jdField_a_of_type_Dpp.a() + "->StateWaitResultWhenPause)");
    this.jdField_a_of_type_Dpp = new dqu(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker);
  }
  ...
  protected void g()
  {
    ...
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "] state change :(" + this.jdField_a_of_type_Dpp.a() + ". doSomeThingOnUploadDone start recv offline file....)");
