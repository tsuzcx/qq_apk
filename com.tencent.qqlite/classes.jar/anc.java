...
public class anc
  implements Runnable
{
  public anc(ForwardOperations paramForwardOperations, String paramString, QQCustomDialog paramQQCustomDialog) {}
  ...
  public void run()
  {
    ...
    if (!this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_Boolean) {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.v == 1)
      {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130837999);
        this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new and(this, (Drawable)localObject1));
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new ane(this, (URLDrawable)localObject1));
          return;
          i = 4;
      ...
      try
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new ang(this, (Drawable)localObject2));
          return;
