...
{
  public acs(ChatHistory paramChatHistory) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        this.a.jdField_a_of_type_AndroidAppDialog.setContentView(2130903615);
        ((TextView)this.a.jdField_a_of_type_AndroidAppDialog.findViewById(2131296470)).setText(paramMessage.obj.toString());
        this.a.jdField_a_of_type_AndroidAppDialog.setOnCancelListener(new act(this));
        ...
        this.a.a(2130837979, this.a.getString(2131363171));
        return true;
        ChatHistory.a(this.a).setEnabled(true);
        if (this.a.jdField_a_of_type_AndroidAppDialog != null) {
          this.a.jdField_a_of_type_AndroidAppDialog.dismiss();
        }
        this.a.a(2130837979, this.a.getString(2131363173));
        return true;
        ChatHistory.a(this.a).setEnabled(true);
        if (this.a.jdField_a_of_type_AndroidAppDialog != null) {
          this.a.jdField_a_of_type_AndroidAppDialog.dismiss();
        }
        this.a.a(2130837979, this.a.getString(2131363172));
        return true;
        this.a.a(2130837979, this.a.getString(2131363394));
        return true;
