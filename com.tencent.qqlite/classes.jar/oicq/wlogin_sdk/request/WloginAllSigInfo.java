  ...
  implements Serializable, Cloneable
{
  ...
  public int put_siginfo(long paramLong, byte[] paramArrayOfByte)
  {
    WloginSigInfo localWloginSigInfo = (WloginSigInfo)this._tk_map.get(new Long(paramLong));
    if (localWloginSigInfo != null) {
      this._tk_map.put(new Long(paramLong), localWloginSigInfo.Set(paramArrayOfByte));
    }
    return 0;
  }
  ...
  public int put_siginfo(long paramLong1, byte[][] paramArrayOfByte, long paramLong2)
  {
    WloginSigInfo localWloginSigInfo = (WloginSigInfo)this._tk_map.get(new Long(paramLong1));
    if (localWloginSigInfo != null) {
      this._tk_map.put(new Long(paramLong1), localWloginSigInfo.Set(paramArrayOfByte, paramLong2));
    }
    return 0;
  }
