  ...
  extends o
{
  ...
  public byte[] a(long paramLong1, long paramLong2, int paramInt1, int paramInt2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt3, int paramInt4, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      ...
      arrayOfByte1 = new k().a(y.K);
      break label192;
      arrayOfByte1 = new cl().a(0, y.s, 0);
      break label192;
      arrayOfByte1 = new al().a(y.C);
      break label192;
      arrayOfByte1 = new ao().a(y.y);
      break label192;
      arrayOfByte1 = new av().b(this.w.i);
      break label192;
      arrayOfByte1 = new q().a(paramArrayOfByte2);
      break label192;
      arrayOfByte1 = new t().a(paramInt3, paramInt4, paramArrayOfLong);
      break label192;
