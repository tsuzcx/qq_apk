...
{
  public static final Parcelable.Creator<WUserSigInfo> CREATOR = new f();
  ...
  public void get_clone(WloginSigInfo paramWloginSigInfo)
  {
    ...
    this._tickets.add(new Ticket(1048576, paramWloginSigInfo._superKey, null, paramWloginSigInfo._psKey_create_time, 0L, paramWloginSigInfo._psKey));
