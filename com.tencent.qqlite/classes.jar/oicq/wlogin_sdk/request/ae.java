  ...
  extends o
{
  ...
  public int a(long paramLong1, TransReqContext paramTransReqContext, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, long paramLong2, long paramLong3, WUserSigInfo paramWUserSigInfo)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        j = this.z;
        this.z = (j + 1);
        arrayOfByte1 = a(l, j, String.valueOf(paramLong1).getBytes(), paramLong2, paramLong2, paramArrayOfByte3, new String("wtlogin_conn_trans").getBytes(), new byte[8], 0, 0L, y.y);
        arrayOfByte2 = paramTransReqContext._body;
        l = System.currentTimeMillis() / 1000L + y.Y;
  ...
  public int a(long paramLong1, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, long paramLong2, WUserSigInfo paramWUserSigInfo)
  {
    for (;;)
    {
      try
      {
        ...
        try
        {
          util.LOGD("request_transport req:" + y.ae.toJasonObj().toString(4));
  ...
  {
    if (this.w.ab != null) {
      util.LOGD("_transport_sk", "_transport_sk" + this.w.ab.toString());
    }
    for (;;)
    {
      return this.w.ab;
 ...
 * Qualified Name:     oicq.wlogin_sdk.request.ae
