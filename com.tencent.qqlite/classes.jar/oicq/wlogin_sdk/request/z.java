  ...
  extends n
{
  ...
  public int b(long paramLong1, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, long paramLong2)
  {
    ...
    y.ae.commit(Build.VERSION.RELEASE, new String(y.E), "", util.buf_to_string(util.get_ksid(y.r)), new String(y.C), new String(y.O), new String(y.G), new String(y.F), util.get_release_time(), "5.2.3.1");
    try
    {
      util.LOGD("request_report_error req:" + y.ae.toJasonObj().toString(4));
      paramArrayOfByte1 = y.ae.toJasonObj().toString().getBytes();
    ...
    catch (Throwable paramArrayOfByte1)
    {
      ...
      if (i != 0)
      {
        report_t.write_tofile(y.ae, y.r);
        return i;
      }
      y.ae.clear_t2();
      return i;
  ...
  public int c(long paramLong1, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, long paramLong2)
  {
    ...
    String str;
    long l2;
    if ((this.a.d != null) && (!y.e.booleanValue()))
    {
      y.e = Boolean.valueOf(true);
      long l3 = System.currentTimeMillis();
      SimpleDateFormat localSimpleDateFormat = new SimpleDateFormat("yyyyMMdd");
      Calendar localCalendar = Calendar.getInstance();
      int j = this.a.d.f();
      int k = this.a.d.g();
      util.LOGI("bitmap:" + j + " network:" + k + " local network:" + util.get_network_type(y.r));
      int i = 0;
      if (i < 32)
      {
        if ((1 << i & j) == 0) {}
        while ((k != 0) && ((k != 1) || (util.get_network_type(y.r) != 2)))
        {
          i += 1;
          break;
        }
        ...
        l2 = util.getLogModifyTime(y.r, str);
        if (l2 != 0L) {
          break label339;
        }
      }
    ...
    for (;;)
    {
      paramArrayOfByte1 = util.readLog(y.r, str);
