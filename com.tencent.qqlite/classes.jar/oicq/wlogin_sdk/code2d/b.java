...
public class b
{
  ...
  {
    byte[] arrayOfByte = new byte[28 + (y.C.length + 2 + 2 + y.E.length + 2 + y.F.length)];
    ...
    System.arraycopy(y.y, 0, arrayOfByte, 12, y.y.length);
    int i = y.y.length;
    i = fill_staff(arrayOfByte, y.C, i + 12);
    i = fill_staff(arrayOfByte, y.E, i);
    fill_staff(arrayOfByte, y.F, i);
    return arrayOfByte;
  }
