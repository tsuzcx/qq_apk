  ...
  extends a
{
  ...
  public byte[] b(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, int paramInt1, byte[] paramArrayOfByte5, byte[] paramArrayOfByte6, boolean paramBoolean, byte[] paramArrayOfByte7, long paramLong, byte[] paramArrayOfByte8, int paramInt2)
  {
    ...
    {
      i = 10;
      paramArrayOfByte7 = new byte[paramArrayOfByte1.length + 1 + 1 + paramArrayOfByte3.length + 1 + 1 + 2 + paramArrayOfByte5.length + 2 + arrayOfByte.length + 2 + paramArrayOfByte6.length + 2 + 1 + 2 + 1 + 2 + paramArrayOfByte4.length + 2 + paramArrayOfByte3.length + 2 + 4 + 2 + paramArrayOfByte8.length + 2 + 4];
    ...
    for (paramArrayOfByte1 = h.a.getBytes();; paramArrayOfByte1 = MD5.toMD5Byte(paramArrayOfByte2))
    {
      ...
      paramArrayOfByte7 = new byte[paramArrayOfByte1.length + 1 + 1 + paramArrayOfByte3.length + 1 + 1 + 2 + paramArrayOfByte5.length + 2 + arrayOfByte.length + 2 + paramArrayOfByte6.length + 2 + 1 + 2 + 4];
      break;
    }
  }
}
