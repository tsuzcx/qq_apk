...
public class euz
  extends BaseAdapter
{
  public euz(QQCustomSingleButtonDialog paramQQCustomSingleButtonDialog) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView.a != null)
    {
      ...
      paramView.a.setOnClickListener(new evd(this.a, paramInt));
