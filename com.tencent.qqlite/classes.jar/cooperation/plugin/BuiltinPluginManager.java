...
public class BuiltinPluginManager
{
  ...
  void c()
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: new 102	java/io/BufferedReader
    //   5: dup
    //   6: new 104	java/io/InputStreamReader
    //   9: dup
    //   10: aload_0
    //   11: getfield 32	cooperation/plugin/BuiltinPluginManager:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   14: invokevirtual 110	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   17: ldc 112
    //   19: invokevirtual 118	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   22: invokespecial 121	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   25: invokespecial 124	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   28: astore_1
    //   29: aload_1
    //   30: invokevirtual 127	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   33: astore_2
    //   34: aload_2
    //   35: ifnull +91 -> 126
    //   38: aload_2
    //   39: invokevirtual 130	java/lang/String:trim	()Ljava/lang/String;
    //   42: ldc 132
    //   44: invokevirtual 136	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   47: astore 4
    //   49: aload 4
    //   51: iconst_0
    //   52: aaload
    ...
    //   67: aaload
    //   68: astore_2
    //   69: new 58	cooperation/plugin/PluginInfo
    //   72: dup
    //   73: invokespecial 139	cooperation/plugin/PluginInfo:<init>	()V
    //   76: astore 4
    //   78: aload 4
    //   80: aload_3
    //   81: putfield 142	cooperation/plugin/PluginInfo:mID	Ljava/lang/String;
    //   84: aload 4
    //   86: aload_2
    //   87: putfield 145	cooperation/plugin/PluginInfo:mMD5	Ljava/lang/String;
    //   90: aload 4
    //   92: iconst_1
    //   93: putfield 149	cooperation/plugin/PluginInfo:mUpdateType	I
    //   96: aload 4
    //   98: iconst_0
    //   99: putfield 152	cooperation/plugin/PluginInfo:mInstallType	I
    //   102: aload_0
    //   103: getfield 30	cooperation/plugin/BuiltinPluginManager:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   106: aload_3
    //   107: aload 4
    //   109: invokevirtual 156	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   112: pop
    //   113: goto -84 -> 29
    //   116: astore_2
    //   117: aload_1
    //   118: ifnull +7 -> 125
    //   121: aload_1
    //   122: invokevirtual 159	java/io/BufferedReader:close	()V
    //   125: return
    //   126: aload_1
    //   127: ifnull -2 -> 125
    //   130: aload_1
    //   131: invokevirtual 159	java/io/BufferedReader:close	()V
    //   134: return
    //   135: astore_1
    //   136: return
    //   137: astore_1
    ...
    //   139: ifnull +7 -> 146
    //   142: aload_2
    //   143: invokevirtual 159	java/io/BufferedReader:close	()V
    //   146: aload_1
    //   147: athrow
    //   148: astore_1
    //   149: return
