...
public class QZoneHelper
{
  ...
  private static Intent a(Context paramContext, Long paramLong, int paramInt)
  {
    ...
    localIntent.putExtra("key_left_tab_title", paramContext.getString(2131364515));
    localIntent.putExtra("key_rihgt_tab_title", paramContext.getString(2131364514));
  ...
  {
    QQToast.a(BaseApplication.getContext(), 2131364511, 0).a();
  }
