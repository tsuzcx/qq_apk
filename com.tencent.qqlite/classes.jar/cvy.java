  ...
  extends View
{
  ...
  public cvy(ScreenShot paramScreenShot, Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidGraphicsRect = new Rect();
    setOnLongClickListener(new cvz(this, paramScreenShot));
  }
    ...
    do
    {
      try
      {
        for (;;)
        {
          ...
          Toast.makeText(this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131363183, 1).show();
          return;
          m = getWidth();
          n = getHeight();
      ...
      if (this.jdField_a_of_type_AndroidGraphicsRect.isEmpty())
      {
        ...
        paramCanvas.drawText(this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidContentContext.getString(2131363181), getWidth() / 2, i2 + 26.0F * f1, this.jdField_b_of_type_AndroidGraphicsPaint);
      }
