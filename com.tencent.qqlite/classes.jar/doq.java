...
public class doq
  extends doh
{
  public doq(OnlineFileSessionWorker paramOnlineFileSessionWorker)
  {
  ...
  protected boolean a(int paramInt, String paramString, long paramLong)
  {
    ...
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "] state change :(" + this.jdField_a_of_type_Doh.a() + "->StateUploadoneWhenChangeToOff)");
    ...
    this.jdField_a_of_type_Doh = new dpk(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker);
    return true;
  }
}
