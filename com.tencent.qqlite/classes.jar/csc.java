  ...
  extends DefaultHandler
{
  ...
  public HashMap a;
  private Pattern jdField_a_of_type_JavaUtilRegexPattern = Pattern.compile("^([0-9]{0,5}|\\{([\\s\\S]*)\\})(,([0-9]{0,5}|\\{([\\s\\S]*)\\}))*$");
  private boolean jdField_a_of_type_Boolean = false;
  private String b = "0";
  
  public csc(HashMap paramHashMap)
  {
  ...
  public void endElement(String paramString1, String paramString2, String paramString3)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      paramString1 = (csd)this.jdField_a_of_type_JavaUtilHashMap.get(paramString2);
      if (QLog.isColorLevel()) {
