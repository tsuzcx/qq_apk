...
public class anf
  implements Runnable
{
  public anf(ForwardOperations paramForwardOperations, String paramString, QQCustomDialog paramQQCustomDialog) {}
  ...
  public void run()
  {
    ...
    if (!this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_Boolean) {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.v == 1)
      {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130838012);
        this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new ang(this, (Drawable)localObject1));
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new anh(this, (URLDrawable)localObject1));
          return;
          i = 4;
      ...
      try
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new anj(this, (Drawable)localObject2));
          return;
