...
public class dzc
  extends AsyncTask
{
  final RichProtoProc.RichProtoCallback jdField_a_of_type_ComTencentMobileqqTransfileProtohandlerRichProtoProc$RichProtoCallback = new dzd(this);
  ArrayList jdField_a_of_type_JavaUtilArrayList;
  
  public dzc(BasePicOprerator paramBasePicOprerator, ArrayList paramArrayList, long paramLong) {}
  ...
  protected Void a(Void... arg1)
  {
    ...
    for (;;)
    {
      if (i < this.b.size())
      {
        ...
        ((RichProto.RichProtoReq.PicUpReq)localObject).jdField_c_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount();
        ((RichProto.RichProtoReq.PicUpReq)localObject).d = this.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin;
        ((RichProto.RichProtoReq.PicUpReq)localObject).jdField_c_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.istroop;
        ...
        boolean bool;
        if (((RichProto.RichProtoReq.PicUpReq)localObject).jdField_c_of_type_Int == 1006)
        {
          bool = true;
          ...
          label544:
          if ((((RichProto.RichProtoReq.PicUpReq)localObject).jdField_c_of_type_Int != 1) && (((RichProto.RichProtoReq.PicUpReq)localObject).jdField_c_of_type_Int != 3000)) {
            break label889;
          }
