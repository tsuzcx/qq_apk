...
public class crv
  implements Runnable
{
  public crv(DeviceProfileManager paramDeviceProfileManager, ConfigurationService.RespGetConfig paramRespGetConfig, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(DeviceProfileManager.jdField_a_of_type_JavaLangString, 2, "onDPCResponse DPCXmlHandler.tempMap: key=" + (String)localObject8 + ", value=" + localcrx.toString() + ", isAccountName=" + bool1);
      }
      ...
      else if (localObject8 != null)
      {
        ...
        bool2 = DeviceProfileManager.a((DeviceProfileManager.DPCConfigInfo)localObject8, localcrx.b.toString().trim());
        if (!bool1) {
          break label969;
        }
    ...
    for (;;)
    {
      localEditor1.putString((String)???, localcrx.b);
      label632:
      if (!QLog.isColorLevel()) {
        break label255;
      }
