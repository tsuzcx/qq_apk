  ...
  implements View.OnClickListener, OnLongClickAndTouchListener
{
  ...
  private bsp(ChatAdapter1 paramChatAdapter1) {}
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    if ((localObject != null) && (localObject.length > 0))
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForText)) {
        ...
        {
          localObject = "地理位置";
          this.jdField_a_of_type_ComTencentWidgetMenuPopupDialog = MenuPopupDialog.a(paramView, (String)localObject, localQQCustomMenu, this, new bsq(this));
          a(paramView);
