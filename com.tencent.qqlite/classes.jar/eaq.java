...
public class eaq
  extends AsyncTask
{
  public eaq(BasePicOprerator paramBasePicOprerator, PicUploadInfo paramPicUploadInfo) {}
  ...
  protected Void a(Void... paramVarArgs)
  {
    ...
    for (long l = SystemClock.uptimeMillis();; l = 0L)
    {
      ...
      if (paramVarArgs.istroop == 1) {
        AnonymousChatHelper.a().a(paramVarArgs);
      }
      ...
      ((TransferRequest)localObject).h = this.jdField_a_of_type_ComTencentMobileqqPicPicUploadInfo.jdField_g_of_type_JavaLangString;
