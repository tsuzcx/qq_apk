...
{
  public ble(SplashActivity paramSplashActivity, Dialog paramDialog) {}
  
  public void onClick(View paramView)
  {
    boolean bool = ((CheckBox)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131297091)).isChecked();
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.e = bool;
    SettingCloneUtil.writeValue(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.a(), this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131363744), "qqsetting_receivemsg_whenexit_key", bool);
