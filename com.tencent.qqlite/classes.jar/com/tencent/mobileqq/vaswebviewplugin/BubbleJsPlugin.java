  ...
  extends VasWebviewJsPlugin
{
  ...
  {
    return super.handleThemeAndBubbleSchemaRequest(paramString1, paramString2, "bubble");
  }
  ...
  public void queryInfo(JSONObject paramJSONObject, String paramString)
  {
    ...
    super.sendRemoteReq(DataFactory.makeIPCRequestPacket("queryBubbleInfo", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
  }
  ...
  public void queryLocal(JSONObject paramJSONObject, String paramString)
  {
    ...
    super.sendRemoteReq(DataFactory.makeIPCRequestPacket("queryLocal", paramString, this.mOnRemoteResp.key, new Bundle()), false, false);
  }
  ...
  public void setup(JSONObject paramJSONObject, String paramString)
  {
    ...
    this.mReqBundle.clear();
    this.mReqBundle.putInt("id", i);
    super.sendRemoteReq(DataFactory.makeIPCRequestPacket("setup", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
  }
  ...
  public void startDownload(JSONObject paramJSONObject, String paramString)
  {
    ...
    this.mReqBundle.clear();
    this.mReqBundle.putInt("id", i);
    super.sendRemoteReq(DataFactory.makeIPCRequestPacket("bubble_startDownLoad", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
  }
  ...
  public void stopDownload(JSONObject paramJSONObject, String paramString)
  {
    ...
    this.mReqBundle.clear();
    this.mReqBundle.putInt("id", i);
    super.sendRemoteReq(DataFactory.makeIPCRequestPacket("bubble_StopDownLoad", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
  }
}
