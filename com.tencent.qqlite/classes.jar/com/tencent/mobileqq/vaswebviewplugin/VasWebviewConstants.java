...
public class VasWebviewConstants
{
  ...
  public static final String HOME_PAGE_URL = "http://imgcache.qq.com/club/themes/mobile/bq/html/index.html?uin=[uin]&adtag=[adtag]&client=[client]&version=[version]&sid=[sid]&platformId=2&device=[device]&system=[system]&systemInt=[systemInt]&updateTime=[updateTime]&updateFlag=[updateFlag]&updateId=[updateId]&_bid=102&_wv=1027";
  ...
  static
  {
    ...
    localStringBuilder.append("?client=androidQQ").append("&version=").append("3.5.0.660").append("&system=").append(Build.VERSION.RELEASE).append("&device=").append(Build.DEVICE).append("&updateFlag=[updateFlag]").append("&_bid=182").append("&_wv=3");
    ...
    localStringBuilder.append("?client=androidQQ").append("&uin=[uin]").append("&version=").append("3.5.0.660").append("&system=").append(Build.VERSION.RELEASE).append("&device=").append(Build.DEVICE).append("&platformId=2").append("&systemInt=").append(Integer.toString(Build.VERSION.SDK_INT)).append("&updateFlag=[updateFlag]").append("&adtag=mvip.gongneng.anroid.individuation.web").append("&_bid=236").append("&_wv=1027");
