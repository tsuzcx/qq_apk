...
public class QQProgressNotifier
{
  ...
  public QQProgressNotifier(BaseActivity paramBaseActivity)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new eyu(this, Looper.getMainLooper());
  }
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    if (paramInt1 == 0)
    {
      if ((paramString == null) || ("".equals(paramString.trim()))) {
        this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363378));
      }
      for (;;)
      {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.a(paramString);
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.c(2130837979);
    ...
    for (long l = paramInt2;; l = 1000L)
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.a(paramString);
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.c(2130837989);
      break;
    }
  }
}
