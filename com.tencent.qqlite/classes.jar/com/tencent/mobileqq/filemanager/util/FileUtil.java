...
public class FileUtil
{
  ...
  public static boolean a(android.graphics.Bitmap paramBitmap, String paramString)
  {
    ...
    //   10: iload_2
    //   11: ireturn
    //   12: new 192	java/io/BufferedOutputStream
    //   15: dup
    //   16: new 194	java/io/FileOutputStream
    //   19: dup
    //   20: aload_1
    //   21: invokespecial 195	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   24: ldc 196
    //   26: invokespecial 199	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   29: astore_1
    //   30: aload_0
    //   31: getstatic 205	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   34: bipush 70
    //   36: aload_1
    //   37: invokevirtual 211	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   40: istore_3
    //   41: iload_3
    //   42: istore_2
    //   43: aload_1
    //   44: ifnull -34 -> 10
    //   47: aload_1
    //   48: invokevirtual 216	java/io/OutputStream:flush	()V
    //   51: aload_1
    //   52: invokevirtual 219	java/io/OutputStream:close	()V
    //   55: iload_3
    //   56: ireturn
    //   57: astore_0
    //   58: aconst_null
    ...
    //   61: ifnull +11 -> 72
    //   64: aload_1
    //   65: invokevirtual 216	java/io/OutputStream:flush	()V
    //   68: aload_1
    //   69: invokevirtual 219	java/io/OutputStream:close	()V
    //   72: aload_0
    //   73: athrow
    //   74: astore_0
    //   75: goto -15 -> 60
  ...
  public static boolean a(File paramFile1, File paramFile2)
  {
    ...
    //   7: istore_2
    //   8: aload_0
    //   9: invokevirtual 232	java/io/File:isFile	()Z
    //   12: ifeq +89 -> 101
    //   15: aload_1
    //   16: invokevirtual 22	java/io/File:exists	()Z
    //   19: ifeq +8 -> 27
    //   22: aload_1
    //   23: invokevirtual 225	java/io/File:delete	()Z
    //   26: pop
    //   27: new 194	java/io/FileOutputStream
    //   30: dup
    //   31: aload_1
    //   32: invokespecial 235	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   35: astore 4
    //   37: new 237	java/io/FileInputStream
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 238	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   45: astore 5
    //   47: sipush 4096
    //   50: newarray byte
    //   52: astore 6
    //   54: aload 5
    //   56: aload 6
    //   58: invokevirtual 242	java/io/FileInputStream:read	([B)I
    //   61: istore_3
    //   62: iload_3
    //   63: iconst_m1
    ...
    //   71: iconst_0
    //   72: iload_3
    //   73: invokevirtual 246	java/io/FileOutputStream:write	([BII)V
    //   76: goto -22 -> 54
    //   79: astore 6
    //   81: aload 4
    //   83: ifnull +8 -> 91
    //   86: aload 4
    //   88: invokevirtual 247	java/io/FileOutputStream:close	()V
    //   91: aload 5
    //   93: ifnull +8 -> 101
    //   96: aload 5
    //   98: invokevirtual 248	java/io/FileInputStream:close	()V
    //   101: aload_0
    //   102: invokevirtual 55	java/io/File:isDirectory	()Z
    //   105: ifeq +135 -> 240
    //   108: aload_0
    //   109: invokevirtual 157	java/io/File:listFiles	()[Ljava/io/File;
    //   112: astore_0
    //   113: aload_1
    //   114: invokevirtual 251	java/io/File:mkdir	()Z
    //   117: pop
    //   118: iload_2
    //   119: aload_0
    //   120: arraylength
    ...
    //   125: iload_2
    //   126: aaload
    //   127: invokevirtual 254	java/io/File:getAbsoluteFile	()Ljava/io/File;
    ...
    //   141: aload_1
    //   142: invokevirtual 254	java/io/File:getAbsoluteFile	()Ljava/io/File;
    //   145: invokevirtual 257	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   148: getstatic 152	java/io/File:separator	Ljava/lang/String;
    ...
    //   169: invokestatic 259	com/tencent/mobileqq/filemanager/util/FileUtil:a	(Ljava/io/File;Ljava/io/File;)Z
    //   172: pop
    //   173: iload_2
    //   174: iconst_1
    //   175: iadd
    ...
    //   177: goto -59 -> 118
    //   180: aload 4
    //   182: invokevirtual 260	java/io/FileOutputStream:flush	()V
    //   185: aload 4
    //   187: ifnull +8 -> 195
    //   190: aload 4
    //   192: invokevirtual 247	java/io/FileOutputStream:close	()V
    //   195: aload 5
    //   197: ifnull -96 -> 101
    //   200: aload 5
    //   202: invokevirtual 248	java/io/FileInputStream:close	()V
    //   205: goto -104 -> 101
    //   208: astore 4
    //   210: goto -109 -> 101
    //   213: astore_0
    ...
    //   231: ifnull +7 -> 238
    //   234: aload_1
    //   235: invokevirtual 248	java/io/FileInputStream:close	()V
    //   238: aload_0
    //   239: athrow
    //   240: iconst_1
    //   241: ireturn
