...
public class FMToastUtil
{
  ...
  public static void a(int paramInt)
  {
    ...
    {
      new Handler(localLooper).post(new dwa(paramInt));
      return;
    }
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    {
      new Handler((Looper)localObject).post(new dwh(paramInt2));
      return;
    }
    localObject = new QQToast(BaseApplicationImpl.getContext());
    ((QQToast)localObject).a(2130837981);
  ...
  public static void a(String paramString)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new dwb(paramString));
      return;
    }
  ...
  public static void b(int paramInt)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new dwc(paramInt));
      return;
    }
  ...
  public static void b(String paramString)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new dwd(paramString));
      return;
    }
  ...
  public static void c(int paramInt)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new dwf(paramInt));
      return;
    }
  ...
  public static void c(String paramString)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new dwe(paramString));
      return;
    }
  ...
  public static void d(int paramInt)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new dwg(paramInt));
      return;
    }
    QQToast.a(BaseApplicationImpl.getContext(), -1, paramInt, 0).b(jdField_a_of_type_Int);
  }
