  ...
  implements UniformDownloader.IUniformDownloader
{
  ...
  private UniformDownloaderGenWorker jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloaderGenWorker = null;
  ...
  private boolean a(long paramLong)
  {
    ...
    localUniformDownloaderGenWorker = new UniformDownloaderGenWorker(this.jdField_c_of_type_Long, UniformDownloadMgr.a().a(), this.jdField_c_of_type_JavaLangString, this.b, new dvp(this));
  ...
  public int a()
  {
    ...
    QQAppInterface localQQAppInterface = UniformDownloadMgr.a().a();
    if (localQQAppInterface != null) {
      StatisticAssist.a(localQQAppInterface.getApplication().getApplicationContext(), localQQAppInterface.a(), "Start_download_2-3_3-1");
    }
    if (!a())
    {
  ...
  public int d()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader$IUniformDownloaderListener.b(h(), null);
    return 0;
  }
