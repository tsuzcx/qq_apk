  ...
  implements INetEngine.INetEngineListener
{
  ...
  public void a(NetResp paramNetResp)
  {
    ...
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.d("FileHttpUploder<FileAssistant>", 4, "logID[" + this.jdField_d_of_type_JavaLangString + "]onResp result:" + paramNetResp.jdField_d_of_type_Int + " errCode:" + paramNetResp.e + " errDesc:" + paramNetResp.jdField_a_of_type_JavaLangString);
      }
      ...
      i = paramNetResp.f;
      if ((paramNetResp.e == 9364) && (this.jdField_b_of_type_Int < 3))
      {
      ...
      if ((FileHttpUtils.a(paramNetResp.e)) && (this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreHttpUrlProcessor != null))
      {
    ...
    QLog.e("FileHttpUploder<FileAssistant>", 1, "logID[" + this.jdField_d_of_type_JavaLangString + "]httpRetCode:" + i + "]onResp result:" + paramNetResp.jdField_d_of_type_Int + " errCode:" + paramNetResp.e + " errDesc:" + paramNetResp.jdField_a_of_type_JavaLangString);
    return;
    this.f = 0;
  ...
  byte[] a(long paramLong)
  {
    ...
    //   15: ifnonnull +23 -> 38
    //   18: aload_0
    //   19: new 350	java/io/FileInputStream
    //   22: dup
    //   23: aload_0
    ...
    //   27: invokespecial 351	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    ...
    //   50: ifeq +23 -> 73
    //   53: aload_0
    //   54: new 350	java/io/FileInputStream
    //   57: dup
    //   58: aload_0
    ...
    //   62: invokespecial 351	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    ...
    //   90: lload_1
    //   91: invokestatic 354	com/tencent/mobileqq/filemanager/discoperation/FileHttpUtils:a	(Lcom/tencent/wstt/SSCM/SSCM;JJJ)I
    //   94: istore_3
    //   95: iload_3
    //   96: newarray byte
    //   98: astore 4
    ...
    //   106: iconst_0
    //   107: iload_3
    //   108: invokevirtual 360	java/io/InputStream:read	([BII)I
    //   111: pop
    //   112: aload_0
    //   113: aload_0
    ...
    //   133: aload 4
    //   135: invokevirtual 363	java/io/FileNotFoundException:printStackTrace	()V
    //   138: aconst_null
    //   139: areturn
    //   140: astore 4
    //   142: aload_0
    ...
    //   147: aload 4
    //   149: invokevirtual 363	java/io/FileNotFoundException:printStackTrace	()V
    //   152: aconst_null
    //   153: areturn
    //   154: lload_1
    //   155: aload_0
    ...
    //   172: lsub
    //   173: invokevirtual 367	java/io/InputStream:skip	(J)J
    //   176: pop2
    //   177: goto -104 -> 73
    //   180: astore 4
    //   182: aload 4
    //   184: invokevirtual 368	java/io/IOException:printStackTrace	()V
    //   187: aconst_null
    //   188: areturn
    //   189: lload_1
    //   190: aload_0
    ...
    //   195: ifge -122 -> 73
    //   198: aload_0
    //   199: new 350	java/io/FileInputStream
    //   202: dup
    //   203: aload_0
    ...
    //   207: invokespecial 351	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    ...
    //   222: lload_1
    //   223: invokevirtual 367	java/io/InputStream:skip	(J)J
    //   226: pop2
    //   227: goto -154 -> 73
    //   230: astore 4
    //   232: aload_0
    ...
    //   237: aload 4
    //   239: invokevirtual 368	java/io/IOException:printStackTrace	()V
    //   242: aconst_null
    //   243: areturn
    //   244: astore 4
    //   246: aconst_null
