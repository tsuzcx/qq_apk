...
public class UniformDownloadMgr
{
  ...
  private int a(String paramString1, String paramString2, long paramLong, int paramInt, boolean paramBoolean)
  {
    ...
    if (1 == localUniformDownloader.g())
    {
      ...
      localUniformDownloader.a(new dpt(this), true);
      localBundle = new Bundle();
      ...
      a(paramString1, new dqd(this, null, localUniformDownloader.g(), localUniformDownloader, l, paramInt));
      if (!paramBoolean) {
        break label372;
      }
  ...
  private dqd a(String paramString)
  {
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      paramString = (dqd)this.jdField_a_of_type_JavaUtilMap.get(paramString);
      return paramString;
    }
  }
  
  private dqe a(String paramString)
  {
    if (paramString == null)
    {
  ...
  private String a(dqe paramdqe)
  {
    ...
    return String.valueOf(paramdqe.jdField_a_of_type_Int) + "^" + paramdqe.jdField_a_of_type_JavaLangString + "^" + String.valueOf(paramdqe.jdField_a_of_type_Long) + "^" + String.valueOf(paramdqe.jdField_a_of_type_Boolean);
  }
  
  private boolean a(String paramString, dqd paramdqd)
  {
    if ((paramString == null) || (paramdqd == null))
    {
    ...
    this.jdField_a_of_type_JavaUtilMap.put(paramString, paramdqd);
  ...
  private int b(String paramString)
  {
    ...
    for (int m = 2;; m = 1)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        {
          dqd localdqd = (dqd)localIterator.next();
          int n = i;
          k = j;
          if (localdqd.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader != null)
          {
            n = i;
            k = j;
            if (localdqd.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader.b())
            {
              j += 1;
              n = i;
              k = j;
              if (paramString != null)
              {
                n = i;
                k = j;
                if (paramString.equalsIgnoreCase(localdqd.jdField_a_of_type_JavaLangString))
                {
          ...
          ((List)localObject2).add(localdqd);
          i = n;
          j = k;
        }
      }
      if (j < m)
      {
        ...
        if (((Iterator)???).hasNext())
        {
          localObject2 = (dqd)((Iterator)???).next();
          k = j;
          if (((dqd)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader == null) {
            break label496;
          }
          k = j;
          if (!((dqd)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader.a()) {
            break label496;
          }
          if (j < m)
          {
            QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] >>> Happy. start a download task, url:[" + ((dqd)localObject2).jdField_a_of_type_JavaLangString + "]");
            j += 1;
            ((dqd)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader.a();
            k = j;
            if (paramString == null) {
              break label496;
            }
            k = j;
            if (!paramString.equalsIgnoreCase(((dqd)localObject2).jdField_a_of_type_JavaLangString)) {
              break label496;
            }
  ...
  {
    dqd localdqd = a(paramString);
    if (localdqd != null)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        if (localdqd.jdField_a_of_type_Int != 1) {
          break label71;
        }
        StatisticAssist.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), "Stop_download_2-2_3-0");
      }
      ...
      {
        if (localdqd.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader != null) {
          localdqd.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader.b();
        }
        b(null);
        return 0;
        label71:
  ...
  private int d(String paramString)
  {
    ...
    {
      if (localdqd.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader != null) {
        localdqd.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader.c();
      }
      b(null);
      return 0;
    }
  ...
  private int e(String paramString)
  {
    ...
    {
      if (localdqd.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader != null) {
        localdqd.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader.d();
      }
      return 0;
    }
  ...
  {
    e();
    this.jdField_a_of_type_AndroidOsHandler.post(new dpv(this));
  }
  ...
  private void i()
  {
    ...
    e();
    this.jdField_a_of_type_AndroidOsHandler.post(new dqc(this));
  }
  
  private void j()
  {
    e();
    this.jdField_a_of_type_AndroidOsHandler.post(new dpu(this));
  }
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((Map)localObject1).size() > 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] getDownloadingRbResmeInfo, url:[" + str + "]" + "] nId:[" + ((dqe)localObject2).jdField_a_of_type_Int + "] w:[" + ((dqe)localObject2).jdField_a_of_type_Boolean + "]");
  ...
  {
    e();
    this.jdField_a_of_type_AndroidOsHandler.post(new dpw(this, paramString, paramBundle));
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong, int paramInt, boolean paramBoolean)
  {
    try
    {
      ...
      dqe localdqe = new dqe(this);
      localdqe.jdField_a_of_type_Int = paramInt;
      localdqe.jdField_a_of_type_JavaLangString = paramString2;
      localdqe.jdField_a_of_type_Long = paramLong;
      localdqe.jdField_a_of_type_Boolean = paramBoolean;
      localEditor.putString(paramString1, a(localdqe));
      localEditor.commit();
      return;
    }
  ...
  public void b()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      ...
      {
        dqd localdqd = (dqd)localIterator.next();
        if ((localdqd.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader != null) && (localdqd.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader.b())) {
          QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] >>>onQQProcessExit. stop download:url:" + localdqd.jdField_a_of_type_JavaLangString);
        }
        Bundle localBundle = new Bundle();
        localBundle.putString("_notify_param_Url", localdqd.jdField_a_of_type_JavaLangString);
        UniformDownloadNfn.a().c(localdqd.b, localBundle);
        QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] >>>onQQProcessExit. cancel notification:" + localdqd.b);
      }
    }
    d();
    c();
  ...
  {
    e();
    this.jdField_a_of_type_AndroidOsHandler.post(new dpx(this, paramString, paramBundle));
  }
  ...
  {
    e();
    this.jdField_a_of_type_AndroidOsHandler.post(new dpy(this, paramString, paramBundle));
  }
  ...
  {
    e();
    this.jdField_a_of_type_AndroidOsHandler.post(new dpz(this, paramString, paramBundle));
  }
  
  public void e(String paramString, Bundle paramBundle)
  {
    e();
    this.jdField_a_of_type_AndroidOsHandler.post(new dqa(this, paramString, paramBundle));
  }
  
  public void f(String paramString, Bundle paramBundle)
  {
    e();
    this.jdField_a_of_type_AndroidOsHandler.post(new dqb(this, paramString, paramBundle));
  }
}
