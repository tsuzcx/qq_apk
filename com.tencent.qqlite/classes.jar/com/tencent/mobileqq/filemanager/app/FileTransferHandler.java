...
public class FileTransferHandler
{
  ...
  static
  {
    jdField_a_of_type_AndroidOsHandler = new dod(Looper.getMainLooper());
  ...
  private dol a(byte[] paramArrayOfByte)
  {
    int i1 = paramArrayOfByte.length;
    if ((paramArrayOfByte == null) || (i1 == 0)) {
      return null;
    }
    dol localdol = new dol(null);
    int i2;
    byte[] arrayOfByte;
    if (i1 >= 16)
    {
    ...
    try
    {
      localdol.jdField_a_of_type_JavaLangString = new String(arrayOfByte, "UTF-16LE");
      if (i1 >= i2 + 4)
      {
        ...
        localdol.jdField_a_of_type_Long = ((PkgTools.a(paramArrayOfByte, i2) << 32) + l1);
        return localdol;
  ...
  private void a(int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, cmd0x345.RspBody.SubCmd0x7RspBody paramSubCmd0x7RspBody)
  {
    ...
    if (paramToServiceMsg.extraData.getBoolean("_IS_VIDEO_THUMB_", false))
    {
      long l1 = paramToServiceMsg.extraData.getLong("_CONTEXT_");
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(bool, 192, new Object[] { Integer.valueOf(paramInt), "", localObject, paramSubCmd0x7RspBody, paramFromServiceMsg, Integer.valueOf(i1), null, Long.valueOf(l1) });
      return;
    }
  ...
  private void a(long paramLong, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, cmd0x345.RspBody.SubCmd0x3RspBody paramSubCmd0x3RspBody)
  {
    ...
    for (paramSubCmd0x3RspBody = paramSubCmd0x3RspBody.str_suggest_file_name.get();; paramSubCmd0x3RspBody = "")
    {
      int i2;
  ...
  private boolean a(String paramString1, String paramString2, long paramLong1, long paramLong2, long paramLong3, List paramList, String paramString3)
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c();
    int i1 = 0;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramGroupFile.equals(String.valueOf(paramLong3)))
        {
          ...
          localFileManagerEntity.nOpType = 7;
          localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131362022);
          localFileManagerEntity.bSend = true;
          localFileManagerEntity.isReaded = true;
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localFileManagerEntity);
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject3 = (cmd0x346.DownloadInfo)((cmd0x346.ApplyDownloadAbsRsp)localObject2).msg_download_info.get();
          localObject2 = ((cmd0x346.DownloadInfo)localObject3).str_download_ip.get();
          str = ((cmd0x346.DownloadInfo)localObject3).str_download_domain.get();
          i2 = ((cmd0x346.DownloadInfo)localObject3).uint32_port.get();
          localObject1 = ((cmd0x346.DownloadInfo)localObject3).str_download_url.get();
          localObject3 = HexUtil.a(((cmd0x346.DownloadInfo)localObject3).bytes_download_key.get().toByteArray());
          bool = true;
          localFromServiceMsg = paramFromServiceMsg;
          paramFromServiceMsg = (FromServiceMsg)localObject1;
          localObject1 = str;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("FileTransferHandler<FileAssistant>", 2, "handlePreviewResponse: return " + bool + ", retCode=" + i1 + ", retMsg=" + localFromServiceMsg + ", Key=" + (String)localObject3 + ", IP=" + (String)localObject2 + ", Domain=" + (String)localObject1 + ", port=" + i2);
    }
    if (i1 == -100001) {
      i3 = 9043;
    }
    for (;;)
    {
      ...
      long l1 = paramToServiceMsg.extraData.getLong("_CONTEXT_");
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(bool, 191, new Object[] { Integer.valueOf(i3), localFromServiceMsg, localObject3, localObject2, localObject1, Integer.valueOf(i2), paramFromServiceMsg, Long.valueOf(l1) });
      return;
      i3 = i1;
      if (i1 == -100003) {
        i3 = 9045;
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(bool, 18, new Object[] { Integer.valueOf(i3), localFromServiceMsg, localObject3, localObject2, localObject1, Integer.valueOf(i2) });
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (bool)
        {
          ...
          paramToServiceMsg.jdField_b_of_type_JavaLangString = "send_file_suc";
        ...
        return;
        if (FileManagerUtil.a(paramToServiceMsg.fileName) == 0)
        {
          if ((paramToServiceMsg.strThumbPath == null) || (paramToServiceMsg.strThumbPath.length() < 1))
          {
        ...
        else if ((FileManagerUtil.a(paramToServiceMsg.fileName) == 2) && ((paramToServiceMsg.strThumbPath == null) || (paramToServiceMsg.strThumbPath.length() < 1)))
        {
          str2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramToServiceMsg, 2);
          if (str2 != null) {
            paramToServiceMsg.strThumbPath = str2;
          }
        }
    ...
    for (;;)
    {
      try
      {
        ...
        if (localRspBody.msg_delete_file_rsp.has())
        {
          ...
          bool = false;
          QLog.i("FileTransferHandler<FileAssistant>", 1, "handleRemoveResponse, bSucess[" + String.valueOf(bool) + "],fileName[" + paramFromServiceMsg.jdField_b_of_type_JavaLangString + "],uuid[" + paramToServiceMsg + "]");
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(bool, 20, new Object[] { Integer.valueOf(i1), localObject, paramToServiceMsg, paramFromServiceMsg.jdField_b_of_type_JavaLangString, Boolean.valueOf(true) });
        }
        return;
      }
      catch (InvalidProtocolBufferMicroException paramToServiceMsg)
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(false, 20, new Object[] { Integer.valueOf(i1), "", paramToServiceMsg, ((WeiYunFileInfo)localObject).jdField_b_of_type_JavaLangString, Boolean.valueOf(true) });
      return;
      label343:
      boolean bool = true;
    }
  ...
  {
    // Byte code:
    //   0: new 686	java/util/ArrayList
    //   3: dup
    //   4: invokespecial 687	java/util/ArrayList:<init>	()V
    //   7: astore 16
    //   9: new 686	java/util/ArrayList
    //   12: dup
    //   13: invokespecial 687	java/util/ArrayList:<init>	()V
    //   16: astore 17
    //   18: aload 17
    //   20: aload_2
    //   21: invokeinterface 1672 2 0
    //   26: pop
    //   27: iconst_0
    //   28: istore 7
    //   30: iload 7
    //   32: aload 17
    //   34: invokeinterface 695 1 0
    //   39: if_icmpge +805 -> 844
    //   42: aload 17
    //   44: iload 7
    //   46: invokeinterface 698 2 0
    //   51: checkcast 1674	msf/msgcomm/msg_comm$Msg
    //   54: astore 18
    //   56: aload 18
    //   58: getfield 1678	msf/msgcomm/msg_comm$Msg:msg_head	Lmsf/msgcomm/msg_comm$MsgHead;
    //   61: invokevirtual 1681	msf/msgcomm/msg_comm$MsgHead:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   64: checkcast 1680	msf/msgcomm/msg_comm$MsgHead
    //   67: astore_1
    //   68: aload 18
    //   70: getfield 1685	msf/msgcomm/msg_comm$Msg:msg_body	Ltencent/im/msg/im_msg_body$MsgBody;
    //   73: invokevirtual 1688	tencent/im/msg/im_msg_body$MsgBody:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   76: checkcast 1687	tencent/im/msg/im_msg_body$MsgBody
    //   79: astore 19
    //   81: aload 18
    //   83: getfield 1678	msf/msgcomm/msg_comm$Msg:msg_head	Lmsf/msgcomm/msg_comm$MsgHead;
    //   86: invokevirtual 1689	msf/msgcomm/msg_comm$MsgHead:has	()Z
    //   89: ifne +68 -> 157
    //   92: invokestatic 255	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   95: ifeq +752 -> 847
    //   98: ldc 11
    //   100: iconst_2
    ...
    //   114: iload 7
    //   116: invokevirtual 328	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   119: ldc_w 1693
    ...
    //   128: invokestatic 269	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   131: iconst_1
    //   132: istore 6
    //   134: iload 6
    //   136: ifeq +12 -> 148
    ...
    //   154: goto -124 -> 30
    //   157: aload_1
    //   158: getfield 1699	msf/msgcomm/msg_comm$MsgHead:msg_seq	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   161: invokevirtual 580	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   164: i2s
    //   165: istore 9
    //   167: aload_1
    //   168: getfield 1702	msf/msgcomm/msg_comm$MsgHead:to_uin	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   171: invokevirtual 956	com/tencent/mobileqq/pb/PBUInt64Field:get	()J
    //   174: pop2
    //   175: aload_1
    //   176: getfield 1705	msf/msgcomm/msg_comm$MsgHead:from_uin	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   179: invokevirtual 956	com/tencent/mobileqq/pb/PBUInt64Field:get	()J
    //   182: lstore 10
    //   184: aload_1
    //   185: getfield 1708	msf/msgcomm/msg_comm$MsgHead:msg_time	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   188: invokevirtual 580	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   191: i2l
    //   192: lstore 12
    //   194: aload_1
    //   195: getfield 1711	msf/msgcomm/msg_comm$MsgHead:msg_uid	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   198: invokevirtual 956	com/tencent/mobileqq/pb/PBUInt64Field:get	()J
    //   201: lstore 14
    //   203: aload_1
    //   204: getfield 1714	msf/msgcomm/msg_comm$MsgHead:msg_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   207: invokevirtual 580	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   210: istore 6
    //   212: aload 18
    //   214: getfield 1678	msf/msgcomm/msg_comm$Msg:msg_head	Lmsf/msgcomm/msg_comm$MsgHead;
    //   217: invokevirtual 1681	msf/msgcomm/msg_comm$MsgHead:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   220: checkcast 1680	msf/msgcomm/msg_comm$MsgHead
    //   223: getfield 1717	msf/msgcomm/msg_comm$MsgHead:c2c_cmd	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   226: invokevirtual 580	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   229: istore 8
    //   231: iload 6
    //   233: invokestatic 1722	com/tencent/mobileqq/service/message/MessageUtils:c	(I)Z
    //   236: ifeq +21 -> 257
    //   239: aload_1
    //   240: getfield 1717	msf/msgcomm/msg_comm$MsgHead:c2c_cmd	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   243: invokevirtual 579	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   246: ifeq +11 -> 257
    //   249: iload 8
    //   251: sipush 169
    ...
    //   274: goto -140 -> 134
    //   277: iload 6
    //   279: invokestatic 1722	com/tencent/mobileqq/service/message/MessageUtils:c	(I)Z
    //   282: ifeq +199 -> 481
    //   285: aload_1
    //   286: getfield 1717	msf/msgcomm/msg_comm$MsgHead:c2c_cmd	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   289: invokevirtual 579	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   292: ifeq +189 -> 481
    //   295: iload 8
    //   297: sipush 169
    //   300: if_icmpne +181 -> 481
    //   303: aload 18
    //   305: getfield 1685	msf/msgcomm/msg_comm$Msg:msg_body	Ltencent/im/msg/im_msg_body$MsgBody;
    //   308: invokevirtual 1723	tencent/im/msg/im_msg_body$MsgBody:has	()Z
    //   311: ifeq +23 -> 334
    //   314: aload 18
    //   316: getfield 1685	msf/msgcomm/msg_comm$Msg:msg_body	Ltencent/im/msg/im_msg_body$MsgBody;
    //   319: invokevirtual 1688	tencent/im/msg/im_msg_body$MsgBody:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   322: checkcast 1687	tencent/im/msg/im_msg_body$MsgBody
    //   325: getfield 1727	tencent/im/msg/im_msg_body$MsgBody:rich_text	Ltencent/im/msg/im_msg_body$RichText;
    //   328: invokevirtual 1730	tencent/im/msg/im_msg_body$RichText:has	()Z
    //   331: ifne +74 -> 405
    //   334: invokestatic 255	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   337: ifeq +510 -> 847
    //   340: ldc 11
    //   342: iconst_2
    //   343: new 195	java/lang/StringBuilder
    //   346: dup
    //   347: invokespecial 196	java/lang/StringBuilder:<init>	()V
    //   350: ldc_w 1732
    //   353: invokevirtual 202	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   356: aload 18
    //   358: getfield 1685	msf/msgcomm/msg_comm$Msg:msg_body	Ltencent/im/msg/im_msg_body$MsgBody;
    //   361: invokevirtual 1723	tencent/im/msg/im_msg_body$MsgBody:has	()Z
    //   364: invokevirtual 267	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   367: ldc_w 1734
    //   370: invokevirtual 202	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   373: aload 18
    //   375: getfield 1685	msf/msgcomm/msg_comm$Msg:msg_body	Ltencent/im/msg/im_msg_body$MsgBody;
    //   378: invokevirtual 1688	tencent/im/msg/im_msg_body$MsgBody:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   381: checkcast 1687	tencent/im/msg/im_msg_body$MsgBody
    //   384: getfield 1727	tencent/im/msg/im_msg_body$MsgBody:rich_text	Ltencent/im/msg/im_msg_body$RichText;
    //   387: invokevirtual 1730	tencent/im/msg/im_msg_body$RichText:has	()Z
    //   390: invokevirtual 267	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   393: invokevirtual 207	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   396: invokestatic 332	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   399: iconst_1
    //   400: istore 6
    //   402: goto -268 -> 134
    //   405: aload 18
    //   407: getfield 1685	msf/msgcomm/msg_comm$Msg:msg_body	Ltencent/im/msg/im_msg_body$MsgBody;
    //   410: invokevirtual 1688	tencent/im/msg/im_msg_body$MsgBody:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   413: checkcast 1687	tencent/im/msg/im_msg_body$MsgBody
    //   416: getfield 1727	tencent/im/msg/im_msg_body$MsgBody:rich_text	Ltencent/im/msg/im_msg_body$RichText;
    //   419: invokevirtual 1735	tencent/im/msg/im_msg_body$RichText:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   422: checkcast 1729	tencent/im/msg/im_msg_body$RichText
    //   425: astore 19
    //   427: aload 19
    //   429: getfield 1739	tencent/im/msg/im_msg_body$RichText:not_online_file	Ltencent/im/msg/im_msg_body$NotOnlineFile;
    //   432: invokevirtual 1742	tencent/im/msg/im_msg_body$NotOnlineFile:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   435: checkcast 1741	tencent/im/msg/im_msg_body$NotOnlineFile
    //   438: astore_1
    //   439: aload 19
    //   441: getfield 1739	tencent/im/msg/im_msg_body$RichText:not_online_file	Ltencent/im/msg/im_msg_body$NotOnlineFile;
    //   444: invokevirtual 1743	tencent/im/msg/im_msg_body$NotOnlineFile:has	()Z
    //   447: ifne +24 -> 471
    //   450: invokestatic 255	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   453: ifeq +394 -> 847
    //   456: ldc 11
    //   458: iconst_2
    //   459: ldc_w 1745
    //   462: invokestatic 332	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   465: iconst_1
    //   466: istore 6
    //   468: goto -334 -> 134
    //   471: aload_1
    ...
    //   495: aload 18
    //   497: getfield 1685	msf/msgcomm/msg_comm$Msg:msg_body	Ltencent/im/msg/im_msg_body$MsgBody;
    //   500: invokevirtual 1688	tencent/im/msg/im_msg_body$MsgBody:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   503: checkcast 1687	tencent/im/msg/im_msg_body$MsgBody
    //   506: getfield 1748	tencent/im/msg/im_msg_body$MsgBody:msg_content	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   509: invokevirtual 939	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   512: invokevirtual 944	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   515: astore_1
    //   516: new 1750	tencent/im/s2c/msgtype0x211/submsgtype0x4/SubMsgType0x4$MsgBody
    //   519: dup
    //   520: invokespecial 1751	tencent/im/s2c/msgtype0x211/submsgtype0x4/SubMsgType0x4$MsgBody:<init>	()V
    //   523: astore 19
    //   525: aload 19
    //   527: aload_1
    //   528: invokevirtual 1752	tencent/im/s2c/msgtype0x211/submsgtype0x4/SubMsgType0x4$MsgBody:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   531: checkcast 1750	tencent/im/s2c/msgtype0x211/submsgtype0x4/SubMsgType0x4$MsgBody
    //   534: astore_1
    //   535: aload_1
    //   536: getfield 1755	tencent/im/s2c/msgtype0x211/submsgtype0x4/SubMsgType0x4$MsgBody:msg_not_online_file	Ltencent/im/msg/im_msg_body$NotOnlineFile;
    //   539: invokevirtual 1743	tencent/im/msg/im_msg_body$NotOnlineFile:has	()Z
    //   542: ifne +70 -> 612
    //   545: invokestatic 255	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   548: ifeq +299 -> 847
    //   551: ldc 11
    //   553: iconst_2
    //   554: ldc_w 1757
    //   557: invokestatic 332	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   560: iconst_1
    //   561: istore 6
    //   563: goto -429 -> 134
    //   566: astore_1
    //   567: invokestatic 255	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   570: ifeq +13 -> 583
    //   573: ldc 11
    //   575: iconst_2
    //   576: ldc_w 1759
    //   579: aload_1
    //   580: invokestatic 1762	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   583: iconst_1
    //   584: istore 6
    //   586: goto -452 -> 134
    //   589: astore_1
    //   590: invokestatic 255	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   593: ifeq +13 -> 606
    //   596: ldc 11
    //   598: iconst_2
    //   599: ldc_w 1764
    //   602: aload_1
    //   603: invokestatic 1762	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   606: iconst_1
    //   607: istore 6
    //   609: goto -475 -> 134
    //   612: aload_1
    //   613: getfield 1755	tencent/im/s2c/msgtype0x211/submsgtype0x4/SubMsgType0x4$MsgBody:msg_not_online_file	Ltencent/im/msg/im_msg_body$NotOnlineFile;
    //   616: invokevirtual 1742	tencent/im/msg/im_msg_body$NotOnlineFile:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   619: checkcast 1741	tencent/im/msg/im_msg_body$NotOnlineFile
    //   622: astore_1
    //   623: goto -152 -> 471
    //   626: aload_1
    //   627: getfield 1767	tencent/im/msg/im_msg_body$NotOnlineFile:bytes_file_name	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   630: invokevirtual 936	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   633: ifne +24 -> 657
    //   636: invokestatic 255	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   639: ifeq +208 -> 847
    //   642: ldc 11
    //   644: iconst_2
    //   645: ldc_w 1769
    //   648: invokestatic 332	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   651: iconst_1
    //   652: istore 6
    //   654: goto -520 -> 134
    //   657: aload_1
    //   658: getfield 1772	tencent/im/msg/im_msg_body$NotOnlineFile:uint32_file_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   661: invokevirtual 580	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   664: istore 6
    //   666: aload_1
    //   667: getfield 1773	tencent/im/msg/im_msg_body$NotOnlineFile:uint64_file_size	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   670: invokevirtual 956	com/tencent/mobileqq/pb/PBUInt64Field:get	()J
    //   673: pop2
    //   674: aload_1
    //   675: getfield 1776	tencent/im/msg/im_msg_body$NotOnlineFile:uint32_subcmd	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   678: invokevirtual 580	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   681: pop
    //   682: iload 5
    //   684: ifeq +15 -> 699
    //   687: iload 6
    ...
    //   700: iconst_0
    //   701: lload_3
    //   702: invokestatic 651	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   705: lload 10
    //   707: invokestatic 651	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   710: lload 12
    //   712: iload 9
    //   714: i2l
    //   715: lload 14
    //   717: invokevirtual 1778	com/tencent/mobileqq/filemanager/app/FileTransferHandler:a	(ILjava/lang/String;Ljava/lang/String;JJJ)Lcom/tencent/mobileqq/data/MessageRecord;
    //   720: astore 19
    //   722: aload 19
    //   724: ifnull +34 -> 758
    //   727: invokestatic 255	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   730: ifeq +12 -> 742
    //   733: ldc 11
    //   735: iconst_2
    //   736: ldc_w 1632
    //   739: invokestatic 269	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   742: aload 16
    //   744: aload 19
    //   746: invokeinterface 701 2 0
    //   751: pop
    //   752: iconst_1
    //   753: istore 6
    //   755: goto -621 -> 134
    ...
    //   759: istore 6
    //   761: aload_1
    //   762: getfield 1781	tencent/im/msg/im_msg_body$NotOnlineFile:uint32_reserved	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   765: invokevirtual 579	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   768: ifeq +28 -> 796
    //   771: aload_1
    //   772: getfield 1781	tencent/im/msg/im_msg_body$NotOnlineFile:uint32_reserved	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   775: invokevirtual 580	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   778: istore 8
    //   780: iload 8
    //   782: istore 6
    //   784: iload 8
    ...
    //   796: aload_0
    //   797: lload_3
    //   798: invokestatic 651	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   801: aload_1
    //   802: getfield 1784	tencent/im/msg/im_msg_body$NotOnlineFile:bytes_file_uuid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   805: invokevirtual 939	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   808: invokevirtual 1260	com/tencent/mobileqq/pb/ByteStringMicro:toStringUtf8	()Ljava/lang/String;
    //   811: iload 6
    //   813: i2l
    //   814: iload 9
    //   816: i2l
    ...
    //   819: aload 16
    //   821: lload 10
    //   823: invokestatic 651	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   826: invokespecial 690	com/tencent/mobileqq/filemanager/app/FileTransferHandler:a	(Ljava/lang/String;Ljava/lang/String;JJJLjava/util/List;Ljava/lang/String;)Z
    //   829: ifeq +9 -> 838
    //   832: iconst_1
    //   833: istore 6
    //   835: goto -701 -> 134
  ...
  public void a(int paramInt, FileManagerEntity paramFileManagerEntity)
  {
    ...
    String str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount().replace("+", "");
    ((cmd0x346.ApplyCopyToReq)localObject).uint64_dst_id.set(Long.parseLong(str1));
    if ((paramInt != 106) && (paramFileManagerEntity.selfUin != null) && (paramFileManagerEntity.selfUin.length() > 0))
    {
      String str2 = paramFileManagerEntity.selfUin.replace("+", "");
      ((cmd0x346.ApplyCopyToReq)localObject).uint64_dst_uin.set(Long.parseLong(str2));
    }
    ((cmd0x346.ApplyCopyToReq)localObject).uint32_dst_svcid.set(paramInt);
    ((cmd0x346.ApplyCopyToReq)localObject).uint64_src_uin.set(Long.parseLong(str1));
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      long l1 = paramInt1;
      new Handler(localLooper).post(new doj(this, l1, paramInt3, paramInt2, paramString));
      return;
    }
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    {
      long l1 = paramInt1;
      new Handler(localLooper).post(new doi(this, l1, paramInt2, paramString2, paramString1));
      return;
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("FileTransferHandler<FileAssistant>", 2, "PreviewOfflineVideo : FileUUID[" + paramString + "]");
    }
    ToServiceMsg localToServiceMsg = a("OfflineFilleHandleSvr.pb_ftn_CMD_REQ_APPLY_DOWNLOAD_ABS-1100");
    Object localObject = new cmd0x346.ApplyDownloadAbsReq();
    ((cmd0x346.ApplyDownloadAbsReq)localObject).uint64_uin.set(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a()));
    ...
    paramString.uint32_client_type.set(104);
    localToServiceMsg.putWupBuffer(paramString.toByteArray());
    localToServiceMsg.extraData.putBoolean("_IS_VIDEO_THUMB_", true);
    localToServiceMsg.extraData.putLong("_CONTEXT_", paramLong);
    a(localToServiceMsg, true);
  }
  ...
  public void a(String paramString1, long paramLong1, int paramInt, String paramString2, long paramLong2)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new dok(this, paramLong1, paramString1, paramInt, paramString2, paramLong2));
      return;
    }
  ...
  public void a(String paramString, long paramLong, boolean paramBoolean)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new dog(this, paramLong, paramBoolean, paramString));
      return;
    }
  ...
  public void a(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    paramString3 = a("OfflineFilleHandleSvr.pb_ftn_CMD_REQ_DELETE_FILE-900");
    paramString3.extraData.putString("Context", paramString2);
    if (paramBoolean) {
      i1 = 1;
    }
    cmd0x346.DeleteFileReq localDeleteFileReq = new cmd0x346.DeleteFileReq();
    localDeleteFileReq.uint64_uin.set(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a()));
    localDeleteFileReq.uint64_peer_uin.set(Long.parseLong(paramString1));
    localDeleteFileReq.uint32_delete_type.set(i1);
    localDeleteFileReq.bytes_uuid.set(ByteStringMicro.copyFrom(paramString2.getBytes()));
    paramString1 = new cmd0x346.ReqBody();
    paramString1.msg_delete_file_req.set(localDeleteFileReq);
    ...
    paramString1.uint32_business_id.set(3);
    paramString1.uint32_client_type.set(104);
    paramString3.putWupBuffer(paramString1.toByteArray());
    a(paramString3, true);
  }
  
  public void a(String paramString, boolean paramBoolean, FileTransferObserver paramFileTransferObserver)
  {
    QLog.d("FileTransferHandler<FileAssistant>", 1, "getDownloadInfo : FileUUID[" + paramString + "], bSelfSend[" + paramBoolean + "]");
  ...
  public void b(int paramInt1, String paramString1, String paramString2, long paramLong1, short paramShort, boolean paramBoolean, int paramInt2, String paramString3, OnlineFileSessionInfo paramOnlineFileSessionInfo, long paramLong2)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new doe(this, paramInt1, paramString1, paramString2, paramLong1, paramShort, paramBoolean, paramInt2, paramString3, paramOnlineFileSessionInfo, paramLong2));
      return;
    }
  ...
  public void b(String paramString, long paramLong, boolean paramBoolean)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new doh(this, paramLong, paramBoolean, paramString));
      return;
    }
  ...
  public void c(String paramString, long paramLong)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new dof(this, paramLong, paramString));
      return;
    }
