...
public class FileManagerEngine
{
  ...
  private void b(long paramLong)
  {
    ...
    do
    {
      ...
      return;
      b(localFileManagerEntity, localFileManagerEntity.nOpType);
      return;
      if (localFileManagerEntity.cloudType == 0)
      {
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      a(((FileInfo)FMDataCache.b().get(j)).d(), paramString1, paramString2, paramInt, true).strApkPackageName = ((FileInfo)FMDataCache.b().get(j)).c();
      j += 1;
    }
  }
  ...
  public void h()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("OfflineFileConfig", 0).edit().putBoolean("HasNewDownload", false).commit();
  }
  
  public void i()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("OfflineFileConfig", 0).edit().putBoolean("HasNewDownload", true).commit();
  }
}
