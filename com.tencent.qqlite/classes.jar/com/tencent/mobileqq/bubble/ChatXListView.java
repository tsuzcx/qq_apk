  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (this.jdField_b_of_type_Float = paramMotionEvent.getY();; this.jdField_b_of_type_Float = -1.0F)
    {
      ...
      do
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView$OnBottomOverScrollListener.X();
          this.jdField_b_of_type_Float = -1.0F;
        }
      } while ((i != 1) && (i != 3));
      this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView$OnBottomOverScrollListener.Y();
    }
  }
