  ...
  extends BaseProtocolCoder
{
  ...
  private void a(int paramInt, byte paramByte1, long paramLong, short paramShort1, short paramShort2, byte paramByte2, byte paramByte3, byte paramByte4, byte paramByte5, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        paramUniPacket.put("FL", new GetFriendListReq(paramInt, paramByte1, paramLong, paramShort1, paramShort2, paramByte2, paramByte3, paramByte4, paramByte5, (byte)0, (byte)1, 5L, null));
        return;
      }
    }
  }
  ...
  private boolean g(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    byte[] arrayOfByte;
    byte b1;
    if (((i == 2007) || (i == 3007) || (i == 2017) || (i != 3017)) || (i == 3016))
    {
  ...
  private boolean m(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localGetFriendListReq.version = 5L;
  ...
  private boolean n(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (int i = 0;; i = 1)
    {
      paramToServiceMsg = new GetFriendListReq(3, (byte)i, Long.valueOf(paramToServiceMsg.getUin()).longValue(), s1, s2, (byte)0, (byte)i, b1, b2, (byte)0, b3, 5L, null);
      paramUniPacket.setServantName("mqq.IMService.FriendListServiceServantObj");
      paramUniPacket.setFuncName("GetFriendListReq");
  ...
  private boolean q(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    //   13: new 651	friendlist/SetGroupReq
    //   16: dup
    //   17: invokespecial 652	friendlist/SetGroupReq:<init>	()V
    //   20: astore 4
    //   22: aload 4
    //   24: aload_1
    ...
    //   31: putfield 653	friendlist/SetGroupReq:uin	J
    //   34: aload 4
    //   36: aload_1
    ...
    //   46: putfield 656	friendlist/SetGroupReq:reqtype	I
    //   49: new 493	java/io/ByteArrayOutputStream
    //   52: dup
    //   53: bipush 10
    //   55: invokespecial 496	java/io/ByteArrayOutputStream:<init>	(I)V
    //   58: astore 5
    //   60: new 498	java/io/DataOutputStream
    //   63: dup
    //   64: aload 5
    //   66: invokespecial 501	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   69: astore 6
    //   71: aload 4
    //   73: getfield 656	friendlist/SetGroupReq:reqtype	I
    //   76: tableswitch	default:+371 -> 447, 0:+32->108, 1:+140->216, 2:+225->301, 3:+262->338
    //   109: iconst_m1
    //   110: i2c
    //   111: dup
    //   112: invokespecial 659	friendlist/AddGroup:<init>	()V
    //   115: astore 7
    //   117: aload 7
    //   119: aload_1
    ...
    //   129: putfield 664	friendlist/AddGroup:cSortId	B
    //   132: aload 7
    //   134: aload_1
    ...
    //   144: putfield 669	friendlist/AddGroup:sGroupName	Ljava/lang/String;
    //   147: aload 7
    //   149: getfield 669	friendlist/AddGroup:sGroupName	Ljava/lang/String;
    //   152: invokevirtual 336	java/lang/String:getBytes	()[B
    //   155: astore_1
    //   156: aload 7
    //   158: aload_1
    //   159: arraylength
    //   160: i2b
    //   161: putfield 672	friendlist/AddGroup:cLen	B
    //   164: aload 6
    //   166: aload 7
    //   168: getfield 664	friendlist/AddGroup:cSortId	B
    //   171: invokevirtual 504	java/io/DataOutputStream:writeByte	(I)V
    //   174: aload 6
    //   176: aload 7
    //   178: getfield 672	friendlist/AddGroup:cLen	B
    //   181: invokevirtual 504	java/io/DataOutputStream:writeByte	(I)V
    //   184: aload 6
    //   186: aload_1
    //   187: invokevirtual 675	java/io/DataOutputStream:write	([B)V
    //   190: aload 6
    //   192: invokevirtual 513	java/io/DataOutputStream:close	()V
    //   195: aload 4
    //   197: aload 5
    //   199: invokevirtual 514	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   202: putfield 676	friendlist/SetGroupReq:vecBody	[B
    //   205: aload_2
    //   206: ldc_w 649
    //   209: aload 4
    ...
    //   214: iconst_1
    //   215: ireturn
    //   216: new 678	friendlist/RenameGroup
    //   219: dup
    //   220: invokespecial 679	friendlist/RenameGroup:<init>	()V
    //   223: astore 7
    //   225: aload 7
    //   227: aload_1
    ...
    //   237: putfield 682	friendlist/RenameGroup:cGroupId	B
    //   240: aload 7
    //   242: aload_1
    ...
    //   252: putfield 683	friendlist/RenameGroup:sGroupName	Ljava/lang/String;
    //   255: aload 7
    //   257: getfield 683	friendlist/RenameGroup:sGroupName	Ljava/lang/String;
    //   260: invokevirtual 336	java/lang/String:getBytes	()[B
    //   263: astore_1
    //   264: aload 7
    //   266: aload_1
    //   267: arraylength
    //   268: i2b
    //   269: putfield 684	friendlist/RenameGroup:cLen	B
    //   272: aload 6
    //   274: aload 7
    //   276: getfield 682	friendlist/RenameGroup:cGroupId	B
    //   279: invokevirtual 686	java/io/DataOutputStream:write	(I)V
    //   282: aload 6
    //   284: aload 7
    //   286: getfield 684	friendlist/RenameGroup:cLen	B
    //   289: invokevirtual 504	java/io/DataOutputStream:writeByte	(I)V
    //   292: aload 6
    //   294: aload_1
    //   295: invokevirtual 675	java/io/DataOutputStream:write	([B)V
    //   298: goto -108 -> 190
    //   301: new 688	friendlist/DelGroup
    //   304: dup
    //   305: invokespecial 689	friendlist/DelGroup:<init>	()V
    //   308: astore 7
    //   310: aload 7
    //   312: aload_1
    ...
    //   322: putfield 690	friendlist/DelGroup:cGroupId	B
    //   325: aload 6
    //   327: aload 7
    //   329: getfield 690	friendlist/DelGroup:cGroupId	B
    //   332: invokevirtual 504	java/io/DataOutputStream:writeByte	(I)V
    //   335: goto -145 -> 190
    //   338: new 692	friendlist/ReSortGroup
    //   341: dup
    //   342: invokespecial 693	friendlist/ReSortGroup:<init>	()V
    //   345: astore 7
    //   347: aload 7
    //   349: aload_1
    ...
    //   359: putfield 697	friendlist/ReSortGroup:cGroupId	[B
    //   362: aload 7
    //   364: aload_1
    ...
    //   374: putfield 701	friendlist/ReSortGroup:cSortId	[B
    //   377: aload 7
    //   379: aload 7
    //   381: getfield 697	friendlist/ReSortGroup:cGroupId	[B
    //   384: arraylength
    //   385: i2b
    //   386: putfield 704	friendlist/ReSortGroup:cNum	B
    //   389: aload 6
    //   391: aload 7
    //   393: getfield 704	friendlist/ReSortGroup:cNum	B
    //   396: invokevirtual 504	java/io/DataOutputStream:writeByte	(I)V
    //   399: aload 7
    //   401: getfield 697	friendlist/ReSortGroup:cGroupId	[B
    //   404: astore_1
    //   405: aload 7
    //   407: getfield 701	friendlist/ReSortGroup:cSortId	[B
    //   410: astore 7
    //   412: iconst_0
    //   413: istore_3
    //   414: iload_3
    ...
    //   423: iload_3
    //   424: baload
    //   425: invokevirtual 504	java/io/DataOutputStream:writeByte	(I)V
    //   428: aload 6
    //   430: aload 7
    //   432: iload_3
    //   433: baload
    //   434: invokevirtual 504	java/io/DataOutputStream:writeByte	(I)V
    //   437: iload_3
    //   438: iconst_1
    //   439: iadd
    //   440: istore_3
