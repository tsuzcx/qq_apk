...
public class MessageFactoryReceiver
{
  ...
  {
    return (FileDeleteResp)a(paramFromServiceMsg.getWupBuffer(), "FileDeleteResp", new FileDeleteResp());
  }
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if ("MessageSvc.SetRoamMsg".equalsIgnoreCase(str)) {
    ...
    if ("TransService.FileDeleteReq".equals(str)) {
