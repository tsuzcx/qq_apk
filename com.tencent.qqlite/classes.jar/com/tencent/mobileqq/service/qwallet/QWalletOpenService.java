...
{
  private static final String jdField_a_of_type_JavaLangString = "QWalletOpenService";
  ...
  private Object b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    catch (RuntimeException paramToServiceMsg)
    {
      if (QLog.isDevelopLevel()) {
        QLog.d("QWalletOpenService", 4, "decodeRecommentWUP error:" + paramToServiceMsg.getMessage());
      }
      return null;
    }
