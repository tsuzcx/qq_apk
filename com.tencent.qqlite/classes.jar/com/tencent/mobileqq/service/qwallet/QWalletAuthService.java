...
{
  private static final String jdField_a_of_type_JavaLangString = "QWalletAuthService";
  ...
  private Object b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    catch (RuntimeException paramToServiceMsg)
    {
      if (QLog.isDevelopLevel()) {
        QLog.d("QWalletAuthService", 4, "decodeModifyPassAuthWUP error:" + paramToServiceMsg.getMessage());
      }
      return null;
    }
