...
{
  private static String[] a = { "QzoneService" };
  ...
  private byte[] a(byte[] paramArrayOfByte)
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: new 140	java/io/ByteArrayInputStream
    //   5: dup
    //   6: aload_1
    //   7: invokespecial 142	java/io/ByteArrayInputStream:<init>	([B)V
    //   10: astore_3
    //   11: new 144	java/io/DataInputStream
    //   14: dup
    //   15: aload_3
    //   16: invokespecial 147	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   19: astore 4
    //   21: aload_2
    //   22: astore_1
    //   23: aload 4
    //   25: invokevirtual 150	java/io/DataInputStream:readInt	()I
    //   28: iconst_4
    //   29: isub
    //   30: newarray byte
    //   32: astore_2
    ...
    //   35: aload 4
    //   37: aload_2
    //   38: invokevirtual 154	java/io/DataInputStream:read	([B)I
    //   41: pop
    //   42: aload_3
    //   43: invokevirtual 157	java/io/ByteArrayInputStream:close	()V
    //   46: aload 4
    //   48: invokevirtual 158	java/io/DataInputStream:close	()V
    //   51: aload_2
    //   52: areturn
    //   53: astore_2
    //   54: aload_3
    //   55: invokevirtual 157	java/io/ByteArrayInputStream:close	()V
    //   58: aload 4
    //   60: invokevirtual 158	java/io/DataInputStream:close	()V
    //   63: aload_1
    //   64: areturn
    //   65: astore_2
    //   66: aload_1
    ...
    //   68: astore_1
    //   69: aload_3
    //   70: invokevirtual 157	java/io/ByteArrayInputStream:close	()V
    //   73: aload 4
    //   75: invokevirtual 158	java/io/DataInputStream:close	()V
    //   78: aload_1
    //   79: athrow
    //   80: astore_2
    //   81: goto -3 -> 78
  ...
  {
    // Byte code:
    //   0: new 183	java/io/ByteArrayOutputStream
    //   3: dup
    //   4: invokespecial 184	java/io/ByteArrayOutputStream:<init>	()V
    //   7: astore_2
    //   8: new 186	java/io/DataOutputStream
    //   11: dup
    //   12: aload_2
    //   13: invokespecial 189	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   16: astore_3
    //   17: aload_3
    //   18: aload_1
    //   19: arraylength
    //   20: iconst_4
    //   21: iadd
    //   22: invokevirtual 193	java/io/DataOutputStream:writeInt	(I)V
    //   25: aload_3
    //   26: aload_1
    //   27: invokevirtual 196	java/io/DataOutputStream:write	([B)V
    //   30: aload_2
    //   31: invokevirtual 199	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   34: astore_1
    //   35: aload_2
    //   36: invokevirtual 200	java/io/ByteArrayOutputStream:close	()V
    //   39: aload_3
    //   40: invokevirtual 201	java/io/DataOutputStream:close	()V
    //   43: aload_1
    //   44: areturn
    //   45: astore_1
    //   46: aload_2
    //   47: invokevirtual 200	java/io/ByteArrayOutputStream:close	()V
    //   50: aload_3
    //   51: invokevirtual 201	java/io/DataOutputStream:close	()V
    //   54: aconst_null
    //   55: areturn
    //   56: astore_1
    //   57: aconst_null
    ...
    //   59: astore_1
    //   60: aload_2
    //   61: invokevirtual 200	java/io/ByteArrayOutputStream:close	()V
    //   64: aload_3
    //   65: invokevirtual 201	java/io/DataOutputStream:close	()V
    //   68: aload_1
    //   69: athrow
    //   70: astore_2
    //   71: goto -3 -> 68
