  ...
  extends BaseProtocolCoder
{
  ...
  private boolean B(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    label206:
    for (localGroupMngReq.wSourceID = 16;; localGroupMngReq.wSourceID = 17)
    {
  ...
  private boolean t(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    Object localObject = localFriendManager.c((String)localObject);
    if (localObject != null) {}
  ...
  private boolean y(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localGroupMngReq.vecBody = localByteBuffer.array();
    localGroupMngReq.wSourceSubID = paramToServiceMsg.extraData.getInt("stat_option");
