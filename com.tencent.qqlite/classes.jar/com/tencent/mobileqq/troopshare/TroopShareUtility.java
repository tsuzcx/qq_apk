  ...
  implements WXShareHelper.WXShareListener
{
  ...
  private TroopObserver jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new eri(this);
  ...
  public static Bitmap a(String paramString, Resources paramResources)
  {
    ...
    catch (OutOfMemoryError paramString)
    {
      ...
      paramResources = BitmapFactory.decodeResource(paramResources, 2130838023);
  ...
  private void h()
  {
    ...
    if (this.jdField_e_of_type_Int == 1)
    {
      ...
      default: 
        ...
        {
          QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131362785), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
          if (QLog.isColorLevel()) {
  ...
  private void i()
  {
    ...
    str1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363712), new Object[] { str1 }) + "(" + this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.jdField_c_of_type_JavaLangString + ")";
  ...
  private void j()
  {
    ...
    localObject = a(BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources(), 2130838305));
    String str2 = a();
  ...
  private void k()
  {
    ...
    localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363706);
    AbsShareMsg localAbsShareMsg = new AbsShareMsg.Builder(StructMsgForGeneralShare.class).c(15).a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363705) + (String)localObject1).e(a()).a((String)localObject2, null).a();
    ...
    {
      localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363709);
    }
  ...
  private void l()
  {
    ...
    str1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363707), new Object[] { str1, a() });
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363708), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
      this.jdField_d_of_type_Int = -1;
      this.jdField_e_of_type_Int = -1;
      return;
  ...
  public void a(BaseResp paramBaseResp)
  {
    ...
    case -1: 
    default: 
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363695), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
      return;
    }
    QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363694), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
  }
  ...
  protected void c()
  {
    ...
    {
      localObject = new erd(this);
      ere localere = new ere(this);
      erf localerf = new erf(this);
      this.jdField_a_of_type_ComTencentWidgetActionSheet = ActionSheetAdapter.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentWidgetActionSheetAdapter, (AdapterView.OnItemClickListener)localObject, localere, localerf, false);
    }
  ...
  public void d()
  {
    ...
    this.jdField_b_of_type_ComTencentWidgetActionSheet.c(2131363701);
    this.jdField_b_of_type_ComTencentWidgetActionSheet.c(2131363702);
    this.jdField_b_of_type_ComTencentWidgetActionSheet.d(2131362790);
    this.jdField_b_of_type_ComTencentWidgetActionSheet.setOnDismissListener(new erg(this));
    this.jdField_b_of_type_ComTencentWidgetActionSheet.a(new erh(this));
    String str;
    switch (this.jdField_d_of_type_Int)
    {
    default: 
      str = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363700);
    }
    for (;;)
    {
      ...
      return;
      str = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363697), new Object[] { this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363698) });
      continue;
      str = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363697), new Object[] { this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363699) });
      continue;
      str = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363697), new Object[] { this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363692) });
    }
  }
  ...
  public void g()
  {
    ...
    localIntent.putExtra("title", this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131362427));
