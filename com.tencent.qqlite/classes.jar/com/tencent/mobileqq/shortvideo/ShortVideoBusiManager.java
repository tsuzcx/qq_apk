...
public class ShortVideoBusiManager
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, FileMsg paramFileMsg, TransferRequest paramTransferRequest)
  {
    ...
    } while (((localMessageForShortVideo.videoFileStatus == 1002) || (localMessageForShortVideo.videoFileStatus == 2002)) && (((localMessageForShortVideo.videoFileStatus == paramFileMsg.B) && (i - j < 10)) || (((localMessageForShortVideo.videoFileStatus == 2004) || (localMessageForShortVideo.videoFileStatus == 1004)) && ((paramFileMsg.B == 1002) || (paramFileMsg.B == 2002)))));
    localMessageForShortVideo.videoFileStatus = paramFileMsg.B;
    localMessageForShortVideo.fileType = paramFileMsg.jdField_e_of_type_Int;
    localMessageForShortVideo.videoFileProgress = i;
    if (paramFileMsg.B == 1003)
    {
    ...
    for (;;)
    {
      ...
      if ((paramFileMsg.B == 1003) || (paramFileMsg.B == 2003))
      {
  ...
  public static void a(ShortVideoReq paramShortVideoReq, QQAppInterface paramQQAppInterface)
  {
    ...
    localBaseShortVideoOprerator.b = paramShortVideoReq.b;
