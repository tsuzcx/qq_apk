  ...
  extends EntityManager
{
  ...
  public List a(String paramString, String[] paramArrayOfString, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((paramString != null) && (paramString.size() > 0))
    {
      ...
      {
        paramArrayOfString = (MessageRecord)paramString.get(i);
        if (paramArrayOfString.msgtype == -2009)
        {
          paramString.remove(paramArrayOfString);
          i -= 1;
        }
        for (;;)
        {
          i += 1;
          break;
          paramQQAppInterface.a().a(paramArrayOfString.frienduin, paramArrayOfString.istroop, paramArrayOfString);
        }
      }
    }
    return paramString;
