...
public class DBUtils
{
  ...
  public int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    return ((RoamSettingManager)paramQQAppInterface.getManager(36)).a(paramString, 0);
  }
  ...
  public Map a(List paramList, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (RoamSettingManager)paramQQAppInterface.getManager(36);
    int i = 0;
    if (i < paramList.size())
    {
  ...
  public void a(int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    ((RoamSettingManager)paramQQAppInterface.getManager(36)).a(paramInt);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, Context paramContext)
  {
    ...
    paramString2.commit();
    ((RoamSettingManager)paramQQAppInterface.getManager(36)).a(paramString1);
  }
  ...
  public void a(ArrayList paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      RoamSettingManager localRoamSettingManager = (RoamSettingManager)paramQQAppInterface.getManager(36);
      int i = 0;
      if (i < paramArrayList.size())
      {
