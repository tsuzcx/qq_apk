...
public class ShortcutUtils
{
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    paramString.putExtra("android.intent.extra.shortcut.NAME", paramActivity.getResources().getString(2131362782));
    paramString.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", Intent.ShortcutIconResource.fromContext(paramActivity.getApplicationContext(), 2130838052));
  ...
  {
    new evu(paramContext, paramString).run();
  }
