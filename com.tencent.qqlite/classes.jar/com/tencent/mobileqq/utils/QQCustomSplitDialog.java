  ...
  extends Dialog
{
  ...
  private BaseAdapter jdField_a_of_type_AndroidWidgetBaseAdapter = new evi(this);
  ...
  public QQCustomSplitDialog a(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.c.setOnClickListener(new evj(this, paramOnClickListener));
    return this;
  }
  ...
  public QQCustomSplitDialog b(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.c.setVisibility(0);
    this.c.setOnClickListener(new evl(this, paramOnClickListener));
    return this;
  }
  ...
  public QQCustomSplitDialog b(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.d.setOnClickListener(new evk(this, paramOnClickListener));
    return this;
  }
  ...
  public QQCustomSplitDialog c(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.d.setVisibility(0);
    this.d.setOnClickListener(new evm(this, paramOnClickListener));
    return this;
  }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131296919));
  }
