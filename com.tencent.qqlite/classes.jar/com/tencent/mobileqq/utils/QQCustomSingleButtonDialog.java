  ...
  extends Dialog
{
  ...
  private BaseAdapter jdField_a_of_type_AndroidWidgetBaseAdapter = new euu(this);
  ...
  public QQCustomSingleButtonDialog a(int paramInt1, int paramInt2, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new euw(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomSingleButtonDialog a(Drawable paramDrawable, boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (paramInt == 2)
      {
        this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130838037);
        return this;
      }
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130838038);
      return this;
    }
  ...
  public QQCustomSingleButtonDialog a(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.d.setOnClickListener(new euv(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomSingleButtonDialog b(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.d.setVisibility(0);
    this.d.setOnClickListener(new eux(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.c = ((TextView)findViewById(2131296929));
    this.f = ((TextView)findViewById(2131296925));
    this.e = ((TextView)findViewById(2131296926));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131296928));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131296927);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131296918));
