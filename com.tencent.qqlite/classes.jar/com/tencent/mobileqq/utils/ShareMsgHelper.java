  ...
  implements AppConstants
{
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, int paramInt)
  {
    ...
    localIntent.putExtra("category", paramContext.getString(2131362443));
    ...
    for (;;)
    {
      ...
      localIntent.putExtra("app_name", paramContext.getString(2131362444));
      localIntent.putExtra("brief_key", String.format(paramContext.getString(2131362446), new Object[] { paramString6, paramString2 }));
