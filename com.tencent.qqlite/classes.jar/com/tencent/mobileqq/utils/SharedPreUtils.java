...
public class SharedPreUtils
{
  ...
  public static void a(Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putInt(paramString2 + paramString1, paramInt);
    paramContext.commit();
  }
  ...
  {
    if ((paramString1 == null) || (paramString1.length() == 0) || (paramContext == null)) {}
    while (paramInt <= PreferenceManager.getDefaultSharedPreferences(paramContext).getInt(paramString2 + paramString1, 0)) {
      return false;
    }
    return true;
  }
