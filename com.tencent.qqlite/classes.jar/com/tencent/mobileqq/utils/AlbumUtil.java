...
public class AlbumUtil
{
  ...
  public static List a(Context paramContext, String paramString1, String paramString2, IMediaFilter paramIMediaFilter)
  {
    if ((paramString2 == null) || ("$RecentAlbumId".equals(paramString1))) {
      paramContext = a(paramContext, 210, 100, paramIMediaFilter);
    }
    do
    {
      do
  ...
  public static List b(Context paramContext, int paramInt1, int paramInt2, IMediaFilter paramIMediaFilter)
  {
    ...
    //   21: invokespecial 259	java/util/ArrayList:<init>	()V
    //   24: astore 5
    //   26: getstatic 479	android/provider/MediaStore$Video$Media:EXTERNAL_CONTENT_URI	Landroid/net/Uri;
    ...
    //   85: iload_2
    //   86: aload_3
    //   87: invokestatic 481	com/tencent/mobileqq/utils/AlbumUtil:a	(Landroid/database/Cursor;Ljava/util/List;ILcom/tencent/mobileqq/activity/photo/IMediaFilter;)Ljava/util/List;
    //   90: pop
    //   91: aload 4
    //   93: ifnull +10 -> 103
    //   96: aload 4
  ...
  public static List b(Context paramContext, String paramString1, String paramString2, IMediaFilter paramIMediaFilter)
  {
    ...
    //   18: bipush 100
    //   20: aload_3
    //   21: invokestatic 483	com/tencent/mobileqq/utils/AlbumUtil:b	(Landroid/content/Context;IILcom/tencent/mobileqq/activity/photo/IMediaFilter;)Ljava/util/List;
    //   24: areturn
    ...
    //   65: getstatic 479	android/provider/MediaStore$Video$Media:EXTERNAL_CONTENT_URI	Landroid/net/Uri;
    ...
    //   84: iconst_m1
    //   85: aload_3
    //   86: invokestatic 481	com/tencent/mobileqq/utils/AlbumUtil:a	(Landroid/database/Cursor;Ljava/util/List;ILcom/tencent/mobileqq/activity/photo/IMediaFilter;)Ljava/util/List;
    //   89: pop
    //   90: aload_1
    //   91: ifnull +72 -> 163
    //   94: aload_1
    ...
    //   120: ldc_w 485
    //   123: aload_2
    //   124: invokestatic 487	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   127: aload_1
    //   128: ifnull +35 -> 163
    //   131: aload_1
