...
public class AntiphishingUrlConfig
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new cqw(this);
  ...
  public void a(int paramInt, String paramString1, String paramString2, Context paramContext)
  {
    ...
    new cqx(this, paramContext, paramString1, paramString2).start();
  }
  ...
  public boolean a()
  {
    ...
    try
    {
      SAXParserFactory.newInstance().newSAXParser().parse(new InputSource(new InputStreamReader(new FileInputStream((File)localObject), "UTF-8")), localcqy);
      this.jdField_a_of_type_Int = localcqy.a();
      this.jdField_a_of_type_JavaUtilArrayList = localcqy.a();
      return true;
    }
