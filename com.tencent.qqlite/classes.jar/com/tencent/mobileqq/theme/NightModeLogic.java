...
public class NightModeLogic
{
  ...
  private void showDownloadDialog()
  {
    ...
    this.downloadDialog = newCustomDialog(2131363265, 2131363266, 2131362790, 2131363447, (float)Math.round(getNightThemeInfo().size / 1024.0D / 1024.0D * 100.0D) / 100.0F + "", new NightModeLogic.1(this), new NightModeLogic.2(this));
  ...
  public void buildBaseNightInfo()
  {
    ...
    String str = ThemeUtil.getThemeDensity(this.mRuntime.getApplication().getApplicationContext());
    String[] arrayOfString;
    if ("m".equals(str)) {
      arrayOfString = "http://i.gtimg.cn/qqshow/admindata/comdata/vip_mobile_theme_lite_night/1103_10503024.zip,301551,10503024".split(",");
    }
    for (;;)
    {
      this.nighThemeInfo.downloadUrl = arrayOfString[0].trim();
      this.nighThemeInfo.size = Long.parseLong(arrayOfString[1].trim());
      this.nighThemeInfo.version = arrayOfString[2].trim();
      if (QLog.isColorLevel()) {
        QLog.i("ThemeSwitch", 2, "night theme density=" + str + ",size=" + this.nighThemeInfo.size + ",ver=" + this.nighThemeInfo.version + ",url=" + this.nighThemeInfo.downloadUrl);
      }
      return;
      if ("h".equals(str)) {
        arrayOfString = "http://i.gtimg.cn/qqshow/admindata/comdata/vip_mobile_theme_lite_night/1103_10503024.zip,301551,10503024".split(",");
