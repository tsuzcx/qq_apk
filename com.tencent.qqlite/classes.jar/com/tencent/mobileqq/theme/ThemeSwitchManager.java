...
public class ThemeSwitchManager
{
  ...
  Runnable checkTopActivity;
  WeakReference currActivityRef;
  String currDownloadingThemeId = "";
  ...
  void failAlert(Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
    ...
    if ((i & 0x100) == 256)
    {
      ...
      QQToast.a(this.mContext, 1, this.mContext.getResources().getString(2131363269), 0).b(this.mContext.getResources().getDimensionPixelSize(2131492887));
  ...
  String[] getTopActivity(Context paramContext)
  {
  ...
  void notifyCallbacks(boolean paramBoolean1, boolean paramBoolean2, Bundle paramBundle)
  {
  ...
  public void startDownload(AppRuntime paramAppRuntime, ThemeUtil.ThemeInfo paramThemeInfo)
  {
    ...
    if (isDownloadingInProgress)
    {
      ...
      if ((this.currDownloadingThemeId.equals(str2)) && (localThemeInfo != null) && (str1.equals(localThemeInfo.version)))
      {
        if (QLog.isColorLevel()) {
