  ...
  extends TransProcessorHandler
{
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (localObject1 != null)
    {
      ...
      if ((!TextUtils.isEmpty(paramMessage)) && (paramMessage.startsWith(AppConstants.bj))) {
        break label147;
      }
      if (QLog.isColorLevel()) {
        QLog.d("ThemeSwitch", 2, "not download theme file message" + AppConstants.bj);
      }
    }
    label147:
    label1450:
            ...
            else
            {
              ...
              if (QLog.isColorLevel())
              {
                ...
                try
                {
                  ...
                  else if ((!localObject2[0].equals(this.this$0.mContext.getPackageName())) || (localObject3.equals(AIOGalleryActivity.class.getName())))
                  {
