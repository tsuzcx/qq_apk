  ...
  public void endElement(String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if ((!this.jdField_a_of_type_Boolean) && (!this.jdField_a_of_type_JavaLangClass.getSimpleName().equals(paramString2)))
          {
            ...
            if (paramString1 == null)
            {
              ...
              QLog.e("EarlyDown", 2, "endElement() return.can't find 'Field:" + paramString2 + "'.  set isError=true");
              return;
            }
