...
public class SogouEmoji
{
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqEmoticonSogouEmoji$OnEmojiJsonBackSogou = new dfa(this);
  ...
  {
    paramString1 = new dfb(this, paramString1, paramString2, paramBoolean);
  ...
  public void a(String paramString, ArrayList paramArrayList, SogouEmoji.OnEmojiKeyBackSogou paramOnEmojiKeyBackSogou)
  {
    ...
    {
      return;
      paramOnEmojiKeyBackSogou = new dfe(this, paramArrayList, paramOnEmojiKeyBackSogou);
  ...
  {
    paramList = new dfd(this, paramList);
