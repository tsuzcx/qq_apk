...
public class MsfCore
{
  ...
  {
    int i = com.tencent.mobileqq.msf.sdk.n.e();
  ...
  public boolean init(Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      k.c();
      this.netFlowStore = new com.tencent.mobileqq.msf.core.b.c(this, paramContext);
      try
      {
        File localFile;
        label364:
