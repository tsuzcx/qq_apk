...
public class n
{
  ...
  protected boolean a(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    ...
    if (-10106 == i2)
    {
      ...
      com.tencent.mobileqq.msf.core.b.m localm = this.s.statReporter;
      if (true == bool2)
      {
        i1 = 1;
    ...
    for (boolean bool1 = true;; bool1 = bool2)
    {
      for (;;)
      {
        this.s.sender.J.set(true);
        label201:
        if (bool1)
        {
          this.s.getAccountCenter().m(paramFromServiceMsg.getUin());
          if ((!com.tencent.mobileqq.msf.service.g.b()) && ((this.u == -1L) || (System.currentTimeMillis() - this.u > 10000L))) {}
          try
          {
            ...
            break;
            label373:
            if ((paramToServiceMsg != null) && (this.s.sender.I != -1) && (paramToServiceMsg.getRequestSsoSeq() >= this.s.sender.I))
            {
              bool2 = true;
              bool1 = bool2;
              ...
              QLog.d("MSF.C.SSORespHandler", 2, "set userTokenExpired. afterReloadD2SendSeq is " + this.s.sender.I);
              bool1 = bool2;
              break label201;
            }
            bool1 = bool2;
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.getServiceCmd().equals("ConfigPushSvc.PushReq"))
    {
      ...
      paramToServiceMsg = (com.tencent.msf.service.protocol.serverconfig.e)paramToServiceMsg.getByClass("PushReq", new com.tencent.msf.service.protocol.serverconfig.e());
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    while (!paramToServiceMsg.getServiceCmd().equals("MessageSvc.QueryPullUp")) {
      return;
    }
    this.s.pushManager.p().a(paramToServiceMsg, paramFromServiceMsg);
  }
  ...
  public void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      try
      {
        if ("MessageSvc.PbSendMsg".equals(paramFromServiceMsg.getServiceCmd())) {
          p.a(paramToServiceMsg, paramFromServiceMsg);
        }
        for (;;)
        {
          if (paramFromServiceMsg.getServiceCmd().startsWith("SharpSvr."))
          {
            ...
            if ((l.u <= 0L) || (l1 - l.u <= 0L) || (l1 - l.u > 30000L)) {
              break;
            }
            paramFromServiceMsg.addAttribute("__timestamp_msf2net_boot_sharp_c2s", Long.valueOf(l.u));
          }
    ...
    {
      com.tencent.mobileqq.msf.core.net.b.c.d = this.s;
      com.tencent.mobileqq.msf.core.net.b.c.a(paramFromServiceMsg);
