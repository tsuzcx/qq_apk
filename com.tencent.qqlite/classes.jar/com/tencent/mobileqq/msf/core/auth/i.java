...
public class i
{
  ...
  public static void a(MsfCore paramMsfCore, WtloginHelper paramWtloginHelper, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, String paramString, WUserSigInfo paramWUserSigInfo)
  {
    ...
    for (String str = String.valueOf(localWloginSimpleInfo._uin);; str = paramString)
    {
      ...
      f.a(arrayOfByte2, 0, (byte[])localObject, localObject.length);
      localObject = new a(str);
      ((a)localObject).e(arrayOfByte1);
      ((a)localObject).h(arrayOfByte3);
      ((a)localObject).j(arrayOfByte2);
      ((a)localObject).b(new String(arrayOfByte4));
      ((a)localObject).a(arrayOfByte5);
      ((a)localObject).b(arrayOfByte6);
      ((a)localObject).c(paramWUserSigInfo);
      ((a)localObject).d(g.b(paramToServiceMsg));
      if (paramWtloginHelper.GetBasicUserInfo(paramString, localWloginSimpleInfo).booleanValue())
      {
  ...
  public static WUserSigInfo c(int paramInt)
  {
    ...
    //   3: dup
    //   4: invokespecial 562	oicq/wlogin_sdk/request/WUserSigInfo:<init>	()V
    //   7: astore 4
    //   9: aload 4
    //   11: iload_0
    //   12: invokestatic 566	com/tencent/mobileqq/msf/sdk/MsfSdkUtils:convertInt2Bytes	(I)[B
    //   15: putfield 64	oicq/wlogin_sdk/request/WUserSigInfo:_reserveData	[B
    //   18: aload 4
    //   20: astore_3
    //   21: getstatic 603	com/tencent/mobileqq/msf/core/auth/h:c	[Ljava/lang/String;
    //   24: ifnull +86 -> 110
    //   27: aload 4
    //   29: astore_3
    //   30: getstatic 603	com/tencent/mobileqq/msf/core/auth/h:c	[Ljava/lang/String;
    //   33: arraylength
    //   34: ifle +76 -> 110
    //   37: getstatic 603	com/tencent/mobileqq/msf/core/auth/h:c	[Ljava/lang/String;
    //   40: astore 5
    //   42: aload 5
    //   44: arraylength
    //   45: istore_2
    ...
    //   60: astore_3
    //   61: aload 4
    //   63: getfield 607	oicq/wlogin_sdk/request/WUserSigInfo:_domains	Ljava/util/List;
    //   66: aload_3
    //   67: invokeinterface 612 2 0
    //   72: pop
    //   73: iload_1
    //   74: iconst_1
    //   75: iadd
    ...
    //   104: aload_3
    //   105: invokestatic 570	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   108: aconst_null
    //   109: astore_3
    //   110: aload_3
    //   111: areturn
