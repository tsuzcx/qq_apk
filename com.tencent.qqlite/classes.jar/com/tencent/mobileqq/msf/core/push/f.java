  ...
  extends BroadcastReceiver
{
  ...
  public static final String E = "com.tencent.qqlite.msf.receiveofflinepush";
  public static final String F = "com.tencent.qqlite.msf.offlinepushclearall";
  public static final String G = "com.tencent.qqlite.msf.devlockquickloginpushclear";
  public static final String H = "com.tencent.qqlite.msf.receiveofflinepushav";
  public static final String I = "com.tencent.qqlite.msf.offlinepushclearallav";
  static final int K = 20140416;
  ...
  private static final int[] ab = { 1, 1, 1, 5, 5, 10, 10, 30, 30, 60, 60, 900, 900 };
  private static int ac = 0;
  private static final long[] aj = { 100L, 200L, 200L, 100L };
  private static final String ak = "com.tencent.qqlite.broadcast.pcactiveQQ";
  ...
  String N = this.M + "/Tencent/QQLite/";
  String O = "head/";
  String P = this.N + this.O + "_hd/";
  String Q = this.N + this.O + "_thd/";
  String R = this.O + "_hd/";
  String S = this.N + ".billd_urldrawable/";
  String Z = "message.ring.switch";
  String aa = "message.vibrate.switch";
  ...
  private void a(String paramString, int paramInt)
  {
    if (com.tencent.mobileqq.msf.service.c.a())
    {
      ...
      try
      {
        BaseApplication.getContext().unregisterReceiver(this.ap);
        HashMap localHashMap1 = new HashMap();
        localHashMap1.put("uin", paramString);
    ...
    if (paramInt >= com.tencent.mobileqq.msf.core.a.a.w())
    {
      ...
      try
      {
        ...
        localHashMap2.put("uin", paramString);
    ...
    Intent localIntent = new Intent("com.tencent.qqlite.broadcast.qq");
    ...
    this.am = paramString;
    this.an = paramInt;
    localIntent = new Intent("com.tencent.qqlite.broadcast.pcactiveQQ");
    localIntent.putExtra("uin", paramString);
    localIntent.putExtra("retryIndex", paramInt + 1);
    this.ao = PendingIntent.getBroadcast(BaseApplication.getContext(), 0, localIntent, 134217728);
    this.j.set(0, System.currentTimeMillis() + 300000, this.ao);
  }
  ...
  private void c(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localObject2 = new NotificationCompat.Builder(localContext).setContentTitle(str1).setContentText(str2).setAutoCancel(true).setSmallIcon(BaseApplication.appnewmsgicon).setTicker((CharSequence)localObject2).setWhen(System.currentTimeMillis());
      if (localObject1 != null) {
      ...
      for (;;)
      {
        ...
        ((NotificationCompat.Builder)localObject2).setContentIntent(PendingIntent.getBroadcast(localContext, 0, new Intent("com.tencent.qqlite.msf.receiveofflinepush"), 0));
        ((NotificationCompat.Builder)localObject2).setDeleteIntent(PendingIntent.getBroadcast(localContext, 0, new Intent("com.tencent.qqlite.msf.offlinepushclearall"), 0));
        ...
        if ((b(String.valueOf(localPbPushOffMsg.to_uin.get()), localContext) == 1) && (w())) {
          ((Vibrator)localContext.getSystemService("vibrator")).vibrate(aj, -1);
        }
  ...
  private void u()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((i1 < 23) && (i1 < 8)) {}
        ((NotificationCompat.Builder)localObject2).setLights(-16711936, 2000, 2000);
        ((NotificationCompat.Builder)localObject2).setContentIntent(PendingIntent.getBroadcast(localContext, 0, new Intent("com.tencent.qqlite.msf.receiveofflinepushav"), 0));
        ((NotificationCompat.Builder)localObject2).setDeleteIntent(PendingIntent.getBroadcast(localContext, 0, new Intent("com.tencent.qqlite.msf.offlinepushclearallav"), 0));
        localObject1 = ((NotificationCompat.Builder)localObject2).build();
        if (localNotificationManager != null) {
  ...
  public int a(String paramString, Context paramContext)
  {
    ...
    paramString = paramContext.getSharedPreferences(paramString, 0).getString(this.Z, String.valueOf(1));
    try
    {
  ...
  public String a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      localStringBuilder.append((String)localObject + this.R);
      break;
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   6: ifnull +30 -> 36
    //   9: aload_0
    //   10: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   13: invokevirtual 1290	android/media/MediaPlayer:isPlaying	()Z
    //   16: istore_3
    //   17: iload_3
    //   18: ifeq +6 -> 24
    //   21: aload_0
    ...
    //   23: return
    //   24: aload_0
    //   25: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   28: invokevirtual 1293	android/media/MediaPlayer:release	()V
    //   31: aload_0
    //   32: aconst_null
    //   33: putfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   36: iload_1
    //   37: sipush 1000
    //   40: if_icmpeq +82 -> 122
    //   43: aload_0
    //   44: aload_0
    //   45: invokestatic 438	com/tencent/qphone/base/util/BaseApplication:getContext	()Landroid/content/Context;
    //   48: iload_1
    //   49: invokespecial 1295	com/tencent/mobileqq/msf/core/push/f:a	(Landroid/content/Context;I)Landroid/media/MediaPlayer;
    //   52: putfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   55: aload_0
    //   56: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   59: ifnull -38 -> 21
    //   62: aload_0
    //   63: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   66: new 1297	com/tencent/mobileqq/msf/core/push/j
    //   69: dup
    //   70: aload_0
    //   71: invokespecial 1298	com/tencent/mobileqq/msf/core/push/j:<init>	(Lcom/tencent/mobileqq/msf/core/push/f;)V
    //   74: invokevirtual 1302	android/media/MediaPlayer:setOnCompletionListener	(Landroid/media/MediaPlayer$OnCompletionListener;)V
    //   77: aload_0
    //   78: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   81: invokevirtual 1303	android/media/MediaPlayer:start	()V
    //   84: aload_0
    //   85: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   88: iload_2
    //   89: invokevirtual 1306	android/media/MediaPlayer:setLooping	(Z)V
    //   92: goto -71 -> 21
    //   95: astore 4
    //   97: aload_0
    //   98: aconst_null
    //   99: putfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   102: goto -66 -> 36
    //   105: astore 4
    //   107: aload_0
    //   108: monitorexit
    ...
    //   114: aload_0
    //   115: aconst_null
    //   116: putfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   119: aload 4
    //   121: athrow
    //   122: aload_0
    //   123: aload_0
    //   124: invokestatic 438	com/tencent/qphone/base/util/BaseApplication:getContext	()Landroid/content/Context;
    //   127: getstatic 1312	android/provider/Settings$System:DEFAULT_NOTIFICATION_URI	Landroid/net/Uri;
    //   130: invokespecial 1314	com/tencent/mobileqq/msf/core/push/f:a	(Landroid/content/Context;Landroid/net/Uri;)Landroid/media/MediaPlayer;
    //   133: putfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   136: goto -81 -> 55
    //   139: astore 4
    //   141: goto -120 -> 21
    ...
    //   16	2	3	bool	boolean
    //   95	1	4	localException1	Exception
    //   105	5	4	localObject1	Object
    //   112	8	4	localObject2	Object
    //   139	1	4	localException2	Exception
    // Exception table:
    //   from	to	target	type
    //   24	31	95	java/lang/Exception
    //   2	17	105	finally
    //   31	36	105	finally
    //   43	55	105	finally
    //   55	92	105	finally
    ...
    //   122	136	139	java/lang/Exception
  }
  ...
  public void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      this.ae = PendingIntent.getBroadcast(BaseApplication.getContext(), 0, localIntent, 0);
      this.j = ((AlarmManager)BaseApplication.getContext().getSystemService("alarm"));
      this.j.set(0, System.currentTimeMillis() + l1, this.ae);
      if (QLog.isColorLevel()) {
  ...
  public void a(com.tencent.mobileqq.msf.sdk.l paraml, ToServiceMsg paramToServiceMsg)
  {
    try
    {
      ...
      if (!this.h.containsKey(paraml.d())) {
        this.h.putIfAbsent(paraml.d(), new a(paraml.d()));
      }
      Object localObject = (a)this.h.get(paraml.d());
      ((a)localObject).a = paraml.c();
      ((a)localObject).m = paraml.g();
      ((a)localObject).l = paraml.f();
      localObject = com.tencent.mobileqq.msf.core.k.a(paramToServiceMsg);
  ...
  public void a(offlinepush.PbPushOffMsg paramPbPushOffMsg)
  {
    ...
    try
    {
      if (paramPbPushOffMsg.msg_str.has())
      {
        ...
        paramPbPushOffMsg.setContentIntent(PendingIntent.getBroadcast(localContext, 0, new Intent("com.tencent.qqlite.msf.receiveofflinepush"), 0));
        paramPbPushOffMsg.setDeleteIntent(PendingIntent.getBroadcast(localContext, 0, new Intent("com.tencent.qqlite.msf.devlockquickloginpushclear"), 0));
        ...
        if (localObject != null)
        {
          ...
          this.L.removeMessages(20140416);
          this.L.sendEmptyMessageDelayed(20140416, 120000L);
        }
      }
    }
  ...
  public void a(ToServiceMsg paramToServiceMsg, m paramm)
  {
    ...
    if (a(str, BaseApplication.getContext().getPackageName()))
    {
      ...
      if ((locala != null) && (locala.k != null) && (locala.c != 0L) && (locala.k.uin.equals(localPushRegisterInfo.uin)) && (locala.k.iStatus == localPushRegisterInfo.iStatus) && (locala.k.bKikPC == localPushRegisterInfo.bKikPC) && (locala.k.bKikWeak == localPushRegisterInfo.bKikWeak) && (locala.k.timeStamp == localPushRegisterInfo.timeStamp))
      {
        if (QLog.isColorLevel()) {
  ...
  public void a(String paramString, ToServiceMsg paramToServiceMsg)
  {
    try
    {
      ...
      FromServiceMsg localFromServiceMsg = com.tencent.mobileqq.msf.core.k.a(paramToServiceMsg);
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    //   33: putfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   36: aload_0
    //   37: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   40: ifnonnull +14 -> 54
    //   43: aload_0
    //   44: new 472	android/media/MediaPlayer
    //   47: dup
    //   48: invokespecial 473	android/media/MediaPlayer:<init>	()V
    //   51: putfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   54: aload_0
    //   55: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   58: invokevirtual 1636	android/media/MediaPlayer:reset	()V
    //   61: aload_0
    //   62: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   65: new 1638	java/io/FileInputStream
    //   68: dup
    //   69: aload_1
    //   70: invokespecial 1639	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   73: invokevirtual 1642	java/io/FileInputStream:getFD	()Ljava/io/FileDescriptor;
    //   76: invokevirtual 1645	android/media/MediaPlayer:setDataSource	(Ljava/io/FileDescriptor;)V
    //   79: aload_0
    //   80: aload_0
    //   81: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   84: invokespecial 476	com/tencent/mobileqq/msf/core/push/f:a	(Landroid/media/MediaPlayer;)V
    //   87: aload_0
    //   88: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   91: invokevirtual 499	android/media/MediaPlayer:prepare	()V
    //   94: aload_0
    //   95: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   98: new 1647	com/tencent/mobileqq/msf/core/push/i
    //   101: dup
    //   102: aload_0
    //   103: invokespecial 1648	com/tencent/mobileqq/msf/core/push/i:<init>	(Lcom/tencent/mobileqq/msf/core/push/f;)V
    //   106: invokevirtual 1302	android/media/MediaPlayer:setOnCompletionListener	(Landroid/media/MediaPlayer$OnCompletionListener;)V
    //   109: aload_0
    //   110: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   113: invokevirtual 1303	android/media/MediaPlayer:start	()V
    //   116: aload_0
    //   117: getfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   120: iload_2
    //   121: invokevirtual 1306	android/media/MediaPlayer:setLooping	(Z)V
    //   124: goto -103 -> 21
    //   127: astore_1
    //   128: aload_1
    //   129: invokevirtual 687	java/lang/Exception:printStackTrace	()V
    //   132: goto -111 -> 21
    //   135: astore_1
    //   136: aload_0
    //   137: monitorexit
    ...
    //   142: aload_0
    //   143: aconst_null
    //   144: putfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   147: goto -111 -> 36
    //   150: astore_1
    //   151: aload_0
    //   152: aconst_null
    //   153: putfield 1287	com/tencent/mobileqq/msf/core/push/f:J	Landroid/media/MediaPlayer;
    //   156: aload_1
    //   157: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    //   142	147	127	java/lang/Exception
    //   151	158	127	java/lang/Exception
    //   2	17	135	finally
    //   31	36	135	finally
    //   36	54	135	finally
    //   54	124	135	finally
  ...
  public void a(boolean paramBoolean)
  {
    ...
    label143:
    Object localObject2;
    if ((true == paramBoolean) && (arrayOfString == null) && (ac < ab.length))
    {
      if (QLog.isColorLevel()) {
        QLog.d("MSF.C.PushManager", 2, "loop to loadAppPushInfo with time " + ab[ac] + " seconds");
      }
      localObject1 = this.ag.obtainMessage();
      ((Message)localObject1).what = 1;
      ((Message)localObject1).obj = Boolean.valueOf(paramBoolean);
      this.ag.sendMessageDelayed((Message)localObject1, ab[ac] * 1000);
      ac += 1;
  ...
  public int b(String paramString, Context paramContext)
  {
    ...
    paramString = paramContext.getSharedPreferences(paramString, 0).getString(this.aa, String.valueOf(1));
    try
    {
      int i1 = Integer.parseInt(paramString);
      return i1;
  ...
  public void b(FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      i1 = BaseApplication.getContext().getSharedPreferences("unreadcount", 0).getInt("unread", -1);
      int i2 = this.C.size();
  ...
  public void c(FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        i1 = BaseApplication.getContext().getSharedPreferences("unreadcount", 0).getInt("unread", -5);
        int i2 = this.C.size();
        BadgeUtilImpl.setBadge(BaseApplication.getContext(), i1 + i2);
        return;
      }
  ...
  public void c(String paramString)
  {
    ...
    this.C.clear();
    this.al.set(true);
    BaseApplication.getContext().registerReceiver(this.ap, new IntentFilter("com.tencent.qqlite.broadcast.pcactiveQQ"));
    this.an = 0;
    this.am = paramString;
    a(paramString, 0);
  }
  ...
  public void l()
  {
    ...
    try
    {
      ...
      localHashMap.put("uin", this.am);
      localHashMap.put("retryIndex", String.valueOf(this.an));
  ...
  public void m()
  {
    ...
    try
    {
      if (b())
      {
        localIntent = new Intent("com.tencent.qqlite.action.MAINACTIVITY");
      ...
      Intent localIntent = new Intent("com.tencent.qqlite.action.MAINACTIVITY");
      localIntent.addFlags(268435456);
      localContext.startActivity(localIntent);
      return;
    }
