...
{
  public static final Parcelable.Creator<PluginBaseInfo> CREATOR = new Parcelable.Creator()
  {
    public PluginBaseInfo createFromParcel(Parcel paramAnonymousParcel)
    {
      return new PluginBaseInfo(paramAnonymousParcel);
    }
    
    public PluginBaseInfo[] newArray(int paramAnonymousInt)
    {
      return new PluginBaseInfo[paramAnonymousInt];
    }
  };
