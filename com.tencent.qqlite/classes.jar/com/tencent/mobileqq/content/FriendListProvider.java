  ...
  implements FriendList
{
  ...
  {
    super.onCreate();
    this.a.addURI("qqlite.friendlist", "group/#", 1000);
    this.a.addURI("qqlite.friendlist", "friendlist/#", 1001);
    this.a.addURI("qqlite.friendlist", "trooplist/#", 1002);
    this.a.addURI("qqlite.friendlist", "troopmemberinfo/#/#/#", 1003);
    this.a.addURI("qqlite.friendlist", "troopname/#", 1004);
    this.a.addURI("qqlite.friendlist", "discussinfo/#/#", 1005);
    this.a.addURI("qqlite.friendlist", "discussmenberinfo/#/#/#", 1006);
    return true;
  }
  ...
  public Cursor query(Uri paramUri, String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2)
  {
    ...
    AppRuntime localAppRuntime = getRuntime(paramArrayOfString1);
    SQLiteDatabase localSQLiteDatabase = new ProviderAppRuntimeProxy().a(localAppRuntime, paramArrayOfString1);
    ...
    for (paramString1 = " " + paramString1.substring(i + 1);; paramString1 = localAppRuntime)
    {
