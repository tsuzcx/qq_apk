  ...
  implements GetChars, Spannable, CharSequence, Cloneable
{
  ...
  static final String e = "\\d{5,}";
  public static final int f = 3;
  protected static final String f = Patterns.jdField_b_of_type_JavaUtilRegexPattern.pattern() + "|" + Patterns.f + "|" + "\\d{5,}";
  ...
  protected QQText(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    {
      localObject1 = new StringBuilder(this.g);
  ...
  SpannableString a()
  {
    SpannableString localSpannableString = new SpannableString(this.h);
  ...
  public QQText a(String paramString, boolean paramBoolean, int... paramVarArgs)
  {
    ...
    for (;;)
    {
      if (paramBoolean)
      {
        paramVarArgs = new StringBuilder().append(paramString).append(this.h);
        ...
        localQQText.g = (paramString + this.g);
        localQQText.h = paramVarArgs.toString();
        return localQQText;
      }
      paramVarArgs = new StringBuilder().append(paramString).append(this.h);
      if (i1 != 0) {
        localQQText.a(this.h.length(), this.h.length() + paramString.length(), i1, i2, paramVarArgs);
      }
      this.g += paramString;
      localQQText.h = paramVarArgs.toString();
      return localQQText;
  ...
  public String a()
  {
    StringBuffer localStringBuffer = new StringBuffer(this.h);
    int i4 = "[emoji]".length();
    int i2 = 0;
    int i3 = 0;
    if (i2 < this.n)
  ...
  public void a()
  {
    Matcher localMatcher = jdField_a_of_type_JavaUtilRegexPattern.matcher(this.h);
    while (localMatcher.find())
    {
      int i1 = localMatcher.start();
      int i2 = localMatcher.end();
      a(new QQText.LinkSpan(this, this.h.substring(i1, i2)), i1, i2, 33);
    }
  }
  ...
  public String b()
  {
    char[] arrayOfChar = this.g.toCharArray();
    int i3 = this.g.length() - 1;
    int i1 = 0;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        return this.g.substring(i1, i2 + 1);
        i2 = i3;
      }
    }
  }
  ...
  public boolean equals(Object paramObject)
  {
    if ((paramObject instanceof QQText)) {
      return this.g.equals(((QQText)paramObject).g);
    }
    return false;
  }
  ...
  public final void getChars(int paramInt1, int paramInt2, char[] paramArrayOfChar, int paramInt3)
  {
    ...
    this.h.getChars(i1, paramInt1, paramArrayOfChar, paramInt3);
  }
  ...
  public CharSequence subSequence(int paramInt1, int paramInt2)
  {
    ...
    if ((jdField_a_of_type_Boolean) && (a())) {
      return this.h.subSequence(i1, paramInt1);
    }
