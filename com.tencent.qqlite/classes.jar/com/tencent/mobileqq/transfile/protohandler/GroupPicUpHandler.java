  ...
  extends BaseHandler
{
  ...
  public void a(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramProtoResp = ((cmd0x388.RspBody)new cmd0x388.RspBody().mergeFrom((byte[])localObject2)).rpt_msg_tryup_img_rsp.get();
      ...
      while (localIterator.hasNext())
      {
          ...
          try
          {
            ...
            if ((paramProtoResp.bool_file_exit.has()) && (paramProtoResp.bool_file_exit.get()))
            {
              ...
              while (i < localList.size())
              {
                ...
                ((RichProto.RichProtoResp.GroupPicUpResp)localObject1).jdField_a_of_type_JavaUtilArrayList.add(i, localObject3);
                i += 1;
              }
            }
        ...
        continue;
        label729:
        ((RichProto.RichProtoResp.GroupPicUpResp)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject3);
