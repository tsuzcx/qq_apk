  ...
  extends BaseHandler
{
  ...
  public void a(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramProtoResp = ((cmd0x388.RspBody)new cmd0x388.RspBody().mergeFrom((byte[])localObject2)).rpt_msg_getimg_url_rsp.get();
      ...
      while (localIterator.hasNext())
      {
        ...
        for (;;)
        {
          try
          {
            localObject1 = (RichProto.RichProtoResp.PicDownResp)localRichProtoResp.jdField_a_of_type_JavaUtilList.get((int)localGetImgUrlRsp.uint64_file_id.get());
          }
          catch (Exception paramProtoResp)
          {
            List localList;
        ...
        for (;;)
        {
          ((RichProto.RichProtoResp.PicDownResp)localObject1).jdField_a_of_type_JavaLangString = paramProtoResp;
        ...
        if (i == 0)
        {
          ...
          while (i < paramProtoResp.size())
          {
            ...
            ((RichProto.RichProtoResp.PicDownResp)localObject1).jdField_a_of_type_JavaUtilArrayList.add(i, localServerAddr);
            i += 1;
          }
          if (localGetImgUrlRsp.bytes_down_domain.has())
          {
            ...
            paramProtoResp.b = 80;
            ((RichProto.RichProtoResp.PicDownResp)localObject1).jdField_a_of_type_JavaUtilArrayList.add(paramProtoResp);
          }
        }
        if (localGetImgUrlRsp.bytes_down_domain.has())
        {
          ...
          paramProtoResp.b = 80;
          ((RichProto.RichProtoResp.PicDownResp)localObject1).jdField_a_of_type_JavaUtilArrayList.add(paramProtoResp);
          ((RichProto.RichProtoResp.PicDownResp)localObject1).b = paramProtoResp.jdField_a_of_type_JavaLangString;
        }
