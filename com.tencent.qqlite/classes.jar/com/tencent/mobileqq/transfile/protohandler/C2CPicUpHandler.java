  ...
  extends BaseHandler
{
  ...
  void a(int paramInt, RichProto.RichProtoReq.ReqCommon paramReqCommon, cmd0x352.ReqBody paramReqBody)
  {
    ...
    localTryUpImgReq.bool_address_book.set(localPicUpReq.jdField_b_of_type_Boolean);
    localTryUpImgReq.uint32_platform_type.set(9);
    localTryUpImgReq.uint32_bu_type.set(1);
    localTryUpImgReq.bool_pic_original.set(localPicUpReq.jdField_a_of_type_Boolean);
    localTryUpImgReq.uint32_pic_width.set(localPicUpReq.jdField_a_of_type_Int);
    localTryUpImgReq.uint32_pic_height.set(localPicUpReq.jdField_b_of_type_Int);
  ...
  public void a(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    Object localObject2 = paramProtoResp.jdField_a_of_type_ComTencentQphoneBaseRemoteFromServiceMsg.getWupBuffer();
    ...
    if (((FromServiceMsg)localObject1).getResultCode() != 1000)
    {
      ...
      if ((i == 1002) || (i == 1013))
      {
        localObject2 = MessageHandler.a((FromServiceMsg)localObject1);
        paramProtoReq = ((FromServiceMsg)localObject1).getBusinessFailMsg();
        paramProtoResp = paramProtoReq;
        if (paramProtoReq == null) {
          paramProtoResp = "";
        }
        a(-1, 9311, (String)localObject2, paramProtoResp, localStatictisInfo, localRichProtoResp.jdField_a_of_type_JavaUtilList);
      }
    }
    for (;;)
    {
      ...
      a(-1, 9044, (String)localObject2, paramProtoResp, localStatictisInfo, localRichProtoResp.jdField_a_of_type_JavaUtilList);
      continue;
      cmd0x352.RspBody localRspBody;
      try
      {
        localRspBody = (cmd0x352.RspBody)new cmd0x352.RspBody().mergeFrom((byte[])localObject2);
      ...
      {
        a(-1, -9527, BaseTransProcessor.a("P", -9529L), paramProtoResp.getMessage() + " hex:" + HexUtil.bytes2HexStr((byte[])localObject2), localStatictisInfo, localRichProtoResp.jdField_a_of_type_JavaUtilList);
      }
      continue;
      label266:
      ...
      while (localIterator.hasNext())
      {
        ...
        a(-1, -9527, BaseTransProcessor.a("P", -9529L), paramProtoResp.getMessage() + " hex:" + HexUtil.bytes2HexStr((byte[])localObject2), localStatictisInfo, (RichProto.RichProtoResp.RespCommon)localObject1);
        continue;
        label416:
        localObject3 = paramProtoResp.bytes_up_resid.get().toStringUtf8();
        localObject4 = paramProtoResp.bytes_up_uuid.get().toStringUtf8();
        if (localObject3 != null) {
          break label919;
        }
        bool = false;
        ((RichProto.RichProtoResp.C2CPicUpResp)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject3);
        ((RichProto.RichProtoResp.C2CPicUpResp)localObject1).jdField_b_of_type_JavaLangString = ((String)localObject4);
        ...
        for (;;)
        {
          ...
          break;
          localObject3 = paramProtoResp.bytes_up_ukey.get().toByteArray();
          if ((paramProtoResp.rpt_uint32_up_ip.size() <= 0) || (paramProtoResp.rpt_uint32_up_port.size() <= 0) || (localObject3 == null) || (localObject3.length == 0)) {
            throw new Exception("check ip,port,ukey");
          }
          ((RichProto.RichProtoResp.C2CPicUpResp)localObject1).jdField_c_of_type_JavaLangString = HexUtil.bytes2HexStr((byte[])localObject3);
          ((RichProto.RichProtoResp.C2CPicUpResp)localObject1).jdField_a_of_type_Int = ((int)paramProtoResp.uint64_block_size.get());
          localObject3 = paramProtoResp.rpt_uint32_up_ip.get();
          paramProtoResp = paramProtoResp.rpt_uint32_up_port.get();
          i = 0;
          while (i < ((List)localObject3).size())
          {
            long l1 = ((Integer)((List)localObject3).get(i)).intValue();
            ...
            ((RichProto.RichProtoResp.C2CPicUpResp)localObject1).jdField_a_of_type_JavaUtilArrayList.add(i, localObject4);
            i += 1;
          }
          if (NetworkCenter.a().a() == this.ap) {
            break label925;
          }
          bool = true;
