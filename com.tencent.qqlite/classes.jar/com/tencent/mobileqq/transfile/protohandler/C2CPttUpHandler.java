  ...
  public void a(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject2 = (cmd0x346.ApplyUploadRsp)paramProtoResp.msg_apply_upload_rsp.get();
        localC2CPttUpResp = (RichProto.RichProtoResp.C2CPttUpResp)localRichProtoResp.jdField_a_of_type_JavaUtilList.get(0);
        i = ((cmd0x346.ApplyUploadRsp)localObject2).int32_ret_code.get();
        if (i != 0) {
          break label455;
        }
        localC2CPttUpResp.jdField_a_of_type_JavaLangString = ((cmd0x346.ApplyUploadRsp)localObject2).bytes_uuid.get().toStringUtf8();
        if ((!((cmd0x346.ApplyUploadRsp)localObject2).bool_file_exist.has()) || (!((cmd0x346.ApplyUploadRsp)localObject2).bool_file_exist.get())) {
          break;
        }
    ...
    if (((cmd0x346.ApplyUploadRsp)localObject2).uint32_pack_size.has()) {
      localC2CPttUpResp.jdField_a_of_type_Int = ((cmd0x346.ApplyUploadRsp)localObject2).uint32_pack_size.get();
    }
    String str = HexUtil.bytes2HexStr(((cmd0x346.ApplyUploadRsp)localObject2).bytes_upload_key.get().toByteArray());
    localC2CPttUpResp.b = str;
    paramProtoReq = ((cmd0x346.ApplyUploadRsp)localObject2).str_upload_ip.get();
    paramProtoResp = paramProtoReq;
    if (paramProtoReq == null) {
      paramProtoResp = ((cmd0x346.ApplyUploadRsp)localObject2).str_upload_domain.get();
    }
    for (;;)
    {
      label393:
      ...
      do
      {
        ...
        paramProtoReq.b = ((cmd0x346.ApplyUploadRsp)localObject2).uint32_upload_port.get();
