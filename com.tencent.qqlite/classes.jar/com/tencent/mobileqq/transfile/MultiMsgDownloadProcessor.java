  ...
  extends BaseDownloadProcessor
{
  private String U;
  private byte[] a;
  private int aG = this.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_a_of_type_Int;
  private byte[] b;
  private byte[] c;
