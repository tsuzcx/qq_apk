...
{
  private static final String b = "AIOPhotoImageDownloader";
  ...
  {
    return AbsDownloader.b(paramString);
  }
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    try
    {
      ...
      paramDownloadParams.inPreferredConfig = URLDrawableHelper.a;
      ...
      if (bool) {
        try
        {
          ...
          if (paramDownloadParams != null) {
            return new ExifBitmapCreator(paramFile.getAbsolutePath()).a(paramDownloadParams);
          }
          paramFile.delete();
