...
public class SosoSrvAddrProvider
{
  ...
  ejb jdField_a_of_type_Ejb = new ejb(this);
  ...
  public String a(SosoSrvAddrProvider.SosoSrvAddrType paramSosoSrvAddrType)
  {
    ...
    try
    {
      FileStorageServerListInfo localFileStorageServerListInfo = this.jdField_a_of_type_Ejb.a(paramSosoSrvAddrType);
  ...
  public void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    try
    {
      ...
      this.jdField_a_of_type_Ejb.a(paramFileStoragePushFSSvcList);
      return;
    }
    finally
    {
  ...
  public void a(SosoSrvAddrProvider.SosoSrvAddrType paramSosoSrvAddrType, String paramString)
  {
    try
    {
      this.jdField_a_of_type_Ejb.a(paramSosoSrvAddrType, paramString);
      return;
    }
    finally
    {
