  ...
  implements ProtocolDownloaderConstants
{
  ...
  public static final File a(String paramString)
  {
    if (paramString != null)
    {
      ...
      File localFile = new File(URLDrawableHelper.a, str);
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    //   4: astore 8
    //   6: aload_0
    //   7: invokevirtual 141	com/tencent/mobileqq/transfile/AbsDownloader:a	()Z
    //   10: ifeq +235 -> 245
    //   13: aload_1
    //   14: getfield 146	com/tencent/image/DownloadParams:urlStr	Ljava/lang/String;
    //   17: astore 9
    //   19: aload 9
    //   21: invokestatic 109	com/tencent/mobileqq/transfile/AbsDownloader:a	(Ljava/lang/String;)Ljava/io/File;
    //   24: astore 6
    //   26: aload 6
    //   28: ifnull +8 -> 36
    //   31: aload 6
    ...
    //   41: astore 10
    //   43: getstatic 159	com/tencent/mobileqq/startup/step/InitUrlDrawable:a	Lcom/tencent/mobileqq/transfile/DiskCache;
    //   46: aload 10
    //   48: invokevirtual 164	com/tencent/mobileqq/transfile/DiskCache:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/transfile/DiskCache$Editor;
    //   51: astore 11
    //   53: aload_0
    //   54: invokevirtual 166	com/tencent/mobileqq/transfile/AbsDownloader:b	()Z
    //   57: istore 4
    //   59: iload 4
    //   61: ifeq +218 -> 279
    //   64: aload 7
    ...
    //   68: aload_1
    //   69: aload 11
    //   71: getfield 169	com/tencent/mobileqq/transfile/DiskCache$Editor:a	Ljava/io/File;
    //   74: invokevirtual 172	java/io/File:length	()J
    //   77: putfield 176	com/tencent/image/DownloadParams:downloaded	J
    //   80: aload 7
    //   82: astore 6
    //   84: aload_0
    //   85: aload_1
    //   86: invokevirtual 178	com/tencent/mobileqq/transfile/AbsDownloader:a	(Lcom/tencent/image/DownloadParams;)Z
    //   89: istore 5
    //   91: iload 5
    //   93: ifne +63 -> 156
    //   96: iconst_1
    ...
    //   104: aload 7
    //   106: astore 6
    //   108: new 180	java/io/FileOutputStream
    //   111: dup
    //   112: aload 11
    //   114: getfield 169	com/tencent/mobileqq/transfile/DiskCache$Editor:a	Ljava/io/File;
    //   117: iload 4
    //   119: invokespecial 183	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   122: astore 7
    //   124: aload_0
    //   125: aload 7
    //   127: aload_1
    //   128: aload_2
    //   129: invokevirtual 185	com/tencent/mobileqq/transfile/AbsDownloader:a	(Ljava/io/OutputStream;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   132: pop
    //   133: aload 11
    //   135: invokevirtual 188	com/tencent/mobileqq/transfile/DiskCache$Editor:a	()Ljava/io/File;
    //   138: astore_1
    //   139: aload_1
    //   140: astore_2
    //   141: aload 7
    //   143: ifnull -109 -> 34
    //   146: aload 7
    //   148: invokevirtual 193	java/io/OutputStream:close	()V
    //   151: aload_1
    //   152: areturn
    //   153: astore_2
    //   154: aload_1
    ...
    //   173: aload 11
    //   175: iload 4
    //   177: invokevirtual 196	com/tencent/mobileqq/transfile/DiskCache$Editor:a	(Z)V
    //   180: aload_2
    //   181: astore 6
    //   183: ldc 198
    //   185: ldc 199
    ...
    //   214: invokevirtual 57	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   217: invokestatic 208	com/tencent/mobileqq/pic/Logger:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   220: aload_2
    //   221: astore 6
    //   223: aload_1
    //   224: invokevirtual 211	java/lang/Exception:printStackTrace	()V
    //   227: aload_2
    //   228: astore 6
    //   230: aload_1
    //   231: athrow
    ...
    //   235: ifnull +8 -> 243
    //   238: aload 6
    //   240: invokevirtual 193	java/io/OutputStream:close	()V
    //   243: aload_1
    //   244: athrow
    //   245: aload_0
    //   246: aconst_null
    //   247: aload_1
    //   248: aload_2
    //   249: invokevirtual 185	com/tencent/mobileqq/transfile/AbsDownloader:a	(Ljava/io/OutputStream;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   252: areturn
    //   253: astore_2
    //   254: goto -11 -> 243
    //   257: astore_1
