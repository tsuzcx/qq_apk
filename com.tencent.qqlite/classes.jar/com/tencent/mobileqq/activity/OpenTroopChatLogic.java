...
public class OpenTroopChatLogic
{
  ...
  public OpenTroopChatLogic(SessionInfo paramSessionInfo, BaseActivity paramBaseActivity)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bah(this);
    this.jdField_a_of_type_ComTencentMobileqqAppBizTroopObserver = new bai(this);
    this.jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new baj(this);
  ...
  private void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.removeObserver(this.jdField_a_of_type_ComTencentMobileqqAppBizTroopObserver);
      d();
      return;
    }
    if (paramBoolean)
    {
      FriendManager localFriendManager = (FriendManager)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(8);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetToast = paramString1.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
      d();
    }
  }
  ...
  public void a()
  {
    ...
    this.jdField_c_of_type_Boolean = false;
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new bak(this), 1000L);
  ...
  public void b(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(localMessageForPic.frienduin, localMessageForPic.istroop, localMessageForPic.uniseq);
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.OpenTroopChatLogic
