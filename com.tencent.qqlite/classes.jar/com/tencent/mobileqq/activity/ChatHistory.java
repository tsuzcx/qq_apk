  ...
  implements SensorEventListener
{
  ...
  public int a;
  public long a;
  aeg jdField_a_of_type_Aeg = new aeg(this, null);
  public Dialog a;
  AnimationDrawable jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable = null;
  private Sensor jdField_a_of_type_AndroidHardwareSensor;
  private SensorManager jdField_a_of_type_AndroidHardwareSensorManager;
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new acs(this);
  public Handler a;
  public View a;
  AbsListView.OnScrollListener jdField_a_of_type_AndroidWidgetAbsListView$OnScrollListener = new adn(this);
  ...
  private AudioPlayer.AudioPlayerListener jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer$AudioPlayerListener = new adm(this);
  ...
  private MessageObserver jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new adj(this);
  private ProxyObserver jdField_a_of_type_ComTencentMobileqqAppProxyProxyObserver = new adk(this);
  ...
  private Handler jdField_b_of_type_AndroidOsHandler = new adf(this);
  public View b;
  ...
  private String a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramAbsStructMsg.mSourceName))
      {
        ...
        localStringBuffer.append(" " + getString(2131364135) + " ");
  ...
  {
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)findViewById(2131296803));
    m();
  ...
  private void b(ImageView paramImageView)
  {
    ...
    {
      this.jdField_b_of_type_AndroidGraphicsDrawableAnimationDrawable.stop();
      paramImageView.setImageDrawable(getResources().getDrawable(2130839018));
    }
  }
  ...
  private void b(String paramString, int paramInt)
  {
    ...
    if ((paramInt == 1) || (paramInt == 3000))
    {
      ...
      if (paramInt == 1)
      {
        ...
        localStringBuffer.append(getString(2131363398) + ":");
    ...
    for (;;)
    {
      ...
      if (localObject4 != null)
      {
        ...
        if (((String)localObject4).length() > 0)
        {
          ...
          if (b((String)localObject4))
          {
            ...
            localObject1 = getString(2131363275);
          }
        }
      }
      ...
      do
      {
        ...
        runOnUiThread(new adi(this, FileUtils.a(AppConstants.as, this.jdField_a_of_type_JavaLangStringBuffer, localStringBuffer.toString())));
        return;
        ...
        if (i3 == -2007)
        {
          paramString = getString(2131364106);
          break label309;
        }
        if (i3 == -2011)
        {
        ...
        if (i3 == -2020)
        {
          if (MsgUtils.a(i1))
          {
            paramString = this.app.a().getString(2131362957, new Object[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d });
            break label309;
          }
          paramString = this.app.a().getString(2131362956);
          break label309;
        }
      } while (i3 == -2006);
      if (i3 == -2000)
    ...
    for (;;)
    {
      ...
      localObject2 = "[" + getString(2131363161) + "]";
      break label405;
      label1136:
      break label151;
      label1139:
  ...
  private void m()
  {
    ...
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new ads(this));
  ...
  private void n()
  {
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131296808));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131296812));
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(getString(2131364380));
    this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(getString(2131364381));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new adw(this));
    this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(new acu(this));
    this.jdField_b_of_type_AndroidWidgetImageView.setEnabled(false);
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130839124);
    if (this.jdField_b_of_type_Int == 1)
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setEnabled(false);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130838096);
    }
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131296811));
    this.jdField_a_of_type_AndroidWidgetTextView.setText(String.valueOf(this.jdField_b_of_type_Int));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131296809));
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new acv(this));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131296813));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new acw(this));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)findViewById(2131296814));
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(new acx(this));
    ...
    for (;;)
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(new acy(this));
      return;
  ...
  private void p()
  {
    ...
    {
      QQToast.a(getApplicationContext(), 2131363395, 1).a();
      return;
    }
    c(getApplication().getResources().getString(2131363396));
    this.app.a().c(this.jdField_b_of_type_JavaLangString);
  }
  
  private void q()
  {
    String str = getResources().getString(2131363078);
    if (this.jdField_a_of_type_Int == 0) {
      if (this.jdField_b_of_type_JavaLangString.equals(String.valueOf(AppConstants.Y)))
      {
        this.jdField_c_of_type_JavaLangString = getResources().getString(2131363525);
        if (!this.jdField_b_of_type_JavaLangString.equals(String.valueOf(AppConstants.Y))) {
          break label298;
        }
        str = getResources().getString(2131363525);
      }
    }
    label298:
    for (;;)
  ...
  protected View a()
  {
    ...
    if ((3000 == this.jdField_a_of_type_Int) || (1 == this.jdField_a_of_type_Int))
    {
      ...
      localImageView1 = (ImageView)findViewById(2131296913);
    }
    for (;;)
    {
      ...
      return localObject;
      localObject = findViewById(2131296911);
      ImageView localImageView2 = (ImageView)findViewById(2131296912);
      localImageView2.setImageResource(2130838049);
      localImageView2.setOnClickListener(new adr(this));
      localImageView1 = (ImageView)findViewById(2131296913);
      localImageView1.setImageResource(2130838048);
  ...
  public void a()
  {
    View localView1 = findViewById(2131296802);
    ...
    localTranslateAnimation1.setAnimationListener(new adt(this, localView2, localView1));
    localTranslateAnimation2.setAnimationListener(new adu(this, localView2, i1));
    this.jdField_a_of_type_ComTencentMobileqqActivityMessagesearchMessageSearchDialog.setOnDismissListener(new adv(this, localView2, i1, localView1, localTranslateAnimation2));
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      localActionSheet.a(getResources().getString(2131362494));
      localActionSheet.a(2131363247, 3);
      localActionSheet.d(2131362790);
      localActionSheet.a(new ado(this, paramMessageRecord, localActionSheet));
  ...
  public void a(String paramString)
  {
    ...
    {
      ((TextView)localView.findViewById(2131296764)).setText(2131363113);
      localView.findViewById(2131297002).setVisibility(8);
    }
    for (;;)
    {
      this.jdField_b_of_type_AndroidAppDialog = DialogUtil.a(this, 230).setTitle(getString(2131363092)).setPositiveButton(getString(2131363247), new adb(this, paramString)).setNegativeButton(getString(2131363111), new ada(this)).addView(localView);
      this.jdField_b_of_type_AndroidAppDialog.show();
      return;
      if (3000 == this.jdField_a_of_type_Int)
      {
        ((TextView)localView.findViewById(2131296764)).setText(2131363114);
        localView.findViewById(2131297002).setVisibility(8);
      }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_Int == 0) && (((CheckBox)this.jdField_b_of_type_AndroidAppDialog.findViewById(2131297002)).isChecked()))
    {
      p();
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable = ((AnimationDrawable)getResources().getDrawable(2130968649));
    this.jdField_b_of_type_AndroidGraphicsDrawableAnimationDrawable = ((AnimationDrawable)getResources().getDrawable(2130968636));
  ...
  public void e()
  {
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(4, getResources().getString(2131363167)).sendToTarget();
  ...
  public void g()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_c_of_type_AndroidAppDialog = DialogUtil.a(this, 230, getString(2131363116), getString(2131363116) + AppConstants.as + this.jdField_a_of_type_JavaLangStringBuffer.toString(), new adc(this), new ade(this));
      if (!bool) {
        break label230;
      }
    ...
    label230:
    b(getString(2131363118));
  }
  
  public void h()
  {
    this.jdField_c_of_type_AndroidAppDialog = DialogUtil.a(this, 230, getString(2131363169), getString(2131363170), new adg(this), new adh(this));
    this.jdField_c_of_type_AndroidAppDialog.show();
  }
  ...
  public void onSensorChanged(SensorEvent paramSensorEvent)
  {
    ...
    label89:
    label94:
    for (int i1 = 2131363177;; i1 = 2131363178)
    {
      a(i1);
      return;
      bool1 = false;
