...
public abstract class RecentItemBaseBuilder
{
  ...
  public static final int[] b = { 2130837957, 2130837964, 2130837961, 2130837967 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 2131363260, 2131363825, 2131364379, 2131364378 };
  }
  ...
  public View a(Context paramContext, int paramInt, ImageView[] paramArrayOfImageView)
  {
    ...
    int k = paramContext.getResources().getDimensionPixelSize(2131493081);
    int m = paramContext.getResources().getDimensionPixelSize(2131493080);
    int j = 0;
    while (j < paramInt)
    {
      ImageView localImageView = (ImageView)LayoutInflater.from(paramContext).inflate(2130903600, null);
  ...
  public View a(Context paramContext, View paramView1, View paramView2)
  {
    ...
    localLinearLayout.addView(paramView2, new LinearLayout.LayoutParams(paramContext.getResources().getDimensionPixelSize(2131493081), -2));
    return localLinearLayout;
  }
    ...
    for (int m = ((RecentBaseData)paramObject).A;; m = 0)
    {
      ...
      if (n < 0)
      {
        ...
        if (paramRecentItemBaseHolder.jdField_a_of_type_ArrayOfAndroidWidgetImageView[0] != null)
        {
          ...
          if ((m & 0xF00) == 256)
          {
            a(paramRecentItemBaseHolder.jdField_a_of_type_ArrayOfAndroidWidgetImageView[0], paramInt, b[1], jdField_a_of_type_ArrayOfInt[1], 2130837956, paramOnClickListener);
            k = 1;
          }
        }
      }
      ...
      if (k < n)
      {
        ...
        if (paramRecentItemBaseHolder.jdField_a_of_type_ArrayOfAndroidWidgetImageView[k] != null)
        {
          ...
          a(paramRecentItemBaseHolder.jdField_a_of_type_ArrayOfAndroidWidgetImageView[k], paramInt, b[2], jdField_a_of_type_ArrayOfInt[2], 2130837956, paramOnClickListener);
          j = k + 1;
        }
      }
      if ((j < n) && (paramRecentItemBaseHolder.jdField_a_of_type_ArrayOfAndroidWidgetImageView[j] != null) && ((m & 0xF) == 1))
      {
        a(paramRecentItemBaseHolder.jdField_a_of_type_ArrayOfAndroidWidgetImageView[j], paramInt, b[0], jdField_a_of_type_ArrayOfInt[0], 2130837958, paramOnClickListener);
        j += 1;
      }
      for (;;)
      {
        ...
        for (;;)
        {
          if (k < n)
          {
            ...
            a(paramRecentItemBaseHolder.jdField_a_of_type_ArrayOfAndroidWidgetImageView[k], paramInt, b[3], jdField_a_of_type_ArrayOfInt[3], 2130837956, paramOnClickListener);
            j = k + 1;
            break;
          }
        }
        j = paramContext.getResources().getDimensionPixelSize(2131493081) * j;
