...
public class SendMultiPictureHelper
{
  ...
  DialogInterface.OnClickListener jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new bjb(this);
  public Bundle a;
  protected SendMultiPictureHelper.SendingFileInfo a;
  public BaseActivity a;
  public QQAppInterface a;
  public FMObserver a;
  private TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new biz(this);
  ...
  DialogInterface.OnClickListener jdField_b_of_type_AndroidContentDialogInterface$OnClickListener = new bjc(this);
  protected String b;
  public boolean b;
  public int c;
  ...
  public SendMultiPictureHelper(BaseActivity paramBaseActivity)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppFMObserver = new bja(this);
    this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener = new bjd(this);
    ...
    this.f = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131364066);
  }
  ...
  public void a()
  {
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilArrayList)
      {
        ...
        if (((File)localObject2).length() == 0L)
        {
          if (this.jdField_c_of_type_Int == 0) {
            Toast.makeText(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131364112), 0).show();
          }
        }
        else
        {
      ...
      Toast.makeText(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131364113), 0).show();
      continue;
      label264:
  ...
  public void a(String paramString1, String paramString2, int paramInt1, String paramString3, int paramInt2, Bundle paramBundle, ArrayList paramArrayList)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230, this.e, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131364069), null, this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentBroadcastReceiver == null) {
        this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bje(this);
      }
  ...
  public void b()
  {
    Object localObject = "";
    if (this.jdField_d_of_type_Int == 1) {
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131364067);
    }
    for (;;)
    {
      localObject = DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131363512), (String)localObject, 2131364116, 2131362787, this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener, this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener);
      ((QQCustomDialog)localObject).setCancelable(false);
      ((QQCustomDialog)localObject).show();
      return;
      if (this.jdField_d_of_type_Int == 0) {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131364068);
      }
    }
  }
