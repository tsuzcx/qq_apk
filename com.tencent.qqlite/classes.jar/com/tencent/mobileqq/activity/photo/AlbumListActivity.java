  ...
  extends PeakActivity
{
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131298184));
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new chy(this, null));
    if (Build.VERSION.SDK_INT > 8) {
      this.jdField_a_of_type_ComTencentWidgetXListView.setOverScrollMode(2);
    }
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131296901));
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131364522);
    ...
    this.jdField_c_of_type_AndroidWidgetTextView.setText(2131364522);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new chx(this));
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_b_of_type_Int = getResources().getDimensionPixelSize(2131492957);
