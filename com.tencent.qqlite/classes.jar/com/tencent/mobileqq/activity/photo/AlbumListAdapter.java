  ...
  extends BaseAdapter
{
  ...
  public AlbumListAdapter(Activity paramActivity, IMediaFilter paramIMediaFilter)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable$ConstantState = this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130837718).getConstantState();
    this.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131492957);
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Int;
    ThreadManager.a().post(new chz(this));
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (i = 0;; i = localList.size() - 1)
        {
          ...
          ThreadManager.a().post(new cic(this));
          return;
        }
        paramInt = n;
        if (localList != null) {
        ...
        ThreadManager.a().post(new cid(this));
        return;
        label355:
        paramInt = i1;
        if (localList != null) {
  ...
  private void b(QQAlbumInfo paramQQAlbumInfo)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new cib(this, paramQQAlbumInfo));
  }
  ...
  private void b(List paramList)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new cia(this, paramList));
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidAppActivity.getLayoutInflater().inflate(2130903479, null);
    ...
    for (paramView = null;; paramView = null)
    {
      ...
      for (paramView = URLDrawable.getDrawable(localURL, jdField_a_of_type_AndroidGraphicsDrawableColorDrawable, jdField_a_of_type_AndroidGraphicsDrawableColorDrawable);; paramView = URLDrawable.getDrawable(localURL, paramView, paramView))
      {
        ...
        localView = paramView;
        break;
        paramView = this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130838379);
      }
    }
  }
}
