  ...
  extends IphoneTitleBarActivity
{
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131296898));
    ...
    this.j = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131296902));
    this.j.setText(2131364384);
    this.j.setOnClickListener(new cir(this));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131296909));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131296910));
    if (this.e == 2) {
      findViewById(2131296908).setVisibility(0);
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityPhonePhoneFrame.setPhoneContext(new cis(this));
      ...
      if (this.e != 1) {
        if (this.e == 0) {
          ...
          findViewById(2131296908).setVisibility(8);
        }
      }
    }
  }
