  ...
  implements BaseSystemMsgInterface, FaceDecoder.DecodeTaskCompletionListener, SlideDetectListView.OnScrollToTopListener, SlideDetectListView.OnSlideListener, Observer
{
  ...
  public Handler a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ccs(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new ccn(this);
  private SystemMsgListAdapter jdField_a_of_type_ComTencentMobileqqAdapterSystemMsgListAdapter;
  FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new ccv(this);
  MessageObserver jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new ccx(this);
  TroopObserver jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new ccw(this);
  private FaceDecoder jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder;
  public QQProgressDialog a;
  private SlideDetectListView.OnScrollToTopListener jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView$OnScrollToTopListener = new cco(this);
  private SlideDetectListView jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView;
  private List jdField_a_of_type_JavaUtilList = new ArrayList();
  public final long b;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new cct(this);
  private boolean jdField_b_of_type_Boolean = true;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new ccu(this);
  public View c;
  ...
  public SystemMsgListView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new ccm(this);
  ...
  private static void c(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null) {
      paramQQAppInterface.a(new ccp(paramQQAppInterface));
    }
    if (QLog.isColorLevel()) {
  ...
  {
    a(2130903560);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView = ((SlideDetectListView)findViewById(2131298547));
    this.jdField_c_of_type_AndroidViewView = findViewById(2131298548);
    this.jdField_d_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130903561, null);
  ...
  private void q()
  {
    if (this.jdField_e_of_type_AndroidViewView == null) {
      this.jdField_e_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130903558, null);
    }
  ...
  public void a(SystemMsgListAdapter.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    if ((paramViewHolder.jdField_b_of_type_JavaLangString != null) && (!paramViewHolder.jdField_b_of_type_JavaLangString.equals("")))
    {
      ...
      paramViewHolder.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131362887) + " " + paramViewHolder.jdField_d_of_type_JavaLangString);
  ...
  protected void e()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqAdapterSystemMsgListAdapter != null) && (this.jdField_a_of_type_ComTencentMobileqqAdapterSystemMsgListAdapter.getCount() > 0))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new ccq(this));
  ...
  public void l()
  {
    ...
    localIntent.putExtra("title", this.jdField_a_of_type_AndroidContentContext.getString(2131364302));
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new ccr(this));
  }
}
