  ...
  implements View.OnClickListener, IndexView.OnIndexChangedListener, PinnedDividerListView.OnLayoutListener
{
  ...
  private ckt jdField_a_of_type_Ckt;
  ...
  private void h()
  {
    ...
    if (this.jdField_a_of_type_Ckt == null)
    {
      this.jdField_a_of_type_Ckt = new ckt(this, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView, false);
      this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_Ckt);
    }
    this.jdField_a_of_type_Ckt.a();
  }
  ...
  private void i()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqPhonecontactContactBindObserver == null) {
      this.jdField_a_of_type_ComTencentMobileqqPhonecontactContactBindObserver = new cks(this);
    }
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Ckt.a(paramString);
    } while (i == -1);
  ...
  {
    super.b(paramBundle);
    this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(true, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131363994), this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131363987));
    switch (this.c)
    {
    case 5: 
    case 6: 
    ...
    case 4: 
    case 7: 
      this.jdField_a_of_type_Ckt.notifyDataSetChanged();
      return;
    case 1: 
    case 2: 
      j();
  ...
  {
    cku localcku = (cku)paramView.getTag();
    PhoneContact localPhoneContact;
    if ((localcku != null) && (localcku.jdField_a_of_type_AndroidWidgetCheckBox != null) && (localcku.jdField_a_of_type_ComTencentMobileqqDataPhoneContact != null))
    {
      localPhoneContact = localcku.jdField_a_of_type_ComTencentMobileqqDataPhoneContact;
      if (localcku.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()) {
        if (!localcku.jdField_a_of_type_JavaLangString.startsWith("+")) {
          break label127;
        }
      }
    }
    label127:
    for (boolean bool = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(localcku.jdField_a_of_type_JavaLangString, localPhoneContact.name, 4, "-1");; bool = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(localcku.jdField_a_of_type_JavaLangString, localPhoneContact.name, 0, "-1"))
    {
      localcku.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(bool);
      if (!localcku.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
        break;
      }
      paramView.setContentDescription(localcku.c.getText().toString() + "已选中");
      return;
    }
    paramView.setContentDescription(localcku.c.getText().toString());
  }
}
