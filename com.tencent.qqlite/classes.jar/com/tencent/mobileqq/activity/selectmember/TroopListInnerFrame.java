  ...
  implements View.OnClickListener
{
  ...
  public TroopListInnerFrame(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131493076);
  }
  ...
  private void a(int paramInt)
  {
    ...
    while (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      return;
      localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131362301, new Object[] { String.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopListInnerFrame$TroopListAdapter.d) });
      break label124;
      localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131362304, new Object[] { String.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopListInnerFrame$TroopListAdapter.c) });
      break label124;
      localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131362302, new Object[] { String.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopListInnerFrame$TroopListAdapter.jdField_a_of_type_Int) });
      break label124;
      localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131362303, new Object[] { String.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopListInnerFrame$TroopListAdapter.b) });
      break label124;
      label382:
  ...
  public void a(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setOnScrollGroupFloatingListener(new coi(this));
  }
  ...
  {
    paramView = (col)paramView.getTag();
