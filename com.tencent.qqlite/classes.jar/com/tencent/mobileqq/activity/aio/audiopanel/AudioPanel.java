  ...
  implements ViewPager.OnPageChangeListener, View.OnClickListener
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (m < n)
        {
          ...
          if (((View)localObject1).getId() == 2131296664) {}
          for (;;)
          {
            m += 1;
            break label107;
  ...
  public static PopupWindow a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, View paramView, int paramInt4, int paramInt5, int paramInt6)
  {
    ...
    jdField_a_of_type_AndroidWidgetPopupWindow = new PopupWindow(localView, paramInt1, paramInt2 - paramInt3 - AIOUtils.a(196.0F, paramContext.getResources()));
  ...
  void a(ViewGroup paramViewGroup, View paramView, int paramInt1, int paramInt2)
  {
    if (paramViewGroup != null)
    {
      ...
      while (m < n)
      {
        Object localObject = paramViewGroup.getChildAt(m);
  ...
  public void b()
  {
    ...
    {
      if ((localView != null) && ((localView instanceof AudioPanelCallback))) {
        ((AudioPanelCallback)localView).f();
      }
      return;
      label71:
      m += 1;
