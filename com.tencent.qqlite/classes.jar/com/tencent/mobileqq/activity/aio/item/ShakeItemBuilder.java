  ...
  extends BaseBubbleBuilder
{
  ...
  public ShakeItemBuilder(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bwu(this);
  }
  ...
  protected View a(ChatMessage paramChatMessage, BaseBubbleBuilder.ViewHolder paramViewHolder, View paramView, BaseChatItemLayout paramBaseChatItemLayout, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    if (paramView == null)
    {
      ...
      ((TextView)localObject).setTextColor(paramBaseChatItemLayout.getResources().getColorStateList(2131427478));
      ((TextView)localObject).setMaxWidth(BaseChatItemLayout.g);
      ((TextView)localObject).setId(2131296698);
    ...
    localHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130838642);
    if (paramChatMessage.isSend())
    {
      k = BaseChatItemLayout.q;
      j = BaseChatItemLayout.p;
      i = BaseChatItemLayout.q;
      localHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130838643);
    }
    ...
    localHolder.jdField_a_of_type_AndroidWidgetTextView.setText(paramBaseChatItemLayout.getResources().getString(2131362955));
  ...
  protected void a(View paramView)
  {
    ...
    String str1 = this.jdField_a_of_type_AndroidContentContext.getString(2131363070);
    String str2 = this.jdField_a_of_type_AndroidContentContext.getString(2131363071);
    if (paramView.isSendFromLocal()) {
      DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230, str1, str2, new bwv(this, paramView), new bww(this)).show();
    }
  }
  ...
  protected void a(BaseBubbleBuilder.ViewHolder paramViewHolder, View paramView, ChatMessage paramChatMessage, BubbleInfo paramBubbleInfo)
  {
    ...
    {
      localHolder.jdField_a_of_type_AndroidWidgetTextView.setLinkTextColor(paramView.getResources().getColorStateList(2131427479));
      return;
      localHolder.jdField_a_of_type_AndroidWidgetTextView.setTextColor(paramBubbleInfo.c);
    }
    localHolder.jdField_a_of_type_AndroidWidgetTextView.setLinkTextColor(paramBubbleInfo.d);
  }
