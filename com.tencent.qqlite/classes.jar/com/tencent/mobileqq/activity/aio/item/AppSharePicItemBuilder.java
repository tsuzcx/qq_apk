  ...
  extends BaseBubbleBuilder
{
  ...
  public AppSharePicItemBuilder(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
  ...
  private void a(AppSharePicItemBuilder.Holder paramHolder)
  {
    if (paramHolder.jdField_a_of_type_ComTencentMobileqqDataMessageForPic.isMixed)
    {
      ...
      String str2 = this.jdField_a_of_type_AndroidContentContext.getString(2131363605);
      String str1;
      if (((MessageForPic)localObject).shareAppID != 0L)
      {
        ...
        if (localAppShareID != null)
        {
          ...
          if (localAppShareID.messagetail != null) {
            str1 = this.jdField_a_of_type_AndroidContentContext.getString(2131363604) + localAppShareID.messagetail;
          }
        }
      }
      for (;;)
      {
        ...
        if (!this.jdField_a_of_type_JavaUtilHashSet.contains(localObject))
        {
          ...
          if (((MessageForPic)localObject).msgtype == -3001) {
            str1 = this.jdField_a_of_type_AndroidContentContext.getString(2131363827);
          }
        }
      }
    }
