  ...
  extends TextView
{
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          ...
          setProgress(i);
          if (this.jdField_a_of_type_Dcj != null) {
            break;
          }
          this.jdField_a_of_type_Dcj = new dcj(this, i, paramInt2);
          postDelayed(this.jdField_a_of_type_Dcj, l);
          return;
          i = paramInt1;
        } while (paramInt1 < 100);
      ...
      this.jdField_a_of_type_Dcj.b(paramInt2);
      return;
      if (QLog.isColorLevel()) {
  ...
  public void setProcessor(BaseTransProcessor paramBaseTransProcessor)
  {
    ...
    if (this.jdField_a_of_type_Dcj != null)
    {
      removeCallbacks(this.jdField_a_of_type_Dcj);
      this.jdField_a_of_type_Dcj = null;
    }
