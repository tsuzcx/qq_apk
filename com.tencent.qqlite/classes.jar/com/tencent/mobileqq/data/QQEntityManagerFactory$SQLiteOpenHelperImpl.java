  ...
  extends SQLiteOpenHelper
{
  ...
  {
    super(BaseApplication.getContext(), paramString, new dco(paramQQEntityManagerFactory, null), paramInt);
    this.databaseName = paramString;
  }
  
  public QQEntityManagerFactory$SQLiteOpenHelperImpl(QQEntityManagerFactory paramQQEntityManagerFactory, String paramString, SQLiteDatabase.CursorFactory paramCursorFactory, int paramInt, dcq paramdcq)
  {
    super(BaseApplication.getContext(), paramString, new dco(paramQQEntityManagerFactory, null), paramInt, paramdcq);
    this.databaseName = paramString;
  }
  ...
  public SQLiteDatabase getReadableDatabase()
  {
    ...
    //   2: aload_0
    //   3: aload_0
    //   4: invokespecial 116	android/database/sqlite/SQLiteOpenHelper:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   7: putfield 102	com/tencent/mobileqq/data/QQEntityManagerFactory$SQLiteOpenHelperImpl:dbR	Landroid/database/sqlite/SQLiteDatabase;
    //   10: aload_0
    //   11: getfield 102	com/tencent/mobileqq/data/QQEntityManagerFactory$SQLiteOpenHelperImpl:dbR	Landroid/database/sqlite/SQLiteDatabase;
    //   14: astore_1
    //   15: aload_0
    //   16: monitorexit
    //   17: aload_1
