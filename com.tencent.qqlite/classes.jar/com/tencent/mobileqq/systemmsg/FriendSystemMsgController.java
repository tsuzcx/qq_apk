  ...
  implements SystemMsgUiActionInterface
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new efn(this, Looper.getMainLooper());
  ...
  {
    ((NewFriendManager)paramQQAppInterface.getManager(31)).a(new NewFriendMessage(1, 0));
    QQMessageFacade localQQMessageFacade = paramQQAppInterface.a();
    if (localQQMessageFacade != null)
    {
      int i = localQQMessageFacade.e();
      BadgeUtils.a(paramQQAppInterface.a(), i);
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    paramQQAppInterface.a(new efm(this, paramQQAppInterface, paramInt));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString, long paramLong)
  {
    if (this.jdField_a_of_type_Int > 0)
    {
      ...
      ((NewFriendManager)paramQQAppInterface.getManager(31)).a(paramString);
    }
    for (;;)
    {
      ...
      ((NewFriendManager)paramQQAppInterface.getManager(31)).a(new NewFriendMessage(1, 0, paramBoolean));
    }
  }
  ...
  public void a(boolean paramBoolean, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.a(new efo(this, paramQQAppInterface, paramBoolean));
  }
