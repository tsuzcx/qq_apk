  ...
  implements View.OnClickListener, AdapterView.OnItemClickListener
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfCvm = new cvm[6];
  }
  ...
  public void onClick(View paramView)
  {
    ...
    } while (this.jdField_a_of_type_ComTencentMobileqqAppQQServiceEntry$Tag.jdField_a_of_type_JavaLangString.equals(String.valueOf(AppConstants.Y)));
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQServiceEntry$Tag.jdField_a_of_type_AndroidWidgetGridView.setAdapter(new cvn(this, this.jdField_a_of_type_ComTencentMobileqqAppQQServiceEntry$Tag.b));
