  ...
  extends AsyncStep
{
  ...
  {
    if (this.a.e) {
      ((TroopHandler)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(17)).a();
    }
    e();
  }
  ...
  private void d()
  {
    ...
    this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.l = true;
    this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.z();
    this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(false);
    if (this.a.e) {
      ((TroopHandler)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(17)).a();
    }
    e();
    ((EqqDetailDataManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(54)).a();
    ((PhoneContactManagerImp)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(10)).b();
    this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().i();
  }
  ...
  private void f()
  {
    ...
    Object localObject1 = new File(AppConstants.as + "head/" + "_thd/");
