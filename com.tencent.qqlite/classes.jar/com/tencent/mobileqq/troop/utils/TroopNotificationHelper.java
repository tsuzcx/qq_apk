...
public class TroopNotificationHelper
{
  ...
  public static TroopNotificationCache a(eqx parameqx, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    if (parameqx != null)
    {
      if (parameqx.jdField_c_of_type_Int == 1)
      {
        String str2 = a(parameqx.jdField_c_of_type_JavaLangString);
        ...
        str2 = a(parameqx.jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty(parameqx.jdField_a_of_type_JavaLangString))
        {
          str2 = new SimpleDateFormat("yyyy年M月d日").format(new Date(parameqx.jdField_e_of_type_Int * 1000L));
          str2 = str2 + " 群公告";
        }
        ...
        localTroopNotificationCache.title = parameqx.jdField_a_of_type_JavaLangString;
        localTroopNotificationCache.feedType = paramInt1;
        localTroopNotificationCache.appId = paramInt2;
        localTroopNotificationCache.userUin = parameqx.jdField_d_of_type_Int;
        localTroopNotificationCache.troopUin = paramLong;
        localTroopNotificationCache.time = parameqx.jdField_e_of_type_Int;
        localTroopNotificationCache.feedsId = parameqx.jdField_b_of_type_JavaLangString;
        ...
        if (TextUtils.isEmpty(parameqx.jdField_d_of_type_JavaLangString)) {}
        for (localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"1\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, str3, str1 }).getBytes();; localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"6\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /></item><item layout=\"2\"><picture cover=\"%s\"/><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, parameqx.jdField_d_of_type_JavaLangString, str3, str1 }).getBytes()) {
          return localTroopNotificationCache;
        }
      }
      if (parameqx.jdField_c_of_type_Int == 2)
      {
        paramString = new TroopNotificationCache();
        paramString.feedType = paramInt1;
        paramString.appId = paramInt2;
        paramString.userUin = parameqx.jdField_d_of_type_Int;
        paramString.troopUin = paramLong;
        paramString.time = parameqx.jdField_e_of_type_Int;
        paramString.feedsId = parameqx.jdField_b_of_type_JavaLangString;
        paramString.ctrlStr = parameqx.jdField_e_of_type_JavaLangString;
        paramString.xmlBytes = parameqx.jdField_a_of_type_ArrayOfByte;
        paramString.src = parameqx.f;
        paramString.filterID = parameqx.jdField_a_of_type_Long;
  ...
  public static eqx a(DataInputStream paramDataInputStream, boolean paramBoolean)
  {
  ...
  public static eqx a(String paramString, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    int j = 0;
    for (;;)
    {
      ...
      try
      {
        ...
        if ((i == 5) || (i == 19))
        {
          ...
          localObject5 = new eqx(null);
          ((eqx)localObject5).jdField_a_of_type_JavaLangString = paramArrayOfByte;
          ((eqx)localObject5).jdField_b_of_type_JavaLangString = paramString;
          ((eqx)localObject5).jdField_c_of_type_JavaLangString = ((String)localObject3);
          ((eqx)localObject5).jdField_d_of_type_JavaLangString = ((String)localObject1);
          ((eqx)localObject5).jdField_c_of_type_Int = 1;
          return localObject5;
        }
        if (i == 22)
        {
      ...
      long l2 = l1;
      localObject3 = new eqx(null);
      ((eqx)localObject3).jdField_b_of_type_JavaLangString = paramString;
      ((eqx)localObject3).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
      ((eqx)localObject3).jdField_e_of_type_JavaLangString = ((String)localObject1);
      ((eqx)localObject3).jdField_c_of_type_Int = 2;
      ((eqx)localObject3).jdField_a_of_type_Long = l2;
      ((eqx)localObject3).f = i;
      return localObject3;
      return null;
      label679:
      label687:
