  ...
  implements INetInfoHandler
{
  ...
  public final boolean a(TroopFileTransferManager.Item paramItem, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        continue;
        continue;
        new Handler(Looper.getMainLooper()).postDelayed(new eot(this, paramItem), 1000L);
        bool1 = true;
        continue;
  ...
  public final void d()
  {
    if (this.jdField_a_of_type_JavaUtilTimer == null)
    {
      ...
      this.jdField_a_of_type_JavaUtilTimer.schedule(new eov(this), 10000L, 10000L);
    }
  }
  ...
  public final void f()
  {
    ...
    //   31: dup
    //   32: aload_0
    //   33: invokespecial 1154	eow:<init>	(Lcom/tencent/mobileqq/troop/utils/TroopFileTransferManager;)V
  ...
  public final boolean f(TroopFileTransferManager.Item paramItem, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      continue;
      continue;
      new Handler(Looper.getMainLooper()).postDelayed(new eou(this, paramItem), 1000L);
      continue;
