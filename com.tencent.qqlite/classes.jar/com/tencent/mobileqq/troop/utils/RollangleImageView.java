  ...
  extends ImageView
{
  ...
  public static Bitmap a(String paramString)
  {
    if ((jdField_a_of_type_AndroidGraphicsBitmap == null) || (jdField_b_of_type_AndroidGraphicsBitmap == null))
    {
      ...
      jdField_a_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource((Resources)localObject, 2130838307);
      jdField_b_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource((Resources)localObject, 2130838306);
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidOsAsyncTask = new eoh(this).execute(new Boolean[] { Boolean.valueOf(paramBoolean) });
  }
