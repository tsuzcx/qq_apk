...
public class TroopFileError
{
  ...
  {
    eoo localeoo = new eoo(paramLong);
    DialogUtil.a(paramContext, 230, paramContext.getResources().getString(2131362284), paramContext.getResources().getString(2131362285), 2131362220, 2131362221, localeoo, localeoo).show();
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      new Handler(Looper.getMainLooper()).post(new eol(paramContext, paramString1, paramString2, paramInt));
      return;
    }
    ...
    localQQCustomDialog.setPositiveButton(paramContext.getResources().getString(paramInt), new eon());
  ...
  public static void a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (Looper.getMainLooper() != Looper.myLooper())
      {
        new Handler(Looper.getMainLooper()).post(new eok(paramBoolean, paramContext, paramString, i1));
        return;
      }
    }
    ...
    QQToast.a(paramContext, 2130837991, paramString, 0).b(i1);
  }
  ...
  public static void a(TroopFileError.SimpleErrorInfo paramSimpleErrorInfo, long paramLong, QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      return;
      str1 = a(paramQQAppInterface, 2131362257);
      paramQQAppInterface = a(paramQQAppInterface, 2131362258);
      i1 = 1;
      continue;
      paramQQAppInterface = a(paramQQAppInterface, 2131362259);
      continue;
      ...
      i1 = 1;
      continue;
      str1 = a(paramQQAppInterface, 2131362262);
      paramQQAppInterface = a(paramQQAppInterface, 2131362263, new Object[] { str3 });
      i1 = 1;
      continue;
      paramQQAppInterface = a(paramQQAppInterface, 2131362264);
      continue;
      paramQQAppInterface = a(paramQQAppInterface, 2131362265);
      continue;
      paramQQAppInterface = a(paramQQAppInterface, 2131362269);
      continue;
      str1 = a(paramQQAppInterface, 2131362262);
      paramQQAppInterface = a(paramQQAppInterface, 2131362266, new Object[] { str3 });
      i1 = 1;
      continue;
      paramQQAppInterface = a(paramQQAppInterface, 2131362267);
      continue;
      paramQQAppInterface = a(paramQQAppInterface, 2131362268);
      continue;
      paramQQAppInterface = a(paramQQAppInterface, 2131362283);
      continue;
      str1 = a(paramQQAppInterface, 2131362297);
      str2 = a(paramQQAppInterface, 2131362298);
      ...
      paramQQAppInterface = str2;
      continue;
      str1 = a(paramQQAppInterface, 2131362272);
      paramQQAppInterface = a(paramQQAppInterface, 2131362270, new Object[] { str3 });
      i1 = 1;
      continue;
      str1 = a(paramQQAppInterface, 2131362262);
      ...
      continue;
      paramQQAppInterface = a(paramQQAppInterface, 2131362274, new Object[] { str3 });
      continue;
      paramQQAppInterface = a(paramQQAppInterface, 2131362275, new Object[] { str3 });
      continue;
      paramQQAppInterface = a(paramQQAppInterface, 2131362258);
      continue;
      paramQQAppInterface = a(paramQQAppInterface, 2131362276);
      continue;
      paramQQAppInterface = a(paramQQAppInterface, 2131362277);
      continue;
      ...
      {
        paramQQAppInterface = a(paramQQAppInterface, 2131362281, new Object[] { str3 });
      }
      else
      {
        paramQQAppInterface = a(paramQQAppInterface, 2131362282, new Object[] { str3 });
        continue;
        paramQQAppInterface = a(paramQQAppInterface, 2131362283);
        continue;
        paramQQAppInterface = a(paramQQAppInterface, 2131362288);
        continue;
        paramQQAppInterface = a(paramQQAppInterface, 2131362289);
        continue;
        a(paramContext, a(paramQQAppInterface, 2131362290, new Object[] { str3 }), true);
        return;
        ...
        continue;
        paramQQAppInterface = a(paramQQAppInterface, 2131362294);
        continue;
        paramQQAppInterface = a(paramQQAppInterface, 2131362295);
        continue;
        paramQQAppInterface = a(paramQQAppInterface, 2131362299);
      }
    }
    label1153:
