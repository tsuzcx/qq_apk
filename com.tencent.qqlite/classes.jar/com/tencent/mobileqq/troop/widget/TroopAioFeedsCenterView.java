  ...
  implements ViewPager.OnPageChangeListener, Observer
{
  ...
  public TroopAioFeedsCenterView(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopFeedsDataManager = ((TroopInfoManager)paramQQAppInterface.getManager(33)).a(Long.valueOf(Long.parseLong(paramSessionInfo.a)), true);
    this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopFeedsDataManager.addObserver(this);
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopFeedViewFactory = new TroopFeedViewFactory(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, getContext(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopFeedsDataManager, this.jdField_a_of_type_Boolean);
    a(paramQQAppInterface, paramContext);
  }
  
  private void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    inflate(paramContext, 2130903366, this);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131297847));
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager = ((ViewPager)findViewById(2131297297));
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetDotIndexView = ((DotIndexView)findViewById(2131297848));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131297849));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131297084));
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(paramContext, new eqi(this, paramContext));
