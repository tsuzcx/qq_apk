  ...
  extends FrameLayout
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new ept(this);
  public View.OnClickListener a;
  private View.OnLayoutChangeListener jdField_a_of_type_AndroidViewView$OnLayoutChangeListener = new epm(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new epp(this);
  ...
  private SeekBar.OnSeekBarChangeListener jdField_a_of_type_AndroidWidgetSeekBar$OnSeekBarChangeListener = new epv(this);
  ...
  public boolean a;
  View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new epr(this);
  ...
  public boolean c;
  public int d;
  View.OnClickListener jdField_d_of_type_AndroidViewView$OnClickListener = new eps(this);
  ...
  private View.OnClickListener jdField_g_of_type_AndroidViewView$OnClickListener = new epu(this);
  private ImageButton jdField_g_of_type_AndroidWidgetImageButton;
  private boolean jdField_g_of_type_Boolean;
  private View.OnClickListener jdField_h_of_type_AndroidViewView$OnClickListener = new epw(this);
  private ImageButton jdField_h_of_type_AndroidWidgetImageButton;
  private boolean jdField_h_of_type_Boolean;
  private View.OnClickListener jdField_i_of_type_AndroidViewView$OnClickListener = new epn(this);
  ...
  public MediaControllerX(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidHardwareSensorEventListener = new epo(this);
  ...
  {
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)paramView.findViewById(2131297885));
    if (this.jdField_a_of_type_AndroidWidgetImageButton != null)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetMediaControllerX$MediaPlayerControlX.a())
      {
        this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131362353));
    ...
    {
      this.jdField_f_of_type_AndroidWidgetImageButton = ((ImageButton)paramView.findViewById(2131297894));
      if ((this.jdField_f_of_type_AndroidWidgetImageButton != null) && (!this.jdField_g_of_type_Boolean) && (!this.jdField_h_of_type_Boolean))
      {
        ...
        this.jdField_f_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131362355));
      }
      label138:
      this.jdField_g_of_type_AndroidWidgetImageButton = ((ImageButton)paramView.findViewById(2131297892));
    ...
    for (;;)
    {
      ...
      this.jdField_h_of_type_AndroidWidgetImageButton = ((ImageButton)paramView.findViewById(2131297893));
      if (this.jdField_h_of_type_AndroidWidgetImageButton != null)
      {
        this.jdField_h_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131362360));
        this.jdField_h_of_type_AndroidWidgetImageButton.setOnClickListener(new epq(this));
      }
      this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131297886));
      if (this.jdField_a_of_type_AndroidWidgetProgressBar != null)
      {
        this.jdField_a_of_type_AndroidWidgetProgressBar.setContentDescription(getResources().getString(2131362357));
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131297888));
      if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null) {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      }
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297891));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297889));
      ...
      l();
      return;
      this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131362352));
      break;
      label438:
      this.jdField_f_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131362354));
      break label138;
      label458:
      this.jdField_g_of_type_AndroidWidgetImageButton.setVisibility(8);
    }
  ...
  private void k()
  {
    ...
    for (;;)
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131362575), 1).a();
      }
      else
      {
  ...
  protected View a()
  {
    this.jdField_b_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2130903377, null);
  ...
  public void a(Configuration paramConfiguration)
  {
    if (paramConfiguration.orientation == 2)
    {
      ...
      if (this.jdField_f_of_type_AndroidWidgetImageButton != null) {
        this.jdField_f_of_type_AndroidWidgetImageButton.setBackgroundResource(2130838451);
      }
    }
    for (;;)
    {
      ...
      if (paramConfiguration.orientation == 1)
      {
        ...
        if (this.jdField_f_of_type_AndroidWidgetImageButton != null) {
          this.jdField_f_of_type_AndroidWidgetImageButton.setBackgroundResource(2130838452);
        }
      }
    }
  }
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetMediaControllerX$MediaPlayerControlX.a())
    {
      this.jdField_a_of_type_AndroidWidgetImageButton.setBackgroundResource(2130838454);
      this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131362353));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageButton.setBackgroundResource(2130838455);
    this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131362352));
  }
