  ...
  extends Observable
{
  ...
  public TroopFeedsDataManager(QQAppInterface paramQQAppInterface, Long paramLong)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new emm(this, Looper.getMainLooper());
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsHttpWebCgiAsyncTask$Callback = new emo(this);
  ...
  public void a()
  {
    ...
    ThreadManager.a().post(new emn(this));
  }
  ...
  public void a(TroopFeedItem paramTroopFeedItem)
  {
    ...
    ((Bundle)localObject2).putString("version", "3.3.0");
  ...
  public void b()
  {
    ...
    ((Bundle)localObject2).putString("ver", "3.3.0");
