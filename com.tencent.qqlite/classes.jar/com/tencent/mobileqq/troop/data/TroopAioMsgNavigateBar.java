  ...
  implements View.OnClickListener, Animation.AnimationListener
{
  ...
  private void h()
  {
    ...
    if (bool)
    {
      this.jdField_c_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130838218);
      ...
      localObject = String.format(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131362495), new Object[] { Integer.valueOf(this.jdField_d_of_type_Int) });
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130838223);
    }
    for (;;)
    {
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ...
      return;
      this.jdField_c_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130838217);
      break;
      label775:
      i = 2130838232;
      break label264;
      ...
      break label291;
      label787:
      this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130838222);
    }
  }
  ...
  protected void b()
  {
    ...
    this.g = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131493049));
    ...
    for (;;)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        if (this.e == 2)
        {
          ...
          this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131362494) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_AndroidContentContext, (MessageRecord)localObject, false));
          this.jdField_c_of_type_AndroidWidgetRelativeLayout.setTag(TroopAioAgent.Message.a(this.e, 0L, this.jdField_c_of_type_Long));
          j();
        }
        for (;;)
        {
          ...
          this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131362894) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_AndroidContentContext, (MessageRecord)localObject, false));
          this.jdField_c_of_type_AndroidWidgetRelativeLayout.setTag(TroopAioAgent.Message.a(this.e, 0L, this.jdField_c_of_type_Long));
          j();
        }
      }
