  ...
  implements Observer
{
  ...
  public TroopFeedsCenterLogic(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, RelativeLayout paramRelativeLayout, ImageView paramImageView, TroopAioTips paramTroopAioTips)
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new enq(this);
    ...
    this.jdField_a_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDimensionPixelSize(2131493096);
  ...
  private void c(boolean paramBoolean)
  {
    ...
    while ((this.jdField_b_of_type_AndroidWidgetRelativeLayout == null) || (this.jdField_a_of_type_AndroidWidgetImageView == null))
    {
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.findViewById(2131296938));
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130839370);
      RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(i, i);
      localLayoutParams.addRule(7, 2131296939);
      localLayoutParams.addRule(6, 2131296939);
  ...
  public void a()
  {
    if (a())
    {
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131362349));
      b();
      return;
    }
    this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131362351));
    a(true);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_b_of_type_AndroidWidgetImageView != null) && (this.jdField_a_of_type_Boolean))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopAioFeedsCenterView.setFlingGestureListener(new enr(this));
  ...
  public void b(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      if (!a())
      {
        ...
        c(true);
        this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131362350));
        return;
      }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      {
        this.c = true;
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new ens(this));
        return;
      }
