...
public class NotifyLightUtil
{
  ...
  {
    if ((SettingCloneUtil.readValue(paramContext, paramAppInterface.a(), paramContext.getString(2131363279), "qqsetting_notify_blncontrol_key", true)) && ((paramAppInterface.isBackground_Pause) || (!ReflectionUtil.a(BaseApplicationImpl.a))))
    {
