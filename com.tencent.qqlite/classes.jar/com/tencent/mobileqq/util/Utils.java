...
public class Utils
{
  ...
  public static ArrayList a(ArrayList paramArrayList)
  {
    ...
    Arrays.sort(arrayOfObject, new esv());
  ...
  public static void a(String paramString)
  {
    ...
    try
    {
      ...
      else
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d(paramString, 2, "" + arrayOfStackTraceElement[i]);
          }
          i += 1;
        }
      }
  ...
  {
    return (paramString == null) || (paramString.equals(AppConstants.W)) || (paramString.equals(String.valueOf(AppConstants.X))) || (paramString.equals(String.valueOf(AppConstants.Y))) || (paramString.equals(String.valueOf(AppConstants.Z))) || (paramString.equals(String.valueOf(AppConstants.aa))) || (paramString.equals(String.valueOf(AppConstants.V))) || (paramString.equals(String.valueOf(AppConstants.U))) || (paramString.equals(String.valueOf(AppConstants.ai))) || (paramString.equals(String.valueOf(AppConstants.T))) || (paramString.equals(String.valueOf(AppConstants.S))) || (paramString.equals(String.valueOf(AppConstants.aj))) || (paramString.equals(String.valueOf(AppConstants.am))) || (paramString.equals(String.valueOf(AppConstants.ak)));
  }
  ...
  public static byte[] a(byte[] paramArrayOfByte)
  {
    ...
    //   23: newarray byte
    //   25: astore_2
    //   26: new 583	java/io/ByteArrayInputStream
    //   29: dup
    //   30: aload_0
    //   31: invokespecial 586	java/io/ByteArrayInputStream:<init>	([B)V
    //   34: astore 4
    //   36: new 588	java/util/zip/GZIPInputStream
    //   39: dup
    //   40: aload 4
    //   42: invokespecial 591	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   45: astore_3
    //   46: new 593	java/io/ByteArrayOutputStream
    //   49: dup
    //   50: invokespecial 594	java/io/ByteArrayOutputStream:<init>	()V
    //   53: astore_0
    //   54: aload_0
    //   55: astore 7
    //   57: aload_3
    ...
    //   67: aload_2
    //   68: arraylength
    //   69: invokevirtual 598	java/util/zip/GZIPInputStream:read	([BII)I
    //   72: istore_1
    //   73: iload_1
    //   74: ifle +76 -> 150
    //   77: aload_0
    ...
    //   89: iconst_0
    //   90: iload_1
    //   91: invokevirtual 602	java/io/ByteArrayOutputStream:write	([BII)V
    //   94: goto -40 -> 54
    //   97: astore_2
    //   98: aload_0
    //   99: astore 7
    ...
    //   106: astore 5
    //   108: aload_2
    //   109: invokevirtual 605	java/io/IOException:printStackTrace	()V
    //   112: aload_0
    //   113: ifnull +7 -> 120
    //   116: aload_0
    //   117: invokevirtual 608	java/io/ByteArrayOutputStream:close	()V
    //   120: aload_3
    //   121: ifnull +7 -> 128
    //   124: aload_3
    //   125: invokevirtual 609	java/util/zip/GZIPInputStream:close	()V
    //   128: aload 8
    //   130: astore_2
    //   131: aload 4
    //   133: ifnull -115 -> 18
    //   136: aload 4
    //   138: invokevirtual 610	java/io/ByteArrayInputStream:close	()V
    //   141: aconst_null
    //   142: areturn
    //   143: astore_0
    //   144: aload_0
    //   145: invokevirtual 605	java/io/IOException:printStackTrace	()V
    //   148: aconst_null
    //   149: areturn
    //   150: aload_0
    //   151: astore 7
    ...
    //   158: astore 5
    //   160: aload_0
    //   161: invokevirtual 614	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   164: astore_2
    //   165: aload_2
    //   166: astore 5
    //   168: aload_0
    //   169: ifnull +7 -> 176
    //   172: aload_0
    //   173: invokevirtual 608	java/io/ByteArrayOutputStream:close	()V
    //   176: aload_3
    //   177: ifnull +7 -> 184
    //   180: aload_3
    //   181: invokevirtual 609	java/util/zip/GZIPInputStream:close	()V
    //   184: aload 5
    //   186: astore_2
    //   187: aload 4
    //   189: ifnull -171 -> 18
    //   192: aload 4
    //   194: invokevirtual 610	java/io/ByteArrayInputStream:close	()V
    //   197: aload 5
    //   199: areturn
    //   200: astore_0
    //   201: aload_0
    //   202: invokevirtual 605	java/io/IOException:printStackTrace	()V
    //   205: aload 5
    //   207: areturn
    //   208: astore_0
    //   209: aconst_null
    ...
    //   217: ifnull +7 -> 224
    //   220: aload_2
    //   221: invokevirtual 608	java/io/ByteArrayOutputStream:close	()V
    //   224: aload_3
    //   225: ifnull +7 -> 232
    //   228: aload_3
    //   229: invokevirtual 609	java/util/zip/GZIPInputStream:close	()V
    //   232: aload 4
    //   234: ifnull +8 -> 242
    //   237: aload 4
    //   239: invokevirtual 610	java/io/ByteArrayInputStream:close	()V
    //   242: aload_0
    //   243: athrow
    //   244: astore_2
    //   245: aload_2
    //   246: invokevirtual 605	java/io/IOException:printStackTrace	()V
    //   249: goto -7 -> 242
    //   252: astore_0
    //   253: aconst_null
    //   254: astore_2
