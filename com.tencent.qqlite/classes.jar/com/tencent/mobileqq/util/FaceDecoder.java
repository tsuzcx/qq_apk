  ...
  implements FaceDecodeTask.DecodeCompletionListener
{
  ...
  private etx jdField_a_of_type_Etx;
  private ety jdField_a_of_type_Ety;
  ...
  private void e()
  {
    ...
    do
    {
      ...
      catch (Throwable localThrowable1)
      {
        try
        {
          if ((localFaceInfo.jdField_a_of_type_Int == 101) && (this.jdField_a_of_type_Etx == null))
          {
            this.jdField_a_of_type_Etx = new etx(this, null);
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Etx);
          }
  ...
  public void a(QQAppInterface paramQQAppInterface, FaceInfo paramFaceInfo)
  {
    ...
    {
      if (this.jdField_a_of_type_Ety == null)
      {
        this.jdField_a_of_type_Ety = new ety(this, null);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Ety);
      }
  ...
  public void d()
  {
    ...
    c();
    if (this.jdField_a_of_type_Etx != null) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(this.jdField_a_of_type_Etx);
    }
    if (this.jdField_a_of_type_Ety != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(this.jdField_a_of_type_Ety);
      this.jdField_a_of_type_Ety = null;
    }
