  ...
  implements FaceDecodeTask.DecodeCompletionListener
{
  ...
  private eua jdField_a_of_type_Eua;
  private eub jdField_a_of_type_Eub;
  ...
  private FaceDrawable(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, String paramString1, byte paramByte, int paramInt3, String paramString2, boolean paramBoolean, Drawable paramDrawable1, Drawable paramDrawable2)
  {
    ...
    else
    {
      ...
      if (paramInt1 == 101)
      {
        this.jdField_a_of_type_Eua = new eua(this, null);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Eua);
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, FaceInfo paramFaceInfo)
  {
    ...
    {
      if (this.jdField_a_of_type_Eub == null)
      {
        this.jdField_a_of_type_Eub = new eub(this, null);
        paramQQAppInterface.a(this.jdField_a_of_type_Eub);
      }
