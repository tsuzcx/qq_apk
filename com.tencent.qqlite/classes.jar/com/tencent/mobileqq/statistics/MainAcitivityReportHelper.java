...
public class MainAcitivityReportHelper
{
  ...
  public long a;
  public Handler a;
  private Runnable jdField_a_of_type_JavaLangRunnable = new eft(this);
  ...
  public MainAcitivityReportHelper(SplashActivity paramSplashActivity)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new efs(this);
  ...
  {
    new efv(paramContext, paramLong, paramString).execute(new Void[0]);
  }
  ...
  {
    return paramContext.getSharedPreferences("QQLite", 0).getInt("menu_quit_" + paramString, 0);
  }
  ...
  {
    new efw(paramString).execute(new Void[0]);
  }
  ...
  public void a()
  {
    ...
    localSplashActivity.getSharedPreferences("QQLite", 0).edit().putInt("online_friend_enter_count_" + localQQAppInterface.a(), 0).commit();
  ...
  public void a(String paramString)
  {
    ...
    localObject = ((SplashActivity)localObject).getSharedPreferences("QQLite", 0).edit();
    ...
    ((SharedPreferences.Editor)localObject).putInt("plugin_manage_click_count_" + paramString, Leba.e);
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    for (String str = paramQQAppInterface.a();; str = null)
    {
      ...
      ThreadManager.a().schedule(new efu(this, paramQQAppInterface), 60000L);
  ...
  public void b(String paramString)
  {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ActionReport", 2, "Plugin Manage Button Click Count : " + Leba.e);
      }
      if (QLog.isColorLevel()) {
        QLog.d("ActionReport", 2, "Clear Picture Buffer Count : " + AssistantSettingActivity.jdField_a_of_type_Int);
      }
      localObject = ((SplashActivity)localObject).getSharedPreferences("QQLite", 0);
      if (QLog.isColorLevel()) {
  ...
  public void c(String paramString)
  {
    ...
    Leba.e = ((SharedPreferences)localObject).getInt("plugin_manage_click_count_" + paramString, 0);
