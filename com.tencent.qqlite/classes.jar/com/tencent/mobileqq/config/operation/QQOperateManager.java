...
public class QQOperateManager
{
  ...
  public static final String a = "QQOperateVoIP";
  private static byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  public static final int b = 3000;
  public static final String b = "QQOperationVoIPRequestCount";
  public static final int c = 1;
  public static final String c = "QQOperationVoIPRequestCountTime";
  ...
  public static QQOperateManager a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      if ((jdField_a_of_type_ComTencentMobileqqConfigOperationQQOperateManager == null) || (!jdField_a_of_type_ComTencentMobileqqConfigOperationQQOperateManager.a()))
      {
        jdField_a_of_type_ComTencentMobileqqConfigOperationQQOperateManager = new QQOperateManager();
        d = paramQQAppInterface.a();
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    ...
    this.e = ((SharedPreferences)localObject1).getInt(d + "QQOperationVoIPRequestCount", 0);
    long l = ((SharedPreferences)localObject1).getLong(d + "QQOperationVoIPRequestCountTime", 0L);
    if ((this.e == 0) || (l == 0L) || (!a(l)))
    {
      this.e = 0;
      ((SharedPreferences)localObject1).edit().putInt(d + "QQOperationVoIPRequestCount", 0).commit();
      ((SharedPreferences)localObject1).edit().putLong(d + "QQOperationVoIPRequestCountTime", System.currentTimeMillis()).commit();
    }
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((List)localObject1).size() > 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if ((l <= ((QQOperationViopTipTask)localObject5).getEndDate().getTime()) && (l >= ((QQOperationViopTipTask)localObject5).getBeginDate().getTime())) {
              continue;
            }
            this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(localObject5);
            if (l <= ((QQOperationViopTipTask)localObject5).getEndDate().getTime()) {
              continue;
            }
  ...
  public int a(String paramString, int paramInt, QQOperationViopTipTask paramQQOperationViopTipTask, QQAppInterface paramQQAppInterface, List paramList)
  {
    ...
    if (k >= 0)
    {
      ...
      {
        if ((!MsgProxyUtils.f(paramString.msgtype)) || (paramString.extraflag != 0)) {
          break label214;
        }
  ...
  public void a()
  {
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      ...
      this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList.clear();
      if (!TextUtils.isEmpty(d)) {
        PreferenceManager.getDefaultSharedPreferences(BaseApplicationImpl.getContext()).edit().putInt(d + "QQOperationVoIPRequestCount", this.e).commit();
      }
      d = null;
  ...
  public void a(QQAppInterface paramQQAppInterface, QQOperationVoipTipsTaskExcuteRecord paramQQOperationVoipTipsTaskExcuteRecord)
  {
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_ArrayOfByte)
      {
        localObject = a(paramQQOperationVoipTipsTaskExcuteRecord);
        if (localObject == null)
        {
          ...
          localObject = (QQOperateTipNativeShowInfo)paramQQAppInterface.next();
          if ((((QQOperateTipNativeShowInfo)localObject).b != paramQQOperationVoipTipsTaskExcuteRecord.uinType) || (((QQOperateTipNativeShowInfo)localObject).jdField_a_of_type_Int != paramQQOperationVoipTipsTaskExcuteRecord.tipType)) {
            continue;
          }
          if (i == 0)
          {
      ...
      ((QQOperationVoipTipsTaskExcuteRecord)localObject).count += 1;
      paramQQOperationVoipTipsTaskExcuteRecord = (QQOperationVoipTipsTaskExcuteRecord)localObject;
    }
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        localObject = (QQOperationTaskRecord)localIterator.next();
        if (((QQOperationTaskRecord)localObject).taskid == paramQQOperationVoipTipsTaskExcuteRecord.taskid)
        {
          ((QQOperationTaskRecord)localObject).addUinShowCount(paramQQOperationVoipTipsTaskExcuteRecord.uin);
          if (!((QQOperationTaskRecord)localObject).hasShowedUins.contains(paramQQOperationVoipTipsTaskExcuteRecord.uin + "_" + paramQQOperationVoipTipsTaskExcuteRecord.uinType))
          {
            ((QQOperationTaskRecord)localObject).hasShowedUins = (((QQOperationTaskRecord)localObject).hasShowedUins + paramQQOperationVoipTipsTaskExcuteRecord.uin + "_" + paramQQOperationVoipTipsTaskExcuteRecord.uinType + "|");
            ((QQOperationTaskRecord)localObject).aioCount += 1;
          }
          paramQQAppInterface = (QQAppInterface)localObject;
          if (!QLog.isDevelopLevel()) {
            break label725;
          }
          QLog.d("QQOperateVoIP", 4, "QQOperationTaskRecord record.taskid = " + ((QQOperationTaskRecord)localObject).taskid + " existTaskRecord.showCount = " + ((QQOperationTaskRecord)localObject).showCount + " existTaskRecord.aioCount = " + ((QQOperationTaskRecord)localObject).aioCount);
          paramQQAppInterface = (QQAppInterface)localObject;
          break label725;
        }
      }
      else
      {
        ...
        {
          localObject = new QQOperationTaskRecord();
          ((QQOperationTaskRecord)localObject).taskid = paramQQOperationVoipTipsTaskExcuteRecord.taskid;
          ((QQOperationTaskRecord)localObject).aioCount = 1;
          ((QQOperationTaskRecord)localObject).addUinShowCount(paramQQOperationVoipTipsTaskExcuteRecord.uin);
          ((QQOperationTaskRecord)localObject).recordTime = System.currentTimeMillis();
          ((QQOperationTaskRecord)localObject).hasShowedUins = (paramQQOperationVoipTipsTaskExcuteRecord.uin + "_" + paramQQOperationVoipTipsTaskExcuteRecord.uinType + "|");
          this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localObject);
        }
        ((QQOperationTaskRecord)localObject).setStatus(1000);
  ...
  {
    // Byte code:
    //   0: invokestatic 174	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   3: ifeq +29 -> 32
    //   6: ldc 11
    //   8: iconst_4
    ...
    //   22: aload_2
    //   23: invokevirtual 285	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   26: invokevirtual 111	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   29: invokestatic 182	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   32: aload_2
    //   33: ifnull +10 -> 43
    //   36: aload_2
    ...
    //   43: return
    //   44: aload_1
    //   45: invokevirtual 146	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/persistence/EntityManagerFactory;
    //   48: invokevirtual 152	com/tencent/mobileqq/persistence/EntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   51: astore_3
    //   52: aload_3
    //   53: invokevirtual 453	com/tencent/mobileqq/persistence/EntityManager:a	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   56: astore_1
    //   57: aload_1
    //   58: invokevirtual 456	com/tencent/mobileqq/persistence/EntityTransaction:a	()V
    //   61: aload_3
    //   62: ldc 154
    //   64: invokevirtual 459	com/tencent/mobileqq/persistence/EntityManager:a	(Ljava/lang/Class;)Z
    //   67: pop
    //   68: aload_2
    //   69: invokevirtual 265	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   72: astore 4
    //   74: aload 4
    //   76: invokeinterface 195 1 0
    //   81: ifeq +38 -> 119
    //   84: aload_3
    //   85: aload 4
    //   87: invokeinterface 199 1 0
    //   92: checkcast 154	com/tencent/mobileqq/config/operation/QQOperationViopTipTask
    ...
    //   106: aload_1
    //   107: invokevirtual 461	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   110: aload_3
    //   111: invokevirtual 223	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   114: aload_0
    //   115: invokevirtual 462	com/tencent/mobileqq/config/operation/QQOperateManager:a	()V
    //   118: return
    //   119: invokestatic 174	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   122: ifeq +32 -> 154
    //   125: ldc 11
    //   127: iconst_4
    //   128: new 103	java/lang/StringBuilder
    //   131: dup
    //   132: invokespecial 104	java/lang/StringBuilder:<init>	()V
    //   135: ldc_w 464
    ...
    //   151: invokestatic 182	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   154: aload_1
    //   155: invokevirtual 466	com/tencent/mobileqq/persistence/EntityTransaction:c	()V
    //   158: aload_1
    //   159: invokevirtual 461	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   162: goto -52 -> 110
    //   165: astore_2
    //   166: aload_1
    //   167: invokevirtual 461	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   170: aload_2
    //   171: athrow
