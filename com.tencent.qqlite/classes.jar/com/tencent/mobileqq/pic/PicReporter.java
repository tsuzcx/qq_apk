...
public class PicReporter
{
  ...
  {
    boolean bool = SettingCloneUtil.readValue(BaseApplication.getContext(), null, BaseApplication.getContext().getString(2131363052), "qqsetting_auto_receive_pic_key", true);
