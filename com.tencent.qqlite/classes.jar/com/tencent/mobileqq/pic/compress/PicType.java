...
public abstract class PicType
{
  ...
  {
    int i = 80;
    boolean bool = this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_e_of_type_Boolean;
    switch (this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_g_of_type_Int)
    {
    default: 
      i = 100;
    }
  ...
  final int b()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_e_of_type_Boolean) {
      return 20971520;
    }
    return 4194304;
  }
  ...
  boolean b()
  {
    ...
    do
    {
      ...
      if ((FileUtils.b(this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_e_of_type_JavaLangString)) && (!this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_g_of_type_Boolean))
      {
  ...
  public final boolean c()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_g_of_type_Int == 2) {
      if (Utils.a(this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.c) <= c())
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_f_of_type_Int != 2) {
          this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_f_of_type_Boolean = true;
        }
      }
    }
    for (;;)
    {
      ...
      continue;
      if (Utils.a(this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.c) > b())
      {
        Logger.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_a_of_type_JavaLangString + " commonCompress()", " src file size > max, file size:" + Utils.a(this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.c) + " max:" + b());
        this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_e_of_type_JavaLangString = Utils.a(this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.c, this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_g_of_type_Int);
        if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_e_of_type_JavaLangString))
        {
        ...
        int i = a(this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.c, this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_e_of_type_JavaLangString, true);
        if (i != 0)
        {
