...
public class Utils
{
  ...
  private static dzv a(int paramInt1, int paramInt2)
  {
    int i = 0;
    int j = 1;
    int k = PhotoPreviewConstant.l;
    int m = PhotoPreviewConstant.k;
    if (paramInt1 > k) {
    ...
    for (;;)
    {
      dzv localdzv = new dzv(null);
      localdzv.a = paramInt2;
      localdzv.b = paramInt1;
      Logger.a("compress.Utils", "getType()", " type=" + localdzv);
      return localdzv;
      paramInt1 = 2;
      paramInt2 = 2;
      continue;
  ...
  public static String a(String paramString)
  {
    ...
    {
      String str2 = AppConstants.as + "thumb/";
  ...
  public static void a(Context paramContext, List paramList)
  {
    ...
    if (paramList.size() > 1)
    {
      ...
      j = 0;
      localObject1 = "";
      str2 = BaseApplication.getContext().getString(2131364314);
      str3 = BaseApplication.getContext().getString(2131364315);
      str4 = BaseApplication.getContext().getString(2131364316);
      str5 = BaseApplication.getContext().getString(2131364317);
      i1 = 0;
      i = 0;
      str1 = "";
      str6 = BaseApplication.getContext().getString(2131364318);
      str7 = BaseApplication.getContext().getString(2131364319);
      localObject3 = BaseApplication.getContext().getString(2131364320);
      localObject2 = BaseApplication.getContext().getString(2131364321);
    ...
    for (;;)
    {
      ...
      if (k == 0)
      {
        ...
        if (((Iterator)localObject5).hasNext())
        {
          ...
          if ((localObject2 == null) || (((CompressInfo)localObject2).f) || (!((CompressInfo)localObject2).jdField_b_of_type_Boolean)) {
            break label435;
          }
          i1 = 1;
          j = 1;
      ...
      for (;;)
      {
        ...
        QQToast.a(paramContext, (CharSequence)localObject3, 0).b(paramContext.getResources().getDimensionPixelSize(2131492887));
        return;
        n = 0;
        break;
        k = 1;
      ...
      for (;;)
      {
        ...
        {
          m = j;
          if (((CompressInfo)localObject2).f)
          {
            m = j;
            if (((CompressInfo)localObject2).jdField_b_of_type_Boolean)
            {
              ...
              if (i == 0)
              {
                ...
                if (m != 0)
                {
                  QQToast.a(paramContext, (CharSequence)localObject2, 0).b(paramContext.getResources().getDimensionPixelSize(2131492887));
                  return;
                }
                if (i1 == 0) {
                  break;
                }
                QQToast.a(paramContext, (CharSequence)localObject4, 0).b(paramContext.getResources().getDimensionPixelSize(2131492887));
                return;
              }
            }
          }
  ...
  {
    return a(paramString1, paramBitmap, paramInt, paramString2, null);
  }
  ...
  public static boolean a(String paramString1, Bitmap paramBitmap, int paramInt, String paramString2, CompressInfo paramCompressInfo)
  {
    ...
    //   80: iload_2
    //   81: invokevirtual 239	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    ...
    //   98: astore_0
    //   99: aload_0
    //   100: invokevirtual 203	java/io/File:exists	()Z
    //   103: ifeq +8 -> 111
    //   106: aload_0
    //   107: invokevirtual 406	java/io/File:delete	()Z
    //   110: pop
    //   111: aload_0
    //   112: invokevirtual 409	java/io/File:createNewFile	()Z
    //   115: pop
    //   116: new 411	java/io/FileOutputStream
    //   119: dup
    //   120: aload_0
    //   121: invokespecial 414	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   124: astore 6
    //   126: aload 6
    //   128: astore_0
    //   129: aload_1
    //   130: getstatic 420	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   133: iload_2
    //   134: aload 6
    //   136: invokevirtual 424	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   139: pop
    //   140: aload 6
    //   142: astore_0
    //   143: aload 6
    //   145: invokevirtual 427	java/io/FileOutputStream:flush	()V
    //   148: aload 6
    //   150: astore_0
    //   151: aload 6
    //   153: invokevirtual 431	java/io/FileOutputStream:getFD	()Ljava/io/FileDescriptor;
    //   156: astore_1
    //   157: aload_1
    //   158: ifnull +20 -> 178
    //   161: aload 6
    //   163: astore_0
    //   164: aload_1
    //   165: invokevirtual 436	java/io/FileDescriptor:valid	()Z
    //   168: ifeq +10 -> 178
    //   171: aload 6
    //   173: astore_0
    //   174: aload_1
    //   175: invokevirtual 439	java/io/FileDescriptor:sync	()V
    //   178: aload 6
    //   180: ifnull -125 -> 55
    //   183: aload 6
    //   185: invokevirtual 442	java/io/FileOutputStream:close	()V
    //   188: iconst_1
    //   189: ireturn
    //   190: astore_0
    //   191: aload_0
    //   192: invokevirtual 443	java/io/IOException:printStackTrace	()V
    //   195: iconst_1
    //   196: ireturn
    //   197: astore_0
    //   198: aload 4
    ...
    //   206: aload 4
    //   208: iconst_1
    //   209: invokevirtual 446	com/tencent/mobileqq/pic/CompressInfo:b	(Z)V
    //   212: aload 6
    //   214: astore_0
    //   215: ldc 10
    //   217: ldc_w 448
    ...
    //   263: astore_0
    //   264: aload_1
    //   265: invokevirtual 453	java/io/FileNotFoundException:printStackTrace	()V
    //   268: aload 6
    //   270: ifnull +8 -> 278
    //   273: aload 6
    //   275: invokevirtual 442	java/io/FileOutputStream:close	()V
    //   278: iconst_0
    //   279: ireturn
    //   280: astore_0
    //   281: aload 4
    ...
    //   289: aload 4
    //   291: iconst_1
    //   292: invokevirtual 446	com/tencent/mobileqq/pic/CompressInfo:b	(Z)V
    //   295: aload 6
    //   297: astore_0
    //   298: ldc 10
    //   300: ldc_w 448
    ...
    //   346: astore_0
    //   347: aload_1
    //   348: invokevirtual 443	java/io/IOException:printStackTrace	()V
    //   351: aload 6
    //   353: ifnull +8 -> 361
    //   356: aload 6
    //   358: invokevirtual 442	java/io/FileOutputStream:close	()V
    //   361: iconst_0
    //   362: ireturn
    //   363: astore_0
    //   364: aload_0
    //   365: invokevirtual 443	java/io/IOException:printStackTrace	()V
    //   368: goto -90 -> 278
    //   371: astore_0
    //   372: aload_0
    //   373: invokevirtual 443	java/io/IOException:printStackTrace	()V
    //   376: goto -15 -> 361
    //   379: astore_1
    //   380: aconst_null
    //   381: astore_0
    ...
    //   383: ifnull +7 -> 390
    //   386: aload_0
    //   387: invokevirtual 442	java/io/FileOutputStream:close	()V
    //   390: aload_1
    //   391: athrow
    //   392: astore_0
    //   393: aload_0
    //   394: invokevirtual 443	java/io/IOException:printStackTrace	()V
    //   397: goto -7 -> 390
    //   400: astore_1
    //   401: goto -19 -> 382
    //   404: astore_1
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        default: 
          ...
          bool2 = true;
          Logger.a("compress.Utils", "compressAIOThumbnail()", paramString3 + " sample after W:" + j + " H:" + i + " isLongImg:" + a(0, 0) + " type:" + localdzv + " needRotate:" + bool2);
          if (m <= k) {
            break label952;
          }
          i3 = m;
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          catch (OutOfMemoryError paramString1)
          {
            ...
            paramString1.printStackTrace();
            Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " cut 3:1 createBitmap OutOfMemoryError, type:" + localdzv);
            return false;
          }
        }
        i = k;
        ...
        for (;;)
        {
          ...
          catch (OutOfMemoryError paramString1)
          {
            ...
            catch (OutOfMemoryError paramString1)
            {
              ...
              paramString1.printStackTrace();
              Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " case 1: cut createBitmap OutOfMemoryError, type:" + localdzv);
              return false;
            }
            ...
            paramString1.printStackTrace();
            Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " case 1: scale or rotate createBitmap OutOfMemoryError, type:" + localdzv);
            return false;
          }
          j = n;
          i = i2;
          ...
          for (m = n;; m = i1)
          {
            for (;;)
            {
              ...
              catch (OutOfMemoryError paramString1)
              {
                ...
                ((Bitmap)localObject2).recycle();
                paramString1.printStackTrace();
                Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " case 2: scale or rotate createBitmap OutOfMemoryError, type:" + localdzv);
                return false;
              }
            }
            k = n;
          ...
          catch (OutOfMemoryError paramString1)
          {
            ...
            paramString1.printStackTrace();
            Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " case 3: rotate createBitmap OutOfMemoryError, type:" + localdzv);
            return false;
          }
        }
        if (bool2)
        ...
        for (;;)
        {
          ...
          catch (OutOfMemoryError paramString1)
          {
            ...
            catch (OutOfMemoryError paramString2)
            {
              ...
              Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " case 4: cut createBitmap OutOfMemoryError, type:" + localdzv);
              return false;
            }
            paramString1 = paramString1;
            if (localObject2 != null) {
            ...
            paramString1.printStackTrace();
            Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " case 4: rotate createBitmap OutOfMemoryError, type:" + localdzv);
            return false;
          }
          i = i1;
          continue;
