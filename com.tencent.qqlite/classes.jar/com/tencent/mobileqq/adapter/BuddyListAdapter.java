...
{
  private static final cov jdField_a_of_type_Cov = new cov(null);
  ...
  public BuddyListAdapter(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, View.OnClickListener paramOnClickListener)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130838648);
    paramExpandableListView.post(new cop(this));
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    label216:
    Object localObject2;
    if ((paramView == null) || ((paramView.getTag() instanceof cow)))
    {
      ...
      ((cos)localObject1).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131296453));
      ((cos)localObject1).d = ((TextView)localView.findViewById(2131296851));
      ((cos)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131296853));
      ((cos)localObject1).e = ((TextView)localView.findViewById(2131296854));
      ((cos)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131296852));
      ...
      ((cos)localObject1).jdField_a_of_type_JavaLangObject = paramView;
      ((cos)localObject1).jdField_a_of_type_JavaLangString = localFriends.uin;
      ...
      ((cos)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText("[" + (String)localObject2 + "]");
      paramViewGroup = ((cos)localObject1).jdField_b_of_type_AndroidWidgetImageView;
      if (paramInt1 == 0) {
        break label497;
      }
      ...
      ((cos)localObject1).e.setText(paramViewGroup);
      ((cos)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      ((cos)localObject1).d.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColorStateList(2131427471));
      paramView = (View)localObject2;
      label347:
      localObject2 = ContactUtils.a(localFriends);
      ((cos)localObject1).d.setText((CharSequence)localObject2);
      ((cos)localObject1).e.setVisibility(0);
    ...
    for (;;)
    {
      ...
      return localView;
      localObject1 = (cos)paramView.getTag();
      ((cos)localObject1).d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      ((cos)localObject1).e.setCompoundDrawables(null, null, null, null);
      localView = paramView;
      break;
      label485:
      paramInt1 = 0;
      ...
      default: 
        ...
        {
          paramInt2 = 1;
          localObject2 = ((cos)localObject1).jdField_b_of_type_AndroidWidgetImageView;
          if (paramInt2 == 0) {
            break label958;
          }
          ...
          ((cos)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText("[" + paramView + "]");
          paramViewGroup = a(localFriends, (cos)localObject1);
          j = 1;
          ((cos)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
          paramInt1 = 0;
          if (paramInt2 != 0) {
            break label977;
          }
          ...
          if (i != 0)
          {
            ...
            ((cos)localObject1).jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(paramInt1);
          }
          localObject2 = ((cos)localObject1).jdField_a_of_type_AndroidWidgetImageView;
          if (i == 0) {
            break label983;
          }
          paramInt1 = 0;
          ...
          ((cos)localObject1).d.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColorStateList(2131427517));
        }
        break;
      }
      for (;;)
      {
        ...
        ((cos)localObject1).d.setCompoundDrawablePadding(this.f);
        ((cos)localObject1).d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130839406, 0);
        break;
      ...
      {
        ((cos)localObject1).d.setCompoundDrawablePadding(this.f);
        ((cos)localObject1).d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130839483, 0);
        break label347;
      }
      ((cos)localObject1).d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      break label347;
  ...
  {
    Collections.sort(paramList, jdField_a_of_type_Cov);
  }
  ...
  {
    if ((paramView == null) || ((paramView.getTag() instanceof cos)))
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130903273, paramViewGroup, false);
      paramViewGroup = new cow();
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131296453));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131297442));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131296851));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297440));
      paramViewGroup.c = ((TextView)paramView.findViewById(2131297439));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297441));
    ...
    for (;;)
    {
      ...
      if (PublicAccountInfo.isLooker(localPublicAccountInfo))
      {
        ...
        return paramView;
        paramViewGroup = (cow)paramView.getTag();
      ...
      else
      {
        ...
        if (localPublicAccountInfo.certifiedGrade > 0L)
        {
          ...
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130838183);
        }
        for (;;)
        {
  ...
  private void c()
  {
    ...
    while (i < j)
    {
      ...
      if ((localObject != null) && ((localObject instanceof cos)))
      {
        localObject = (cos)localObject;
        if ((TextUtils.isEmpty(((cos)localObject).e.getText().toString())) && ((((cos)localObject).jdField_a_of_type_JavaLangObject instanceof Friends))) {
          a((Friends)((cos)localObject).jdField_a_of_type_JavaLangObject, (cos)localObject);
        }
      }
      i += 1;
    }
      ...
      for (localObject2 = (List)((ConcurrentHashMap)localObject1).get(String.valueOf(localGroups.group_id));; localObject2 = null)
      {
        ...
        for (localObject2 = new ArrayList();; localObject2 = new ArrayList((Collection)localObject2))
        {
          ...
          while (((Iterator)localObject5).hasNext()) {
            ((ArrayList)localObject4).add(new cot((Friends)((Iterator)localObject5).next(), -1));
          }
          if (QLog.isColorLevel()) {
        ...
        while (((Iterator)localObject4).hasNext()) {
          ((List)localObject2).add(((cot)((Iterator)localObject4).next()).a);
        }
        label462:
  ...
  SpannableString a(Friends paramFriends, cos paramcos)
  {
    ...
    if (this.jdField_a_of_type_Int != 0)
    {
      ...
      paramcos.e.setCompoundDrawables((Drawable)localObject, null, null, null);
    }
    for (;;)
    {
      paramFriends = paramFriends.a(null);
      paramcos.e.setText(paramFriends);
      return paramFriends;
      bool = false;
      break;
      label138:
      paramcos.e.setCompoundDrawables(null, null, null, null);
    }
  }
  
  public void a(View paramView, int paramInt)
  {
    Object localObject = (cou)paramView.getTag();
    if (localObject == null)
    {
      localObject = new cou();
      paramView.findViewById(2131296847).setVisibility(0);
      ((cou)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131296848));
      ((cou)localObject).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131296849));
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      paramViewGroup = (cou)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramViewGroup = new cou();
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131296848));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131296849));
      paramView.setTag(paramViewGroup);
  ...
  {
    paramView = (cou)paramView.getTag();
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    String str = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131363790);
    localQQCustomMenu.a(0, str);
    this.jdField_a_of_type_ComTencentWidgetMenuPopupDialog = MenuPopupDialog.a(paramView, str, localQQCustomMenu, this.b, new coq(this));
    return true;
  }
}
