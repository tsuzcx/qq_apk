  ...
  extends FacePreloadBaseAdapter
{
  ...
  private Comparator jdField_a_of_type_JavaUtilComparator = new cps(this);
  ...
  private View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.d.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColorStateList(2131427518));
      label328:
      if (!localFriends.isServiceEnabled(EVIPSPEC.E_SP_SUPERVIP)) {
        break label486;
      }
      paramViewGroup.d.setCompoundDrawablePadding(this.c);
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130839436, 0);
    }
    for (;;)
    {
      ...
      break;
      label430:
      paramViewGroup.b.setImageResource(2130838529);
      break label135;
      label443:
      bool = false;
      break label158;
      ...
      {
        paramViewGroup.d.setCompoundDrawablePadding(this.c);
        paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130839513, 0);
      }
      else
      {
        paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
