  ...
  extends AbsShareMsg
{
  ...
  private static View.OnClickListener a = new egq();
  ...
  public static boolean resendAndUploadImageShare(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, StructMsgForImageShare paramStructMsgForImageShare)
  {
    ...
    localTransferRequest.h = paramStructMsgForImageShare.h;
      ...
      do
      {
        ...
        do
        {
          ...
          for (;;)
          {
            ...
            return null;
            str1 = str2;
            localFile = new File(AbsStructMsg.az);
            str1 = str2;
            if (!localFile.exists())
            {
              str1 = str2;
  ...
  public static boolean sendAndUploadImageShare(QQAppInterface paramQQAppInterface, StructMsgForImageShare paramStructMsgForImageShare, String paramString, int paramInt)
  {
    ...
    if (FileUtils.c(localStructMsgItemImage.h))
    {
      localObject = HexUtil.bytes2HexStr(MD5.getFileMd5(localStructMsgItemImage.h));
      if (localObject == null)
      {
        if (QLog.isColorLevel()) {
      ...
      if (!AbsDownloader.a((String)localObject))
      {
        ...
        FileUtils.c(localStructMsgItemImage.h, (String)localObject);
      }
    }
    ...
    ((TransferRequest)localObject).h = localStructMsgItemImage.h;
  ...
  public View getPreDialogView(Context paramContext, View paramView)
  {
    ...
    paramView.setContentDescription(paramContext.getString(2131364510));
    paramContext = ((Resources)localObject1).getDrawable(2130839430);
    ...
    if ((localObject1 != null) && (((StructMsgItemImage)localObject1).h != null))
    {
      ...
      {
        localObject2 = com.tencent.biz.common.util.ImageUtil.b(((StructMsgItemImage)localObject1).h, i * 288);
        if (localObject2 != null)
        {
          paramView.setImageBitmap(com.tencent.mobileqq.utils.ImageUtil.a((Bitmap)localObject2, new File(((StructMsgItemImage)localObject1).h)));
          return paramView;
        }
  ...
  public View getView(Context paramContext, View paramView, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    for (;;)
    {
      ...
      paramOnLongClickAndTouchListener.setId(2131296292);
      paramOnLongClickAndTouchListener.setTag(2131296292, this);
