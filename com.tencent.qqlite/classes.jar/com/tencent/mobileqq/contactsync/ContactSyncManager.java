  ...
  implements Manager
{
  ...
  private ContactBindObserver jdField_a_of_type_ComTencentMobileqqPhonecontactContactBindObserver = new dcc(this);
  private Runnable jdField_a_of_type_JavaLangRunnable = new dce(this);
  ...
  private List a()
  {
    ...
    ((ContentResolver)localObject).delete(dci.a(c()), "deleted>0", null);
    Cursor localCursor = ((ContentResolver)localObject).query(dci.a(c()), dci.jdField_a_of_type_ArrayOfJavaLangString, null, null, null);
  ...
  private void a(List paramList, PhoneContact paramPhoneContact, long paramLong)
  {
    ...
    Cursor localCursor = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getContentResolver().query(dcg.jdField_a_of_type_AndroidNetUri, dcg.jdField_a_of_type_ArrayOfJavaLangString, "raw_contact_id=?", new String[] { String.valueOf(paramLong) }, null);
    if (localCursor != null) {
      while (localCursor.moveToNext()) {
        if (localCursor.getString(1).equals("vnd.android.cursor.item/name"))
        {
          ...
          if ((TextUtils.isEmpty((CharSequence)localObject)) || (!((String)localObject).equals(paramPhoneContact.name)))
          {
            ...
            localObject = ContentUris.withAppendedId(dcg.jdField_a_of_type_AndroidNetUri, paramLong);
  ...
  private Map b()
  {
    Cursor localCursor = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getContentResolver().query(dch.jdField_a_of_type_AndroidNetUri, dch.jdField_a_of_type_ArrayOfJavaLangString, null, null, null);
    ...
    try
    {
      ...
      while (i < j)
      {
        ...
        synchronized (jdField_a_of_type_JavaUtilSet)
        {
          ...
          localAccountManager.removeAccount(localAccount, new dcf(this), null);
          i += 1;
        }
      }
      return;
  ...
  public SimplePhoneContact a(Uri paramUri)
  {
    ...
    Cursor localCursor = ((ContentResolver)localObject).query(dcg.jdField_a_of_type_AndroidNetUri, dcg.jdField_a_of_type_ArrayOfJavaLangString, "raw_contact_id=?", new String[] { String.valueOf(l1) }, null);
    if (localCursor != null) {
      while (localCursor.moveToNext()) {
        if (localCursor.getString(1).equals("vnd.android.cursor.item/name")) {
    ...
    {
      localCursor.close();
      localObject = ((ContentResolver)localObject).query(ContactsContract.RawContacts.CONTENT_URI, dci.b, "_id=?", new String[] { String.valueOf(l1) }, null);
      if (localObject != null) {
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getContentResolver().delete(dci.a(c()), "sourceid=?", new String[] { paramString });
  }
  ...
  public String b(GetOnlineInfoResp paramGetOnlineInfoResp)
  {
    ...
    while (i != 0)
    {
      return String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getApplicationContext().getResources().getString(2131364358), new Object[] { str1, paramGetOnlineInfoResp });
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getApplicationContext().getString(2131364362);
      paramGetOnlineInfoResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getApplicationContext().getString(2131364364);
      i = 1;
      continue;
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getApplicationContext().getString(2131364362);
      paramGetOnlineInfoResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getApplicationContext().getString(2131364365);
      i = 1;
      continue;
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getApplicationContext().getString(2131364362);
      paramGetOnlineInfoResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getApplicationContext().getString(2131364366);
      i = 1;
      continue;
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getApplicationContext().getString(2131364363);
      paramGetOnlineInfoResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getApplicationContext().getString(2131364367);
      i = 1;
    }
  }
  ...
  public boolean b()
  {
    ...
    BaseApplicationImpl.a.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    if (!this.c) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new dcd(this));
    }
    for (;;)
    {
      return true;
