...
public class j
{
  ...
  public static j a(ByteBuffer paramByteBuffer)
    throws IOException
  {
    ...
    j localj = new j();
    localj.a = c.c(paramByteBuffer, m);
    if (i != 0) {
      localj.c = c.c(paramByteBuffer, i);
    }
    ...
    localj.f = localByteBuffer;
    localj.b = new String[m];
    ...
    if (k != 0)
    {
      ...
      localj.d = c.c(paramByteBuffer, i / 4);
    }
    return localj;
  }
 ...
 * Qualified Name:     com.tencent.theme.j
