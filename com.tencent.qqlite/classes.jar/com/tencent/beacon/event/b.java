  ...
  extends com.tencent.beacon.upload.a
{
        ...
        if ((paramList == null) && (localObject1 == null))
        {
          ...
          else if ("UA".equals(locali.b()))
          {
            ...
            else
            {
              ...
              break label740;
              if (this.g.size() > 0) {
                g.a(this.d, (Long[])this.g.toArray(new Long[this.g.size()]));
              }
  ...
  public final com.tencent.beacon.c.a.b a()
  {
    for (;;)
    {
      try
      {
        ...
        if ((localObject1 == null) || (!((n)localObject1).h()))
        {
          com.tencent.beacon.d.a.c(" imposiable! ua not ready!", new Object[0]);
          localObject1 = null;
          return localObject1;
        }
        localObject1 = ((n)localObject1).k();
        if (localObject1 == null)
        {
        ...
        catch (Throwable localThrowable1)
        {
          try
          {
            ...
            if (i < this.f.length)
            {
              this.f[i] = Long.valueOf(((i)localList.get(i)).a());
              i += 1;
              continue;
            }
            localList.clear();
  ...
  public final void a(boolean paramBoolean)
  {
    ...
    //   9: invokestatic 173	com/tencent/beacon/d/a:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   12: iload_1
    //   13: ifeq +20 -> 33
    //   16: aload_0
    ...
    //   44: invokestatic 166	com/tencent/beacon/a/g:a	(Landroid/content/Context;[Ljava/lang/Long;)I
    //   47: istore_2
    ...
    //   58: iload_2
    //   59: invokevirtual 171	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   62: invokevirtual 79	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   65: iconst_0
    //   66: anewarray 81	java/lang/Object
    //   69: invokestatic 173	com/tencent/beacon/d/a:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   72: aload_0
    //   73: aconst_null
