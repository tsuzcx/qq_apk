  ...
  extends HttpAsyncTask
{
  ...
  {
    if (!isCancelled()) {
      this.jdField_a_of_type_AndroidOsHandler.post(new ffp(this, paramHashMap));
    }
  }
  ...
  public HashMap b(Bundle... paramVarArgs)
  {
    ...
    long l1 = 0L;
    String str2 = MsfSdkUtils.insertMtype("yingyongbao", this.i);
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          try
          {
            localStatistic = a(this.i, this.j, paramVarArgs[0]);
            l2 = l1;
            l4 = l1;
