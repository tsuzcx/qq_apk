...
public class ToastUtil
{
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new fda(this, paramInt1, paramInt2));
  }
  
  public void a(View paramView, int paramInt)
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new fdb(this, paramView, paramInt));
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new fcz(this, paramString, paramInt));
  }
}
