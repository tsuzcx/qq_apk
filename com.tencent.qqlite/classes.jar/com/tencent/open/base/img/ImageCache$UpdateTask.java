  ...
  public void run()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject1 = Common.b() + ImageCache.jdField_b_of_type_JavaLangString + this.jdField_b_of_type_JavaLangString + File.separator + FileUtils.a(this.jdField_c_of_type_JavaLangString);
        ...
        if (localImageInfo == null)
        {
          ...
          this.jdField_a_of_type_ComTencentOpenBaseImgImageDownCallback.a(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, Common.b() + ImageCache.jdField_b_of_type_JavaLangString + this.jdField_b_of_type_JavaLangString + File.separator + FileUtils.a(((ImageInfo)localObject1).jdField_b_of_type_JavaLangString));
          return;
        }
