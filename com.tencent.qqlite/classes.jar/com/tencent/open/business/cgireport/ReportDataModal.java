...
public class ReportDataModal
{
  ...
  public ArrayList a(String paramString1, String paramString2)
  {
    ...
    //   384: aload 5
    //   386: invokevirtual 124	java/util/ArrayList:size	()I
    //   389: invokevirtual 57	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   392: invokevirtual 60	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   395: invokestatic 66	com/tencent/open/base/LogUtility:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   398: aload_0
    //   399: monitorexit
    //   400: aload 5
    //   402: areturn
    //   403: astore_1
    //   404: getstatic 18	com/tencent/open/business/cgireport/ReportDataModal:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   407: ldc 105
    //   409: aload_1
    //   410: invokestatic 108	com/tencent/open/base/LogUtility:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   413: goto -15 -> 398
    //   416: aload_3
    //   417: ifnull -70 -> 347
    //   420: aload_3
    //   421: invokeinterface 99 1 0
    //   426: goto -79 -> 347
    //   429: astore_1
    //   430: aload_0
    //   431: monitorexit
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	466	0	this	ReportDataModal
    //   0	466	1	paramString1	String
    //   0	466	2	paramString2	String
    //   81	375	3	localObject	Object
    //   459	1	3	localException1	Exception
    //   30	207	4	str1	String
    //   298	163	4	localException2	Exception
    //   16	385	5	localArrayList	ArrayList
