...
public class AppUtil
{
  ...
  public static String a(String[] paramArrayOfString)
  {
    ...
    //   19: astore_1
    //   20: new 249	java/io/DataOutputStream
    //   23: dup
    //   24: aload_1
    //   25: invokevirtual 255	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   28: invokespecial 258	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   31: astore_2
    //   32: new 260	java/io/DataInputStream
    //   35: dup
    //   36: aload_1
    //   37: invokevirtual 264	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   40: invokespecial 267	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   43: astore_0
    //   44: aload_0
    //   45: ifnull +88 -> 133
    //   48: aload_2
    //   49: ifnull +84 -> 133
    //   52: aload_0
    //   53: invokevirtual 270	java/io/DataInputStream:readLine	()Ljava/lang/String;
    //   56: astore_0
    //   57: aload_2
    //   58: ldc_w 272
    //   61: invokevirtual 275	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   64: aload_2
    //   65: invokevirtual 278	java/io/DataOutputStream:flush	()V
    //   68: aload_1
    //   69: invokevirtual 281	java/lang/Process:waitFor	()I
    //   72: pop
    //   73: aload_0
    //   74: astore_2
    //   75: aload_1
    ...
    //   109: ifnull +7 -> 116
    //   112: aload_1
    //   113: invokevirtual 284	java/lang/Process:destroy	()V
    //   116: aload_0
    //   117: athrow
    //   118: astore_0
    //   119: goto -11 -> 108
  ...
  public static boolean a(Context paramContext)
  {
    ...
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getBoolean("qqsetting_package_scan_flag", true);
  }
    ...
    if (localIntent == null)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ((StartAppCheckHandler)((BaseActivity)paramContext).app.a(20)).b(paramString.trim(), paramContext, localIntent);
            return true;
          }
