  ...
  implements HttpCgiAsyncTask.Callback
{
  ...
  public AppReport$FullReportCallback(Context paramContext, String paramString, WebView paramWebView)
  {
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    if (i == 0)
    {
      ...
      if ((this.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentSmttSdkWebView != null))
      {
        ...
        localObject = BaseApplicationImpl.a().getFirstSimpleAccount();
        paramJSONObject = "";
        if (localObject != null) {
