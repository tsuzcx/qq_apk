...
public class DownloadManager
{
  ...
  protected DownloadManager()
  {
    ...
    this.jdField_a_of_type_ComTencentTmassistantsdkDownloadclientITMAssistantDownloadSDKClientListener = new fer(this);
    ...
    ThreadManager.b().post(new feo(this));
  }
  ...
  public int a(String paramString)
  {
    ...
    {
      ThreadManager.b().post(new fef(this, (String)localObject));
  ...
  public void a()
  {
    ThreadManager.b().post(new fec(this));
  }
  ...
  {
    new Handler(Looper.getMainLooper()).post(new fek(this, paramBundle, paramActivity, paramInt1, paramApkUpdateDetail, paramInt2));
  }
  ...
  public void a(DownloadInfo paramDownloadInfo)
  {
    ...
    //   25: aload_0
    //   26: aload_1
    //   27: invokespecial 529	fed:<init>	(Lcom/tencent/open/downloadnew/DownloadManager;Lcom/tencent/open/downloadnew/DownloadInfo;)V
    ...
    //   153: aload_3
    //   154: aload 4
    //   156: invokespecial 553	fee:<init>	(Lcom/tencent/open/downloadnew/DownloadManager;Ljava/lang/String;ILcom/tencent/open/downloadnew/DownloadInfo;Lcom/tencent/open/downloadnew/DownloadInfo;)V
  ...
  public void a(DownloadInfo paramDownloadInfo, int paramInt, String paramString)
  {
    ...
    if ((paramInt >= 400) && (paramInt <= 599))
    {
      try
      {
        CommonDataAdapter.a().a().getString(2131362095);
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (((Iterator)localObject).hasNext())
        {
          ...
          {
            ThreadManager.b().post(new feu(this, paramDownloadInfo));
            return;
          }
          ThreadManager.b().post(new fev(this, paramDownloadInfo));
          return;
          paramString = CommonDataAdapter.a().a().getString(2131362100);
          i = 3;
          break;
          ...
          i = 3;
          break;
          paramString = CommonDataAdapter.a().a().getString(2131362098);
          i = 3;
          break;
          paramString = CommonDataAdapter.a().a().getString(2131362099);
          i = 3;
          break;
          ...
          {
            ThreadManager.b().post(new few(this, (String)localObject));
            break;
          }
        }
      }
  ...
  protected void b()
  {
    ThreadManager.b().postDelayed(new fep(this), 5000L);
    ThreadManager.b().postDelayed(new feq(this), 10000L);
  }
  ...
  public void b(DownloadInfo paramDownloadInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        if (paramDownloadInfo.jdField_f_of_type_Int == 1) {
          ThreadManager.b().post(new feg(this, paramDownloadInfo));
        } else {
          ThreadManager.b().post(new feh(this, paramDownloadInfo));
        }
      }
      else {
        ThreadManager.b().post(new fei(this, paramDownloadInfo));
      }
    }
  }
  ...
  public void b(String paramString)
  {
    ...
    for (localObject = ((DownloadInfo)localObject).jdField_h_of_type_JavaLangString;; localObject = ((DownloadInfo)localObject).jdField_c_of_type_JavaLangString)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        ThreadManager.b().post(new fex(this, (String)localObject));
      }
  ...
  public void e()
  {
    ...
    //   61: dup
    //   62: aload_0
    //   63: invokespecial 928	fej:<init>	(Lcom/tencent/open/downloadnew/DownloadManager;)V
  ...
  protected void f()
  {
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 200) {
      ThreadManager.b().postDelayed(new fen(this), 3000L);
    }
  }
}
