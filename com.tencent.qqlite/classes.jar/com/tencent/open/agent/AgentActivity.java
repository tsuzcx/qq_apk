      ...
      catch (Exception paramBundle)
      {
        ...
        if ("action_login".equals(localObject))
        {
          ...
          if (!TextUtils.isEmpty(str2))
          {
            ...
            str2 = a(this, str2, (String)localObject);
            localBundle.putString("sign", str2);
            localBundle.putString("time", (String)localObject);
            if (QLog.isColorLevel()) {
              QLog.d("AgentActivity", 2, "-->onCreate, sign: " + str2);
            }
          }
        }
        try
        {
          OpenSdkStatic.a().a(0, "LOGIN_CHECK_AGENT", null, null, null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
          if (paramBundle != null)
          {
            ...
            try
            {
              OpenSdkStatic.a().a(1, "LOGIN_CHECK_AGENT", null, null, null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "AgentActivity callFromPackageName is null");
            }
