...
public class ReportCenter
{
  ...
  {
    this.jdField_b_of_type_AndroidOsHandler = new fen(this, Looper.getMainLooper());
  ...
  private void a(Bundle paramBundle, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_AndroidOsHandler.post(new feo(this, paramString2, paramBundle, paramBoolean));
        return;
      }
  ...
  public void a()
  {
    this.jdField_a_of_type_JavaUtilConcurrentExecutor.execute(new feq(this));
  }
  ...
  public void a(String paramString1, long paramLong1, long paramLong2, long paramLong3, int paramInt, long paramLong4, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new fep(this, paramLong1, paramString2, paramString1, paramString3, paramInt, paramLong2, paramLong3, paramLong4, paramBoolean));
  }
  
  public void a(String paramString1, String paramString2, Bundle paramBundle, boolean paramBoolean)
  {
    this.jdField_a_of_type_JavaUtilConcurrentExecutor.execute(new fes(this, paramBundle, paramString1, paramBoolean));
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_JavaUtilConcurrentExecutor.execute(new fer(this));
  }
}
