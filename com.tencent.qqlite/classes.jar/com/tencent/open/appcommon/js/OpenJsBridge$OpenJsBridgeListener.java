  ...
  extends JsBridge.JsBridgeListener
{
  ...
  public void a(String paramString, Object paramObject)
  {
    ...
    for (;;)
    {
      new Handler(Looper.getMainLooper()).post(new fct(this, paramString, str, localWebView));
      return;
  ...
  public void c(String paramString)
  {
    ...
    new Handler(Looper.getMainLooper()).post(new fcu(this, paramString, localWebView));
  }
}
