  ...
  extends AppInterface
{
  ...
  public Bitmap a(String paramString)
  {
    ...
    return BitmapManager.a(AppConstants.as + "appicon/" + paramString);
  }
  ...
  public String a(String paramString)
  {
    ...
    return AppConstants.aF + paramString + ".png";
  }
  ...
  public void a(Context paramContext, String paramString)
  {
    if (((paramContext instanceof Activity)) && (!((Activity)paramContext).isFinishing()))
    {
      ...
      paramContext.setNegativeButton("确定", new fgk(this));
      paramContext.show();
    }
  }
  ...
  public void a(String paramString, Bitmap paramBitmap)
  {
    ...
    File localFile = new File(AppConstants.as + "appicon/");
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  ...
  public String b(String paramString)
  {
    ...
    str = MD5.toMD5(str + paramString);
    paramString = MD5.toMD5(str + paramString);
    return AppConstants.aU + paramString + ".png";
  }
