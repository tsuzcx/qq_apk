  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 40, 50 }, new String[] { "iResult", "sErrMsg", "iInterval", "rptMsgAppInfo", "uiUin", "rptSetting" }, new Object[] { Integer.valueOf(0), "", Integer.valueOf(0), null, Long.valueOf(0L), null }, TimeRspBody.class);
