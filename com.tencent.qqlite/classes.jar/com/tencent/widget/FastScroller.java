...
public class FastScroller
{
  ...
  private final Runnable jdField_a_of_type_JavaLangRunnable = new fkl(this);
  ...
  private void a(Context paramContext)
  {
    ...
    b();
    this.r = paramContext.getResources().getDimensionPixelSize(2131492879);
  ...
  private void a(Context paramContext, Drawable paramDrawable)
  {
    ...
    if ((paramDrawable instanceof NinePatchDrawable)) {
      this.jdField_b_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131492880);
    }
    for (this.jdField_a_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131492881);; this.jdField_a_of_type_Int = paramDrawable.getIntrinsicHeight())
    {
  ...
  {
    int i8 = this.jdField_a_of_type_ComTencentWidgetAbsListView.b();
