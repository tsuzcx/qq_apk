...
public class ScrollView
  extends FrameLayout
{
  static final float jdField_a_of_type_Float = 0.5F;
  ...
  public void computeScroll()
  {
    if (this.jdField_a_of_type_ComTencentWidgetOverScroller.b())
    {
      ...
      if ((i1 != i3) || (i2 != i4))
      {
        ...
        overScrollBy(i3 - i1, i4 - i2, i1, i2, 0, i5, 0, this.jdField_e_of_type_Int, false);
        onScrollChanged(this.mScrollX, this.mScrollY, i1, i2);
        if (n != 0)
        {
          if ((this.jdField_a_of_type_AndroidWidgetEdgeEffect == null) || (i4 >= 0) || (i2 < 0)) {
            break label219;
          }
          this.jdField_a_of_type_AndroidWidgetEdgeEffect.onAbsorb((int)this.jdField_a_of_type_ComTencentWidgetOverScroller.a());
        }
      }
      awakenScrollBars();
      postInvalidate();
    ...
    while (this.jdField_b_of_type_JavaLangObject == null) {
      for (;;)
      {
        ...
        scrollTo(i3, i4);
        continue;
        if ((this.jdField_a_of_type_AndroidWidgetEdgeEffect != null) && (i4 > i5) && (i2 <= i5)) {
          this.jdField_b_of_type_AndroidWidgetEdgeEffect.onAbsorb((int)this.jdField_a_of_type_ComTencentWidgetOverScroller.a());
        }
      }
    }
    a(this.jdField_b_of_type_JavaLangObject);
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetEdgeEffect != null)
    {
      ...
      if (!this.jdField_a_of_type_AndroidWidgetEdgeEffect.isFinished())
      {
        ...
        this.jdField_a_of_type_AndroidWidgetEdgeEffect.setSize(i2 - i3 - i4, getHeight());
      ...
      if (!this.jdField_b_of_type_AndroidWidgetEdgeEffect.isFinished())
      {
        ...
        this.jdField_b_of_type_AndroidWidgetEdgeEffect.setSize(i2, i3);
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if ((n == 2) && (this.jdField_d_of_type_Boolean)) {
      return true;
    }
    switch (n & 0xFF)
    {
    ...
    for (;;)
    {
      ...
      if (n != -1)
      {
        ...
        if ((int)Math.abs(f1 - this.jdField_b_of_type_Float) > this.h)
        {
          ...
          if (paramMotionEvent != null)
          {
            ...
            else
            {
              ...
              if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_JavaLangObject == null))
              {
                this.jdField_a_of_type_JavaLangObject = a("ScrollView-scroll");
                continue;
                this.jdField_d_of_type_Boolean = false;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      do
      {
        ...
        i1 = (int)(this.jdField_b_of_type_Float - f1);
        n = i1;
        if (!this.jdField_d_of_type_Boolean)
        {
          n = i1;
    ...
    for (;;)
    {
      ...
      if ((i5 < 0) || (i5 > i2)) {
        if (i1 != 0)
        {
          overScrollBy(0, n, 0, this.mScrollY, 0, i2, 0, this.jdField_d_of_type_Int, true);
          onScrollChanged(this.mScrollX, this.mScrollY, i3, i4);
          if ((i1 == 0) || (this.jdField_a_of_type_AndroidWidgetEdgeEffect == null)) {
            break;
          }
          i1 = i4 + n;
          if (i1 >= 0) {
          ...
          this.jdField_a_of_type_AndroidWidgetEdgeEffect.onPull(n / getHeight());
          if (!this.jdField_b_of_type_AndroidWidgetEdgeEffect.isFinished()) {
            this.jdField_b_of_type_AndroidWidgetEdgeEffect.onRelease();
          }
        }
      }
      while ((this.jdField_a_of_type_AndroidWidgetEdgeEffect != null) && ((!this.jdField_a_of_type_AndroidWidgetEdgeEffect.isFinished()) || (!this.jdField_b_of_type_AndroidWidgetEdgeEffect.isFinished())))
      {
        invalidate();
        break;
        n = i1 + this.h;
        ...
        if (i1 > i2)
        {
          this.jdField_b_of_type_AndroidWidgetEdgeEffect.onPull(n / getHeight());
          if (!this.jdField_a_of_type_AndroidWidgetEdgeEffect.isFinished()) {
            this.jdField_a_of_type_AndroidWidgetEdgeEffect.onRelease();
          }
        }
      ...
      if ((!this.jdField_d_of_type_Boolean) || (getChildCount() <= 0)) {
        break;
      }
      if (this.jdField_a_of_type_ComTencentWidgetOverScroller.a(this.mScrollX, this.mScrollY, 0, 0, 0, this.jdField_d_of_type_Int)) {
        invalidate();
      }
      this.k = -1;
      f();
  ...
  public void setContentBackground(Drawable paramDrawable)
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130838119);
  }
  ...
  public void setEdgeEffectEnabled(boolean paramBoolean)
  {
    ...
    if (this.jdField_b_of_type_Boolean != paramBoolean)
    {
      ...
      if ((this.g != 2) && (this.jdField_a_of_type_AndroidWidgetEdgeEffect == null))
      {
  ...
  public void setOverScrollMode(int paramInt)
  {
    ...
    if (paramInt != 2)
    {
      if ((this.jdField_a_of_type_AndroidWidgetEdgeEffect == null) && (this.jdField_b_of_type_Boolean))
      {
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_AndroidWidgetEdgeEffect = null;
      this.jdField_b_of_type_AndroidWidgetEdgeEffect = null;
    }
  }
