...
public class QPSingleUpdEngine
{
  ...
  public boolean a()
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        this.jdField_a_of_type_ComTencentQqprotectSingleupdateQPSinlgeUpdInfo.jdField_a_of_type_ArrayOfFiw[i].jdField_a_of_type_JavaLangString = new String(localObject4[i].bytes_name.get().toByteArray());
        this.jdField_a_of_type_ComTencentQqprotectSingleupdateQPSinlgeUpdInfo.jdField_a_of_type_ArrayOfFiw[i].jdField_b_of_type_JavaLangString = new String(localObject4[i].bytes_hash.get().toByteArray());
        i += 1;
      }
      i = ((InputStream)localObject3).read();
