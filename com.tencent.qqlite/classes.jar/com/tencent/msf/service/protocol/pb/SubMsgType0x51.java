...
public final class SubMsgType0x51
{
    ...
    extends MessageMicro
  {
    ...
    static
    {
      ...
      __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 42, 48, 56 }, new String[] { "bytes_qrsig_url", "bytes_hint1", "bytes_hint2", "bytes_appname", "bytes_logincity", "uint32_logintime", "uint32_allow_tmp_auth" }, new Object[] { localByteStringMicro1, localByteStringMicro2, localByteStringMicro3, localByteStringMicro4, localByteStringMicro5, Integer.valueOf(0), Integer.valueOf(0) }, MsgBody.class);
    }
  }
}
