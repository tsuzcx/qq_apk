...
public class ImageUtil
{
  ...
  public static Bitmap b(Bitmap paramBitmap, int paramInt)
  {
    ...
    label143:
    label212:
    for (Object localObject = Bitmap.createBitmap(paramBitmap, 0, 0, j, k, (Matrix)localObject, true);; localObject = null)
    {
      if (localObject != null)
      {
        ...
        if (i > j) {}
        for (paramBitmap = Bitmap.createBitmap((Bitmap)localObject, (int)((i - paramInt) / 2.0F), 0, paramInt, paramInt);; paramBitmap = Bitmap.createBitmap((Bitmap)localObject, 0, (int)((j - paramInt) / 2.0F), paramInt, paramInt))
        {
          ((Bitmap)localObject).recycle();
          return paramBitmap;
          i = k;
      ...
      if (j > k) {
        return Bitmap.createBitmap(paramBitmap, (int)((j - paramInt) / 2.0F), 0, paramInt, paramInt);
      }
      return Bitmap.createBitmap(paramBitmap, 0, (int)((k - paramInt) / 2.0F), paramInt, paramInt);
    }
  }
