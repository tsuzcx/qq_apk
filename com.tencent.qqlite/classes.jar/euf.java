...
public class euf
  extends BaseAdapter
{
  public euf(QQCustomDialogThreeBtns paramQQCustomDialogThreeBtns) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView.a != null)
    {
      ...
      paramView.a.setOnClickListener(new eum(this.a, paramInt));
