...
public class ddf
  implements Runnable
{
  public ddf(ConfigServlet paramConfigServlet, File paramFile, String paramString) {}
  ...
  public void run()
  {
    ...
    //   4: istore_2
    //   5: aload_0
    //   6: getfield 16	ddf:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   134: dup
    //   135: aload_0
    //   136: getfield 16	ddf:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   199: aload_0
    //   200: getfield 18	ddf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   239: pop
    //   240: aload_0
    //   241: getfield 14	ddf:jdField_a_of_type_ComTencentMobileqqConfigSplashlogoConfigServlet	Lcom/tencent/mobileqq/config/splashlogo/ConfigServlet;
    ...
    //   320: aload_0
    //   321: getfield 18	ddf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   411: pop
    //   412: aload_0
    //   413: getfield 16	ddf:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   416: ifnull +21 -> 437
    //   419: aload_0
    //   420: getfield 16	ddf:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   423: invokevirtual 128	java/io/File:exists	()Z
    //   426: ifeq +11 -> 437
    //   429: aload_0
    //   430: getfield 16	ddf:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   499: aload_0
    //   500: getfield 16	ddf:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   503: ifnull +21 -> 524
    //   506: aload_0
    //   507: getfield 16	ddf:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   510: invokevirtual 128	java/io/File:exists	()Z
    //   513: ifeq +11 -> 524
    //   516: aload_0
    //   517: getfield 16	ddf:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   631: aload_0
    //   632: getfield 16	ddf:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   635: ifnull -193 -> 442
    //   638: aload_0
    //   639: getfield 16	ddf:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   642: invokevirtual 128	java/io/File:exists	()Z
    //   645: ifeq -203 -> 442
    //   648: aload_0
    //   649: getfield 16	ddf:jdField_a_of_type_JavaIoFile	Ljava/io/File;
