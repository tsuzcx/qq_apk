...
public class eft
  implements Runnable
{
  public eft(MainAcitivityReportHelper paramMainAcitivityReportHelper) {}
      ...
      for (;;)
      {
        try
        {
          ...
          else
          {
            ...
            MessageReportData localMessageReportData = (MessageReportData)((Iterator)localObject1).next();
            if (localMessageReportData.msgCount <= 0) {
              continue;
            }
            localStatisticCollector.c(localQQAppInterface, localMessageReportData.getMsgReport());
            continue;
          }
        }
        catch (Exception localException)
        {
          ...
          i = 2;
          continue;
          int j = localQQAppInterface.a().c("recv_msg_back_group");
          ...
          if (!Boolean.valueOf(SettingCloneUtil.readValue(MainAcitivityReportHelper.a(this.a), localQQAppInterface.a(), MainAcitivityReportHelper.a(this.a).getString(2131363749), "qqsetting_lock_screen_whenexit_key", true)).booleanValue()) {}
        }
