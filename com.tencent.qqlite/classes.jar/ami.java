...
{
  public ami(ForwardOperations paramForwardOperations) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 0)
      {
        ...
        if (!bool) {
          QfavUtil.a(this.a.jdField_a_of_type_AndroidAppActivity, 2131362755, 2);
        }
      }
      while (!bool)
      {
        ...
        paramDialogInterface = this.a.jdField_a_of_type_AndroidAppActivity.getString(2131362758);
        ...
        if (TextUtils.isEmpty(str)) {
          paramDialogInterface = this.a.jdField_a_of_type_AndroidAppActivity.getString(2131362759);
        }
        paramDialogInterface = paramDialogInterface;
        paramDialogInterface = DialogUtil.a(this.a.jdField_a_of_type_AndroidAppActivity, 230, this.a.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131362695), this.a.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131362756), paramDialogInterface, this.a.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131362697), new amj(this), new amk(this));
        paramDialogInterface.setOnDismissListener(new aml(this));
        if (!this.a.jdField_a_of_type_AndroidAppActivity.isFinishing())
        {
          ...
          continue;
          if (2 == paramInt) {
            QfavUtil.a(this.a.jdField_a_of_type_AndroidAppActivity, 2131362725, 1);
          } else if (3 == paramInt) {
            QfavUtil.a(this.a.jdField_a_of_type_AndroidAppActivity, 2131362757, 1);
          } else {
            QfavUtil.a(this.a.jdField_a_of_type_AndroidAppActivity, 2131362754, 1);
          }
        }
      }
    }
