...
{
  public fhc(DownloadManager paramDownloadManager) {}
  ...
  {
    ThreadManager.b().post(new fhe(this, paramLong1, paramLong2, paramString));
  }
  ...
  {
    ThreadManager.b().post(new fhd(this, paramTMAssistantDownloadSDKClient, paramInt1, paramString1, paramInt2, paramString2));
  }
