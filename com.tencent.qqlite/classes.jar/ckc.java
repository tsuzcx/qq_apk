...
{
  public ckc(PhotoListActivity paramPhotoListActivity) {}
  ...
  public void a(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    switch (this.a.jdField_a_of_type_Ckh.getItemViewType(paramInt))
    {
    default: 
    case 0: 
    case 1: 
      ...
      do
      {
        ...
        {
          paramAdapterView = this.a.jdField_a_of_type_Ckh.a(paramInt);
          PhotoListActivity.a(this.a, paramAdapterView.a);
          return;
        }
        localObject = this.a.jdField_a_of_type_Ckh;
        LocalMediaInfo localLocalMediaInfo = ((ckh)localObject).a(paramInt);
        ...
        for (;;)
        {
          ((ckh)localObject).notifyDataSetChanged();
        ...
        if (!this.a.jdField_a_of_type_JavaUtilArrayList.isEmpty())
        {
          ...
          paramAdapterView.setPositiveButton(2131362802, new DialogUtil.DialogOnClickAdapter());
          paramAdapterView.show();
          return;
        }
        if (!Utils.e())
        {
          Toast.makeText(this.a, this.a.getResources().getString(2131363522), 0).show();
          return;
        }
        paramAdapterView = this.a.jdField_a_of_type_Ckh.a(paramInt);
