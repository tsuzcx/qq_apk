  ...
  extends BaseAdapter
{
  ...
  public ckh(PhotoListActivity paramPhotoListActivity)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130839067);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
        ...
        do
        {
          ...
          do
          {
            do
            {
              ...
              if (paramView == null)
              {
                paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903520, null);
                ...
                paramViewGroup = new cki(this, null);
                paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131298350));
                paramViewGroup.b = ((ImageView)paramView.findViewById(2131298351));
                paramViewGroup.c = ((ImageView)paramView.findViewById(2131298352));
              ...
              for (bool = true;; bool = false)
              {
                ...
                return paramView;
                paramViewGroup = (cki)paramView.getTag();
                break label134;
              }
              if (paramInt != 3) {
                break label369;
            ...
            paramView.setBackgroundResource(2130837601);
            return paramView;
            paramView.setBackgroundDrawable(null);
            return paramView;
            ((ImageView)localObject2).setVisibility(4);
          ...
          if (paramView == null)
          {
            paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903574, null);
            paramView.setLayoutParams(new AbsListView.LayoutParams(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_b_of_type_Int));
            paramViewGroup = new cki(this, null);
            paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131298350));
            paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131298561));
            paramViewGroup.b = ((ImageView)paramView.findViewById(2131298351));
            paramViewGroup.c = ((ImageView)paramView.findViewById(2131298352));
            paramView.setTag(paramViewGroup);
            localObject2 = paramViewGroup.jdField_a_of_type_AndroidWidgetImageView;
    ...
    paramViewGroup.setImageResource(2130838179);
