...
public class eyw
  extends Handler
{
  public eyw(QQToastNotifier paramQQToastNotifier, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  {
    paramMessage = (eyx)paramMessage.obj;
    ...
    TextView localTextView = (TextView)localView.findViewById(2131297379);
    if ((paramMessage.jdField_a_of_type_JavaLangString != null) && (paramMessage.jdField_a_of_type_JavaLangString.length() > 0)) {
      localTextView.setText(paramMessage.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      ((ImageView)localView.findViewById(2131297378)).setImageResource(QQToast.a(paramMessage.jdField_a_of_type_Int));
