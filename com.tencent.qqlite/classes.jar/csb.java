...
public class csb
  implements Runnable
{
  public csb(DeviceProfileManager paramDeviceProfileManager, ConfigurationService.RespGetConfig paramRespGetConfig, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(DeviceProfileManager.jdField_a_of_type_JavaLangString, 2, "onDPCResponse DPCXmlHandler.tempMap: key=" + (String)localObject8 + ", value=" + localcsd.toString() + ", isAccountName=" + bool1);
      }
      ...
      else if (localObject8 != null)
      {
        ...
        bool2 = DeviceProfileManager.a((DeviceProfileManager.DPCConfigInfo)localObject8, localcsd.b.toString().trim());
        if (!bool1) {
          break label969;
        }
    ...
    for (;;)
    {
      localEditor1.putString((String)???, localcsd.b);
      label632:
      if (!QLog.isColorLevel()) {
        break label255;
      }
