...
{
  public bwg(PATextItemBuilder paramPATextItemBuilder) {}
  
  public void onClick(View paramView)
  {
    paramView = (bwh)AIOUtils.a(paramView);
    ...
    for (;;)
    {
      ...
      if ((paramView.b == null) || (!paramView.b.equals("open_local")))
      {
        ...
        localIntent.putExtra("assignBackText", PATextItemBuilder.c(this.a).getResources().getString(2131363113));
