...
{
  public eod(VideoPlayLogic paramVideoPlayLogic) {}
  ...
  protected void a(String paramString, List paramList, int paramInt)
  {
    ...
    if (VideoPlayLogic.a(this.a) == null)
    {
      ...
      paramString.leftMargin = VideoPlayLogic.a(this.a).getResources().getDimensionPixelSize(2131493062);
      paramString.rightMargin = VideoPlayLogic.a(this.a).getResources().getDimensionPixelSize(2131493063);
      paramString.topMargin = VideoPlayLogic.a(this.a).getResources().getDimensionPixelSize(2131493065);
