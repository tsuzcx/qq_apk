...
public final class ffr
  implements Runnable
{
  public ffr(String paramString1, int paramInt, Context paramContext, String paramString2, WebView paramWebView, String paramString3) {}
      ...
      try
      {
          ...
          else
          {
            ...
            if (l != 0L)
            {
              if (!bool1)
              {
                ...
                AppReport.a(this.jdField_a_of_type_AndroidContentContext, this.b, this.jdField_a_of_type_ComTencentSmttSdkWebView, this.c);
                return;
              }
              if (bool2)
              {
        ...
        else
        {
          ...
          catch (PackageManager.NameNotFoundException localNameNotFoundException2)
          {
            ...
            new HttpCgiAsyncTask("http://appsupport.qq.com/cgi-bin/appstage/sdk_update", "POST", new AppReport.IncrementalReportCallback(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, j, this.b, this.jdField_a_of_type_ComTencentSmttSdkWebView)).execute(new Bundle[] { localObject2 });
            return;
            AppReport.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, j);
            return;
            new HttpCgiAsyncTask("http://appsupport.qq.com/cgi-bin/appstage/sdk_update", "POST", new AppReport.IncrementalReportCallback(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, j, this.b, this.jdField_a_of_type_ComTencentSmttSdkWebView)).execute(new Bundle[] { localObject2 });
          }
          localHashMap.put(this.jdField_a_of_type_JavaLangString, AppReport.a(this.jdField_a_of_type_JavaLangString, n, (String)localObject4, j));
