...
{
  public clg(BannerManager paramBannerManager, View paramView, int paramInt, FrameLayout paramFrameLayout, String paramString) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ThreadManager.a().post(new clh(this, paramView));
