...
public class ctr
{
  ...
  public ctr(MemoryManager paramMemoryManager) {}
  ...
  public void c()
  {
    try
    {
      ...
      BaseApplicationImpl.a().getSharedPreferences("MemoryInfomation", 0).edit().putString("LowMemoryStat", Base64Util.a((byte[])localObject, 0)).commit();
      return;
    }
    catch (Exception localException) {}
  }
