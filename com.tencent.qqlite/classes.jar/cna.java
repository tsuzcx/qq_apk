...
public class cna
  extends Thread
{
  public cna(SelectMemberActivity paramSelectMemberActivity, FriendManager paramFriendManager) {}
  ...
  public void run()
  {
    ...
    if (i >= 0)
    {
      ...
      for (localObject1 = str + localResultRecord.jdField_a_of_type_JavaLangString;; localObject1 = str + (String)localObject1)
      {
        ...
        {
          localObject3 = DBUtils.a().a(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.app, localResultRecord.c, localResultRecord.jdField_a_of_type_JavaLangString);
          localObject1 = localObject2;
          if (localObject3 == null) {
            break label189;
          }
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        localException.a(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.F).longValue(), localArrayList);
        return;
      }
      localObject2 = (DiscussionHandler)this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.app.a(6);
