...
{
  public bxb(PAMultiItemBuilder paramPAMultiItemBuilder) {}
  
  public void onClick(View paramView)
  {
    bxc localbxc = (bxc)paramView.getTag();
    paramView = AIOUtils.a(paramView);
    if ((localbxc == null) || (!(paramView instanceof MessageForPubAccount))) {
      if (QLog.isColorLevel()) {
        QLog.d(ChatItemBuilder.a, 2, "PAMultiItemBuilder onClickListener holder = " + localbxc + ", msg = " + paramView);
      }
    }
    ...
    return;
    PAMessage.Item localItem = (PAMessage.Item)localMessageForPubAccount.mPAMessage.items.get(localbxc.jdField_c_of_type_Int);
    if ((PAMultiItemBuilder.a(this.a) instanceof QQAppInterface)) {
      ReportController.b(PAMultiItemBuilder.b(this.a), "P_CliOper", "Pb_account_lifeservice", PAMultiItemBuilder.a(this.a).a, "mp_msg_msgpic_click", "aio_morpic_click", localbxc.jdField_c_of_type_Int + 1, 0, "", "", Long.toString(localMessageForPubAccount.mPAMessage.mMsgId), "");
    }
    label228:
    ...
    if (TextUtils.isEmpty(localItem.a_actionData))
    {
      ...
      PASingleItemBuilder.a(PAMultiItemBuilder.e(this.a), PAMultiItemBuilder.c(this.a), localbxc.a, localbxc.b, localbxc.jdField_c_of_type_JavaLangString, PAMultiItemBuilder.b(this.a).a, PAMultiItemBuilder.c(this.a).d);
      label359:
    ...
    for (;;)
    {
      ...
      break label359;
      label480:
      PASingleItemBuilder.a(PAMultiItemBuilder.g(this.a), PAMultiItemBuilder.d(this.a), localbxc.a, localbxc.b, localbxc.jdField_c_of_type_JavaLangString, PAMultiItemBuilder.e(this.a).a, PAMultiItemBuilder.f(this.a).d);
      break label359;
      label535:
      if (TextUtils.isEmpty(localJumpAction.a()))
      {
        ...
        {
          PASingleItemBuilder.a(PAMultiItemBuilder.i(this.a), PAMultiItemBuilder.f(this.a), localbxc.a, localbxc.b, localbxc.jdField_c_of_type_JavaLangString, PAMultiItemBuilder.g(this.a).a, PAMultiItemBuilder.h(this.a).d);
          break label359;
        }
      ...
      {
        PASingleItemBuilder.a(PAMultiItemBuilder.k(this.a), PAMultiItemBuilder.g(this.a), localbxc.a, localbxc.b, localbxc.jdField_c_of_type_JavaLangString, PAMultiItemBuilder.j(this.a).a, PAMultiItemBuilder.k(this.a).d);
        break label359;
      }
      ...
      break label359;
      label755:
      PASingleItemBuilder.a(PAMultiItemBuilder.n(this.a), PAMultiItemBuilder.h(this.a), localbxc.a, localbxc.b, localbxc.jdField_c_of_type_JavaLangString, PAMultiItemBuilder.n(this.a).a, PAMultiItemBuilder.o(this.a).d);
    }
  }
}
