...
public class clp
  extends BaseAdapter
{
  private clp(DiscussionListInnerFrame paramDiscussionListInnerFrame) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = (clq)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramViewGroup = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903614, paramViewGroup, false);
      paramView = new clq(this.a, null);
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131296439));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131298742));
      paramView.b = ((TextView)paramViewGroup.findViewById(2131298743));
