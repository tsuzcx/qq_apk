  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public clp(FriendListInnerFrame paramFriendListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903636, paramViewGroup, false);
      paramView = new clq(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame, null);
    ...
    paramView = (clq)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
