  ...
  implements Runnable
{
  ...
  public fhh(AbsListView paramAbsListView)
  {
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.a.e(paramInt1 - paramInt2, paramInt3);
  }
  ...
  public void run()
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            } while ((i1 == this.i) || (n <= 1) || (n + i1 >= this.a.aA));
            n = i1 + 1;
            if (n == this.j)
            {
              this.a.post(this);
            ...
            if (n < this.i)
            {
              this.a.e(Math.max(0, i2 + i1 - i3), this.k);
              this.j = n;
              this.a.post(this);
              return;
            }
          } while (i2 <= i3);
          this.a.e(i2 - i3, this.k);
          return;
          if (i1 == this.j)
          {
            this.a.post(this);
    ...
    for (;;)
    {
      ...
      this.a.e((int)(f1 * -this.a.getHeight()), this.k);
      this.a.post(this);
      return;
      if (i3 > i4) {
        n = i3 - i4;
