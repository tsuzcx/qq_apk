...
public class arv
  implements Runnable
{
  public arv(JumpActivity paramJumpActivity, Bundle paramBundle) {}
  ...
  public void run()
  {
    ...
    if (((String)localObject2).startsWith("image"))
    {
      ...
      for (;;)
      {
        ...
        ((Intent)localObject1).putExtra("forward_text", this.jdField_a_of_type_ComTencentMobileqqActivityJumpActivity.getString(2131364067));
      }
    }
