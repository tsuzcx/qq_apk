...
public class euk
  extends BaseAdapter
{
  public euk(QQCustomDialogThreeBtns paramQQCustomDialogThreeBtns) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView.a != null)
    {
      ...
      paramView.a.setOnClickListener(new eur(this.a, paramInt));
