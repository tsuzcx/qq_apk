  ...
  private IErrorHandler errorHandler = new IErrorHandler()
  {
    ...
    private void onKicked(ToServiceMsg paramAnonymousToServiceMsg, FromServiceMsg paramAnonymousFromServiceMsg, boolean paramAnonymousBoolean1, boolean paramAnonymousBoolean2)
    {
      ...
      if (paramAnonymousBoolean1)
      {
        ...
        if (paramAnonymousToServiceMsg.bSigKick == 1)
        {
          ...
          popupNotificationEx("mqql.intent.action.ACCOUNT_KICKED", paramAnonymousFromServiceMsg.getUin(), paramAnonymousToServiceMsg.strTitle, paramAnonymousToServiceMsg.strInfo, Constants.LogoutReason.secKicked, paramAnonymousToServiceMsg.vecSigKickData);
          if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        popupNotification("mqql.intent.action.ACCOUNT_KICKED", paramAnonymousFromServiceMsg.getUin(), paramAnonymousToServiceMsg.strTitle, paramAnonymousToServiceMsg.strInfo, Constants.LogoutReason.kicked, paramAnonymousBoolean2);
        break;
        if (QLog.isColorLevel()) {
        ...
        if (paramAnonymousToServiceMsg != null)
        {
          ...
          popupNotification("mqql.intent.action.ACCOUNT_KICKED", paramAnonymousFromServiceMsg, str1, str2, localLogoutReason, paramAnonymousBoolean1);
        }
        while (QLog.isColorLevel())
        {
          QLog.d("sec_sig_tag", 2, "kicked.....onKicked: not isTokenExpired end");
          return;
          popupNotification("mqql.intent.action.ACCOUNT_KICKED", paramAnonymousFromServiceMsg.getUin(), null, null, Constants.LogoutReason.forceLogout, false);
        }
      }
    }
        ...
        public void run()
        {
          ...
          if ((paramAnonymousString2 != null) && (paramAnonymousString2.equals(localAppRuntime.getAccount())))
          {
            ...
            if ((bool) && (MainService.this.mApplicaiton != null) && (MainService.this.mApplicaiton.getProcessName().equalsIgnoreCase(MainService.this.mApplicaiton.getPackageName())))
            {
              ...
              if ((!localAppRuntime.isClearTaskBySystem) && ((!paramAnonymousBoolean) || (paramAnonymousString1 == null) || (!paramAnonymousString1.equalsIgnoreCase("mqql.intent.action.ACCOUNT_KICKED")) || (!localAppRuntime.isBackground_Stop))) {
                break label392;
              }
              if (QLog.isColorLevel()) {
    ...
    public void onGrayError(final ToServiceMsg paramAnonymousToServiceMsg, final FromServiceMsg paramAnonymousFromServiceMsg, final boolean paramAnonymousBoolean)
    {
      ...
      new Handler(Looper.getMainLooper()).postDelayed(new Runnable()
      {
        public void run()
        {
          MainService.3.this.popupNotification("mqql.intent.action.GRAY", paramAnonymousFromServiceMsg.getUin(), paramAnonymousToServiceMsg, paramAnonymousFromServiceMsg.getBusinessFailMsg(), Constants.LogoutReason.gray, paramAnonymousBoolean);
        }
      }, 500L);
      if (QLog.isColorLevel()) {
    ...
    public void onRecvServerTip(ToServiceMsg paramAnonymousToServiceMsg, FromServiceMsg paramAnonymousFromServiceMsg, boolean paramAnonymousBoolean)
    {
      ...
      popupNotification("mqql.intent.action.ACCOUNT_TIPS", paramAnonymousFromServiceMsg.getUin(), arrayOfString[0], paramAnonymousToServiceMsg, Constants.LogoutReason.tips, paramAnonymousBoolean);
    }
    ...
    public void onServerSuspended(ToServiceMsg paramAnonymousToServiceMsg, FromServiceMsg paramAnonymousFromServiceMsg, boolean paramAnonymousBoolean)
    {
      ...
      if (paramAnonymousToServiceMsg == null) {
        popupNotification("mqql.intent.action.SUSPEND", paramAnonymousFromServiceMsg.getUin(), null, paramAnonymousFromServiceMsg.getBusinessFailMsg(), Constants.LogoutReason.suspend, paramAnonymousBoolean);
      }
      if (QLog.isColorLevel()) {
    ...
    public void onUserTokenExpired(ToServiceMsg paramAnonymousToServiceMsg, FromServiceMsg paramAnonymousFromServiceMsg, boolean paramAnonymousBoolean)
    {
      ...
      MsfSdkUtils.updateSimpleAccount(paramAnonymousFromServiceMsg.getUin(), false);
      MainService.this.mApplicaiton.setSortAccountList(MsfSdkUtils.getLoginedAccountList());
      popupNotification("mqql.intent.action.ACCOUNT_EXPIRED", paramAnonymousFromServiceMsg.getUin(), null, paramAnonymousFromServiceMsg.getBusinessFailMsg(), Constants.LogoutReason.expired, paramAnonymousBoolean);
      if (QLog.isColorLevel()) {
