  ...
  implements Constants.Action
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    case 1037: 
      localObject5 = (String)paramFromServiceMsg.getAttribute("MSF.getKey");
    ...
    for (;;)
    {
      try
      {
        if (localObject5.length > 0)
        {
          ...
          if (i < localObject5.length)
          {
            ...
            if ((localObject1 == null) || (((String)localObject1).length() == 0) || (!((String)localObject1).startsWith("UIN=" + (String)localObject4 + ","))) {
              break label3679;
            }
      ...
      try
      {
        ...
        str = (String)paramFromServiceMsg.getAttribute("resp_register_uin", "");
        localBundle.putInt("code", j);
