...
{
  public cmk(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity) {}
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    while (i != this.a.jdField_b_of_type_Int)
    {
      ...
      Intent localIntent;
      return;
      CreateFaceToFaceDiscussionActivity.a(this.a, 1, this.a.getString(2131364392));
      return;
    }
    CreateFaceToFaceDiscussionActivity.b(this.a, 1, this.a.getString(2131364392));
  }
  ...
  protected void a(boolean paramBoolean, List paramList, int paramInt1, int paramInt2, nearfield_discuss.BusiRespHead paramBusiRespHead)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilList == null)
      {
        ...
        if (this.a.jdField_a_of_type_Cmn != null)
        {
          this.a.jdField_a_of_type_Cmn.notifyDataSetChanged();
