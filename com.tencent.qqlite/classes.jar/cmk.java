...
public class cmk
  extends Handler
{
  public cmk(SelectMemberActivity paramSelectMemberActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        this.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130837989);
        postDelayed(new cml(this), 1500L);
        return;
      } while ((this.a.jdField_a_of_type_AndroidAppDialog == null) || (!this.a.jdField_a_of_type_AndroidAppDialog.isShowing()));
      ...
      postDelayed(new cmm(this), 1500L);
      return;
