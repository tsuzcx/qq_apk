...
public class amm
  extends Thread
{
  public amm(ForwardOperations paramForwardOperations, String paramString1, int paramInt, String paramString2) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      if ((i >= 3) || ((this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.c) && (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse != null)))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new amn(this));
      }
      label89:
      Object localObject1;
      Object localObject2;
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.w == 5)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new amo(this, (HashMap)localObject1));
        return;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = HttpUtil.a(BaseApplication.getContext(), str2, this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.C, 1, localHashMap);
        this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new amp(this, (HashMap)localObject1));
        return;
      }
