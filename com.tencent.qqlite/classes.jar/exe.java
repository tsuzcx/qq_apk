...
public class exe
  extends BaseAdapter
{
  public exe(QQCustomSingleButtonDialog paramQQCustomSingleButtonDialog) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = new exj(this.a, null);
      paramView.a = ((TextView)paramViewGroup.findViewById(2131296917));
      paramViewGroup.setTag(paramView);
    }
    paramView = (exj)paramViewGroup.getTag();
    int i;
    int j;
    int k;
    int m;
    if (paramView.a != null)
    {
      ...
      paramView.a.setOnClickListener(new exi(this.a, paramInt));
      ...
      paramView.a.setBackgroundResource(2130837977);
    }
    for (;;)
    {
      ...
      label207:
      if (paramInt == 0) {
        paramView.a.setBackgroundResource(2130837978);
      } else if (paramInt == this.a.jdField_a_of_type_ArrayOfJavaLangString.length - 1) {
        paramView.a.setBackgroundResource(2130837976);
      }
    }
  }
}
