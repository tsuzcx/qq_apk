...
{
  public eae(TroopSystemMessage paramTroopSystemMessage) {}
  
  protected void a(String paramString)
  {
    TroopSystemMessage.a(this.a).c(this.a.jdField_a_of_type_ComTencentMobileqqAppMessageObserver);
    paramString = this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131362903);
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    if (!paramBoolean)
    {
      ...
      paramString1 = this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131363399);
