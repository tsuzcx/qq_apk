  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public ckt(ContactsInnerFrame paramContactsInnerFrame, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903636, paramViewGroup, false);
      paramView = new cku(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame, null);
      ...
      paramView.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)localView.findViewById(2131298795));
      paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131296453));
      paramView.c = ((TextView)localView.findViewById(2131296455));
    }
    paramView = (cku)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      ...
      if (!paramViewGroup.uin.equals("0"))
      {
        ...
        paramView.jdField_b_of_type_AndroidWidgetImageView.setImageBitmap(a(paramView.jdField_a_of_type_JavaLangString, 1, (byte)0));
        ...
        if (paramView.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled())
        {
          ...
          localView.setContentDescription(paramViewGroup.name + "已选中");
        }
      }
      for (;;)
      {
        ...
        paramView.jdField_b_of_type_Int = 11;
        paramView.jdField_b_of_type_AndroidWidgetImageView.setImageBitmap(a(paramView.jdField_a_of_type_JavaLangString, 11, (byte)0));
        break;
        label438:
        ...
        break label318;
        label460:
        localView.setContentDescription(paramViewGroup.name);
      }
    }
