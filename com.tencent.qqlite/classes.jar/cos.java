...
{
  public cos(TroopMemberListInnerFrame paramTroopMemberListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903629, paramViewGroup, false);
      paramView = new cot(this.a, null);
    ...
    paramView = (cot)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
