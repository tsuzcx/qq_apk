...
{
  public ss(SosoPlugin paramSosoPlugin, String paramString) {}
          ...
          if ((localCheckURLResp.retcode.has()) && (localCheckURLResp.retcode.get() == 0) && (localCheckURLResp.result.has()))
          {
            ...
            for (;;)
            {
              ...
              if (paramInt == 2)
              {
                ...
                this.jdField_a_of_type_ComTencentBizWebviewpluginSosoPlugin.a.loadUrl("http://pub.idqqimg.com/qqmobile/client/android/forbidden.html?url=" + this.jdField_a_of_type_JavaLangString);
              }
            }
          }
          return;
