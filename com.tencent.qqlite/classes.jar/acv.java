  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        return true;
        this.a.jdField_a_of_type_AndroidAppDialog = new Dialog(this.a, 2131624120);
        this.a.jdField_a_of_type_AndroidAppDialog.setContentView(2130903608);
        ((TextView)this.a.jdField_a_of_type_AndroidAppDialog.findViewById(2131296473)).setText(paramMessage.obj.toString());
        this.a.jdField_a_of_type_AndroidAppDialog.setOnCancelListener(new acw(this));
        ...
        this.a.a(2130837994, this.a.getString(2131363184));
        return true;
        ChatHistory.a(this.a).setEnabled(true);
        if (this.a.jdField_a_of_type_AndroidAppDialog != null) {
          this.a.jdField_a_of_type_AndroidAppDialog.dismiss();
        }
        this.a.a(2130837994, this.a.getString(2131363186));
        return true;
        ChatHistory.a(this.a).setEnabled(true);
        if (this.a.jdField_a_of_type_AndroidAppDialog != null) {
          this.a.jdField_a_of_type_AndroidAppDialog.dismiss();
        }
        this.a.a(2130837994, this.a.getString(2131363185));
        return true;
        this.a.a(2130837994, this.a.getString(2131363408));
        return true;
