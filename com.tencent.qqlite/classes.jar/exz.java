...
public final class exz
  implements Runnable
{
  public exz(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2) {}
  ...
  public void run()
  {
    ...
    if (QQUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), new String[] { this.jdField_a_of_type_JavaLangString })) {
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131363670);
    }
