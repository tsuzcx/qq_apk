  ...
  extends AsyncTask
{
  ...
  public ery(ImageWorker paramImageWorker, View paramView)
  {
  ...
  {
    View localView = a();
    esa localesa = (esa)ImageWorker.a(this.jdField_a_of_type_ComTencentMobileqqUtilImageWorker).remove(localView);
    ...
    if (localView != null)
    {
      ...
      if ((localesa != null) && (localesa.a != null)) {
        localesa.a.a(localView, null);
      }
    }
    return;
    label72:
    ImageWorker.a(this.jdField_a_of_type_ComTencentMobileqqUtilImageWorker, this.jdField_a_of_type_Boolean, localView, paramDrawable, localesa);
  }
}
