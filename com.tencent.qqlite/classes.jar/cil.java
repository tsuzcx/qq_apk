  ...
  implements TextWatcher, View.OnClickListener, View.OnTouchListener
{
  ...
  private cik jdField_a_of_type_Cik;
  private ListView jdField_a_of_type_ComTencentWidgetListView;
  
  public cil(CountryActivity paramCountryActivity, Context paramContext)
  {
    super(paramContext);
    ...
    ((Button)findViewById(2131298430)).setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = findViewById(2131296866);
    ...
    this.jdField_a_of_type_ComTencentWidgetListView = ((ListView)findViewById(2131296867));
    this.jdField_a_of_type_Cik = new cik(paramCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Cik);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Cik.a(paramString);
    if (this.jdField_a_of_type_Cik.getCount() == 0) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      this.jdField_a_of_type_Cik.notifyDataSetChanged();
      return;
