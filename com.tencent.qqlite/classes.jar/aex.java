...
public class aex
  extends Handler
{
  public aex(ChatSettingForTroop paramChatSettingForTroop) {}
                    ...
                    do
                    {
                      ...
                      if (paramMessage.what == 2)
                      {
                        ...
                        for (;;)
                        {
                          ...
                          ((FormSimpleItem)((View)localObject3).findViewById(2131298524)).setRightText((CharSequence)localObject1);
                          ((TextView)((View)localObject3).findViewById(2131298525)).setText(paramMessage);
                          return;
                          localObject1 = this.a.getString(2131363851);
                          paramMessage = this.a.getString(2131362538);
                          continue;
                          localObject1 = this.a.getString(2131363852);
                          paramMessage = this.a.getString(2131362540);
                          continue;
                          localObject1 = this.a.getString(2131362533);
                          paramMessage = this.a.getString(2131362539);
                        }
                      }
