...
{
  public bkp(SplashActivity paramSplashActivity, CheckBox paramCheckBox) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    localEditor.putBoolean(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131363279) + paramDialogInterface, false);
    localEditor.putBoolean(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131363280) + paramDialogInterface, false);
    localEditor.putBoolean("discussion_msg_notify" + paramDialogInterface, false);
    localEditor.putBoolean(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131363283) + paramDialogInterface, false);
    localEditor.commit();
