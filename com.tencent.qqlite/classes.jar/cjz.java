...
{
  public cjz(BannerManager paramBannerManager, View paramView, int paramInt, FrameLayout paramFrameLayout, String paramString) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (paramView != null)
    {
      ...
      paramView.a.a();
      ADView localADView = (ADView)this.jdField_a_of_type_AndroidViewView.findViewById(2131297449);
      if (localADView != null)
      {
    ...
    for (;;)
    {
      ThreadManager.a().post(new cka(this, paramView));
