...
public class sm
  extends Thread
{
  public sm(Share paramShare, String paramString, boolean paramBoolean, Bitmap paramBitmap, int paramInt) {}
  ...
  public void run()
  {
    ...
    //   9: iconst_0
    //   10: aload_0
    //   11: getfield 14	sm:jdField_a_of_type_ComTencentBizWebviewpluginShare	Lcom/tencent/biz/webviewplugin/Share;
    //   14: getfield 46	com/tencent/biz/webviewplugin/Share:k	Ljava/lang/String;
    //   17: aastore
    //   18: dup
    //   19: iconst_1
    //   20: aload_0
    //   21: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   183: ifeq +9 -> 192
    //   186: aload_0
    //   187: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   190: astore 6
    //   192: aload 13
    //   194: astore 7
    //   196: aload 13
    ...
    //   201: ifeq +9 -> 210
    //   204: aload_0
    //   205: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   208: astore 7
    //   210: aload_0
    //   211: getfield 18	sm:jdField_a_of_type_Boolean	Z
    //   214: ifeq +422 -> 636
    //   217: aload_0
    //   218: getfield 14	sm:jdField_a_of_type_ComTencentBizWebviewpluginShare	Lcom/tencent/biz/webviewplugin/Share;
    ...
    //   235: aload 10
    //   237: aload 5
    //   239: invokespecial 124	sn:<init>	(Lsm;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    //   291: astore 10
    //   293: aload_0
    //   294: getfield 18	sm:jdField_a_of_type_Boolean	Z
    //   297: ifeq +324 -> 621
    //   300: aload_0
    //   301: getfield 20	sm:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    ...
    //   531: astore 15
    //   533: aload_0
    //   534: getfield 14	sm:jdField_a_of_type_ComTencentBizWebviewpluginShare	Lcom/tencent/biz/webviewplugin/Share;
    ...
    //   558: ifeq +9 -> 567
    //   561: aload_0
    //   562: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   565: astore 5
    //   567: aload 7
    //   569: astore 8
    //   571: aload 7
    ...
    //   576: ifeq +9 -> 585
    //   579: aload_0
    //   580: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   583: astore 8
    //   585: aload_0
    //   586: getfield 18	sm:jdField_a_of_type_Boolean	Z
    //   589: ifeq +41 -> 630
    //   592: aload_0
    //   593: getfield 14	sm:jdField_a_of_type_ComTencentBizWebviewpluginShare	Lcom/tencent/biz/webviewplugin/Share;
    ...
    //   610: aload 10
    //   612: aload 6
    //   614: invokespecial 124	sn:<init>	(Lsm;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;)V
    //   617: invokevirtual 130	com/tencent/mobileqq/activity/QQBrowserActivity:runOnUiThread	(Ljava/lang/Runnable;)V
    //   620: return
    //   621: aload_0
    //   622: getfield 20	sm:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   625: astore 6
    //   627: goto -78 -> 549
    //   630: aconst_null
    //   631: astore 6
    ...
    //   697: ifeq +9 -> 706
    //   700: aload_0
    //   701: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   704: astore 6
    //   706: aload 13
    //   708: astore 7
    //   710: aload 13
    ...
    //   715: ifeq +9 -> 724
    //   718: aload_0
    //   719: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   722: astore 7
    //   724: aload_0
    //   725: getfield 18	sm:jdField_a_of_type_Boolean	Z
    //   728: ifeq +32 -> 760
    //   731: aload_0
    //   732: getfield 14	sm:jdField_a_of_type_ComTencentBizWebviewpluginShare	Lcom/tencent/biz/webviewplugin/Share;
    ...
    //   749: aload 10
    //   751: aload 5
    //   753: invokespecial 124	sn:<init>	(Lsm;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    //   821: ifeq +9 -> 830
    //   824: aload_0
    //   825: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   828: astore 6
    //   830: aload 13
    //   832: astore 7
    //   834: aload 13
    ...
    //   839: ifeq +9 -> 848
    //   842: aload_0
    //   843: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   846: astore 7
    //   848: aload_0
    //   849: getfield 18	sm:jdField_a_of_type_Boolean	Z
    //   852: ifeq +32 -> 884
    //   855: aload_0
    //   856: getfield 14	sm:jdField_a_of_type_ComTencentBizWebviewpluginShare	Lcom/tencent/biz/webviewplugin/Share;
    ...
    //   873: aload 10
    //   875: aload 5
    //   877: invokespecial 124	sn:<init>	(Lsm;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    //   920: ifeq +9 -> 929
    //   923: aload_0
    //   924: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   927: astore 6
    //   929: aload 7
    //   931: astore 8
    //   933: aload 7
    ...
    //   938: ifeq +9 -> 947
    //   941: aload_0
    //   942: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   945: astore 8
    //   947: aload_0
    //   948: getfield 18	sm:jdField_a_of_type_Boolean	Z
    //   951: ifeq +32 -> 983
    //   954: aload_0
    //   955: getfield 14	sm:jdField_a_of_type_ComTencentBizWebviewpluginShare	Lcom/tencent/biz/webviewplugin/Share;
    ...
    //   972: aload 10
    //   974: aload 5
    //   976: invokespecial 124	sn:<init>	(Lsm;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    //   1019: ifeq +9 -> 1028
    //   1022: aload_0
    //   1023: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   1026: astore 7
    //   1028: aload 11
    //   1030: astore 8
    //   1032: aload 11
    ...
    //   1037: ifeq +9 -> 1046
    //   1040: aload_0
    //   1041: getfield 16	sm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   1044: astore 8
    //   1046: aload_0
    //   1047: getfield 18	sm:jdField_a_of_type_Boolean	Z
    //   1050: ifeq +34 -> 1084
    //   1053: aload_0
    //   1054: getfield 14	sm:jdField_a_of_type_ComTencentBizWebviewpluginShare	Lcom/tencent/biz/webviewplugin/Share;
    ...
    //   1071: aload 10
    //   1073: aload 5
    //   1075: invokespecial 124	sn:<init>	(Lsm;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;)V
