...
public class eno
  implements Runnable
{
  public eno(TroopMessageManager paramTroopMessageManager, String paramString, int paramInt, long paramLong, QQMessageFacade.RefreshMessageContext paramRefreshMessageContext, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (int i = (int)localChatMessage.shmsgseq;; i = 0)
    {
      ...
      for (boolean bool = true; (j == i) || (i <= this.jdField_a_of_type_Long); bool = false)
      {
        ...
        TroopMessageManager.d(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopMessageManager).a.post(new enp(this));
        return;
      }
