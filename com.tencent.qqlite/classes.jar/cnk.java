...
{
  public cnk(TroopMemberListInnerFrame paramTroopMemberListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903636, paramViewGroup, false);
      paramView = new cnl(this.a, null);
    ...
    paramView = (cnl)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
    ...
    paramView.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131363997), new Object[] { paramViewGroup.toLowerCase() }));
    return localView;
  }
}
