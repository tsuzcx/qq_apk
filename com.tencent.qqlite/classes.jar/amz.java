  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.a.w == 5)
    {
      ...
      localBundle.putString("title", this.a.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131364191, new Object[] { this.a.jdField_a_of_type_AndroidOsBundle.getString("app_name") }));
    }
    for (;;)
    {
