...
public class drb
  implements Runnable
{
  public drb(DiscFileOperator paramDiscFileOperator) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      {
        str1 = FileHttpUtils.a(FileManagerUtil.b(this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFilePath));
