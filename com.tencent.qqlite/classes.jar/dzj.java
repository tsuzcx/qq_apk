  ...
  implements RichProtoProc.RichProtoCallback
{
  ...
  private im_msg_body.CustomFace a(im_msg_body.NotOnlineImage paramNotOnlineImage)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        Logger.a(this.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.convert2CustomFace", dzi.a(this.a, localCustomFace));
  ...
  private im_msg_body.NotOnlineImage a(im_msg_body.CustomFace paramCustomFace)
  {
    ...
    try
    {
      ...
      Logger.a(this.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.createNotOnlineImage", "OK, " + dzi.a(this.a, localNotOnlineImage));
  ...
  private void b()
  {
    new dzk(this).execute(new Void[0]);
  }
