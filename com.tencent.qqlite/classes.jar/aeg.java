  ...
  implements DialogInterface.OnDismissListener, View.OnClickListener, OnLongClickAndTouchListener
{
  ...
  private aeg(ChatHistory paramChatHistory) {}
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    localQQCustomMenu.a(2131298983, this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131363073));
    if (localQQCustomMenu.a() > 0)
    {
      this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = ((aeh)ChatHistory.a(paramView)).jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
      String str;
