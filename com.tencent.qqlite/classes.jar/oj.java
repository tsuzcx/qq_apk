...
{
  public oj(PublicAccountManager paramPublicAccountManager, NewIntent paramNewIntent, QQAppInterface paramQQAppInterface, String paramString, BusinessObserver paramBusinessObserver) {}
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ...
            {
              ThreadManager.b(new ok(this, localGetPublicAccountMenuResponse, paramInt, paramBoolean, paramBundle));
              return;
              l = 0L;
              break label98;
              label222:
