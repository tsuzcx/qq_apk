...
{
  public csm(EmoticonManagerImp paramEmoticonManagerImp, EmosmHandler paramEmosmHandler) {}
  ...
  public void a(boolean paramBoolean, int paramInt, EmosmResp paramEmosmResp)
  {
    ...
    if ((paramInt == 2) && (paramBoolean))
    {
      ...
      if ((paramEmosmResp.magicData.size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqAppEmoticonManagerImp.b("100000") == null))
      {
        ...
        paramEmosmResp.name = EmoticonManagerImp.a(this.jdField_a_of_type_ComTencentMobileqqAppEmoticonManagerImp).getApplication().getString(2131364078);
        paramEmosmResp.mark = EmoticonManagerImp.a(this.jdField_a_of_type_ComTencentMobileqqAppEmoticonManagerImp).getApplication().getString(2131364078);
