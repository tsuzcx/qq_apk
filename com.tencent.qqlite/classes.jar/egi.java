  ...
  implements View.OnClickListener
{
  ...
  public egi(StructMsgForAudioShare paramStructMsgForAudioShare) {}
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((localObject != null) && (((AbsShareMsg)localObject).mMsgServiceID == 2))
          {
            ...
            if (QQPlayerService.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForAudioShare))
            {
              ...
              paramView.setContentDescription(localResources.getString(2131364338));
              return;
            }
          }
        }
        catch (AccountNotMatchException localAccountNotMatchException)
        {
          ...
          else
          {
            ...
            paramView.setContentDescription(localResources.getString(2131364337));
            return;
          }
        }
      }
