...
public final class esk
  implements Runnable
{
  public esk(BaseActivity paramBaseActivity, String paramString1, boolean paramBoolean, String paramString2, String paramString3, QQProgressDialog paramQQProgressDialog) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new esm(this, localException));
        return;
      }
    }
    ...
    for (Object localObject1 = "subapp=tips&";; localObject1 = "subapp=BusinessCard&")
    {
      ...
      for (str = "&uin_source=friend";; str = "&uin_source=0")
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new esl(this, str));
        return;
      }
      str = "0";
      break label428;
