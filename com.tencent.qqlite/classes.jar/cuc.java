...
{
  public cuc(PhoneContactManagerImp paramPhoneContactManagerImp) {}
  ...
  void a()
  {
    ...
    do
    {
      ...
      for (boolean bool = ((AppActivity)localObject1).isFinishing();; bool = false)
      {
        ...
        ((AppActivity)localObject1).overridePendingTransition(2130968637, 2130968589);
        return;
    ...
    BaseActivity.sTopActivity.overridePendingTransition(2130968637, 2130968589);
  }
  ...
  void c(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      cud localcud = new cud(this);
      PhoneContactManagerImp.a(this.a).a(localcud);
    }
  }
