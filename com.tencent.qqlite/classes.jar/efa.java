  ...
  implements XmlSerializer
{
  ...
  public efa(AbsStructMsg paramAbsStructMsg, XmlSerializer paramXmlSerializer)
  {
  ...
  public XmlSerializer text(String paramString)
  {
    if (paramString != null) {
      try
      {
        XmlSerializer localXmlSerializer = this.jdField_a_of_type_OrgXmlpullV1XmlSerializer.text(MessageUtils.a(paramString, false));
