  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public ckz(ContactsInnerFrame paramContactsInnerFrame, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903620, paramViewGroup, false);
      paramView = new cla(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame, null);
    ...
    paramView = (cla)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
