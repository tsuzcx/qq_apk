...
{
  public bro(VerifyCodeActivity paramVerifyCodeActivity) {}
  ...
  public void onReceiveVerifyCode(String paramString1, int paramInt, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    if (this.a.jdField_a_of_type_Boolean)
    {
      ...
      Toast.makeText(this.a, this.a.getString(2131362816), 0).show();
    }
    ...
    Toast.makeText(this.a, this.a.getString(2131362817), 1).show();
  }
