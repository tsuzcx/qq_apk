...
public class cji
  extends AsyncTask
{
  private cji(PhotoListActivity paramPhotoListActivity) {}
  ...
  protected void a(List paramList)
  {
    ...
    if (paramList == null)
    {
      this.a.jdField_a_of_type_Cjg.a(paramList);
      this.a.jdField_a_of_type_Cjg.notifyDataSetChanged();
    ...
    for (;;)
    {
      ...
      {
        label249:
        j = this.a.jdField_a_of_type_Cjg.getCount();
        if (j == 0) {
          j = k;
        }
        for (;;)
