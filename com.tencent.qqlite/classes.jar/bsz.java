  ...
  extends LinearLayout
{
  ...
  public bsz(PanelAdapter paramPanelAdapter, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    while (i < m)
    {
      ...
      while (j < k)
      {
        ...
        ((PanelAdapter.ViewHolder)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131296759));
        ((PanelAdapter.ViewHolder)localObject).b = ((ImageView)localView.findViewById(2131296761));
        ((PanelAdapter.ViewHolder)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131296760));
