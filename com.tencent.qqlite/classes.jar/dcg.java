...
public class dcg
  implements Runnable
{
  public dcg(ConfigServlet paramConfigServlet, File paramFile1, String paramString1, String paramString2, File paramFile2, String paramString3, String paramString4, String paramString5, String paramString6) {}
  ...
  public void run()
  {
    ...
    //   1: istore_2
    //   2: aload_0
    //   3: getfield 21	dcg:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   6: invokevirtual 52	java/io/File:exists	()Z
    //   9: ifne +148 -> 157
    //   12: iconst_0
    //   13: istore_1
    //   14: aload_0
    //   15: getfield 19	dcg:jdField_a_of_type_ComTencentMobileqqConfigSplashlogoConfigServlet	Lcom/tencent/mobileqq/config/splashlogo/ConfigServlet;
    ...
    //   24: aload_0
    //   25: getfield 23	dcg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   28: aload_0
    //   29: getfield 21	dcg:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   37: ifeq +103 -> 140
    //   40: aload_0
    //   41: getfield 21	dcg:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   44: invokevirtual 52	java/io/File:exists	()Z
    //   47: ifeq +88 -> 135
    //   50: aload_0
    //   51: getfield 21	dcg:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   54: invokestatic 71	oicq/wlogin_sdk/tools/MD5:getFileMD5	(Ljava/io/File;)Ljava/lang/String;
    //   57: aload_0
    //   58: getfield 25	dcg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   99: ifeq +132 -> 231
    //   102: aload_0
    //   103: getfield 27	dcg:jdField_b_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   154: goto -69 -> 85
    //   157: aload_0
    //   158: getfield 21	dcg:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   161: invokestatic 71	oicq/wlogin_sdk/tools/MD5:getFileMD5	(Ljava/io/File;)Ljava/lang/String;
    //   164: aload_0
    //   165: getfield 25	dcg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   181: astore 4
    //   183: aload_0
    //   184: getfield 21	dcg:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   187: invokevirtual 52	java/io/File:exists	()Z
    //   190: ifeq +11 -> 201
    //   193: aload_0
    //   194: getfield 21	dcg:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   275: aload_0
    //   276: getfield 25	dcg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   287: aload_0
    //   288: getfield 33	dcg:e	Ljava/lang/String;
    ...
    //   310: astore 4
    //   312: aload_0
    //   313: getfield 21	dcg:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   316: invokevirtual 52	java/io/File:exists	()Z
    //   319: ifeq +15 -> 334
    //   322: aload 5
    //   324: astore 4
    //   326: aload_0
    //   327: getfield 21	dcg:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   359: aload 5
    //   361: aload_0
    //   362: getfield 35	dcg:f	Ljava/lang/String;
    //   365: ldc 133
