...
public class dfb
  implements Runnable
{
  public dfb(SogouEmoji paramSogouEmoji, String paramString1, String paramString2, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonSogouEmoji.a(this.jdField_a_of_type_JavaLangString, localArrayList, new dfc(this));
    } while (!QLog.isColorLevel());
