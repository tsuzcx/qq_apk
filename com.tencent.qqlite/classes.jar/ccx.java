...
{
  public ccx(SystemMsgListView paramSystemMsgListView) {}
  ...
  protected void a(String paramString)
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog != null) && (this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.isShowing()))
    {
      ...
      paramString = SystemMsgListView.a(this.a).getResources().getString(2131362892);
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = SystemMsgListView.a(this.a).getResources().getString(2131363385);
      ...
      paramString1 = SystemMsgListView.a(this.a).getResources().getString(2131362822);
      if (paramInt1 == 0) {
        paramString1 = SystemMsgListView.a(this.a).getResources().getString(2131362821);
      }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      {
        String str = SystemMsgListView.a(this.a).getResources().getString(2131362893);
