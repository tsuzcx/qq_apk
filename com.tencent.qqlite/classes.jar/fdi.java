...
public class fdi
  implements Runnable
{
  public fdi(AppReportReceiver paramAppReportReceiver, Intent paramIntent, Context paramContext) {}
  ...
  public void run()
  {
    ...
    //   2: istore_1
    //   3: aload_0
    //   4: getfield 16	fdi:jdField_a_of_type_AndroidContentIntent	Landroid/content/Intent;
    ...
    //   25: ifeq +211 -> 236
    //   28: aload_0
    //   29: getfield 18	fdi:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   32: ldc 43
    ...
    //   129: ifne +314 -> 443
    //   132: aload_0
    //   133: getfield 16	fdi:jdField_a_of_type_AndroidContentIntent	Landroid/content/Intent;
    ...
    //   163: ifeq +280 -> 443
    //   166: aload_0
    //   167: getfield 14	fdi:jdField_a_of_type_ComTencentOpenBusinessBaseAppreportAppReportReceiver	Lcom/tencent/open/business/base/appreport/AppReportReceiver;
    //   170: aload 4
    ...
    //   198: aload_0
    //   199: getfield 16	fdi:jdField_a_of_type_AndroidContentIntent	Landroid/content/Intent;
    //   202: ldc 150
    //   204: iconst_0
    //   205: invokevirtual 154	android/content/Intent:getBooleanExtra	(Ljava/lang/String;Z)Z
    //   208: ifne +235 -> 443
    //   211: aload_0
    //   212: getfield 14	fdi:jdField_a_of_type_ComTencentOpenBusinessBaseAppreportAppReportReceiver	Lcom/tencent/open/business/base/appreport/AppReportReceiver;
    ...
    //   235: return
    //   236: aload_0
    //   237: getfield 16	fdi:jdField_a_of_type_AndroidContentIntent	Landroid/content/Intent;
    //   240: ldc 165
    //   242: iconst_0
    //   243: invokevirtual 154	android/content/Intent:getBooleanExtra	(Ljava/lang/String;Z)Z
    //   246: istore_2
    //   247: aload_0
    //   248: getfield 16	fdi:jdField_a_of_type_AndroidContentIntent	Landroid/content/Intent;
    ...
    //   317: ifeq +121 -> 438
    //   320: aload_0
    //   321: getfield 18	fdi:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   353: aload_0
    //   354: getfield 14	fdi:jdField_a_of_type_ComTencentOpenBusinessBaseAppreportAppReportReceiver	Lcom/tencent/open/business/base/appreport/AppReportReceiver;
    //   357: aload 5
    ...
    //   414: goto -80 -> 334
    //   417: aload_0
    //   418: getfield 18	fdi:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
