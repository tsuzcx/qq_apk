  ...
  public final void a(e parame)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        parame.d(localb.tag, localb.aiV, localb.aiW);
        continue;
        parame.e(localb.tag, localb.aiV, localb.aiW);
        continue;
        parame.c(localb.tag, localb.aiV, localb.aiW);
        continue;
        parame.b(localb.tag, localb.aiV, localb.aiW);
        continue;
        if (localb.aiX != null) {
          parame.a(localb.tag, localb.aiX, localb.aiV, localb.aiW);
        } else {
          parame.a(localb.tag, localb.aiV, localb.aiW);
        }
      }
    }
