...
final class SystemClassLoaderAdder$V19
{
  private static Object[] a(Object paramObject, ArrayList<File> paramArrayList, File paramFile, ArrayList<IOException> paramArrayList1)
  {
    try
    {
      Method localMethod1 = h.a(paramObject, "makeDexElements", new Class[] { ArrayList.class, File.class, ArrayList.class });
    ...
    catch (NoSuchMethodException localNoSuchMethodException)
    {
      for (;;)
      {
        ...
        try
        {
          Method localMethod2 = h.a(paramObject, "makeDexElements", new Class[] { List.class, File.class, List.class });
        }
