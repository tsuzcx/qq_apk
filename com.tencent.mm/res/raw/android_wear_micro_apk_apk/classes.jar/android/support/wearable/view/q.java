  ...
  implements TimeInterpolator
{
  ...
  public final float getInterpolation(float paramFloat)
  {
    ...
    int i = Math.min((int)((nj.length - 1) * paramFloat), nj.length - 2);
    paramFloat = (paramFloat - i * Dr) / Dr;
    float f = nj[i];
    return (nj[(i + 1)] - nj[i]) * paramFloat + f;
  }
}
