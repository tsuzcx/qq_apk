...
@Metadata(d1={""}, d2={"Landroidx/compose/runtime/snapshots/SnapshotMapValueSet;", "K", "V", "Landroidx/compose/runtime/snapshots/SnapshotMapSet;", "map", "Landroidx/compose/runtime/snapshots/SnapshotStateMap;", "(Landroidx/compose/runtime/snapshots/SnapshotStateMap;)V", "add", "", "element", "(Ljava/lang/Object;)Ljava/lang/Void;", "addAll", "elements", "", "contains", "", "(Ljava/lang/Object;)Z", "containsAll", "iterator", "Landroidx/compose/runtime/snapshots/StateMapMutableValuesIterator;", "remove", "removeAll", "retainAll", "runtime_release"}, k=1, mv={1, 5, 1}, xi=48)
final class p<K, V>
  extends o<K, V, V>
{
  public p(t<K, V> paramt)
  {
    super(paramt);
  ...
  public final boolean contains(Object paramObject)
  {
    ...
    boolean bool = rK().containsValue(paramObject);
  ...
  public final boolean containsAll(Collection<? extends Object> paramCollection)
  {
    ...
    if (!((Collection)paramCollection).isEmpty())
    {
      ...
      while (paramCollection.hasNext())
      {
        ...
        if (!rK().containsValue(localObject))
        {
  ...
  public final boolean remove(Object paramObject)
  {
    ...
    t localt = rK();
    Iterator localIterator = ((Iterable)localt.entrySet()).iterator();
    Object localObject;
    do
    {
    ...
    } while (!s.p(((Map.Entry)localObject).getValue(), paramObject));
    ...
    localt.remove(paramObject.getKey());
    AppMethodBeat.o(202490);
    return true;
  }
  ...
  public final boolean removeAll(Collection<? extends Object> paramCollection)
  {
    ...
    s.u(paramCollection, "elements");
    Object localObject1 = kotlin.a.p.r((Iterable)paramCollection);
    paramCollection = rK();
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((Set)localObject1).contains(localEntry.getValue()))
      {
 ...
 * Qualified Name:     androidx.compose.runtime.f.p
