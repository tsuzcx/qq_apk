...
public final class e
{
  ...
  public static Animator a(Context paramContext, Resources paramResources, Resources.Theme paramTheme, int paramInt)
  {
    ...
    //   44: iconst_0
    //   45: fconst_1
    //   46: invokestatic 34	androidx/k/a/a/e:a	(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/animation/AnimatorSet;IF)Landroid/animation/Animator;
    //   49: astore_0
    //   50: aload 7
    //   52: ifnull +10 -> 62
    //   55: aload 7
  ...
  private static Animator a(Context paramContext, Resources paramResources, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, AnimatorSet paramAnimatorSet, int paramInt, float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      if (((String)localObject1).equals("set"))
      {
        ...
        localObject2 = g.a(paramResources, paramTheme, paramAttributeSet, a.atL);
  ...
  private static PropertyValuesHolder a(TypedArray paramTypedArray, int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    for (;;)
    {
      if (i == 2)
      {
        ...
        arrayOfb1 = androidx.core.graphics.d.B((String)localObject);
        arrayOfb2 = androidx.core.graphics.d.B(paramTypedArray);
    ...
    for (;;)
    {
      ...
      if (arrayOfb2 != null)
      {
        paramString = PropertyValuesHolder.ofObject(paramString, new a(), new Object[] { arrayOfb2 });
        continue;
        localObject = null;
        if (i == 3) {
          localObject = f.nB();
  ...
  private static ValueAnimator a(Context paramContext, Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, ValueAnimator paramValueAnimator, float paramFloat, XmlPullParser paramXmlPullParser)
  {
    ...
    TypedArray localTypedArray = g.a(paramResources, paramTheme, paramAttributeSet, a.atK);
    paramTheme = g.a(paramResources, paramTheme, paramAttributeSet, a.atO);
    ...
    if (i > 0) {
      paramResources.setInterpolator(d.x(paramContext, i));
    }
  ...
  private static void a(ValueAnimator paramValueAnimator, TypedArray paramTypedArray1, TypedArray paramTypedArray2, float paramFloat, XmlPullParser paramXmlPullParser)
  {
    ...
    label368:
    a(androidx.core.graphics.d.A(paramTypedArray1), paramValueAnimator, 0.5F * paramFloat, (String)localObject, paramXmlPullParser);
    AppMethodBeat.o(202594);
    return;
    label392:
  ...
  private static PropertyValuesHolder[] a(Context paramContext, Resources paramResources, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet)
  {
    ...
    {
      TypedArray localTypedArray1 = g.a(paramResources, paramTheme, paramAttributeSet, a.atM);
      ...
      if ((j != 3) && (j != 1))
      {
        ...
        if (paramXmlPullParser.getName().equals("keyframe"))
        {
          ...
          if (i == 4)
          {
            localObject2 = g.a(paramResources, paramTheme, Xml.asAttributeSet(paramXmlPullParser), a.atN);
            localObject3 = g.a((TypedArray)localObject2, paramXmlPullParser, "value");
            if (localObject3 == null) {
              break label426;
            }
            i = 1;
            if ((i == 0) || (!dB(((TypedValue)localObject3).type))) {
              break label432;
            }
            i = 3;
            ((TypedArray)localObject2).recycle();
          ...
          localTypedArray2 = g.a(paramResources, paramTheme, Xml.asAttributeSet(paramXmlPullParser), a.atN);
          localObject3 = null;
          ...
          if ((k == 0) || (!dB(((TypedValue)localObject2).type))) {
            break label444;
          }
          i = 3;
          label293:
        ...
        for (;;)
        {
          ...
          if (i > 0) {
            ((Keyframe)localObject2).setInterpolator(d.x(paramContext, i));
          }
      ...
      else if (localObject1 != null)
      {
        ...
        if (j > 0)
        {
          ...
          if (f < 1.0F)
          {
            ...
            if (i == 3)
            {
              ((PropertyValuesHolder)localObject2).setEvaluator(f.nB());
              localObject1 = localObject2;
            }
            label856:
            if (localObject1 == null)
  ...
  private static boolean dB(int paramInt)
  {
 ...
 * Qualified Name:     androidx.k.a.a.e
