  ...
  implements Interpolator
{
  ...
  private g(Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, XmlPullParser paramXmlPullParser)
  {
    ...
    paramResources = androidx.core.content.a.g.a(paramResources, paramTheme, paramAttributeSet, a.atP);
    if (androidx.core.content.a.g.a(paramXmlPullParser, "pathData"))
    {
      ...
      paramAttributeSet = d.A(paramTheme);
  ...
  private void b(Path paramPath)
  {
    ...
    if ((Math.abs(this.Pu[0]) > 1.E-005D) || (Math.abs(this.Pv[0]) > 1.E-005D) || (Math.abs(this.Pu[(k - 1)] - 1.0F) > 1.E-005D) || (Math.abs(this.Pv[(k - 1)] - 1.0F) > 1.E-005D))
    {
      paramPath = new IllegalArgumentException("The Path must start at (0,0) and end at (1,1) start: " + this.Pu[0] + "," + this.Pv[0] + " end:" + this.Pu[(k - 1)] + "," + this.Pv[(k - 1)]);
      AppMethodBeat.o(202659);
      throw paramPath;
    }
    f1 = 0.0F;
 ...
 * Qualified Name:     androidx.k.a.a.g
