...
{
  /* Error */
  public static byte[] cV(byte[] paramArrayOfByte)
  {
    // Byte code:
    //   0: ldc 11
    ...
    //   49: astore 4
    //   51: aload_0
    //   52: invokevirtual 43	java/io/ByteArrayInputStream:close	()V
    //   55: aload_2
    //   56: invokevirtual 44	java/util/zip/InflaterInputStream:close	()V
    //   59: aload_3
    //   60: invokevirtual 45	java/io/ByteArrayOutputStream:close	()V
    //   63: ldc 11
    //   65: invokestatic 48	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   68: aconst_null
    //   69: areturn
    //   70: aload_3
    //   71: invokevirtual 52	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   74: astore 4
    //   76: aload_0
    //   77: invokevirtual 43	java/io/ByteArrayInputStream:close	()V
    //   80: aload_2
    //   81: invokevirtual 44	java/util/zip/InflaterInputStream:close	()V
    //   84: aload_3
    //   85: invokevirtual 45	java/io/ByteArrayOutputStream:close	()V
    //   88: ldc 11
    ...
    //   96: astore 4
    //   98: aload_0
    //   99: invokevirtual 43	java/io/ByteArrayInputStream:close	()V
    //   102: aload_2
    //   103: invokevirtual 44	java/util/zip/InflaterInputStream:close	()V
    //   106: aload_3
    //   107: invokevirtual 45	java/io/ByteArrayOutputStream:close	()V
    //   110: ldc 11
  ...
  public static byte[] compress(byte[] paramArrayOfByte)
  {
    ...
    //   12: astore_1
    //   13: new 57	java/util/zip/DeflaterOutputStream
    //   16: dup
    //   17: aload_1
    //   18: invokespecial 60	java/util/zip/DeflaterOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   21: astore_2
    //   22: aload_2
    //   23: aload_0
    //   24: invokevirtual 62	java/util/zip/DeflaterOutputStream:write	([B)V
    //   27: aload_2
    //   28: invokevirtual 65	java/util/zip/DeflaterOutputStream:finish	()V
    //   31: aload_1
    //   32: invokevirtual 52	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   35: astore_0
    //   36: aload_1
    //   37: invokevirtual 45	java/io/ByteArrayOutputStream:close	()V
    //   40: aload_2
    //   41: invokevirtual 66	java/util/zip/DeflaterOutputStream:close	()V
    //   44: ldc 55
    //   46: invokestatic 48	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   49: aload_0
    //   50: areturn
    //   51: astore_0
    //   52: aload_1
    //   53: invokevirtual 45	java/io/ByteArrayOutputStream:close	()V
    //   56: aload_2
    //   57: invokevirtual 66	java/util/zip/DeflaterOutputStream:close	()V
    //   60: ldc 55
    ...
    //   67: astore_0
    //   68: aload_1
    //   69: invokevirtual 45	java/io/ByteArrayOutputStream:close	()V
    //   72: aload_2
    //   73: invokevirtual 66	java/util/zip/DeflaterOutputStream:close	()V
    //   76: ldc 55
 ...
 * Qualified Name:     com.tencent.h.c.a
