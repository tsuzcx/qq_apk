  ...
  extends b
{
  private void a(PointF paramPointF, float paramFloat, int paramInt1, int paramInt2)
  {
    ...
    localFaceParam.bco = paramPointF;
    ...
    localFaceParam.bcq = new Point(paramPointF.centerX(), paramPointF.centerY());
    paramPointF = new Rect(paramPointF);
    localFaceParam.bcp = paramPointF;
    paramPointF.left += localRect2.width() * 2 / 3;
    int i = paramPointF.right;
    paramPointF.right = (localRect2.width() * 2 / 3 + i);
    localFaceParam.bcr = new Point(paramPointF.centerX(), paramPointF.centerY());
    paramPointF = new Rect();
    localFaceParam.bct = paramPointF;
