  ...
  extends View
{
  ...
  public uc(tn paramtn)
  {
    ...
    this.h.setStrokeWidth(6.0F * paramtn.f().b());
    this.h.setStyle(Paint.Style.STROKE);
    this.i = new Paint();
    this.i.setAntiAlias(true);
    this.i.setColor(Color.rgb(100, 100, 100));
    this.i.setStrokeWidth(10.0F * paramtn.f().b());
    this.i.setStyle(Paint.Style.STROKE);
    this.s = new Paint();
    this.s.setAntiAlias(true);
    this.s.setColor(Color.rgb(255, 255, 255));
    this.s.setStrokeWidth(7.0F * paramtn.f().b());
    this.s.setStyle(Paint.Style.STROKE);
    this.g = new Paint();
    this.g.setAntiAlias(true);
    this.g.setColor(-16777216);
    this.g.setTextSize(25.0F * paramtn.f().b());
    this.j = new Rect();
  }
 ...
 * Qualified Name:     com.tencent.tencentmap.mapsdk.a.uc
