...
public final class hq
{
  ...
  public static String a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i != 0)
        {
          localObject = (TelephonyManager)em.a().getSystemService("phone");
          if (localObject != null)
          {
  ...
  public static String a(int paramInt)
  {
    ...
    //   5: dup
    //   6: ldc 74
    //   8: invokespecial 78	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   11: iload_0
    //   12: invokevirtual 82	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   15: ldc 84
    ...
    //   23: astore_2
    //   24: new 92	java/io/BufferedReader
    //   27: dup
    //   28: new 94	java/io/FileReader
    //   31: dup
    //   32: aload_2
    //   33: invokespecial 95	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   36: invokespecial 98	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   39: astore_2
    //   40: aload_2
    //   41: invokevirtual 101	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   44: astore_3
    //   45: aload_3
    //   46: invokestatic 107	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   49: ifne +60 -> 109
    //   52: aload_3
    //   53: invokevirtual 61	java/lang/String:trim	()Ljava/lang/String;
    //   56: astore_3
    //   57: aload_3
    //   58: astore_1
    //   59: aload_2
    //   60: invokevirtual 110	java/io/BufferedReader:close	()V
    //   63: aload_1
    //   64: areturn
    //   65: astore_2
    //   66: aconst_null
    ...
    //   69: ifnull -6 -> 63
    //   72: aload_2
    //   73: invokevirtual 110	java/io/BufferedReader:close	()V
    //   76: aconst_null
    //   77: areturn
    //   78: astore_1
    //   79: aconst_null
  ...
  public static String c()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i != 0)
        {
          localObject = (WifiManager)em.a().getApplicationContext().getSystemService("wifi");
          if (localObject != null)
          {
  ...
  public static String d()
  {
    try
    {
      ...
      localObject = hp.a(((StringBuilder)localObject).toString());
      return localObject;
    }
    catch (Throwable localThrowable) {}
    return "";
  ...
  public static String e()
  {
    ...
    try
    {
      ...
      {
        if (i != 0) {
          d = Settings.Secure.getString(em.a().getContentResolver(), "android_id");
        }
        return d;
 ...
 * Qualified Name:     com.tencent.tencentmap.mapsdk.a.hq
