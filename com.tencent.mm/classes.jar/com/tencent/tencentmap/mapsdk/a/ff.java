...
public final class ff
{
  ...
  public final String a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 16	com/tencent/tencentmap/mapsdk/a/ff:a	Lorg/json/JSONObject;
    //   6: ifnonnull +10 -> 16
    //   9: ldc 18
    //   11: astore_1
    //   12: aload_0
    ...
    //   15: areturn
    //   16: aload_0
    //   17: getfield 16	com/tencent/tencentmap/mapsdk/a/ff:a	Lorg/json/JSONObject;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString1.hasNext())
        {
          ...
          localObject = new ff.a(this, (String)localObject, paramInt, paramString2, paramString3, paramString4, paramString5);
          if (!((ff.a)localObject).b) {
            continue;
          }
      ...
      {
        paramString1 = localJSONObject.optString(((ff.a)localArrayList.get(0)).a);
      }
      else
      {
        paramString1 = (ff.a)localArrayList.get(0);
        paramInt = 1;
        if (paramInt < localArrayList.size())
        {
          paramString2 = (ff.a)localArrayList.get(paramInt);
          if (!paramString1.b) {
            break label398;
          }
  ...
  public final void a(String paramString)
  {
    ...
    //   22: astore_3
    //   23: aload_0
    //   24: getfield 16	com/tencent/tencentmap/mapsdk/a/ff:a	Lorg/json/JSONObject;
    //   27: ifnonnull +11 -> 38
    //   30: aload_0
    //   31: aload_3
    //   32: putfield 16	com/tencent/tencentmap/mapsdk/a/ff:a	Lorg/json/JSONObject;
    //   35: goto -24 -> 11
    //   38: aload_3
    //   39: ldc 32
    ...
    //   60: ifne -49 -> 11
    //   63: aload_0
    //   64: getfield 16	com/tencent/tencentmap/mapsdk/a/ff:a	Lorg/json/JSONObject;
    //   67: ldc 32
    ...
    //   76: ifnonnull +33 -> 109
    //   79: aload_0
    //   80: getfield 16	com/tencent/tencentmap/mapsdk/a/ff:a	Lorg/json/JSONObject;
    //   83: ldc 32
    //   85: aload_1
    //   86: invokevirtual 114	org/json/JSONObject:putOpt	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   89: pop
    //   90: aload_0
    //   91: getfield 16	com/tencent/tencentmap/mapsdk/a/ff:a	Lorg/json/JSONObject;
    //   94: ldc 110
    //   96: aload_3
  ...
  public final String c()
  {
    ...
    //   6: ifnull +17 -> 23
    //   9: aload_0
    //   10: getfield 16	com/tencent/tencentmap/mapsdk/a/ff:a	Lorg/json/JSONObject;
    //   13: ldc 110
 ...
 * Qualified Name:     com.tencent.tencentmap.mapsdk.a.ff
