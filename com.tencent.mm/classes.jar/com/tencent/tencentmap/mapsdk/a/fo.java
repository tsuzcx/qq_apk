  ...
  extends SSLSocketFactory
{
  ...
  private final String b = fo.class.getSimpleName();
  private String c;
  ...
  public Socket createSocket(Socket paramSocket, String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      {
        paramSocket = (SSLSocket)((SSLCertificateSocketFactory)SSLCertificateSocketFactory.getInsecure(10000, new SSLSessionCache(em.a()))).createSocket(paramSocket, this.c, paramInt, paramBoolean);
      ...
      paramString = (SSLCertificateSocketFactory)SSLCertificateSocketFactory.getInsecure(10000, new SSLSessionCache(em.a()));
  ...
  {
    if ((TextUtils.isEmpty(this.c)) || (!(paramObject instanceof fo))) {}
    do
    {
      return false;
      paramObject = ((fo)paramObject).c;
 ...
 * Qualified Name:     com.tencent.tencentmap.mapsdk.a.fo
