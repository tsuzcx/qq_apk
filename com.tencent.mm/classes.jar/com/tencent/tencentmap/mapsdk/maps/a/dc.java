...
public final class dc
{
  ...
  public static String a(String paramString)
  {
    ...
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
      ...
      paramString = localUnsupportedEncodingException.toString();
      AppMethodBeat.o(147415);
    }
    localObject = new dc();
    ((dc)localObject).a();
    ((dc)localObject).a(new ByteArrayInputStream(paramString), paramString.length);
    paramString = new byte[8];
    a(paramString, ((dc)localObject).c, 8);
    i = (int)(localObject.c[0] >>> 3) & 0x3F;
    if (i < 56)
    {
      i = 56 - i;
      ((dc)localObject).a(a, i);
      ((dc)localObject).a(paramString, 8);
      a(((dc)localObject).e, ((dc)localObject).b, 16);
      paramString = ((dc)localObject).e;
      ...
      while (i < 16)
      {
        ...
        char[] tmp142_140 = arrayOfChar;
        tmp142_140[0] = 48;
        char[] tmp147_142 = tmp142_140;
        tmp147_142[1] = 49;
        ...
        tmp167_162[5] = 53;
        char[] tmp172_167 = tmp167_162;
        tmp172_167[6] = 54;
        char[] tmp178_172 = tmp172_167;
        tmp178_172[7] = 55;
