...
{
  private static final d RTF;
  private static final ConcurrentHashMap<Looper, WeakReference<Handler>> RTG;
  ...
  public static Handler a(String paramString, Handler.Callback paramCallback)
  {
    ...
    paramString = new a(paramString, RTF.looper, paramCallback);
    RTG.put(RTF.looper, new WeakReference(paramString));
  ...
  public static void release()
  {
    ...
    Iterator localIterator = RTG.values().iterator();
 ...
 * Qualified Name:     com.tencent.f.e.d
