  ...
  implements Handler.Callback
{
  ...
  public c(int paramInt)
  {
    ...
    this.RUq = d.a("HotPoolLeader", this);
    this.RUw = new a(paramInt);
  ...
  public final boolean handleMessage(Message paramMessage)
  {
    ...
    {
      this.RUw.execute((k)paramMessage);
  ...
  public final List<String> hmx()
  {
    ...
    Iterator localIterator = this.RUw.getQueue().iterator();
    ...
    a(int paramInt)
    {
      super(paramInt, 2147483647L, TimeUnit.HOURS, new LinkedBlockingQueue(), new ThreadFactory()new RejectedExecutionHandler
      {
        ...
        public final Thread newThread(Runnable paramAnonymousRunnable)
        {
          ...
          paramAnonymousRunnable = com.tencent.f.c.c.a("HotPool#" + this.RUu.getAndIncrement(), paramAnonymousRunnable, 7);
 ...
 * Qualified Name:     com.tencent.f.h.c
