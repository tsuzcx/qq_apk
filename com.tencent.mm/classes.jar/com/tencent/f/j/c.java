  ...
  implements com.tencent.f.d.a
{
  ...
  public c(a parama, Handler.Callback paramCallback)
  {
    ...
    try
    {
      ...
      new com.tencent.f.k.a(Handler.class, "mLooper").eE(parama);
  ...
  {
    this(a.bqt(paramString), paramCallback);
  ...
  private void cancelAll()
  {
    ...
    this.serial.RUS.a(new d.b()
    {
      public final boolean c(e paramAnonymouse)
      {
        ...
        paramAnonymouse = paramAnonymouse.RUI;
  ...
  private void recycleMessage(Message paramMessage)
  {
    ...
    try
    {
      this.recycleMethod.invoke(paramMessage, new Object[0]);
      AppMethodBeat.o(256691);
      return;
    }
  ...
  public void dump(Printer paramPrinter, String paramString)
  {
    ...
    paramPrinter.println(paramString + this.serial.RUS.hmI().toString());
  ...
  public boolean hasMessages(final int paramInt)
  {
    ...
    boolean bool = this.serial.RUS.a(new d.a()
    {
  ...
  public boolean sendMessageAtTime(Message paramMessage, long paramLong)
  {
    ...
    if (isQuit())
    {
      com.tencent.f.d.RSQ.g(paramMessage.getKey(), 0, this.serialTag);
    ...
    for (;;)
    {
      AppMethodBeat.o(183450);
      return true;
      h.RTc.c(paramMessage, this.serialTag);
      continue;
      paramLong -= SystemClock.uptimeMillis();
      if (a.hmD() == this.serial) {
        h.RTc.n(paramMessage, paramLong);
      } else {
        h.RTc.a(paramMessage, paramLong, this.serialTag);
      }
    }
  }
  ...
  final class a
    implements com.tencent.f.i.e, j
  {
    private Message RUY;
    private String RUZ;
    private Future<?> dBz;
    ...
    a(Message paramMessage)
    {
      ...
      this.RUY = paramMessage;
      this.RUZ = (c.this.serialTag + "#" + c.this.getMessageName(paramMessage));
      this.token = c.this;
      AppMethodBeat.o(183426);
    }
    ...
    public final boolean cancel()
    {
      ...
      boolean bool = this.dBz.cancel(false);
    ...
    public final void run()
    {
      ...
      if (c.this.isQuit.get())
      {
        ...
        com.tencent.f.d.RSS.w("SerialHandler", String.format("this handler has quit! %s", new Object[] { this.RUZ }), new Object[0]);
        AppMethodBeat.o(183427);
        return;
      }
      if ((this.RUY.getTarget() == null) && (this.RUY.obj == null) && (this.RUY.what == 0))
      {
        this.dBz.cancel(false);
        com.tencent.f.d.RSS.w("SerialHandler", String.format("maybe it's removed before! %s", new Object[] { this.RUZ }), new Object[0]);
        AppMethodBeat.o(183427);
        return;
      }
 ...
 * Qualified Name:     com.tencent.f.j.c
