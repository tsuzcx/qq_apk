  ...
  extends SQLiteOpenHelper
{
  ...
  private void createTable(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    for (;;)
    {
      ...
      catch (InstantiationException localInstantiationException)
      {
        for (;;)
        {
          Log.printErrStackTrace("MicroMsg.SqliteHelper", localInstantiationException, "", new Object[0]);
        }
      }
      catch (IllegalAccessException localIllegalAccessException)
      {
        for (;;)
        {
          Log.printErrStackTrace("MicroMsg.SqliteHelper", localIllegalAccessException, "", new Object[0]);
        }
      }
      i += 1;
    }
  ...
  public SQLiteDatabase getReadableDatabase()
  {
    ...
    //   49: invokestatic 111	com/tencent/mm/sdk/platformtools/Log:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   52: goto -41 -> 11
    //   55: aload_0
    //   56: monitorexit
    //   57: aload_1
    ...
    while (paramInt1 < paramInt2)
    {
      ...
      for (;;)
      {
        if (i < k)
        {
          ...
          {
            Log.printErrStackTrace("MicroMsg.SqliteHelper", localException, "", new Object[0]);
            i += 1;
          }
        }
      }
