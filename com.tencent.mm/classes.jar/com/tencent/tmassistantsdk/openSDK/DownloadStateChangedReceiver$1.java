  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    localTMQQDownloaderStateChangeParam.errorCode = bk.getInt(this.val$intent.getStringExtra("errorCode"), 0);
    localTMQQDownloaderStateChangeParam.errorMsg = this.val$intent.getStringExtra("errorMsg");
    localTMQQDownloaderStateChangeParam.state = bk.getInt(this.val$intent.getStringExtra("state"), 0);
    ...
    ((TMQQDownloaderOpenSDKParam)localObject).taskVersion = bk.getInt(this.val$intent.getStringExtra("taskVersion"), 0);
