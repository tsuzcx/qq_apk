  ...
  private TMOpenSDKToMsdkManager(Context paramContext)
  {
    ...
    this.retryBtnListener = new View.OnClickListener()
    {
      ...
      public void onClick(View paramAnonymousView)
      {
        ...
        a.b("com/tencent/tmassistantsdk/openSDK/opensdktomsdk/TMOpenSDKToMsdkManager$4", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
    ...
    this.negativeBtnListenner = new View.OnClickListener()
    {
      ...
      public void onClick(View paramAnonymousView)
      {
        ...
        b localb = new b();
        localb.bd(paramAnonymousView);
        a.b("com/tencent/tmassistantsdk/openSDK/opensdktomsdk/TMOpenSDKToMsdkManager$5", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
    ...
    this.positiveBtnListener = new View.OnClickListener()
    {
      ...
      public void onClick(View paramAnonymousView)
      {
        ...
        b localb = new b();
        localb.bd(paramAnonymousView);
        a.b("com/tencent/tmassistantsdk/openSDK/opensdktomsdk/TMOpenSDKToMsdkManager$6", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
        if (TMOpenSDKToMsdkManager.this.mContext == null)
        {
