...
public class SegmenterLib
{
  ...
  public native void refineUsingGC(Bitmap paramBitmap1, Bitmap paramBitmap2, Bitmap paramBitmap3, Bitmap paramBitmap4);
  
  public native Bitmap segment(Bitmap paramBitmap);
  
  public native void segmentOnBit(Bitmap paramBitmap1, Bitmap paramBitmap2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean);
