...
public abstract class SQLiteOpenHelper
{
  ...
  private SQLiteDatabase getDatabaseLocked(boolean paramBoolean)
  {
    ...
    //   11: invokevirtual 100	com/tencent/wcdb/database/SQLiteDatabase:isOpen	()Z
    //   14: ifne +25 -> 39
    //   17: aload_0
    //   18: aconst_null
    //   19: putfield 94	com/tencent/wcdb/database/SQLiteOpenHelper:mDatabase	Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   22: aload_0
    //   23: getfield 102	com/tencent/wcdb/database/SQLiteOpenHelper:mIsInitializing	Z
    //   26: ifeq +36 -> 62
    //   29: new 104	java/lang/IllegalStateException
    //   32: dup
    //   33: ldc 106
    //   35: invokespecial 107	java/lang/IllegalStateException:<init>	(Ljava/lang/String;)V
    //   38: athrow
    //   39: iload_1
    //   40: ifeq +13 -> 53
    //   43: aload_0
    //   44: getfield 94	com/tencent/wcdb/database/SQLiteOpenHelper:mDatabase	Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   47: invokevirtual 110	com/tencent/wcdb/database/SQLiteDatabase:isReadOnly	()Z
    //   50: ifne -28 -> 22
    //   53: aload_0
    ...
    //   67: aload_0
    //   68: iconst_1
    //   69: putfield 102	com/tencent/wcdb/database/SQLiteOpenHelper:mIsInitializing	Z
    //   72: aload_3
    //   73: ifnull +57 -> 130
    //   76: iload_1
    //   77: ifeq +256 -> 333
    //   80: aload_3
    //   81: invokevirtual 110	com/tencent/wcdb/database/SQLiteDatabase:isReadOnly	()Z
    //   84: ifeq +249 -> 333
    //   87: aload_3
    //   88: invokevirtual 113	com/tencent/wcdb/database/SQLiteDatabase:reopenReadWrite	()V
    //   91: aload_0
    //   92: aload_3
    //   93: invokespecial 117	com/tencent/wcdb/database/SQLiteOpenHelper:getDatabaseLockedLast	(Lcom/tencent/wcdb/database/SQLiteDatabase;)Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   96: astore 5
    //   98: aload_0
    //   99: iconst_0
    //   100: putfield 102	com/tencent/wcdb/database/SQLiteOpenHelper:mIsInitializing	Z
    //   103: aload 5
    //   105: astore 4
    //   107: aload_3
    //   108: ifnull -49 -> 59
    ...
    //   120: if_acmpeq -61 -> 59
    //   123: aload_3
    //   124: invokevirtual 120	com/tencent/wcdb/database/SQLiteDatabase:close	()V
    //   127: aload 5
    //   129: areturn
    //   130: aload_0
    ...
    //   137: aconst_null
    //   138: invokestatic 124	com/tencent/wcdb/database/SQLiteDatabase:create	(Lcom/tencent/wcdb/database/SQLiteDatabase$CursorFactory;)Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   141: astore 4
    //   143: aload 4
    //   145: astore_3
    //   146: goto -55 -> 91
    ...
    //   154: aload_0
    //   155: getfield 126	com/tencent/wcdb/database/SQLiteOpenHelper:mEnableWriteAheadLogging	Z
    //   158: ifeq +50 -> 208
    //   161: bipush 8
    //   163: istore_2
    //   164: aload_0
    //   165: iload_2
    //   166: putfield 128	com/tencent/wcdb/database/SQLiteOpenHelper:mMode	I
    //   169: aload_0
    ...
    //   185: aload_0
    //   186: getfield 128	com/tencent/wcdb/database/SQLiteOpenHelper:mMode	I
    //   189: aload_0
    ...
    //   197: invokestatic 134	com/tencent/wcdb/support/Context:openOrCreateDatabase	(Landroid/content/Context;Ljava/lang/String;[BLcom/tencent/wcdb/database/SQLiteCipherSpec;ILcom/tencent/wcdb/database/SQLiteDatabase$CursorFactory;Lcom/tencent/wcdb/DatabaseErrorHandler;)Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   200: astore 4
    //   202: aload 4
    //   204: astore_3
    //   205: goto -114 -> 91
    ...
    //   224: aload_0
    //   225: iconst_0
    //   226: putfield 102	com/tencent/wcdb/database/SQLiteOpenHelper:mIsInitializing	Z
    //   229: aload_3
    //   230: ifnull +15 -> 245
    //   233: aload_3
    //   234: aload_0
    ...
    //   238: if_acmpeq +7 -> 245
    //   241: aload_3
    //   242: invokevirtual 120	com/tencent/wcdb/database/SQLiteDatabase:close	()V
    //   245: aload 4
    //   247: athrow
    //   248: ldc 11
    ...
    //   280: aload 4
    //   282: aastore
    //   283: invokestatic 147	com/tencent/wcdb/support/Log:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   286: aload_0
    ...
    //   294: invokevirtual 153	android/content/Context:getDatabasePath	(Ljava/lang/String;)Ljava/io/File;
    //   297: invokevirtual 158	java/io/File:getPath	()Ljava/lang/String;
    //   300: aload_0
    ...
    //   317: invokestatic 162	com/tencent/wcdb/database/SQLiteDatabase:openDatabase	(Ljava/lang/String;[BLcom/tencent/wcdb/database/SQLiteCipherSpec;Lcom/tencent/wcdb/database/SQLiteDatabase$CursorFactory;ILcom/tencent/wcdb/DatabaseErrorHandler;)Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   320: astore 4
    //   322: aload 4
    //   324: astore_3
    //   325: goto -234 -> 91
  ...
  public void setWriteAheadLoggingEnabled(boolean paramBoolean)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 126	com/tencent/wcdb/database/SQLiteOpenHelper:mEnableWriteAheadLogging	Z
    //   6: iload_1
    //   7: if_icmpeq +47 -> 54
    //   10: aload_0
    ...
    //   49: aload_0
    //   50: iload_1
    //   51: putfield 126	com/tencent/wcdb/database/SQLiteOpenHelper:mEnableWriteAheadLogging	Z
    //   54: aload_0
    //   55: monitorexit
    //   56: return
    //   57: aload_0
