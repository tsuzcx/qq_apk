...
{
  public static int ACTION_ACK_ASYNC = 0;
  public static int ACTION_ACK_FAILED = 0;
  public static int ACTION_ACK_MALFORMED = 0;
  public static int ACTION_ACK_OK = 0;
  public static int ACTION_ACK_UNSUPPORTED = 0;
  ...
  public static LruCache<String, String> UUID_CACHE;
  ...
  static
  {
    ACTION_ACK_ASYNC = -100;
    ACTION_ACK_OK = 0;
    ACTION_ACK_MALFORMED = 1;
    ACTION_ACK_UNSUPPORTED = 2;
    ACTION_ACK_FAILED = 3;
    UUID_CACHE = new LruCache(100);
    totalWifiRecv = 0;
    totalWifiSend = 0;
    totalMobileRecv = 0;
    totalMobileSend = 0;
  ...
  private static int OnActionNotify(String paramString, long paramLong1, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, final byte[] paramArrayOfByte3, final long paramLong2)
  {
    Log.i(TAG, "[OnActionNotify] code: %d, uuid: %s, taskid:%d", new Object[] { Long.valueOf(paramLong1), paramString, Long.valueOf(paramLong2) });
    try
    {
      if ((UUID_CACHE.check(paramString)) && (paramLong1 != 5L))
      {
        Log.i(TAG, "[OnActionNotify] uuid = " + paramString + ", is Repeated");
        return ACTION_ACK_OK;
      }
      UUID_CACHE.put(paramString, paramString);
      if (paramLong1 == 2L)
      {
          ...
          ag.getHandler().post(new Runnable()
          {
            public void run()
            {
              try
              {
                ...
                localewv.Zsu = com.tencent.mm.bx.b.cX(MMLogic.this);
                localewv.TpC = com.tencent.mm.bx.b.cX(paramArrayOfByte3);
                localewv.abyW = paramLong2;
                ag.bRz().k(321, localewv.toByteArray());
                return;
              }
              catch (IOException localIOException)
              {
                Log.printErrStackTrace(MMLogic.TAG, localIOException, null, new Object[0]);
              }
            }
          });
          return ACTION_ACK_ASYNC;
        }
        int i = ACTION_ACK_FAILED;
        return i;
      }
    }
    catch (Exception paramString)
    {
      Log.e(TAG, "[OnActionNotify] e: " + paramString.getMessage());
    }
    return ACTION_ACK_UNSUPPORTED;
  }
  
  public static int ackActionNotify(String paramString, long paramLong, int paramInt)
  {
    Log.i(TAG, "action notify task=" + paramLong + ",result=" + paramInt);
    return mmAckActionNotify(paramString, paramLong, paramInt);
  }
  ...
  public static int doLiveSpeedTest(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, u paramu)
  {
    return MMLiveSpeedTestInterfaces.getInstance().doLiveSpeedTest(paramString, paramInt1, paramInt2, paramInt3, paramInt4, paramArrayOfByte1, paramArrayOfByte2, paramu);
  }
  
  public static native void doLiveSpeedTest(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, MMLiveSpeedTestInterfaces.SpeedTestCtx paramSpeedTestCtx, int paramInt5);
  ...
  {
    String str2 = d.dNI().a("clicfg_mars_use_new_netid", "0", false, true);
    Log.i("C2Java", "use new netid flag is ".concat(String.valueOf(str2)));
    String str1 = str2;
    if (str2 == null) {
      str1 = "0";
    }
  ...
  {
    String str = d.dNI().a("clicfg_android_newdns_cn", "0", false, true);
    Log.i(TAG, "newdns use cn flag is ".concat(String.valueOf(str)));
    if ("0".equals(str)) {}
    while (Util.isOverseasUser(MMApplicationContext.getContext())) {
      return 1;
    }
    return 0;
  }
  
  public static native int mmAckActionNotify(String paramString, long paramLong, int paramInt);
  ...
  private static void notifyNewSpeedTestReport(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString1, int paramInt5, String paramString2, int paramInt6, int paramInt7)
  {
    ...
    fgw localfgw = new fgw();
    localfgw.abHf = paramInt1;
    localfgw.abHg = paramInt2;
    localfgw.abHh = paramInt3;
    localfgw.abHi = paramInt4;
    localfgw.aaPP = com.tencent.mm.bx.b.cX(paramArrayOfByte);
    localfgw.abHd = "";
    localfgw.abHc = "";
    localfgw.abHe = "";
    if (paramInt7 == 3) {
    ...
    fgt localfgt1 = new fgt();
    fgt localfgt2 = new fgt();
    localfgt1.ip = paramString1;
    localfgt1.port = paramInt5;
    localfgt2.ip = paramString2;
    localfgt2.port = paramInt6;
    localfgw.abHk = localfgt1;
    localfgw.abHj = localfgt2;
    paramString1 = new String(paramArrayOfByte);
    Log.d("C2Java", "notifyNewSpeedTestReport origin cookie: " + paramString1 + ", origin size : " + paramArrayOfByte.length + ", covert cookie size " + localfgw.aaPP.Op.length);
    try
    {
      paramArrayOfByte = localfgw.toByteArray();
      ag.getHandler().post(new Runnable()
      {
        public void run()
        {
          ag.bRz().k(271, MMLogic.this);
        }
      });
      return;
    }
  ...
  private static void notifyStnWeaknet(boolean paramBoolean)
  {
  ...
  private static void onLiveSpeedTestCallback(MMLiveSpeedTestInterfaces.LiveSpeedTestResult paramLiveSpeedTestResult, boolean paramBoolean)
  {
    MMLiveSpeedTestInterfaces.getInstance().onLiveSpeedTestCallback(paramLiveSpeedTestResult, paramBoolean);
  }
  ...
  private static void onOOBNotify(String paramString)
  {
    ...
    try
    {
      ag.getHandler().post(new Runnable()
      {
        ...
        {
          ae localae = ag.bRz();
          if (Util.isNullOrNil(MMLogic.this)) {}
          for (byte[] arrayOfByte = null;; arrayOfByte = MMLogic.this.getBytes())
          {
            localae.k(268369923, arrayOfByte);
            return;
          }
        }
      });
  ...
  private static void reportFlow(final int paramInt1, final int paramInt2, final int paramInt3, final int paramInt4)
  {
    ...
    com.tencent.mm.network.a.b localb = ag.bRu().ppT;
    ...
    try
    {
      ag.getHandler().post(new Runnable()
      {
        public void run()
        {
          try
          {
            MMLogic.this.C(paramInt1, paramInt2, paramInt3, paramInt4);
            return;
          }
          finally
          {
  ...
  public static void reportStat(ReportInfo paramReportInfo)
  {
    try
    {
      ag.getHandler().post(new Runnable()
      {
        public void run()
        {
          int i = MMLogic.getJavaActionId(MMLogic.this.actionId);
          if (i == 0)
          {
            Log.e("C2Java", "ActionId Can not convert");
            return;
          }
          MMLogic.this.actionId = i;
        }
      });
      return;
    }
  ...
  public static native void setMMtlsRegion(int paramInt);
  
  public static native void setMmtlsCtrlInfo(boolean paramBoolean);
  
  public static native void setNetIdAndIsp(String paramString1, String paramString2, String paramString3);
  ...
  public static void simpleTestCommand(String paramString)
  {
    Log.d("zyzhang", "command is ".concat(String.valueOf(paramString)));
    ...
    do
    {
      ...
      {
        return;
        if (paramString.contains("testReportFlush"))
        {
          testReportFlush();
          return;
        }
      } while (paramString.contains("speedtest"));
      if (paramString.contains("oversea"))
      {
        Log.d("MMlogic", "is oversea user: " + Util.isOverseasUser(MMApplicationContext.getContext()));
        return;
      }
    } while (!paramString.contains("timestamp"));
    Log.d("MMlogic", "current timestamp ".concat(String.valueOf(getMarsTimestamp())));
  }
