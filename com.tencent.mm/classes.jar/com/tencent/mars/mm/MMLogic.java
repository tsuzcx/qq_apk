...
public class MMLogic
{
  ...
  private static int OnActionNotify(String paramString, long paramLong, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
  ...
  {
    String str2 = d.dgX().a("clicfg_mars_use_new_netid", "0", false, true);
  ...
  private static void notifyNewSpeedTestReport(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString1, int paramInt5, String paramString2, int paramInt6, int paramInt7)
  {
    ...
    emc localemc = new emc();
    localemc.UoB = paramInt1;
    localemc.UoC = paramInt2;
    localemc.UoD = paramInt3;
    localemc.UoE = paramInt4;
    localemc.TAB = com.tencent.mm.cd.b.cU(paramArrayOfByte);
    localemc.Uoz = "";
    localemc.Uoy = "";
    localemc.UoA = "";
    if (paramInt7 == 3) {
    ...
    ema localema1 = new ema();
    ema localema2 = new ema();
    localema1.ip = paramString1;
    localema1.port = paramInt5;
    localema2.ip = paramString2;
    localema2.port = paramInt6;
    localemc.UoG = localema1;
    localemc.UoF = localema2;
    paramString1 = new String(paramArrayOfByte);
    Log.d("C2Java", "notifyNewSpeedTestReport origin cookie: " + paramString1 + ", origin size : " + paramArrayOfByte.length + ", covert cookie size " + localemc.TAB.UH.length);
    try
    {
      paramArrayOfByte = localemc.toByteArray();
      af.btS().post(new Runnable()
      {
        public final void run()
        {
          af.btW().k(271, this.val$cookieByte);
        }
      });
      return;
    }
    ...
    try
    {
      af.btS().post(new Runnable()
      {
        public final void run()
        {
          ...
          {
            localad.k(268369923, arrayOfByte);
            return;
          }
        }
      });
  ...
  private static void reportFlow(final int paramInt1, final int paramInt2, final int paramInt3, final int paramInt4)
  {
    ...
    com.tencent.mm.network.a.b localb = af.btQ().mwu;
    ...
    try
    {
      af.btS().post(new Runnable()
      {
        public final void run()
        {
          try
          {
            this.val$monitor.w(paramInt1, paramInt2, paramInt3, paramInt4);
            return;
          }
  ...
  public static void simpleTestCommand(String paramString)
  {
    ...
    while (!paramString.contains("testReportFlush")) {
      return;
    }
    testReportFlush();
  }
