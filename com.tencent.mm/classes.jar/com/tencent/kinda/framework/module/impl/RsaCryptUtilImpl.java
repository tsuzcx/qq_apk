  ...
  implements RsaCryptUtil
{
  ...
  public RsaEncryptResult rsaPublicEncryptPemkey(String paramString1, String paramString2)
  {
    ...
    {
      ae.w("MicroMsg.RsaCryptUtilImpl", "input is null");
    ...
    if ((bool) && (!bu.cF(localPByteArray.value))) {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      ae.d("MicroMsg.RsaCryptUtilImpl", "encrypt ret: %s", new Object[] { localRsaEncryptResult });
      AppMethodBeat.o(18680);
      return localRsaEncryptResult;
    }
  }
