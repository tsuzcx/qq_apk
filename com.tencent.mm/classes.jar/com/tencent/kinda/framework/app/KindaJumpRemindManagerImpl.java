  ...
  implements KindaJumpRemindManager
{
  ...
  public void jumpRemindImpl(KJumpRemindInfo paramKJumpRemindInfo, int paramInt1, int paramInt2, final VoidBoolStringCallback paramVoidBoolStringCallback1, final VoidBoolStringCallback paramVoidBoolStringCallback2)
  {
    ...
    localcfm.uSc = paramKJumpRemindInfo.mJumpType;
    localcfm.Mlw = paramKJumpRemindInfo.mIsPopUpWindows;
    localcfm.dQx = paramKJumpRemindInfo.mWording;
    localcfm.lHA = paramKJumpRemindInfo.mLeftButtonWording;
    localcfm.lHB = paramKJumpRemindInfo.mRightButtonWording;
    dlx localdlx = new dlx();
    localdlx.type = paramKJumpRemindInfo.mUrl.mType;
    localdlx.dNI = paramKJumpRemindInfo.mUrl.mAppid;
    localdlx.MPC = paramKJumpRemindInfo.mUrl.mAppVersion;
    localdlx.path = paramKJumpRemindInfo.mUrl.mPath;
    localdlx.gTt = paramKJumpRemindInfo.mUrl.mBtnName;
    localcfm.Mlx = localdlx;
    localcfm.title = paramKJumpRemindInfo.mTitle;
    this.jumpRemind = m.a(localcfm);
