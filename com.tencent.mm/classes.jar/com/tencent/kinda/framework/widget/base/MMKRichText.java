  ...
  implements KText
{
  ...
  public void appendLink(KLink paramKLink)
  {
    ...
    if ((paramKLink != null) && ((paramKLink instanceof MMKLink)))
    {
      ...
      this.linkCallback = paramKLink.clickCallback;
    }
  ...
  public void appendText(String paramString)
  {
    ...
    if (paramString != null) {
      this.spanText.append(p.b(MMApplicationContext.getContext(), paramString));
    }
    ...
    public SpannableString get()
    {
      ...
      for (;;)
      {
        ...
        if (this.bgColor != null)
        {
          ...
          int i = a.fromDPToPix(MMApplicationContext.getContext(), 8);
