...
{
  private static final Field chb;
  ...
  static
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ac.w("MicroMsg.AppBrand.SurfaceTextureWrapper", "get mOnFrameAvailableHandler fail since " + localException.toString());
      }
    }
    chb = localObject;
  ...
  private m(SurfaceTexture paramSurfaceTexture)
  {
  ...
  /* Error */
  public static m d(SurfaceTexture paramSurfaceTexture)
  {
    // Byte code:
    //   0: ldc 97
    ...
    //   5: aload_0
    //   6: monitorenter
    //   7: getstatic 48	com/tencent/luggage/k/a/a/m:chb	Ljava/lang/reflect/Field;
    //   10: ifnonnull +12 -> 22
    //   13: aload_0
    //   14: monitorexit
    //   15: ldc 97
    ...
    //   20: aconst_null
    //   21: areturn
    //   22: getstatic 48	com/tencent/luggage/k/a/a/m:chb	Ljava/lang/reflect/Field;
    //   25: aload_0
    ...
    //   37: ldc 53
    //   39: ldc 105
    //   41: invokestatic 76	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   44: aload_0
    //   45: monitorexit
    //   46: ldc 97
    ...
    //   60: ldc 53
    //   62: ldc 107
    //   64: invokestatic 109	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   67: aload_2
    //   68: checkcast 8	com/tencent/luggage/k/a/a/m$a
    //   71: getfield 113	com/tencent/luggage/k/a/a/m$a:che	Lcom/tencent/luggage/k/a/a/m;
    //   74: astore_1
    //   75: aload_0
    //   76: monitorexit
    //   77: ldc 97
    ...
    //   82: aload_1
    //   83: areturn
    //   84: new 2	com/tencent/luggage/k/a/a/m
    //   87: dup
    //   88: aload_0
    //   89: invokespecial 115	com/tencent/luggage/k/a/a/m:<init>	(Landroid/graphics/SurfaceTexture;)V
    //   92: astore_1
    //   93: new 8	com/tencent/luggage/k/a/a/m$a
    //   96: dup
    //   97: aload_2
    //   98: aload_1
    //   99: invokespecial 118	com/tencent/luggage/k/a/a/m$a:<init>	(Landroid/os/Handler;Lcom/tencent/luggage/k/a/a/m;)V
    //   102: astore_2
    //   103: getstatic 48	com/tencent/luggage/k/a/a/m:chb	Ljava/lang/reflect/Field;
    //   106: aload_0
    //   107: aload_2
    ...
    //   142: invokestatic 76	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   145: aload_0
    //   146: monitorexit
    //   147: ldc 97
    ...
    for (;;)
    {
      try
      {
        ...
        if (localb.handler == null) {
          localb.chg.onFrameAvailable(this.mSurfaceTexture);
        } else {
          localb.handler.post(new Runnable()
          {
            public final void run()
            {
              ...
              localb.chg.onFrameAvailable(m.a(m.this));
    ...
    extends Handler
  {
    ...
    public a(Handler paramHandler, m paramm)
    {
      super();
      AppMethodBeat.i(206512);
      this.chf = paramHandler;
      this.che = paramm;
    ...
    public final void handleMessage(Message paramMessage)
    {
      ...
      this.chf.handleMessage(paramMessage);
      m.b(this.che);
  ...
  static final class b
  {
    ...
    public final boolean equals(Object paramObject)
    {
      ...
      boolean bool = this.chg.equals(paramObject.chg);
      AppMethodBeat.o(206514);
      return bool;
    }
    ...
    public final int hashCode()
    {
      ...
      int i = Objects.hash(new Object[] { this.chg });
 ...
 * Qualified Name:     com.tencent.luggage.k.a.a.m
