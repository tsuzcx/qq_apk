...
{
  private static final Field ckb;
  ...
  private p(SurfaceTexture paramSurfaceTexture)
  {
  ...
  /* Error */
  public static p d(SurfaceTexture paramSurfaceTexture)
  {
    // Byte code:
    //   0: ldc 97
    ...
    //   5: aload_0
    //   6: monitorenter
    //   7: getstatic 48	com/tencent/luggage/k/a/a/p:ckb	Ljava/lang/reflect/Field;
    //   10: ifnonnull +12 -> 22
    //   13: aload_0
    //   14: monitorexit
    //   15: ldc 97
    ...
    //   20: aconst_null
    //   21: areturn
    //   22: getstatic 48	com/tencent/luggage/k/a/a/p:ckb	Ljava/lang/reflect/Field;
    //   25: aload_0
    ...
    //   67: aload_2
    //   68: checkcast 8	com/tencent/luggage/k/a/a/p$a
    //   71: getfield 113	com/tencent/luggage/k/a/a/p$a:cke	Lcom/tencent/luggage/k/a/a/p;
    //   74: astore_1
    //   75: aload_0
    //   76: monitorexit
    //   77: ldc 97
    ...
    //   82: aload_1
    //   83: areturn
    //   84: new 2	com/tencent/luggage/k/a/a/p
    //   87: dup
    //   88: aload_0
    //   89: invokespecial 115	com/tencent/luggage/k/a/a/p:<init>	(Landroid/graphics/SurfaceTexture;)V
    //   92: astore_1
    //   93: new 8	com/tencent/luggage/k/a/a/p$a
    //   96: dup
    //   97: aload_2
    //   98: aload_1
    //   99: invokespecial 118	com/tencent/luggage/k/a/a/p$a:<init>	(Landroid/os/Handler;Lcom/tencent/luggage/k/a/a/p;)V
    //   102: astore_2
    //   103: getstatic 48	com/tencent/luggage/k/a/a/p:ckb	Ljava/lang/reflect/Field;
    //   106: aload_0
    //   107: aload_2
    ...
    for (;;)
    {
      try
      {
        ...
        if (localb.handler == null) {
          localb.ckg.onFrameAvailable(this.mSurfaceTexture);
        } else {
          localb.handler.post(new Runnable()
          {
            public final void run()
            {
              ...
              localb.ckg.onFrameAvailable(p.a(p.this));
  ...
  {
    public final p cke;
    private final Handler ckf;
    
    public a(Handler paramHandler, p paramp)
    {
      super();
      AppMethodBeat.i(194928);
      this.ckf = paramHandler;
      this.cke = paramp;
    ...
    public final void handleMessage(Message paramMessage)
    {
      ...
      this.ckf.handleMessage(paramMessage);
      p.b(this.cke);
  ...
  static final class b
  {
    ...
    public final boolean equals(Object paramObject)
    {
      ...
      boolean bool = this.ckg.equals(paramObject.ckg);
      AppMethodBeat.o(194930);
      return bool;
    }
    ...
    public final int hashCode()
    {
      ...
      int i = Objects.hash(new Object[] { this.ckg });
 ...
 * Qualified Name:     com.tencent.luggage.k.a.a.p
