  ...
  implements com.tencent.mm.plugin.appbrand.utils.b.a
{
  ...
  @SuppressLint({"NewApi"})
  private final List<a.b> cCO;
  @SuppressLint({"NewApi"})
  private final List<a.b> cCP;
  @SuppressLint({"NewApi"})
  private final List<a.b> cCQ;
  @SuppressLint({"NewApi"})
  private final List<a.b> cCR;
  TencentLocationListener cCS;
  private Set<String> cCT;
  private Runnable cCU;
  
  public a()
  {
    AppMethodBeat.i(146447);
    this.cCO = new CopyOnWriteArrayList();
    this.cCP = new CopyOnWriteArrayList();
    this.cCQ = new CopyOnWriteArrayList();
    this.cCR = new CopyOnWriteArrayList();
    this.cCS = new TencentLocationListener()
    {
  ...
  private TencentLocationManager Pc()
  {
    ...
    //   5: aload_0
    //   6: getfield 93	com/tencent/luggage/f/a/a:cCN	Lcom/tencent/map/geolocation/sapp/TencentLocationManager;
    //   9: ifnonnull +166 -> 175
    //   12: aload_0
    //   13: monitorenter
    //   14: aload_0
    //   15: getfield 93	com/tencent/luggage/f/a/a:cCN	Lcom/tencent/map/geolocation/sapp/TencentLocationManager;
    //   18: ifnonnull +155 -> 173
    //   21: aload_0
    //   22: invokevirtual 97	com/tencent/luggage/f/a/a:Pd	()Z
    //   25: ifeq +77 -> 102
    //   28: new 99	com/tencent/mm/vfs/o
    //   31: dup
    //   32: new 101	java/lang/StringBuilder
    //   35: dup
    //   36: invokespecial 102	java/lang/StringBuilder:<init>	()V
    //   39: invokestatic 107	com/tencent/mm/loader/j/b:aKJ	()Ljava/lang/String;
    ...
    //   50: invokestatic 77	com/tencent/mm/sdk/platformtools/MMApplicationContext:getProcessName	()Ljava/lang/String;
    //   53: invokestatic 116	com/tencent/mm/sdk/platformtools/MMApplicationContext:getPackageName	()Ljava/lang/String;
    ...
    //   70: iconst_1
    //   71: invokestatic 135	com/tencent/mm/vfs/s:k	(Ljava/lang/String;Z)Ljava/lang/String;
    //   74: invokespecial 138	com/tencent/mm/vfs/o:<init>	(Ljava/lang/String;)V
    //   77: astore_1
    //   78: invokestatic 142	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   81: new 144	java/io/File
    //   84: dup
    //   85: aload_1
    //   86: getfield 148	com/tencent/mm/vfs/o:mUri	Landroid/net/Uri;
    //   89: invokestatic 154	com/tencent/mm/vfs/aa:z	(Landroid/net/Uri;)Ljava/lang/String;
    //   92: iconst_1
    //   93: invokestatic 135	com/tencent/mm/vfs/s:k	(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    //   102: invokestatic 142	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    ...
    //   119: invokestatic 175	com/tencent/mm/compatible/deviceinfo/q:aoK	()Ljava/lang/String;
    //   122: astore_1
    //   123: aload_1
    //   124: invokestatic 181	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   127: ifeq +108 -> 235
    //   130: aload_0
    //   131: invokestatic 142	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    ...
    //   137: putfield 93	com/tencent/luggage/f/a/a:cCN	Lcom/tencent/map/geolocation/sapp/TencentLocationManager;
    //   140: aload_0
    //   141: getfield 93	com/tencent/luggage/f/a/a:cCN	Lcom/tencent/map/geolocation/sapp/TencentLocationManager;
    //   144: iconst_0
    ...
    //   161: iconst_1
    //   162: aload_0
    //   163: getfield 93	com/tencent/luggage/f/a/a:cCN	Lcom/tencent/map/geolocation/sapp/TencentLocationManager;
    //   166: invokevirtual 195	com/tencent/map/geolocation/sapp/TencentLocationManager:getVersion	()Ljava/lang/String;
    //   169: aastore
    //   170: invokestatic 82	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   173: aload_0
    //   174: monitorexit
    //   175: aload_0
    //   176: getfield 93	com/tencent/luggage/f/a/a:cCN	Lcom/tencent/map/geolocation/sapp/TencentLocationManager;
    //   179: astore_1
    //   180: ldc 91
    ...
    //   198: aload_1
    //   199: aastore
    //   200: invokestatic 200	com/tencent/mm/sdk/platformtools/Log:printInfoStack	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   203: goto -101 -> 102
    //   206: astore_1
    //   207: aload_0
    //   208: monitorexit
    ...
    //   227: aload_1
    //   228: aastore
    //   229: invokestatic 200	com/tencent/mm/sdk/platformtools/Log:printInfoStack	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   232: goto -113 -> 119
    //   235: aload_0
    //   236: invokestatic 142	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    ...
    //   252: putfield 93	com/tencent/luggage/f/a/a:cCN	Lcom/tencent/map/geolocation/sapp/TencentLocationManager;
    //   255: goto -115 -> 140
  ...
  public final void a(String paramString, a.b paramb, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      i = Pc().requestSingleFreshLocation(paramString, this.cCS, Looper.getMainLooper(), bool2);
      Log.d("MicroMsg.DefaultTencentLocationManager", "MapReport:%s getLocation", new Object[] { paramBundle.getString("smallAppKey") });
      Log.i("MicroMsg.DefaultTencentLocationManager", "requestCode %d", new Object[] { Integer.valueOf(i) });
  ...
  public final boolean b(String paramString, a.b paramb, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      bool = true;
      if (this.cCQ.size() + this.cCR.size() != 1) {
        break label424;
      }
      i = 1;
    }
    ...
    for (long l = 1000L;; l = 2000L)
    {
      ...
      Log.i("MicroMsg.DefaultTencentLocationManager", "requestCode %d", new Object[] { Integer.valueOf(Pc().requestLocationUpdates(paramString, this.cCS, Looper.getMainLooper())) });
      label396:
      AppMethodBeat.o(146450);
      break;
      for (;;)
  ...
  public final boolean c(String paramString, a.b paramb, Bundle paramBundle)
  {
    ...
    //   19: aload_1
    //   20: aastore
    //   21: invokestatic 82	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   24: ldc_w 380
    //   27: aload_1
    //   28: invokevirtual 259	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   31: ifeq +51 -> 82
    //   34: aload_0
    //   35: getfield 52	com/tencent/luggage/f/a/a:cCQ	Ljava/util/List;
    //   38: aload_2
    ...
    //   56: astore_1
    //   57: aload_0
    //   58: getfield 64	com/tencent/luggage/f/a/a:cCT	Ljava/util/Set;
    //   61: aload_1
    //   62: invokeinterface 497 2 0
    //   67: pop
    //   68: aload_0
    //   69: invokespecial 376	com/tencent/luggage/f/a/a:Pe	()V
    //   72: ldc_w 491
    ...
    //   81: ireturn
    //   82: aload_0
    //   83: getfield 54	com/tencent/luggage/f/a/a:cCR	Ljava/util/List;
    //   86: aload_2
