...
{
  private static final Map<String, String> Fmu;
  private static HashMap<String, com.tencent.mm.pluginsdk.b.d> Fmv;
  private static final HashSet<String> Fmw;
  ...
  public static com.tencent.mm.pluginsdk.b.a R(Context paramContext, String paramString1, String paramString2)
  {
    ...
    Object localObject = aNU(paramString1);
    if (localObject == null)
    {
      ad.f("MicroMsg.PluginHelper", "create contact widget failed, plugin=%s, type=%s", new Object[] { paramString1, paramString2 });
    ...
    if (localObject == null)
    {
      ad.f("MicroMsg.PluginHelper", "create contact widget factory failed, plugin=%s, type=%s", new Object[] { paramString1, paramString2 });
      AppMethodBeat.o(133743);
      return null;
    }
    paramContext = ((com.tencent.mm.pluginsdk.b.c)localObject).aa(paramContext, paramString2);
    AppMethodBeat.o(133743);
    return paramContext;
  }
  ...
  public static com.tencent.mm.pluginsdk.b.d a(String paramString, a parama, b paramb)
  {
    for (;;)
    {
      try
      {
        ...
        localObject = (String)Fmu.get(paramString);
        if (localObject != null) {
          ad.d("MicroMsg.PluginHelper", "load plugin with mapping %s -> %s", new Object[] { paramString, localObject });
        }
        localObject = (com.tencent.mm.pluginsdk.b.d)Fmv.get(paramString);
        if (localObject == null) {
          continue;
        }
        parama.onDone();
      ...
      finally
      {
        try
        {
          Object localObject = aNV(paramString);
          if (localObject != null) {
            parama.onDone();
          }
          AppMethodBeat.o(133746);
      ...
      try
      {
        com.tencent.mm.pluginsdk.b.d locald = aNV(paramString);
        if (locald != null) {
          parama.onDone();
        }
        AppMethodBeat.o(133746);
      ...
      {
        ad.f("MicroMsg.PluginHelper", "plugin load failed ClassNotFoundException , plugin=%s ,e:%s", new Object[] { paramString, parama.toString() });
        ad.f("MicroMsg.PluginHelper", "plugin load failed, plugin=%s", new Object[] { paramString });
      ...
      catch (InstantiationException parama)
      {
        for (;;)
        {
          ad.f("MicroMsg.PluginHelper", "plugin load failed InstantiationException , plugin=%s, e:%s", new Object[] { paramString, parama.toString() });
        }
      }
      catch (IllegalAccessException parama)
      {
        for (;;)
        {
          ad.f("MicroMsg.PluginHelper", "plugin load failed IllegalAccessException , plugin=%s, e:%s", new Object[] { paramString, parama.toString() });
        }
      }
    }
  }
  ...
  public static void a(final Context paramContext, final String paramString1, final String paramString2, Intent paramIntent)
  {
    ...
    a(paramString1, new a()new b
    {
      public final void onDone()
      {
        ...
        if (this.val$intent == null)
        {
          ...
          str = aj.fkB() + ".plugin." + paramString1;
        ...
        {
          localIntent.setClassName(aj.getPackageName(), str);
    ...
    }, new b()
    {
      public final void j(Exception paramAnonymousException)
      {
        ...
        ad.e("MicroMsg.PluginHelper", "start wizard activity failed, plugin(%s) not loaded", new Object[] { this.Fms });
        ad.e("MicroMsg.PluginHelper", "start wizard activity with exception:%s", new Object[] { paramAnonymousException });
  ...
  public static void a(final Context paramContext, final String paramString1, final String paramString2, Intent paramIntent, final int paramInt, boolean paramBoolean)
  {
    ...
    ad.d("MicroMsg.PluginHelper", "start activity for result, need try load plugin[%B]", new Object[] { Boolean.valueOf(paramBoolean) });
    ...
    if (".ui.tools.WebViewUI".equals(paramString2))
    {
      ...
      for (;;)
      {
        ad.i("MicroMsg.PluginHelper", "summer hardcoder biz startPerformance [%s][%s]", new Object[] { Integer.valueOf(902), Integer.valueOf(WXHardCoderJNI.startPerformance(paramBoolean, j, k, m, i, WXHardCoderJNI.hcBizTimeout, 902, WXHardCoderJNI.hcBizAction, "MicroMsg.PluginHelper")) });
        try
        {
          ...
          for (;;)
          {
            ...
            }, new b()
            {
              public final void j(Exception paramAnonymousException)
              {
                ...
                ad.f("MicroMsg.PluginHelper", "start activity failed, plugin(%s) not loaded", new Object[] { this.Fms });
                ad.e("MicroMsg.PluginHelper", "start activity failed,%s", new Object[] { paramAnonymousException });
            ...
            i = 0;
            break;
            if ((t.baV(((Uri)localObject).getHost())) && (!ToolsProcessIPCService.ahO()))
            {
              if (!"true".equalsIgnoreCase(com.tencent.xweb.a.baB("dis_switch_to_mp_start_activity_for_ret"))) {
                paramString2 = ".ui.tools.WebviewMpUI";
              } else {
                ad.i("MicroMsg.PluginHelper", "dis_switch_to_mp_start_activity_for_ret == true");
              }
            }
            else {}
          }
        ...
        {
          ad.e("MicroMsg.PluginHelper", "parse url failed :" + localException.getMessage());
        }
      }
    }
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, Intent paramIntent, Bundle paramBundle)
  {
    ...
    try
    {
      if ((paramContext.getSharedPreferences(aj.fkC(), 0).getBoolean("settings_multi_webview", false)) && (".ui.tools.WebViewUI".endsWith(paramString2)))
      {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ad.e("MicroMsg.PluginHelper", "%s", new Object[] { localException.getMessage() });
      }
    }
  }
  ...
  public static void a(ServiceConnection paramServiceConnection, String paramString)
  {
    ...
    com.tencent.mm.service.c.a(paramServiceConnection, paramString, true, aNS(paramString));
  ...
  public static void a(Fragment paramFragment, String paramString, Intent paramIntent, int paramInt)
  {
    ...
    {
      paramIntent.setClassName(aj.getPackageName(), str);
  ...
  public static void a(final Fragment paramFragment, final String paramString1, final String paramString2, Intent paramIntent, final int paramInt)
  {
    ...
    ad.d("MicroMsg.PluginHelper", "start activity for result, need try load plugin[%B]", new Object[] { Boolean.TRUE });
    a(paramString1, new a()new b
    {
      public final void onDone()
      {
  ...
  public static void a(String paramString, m paramm, l paraml)
  {
    ...
    ad.d("MicroMsg.PluginHelper", "--> registerApplication: %s", new Object[] { paramString });
    Object localObject = aNU(paramString);
    if (localObject == null)
    {
      ad.f("MicroMsg.PluginHelper", "register application failed, plugin=%s", new Object[] { paramString });
    ...
    if (localObject == null)
    {
      ad.w("MicroMsg.PluginHelper", "register application failed, plugin=%s", new Object[] { paramString });
      AppMethodBeat.o(133741);
      return;
    }
    ((n)localObject).a(paraml);
    ((n)localObject).a(paramm);
    ad.d("MicroMsg.PluginHelper", "<-- registerApplication successfully: %s %s %s", new Object[] { paramString, paramm, paraml });
    AppMethodBeat.o(133741);
  }
  ...
  public static boolean a(Intent paramIntent, ServiceConnection paramServiceConnection, String paramString)
  {
    ...
    boolean bool = com.tencent.mm.service.c.a(paramIntent, paramServiceConnection, 1, paramString, true, aNS(paramString));
    AppMethodBeat.o(133737);
    return bool;
  }
  
  /* Error */
  public static boolean aIu(String paramString)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   9: getstatic 73	com/tencent/mm/bs/d:Fmv	Ljava/util/HashMap;
    //   12: aload_0
  ...
  private static Intent aNS(String paramString)
  {
    ...
    for (;;)
    {
      paramString = new Intent(aj.getContext(), paramString);
  ...
  public static ax aNT(String paramString)
  {
    AppMethodBeat.i(133740);
    ad.d("MicroMsg.PluginHelper", "-->createSubCore: %s alone", new Object[] { paramString });
    Object localObject = aNU(paramString);
    if (localObject == null)
    {
      ad.f("MicroMsg.PluginHelper", "register subcore failed, plugin=%s", new Object[] { paramString });
    ...
    if (localObject == null)
    {
      ad.w("MicroMsg.PluginHelper", "create sub core failed, plugin=%s", new Object[] { paramString });
      AppMethodBeat.o(133740);
      return null;
    }
    ad.d("MicroMsg.PluginHelper", "<--createSubCore successfully: %s", new Object[] { paramString });
    AppMethodBeat.o(133740);
    return localObject;
  }
  
  /* Error */
  private static com.tencent.mm.pluginsdk.b.d aNU(String paramString)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   6: invokestatic 52	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   9: aload_0
    //   10: invokestatic 150	com/tencent/mm/bs/d:aNV	(Ljava/lang/String;)Lcom/tencent/mm/pluginsdk/b/d;
    //   13: astore_1
    //   14: aload_1
    //   15: astore_0
    //   16: ldc_w 563
    ...
    //   47: aastore
    //   48: invokestatic 106	com/tencent/mm/sdk/platformtools/ad:f	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   51: aconst_null
    //   52: astore_0
    //   53: ldc_w 563
    ...
    //   87: aastore
    //   88: invokestatic 106	com/tencent/mm/sdk/platformtools/ad:f	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   91: goto -40 -> 51
    //   94: astore_1
    //   95: ldc 98
    //   97: ldc 176
    ...
    //   113: aastore
    //   114: invokestatic 106	com/tencent/mm/sdk/platformtools/ad:f	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   117: goto -66 -> 51
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  private static com.tencent.mm.pluginsdk.b.d aNV(String paramString)
  {
    AppMethodBeat.i(133747);
    com.tencent.mm.pluginsdk.b.d locald = (com.tencent.mm.pluginsdk.b.d)Fmv.get(paramString);
    if (locald != null)
    {
      AppMethodBeat.o(133747);
      return locald;
    }
    locald = (com.tencent.mm.pluginsdk.b.d)aj.getContext().getClassLoader().loadClass(aj.fkB() + ".plugin." + paramString + ".Plugin").newInstance();
    Fmv.put(paramString, locald);
    AppMethodBeat.o(133747);
    return locald;
  }
  ...
  public static boolean aNW(String paramString)
  {
    ...
    //   6: invokestatic 52	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   9: aload_0
    //   10: invokestatic 96	com/tencent/mm/bs/d:aNU	(Ljava/lang/String;)Lcom/tencent/mm/pluginsdk/b/d;
    //   13: ifnull +16 -> 29
    //   16: iconst_1
    //   17: istore_1
    //   18: ldc_w 589
  ...
  public static com.tencent.mm.pluginsdk.b.a aa(Context paramContext, String paramString)
  {
  ...
  public static boolean ahO()
  {
    ...
    boolean bool = ToolsProcessIPCService.ahO();
  ...
  private static void b(final Context paramContext, String paramString1, final String paramString2, final Intent paramIntent, final Bundle paramBundle)
  {
    ...
    ad.d("MicroMsg.PluginHelper", "start activity, need try load plugin[%B]", new Object[] { Boolean.TRUE });
    if (paramContext == null)
    {
      ad.e("MicroMsg.PluginHelper", "start activity error, context is null");
    ...
    if ((paramIntent != null) && (!bt.isNullOrNil(paramIntent.getStringExtra("rawUrl")))) {
    ...
    if ((".ui.tools.WebViewUI".equals(paramString2)) || ("com.tencent.mm.plugin.webview.ui.tools.WebViewUI".equals(paramString2)))
    {
      ...
      for (;;)
      {
        ad.i("MicroMsg.PluginHelper", "summer hardcoder biz startPerformance [%s][%s]", new Object[] { Integer.valueOf(902), Integer.valueOf(WXHardCoderJNI.startPerformance(bool1, j, k, m, i, WXHardCoderJNI.hcBizTimeout, 902, WXHardCoderJNI.hcBizAction, "MicroMsg.PluginHelper")) });
        try
        {
          Object localObject = paramIntent.getStringExtra("rawUrl");
          ...
          for (;;)
          {
            a(paramString1, new a()new b
            {
              public final void onDone()
              {
                ...
                ad.d("MicroMsg.PluginHelper", "[DEBUG] onDone Load %s:%s", new Object[] { this.Fms, paramString2 });
                try
                {
                  if (paramIntent == null)
                  {
                    localObject1 = new Intent();
                    localObject2 = aj.fkB() + ".plugin." + this.Fms;
                    if (!paramString2.startsWith(".")) {
                      break label236;
                    }
                  }
                  ...
                  {
                    ((Intent)localObject1).setClassName(aj.getPackageName(), (String)localObject2);
                    ...
                    com.tencent.mm.hellhoundlib.a.a.a(localObject2, ((com.tencent.mm.hellhoundlib.b.a)localObject1).ahp(), "com/tencent/mm/pluginstub/PluginHelper$5", "onDone", "()V", "Undefined", "startActivity", "(Landroid/content/Intent;Landroid/os/Bundle;)V");
                    ((Context)localObject2).startActivity((Intent)((com.tencent.mm.hellhoundlib.b.a)localObject1).mq(0), (Bundle)((com.tencent.mm.hellhoundlib.b.a)localObject1).mq(1));
                ...
                {
                  ad.e("MicroMsg.PluginHelper", "Class Not Found when startActivity %s", new Object[] { localClassNotFoundException });
                  AppMethodBeat.o(133704);
                }
              }
            }, new b()
            ...
            i = 0;
            break;
            if ((((Uri)localObject).getHost() != null) && (((Uri)localObject).getHost().equals("mp.weixin.qq.com")) && (!ToolsProcessIPCService.ahO()))
            {
              paramString2 = ".ui.tools.WebviewMpUI";
            }
            else if ((t.baV(((Uri)localObject).getHost())) && (!ToolsProcessIPCService.ahO()))
            {
              paramString2 = ".ui.tools.WebviewMpUI";
            }
            else
            {
              ...
              if (!"false".equalsIgnoreCase(com.tencent.xweb.b.mV("dark_to_toolsmp", "tools"))) {}
              for (bool1 = true;; bool1 = false)
              {
                ad.i("MicroMsg.PluginHelper", "other web, isDarkMode:%s, darkToToolsmp:%s", new Object[] { Boolean.valueOf(bool2), Boolean.valueOf(bool1) });
                str = paramString2;
                if (al.isDarkMode())
                {
                  str = paramString2;
                  ...
                  {
                    str = paramString2;
                    if (!t.baW(((Uri)localObject).getHost())) {
  ...
  public static void c(Context paramContext, String paramString, Intent paramIntent, Bundle paramBundle)
  {
    ...
    if ((paramContext instanceof Activity))
    {
      ...
      com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramString.ahp(), "com/tencent/mm/pluginstub/PluginHelper", "startAppActivity", "(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/os/Bundle;)V", "Undefined", "startActivity", "(Landroid/content/Intent;Landroid/os/Bundle;)V");
  ...
  public static void ffG()
  {
    ...
    com.tencent.mm.service.c.b("mm", true, aNS("mm"));
  ...
  private static void k(Intent paramIntent, String paramString)
  {
    ...
    com.tencent.mm.service.c.a(paramIntent, paramString, true, aNS(paramString));
  ...
  public static Class<?> lD(String paramString1, String paramString2)
  {
    for (;;)
    {
      try
      {
        ...
        str1 = (String)Fmu.get(paramString1);
        if (str1 != null) {
          ad.d("MicroMsg.PluginHelper", "load plugin with mapping %s -> %s", new Object[] { paramString1, str1 });
        }
        if (aNW(paramString1)) {
          continue;
        }
        ad.f("MicroMsg.PluginHelper", "plugin load failed, plugin=%s", new Object[] { paramString1 });
      ...
      finally
      {
        try
        {
          String str1;
          String str2;
          paramString2 = aj.getContext().getClassLoader().loadClass(str1);
      ...
      return paramString1;
      str2 = aj.fkB() + ".plugin." + paramString1;
      str1 = paramString2;
      if (paramString2.startsWith(".")) {
  ...
  private static void m(Intent paramIntent, String paramString)
  {
    ...
    com.tencent.mm.service.c.b(paramIntent, paramString, true, aNS(paramString));
  ...
  private static String x(Uri paramUri)
  {
    ...
    if ((!bt.nullAsNil(paramUri.getQueryParameter("not_in_game_luggage")).equals("1")) && (((com.tencent.mm.plugin.expt.b.b)g.ab(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.qpL, true))) {
      if ((t.baV(paramUri.getHost())) && (!ToolsProcessIPCService.ahO())) {
 ...
 * Qualified Name:     com.tencent.mm.bs.d
