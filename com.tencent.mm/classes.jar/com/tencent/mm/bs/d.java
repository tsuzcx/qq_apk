...
public final class d
{
  ...
  private static HashMap<String, com.tencent.mm.pluginsdk.b.d> CoW;
  private static final HashSet<String> CoX;
  ...
  public static com.tencent.mm.pluginsdk.b.a P(Context paramContext, String paramString1, String paramString2)
  {
    AppMethodBeat.i(133743);
    Object localObject = aDa(paramString1);
    if (localObject == null)
    {
  ...
  public static com.tencent.mm.pluginsdk.b.d a(String paramString, a parama, b paramb)
  {
    for (;;)
    {
      try
      {
        ...
        localObject = (String)CoV.get(paramString);
        if (localObject != null) {
          ad.d("MicroMsg.PluginHelper", "load plugin with mapping %s -> %s", new Object[] { paramString, localObject });
        }
        localObject = (com.tencent.mm.pluginsdk.b.d)CoW.get(paramString);
        if (localObject == null) {
          continue;
        }
        parama.onDone();
      ...
      try
      {
        com.tencent.mm.pluginsdk.b.d locald = aDb(paramString);
        if (locald != null) {
          parama.onDone();
        }
        AppMethodBeat.o(133746);
  ...
  public static void a(final Context paramContext, final String paramString1, final String paramString2, Intent paramIntent)
  {
    ...
    a(paramString1, new a()new b
    {
      public final void onDone()
      {
        ...
        if (this.val$intent == null)
        {
          ...
          str = aj.eFC() + ".plugin." + paramString1;
    ...
    }, new b()
    {
      public final void j(Exception paramAnonymousException)
      {
        ...
        ad.e("MicroMsg.PluginHelper", "start wizard activity failed, plugin(%s) not loaded", new Object[] { this.CoT });
      ...
      try
      {
        ...
        }, new b()
        {
          public final void j(Exception paramAnonymousException)
          {
            ...
            ad.f("MicroMsg.PluginHelper", "start activity failed, plugin(%s) not loaded", new Object[] { this.CoT });
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, Intent paramIntent, Bundle paramBundle)
  {
    ...
    try
    {
      if ((paramContext.getSharedPreferences(aj.eFD(), 0).getBoolean("settings_multi_webview", false)) && (".ui.tools.WebViewUI".endsWith(paramString2)))
      {
  ...
  public static void a(ServiceConnection paramServiceConnection, String paramString)
  {
    ...
    com.tencent.mm.service.c.a(paramServiceConnection, paramString, true, aCY(paramString));
  ...
  public static void a(String paramString, l paraml, k paramk)
  {
    ...
    Object localObject = aDa(paramString);
    if (localObject == null)
    {
    ...
    ad.d("MicroMsg.PluginHelper", "<-- registerApplication successfully: %s %s %s", new Object[] { paramString, paraml, paramk });
    AppMethodBeat.o(133741);
  }
  ...
  public static boolean a(Intent paramIntent, ServiceConnection paramServiceConnection, String paramString)
  {
    ...
    boolean bool = com.tencent.mm.service.c.a(paramIntent, paramServiceConnection, 1, paramString, true, aCY(paramString));
    AppMethodBeat.o(133737);
    return bool;
  }
  
  private static Intent aCY(String paramString)
  {
  ...
  public static aw aCZ(String paramString)
  {
  ...
  /* Error */
  private static com.tencent.mm.pluginsdk.b.d aDa(String paramString)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   9: aload_0
    //   10: invokestatic 150	com/tencent/mm/bs/d:aDb	(Ljava/lang/String;)Lcom/tencent/mm/pluginsdk/b/d;
    //   13: astore_1
    //   14: aload_1
    //   15: astore_0
    //   16: ldc_w 529
  ...
  private static com.tencent.mm.pluginsdk.b.d aDb(String paramString)
  {
    AppMethodBeat.i(133747);
    com.tencent.mm.pluginsdk.b.d locald = (com.tencent.mm.pluginsdk.b.d)CoW.get(paramString);
    if (locald != null)
    {
      AppMethodBeat.o(133747);
      return locald;
    }
    locald = (com.tencent.mm.pluginsdk.b.d)aj.getContext().getClassLoader().loadClass(aj.eFC() + ".plugin." + paramString + ".Plugin").newInstance();
    CoW.put(paramString, locald);
    AppMethodBeat.o(133747);
    return locald;
  }
  ...
  public static boolean aDc(String paramString)
  {
    ...
    //   6: invokestatic 52	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   9: aload_0
    //   10: invokestatic 96	com/tencent/mm/bs/d:aDa	(Ljava/lang/String;)Lcom/tencent/mm/pluginsdk/b/d;
    //   13: ifnull +16 -> 29
    //   16: iconst_1
    //   17: istore_1
    //   18: ldc_w 555
  ...
  public static boolean adM()
  {
    ...
    boolean bool = ToolsProcessIPCService.adM();
  ...
  public static boolean axB(String paramString)
  {
    ...
    //   3: ldc_w 579
    //   6: invokestatic 52	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   9: getstatic 73	com/tencent/mm/bs/d:CoW	Ljava/util/HashMap;
    //   12: aload_0
          ...
          for (;;)
          {
            a(paramString1, new a()new b
            {
              public final void onDone()
              {
                ...
                ad.d("MicroMsg.PluginHelper", "[DEBUG] onDone Load %s:%s", new Object[] { this.CoT, paramString2 });
                try
                {
                  if (paramIntent == null)
                  {
                    localObject1 = new Intent();
                    localObject2 = aj.eFC() + ".plugin." + this.CoT;
                    if (!paramString2.startsWith(".")) {
                      break label236;
                    }
                  }
                  ...
                  for (Object localObject2 = (String)localObject2 + paramString2;; localObject2 = paramString2)
                  {
                    ...
                    localObject1 = new com.tencent.mm.hellhoundlib.b.a().bd(localBundle).bd(localObject1);
                    com.tencent.mm.hellhoundlib.a.a.a(localObject2, ((com.tencent.mm.hellhoundlib.b.a)localObject1).adn(), "com/tencent/mm/pluginstub/PluginHelper$5", "onDone", "()V", "Undefined", "startActivity", "(Landroid/content/Intent;Landroid/os/Bundle;)V");
                    ((Context)localObject2).startActivity((Intent)((com.tencent.mm.hellhoundlib.b.a)localObject1).lS(0), (Bundle)((com.tencent.mm.hellhoundlib.b.a)localObject1).lS(1));
                  ...
                  Object localObject1 = new com.tencent.mm.hellhoundlib.b.a().bd(localBundle).bd(localObject1);
                  com.tencent.mm.hellhoundlib.a.a.a(localObject2, ((com.tencent.mm.hellhoundlib.b.a)localObject1).adn(), "com/tencent/mm/pluginstub/PluginHelper$5", "onDone", "()V", "Undefined", "startActivity", "(Landroid/content/Intent;Landroid/os/Bundle;)V");
                  ((Context)localObject2).startActivity((Intent)((com.tencent.mm.hellhoundlib.b.a)localObject1).lS(0), (Bundle)((com.tencent.mm.hellhoundlib.b.a)localObject1).lS(1));
                  com.tencent.mm.hellhoundlib.a.a.a(localObject2, "com/tencent/mm/pluginstub/PluginHelper$5", "onDone", "()V", "Undefined", "startActivity", "(Landroid/content/Intent;Landroid/os/Bundle;)V");
                  AppMethodBeat.o(133704);
            ...
            i = 0;
            break;
            if ((((Uri)localObject).getHost() != null) && (((Uri)localObject).getHost().equals("mp.weixin.qq.com")) && (!ToolsProcessIPCService.adM()))
            {
              paramString2 = ".ui.tools.WebviewMpUI";
            }
            else if ((s.aOZ(((Uri)localObject).getHost())) && (!ToolsProcessIPCService.adM()))
            {
              paramString2 = ".ui.tools.WebviewMpUI";
            }
            else
            {
              boolean bool2 = ai.Eq();
              if (!"false".equalsIgnoreCase(com.tencent.xweb.b.lW("dark_to_toolsmp", "tools"))) {}
              for (bool1 = true;; bool1 = false)
              {
                ...
                if (ai.Eq())
                {
                  ...
                  {
                    str = paramString2;
                    if (!s.aPa(((Uri)localObject).getHost())) {
  ...
  public static void c(Context paramContext, String paramString, Intent paramIntent, Bundle paramBundle)
  {
    ...
    if ((paramContext instanceof Activity))
    {
      ...
      com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramString.adn(), "com/tencent/mm/pluginstub/PluginHelper", "startAppActivity", "(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/os/Bundle;)V", "Undefined", "startActivity", "(Landroid/content/Intent;Landroid/os/Bundle;)V");
  ...
  public static void eBi()
  {
    ...
    com.tencent.mm.service.c.b("mm", true, aCY("mm"));
  ...
  private static void k(Intent paramIntent, String paramString)
  {
    ...
    com.tencent.mm.service.c.a(paramIntent, paramString, true, aCY(paramString));
    AppMethodBeat.o(133731);
  }
  
  public static Class<?> kH(String paramString1, String paramString2)
  {
    for (;;)
    {
      try
      {
        ...
        str1 = (String)CoV.get(paramString1);
        if (str1 != null) {
      ...
      return paramString1;
      str2 = aj.eFC() + ".plugin." + paramString1;
      str1 = paramString2;
      if (paramString2.startsWith(".")) {
  ...
  private static void m(Intent paramIntent, String paramString)
  {
    ...
    com.tencent.mm.service.c.b(paramIntent, paramString, true, aCY(paramString));
  ...
  private static String x(Uri paramUri)
  {
    ...
    if ((!bt.nullAsNil(paramUri.getQueryParameter("not_in_game_luggage")).equals("1")) && (((com.tencent.mm.plugin.expt.a.b)g.ab(com.tencent.mm.plugin.expt.a.b.class)).a(b.a.piL, true))) {
      if ((s.aOZ(paramUri.getHost())) && (!ToolsProcessIPCService.adM())) {
