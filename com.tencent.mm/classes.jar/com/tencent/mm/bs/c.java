...
{
  private static String bfY(String paramString)
  {
  ...
  public static String gsZ()
  {
    ...
    //   13: dup
    //   14: ldc 127
    //   16: invokestatic 133	com/tencent/mm/vfs/s:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   19: ldc 135
    ...
    //   63: aload_2
    //   64: aload_3
    //   65: invokestatic 148	com/tencent/mm/bs/c:bfY	(Ljava/lang/String;)Ljava/lang/String;
  ...
  public static String gtc()
  {
    ...
    try
    {
      StatFs localStatFs = new StatFs(b.aKJ());
      str1 = str2;
      long l = localStatFs.getBlockSize();
      str1 = str2;
      str2 = "" + "AvailableSizes:" + localStatFs.getAvailableBlocks() * l + ";";
  ...
  public static String gtd()
  {
    ...
    bg.aVF();
    String str = (String)com.tencent.mm.model.c.azQ().get(71, null);
