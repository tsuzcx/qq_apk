...
public final class ak
{
  ...
  private static long pqb;
  
  static
  {
    AppMethodBeat.i(132942);
    pqa = b.bmt() + "/tencent/noop.dat";
    lastUpdateTime = 0L;
    ...
    {
      pqb = 270L;
      new StringBuilder("getNoopIntervalInMs use hard code noop:").append(pqb);
      l = pqb * 1000L;
    }
    for (;;)
    {
      ...
      {
        pqb = 270L;
        new StringBuilder("getNoopIntervalInMs use wx noop:").append(pqb);
        l = pqb * 1000L;
      }
    }
    ...
    label262:
    for (pqb = localObject[0];; pqb = 270L)
    {
      lastUpdateTime = l;
      new StringBuilder("getNoopIntervalInMs use sync noop:").append(pqb);
      l = pqb * 1000L;
      break;
    }
  }
  ...
  public static void aa(long paramLong1, long paramLong2)
  {
    ...
    //   36: lcmp
    //   37: ifgt +37 -> 74
    //   40: invokestatic 48	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   43: ldc 50
    //   45: iconst_0
    ...
    //   86: lcmp
    //   87: ifgt +45 -> 132
    //   90: invokestatic 48	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   93: ldc 50
    //   95: iconst_0
    ...
    //   160: return
    //   161: invokestatic 48	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   164: ldc 50
    //   166: iconst_0
    ...
    //   228: return
    //   229: new 139	com/tencent/mm/vfs/u
    //   232: dup
    //   233: getstatic 40	com/tencent/mm/network/ak:pqa	Ljava/lang/String;
    //   236: invokespecial 140	com/tencent/mm/vfs/u:<init>	(Ljava/lang/String;)V
    //   239: astore 8
    //   241: aload 8
    //   243: invokevirtual 143	com/tencent/mm/vfs/u:jKS	()Z
    //   246: ifeq +36 -> 282
    //   249: invokestatic 103	com/tencent/mm/network/ak:bRC	()[J
    //   252: astore 8
    //   254: aload 8
    //   256: iconst_1
    //   257: laload
    ...
    //   281: return
    //   282: aload 8
    //   284: invokevirtual 146	com/tencent/mm/vfs/u:jKZ	()Z
    //   287: istore 7
    //   289: iload 7
    //   291: ifne +9 -> 300
    //   294: ldc 111
    ...
    //   306: aload 9
    //   308: astore 8
    //   310: new 139	com/tencent/mm/vfs/u
    //   313: dup
    //   314: getstatic 40	com/tencent/mm/network/ak:pqa	Ljava/lang/String;
    //   317: invokespecial 140	com/tencent/mm/vfs/u:<init>	(Ljava/lang/String;)V
    //   320: astore 11
    //   322: aload 9
    //   324: astore 8
    //   326: aload 11
    //   328: invokevirtual 143	com/tencent/mm/vfs/u:jKS	()Z
    //   331: ifne +51 -> 382
    //   334: aload 9
    //   336: astore 8
    //   338: aload 11
    //   340: invokevirtual 146	com/tencent/mm/vfs/u:jKZ	()Z
    //   343: istore 7
    //   345: iload 7
    //   347: ifne +35 -> 382
    //   350: ldc 111
    ...
    //   389: dup
    //   390: aload 11
    //   392: invokestatic 163	com/tencent/mm/vfs/y:ap	(Lcom/tencent/mm/vfs/u;)Ljava/io/OutputStream;
    ...
    //   320	71	11	localu	com.tencent.mm.vfs.u
    // Exception table:
    //   from	to	target	type
  ...
  private static long[] bRC()
  {
    ...
    //   19: lastore
    //   20: pop
    //   21: new 139	com/tencent/mm/vfs/u
    //   24: dup
    //   25: getstatic 40	com/tencent/mm/network/ak:pqa	Ljava/lang/String;
    //   28: invokespecial 140	com/tencent/mm/vfs/u:<init>	(Ljava/lang/String;)V
    //   31: astore_3
    //   32: aload_3
    //   33: invokevirtual 143	com/tencent/mm/vfs/u:jKS	()Z
    //   36: ifne +11 -> 47
    //   39: ldc 178
    ...
    //   50: dup
    //   51: aload_3
    //   52: invokestatic 184	com/tencent/mm/vfs/y:ao	(Lcom/tencent/mm/vfs/u;)Ljava/io/InputStream;
