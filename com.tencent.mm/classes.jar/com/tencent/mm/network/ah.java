...
{
  public static final String iJu;
  private static long iJv;
  private static long lastUpdateTime;
  
  static
  {
    AppMethodBeat.i(132942);
    iJu = b.asd() + "/tencent/noop.dat";
    lastUpdateTime = 0L;
    Object localObject = ak.getContext().getSharedPreferences("noop_prefs", 0);
    int i = ((SharedPreferences)localObject).getInt("noop_strategy", 1);
    if (1 == i)
    {
      iJv = 270L;
      new StringBuilder("getNoopIntervalInMs use hard code noop:").append(iJv);
      l = iJv * 1000L;
    }
    for (;;)
    {
      ...
      {
        iJv = 270L;
        new StringBuilder("getNoopIntervalInMs use wx noop:").append(iJv);
        l = iJv * 1000L;
      }
    }
    ...
    label262:
    for (iJv = localObject[0];; iJv = 270L)
    {
      lastUpdateTime = l;
      new StringBuilder("getNoopIntervalInMs use sync noop:").append(iJv);
      l = iJv * 1000L;
      break;
    }
  }
  ...
  private static long[] aPP()
  {
    ...
    //   19: lastore
    //   20: pop
    //   21: new 111	com/tencent/mm/vfs/k
    //   24: dup
    //   25: getstatic 40	com/tencent/mm/network/ah:iJu	Ljava/lang/String;
    //   28: invokespecial 112	com/tencent/mm/vfs/k:<init>	(Ljava/lang/String;)V
    //   31: astore_3
    //   32: aload_3
    //   33: invokevirtual 116	com/tencent/mm/vfs/k:exists	()Z
    //   36: ifne +11 -> 47
    //   39: ldc 109
    ...
    //   50: dup
    //   51: aload_3
    //   52: invokestatic 124	com/tencent/mm/vfs/o:ai	(Lcom/tencent/mm/vfs/k;)Ljava/io/InputStream;
    //   55: invokespecial 127	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   58: astore 4
    //   60: aload 4
    //   62: astore_3
    //   63: aload 4
    //   65: invokevirtual 131	java/io/DataInputStream:readInt	()I
    //   68: istore_0
    //   69: iload_0
    //   70: i2l
    //   71: ldc2_w 88
    ...
    //   89: astore_3
    //   90: aload 4
    //   92: invokevirtual 134	java/io/DataInputStream:close	()V
    //   95: aload 4
    //   97: invokevirtual 134	java/io/DataInputStream:close	()V
    //   100: ldc 109
    ...
    //   118: astore_3
    //   119: aload 4
    //   121: invokevirtual 131	java/io/DataInputStream:readInt	()I
    //   124: istore_0
    //   125: aload 4
    //   127: astore_3
    //   128: iload_0
    ...
    //   143: astore_3
    //   144: aload 4
    //   146: invokevirtual 134	java/io/DataInputStream:close	()V
    //   149: aload 4
    //   151: invokevirtual 134	java/io/DataInputStream:close	()V
    //   154: ldc 109
    ...
    //   172: astore_3
    //   173: aload 4
    //   175: invokevirtual 134	java/io/DataInputStream:close	()V
    //   178: aload 4
    //   180: invokevirtual 134	java/io/DataInputStream:close	()V
    //   183: ldc 109
    ...
    //   208: aload 5
    //   210: invokevirtual 140	java/lang/Exception:getStackTrace	()[Ljava/lang/StackTraceElement;
    //   213: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   216: pop
    //   217: aload 4
    //   219: ifnull +8 -> 227
    //   222: aload 4
    //   224: invokevirtual 134	java/io/DataInputStream:close	()V
    //   227: ldc 109
    ...
    //   240: ifnull +7 -> 247
    //   243: aload_3
    //   244: invokevirtual 134	java/io/DataInputStream:close	()V
    //   247: ldc 109
  ...
  public static void z(long paramLong1, long paramLong2)
  {
    ...
    //   36: lcmp
    //   37: ifgt +37 -> 74
    //   40: invokestatic 48	com/tencent/mm/sdk/platformtools/ak:getContext	()Landroid/content/Context;
    //   43: ldc 50
    //   45: iconst_0
    ...
    //   86: lcmp
    //   87: ifgt +45 -> 132
    //   90: invokestatic 48	com/tencent/mm/sdk/platformtools/ak:getContext	()Landroid/content/Context;
    //   93: ldc 50
    //   95: iconst_0
    ...
    //   104: ldc 58
    //   106: iconst_3
    //   107: invokeinterface 160 3 0
    //   112: ldc 83
    //   114: lload_0
    //   115: invokeinterface 167 4 0
    //   120: invokeinterface 163 1 0
    //   125: pop
    //   126: ldc 146
    ...
    //   160: return
    //   161: invokestatic 48	com/tencent/mm/sdk/platformtools/ak:getContext	()Landroid/content/Context;
    //   164: ldc 50
    //   166: iconst_0
    ...
    //   228: return
    //   229: new 111	com/tencent/mm/vfs/k
    //   232: dup
    //   233: getstatic 40	com/tencent/mm/network/ah:iJu	Ljava/lang/String;
    //   236: invokespecial 112	com/tencent/mm/vfs/k:<init>	(Ljava/lang/String;)V
    //   239: astore 8
    //   241: aload 8
    //   243: invokevirtual 116	com/tencent/mm/vfs/k:exists	()Z
    //   246: ifeq +36 -> 282
    //   249: invokestatic 103	com/tencent/mm/network/ah:aPP	()[J
    //   252: astore 8
    //   254: aload 8
    //   256: iconst_1
    //   257: laload
    ...
    //   281: return
    //   282: aload 8
    //   284: invokevirtual 174	com/tencent/mm/vfs/k:createNewFile	()Z
    //   287: istore 7
    //   289: iload 7
    //   291: ifne +9 -> 300
    //   294: ldc 146
    ...
    //   306: aload 9
    //   308: astore 8
    //   310: new 111	com/tencent/mm/vfs/k
    //   313: dup
    //   314: getstatic 40	com/tencent/mm/network/ah:iJu	Ljava/lang/String;
    //   317: invokespecial 112	com/tencent/mm/vfs/k:<init>	(Ljava/lang/String;)V
    //   320: astore 11
    //   322: aload 9
    //   324: astore 8
    //   326: aload 11
    //   328: invokevirtual 116	com/tencent/mm/vfs/k:exists	()Z
    //   331: ifne +51 -> 382
    //   334: aload 9
    //   336: astore 8
    //   338: aload 11
    //   340: invokevirtual 174	com/tencent/mm/vfs/k:createNewFile	()Z
    //   343: istore 7
    //   345: iload 7
    //   347: ifne +35 -> 382
    //   350: ldc 146
    ...
    //   367: aload 8
    //   369: invokevirtual 140	java/lang/Exception:getStackTrace	()[Ljava/lang/StackTraceElement;
    //   372: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   375: pop
    //   376: ldc 146
    ...
    //   389: dup
    //   390: aload 11
    //   392: invokestatic 182	com/tencent/mm/vfs/o:aj	(Lcom/tencent/mm/vfs/k;)Ljava/io/OutputStream;
    ...
    //   404: aload 9
    //   406: iload 4
    //   408: invokevirtual 188	java/io/DataOutputStream:writeInt	(I)V
    //   411: aload 9
    //   413: lload_2
    //   414: l2i
    //   415: invokevirtual 188	java/io/DataOutputStream:writeInt	(I)V
    //   418: aload 9
    //   420: invokevirtual 191	java/io/DataOutputStream:flush	()V
    //   423: aload 9
    //   425: invokevirtual 192	java/io/DataOutputStream:close	()V
    //   428: aload 9
    //   430: invokevirtual 192	java/io/DataOutputStream:close	()V
    //   433: ldc 146
    ...
    //   470: aload 10
    //   472: invokevirtual 140	java/lang/Exception:getStackTrace	()[Ljava/lang/StackTraceElement;
    //   475: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   478: pop
    //   479: aload 9
    //   481: ifnull +8 -> 489
    //   484: aload 9
    //   486: invokevirtual 192	java/io/DataOutputStream:close	()V
    //   489: ldc 146
    ...
    //   515: ifnull +8 -> 523
    //   518: aload 9
    //   520: invokevirtual 192	java/io/DataOutputStream:close	()V
    //   523: ldc 146
    ...
    //   320	71	11	localk	com.tencent.mm.vfs.k
    // Exception table:
    //   from	to	target	type
