  ...
  implements bd
{
  ...
  public v()
  {
    ...
    this.jhB = new u();
    this.jhC = null;
    this.jhD = new IListener() {};
    AppMethodBeat.o(150861);
  }
  
  /* Error */
  private boolean Pq(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   8: new 106	com/tencent/mm/vfs/o
    //   11: dup
    //   12: aload_1
    //   13: invokespecial 109	com/tencent/mm/vfs/o:<init>	(Ljava/lang/String;)V
    //   16: astore 8
    //   18: aload 8
    //   20: invokevirtual 113	com/tencent/mm/vfs/o:exists	()Z
    //   23: ifne +24 -> 47
    //   26: ldc 115
    //   28: ldc 117
    //   30: aload_1
    ...
    //   54: astore 7
    //   56: aload 8
    //   58: invokestatic 136	com/tencent/mm/vfs/s:ao	(Lcom/tencent/mm/vfs/o;)Ljava/io/InputStream;
    //   61: astore_1
    ...
    //   268: invokestatic 213	com/tencent/mm/storage/RegionCodeDecoder:gEm	()Lcom/tencent/mm/storage/RegionCodeDecoder;
    //   271: pop
    //   272: aload 11
    //   274: iconst_0
    //   275: aaload
    //   276: invokestatic 216	com/tencent/mm/storage/RegionCodeDecoder:bkN	(Ljava/lang/String;)Ljava/lang/String;
    //   279: astore 5
    //   281: aload 5
    //   283: astore 4
    //   285: aload 5
    ...
    //   290: ifne -205 -> 85
    //   293: new 106	com/tencent/mm/vfs/o
    //   296: dup
    //   297: aload 5
    //   299: invokespecial 109	com/tencent/mm/vfs/o:<init>	(Ljava/lang/String;)V
    //   302: astore 4
    //   304: aload 4
    //   306: invokevirtual 113	com/tencent/mm/vfs/o:exists	()Z
    //   309: ifne +9 -> 318
    //   312: aload 4
    //   314: invokevirtual 219	com/tencent/mm/vfs/o:createNewFile	()Z
    //   317: pop
    //   318: new 202	java/io/BufferedWriter
    //   321: dup
    //   322: new 221	com/tencent/mm/vfs/v
    //   325: dup
    //   326: aload 4
    //   328: invokespecial 224	com/tencent/mm/vfs/v:<init>	(Lcom/tencent/mm/vfs/o;)V
    ...
    //   547: ifne +72 -> 619
    //   550: new 106	com/tencent/mm/vfs/o
    //   553: dup
    //   554: aload 4
    //   556: invokespecial 109	com/tencent/mm/vfs/o:<init>	(Ljava/lang/String;)V
    //   559: invokevirtual 251	com/tencent/mm/vfs/o:heq	()Lcom/tencent/mm/vfs/o;
    //   562: new 14	com/tencent/mm/bb/v$4
    //   565: dup
    //   566: aload_0
    //   567: invokespecial 252	com/tencent/mm/bb/v$4:<init>	(Lcom/tencent/mm/bb/v;)V
    //   570: invokevirtual 256	com/tencent/mm/vfs/o:a	(Lcom/tencent/mm/vfs/q;)[Lcom/tencent/mm/vfs/o;
    //   573: astore 4
    //   575: aload 4
    //   577: arraylength
    //   578: istore_3
    ...
    //   589: aaload
    //   590: astore 5
    //   592: invokestatic 213	com/tencent/mm/storage/RegionCodeDecoder:gEm	()Lcom/tencent/mm/storage/RegionCodeDecoder;
    //   595: pop
    //   596: aload 5
    //   598: aload 5
    //   600: invokevirtual 251	com/tencent/mm/vfs/o:heq	()Lcom/tencent/mm/vfs/o;
    //   603: invokestatic 259	com/tencent/mm/storage/RegionCodeDecoder:e	(Lcom/tencent/mm/vfs/o;Lcom/tencent/mm/vfs/o;)V
    //   606: iload_2
    //   607: iconst_1
    //   608: iadd
    //   609: istore_2
    //   610: goto -29 -> 581
    //   613: invokestatic 213	com/tencent/mm/storage/RegionCodeDecoder:gEm	()Lcom/tencent/mm/storage/RegionCodeDecoder;
    //   616: invokevirtual 262	com/tencent/mm/storage/RegionCodeDecoder:gBs	()V
    //   619: aload 10
    //   621: invokevirtual 263	java/io/BufferedReader:close	()V
    //   624: aload 9
    //   626: invokevirtual 264	java/io/InputStreamReader:close	()V
    //   629: aload 8
    //   631: invokevirtual 267	com/tencent/mm/vfs/o:delete	()Z
    //   634: pop
    //   635: aload_1
    //   636: ifnull +7 -> 643
    //   639: aload_1
 ...
 * Qualified Name:     com.tencent.mm.bb.v
