  ...
  extends k
{
  ...
  public static String T(String paramString, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramString = a.awS() + paramString + "_chatting_bg_vertical.jpg";
      AppMethodBeat.o(150850);
      return paramString;
    }
    paramString = a.awS() + paramString + "_chatting_bg_horizontal.jpg";
    AppMethodBeat.o(150850);
    return paramString;
  }
  ...
  public final boolean a(o paramo)
  {
    ...
    if ((int)this.hpA.a("packageinfo2", "localId", paramo) != -1)
    {
      doNotify();
      AppMethodBeat.o(150837);
      return true;
  ...
  public final boolean b(o paramo)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.hpA.update("packageinfo2", localContentValues, "id= ? and type =?", new String[] { paramo.id, paramo.dib }) <= 0) {
        break;
      }
      doNotify();
  ...
  public final o dg(int paramInt1, int paramInt2)
  {
    ...
    Object localObject = "select packageinfo2.localId,packageinfo2.id,packageinfo2.version,packageinfo2.name,packageinfo2.size,packageinfo2.packname,packageinfo2.status,packageinfo2.type,packageinfo2.reserved1,packageinfo2.reserved2,packageinfo2.reserved3,packageinfo2.reserved4 from packageinfo2   where packageinfo2.id = \"" + bs.aLh(String.valueOf(paramInt1)) + "\" and packageinfo2.type = \"" + bs.aLh(String.valueOf(paramInt2)) + "\"";
  ...
  public final String dj(int paramInt1, int paramInt2)
  {
    ...
    case 0: 
      ...
      return "";
    case 1: 
      str = a.awS() + paramInt1 + "_session_bg/";
      try
      {
        e locale = new e(str);
        if (!locale.exists()) {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ac.e("MicroMsg.PackageInfoStorage", "exception:%s", new Object[] { bs.m(localException) });
          ac.e("MicroMsg.PackageInfoStorage", "can not create dir, dir = ".concat(String.valueOf(str)));
        }
      }
    case 2: 
      AppMethodBeat.o(150847);
  ...
  public final void dk(int paramInt1, int paramInt2)
  {
    ...
    i.deleteFile(a.awS() + di(paramInt1, paramInt2));
  ...
  public final boolean pm(int paramInt)
  {
    ...
    boolean bool = this.hpA.execSQL("packageinfo2", str);
    doNotify();
  ...
  public final boolean pn(int paramInt)
  {
    ...
    if (this.hpA.delete("packageinfo2", "type =?", new String[] { String.valueOf(paramInt) }) > 0)
    {
      doNotify();
  ...
  public final o[] po(int paramInt)
  {
