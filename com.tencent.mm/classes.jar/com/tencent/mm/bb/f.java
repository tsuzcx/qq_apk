  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.e(1, 8, this.hPJ);
      paramVarArgs.e(2, this.bDF);
    ...
    if (paramInt == 1)
    {
      paramInt = f.a.a.a.c(1, 8, this.hPJ);
      i = f.a.a.b.b.a.fK(2);
      AppMethodBeat.o(150798);
    ...
    if (paramInt == 3)
    {
      ...
      case 1: 
        ...
        while (paramInt < i)
        {
          ...
          localf.hPJ.add(localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(150798);
        return 0;
      }
      localf.bDF = Double.longBitsToDouble(((f.a.a.a.a)localObject1).LVo.gab());
      AppMethodBeat.o(150798);
      return 0;
    }
    AppMethodBeat.o(150798);
