...
public class MatrixSettingHeaderPreference
  extends Preference
{
  MatrixSettingHeaderPreference.a KXV;
  ...
  public final void onBindView(View paramView)
  {
    ...
    localTextView.setText(j.MATRIX_VERSION);
    paramView.setOnLongClickListener(new View.OnLongClickListener()
    {
      ...
      public final boolean onLongClick(View paramAnonymousView)
      {
        ...
        a.b("com/tencent/mm/ui/matrix/MatrixSettingHeaderPreference$1", "android/view/View$OnLongClickListener", "onLongClick", "(Landroid/view/View;)Z", this, localb.ahF());
        ...
        this.clickCount -= 1;
        if (this.tOw == null) {
          this.tOw = Toast.makeText(MatrixSettingHeaderPreference.this.mContext, MatrixSettingHeaderPreference.this.mContext.getResources().getString(2131761190, new Object[] { Integer.valueOf(this.clickCount) }), 1);
        }
        if (this.clickCount <= 0) {
          this.tOw.setText(MatrixSettingHeaderPreference.this.mContext.getResources().getString(2131761189));
        }
        for (;;)
        {
          ...
          if ((this.clickCount == 0) && (MatrixSettingHeaderPreference.a(MatrixSettingHeaderPreference.this) != null)) {
            MatrixSettingHeaderPreference.a(MatrixSettingHeaderPreference.this).fOd();
          }
          a.a(true, this, "com/tencent/mm/ui/matrix/MatrixSettingHeaderPreference$1", "android/view/View$OnLongClickListener", "onLongClick", "(Landroid/view/View;)Z");
          AppMethodBeat.o(38881);
          return true;
          this.tOw.setText(MatrixSettingHeaderPreference.this.mContext.getResources().getString(2131761190, new Object[] { Integer.valueOf(this.clickCount) }));
        }
      }
    });
