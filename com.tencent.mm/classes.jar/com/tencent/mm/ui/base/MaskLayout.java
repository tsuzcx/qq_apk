  ...
  extends RelativeLayout
{
  ...
  public MaskLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.JoX = paramContext.getDrawable(5);
  ...
  private void a(a parama)
  {
    ...
    for (;;)
    {
      addView(this.rDx, localLayoutParams1);
  ...
  public final void a(Bitmap paramBitmap, a parama)
  {
    ...
    a(parama);
    this.rDx.setImageBitmap(paramBitmap);
  ...
  public void onFinishInflate()
  {
    ...
    this.rDx = new ImageView(getContext());
    this.rDx.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
    this.rDx.setImageDrawable(this.JoX);
    addView(this.rDx);
  ...
  public void setMaskDrawable(Drawable paramDrawable)
  {
    ...
    a(a.Jpd);
    this.rDx.setImageDrawable(paramDrawable);
  ...
  public static enum a
  {
    static
    {
      ...
      JoZ = new a("SUBSCRIPT_DRAWABLE_DIRECTION_TOP_RIGHT", 0);
      Jpa = new a("SUBSCRIPT_DRAWABLE_DIRECTION_TOP_LEFT", 1);
      Jpb = new a("SUBSCRIPT_DRAWABLE_DIRECTION_BOTTOM_RIGHT", 2);
      Jpc = new a("SUBSCRIPT_DRAWABLE_DIRECTION_BOTTOM_LEFT", 3);
      Jpd = new a("SUBSCRIPT_DRAWABLE_DIRECTION_ALL", 4);
      Jpe = new a[] { JoZ, Jpa, Jpb, Jpc, Jpd };
