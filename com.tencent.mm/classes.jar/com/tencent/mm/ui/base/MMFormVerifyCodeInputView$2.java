  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bd(paramView);
    a.b("com/tencent/mm/ui/base/MMFormVerifyCodeInputView$2", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
    if (MMFormVerifyCodeInputView.e(this.JkE) != null) {
      MMFormVerifyCodeInputView.e(this.JkE).onClick(paramView);
    }
