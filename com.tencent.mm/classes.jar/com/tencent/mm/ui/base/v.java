...
public class v
  extends PopupWindow
{
  private View.OnTouchListener adSu;
  ...
  public v(View paramView, int paramInt1, int paramInt2)
  {
  ...
  public v(View paramView, int paramInt1, int paramInt2, boolean paramBoolean)
  {
  ...
  public void dismiss()
  {
    ...
    {
      bc.e("MicroMsg.MMPopupWindow", "dismiss exception, e = " + localException.getMessage(), new Object[0]);
      AppMethodBeat.o(159251);
    }
  }
  ...
  {
    this.adSu = paramOnTouchListener;
  }
    ...
    extends FrameLayout
  {
    ...
    public final boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
    {
      ...
      if ((v.a(v.this) != null) && (v.a(v.this).onTouch(this, paramMotionEvent)))
      {
