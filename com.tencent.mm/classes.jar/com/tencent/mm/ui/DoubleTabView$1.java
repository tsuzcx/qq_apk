  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bd(paramView);
    a.b("com/tencent/mm/ui/DoubleTabView$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahF());
    int i = ((Integer)paramView.getTag()).intValue();
    if (DoubleTabView.a(this.Jqr) != null) {
      DoubleTabView.a(this.Jqr).onTabClick(i);
    }
