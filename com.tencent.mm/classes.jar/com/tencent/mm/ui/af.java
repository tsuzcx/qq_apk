...
@l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/ui/ScreenSizeUtil;", "", "()V", "get", "Lcom/tencent/mm/ui/ScreenSizeUtil$Size;", "_context", "Landroid/content/Context;", "Size", "wechat-ui-sdk_release"})
public final class af
{
  public static final af Jfr;
  ...
  public static final af.a jP(Context paramContext)
  {
    ...
    {
      paramContext = new af.a(paramContext.x, paramContext.y);
    ...
    paramContext = localContext.getResources();
    p.g(paramContext, "context.resources");
    paramContext = new af.a(i, paramContext.getDisplayMetrics().heightPixels);
    AppMethodBeat.o(175971);
    return paramContext;
  }
}
