  ...
  extends ViewGroup
{
  ...
  private void scrollToItem(int paramInt1, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    for (int i = (int)(Math.max(this.mFirstOffset, Math.min(localb.offset, this.mLastOffset)) * f);; i = 0)
    {
      if (paramBoolean1)
      {
        ...
        if (paramBoolean2)
        {
          notifyOnPageSelected(paramInt1);
  ...
  public void addOnPageChangeListener(ViewPager.OnPageChangeListener paramOnPageChangeListener)
  {
    ...
    if (!this.listeners.contains(paramOnPageChangeListener)) {
      this.listeners.add(paramOnPageChangeListener);
    }
  ...
  void initViewPager()
  {
    ...
    this.mTouchSlop = aa.a(localViewConfiguration);
    this.mMinimumVelocity = ((int)(400.0F * f));
    this.mMaximumVelocity = localViewConfiguration.getScaledMaximumFlingVelocity();
    this.mLeftEdge = new androidx.core.widget.d(localContext);
    this.mRightEdge = new androidx.core.widget.d(localContext);
    ...
    if ((this.mPageMargin > 0) && (this.mMarginDrawable != null) && (this.mItems.size() > 0) && (this.mAdapter != null))
    {
      ...
      if (i < i1)
      {
        ...
        for (f1 = ((b)localObject).offset + ((b)localObject).widthFactor + f3;; f1 += f4 + f3)
        {
          ...
          {
            this.mMarginDrawable.setBounds((int)f2 - 1, this.mTopPageBounds, (int)(this.mPageMargin + f2 + 0.5F) - 1, this.mBottomPageBounds);
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (i != -1)
      {
        ...
        if ((f1 != 0.0F) && (!isGutterDrag(this.mLastMotionX, f1)) && (!this.mIgnoreGutter) && (canScroll(this, false, (int)f1, (int)f2, (int)f3)))
        {
  ...
  public void removeOnPageChangeListener(ViewPager.OnPageChangeListener paramOnPageChangeListener)
  {
    ...
    this.listeners.remove(paramOnPageChangeListener);
  ...
  public void setUnableDrag(boolean paramBoolean1, boolean paramBoolean2)
  {
    this.mIsUnableToDrag = paramBoolean1;
    this.mIgnoreGutter = paramBoolean2;
  }
    ...
    extends androidx.core.g.a
  {
    ...
    public final void onInitializeAccessibilityEvent(View paramView, AccessibilityEvent paramAccessibilityEvent)
    {
      ...
      {
        paramView.ez(WxViewPager.this.mAdapter.getCount());
        paramView.eA(WxViewPager.this.mCurItem);
        paramView.eB(WxViewPager.this.mCurItem);
      }
    ...
    public final void onInitializeAccessibilityNodeInfo(View paramView, androidx.core.g.a.d paramd)
    {
      ...
      paramd.v(WxViewPager.class.getName());
      paramd.aH(Fj());
