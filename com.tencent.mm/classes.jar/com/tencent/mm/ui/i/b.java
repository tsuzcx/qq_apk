  ...
  extends p
{
  ...
  public static b kz(Context paramContext)
  {
    AppMethodBeat.i(142862);
    paramContext = LayoutInflater.from(paramContext).inflate(2131496723, null);
    ((TextView)paramContext.findViewById(2131309260)).setVisibility(8);
    b localb = new b(paramContext);
    localb.setFocusable(false);
    localb.setContentView(paramContext);
    localb.setWidth(-1);
    localb.setHeight(-1);
    localb.setAnimationStyle(2131821527);
