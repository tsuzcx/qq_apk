  ...
  extends PasterEditText
{
  ...
  public final void aRF(String paramString)
  {
    ...
    getContext();
    int m = b.cO(getText().toString(), getSelectionStart());
    getContext();
    int i = b.cO(getText().toString(), getSelectionEnd());
    ...
    for (;;)
    {
      ...
      if ((k > 0) && (i > k))
      {
        ac.d("MicroMsg.MMEditText", "exceed :%s, %s", new Object[] { Integer.valueOf(k), Integer.valueOf(i) });
  ...
  public InputConnection onCreateInputConnection(EditorInfo paramEditorInfo)
  {
    ...
    this.IZS = super.onCreateInputConnection(paramEditorInfo);
    if ((this.IZS != null) && (this.IZT)) {
      paramEditorInfo.imeOptions &= 0xBFFFFFFF;
    }
    paramEditorInfo = this.IZS;
  ...
  public boolean onKeyPreIme(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    {
      ac.v("MicroMsg.MMEditText", "on onKeyPreIme, listener null ? %B", new Object[] { Boolean.valueOf(bool) });
      if ((this.IZU == null) || (paramInt != 4)) {
        break label191;
      }
      if ((paramKeyEvent.getAction() != 0) || (paramKeyEvent.getRepeatCount() != 0)) {
        break;
      }
      ac.v("MicroMsg.MMEditText", "on onKeyPreIme action down");
    ...
    {
      ac.v("MicroMsg.MMEditText", "on onKeyPreIme action up");
      localDispatcherState = getKeyDispatcherState();
      if (localDispatcherState != null) {
      ...
      {
        ac.v("MicroMsg.MMEditText", "on onKeyPreIme action up is tracking");
        this.IZU.onBack();
  ...
  public boolean onTextContextMenuItem(int paramInt)
  {
    ...
    //   17: aload_0
    //   18: iconst_0
    //   19: putfield 27	com/tencent/mm/ui/widget/MMEditText:oRW	I
    //   22: aload_0
    ...
    //   30: aload_0
    //   31: aload_3
    //   32: invokespecial 250	com/tencent/mm/ui/widget/MMEditText:aGT	(Ljava/lang/String;)V
    //   35: ldc 245
    ...
    //   53: aload_3
    //   54: aastore
    //   55: invokestatic 255	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   58: iconst_0
    //   59: istore_2
    //   60: goto -49 -> 11
    //   63: astore_3
    ...
    //   75: aload_3
    //   76: aastore
    //   77: invokestatic 255	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   80: ldc 245
    ...
    //   99: iconst_0
    //   100: aload_0
    //   101: getfield 27	com/tencent/mm/ui/widget/MMEditText:oRW	I
    //   104: invokestatic 142	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   107: aastore
    //   108: invokestatic 255	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   111: aload_0
    //   112: getfield 27	com/tencent/mm/ui/widget/MMEditText:oRW	I
    //   115: iconst_3
    //   116: if_icmpge +30 -> 146
    //   119: aload_0
    //   120: aload_0
    //   121: getfield 27	com/tencent/mm/ui/widget/MMEditText:oRW	I
    //   124: iconst_1
    //   125: iadd
    //   126: putfield 27	com/tencent/mm/ui/widget/MMEditText:oRW	I
    //   129: aload_0
    //   130: ldc_w 261
    //   133: aload_3
    ...
    //   140: invokespecial 250	com/tencent/mm/ui/widget/MMEditText:aGT	(Ljava/lang/String;)V
    //   143: goto -108 -> 35
    //   146: ldc 245
  ...
  public boolean requestFocus(int paramInt, Rect paramRect)
  {
    ...
    {
      ac.e("MicroMsg.MMEditText", "[requestFocus] error:%s", new Object[] { paramRect });
      AppMethodBeat.o(143356);
    }
    return false;
  }
  ...
  public void setSelection(int paramInt)
  {
    ...
    {
      ac.printErrStackTrace("MicroMsg.MMEditText", localIndexOutOfBoundsException, "IndexOutOfBoundsExceptionindex = ".concat(String.valueOf(paramInt)), new Object[0]);
      AppMethodBeat.o(143357);
    }
  }
