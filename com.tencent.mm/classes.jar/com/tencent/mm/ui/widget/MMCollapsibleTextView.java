  ...
  extends ConstraintLayout
{
  ...
  public MMCollapsibleTextView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.QCe = g.ah((kotlin.g.a.a)new i(this));
    this.maxLines = 2147483647;
    this.Inc = 2131495516;
    this.QCj = g.ah((kotlin.g.a.a)new d(this));
    this.QCk = g.ah((kotlin.g.a.a)new c(this));
    this.QCl = g.ah((kotlin.g.a.a)new a(this));
    this.QCm = g.ah((kotlin.g.a.a)new b(this));
    this.QCn = g.ah((kotlin.g.a.a)new f(this));
    this.QCo = g.ah((kotlin.g.a.a)new e(this));
    this.QCp = g.ah((kotlin.g.a.a)new g(this));
    this.QCq = g.ah((kotlin.g.a.a)new j(this));
    this.QCr = g.ah((kotlin.g.a.a)new k(this));
    this.QCs = true;
    this.QCv = -1;
    this.QCw = -1.0F;
    this.QCx = -1.0F;
  ...
  private final Placeholder getCenterContentPlaceHolder()
  {
    ...
    Placeholder localPlaceholder = (Placeholder)this.QCo.getValue();
  ...
  private final Placeholder getFullContentPlaceHolder()
  {
    ...
    Placeholder localPlaceholder = (Placeholder)this.QCn.getValue();
  ...
  private final Placeholder getLeftBottomCollapsePlaceHolder()
  {
    ...
    Placeholder localPlaceholder = (Placeholder)this.QCp.getValue();
  ...
  private final Resources getResource()
  {
    ...
    Resources localResources = (Resources)this.QCe.getValue();
  ...
  private final Placeholder getRightBottomCollapsePlaceHolder()
  {
    ...
    Placeholder localPlaceholder = (Placeholder)this.QCq.getValue();
  ...
  private final Placeholder getRightCollapsePlaceHolder()
  {
    ...
    Placeholder localPlaceholder = (Placeholder)this.QCr.getValue();
  ...
  private final ImageView get_collapseImage()
  {
    ...
    ImageView localImageView = (ImageView)this.QCm.getValue();
  ...
  private final void init(AttributeSet paramAttributeSet, int paramInt)
  {
      ...
      if (m < i5)
      {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            this.QCg = paramAttributeSet.getBoolean(n, this.QCg);
          }
        }
        label255:
        if (n == 7) {
    ...
    aa.jQ(this.mContext).inflate(this.Inc, (ViewGroup)this);
    if (i2 != -1) {
  ...
  public final TextView get_collapseButton()
  {
    ...
    TextView localTextView = (TextView)this.QCl.getValue();
  ...
  public final TextView get_contentBackupText()
  {
    ...
    TextView localTextView = (TextView)this.QCk.getValue();
  ...
  public final MMNeat7extView get_contentText()
  {
    ...
    MMNeat7extView localMMNeat7extView = (MMNeat7extView)this.QCj.getValue();
  ...
  public final void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if ((this.QCf) || (i != this.QCv))
    {
      ...
      ((MMNeat7extView)localObject1).aw((CharSequence)localObject2);
      localObject1 = get_contentText();
      p.g(localObject1, "_contentText");
      this.pMM = ((MMNeat7extView)localObject1).hiS();
      com.tencent.neattextview.textview.layout.a locala = get_contentText().mq(i, 2147483647);
      if (locala == null) {
        break label731;
      }
      i = locala.hiG();
      ...
      if (this.wXG)
      {
        ...
        if (this.QCh)
        {
          ...
          if (locala != null)
          {
            ...
            label556:
            this.QCw = f1;
            this.QCx = locala.getLineRight(j - 1);
          }
          gYC();
        }
      }
    ...
    for (;;)
    {
      ...
      get_contentText().aw((CharSequence)localObject1);
    }
  }
  ...
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"<anonymous>", "Lcom/tencent/mm/ui/widget/MMNeat7extView;", "kotlin.jvm.PlatformType", "invoke"})
  ...
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"<anonymous>", "Landroid/support/constraint/Placeholder;", "kotlin.jvm.PlatformType", "invoke"})
  ...
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"<anonymous>", "", "run", "com/tencent/mm/ui/widget/MMCollapsibleTextView$measureTruncate$2$1"})
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      this.tCl.setTouchDelegate(new TouchDelegate(localRect, (View)MMCollapsibleTextView.a(jdField_this)));
      AppMethodBeat.o(140952);
    }
  }
  
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"<anonymous>", "Landroid/content/res/Resources;", "kotlin.jvm.PlatformType", "invoke"})
    ...
    implements View.OnClickListener
  {
    ...
    public final void onClick(View paramView)
    {
      ...
      b localb = new b();
      localb.bm(paramView);
      com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/ui/widget/MMCollapsibleTextView$setupCollapseButton$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.axR());
