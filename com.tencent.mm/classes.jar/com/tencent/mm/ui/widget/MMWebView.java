...
public class MMWebView
  extends WebView
{
  public static final WebView.c KSk;
  private static Vector<WeakReference<MMWebView>> KSm;
  private View.OnTouchListener Cjy;
  private r EvK;
  protected boolean KSl;
  private boolean KSn;
  private ViewGroup KSo;
  private View.OnTouchListener KSp;
  public e KSq;
  private LinkedList<e> KSr;
  private boolean KSs;
  private List<i> KSt;
  public boolean gcX;
  private boolean kmY;
  ...
  {
    this(paramContext, paramAttributeSet, 0, WebView.c.Mqt);
  }
  
  public MMWebView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    this(paramContext, paramAttributeSet, paramInt, WebView.c.Mqt);
  }
  ...
  public MMWebView(Context paramContext, AttributeSet paramAttributeSet, int paramInt, WebView.c paramc)
  {
    ...
    {
      ad.e("MicroMsg.MMWebView", "alvinluo MMWebView create not in main thread, stack: %s", new Object[] { bt.flS() });
    ...
    fLy();
    KSm.add(new WeakReference(this));
    AppMethodBeat.o(143424);
  }
  ...
  public static void yK(boolean paramBoolean)
  {
    ...
    Iterator localIterator = KSm.iterator();
  ...
  public final void S(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    Iterator localIterator = this.KSr.iterator();
    while (localIterator.hasNext()) {
  ...
  public final boolean ah(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.KSn)
      {
        this.KSo.requestDisallowInterceptTouchEvent(false);
        break;
      }
      this.KSo.requestDisallowInterceptTouchEvent(true);
      break;
      bool1 = false;
      continue;
      bool1 = bool2;
  ...
  public final boolean ai(MotionEvent paramMotionEvent)
  {
  ...
  public final boolean aj(MotionEvent paramMotionEvent)
  {
  ...
  public void evaluateJavascript(String paramString, ValueCallback<String> paramValueCallback)
  {
    ...
    if ((com.tencent.mm.compatible.util.d.ly(19)) || (this.isX5Kernel)) {}
    for (int i = 1; i != 0; i = 0)
    {
      super.evaluateJavascript(paramString, paramValueCallback);
      AppMethodBeat.o(143429);
    ...
    if ((this.KSl) && (b(this, paramString)))
    {
      AppMethodBeat.o(143429);
      return;
    }
  ...
  public final void fLA()
  {
    ...
    super.setOnTouchListener(new View.OnTouchListener()
    {
      public final boolean onTouch(View paramAnonymousView, MotionEvent paramAnonymousMotionEvent)
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/ui/widget/MMWebView$1", "android/view/View$OnTouchListener", "onTouch", "(Landroid/view/View;Landroid/view/MotionEvent;)Z", this, localb.ahq());
  ...
  public float getMMDensity()
  {
    ...
    float f1 = f2;
    if (getWebCoreType() == WebView.c.Mqu)
    {
      f1 = f2;
  ...
  public void onWebViewScrollChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.KSq != null) {
      this.KSq.onWebViewScrollChanged(paramInt1, paramInt2, paramInt3, paramInt4);
    }
    Iterator localIterator = this.KSr.iterator();
    while (localIterator.hasNext()) {
      ((e)localIterator.next()).onWebViewScrollChanged(paramInt1, paramInt2, paramInt3, paramInt4);
  ...
  public static final class a
  {
    ...
    public static MMWebView kG(Context paramContext)
    {
      AppMethodBeat.i(143419);
      try
      {
        ad.i("MMWebView", "TRACE_ORDER:MMWebView.java");
        WebView.initWebviewCore(paramContext, MMWebView.KSk, "tools", null);
        MMWebView.kF(paramContext);
        paramContext = new MMWebView(paramContext, null, 0, WebView.c.Mqw);
        paramContext.gcX = true;
    ...
    public static MMWebView kH(Context paramContext)
    {
    ...
    extends x
  {
    ...
    public final void a(WebView paramWebView, int paramInt)
    {
      ...
      Iterator localIterator = this.KSv.iterator();
      while (localIterator.hasNext()) {
        ((i)localIterator.next()).a(paramWebView, paramInt);
      }
      this.DOs.a(paramWebView, paramInt);
    ...
    public final boolean a(long paramLong, String paramString1, String paramString2, String paramString3)
    {
      ...
      boolean bool = this.DOs.a(paramLong, paramString1, paramString2, paramString3);
    ...
    public final boolean a(View paramView, WebChromeClient.CustomViewCallback paramCustomViewCallback)
    {
      ...
      boolean bool = this.DOs.a(paramView, paramCustomViewCallback);
    ...
    public final boolean a(WebView paramWebView, ValueCallback<Uri[]> paramValueCallback, x.a parama)
    {
      ...
      boolean bool = this.DOs.a(paramWebView, paramValueCallback, parama);
    ...
    public final boolean a(WebView paramWebView, String paramString1, String paramString2, JsResult paramJsResult)
    {
      ...
      boolean bool = this.DOs.a(paramWebView, paramString1, paramString2, paramJsResult);
    ...
    public final boolean a(WebView paramWebView, String paramString1, String paramString2, String paramString3, o paramo)
    {
      ...
      boolean bool = this.DOs.a(paramWebView, paramString1, paramString2, paramString3, paramo);
    ...
    public final void b(WebView paramWebView, int paramInt)
    {
      ...
      this.DOs.b(paramWebView, paramInt);
    ...
    public final boolean b(WebView paramWebView, String paramString1, String paramString2, JsResult paramJsResult)
    {
      ...
      boolean bool = this.DOs.b(paramWebView, paramString1, paramString2, paramJsResult);
    ...
    public final boolean c(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
    {
      ...
      boolean bool = this.DOs.c(paramString1, paramString2, paramString3, paramString4, paramString5, paramString6);
    ...
    public final void d(WebView paramWebView, String paramString)
    {
      ...
      this.DOs.d(paramWebView, paramString);
    ...
    public final View getVideoLoadingProgressView()
    {
      ...
      Object localObject = this.KSv.iterator();
      while (((Iterator)localObject).hasNext()) {
        ((Iterator)localObject).next();
      }
      localObject = this.DOs.getVideoLoadingProgressView();
    ...
    public final boolean onConsoleMessage(ConsoleMessage paramConsoleMessage)
    {
      ...
      boolean bool = this.DOs.onConsoleMessage(paramConsoleMessage);
    ...
    public final void onExitFullscreenVideo(Bitmap paramBitmap)
    {
      ...
      this.DOs.onExitFullscreenVideo(paramBitmap);
    ...
    public final void onGeolocationPermissionsHidePrompt()
    {
      ...
      this.DOs.onGeolocationPermissionsHidePrompt();
    ...
    public final void onGeolocationPermissionsShowPrompt(String paramString, GeolocationPermissions.Callback paramCallback)
    {
      ...
      this.DOs.onGeolocationPermissionsShowPrompt(paramString, paramCallback);
    ...
    public final void onShowCustomView(View paramView, WebChromeClient.CustomViewCallback paramCustomViewCallback)
    {
      ...
      this.DOs.onShowCustomView(paramView, paramCustomViewCallback);
    ...
    public final void openFileChooser(ValueCallback<Uri> paramValueCallback, String paramString1, String paramString2)
    {
      ...
      this.DOs.openFileChooser(paramValueCallback, paramString1, paramString2);
