...
public final class b
{
  ...
  public static a a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean)
  {
    ...
    if ((paramContext instanceof Activity))
    {
      ...
      locala.mgf = 0;
      locala.mgg = (localDisplayMetrics.widthPixels - (paramInt5 * 2 + i));
      paramInt1 = 0;
      paramInt2 = 1;
      label100:
      if (paramInt3 >= 0)
      ...
      locala.xLU = (i - paramInt5 - paramInt4);
      paramInt3 = 0;
      paramInt4 = 1;
      label160:
      if (paramInt4 == 0) {
    ...
    for (;;)
    {
      ...
      {
        locala.mgf = (paramInt2 - i - paramInt5);
        locala.mgg = (localDisplayMetrics.widthPixels - paramInt2 - paramInt5);
        paramInt1 = 1;
        paramInt2 = 0;
        break label100;
      }
      locala.mgf = paramInt2;
      locala.mgg = (localDisplayMetrics.widthPixels - (paramInt2 + i));
      paramInt1 = 0;
      paramInt2 = 1;
      break label100;
      label315:
      ...
      if ((paramInt2 != 0) && (paramInt4 != 0)) {
        locala.HIC = 2131821217;
      } else if ((paramInt1 != 0) && (paramInt4 != 0)) {
        locala.HIC = 2131821219;
      } else {
        label432:
        locala.HIC = 2131821218;
      }
    }
  }
