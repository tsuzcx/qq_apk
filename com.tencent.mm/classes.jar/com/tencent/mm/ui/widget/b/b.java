...
public final class b
{
  ...
  public static a a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean)
  {
    ...
    if ((paramContext instanceof Activity))
    {
      ...
      int j = at.fromDPToPix(paramContext, 95);
      i = paramInt1;
      if (paramInt1 < j) {
        i = j;
      }
      ...
      locala.oxq = 0;
      locala.oxr = (localDisplayMetrics.widthPixels - (paramInt5 * 2 + i));
      paramInt1 = 0;
      paramInt2 = 1;
      label100:
      if (paramInt3 >= 0)
      ...
      locala.ERI = (i - paramInt5 - paramInt4);
      paramInt3 = 0;
      paramInt4 = 1;
      label160:
      if (paramInt4 == 0) {
    ...
    for (;;)
    {
      ...
      {
        locala.oxq = (paramInt2 - i - paramInt5);
        locala.oxr = (localDisplayMetrics.widthPixels - paramInt2 - paramInt5);
        paramInt1 = 1;
        paramInt2 = 0;
        break label100;
      }
      locala.oxq = paramInt2;
      locala.oxr = (localDisplayMetrics.widthPixels - (paramInt2 + i));
      paramInt1 = 0;
      paramInt2 = 1;
      break label100;
      label315:
      ...
      if ((paramInt2 != 0) && (paramInt4 != 0)) {
        locala.QSG = 2131821255;
      } else if ((paramInt1 != 0) && (paramInt4 != 0)) {
        locala.QSG = 2131821257;
      } else {
        label432:
        locala.QSG = 2131821256;
      }
    }
  }
