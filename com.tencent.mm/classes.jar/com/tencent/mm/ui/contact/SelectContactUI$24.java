  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.cH(paramView);
    a.c("com/tencent/mm/ui/contact/SelectContactUI$7", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aYj());
    h.OAn.b(11140, new Object[] { Integer.valueOf(0) });
    c.ai(this.afik, "pwdgroup", ".ui.FacingCreateChatRoomAllInOneUI");
