  ...
  implements c
{
  ...
  private void init()
  {
    ...
    LayoutInflater.from(getContext()).inflate(R.i.ebp, this, true);
    this.XqR = ((TextView)findViewById(R.h.dCz));
    setOnClickListener(new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.c("com/tencent/mm/ui/contact/CategoryTipView$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aFi());
        ...
        {
          paramAnonymousView = com.tencent.mm.plugin.story.h.h.LOJ;
          com.tencent.mm.plugin.story.h.h.geE().Cv(CategoryTipView.c(CategoryTipView.this));
          paramAnonymousView = com.tencent.mm.plugin.story.h.h.LOJ;
          com.tencent.mm.plugin.story.h.h.geE().gQR = 6L;
          o.a(CategoryTipView.this.getContext(), ((e)com.tencent.mm.kernel.h.ag(e.class)).getFavourUserChecker().gbv(), null, null);
        }
        com.tencent.mm.hellhoundlib.a.a.a(this, "com/tencent/mm/ui/contact/CategoryTipView$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
        AppMethodBeat.o(37668);
      }
    });
    ((e)com.tencent.mm.kernel.h.ag(e.class)).getFavourUserChecker().g(new WeakReference(this));
    AppMethodBeat.o(37673);
  }
  
  public final void ahY(final int paramInt)
  {
    ...
    if ((getVisibility() == 0) && (hUo()) && (this.mStatus != paramInt)) {
      post(new Runnable()
      {
  ...
  public final void awL(int paramInt)
  {
    ...
    if (hUo())
    {
      int i = com.tencent.mm.n.h.axc().getInt("StoryShouldShowEntraceInFavorFriend", 1);
      ...
      if ((i == 1) && ((paramInt & 0x1) != 0))
      {
        ...
        localDrawable.setBounds(0, 0, com.tencent.mm.ci.a.fromDPToPix(getContext(), 20), com.tencent.mm.ci.a.fromDPToPix(getContext(), 20));
        this.XqR.setCompoundDrawables(null, null, localDrawable, null);
        this.XqR.invalidate();
      ...
      if ((i == 1) && ((paramInt & 0x2) != 0))
      {
        ...
        setVisibility(0);
        this.XqR.setVisibility(0);
        localDrawable = au.o(getContext(), R.k.icons_outlined_one_day_video, getContext().getResources().getColor(R.e.black_color));
        localDrawable.setBounds(0, 0, com.tencent.mm.ci.a.fromDPToPix(getContext(), 20), com.tencent.mm.ci.a.fromDPToPix(getContext(), 20));
        this.XqR.setCompoundDrawables(null, null, localDrawable, null);
        this.XqR.invalidate();
        AppMethodBeat.o(37674);
  ...
  protected void onVisibilityChanged(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 0) {
        this.AvN = com.tencent.mm.ui.f.bjQ("6");
      }
