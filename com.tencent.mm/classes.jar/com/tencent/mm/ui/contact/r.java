  ...
  extends s
{
  ...
  protected final com.tencent.mm.ui.contact.a.a pU(int paramInt)
  {
    ...
    if ((paramInt >= 0) && (this.icq.moveToPosition(paramInt)))
    {
      ...
      localc = new c();
      localc.convertFrom(this.icq);
      if (locala.mUQ == -1L)
      {
        locala.mUQ = localc.field_bizChatLocalId;
        if (!localc.isGroup()) {
          break label155;
        }
        locala.ibW = localc.field_chatName;
        locala.GgK = localc.field_headImageUrl;
        locala.username = localc.field_brandUserName;
        if (bt.ai(locala.ibW)) {
          locala.ibW = this.GVS.getActivity().getResources().getString(2131763000);
        }
    ...
    for (;;)
    {
      ...
      return locala;
      label155:
      com.tencent.mm.am.a.k localk = ((com.tencent.mm.api.k)g.ab(com.tencent.mm.api.k.class)).ea(localc.field_bizChatServId);
      if (localk == null) {
        break;
      }
      locala.ibW = localk.field_userName;
      locala.GgK = localk.field_headImageUrl;
