  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    this.KuE.topMargin = ar.dT(this.KuA.getContext());
    ad.i("MicroMsg.ConversationWithAppBrandListView", "[initLayoutParams]2 ActionBar height:%s", new Object[] { Integer.valueOf(this.KuE.topMargin) });
