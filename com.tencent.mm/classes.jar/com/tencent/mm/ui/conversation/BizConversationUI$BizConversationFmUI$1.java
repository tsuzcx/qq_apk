    ...
    if (ai.ang(0)) {
      ((i)h.ae(i.class)).a(MMApplicationContext.getContext(), new Runnable()
      {
        public final void run()
        {
          ...
          localIntent.putExtra("title", BizConversationUI.BizConversationFmUI.1.this.XzJ.getString(R.l.fts_search_biz_article));
          localIntent.putExtra("searchbar_tips", BizConversationUI.BizConversationFmUI.1.this.XzJ.getString(R.l.fts_search_biz_article));
          ...
          if (Build.VERSION.SDK_INT >= 21)
          {
            localObject = str;
            if (!ar.isDarkMode()) {
              localObject = ActivityOptions.makeSceneTransitionAnimation(BizConversationUI.BizConversationFmUI.1.this.XzJ.thisActivity(), new Pair[0]).toBundle();
            }
          }
          c.a(BizConversationUI.BizConversationFmUI.1.this.XzJ.thisActivity(), "webview", ".ui.tools.fts.FTSSearchTabWebViewUI", localIntent, (Bundle)localObject);
