...
{
  private static final String[] IAY = { "M3X", "M5s", "M5", "MX6", "U10", "U20", "M2 E", "M A5", "DIG-AL00", "DIG-TL10", "NCE-AL00", "NCE-TL10", "MYA-TL10", "MYA-AL10", "NEM-AL10" };
  ...
  public static boolean frM()
  {
    ...
    if ((Build.VERSION.SDK_INT == 23) && (Build.MODEL != null))
    {
      ...
      while (i < j)
      {
        ...
        {
          ac.i("CompatSupportV27", "for weird crash, %s", new Object[] { Build.MODEL });
