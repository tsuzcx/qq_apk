  ...
  extends BaseConversationUI
{
    ...
    implements n.d
  {
    ...
    private void batchSyncForWxaContact()
    {
      ...
      {
        List localList = ((a)this.adapter).fHX;
        if ((localList != null) && (localList.size() > 0)) {
          ((m)com.tencent.mm.kernel.g.ab(m.class)).bd(localList);
        }
      }
      AppMethodBeat.o(38129);
    }
    ...
    private void cleadAllServiceAppBrandUnreadCount()
    {
      ...
      com.tencent.mm.sdk.b.a.ESL.l(localp);
    ...
    private void delConversationAndMsg(String paramString)
    {
      ...
      com.tencent.e.h.Iye.aP(new Runnable()
      {
        public final void run()
        {
          ...
          ((com.tencent.mm.plugin.appbrand.service.f)com.tencent.mm.kernel.g.ab(com.tencent.mm.plugin.appbrand.service.f.class)).c(null);
    ...
    private void enterConversationReport()
    {
      ...
      az.arV();
      Object localObject1 = com.tencent.mm.model.c.apR().aIn("appbrandcustomerservicemsg");
      if ((localObject1 != null) && (!bt.isNullOrNil(((ay)localObject1).field_username))) {}
      for (int j = ((ay)localObject1).field_unReadCount;; j = 0)
      {
        localObject1 = (am)this.adapter.getItem(0);
        Object localObject2;
        if ((localObject1 != null) && (!bt.isNullOrNil(((ay)localObject1).field_username)))
        {
          localObject2 = bt.nullAsNil(((ay)localObject1).field_content);
          localObject1 = ((m)com.tencent.mm.kernel.g.ab(m.class)).FW(((ay)localObject1).field_username);
        ...
        for (localObject1 = localObject2;; localObject1 = "")
        {
          ...
          if (j > 0)
          {
            ...
            localObject2 = (am)this.adapter.getItem(k);
            m = ((ay)localObject2).field_unReadCount;
            if (((ay)localObject2).field_unReadMuteCount + m <= 0) {
              break label354;
            }
            i += 1;
          }
          ...
          for (;;)
          {
            ...
            com.tencent.mm.plugin.report.service.h.vKh.f(13797, new Object[] { this.mSceneId, Integer.valueOf(j), Integer.valueOf(m), this.mAppId, Long.valueOf(bt.aGK()), Integer.valueOf(0), localObject1 });
            AppMethodBeat.o(38131);
            return;
          }
        }
    ...
    public void customerMsgOperateReport(int paramInt)
    {
      ...
      com.tencent.mm.plugin.report.service.h.vKh.f(13798, new Object[] { Integer.valueOf(paramInt), this.mAppId, Integer.valueOf(0), this.mSceneId, Long.valueOf(bt.aGK()) });
    ...
    public void entryCustomerMsgDialogReport(String paramString, int paramInt)
    {
      ...
      az.arV();
      am localam = com.tencent.mm.model.c.apR().aIn(paramString);
      if (localam == null)
      {
      ...
      int i = localam.field_unReadCount;
      ...
      com.tencent.mm.plugin.report.service.h.vKh.f(13799, new Object[] { this.mAppId, Integer.valueOf(paramInt), Integer.valueOf(i), paramString, Long.valueOf(bt.aGK()) });
      AppMethodBeat.o(38133);
    }
    ...
    protected void initView()
    {
      ...
      this.adapter = new a(thisActivity(), this.superUsername, new q.a()
      {
      ...
      this.appbrandMessageLV.setOnItemClickListener(new AdapterView.OnItemClickListener()
      {
        public final void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
        {
          ...
          AppBrandServiceConversationUI.AppBrandServiceConversationFmUI.access$402(AppBrandServiceConversationUI.AppBrandServiceConversationFmUI.this, (am)AppBrandServiceConversationUI.AppBrandServiceConversationFmUI.this.adapter.getItem(paramAnonymousInt));
    ...
    public void onActivityCreated(Bundle paramBundle)
    {
      ...
      addIconOptionMenu(1, 2131689645, new MenuItem.OnMenuItemClickListener()
      {
        public final boolean onMenuItemClick(MenuItem paramAnonymousMenuItem)
        {
          ...
          com.tencent.mm.hellhoundlib.a.a.a(paramAnonymousMenuItem, ((com.tencent.mm.hellhoundlib.b.a)localObject).adn(), "com/tencent/mm/ui/conversation/AppBrandServiceConversationUI$AppBrandServiceConversationFmUI$1", "onMenuItemClick", "(Landroid/view/MenuItem;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
      ...
      az.arV();
      com.tencent.mm.model.c.apR().a(this.adapter);
    ...
    public void onCreateContextMenu(ContextMenu paramContextMenu, View paramView, ContextMenu.ContextMenuInfo paramContextMenuInfo)
    {
      ...
      paramContextMenuInfo = ((m)com.tencent.mm.kernel.g.ab(m.class)).FW(this.talker);
      int i;
    ...
    public void onDestroy()
    {
      ...
      {
        az.arV();
        com.tencent.mm.model.c.apR().b(this.adapter);
      }
      batchSyncForWxaContact();
      if (this.adapter != null) {
    ...
    public void onMMMenuItemSelected(MenuItem paramMenuItem, int paramInt)
    {
      ...
      az.arV();
      af localaf = com.tencent.mm.model.c.apM().aHY(this.talker);
      ...
      for (;;)
      {
        ...
        this.appBrandServiceActionSheet.FTO = this.mSceneId;
        this.appBrandServiceActionSheet.mlE = true;
    ...
    public void onPause()
    {
      ...
      az.arV();
      com.tencent.mm.model.c.apR().aIp(this.superUsername);
      if (this.adapter != null) {
      ...
      extends f
    {
      ...
      private HashMap<String, Boolean> Haa;
      private HashMap<String, String> Hab;
      List<String> fHX;
      private Paint paint;
      private String username;
      
      a(Context paramContext, String paramString, q.a parama)
      {
        super(parama);
      ...
      public final void Wd()
      {
        ...
        az.arV();
        setCursor(com.tencent.mm.model.c.apR().c(w.gMt, this.fvP, this.username));
        if (this.FNn != null) {
          this.FNn.aIp();
        }
      ...
      protected final void a(String paramString, f.g paramg)
      {
        ...
        Object localObject1 = (Boolean)this.Haa.get(paramString);
        boolean bool;
        if (localObject1 == null)
        {
          Object localObject2 = ((m)com.tencent.mm.kernel.g.ab(m.class)).FW(paramString);
          if ((localObject2 != null) && ((((WxaAttributes)localObject2).field_appOpt & 0x2) > 0))
          {
            bool = true;
            this.Haa.put(paramString, localObject1);
            label68:
            if (!bool) {
              break label598;
            }
            paramg.Ghh.setVisibility(0);
            paramg.Ghh.setImageResource(2131689881);
            label90:
            localObject2 = (String)this.Hab.get(paramString);
            localObject1 = localObject2;
            if (TextUtils.isEmpty((CharSequence)localObject2))
            {
              localObject2 = e.aKf(e.aKe(paramString));
              localObject1 = localObject2;
              if (!TextUtils.isEmpty((CharSequence)localObject2))
              {
                this.Hab.put(paramString, localObject2);
                localObject1 = localObject2;
              }
            }
            ...
            paramg.HbK.setVisibility(0);
            localObject1 = this.context.getString(2131755664, new Object[] { localObject1 });
            paramg.HbK.setText((CharSequence)localObject1);
        ...
        for (int i = this.context.getResources().getDisplayMetrics().widthPixels;; i = 0)
        {
          ...
          if (com.tencent.mm.cd.a.hS(this.context))
          {
            ...
            localObject1 = (f.d)this.GgX.get(paramString);
            if ((localObject1 == null) || (((f.d)localObject1).nickName == null)) {
              break label642;
            }
            localObject1 = ((f.d)localObject1).nickName.toString();
            if (localObject1 != null) {
              break label650;
            }
            f1 = 0.0F;
            ...
            f2 = 1.0F - f1;
            label477:
            localObject1 = (LinearLayout.LayoutParams)paramg.Ghe.getLayoutParams();
            ((LinearLayout.LayoutParams)localObject1).width = 0;
            ((LinearLayout.LayoutParams)localObject1).weight = f1;
            paramg.Ghe.setLayoutParams((ViewGroup.LayoutParams)localObject1);
            localObject1 = (LinearLayout.LayoutParams)paramg.HbK.getLayoutParams();
            ((LinearLayout.LayoutParams)localObject1).width = 0;
            ((LinearLayout.LayoutParams)localObject1).weight = f2;
            paramg.HbK.setLayoutParams((ViewGroup.LayoutParams)localObject1);
          }
          for (;;)
          {
            a.b.d(paramg.frr, paramString);
            if (!this.fHX.contains(paramString)) {
              this.fHX.add(paramString);
            }
            ...
            localObject1 = "";
            break label328;
            this.paint.setTextSize(this.GgT);
