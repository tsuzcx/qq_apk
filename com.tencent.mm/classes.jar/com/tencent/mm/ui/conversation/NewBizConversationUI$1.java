  ...
  implements MenuItem.OnMenuItemClickListener
{
  ...
  public final boolean onMenuItemClick(MenuItem paramMenuItem)
  {
    ...
    if (com.tencent.mm.plugin.websearch.api.ad.Wd(0)) {
      ((i)g.ab(i.class)).a(aj.getContext(), new Runnable()
      {
        public final void run()
        {
          ...
          localIntent.putExtra("title", NewBizConversationUI.1.this.Kxj.getString(2131759718));
          localIntent.putExtra("searchbar_tips", NewBizConversationUI.1.this.Kxj.getString(2131759718));
          ...
          if (Build.VERSION.SDK_INT >= 21)
          {
            localObject = str;
            if (!al.isDarkMode()) {
              localObject = ActivityOptions.makeSceneTransitionAnimation(NewBizConversationUI.1.this.Kxj, new Pair[0]).toBundle();
            }
          }
          str = af.aFR("bizAccountTopSearch");
          if (!TextUtils.isEmpty(str)) {
            localIntent.putExtra("key_search_input_hint", str);
          }
          d.a(NewBizConversationUI.1.this.Kxj, "webview", ".ui.tools.fts.FTSSearchTabWebViewUI", localIntent, (Bundle)localObject);
    ...
    for (;;)
    {
      ...
      return true;
      com.tencent.mm.sdk.platformtools.ad.e("MicroMsg.NewBizConversationUI", "fts h5 template not avail");
    }
  }
}
