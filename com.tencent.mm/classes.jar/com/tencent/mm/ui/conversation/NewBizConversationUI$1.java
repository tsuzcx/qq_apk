    ...
    if (ai.afs(0)) {
      ((i)g.af(i.class)).a(MMApplicationContext.getContext(), new Runnable()
      {
        public final void run()
        {
          ...
          localIntent.putExtra("title", NewBizConversationUI.1.this.QgK.getString(2131761039));
          localIntent.putExtra("searchbar_tips", NewBizConversationUI.1.this.QgK.getString(2131761039));
          ...
          if (Build.VERSION.SDK_INT >= 21)
          {
            localObject = str;
            if (!ao.isDarkMode()) {
              localObject = ActivityOptions.makeSceneTransitionAnimation(NewBizConversationUI.1.this.QgK, new Pair[0]).toBundle();
            }
          }
          str = ak.aXg("bizAccountTopSearch");
          if (!TextUtils.isEmpty(str)) {
            localIntent.putExtra("key_search_input_hint", str);
          }
          c.a(NewBizConversationUI.1.this.QgK, "webview", ".ui.tools.fts.FTSSearchTabWebViewUI", localIntent, (Bundle)localObject);
