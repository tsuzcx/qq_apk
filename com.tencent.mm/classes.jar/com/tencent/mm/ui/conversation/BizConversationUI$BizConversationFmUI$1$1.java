  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    localIntent.putExtra("title", this.Ahg.Ahf.getString(2131300238));
    localIntent.putExtra("searchbar_tips", this.Ahg.Ahf.getString(2131300238));
    ...
    if (Build.VERSION.SDK_INT >= 21) {
      localObject = ActivityOptions.makeSceneTransitionAnimation(this.Ahg.Ahf.thisActivity(), new Pair[0]).toBundle();
    }
    d.a(this.Ahg.Ahf.thisActivity(), "webview", ".ui.tools.fts.FTSSearchTabWebViewUI", localIntent, (Bundle)localObject);
