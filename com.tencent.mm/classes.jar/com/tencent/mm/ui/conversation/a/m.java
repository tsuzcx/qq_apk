  ...
  implements View.OnClickListener
{
  ...
  public static void lt(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      com.tencent.mm.hellhoundlib.a.a.b(paramContext, ((com.tencent.mm.hellhoundlib.b.a)localObject).aFh(), "com/tencent/mm/ui/conversation/banner/MsgDelayTipsBanner", "showTips", "(Landroid/content/Context;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
  ...
  public static void lu(Context paramContext)
  {
    ...
    Object localObject3 = com.tencent.mm.as.a.bkH();
    ...
    bh.beI();
    localObject2 = c.bbH() + "/delayedMsg";
    u.bBD((String)localObject2);
    Object localObject4 = new q((String)localObject2, "data.txt");
    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        try
        {
          localObject3 = u.e((q)localObject4, false);
        ...
        try
        {
          ...
          Toast.makeText(paramContext, ((q)localObject4).bOF(), 1).show();
          paramContext = ((q)localObject4).bOF();
          localObject1 = new ca();
          ((ca)localObject1).Jm("weixin");
          ...
          if (((et)localObject1).field_isSend == 1)
          {
            ...
            ((ca)localObject1).EG(l);
            ((ca)localObject1).setCreateTime(l);
            ((n)com.tencent.mm.kernel.h.ae(n.class)).eSe().aM((ca)localObject1);
            AppMethodBeat.o(38831);
            return;
  ...
  public final boolean ckL()
  {
    ...
    boolean bool = com.tencent.mm.kernel.h.aHG().aHp().getBoolean(ar.a.VsE, false);
  ...
  public final void onClick(View paramView)
  {
    ...
    localb.bn(paramView);
    com.tencent.mm.hellhoundlib.a.a.c("com/tencent/mm/ui/conversation/banner/MsgDelayTipsBanner", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aFi());
    lt((Context)this.Rhc.get());
    com.tencent.mm.kernel.h.aHH();
    com.tencent.mm.kernel.h.aHG().aHp().set(ar.a.VsE, Boolean.FALSE);
    if (this.view != null) {
      this.view.setVisibility(8);
    }
