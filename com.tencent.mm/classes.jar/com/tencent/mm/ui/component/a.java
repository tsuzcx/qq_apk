...
@l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/ui/component/UICProvider;", "", "()V", "of", "Landroid/arch/lifecycle/ViewModelProvider;", "fragment", "Landroid/support/v4/app/Fragment;", "activity", "Lcom/tencent/mm/ui/MMActivity;", "P", "Lcom/tencent/mm/kernel/plugin/Plugin;", "ownerClazz", "Ljava/lang/Class;", "libmmui_release"})
public final class a
{
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"com/tencent/mm/ui/component/UICProvider$of$1", "Landroid/arch/lifecycle/ViewModelProvider$NewInstanceFactory;", "create", "T", "Landroid/arch/lifecycle/ViewModel;", "modelClass", "Ljava/lang/Class;", "(Ljava/lang/Class;)Landroid/arch/lifecycle/ViewModel;", "libmmui_release"})
    ...
    extends ViewModelProvider.NewInstanceFactory
  {
    ...
    public final <T extends ViewModel> T create(Class<T> paramClass)
    {
      ...
      if (SimpleUIComponent.class.isAssignableFrom(paramClass)) {
        try
        {
          ViewModel localViewModel = (ViewModel)paramClass.getConstructor(new Class[] { Fragment.class }).newInstance(new Object[] { this.tcc });
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"com/tencent/mm/ui/component/UICProvider$of$2", "Landroid/arch/lifecycle/ViewModelProvider$NewInstanceFactory;", "create", "T", "Landroid/arch/lifecycle/ViewModel;", "modelClass", "Ljava/lang/Class;", "(Ljava/lang/Class;)Landroid/arch/lifecycle/ViewModel;", "libmmui_release"})
    ...
    extends ViewModelProvider.NewInstanceFactory
  {
    ...
    public final <T extends ViewModel> T create(Class<T> paramClass)
    {
      ...
      if (SimpleUIComponent.class.isAssignableFrom(paramClass)) {
        try
        {
          ViewModel localViewModel = (ViewModel)paramClass.getConstructor(new Class[] { MMActivity.class }).newInstance(new Object[] { this.lPs });
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"com/tencent/mm/ui/component/UICProvider$of$3", "Landroid/arch/lifecycle/ViewModelProvider$NewInstanceFactory;", "create", "T", "Landroid/arch/lifecycle/ViewModel;", "modelClass", "Ljava/lang/Class;", "(Ljava/lang/Class;)Landroid/arch/lifecycle/ViewModel;", "libmmui_release"})
    ...
    public final <T extends ViewModel> T create(Class<T> paramClass)
    {
      ...
      if (UIComponentPlugin.class.isAssignableFrom(paramClass)) {
        ...
        catch (NoSuchMethodException localNoSuchMethodException)
        {
          ...
          f localf = this.KiE;
          p.h(localf, "<set-?>");
          ((UIComponentPlugin)localObject2).KiN = localf;
