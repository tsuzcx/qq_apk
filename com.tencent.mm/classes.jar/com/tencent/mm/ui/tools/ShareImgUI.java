  ...
  implements com.tencent.mm.ak.g
{
  ...
  private String a(Uri paramUri, android.database.Cursor paramCursor)
  {
    ...
    //   169: astore 8
    //   171: new 191	com/tencent/mm/vfs/e
    //   174: dup
    //   175: aload 4
    //   177: invokespecial 194	com/tencent/mm/vfs/e:<init>	(Ljava/lang/String;)V
    //   180: astore 4
    //   182: aload 4
    //   184: invokevirtual 197	com/tencent/mm/vfs/e:exists	()Z
    //   187: ifne +9 -> 196
    //   190: aload 4
    //   192: invokevirtual 200	com/tencent/mm/vfs/e:mkdirs	()Z
    //   195: pop
    //   196: new 191	com/tencent/mm/vfs/e
    //   199: dup
    //   200: aload 8
    //   202: invokespecial 194	com/tencent/mm/vfs/e:<init>	(Ljava/lang/String;)V
    //   205: astore 4
    //   207: aload 4
    //   209: invokevirtual 197	com/tencent/mm/vfs/e:exists	()Z
    //   212: ifne +9 -> 221
    //   215: aload 4
    //   217: invokevirtual 203	com/tencent/mm/vfs/e:createNewFile	()Z
    //   220: pop
    //   221: aload 8
    //   223: iconst_0
