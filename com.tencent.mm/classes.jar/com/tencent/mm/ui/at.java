...
public final class at
{
  ...
  public static Bitmap a(Bitmap paramBitmap, float paramFloat)
  {
    ...
    {
      av.e("WeUIBitmapUtil", "getRoundedCornerBitmap in bitmap is null", new Object[0]);
      AppMethodBeat.o(159110);
      return null;
    }
    Bitmap localBitmap = a(paramBitmap.getWidth(), paramBitmap.getHeight(), Bitmap.Config.ARGB_8888);
    if (localBitmap == null)
    {
      AppMethodBeat.o(159110);
      return null;
    ...
    av.i("WeUIBitmapUtil", "getRoundedCornerBitmap bitmap recycle %s", new Object[] { paramBitmap });
    paramBitmap.recycle();
    AppMethodBeat.o(159110);
    return localBitmap;
  }
