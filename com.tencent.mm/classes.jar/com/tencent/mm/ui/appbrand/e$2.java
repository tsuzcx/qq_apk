  ...
  implements x.a
{
  public final int a(int paramInt1, int paramInt2, String paramString, b paramb, n paramn)
  {
    ...
    paramString = (avh)paramb.gUT.gUX;
    if ((paramInt1 == 0) && (paramInt2 == 0) && (paramString != null) && (paramString.DuJ != null))
    {
      paramb = new StringBuilder();
      paramn = paramString.DuJ.iterator();
      while (paramn.hasNext())
      {
        String str = (String)paramn.next();
        paramb.append(str + "|");
      }
      ad.d("MicroMsg.AppBrandServiceHelper", "block_qr_prefix:%s, size:%d", new Object[] { paramb.toString(), Integer.valueOf(paramString.DuJ.size()) });
      g.afB().afk().set(ae.a.FlN, paramb.toString());
    }
