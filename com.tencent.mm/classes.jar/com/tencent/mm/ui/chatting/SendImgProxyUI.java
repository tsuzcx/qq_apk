  ...
  extends MMBaseActivity
{
  ...
  private static void g(ArrayList<Integer> paramArrayList, ArrayList<String> paramArrayList1)
  {
    ...
    while (i < paramArrayList1.size())
    {
      ...
      Object localObject = o.ayF().od(j);
      int k = (int)i.aMN((String)paramArrayList1.get(i));
      ((e)localObject).setOffset(k);
      ((e)localObject).nX(k);
      o.ayF().a(j, (e)localObject);
      long l = ((e)localObject).hgs;
      ad.i("MicroMsg.SendImgProxyUI", "[insertErrMsg] msgLocalId:%s oriImgLocalId:%s", new Object[] { Long.valueOf(l), Integer.valueOf(j) });
      localObject = ((k)com.tencent.mm.kernel.g.ab(k.class)).cOI().rm(l);
      ((bl)localObject).setStatus(5);
      ((bl)localObject).jC(256);
      ((k)com.tencent.mm.kernel.g.ab(k.class)).cOI().a(l, (bl)localObject);
      ad.i("MicroMsg.SendImgProxyUI", "after update msgInfo, localId[%d] svrId[%d] talker[%s] type[%d] isSend[%d] imgPath[%s], status[%d] createTime[%d]", new Object[] { Long.valueOf(((du)localObject).field_msgId), Long.valueOf(((du)localObject).field_msgSvrId), ((du)localObject).field_talker, Integer.valueOf(((bl)localObject).getType()), Integer.valueOf(((du)localObject).field_isSend), ((du)localObject).field_imgPath, Integer.valueOf(((du)localObject).field_status), Long.valueOf(((du)localObject).field_createTime) });
      i += 1;
    }
    AppMethodBeat.o(34894);
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.lAj = com.tencent.mm.ui.base.h.b(this, getString(2131761075), false, null);
