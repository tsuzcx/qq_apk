  ...
  implements j
{
  ...
  public v(a parama, ai paramai, String paramString)
  {
    ...
    if ((this.contact != null) && (ai.ww(this.contact.field_username))) {
      parama = this.HMZ;
    }
    for (;;)
    {
  ...
  public final void B(EmojiInfo paramEmojiInfo)
  {
    ...
    {
      t.g(this.HpO.HZF.getContext(), this.HpO.HZF.getContentView());
    ...
    for (int i = 1; i != 0; i = 0)
    {
      ...
      paramEmojiInfo.field_state = EmojiInfo.Kgf;
      ...
      ((bo)localObject).re("medianote");
      ((bo)localObject).jT(1);
      if (paramEmojiInfo.CC()) {
        ((bo)localObject).setContent(au.a(u.axw(), 0L, false, paramEmojiInfo.JC(), false, ""));
      }
      ((bo)localObject).rf(paramEmojiInfo.JC());
      ((bo)localObject).oA(bi.yp(((dy)localObject).field_talker));
      ((bo)localObject).setStatus(2);
      az.ayM();
      c.awD().ap((bo)localObject);
      AppMethodBeat.o(34685);
      return;
    }
    ...
    if (bs.isNullOrNil(this.HMZ)) {}
    for (Object localObject = this.contact.field_username;; localObject = this.HMZ)
    {
  ...
  public final void N(EmojiInfo paramEmojiInfo)
  {
    ...
    //   5: invokestatic 72	com/tencent/mm/model/az:ayM	()Lcom/tencent/mm/model/c;
    //   8: pop
    //   9: invokestatic 78	com/tencent/mm/model/c:isSDCardAvailable	()Z
    //   12: ifne +32 -> 44
    //   15: aload_0
    //   16: getfield 33	com/tencent/mm/ui/chatting/v:HpO	Lcom/tencent/mm/ui/chatting/d/a;
    //   19: getfield 84	com/tencent/mm/ui/chatting/d/a:HZF	Lcom/tencent/mm/ui/chatting/BaseChattingUIFragment;
    //   22: invokevirtual 90	com/tencent/mm/ui/chatting/BaseChattingUIFragment:getContext	()Landroid/app/Activity;
    //   25: aload_0
    //   26: getfield 33	com/tencent/mm/ui/chatting/v:HpO	Lcom/tencent/mm/ui/chatting/d/a;
    //   29: getfield 84	com/tencent/mm/ui/chatting/d/a:HZF	Lcom/tencent/mm/ui/chatting/BaseChattingUIFragment;
    ...
    //   70: astore_3
    //   71: invokestatic 72	com/tencent/mm/model/az:ayM	()Lcom/tencent/mm/model/c;
    //   74: pop
    //   75: aload_3
    //   76: invokestatic 235	com/tencent/mm/model/c:awQ	()Ljava/lang/String;
    //   79: invokevirtual 239	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   82: aload_1
    //   83: invokevirtual 168	com/tencent/mm/storage/emotion/EmojiInfo:JC	()Ljava/lang/String;
    ...
    //   114: invokestatic 249	com/tencent/mm/vfs/i:eA	(Ljava/lang/String;)Z
    //   117: ifeq +98 -> 215
    ...
    //   140: invokestatic 252	com/tencent/mm/vfs/i:aSp	(Ljava/lang/String;)J
    //   143: l2i
    //   144: istore_2
    //   145: aload 6
    ...
    //   167: iconst_0
    //   168: iload_2
    //   169: invokestatic 256	com/tencent/mm/vfs/i:aU	(Ljava/lang/String;II)[B
    ...
    //   195: aconst_null
    //   196: aload_0
    //   197: getfield 37	com/tencent/mm/ui/chatting/v:HMZ	Ljava/lang/String;
    //   200: iconst_1
    //   201: aload_1
    //   202: invokevirtual 168	com/tencent/mm/storage/emotion/EmojiInfo:JC	()Ljava/lang/String;
    ...
    //   236: aload 4
    //   238: invokestatic 294	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   241: goto -66 -> 175
    //   244: astore 5
    //   246: aconst_null
    //   247: astore 4
    ...
    //   263: invokestatic 302	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   266: aload 4
    //   268: astore_3
    //   269: ldc_w 296
    //   272: ldc_w 304
    //   275: invokestatic 308	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   278: aload 4
    //   280: invokestatic 294	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   283: goto -108 -> 175
    //   286: astore_1
    //   287: aconst_null
    //   288: astore_3
    //   289: aload_3
    //   290: invokestatic 294	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   293: ldc 226
