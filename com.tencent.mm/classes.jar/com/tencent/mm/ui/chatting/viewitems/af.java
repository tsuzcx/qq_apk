  ...
  extends RelativeLayout
{
  ...
  public af(LayoutInflater paramLayoutInflater, int paramInt)
  {
    ...
    paramLayoutInflater = this.imq.inflate(2131493407, null);
    ...
    int i = a.ao(getContext(), 2131165576);
    if (i != paramInt) {
    ...
    addView(paramLayoutInflater, localLayoutParams);
    paramLayoutInflater = this.imq.inflate(this.GNf, null);
