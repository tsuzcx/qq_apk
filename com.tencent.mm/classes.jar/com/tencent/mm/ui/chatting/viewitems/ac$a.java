  ...
  extends c
{
  ...
  public final View a(LayoutInflater paramLayoutInflater, View paramView)
  {
    ...
    {
      localObject = new t(paramLayoutInflater, R.i.chatting_item_from_location);
      ((View)localObject).setTag(new ac.d().s((View)localObject, true));
    }
    return localObject;
  }
  ...
  public final void a(c.a parama, int paramInt, com.tencent.mm.ui.chatting.c.a parama1, bi parambi, String paramString)
  {
    ...
    ac.d.a(parama, parambi, true, paramInt, parama1, this.vFb, c(parama1));
  }
  ...
  public final boolean a(ContextMenu paramContextMenu, View paramView, bi parambi)
  {
    if (parambi.getType() == 48)
    {
      ...
      if ((localdo.bKa.bJy) || (g.S(this.vko.vtz.getContext(), parambi.getType()))) {
  ...
  public final boolean a(MenuItem paramMenuItem, com.tencent.mm.ui.chatting.c.a parama, bi parambi)
  {
    ...
    {
      return bool;
      paramMenuItem = new Intent(parama.vtz.getContext(), ChattingSendDataToDeviceUI.class);
      paramMenuItem.putExtra("exdevice_open_scene_type", 1);
      paramMenuItem.putExtra("Retr_Msg_Id", parambi.field_msgId);
      parama.vtz.getContext().startActivity(paramMenuItem);
      return true;
    } while (!parambi.aVM());
