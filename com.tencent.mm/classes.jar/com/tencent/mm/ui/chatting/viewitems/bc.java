  ...
  implements ba.a
{
  public final void b(c.a parama, int paramInt, com.tencent.mm.ui.chatting.e.a parama1, ca paramca)
  {
    ...
    if ((parama1.Pwc instanceof AppBrandServiceChattingUI.AppBrandServiceChattingFmUI))
    {
      ...
      localBundle.putString("local_session", parama1.Pwh);
      paramca = ((e)g.af(e.class)).b(paramca.field_content, localBundle, new WeakReference(parama1.Pwc.getContext()), new WeakReference(parama.POM));
    ...
    for (;;)
    {
      parama.POM.setOnClickListener(new bc.1(this));
