  ...
  extends c
{
  ...
  private static void a(ae.a parama)
  {
    ...
    parama.clickArea.setBackgroundResource(2131231459);
  ...
  public final View a(LayoutInflater paramLayoutInflater, View paramView)
  {
    ...
    {
      localObject = new an(paramLayoutInflater, 2131493598);
  ...
  public final void a(c.a parama, int paramInt, a parama1, ca paramca, String paramString)
  {
    ...
    for (paramString = k.b.aD(parama, paramca.field_reserved);; paramString = null)
    {
      ...
      if (paramString != null)
      {
        ...
        locala.clickArea.setBackgroundResource(2131231454);
      ...
      bg.aVF();
      parama = com.tencent.mm.model.c.aSN().bjK(paramca.field_talker);
      if (parama != null) {}
      Object localObject;
      for (parama = parama.arJ();; parama = paramca.field_talker)
      {
        localObject = (j)paramString.as(j.class);
        if (!parama1.gRM()) {
          break label550;
        }
      ...
      {
        parama = parama1.Pwc.getMMResources().getString(2131757406, new Object[] { af.nullAsNil(parama) });
        if (!Util.isEqual(((j)localObject).iwA, 1)) {
          break label1695;
        }
        if (parama.length() > 5) {
          parama = parama.substring(0, 5) + "..." + MMApplicationContext.getContext().getString(2131757408);
        }
      }
      label770:
      label1695:
      for (;;)
      {
        locala.PLD.setText(l.b(parama1.Pwc.getContext(), parama, locala.PLD.getTextSize()));
        break label515;
        parama = parama + MMApplicationContext.getContext().getString(2131757408);
        continue;
        if (Util.isEqual(((j)localObject).iwA, 1)) {
        ...
        for (;;)
        {
          ...
          if (bool)
          {
            ...
            for (;;)
            {
              ...
              break;
              localObject = MMApplicationContext.getContext().getString(2131757395) + "-" + paramString.iyX;
              parama = (c.a)localObject;
              if (((String)localObject).length() > 5)
              {
                parama = ((String)localObject).substring(0, 5) + "..." + MMApplicationContext.getContext().getString(2131757408);
                continue;
                if (af.isNullOrNil(paramString.iyX)) {
  ...
  public final boolean c(View paramView, a parama, ca paramca)
  {
    ...
    if (paramView != null)
    {
      ...
      case 2: 
      default: 
        Log.w("MicroMsg.ChattingItemAppMsgRemittanceTo", "Unrecognized type %d, probably version to low & check update!", new Object[] { Integer.valueOf(paramView.ixN) });
      ...
      for (;;)
      {
        ...
        paramView = new ae.c.1(this, parama);
        if (z.aUo())
        {
          com.tencent.mm.br.c.a(parama.Pwa, "wallet_payu", ".remittance.ui.PayURemittanceDetailUI", (Intent)localObject, 221, paramView);
        }
        else
        {
          com.tencent.mm.br.c.a(parama.Pwa, "remittance", ".ui.RemittanceDetailUI", (Intent)localObject, 221, paramView);
          continue;
          ((Intent)localObject).putExtra("appmsg_type", paramView.ixN);
          ((Intent)localObject).putExtra("transfer_id", paramView.ixQ);
          ((Intent)localObject).putExtra("transaction_id", paramView.ixP);
