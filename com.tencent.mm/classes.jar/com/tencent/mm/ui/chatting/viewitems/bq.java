  ...
  implements bf.a
{
  public final void b(c.a parama, int paramInt, com.tencent.mm.ui.chatting.e.a parama1, ca paramca)
  {
    ...
    if ((parama1.WQv instanceof AppBrandServiceChattingUI.AppBrandServiceChattingFmUI))
    {
      ...
      paramca = ((l)h.ae(l.class)).a(paramca.field_content, localBundle, new WeakReference(parama1.WQv.getContext()), new WeakReference(parama.XkO));
    ...
    for (;;)
    {
      parama.XkO.setOnClickListener(new bq.1(this));
