...
{
  private static final int[] Iop = { 2131231608, 2131231608, 2131231614, 2131231611 };
  private static final int[] Ioq = { 2131233778, 2131233782, 2131233787, 2131233784 };
  private String lhM;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      AppMethodBeat.o(37301);
      return;
      ac.d("ChattingItemFooter", "get latest message");
      paramView.state = j.hxN;
      c(paramView);
      AppMethodBeat.o(37301);
      return;
      ac.d("ChattingItemFooter", "start webview url");
      paramView.state = j.hxN;
      c(paramView);
      Intent localIntent = new Intent();
      localIntent.putExtra("rawUrl", paramView.value);
      localIntent.putExtra("showShare", false);
      localIntent.putExtra("geta8key_username", this.lhM);
