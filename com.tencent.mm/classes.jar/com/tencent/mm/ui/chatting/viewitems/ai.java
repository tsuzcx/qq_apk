  ...
  implements ag.a
{
  public final void b(c.a parama, int paramInt, com.tencent.mm.ui.chatting.c.a parama1, bi parambi)
  {
    ...
    if ((parama1.vtz instanceof AppBrandServiceChattingUI.a))
    {
      ...
      localBundle.putString("local_session", parama1.vtC);
      com.tencent.mm.plugin.messenger.a.e locale = (com.tencent.mm.plugin.messenger.a.e)g.r(com.tencent.mm.plugin.messenger.a.e.class);
      long l = parambi.field_msgId;
      parambi = parambi.field_content;
      WeakReference localWeakReference = new WeakReference(parama1.vtz.getContext());
      new WeakReference(parama.vEC);
    ...
    for (;;)
    {
      parama.vEC.setOnClickListener(new ai.1(this));
