    ...
    for (;;)
    {
      ...
      localSpannableString.setSpan(new com.tencent.mm.plugin.messenger.a.a(paramMap, paramBundle)
      {
        public final void onClickImp(View paramAnonymousView)
        {
          ...
          ((e)h.ae(e.class)).a("link_profile", paramMap, paramBundle);
          if ((paramWeakReference != null) && (paramWeakReference.get() != null))
          {
            long l = paramBundle.getLong("msg_id");
            paramAnonymousView = paramBundle.getString("conv_talker_username", null);
            if (ab.Lj(paramAnonymousView))
            {
              a.a((Context)paramWeakReference.get(), this.iXL, paramAnonymousView, str2, l);
              AppMethodBeat.o(290275);
              return;
            }
            a.a((Context)paramWeakReference.get(), this.iXL, null, str2, l);
          }
          AppMethodBeat.o(290275);
        }
