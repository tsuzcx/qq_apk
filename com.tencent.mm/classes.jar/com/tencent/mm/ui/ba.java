...
public final class ba
{
  public static Bitmap b(Bitmap paramBitmap, float paramFloat)
  {
    ...
    {
      bc.e("WeUIBitmapUtil", "getRoundedCornerBitmap in bitmap is null", new Object[0]);
      AppMethodBeat.o(159110);
      return null;
    }
    Bitmap localBitmap = g(paramBitmap.getWidth(), paramBitmap.getHeight(), Bitmap.Config.ARGB_8888);
    if (localBitmap == null)
    {
      AppMethodBeat.o(159110);
      return null;
    ...
    bc.i("WeUIBitmapUtil", "getRoundedCornerBitmap bitmap recycle %s", new Object[] { paramBitmap });
    paramBitmap.recycle();
    AppMethodBeat.o(159110);
    return localBitmap;
  }
