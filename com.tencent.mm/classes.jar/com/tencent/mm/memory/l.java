  ...
  extends k
{
  ...
  private static Bitmap b(java.io.InputStream paramInputStream, android.graphics.Rect paramRect, android.graphics.BitmapFactory.Options paramOptions)
  {
    ...
    //   5: getstatic 31	com/tencent/mm/memory/g:nNt	Lcom/tencent/mm/memory/g;
    //   8: invokevirtual 35	com/tencent/mm/memory/g:acquire	()Ljava/lang/Object;
    ...
    //   114: aload_0
    //   115: ifnull +11 -> 126
    //   118: getstatic 31	com/tencent/mm/memory/g:nNt	Lcom/tencent/mm/memory/g;
    //   121: aload_0
    //   122: invokevirtual 93	com/tencent/mm/memory/g:release	(Ljava/lang/Object;)Z
    //   125: pop
    //   126: ldc 19
    ...
    //   187: aload_0
    //   188: invokestatic 123	com/tencent/mm/memory/l:E	(Ljava/io/InputStream;)Ljava/io/InputStream;
    //   191: astore_0
    //   192: aload_0
    //   193: invokestatic 127	com/tencent/mm/memory/l:F	(Ljava/io/InputStream;)V
    //   196: aload_0
    //   197: aload_1
    //   198: aload 4
    //   200: invokestatic 130	com/tencent/mm/memory/l:c	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   203: astore_0
    //   204: aload_3
    //   205: ifnull +11 -> 216
    //   208: getstatic 31	com/tencent/mm/memory/g:nNt	Lcom/tencent/mm/memory/g;
    //   211: aload_3
    //   212: invokevirtual 93	com/tencent/mm/memory/g:release	(Ljava/lang/Object;)Z
    //   215: pop
    //   216: ldc 19
    ...
    //   226: aload_0
    //   227: ifnull +11 -> 238
    //   230: getstatic 31	com/tencent/mm/memory/g:nNt	Lcom/tencent/mm/memory/g;
    //   233: aload_0
    //   234: invokevirtual 93	com/tencent/mm/memory/g:release	(Ljava/lang/Object;)Z
    //   237: pop
    //   238: ldc 19
  ...
  private static Bitmap c(java.io.InputStream paramInputStream, android.graphics.Rect paramRect, android.graphics.BitmapFactory.Options paramOptions)
  {
    ...
    //   24: iload_3
    //   25: istore 5
    //   27: getstatic 143	com/tencent/mm/memory/f:nNs	Lcom/tencent/mm/memory/f;
    //   30: iload_3
    //   31: invokestatic 149	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   34: invokevirtual 153	com/tencent/mm/memory/f:g	(Ljava/lang/Integer;)Ljava/lang/Object;
    //   37: checkcast 154	[B
    //   40: astore 6
    //   42: aload 6
    ...
    //   110: aload 6
    //   112: ifnull +11 -> 123
    //   115: getstatic 143	com/tencent/mm/memory/f:nNs	Lcom/tencent/mm/memory/f;
    //   118: aload 6
    //   120: invokevirtual 176	com/tencent/mm/memory/f:as	([B)V
    //   123: ldc 131
    ...
    //   200: aload 6
    //   202: ifnull -49 -> 153
    //   205: getstatic 143	com/tencent/mm/memory/f:nNs	Lcom/tencent/mm/memory/f;
    //   208: aload 6
    //   210: invokevirtual 176	com/tencent/mm/memory/f:as	([B)V
    //   213: goto -60 -> 153
    //   216: astore_1
    //   217: aconst_null
    //   218: astore 7
    ...
    //   231: aload 7
    //   233: ifnull +11 -> 244
    //   236: getstatic 143	com/tencent/mm/memory/f:nNs	Lcom/tencent/mm/memory/f;
    //   239: aload 7
    //   241: invokevirtual 176	com/tencent/mm/memory/f:as	([B)V
    //   244: ldc 131
  ...
  public final Bitmap a(java.lang.String paramString, android.graphics.BitmapFactory.Options paramOptions)
  {
    ...
    //   2: invokestatic 25	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   5: aload_1
    //   6: invokestatic 211	com/tencent/mm/vfs/y:Lh	(Ljava/lang/String;)Ljava/io/InputStream;
    //   9: astore_3
    //   10: aload_3
    //   11: astore_1
    //   12: aload_3
    //   13: aconst_null
    //   14: aload_2
    //   15: invokestatic 213	com/tencent/mm/memory/l:b	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   18: astore_2
    //   19: aload_3
  ...
  public final Bitmap a(java.lang.String paramString, android.graphics.Rect paramRect, android.graphics.BitmapFactory.Options paramOptions)
  {
    ...
    //   16: aload_2
    //   17: aload_3
    //   18: invokestatic 213	com/tencent/mm/memory/l:b	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   21: astore_2
    //   22: aload 4
