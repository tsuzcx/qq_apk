  ...
  extends l
{
  ...
  private static Bitmap a(InputStream paramInputStream, BitmapFactory.Options paramOptions)
  {
    ...
    //   5: getstatic 26	com/tencent/mm/memory/h:hev	Lcom/tencent/mm/memory/h;
    ...
    //   29: aload_2
    //   30: ifnull +99 -> 129
    //   33: getstatic 26	com/tencent/mm/memory/h:hev	Lcom/tencent/mm/memory/h;
    //   36: aload_2
    ...
    //   65: aastore
    //   66: invokestatic 62	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   69: aload_0
    //   70: ifnull +54 -> 124
    //   73: getstatic 26	com/tencent/mm/memory/h:hev	Lcom/tencent/mm/memory/h;
    //   76: aload_0
    ...
    //   89: aload_0
    //   90: ifnull +11 -> 101
    //   93: getstatic 26	com/tencent/mm/memory/h:hev	Lcom/tencent/mm/memory/h;
    //   96: aload_0
  ...
  private static BitmapFactory.Options a(InputStream paramInputStream, BitmapFactory.Options paramOptions, ByteBuffer paramByteBuffer, boolean paramBoolean, Rect paramRect)
  {
    ...
    if (paramRect == null)
    {
      ac.i("MicroMsg.InBitmapFactory", "options.outWidth: %s, options.outHeight: %s, sampleSize: %s", new Object[] { Integer.valueOf(j), Integer.valueOf(i), Integer.valueOf(localOptions.inSampleSize) });
      if (!paramBoolean) {
        break label407;
      }
      paramOptions = (Bitmap)c.hen.d(c.e(Integer.valueOf(j * i)));
    ...
    {
      ac.i("MicroMsg.InBitmapFactory", "bitmapToReuse: %s, isRecycle: %s, isRegionDecode: %s, width: %s, height: %s", new Object[] { paramInputStream, Boolean.valueOf(bool), Boolean.valueOf(paramBoolean), Integer.valueOf(i), Integer.valueOf(j) });
      ...
      f.eUu();
      ac.i("MicroMsg.InBitmapFactory", "mimetype: %s", new Object[] { localOptions.outMimeType });
      AppMethodBeat.o(156429);
      return localOptions;
      j = paramRect.right - paramRect.left;
      i = paramRect.bottom - paramRect.top;
      ac.i("MicroMsg.InBitmapFactory", "region decode, width: %s, height: %s, rect: %s", new Object[] { Integer.valueOf(j), Integer.valueOf(i), paramRect });
      break;
      paramInputStream = c.hen.f(c.e(Integer.valueOf(i * j)));
      break label206;
      bool = false;
      break label220;
      i = 0;
  ...
  private static Bitmap b(InputStream paramInputStream, Rect paramRect, BitmapFactory.Options paramOptions)
  {
    ...
    for (;;)
    {
      try
      {
        localInputStream = r(paramInputStream);
        localObject1 = localObject3;
        s(localInputStream);
        localObject1 = localObject3;
      ...
      catch (Exception paramInputStream)
      {
        ...
        int m;
        int n;
        ac.e("MicroMsg.InBitmapFactory", "decodeInternal error: %s", new Object[] { paramInputStream.getMessage() });
        ...
        paramInputStream = b.a(localInputStream, paramRect, paramOptions);
        continue;
        continue;
      }
      try
      {
        ...
        localObject1 = paramInputStream;
        ac.i("MicroMsg.InBitmapFactory", "decode again");
        localObject1 = paramInputStream;
        s(localInputStream);
        localObject1 = paramInputStream;
      ...
      try
      {
        if (paramInputStream.getWidth() > paramRect.right - paramRect.left)
        {
          ...
          {
            ac.i("MicroMsg.InBitmapFactory", "fuck region decode size not match, clip it, reqWidth: %s, reqHeight: %s, resultWidth: %s, resultHeight: %s", new Object[] { Integer.valueOf(paramRect.right - paramRect.left), Integer.valueOf(paramRect.bottom - paramRect.top), Integer.valueOf(paramInputStream.getWidth()), Integer.valueOf(paramInputStream.getHeight()) });
            paramOptions = Bitmap.createBitmap(paramInputStream, 0, 0, paramRect.right - paramRect.left, paramRect.bottom - paramRect.top);
          }
        }
        if (paramOptions != null) {
          ac.i("MicroMsg.InBitmapFactory", "finish decode, decodedBitmap: %s, width: %s, height: %s", new Object[] { paramOptions, Integer.valueOf(paramOptions.getWidth()), Integer.valueOf(paramOptions.getHeight()) });
        }
      ...
      localObject1 = localObject3;
      ac.printErrStackTrace("MicroMsg.InBitmapFactory", paramInputStream, "decode with inBitmap error: %s, outWidth: %s, outHeight: %s, sampleSize: %s, reuseBitmapWidth: %s, reuseBitmapHeight: %s", new Object[] { str, Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(n), Integer.valueOf(i), Integer.valueOf(j) });
  ...
  public final Bitmap a(String paramString, BitmapFactory.Options paramOptions)
  {
    ...
    //   15: aload_3
    //   16: aload_2
    //   17: invokestatic 262	com/tencent/mm/memory/j:a	(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   20: astore_2
    //   21: aload_2
    //   22: astore_1
    //   23: aload_3
    //   24: invokestatic 267	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   27: ldc 254
    ...
    //   54: aastore
    //   55: invokestatic 245	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   58: aload_3
    //   59: invokestatic 267	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   62: aload 4
    //   64: astore_1
    //   65: goto -38 -> 27
    //   68: astore_2
    ...
    //   70: astore_1
    //   71: aload_1
    //   72: invokestatic 267	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   75: ldc 254
  ...
  public final Bitmap a(String paramString, Rect paramRect, BitmapFactory.Options paramOptions)
  {
    ...
    //   10: astore_1
    //   11: getstatic 26	com/tencent/mm/memory/h:hev	Lcom/tencent/mm/memory/h;
    ...
    //   37: aload 4
    //   39: ifnull +12 -> 51
    //   42: getstatic 26	com/tencent/mm/memory/h:hev	Lcom/tencent/mm/memory/h;
    //   45: aload 4
    //   47: invokevirtual 43	com/tencent/mm/memory/h:release	(Ljava/lang/Object;)Z
    //   50: pop
    //   51: aload_1
    //   52: invokestatic 267	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   55: aload_2
    //   56: astore_1
    //   57: ldc_w 269
    ...
    //   84: aastore
    //   85: invokestatic 62	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   88: aload_1
    //   89: ifnull +11 -> 100
    //   92: getstatic 26	com/tencent/mm/memory/h:hev	Lcom/tencent/mm/memory/h;
    //   95: aload_1
    //   96: invokevirtual 43	com/tencent/mm/memory/h:release	(Ljava/lang/Object;)Z
    //   99: pop
    //   100: aload_3
    //   101: invokestatic 267	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   104: aconst_null
    //   105: astore_1
    //   106: goto -49 -> 57
    //   109: astore_2
    ...
    //   114: aload_1
    //   115: ifnull +11 -> 126
    //   118: getstatic 26	com/tencent/mm/memory/h:hev	Lcom/tencent/mm/memory/h;
    //   121: aload_1
    //   122: invokevirtual 43	com/tencent/mm/memory/h:release	(Ljava/lang/Object;)Z
    //   125: pop
    //   126: aload_3
    //   127: invokestatic 267	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   130: ldc_w 269
