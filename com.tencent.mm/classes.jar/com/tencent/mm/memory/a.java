  ...
  extends e<T, Integer>
{
  public T d(Integer paramInteger)
  {
    ...
    for (;;)
    {
      try
      {
        paramInteger = this.itu.subMap(paramInteger, true, Integer.valueOf(2147483647), true);
        if ((paramInteger != null) && (!paramInteger.isEmpty()))
        {
          ...
          this.itu.put(locald.aRS(), locald);
  ...
  public T e(Integer paramInteger)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 22	com/tencent/mm/memory/a:itu	Ljava/util/NavigableMap;
    //   6: aload_1
    ...
    //   31: astore_1
    //   32: aload_0
    //   33: getfield 22	com/tencent/mm/memory/a:itu	Ljava/util/NavigableMap;
    //   36: aload_3
    //   37: invokevirtual 75	com/tencent/mm/memory/d:aRS	()Ljava/lang/Object;
    //   40: aload_3
    ...
    //   53: invokevirtual 87	com/tencent/mm/memory/a:zZ	(J)V
    //   56: aload_0
    //   57: monitorexit
    //   58: aload_1
    //   59: areturn
    ...
    //   84: aastore
    //   85: invokestatic 101	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   88: aconst_null
    //   89: astore_1
    //   90: goto -34 -> 56
    //   93: aload_3
    //   94: getfield 105	com/tencent/mm/memory/d:its	Ljava/util/Queue;
    //   97: ifnonnull +8 -> 105
    //   100: iconst_m1
    //   101: istore_2
    //   102: goto -36 -> 66
    //   105: aload_3
    //   106: getfield 105	com/tencent/mm/memory/d:its	Ljava/util/Queue;
