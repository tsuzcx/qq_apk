...
public final class q
{
  ...
  private static void IS()
  {
    ...
    try
    {
      String str = ((a)g.ab(a.class)).Zd().getValue("BizEnableWebpUrl");
      ad.i("MicroMsg.WebpUtil", "initCdnUrlList, urllist: %s", new Object[] { str });
      if (!bt.isNullOrNil(str))
      {
        cHZ = str.split(";");
        ad.d("MicroMsg.WebpUtil", "initCdnUrlList, CDN_URL_LIST.length: %d", new Object[] { Integer.valueOf(cHZ.length) });
      }
  ...
  public static boolean ayM()
  {
    ...
    if ((Build.VERSION.SDK_INT >= 14) && (cHZ != null) && (cHZ.length > 0) && (ae.fFH.fCV == 1))
    {
  ...
  public static String ol(int paramInt)
  {
    ...
    String str = String.format("System=android-%d,ClientVersion=%d,NetworkType=%d,Scene=%d", new Object[] { Integer.valueOf(Build.VERSION.SDK_INT), Integer.valueOf(paramInt), Integer.valueOf(ayN()), Integer.valueOf(2) });
    AppMethodBeat.o(150778);
    return str;
  }
  
  public static String om(int paramInt)
  {
    AppMethodBeat.i(150779);
    String str = String.format("System=android-%d,ClientVersion=%d,NetworkType=%d,Scene=%d", new Object[] { Integer.valueOf(Build.VERSION.SDK_INT), Integer.valueOf(paramInt), Integer.valueOf(ayN()), Integer.valueOf(1) });
