...
{
  public static Executor ayQ()
  {
    AppMethodBeat.i(182800);
    b localb = h.Iye.aNX("image_loader_ImageTempFile");
    AppMethodBeat.o(182800);
    return localb;
  }
  
  public static j on(int paramInt)
  {
    AppMethodBeat.i(182799);
    a locala = new a("image_loader_default", paramInt, paramInt, new com.tencent.mm.aw.a.e.a());
    ...
    implements j
  {
    ...
    private Condition glo;
    private BlockingQueue<Runnable> glp;
    ...
    public a(String paramString, int paramInt1, int paramInt2, BlockingQueue<Runnable> paramBlockingQueue)
    {
      ...
      this.glo = this.gln.newCondition();
      this.glp = paramBlockingQueue;
    ...
    public final void beforeExecute(java.lang.Thread paramThread, Runnable paramRunnable)
    {
      ...
      //   11: aload_0
      //   12: getfield 37	com/tencent/mm/aw/a/a/a$a:gln	Ljava/util/concurrent/locks/ReentrantLock;
      //   15: invokevirtual 70	java/util/concurrent/locks/ReentrantLock:lock	()V
      //   18: aload_0
      //   19: getfield 55	com/tencent/mm/aw/a/a/a$a:isPaused	Z
      //   22: ifeq +51 -> 73
      //   25: aload_0
      //   26: getfield 43	com/tencent/mm/aw/a/a/a$a:glo	Ljava/util/concurrent/locks/Condition;
      ...
      //   56: aastore
      //   57: invokestatic 96	com/tencent/mm/sdk/platformtools/ad:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   60: aload_0
      //   61: getfield 37	com/tencent/mm/aw/a/a/a$a:gln	Ljava/util/concurrent/locks/ReentrantLock;
      ...
      //   72: return
      //   73: aload_0
      //   74: getfield 37	com/tencent/mm/aw/a/a/a$a:gln	Ljava/util/concurrent/locks/ReentrantLock;
      ...
      //   86: astore_1
      //   87: aload_0
      //   88: getfield 37	com/tencent/mm/aw/a/a/a$a:gln	Ljava/util/concurrent/locks/ReentrantLock;
 ...
 * Qualified Name:     com.tencent.mm.aw.a.a.a
