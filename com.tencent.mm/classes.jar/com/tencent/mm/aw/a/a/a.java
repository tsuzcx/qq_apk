...
{
  public static Executor aIQ()
  {
    AppMethodBeat.i(182800);
    b localb = h.LTJ.aZA("image_loader_ImageTempFile");
    AppMethodBeat.o(182800);
    return localb;
  }
  
  public static j pE(int paramInt)
  {
  ...
  static final class a
    ...
    implements j
  {
    private ReentrantLock hfX;
    private Condition hfY;
    ...
    public a(String paramString, int paramInt1, int paramInt2, BlockingQueue<Runnable> paramBlockingQueue)
    {
      ...
      this.hfX = new ReentrantLock();
      this.hfY = this.hfX.newCondition();
    ...
    public final void beforeExecute(java.lang.Thread paramThread, Runnable paramRunnable)
    {
      ...
      //   11: aload_0
      //   12: getfield 37	com/tencent/mm/aw/a/a/a$a:hfX	Ljava/util/concurrent/locks/ReentrantLock;
      //   15: invokevirtual 70	java/util/concurrent/locks/ReentrantLock:lock	()V
      //   18: aload_0
      //   19: getfield 55	com/tencent/mm/aw/a/a/a$a:isPaused	Z
      //   22: ifeq +51 -> 73
      //   25: aload_0
      //   26: getfield 43	com/tencent/mm/aw/a/a/a$a:hfY	Ljava/util/concurrent/locks/Condition;
      ...
      //   60: aload_0
      //   61: getfield 37	com/tencent/mm/aw/a/a/a$a:hfX	Ljava/util/concurrent/locks/ReentrantLock;
      ...
      //   72: return
      //   73: aload_0
      //   74: getfield 37	com/tencent/mm/aw/a/a/a$a:hfX	Ljava/util/concurrent/locks/ReentrantLock;
      ...
      //   86: astore_1
      //   87: aload_0
      //   88: getfield 37	com/tencent/mm/aw/a/a/a$a:hfX	Ljava/util/concurrent/locks/ReentrantLock;
