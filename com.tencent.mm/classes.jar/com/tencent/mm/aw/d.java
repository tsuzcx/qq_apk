  ...
  implements be
{
  ...
  private static d blA()
  {
    AppMethodBeat.i(20534);
    bh.beC();
    a locala = (a)ch.RZ("plugin.subapp");
    d locald;
    if (locala == null)
    {
      locald = null;
    ...
    for (;;)
    {
      ...
      return locald;
      locald = (d)locala.bdM(d.class.getName());
      break;
    }
  }
  ...
  public static b blB()
  {
    ...
    if (blA().lMZ == null)
    {
      localObject = blA();
      bh.beI();
      ((d)localObject).lMZ = new b(com.tencent.mm.model.c.getDataDB());
    }
    Object localObject = blA().lMZ;
  ...
  public void onAccountPostReset(boolean paramBoolean)
  {
    ...
    if (this.lNa == null) {
      this.lNa = new af(new c());
    }
    com.tencent.mm.model.az.a.ltq = this.lNa;
    Log.i("SubCoreGetContact", "summergetcontac onAccountPostReset setGetContact[%s]", new Object[] { this.lNa });
