  ...
  implements c.c
{
  ...
  public p()
  {
    ...
    this.hjo = new LinkedList();
    this.hjp = null;
    this.hjq = false;
    AppMethodBeat.o(150764);
  }
  
  static String yr(String paramString)
  {
  ...
  public final void a(Bitmap paramBitmap, byte[] paramArrayOfByte)
  {
    ...
    if (paramBitmap == null)
    {
      ad.e("MicroMsg.UrlImageCacheService", "load from url failed: " + this.hjp.url);
      this.hjp = null;
      ayL();
      AppMethodBeat.o(150770);
      return;
    }
    ad.i("MicroMsg.UrlImageCacheService", "load from %s successed", new Object[] { this.hjp.url });
    boolean bool;
    if ((!bt.isNullOrNil(this.hjp.md5)) && (paramArrayOfByte != null))
    {
      paramArrayOfByte = g.getMessageDigest(paramArrayOfByte);
      if (!bt.kU(paramArrayOfByte, this.hjp.md5))
      {
        bool = false;
        ad.i("MicroMsg.UrlImageCacheService", "orgmd5:%s newmd5:%s checkReuslt:%s", new Object[] { this.hjp.md5, paramArrayOfByte, Boolean.valueOf(bool) });
      }
    }
    for (;;)
    {
      if (bool)
      {
        paramArrayOfByte = yr(this.hjp.url);
        new AsyncTask()new b
        {
        ...
        {
          o.ayE();
          c.h(this.hjp.url, paramBitmap);
          this.hjp.hjs.a(this.hjp.url, paramBitmap, paramArrayOfByte);
        }
      }
      for (;;)
      {
        ...
        return;
        if (!this.hjq) {
          this.hjp.hjs.a(this.hjp.url, null, "");
        }
      }
      bool = true;
      break;
  ...
  public final void a(String paramString1, String paramString2, a parama)
  {
    ...
    if ((this.hjp != null) && (this.hjp.url.equals(paramString1)) && (this.hjp.hjs == parama))
    {
      ad.e("MicroMsg.UrlImageCacheService", "url and callback is loading");
      AppMethodBeat.o(150766);
      return;
    }
    Iterator localIterator = this.hjo.iterator();
    while (localIterator.hasNext())
    {
      c localc = (c)localIterator.next();
      if ((localc.url.equals(paramString1)) && (localc.hjs == parama))
      {
        ad.e("MicroMsg.UrlImageCacheService", "url and callback is loading");
        AppMethodBeat.o(150766);
        return;
    ...
    this.hjo.add(new c(paramString1, paramString2, parama));
    ayL();
    AppMethodBeat.o(150766);
  }
  ...
  final void ayL()
  {
    ...
    for (;;)
    {
      if ((this.hjp != null) || (this.hjo.size() == 0))
      {
        ad.d("MicroMsg.UrlImageCacheService", "task is downing or no more task");
        AppMethodBeat.o(150768);
        return;
      }
      this.hjp = ((c)this.hjo.get(0));
      this.hjo.remove(0);
      this.hjq = false;
      o.ayE();
      Bitmap localBitmap = c.pT(this.hjp.url);
      if (localBitmap == null) {
        break;
      }
      ad.d("MicroMsg.UrlImageCacheService", "find bitmap in cache of " + this.hjp.url);
      if (!this.hjq) {
        this.hjp.hjs.a(this.hjp.url, localBitmap, yr(this.hjp.url));
      }
      this.hjp = null;
    }
    new AsyncTask() {}.execute(new String[] { this.hjp.url });
    AppMethodBeat.o(150768);
  }
  ...
  public final void b(String paramString, a parama)
  {
    ...
    if ((this.hjp != null) && (this.hjp.url.equals(paramString)) && (this.hjp.hjs == parama))
    {
      this.hjq = true;
