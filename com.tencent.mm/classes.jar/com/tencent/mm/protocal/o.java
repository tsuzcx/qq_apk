...
public final class o
{
  ...
  {
    this.type = paramInt1;
    this.KbS = paramString1;
    this.port = paramInt2;
    this.host = paramString2;
  }
  
  private static o bsl(String paramString)
  {
    ...
    try
    {
      ...
      localo.KbS = Util.nullAsNil(paramString[1]);
  ...
  public static List<o> bsm(String paramString)
  {
  ...
  public static String mD(List<o> paramList)
  {
  ...
  public static a pw(String paramString1, String paramString2)
  {
  ...
  public final String toString()
  {
    ...
    String str = this.type + "," + this.KbS + "," + this.port + "," + this.host;
