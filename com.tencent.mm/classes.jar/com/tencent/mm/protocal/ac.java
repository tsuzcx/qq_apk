...
public final class ac
{
  ...
  public static void am(String paramString1, String paramString2, int paramInt)
  {
    ...
    ae.d("MicroMsg.RsaInfo", "summercert dkcert saveRsaInfo ver:%d keye:%s keyn:%s  ", new Object[] { Integer.valueOf(paramInt), paramString1, paramString2 });
    SharedPreferences.Editor localEditor = ak.getContext().getSharedPreferences("rsa_public_key_prefs", g.abv()).edit();
    localEditor.putString("keye", paramString1);
    localEditor.putString("keyn", paramString2);
    localEditor.putInt("version", paramInt);
    localEditor.putInt("client_version", d.FFH);
    localEditor.commit();
    AppMethodBeat.o(133132);
  }
  
  public static ac fkn()
  {
    AppMethodBeat.i(133133);
    Object localObject = ak.getContext().getSharedPreferences("rsa_public_key_prefs", g.abv());
  ...
  public static boolean fkr()
  {
    ...
    //   7: new 189	com/tencent/mm/vfs/r
    //   10: dup
    //   11: new 154	java/lang/StringBuilder
    //   14: dup
    //   15: invokespecial 155	java/lang/StringBuilder:<init>	()V
    //   18: invokestatic 194	com/tencent/mm/loader/j/b:asj	()Ljava/lang/String;
    ...
    //   32: invokespecial 199	com/tencent/mm/vfs/r:<init>	(Ljava/lang/String;)V
    //   35: astore_3
    //   36: aload_3
    //   37: astore_2
    //   38: aload_3
    //   39: ldc 201
    //   41: invokevirtual 204	com/tencent/mm/vfs/r:write	(Ljava/lang/String;)V
    //   44: aload_3
    //   45: astore_2
    //   46: aload_3
    ...
    //   56: getstatic 212	com/tencent/mm/sdk/platformtools/j:hju	Ljava/lang/String;
    ...
    //   70: invokevirtual 204	com/tencent/mm/vfs/r:write	(Ljava/lang/String;)V
    //   73: aload_3
    //   74: astore_2
    //   75: aload_3
    ...
    //   115: invokevirtual 204	com/tencent/mm/vfs/r:write	(Ljava/lang/String;)V
    //   118: aload_3
    //   119: astore_2
    //   120: aload_3
    //   121: ldc 232
    //   123: invokevirtual 204	com/tencent/mm/vfs/r:write	(Ljava/lang/String;)V
    //   126: aload_3
    //   127: astore_2
    //   128: aload_3
    //   129: ldc 234
    //   131: invokevirtual 204	com/tencent/mm/vfs/r:write	(Ljava/lang/String;)V
    //   134: aload_3
    //   135: astore_2
    //   136: aload_3
    //   137: ldc 236
    //   139: invokevirtual 204	com/tencent/mm/vfs/r:write	(Ljava/lang/String;)V
    //   142: aload_3
    //   143: astore_2
    //   144: aload_3
    //   145: ldc 238
    //   147: invokevirtual 204	com/tencent/mm/vfs/r:write	(Ljava/lang/String;)V
    //   150: aload_3
    //   151: astore_2
    //   152: aload_3
    //   153: ldc 240
    //   155: invokevirtual 204	com/tencent/mm/vfs/r:write	(Ljava/lang/String;)V
    //   158: aload_3
    //   159: astore_2
    //   160: aload_3
    //   161: ldc 242
    //   163: invokevirtual 204	com/tencent/mm/vfs/r:write	(Ljava/lang/String;)V
    //   166: aload_3
    //   167: astore_2
    //   168: aload_3
    //   169: ldc 244
    //   171: invokevirtual 204	com/tencent/mm/vfs/r:write	(Ljava/lang/String;)V
    //   174: iconst_1
    //   175: istore_0
    //   176: aload_3
    //   177: invokevirtual 247	com/tencent/mm/vfs/r:close	()V
    //   180: ldc 187
    ...
    //   203: invokestatic 251	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   206: iload_1
    //   207: istore_0
    //   208: aload_3
    //   209: ifnull -29 -> 180
    //   212: aload_3
    //   213: invokevirtual 247	com/tencent/mm/vfs/r:close	()V
    //   216: iload_1
    //   217: istore_0
    //   218: goto -38 -> 180
    //   221: astore_2
    ...
    //   231: ifnull +7 -> 238
    //   234: aload_2
    //   235: invokevirtual 247	com/tencent/mm/vfs/r:close	()V
    //   238: ldc 187
    ...
    //   37	156	2	localr1	com.tencent.mm.vfs.r
    ...
    //   35	178	3	localr2	com.tencent.mm.vfs.r
  ...
  public final boolean fkq()
  {
    ...
    if ((this.ver == 0) || (bu.isNullOrNil(this.FHi)) || (bu.isNullOrNil(this.FHj)))
    {
