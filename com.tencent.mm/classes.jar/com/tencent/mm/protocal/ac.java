...
public final class ac
{
  ...
  public static void ag(String paramString1, String paramString2, int paramInt)
  {
    ...
    com.tencent.mm.sdk.platformtools.ac.d("MicroMsg.RsaInfo", "summercert dkcert saveRsaInfo ver:%d keye:%s keyn:%s  ", new Object[] { Integer.valueOf(paramInt), paramString1, paramString2 });
    SharedPreferences.Editor localEditor = ai.getContext().getSharedPreferences("rsa_public_key_prefs", g.YK()).edit();
    localEditor.putString("keye", paramString1);
    localEditor.putString("keyn", paramString2);
    localEditor.putInt("version", paramInt);
    localEditor.putInt("client_version", d.DIc);
    localEditor.commit();
    AppMethodBeat.o(133132);
  }
  
  public static ac eRt()
  {
    AppMethodBeat.i(133133);
    Object localObject = ai.getContext().getSharedPreferences("rsa_public_key_prefs", g.YK());
  ...
  public static boolean eRx()
  {
    ...
    //   18: invokestatic 194	com/tencent/mm/loader/j/b:aph	()Ljava/lang/String;
    ...
    //   56: getstatic 212	com/tencent/mm/sdk/platformtools/h:gMJ	Ljava/lang/String;
    ...
    //   203: invokestatic 251	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   206: iload_1
    //   207: istore_0
    //   208: aload_3
    //   209: ifnull -29 -> 180
  ...
  public final boolean eRw()
  {
    ...
    if ((this.ver == 0) || (bs.isNullOrNil(this.DJD)) || (bs.isNullOrNil(this.DJE)))
    {
