...
public final class ac
{
  ...
  {
    this.FoK = paramString1;
    this.FoL = paramString2;
    this.ver = paramInt;
  }
  
  public static void ak(String paramString1, String paramString2, int paramInt)
  {
    ...
    SharedPreferences.Editor localEditor = aj.getContext().getSharedPreferences("rsa_public_key_prefs", g.abm()).edit();
    localEditor.putString("keye", paramString1);
    localEditor.putString("keyn", paramString2);
    localEditor.putInt("version", paramInt);
    localEditor.putInt("client_version", d.Fnj);
    localEditor.commit();
  ...
  public static boolean fgB()
  {
    ...
    //   7: new 107	com/tencent/mm/vfs/l
    //   10: dup
    //   11: new 109	java/lang/StringBuilder
    //   14: dup
    //   15: invokespecial 110	java/lang/StringBuilder:<init>	()V
    //   18: invokestatic 116	com/tencent/mm/loader/j/b:arU	()Ljava/lang/String;
    ...
    //   29: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   32: invokespecial 128	com/tencent/mm/vfs/l:<init>	(Ljava/lang/String;)V
    //   35: astore_3
    //   36: aload_3
    //   37: astore_2
    //   38: aload_3
    //   39: ldc 130
    //   41: invokevirtual 133	com/tencent/mm/vfs/l:write	(Ljava/lang/String;)V
    //   44: aload_3
    //   45: astore_2
    //   46: aload_3
    //   47: new 109	java/lang/StringBuilder
    //   50: dup
    //   51: ldc 135
    //   53: invokespecial 136	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   56: getstatic 141	com/tencent/mm/sdk/platformtools/i:hgG	Ljava/lang/String;
    ...
    //   70: invokevirtual 133	com/tencent/mm/vfs/l:write	(Ljava/lang/String;)V
    //   73: aload_3
    //   74: astore_2
    //   75: aload_3
    ...
    //   79: dup
    //   80: ldc 145
    //   82: invokespecial 136	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   85: new 147	java/text/SimpleDateFormat
    //   88: dup
    //   89: ldc 149
    //   91: invokespecial 150	java/text/SimpleDateFormat:<init>	(Ljava/lang/String;)V
    //   94: new 152	java/util/Date
    //   97: dup
    //   98: invokespecial 153	java/util/Date:<init>	()V
    //   101: invokevirtual 157	java/text/SimpleDateFormat:format	(Ljava/util/Date;)Ljava/lang/String;
    ...
    //   115: invokevirtual 133	com/tencent/mm/vfs/l:write	(Ljava/lang/String;)V
    //   118: aload_3
    //   119: astore_2
    //   120: aload_3
    //   121: ldc 161
    //   123: invokevirtual 133	com/tencent/mm/vfs/l:write	(Ljava/lang/String;)V
    //   126: aload_3
    //   127: astore_2
    //   128: aload_3
    //   129: ldc 163
    //   131: invokevirtual 133	com/tencent/mm/vfs/l:write	(Ljava/lang/String;)V
    //   134: aload_3
    //   135: astore_2
    //   136: aload_3
    //   137: ldc 165
    //   139: invokevirtual 133	com/tencent/mm/vfs/l:write	(Ljava/lang/String;)V
    //   142: aload_3
    //   143: astore_2
    //   144: aload_3
    //   145: ldc 167
    //   147: invokevirtual 133	com/tencent/mm/vfs/l:write	(Ljava/lang/String;)V
    //   150: aload_3
    //   151: astore_2
    //   152: aload_3
    //   153: ldc 169
    //   155: invokevirtual 133	com/tencent/mm/vfs/l:write	(Ljava/lang/String;)V
    //   158: aload_3
    //   159: astore_2
    //   160: aload_3
    //   161: ldc 171
    //   163: invokevirtual 133	com/tencent/mm/vfs/l:write	(Ljava/lang/String;)V
    //   166: aload_3
    //   167: astore_2
    //   168: aload_3
    //   169: ldc 173
    //   171: invokevirtual 133	com/tencent/mm/vfs/l:write	(Ljava/lang/String;)V
    //   174: iconst_1
    //   175: istore_0
    //   176: aload_3
    //   177: invokevirtual 176	com/tencent/mm/vfs/l:close	()V
    //   180: ldc 105
    ...
    //   203: invokestatic 182	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   206: iload_1
    //   207: istore_0
    //   208: aload_3
    //   209: ifnull -29 -> 180
    //   212: aload_3
    //   213: invokevirtual 176	com/tencent/mm/vfs/l:close	()V
    //   216: iload_1
    //   217: istore_0
    //   218: goto -38 -> 180
    //   221: astore_2
    ...
    //   231: ifnull +7 -> 238
    //   234: aload_2
    //   235: invokevirtual 176	com/tencent/mm/vfs/l:close	()V
    //   238: ldc 105
  ...
  public static ac fgx()
  {
    AppMethodBeat.i(133133);
    Object localObject = aj.getContext().getSharedPreferences("rsa_public_key_prefs", g.abm());
    ...
    if (!localac.fgA())
    {
      ...
      e.ygI.idkeyStat(148L, 38L, 1L, false);
      ad.i("MicroMsg.RsaInfo", "summercert clear old rsa lastClientVer[%d] nowVer[%d], commit[%b]", new Object[] { Integer.valueOf(i), Integer.valueOf(d.Fnj), Boolean.valueOf(bool) });
    }
    e.ygI.idkeyStat(148L, 39L, 1L, false);
  ...
  public final boolean fgA()
  {
    ...
    if ((this.ver == 0) || (bt.isNullOrNil(this.FoK)) || (bt.isNullOrNil(this.FoL)))
    {
