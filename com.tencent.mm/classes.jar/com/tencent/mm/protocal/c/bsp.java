  ...
  extends blm
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.tJe != null)
      {
        paramVarArgs.gD(4, this.tJe.btq());
        this.tJe.a(paramVarArgs);
      }
      paramVarArgs.gB(5, this.swS);
      if (this.tJg != null)
      {
        paramVarArgs.gD(6, this.tJg.btq());
    ...
    for (int i = d.a.a.a.gA(1, this.tEX.btq()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.tJe != null) {
        paramInt = i + d.a.a.a.gA(4, this.tJe.btq());
      }
      i = paramInt + d.a.a.a.gy(5, this.swS);
      paramInt = i;
      if (this.tJg != null) {
        paramInt = i + d.a.a.a.gA(6, this.tJg.btq());
      }
      return paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localbsp.tJf = ((bsy)localObject1);
            paramInt += 1;
          }
        case 3: 
          localbsp.nde = ((d.a.a.a.a)localObject1).xpH.readString();
          return 0;
        case 4: 
          paramVarArgs = ((d.a.a.a.a)localObject1).KN(paramInt);
          i = paramVarArgs.size();
          ...
          while (paramInt < i)
          {
            ...
            localbsp.tJe = ((bml)localObject1);
            paramInt += 1;
          }
        case 5: 
          localbsp.swS = ((d.a.a.a.a)localObject1).xpH.oD();
          return 0;
        }
        paramVarArgs = ((d.a.a.a.a)localObject1).KN(paramInt);
        i = paramVarArgs.size();
 ...
 * Qualified Name:     com.tencent.mm.protocal.c.bsp
