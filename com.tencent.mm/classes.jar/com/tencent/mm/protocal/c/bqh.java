  ...
  extends bly
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.sCR != null)
      {
        paramVarArgs.gD(3, this.sCR.btq());
    ...
    for (int i = d.a.a.a.gA(1, this.tFx.btq()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.sCR != null) {
        i = paramInt + d.a.a.a.gA(3, this.sCR.btq());
      }
      return i;
      if (paramInt == 2)
      {
 ...
 * Qualified Name:     com.tencent.mm.protocal.c.bqh
