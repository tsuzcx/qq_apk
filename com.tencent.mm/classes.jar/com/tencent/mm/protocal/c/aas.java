  ...
  extends bly
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.tar != null)
      {
        paramVarArgs.gD(2, this.tar.btq());
    ...
    for (paramInt = d.a.a.a.gA(1, this.tFx.btq()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.tar != null) {
        i = paramInt + d.a.a.a.gA(2, this.tar.btq());
      }
      return i;
      if (paramInt == 2)
      {
 ...
 * Qualified Name:     com.tencent.mm.protocal.c.aas
