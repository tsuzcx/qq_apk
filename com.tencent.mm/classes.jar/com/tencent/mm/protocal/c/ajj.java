  ...
  extends bly
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.tfY != null)
      {
        paramVarArgs.gD(3, this.tfY.btq());
        this.tfY.a(paramVarArgs);
      }
      if (this.tfZ != null)
      {
        paramVarArgs.gD(4, this.tfZ.btq());
    ...
    for (int i = d.a.a.a.gA(1, this.tFx.btq()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.tfX != null) {
        paramInt = i + d.a.a.a.gA(2, this.tfX.btq());
      }
      i = paramInt;
      if (this.tfY != null) {
        i = paramInt + d.a.a.a.gA(3, this.tfY.btq());
      }
      paramInt = i;
      if (this.tfZ != null) {
        paramInt = i + d.a.a.a.gA(4, this.tfZ.btq());
      }
      return paramInt;
      if (paramInt == 2)
      {
 ...
 * Qualified Name:     com.tencent.mm.protocal.c.ajj
