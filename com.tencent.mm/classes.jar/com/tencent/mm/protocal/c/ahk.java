  ...
  extends bly
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.tcF != null)
      {
        paramVarArgs.gD(2, this.tcF.btq());
    ...
    for (paramInt = d.a.a.a.gA(1, this.tFx.btq()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.tcF != null) {
        i = paramInt + d.a.a.a.gA(2, this.tcF.btq());
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localahk.tcF = ((bya)localObject1);
            paramInt += 1;
          }
        case 3: 
          localahk.ino = ((d.a.a.a.a)localObject1).xpH.oD();
          return 0;
        }
        localahk.inp = ((d.a.a.a.a)localObject1).xpH.readString();
        return 0;
      }
      return -1;
    }
 ...
 * Qualified Name:     com.tencent.mm.protocal.c.ahk
