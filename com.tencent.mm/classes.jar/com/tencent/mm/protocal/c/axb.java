  ...
  extends com.tencent.mm.bv.a
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.svp != null)
      {
        paramVarArgs.gD(1, this.svp.btq());
    ...
    label344:
    for (paramInt = d.a.a.a.gA(1, this.svp.btq()) + 0;; paramInt = 0)
    {
      return paramInt + d.a.a.a.gy(2, this.hQq);
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localaxb.svp = ((bml)localObject1);
            paramInt += 1;
          }
        }
        localaxb.hQq = ((d.a.a.a.a)localObject1).xpH.oD();
        return 0;
      }
      return -1;
    }
 ...
 * Qualified Name:     com.tencent.mm.protocal.c.axb
