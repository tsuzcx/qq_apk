  ...
  extends blm
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.tna != null)
      {
        paramVarArgs.gD(4, this.tna.btq());
    ...
    for (paramInt = d.a.a.a.gA(1, this.tEX.btq()) + 0;; paramInt = 0)
    {
      ...
      i += d.a.a.a.gy(3, this.tmZ);
      paramInt = i;
      if (this.tna != null) {
        paramInt = i + d.a.a.a.gA(4, this.tna.btq());
      }
      return paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localarv.tEX = ((gc)localObject1);
            paramInt += 1;
          }
        case 2: 
          localarv.euK = ((d.a.a.a.a)localObject1).xpH.readString();
          return 0;
        case 3: 
          localarv.tmZ = ((d.a.a.a.a)localObject1).xpH.oD();
          return 0;
        }
        paramVarArgs = ((d.a.a.a.a)localObject1).KN(paramInt);
        i = paramVarArgs.size();
 ...
 * Qualified Name:     com.tencent.mm.protocal.c.arv
