  ...
  extends com.tencent.mm.bv.a
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.ttn != null)
      {
        paramVarArgs.gD(2, this.ttn.btq());
        this.ttn.a(paramVarArgs);
      }
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = d.a.a.a.gA(1, this.svp.btq()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.ttn != null) {
        i = paramInt + d.a.a.a.gA(2, this.ttn.btq());
      }
      return i;
      if (paramInt == 2)
      {
 ...
 * Qualified Name:     com.tencent.mm.protocal.c.axc
