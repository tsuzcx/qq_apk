  ...
  extends blm
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.swr != null)
      {
        paramVarArgs.gD(3, this.swr.btq());
    ...
    for (paramInt = d.a.a.a.gA(1, this.tEX.btq()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.swr != null) {
        paramInt = i + d.a.a.a.gA(3, this.swr.btq());
      }
      return paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdc.tEX = ((gc)localObject1);
            paramInt += 1;
          }
        case 2: 
          localdc.hQR = ((d.a.a.a.a)localObject1).xpH.oD();
          return 0;
        }
        paramVarArgs = ((d.a.a.a.a)localObject1).KN(paramInt);
        i = paramVarArgs.size();
