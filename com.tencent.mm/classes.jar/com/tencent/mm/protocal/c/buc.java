  ...
  extends com.tencent.mm.bv.a
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.tKN != null)
      {
        paramVarArgs.gD(2, this.tKN.btq());
    ...
    for (paramInt = d.a.a.a.gA(1, this.tJi.btq()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.tKN != null) {
        i = paramInt + d.a.a.a.gA(2, this.tKN.btq());
      }
      return i;
      if (paramInt == 2)
      {
 ...
 * Qualified Name:     com.tencent.mm.protocal.c.buc
