  ...
  extends bly
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.srs != null) {
        paramVarArgs.d(5, this.srs);
      }
      if (this.sry != null)
      {
        paramVarArgs.gD(6, this.sry.btq());
    ...
    for (paramInt = d.a.a.a.gA(1, this.tFx.btq()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.srs != null) {
        paramInt = i + d.a.a.b.b.a.e(5, this.srs);
      }
      i = paramInt;
      if (this.sry != null) {
        i = paramInt + d.a.a.a.gA(6, this.sry.btq());
      }
      return i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localg.tFx = ((gd)localObject1);
            paramInt += 1;
          }
        case 2: 
          localg.iHq = ((d.a.a.a.a)localObject1).xpH.oD();
          return 0;
        case 3: 
          localg.iHr = ((d.a.a.a.a)localObject1).xpH.readString();
          return 0;
        case 4: 
          localg.srq = ((d.a.a.a.a)localObject1).xpH.readString();
          return 0;
        case 5: 
          localg.srs = ((d.a.a.a.a)localObject1).xpH.readString();
          return 0;
        }
        paramVarArgs = ((d.a.a.a.a)localObject1).KN(paramInt);
        i = paramVarArgs.size();
