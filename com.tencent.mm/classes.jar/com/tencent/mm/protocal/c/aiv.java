  ...
  extends bly
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.ssE != null)
      {
        paramVarArgs.gD(2, this.ssE.btq());
    ...
    for (paramInt = d.a.a.a.gA(1, this.tFx.btq()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.ssE != null) {
        i = paramInt + d.a.a.a.gA(2, this.ssE.btq());
      }
      return i;
      if (paramInt == 2)
      {
 ...
 * Qualified Name:     com.tencent.mm.protocal.c.aiv
