  ...
  extends bly
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.tGK != null)
      {
        paramVarArgs.gD(2, this.tGK.btq());
        this.tGK.a(paramVarArgs);
      }
      if (this.url != null) {
    ...
    for (int i = d.a.a.a.gA(1, this.tFx.btq()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.tGK != null) {
        paramInt = i + d.a.a.a.gA(2, this.tGK.btq());
      }
      i = paramInt;
      if (this.url != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localbod.tGK = ((bob)localObject1);
            paramInt += 1;
          }
        }
        localbod.url = ((d.a.a.a.a)localObject1).xpH.readString();
        return 0;
      }
      return -1;
    }
 ...
 * Qualified Name:     com.tencent.mm.protocal.c.bod
