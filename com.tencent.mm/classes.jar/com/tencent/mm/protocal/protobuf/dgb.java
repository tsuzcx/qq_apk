  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Huo != null)
      {
        paramVarArgs.lC(2, this.Huo.computeSize());
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Huo != null) {
        i = paramInt + f.a.a.a.lB(2, this.Huo.computeSize());
      }
      AppMethodBeat.o(125794);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdgb.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(125794);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localdgb.Huo = ((SnsObject)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(125794);
        return 0;
