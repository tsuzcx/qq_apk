  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.FWM != null)
      {
        paramVarArgs.lC(4, this.FWM.computeSize());
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.FWM != null) {
        i = paramInt + f.a.a.a.lB(4, this.FWM.computeSize());
      }
      AppMethodBeat.o(91469);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localatf.ozR = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(91469);
          return 0;
        case 3: 
          localatf.ozS = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(91469);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).alQ(paramInt);
