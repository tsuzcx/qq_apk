      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdso.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(259786);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((dsp)localObject2).parseFrom((byte[])localObject1);
          }
          localdso.ToF.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(259786);
        return 0;
