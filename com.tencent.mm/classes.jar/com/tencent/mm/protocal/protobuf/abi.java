  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Gtb != null)
      {
        paramVarArgs.lJ(1, this.Gtb.computeSize());
    ...
    label466:
    for (paramInt = f.a.a.a.lI(1, this.Gtb.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Gtc != null) {
