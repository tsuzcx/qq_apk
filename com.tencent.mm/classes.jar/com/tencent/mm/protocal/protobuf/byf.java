  ...
  extends buy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = e.a.a.a.iP(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.xKB != null) {
        i = paramInt + e.a.a.b.b.a.f(3, this.xKB);
      }
      AppMethodBeat.o(28626);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbyf.BaseRequest = ((hq)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(28626);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localbyf.wvw = ((auh)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(28626);
          return 0;
        }
        localbyf.xKB = ((e.a.a.a.a)localObject1).CLY.readString();
        AppMethodBeat.o(28626);
        return 0;
      }
      AppMethodBeat.o(28626);
