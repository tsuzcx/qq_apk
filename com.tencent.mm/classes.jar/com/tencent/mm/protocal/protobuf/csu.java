  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.FEX != null)
      {
        paramVarArgs.ln(2, this.FEX.computeSize());
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.FEX != null) {
        i = paramInt + f.a.a.a.lm(2, this.FEX.computeSize());
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localcsu.FEX = ((pm)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(117910);
          return 0;
        }
        localcsu.EfV = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(117910);
        return 0;
      }
      AppMethodBeat.o(117910);
