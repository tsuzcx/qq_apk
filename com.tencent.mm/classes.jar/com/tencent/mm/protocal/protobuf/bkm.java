  ...
  extends cvw
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lI(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.pqK != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.pqK);
      }
      paramInt = i;
      if (this.signature != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbkm.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(82418);
          return 0;
        case 2: 
          localbkm.dwb = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(82418);
          return 0;
        case 3: 
          localbkm.pqK = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(82418);
          return 0;
        }
        localbkm.signature = ((f.a.a.a.a)localObject1).OmT.readString();
        AppMethodBeat.o(82418);
        return 0;
      }
      AppMethodBeat.o(82418);
