  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.GMv != null)
      {
        paramVarArgs.lJ(6, this.GMv.computeSize());
    ...
    for (int i = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.GMv != null) {
        i = paramInt + f.a.a.a.lI(6, this.GMv.computeSize());
      }
      AppMethodBeat.o(91474);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localavi.GMp = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91474);
          return 0;
        case 3: 
          localavi.GMq = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91474);
          return 0;
        case 4: 
          localavi.qkQ = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(91474);
          return 0;
        case 5: 
          localavi.qkR = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91474);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).amA(paramInt);
