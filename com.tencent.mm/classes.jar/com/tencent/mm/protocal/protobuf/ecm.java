  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.IhK != null)
      {
        paramVarArgs.lJ(1, this.IhK.computeSize());
        this.IhK.writeFields(paramVarArgs);
      }
    ...
    label310:
    for (paramInt = f.a.a.a.lI(1, this.IhK.computeSize()) + 0;; paramInt = 0)
    {
      AppMethodBeat.o(188961);
      return paramInt;
      if (paramInt == 2)
