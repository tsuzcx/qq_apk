  ...
  extends erp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.aaKQ != null) {
        i = paramInt + i.a.a.b.b.a.h(2, this.aaKQ);
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdet.BaseRequest = localkc;
            paramInt += 1;
          }
          AppMethodBeat.o(56255);
          return 0;
        case 2: 
          localdet.aaKQ = ((i.a.a.a.a)localObject).ajGk.readString();
          AppMethodBeat.o(56255);
          return 0;
        }
        localdet.IJG = ((i.a.a.a.a)localObject).ajGk.aar();
        AppMethodBeat.o(56255);
        return 0;
      }
      AppMethodBeat.o(56255);
