  ...
  extends erp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = i.a.a.a.qC(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.YYi != null) {
        paramInt = i + i.a.a.b.b.a.h(2, this.YYi);
      }
      i = paramInt;
      if (this.Oks != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localsu.BaseRequest = localkc;
            paramInt += 1;
          }
          AppMethodBeat.o(72424);
          return 0;
        case 2: 
          localsu.YYi = ((i.a.a.a.a)localObject).ajGk.readString();
          AppMethodBeat.o(72424);
          return 0;
        }
        localsu.Oks = ((i.a.a.a.a)localObject).ajGk.readString();
        AppMethodBeat.o(72424);
        return 0;
      }
      AppMethodBeat.o(72424);
