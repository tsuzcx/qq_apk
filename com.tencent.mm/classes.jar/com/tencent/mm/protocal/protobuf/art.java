  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bA(3, this.DrX);
      AppMethodBeat.o(133170);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localart.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(133170);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localart.CFU = ((SKBuiltinBuffer_t)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(133170);
          return 0;
        }
        localart.DrX = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(133170);
        return 0;
      }
      AppMethodBeat.o(133170);
