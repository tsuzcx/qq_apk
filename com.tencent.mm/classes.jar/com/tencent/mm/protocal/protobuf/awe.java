...
{
  public LinkedList<awd> SIx;
  
  public awe()
  {
    AppMethodBeat.i(199352);
    this.SIx = new LinkedList();
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ((g.a.a.c.a)paramVarArgs[0]).e(1, 8, this.SIx);
      AppMethodBeat.o(199357);
      return 0;
    }
    if (paramInt == 1)
    {
      paramInt = g.a.a.a.c(1, 8, this.SIx);
      AppMethodBeat.o(199357);
      return paramInt + 0;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      while (paramInt < i)
      {
        ...
        if ((localObject != null) && (localObject.length > 0)) {
          localawd.parseFrom((byte[])localObject);
        }
        localawe.SIx.add(localawd);
        paramInt += 1;
      }
      AppMethodBeat.o(199357);
      return 0;
