  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.DlF != null)
      {
        paramVarArgs.kX(4, this.DlF.computeSize());
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i += f.a.a.b.b.a.bA(3, this.dvW);
      paramInt = i;
      if (this.DlF != null) {
        paramInt = i + f.a.a.a.kW(4, this.DlF.computeSize());
      }
      AppMethodBeat.o(203822);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdyc.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(203822);
          return 0;
        case 2: 
          localdyc.finderUsername = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(203822);
          return 0;
        case 3: 
          localdyc.dvW = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(203822);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
