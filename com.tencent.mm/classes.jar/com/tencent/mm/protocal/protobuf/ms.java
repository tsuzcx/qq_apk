  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.CJG != null) {
        paramInt = i + f.a.a.b.b.a.e(3, this.CJG);
      }
      i = paramInt;
      if (this.ProductID != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localms.mBH = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(124432);
          return 0;
        case 3: 
          localms.CJG = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(124432);
          return 0;
        }
        localms.ProductID = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(124432);
        return 0;
      }
      AppMethodBeat.o(124432);
