  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int k = f.a.a.b.b.a.bz(4, this.FYU);
      AppMethodBeat.o(124405);
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localms.FYS.add(localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124405);
          return 0;
        case 3: 
          localms.FYT = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(124405);
          return 0;
        }
        localms.FYU = ((f.a.a.a.a)localObject1).OmT.zc();
        AppMethodBeat.o(124405);
        return 0;
      }
      AppMethodBeat.o(124405);
