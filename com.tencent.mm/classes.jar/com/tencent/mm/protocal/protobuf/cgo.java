  ...
  extends cvw
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lI(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.Gbn != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.Gbn);
      }
      paramInt = i;
      if (this.CPZ != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcgo.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91563);
          return 0;
        case 2: 
          localcgo.FVJ = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91563);
          return 0;
        case 3: 
          localcgo.Gbn = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91563);
          return 0;
        }
        localcgo.CPZ = ((f.a.a.a.a)localObject1).OmT.readString();
        AppMethodBeat.o(91563);
        return 0;
      }
      AppMethodBeat.o(91563);
