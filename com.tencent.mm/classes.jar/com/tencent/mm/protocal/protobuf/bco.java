  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = g.a.a.a.c(4, 8, this.LEw);
      AppMethodBeat.o(209677);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbco.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(209677);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localbco.LAI = ((aov)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(209677);
          return 0;
        case 3: 
          localbco.lastBuffer = ((g.a.a.a.a)localObject1).UbS.hPo();
          AppMethodBeat.o(209677);
          return 0;
        }
        paramVarArgs = ((g.a.a.a.a)localObject1).awh(paramInt);
