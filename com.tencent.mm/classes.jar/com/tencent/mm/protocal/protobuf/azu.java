  ...
  extends com.tencent.mm.bv.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 1)
    {
      ...
      i += e.a.a.b.b.a.bl(6, this.wSn);
      paramInt = i;
      if (this.xpq != null) {
        paramInt = i + e.a.a.b.b.a.f(7, this.xpq);
      }
      AppMethodBeat.o(124320);
      return paramInt;
    }
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localazu.wDh = Float.intBitsToFloat(locala.CLY.emx());
        AppMethodBeat.o(124320);
        return 0;
      case 2: 
        localazu.wDi = Float.intBitsToFloat(locala.CLY.emx());
        AppMethodBeat.o(124320);
        return 0;
      case 3: 
        localazu.wSk = locala.CLY.sl();
        AppMethodBeat.o(124320);
        return 0;
      case 4: 
        localazu.wSl = locala.CLY.readString();
        AppMethodBeat.o(124320);
        return 0;
      case 5: 
        localazu.wSm = locala.CLY.readString();
        AppMethodBeat.o(124320);
        return 0;
      case 6: 
        localazu.wSn = locala.CLY.sl();
        AppMethodBeat.o(124320);
        return 0;
      }
      localazu.xpq = locala.CLY.readString();
      AppMethodBeat.o(124320);
      return 0;
    }
    AppMethodBeat.o(124320);
