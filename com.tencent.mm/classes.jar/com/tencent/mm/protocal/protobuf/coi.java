    ...
    for (paramInt = g.a.a.b.b.a.g(1, this.wording) + 0;; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localcoi.wording = locala.abFh.readString();
          AppMethodBeat.o(72510);
          return 0;
        case 2: 
          localcoi.action = locala.abFh.AK();
          AppMethodBeat.o(72510);
          return 0;
        case 3: 
          localcoi.url = locala.abFh.readString();
          AppMethodBeat.o(72510);
          return 0;
        case 4: 
          localcoi.username = locala.abFh.readString();
          AppMethodBeat.o(72510);
          return 0;
        }
        localcoi.InB = locala.abFh.readString();
        AppMethodBeat.o(72510);
        return 0;
      }
      AppMethodBeat.o(72510);
