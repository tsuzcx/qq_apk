  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.Dek != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.Dek);
      }
      i = paramInt;
      if (this.CEv != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.CEv);
      }
      AppMethodBeat.o(56256);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localbjn.Dek = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(56256);
          return 0;
        }
        localbjn.CEv = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(56256);
        return 0;
      }
      AppMethodBeat.o(56256);
