  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.MZy != null)
      {
        paramVarArgs.ni(2, this.MZy.computeSize());
        this.MZy.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(125794);
      return 0;
    }
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.MZy != null) {
        i = paramInt + g.a.a.a.nh(2, this.MZy.computeSize());
      }
      AppMethodBeat.o(125794);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        while (paramInt < i)
        {
          ...
          localead.MZy = ((SnsObject)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(125794);
        return 0;
