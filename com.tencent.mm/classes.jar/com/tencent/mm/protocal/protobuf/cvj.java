  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aS(1, this.Hlk);
      if (this.HnH != null)
      {
        paramVarArgs.lC(2, this.HnH.computeSize());
        this.HnH.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(32414);
      return 0;
    }
    ...
    if (paramInt == 1)
    {
      i = f.a.a.b.b.a.bz(1, this.Hlk) + 0;
      paramInt = i;
      if (this.HnH != null) {
        paramInt = i + f.a.a.a.lB(2, this.HnH.computeSize());
      }
      AppMethodBeat.o(32414);
      return paramInt;
    }
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localcvj.Hlk = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(32414);
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        localcvj.HnH = ((SKBuiltinBuffer_t)localObject1);
        paramInt += 1;
      }
      AppMethodBeat.o(32414);
      return 0;
