  ...
  extends cvw
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lI(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.Gxz != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.Gxz);
      }
      i = paramInt;
      if (this.ikm != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.ikm);
      }
      i += f.a.a.b.b.a.bz(4, this.yxf);
      paramInt = i;
      if (this.Ghz != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localahi.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91441);
          return 0;
        case 2: 
          localahi.Gxz = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91441);
          return 0;
        case 3: 
          localahi.ikm = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91441);
          return 0;
        case 4: 
          localahi.yxf = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(91441);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).amA(paramInt);
