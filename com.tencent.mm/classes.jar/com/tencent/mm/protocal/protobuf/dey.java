      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdey.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(116335);
          return 0;
        ...
        {
          localObject1 = (byte[])paramVarArgs.get(paramInt);
          localObject2 = new dco();
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((dco)localObject2).parseFrom((byte[])localObject1);
          }
          localdey.aaKT.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(116335);
        return 0;
