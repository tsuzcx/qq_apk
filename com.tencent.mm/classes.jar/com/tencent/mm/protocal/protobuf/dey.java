  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.FOq != null)
      {
        paramVarArgs.ln(4, this.FOq.computeSize());
        this.FOq.writeFields(paramVarArgs);
      }
      if (this.Eua != null) {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.FOq != null) {
        paramInt = i + f.a.a.a.lm(4, this.FOq.computeSize());
      }
      i = paramInt;
      if (this.Eua != null) {
        i = paramInt + f.a.a.b.b.a.e(5, this.Eua);
      }
      AppMethodBeat.o(123658);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localdey.FGd = ((gx)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(123658);
          return 0;
        case 3: 
          localdey.DTW = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(123658);
          return 0;
        case 4: 
          paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localObject1 = new hb();
            localObject2 = new f.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = ((hb)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bw.a)localObject1, cqk.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
            localdey.FOq = ((hb)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(123658);
          return 0;
        }
        localdey.Eua = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(123658);
        return 0;
      }
      AppMethodBeat.o(123658);
