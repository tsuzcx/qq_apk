  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.AgD != null)
      {
        paramVarArgs.kX(4, this.AgD.computeSize());
        this.AgD.writeFields(paramVarArgs);
      }
      if (this.DqX != null) {
        paramVarArgs.d(5, this.DqX);
      }
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.AgD != null) {
        i = paramInt + f.a.a.a.kW(4, this.AgD.computeSize());
      }
      paramInt = i;
      if (this.DqX != null) {
        paramInt = i + f.a.a.b.b.a.e(5, this.DqX);
      }
      AppMethodBeat.o(91492);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localavy.ntx = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(91492);
          return 0;
        case 3: 
          localavy.nty = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(91492);
          return 0;
        case 4: 
          paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localavy.AgD = ((c)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91492);
          return 0;
        }
        localavy.DqX = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(91492);
        return 0;
      }
      AppMethodBeat.o(91492);
