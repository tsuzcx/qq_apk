  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.EEZ != null)
      {
        paramVarArgs.ln(3, this.EEZ.computeSize());
    ...
    for (int i = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.EEZ != null) {
        i = paramInt + f.a.a.a.lm(3, this.EEZ.computeSize());
      }
      AppMethodBeat.o(169065);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localaor.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(169065);
          return 0;
        case 2: 
          localaor.query = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(169065);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
