  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aS(2, this.Hll);
      paramVarArgs.aS(3, this.Hlm);
      if (this.Hln != null)
      {
        paramVarArgs.lC(4, this.Hln.computeSize());
        this.Hln.writeFields(paramVarArgs);
      }
      paramVarArgs.aS(5, this.Hli);
      AppMethodBeat.o(32413);
      return 0;
    }
    if (paramInt == 1) {
    ...
    {
      int i = paramInt + f.a.a.b.b.a.bz(2, this.Hll) + f.a.a.b.b.a.bz(3, this.Hlm);
      paramInt = i;
      if (this.Hln != null) {
        paramInt = i + f.a.a.a.lB(4, this.Hln.computeSize());
      }
      i = f.a.a.b.b.a.bz(5, this.Hli);
      AppMethodBeat.o(32413);
      return paramInt + i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localcsz.Hll = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(32413);
          return 0;
        case 3: 
          localcsz.Hlm = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(32413);
          return 0;
        case 4: 
          paramVarArgs = ((f.a.a.a.a)localObject1).alQ(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localcsz.Hln = ((dwk)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32413);
          return 0;
        }
        localcsz.Hli = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(32413);
        return 0;
      }
      AppMethodBeat.o(32413);
