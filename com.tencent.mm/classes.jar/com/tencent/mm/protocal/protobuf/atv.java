  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Gpl != null)
      {
        paramVarArgs.lJ(4, this.Gpl.computeSize());
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.Gpl != null) {
        i = paramInt + f.a.a.a.lI(4, this.Gpl.computeSize());
      }
      AppMethodBeat.o(91469);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localatv.oGt = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(91469);
          return 0;
        case 3: 
          localatv.oGu = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91469);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).amA(paramInt);
