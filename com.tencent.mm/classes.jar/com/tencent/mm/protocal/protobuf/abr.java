  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bx(3, this.dvQ);
      AppMethodBeat.o(74652);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localabr.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(74652);
          return 0;
        case 2: 
          localabr.djj = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(74652);
          return 0;
        }
        localabr.dvQ = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(74652);
        return 0;
      }
      AppMethodBeat.o(74652);
