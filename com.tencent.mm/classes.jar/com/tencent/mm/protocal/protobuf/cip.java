  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aR(2, this.mBG);
      paramVarArgs.aR(3, this.EdW);
      if (this.EdX != null)
      {
        paramVarArgs.kX(4, this.EdX.computeSize());
    ...
    {
      int i = paramInt + f.a.a.b.b.a.bA(2, this.mBG) + f.a.a.b.b.a.bA(3, this.EdW);
      paramInt = i;
      if (this.EdX != null) {
        paramInt = i + f.a.a.a.kW(4, this.EdX.computeSize());
      }
      i = f.a.a.b.b.a.bA(5, this.EdY);
      AppMethodBeat.o(32412);
      return paramInt + i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcip.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32412);
          return 0;
        case 2: 
          localcip.mBG = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(32412);
          return 0;
        case 3: 
          localcip.EdW = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(32412);
          return 0;
        case 4: 
          paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localcip.EdX = ((dkz)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32412);
          return 0;
        }
        localcip.EdY = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(32412);
        return 0;
      }
      AppMethodBeat.o(32412);
