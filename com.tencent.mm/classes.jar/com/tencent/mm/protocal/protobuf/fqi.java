  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localfqi.rVx = ((g.a.a.a.a)localObject).abFh.AK();
        AppMethodBeat.o(204134);
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        fqh localfqh = new fqh();
        if ((localObject != null) && (localObject.length > 0)) {
          localfqh.parseFrom((byte[])localObject);
        }
        localfqi.UOe.add(localfqh);
        paramInt += 1;
      }
      AppMethodBeat.o(204134);
      return 0;
