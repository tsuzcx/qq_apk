  ...
  extends dyy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.TYs != null) {
        i = paramInt + g.a.a.a.oD(4, this.TYs.computeSize());
      }
      AppMethodBeat.o(91647);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdrk.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(91647);
          return 0;
        case 2: 
          localdrk.tqa = ((g.a.a.a.a)localObject1).abFh.AK();
          AppMethodBeat.o(91647);
          return 0;
        case 3: 
          localdrk.tqb = ((g.a.a.a.a)localObject1).abFh.readString();
          AppMethodBeat.o(91647);
          return 0;
        }
        paramVarArgs = ((g.a.a.a.a)localObject1).aGc(paramInt);
