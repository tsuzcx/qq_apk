  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.DvJ != null)
      {
        paramVarArgs.kX(6, this.DvJ.computeSize());
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.DvJ != null) {
        paramInt = i + f.a.a.a.kW(6, this.DvJ.computeSize());
      }
      i = f.a.a.b.b.a.bA(7, this.DvK);
      AppMethodBeat.o(114031);
      return paramInt + i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localawk.ntx = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(114031);
          return 0;
        case 3: 
          localawk.nty = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(114031);
          return 0;
        case 4: 
          localawk.ocT = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(114031);
          return 0;
        case 5: 
          localawk.DsQ = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(114031);
          return 0;
        case 6: 
          paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localawk.DvJ = ((byb)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(114031);
          return 0;
        }
        localawk.DvK = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(114031);
        return 0;
      }
      AppMethodBeat.o(114031);
