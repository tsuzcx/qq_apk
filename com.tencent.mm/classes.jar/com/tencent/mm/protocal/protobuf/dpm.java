  ...
  extends erp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i.a.a.b.b.a.cJ(3, this.YIq);
      AppMethodBeat.o(104822);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdpm.BaseRequest = localkc;
            paramInt += 1;
          }
          AppMethodBeat.o(104822);
          return 0;
        case 2: 
          localdpm.ProductID = ((i.a.a.a.a)localObject).ajGk.readString();
          AppMethodBeat.o(104822);
          return 0;
        }
        localdpm.YIq = ((i.a.a.a.a)localObject).ajGk.aar();
        AppMethodBeat.o(104822);
        return 0;
      }
      AppMethodBeat.o(104822);
