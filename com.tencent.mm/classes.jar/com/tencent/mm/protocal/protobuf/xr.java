  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.llH != null) {
        paramInt = i + g.a.a.b.b.a.g(2, this.llH);
      }
      i = paramInt;
      if (this.signature != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localxr.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(257333);
          return 0;
        case 2: 
          localxr.llH = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(257333);
          return 0;
        }
        localxr.signature = ((g.a.a.a.a)localObject).abFh.readString();
        AppMethodBeat.o(257333);
        return 0;
      }
      AppMethodBeat.o(257333);
