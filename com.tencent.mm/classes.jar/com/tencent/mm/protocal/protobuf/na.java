...
{
  public int CPw;
  public LinkedList<fu> RTO;
  
  public na()
  {
    AppMethodBeat.i(124402);
    this.RTO = new LinkedList();
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localna.BaseRequest = ((jg)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(124403);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localna.RTO.add(localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(124403);
          return 0;
        }
        localna.CPw = ((g.a.a.a.a)localObject1).abFh.AK();
        AppMethodBeat.o(124403);
        return 0;
      }
      AppMethodBeat.o(124403);
