  ...
  extends dyy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.UlS != null)
      {
        paramVarArgs.oE(2, this.UlS.computeSize());
        this.UlS.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(125794);
      return 0;
    }
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.UlS != null) {
        i = paramInt + g.a.a.a.oD(2, this.UlS.computeSize());
      }
      AppMethodBeat.o(125794);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localekd.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(125794);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localekd.UlS = ((SnsObject)localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(125794);
        return 0;
