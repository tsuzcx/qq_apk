  ...
  extends cvw
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lI(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bz(4, this.Hag);
      AppMethodBeat.o(114041);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbmv.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(114041);
          return 0;
        case 2: 
          localbmv.dJb = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(114041);
          return 0;
        case 3: 
          localbmv.oBN = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(114041);
          return 0;
        }
        localbmv.Hag = ((f.a.a.a.a)localObject1).OmT.zc();
        AppMethodBeat.o(114041);
        return 0;
      }
      AppMethodBeat.o(114041);
