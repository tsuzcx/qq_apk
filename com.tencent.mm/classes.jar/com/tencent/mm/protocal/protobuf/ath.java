  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.EMm != null)
      {
        paramVarArgs.ln(4, this.EMm.computeSize());
        this.EMm.writeFields(paramVarArgs);
      }
      paramVarArgs.aO(5, this.EMn);
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.EMm != null) {
        paramInt = i + f.a.a.a.lm(4, this.EMm.computeSize());
      }
      i = f.a.a.b.b.a.p(5, this.EMn);
      AppMethodBeat.o(82407);
      return paramInt + i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localath.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(82407);
          return 0;
        ...
        case 4: 
          ...
          while (paramInt < i)
          {
            ...
            localObject2 = new f.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = ((bku)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bw.a)localObject1, cpx.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
            localath.EMm = ((bku)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(82407);
          return 0;
        }
        localath.EMn = ((f.a.a.a.a)localObject1).LVo.xG();
        AppMethodBeat.o(82407);
        return 0;
      }
      AppMethodBeat.o(82407);
