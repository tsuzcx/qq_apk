  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Ggs != null) {
        paramVarArgs.d(2, this.Ggs);
      }
      paramVarArgs.bt(3, this.Ggt);
      AppMethodBeat.o(104364);
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Ggs != null) {
        i = paramInt + f.a.a.b.b.a.e(2, this.Ggs);
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localajd.Ggs = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(104364);
          return 0;
        }
        localajd.Ggt = ((f.a.a.a.a)localObject1).NPN.grw();
        AppMethodBeat.o(104364);
        return 0;
      }
      AppMethodBeat.o(104364);
