  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = g.a.a.b.b.a.bu(4, this.Version);
      AppMethodBeat.o(104794);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localGetEmotionDetailRequest.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(104794);
          return 0;
        case 2: 
          localGetEmotionDetailRequest.ProductID = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(104794);
          return 0;
        case 3: 
          localGetEmotionDetailRequest.Scene = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(104794);
          return 0;
        }
        localGetEmotionDetailRequest.Version = ((g.a.a.a.a)localObject1).UbS.zi();
        AppMethodBeat.o(104794);
        return 0;
      }
      AppMethodBeat.o(104794);
