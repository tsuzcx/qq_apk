  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.ozQ != null) {
        i = paramInt + f.a.a.b.b.a.e(4, this.ozQ);
      }
      AppMethodBeat.o(114072);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localddh.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(114072);
          return 0;
        case 2: 
          localddh.ozR = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(114072);
          return 0;
        case 3: 
          localddh.ozS = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(114072);
          return 0;
        }
        localddh.ozQ = ((f.a.a.a.a)localObject1).NPN.readString();
        AppMethodBeat.o(114072);
        return 0;
      }
      AppMethodBeat.o(114072);
