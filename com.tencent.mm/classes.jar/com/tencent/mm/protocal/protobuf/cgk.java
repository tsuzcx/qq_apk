  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.BaseResponse != null)
      {
        paramVarArgs.kX(2, this.BaseResponse.computeSize());
    ...
    for (paramInt = f.a.a.a.kW(1, this.Ece.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.BaseResponse != null) {
        i = paramInt + f.a.a.a.kW(2, this.BaseResponse.computeSize());
      }
      AppMethodBeat.o(32397);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        while (paramInt < i)
        {
          ...
          localcgk.BaseResponse = ((BaseResponse)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(32397);
        return 0;
