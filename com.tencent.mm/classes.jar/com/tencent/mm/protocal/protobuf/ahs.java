  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Lrx != null)
      {
        paramVarArgs.ni(2, this.Lrx.computeSize());
        this.Lrx.writeFields(paramVarArgs);
      }
      paramVarArgs.aM(3, this.oUv);
      paramVarArgs.aM(4, this.Lry);
      AppMethodBeat.o(152537);
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Lrx != null) {
        i = paramInt + g.a.a.a.nh(2, this.Lrx.computeSize());
      }
      paramInt = g.a.a.b.b.a.bu(3, this.oUv);
      int j = g.a.a.b.b.a.bu(4, this.Lry);
      AppMethodBeat.o(152537);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localahs.Lrx = ((SKBuiltinBuffer_t)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(152537);
          return 0;
        case 3: 
          localahs.oUv = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(152537);
          return 0;
        }
        localahs.Lry = ((g.a.a.a.a)localObject1).UbS.zi();
        AppMethodBeat.o(152537);
        return 0;
      }
      AppMethodBeat.o(152537);
