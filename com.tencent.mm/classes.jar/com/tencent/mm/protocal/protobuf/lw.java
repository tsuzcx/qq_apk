      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            locallw.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(127443);
          return 0;
        case 2: 
          locallw.vgN = ((i.a.a.a.a)localObject1).ajGk.aar();
          AppMethodBeat.o(127443);
          return 0;
        }
        paramVarArgs = ((i.a.a.a.a)localObject1).aMP(paramInt);
        ...
        {
          localObject1 = (byte[])paramVarArgs.get(paramInt);
          localObject2 = new fov();
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((fov)localObject2).parseFrom((byte[])localObject1);
          }
          locallw.vgO.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(127443);
        return 0;
