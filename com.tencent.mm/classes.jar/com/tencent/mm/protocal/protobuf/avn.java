  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bx(4, this.ENG);
      AppMethodBeat.o(90968);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localavn.DZz = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(90968);
          return 0;
        case 3: 
          localavn.DSl = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(90968);
          return 0;
        }
        localavn.ENG = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(90968);
        return 0;
      }
      AppMethodBeat.o(90968);
