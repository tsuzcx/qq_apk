  ...
  extends dyy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.trU != null) {
        i = paramInt + g.a.a.b.b.a.g(3, this.trU);
      }
      AppMethodBeat.o(114021);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbsb.BaseResponse = localjh;
            paramInt += 1;
          }
          AppMethodBeat.o(114021);
          return 0;
        case 2: 
          localbsb.tpZ = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(114021);
          return 0;
        }
        localbsb.trU = ((g.a.a.a.a)localObject).abFh.readString();
        AppMethodBeat.o(114021);
        return 0;
      }
      AppMethodBeat.o(114021);
