  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.DrA != null)
      {
        paramVarArgs.kX(3, this.DrA.computeSize());
    ...
    for (int i = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.DrA != null) {
        i = paramInt + f.a.a.a.kW(3, this.DrA.computeSize());
      }
      AppMethodBeat.o(124552);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcrd.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124552);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localObject1 = new mn();
          localObject2 = new f.a.a.a.a((byte[])localObject2, unknownTagHandler);
          for (bool = true; bool; bool = ((mn)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bx.a)localObject1, cld.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
          localcrd.DrA = ((mn)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(124552);
        return 0;
