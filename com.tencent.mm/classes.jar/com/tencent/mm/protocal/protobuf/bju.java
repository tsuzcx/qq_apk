  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.KJw != null) {
        i = paramInt + g.a.a.b.b.a.f(3, this.KJw);
      }
      AppMethodBeat.o(124507);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbju.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124507);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localbju.KTz = ((dis)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124507);
          return 0;
        }
        localbju.KJw = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(124507);
        return 0;
      }
      AppMethodBeat.o(124507);
