  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aR(4, this.Dns);
      paramVarArgs.aR(5, this.Dnt);
    ...
    for (int i = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bA(4, this.Dns);
      int j = f.a.a.b.b.a.bA(5, this.Dnt);
      AppMethodBeat.o(91468);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localamh.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91468);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localamh.CWP = ((il)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91468);
          return 0;
        case 3: 
          localamh.CWQ = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(91468);
          return 0;
        case 4: 
          localamh.Dns = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(91468);
          return 0;
        }
        localamh.Dnt = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(91468);
        return 0;
      }
      AppMethodBeat.o(91468);
