      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localaab.BaseRequest = ((kc)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(127446);
          return 0;
        case 2: 
          localaab.vgN = ((i.a.a.a.a)localObject1).ajGk.aar();
          AppMethodBeat.o(127446);
          return 0;
        }
        paramVarArgs = ((i.a.a.a.a)localObject1).aMP(paramInt);
        ...
        {
          localObject1 = (byte[])paramVarArgs.get(paramInt);
          localObject2 = new aaa();
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((aaa)localObject2).parseFrom((byte[])localObject1);
          }
          localaab.vgO.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(127446);
        return 0;
