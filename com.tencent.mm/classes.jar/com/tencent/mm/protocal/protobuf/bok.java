  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.LUV != null)
      {
        paramVarArgs.ni(3, this.LUV.computeSize());
    ...
    for (int i = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.LUV != null) {
        i = paramInt + g.a.a.a.nh(3, this.LUV.computeSize());
      }
      AppMethodBeat.o(72488);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbok.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72488);
          return 0;
        case 2: 
          localbok.LWD = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(72488);
          return 0;
        }
        paramVarArgs = ((g.a.a.a.a)localObject1).awh(paramInt);
