  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lB(1, this.HMT.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = f.a.a.b.b.a.bz(3, this.HMU);
      AppMethodBeat.o(147807);
      return paramInt + i + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localdzv.HMK.add(localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(147807);
          return 0;
        }
        localdzv.HMU = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(147807);
        return 0;
      }
      AppMethodBeat.o(147807);
