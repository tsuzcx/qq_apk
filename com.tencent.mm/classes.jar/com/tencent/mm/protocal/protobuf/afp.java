      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localafp.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(101804);
          return 0;
        case 2: 
          localafp.iWB = ((g.a.a.a.a)localObject1).abFh.AK();
          AppMethodBeat.o(101804);
          return 0;
        }
        paramVarArgs = ((g.a.a.a.a)localObject1).aGc(paramInt);
        ...
        while (paramInt < i)
        {
          ...
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((afz)localObject2).parseFrom((byte[])localObject1);
          }
          localafp.RIk.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(101804);
        return 0;
