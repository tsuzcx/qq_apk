      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdcu.BaseRequest = ((kc)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(155426);
          return 0;
        case 2: 
          localdcu.vgN = ((i.a.a.a.a)localObject1).ajGk.aar();
          AppMethodBeat.o(155426);
          return 0;
        }
        paramVarArgs = ((i.a.a.a.a)localObject1).aMP(paramInt);
        ...
        {
          localObject1 = (byte[])paramVarArgs.get(paramInt);
          localObject2 = new dct();
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((dct)localObject2).parseFrom((byte[])localObject1);
          }
          localdcu.vgO.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(155426);
        return 0;
