  ...
  extends cvw
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bz(3, this.HKY);
      int j = f.a.a.b.b.a.bz(4, this.HKZ);
      AppMethodBeat.o(124553);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdcu.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124553);
          return 0;
        case 2: 
          localdcu.FZx = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(124553);
          return 0;
        case 3: 
          localdcu.HKY = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(124553);
          return 0;
        }
        localdcu.HKZ = ((f.a.a.a.a)localObject1).OmT.zc();
        AppMethodBeat.o(124553);
        return 0;
      }
      AppMethodBeat.o(124553);
