  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.EOb != null)
      {
        paramVarArgs.ln(3, this.EOb.computeSize());
    ...
    for (int i = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.EOb != null) {
        i = paramInt + f.a.a.a.lm(3, this.EOb.computeSize());
      }
      AppMethodBeat.o(72488);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localaye.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72488);
          return 0;
        case 2: 
          localaye.EPH = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(72488);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
