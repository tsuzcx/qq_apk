    ...
    for (paramInt = i.a.a.b.b.a.h(1, this.wording) + 0;; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localdfc.wording = locala.ajGk.readString();
          AppMethodBeat.o(72510);
          return 0;
        case 2: 
          localdfc.action = locala.ajGk.aar();
          AppMethodBeat.o(72510);
          return 0;
        case 3: 
          localdfc.url = locala.ajGk.readString();
          AppMethodBeat.o(72510);
          return 0;
        case 4: 
          localdfc.username = locala.ajGk.readString();
          AppMethodBeat.o(72510);
          return 0;
        }
        localdfc.OkP = locala.ajGk.readString();
        AppMethodBeat.o(72510);
        return 0;
      }
      AppMethodBeat.o(72510);
