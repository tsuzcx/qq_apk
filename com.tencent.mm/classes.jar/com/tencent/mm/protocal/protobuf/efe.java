  ...
  extends com.tencent.mm.cd.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.b.b.a.g(1, this.className) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.Uix != null) {
        i = paramInt + g.a.a.b.b.a.g(3, this.Uix);
      }
      AppMethodBeat.o(122531);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localefe.className = locala.abFh.readString();
          AppMethodBeat.o(122531);
          return 0;
        case 2: 
          localefe.dataPath = locala.abFh.readString();
          AppMethodBeat.o(122531);
          return 0;
        }
        localefe.Uix = locala.abFh.readString();
        AppMethodBeat.o(122531);
        return 0;
      }
      AppMethodBeat.o(122531);
