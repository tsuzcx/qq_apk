  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.nvC != null) {
        paramInt = i + f.a.a.b.b.a.e(4, this.nvC);
      }
      AppMethodBeat.o(82453);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbnh.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(82453);
          return 0;
        case 2: 
          localbnh.app_id = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(82453);
          return 0;
        case 3: 
          localbnh.DqD = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(82453);
          return 0;
        }
        localbnh.nvC = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(82453);
        return 0;
      }
      AppMethodBeat.o(82453);
