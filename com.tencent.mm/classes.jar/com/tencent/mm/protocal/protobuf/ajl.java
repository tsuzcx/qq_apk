  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.CRx != null)
      {
        paramVarArgs.kX(2, this.CRx.computeSize());
    ...
    for (int i = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.CRx != null) {
        paramInt = i + f.a.a.a.kW(2, this.CRx.computeSize());
      }
      i = paramInt;
      if (this.Dkw != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localajl.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(168997);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localajl.CRx = ((SKBuiltinBuffer_t)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(168997);
          return 0;
