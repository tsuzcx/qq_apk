  ...
  extends buy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aO(5, this.wox);
      if (this.woy != null) {
        paramVarArgs.e(6, this.woy);
      }
      AppMethodBeat.o(5562);
      return 0;
    }
    ...
    for (paramInt = e.a.a.a.iP(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt + e.a.a.b.b.a.bl(5, this.wox);
      paramInt = i;
      if (this.woy != null) {
        paramInt = i + e.a.a.b.b.a.f(6, this.woy);
      }
      AppMethodBeat.o(5562);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localca.BaseRequest = ((hq)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(5562);
          return 0;
        case 2: 
          localca.eeF = ((e.a.a.a.a)localObject1).CLY.sl();
          AppMethodBeat.o(5562);
          return 0;
        case 3: 
          paramVarArgs = ((e.a.a.a.a)localObject1).Wp(paramInt);
        ...
        case 4: 
          ...
          while (paramInt < i)
          {
            ...
            localca.wow = ((bwc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(5562);
          return 0;
        case 5: 
          localca.wox = ((e.a.a.a.a)localObject1).CLY.sl();
          AppMethodBeat.o(5562);
          return 0;
        }
        localca.woy = ((e.a.a.a.a)localObject1).CLY.readString();
        AppMethodBeat.o(5562);
        return 0;
      }
      AppMethodBeat.o(5562);
