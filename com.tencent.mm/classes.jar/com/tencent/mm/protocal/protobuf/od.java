  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.KTG != null) {
        i = paramInt + g.a.a.b.b.a.f(4, this.KTG);
      }
      AppMethodBeat.o(224533);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localod.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(224533);
          return 0;
        case 2: 
          localod.ret = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(224533);
          return 0;
        case 3: 
          localod.dJa = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(224533);
          return 0;
        }
        localod.KTG = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(224533);
        return 0;
      }
      AppMethodBeat.o(224533);
