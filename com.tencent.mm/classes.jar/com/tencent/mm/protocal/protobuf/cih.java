  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aY(1, this.Hcf);
      if (this.Hcg != null)
      {
        paramVarArgs.lC(2, this.Hcg.computeSize());
    ...
    if (paramInt == 1)
    {
      i = f.a.a.b.b.a.p(1, this.Hcf) + 0;
      paramInt = i;
      if (this.Hcg != null) {
        paramInt = i + f.a.a.a.lB(2, this.Hcg.computeSize());
      }
      AppMethodBeat.o(215758);
      return paramInt;
    }
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localcih.Hcf = ((f.a.a.a.a)localObject1).NPN.zd();
        AppMethodBeat.o(215758);
        return 0;
      }
