...
{
  public LinkedList<cvq> TDB;
  
  public cvp()
  {
    AppMethodBeat.i(169216);
    this.TDB = new LinkedList();
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ((g.a.a.c.a)paramVarArgs[0]).e(1, 8, this.TDB);
      AppMethodBeat.o(169217);
      return 0;
    }
    if (paramInt == 1)
    {
      paramInt = g.a.a.a.c(1, 8, this.TDB);
      AppMethodBeat.o(169217);
      return paramInt + 0;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      while (paramInt < i)
      {
        ...
        if ((localObject != null) && (localObject.length > 0)) {
          localcvq.parseFrom((byte[])localObject);
        }
        localcvp.TDB.add(localcvq);
        paramInt += 1;
      }
      AppMethodBeat.o(169217);
      return 0;
