  ...
  extends com.tencent.mm.cd.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.i(1, this.latitude);
      paramVarArgs.i(2, this.longitude);
      paramVarArgs.i(3, this.RSf);
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localml.latitude = Float.intBitsToFloat(locala.abFh.AO());
        AppMethodBeat.o(210472);
        return 0;
      case 2: 
        localml.longitude = Float.intBitsToFloat(locala.abFh.AO());
        AppMethodBeat.o(210472);
        return 0;
      }
      localml.RSf = Float.intBitsToFloat(locala.abFh.AO());
      AppMethodBeat.o(210472);
      return 0;
    }
    AppMethodBeat.o(210472);
