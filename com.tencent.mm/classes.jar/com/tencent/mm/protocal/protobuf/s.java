  ...
  extends cvw
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lI(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.FIe != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.FIe);
      }
      i = paramInt;
      if (this.FIf != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          locals.FIe = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91330);
          return 0;
        case 3: 
          locals.FIf = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91330);
          return 0;
        }
        locals.scene = ((f.a.a.a.a)localObject1).OmT.zc();
        AppMethodBeat.o(91330);
        return 0;
      }
      AppMethodBeat.o(91330);
