  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.DKA != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.DKA);
      }
      i = paramInt;
      if (this.DKB != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            locals.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91330);
          return 0;
        case 2: 
          locals.DKA = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91330);
          return 0;
        case 3: 
          locals.DKB = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91330);
          return 0;
        }
        locals.scene = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(91330);
        return 0;
      }
      AppMethodBeat.o(91330);
