  ...
  extends erp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.YNN != null) {
        paramInt = i + i.a.a.b.b.a.h(3, this.YNN);
      }
      AppMethodBeat.o(155390);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localmo.BaseRequest = localkc;
            paramInt += 1;
          }
          AppMethodBeat.o(155390);
          return 0;
        case 2: 
          localmo.YIq = ((i.a.a.a.a)localObject).ajGk.aar();
          AppMethodBeat.o(155390);
          return 0;
        }
        localmo.YNN = ((i.a.a.a.a)localObject).ajGk.readString();
        AppMethodBeat.o(155390);
        return 0;
      }
      AppMethodBeat.o(155390);
