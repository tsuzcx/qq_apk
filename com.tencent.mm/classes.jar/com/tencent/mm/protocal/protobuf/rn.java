  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      int j = f.a.a.b.b.a.bA(5, this.CRB);
      AppMethodBeat.o(93331);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localrn.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(93331);
          return 0;
        ...
        case 3: 
          ...
          while (paramInt < i)
          {
            ...
            localrn.CRx = ((SKBuiltinBuffer_t)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(93331);
          return 0;
        case 4: 
          localrn.CNq = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(93331);
          return 0;
        }
        localrn.CRB = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(93331);
        return 0;
      }
      AppMethodBeat.o(93331);
