  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.rNF != null) {
        i = paramInt + f.a.a.b.b.a.e(2, this.rNF);
      }
      AppMethodBeat.o(42649);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcnr.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(42649);
          return 0;
        }
        localcnr.rNF = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(42649);
        return 0;
      }
      AppMethodBeat.o(42649);
