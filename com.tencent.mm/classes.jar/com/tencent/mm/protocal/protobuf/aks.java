  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.Dmn != null) {
        paramInt = i + f.a.a.b.b.a.b(2, this.Dmn);
      }
      i = paramInt;
      if (this.CCM != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localaks.Dmn = ((f.a.a.a.a)localObject1).KhF.fMu();
          AppMethodBeat.o(169040);
          return 0;
        }
        localaks.CCM = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(169040);
        return 0;
      }
      AppMethodBeat.o(169040);
