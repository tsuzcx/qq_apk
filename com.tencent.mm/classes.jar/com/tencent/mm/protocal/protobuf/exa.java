  ...
  extends esc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.abze != null) {
        paramInt = i + i.a.a.b.b.a.c(3, this.abze);
      }
      AppMethodBeat.o(108149);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localexa.BaseResponse = localkd;
            paramInt += 1;
          }
          AppMethodBeat.o(108149);
          return 0;
        case 2: 
          localexa.aaqE = ((i.a.a.a.a)localObject).ajGk.aaw();
          AppMethodBeat.o(108149);
          return 0;
        }
        localexa.abze = ((i.a.a.a.a)localObject).ajGk.kFX();
        AppMethodBeat.o(108149);
        return 0;
      }
      AppMethodBeat.o(108149);
