  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Hax != null)
      {
        paramVarArgs.lJ(2, this.Hax.computeSize());
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Hax != null) {
        i = paramInt + f.a.a.a.lI(2, this.Hax.computeSize());
      }
      AppMethodBeat.o(6411);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        while (paramInt < i)
        {
          ...
          localObject2 = new f.a.a.a.a((byte[])localObject2, unknownTagHandler);
          for (bool = true; bool; bool = ((css)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bw.a)localObject1, cwj.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
          localbnm.Hax = ((css)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(6411);
        return 0;
