  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.KLq != null)
      {
        paramVarArgs.ni(2, this.KLq.computeSize());
        this.KLq.writeFields(paramVarArgs);
      }
      if (this.KLr != null)
      {
        paramVarArgs.ni(3, this.KLr.computeSize());
    ...
    for (int i = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.KLq != null) {
        paramInt = i + g.a.a.a.nh(2, this.KLq.computeSize());
      }
      i = paramInt;
      if (this.KLr != null) {
        i = paramInt + g.a.a.a.nh(3, this.KLr.computeSize());
      }
      AppMethodBeat.o(133151);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localie.KLq = ((SKBuiltinBuffer_t)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(133151);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localObject2 = new g.a.a.a.a((byte[])localObject2, unknownTagHandler);
          for (bool = true; bool; bool = ((SKBuiltinBuffer_t)localObject1).populateBuilderWithField((g.a.a.a.a)localObject2, (com.tencent.mm.bw.a)localObject1, dpc.getNextFieldNumber((g.a.a.a.a)localObject2))) {}
          localie.KLr = ((SKBuiltinBuffer_t)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(133151);
        return 0;
