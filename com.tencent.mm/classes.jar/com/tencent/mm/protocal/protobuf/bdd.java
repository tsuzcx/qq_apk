  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.ETq != null)
      {
        paramVarArgs.ln(2, this.ETq.computeSize());
        this.ETq.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(207324);
      return 0;
    }
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.ETq != null) {
        i = paramInt + f.a.a.a.lm(2, this.ETq.computeSize());
      }
      AppMethodBeat.o(207324);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbdd.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(207324);
          return 0;
