  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.UAl != null) {
        paramInt = i + g.a.a.b.b.a.b(2, this.UAl);
      }
      i = paramInt;
      if (this.SpW != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localfah.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(202111);
          return 0;
        case 2: 
          localfah.UAl = ((g.a.a.a.a)localObject).abFh.iUw();
          AppMethodBeat.o(202111);
          return 0;
        }
        localfah.SpW = ((g.a.a.a.a)localObject).abFh.iUw();
        AppMethodBeat.o(202111);
        return 0;
      }
      AppMethodBeat.o(202111);
