  ...
  extends dyy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.SFP != null)
      {
        paramVarArgs.oE(2, this.SFP.computeSize());
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.SFP != null) {
        i = paramInt + g.a.a.a.oD(2, this.SFP.computeSize());
      }
      AppMethodBeat.o(199418);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbgv.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(199418);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localbgv.SFP = ((FinderObject)localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(199418);
        return 0;
