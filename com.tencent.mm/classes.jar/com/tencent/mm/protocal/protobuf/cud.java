  ...
  extends cvw
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aS(2, this.HFc);
      if (this.HFd != null) {
        paramVarArgs.d(3, this.HFd);
      }
      if (this.Ghz != null)
      {
        paramVarArgs.lJ(4, this.Ghz.computeSize());
    ...
    {
      int i = paramInt + f.a.a.b.b.a.bz(2, this.HFc);
      paramInt = i;
      if (this.HFd != null) {
        paramInt = i + f.a.a.b.b.a.e(3, this.HFd);
      }
      i = paramInt;
      if (this.Ghz != null) {
        i = paramInt + f.a.a.a.lI(4, this.Ghz.computeSize());
      }
      AppMethodBeat.o(91669);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localcud.HFc = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(91669);
          return 0;
        case 3: 
          localcud.HFd = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91669);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).amA(paramInt);
