  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bA(4, this.error_code);
      AppMethodBeat.o(123581);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localbbf.fnK = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(123581);
          return 0;
        case 3: 
          localbbf.error_msg = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(123581);
          return 0;
        }
        localbbf.error_code = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(123581);
        return 0;
      }
      AppMethodBeat.o(123581);
