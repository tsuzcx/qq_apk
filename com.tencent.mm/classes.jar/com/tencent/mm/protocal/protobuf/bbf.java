  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.FOC != null)
      {
        paramVarArgs.lJ(4, this.FOC.computeSize());
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.FOC != null) {
        paramInt = i + f.a.a.a.lI(4, this.FOC.computeSize());
      }
      AppMethodBeat.o(104798);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localbbf.DonorNum = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(104798);
          return 0;
        case 3: 
          paramVarArgs = ((f.a.a.a.a)localObject1).amA(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localbbf.Donors.add(localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(104798);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localbbf.FOC = ((SKBuiltinBuffer_t)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(104798);
        return 0;
