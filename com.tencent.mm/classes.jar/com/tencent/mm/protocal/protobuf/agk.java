  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.SrO != null) {
        i = paramInt + g.a.a.b.b.a.b(3, this.SrO);
      }
      AppMethodBeat.o(124483);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localagk.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(124483);
          return 0;
        case 2: 
          localagk.RTS = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(124483);
          return 0;
        }
        localagk.SrO = ((g.a.a.a.a)localObject).abFh.iUw();
        AppMethodBeat.o(124483);
        return 0;
      }
      AppMethodBeat.o(124483);
