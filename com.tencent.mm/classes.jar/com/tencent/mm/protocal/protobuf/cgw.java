...
{
  public fne SkF;
  public LinkedList<akt> Tol;
  
  public cgw()
  {
    AppMethodBeat.i(179489);
    this.Tol = new LinkedList();
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = g.a.a.a.c(3, 8, this.Tol);
      AppMethodBeat.o(179490);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcgw.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(179490);
          return 0;
