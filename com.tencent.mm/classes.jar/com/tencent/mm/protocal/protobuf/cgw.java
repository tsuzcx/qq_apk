  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.FuX != null) {
        i = paramInt + f.a.a.b.b.a.e(4, this.FuX);
      }
      paramInt = i;
      if (this.AYl != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcgw.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91625);
          return 0;
        case 2: 
          localcgw.nWx = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(91625);
          return 0;
        case 3: 
          localcgw.nWy = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91625);
          return 0;
        case 4: 
          localcgw.FuX = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91625);
          return 0;
        }
        localcgw.AYl = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(91625);
        return 0;
      }
      AppMethodBeat.o(91625);
