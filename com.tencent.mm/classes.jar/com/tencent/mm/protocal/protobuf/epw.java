  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.Nnu != null) {
        paramInt = i + g.a.a.b.b.a.b(2, this.Nnu);
      }
      i = paramInt;
      if (this.LoA != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localepw.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(214325);
          return 0;
        case 2: 
          localepw.Nnu = ((g.a.a.a.a)localObject1).UbS.hPo();
          AppMethodBeat.o(214325);
          return 0;
        }
        localepw.LoA = ((g.a.a.a.a)localObject1).UbS.hPo();
        AppMethodBeat.o(214325);
        return 0;
      }
      AppMethodBeat.o(214325);
