  ...
  extends erp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = i.a.a.a.qC(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.aapN != null) {
        i = paramInt + i.a.a.b.b.a.h(3, this.aapN);
      }
      AppMethodBeat.o(101830);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localezv.BaseRequest = localkc;
            paramInt += 1;
          }
          AppMethodBeat.o(101830);
          return 0;
        case 2: 
          localezv.YFk = ((i.a.a.a.a)localObject).ajGk.readString();
          AppMethodBeat.o(101830);
          return 0;
        }
        localezv.aapN = ((i.a.a.a.a)localObject).ajGk.readString();
        AppMethodBeat.o(101830);
        return 0;
      }
      AppMethodBeat.o(101830);
