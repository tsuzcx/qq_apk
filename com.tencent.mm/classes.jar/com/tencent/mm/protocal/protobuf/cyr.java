  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.HpF != null)
      {
        paramVarArgs.lC(2, this.HpF.computeSize());
    ...
    for (int i = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.HpF != null) {
        paramInt = i + f.a.a.a.lB(2, this.HpF.computeSize());
      }
      i = paramInt;
      if (this.url != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localcyr.HpF = ((cyp)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(152687);
          return 0;
        }
        localcyr.url = ((f.a.a.a.a)localObject1).NPN.readString();
        AppMethodBeat.o(152687);
        return 0;
      }
      AppMethodBeat.o(152687);
