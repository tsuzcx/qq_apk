  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.HWZ != null) {
        paramVarArgs.d(4, this.HWZ);
      }
      if (this.HXa != null) {
        paramVarArgs.d(5, this.HXa);
      }
      if (this.HWU != null)
      {
        paramVarArgs.lJ(6, this.HWU.computeSize());
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.HWZ != null) {
        i = paramInt + f.a.a.b.b.a.e(4, this.HWZ);
      }
      paramInt = i;
      if (this.HXa != null) {
        paramInt = i + f.a.a.b.b.a.e(5, this.HXa);
      }
      i = paramInt;
      if (this.HWU != null) {
        i = paramInt + f.a.a.a.lI(6, this.HWU.computeSize());
      }
      AppMethodBeat.o(72591);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdpy.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72591);
          return 0;
        case 2: 
          localdpy.oGt = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(72591);
          return 0;
        case 3: 
          localdpy.oGu = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(72591);
          return 0;
        case 4: 
          localdpy.HWZ = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(72591);
          return 0;
        case 5: 
          localdpy.HXa = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(72591);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).amA(paramInt);
