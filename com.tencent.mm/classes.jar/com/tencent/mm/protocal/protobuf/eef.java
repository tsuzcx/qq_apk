  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aM(3, this.New);
      paramVarArgs.aM(4, this.Nex);
      AppMethodBeat.o(118470);
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = g.a.a.b.b.a.bu(3, this.New);
      int j = g.a.a.b.b.a.bu(4, this.Nex);
      AppMethodBeat.o(118470);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localeef.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(118470);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localeef.NdL = ((eea)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(118470);
          return 0;
        case 3: 
          localeef.New = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(118470);
          return 0;
        }
        localeef.Nex = ((g.a.a.a.a)localObject1).UbS.zi();
        AppMethodBeat.o(118470);
        return 0;
      }
      AppMethodBeat.o(118470);
