  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.DMY != null) {
        i = paramInt + f.a.a.b.b.a.e(4, this.DMY);
      }
      AppMethodBeat.o(190904);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcnl.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(190904);
          return 0;
        case 2: 
          localcnl.DMV = ((f.a.a.a.a)localObject1).LVo.xG();
          AppMethodBeat.o(190904);
          return 0;
        case 3: 
          localcnl.DMW = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(190904);
          return 0;
        }
        localcnl.DMY = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(190904);
        return 0;
      }
      AppMethodBeat.o(190904);
