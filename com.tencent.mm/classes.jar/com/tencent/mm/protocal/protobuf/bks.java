  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.pVT != null) {
        i = paramInt + g.a.a.b.b.a.f(3, this.pVT);
      }
      AppMethodBeat.o(114021);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbks.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(114021);
          return 0;
        case 2: 
          localbks.pTY = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(114021);
          return 0;
        }
        localbks.pVT = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(114021);
        return 0;
      }
      AppMethodBeat.o(114021);
