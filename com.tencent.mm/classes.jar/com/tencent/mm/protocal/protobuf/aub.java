  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = f.a.a.a.c(3, 1, this.DtZ);
      AppMethodBeat.o(124512);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localaub.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124512);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localaub.CIW = ((cfw)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124512);
          return 0;
        }
        localaub.DtZ.add(((f.a.a.a.a)localObject1).KhF.readString());
        AppMethodBeat.o(124512);
        return 0;
      }
      AppMethodBeat.o(124512);
