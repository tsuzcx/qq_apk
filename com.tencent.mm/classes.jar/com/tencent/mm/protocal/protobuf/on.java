  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    label322:
    for (paramInt = f.a.a.b.b.a.e(2, this.Ebs) + 0;; paramInt = 0)
    {
      int i = f.a.a.a.c(3, 1, this.Eev);
      AppMethodBeat.o(124466);
      return paramInt + i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 2: 
          localon.Ebs = locala.LVo.readString();
          AppMethodBeat.o(124466);
          return 0;
        }
        localon.Eev.add(locala.LVo.readString());
        AppMethodBeat.o(124466);
        return 0;
      }
      AppMethodBeat.o(124466);
