  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.HZj != null)
      {
        paramVarArgs.lJ(3, this.HZj.computeSize());
    ...
    {
      int i = paramInt + f.a.a.b.b.a.bz(2, this.ijY);
      paramInt = i;
      if (this.HZj != null) {
        paramInt = i + f.a.a.a.lI(3, this.HZj.computeSize());
      }
      AppMethodBeat.o(148658);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdtp.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(148658);
          return 0;
        case 2: 
          localdtp.ijY = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(148658);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).amA(paramInt);
        ...
        while (paramInt < i)
        {
          ...
          localdtp.HZj = ((SKBuiltinBuffer_t)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(148658);
        return 0;
