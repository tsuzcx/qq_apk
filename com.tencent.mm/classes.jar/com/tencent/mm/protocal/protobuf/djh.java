  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.MNt != null)
      {
        paramVarArgs.ni(4, this.MNt.computeSize());
        this.MNt.writeFields(paramVarArgs);
      }
    ...
    {
      int i = paramInt + g.a.a.b.b.a.bu(2, this.qq);
      paramInt = i;
      if (this.KLh != null) {
      ...
      i = paramInt;
      if (this.MNt != null) {
        i = paramInt + g.a.a.a.nh(4, this.MNt.computeSize());
      }
      AppMethodBeat.o(32398);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdjh.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32398);
          return 0;
        case 2: 
          localdjh.qq = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(32398);
          return 0;
        case 3: 
          paramVarArgs = ((g.a.a.a.a)localObject1).awh(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localdjh.KLh = ((SKBuiltinBuffer_t)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32398);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localObject2 = new g.a.a.a.a((byte[])localObject2, unknownTagHandler);
          for (bool = true; bool; bool = ((SKBuiltinBuffer_t)localObject1).populateBuilderWithField((g.a.a.a.a)localObject2, (com.tencent.mm.bw.a)localObject1, dop.getNextFieldNumber((g.a.a.a.a)localObject2))) {}
          localdjh.MNt = ((SKBuiltinBuffer_t)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(32398);
        return 0;
