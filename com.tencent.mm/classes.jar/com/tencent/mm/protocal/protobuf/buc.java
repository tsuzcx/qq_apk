  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = g.a.a.b.b.a.bM(4, this.rWt);
      AppMethodBeat.o(104794);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbuc.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(104794);
          return 0;
        case 2: 
          localbuc.ProductID = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(104794);
          return 0;
        case 3: 
          localbuc.CPw = ((g.a.a.a.a)localObject).abFh.AK();
          AppMethodBeat.o(104794);
          return 0;
        }
        localbuc.rWt = ((g.a.a.a.a)localObject).abFh.AK();
        AppMethodBeat.o(104794);
        return 0;
      }
      AppMethodBeat.o(104794);
