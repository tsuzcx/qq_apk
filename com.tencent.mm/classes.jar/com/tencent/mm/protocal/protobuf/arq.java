  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aM(5, this.blockCount);
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = g.a.a.b.b.a.bu(5, this.blockCount);
      AppMethodBeat.o(209397);
      return paramInt + i + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localarq.LCI.add(localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(209397);
          return 0;
        case 3: 
          localarq.lastBuffer = ((g.a.a.a.a)localObject1).UbS.hPo();
          AppMethodBeat.o(209397);
          return 0;
        case 4: 
          localarq.continueFlag = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(209397);
          return 0;
        }
        localarq.blockCount = ((g.a.a.a.a)localObject1).UbS.zi();
        AppMethodBeat.o(209397);
        return 0;
      }
      AppMethodBeat.o(209397);
