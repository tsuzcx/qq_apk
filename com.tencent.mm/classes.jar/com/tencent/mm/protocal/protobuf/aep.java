  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.Exo != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.Exo);
      }
      i = paramInt;
      if (this.hOf != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.hOf);
      }
      i += f.a.a.b.b.a.bx(4, this.wTE);
      paramInt = i;
      if (this.EhT != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localaep.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91441);
          return 0;
        case 2: 
          localaep.Exo = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91441);
          return 0;
        case 3: 
          localaep.hOf = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91441);
          return 0;
        case 4: 
          localaep.wTE = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(91441);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
