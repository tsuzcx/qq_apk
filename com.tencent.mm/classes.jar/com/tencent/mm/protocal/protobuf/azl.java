  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.FEX != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.FEX);
      }
      i = paramInt;
      if (this.FxE != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.FxE);
      }
      paramInt = f.a.a.b.b.a.bz(4, this.GwK);
      AppMethodBeat.o(90968);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localazl.FEX = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(90968);
          return 0;
        case 3: 
          localazl.FxE = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(90968);
          return 0;
        }
        localazl.GwK = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(90968);
        return 0;
      }
      AppMethodBeat.o(90968);
