  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aS(2, this.HNg);
      paramVarArgs.aS(3, this.HNh);
      AppMethodBeat.o(147817);
      return 0;
    }
    if (paramInt == 1) {
    ...
    {
      int i = f.a.a.b.b.a.bz(2, this.HNg);
      int j = f.a.a.b.b.a.bz(3, this.HNh);
      AppMethodBeat.o(147817);
      return paramInt + i + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localeaf.HMT = ((dza)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(147817);
          return 0;
        case 2: 
          localeaf.HNg = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(147817);
          return 0;
        }
        localeaf.HNh = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(147817);
        return 0;
      }
      AppMethodBeat.o(147817);
