  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.DKK != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.DKK);
      }
      i = paramInt;
      if (this.djj != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localckg.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91648);
          return 0;
        case 2: 
          localckg.DKK = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91648);
          return 0;
        }
        localckg.djj = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(91648);
        return 0;
      }
      AppMethodBeat.o(91648);
