  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aG(6, this.objectId);
    ...
    for (int i = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt + f.a.a.b.b.a.q(6, this.objectId);
      paramInt = i;
      if (this.objectNonceId != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdyr.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(203842);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localdyr.DlF = ((aht)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(203842);
          return 0;
        case 3: 
          localdyr.finderUsername = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(203842);
          return 0;
        case 4: 
          localdyr.scene = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(203842);
          return 0;
        case 5: 
          localdyr.lastBuffer = ((f.a.a.a.a)localObject1).KhF.fMu();
          AppMethodBeat.o(203842);
          return 0;
        case 6: 
          localdyr.objectId = ((f.a.a.a.a)localObject1).KhF.xT();
          AppMethodBeat.o(203842);
          return 0;
        }
        localdyr.objectNonceId = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(203842);
        return 0;
      }
      AppMethodBeat.o(203842);
