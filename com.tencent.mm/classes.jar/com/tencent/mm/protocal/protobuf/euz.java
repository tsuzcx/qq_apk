  ...
  extends esc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.YNj != null) {
        paramVarArgs.g(4, this.YNj);
      }
      if (this.YNk != null)
      {
        paramVarArgs.qD(5, this.YNk.computeSize());
    ...
    for (int i = i.a.a.a.qC(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.YNj != null) {
        paramInt = i + i.a.a.b.b.a.h(4, this.YNj);
      }
      i = paramInt;
      if (this.YNk != null) {
        i = paramInt + i.a.a.a.qC(5, this.YNk.computeSize());
      }
      AppMethodBeat.o(32420);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localeuz.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(32420);
          return 0;
        ...
        case 3: 
          ...
          while (paramInt < i)
          {
            ...
            localeuz.YNS = ((cyy)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(32420);
          return 0;
        case 4: 
          localeuz.YNj = ((i.a.a.a.a)localObject1).ajGk.readString();
          AppMethodBeat.o(32420);
          return 0;
        }
        paramVarArgs = ((i.a.a.a.a)localObject1).aMP(paramInt);
