  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.Eci != null) {
        paramInt = i + f.a.a.b.b.a.e(3, this.Eci);
      }
      i = paramInt;
      if (this.ProductID != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localmz.ndI = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(124432);
          return 0;
        case 3: 
          localmz.Eci = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(124432);
          return 0;
        }
        localmz.ProductID = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(124432);
        return 0;
      }
      AppMethodBeat.o(124432);
