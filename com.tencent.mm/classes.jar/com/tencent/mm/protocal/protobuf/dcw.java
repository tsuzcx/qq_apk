  ...
  extends cvw
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lI(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.GPI != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.GPI);
      }
      AppMethodBeat.o(101830);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdcw.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(101830);
          return 0;
        case 2: 
          localdcw.FNj = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(101830);
          return 0;
        }
        localdcw.GPI = ((f.a.a.a.a)localObject1).OmT.readString();
        AppMethodBeat.o(101830);
        return 0;
      }
      AppMethodBeat.o(101830);
