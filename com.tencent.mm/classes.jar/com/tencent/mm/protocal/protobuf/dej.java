  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.request_id != null) {
        i = paramInt + g.a.a.b.b.a.f(2, this.request_id);
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdej.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(214317);
          return 0;
        case 2: 
          localdej.request_id = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(214317);
          return 0;
        case 3: 
          localdej.eht = ((g.a.a.a.a)localObject1).UbS.zl();
          AppMethodBeat.o(214317);
          return 0;
        }
        localdej.LoB = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(214317);
        return 0;
      }
      AppMethodBeat.o(214317);
