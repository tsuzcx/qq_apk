  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.HNR != null)
      {
        paramVarArgs.lJ(2, this.HNR.computeSize());
        this.HNR.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(125794);
      return 0;
    }
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.HNR != null) {
        i = paramInt + f.a.a.a.lI(2, this.HNR.computeSize());
      }
      AppMethodBeat.o(125794);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        while (paramInt < i)
        {
          ...
          localdgv.HNR = ((SnsObject)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(125794);
        return 0;
