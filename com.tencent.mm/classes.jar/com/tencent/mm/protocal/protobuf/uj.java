  ...
  extends cvw
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lI(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.ypA != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.ypA);
      }
      i = paramInt;
      if (this.dwb != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localuj.ypA = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(197183);
          return 0;
        }
        localuj.dwb = ((f.a.a.a.a)localObject1).OmT.readString();
        AppMethodBeat.o(197183);
        return 0;
      }
      AppMethodBeat.o(197183);
