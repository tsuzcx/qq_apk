  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Hox != null)
      {
        paramVarArgs.lJ(2, this.Hox.computeSize());
        this.Hox.writeFields(paramVarArgs);
      }
    ...
    for (paramInt = f.a.a.b.b.a.e(1, this.iKu) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Hox != null) {
        i = paramInt + f.a.a.a.lI(2, this.Hox.computeSize());
      }
      AppMethodBeat.o(152628);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localcaw.iKu = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(152628);
          return 0;
        }
