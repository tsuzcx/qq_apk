  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    label538:
    for (int i = f.a.a.a.lB(1, this.HMT.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.username != null) {
      ...
      paramInt = i;
      if (this.HNe != null) {
        paramInt = i + f.a.a.b.b.a.e(4, this.HNe);
      }
      AppMethodBeat.o(147812);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localeaa.HMT = ((dza)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(147812);
          return 0;
        case 2: 
          localeaa.username = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(147812);
          return 0;
        case 3: 
          localeaa.Fsb = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(147812);
          return 0;
        }
        localeaa.HNe = ((f.a.a.a.a)localObject1).NPN.readString();
        AppMethodBeat.o(147812);
        return 0;
      }
      AppMethodBeat.o(147812);
