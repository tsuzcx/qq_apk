  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bx(3, this.ENJ);
      int j = f.a.a.a.c(4, 8, this.DPy);
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbfq.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32275);
          return 0;
        case 2: 
          localbfq.fZx = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(32275);
          return 0;
        case 3: 
          localbfq.ENJ = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(32275);
          return 0;
        case 4: 
          paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localbfq.DPy.add(localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32275);
          return 0;
        }
        localbfq.Scene = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(32275);
        return 0;
      }
      AppMethodBeat.o(32275);
