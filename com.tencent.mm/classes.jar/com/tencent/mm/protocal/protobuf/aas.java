  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bA(3, this.dye);
      AppMethodBeat.o(74652);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localaas.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(74652);
          return 0;
        case 2: 
          localaas.dlB = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(74652);
          return 0;
        }
        localaas.dye = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(74652);
        return 0;
      }
      AppMethodBeat.o(74652);
