  ...
  extends dyy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.THz != null) {
        i = paramInt + g.a.a.b.b.a.g(4, this.THz);
      }
      AppMethodBeat.o(273619);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdad.BaseResponse = localjh;
            paramInt += 1;
          }
          AppMethodBeat.o(273619);
          return 0;
        case 2: 
          localdad.tqa = ((g.a.a.a.a)localObject).abFh.AK();
          AppMethodBeat.o(273619);
          return 0;
        case 3: 
          localdad.tqb = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(273619);
          return 0;
        }
        localdad.THz = ((g.a.a.a.a)localObject).abFh.readString();
        AppMethodBeat.o(273619);
        return 0;
      }
      AppMethodBeat.o(273619);
