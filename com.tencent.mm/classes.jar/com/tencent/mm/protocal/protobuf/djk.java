  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.EmH != null)
      {
        paramVarArgs.ln(4, this.EmH.computeSize());
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.EmH != null) {
        i = paramInt + f.a.a.a.lm(4, this.EmH.computeSize());
      }
      paramInt = i;
      if (this.FSy != null) {
        paramInt = i + f.a.a.a.lm(5, this.FSy.computeSize());
      }
      i = paramInt + f.a.a.b.b.a.bx(6, this.FSx);
      paramInt = i;
      if (this.dlQ != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdjk.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72589);
          return 0;
        case 2: 
          localdjk.nWx = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(72589);
          return 0;
        case 3: 
          localdjk.nWy = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(72589);
          return 0;
        case 4: 
          paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
        ...
        case 5: 
          ...
          while (paramInt < i)
          {
            ...
            localdjk.FSy = ((coc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72589);
          return 0;
        case 6: 
          localdjk.FSx = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(72589);
          return 0;
        }
        localdjk.dlQ = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(72589);
        return 0;
      }
      AppMethodBeat.o(72589);
