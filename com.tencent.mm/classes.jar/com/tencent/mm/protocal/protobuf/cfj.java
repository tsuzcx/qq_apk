...
public final class cfj
  extends erp
{
  public LinkedList<oq> aapd;
  
  public cfj()
  {
    AppMethodBeat.i(124492);
    this.aapd = new LinkedList();
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcfj.BaseRequest = ((kc)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(124493);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localcfj.aapd.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(124493);
        return 0;
