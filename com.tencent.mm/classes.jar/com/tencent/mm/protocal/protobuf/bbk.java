  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int m = f.a.a.b.b.a.bx(5, this.DPI);
      AppMethodBeat.o(152589);
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbbk.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(152589);
          return 0;
        case 2: 
          localbbk.ncL = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(152589);
          return 0;
        case 3: 
          paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localbbk.ncM.add(localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(152589);
          return 0;
        case 4: 
          localbbk.ndI = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(152589);
          return 0;
        }
        localbbk.DPI = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(152589);
        return 0;
      }
      AppMethodBeat.o(152589);
