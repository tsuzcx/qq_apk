  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.aaVK != null)
      {
        paramVarArgs.qD(2, this.aaVK.computeSize());
        this.aaVK.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(101828);
      return 0;
    }
    ...
    for (paramInt = i.a.a.a.qC(1, this.YFn.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.aaVK != null) {
        i = paramInt + i.a.a.a.qC(2, this.aaVK.computeSize());
      }
      AppMethodBeat.o(101828);
      return i;
      if (paramInt == 2)
