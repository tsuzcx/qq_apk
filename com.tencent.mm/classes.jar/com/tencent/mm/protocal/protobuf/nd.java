      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localnd.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(124408);
          return 0;
        case 2: 
          localnd.RTT = ((g.a.a.a.a)localObject1).abFh.iUw();
          AppMethodBeat.o(124408);
          return 0;
        }
        paramVarArgs = ((g.a.a.a.a)localObject1).aGc(paramInt);
        ...
        while (paramInt < i)
        {
          ...
          localObject2 = new ne();
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((ne)localObject2).parseFrom((byte[])localObject1);
          }
          localnd.RTU.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(124408);
        return 0;
