  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.e(3, 1, this.FAs);
      paramVarArgs.aS(4, this.ihf);
      paramVarArgs.e(5, 8, this.FCm);
      AppMethodBeat.o(104758);
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = f.a.a.a.c(3, 1, this.FAs);
      int k = f.a.a.b.b.a.bz(4, this.ihf);
      int m = f.a.a.a.c(5, 8, this.FCm);
      AppMethodBeat.o(104758);
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localjm.FCk = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(104758);
          return 0;
        case 3: 
          localjm.FAs.add(((f.a.a.a.a)localObject1).NPN.readString());
          AppMethodBeat.o(104758);
          return 0;
        case 4: 
          localjm.ihf = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(104758);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).alQ(paramInt);
