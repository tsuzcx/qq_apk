      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localyv.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124481);
          return 0;
        case 2: 
          localyv.CIQ = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(124481);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
        ...
        while (paramInt < i)
        {
          ...
          localObject2 = new f.a.a.a.a((byte[])localObject2, unknownTagHandler);
          for (bool = true; bool; bool = ((amv)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bx.a)localObject1, ckq.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
          localyv.DaY = ((amv)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(124481);
        return 0;
