  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Dmb != null)
      {
        paramVarArgs.kX(2, this.Dmb.computeSize());
        this.Dmb.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(169038);
      return 0;
    }
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Dmb != null) {
        i = paramInt + f.a.a.a.kW(2, this.Dmb.computeSize());
      }
      AppMethodBeat.o(169038);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        while (paramInt < i)
        {
          ...
          localakm.Dmb = ((FinderObject)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(169038);
        return 0;
