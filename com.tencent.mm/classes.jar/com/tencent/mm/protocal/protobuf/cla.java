  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bx(4, this.time_stamp);
      AppMethodBeat.o(124544);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcla.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124544);
          return 0;
        case 2: 
          localcla.Ebs = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(124544);
          return 0;
        case 3: 
          localcla.Ebl = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(124544);
          return 0;
        }
        localcla.time_stamp = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(124544);
        return 0;
      }
      AppMethodBeat.o(124544);
