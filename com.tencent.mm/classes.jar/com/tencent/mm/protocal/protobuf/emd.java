  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.KLO != null) {
        paramInt = i + g.a.a.b.b.a.f(4, this.KLO);
      }
      AppMethodBeat.o(155472);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localemd.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(155472);
          return 0;
        case 2: 
          localemd.Lke = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(155472);
          return 0;
        case 3: 
          localemd.Name = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(155472);
          return 0;
        }
        localemd.KLO = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(155472);
        return 0;
      }
      AppMethodBeat.o(155472);
