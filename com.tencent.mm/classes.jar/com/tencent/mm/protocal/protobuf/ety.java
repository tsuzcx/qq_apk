  ...
  extends erp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Tox != null) {
        i = paramInt + i.a.a.b.b.a.h(2, this.Tox);
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localety.BaseRequest = localkc;
            paramInt += 1;
          }
          AppMethodBeat.o(91679);
          return 0;
        case 2: 
          localety.Tox = ((i.a.a.a.a)localObject).ajGk.readString();
          AppMethodBeat.o(91679);
          return 0;
        }
        localety.scene = ((i.a.a.a.a)localObject).ajGk.aar();
        AppMethodBeat.o(91679);
        return 0;
      }
      AppMethodBeat.o(91679);
