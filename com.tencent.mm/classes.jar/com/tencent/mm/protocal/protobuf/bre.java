  ...
  extends cvc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aS(7, this.GLq);
      if (this.GLr != null)
      {
        paramVarArgs.lC(8, this.GLr.computeSize());
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.GLA != null) {
        i = paramInt + f.a.a.b.b.a.e(6, this.GLA);
      }
      i += f.a.a.b.b.a.bz(7, this.GLq);
      paramInt = i;
      if (this.GLr != null) {
        paramInt = i + f.a.a.a.lB(8, this.GLr.computeSize());
      }
      AppMethodBeat.o(123615);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbre.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(123615);
          return 0;
        case 2: 
          localbre.iht = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(123615);
          return 0;
        case 3: 
          localbre.GLo.add(((f.a.a.a.a)localObject1).NPN.readString());
          AppMethodBeat.o(123615);
          return 0;
        case 4: 
          localbre.GLz = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(123615);
          return 0;
        case 5: 
          localbre.Url = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(123615);
          return 0;
        case 6: 
          localbre.GLA = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(123615);
          return 0;
        case 7: 
          localbre.GLq = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(123615);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).alQ(paramInt);
