  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aS(4, this.error_code);
      AppMethodBeat.o(123581);
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (int i = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bz(4, this.error_code);
      AppMethodBeat.o(123581);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localbjx.fLp = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(123581);
          return 0;
        case 3: 
          localbjx.error_msg = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(123581);
          return 0;
        }
        localbjx.error_code = ((f.a.a.a.a)localObject1).OmT.zc();
        AppMethodBeat.o(123581);
        return 0;
      }
      AppMethodBeat.o(123581);
