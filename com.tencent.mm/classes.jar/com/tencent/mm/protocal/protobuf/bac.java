  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.ERe != null)
      {
        paramVarArgs.ln(6, this.ERe.computeSize());
        this.ERe.writeFields(paramVarArgs);
      }
      paramVarArgs.aR(7, this.ERf);
      AppMethodBeat.o(114031);
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.ERe != null) {
        paramInt = i + f.a.a.a.lm(6, this.ERe.computeSize());
      }
      i = f.a.a.b.b.a.bx(7, this.ERf);
      AppMethodBeat.o(114031);
      return paramInt + i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbac.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(114031);
          return 0;
        case 2: 
          localbac.nWx = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(114031);
          return 0;
        case 3: 
          localbac.nWy = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(114031);
          return 0;
        case 4: 
          localbac.oGs = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(114031);
          return 0;
        case 5: 
          localbac.ENU = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(114031);
          return 0;
        case 6: 
          paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localbac.ERe = ((ccx)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(114031);
          return 0;
        }
        localbac.ERf = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(114031);
        return 0;
      }
      AppMethodBeat.o(114031);
