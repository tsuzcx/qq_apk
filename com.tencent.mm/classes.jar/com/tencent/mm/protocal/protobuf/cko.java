...
public final class cko
  extends esc
{
  public LinkedList<ckp> aasN;
  
  public cko()
  {
    AppMethodBeat.i(123577);
    this.aasN = new LinkedList();
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcko.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(123578);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localcko.aasN.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(123578);
        return 0;
