  ...
  extends com.tencent.mm.cd.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.SJf != null)
      {
        paramVarArgs.oE(2, this.SJf.computeSize());
    ...
    for (paramInt = g.a.a.b.b.a.g(1, this.wording) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.SJf != null) {
        i = paramInt + g.a.a.a.oD(2, this.SJf.computeSize());
      }
      AppMethodBeat.o(229429);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localawn.wording = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(229429);
          return 0;
        }
