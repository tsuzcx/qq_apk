  ...
  extends erp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = i.a.a.a.qC(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.aavx != null) {
        i = paramInt + i.a.a.b.b.a.h(3, this.aavx);
      }
      AppMethodBeat.o(259366);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localexv.BaseRequest = localkc;
            paramInt += 1;
          }
          AppMethodBeat.o(259366);
          return 0;
        case 2: 
          localexv.abzw = ((i.a.a.a.a)localObject).ajGk.readString();
          AppMethodBeat.o(259366);
          return 0;
        }
        localexv.aavx = ((i.a.a.a.a)localObject).ajGk.readString();
        AppMethodBeat.o(259366);
        return 0;
      }
      AppMethodBeat.o(259366);
