  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ((i.a.a.c.a)paramVarArgs[0]).e(1, 8, this.ZIQ);
      AppMethodBeat.o(258603);
      return 0;
    }
    if (paramInt == 1)
    {
      paramInt = i.a.a.a.c(1, 8, this.ZIQ);
      AppMethodBeat.o(258603);
      return paramInt + 0;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      fvm localfvm = (fvm)paramVarArgs[1];
      ...
      while (paramInt < i)
      {
        ...
        localfvm.ZIQ.add(localFinderObject);
        paramInt += 1;
      }
      AppMethodBeat.o(258603);
      return 0;
 ...
 * Qualified Name:     com.tencent.mm.protocal.protobuf.fvm
