  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = g.a.a.b.b.a.bM(3, this.fUN);
      AppMethodBeat.o(74652);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localagm.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(74652);
          return 0;
        case 2: 
          localagm.appid = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(74652);
          return 0;
        }
        localagm.fUN = ((g.a.a.a.a)localObject).abFh.AK();
        AppMethodBeat.o(74652);
        return 0;
      }
      AppMethodBeat.o(74652);
