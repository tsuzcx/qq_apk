  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aY(4, this.GmD);
      if (this.sbF != null) {
        paramVarArgs.c(5, this.sbF);
      }
      paramVarArgs.e(6, 8, this.GmE);
    ...
    {
      int i = paramInt + f.a.a.a.c(2, 8, this.Gmj) + f.a.a.b.b.a.bz(3, this.continueFlag) + f.a.a.b.b.a.p(4, this.GmD);
      paramInt = i;
      if (this.sbF != null) {
        paramInt = i + f.a.a.b.b.a.b(5, this.sbF);
      }
      i = f.a.a.a.c(6, 8, this.GmE);
      AppMethodBeat.o(168978);
      return paramInt + i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localanl.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(168978);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localanl.Gmj.add(localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(168978);
          return 0;
        case 3: 
          localanl.continueFlag = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(168978);
          return 0;
        case 4: 
          localanl.GmD = ((f.a.a.a.a)localObject1).NPN.zd();
          AppMethodBeat.o(168978);
          return 0;
        case 5: 
          localanl.sbF = ((f.a.a.a.a)localObject1).NPN.gxI();
          AppMethodBeat.o(168978);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).alQ(paramInt);
