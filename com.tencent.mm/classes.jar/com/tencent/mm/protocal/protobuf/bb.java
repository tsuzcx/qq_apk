    ...
    for (paramInt = g.a.a.b.b.a.g(1, this.CMP) + 0;; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localbb.CMP = locala.abFh.readString();
          AppMethodBeat.o(91340);
          return 0;
        case 2: 
          localbb.GTG = locala.abFh.readString();
          AppMethodBeat.o(91340);
          return 0;
        case 3: 
          localbb.rWu = locala.abFh.AK();
          AppMethodBeat.o(91340);
          return 0;
        case 4: 
          localbb.lpy = locala.abFh.readString();
          AppMethodBeat.o(91340);
          return 0;
        }
        localbb.CNj = locala.abFh.readString();
        AppMethodBeat.o(91340);
        return 0;
      }
      AppMethodBeat.o(91340);
