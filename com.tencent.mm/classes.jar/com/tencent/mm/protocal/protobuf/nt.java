  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.FIe != null) {
        paramInt = i + f.a.a.b.b.a.e(3, this.FIe);
      }
      i = paramInt;
      if (this.ProductID != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localnt.nEf = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(124432);
          return 0;
        case 3: 
          localnt.FIe = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(124432);
          return 0;
        }
        localnt.ProductID = ((f.a.a.a.a)localObject1).NPN.readString();
        AppMethodBeat.o(124432);
        return 0;
      }
      AppMethodBeat.o(124432);
