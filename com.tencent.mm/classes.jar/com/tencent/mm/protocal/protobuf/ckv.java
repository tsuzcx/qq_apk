  ...
  extends com.tencent.mm.cd.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aY(1, this.Tsn);
      paramVarArgs.e(2, 8, this.COK);
    ...
    if (paramInt == 1)
    {
      paramInt = g.a.a.b.b.a.bM(1, this.Tsn);
      i = g.a.a.a.c(2, 8, this.COK);
      AppMethodBeat.o(143980);
      return paramInt + 0 + i;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localckv.Tsn = ((g.a.a.a.a)localObject).abFh.AK();
        AppMethodBeat.o(143980);
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        if ((localObject != null) && (localObject.length > 0)) {
          localckw.parseFrom((byte[])localObject);
        }
