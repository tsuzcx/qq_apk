  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Dvo != null)
      {
        paramVarArgs.kX(2, this.Dvo.computeSize());
        this.Dvo.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(104806);
      return 0;
    }
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Dvo != null) {
        i = paramInt + f.a.a.a.kW(2, this.Dvo.computeSize());
      }
      AppMethodBeat.o(104806);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localavs.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(104806);
          return 0;
