  ...
  extends buy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.wrT != null)
      {
        paramVarArgs.iQ(2, this.wrT.computeSize());
      ...
      if (this.xhE != null) {
        paramVarArgs.e(5, this.xhE);
      }
      if (this.wYg != null)
      {
        paramVarArgs.iQ(6, this.wYg.computeSize());
    ...
    for (int i = e.a.a.a.iP(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.wrT != null) {
        paramInt = i + e.a.a.a.iP(2, this.wrT.computeSize());
      }
      i = paramInt;
      if (this.jJA != null) {
      ...
      paramInt = i;
      if (this.xhE != null) {
        paramInt = i + e.a.a.b.b.a.f(5, this.xhE);
      }
      i = paramInt;
      if (this.wYg != null) {
        i = paramInt + e.a.a.a.iP(6, this.wYg.computeSize());
      }
      AppMethodBeat.o(28515);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localasm.BaseRequest = ((hq)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(28515);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localasm.wrT = ((SKBuiltinBuffer_t)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(28515);
          return 0;
        case 3: 
          localasm.jJA = ((e.a.a.a.a)localObject1).CLY.readString();
          AppMethodBeat.o(28515);
          return 0;
        case 4: 
          localasm.Scene = ((e.a.a.a.a)localObject1).CLY.sl();
          AppMethodBeat.o(28515);
          return 0;
        case 5: 
          localasm.xhE = ((e.a.a.a.a)localObject1).CLY.readString();
          AppMethodBeat.o(28515);
          return 0;
        }
        paramVarArgs = ((e.a.a.a.a)localObject1).Wp(paramInt);
        ...
        while (paramInt < i)
        {
          ...
          localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
          for (bool = true; bool; bool = ((SKBuiltinBuffer_t)localObject1).populateBuilderWithField((e.a.a.a.a)localObject2, (com.tencent.mm.bv.a)localObject1, buy.getNextFieldNumber((e.a.a.a.a)localObject2))) {}
          localasm.wYg = ((SKBuiltinBuffer_t)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(28515);
        return 0;
