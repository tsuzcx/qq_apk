...
{
  public LinkedList<anj> SXE;
  
  public bmt()
  {
    AppMethodBeat.i(125726);
    this.SXE = new LinkedList();
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ((g.a.a.c.a)paramVarArgs[0]).e(1, 8, this.SXE);
      AppMethodBeat.o(125727);
      return 0;
    }
    if (paramInt == 1)
    {
      paramInt = g.a.a.a.c(1, 8, this.SXE);
      AppMethodBeat.o(125727);
      return paramInt + 0;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      while (paramInt < i)
      {
        ...
        if ((localObject != null) && (localObject.length > 0)) {
          localanj.parseFrom((byte[])localObject);
        }
        localbmt.SXE.add(localanj);
        paramInt += 1;
      }
      AppMethodBeat.o(125727);
      return 0;
