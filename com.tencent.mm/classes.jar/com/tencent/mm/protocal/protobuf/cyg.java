  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.Hpx != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.Hpx);
      }
      i = paramInt;
      if (this.Gxi != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcyg.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(104835);
          return 0;
        case 2: 
          localcyg.Hpx = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(104835);
          return 0;
        case 3: 
          paramVarArgs = ((f.a.a.a.a)localObject1).alQ(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localcyg.Gxi = ((SKBuiltinBuffer_t)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(104835);
          return 0;
        }
        localcyg.Gxl = ((f.a.a.a.a)localObject1).NPN.zd();
        AppMethodBeat.o(104835);
        return 0;
      }
      AppMethodBeat.o(104835);
