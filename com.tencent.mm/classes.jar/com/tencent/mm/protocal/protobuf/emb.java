  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.NkH != null) {
        paramInt = i + g.a.a.b.b.a.f(4, this.NkH);
      }
      AppMethodBeat.o(153309);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localemb.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(153309);
          return 0;
        case 2: 
          localemb.uuid = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(153309);
          return 0;
        case 3: 
          localemb.status = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(153309);
          return 0;
        }
        localemb.NkH = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(153309);
        return 0;
      }
      AppMethodBeat.o(153309);
