...
public final class kd
  extends dyy
{
  public LinkedList<btv> RPE;
  
  public kd()
  {
    AppMethodBeat.i(175242);
    this.RPE = new LinkedList();
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localkd.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(175243);
          return 0;
        ...
        {
          localObject1 = (byte[])paramVarArgs.get(paramInt);
          localObject2 = new btv();
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((btv)localObject2).parseFrom((byte[])localObject1);
          }
          localkd.RPE.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(175243);
        return 0;
