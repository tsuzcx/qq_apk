  ...
  extends cvc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lB(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.uhu != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.uhu);
      }
      paramInt = i;
      if (this.jdl != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbnd.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(89660);
          return 0;
        case 2: 
          localbnd.iht = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(89660);
          return 0;
        case 3: 
          localbnd.uhu = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(89660);
          return 0;
        }
        localbnd.jdl = ((f.a.a.a.a)localObject1).NPN.readString();
        AppMethodBeat.o(89660);
        return 0;
      }
      AppMethodBeat.o(89660);
