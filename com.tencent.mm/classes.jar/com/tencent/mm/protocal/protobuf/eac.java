  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.GfL != null)
      {
        paramVarArgs.ln(2, this.GfL.computeSize());
        this.GfL.writeFields(paramVarArgs);
      }
      paramVarArgs.e(3, 8, this.GfM);
      AppMethodBeat.o(147825);
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.GfL != null) {
        i = paramInt + f.a.a.a.lm(2, this.GfL.computeSize());
      }
      paramInt = f.a.a.a.c(3, 8, this.GfM);
      AppMethodBeat.o(147825);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        while (paramInt < i)
        {
          ...
          localObject1 = new gp();
          localObject2 = new f.a.a.a.a((byte[])localObject2, unknownTagHandler);
          for (bool = true; bool; bool = ((gp)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bw.a)localObject1, cqk.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
          localeac.GfM.add(localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(147825);
        return 0;
