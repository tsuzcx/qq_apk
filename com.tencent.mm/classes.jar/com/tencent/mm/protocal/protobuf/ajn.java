  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Gzb != null) {
        paramVarArgs.d(2, this.Gzb);
      }
      paramVarArgs.bC(3, this.Gzc);
      AppMethodBeat.o(104364);
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Gzb != null) {
        i = paramInt + f.a.a.b.b.a.e(2, this.Gzb);
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localajn.Gzb = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(104364);
          return 0;
        }
        localajn.Gzc = ((f.a.a.a.a)localObject1).OmT.gvY();
        AppMethodBeat.o(104364);
        return 0;
      }
      AppMethodBeat.o(104364);
