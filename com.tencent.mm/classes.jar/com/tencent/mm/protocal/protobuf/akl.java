...
{
  public bqx wyn;
  public LinkedList<String> xbF;
  
  public akl()
  {
    AppMethodBeat.i(11770);
    this.xbF = new LinkedList();
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = e.a.a.a.iP(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = e.a.a.a.c(3, 1, this.xbF);
      AppMethodBeat.o(11771);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localakl.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(11771);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localakl.wyn = ((bqx)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(11771);
          return 0;
        }
        localakl.xbF.add(((e.a.a.a.a)localObject1).CLY.readString());
        AppMethodBeat.o(11771);
        return 0;
      }
      AppMethodBeat.o(11771);
