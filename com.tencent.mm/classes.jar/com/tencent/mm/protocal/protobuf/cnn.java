  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      {
        paramVarArgs.ni(3, this.contact.computeSize());
    ...
    for (int i = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.contact != null) {
        i = paramInt + g.a.a.a.nh(3, this.contact.computeSize());
      }
      AppMethodBeat.o(209741);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localObject2 = new g.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = ((cng)localObject1).populateBuilderWithField((g.a.a.a.a)localObject2, (com.tencent.mm.bw.a)localObject1, dpc.getNextFieldNumber((g.a.a.a.a)localObject2))) {}
            localcnn.LIA = ((cng)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(209741);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localcnn.contact = ((FinderContact)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(209741);
        return 0;
