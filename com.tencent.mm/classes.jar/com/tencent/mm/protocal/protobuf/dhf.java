  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.HMY != null)
      {
        paramVarArgs.lJ(2, this.HMY.computeSize());
        this.HMY.writeFields(paramVarArgs);
      }
      if (this.HmW != null) {
        paramVarArgs.d(3, this.HmW);
      }
      AppMethodBeat.o(125807);
      return 0;
    }
    ...
    for (int i = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.HMY != null) {
        paramInt = i + f.a.a.a.lI(2, this.HMY.computeSize());
      }
      i = paramInt;
      if (this.HmW != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.HmW);
      }
      AppMethodBeat.o(125807);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localdhf.HMY = ((SnsObject)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(125807);
          return 0;
        }
        localdhf.HmW = ((f.a.a.a.a)localObject1).OmT.readString();
        AppMethodBeat.o(125807);
        return 0;
      }
      AppMethodBeat.o(125807);
