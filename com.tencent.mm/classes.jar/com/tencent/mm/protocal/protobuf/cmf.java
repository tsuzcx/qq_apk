  ...
  extends cvw
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = f.a.a.b.b.a.bz(3, this.COB);
      AppMethodBeat.o(91621);
      return paramInt + i + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcmf.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91621);
          return 0;
        case 2: 
          localcmf.scene = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(91621);
          return 0;
        }
        localcmf.COB = ((f.a.a.a.a)localObject1).OmT.zc();
        AppMethodBeat.o(91621);
        return 0;
      }
      AppMethodBeat.o(91621);
