  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.TLO != null) {
        paramInt = i + g.a.a.b.b.a.g(2, this.TLO);
      }
      i = paramInt;
      if (this.OmF != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdee.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(250102);
          return 0;
        case 2: 
          localdee.TLO = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(250102);
          return 0;
        }
        localdee.OmF = ((g.a.a.a.a)localObject).abFh.readString();
        AppMethodBeat.o(250102);
        return 0;
      }
      AppMethodBeat.o(250102);
