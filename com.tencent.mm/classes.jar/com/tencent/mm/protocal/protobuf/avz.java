  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.EOc != null)
      {
        paramVarArgs.ln(4, this.EOc.computeSize());
        this.EOc.writeFields(paramVarArgs);
      }
      if (this.EOd != null)
      {
        paramVarArgs.ln(5, this.EOd.computeSize());
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.EOc != null) {
        i = paramInt + f.a.a.a.lm(4, this.EOc.computeSize());
      }
      paramInt = i;
      if (this.EOd != null) {
        paramInt = i + f.a.a.a.lm(5, this.EOd.computeSize());
      }
      AppMethodBeat.o(72484);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localavz.nWx = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(72484);
          return 0;
        case 3: 
          localavz.nWy = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(72484);
          return 0;
        case 4: 
          paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
