  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bz(3, this.Gpf);
      int j = f.a.a.b.b.a.bz(4, this.HEI);
      AppMethodBeat.o(32495);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdwd.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32495);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localdwd.HEN = ((dyb)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32495);
          return 0;
        case 3: 
          localdwd.Gpf = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(32495);
          return 0;
        }
        localdwd.HEI = ((f.a.a.a.a)localObject1).OmT.zc();
        AppMethodBeat.o(32495);
        return 0;
      }
      AppMethodBeat.o(32495);
