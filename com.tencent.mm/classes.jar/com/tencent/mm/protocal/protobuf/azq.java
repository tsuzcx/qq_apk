  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.ByX != null)
      {
        paramVarArgs.ln(4, this.ByX.computeSize());
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.ByX != null) {
        i = paramInt + f.a.a.a.lm(4, this.ByX.computeSize());
      }
      paramInt = i;
      if (this.ELZ != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localazq.nWx = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(91492);
          return 0;
        case 3: 
          localazq.nWy = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91492);
          return 0;
        case 4: 
          paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localazq.ByX = ((c)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91492);
          return 0;
        }
        localazq.ELZ = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(91492);
        return 0;
      }
      AppMethodBeat.o(91492);
