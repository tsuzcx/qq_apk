  ...
  extends buy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = e.a.a.a.iP(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.xli != null) {
        paramInt = i + e.a.a.b.b.a.f(2, this.xli);
      }
      i = paramInt;
      if (this.ntu != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localavt.BaseRequest = ((hq)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(28530);
          return 0;
        case 2: 
          localavt.xli = ((e.a.a.a.a)localObject1).CLY.readString();
          AppMethodBeat.o(28530);
          return 0;
        }
        localavt.ntu = ((e.a.a.a.a)localObject1).CLY.readString();
        AppMethodBeat.o(28530);
        return 0;
      }
      AppMethodBeat.o(28530);
