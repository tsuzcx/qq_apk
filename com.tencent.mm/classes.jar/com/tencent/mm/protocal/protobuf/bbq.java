...
{
  public LinkedList<bbp> ZMj;
  
  public bbq()
  {
    AppMethodBeat.i(259666);
    this.ZMj = new LinkedList();
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ((i.a.a.c.a)paramVarArgs[0]).e(1, 8, this.ZMj);
      AppMethodBeat.o(259669);
      return 0;
    }
    if (paramInt == 1)
    {
      paramInt = i.a.a.a.c(1, 8, this.ZMj);
      AppMethodBeat.o(259669);
      return paramInt + 0;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      while (paramInt < i)
      {
        ...
        if ((localObject != null) && (localObject.length > 0)) {
          localbbp.parseFrom((byte[])localObject);
        }
        localbbq.ZMj.add(localbbp);
        paramInt += 1;
      }
      AppMethodBeat.o(259669);
      return 0;
