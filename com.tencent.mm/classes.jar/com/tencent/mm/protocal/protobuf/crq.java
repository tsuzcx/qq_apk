  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.EjT != null) {
        paramInt = i + f.a.a.b.b.a.e(3, this.EjT);
      }
      AppMethodBeat.o(91687);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcrq.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91687);
          return 0;
        case 2: 
          localcrq.mBH = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(91687);
          return 0;
        }
        localcrq.EjT = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(91687);
        return 0;
      }
      AppMethodBeat.o(91687);
