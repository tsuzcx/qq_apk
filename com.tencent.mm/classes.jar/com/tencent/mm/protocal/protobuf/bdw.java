  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Gxg != null)
      {
        paramVarArgs.lC(2, this.Gxg.computeSize());
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Gxg != null) {
        i = paramInt + f.a.a.a.lB(2, this.Gxg.computeSize());
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localbdw.Gxg = ((dnn)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72491);
          return 0;
        case 3: 
          localbdw.ozR = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(72491);
          return 0;
        }
        localbdw.ozS = ((f.a.a.a.a)localObject1).NPN.readString();
        AppMethodBeat.o(72491);
        return 0;
      }
      AppMethodBeat.o(72491);
