  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aM(3, this.bitrate);
      if (this.uUI != null) {
    ...
    {
      int i = paramInt + g.a.a.b.b.a.bu(2, this.LEL) + g.a.a.b.b.a.bu(3, this.bitrate);
      paramInt = i;
      if (this.uUI != null) {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localatz.dVY = locala.UbS.readString();
          AppMethodBeat.o(209464);
          return 0;
        case 2: 
          localatz.LEL = locala.UbS.zi();
          AppMethodBeat.o(209464);
          return 0;
        case 3: 
          localatz.bitrate = locala.UbS.zi();
          AppMethodBeat.o(209464);
          return 0;
        }
        localatz.uUI = locala.UbS.readString();
        AppMethodBeat.o(209464);
        return 0;
      }
      AppMethodBeat.o(209464);
