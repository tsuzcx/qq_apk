  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.zWG != null) {
        paramInt = i + f.a.a.b.b.a.e(4, this.zWG);
      }
      i = paramInt;
      if (this.dnk != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbwo.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(129970);
          return 0;
        case 2: 
          localbwo.DSX = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(129970);
          return 0;
        case 3: 
          localbwo.signature = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(129970);
          return 0;
        case 4: 
          localbwo.zWG = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(129970);
          return 0;
        }
        localbwo.dnk = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(129970);
        return 0;
      }
      AppMethodBeat.o(129970);
