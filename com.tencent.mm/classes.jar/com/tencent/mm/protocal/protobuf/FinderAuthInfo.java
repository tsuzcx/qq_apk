  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      {
        paramVarArgs.ln(4, this.authGenerator.computeSize());
    ...
    {
      int i = paramInt + f.a.a.b.b.a.bx(2, this.authIconType);
      paramInt = i;
      if (this.authProfession != null) {
      ...
      i = paramInt;
      if (this.authGenerator != null) {
        i = paramInt + f.a.a.a.lm(4, this.authGenerator.computeSize());
      }
      paramInt = i;
      if (this.detailLink != null) {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localFinderAuthInfo.realName = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(168936);
          return 0;
        case 2: 
          localFinderAuthInfo.authIconType = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(168936);
          return 0;
        case 3: 
          localFinderAuthInfo.authProfession = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(168936);
          return 0;
        case 4: 
          ...
          return 0;
        case 5: 
          localFinderAuthInfo.detailLink = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(168936);
          return 0;
        }
        localFinderAuthInfo.appName = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(168936);
        return 0;
      }
      AppMethodBeat.o(168936);
