  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aR(3, this.DCO);
      if (this.DCP != null)
      {
        paramVarArgs.kX(4, this.DCP.computeSize());
        this.DCP.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(32318);
      return 0;
    }
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.CFB != null) {
        i = paramInt + f.a.a.a.kW(2, this.CFB.computeSize());
      }
      i += f.a.a.b.b.a.bA(3, this.DCO);
      paramInt = i;
      if (this.DCP != null) {
        paramInt = i + f.a.a.a.kW(4, this.DCP.computeSize());
      }
      AppMethodBeat.o(32318);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbfl.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32318);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localbfl.CFB = ((bfj)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32318);
          return 0;
        case 3: 
          localbfl.DCO = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(32318);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
        ...
        while (paramInt < i)
        {
          ...
          localbfl.DCP = ((SKBuiltinBuffer_t)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(32318);
        return 0;
