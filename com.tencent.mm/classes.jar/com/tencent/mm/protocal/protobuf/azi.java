  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.oIf != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.oIf);
      }
      AppMethodBeat.o(114021);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localazi.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(114021);
          return 0;
        case 2: 
          localazi.oGs = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(114021);
          return 0;
        }
        localazi.oIf = ((f.a.a.a.a)localObject1).OmT.readString();
        AppMethodBeat.o(114021);
        return 0;
      }
      AppMethodBeat.o(114021);
