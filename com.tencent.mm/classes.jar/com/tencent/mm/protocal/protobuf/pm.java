  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    {
      int i = paramInt + f.a.a.a.c(2, 8, this.FKG) + f.a.a.b.b.a.bz(3, this.qel);
      paramInt = i;
      if (this.qem != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localpm.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32151);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localpm.FKG.add(localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32151);
          return 0;
        case 3: 
          localpm.qel = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(32151);
          return 0;
        }
        localpm.qem = ((f.a.a.a.a)localObject1).NPN.readString();
        AppMethodBeat.o(32151);
        return 0;
      }
      AppMethodBeat.o(32151);
