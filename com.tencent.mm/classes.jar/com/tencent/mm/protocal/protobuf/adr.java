  ...
  extends cvc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bz(3, this.dHZ);
      AppMethodBeat.o(74652);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localadr.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(74652);
          return 0;
        case 2: 
          localadr.duW = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(74652);
          return 0;
        }
        localadr.dHZ = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(74652);
        return 0;
      }
      AppMethodBeat.o(74652);
