  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lm(1, this.GbY.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = f.a.a.b.b.a.bx(3, this.Gcl);
      AppMethodBeat.o(147819);
      return paramInt + i + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localdum.GbN.add(localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(147819);
          return 0;
        }
        localdum.Gcl = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(147819);
        return 0;
      }
      AppMethodBeat.o(147819);
