  ...
  extends dyy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.VHU != null)
      {
        paramVarArgs.oE(2, this.VHU.computeSize());
        this.VHU.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(104795);
      return 0;
    }
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.VHU != null) {
        i = paramInt + g.a.a.a.oD(2, this.VHU.computeSize());
      }
      AppMethodBeat.o(104795);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbud.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(104795);
          return 0;
