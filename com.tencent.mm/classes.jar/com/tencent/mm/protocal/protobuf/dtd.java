  ...
  extends esc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.aaYD != null)
      {
        paramVarArgs.qD(2, this.aaYD.computeSize());
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.aaYD != null) {
        i = paramInt + i.a.a.a.qC(2, this.aaYD.computeSize());
      }
      AppMethodBeat.o(259439);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdtd.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(259439);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localdtd.aaYD = ((dta)localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(259439);
        return 0;
