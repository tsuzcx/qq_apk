  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.dOe != null) {
        i = paramInt + g.a.a.b.b.a.f(3, this.dOe);
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localgl.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(194536);
          return 0;
        case 2: 
          localgl.dNI = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(194536);
          return 0;
        case 3: 
          localgl.dOe = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(194536);
          return 0;
        }
        localgl.scene = ((g.a.a.a.a)localObject1).UbS.zi();
        AppMethodBeat.o(194536);
        return 0;
      }
      AppMethodBeat.o(194536);
