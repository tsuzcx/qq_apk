  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aR(2, this.DRz);
      if (this.Id != null) {
        paramVarArgs.d(3, this.Id);
      }
      if (this.ijt != null) {
        paramVarArgs.d(4, this.ijt);
      }
      if (this.CPi != null)
      {
    ...
    {
      int i = paramInt + f.a.a.b.b.a.bA(2, this.DRz);
      paramInt = i;
      if (this.Id != null) {
      ...
      i = paramInt;
      if (this.ijt != null) {
        i = paramInt + f.a.a.b.b.a.e(4, this.ijt);
      }
      paramInt = i;
      if (this.CPi != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbue.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91556);
          return 0;
        case 2: 
          localbue.DRz = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(91556);
          return 0;
        case 3: 
          localbue.Id = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(91556);
          return 0;
        case 4: 
          localbue.ijt = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(91556);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
