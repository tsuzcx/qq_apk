  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.bz(3, this.GWi);
      AppMethodBeat.o(50088);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbhv.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(50088);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localbhv.GSd = ((eii)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(50088);
          return 0;
        }
        localbhv.GWi = ((f.a.a.a.a)localObject1).OmT.zc();
        AppMethodBeat.o(50088);
        return 0;
      }
      AppMethodBeat.o(50088);
