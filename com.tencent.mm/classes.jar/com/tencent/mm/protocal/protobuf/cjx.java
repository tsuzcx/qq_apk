  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.Fyf != null) {
        i = paramInt + f.a.a.a.lm(4, this.Fyf.computeSize());
      }
      AppMethodBeat.o(91647);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localcjx.nWx = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(91647);
          return 0;
        case 3: 
          localcjx.nWy = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91647);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
        ...
        while (paramInt < i)
        {
          ...
          localObject1 = new bh();
          localObject2 = new f.a.a.a.a((byte[])localObject2, unknownTagHandler);
          for (bool = true; bool; bool = ((bh)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bw.a)localObject1, cqk.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
          localcjx.Fyf = ((bh)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(91647);
        return 0;
