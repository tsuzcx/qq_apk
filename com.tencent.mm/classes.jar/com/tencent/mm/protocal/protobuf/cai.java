  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.GUC != null)
      {
        paramVarArgs.lC(2, this.GUC.computeSize());
    ...
    for (paramInt = f.a.a.b.b.a.e(1, this.GUK) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.GUC != null) {
        i = paramInt + f.a.a.a.lB(2, this.GUC.computeSize());
      }
      AppMethodBeat.o(32352);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localcai.GUK = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(32352);
          return 0;
        }
        ...
        while (paramInt < i)
        {
          ...
          for (boolean bool = true; bool; bool = ((ckj)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bx.a)localObject1, com.tencent.mm.bx.a.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
          localcai.GUC = ((ckj)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(32352);
        return 0;
