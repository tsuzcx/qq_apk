  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.DuL != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.DuL);
      }
      i = paramInt;
      if (this.DuM != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localavj.DuL = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(125733);
          return 0;
        }
        localavj.DuM = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(125733);
        return 0;
      }
      AppMethodBeat.o(125733);
