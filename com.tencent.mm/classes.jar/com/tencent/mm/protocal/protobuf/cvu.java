      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcvu.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(32303);
          return 0;
        case 2: 
          localcvu.aaAX = ((i.a.a.a.a)localObject1).ajGk.aar();
          AppMethodBeat.o(32303);
          return 0;
        }
        paramVarArgs = ((i.a.a.a.a)localObject1).aMP(paramInt);
        ...
        {
          localObject1 = (byte[])paramVarArgs.get(paramInt);
          localObject2 = new gdi();
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((gdi)localObject2).parseFrom((byte[])localObject1);
          }
          localcvu.aaAY.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(32303);
        return 0;
