  ...
  extends com.tencent.mm.cd.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ((g.a.a.c.a)paramVarArgs[0]).e(1, 8, this.UkP);
      AppMethodBeat.o(104837);
      return 0;
    }
    if (paramInt == 1)
    {
      paramInt = g.a.a.a.c(1, 8, this.UkP);
      AppMethodBeat.o(104837);
      return paramInt + 0;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      while (paramInt < i)
      {
        ...
        eiw localeiw = new eiw();
        if ((localObject != null) && (localObject.length > 0)) {
          localeiw.parseFrom((byte[])localObject);
        }
        localeiv.UkP.add(localeiw);
        paramInt += 1;
      }
      AppMethodBeat.o(104837);
      return 0;
