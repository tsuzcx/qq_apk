  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.tVM != null) {
        i = paramInt + g.a.a.b.b.a.b(3, this.tVM);
      }
      paramInt = i;
      if (this.query != null) {
      ...
      i = paramInt;
      if (this.finderUsername != null) {
        i = paramInt + g.a.a.b.b.a.f(5, this.finderUsername);
      }
      AppMethodBeat.o(209663);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbbs.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(209663);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localbbs.uli = ((aov)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(209663);
          return 0;
        case 3: 
          localbbs.tVM = ((g.a.a.a.a)localObject1).UbS.hPo();
          AppMethodBeat.o(209663);
          return 0;
        case 4: 
          localbbs.query = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(209663);
          return 0;
        }
        localbbs.finderUsername = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(209663);
        return 0;
      }
      AppMethodBeat.o(209663);
