...
{
  public LinkedList<adu> ZpS;
  
  public ags()
  {
    AppMethodBeat.i(32179);
    this.ZpS = new LinkedList();
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ((i.a.a.c.a)paramVarArgs[0]).e(1, 8, this.ZpS);
      AppMethodBeat.o(32180);
      return 0;
    }
    if (paramInt == 1)
    {
      paramInt = i.a.a.a.c(1, 8, this.ZpS);
      AppMethodBeat.o(32180);
      return paramInt + 0;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      while (paramInt < i)
      {
        ...
        if ((localObject != null) && (localObject.length > 0)) {
          localadu.parseFrom((byte[])localObject);
        }
