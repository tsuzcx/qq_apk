  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.LyZ != null) {
        paramInt = i + f.a.a.b.b.a.b(3, this.LyZ);
      }
      AppMethodBeat.o(202533);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localebr.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(202533);
          return 0;
        case 2: 
          localebr.LwA = ((f.a.a.a.a)localObject1).KhF.xT();
          AppMethodBeat.o(202533);
          return 0;
        }
        localebr.LyZ = ((f.a.a.a.a)localObject1).KhF.fMu();
        AppMethodBeat.o(202533);
        return 0;
      }
      AppMethodBeat.o(202533);
