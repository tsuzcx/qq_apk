  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.CAL != null)
      {
        paramVarArgs.kX(4, this.CAL.computeSize());
        this.CAL.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(72479);
      return 0;
    }
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.CAL != null) {
        i = paramInt + f.a.a.a.kW(4, this.CAL.computeSize());
      }
      AppMethodBeat.o(72479);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localapw.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72479);
          return 0;
        case 2: 
          localapw.dcG = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(72479);
          return 0;
        case 3: 
          localapw.nTK = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(72479);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
