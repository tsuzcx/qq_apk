  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = f.a.a.a.c(4, 1, this.CJF);
      AppMethodBeat.o(124430);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 3: 
          localmq.ProductID = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(124430);
          return 0;
        }
        localmq.CJF.add(((f.a.a.a.a)localObject1).KhF.readString());
        AppMethodBeat.o(124430);
        return 0;
      }
      AppMethodBeat.o(124430);
