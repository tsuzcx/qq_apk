  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ((i.a.a.c.a)paramVarArgs[0]).e(1, 8, this.aaca);
      AppMethodBeat.o(259161);
      return 0;
    }
    if (paramInt == 1)
    {
      paramInt = i.a.a.a.c(1, 8, this.aaca);
      AppMethodBeat.o(259161);
      return paramInt + 0;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      while (paramInt < i)
      {
        ...
        if ((localObject != null) && (localObject.length > 0)) {
          localbuk.parseFrom((byte[])localObject);
        }
        localbuj.aaca.add(localbuk);
        paramInt += 1;
      }
      AppMethodBeat.o(259161);
      return 0;
