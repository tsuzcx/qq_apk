  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    {
      int i = paramInt + f.a.a.b.b.a.bx(2, this.ndH) + f.a.a.b.b.a.bx(3, this.FAV);
      paramInt = i;
      if (this.FAW != null) {
        paramInt = i + f.a.a.a.lm(4, this.FAW.computeSize());
      }
      i = f.a.a.b.b.a.bx(5, this.FAX);
      AppMethodBeat.o(32412);
      return paramInt + i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcnv.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32412);
          return 0;
        case 2: 
          localcnv.ndH = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(32412);
          return 0;
        case 3: 
          localcnv.FAV = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(32412);
          return 0;
        case 4: 
          paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localcnv.FAW = ((dqq)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32412);
          return 0;
        }
        localcnv.FAX = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(32412);
        return 0;
      }
      AppMethodBeat.o(32412);
