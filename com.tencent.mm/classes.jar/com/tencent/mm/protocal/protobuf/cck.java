  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.Mis != null) {
        paramInt = i + g.a.a.b.b.a.f(2, this.Mis);
      }
      i = paramInt;
      if (this.iAc != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcck.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32330);
          return 0;
        case 2: 
          localcck.Mis = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(32330);
          return 0;
        }
        localcck.iAc = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(32330);
        return 0;
      }
      AppMethodBeat.o(32330);
