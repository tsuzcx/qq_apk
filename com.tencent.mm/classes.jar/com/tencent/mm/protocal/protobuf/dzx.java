  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.MYW != null)
      {
        paramVarArgs.ni(3, this.MYW.computeSize());
    ...
    {
      int i = paramInt + g.a.a.b.b.a.bu(2, this.CreateTime);
      paramInt = i;
      if (this.MYW != null) {
        paramInt = i + g.a.a.a.nh(3, this.MYW.computeSize());
      }
      AppMethodBeat.o(125786);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localdzx.Username = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(125786);
          return 0;
        case 2: 
          localdzx.CreateTime = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(125786);
          return 0;
        }
        ...
        while (paramInt < i)
        {
          ...
          localdzx.MYW = ((SKBuiltinBuffer_t)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(125786);
        return 0;
