  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.DWE != null)
      {
        paramVarArgs.ln(2, this.DWE.computeSize());
    ...
    if (paramInt == 1)
    {
      ...
      paramInt = i;
      if (this.DWE != null) {
        paramInt = i + f.a.a.a.lm(2, this.DWE.computeSize());
      }
      AppMethodBeat.o(140925);
      return paramInt;
    }
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localit.dataType = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(140925);
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        localit.DWE = ((SKBuiltinBuffer_t)localObject1);
        paramInt += 1;
      }
      AppMethodBeat.o(140925);
      return 0;
