  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.CEe != null)
      {
        paramVarArgs.kX(2, this.CEe.computeSize());
        this.CEe.writeFields(paramVarArgs);
      }
    ...
    if (paramInt == 1)
    {
      ...
      paramInt = i;
      if (this.CEe != null) {
        paramInt = i + f.a.a.a.kW(2, this.CEe.computeSize());
      }
      AppMethodBeat.o(140925);
      return paramInt;
    }
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localin.dataType = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(140925);
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        localin.CEe = ((SKBuiltinBuffer_t)localObject1);
        paramInt += 1;
      }
      AppMethodBeat.o(140925);
      return 0;
