  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.Tlg != null) {
        i = paramInt + g.a.a.b.b.a.g(3, this.Tlg);
      }
      AppMethodBeat.o(153282);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcdj.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(153282);
          return 0;
        case 2: 
          localcdj.username = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(153282);
          return 0;
        }
        localcdj.Tlg = ((g.a.a.a.a)localObject).abFh.readString();
        AppMethodBeat.o(153282);
        return 0;
      }
      AppMethodBeat.o(153282);
