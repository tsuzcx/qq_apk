  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.TfK != null) {
        paramInt = i + g.a.a.b.b.a.g(2, this.TfK);
      }
      i = paramInt;
      if (this.SqY != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localevk.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(72613);
          return 0;
        case 2: 
          localevk.TfK = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(72613);
          return 0;
        }
        localevk.SqY = ((g.a.a.a.a)localObject).abFh.readString();
        AppMethodBeat.o(72613);
        return 0;
      }
      AppMethodBeat.o(72613);
