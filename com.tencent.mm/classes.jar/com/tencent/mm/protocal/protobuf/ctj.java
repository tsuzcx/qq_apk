  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Hgi != null)
      {
        paramVarArgs.lJ(2, this.Hgi.computeSize());
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Hgi != null) {
        i = paramInt + f.a.a.a.lI(2, this.Hgi.computeSize());
      }
      AppMethodBeat.o(215600);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localctj.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(215600);
          return 0;
