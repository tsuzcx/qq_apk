...
public final class dkx
  extends esc
{
  public LinkedList<dkv> aaQQ;
  
  public dkx()
  {
    AppMethodBeat.i(124530);
    this.aaQQ = new LinkedList();
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdkx.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(124531);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localdkx.aaQQ.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(124531);
        return 0;
