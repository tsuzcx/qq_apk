  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.CWR != null)
      {
        paramVarArgs.kX(4, this.CWR.computeSize());
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.CWR != null) {
        i = paramInt + f.a.a.a.kW(4, this.CWR.computeSize());
      }
      AppMethodBeat.o(91469);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localami.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91469);
          return 0;
        case 2: 
          localami.ntx = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(91469);
          return 0;
        case 3: 
          localami.nty = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(91469);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
