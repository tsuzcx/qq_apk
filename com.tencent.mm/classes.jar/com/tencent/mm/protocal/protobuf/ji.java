      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localji.BaseRequest = ((jg)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(227462);
          return 0;
        case 2: 
          localji.rVx = ((g.a.a.a.a)localObject1).abFh.AK();
          AppMethodBeat.o(227462);
          return 0;
        }
        paramVarArgs = ((g.a.a.a.a)localObject1).aGc(paramInt);
        ...
        while (paramInt < i)
        {
          ...
          localObject2 = new yb();
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((yb)localObject2).parseFrom((byte[])localObject1);
          }
          localji.rVy.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(227462);
        return 0;
