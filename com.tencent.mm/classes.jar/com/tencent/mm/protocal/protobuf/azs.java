  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.EOc != null)
      {
        paramVarArgs.ln(2, this.EOc.computeSize());
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.EOc != null) {
        i = paramInt + f.a.a.a.lm(2, this.EOc.computeSize());
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localazs.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72491);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localazs.EOc = ((dhy)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72491);
          return 0;
        case 3: 
          localazs.nWx = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(72491);
          return 0;
        }
        localazs.nWy = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(72491);
        return 0;
      }
      AppMethodBeat.o(72491);
