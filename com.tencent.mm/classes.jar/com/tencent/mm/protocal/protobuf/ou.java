  ...
  extends erp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = i.a.a.a.qC(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.hAB != null) {
        i = paramInt + i.a.a.b.b.a.h(3, this.hAB);
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localou.BaseRequest = localkc;
            paramInt += 1;
          }
          AppMethodBeat.o(124422);
          return 0;
        case 2: 
          localou.YRQ = ((i.a.a.a.a)localObject).ajGk.readString();
          AppMethodBeat.o(124422);
          return 0;
        case 3: 
          localou.hAB = ((i.a.a.a.a)localObject).ajGk.readString();
          AppMethodBeat.o(124422);
          return 0;
        }
        localou.offset = ((i.a.a.a.a)localObject).ajGk.aar();
        AppMethodBeat.o(124422);
        return 0;
      }
      AppMethodBeat.o(124422);
