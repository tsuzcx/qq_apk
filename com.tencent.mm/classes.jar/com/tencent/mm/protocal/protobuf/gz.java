  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.KKH != null)
      {
        paramVarArgs.ni(4, this.KKH.computeSize());
        this.KKH.writeFields(paramVarArgs);
      }
      if (this.KKI != null) {
        paramVarArgs.e(5, this.KKI);
      }
      AppMethodBeat.o(72418);
      return 0;
    }
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.KKH != null) {
        i = paramInt + g.a.a.a.nh(4, this.KKH.computeSize());
      }
      paramInt = i;
      if (this.KKI != null) {
        paramInt = i + g.a.a.b.b.a.f(5, this.KKI);
      }
      AppMethodBeat.o(72418);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localgz.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72418);
          return 0;
        case 2: 
          localgz.dDN = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(72418);
          return 0;
        case 3: 
          localgz.qwn = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(72418);
          return 0;
        case 4: 
          paramVarArgs = ((g.a.a.a.a)localObject1).awh(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localgz.KKH = ((jg)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72418);
          return 0;
        }
        localgz.KKI = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(72418);
        return 0;
      }
      AppMethodBeat.o(72418);
