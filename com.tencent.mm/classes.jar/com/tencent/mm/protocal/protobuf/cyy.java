  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.HIY != null)
      {
        paramVarArgs.lJ(2, this.HIY.computeSize());
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.HIY != null) {
        i = paramInt + f.a.a.a.lI(2, this.HIY.computeSize());
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localcyy.HIY = ((qt)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(117910);
          return 0;
        }
        localcyy.GeT = ((f.a.a.a.a)localObject1).OmT.zc();
        AppMethodBeat.o(117910);
        return 0;
      }
      AppMethodBeat.o(117910);
