  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.BannerImg != null)
      {
        paramVarArgs.ln(1, this.BannerImg.computeSize());
      ...
      paramVarArgs.aR(4, this.ID);
      if (this.SecondUrl != null) {
        paramVarArgs.d(5, this.SecondUrl);
      }
      paramVarArgs.aR(6, this.SetType);
    ...
    label878:
    for (int i = f.a.a.a.lm(1, this.BannerImg.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.Title != null) {
      ...
      i += f.a.a.b.b.a.bx(4, this.ID);
      paramInt = i;
      if (this.SecondUrl != null) {
        paramInt = i + f.a.a.b.b.a.e(5, this.SecondUrl);
      }
      i = paramInt + f.a.a.b.b.a.bx(6, this.SetType);
      paramInt = i;
      if (this.IconUrl != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localEmotionBannerSet.Title = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(104770);
          return 0;
        case 3: 
          localEmotionBannerSet.LocateUrl = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(104770);
          return 0;
        case 4: 
          localEmotionBannerSet.ID = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(104770);
          return 0;
        case 5: 
          localEmotionBannerSet.SecondUrl = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(104770);
          return 0;
        case 6: 
          localEmotionBannerSet.SetType = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(104770);
          return 0;
        case 7: 
          localEmotionBannerSet.IconUrl = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(104770);
          return 0;
        case 8: 
          localEmotionBannerSet.Desc = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(104770);
          return 0;
        case 9: 
          localEmotionBannerSet.ProductID = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(104770);
          return 0;
        }
        localEmotionBannerSet.TagUrl = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(104770);
        return 0;
      }
      AppMethodBeat.o(104770);
