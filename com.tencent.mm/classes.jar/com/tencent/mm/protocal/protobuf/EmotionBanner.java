  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.BannerSummary != null)
      {
        paramVarArgs.kX(1, this.BannerSummary.computeSize());
        this.BannerSummary.writeFields(paramVarArgs);
      }
      if (this.BannerImg != null)
      {
        paramVarArgs.kX(2, this.BannerImg.computeSize());
    ...
    label562:
    for (paramInt = f.a.a.a.kW(1, this.BannerSummary.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.BannerImg != null) {
        i = paramInt + f.a.a.a.kW(2, this.BannerImg.computeSize());
      }
      AppMethodBeat.o(104768);
      return i;
      if (paramInt == 2)
