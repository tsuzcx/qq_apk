  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Tlw != null) {
        i = paramInt + g.a.a.b.b.a.g(2, this.Tlw);
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcdp.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(32269);
          return 0;
        case 2: 
          localcdp.Tlw = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(32269);
          return 0;
        }
        localcdp.CPw = ((g.a.a.a.a)localObject).abFh.AK();
        AppMethodBeat.o(32269);
        return 0;
      }
      AppMethodBeat.o(32269);
