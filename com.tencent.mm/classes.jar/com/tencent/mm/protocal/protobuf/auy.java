  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Duy != null) {
        paramVarArgs.d(2, this.Duy);
      }
      if (this.DsX != null)
      {
        paramVarArgs.kX(3, this.DsX.computeSize());
    ...
    for (int i = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.Duy != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.Duy);
      }
      i = paramInt;
      if (this.DsX != null) {
        i = paramInt + f.a.a.a.kW(3, this.DsX.computeSize());
      }
      AppMethodBeat.o(72488);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localauy.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72488);
          return 0;
        case 2: 
          localauy.Duy = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(72488);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
