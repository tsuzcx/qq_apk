  ...
  extends com.tencent.mm.cd.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.oD(1, this.UGy.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = g.a.a.b.b.a.bM(3, this.UGL);
      AppMethodBeat.o(147819);
      return paramInt + i + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localfgq.UGn.add(localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(147819);
          return 0;
        }
        localfgq.UGL = ((g.a.a.a.a)localObject1).abFh.AK();
        AppMethodBeat.o(147819);
        return 0;
      }
      AppMethodBeat.o(147819);
