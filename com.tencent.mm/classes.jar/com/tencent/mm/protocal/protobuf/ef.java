  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.signature != null) {
        paramVarArgs.f(1, this.signature);
      }
      if (this.ufq != null) {
    ...
    label274:
    for (paramInt = g.a.a.b.b.a.g(1, this.signature) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.ufq != null) {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localef.signature = locala.abFh.readString();
          AppMethodBeat.o(152489);
          return 0;
        }
        localef.ufq = locala.abFh.readString();
        AppMethodBeat.o(152489);
        return 0;
      }
      AppMethodBeat.o(152489);
