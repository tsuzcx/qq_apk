  ...
  extends esc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.e(3, 8, this.aaAb);
      paramVarArgs.bS(4, this.aaAc);
      AppMethodBeat.o(82420);
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i.a.a.a.c(3, 8, this.aaAb);
      int j = i.a.a.b.b.a.cJ(4, this.aaAc);
      AppMethodBeat.o(82420);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcuo.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(82420);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localcuo.aaAa = ((fvg)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(82420);
          return 0;
        case 3: 
          ...
          {
            localObject1 = (byte[])paramVarArgs.get(paramInt);
            localObject2 = new fuq();
            if ((localObject1 != null) && (localObject1.length > 0)) {
              ((fuq)localObject2).parseFrom((byte[])localObject1);
            }
            localcuo.aaAb.add(localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(82420);
          return 0;
        }
        localcuo.aaAc = ((i.a.a.a.a)localObject1).ajGk.aar();
        AppMethodBeat.o(82420);
        return 0;
      }
      AppMethodBeat.o(82420);
