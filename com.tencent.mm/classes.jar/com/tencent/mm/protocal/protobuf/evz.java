  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Uxp != null)
      {
        paramVarArgs.oE(2, this.Uxp.computeSize());
        this.Uxp.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(32475);
      return 0;
    }
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Uxp != null) {
        i = paramInt + g.a.a.a.oD(2, this.Uxp.computeSize());
      }
      AppMethodBeat.o(32475);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localevz.BaseRequest = ((jg)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(32475);
          return 0;
