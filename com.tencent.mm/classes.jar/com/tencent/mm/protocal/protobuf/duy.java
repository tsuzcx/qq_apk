  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.Gbt != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.Gbt);
      }
      AppMethodBeat.o(123677);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localduy.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(123677);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localduy.HqD = ((he)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(123677);
          return 0;
        }
        localduy.Gbt = ((f.a.a.a.a)localObject1).NPN.readString();
        AppMethodBeat.o(123677);
        return 0;
      }
      AppMethodBeat.o(123677);
