  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.EPH != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.EPH);
      }
      i = paramInt;
      if (this.Eua != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdku.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72613);
          return 0;
        case 2: 
          localdku.EPH = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(72613);
          return 0;
        }
        localdku.Eua = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(72613);
        return 0;
      }
      AppMethodBeat.o(72613);
