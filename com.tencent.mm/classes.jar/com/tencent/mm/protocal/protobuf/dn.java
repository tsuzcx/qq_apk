  ...
  extends buy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.ReqBuf != null)
      {
        paramVarArgs.iQ(3, this.ReqBuf.computeSize());
    ...
    for (paramInt = e.a.a.a.iP(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.ReqBuf != null) {
        paramInt = i + e.a.a.a.iP(3, this.ReqBuf.computeSize());
      }
      AppMethodBeat.o(80014);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdn.BaseRequest = ((hq)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(80014);
          return 0;
        case 2: 
          localdn.jKs = ((e.a.a.a.a)localObject1).CLY.sl();
          AppMethodBeat.o(80014);
          return 0;
        }
        paramVarArgs = ((e.a.a.a.a)localObject1).Wp(paramInt);
        ...
        while (paramInt < i)
        {
          ...
          localdn.ReqBuf = ((SKBuiltinBuffer_t)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(80014);
        return 0;
