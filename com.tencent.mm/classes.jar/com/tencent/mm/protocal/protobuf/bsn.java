  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = g.a.a.b.b.a.bM(3, this.RPe);
      AppMethodBeat.o(101814);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbsn.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(101814);
          return 0;
        case 2: 
          localbsn.TcP = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(101814);
          return 0;
        }
        localbsn.RPe = ((g.a.a.a.a)localObject).abFh.AK();
        AppMethodBeat.o(101814);
        return 0;
      }
      AppMethodBeat.o(101814);
