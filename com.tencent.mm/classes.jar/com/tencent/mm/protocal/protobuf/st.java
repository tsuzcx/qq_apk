  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = f.a.a.b.b.a.bx(6, this.EmS);
      AppMethodBeat.o(91409);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localst.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91409);
          return 0;
        case 2: 
          localst.dae = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(91409);
          return 0;
        case 3: 
          localst.oxf = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91409);
          return 0;
        case 4: 
          localst.EmR = ((f.a.a.a.a)localObject1).LVo.gfk();
          AppMethodBeat.o(91409);
          return 0;
        case 5: 
          localst.EgR = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(91409);
          return 0;
        }
        localst.EmS = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(91409);
        return 0;
      }
      AppMethodBeat.o(91409);
