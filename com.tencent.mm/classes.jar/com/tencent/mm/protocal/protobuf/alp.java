  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Dlx != null)
      {
        paramVarArgs.kX(3, this.Dlx.computeSize());
    ...
    for (int i = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.Dlx != null) {
        i = paramInt + f.a.a.a.kW(3, this.Dlx.computeSize());
      }
      AppMethodBeat.o(169065);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localalp.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(169065);
          return 0;
        case 2: 
          localalp.query = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(169065);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
