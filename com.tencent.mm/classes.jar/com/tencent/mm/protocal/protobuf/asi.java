  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.DsB != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.DsB);
      }
      AppMethodBeat.o(90967);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localasi.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(90967);
          return 0;
        case 2: 
          localasi.dlB = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(90967);
          return 0;
        }
        localasi.DsB = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(90967);
        return 0;
      }
      AppMethodBeat.o(90967);
