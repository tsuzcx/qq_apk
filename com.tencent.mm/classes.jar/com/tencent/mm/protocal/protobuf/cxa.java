  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.HQm != null) {
        paramInt = i + g.a.a.b.b.a.f(4, this.HQm);
      }
      i = paramInt;
      if (this.dPr != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcxa.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(129970);
          return 0;
        case 2: 
          localcxa.MBA = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(129970);
          return 0;
        case 3: 
          localcxa.signature = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(129970);
          return 0;
        case 4: 
          localcxa.HQm = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(129970);
          return 0;
        }
        localcxa.dPr = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(129970);
        return 0;
      }
      AppMethodBeat.o(129970);
