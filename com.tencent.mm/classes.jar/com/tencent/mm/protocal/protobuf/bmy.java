  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.FbS != null)
      {
        paramVarArgs.ln(4, this.FbS.computeSize());
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i += f.a.a.b.b.a.bx(3, this.FbR);
      paramInt = i;
      if (this.FbS != null) {
        paramInt = i + f.a.a.a.lm(4, this.FbS.computeSize());
      }
      AppMethodBeat.o(123620);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbmy.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(123620);
          return 0;
        case 2: 
          localbmy.hOf = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(123620);
          return 0;
        case 3: 
          localbmy.FbR = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(123620);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
