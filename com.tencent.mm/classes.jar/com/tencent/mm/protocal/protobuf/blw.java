  ...
  extends com.tencent.mm.cd.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aY(3, this.oxQ);
      AppMethodBeat.o(32211);
      return 0;
    }
    if (paramInt == 1)
    {
      int i = g.a.a.b.b.a.bM(1, this.index) + 0;
      paramInt = i;
      if (this.username != null) {
        paramInt = i + g.a.a.b.b.a.g(2, this.username);
      }
      i = g.a.a.b.b.a.bM(3, this.oxQ);
      AppMethodBeat.o(32211);
      return paramInt + i;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localblw.index = locala.abFh.AK();
        AppMethodBeat.o(32211);
        return 0;
      case 2: 
        localblw.username = locala.abFh.readString();
        AppMethodBeat.o(32211);
        return 0;
      }
      localblw.oxQ = locala.abFh.AK();
      AppMethodBeat.o(32211);
      return 0;
    }
    AppMethodBeat.o(32211);
