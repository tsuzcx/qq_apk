  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.MnG != null) {
        paramInt = i + g.a.a.b.b.a.b(3, this.MnG);
      }
      AppMethodBeat.o(207514);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdvs.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(207514);
          return 0;
        case 2: 
          localdvs.hyH = ((g.a.a.a.a)localObject1).UbS.zl();
          AppMethodBeat.o(207514);
          return 0;
        }
        localdvs.MnG = ((g.a.a.a.a)localObject1).UbS.hPo();
        AppMethodBeat.o(207514);
        return 0;
      }
      AppMethodBeat.o(207514);
