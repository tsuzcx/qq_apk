  ...
  extends dyy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.UmN != null)
      {
        paramVarArgs.oE(2, this.UmN.computeSize());
        this.UmN.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(125823);
      return 0;
    }
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.UmN != null) {
        i = paramInt + g.a.a.a.oD(2, this.UmN.computeSize());
      }
      AppMethodBeat.o(125823);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localela.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(125823);
          return 0;
