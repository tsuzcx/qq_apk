  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.oGB != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.oGB);
      }
      paramInt = i;
      if (this.signature != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbfm.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(82418);
          return 0;
        case 2: 
          localbfm.djj = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(82418);
          return 0;
        case 3: 
          localbfm.oGB = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(82418);
          return 0;
        }
        localbfm.signature = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(82418);
        return 0;
      }
      AppMethodBeat.o(82418);
