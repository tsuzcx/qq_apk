    ...
    for (paramInt = g.a.a.b.b.a.f(1, this.iyZ) + 0;; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localeeq.iyZ = locala.UbS.readString();
          AppMethodBeat.o(127178);
          return 0;
        case 2: 
          localeeq.LxJ = locala.UbS.zi();
          AppMethodBeat.o(127178);
          return 0;
        case 3: 
          localeeq.izc = locala.UbS.readString();
          AppMethodBeat.o(127178);
          return 0;
        case 4: 
          localeeq.izd = locala.UbS.readString();
          AppMethodBeat.o(127178);
          return 0;
        case 5: 
          localeeq.izb = locala.UbS.readString();
          AppMethodBeat.o(127178);
          return 0;
        case 6: 
          localeeq.ize = locala.UbS.readString();
          AppMethodBeat.o(127178);
          return 0;
        case 7: 
          localeeq.izf = locala.UbS.readString();
          AppMethodBeat.o(127178);
          return 0;
        }
        localeeq.izg = locala.UbS.readString();
        AppMethodBeat.o(127178);
        return 0;
      }
      AppMethodBeat.o(127178);
