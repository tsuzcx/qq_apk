  ...
  extends dyy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.TuJ != null)
      {
        paramVarArgs.oE(3, this.TuJ.computeSize());
    ...
    for (int i = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.Tun != null) {
        paramInt = i + g.a.a.a.oD(2, this.Tun.computeSize());
      }
      i = paramInt;
      if (this.TuJ != null) {
        i = paramInt + g.a.a.a.oD(3, this.TuJ.computeSize());
      }
      AppMethodBeat.o(82443);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcnc.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(82443);
          return 0;
