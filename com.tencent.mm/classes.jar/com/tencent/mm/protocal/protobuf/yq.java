      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localyq.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(127452);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localObject2 = new yr();
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((yr)localObject2).parseFrom((byte[])localObject1);
          }
          localyq.SkQ.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(127452);
        return 0;
