  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int n = f.a.a.b.b.a.bx(6, this.Ekd);
      AppMethodBeat.o(206453);
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localazv.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(206453);
          return 0;
        case 2: 
          localazv.offset = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(206453);
          return 0;
        case 3: 
          localazv.Eke = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(206453);
          return 0;
        case 4: 
          localazv.latitude = Double.longBitsToDouble(((f.a.a.a.a)localObject1).LVo.gab());
          AppMethodBeat.o(206453);
          return 0;
        case 5: 
          localazv.longitude = Double.longBitsToDouble(((f.a.a.a.a)localObject1).LVo.gab());
          AppMethodBeat.o(206453);
          return 0;
        }
        localazv.Ekd = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(206453);
        return 0;
      }
      AppMethodBeat.o(206453);
