  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.cc(2, this.KKE);
      if (this.KKF != null) {
        paramVarArgs.e(3, this.KKF);
      }
      AppMethodBeat.o(207506);
      return 0;
    }
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.KKF != null) {
        paramInt = i + g.a.a.b.b.a.f(3, this.KKF);
      }
      AppMethodBeat.o(207506);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localcjg.KKE = ((g.a.a.a.a)localObject1).UbS.yZ();
          AppMethodBeat.o(207506);
          return 0;
        }
        localcjg.KKF = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(207506);
        return 0;
      }
      AppMethodBeat.o(207506);
