  ...
  extends dyy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = g.a.a.b.b.a.bM(3, this.Ute);
      AppMethodBeat.o(32463);
      return paramInt + i + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localeqq.BaseResponse = localjh;
            paramInt += 1;
          }
          AppMethodBeat.o(32463);
          return 0;
        case 2: 
          localeqq.Svw = ((g.a.a.a.a)localObject).abFh.AK();
          AppMethodBeat.o(32463);
          return 0;
        }
        localeqq.Ute = ((g.a.a.a.a)localObject).abFh.AK();
        AppMethodBeat.o(32463);
        return 0;
      }
      AppMethodBeat.o(32463);
