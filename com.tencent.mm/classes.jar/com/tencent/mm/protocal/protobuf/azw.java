  ...
  extends cvc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Gxf != null)
      {
        paramVarArgs.lC(4, this.Gxf.computeSize());
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.FWx != null) {
        i = paramInt + f.a.a.b.b.a.e(2, this.FWx);
      }
      i += f.a.a.b.b.a.p(3, this.Gbu);
      paramInt = i;
      if (this.Gxf != null) {
        paramInt = i + f.a.a.a.lB(4, this.Gxf.computeSize());
      }
      AppMethodBeat.o(72483);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localazw.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72483);
          return 0;
        case 2: 
          localazw.FWx = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(72483);
          return 0;
        case 3: 
          localazw.Gbu = ((f.a.a.a.a)localObject1).NPN.zd();
          AppMethodBeat.o(72483);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).alQ(paramInt);
