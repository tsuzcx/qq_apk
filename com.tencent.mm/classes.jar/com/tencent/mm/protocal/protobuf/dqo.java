  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aS(4, this.HXo);
      paramVarArgs.e(5, 8, this.HXw);
      if (this.HXm != null)
      {
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt + f.a.a.b.b.a.bz(4, this.HXo) + f.a.a.a.c(5, 8, this.HXw);
      paramInt = i;
      if (this.HXm != null) {
        paramInt = i + f.a.a.a.lI(6, this.HXm.computeSize());
      }
      AppMethodBeat.o(72611);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localdqo.oGt = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(72611);
          return 0;
        case 3: 
          localdqo.oGu = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(72611);
          return 0;
        case 4: 
          localdqo.HXo = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(72611);
          return 0;
        case 5: 
          paramVarArgs = ((f.a.a.a.a)localObject1).amA(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localObject2 = new f.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = ((btg)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bw.a)localObject1, cwj.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
            localdqo.HXw.add(localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72611);
          return 0;
