  ...
  extends esc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.aaqm != null)
      {
        paramVarArgs.qD(2, this.aaqm.computeSize());
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.aaqm != null) {
        i = paramInt + i.a.a.a.qC(2, this.aaqm.computeSize());
      }
      AppMethodBeat.o(110901);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localchl.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(110901);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localchl.aaqm = ((acw)localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(110901);
        return 0;
