...
public final class dkm
  extends esc
{
  public LinkedList<dkn> aaQs;
  
  public dkm()
  {
    AppMethodBeat.i(152625);
    this.aaQs = new LinkedList();
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdkm.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(152626);
          return 0;
        ...
        {
          localObject1 = (byte[])paramVarArgs.get(paramInt);
          localObject2 = new dkn();
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((dkn)localObject2).parseFrom((byte[])localObject1);
          }
          localdkm.aaQs.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(152626);
        return 0;
