  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.GvR != null)
      {
        paramVarArgs.lJ(2, this.GvR.computeSize());
        this.GvR.writeFields(paramVarArgs);
      }
      paramVarArgs.aS(3, this.nJA);
      paramVarArgs.aS(4, this.GvS);
      AppMethodBeat.o(152537);
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.GvR != null) {
        i = paramInt + f.a.a.a.lI(2, this.GvR.computeSize());
      }
      paramInt = f.a.a.b.b.a.bz(3, this.nJA);
      int j = f.a.a.b.b.a.bz(4, this.GvS);
      AppMethodBeat.o(152537);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localafl.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(152537);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localafl.GvR = ((SKBuiltinBuffer_t)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(152537);
          return 0;
        case 3: 
          localafl.nJA = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(152537);
          return 0;
        }
        localafl.GvS = ((f.a.a.a.a)localObject1).OmT.zc();
        AppMethodBeat.o(152537);
        return 0;
      }
      AppMethodBeat.o(152537);
