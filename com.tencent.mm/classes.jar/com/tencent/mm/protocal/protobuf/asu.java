...
{
  public LinkedList<fll> field_info;
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ((i.a.a.c.a)paramVarArgs[0]).e(1, 8, this.field_info);
      AppMethodBeat.o(91462);
      return 0;
    }
    if (paramInt == 1)
    {
      paramInt = i.a.a.a.c(1, 8, this.field_info);
      AppMethodBeat.o(91462);
      return paramInt + 0;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      while (paramInt < i)
      {
        ...
        fll localfll = new fll();
        if ((localObject != null) && (localObject.length > 0)) {
          localfll.parseFrom((byte[])localObject);
        }
        localasu.field_info.add(localfll);
        paramInt += 1;
      }
      AppMethodBeat.o(91462);
      return 0;
