  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.DxU != null)
      {
        paramVarArgs.kX(2, this.DxU.computeSize());
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.DxU != null) {
        i = paramInt + f.a.a.a.kW(2, this.DxU.computeSize());
      }
      AppMethodBeat.o(72546);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbzq.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72546);
          return 0;
