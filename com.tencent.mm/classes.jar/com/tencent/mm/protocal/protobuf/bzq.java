  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.FoB != null) {
        paramInt = i + f.a.a.b.b.a.e(3, this.FoB);
      }
      AppMethodBeat.o(32362);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbzq.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32362);
          return 0;
        case 2: 
          localbzq.fZz = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(32362);
          return 0;
        }
        localbzq.FoB = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(32362);
        return 0;
      }
      AppMethodBeat.o(32362);
