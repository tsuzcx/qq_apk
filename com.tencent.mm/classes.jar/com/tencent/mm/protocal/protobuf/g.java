  ...
  extends bvk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.wjY != null) {
        paramVarArgs.e(5, this.wjY);
      }
      if (this.wke != null)
      {
        paramVarArgs.iQ(6, this.wke.computeSize());
    ...
    for (paramInt = e.a.a.a.iP(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.wjY != null) {
        paramInt = i + e.a.a.b.b.a.f(5, this.wjY);
      }
      i = paramInt;
      if (this.wke != null) {
        i = paramInt + e.a.a.a.iP(6, this.wke.computeSize());
      }
      AppMethodBeat.o(56674);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localg.cnK = ((e.a.a.a.a)localObject1).CLY.sl();
          AppMethodBeat.o(56674);
          return 0;
        case 3: 
          localg.kNv = ((e.a.a.a.a)localObject1).CLY.readString();
          AppMethodBeat.o(56674);
          return 0;
        case 4: 
          localg.wjW = ((e.a.a.a.a)localObject1).CLY.readString();
          AppMethodBeat.o(56674);
          return 0;
        case 5: 
          localg.wjY = ((e.a.a.a.a)localObject1).CLY.readString();
          AppMethodBeat.o(56674);
          return 0;
        }
        paramVarArgs = ((e.a.a.a.a)localObject1).Wp(paramInt);
