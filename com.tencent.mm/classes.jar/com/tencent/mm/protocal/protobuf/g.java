  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.FIp != null)
      {
        paramVarArgs.lJ(6, this.FIp.computeSize());
        this.FIp.writeFields(paramVarArgs);
      }
      if (this.FIq != null)
      {
        paramVarArgs.lJ(7, this.FIq.computeSize());
    ...
    for (paramInt = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.FIg != null) {
        paramInt = i + f.a.a.b.b.a.e(5, this.FIg);
      }
      i = paramInt;
      if (this.FIp != null) {
        i = paramInt + f.a.a.a.lI(6, this.FIp.computeSize());
      }
      paramInt = i;
      if (this.FIq != null) {
        paramInt = i + f.a.a.a.lI(7, this.FIq.computeSize());
      }
      AppMethodBeat.o(91317);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localg.dmy = ((f.a.a.a.a)localObject1).OmT.zc();
          AppMethodBeat.o(91317);
          return 0;
        case 3: 
          localg.phe = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91317);
          return 0;
        case 4: 
          localg.FIe = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91317);
          return 0;
        case 5: 
          localg.FIg = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(91317);
          return 0;
        case 6: 
          paramVarArgs = ((f.a.a.a.a)localObject1).amA(paramInt);
