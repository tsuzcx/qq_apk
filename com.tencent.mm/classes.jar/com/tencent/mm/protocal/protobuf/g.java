  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Csk != null) {
        paramVarArgs.d(5, this.Csk);
      }
      if (this.Cst != null)
      {
        paramVarArgs.kX(6, this.Cst.computeSize());
        this.Cst.writeFields(paramVarArgs);
      }
      if (this.Csu != null)
      {
        paramVarArgs.kX(7, this.Csu.computeSize());
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.Csk != null) {
        paramInt = i + f.a.a.b.b.a.e(5, this.Csk);
      }
      i = paramInt;
      if (this.Cst != null) {
        i = paramInt + f.a.a.a.kW(6, this.Cst.computeSize());
      }
      paramInt = i;
      if (this.Csu != null) {
        paramInt = i + f.a.a.a.kW(7, this.Csu.computeSize());
      }
      AppMethodBeat.o(91317);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localg.dcG = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(91317);
          return 0;
        case 3: 
          localg.nTK = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(91317);
          return 0;
        case 4: 
          localg.Csi = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(91317);
          return 0;
        case 5: 
          localg.Csk = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(91317);
          return 0;
        case 6: 
          paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
