  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.FpI != null) {
        paramVarArgs.d(5, this.FpI);
      }
      if (this.FpR != null)
      {
        paramVarArgs.lC(6, this.FpR.computeSize());
        this.FpR.writeFields(paramVarArgs);
      }
      if (this.FpS != null)
      {
        paramVarArgs.lC(7, this.FpS.computeSize());
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.FpI != null) {
        paramInt = i + f.a.a.b.b.a.e(5, this.FpI);
      }
      i = paramInt;
      if (this.FpR != null) {
        i = paramInt + f.a.a.a.lB(6, this.FpR.computeSize());
      }
      paramInt = i;
      if (this.FpS != null) {
        paramInt = i + f.a.a.a.lB(7, this.FpS.computeSize());
      }
      AppMethodBeat.o(91317);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localg.dlw = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(91317);
          return 0;
        case 3: 
          localg.paA = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(91317);
          return 0;
        case 4: 
          localg.FpG = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(91317);
          return 0;
        case 5: 
          localg.FpI = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(91317);
          return 0;
        case 6: 
          paramVarArgs = ((f.a.a.a.a)localObject1).alQ(paramInt);
