  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.fHp != null) {
        i = paramInt + g.a.a.b.b.a.g(3, this.fHp);
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localfz.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(259110);
          return 0;
        case 2: 
          localfz.appid = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(259110);
          return 0;
        case 3: 
          localfz.fHp = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(259110);
          return 0;
        }
        localfz.scene = ((g.a.a.a.a)localObject).abFh.AK();
        AppMethodBeat.o(259110);
        return 0;
      }
      AppMethodBeat.o(259110);
