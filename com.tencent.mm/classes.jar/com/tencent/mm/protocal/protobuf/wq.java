  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.qwo != null) {
        i = paramInt + g.a.a.b.b.a.f(2, this.qwo);
      }
      i += g.a.a.b.b.a.bu(3, this.channel);
      paramInt = i;
      if (this.LhJ != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localwq.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72439);
          return 0;
        case 2: 
          localwq.qwo = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(72439);
          return 0;
        case 3: 
          localwq.channel = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(72439);
          return 0;
        }
        localwq.LhJ = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(72439);
        return 0;
      }
      AppMethodBeat.o(72439);
