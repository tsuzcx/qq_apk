      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localaup.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(257750);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((abk)localObject2).parseFrom((byte[])localObject1);
          }
          localaup.ZEW.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(257750);
        return 0;
