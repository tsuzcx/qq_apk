  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aR(2, this.FBp);
      if (this.FBq != null) {
        paramVarArgs.d(3, this.FBq);
      }
      if (this.EhT != null)
      {
    ...
    {
      int i = paramInt + f.a.a.b.b.a.bx(2, this.FBp);
      paramInt = i;
      if (this.FBq != null) {
        paramInt = i + f.a.a.b.b.a.e(3, this.FBq);
      }
      i = paramInt;
      if (this.EhT != null) {
        i = paramInt + f.a.a.a.lm(4, this.EhT.computeSize());
      }
      AppMethodBeat.o(91669);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcog.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91669);
          return 0;
        case 2: 
          localcog.FBp = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(91669);
          return 0;
        case 3: 
          localcog.FBq = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91669);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).ajj(paramInt);
