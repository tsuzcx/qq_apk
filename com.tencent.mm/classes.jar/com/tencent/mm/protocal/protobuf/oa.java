  ...
  extends dyy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = g.a.a.b.b.a.bM(3, this.RVn);
      AppMethodBeat.o(206463);
      return paramInt + i + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localoa.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(206463);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localoa.jmy.add(localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(206463);
          return 0;
        }
        localoa.RVn = ((g.a.a.a.a)localObject1).abFh.AK();
        AppMethodBeat.o(206463);
        return 0;
      }
      AppMethodBeat.o(206463);
