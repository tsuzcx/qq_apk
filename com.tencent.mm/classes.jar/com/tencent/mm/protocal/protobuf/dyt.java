  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.KJD != null) {
        paramVarArgs.d(4, this.KJD);
      }
      paramVarArgs.aG(5, this.objectId);
    ...
    for (int i = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.KJD != null) {
        paramInt = i + f.a.a.b.b.a.e(4, this.KJD);
      }
      i = paramInt + f.a.a.b.b.a.q(5, this.objectId);
      paramInt = i;
      if (this.objectNonceId != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdyt.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(203845);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localdyt.DlF = ((aht)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(203845);
          return 0;
        case 3: 
          localdyt.lastBuffer = ((f.a.a.a.a)localObject1).KhF.fMu();
          AppMethodBeat.o(203845);
          return 0;
        case 4: 
          localdyt.KJD = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(203845);
          return 0;
        case 5: 
          localdyt.objectId = ((f.a.a.a.a)localObject1).KhF.xT();
          AppMethodBeat.o(203845);
          return 0;
        }
        localdyt.objectNonceId = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(203845);
        return 0;
      }
      AppMethodBeat.o(203845);
