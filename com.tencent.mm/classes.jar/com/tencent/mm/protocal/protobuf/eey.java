  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.NeT != null)
      {
        paramVarArgs.ni(8, this.NeT.computeSize());
        this.NeT.writeFields(paramVarArgs);
      }
    ...
    for (int i = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.NeT != null) {
        paramInt = i + g.a.a.a.nh(8, this.NeT.computeSize());
      }
      AppMethodBeat.o(50115);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localeey.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(50115);
          return 0;
        case 2: 
          localeey.jfi = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(50115);
          return 0;
        case 3: 
          paramVarArgs = ((g.a.a.a.a)localObject1).awh(paramInt);
        ...
        {
          localObject2 = (byte[])paramVarArgs.get(paramInt);
          localObject1 = new ffd();
          localObject2 = new g.a.a.a.a((byte[])localObject2, unknownTagHandler);
          for (bool = true; bool; bool = ((ffd)localObject1).populateBuilderWithField((g.a.a.a.a)localObject2, (com.tencent.mm.bw.a)localObject1, dop.getNextFieldNumber((g.a.a.a.a)localObject2))) {}
          localeey.NeT = ((ffd)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(50115);
        return 0;
