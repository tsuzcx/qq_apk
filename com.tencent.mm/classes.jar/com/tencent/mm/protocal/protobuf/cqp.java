  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.FDG != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.FDG);
      }
      i = paramInt;
      if (this.FDH != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcqp.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(138186);
          return 0;
        case 2: 
          localcqp.FDG = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(138186);
          return 0;
        }
        localcqp.FDH = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(138186);
        return 0;
      }
      AppMethodBeat.o(138186);
