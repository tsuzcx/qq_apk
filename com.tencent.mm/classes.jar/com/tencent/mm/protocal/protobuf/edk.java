...
{
  public LinkedList<edj> abiF;
  public int vgN;
  
  public edk()
  {
    AppMethodBeat.i(43123);
    this.abiF = new LinkedList();
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localedk.vgN = ((i.a.a.a.a)localObject).ajGk.aar();
        AppMethodBeat.o(43124);
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        if ((localObject != null) && (localObject.length > 0)) {
          localedj.parseFrom((byte[])localObject);
        }
