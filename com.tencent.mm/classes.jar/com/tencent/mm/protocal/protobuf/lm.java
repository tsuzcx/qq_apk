  ...
  extends dyy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.RQw != null)
      {
        paramVarArgs.oE(7, this.RQw.computeSize());
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.RQv != null) {
        i = paramInt + g.a.a.a.oD(6, this.RQv.computeSize());
      }
      paramInt = i;
      if (this.RQw != null) {
        paramInt = i + g.a.a.a.oD(7, this.RQw.computeSize());
      }
      AppMethodBeat.o(72423);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            locallm.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(72423);
          return 0;
        case 2: 
          locallm.tqa = ((g.a.a.a.a)localObject1).abFh.AK();
          AppMethodBeat.o(72423);
          return 0;
        case 3: 
          locallm.tqb = ((g.a.a.a.a)localObject1).abFh.readString();
          AppMethodBeat.o(72423);
          return 0;
        case 6: 
          paramVarArgs = ((g.a.a.a.a)localObject1).aGc(paramInt);
