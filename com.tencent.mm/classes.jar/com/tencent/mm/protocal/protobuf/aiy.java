  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.Lsw != null) {
        paramInt = i + g.a.a.b.b.a.f(3, this.Lsw);
      }
      i = paramInt;
      if (this.Lsx != null) {
        i = paramInt + g.a.a.b.b.a.f(4, this.Lsx);
      }
      AppMethodBeat.o(104762);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localaiy.Lsv = ((g.a.a.a.a)localObject1).UbS.yZ();
          AppMethodBeat.o(104762);
          return 0;
        case 3: 
          localaiy.Lsw = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(104762);
          return 0;
        }
        localaiy.Lsx = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(104762);
        return 0;
      }
      AppMethodBeat.o(104762);
