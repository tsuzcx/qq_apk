  ...
  extends erp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Zvv != null)
      {
        paramVarArgs.qD(2, this.Zvv.computeSize());
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Zvv != null) {
        i = paramInt + i.a.a.a.qC(2, this.Zvv.computeSize());
      }
      AppMethodBeat.o(152538);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localanv.BaseRequest = ((kc)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(152538);
          return 0;
        ...
        {
          localObject1 = (byte[])paramVarArgs.get(paramInt);
          localObject2 = new abi();
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((abi)localObject2).parseFrom((byte[])localObject1);
          }
          localanv.Zvv = ((abi)localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(152538);
        return 0;
