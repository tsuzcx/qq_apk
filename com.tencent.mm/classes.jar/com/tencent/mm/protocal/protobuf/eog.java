  ...
  extends dpc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Lll != null)
      {
        paramVarArgs.ni(2, this.Lll.computeSize());
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Lll != null) {
        i = paramInt + g.a.a.a.nh(2, this.Lll.computeSize());
      }
      AppMethodBeat.o(32488);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localeog.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32488);
          return 0;
