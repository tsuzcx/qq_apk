  ...
  extends cqk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.bl(2, this.DTg);
      if (this.DTh != null) {
        paramVarArgs.d(3, this.DTh);
      }
      AppMethodBeat.o(190898);
      return 0;
    }
    ...
    for (paramInt = f.a.a.a.lm(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.DTh != null) {
        paramInt = i + f.a.a.b.b.a.e(3, this.DTh);
      }
      AppMethodBeat.o(190898);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localbqo.DTg = ((f.a.a.a.a)localObject1).LVo.fZX();
          AppMethodBeat.o(190898);
          return 0;
        }
        localbqo.DTh = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(190898);
        return 0;
      }
      AppMethodBeat.o(190898);
