  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = f.a.a.b.b.a.bA(3, this.DyW);
      AppMethodBeat.o(74658);
      return paramInt + i + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localObject2 = new f.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = ((dev)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bx.a)localObject1, cld.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
            localbbj.CxO.add(localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(74658);
          return 0;
        }
        localbbj.DyW = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(74658);
        return 0;
      }
      AppMethodBeat.o(74658);
