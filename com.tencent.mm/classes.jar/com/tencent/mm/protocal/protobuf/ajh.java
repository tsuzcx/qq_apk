  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.diA != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.diA);
      }
      paramInt = f.a.a.b.b.a.bx(4, this.EDT);
      AppMethodBeat.o(195057);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localajh.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(195057);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localajh.EDu = ((aiu)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(195057);
          return 0;
        case 3: 
          localajh.diA = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(195057);
          return 0;
        }
        localajh.EDT = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(195057);
        return 0;
      }
      AppMethodBeat.o(195057);
