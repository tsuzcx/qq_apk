  ...
  extends erp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.ZHe != null) {
        paramInt = i + i.a.a.b.b.a.h(3, this.ZHe);
      }
      i = paramInt;
      if (this.YIY != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localawg.BaseRequest = ((kc)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(260194);
          return 0;
        case 2: 
          localawg.id = ((i.a.a.a.a)localObject1).ajGk.aaw();
          AppMethodBeat.o(260194);
          return 0;
        case 3: 
          localawg.ZHe = ((i.a.a.a.a)localObject1).ajGk.readString();
          AppMethodBeat.o(260194);
          return 0;
        }
        paramVarArgs = ((i.a.a.a.a)localObject1).aMP(paramInt);
