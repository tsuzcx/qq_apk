  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.NkF != null)
      {
        paramVarArgs.ni(2, this.NkF.computeSize());
        this.NkF.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(32475);
      return 0;
    }
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.NkF != null) {
        i = paramInt + g.a.a.a.nh(2, this.NkF.computeSize());
      }
      AppMethodBeat.o(32475);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localelt.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32475);
          return 0;
