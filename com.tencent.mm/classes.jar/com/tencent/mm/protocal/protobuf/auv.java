  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.CEX != null)
      {
        paramVarArgs.kX(2, this.CEX.computeSize());
    ...
    if (paramInt == 1)
    {
      ...
      paramInt = i;
      if (this.CEX != null) {
        paramInt = i + f.a.a.a.kW(2, this.CEX.computeSize());
      }
      i = paramInt;
      if (this.Ddo != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.Ddo);
      }
      paramInt = f.a.a.b.b.a.bA(4, this.Dus);
      AppMethodBeat.o(82415);
      return i + paramInt;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localauv.Ret = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(82415);
        return 0;
      case 2: 
        ...
        while (paramInt < i)
        {
          ...
          localauv.CEX = ((bfj)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(82415);
        return 0;
      case 3: 
        localauv.Ddo = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(82415);
        return 0;
      }
      localauv.Dus = ((f.a.a.a.a)localObject1).KhF.xS();
      AppMethodBeat.o(82415);
      return 0;
    }
    AppMethodBeat.o(82415);
