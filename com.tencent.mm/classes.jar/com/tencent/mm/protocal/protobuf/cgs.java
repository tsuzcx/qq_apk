  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Ece != null)
      {
        paramVarArgs.kX(2, this.Ece.computeSize());
    ...
    if (paramInt == 1)
    {
      ...
      paramInt = i;
      if (this.Ece != null) {
        paramInt = i + f.a.a.a.kW(2, this.Ece.computeSize());
      }
      i = paramInt;
      if (this.BaseResponse != null) {
        i = paramInt + f.a.a.a.kW(3, this.BaseResponse.computeSize());
      }
      AppMethodBeat.o(32406);
      return i;
    }
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localcgs.id = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(32406);
        return 0;
      case 2: 
