  ...
  extends cvc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lB(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.xZI != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.xZI);
      }
      i = paramInt;
      if (this.duW != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localuh.xZI = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(209396);
          return 0;
        }
        localuh.duW = ((f.a.a.a.a)localObject1).NPN.readString();
        AppMethodBeat.o(209396);
        return 0;
      }
      AppMethodBeat.o(209396);
