  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = g.a.a.b.b.a.bu(3, this.Htr);
      AppMethodBeat.o(91621);
      return paramInt + i + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdds.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91621);
          return 0;
        case 2: 
          localdds.scene = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(91621);
          return 0;
        }
        localdds.Htr = ((g.a.a.a.a)localObject1).UbS.zi();
        AppMethodBeat.o(91621);
        return 0;
      }
      AppMethodBeat.o(91621);
