  ...
  extends dyy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.TdE != null)
      {
        paramVarArgs.oE(2, this.TdE.computeSize());
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.TdE != null) {
        i = paramInt + g.a.a.a.oD(2, this.TdE.computeSize());
      }
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbxw.BaseResponse = ((jh)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(72491);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localbxw.TdE = ((esi)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(72491);
          return 0;
        case 3: 
          localbxw.tqa = ((g.a.a.a.a)localObject1).abFh.AK();
          AppMethodBeat.o(72491);
          return 0;
        }
        localbxw.tqb = ((g.a.a.a.a)localObject1).abFh.readString();
        AppMethodBeat.o(72491);
        return 0;
      }
      AppMethodBeat.o(72491);
