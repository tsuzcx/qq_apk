  ...
  extends erp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = i.a.a.b.b.a.cJ(3, this.YJZ);
      AppMethodBeat.o(152604);
      return paramInt + i + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcuf.BaseRequest = localkc;
            paramInt += 1;
          }
          AppMethodBeat.o(152604);
          return 0;
        case 2: 
          localcuf.aazF = ((i.a.a.a.a)localObject).ajGk.aar();
          AppMethodBeat.o(152604);
          return 0;
        }
        localcuf.YJZ = ((i.a.a.a.a)localObject).ajGk.aar();
        AppMethodBeat.o(152604);
        return 0;
      }
      AppMethodBeat.o(152604);
