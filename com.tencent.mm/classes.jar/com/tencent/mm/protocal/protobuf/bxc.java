  ...
  extends bvk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.wuZ != null)
      {
        paramVarArgs.iQ(5, this.wuZ.computeSize());
    ...
    for (int i = e.a.a.a.iP(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.wuZ != null) {
        i = paramInt + e.a.a.a.iP(5, this.wuZ.computeSize());
      }
      AppMethodBeat.o(28623);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 3: 
          ...
          while (paramInt < i)
          {
            ...
            localbxc.wvx = ((aui)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(28623);
          return 0;
        case 4: 
          localbxc.wuY = ((e.a.a.a.a)localObject1).CLY.readString();
          AppMethodBeat.o(28623);
          return 0;
        }
        paramVarArgs = ((e.a.a.a.a)localObject1).Wp(paramInt);
