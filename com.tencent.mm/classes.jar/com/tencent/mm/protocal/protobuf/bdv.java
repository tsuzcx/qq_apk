  ...
  extends cvc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = f.a.a.b.b.a.p(3, this.Gbu);
      AppMethodBeat.o(72490);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbdv.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72490);
          return 0;
        case 2: 
          localbdv.GyY = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(72490);
          return 0;
        }
        localbdv.Gbu = ((f.a.a.a.a)localObject1).NPN.zd();
        AppMethodBeat.o(72490);
        return 0;
      }
      AppMethodBeat.o(72490);
