  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.Eil != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.Eil);
      }
      AppMethodBeat.o(32423);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcoh.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32423);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localcoh.CFB = ((bfj)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(32423);
          return 0;
        }
        localcoh.Eil = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(32423);
        return 0;
      }
      AppMethodBeat.o(32423);
