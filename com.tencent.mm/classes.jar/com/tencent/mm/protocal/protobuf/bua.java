  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.Buffer != null) {
        paramInt = i + g.a.a.b.b.a.b(3, this.Buffer);
      }
      AppMethodBeat.o(212277);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbua.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(212277);
          return 0;
        case 2: 
          localbua.Scene = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(212277);
          return 0;
        }
        localbua.Buffer = ((g.a.a.a.a)localObject1).UbS.hPo();
        AppMethodBeat.o(212277);
        return 0;
      }
      AppMethodBeat.o(212277);
