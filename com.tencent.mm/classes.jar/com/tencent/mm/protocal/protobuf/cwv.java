  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.KUp != null) {
        i = paramInt + g.a.a.b.b.a.f(3, this.KUp);
      }
      paramInt = i;
      if (this.HuS != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcwv.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91563);
          return 0;
        case 2: 
          localcwv.KPu = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(91563);
          return 0;
        case 3: 
          localcwv.KUp = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(91563);
          return 0;
        }
        localcwv.HuS = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(91563);
        return 0;
      }
      AppMethodBeat.o(91563);
