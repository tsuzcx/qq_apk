  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localcsx.GgZ = Float.intBitsToFloat(locala.OmT.gwb());
        AppMethodBeat.o(101530);
        return 0;
      case 2: 
        localcsx.Gha = Float.intBitsToFloat(locala.OmT.gwb());
        AppMethodBeat.o(101530);
        return 0;
      case 3: 
        localcsx.jfX = locala.OmT.readString();
        AppMethodBeat.o(101530);
        return 0;
      case 4: 
        localcsx.jGd = locala.OmT.readString();
        AppMethodBeat.o(101530);
        return 0;
      case 5: 
        localcsx.Ajr = locala.OmT.readString();
        AppMethodBeat.o(101530);
        return 0;
      case 6: 
        localcsx.GGA = locala.OmT.readString();
        AppMethodBeat.o(101530);
        return 0;
      case 7: 
        localcsx.Ajt = locala.OmT.zc();
        AppMethodBeat.o(101530);
        return 0;
      case 8: 
        localcsx.Hjq = locala.OmT.readString();
        AppMethodBeat.o(101530);
        return 0;
      case 9: 
        localcsx.Hjr = locala.OmT.zc();
        AppMethodBeat.o(101530);
        return 0;
      case 10: 
        localcsx.Hjs = locala.OmT.zc();
        AppMethodBeat.o(101530);
        return 0;
      case 11: 
        localcsx.Ajv = locala.OmT.zc();
        AppMethodBeat.o(101530);
        return 0;
      case 12: 
        localcsx.bYG = Float.intBitsToFloat(locala.OmT.gwb());
        AppMethodBeat.o(101530);
        return 0;
      case 13: 
        localcsx.Hjt = locala.OmT.gCk();
        AppMethodBeat.o(101530);
        return 0;
      case 14: 
        localcsx.score = locala.OmT.zc();
        AppMethodBeat.o(101530);
        return 0;
      case 15: 
        localcsx.Hju = locala.OmT.readString();
        AppMethodBeat.o(101530);
        return 0;
      }
      localcsx.country = locala.OmT.readString();
      AppMethodBeat.o(101530);
      return 0;
    }
    AppMethodBeat.o(101530);
