  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Eki != null)
      {
        paramVarArgs.ln(2, this.Eki.computeSize());
    ...
    for (int i = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.Eki != null) {
        paramInt = i + f.a.a.a.lm(2, this.Eki.computeSize());
      }
      i = paramInt;
      if (this.EDL != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localalm.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(168997);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localalm.Eki = ((SKBuiltinBuffer_t)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(168997);
          return 0;
