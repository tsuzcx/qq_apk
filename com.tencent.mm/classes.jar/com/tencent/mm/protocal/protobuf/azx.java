  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Gxg != null)
      {
        paramVarArgs.lC(4, this.Gxg.computeSize());
        this.Gxg.writeFields(paramVarArgs);
      }
      if (this.Gxh != null)
      {
        paramVarArgs.lC(5, this.Gxh.computeSize());
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.Gxg != null) {
        i = paramInt + f.a.a.a.lB(4, this.Gxg.computeSize());
      }
      paramInt = i;
      if (this.Gxh != null) {
        paramInt = i + f.a.a.a.lB(5, this.Gxh.computeSize());
      }
      AppMethodBeat.o(72484);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localazx.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72484);
          return 0;
        case 2: 
          localazx.ozR = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(72484);
          return 0;
        case 3: 
          localazx.ozS = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(72484);
          return 0;
        case 4: 
          paramVarArgs = ((f.a.a.a.a)localObject1).alQ(paramInt);
