  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.EtF != null)
      {
        paramVarArgs.ln(2, this.EtF.computeSize());
        this.EtF.writeFields(paramVarArgs);
      }
      if (this.DNL != null)
      {
    ...
    if (paramInt == 1)
    {
      ...
      paramInt = i;
      if (this.EtF != null) {
        paramInt = i + f.a.a.a.lm(2, this.EtF.computeSize());
      }
      i = paramInt;
      if (this.DNL != null) {
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localzg.type = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(91426);
        return 0;
      case 2: 
        ...
        while (paramInt < i)
        {
          ...
          for (bool = true; bool; bool = ((cqo)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bw.a)localObject1, com.tencent.mm.bw.a.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
          localzg.EtF = ((cqo)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(91426);
        return 0;
