  ...
  extends esc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i.a.a.a.c(3, 8, this.acfU);
      AppMethodBeat.o(147825);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        gkn localgkn = (gkn)paramVarArgs[1];
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localgkn.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(147825);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localgkn.acfT = ((fvg)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(147825);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localgkn.acfU.add(localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(147825);
        return 0;
 ...
 * Qualified Name:     com.tencent.mm.protocal.protobuf.gkn
