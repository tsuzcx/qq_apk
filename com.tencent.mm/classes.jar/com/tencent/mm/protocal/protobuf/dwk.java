  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.MWK != null) {
        paramInt = i + g.a.a.b.b.a.f(3, this.MWK);
      }
      AppMethodBeat.o(91687);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdwk.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91687);
          return 0;
        case 2: 
          localdwk.oUv = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(91687);
          return 0;
        }
        localdwk.MWK = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(91687);
        return 0;
      }
      AppMethodBeat.o(91687);
