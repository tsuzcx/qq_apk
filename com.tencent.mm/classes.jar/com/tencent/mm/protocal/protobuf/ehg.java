  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.Luy != null) {
        paramVarArgs.e(2, this.Luy);
      }
      paramVarArgs.aM(3, this.NgU);
      if (this.rBI != null) {
        paramVarArgs.e(4, this.rBI);
      }
      if (this.KPW != null)
      {
    ...
    for (paramInt = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.Luy != null) {
        i = paramInt + g.a.a.b.b.a.f(2, this.Luy);
      }
      i += g.a.a.b.b.a.bu(3, this.NgU);
      paramInt = i;
      if (this.rBI != null) {
        paramInt = i + g.a.a.b.b.a.f(4, this.rBI);
      }
      i = paramInt;
      if (this.KPW != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localehg.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(133203);
          return 0;
        case 2: 
          localehg.Luy = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(133203);
          return 0;
        case 3: 
          localehg.NgU = ((g.a.a.a.a)localObject1).UbS.zi();
          AppMethodBeat.o(133203);
          return 0;
        case 4: 
          localehg.rBI = ((g.a.a.a.a)localObject1).UbS.readString();
          AppMethodBeat.o(133203);
          return 0;
        }
        paramVarArgs = ((g.a.a.a.a)localObject1).awh(paramInt);
        ...
        while (paramInt < i)
        {
          ...
          localehg.KPW = ((SKBuiltinBuffer_t)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(133203);
        return 0;
