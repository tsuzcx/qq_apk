  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aR(1, this.BX);
      if (this.uuid != null) {
        paramVarArgs.d(2, this.uuid);
      }
      if (this.DcU != null) {
        paramVarArgs.c(3, this.DcU);
      }
    ...
    if (paramInt == 1)
    {
      int i = f.a.a.b.b.a.bA(1, this.BX) + 0;
      paramInt = i;
      if (this.uuid != null) {
      ...
      i = paramInt;
      if (this.DcU != null) {
        i = paramInt + f.a.a.b.b.a.b(3, this.DcU);
      }
      AppMethodBeat.o(147789);
      return i;
    }
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localdnw.BX = locala.KhF.xS();
        AppMethodBeat.o(147789);
        return 0;
      case 2: 
        localdnw.uuid = locala.KhF.readString();
        AppMethodBeat.o(147789);
        return 0;
      }
      localdnw.DcU = locala.KhF.fMu();
      AppMethodBeat.o(147789);
      return 0;
    }
    AppMethodBeat.o(147789);
