  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.Hfc != null) {
        i = paramInt + f.a.a.b.b.a.e(4, this.Hfc);
      }
      paramInt = i;
      if (this.Cyu != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localclv.ozR = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(91625);
          return 0;
        case 3: 
          localclv.ozS = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(91625);
          return 0;
        case 4: 
          localclv.Hfc = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(91625);
          return 0;
        }
        localclv.Cyu = ((f.a.a.a.a)localObject1).NPN.readString();
        AppMethodBeat.o(91625);
        return 0;
      }
      AppMethodBeat.o(91625);
