  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = f.a.a.b.b.a.bA(4, this.DRi);
      AppMethodBeat.o(40109);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcrk.BaseRequest = ((ip)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(40109);
          return 0;
        case 2: 
          localcrk.dlB = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(40109);
          return 0;
        case 3: 
          localcrk.scene = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(40109);
          return 0;
        }
        localcrk.DRi = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(40109);
        return 0;
      }
      AppMethodBeat.o(40109);
