  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.origin != null)
      {
        paramVarArgs.lC(9, this.origin.computeSize());
        this.origin.writeFields(paramVarArgs);
      }
      if (this.target != null)
      {
        paramVarArgs.lC(10, this.target.computeSize());
      ...
      {
        paramVarArgs.lC(15, this.codecInfo.computeSize());
    ...
    if (paramInt == 1)
    {
      ...
      i = paramInt;
      if (this.origin != null) {
        i = paramInt + f.a.a.a.lB(9, this.origin.computeSize());
      }
      paramInt = i;
      if (this.target != null) {
        paramInt = i + f.a.a.a.lB(10, this.target.computeSize());
      }
      ...
      paramInt = i;
      if (this.codecInfo != null) {
        paramInt = i + f.a.a.a.lB(15, this.codecInfo.computeSize());
      }
      AppMethodBeat.o(169008);
      return paramInt;
    }
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localFinderMediaReportObject.remuxTime = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(169008);
        return 0;
      case 2: 
        localFinderMediaReportObject.remuxRetCode = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(169008);
        return 0;
      case 3: 
        localFinderMediaReportObject.cdnUploadTime = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(169008);
        return 0;
      case 4: 
        localFinderMediaReportObject.cdnUploadRetCode = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(169008);
        return 0;
      case 5: 
        localFinderMediaReportObject.zipTime = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(169008);
        return 0;
      case 6: 
        localFinderMediaReportObject.zipRetCode = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(169008);
        return 0;
      case 7: 
        localFinderMediaReportObject.mediaType = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(169008);
        return 0;
      case 8: 
        localFinderMediaReportObject.mediaId = ((f.a.a.a.a)localObject1).NPN.readString();
        AppMethodBeat.o(169008);
        return 0;
      case 9: 
      ...
      case 10: 
        ...
        return 0;
      case 11: 
        localFinderMediaReportObject.isBigFile = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(169008);
        return 0;
      case 12: 
        localFinderMediaReportObject.cdnControl = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(169008);
        return 0;
      case 13: 
        localFinderMediaReportObject.videoFinalSize = ((f.a.a.a.a)localObject1).NPN.zc();
        AppMethodBeat.o(169008);
        return 0;
      case 14: 
        paramVarArgs = ((f.a.a.a.a)localObject1).alQ(paramInt);
      ...
      while (paramInt < i)
      {
        ...
        localFinderMediaReportObject.codecInfo = ((apb)localObject1);
        paramInt += 1;
      }
      AppMethodBeat.o(169008);
      return 0;
