  ...
  extends cld
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.DaK != null) {
        paramVarArgs.d(7, this.DaK);
      }
      if (this.DaL != null) {
        paramVarArgs.d(8, this.DaL);
      }
      AppMethodBeat.o(124518);
      return 0;
    }
    ...
    for (int i = f.a.a.a.kW(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.DaK != null) {
        paramInt = i + f.a.a.b.b.a.e(7, this.DaK);
      }
      i = paramInt;
      if (this.DaL != null) {
        i = paramInt + f.a.a.b.b.a.e(8, this.DaL);
      }
      AppMethodBeat.o(124518);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbhr.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124518);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localbhr.CIW = ((cfw)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124518);
          return 0;
        case 3: 
          localbhr.CIQ = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(124518);
          return 0;
        case 4: 
          localbhr.DaM = ((f.a.a.a.a)localObject1).KhF.xS();
          AppMethodBeat.o(124518);
          return 0;
        case 5: 
          paramVarArgs = ((f.a.a.a.a)localObject1).agn(paramInt);
        ...
        case 6: 
          ...
          while (paramInt < i)
          {
            ...
            localbhr.DaO = ((mk)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124518);
          return 0;
        case 7: 
          localbhr.DaK = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(124518);
          return 0;
        }
        localbhr.DaL = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(124518);
        return 0;
      }
      AppMethodBeat.o(124518);
