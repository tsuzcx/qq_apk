  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.FyU != null)
      {
        paramVarArgs.lC(2, this.FyU.computeSize());
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.FyU != null) {
        i = paramInt + f.a.a.a.lB(2, this.FyU.computeSize());
      }
      AppMethodBeat.o(134258);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localdcp.BaseResponse = ((BaseResponse)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(134258);
          return 0;
        ...
        while (paramInt < i)
        {
          ...
          localdcp.FyU = ((SKBuiltinBuffer_t)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(134258);
        return 0;
