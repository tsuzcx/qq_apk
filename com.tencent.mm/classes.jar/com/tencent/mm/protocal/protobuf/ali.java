  ...
  extends buy
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.xaW != null)
      {
        paramVarArgs.iQ(3, this.xaW.computeSize());
    ...
    for (int i = e.a.a.a.iP(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.xcf != null) {
        paramInt = i + e.a.a.b.b.a.f(2, this.xcf);
      }
      i = paramInt;
      if (this.xaW != null) {
        i = paramInt + e.a.a.a.iP(3, this.xaW.computeSize());
      }
      AppMethodBeat.o(48854);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localali.BaseRequest = ((hq)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(48854);
          return 0;
        case 2: 
          localali.xcf = ((e.a.a.a.a)localObject1).CLY.readString();
          AppMethodBeat.o(48854);
          return 0;
        }
        paramVarArgs = ((e.a.a.a.a)localObject1).Wp(paramInt);
