  ...
  extends dop
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.LAN != null) {
        i = paramInt + g.a.a.b.b.a.f(3, this.LAN);
      }
      AppMethodBeat.o(209417);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localasl.BaseRequest = ((jr)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(209417);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localasl.LAI = ((aov)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(209417);
          return 0;
        }
        localasl.LAN = ((g.a.a.a.a)localObject1).UbS.readString();
        AppMethodBeat.o(209417);
        return 0;
      }
      AppMethodBeat.o(209417);
