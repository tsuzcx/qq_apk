  ...
  extends esc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      int j = i.a.a.b.b.a.cJ(3, this.YSK);
      AppMethodBeat.o(258368);
      return paramInt + i + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localpg.BaseResponse = ((kd)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(258368);
          return 0;
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localpg.lPK.add(localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(258368);
          return 0;
        }
        localpg.YSK = ((i.a.a.a.a)localObject1).ajGk.aar();
        AppMethodBeat.o(258368);
        return 0;
      }
      AppMethodBeat.o(258368);
