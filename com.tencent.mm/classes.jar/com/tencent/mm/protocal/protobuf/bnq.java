  ...
  extends cpx
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lm(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.Fds != null) {
        paramInt = i + f.a.a.b.b.a.e(2, this.Fds);
      }
      i = paramInt;
      if (this.Fdt != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbnq.BaseRequest = ((iv)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(124519);
          return 0;
        case 2: 
          localbnq.Fds = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(124519);
          return 0;
        }
        localbnq.Fdt = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(124519);
        return 0;
      }
      AppMethodBeat.o(124519);
