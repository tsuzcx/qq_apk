  ...
  extends com.tencent.mm.bv.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aO(1, this.xGP);
      if (this.xIU != null)
      {
        paramVarArgs.iQ(2, this.xIU.computeSize());
    ...
    if (paramInt == 1)
    {
      i = e.a.a.b.b.a.bl(1, this.xGP) + 0;
      paramInt = i;
      if (this.xIU != null) {
        paramInt = i + e.a.a.a.iP(2, this.xIU.computeSize());
      }
      AppMethodBeat.o(28617);
      return paramInt;
    }
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localbve.xGP = ((e.a.a.a.a)localObject1).CLY.sl();
        AppMethodBeat.o(28617);
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        localbve.xIU = ((SKBuiltinBuffer_t)localObject1);
        paramInt += 1;
      }
      AppMethodBeat.o(28617);
      return 0;
