  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.aall != null)
      {
        paramVarArgs.qD(2, this.aall.computeSize());
    ...
    label418:
    for (paramInt = i.a.a.a.qC(1, this.aalk.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.aall != null) {
        i = paramInt + i.a.a.a.qC(2, this.aall.computeSize());
      }
      AppMethodBeat.o(258118);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcby.aalk = ((fvo)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(258118);
          return 0;
        ...
        {
          localObject1 = (byte[])paramVarArgs.get(paramInt);
          localObject2 = new cbx();
          if ((localObject1 != null) && (localObject1.length > 0)) {
            ((cbx)localObject2).parseFrom((byte[])localObject1);
          }
          localcby.aall = ((cbx)localObject2);
          paramInt += 1;
        }
        AppMethodBeat.o(258118);
        return 0;
