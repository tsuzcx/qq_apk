  ...
  extends cvp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aS(4, this.HDB);
      paramVarArgs.e(5, 8, this.HDJ);
      if (this.HDz != null)
      {
    ...
    for (paramInt = f.a.a.a.lB(1, this.BaseResponse.computeSize()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt + f.a.a.b.b.a.bz(4, this.HDB) + f.a.a.a.c(5, 8, this.HDJ);
      paramInt = i;
      if (this.HDz != null) {
        paramInt = i + f.a.a.a.lB(6, this.HDz.computeSize());
      }
      AppMethodBeat.o(72611);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localdpr.ozR = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(72611);
          return 0;
        case 3: 
          localdpr.ozS = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(72611);
          return 0;
        case 4: 
          localdpr.HDB = ((f.a.a.a.a)localObject1).NPN.zc();
          AppMethodBeat.o(72611);
          return 0;
        case 5: 
          paramVarArgs = ((f.a.a.a.a)localObject1).alQ(paramInt);
          ...
          while (paramInt < i)
          {
            ...
            localObject2 = new f.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = ((bsm)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bx.a)localObject1, cvp.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
            localdpr.HDJ.add(localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(72611);
          return 0;
