  ...
  extends cvc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lB(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.GEh != null) {
        i = paramInt + f.a.a.b.b.a.b(3, this.GEh);
      }
      AppMethodBeat.o(74666);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcyw.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(74666);
          return 0;
        case 2: 
          localcyw.dld = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(74666);
          return 0;
        }
        localcyw.GEh = ((f.a.a.a.a)localObject1).NPN.gxI();
        AppMethodBeat.o(74666);
        return 0;
      }
      AppMethodBeat.o(74666);
