...
public final class a
{
  ...
  public static boolean kr(int paramInt1, int paramInt2)
  {
    ...
    while (i < j)
    {
      ...
      {
        ac.i("MicroMsg.BigImageFilter", "alvinluo BigImageFilter filter model: %s, width: %d, height: %d", new Object[] { str, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
        AppMethodBeat.o(152884);
        return true;
      }
      i += 1;
