...
{
  private static b gfZ;
  public static a ggd;
  private ConcurrentHashMap<String, c> gfY;
  public String gga;
  public ap ggb;
  public boolean ggc;
  ...
  public b()
  {
    ...
    this.gfY = new ConcurrentHashMap();
  ...
  public final boolean a(String paramString, int paramInt1, int paramInt2, ViewGroup paramViewGroup, int... paramVarArgs)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((c)this.gfY.get(paramString) == null) {
        break;
      }
      AppMethodBeat.o(141004);
      return false;
    ...
    c localc = new c();
    this.gfY.put(paramString, localc);
    localc.cPu = paramInt1;
    localc.ggo = paramString;
    localc.Sg = paramInt2;
    localc.ggp = paramVarArgs;
    localc.ggq = paramViewGroup;
    localc.ggr = false;
    this.ggb.sendMessage(this.ggb.obtainMessage(0, localc));
    AppMethodBeat.o(141004);
    return true;
  }
  ...
  public static final class a
  {
      ...
      this.mHandler = new ap(paramString)
      {
        public final void handleMessage(Message paramAnonymousMessage)
        {
          ...
          try
          {
            ...
            try
            {
              localObject = (ThreadLocal)paramAnonymousMessage.ggg.get(null);
              if (localObject != null)
              {
          ...
          try
          {
            paramAnonymousMessage = paramAnonymousMessage.ggi.get(localObject);
    ...
    final boolean init()
    {
      ...
      //   5: aload_0
      //   6: getfield 36	com/tencent/mm/kiss/a/b$a:ggj	Z
      //   9: ifeq +15 -> 24
      //   12: aload_0
      //   13: getfield 38	com/tencent/mm/kiss/a/b$a:ggk	Z
      //   16: istore_1
      //   17: ldc 54
      ...
      //   24: aload_0
      //   25: iconst_1
      //   26: putfield 36	com/tencent/mm/kiss/a/b$a:ggj	Z
      //   29: aload_0
      //   30: ldc 56
      //   32: invokestatic 62	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
      //   35: putfield 64	com/tencent/mm/kiss/a/b$a:ggf	Ljava/lang/Class;
      //   38: aload_0
      //   39: aload_0
      //   40: getfield 64	com/tencent/mm/kiss/a/b$a:ggf	Ljava/lang/Class;
      //   43: ldc 66
      //   45: invokevirtual 70	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
      //   48: putfield 72	com/tencent/mm/kiss/a/b$a:ggg	Ljava/lang/reflect/Field;
      //   51: aload_0
      //   52: getfield 72	com/tencent/mm/kiss/a/b$a:ggg	Ljava/lang/reflect/Field;
      //   55: iconst_1
      ...
      //   65: putfield 82	com/tencent/mm/kiss/a/b$a:ggh	Ljava/lang/Class;
      //   68: aload_0
      //   69: aload_0
      //   70: getfield 82	com/tencent/mm/kiss/a/b$a:ggh	Ljava/lang/Class;
      //   73: ldc 84
      //   75: invokevirtual 70	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
      //   78: putfield 34	com/tencent/mm/kiss/a/b$a:ggi	Ljava/lang/reflect/Field;
      //   81: aload_0
      //   82: getfield 34	com/tencent/mm/kiss/a/b$a:ggi	Ljava/lang/reflect/Field;
      //   85: iconst_1
      //   86: invokevirtual 78	java/lang/reflect/Field:setAccessible	(Z)V
      //   89: aload_0
      //   90: iconst_1
      //   91: putfield 38	com/tencent/mm/kiss/a/b$a:ggk	Z
      //   94: ldc 54
