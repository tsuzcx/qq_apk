...
public final class b
{
  ...
  public static a gkJ;
  private ConcurrentHashMap<String, c> gkE;
  public String gkG;
  public ao gkH;
  public boolean gkI;
  ...
  public final boolean a(String paramString, int paramInt1, int paramInt2, ViewGroup paramViewGroup, int... paramVarArgs)
  {
    ...
    if (this.gkI)
    {
      ac.i("KISS.InflateRecycler", "not support application inflate");
      AppMethodBeat.o(141004);
      return false;
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((c)this.gkE.get(paramString) == null) {
        break;
      }
      AppMethodBeat.o(141004);
      return false;
    ...
    c localc = new c();
    this.gkE.put(paramString, localc);
    localc.cMP = paramInt1;
    localc.gkU = paramString;
    localc.Tb = paramInt2;
    localc.gkV = paramVarArgs;
    localc.gkW = paramViewGroup;
    localc.gkX = false;
    this.gkH.sendMessage(this.gkH.obtainMessage(0, localc));
    AppMethodBeat.o(141004);
    return true;
  }
  ...
  public static final class a
  {
      ...
      this.mHandler = new ao(paramString)
      {
        public final void handleMessage(Message paramAnonymousMessage)
        {
          ...
          try
          {
            ...
            try
            {
              localObject = (ThreadLocal)paramAnonymousMessage.gkM.get(null);
              if (localObject != null)
              {
            ...
            catch (IllegalAccessException paramAnonymousMessage)
            {
              for (;;)
              {
                Object localObject;
                label74:
                ac.printErrStackTrace("KISS.InflateRecycler", paramAnonymousMessage, "", new Object[0]);
              }
            }
          }
          ...
          try
          {
            paramAnonymousMessage = paramAnonymousMessage.gkO.get(localObject);
          ...
          ac.i("KISS.InflateRecycler", "durtion %s", new Object[] { Long.valueOf(System.nanoTime() - l) });
          AppMethodBeat.o(140998);
        }
      };
    ...
    final boolean init()
    {
      ...
      //   5: aload_0
      //   6: getfield 36	com/tencent/mm/kiss/a/b$a:gkP	Z
      //   9: ifeq +15 -> 24
      //   12: aload_0
      //   13: getfield 38	com/tencent/mm/kiss/a/b$a:gkQ	Z
      //   16: istore_1
      //   17: ldc 54
      ...
      //   24: aload_0
      //   25: iconst_1
      //   26: putfield 36	com/tencent/mm/kiss/a/b$a:gkP	Z
      //   29: aload_0
      //   30: ldc 56
      //   32: invokestatic 62	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
      //   35: putfield 64	com/tencent/mm/kiss/a/b$a:gkL	Ljava/lang/Class;
      //   38: aload_0
      //   39: aload_0
      //   40: getfield 64	com/tencent/mm/kiss/a/b$a:gkL	Ljava/lang/Class;
      //   43: ldc 66
      //   45: invokevirtual 70	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
      //   48: putfield 72	com/tencent/mm/kiss/a/b$a:gkM	Ljava/lang/reflect/Field;
      //   51: aload_0
      //   52: getfield 72	com/tencent/mm/kiss/a/b$a:gkM	Ljava/lang/reflect/Field;
      //   55: iconst_1
      ...
      //   65: putfield 82	com/tencent/mm/kiss/a/b$a:gkN	Ljava/lang/Class;
      //   68: aload_0
      //   69: aload_0
      //   70: getfield 82	com/tencent/mm/kiss/a/b$a:gkN	Ljava/lang/Class;
      //   73: ldc 84
      //   75: invokevirtual 70	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
      //   78: putfield 34	com/tencent/mm/kiss/a/b$a:gkO	Ljava/lang/reflect/Field;
      //   81: aload_0
      //   82: getfield 34	com/tencent/mm/kiss/a/b$a:gkO	Ljava/lang/reflect/Field;
      //   85: iconst_1
      //   86: invokevirtual 78	java/lang/reflect/Field:setAccessible	(Z)V
      //   89: aload_0
      //   90: iconst_1
      //   91: putfield 38	com/tencent/mm/kiss/a/b$a:gkQ	Z
      //   94: ldc 54
      ...
      //   111: invokestatic 94	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
      //   114: ldc 54
      ...
      //   131: invokestatic 94	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
      //   134: ldc 54
      ...
      //   151: invokestatic 94	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
      //   154: ldc 54
      ...
      //   171: invokestatic 94	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
      //   174: ldc 54
