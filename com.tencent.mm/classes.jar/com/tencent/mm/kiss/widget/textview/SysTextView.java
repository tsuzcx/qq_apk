  ...
  implements a
{
  ...
  public SysTextView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.huI = new g(this, new com.tencent.mm.kiss.widget.textview.a.a());
    init();
  ...
  private void init()
  {
    ...
    this.huI.huK = new com.tencent.mm.kiss.widget.textview.a.a();
  ...
  protected f getLayoutWrapper()
  {
    ...
    f localf = this.huI.getLayoutWrapper();
    AppMethodBeat.o(141100);
    return localf;
  }
  ...
  public CharSequence getText()
  {
    ...
    CharSequence localCharSequence = this.huI.getText();
    AppMethodBeat.o(141114);
  ...
  public Layout getTvLayout()
  {
    ...
    Layout localLayout = this.huI.getTvLayout();
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      Point localPoint = this.huI.cV(paramInt1, paramInt2);
      if (localPoint != null)
      {
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    boolean bool1 = this.huI.w(paramMotionEvent);
  ...
  public void setSingleLine(boolean paramBoolean)
  {
    ...
    this.huI.setSingleLine(paramBoolean);
    AppMethodBeat.o(141101);
  }
  ...
  public final void setText$609c24db(CharSequence paramCharSequence)
  {
    ...
    this.huI.setText(paramCharSequence, false);
    AppMethodBeat.o(141104);
  }
  ...
  public void setTextColor(int paramInt)
  {
    ...
    this.huI.setTextColor(paramInt);
    AppMethodBeat.o(141108);
  }
  ...
  public void setTextSize(int paramInt, float paramFloat)
  {
    ...
    this.huI.setTextSize(paramInt, paramFloat);
    AppMethodBeat.o(141106);
  }
}
