  ...
  extends MMIntentService
{
  ...
  private static boolean a(String paramString1, byte[] paramArrayOfByte, int paramInt, String paramString2, String paramString3, String paramString4)
  {
    ...
    paramString2 = new StringBuilder().append(paramString3).append("/cgi-bin/mmsupport-bin/stackreport?version=").append(Integer.toHexString(paramInt)).append("&devicetype=").append(paramString2).append("&filelength=").append(i).append("&sum=").append(str).append("&reporttype=1&NewReportType=").append(bt.n((Integer)gfm.get(paramString4)));
  ...
  private static void i(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      com.tencent.mm.vfs.i.e(paramString1, paramString3, paramString3.length);
      paramString2 = (paramString2 + "\n").getBytes();
      com.tencent.mm.vfs.i.e(paramString1, paramString2, paramString2.length);
  ...
  public final void onHandleIntent(Intent paramIntent)
  {
    ...
    localObject1 = (String)localObject1 + "exception,time_" + bt.aQJ() + ",error_" + (String)localObject4;
    for (;;)
    {
      try
      {
      ...
      localObject1 = com.tencent.mm.vfs.i.aY((String)localObject3, 0, -1);
      if (!bt.cC((byte[])localObject1)) {
        continue;
      }
      AppMethodBeat.o(145674);
      return;
      localObject4 = ((e)localObject4).fOM();
      if (localObject4 != null)
      {
        ...
        if (j < k)
        {
          ...
          if (bt.Df(localSimpleDateFormat.lastModified()) > 2592000000L) {
