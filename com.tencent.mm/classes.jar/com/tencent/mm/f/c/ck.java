  ...
  extends IAutoDBItem
{
  ...
  static
  {
    C_ROWID = new Column("rowid", "long", "FinderLiveConfig", "");
    C_KEY = new Column("key", "string", "FinderLiveConfig", "");
    C_VALUE = new Column("value", "byte[]", "FinderLiveConfig", "");
 ...
 * Qualified Name:     com.tencent.mm.f.c.ck
