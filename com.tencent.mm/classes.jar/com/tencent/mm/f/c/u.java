  ...
  extends IAutoDBItem
{
  ...
  private static final int hpF = "orderSequence".hashCode();
  ...
  static
  {
    C_ROWID = new Column("rowid", "long", "AppBrandStarApp", "");
    C_USERNAME = new Column("username", "string", "AppBrandStarApp", "");
    hoQ = new Column("versiontype", "int", "AppBrandStarApp", "");
    C_UPDATETIME = new Column("updatetime", "long", "AppBrandStarApp", "");
    hpD = new Column("ordersequence", "long", "AppBrandStarApp", "");
  ...
  {
    return "AppBrandStarApp";
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mm\classes.jar
 * Qualified Name:     com.tencent.mm.f.c.u
