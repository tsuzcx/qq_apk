  ...
  extends IAutoDBItem
{
  ...
  public static final Column C_ADINFO;
  public static final Column C_ADXML;
  public static final Column C_ATADINFO;
  public static final Column C_ATTRBUF;
  public static final Column C_CONTENT;
  public static final Column C_CREATEADTIME;
  public static final Column C_CREATETIME;
  public static final Column C_EXPOSURECOUNT;
  public static final Column C_EXPOSURETIME;
  public static final Column C_FIRSTCONTROLTIME;
  public static final Column C_HEAD;
  public static final Column C_LIKEFLAG;
  public static final Column C_LOCALFLAG;
  public static final Column C_LOCALPRIVATE;
  public static final Column C_POSTBUF;
  public static final Column C_PRAVITED;
  public static final Column C_RECXML;
  public static final Column C_REMINDINFOGROUP;
  public static final Column C_ROWID;
  public static final Column C_SNSID;
  public static final Column C_SOURCETYPE;
  public static final Column C_STRINGSEQ;
  ...
  static
  {
    C_ROWID = new Column("rowid", "long", "AdSnsInfo", "");
    C_SNSID = new Column("snsid", "long", "AdSnsInfo", "");
    C_USERNAME = new Column("username", "string", "AdSnsInfo", "");
    C_LOCALFLAG = new Column("localflag", "int", "AdSnsInfo", "");
    C_CREATETIME = new Column("createtime", "int", "AdSnsInfo", "");
    C_HEAD = new Column("head", "int", "AdSnsInfo", "");
    C_LOCALPRIVATE = new Column("localprivate", "int", "AdSnsInfo", "");
    C_TYPE = new Column("type", "int", "AdSnsInfo", "");
    C_SOURCETYPE = new Column("sourcetype", "int", "AdSnsInfo", "");
    C_LIKEFLAG = new Column("likeflag", "int", "AdSnsInfo", "");
    C_PRAVITED = new Column("pravited", "int", "AdSnsInfo", "");
    C_STRINGSEQ = new Column("stringseq", "string", "AdSnsInfo", "");
    C_CONTENT = new Column("content", "byte[]", "AdSnsInfo", "");
    C_ATTRBUF = new Column("attrbuf", "byte[]", "AdSnsInfo", "");
    C_POSTBUF = new Column("postbuf", "byte[]", "AdSnsInfo", "");
    C_ADINFO = new Column("adinfo", "string", "AdSnsInfo", "");
    C_ADXML = new Column("adxml", "string", "AdSnsInfo", "");
    C_CREATEADTIME = new Column("createadtime", "int", "AdSnsInfo", "");
    C_EXPOSURETIME = new Column("exposuretime", "int", "AdSnsInfo", "");
    C_FIRSTCONTROLTIME = new Column("firstcontroltime", "int", "AdSnsInfo", "");
    C_RECXML = new Column("recxml", "string", "AdSnsInfo", "");
    C_SUBTYPE = new Column("subtype", "int", "AdSnsInfo", "");
    C_EXPOSURECOUNT = new Column("exposurecount", "int", "AdSnsInfo", "");
    C_ATADINFO = new Column("atadinfo", "string", "AdSnsInfo", "");
    C_REMINDINFOGROUP = new Column("remindinfogroup", "byte[]", "AdSnsInfo", "");
 ...
 * Qualified Name:     com.tencent.mm.f.c.f
