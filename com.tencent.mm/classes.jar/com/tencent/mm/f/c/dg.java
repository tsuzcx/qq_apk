  ...
  extends IAutoDBItem
{
  ...
  static
  {
    C_ROWID = new Column("rowid", "long", "GamePBCache", "");
    C_KEY = new Column("key", "string", "GamePBCache", "");
    C_VALUE = new Column("value", "byte[]", "GamePBCache", "");
 ...
 * Qualified Name:     com.tencent.mm.f.c.dg
