  ...
  extends IAutoDBItem
{
  ...
  private static final int hUU;
  private static final int hUV = "refVideoObjectId".hashCode();
  private static final int hUW = "refVideoObjectNonceId".hashCode();
  public static String hUn = "FinderIdentityMsg";
  public static String hUo = "WxIdentityMsg";
  ...
  public beg field_aggregatedContacts;
  ...
  static
  {
    ...
    hUH = "objectId".hashCode();
    hUI = "commentId".hashCode();
    hsm = "flag".hashCode();
    hUJ = "refContent".hashCode();
    hLy = "extFlag".hashCode();
    hUK = "mediaType".hashCode();
    hsh = "description".hashCode();
    hUL = "notify".hashCode();
    hUM = "replayUsername".hashCode();
    hUN = "replayNickname".hashCode();
    hPJ = "objectNonceId".hashCode();
    hUO = "userVersion".hashCode();
    username_HASHCODE = "username".hashCode();
    hUP = "contact".hashCode();
    hUQ = "replyContact".hashCode();
    hUR = "aggregatedContacts".hashCode();
    hUS = "followExpireTime".hashCode();
    hUT = "clientMsgId".hashCode();
    hUU = "followId".hashCode();
  }
    ...
    for (;;)
    {
      ...
      if (hwF == k) {
        ...
        try
        {
          ...
          this.field_notify = ((bfo)new bfo().parseFrom(arrayOfByte1));
        }
        ...
        try
        {
          ...
          this.field_aggregatedContacts = ((beg)new beg().parseFrom(arrayOfByte4));
        }
  ...
  public ContentValues convertTo()
  {
    ...
    if ((this.hUu) && (this.field_notify != null)) {}
    try
    {
      ...
      if ((!this.hUy) || (this.field_contact == null)) {}
    }
    catch (IOException localIOException3)
    {
      try
      {
        ...
        if ((!this.hUz) || (this.field_replyContact == null)) {}
      }
      catch (IOException localIOException3)
      {
        try
        {
          ...
          if ((!this.hUA) || (this.field_aggregatedContacts == null)) {}
        }
        catch (IOException localIOException3)
        {
          try
 ...
 * Qualified Name:     com.tencent.mm.f.c.cr
