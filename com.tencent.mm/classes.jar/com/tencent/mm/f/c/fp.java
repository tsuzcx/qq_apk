  ...
  extends IAutoDBItem
{
  ...
  static
  {
    C_ROWID = new Column("rowid", "long", "PluginCodeUsageLRURecord", "");
    hnz = new Column("appid", "string", "PluginCodeUsageLRURecord", "");
    hpJ = new Column("version", "int", "PluginCodeUsageLRURecord", "");
    iqY = new Column("hit", "int", "PluginCodeUsageLRURecord", "");
    iqZ = new Column("hittimems", "long", "PluginCodeUsageLRURecord", "");
  }
  ...
  {
    return "PluginCodeUsageLRURecord";
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mm\classes2.jar
 * Qualified Name:     com.tencent.mm.f.c.fp
