  ...
  extends IAutoDBItem
{
  ...
  static
  {
    C_ROWID = new Column("rowid", "long", "SnsInfo", "");
    C_SNSID = new Column("snsid", "long", "SnsInfo", "");
    C_USERNAME = new Column("username", "string", "SnsInfo", "");
    C_LOCALFLAG = new Column("localflag", "int", "SnsInfo", "");
    C_CREATETIME = new Column("createtime", "int", "SnsInfo", "");
    C_HEAD = new Column("head", "int", "SnsInfo", "");
    C_LOCALPRIVATE = new Column("localprivate", "int", "SnsInfo", "");
    C_TYPE = new Column("type", "int", "SnsInfo", "");
    C_SOURCETYPE = new Column("sourcetype", "int", "SnsInfo", "");
    C_LIKEFLAG = new Column("likeflag", "int", "SnsInfo", "");
    C_PRAVITED = new Column("pravited", "int", "SnsInfo", "");
    C_STRINGSEQ = new Column("stringseq", "string", "SnsInfo", "");
    C_CONTENT = new Column("content", "byte[]", "SnsInfo", "");
    C_ATTRBUF = new Column("attrbuf", "byte[]", "SnsInfo", "");
    C_POSTBUF = new Column("postbuf", "byte[]", "SnsInfo", "");
    C_SUBTYPE = new Column("subtype", "int", "SnsInfo", "");
 ...
 * Qualified Name:     com.tencent.mm.f.c.gr
