  ...
  extends IAutoDBItem
{
  ...
  static
  {
    C_ROWID = new Column("rowid", "long", "KindaConfigCache", "");
    C_KEY = new Column("key", "string", "KindaConfigCache", "");
    C_VALUE = new Column("value", "string", "KindaConfigCache", "");
    C_TYPE = new Column("type", "int", "KindaConfigCache", "");
    C_EXPIRE_AT = new Column("expire_at", "long", "KindaConfigCache", "");
 ...
 * Qualified Name:     com.tencent.mm.f.c.ee
