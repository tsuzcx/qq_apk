...
public final class g
{
  ...
  public static final <_Var> void a(d<_Var> paramd)
  {
    ...
    paramd.a(new d.b()
    {
      public final void bq(_Var paramAnonymous_Var)
      {
        ...
        g.a(this.cnt, new Object[] { paramAnonymous_Var });
    ...
    }).a(new d.a()
    {
      public final void ce(Object paramAnonymousObject)
      {
        ...
        this.cnt.ef(paramAnonymousObject);
  ...
  public static final void b(b paramVarArgs)
  {
    ...
    paramVarArgs.ef(null);
    AppMethodBeat.o(74822);
  }
  
  public static final <Var1> c<Var1> ej(Var1 paramVar1)
  {
  ...
  public static <$1> com.tencent.mm.vending.j.b<$1> ek($1 param$1)
  {
    AppMethodBeat.i(74817);
    param$1 = com.tencent.mm.vending.j.a.el(param$1);
    AppMethodBeat.o(74817);
    return param$1;
  }
  
  public static final c<Void> fSA()
  {
  ...
  public static final b fSv()
  {
    AppMethodBeat.i(74819);
    Object localObject = f.fSz();
    Stack localStack = (Stack)((f)localObject).LFl.get();
    if (localStack == null) {
      localObject = null;
    }
    while (localObject != null)
    {
      localObject = ((c)localObject).fSv();
      AppMethodBeat.o(74819);
      return localObject;
      if (localStack.size() == 0) {
        localObject = null;
      } else {
        localObject = (c)((Stack)((f)localObject).LFl.get()).peek();
      }
    }
    localObject = LFm;
    AppMethodBeat.o(74819);
