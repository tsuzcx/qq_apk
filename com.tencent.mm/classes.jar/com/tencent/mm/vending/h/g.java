...
public class g
{
  private static Map<String, d> RaH;
  private static Map<Thread, d> RaI;
  private static boolean RaJ;
  private static ThreadLocal<d> RaK;
  private static a RaL;
  
  static
  {
    AppMethodBeat.i(74933);
    RaH = new ConcurrentHashMap();
    RaI = new HashMap();
    RaJ = false;
    RaK = new ThreadLocal();
    RaL = null;
  ...
  public static void a(String paramString, d paramd)
  {
    ...
    if ((paramd instanceof h)) {
      try
      {
        RaI.put(((h)paramd).mLooper.getThread(), paramd);
        return;
      }
      finally
      {
    ...
    if ((paramd instanceof i)) {
      try
      {
        RaI.put(((i)paramd).mThread, paramd);
        return;
      }
      finally
      {
  ...
  public static void boG(String paramString)
  {
    AppMethodBeat.i(74929);
    RaH.remove(paramString.toUpperCase(Locale.ENGLISH));
    AppMethodBeat.o(74929);
  }
  
  public static d boH(String paramString)
  {
    AppMethodBeat.i(74930);
    Assert.assertNotNull("Scheduler type is null", paramString);
    d locald = (d)RaH.get(paramString.toUpperCase(Locale.ENGLISH));
  ...
  public static d current()
  {
    ...
    Object localObject3 = (d)RaK.get();
    if ((localObject3 != null) && (RaI.size() == 0))
    {
    ...
    try
    {
      d locald = (d)RaI.remove(Thread.currentThread());
    ...
    if (localObject3 != null)
    {
      ...
      localObject2 = ((a)localObject3).hdJ();
  ...
  static void hdI()
  {
    ...
    //   8: getstatic 42	com/tencent/mm/vending/h/g:RaJ	Z
    //   11: ifeq +12 -> 23
    //   14: ldc 189
    ...
    //   34: iconst_1
    //   35: putstatic 42	com/tencent/mm/vending/h/g:RaJ	Z
    //   38: ldc 193
    //   40: getstatic 197	com/tencent/mm/vending/h/d:UI	Lcom/tencent/mm/vending/h/h;
    //   43: invokestatic 199	com/tencent/mm/vending/h/g:a	(Ljava/lang/String;Lcom/tencent/mm/vending/h/d;)V
    //   46: ldc 201
    //   48: getstatic 204	com/tencent/mm/vending/h/d:LOGIC	Lcom/tencent/mm/vending/h/h;
    //   51: invokestatic 199	com/tencent/mm/vending/h/g:a	(Ljava/lang/String;Lcom/tencent/mm/vending/h/d;)V
    //   54: ldc 206
    //   56: getstatic 209	com/tencent/mm/vending/h/d:HEAVY_WORK	Lcom/tencent/mm/vending/h/h;
