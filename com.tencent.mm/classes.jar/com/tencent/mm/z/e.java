  ...
  implements Cloneable
{
  ...
  private static Paint gfv;
  private float cEY;
  private LinkedList<b> cQo;
  public e.a cQp;
  private Bitmap gfu;
  private Path vU;
  ...
  static
  {
    ...
    gfv.setStyle(Paint.Style.STROKE);
    gfv.setColor(-16776961);
    gfv.setStrokeCap(Paint.Cap.ROUND);
  ...
  public e(e.a parama, Path paramPath, float paramFloat, Bitmap paramBitmap)
  {
    ...
    this.cQp = parama;
    this.gfu = paramBitmap;
    this.vU = paramPath;
    this.cEY = paramFloat;
    gfv.setStrokeWidth(a.bY(24.0F) * paramFloat);
  ...
  public final void draw(Canvas paramCanvas)
  {
    ...
    if (this.cQp == e.a.gfw)
    {
      localObject1 = this.gfu;
      if ((localObject1 != null) && (!((Bitmap)localObject1).isRecycled()))
      {
        paramCanvas.saveLayer(0.0F, 0.0F, ((Bitmap)localObject1).getWidth(), ((Bitmap)localObject1).getHeight(), null, 31);
        paramCanvas.drawColor(0, PorterDuff.Mode.CLEAR);
        paramCanvas.drawPath(this.vU, gfv);
        gfv.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_IN));
        paramCanvas.drawBitmap((Bitmap)localObject1, 0.0F, 0.0F, gfv);
        gfv.setXfermode(null);
        paramCanvas.restore();
      }
    ...
    if (this.cQp == e.a.gfx)
    {
      ...
      localObject1 = (b)this.cQo.getLast();
      ...
      BitmapFactory.decodeResource(ai.getContext().getResources(), 2131233344, (BitmapFactory.Options)localObject2);
      ...
      localObject2 = BitmapFactory.decodeResource(ai.getContext().getResources(), 2131233344, (BitmapFactory.Options)localObject2);
      gfv.setStyle(Paint.Style.FILL);
      gfv.setColorFilter(new LightingColorFilter(i, 1));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (localObject2 != null) {
          paramCanvas.drawBitmap((Bitmap)localObject2, f2, f1, gfv);
        }
        paramCanvas.restore();
        gfv.setStyle(Paint.Style.STROKE);
        gfv.setColorFilter(null);
        AppMethodBeat.o(9271);
        return;
        if (80 < j)
        {
