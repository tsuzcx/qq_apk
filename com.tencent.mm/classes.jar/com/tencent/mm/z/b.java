...
public final class b
{
  ...
  private a a(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    a locala = new a();
    locala.gwz = paramInt1;
    locala.type = paramInt2;
    locala.value = paramString1;
    locala.dpf = paramString2;
    AppMethodBeat.o(150073);
    return locala;
  }
  
  private a a(al.a parama, int paramInt, String paramString1, String paramString2)
  {
  ...
  private void a(a parama)
  {
    ...
    localStringBuffer.append(wo(parama.value));
    localStringBuffer.append("|");
    localStringBuffer.append(wo(parama.dpf));
    if (parama.gwA != null)
    {
      this.gwI.set(parama.gwA, localStringBuffer.toString());
      AppMethodBeat.o(150063);
      return;
    }
    this.gwI.set(parama.gwz, localStringBuffer.toString());
    AppMethodBeat.o(150063);
  }
  
  private a c(al.a parama)
  {
    AppMethodBeat.i(150066);
    String str = (String)this.gwI.get(parama, null);
    if (str == null)
    {
    ...
    {
      ad.e("MicroMsg.NewBadgeDecoder", "exception:%s", new Object[] { bt.n(parama) });
  ...
  private a c(al.a parama, int paramInt)
  {
  ...
  private a cL(int paramInt1, int paramInt2)
  {
    ...
    a locala2 = mv(paramInt1);
    a locala1 = locala2;
    if (locala2 == null)
    {
      locala1 = a(paramInt1, paramInt2, "", "");
      this.gwD.put(paramInt1, locala1);
      a(locala1);
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < arrayOfString.length) {
          if (wp(arrayOfString[i])) {
            parama.gwL.put(Integer.valueOf(arrayOfString[i]).intValue(), unescape(arrayOfString[(i + 1)]));
          } else {
            parama.gwM.put(arrayOfString[i], unescape(arrayOfString[(i + 1)]));
          }
        }
      }
      catch (Exception parama)
  ...
  private b g(al.a parama)
  {
    AppMethodBeat.i(150080);
    b localb2 = (b)this.gwG.get(parama);
    b localb1 = localb2;
    if (localb2 == null)
    {
      localb1 = d(parama);
      ...
      this.gwG.put(parama, localb1);
    }
    AppMethodBeat.o(150080);
    return localb1;
  }
  
  private a ms(int paramInt)
  {
    AppMethodBeat.i(150065);
    String str = (String)this.gwI.get(paramInt, null);
    if (str == null)
    {
    ...
    {
      ad.e("MicroMsg.NewBadgeDecoder", "exception:%s", new Object[] { bt.n(localException) });
      ad.e("MicroMsg.NewBadgeDecoder", "loadDataSource exception content %s", new Object[] { str });
      AppMethodBeat.o(150065);
    }
    return null;
  ...
  private b mt(int paramInt)
  {
    AppMethodBeat.i(150068);
    Object localObject = (String)this.gwI.get(paramInt, null);
    if (localObject == null)
    {
      localObject = mu(paramInt);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramInt < arrayOfString.length) {
          if (wp(arrayOfString[paramInt])) {
            localb.gwL.put(Integer.valueOf(arrayOfString[paramInt]).intValue(), unescape(arrayOfString[(paramInt + 1)]));
          } else {
            localb.gwM.put(arrayOfString[paramInt], unescape(arrayOfString[(paramInt + 1)]));
          }
        }
      }
      catch (Exception localException)
  ...
  public final a K(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    b localb = mw(paramInt2);
    if (localb != null)
    {
      String str = (String)localb.gwL.get(paramInt1);
  ...
  public final a a(al.a parama1, al.a parama2, int paramInt)
  {
    ...
    if (parama2 != null)
    {
      String str = (String)parama2.gwM.get(parama1.name());
      if ((str != null) && (str.equals(locala.dpf)))
      {
        AppMethodBeat.o(150084);
        return null;
      ...
      {
        str = ahr();
        parama2.gwM.put(parama1.name(), str);
        a(parama2);
      }
      AppMethodBeat.o(150084);
      return locala;
  ...
  final void a(b paramb)
  {
    ...
    StringBuffer localStringBuffer = new StringBuffer();
    Object localObject1 = paramb.gwM.entrySet().iterator();
    int i = 0;
    int j;
    int k;
    for (;;)
    {
      ...
      localStringBuffer.append("|");
      localStringBuffer.append(wo((String)localObject2));
      i += 1;
    }
    while (k < paramb.gwL.size())
    {
      i = paramb.gwL.keyAt(k);
      localObject1 = (String)paramb.gwL.get(i);
      if (j != 0) {
        localStringBuffer.append("|");
      }
      localStringBuffer.append(i);
      localStringBuffer.append("|");
      localStringBuffer.append(wo((String)localObject1));
      j += 1;
      k += 1;
    }
    if (paramb.gwC != null)
    {
      this.gwI.set(paramb.gwC, localStringBuffer.toString());
      AppMethodBeat.o(150064);
      return;
    }
    this.gwI.set(paramb.gwK, localStringBuffer.toString());
    AppMethodBeat.o(150064);
  }
  ...
  final String ahr()
  {
    ...
    String str = String.format("%d%04d", new Object[] { Long.valueOf(System.currentTimeMillis()), Integer.valueOf(this.gwH.nextInt(Math.abs(this.gwH.nextInt(2147483647))) % 10000) });
    AppMethodBeat.o(150070);
    return str;
  }
  
  public final void b(al.a parama, int paramInt, String paramString)
  {
  ...
  public final void d(al.a parama1, al.a parama2)
  {
    ...
    if (localb2 == null)
    {
      ...
      localb1 = e(parama2);
      this.gwG.put(parama2, localb1);
    }
    localb1.gwM.put(parama1.name(), locala.dpf);
    a(localb1);
    AppMethodBeat.o(150085);
  }
  
  public final a f(al.a parama)
  {
    AppMethodBeat.i(150078);
    a locala2 = (a)this.gwE.get(parama);
    a locala1 = locala2;
    if (locala2 == null)
    {
      locala2 = c(parama);
  ...
  public final a mv(int paramInt)
  {
    AppMethodBeat.i(150077);
    a locala2 = (a)this.gwD.get(paramInt);
    a locala1 = locala2;
    if (locala2 == null)
    {
      locala2 = ms(paramInt);
  ...
  final b mw(int paramInt)
  {
    AppMethodBeat.i(150079);
    b localb2 = (b)this.gwF.get(paramInt);
    b localb1 = localb2;
    if (localb2 == null)
    {
      localb1 = mt(paramInt);
  ...
  public final class b
  {
    al.a gwC;
    int gwK;
    SparseArray<String> gwL;
    HashMap<String, String> gwM;
    
    public b()
    {
      AppMethodBeat.i(150059);
      this.gwL = new SparseArray();
      this.gwM = new HashMap();
