  ...
  implements c
{
  ...
  public d(String paramString)
  {
    ...
    try
    {
      this.gAc = new JSONObject(paramString);
  ...
  public d(Map paramMap)
  {
    ...
    this.gAc = new JSONObject(paramMap);
  ...
  d(JSONObject paramJSONObject)
  {
    ...
    this.gAc = paramJSONObject;
    AppMethodBeat.o(158466);
  }
  
  public final c Q(String paramString, int paramInt)
  {
    AppMethodBeat.i(158470);
    try
    {
      this.gAc.put(paramString, paramInt);
  ...
  public final c b(String paramString, double paramDouble)
  {
    ...
    try
    {
      this.gAc.put(paramString, paramDouble);
  ...
  public final c f(String paramString, Object paramObject)
  {
    ...
    //   9: ifeq +26 -> 35
    //   12: aload_0
    //   13: getfield 24	com/tencent/mm/ac/d:gAc	Lorg/json/JSONObject;
    //   16: aload_1
    //   17: aload_2
    //   18: checkcast 2	com/tencent/mm/ac/d
    //   21: getfield 24	com/tencent/mm/ac/d:gAc	Lorg/json/JSONObject;
    ...
    //   34: areturn
    //   35: aload_0
    //   36: getfield 24	com/tencent/mm/ac/d:gAc	Lorg/json/JSONObject;
    //   39: aload_1
    //   40: aload_2
  ...
  public final Object get(String paramString)
  {
    ...
    try
    {
      paramString = this.gAc.get(paramString);
  ...
  public final boolean getBoolean(String paramString)
  {
    ...
    try
    {
      boolean bool = this.gAc.getBoolean(paramString);
  ...
  public final double getDouble(String paramString)
  {
    ...
    try
    {
      double d = this.gAc.getDouble(paramString);
  ...
  public final int getInt(String paramString)
  {
    ...
    try
    {
      int i = this.gAc.getInt(paramString);
  ...
  public final long getLong(String paramString)
  {
    ...
    try
    {
      long l = this.gAc.getLong(paramString);
  ...
  public final String getString(String paramString)
  {
    ...
    try
    {
      paramString = this.gAc.getString(paramString);
  ...
  public final boolean has(String paramString)
  {
    ...
    boolean bool = this.gAc.has(paramString);
  ...
  public final boolean isNull(String paramString)
  {
    ...
    boolean bool = this.gAc.isNull(paramString);
  ...
  public final Iterator<String> keys()
  {
    ...
    Iterator localIterator = this.gAc.keys();
  ...
  public final boolean optBoolean(String paramString, boolean paramBoolean)
  {
    ...
    paramBoolean = this.gAc.optBoolean(paramString, paramBoolean);
  ...
  public final double optDouble(String paramString, double paramDouble)
  {
    ...
    paramDouble = this.gAc.optDouble(paramString, paramDouble);
  ...
  public final int optInt(String paramString, int paramInt)
  {
    ...
    paramInt = this.gAc.optInt(paramString, paramInt);
  ...
  public final long optLong(String paramString, long paramLong)
  {
    ...
    paramLong = this.gAc.optLong(paramString, paramLong);
  ...
  public final String optString(String paramString)
  {
    ...
    paramString = this.gAc.optString(paramString);
  ...
  public final String optString(String paramString1, String paramString2)
  {
    ...
    paramString1 = this.gAc.optString(paramString1, paramString2);
  ...
  public final Object remove(String paramString)
  {
    ...
    paramString = this.gAc.remove(paramString);
  ...
  public final c t(String paramString, long paramLong)
  {
    ...
    try
    {
      this.gAc.put(paramString, paramLong);
  ...
  public final c u(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      this.gAc.put(paramString, paramBoolean);
  ...
  public final a wF(String paramString)
  {
    ...
    try
    {
      paramString = this.gAc.getJSONArray(paramString);
      if (paramString == null)
      {
  ...
  public final a wG(String paramString)
  {
    ...
    paramString = this.gAc.optJSONArray(paramString);
    if (paramString == null)
    {
  ...
  public final c wH(String paramString)
  {
    AppMethodBeat.i(158493);
    try
    {
      paramString = this.gAc.getJSONObject(paramString);
      if (paramString == null)
      {
  ...
  public final c wI(String paramString)
  {
    AppMethodBeat.i(158494);
    paramString = this.gAc.optJSONObject(paramString);
    if (paramString == null)
    {
