  ...
  implements c
{
  ...
  public d(String paramString)
  {
    ...
    try
    {
      this.gbM = new JSONObject(paramString);
  ...
  public d(Map paramMap)
  {
    ...
    this.gbM = new JSONObject(paramMap);
  ...
  public final c N(String paramString, int paramInt)
  {
    ...
    try
    {
      this.gbM.put(paramString, paramInt);
  ...
  public final c b(String paramString, double paramDouble)
  {
    ...
    try
    {
      this.gbM.put(paramString, paramDouble);
  ...
  public final Object get(String paramString)
  {
    ...
    try
    {
      paramString = this.gbM.get(paramString);
  ...
  public final boolean getBoolean(String paramString)
  {
    ...
    try
    {
      boolean bool = this.gbM.getBoolean(paramString);
  ...
  public final double getDouble(String paramString)
  {
    ...
    try
    {
      double d = this.gbM.getDouble(paramString);
  ...
  public final int getInt(String paramString)
  {
    ...
    try
    {
      int i = this.gbM.getInt(paramString);
  ...
  public final long getLong(String paramString)
  {
    ...
    try
    {
      long l = this.gbM.getLong(paramString);
  ...
  public final String getString(String paramString)
  {
    ...
    try
    {
      paramString = this.gbM.getString(paramString);
  ...
  public final c h(String paramString, Object paramObject)
  {
    ...
    //   9: ifeq +26 -> 35
    //   12: aload_0
    //   13: getfield 24	com/tencent/mm/ac/d:gbM	Lorg/json/JSONObject;
    //   16: aload_1
    //   17: aload_2
    //   18: checkcast 2	com/tencent/mm/ac/d
    //   21: getfield 24	com/tencent/mm/ac/d:gbM	Lorg/json/JSONObject;
    //   24: invokevirtual 109	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   27: pop
    //   28: ldc 106
    ...
    //   34: areturn
    //   35: aload_0
    //   36: getfield 24	com/tencent/mm/ac/d:gbM	Lorg/json/JSONObject;
    //   39: aload_1
    //   40: aload_2
    //   41: invokevirtual 109	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   44: pop
    //   45: goto -17 -> 28
    //   48: astore_1
    //   49: new 36	com/tencent/mm/ac/g
    //   52: dup
    //   53: aload_1
    //   54: invokespecial 39	com/tencent/mm/ac/g:<init>	(Ljava/lang/Throwable;)V
    //   57: astore_1
    //   58: ldc 106
  ...
  public final boolean has(String paramString)
  {
    ...
    boolean bool = this.gbM.has(paramString);
  ...
  public final c i(String paramString, Object paramObject)
  {
    ...
    //   18: checkcast 2	com/tencent/mm/ac/d
    //   21: getfield 24	com/tencent/mm/ac/d:gbM	Lorg/json/JSONObject;
    //   24: invokevirtual 117	org/json/JSONObject:putOpt	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   27: pop
    //   28: ldc 114
    //   30: invokestatic 27	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   33: aload_0
    ...
    //   39: aload_1
    //   40: aload_2
    //   41: invokevirtual 117	org/json/JSONObject:putOpt	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   44: pop
    //   45: goto -17 -> 28
    //   48: astore_1
    //   49: new 36	com/tencent/mm/ac/g
  ...
  public final boolean isNull(String paramString)
  {
    ...
    boolean bool = this.gbM.isNull(paramString);
  ...
  public final Iterator<String> keys()
  {
    ...
    Iterator localIterator = this.gbM.keys();
  ...
  public final boolean optBoolean(String paramString, boolean paramBoolean)
  {
    ...
    paramBoolean = this.gbM.optBoolean(paramString, paramBoolean);
  ...
  public final double optDouble(String paramString, double paramDouble)
  {
    ...
    paramDouble = this.gbM.optDouble(paramString, paramDouble);
  ...
  public final int optInt(String paramString, int paramInt)
  {
    ...
    paramInt = this.gbM.optInt(paramString, paramInt);
  ...
  public final long optLong(String paramString, long paramLong)
  {
    ...
    paramLong = this.gbM.optLong(paramString, paramLong);
  ...
  public final String optString(String paramString)
  {
    ...
    paramString = this.gbM.optString(paramString);
  ...
  public final String optString(String paramString1, String paramString2)
  {
    ...
    paramString1 = this.gbM.optString(paramString1, paramString2);
  ...
  public final a qA(String paramString)
  {
    ...
    try
    {
      paramString = this.gbM.getJSONArray(paramString);
      if (paramString == null)
      {
  ...
  public final a qB(String paramString)
  {
    ...
    paramString = this.gbM.optJSONArray(paramString);
    if (paramString == null)
    {
  ...
  public final c qC(String paramString)
  {
    ...
    try
    {
      paramString = this.gbM.getJSONObject(paramString);
      if (paramString == null)
      {
  ...
  public final c qD(String paramString)
  {
    ...
    paramString = this.gbM.optJSONObject(paramString);
    if (paramString == null)
    {
  ...
  public final c r(String paramString, long paramLong)
  {
    ...
    try
    {
      this.gbM.put(paramString, paramLong);
  ...
  public final Object remove(String paramString)
  {
    ...
    paramString = this.gbM.remove(paramString);
  ...
  public final c u(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      this.gbM.put(paramString, paramBoolean);
