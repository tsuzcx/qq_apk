  ...
  implements a
{
  ...
  public b(String paramString)
  {
    ...
    try
    {
      this.gAb = new JSONArray(paramString);
  ...
  public final a c(int paramInt, double paramDouble)
  {
    ...
    try
    {
      this.gAb.put(paramInt, paramDouble);
  ...
  public final a cM(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      this.gAb.put(paramInt1, paramInt2);
  ...
  public final a f(int paramInt, Object paramObject)
  {
    ...
    try
    {
      this.gAb.put(paramInt, paramObject);
  ...
  public final Object get(int paramInt)
  {
    ...
    try
    {
      Object localObject = this.gAb.get(paramInt);
  ...
  public final boolean getBoolean(int paramInt)
  {
    ...
    try
    {
      boolean bool = this.gAb.getBoolean(paramInt);
  ...
  public final double getDouble(int paramInt)
  {
    ...
    try
    {
      double d = this.gAb.getDouble(paramInt);
  ...
  public final int getInt(int paramInt)
  {
    ...
    try
    {
      paramInt = this.gAb.getInt(paramInt);
  ...
  public final long getLong(int paramInt)
  {
    ...
    try
    {
      long l = this.gAb.getLong(paramInt);
  ...
  public final String getString(int paramInt)
  {
    ...
    try
    {
      String str = this.gAb.getString(paramInt);
  ...
  public final boolean isNull(int paramInt)
  {
    ...
    boolean bool = this.gAb.isNull(paramInt);
  ...
  public final a mB(int paramInt)
  {
    ...
    try
    {
      Object localObject = this.gAb.getJSONArray(paramInt);
      if (localObject == null)
      {
  ...
  public final a mC(int paramInt)
  {
    ...
    Object localObject = this.gAb.optJSONArray(paramInt);
    if (localObject == null)
    {
  ...
  public final c mD(int paramInt)
  {
    ...
    try
    {
      Object localObject = this.gAb.getJSONObject(paramInt);
      if (localObject == null)
      {
  ...
  public final c mE(int paramInt)
  {
    ...
    Object localObject = this.gAb.optJSONObject(paramInt);
    if (localObject == null)
    {
  ...
  public final Object opt(int paramInt)
  {
    ...
    Object localObject = this.gAb.opt(paramInt);
    if ((localObject instanceof JSONObject))
    {
      localObject = new d((JSONObject)localObject);
  ...
  public final boolean optBoolean(int paramInt)
  {
    ...
    boolean bool = this.gAb.optBoolean(paramInt);
  ...
  public final boolean optBoolean(int paramInt, boolean paramBoolean)
  {
    ...
    paramBoolean = this.gAb.optBoolean(paramInt, paramBoolean);
  ...
  public final double optDouble(int paramInt)
  {
    ...
    double d = this.gAb.optDouble(paramInt);
  ...
  public final double optDouble(int paramInt, double paramDouble)
  {
    ...
    paramDouble = this.gAb.optDouble(paramInt, paramDouble);
  ...
  public final int optInt(int paramInt)
  {
    ...
    paramInt = this.gAb.optInt(paramInt);
  ...
  public final int optInt(int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = this.gAb.optInt(paramInt1, paramInt2);
  ...
  public final long optLong(int paramInt)
  {
    ...
    long l = this.gAb.optLong(paramInt);
  ...
  public final long optLong(int paramInt, long paramLong)
  {
    ...
    paramLong = this.gAb.optLong(paramInt, paramLong);
  ...
  public final String optString(int paramInt)
  {
    ...
    String str = this.gAb.optString(paramInt);
  ...
  public final String optString(int paramInt, String paramString)
  {
    ...
    paramString = this.gAb.optString(paramInt, paramString);
  ...
  public final Object remove(int paramInt)
  {
    ...
    Object localObject = this.gAb.remove(paramInt);
    if ((localObject instanceof JSONObject))
    {
      localObject = new d((JSONObject)localObject);
  ...
  public final a t(int paramInt, long paramLong)
  {
    ...
    try
    {
      this.gAb.put(paramInt, paramLong);
  ...
  public final String toString(int paramInt)
  {
    ...
    try
    {
      String str = this.gAb.toString(paramInt);
  ...
  public final a y(int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      this.gAb.put(paramInt, paramBoolean);
