...
@l(hxD={1, 1, 16}, hxE={""}, hxF={"getKey", "", "originKey", "keyMap", "Ljava/util/HashMap;", "pbToJSON", "Lorg/json/JSONObject;", "originObj", "", "", "jsonObj", "pbToList", "Ljava/util/LinkedList;", "list", "pbToMap", "obj", "clazz", "Ljava/lang/Class;", "putListToJSON", "", "array", "Lorg/json/JSONArray;", "putMapToJSON", "map", "", "safePbToJSON", "libktcomm_release"})
public final class g
{
  private static String a(String paramString, HashMap<String, String> paramHashMap)
  {
    AppMethodBeat.i(168834);
    p.h(paramString, "originKey");
  ...
  private static LinkedList<Object> a(LinkedList<?> paramLinkedList, HashMap<String, String> paramHashMap)
  {
    ...
    for (Object localObject1 = paramLinkedList.get(0);; localObject1 = null)
    {
      ...
      if ((localObject1 instanceof dqi))
      {
