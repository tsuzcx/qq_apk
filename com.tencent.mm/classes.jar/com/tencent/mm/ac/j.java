...
public final class j
{
  ...
  protected static void a(b paramb, Object paramObject)
  {
    ...
    {
      paramb.dD(((Integer)paramObject).intValue());
      AppMethodBeat.o(158632);
      return;
    }
    if ((paramObject instanceof String))
    {
      paramb.Y((String)paramObject);
      AppMethodBeat.o(158632);
      return;
    }
    ...
    {
      paramb.r(((Long)paramObject).longValue());
      AppMethodBeat.o(158632);
      return;
    }
    if ((paramObject instanceof Float))
    {
      paramb.W(((Float)paramObject).floatValue());
      AppMethodBeat.o(158632);
      return;
    }
    if ((paramObject instanceof Integer))
  ...
  protected static void a(e parame, String paramString, Object paramObject)
  {
    ...
    if ((paramObject instanceof String))
    {
      parame.g(paramString, (String)paramObject);
      AppMethodBeat.o(158633);
      return;
    }
    if ((paramObject instanceof Boolean))
 ...
 * Qualified Name:     com.tencent.mm.ac.j
