  ...
  implements k
{
  ...
  public b(String paramString1, String paramString2)
  {
    ...
    ((b.a)localObject).gUU = new cy();
    ((b.a)localObject).gUV = new cz();
    ((b.a)localObject).uri = "/cgi-bin/micromsg-bin/addopenimcontact";
    ((b.a)localObject).funcId = 667;
    this.rr = ((b.a)localObject).atI();
    this.hNH = paramString1;
    localObject = (cy)this.rr.gUS.gUX;
    ((cy)localObject).hNH = paramString1;
    ((cy)localObject).CxM = paramString2;
  ...
  public final void onGYNetEnd(int paramInt1, int paramInt2, int paramInt3, String paramString, q paramq, byte[] paramArrayOfByte)
  {
    ...
    ad.i("MicroMsg.Openim.NetSceneAddOpenIMContact", "onGYNetEnd : errType : %d, errCode : %d, errMsg : %s, tp_username = %s", new Object[] { Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), paramString, this.hNH });
