...
public final class i
{
  ...
  private MMHandler lMk;
  
  private i()
  {
    AppMethodBeat.i(150507);
    HandlerThread localHandlerThread = d.bDj("SLocationManager");
    localHandlerThread.start();
    this.lMk = new MMHandler(localHandlerThread.getLooper());
  ...
  public static i cX(Context paramContext)
  {
  ...
  public final void a(final TencentLocationListener paramTencentLocationListener, final int paramInt, final Looper paramLooper)
  {
    ...
    execute(new Runnable()
    {
      public final void run()
      {
        ...
        h.IzE.idkeyStat(584L, 0L, 1L, true);
        TencentLocationManager.getInstance(i.mContext, new Pair("oaId", q.auQ())).setCoordinateType(paramInt);
        ...
        Log.i("MicroMsg.SLocationManager", "requestCode %d", new Object[] { Integer.valueOf(TencentLocationManager.getInstance(i.mContext, new Pair("oaId", q.auQ())).requestLocationUpdates(localTencentLocationRequest, paramTencentLocationListener, paramLooper)) });
  ...
  public final void blu()
  {
    ...
    execute(new Runnable()
    {
      public final void run()
      {
        ...
        TencentLocationManager.getInstance(i.mContext, new Pair("oaId", q.auQ())).removeUpdates(null);
