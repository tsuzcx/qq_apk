  ...
  extends k
{
  ...
  public final boolean a(d paramd)
  {
    ...
    if ((int)this.hKK.a("qcontact", "username", paramd) != -1)
    {
  ...
  public final boolean a(String paramString, d paramd)
  {
    ...
    if (this.hKK.update("qcontact", paramd.convertTo(), "username=?", new String[] { paramString }) > 0)
    {
      AppMethodBeat.o(27723);
      return true;
    }
  ...
  public final d awi(String paramString)
  {
    Object localObject = null;
    AppMethodBeat.i(27724);
    paramString = "select qcontact.username,qcontact.qq,qcontact.extinfo,qcontact.needupdate,qcontact.extupdateseq,qcontact.imgupdateseq,qcontact.reserved1,qcontact.reserved2,qcontact.reserved3,qcontact.reserved4,qcontact.reserved5,qcontact.reserved6,qcontact.reserved7,qcontact.reserved8 from qcontact   where qcontact.username = \"" + bu.aSk(String.valueOf(paramString)) + "\"";
