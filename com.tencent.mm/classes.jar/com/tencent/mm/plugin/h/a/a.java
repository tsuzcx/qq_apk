...
import com.tencent.mm.plugin.h.b.b;
...
public abstract class a
{
  ...
  protected static com.tencent.mm.plugin.h.b.a ay(ca paramca)
  {
    com.tencent.mm.plugin.h.b.a locala = new com.tencent.mm.plugin.h.b.a();
    locala.field_msgId = paramca.field_msgId;
    locala.field_msgType = paramca.getType();
    locala.field_username = paramca.field_talker;
    locala.field_msgtime = paramca.field_createTime;
    return locala;
  }
  
  public final void aw(ca paramca)
  {
    int j = 0;
    if (paramca == null) {
      return;
    }
    List localList = com.tencent.mm.plugin.h.a.cFg().cFh().az(paramca);
    paramca = ax(paramca);
    ArrayList localArrayList1 = new ArrayList();
    ArrayList localArrayList2 = new ArrayList();
    int k = a(localList, paramca, localArrayList1, localArrayList2);
    String str = info();
    if (localList != null) {}
    for (int i = localList.size();; i = 0)
    {
      ...
      if (!localArrayList1.isEmpty()) {
        com.tencent.mm.plugin.h.a.cFg().cFh().cN(localArrayList1);
      }
      if (localArrayList2.isEmpty()) {
        break;
      }
      com.tencent.mm.plugin.h.a.cFg().cFh().cO(localArrayList2);
      return;
    }
  }
  
  protected abstract List<com.tencent.mm.plugin.h.b.a> ax(ca paramca);
  
  protected final String bAT(String paramString)
  {
