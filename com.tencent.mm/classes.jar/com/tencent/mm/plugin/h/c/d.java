  ...
  extends b
{
  ...
  public d(String paramString, long paramLong, int paramInt, a parama)
  {
    ...
    this.limit = paramInt;
    this.sXq = parama;
    Log.d("MicroMsg.ScanMsgTask", "%d scan msg[%d %d]", new Object[] { Integer.valueOf(hashCode()), Long.valueOf(this.sXp), Integer.valueOf(this.limit) });
  ...
  public final void run()
  {
    ...
    try
    {
      ...
      localCursor1 = localCursor2;
      localObject1 = localObject3;
      localCursor2 = c.bbO().l(this.tableName, this.sXp, this.limit);
      localCursor1 = localCursor2;
      ...
      do
      {
        ...
        localCursor1 = localCursor2;
        localObject1 = localCursor2;
        a.cFg().av((ca)localObject3);
        localCursor1 = localCursor2;
        localObject1 = localCursor2;
        a.cFg().Id(((et)localObject3).field_msgId);
        localCursor1 = localCursor2;
        localObject1 = localCursor2;
        bool = this.isStop;
      } while (!bool);
 ...
 * Qualified Name:     com.tencent.mm.plugin.h.c.d
