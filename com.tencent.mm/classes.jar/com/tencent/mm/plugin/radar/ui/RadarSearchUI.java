...
@l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lcom/tencent/mm/plugin/radar/ui/RadarSearchUI;", "Lcom/tencent/mm/ui/MMBaseActivity;", "()V", "REQUEST_CODE_GDPR_LOCATION_USE_SCENE", "", "mRadarViewController", "Lcom/tencent/mm/plugin/radar/ui/RadarViewController;", "getMRadarViewController", "()Lcom/tencent/mm/plugin/radar/ui/RadarViewController;", "mRadarViewController$delegate", "Lkotlin/Lazy;", "shouldCheckPermission", "", "getSystemService", "", "name", "", "hideTalkRoomeStatusBar", "", "isHide", "onActivityResult", "requestCode", "resultCode", "data", "Landroid/content/Intent;", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "onDestroy", "onKeyDown", "keyCode", "event", "Landroid/view/KeyEvent;", "onPause", "onRequestPermissionsResult", "permissions", "", "grantResults", "", "(I[Ljava/lang/String;[I)V", "onResume", "onResumeAfterMPermissionGranted", "radarUsagePlusOne", "Companion", "plugin-radar_release"})
public final class RadarSearchUI
  extends MMBaseActivity
{
  private static final String TAG = "MicroMsg.RadarSearchUI";
  public static final RadarSearchUI.a wco;
  private boolean iMq;
  private final f wcm;
  private final int wcn;
  
  static
  {
    AppMethodBeat.i(138637);
    $$delegatedProperties = new d.l.k[] { (d.l.k)w.a(new d.g.b.u(w.bn(RadarSearchUI.class), "mRadarViewController", "getMRadarViewController()Lcom/tencent/mm/plugin/radar/ui/RadarViewController;")) };
    wco = new RadarSearchUI.a((byte)0);
  ...
  public RadarSearchUI()
  {
    ...
    this.wcm = d.g.a(d.k.KTe, locala);
    this.iMq = true;
    this.wcn = 30764;
    AppMethodBeat.o(138649);
  }
  
  private final RadarViewController dsP()
  {
    AppMethodBeat.i(138638);
    RadarViewController localRadarViewController = (RadarViewController)this.wcm.getValue();
  ...
  private final void dsQ()
  {
    ...
    pg(true);
    com.tencent.mm.plugin.radar.b.d locald = com.tencent.mm.plugin.radar.b.d.wba;
    com.tencent.mm.plugin.radar.b.d.dsE();
    locald = com.tencent.mm.plugin.radar.b.d.wba;
    com.tencent.mm.plugin.radar.b.d.dsF();
    if ((dsP().getRadarStatus() == e.e.wbw) || (dsP().getRadarStatus() == e.e.wbx))
    {
      dsP().onResume();
      dsP().dsH();
      dsP().getWaveView().dtb();
  ...
  private static void pg(boolean paramBoolean)
  {
    ...
    vv localvv = new vv();
    localvv.dyJ.dyK = paramBoolean;
    com.tencent.mm.sdk.b.a.GpY.l((com.tencent.mm.sdk.b.b)localvv);
  ...
  public final Object getSystemService(String paramString)
  {
    ...
    {
      paramString = com.tencent.mm.ui.z.b((LayoutInflater)localObject);
  ...
  public final void onCreate(Bundle paramBundle)
  {
    ...
    localObject1 = paramBundle.getRadarTips();
    ((RadarTipsView)localObject1).wdi = RadarTipsView.wdl;
    localObject2 = d.wcl;
    int i = d.dsO();
    ((RadarTipsView)localObject1).wda.sendEmptyMessageDelayed(((RadarTipsView)localObject1).wcX, i);
    ((RadarTipsView)localObject1).wda.sendEmptyMessageDelayed(((RadarTipsView)localObject1).wcW, i + 8000);
    paramBundle.getRadarTips().setPressingDown(true);
    paramBundle.getQuitBtn().setOnClickListener(paramBundle.wdF);
    ...
    i = j;
    if (aj.aG(paramBundle.getContext())) {
      i = j + aj.aF(paramBundle.getContext());
    }
    ...
    ((RadarWaveView)localObject1).weg = ((RadarWaveView)localObject1).findViewById(2131303696);
    ((RadarWaveView)localObject1).weh = AnimationUtils.loadAnimation(((RadarWaveView)localObject1).getContext(), 2130772118);
    localObject1 = ((RadarWaveView)localObject1).weh;
    if (localObject1 == null) {
      d.g.b.k.fOy();
    }
    ((Animation)localObject1).setInterpolator((Interpolator)new LinearInterpolator());
    localObject1 = b.a.wbN;
    ...
    paramBundle.wdC = new RadarViewController.c(paramBundle, (RadarSpecialGridView)localObject1, (Context)localObject2);
    paramBundle.getGrid().setOnItemClickListener((RadarSpecialGridView.a)new RadarViewController.h(paramBundle));
    paramBundle = dsP();
    localObject1 = paramBundle.wdB;
    ...
    ((com.tencent.mm.plugin.messenger.foundation.a.k)localObject2).awB().a((n.b)localObject1);
    com.tencent.mm.sdk.b.a.GpY.c((com.tencent.mm.sdk.b.c)((com.tencent.mm.plugin.radar.b.c)localObject1).way);
    ...
    ((com.tencent.mm.plugin.messenger.foundation.a.q)localObject2).getSysCmdMsgExtension().a("addcontact", (cc.a)((com.tencent.mm.plugin.radar.b.c)localObject1).waz, true);
    paramBundle = paramBundle.wdA;
    if (paramBundle == null) {
      d.g.b.k.aVY("radarManager");
    }
    com.tencent.mm.kernel.g.agi().a(425, (com.tencent.mm.ak.g)paramBundle);
    com.tencent.mm.kernel.g.agi().a(602, (com.tencent.mm.ak.g)paramBundle);
    paramBundle = com.tencent.mm.kernel.g.agR().agA().get(229377, Integer.valueOf(0));
    if (paramBundle == null)
    {
    ...
    com.tencent.mm.kernel.g.agR().agA().set(229377, Integer.valueOf(i + 1));
    AppMethodBeat.o(138639);
  }
  ...
  public final void onDestroy()
  {
    ...
    localObject1 = dsP();
    Object localObject2 = ((RadarViewController)localObject1).wdB;
    ...
    ((com.tencent.mm.plugin.messenger.foundation.a.k)localObject3).awB().b((n.b)localObject2);
    com.tencent.mm.sdk.b.a.GpY.d((com.tencent.mm.sdk.b.c)((com.tencent.mm.plugin.radar.b.c)localObject2).way);
    ...
    ((com.tencent.mm.plugin.messenger.foundation.a.q)localObject3).getSysCmdMsgExtension().b("addcontact", (cc.a)((com.tencent.mm.plugin.radar.b.c)localObject2).waz, true);
    localObject2 = ((RadarViewController)localObject1).wdA;
    if (localObject2 == null) {
      d.g.b.k.aVY("radarManager");
    }
    com.tencent.mm.kernel.g.agi().b(425, (com.tencent.mm.ak.g)localObject2);
    com.tencent.mm.kernel.g.agi().b(602, (com.tencent.mm.ak.g)localObject2);
    ((com.tencent.mm.plugin.radar.b.e)localObject2).stop();
    localObject3 = ((com.tencent.mm.plugin.radar.b.e)localObject2).hxT;
    if (localObject3 != null) {
      ((com.tencent.mm.modelgeo.d)localObject3).c(((com.tencent.mm.plugin.radar.b.e)localObject2).fnd);
    }
    localObject1 = ((RadarViewController)localObject1).getWaveView();
    try
    {
      localObject2 = ((RadarWaveView)localObject1).wef;
      if (localObject2 != null)
      {
        ((MediaPlayer)localObject2).stop();
        ((MediaPlayer)localObject2).release();
      }
      ((RadarWaveView)localObject1).wef = null;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ac.printErrStackTrace(RadarWaveView.TAG, (Throwable)localException, "", new Object[0]);
        ac.e(RadarWaveView.TAG, "stop() crash, because of the native mediaplay is null.");
        ((RadarWaveView)localObject1).wef = null;
      }
    }
    super.onDestroy();
  ...
  public final boolean onKeyDown(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    boolean bool = dsP().onKeyDown(paramInt, paramKeyEvent);
    if (bool)
    {
  ...
  public final void onPause()
  {
    ...
    super.onPause();
    pg(false);
    Object localObject1 = com.tencent.mm.plugin.radar.b.d.wba;
    long l1;
    if (com.tencent.mm.plugin.radar.b.d.waW != 0L)
    {
      l1 = com.tencent.mm.plugin.radar.b.d.dsG() - com.tencent.mm.plugin.radar.b.d.waW;
      localObject1 = d.wcl;
      if (d.wo(l1)) {
        break label446;
      }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (i != 0)
      {
        i = com.tencent.mm.plugin.radar.b.d.dni;
        ac.d(com.tencent.mm.plugin.radar.b.d.TAG, "FoundFriendsCnt %d", new Object[] { Integer.valueOf(i) });
        localObject1 = com.tencent.mm.plugin.report.service.h.wUl;
        localObject2 = d.g.b.z.KUT;
        ...
        com.tencent.mm.plugin.radar.b.d.waT += 1;
        com.tencent.mm.plugin.radar.b.d.waU = l1 + com.tencent.mm.plugin.radar.b.d.waU;
        com.tencent.mm.plugin.radar.b.d.waW = 0L;
      }
      localObject1 = com.tencent.mm.plugin.radar.b.d.wba;
      if (com.tencent.mm.plugin.radar.b.d.waV != 0L)
      {
        l1 = System.currentTimeMillis();
        long l2 = com.tencent.mm.plugin.radar.b.d.waV;
        i = com.tencent.mm.plugin.radar.b.d.waT;
        float f1 = (float)com.tencent.mm.plugin.radar.b.d.waU * 1.0F / 1000.0F;
        int j = com.tencent.mm.plugin.radar.b.d.waX;
        float f2 = (float)(l1 - l2) * 1.0F / 1000.0F;
        ac.d(com.tencent.mm.plugin.radar.b.d.TAG, "RadarAddFriendStat %d,%d,%s,%d,%s", new Object[] { Integer.valueOf(1), Integer.valueOf(i), Float.valueOf(f1), Integer.valueOf(j), Float.valueOf(f2) });
        localObject1 = com.tencent.mm.plugin.report.service.h.wUl;
        localObject2 = d.g.b.z.KUT;
      ...
      if ((dsP().getRadarStatus() == e.e.wbw) || (dsP().getRadarStatus() == e.e.wbx))
      {
        localObject1 = dsP().wdA;
        if (localObject1 == null) {
          d.g.b.k.aVY("radarManager");
        }
        ((com.tencent.mm.plugin.radar.b.e)localObject1).dsI();
        localObject1 = dsP().wdA;
        if (localObject1 == null) {
          d.g.b.k.aVY("radarManager");
        }
        localObject2 = ((com.tencent.mm.plugin.radar.b.e)localObject1).hxT;
        if (localObject2 != null) {
          ((com.tencent.mm.modelgeo.d)localObject2).c(((com.tencent.mm.plugin.radar.b.e)localObject1).fnd);
        }
        dsP().getWaveView().dtc();
      }
  ...
  public final void onRequestPermissionsResult(int paramInt, String[] paramArrayOfString, int[] paramArrayOfInt)
  {
    ...
    if (paramArrayOfInt.length <= 0)
    {
      ...
      ac.i(paramArrayOfString, "onRequestPermissionsResult grantResults length 0. requestCode[%d], tid[%d]", new Object[] { Integer.valueOf(paramInt), Long.valueOf(paramArrayOfInt.getId()) });
    ...
    ac.i(paramArrayOfString, "onRequestPermissionsResult requestCode[%d],grantResults[%d] tid[%d]", new Object[] { Integer.valueOf(paramInt), Integer.valueOf(i), Long.valueOf(localThread.getId()) });
    switch (paramInt)
    {
    }
    for (;;)
    {
      ...
      this.iMq = false;
      com.tencent.mm.ui.base.h.a((Context)this, getString(2131761869), getString(2131761885), getString(2131760598), getString(2131761861), false, (DialogInterface.OnClickListener)new RadarSearchUI.b(this), (DialogInterface.OnClickListener)new RadarSearchUI.c(this));
    }
  }
  ...
  public final void onResume()
  {
    ...
    if (this.iMq)
    {
      ...
      Object localObject2 = ((com.tencent.mm.kernel.e)localObject1).agA().get(274436);
      localObject1 = localObject2;
      if (!(localObject2 instanceof String)) {
        localObject1 = null;
      }
      if (com.tencent.mm.aw.b.CQ((String)localObject1))
      {
        if (!com.tencent.mm.pluginsdk.permission.b.o((Context)this, "android.permission.ACCESS_COARSE_LOCATION"))
        {
          ...
          d.g.b.k.g(localObject1, "MMKernel.storage()");
          localObject1 = ((com.tencent.mm.kernel.e)localObject1).agA().get(ah.a.GRN, Boolean.FALSE);
          if (localObject1 == null)
          {
          ...
          {
            com.tencent.mm.plugin.account.a.b.a.b((Context)this, getString(2131760740, new Object[] { ab.eUO() }), this.wcn, true);
            AppMethodBeat.o(138640);
            return;
          }
          com.tencent.mm.pluginsdk.permission.b.b((Activity)this, "android.permission.ACCESS_COARSE_LOCATION", 64);
      ...
      else
      {
        ...
        ac.i(TAG, "summerper checkPermission checkLocation[%b]", new Object[] { Boolean.valueOf(bool) });
        if (!bool)
        {
          AppMethodBeat.o(138640);
          return;
