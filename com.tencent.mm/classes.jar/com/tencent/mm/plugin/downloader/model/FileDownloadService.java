  ...
  extends MMIntentService
{
  ...
  private static final String pmO;
  public static final String pmP;
  public static final String pmQ;
  public static final String pmR;
  public static final String pmS;
  
  static
  {
    AppMethodBeat.i(89010);
    pmO = FileDownloadService.class.getSimpleName() + "_extra_";
    EXTRA_ID = pmO + "id";
    pmP = pmO + "action_type";
    EXTRA_PACKAGE_NAME = pmO + "package_name";
    pmQ = pmO + "file_path";
    pmR = pmO + "md5";
    pmS = pmO + "change_url";
  ...
  public final void onHandleIntent(Intent paramIntent)
  {
    ...
    int i = paramIntent.getIntExtra(pmP, 0);
    ...
    case 1: 
      ...
      localObject2 = d.ua(l2);
      if (localObject2 != null)
      {
        if ((paramIntent.getBooleanExtra(pmS, false)) || (((com.tencent.mm.plugin.downloader.g.a)localObject2).field_isSecondDownload)) {}
        for (bool1 = true;; bool1 = false)
        {
          ad.i("MicroMsg.FileDownloadService", "filePath = " + ((com.tencent.mm.plugin.downloader.g.a)localObject2).field_filePath);
          if ((!bt.isNullOrNil(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_filePath)) && (i.fv(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_filePath))) {
            break;
          }
          com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(710L, 5L, 1L, false);
          ((com.tencent.mm.plugin.downloader.g.a)localObject2).field_status = 4;
          ((com.tencent.mm.plugin.downloader.g.a)localObject2).field_errCode = com.tencent.mm.plugin.downloader.a.a.pjm;
          d.e((com.tencent.mm.plugin.downloader.g.a)localObject2);
          paramIntent = f.ccl();
          i = com.tencent.mm.plugin.downloader.a.a.pjm;
          ad.i("MicroMsg.FileDownloadManager", "onDownloadFailed, id = %d, errCode = %d", new Object[] { Long.valueOf(l2), Integer.valueOf(i) });
          if (paramIntent.pmp != null) {
            paramIntent.pmp.c(l2, i, bool1);
          }
        ...
        try
        {
          ...
          localObject1 = com.tencent.mm.vfs.q.B(((com.tencent.mm.vfs.e)localObject3).fOK());
          bool2 = com.tencent.mm.plugin.downloader.d.b.aab((String)localObject1);
          if (!bool2) {
            break label733;
          }
          paramIntent = "v2";
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        if (((com.tencent.mm.plugin.downloader.g.a)localObject2).field_reserveInWifi)
        {
          ...
          d.e((com.tencent.mm.plugin.downloader.g.a)localObject2);
          d.cN(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_downloadUrl, 3);
          f.ccl().o(l2, bool1);
          AppMethodBeat.o(89008);
          return;
          label733:
        ...
        if (((com.tencent.mm.plugin.downloader.g.a)localObject2).field_downloaderType == 3) {
          if (((com.tencent.mm.plugin.downloader.g.a)localObject2).field_downloadUrl.startsWith("https"))
          {
            com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(710L, 10L, 1L, false);
            ((com.tencent.mm.plugin.downloader.g.a)localObject2).field_status = 4;
            ((com.tencent.mm.plugin.downloader.g.a)localObject2).field_channelId = paramIntent;
            ((com.tencent.mm.plugin.downloader.g.a)localObject2).field_errCode = com.tencent.mm.plugin.downloader.a.a.pji;
            ((com.tencent.mm.plugin.downloader.g.a)localObject2).field_downloadedSize = i.aYo(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_filePath);
            d.e((com.tencent.mm.plugin.downloader.g.a)localObject2);
            ad.i("MicroMsg.FileDownloadService", "ChannelId = %s, receivedSize = %d, fileSize = %d", new Object[] { paramIntent, Long.valueOf(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_downloadedSize), Long.valueOf(i.aYo(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_filePath)) });
            ...
            paramIntent = new g.a();
            paramIntent.aak(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_secondaryUrl);
            paramIntent.ui(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_fileSize);
            paramIntent.aam(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_fileName);
            paramIntent.setAppId(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_appId);
            paramIntent.aan(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_md5);
            paramIntent.setScene(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_scene);
            paramIntent.aao(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_extInfo);
            paramIntent.pmN.pmC = true;
            paramIntent.jQ(true);
            paramIntent.Bp(1);
            paramIntent.ft(((com.tencent.mm.plugin.downloader.g.a)localObject2).field_packageName);
            paramIntent.pmN.pmE = true;
        ...
        try
        {
          ...
          paramIntent.T(((com.tencent.mm.plugin.downloader.c.b.q)localObject3).pkp);
          label1193:
          if (((com.tencent.mm.plugin.downloader.g.a)localObject2).field_downloaderType != 3)
          {
            l1 = f.ccl().a(paramIntent.pmN);
            com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(710L, 8L, 1L, false);
          }
          for (;;)
          {
            ...
            AppMethodBeat.o(89008);
            return;
            com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(710L, 9L, 1L, false);
            break;
            if (((com.tencent.mm.plugin.downloader.g.a)localObject2).field_downloadUrl.startsWith("https"))
            {
              com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(710L, 7L, 1L, false);
              break;
            }
            com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(710L, 6L, 1L, false);
            break;
            label1331:
            bool2 = false;
            break label981;
            ...
            i = 0;
            break label1046;
            l1 = f.ccl().b(paramIntent.pmN);
            com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(710L, 11L, 1L, false);
          }
          label1370:
          paramIntent = f.ccl();
          localObject1 = d.ua(l2);
          if (localObject1 != null)
          {
          ...
          for (;;)
          {
            paramIntent.pmp.c(l2, com.tencent.mm.plugin.downloader.a.a.pji, bool1);
            AppMethodBeat.o(89008);
            return;
            label1450:
            if ((((com.tencent.mm.plugin.downloader.g.a)localObject1).field_showNotification) && (!bt.isNullOrNil(((com.tencent.mm.plugin.downloader.g.a)localObject1).field_fileName))) {
          ...
          localObject1 = paramIntent.getStringExtra(pmQ);
          l1 = paramIntent.getLongExtra("downloadId", -1L);
          if ((bt.isNullOrNil((String)localObject1)) || (!i.fv((String)localObject1)))
          {
