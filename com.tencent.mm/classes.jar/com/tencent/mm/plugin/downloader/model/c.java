...
{
  private static Vector<m> uhk;
  private static m uhl;
  ...
  public static void a(m paramm)
  {
    ...
    if ((paramm != null) && (!uhk.contains(paramm))) {
      uhk.add(paramm);
    }
  ...
  public final void IC(final long paramLong)
  {
    AppMethodBeat.i(88943);
    Log.i("MicroMsg.FileDownloaderCallbackManager", "notifyTaskRemoved: %d", new Object[] { Long.valueOf(paramLong) });
    a locala = d.IF(paramLong);
    if (locala != null) {
      com.tencent.mm.plugin.downloader.a.c.v(new String[] { locala.field_downloadUrl, locala.field_secondaryUrl });
    }
  ...
  public final void ID(final long paramLong)
  {
  ...
  public final void IE(final long paramLong)
  {
  ...
  public final void b(final long paramLong1, String paramString, final long paramLong2, final long paramLong3)
  {
    ...
    MMHandlerThread.postToMainThread(new Runnable()
    {
      public final void run()
      {
        ...
        while (i < j)
        {
          arrayOfm[i].a(paramLong1, paramLong2, paramLong3, this.uhp);
          i += 1;
        }
  ...
  public final void c(final long paramLong, int paramInt, final boolean paramBoolean)
  {
    ...
    MMHandlerThread.postToMainThread(new Runnable()
    {
      public final void run()
      {
        ...
        while (i < j)
        {
          arrayOfm[i].b(paramLong, paramBoolean, this.uhn);
          i += 1;
        }
        if (c.cPV() != null) {
          c.cPV().b(paramLong, paramBoolean, this.uhn);
        }
  ...
  public final void o(final long paramLong, String paramString)
  {
    ...
    MMHandlerThread.postToMainThread(new Runnable()
    {
      public final void run()
      {
        ...
        while (i < j)
        {
          arrayOfm[i].m(paramLong, this.val$path);
          i += 1;
        }
        if (c.cPV() != null) {
          c.cPV().m(paramLong, this.val$path);
        }
  ...
  public final void p(final long paramLong, String paramString)
  {
    ...
    MMHandlerThread.postToMainThread(new Runnable()
    {
      public final void run()
      {
        ...
        while (i < j)
        {
          arrayOfm[i].n(paramLong, this.val$path);
          i += 1;
        }
        if (c.cPV() != null) {
          c.cPV().n(paramLong, this.val$path);
        }
