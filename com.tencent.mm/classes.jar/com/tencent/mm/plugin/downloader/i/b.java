...
public final class b
{
  public static void a(long paramLong, float paramFloat, int paramInt)
  {
    ...
    ac.d("MicroMsg.FileDownloadSP", "speed = ".concat(String.valueOf(paramFloat)));
    int i = Math.round(100.0F * paramFloat);
    String str = i + "_" + paramInt;
    ac.d("MicroMsg.FileDownloadSP", "speedStr = ".concat(String.valueOf(str)));
    m(paramLong, str);
  ...
  private static void m(long paramLong, String paramString)
  {
    ...
    SharedPreferences localSharedPreferences = ai.getContext().getSharedPreferences("download_pref", 0);
    ...
    {
      ac.d("MicroMsg.FileDownloadSP", "saveDownloadSpeed, speedStr = ".concat(String.valueOf(paramString)));
      localSharedPreferences.edit().putString(String.valueOf(paramLong), paramString).apply();
      AppMethodBeat.o(89137);
      return;
      String[] arrayOfString = str.split("\\|");
      i = bs.getInt(arrayOfString[(arrayOfString.length - 1)].split("_")[0], 0);
    }
  }
}
