...
{
  private com.tencent.mm.ui.widget.a.d iKm = null;
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    locala.aXF("");
    locala.afi(2131759048);
    locala.afl(2131755939).c(paramBundle);
    locala.afm(2131755831).d((DialogInterface.OnClickListener)localObject);
    locala.a(local3);
    this.iKm = locala.fMb();
    this.iKm.show();
    paramBundle = com.tencent.mm.plugin.downloader.model.d.ua(l);
    if (paramBundle != null)
    {
      localObject = new b();
