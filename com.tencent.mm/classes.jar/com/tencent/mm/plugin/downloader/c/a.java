...
{
  public static void G(ByteBuffer paramByteBuffer)
  {
  ...
  public static boolean amG(String paramString)
  {
    ...
    //   8: aload_0
    //   9: iconst_0
    //   10: invokestatic 52	com/tencent/mm/vfs/y:eA	(Ljava/lang/String;Z)Ljava/io/RandomAccessFile;
    //   13: astore_0
    //   14: aload_0
    //   15: invokestatic 56	com/tencent/mm/plugin/downloader/c/a:g	(Ljava/io/RandomAccessFile;)Landroid/util/Pair;
    //   18: astore 13
    //   20: aload 13
    ...
    //   43: aload_0
    //   44: lload 4
    //   46: invokestatic 77	com/tencent/mm/plugin/downloader/c/h:c	(Ljava/io/RandomAccessFile;J)Z
    //   49: ifeq +39 -> 88
    //   52: new 9	com/tencent/mm/plugin/downloader/c/a$b
    //   55: dup
    //   56: ldc 79
    //   58: invokespecial 80	com/tencent/mm/plugin/downloader/c/a$b:<init>	(Ljava/lang/String;)V
    //   61: astore 12
    //   63: ldc 46
    ...
    //   88: aload 12
    //   90: lload 4
    //   92: invokestatic 89	com/tencent/mm/plugin/downloader/c/a:c	(Ljava/nio/ByteBuffer;J)J
    //   95: lstore 6
    //   97: aload_0
    //   98: lload 6
    //   100: invokestatic 92	com/tencent/mm/plugin/downloader/c/a:b	(Ljava/io/RandomAccessFile;J)Landroid/util/Pair;
    //   103: astore 13
    //   105: aload 13
    ...
    //   126: lstore 8
    //   128: aload 14
    //   130: invokestatic 94	com/tencent/mm/plugin/downloader/c/a:G	(Ljava/nio/ByteBuffer;)V
    //   133: aload 14
    //   135: aload 14
    //   137: invokevirtual 98	java/nio/ByteBuffer:capacity	()I
    //   140: bipush 24
    //   142: isub
    //   143: invokestatic 101	com/tencent/mm/plugin/downloader/c/a:c	(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    //   146: astore 13
    //   148: iconst_0
    //   149: istore_1
    //   150: aload 13
    ...
    //   172: new 9	com/tencent/mm/plugin/downloader/c/a$b
    //   175: dup
    //   176: ldc 110
    //   178: iload_1
    ...
    //   185: invokespecial 80	com/tencent/mm/plugin/downloader/c/a$b:<init>	(Ljava/lang/String;)V
    //   188: astore 12
    //   190: ldc 46
    ...
    //   237: lcmp
    //   238: ifle +46 -> 284
    //   241: new 9	com/tencent/mm/plugin/downloader/c/a$b
    //   244: dup
    ...
    //   271: invokespecial 80	com/tencent/mm/plugin/downloader/c/a$b:<init>	(Ljava/lang/String;)V
    //   274: astore 12
    //   276: ldc 46
    ...
    //   303: new 9	com/tencent/mm/plugin/downloader/c/a$b
    //   306: dup
    ...
    //   345: invokespecial 80	com/tencent/mm/plugin/downloader/c/a$b:<init>	(Ljava/lang/String;)V
    //   348: astore 12
    //   350: ldc 46
    ...
    //   368: new 6	com/tencent/mm/plugin/downloader/c/a$a
    //   371: dup
    //   372: aload 13
    //   374: iload_2
    //   375: iconst_4
    //   376: isub
    //   377: invokestatic 160	com/tencent/mm/plugin/downloader/c/a:d	(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    //   380: lload 8
    //   382: lload 6
    //   384: lload 4
    //   386: aload 12
    //   388: iconst_0
    //   389: invokespecial 163	com/tencent/mm/plugin/downloader/c/a$a:<init>	(Ljava/nio/ByteBuffer;JJJLjava/nio/ByteBuffer;B)V
    //   392: pop
    //   393: aload_0
    //   394: ifnull +7 -> 401
    //   397: aload_0
    ...
    //   416: pop
    //   417: goto -267 -> 150
    //   420: new 9	com/tencent/mm/plugin/downloader/c/a$b
    //   423: dup
    //   424: ldc 168
    //   426: invokespecial 80	com/tencent/mm/plugin/downloader/c/a$b:<init>	(Ljava/lang/String;)V
    //   429: astore 12
    //   431: ldc 46
    ...
    // Exception table:
    //   from	to	target	type
    //   14	71	71	com/tencent/mm/plugin/downloader/c/a$b
    //   88	148	71	com/tencent/mm/plugin/downloader/c/a$b
    //   150	158	71	com/tencent/mm/plugin/downloader/c/a$b
    //   162	198	71	com/tencent/mm/plugin/downloader/c/a$b
    //   216	223	71	com/tencent/mm/plugin/downloader/c/a$b
    //   241	284	71	com/tencent/mm/plugin/downloader/c/a$b
    //   288	358	71	com/tencent/mm/plugin/downloader/c/a$b
    //   358	393	71	com/tencent/mm/plugin/downloader/c/a$b
    //   408	417	71	com/tencent/mm/plugin/downloader/c/a$b
    //   420	439	71	com/tencent/mm/plugin/downloader/c/a$b
    //   14	71	198	finally
    //   88	148	198	finally
    //   150	158	198	finally
    //   162	198	198	finally
    ...
    //   420	439	198	finally
    //   8	14	439	finally
    //   8	14	446	com/tencent/mm/plugin/downloader/c/a$b
  }
  ...
  public static long c(ByteBuffer paramByteBuffer, long paramLong)
  {
    AppMethodBeat.i(88852);
    long l = h.I(paramByteBuffer);
    if (l >= paramLong)
    {
    ...
    if (h.J(paramByteBuffer) + l != paramLong)
    {
  ...
  {
    private final ByteBuffer xmC;
    private final long xmD;
    private final long xmE;
    private final long xmF;
    private final ByteBuffer xmG;
    
    private a(ByteBuffer paramByteBuffer1, long paramLong1, long paramLong2, long paramLong3, ByteBuffer paramByteBuffer2)
    {
      this.xmC = paramByteBuffer1;
      this.xmD = paramLong1;
      this.xmE = paramLong2;
      this.xmF = paramLong3;
      this.xmG = paramByteBuffer2;
    }
  }
