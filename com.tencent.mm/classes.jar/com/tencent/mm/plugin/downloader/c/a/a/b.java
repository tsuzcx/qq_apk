  ...
  extends bvk
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.e(2, 8, this.kVN);
      if (this.kVO != null)
      {
        paramVarArgs.iQ(3, this.kVO.computeSize());
        this.kVO.writeFields(paramVarArgs);
      }
      AppMethodBeat.o(35509);
      return 0;
    }
    ...
    {
      int i = paramInt + e.a.a.a.c(2, 8, this.kVN);
      paramInt = i;
      if (this.kVO != null) {
        paramInt = i + e.a.a.a.iP(3, this.kVO.computeSize());
      }
      AppMethodBeat.o(35509);
      return paramInt;
      if (paramInt == 2)
