  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.pjM != null)
      {
        paramVarArgs.lC(1, this.pjM.computeSize());
        this.pjM.writeFields(paramVarArgs);
      }
      if (this.pjN != null) {
        paramVarArgs.d(2, this.pjN);
      }
      AppMethodBeat.o(153049);
      return 0;
    }
    ...
    label418:
    for (paramInt = f.a.a.a.lB(1, this.pjM.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.pjN != null) {
        i = paramInt + f.a.a.b.b.a.e(2, this.pjN);
      }
      AppMethodBeat.o(153049);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localh.pjM = ((d)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(153049);
          return 0;
        }
        localh.pjN = ((f.a.a.a.a)localObject1).NPN.readString();
        AppMethodBeat.o(153049);
        return 0;
      }
      AppMethodBeat.o(153049);
