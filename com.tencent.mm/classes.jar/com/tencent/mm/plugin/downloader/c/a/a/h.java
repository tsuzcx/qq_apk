  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.oGi != null)
      {
        paramVarArgs.ln(1, this.oGi.computeSize());
        this.oGi.writeFields(paramVarArgs);
      }
      if (this.oGj != null) {
        paramVarArgs.d(2, this.oGj);
      }
      AppMethodBeat.o(153049);
      return 0;
    }
    ...
    label418:
    for (paramInt = f.a.a.a.lm(1, this.oGi.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.oGj != null) {
        i = paramInt + f.a.a.b.b.a.e(2, this.oGj);
      }
      AppMethodBeat.o(153049);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localh.oGi = ((d)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(153049);
          return 0;
        }
        localh.oGj = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(153049);
        return 0;
      }
      AppMethodBeat.o(153049);
