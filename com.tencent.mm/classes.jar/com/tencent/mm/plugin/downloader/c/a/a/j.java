  ...
  extends ckq
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.kW(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.ocM != null) {
        i = paramInt + f.a.a.b.b.a.e(3, this.ocM);
      }
      paramInt = i;
      if (this.source != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          return 0;
        case 3: 
          localj.ocM = ((f.a.a.a.a)localObject1).KhF.readString();
          AppMethodBeat.o(153052);
          return 0;
        }
        localj.source = ((f.a.a.a.a)localObject1).KhF.readString();
        AppMethodBeat.o(153052);
        return 0;
      }
      AppMethodBeat.o(153052);
