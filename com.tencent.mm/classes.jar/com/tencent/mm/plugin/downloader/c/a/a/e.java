  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.e(1, 8, this.pjI);
      paramVarArgs.aY(2, this.pjJ);
    ...
    if (paramInt == 1)
    {
      paramInt = f.a.a.a.c(1, 8, this.pjI);
      i = f.a.a.b.b.a.p(2, this.pjJ);
      AppMethodBeat.o(153046);
      return paramInt + 0 + i;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      case 1: 
        ...
        while (paramInt < i)
        {
          ...
          locale.pjI.add(localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(153046);
        return 0;
      }
      locale.pjJ = ((f.a.a.a.a)localObject1).NPN.zd();
      AppMethodBeat.o(153046);
      return 0;
    }
    AppMethodBeat.o(153046);
