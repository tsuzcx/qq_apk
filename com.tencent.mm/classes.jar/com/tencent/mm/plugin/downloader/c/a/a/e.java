...
{
  public LinkedList<g> pqn;
  public long pqo;
  
  public e()
  {
    AppMethodBeat.i(153045);
    this.pqn = new LinkedList();
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.e(1, 8, this.pqn);
      paramVarArgs.aZ(2, this.pqo);
    ...
    if (paramInt == 1)
    {
      paramInt = f.a.a.a.c(1, 8, this.pqn);
      i = f.a.a.b.b.a.p(2, this.pqo);
      AppMethodBeat.o(153046);
      return paramInt + 0 + i;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      case 1: 
        ...
        while (paramInt < i)
        {
          ...
          locale.pqn.add(localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(153046);
        return 0;
      }
      locale.pqo = ((f.a.a.a.a)localObject1).OmT.zd();
      AppMethodBeat.o(153046);
      return 0;
    }
    AppMethodBeat.o(153046);
