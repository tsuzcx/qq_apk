  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.e(1, 8, this.ocF);
      paramVarArgs.aG(2, this.ocG);
    ...
    if (paramInt == 1)
    {
      paramInt = f.a.a.a.c(1, 8, this.ocF);
      i = f.a.a.b.b.a.q(2, this.ocG);
      AppMethodBeat.o(153046);
      return paramInt + 0 + i;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      case 1: 
        ...
        while (paramInt < i)
        {
          ...
          locale.ocF.add(localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(153046);
        return 0;
      }
      locale.ocG = ((f.a.a.a.a)localObject1).KhF.xT();
      AppMethodBeat.o(153046);
      return 0;
    }
    AppMethodBeat.o(153046);
