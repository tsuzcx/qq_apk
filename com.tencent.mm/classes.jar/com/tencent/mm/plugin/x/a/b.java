...
final class b
  extends a.a
{
  private final Map<String, a.b> DlW;
  ...
  private static String getManufacturer()
  {
    ...
    String str = ae.cu(MMApplicationContext.getContext()).toLowerCase();
  ...
  public final boolean eVn()
  {
    ...
    a.b localb = (a.b)this.DlW.get(str);
    if ((this.DlW.containsKey(str)) && (localb.eVo()))
    {
  ...
  public final void gX(Context paramContext)
  {
    ...
    Object localObject = ae.cu(paramContext).toLowerCase();
    Log.i("MicroMsg.AppPermissionSettingAdapterFactory", "[jumpPermissionSettingPage] manufacturer = %s", new Object[] { localObject });
    localObject = (a.b)this.DlW.get(localObject);
    if (localObject != null) {
      ((a.b)localObject).gY(paramContext);
    }
