...
{
  protected static boolean sgs;
  private static HashMap<String, Long> wsX;
  protected MatrixCursor sgp;
  private long wsS;
  private String wsT;
  public String wsU;
  private String[] wsV;
  ...
  public ExtContentProviderBase()
  {
    ...
    this.sgp = new MatrixCursor(new String[0]);
    this.wsS = Util.currentTicks();
    this.wsU = "";
    this.wsW = 0;
  ...
  private int dhs()
  {
    ...
    int i = (int)Util.ticksToNow(this.wsS);
  ...
  private void fk(Context paramContext)
  {
    ...
    this.wsV = paramContext.getPackageManager().getPackagesForUid(Binder.getCallingUid());
    if (this.wsV == null) {
  ...
  protected final void Lp(int paramInt)
  {
    AppMethodBeat.i(24406);
    Log.i("MicroMsg.ExtContentProviderBase", "callingPkg = %s, appID = %s, apiID = %s, result = %s, timeCost = %s", new Object[] { dht(), this.wsU, Integer.valueOf(this.wsW), Integer.valueOf(paramInt), Integer.valueOf(dhs()) });
    com.tencent.mm.plugin.report.service.h.IzE.a(10505, new Object[] { dht(), this.wsU, Integer.valueOf(this.wsW), Integer.valueOf(paramInt), Integer.valueOf(dhs()) });
  ...
  protected final void a(Uri paramUri, Context paramContext, UriMatcher paramUriMatcher)
  {
    ...
    {
      this.wsW = paramUriMatcher.match(paramUri);
      if (this.wsW < 0) {
        this.wsW = 0;
      }
    }
  ...
  protected final void ad(int paramInt1, int paramInt2, int paramInt3)
  {
    AppMethodBeat.i(24408);
    Log.i("MicroMsg.ExtContentProviderBase", "callingPkg = %s, appID = %s, apiID = %s, result = %s, timeCost = %s", new Object[] { dht(), this.wsU, Integer.valueOf(this.wsW), Integer.valueOf(paramInt2), Integer.valueOf(dhs()) });
    com.tencent.mm.plugin.report.service.h.IzE.a(10505, new Object[] { dht(), this.wsU, Integer.valueOf(this.wsW), Integer.valueOf(paramInt2), Integer.valueOf(dhs()), Integer.valueOf(paramInt3) });
    com.tencent.mm.plugin.report.service.h.IzE.idkeyStat(300L, paramInt1, 1L, false);
  ...
  protected final boolean cxw()
  {
    ...
    try
    {
            ...
            try
            {
              ...
              bh.aGY().a(new bv(new bv.a()
              {
                public final void a(com.tencent.mm.network.g paramAnonymous2g)
                {
                  ...
                  ExtContentProviderBase.1.this.sgy.Sz();
      ...
      if ((bh.aHB()) && (bh.beJ()) && (!bh.aGE())) {}
      for (sgs = true;; sgs = false)
      {
        Log.i("MicroMsg.ExtContentProviderBase", "hasLogin = " + sgs);
        boolean bool = sgs;
  ...
  public final String dht()
  {
    ...
    if (!Util.isNullOrNil(this.wsT))
    {
      str = this.wsT;
      AppMethodBeat.o(24413);
      return str;
    }
    if ((this.wsV == null) || (this.wsV.length <= 0))
    {
      AppMethodBeat.o(24413);
      return "";
    }
    String str = this.wsV[0];
    AppMethodBeat.o(24413);
    return str;
  }
  
  protected final int dhu()
  {
    ...
    try
    {
      localg = com.tencent.mm.pluginsdk.model.app.h.o(this.wsU, true, false);
      if (localg == null)
      {
    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        ...
        try
        {
          localObject2 = (Integer)e.c.QRO.get(Integer.valueOf(this.wsW));
    ...
    try
    {
      localObject1 = Long.valueOf(Util.nullAs((Long)wsX.get(this.wsU), 0L));
      ...
      {
        Log.i("MicroMsg.ExtContentProviderBase", "update appInfo %s", new Object[] { this.wsU });
        a.a.fmG().aTV(this.wsU);
        wsX.put(this.wsU, Long.valueOf(System.currentTimeMillis()));
      }
      AppMethodBeat.o(24417);
      return i;
    }
  ...
  protected final boolean fj(Context paramContext)
  {
    ...
    catch (Exception paramContext)
    {
      for (;;)
      {
        ...
        try
        {
          localObject = (Integer)e.c.QRO.get(Integer.valueOf(this.wsW));
    ...
    try
    {
      paramContext = Long.valueOf(Util.nullAs((Long)wsX.get(this.wsU), 0L));
  ...
  protected final void gm(int paramInt1, int paramInt2)
  {
    ...
    Log.i("MicroMsg.ExtContentProviderBase", "callingPkg = %s, appID = %s, apiID = %s, result = %s, timeCost = %s", new Object[] { dht(), this.wsU, Integer.valueOf(this.wsW), Integer.valueOf(paramInt1), Integer.valueOf(dhs()) });
    com.tencent.mm.plugin.report.service.h.IzE.a(10505, new Object[] { dht(), this.wsU, Integer.valueOf(this.wsW), Integer.valueOf(paramInt1), Integer.valueOf(dhs()), Integer.valueOf(paramInt2) });
