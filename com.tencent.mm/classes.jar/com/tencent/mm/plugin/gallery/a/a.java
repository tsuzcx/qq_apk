...
public final class a
{
  private static Bitmap a(String paramString, BitmapFactory.Options paramOptions, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        paramString = i.lY(paramString, "r").getFileDescriptor();
        if (paramString == null)
        {
        ...
        if ((i == -1) || (j == -1))
        {
          ac.i("MicroMsg.GalleryBitmapUtil", "decode error, get invalid picture size");
          AppMethodBeat.o(111738);
          return null;
        }
      ...
      catch (Exception paramString)
      {
        int i;
        int j;
        ac.printErrStackTrace("MicroMsg.GalleryBitmapUtil", paramString, "decodeThumbnail fail!!!", new Object[0]);
        AppMethodBeat.o(111738);
        return null;
        paramInt -= 1;
      ...
      {
        ac.printErrStackTrace("MicroMsg.GalleryBitmapUtil", paramString, "err!!", new Object[0]);
        AppMethodBeat.o(111738);
        return null;
      }
  ...
  public static Bitmap dq(String paramString, int paramInt)
  {
    Object localObject2 = null;
    AppMethodBeat.i(111737);
    if (bs.isNullOrNil(paramString))
    {
      ac.e("MicroMsg.GalleryBitmapUtil", "imgPath is invalid.");
    ...
    for (;;)
    {
      try
      {
        ...
        if (arrayOfByte == null)
        {
          ...
          ac.i("MicroMsg.GalleryBitmapUtil", "decode thumb success from exif.");
          AppMethodBeat.o(111737);
          return localObject1;
        }
      ...
      catch (FileNotFoundException localFileNotFoundException)
      {
        byte[] arrayOfByte;
        Object localObject1;
        ac.printErrStackTrace("MicroMsg.GalleryBitmapUtil", localFileNotFoundException, "failed to find file to read thumbnail: %s.", new Object[] { paramString });
      ...
      {
        ac.printErrStackTrace("MicroMsg.GalleryBitmapUtil", localIndexOutOfBoundsException, "failed to get thumbnail from: %s.", new Object[] { paramString });
        continue;
      }
      catch (Exception localException)
      {
        ac.printErrStackTrace("MicroMsg.GalleryBitmapUtil", localException, "failed to get thumbnail from: %s.", new Object[] { paramString });
        continue;
      }
