  ...
  extends HellActivity
{
  ...
  public final void onCreate(Bundle paramBundle)
  {
    ...
    ad.i("MicroMsg.GalleryEntryUI", "checktask onCreate:%s#0x%x task:%s", new Object[] { getClass().getSimpleName(), Integer.valueOf(hashCode()), bt.iQ(this) });
    this.rHY = getIntent().getIntExtra("query_source_type", 3);
    this.rHZ = getIntent().getIntExtra("query_media_type", 1);
    ad.i("MicroMsg.GalleryEntryUI", "query souce: " + this.rHY + ", queryType: " + this.rHZ);
    e.czh().setQueryType(this.rHZ);
    e.czh().jWF = this.rHY;
  ...
  public final void onResume()
  {
    ...
    if (!this.mInit)
    {
      ad.i("MicroMsg.GalleryEntryUI", "doRedirect %s", new Object[] { bt.eGN() });
      ...
      localIntent.putExtra("query_source_type", this.rHY);
