...
@l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lcom/tencent/mm/plugin/gallery/picker/generator/MediaTailor$Companion;", "", "()V", "TAG", "", "decodeBitmap", "Landroid/graphics/Bitmap;", "inputStream", "Ljava/io/InputStream;", "limitW", "", "limitH", "isRotate", "", "isClose", "inputPath", "plugin-gallery_release"})
      ...
      if (localOptions.outWidth <= localOptions.outHeight)
      {
        ...
        if (f1 > f2)
        {
          ...
          if (paramBoolean1)
          {
            ...
            ac.i("MediaTailor", "read exif rotate degree %d", new Object[] { Integer.valueOf(i) });
          ...
          label271:
          ac.i("MediaTailor", paramInputStream + "] scale=" + f1 + " limit[" + paramInt2 + ':' + paramInt1 + "] decode bitmap done!");
          if (localObject1 != null) {
            break label433;
          }
          paramInputStream = f.createBitmap(1, 1, Bitmap.Config.ARGB_8888);
          ac.e("MediaTailor", "bitmap is null. " + bs.eWi());
        }
      }
      for (;;)
      {
