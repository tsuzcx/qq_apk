...
public final class d
{
  l<b, String> gTG;
  final byte[] lock;
  com.tencent.mm.b.f<String, a> rAu;
  f rAv;
  CopyOnWriteArrayList<String> rAw;
  ConcurrentHashMap<String, b> rAx;
  
  public d()
  {
    AppMethodBeat.i(111254);
    this.gTG = new l() {};
    this.rAw = new CopyOnWriteArrayList();
    this.rAx = new ConcurrentHashMap();
    this.lock = new byte[0];
    this.rAu = new b(200, new f.b() {}, getClass());
    f localf = new f();
    localf.rAQ = aj.getContext().getSharedPreferences(aj.eFD(), 0).getInt("com.tencent.mm.gallery.cache.suffix", 0);
    ad.d("MicroMsg.DiskCache", "pennqin debug disk cache current suffix: %s.", new Object[] { Integer.valueOf(localf.rAQ) });
    localf.czr();
    localf.DT(-1);
    this.rAv = localf;
    this.gTG.a(new b()
    {
      public final void abz(String paramAnonymousString)
      {
        AppMethodBeat.i(179449);
        ad.d("MicroMsg.GalleryCache", "now listener size : " + d.this.rAx.size());
        Object localObject;
        if (h.DEBUG)
        {
          localObject = d.this.rAx.entrySet().iterator();
        ...
        if (d.this.rAx.containsKey(paramAnonymousString))
        {
          ad.d("MicroMsg.GalleryCache", "hit!!!");
          localObject = (d.b)d.this.rAx.get(paramAnonymousString);
          if (localObject != null) {
            ((d.b)localObject).abz(paramAnonymousString);
          }
  ...
  public final void a(String paramString, Bitmap paramBitmap, int paramInt1, s.e parame, boolean paramBoolean, int paramInt2, long paramLong)
  {
    ...
    this.rAu.o(com.tencent.mm.plugin.gallery.a.d.a(paramString, parame, paramLong), new a(paramBitmap, paramInt1));
    if (!paramBoolean)
    {
      this.gTG.dR(com.tencent.mm.plugin.gallery.a.d.a(paramString, parame, paramInt2));
      this.gTG.doNotify();
    }
    AppMethodBeat.o(179450);
  }
  ...
  public final void a(String paramString1, String paramString2, Bitmap paramBitmap, s.e parame, long paramLong)
  {
    ...
    //   15: ifnull +10 -> 25
    //   18: aload_3
    //   19: invokevirtual 180	android/graphics/Bitmap:isRecycled	()Z
    //   22: ifeq +19 -> 41
    //   25: ldc 143
    //   27: ldc 182
    ...
    //   40: return
    //   41: aload_0
    //   42: getfield 129	com/tencent/mm/plugin/gallery/model/d:rAv	Lcom/tencent/mm/plugin/gallery/model/f;
    //   45: ifnonnull +12 -> 57
    //   48: aload 8
    //   50: monitorexit
    //   51: ldc 174
    ...
    //   56: return
    //   57: aload_1
    //   58: invokestatic 188	com/tencent/mm/sdk/platformtools/bt:isNullOrNil	(Ljava/lang/String;)Z
    //   61: ifeq +35 -> 96
    //   64: aload_2
    //   65: aload 4
    //   67: lload 5
    ...
    //   72: invokevirtual 194	java/lang/String:hashCode	()I
    //   75: istore 7
    //   77: aload_0
    //   78: getfield 129	com/tencent/mm/plugin/gallery/model/d:rAv	Lcom/tencent/mm/plugin/gallery/model/f;
    //   81: iload 7
    //   83: aload_3
    //   84: invokevirtual 197	com/tencent/mm/plugin/gallery/model/f:a	(ILandroid/graphics/Bitmap;)V
    //   87: aload 8
    //   89: monitorexit
    //   90: ldc 174
  ...
  public final Bitmap getBitmap(String paramString)
  {
    ...
    if (this.rAu.aN(paramString))
    {
      Object localObject = (a)this.rAu.aM(paramString);
      if (localObject == null)
      {
        ad.d("MicroMsg.GalleryCache", "weakreference is null! %s", new Object[] { paramString });
        this.rAu.remove(paramString);
        AppMethodBeat.o(111255);
        return null;
      }
