  ...
  extends cwj
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.uIT != null)
      {
        paramVarArgs.lJ(3, this.uIT.computeSize());
    ...
    for (int i = f.a.a.a.lI(1, this.BaseResponse.computeSize()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.uIT != null) {
        i = paramInt + f.a.a.a.lI(3, this.uIT.computeSize());
      }
      AppMethodBeat.o(218206);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          locali.session_id = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(218206);
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).amA(paramInt);
