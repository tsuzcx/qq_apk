  ...
  implements l.b
{
  ...
  public final k GL(long paramLong)
  {
    ...
    if (!((PluginGameLife)g.ah(PluginGameLife.class)).getAppMessageStorage().get((IAutoDBItem)locala, new String[0]))
    {
  ...
  public final boolean a(k paramk, boolean paramBoolean)
  {
    ...
    paramBoolean = ((PluginGameLife)g.ah(PluginGameLife.class)).getAppMessageStorage().insertNotify((IAutoDBItem)b(paramk), paramBoolean);
  ...
  public final boolean a(k paramk, boolean paramBoolean, String... paramVarArgs)
  {
    ...
    paramBoolean = ((PluginGameLife)g.ah(PluginGameLife.class)).getAppMessageStorage().updateNotify((IAutoDBItem)b(paramk), paramBoolean, (String[])Arrays.copyOf(paramVarArgs, paramVarArgs.length));
  ...
  public final boolean b(k paramk, boolean paramBoolean)
  {
    ...
    paramBoolean = ((PluginGameLife)g.ah(PluginGameLife.class)).getAppMessageStorage().replace((IAutoDBItem)b(paramk), paramBoolean);
