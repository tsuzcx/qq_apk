...
public final class b
{
  private static boolean a(Context paramContext, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramString1.ahp(), "com/tencent/mm/plugin/multitalk/utils/MeetingLinkHelper", "jumpApp", "(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
  ...
  public static void aT(Context paramContext, String paramString)
  {
    ...
    ad.i("MicroMsg.MeetingLinkHelper", "handleMeetingLinkClick, isAllowedToShowMeetingLink:%s, isAllowedToShowWorkWeChat:%s", new Object[] { Boolean.valueOf(drb()), Boolean.valueOf(drc()) });
    boolean bool;
    if (dra()) {
      if (drb())
      {
        bool = ib("com.tencent.wemeet.app", "EF1B5A11844923BB7515E6F6AFCBC45F");
    ...
    for (;;)
    {
      ...
      if (!bool)
      {
        c.f(i, drj(), paramString.equals("list"));
        ...
        {
          c.g(i, drj(), paramString.equals("list"));
          AppMethodBeat.o(164084);
          return;
        }
        if (drc())
        {
          bool = ib("com.tencent.wework", "011a40266c8c75d181ddd8e4ddc50075");
        ...
        bool = ib(str, (String)localObject);
        ad.i("MicroMsg.MeetingLinkHelper", "check wework install result:%s", new Object[] { Boolean.valueOf(bool) });
        continue;
      }
      ...
      if (drb())
      {
        ...
        {
          c.ar(i, paramString.equals("list"));
          AppMethodBeat.o(164084);
          return;
        }
        c.as(i, paramString.equals("list"));
        AppMethodBeat.o(164084);
        return;
      }
      if (drc())
  ...
  public static boolean drb()
  {
    ...
    if (((com.tencent.mm.plugin.expt.b.b)g.ab(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.qFZ, 0) == 1)
    {
  ...
  public static boolean drc()
  {
    ...
    if (((com.tencent.mm.plugin.expt.b.b)g.ab(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.qFZ, 0) == 2)
    {
  ...
  private static boolean drd()
  {
    ...
    if (((com.tencent.mm.plugin.expt.b.b)g.ab(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.qFZ, 0) == 3)
    {
  ...
  private static String dre()
  {
    ...
    Object localObject = ((com.tencent.mm.plugin.expt.b.b)g.ab(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.qGd, "");
  ...
  private static String drj()
  {
    ...
    String str2 = ((com.tencent.mm.plugin.expt.b.b)g.ab(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.qGa, "");
    String str1 = str2;
  ...
  private static i drl()
  {
    AppMethodBeat.i(164080);
    Object localObject = ((com.tencent.mm.plugin.expt.b.b)g.ab(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.qGe, "");
    if (!bt.isNullOrNil((String)localObject)) {
      try
      {
        localObject = new i((String)localObject);
  ...
  public static String getIconUrl()
  {
    ...
    String str = ((com.tencent.mm.plugin.expt.b.b)g.ab(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.qGb, "");
    AppMethodBeat.o(164069);
    return str;
  }
  
  private static boolean ib(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = null;
        if (!bt.lQ(paramString1, paramString2.toUpperCase()))
        {
          bool = bt.lQ(paramString1, paramString2.toLowerCase());
          if (!bool) {
            continue;
          }
        }
