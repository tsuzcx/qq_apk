  ...
  extends j<com.tencent.mm.bh.f>
{
  ...
  public static LinkedHashMap<String, Class> ssj;
  ...
  public final boolean a(com.tencent.mm.bh.f paramf)
  {
    ...
    if (com.tencent.pb.common.c.f.cX(str))
    {
      ac.e("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "save. multiTalkInfo wxGroupId is empty!");
      AppMethodBeat.o(114639);
      return false;
    }
    ac.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "save. wxGroupId=%s, groupId=%s, roomId =%d, roomKey =%d, routeId =%d, inviteUser=%s,memberCount=%d,createTime=%d", new Object[] { str, paramf.field_groupId, Integer.valueOf(paramf.field_roomId), Long.valueOf(paramf.field_roomKey), Integer.valueOf(paramf.field_routeId), paramf.field_inviteUserName, Integer.valueOf(paramf.field_memberCount), Long.valueOf(paramf.field_createTime) });
    try
    {
      boolean bool = insert(paramf);
      ac.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "insert ret " + bool + " for id=%s" + str);
      AppMethodBeat.o(114639);
      return bool;
    }
    catch (Exception paramf)
    {
      ac.e("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "save mulitalTalk failure!" + paramf.toString());
      AppMethodBeat.o(114639);
    }
    return false;
  }
  ...
  public final com.tencent.mm.bh.f aml(String paramString)
  {
    ...
    ac.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "getMultiTaklInfo for wxGroupId = %s", new Object[] { paramString });
    ...
    {
      ac.e("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "getMultiTalkInfo error! " + localException.toString());
      return null;
    }
    finally
    {
  ...
  public final boolean b(com.tencent.mm.bh.f paramf)
  {
    ...
    if (com.tencent.pb.common.c.f.cX(str))
    {
      ac.e("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "update. multiTalkInfo wxGroupId is empty!");
      AppMethodBeat.o(114640);
      return false;
    }
    ac.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "update. wxGroupId=%s, groupId=%s, roomId =%d, roomKey =%d, routeId =%d, inviteUser=%s,memberCount=%d,createTime=%d,state=%d", new Object[] { str, paramf.field_groupId, Integer.valueOf(paramf.field_roomId), Long.valueOf(paramf.field_roomKey), Integer.valueOf(paramf.field_routeId), paramf.field_inviteUserName, Integer.valueOf(paramf.field_memberCount), Long.valueOf(paramf.field_createTime), Integer.valueOf(paramf.field_state) });
    try
    {
      boolean bool = update(paramf, new String[] { "wxGroupId" });
      ac.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "update ret " + bool + " for id=%s" + str);
      AppMethodBeat.o(114640);
      return bool;
    }
    catch (Exception paramf)
  ...
  public final LinkedList<com.tencent.mm.bh.f> dgB()
  {
    ...
    for (;;)
    {
      ...
      {
        ac.e("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "getMultiTalkInfoList error!");
        for (;;)
        {
  ...
  public final boolean zB(String paramString)
  {
    ...
    ac.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "delete id = %s", new Object[] { paramString });
    try
    {
    ...
    {
      ac.e("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "delete fail for wxGroupId = ".concat(String.valueOf(paramString)));
      AppMethodBeat.o(114642);
    }
    return false;
  }
