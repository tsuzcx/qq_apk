...
public final class a
  extends MAutoStorage<com.tencent.mm.bc.f>
{
  public static LinkedHashMap<String, Class> Lrp;
  public static final String[] SQL_CREATE;
  
  static
  {
    AppMethodBeat.i(114643);
    SQL_CREATE = new String[] { MAutoStorage.getCreateSQLs(com.tencent.mm.bc.f.info, "MultiTalkInfo"), "CREATE INDEX IF NOT EXISTS idx_MultiTalkInfo_key  on MultiTalkInfo  (  wxGroupId )" };
    Lrp = new LinkedHashMap() {};
    AppMethodBeat.o(114643);
  }
  
  public a(ISQLiteDatabase paramISQLiteDatabase)
  {
    super(paramISQLiteDatabase, com.tencent.mm.bc.f.info, "MultiTalkInfo", null);
  }
  
  public final boolean a(com.tencent.mm.bc.f paramf)
  {
    AppMethodBeat.i(114639);
    String str = paramf.field_wxGroupId;
    if (com.tencent.pb.common.c.f.hm(str))
    {
  ...
  public final boolean b(com.tencent.mm.bc.f paramf)
  {
  ...
  public final LinkedList<com.tencent.mm.bc.f> ggZ()
  {
