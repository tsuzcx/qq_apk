...
@l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/story/ui/view/StoryAvatarItemView;", "Landroid/widget/RelativeLayout;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "attributeSet", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "style", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "avatarIv", "Landroid/widget/ImageView;", "dp_2", "nameTv", "Landroid/widget/TextView;", "unreadTip", "setAvatar", "", "username", "", "setTipCount", "count", "plugin-story_release"})
  ...
  extends RelativeLayout
{
  ...
  public StoryAvatarItemView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.yuw = a.fromDPToPix(getContext(), 2);
  ...
  public final void setAvatar(String paramString)
  {
    ...
    this.fuj.setBackground(getResources().getDrawable(2131234224));
    this.fuj.setPadding(this.yuw, this.yuw, this.yuw, this.yuw);
    ...
    paramString = ((com.tencent.mm.plugin.messenger.foundation.a.k)localObject).apM().aHY(paramString);
    localObject = getContext();
    if (paramString != null)
    {
      paramString = paramString.ZX();
      if (paramString == null) {}
    }
    for (paramString = (CharSequence)paramString;; paramString = (CharSequence)"")
    {
      paramString = com.tencent.mm.pluginsdk.ui.span.k.b((Context)localObject, paramString, this.ftj.getTextSize());
      this.ftj.setText((CharSequence)paramString);
  ...
  public final void setTipCount(int paramInt)
  {
    ...
    this.yux.setText((CharSequence)String.valueOf(paramInt));
