...
@l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/story/ui/adapter/GalleryAvatarAdapter;", "Lcom/tencent/mm/plugin/story/ui/adapter/GalleryHeaderAdapter;", "Lcom/tencent/mm/plugin/story/ui/adapter/GalleryAvatarAdapter$GalleryAvatarViewHolder;", "()V", "chatRoom", "", "getChatRoom", "()Ljava/lang/String;", "setChatRoom", "(Ljava/lang/String;)V", "getItemCount", "", "onBindViewHolder", "", "holder", "position", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "GalleryAvatarViewHolder", "plugin-story_release"})
    ...
    implements View.OnClickListener
  {
    ...
    public final void onClick(View paramView)
    {
      ...
      if (paramView.isSelected())
      {
        ...
        paramView.putExtra("Contact_User", this.yqv);
        paramView.putExtra("Contact_ChatRoomId", this.yqu.ies);
        paramView.putExtra("CONTACT_INFO_UI_SOURCE", 15);
        View localView = this.yqw.arI;
        k.g(localView, "holder.itemView");
        com.tencent.mm.bs.d.b(localView.getContext(), "profile", ".ui.ContactInfoUI", paramView);
      }
