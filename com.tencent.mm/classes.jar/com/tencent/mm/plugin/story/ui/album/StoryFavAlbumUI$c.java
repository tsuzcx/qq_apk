  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bd(paramView);
    a.b("com/tencent/mm/plugin/story/ui/album/StoryFavAlbumUI$initViews$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahF());
    paramView = new Intent();
    paramView.putExtra("Contact_User", StoryFavAlbumUI.a(this.Bot));
    paramView.putExtra("CONTACT_INFO_UI_SOURCE", 12);
    d.b((Context)this.Bot, "profile", ".ui.ContactInfoUI", paramView);
