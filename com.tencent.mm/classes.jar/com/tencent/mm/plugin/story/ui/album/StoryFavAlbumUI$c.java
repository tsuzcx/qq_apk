  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bn(paramView);
    a.c("com/tencent/mm/plugin/story/ui/album/StoryFavAlbumUI$initViews$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aFi());
    paramView = new Intent();
    paramView.putExtra("Contact_User", StoryFavAlbumUI.a(this.LTl));
    paramView.putExtra("CONTACT_INFO_UI_SOURCE", 12);
    c.b((Context)this.LTl, "profile", ".ui.ContactInfoUI", paramView);
