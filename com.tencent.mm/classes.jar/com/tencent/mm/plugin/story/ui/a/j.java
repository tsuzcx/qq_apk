  ...
  extends RecyclerView.a<a>
{
    ...
    extends RecyclerView.w
  {
    ...
    public a()
    {
      ...
      this.AVY = ((StoryAvatarItemView)j.this);
    ...
    implements View.OnClickListener
  {
    ...
    public final void onClick(View paramView)
    {
      ...
      a.b("com/tencent/mm/plugin/story/ui/adapter/StoryHeaderTipAdapter$onBindViewHolder$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).ahq());
      p.g(paramView, "it");
      ...
      boolean bool = ((l.d)paramView).ehg();
      paramView = this.AVZ.AVW;
      if (paramView != null)
      {
