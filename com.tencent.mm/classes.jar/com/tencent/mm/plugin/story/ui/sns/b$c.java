  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    localb.bn(paramView);
    a.c("com/tencent/mm/plugin/story/ui/sns/StoryBigMouthGuideDialog$wrapSheet$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aFi());
    if (this.LTX.isShowing()) {
      this.LTX.cancel();
    }
