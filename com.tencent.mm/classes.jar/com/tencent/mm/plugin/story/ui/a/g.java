  ...
  extends RecyclerView.a<i>
{
  ...
  public final void gz(List<h> paramList)
  {
    ...
    p.h(paramList, "items");
    this.Bno.clear();
    this.Bno.addAll((Collection)paramList);
