  ...
  extends RecyclerView.a<i>
{
  ...
  public final void gq(List<h> paramList)
  {
    ...
    p.h(paramList, "items");
    this.AVQ.clear();
    this.AVQ.addAll((Collection)paramList);
