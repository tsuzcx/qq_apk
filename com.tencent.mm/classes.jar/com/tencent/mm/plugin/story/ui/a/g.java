  ...
  extends RecyclerView.a<i>
{
  ...
  public final void hw(List<h> paramList)
  {
    ...
    p.h(paramList, "items");
    this.Fye.clear();
    this.Fye.addAll((Collection)paramList);
