  ...
  implements c
{
  ...
  public d(cym paramcym, String paramString, bc parambc)
  {
  ...
  public final String aaX()
  {
    ...
    Object localObject = (CharSequence)this.yhp.DMQ;
    if ((localObject == null) || (((CharSequence)localObject).length() == 0)) {}
    for (int i = 1; i != 0; i = 0)
    {
      localObject = this.yhp.Id + '_' + this.wLv.tag;
      AppMethodBeat.o(118902);
      return localObject;
    }
    localObject = this.yhp.DMQ + '_' + this.wLv.tag;
    AppMethodBeat.o(118902);
    return localObject;
  }
}
