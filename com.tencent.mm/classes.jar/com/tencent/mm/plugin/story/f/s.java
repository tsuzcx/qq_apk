...
public final class s
{
  ...
  public static n a(com.tencent.mm.plugin.story.f.d.j paramj)
  {
    ...
    String str = a(paramj.Fpd, paramj.username);
    Object localObject = l.FmK;
    if (str == null) {}
    for (localObject = "";; localObject = str)
    {
      l.aLP((String)localObject);
      localObject = j.Fmy;
      localObject = j.b.fog().KC(paramj.edx);
      if (localObject == null)
      {
        localObject = new n();
        ((n)localObject).field_storyId = paramj.edx;
        ((n)localObject).field_url = paramj.Fpd.Url;
        ((n)localObject).field_cacheSize = 0;
        ((n)localObject).field_totalSize = 0;
        ((n)localObject).field_filePath = str;
        paramj = j.Fmy;
        j.b.fog().a((n)localObject);
      }
  ...
  public static String a(edt paramedt)
  {
    ...
    l locall = l.FmK;
    paramedt = l.aRW(paramedt.Id);
    AppMethodBeat.o(118792);
    return paramedt;
  }
  
  public static String a(edt paramedt, String paramString)
  {
    ...
    paramedt = l.FmK.kY(paramedt.Url, paramString);
    Log.i(TAG, "get story video path %s", new Object[] { paramedt });
    AppMethodBeat.o(118791);
    return paramedt;
  }
  
  public static String aSc(String paramString)
  {
    AppMethodBeat.i(118790);
    Object localObject = l.FmK;
    localObject = com.tencent.mm.vfs.s.k(l.aRU(paramString) + "video/", true);
    if (localObject == null) {
      p.hyc();
    }
  ...
  private static n b(com.tencent.mm.plugin.story.f.d.j paramj)
  {
    ...
    p.h(paramj, "videoItem");
    Object localObject3 = (a)new aio();
    Object localObject1 = paramj.Fpe;
    ...
    for (localObject1 = ((com.tencent.mm.plugin.recordvideo.background.c)localObject1).field_baseItemData;; localObject1 = null)
    {
      ...
      i = (int)com.tencent.mm.vfs.s.boW((String)localObject1);
      localn = new n();
      localn.field_storyId = paramj.edx;
      localn.field_url = "";
  ...
  public static String cs(int paramInt, String paramString)
  {
    ...
    if (paramString == null) {}
    for (paramString = "story_local_video_".concat(String.valueOf(paramInt)); Util.isNullOrNil(paramString); paramString = com.tencent.mm.an.c.a("storyvideo", paramInt, "story", paramString))
    {
