  ...
  implements k.a
{
  ...
  private static final String yoY = "select *, rowid from StoryExtItem ";
  private static final String yoZ = "select * from StoryExtItem";
  public static final a ypa;
  private final e db;
  public final ArrayList<com.tencent.mm.plugin.story.api.m> yoU;
  private final com.tencent.mm.memory.a.c<String, f> yoV;
  private com.tencent.mm.memory.a.c<String, f> yoW;
  private final e yoX;
  ...
  public g(e parame)
  {
    super(parame, f.access$getInfo$cp(), TABLE, fs.INDEX_CREATE);
    AppMethodBeat.i(119517);
    this.yoX = parame;
    this.yoU = new ArrayList();
    this.yoV = new com.tencent.mm.memory.a.c(1000);
    this.yoW = new com.tencent.mm.memory.a.c(1000);
    this.db = this.yoX;
  ...
  private final void c(f paramf)
  {
    ...
    if (((com.tencent.mm.plugin.messenger.foundation.a.k)localObject).apM().aHT(paramf.getUserName()))
    {
      this.yoV.put(paramf.getUserName(), paramf);
      this.yoW.remove(paramf.getUserName());
      AppMethodBeat.o(119509);
      return;
    }
    this.yoV.remove(paramf.getUserName());
    this.yoW.put(paramf.getUserName(), paramf);
    AppMethodBeat.o(119509);
  }
  ...
  public final void a(String paramString, com.tencent.mm.sdk.e.m paramm)
  {
    ...
    if ((paramString != null) && (paramm != null))
    {
      if ((d.g.b.k.g(paramString, "notify_story_read")) && ((paramm.obj instanceof f)))
      {
        ...
        paramm = ((Iterable)this.yoU).iterator();
        while (paramm.hasNext()) {
          ((com.tencent.mm.plugin.story.api.m)paramm.next()).bH(paramString, true);
        }
        paramString = b.yeq;
        b.dGE();
        AppMethodBeat.o(119515);
      ...
      if ((d.g.b.k.g(paramString, "notify_story_unread")) && ((paramm.obj instanceof f)))
      {
        ...
        paramm = ((Iterable)this.yoU).iterator();
        while (paramm.hasNext()) {
          ((com.tencent.mm.plugin.story.api.m)paramm.next()).bH(paramString, false);
        }
        paramString = b.yeq;
        b.dGE();
        AppMethodBeat.o(119515);
  ...
  public final String arT(String paramString)
  {
    ...
    paramString = arS(paramString).field_md5;
    AppMethodBeat.o(119505);
    return paramString;
  }
  
  public final f arU(String paramString)
  {
    ...
    f localf2 = (f)this.yoV.get(paramString);
    f localf1 = localf2;
    if (localf2 == null)
    {
      localf2 = (f)this.yoW.get(paramString);
      localf1 = localf2;
      if (localf2 == null)
      {
        localf1 = arS(paramString);
        c(localf1);
      }
    }
    AppMethodBeat.o(119512);
  ...
  public final f arV(String paramString)
  {
    AppMethodBeat.i(119513);
    d.g.b.k.h(paramString, "username");
    f localf2 = (f)this.yoW.get(paramString);
    f localf1 = localf2;
    if (localf2 == null)
    {
      localf1 = arS(paramString);
  ...
  public final f arp(String paramString)
  {
    AppMethodBeat.i(119502);
    d.g.b.k.h(paramString, "userName");
    f localf = arU(paramString);
    if (localf != null)
    {
  ...
  public final List<f> dKD()
  {
    AppMethodBeat.i(119510);
    Object localObject1 = new ArrayList();
    Object localObject2 = yoY;
  ...
  public final List<f> dKw()
  {
    AppMethodBeat.i(119511);
    Object localObject1 = new ArrayList();
    Object localObject2 = yoZ;
    localObject2 = this.db.a((String)localObject2, null, 2);
    ((Cursor)localObject2).moveToFirst();
    do
    {
  ...
  public final int ju(String paramString1, String paramString2)
  {
