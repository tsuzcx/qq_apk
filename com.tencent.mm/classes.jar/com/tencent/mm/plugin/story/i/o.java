  ...
  extends MAutoStorage<n>
{
  ...
  static
  {
    ...
    LQJ = new a((byte)0);
    n.a locala = n.LQI;
    LQe = new String[] { MAutoStorage.getCreateSQLs(n.access$getInfo$cp(), "StoryVideoCacheInfo") };
  ...
  {
    super(paramISQLiteDatabase, n.access$getInfo$cp(), "StoryVideoCacheInfo", hb.INDEX_CREATE);
    AppMethodBeat.i(119609);
    this.db = paramISQLiteDatabase;
    AppMethodBeat.o(119609);
  }
  
  public final n RW(long paramLong)
  {
  ...
  @l(iBK={1, 1, 16}, iBL={""}, iBM={"Lcom/tencent/mm/plugin/story/storage/StoryVideoCacheStorage$Companion;", "", "()V", "SqlCreate", "", "", "kotlin.jvm.PlatformType", "getSqlCreate", "()[Ljava/lang/String;", "[Ljava/lang/String;", "TAG", "getTAG", "()Ljava/lang/String;", "Table", "plugin-story_release"})
