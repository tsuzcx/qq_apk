  ...
  extends j<n>
{
  ...
  static
  {
    ...
    AUt = new a((byte)0);
    n.a locala = n.AUs;
    ATN = new String[] { j.getCreateSQLs(n.access$getInfo$cp(), "StoryVideoCacheInfo") };
  ...
  public o(e parame)
  {
    super(parame, n.access$getInfo$cp(), "StoryVideoCacheInfo", gi.INDEX_CREATE);
    AppMethodBeat.i(119609);
    this.db = parame;
    AppMethodBeat.o(119609);
  }
  
  public final n AZ(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ad.i(TAG, "Test get mediaId error " + paramLong + ' ' + bt.flS());
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/story/storage/StoryVideoCacheStorage$Companion;", "", "()V", "SqlCreate", "", "", "kotlin.jvm.PlatformType", "getSqlCreate", "()[Ljava/lang/String;", "[Ljava/lang/String;", "TAG", "getTAG", "()Ljava/lang/String;", "Table", "plugin-story_release"})
