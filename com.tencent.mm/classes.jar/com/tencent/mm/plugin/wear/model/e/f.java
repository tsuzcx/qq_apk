  ...
  extends a
{
  ...
  protected final byte[] s(int paramInt, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        ae.i("MicroMsg.Wear.HttpFriendServer", "error to get username");
    ...
    catch (UnsupportedEncodingException paramArrayOfByte)
    {
      ...
      ae.i("MicroMsg.Wear.HttpFriendServer", "handle friend request %s", new Object[] { paramArrayOfByte });
      if (paramInt != 11016) {
        break label206;
      }
    }
    Object localObject = new Intent();
    ((Intent)localObject).setClassName(ak.getPackageName(), ak.getPackageName() + ".plugin.subapp.ui.friend.FMessageTransferUI");
    ...
    com.tencent.mm.hellhoundlib.a.a.a(paramArrayOfByte, ((com.tencent.mm.hellhoundlib.b.a)localObject).ahE(), "com/tencent/mm/plugin/wear/model/server/HttpFriendServer", "handleData", "(I[B)[B", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
    ...
    for (;;)
    {
      ...
      {
        localObject = new Intent();
        ((Intent)localObject).setClassName(ak.getPackageName(), ak.getPackageName() + ".plugin.subapp.ui.friend.FMessageConversationUI");
        ((Intent)localObject).setFlags(335544320);
        paramArrayOfByte = ak.getContext();
        localObject = new com.tencent.mm.hellhoundlib.b.a().bc(localObject);
        com.tencent.mm.hellhoundlib.a.a.a(paramArrayOfByte, ((com.tencent.mm.hellhoundlib.b.a)localObject).ahE(), "com/tencent/mm/plugin/wear/model/server/HttpFriendServer", "handleData", "(I[B)[B", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
