...
{
  private static Bundle bY(byte[] paramArrayOfByte)
  {
  ...
  public void onChannelOpened(Channel paramChannel)
  {
    ...
    localObject = new File(com.tencent.mm.loader.j.b.aip(), (String)localObject);
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        try
        {
          paramChannel.receiveFile(new com.tencent.mm.plugin.wear.model.a.a().ehj(), Uri.fromFile((File)localObject), false);
  ...
  public void onDataChanged(DataEventBuffer paramDataEventBuffer)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        if (!com.tencent.mm.plugin.wear.a.b.auU(localUri.getPath())) {
          continue;
        }
        ...
        try
        {
          ...
          com.tencent.mm.plugin.wear.model.b.a.an(bY((byte[])localObject));
  ...
  public void onInputClosed(Channel paramChannel, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      paramChannel = new File(com.tencent.mm.loader.j.b.aip(), paramChannel);
      ...
      localBundle.putInt("key_funid", com.tencent.mm.plugin.wear.a.b.auV(str));
      localBundle.putInt("key_sessionid", 0);
      localBundle.putByteArray("key_data", paramChannel.getAbsolutePath().getBytes());
      com.tencent.mm.plugin.wear.model.b.a.an(localBundle);
    }
  ...
  public void onMessageReceived(MessageEvent paramMessageEvent)
  {
    ...
    if (com.tencent.mm.plugin.wear.a.b.auU(paramMessageEvent.getPath())) {
      try
      {
        ...
        com.tencent.mm.plugin.wear.model.b.a.an(bY(paramMessageEvent));
