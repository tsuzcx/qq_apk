  ...
  extends d
{
  ...
  public final void execute()
  {
    ...
    s.aU(str, (int)this.Psz.UIY);
    o.brB().run();
    Log.i("MicroMsg.Wear.HttpReplyServer", "run service to send the voice");
    bh.beI();
    com.tencent.mm.model.c.bbR().bwz(this.Psz.Ueg);
