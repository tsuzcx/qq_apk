  ...
  extends w
{
  ...
  public b(String paramString)
  {
    ...
    ((b.a)localObject).hvt = new cev();
    ((b.a)localObject).hvu = new cew();
    ((b.a)localObject).uri = "/cgi-bin/mmpay-bin/payudeluserroll";
    ((b.a)localObject).funcId = 1544;
    ((b.a)localObject).reqCmdId = 0;
    ((b.a)localObject).respCmdId = 0;
    this.rr = ((b.a)localObject).aAz();
    localObject = (cev)this.rr.hvr.hvw;
    if (!bs.isNullOrNil(paramString)) {
      ((cev)localObject).vxU = paramString;
    }
  ...
  public final void onGYNetEnd(int paramInt1, int paramInt2, int paramInt3, String paramString, q paramq, byte[] paramArrayOfByte, long paramLong)
  {
    ...
    ac.d("MicroMsg.NetScenePayUDelUserRoll", "errType:" + paramInt2 + ",errCode:" + paramInt3 + ",errMsg" + paramString);
