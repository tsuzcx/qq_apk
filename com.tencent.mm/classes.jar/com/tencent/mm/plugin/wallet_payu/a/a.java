  ...
  extends com.tencent.mm.wallet_core.e.a.a
{
  ...
  public final void onGYNetEnd(int paramInt, String paramString, JSONObject paramJSONObject)
  {
    ...
    ae.d("MicroMsg.NetScenePayUComfirmOtp", "hy: get NetScenePayUCreateUser info. errCode: %d, errMsg:%s, json:%s", new Object[] { Integer.valueOf(paramInt), paramString, paramJSONObject.toString() });
    this.yXW = paramJSONObject.optBoolean("verified");
    this.DKh = paramJSONObject.optString("payu_reference");
