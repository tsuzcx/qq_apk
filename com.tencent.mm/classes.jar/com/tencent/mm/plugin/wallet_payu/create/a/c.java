  ...
  extends com.tencent.mm.wallet_core.d
{
  ...
  public final com.tencent.mm.wallet_core.d.g a(MMActivity paramMMActivity, i parami)
  {
    ...
    if ((paramMMActivity instanceof WalletPayUStartOpenUI))
    {
      paramMMActivity = new com.tencent.mm.wallet_core.d.g(paramMMActivity, parami)
      {
        public final boolean onSceneEnd(int paramAnonymousInt1, int paramAnonymousInt2, String paramAnonymousString, q paramAnonymousq)
        {
          ...
          if ((paramAnonymousq instanceof com.tencent.mm.plugin.wallet_payu.a.b))
          {
            ...
            if ((paramAnonymousInt1 == 0) && (paramAnonymousInt2 == 0))
            {
              ...
              c.this.fKb.putString("payu_reference", paramAnonymousString.fLj);
              Log.d("MicroMsg.PayUOpenProcess", "hy: session: %s", new Object[] { paramAnonymousString.fLj });
              c.this.fKb.putBoolean("key_is_has_mobile", paramAnonymousString.Pmi);
              com.tencent.mm.wallet_core.a.l(this.activity, c.this.fKb);
        ...
        public final boolean r(Object... paramAnonymousVarArgs)
        {
          ...
          this.YVX.b(new com.tencent.mm.plugin.wallet_payu.a.b(c.this.fKb.getString("dial_code"), c.this.fKb.getString("key_mobile")), true);
    ...
    if ((paramMMActivity instanceof WalletPayUVerifyCodeUI))
    {
      paramMMActivity = new com.tencent.mm.wallet_core.d.g(paramMMActivity, parami)
      {
        public final boolean B(Object... paramAnonymousVarArgs)
        {
          ...
          this.YVX.a(new com.tencent.mm.plugin.wallet_payu.a.b(c.this.fKb.getString("dial_code"), c.this.fKb.getString("key_mobile")), true, 1);
        ...
        public final CharSequence getTips(int paramAnonymousInt)
        {
          ...
          {
            localObject = this.activity.getString(a.i.wallet_verify_code_bind_hint_payu, new Object[] { com.tencent.mm.wallet_core.ui.g.bCq("+" + c.b(c.this).getString("dial_code") + c.c(c.this).getString("key_mobile")) });
        ...
        public final boolean onSceneEnd(int paramAnonymousInt1, int paramAnonymousInt2, String paramAnonymousString, q paramAnonymousq)
        {
          ...
          if ((paramAnonymousq instanceof com.tencent.mm.plugin.wallet_payu.a.a))
          {
            ...
            if ((paramAnonymousInt1 == 0) && (paramAnonymousInt2 == 0) && (paramAnonymousString.Jip))
            {
              c.a(c.this).putString("payu_reference", paramAnonymousString.Pmh);
              com.tencent.mm.wallet_core.a.l(this.activity, c.this.fKb);
        ...
        public final boolean r(Object... paramAnonymousVarArgs)
        {
          ...
          this.YVX.b(new com.tencent.mm.plugin.wallet_payu.a.a((String)paramAnonymousVarArgs[0], c.this.fKb.getString("payu_reference")), true);
    ...
    if ((paramMMActivity instanceof WalletPayUSecurityQuestionSettingUI))
    {
      paramMMActivity = new com.tencent.mm.wallet_core.d.g(paramMMActivity, parami)
      {
        public final boolean A(Object... paramAnonymousVarArgs)
        {
          ...
          this.YVX.b(new com.tencent.mm.plugin.wallet_payu.security_question.model.d(), true);
        ...
        public final boolean onSceneEnd(int paramAnonymousInt1, int paramAnonymousInt2, String paramAnonymousString, q paramAnonymousq)
        {
          ...
          {
            c.this.fKb.putParcelableArrayList("key_security_question_list", ((com.tencent.mm.plugin.wallet_payu.security_question.model.d)paramAnonymousq).Pns);
      ...
      paramMMActivity = new com.tencent.mm.wallet_core.d.g(paramMMActivity, parami)
      {
        public final boolean onSceneEnd(int paramAnonymousInt1, int paramAnonymousInt2, String paramAnonymousString, q paramAnonymousq)
        {
          ...
          if (((paramAnonymousq instanceof a)) && (paramAnonymousInt1 == 0) && (paramAnonymousInt2 == 0))
          {
            ...
            com.tencent.mm.wallet_core.a.b(this.activity, c.this.fKb, 0);
            c.d(c.this).putInt("key_open_error_code", 0);
            com.tencent.mm.ui.base.w.makeText(this.activity, this.activity.getString(a.i.wallet_payu_start_success), 0).show();
        ...
        public final boolean r(Object... paramAnonymousVarArgs)
        {
          ...
          paramAnonymousVarArgs = c.this.fKb.getString("dial_code");
          String str1 = c.this.fKb.getString("key_mobile");
          localObject = ((com.tencent.mm.plugin.wallet_core.model.w)localObject).mVf;
          String str2 = c.this.fKb.getString("key_question_id");
          String str3 = c.this.fKb.getString("key_question_answer");
          String str4 = c.this.fKb.getString("payu_reference");
          if (!c.this.fKb.getBoolean("key_is_has_mobile")) {
            this.YVX.b(new a(paramAnonymousVarArgs, str1, (String)localObject, str2, str3, str4), true);
          }
          for (;;)
          {
            AppMethodBeat.o(72021);
            return true;
            this.YVX.b(new b(paramAnonymousVarArgs, str1, (String)localObject, str4), true);
          }
        }
      };
      AppMethodBeat.o(72028);
    ...
    {
      paramMMActivity = new com.tencent.mm.plugin.wallet_payu.security_question.model.a(paramMMActivity, parami, this.fKb);
      AppMethodBeat.o(72028);
      return paramMMActivity;
    }
  ...
  public final void b(Activity paramActivity, Bundle paramBundle)
  {
    ...
    com.tencent.mm.wallet_core.ui.g.lO(paramActivity);
    AppMethodBeat.o(72026);
  }
  ...
  public final boolean j(Activity paramActivity, Bundle paramBundle)
  {
    ...
    com.tencent.mm.ui.base.w.makeText(paramActivity, paramActivity.getString(a.i.wallet_payu_start_failed), 0).show();
