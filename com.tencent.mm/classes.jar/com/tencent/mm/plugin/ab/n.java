...
@l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/webjsapi/WxPopupAPI;", "Lcom/tencent/mm/plugin/webjsapi/JSAPI;", "Lcom/tencent/mm/plugin/webjsapi/WxPopupAPIContext;", "context", "(Lcom/tencent/mm/plugin/webjsapi/WxPopupAPIContext;)V", "close", "", "popupId", "", "popup", "width", "", "height", "left", "top", "mode", "", "colorRGBA", "onDismissCallback", "onOuterClickCallback", "webview-sdk_release"})
  ...
  extends a<o>
{
  ...
  public final void close(final String paramString)
  {
    ...
    p.h(paramString, "popupId");
    d.h((kotlin.g.a.a)new a(this, paramString));
  ...
  public final void popup(final String paramString1, final Number paramNumber1, final Number paramNumber2, final Number paramNumber3, final Number paramNumber4, final int paramInt, String paramString2, final String paramString3, final String paramString4)
  {
    ...
    p.h(paramString1, "popupId");
    p.h(paramNumber1, "width");
    p.h(paramNumber2, "height");
    p.h(paramNumber3, "left");
    p.h(paramNumber4, "top");
    p.h(paramString2, "colorRGBA");
    p.h(paramString3, "onDismissCallback");
    p.h(paramString4, "onOuterClickCallback");
    Object localObject = new char[1];
    localObject[0] = 35;
    p.h(paramString2, "$this$trimStart");
    p.h(localObject, "chars");
    ...
    p.g(paramString2, "(this as java.lang.String).toUpperCase()");
    localObject = (CharSequence)paramString2;
    int k;
    if (new k("[A-F0-9]{8}").aJ((CharSequence)localObject))
    {
      if (paramString2 == null)
      {
        paramString1 = new t("null cannot be cast to non-null type java.lang.String");
      ...
      i = Integer.parseInt((String)localObject, kotlin.n.a.avR(16));
      if (paramString2 == null)
      {
        paramString1 = new t("null cannot be cast to non-null type java.lang.String");
        AppMethodBeat.o(224840);
      ...
      p.g(localObject, "(this as java.lang.Strin…ing(startIndex, endIndex)");
      j = Integer.parseInt((String)localObject, kotlin.n.a.avR(16));
      if (paramString2 == null)
      {
        paramString1 = new t("null cannot be cast to non-null type java.lang.String");
        AppMethodBeat.o(224840);
      ...
      p.g(localObject, "(this as java.lang.Strin…ing(startIndex, endIndex)");
      k = Integer.parseInt((String)localObject, kotlin.n.a.avR(16));
      if (paramString2 == null)
      {
        paramString1 = new t("null cannot be cast to non-null type java.lang.String");
        AppMethodBeat.o(224840);
      ...
      p.g(paramString2, "(this as java.lang.Strin…ing(startIndex, endIndex)");
    }
    for (i = Color.argb(i, j, k, Integer.parseInt(paramString2, kotlin.n.a.avR(16)));; i = 0)
    {
      ((o)this.IBa).aWy(paramString1);
      d.h((kotlin.g.a.a)new b(this, paramString1, paramNumber1, paramNumber2, paramNumber3, paramNumber4, paramInt, i, paramString3, paramString4));
      AppMethodBeat.o(224840);
      return;
    }
  }
 ...
 * Qualified Name:     com.tencent.mm.plugin.ab.n
