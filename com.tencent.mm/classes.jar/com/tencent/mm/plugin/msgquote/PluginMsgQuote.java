  ...
  implements com.tencent.mm.kernel.api.bucket.a, c, a
{
  ...
  private com.tencent.mm.plugin.msgquote.model.b zFG = null;
  ...
  public com.tencent.mm.plugin.msgquote.a.a getMsgQuoteStorage()
  {
    ...
    com.tencent.mm.plugin.msgquote.a.a locala = this.zFH;
  ...
  public com.tencent.mm.plugin.msgquote.model.b getMsgReportManager()
  {
    ...
    com.tencent.mm.kernel.g.aAf().azk();
    if (this.zFG == null) {
      this.zFG = new com.tencent.mm.plugin.msgquote.model.b();
    }
    com.tencent.mm.plugin.msgquote.model.b localb = this.zFG;
  ...
  public void handleQuoteMsgClick(Context paramContext, long paramLong, MsgQuoteItem paramMsgQuoteItem)
  {
    ...
    Log.i("MicroMsg.msgquote.PluginMsgQuote", "handleQuoteMsgClick msgId:%s msgSvrId:%s MsgQuoteItem(type:%s svrid:%s content:%s)", new Object[] { Long.valueOf(paramLong), Long.valueOf(((l)com.tencent.mm.kernel.g.af(l.class)).eiy().Hb(paramLong).field_msgSvrId), Integer.valueOf(paramMsgQuoteItem.type), Long.valueOf(paramMsgQuoteItem.zFI), Util.secPrint(paramMsgQuoteItem.content) });
    AppMethodBeat.o(88788);
  }
  ...
  public void handleQuoteMsgSendResuld(long paramLong1, long paramLong2)
  {
    ...
    com.tencent.mm.plugin.msgquote.a.b localb = ((a)com.tencent.mm.kernel.g.ah(a.class)).getMsgQuoteStorage().Hj(paramLong1);
    if (localb != null)
    {
      localb.field_msgSvrId = paramLong2;
      boolean bool = ((a)com.tencent.mm.kernel.g.ah(a.class)).getMsgQuoteStorage().a(localb);
      Object localObject = ((l)com.tencent.mm.kernel.g.af(l.class)).eiy().Hb(localb.field_quotedMsgId);
      if ((((ca)localObject).getType() == 49) || (((ca)localObject).getType() == 805306417) || (((ca)localObject).getType() == 822083633))
      {
        localObject = k.b.HD(((eo)localObject).field_content);
        if (localObject != null) {
      ...
      for (;;)
      {
        ...
        return;
        com.tencent.mm.plugin.msgquote.model.b.b(2L, localb.field_quotedMsgSvrId, ((ca)localObject).getType(), 0L);
      }
    }
  ...
  public void handleReceivedQuoteMsg(long paramLong1, long paramLong2, String paramString, long paramLong3)
  {
    ...
    localb.field_quotedMsgId = ((l)com.tencent.mm.kernel.g.af(l.class)).eiy().aJ(paramString, paramLong3).field_msgId;
    Log.i("MicroMsg.msgquote.PluginMsgQuote", "handleReceivedQuoteMsg() msgId:%s msgSvrid:%s talker:%s quotedMsgSvrid:%s result:%s", new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), paramString, Long.valueOf(paramLong3), Boolean.valueOf(((a)com.tencent.mm.kernel.g.ah(a.class)).getMsgQuoteStorage().b(localb)) });
  ...
  public void handleRevokeMsgBySelf(long paramLong)
  {
    ...
    com.tencent.mm.plugin.msgquote.a.b localb = ((a)com.tencent.mm.kernel.g.ah(a.class)).getMsgQuoteStorage().Hl(paramLong);
    if (localb == null)
    {
    ...
    Log.i("MicroMsg.msgquote.PluginMsgQuote", "handleRevokeMsgBySelf() msgId:%s result:%s", new Object[] { Long.valueOf(paramLong), Boolean.valueOf(((a)com.tencent.mm.kernel.g.ah(a.class)).getMsgQuoteStorage().a(localb)) });
    AppMethodBeat.o(88790);
  }
  ...
  public void handleRevokeMsgBySvrId(long paramLong)
  {
    ...
    com.tencent.mm.plugin.msgquote.a.b localb = ((a)com.tencent.mm.kernel.g.ah(a.class)).getMsgQuoteStorage().Hk(paramLong);
    if (localb == null)
    {
    ...
    localb.field_status = 1;
    Log.i("MicroMsg.msgquote.PluginMsgQuote", "handleRevokeMsgBySelf() msgSvrId:%s result:%s", new Object[] { Long.valueOf(paramLong), Boolean.valueOf(((a)com.tencent.mm.kernel.g.ah(a.class)).getMsgQuoteStorage().a(localb)) });
    AppMethodBeat.o(88791);
  }
  ...
  public void sendQuoteMsg(ca paramca, int paramInt1, String paramString1, CharSequence paramCharSequence, String paramString2, int paramInt2, HashMap<String, String> paramHashMap)
  {
    ...
    if (paramca != null)
    {
      ...
      localb.type = 57;
      localb.izy = com.tencent.mm.plugin.msgquote.model.a.a(paramca, paramInt1, paramCharSequence, paramInt2, paramHashMap);
      if ((BuildInfo.DEBUG) || (BuildInfo.IS_FLAVOR_RED) || (BuildInfo.IS_FLAVOR_PURPLE)) {
        Log.d("MicroMsg.msgquote.PluginMsgQuote", "content:%s MsgQuoteItem:%s", new Object[] { Util.secPrint(paramString2), localb.izy });
      }
      paramString1 = w.a.aSz().a(localb, "", "", paramString1, "", null);
      if (paramString1 != null)
      {
        ...
        boolean bool = ((a)com.tencent.mm.kernel.g.ah(a.class)).getMsgQuoteStorage().b(paramCharSequence);
