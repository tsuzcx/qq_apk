  ...
  extends FTSMainUIEducationLayout
{
  ...
  private void eS(String paramString, int paramInt)
  {
    ...
    localLinearLayout.findViewById(2131305758).setOnClickListener(this.ruG);
    ((TextView)localLinearLayout.findViewById(2131305758)).setText(paramString);
    this.rxp.add(localLinearLayout);
    this.rxq.put(Integer.valueOf(paramInt), (TextView)localLinearLayout.findViewById(2131305758));
  ...
  public final boolean aq(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      eS(paramJSONObject.optString("hotword"), paramJSONObject.optInt("businessType"));
    }
  }
