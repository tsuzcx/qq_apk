...
public final class b
{
  ...
  public static boolean a(String paramString1, n paramn, String paramString2, WidgetData paramWidgetData)
  {
    ...
    Object localObject = DEC.iterator();
    while (((Iterator)localObject).hasNext())
    {
      a locala = (a)((Iterator)localObject).next();
      if ((locala != null) && (locala.aFZ(paramString1))) {
        if (locala.Co(paramWidgetData.DCO.DCW))
        {
          if (locala.aGa(paramString1))
          {
            if ((locala instanceof d))
            {
              paramn = new dc();
              paramn.edX = 2L;
              paramString1 = paramn.mq(paramString1).mp(paramWidgetData.query).SU().mn(paramWidgetData.DCO.keN);
              paramString1.eea = paramWidgetData.DCO.cQN;
              paramString1.mo(paramWidgetData.dDE).aLk();
            }
            for (;;)
            {
        ...
        {
          com.tencent.mm.plugin.websearch.widget.c.c.d(paramWidgetData.DCO.hKC, "openApp", new String[] { paramString1 });
    ...
    if ((!TextUtils.isEmpty(paramString1)) && (paramString1.startsWith("open_target_weapp://"))) {
      if (com.tencent.mm.plugin.websearch.widget.c.c.ah(paramWidgetData.DCO.DCW, 2))
      {
    ...
    label436:
    for (int i = bt.aRe((String)localObject);; i = -1)
    {
