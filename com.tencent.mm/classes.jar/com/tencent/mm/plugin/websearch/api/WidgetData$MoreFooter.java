  ...
  implements Parcelable
{
  ...
  protected WidgetData$MoreFooter(Parcel paramParcel)
  {
    ...
    this.Cae = paramParcel.readString();
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((Objects.equals(this.title, paramObject.title)) && (Objects.equals(this.Cad, paramObject.Cad)) && (Objects.equals(this.Cae, paramObject.Cae)))
    {
      AppMethodBeat.o(117817);
      return true;
    }
  ...
  public int hashCode()
  {
    ...
    int i = Objects.hash(new Object[] { this.title, this.Cad, this.Cae });
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    paramParcel.writeString(this.Cae);
