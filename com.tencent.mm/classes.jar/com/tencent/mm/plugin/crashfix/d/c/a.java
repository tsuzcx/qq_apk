  ...
  implements com.tencent.mm.plugin.crashfix.d.b
{
  ...
  private int IQ(int paramInt)
  {
    for (;;)
    {
      try
      {
        ...
        int i = 0;
        Iterator localIterator = this.ubI.iterator();
  ...
  public final boolean IP(int paramInt)
  {
    ...
    if ((paramInt >= 30) && (((com.tencent.mm.plugin.expt.b.b)h.ae(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.wam, 1) == 1))
    {
  ...
  final void IR(int paramInt)
  {
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = this.ubJ.iterator();
        if (((Iterator)localObject1).hasNext())
        {
          ...
          ((a)localObject3).count = IQ(paramInt);
          i = 1;
          if (i == 0)
          {
            ...
            ((a)localObject3).fYr = new b((a)localObject3);
            ((a)localObject3).count = 1;
            this.ubJ.add(localObject3);
            localObject1 = (TelephonyManager)MMApplicationContext.getContext().getSystemService("phone");
            localObject3 = ((a)localObject3).fYr;
            localObject3 = c.a(paramInt, new com.tencent.mm.hellhoundlib.b.a()).bm(localObject3);
            com.tencent.mm.hellhoundlib.a.a.b(localObject1, ((com.tencent.mm.hellhoundlib.b.a)localObject3).aFh(), "com/tencent/mm/plugin/crashfix/patch/phonestateoverflow/PhoneStateOverflow", "initInnerListener", "(I)V", "android/telephony/TelephonyManager_EXEC_", "listen", "(Landroid/telephony/PhoneStateListener;I)V");
            ((TelephonyManager)localObject1).listen((PhoneStateListener)((com.tencent.mm.hellhoundlib.b.a)localObject3).sf(0), ((Integer)((com.tencent.mm.hellhoundlib.b.a)localObject3).sf(1)).intValue());
  ...
  final void a(PhoneStateListener paramPhoneStateListener)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        localIterator = this.ubI.iterator();
        if (!localIterator.hasNext()) {
          break;
        }
        localc = (c)localIterator.next();
        localPhoneStateListener = (PhoneStateListener)localc.ubQ.get();
  ...
  final boolean a(int paramInt, PhoneStateListener paramPhoneStateListener, String paramString)
  {
    ...
    //   39: aload_0
    //   40: getfield 48	com/tencent/mm/plugin/crashfix/d/c/a:ubI	Ljava/util/List;
    ...
    //   67: astore 5
    //   69: aload 5
    //   71: getfield 216	com/tencent/mm/plugin/crashfix/d/c/a$c:ubQ	Ljava/lang/ref/WeakReference;
    ...
    //   102: iconst_0
    //   103: aload 5
    //   105: getfield 90	com/tencent/mm/plugin/crashfix/d/c/a$c:eventId	I
    ...
    //   122: aload 5
    //   124: iload_1
    //   125: putfield 90	com/tencent/mm/plugin/crashfix/d/c/a$c:eventId	I
    //   128: ldc 228
    ...
    //   145: aload_0
    //   146: iconst_0
    //   147: invokespecial 236	com/tencent/mm/plugin/crashfix/d/c/a$c:<init>	(Lcom/tencent/mm/plugin/crashfix/d/c/a;B)V
    //   150: astore_3
    //   151: aload_3
    //   152: iload_1
    //   153: putfield 90	com/tencent/mm/plugin/crashfix/d/c/a$c:eventId	I
    //   156: aload_3
    //   157: new 218	java/lang/ref/WeakReference
    //   160: dup
    //   161: aload_2
    //   162: invokespecial 239	java/lang/ref/WeakReference:<init>	(Ljava/lang/Object;)V
    //   165: putfield 216	com/tencent/mm/plugin/crashfix/d/c/a$c:ubQ	Ljava/lang/ref/WeakReference;
    //   168: aload_0
    //   169: getfield 48	com/tencent/mm/plugin/crashfix/d/c/a:ubI	Ljava/util/List;
    //   172: aload_3
    ...
    extends PhoneStateListener
  {
    ...
    public final void onCallForwardingIndicatorChanged(boolean paramBoolean)
    {
      ...
      synchronized (a.this)
      {
        Iterator localIterator = a.this.ubI.iterator();
        while (localIterator.hasNext())
        {
          Object localObject2 = (a.c)localIterator.next();
          if (((a.c)localObject2).eventId == this.ubP.eventId)
          {
            localObject2 = (PhoneStateListener)((a.c)localObject2).ubQ.get();
            if (localObject2 != null)
            {
              Log.i("MicroMsg.PhoneStateOverflow", "onCallForwardingIndicatorChanged %d %d", new Object[] { Integer.valueOf(this.ubP.eventId), Integer.valueOf(localObject2.hashCode()) });
    ...
    public final void onCallStateChanged(int paramInt, String paramString)
    {
      ...
      synchronized (a.this)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((a.c)localObject).eventId == this.ubP.eventId)
          {
            localObject = (PhoneStateListener)((a.c)localObject).ubQ.get();
            if (localObject != null)
            {
              Log.i("MicroMsg.PhoneStateOverflow", "onCallStateChanged %d %d", new Object[] { Integer.valueOf(this.ubP.eventId), Integer.valueOf(localObject.hashCode()) });
      ...
      synchronized (a.this)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((a.c)localObject).eventId == this.ubP.eventId)
          {
            ...
            if (localObject != null)
            {
              Log.i("MicroMsg.PhoneStateOverflow", "onCellInfoChanged %d %d", new Object[] { Integer.valueOf(this.ubP.eventId), Integer.valueOf(localObject.hashCode()) });
      ...
      synchronized (a.this)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((a.c)localObject).eventId == this.ubP.eventId)
          {
            ...
            if (localObject != null)
            {
              Log.i("MicroMsg.PhoneStateOverflow", "onCellLocationChanged %d %d", new Object[] { Integer.valueOf(this.ubP.eventId), Integer.valueOf(localObject.hashCode()) });
      ...
      synchronized (a.this)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((a.c)localObject2).eventId == this.ubP.eventId)
          {
            ...
            if (localObject2 != null)
            {
              Log.i("MicroMsg.PhoneStateOverflow", "onDataActivity %d %d", new Object[] { Integer.valueOf(this.ubP.eventId), Integer.valueOf(localObject2.hashCode()) });
      ...
      synchronized (a.this)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((a.c)localObject2).eventId == this.ubP.eventId)
          {
            ...
            if (localObject2 != null)
            {
              Log.i("MicroMsg.PhoneStateOverflow", "onDataConnectionStateChanged %d %d", new Object[] { Integer.valueOf(this.ubP.eventId), Integer.valueOf(localObject2.hashCode()) });
      ...
      synchronized (a.this)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((a.c)localObject2).eventId == this.ubP.eventId)
          {
            ...
            if (localObject2 != null)
            {
              Log.i("MicroMsg.PhoneStateOverflow", "onDataConnectionStateChanged2 %d %d", new Object[] { Integer.valueOf(this.ubP.eventId), Integer.valueOf(localObject2.hashCode()) });
      ...
      synchronized (a.this)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((a.c)localObject2).eventId == this.ubP.eventId)
          {
            ...
            if (localObject2 != null)
            {
              Log.i("MicroMsg.PhoneStateOverflow", "onMessageWaitingIndicatorChanged %d %d", new Object[] { Integer.valueOf(this.ubP.eventId), Integer.valueOf(localObject2.hashCode()) });
      ...
      synchronized (a.this)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((a.c)localObject).eventId == this.ubP.eventId)
          {
            ...
            if (localObject != null)
            {
              Log.i("MicroMsg.PhoneStateOverflow", "onServiceStateChanged %d %d", new Object[] { Integer.valueOf(this.ubP.eventId), Integer.valueOf(localObject.hashCode()) });
      ...
      synchronized (a.this)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((a.c)localObject2).eventId == this.ubP.eventId)
          {
            ...
            if (localObject2 != null)
            {
              Log.i("MicroMsg.PhoneStateOverflow", "onSignalStrengthChanged %d %d", new Object[] { Integer.valueOf(this.ubP.eventId), Integer.valueOf(localObject2.hashCode()) });
      ...
      synchronized (a.this)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((a.c)localObject).eventId == this.ubP.eventId)
          {
            ...
            if (localObject != null)
            {
              Log.i("MicroMsg.PhoneStateOverflow", "onSignalStrengthsChanged %d %d", new Object[] { Integer.valueOf(this.ubP.eventId), Integer.valueOf(localObject.hashCode()) });
      ...
      synchronized (a.this)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((a.c)localObject2).eventId == this.ubP.eventId)
          {
            ...
            if (localObject2 != null)
            {
              Log.i("MicroMsg.PhoneStateOverflow", "onUserMobileDataStateChanged %d %d", new Object[] { Integer.valueOf(this.ubP.eventId), Integer.valueOf(localObject2.hashCode()) });
  ...
  {
    int eventId;
    WeakReference<PhoneStateListener> ubQ;
