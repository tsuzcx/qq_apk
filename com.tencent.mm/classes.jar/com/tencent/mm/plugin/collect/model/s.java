  ...
  extends m
{
  ...
  public final void onGYNetEnd(int paramInt, String paramString, JSONObject paramJSONObject)
  {
    ...
    this.nTB = paramJSONObject.optInt("total_num");
    this.djm = paramJSONObject.optInt("total_amt");
    ...
    while (paramInt < paramString.length()) {
      try
      {
        ...
        a locala = new a();
        locala.nSX = paramJSONObject.optString("bill_id");
        locala.nSY = paramJSONObject.optString("trans_id");
        locala.timestamp = paramJSONObject.optLong("timestamp", 0L);
        locala.desc = paramJSONObject.optString("desc");
        locala.del = paramJSONObject.optInt("fee", 0);
        this.nUd.add(locala);
        paramInt += 1;
      }
