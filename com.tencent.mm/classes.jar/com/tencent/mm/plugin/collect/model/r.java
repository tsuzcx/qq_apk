  ...
  extends m
{
  ...
  public final void onGYNetEnd(int paramInt, String paramString, JSONObject paramJSONObject)
  {
    ...
    this.qwC = paramJSONObject.optInt("choose_flag", 0);
    this.qwd = paramJSONObject.optLong("from_timestamp", -1L);
    this.qwE = paramJSONObject.optInt("finish_flag", 0);
    this.qwF = paramJSONObject.optInt("try_num", 0);
    ...
    while (paramInt < paramString.length()) {
      try
      {
        ...
        localh.qwd = paramJSONObject.optLong("from_timestamp", 0L);
        localh.qwe = paramJSONObject.optInt("total_num", 0);
        localh.dKt = paramJSONObject.optInt("total_amt", 0);
        this.qwH.add(localh);
        paramInt += 1;
      }
