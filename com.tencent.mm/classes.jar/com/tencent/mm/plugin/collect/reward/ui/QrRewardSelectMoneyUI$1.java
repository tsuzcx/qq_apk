  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public final void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    localb.pH(paramInt);
    localb.zo(paramLong);
    a.b("com/tencent/mm/plugin/collect/reward/ui/QrRewardSelectMoneyUI$1", "android/widget/AdapterView$OnItemClickListener", "onItemClick", "(Landroid/widget/AdapterView;Landroid/view/View;IJ)V", this, localb.axR());
    paramInt = ((Integer)paramAdapterView.getAdapter().getItem(paramInt)).intValue();
    QrRewardSelectMoneyUI.a(this.qzb, paramInt, 1);
