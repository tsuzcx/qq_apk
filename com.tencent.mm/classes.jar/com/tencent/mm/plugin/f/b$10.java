  ...
  public final void run()
  {
    ...
    if (j < m)
    {
      ...
      if (locale.getName().endsWith(".temp")) {
        if (bt.Df(locale.lastModified()) > 86400000L)
        {
          locale.delete();
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          {
            localObject1 = aj.getContext().getPackageManager().getPackageArchiveInfo(q.B(locale.fOK()), 128);
            if (localObject1 != null)
            {
              ...
              if ((localObject1 != null) && (((ApplicationInfo)localObject1).metaData != null))
              {
                ...
                ad.d("MicroMsg.CalcWxService", "startCleanAPKFiles:%d, currentVersion;%d", new Object[] { Integer.valueOf(i), Integer.valueOf(d.Fnj) });
                if (i <= d.Fnj)
                {
                  locale.delete();
                  i = k;
