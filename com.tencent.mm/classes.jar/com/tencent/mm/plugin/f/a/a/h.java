...
public final class h
  extends j
{
  private static final byte[] siA = { 76, 0, 2, 21 };
  private byte[] siB = null;
  public byte[] siC = null;
  public short siD = -1;
  public short siE = -1;
  public int siF = 0;
  ...
  final boolean bj(byte[] paramArrayOfByte)
  {
    ...
    locala.W(paramArrayOfByte, 4);
    if (!Arrays.equals(paramArrayOfByte, siA))
    {
      Log.d("MicroMsg.exdevice.IBeaconTLVSectionB", "Cannot find ibeacon cookies!!!");
      AppMethodBeat.o(22468);
      return false;
    }
    this.siB = paramArrayOfByte;
    this.siC = new byte[16];
    locala.W(this.siC, 16);
    try
    {
      this.siD = locala.readShort();
      this.siE = locala.readShort();
      paramArrayOfByte = new byte[1];
      locala.W(paramArrayOfByte, 1);
      this.siF = paramArrayOfByte[0];
      AppMethodBeat.o(22468);
      return true;
    }
