  ...
  implements a
{
  ...
  public final void cuN()
  {
    ...
    if (this.rdM)
    {
      if (!this.ojg)
      {
        Bitmap localBitmap = ((PluginFlutter)g.ad(PluginFlutter.class)).getFlutterEngineMgr().rdu.IXd.IYd.getBitmap();
        this.rdK.setImageBitmap(localBitmap);
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.ojg = getIntent().getBooleanExtra("first_create", false);
    int i = ((PluginFlutter)g.ad(PluginFlutter.class)).getFlutterEngineMgr().rdz.incrementAndGet();
    ad.i("MicroMsg.Flutter.FlutterEngineMgr", "onCreate %s InstanceCount %d", new Object[] { Integer.valueOf(hashCode()), Integer.valueOf(i) });
    this.rdu = ((PluginFlutter)g.ad(PluginFlutter.class)).getFlutterEngineMgr().rdu;
    this.rdL = ((FrameLayout)findViewById(2131300142));
    this.rdK = ((ImageView)findViewById(2131300143));
    this.rdK.setVisibility(8);
    this.rdJ = new FlutterView(this);
    this.rdL.addView(this.rdJ);
    this.rdM = true;
