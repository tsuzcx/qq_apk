  ...
  implements com.tencent.mm.ipcinvoker.wx_extension.c.a
{
  ...
  private static final Object qmy;
  private Context mContext;
  private Set<CDNTaskInfo> qmA;
  public b qmB;
  private ServiceConnection qmC;
  private MTimerHandler qmD;
  private com.tencent.mm.plugin.cdndownloader.a.b qmE;
  private p.a qmF;
  private long qmw;
  private long qmx;
  ...
  public a()
  {
    ...
    this.qmw = 0L;
    this.qmx = 0L;
    this.qmA = new com.tencent.mm.plugin.cdndownloader.e.a(new com.tencent.mm.plugin.cdndownloader.e.b()
    {
      ...
      public final void onServiceDisconnected(ComponentName paramAnonymousComponentName)
      {
        ...
        if (a.c(a.this).size() != 0)
        {
          ...
          while (paramAnonymousComponentName.hasNext()) {
            ((CDNTaskInfo)paramAnonymousComponentName.next()).qmN = true;
          }
        }
        AppMethodBeat.o(120727);
      }
    };
    this.qmD = new MTimerHandler(p.ayg().getLooper(), new MTimerHandler.CallBack()
    {
      public final boolean onTimerExpired()
      {
        ...
        catch (RemoteException localRemoteException)
        {
          ...
          h.CyF.idkeyStat(710L, 4L, 1L, false);
          Iterator localIterator = a.c(a.this).iterator();
          while (localIterator.hasNext())
          {
            CDNTaskInfo localCDNTaskInfo = (CDNTaskInfo)localIterator.next();
            a.k(a.this).g(localCDNTaskInfo.downloadUrl, 4, com.tencent.mm.plugin.downloader.a.a.qFo, null);
          }
          a.l(a.this);
          AppMethodBeat.o(120728);
        }
    ...
    this.qmE = new b.a()
    {
      ...
      public final void w(String paramAnonymousString, long paramAnonymousLong1, long paramAnonymousLong2)
      {
        ...
        if (a.k(a.this) != null) {
          a.k(a.this).x(paramAnonymousString, paramAnonymousLong1, paramAnonymousLong2);
        }
    ...
    this.qmF = new p.a()
    {
      public final void onNetworkChange(int paramAnonymousInt)
      {
        ...
        if (locala.qmz != null) {
          try
          {
            locala.qmz.EL(paramAnonymousInt);
  ...
  private void cyb()
  {
    try
    {
      ...
      try
      {
        Log.i("MicroMsg.CDNDownloadClient", "bindService: ".concat(String.valueOf(this.mContext.bindService(localIntent, this.qmC, 1))));
  ...
  private void d(CDNTaskInfo paramCDNTaskInfo)
  {
    ...
    this.qmA.remove(paramCDNTaskInfo);
    com.tencent.mm.plugin.cdndownloader.f.b.akv(paramCDNTaskInfo.downloadUrl);
  ...
  private static com.tencent.mm.plugin.cdndownloader.f.a e(CDNTaskInfo paramCDNTaskInfo)
  {
    ...
    locala.field_httpsUrl = paramCDNTaskInfo.qmH;
    locala.field_filePath = paramCDNTaskInfo.filePath;
    locala.field_verifyHeaders = paramCDNTaskInfo.qmI;
    locala.field_allowMobileNetDownload = Boolean.valueOf(paramCDNTaskInfo.qmL);
    locala.field_wifiAutoDownload = Boolean.valueOf(paramCDNTaskInfo.qmM);
    locala.field_game_package_download = Boolean.valueOf(paramCDNTaskInfo.gqH);
  ...
  public final int a(CDNTaskInfo paramCDNTaskInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.qmA.contains(paramCDNTaskInfo))
        {
          Log.i("MicroMsg.CDNDownloadClient", "addDownloadTask, already in running");
          AppMethodBeat.o(120735);
          continue;
        }
        localObject = akt(paramCDNTaskInfo.downloadUrl);
      }
      finally {}
      Object localObject;
      if ((localObject != null) && (((CDNTaskState)localObject).taskState == 104) && (s.YS(paramCDNTaskInfo.filePath)))
      {
      ...
      {
        localObject = this.qmz;
        if (localObject != null)
        {
          try
          {
            i = this.qmz.a(paramCDNTaskInfo);
            this.qmE.f(paramCDNTaskInfo.mediaId, 1, 0, "");
            if ((i == 0) || (i == -2)) {
              c(paramCDNTaskInfo);
            }
            AppMethodBeat.o(120735);
  ...
  public final boolean akr(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        com.tencent.mm.plugin.cdndownloader.a.a locala = this.qmz;
        if (locala == null) {}
      }
      finally
      {
        try
        {
          boolean bool2 = this.qmz.akr(paramString);
          bool1 = bool2;
          AppMethodBeat.o(120736);
        }
  ...
  public final boolean aks(String paramString)
  {
    ...
    for (;;)
    {
      ...
      finally
      {
        try
        {
          boolean bool2 = this.qmz.aks(paramString);
          bool1 = bool2;
          AppMethodBeat.o(120738);
        }
        catch (RemoteException paramString)
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.qmz != null)
        {
          ...
          try
          {
            localCDNTaskState = this.qmz.akt(paramString);
            if ((localCDNTaskState.taskState != 100) && (localCDNTaskState.taskState != 101)) {
              break label420;
            }
            if (!this.qmA.contains(new CDNTaskInfo(paramString)))
            {
              localObject1 = com.tencent.mm.plugin.cdndownloader.f.b.cxT();
              ...
              ((CDNTaskInfo)localObject4).qmH = ((com.tencent.mm.plugin.cdndownloader.f.a)localObject1).field_httpsUrl;
              ...
              ((CDNTaskInfo)localObject4).qmI = ((com.tencent.mm.plugin.cdndownloader.f.a)localObject1).field_verifyHeaders;
              ((CDNTaskInfo)localObject4).qmL = ((com.tencent.mm.plugin.cdndownloader.f.a)localObject1).field_allowMobileNetDownload.booleanValue();
              ((CDNTaskInfo)localObject4).qmM = ((com.tencent.mm.plugin.cdndownloader.f.a)localObject1).field_wifiAutoDownload.booleanValue();
              ((CDNTaskInfo)localObject4).gqH = ((com.tencent.mm.plugin.cdndownloader.f.a)localObject1).field_game_package_download.booleanValue();
              ((CDNTaskInfo)localObject4).qmJ = 15;
              ((CDNTaskInfo)localObject4).qmK = 3600;
              localObject1 = localObject4;
              if (localObject1 != null) {
                this.qmA.add(localObject1);
              }
            }
            AppMethodBeat.o(120739);
  ...
  public final int b(CDNTaskInfo paramCDNTaskInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        paramCDNTaskInfo.qmN = true;
        localObject = this.qmz;
        if (localObject != null)
        {
          try
          {
            i = this.qmz.b(paramCDNTaskInfo);
            this.qmE.f(paramCDNTaskInfo.mediaId, 1, 0, "");
            if ((i == 0) || (i == -2)) {
              c(paramCDNTaskInfo);
            }
