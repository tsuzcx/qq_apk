  ...
  implements com.tencent.xweb.downloader.a
{
  ...
  public a()
  {
    ...
    this.onW = new g.a()
    {
      public final int a(String paramAnonymousString, int paramAnonymousInt, c paramAnonymousc, d paramAnonymousd, boolean paramAnonymousBoolean)
      {
        ...
        {
          ac.d("FileDownloaderXWEBProxy", "on cdn callback mediaId = %s, startRet = %d, keep_ProgressInfo = %s, keep_SceneResult = %s", new Object[] { paramAnonymousString, Integer.valueOf(paramAnonymousInt), str1, str2 });
          if (paramAnonymousInt != -21006) {
            break label102;
          }
          ac.i("FileDownloaderXWEBProxy", "duplicate request, ignore this request, media id is %s", new Object[] { paramAnonymousString });
        ...
        {
          ac.e("FileDownloaderXWEBProxy", "start failed : %d, media id is :%s", new Object[] { Integer.valueOf(paramAnonymousInt), paramAnonymousString });
        ...
        if (paramAnonymousd != null)
        {
          ...
          ac.e("FileDownloaderXWEBProxy", "cdntra clientid:%s sceneResult.retCode:%d sceneResult[%s]", new Object[] { paramAnonymousString, Integer.valueOf(paramAnonymousd.field_retCode), paramAnonymousd });
        ...
        for (;;)
        {
          ...
          return 0;
          label243:
          ac.i("FileDownloaderXWEBProxy", "cdn trans suceess, media id : %s", new Object[] { paramAnonymousString });
  ...
  public final int a(String paramString1, String paramString2, b paramb)
  {
    ...
    ac.i("FileDownloaderXWEBProxy", "addDownloadTask: %s filepath:%s", new Object[] { paramString1, paramString2 });
    g localg = new g();
    localg.field_mediaId = paramString1;
    localg.field_fullpath = paramString2;
    localg.fre = paramString1;
    localg.field_fileType = com.tencent.mm.i.a.fqG;
    localg.frb = this.onW;
    localg.frf = 60;
    localg.frg = 600;
    localg.fri = false;
    ...
    ac.i("FileDownloaderXWEBProxy", "addDownloadTask: ".concat(String.valueOf(i)));
