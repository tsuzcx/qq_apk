...
final class b
  extends a.a
{
  private final Map<String, a.b> Jry;
  
  b()
  {
    AppMethodBeat.i(151590);
    this.Jry = new HashMap();
    this.Jry.put("xiaomi", new a.b()
    {
      protected final Intent fIq()
      {
  ...
  private static String fIr()
  {
    ...
    String str = af.cq(MMApplicationContext.getContext()).toLowerCase();
  ...
  public final int fIn()
  {
    ...
    //   11: invokestatic 59	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   14: astore 6
    //   16: invokestatic 77	com/tencent/mm/plugin/am/a/b:fIr	()Ljava/lang/String;
    //   19: astore_3
    //   20: ldc 79
    //   22: ldc 81
    //   24: iconst_1
    ...
    //   30: aload_3
    //   31: aastore
    //   32: invokestatic 88	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   35: aload_3
    ...
    //   376: dup
    //   377: invokestatic 59	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   380: ldc 173
    ...
    //   503: invokestatic 221	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   506: iload_1
    //   507: bipush 16
    ...
    //   580: invokestatic 232	com/tencent/mm/sdk/platformtools/Log:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   583: aload 4
    //   585: ifnull +10 -> 595
    //   588: aload 4
  ...
  public final boolean fIo()
  {
    ...
    a.b localb = (a.b)this.Jry.get(str);
    if ((this.Jry.containsKey(str)) && (localb.fIp()))
    {
  ...
  public final void hX(Context paramContext)
  {
    ...
    Object localObject = af.cq(paramContext).toLowerCase();
    Log.i("MicroMsg.AppPermissionSettingAdapterFactory", "[jumpPermissionSettingPage] manufacturer = %s", new Object[] { localObject });
    localObject = (a.b)this.Jry.get(localObject);
    if (localObject != null) {
      ((a.b)localObject).hY(paramContext);
    }
 ...
 * Qualified Name:     com.tencent.mm.plugin.am.a.b
