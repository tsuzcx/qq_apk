...
{
  public c lUI;
  public final String vBY;
  public final k.c vCk;
  final Map<String, a> vCv;
  
  public d(String paramString)
  {
    AppMethodBeat.i(123840);
    this.vBY = paramString;
    this.vCv = ((Map)new LinkedHashMap());
    this.vCk = ((k.c)new a(this));
  ...
  public final void a(a parama)
  {
    ...
    Iterator localIterator = parama.djS().iterator();
    while (localIterator.hasNext())
    {
      String str = (String)localIterator.next();
      if ((a)this.vCv.get(str) != null)
      {
        parama = (Throwable)new RuntimeException(str + "'s handler exist");
        AppMethodBeat.o(123835);
        throw parama;
      }
      this.vCv.put(str, parama);
    }
    AppMethodBeat.o(123835);
  }
  ...
  public final void dp(Object paramObject)
  {
    ...
    com.tencent.mm.plugin.m.a.a.a.a.djQ().g(this.vBY, "onBackground", paramObject);
    AppMethodBeat.o(123837);
  }
  
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"<anonymous>", "", "methodCall", "Lio/flutter/plugin/common/MethodCall;", "result", "Lio/flutter/plugin/common/MethodChannel$Result;", "onMethodCall"})
    ...
    implements k.c
  {
    ...
    public final void a(j paramj, k.d paramd)
    {
      ...
      p.h(paramd, "result");
      Object localObject1 = (a)this.vCw.vCv.get(paramj.method);
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                          AppMethodBeat.o(123834);
                          return;
                        } while ((!((String)localObject1).equals("inputLocationChange")) || (!(paramj.grf instanceof Map)));
                        paramj = paramj.grf;
                        if (paramj != null) {
                          break;
                        }
                        ...
                        AppMethodBeat.o(123834);
                        throw paramj;
                      } while ((!((String)localObject1).equals("hideKeyboard")) || (!(paramj.grf instanceof Map)));
                      paramj = paramj.grf;
                      if (paramj != null) {
                        break label1145;
                      }
                      ...
                      AppMethodBeat.o(123834);
                      throw paramj;
                    } while ((!((String)localObject1).equals("publishEvent")) || (!(paramj.grf instanceof Map)));
                    paramj = paramj.grf;
                    if (paramj != null) {
                      break;
                    }
                    ...
                    AppMethodBeat.o(123834);
                    throw paramj;
                  } while ((!((String)localObject1).equals("showPicker")) || (!(paramj.grf instanceof Map)));
                  paramj = paramj.grf;
                  if (paramj != null) {
                    break label1196;
                  }
                  ...
                  AppMethodBeat.o(123834);
                  throw paramj;
                } while ((!((String)localObject1).equals("getLocalFileData")) || (!(paramj.grf instanceof Map)));
                paramj = paramj.grf;
                if (paramj != null) {
                  break label1281;
                }
                ...
                AppMethodBeat.o(123834);
                throw paramj;
              } while ((!((String)localObject1).equals("inputOnKeyboardValueChange")) || (!(paramj.grf instanceof Map)));
              paramj = paramj.grf;
              if (paramj != null) {
                break label931;
              }
              ...
              AppMethodBeat.o(123834);
              throw paramj;
            } while ((!((String)localObject1).equals("setCanOverScroll")) || (!(paramj.grf instanceof Map)));
            paramj = paramj.grf;
            if (paramj != null) {
              break label744;
            }
            ...
            AppMethodBeat.o(123834);
            throw paramj;
          } while ((!((String)localObject1).equals("onRenderCallback")) || (!(paramj.grf instanceof Map)));
          paramj = paramj.grf;
          if (paramj != null) {
            break label1462;
          }
          ...
          AppMethodBeat.o(123834);
          throw paramj;
        } while ((!((String)localObject1).equals("generateInputEventData")) || (!(paramj.grf instanceof Map)));
        paramj = paramj.grf;
        if (paramj == null)
        {
          paramj = new v("null cannot be cast to non-null type kotlin.collections.Map<*, *>");
          ...
          throw paramj;
          paramj = (Map)paramj;
          paramd = com.tencent.mm.plugin.m.a.a.a.vCa;
          paramd = (a.a.a)com.tencent.mm.plugin.m.a.a.a.djO().get(paramj.get("viewId"));
          if (paramd != null)
          {
          ...
          if (paramd != null)
          {
            ...
            paramd.oh(((Boolean)paramj).booleanValue());
            AppMethodBeat.o(123834);
            return;
          }
          AppMethodBeat.o(123834);
        ...
        paramj = (Map)paramj;
        localObject1 = com.tencent.mm.plugin.m.a.a.a.vCa;
        localObject1 = (a.a.a)com.tencent.mm.plugin.m.a.a.a.djO().get(paramj.get("viewId"));
        if (localObject1 != null)
        {
        ...
        for (paramj = ((a.a.a)localObject1).JB(((Integer)paramj).intValue());; paramj = null)
        {
          paramd.de(paramj);
          AppMethodBeat.o(123834);
          return;
        ...
        if (paramd != null)
        {
          ...
          paramd.IV(((Integer)paramj).intValue());
          AppMethodBeat.o(123834);
          return;
        }
        AppMethodBeat.o(123834);
        ...
        paramj = (Map)paramj;
        paramd = com.tencent.mm.plugin.m.a.a.a.vCa;
        paramj = (a.a.a)com.tencent.mm.plugin.m.a.a.a.djO().get(paramj.get("viewId"));
        if (paramj != null)
        {
          paramj.dfJ();
          AppMethodBeat.o(123834);
        ...
        if (!d.n.n.nz((String)localObject1, "wxfile"))
        {
        ...
        paramj = new i();
        Object localObject2 = this.vCw.lUI;
        if (localObject2 != null)
        {
          localObject2 = ((c)localObject2).EY();
          if (localObject2 != null) {
