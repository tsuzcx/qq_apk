  ...
  implements k
{
  ...
  public c(String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    ...
    ((b.a)localObject).gUU = new ko();
    ((b.a)localObject).gUV = new kp();
    ((b.a)localObject).funcId = getType();
    ((b.a)localObject).uri = "/cgi-bin/mmpay-bin/bindecard";
    ((b.a)localObject).reqCmdId = 0;
    ((b.a)localObject).respCmdId = 0;
    this.rr = ((b.a)localObject).atI();
    localObject = (ko)this.rr.gUS.gUX;
    ((ko)localObject).CFs = paramString1;
    ((ko)localObject).CFt = paramString2;
    ((ko)localObject).Ahs = paramString3;
    ((ko)localObject).CFu = paramString4;
    ((ko)localObject).dsB = paramInt;
  ...
  public final void onGYNetEnd(int paramInt1, int paramInt2, int paramInt3, String paramString, q paramq, byte[] paramArrayOfByte)
  {
    ...
    this.Awn = ((kp)((b)paramq).gUT.gUX);
    ad.i("MicroMsg.NetSceneBindECard", "ret_code: %d, ret_msg: %s", new Object[] { Integer.valueOf(this.Awn.ntx), this.Awn.nty });
