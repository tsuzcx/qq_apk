  ...
  implements k
{
  ...
  public f(String paramString, int paramInt)
  {
    ...
    ((b.a)localObject).gUU = new cec();
    ((b.a)localObject).gUV = new ced();
    ((b.a)localObject).funcId = getType();
    ((b.a)localObject).uri = "/cgi-bin/mmpay-bin/qryecardbanklist4bind";
    ((b.a)localObject).reqCmdId = 0;
    ((b.a)localObject).respCmdId = 0;
    this.rr = ((b.a)localObject).atI();
    localObject = (cec)this.rr.gUS.gUX;
    ((cec)localObject).CFs = paramString;
    ((cec)localObject).dsB = paramInt;
  ...
  public final void onGYNetEnd(int paramInt1, int paramInt2, int paramInt3, String paramString, q paramq, byte[] paramArrayOfByte)
  {
    ...
    this.Awt = ((ced)((b)paramq).gUT.gUX);
    ad.i("MicroMsg.NetSceneQryBankList4Bind", "ret_code: %d, ret_msg: %s", new Object[] { Integer.valueOf(this.Awt.ntx), this.Awt.nty });
