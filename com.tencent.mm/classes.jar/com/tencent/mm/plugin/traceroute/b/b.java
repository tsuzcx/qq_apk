...
{
  public static List<Object> S(String[] paramArrayOfString)
  {
    ...
    paramArrayOfString = com.tencent.f.h.RTc.aX(paramArrayOfString);
    try
    {
  ...
  public static int aTL(String paramString)
  {
    ...
    i = Util.getInt(paramString.substring(i, j), 0);
    AppMethodBeat.o(29671);
    return i;
  }
    ...
    implements com.tencent.f.i.h
  {
    ...
    public final void run()
    {
      ...
      //   18: dup
      //   19: aload_0
      //   20: getfield 21	com/tencent/mm/plugin/traceroute/b/b$a:GrB	[Ljava/lang/String;
      ...
      //   34: pop
      //   35: invokestatic 61	com/tencent/mm/sdk/platformtools/Util:nowMilliSecond	()J
      //   38: lstore 9
      //   40: invokestatic 61	com/tencent/mm/sdk/platformtools/Util:nowMilliSecond	()J
      //   43: lstore_1
      //   44: aload 11
      ...
      //   64: invokestatic 75	com/tencent/mm/sdk/platformtools/Util:qualityClose	(Ljava/io/Closeable;)V
      //   67: lload_1
      //   68: lstore_3
      //   69: lload_1
      //   70: lstore 5
      //   72: lload_1
      //   73: lstore 7
      //   75: invokestatic 61	com/tencent/mm/sdk/platformtools/Util:nowMilliSecond	()J
      //   78: lstore_1
      //   79: lload_1
      //   80: lstore_3
      //   81: lload_1
      ...
      //   182: invokestatic 115	com/tencent/mm/sdk/platformtools/Log:e	(Ljava/lang/String;Ljava/lang/String;)V
      //   185: aload 11
      //   187: aload 14
      //   189: invokestatic 118	com/tencent/mm/plugin/traceroute/b/b:a	(Ljava/lang/Process;Ljava/io/BufferedReader;)V
      //   192: aload_0
      //   193: getfield 23	com/tencent/mm/plugin/traceroute/b/b$a:mWl	Ljava/util/List;
      //   196: aload 16
      //   198: invokevirtual 109	java/lang/StringBuilder:toString	()Ljava/lang/String;
      //   201: invokeinterface 124 2 0
      //   206: pop
      //   207: aload_0
      //   208: getfield 23	com/tencent/mm/plugin/traceroute/b/b$a:mWl	Ljava/util/List;
      //   211: lload_1
      //   212: lload 9
      //   214: lsub
      ...
      //   246: invokestatic 134	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
      //   249: sipush 29669
      ...
      //   318: invokestatic 115	com/tencent/mm/sdk/platformtools/Log:e	(Ljava/lang/String;Ljava/lang/String;)V
      //   321: aload 11
      //   323: aload 14
      ...
      //   369: invokestatic 115	com/tencent/mm/sdk/platformtools/Log:e	(Ljava/lang/String;Ljava/lang/String;)V
      //   372: aload 11
      //   374: aload 14
