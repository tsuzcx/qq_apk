...
public final class a
{
  ...
  private boolean Bze;
  f Bzf;
  public Map<String, Set<Integer>> Bzg;
  public e Bzh;
  public d Bzi;
  public c Bzj;
  public b Bzk;
  ...
  public a(String paramString)
  {
    ...
    this.Bzd = 64;
    this.Bze = false;
    this.Bzf = new f((byte)0);
    this.Bzg = new HashMap();
    this.userName = paramString;
    Bzb = g.getExternalStorageDirectory().getAbsolutePath() + "/tencent/traceroute_log_" + new SimpleDateFormat("yyyyMMddHHmmss").format(new java.util.Date()).toString() + ".log";
  ...
  final void a(String paramString1, String paramString2, Integer paramInteger)
  {
    for (;;)
    {
      try
      {
        ...
        if (!this.Bzf.containsKey(paramString1))
        {
          ConcurrentHashMap localConcurrentHashMap = new ConcurrentHashMap();
          localConcurrentHashMap.put(paramInteger, new StringBuilder(paramString2));
          this.Bzf.put(paramString1, (ConcurrentHashMap)localConcurrentHashMap);
          AppMethodBeat.o(29666);
          continue;
        }
        if (!((ConcurrentHashMap)this.Bzf.get(paramString1)).containsKey(paramInteger)) {
          break label147;
        }
      }
      finally {}
      ((StringBuilder)((ConcurrentHashMap)this.Bzf.get(paramString1)).get(paramInteger)).append(paramString2);
      AppMethodBeat.o(29666);
      continue;
      label147:
      new ConcurrentHashMap().put(paramInteger, new StringBuilder(paramString2));
      ((ConcurrentHashMap)this.Bzf.get(paramString1)).put(paramInteger, new StringBuilder(paramString2));
      AppMethodBeat.o(29666);
    }
  }
  ...
  public final void c(String[] paramArrayOfString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      break;
      label140:
      if (!this.Bzg.containsKey(arrayOfString[0]))
      {
        localObject2 = new HashSet();
        ((Set)localObject2).add(Integer.valueOf(bt.getInt(arrayOfString[1], 0)));
        this.Bzg.put(arrayOfString[0], localObject2);
        localObject1 = (String)localObject1 + arrayOfString[0] + " ";
      }
      else
      {
        ((Set)this.Bzg.get(arrayOfString[0])).add(Integer.valueOf(bt.getInt(arrayOfString[1], 0)));
      }
    }
    label268:
    Object localObject1 = (String)localObject1 + "\n";
    paramArrayOfString = Bzb;
  ...
  public final void erb()
  {
    ...
    //   8: aload_0
    //   9: getfield 82	com/tencent/mm/plugin/traceroute/b/a:Bzf	Lcom/tencent/mm/plugin/traceroute/b/a$f;
    //   12: ifnull +616 -> 628
    //   15: aload_0
    //   16: getfield 82	com/tencent/mm/plugin/traceroute/b/a:Bzf	Lcom/tencent/mm/plugin/traceroute/b/a$f;
    //   19: astore 6
    //   21: new 235	com/tencent/mm/vfs/e
    //   24: dup
    //   25: getstatic 133	com/tencent/mm/plugin/traceroute/b/a:Bzb	Ljava/lang/String;
    ...
    //   48: pop
    //   49: getstatic 133	com/tencent/mm/plugin/traceroute/b/a:Bzb	Ljava/lang/String;
    //   52: astore 4
    //   54: new 91	java/lang/StringBuilder
    //   57: dup
    //   58: invokespecial 92	java/lang/StringBuilder:<init>	()V
    //   61: aload 6
    //   63: getfield 246	com/tencent/mm/plugin/traceroute/b/a$f:Bzm	Lcom/tencent/mm/plugin/traceroute/b/a;
    ...
    //   95: pop
    //   96: aload 6
    //   98: getfield 246	com/tencent/mm/plugin/traceroute/b/a$f:Bzm	Lcom/tencent/mm/plugin/traceroute/b/a;
    //   101: getfield 82	com/tencent/mm/plugin/traceroute/b/a:Bzf	Lcom/tencent/mm/plugin/traceroute/b/a$f;
    ...
    //   149: ifne -35 -> 114
    //   152: aload 6
    //   154: getfield 246	com/tencent/mm/plugin/traceroute/b/a$f:Bzm	Lcom/tencent/mm/plugin/traceroute/b/a;
    //   157: getfield 82	com/tencent/mm/plugin/traceroute/b/a:Bzf	Lcom/tencent/mm/plugin/traceroute/b/a$f;
    //   160: aload 8
    //   162: invokevirtual 148	com/tencent/mm/plugin/traceroute/b/a$f:containsKey	(Ljava/lang/Object;)Z
    //   165: ifeq -51 -> 114
    //   168: aload 6
    //   170: getfield 246	com/tencent/mm/plugin/traceroute/b/a$f:Bzm	Lcom/tencent/mm/plugin/traceroute/b/a;
    //   173: getfield 82	com/tencent/mm/plugin/traceroute/b/a:Bzf	Lcom/tencent/mm/plugin/traceroute/b/a$f;
    //   176: aload 8
    ...
    //   290: getstatic 133	com/tencent/mm/plugin/traceroute/b/a:Bzb	Ljava/lang/String;
    //   293: astore 4
    //   295: aload 5
    ...
    //   364: aload 6
    //   366: getfield 246	com/tencent/mm/plugin/traceroute/b/a$f:Bzm	Lcom/tencent/mm/plugin/traceroute/b/a;
    //   369: invokevirtual 292	com/tencent/mm/plugin/traceroute/b/a:erc	()V
    //   372: sipush 29667
    ...
    //   490: astore 4
    //   492: goto +145 -> 637
    //   495: getstatic 133	com/tencent/mm/plugin/traceroute/b/a:Bzb	Ljava/lang/String;
    //   498: iconst_0
    //   499: iconst_m1
    //   500: invokestatic 302	com/tencent/mm/vfs/i:aY	(Ljava/lang/String;II)[B
    //   503: astore 5
    //   505: aload 5
    //   507: invokestatic 306	com/tencent/mm/sdk/platformtools/bt:cC	([B)Z
    //   510: ifeq +28 -> 538
    //   513: ldc 71
    //   515: ldc_w 308
    //   518: invokestatic 174	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   521: aload 6
    //   523: getfield 246	com/tencent/mm/plugin/traceroute/b/a$f:Bzm	Lcom/tencent/mm/plugin/traceroute/b/a;
    //   526: invokevirtual 292	com/tencent/mm/plugin/traceroute/b/a:erc	()V
    //   529: sipush 29667
    ...
    //   549: dup
    //   550: iconst_0
    //   551: getstatic 315	com/tencent/mm/protocal/d:Fnj	I
  ...
  final void sN(boolean paramBoolean)
  {
    try
    {
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      //   22: astore 6
      //   24: aload_0
      //   25: getfield 20	com/tencent/mm/plugin/traceroute/b/a$a:Bzm	Lcom/tencent/mm/plugin/traceroute/b/a;
      //   28: aload_0
      ...
      //   41: aload_0
      //   42: getfield 27	com/tencent/mm/plugin/traceroute/b/a$a:Bzl	Ljava/util/Set;
      ...
      //   72: astore 6
      //   74: aload_0
      //   75: getfield 20	com/tencent/mm/plugin/traceroute/b/a$a:Bzm	Lcom/tencent/mm/plugin/traceroute/b/a;
      //   78: astore 10
      //   80: aload_0
      ...
      //   113: aload 7
      //   115: astore 6
      //   117: invokestatic 92	com/tencent/mm/sdk/platformtools/bt:flT	()J
      //   120: lstore_2
      //   121: aload 7
      //   123: astore 6
      //   125: aload 7
      ...
      //   140: aload 7
      //   142: astore 6
      //   144: invokestatic 92	com/tencent/mm/sdk/platformtools/bt:flT	()J
      //   147: lstore 4
      //   149: aload 7
      //   151: astore 6
      //   153: ldc 103
      ...
      //   778: goto -49 -> 729
      //   781: aload_0
      //   782: getfield 20	com/tencent/mm/plugin/traceroute/b/a$a:Bzm	Lcom/tencent/mm/plugin/traceroute/b/a;
      //   785: aload_0
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      ad.i("MicroMsg.MMTraceRoute", "ttl= " + this.Bzu);
      a locala = a.this;
      String str1 = this.ip;
      int m = this.Bzu;
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            if (a.Bzc != null)
            {
              a.Bzc.execute(new a.g(locala, (String)localObject, str1, true, Integer.valueOf(m + 1)));
              i = j;
            }
          }
        }
        ...
        if (a.Bzc != null) {
          a.Bzc.execute(new a.g(locala, (String)localObject, str1, false, Integer.valueOf(m + 1)));
        }
      }
      label570:
      AppMethodBeat.o(29660);
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      int i = b.aDc((String)localObject1);
      if (i <= 0)
      {
      ...
      localObject1 = b.aDb((String)localObject1);
      if (!bt.isNullOrNil((String)localObject1)) {
      ...
      for (;;)
      {
        ...
        while ((j < i) && (!a.this.era()))
        {
          localObject1 = new a.h(a.this, this.ip, j);
          if (a.Bzc != null) {
            a.Bzc.execute((Runnable)localObject1);
          }
          j += 1;
        }
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      try
      {
        ...
        {
          Thread.sleep(500L);
          if ((a.this.era()) || (a.Bzc.getActiveCount() <= 0)) {
            break;
          }
          ad.d("MicroMsg.MMTraceRoute", "task count: " + String.valueOf(a.Bzc.getActiveCount()));
          l2 = bt.flT();
        } while (l2 - l1 < 120000L);
