...
final class WxaBindWxaInfoUI$a
  extends BaseAdapter
{
  private List<WxaAttributes.WxaEntryInfo> jfV;
  private LayoutInflater mInflater;
  
  public WxaBindWxaInfoUI$a(LayoutInflater paramLayoutInflater, List<WxaAttributes.WxaEntryInfo> paramList)
  {
  ...
  public final View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup = new WxaBindWxaInfoUI.a.a((byte)0);
    ...
    for (paramInt = 8;; paramInt = 0)
    {
      ...
      return paramView;
      paramViewGroup = (WxaBindWxaInfoUI.a.a)paramView.getTag();
      break;
 ...
 * Qualified Name:     com.tencent.mm.plugin.profile.ui.WxaBindWxaInfoUI.a
