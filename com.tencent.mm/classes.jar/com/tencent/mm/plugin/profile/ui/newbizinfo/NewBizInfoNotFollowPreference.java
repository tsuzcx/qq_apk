  ...
  extends Preference
{
  ...
  private final void dBs()
  {
    ...
    if (!n.aE((CharSequence)this.title)) {}
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
