...
{
  public static f Rk(String paramString)
  {
    ...
    try
    {
      ...
      f localf = new f();
      localf.nsN = paramString.optString("empty_tips");
      localf.nsO = paramString.optString("shoppingmall_title");
      localf.nsP = paramString.optString("shoppingmall_url");
