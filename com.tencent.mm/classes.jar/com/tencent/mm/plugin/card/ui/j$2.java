  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bm(paramView);
    a.b("com/tencent/mm/plugin/card/ui/CardPopupWindow$2", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.axR());
    if ((this.qdQ.kuK != null) && (this.qdQ.kuK.isShowing())) {
      this.qdQ.kuK.dismiss();
    }
