  ...
  extends RecyclerView.w
{
  ...
  public d(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.ojf = ((CdnImageView)localView);
  ...
  public static void b(ImageView paramImageView, String paramString)
  {
    ...
    ((c.a)localObject).CB(b.aph());
    ((c.a)localObject).a(o.aFC());
    ((c.a)localObject).CA(m.UK(paramString));
    ((c.a)localObject).aFP();
    ((c.a)localObject).aFS();
    ((c.a)localObject).aFO();
    ((c.a)localObject).pe(2131231461);
    ((c.a)localObject).pd(com.tencent.mm.cc.a.fromDPToPix(paramImageView.getContext(), 84));
    ((c.a)localObject).pc(com.tencent.mm.cc.a.ig(paramImageView.getContext()));
