...
public class PluginCloudVoice
  ...
  implements c, a
{
  private static final String[] pcy = { "confService", "ilink_network", "ilink_xlog" };
  
  public void configure(g paramg)
  {
    AppMethodBeat.i(90784);
    super.configure(paramg);
    ae.i("MicroMsg.OpenVoice.PluginCloudVoice", "hy: PluginCloudVoice configure");
  ...
  public void execute(g paramg)
  {
    ...
    ae.i("MicroMsg.OpenVoice.PluginCloudVoice", "hy: PluginCloudVoice execute");
  ...
  public void onAccountRelease()
  {
    ...
    ae.i("MicroMsg.OpenVoice.PluginCloudVoice", "hy: account release. uninit openvoice so");
    p localp = p.pdY;
