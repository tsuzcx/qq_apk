...
public final class h
{
  ...
  public h(int paramInt1, int paramInt2, String paramString)
  {
    ...
    catch (Exception paramString)
    {
      for (;;)
      {
        Log.e("OpenVoice[HWEnc]", " error:" + paramString.toString());
      }
    }
  }
  ...
  private void E(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    i = m.e(paramArrayOfByte, 0, paramInt1, i);
    if (i > 0) {
      Log.d("OpenVoice[HWEnc]", "steve: send successfully! frameLen = " + paramInt2 + ", type = " + paramInt1 + ", pkt cnt = " + i);
    }
  ...
  private void StopEncoder()
  {
    ...
    {
      Log.e("OpenVoice[HWEnc]", " error:" + localException.toString());
      AppMethodBeat.o(90803);
    }
  }
  ...
  private static boolean a(MediaCodecInfo paramMediaCodecInfo)
  {
    ...
    for (;;)
    {
      ...
      if (i < j)
      {
        ...
        {
          bool1 = true;
          Log.d("OpenVoice[HWEnc]", "steve : known H.264 HW encoder :".concat(String.valueOf(paramMediaCodecInfo)));
        }
      }
      else
      {
          ...
          if (str.startsWith(arrayOfString[i]))
          {
            ...
            try
            {
              ...
              for (;;)
              {
                ...
                bool2 = bool3;
                Log.d("OpenVoice[HWEnc]", "steve : [" + str + "] supported profiles:" + localCodecProfileLevel.profile + ", maxAllowedProfile: " + this.wUj + ", MIME:" + paramString);
                j += 1;
                bool1 = bool3;
              }
              i += 1;
    ...
    if (d.rb(23))
    {
      for (;;)
      {
        ...
        catch (Exception paramMediaCodecInfo)
        {
          ...
          int n;
          boolean bool3;
          Log.e("OpenVoice[HWEnc]", "trySetProfile error: " + paramMediaCodecInfo.getMessage());
          bool1 = bool2;
          continue;
          int j = 0;
          continue;
        ...
        Log.i("OpenVoice[HWEnc]", "steve : profile: " + m + ", level: " + n + ", maxProfile: " + paramInt + ", isRecognized:" + bool1);
        i += 1;
      }
      Log.i("OpenVoice[HWEnc]", "best profile: " + paramString.profile + ", best level: " + paramString.level);
      bool1 = bool2;
  ...
  private int drc()
  {
      ...
      if (localMediaCodecInfo.isEncoder())
      {
        ...
        if (j < arrayOfString.length) {
          if (arrayOfString[j].equalsIgnoreCase(str)) {
            Log.d("OpenVoice[HWEnc]", "steve : H.264 HW encoder found:".concat(String.valueOf(localMediaCodecInfo.getName())));
          }
        }
      }
    }
    ...
    label169:
    Log.i("OpenVoice[HWEnc]", "steve: found HW codec: " + localMediaCodecInfo.getName());
    ...
    for (this.wUi = this.mediaFormat.getInteger("profile");; this.wUi = 1)
    {
      ...
      try
      {
        ...
        Log.i("OpenVoice[HWEnc]", "steve: mediaFormat: " + this.mediaFormat + ", actProfile: " + this.wUi);
  ...
  public final boolean SetBitRate(int paramInt)
  {
    ...
    try
    {
      if (this.wUb != null)
      {
        ...
        paramInt *= 1000;
        Log.v("OpenVoice[HWEnc]", "steve: setRates: ".concat(String.valueOf(paramInt)));
    ...
    {
      Log.e("OpenVoice[HWEnc]", "steve: setRates failed:".concat(String.valueOf(localException)));
      AppMethodBeat.o(90805);
    }
    return false;
  }
  ...
  public final int d(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   9: iload_2
    //   10: aload_0
    //   11: getfield 160	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_CapW	I
    //   14: if_icmpne +11 -> 25
    //   17: iload_3
    //   18: aload_0
    //   19: getfield 162	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_CapH	I
    //   22: if_icmpeq +13 -> 35
    //   25: aload_0
    //   26: iload_2
    //   27: putfield 160	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_CapW	I
    //   30: aload_0
    //   31: iload_3
    //   32: putfield 162	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_CapH	I
    //   35: aload_0
    //   36: getfield 130	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUc	[B
    //   39: ifnonnull +22 -> 61
    //   42: aload_0
    //   43: aload_0
    //   44: getfield 160	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_CapW	I
    //   47: aload_0
    //   48: getfield 162	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_CapH	I
    //   51: imul
    //   52: iconst_3
    //   53: imul
    //   54: iconst_2
    //   55: idiv
    //   56: newarray byte
    //   58: putfield 130	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUc	[B
    //   61: ldc 212
    ...
    //   73: aload_0
    //   74: getfield 164	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_framerate	I
    ...
    //   86: aload_0
    //   87: getfield 166	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_br_kbps	I
    ...
    //   99: aload_0
    //   100: getfield 148	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUm	Lcom/tencent/mm/plugin/cloudvoip/cloudvoice/service/a;
    //   103: getfield 464	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/a:cSkipFlag	B
    //   106: ifne +1179 -> 1285
    //   109: aload_1
    //   110: aload_1
    //   111: arraylength
    //   112: aload_0
    //   113: getfield 160	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_CapW	I
    //   116: aload_0
    //   117: getfield 162	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_CapH	I
    //   120: iload 4
    //   122: aload_0
    //   123: getfield 130	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUc	[B
    //   126: aload_0
    //   127: getfield 160	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_CapW	I
    //   130: aload_0
    //   131: getfield 162	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_CapH	I
    //   134: invokestatic 468	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/m:videoHWProcess	([BIIII[BII)I
    //   137: pop
    //   138: aload_0
    //   139: getfield 130	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUc	[B
    //   142: astore_1
    //   143: invokestatic 472	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/m:dri	()Lcom/tencent/wxmm/v2conference;
    //   146: getfield 477	com/tencent/wxmm/v2conference:field_HWEncW	I
    //   149: istore_2
    //   150: invokestatic 472	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/m:dri	()Lcom/tencent/wxmm/v2conference;
    //   153: getfield 480	com/tencent/wxmm/v2conference:field_HWEncH	I
    //   156: istore_3
    //   157: aload_0
    //   158: getfield 156	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_width	I
    //   161: iload_2
    //   162: if_icmpne +18 -> 180
    //   165: aload_0
    //   166: getfield 158	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_height	I
    //   169: iload_3
    //   170: if_icmpne +10 -> 180
    //   173: aload_0
    //   174: getfield 210	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUb	Lcom/tencent/mm/compatible/deviceinfo/aa;
    ...
    //   212: aload_0
    //   213: getfield 156	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_width	I
    ...
    //   225: aload_0
    //   226: getfield 158	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_height	I
    ...
    //   238: aload_0
    //   239: iload_2
    //   240: putfield 156	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_width	I
    //   243: aload_0
    //   244: iload_3
    //   245: putfield 158	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_height	I
    //   248: aload_0
    //   249: aload_0
    //   250: getfield 156	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_width	I
    //   253: aload_0
    //   254: getfield 158	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_height	I
    //   257: imul
    //   258: iconst_3
    //   259: imul
    //   260: iconst_1
    //   261: ishr
    //   262: putfield 152	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:encLen	I
    //   265: aload_0
    //   266: invokespecial 488	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:drc	()I
    //   269: istore_2
    //   270: iload_2
    //   271: istore_3
    //   272: iload_2
    ...
    //   291: aload_0
    //   292: iconst_0
    //   293: putfield 150	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:isRuning	Z
    //   296: aload_0
    //   297: invokespecial 358	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:StopEncoder	()V
    //   300: aload_0
    //   301: getfield 205	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:outputStream	Ljava/io/BufferedOutputStream;
    //   304: ifnull +17 -> 321
    //   307: aload_0
    //   308: getfield 205	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:outputStream	Ljava/io/BufferedOutputStream;
    //   311: invokevirtual 493	java/io/BufferedOutputStream:flush	()V
    //   314: aload_0
    //   315: getfield 205	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:outputStream	Ljava/io/BufferedOutputStream;
    //   318: invokevirtual 496	java/io/BufferedOutputStream:close	()V
    //   321: aload_0
    //   322: getfield 498	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUg	Ljava/io/BufferedOutputStream;
    //   325: ifnull +17 -> 342
    //   328: aload_0
    //   329: getfield 498	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUg	Ljava/io/BufferedOutputStream;
    //   332: invokevirtual 493	java/io/BufferedOutputStream:flush	()V
    //   335: aload_0
    //   336: getfield 498	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUg	Ljava/io/BufferedOutputStream;
    //   339: invokevirtual 496	java/io/BufferedOutputStream:close	()V
    //   342: aload_0
    //   343: getfield 500	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUd	Landroid/media/MediaMuxer;
    //   346: ifnull +17 -> 363
    //   349: aload_0
    //   350: getfield 500	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUd	Landroid/media/MediaMuxer;
    //   353: invokevirtual 503	android/media/MediaMuxer:stop	()V
    //   356: aload_0
    //   357: getfield 500	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUd	Landroid/media/MediaMuxer;
    ...
    //   399: aload_0
    //   400: sipush 2003
    //   403: putfield 120	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUa	I
    //   406: aload_0
    //   407: getfield 120	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUa	I
    //   410: ineg
    //   411: istore_2
    //   412: goto -142 -> 270
    //   415: astore_1
    ...
    //   443: iconst_0
    //   444: istore_3
    //   445: getstatic 67	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:frameID	I
    //   448: bipush 100
    //   450: if_icmpgt +465 -> 915
    //   453: aload_0
    //   454: getfield 498	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUg	Ljava/io/BufferedOutputStream;
    //   457: ifnull +458 -> 915
    //   460: aload_0
    //   461: getfield 498	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUg	Ljava/io/BufferedOutputStream;
    //   464: aload_0
    //   465: getfield 130	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUc	[B
    //   468: iconst_0
    //   469: aload_0
    //   470: getfield 152	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:encLen	I
    ...
    //   479: ifnull +773 -> 1252
    //   482: aload_0
    //   483: getfield 210	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUb	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   486: ifnull +766 -> 1252
    //   489: aload_0
    //   490: iconst_0
    //   491: putfield 146	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUl	I
    ...
    //   511: aload_0
    //   512: getfield 152	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:encLen	I
    ...
    //   524: getstatic 67	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:frameID	I
    ...
    //   547: aload_0
    //   548: getfield 210	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUb	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   551: invokevirtual 528	com/tencent/mm/compatible/deviceinfo/aa:aPD	()[Ljava/nio/ByteBuffer;
    //   554: astore 9
    //   556: aload_0
    //   557: getfield 210	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUb	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   560: invokevirtual 531	com/tencent/mm/compatible/deviceinfo/aa:aPE	()[Ljava/nio/ByteBuffer;
    //   563: astore 8
    //   565: aload_0
    //   566: getfield 210	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUb	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   569: ldc2_w 532
    ...
    //   577: iflt +103 -> 680
    //   580: aload_0
    //   581: getfield 134	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:mGeneratedIdx	J
    //   584: lstore 6
    //   586: aload_0
    //   587: getfield 164	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:m_framerate	I
    //   590: bipush 15
    ...
    //   606: ifeq +12 -> 618
    //   609: aload_0
    //   610: getfield 136	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:nAO	J
    //   613: lconst_0
    //   614: lcmp
    //   615: ifne +305 -> 920
    //   618: aload_0
    //   619: ldc2_w 547
    //   622: putfield 136	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:nAO	J
    //   625: aload_0
    //   626: getfield 136	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:nAO	J
    //   629: lstore 6
    //   631: aload 9
    //   633: iload_3
    //   634: aaload
    ...
    //   646: iconst_0
    //   647: aload_0
    //   648: getfield 152	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:encLen	I
    //   651: invokevirtual 558	java/nio/ByteBuffer:put	([BII)Ljava/nio/ByteBuffer;
    //   654: pop
    //   655: aload_0
    //   656: getfield 210	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUb	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   659: iload_3
    //   660: aload_0
    //   661: getfield 152	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:encLen	I
    //   664: lload 6
    //   666: iconst_0
    //   667: invokevirtual 561	com/tencent/mm/compatible/deviceinfo/aa:a	(IIJI)V
    //   670: aload_0
    //   671: aload_0
    //   672: getfield 134	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:mGeneratedIdx	J
    //   675: lconst_1
    //   676: ladd
    //   677: putfield 134	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:mGeneratedIdx	J
    //   680: new 563	android/media/MediaCodec$BufferInfo
    //   683: dup
    //   684: invokespecial 564	android/media/MediaCodec$BufferInfo:<init>	()V
    //   687: astore_1
    //   688: aload_0
    //   689: getfield 210	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUb	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   692: aload_1
    //   693: aload_0
    //   694: getfield 126	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:TIMEOUT_USEC	I
    //   697: i2l
    ...
    //   718: ldc_w 570
    //   721: aload_0
    //   722: getfield 210	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUb	Lcom/tencent/mm/compatible/deviceinfo/aa;
    ...
    //   772: pop
    //   773: aload_0
    //   774: getfield 205	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:outputStream	Ljava/io/BufferedOutputStream;
    //   777: ifnull +16 -> 793
    //   780: aload_0
    //   781: getfield 205	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:outputStream	Ljava/io/BufferedOutputStream;
    //   784: aload 10
    //   786: iconst_0
    //   787: aload 10
    //   789: arraylength
    ...
    //   801: aload_0
    //   802: getfield 140	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUi	I
    //   805: iconst_1
    //   806: if_icmpeq +221 -> 1027
    //   809: aload_0
    //   810: getfield 138	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUh	Lcom/tencent/mm/plugin/voip/model/g;
    //   813: aload 10
    //   815: invokevirtual 588	com/tencent/mm/plugin/voip/model/g:cA	([B)Z
    //   818: ifeq +209 -> 1027
    //   821: aload_0
    //   822: aload_0
    //   823: getfield 138	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUh	Lcom/tencent/mm/plugin/voip/model/g;
    //   826: getfield 591	com/tencent/mm/plugin/voip/model/g:UwP	I
    //   829: putfield 144	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUk	I
    //   832: aload_0
    //   833: iconst_1
    //   834: putfield 142	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUj	I
    //   837: ldc 212
    ...
    //   849: aload_0
    //   850: getfield 142	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUj	I
    ...
    //   862: aload_0
    //   863: getfield 144	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUk	I
    ...
    //   875: aload_0
    //   876: invokespecial 488	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:drc	()I
    //   879: istore_2
    //   880: ldc_w 456
    ...
    //   920: aload_0
    //   921: aload_0
    //   922: getfield 136	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:nAO	J
    //   925: ldc_w 596
    //   928: iload 4
    //   930: idiv
    //   931: i2l
    //   932: ladd
    //   933: putfield 136	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:nAO	J
    //   936: goto -311 -> 625
    //   939: astore_1
    //   940: ldc 212
    ...
    //   964: aload_0
    //   965: sipush 2004
    //   968: putfield 120	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUa	I
    //   971: aload_0
    //   972: getfield 120	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUa	I
    //   975: ineg
    //   976: istore_2
    //   977: ldc_w 456
    ...
    //   1011: aload_0
    //   1012: sipush 2005
    //   1015: putfield 120	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUa	I
    //   1018: aload_0
    //   1019: getfield 120	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUa	I
    //   1022: ineg
    //   1023: istore_2
    //   1024: goto -144 -> 880
    //   1027: aload_0
    ...
    //   1034: aload 10
    //   1036: arraylength
    //   1037: invokespecial 600	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:E	([BII)V
    //   1040: aload_0
    //   1041: getfield 602	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUf	Z
    //   1044: ifeq +22 -> 1066
    //   1047: aload 9
    //   1049: ifnull +17 -> 1066
    //   1052: aload_0
    //   1053: getfield 500	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUd	Landroid/media/MediaMuxer;
    //   1056: aload_0
    //   1057: getfield 604	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUe	I
    //   1060: aload 9
    //   1062: aload_1
    ...
    //   1070: istore_3
    //   1071: getstatic 67	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:frameID	I
    //   1074: iconst_1
    //   1075: iadd
    //   1076: putstatic 67	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:frameID	I
    //   1079: aload_0
    //   1080: getfield 210	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUb	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   1083: iload 4
    //   1085: iconst_0
    //   1086: invokevirtual 612	com/tencent/mm/compatible/deviceinfo/aa:releaseOutputBuffer	(IZ)V
    //   1089: aload_0
    //   1090: getfield 210	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUb	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   1093: aload_1
    //   1094: aload_0
    //   1095: getfield 126	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:TIMEOUT_USEC	I
    //   1098: i2l
    ...
    //   1104: goto -361 -> 743
    //   1107: aload_0
    //   1108: getfield 140	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUi	I
    //   1111: iconst_1
    //   1112: if_icmpeq +124 -> 1236
    //   1115: aload_0
    //   1116: getfield 138	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUh	Lcom/tencent/mm/plugin/voip/model/g;
    //   1119: aload 10
    //   1121: invokevirtual 615	com/tencent/mm/plugin/voip/model/g:cB	([B)Z
    //   1124: ifeq +112 -> 1236
    //   1127: aload_0
    //   1128: aload_0
    //   1129: getfield 138	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUh	Lcom/tencent/mm/plugin/voip/model/g;
    //   1132: getfield 591	com/tencent/mm/plugin/voip/model/g:UwP	I
    //   1135: putfield 144	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUk	I
    //   1138: aload_0
    //   1139: iconst_1
    //   1140: putfield 142	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUj	I
    //   1143: ldc 212
    ...
    //   1155: aload_0
    //   1156: getfield 142	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUj	I
    ...
    //   1168: aload_0
    //   1169: getfield 144	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUk	I
    ...
    //   1181: aload_0
    //   1182: invokespecial 488	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:drc	()I
    //   1185: istore_2
    //   1186: ldc_w 456
    ...
    //   1220: aload_0
    //   1221: sipush 2005
    //   1224: putfield 120	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUa	I
    //   1227: aload_0
    //   1228: getfield 120	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUa	I
    //   1231: ineg
    //   1232: istore_2
    //   1233: goto -47 -> 1186
    //   1236: aload_0
    ...
    //   1243: aload 10
    //   1245: arraylength
    //   1246: invokespecial 600	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:E	([BII)V
    //   1249: goto -209 -> 1040
    //   1252: aload_0
    //   1253: getfield 146	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUl	I
    //   1256: istore_3
    //   1257: aload_0
    //   1258: iload_3
    //   1259: iconst_1
    //   1260: iadd
    //   1261: putfield 146	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUl	I
    //   1264: iload_3
    //   1265: iconst_5
    //   1266: if_icmple -289 -> 977
    //   1269: aload_0
    //   1270: sipush 2006
    //   1273: putfield 120	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUa	I
    //   1276: aload_0
    //   1277: getfield 120	com/tencent/mm/plugin/cloudvoip/cloudvoice/service/h:wUa	I
    //   1280: ineg
    //   1281: istore_2
    //   1282: goto -305 -> 977
    //   1285: iconst_0
 ...
 * Qualified Name:     com.tencent.mm.plugin.cloudvoip.cloudvoice.service.h
