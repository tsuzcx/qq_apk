  ...
  public final boolean equals(Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof g))
      {
        ...
        if ((this.uhB != paramObject.uhB) || (this.uhC != paramObject.uhC) || (this.uhD != paramObject.uhD) || (this.uhE != paramObject.uhE) || (this.uhF != paramObject.uhF)) {}
      }
    }
    else {
      return true;
