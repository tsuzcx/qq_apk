...
@Metadata(d1={""}, d2={"Lcom/tencent/mm/plugin/finder/live/component/msginterceptor/IFinderLiveAppMsgInterceptor;", "Lcom/tencent/mm/plugin/finder/live/component/msginterceptor/IAfterCheckInterceptor;", "liveContext", "Lcom/tencent/mm/plugin/finder/live/model/context/LiveBuContext;", "(Lcom/tencent/mm/plugin/finder/live/model/context/LiveBuContext;)V", "legalMsgType", "", "getLegalMsgType", "()[I", "legalMsgType$delegate", "Lkotlin/Lazy;", "getLiveContext", "()Lcom/tencent/mm/plugin/finder/live/model/context/LiveBuContext;", "dealWithMsgList", "", "msgList", "Ljava/util/LinkedList;", "Lcom/tencent/mm/protocal/protobuf/FinderLiveAppMsg;", "dealWithMsgListOnEmpty", "", "extraFilter", "appMsg", "intercept", "respWrapper", "Lcom/tencent/mm/plugin/finder/live/component/msginterceptor/FinderGetLiveMsgCgiResp$FinderGetLiveMsgRespWrapper;", "plugin-finder-live_release"}, k=1, mv={1, 5, 1}, xi=48)
  ...
  extends e
{
  ...
  public final boolean a(a.a parama)
  {
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (kotlin.a.k.contains((int[])this.CBL.getValue(), localbdm.msg_type))
        {
          s.s(localbdm, "it");
          if (!b(localbdm)) {}
        }
  ...
  public abstract void ap(LinkedList<bdm> paramLinkedList);
  
  public boolean b(bdm parambdm)
  {
    s.u(parambdm, "appMsg");
    return true;
  }
 ...
 * Qualified Name:     com.tencent.mm.plugin.finder.live.component.msginterceptor.f
