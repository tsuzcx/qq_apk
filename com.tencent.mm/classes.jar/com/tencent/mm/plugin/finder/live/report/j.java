...
public final class j
{
  ...
  public j(bip parambip, int paramInt, String paramString1, s.t paramt, String paramString2, boolean paramBoolean, String paramString3)
  {
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (this != paramObject)
    {
      if ((paramObject instanceof j))
      {
        ...
        if ((!p.h(this.yBd, paramObject.yBd)) || (this.pos != paramObject.pos) || (!p.h(this.feedId, paramObject.feedId)) || (!p.h(this.yAO, paramObject.yAO)) || (!p.h(this.yAP, paramObject.yAP)) || (this.yBc != paramObject.yBc) || (!p.h(this.nickName, paramObject.nickName))) {}
      }
    }
    else
    {
  ...
  public final String toString()
  {
    ...
    String str = "HellLiveMixSearchItem(contact=" + this.yBd + ", pos=" + this.pos + ", feedId=" + this.feedId + ", actionType=" + this.yAO + ", commentscene=" + this.yAP + ", liveStatus=" + this.yBc + ", nickName=" + this.nickName + ")";
