...
{
  FinderCreateContactUI$m(FinderCreateContactUI paramFinderCreateContactUI, Spannable paramSpannable, TextView paramTextView) {}
  ...
  public final boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      Log.i(FinderCreateContactUI.c(this.vJa), "touch " + paramMotionEvent.getX() + ", " + paramMotionEvent.getY() + ", ret:" + bool);
      AppMethodBeat.o(167173);
      return bool;
      if (j != 0) {
        break;
