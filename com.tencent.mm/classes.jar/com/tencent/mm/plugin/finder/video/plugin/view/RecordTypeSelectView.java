...
@l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/plugin/finder/video/plugin/view/RecordTypeSelectView;", "Landroid/widget/RelativeLayout;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "adapter", "Lcom/tencent/mm/plugin/finder/video/plugin/view/RecordTypeSelectView$RecordTypeAdapter;", "itemClickListener", "Lkotlin/Function1;", "", "Lkotlin/ParameterName;", "name", "pos", "", "layoutManager", "Lcom/tencent/mm/plugin/recordvideo/plugin/effect/FinderFilterLayoutManager;", "selectChangeListener", "position", "selectIndex", "selectTypeList", "Ljava/util/ArrayList;", "", "Lkotlin/collections/ArrayList;", "selectTypeView", "Landroid/support/v7/widget/RecyclerView;", "snapHelper", "Lcom/tencent/mm/plugin/finder/video/plugin/view/RecordTypeSelectView$RecordLinearSnapHelper;", "setData", "title", "setSelectChangeListener", "listener", "Companion", "RecordLinearSnapHelper", "RecordTypeAdapter", "plugin-finder_release"})
public final class RecordTypeSelectView
  extends RelativeLayout
{
  public static final RecordTypeSelectView.a tcn;
  private d.g.a.b<? super Integer, z> heP;
  private RecyclerView tcg;
  private ArrayList<String> tch;
  private int tci;
  private c tcj;
  private FinderFilterLayoutManager tck;
  private b tcl;
  private d.g.a.b<? super Integer, z> tcm;
  
  static
  {
    AppMethodBeat.i(205592);
    tcn = new RecordTypeSelectView.a((byte)0);
  ...
  public RecordTypeSelectView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.tcj = new c(paramContext);
    this.tck = new FinderFilterLayoutManager(paramContext);
    this.tcl = new b();
    this.heP = ((d.g.a.b)new d(this));
    ...
    this.tcg = ((RecyclerView)paramContext);
    this.tcg.setLayoutManager((RecyclerView.i)this.tck);
    this.tcg.setAdapter((RecyclerView.a)this.tcj);
    this.tcl.j(this.tcg);
  ...
  public final void setData(ArrayList<String> paramArrayList)
  {
    ...
    this.tch.addAll((Collection)paramArrayList);
    this.tcj.notifyDataSetChanged();
  ...
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/plugin/finder/video/plugin/view/RecordTypeSelectView$RecordLinearSnapHelper;", "Landroid/support/v7/widget/LinearSnapHelper;", "(Lcom/tencent/mm/plugin/finder/video/plugin/view/RecordTypeSelectView;)V", "calculateDistanceToFinalSnap", "", "layoutManager", "Landroid/support/v7/widget/RecyclerView$LayoutManager;", "targetView", "Landroid/view/View;", "findSnapView", "findTargetSnapPosition", "", "velocityX", "velocityY", "plugin-finder_release"})
    ...
    extends af
  {
    ...
    public final View a(RecyclerView.i parami)
    {
      ...
      if (localView != null)
      {
        ...
        ae.i("MicroMsg.RecordTypeSelectView", parami);
        i = RecordTypeSelectView.a(this.tco);
        if (localView == null) {
          break label155;
        }
        parami = localView.getTag();
      ...
      for (int i = parami.intValue();; i = 0)
      {
        ...
        parami = RecordTypeSelectView.b(this.tco);
        if (parami != null) {
          parami.invoke(Integer.valueOf(RecordTypeSelectView.a(this.tco)));
        }
        RecordTypeSelectView.c(this.tco).notifyDataSetChanged();
        do
        {
  ...
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/plugin/finder/video/plugin/view/RecordTypeSelectView$RecordTypeAdapter;", "Landroid/support/v7/widget/RecyclerView$Adapter;", "Landroid/support/v7/widget/RecyclerView$ViewHolder;", "context", "Landroid/content/Context;", "(Lcom/tencent/mm/plugin/finder/video/plugin/view/RecordTypeSelectView;Landroid/content/Context;)V", "getContext", "()Landroid/content/Context;", "setContext", "(Landroid/content/Context;)V", "getItemCount", "", "getSpecialMargin", "width", "onBindViewHolder", "", "viewHolder", "position", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "plugin-finder_release"})
    ...
    extends RecyclerView.a<RecyclerView.w>
  {
    ...
    private final int GB(int paramInt)
    {
      ...
      paramInt = (com.tencent.mm.cb.a.iu(this.context) - paramInt) / 2;
    ...
    public final void a(RecyclerView.w paramw, final int paramInt)
    {
      ...
      float f = paramw.getPaint().measureText((String)RecordTypeSelectView.d(RecordTypeSelectView.this).get(paramInt)) + com.tencent.mm.cb.a.ax(this.context, 2131165294);
      ae.d("MicroMsg.RecordTypeSelectView", "onBindViewHolder pos:" + paramInt + " width:" + f);
      ...
      implements View.OnClickListener
    {
      ...
      public final void onClick(View paramView)
      {
        ...
        localb.bd(paramView);
        com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/finder/video/plugin/view/RecordTypeSelectView$RecordTypeAdapter$onBindViewHolder$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahF());
        RecordTypeSelectView.e(this.tcp.tco).invoke(Integer.valueOf(paramInt));
    ...
    @l(gjZ={1, 1, 16}, gka={""}, gkb={"com/tencent/mm/plugin/finder/video/plugin/view/RecordTypeSelectView$RecordTypeAdapter$onCreateViewHolder$1", "Landroid/support/v7/widget/RecyclerView$ViewHolder;", "plugin-finder_release"})
