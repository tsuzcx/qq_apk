...
@l(gjZ={1, 1, 16}, gka={""}, gkb={"com/tencent/mm/plugin/finder/video/FinderVideoCore$onInitialize$2", "Lcom/tencent/mm/plugin/finder/life/UILifecycleObserver;", "onCreate", "", "var1", "Landroid/arch/lifecycle/LifecycleOwner;", "onDestroy", "onPause", "onResume", "onStart", "onStop", "plugin-finder_release"})
  ...
  implements UILifecycleObserver
{
  ...
  public final void onDestroy(LifecycleOwner paramLifecycleOwner)
  {
    ...
    p.h(paramLifecycleOwner, "var1");
    AppForegroundDelegate.cTA.b((o)this.tar);
  ...
  public final void onPause(LifecycleOwner paramLifecycleOwner)
  {
    ...
    p.h(paramLifecycleOwner, "var1");
    this.tar.cPa().fe((Context)this.sjk);
  ...
  public final void onResume(LifecycleOwner paramLifecycleOwner)
  {
    ...
    p.h(paramLifecycleOwner, "var1");
    c.h((a)new FinderVideoRecycler.q(this.tar.cPa(), (Context)this.sjk));
