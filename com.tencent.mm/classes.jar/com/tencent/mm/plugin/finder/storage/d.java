...
@l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/plugin/finder/storage/FinderConversationStorage;", "Lcom/tencent/mm/sdk/storage/MAutoStorage;", "Lcom/tencent/mm/plugin/finder/conv/FinderConversation;", "db", "Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;", "(Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;)V", "getDb", "()Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;", "clearUnreadCount", "", "sessionId", "", "genSceneTypeIndex", "", "get", "getGreetConvCount", "", "scene", "getTopPlaceCount", "type", "getUnreadCount", "isExit", "query", "", "offset", "nextCount", "", "queryLimit", "limitCount", "types", "replace", "item", "isNotify", "setEditing", "editing", "setTopPlace", "isTopPlace", "Companion", "plugin-finder_release"})
  ...
  extends j<com.tencent.mm.plugin.finder.conv.c>
{
  ...
  static
  {
    ...
    sIu = new a((byte)0);
    c.a locala = com.tencent.mm.plugin.finder.conv.c.rTB;
  ...
  private final List<com.tencent.mm.plugin.finder.conv.c> b(int paramInt1, int paramInt2, int[] paramArrayOfInt, int paramInt3)
  {
    ...
    //   3: ldc 168
    //   5: invokestatic 63	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   8: new 170	java/util/LinkedList
    //   11: dup
    //   12: invokespecial 172	java/util/LinkedList:<init>	()V
    //   15: astore 13
    //   17: aload_0
    //   18: iload 4
    //   20: invokevirtual 176	com/tencent/mm/plugin/finder/storage/d:FJ	(I)I
    //   23: istore 7
    //   25: aload_3
    //   26: ifnull +304 -> 330
    //   29: ldc 178
    ...
    //   68: new 128	java/lang/StringBuilder
    //   71: dup
    //   72: invokespecial 179	java/lang/StringBuilder:<init>	()V
    //   75: aload 10
    //   77: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   80: ldc 181
    //   82: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   85: iload 9
    //   87: invokevirtual 184	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   90: invokevirtual 143	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   93: astore 12
    //   95: aload 12
    //   97: astore 10
    //   99: iload 5
    ...
    //   111: dup
    //   112: invokespecial 179	java/lang/StringBuilder:<init>	()V
    //   115: aload 12
    //   117: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   120: ldc 186
    //   122: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   125: invokevirtual 143	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   128: astore 10
    //   130: iload 6
    //   132: iconst_1
    //   133: iadd
    ...
    //   145: aload 10
    //   147: ldc 186
    //   149: checkcast 188	java/lang/CharSequence
    //   152: invokestatic 194	d/n/n:c	(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   155: astore_3
    //   156: new 128	java/lang/StringBuilder
    //   159: dup
    //   160: invokespecial 179	java/lang/StringBuilder:<init>	()V
    //   163: aload_3
    ...
    //   172: invokevirtual 143	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   175: astore_3
    //   176: new 128	java/lang/StringBuilder
    //   179: dup
    //   180: ldc 198
    //   182: invokespecial 133	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   185: iload 4
    //   187: invokevirtual 184	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   190: ldc 200
    ...
    //   204: iload_2
    //   205: invokevirtual 184	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   208: ldc 204
    //   210: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   213: iload_1
    //   214: invokevirtual 184	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   217: invokevirtual 143	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   220: astore_3
    //   221: aload_0
    //   222: getfield 112	com/tencent/mm/plugin/finder/storage/d:db	Lcom/tencent/mm/sdk/e/e;
    //   225: aload_3
    //   226: aconst_null
    //   227: invokeinterface 147 3 0
    //   232: checkcast 149	java/io/Closeable
    //   235: astore 12
    //   237: aload 12
    //   239: checkcast 151	android/database/Cursor
    //   242: astore_3
    //   243: aload_3
    ...
    //   252: aload_3
    //   253: ldc 210
    //   255: invokestatic 156	d/g/b/p:g	(Ljava/lang/Object;Ljava/lang/String;)V
    //   258: aload_3
    //   259: invokeinterface 213 1 0
    //   264: ifne +105 -> 369
    //   267: new 71	com/tencent/mm/plugin/finder/conv/c
    //   270: dup
    //   271: invokespecial 214	com/tencent/mm/plugin/finder/conv/c:<init>	()V
    //   274: astore 10
    //   276: aload 10
    //   278: aload_3
    //   279: invokevirtual 218	com/tencent/mm/plugin/finder/conv/c:convertFrom	(Landroid/database/Cursor;)V
    //   282: aload 10
    //   284: invokevirtual 221	com/tencent/mm/plugin/finder/conv/c:prepare	()V
    //   287: aload 13
    //   289: aload 10
    //   291: invokevirtual 225	java/util/LinkedList:add	(Ljava/lang/Object;)Z
    //   294: pop
    //   295: aload_3
    ...
    //   305: astore 10
    //   307: ldc 168
    //   309: invokestatic 92	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   312: aload 10
    //   314: athrow
    //   315: astore_3
    //   316: aload 12
    //   318: aload 10
    //   320: invokestatic 165	d/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   323: ldc 168
    //   325: invokestatic 92	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   328: aload_3
    //   329: athrow
    //   330: new 128	java/lang/StringBuilder
    //   333: dup
    //   334: ldc 198
    //   336: invokespecial 133	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   339: iload 4
    //   341: invokevirtual 184	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   344: ldc 202
    //   346: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   349: iload_2
    //   350: invokevirtual 184	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   353: ldc 204
    ...
    //   362: invokevirtual 143	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   365: astore_3
    //   366: goto -145 -> 221
    //   369: getstatic 234	d/z:Nhr	Ld/z;
    //   372: astore_3
    //   373: aload 12
    //   375: aconst_null
    //   376: invokestatic 165	d/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   379: aload 13
    //   381: checkcast 236	java/util/List
    //   384: astore_3
    //   385: ldc 168
  ...
  public final int FJ(int paramInt)
  {
    ...
    //   7: aload_0
    //   8: getfield 112	com/tencent/mm/plugin/finder/storage/d:db	Lcom/tencent/mm/sdk/e/e;
    //   11: new 128	java/lang/StringBuilder
    //   14: dup
    //   15: ldc 243
    //   17: invokespecial 133	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   20: iload_1
    //   21: invokevirtual 184	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   24: ldc 245
    //   26: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   29: invokevirtual 143	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   32: aconst_null
    ...
    //   65: istore_1
    //   66: getstatic 234	d/z:Nhr	Ld/z;
    //   69: astore_2
    //   70: aload 4
    //   72: aconst_null
    //   73: invokestatic 165	d/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   76: ldc 241
    //   78: invokestatic 92	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   81: iload_1
    //   82: ireturn
    //   83: astore_3
    //   84: ldc 241
    //   86: invokestatic 92	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   89: aload_3
    //   90: athrow
    //   91: astore_2
    //   92: aload 4
    //   94: aload_3
    //   95: invokestatic 165	d/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   98: ldc 241
  ...
  public final List<com.tencent.mm.plugin.finder.conv.c> a(int paramInt1, int paramInt2, int[] paramArrayOfInt, int paramInt3)
  {
    ...
    ae.i("Finder.ConversationStorage", "[query] offset=" + paramInt1 + " pageCount=" + paramInt2 + " type=" + paramArrayOfInt + " list size=" + localList.size() + ", scene=" + paramInt3);
  ...
  public final boolean a(com.tencent.mm.plugin.finder.conv.c paramc, boolean paramBoolean)
  {
    ...
    {
      ae.i("Finder.ConversationStorage", (String)localObject1);
      if (paramc != null) {
        break;
      }
  ...
  public final int ajc(String paramString)
  {
    ...
    //   14: ldc_w 318
    //   17: aload_1
    //   18: invokestatic 322	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   21: invokevirtual 326	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   24: astore 4
    //   26: aload_0
    ...
    //   113: bipush 32
    //   115: invokevirtual 331	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   118: iload_2
    //   119: invokevirtual 184	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   122: invokevirtual 143	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   125: invokestatic 274	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   128: ldc_w 316
    //   131: invokestatic 92	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   134: iload_2
    //   135: ireturn
    //   136: astore_3
    //   137: ldc_w 316
    //   140: invokestatic 92	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   143: aload_3
    //   144: athrow
    //   145: astore_1
    //   146: aload 4
    //   148: aload_3
    //   149: invokestatic 165	d/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   152: ldc_w 316
    //   155: invokestatic 92	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   158: aload_1
    //   159: athrow
    //   160: astore_1
    //   161: goto -15 -> 146
  ...
  public final com.tencent.mm.plugin.finder.conv.c ajn(String paramString)
  {
  ...
  public final boolean ajp(String paramString)
  {
    ...
    com.tencent.mm.plugin.finder.conv.c localc = ajn(paramString);
    ...
    ae.i("Finder.ConversationStorage", "[clearUnreadCount] ret=" + bool + ' ' + i + " => " + localc.field_unReadCount + " sessionId=" + paramString);
    AppMethodBeat.o(204215);
    return bool;
  }
  ...
  public final boolean bh(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ae.i("Finder.ConversationStorage", "[setTopPlace] ret=" + bool2 + " isTopPlace=" + bool1 + " => " + localc.cAw() + " sessionId=" + paramString);
  ...
  public final int fQ(int paramInt1, int paramInt2)
  {
    ...
    //   113: istore_3
    //   114: getstatic 234	d/z:Nhr	Ld/z;
    //   117: astore 5
    //   119: aload 8
    //   121: aconst_null
    ...
    //   204: dup
    //   205: invokespecial 214	com/tencent/mm/plugin/finder/conv/c:<init>	()V
    //   208: aload 5
    //   210: invokevirtual 218	com/tencent/mm/plugin/finder/conv/c:convertFrom	(Landroid/database/Cursor;)V
    //   213: getstatic 234	d/z:Nhr	Ld/z;
    //   216: astore 5
    //   218: aload 7
    //   220: aconst_null
    //   221: invokestatic 165	d/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   224: ldc 253
    //   226: new 128	java/lang/StringBuilder
    //   229: dup
    //   230: ldc_w 397
    //   233: invokespecial 133	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   236: iload_2
    //   237: invokevirtual 184	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   240: ldc_w 399
    ...
    //   253: invokestatic 274	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   256: ldc_w 389
    //   259: invokestatic 92	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   262: iload_3
    //   263: ireturn
    //   264: ldc_w 401
    //   267: iload_1
    //   268: invokestatic 404	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   271: invokevirtual 326	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   274: astore 5
    //   276: goto -228 -> 48
    //   279: astore 6
    //   281: ldc_w 389
    //   284: invokestatic 92	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   287: aload 6
    //   289: athrow
    //   290: astore 5
    //   292: aload 8
    //   294: aload 6
    //   296: invokestatic 165	d/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   299: ldc_w 389
    //   302: invokestatic 92	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   305: aload 5
    //   307: athrow
    //   308: astore 6
    //   310: ldc_w 389
    //   313: invokestatic 92	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   316: aload 6
    //   318: athrow
    //   319: astore 5
    //   321: aload 7
    //   323: aload 6
    //   325: invokestatic 165	d/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   328: ldc_w 389
    //   331: invokestatic 92	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   334: aload 5
    //   336: athrow
    //   337: astore 5
    //   339: goto -18 -> 321
  ...
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/plugin/finder/storage/FinderConversationStorage$Companion;", "", "()V", "HOLDER_PLACE", "", "SET_TOP_PLACE", "SQL_CREATE", "", "", "kotlin.jvm.PlatformType", "getSQL_CREATE", "()[Ljava/lang/String;", "[Ljava/lang/String;", "TABLE", "TAG", "UNSET_TOP_PLACE", "plugin-finder_release"})
