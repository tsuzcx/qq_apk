...
@l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/finder/utils/GeoDegree;", "", "exif", "Landroid/media/ExifInterface;", "(Landroid/media/ExifInterface;)V", "Latitude", "", "getLatitude", "()Ljava/lang/Float;", "setLatitude", "(Ljava/lang/Float;)V", "Ljava/lang/Float;", "Longitude", "getLongitude", "setLongitude", "TAG", "", "isValid", "", "()Z", "setValid", "(Z)V", "convertToDegree", "stringDMS", "(Ljava/lang/String;)Ljava/lang/Float;", "toString", "plugin-finder_release"})
public final class ab
{
  ...
  public ab(ExifInterface paramExifInterface)
  {
    ...
    if ((localObject != null) && (str2 != null) && (str1 != null) && (paramExifInterface != null))
    {
      this.daZ = true;
      if (p.j(str2, "N")) {}
      for (this.vYk = awx((String)localObject); p.j(paramExifInterface, "E"); this.vYk = Float.valueOf(0.0F - ((Float)localObject).floatValue()))
      {
        this.vYl = awx(str1);
        AppMethodBeat.o(167973);
        return;
        localObject = awx((String)localObject);
        if (localObject == null) {
          p.hyc();
        }
      }
      paramExifInterface = awx(str1);
      if (paramExifInterface == null) {
        p.hyc();
      }
      this.vYl = Float.valueOf(0.0F - paramExifInterface.floatValue());
    }
    AppMethodBeat.o(167973);
  }
  
  private final Float awx(String paramString)
  {
