...
@Metadata(d1={""}, d2={"Lcom/tencent/mm/plugin/finder/utils/CheckDownloadUtil;", "", "()V", "TAG", "", "bytesToHexString", "bArray", "", "checkAppInstalled", "", "context", "Landroid/content/Context;", "packageName", "publicKey", "doDownloadApp", "", "downloadUrl", "plugin-finder-base_release"}, k=1, mv={1, 5, 1}, xi=48)
public final class e
{
  public static final e GfX;
  
  static
  {
    AppMethodBeat.i(333790);
    GfX = new e();
    AppMethodBeat.o(333790);
  }
  ...
  public static boolean D(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramContext)
      {
        ...
        int j;
        String str;
        Log.w("Finder.CheckDownloadUtil", "checkInstalled " + paramString1 + " Exception: %s", new Object[] { paramContext.getMessage() });
        bool1 = false;
        continue;
        int i = j;
        continue;
  ...
  {
    AppMethodBeat.i(333779);
    s.u(paramContext, "context");
    s.u(paramString, "downloadUrl");
    Log.i("Finder.CheckDownloadUtil", s.X("download SecondCut url ", paramString));
    Intent localIntent = new Intent();
    localIntent.putExtra("rawUrl", paramString);
    c.b(paramContext, "webview", ".ui.tools.WebViewUI", localIntent);
    AppMethodBeat.o(333779);
  }
}
