...
@d.l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lcom/tencent/mm/plugin/finder/view/FinderBottomDialogHelper$Companion;", "", "()V", "TAG", "", "showConfirmDialog", "Lcom/tencent/mm/ui/widget/dialog/MMBottomSheet;", "context", "Landroid/content/Context;", "title", "msg", "lok", "Landroid/content/DialogInterface$OnClickListener;", "lcancel", "ldismiss", "Landroid/content/DialogInterface$OnDismissListener;", "ok", "cancel", "plugin-finder_release"})
public final class b$a
{
  public static e a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, final DialogInterface.OnClickListener paramOnClickListener1, final DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnDismissListener paramOnDismissListener)
  {
    ...
    localTextView.setText((CharSequence)bs.nullAsNil(paramString2));
    ...
    implements e.b
  {
    ...
    public final void onDismiss()
    {
      ...
      DialogInterface.OnDismissListener localOnDismissListener = this.rVw;
    ...
    implements n.c
  {
    ...
    public final void onCreateMMMenu(com.tencent.mm.ui.base.l paraml)
    {
      ...
      paraml.clear();
      this.rVt.setFooterView(null);
      this.rVt.setFooterView((View)this.rVx);
 ...
 * Qualified Name:     com.tencent.mm.plugin.finder.view.b.a
