  ...
  implements View.OnTouchListener
{
  ...
  public final boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    a.b("com/tencent/mm/plugin/finder/view/FinderFeedExposeLayout$setSpanTouch$touchListener$1", "android/view/View$OnTouchListener", "onTouch", "(Landroid/view/View;Landroid/view/MotionEvent;)Z", this, ((b)localObject1).ahq());
    ...
    {
      ad.i(FinderFeedExposeLayout.b(this.sUc), "touch " + paramMotionEvent.getX() + ", " + paramMotionEvent.getY() + ", ret:" + bool);
