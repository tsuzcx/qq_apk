  ...
  extends a<bvz, View>
{
  ...
  public final void a(com.tencent.mm.ui.base.a.b paramb, int paramInt)
  {
    ...
    paramb.ep(getItemAtPosition(paramInt));
    p.h(paramb, "holder");
    ...
    do
    {
      ...
      return;
      localObject1 = (bvz)getItemAtPosition(paramInt);
      ...
      paramb = com.tencent.mm.plugin.finder.loader.i.srW;
      paramb = com.tencent.mm.plugin.finder.loader.i.cEn();
      p.g(localObject1, "item");
      Object localObject3 = paramb.bI(new g((bvz)localObject1, r.sJu));
      paramb = com.tencent.mm.plugin.finder.storage.b.sHP;
      ...
      for (paramb = new com.tencent.mm.loader.e.d(null, null, 3);; paramb = null)
      {
        ...
        paramb.a(com.tencent.mm.plugin.finder.loader.i.a(i.a.srX)).a((e)new b((bvz)localObject1)).c((ImageView)localObject2);
        AppMethodBeat.o(168451);
        return;
      }
    ...
    {
      ((FinderVideoLayout)localObject1).a(paramInt, (FinderItem)localObject2, paramb, this.dvm);
      AppMethodBeat.o(168451);
      return;
    }
  }
  ...
  public final int getItemViewType(int paramInt)
  {
    ...
    paramInt = ((bvz)this.cjg.get(paramInt)).mediaType;
  ...
  public final View m(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    if (paramInt == 4)
    {
      paramViewGroup = z.jV(paramViewGroup.getContext()).inflate(2131494065, paramViewGroup, false);
      ...
      com.tencent.mm.plugin.finder.video.i locali = this.rWB;
      if (locali == null) {
        p.gkB();
      }
    ...
    {
      paramViewGroup = z.jV(paramViewGroup.getContext()).inflate(2131494063, paramViewGroup, false);
  ...
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"<anonymous>", "", "url", "Lcom/tencent/mm/loader/model/data/DataItem;", "Lcom/tencent/mm/plugin/finder/loader/FinderLoaderData;", "kotlin.jvm.PlatformType", "view", "Lcom/tencent/mm/loader/impr/target/ViewWeakHolder;", "resource", "Landroid/graphics/Bitmap;", "onImageLoadComplete"})
