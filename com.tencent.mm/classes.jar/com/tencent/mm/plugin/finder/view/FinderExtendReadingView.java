  ...
  extends LinearLayout
{
  ...
  private final View sHn;
  public d.g.a.a<d.z> sTF;
  public d.g.a.b<? super String, d.z> sTG;
  public m<? super String, ? super String, d.z> sTH;
  private String sTI;
  private String sTJ;
  private final View sTK;
  private final View sTL;
  private final View sTM;
  private final View sTN;
  private final TextView sTO;
  public boolean sTP;
  ...
  public FinderExtendReadingView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    setOrientation(1);
    paramContext = com.tencent.mm.ui.z.jO(getContext()).inflate(2131494031, null);
  ...
  public final void cNj()
  {
    ...
    gC(this.sTJ, this.sTI);
    this.sTK.setOnClickListener((View.OnClickListener)new a(this));
    AppMethodBeat.o(168327);
  }
  
  public final void gB(String paramString1, final String paramString2)
  {
    ...
    this.sTO.setText((CharSequence)paramString1);
    this.sTN.setOnClickListener((View.OnClickListener)new b(this, paramString2));
    AppMethodBeat.o(168329);
  }
  
  public final void gC(final String paramString1, final String paramString2)
  {
    ...
    for (;;)
    {
      ...
      this.opV.setText((CharSequence)getContext().getString(2131759203, new Object[] { paramString1 }));
      this.opV.setOnClickListener((View.OnClickListener)new d(this, paramString1, paramString2));
      AppMethodBeat.o(168330);
      return;
  ...
  public final void setVerifyingState(final String paramString)
  {
    ...
    this.sHn.setVisibility(8);
    setLink(paramString);
    this.sTL.setOnClickListener((View.OnClickListener)new c(this, paramString));
    ...
    implements View.OnClickListener
  {
    ...
    public final void onClick(View paramView)
    {
      ...
      localb.bd(paramView);
      com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/finder/view/FinderExtendReadingView$setOriginState$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
      paramView = FinderExtendReadingView.a(this.sTQ);
      if (paramView != null) {
        paramView.invoke();
      }
    ...
    implements View.OnClickListener
  {
    ...
    public final void onClick(View paramView)
    {
      ...
      com.tencent.mm.hellhoundlib.b.b localb = new com.tencent.mm.hellhoundlib.b.b();
      localb.bd(paramView);
      com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/finder/view/FinderExtendReadingView$setSuccState$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
      paramView = FinderExtendReadingView.b(this.sTQ);
      if (paramView != null) {
    ...
    implements View.OnClickListener
  {
    ...
    public final void onClick(View paramView)
    {
      ...
      com.tencent.mm.hellhoundlib.b.b localb = new com.tencent.mm.hellhoundlib.b.b();
      localb.bd(paramView);
      com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/finder/view/FinderExtendReadingView$setVerifyingState$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
      paramView = FinderExtendReadingView.b(this.sTQ);
      if (paramView != null) {
    ...
    implements View.OnClickListener
  {
    ...
    public final void onClick(View paramView)
    {
      ...
      com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/finder/view/FinderExtendReadingView$updateVerifiedTips$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((com.tencent.mm.hellhoundlib.b.b)localObject).ahq());
      paramView = FinderExtendReadingView.c(this.sTQ);
      if (paramView != null)
      {
