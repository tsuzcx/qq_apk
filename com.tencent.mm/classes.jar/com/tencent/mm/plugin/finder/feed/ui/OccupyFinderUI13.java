...
@a(32)
@l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/finder/feed/ui/OccupyFinderUI13;", "Lcom/tencent/mm/plugin/finder/ui/MMFinderUI;", "()V", "TAG", "", "fragment", "Lcom/tencent/mm/plugin/finder/live/fragment/FinderLiveAnchorFragment;", "getFragment", "()Lcom/tencent/mm/plugin/finder/live/fragment/FinderLiveAnchorFragment;", "setFragment", "(Lcom/tencent/mm/plugin/finder/live/fragment/FinderLiveAnchorFragment;)V", "lastOrientation", "", "swipeBack", "", "getSwipeBack", "()Z", "setSwipeBack", "(Z)V", "commitFragment", "", "finish", "getLayoutId", "onConfigurationChanged", "newConfig", "Landroid/content/res/Configuration;", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "onDestroy", "onPause", "onResume", "onStart", "onStop", "onSwipeBack", "resetFragment", "plugin-finder_release"})
public final class OccupyFinderUI13
  extends MMFinderUI
{
  ...
  private final void dej()
  {
    ...
    FinderLiveAnchorFragment localFinderLiveAnchorFragment = this.ubq;
    if (localFinderLiveAnchorFragment != null) {
      localFinderLiveAnchorFragment.uhI = true;
    }
    localFinderLiveAnchorFragment = this.ubq;
    if (localFinderLiveAnchorFragment != null)
    {
      k localk = getSupportFragmentManager().beginTransaction();
      p.g(localk, "supportFragmentManager.beginTransaction()");
      localk.b(2131301711, (Fragment)localFinderLiveAnchorFragment);
      localk.commitNow();
 ...
 * Qualified Name:     com.tencent.mm.plugin.finder.feed.ui.OccupyFinderUI13
