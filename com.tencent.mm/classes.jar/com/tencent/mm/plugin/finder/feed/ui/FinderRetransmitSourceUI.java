...
@l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/plugin/finder/feed/ui/FinderRetransmitSourceUI;", "Lcom/tencent/mm/plugin/finder/feed/ui/FinderLoaderFeedUI;", "Lcom/tencent/mm/plugin/finder/feed/FinderRetransmitSourceContract$Loader;", "Lcom/tencent/mm/plugin/finder/feed/FinderRetransmitSourceContract$ViewCallback;", "Lcom/tencent/mm/plugin/finder/feed/FinderRetransmitSourceContract$Presenter;", "()V", "feedLoader", "presenter", "refObjectId", "", "refObjectNonceId", "", "targetNickname", "targetUsername", "viewCallback", "getLayoutId", "", "getModel", "getPresenter", "getViewCallback", "initOnCreate", "", "plugin-finder_release"})
  ...
  extends FinderLoaderFeedUI<FinderRetransmitSourceContract.Loader, FinderRetransmitSourceContract.c, FinderRetransmitSourceContract.a>
{
  ...
  private String snr;
  private FinderRetransmitSourceContract.a sqi;
  private FinderRetransmitSourceContract.c sqj;
  private FinderRetransmitSourceContract.Loader sqk;
  ...
  public final void initOnCreate()
  {
    ...
    if (localObject1 == null) {
      p.bdF("targetUsername");
    }
    if ((bu.isNullOrNil((String)localObject1)) || (this.refObjectId == 0L)) {
      finish();
    }
    this.sqi = new FinderRetransmitSourceContract.a((MMActivity)this);
    localObject1 = (MMActivity)this;
    Object localObject2 = this.sqi;
    if (localObject2 == null) {
      p.bdF("presenter");
    }
    this.sqj = new FinderRetransmitSourceContract.c((MMActivity)localObject1, (FinderRetransmitSourceContract.a)localObject2);
    localObject1 = this.rRD;
    if (localObject1 == null) {
      p.bdF("targetUsername");
    }
    ...
    e locale = e.slF;
    a locala = a.KEX;
    this.sqk = new FinderRetransmitSourceContract.Loader((String)localObject1, l, (String)localObject2, locale, ((FinderReporterUIC)a.s((MMActivity)this).get(FinderReporterUIC.class)).cQZ());
    localObject1 = (Context)getContext();
    localObject2 = this.snr;
    if (localObject2 == null) {
      p.bdF("targetNickname");
    }
