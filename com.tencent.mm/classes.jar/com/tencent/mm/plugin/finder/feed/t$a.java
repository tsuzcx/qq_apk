  ...
  extends ae.a
{
  ...
  public t$a(MMActivity paramMMActivity, int paramInt)
  {
    super(paramMMActivity);
    AppMethodBeat.i(362687);
    this.scene = paramInt;
    k localk = k.aeZF;
  ...
  public final void bXB()
  {
    ...
    AppMethodBeat.o(362704);
  }
  
  public final void onDetach()
  {
    AppMethodBeat.i(362724);
    this.Aye.onDetach();
    ...
    super.onDetach();
    AppMethodBeat.o(362724);
  }
  
  public final void requestRefresh()
  {
    AppMethodBeat.i(362697);
    BaseFinderFeedLoader localBaseFinderFeedLoader = this.ALH;
    if (localBaseFinderFeedLoader != null) {
      localBaseFinderFeedLoader.requestRefresh();
    }
    AppMethodBeat.o(362697);
  }
