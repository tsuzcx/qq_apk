  ...
  extends a.b
{
  ...
  public void cCw()
  {
    c.a(c.ale(), (b)new b(this));
  }
  
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"com/tencent/mm/plugin/finder/feed/FinderLoaderFeedUIContract$ViewCallback$actionCallback$1", "Lcom/tencent/mm/view/IViewActionCallback;", "onChanged", "", "onItemRangeChanged", "positionStart", "", "itemCount", "payload", "", "onItemRangeInserted", "onItemRangeMoved", "fromPosition", "toPosition", "onItemRangeRemoved", "onPreFinishLoadMore", "reason", "Lcom/tencent/mm/view/RefreshLoadMoreLayout$MoreReason;", "onPreFinishLoadMoreSmooth", "onPreFinishRefresh", "plugin-finder_release"})
    ...
    implements d
  {
    ...
    public final void au(int paramInt1, int paramInt2)
    {
      ...
      this.sfe.scj.au(this.sfe.rgr + paramInt1, paramInt2);
    ...
    public final void av(int paramInt1, int paramInt2)
    {
      ...
      this.sfe.scj.av(this.sfe.rgr + paramInt1, paramInt2);
    ...
    public final void f(int paramInt1, int paramInt2, Object paramObject)
    {
      ...
      this.sfe.scj.f(this.sfe.rgr + paramInt1, paramInt2, paramObject);
