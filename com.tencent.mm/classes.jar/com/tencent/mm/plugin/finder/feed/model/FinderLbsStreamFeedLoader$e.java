...
@d.l(gjZ={1, 1, 16}, gka={""}, gkb={"com/tencent/mm/plugin/finder/feed/model/FinderLbsStreamFeedLoader$createDataMerger$1", "Lcom/tencent/mm/plugin/finder/feed/model/internal/BaseFeedLoader$DefaultDataMerger;", "Lcom/tencent/mm/plugin/finder/feed/model/internal/BaseFeedLoader;", "Lcom/tencent/mm/plugin/finder/model/RVFeed;", "mergeRefresh", "", "response", "Lcom/tencent/mm/plugin/finder/feed/model/internal/IResponse;", "next", "Lkotlin/Function1;", "plugin-finder_release"})
public final class FinderLbsStreamFeedLoader$e
  extends BaseFeedLoader<am>.a
{
  FinderLbsStreamFeedLoader$e()
  {
  ...
  public final void mergeRefresh(final IResponse<am> paramIResponse, final b<? super IResponse<am>, z> paramb)
  {
    ...
    if ((paramIResponse.getErrType() == 0) && (paramIResponse.getErrCode() == 0))
    {
      ...
      ae.i(this.sky.getTAG(), "[onFetchRefreshDone]  reason=".concat(String.valueOf(localc)));
  ...
  static final class a
    ...
    implements a<z>
  {
    a(FinderLbsStreamFeedLoader.e parame, com.tencent.mm.plugin.finder.feed.model.internal.l paraml, RefreshLoadMoreLayout.c paramc, b paramb, IResponse paramIResponse)
    {
      super();
    }
  }
 ...
 * Qualified Name:     com.tencent.mm.plugin.finder.feed.model.FinderLbsStreamFeedLoader.e
