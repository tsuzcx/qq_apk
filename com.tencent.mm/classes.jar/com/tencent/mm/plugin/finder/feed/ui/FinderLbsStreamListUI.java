  ...
  extends FinderLoaderFeedUI<FinderLbsStreamFeedLoader, r.b, r.a>
{
  ...
  private r.a snM;
  private r.b snN;
  private FinderLbsStreamFeedLoader snO;
  private boolean snP;
  ...
  public final void initOnCreate()
  {
    ...
    for (localObject1 = (CharSequence)localObject1;; localObject1 = (CharSequence)"")
    {
      ...
      setMMTitle(getTitle());
      this.snP = getIntent().getBooleanExtra("KEY_SAVE_RESULT", false);
      this.snM = new r.a((MMActivity)this, this.scene);
      localObject1 = (MMActivity)this;
      Object localObject2 = this.snM;
      if (localObject2 == null) {
        d.g.b.p.bdF("presenter");
      }
      this.snN = new r.b((MMActivity)localObject1, (r.a)localObject2, this.scene);
      ...
      localObject1 = new FinderLbsStreamFeedLoader((String)localObject1, ((FinderReporterUIC)com.tencent.mm.ui.component.a.s((MMActivity)this).get(FinderReporterUIC.class)).cQZ());
      ...
      this.snO = ((FinderLbsStreamFeedLoader)localObject1);
  ...
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"com/tencent/mm/plugin/finder/feed/ui/FinderLbsStreamListUI$initOnCreate$1$1", "Lcom/tencent/mm/plugin/finder/feed/model/internal/IInitDone;", "call", "", "incrementCount", "", "plugin-finder_release"})
    ...
    implements h
  {
    ...
    public final void call(int paramInt)
    {
      ...
      Object localObject = FinderLbsStreamListUI.a(jdField_this).scj.getRecyclerView().getLayoutManager();
      if (localObject != null)
      {
        if (localObject == null)
        {
        ...
        ((FinderLayoutManager)localObject).ag(this.snQ.getInitPos(), 0);
        AppMethodBeat.o(203224);
        return;
      }
      AppMethodBeat.o(203224);
  ...
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"<anonymous>", "", "it", "Lcom/tencent/mm/plugin/finder/feed/model/internal/IResponse;", "Lcom/tencent/mm/plugin/finder/model/RVFeed;", "invoke", "com/tencent/mm/plugin/finder/feed/ui/FinderLbsStreamListUI$initOnCreate$1$2"})
