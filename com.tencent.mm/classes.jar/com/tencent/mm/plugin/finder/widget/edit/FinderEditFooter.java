...
{
  private static final int qZL = 101;
  private static final int qZM = 102;
  private static final int qZN = 201;
  private static final int qZO = 202;
  public static final b qZP;
  private String TAG;
  private ChatFooterPanel fSY;
  private ImageButton qZF;
  private ImageButton qZG;
  private int qZH;
  private a qZI;
  private ChatFooterPanel.a qZJ;
  private int qZK;
  ...
  private final void init()
  {
    ...
    this.qZF = ((ImageButton)localObject);
    ...
    ((ChatFooterPanel)localObject).exn();
  ...
  public final void setSmileyTextOperationListener(ChatFooterPanel.a parama)
  {
    ...
    this.qZJ = parama;
    ChatFooterPanel localChatFooterPanel = this.fSY;
  ...
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/finder/widget/edit/FinderEditFooter$AlignModeChangeListener;", "", "onAlignModeChange", "", "alignMode", "", "plugin-finder_release"})
  public static abstract interface a
  {
    public abstract void CZ(int paramInt);
  }
  
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/finder/widget/edit/FinderEditFooter$Companion;", "", "()V", "ALIGN_MODE_CENTER", "", "getALIGN_MODE_CENTER", "()I", "ALIGN_MODE_LEFT", "getALIGN_MODE_LEFT", "EDIT_MODE_EMOJI", "getEDIT_MODE_EMOJI", "EDIT_MODE_KEYBOARD", "getEDIT_MODE_KEYBOARD", "plugin-finder_release"})
    ...
    implements View.OnClickListener
  {
    ...
    public final void onClick(View paramView)
    {
      ...
      int i = FinderEditFooter.a(this.qZQ);
      paramView = FinderEditFooter.qZP;
      if (i == FinderEditFooter.ctp())
      {
        FinderEditFooter.b(this.qZQ);
        paramView = this.qZQ.getContext();
        if (paramView == null)
        {
        ...
        paramView = this.qZQ;
        localb = FinderEditFooter.qZP;
        FinderEditFooter.a(paramView, FinderEditFooter.cto());
        AppMethodBeat.o(168567);
        return;
      }
      paramView = this.qZQ.getContext();
      ...
      FinderEditFooter.c(this.qZQ);
      paramView = this.qZQ;
      FinderEditFooter.b localb = FinderEditFooter.qZP;
      FinderEditFooter.a(paramView, FinderEditFooter.ctp());
      AppMethodBeat.o(168567);
    }
  }
    ...
    implements View.OnClickListener
  {
    ...
    public final void onClick(View paramView)
    {
      ...
      FinderEditFooter.d(this.qZQ);
      paramView = FinderEditFooter.e(this.qZQ);
      if (paramView != null)
      {
        paramView.CZ(FinderEditFooter.f(this.qZQ));
