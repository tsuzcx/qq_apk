  ...
  extends b
{
  ...
  public g(FinderItem paramFinderItem, long paramLong, String paramString, boolean paramBoolean, dzp paramdzp)
  {
    AppMethodBeat.i(199540);
    this.qRJ = paramFinderItem;
    this.feedId = paramLong;
    this.objectNonceId = paramString;
    this.Lak = paramBoolean;
    this.scene = 2;
  ...
  public final void a(final e.b paramb)
  {
    ...
    k.h(paramb, "callback");
    super.a(paramb);
    new ah(this, this.contextObj).auK().g((a)new a(this, paramb));
  ...
  public final String abi()
  {
    ...
    String str = "id_" + this.feedId + '_' + this.Lak;
  ...
  public final String toString()
  {
    ...
    String str = "action_" + this.feedId + '_' + this.Lak + '_' + this.scene + '_' + this.qRH;
    AppMethodBeat.o(199537);
    return str;
  }
  
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"<anonymous>", "", "it", "Lcom/tencent/mm/modelbase/Cgi$CgiBack;", "Lcom/tencent/mm/protocal/protobuf/FinderFavResp;", "kotlin.jvm.PlatformType", "call"})
