...
@l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/finder/report/FinderSearchReportLogic;", "", "()V", "TAG", "", "getTAG", "()Ljava/lang/String;", "report18690", "", "requestId", "query", "requestType", "", "itemType", "itemId", "", "position", "scene", "report18691", "exposeItemMap", "Ljava/util/HashMap;", "Lcom/tencent/mm/plugin/finder/search/FinderExposeItem;", "Lkotlin/collections/HashMap;", "report19184", "plugin-finder_release"})
public final class d
{
  private static final String TAG = "Finder.FinderSearchReportLogic";
  public static final d qFr;
  ...
  public static void a(String paramString1, String paramString2, HashMap<String, a> paramHashMap, int paramInt)
  {
    ...
    for (paramInt = 0;; paramInt = 1)
    {
      ...
      e.vIY.kvStat(18691, paramString1);
      AppMethodBeat.o(166601);
      return;
    }
  }
  ...
  public static void b(String paramString1, String paramString2, int paramInt1, String paramString3, int paramInt2, int paramInt3)
  {
    ...
    e.vIY.kvStat(18690, paramString1);
  ...
  public static void cnB()
  {
    ...
    String str = ((c)g.ab(c.class)).cbk();
    str = str + ',' + 1;
    ad.i(TAG, "report19184 ".concat(String.valueOf(str)));
    e.vIY.kvStat(19184, str);
