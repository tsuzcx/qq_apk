  ...
  extends com.tencent.mm.loader.d.b<o>
{
  ...
  public final void a(a<o> parama, g paramg, b.b paramb)
  {
    ...
    try
    {
      ...
      if (paramg.djU() == x.vEn)
      {
        ...
        Log.i("Finder.ImageDownloader", "loadDataImp http " + paramg.djU() + " thumbUrl " + paramg.aBE() + " url " + paramg.getUrl());
        paramg = b.uIv;
        p.h(parama, "url");
        parama = b.aud(parama);
  ...
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/finder/loader/FinderImageDownloader$Companion;", "", "()V", "TAG", "", "plugin-finder_release"})
  public static final class a {}
  
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/finder/loader/FinderImageDownloader$DefaultHttpClientFactory;", "", "()V", "httpURLConnectionGet", "Lcom/tencent/mm/loader/model/HttpResponse;", "url", "", "openConnection", "Ljava/net/HttpURLConnection;", "plugin-finder_release"})
  public static final class b
  {
    public static final b uIv;
    ...
    public static HttpURLConnection aud(String paramString)
    {
