...
public final class i
{
  ...
  public static String Zq(String paramString)
  {
    ...
    paramString = (CharSequence)new d.n.k(qIv).c(paramString, "");
    paramString = new d.n.k(qIw).c(paramString, "");
    AppMethodBeat.o(166865);
    return paramString;
  }
  
  public static Spanned Zr(String paramString)
  {
    int i = 0;
    AppMethodBeat.i(166866);
    d.g.b.k.h(paramString, "origin");
    paramString = (CharSequence)paramString;
    paramString = (CharSequence)new d.n.k(qIv).c(paramString, qIx);
    paramString = Html.fromHtml(new d.n.k(qIw).c(paramString, qIy));
  ...
  public static Spanned a(String paramString, TextPaint paramTextPaint, int paramInt)
  {
    ...
    paramString = (CharSequence)paramString;
    paramString = (CharSequence)new d.n.k(qIv).c(paramString, qIx);
    Object localObject2 = Html.fromHtml(new d.n.k(qIw).c(paramString, qIy));
  ...
  public static void a(aik paramaik)
  {
    qIA = paramaik;
  }
  ...
  public static aik cov()
  {
    return qIA;
  }
  
  public static ConcurrentHashMap<Long, FinderItem> cow()
  {
    return qBG;
  }
}
