  ...
  implements a, MMActivity.a
{
  ...
  private void a(cvf paramcvf)
  {
    ...
    this.vkL = true;
    new e(paramcvf).b(new com.tencent.mm.vending.c.a() {});
    AppMethodBeat.o(64982);
  }
  ...
  public final void c(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == this.vkM)
    {
      if (paramInt2 == -1)
      {
        paramIntent = new Intent();
        this.vkJ.a(b.class, paramIntent, new d.a()
        {
          public final void g(int paramAnonymousInt, Intent paramAnonymousIntent)
          {
            AppMethodBeat.i(64977);
            paramAnonymousIntent = new Intent().putExtra("sendId", d.this.vkK.GZe);
            ...
            for (;;)
            {
              ...
              locald.vkL = false;
              if (locald.vkJ != null) {
                locald.vkJ.f(-1, paramAnonymousIntent);
              }
      ...
      ay(new Intent().putExtra("result_error_code", 10001).putExtra("result_error_msg", "fail:pay fail"));
    }
    AppMethodBeat.o(64984);
  }
  ...
  public final void c(int paramInt1, int paramInt2, String paramString, int paramInt3)
  {
    ...
    localcvf.duW = this.appId;
    localcvf.vjq = 1;
    localcvf.FpJ = paramInt2;
    localcvf.GZk = paramInt1;
    localcvf.vjr = paramString;
    localcvf.Hnm = paramInt3;
    a(localcvf);
    AppMethodBeat.o(64980);
  }
