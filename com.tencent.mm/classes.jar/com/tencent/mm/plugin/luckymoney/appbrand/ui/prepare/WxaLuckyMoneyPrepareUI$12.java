  ...
  implements View.OnTouchListener
{
  ...
  public final boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    a.b("com/tencent/mm/plugin/luckymoney/appbrand/ui/prepare/WxaLuckyMoneyPrepareUI$4", "android/view/View$OnTouchListener", "onTouch", "(Landroid/view/View;Landroid/view/MotionEvent;)Z", this, localb.ahF());
    if (paramMotionEvent.getAction() == 0)
    {
      this.vwG.hideTenpayKB();
      this.vwG.hideVKB();
    }
