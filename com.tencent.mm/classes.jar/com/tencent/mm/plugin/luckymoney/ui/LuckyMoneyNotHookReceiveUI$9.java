  ...
  public final void onSceneEnd(int paramInt1, int paramInt2, String paramString, m paramm)
  {
    ...
    if ((bo.hl(paramm.getType(), 697)) && ((paramm instanceof e)))
    {
      ...
      if ((paramInt1 == 0) && (paramInt2 == 0))
      {
        ...
        if ((paramString != null) && (paramString.wuz != null) && (paramString.wuz.size() > 0) && (bo.isEqual(((zg)paramString.wuz.get(0)).Md5, LuckyMoneyNotHookReceiveUI.a(this.ovv).Al()))) {
          LuckyMoneyNotHookReceiveUI.a(this.ovv, false);
        }
      }
    }
