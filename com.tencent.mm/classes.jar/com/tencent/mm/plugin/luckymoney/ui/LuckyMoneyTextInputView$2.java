  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bn(paramView);
    a.c("com/tencent/mm/plugin/luckymoney/ui/LuckyMoneyTextInputView$2", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aFi());
    if (LuckyMoneyTextInputView.b(this.ENZ) != null) {
      LuckyMoneyTextInputView.b(this.ENZ).onClick(paramView);
    }
