  ...
  implements MenuItem.OnMenuItemClickListener
{
  ...
  public final boolean onMenuItemClick(MenuItem paramMenuItem)
  {
    ...
    h.vKh.f(11701, new Object[] { Integer.valueOf(LuckyMoneyDetailUI.Ga(LuckyMoneyDetailUI.r(this.tme))), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(4) });
    Object localObject = new Intent();
    ((Intent)localObject).setClass(this.tme.getContext(), LuckyMoneyMyRecordUI.class);
    ((Intent)localObject).putExtra("key_type", 2);
    paramMenuItem = this.tme;
    localObject = new com.tencent.mm.hellhoundlib.b.a().bd(localObject);
    com.tencent.mm.hellhoundlib.a.a.a(paramMenuItem, ((com.tencent.mm.hellhoundlib.b.a)localObject).adn(), "com/tencent/mm/plugin/luckymoney/ui/LuckyMoneyDetailUI$4", "onMenuItemClick", "(Landroid/view/MenuItem;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
