  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    ((Intent)localObject).setClass(this.uyl.getContext(), LuckyMoneyIndexUI.class);
    ((Intent)localObject).addFlags(67108864);
    AppCompatActivity localAppCompatActivity = this.uyl.getContext();
    localObject = new com.tencent.mm.hellhoundlib.b.a().ba(localObject);
    com.tencent.mm.hellhoundlib.a.a.a(localAppCompatActivity, ((com.tencent.mm.hellhoundlib.b.a)localObject).aeD(), "com/tencent/mm/plugin/luckymoney/ui/LuckyMoneyPrepareUI$31", "run", "()V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
