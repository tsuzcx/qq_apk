  ...
  public final void onSceneEnd(int paramInt1, int paramInt2, String paramString, q paramq)
  {
    ...
    if ((Util.isEqual(paramq.getType(), 697)) && ((paramq instanceof e)))
    {
      ...
      if ((paramInt1 == 0) && (paramInt2 == 0))
      {
        ...
        if ((paramString != null) && (paramString.KOp != null) && (paramString.KOp.size() > 0) && (Util.isEqual(((ait)paramString.KOp.get(0)).Md5, LuckyMoneyDetailUI.n(this.zee).getMd5()))) {
          LuckyMoneyDetailUI.a(this.zee, false);
        }
      }
    }
