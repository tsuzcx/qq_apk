  ...
  implements d.a
{
  ...
  public final void ce(Object paramObject)
  {
    ...
    ae.i("MicroMsg.LuckyMoneyDetailUI", "fetch detail failed: %s", new Object[] { paramObject });
    if (paramObject != null) {
    ...
    label71:
    for (paramObject = paramObject.toString();; paramObject = this.vJe.getString(2131765420))
    {
      Toast.makeText(this.vJe.getContext(), paramObject, 1).show();
