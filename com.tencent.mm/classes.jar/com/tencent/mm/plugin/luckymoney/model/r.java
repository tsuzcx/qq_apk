...
public final class r
{
  ...
  public r()
  {
    ...
    Object localObject1 = (String)g.afB().afk().get(ae.a.Fnv, "");
  ...
  public final boolean afm(String paramString)
  {
    ...
    {
      if (!this.tel.contains(paramString))
      {
        StringBuilder localStringBuilder = new StringBuilder((String)g.afB().afk().get(ae.a.Fnv, ""));
        if (this.tel.size() <= 0)
        {
          localStringBuilder.append(paramString);
          g.afB().afk().set(ae.a.Fnv, localStringBuilder.toString());
          boolean bool = this.tel.add(paramString);
  ...
  public final void afn(String paramString)
  {
    ...
    synchronized (this.lock)
    {
      this.tel.remove(paramString);
      paramString = new StringBuilder();
      Iterator localIterator = this.tel.iterator();
    ...
    {
      g.afB().afk().set(ae.a.Fnv, paramString);
