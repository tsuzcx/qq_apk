  ...
  implements h.b
{
  ...
  private void a(View paramView, final int paramInt, final com.tencent.mm.plugin.record.ui.a.b paramb, final i parami, final w paramw, final boolean paramBoolean)
  {
    ...
    paramView.setOnLongClickListener(new View.OnLongClickListener()
    {
      public final boolean onLongClick(View paramAnonymousView)
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/record/ui/viewWrappers/TextViewWrapper$2", "android/view/View$OnLongClickListener", "onLongClick", "(Landroid/view/View;)Z", this, ((com.tencent.mm.hellhoundlib.b.b)localObject1).ahF());
        ...
        ((com.tencent.mm.ui.widget.b.a)localObject2).LwJ = true;
        ((com.tencent.mm.ui.widget.b.a)localObject2).LwH = new n.c()
        {
        ...
        ((com.tencent.mm.ui.widget.b.a)localObject2).LfT = new n.e()
        {
          public final void onMMMenuItemSelected(MenuItem paramAnonymous2MenuItem, int paramAnonymous2Int)
          {
            ...
            default: 
              ...
              return;
            case 0: 
              ((ClipboardManager)ak.getContext().getSystemService("clipboard")).setText(this.fTe.getText());
              h.cl(d.this.context, d.this.context.getString(2131755702));
              AppMethodBeat.o(28035);
              return;
            case 1: 
              paramAnonymous2MenuItem = d.2.this.xJe;
              paramAnonymous2Int = d.2.this.jgx;
              if (!d.2.this.xJf) {}
              for (;;)
              {
                paramAnonymous2MenuItem.aw(paramAnonymous2Int, bool1);
                AppMethodBeat.o(28035);
                return;
                bool1 = false;
              }
            case 2: 
              paramAnonymous2MenuItem = d.2.this.xJe;
              w localw = paramAnonymous2MenuItem.Oi(d.2.this.jgx);
              if (localw.status == 2)
              {
                localw.status = 0;
                paramAnonymous2MenuItem.ohU.notifyDataSetChanged();
              }
              AppMethodBeat.o(28035);
              return;
            }
        ...
        ((com.tencent.mm.ui.widget.b.a)localObject2).LhV = new PopupWindow.OnDismissListener()
        {
          public final void onDismiss()
          {
            ...
            TextView localTextView = this.fTe;
            if (d.2.this.xJf) {}
            for (String str = d.2.this.xIS.dtI.desc;; str = d.2.this.xJg.xHs)
            {
        ...
        for (;;)
        {
          ...
          return true;
          ((com.tencent.mm.ui.widget.b.a)localObject2).el(d.this.oef, d.this.oeg);
        }
      }
    });
  ...
  public final void a(View paramView, int paramInt, com.tencent.mm.plugin.record.ui.a.b paramb, Object paramObject)
  {
    ...
    localTextView1.setText(paramb.dtI.desc);
    k.o(localTextView1, 1);
