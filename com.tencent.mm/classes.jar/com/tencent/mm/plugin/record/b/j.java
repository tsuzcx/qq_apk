  ...
  extends i<com.tencent.mm.plugin.record.a.j>
{
  ...
  public j()
  {
    ...
    this.lPx = new g.a()
    {
      public final int a(String paramAnonymousString, int paramAnonymousInt, com.tencent.mm.i.c paramAnonymousc, final d paramAnonymousd, boolean paramAnonymousBoolean)
      {
        ...
        final com.tencent.mm.plugin.record.a.j localj = ((com.tencent.mm.plugin.record.a.a)h.ag(com.tencent.mm.plugin.record.a.a.class)).getRecordMsgCDNStorage().aVy(paramAnonymousString);
        if (localj == null)
        {
        ...
        if (paramAnonymousInt != 0)
        {
          ...
          if (-5103059 == paramAnonymousInt)
          {
            ...
            ((com.tencent.mm.plugin.record.a.a)h.ag(com.tencent.mm.plugin.record.a.a.class)).getRecordMsgCDNStorage().b(localj, new String[] { "localId" });
          }
        }
        for (;;)
        {
          ...
          for (boolean bool1 = true;; bool1 = false)
          {
            ...
            j.jK(localj.field_path + ".temp", localj.field_path);
            ((com.tencent.mm.plugin.record.a.a)h.ag(com.tencent.mm.plugin.record.a.a.class)).getRecordMsgCDNStorage().a(localj, new String[] { "localId" });
            break;
          }
          label539:
          ...
          if (paramAnonymousd.arK())
          {
            ...
            h.aHF().kcd.a(new e(paramAnonymousd.field_fileId, paramAnonymousd.field_filemd5, paramAnonymousd.field_mp4identifymd5, paramAnonymousd.field_filecrc, new e.a()
            {
              public final void aA(String paramAnonymous2String, int paramAnonymous2Int1, int paramAnonymous2Int2)
              {
  ...
  private void b(com.tencent.mm.plugin.record.a.j paramj, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      Log.d("MicroMsg.RecordMsgCDNService", "summersafecdn doJob, isSend:%B totallen:%d, aseKey:%s, url[%s], fullPath[%s], fileType[%d], enable_hitcheck[%b], force_aeskeycdn[%b]", new Object[] { Boolean.valueOf(localg.gbt), Integer.valueOf(localg.field_totalLen), localg.field_aesKey, localg.field_fileId, localg.field_fullpath, Integer.valueOf(localg.field_fileType), Boolean.valueOf(localg.field_enable_hitcheck), Boolean.valueOf(localg.field_force_aeskeycdn) });
      AppMethodBeat.o(9495);
      return;
      localg.gbt = false;
      ...
      if (!Util.isNullOrNil(paramj.field_tpdataurl))
      {
        ...
        localg.iUJ = paramj.field_tpdataurl;
        localg.field_fileId = "";
      }
  ...
  public final void b(com.tencent.mm.plugin.record.a.c paramc)
  {
    ...
    if ((paramc instanceof com.tencent.mm.plugin.record.a.j))
    {
      f.bkg().Vy(((com.tencent.mm.plugin.record.a.j)paramc).field_mediaId);
      boolean bool = ((com.tencent.mm.plugin.record.a.a)h.ag(com.tencent.mm.plugin.record.a.a.class)).getRecordMsgCDNStorage().a((com.tencent.mm.plugin.record.a.j)paramc, new String[] { "localId" });
      super.b(paramc);
  ...
  protected final List<com.tencent.mm.plugin.record.a.j> fuu()
  {
    AppMethodBeat.i(9494);
    List localList = ((com.tencent.mm.plugin.record.a.a)h.ag(com.tencent.mm.plugin.record.a.a.class)).getRecordMsgCDNStorage().fup();
