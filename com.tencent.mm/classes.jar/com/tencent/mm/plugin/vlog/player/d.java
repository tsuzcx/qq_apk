...
@l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/vlog/player/VLogImagePlayer;", "Lcom/tencent/mm/plugin/vlog/player/MaterialPlayer;", "texture", "", "drawWidth", "drawHeight", "material", "Lcom/tencent/mm/plugin/vlog/model/ImageMaterial;", "(IIILcom/tencent/mm/plugin/vlog/model/ImageMaterial;)V", "cacheBitmap", "Landroid/graphics/Bitmap;", "enableMute", "", "mute", "", "isMirror", "isOES", "pause", "playing", "pts", "", "updateTex", "prepare", "readyAt", "seekTime", "release", "resizeBitmap", "bitmap", "resume", "stop", "Companion", "plugin-vlog_release"})
  ...
  extends b
{
  ...
  public final void KV(long paramLong)
  {
    ...
    //   11: aload_0
    //   12: getfield 88	com/tencent/mm/plugin/vlog/player/b:GBl	Z
    //   15: ifeq +9 -> 24
    //   18: ldc 84
    ...
    //   24: aload_0
    //   25: iconst_1
    //   26: putfield 88	com/tencent/mm/plugin/vlog/player/b:GBl	Z
    //   29: getstatic 94	com/tencent/mm/plugin/vlog/player/e:GBH	Lcom/tencent/mm/plugin/vlog/player/e;
    //   32: astore 5
    //   34: aload_0
    //   35: getfield 98	com/tencent/mm/plugin/vlog/player/b:GBm	Lcom/tencent/mm/plugin/vlog/model/s;
    //   38: getfield 102	com/tencent/mm/plugin/vlog/model/s:path	Ljava/lang/String;
    //   41: invokestatic 106	com/tencent/mm/plugin/vlog/player/e:aUf	(Ljava/lang/String;)Lcom/tencent/mm/plugin/vlog/player/a;
    //   44: astore 5
    //   46: aload 5
    //   48: ifnull +123 -> 171
    //   51: ldc 108
    //   53: ldc 110
    //   55: invokestatic 115	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   58: aload_0
    //   59: aload 5
    ...
    //   76: aload_0
    //   77: aload 5
    //   79: getfield 129	com/tencent/mm/plugin/vlog/player/a:dYT	I
    //   82: putfield 130	com/tencent/mm/plugin/vlog/player/b:dYT	I
    //   85: iconst_1
    //   86: istore_3
    //   87: iload_3
    //   88: ifeq +88 -> 176
    //   91: aload_0
    //   92: getfield 132	com/tencent/mm/plugin/vlog/player/d:GBF	Landroid/graphics/Bitmap;
    //   95: ifnull +81 -> 176
    //   98: ldc 108
    //   100: ldc 134
    //   102: invokestatic 115	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   105: ldc 108
    ...
    //   116: aload_0
    //   117: getfield 144	com/tencent/mm/plugin/vlog/player/b:hEp	I
    ...
    //   128: aload_0
    //   129: getfield 156	com/tencent/mm/plugin/vlog/player/b:hEq	I
    ...
    //   162: invokestatic 115	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   165: ldc 84
    ...
    //   195: aload_0
    //   196: getfield 98	com/tencent/mm/plugin/vlog/player/b:GBm	Lcom/tencent/mm/plugin/vlog/model/s;
    //   199: getfield 102	com/tencent/mm/plugin/vlog/model/s:path	Ljava/lang/String;
    //   202: aload 5
    ...
    //   224: iload 4
    //   226: aload_0
    //   227: getfield 144	com/tencent/mm/plugin/vlog/player/b:hEp	I
    //   230: aload_0
    //   231: getfield 156	com/tencent/mm/plugin/vlog/player/b:hEq	I
    //   234: invokestatic 195	com/tencent/mm/sdk/platformtools/BitmapUtil:calculateInSampleSize	(IIII)I
    ...
    //   246: aload_0
    //   247: getfield 98	com/tencent/mm/plugin/vlog/player/b:GBm	Lcom/tencent/mm/plugin/vlog/model/s;
    //   250: getfield 102	com/tencent/mm/plugin/vlog/model/s:path	Ljava/lang/String;
    //   253: aload 5
    ...
    //   304: aload 8
    //   306: ifnonnull +6 -> 312
    //   309: invokestatic 227	kotlin/g/b/p:hyc	()V
    ...
    //   346: aload 5
    //   348: ifnonnull +6 -> 354
    //   351: invokestatic 227	kotlin/g/b/p:hyc	()V
    //   354: aload_0
    //   355: aload 5
    ...
    //   402: aload_0
    //   403: getfield 144	com/tencent/mm/plugin/vlog/player/b:hEp	I
    ...
    //   414: aload_0
    //   415: getfield 156	com/tencent/mm/plugin/vlog/player/b:hEq	I
    ...
    //   448: invokestatic 115	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   451: aload_0
    //   452: getfield 98	com/tencent/mm/plugin/vlog/player/b:GBm	Lcom/tencent/mm/plugin/vlog/model/s;
    //   455: getfield 102	com/tencent/mm/plugin/vlog/model/s:path	Ljava/lang/String;
    //   458: invokestatic 252	com/tencent/mm/vfs/s:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   461: astore 8
    //   463: aload 8
    //   465: ifnull +166 -> 631
    //   468: aload 8
    ...
    //   487: astore 8
    //   489: getstatic 267	kotlin/x:SXb	Lkotlin/x;
    //   492: astore 10
    //   494: aload 9
    //   496: aconst_null
    //   497: invokestatic 272	kotlin/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   500: aload 8
    //   502: astore 6
    //   504: aload 6
    //   506: ifnull +16 -> 522
    ...
    //   537: aload_0
    //   538: aload 5
    //   540: putfield 132	com/tencent/mm/plugin/vlog/player/d:GBF	Landroid/graphics/Bitmap;
    //   543: getstatic 94	com/tencent/mm/plugin/vlog/player/e:GBH	Lcom/tencent/mm/plugin/vlog/player/e;
    //   546: astore 5
    //   548: aload_0
    //   549: getfield 98	com/tencent/mm/plugin/vlog/player/b:GBm	Lcom/tencent/mm/plugin/vlog/model/s;
    //   552: getfield 102	com/tencent/mm/plugin/vlog/model/s:path	Ljava/lang/String;
    //   555: aload_0
    ...
    //   563: aload_0
    //   564: getfield 130	com/tencent/mm/plugin/vlog/player/b:dYT	I
    //   567: invokestatic 288	com/tencent/mm/plugin/vlog/player/e:p	(Ljava/lang/String;III)V
    //   570: ldc 108
    //   572: ldc_w 290
    //   575: invokestatic 170	java/lang/System:currentTimeMillis	()J
    //   578: lload_1
    //   579: lsub
    //   580: invokestatic 295	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   583: invokevirtual 299	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   586: invokestatic 115	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   589: ldc 84
    ...
    //   616: aload 9
    //   618: aload 6
    //   620: invokestatic 272	kotlin/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   623: ldc 84
    ...
    //   634: goto -130 -> 504
    //   637: aload 7
    //   639: invokevirtual 302	java/lang/Integer:intValue	()I
    //   642: bipush 6
    //   644: if_icmpne -117 -> 527
    //   647: aload_0
    //   648: iconst_3
    //   649: putfield 130	com/tencent/mm/plugin/vlog/player/b:dYT	I
    //   652: ldc 108
    //   654: ldc_w 304
    //   657: invokestatic 115	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   660: goto -123 -> 537
    //   663: aload 7
    //   665: invokevirtual 302	java/lang/Integer:intValue	()I
    //   668: iconst_3
    //   669: if_icmpne -137 -> 532
    //   672: aload_0
    //   673: iconst_2
    //   674: putfield 130	com/tencent/mm/plugin/vlog/player/b:dYT	I
    //   677: ldc 108
    //   679: ldc_w 306
    //   682: invokestatic 115	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   685: goto -148 -> 537
    //   688: aload 7
    //   690: invokevirtual 302	java/lang/Integer:intValue	()I
    //   693: bipush 8
    //   695: if_icmpne -158 -> 537
    //   698: aload_0
    //   699: iconst_1
    //   700: putfield 130	com/tencent/mm/plugin/vlog/player/b:dYT	I
    //   703: ldc 108
    //   705: ldc_w 308
    //   708: invokestatic 115	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   711: goto -174 -> 537
    //   714: astore 5
    //   716: goto -100 -> 616
  ...
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/vlog/player/VLogImagePlayer$Companion;", "", "()V", "TAG", "", "plugin-vlog_release"})
