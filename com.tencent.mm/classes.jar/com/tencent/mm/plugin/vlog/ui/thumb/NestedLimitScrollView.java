  ...
  implements n
{
  ...
  public final void a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    if (getScrollX() + paramInt3 > this.GPQ)
    {
      setScrollX(this.GPQ);
      AppMethodBeat.o(192139);
      return;
    }
    if (getScrollX() + paramInt3 < -this.GPP)
    {
      setScrollX(-this.GPP);
      AppMethodBeat.o(192139);
      return;
