...
{
  private static final String[] rFE = { "A53", "A53m", "A53t", "A33m", "A33", "A33t", "R7Plust", "R7Plus", "A59t", "A59s", "A59m", "R9PlustA", "R9PlusmA", "R9PlustmA", "R9tm", "R9m", "R9km", "A37t", "A37m", "R7sPlus", "R7Plusm", "A53", "A51kc", "A51", "A30" };
  
  public static final boolean e(g paramg)
  {
    AppMethodBeat.i(127581);
    int i;
    if (((Build.VERSION.SDK_INT == 21) || (Build.VERSION.SDK_INT == 22)) && (bt.bI(Build.MANUFACTURER, "").toLowerCase().contains("oppo".toLowerCase())))
    {
      String[] arrayOfString = rFE;
