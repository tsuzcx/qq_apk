  ...
  extends WalletBaseUI
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (localIntent != null)
    {
      this.zNS = localIntent.getStringExtra("packageExt");
      if (!bt.isNullOrNil(this.zNS))
      {
        paramBundle = this.zNS;
        Object localObject2;
        ...
        paramBundle = null;
        this.zNU = paramBundle;
        if ((this.zNU.containsKey("bank_type")) && (this.zNU.containsKey("bind_serial")))
        {
          paramBundle = s.ebZ();
          localObject2 = (String)this.zNU.get("bind_serial");
          ...
          localIntent.putExtra("key_bankcard", this.zNT);
        ...
        ad.e("MicorMsg.WalletUnbindBankCardProxyUI", "jsapi param:package error.package==" + this.zNS);
        setResult(1);
        finish();
        AppMethodBeat.o(69175);
        return;
