  ...
  extends m
{
  ...
  public t(String paramString1, int paramInt, String paramString2)
  {
    ...
    this.BkU = -1;
    this.dtT = "";
    this.BkR = paramString1;
    this.BkS = paramInt;
    this.dAC = paramString2;
  ...
  public final void onGYNetEnd(int paramInt, String paramString, JSONObject paramJSONObject)
  {
    ...
    ac.i("MicroMsg.NetSceneVerifyUserRealNameInfo", "onGYNetEnd, errCode: %s, errMsg: %s, json: %s", new Object[] { Integer.valueOf(paramInt), paramString, paramJSONObject });
    if (paramInt == 0)
    {
      paramJSONObject.optString("retcode");
      paramJSONObject.optString("retmsg");
      this.BkT = paramJSONObject.optInt("is_support_face", 0);
      this.scene = paramJSONObject.optInt("scene", 0);
      this.packageName = paramJSONObject.optString("package");
      this.BkU = paramJSONObject.optInt("is_need_cert");
