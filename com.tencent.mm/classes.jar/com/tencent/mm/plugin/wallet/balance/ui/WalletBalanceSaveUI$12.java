  ...
  implements TextView.OnEditorActionListener
{
  ...
  public final boolean onEditorAction(TextView paramTextView, int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    ae.d("MicroMsg.WalletBalanceSaveUI", "on action key: %s, %s, %s", new Object[] { Integer.valueOf(paramInt), Integer.valueOf(paramKeyEvent.getKeyCode()), Integer.valueOf(paramKeyEvent.getAction()) });
