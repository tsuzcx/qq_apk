  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    localb.bd(paramView);
    com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/wallet/balance/ui/WalletBalanceManagerUI$5", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
    s.eDp();
    paramView = s.eDq().eGw();
    if ((paramView == null) || (paramView.size() == 0))
    {
      ad.i("MicroMsg.WalletBalanceManagerUI", "mBankcardList is empty, do bind card to fetch");
      WalletBalanceManagerUI.d(this.CzL);
    }
    for (;;)
    {
      ...
      com.tencent.mm.wallet_core.a.a(this.CzL, com.tencent.mm.plugin.wallet.balance.b.class, null, null);
      e.agr(15);
    }
  }
}
