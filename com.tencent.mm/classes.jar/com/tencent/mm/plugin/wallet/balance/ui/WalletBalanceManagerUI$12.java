  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    localb.bn(paramView);
    com.tencent.mm.hellhoundlib.a.a.c("com/tencent/mm/plugin/wallet/balance/ui/WalletBalanceManagerUI$5", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aFi());
    s.gGL();
    paramView = s.gGM().gKm();
    if ((paramView == null) || (paramView.size() == 0))
    {
      Log.i("MicroMsg.WalletBalanceManagerUI", "mBankcardList is empty, do bind card to fetch");
      WalletBalanceManagerUI.d(this.OnZ);
    }
    for (;;)
    {
      ...
      com.tencent.mm.wallet_core.a.a(this.OnZ, com.tencent.mm.plugin.wallet.balance.b.class, null, null);
      g.azK(15);
    }
  }
}
