  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bd(paramView);
    a.b("com/tencent/mm/plugin/wallet/balance/ui/lqt/WalletLqtSaveFetchUI$16", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahF());
    if (!WalletLqtSaveFetchUI.q(this.CWq).isChecked()) {}
    for (boolean bool = true;; bool = false)
    {
      WalletLqtSaveFetchUI.q(this.CWq).setChecked(bool);
