  ...
  extends WalletBaseUI
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.BiQ = getIntent().getStringExtra("INTENT_PAYFEE");
    ...
    for (;;)
    {
      ...
      try
      {
        this.tDa.parseFrom(paramBundle);
        ac.i("MicroMsg.WalletPayCustomUI", "mTokeMess packageex:%s busi_id:%s sign:%s can_use_touch %s mPayFee %s mTitle %s", new Object[] { this.tDa.FQT, this.tDa.ELF, this.tDa.sign, Boolean.valueOf(this.BiR), this.BiQ, this.mTitle });
        this.BiP = r.a(this, this.mTitle, this.BiQ, "", this.BiR, new r.b()new DialogInterface.OnCancelListener
        {
          public final void h(String paramAnonymousString1, boolean paramAnonymousBoolean, String paramAnonymousString2)
          {
            ...
            int j = WalletPayCustomUI.a(WalletPayCustomUI.this).FQU;
            String str1 = WalletPayCustomUI.a(WalletPayCustomUI.this).FQT;
            String str2 = WalletPayCustomUI.a(WalletPayCustomUI.this).sign;
            String str3 = WalletPayCustomUI.a(WalletPayCustomUI.this).ofa;
            String str4 = WalletPayCustomUI.a(WalletPayCustomUI.this).ELF;
      ...
      catch (Exception paramBundle)
      {
        for (;;)
        {
          ac.printErrStackTrace("MicroMsg.WalletPayCustomUI", paramBundle, "", new Object[0]);
        }
      }
    }
  }
  ...
  public boolean onSceneEnd(int paramInt1, int paramInt2, String paramString, n paramn)
  {
    ...
    ac.i("MicroMsg.WalletPayCustomUI", "errorType %s errCode %s, errmsg %s, scene %s", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), paramString, paramn });
    if ((paramn instanceof ab))
    {
      if ((paramInt1 == 0) && (paramInt2 == 0))
      {
        ...
        paramn = new Intent();
        paramn.putExtra("INTENT_RESULT_TOKEN", paramString.Bpa);
