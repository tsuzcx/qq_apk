...
public final class b
  extends j
{
  public com.tencent.mm.bv.b jxj;
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.jxj == null) {
        throw new d.a.a.b("Not all required fields were included: AesSessionKey");
      }
      if (this.jxC != null)
      {
    ...
    for (paramInt = d.a.a.a.gA(1, this.jxC.btq()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.jxj != null) {
        i = paramInt + d.a.a.a.a(2, this.jxj);
      }
      return i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localb.jxC = ((e)localObject1);
            paramInt += 1;
          }
        }
        localb.jxj = ((d.a.a.a.a)localObject1).cUs();
        return 0;
      }
      return -1;
    }
