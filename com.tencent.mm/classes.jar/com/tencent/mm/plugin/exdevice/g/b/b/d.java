  ...
  extends j<com.tencent.mm.plugin.exdevice.g.b.a.d>
{
  ...
  private boolean c(com.tencent.mm.plugin.exdevice.g.b.a.d paramd, boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      insert(paramd);
      com.tencent.mm.sdk.platformtools.ad.d("MicroMsg.ExdeviceRankInfoStg", "hy: insert success");
      if (paramBoolean) {
        com.tencent.mm.plugin.exdevice.model.ad.bZP().a("HardDeviceRankInfo", new com.tencent.mm.plugin.exdevice.g.b.d(paramd.field_rankID, paramd.field_appusername, paramd.field_username));
      }
  ...
  public final com.tencent.mm.plugin.exdevice.g.b.a.d a(com.tencent.mm.plugin.exdevice.g.b.d paramd)
  {
    ...
    localObject2 = this.db.a((String)localObject2, new String[] { bt.by(paramd.oYm, ""), bt.by(paramd.username, "") }, 2);
  ...
  public final boolean b(com.tencent.mm.plugin.exdevice.g.b.a.d paramd, boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      com.tencent.mm.sdk.platformtools.ad.d("MicroMsg.ExdeviceRankInfoStg", "hy: update success");
      if (paramBoolean) {
        com.tencent.mm.plugin.exdevice.model.ad.bZP().a("HardDeviceRankInfo", new com.tencent.mm.plugin.exdevice.g.b.d(paramd.field_rankID, paramd.field_appusername, paramd.field_username));
      }
  ...
  public final void f(String paramString, ArrayList<com.tencent.mm.plugin.exdevice.g.b.a.d> paramArrayList)
  {
    ...
    if ((bt.isNullOrNil(paramString)) || (paramArrayList == null))
    {
      com.tencent.mm.sdk.platformtools.ad.w("MicroMsg.ExdeviceRankInfoStg", "insertOrUpdateRankInfo failed, rank id is null or nil or data is null.");
      AppMethodBeat.o(23578);
      return;
    }
    com.tencent.mm.sdk.platformtools.ad.i("MicroMsg.ExdeviceRankInfoStg", "insertOrUpdateRankInfo, rankId(%s) , size(%d).", new Object[] { paramString, Integer.valueOf(paramArrayList.size()) });
    int i = 0;
    ...
    com.tencent.mm.plugin.exdevice.model.ad.bZP().a("HardDeviceRankInfo", new com.tencent.mm.plugin.exdevice.g.b.d(paramString, null, null));
    AppMethodBeat.o(23578);
  }
}
