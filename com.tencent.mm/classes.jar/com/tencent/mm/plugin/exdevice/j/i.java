  ...
  extends af
{
  ...
  public final boolean a(m paramm, d paramd)
  {
    ...
    if (!u.dak().Jq(this.vkt.smk))
    {
      Log.w("MicroMsg.exdevice.MMSwitchBackGroudTaskExcuter", "push switch backgroud event to device before it do auth, device id = %d", new Object[] { Long.valueOf(this.vkt.smk) });
      AppMethodBeat.o(23808);
      return true;
    }
    this.vkr = new a(this.vkt, paramd);
