  ...
  implements f
{
  ...
  private int pFB = -1;
  private String qbM = null;
  private String qbN = null;
  ...
  public final boolean a(m paramm, d paramd)
  {
    ...
    ad.i("MicroMsg.exdevice.MMWifiStatusSubscribeTaskExcuter", "execute MMWifiStatusSubscribeTaskExcuter. brandName=" + this.qbM + ",deviceType=" + this.mDeviceType + ",deviceId=" + this.qbN + ",reqType=" + this.pFB);
    ba.aiU().a(1090, this);
    paramm = new s(this.qbM, this.mDeviceType, this.qbN, this.pFB);
    ba.aiU().a(paramm, 0);
