  ...
  implements k
{
  ...
  public t(String paramString1, String paramString2, String paramString3)
  {
    ...
    ((b.a)localObject).hvt = new csm();
    ((b.a)localObject).hvu = new csn();
    ((b.a)localObject).uri = "/cgi-bin/mmoc-bin/hardware/searchbleharddevice";
    ((b.a)localObject).funcId = 1706;
    ((b.a)localObject).reqCmdId = 0;
    ((b.a)localObject).respCmdId = 0;
    this.rr = ((b.a)localObject).aAz();
    localObject = (csm)this.rr.hvr.hvw;
    ((csm)localObject).mac = paramString1;
    paramString1 = paramString2;
    if (paramString2 == null) {
      paramString1 = "";
    }
    ((csm)localObject).userName = paramString1;
    paramString1 = paramString3;
    if (paramString3 == null) {
      paramString1 = "";
    }
    ((csm)localObject).category = paramString1;
    AppMethodBeat.o(23407);
  }
  
  public final csn cgL()
  {
    return (csn)this.rr.hvs.hvw;
  }
  ...
  public final void onGYNetEnd(int paramInt1, int paramInt2, int paramInt3, String paramString, q paramq, byte[] paramArrayOfByte)
  {
    ...
    ac.i("MicroMsg.exdevice.NetSceneSearchBLEHardDevice", "onGYNetEnd netId = " + paramInt1 + " errType = " + paramInt2 + " errCode = " + paramInt3 + paramString);
