...
{
  private static j vfW;
  private SparseArray<List<a>> vfX;
  
  private j()
  {
    AppMethodBeat.i(23375);
    this.vfX = new SparseArray();
  ...
  public final boolean a(int paramInt, a parama)
  {
    ...
    List localList = (List)this.vfX.get(paramInt);
    Object localObject;
    if (localList == null)
    {
      localObject = new LinkedList();
      this.vfX.put(paramInt, localObject);
    }
    do
    {
