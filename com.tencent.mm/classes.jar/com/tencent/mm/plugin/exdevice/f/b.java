...
public final class b
  extends j
{
  public com.tencent.mm.bx.b oXt;
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = f.a.a.a.kW(1, this.oXM.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.oXt != null) {
        i = paramInt + f.a.a.b.b.a.b(2, this.oXt);
      }
      AppMethodBeat.o(23486);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localb.oXM = ((e)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(23486);
          return 0;
        }
        localb.oXt = ((f.a.a.a.a)localObject1).KhF.fMu();
        AppMethodBeat.o(23486);
        return 0;
      }
      AppMethodBeat.o(23486);
