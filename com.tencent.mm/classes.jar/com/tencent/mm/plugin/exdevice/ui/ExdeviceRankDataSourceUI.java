  ...
  implements f
{
  ...
  public void initView()
  {
    ...
    this.qsY = new b();
    this.mListView.setAdapter(this.qsY);
    ...
    localView2.setOnClickListener(new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/exdevice/ui/ExdeviceRankDataSourceUI$2", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahF());
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    ae.d("MicroMsg.ExdeviceRankDataSourceUI", "onActivityResult, reqCode(%s), resultCode(%s)", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
    if ((paramInt1 == 1) && (paramInt2 == -1) && (paramIntent != null))
    {
      ...
      if (l == 0L)
      {
        ae.e("MicroMsg.ExdeviceRankDataSourceUI", "onActivityResult, mac is nil.");
        AppMethodBeat.o(24200);
        return;
      }
      paramIntent = com.tencent.mm.plugin.exdevice.k.b.vf(l);
      if (paramIntent == null)
      {
        ae.e("MicroMsg.ExdeviceRankDataSourceUI", "invalid mac(%s).", new Object[] { paramIntent });
        AppMethodBeat.o(24200);
        return;
      }
      if (this.qsY.adL(paramIntent) != null)
      {
        ae.i("MicroMsg.ExdeviceRankDataSourceUI", "The device has been added, now switch it to be the main device.");
        AppMethodBeat.o(24200);
        return;
      }
      paramIntent = ad.cmJ().ve(l);
      if (paramIntent == null)
      {
        ae.w("MicroMsg.ExdeviceRankDataSourceUI", "hard device info is null.(mac : %s)", new Object[] { Long.valueOf(l) });
        AppMethodBeat.o(24200);
        return;
      }
      if (this.qsY.fM(paramIntent.field_deviceID, paramIntent.field_deviceType) != null)
      {
        ae.i("MicroMsg.ExdeviceRankDataSourceUI", "The device has been added, now switch it to be the main device.");
        AppMethodBeat.o(24200);
        return;
      ...
      bc.ajj().a(1267, this);
      bc.ajj().a(new com.tencent.mm.plugin.exdevice.model.q(), 0);
    }
    AppMethodBeat.o(24200);
  }
  ...
  public void onSceneEnd(int paramInt1, int paramInt2, String paramString, n paramn)
  {
    ...
    if (paramn == null)
    {
      ae.e("MicroMsg.ExdeviceRankDataSourceUI", "onSceneEnd, scene is null.");
    ...
    if ((paramn instanceof com.tencent.mm.plugin.exdevice.model.q))
    {
      ...
      {
        paramString = (bjj)((com.tencent.mm.plugin.exdevice.model.q)paramn).rr.hQE.hQJ;
        if (paramString.GPi == null) {
          break label127;
        }
      }
    }
    label127:
    for (paramInt1 = paramString.GPi.size();; paramInt1 = 0)
    {
      ae.d("MicroMsg.ExdeviceRankDataSourceUI", "onSceneEnd, get sport device list succ.(size : %d)", new Object[] { Integer.valueOf(paramInt1) });
      runOnUiThread(new Runnable()
      {
        public final void run()
        {
          ...
          for (;;)
          {
            ...
            {
              duz localduz = (duz)((Iterator)localObject).next();
              if (localduz != null) {
                localb.qtd.add(ExdeviceRankDataSourceUI.a(localduz));
              }
            }
          }
        }
  ...
  static final class a
  {
    String mac;
    duz qtb;
    com.tencent.mm.plugin.exdevice.i.b qtc;
  }
    ...
    extends BaseAdapter
  {
    ...
    List<ExdeviceRankDataSourceUI.a> qtd;
    ...
    private ExdeviceRankDataSourceUI.a CY(int paramInt)
    {
      AppMethodBeat.i(24193);
      ExdeviceRankDataSourceUI.a locala = (ExdeviceRankDataSourceUI.a)this.qtd.get(paramInt);
      AppMethodBeat.o(24193);
      return locala;
    }
    
    /* Error */
    public final ExdeviceRankDataSourceUI.a adL(String paramString)
    {
      // Byte code:
      //   0: aload_0
      //   1: monitorenter
      ...
      //   8: aload_1
      //   9: invokestatic 66	com/tencent/mm/sdk/platformtools/bu:isNullOrNil	(Ljava/lang/String;)Z
      //   12: ifne +55 -> 67
      //   15: aload_0
      //   16: getfield 30	com/tencent/mm/plugin/exdevice/ui/ExdeviceRankDataSourceUI$b:qtd	Ljava/util/List;
    ...
    /* Error */
    public final ExdeviceRankDataSourceUI.a fM(String paramString1, String paramString2)
    {
      // Byte code:
      //   0: aload_0
      //   1: monitorenter
      ...
      //   5: invokestatic 25	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
      //   8: aload_0
      //   9: getfield 30	com/tencent/mm/plugin/exdevice/ui/ExdeviceRankDataSourceUI$b:qtd	Ljava/util/List;
      ...
      //   45: aload_2
      //   46: aload_3
      //   47: getfield 96	com/tencent/mm/plugin/exdevice/ui/ExdeviceRankDataSourceUI$a:qtb	Lcom/tencent/mm/protocal/protobuf/duz;
      //   50: invokestatic 99	com/tencent/mm/plugin/exdevice/ui/ExdeviceRankDataSourceUI:a	(Ljava/lang/String;Ljava/lang/String;Lcom/tencent/mm/protocal/protobuf/duz;)Z
      //   53: ifeq -34 -> 19
      //   56: sipush 24191
    ...
    public final View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      ExdeviceRankDataSourceUI.a locala = CY(paramInt);
      Object localObject;
      if (paramView == null)
      {
      ...
      for (;;)
      {
        ...
        ae.d("MicroMsg.ExdeviceRankDataSourceUI", "position(%s), name(%s), mac(%s).", new Object[] { Integer.valueOf(paramInt), localObject, locala.mac });
        paramViewGroup.jiC.setText((CharSequence)localObject);
        com.tencent.mm.av.q.aJb().a(locala.qtb.IconUrl, paramViewGroup.mdt, this.qon);
