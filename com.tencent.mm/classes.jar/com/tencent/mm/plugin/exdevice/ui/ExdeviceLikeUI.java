  ...
  extends MMActivity
{
  ...
  private ArrayList<com.tencent.mm.plugin.exdevice.g.b.a.e> vnT;
  private boolean vnU;
  private ListView vnV;
  private ExdeviceLikeUI.a vnW;
  private final int vnX = 30;
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.vnU = getIntent().getBooleanExtra("key_is_like_read_only", false);
    if (!Util.isNullOrNil(paramBundle))
    {
      ...
      do
      {
        ...
        {
          paramBundle = null;
          this.vnT = paramBundle;
          this.vnV = ((ListView)findViewById(R.h.dFY));
          this.vnV.setEmptyView(findViewById(R.h.empty));
          this.vnW = new ExdeviceLikeUI.a(this);
          this.vnV.setAdapter(this.vnW);
          if (!this.vnU) {
            this.vnV.setOnItemClickListener(new AdapterView.OnItemClickListener()
            {
              public final void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
              {
                ...
                com.tencent.mm.hellhoundlib.a.a.c("com/tencent/mm/plugin/exdevice/ui/ExdeviceLikeUI$3", "android/widget/AdapterView$OnItemClickListener", "onItemClick", "(Landroid/widget/AdapterView;Landroid/view/View;IJ)V", this, localb.aFi());
                ...
                com.tencent.mm.hellhoundlib.a.a.b(paramAnonymousView, paramAnonymousAdapterView.aFh(), "com/tencent/mm/plugin/exdevice/ui/ExdeviceLikeUI$3", "onItemClick", "(Landroid/widget/AdapterView;Landroid/view/View;IJ)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
          ...
          this.vnV.setOnItemClickListener(new AdapterView.OnItemClickListener()
          {
            public final void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
            {
              ...
              localb.sg(paramAnonymousInt);
              localb.Fs(paramAnonymousLong);
              com.tencent.mm.hellhoundlib.a.a.c("com/tencent/mm/plugin/exdevice/ui/ExdeviceLikeUI$4", "android/widget/AdapterView$OnItemClickListener", "onItemClick", "(Landroid/widget/AdapterView;Landroid/view/View;IJ)V", this, localb.aFi());
              ...
              paramAnonymousView.putExtra("app_username", aa.PJ("gh_43f2581f6fd6"));
          ...
          setMMTitle(R.l.eDC);
          if (!this.vnU) {
            addTextOptionMenu(0, getString(R.l.eDA), new MenuItem.OnMenuItemClickListener()
            {
              public final boolean onMenuItemClick(MenuItem paramAnonymousMenuItem)
              {
                ...
                com.tencent.mm.hellhoundlib.a.a.b(paramAnonymousMenuItem, ((com.tencent.mm.hellhoundlib.b.a)localObject).aFh(), "com/tencent/mm/plugin/exdevice/ui/ExdeviceLikeUI$1", "onMenuItemClick", "(Landroid/view/MenuItem;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
          ...
          return;
          paramBundle = k.b.aG(paramBundle, (String)localObject1);
        } while (paramBundle == null);
        localMap = paramBundle.llV;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.vnT = ae.cZD().avF(paramBundle);
      break;
    }
  }
