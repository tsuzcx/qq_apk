...
public final class i
  implements f
{
  private static HashMap<Integer, WeakReference<a>> wsG;
  private static HashMap<String, WeakReference<a>> wsH;
  public a wsI = null;
  ...
  public static void LO(int paramInt)
  {
    ...
    com.tencent.mm.plugin.newtips.b.a locala = com.tencent.mm.plugin.newtips.a.duo().LT(paramInt);
    if (locala == null)
    {
    ...
    if (locala.field_tipType == d.wsg)
    {
      locala.field_hadRead = true;
      com.tencent.mm.plugin.newtips.a.duo().a(locala, new String[0]);
    }
    if (locala.field_tipType == d.wsh)
    {
      locala.field_hadRead = true;
      com.tencent.mm.plugin.newtips.a.duo().a(locala, new String[0]);
    }
    long l = bt.flT();
    aj.getContext().getSharedPreferences(aj.fkC() + "_newtips_report", 0).edit().putLong("newtips_makeread_time", l).commit();
    AppMethodBeat.o(127241);
  }
  ...
  public static void LR(int paramInt)
  {
    ...
    com.tencent.mm.plugin.newtips.a.dun().LP(paramInt);
  ...
  private void a(WeakReference<a> paramWeakReference, com.tencent.mm.plugin.newtips.b.e parame)
  {
    ...
    ad.i("MicroMsg.NewTips.NewTipsManager", "showNewTip() path:%s show %s [%s,%s,%s]", new Object[] { parame, ((k)localPair.first).wsR, ((dnc)localPair.second).title, ((dnc)localPair.second).url, Integer.valueOf(((dnc)localPair.second).hgh) });
    boolean bool2;
    if (g.a(parame, (k)localPair.first))
    {
      ...
      bool2 = g.a(paramWeakReference, new Pair(localk, new dnc()), false);
      if (!bool2) {
        break label332;
      }
    }
  ...
  private void a(List<com.tencent.mm.plugin.newtips.b.c> paramList, com.tencent.mm.plugin.newtips.b.c paramc, int paramInt)
  {
    ...
    if ((paramc != null) && (paramc.fVg != null))
    {
      Iterator localIterator1 = paramc.fVg.iterator();
      while (localIterator1.hasNext())
      {
        ...
        for (;;)
        {
          ...
          if (paramc.wsX)
          {
            if (!bt.lQ(localc.field_dynamicPath, paramc.wsW)) {
              continue;
            }
        ...
        label237:
        ad.d("MicroMsg.NewTips.NewTipsManager", "clickNewTip() clickNewTip parentTipsInfos(%s) state to NEW_TIPS_STATE_DISAPPEAR. ret: %s layer: %s", new Object[] { str, Integer.valueOf(com.tencent.mm.plugin.newtips.a.dup().eD(localArrayList)), Integer.valueOf(paramInt) });
        d(paramc);
      }
    }
    AppMethodBeat.o(127248);
  ...
  public static com.tencent.mm.plugin.newtips.b.a am(Map<String, String> paramMap)
  {
    ...
    {
      locala.field_tipsShowInfo = new dne();
      locala.field_tipsShowInfo.dlp = bt.getInt((String)paramMap.get(".sysmsg.newtips.control.tips_showInfo.show_type"), 0);
      locala.field_tipsShowInfo.title = ((String)paramMap.get(".sysmsg.newtips.control.tips_showInfo.title"));
      locala.field_tipsShowInfo.pkr = ((String)paramMap.get(".sysmsg.newtips.control.tips_showInfo.icon_url"));
    ...
    com.tencent.mm.plugin.newtips.a.duo().LT(locala.field_tipId);
  ...
  private void atg(String paramString)
  {
    ...
    a((WeakReference)wsH.get(paramString), new com.tencent.mm.plugin.newtips.b.e(paramString));
    AppMethodBeat.o(214423);
  }
  
  private Pair<k, dnc> b(com.tencent.mm.plugin.newtips.b.e parame)
  {
    AppMethodBeat.i(214425);
    if (!g.a(parame))
    {
      ad.i("MicroMsg.NewTips.NewTipsManager", "getShouldShowType() %s not support newTip", new Object[] { parame });
      parame = new Pair(k.wsK, new dnc());
      AppMethodBeat.o(214425);
      return parame;
    }
    Object localObject1 = e.eB(com.tencent.mm.plugin.newtips.a.dup().e(parame));
    ...
    if (!((List)localObject2).isEmpty()) {
      ad.i("MicroMsg.NewTips.NewTipsManager", "getShouldShowType() set exposureTime(%s). ret: %s", new Object[] { Long.valueOf(l), Integer.valueOf(com.tencent.mm.plugin.newtips.a.dup().eD((List)localObject2)) });
    }
    if (((List)localObject1).size() == 1)
    {
      localObject2 = k.LS(((com.tencent.mm.plugin.newtips.b.c)((List)localObject1).get(0)).field_showType);
      if (g.a(parame, (k)localObject2))
      {
        if (localObject2 == k.wsQ)
        {
          parame = new dnc();
          parame.hgh = 1;
          parame = new Pair(k.wsQ, parame);
          AppMethodBeat.o(214425);
          return parame;
        }
    ...
    {
      localc = (com.tencent.mm.plugin.newtips.b.c)localIterator.next();
      if (k.wsQ == k.LS(localc.field_showType)) {
        i += 1;
      } else {
        ((List)localObject2).add(localc);
      }
    ...
    Collections.sort((List)localObject2, new i.1(this));
    i = ((List)localObject2).size() - 1;
    while (i >= 0)
    {
      localObject1 = k.LS(((com.tencent.mm.plugin.newtips.b.c)((List)localObject2).get(i)).field_showType);
  ...
  public static void b(String paramString, PluginNewTips.a parama)
  {
    ...
    String str = bt.bI(paramString, "null");
    boolean bool = ax.aQz("new_tips").getBoolean(str, false);
  ...
  private static void d(com.tencent.mm.plugin.newtips.b.e parame)
  {
    ...
    {
      parame = parame.wsW;
      com.tencent.mm.plugin.newtips.a.dun().atg(parame);
      AppMethodBeat.o(214427);
      return;
    }
    int i = parame.path;
    com.tencent.mm.plugin.newtips.a.dun().LP(i);
    AppMethodBeat.o(214427);
  }
  
  public static void eC(List<com.tencent.mm.plugin.newtips.b.c> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      else
      {
        ...
        com.tencent.mm.plugin.newtips.a.dun().atg((String)localObject);
      }
    }
  ...
  public static void g(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    com.tencent.mm.plugin.newtips.b.a locala = com.tencent.mm.plugin.newtips.a.duo().LT(paramInt1);
    if (locala == null)
    {
      ...
      com.tencent.mm.plugin.newtips.a.duo().f(locala);
      if ((paramInt2 == d.wsg) && ((!locala.field_isExit) || (1 != locala.field_tipVersion)))
      {
    ...
    else
    {
      if ((paramInt2 == d.wsg) && ((!locala.field_isExit) || (1 != locala.field_tipVersion)))
      {
        ...
        com.tencent.mm.kernel.g.aiU().a(localb, 0);
        ad.d("MicroMsg.NewTips.NewTipsManager", "dancy doScene NetScenePushCompatNewTips！！");
      }
      if (((paramInt2 == d.wsg) && (1 != locala.field_tipVersion)) || ((paramInt2 == d.wsh) && (locala.field_tipVersion <= 0)))
      {
        locala.field_tipId = paramInt1;
        locala.field_tipVersion = 1;
        locala.field_tipkey = paramString1;
  ...
  public static void i(a parama)
  {
    ...
    if (parama.dkD())
    {
      ...
      if ((WeakReference)wsH.get(str) != null) {
        wsH.remove(str);
      }
    }
    for (;;)
    {
      ad.i("MicroMsg.NewTips.NewTipsManager", "unRegisterNewTips %s %s", new Object[] { parama.getPath(), Boolean.valueOf(parama.dkD()) });
      AppMethodBeat.o(184032);
      return;
      int i = g.atf(parama.getPath());
      if ((WeakReference)wsG.get(Integer.valueOf(i)) != null) {
        wsG.remove(Integer.valueOf(i));
      }
    }
  }
  ...
  public final void LP(int paramInt)
  {
    ...
    a((WeakReference)wsG.get(Integer.valueOf(paramInt)), new com.tencent.mm.plugin.newtips.b.e(paramInt));
    AppMethodBeat.o(127245);
  }
  ...
  public final void c(com.tencent.mm.plugin.newtips.b.e parame)
  {
    ...
    ad.i("MicroMsg.NewTips.NewTipsManager", "clickNewTip(%s) clickNewTip tipsInfos state to NEW_TIPS_STATE_DISAPPEAR. ret: %s", new Object[] { parame, Integer.valueOf(com.tencent.mm.plugin.newtips.a.dup().eD((List)localObject1)) });
    d(parame);
    localObject1 = ((List)localObject1).iterator();
    while (((Iterator)localObject1).hasNext())
    {
      parame = ((com.tencent.mm.plugin.newtips.b.c)((Iterator)localObject1).next()).field_parents;
      if ((parame != null) && (parame.fVg != null))
      {
        localIterator1 = parame.fVg.iterator();
        while (localIterator1.hasNext())
        {
          Object localObject2 = (String)localIterator1.next();
          int i = g.atf((String)localObject2);
          if (i == 0) {}
          List localList;
          for (parame = new com.tencent.mm.plugin.newtips.b.e((String)localObject2);; parame = new com.tencent.mm.plugin.newtips.b.e(i))
          {
            localList = com.tencent.mm.plugin.newtips.a.dup().e(parame);
            Iterator localIterator2 = localList.iterator();
            while (localIterator2.hasNext()) {
              ((com.tencent.mm.plugin.newtips.b.c)localIterator2.next()).field_state = 1;
            }
          }
          ad.i("MicroMsg.NewTips.NewTipsManager", "clickNewTip() clickNewTip parentTipsInfos(%s) state to NEW_TIPS_STATE_DISAPPEAR. ret: %s", new Object[] { localObject2, Integer.valueOf(com.tencent.mm.plugin.newtips.a.dup().eD(localList)) });
          d(parame);
          parame = localList.iterator();
          while (parame.hasNext())
          {
            localObject2 = (com.tencent.mm.plugin.newtips.b.c)parame.next();
            a(com.tencent.mm.plugin.newtips.a.dup().ati(((com.tencent.mm.plugin.newtips.b.c)localObject2).field_uniqueId), (com.tencent.mm.plugin.newtips.b.c)localObject2, 1);
          }
        }
      }
    }
  ...
  public final void h(a parama)
  {
    ...
    if (parama.dkD())
    {
      ...
      WeakReference localWeakReference = (WeakReference)wsH.get(localObject);
      if ((localWeakReference != null) && (parama.equals((a)localWeakReference.get())))
      {
        ...
        atg((String)localObject);
        AppMethodBeat.o(127244);
        return;
      }
      wsH.put(localObject, new WeakReference(parama));
      atg((String)localObject);
    }
    for (;;)
    {
      ad.i("MicroMsg.NewTips.NewTipsManager", "registerNewTips() register %s (%s) [%s] (%s)", new Object[] { parama.getPath(), Boolean.valueOf(parama.dkD()), parama.toString(), parama.getClass().getName() + "@" + Integer.toHexString(parama.hashCode()) });
      AppMethodBeat.o(127244);
      return;
      int i = g.atf(parama.getPath());
      localObject = (WeakReference)wsG.get(Integer.valueOf(i));
      ...
      wsG.put(Integer.valueOf(i), new WeakReference(parama));
      LP(i);
    }
  }
  ...
  public final void onSceneEnd(int paramInt1, int paramInt2, String paramString, n paramn)
  {
    ...
    if (paramn.getType() == 597)
    {
      ...
      boolean bool = ((b)paramn).wse;
      paramInt1 = ((b)paramn).wsf;
      paramString = com.tencent.mm.plugin.newtips.a.duo().LT(paramInt1);
      if (paramString != null)
      {
        ...
        com.tencent.mm.plugin.newtips.a.duo().a(paramString, new String[0]);
      }
    }
    AppMethodBeat.o(127239);
  }
