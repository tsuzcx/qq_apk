  ...
  implements o
{
  ...
  private ConcurrentHashMap<String, l.a> LmZ;
  
  static
  {
    AppMethodBeat.i(127261);
    cUc = Long.valueOf(604800L);
  ...
  public l()
  {
    ...
    this.LmZ = new ConcurrentHashMap();
  ...
  public final f.b a(String paramString, Map<String, String> paramMap, f.a parama)
  {
    ...
    label2613:
    label3005:
    for (long l3 = bt.getLong((String)paramMap.get(".sysmsg.newtips.control.tips_id"), 0L);; l3 = 0L)
    {
      int k = 0;
      ...
      if (paramMap.containsKey(".sysmsg.newtips.control.op")) {
        k = bt.getInt((String)paramMap.get(".sysmsg.newtips.control.op"), 0);
      }
      int j;
      if (bt.isNullOrNil(paramString))
      {
        ...
        if (paramMap.containsKey(".sysmsg.newtips.control.tips_type")) {
          j = bt.getInt((String)paramMap.get(".sysmsg.newtips.control.tips_type"), 0);
        }
        parama = com.tencent.mm.plugin.newtips.a.cWu().ajl(paramString);
        ad.i("MicroMsg.NewTips.NewTipsXMLConsumer", "checkLogicValidOp() newTips type(%s) unique_id(%s) op(%s)", new Object[] { Integer.valueOf(j), paramString, Integer.valueOf(k) });
        if (parama.size() > 0) {
          break label369;
        }
        ...
        if (i != 0)
        {
          ...
          for (;;)
          {
            if (((Iterator)localObject1).hasNext())
            {
              ...
              continue;
              ad.i("MicroMsg.NewTips.NewTipsXMLConsumer", "checkNumValidUniqueIdAndOp() uniqueId:%s op:%s", new Object[] { paramString, Integer.valueOf(k) });
              if ((k != 0) && (k != 1))
              {
                ad.i("MicroMsg.NewTips.NewTipsXMLConsumer", "checkNumValidUniqueIdAndOp() op:%s not exist in (0,1)", new Object[] { Integer.valueOf(k) });
                i = 0;
                break;
              }
              i = 1;
      ...
      for (int i = 1;; i = 0)
      {
        ...
        ad.i("MicroMsg.NewTips.NewTipsXMLConsumer", "checkLogicValidOp() unique_id(%s) exist(op:%s)", new Object[] { paramString, Integer.valueOf(k) });
        i = 0;
        break;
        localObject1 = this.LmZ.entrySet().iterator();
        Object localObject3;
        while (((Iterator)localObject1).hasNext())
        {
          localObject2 = (Map.Entry)((Iterator)localObject1).next();
          localObject3 = (l.a)((Map.Entry)localObject2).getValue();
          if ((localObject3 != null) && (((l.a)localObject3).a(l3, parama, paramMap))) {
        ...
        for (;;)
        {
          ...
          aq.n(new Runnable()
          {
            public final void run()
            {
              ...
              com.tencent.mm.plugin.newtips.a.cWu().rA(ce.asQ() / 1000L);
          ...
          return null;
          ad.i("MicroMsg.NewTips.NewTipsXMLConsumer", "handleNewXml() update localNewTips state to NEW_TIPS_STATE_CANCEL. ret: %s", new Object[] { Integer.valueOf(com.tencent.mm.plugin.newtips.a.cWu().em(parama)) });
        ...
        label2630:
        for (i = bt.getInt((String)paramMap.get(".sysmsg.newtips.tips_showInfo_list.size"), 0);; i = 0)
        {
          if (i == 0) {
          ...
          do
          {
            ...
            parama = this.LmZ.entrySet().iterator();
            do
            {
              if (!parama.hasNext()) {
                break;
              ...
              localObject3 = (l.a)((Map.Entry)localObject1).getValue();
            } while ((localObject3 == null) || (!((l.a)localObject3).a(l3, paramString, (List)localObject2, paramMap)));
          ...
          for (int i2 = bt.getInt((String)paramMap.get(".sysmsg.newtips.tips_showInfo_list.tips_showInfo.parents.size"), 0);; i2 = 0)
          {
            ...
            if (i2 != 0)
            {
              ...
              if (localdcd.fyl.size() > 0) {
                ((c)localObject3).field_parents = localdcd;
              }
            }
            localObject1 = k.Ir(((c)localObject3).field_showType);
            label2786:
            label2792:
            switch (2.uep[localObject1.ordinal()])
            {
            case 1: 
            case 2: 
            case 3: 
            ...
            case 7: 
              ...
              for (i2 = bt.getInt((String)paramMap.get(".sysmsg.newtips.tips_showInfo_list.tips_showInfo" + i1 + ".parents.size"), 0);; i2 = 0)
              {
                ...
                bool = parama.cWy();
                break label716;
                i = com.tencent.mm.plugin.newtips.a.cWu().en((List)localObject2);
                paramMap = new mo();
                paramMap.drH.drI = paramString;
                com.tencent.mm.sdk.b.a.ESL.l(paramMap);
                ad.i("MicroMsg.NewTips.NewTipsXMLConsumer", "handleNewXml() insert ret:%s", new Object[] { Integer.valueOf(i) });
                com.tencent.mm.plugin.newtips.a.cWs();
                i.el((List)localObject2);
                break;
                ad.i("MicroMsg.NewTips.NewTipsXMLConsumer", "handleNewXml() no insert");
                break;
                com.tencent.mm.plugin.newtips.a.cWs();
                localObject1 = i.af(paramMap);
                ...
                if (localObject1 == null)
                {
                  ...
                  paramString = com.tencent.mm.plugin.newtips.a.cWs().ues;
                  if (paramString == null) {
                    break label598;
                  }
                ...
                l1 = bt.eGO();
                aj.getContext().getSharedPreferences(aj.eFD() + "_newtips_report", 0).edit().putLong("newtips_gettipstime", l1).commit();
                if (((com.tencent.mm.plugin.newtips.b.a)localObject1).field_tipsShowInfo != null)
                {
                  j = ((com.tencent.mm.plugin.newtips.b.a)localObject1).field_tipsShowInfo.dcz;
                  if (((com.tencent.mm.plugin.newtips.b.a)localObject1).field_tipsShowInfo == null) {
                    break label2786;
                  }
                  ...
                  paramMap = ((com.tencent.mm.plugin.newtips.b.a)localObject1).field_tipsShowInfo.odo;
                  if (((com.tencent.mm.plugin.newtips.b.a)localObject1).field_tipsShowInfo == null) {
                    break label2798;
                  }
                ...
                for (;;)
                {
                  com.tencent.mm.plugin.report.service.h.vKh.f(14995, new Object[] { Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(n), Long.valueOf(l1), "", "", "", "", "", "", "", Integer.valueOf(j), paramString, paramMap, parama, Integer.valueOf(i), Integer.valueOf(d.uee), "" });
                  break;
                  j = 0;
                  break label2579;
                  paramString = "";
                  ...
                  else
                  {
                    ...
                    for (i = 0;; i = 1)
                    {
                      ...
                      i = 5;
                      break;
                      localObject2 = com.tencent.mm.plugin.newtips.a.cWt().Is(((com.tencent.mm.plugin.newtips.b.a)localObject1).field_tipId);
                    ...
                    for (i = 0;; i = 1)
                    {
                      ...
                      i = 6;
                      break;
                      if (com.tencent.mm.plugin.newtips.a.cWt().Is(((com.tencent.mm.plugin.newtips.b.a)localObject1).field_tipId) == null) {
                        break label2925;
                      }
                    }
  ...
  public final void a(String paramString, l.a parama)
  {
    ...
    this.LmZ.put(paramString, parama);
