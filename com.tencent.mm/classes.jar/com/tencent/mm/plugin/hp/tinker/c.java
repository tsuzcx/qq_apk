  ...
  extends com.tencent.tinker.lib.b.a
{
  ...
  public c(Context paramContext)
  {
    ...
    this.DNm = ((ActivityManager)paramContext.getSystemService("activity")).getMemoryClass();
    ShareTinkerLog.v("Tinker.TinkerPatchListener", "application maxMemory:" + this.DNm, new Object[0]);
    AppMethodBeat.o(117464);
  }
  
  public final int iw(String paramString1, String paramString2)
  {
    boolean bool = false;
    ...
    int j = super.iw(paramString1, paramString2);
    int i = j;
    if (j == 0)
    {
      if (this.DNm < 45) {
    ...
    else
    {
      ...
      if (i == 0)
      {
        com.tencent.tinker.lib.e.a.mi(this.context);
        j = i;
        if (i == 0)
        {
      ...
      if (j == 0)
      {
        ...
        {
          i = j;
          if (ah.b(new Throwable().getStackTrace())) {
            i = -26;
          }
        }
      }
      localObject = com.tencent.mm.plugin.hp.d.c.fastGetPatchPackageMeta((File)localObject);
      if (localObject == null) {
        break label307;
      }
      ...
      j = b.a.DMs.value;
      label200:
      b.f(paramString1, paramString2, (String)localObject, k, j);
    }
    for (;;)
    {
      if (i == 0) {
      ...
      return i;
      if (!com.tencent.mm.plugin.hp.d.c.eIw())
      {
        i = -21;
        break;
      }
