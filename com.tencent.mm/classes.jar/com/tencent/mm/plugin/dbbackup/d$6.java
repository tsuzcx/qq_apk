  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    Object localObject = this.obc + "corrupted/EnMicroMsg.db";
    if (i.eK((String)localObject + ".corrupt"))
    {
      AppMethodBeat.o(23084);
      return;
    }
    long l = System.currentTimeMillis();
    localObject = new e(this.obc + "corrupted");
    ...
    if (i.cO(q.B(((e)localObject).mUri), true)) {
