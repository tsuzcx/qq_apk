...
{
  /* Error */
  public static boolean amE(java.lang.String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
    ...
    //   20: invokestatic 34	com/tencent/mm/vfs/u:V	(Ljava/io/File;)Lcom/tencent/mm/vfs/u;
    //   23: astore 7
    //   25: new 30	com/tencent/mm/vfs/u
    //   28: dup
    //   29: new 36	java/lang/StringBuilder
    //   32: dup
    //   33: invokespecial 40	java/lang/StringBuilder:<init>	()V
    //   36: aload 7
    //   38: getfield 44	com/tencent/mm/vfs/u:mUri	Landroid/net/Uri;
    //   41: invokestatic 50	com/tencent/mm/vfs/ah:v	(Landroid/net/Uri;)Ljava/lang/String;
    ...
    //   55: invokespecial 63	com/tencent/mm/vfs/u:<init>	(Ljava/lang/String;)V
    //   58: astore 8
    ...
    //   111: dup
    //   112: aload 7
    //   114: invokestatic 103	com/tencent/mm/vfs/y:ao	(Lcom/tencent/mm/vfs/u;)Ljava/io/InputStream;
    //   117: aload 11
    ...
    //   254: dup
    //   255: aload 8
    //   257: invokestatic 158	com/tencent/mm/vfs/y:ap	(Lcom/tencent/mm/vfs/u;)Ljava/io/OutputStream;
    //   260: aload 11
    ...
    //   367: astore_2
    //   368: aload 7
    //   370: invokevirtual 192	com/tencent/mm/vfs/u:diJ	()Z
    //   373: pop
    //   374: aload 6
    //   376: astore_2
    //   377: aload 8
    //   379: aload 7
    //   381: invokevirtual 196	com/tencent/mm/vfs/u:am	(Lcom/tencent/mm/vfs/u;)Z
    //   384: istore_1
    //   385: aload 6
    //   387: astore_2
    //   388: ldc 121
    ...
    //   23	357	7	localu1	com.tencent.mm.vfs.u
    //   58	320	8	localu2	com.tencent.mm.vfs.u
  ...
  /* Error */
  public static java.util.Collection<java.lang.String> duk()
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
    ...
    //   25: new 30	com/tencent/mm/vfs/u
    //   28: dup
    //   29: invokestatic 214	com/tencent/mm/loader/i/b:bmz	()Ljava/lang/String;
    //   32: ldc 216
    //   34: invokespecial 218	com/tencent/mm/vfs/u:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   37: astore_1
    //   38: ldc 121
    ...
    //   64: aload 6
    //   66: iconst_1
    //   67: invokestatic 226	com/tencent/mm/compatible/deviceinfo/q:eD	(Z)Ljava/lang/String;
    //   70: invokevirtual 146	java/util/LinkedHashSet:add	(Ljava/lang/Object;)Z
    //   73: pop
    //   74: aload 6
    //   76: iconst_0
    //   77: invokestatic 226	com/tencent/mm/compatible/deviceinfo/q:eD	(Z)Ljava/lang/String;
    //   80: invokevirtual 146	java/util/LinkedHashSet:add	(Ljava/lang/Object;)Z
    //   83: pop
    //   84: aload_1
    //   85: invokevirtual 229	com/tencent/mm/vfs/u:jKS	()Z
    //   88: ifne +105 -> 193
    //   91: ldc 121
    //   93: ldc 231
    //   95: invokestatic 128	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   98: aload 7
    //   100: invokevirtual 229	com/tencent/mm/vfs/u:jKS	()Z
    //   103: ifeq +215 -> 318
    //   106: aload 5
    //   108: astore_1
    //   109: ldc 75
    ...
    //   151: dup
    //   152: aload 7
    //   154: invokestatic 103	com/tencent/mm/vfs/y:ao	(Lcom/tencent/mm/vfs/u;)Ljava/io/InputStream;
    //   157: aload_2
    ...
    //   196: dup
    //   197: new 233	com/tencent/mm/vfs/ab
    //   200: dup
    //   201: aload_1
    //   202: invokespecial 236	com/tencent/mm/vfs/ab:<init>	(Lcom/tencent/mm/vfs/u;)V
    ...
    //   23	130	7	localu	com.tencent.mm.vfs.u
    // Exception table:
    //   from	to	target	type
