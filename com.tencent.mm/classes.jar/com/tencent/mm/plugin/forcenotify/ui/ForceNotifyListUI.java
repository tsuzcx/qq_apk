...
@l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/forcenotify/ui/ForceNotifyListUI;", "Lcom/tencent/mm/ui/MMActivity;", "Lcom/tencent/mm/sdk/storage/MStorage$IOnStorageChange;", "()V", "TAG", "", "adapter", "Lcom/tencent/mm/plugin/forcenotify/ui/ForceNotifyListUI$ForceNotifyListAdapter;", "data", "Ljava/util/ArrayList;", "Lcom/tencent/mm/plugin/forcenotify/model/ForceNotifyInfo;", "emptyTipView", "Landroid/view/View;", "loadingView", "recyclerView", "Landroid/support/v7/widget/RecyclerView;", "touchLoc", "", "getLayoutId", "", "onBackPressed", "", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "onDestroy", "onNotifyChange", "event", "eventData", "Lcom/tencent/mm/sdk/storage/MStorageEventData;", "ForceNotifyListAdapter", "ForceNotifyViewHolder", "plugin-force-notify_release"})
  ...
  implements k.a
{
  ...
  public final void onCreate(Bundle paramBundle)
  {
    ...
    com.tencent.mm.plugin.forcenotify.d.a.tjV.add((k.a)this);
    setMMTitle(2131759588);
    setBackBtn((MenuItem.OnMenuItemClickListener)new c(this));
    this.gWO = findViewById(2131301491);
    this.tke = findViewById(2131299472);
    this.gmV = ((RecyclerView)findViewById(2131301443));
    ...
    paramBundle.setAdapter((RecyclerView.a)this.tkd);
    h.LTJ.aR((Runnable)new d(this));
    ((com.tencent.mm.plugin.forcenotify.a.a)g.ab(com.tencent.mm.plugin.forcenotify.a.a.class)).D("", 1, cf.aCL() / 1000L);
  ...
  public final void onDestroy()
  {
    ...
    super.onDestroy();
    com.tencent.mm.plugin.forcenotify.d.a.tjV.remove((k.a)this);
    ((com.tencent.mm.plugin.forcenotify.a.a)g.ab(com.tencent.mm.plugin.forcenotify.a.a.class)).D("", 2, cf.aCL() / 1000L);
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/forcenotify/ui/ForceNotifyListUI$ForceNotifyListAdapter;", "Landroid/support/v7/widget/RecyclerView$Adapter;", "Lcom/tencent/mm/plugin/forcenotify/ui/ForceNotifyListUI$ForceNotifyViewHolder;", "Lcom/tencent/mm/plugin/forcenotify/ui/ForceNotifyListUI;", "(Lcom/tencent/mm/plugin/forcenotify/ui/ForceNotifyListUI;)V", "getItemCount", "", "getItemViewType", "position", "onBindViewHolder", "", "holder", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "plugin-force-notify_release"})
    ...
    extends RecyclerView.a<ForceNotifyListUI.b>
  {
    public final int getItemCount()
    {
      ...
      int i = ForceNotifyListUI.a(this.tkg).size();
    ...
    public final int getItemViewType(int paramInt)
    {
      ...
      Object localObject = ForceNotifyListUI.a(this.tkg).get(paramInt);
    ...
    @l(gfx={1, 1, 16}, gfy={""}, gfz={"<anonymous>", "", "it", "Lcom/tencent/mm/plugin/appbrand/config/WxaAttributes;", "kotlin.jvm.PlatformType", "onGetWeAppInfo"})
      ...
      implements n.a
    {
      ...
      public final void b(WxaAttributes paramWxaAttributes)
      {
        ...
        ad.i(ForceNotifyListUI.b(this.tkh.tkg), "getOrSync result=".concat(String.valueOf(paramWxaAttributes)));
        aq.f((Runnable)new Runnable()
        {
          public final void run()
          {
            AppMethodBeat.i(149207);
            q.aIJ().loadImage(this.tkk, this.tkj.tki.jdF);
    ...
    implements View.OnCreateContextMenuListener, n.e
  {
    ...
    public b()
    {
      ...
      this.jdF = ((ImageView)ForceNotifyListUI.this);
      ...
      this.tkl = ((TextView)ForceNotifyListUI.this);
      this.tkm = ((TextView)localObject.findViewById(2131306251));
      this$1 = localObject.findViewById(2131304110);
      if (ForceNotifyListUI.this == null) {
        p.gfZ();
      }
      this.tkn = ((LinearLayout)ForceNotifyListUI.this);
      this$1 = localObject.findViewById(2131303924);
      if (ForceNotifyListUI.this == null) {
        p.gfZ();
      }
      this.tko = ForceNotifyListUI.this;
      ...
      ForceNotifyListUI.this.setOnTouchListener((View.OnTouchListener)new View.OnTouchListener()
      {
        public final boolean onTouch(View paramAnonymousView, MotionEvent paramAnonymousMotionEvent)
        {
          ...
          com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/forcenotify/ui/ForceNotifyListUI$ForceNotifyViewHolder$1", "android/view/View$OnTouchListener", "onTouch", "(Landroid/view/View;Landroid/view/MotionEvent;)Z", this, localb.ahq());
          ...
          for (;;)
          {
            ...
            return false;
            ForceNotifyListUI.f(this.tkq.tkg)[0] = ((int)paramAnonymousMotionEvent.getRawX());
            ForceNotifyListUI.f(this.tkq.tkg)[1] = ((int)paramAnonymousMotionEvent.getRawY());
          }
        }
      });
      ForceNotifyListUI.this.setOnLongClickListener((View.OnLongClickListener)new View.OnLongClickListener()
      {
        public final boolean onLongClick(View paramAnonymousView)
        {
          ...
          b localb = new b();
          localb.bd(paramAnonymousView);
          com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/forcenotify/ui/ForceNotifyListUI$ForceNotifyViewHolder$2", "android/view/View$OnLongClickListener", "onLongClick", "(Landroid/view/View;)Z", this, localb.ahq());
          ad.i(ForceNotifyListUI.b(this.tkq.tkg), "OnLongClick!");
          new com.tencent.mm.ui.widget.b.a((Context)this.tkq.tkg.getContext()).a(paramAnonymousView, 0, 0L, (View.OnCreateContextMenuListener)this.tkq, (n.e)this.tkq, ForceNotifyListUI.f(this.tkq.tkg)[0], ForceNotifyListUI.f(this.tkq.tkg)[1]);
      ...
      this.tkn.setOnClickListener((View.OnClickListener)new View.OnClickListener()
      {
        public final void onClick(View paramAnonymousView)
        {
          ...
          b localb = new b();
          localb.bd(paramAnonymousView);
          com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/forcenotify/ui/ForceNotifyListUI$ForceNotifyViewHolder$3", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
          ad.i(ForceNotifyListUI.b(this.tkq.tkg), "resetView onClick! username:%s", new Object[] { this.tkq.username });
          c.tjT.ajx(this.tkq.username);
          this.tkq.tko.animate().rotation(360.0F).setDuration(300L).withEndAction((Runnable)new Runnable()
          {
            public final void run()
            {
              AppMethodBeat.i(149215);
              this.tkr.tkq.tko.animate().start();
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      ForceNotifyListUI.a(this.tkg).clear();
      ArrayList localArrayList = ForceNotifyListUI.a(this.tkg);
      c localc = c.tjT;
      localArrayList.addAll((Collection)c.cQA());
      this.tkg.runOnUiThread((Runnable)new Runnable()
      {
        public final void run()
        {
          AppMethodBeat.i(149221);
          ad.i(ForceNotifyListUI.b(this.tks.tkg), "[onCreate] load size=" + ForceNotifyListUI.a(this.tks.tkg).size());
          Object localObject = ForceNotifyListUI.c(this.tks.tkg);
          if (localObject == null) {
            p.gfZ();
          }
          ((ForceNotifyListUI.a)localObject).notifyDataSetChanged();
          localObject = ForceNotifyListUI.g(this.tks.tkg);
          if (localObject == null) {
            p.gfZ();
          }
          ((View)localObject).setVisibility(8);
          if (ForceNotifyListUI.a(this.tks.tkg).isEmpty())
          {
            localObject = ForceNotifyListUI.d(this.tks.tkg);
            if (localObject == null) {
              p.gfZ();
            }
            ((RecyclerView)localObject).setVisibility(8);
            localObject = ForceNotifyListUI.e(this.tks.tkg);
            if (localObject == null) {
              p.gfZ();
            }
    ...
    public final void run()
    {
      ...
      this.tkg.runOnUiThread((Runnable)new Runnable()
      {
        public final void run()
        {
          ...
          if (ForceNotifyListUI.a(this.tkt.tkg).isEmpty())
          {
            localObject = ForceNotifyListUI.d(this.tkt.tkg);
            if (localObject == null) {
              p.gfZ();
            }
            ((RecyclerView)localObject).setVisibility(8);
            localObject = ForceNotifyListUI.e(this.tkt.tkg);
            if (localObject == null) {
              p.gfZ();
            }
            ((View)localObject).setVisibility(0);
          ...
          Object localObject = ForceNotifyListUI.d(this.tkt.tkg);
          if (localObject == null) {
            p.gfZ();
          }
          ((RecyclerView)localObject).setVisibility(0);
          localObject = ForceNotifyListUI.c(this.tkt.tkg);
          if (localObject == null) {
            p.gfZ();
          }
          ((ForceNotifyListUI.a)localObject).notifyDataSetChanged();
