...
@l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/brandservice/BizProcessorCommand;", "Lcom/tencent/mm/pluginsdk/cmd/ProcessorCommand;", "()V", "processCommand", "", "context", "Landroid/content/Context;", "args", "", "", "username", "(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;)Z", "Companion", "plugin-brandservice_release"})
public final class a
  implements com.tencent.mm.pluginsdk.cmd.a
{
  private static final String nVv = "//biz";
  public static final a nVw;
  ...
  public final boolean a(Context paramContext, String[] paramArrayOfString, String paramString)
  {
    ...
    if ((paramArrayOfString != null) && (p.i(nVv, paramArrayOfString[0])))
    {
      if ((p.i("openbiztimeline", paramArrayOfString[1])) && (paramArrayOfString.length > 2))
      {
        paramContext = ax.aQA("brandService");
      ...
      {
        ax.aQz("WebViewUIShowBottom").encode("WebViewUIShowBottomNav", bt.getInt(paramArrayOfString[2], -1));
        AppMethodBeat.o(6446);
        return true;
      }
      if ((p.i("checkWebviewId", paramArrayOfString[1])) && (paramArrayOfString.length > 2))
      {
        paramContext = ax.aQz("MicroMsg.BizVideoDetailUI");
      ...
      if ((p.i("addRecCard", paramArrayOfString[1])) && (paramArrayOfString.length > 2))
      {
        ...
        paramContext = new String(paramContext, d.UTF_8);
        paramArrayOfString = ax.aQA("brandService");
      ...
      if ((p.i("addPayAlbum", paramArrayOfString[1])) && (paramArrayOfString.length > 2))
      {
        paramContext = Base64.decode(paramArrayOfString[2], 2);
        p.g(paramContext, "Base64.decode(args[2], Base64.NO_WRAP)");
        paramString = new String(paramContext, d.UTF_8);
        ...
        if (i != -1)
        {
          ...
          paramArrayOfString = bw.M(paramContext, "sysmsg");
          paramContext = paramArrayOfString;
          if (paramArrayOfString == null)
          {
            ad.e(nVv, "XmlParser values is null, msgContent %s", new Object[] { paramString });
            AppMethodBeat.o(6446);
            return true;
          }
        }
        ...
        paramArrayOfString = com.tencent.mm.plugin.biz.b.a.nOO;
      ...
      if ((p.i("paySuccess", paramArrayOfString[1])) && (paramArrayOfString.length > 2))
      {
        paramContext = Base64.decode(paramArrayOfString[2], 2);
        p.g(paramContext, "Base64.decode(args[2], Base64.NO_WRAP)");
        paramContext = bw.M(new String(paramContext, d.UTF_8), "sysmsg");
        paramArrayOfString = com.tencent.mm.plugin.brandservice.b.a.nWn;
      ...
      {
        paramContext = ax.aQA("ProfileCrashCheck");
      ...
      if ((p.i("updateAppInfo", paramArrayOfString[1])) && (paramArrayOfString.length > 2))
      {
        ...
        h.LTJ.f((Runnable)new a.b(paramContext), "GetAppInfoASyncThread");
        AppMethodBeat.o(6446);
        return true;
      }
      ...
      {
        if (bt.getInt(paramArrayOfString[2], -1) == 0) {}
        for (bool = true;; bool = false)
        {
          com.tencent.mm.plugin.biz.b.b.jf(bool);
          AppMethodBeat.o(6446);
          return true;
        }
      }
      if ((p.i("videochannel", paramArrayOfString[1])) && (paramArrayOfString.length > 2))
      {
        ...
        com.tencent.mm.plugin.biz.b.b.jg(bool);
        AppMethodBeat.o(6446);
        return true;
      }
      if ((p.i("sl", paramArrayOfString[1])) && (paramArrayOfString.length > 2))
      {
        paramContext = ax.aQz("bizCommand");
      ...
      {
        paramContext = u.Iom;
        u.aaF(bt.getInt(paramArrayOfString[2], -1));
        a.onSuccess();
        AppMethodBeat.o(6446);
        return true;
      }
      ...
      {
        paramContext = ax.aQA("brandService");
        paramContext.encode("BizTimeLineAdTestMode", bt.getInt(paramArrayOfString[2], 0));
        paramContext.apply();
        a.onSuccess();
        AppMethodBeat.o(6446);
        return true;
      ...
      {
        paramContext = ax.aQA("brandService");
        paramContext.encode("BizTimeLineAdOpen", bt.getInt(paramArrayOfString[2], 0));
        paramContext.apply();
        a.onSuccess();
        AppMethodBeat.o(6446);
        return true;
      ...
      {
        paramContext = com.tencent.mm.plugin.webcanvas.g.Dzc;
        com.tencent.mm.plugin.webcanvas.g.uN(true);
        AppMethodBeat.o(6446);
        return true;
      }
      if ((p.i("adpreview", paramArrayOfString[1])) && (paramArrayOfString.length > 2))
      {
        paramContext = ax.aQA("WebCanvasStorage");
        paramContext.encode("BizTimeLineAdPreviewMode", bt.getInt(paramArrayOfString[2], 0));
        paramContext.apply();
        a.onSuccess();
        AppMethodBeat.o(6446);
        return true;
      ...
      {
        paramContext = ax.aQA("brandService");
        paramContext.encode("BizTimeLineTestMode", bt.getInt(paramArrayOfString[2], 0));
        paramContext.apply();
        a.onSuccess();
        AppMethodBeat.o(6446);
        return true;
      ...
      {
        com.tencent.mm.am.b.b.hSI.aGy();
        AppMethodBeat.o(6446);
        return true;
      }
      if (p.i("clearimg", paramArrayOfString[1]))
      {
        h.LTJ.aR((Runnable)a.c.nVA);
        AppMethodBeat.o(6446);
        return true;
      }
      if (p.i("timel", paramArrayOfString[1]))
      {
        ...
        if (i == 1001)
        {
          ...
          if (i != -1)
          {
            ...
            paramArrayOfString = bw.M(paramArrayOfString, "sysmsg");
            if (paramArrayOfString != null) {
              break label1400;
            }
            ad.e("MicroMsg.BizTimeLineStorageLogicExKt", "XmlParser values is null, msgContent %s", new Object[] { paramContext });
          }
          for (;;)
          {
            AppMethodBeat.o(6446);
            return true;
            label1400:
            paramContext = aa.bK(paramArrayOfString);
            if (paramContext == null) {
              p.gfZ();
            }
            aa.d(paramContext);
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/brandservice/BizProcessorCommand$Companion;", "", "()V", "COMMAND_BIZ", "", "init", "", "onSuccess", "plugin-brandservice_release"})
  public static final class a
  {
    public static void onSuccess()
    {
      AppMethodBeat.i(209616);
      Toast.makeText(aj.getContext(), (CharSequence)"Success! WeChat will kill self in 1 second...", 1).show();
      h.LTJ.q((Runnable)a.nVx, 1000L);
      ...
      implements Runnable
    {
      ...
      public final void run()
      {
        ...
        ((com.tencent.mm.plugin.brandservice.a.a)com.tencent.mm.kernel.g.ab(com.tencent.mm.plugin.brandservice.a.a.class)).bgl();
