  ...
  implements x.a
{
  ...
  public final int a(int paramInt1, int paramInt2, String paramString, b paramb, n paramn)
  {
    ...
    ae.i("MicroMsg.BizTimeLineOftenReadReport", "often_read_bar_report CGI return, errType = %d, errCode = %d", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
