  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    a.b("com/tencent/mm/plugin/brandservice/ui/timeline/BizTimeLineAdapter$8", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((com.tencent.mm.hellhoundlib.b.b)localObject1).ahF());
    localObject1 = (w)paramView.getTag();
    paramView = ((w)localObject1).field_talker;
    Object localObject2 = ((l)com.tencent.mm.kernel.g.ab(l.class)).azF().BH(((w)localObject1).field_talker);
    if ((!((w)localObject1).ftb()) && (localObject2 != null) && (!com.tencent.mm.contact.c.lO(((aw)localObject2).field_type)))
    {
      ...
      d.b(b.a(this.ogx), "profile", ".ui.ContactInfoUI", (Intent)localObject2);
      this.ogx.ogr.d((w)localObject1, 1);
    }
    for (;;)
    {
      ...
      d.f(b.a(this.ogx), ".ui.chatting.ChattingUI", (Intent)localObject2);
      this.ogx.ogr.d((w)localObject1, 9);
