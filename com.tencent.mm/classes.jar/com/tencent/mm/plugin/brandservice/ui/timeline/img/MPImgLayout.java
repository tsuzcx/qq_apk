  ...
  extends RelativeLayout
{
  ...
  public MPImgLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    View.inflate(getContext(), 2131495691, (ViewGroup)this);
    paramAttributeSet = findViewById(2131299289);
    p.g(paramAttributeSet, "findViewById(R.id.cover_iv)");
    this.ptx = ((ImageView)paramAttributeSet);
