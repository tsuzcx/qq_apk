...
public final class b
{
  ...
  public static void a(long paramLong1, int paramInt1, int paramInt2, int paramInt3, long paramLong2)
  {
    ...
    h.wUl.f(17747, new Object[] { Long.valueOf(paramLong1), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(paramLong1), Integer.valueOf(paramInt3), Long.valueOf(paramLong2) });
    AppMethodBeat.o(6531);
  }
  
  public static void a(t paramt, int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong)
  {
    ...
    {
      h.wUl.f(17750, new Object[] { paramt.field_talker, Long.valueOf(l), Integer.valueOf(paramInt1), Integer.valueOf(i), Long.valueOf(paramt.field_msgId), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), Integer.valueOf(paramInt4), Long.valueOf(paramLong) });
  ...
  public static void a(String paramString, long paramLong1, int paramInt1, long paramLong2, int paramInt2)
  {
    ...
    h.wUl.f(17748, new Object[] { paramString, Long.valueOf(paramLong1), Integer.valueOf(paramInt1), Long.valueOf(paramLong2), Integer.valueOf(paramInt2) });
  ...
  public static void a(String paramString1, long paramLong1, String paramString2, int paramInt1, long paramLong2, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    long l = System.currentTimeMillis() / 1000L;
    h.wUl.f(17616, new Object[] { paramString1, Long.valueOf(paramLong1), paramString2, Integer.valueOf(paramInt1), Long.valueOf(paramLong2), Integer.valueOf(paramInt2), Long.valueOf(l), Integer.valueOf(paramInt3), Integer.valueOf(paramInt4) });
  ...
  public static List<a> d(Map<String, String> paramMap, int paramInt)
  {
    ...
    {
      ac.i("MicroMsg.BizFastRejectTool", "parse AccountInfo failed , map is null");
      AppMethodBeat.o(6530);
      return localList;
    }
    if ((String)paramMap.get(".sysmsg.BizMsgRejectRecommend.BizAccount.UserName") == null)
    {
      ac.i("MicroMsg.BizFastRejectTool", "no msg in map");
      AppMethodBeat.o(6530);
      return localList;
    }
    Object localObject = new a();
    ((a)localObject).hlG = ((String)paramMap.get(".sysmsg.BizMsgRejectRecommend.BizAccount.HeadImgUrl"));
    ((a)localObject).bLs = ((String)paramMap.get(".sysmsg.BizMsgRejectRecommend.BizAccount.NickName"));
    ...
    for (;;)
    {
      ...
      locala.hlG = ((String)paramMap.get(".sysmsg.BizMsgRejectRecommend.BizAccount" + i + ".HeadImgUrl"));
      locala.bLs = ((String)paramMap.get(".sysmsg.BizMsgRejectRecommend.BizAccount" + i + ".NickName"));
