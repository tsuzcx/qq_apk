...
@l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lcom/tencent/mm/plugin/brandservice/ui/timeline/video/MPVideoErrorView;", "Landroid/widget/RelativeLayout;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "TAG", "", "errIv", "Landroid/widget/ImageView;", "errTv", "Landroid/widget/TextView;", "root", "Landroid/view/View;", "init", "", "controller", "Lcom/tencent/mm/plugin/brandservice/ui/timeline/video/BizNativePageController;", "setCigError", "errMsg", "errCode", "", "setPlayError", "plugin-brandservice_release"})
  ...
  extends RelativeLayout
{
  ...
  public final void setCigError$505cff1c(String paramString)
  {
    ...
    this.nMO.setBackgroundResource(2131231310);
    if (!bs.isNullOrNil(paramString)) {
      this.nMN.setText((CharSequence)(getContext().getString(2131761343) + ' ' + paramString));
    }
    for (;;)
    {
      ...
      return;
      this.nMN.setText((CharSequence)getContext().getString(2131761343));
    }
  }
  ...
  public final void setPlayError$505cff1c(String paramString)
  {
    ...
    this.nMO.setBackgroundResource(2131231304);
    this.nMN.setText((CharSequence)paramString);
    this.fvu.setClickable(false);
