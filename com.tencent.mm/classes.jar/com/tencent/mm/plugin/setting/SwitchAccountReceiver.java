  ...
  extends BroadcastReceiver
{
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    ac.i("MicroMsg.SwitchAccountReceiver", "onReceive, action %s", new Object[] { str });
    ...
    if (str.equals("action_reload_resources"))
    {
      ...
      ac.i("MicroMsg.SwitchAccountReceiver", "onReceive, language %s", new Object[] { str });
      paramIntent = ab.aKK(str);
    ...
    for (;;)
    {
      ...
      ai.h(b.a(paramContext.getApplicationContext().getResources(), paramContext.getApplicationContext(), str));
      AppMethodBeat.o(73757);
      return;
      label147:
