  ...
  extends BroadcastReceiver
{
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    ad.i("MicroMsg.SwitchAccountReceiver", "onReceive, action %s", new Object[] { str });
    ...
    if (str.equals("action_reload_resources"))
    {
      ...
      ad.i("MicroMsg.SwitchAccountReceiver", "onReceive, language %s", new Object[] { str });
      paramIntent = ac.aQq(str);
    ...
    for (;;)
    {
      ...
      aj.h(b.a(paramContext.getApplicationContext().getResources(), paramContext.getApplicationContext(), str));
      AppMethodBeat.o(73757);
      return;
      label147:
