  ...
  implements DialogInterface.OnClickListener
{
  ...
  public final void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    this.Jgj.getDefaultSharedPreferences().edit().putBoolean("settings_voicerecorder_mode", true).commit();
    ((CheckBoxPreference)SettingsAboutSystemUI.a(this.Jgj).byG("settings_voicerecorder_mode")).setChecked(true);
