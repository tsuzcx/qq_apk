  ...
  extends MMPreference
{
  ...
  private String qp(boolean paramBoolean)
  {
  ...
  public void initView()
  {
    ...
    if (!this.xrR)
    {
      Preference localPreference = this.screen.aPN("settings_chatting_bg_apply_to_all");
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        ((Intent)localObject).putExtra("CropImage_bg_vertical", qp(true));
        ((Intent)localObject).putExtra("CropImage_bg_horizontal", qp(false));
        com.tencent.mm.plugin.setting.b.iyx.a(this, paramIntent, (Intent)localObject, d.awL(), 4, null);
        AppMethodBeat.o(74132);
        return;
        paramIntent = q.h(getApplicationContext(), paramIntent, d.awL());
        if (paramIntent == null)
        {
          AppMethodBeat.o(74132);
          return;
        ...
        ((Intent)localObject).putExtra("CropImage_bg_vertical", qp(true));
        ((Intent)localObject).putExtra("CropImage_bg_horizontal", qp(false));
        com.tencent.mm.plugin.setting.b.iyx.a(this, (Intent)localObject, 4);
        AppMethodBeat.o(74132);
        return;
        if (paramInt2 == -1)
        {
          g.agR().agA().set(66820, Integer.valueOf(-1));
          com.tencent.mm.plugin.report.service.h.wUl.f(10198, new Object[] { Integer.valueOf(-1) });
          ac.i("MicroMsg.SettingsChattingBackgroundUI", "set chating bg id:%d", new Object[] { Integer.valueOf(-1) });
          if (this.xrR)
          {
            g.agR().agA().set(12311, Integer.valueOf(-1));
            t.aGO().pm(1);
          }
          else
          {
            paramIntent = t.aGP();
            localObject = paramIntent.CW(this.username);
            if (localObject == null)
            {
              localObject = new a();
  ...
  public boolean onPreferenceTreeClick(f paramf, Preference paramPreference)
  {
    ...
    ac.i("MicroMsg.SettingsChattingBackgroundUI", paramf + " item has been clicked!");
    if (paramf.equals("settings_chatting_bg_select_bg"))
    {
      paramf = new Intent();
      paramf.setClass(this, SettingsSelectBgUI.class);
      paramf.putExtra("isApplyToAll", this.xrR);
    ...
    if (paramf.equals("settings_chatting_bg_take_photo"))
    {
      ...
      ac.i("MicroMsg.SettingsChattingBackgroundUI", "summerper checkPermission checkCamera[%b], stack[%s], activity[%s]", new Object[] { Boolean.valueOf(bool), bs.eWi(), getContext() });
      if (!bool)
      {
        AppMethodBeat.o(74134);
        return false;
    ...
    {
      com.tencent.mm.ui.base.h.a(getContext(), getString(2131763197), "", new SettingsChattingBackgroundUI.3(this), null);
      AppMethodBeat.o(74134);
      return true;
    }
    AppMethodBeat.o(74134);
  ...
  public void onRequestPermissionsResult(int paramInt, String[] paramArrayOfString, int[] paramArrayOfInt)
  {
    ...
    {
      ac.i("MicroMsg.SettingsChattingBackgroundUI", "onRequestPermissionsResult grantResults length 0. requestCode[%d], tid[%d]", new Object[] { Integer.valueOf(paramInt), Long.valueOf(Thread.currentThread().getId()) });
      AppMethodBeat.o(74136);
      return;
    }
    ac.i("MicroMsg.SettingsChattingBackgroundUI", "onRequestPermissionsResult requestCode[%d],grantResults[%d] tid[%d]", new Object[] { Integer.valueOf(paramInt), Integer.valueOf(paramArrayOfInt[0]), Long.valueOf(Thread.currentThread().getId()) });
    switch (paramInt)
    {
    }
    for (;;)
    {
      ...
      com.tencent.mm.ui.base.h.a(this, getString(2131761860), getString(2131761885), getString(2131760598), getString(2131755691), false, new SettingsChattingBackgroundUI.2(this), null);
    }
  }
