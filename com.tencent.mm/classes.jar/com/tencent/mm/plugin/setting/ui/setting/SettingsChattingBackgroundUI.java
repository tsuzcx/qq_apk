  ...
  extends MMPreference
{
  ...
  private void cAv()
  {
    ...
    if (!q.d(this, com.tencent.mm.loader.j.b.ais(), "microMsg." + System.currentTimeMillis() + ".jpg", 2)) {
      Toast.makeText(this, getString(2131763022), 1).show();
    }
    AppMethodBeat.o(74135);
  }
  
  private String pq(boolean paramBoolean)
  {
    AppMethodBeat.i(74137);
    t.azY();
    if (this.wgB)
    {
      str = p.S("default", paramBoolean);
      AppMethodBeat.o(74137);
      return str;
    }
    String str = p.S(this.username, paramBoolean);
    AppMethodBeat.o(74137);
    return str;
  }
  ...
  public void initView()
  {
    ...
    if (!this.wgB)
    {
      Preference localPreference = this.screen.aKk("settings_chatting_bg_apply_to_all");
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        ((Intent)localObject).putExtra("CropImage_bg_vertical", pq(true));
        ((Intent)localObject).putExtra("CropImage_bg_horizontal", pq(false));
        com.tencent.mm.plugin.setting.b.hYt.a(this, paramIntent, (Intent)localObject, d.apW(), 4, null);
        AppMethodBeat.o(74132);
        return;
        paramIntent = q.h(getApplicationContext(), paramIntent, d.apW());
        if (paramIntent == null)
        {
          AppMethodBeat.o(74132);
          return;
        ...
        ((Intent)localObject).putExtra("CropImage_bg_vertical", pq(true));
        ((Intent)localObject).putExtra("CropImage_bg_horizontal", pq(false));
        com.tencent.mm.plugin.setting.b.hYt.a(this, (Intent)localObject, 4);
        AppMethodBeat.o(74132);
        return;
        if (paramInt2 == -1)
        {
          g.afB().afk().set(66820, Integer.valueOf(-1));
          com.tencent.mm.plugin.report.service.h.vKh.f(10198, new Object[] { Integer.valueOf(-1) });
          ad.i("MicroMsg.SettingsChattingBackgroundUI", "set chating bg id:%d", new Object[] { Integer.valueOf(-1) });
          if (this.wgB)
          {
            g.afB().afk().set(12311, Integer.valueOf(-1));
            t.azY().oy(1);
          }
          else
          {
            paramIntent = t.azZ();
            localObject = paramIntent.yR(this.username);
            if (localObject == null)
            {
              localObject = new a();
  ...
  public boolean onPreferenceTreeClick(f paramf, Preference paramPreference)
  {
    ...
    if (paramf.equals("settings_chatting_bg_select_bg"))
    {
      ...
      paramf.putExtra("isApplyToAll", this.wgB);
    ...
    if (paramf.equals("settings_chatting_bg_take_photo"))
    {
      ...
      ad.i("MicroMsg.SettingsChattingBackgroundUI", "summerper checkPermission checkCamera[%b], stack[%s], activity[%s]", new Object[] { Boolean.valueOf(bool), bt.eGN(), getContext() });
      if (!bool)
      {
        AppMethodBeat.o(74134);
        return false;
    ...
    {
      com.tencent.mm.ui.base.h.a(getContext(), getString(2131763197), "", new DialogInterface.OnClickListener()
      {
        public final void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
        {
          AppMethodBeat.i(74129);
          SettingsChattingBackgroundUI.dnV();
