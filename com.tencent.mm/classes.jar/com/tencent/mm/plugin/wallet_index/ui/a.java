...
public final class a
  implements b
{
  public static long DHR = 0L;
  private d DHO;
  private d DHP;
  private c DHQ;
  private d DHS;
  private com.tencent.mm.plugin.wallet_index.b.a.a DHT;
  private com.tencent.mm.plugin.wallet_index.b.a.b DHU;
  String DHV;
  private String DHu;
  String DHv;
  ...
  public a(Activity paramActivity, c paramc, d paramd)
  {
        ...
        if ("com.tencent.mm.gwallet.ACTION_QUERY_RESPONSE".equals(paramAnonymousContext))
        {
          ...
          com.tencent.mm.plugin.wallet_index.b.a.a.a(paramAnonymousIntent, new a.a()
          {
            public final void a(com.tencent.mm.plugin.wallet_index.c.b paramAnonymous2b, com.tencent.mm.plugin.wallet_index.b.a.b paramAnonymous2b1)
            {
              ...
              ae.d("MicroMsg.GoogleWallet", "Query inventory finished.");
              if ((paramAnonymous2b.eMH()) || (paramAnonymous2b1 == null))
              {
                ae.w("MicroMsg.GoogleWallet", "Failed to query inventory: ".concat(String.valueOf(paramAnonymous2b)));
                AppMethodBeat.o(71852);
                return;
              }
              ae.d("MicroMsg.GoogleWallet", "Query inventory was successful.");
              a.a(a.this, paramAnonymous2b1);
              paramAnonymous2b = a.c(a.this);
              ArrayList localArrayList = new ArrayList(paramAnonymous2b1.DHn.keySet());
              paramAnonymous2b.DIc.clear();
              paramAnonymous2b.DIc.addAll(localArrayList);
              paramAnonymous2b = new ArrayList(paramAnonymous2b1.DHn.values());
              if (paramAnonymous2b.size() > 0)
              {
                ...
                while (paramAnonymous2b.hasNext())
                {
                  ...
                  ae.i("MicroMsg.GoogleWallet", "do NetSceneVerifyPurchase. productId:" + paramAnonymous2b1.pMk + ",billNo:" + paramAnonymous2b1.DHs);
                  g.ajS();
                  g.ajQ().gDv.a(a.c(a.this).a(paramAnonymous2b1, true), 0);
                }
                AppMethodBeat.o(71852);
                return;
              }
              ae.d("MicroMsg.GoogleWallet", "purchases is null. consume null ");
              if (!bool) {
                ae.d("MicroMsg.GoogleWallet", "unknown_purchase");
              }
              for (paramAnonymous2b = com.tencent.mm.plugin.wallet_index.c.b.cr(5, "");; paramAnonymous2b = com.tencent.mm.plugin.wallet_index.c.b.cr(0, ""))
              {
                ...
                AppMethodBeat.o(71852);
                return;
                ae.d("MicroMsg.GoogleWallet", "result ok");
              }
            }
          });
        }
    ...
    this.DHT = new com.tencent.mm.plugin.wallet_index.b.a.a();
  ...
  private static void b(MMActivity paramMMActivity, int paramInt)
  {
    ...
    localIntent.putExtra("key_err_code", localb.uPh);
    localIntent.putExtra("key_err_msg", localb.uPi);
    localIntent.putExtra("key_launch_ts", DHR);
  ...
  public final int a(MMActivity paramMMActivity, d paramd)
  {
    ...
    this.DHO = paramd;
    this.pMk = this.DHQ.DHB.xbV;
    this.DHv = this.DHQ.DHB.wTD;
    this.DHu = this.DHQ.DHB.GOh;
    Intent localIntent = new Intent("com.tencent.mm.gwallet.ACTION_PAY_REQUEST");
    localIntent.setPackage("com.tencent.mm");
    localIntent.putExtra("product_id", this.pMk);
    this.DHV = this.DHQ.DHB.HdE;
    Object localObject1 = this.DHV;
    Object localObject2 = this.DHv;
    String str = this.DHu;
    ...
    {
      DHR = bu.fpO();
      ae.i("MicroMsg.GoogleWallet", "GWallet Found!");
    ...
    for (;;)
    {
      ...
      return 10001;
      ae.i("MicroMsg.GoogleWallet", "Try to downloading GWallet Moudle!");
      paramMMActivity = com.tencent.mm.plugin.wallet_index.c.b.cr(3, "");
      if (this.DHO != null) {
        this.DHO.a(paramMMActivity, null);
      }
    }
  }
  ...
  public final void a(MMActivity paramMMActivity, ArrayList<String> paramArrayList, d paramd, boolean paramBoolean)
  {
    ...
    this.DHP = paramd;
    ae.d("MicroMsg.GoogleWallet", "consumePurchase. consume...");
    com.tencent.mm.plugin.wallet_index.b.a.b localb = this.DHU;
    paramd = new ArrayList();
    paramArrayList = paramArrayList.iterator();
    while (paramArrayList.hasNext())
    {
      Object localObject = (String)paramArrayList.next();
      localObject = (com.tencent.mm.plugin.wallet_index.b.a.c)localb.DHn.get(localObject);
      if (localObject != null) {
    ...
    if (this.DHP != null) {
      this.DHP.a(paramMMActivity, null);
    }
    AppMethodBeat.o(71860);
  }
  ...
  public final boolean a(MMActivity paramMMActivity, int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 10001)
    {
      ae.i("MicroMsg.GoogleWallet", "purchase flow!result_code: %d", new Object[] { Integer.valueOf(paramInt2) });
      if (paramIntent != null)
      {
        paramInt1 = paramIntent.getIntExtra("RESPONSE_CODE", 0);
        if ((paramInt1 == 3) || (paramInt1 == 105))
        {
          ab.e(this.DHV, this.pMk, this.DHv, paramInt1, "");
    ...
    paramMMActivity = this.DHP;
    String str1 = this.DHV;
    String str2 = this.pMk;
    String str3 = this.DHv;
    paramInt1 = com.tencent.mm.plugin.wallet_index.b.a.a.aW(paramIntent);
    ae.d("MicroMsg.IabResolver", "Owned items response: " + String.valueOf(paramInt1));
    paramIntent = com.tencent.mm.plugin.wallet_index.c.b.cr(paramInt1, "");
    ab.e(str1, str2, str3, paramInt1, paramIntent.uPi);
  ...
  public final void d(MMActivity paramMMActivity, boolean paramBoolean)
  {
    ...
    ae.d("MicroMsg.GoogleWallet", "restorePurchase. Querying inventory.");
    ae.d("MicroMsg.GoogleWallet", "is direct? ".concat(String.valueOf(paramBoolean)));
  ...
  public final void p(MMActivity paramMMActivity)
  {
    ...
    catch (IllegalArgumentException localIllegalArgumentException)
    {
      for (;;)
      {
        ae.e("MicroMsg.GoogleWallet", localIllegalArgumentException.toString());
      }
    }
  }
}
