...
{
  private com.tencent.mm.plugin.wallet.balance.ui.lqt.a Pjh;
  private Map<String, String> PkV;
  
  public WalletOpenViewProxyUI()
  {
    AppMethodBeat.i(71942);
    this.PkV = new HashMap();
    AppMethodBeat.o(71942);
  }
  
  private void bhK(final String paramString)
  {
    AppMethodBeat.i(71946);
    int i;
    if (!Util.isNullOrNil(paramString))
    {
      paramString = (String)this.PkV.get("openview");
      if ("open_wcpay_biz_view".equals(paramString))
      {
        Log.d("MicroMsg.WalletOpenViewProxyUI", "func[handleOpenView] do open mall_index_ui");
        com.tencent.mm.pluginsdk.wallet.f.jI(getContext());
        i = 1;
      }
    }
    for (;;)
    {
      ...
      paramString.putExtra("closeWebView", (String)this.PkV.get("closeWebView"));
      ...
      else if ("open_wcpay_balance_view".equals(paramString))
      {
        ...
        com.tencent.mm.pluginsdk.wallet.f.aX(getContext(), 0);
        i = 1;
      }
      else if ("open_wcpay_order_detail_view".equals(paramString))
      {
        ...
        paramString = new Intent();
        paramString.putExtra("trans_id", (String)this.PkV.get("trans_id"));
        paramString.putExtra("scene", 1);
        if (this.PkV.containsKey("bill_id")) {
          paramString.putExtra("bill_id", (String)this.PkV.get("bill_id"));
        }
      ...
      else if ("open_wcpay_f2f_receive_detail".equals(paramString))
      {
        ...
        paramString = new Intent();
        paramString.putExtra("key_timestamp", Util.getLong((String)this.PkV.get("fromtimestamp"), 0L));
        paramString.putExtra("key_from_scene", 1);
        c.b(getContext(), "collect", ".ui.CollectBillUI", paramString);
        com.tencent.mm.plugin.report.service.h.IzE.a(13944, new Object[] { Integer.valueOf(2) });
        i = 1;
      }
      else if ("open_wcpay_grouppay_detail".equals(paramString))
      {
        ...
        paramString = new Intent();
        paramString.putExtra("bill_no", (String)this.PkV.get("billno"));
        paramString.putExtra("chatroom", (String)this.PkV.get("groupid"));
        paramString.putExtra("key_sign", (String)this.PkV.get("sign"));
        paramString.putExtra("key_ver", (String)this.PkV.get("ver"));
      ...
      else if ("open_wcpay_t2bc_detail".equals(paramString))
      {
        ...
        paramString = new Intent();
        paramString.putExtra("key_transfer_bill_id", (String)this.PkV.get("transfer_bill_id"));
      ...
      else if ("open_wcpay_fetch_balance_view".equals(paramString))
      {
        ...
        paramString = new aat();
        paramString.fZS.context = getContext();
      ...
      {
        paramString = new Intent();
        paramString.putExtra("wallet_lock_jsapi_scene", (String)this.PkV.get("entry_scene"));
        ((b)com.tencent.mm.kernel.h.ae(b.class)).n(this, paramString);
        i = 1;
      }
      ...
      else
      {
        ...
        if ("open_wcpay_c2c_message_view".equals(paramString))
        {
          if (this.PkV != null)
          {
            i = Util.getInt((String)this.PkV.get("bizType"), -1);
            if (i == 1)
            {
              paramString = (String)this.PkV.get("bizId");
              localObject1 = (String)this.PkV.get("username");
              long l = Util.getLong((String)this.PkV.get("createTime"), -1L);
              ...
              localObject2 = new lu();
              ((lu)localObject2).fJF.fJG = paramString;
              ((lu)localObject2).fJF.username = ((String)localObject1);
              ((lu)localObject2).fJF.fJH = Long.valueOf(l);
        ...
        else
        {
          ...
          if ("open_lqt_auto_planadd_view".equals(paramString))
          {
            ...
            com.tencent.mm.hellhoundlib.a.a.b(this, paramString.aFh(), "com/tencent/mm/plugin/wallet_index/ui/WalletOpenViewProxyUI", "handleOpenView", "(Ljava/lang/String;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
          ...
          {
            ah.bgp((String)this.PkV.get("trace_info"));
            paramString = (String)this.PkV.get("operate_id");
            localObject1 = i.c(getContext(), false, null);
          ...
          {
            localObject2 = (String)this.PkV.get("amount");
            localObject1 = (String)this.PkV.get("title");
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 563)
    {
      if (paramInt2 == -1)
      {
        ...
        String str4 = (String)this.PkV.get("amount");
        String str2 = (String)this.PkV.get("title");
        Intent localIntent = new Intent();
  ...
  public void onCreate(Bundle paramBundle)
  {
        ...
        while (i < paramBundle.length)
        {
          if (!Util.isNullOrNil(paramBundle[i]))
          {
            ...
            if ((localObject.length == 2) && (!Util.isNullOrNil(localObject[0]))) {
              this.PkV.put(localObject[0], localObject[1]);
            }
          }
          i += 1;
        }
    ...
    paramBundle = (String)this.PkV.get("trace_info");
    if (!Util.isNullOrNil(paramBundle)) {
      ah.bgp(paramBundle);
    }
    ...
    paramBundle = (String)this.PkV.get("openview");
    ...
    if ("open_wcpay_lqt_detail".equals(paramBundle))
    {
      ...
      if (this.PkV != null)
      {
        ...
        localObject = (String)this.PkV.get("ecardtype");
        str1 = (String)this.PkV.get("extradata");
        paramBundle = (String)this.PkV.get("need_open_lqb");
        ...
        if (Util.getInt(paramBundle, 0) == 1)
        {
          ...
          doSceneForceProgress(new aj(paramBundle, str1));
        }
      }
      for (;;)
      {
        com.tencent.mm.plugin.report.service.h.IzE.idkeyStat(663L, 18L, 1L, false);
        AppMethodBeat.o(71943);
        return;
        i = Util.getInt((String)this.PkV.get("auto_jump_charge_setting"), 0);
        int j = Util.getInt((String)this.PkV.get("show_open_toast"), 0);
        ...
        c.ad(getContext(), "wallet", ".balance.ui.lqt.WalletLqtDetailUI");
        setResult(-1);
        finish();
      }
    }
    if ("redenvelopes_getshowresouces_and_move_to_root".equals(paramBundle))
    {
      ...
      ((com.tencent.mm.plugin.luckymoney.a.a)com.tencent.mm.kernel.h.ae(com.tencent.mm.plugin.luckymoney.a.a.class)).ag(true, true);
      setResult(-1);
      finish();
      AppMethodBeat.o(71943);
      return;
  ...
  public boolean onSceneEnd(int paramInt1, int paramInt2, String paramString, q paramq)
  {
    ...
    if ((paramInt1 == 0) && (paramInt2 == 0))
    {
      ...
      {
        e.bsi(((d)paramq).gIv());
        bhK(getIntent().getStringExtra("packageExt"));
      ...
      {
        paramString = ((aj)paramq).OmI;
        Log.i("MicroMsg.WalletOpenViewProxyUI", "on open lqb account scene end, retcode: %s, regmsg: %s", new Object[] { Integer.valueOf(paramString.tqa), paramString.tqb });
        if (paramString.fZQ != null) {
          this.Pjh.a(paramString.fZQ, null);
        }
        ...
        for (;;)
        {
          ...
          if (paramString.fZQ == null)
          {
            Toast.makeText(this, paramString.tqb, 1).show();
            setResult(0);
          }
        }
      }
