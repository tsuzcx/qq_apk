...
public final class e
{
  public static boolean a(Context paramContext, String paramString, PayResp paramPayResp, PayReq.Options paramOptions)
  {
    ...
    ad.d("MicroMsg.PayCallbackHelper", "callback, packageName = ".concat(String.valueOf(paramString)));
    String str;
    if ((paramOptions == null) || (bt.isNullOrNil(paramOptions.callbackClassName)))
    {
    ...
    {
      ad.d("MicroMsg.PayCallbackHelper", "callback, cbPkg = " + paramString + ", cbCls = " + str + ", cbFlags(hex) = " + Integer.toHexString(i));
