        ...
        public final void ei(boolean paramAnonymousBoolean)
        {
          ...
          MMHandlerThread.postToMainThread(new Runnable()
          {
            public final void run()
            {
              ...
              if (c.1.this.oYb != null)
              {
                Object localObject2 = c.1.this.oYc;
                Object localObject3 = c.1.this.oYb;
                float f = c.1.this.oYd;
                a locala = c.1.this.oYa;
                ...
                int k = com.tencent.mm.plugin.ball.f.e.oYK / 2;
                ((com.tencent.mm.plugin.ball.view.e)localObject1).pcW = i;
                ((com.tencent.mm.plugin.ball.view.e)localObject1).pcX = j;
                ((com.tencent.mm.plugin.ball.view.e)localObject1).pcV = k;
                ...
                localObject3 = ((f)localObject2).chG();
                ...
                boolean bool;
                if (((com.tencent.mm.plugin.ball.view.e)localObject1).pcY > 0)
                {
                  bool = true;
                  ((com.tencent.mm.plugin.ball.view.e)localObject1).pcZ = bool;
                  if (((com.tencent.mm.plugin.ball.view.e)localObject1).pcY >= ((com.tencent.mm.plugin.ball.view.e)localObject1).pcW) {
                    break label678;
                  }
                  i = ((com.tencent.mm.plugin.ball.view.e)localObject1).pcY;
                  label412:
                  localObject3 = PropertyValuesHolder.ofInt("canvasTranslationX", new int[] { ((com.tencent.mm.plugin.ball.view.e)localObject1).pcY, i });
                  i = ((com.tencent.mm.plugin.ball.view.e)localObject1).pcW;
                  if (((com.tencent.mm.plugin.ball.view.e)localObject1).pcZ) {
                    if (((com.tencent.mm.plugin.ball.view.e)localObject1).pcY >= ((com.tencent.mm.plugin.ball.view.e)localObject1).pcW) {
                      break label687;
                    }
                  }
                ...
                label678:
                label687:
                for (i = ((com.tencent.mm.plugin.ball.view.e)localObject1).pcW - ((com.tencent.mm.plugin.ball.view.e)localObject1).pcY;; i = 0)
                {
                  localObject3 = ValueAnimator.ofPropertyValuesHolder(new PropertyValuesHolder[] { PropertyValuesHolder.ofInt("translationX", new int[] { 0, i }), PropertyValuesHolder.ofInt("translationY", new int[] { 0, ((com.tencent.mm.plugin.ball.view.e)localObject1).pcX }), PropertyValuesHolder.ofFloat("scaleX", new float[] { 1.0F, 2.0F * ((com.tencent.mm.plugin.ball.view.e)localObject1).pcV / ((com.tencent.mm.plugin.ball.view.e)localObject1).mWidth }), PropertyValuesHolder.ofFloat("scaleY", new float[] { 1.0F, 2.0F * ((com.tencent.mm.plugin.ball.view.e)localObject1).pcV / ((com.tencent.mm.plugin.ball.view.e)localObject1).mHeight }), localObject3, PropertyValuesHolder.ofInt("bgAlpha", new int[] { 255, 0 }) });
