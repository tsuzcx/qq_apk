  ...
  extends g
{
  ...
  protected final void a(final ChatroomMsgPack paramChatroomMsgPack)
  {
    ...
    this.CuY.a(this.mContext, localLinkedList, com.tencent.mm.plugin.game.chatroom.e.aIP(this.iZU), new i()
    {
      public final void NM(long paramAnonymousLong)
      {
        AppMethodBeat.i(211786);
        d.a locala = d.jTj;
        d.a.a(1L, paramAnonymousLong, e.this.Cuy, e.this.Cuz, paramChatroomMsgPack.seq, paramChatroomMsgPack.from_username);
      ...
      public final void b(SpannableStringBuilder paramAnonymousSpannableStringBuilder)
      {
        ...
        e.a(e.this).aL(paramAnonymousSpannableStringBuilder);
