  ...
  implements k
{
  ...
  public al(String paramString1, String paramString2, LinkedList<String> paramLinkedList)
  {
    ...
    ((b.a)localObject).hvt = new aqj();
    ((b.a)localObject).hvu = new aqk();
    ((b.a)localObject).uri = "/cgi-bin/mmgame-bin/gamecentersearchrecommend";
    ((b.a)localObject).funcId = getType();
    ((b.a)localObject).reqCmdId = 0;
    ((b.a)localObject).respCmdId = 0;
    if (paramString2 == null) {}
    for (this.cZL = "";; this.cZL = paramString2.trim())
    {
      this.fYA = ((b.a)localObject).aAz();
      localObject = (aqj)this.fYA.hvr.hvw;
      ((aqj)localObject).tju = paramString1;
      ((aqj)localObject).EJp = paramString2;
      ((aqj)localObject).EJq = paramLinkedList;
  ...
  public final void onGYNetEnd(int paramInt1, int paramInt2, int paramInt3, String paramString, q paramq, byte[] paramArrayOfByte)
  {
    ...
    ac.i("MicroMsg.NetSceneGameSearchRecmd", "errType = " + paramInt2 + ", errCode = " + paramInt3);
