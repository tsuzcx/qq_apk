...
public final class a
{
  ...
  private static void a(c paramc, int paramInt1, String paramString, int paramInt2)
  {
    ...
    h.vKh.f(14841, new Object[] { paramc.field_layerId, paramc.field_business, paramc.field_expId, Long.valueOf(paramc.field_sequence), Integer.valueOf(paramc.field_prioritylevel), Long.valueOf(paramc.field_startTime), Long.valueOf(paramc.field_endTime), Integer.valueOf(paramInt1), paramString });
    AppMethodBeat.o(41350);
  }
  ...
  public static a cCF()
  {
    ...
    a locala = new a();
    c localc = com.tencent.mm.model.c.d.aty().qu("100001");
    if (!localc.isValid())
    {
    ...
    locala.dtM = bt.getInt((String)((Map)localObject).get("game_homepage_jump"), 0);
    ...
    a(localc, 901, locala.url, locala.dtM);
    ad.i(TAG, "getIndexABTestInfo success, layerId = %s, expId = %s, flag = %d, url = %s", new Object[] { localc.field_layerId, localc.field_expId, Integer.valueOf(locala.dtM), locala.url });
    AppMethodBeat.o(41346);
    return locala;
  }
  ...
  public static a cCG()
  {
    ...
    a locala = new a();
    c localc = com.tencent.mm.model.c.d.aty().qu("100003");
    if (!localc.isValid())
    {
    ...
    Object localObject = localc.eJy();
    locala.dtM = bt.getInt((String)((Map)localObject).get("game_library_jump"), 0);
    ...
    locala.url = ((String)localObject);
    a(localc, 1005, locala.url, locala.dtM);
    AppMethodBeat.o(41348);
    return locala;
  }
  ...
  public static a cCH()
  {
    ...
    a locala = new a();
    c localc = com.tencent.mm.model.c.d.aty().qu("100022");
    if (!localc.isValid())
    {
    ...
    Object localObject = localc.eJy();
    locala.dtM = bt.getInt((String)((Map)localObject).get("game_message_jump"), 0);
    ...
    locala.url = ((String)localObject);
    a(localc, 1001, locala.url, locala.dtM);
    AppMethodBeat.o(41349);
    return locala;
  }
  
  public static a ds(String paramString, int paramInt)
  {
    ...
    c localc = com.tencent.mm.model.c.d.aty().qu("100002");
    if (!localc.isValid())
    {
    ...
    Object localObject = localc.eJy();
    locala.dtM = bt.getInt((String)((Map)localObject).get("game_detail_jump"), 0);
    ...
    for (paramString = "";; paramString = (String)localObject + paramString)
    {
      ...
      a(localc, paramInt, locala.url, locala.dtM);
      AppMethodBeat.o(41347);
      return locala;
    }
  }
