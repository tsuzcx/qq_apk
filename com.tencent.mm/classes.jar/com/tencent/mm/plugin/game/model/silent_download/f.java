...
public final class f
{
  static void T(String paramString, int paramInt1, int paramInt2)
  {
    ...
    FileDownloadTaskInfo localFileDownloadTaskInfo = com.tencent.mm.plugin.downloader.model.f.duv().amO(paramString);
    if ((localFileDownloadTaskInfo != null) && (localFileDownloadTaskInfo.id > 0L))
    {
      ...
      for (int i = 0;; i = (int)(localFileDownloadTaskInfo.xom * 100L / localFileDownloadTaskInfo.uWn))
      {
  ...
  private static void a(String paramString1, long paramLong, String paramString2, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5)
  {
    ...
    //   30: astore 17
    //   32: ldc 76
    //   34: invokestatic 82	com/tencent/mm/kernel/h:ax	(Ljava/lang/Class;)Lcom/tencent/mm/kernel/c/a;
    //   37: checkcast 76	com/tencent/mm/plugin/game/api/f
    //   40: invokeinterface 86 1 0
    //   45: aload_0
    //   46: invokevirtual 92	com/tencent/mm/plugin/game/model/silent_download/g:aGU	(Ljava/lang/String;)Lcom/tencent/mm/plugin/game/model/silent_download/d;
    //   49: astore 18
    //   51: aload 18
    //   53: ifnull +21 -> 74
    //   56: aload 17
    //   58: ldc 94
    //   60: aload 18
    //   62: getfield 100	com/tencent/mm/plugin/game/model/silent_download/d:field_forceUpdateFlag	I
    ...
    //   327: aload 17
    //   329: aastore
    //   330: invokestatic 149	com/tencent/mm/plugin/game/model/silent_download/f:u	([Ljava/lang/Object;)Ljava/lang/String;
    //   333: astore_0
    //   334: getstatic 155	com/tencent/mm/game/report/api/a:mtH	Lcom/tencent/mm/game/report/api/a;
  ...
  public static void aGT(String paramString)
  {
    ...
    FileDownloadTaskInfo localFileDownloadTaskInfo = com.tencent.mm.plugin.downloader.model.f.duv().amO(paramString);
    Object localObject = ((com.tencent.mm.plugin.game.api.f)h.ax(com.tencent.mm.plugin.game.api.f.class)).fCj().aGU(paramString);
    if ((localFileDownloadTaskInfo != null) && (localFileDownloadTaskInfo.id > 0L))
    {
      if (localObject != null)
      {
        ...
        String str = localFileDownloadTaskInfo.url;
        if (localFileDownloadTaskInfo.uWn == 0L) {}
        for (i = 0;; i = (int)(localFileDownloadTaskInfo.xom * 100L / localFileDownloadTaskInfo.uWn))
        {
  ...
  static void ay(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (((com.tencent.mm.plugin.game.api.f)h.ax(com.tencent.mm.plugin.game.api.f.class)).fCj().aGU(paramString) != null) {
      T(paramString, paramInt1, paramInt2);
    }
    AppMethodBeat.o(41684);
  }
 ...
 * Qualified Name:     com.tencent.mm.plugin.game.model.silent_download.f
