...
public final class d
{
  ...
  public static void aZ(LinkedList<? extends g> paramLinkedList)
  {
  ...
  public static void c(g paramg)
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      if (str2.equals("zh_CN"))
      {
        ...
        localg.Bl(paramg.fmE);
        localg.Bo(paramg.fmJ);
        localg.mZ(paramg.fmN);
        localg.Bp(paramg.fmK);
        localg.Bu(paramg.fmQ);
        localg.Bv(paramg.fmR);
        localg.Bs(paramg.fmO);
        localg.Bt(paramg.fmP);
        localg.na(paramg.fmT);
        if (!Util.isNullOrNil(paramg.fmH)) {
          localg.Bm(paramg.fmH);
        }
        if (!bool2) {
          break label308;
        }
        bool1 = com.tencent.mm.plugin.r.a.eAS().r(localg);
        a.a.eAZ().aJz(str1);
      }
      for (;;)
      {
        ...
        if (localg.field_appVersion < paramg.field_appVersion)
        {
          ...
          bool1 = com.tencent.mm.plugin.r.a.eAS().a(localg, new String[0]);
          a.a.eAZ().aJz(str1);
        }
        else if (a(localg, paramg))
        {
          ...
          bool1 = com.tencent.mm.plugin.r.a.eAS().a(localg, new String[0]);
          com.tencent.mm.plugin.r.a.eAQ().gD(str1, 1);
          com.tencent.mm.plugin.r.a.eAQ().gD(str1, 2);
          com.tencent.mm.plugin.r.a.eAQ().gD(str1, 3);
          com.tencent.mm.plugin.r.a.eAQ().gD(str1, 4);
          com.tencent.mm.plugin.r.a.eAQ().gD(str1, 5);
        }
        else
        {
          bool1 = com.tencent.mm.plugin.r.a.eAS().a(localg, new String[0]);
 ...
 * Qualified Name:     com.tencent.mm.plugin.game.e.d
