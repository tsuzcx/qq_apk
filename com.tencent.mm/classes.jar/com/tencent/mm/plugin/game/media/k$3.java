  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.cH(paramView);
    a.c("com/tencent/mm/plugin/game/media/GamePublishGalleryView$3", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aYj());
    k.g(this.IzB).setVisibility(8);
