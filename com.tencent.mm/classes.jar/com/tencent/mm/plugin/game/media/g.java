  ...
  extends MAutoStorage<e>
{
  ...
  public final void aR(LinkedList<String> paramLinkedList)
  {
    ...
    Object localObject = aS(paramLinkedList);
    if (localObject != null)
    {
      localObject = ((LinkedList)localObject).iterator();
      while (((Iterator)localObject).hasNext())
      {
        LinkedList localLinkedList = c.aAL(((e)((Iterator)localObject).next()).field_localIdList);
        ((f)com.tencent.mm.kernel.g.af(f.class)).dSO().aR(localLinkedList);
      }
      paramLinkedList = String.format("delete from %s where %s in %s", new Object[] { "GameHaowanPublishEdition", "taskId", c.aY(paramLinkedList) });
  ...
  public final LinkedList<e> aS(LinkedList<String> paramLinkedList)
  {
    AppMethodBeat.i(40973);
    paramLinkedList = String.format("select * from %s where %s in %s", new Object[] { "GameHaowanPublishEdition", "taskId", c.aY(paramLinkedList) });
  ...
  public final e azX(String paramString)
  {
  ...
  public final boolean ef(String paramString, int paramInt)
  {
