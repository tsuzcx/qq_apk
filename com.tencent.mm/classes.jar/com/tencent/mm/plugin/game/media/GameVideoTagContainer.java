  ...
  extends LinearLayout
{
  ...
  public void setData(LinkedList<l> paramLinkedList)
  {
    ...
    while (getChildCount() < paramLinkedList.size())
    {
      ...
      ((LinearLayout.LayoutParams)localObject2).height = ao.fromDPToPix(getContext(), 14);
      ((LinearLayout.LayoutParams)localObject2).rightMargin = ao.fromDPToPix(getContext(), 4);
