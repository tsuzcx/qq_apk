...
public class r
{
  private static final f<String, Bitmap> fkD;
  
  static
  {
    AppMethodBeat.i(41178);
    fkD = new b(100, r.class);
    AppMethodBeat.o(41178);
  }
  
  public static Bitmap acr(String paramString)
  {
    AppMethodBeat.i(41176);
    Bitmap localBitmap = (Bitmap)fkD.aM(paramString);
    ...
    if ((localBitmap != null) && (!localBitmap.isRecycled()))
    {
      ...
      if ((Bitmap)fkD.put(paramString, localBitmap) == null) {}
  ...
  public static void f(final ImageView paramImageView, String paramString)
  {
    ...
    Bitmap localBitmap = (Bitmap)fkD.get(paramString);
    if ((localBitmap != null) && (!localBitmap.isRecycled()))
    {
    ...
    ad.i("MicroMsg.SimpleVideoAnalyzer", "attachVideoThumbBitmap, not from cache, size = %d", new Object[] { Integer.valueOf(fkD.size()) });
    ...
    h.Iye.aP(new Runnable()
    {
      public final void run()
      {
        ...
        final Bitmap localBitmap = r.acr(this.jXH);
