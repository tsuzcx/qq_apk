  ...
  extends AppCompatImageView
{
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    localPaint.setColor(getResources().getColor(g.b.game_image_stroke_color));
    paramCanvas.drawRoundRect(this.iTa, 18.0F, 18.0F, localPaint);
  }
  ...
  protected void onSizeChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localPaint.setColor(-1);
    localCanvas.drawRoundRect(this.iTa, 18.0F, 18.0F, localPaint);
