  ...
  implements View.OnClickListener
{
  ...
  protected static int a(Context paramContext, o paramo)
  {
    if (paramo == null)
    {
      ae.e("MicroMsg.GameMessageOnClickListener", "game message is null.");
      return 0;
    }
    if (!bu.isNullOrNil(paramo.field_appId))
    {
    ...
    ae.e("MicroMsg.GameMessageOnClickListener", "message type : " + paramo.field_msgType + " ,message.field_appId is null.");
    return 0;
  }
}
