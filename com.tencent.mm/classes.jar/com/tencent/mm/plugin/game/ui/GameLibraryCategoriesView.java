  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/game/ui/GameLibraryCategoriesView", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject1).ahq());
    ...
    int i = 7;
    if (!bt.isNullOrNil(paramView.uqg)) {
      c.aB(this.mContext, paramView.uqg);
    }
    for (;;)
    {
      f.a(this.mContext, 11, paramView.uqf + 100, paramView.position, i, this.udq, null);
      com.tencent.mm.hellhoundlib.a.a.a(this, "com/tencent/mm/plugin/game/ui/GameLibraryCategoriesView", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
      AppMethodBeat.o(42200);
      return;
      Object localObject2 = new Intent(this.mContext, GameCategoryUI.class);
      ((Intent)localObject2).putExtra("extra_type", 1);
      ((Intent)localObject2).putExtra("extra_category_id", paramView.uqf);
      ((Intent)localObject2).putExtra("extra_category_name", paramView.tHQ);
      ((Intent)localObject2).putExtra("game_report_from_scene", paramView.uqf + 100);
      localObject1 = this.mContext;
      localObject2 = new com.tencent.mm.hellhoundlib.b.a().bc(localObject2);
      com.tencent.mm.hellhoundlib.a.a.a(localObject1, ((com.tencent.mm.hellhoundlib.b.a)localObject2).ahp(), "com/tencent/mm/plugin/game/ui/GameLibraryCategoriesView", "onClick", "(Landroid/view/View;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
  ...
  protected void onFinishInflate()
  {
    ...
    this.rEk = ((LinearLayout)findViewById(2131300489));
    int i = ((WindowManager)this.mContext.getSystemService("window")).getDefaultDisplay().getWidth();
    this.hA = (i * 100 / 750);
    this.sMk = ((i - this.hA * 6) / 14);
    this.rEk.setPadding(this.sMk, com.tencent.mm.cc.a.fromDPToPix(this.mContext, 12), this.sMk, com.tencent.mm.cc.a.fromDPToPix(this.mContext, 12));
  ...
  public void setData(LinkedList<a> paramLinkedList)
  {
    ...
    while (paramLinkedList.hasNext())
    {
      ...
      localObject3 = q.aIJ();
      String str = ((a)localObject1).jPZ;
      c.a locala = new c.a();
      locala.idq = true;
      ((com.tencent.mm.aw.a.a)localObject3).a(str, (ImageView)localObject2, locala.aJc());
      localLinearLayout.addView((View)localObject2, this.hA, this.hA);
      localObject2 = new TextView(this.mContext);
      ((TextView)localObject2).setText(((a)localObject1).tHQ);
      ...
      ((LinearLayout.LayoutParams)localObject1).setMargins(this.sMk, 0, this.sMk, 0);
      this.rEk.addView(localLinearLayout, (ViewGroup.LayoutParams)localObject1);
    }
    AppMethodBeat.o(42199);
  }
