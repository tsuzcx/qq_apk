  ...
  extends GameWebViewUI
{
  ...
  public void onNewIntent(Intent paramIntent)
  {
    ...
    if (!bt.nullAsNil(this.uui).equals(str))
    {
      ...
      com.tencent.mm.hellhoundlib.a.a.a(this, paramIntent.ahp(), "com/tencent/mm/plugin/game/ui/tab/GameTabWebUI", "onNewIntent", "(Landroid/content/Intent;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
