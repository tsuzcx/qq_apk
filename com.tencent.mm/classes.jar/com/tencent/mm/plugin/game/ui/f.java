  ...
  implements View.OnClickListener
{
  ...
  public final void a(ai paramai, String paramString, int paramInt1, int paramInt2)
  {
    ...
    if ((paramai == null) || (bs.gY(paramai.tiT)))
    {
      setVisibility(8);
      AppMethodBeat.o(41906);
      return;
    }
    if (paramai.tiT.size() == 1)
    {
      paramai.tiT.add(null);
      paramai.tiT.add(null);
    }
    l locall;
    ...
    for (;;)
    {
      ...
      if (paramai.tiT.size() == 2) {
        paramai.tiT.add(null);
      }
    }
    localLinearLayout.setOnClickListener(this);
    com.tencent.mm.plugin.game.f.e.cRL().l(localImageView, locall.IconUrl);
    localTextView1.setText(locall.Title);
    if (!bs.isNullOrNil(locall.Desc))
    {
    ...
    for (;;)
    {
      ...
      a.a(this.mContext, 10, 1002, locall.thR, paramString, paramInt2, a.tu(locall.thP));
      break;
  ...
  public final void onClick(View paramView)
  {
    ...
    {
      ac.w("MicroMsg.GameBlockEntranceView", "getTag is null");
    ...
    {
      ac.w("MicroMsg.GameBlockEntranceView", "jumpUrl is null");
      AppMethodBeat.o(41907);
      return;
    }
    int i = c.z(this.mContext, paramView.thh, "game_center_mygame_comm");
    com.tencent.mm.game.report.e.a(this.mContext, 10, 1002, paramView.thR, i, this.mAppId, this.tfA, a.tu(paramView.thP));
    AppMethodBeat.o(41907);
  }
}
