...
{
  private GameRegionPreference.a CZO;
  ...
  public void initView()
  {
    ...
    addTextOptionMenu(0, getString(g.i.CpE), new MenuItem.OnMenuItemClickListener()
    {
      public final boolean onMenuItemClick(MenuItem paramAnonymousMenuItem)
      {
        AppMethodBeat.i(42358);
        if (e.gA(GameRegionSelectUI.this))
        {
          h.a(GameRegionSelectUI.this, true, GameRegionSelectUI.this.getString(g.i.CpC), "", GameRegionSelectUI.this.getString(g.i.CpD), GameRegionSelectUI.this.getString(g.i.CpB), new DialogInterface.OnClickListener()new DialogInterface.OnClickListener
          {
            public final void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
            {
              AppMethodBeat.i(42357);
              e.gB(GameRegionSelectUI.this);
              GameRegionSelectUI.a(GameRegionSelectUI.this);
              paramAnonymous2DialogInterface = new Intent();
              GameRegionPreference.a locala = e.gr(GameRegionSelectUI.this);
              if (locala != null)
              {
    ...
    this.CZS = a.a.ezW().ezV();
    Object localObject = e.gr(this);
    if (localObject != null) {
      ((GameRegionPreference.a)localObject).isSelected = true;
    }
    localObject = this.CZS.values().iterator();
    while (((Iterator)localObject).hasNext())
    {
      ...
      if (locala != null)
      {
        ...
        if ((locala == null) || (Util.isNullOrNil(locala.hDn))) {
        ...
        for (;;)
        {
          ...
          break;
          localGameRegionPreference.CZO = locala;
          localGameRegionPreference.setKey(locala.hDn);
        }
        label186:
  ...
  public boolean onPreferenceTreeClick(f paramf, Preference paramPreference)
  {
    ...
    {
      paramPreference = ((GameRegionPreference)paramPreference).CZO;
      if (paramPreference == null)
      {
        AppMethodBeat.o(42362);
        return false;
      }
      this.CZO = paramPreference;
