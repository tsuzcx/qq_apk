  ...
  extends cvw
{
  public String gvv;
  public String urR;
  public com.tencent.mm.bw.b urS;
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.urS != null) {
        paramVarArgs.c(4, this.urS);
      }
      if (this.urT != null) {
        paramVarArgs.c(5, this.urT);
      }
      AppMethodBeat.o(41729);
      return 0;
    }
    ...
    for (int i = f.a.a.a.lI(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.urS != null) {
        paramInt = i + f.a.a.b.b.a.b(4, this.urS);
      }
      i = paramInt;
      if (this.urT != null) {
        i = paramInt + f.a.a.b.b.a.b(5, this.urT);
      }
      AppMethodBeat.o(41729);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localaj.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(41729);
          return 0;
        case 2: 
          localaj.gvv = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(41729);
          return 0;
        case 3: 
          localaj.urR = ((f.a.a.a.a)localObject1).OmT.readString();
          AppMethodBeat.o(41729);
          return 0;
        case 4: 
          localaj.urS = ((f.a.a.a.a)localObject1).OmT.gCk();
          AppMethodBeat.o(41729);
          return 0;
        }
        localaj.urT = ((f.a.a.a.a)localObject1).OmT.gCk();
        AppMethodBeat.o(41729);
        return 0;
      }
      AppMethodBeat.o(41729);
