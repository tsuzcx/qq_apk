  ...
  extends blm
{
  public String kRX;
  public String kTb;
  public com.tencent.mm.bv.b kTc;
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.kTc != null) {
        paramVarArgs.b(4, this.kTc);
      }
      if (this.kTd != null) {
        paramVarArgs.b(5, this.kTd);
      }
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (int i = d.a.a.a.gA(1, this.tEX.btq()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.kTc != null) {
        paramInt = i + d.a.a.a.a(4, this.kTc);
      }
      i = paramInt;
      if (this.kTd != null) {
        i = paramInt + d.a.a.a.a(5, this.kTd);
      }
      return i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localy.tEX = ((gc)localObject1);
            paramInt += 1;
          }
        case 2: 
          localy.kRX = ((d.a.a.a.a)localObject1).xpH.readString();
          return 0;
        case 3: 
          localy.kTb = ((d.a.a.a.a)localObject1).xpH.readString();
          return 0;
        case 4: 
          localy.kTc = ((d.a.a.a.a)localObject1).cUs();
          return 0;
        }
        localy.kTd = ((d.a.a.a.a)localObject1).cUs();
        return 0;
      }
      return -1;
    }
