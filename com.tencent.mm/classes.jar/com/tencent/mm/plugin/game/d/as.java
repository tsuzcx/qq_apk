  ...
  extends cvc
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = f.a.a.a.lB(1, this.BaseRequest.computeSize()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.ugv != null) {
        paramInt = i + f.a.a.b.b.a.b(4, this.ugv);
      }
      AppMethodBeat.o(41746);
      return paramInt;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localas.BaseRequest = ((jc)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(41746);
          return 0;
        case 2: 
          localas.gsT = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(41746);
          return 0;
        case 3: 
          localas.ugt = ((f.a.a.a.a)localObject1).NPN.readString();
          AppMethodBeat.o(41746);
          return 0;
        }
        localas.ugv = ((f.a.a.a.a)localObject1).NPN.gxI();
        AppMethodBeat.o(41746);
        return 0;
      }
      AppMethodBeat.o(41746);
