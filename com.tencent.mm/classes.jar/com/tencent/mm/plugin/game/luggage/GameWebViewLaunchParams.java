  ...
  implements Parcelable
{
  ...
  private GameWebViewLaunchParams(Parcel paramParcel)
  {
    ...
    this.rOO = ((GameFloatLayerInfo)paramParcel.readParcelable(GameFloatLayerInfo.class.getClassLoader()));
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    paramParcel.writeParcelable(this.rOO, paramInt);
