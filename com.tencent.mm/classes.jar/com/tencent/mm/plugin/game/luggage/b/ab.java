  ...
  extends br<com.tencent.mm.plugin.game.luggage.f.g>
{
  ...
  public final void b(b<com.tencent.mm.plugin.game.luggage.f.g>.a paramb)
  {
    ...
    {
      ae.i("MicroMsg.JsApiReportGameWeb", "data is null or not json");
    ...
    {
      ae.i("MicroMsg.JsApiReportGameWeb", "report web performance, url:%s", new Object[] { ((com.tencent.mm.plugin.game.luggage.f.g)paramb.chg).bRn() });
      ((Map)localObject1).put(Integer.valueOf(d.b.EBa), Boolean.valueOf(bool));
      ...
      f.K(((com.tencent.mm.plugin.game.luggage.f.g)paramb.chg).dah(), (Map)localObject1);
      paramb.a("", null);
      AppMethodBeat.o(83089);
      return;
    }
    ...
    {
      ((Map)localObject1).putAll(((com.tencent.mm.plugin.game.luggage.f.g)paramb.chg).dai());
      localObject2 = f.bD((JSONObject)localObject3);
      localObject3 = ((Map)localObject2).keySet().iterator();
      while (((Iterator)localObject3).hasNext())
      {
      ...
      localObject1 = d.bK((Map)localObject1);
      ae.i("MicroMsg.JsApiReportGameWeb", "report web runtime. isReportNow:%b, reportData: [%s]", new Object[] { Boolean.valueOf(bool), localObject1 });
      com.tencent.mm.plugin.report.service.g.yxI.a(16145, (String)localObject1, bool, false);
      paramb.a("", null);
      AppMethodBeat.o(83089);
      return;
    }
    ae.i("MicroMsg.JsApiReportGameWeb", "type is error. type:%s", new Object[] { localObject2 });
