  ...
  extends HorizontalScrollView
{
  ...
  protected void onFinishInflate()
  {
    ...
    this.lgP = ((int)(this.mContext.getResources().getDisplayMetrics().density * 300.0F));
    setOverScrollMode(0);
  ...
  {
    return super.overScrollBy(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, this.lgP, paramInt8, paramBoolean);
  }
}
