...
public final class a
{
  ...
  public boolean uGL;
  private Map<String, Boolean> uGM;
  
  private a()
  {
    AppMethodBeat.i(42483);
    this.uGL = false;
    this.uGM = new ConcurrentHashMap();
  ...
  public final boolean ano(String paramString)
  {
    ...
    //   7: aload_1
    //   8: invokestatic 46	com/tencent/mm/sdk/platformtools/bu:isNullOrNil	(Ljava/lang/String;)Z
    //   11: ifeq +14 -> 25
    //   14: ldc 41
    ...
    //   24: ireturn
    //   25: aload_0
    //   26: getfield 32	com/tencent/mm/plugin/game/f/a:uGM	Ljava/util/Map;
    //   29: aload_1
    //   30: invokeinterface 52 2 0
    //   35: ifeq +22 -> 57
    //   38: aload_0
    //   39: getfield 32	com/tencent/mm/plugin/game/f/a:uGM	Ljava/util/Map;
    //   42: aload_1
    ...
    //   67: aload_1
    //   68: aastore
    //   69: invokestatic 71	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   72: aload_0
    //   73: getfield 32	com/tencent/mm/plugin/game/f/a:uGM	Ljava/util/Map;
    //   76: aload_1
  ...
  public final void anp(String paramString)
  {
    try
    {
      ...
      if ((!bu.isNullOrNil(paramString)) && (this.uGM.containsKey(paramString)))
      {
        ae.i("MicroMsg.GameCacheUtil", "download entrance image finish : %s", new Object[] { paramString });
        this.uGM.remove(paramString);
      }
  ...
  public final void ddc()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localInputStream = ak.getContext().getAssets().open("game_region_data.txt");
      ...
      catch (IOException localIOException4)
      {
        ...
        ae.e("MicroMsg.GameCacheUtil", "exception:%s", new Object[] { bu.o(localIOException4) });
        ...
        {
          ae.e("MicroMsg.GameCacheUtil", "exception:%s", new Object[] { bu.o(localIOException2) });
          str2 = "";
        }
        continue;
      }
      finally
      {
        ...
        catch (IOException localIOException3)
        {
          for (;;)
          {
            ae.e("MicroMsg.GameCacheUtil", "exception:%s", new Object[] { bu.o(localIOException3) });
          }
        }
        locala = new GameRegionPreference.a();
        locala.uDG = localIOException3[0];
        locala.uDH = localIOException3[1];
        locala.uDI = localIOException3[2];
        locala.eRl = localIOException3[3];
        locala.isSelected = false;
        locala.isDefault = false;
        this.uDJ.put(locala.eRl, locala);
        break label437;
      }
      try
      {
      ...
      {
        ae.e("MicroMsg.GameCacheUtil", "exception:%s", new Object[] { bu.o(localIOException1) });
    ...
    for (;;)
    {
      if (i < localObject1.length)
      {
        ...
        {
          ae.e("MicroMsg.GameCacheUtil", "this GameRegion item has problem %s", new Object[] { localObject1[i] });
          break label437;
        }
      }
      Object localObject2;
      ...
      Object localObject5 = e.dbl();
      localObject5 = (GameRegionPreference.a)this.uDJ.get(localObject5);
      if (localObject5 != null)
      {
        ((GameRegionPreference.a)localObject5).uDG = e.dbm();
        ((GameRegionPreference.a)localObject5).uDH = e.dbn();
        ((GameRegionPreference.a)localObject5).uDI = e.dbo();
  ...
  public final Map<String, GameRegionPreference.a> ddd()
  {
    try
    {
      AppMethodBeat.i(42487);
      ddc();
      Map localMap = this.uDJ;
