  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (int i = g.a.a.b.b.a.f(1, this.Title) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.xJG != null) {
        i = paramInt + g.a.a.b.b.a.f(3, this.xJG);
      }
      AppMethodBeat.o(41719);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localt.Title = locala.UbS.readString();
          AppMethodBeat.o(41719);
          return 0;
        case 2: 
          localt.Desc = locala.UbS.readString();
          AppMethodBeat.o(41719);
          return 0;
        }
        localt.xJG = locala.UbS.readString();
        AppMethodBeat.o(41719);
        return 0;
      }
      AppMethodBeat.o(41719);
