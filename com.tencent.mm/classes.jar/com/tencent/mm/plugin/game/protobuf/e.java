  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.xIF != null)
      {
        paramVarArgs.ni(3, this.xIF.computeSize());
        this.xIF.writeFields(paramVarArgs);
      }
      if (this.xIG != null) {
    ...
    if (paramInt == 1)
    {
      ...
      i = paramInt;
      if (this.xIF != null) {
        i = paramInt + g.a.a.a.nh(3, this.xIF.computeSize());
      }
      paramInt = i;
      if (this.xIG != null) {
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        locale.oUv = ((g.a.a.a.a)localObject1).UbS.zi();
        AppMethodBeat.o(41709);
        return 0;
      case 2: 
      ...
      case 3: 
        ...
        while (paramInt < i)
        {
          ...
          locale.xIF = ((c)localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(41709);
        return 0;
      }
      locale.xIG = ((g.a.a.a.a)localObject1).UbS.readString();
      AppMethodBeat.o(41709);
      return 0;
    }
    AppMethodBeat.o(41709);
