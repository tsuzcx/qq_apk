  ...
  extends erp
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      {
        paramVarArgs.qD(2, this.lbs_info.computeSize());
    ...
    for (paramInt = i.a.a.a.qC(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.lbs_info != null) {
        i = paramInt + i.a.a.a.qC(2, this.lbs_info.computeSize());
      }
      AppMethodBeat.o(275469);
      return i;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localGetCanJoinChatroomRequest.BaseRequest = ((kc)localObject2);
            paramInt += 1;
          }
          AppMethodBeat.o(275469);
          return 0;
