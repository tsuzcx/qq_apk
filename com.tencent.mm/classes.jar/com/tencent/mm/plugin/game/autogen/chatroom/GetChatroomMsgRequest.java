  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.bm(3, this.seq_gt);
      paramVarArgs.bm(4, this.seq_lt);
      AppMethodBeat.o(195620);
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = g.a.a.b.b.a.p(3, this.seq_gt);
      int j = g.a.a.b.b.a.p(4, this.seq_lt);
      AppMethodBeat.o(195620);
      return i + paramInt + j;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localGetChatroomMsgRequest.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(195620);
          return 0;
        case 2: 
          localGetChatroomMsgRequest.chatroom_name = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(195620);
          return 0;
        case 3: 
          localGetChatroomMsgRequest.seq_gt = ((g.a.a.a.a)localObject).abFh.AN();
          AppMethodBeat.o(195620);
          return 0;
        }
        localGetChatroomMsgRequest.seq_lt = ((g.a.a.a.a)localObject).abFh.AN();
        AppMethodBeat.o(195620);
        return 0;
      }
      AppMethodBeat.o(195620);
