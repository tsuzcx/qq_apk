  ...
  extends dyl
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    for (paramInt = g.a.a.a.oD(1, this.BaseRequest.computeSize()) + 0;; paramInt = 0)
    {
      ...
      paramInt = g.a.a.b.b.a.p(3, this.seq);
      AppMethodBeat.o(195336);
      return i + paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localReceiveChatroomMsgRequest.BaseRequest = localjg;
            paramInt += 1;
          }
          AppMethodBeat.o(195336);
          return 0;
        case 2: 
          localReceiveChatroomMsgRequest.chatroom_name = ((g.a.a.a.a)localObject).abFh.readString();
          AppMethodBeat.o(195336);
          return 0;
        }
        localReceiveChatroomMsgRequest.seq = ((g.a.a.a.a)localObject).abFh.AN();
        AppMethodBeat.o(195336);
        return 0;
      }
      AppMethodBeat.o(195336);
