  ...
  implements View.OnLongClickListener
{
  ...
  public final boolean onLongClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bd(paramView);
    a.b("com/tencent/mm/plugin/remittance/ui/RemittanceF2fDynamicCodeUI$4", "android/view/View$OnLongClickListener", "onLongClick", "(Landroid/view/View;)Z", this, localb.ahq());
    RemittanceF2fDynamicCodeUI.d(this.yfD);
