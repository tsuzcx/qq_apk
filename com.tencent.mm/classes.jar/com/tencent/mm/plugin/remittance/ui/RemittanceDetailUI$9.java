  ...
  implements d.a
{
  ...
  public final void cc(Object paramObject)
  {
    ...
    ac.i("MicroMsg.RemittanceDetailUI", "fetch detail failed: %s", new Object[] { paramObject });
    if (paramObject != null) {
    ...
    label68:
    for (paramObject = paramObject.toString();; paramObject = this.wRp.getString(2131765420))
    {
      Toast.makeText(this.wRp, paramObject, 1).show();
