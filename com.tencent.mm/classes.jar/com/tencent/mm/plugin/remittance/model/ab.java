  ...
  extends a
{
  ...
  public ab(double paramDouble, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    ...
    try
    {
      ...
      localHashMap.put("reason", URLEncoder.encode(bt.bI(paramString4, ""), "utf-8"));
  ...
  public final void onGYNetEnd(int paramInt, String paramString, JSONObject paramJSONObject)
  {
    ...
    this.xZE = paramJSONObject.optString("tradeurl");
    this.xYn = paramJSONObject.optInt("transfering_num");
    this.xZF = paramJSONObject.optInt("transfering_type");
    paramString.append("payurl:" + this.xYg);
    paramString.append(" tradeurl:" + this.xZE);
    paramString.append(" transfering_num:" + this.xYn);
    paramString.append(" transfering_type:" + this.xZF);
