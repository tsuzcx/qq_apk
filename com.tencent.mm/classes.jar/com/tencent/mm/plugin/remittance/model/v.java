  ...
  extends m
{
  ...
  public v(String paramString1, String paramString2, int paramInt1, String paramString3, String paramString4, int paramInt2)
  {
    ...
    ac.i("Micromsg.NetSceneTenpayRemittanceQuery", "trans_id=" + paramString2 + ";transaction_id=" + paramString1 + ";total_fee=" + paramInt1);
  ...
  public final void onGYNetEnd(int paramInt, String paramString, JSONObject paramJSONObject)
  {
    ...
    if (paramString != null) {
      this.unU = paramString.optString("guide_flag", "0");
    }
    if (paramJSONObject.has("intercept_win")) {
      this.unS = b.bn(paramJSONObject.optJSONObject("intercept_win"));
    }
    AppMethodBeat.o(67884);
  }
}
