  ...
  extends b
{
  ...
  public g(String paramString1, String paramString2)
  {
    ...
    locala.respCmdId = 0;
    this.rr = locala.atI();
    ((apv)this.rr.gUS.gUX).CVI = paramString1;
  ...
  public final void b(int paramInt1, int paramInt2, String paramString, q paramq)
  {
    ...
    this.vui = ((apw)((com.tencent.mm.al.b)paramq).gUT.gUX);
    ad.i("MicroMsg.NetSceneBankRemitGetBankInfo", "retcode: %s, retmsg: %s", new Object[] { Integer.valueOf(this.vui.dcG), this.vui.nTK });
  ...
  {
    paramq = (apw)((com.tencent.mm.al.b)paramq).gUT.gUX;
    this.IdO = paramq.dcG;
    this.IdP = paramq.nTK;
  }
