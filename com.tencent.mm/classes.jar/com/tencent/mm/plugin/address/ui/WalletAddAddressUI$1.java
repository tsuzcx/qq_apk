  ...
  implements AddrEditView.a
{
  ...
  public final void onClick()
  {
    ...
    boolean bool = b.a(this.jaI, "android.permission.READ_CONTACTS", 48, null, null);
    ac.i("MicroMsg.WalletAddAddressUI", "summerper checkPermission checkContacts[%b],stack[%s]", new Object[] { Boolean.valueOf(bool), bs.eWi() });
    if (!bool)
    {
      AppMethodBeat.o(20976);
      return;
    }
    WalletAddAddressUI.a(this.jaI);
    AppMethodBeat.o(20976);
  }
}
