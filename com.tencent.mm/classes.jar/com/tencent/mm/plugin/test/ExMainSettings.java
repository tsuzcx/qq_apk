  ...
  extends MMActivity
{
  ...
  public final void onCreate(Bundle paramBundle)
  {
    ...
    this.jfg.add(new b("朋友圈", 2131690250, (View.OnClickListener)new e(this)));
    this.jfg.add(new b("视频动态", 2131689897, (View.OnClickListener)new f(this)));
    this.jfg.add(new b("Live", 2131691550, (View.OnClickListener)new g(this)));
    ...
    this.jfg.add(new b("Finder", paramBundle, (View.OnClickListener)new h(this)));
    if (i.DEBUG) {
      this.jfg.add(new b("moveXlog", null, (View.OnClickListener)new i(this)));
    }
    this.gmV = ((RecyclerView)findViewById(2131303744));
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/test/ExMainSettings$Companion;", "", "()V", "TAG", "", "getTAG", "()Ljava/lang/String;", "app_release"})
  public static final class a {}
  
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/test/ExMainSettings$Info;", "", "name", "", "resId", "", "onClickListener", "Landroid/view/View$OnClickListener;", "(Ljava/lang/String;ILandroid/view/View$OnClickListener;)V", "Landroid/graphics/drawable/Drawable;", "(Ljava/lang/String;Landroid/graphics/drawable/Drawable;Landroid/view/View$OnClickListener;)V", "drawable", "getDrawable", "()Landroid/graphics/drawable/Drawable;", "setDrawable", "(Landroid/graphics/drawable/Drawable;)V", "getName", "()Ljava/lang/String;", "setName", "(Ljava/lang/String;)V", "getOnClickListener", "()Landroid/view/View$OnClickListener;", "setOnClickListener", "(Landroid/view/View$OnClickListener;)V", "getResId", "()Ljava/lang/Integer;", "setResId", "(Ljava/lang/Integer;)V", "Ljava/lang/Integer;", "app_release"})
  public static final class b
  {
    ...
    public b(String paramString, int paramInt, View.OnClickListener paramOnClickListener)
    {
      ...
      this.BpF = Integer.valueOf(paramInt);
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/test/ExMainSettings$SimpleAdapter;", "Landroid/support/v7/widget/RecyclerView$Adapter;", "Landroid/support/v7/widget/RecyclerView$ViewHolder;", "list", "Ljava/util/ArrayList;", "Lcom/tencent/mm/plugin/test/ExMainSettings$Info;", "(Ljava/util/ArrayList;)V", "getList", "()Ljava/util/ArrayList;", "getItemCount", "", "onBindViewHolder", "", "_holder", "position", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "app_release"})
  public static final class c
    extends RecyclerView.a<RecyclerView.w>
  {
    private final ArrayList<ExMainSettings.b> dbZ;
    
    public c(ArrayList<ExMainSettings.b> paramArrayList)
    {
      AppMethodBeat.i(163399);
      this.dbZ = paramArrayList;
    ...
    public final void a(RecyclerView.w paramw, int paramInt)
    {
      ...
      paramw = this.dbZ.get(paramInt);
      p.g(paramw, "list[position]");
      ExMainSettings.b localb = (ExMainSettings.b)paramw;
      TextView localTextView = ((ExMainSettings.d)localObject2).fQd;
      if (localb != null) {}
      for (paramw = localb.name;; paramw = null)
      {
        ...
        if (localb != null)
        {
          ...
          if (paramw != null)
          {
            ...
            ((ExMainSettings.d)localObject2).fUN.setImageResource(paramInt);
          }
        }
        if (localb != null)
        {
          ...
          if (paramw != null) {
            ((ExMainSettings.d)localObject2).fUN.setImageDrawable(paramw);
          }
        }
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"com/tencent/mm/plugin/test/ExMainSettings$initList$1", "Landroid/view/View$OnClickListener;", "onClick", "", "v", "Landroid/view/View;", "app_release"})
    ...
    implements View.OnClickListener
  {
    public final void onClick(View paramView)
    {
      ...
      com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/test/ExMainSettings$initList$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).ahq());
      localObject = new Intent((Context)this.BpG, Class.forName("com.tencent.mm.plugin.sns.ui.SnsSettingUI"));
      paramView = this.BpG;
      localObject = new com.tencent.mm.hellhoundlib.b.a().bc(localObject);
      com.tencent.mm.hellhoundlib.a.a.a(paramView, ((com.tencent.mm.hellhoundlib.b.a)localObject).ahp(), "com/tencent/mm/plugin/test/ExMainSettings$initList$1", "onClick", "(Landroid/view/View;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"com/tencent/mm/plugin/test/ExMainSettings$initList$2", "Landroid/view/View$OnClickListener;", "onClick", "", "v", "Landroid/view/View;", "app_release"})
    ...
    implements View.OnClickListener
  {
    public final void onClick(View paramView)
    {
      ...
      Object localObject = new b();
      ((b)localObject).bd(paramView);
      com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/test/ExMainSettings$initList$2", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).ahq());
      localObject = new Intent((Context)this.BpG, Class.forName("com.tencent.mm.plugin.story.ui.StorySettingsUI"));
      paramView = this.BpG;
      localObject = new com.tencent.mm.hellhoundlib.b.a().bc(localObject);
      com.tencent.mm.hellhoundlib.a.a.a(paramView, ((com.tencent.mm.hellhoundlib.b.a)localObject).ahp(), "com/tencent/mm/plugin/test/ExMainSettings$initList$2", "onClick", "(Landroid/view/View;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
      paramView.startActivity((Intent)((com.tencent.mm.hellhoundlib.b.a)localObject).mq(0));
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"com/tencent/mm/plugin/test/ExMainSettings$initList$3", "Landroid/view/View$OnClickListener;", "onClick", "", "v", "Landroid/view/View;", "app_release"})
    ...
    implements View.OnClickListener
  {
    public final void onClick(View paramView)
    {
      ...
      Object localObject = new b();
      ((b)localObject).bd(paramView);
      com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/test/ExMainSettings$initList$3", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).ahq());
      localObject = new Intent((Context)this.BpG, Class.forName("com.tencent.mm.live.ui.LiveUIG"));
      paramView = this.BpG;
      localObject = new com.tencent.mm.hellhoundlib.b.a().bc(localObject);
      com.tencent.mm.hellhoundlib.a.a.a(paramView, ((com.tencent.mm.hellhoundlib.b.a)localObject).ahp(), "com/tencent/mm/plugin/test/ExMainSettings$initList$3", "onClick", "(Landroid/view/View;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
      paramView.startActivity((Intent)((com.tencent.mm.hellhoundlib.b.a)localObject).mq(0));
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"com/tencent/mm/plugin/test/ExMainSettings$initList$4", "Landroid/view/View$OnClickListener;", "onClick", "", "v", "Landroid/view/View;", "app_release"})
    ...
    implements View.OnClickListener
  {
    public final void onClick(View paramView)
    {
      ...
      Object localObject = new b();
      ((b)localObject).bd(paramView);
      com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/test/ExMainSettings$initList$4", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).ahq());
      localObject = new Intent((Context)this.BpG, Class.forName("com.tencent.mm.plugin.finder.ui.FinderSettingsUI"));
      paramView = this.BpG;
      localObject = new com.tencent.mm.hellhoundlib.b.a().bc(localObject);
      com.tencent.mm.hellhoundlib.a.a.a(paramView, ((com.tencent.mm.hellhoundlib.b.a)localObject).ahp(), "com/tencent/mm/plugin/test/ExMainSettings$initList$4", "onClick", "(Landroid/view/View;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
      paramView.startActivity((Intent)((com.tencent.mm.hellhoundlib.b.a)localObject).mq(0));
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"com/tencent/mm/plugin/test/ExMainSettings$initList$5", "Landroid/view/View$OnClickListener;", "onClick", "", "v", "Landroid/view/View;", "app_release"})
    ...
    implements View.OnClickListener
  {
    public final void onClick(View paramView)
    {
      ...
      b localb = new b();
      localb.bd(paramView);
      com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/test/ExMainSettings$initList$5", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
      ad.moveLogsFromCacheDirToLogDir();
      Toast.makeText((Context)this.BpG.getContext(), (CharSequence)"move success", 0).show();
