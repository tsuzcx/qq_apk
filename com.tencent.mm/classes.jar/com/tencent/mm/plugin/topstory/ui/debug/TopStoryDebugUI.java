  ...
  extends MMActivity
{
  ...
  public void onCreate(final Bundle paramBundle)
  {
    ...
    paramBundle = z.Uj(1);
    this.Aas = ((TextView)findViewById(2131306292));
    this.Aas.setText(getString(2131764462, new Object[] { String.valueOf(paramBundle.aEh()) }));
    findViewById(2131298350).setOnClickListener(new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        AppMethodBeat.i(125894);
        i.cU(paramBundle.exF(), true);
    ...
    findViewById(2131303406).setOnClickListener(new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        ...
        try
        {
          paramAnonymousView = i.aSr(b.aph() + "topstory/trace.info");
          TopStoryDebugUI.bi(TopStoryDebugUI.this, paramAnonymousView);
