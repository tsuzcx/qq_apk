...
@l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/Atom/Mp4ParserStat;", "", "()V", "ID", "", "TAG", "", "markIncrementParseCost", "", "cost", "markParse", "useLazy", "", "markParseCost", "timeTableLength", "", "plugin-playvideo_release"})
public final class k
{
  public static final k hXN;
  ...
  public static void a(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      int j = ((Number)localt.JfT).intValue();
      h.vKh.m(1290L, paramInt, 1L);
      h.vKh.m(1290L, i, paramLong);
      h.vKh.m(1290L, j, 1L);
      AppMethodBeat.o(175936);
      return;
      h.vKh.m(1290L, 3L, paramLong);
      h.vKh.m(1290L, 4L, 1L);
      break;
      label258:
      if (30 < paramInt) {
  ...
  public static void mM(long paramLong)
  {
    ...
    if (paramLong >= 0L)
    {
      h.vKh.m(1290L, 72L, paramLong);
      h.vKh.m(1290L, 73L, 1L);
    }
