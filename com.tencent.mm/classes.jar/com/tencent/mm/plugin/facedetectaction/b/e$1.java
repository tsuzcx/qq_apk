  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    Object localObject = a.cTF();
    int i = this.moi;
    ((a)localObject).sUq.postToWorker(new a.4((a)localObject, i));
    localObject = a.cTF();
    float f = this.sXQ.fps;
    ((a)localObject).sUq.postToWorker(new a.5((a)localObject, f));
    localObject = this.sXS;
    byte[][] arrayOfByte = this.sXR;
    d.sXz.aj(new e.2((e)localObject, arrayOfByte));
