...
public final class l
{
  ...
  static
  {
    ...
    AMy = Uri.parse("content://com.lbe.security.miui.permmgr/active");
  ...
  public static int Fs(String paramString)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ac.e("VoipUtil", "getIntValFromDynamicConfig parseInt failed, val: ".concat(String.valueOf(paramString)));
      }
    }
  ...
  private static boolean emi()
  {
    ...
    //   52: invokestatic 213	com/tencent/mm/vfs/i:ag	(Lcom/tencent/mm/vfs/e;)Ljava/io/InputStream;
    //   55: astore 6
    //   57: aload 6
    //   59: astore 4
    //   61: aload 6
    ...
    //   137: invokestatic 243	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   140: ldc 191
  ...
  public static boolean eml()
  {
    ...
    be localbe = new be();
    a.GpY.l(localbe);
    boolean bool = localbe.daQ.daR;
    AppMethodBeat.o(115540);
    return bool;
  }
  
  /* Error */
  private static boolean gA(Context paramContext)
  {
    // Byte code:
    //   0: ldc_w 304
    //   3: invokestatic 19	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: aload_0
    //   7: invokevirtual 310	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   10: astore_0
    //   11: aload_0
    //   12: getstatic 125	com/tencent/mm/plugin/voip/b/l:AMy	Landroid/net/Uri;
    //   15: iconst_1
    ...
    //   42: astore 5
    //   44: aload 6
    //   46: invokeinterface 326 1 0
    //   51: ifle +353 -> 404
    //   54: aload 6
    //   56: astore 5
    //   58: aload 6
    //   60: invokeinterface 329 1 0
    //   65: ifeq +339 -> 404
    //   68: aload 6
    //   70: astore 5
    //   72: aload 6
    //   74: iconst_0
    //   75: invokeinterface 332 2 0
    //   80: istore_2
    //   81: aload_0
    //   82: astore 4
    //   84: iload_2
    ...
    //   113: iconst_0
    //   114: iload_1
    //   115: invokestatic 340	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   118: aastore
    //   119: dup
    //   120: iconst_1
    //   121: ldc_w 342
    ...
    //   126: iconst_2
    //   127: ldc_w 343
    //   130: invokestatic 340	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   133: aastore
    //   134: invokestatic 346	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   137: iconst_m1
    //   138: istore_2
    //   139: iload_1
    //   140: iconst_m1
    ...
    //   153: ior
    //   154: istore_3
    //   155: new 348	android/content/ContentValues
    //   158: dup
    //   159: invokespecial 349	android/content/ContentValues:<init>	()V
    //   162: astore_0
    //   163: aload_0
    //   164: ldc_w 312
    //   167: iload_3
    //   168: invokestatic 340	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   171: invokevirtual 353	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    //   174: aload 4
    //   176: getstatic 125	com/tencent/mm/plugin/voip/b/l:AMy	Landroid/net/Uri;
    //   179: aload_0
    //   180: ldc_w 314
    //   183: aconst_null
    //   184: invokevirtual 357	android/content/ContentResolver:update	(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    //   187: istore_1
    //   188: ldc 154
    //   190: ldc_w 359
    //   193: iconst_5
    ...
    //   198: iconst_0
    //   199: iload_3
    //   200: invokestatic 340	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   203: aastore
    //   204: dup
    //   205: iconst_1
    //   206: ldc_w 342
    ...
    //   211: iconst_2
    //   212: ldc_w 343
    //   215: invokestatic 340	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   218: aastore
    //   219: dup
    //   220: iconst_3
    //   221: ldc_w 361
    ...
    //   226: iconst_4
    //   227: iload_1
    //   228: invokestatic 340	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   231: aastore
    //   232: invokestatic 346	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   235: iload_1
    //   236: ifle +117 -> 353
    //   239: ldc_w 304
    ...
    //   272: iconst_1
    //   273: ldc_w 343
    //   276: invokestatic 340	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   279: aastore
    //   280: invokestatic 366	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   283: aload_0
    //   284: ifnull +115 -> 399
    //   287: aload_0
    //   288: invokeinterface 333 1 0
    //   293: iconst_m1
    //   294: istore_1
    //   295: goto -192 -> 103
    //   298: astore_0
    ...
    //   339: iconst_1
    //   340: ldc_w 343
    //   343: invokestatic 340	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   346: aastore
    //   347: invokestatic 366	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   350: goto -115 -> 235
    //   353: ldc_w 304
  ...
  private static boolean gB(Context paramContext)
  {
    ...
    //   6: aload_0
    //   7: invokevirtual 310	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   10: getstatic 125	com/tencent/mm/plugin/voip/b/l:AMy	Landroid/net/Uri;
    //   13: iconst_4
    ...
    //   44: aconst_null
    //   45: aconst_null
    //   46: invokevirtual 320	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   49: astore 6
    //   51: aload 6
    //   53: ifnull +147 -> 200
    //   56: aload 6
    ...
    //   244: iconst_1
    //   245: ldc_w 343
    //   248: invokestatic 340	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   251: aastore
    //   252: invokestatic 366	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   255: aload 6
    //   257: ifnull -45 -> 212
    //   260: aload 6
    //   262: invokeinterface 333 1 0
    //   267: goto -55 -> 212
    //   270: astore 6
    //   272: aconst_null
    //   273: astore_0
  ...
  public static boolean gy(Context paramContext)
  {
    ...
    boolean bool = false;
    if (emi() == true) {
      bool = gB(paramContext);
    }
    ac.d("VoipUtil", "isLbePermissionEnable ret:".concat(String.valueOf(bool)));
  ...
  public static boolean gz(Context paramContext)
  {
    ...
    boolean bool = false;
    if (emi() == true) {
      bool = gA(paramContext);
    }
    ac.d("VoipUtil", "setLbePermissionEnable ret:".concat(String.valueOf(bool)));
