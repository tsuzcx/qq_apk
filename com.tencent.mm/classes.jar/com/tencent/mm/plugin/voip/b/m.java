...
{
  public static Context Hhs;
  private static final Uri Hht;
  ...
  static
  {
    ...
    Hht = Uri.parse("content://com.lbe.security.miui.permmgr/active");
    AppMethodBeat.o(115542);
  }
  
  public static int Se(String paramString)
  {
    int i = 0;
  ...
  private static boolean fKG()
  {
    ...
    //   36: aload 7
    //   38: astore 5
    //   40: new 196	com/tencent/mm/vfs/o
    //   43: dup
    //   44: invokestatic 202	android/os/Environment:getRootDirectory	()Ljava/io/File;
    //   47: ldc 204
    //   49: invokespecial 207	com/tencent/mm/vfs/o:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   52: invokestatic 213	com/tencent/mm/vfs/s:ao	(Lcom/tencent/mm/vfs/o;)Ljava/io/InputStream;
    //   55: astore 6
    //   57: aload 6
    //   59: astore 4
    //   61: aload 6
    ...
    //   120: istore_0
    //   121: aload 6
    //   123: invokestatic 235	com/tencent/mm/vfs/aa:closeQuietly	(Ljava/io/Closeable;)V
    //   126: ldc 154
    //   128: ldc 237
    //   130: iload_0
    ...
    //   137: invokestatic 243	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   140: ldc 191
    ...
    //   163: aload 4
    //   165: invokestatic 235	com/tencent/mm/vfs/aa:closeQuietly	(Ljava/io/Closeable;)V
    //   168: iload_2
    //   169: istore_0
    //   170: goto -44 -> 126
    //   173: astore 4
    //   175: aload 5
    //   177: invokestatic 235	com/tencent/mm/vfs/aa:closeQuietly	(Ljava/io/Closeable;)V
    //   180: ldc 191
  ...
  public static boolean fKH()
  {
    ...
    bl localbl = new bl();
    EventCenter.instance.publish(localbl);
    boolean bool = localbl.dEG.isStarted;
  ...
  public static boolean fKI()
  {
    ...
    bu localbu = new bu();
    EventCenter.instance.publish(localbu);
    boolean bool = localbu.dEZ.isStarted;
  ...
  public static boolean fKJ()
  {
    ...
    bj localbj = new bj();
    EventCenter.instance.publish(localbj);
    boolean bool = localbj.dEB.dEC;
  ...
  /* Error */
  private static boolean hE(Context paramContext)
  {
    // Byte code:
    //   0: ldc_w 325
    //   3: invokestatic 19	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: aload_0
    //   7: invokevirtual 331	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   10: astore_0
    //   11: aload_0
    //   12: getstatic 125	com/tencent/mm/plugin/voip/b/m:Hht	Landroid/net/Uri;
    //   15: iconst_1
    ...
    //   28: aconst_null
    //   29: aconst_null
    //   30: invokevirtual 341	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   33: astore 6
    //   35: aload 6
    //   37: ifnull +367 -> 404
    //   40: aload 6
    ...
    //   56: astore 5
    //   58: aload 6
    //   60: invokeinterface 349 1 0
    //   65: ifeq +339 -> 404
    //   68: aload 6
    //   70: astore 5
    //   72: aload 6
    //   74: iconst_0
    //   75: invokeinterface 352 2 0
    //   80: istore_2
    //   81: aload_0
    //   82: astore 4
    //   84: iload_2
    ...
    //   113: iconst_0
    //   114: iload_1
    //   115: invokestatic 360	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   118: aastore
    //   119: dup
    //   120: iconst_1
    //   121: ldc_w 362
    ...
    //   126: iconst_2
    //   127: ldc_w 363
    //   130: invokestatic 360	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   133: aastore
    //   134: invokestatic 366	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   137: iconst_m1
    //   138: istore_2
    //   139: iload_1
    //   140: iconst_m1
    ...
    //   153: ior
    //   154: istore_3
    //   155: new 368	android/content/ContentValues
    //   158: dup
    //   159: invokespecial 369	android/content/ContentValues:<init>	()V
    //   162: astore_0
    //   163: aload_0
    //   164: ldc_w 333
    //   167: iload_3
    //   168: invokestatic 360	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   171: invokevirtual 373	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    //   174: aload 4
    //   176: getstatic 125	com/tencent/mm/plugin/voip/b/m:Hht	Landroid/net/Uri;
    //   179: aload_0
    //   180: ldc_w 335
    //   183: aconst_null
    //   184: invokevirtual 377	android/content/ContentResolver:update	(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    //   187: istore_1
    //   188: ldc 154
    //   190: ldc_w 379
    //   193: iconst_5
    ...
    //   198: iconst_0
    //   199: iload_3
    //   200: invokestatic 360	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   203: aastore
    //   204: dup
    //   205: iconst_1
    //   206: ldc_w 362
    ...
    //   211: iconst_2
    //   212: ldc_w 363
    //   215: invokestatic 360	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   218: aastore
    //   219: dup
    //   220: iconst_3
    //   221: ldc_w 381
    ...
    //   226: iconst_4
    //   227: iload_1
    //   228: invokestatic 360	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   231: aastore
    //   232: invokestatic 366	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   235: iload_1
    //   236: ifle +117 -> 353
    //   239: ldc_w 325
    ...
    //   272: iconst_1
    //   273: ldc_w 363
    //   276: invokestatic 360	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   279: aastore
    //   280: invokestatic 386	com/tencent/mm/sdk/platformtools/Log:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   283: aload_0
    //   284: ifnull +115 -> 399
    //   287: aload_0
    //   288: invokeinterface 353 1 0
    //   293: iconst_m1
    //   294: istore_1
    //   295: goto -192 -> 103
    //   298: astore_0
    ...
    //   339: iconst_1
    //   340: ldc_w 363
    //   343: invokestatic 360	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   346: aastore
    //   347: invokestatic 386	com/tencent/mm/sdk/platformtools/Log:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   350: goto -115 -> 235
    //   353: ldc_w 325
  ...
  private static boolean hF(Context paramContext)
  {
    ...
    //   6: aload_0
    //   7: invokevirtual 331	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   10: getstatic 125	com/tencent/mm/plugin/voip/b/m:Hht	Landroid/net/Uri;
    //   13: iconst_4
    ...
    //   44: aconst_null
    //   45: aconst_null
    //   46: invokevirtual 341	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   49: astore 6
    //   51: aload 6
    //   53: ifnull +147 -> 200
    //   56: aload 6
    ...
    //   85: aload 6
    //   87: iconst_0
    //   88: invokeinterface 352 2 0
    //   93: istore_1
    //   94: aload 6
    //   96: astore_0
    //   97: aload 6
    //   99: iconst_1
    //   100: invokeinterface 352 2 0
    //   105: istore_2
    //   106: aload 6
    //   108: astore_0
    //   109: aload 6
    //   111: iconst_2
    //   112: invokeinterface 352 2 0
    //   117: istore_3
    //   118: aload 6
    //   120: astore_0
    //   121: aload 6
    //   123: iconst_3
    //   124: invokeinterface 352 2 0
    //   129: istore 4
    //   131: iload_1
    //   132: ldc_w 363
    //   135: iand
    ...
    //   244: iconst_1
    //   245: ldc_w 363
    //   248: invokestatic 360	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   251: aastore
    //   252: invokestatic 386	com/tencent/mm/sdk/platformtools/Log:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   255: aload 6
    //   257: ifnull -45 -> 212
    //   260: aload 6
    //   262: invokeinterface 353 1 0
    //   267: goto -55 -> 212
    //   270: astore 6
    //   272: aconst_null
    //   273: astore_0
  ...
  public static void hG(Context paramContext)
  {
    ...
    Toast.makeText(paramContext, 2131767307, 0).show();
