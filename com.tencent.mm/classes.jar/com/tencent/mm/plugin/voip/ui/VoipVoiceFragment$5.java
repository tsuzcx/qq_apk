  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bd(paramView);
    a.b("com/tencent/mm/plugin/voip/ui/VoipVoiceFragment$2", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
    g.yhR.f(11619, new Object[] { Integer.valueOf(3) });
    if ((this.CkP.CiR != null) && (this.CkP.CiR.get() != null)) {
      ((c)this.CkP.CiR.get()).evC();
    }
