...
public final class d
{
  ...
  float[] OcI;
  float[] OcJ;
  com.tencent.mm.media.g.d[] Ocu;
  private int[] Ocv;
  private FloatBuffer Ocw;
  public b Ocx;
  com.tencent.mm.media.g.d Ocy;
  com.tencent.mm.media.g.d Ocz;
  ...
  public final void a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if ((this.ObM == null) || (this.ObM.capacity() != paramArrayOfFloat1.length)) {
      this.ObM = ByteBuffer.allocateDirect(paramArrayOfFloat1.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
    }
    this.ObM.put(paramArrayOfFloat1);
    this.ObM.position(0);
    e.d(paramArrayOfFloat2, paramArrayOfFloat3);
    if ((this.ObN == null) || (this.ObN.capacity() != paramArrayOfFloat3.length)) {
      this.ObN = ByteBuffer.allocateDirect(paramArrayOfFloat3.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
    }
    this.ObN.put(paramArrayOfFloat3);
    this.ObN.position(0);
    AppMethodBeat.o(236159);
  }
  
  final void alK(int paramInt)
  {
    int j = 2;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (j < i)
        {
          ...
          GLES20.glBindTexture(3553, this.Ocu[j].kVj);
          GLES20.glUniform1i(this.Ocv[j], j);
          j += 1;
          continue;
          if (paramInt != 3) {
            break label314;
          ...
          this.Ocv[0] = GLES20.glGetUniformLocation(this.mProgram, "samplerY");
          this.Ocv[1] = GLES20.glGetUniformLocation(this.mProgram, "samplerUV");
          i = j;
          break;
        }
      }
  ...
  final void b(ByteBuffer paramByteBuffer, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  public final com.tencent.mm.plugin.voip.video.d.b gBH()
  {
    ...
    if (this.ObO != null)
    {
      int i = this.ObO.outputWidth;
      int j = this.ObO.outputHeight;
      Object localObject = this.ObO;
      if ((((e)localObject).YGE != null) && (((e)localObject).outputHeight != 0) && (((e)localObject).outputWidth != 0)) {}
      for (localObject = ((e)localObject).Ocj; (localObject != null) && (this.outputHeight != 0) && (this.outputWidth != 0); localObject = null)
      {
  ...
  public final a gEj()
  {
    ...
    if (this.Ocx != null)
    {
      Object localObject = this.Ocx;
      if ((((b)localObject).Ocq != null) && (((b)localObject).outputHeight != 0) && (((b)localObject).outputWidth != 0))
      {
        localObject = new a(((b)localObject).outputWidth, ((b)localObject).outputHeight, 1, ((b)localObject).Ocj);
