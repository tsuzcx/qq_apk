...
{
  com.tencent.mm.media.f.d[] AQF;
  private int[] AQG;
  private FloatBuffer AQH;
  public b AQI;
  com.tencent.mm.media.f.d AQJ;
  com.tencent.mm.media.f.a AQK;
  boolean AQL;
  public float[] AQM;
  public float[] AQN;
  float[] AQO;
  ...
  public d()
  {
    ...
    this.mProgram = 0;
    this.AQF = new com.tencent.mm.media.f.d[3];
    this.AQG = new int[3];
    this.AQJ = null;
    this.AQK = null;
    this.AQL = false;
  ...
  final void Tb(int paramInt)
  {
    ...
    if (k < 0)
    {
      ac.e("MicroMsg.VoipGLSProgram", "int mPositionHandle error: %s, reinit program", new Object[] { Integer.valueOf(k) });
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (j < i)
        {
          ...
          GLES20.glBindTexture(3553, this.AQF[j].gRW);
          GLES20.glUniform1i(this.AQG[j], j);
          j += 1;
          continue;
          if (paramInt != 3) {
            break label303;
          ...
          this.AQG[0] = GLES20.glGetUniformLocation(this.mProgram, "samplerY");
          this.AQG[1] = GLES20.glGetUniformLocation(this.mProgram, "samplerUV");
          i = j;
          break;
        }
      }
  ...
  public final void emS()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        com.tencent.mm.media.f.d[] arrayOfd = this.AQF;
        int j = arrayOfd.length;
        if (i < j)
        {
          com.tencent.mm.media.f.d locald = arrayOfd[i];
          if (locald != null) {
            locald.close();
          }
        }
  ...
  public final a emW()
  {
    ...
    if (this.AQI != null)
    {
      Object localObject = this.AQI;
      if ((((b)localObject).AQB != null) && (((b)localObject).grB != 0) && (((b)localObject).grA != 0))
      {
        localObject = new a(((b)localObject).grA, ((b)localObject).grB, 1, ((b)localObject).AQu);
