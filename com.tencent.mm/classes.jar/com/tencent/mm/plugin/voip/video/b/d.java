...
{
  com.tencent.mm.media.g.d[] CpX;
  private int[] CpY;
  private FloatBuffer CpZ;
  public b Cqa;
  com.tencent.mm.media.g.d Cqb;
  com.tencent.mm.media.g.a Cqc;
  boolean Cqd;
  public float[] Cqe;
  public float[] Cqf;
  float[] Cqg;
  ...
  public d()
  {
    ...
    this.mProgram = 0;
    this.CpX = new com.tencent.mm.media.g.d[3];
    this.CpY = new int[3];
    this.Cqb = null;
    this.Cqc = null;
    this.Cqd = false;
    ...
    this.outputWidth = 0;
    this.outputHeight = 0;
    this.Cqe = new float[] { -1.0F, -1.0F, 1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 1.0F };
    this.Cqf = new float[] { 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F };
    this.Cqg = new float[] { -1.0F, -1.0F, 1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 1.0F };
    this.Cqh = new float[] { 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F };
    eAQ();
    eAT();
  ...
  final void UU(int paramInt)
  {
    ...
    if (k < 0)
    {
      ad.e("MicroMsg.VoipGLSProgram", "int mPositionHandle error: %s, reinit program", new Object[] { Integer.valueOf(k) });
    ...
    GLES20.glEnableVertexAttribArray(i);
    GLES20.glVertexAttribPointer(i, 2, 5126, false, 8, this.CpZ);
    if ((paramInt == 0) || (paramInt == 1))
    {
      this.CpY[0] = GLES20.glGetUniformLocation(this.mProgram, "samplerY");
      this.CpY[1] = GLES20.glGetUniformLocation(this.mProgram, "samplerU");
      this.CpY[2] = GLES20.glGetUniformLocation(this.mProgram, "samplerV");
      i = 3;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if (j < i)
        {
          ...
          GLES20.glBindTexture(3553, this.CpX[j].hko);
          GLES20.glUniform1i(this.CpY[j], j);
          j += 1;
          continue;
          if (paramInt != 3) {
            break label303;
          ...
          this.CpY[0] = GLES20.glGetUniformLocation(this.mProgram, "samplerY");
          this.CpY[1] = GLES20.glGetUniformLocation(this.mProgram, "samplerUV");
          i = j;
          break;
        }
      }
  ...
  final void a(ByteBuffer paramByteBuffer, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.CpX[paramInt3].a(paramInt1, paramInt2, 6409, paramByteBuffer, 9729, 33071);
  ...
  public final void c(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    ...
    if ((this.CpZ == null) || (this.CpZ.capacity() != paramArrayOfFloat2.length)) {
      this.CpZ = ByteBuffer.allocateDirect(paramArrayOfFloat2.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
    }
    this.CpZ.put(paramArrayOfFloat2);
    this.CpZ.position(0);
  ...
  public final void eAQ()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        com.tencent.mm.media.g.d[] arrayOfd = this.CpX;
  ...
  public final a eAU()
  {
    ...
    if (this.Cqa != null)
    {
      Object localObject = this.Cqa;
      if ((((b)localObject).CpT != null) && (((b)localObject).outputHeight != 0) && (((b)localObject).outputWidth != 0))
      {
        localObject = new a(((b)localObject).outputWidth, ((b)localObject).outputHeight, 1, ((b)localObject).CpM);
