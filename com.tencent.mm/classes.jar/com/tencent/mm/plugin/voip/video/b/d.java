...
{
  com.tencent.mm.media.g.d[] CHB;
  private int[] CHC;
  private FloatBuffer CHD;
  public b CHE;
  com.tencent.mm.media.g.d CHF;
  com.tencent.mm.media.g.a CHG;
  boolean CHH;
  public float[] CHI;
  public float[] CHJ;
  float[] CHK;
  ...
  public d()
  {
    ...
    this.mProgram = 0;
    this.CHB = new com.tencent.mm.media.g.d[3];
    this.CHC = new int[3];
    this.CHF = null;
    this.CHG = null;
    this.CHH = false;
  ...
  final void VB(int paramInt)
  {
    ...
    if (k < 0)
    {
      ae.e("MicroMsg.VoipGLSProgram", "int mPositionHandle error: %s, reinit program", new Object[] { Integer.valueOf(k) });
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (j < i)
        {
          ...
          GLES20.glBindTexture(3553, this.CHB[j].hnc);
          GLES20.glUniform1i(this.CHC[j], j);
          j += 1;
          continue;
          if (paramInt != 3) {
            break label303;
          ...
          this.CHC[0] = GLES20.glGetUniformLocation(this.mProgram, "samplerY");
          this.CHC[1] = GLES20.glGetUniformLocation(this.mProgram, "samplerUV");
          i = j;
          break;
        }
      }
  ...
  public final a eEC()
  {
    ...
    if (this.CHE != null)
    {
      Object localObject = this.CHE;
      if ((((b)localObject).CHx != null) && (((b)localObject).outputHeight != 0) && (((b)localObject).outputWidth != 0))
      {
        localObject = new a(((b)localObject).outputWidth, ((b)localObject).outputHeight, 1, ((b)localObject).CHq);
  ...
  public final void eEy()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        com.tencent.mm.media.g.d[] arrayOfd = this.CHB;
