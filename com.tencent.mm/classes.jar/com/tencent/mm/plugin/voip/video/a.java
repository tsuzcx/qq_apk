...
{
  private static final Pattern CDr;
  private static int CDs;
  private static int CDt;
  protected long CDA;
  protected int CDB;
  protected Camera.Parameters CDC;
  protected ac CDD;
  protected int CDE;
  protected boolean CDF;
  protected boolean CDG;
  protected boolean CDH;
  protected ObservableSurfaceView CDI;
  protected ObservableTextureView CDJ;
  protected f CDK;
  protected boolean CDL;
  protected boolean CDM;
  protected byte[] CDN;
  protected int[] CDO;
  protected List<byte[]> CDP;
  ...
  public a(int paramInt1, int paramInt2)
  {
    ...
    this.CDV = false;
    this.CDW = null;
    this.CDX = new Camera.PreviewCallback()
    {
      public final void onPreviewFrame(byte[] paramAnonymousArrayOfByte, Camera paramAnonymousCamera)
      {
        ...
        {
          com.tencent.mm.plugin.report.service.g.yxI.idkeyStat(159L, 0L, 1L, false);
          com.tencent.mm.plugin.report.service.g.yxI.idkeyStat(159L, 3L, 1L, false);
          if (a.this.CDK != null) {
            a.this.CDK.cbl();
          }
        ...
        if (a.this.CDD == null)
        {
          com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "onPreviewFrame mSize is null");
          AppMethodBeat.o(115544);
          return;
        }
        int m;
        ...
        if (a.this.CDK != null)
        {
          ...
          if (a.this.CDu)
          {
            ...
            k = i;
            if (com.tencent.mm.compatible.deviceinfo.ae.geM.gan.dHi == 0) {
              break label609;
            }
            j = com.tencent.mm.compatible.deviceinfo.ae.geM.gan.gaX;
            m = 1;
            k = i;
            i = m;
          }
        ...
        for (;;)
        {
          ...
          if (k > 0)
          {
            ...
            bool = true;
            label241:
            paramAnonymousCamera.CDv = bool;
            k = a.this.CDD.width;
            int n = a.this.CDD.height;
            if ((i == 0) || (a.this.cbk())) {
              break label522;
            }
            if (a.this.CDN == null)
            {
              i = k * n * 3 / 2;
              a.this.CDN = new byte[i];
              a.this.CDN[0] = 90;
            }
            com.tencent.mm.plugin.voip.c.eys().a(a.a(a.this), a.a(a.this).length, k, n, a.this.CDE, a.this.CDN, a.this.CDN.length, k, n, j);
            a.this.CDK.a(a.this.CDN, a.this.CDN.length, k, n, a.this.CDE, m);
          }
          for (;;)
          {
            if (n.getApiLevel() >= 8)
            {
              if (a.this.rza == null)
              {
                com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "the camera is null and has been release");
                AppMethodBeat.o(115544);
                return;
                j = j.CGe;
                k = j;
                ...
                k = j;
                if (com.tencent.mm.compatible.deviceinfo.ae.geM.gaq.dHi == 0) {
                  break label609;
                }
                m = com.tencent.mm.compatible.deviceinfo.ae.geM.gaq.gaX;
                i = 1;
                k = j;
                j = m;
                break;
                ...
                break label241;
                label522:
                a.this.CDK.a(a.a(a.this), a.a(a.this).length, a.this.CDD.width, a.this.CDD.height, a.this.CDE, m);
                continue;
              }
              if (a.this.rza != null) {
                a.this.rza.addCallbackBuffer(paramAnonymousArrayOfByte);
              }
            }
          }
          AppMethodBeat.o(115544);
    ...
    j.gM(ak.getContext().getApplicationContext());
    com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "width: %d, height: %d", new Object[] { Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight) });
  ...
  private static Point a(CharSequence paramCharSequence, Point paramPoint)
  {
    ...
    int i1 = 2147483647;
    paramCharSequence = CDr.split(paramCharSequence);
    ...
    for (int i = 0;; i = i4)
    {
      ...
      com.tencent.mm.sdk.platformtools.ae.w("MicroMsg.Voip.CaptureRender", "Bad preview-size: ".concat(String.valueOf(str)));
      i4 = i;
      i3 = j;
      i2 = i1;
      m += 1;
    ...
    for (;;)
    {
      ...
      try
      {
        n = bu.getInt(str.substring(0, k), 0);
        k = bu.getInt(str.substring(k + 1), 0);
  ...
  private static boolean a(v paramv, int paramInt1, int paramInt2)
  {
    ...
    {
      com.tencent.mm.plugin.report.service.g.yxI.idkeyStat(159L, 0L, 1L, false);
      com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "TryPreviewSize fail:" + paramv.toString());
      AppMethodBeat.o(115554);
    }
    return false;
  }
  ...
  private boolean c(v paramv, boolean paramBoolean)
  {
    ...
    try
    {
      com.tencent.mm.sdk.platformtools.ae.i("MicroMsg.Voip.CaptureRender", "trySetAutoFocus, isFrontCamera:%s", new Object[] { Boolean.valueOf(paramBoolean) });
      localParameters = paramv.getParameters();
      localList = localParameters.getSupportedFocusModes();
      if (localList == null) {
        break label224;
      }
      com.tencent.mm.sdk.platformtools.ae.i("MicroMsg.Voip.CaptureRender", "supported focus modes size = " + localList.size());
      Iterator localIterator = localList.iterator();
      while (localIterator.hasNext()) {
        com.tencent.mm.sdk.platformtools.ae.i("MicroMsg.Voip.CaptureRender", "supported focus modes : ".concat(String.valueOf((String)localIterator.next())));
      }
      if (com.tencent.mm.compatible.deviceinfo.ae.geM.gaP != 0) {
        break label268;
      }
    }
    catch (Exception paramv)
    {
      com.tencent.mm.plugin.report.service.g.yxI.idkeyStat(159L, 0L, 1L, false);
      com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "TrySetAutoFocus fail:" + paramv.toString());
      AppMethodBeat.o(115555);
      return false;
    }
    if (paramBoolean) {
      ...
      {
        com.tencent.mm.sdk.platformtools.ae.i("MicroMsg.Voip.CaptureRender", "camera support auto focus");
    ...
    for (;;)
    {
      ...
      {
        com.tencent.mm.sdk.platformtools.ae.i("MicroMsg.Voip.CaptureRender", "camera support continuous video focus");
        localParameters.setFocusMode("continuous-video");
        this.CDG = true;
        continue;
        label268:
        if ((com.tencent.mm.compatible.deviceinfo.ae.geM.gaP == 1) || (!paramBoolean)) {
          if (localList.contains("continuous-video"))
          {
            com.tencent.mm.sdk.platformtools.ae.i("MicroMsg.Voip.CaptureRender", "camera support continuous video focus");
            localParameters.setFocusMode("continuous-video");
  ...
  private void eDP()
  {
    ...
    for (;;)
    {
      try
      {
        if ((this.rza != null) && (this.CDF))
        {
          if ((this.CDD != null) && (this.CDD.height > 0) && (this.CDD.width > 0))
          {
            int j = this.CDD.height * this.CDD.width * 3 / 2;
            if (this.CDP == null)
            {
              this.CDP = new ArrayList(3);
              i = 0;
              if (i < 3)
              {
                this.CDP.add(new byte[j]);
                i += 1;
                continue;
                if (i < this.CDP.size())
                {
                  ...
                  this.rza.addCallbackBuffer((byte[])this.CDP.get(i));
                  break label225;
                }
                this.rza.setPreviewCallbackWithBuffer(this.CDX);
          ...
          {
            this.rza.setPreviewCallback(this.CDX);
          }
        }
        else
        {
      ...
      {
        com.tencent.mm.sdk.platformtools.ae.printErrStackTrace("MicroMsg.Voip.CaptureRender", localException, "setPreviewCallback error: %s", new Object[] { localException.getMessage() });
        AppMethodBeat.o(115551);
        return;
      }
      int i = 0;
    ...
    for (;;)
    {
      ...
      try
      {
        if (((Iterator)localObject).hasNext())
        {
          ...
          com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "support Size:" + localSize.width + "," + localSize.height);
          if (i == 0)
          {
            this.CDS = localSize.width;
            this.CDT = localSize.height;
          }
          i += 1;
          continue;
        }
        try
        {
          ...
          com.tencent.mm.sdk.platformtools.ae.i("MicroMsg.Voip.CaptureRender", "support Format:".concat(String.valueOf(((Integer)paramv.next()).intValue())));
          continue;
          com.tencent.mm.sdk.platformtools.ae.printErrStackTrace("MicroMsg.Voip.CaptureRender", paramv, "", new Object[0]);
        }
        catch (Exception paramv) {}
      }
      catch (Exception paramv)
  ...
  private static void h(v paramv)
  {
    ...
    catch (Exception paramv)
    {
      ...
      for (;;)
      {
        com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "getSupportedPreviewFrameRates:error:" + paramv.toString());
        List localList = null;
      }
      com.tencent.mm.sdk.platformtools.ae.i("MicroMsg.Voip.CaptureRender", localv);
  ...
  private int l(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    //   18: invokestatic 327	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   21: aload_0
    //   22: iconst_0
    //   23: putfield 118	com/tencent/mm/plugin/voip/video/a:CDG	Z
    //   26: iconst_1
    //   27: istore 17
    //   29: iload 17
    //   31: istore 16
    //   33: aload_0
    //   34: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   37: ifnull +52 -> 89
    //   40: aload_0
    //   41: getfield 98	com/tencent/mm/plugin/voip/video/a:CDu	Z
    //   44: iload_1
    //   45: if_icmpeq +78 -> 123
    //   48: aload_0
    //   49: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   52: getfield 467	com/tencent/mm/compatible/deviceinfo/v:gdl	Z
    //   55: ifne +11 -> 66
    //   58: aload_0
    //   59: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   62: aconst_null
    ...
    //   66: aload_0
    //   67: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   70: invokevirtual 470	com/tencent/mm/compatible/deviceinfo/v:stopPreview	()V
    //   73: aload_0
    //   74: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   77: invokevirtual 473	com/tencent/mm/compatible/deviceinfo/v:release	()V
    //   80: aload_0
    //   81: aconst_null
    //   82: putfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   85: iload 17
    //   87: istore 16
    //   89: iload 16
    //   91: ifeq +46 -> 137
    ...
    //   95: aload_0
    //   96: iload_1
    //   97: invokespecial 477	com/tencent/mm/plugin/voip/video/a:tL	(Z)Lcom/tencent/mm/compatible/deviceinfo/v;
    //   100: putfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   103: aload_0
    //   104: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   107: ifnonnull +25 -> 132
    //   110: aload_0
    //   111: iconst_0
    //   112: putfield 116	com/tencent/mm/plugin/voip/video/a:CDF	Z
    //   115: ldc_w 459
    //   118: invokestatic 90	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   121: iconst_m1
    //   122: ireturn
    //   123: aload_0
    //   124: getfield 146	com/tencent/mm/plugin/voip/video/a:CDV	Z
    //   127: istore 16
    //   129: goto -40 -> 89
    //   132: aload_0
    //   133: iconst_0
    //   134: putfield 146	com/tencent/mm/plugin/voip/video/a:CDV	Z
    //   137: aload_0
    //   138: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   141: ifnull +11 -> 152
    //   144: aload_0
    //   145: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   148: invokevirtual 257	com/tencent/mm/compatible/deviceinfo/v:getParameters	()Landroid/hardware/Camera$Parameters;
    //   151: pop
    //   152: aload_0
    //   153: iconst_1
    //   154: putfield 116	com/tencent/mm/plugin/voip/video/a:CDF	Z
    //   157: aload_0
    //   158: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   161: astore 18
    //   163: getstatic 481	com/tencent/mm/plugin/voip/video/j:CGa	Lcom/tencent/mm/plugin/voip/video/g;
    //   166: getfield 486	com/tencent/mm/plugin/voip/video/g:CEx	I
    //   169: istore 11
    //   171: aload 18
    //   173: ifnull +256 -> 429
    //   176: bipush 26
    ...
    //   196: aastore
    //   197: invokestatic 310	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   200: aload 18
    //   202: invokevirtual 257	com/tencent/mm/compatible/deviceinfo/v:getParameters	()Landroid/hardware/Camera$Parameters;
    //   205: astore 19
    //   207: invokestatic 491	com/tencent/mm/sdk/platformtools/ak:coh	()Z
    //   210: ifeq +27 -> 237
    //   213: ldc_w 493
    ...
    //   227: ldc_w 505
    //   230: bipush 26
    //   232: invokevirtual 508	com/tencent/mm/n/e:getInt	(Ljava/lang/String;I)I
    //   235: istore 4
    //   237: ldc 172
    //   239: ldc_w 510
    //   242: iconst_1
    ...
    //   253: aastore
    //   254: invokestatic 310	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   257: invokestatic 515	com/tencent/mm/compatible/util/k:Xu	()Z
    //   260: ifne +11 -> 271
    //   263: iload 4
    //   265: invokestatic 521	com/tencent/mm/compatible/util/d:lA	(I)Z
    //   268: ifeq +1114 -> 1382
    //   271: ldc 192
    //   273: istore 6
    //   275: iconst_0
    ...
    //   281: iconst_0
    //   282: istore 7
    //   284: getstatic 351	com/tencent/mm/compatible/deviceinfo/ae:geM	Lcom/tencent/mm/compatible/deviceinfo/c;
    //   287: ifnull +1752 -> 2039
    //   290: getstatic 351	com/tencent/mm/compatible/deviceinfo/ae:geM	Lcom/tencent/mm/compatible/deviceinfo/c;
    //   293: getfield 524	com/tencent/mm/compatible/deviceinfo/c:gaS	I
    //   296: sipush 1000
    //   299: imul
    //   300: istore 8
    //   302: getstatic 351	com/tencent/mm/compatible/deviceinfo/ae:geM	Lcom/tencent/mm/compatible/deviceinfo/c;
    //   305: getfield 527	com/tencent/mm/compatible/deviceinfo/c:gaT	I
    //   308: sipush 1000
    //   311: imul
    //   312: istore 7
    //   314: goto +1725 -> 2039
    ...
    //   357: aastore
    //   358: invokestatic 310	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   361: iload 8
    //   363: ldc 192
    ...
    //   404: aastore
    //   405: invokestatic 310	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   408: aload 18
    ...
    //   457: invokestatic 327	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   460: iload_1
    //   461: ifeq +992 -> 1453
    //   464: getstatic 481	com/tencent/mm/plugin/voip/video/j:CGa	Lcom/tencent/mm/plugin/voip/video/g;
    //   467: getfield 540	com/tencent/mm/plugin/voip/video/g:CEC	Landroid/graphics/Point;
    //   470: astore 18
    //   472: aload 18
    //   474: ifnull +990 -> 1464
    //   477: iconst_1
    ...
    //   543: invokestatic 327	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   546: aload_0
    //   547: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    ...
    //   612: invokestatic 327	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   615: aload 20
    //   617: aload 22
    ...
    //   715: invokestatic 327	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   718: iload 4
    //   720: ifeq +779 -> 1499
    //   723: aload_0
    //   724: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   727: aload 19
    ...
    //   778: invokestatic 327	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   781: iload_1
    //   782: ifne +838 -> 1620
    //   785: aload 18
    //   787: ifnull +833 -> 1620
    ...
    //   827: invokestatic 296	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   830: aload_0
    //   831: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   834: aload 18
    ...
    //   887: invokestatic 296	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   890: ldc_w 459
    //   893: invokestatic 90	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   896: iconst_m1
    //   897: ireturn
    //   898: astore 18
    //   900: getstatic 272	com/tencent/mm/plugin/report/service/g:yxI	Lcom/tencent/mm/plugin/report/service/g;
    //   903: ldc2_w 273
    //   906: lconst_0
    //   907: lconst_1
    //   908: iconst_0
    //   909: invokevirtual 278	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
    //   912: ldc 172
    //   914: ldc_w 567
    //   917: iconst_1
    ...
    //   928: aastore
    //   929: invokestatic 569	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   932: aload_0
    //   933: getfield 571	com/tencent/mm/plugin/voip/video/a:CDK	Lcom/tencent/mm/plugin/voip/video/f;
    //   936: ifnull +54 -> 990
    //   939: aload_0
    //   940: getfield 571	com/tencent/mm/plugin/voip/video/a:CDK	Lcom/tencent/mm/plugin/voip/video/f;
    //   943: invokeinterface 576 1 0
    //   948: aload_0
    //   949: iconst_1
    //   950: putfield 146	com/tencent/mm/plugin/voip/video/a:CDV	Z
    //   953: aload_0
    //   954: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   957: getfield 467	com/tencent/mm/compatible/deviceinfo/v:gdl	Z
    //   960: ifne +11 -> 971
    //   963: aload_0
    //   964: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   967: aconst_null
    ...
    //   971: aload_0
    //   972: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   975: invokevirtual 470	com/tencent/mm/compatible/deviceinfo/v:stopPreview	()V
    //   978: aload_0
    //   979: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   982: invokevirtual 473	com/tencent/mm/compatible/deviceinfo/v:release	()V
    //   985: aload_0
    //   986: aconst_null
    //   987: putfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   990: ldc_w 459
    ...
    //   1018: aastore
    //   1019: invokestatic 419	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1022: goto -32 -> 990
    //   1025: iload 8
    //   1027: ifne +24 -> 1051
    //   1030: iload 7
    ...
    //   1187: aastore
    //   1188: invokestatic 310	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1191: iload 8
    //   1193: iflt +831 -> 2024
    //   1196: iload 10
    //   1198: iload 8
    ...
    //   1356: aastore
    //   1357: invokestatic 310	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1360: aload 19
    //   1362: iload 8
    //   1364: iload 7
    ...
    //   1413: invokestatic 296	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   1416: iconst_1
    //   1417: istore 4
    //   1419: goto -1036 -> 383
    //   1422: astore 18
    ...
    //   1447: invokestatic 296	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   1450: goto -1021 -> 429
    //   1453: getstatic 481	com/tencent/mm/plugin/voip/video/j:CGa	Lcom/tencent/mm/plugin/voip/video/g;
    //   1456: getfield 604	com/tencent/mm/plugin/voip/video/g:CED	Landroid/graphics/Point;
    //   1459: astore 18
    //   1461: goto -989 -> 472
    //   1464: iconst_0
    //   1465: istore 4
    ...
    //   1492: aastore
    //   1493: invokestatic 569	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1496: goto -778 -> 718
    //   1499: ldc 172
    //   1501: ldc_w 608
    //   1504: invokestatic 327	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   1507: aload 18
    ...
    //   1549: invokestatic 327	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   1552: aload_0
    //   1553: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   1556: aload 18
    ...
    //   1609: invokestatic 296	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   1612: ldc_w 459
    ...
    //   1620: aload_0
    //   1621: aload_0
    //   1622: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   1625: aload_0
    //   1626: getfield 98	com/tencent/mm/plugin/voip/video/a:CDu	Z
    //   1629: invokespecial 614	com/tencent/mm/plugin/voip/video/a:c	(Lcom/tencent/mm/compatible/deviceinfo/v;Z)Z
    //   1632: pop
    //   1633: aload_0
    //   1634: aload_0
    //   1635: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   1638: invokevirtual 257	com/tencent/mm/compatible/deviceinfo/v:getParameters	()Landroid/hardware/Camera$Parameters;
    //   1641: putfield 616	com/tencent/mm/plugin/voip/video/a:CDC	Landroid/hardware/Camera$Parameters;
    //   1644: aload_0
    //   1645: getfield 616	com/tencent/mm/plugin/voip/video/a:CDC	Landroid/hardware/Camera$Parameters;
    ...
    //   1676: putfield 377	com/tencent/mm/plugin/voip/video/a:CDD	Lcom/tencent/mm/compatible/deviceinfo/ac;
    //   1679: aload_0
    //   1680: getfield 616	com/tencent/mm/plugin/voip/video/a:CDC	Landroid/hardware/Camera$Parameters;
    //   1683: invokevirtual 623	android/hardware/Camera$Parameters:getPreviewFrameRate	()I
    //   1686: istore_3
    //   1687: aload_0
    //   1688: getstatic 626	com/tencent/mm/plugin/voip/video/j:CGf	I
    //   1691: putfield 628	com/tencent/mm/plugin/voip/video/a:CDE	I
    //   1694: aload_0
    //   1695: getfield 628	com/tencent/mm/plugin/voip/video/a:CDE	I
    //   1698: ifgt +9 -> 1707
    //   1701: aload_0
    //   1702: bipush 7
    //   1704: putfield 628	com/tencent/mm/plugin/voip/video/a:CDE	I
    //   1707: aload_0
    //   1708: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   1711: astore 18
    ...
    //   1720: astore 19
    //   1722: aload_0
    //   1723: getfield 98	com/tencent/mm/plugin/voip/video/a:CDu	Z
    //   1726: ifeq +233 -> 1959
    //   1729: getstatic 634	com/tencent/mm/plugin/voip/video/j:CGb	I
    //   1732: istore_2
    //   1733: iload_2
    //   1734: aload 19
    //   1736: invokestatic 640	android/hardware/Camera:getCameraInfo	(ILandroid/hardware/Camera$CameraInfo;)V
    //   1739: invokestatic 159	com/tencent/mm/sdk/platformtools/ak:getContext	()Landroid/content/Context;
    //   1742: ldc_w 642
    ...
    //   1797: getfield 98	com/tencent/mm/plugin/voip/video/a:CDu	Z
    //   1800: ifeq +166 -> 1966
    //   1803: sipush 360
    //   1806: iload_2
    //   1807: aload 19
    ...
    //   1829: aload_0
    //   1830: iload_2
    //   1831: putfield 665	com/tencent/mm/plugin/voip/video/a:CDR	I
    //   1834: ldc 172
    //   1836: ldc_w 667
    //   1839: bipush 6
    ...
    //   1852: iconst_1
    //   1853: aload_0
    //   1854: getfield 377	com/tencent/mm/plugin/voip/video/a:CDD	Lcom/tencent/mm/compatible/deviceinfo/ac;
    ...
    //   1865: iconst_2
    //   1866: aload_0
    //   1867: getfield 377	com/tencent/mm/plugin/voip/video/a:CDD	Lcom/tencent/mm/compatible/deviceinfo/ac;
    ...
    //   1878: iconst_3
    //   1879: aload_0
    //   1880: getfield 628	com/tencent/mm/plugin/voip/video/a:CDE	I
    //   1883: invokestatic 180	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   1886: aastore
    //   1887: dup
    //   1888: iconst_4
    //   1889: getstatic 670	com/tencent/mm/plugin/voip/video/j:CGd	I
    //   1892: invokestatic 180	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   1895: aastore
    //   1896: dup
    //   1897: iconst_5
    //   1898: aload_0
    //   1899: getfield 665	com/tencent/mm/plugin/voip/video/a:CDR	I
    //   1902: invokestatic 180	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   1905: aastore
    //   1906: invokestatic 310	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1909: ldc_w 459
    //   1912: invokestatic 90	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   1915: iconst_1
    //   1916: ireturn
    //   1917: astore 18
    //   1919: getstatic 272	com/tencent/mm/plugin/report/service/g:yxI	Lcom/tencent/mm/plugin/report/service/g;
    //   1922: ldc2_w 273
    //   1925: lconst_0
    //   1926: lconst_1
    //   1927: iconst_0
    //   1928: invokevirtual 278	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
    //   1931: ldc 172
    //   1933: ldc_w 672
    //   1936: iconst_1
    ...
    //   1947: aastore
    //   1948: invokestatic 569	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1951: ldc_w 459
    //   1954: invokestatic 90	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   1957: iconst_m1
    //   1958: ireturn
    //   1959: getstatic 675	com/tencent/mm/plugin/voip/video/j:CGc	I
    //   1962: istore_2
    //   1963: goto -230 -> 1733
    //   1966: aload 19
    ...
    //   2003: aastore
    //   2004: invokestatic 569	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2007: goto -173 -> 1834
    //   2010: astore 20
    //   2012: goto -536 -> 1476
    //   2015: goto -1424 -> 591
  ...
  private static v tK(boolean paramBoolean)
  {
    localObject2 = null;
    ...
    for (;;)
    {
      try
      {
        locala = com.tencent.mm.compatible.deviceinfo.d.a(ak.getContext(), j.CGb, null);
        com.tencent.mm.sdk.platformtools.ae.i("Camera", "Use front");
        localObject1 = localObject2;
        if (locala != null) {
          localObject1 = locala.gaZ;
        }
      }
      catch (Exception localException)
      {
        d.a.a locala;
        com.tencent.mm.plugin.report.service.g.yxI.idkeyStat(159L, 0L, 1L, false);
        com.tencent.mm.plugin.report.service.g.yxI.idkeyStat(159L, 1L, 1L, false);
        com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "openCameraByHighApiLvl:error:" + localException.toString());
        Object localObject1 = localObject2;
        continue;
      }
      AppMethodBeat.o(115552);
      return localObject1;
      locala = com.tencent.mm.compatible.deviceinfo.d.a(ak.getContext(), j.CGc, null);
      com.tencent.mm.sdk.platformtools.ae.i("Camera", "Use back");
    }
  }
  
  private v tL(boolean paramBoolean)
  {
    AppMethodBeat.i(115553);
    v localv = tK(paramBoolean);
    if (localv == null) {}
    for (;;)
    {
      try
      ...
      {
        com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "OpenCameraError:" + localException.toString());
        com.tencent.mm.plugin.report.service.g.yxI.idkeyStat(159L, 0L, 1L, false);
        com.tencent.mm.plugin.report.service.g.yxI.idkeyStat(159L, 1L, 1L, false);
        if (this.CDK != null) {
          this.CDK.cbl();
  ...
  public final void F(int[] paramArrayOfInt)
  {
    ...
    if ((com.tencent.mm.compatible.deviceinfo.ae.geM.gaP == 1) && (this.CDG))
    {
      AppMethodBeat.o(115561);
      return;
    }
    if (com.tencent.mm.compatible.deviceinfo.ae.geM.gaO > 2000) {
      this.CDA = com.tencent.mm.compatible.deviceinfo.ae.geM.gaO;
    }
    if (paramArrayOfInt == null)
    {
      com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "focusOnFace error, faceLocation is null");
      boolean bool2;
      if (System.currentTimeMillis() - this.CDz > this.CDA)
      {
        bool1 = true;
        if ((this.CDw) && (!bool1) && (this.CDx == this.CDu)) {
          break label336;
        }
        ...
        bool2 = true;
        label131:
        paramArrayOfInt = paramArrayOfInt.append(bool2).append(",isAutoFocusTimeout: ").append(bool1).append(",mAutoFocusTimeOut:").append(this.CDA).append(",mIsLastAutoFocusFaceCamera != mIsCurrentFaceCamera :");
        if (this.CDx == this.CDu) {
          break label304;
        }
      }
      label298:
      ...
      {
        com.tencent.mm.sdk.platformtools.ae.i("MicroMsg.Voip.CaptureRender", bool1 + ",isClickScreen :false");
        try
        {
          if ((this.rza != null) && (this.rza.getParameters() != null) && (this.rza.getParameters().getFocusMode() != null) && (this.rza.getParameters().getFocusMode().equals("auto")))
          {
            this.rza.autoFocus(null);
            this.CDO = null;
        ...
        {
          com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "mCamera.getParameters() or autoFocus fail!" + paramArrayOfInt.toString());
        }
        bool1 = false;
        break;
        bool2 = false;
    ...
    if (this.CDO == null)
    {
      ...
      com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "face location diff:%d", new Object[] { Integer.valueOf(k) });
      if (k <= CDt)
      {
        j = i;
        if (k <= CDs) {}
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = this.rza.getParameters();
        k = j;
        ArrayList localArrayList;
        if (j != 0)
        {
          if ((com.tencent.mm.compatible.util.d.lA(14)) && (((Camera.Parameters)localObject).getMaxNumMeteringAreas() > 0))
          {
        ...
        else
        {
          ...
          if ((!com.tencent.mm.compatible.util.d.lA(14)) || (((Camera.Parameters)localObject).getMaxNumFocusAreas() <= 0)) {
            continue;
          }
          localArrayList = new ArrayList();
          localArrayList.add(new Camera.Area(paramArrayOfInt, 1000));
          ...
          j = i;
          break label815;
          this.rza.setParameters((Camera.Parameters)localObject);
          if (j != 0)
          {
            com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "refocus, mIsFocusOnFace:%b", new Object[] { Boolean.valueOf(this.CDQ) });
            if (this.CDQ)
            {
              this.CDw = false;
              this.CDQ = false;
              this.rza.autoFocus(new Camera.AutoFocusCallback()
              {
                public final void onAutoFocus(boolean paramAnonymousBoolean, Camera paramAnonymousCamera)
                {
                  AppMethodBeat.i(115543);
                  com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "onAutoFocus, success:%b", new Object[] { Boolean.valueOf(paramAnonymousBoolean) });
                  a.this.CDQ = true;
        ...
        com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "camera not support metering area");
        k = 0;
        continue;
        com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "camera not support area focus");
        j = 0;
      }
      catch (Exception paramArrayOfInt)
      {
        com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "focusOnFace exception:%s", new Object[] { paramArrayOfInt.getMessage() });
      }
      AppMethodBeat.o(115561);
      return;
      k = 0;
  ...
  public final void a(SurfaceHolder paramSurfaceHolder)
  {
    ...
    com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "surfaceChange");
    if ((!this.CDF) || (paramSurfaceHolder.getSurface() == null))
    {
      boolean bool2 = this.CDF;
      if (paramSurfaceHolder.getSurface() == null) {
        bool1 = true;
      }
      com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "surfaceChange failed, CameraOpen: %b, surface: %b, apiLevel: %s", new Object[] { Boolean.valueOf(bool2), Boolean.valueOf(bool1), Integer.valueOf(Build.VERSION.SDK_INT) });
    ...
    try
    {
      ...
      this.rza.setPreviewDisplay(paramSurfaceHolder);
      eDP();
      this.rza.startPreview();
      this.rzb = true;
    }
    catch (Exception paramSurfaceHolder)
    {
      ...
      {
        com.tencent.mm.plugin.report.service.g.yxI.idkeyStat(159L, 0L, 1L, false);
        com.tencent.mm.plugin.report.service.g.yxI.idkeyStat(159L, 2L, 1L, false);
        com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "surfaceChange failed" + paramSurfaceHolder.getMessage());
        this.CDB = 1;
      }
    }
    if (this.CDM)
    ...
    if (!cbk()) {
      com.tencent.mm.plugin.voip.c.eys().UT(this.CDB);
    }
    AppMethodBeat.o(115548);
  }
  ...
  public final void a(ObservableSurfaceView paramObservableSurfaceView)
  {
    ...
    com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "bind ObservableSurfaceView");
    if (paramObservableSurfaceView == null)
    {
      AppMethodBeat.o(115546);
      return;
    }
    this.CDI = paramObservableSurfaceView;
    this.CDI.setSurfaceChangeCallback(this);
    this.CDH = true;
    AppMethodBeat.o(115546);
  }
  ...
  public final void a(ObservableTextureView paramObservableTextureView)
  {
    ...
    com.tencent.mm.sdk.platformtools.ae.i("MicroMsg.Voip.CaptureRender", "bind ObservableTextureView");
    if (paramObservableTextureView == null)
    {
      AppMethodBeat.o(115547);
      return;
    }
    this.CDJ = paramObservableTextureView;
    this.CDJ.setTextureChangeCallback(this);
    this.CDH = false;
    AppMethodBeat.o(115547);
  }
  ...
  public final void eDQ()
  {
    ...
    if (j.CGa.gag < 2)
    {
      com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "ExchangeCapture...gCameraNum= " + j.CGa.gag);
      AppMethodBeat.o(115558);
      return;
    }
    com.tencent.mm.sdk.platformtools.ae.i("MicroMsg.Voip.CaptureRender", "ExchangeCapture start, gCameraNum= " + j.CGa.gag);
    eDT();
    f localf = this.CDK;
    if (!this.CDu) {}
  ...
  public final void eDR()
  {
    ...
    com.tencent.mm.sdk.platformtools.ae.i("MicroMsg.Voip.CaptureRender", "exchangeToHignCapture 1280 true");
    eDT();
    this.mWidth = 1280;
    this.mHeight = 720;
    a(this.CDK, this.CDu);
  ...
  public final int eDS()
  {
    ...
    //   3: invokestatic 73	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: aload_0
    //   7: getfield 116	com/tencent/mm/plugin/voip/video/a:CDF	Z
    //   10: ifne +24 -> 34
    //   13: ldc 172
    //   15: ldc_w 898
    //   18: invokestatic 296	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   21: aload_0
    //   22: iconst_1
    //   23: putfield 114	com/tencent/mm/plugin/voip/video/a:CDB	I
    //   26: ldc_w 896
    //   29: invokestatic 90	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   32: iconst_m1
    //   33: ireturn
    //   34: aload_0
    //   35: getfield 124	com/tencent/mm/plugin/voip/video/a:CDL	Z
    //   38: ifeq +19 -> 57
    //   41: ldc 172
    //   43: ldc_w 900
    //   46: invokestatic 296	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   49: ldc_w 896
    //   52: invokestatic 90	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   55: iconst_m1
    //   56: ireturn
    //   57: aload_0
    //   58: getfield 122	com/tencent/mm/plugin/voip/video/a:CDI	Lcom/tencent/mm/plugin/video/ObservableSurfaceView;
    //   61: ifnull +34 -> 95
    //   64: aload_0
    //   65: getfield 122	com/tencent/mm/plugin/voip/video/a:CDI	Lcom/tencent/mm/plugin/video/ObservableSurfaceView;
    //   68: invokevirtual 903	com/tencent/mm/plugin/video/ObservableSurfaceView:evw	()Z
    //   71: ifne +24 -> 95
    //   74: ldc 172
    //   76: ldc_w 905
    //   79: invokestatic 433	com/tencent/mm/sdk/platformtools/ae:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   82: aload_0
    //   83: iconst_1
    //   84: putfield 126	com/tencent/mm/plugin/voip/video/a:CDM	Z
    //   87: ldc_w 896
    ...
    //   105: iconst_0
    //   106: aload_0
    //   107: getfield 120	com/tencent/mm/plugin/voip/video/a:CDH	Z
    //   110: invokestatic 308	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   113: aastore
    //   114: invokestatic 186	com/tencent/mm/sdk/platformtools/ae:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   117: aload_0
    //   118: getfield 122	com/tencent/mm/plugin/voip/video/a:CDI	Lcom/tencent/mm/plugin/video/ObservableSurfaceView;
    //   121: ifnull +109 -> 230
    //   124: aload_0
    //   125: getfield 120	com/tencent/mm/plugin/voip/video/a:CDH	Z
    //   128: ifeq +102 -> 230
    //   131: aload_0
    //   132: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   135: aload_0
    //   136: getfield 122	com/tencent/mm/plugin/voip/video/a:CDI	Lcom/tencent/mm/plugin/video/ObservableSurfaceView;
    //   139: invokevirtual 911	com/tencent/mm/plugin/video/ObservableSurfaceView:getSurfaceHolder	()Landroid/view/SurfaceHolder;
    //   142: invokevirtual 833	com/tencent/mm/compatible/deviceinfo/v:setPreviewDisplay	(Landroid/view/SurfaceHolder;)V
    //   145: aload_0
    //   146: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   149: invokevirtual 836	com/tencent/mm/compatible/deviceinfo/v:startPreview	()V
    //   152: aload_0
    //   153: iconst_1
    //   154: putfield 144	com/tencent/mm/plugin/voip/video/a:rzb	Z
    //   157: aload_0
    //   158: iconst_1
    //   159: putfield 124	com/tencent/mm/plugin/voip/video/a:CDL	Z
    //   162: ldc_w 896
    //   165: invokestatic 90	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   168: iconst_1
    //   169: ireturn
    //   170: astore_1
    //   171: getstatic 272	com/tencent/mm/plugin/report/service/g:yxI	Lcom/tencent/mm/plugin/report/service/g;
    //   174: ldc2_w 273
    //   177: lconst_0
    //   178: lconst_1
    //   179: iconst_0
    //   180: invokevirtual 278	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
    //   183: getstatic 272	com/tencent/mm/plugin/report/service/g:yxI	Lcom/tencent/mm/plugin/report/service/g;
    //   186: ldc2_w 273
    //   189: ldc2_w 854
    //   192: lconst_1
    //   193: iconst_0
    //   194: invokevirtual 278	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
    //   197: aload_0
    //   198: iconst_1
    //   199: putfield 114	com/tencent/mm/plugin/voip/video/a:CDB	I
    //   202: ldc 172
    ...
    //   224: invokestatic 296	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   227: goto -82 -> 145
    //   230: aload_0
    //   231: getfield 873	com/tencent/mm/plugin/voip/video/a:CDJ	Lcom/tencent/mm/plugin/video/ObservableTextureView;
    //   234: ifnull -89 -> 145
    //   237: aload_0
    //   238: getfield 120	com/tencent/mm/plugin/voip/video/a:CDH	Z
    //   241: ifne -96 -> 145
    //   244: aload_0
    //   245: getfield 375	com/tencent/mm/plugin/voip/video/a:rza	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   248: aload_0
    //   249: getfield 873	com/tencent/mm/plugin/voip/video/a:CDJ	Lcom/tencent/mm/plugin/video/ObservableTextureView;
    //   252: invokevirtual 917	com/tencent/mm/plugin/video/ObservableTextureView:getSurfaceTexture	()Landroid/graphics/SurfaceTexture;
    //   255: invokevirtual 921	com/tencent/mm/compatible/deviceinfo/v:setPreviewTexture	(Landroid/graphics/SurfaceTexture;)V
    //   258: goto -113 -> 145
    //   261: astore_1
    //   262: getstatic 272	com/tencent/mm/plugin/report/service/g:yxI	Lcom/tencent/mm/plugin/report/service/g;
    //   265: ldc2_w 273
    //   268: lconst_0
    //   269: lconst_1
    //   270: iconst_0
    //   271: invokevirtual 278	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
    //   274: getstatic 272	com/tencent/mm/plugin/report/service/g:yxI	Lcom/tencent/mm/plugin/report/service/g;
    //   277: ldc2_w 273
    //   280: ldc2_w 854
    //   283: lconst_1
    //   284: iconst_0
    //   285: invokevirtual 278	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
    //   288: aload_0
    //   289: iconst_1
    //   290: putfield 114	com/tencent/mm/plugin/voip/video/a:CDB	I
    //   293: ldc 172
    ...
    //   315: invokestatic 296	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   318: goto -173 -> 145
    //   321: astore_1
    //   322: getstatic 272	com/tencent/mm/plugin/report/service/g:yxI	Lcom/tencent/mm/plugin/report/service/g;
    //   325: ldc2_w 273
    //   328: lconst_0
    //   329: lconst_1
    //   330: iconst_0
    //   331: invokevirtual 278	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
    //   334: getstatic 272	com/tencent/mm/plugin/report/service/g:yxI	Lcom/tencent/mm/plugin/report/service/g;
    //   337: ldc2_w 273
    //   340: ldc2_w 854
    //   343: lconst_1
    //   344: iconst_0
    //   345: invokevirtual 278	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
    //   348: aload_0
    //   349: iconst_1
    //   350: putfield 114	com/tencent/mm/plugin/voip/video/a:CDB	I
    //   353: aload_0
    //   354: getfield 571	com/tencent/mm/plugin/voip/video/a:CDK	Lcom/tencent/mm/plugin/voip/video/f;
    //   357: ifnull +12 -> 369
    //   360: aload_0
    //   361: getfield 571	com/tencent/mm/plugin/voip/video/a:CDK	Lcom/tencent/mm/plugin/voip/video/f;
    ...
    //   391: invokestatic 296	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   394: goto -237 -> 157
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	397	0	this	a
  ...
  public final void eDT()
  {
    ...
    com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "StopCapture....mIsInCapture = " + this.CDL);
    if ((this.CDL) && (this.rza != null))
    {
      this.CDM = false;
      if (!this.rza.gdl) {
        this.rza.setPreviewCallback(null);
    ...
    try
    {
      ...
      if (1 == this.CDB)
      {
        ot localot = new ot();
        localot.dDO.type = 2;
        com.tencent.mm.sdk.b.a.IvT.l(localot);
      }
      com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "UnInitCapture....mCameraOpen = " + this.CDF);
      if (this.CDF)
      {
        this.CDB = 0;
        this.CDM = false;
        if ((this.rza != null) && (!this.rza.gdl))
        {
          this.rza.setPreviewCallback(null);
          this.rza.release();
        }
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "stopPreview:error" + localException.toString());
        continue;
        if (this.rza != null)
        {
          if (!this.rza.gdl) {
  ...
  public final void f(SurfaceTexture paramSurfaceTexture)
  {
    ...
    com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.Voip.CaptureRender", "onSurfaceTextureAvailable");
    if ((!this.CDF) || (paramSurfaceTexture == null))
    {
      boolean bool2 = this.CDF;
      if (paramSurfaceTexture == null) {
        bool1 = true;
      }
      com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "onSurfaceTextureAvailable failed, CameraOpen: %b, surface: %b", new Object[] { Boolean.valueOf(bool2), Boolean.valueOf(bool1) });
    ...
    try
    {
      ...
      this.rza.stopPreview();
      this.rza.setPreviewTexture(paramSurfaceTexture);
      eDP();
      this.rza.startPreview();
      this.rzb = true;
    }
    catch (Exception paramSurfaceTexture)
    {
      for (;;)
      {
        com.tencent.mm.plugin.report.service.g.yxI.idkeyStat(159L, 0L, 1L, false);
        com.tencent.mm.plugin.report.service.g.yxI.idkeyStat(159L, 2L, 1L, false);
        com.tencent.mm.sdk.platformtools.ae.e("MicroMsg.Voip.CaptureRender", "surfaceChange failed" + paramSurfaceTexture.getMessage());
        this.CDB = 1;
      }
    }
    if (this.CDM)
