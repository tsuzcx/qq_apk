  ...
  implements com.tencent.mm.plugin.video.a, b
{
  ...
  protected long ClW;
  protected int ClX;
  protected Camera.Parameters ClY;
  protected ac ClZ;
  protected int Cma;
  protected boolean Cmb;
  protected boolean Cmc;
  protected boolean Cmd;
  protected ObservableSurfaceView Cme;
  protected ObservableTextureView Cmf;
  protected f Cmg;
  protected boolean Cmh;
  protected boolean Cmi;
  protected byte[] Cmj;
  protected int[] Cmk;
  protected List<byte[]> Cml;
  ...
  public a(int paramInt1, int paramInt2)
  {
    ...
    this.Cmr = false;
    this.Cms = null;
    this.Cmt = new Camera.PreviewCallback()
    {
      public final void onPreviewFrame(byte[] paramAnonymousArrayOfByte, Camera paramAnonymousCamera)
      {
        ...
        {
          com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(159L, 0L, 1L, false);
          com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(159L, 3L, 1L, false);
          if (a.this.Cmg != null) {
            a.this.Cmg.bZW();
          }
        ...
        for (;;)
        {
          ...
          if (k > 0)
          {
            ...
            bool = true;
            label241:
            paramAnonymousCamera.ClR = bool;
            k = a.this.ClZ.width;
            int n = a.this.ClZ.height;
            if ((i == 0) || (a.this.bZV())) {
              break label522;
            }
            if (a.this.Cmj == null)
            {
              i = k * n * 3 / 2;
              a.this.Cmj = new byte[i];
              a.this.Cmj[0] = 90;
            }
            com.tencent.mm.plugin.voip.c.euM().a(a.a(a.this), a.a(a.this).length, k, n, a.this.Cma, a.this.Cmj, a.this.Cmj.length, k, n, j);
            a.this.Cmg.a(a.this.Cmj, a.this.Cmj.length, k, n, a.this.Cma, m);
          }
          for (;;)
          {
            if (n.getApiLevel() >= 8)
            {
              if (a.this.rqL == null)
              {
                ...
                break label241;
                label522:
                a.this.Cmg.a(a.a(a.this), a.a(a.this).length, a.this.ClZ.width, a.this.ClZ.height, a.this.Cma, m);
                continue;
              }
              if (a.this.rqL != null) {
                a.this.rqL.addCallbackBuffer(paramAnonymousArrayOfByte);
              }
            }
          }
          AppMethodBeat.o(115544);
    ...
    j.gH(aj.getContext().getApplicationContext());
  ...
  private static Point a(CharSequence paramCharSequence, Point paramPoint)
  {
    ...
    int i1 = 2147483647;
    paramCharSequence = ClN.split(paramCharSequence);
  ...
  private void eAh()
  {
    ...
    for (;;)
    {
      try
      {
        if ((this.rqL != null) && (this.Cmb))
        {
          if ((this.ClZ != null) && (this.ClZ.height > 0) && (this.ClZ.width > 0))
          {
            int j = this.ClZ.height * this.ClZ.width * 3 / 2;
            if (this.Cml == null)
            {
              this.Cml = new ArrayList(3);
              i = 0;
              if (i < 3)
              {
                this.Cml.add(new byte[j]);
                i += 1;
                continue;
                if (i < this.Cml.size())
                {
                  ...
                  this.rqL.addCallbackBuffer((byte[])this.Cml.get(i));
                  break label225;
                }
                this.rqL.setPreviewCallbackWithBuffer(this.Cmt);
          ...
          {
            this.rqL.setPreviewCallback(this.Cmt);
          }
        }
        else
        {
    ...
    for (;;)
    {
      ...
      try
      {
        if (((Iterator)localObject).hasNext())
        {
          ...
          if (i == 0)
          {
            this.Cmo = localSize.width;
            this.Cmp = localSize.height;
          }
          i += 1;
          continue;
        }
  ...
  private int l(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    //   21: aload_0
    //   22: iconst_0
    //   23: putfield 118	com/tencent/mm/plugin/voip/video/a:Cmc	Z
    //   26: iconst_1
    //   27: istore 17
    //   29: iload 17
    //   31: istore 16
    //   33: aload_0
    //   34: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   37: ifnull +52 -> 89
    //   40: aload_0
    //   41: getfield 98	com/tencent/mm/plugin/voip/video/a:ClQ	Z
    //   44: iload_1
    //   45: if_icmpeq +78 -> 123
    //   48: aload_0
    //   49: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   52: getfield 467	com/tencent/mm/compatible/deviceinfo/v:gbd	Z
    //   55: ifne +11 -> 66
    //   58: aload_0
    //   59: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   62: aconst_null
    ...
    //   66: aload_0
    //   67: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   70: invokevirtual 470	com/tencent/mm/compatible/deviceinfo/v:stopPreview	()V
    //   73: aload_0
    //   74: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   77: invokevirtual 473	com/tencent/mm/compatible/deviceinfo/v:release	()V
    //   80: aload_0
    //   81: aconst_null
    //   82: putfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   85: iload 17
    //   87: istore 16
    //   89: iload 16
    //   91: ifeq +46 -> 137
    ...
    //   95: aload_0
    //   96: iload_1
    //   97: invokespecial 477	com/tencent/mm/plugin/voip/video/a:tE	(Z)Lcom/tencent/mm/compatible/deviceinfo/v;
    //   100: putfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   103: aload_0
    //   104: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   107: ifnonnull +25 -> 132
    //   110: aload_0
    //   111: iconst_0
    //   112: putfield 116	com/tencent/mm/plugin/voip/video/a:Cmb	Z
    //   115: ldc_w 459
    //   118: invokestatic 90	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   121: iconst_m1
    //   122: ireturn
    //   123: aload_0
    //   124: getfield 146	com/tencent/mm/plugin/voip/video/a:Cmr	Z
    //   127: istore 16
    //   129: goto -40 -> 89
    //   132: aload_0
    //   133: iconst_0
    //   134: putfield 146	com/tencent/mm/plugin/voip/video/a:Cmr	Z
    //   137: aload_0
    //   138: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   141: ifnull +11 -> 152
    //   144: aload_0
    //   145: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   148: invokevirtual 257	com/tencent/mm/compatible/deviceinfo/v:getParameters	()Landroid/hardware/Camera$Parameters;
    //   151: pop
    //   152: aload_0
    //   153: iconst_1
    //   154: putfield 116	com/tencent/mm/plugin/voip/video/a:Cmb	Z
    //   157: aload_0
    //   158: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   161: astore 18
    //   163: getstatic 481	com/tencent/mm/plugin/voip/video/j:Cow	Lcom/tencent/mm/plugin/voip/video/g;
    //   166: getfield 486	com/tencent/mm/plugin/voip/video/g:CmT	I
    //   169: istore 11
    //   171: aload 18
    //   173: ifnull +256 -> 429
    //   176: bipush 26
    ...
    //   205: astore 19
    //   207: invokestatic 491	com/tencent/mm/sdk/platformtools/aj:cmR	()Z
    //   210: ifeq +27 -> 237
    //   213: ldc_w 493
    ...
    //   257: invokestatic 515	com/tencent/mm/compatible/util/k:Xm	()Z
    //   260: ifne +11 -> 271
    //   263: iload 4
    //   265: invokestatic 521	com/tencent/mm/compatible/util/d:ly	(I)Z
    //   268: ifeq +1114 -> 1382
    //   271: ldc 192
    //   273: istore 6
    //   275: iconst_0
    ...
    //   281: iconst_0
    //   282: istore 7
    //   284: getstatic 351	com/tencent/mm/compatible/deviceinfo/ae:gcE	Lcom/tencent/mm/compatible/deviceinfo/c;
    //   287: ifnull +1752 -> 2039
    //   290: getstatic 351	com/tencent/mm/compatible/deviceinfo/ae:gcE	Lcom/tencent/mm/compatible/deviceinfo/c;
    //   293: getfield 524	com/tencent/mm/compatible/deviceinfo/c:fYL	I
    //   296: sipush 1000
    //   299: imul
    //   300: istore 8
    //   302: getstatic 351	com/tencent/mm/compatible/deviceinfo/ae:gcE	Lcom/tencent/mm/compatible/deviceinfo/c;
    //   305: getfield 527	com/tencent/mm/compatible/deviceinfo/c:fYM	I
    //   308: sipush 1000
    //   311: imul
    //   312: istore 7
    //   314: goto +1725 -> 2039
    ...
    //   460: iload_1
    //   461: ifeq +992 -> 1453
    //   464: getstatic 481	com/tencent/mm/plugin/voip/video/j:Cow	Lcom/tencent/mm/plugin/voip/video/g;
    //   467: getfield 540	com/tencent/mm/plugin/voip/video/g:CmY	Landroid/graphics/Point;
    //   470: astore 18
    //   472: aload 18
    //   474: ifnull +990 -> 1464
    //   477: iconst_1
    ...
    //   546: aload_0
    //   547: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    ...
    //   720: ifeq +779 -> 1499
    //   723: aload_0
    //   724: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   727: aload 19
    ...
    //   830: aload_0
    //   831: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   834: aload 18
    ...
    //   897: ireturn
    //   898: astore 18
    //   900: getstatic 272	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
    //   903: ldc2_w 273
    //   906: lconst_0
    //   907: lconst_1
    //   908: iconst_0
    ...
    //   932: aload_0
    //   933: getfield 571	com/tencent/mm/plugin/voip/video/a:Cmg	Lcom/tencent/mm/plugin/voip/video/f;
    //   936: ifnull +54 -> 990
    //   939: aload_0
    //   940: getfield 571	com/tencent/mm/plugin/voip/video/a:Cmg	Lcom/tencent/mm/plugin/voip/video/f;
    //   943: invokeinterface 576 1 0
    //   948: aload_0
    //   949: iconst_1
    //   950: putfield 146	com/tencent/mm/plugin/voip/video/a:Cmr	Z
    //   953: aload_0
    //   954: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   957: getfield 467	com/tencent/mm/compatible/deviceinfo/v:gbd	Z
    //   960: ifne +11 -> 971
    //   963: aload_0
    //   964: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   967: aconst_null
    ...
    //   971: aload_0
    //   972: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   975: invokevirtual 470	com/tencent/mm/compatible/deviceinfo/v:stopPreview	()V
    //   978: aload_0
    //   979: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   982: invokevirtual 473	com/tencent/mm/compatible/deviceinfo/v:release	()V
    //   985: aload_0
    //   986: aconst_null
    //   987: putfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   990: ldc_w 459
    ...
    //   1450: goto -1021 -> 429
    //   1453: getstatic 481	com/tencent/mm/plugin/voip/video/j:Cow	Lcom/tencent/mm/plugin/voip/video/g;
    //   1456: getfield 604	com/tencent/mm/plugin/voip/video/g:CmZ	Landroid/graphics/Point;
    //   1459: astore 18
    //   1461: goto -989 -> 472
    //   1464: iconst_0
    //   1465: istore 4
    ...
    //   1552: aload_0
    //   1553: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   1556: aload 18
    ...
    //   1620: aload_0
    //   1621: aload_0
    //   1622: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   1625: aload_0
    //   1626: getfield 98	com/tencent/mm/plugin/voip/video/a:ClQ	Z
    //   1629: invokespecial 614	com/tencent/mm/plugin/voip/video/a:c	(Lcom/tencent/mm/compatible/deviceinfo/v;Z)Z
    //   1632: pop
    //   1633: aload_0
    //   1634: aload_0
    //   1635: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   1638: invokevirtual 257	com/tencent/mm/compatible/deviceinfo/v:getParameters	()Landroid/hardware/Camera$Parameters;
    //   1641: putfield 616	com/tencent/mm/plugin/voip/video/a:ClY	Landroid/hardware/Camera$Parameters;
    //   1644: aload_0
    //   1645: getfield 616	com/tencent/mm/plugin/voip/video/a:ClY	Landroid/hardware/Camera$Parameters;
    ...
    //   1676: putfield 377	com/tencent/mm/plugin/voip/video/a:ClZ	Lcom/tencent/mm/compatible/deviceinfo/ac;
    //   1679: aload_0
    //   1680: getfield 616	com/tencent/mm/plugin/voip/video/a:ClY	Landroid/hardware/Camera$Parameters;
    //   1683: invokevirtual 623	android/hardware/Camera$Parameters:getPreviewFrameRate	()I
    //   1686: istore_3
    //   1687: aload_0
    //   1688: getstatic 626	com/tencent/mm/plugin/voip/video/j:CoB	I
    //   1691: putfield 628	com/tencent/mm/plugin/voip/video/a:Cma	I
    //   1694: aload_0
    //   1695: getfield 628	com/tencent/mm/plugin/voip/video/a:Cma	I
    //   1698: ifgt +9 -> 1707
    //   1701: aload_0
    //   1702: bipush 7
    //   1704: putfield 628	com/tencent/mm/plugin/voip/video/a:Cma	I
    //   1707: aload_0
    //   1708: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   1711: astore 18
    ...
    //   1720: astore 19
    //   1722: aload_0
    //   1723: getfield 98	com/tencent/mm/plugin/voip/video/a:ClQ	Z
    //   1726: ifeq +233 -> 1959
    //   1729: getstatic 634	com/tencent/mm/plugin/voip/video/j:Cox	I
    //   1732: istore_2
    //   1733: iload_2
    //   1734: aload 19
    ...
    //   1797: getfield 98	com/tencent/mm/plugin/voip/video/a:ClQ	Z
    //   1800: ifeq +166 -> 1966
    //   1803: sipush 360
    //   1806: iload_2
    //   1807: aload 19
    ...
    //   1829: aload_0
    //   1830: iload_2
    //   1831: putfield 665	com/tencent/mm/plugin/voip/video/a:Cmn	I
    //   1834: ldc 172
    //   1836: ldc_w 667
    //   1839: bipush 6
    ...
    //   1852: iconst_1
    //   1853: aload_0
    //   1854: getfield 377	com/tencent/mm/plugin/voip/video/a:ClZ	Lcom/tencent/mm/compatible/deviceinfo/ac;
    ...
    //   1865: iconst_2
    //   1866: aload_0
    //   1867: getfield 377	com/tencent/mm/plugin/voip/video/a:ClZ	Lcom/tencent/mm/compatible/deviceinfo/ac;
    ...
    //   1878: iconst_3
    //   1879: aload_0
    //   1880: getfield 628	com/tencent/mm/plugin/voip/video/a:Cma	I
    //   1883: invokestatic 180	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   1886: aastore
    //   1887: dup
    //   1888: iconst_4
    //   1889: getstatic 670	com/tencent/mm/plugin/voip/video/j:Coz	I
    //   1892: invokestatic 180	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   1895: aastore
    //   1896: dup
    //   1897: iconst_5
    //   1898: aload_0
    //   1899: getfield 665	com/tencent/mm/plugin/voip/video/a:Cmn	I
    ...
    //   1916: ireturn
    //   1917: astore 18
    //   1919: getstatic 272	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
    //   1922: ldc2_w 273
    //   1925: lconst_0
    //   1926: lconst_1
    //   1927: iconst_0
    ...
    //   1957: iconst_m1
    //   1958: ireturn
    //   1959: getstatic 675	com/tencent/mm/plugin/voip/video/j:Coy	I
    //   1962: istore_2
    //   1963: goto -230 -> 1733
    //   1966: aload 19
  ...
  private static v tD(boolean paramBoolean)
  {
    localObject2 = null;
    ...
    for (;;)
    {
      try
      {
        locala = com.tencent.mm.compatible.deviceinfo.d.a(aj.getContext(), j.Cox, null);
        ad.i("Camera", "Use front");
        localObject1 = localObject2;
        if (locala != null) {
          localObject1 = locala.fYS;
        }
      }
      catch (Exception localException)
      {
        d.a.a locala;
        com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(159L, 0L, 1L, false);
        com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(159L, 1L, 1L, false);
      ...
      AppMethodBeat.o(115552);
      return localObject1;
      locala = com.tencent.mm.compatible.deviceinfo.d.a(aj.getContext(), j.Coy, null);
      ad.i("Camera", "Use back");
    }
  }
  
  private v tE(boolean paramBoolean)
  {
    AppMethodBeat.i(115553);
    v localv = tD(paramBoolean);
    if (localv == null) {}
    for (;;)
    {
      try
  ...
  public final void E(int[] paramArrayOfInt)
  {
    ...
    if (paramArrayOfInt == null)
    {
      ...
      boolean bool2;
      if (System.currentTimeMillis() - this.ClV > this.ClW)
      {
        bool1 = true;
        if ((this.ClS) && (!bool1) && (this.ClT == this.ClQ)) {
          break label336;
        }
        ...
        bool2 = true;
        label131:
        paramArrayOfInt = paramArrayOfInt.append(bool2).append(",isAutoFocusTimeout: ").append(bool1).append(",mAutoFocusTimeOut:").append(this.ClW).append(",mIsLastAutoFocusFaceCamera != mIsCurrentFaceCamera :");
        if (this.ClT == this.ClQ) {
          break label304;
        }
      }
      label298:
      ...
      for (boolean bool1 = bool3;; bool1 = false)
      {
        ...
        try
        {
          if ((this.rqL != null) && (this.rqL.getParameters() != null) && (this.rqL.getParameters().getFocusMode() != null) && (this.rqL.getParameters().getFocusMode().equals("auto")))
          {
            this.rqL.autoFocus(null);
            this.Cmk = null;
    ...
    if (this.Cmk == null)
    {
      this.Cmk = paramArrayOfInt;
      i = 1;
      localObject = this.Cmk;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = this.rqL.getParameters();
        k = j;
        ArrayList localArrayList;
        if (j != 0)
        {
          if ((com.tencent.mm.compatible.util.d.ly(14)) && (((Camera.Parameters)localObject).getMaxNumMeteringAreas() > 0))
          {
        ...
        else
        {
          ...
          if ((!com.tencent.mm.compatible.util.d.ly(14)) || (((Camera.Parameters)localObject).getMaxNumFocusAreas() <= 0)) {
            continue;
          }
          localArrayList = new ArrayList();
          localArrayList.add(new Camera.Area(paramArrayOfInt, 1000));
          ...
          j = i;
          break label815;
          this.rqL.setParameters((Camera.Parameters)localObject);
          if (j != 0)
          {
            ad.d("MicroMsg.Voip.CaptureRender", "refocus, mIsFocusOnFace:%b", new Object[] { Boolean.valueOf(this.Cmm) });
            if (this.Cmm)
            {
              this.ClS = false;
              this.Cmm = false;
              this.rqL.autoFocus(new Camera.AutoFocusCallback()
              {
  ...
  public final void a(SurfaceHolder paramSurfaceHolder)
  {
    ...
    if ((!this.Cmb) || (paramSurfaceHolder.getSurface() == null))
    {
      boolean bool2 = this.Cmb;
    ...
    try
    {
      ...
      this.rqL.setPreviewDisplay(paramSurfaceHolder);
      eAh();
      this.rqL.startPreview();
      this.rqM = true;
    }
    catch (Exception paramSurfaceHolder)
    {
      ...
      {
        com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(159L, 0L, 1L, false);
        com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(159L, 2L, 1L, false);
    ...
    if (!bZV()) {
      com.tencent.mm.plugin.voip.c.euM().Um(this.ClX);
    }
    AppMethodBeat.o(115548);
  }
  ...
  public final void a(ObservableSurfaceView paramObservableSurfaceView)
  {
    ...
    this.Cme = paramObservableSurfaceView;
    this.Cme.setSurfaceChangeCallback(this);
    this.Cmd = true;
    AppMethodBeat.o(115546);
  }
  ...
  public final void a(ObservableTextureView paramObservableTextureView)
  {
    ...
    this.Cmf = paramObservableTextureView;
    this.Cmf.setTextureChangeCallback(this);
    this.Cmd = false;
    AppMethodBeat.o(115547);
  }
  ...
  public final void eAi()
  {
    ...
    if (j.Cow.fYa < 2)
    {
      ad.e("MicroMsg.Voip.CaptureRender", "ExchangeCapture...gCameraNum= " + j.Cow.fYa);
      AppMethodBeat.o(115558);
      return;
    }
    ad.i("MicroMsg.Voip.CaptureRender", "ExchangeCapture start, gCameraNum= " + j.Cow.fYa);
    eAl();
    f localf = this.Cmg;
    if (!this.ClQ) {}
  ...
  public final void eAj()
  {
    ...
    ad.i("MicroMsg.Voip.CaptureRender", "exchangeToHignCapture 1280 true");
    eAl();
    this.mWidth = 1280;
    this.mHeight = 720;
    a(this.Cmg, this.ClQ);
  ...
  public final int eAk()
  {
    ...
    //   3: invokestatic 73	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: aload_0
    //   7: getfield 116	com/tencent/mm/plugin/voip/video/a:Cmb	Z
    //   10: ifne +24 -> 34
    //   13: ldc 172
    //   15: ldc_w 898
    ...
    //   21: aload_0
    //   22: iconst_1
    //   23: putfield 114	com/tencent/mm/plugin/voip/video/a:ClX	I
    //   26: ldc_w 896
    //   29: invokestatic 90	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   32: iconst_m1
    //   33: ireturn
    //   34: aload_0
    //   35: getfield 124	com/tencent/mm/plugin/voip/video/a:Cmh	Z
    //   38: ifeq +19 -> 57
    //   41: ldc 172
    //   43: ldc_w 900
    ...
    //   56: ireturn
    //   57: aload_0
    //   58: getfield 122	com/tencent/mm/plugin/voip/video/a:Cme	Lcom/tencent/mm/plugin/video/ObservableSurfaceView;
    //   61: ifnull +34 -> 95
    //   64: aload_0
    //   65: getfield 122	com/tencent/mm/plugin/voip/video/a:Cme	Lcom/tencent/mm/plugin/video/ObservableSurfaceView;
    //   68: invokevirtual 903	com/tencent/mm/plugin/video/ObservableSurfaceView:erP	()Z
    //   71: ifne +24 -> 95
    //   74: ldc 172
    //   76: ldc_w 905
    ...
    //   82: aload_0
    //   83: iconst_1
    //   84: putfield 126	com/tencent/mm/plugin/voip/video/a:Cmi	Z
    //   87: ldc_w 896
    ...
    //   105: iconst_0
    //   106: aload_0
    //   107: getfield 120	com/tencent/mm/plugin/voip/video/a:Cmd	Z
    ...
    //   117: aload_0
    //   118: getfield 122	com/tencent/mm/plugin/voip/video/a:Cme	Lcom/tencent/mm/plugin/video/ObservableSurfaceView;
    //   121: ifnull +109 -> 230
    //   124: aload_0
    //   125: getfield 120	com/tencent/mm/plugin/voip/video/a:Cmd	Z
    //   128: ifeq +102 -> 230
    //   131: aload_0
    //   132: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   135: aload_0
    //   136: getfield 122	com/tencent/mm/plugin/voip/video/a:Cme	Lcom/tencent/mm/plugin/video/ObservableSurfaceView;
    ...
    //   145: aload_0
    //   146: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   149: invokevirtual 836	com/tencent/mm/compatible/deviceinfo/v:startPreview	()V
    //   152: aload_0
    //   153: iconst_1
    //   154: putfield 144	com/tencent/mm/plugin/voip/video/a:rqM	Z
    //   157: aload_0
    //   158: iconst_1
    //   159: putfield 124	com/tencent/mm/plugin/voip/video/a:Cmh	Z
    //   162: ldc_w 896
    //   165: invokestatic 90	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   168: iconst_1
    //   169: ireturn
    //   170: astore_1
    //   171: getstatic 272	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
    //   174: ldc2_w 273
    //   177: lconst_0
    //   178: lconst_1
    //   179: iconst_0
    //   180: invokevirtual 278	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
    //   183: getstatic 272	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
    //   186: ldc2_w 273
    //   189: ldc2_w 854
    //   192: lconst_1
    //   193: iconst_0
    ...
    //   197: aload_0
    //   198: iconst_1
    //   199: putfield 114	com/tencent/mm/plugin/voip/video/a:ClX	I
    //   202: ldc 172
    ...
    //   227: goto -82 -> 145
    //   230: aload_0
    //   231: getfield 873	com/tencent/mm/plugin/voip/video/a:Cmf	Lcom/tencent/mm/plugin/video/ObservableTextureView;
    //   234: ifnull -89 -> 145
    //   237: aload_0
    //   238: getfield 120	com/tencent/mm/plugin/voip/video/a:Cmd	Z
    //   241: ifne -96 -> 145
    //   244: aload_0
    //   245: getfield 375	com/tencent/mm/plugin/voip/video/a:rqL	Lcom/tencent/mm/compatible/deviceinfo/v;
    //   248: aload_0
    //   249: getfield 873	com/tencent/mm/plugin/voip/video/a:Cmf	Lcom/tencent/mm/plugin/video/ObservableTextureView;
    ...
    //   258: goto -113 -> 145
    //   261: astore_1
    //   262: getstatic 272	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
    //   265: ldc2_w 273
    //   268: lconst_0
    //   269: lconst_1
    //   270: iconst_0
    //   271: invokevirtual 278	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
    //   274: getstatic 272	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
    //   277: ldc2_w 273
    //   280: ldc2_w 854
    //   283: lconst_1
    //   284: iconst_0
    ...
    //   288: aload_0
    //   289: iconst_1
    //   290: putfield 114	com/tencent/mm/plugin/voip/video/a:ClX	I
    //   293: ldc 172
    ...
    //   318: goto -173 -> 145
    //   321: astore_1
    //   322: getstatic 272	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
    //   325: ldc2_w 273
    //   328: lconst_0
    //   329: lconst_1
    //   330: iconst_0
    //   331: invokevirtual 278	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
    //   334: getstatic 272	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
    //   337: ldc2_w 273
    //   340: ldc2_w 854
    //   343: lconst_1
    //   344: iconst_0
    ...
    //   348: aload_0
    //   349: iconst_1
    //   350: putfield 114	com/tencent/mm/plugin/voip/video/a:ClX	I
    //   353: aload_0
    //   354: getfield 571	com/tencent/mm/plugin/voip/video/a:Cmg	Lcom/tencent/mm/plugin/voip/video/f;
    //   357: ifnull +12 -> 369
    //   360: aload_0
    //   361: getfield 571	com/tencent/mm/plugin/voip/video/a:Cmg	Lcom/tencent/mm/plugin/voip/video/f;
  ...
  public final void eAl()
  {
    ...
    ad.d("MicroMsg.Voip.CaptureRender", "StopCapture....mIsInCapture = " + this.Cmh);
    if ((this.Cmh) && (this.rqL != null))
    {
      this.Cmi = false;
      if (!this.rqL.gbd) {
        this.rqL.setPreviewCallback(null);
    ...
    try
    {
      ...
      if (1 == this.ClX)
      {
        os localos = new os();
        localos.dCJ.type = 2;
        com.tencent.mm.sdk.b.a.IbL.l(localos);
      }
      ad.d("MicroMsg.Voip.CaptureRender", "UnInitCapture....mCameraOpen = " + this.Cmb);
      if (this.Cmb)
      {
        this.ClX = 0;
        this.Cmi = false;
        if ((this.rqL != null) && (!this.rqL.gbd))
        {
          this.rqL.setPreviewCallback(null);
          this.rqL.release();
        }
  ...
  public final void f(SurfaceTexture paramSurfaceTexture)
  {
    ...
    if ((!this.Cmb) || (paramSurfaceTexture == null))
    {
      boolean bool2 = this.Cmb;
    ...
    try
    {
      ...
      this.rqL.stopPreview();
      this.rqL.setPreviewTexture(paramSurfaceTexture);
      eAh();
      this.rqL.startPreview();
      this.rqM = true;
    }
