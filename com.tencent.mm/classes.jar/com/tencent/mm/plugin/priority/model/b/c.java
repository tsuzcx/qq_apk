  ...
  extends a
{
  private static void a(b paramb, String paramString, long paramLong, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    if (paramb.ayi((String)localObject3)) {
      paramb.aKd((String)localObject3);
    }
    ...
    if (paramb.aKc((String)localObject3) == 0)
    {
      AppMethodBeat.o(87869);
      return;
    }
  ...
  public static boolean eDa()
  {
    ...
    try
    {
      long l1 = com.tencent.mm.plugin.priority.a.a.a.eCQ();
      long l2 = ((PluginPriority)g.ah(PluginPriority.class)).getPriorityDB().ag(16777219L, 0L);
      if (l2 < l1)
      {
  ...
  public final void run()
  {
    ...
    Object localObject1 = ((PluginPriority)g.ah(PluginPriority.class)).getPriorityDB();
    if (((b)localObject1).aKc("C2CChatUsage") == 0)
    {
      AppMethodBeat.o(87868);
      return;
    }
    e.Cxv.idkeyStat(1252L, 1L, 1L, false);
    long l1 = com.tencent.mm.plugin.priority.a.a.a.eCQ();
    ...
    if (((b)localObject1).ayi(str3)) {
      ((b)localObject1).aKd(str3);
    }
    ...
    ((Cursor)localObject3).close();
    Log.i("MicroMsg.Priority.CalC2CChatPriorityTask", "calculateStayTime %.2f %.2f %.2f %.2f", new Object[] { Double.valueOf(arrayOfDouble[0]), Double.valueOf(arrayOfDouble[1]), Double.valueOf(localObject2[0]), Double.valueOf(localObject2[1]) });
    localObject3 = "staytime" + "temp2";
    if (((b)localObject1).ayi((String)localObject3)) {
      ((b)localObject1).aKd((String)localObject3);
    }
    ...
    if (((b)localObject1).ayi("lsptemp")) {
      ((b)localObject1).aKd("lsptemp");
    }
    ...
    ((PluginPriority)g.ah(PluginPriority.class)).getPriorityDB().ah(16777219L, l1);
    e.Cxv.idkeyStat(1252L, 0L, 1L, false);
    AppMethodBeat.o(87868);
  }
}
