  ...
  extends a
{
  private static void a(b paramb, String paramString, long paramLong, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    ae.i("MicroMsg.Priority.CalC2CChatPriorityTask", "calculateStdev %s %.2f %.2f %.2f %.2f %.2f %.2f", new Object[] { paramString, Double.valueOf(localObject1[0]), Double.valueOf(localObject1[1]), Double.valueOf(localObject1[2]), Double.valueOf(localObject2[0]), Double.valueOf(localObject2[1]), Double.valueOf(localObject2[2]) });
    localObject3 = paramString + "temp2";
    if (paramb.ale((String)localObject3)) {
      paramb.avL((String)localObject3);
    }
    ...
    if (paramb.avK((String)localObject3) == 0)
    {
      AppMethodBeat.o(87869);
      return;
    }
  ...
  public static boolean dCI()
  {
    ...
    try
    {
      long l1 = com.tencent.mm.plugin.priority.a.a.a.dCy();
      long l2 = ((PluginPriority)g.ad(PluginPriority.class)).getPriorityDB().ac(16777219L, 0L);
      if (l2 < l1)
      {
  ...
  public final void run()
  {
    ...
    if (!dCI())
    {
      localObject1 = com.tencent.mm.util.c.LDf;
      if (!com.tencent.mm.util.c.fSf())
      {
        ae.i("MicroMsg.Priority.CalC2CChatPriorityTask", "no need to cal usage result");
        AppMethodBeat.o(87868);
        return;
      }
    }
    Object localObject1 = ((PluginPriority)g.ad(PluginPriority.class)).getPriorityDB();
    if (((b)localObject1).avK("C2CChatUsage") == 0)
    {
      AppMethodBeat.o(87868);
      return;
    }
    e.ywz.idkeyStat(1252L, 1L, 1L, false);
    long l1 = com.tencent.mm.plugin.priority.a.a.a.dCy();
    ...
    if (((b)localObject1).ale(str3)) {
      ((b)localObject1).avL(str3);
    }
    ...
    ((Cursor)localObject3).close();
    ae.i("MicroMsg.Priority.CalC2CChatPriorityTask", "calculateStayTime %.2f %.2f %.2f %.2f", new Object[] { Double.valueOf(arrayOfDouble[0]), Double.valueOf(arrayOfDouble[1]), Double.valueOf(localObject2[0]), Double.valueOf(localObject2[1]) });
    localObject3 = "staytime" + "temp2";
    if (((b)localObject1).ale((String)localObject3)) {
      ((b)localObject1).avL((String)localObject3);
    }
    ...
    ae.i("MicroMsg.Priority.CalC2CChatPriorityTask", "d: %.2f r: %.4f", new Object[] { Double.valueOf(0.9D), Double.valueOf(d) });
    ...
    if (((b)localObject1).ale("lsptemp")) {
      ((b)localObject1).avL("lsptemp");
    }
    ...
    ((PluginPriority)g.ad(PluginPriority.class)).getPriorityDB().ad(16777219L, l1);
    e.ywz.idkeyStat(1252L, 0L, 1L, false);
    AppMethodBeat.o(87868);
  }
}
