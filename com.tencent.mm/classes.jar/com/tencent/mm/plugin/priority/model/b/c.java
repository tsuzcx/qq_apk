  ...
  extends a
{
  private static void a(b paramb, String paramString, long paramLong, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    if (paramb.aHB((String)localObject3)) {
      paramb.aUA((String)localObject3);
    }
    ...
    if (paramb.aUz((String)localObject3) == 0)
    {
      AppMethodBeat.o(87869);
      return;
    }
  ...
  public static boolean foT()
  {
    ...
    try
    {
      long l1 = com.tencent.mm.plugin.priority.a.a.a.foJ();
      long l2 = ((PluginPriority)h.ag(PluginPriority.class)).getPriorityDB().ao(16777219L, 0L);
      if (l2 < l1)
      {
  ...
  public final void run()
  {
    ...
    b localb = ((PluginPriority)h.ag(PluginPriority.class)).getPriorityDB();
    if (localb.aUz("C2CChatUsage") == 0)
    {
      AppMethodBeat.o(87868);
      return;
    }
    f.Iyx.idkeyStat(1252L, 1L, 1L, false);
    long l1 = com.tencent.mm.plugin.priority.a.a.a.foJ();
    ...
    if (localb.aHB((String)localObject2)) {
      localb.aUA((String)localObject2);
    }
    ...
    ((PluginPriority)h.ag(PluginPriority.class)).getPriorityDB().ap(16777219L, l1);
    f.Iyx.idkeyStat(1252L, 0L, 1L, false);
    AppMethodBeat.o(87868);
  }
}
