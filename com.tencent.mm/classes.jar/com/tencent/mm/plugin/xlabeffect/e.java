...
@l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/plugin/xlabeffect/XLabFileUtil;", "", "()V", "TAG", "", "assetsRoot", "filterPath", "getFilterPath", "()Ljava/lang/String;", "localRoot", "getLocalRoot", "modelRoot", "getModelRoot", "versionFile", "checkFile", "", "checkVersionMatch", "", "copyAssets", "assets", "Landroid/content/res/AssetManager;", "assetsPath", "localPath", "plugin-xlabeffect_release"})
public final class e
{
  private static final String FaJ;
  private static final String FaK;
  public static final e FaL;
  ...
  static
  {
    ...
    gvG = com.tencent.mm.loader.j.b.asc() + "xlab";
    FaJ = gvG + "/Models";
    FaK = gvG + "/filters";
  ...
  public static void a(AssetManager paramAssetManager, String paramString1, String paramString2)
  {
    ...
    //   26: getstatic 61	com/tencent/mm/plugin/xlabeffect/e:TAG	Ljava/lang/String;
    //   29: astore 6
    ...
    //   40: astore 7
    //   42: getstatic 120	com/tencent/mm/xeffect/d:LYD	Lcom/tencent/mm/xeffect/d;
    //   45: astore 8
    //   47: aload 6
    //   49: aload 7
    //   51: invokestatic 123	com/tencent/mm/xeffect/d:fWS	()Ljava/lang/String;
    ...
    //   60: invokestatic 128	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   63: aload_0
    //   64: aload_1
    ...
    //   108: astore_0
    //   109: aload_2
    //   110: invokestatic 148	com/tencent/mm/vfs/o:Db	(Ljava/lang/String;)Ljava/io/OutputStream;
    ...
    //   158: getstatic 80	com/tencent/mm/plugin/xlabeffect/e:gvG	Ljava/lang/String;
    ...
    //   172: astore_0
    //   173: getstatic 120	com/tencent/mm/xeffect/d:LYD	Lcom/tencent/mm/xeffect/d;
    //   176: astore_1
    //   177: invokestatic 123	com/tencent/mm/xeffect/d:fWS	()Ljava/lang/String;
    ...
    //   193: aload_0
    //   194: aload_1
    //   195: invokestatic 187	com/tencent/mm/vfs/o:C	(Ljava/lang/String;[B)I
    //   198: pop
    //   199: ldc 100
    ...
    //   252: athrow
    //   253: astore_0
    //   254: getstatic 61	com/tencent/mm/plugin/xlabeffect/e:TAG	Ljava/lang/String;
    //   257: aload_0
    //   258: checkcast 99	java/lang/Throwable
    //   261: ldc 188
    //   263: iconst_0
    //   264: anewarray 4	java/lang/Object
    //   267: invokestatic 192	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   270: ldc 100
    //   272: invokestatic 91	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   275: return
    //   276: aload_2
    //   277: invokestatic 196	com/tencent/mm/vfs/o:aZI	(Ljava/lang/String;)Z
    //   280: pop
    //   281: aload 6
    //   283: arraylength
    //   284: istore 4
    ...
    //   349: invokestatic 201	com/tencent/mm/plugin/xlabeffect/e:a	(Landroid/content/res/AssetManager;Ljava/lang/String;Ljava/lang/String;)V
    //   352: iload_3
    //   353: iconst_1
    //   354: iadd
    //   355: istore_3
  ...
  public static void fcm()
  {
    ...
    if (!fcn())
    {
      o.deleteDir(gvG);
      o.aZI(gvG);
      Object localObject = com.tencent.mm.plugin.expansions.d.qvZ;
      if (!com.tencent.mm.plugin.expansions.d.adS("xlab"))
      {
        ...
        a((AssetManager)localObject, "xlab", gvG);
        AppMethodBeat.o(90535);
        return;
      }
      localObject = com.tencent.mm.plugin.expansions.d.qvZ;
      com.tencent.mm.plugin.expansions.d.z((d.g.a.b)a.FaM);
    }
    AppMethodBeat.o(90535);
  }
  ...
  private static boolean fcn()
  {
    ...
    String str = gvG + "/version.txt";
    if (o.fB(str)) {}
    for (str = o.aZT(str);; str = "")
    {
      Object localObject = TAG;
      StringBuilder localStringBuilder = new StringBuilder("checkVersionMatch: ").append(str).append(", ");
      com.tencent.mm.xeffect.d locald = com.tencent.mm.xeffect.d.LYD;
      ae.i((String)localObject, com.tencent.mm.xeffect.d.fWS());
      localObject = com.tencent.mm.xeffect.d.LYD;
      p.g(str, "localVersion");
      boolean bool = com.tencent.mm.xeffect.d.bav(str);
      AppMethodBeat.o(218385);
      return bool;
    }
  }
  
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"<anonymous>", "", "Lcom/tencent/mm/plugin/expansions/ExpansionsKtWrapper;", "invoke"})
