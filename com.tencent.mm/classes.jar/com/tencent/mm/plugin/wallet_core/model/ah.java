...
public final class ah
{
  ...
  private boolean a(int paramInt, final Map<String, String> paramMap, String paramString, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 12)
    {
      ...
      paramMap = new f.a()
      {
        public final void bb(Map<String, Object> paramAnonymousMap)
        {
          ...
          if (paramAnonymousMap != null)
          {
            ...
            if ((l2 < 0L) || (l1 < 0L) || (l2 + this.Ibn > Util.currentTicks()) || (i >= l1))
            {
              f.a(new f.c[] { new f.c("wallet_balance_version", Long.valueOf(i)), new f.c("wallet_balance_last_update_time", Long.valueOf(Util.currentTicks())), new f.c("wallet_balance", Double.valueOf(paramMap / 100.0D)) });
              ah.a(this.Ibp, this.nsq, null);
