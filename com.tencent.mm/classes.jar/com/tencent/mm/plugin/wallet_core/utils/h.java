...
{
  public static boolean F(List<Bankcard> paramList, int paramInt)
  {
  ...
  public static boolean a(Bankcard paramBankcard, int paramInt)
  {
    ...
    if (paramInt == 8)
    {
      paramBankcard = l(paramBankcard);
      paramBankcard.field_scene = 8;
      bool = u.gJm().a(paramBankcard);
    }
    for (;;)
    {
      AppMethodBeat.o(71637);
      ...
      {
        bool = u.gJl().h(paramBankcard);
      }
    }
  }
  
  public static boolean amL(int paramInt)
  {
    AppMethodBeat.i(71638);
    if (paramInt == 8) {}
    for (boolean bool = u.gJm().amA(paramInt);; bool = u.gJm().byd())
    {
  ...
  public static ArrayList<Bankcard> amM(int paramInt)
  {
    AppMethodBeat.i(271197);
    Object localObject1 = u.gJm();
    Object localObject2 = "select * from WalletBankcardScene where (cardType <= 7 OR cardType & " + BankcardScene.ONx + " != 0 OR cardType & " + BankcardScene.ONw + " != 0) and scene=" + paramInt;
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      Bankcard localBankcard = new Bankcard(localBankcardScene.ONy, localBankcardScene.ONz, localBankcardScene.OMT, localBankcardScene.ONA, localBankcardScene.ONB, localBankcardScene.ONC, localBankcardScene.OND, localBankcardScene.ONE, localBankcardScene.ONF, localBankcardScene.ONG, localBankcardScene.ONH, localBankcardScene.ONI, localBankcardScene.ONJ, localBankcardScene.ONK, localBankcardScene.ONL, localBankcardScene.OMR, localBankcardScene.ONM, localBankcardScene.fDD, localBankcardScene.ONN, localBankcardScene.ONO, localBankcardScene.ONP, localBankcardScene.ONQ, localBankcardScene.ONR, localBankcardScene.ONS, localBankcardScene.ONT, localBankcardScene.ONU, localBankcardScene.ONV, localBankcardScene.ONW, localBankcardScene.ONX, localBankcardScene.ONY, localBankcardScene.ONZ, localBankcardScene.OOa, localBankcardScene.OOb, localBankcardScene.Ooe, localBankcardScene.Oof);
      localBankcard.field_bindSerial = localBankcardScene.field_bindSerial;
      localBankcard.field_defaultCardState = localBankcardScene.field_defaultCardState;
  ...
  private static BankcardScene l(Bankcard paramBankcard)
  {
    AppMethodBeat.i(71640);
    BankcardScene localBankcardScene = new BankcardScene(paramBankcard.ONy, paramBankcard.ONz, paramBankcard.OMT, paramBankcard.ONA, paramBankcard.ONB, paramBankcard.ONC, paramBankcard.OND, paramBankcard.ONE, paramBankcard.ONF, paramBankcard.ONG, paramBankcard.ONH, paramBankcard.ONI, paramBankcard.ONJ, paramBankcard.ONK, paramBankcard.ONL, paramBankcard.OMR, paramBankcard.ONM, paramBankcard.fDD, paramBankcard.ONN, paramBankcard.ONO, paramBankcard.ONP, paramBankcard.ONQ, paramBankcard.ONR, paramBankcard.ONS, paramBankcard.ONT, paramBankcard.ONU, paramBankcard.ONV, paramBankcard.ONW, paramBankcard.ONX, paramBankcard.ONY, paramBankcard.ONZ, paramBankcard.OOa, paramBankcard.OOb, paramBankcard.Ooe, paramBankcard.Oof);
