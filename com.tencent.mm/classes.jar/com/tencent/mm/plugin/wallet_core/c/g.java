  ...
  extends m
{
  public g()
  {
    ...
    s.ecg().db.execSQL("WalletBulletin", "delete from WalletBulletin");
  ...
  public final void onGYNetEnd(int paramInt, String paramString, JSONObject paramJSONObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      com.tencent.mm.kernel.g.afB().afk().set(ae.a.FjY, Long.valueOf(l));
      ...
      if (paramString != null)
      {
        ...
        if ((localJSONArray != null) && (localJSONArray.length() > 0))
        {
          ...
          if (localJSONArray != null)
          {
            ...
            localk.Aeo = localJSONArray;
            com.tencent.mm.kernel.g.afC();
            com.tencent.mm.kernel.g.afB().afk().set(ae.a.FkP, localJSONArray.toString());
          }
        }
        com.tencent.mm.kernel.g.afC();
        com.tencent.mm.kernel.g.afB().afk().set(ae.a.FkQ, paramString.optString("title"));
        com.tencent.mm.kernel.g.afC();
        com.tencent.mm.kernel.g.afB().afk().set(ae.a.FkR, paramString.optString("content"));
      }
      ...
      if (paramJSONObject != null)
      {
        ...
        com.tencent.mm.kernel.g.afC();
        com.tencent.mm.kernel.g.afB().afk().set(ae.a.FkS, paramString);
        com.tencent.mm.kernel.g.afC();
        com.tencent.mm.kernel.g.afB().afk().set(ae.a.FkT, paramJSONObject);
      }
    }
