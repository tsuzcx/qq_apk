  ...
  extends com.tencent.mm.wallet_core.e.a.a
{
  ...
  public final void onGYNetEnd(int paramInt, String paramString, JSONObject paramJSONObject)
  {
    ...
    ae.i("MicroMsg.NetScenePayUQueryBoundBankcard", "hy: payu query bind on gy net end. errCode: %d, errMsg: %s", new Object[] { Integer.valueOf(paramInt), paramString });
    if (paramInt != 0)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (l > 0L)
        {
          ...
          {
            paramString.field_is_reg = bu.getInt(((JSONObject)localObject1).optString("is_reg"), 0);
            ...
            t.eJf();
            an.aFP(paramString.field_main_card_bind_serialno);
            ...
            localObject3 = com.tencent.mm.plugin.wallet_core.model.a.a.eKG().ba((JSONObject)localObject3);
        ...
        {
          ae.w("MicroMsg.NetScenePayUQueryBoundBankcard", "no time_stamp in bindquerynew.");
          continue;
        }
        paramString = null;
      }
      ...
      {
        ae.printErrStackTrace("MicroMsg.NetScenePayUQueryBoundBankcard", paramString, "", new Object[0]);
        if ((this.Dhq) && (!t.eJf().eJH()))
        {
      ...
      if ((localObject2 != null) && (((JSONObject)localObject2).length() > 0))
      {
        ...
        paramJSONObject.Dmj = (((JSONObject)localObject2).optInt("avail_balance") / 100.0D);
        paramJSONObject.Dml = (((JSONObject)localObject2).optInt("fetch_balance") / 100.0D);
        ...
        paramJSONObject.field_desc = ak.getContext().getString(2131765289);
        paramJSONObject.field_cardType |= Bankcard.DlY;
      }
      for (;;)
      {
        t.eJf().a(paramString, (ArrayList)localObject1, null, paramJSONObject, null, null, null, null, 0, 0, null);
        break;
