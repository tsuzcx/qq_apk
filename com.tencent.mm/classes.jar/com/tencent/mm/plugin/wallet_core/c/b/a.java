  ...
  public final void onGYNetEnd(int paramInt, String paramString, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (l > 0L)
        {
          ...
          if ((localObject1 != null) && (((JSONObject)localObject1).length() > 0))
          {
            ...
            u.gJo();
            ao.bgX(paramString.field_main_card_bind_serialno);
            ...
            localObject3 = com.tencent.mm.plugin.wallet_core.model.a.a.gKQ().bL((JSONObject)localObject3);
      ...
      if ((localObject2 != null) && (((JSONObject)localObject2).length() > 0))
      {
        ...
        paramJSONObject.OND = (((JSONObject)localObject2).optInt("avail_balance") / 100.0D);
        paramJSONObject.ONF = (((JSONObject)localObject2).optInt("fetch_balance") / 100.0D);
        ...
        paramJSONObject.field_cardType |= Bankcard.ONs;
      }
      for (;;)
      {
        u.gJo().a(paramString, (ArrayList)localObject1, null, paramJSONObject, null, null, null, null, 0, 0, null);
        break;
