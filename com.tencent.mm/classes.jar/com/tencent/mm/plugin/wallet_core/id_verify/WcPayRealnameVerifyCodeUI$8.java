  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(final View paramView)
  {
    ...
    a.b("com/tencent/mm/plugin/wallet_core/id_verify/WcPayRealnameVerifyCodeUI$8", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).ahF());
    ae.d("MicroMsg.WcPayRealNameVerifyCodeUI", "click verify code fail tv");
    paramView = new e(this.DiL.getContext(), 1, false);
    localObject = this.DiL.getLayoutInflater().inflate(2131496064, null);
    ((Button)((View)localObject).findViewById(2131300871)).setOnClickListener(new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        ...
        a.b("com/tencent/mm/plugin/wallet_core/id_verify/WcPayRealnameVerifyCodeUI$8$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahF());
        paramView.bqD();
    ...
    paramView.LfS = new n.d()
    {
      public final void onCreateMMMenu(l paramAnonymousl)
      {
        ...
        paramView.setFooterView(this.DiN);
