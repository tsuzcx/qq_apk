  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bn(paramView);
    a.c("com/tencent/mm/plugin/wallet_core/ui/WalletConfirmCardIDUI$3", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aFi());
    paramView = WalletConfirmCardIDUI.f(this.OYQ).get3DesEncrptData();
    if ((paramView != null) && (paramView.equals(this.OYR))) {
      h.IzE.a(11353, new Object[] { Integer.valueOf(0), Integer.valueOf(1) });
    }
    for (;;)
    {
      WalletConfirmCardIDUI.g(this.OYQ);
      ...
      return;
      h.IzE.a(11353, new Object[] { Integer.valueOf(0), Integer.valueOf(2) });
    }
  }
}
