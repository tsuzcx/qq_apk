...
final class WalletCheckPwdUI$8
  implements d.a
{
  WalletCheckPwdUI$8(WalletCheckPwdUI paramWalletCheckPwdUI) {}
  
  public final Intent q(int paramInt, Bundle paramBundle)
  {
    AppMethodBeat.i(70903);
    ad.i("Micromsg.WalletCheckPwdUI", "verify code end: %s", new Object[] { Integer.valueOf(paramInt) });
    ...
    localIntent.setClass(this.Anc.getContext(), WalletCheckPwdUI.class);
