    ...
    for (String str = getString(2131765874);; str = getString(2131765873))
    {
      ...
      this.swk.setOnInputValidListener(new EditHintPasswdView.a()
      {
        public final void onInputValidChange(boolean paramAnonymousBoolean)
        {
          ...
          {
            String str = WalletSetPasswordUI.this.swk.getMd5Value();
            Bundle localBundle = new Bundle();
            localBundle.putString("key_new_pwd1", str);
            WalletSetPasswordUI.this.swk.dga();
      ...
      return;
      if ((getProcess() == null) || (!"ResetPwdProcessByToken".equals(getProcess().cuB()))) {
        break;
      }
      str = getInput().getString("key_pwd_title");
      localObject = getInput().getString("key_pwd_desc");
      if (!bt.isNullOrNil(str)) {
        this.kEu.setText(str);
      }
      if (bt.isNullOrNil((String)localObject)) {
        break;
      }
      this.nym.setText((CharSequence)localObject);
