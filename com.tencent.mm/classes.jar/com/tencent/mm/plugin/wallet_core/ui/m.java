...
public final class m
{
  public static d a(Context paramContext, b paramb, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2)
  {
    ...
    if ((paramb == null) || ((TextUtils.isEmpty(paramb.BtS)) && ((paramb.BtT == null) || (paramb.BtT.isEmpty()))))
    {
      ac.w("MicroMsg.WalletDialogHelper", "show showBalanceFetchAlert alert fail");
      AppMethodBeat.o(70939);
      return null;
    }
    ...
    while ((i < paramb.BtT.size()) && (i < paramb.BtT.size()))
    {
      ...
      localTextView1.setText(((b.b)paramb.BtT.get(i)).key);
      localTextView2.setText(((b.b)paramb.BtT.get(i)).value);
      paramOnClickListener2.addView(localView, i);
      i += 1;
      continue;
      ac.e("MicroMsg.WalletDialogHelper", "fetch itemsList is empty");
    }
    ((TextView)paramOnClickListener1.findViewById(2131305902)).setText(paramb.BtS);
    paramb = (TextView)paramOnClickListener1.findViewById(2131305884);
    paramb.setVisibility(0);
    paramb.setText(paramContext.getString(2131764977));
    locala.gH(paramOnClickListener1);
    paramb = locala.fvp();
    paramb.show();
