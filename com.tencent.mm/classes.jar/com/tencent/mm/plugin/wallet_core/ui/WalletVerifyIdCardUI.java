...
{
  private EditHintPasswdView BJE;
  private boolean BJv;
  private i BJx;
  private p.a BJy;
  ...
  public void initView()
  {
    ...
    this.lfN = ((TextView)findViewById(2131307103));
    this.BJE = ((EditHintPasswdView)findViewById(2131307102));
    ...
    this.lfN.setText(getString(2131765294, new Object[] { str1, str2 }));
    this.BJE.setEditTextMaxLength(4);
    this.BJE.setEditTextSize(34.0F);
    this.BJE.setOnInputValidListener(new EditHintPasswdView.a()
    {
    ...
    if ("1".equals(str3))
    {
      setEditFocusListener(this.BJE, 1, false);
      AppMethodBeat.o(71295);
      return;
    }
    setEditFocusListener(this.BJE, 1, true);
    AppMethodBeat.o(71295);
  }
  ...
  public boolean onPreSceneEnd(int paramInt1, int paramInt2, String paramString, n paramn)
  {
    ...
    ac.i("MicroMsg.WalletVerifyIdCardUI", "onPreSceneEnd %s %s", new Object[] { Integer.valueOf(paramInt2), paramn });
    if (((paramn instanceof p)) && (paramInt2 == 0))
    {
      this.BJv = true;
      t.makeText(this, 2131765617, 0).show();
      ac.i("MicroMsg.WalletVerifyIdCardUI", "tag it isCertInstalled ok");
    }
