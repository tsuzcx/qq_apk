  ...
  implements com.tencent.mm.aj.e
{
  ...
  public d(String paramString1, String paramString2)
  {
    ...
    this.lQM = dX(paramString1, paramString2);
    AppMethodBeat.o(145785);
  }
  
  private static a dX(String paramString1, String paramString2)
  {
    ...
    InputStream localInputStream = paramString2.Lh(paramString1);
  ...
  public final int aEj()
  {
    ...
    if (this.lQM == null) {
      this.lQM = dX(this.filePath, this.pkgPath);
    }
    if (this.lQM == null)
    {
    ...
    try
    {
      ...
      this.lQM.seek(0);
      this.lQM.read((byte[])localObject1);
  ...
  public final int readAt(long paramLong, byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    {
      this.lQM.seek((int)paramLong);
      this.currentPosition = paramLong;
    }
    paramInt1 = this.lQM.read(paramArrayOfByte, paramInt1, paramInt2);
    if (paramInt1 >= 0) {
