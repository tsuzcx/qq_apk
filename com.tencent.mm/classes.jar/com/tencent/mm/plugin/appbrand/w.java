...
public class w
{
  protected com.tencent.mm.appbrand.v8.w cQN;
  protected q iDy;
  k iHx;
  public v iHy;
  private ArrayList<v.a> iHz;
  
  public w(q paramq)
  {
    AppMethodBeat.i(134612);
    this.cQN = new com.tencent.mm.appbrand.v8.w()
    {
      public final int LX()
      {
        ...
        if (w.this.iHx != null)
        {
          int i = w.this.iHx.getNativeBufferId();
      ...
      public final void bufferStoreBindTo(long paramAnonymousLong1, long paramAnonymousLong2)
      {
        ...
        if (w.this.iHx != null) {
          w.this.iHx.bufferStoreBindTo(paramAnonymousLong1, paramAnonymousLong2);
        }
      ...
      public final ByteBuffer getBuffer(int paramAnonymousInt)
      {
        ...
        if (w.this.iHx != null)
        {
          ByteBuffer localByteBuffer = w.this.iHx.getNativeBuffer(paramAnonymousInt);
      ...
      public final void n(int paramAnonymousInt, String paramAnonymousString)
      {
        ...
        w.this.iDy.aOf().evaluateJavascript(String.format("typeof WeixinWorker.workerMsgHandler !== 'undefined' && WeixinWorker.workerMsgHandler(%d, %s);", new Object[] { Integer.valueOf(paramAnonymousInt), paramAnonymousString }), null);
      ...
      public final void setBuffer(int paramAnonymousInt, ByteBuffer paramAnonymousByteBuffer)
      {
        ...
        if (w.this.iHx != null) {
          w.this.iHx.setNativeBuffer(paramAnonymousInt, paramAnonymousByteBuffer);
        }
      ...
      public final boolean supportBufferStoreBindTo()
      {
        ...
        if (w.this.iHx != null)
        {
          boolean bool = w.this.iHx.supportBufferStoreBindTo();
    ...
    this.iDy = paramq;
    this.iHx = ((k)paramq.aOf().P(k.class));
    this.iHy = aNH();
    this.iHz = new ArrayList();
    String str1 = this.iDy.DO() + "wxa_library/bootstrap_j2v8_worker.js";
    String str2 = d.Ne("wxa_library/bootstrap_j2v8_worker.js");
    this.iHz.add(new v.a(str1, str2));
    paramq.aOf().addJavascriptInterface(this, "WeixinWorker");
    AppMethodBeat.o(134612);
  }
  
  protected v.a Dv(String paramString)
  {
    AppMethodBeat.i(134615);
    paramString = new v.a(this.iDy.DN() + paramString, be.d(this.iDy.getRuntime(), paramString) + this.iDy.cv(paramString));
  ...
  protected void a(ArrayList<v.a> paramArrayList, String paramString)
  {
    ...
    paramArrayList.add(new v.a(this.iDy.DO() + "config", String.format("var __wxConfig = %s;", new Object[] { this.iDy.DL().toString() })));
  ...
  public int createWithParams(String paramString1, String paramString2)
  {
    ...
    //   27: dup
    //   28: aload_0
    //   29: getfield 63	com/tencent/mm/plugin/appbrand/w:iHz	Ljava/util/ArrayList;
    ...
    //   46: aload_0
    //   47: aload_1
    //   48: invokevirtual 179	com/tencent/mm/plugin/appbrand/w:Dv	(Ljava/lang/String;)Lcom/tencent/mm/appbrand/v8/v$a;
    ...
    //   154: aload_0
    //   155: getfield 58	com/tencent/mm/plugin/appbrand/w:iHy	Lcom/tencent/mm/appbrand/v8/v;
    //   158: aload 6
    //   160: aload_0
    //   161: getfield 36	com/tencent/mm/plugin/appbrand/w:iDy	Lcom/tencent/mm/plugin/appbrand/q;
    //   164: aload_1
  ...
  public void postMsgToWorker(int paramInt, String paramString)
  {
    ...
    v localv = this.iHy;
    m localm = (m)localv.cQM.get(Integer.valueOf(paramInt));
    if (localm != null) {
      localm.cPC.q(new v.5(localv, localm, paramString));
    }
  ...
  public void terminate(int paramInt)
  {
    ...
    m localm = (m)this.iHy.cQM.remove(Integer.valueOf(paramInt));
    if (localm != null) {
      localm.destroy();
    }
