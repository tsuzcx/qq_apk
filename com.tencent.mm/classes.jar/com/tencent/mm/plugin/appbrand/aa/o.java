...
public final class o
{
  public static <T extends a> String a(Context paramContext, String paramString, T paramT)
  {
    ...
    String str = "Luggage.UserAgentUtil, appendUserAgent fail, context is null, stack = " + bt.eGN();
    boolean bool;
    if (paramContext != null)
    {
      ...
      paramContext = paramT.CU();
      label48:
      paramContext = paramContext + paramT.version();
      paramString = ay.iw(aj.getContext());
      paramContext = paramContext + " NetType/" + paramString;
      paramContext = paramContext + " Language/" + ac.ir(aj.getContext());
    ...
    for (paramContext = "arm64";; paramContext = "arm32")
    {
      ...
      bool = false;
      break;
      paramContext = paramString + paramT.CU();
      break label48;
    }
  }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.aa.o
