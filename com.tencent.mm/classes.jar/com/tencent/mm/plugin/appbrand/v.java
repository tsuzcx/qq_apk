...
public enum v
{
  ...
  public static String Li(String paramString)
  {
    ...
    {
      ae.e("MicroMsg.AppBrandUrlBuilders", "buildEntityUrl fail, null or nil appId");
  ...
  public static String Lj(String paramString)
  {
    ...
    if (bu.isNullOrNil(paramString))
    {
      ae.e("MicroMsg.AppBrandUrlBuilders", "buildLowVersionUrl fail, invalid arguments");
  ...
  public static String a(WxaExposedParams paramWxaExposedParams)
  {
    ...
    if ((paramWxaExposedParams == null) || (bu.isNullOrNil(paramWxaExposedParams.appId)))
    {
      ae.e("MicroMsg.AppBrandUrlBuilders", "buildFeedbackUrl fail, null or nil appId");
      AppMethodBeat.o(43969);
      return "";
    }
    try
    {
      paramWxaExposedParams = String.format("https://mp.weixin.qq.com/wxawap/wapreportwxadevlog?action=complain_feedback&appid=%s&pageid=%s&from=%d&version_type=%d&version_code=%d&screenshot_localId=%s&sessionid=%s#wechat_redirect", new Object[] { paramWxaExposedParams.appId, q.encode(bu.nullAsNil(paramWxaExposedParams.pageId), "UTF-8"), Integer.valueOf(paramWxaExposedParams.from), Integer.valueOf(bu.m(Integer.valueOf(paramWxaExposedParams.jLV), -1)), Integer.valueOf(bu.m(Integer.valueOf(paramWxaExposedParams.pkgVersion), -1)), q.encode(bu.nullAsNil(paramWxaExposedParams.kdK), "UTF-8"), bu.nullAsNil(paramWxaExposedParams.sessionId) });
      AppMethodBeat.o(43969);
      return paramWxaExposedParams;
    }
    catch (UnsupportedEncodingException paramWxaExposedParams)
    {
      ae.e("MicroMsg.AppBrandUrlBuilders", "buildFeedbackUrl encode fail, invalid arguments");
      AppMethodBeat.o(43969);
    }
    return "";
  }
  ...
  public static String b(WxaExposedParams paramWxaExposedParams)
  {
    ...
    if ((paramWxaExposedParams == null) || (bu.isNullOrNil(paramWxaExposedParams.appId)))
    {
      ae.e("MicroMsg.AppBrandUrlBuilders", "buildExposeUrl fail, null or nil appId");
      AppMethodBeat.o(43970);
      return "";
    }
    try
    {
      paramWxaExposedParams = String.format("https://mp.weixin.qq.com/mp/wacomplain?action=show&appid=%s&pageid=%s&from=%d&version_type=%d&version_code=%d#wechat_redirect", new Object[] { paramWxaExposedParams.appId, q.encode(bu.nullAsNil(paramWxaExposedParams.pageId), "UTF-8"), Integer.valueOf(paramWxaExposedParams.from), Integer.valueOf(bu.m(Integer.valueOf(paramWxaExposedParams.jLV), -1)), Integer.valueOf(bu.m(Integer.valueOf(paramWxaExposedParams.pkgVersion), -1)) });
      AppMethodBeat.o(43970);
      return paramWxaExposedParams;
    }
    catch (UnsupportedEncodingException paramWxaExposedParams)
    {
      ae.e("MicroMsg.AppBrandUrlBuilders", "buildExposeUrl encode fail, invalid arguments");
      AppMethodBeat.o(43970);
    }
    return "";
  }
