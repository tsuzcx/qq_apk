  ...
  implements DialogInterface.OnClickListener
{
  ...
  public final void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    Object localObject1 = aa.f(this.lmf);
    ...
    for (localObject1 = ((EditVerifyCodeView)localObject1).getText();; localObject1 = null)
    {
      ...
      localEditVerifyCodeView = aa.f(this.lmf);
    ...
    paramDialogInterface = aa.f(this.lmf);
    ...
    for (paramDialogInterface = Integer.valueOf(paramDialogInterface.length());; paramDialogInterface = null)
    {
      ...
      com.tencent.mm.plugin.appbrand.utils.k.a(this.lmf.context, this.lmf.context.getString(2131755450), this.lmf.context.getString(2131755442), (DialogInterface.OnClickListener)1.lmo);
      AppMethodBeat.o(148190);
      return;
    }
    localObject1 = aa.f(this.lmf);
    ...
    if (paramDialogInterface.intValue() == 0)
    {
      ...
      com.tencent.mm.plugin.appbrand.utils.k.a(this.lmf.context, this.lmf.context.getString(2131755449), this.lmf.context.getString(2131755442), (DialogInterface.OnClickListener)2.lmp);
    }
    AppMethodBeat.o(148190);
  }
}
