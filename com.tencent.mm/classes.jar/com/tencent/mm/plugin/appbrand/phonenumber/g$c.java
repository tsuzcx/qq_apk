  ...
  implements b.a
{
  ...
  public final void a(int paramInt1, int paramInt2, String paramString, b paramb)
  {
    ...
    if (localr != null)
    {
      ...
      if (paramb == null)
      {
        paramString = new v("null cannot be cast to non-null type com.tencent.mm.protocal.protobuf.UpdateUserPhoneResp");
        AppMethodBeat.o(143937);
        throw paramString;
      }
      localr.a(Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), paramString, (cnk)paramb);
      AppMethodBeat.o(143937);
      return;
    }
    AppMethodBeat.o(143937);
