  ...
  implements Parcelable
{
  ...
  public PhoneItem(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    this.dzn = paramString1;
    this.mjK = paramString2;
    this.mjL = paramString3;
    this.bxJ = paramString4;
    this.mjM = paramString5;
    this.mjN = paramBoolean1;
    this.mjO = paramBoolean2;
    this.mjP = paramBoolean3;
    this.mjQ = paramBoolean4;
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    {
      if ((p.i(((PhoneItem)paramObject).dzn, this.dzn)) && (((PhoneItem)paramObject).mjP == this.mjP))
      {
  ...
  public final String toString()
  {
    ...
    String str = "PhoneItem(mobile=" + this.dzn + ", showMobile=" + this.mjK + ", encryptedData=" + this.mjL + ", iv=" + this.bxJ + ", cloud_id=" + this.mjM + ", needAuth=" + this.mjN + ", allowSendSms=" + this.mjO + ", isWechat=" + this.mjP + ", isCheck=" + this.mjQ + ")";
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/appbrand/phonenumber/PhoneItem$Companion;", "", "()V", "TAG", "", "parseFromJson", "Lcom/tencent/mm/plugin/appbrand/phonenumber/PhoneItem;", "jsonStr", "luggage-wechat-full-sdk_release"})
  public static final class a
  {
    public static PhoneItem TV(String paramString)
    {
