  ...
  implements Parcelable
{
  ...
  public PhoneItem(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    this.nzt = paramString2;
    this.nzu = paramString3;
    this.bxK = paramString4;
    this.nzv = paramString5;
    this.nzw = paramBoolean1;
    this.nzx = paramBoolean2;
    this.nzy = paramBoolean3;
    this.nzz = paramBoolean4;
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    {
      if ((p.j(((PhoneItem)paramObject).dSf, this.dSf)) && (((PhoneItem)paramObject).nzy == this.nzy))
      {
  ...
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/appbrand/phonenumber/PhoneItem$Companion;", "", "()V", "TAG", "", "parseFromJson", "Lcom/tencent/mm/plugin/appbrand/phonenumber/PhoneItem;", "jsonStr", "luggage-wechat-full-sdk_release"})
  public static final class a
  {
    public static PhoneItem aet(String paramString)
    {
