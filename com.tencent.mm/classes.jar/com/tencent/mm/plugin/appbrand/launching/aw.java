  ...
  extends j<ax>
{
  ...
  static
  {
    ...
    lKt = j.getCreateSQLs(ax.jGU, "LaunchWxaAppRespTable");
    AppMethodBeat.o(47281);
  }
  
  public aw(e parame)
  {
    super(parame, ax.jGU, "LaunchWxaAppRespTable", ax.INDEX_CREATE);
  }
  ...
  private boolean a(ax paramax, boolean paramBoolean)
  {
    ...
    ad.i("MicroMsg.LaunchWxaAppCacheStorage", "insertNotify appId %s ret %B", new Object[] { paramax.field_appId, Boolean.valueOf(paramBoolean) });
  ...
  private boolean b(ax paramax, boolean paramBoolean, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        ad.i("MicroMsg.LaunchWxaAppCacheStorage", "updateNotify appId %s, ret %B", new Object[] { paramax.field_appId, Boolean.valueOf(paramBoolean) });
  ...
  public final ax a(String paramString, btg parambtg)
  {
    AppMethodBeat.i(47271);
    if ((bt.isNullOrNil(paramString)) || (parambtg == null))
    {
    ...
    localax.field_appId = paramString;
    parambtg = new ax();
    parambtg.field_appId = paramString;
    boolean bool1;
    boolean bool2;
    if (!a(parambtg, new String[] { "appId" }))
    {
      bool1 = true;
      if ((!bool1) && (parambtg.equals(localax))) {
        break label173;
      }
      bool2 = true;
      label92:
