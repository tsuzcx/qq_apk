  ...
  extends cgz
{
  ...
  public final String toString()
  {
    ...
    String str = "PrefetchPkgDownloadInfo{packageMD5='" + this.lpa + '\'' + ", packageURL='" + this.lpb + '\'' + ", urlLifespan=" + this.lpc + ", appId='" + this.appId + '\'' + ", packageKey='" + this.Fvc + '\'' + ", packageType=" + this.dcj + ", packageVersion=" + this.Fvd + '}';
