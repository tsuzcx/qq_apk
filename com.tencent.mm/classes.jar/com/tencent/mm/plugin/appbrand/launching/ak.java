  ...
  implements x
{
  ...
  ak(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, List<WxaAttributes.WxaVersionModuleInfo> paramList, List<WxaAttributes.WxaPluginCodeInfo> paramList1, PBool paramPBool)
  {
    ...
    this.llr = false;
    ac.i("MicroMsg.AppBrand.LaunchCheckPkgSplitPluginCodeModuleHandler", "appId:%s,versionType:%s,desirePkgVersion:%s", new Object[] { paramString1, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
  ...
  private static WxaPkgWrappingInfo O(String paramString, int paramInt1, int paramInt2)
  {
    ...
    //   21: ifeq +293 -> 314
    //   24: invokestatic 132	com/tencent/mm/plugin/appbrand/app/j:aVC	()Lcom/tencent/mm/plugin/appbrand/appcache/bf;
    //   27: astore_3
    //   28: aload_3
    //   29: ifnonnull +10 -> 39
    //   32: ldc 113
    ...
    //   73: invokestatic 154	com/tencent/mm/sdk/platformtools/bs:isNullOrNil	(Ljava/lang/String;)Z
    //   76: ifeq +10 -> 86
    //   79: ldc 113
    ...
    //   146: aastore
    //   147: invokestatic 81	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   150: aload 4
    //   152: astore_3
    //   153: aload 6
    //   155: getfield 157	com/tencent/mm/plugin/appbrand/appcache/bb:field_pkgPath	Ljava/lang/String;
    //   158: iload_2
    //   159: invokestatic 179	com/tencent/mm/plugin/appbrand/launching/ak:bL	(Ljava/lang/String;I)Lcom/tencent/mm/plugin/appbrand/appcache/WxaPkgWrappingInfo;
    //   162: astore 7
    //   164: aload 4
    //   166: invokestatic 183	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   169: ldc 113
    //   171: invokestatic 105	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   174: aload 7
    //   176: areturn
    //   177: aload 4
    //   179: invokestatic 183	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   182: aload 6
    ...
    //   200: iconst_0
    //   201: aload 6
    //   203: getfield 148	com/tencent/mm/plugin/appbrand/appcache/bb:field_versionMd5	Ljava/lang/String;
    //   206: aastore
    //   207: invokestatic 191	com/tencent/mm/plugin/appbrand/launching/m:a	(Lcom/tencent/mm/plugin/appbrand/appcache/ab;II[Ljava/lang/String;)Lcom/tencent/mm/plugin/appbrand/appcache/bb;
    //   210: astore_0
    //   211: aload_0
    //   212: ifnull +176 -> 388
    //   215: aload 5
    //   217: invokevirtual 136	com/tencent/mm/plugin/appbrand/appcache/ab:toString	()Ljava/lang/String;
    //   220: iload_2
    //   221: invokestatic 197	com/tencent/mm/plugin/appbrand/appcache/ay:aJ	(Ljava/lang/String;I)Ljava/lang/String;
    //   224: astore_3
    //   225: aload_0
    //   226: getfield 157	com/tencent/mm/plugin/appbrand/appcache/bb:field_pkgPath	Ljava/lang/String;
    //   229: aload_3
    //   230: invokestatic 201	com/tencent/mm/vfs/i:lZ	(Ljava/lang/String;Ljava/lang/String;)J
    //   233: pop2
    //   234: invokestatic 132	com/tencent/mm/plugin/appbrand/app/j:aVC	()Lcom/tencent/mm/plugin/appbrand/appcache/bf;
    //   237: aload 5
    //   239: invokevirtual 136	com/tencent/mm/plugin/appbrand/appcache/ab:toString	()Ljava/lang/String;
    //   242: iload_1
    //   243: iload_2
    //   244: aload_3
    //   245: invokevirtual 205	com/tencent/mm/plugin/appbrand/appcache/bf:e	(Ljava/lang/String;IILjava/lang/String;)Z
    //   248: pop
    //   249: aload_3
    //   250: iload_2
    //   251: invokestatic 179	com/tencent/mm/plugin/appbrand/launching/ak:bL	(Ljava/lang/String;I)Lcom/tencent/mm/plugin/appbrand/appcache/WxaPkgWrappingInfo;
    //   254: astore_0
    //   255: ldc 113
    ...
    //   282: iconst_1
    //   283: aload 6
    //   285: getfield 157	com/tencent/mm/plugin/appbrand/appcache/bb:field_pkgPath	Ljava/lang/String;
    //   288: aastore
    //   289: invokestatic 209	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   292: aload 4
    //   294: invokestatic 183	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   297: goto -115 -> 182
    //   300: astore_0
    //   301: aconst_null
    //   302: astore_3
    //   303: aload_3
    //   304: invokestatic 183	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   307: ldc 113
    //   309: invokestatic 105	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   312: aload_0
    //   313: athrow
    //   314: aload 5
    //   316: invokevirtual 136	com/tencent/mm/plugin/appbrand/appcache/ab:toString	()Ljava/lang/String;
    //   319: iload_1
    //   320: iconst_1
    //   321: invokestatic 215	com/tencent/mm/plugin/appbrand/appcache/WxaPkgIntegrityChecker:B	(Ljava/lang/String;II)Landroid/util/Pair;
    //   324: astore_3
    //   325: aload_3
    ...
    //   369: aastore
    //   370: invokestatic 81	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   373: aload_3
    ...
    //   15	300	5	localab	com.tencent.mm.plugin.appbrand.appcache.ab
    //   54	230	6	localbb	com.tencent.mm.plugin.appbrand.appcache.bb
  ...
  private static WxaPkgWrappingInfo bL(String paramString, int paramInt)
  {
    AppMethodBeat.i(47233);
    paramString = WxaPkgWrappingInfo.Iu(paramString);
    ...
    implements aa.b
  {
    ...
    {
      ak.a(ak.this);
      ac.i("MicroMsg.AppBrand.LaunchCheckPkgSplitPluginCodeModuleHandler", bnA() + " progress=" + paramWxaPkgLoadProgress.progress);
      long l = bnz();
      if (l == 0L) {
      ...
      for (;;)
      {
        ...
        ak.c(ak.this);
        return;
        ak.b(ak.this).addAndGet(Math.round(Math.max(0, paramWxaPkgLoadProgress.progress - this.llz) / (float)l));
      }
    }
