...
{
  public static final ILaunchWxaAppInfoNotify lMO = new ILaunchWxaAppInfoNotify()
  {
    ...
    private static String a(ax paramAnonymousax)
    {
      ...
      try
      {
        paramAnonymousax = String.format(Locale.US, "bytes[%d]", new Object[] { Integer.valueOf(paramAnonymousax.field_jsapiInfo.Gph.zr.length) });
        AppMethodBeat.o(47171);
    ...
    public final void a(String paramAnonymousString1, int paramAnonymousInt, String paramAnonymousString2, ax paramAnonymousax)
    {
      ...
      Object localObject = k.Ss(paramAnonymousString2);
      if (localObject != null)
      {
        ae.i("MicroMsg.AppBrand.ILaunchWxaAppInfoNotify.INSTANCE[permission]", "notifyLaunchInfoUpdate [update deferred process] appId[%s], type[%d], sessionId[%s], %s", new Object[] { paramAnonymousString1, Integer.valueOf(paramAnonymousInt), paramAnonymousString2, a(paramAnonymousax) });
        ((k)localObject).a(paramAnonymousString1, paramAnonymousInt, paramAnonymousString2, paramAnonymousax);
      }
      try
      {
        ae.i("MicroMsg.AppBrand.ILaunchWxaAppInfoNotify.INSTANCE[permission]", "notifyLaunchInfoUpdate [update remote] appId[%s], type[%d], sessionId[%s], %s", new Object[] { paramAnonymousString1, Integer.valueOf(paramAnonymousInt), paramAnonymousString2, a(paramAnonymousax) });
        ...
        ((ILaunchWxaAppInfoNotify.LaunchInfoIpcWrapper)localObject).hSZ = paramAnonymousInt;
        ((ILaunchWxaAppInfoNotify.LaunchInfoIpcWrapper)localObject).cmK = new AppRuntimeApiPermissionBundle(paramAnonymousax.field_jsapiInfo);
        AppBrandLaunchErrorAction.a locala = AppBrandLaunchErrorAction.CREATOR;
        ((ILaunchWxaAppInfoNotify.LaunchInfoIpcWrapper)localObject).lMP = AppBrandLaunchErrorAction.a.a(paramAnonymousString1, paramAnonymousInt, paramAnonymousax);
      ...
      {
        ae.printErrStackTrace("MicroMsg.AppBrand.ILaunchWxaAppInfoNotify.INSTANCE[permission]", localThrowable, "notifyLaunchInfoUpdate [update remote] appId[%s], type[%d], sessionId[%s], %s", new Object[] { paramAnonymousString1, Integer.valueOf(paramAnonymousInt), paramAnonymousString2, a(paramAnonymousax) });
        AppMethodBeat.o(47170);
      }
    }
    ...
    public final void a(String paramAnonymousString1, int paramAnonymousInt, String paramAnonymousString2, HashMap<String, AppRuntimeApiPermissionBundle> paramAnonymousHashMap)
    {
      ...
      if (localObject != null)
      {
        ...
        {
          i = 0;
          ae.i("MicroMsg.AppBrand.ILaunchWxaAppInfoNotify.INSTANCE[permission]", "notifyPluginPermissionInfoUpdate [update deferred process] appId[%s], type[%d], sessionId[%s], pluginMapSize:[%d]", new Object[] { paramAnonymousString1, Integer.valueOf(paramAnonymousInt), paramAnonymousString2, Integer.valueOf(i) });
      ...
      for (int i = 0;; i = paramAnonymousHashMap.size())
      {
        try
        {
          ae.i("MicroMsg.AppBrand.ILaunchWxaAppInfoNotify.INSTANCE[permission]", "notifyPluginPermissionInfoUpdate [update remote] appId[%s], type[%d], sessionId[%s], pluginMapSize:[%d]", new Object[] { paramAnonymousString1, Integer.valueOf(paramAnonymousInt), paramAnonymousString2, Integer.valueOf(i) });
          ...
          ((ILaunchWxaAppInfoNotify.PluginIpcWrapper)localObject).hSZ = paramAnonymousInt;
          ((ILaunchWxaAppInfoNotify.PluginIpcWrapper)localObject).lMQ = paramAnonymousHashMap;
          e.b(paramAnonymousString1, (Parcelable)localObject);
      ...
      {
        ae.printErrStackTrace("MicroMsg.AppBrand.ILaunchWxaAppInfoNotify.INSTANCE[permission]", localThrowable, "notifyPluginPermissionInfoUpdate [update remote] appId[%s], type[%d], sessionId[%s], pluginMapSize:[%d]", new Object[] { paramAnonymousString1, Integer.valueOf(paramAnonymousInt), paramAnonymousString2, Integer.valueOf(i) });
        AppMethodBeat.o(222769);
        return;
      }
    }
    ...
    implements Parcelable
  {
    ...
    public int hSZ;
    public AppBrandLaunchErrorAction lMP;
    ...
    LaunchInfoIpcWrapper(Parcel paramParcel)
    {
      ...
      this.lMP = ((AppBrandLaunchErrorAction)paramParcel.readParcelable(AppBrandLaunchErrorAction.class.getClassLoader()));
    ...
    public void writeToParcel(Parcel paramParcel, int paramInt)
    {
      ...
      paramParcel.writeParcelable(this.lMP, paramInt);
    ...
    implements Parcelable
  {
    ...
    public String appId;
    public int hSZ;
    public HashMap<String, AppRuntimeApiPermissionBundle> lMQ;
    ...
    PluginIpcWrapper(Parcel paramParcel)
    {
      ...
      this.appId = paramParcel.readString();
      this.hSZ = paramParcel.readInt();
      this.lMQ = paramParcel.readHashMap(AppRuntimeApiPermissionBundle.class.getClassLoader());
