...
public final class i
{
  static void b(Context paramContext, AppBrandInitConfigWC paramAppBrandInitConfigWC, AppBrandStatObject paramAppBrandStatObject)
  {
    ...
    if (b.d(paramAppBrandInitConfigWC)) {
      b.a(paramAppBrandInitConfigWC.appId, paramAppBrandInitConfigWC.username, paramAppBrandInitConfigWC.iOP, paramAppBrandInitConfigWC.iJb, paramAppBrandStatObject.scene, new com.tencent.mm.plugin.appbrand.backgroundfetch.j());
    }
    ...
    g.aTy().a(paramAppBrandInitConfigWC.username, paramAppBrandInitConfigWC);
