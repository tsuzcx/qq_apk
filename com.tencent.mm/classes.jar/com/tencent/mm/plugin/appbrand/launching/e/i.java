...
public final class i
{
  static void b(Context paramContext, AppBrandInitConfigWC paramAppBrandInitConfigWC, AppBrandStatObject paramAppBrandStatObject)
  {
    ...
    ac.i("MicroMsg.AppBrand.PreconditionUtil", "startAppOnInitConfigGot, %s", new Object[] { paramAppBrandInitConfigWC });
    if (b.d(paramAppBrandInitConfigWC)) {
      b.a(paramAppBrandInitConfigWC.appId, paramAppBrandInitConfigWC.username, paramAppBrandInitConfigWC.joY, paramAppBrandInitConfigWC.jjf, paramAppBrandStatObject.scene, new com.tencent.mm.plugin.appbrand.backgroundfetch.j());
    }
    ...
    g.baw().a(paramAppBrandInitConfigWC.username, paramAppBrandInitConfigWC);
