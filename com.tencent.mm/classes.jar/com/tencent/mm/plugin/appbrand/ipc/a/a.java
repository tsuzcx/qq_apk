...
@l(iBK={1, 1, 16}, iBL={""}, iBM={"Lcom/tencent/mm/plugin/appbrand/ipc/util/IpcBigDataTransfer;", "", "()V", "BUFF_MAX_LIMIT", "", "CLEAN_CHECK_INTERVAL", "", "MMKV_FILE_DANGER_SIZE", "MMKV_NANE", "", "TAG", "mmkv", "Lcom/tencent/mm/sdk/platformtools/MultiProcessMMKV;", "kotlin.jvm.PlatformType", "get", "", "key", "clear", "", "save", "Lkotlin/Pair;", "data", "tryCleanInvalidData", "", "plugin-appbrand-integration_release"})
public final class a
{
  private static final MultiProcessMMKV cQO;
  private static final long orT;
  ...
  static
  {
    ...
    orU = new a();
    orT = TimeUnit.DAYS.toMillis(1L);
    cQO = MultiProcessMMKV.getMMKV("jsapi_ipc_big_data_transfer");
    AppMethodBeat.o(274968);
  }
  
  public static o<Boolean, String> aT(byte[] paramArrayOfByte)
  {
    ...
    if (paramArrayOfByte.length >= 102400)
    {
      ...
      cQO.encode(str, paramArrayOfByte);
  ...
  public static byte[] agM(String paramString)
  {
    AppMethodBeat.i(274966);
    p.k(paramString, "key");
    byte[] arrayOfByte = cQO.decodeBytes(paramString);
    cQO.remove(paramString);
    p.j(arrayOfByte, "mmkv.decodeBytes(key).al…mkv.remove(key)\n        }");
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      //   7: invokestatic 50	com/tencent/mm/kernel/h:aHG	()Lcom/tencent/mm/kernel/f;
      //   10: astore 8
      //   12: aload 8
      //   14: ldc 52
      //   16: invokestatic 58	kotlin/g/b/p:j	(Ljava/lang/Object;Ljava/lang/String;)V
      //   19: aload 8
      //   21: invokevirtual 64	com/tencent/mm/kernel/f:aHp	()Lcom/tencent/mm/storage/ao;
      //   24: getstatic 70	com/tencent/mm/storage/ar$a:VmT	Lcom/tencent/mm/storage/ar$a;
      //   27: lconst_0
      //   28: invokevirtual 76	com/tencent/mm/storage/ao:a	(Lcom/tencent/mm/storage/ar$a;J)J
      //   31: lstore_2
      //   32: getstatic 80	com/tencent/mm/plugin/appbrand/ipc/a/a:orU	Lcom/tencent/mm/plugin/appbrand/ipc/a/a;
      //   35: astore 8
      //   37: invokestatic 84	com/tencent/mm/plugin/appbrand/ipc/a/a:bPw	()J
      //   40: lstore 4
      ...
      //   53: lcmp
      //   54: ifgt +149 -> 203
      //   57: getstatic 80	com/tencent/mm/plugin/appbrand/ipc/a/a:orU	Lcom/tencent/mm/plugin/appbrand/ipc/a/a;
      //   60: astore 8
      //   62: invokestatic 93	com/tencent/mm/plugin/appbrand/ipc/a/a:bPx	()Lcom/tencent/mm/sdk/platformtools/MultiProcessMMKV;
      ...
      //   93: iload_1
      //   94: ifeq +14 -> 108
      //   97: getstatic 80	com/tencent/mm/plugin/appbrand/ipc/a/a:orU	Lcom/tencent/mm/plugin/appbrand/ipc/a/a;
      //   100: astore 8
      //   102: invokestatic 93	com/tencent/mm/plugin/appbrand/ipc/a/a:bPx	()Lcom/tencent/mm/sdk/platformtools/MultiProcessMMKV;
      //   105: invokevirtual 118	com/tencent/mm/sdk/platformtools/MultiProcessMMKV:clearAll	()V
      //   108: invokestatic 50	com/tencent/mm/kernel/h:aHG	()Lcom/tencent/mm/kernel/f;
      //   111: astore 8
      //   113: aload 8
      //   115: ldc 52
      //   117: invokestatic 58	kotlin/g/b/p:j	(Ljava/lang/Object;Ljava/lang/String;)V
      //   120: aload 8
      //   122: invokevirtual 64	com/tencent/mm/kernel/f:aHp	()Lcom/tencent/mm/storage/ao;
      //   125: getstatic 70	com/tencent/mm/storage/ar$a:VmT	Lcom/tencent/mm/storage/ar$a;
      ...
      //   166: invokestatic 50	com/tencent/mm/kernel/h:aHG	()Lcom/tencent/mm/kernel/f;
      //   169: astore 8
      //   171: aload 8
      //   173: ldc 52
      //   175: invokestatic 58	kotlin/g/b/p:j	(Ljava/lang/Object;Ljava/lang/String;)V
      //   178: aload 8
      //   180: invokevirtual 64	com/tencent/mm/kernel/f:aHp	()Lcom/tencent/mm/storage/ao;
      //   183: getstatic 70	com/tencent/mm/storage/ar$a:VmT	Lcom/tencent/mm/storage/ar$a;
      ...
      //   208: return
      //   209: astore 8
      //   211: invokestatic 50	com/tencent/mm/kernel/h:aHG	()Lcom/tencent/mm/kernel/f;
      //   214: astore 9
      //   216: aload 9
      //   218: ldc 52
      //   220: invokestatic 58	kotlin/g/b/p:j	(Ljava/lang/Object;Ljava/lang/String;)V
      //   223: aload 9
      //   225: invokevirtual 64	com/tencent/mm/kernel/f:aHp	()Lcom/tencent/mm/storage/ao;
      //   228: getstatic 70	com/tencent/mm/storage/ar$a:VmT	Lcom/tencent/mm/storage/ar$a;
      ...
      //   169	10	8	localf1	com.tencent.mm.kernel.f
      //   201	1	8	localThrowable2	java.lang.Throwable
      //   209	37	8	localObject2	Object
      //   214	10	9	localf2	com.tencent.mm.kernel.f
      // Exception table:
      //   from	to	target	type
