...
public final class d
{
  ...
  public final ArrayList<e> lwv;
  public final Set<String> lww;
  public final Set<String> lwx;
  int lwy;
  final WeakReference<c> lwz;
  
  public d(c paramc, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    AppMethodBeat.i(144320);
    this.lwv = new ArrayList();
    this.lww = new ConcurrentSkipListSet();
    this.lwx = new ConcurrentSkipListSet();
    this.kBd = com.tencent.mm.plugin.appbrand.jsapi.j.b.a.kBb;
    this.lwB = false;
    this.lwC = false;
    this.lwz = new WeakReference(paramc);
    this.lwA = bs.nullAsNil(paramc.getAppId());
    a locala = (a)paramc.ar(a.class);
    if (locala == null)
    {
      ac.e("MicroMsg.AppBrandNetworkRequest", "<init> hy: config not found, appId(%s)", new Object[] { paramc.getAppId() });
      this.kXC = "";
    ...
    this.lwm = j.a(locala);
    this.kBd = paramInt;
    this.lwB = paramBoolean1;
    this.lwC = paramBoolean2;
    AppMethodBeat.o(144320);
  }
  ...
  private void a(a parama, String paramString1, String paramString2, String paramString3, HttpURLConnection paramHttpURLConnection)
  {
    ...
    parama.dj(paramString1, paramString2);
  ...
  private void tc(String paramString)
  {
    ...
    //   19: aload_1
    //   20: aastore
    //   21: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   24: aload_1
    //   25: ifnonnull +12 -> 37
    //   28: ldc_w 405
    ...
    //   36: return
    //   37: aload_0
    //   38: getfield 56	com/tencent/mm/plugin/appbrand/p/d:lwv	Ljava/util/ArrayList;
    //   41: astore_2
    //   42: aload_2
    //   43: monitorenter
    //   44: aload_0
    //   45: getfield 56	com/tencent/mm/plugin/appbrand/p/d:lwv	Ljava/util/ArrayList;
    //   48: invokevirtual 411	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   51: astore_3
    //   52: aload_3
    //   53: invokeinterface 416 1 0
    //   58: ifeq +56 -> 114
    //   61: aload_3
    //   62: invokeinterface 420 1 0
    //   67: checkcast 160	com/tencent/mm/plugin/appbrand/p/e
    //   70: astore 4
    //   72: aload_1
    //   73: aload 4
    //   75: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   78: invokevirtual 425	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   81: ifeq -29 -> 52
    //   84: ldc 103
    //   86: ldc_w 427
    //   89: iconst_1
    ...
    //   94: iconst_0
    //   95: aload 4
    //   97: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   100: aastore
    //   101: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   104: aload_0
    //   105: getfield 56	com/tencent/mm/plugin/appbrand/p/d:lwv	Ljava/util/ArrayList;
    //   108: aload 4
    //   110: invokevirtual 430	java/util/ArrayList:remove	(Ljava/lang/Object;)Z
    //   113: pop
    //   114: aload_2
    //   115: monitorexit
    //   116: ldc_w 405
  ...
  public final boolean Pe(String paramString)
  {
    ...
    boolean bool = this.lww.contains(paramString);
    AppMethodBeat.o(144325);
    return bool;
  }
  
  final boolean Ph(String paramString)
  {
    AppMethodBeat.i(144327);
    if (((this.kBd == com.tencent.mm.plugin.appbrand.jsapi.j.b.a.kBb) && (this.lwB)) || ((this.kBd == com.tencent.mm.plugin.appbrand.jsapi.j.b.a.kBc) && (this.lwC)))
    {
  ...
  public final e Pi(String paramString)
  {
    ...
    synchronized (this.lwv)
    {
      Iterator localIterator = this.lwv.iterator();
      while (localIterator.hasNext())
      {
        e locale = (e)localIterator.next();
        if (paramString.equals(locale.imk))
        {
          AppMethodBeat.o(144330);
          return locale;
        }
  ...
  public final void a(final c paramc, final int paramInt, final JSONObject paramJSONObject, final Map<String, String> paramMap, final ArrayList<String> paramArrayList, final a parama, final String paramString1, final String paramString2)
  {
    ...
    this.lwx.add(paramString1);
    paramc = new Runnable()
    {
      public final void run()
      {
        AppMethodBeat.i(144319);
        if (d.this.Pe(paramString1))
        {
          ac.w("MicroMsg.AppBrandNetworkRequest", "try request but already abort, taskId:%s, appId:%s", new Object[] { paramString1, d.this.lwA });
          AppMethodBeat.o(144319);
          return;
        }
        if (v.a(paramc.aUV(), paramJSONObject, (v.a)paramc.ar(v.a.class)) == v.b.moH)
        {
          parama.dj("fail", "convert native buffer parameter fail. native buffer exceed size limit.");
          AppMethodBeat.o(144319);
          return;
        }
        String str = j.Pp(paramJSONObject.optString("url"));
        ...
        {
          parama.dj("fail", "url is null");
          AppMethodBeat.o(144319);
          return;
        }
        if ((!URLUtil.isHttpsUrl(str)) && (!URLUtil.isHttpUrl(str)))
        {
          parama.dj("fail", "request protocol must be http or https");
          AppMethodBeat.o(144319);
          return;
        }
        ??? = new byte[0];
        ...
        {
          ??? = ???;
          if (d.this.Ph((String)localObject3))
          {
        ...
        synchronized (d.this.lwv)
        {
          for (;;)
          {
            ac.i("MicroMsg.AppBrandNetworkRequest", "lm:mRequestTaskList.size() :%d,mMaxRequestConcurrent:%d", new Object[] { Integer.valueOf(d.this.lwv.size()), Integer.valueOf(d.this.lwy) });
            if (d.this.lwv.size() < d.this.lwy) {
              break;
            }
            parama.dj("fail", "max connected");
            ac.i("MicroMsg.AppBrandNetworkRequest", "max connected mRequestTaskList.size():%d,mMaxRequestConcurrent:%d", new Object[] { Integer.valueOf(d.this.lwv.size()), Integer.valueOf(d.this.lwy) });
            AppMethodBeat.o(144319);
            return;
            label407:
            ??? = ???;
            if ((localObject5 instanceof ByteBuffer)) {
              ??? = com.tencent.mm.plugin.appbrand.z.d.q((ByteBuffer)localObject5);
            }
          }
          ...
          ac.i("MicroMsg.AppBrandNetworkRequest", "request taskId %s, method %s,timeout %s, useHttp2 %b, useQuic %b, useMemoryCache %b, useProfile %b, url %s ", new Object[] { paramString1, localObject3, Integer.valueOf(paramInt), Boolean.valueOf(bool1), Boolean.valueOf(bool2), Boolean.valueOf(bool3), Boolean.valueOf(bool4), str });
          localObject3 = new e(str, (byte[])???, paramInt, parama, (String)localObject3, bool1, bool2, bool3);
          ((e)localObject3).iml = paramMap;
          ((e)localObject3).lwO = paramArrayList;
          ((e)localObject3).lwT = paramString2;
          ((e)localObject3).lwQ = paramJSONObject.optString("responseType", "text");
          ((e)localObject3).imt = bool1;
          ((e)localObject3).imu = bool2;
          ((e)localObject3).lwV = bool3;
          ((e)localObject3).lwW = bool4;
        }
        synchronized (d.this.lwv)
        {
          ac.i("MicroMsg.AppBrandNetworkRequest", "lm:request mRequestTaskList.add, appId(%s) taskId(%s)", new Object[] { d.this.lwA, paramString1 });
          d.this.lwv.add(localObject3);
          ((e)localObject3).imk = paramString1;
          ac.i("MicroMsg.AppBrandNetworkRequest", "lm:request %s ,url %s", new Object[] { paramString1, str });
          if (((d.this.kBd == com.tencent.mm.plugin.appbrand.jsapi.j.b.a.kBb) && (d.this.lwB)) || ((d.this.kBd == com.tencent.mm.plugin.appbrand.jsapi.j.b.a.kBc) && (d.this.lwC)))
          {
    ...
    h.JZN.aS(new Runnable()
    {
      public final void run()
      {
        ...
        {
          d.this.lwx.remove(paramString1);
  ...
  final void a(e parame)
  {
    ...
    //   97: astore 31
    //   99: aload_1
    //   100: getfield 164	com/tencent/mm/plugin/appbrand/p/e:lwN	Lcom/tencent/mm/plugin/appbrand/p/d$a;
    //   103: astore 60
    //   105: aload_1
    //   106: getfield 298	com/tencent/mm/plugin/appbrand/p/e:iml	Ljava/util/Map;
    //   109: astore 26
    //   111: iconst_0
    //   112: istore_3
    //   113: iconst_0
    ...
    //   162: istore 7
    //   164: aload_1
    //   165: getfield 167	com/tencent/mm/plugin/appbrand/p/e:lwO	Ljava/util/ArrayList;
    //   168: astore 59
    ...
    //   180: aload 59
    //   182: aload_1
    //   183: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   186: invokestatic 180	com/tencent/mm/plugin/appbrand/p/j:c	(Ljava/util/ArrayList;Ljava/lang/String;)Z
    //   189: ifne +83 -> 272
    //   192: aload_0
    //   193: aload 60
    //   195: ldc 182
    //   197: ldc 184
    //   199: aload_1
    //   200: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   203: aconst_null
    //   204: invokespecial 156	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   207: ldc 189
    //   209: invokestatic 195	com/tencent/luggage/a/e:L	(Ljava/lang/Class;)Lcom/tencent/luggage/a/d;
    //   212: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   215: aload_0
    //   216: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   219: aload_1
    //   220: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   223: aload_1
    //   224: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   227: aload_1
    //   228: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   231: lconst_0
    //   232: lconst_0
    //   233: iconst_0
    //   234: iconst_2
    //   235: aload_1
    //   236: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   239: aconst_null
    //   240: aconst_null
    ...
    //   256: iconst_0
    //   257: aload_1
    //   258: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   261: aastore
    //   262: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   265: ldc_w 495
    ...
    //   296: invokestatic 229	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   299: ldc 231
    ...
    //   349: iconst_0
    //   350: aload_1
    //   351: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   354: aastore
    //   355: dup
    //   356: iconst_1
    //   357: aload_1
    //   358: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   361: aastore
    //   362: dup
    //   363: iconst_2
    //   364: aload_1
    //   365: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   368: aastore
    //   369: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   372: new 507	java/net/URL
    //   375: dup
    //   376: aload_1
    //   377: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   380: invokespecial 508	java/net/URL:<init>	(Ljava/lang/String;)V
    //   383: invokevirtual 512	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   386: checkcast 514	java/net/HttpURLConnection
    //   389: astore 27
    //   391: aload 27
    //   393: astore 28
    //   395: aload 27
    ...
    //   429: astore 30
    //   431: aload_1
    //   432: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   435: invokestatic 517	com/tencent/mm/sdk/platformtools/bs:isNullOrNil	(Ljava/lang/String;)Z
    //   438: ifne +49 -> 487
    //   441: aload 27
    //   443: astore 28
    //   445: aload 27
    ...
    //   481: aload_1
    //   482: aload 27
    //   484: putfield 521	com/tencent/mm/plugin/appbrand/p/e:lwR	Ljava/net/HttpURLConnection;
    //   487: aload 27
    ...
    //   664: iconst_0
    //   665: aload_1
    //   666: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   669: aastore
    //   670: dup
    //   671: iconst_1
    //   672: aload_1
    //   673: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   676: aastore
    //   677: invokestatic 111	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   680: ldc 231
    ...
    //   706: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   709: aload_0
    //   710: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   713: aload_1
    //   714: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   717: aload_1
    //   718: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   721: aload_1
    //   722: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   725: aload_1
    //   726: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   729: lconst_0
    //   730: iconst_0
    //   731: iconst_2
    //   732: aload_1
    //   733: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   736: aconst_null
    //   737: aconst_null
    //   738: invokeinterface 208 14 0
    //   743: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   746: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   749: istore_2
    //   750: iload_2
    //   751: iconst_m1
    ...
    //   791: aastore
    //   792: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   795: ldc 103
    //   797: ldc_w 550
    //   800: iconst_1
    ...
    //   805: iconst_0
    //   806: aload_1
    //   807: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   810: aastore
    //   811: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   814: aload_0
    //   815: aload_1
    //   816: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   819: aload 27
    //   821: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   824: ldc 103
    //   826: ldc_w 552
    //   829: iconst_1
    ...
    //   834: iconst_0
    //   835: aload_1
    //   836: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   839: aastore
    //   840: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   843: aload_0
    //   844: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   847: aload_1
    //   848: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   851: invokeinterface 553 2 0
    //   856: pop
    //   857: ldc_w 495
    ...
    //   950: astore 30
    //   952: aload_0
    //   953: getfield 133	com/tencent/mm/plugin/appbrand/p/d:lwm	Ljavax/net/ssl/SSLContext;
    //   956: ifnull +58 -> 1014
    //   959: aload 27
    //   961: astore 28
    //   963: aload 27
    ...
    //   997: astore 30
    //   999: aload 27
    //   1001: checkcast 555	javax/net/ssl/HttpsURLConnection
    //   1004: aload_0
    //   1005: getfield 133	com/tencent/mm/plugin/appbrand/p/d:lwm	Ljavax/net/ssl/SSLContext;
    //   1008: invokevirtual 561	javax/net/ssl/SSLContext:getSocketFactory	()Ljavax/net/ssl/SSLSocketFactory;
    //   1011: invokevirtual 565	javax/net/ssl/HttpsURLConnection:setSSLSocketFactory	(Ljavax/net/ssl/SSLSocketFactory;)V
    //   1014: aload 27
    //   1016: astore 28
    //   1018: aload 27
    //   1020: astore 29
    ...
    //   1056: ldc_w 567
    //   1059: aload 59
    //   1061: invokestatic 570	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   1064: invokevirtual 573	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   1067: invokestatic 397	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   1070: aload 27
    //   1072: astore 28
    //   1074: aload 27
    //   1076: astore 29
    ...
    //   1110: aload 27
    //   1112: aload 59
    //   1114: invokestatic 576	com/tencent/mm/plugin/appbrand/p/j:a	(Ljava/net/HttpURLConnection;Ljava/util/ArrayList;)V
    //   1117: aload 27
    //   1119: astore 28
    //   1121: aload 27
    //   1123: astore 29
    ...
    //   1167: iconst_0
    //   1168: aload_1
    //   1169: getfield 242	com/tencent/mm/plugin/appbrand/p/e:mTimeout	I
    //   1172: invokestatic 248	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   1175: aastore
    //   1176: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1179: aload 27
    //   1181: astore 28
    //   1183: aload 27
    //   1185: astore 29
    ...
    //   1219: aload 27
    //   1221: aload_1
    //   1222: getfield 242	com/tencent/mm/plugin/appbrand/p/e:mTimeout	I
    //   1225: invokevirtual 581	java/net/HttpURLConnection:setConnectTimeout	(I)V
    //   1228: aload 27
    //   1230: astore 28
    //   1232: aload 27
    //   1234: astore 29
    ...
    //   1268: aload 27
    //   1270: aload_1
    //   1271: getfield 242	com/tencent/mm/plugin/appbrand/p/e:mTimeout	I
    //   1274: invokevirtual 584	java/net/HttpURLConnection:setReadTimeout	(I)V
    //   1277: aload 27
    //   1279: astore 28
    //   1281: aload 27
    //   1283: astore 29
    ...
    //   1319: ldc_w 314
    //   1322: ldc_w 316
    //   1325: invokevirtual 587	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   1328: aload 27
    //   1330: astore 28
    //   1332: aload 27
    //   1334: astore 29
    ...
    //   1368: aload 27
    //   1370: iconst_0
    //   1371: invokevirtual 591	java/net/HttpURLConnection:setInstanceFollowRedirects	(Z)V
    //   1374: aload 27
    //   1376: astore 28
    //   1378: aload 27
    //   1380: astore 29
    ...
    //   1410: aload 27
    //   1412: astore 30
    //   1414: getstatic 596	android/os/Build$VERSION:SDK_INT	I
    //   1417: bipush 19
    ...
    //   1460: astore 30
    //   1462: aload_1
    //   1463: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   1466: ldc_w 450
    //   1469: invokevirtual 446	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   1472: ifeq +853 -> 2325
    //   1475: aload 27
    //   1477: astore 28
    //   1479: aload 27
    ...
    //   1515: ldc 103
    //   1517: ldc_w 598
    //   1520: invokestatic 397	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   1523: aload 27
    //   1525: astore 28
    //   1527: aload 27
    //   1529: astore 29
    ...
    //   1565: ldc_w 600
    //   1568: ldc_w 450
    //   1571: invokevirtual 587	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   1574: aload 27
    //   1576: astore 28
    //   1578: aload 27
    //   1580: astore 29
    ...
    //   1614: aload 27
    //   1616: ldc_w 443
    //   1619: invokevirtual 603	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   1622: aload 27
    //   1624: astore 28
    //   1626: aload 27
    //   1628: astore 29
    ...
    //   1662: aload 27
    //   1664: iconst_1
    //   1665: invokevirtual 606	java/net/HttpURLConnection:setUseCaches	(Z)V
    //   1668: aload 27
    //   1670: astore 28
    //   1672: aload 27
    //   1674: astore 29
    ...
    //   1710: ldc_w 300
    //   1713: ldc_w 608
    //   1716: invokevirtual 587	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   1719: aload 26
    ...
    //   1774: iconst_0
    //   1775: aload_1
    //   1776: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   1779: aastore
    //   1780: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1783: aload 27
    //   1785: astore 28
    //   1787: aload 27
    //   1789: astore 29
    ...
    //   1821: astore 30
    //   1823: aload 26
    //   1825: invokeinterface 614 1 0
    //   1830: invokeinterface 615 1 0
    //   1835: astore 26
    //   1837: aload 27
    //   1839: astore 28
    //   1841: aload 27
    ...
    //   1925: astore 30
    //   1927: aload 26
    //   1929: invokeinterface 420 1 0
    //   1934: checkcast 617	java/util/Map$Entry
    //   1937: astore 59
    //   1939: aload 27
    //   1941: astore 28
    //   1943: aload 27
    ...
    //   1979: aload 27
    //   1981: aload 59
    //   1983: invokeinterface 620 1 0
    //   1988: checkcast 422	java/lang/String
    //   1991: aload 59
    //   1993: invokeinterface 623 1 0
    //   1998: checkcast 422	java/lang/String
    //   2001: invokevirtual 587	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   2004: aload 27
    //   2006: astore 28
    //   2008: aload 27
    //   2010: astore 29
    ...
    //   2054: iconst_0
    //   2055: aload_1
    //   2056: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   2059: aastore
    //   2060: dup
    //   2061: iconst_1
    //   2062: aload 59
    //   2064: invokeinterface 620 1 0
    //   2069: aastore
    //   2070: dup
    //   2071: iconst_2
    //   2072: aload 59
    //   2074: invokeinterface 623 1 0
    //   2079: aastore
    //   2080: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2083: goto -246 -> 1837
    //   2086: astore 29
    //   2088: iconst_0
    //   2089: istore_3
    ...
    //   2141: iconst_0
    //   2142: aload_1
    //   2143: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   2146: aastore
    //   2147: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2150: aload_0
    //   2151: aload 60
    //   2153: ldc 182
    //   2155: ldc_w 633
    //   2158: aload_1
    //   2159: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   2162: aload 27
    //   2164: invokespecial 156	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   2167: iload_2
    //   2168: ifeq +3805 -> 5973
    //   2171: ldc 231
    ...
    //   2197: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   2200: aload_0
    //   2201: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   2204: aload_1
    //   2205: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   2208: aload_1
    //   2209: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   2212: aload_1
    //   2213: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   2216: aload_1
    //   2217: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   2220: iload 4
    //   2222: i2l
    //   2223: iload_3
    //   2224: iconst_1
    //   2225: aload_1
    //   2226: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   2229: aconst_null
    //   2230: aconst_null
    ...
    //   2246: iconst_0
    //   2247: aload_1
    //   2248: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   2251: aastore
    //   2252: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2255: aload_0
    //   2256: aload_1
    //   2257: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   2260: aload 27
    //   2262: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   2265: aload 26
    //   2267: ifnull +8 -> 2275
    //   2270: aload 26
    //   2272: invokevirtual 640	java/io/InputStream:close	()V
    //   2275: aload 28
    //   2277: ifnull +8 -> 2285
    //   2280: aload 28
    //   2282: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   2285: ldc 103
    //   2287: ldc_w 552
    //   2290: iconst_1
    ...
    //   2295: iconst_0
    //   2296: aload_1
    //   2297: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   2300: aastore
    //   2301: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2304: aload_0
    //   2305: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   2308: aload_1
    //   2309: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   2312: invokeinterface 553 2 0
    //   2317: pop
    //   2318: ldc_w 495
    ...
    //   2375: iconst_0
    //   2376: aload_1
    //   2377: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   2380: aastore
    //   2381: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2384: aload 27
    //   2386: astore 28
    //   2388: aload 27
    //   2390: astore 29
    ...
    //   2424: aload 27
    //   2426: aload_1
    //   2427: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   2430: invokevirtual 603	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   2433: goto -811 -> 1622
    //   2436: astore 26
    //   2438: iconst_0
    //   2439: istore 5
    ...
    //   2533: iconst_0
    //   2534: aload_1
    //   2535: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   2538: aastore
    //   2539: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2542: iload 5
    //   2544: istore 4
    //   2546: iload 7
    //   2548: istore_2
    ...
    //   2569: ldc_w 649
    //   2572: aload_1
    //   2573: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   2576: aload 32
    //   2578: invokespecial 156	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   2581: iload 7
    //   2583: ifeq +3546 -> 6129
    //   2586: ldc 231
    ...
    //   2612: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   2615: aload_0
    //   2616: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   2619: aload_1
    //   2620: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   2623: aload_1
    //   2624: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   2627: aload_1
    //   2628: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   2631: aload_1
    //   2632: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   2635: iload 6
    //   2637: i2l
    //   2638: iload 5
    //   2640: iconst_1
    //   2641: aload_1
    //   2642: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   2645: aconst_null
    //   2646: aconst_null
    ...
    //   2662: iconst_0
    //   2663: aload_1
    //   2664: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   2667: aastore
    //   2668: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2671: aload_0
    //   2672: aload_1
    //   2673: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   2676: aload 32
    //   2678: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   2681: aload 31
    //   2683: ifnull +8 -> 2691
    //   2686: aload 31
    //   2688: invokevirtual 640	java/io/InputStream:close	()V
    //   2691: aload 30
    //   2693: ifnull +8 -> 2701
    //   2696: aload 30
    //   2698: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   2701: ldc 103
    //   2703: ldc_w 552
    //   2706: iconst_1
    ...
    //   2711: iconst_0
    //   2712: aload_1
    //   2713: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   2716: aastore
    //   2717: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2720: aload_0
    //   2721: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   2724: aload_1
    //   2725: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   2728: invokeinterface 553 2 0
    //   2733: pop
    //   2734: ldc_w 495
    ...
    //   2783: ldc_w 318
    //   2786: aload_0
    //   2787: getfield 115	com/tencent/mm/plugin/appbrand/p/d:kXC	Ljava/lang/String;
    //   2790: invokevirtual 587	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   2793: aload 27
    //   2795: astore 28
    //   2797: aload 27
    //   2799: astore 29
    ...
    //   2833: aload_0
    //   2834: aload_1
    //   2835: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   2838: invokevirtual 322	com/tencent/mm/plugin/appbrand/p/d:Ph	(Ljava/lang/String;)Z
    //   2841: ifeq +995 -> 3836
    //   2844: aload 27
    //   2846: astore 28
    //   2848: aload 27
    ...
    //   2884: ldc 103
    //   2886: ldc_w 651
    //   2889: invokestatic 397	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   2892: aload 27
    //   2894: astore 28
    //   2896: aload 27
    //   2898: astore 29
    ...
    //   2934: ldc_w 324
    //   2937: aload_1
    //   2938: getfield 267	com/tencent/mm/plugin/appbrand/p/e:mPostData	[B
    //   2941: arraylength
    //   2942: invokestatic 327	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   2945: invokevirtual 587	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   2948: aload 27
    //   2950: astore 28
    //   2952: aload 27
    //   2954: astore 29
    ...
    //   2988: aload 27
    //   2990: iconst_1
    //   2991: invokevirtual 654	java/net/HttpURLConnection:setDoOutput	(Z)V
    //   2994: aload 27
    //   2996: astore 28
    //   2998: aload 27
    //   3000: astore 29
    ...
    //   3032: astore 30
    //   3034: aload 27
    //   3036: invokestatic 657	com/tencent/mm/plugin/appbrand/p/j:c	(Ljava/net/HttpURLConnection;)Lorg/json/JSONObject;
    //   3039: astore 59
    //   3041: aload 27
    //   3043: astore 28
    //   3045: aload 27
    ...
    //   3077: aload 27
    //   3079: astore 30
    //   3081: new 642	java/io/DataOutputStream
    //   3084: dup
    //   3085: aload 27
    //   3087: invokevirtual 661	java/net/HttpURLConnection:getOutputStream	()Ljava/io/OutputStream;
    //   3090: invokespecial 664	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   3093: astore 26
    //   3095: aload 26
    //   3097: aload_1
    //   3098: getfield 267	com/tencent/mm/plugin/appbrand/p/e:mPostData	[B
    //   3101: invokevirtual 668	java/io/DataOutputStream:write	([B)V
    //   3104: aload 26
    //   3106: invokevirtual 671	java/io/DataOutputStream:flush	()V
    //   3109: aload 26
    //   3111: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   3114: aload 26
    //   3116: astore 28
    //   3118: aload 59
    //   3120: astore 26
    ...
    //   3131: aload 27
    //   3133: invokevirtual 674	java/net/HttpURLConnection:getResponseCode	()I
    //   3136: istore_2
    //   3137: aload 41
    //   3139: astore 31
    //   3141: aload 42
    ...
    //   3175: astore 30
    //   3177: aload 27
    //   3179: invokestatic 676	com/tencent/mm/plugin/appbrand/p/j:b	(Ljava/net/HttpURLConnection;)Lorg/json/JSONObject;
    //   3182: astore 51
    //   3184: aload 41
    //   3186: astore 31
    //   3188: aload 42
    ...
    //   3290: iconst_1
    //   3291: aload_1
    //   3292: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   3295: aastore
    //   3296: dup
    //   3297: iconst_2
    //   3298: aload_1
    //   3299: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   3302: aastore
    //   3303: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   3306: iload_2
    //   3307: sipush 200
    ...
    //   3363: iconst_0
    //   3364: aload_1
    //   3365: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   3368: aastore
    //   3369: dup
    //   3370: iconst_1
    //   3371: iload_2
    ...
    //   3375: aastore
    //   3376: invokestatic 111	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   3379: aload 41
    //   3381: astore 31
    //   3383: aload 42
    //   3385: astore 39
    ...
    //   3417: astore 30
    //   3419: iload_2
    //   3420: invokestatic 684	com/tencent/mm/plugin/appbrand/p/j:nO	(I)Z
    //   3423: ifeq +980 -> 4403
    //   3426: aload 41
    //   3428: astore 31
    //   3430: aload 42
    ...
    //   3464: astore 30
    //   3466: aload 27
    //   3468: invokestatic 687	com/tencent/mm/plugin/appbrand/p/j:a	(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    //   3471: astore 26
    //   3473: aload 41
    //   3475: astore 31
    //   3477: aload 42
    ...
    //   3511: astore 30
    //   3513: aload_1
    //   3514: getfield 690	com/tencent/mm/plugin/appbrand/p/e:lwP	I
    //   3517: istore 21
    //   3519: aload 41
    //   3521: astore 31
    //   3523: aload 42
    ...
    //   3557: astore 30
    //   3559: aload 26
    //   3561: invokestatic 696	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   3564: ifne +839 -> 4403
    //   3567: iload 21
    //   3569: ifgt +349 -> 3918
    //   3572: aload 41
    ...
    //   3628: aastore
    //   3629: invokestatic 701	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   3632: aload 41
    //   3634: astore 31
    //   3636: aload 42
    //   3638: astore 39
    ...
    //   3682: aload 51
    //   3684: aload_1
    //   3685: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   3688: aload 27
    //   3690: aconst_null
    //   3691: invokespecial 152	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/Object;ILorg/json/JSONObject;Ljava/lang/String;Ljava/net/HttpURLConnection;Ljava/util/Map;)V
    //   3694: ldc 231
    ...
    //   3720: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   3723: aload_0
    //   3724: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   3727: aload_1
    //   3728: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   3731: aload_1
    //   3732: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   3735: aload_1
    //   3736: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   3739: aload_1
    //   3740: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   3743: lconst_0
    //   3744: iload_2
    //   3745: iconst_1
    //   3746: aload_1
    //   3747: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   3750: aconst_null
    //   3751: aconst_null
    ...
    //   3767: iconst_0
    //   3768: aload_1
    //   3769: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   3772: aastore
    //   3773: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   3776: aload_0
    //   3777: aload_1
    //   3778: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   3781: aload 27
    //   3783: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   3786: aload 28
    //   3788: ifnull +8 -> 3796
    //   3791: aload 28
    //   3793: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   3796: ldc 103
    //   3798: ldc_w 552
    //   3801: iconst_1
    ...
    //   3806: iconst_0
    //   3807: aload_1
    //   3808: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   3811: aastore
    //   3812: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   3815: aload_0
    //   3816: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   3819: aload_1
    //   3820: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   3823: invokeinterface 553 2 0
    //   3828: pop
    //   3829: ldc_w 495
    ...
    //   3874: astore 30
    //   3876: aload 27
    //   3878: invokestatic 657	com/tencent/mm/plugin/appbrand/p/j:c	(Ljava/net/HttpURLConnection;)Lorg/json/JSONObject;
    //   3881: astore 26
    //   3883: aconst_null
    //   3884: astore 28
    //   3886: goto -764 -> 3122
    //   3889: astore 26
    //   3891: aload 27
    //   3893: invokevirtual 674	java/net/HttpURLConnection:getResponseCode	()I
    //   3896: istore_2
    //   3897: goto -760 -> 3137
    //   3900: astore 26
    //   3902: ldc 103
    ...
    //   3912: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   3915: goto -119 -> 3796
    //   3918: aload 41
    //   3920: astore 31
    //   3922: aload 42
    ...
    //   3976: iconst_1
    //   3977: aload_1
    //   3978: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   3981: aastore
    //   3982: dup
    //   3983: iconst_2
    //   3984: aload 26
    //   3986: aastore
    //   3987: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   3990: aload 41
    //   3992: astore 31
    //   3994: aload 42
    //   3996: astore 39
    ...
    //   4030: aload_1
    //   4031: aload 26
    //   4033: putfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   4036: aload 41
    //   4038: astore 31
    //   4040: aload 42
    //   4042: astore 39
    ...
    //   4079: iconst_1
    //   4080: isub
    //   4081: putfield 690	com/tencent/mm/plugin/appbrand/p/e:lwP	I
    //   4084: aload 41
    //   4086: astore 31
    //   4088: aload 42
    //   4090: astore 39
    ...
    //   4134: iconst_0
    //   4135: aload_1
    //   4136: getfield 690	com/tencent/mm/plugin/appbrand/p/e:lwP	I
    //   4139: invokestatic 248	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   4142: aastore
    //   4143: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4146: aload 41
    //   4148: astore 31
    //   4150: aload 42
    //   4152: astore 39
    ...
    //   4186: aload_0
    //   4187: aload_1
    //   4188: invokevirtual 711	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/e;)V
    //   4191: ldc 231
    ...
    //   4217: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   4220: aload_0
    //   4221: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   4224: aload_1
    //   4225: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   4228: aload_1
    //   4229: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   4232: aload_1
    //   4233: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   4236: aload_1
    //   4237: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   4240: lconst_0
    //   4241: iload_2
    //   4242: iconst_2
    //   4243: aload_1
    //   4244: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   4247: aconst_null
    //   4248: aconst_null
    //   4249: invokeinterface 208 14 0
    //   4254: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   4257: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   4260: istore_2
    //   4261: iload_2
    //   4262: iconst_m1
    ...
    //   4302: aastore
    //   4303: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4306: ldc 103
    //   4308: ldc_w 550
    //   4311: iconst_1
    ...
    //   4316: iconst_0
    //   4317: aload_1
    //   4318: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   4321: aastore
    //   4322: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4325: aload_0
    //   4326: aload_1
    //   4327: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   4330: aload 27
    //   4332: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   4335: aload 28
    //   4337: ifnull +8 -> 4345
    //   4340: aload 28
    //   4342: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   4345: ldc 103
    //   4347: ldc_w 552
    //   4350: iconst_1
    ...
    //   4355: iconst_0
    //   4356: aload_1
    //   4357: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   4360: aastore
    //   4361: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4364: aload_0
    //   4365: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   4368: aload_1
    //   4369: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   4372: invokeinterface 553 2 0
    //   4377: pop
    //   4378: ldc_w 495
    ...
    //   4397: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4400: goto -55 -> 4345
    //   4403: aload 41
    //   4405: astore 31
    //   4407: aload 42
    ...
    //   4561: aload 50
    //   4563: astore 30
    //   4565: new 715	java/io/ByteArrayOutputStream
    //   4568: dup
    //   4569: invokespecial 716	java/io/ByteArrayOutputStream:<init>	()V
    //   4572: astore 52
    //   4574: aload 41
    //   4576: astore 31
    //   4578: aload 43
    ...
    //   4610: ldc_w 608
    //   4613: aload 27
    //   4615: invokevirtual 719	java/net/HttpURLConnection:getContentEncoding	()Ljava/lang/String;
    //   4618: invokevirtual 425	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   4621: ifeq +554 -> 5175
    //   4624: aload 41
    //   4626: astore 31
    //   4628: aload 43
    ...
    //   4656: aload 50
    //   4658: astore 30
    //   4660: new 721	java/util/zip/GZIPInputStream
    //   4663: dup
    //   4664: aload 27
    //   4666: invokevirtual 725	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   4669: invokespecial 728	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   4672: astore 26
    //   4674: aconst_null
    //   4675: astore 29
    //   4677: aload 26
    ...
    //   4718: aload 26
    //   4720: astore 30
    //   4722: getstatic 596	android/os/Build$VERSION:SDK_INT	I
    //   4725: bipush 24
    ...
    //   4768: astore 30
    //   4770: aload 27
    //   4772: invokevirtual 731	java/net/HttpURLConnection:getContentLengthLong	()J
    //   4775: lstore 22
    //   4777: aload 26
    //   4779: astore 31
    //   4781: aload 26
    ...
    //   4827: iconst_0
    //   4828: lload 22
    //   4830: invokestatic 738	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   4833: aastore
    //   4834: invokestatic 740	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4837: aload 26
    //   4839: astore 31
    //   4841: aload 26
    //   4843: astore 39
    ...
    //   4877: lload 22
    //   4879: iconst_1
    //   4880: invokestatic 743	com/tencent/mm/plugin/appbrand/p/j:i	(JI)I
    //   4883: newarray byte
    //   4885: astore 29
    //   4887: iconst_0
    //   4888: istore_3
    //   4889: aload 26
    //   4891: aload 29
    //   4893: invokevirtual 747	java/io/InputStream:read	([B)I
    //   4896: istore 6
    //   4898: iload 6
    //   4900: iconst_m1
    //   4901: if_icmpeq +703 -> 5604
    //   4904: aload_0
    //   4905: getfield 81	com/tencent/mm/plugin/appbrand/p/d:lwz	Ljava/lang/ref/WeakReference;
    //   4908: invokevirtual 749	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   4911: checkcast 83	com/tencent/mm/plugin/appbrand/jsapi/c
    //   4914: astore 30
    //   4916: aload 30
    //   4918: ifnull +11 -> 4929
    //   4921: aload 30
    //   4923: invokestatic 753	com/tencent/mm/plugin/appbrand/p/j:F	(Lcom/tencent/mm/plugin/appbrand/jsapi/c;)Z
    //   4926: ifeq +660 -> 5586
    //   4929: ldc 103
    //   4931: ldc_w 755
    //   4934: iconst_1
    ...
    //   4939: iconst_0
    //   4940: aload_1
    //   4941: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   4944: aastore
    //   4945: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4948: aload_0
    //   4949: aload 60
    //   4951: ldc 182
    //   4953: ldc_w 757
    //   4956: aload_1
    //   4957: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   4960: aload 27
    //   4962: invokespecial 156	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   4965: aload 26
    //   4967: invokevirtual 640	java/io/InputStream:close	()V
    //   4970: ldc 231
    ...
    //   4996: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   4999: aload_0
    //   5000: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   5003: aload_1
    //   5004: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   5007: aload_1
    //   5008: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   5011: aload_1
    //   5012: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   5015: aload_1
    //   5016: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   5019: iload_3
    //   5020: i2l
    //   5021: iload_2
    //   5022: iconst_2
    //   5023: aload_1
    //   5024: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   5027: aconst_null
    //   5028: aconst_null
    //   5029: invokeinterface 208 14 0
    //   5034: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   5037: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   5040: istore_2
    //   5041: iload_2
    //   5042: iconst_m1
    ...
    //   5082: aastore
    //   5083: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5086: ldc 103
    //   5088: ldc_w 550
    //   5091: iconst_1
    ...
    //   5096: iconst_0
    //   5097: aload_1
    //   5098: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   5101: aastore
    //   5102: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5105: aload_0
    //   5106: aload_1
    //   5107: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   5110: aload 27
    //   5112: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   5115: aload 26
    //   5117: ifnull +8 -> 5125
    //   5120: aload 26
    //   5122: invokevirtual 640	java/io/InputStream:close	()V
    //   5125: aload 28
    //   5127: ifnull +8 -> 5135
    //   5130: aload 28
    //   5132: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   5135: ldc 103
    //   5137: ldc_w 552
    //   5140: iconst_1
    ...
    //   5145: iconst_0
    //   5146: aload_1
    //   5147: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   5150: aastore
    //   5151: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5154: aload_0
    //   5155: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   5158: aload_1
    //   5159: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   5162: invokeinterface 553 2 0
    //   5167: pop
    //   5168: ldc_w 495
    ...
    //   5209: astore 30
    //   5211: aload 27
    //   5213: invokevirtual 725	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   5216: astore 26
    //   5218: goto -544 -> 4674
    //   5221: astore 26
    //   5223: aload 41
    ...
    //   5273: iconst_0
    //   5274: aload 26
    //   5276: invokevirtual 760	java/lang/Exception:toString	()Ljava/lang/String;
    //   5279: aastore
    //   5280: invokestatic 111	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5283: aload 41
    //   5285: astore 31
    //   5287: aload 43
    //   5289: astore 32
    ...
    //   5319: ldc_w 608
    //   5322: aload 27
    //   5324: invokevirtual 719	java/net/HttpURLConnection:getContentEncoding	()Ljava/lang/String;
    //   5327: invokevirtual 425	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   5330: ifeq +56 -> 5386
    //   5333: aload 41
    //   5335: astore 31
    //   5337: aload 43
    ...
    //   5365: aload 50
    //   5367: astore 30
    //   5369: new 721	java/util/zip/GZIPInputStream
    //   5372: dup
    //   5373: aload 27
    //   5375: invokevirtual 763	java/net/HttpURLConnection:getErrorStream	()Ljava/io/InputStream;
    //   5378: invokespecial 728	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   5381: astore 26
    //   5383: goto -709 -> 4674
    //   5386: aload 41
    //   5388: astore 31
    ...
    //   5420: astore 30
    //   5422: aload 27
    //   5424: invokevirtual 763	java/net/HttpURLConnection:getErrorStream	()Ljava/io/InputStream;
    //   5427: astore 26
    //   5429: goto -755 -> 4674
    //   5432: astore 26
    //   5434: aload 41
    ...
    //   5485: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5488: aload 40
    //   5490: astore 26
    //   5492: goto -818 -> 4674
    //   5495: aload 26
    ...
    //   5533: astore 30
    //   5535: aload 27
    //   5537: invokevirtual 768	java/net/HttpURLConnection:getContentLength	()I
    //   5540: istore 21
    //   5542: iload 21
    //   5544: i2l
    //   5545: lstore 22
    ...
    //   5562: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5565: goto -440 -> 5125
    //   5568: astore 26
    //   5570: ldc 103
    //   5572: aload 26
    ...
    //   5580: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5583: goto -448 -> 5135
    //   5586: aload 52
    //   5588: aload 29
    //   5590: iconst_0
    //   5591: iload 6
    //   5593: invokevirtual 771	java/io/ByteArrayOutputStream:write	([BII)V
    //   5596: iload_3
    //   5597: iload 6
    //   5599: iadd
    //   5600: istore_3
    //   5601: goto -712 -> 4889
    //   5604: aload 52
    //   5606: invokevirtual 772	java/io/ByteArrayOutputStream:flush	()V
    //   5609: aload 26
    //   5611: invokevirtual 640	java/io/InputStream:close	()V
    //   5614: aload 27
    //   5616: invokevirtual 775	java/net/HttpURLConnection:disconnect	()V
    //   5619: ldc_w 777
    //   5622: aload_1
    //   5623: getfield 780	com/tencent/mm/plugin/appbrand/p/e:lwQ	Ljava/lang/String;
    //   5626: invokevirtual 425	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   5629: ifeq +292 -> 5921
    //   5632: aload 52
    //   5634: invokevirtual 784	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   5637: invokestatic 790	com/tencent/mm/plugin/appbrand/utils/v:ay	([B)Ljava/nio/ByteBuffer;
    //   5640: astore 29
    //   5642: ldc 103
    //   5644: ldc_w 792
    //   5647: iconst_3
    ...
    //   5652: iconst_0
    //   5653: aload_1
    //   5654: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   5657: aastore
    //   5658: dup
    //   5659: iconst_1
    //   5660: aload_1
    //   5661: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   5664: aastore
    //   5665: dup
    //   5666: iconst_2
    //   5667: aload 52
    //   5669: invokevirtual 795	java/io/ByteArrayOutputStream:size	()I
    //   5672: invokestatic 248	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   5675: aastore
    //   5676: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5679: aload_0
    //   5680: aload 60
    //   5682: ldc_w 703
    //   5685: aload 29
    ...
    //   5688: aload 51
    //   5690: aload_1
    //   5691: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   5694: aload 27
    //   5696: aconst_null
    //   5697: invokespecial 152	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/Object;ILorg/json/JSONObject;Ljava/lang/String;Ljava/net/HttpURLConnection;Ljava/util/Map;)V
    ...
    //   5711: ldc_w 799
    //   5714: lload 22
    //   5716: invokestatic 802	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   5719: invokevirtual 573	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   5722: invokestatic 229	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   5725: ldc 231
    ...
    //   5794: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   5797: aload_0
    //   5798: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   5801: aload_1
    //   5802: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   5805: aload_1
    //   5806: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   5809: aload_1
    //   5810: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   5813: aload_1
    //   5814: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   5817: iload_3
    //   5818: i2l
    //   5819: iload_2
    //   5820: iconst_1
    //   5821: aload_1
    //   5822: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   5825: aconst_null
    //   5826: aconst_null
    ...
    //   5842: iconst_0
    //   5843: aload_1
    //   5844: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   5847: aastore
    //   5848: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5851: aload_0
    //   5852: aload_1
    //   5853: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   5856: aload 27
    //   5858: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   5861: aload 26
    //   5863: ifnull +8 -> 5871
    //   5866: aload 26
    //   5868: invokevirtual 640	java/io/InputStream:close	()V
    //   5871: aload 28
    //   5873: ifnull +8 -> 5881
    //   5876: aload 28
    //   5878: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   5881: ldc 103
    //   5883: ldc_w 552
    //   5886: iconst_1
    ...
    //   5891: iconst_0
    //   5892: aload_1
    //   5893: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   5896: aastore
    //   5897: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5900: aload_0
    //   5901: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   5904: aload_1
    //   5905: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   5908: invokeinterface 553 2 0
    //   5913: pop
    //   5914: ldc_w 495
    ...
    //   5921: aload 52
    //   5923: ldc_w 810
    //   5926: invokevirtual 812	java/io/ByteArrayOutputStream:toString	(Ljava/lang/String;)Ljava/lang/String;
    //   5929: invokestatic 817	com/tencent/mm/plugin/appbrand/utils/w:Rv	(Ljava/lang/String;)Ljava/lang/String;
    //   5932: astore 29
    //   5934: goto -292 -> 5642
    //   5937: astore 26
    //   5939: ldc 103
    ...
    //   5949: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5952: goto -81 -> 5871
    //   5955: astore 26
    //   5957: ldc 103
    //   5959: aload 26
    ...
    //   5967: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5970: goto -89 -> 5881
    //   5973: ldc 231
    ...
    //   5999: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   6002: aload_0
    //   6003: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   6006: aload_1
    //   6007: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   6010: aload_1
    //   6011: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   6014: aload_1
    //   6015: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   6018: aload_1
    //   6019: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   6022: iload 4
    //   6024: i2l
    //   6025: iload_3
    //   6026: iconst_2
    //   6027: aload_1
    //   6028: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   6031: aconst_null
    //   6032: aconst_null
    //   6033: invokeinterface 208 14 0
    //   6038: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   6041: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   6044: istore_2
    //   6045: iload_2
    //   6046: iconst_m1
    ...
    //   6086: aastore
    //   6087: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6090: goto -3854 -> 2236
    //   6093: astore 26
    //   6095: ldc 103
    //   6097: aload 26
    ...
    //   6105: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6108: goto -3833 -> 2275
    //   6111: astore 26
    //   6113: ldc 103
    //   6115: aload 26
    ...
    //   6123: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6126: goto -3841 -> 2285
    //   6129: ldc 231
    ...
    //   6155: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   6158: aload_0
    //   6159: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   6162: aload_1
    //   6163: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   6166: aload_1
    //   6167: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   6170: aload_1
    //   6171: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   6174: aload_1
    //   6175: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   6178: iload 6
    //   6180: i2l
    //   6181: iload 5
    //   6183: iconst_2
    //   6184: aload_1
    //   6185: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   6188: aconst_null
    //   6189: aconst_null
    //   6190: invokeinterface 208 14 0
    //   6195: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   6198: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   6201: istore_2
    //   6202: iload_2
    //   6203: iconst_m1
    ...
    //   6243: aastore
    //   6244: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6247: goto -3595 -> 2652
    //   6250: astore 26
    //   6252: ldc 103
    //   6254: aload 26
    ...
    //   6262: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6265: goto -3574 -> 2691
    //   6268: astore 26
    //   6270: ldc 103
    //   6272: aload 26
    ...
    //   6280: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6283: goto -3582 -> 2701
    //   6286: astore 29
    //   6288: iconst_0
    //   6289: istore 5
    ...
    //   6382: iconst_0
    //   6383: aload_1
    //   6384: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   6387: aastore
    //   6388: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6391: iload 5
    //   6393: istore 4
    //   6395: iload 7
    //   6397: istore_2
    ...
    //   6418: ldc_w 823
    //   6421: aload_1
    //   6422: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   6425: aload 32
    //   6427: invokespecial 156	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   6430: iload 7
    //   6432: ifeq +158 -> 6590
    //   6435: ldc 231
    ...
    //   6461: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   6464: aload_0
    //   6465: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   6468: aload_1
    //   6469: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   6472: aload_1
    //   6473: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   6476: aload_1
    //   6477: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   6480: aload_1
    //   6481: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   6484: iload 6
    //   6486: i2l
    //   6487: iload 5
    //   6489: iconst_1
    //   6490: aload_1
    //   6491: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   6494: aconst_null
    //   6495: aconst_null
    ...
    //   6511: iconst_0
    //   6512: aload_1
    //   6513: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   6516: aastore
    //   6517: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6520: aload_0
    //   6521: aload_1
    //   6522: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   6525: aload 32
    //   6527: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   6530: aload 31
    //   6532: ifnull +8 -> 6540
    //   6535: aload 31
    //   6537: invokevirtual 640	java/io/InputStream:close	()V
    //   6540: aload 30
    //   6542: ifnull +8 -> 6550
    //   6545: aload 30
    //   6547: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   6550: ldc 103
    //   6552: ldc_w 552
    //   6555: iconst_1
    ...
    //   6560: iconst_0
    //   6561: aload_1
    //   6562: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   6565: aastore
    //   6566: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6569: aload_0
    //   6570: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   6573: aload_1
    //   6574: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   6577: invokeinterface 553 2 0
    //   6582: pop
    //   6583: ldc_w 495
    ...
    //   6616: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   6619: aload_0
    //   6620: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   6623: aload_1
    //   6624: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   6627: aload_1
    //   6628: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   6631: aload_1
    //   6632: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   6635: aload_1
    //   6636: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   6639: iload 6
    //   6641: i2l
    //   6642: iload 5
    //   6644: iconst_2
    //   6645: aload_1
    //   6646: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   6649: aconst_null
    //   6650: aconst_null
    //   6651: invokeinterface 208 14 0
    //   6656: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   6659: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   6662: istore_2
    //   6663: iload_2
    //   6664: iconst_m1
    ...
    //   6704: aastore
    //   6705: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6708: goto -207 -> 6501
    //   6711: astore 26
    //   6713: ldc 103
    //   6715: aload 26
    ...
    //   6723: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6726: goto -186 -> 6540
    //   6729: astore 26
    //   6731: ldc 103
    //   6733: aload 26
    ...
    //   6741: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6744: goto -194 -> 6550
    //   6747: astore 29
    //   6749: iconst_0
    //   6750: istore 5
    ...
    //   6830: astore 28
    //   6832: aload_1
    //   6833: getfield 242	com/tencent/mm/plugin/appbrand/p/e:mTimeout	I
    //   6836: sipush 1000
    ...
    //   6919: iconst_0
    //   6920: aload_1
    //   6921: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   6924: aastore
    //   6925: dup
    //   6926: iconst_1
    //   6927: aload_1
    //   6928: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   6931: aastore
    //   6932: dup
    //   6933: iconst_2
    //   6934: aload_1
    //   6935: getfield 242	com/tencent/mm/plugin/appbrand/p/e:mTimeout	I
    //   6938: invokestatic 248	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   6941: aastore
    //   6942: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6945: iload 5
    //   6947: istore 4
    //   6949: iload 7
    //   6951: istore_2
    ...
    //   6982: aload_1
    //   6983: getfield 242	com/tencent/mm/plugin/appbrand/p/e:mTimeout	I
    //   6986: invokevirtual 834	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   6989: invokevirtual 226	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   6992: aload_1
    //   6993: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   6996: aload 33
    //   6998: invokespecial 156	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   7001: iload 7
    //   7003: ifeq +536 -> 7539
    //   7006: ldc 231
    ...
    //   7032: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   7035: aload_0
    //   7036: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   7039: aload_1
    //   7040: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   7043: aload_1
    //   7044: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   7047: aload_1
    //   7048: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   7051: aload_1
    //   7052: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   7055: iload 6
    //   7057: i2l
    //   7058: iload 5
    //   7060: iconst_1
    //   7061: aload_1
    //   7062: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   7065: aconst_null
    //   7066: aconst_null
    ...
    //   7082: iconst_0
    //   7083: aload_1
    //   7084: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7087: aastore
    //   7088: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7091: aload_0
    //   7092: aload_1
    //   7093: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7096: aload 33
    //   7098: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   7101: aload 31
    //   7103: ifnull +8 -> 7111
    //   7106: aload 31
    //   7108: invokevirtual 640	java/io/InputStream:close	()V
    //   7111: aload 30
    //   7113: ifnull +8 -> 7121
    //   7116: aload 30
    //   7118: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   7121: ldc 103
    //   7123: ldc_w 552
    //   7126: iconst_1
    ...
    //   7131: iconst_0
    //   7132: aload_1
    //   7133: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7136: aastore
    //   7137: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7140: aload_0
    //   7141: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   7144: aload_1
    //   7145: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7148: invokeinterface 553 2 0
    //   7153: pop
    //   7154: ldc_w 495
    ...
    //   7181: astore 28
    //   7183: aload_1
    //   7184: getfield 242	com/tencent/mm/plugin/appbrand/p/e:mTimeout	I
    //   7187: sipush 5000
    ...
    //   7286: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   7289: aload_0
    //   7290: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   7293: aload_1
    //   7294: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   7297: aload_1
    //   7298: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   7301: aload_1
    //   7302: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   7305: aload_1
    //   7306: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   7309: iload_3
    //   7310: i2l
    //   7311: iload_2
    //   7312: iconst_1
    //   7313: aload_1
    //   7314: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   7317: aconst_null
    //   7318: aconst_null
    ...
    //   7334: iconst_0
    //   7335: aload_1
    //   7336: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7339: aastore
    //   7340: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7343: aload_0
    //   7344: aload_1
    //   7345: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7348: aload 30
    //   7350: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   7353: aload 28
    //   7355: ifnull +8 -> 7363
    //   7358: aload 28
    //   7360: invokevirtual 640	java/io/InputStream:close	()V
    //   7363: aload 27
    //   7365: ifnull +8 -> 7373
    //   7368: aload 27
    //   7370: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   7373: ldc 103
    //   7375: ldc_w 552
    //   7378: iconst_1
    ...
    //   7383: iconst_0
    //   7384: aload_1
    //   7385: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7388: aastore
    //   7389: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7392: aload_0
    //   7393: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   7396: aload_1
    //   7397: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7400: invokeinterface 553 2 0
    //   7405: pop
    //   7406: ldc_w 495
    ...
    //   7435: astore 28
    //   7437: aload_1
    //   7438: getfield 242	com/tencent/mm/plugin/appbrand/p/e:mTimeout	I
    //   7441: sipush 10000
    ...
    //   7565: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   7568: aload_0
    //   7569: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   7572: aload_1
    //   7573: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   7576: aload_1
    //   7577: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   7580: aload_1
    //   7581: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   7584: aload_1
    //   7585: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   7588: iload 6
    //   7590: i2l
    //   7591: iload 5
    //   7593: iconst_2
    //   7594: aload_1
    //   7595: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   7598: aconst_null
    //   7599: aconst_null
    //   7600: invokeinterface 208 14 0
    //   7605: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   7608: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   7611: istore_2
    //   7612: iload_2
    //   7613: iconst_m1
    ...
    //   7653: aastore
    //   7654: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7657: goto -585 -> 7072
    //   7660: astore 26
    //   7662: ldc 103
    //   7664: aload 26
    ...
    //   7672: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7675: goto -564 -> 7111
    //   7678: astore 26
    //   7680: ldc 103
    //   7682: aload 26
    ...
    //   7690: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7693: goto -572 -> 7121
    //   7696: astore 29
    //   7698: iconst_0
    //   7699: istore 5
    ...
    //   7793: iconst_0
    //   7794: aload_1
    //   7795: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   7798: aastore
    //   7799: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7802: iload 5
    //   7804: istore 4
    //   7806: iload 7
    //   7808: istore_2
    ...
    //   7829: ldc_w 840
    //   7832: aload_1
    //   7833: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7836: aload 34
    //   7838: invokespecial 156	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   7841: iload 7
    //   7843: ifeq +158 -> 8001
    //   7846: ldc 231
    ...
    //   7872: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   7875: aload_0
    //   7876: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   7879: aload_1
    //   7880: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   7883: aload_1
    //   7884: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   7887: aload_1
    //   7888: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   7891: aload_1
    //   7892: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   7895: iload 6
    //   7897: i2l
    //   7898: iload 5
    //   7900: iconst_1
    //   7901: aload_1
    //   7902: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   7905: aconst_null
    //   7906: aconst_null
    ...
    //   7922: iconst_0
    //   7923: aload_1
    //   7924: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7927: aastore
    //   7928: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7931: aload_0
    //   7932: aload_1
    //   7933: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7936: aload 34
    //   7938: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   7941: aload 31
    //   7943: ifnull +8 -> 7951
    //   7946: aload 31
    //   7948: invokevirtual 640	java/io/InputStream:close	()V
    //   7951: aload 30
    //   7953: ifnull +8 -> 7961
    //   7956: aload 30
    //   7958: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   7961: ldc 103
    //   7963: ldc_w 552
    //   7966: iconst_1
    ...
    //   7971: iconst_0
    //   7972: aload_1
    //   7973: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7976: aastore
    //   7977: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7980: aload_0
    //   7981: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   7984: aload_1
    //   7985: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   7988: invokeinterface 553 2 0
    //   7993: pop
    //   7994: ldc_w 495
    ...
    //   8027: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   8030: aload_0
    //   8031: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   8034: aload_1
    //   8035: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   8038: aload_1
    //   8039: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   8042: aload_1
    //   8043: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   8046: aload_1
    //   8047: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   8050: iload 6
    //   8052: i2l
    //   8053: iload 5
    //   8055: iconst_2
    //   8056: aload_1
    //   8057: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   8060: aconst_null
    //   8061: aconst_null
    //   8062: invokeinterface 208 14 0
    //   8067: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   8070: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   8073: istore_2
    //   8074: iload_2
    //   8075: iconst_m1
    ...
    //   8115: aastore
    //   8116: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   8119: goto -207 -> 7912
    //   8122: astore 26
    //   8124: ldc 103
    //   8126: aload 26
    ...
    //   8134: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   8137: goto -186 -> 7951
    //   8140: astore 26
    //   8142: ldc 103
    //   8144: aload 26
    ...
    //   8152: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   8155: goto -194 -> 7961
    //   8158: astore 29
    //   8160: iconst_0
    //   8161: istore 5
    ...
    //   8255: iconst_0
    //   8256: aload_1
    //   8257: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   8260: aastore
    //   8261: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   8264: iload 5
    //   8266: istore 4
    //   8268: iload 7
    //   8270: istore_2
    ...
    //   8291: ldc_w 844
    //   8294: aload_1
    //   8295: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   8298: aload 35
    //   8300: invokespecial 156	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   8303: iload 7
    //   8305: ifeq +158 -> 8463
    //   8308: ldc 231
    ...
    //   8334: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   8337: aload_0
    //   8338: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   8341: aload_1
    //   8342: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   8345: aload_1
    //   8346: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   8349: aload_1
    //   8350: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   8353: aload_1
    //   8354: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   8357: iload 6
    //   8359: i2l
    //   8360: iload 5
    //   8362: iconst_1
    //   8363: aload_1
    //   8364: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   8367: aconst_null
    //   8368: aconst_null
    ...
    //   8384: iconst_0
    //   8385: aload_1
    //   8386: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   8389: aastore
    //   8390: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   8393: aload_0
    //   8394: aload_1
    //   8395: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   8398: aload 35
    //   8400: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   8403: aload 31
    //   8405: ifnull +8 -> 8413
    //   8408: aload 31
    //   8410: invokevirtual 640	java/io/InputStream:close	()V
    //   8413: aload 30
    //   8415: ifnull +8 -> 8423
    //   8418: aload 30
    //   8420: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   8423: ldc 103
    //   8425: ldc_w 552
    //   8428: iconst_1
    ...
    //   8433: iconst_0
    //   8434: aload_1
    //   8435: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   8438: aastore
    //   8439: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   8442: aload_0
    //   8443: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   8446: aload_1
    //   8447: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   8450: invokeinterface 553 2 0
    //   8455: pop
    //   8456: ldc_w 495
    ...
    //   8489: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   8492: aload_0
    //   8493: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   8496: aload_1
    //   8497: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   8500: aload_1
    //   8501: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   8504: aload_1
    //   8505: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   8508: aload_1
    //   8509: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   8512: iload 6
    //   8514: i2l
    //   8515: iload 5
    //   8517: iconst_2
    //   8518: aload_1
    //   8519: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   8522: aconst_null
    //   8523: aconst_null
    //   8524: invokeinterface 208 14 0
    //   8529: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   8532: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   8535: istore_2
    //   8536: iload_2
    //   8537: iconst_m1
    ...
    //   8577: aastore
    //   8578: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   8581: goto -207 -> 8374
    //   8584: astore 26
    //   8586: ldc 103
    //   8588: aload 26
    ...
    //   8596: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   8599: goto -186 -> 8413
    //   8602: astore 26
    //   8604: ldc 103
    //   8606: aload 26
    ...
    //   8614: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   8617: goto -194 -> 8423
    //   8620: astore 29
    //   8622: iconst_0
    //   8623: istore 5
    ...
    //   8717: iconst_0
    //   8718: aload_1
    //   8719: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   8722: aastore
    //   8723: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   8726: iload 5
    //   8728: istore 4
    //   8730: iload 7
    //   8732: istore_2
    ...
    //   8753: ldc_w 848
    //   8756: aload_1
    //   8757: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   8760: aload 36
    //   8762: invokespecial 156	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   8765: iload 7
    //   8767: ifeq +158 -> 8925
    //   8770: ldc 231
    ...
    //   8796: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   8799: aload_0
    //   8800: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   8803: aload_1
    //   8804: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   8807: aload_1
    //   8808: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   8811: aload_1
    //   8812: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   8815: aload_1
    //   8816: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   8819: iload 6
    //   8821: i2l
    //   8822: iload 5
    //   8824: iconst_1
    //   8825: aload_1
    //   8826: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   8829: aconst_null
    //   8830: aconst_null
    ...
    //   8846: iconst_0
    //   8847: aload_1
    //   8848: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   8851: aastore
    //   8852: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   8855: aload_0
    //   8856: aload_1
    //   8857: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   8860: aload 36
    //   8862: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   8865: aload 31
    //   8867: ifnull +8 -> 8875
    //   8870: aload 31
    //   8872: invokevirtual 640	java/io/InputStream:close	()V
    //   8875: aload 30
    //   8877: ifnull +8 -> 8885
    //   8880: aload 30
    //   8882: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   8885: ldc 103
    //   8887: ldc_w 552
    //   8890: iconst_1
    ...
    //   8895: iconst_0
    //   8896: aload_1
    //   8897: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   8900: aastore
    //   8901: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   8904: aload_0
    //   8905: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   8908: aload_1
    //   8909: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   8912: invokeinterface 553 2 0
    //   8917: pop
    //   8918: ldc_w 495
    ...
    //   8951: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   8954: aload_0
    //   8955: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   8958: aload_1
    //   8959: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   8962: aload_1
    //   8963: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   8966: aload_1
    //   8967: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   8970: aload_1
    //   8971: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   8974: iload 6
    //   8976: i2l
    //   8977: iload 5
    //   8979: iconst_2
    //   8980: aload_1
    //   8981: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   8984: aconst_null
    //   8985: aconst_null
    //   8986: invokeinterface 208 14 0
    //   8991: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   8994: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   8997: istore_2
    //   8998: iload_2
    //   8999: iconst_m1
    ...
    //   9039: aastore
    //   9040: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9043: goto -207 -> 8836
    //   9046: astore 26
    //   9048: ldc 103
    //   9050: aload 26
    ...
    //   9058: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9061: goto -186 -> 8875
    //   9064: astore 26
    //   9066: ldc 103
    //   9068: aload 26
    ...
    //   9076: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9079: goto -194 -> 8885
    //   9082: astore 29
    //   9084: iconst_0
    //   9085: istore 5
    ...
    //   9179: iconst_0
    //   9180: aload_1
    //   9181: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   9184: aastore
    //   9185: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9188: iload 5
    //   9190: istore 4
    //   9192: iload 7
    //   9194: istore_2
    ...
    //   9215: ldc_w 854
    //   9218: aload_1
    //   9219: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   9222: aload 37
    //   9224: invokespecial 156	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   9227: iload 7
    //   9229: ifeq +158 -> 9387
    //   9232: ldc 231
    ...
    //   9258: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   9261: aload_0
    //   9262: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   9265: aload_1
    //   9266: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   9269: aload_1
    //   9270: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   9273: aload_1
    //   9274: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   9277: aload_1
    //   9278: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   9281: iload 6
    //   9283: i2l
    //   9284: iload 5
    //   9286: iconst_1
    //   9287: aload_1
    //   9288: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   9291: aconst_null
    //   9292: aconst_null
    ...
    //   9308: iconst_0
    //   9309: aload_1
    //   9310: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   9313: aastore
    //   9314: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9317: aload_0
    //   9318: aload_1
    //   9319: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   9322: aload 37
    //   9324: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   9327: aload 31
    //   9329: ifnull +8 -> 9337
    //   9332: aload 31
    //   9334: invokevirtual 640	java/io/InputStream:close	()V
    //   9337: aload 30
    //   9339: ifnull +8 -> 9347
    //   9342: aload 30
    //   9344: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   9347: ldc 103
    //   9349: ldc_w 552
    //   9352: iconst_1
    ...
    //   9357: iconst_0
    //   9358: aload_1
    //   9359: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   9362: aastore
    //   9363: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9366: aload_0
    //   9367: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   9370: aload_1
    //   9371: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   9374: invokeinterface 553 2 0
    //   9379: pop
    //   9380: ldc_w 495
    ...
    //   9413: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   9416: aload_0
    //   9417: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   9420: aload_1
    //   9421: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   9424: aload_1
    //   9425: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   9428: aload_1
    //   9429: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   9432: aload_1
    //   9433: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   9436: iload 6
    //   9438: i2l
    //   9439: iload 5
    //   9441: iconst_2
    //   9442: aload_1
    //   9443: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   9446: aconst_null
    //   9447: aconst_null
    //   9448: invokeinterface 208 14 0
    //   9453: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   9456: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   9459: istore_2
    //   9460: iload_2
    //   9461: iconst_m1
    ...
    //   9501: aastore
    //   9502: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9505: goto -207 -> 9298
    //   9508: astore 26
    //   9510: ldc 103
    //   9512: aload 26
    ...
    //   9520: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9523: goto -186 -> 9337
    //   9526: astore 26
    //   9528: ldc 103
    //   9530: aload 26
    ...
    //   9538: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9541: goto -194 -> 9347
    //   9544: astore 29
    //   9546: iconst_0
    //   9547: istore 5
    ...
    //   9641: iconst_0
    //   9642: aload_1
    //   9643: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   9646: aastore
    //   9647: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9650: iload 5
    //   9652: istore 4
    //   9654: iload 7
    //   9656: istore_2
    ...
    //   9680: dup
    //   9681: invokespecial 859	java/lang/StringBuilder:<init>	()V
    //   9684: aload 29
    //   9686: invokevirtual 862	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   9689: invokevirtual 865	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   9692: invokevirtual 226	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   9695: aload_1
    //   9696: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   9699: aload 38
    //   9701: invokespecial 156	com/tencent/mm/plugin/appbrand/p/d:a	(Lcom/tencent/mm/plugin/appbrand/p/d$a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   9704: iload 7
    //   9706: ifeq +158 -> 9864
    //   9709: ldc 231
    ...
    //   9735: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   9738: aload_0
    //   9739: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   9742: aload_1
    //   9743: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   9746: aload_1
    //   9747: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   9750: aload_1
    //   9751: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   9754: aload_1
    //   9755: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   9758: iload 6
    //   9760: i2l
    //   9761: iload 5
    //   9763: iconst_1
    //   9764: aload_1
    //   9765: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   9768: aconst_null
    //   9769: aconst_null
    ...
    //   9785: iconst_0
    //   9786: aload_1
    //   9787: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   9790: aastore
    //   9791: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9794: aload_0
    //   9795: aload_1
    //   9796: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   9799: aload 38
    //   9801: invokevirtual 139	com/tencent/mm/plugin/appbrand/p/d:a	(Ljava/lang/String;Ljava/net/HttpURLConnection;)V
    //   9804: aload 31
    //   9806: ifnull +8 -> 9814
    //   9809: aload 31
    //   9811: invokevirtual 640	java/io/InputStream:close	()V
    //   9814: aload 30
    //   9816: ifnull +8 -> 9824
    //   9819: aload 30
    //   9821: invokevirtual 643	java/io/DataOutputStream:close	()V
    //   9824: ldc 103
    //   9826: ldc_w 552
    //   9829: iconst_1
    ...
    //   9834: iconst_0
    //   9835: aload_1
    //   9836: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   9839: aastore
    //   9840: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9843: aload_0
    //   9844: getfield 61	com/tencent/mm/plugin/appbrand/p/d:lww	Ljava/util/Set;
    //   9847: aload_1
    //   9848: getfield 187	com/tencent/mm/plugin/appbrand/p/e:imk	Ljava/lang/String;
    //   9851: invokeinterface 553 2 0
    //   9856: pop
    //   9857: ldc_w 495
    ...
    //   9890: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   9893: aload_0
    //   9894: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   9897: aload_1
    //   9898: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   9901: aload_1
    //   9902: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   9905: aload_1
    //   9906: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   9909: aload_1
    //   9910: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   9913: iload 6
    //   9915: i2l
    //   9916: iload 5
    //   9918: iconst_2
    //   9919: aload_1
    //   9920: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   9923: aconst_null
    //   9924: aconst_null
    //   9925: invokeinterface 208 14 0
    //   9930: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   9933: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   9936: istore_2
    //   9937: iload_2
    //   9938: iconst_m1
    ...
    //   9978: aastore
    //   9979: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   9982: goto -207 -> 9775
    //   9985: astore 26
    //   9987: ldc 103
    //   9989: aload 26
    ...
    //   9997: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   10000: goto -186 -> 9814
    //   10003: astore 26
    //   10005: ldc 103
    //   10007: aload 26
    ...
    //   10015: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   10018: goto -194 -> 9824
    //   10021: ldc 231
    ...
    //   10047: checkcast 189	com/tencent/mm/plugin/appbrand/p/o
    //   10050: aload_0
    //   10051: getfield 95	com/tencent/mm/plugin/appbrand/p/d:lwA	Ljava/lang/String;
    //   10054: aload_1
    //   10055: getfield 198	com/tencent/mm/plugin/appbrand/p/e:lwT	Ljava/lang/String;
    //   10058: aload_1
    //   10059: getfield 201	com/tencent/mm/plugin/appbrand/p/e:bWk	Ljava/lang/String;
    //   10062: aload_1
    //   10063: getfield 176	com/tencent/mm/plugin/appbrand/p/e:mUrl	Ljava/lang/String;
    //   10066: aload_1
    //   10067: invokevirtual 532	com/tencent/mm/plugin/appbrand/p/e:getDataSize	()J
    //   10070: iload_3
    //   10071: i2l
    //   10072: iload_2
    //   10073: iconst_2
    //   10074: aload_1
    //   10075: invokevirtual 205	com/tencent/mm/plugin/appbrand/p/e:bpi	()I
    //   10078: aconst_null
    //   10079: aconst_null
    //   10080: invokeinterface 208 14 0
    //   10085: invokestatic 538	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   10088: invokestatic 544	com/tencent/mm/sdk/platformtools/ax:getNetType	(Landroid/content/Context;)I
    //   10091: istore_2
    //   10092: iload_2
    //   10093: iconst_m1
    ...
    //   10133: aastore
    //   10134: invokestatic 212	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    //   10152: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    //   10170: invokestatic 631	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
  ...
  public final void a(String paramString, HttpURLConnection paramHttpURLConnection)
  {
    ...
    if (paramHttpURLConnection != null) {
      ...
      {
        ac.printErrStackTrace("MicroMsg.AppBrandNetworkRequest", paramHttpURLConnection, "removeTask Exception: id %s", new Object[] { paramString });
      }
    }
    AppMethodBeat.o(144326);
  }
