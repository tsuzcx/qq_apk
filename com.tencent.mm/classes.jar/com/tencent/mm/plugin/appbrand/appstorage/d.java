  ...
  implements q
{
  ...
  private b<String, String> nLR;
  private m<String, String, x> nLS;
  ...
  private int ac(int paramInt, String paramString)
  {
    AppMethodBeat.i(146944);
    c localc = new c();
    localc.field_key = v.n(paramInt, paramString, "@@@TOTAL@DATA@SIZE@@@");
  ...
  private int adx(String paramString)
  {
    AppMethodBeat.i(146948);
    paramString = this.nFQ.query("AppBrandKVData", new String[] { "size" }, "key = ?", new String[] { paramString }, null, null, null, 2);
  ...
  private void g(int paramInt1, String paramString, int paramInt2)
  {
    ...
    c localc = new c();
    localc.field_key = v.n(paramInt1, paramString, "@@@TOTAL@DATA@SIZE@@@");
  ...
  public final void aa(int paramInt, String paramString)
  {
    ...
    for (String str = paramString + "__";; str = paramInt + "__" + paramString + "__")
    {
      ...
      this.nFQ.delete("AppBrandKVData", String.format("%s like ? escape ? OR %s=?", new Object[] { "key", "key" }), new String[] { str.replace("_", "\\_") + "%", "\\", v.n(paramInt, paramString, "@@@TOTAL@DATA@SIZE@@@") });
  ...
  public final q.a d(final int paramInt, final String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    Object localObject1 = v.c(paramInt, paramString1, paramString2, "__");
    int i = adx((String)localObject1);
    int j = v.cP(paramString2, paramString3);
    final int k = j - i;
    if (ac(paramInt, paramString1) + k >= v.ad(paramInt, paramString1)) {}
    for (i = 1; i != 0; i = 0)
    {
    ...
    try
    {
      paramString3 = (q.a)paramString4.invoke();
      AppMethodBeat.o(146937);
      return paramString3;
    }
    catch (SQLiteException paramString3)
    {
      if (Util.nullAsNil(paramString3.getMessage()).contains("no such table"))
      {
        ...
        try
        {
          ...
          paramString4 = (q.a)paramString4.invoke();
        }
  ...
  public final Object[] l(int paramInt, String paramString1, String paramString2)
  {
    ...
    Object localObject2 = new c();
    ((c)localObject2).field_key = v.c(paramInt, paramString1, paramString2, "__");
    try
    {
      if (super.get((IAutoDBItem)localObject2, new String[0]))
      {
        localObject1 = q.a.nNn;
