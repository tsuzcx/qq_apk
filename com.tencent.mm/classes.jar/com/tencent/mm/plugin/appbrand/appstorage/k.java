  ...
  public static boolean ce(String paramString1, String paramString2)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21) {
      try
      {
        ...
        new a();
        Os.rename(str1, str2);
        ad.d("MicroMsg.AppBrand.FileMove", "move, os rename works, cost = %d", new Object[] { Long.valueOf(bt.eGO() - l) });
        AppMethodBeat.o(134327);
        return true;
      }
      catch (Exception localException)
      {
        ad.e("MicroMsg.AppBrand.FileMove", "move, os rename exp = %s", new Object[] { bt.m(localException) });
      }
    }
    boolean bool = new e(paramString1).af(new e(paramString2));
    AppMethodBeat.o(134327);
    return bool;
  }
