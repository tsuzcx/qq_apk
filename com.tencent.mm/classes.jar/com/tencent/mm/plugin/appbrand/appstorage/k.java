  ...
  public static boolean cn(String paramString1, String paramString2)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21) {
      try
      {
        ...
        new a();
        Os.rename(str1, str2);
        ac.d("MicroMsg.AppBrand.FileMove", "move, os rename works, cost = %d", new Object[] { Long.valueOf(bs.eWj() - l) });
        AppMethodBeat.o(134327);
        return true;
      }
      catch (Exception localException)
      {
        ac.e("MicroMsg.AppBrand.FileMove", "move, os rename exp = %s", new Object[] { bs.m(localException) });
      }
    }
    boolean bool = new e(paramString1).ae(new e(paramString2));
    AppMethodBeat.o(134327);
    return bool;
  }
