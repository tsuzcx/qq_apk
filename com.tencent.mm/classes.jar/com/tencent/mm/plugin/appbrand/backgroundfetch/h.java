  ...
  implements b, l
{
  ...
  public final AppBrandBackgroundFetchDataTokenParcel Fm(String paramString)
  {
    ...
    AppBrandBackgroundFetchDataTokenParcel localAppBrandBackgroundFetchDataTokenParcel = this.iXt.Fm(paramString);
  ...
  public final boolean cl(String paramString1, String paramString2)
  {
    ...
    boolean bool = this.iXt.cl(paramString1, paramString2);
    if (bool) {
