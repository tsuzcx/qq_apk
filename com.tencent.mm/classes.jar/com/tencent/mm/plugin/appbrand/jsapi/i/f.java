  ...
  extends b
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    {
      ad.e("MicroMsg.JsApiAddMapGroundOverlay", "data is null");
      paramc.h(paramInt, e("fail:invalid data", null));
      AppMethodBeat.o(186138);
      return;
    }
    ad.i("MicroMsg.JsApiAddMapGroundOverlay", "data:%s", new Object[] { paramJSONObject });
    com.tencent.mm.plugin.appbrand.jsapi.i.a.b localb = h(paramc, paramJSONObject);
    if (localb == null)
    {
      ad.e("MicroMsg.JsApiAddMapGroundOverlay", "mapView is null, return");
    ...
    try
    {
      ...
      {
        ad.i("MicroMsg.JsApiAddMapGroundOverlay", "addGroundOverlay ok");
    ...
    {
      ad.i("MicroMsg.JsApiAddMapGroundOverlay", "");
      ad.e("MicroMsg.JsApiAddMapGroundOverlay", "parse add groundOverlay error, exception : %s", new Object[] { paramJSONObject });
      a(paramc, paramInt, e("fail:internal error", null), false, localb.bkR());
      AppMethodBeat.o(186138);
      return;
    }
    ad.i("MicroMsg.JsApiAddMapGroundOverlay", "addGroundOverlay fail");
