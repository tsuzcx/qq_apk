  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a
{
  ...
  public final void a(com.tencent.mm.plugin.appbrand.jsapi.c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    com.tencent.mm.plugin.appbrand.jsapi.bluetooth.c.md(136);
    if (paramJSONObject == null)
    {
      ae.e("MicroMsg.JsApiGetBLEDeviceServices", "getBLEDeviceServices data is null");
      paramc.h(paramInt, e("fail:invalid data", null));
      com.tencent.mm.plugin.appbrand.jsapi.bluetooth.c.dN(138, 139);
      AppMethodBeat.o(144499);
      return;
    }
    ae.i("MicroMsg.JsApiGetBLEDeviceServices", "appId:%s getBLEDeviceServices data %s", new Object[] { paramc.getAppId(), paramJSONObject.toString() });
    Object localObject = com.tencent.mm.plugin.appbrand.jsapi.bluetooth.a.Qb(paramc.getAppId());
    if (localObject == null)
    {
      ae.e("MicroMsg.JsApiGetBLEDeviceServices", "bleWorker is null, may not open ble");
    ...
    {
      ae.e("MicroMsg.JsApiGetBLEDeviceServices", "adapter is null or not enabled!");
      paramJSONObject = new HashMap();
    ...
    localObject = ((b)localObject).Qd(paramJSONObject.optString("deviceId"));
    paramJSONObject = new HashMap();
    if ((localObject == null) || (((List)localObject).size() <= 0))
    {
      ae.e("MicroMsg.JsApiGetBLEDeviceServices", "not found services");
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if (bu.isNullOrNil(locale.uuid)) {
        ae.e("MicroMsg.JsApiGetBLEDeviceServices", "get uuid is null");
      } else {
        try
        {
          if (locale.jsonObject == null)
          {
            ...
            locale.jsonObject.put("isPrimary", locale.kIO);
          }
          paramJSONObject.put(locale.jsonObject);
        }
        catch (JSONException localJSONException)
        {
          ae.e("MicroMsg.JsApiGetBLEDeviceServices", "JSONException %s", new Object[] { localJSONException.getMessage() });
        }
      }
    }
    ...
    try
    {
      ...
      ae.i("MicroMsg.JsApiGetBLEDeviceServices", "retJson %s", new Object[] { ((JSONObject)localObject).toString() });
      paramc.h(paramInt, ((JSONObject)localObject).toString());
      com.tencent.mm.plugin.appbrand.jsapi.bluetooth.c.md(137);
      AppMethodBeat.o(144499);
      return;
    }
    catch (JSONException paramJSONObject)
    {
      for (;;)
      {
        ae.printErrStackTrace("MicroMsg.JsApiGetBLEDeviceServices", paramJSONObject, "", new Object[0]);
      }
    }
  }
}
