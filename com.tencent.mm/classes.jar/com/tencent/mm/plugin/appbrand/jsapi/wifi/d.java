  ...
  extends a
{
  ...
  public static boolean kxS = false;
  public static BroadcastReceiver kxT = null;
  ...
  public final void a(final com.tencent.mm.plugin.appbrand.jsapi.c paramc, final JSONObject paramJSONObject, int paramInt)
  {
    ...
    if (!kxS)
    {
          ...
          for (;;)
          {
            if ((i != 0) && (j != 0))
            {
              ...
              try
              {
                ...
                paramAnonymousIntent.b(paramc, 0).C(localHashMap).aXQ();
                AppMethodBeat.o(144689);
                return;
              }
      ...
      paramJSONObject.registerReceiver(kxT, localIntentFilter);
      kxS = true;
    }
