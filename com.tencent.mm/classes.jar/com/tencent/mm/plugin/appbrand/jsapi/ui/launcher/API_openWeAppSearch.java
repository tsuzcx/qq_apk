  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a<com.tencent.mm.plugin.appbrand.d>
{
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/appbrand/jsapi/ui/launcher/API_openWeAppSearch$Companion;", "", "()V", "CTRL_INDEX", "", "NAME", "", "plugin-appbrand-integration_release"})
  ...
  {
    @l(gfx={1, 1, 16}, gfy={""}, gfz={"performCallback", "", "result", "Lcom/tencent/mm/plugin/appbrand/jsapi/ui/launcher/API_openWeAppSearch$IPC_AppBrandSearchUIParamsPrepareResult;", "invoke"})
    static final class a
      extends q
      implements d.g.a.b<API_openWeAppSearch.IPC_AppBrandSearchUIParamsPrepareResult, z>
    {
      ...
      public final void a(API_openWeAppSearch.IPC_AppBrandSearchUIParamsPrepareResult paramIPC_AppBrandSearchUIParamsPrepareResult)
      {
        ...
        this.jDK.be(paramIPC_AppBrandSearchUIParamsPrepareResult);
        this.lkc.value = true;
        AppMethodBeat.o(50711);
      }
    }
      ...
      implements Runnable
    {
      ...
      public final void run()
      {
        ...
        Object localObject = com.tencent.mm.plugin.appbrand.c.a.jVc;
        localObject = com.tencent.mm.plugin.appbrand.c.a.I(aj.getContext(), this.lkd.ljZ);
        API_openWeAppSearch.b.a locala = this.lke;
    ...
    @l(gfx={1, 1, 16}, gfy={""}, gfz={"<anonymous>", "", "<anonymous parameter 0>", "", "<anonymous parameter 1>", "<anonymous parameter 2>", "", "kotlin.jvm.PlatformType", "<anonymous parameter 3>", "Lcom/tencent/mm/modelbase/NetSceneBase;", "onSceneEnd"})
      ...
      implements f
    {
      ...
      public final void onSceneEnd(int paramInt1, int paramInt2, String paramString, n paramn)
      {
        ...
        if (!((i)paramString).eLH())
        {
          paramString = this.lke;
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"<anonymous>", "", "result", "Lcom/tencent/mm/plugin/appbrand/jsapi/ui/launcher/API_openWeAppSearch$IPC_AppBrandSearchUIParamsPrepareResult;", "kotlin.jvm.PlatformType", "onCallback"})
    ...
    implements com.tencent.mm.ipcinvoker.d<API_openWeAppSearch.IPC_AppBrandSearchUIParamsPrepareResult>
  {
    ...
    @l(gfx={1, 1, 16}, gfy={""}, gfz={"<anonymous>", "", "invoke", "com/tencent/mm/plugin/appbrand/jsapi/ui/launcher/API_openWeAppSearch$invoke$1$1$2"})
    static final class a
      extends q
