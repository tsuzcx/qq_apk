  ...
  extends f
{
  ...
  protected final f.a b(c paramc, JSONObject paramJSONObject)
  {
    ...
    if ((bs.isNullOrNil(paramc.kLr)) && (bs.isNullOrNil(paramc.kLs)))
    {
      ac.i("MicroMsg.JsApiShareAppMessageToSpecificContactForFakeNativeDirectly", "openid and chatroom is null");
