  ...
  extends h
{
  ...
  public f()
  {
    ...
    this.kEQ = false;
    this.kER = false;
    com.tencent.mm.plugin.appbrand.permission.c.Qk("updateVoIPChatMuteConfig");
  ...
  public final void a(final com.tencent.mm.plugin.appbrand.service.c paramc, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    try
    {
      ...
      ac.i("MicroMsg.OpenVoice.JsApiCloudVoiceUpdateVoIPChatMuteConfig", "hy: muteMicroPhone:%b, muteEarPhone:%b, handsFree:%b", new Object[] { Boolean.valueOf(bool1), Boolean.valueOf(bool2), Boolean.valueOf(bool3) });
      p.otZ.a(bool2, new b() {});
      p.otZ.b(bool1, new b() {});
      p.otZ.c(bool3, new b() {});
    ...
    {
      ac.printErrStackTrace("MicroMsg.OpenVoice.JsApiCloudVoiceUpdateVoIPChatMuteConfig", paramc, "", new Object[0]);
      AppMethodBeat.o(46690);
    }
  }
}
