...
public final class q
{
  ...
  public static String abG(String paramString)
  {
    ...
    paramString = y(new u(MMApplicationContext.getContext().getCacheDir(), paramString));
  ...
  public static void abH(String paramString)
  {
    ...
    boolean bool = new u(MMApplicationContext.getContext().getCacheDir(), paramString).diJ();
  ...
  public static void f(String paramString, String... paramVarArgs)
  {
    ...
    //   15: aload_0
    //   16: invokespecial 49	com/tencent/mm/vfs/u:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   19: astore_0
    //   20: new 96	com/tencent/mm/vfs/ac
    //   23: dup
    //   24: aload_0
    //   25: invokespecial 99	com/tencent/mm/vfs/ac:<init>	(Lcom/tencent/mm/vfs/u;)V
    //   28: astore 4
    //   30: aload_1
    //   31: arraylength
    //   32: istore_3
    ...
    //   43: iload_2
    //   44: aaload
    //   45: invokevirtual 102	com/tencent/mm/vfs/ac:write	(Ljava/lang/String;)V
    //   48: iload_2
    //   49: iconst_1
    //   50: iadd
    //   51: istore_2
    //   52: goto -17 -> 35
    //   55: aload 4
    //   57: invokevirtual 106	com/tencent/mm/vfs/ac:close	()V
    //   60: ldc 94
    ...
    //   77: ifnull +7 -> 84
    //   80: aload_1
    //   81: invokevirtual 106	com/tencent/mm/vfs/ac:close	()V
    //   84: ldc 94
    ...
    //   34	18	2	i	int
    //   32	6	3	j	int
    //   28	69	4	localac	com.tencent.mm.vfs.ac
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  private static String y(u paramu)
  {
    // Byte code:
    //   0: ldc 117
    //   2: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   5: aload_0
    //   6: invokevirtual 120	com/tencent/mm/vfs/u:jKS	()Z
    //   9: ifne +11 -> 20
    //   12: ldc 117
    ...
    //   31: dup
    //   32: new 130	com/tencent/mm/vfs/ab
    //   35: dup
    //   36: aload_0
    //   37: invokespecial 131	com/tencent/mm/vfs/ab:<init>	(Lcom/tencent/mm/vfs/u;)V
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.storage.q
