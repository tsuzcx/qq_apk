  ...
  extends y<C>
{
  ...
  protected Map<String, Object> a(C paramC)
  {
    ...
    localHashMap.put("screenWidth", Integer.valueOf(g.uk(paramC.widthPixels)));
    localHashMap.put("screenHeight", Integer.valueOf(g.uk(paramC.heightPixels)));
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.v.h
