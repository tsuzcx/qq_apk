...
@l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/appbrand/jsapi/xwebplugin/video/AppBrandVideoCastHandler$Companion;", "", "()V", "TAG", "", "getFormatTime", "timeMs", "", "getMsTime", "", "formatTime", "luggage-xweb-ext_release"})
public final class b$c
{
  public static long Ry(String paramString)
  {
    ...
    localObject = new k(":").q((CharSequence)localObject, 0);
    ...
    for (localObject = j.b((Iterable)localObject, localListIterator.nextIndex() + 1);; localObject = (List)d.a.v.MKE)
    {
  ...
  public static String tP(int paramInt)
  {
    ...
    p.g(localObject, "formatter.format(\"%02d:%…utes, seconds).toString()");
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ac.e.b.c
