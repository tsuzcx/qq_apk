  ...
  extends b
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    {
      ac.e("MicroMsg.JsApiSetMapCenterOffset", "data is null");
      paramc.h(paramInt, e("fail:invalid data", null));
      AppMethodBeat.o(143691);
      return;
    }
    ac.i("MicroMsg.JsApiSetMapCenterOffset", "data:%s", new Object[] { paramJSONObject });
    com.tencent.mm.plugin.appbrand.jsapi.f.a.b localb = h(paramc, paramJSONObject);
    if (localb == null)
    {
      ac.e("MicroMsg.JsApiSetMapCenterOffset", "mapView is null, return");
    ...
    catch (JSONException paramJSONObject)
    {
      for (;;)
      {
        ac.e("MicroMsg.JsApiSetMapCenterOffset", "parse offset err:%s", new Object[] { paramJSONObject });
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.f.x
