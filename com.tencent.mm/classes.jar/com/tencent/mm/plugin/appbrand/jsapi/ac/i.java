  ...
  extends d
{
  ...
  public final boolean c(e parame, int paramInt, View paramView, JSONObject paramJSONObject)
  {
    ...
    try
    {
      paramView.setBackgroundColor(g.VI(paramJSONObject.getString("backgroundColor")));
      label43:
      paramJSONObject = paramJSONObject.optString("src", "");
      ae.i("MicroMsg.AppBrand.JsApiUpdateHTMLWebView", "onUpdateView appId[%s] viewId[%d] viewHash[%d] src[%s]", new Object[] { parame.getAppId(), Integer.valueOf(paramInt), Integer.valueOf(paramView.hashCode()), paramJSONObject });
      ...
      if ((paramJSONObject.indexOf("#") >= 0) && (!TextUtils.isEmpty(parame.getUrl()))) {
        parame.evaluateJavascript(String.format("window.location=\"%s\"", new Object[] { r.VN(paramJSONObject) }), null);
      }
      for (;;)
      {
        AppMethodBeat.o(47020);
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ac.i
