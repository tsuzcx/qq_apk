...
public final class di
{
  ...
  public static String H(String paramString1, String paramString2, int paramInt)
  {
    ...
    //   49: dup
    //   50: iconst_3
    //   51: invokestatic 37	com/tencent/mm/plugin/appbrand/jsapi/di:aZl	()Ljava/lang/String;
    //   54: aastore
  ...
  public static void a(o paramo, String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      n localn = (n)((i)paramo).Z(n.class);
      if (localn != null)
      {
        localn.subscribeHandler(paramString1, paramString2, paramInt, aZl());
        AppMethodBeat.o(325487);
        return;
      }
    }
    paramo.evaluateJavascript(H(paramString1, paramString2, paramInt), null);
    AppMethodBeat.o(325487);
  }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.di
