...
@l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lcom/tencent/mm/plugin/appbrand/jsapi/webview/AppBrandXWVideoJsCallbackIMPL;", "Lcom/tencent/xweb/VideoJsCallback;", "()V", "webView", "Lcom/tencent/mm/plugin/appbrand/jsapi/webview/AppBrandHTMLWebView;", "getWebView", "()Lcom/tencent/mm/plugin/appbrand/jsapi/webview/AppBrandHTMLWebView;", "setWebView", "(Lcom/tencent/mm/plugin/appbrand/jsapi/webview/AppBrandHTMLWebView;)V", "onVideoEmptied", "", "onVideoEnded", "onVideoEnterFullscreen", "isVideoTag", "", "id", "", "width", "", "height", "paused", "seeking", "currentTime", "duration", "buffered", "", "onVideoError", "error", "", "msg", "", "onVideoExitFullscreen", "onVideoPause", "onVideoPlay", "onVideoPlaying", "onVideoSeeked", "onVideoSeeking", "onVideoSizeUpdate", "onVideoTimeUpdate", "onVideoWaiting", "Companion", "plugin-appbrand-integration_release"})
public abstract class d
  implements v
{
  @Deprecated
  public static final a kYp = new a((byte)0);
  private a kYo;
  ...
  public final void onVideoEnterFullscreen(boolean paramBoolean1, long paramLong, double paramDouble1, double paramDouble2, boolean paramBoolean2, boolean paramBoolean3, double paramDouble3, double paramDouble4, double[] paramArrayOfDouble)
  {
    ...
    {
      ac.i("MicroMsg.AppBrandXWVideoJsCallbackIMPL", i + ']');
      return;
    }
  }
  ...
  public final void onVideoError(int paramInt, String paramString)
  {
    ...
    {
      ac.e("MicroMsg.AppBrandXWVideoJsCallbackIMPL", paramInt + ']');
      return;
    }
  }
  ...
  @l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lcom/tencent/mm/plugin/appbrand/jsapi/webview/AppBrandXWVideoJsCallbackIMPL$Companion;", "", "()V", "TAG", "", "plugin-appbrand-integration_release"})
