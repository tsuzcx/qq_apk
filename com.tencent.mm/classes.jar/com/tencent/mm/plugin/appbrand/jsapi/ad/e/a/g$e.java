  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bd(paramView);
    com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/appbrand/jsapi/xwebplugin/video/cast/SelectDevicesBottomSheet$initView$2", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahF());
    paramView = g.d(this.lEq);
    if (paramView != null) {
      paramView.invoke();
    }
    paramView = g.c(this.lEq);
    if (paramView != null) {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ad.e.a.g.e
