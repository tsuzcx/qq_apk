  ...
  implements com.tencent.mm.plugin.appbrand.jsapi.j.e
{
  ...
  final void a(com.tencent.mm.plugin.appbrand.jsapi.c paramc, String paramString1, String paramString2)
  {
  ...
  public final void a(final com.tencent.mm.plugin.appbrand.jsapi.c paramc, JSONObject paramJSONObject, final String paramString)
  {
    ...
    Object localObject = paramc.Ee().EP(str1);
    ...
    final String str2 = q.B(((com.tencent.mm.vfs.e)localObject).fhU());
    String str3 = d.aCP(str1);
    ...
    g.a local1 = new g.a()
    {
      ...
      public final void IL(String paramAnonymousString)
      {
      ...
      public final void i(int paramAnonymousInt1, String paramAnonymousString, int paramAnonymousInt2)
      {
        ...
        if (paramAnonymousInt1 == 0)
        {
          ...
          if (this.kaJ != null) {
            localHashMap.put("header", this.kaJ);
          }
          paramAnonymousString = new JSONObject(localHashMap).toString();
          new a.a().h(paramc).HK(paramAnonymousString).a(a.this.kaj.II(paramString));
    ...
    for (boolean bool = false; (bool) && (!j.c(locala.cfJ, (String)localObject)); bool = locala.kUo)
    {
    ...
    for (;;)
    {
      if (i.bir().Ld(str4) == null)
      {
        localObject = new g(paramc);
        i locali = i.bir();
        paramc = (com.tencent.mm.plugin.appbrand.jsapi.c)localObject;
        if (!locali.kUJ.containsKey(str4)) {
          locali.kUJ.put(str4, localObject);
        }
      }
      for (paramc = (com.tencent.mm.plugin.appbrand.jsapi.c)localObject;; paramc = i.bir().Ld(str4))
      {
        localObject = org.apache.commons.a.c.getName(str1);
        if (paramc == null) {
          break label520;
        }
      ...
      paramc.a(i, str3, str2, paramJSONObject, localMap, locala.cfJ, local1, paramString, "createUploadTask", (String)localObject);
      label520:
      AppMethodBeat.o(179540);
      return;
      i = 60000;
