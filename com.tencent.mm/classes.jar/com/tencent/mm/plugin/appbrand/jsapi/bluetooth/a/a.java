  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.c
{
  ...
  public final void a(e parame, JSONObject paramJSONObject, int paramInt)
  {
    ...
    com.tencent.mm.plugin.appbrand.jsapi.bluetooth.c.rE(91);
    if (paramJSONObject == null)
    {
      ...
      com.tencent.mm.plugin.appbrand.jsapi.bluetooth.c.ex(93, 94);
      AppMethodBeat.o(144494);
      return;
    }
    Log.i("MicroMsg.JsApiCloseBLEConnection", "appId:%s closeBLEConnection data %s", new Object[] { parame.getAppId(), paramJSONObject.toString() });
    b localb = com.tencent.mm.plugin.appbrand.jsapi.bluetooth.a.ahq(parame.getAppId());
    if (localb == null)
    {
      ...
      com.tencent.mm.plugin.appbrand.jsapi.bluetooth.c.ex(93, 96);
      AppMethodBeat.o(144494);
      return;
    }
    if (!com.tencent.mm.plugin.appbrand.jsapi.bluetooth.sdk.d.c.bRm())
    {
      ...
      com.tencent.mm.plugin.appbrand.jsapi.bluetooth.c.ex(93, 98);
      AppMethodBeat.o(144494);
      return;
    }
    ...
    localb.a(str, paramJSONObject, new a.1(this, parame, paramInt));
    AppMethodBeat.o(144494);
  }
}
