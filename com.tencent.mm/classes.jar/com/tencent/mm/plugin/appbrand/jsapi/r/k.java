  ...
  extends e
{
  ...
  final void ad(JSONObject paramJSONObject)
  {
    ...
    if (localObject2 != null)
    {
      ...
      localObject1 = com.tencent.mm.plugin.appbrand.widget.picker.e.agg((String)localObject1);
      if (localObject1 != null)
      {
        this.mMinTimeHour = localObject1[0];
        this.mMinTimeMinute = localObject1[1];
      }
      localObject1 = com.tencent.mm.plugin.appbrand.widget.picker.e.agg((String)localObject2);
      if (localObject1 != null)
      {
    ...
    paramJSONObject = com.tencent.mm.plugin.appbrand.widget.picker.e.agg(paramJSONObject.optString("current"));
    if (paramJSONObject != null)
    {
      this.mnn = paramJSONObject[0];
      this.mno = paramJSONObject[1];
    }
    P(new Runnable()
    {
