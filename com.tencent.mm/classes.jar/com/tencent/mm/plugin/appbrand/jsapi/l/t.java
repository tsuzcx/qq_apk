...
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.a;
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.f;
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.g;
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.l;
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.m;
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.o;
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.p;
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.s;
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.t;
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.u;
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.w;
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.x;
import com.tencent.mm.plugin.appbrand.jsapi.l.a.b.z;
  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.base.b
{
  ...
  public final View a(final com.tencent.mm.plugin.appbrand.jsapi.g paramg, final JSONObject paramJSONObject)
  {
    ...
    com.tencent.mm.plugin.appbrand.jsapi.l.a.e.AC(0);
    final String str = paramg.getAppId();
    Log.i("MicroMsg.JsApiInsertMap", "insertMap appId:%s viewId:%d data:%s", new Object[] { str, Integer.valueOf(K(paramJSONObject)), paramJSONObject });
    final com.tencent.mm.plugin.appbrand.jsapi.l.a.b localb = ((c)com.tencent.luggage.a.e.K(c.class)).b(paramg, paramJSONObject);
    if (localb == null)
    {
    ...
    if (!com.tencent.mm.plugin.appbrand.jsapi.l.a.g.a(str, f.h(paramg, paramJSONObject), localb))
    {
      Log.e("MicroMsg.JsApiInsertMap", "initMapView is false, return");
      com.tencent.mm.plugin.appbrand.jsapi.l.a.e.AC(1);
      AppMethodBeat.o(143683);
      return null;
    }
    com.tencent.mm.plugin.appbrand.jsapi.l.a.e.AC(2);
    localb.im(paramJSONObject.optBoolean("enableZoom", true));
    localb.in(paramJSONObject.optBoolean("enableScroll", true));
    localb.io(paramJSONObject.optBoolean("enableRotate", false));
    localb.ip(paramJSONObject.optBoolean("showCompass", false));
    localb.setBuilding3dEffectEnable(paramJSONObject.optBoolean("enable3D", false));
    localb.iq(paramJSONObject.optBoolean("enableOverlooking", false));
    localb.ir(paramJSONObject.optBoolean("enableSatellite", false));
    localb.it(paramJSONObject.optBoolean("enableIndoor", true));
    localb.iu(paramJSONObject.optBoolean("enableIndoorLevelPick", false));
    localb.iv(paramJSONObject.optBoolean("showScale", true));
    ...
    if (paramJSONObject.has("enableBuilding")) {
      localb.iw(paramJSONObject.optBoolean("enableBuilding", true));
    }
    ...
    paramg.a(new h.c()
    {
      public final void onDestroy()
      {
        ...
        paramg.b(this);
        com.tencent.mm.plugin.appbrand.jsapi.l.a.g.dL(str, f.h(paramg, paramJSONObject));
        AppMethodBeat.o(143674);
      }
    });
    localb.getView().setVisibility(0);
    paramg = new CoverViewContainer(paramg.getContext(), localb.getView());
    AppMethodBeat.o(143683);
    return paramg;
  }
  
  public final void a(final com.tencent.mm.plugin.appbrand.jsapi.g paramg, final int paramInt, final View paramView, JSONObject paramJSONObject)
  {
    AppMethodBeat.i(143685);
    paramView = com.tencent.mm.plugin.appbrand.jsapi.l.a.g.dK(paramg.getAppId(), f.h(paramg, paramJSONObject));
    if (paramView == null)
    {
    ...
    paramView.a(new b.l()
    {
      public final void a(b.u paramAnonymousu)
      {
        ...
        try
        {
          ...
          localb.agU(localJSONObject.toString());
    ...
    paramView.a(new b.p()
    {
      public final boolean b(b.u paramAnonymousu)
      {
        ...
        try
        {
          localJSONObject.put("mapId", paramInt);
          localJSONObject.put("data", paramAnonymousu.data);
          localf.agU(localJSONObject.toString());
          paramg.a(localf, null);
    ...
    paramView.a(new b.m()
    {
      public final void d(double paramAnonymousDouble1, double paramAnonymousDouble2)
      {
        ...
        try
        {
          ...
          localc.agU(localJSONObject.toString());
          paramg.a(localc, null);
    ...
    paramView.a(new b.o()
    {
      public final boolean c(b.u paramAnonymousu)
      {
        ...
        try
        {
          localJSONObject.put("mapId", paramInt);
          localJSONObject.put("data", paramAnonymousu.data);
          locale.agU(localJSONObject.toString());
          paramg.a(locale, null);
    ...
    paramView.a(new b.z()
    {
      public final void a(b.t paramAnonymoust)
      {
        ...
        try
        {
          ...
          localg.agU(localJSONObject.toString());
          paramg.a(localg, null);
    ...
    paramView.ix(paramJSONObject.optBoolean("showLocation"));
    paramView.a(new b.w()
    {
      ...
      public final void a(b.a paramAnonymousa, boolean paramAnonymousBoolean)
      {
        ...
        if (this.oWh.compareAndSet(false, true)) {}
        for (;;)
        {
          try
          {
          ...
          this.oWj.agU(this.jsonObject.toString());
          paramg.a(this.oWj, null);
          this.oWi = paramAnonymousa.zoom;
      ...
      public final void b(b.a paramAnonymousa, boolean paramAnonymousBoolean)
      {
        ...
        if (this.oWh.compareAndSet(true, false)) {}
        for (;;)
        {
          try
          {
            ...
            if (paramAnonymousa.zoom == this.oWi) {
              continue;
            }
            i = 1;
            if (!paramAnonymousBoolean) {
          ...
          this.jsonObject.remove("rotate");
          this.jsonObject.put("rotate", paramAnonymousa.oYk);
          this.jsonObject.remove("skew");
      ...
      public final void a(b.f paramAnonymousf)
      {
        ...
        try
        {
          ...
          if (paramAnonymousf != null)
          {
            ...
            if ((paramAnonymousf.oYq != null) && (paramAnonymousf.oYq.size() > 0))
            {
              localJSONArray = new JSONArray();
              Iterator localIterator = paramAnonymousf.oYq.iterator();
          ...
          {
            locald.agU(localJSONObject1.toString());
          }
        }
        ...
        for (;;)
        {
          ...
          localJSONObject1.put("floorIndex", paramAnonymousf.oYr);
        }
      }
    });
    paramView.a(new b.s()
    {
      public final void c(double paramAnonymousDouble1, double paramAnonymousDouble2)
      {
