  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a
{
    ...
    com.tencent.mm.sdk.g.b.d(new Runnable()
    {
      public final void run()
      {
        ...
        for (Object localObject = new g.b((byte)0);; localObject = new g.d((byte)0))
        {
          ...
          if ((this.cQR.get() == null) || (!((c)this.cQR.get()).isRunning())) {
            break label256;
          }
          localc = (c)this.cQR.get();
          if ((((g.a)localObject).success) || (!bt.isNullOrNil(((g.a)localObject).result))) {
            break;
          }
        ...
        {
          ad.w("MicroMsg.JsApiCompressImage.javayhu", "worker:compress image fail, message:%s", new Object[] { ((g.a)localObject).result });
    ...
    implements g.c
  {
    public final g.a a(c paramc, String paramString, int paramInt)
    {
      ...
      e locale = paramc.Ee().EP(paramString);
      if (locale == null)
      {
      ...
      try
      {
        ...
        localBitmap = d.a.a((d)paramc.K(d.class)).decodeFile(com.tencent.mm.vfs.q.B(locale.fhU()), localOptions);
        if (localBitmap == null)
        {
      ...
      catch (OutOfMemoryError paramc)
      {
        try
        {
          ...
          for (paramString = Bitmap.CompressFormat.JPEG;; paramString = Bitmap.CompressFormat.PNG)
          {
            ...
            if (com.tencent.luggage.e.a.a.d(localOptions)) {
              com.tencent.mm.plugin.appbrand.m.b.cH(com.tencent.mm.vfs.q.B(locale.fhU()), str);
            }
            paramString = new com.tencent.mm.plugin.appbrand.aa.i();
            if (localp.a(new e(str), paramc, false, paramString) == l.iSq) {
              break label323;
            }
      ...
      str = com.tencent.mm.loader.j.b.ais() + "microMsg.tmp." + System.currentTimeMillis() + "." + paramc;
