  ...
  extends a
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    if (((String)localObject1).equalsIgnoreCase("getAbsolutePath"))
    {
      ...
      paramJSONObject = paramc.Fg().Mj((String)localObject1);
      ...
      try
      {
        ...
        ((JSONObject)localObject1).put("filePath", q.B(paramJSONObject.fOK()));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else
        {
          ...
          localObject2 = ((x)paramJSONObject.Mt("wxfile://clientdata")).jMN;
      ...
      if (i.fv(paramJSONObject)) {
        i.deleteFile(paramJSONObject);
      }
      String str1 = i.aYr(paramJSONObject);
      i.aYg(str1);
