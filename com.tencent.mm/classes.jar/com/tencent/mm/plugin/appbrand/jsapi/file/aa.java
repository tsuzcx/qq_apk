  ...
  extends a
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    ac.i("MicroMsg.AppBrand.JsApiPrivateFileSystem", "hy: %s %s", new Object[] { "private_fileSystemConvert", paramJSONObject.toString() });
    ...
    if (((String)localObject1).equalsIgnoreCase("getAbsolutePath"))
    {
      ...
      paramJSONObject = paramc.DH().IS((String)localObject1);
      ...
      try
      {
        ...
        ((JSONObject)localObject1).put("filePath", q.B(paramJSONObject.fxV()));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramc == null) || (bs.isNullOrNil(str2)))
        {
          boolean bool1;
          if (paramc == null)
          {
            bool1 = true;
            ac.w("MicroMsg.AppBrand.JsApiPrivateFileSystem", "hy: param error %b, %s", new Object[] { Boolean.valueOf(bool1), str2 });
        ...
        {
          paramJSONObject = (ar)paramc.DH();
          if (paramJSONObject == null)
          {
            ac.w("MicroMsg.AppBrand.JsApiPrivateFileSystem", "hy: fs is null");
            paramJSONObject = null;
            continue;
          }
          localObject2 = ((x)paramJSONObject.Jc("wxfile://clientdata")).jsT;
          ...
          if (!((e)localObject2).exists()) {
            ac.i("MicroMsg.AppBrand.JsApiPrivateFileSystem", "hy: no nomedia file. trigger new");
          }
          try
          {
          ...
          {
            ac.printErrStackTrace("MicroMsg.AppBrand.JsApiPrivateFileSystem", localIOException, "hy: create no media file failed!", new Object[0]);
            continue;
          }
        }
        if (!bool2) {
      ...
      {
        paramc.h(paramInt, e(String.format("fail: error %s", new Object[] { paramJSONObject.getMessage() }), null));
        ac.printErrStackTrace("MicroMsg.AppBrand.JsApiPrivateFileSystem", paramJSONObject, "hy: json error!", new Object[0]);
        AppMethodBeat.o(174794);
        return;
      }
      if (i.eA(paramJSONObject)) {
        i.deleteFile(paramJSONObject);
      }
      String str1 = i.aSs(paramJSONObject);
      i.aSh(str1);
      ac.w("MicroMsg.AppBrand.JsApiPrivateFileSystem", "hy: getWxFilePath, fileName: %s, relativeFilePath: %s, relativeFileName: %s, parentAbsolutePath: %s!", new Object[] { localObject1, str2, paramJSONObject, str1 });
      localObject1 = new JSONObject();
      ...
      AppMethodBeat.o(174794);
      return;
      ac.e("MicroMsg.AppBrand.JsApiPrivateFileSystem", "hy: invalid operate type: %s", new Object[] { localObject1 });
