  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.base.a<ae>
{
  ...
  public static final h.a jNw;
  private final HashMap<Integer, b> jNu;
  private boolean jNv;
  ...
  private View a(ae paramae, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    Object localObject1 = paramae.aNe();
    ...
    this.jNv = paramJSONObject.optBoolean("scrollSupportedTouchEvent", false);
    Object localObject2 = new b(paramInt);
    ((Map)this.jNu).put(Integer.valueOf(paramInt), localObject2);
    paramJSONObject = paramae.getContext();
    k.g(paramJSONObject, "component.context");
    paramJSONObject = new MagicBrushView(paramJSONObject, MagicBrushView.h.css);
    ...
    a.a.HZ((String)localObject2).a(paramInt, paramJSONObject);
    if (this.jNv) {
    ...
    if (paramae.bjz())
    {
      ...
      localObject2 = paramae.getAppId();
      k.g(localObject2, "component.appId");
      localObject2 = a.a.HZ((String)localObject2);
      ((a)localObject2).rJ(paramInt);
      if (((a)localObject2).aZB() == 1) {
        ((d)localObject1).FZ();
      }
    }
  ...
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/appbrand/jsapi/canvas/JsApiInsertHTMLCanvasElement$Request;", "", "id", "", "(Lcom/tencent/mm/plugin/appbrand/jsapi/canvas/JsApiInsertHTMLCanvasElement;I)V", "value", "Lcom/tencent/mm/plugin/appbrand/jsapi/base/JsApiCallback;", "callback", "getCallback", "()Lcom/tencent/mm/plugin/appbrand/jsapi/base/JsApiCallback;", "setCallback", "(Lcom/tencent/mm/plugin/appbrand/jsapi/base/JsApiCallback;)V", "getId", "()I", "", "isViewReady", "()Z", "setViewReady", "(Z)V", "invoke", "", "plugin-appbrand-integration_release"})
  final class b
  {
  ...
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"com/tencent/mm/plugin/appbrand/jsapi/canvas/JsApiInsertHTMLCanvasElement$inflateView$1", "Lcom/tencent/magicbrush/ui/MagicBrushView$OnPreparedListener;", "onPrepared", "", "plugin-appbrand-integration_release"})
  ...
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"<anonymous>", "", "onForeground"})
    ...
    implements f.d
  {
    ...
    public final void onForeground()
    {
      ...
      Object localObject = a.jNm;
      localObject = this.jNB.getAppId();
      k.g(localObject, "component.appId");
      localObject = a.a.HZ((String)localObject);
      ((a)localObject).rJ(paramInt);
      if (((a)localObject).aZB() == 1) {
        this.jND.FZ();
      }
  ...
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"<anonymous>", "", "onBackground"})
    ...
    implements f.b
  {
    ...
    public final void onBackground()
    {
      ...
      Object localObject = this.jNB.getRuntime();
      ...
      k.g(localObject, "component.appId");
      localObject = a.a.HZ((String)localObject);
      ((a)localObject).rK(paramInt);
      if (((a)localObject).aZB() == 0) {
        this.jND.Ga();
      }
      AppMethodBeat.o(50495);
    }
