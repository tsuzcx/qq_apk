...
public final class e
{
  public static void a(ViewGroup paramViewGroup, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if ((AppBrandViewMotionCompat.cU(localView)) && (AppBrandViewMotionCompat.a(paramViewGroup, f1, f2, localView)) && (localView.isDuplicateParentStateEnabled()))
      {
        a(paramViewGroup, paramMotionEvent, localView, i);
        if (((localView instanceof com.tencent.mm.plugin.appbrand.jsapi.base.e)) && (((com.tencent.mm.plugin.appbrand.jsapi.base.e)localView).bfw()))
        {
  ...
  public static boolean a(ViewGroup paramViewGroup, MotionEvent paramMotionEvent, View paramView, int paramInt)
  {
    ...
    if (paramView == null)
    {
      ac.v("MicroMsg.ViewMotionHelper", "child is null.");
    ...
    if (paramInt == 0)
    {
      ac.v("MicroMsg.ViewMotionHelper", "newPointerIdBits is 0.");
      AppMethodBeat.o(140691);
      return false;
    }
    boolean bool = AppBrandViewMotionCompat.cV(paramView);
    Object localObject;
    if (paramInt == i)
    {
      if (bool)
    ...
    for (;;)
    {
      ...
      if (!bool) {
        ((MotionEvent)localObject).transform(AppBrandViewMotionCompat.cW(paramView));
      }
  ...
  public static f cD(View paramView)
  {
  ...
  public static final class f
  {
    ...
    public final JSONObject toJSONObject()
    {
      ...
      try
      {
        ...
        localJSONObject.put("x", g.aF(this.x));
        localJSONObject.put("y", g.aF(this.y));
        label54:
