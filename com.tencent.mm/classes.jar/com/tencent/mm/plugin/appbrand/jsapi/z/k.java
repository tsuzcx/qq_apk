...
public class k<C extends com.tencent.mm.plugin.appbrand.d>
  extends i<C>
{
  ...
  protected Map<String, Object> a(C paramC)
  {
    ...
    localMap.put("windowWidth", Integer.valueOf(g.zB(localObject1[0])));
    localMap.put("windowHeight", Integer.valueOf(g.zB(localObject1[1])));
    localObject1 = ai.f(paramC);
    int m = localObject1[0];
    int k = localObject1[1];
    localMap.put("screenWidth", Integer.valueOf(g.zB(m)));
    localMap.put("screenHeight", Integer.valueOf(g.zB(k)));
    localMap.put("pixelRatio", Float.valueOf(g.bZk()));
    localObject1 = df.i(paramC);
    int j;
    if ((localObject1 != null) && (((ac)localObject1).bRj() != null))
    {
      j = ((ac)localObject1).bRj().getDrawnStatusBarHeight();
      i = j;
      if (j != 0) {}
    }
    else
    ...
    localMap.put("statusBarHeight", Integer.valueOf(g.zB(i)));
    ...
    if ((paramC.getRuntime() != null) && (paramC.getRuntime().OT() != null)) {
      localMap.put("benchmarkLevel", Integer.valueOf(((AppBrandSysConfigLU)paramC.getRuntime().OT()).cyZ));
    }
    ...
    for (int i = localObject1[1];; i = 0)
    {
      ...
      localMap.put("screenTop", Integer.valueOf(g.zB(i)));
      ...
      if (2 == i)
      {
        ...
        localObject1 = (b)paramC.M(b.class);
        if (localObject1 != null) {
          break label927;
        }
        f = 1.0F;
        ...
        label514:
        ((Map)localObject1).put("notificationAuthorized", Boolean.valueOf(v.P((Context)localObject2).areNotificationsEnabled()));
      ...
      for (;;)
      {
        try
        {
          ((Map)localObject1).put("locationAuthorized", Boolean.valueOf(com.tencent.luggage.h.i.n((Context)localObject2, "android.permission.ACCESS_FINE_LOCATION")));
          ((Map)localObject1).put("cameraAuthorized", Boolean.valueOf(com.tencent.luggage.h.i.n((Context)localObject2, "android.permission.CAMERA")));
          ((Map)localObject1).put("microphoneAuthorized", Boolean.valueOf(com.tencent.luggage.h.i.n((Context)localObject2, "android.permission.RECORD_AUDIO")));
          ...
          if (localObject2 != null)
          {
            i = g.zB(((Rect)localObject2).left);
            j = g.zB(((Rect)localObject2).top);
            m = g.zB(Math.min(((Rect)localObject2).right, m));
            k = g.zB(Math.min(((Rect)localObject2).bottom, k));
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.z.k
