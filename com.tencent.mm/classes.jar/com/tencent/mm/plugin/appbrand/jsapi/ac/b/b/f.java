package com.tencent.mm.plugin.appbrand.jsapi.ac.b.b;
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else
        {
          ...
          localObject1 = com.tencent.mm.plugin.appbrand.z.d.p((ByteBuffer)localObject1);
    ...
    catch (Throwable localThrowable1)
    {
      ...
      catch (Throwable localThrowable2)
      {
        ...
        {
          localObject6 = paramc.Fg().Ml("canvas_" + System.currentTimeMillis() + "." + (String)localObject1);
        ...
        Object localObject6 = q.B(((e)localObject6).fOK());
        ad.d("MicroMsg.JsApiXWebCanvasToTempFilePath", "toTempFilePath, savePath = %s", new Object[] { localObject6 });
        try
        {
          g.a(localObject5, K(paramJSONObject), localCompressFormat, (String)localObject6, true);
          paramJSONObject = new i();
          paramc.Fg().a(new e((String)localObject6), (String)localObject1, true, paramJSONObject);
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ac.b.b.f
