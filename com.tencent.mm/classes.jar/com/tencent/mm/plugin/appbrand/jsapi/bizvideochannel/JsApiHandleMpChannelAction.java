  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a<c>
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    this.jHv = paramJSONObject;
    ad.i("MicroMsg.JsApiHandleMpChannelAction", "alvinluo handleMPChannelAction operateType: %s", new Object[] { this.jHv });
    if (((CharSequence)this.jHv).length() == 0) {}
    for (int i = 1; i != 0; i = 0)
    {
      ad.e("MicroMsg.JsApiHandleMpChannelAction", "alvinluo handleMPChannelAction operateType empty");
      paramJSONObject = HI("fail: operationType empty");
      k.g(paramJSONObject, "makeReturnJson(\"fail: operationType empty\")");
      a(paramc, paramInt, paramJSONObject);
      AppMethodBeat.o(175152);
      return;
    }
    if (this.jHv.equals("getChannelFeeds"))
    {
    ...
    if (this.jHv.equals("updateChannelFeeds"))
    {
    ...
    paramJSONObject = HI("fail: operationType error");
    k.g(paramJSONObject, "makeReturnJson(\"fail: operationType error\")");
    a(paramc, paramInt, paramJSONObject);
    AppMethodBeat.o(175152);
  }
  
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/appbrand/jsapi/bizvideochannel/JsApiHandleMpChannelAction$GetChannelFeedsTask;", "Lcom/tencent/mm/plugin/appbrand/ipc/MainProcessTask;", "()V", "api", "Lcom/tencent/mm/plugin/appbrand/jsapi/AppBrandJsApi;", "service", "Lcom/tencent/mm/plugin/appbrand/jsapi/AppBrandComponent;", "callbackId", "", "(Lcom/tencent/mm/plugin/appbrand/jsapi/AppBrandJsApi;Lcom/tencent/mm/plugin/appbrand/jsapi/AppBrandComponent;I)V", "parcel", "Landroid/os/Parcel;", "(Landroid/os/Parcel;)V", "channelFeedsData", "", "jsapi", "describeContents", "parseFromParcel", "", "src", "runInClientProcess", "runInMainProcess", "writeToParcel", "flags", "CREATOR", "plugin-appbrand-integration_release"})
    ...
    extends MainProcessTask
  {
    ...
    public final void aEA()
    {
      ...
      aXn();
      int i;
      if (((CharSequence)this.jHx).length() == 0)
      {
        i = 1;
        if (i == 0) {
          break label103;
      ...
      label92:
      for (localObject = ((m)localObject).HI("fail: no channel feeds");; localObject = null)
      {
      ...
      ((Map)localHashMap).put("channelFeedsData", this.jHx);
    ...
    public final void aEz()
    {
      ...
      String str = ((b)g.ab(b.class)).bBV();
      k.g(str, "MMKernel.service(IBrandS…s.java).getChannelFeeds()");
      this.jHx = str;
      ad.i("MicroMsg.JsApiHandleMpChannelAction", "alvinluo GetChannelFeedsTask channelFeedsData: %s", new Object[] { this.jHx });
      aXw();
    ...
    extends MainProcessTask
  {
    ...
    public final void aEA()
    {
      ...
      for (;;)
      {
        locala.h(localc).C((Map)localHashMap).aXQ();
    ...
    @l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/appbrand/jsapi/bizvideochannel/JsApiHandleMpChannelAction$UpdateChannelFeedsTask$CREATOR;", "Landroid/os/Parcelable$Creator;", "Lcom/tencent/mm/plugin/appbrand/jsapi/bizvideochannel/JsApiHandleMpChannelAction$UpdateChannelFeedsTask;", "()V", "createFromParcel", "parcel", "Landroid/os/Parcel;", "newArray", "", "size", "", "(I)[Lcom/tencent/mm/plugin/appbrand/jsapi/bizvideochannel/JsApiHandleMpChannelAction$UpdateChannelFeedsTask;", "plugin-appbrand-integration_release"})
    public static final class a
      implements Parcelable.Creator<JsApiHandleMpChannelAction.UpdateChannelFeedsTask>
    {}
    
    @l(fvt={1, 1, 16}, fvu={""}, fvv={"com/tencent/mm/plugin/appbrand/jsapi/bizvideochannel/JsApiHandleMpChannelAction$UpdateChannelFeedsTask$runInMainProcess$1", "Lcom/tencent/mm/plugin/brandservice/api/IBrandService$UpdateChannelFeedsCallback;", "onFailed", "", "errType", "", "errCode", "errMsg", "", "onSuccess", "channelFeeds", "plugin-appbrand-integration_release"})
      ...
      implements b.b
    {
      public final void onSuccess(String paramString)
      {
        ...
        JsApiHandleMpChannelAction.UpdateChannelFeedsTask localUpdateChannelFeedsTask = this.jHz;
        String str = paramString;
        if (paramString == null) {
          str = "";
        }
        JsApiHandleMpChannelAction.UpdateChannelFeedsTask.a(localUpdateChannelFeedsTask, str);
        JsApiHandleMpChannelAction.UpdateChannelFeedsTask.a(this.jHz, true);
        JsApiHandleMpChannelAction.UpdateChannelFeedsTask.a(this.jHz);
      ...
      public final void p(int paramInt1, int paramInt2, String paramString)
      {
        ...
        JsApiHandleMpChannelAction.UpdateChannelFeedsTask.a(this.jHz, false);
        JsApiHandleMpChannelAction.UpdateChannelFeedsTask.a(this.jHz);
  ...
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/appbrand/jsapi/bizvideochannel/JsApiHandleMpChannelAction$Companion;", "", "()V", "CTRL_INDEX", "", "NAME", "", "OPERATE_TYPE_GET", "OPERATE_TYPE_UPDATE", "TAG", "plugin-appbrand-integration_release"})
  public static final class a {}
}
