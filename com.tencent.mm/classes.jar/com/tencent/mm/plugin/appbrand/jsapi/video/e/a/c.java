  ...
  extends b
{
  ...
  private final int ak(long paramLong)
  {
    ...
    {
      l1 = this.bDT;
      ad.i("MicroMsg.AdavanceTrackSelection", "[TRACE_ADAPTIVE] determineIdealSelectedIndex bitrateEstimate = ".concat(String.valueOf(l2)));
      k = this.length;
      i = 0;
      j = 0;
    }
  ...
  public final void af(long paramLong)
  {
    ...
    if (this.bxN != i) {
      if (!k(i, l))
      {
        ...
        ad.i("MicroMsg.AdavanceTrackSelection", "[TRACE_ADAPTIVE] updateSelectedTrack < selectIndex = " + this.bxN + ", bufferedDurationUs = " + paramLong + ", min = " + this.bDU);
      }
    }
    for (this.bxN = i;; this.bxN = i)
    {
      ...
      do
      {
        ...
        ad.i("MicroMsg.AdavanceTrackSelection", "[TRACE_ADAPTIVE] updateSelectedTrack selectIndex = " + this.bxN);
        AppMethodBeat.o(206523);
        return;
      } while ((localFormat2.bitrate >= localFormat1.bitrate) || (paramLong < this.bDV));
      ad.i("MicroMsg.AdavanceTrackSelection", "[TRACE_ADAPTIVE] updateSelectedTrack > selectIndex = " + this.bxN + ", bufferedDurationUs = " + paramLong);
    }
  }
