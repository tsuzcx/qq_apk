  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.base.a
{
      ...
      default: 
        ...
        if (localObject != null)
        {
          ...
          if ((parame != null) && (parame.length == 2) && (parame[0] > 0) && (parame[1] > 0))
          {
            ...
            ac.i("MicroMsg.JsApiInsertCamera", "onInsertView screen width: %d, screen height: %d", new Object[] { Integer.valueOf(parame[0]), Integer.valueOf(parame[1]) });
          }
        }
        parame = paramJSONObject.optJSONArray("scanArea");
        if ((parame != null) && (parame.length() == 4))
        {
          ac.i("MicroMsg.JsApiInsertCamera", "scanAreaArray:%s, scanAreaArray.length:%d", new Object[] { parame, Integer.valueOf(parame.length()) });
          localf.w(com.tencent.mm.plugin.appbrand.z.g.ve(parame.optInt(0)), com.tencent.mm.plugin.appbrand.z.g.ve(parame.optInt(1)), com.tencent.mm.plugin.appbrand.z.g.ve(parame.optInt(2)), com.tencent.mm.plugin.appbrand.z.g.ve(parame.optInt(3)));
          label486:
          ...
          ac.d("MicroMsg.JsApiInsertCamera", "inflateView cameraId: %d,devicePosition: %s,flash: %s,width: %d,height: %d, centerCrop: %b", new Object[] { Integer.valueOf(k), str2, str3, Integer.valueOf(i), Integer.valueOf(j), Boolean.valueOf(bool) });
  ...
  public final void a(com.tencent.mm.plugin.appbrand.jsapi.e parame, int paramInt, View paramView, final JSONObject paramJSONObject, com.tencent.mm.plugin.appbrand.jsapi.base.g paramg)
  {
    ...
    ac.i("MicroMsg.JsApiInsertCamera", "onInsertView cameraId=%d", new Object[] { Integer.valueOf(paramInt) });
    paramView = (f)((CoverViewContainer)paramView).ax(View.class);
    if (paramView == null)
    {
      ac.e("MicroMsg.JsApiInsertCamera", "onInsertView(viewId : %d) failed, cameraView is null", new Object[] { Integer.valueOf(paramInt) });
      paramg.LV(e("fail:internal error", null));
    ...
    a.a.bfZ().a(paramView.getCameraId(), paramView);
    parame.a(paramView);
    parame.a(paramView);
    parame.a(paramView);
    com.tencent.mm.plugin.appbrand.g.a(parame.getAppId(), new g.c()
    {
      public final void onDestroy()
      {
        ...
        if ((localf != null) && (locale != null))
        {
          ...
          locale.b(localf);
          locale.b(localf);
          a.a.bfZ().I(localf.getCameraId(), true);
      ...
      public final void onRequestPermissionsResult(int paramAnonymousInt, String[] paramAnonymousArrayOfString, int[] paramAnonymousArrayOfInt)
      {
        ...
        if (paramAnonymousInt == 16)
        {
          ...
          if (localf != null)
          {
            ...
            new i().h(paramAnonymousArrayOfString).LO(paramAnonymousArrayOfInt).beN();
          }
          for (;;)
          {
            a.a.bfZ().kma = false;
            AppMethodBeat.o(137470);
            return;
            ac.w("MicroMsg.JsApiInsertCamera", "onRequestPermissionsResult weak camera is null, get Camera id fail");
            break;
            label175:
            ac.w("MicroMsg.JsApiInsertCamera", "onRequestPermissionsResult weak camera is null, dispatch data fail");
          }
        }
