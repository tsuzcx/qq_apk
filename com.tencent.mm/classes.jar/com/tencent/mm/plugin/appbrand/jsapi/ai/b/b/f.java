  ...
  public final void a(e parame, JSONObject paramJSONObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else
        {
          ...
          localObject1 = com.tencent.mm.plugin.appbrand.ac.d.m((ByteBuffer)localObject1);
    ...
    catch (Throwable localThrowable1)
    {
      ...
      catch (Throwable localThrowable2)
      {
        ...
        {
          localObject6 = parame.getFileSystem().adN("canvas_" + System.currentTimeMillis() + "." + (String)localObject1);
        ...
        Object localObject6 = ((q)localObject6).bOF();
        ...
        try
        {
          BitmapUtil.saveBitmapToImage(localObject5, V(paramJSONObject), localCompressFormat, (String)localObject6, true);
          paramJSONObject = new i();
          parame.getFileSystem().a(new q((String)localObject6), (String)localObject1, true, paramJSONObject);
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ai.b.b.f
