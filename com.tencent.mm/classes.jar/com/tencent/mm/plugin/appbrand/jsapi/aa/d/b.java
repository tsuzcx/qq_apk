  ...
  extends a
{
  ...
  public final TencentMapOptions G(Map<String, Object> paramMap)
  {
    AppMethodBeat.i(139539);
    TencentMapOptions localTencentMapOptions = super.G(paramMap);
    if (paramMap != null)
    {
  ...
  public final void g(SurfaceTexture paramSurfaceTexture)
  {
    ...
    if ((paramSurfaceTexture != null) && (this.mSurfaceTexture != paramSurfaceTexture))
    {
      ...
      this.jTA.onSurfaceChanged(this.mSurfaceTexture, this.mWidth, this.mHeight);
      this.mSurfaceTexture.setDefaultBufferSize(this.mWidth, this.mHeight);
  ...
  public final void onSizeChanged(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      this.jTA.onSizeChanged(paramInt1, paramInt2, paramInt1, paramInt2);
  ...
  public final void onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (this.jTA != null) {
      this.jTA.onTouchEvent(paramMotionEvent);
    }
    AppMethodBeat.o(139540);
  }
}
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.aa.d.b
