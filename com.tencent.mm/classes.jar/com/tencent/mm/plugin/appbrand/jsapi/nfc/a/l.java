...
@d.l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lcom/tencent/mm/plugin/appbrand/jsapi/nfc/rw/JsApiNFCTransceive;", "Lcom/tencent/mm/plugin/appbrand/jsapi/AppBrandAsyncJsApi;", "Lcom/tencent/mm/plugin/appbrand/jsapi/AppBrandComponent;", "()V", "invoke", "", "env", "data", "Lorg/json/JSONObject;", "callbackId", "", "Companion", "luggage-commons-jsapi-nfc-ext_release"})
  ...
  extends a<com.tencent.mm.plugin.appbrand.jsapi.c>
{
  ...
  public final void a(final com.tencent.mm.plugin.appbrand.jsapi.c paramc, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    if (paramc == null)
    {
      ac.w("MicroMsg.AppBrand.JsApiNFCTransceive", "invoke, env is null");
      AppMethodBeat.o(183650);
      return;
    }
    if (paramJSONObject == null)
    {
      ac.w("MicroMsg.AppBrand.JsApiNFCTransceive", "invoke, data is null");
    ...
    if (localObject == null)
    {
      ac.w("MicroMsg.AppBrand.JsApiNFCTransceive", "invoke, can not get activity");
      paramc.h(paramInt, k("fail:unknown", (Map)ae.c(new o[] { u.Q("errCode", Integer.valueOf(13010)) })));
      AppMethodBeat.o(183650);
      return;
    }
    ac.d("MicroMsg.AppBrand.JsApiNFCTransceive", "invoke, appId: " + paramc.getAppId() + ", data: " + paramJSONObject);
    String str1;
    try
    {
      ...
      {
        ac.w("MicroMsg.AppBrand.JsApiNFCTransceive", "parse data failed since ".concat(String.valueOf(paramJSONObject)));
        paramc.h(paramInt, k("fail:invalid parameter", (Map)ae.c(new o[] { u.Q("errCode", Integer.valueOf(13011)) })));
        AppMethodBeat.o(183650);
        return;
      }
    ...
    {
      ac.w("MicroMsg.AppBrand.JsApiNFCTransceive", "parse tech failed");
      paramc.h(paramInt, k("fail:invalid parameter", (Map)ae.c(new o[] { u.Q("errCode", Integer.valueOf(13011)) })));
      AppMethodBeat.o(183650);
      return;
    }
    ...
    ac.d("MicroMsg.AppBrand.NFCReadWriteManager", str2);
    h.JZN.f((Runnable)new c.l((com.tencent.mm.plugin.appbrand.jsapi.nfc.a.a.c)localObject, paramc, str1, paramJSONObject), "NFC-IO");
    AppMethodBeat.o(183650);
  }
  
  @d.l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lcom/tencent/mm/plugin/appbrand/jsapi/nfc/rw/JsApiNFCTransceive$Companion;", "", "()V", "CTRL_INDEX", "", "NAME", "", "PARAM_RESULT_DATA", "PARAM_TECH", "TAG", "luggage-commons-jsapi-nfc-ext_release"})
