  ...
  public final void a(final com.tencent.mm.plugin.appbrand.jsapi.c paramc, final JSONObject paramJSONObject, final int paramInt)
  {
    ...
    aq.f(new Runnable()
    {
      public final void run()
      {
        ...
        Object localObject = a.a.bjD();
        if (((a)localObject).kHc.indexOfKey(i) >= 0)
        {
          localObject = (WeakReference)((a)localObject).kHc.get(i);
          if (localObject != null) {
        ...
        ((f)localObject).setOperateCallBack(new c()
        {
          public final void a(int paramAnonymous2Int1, String paramAnonymous2String1, String paramAnonymous2String2, int paramAnonymous2Int2, int paramAnonymous2Int3)
          {
            ...
            if (paramAnonymous2Int1 == 0)
            {
              ...
              n.1.this.ktT.h(n.1.this.cjQ, n.this.m("ok", paramAnonymous2String2));
              AppMethodBeat.o(137475);
              return;
            }
            n.1.this.ktT.h(n.1.this.cjQ, n.this.e("fail:".concat(String.valueOf(paramAnonymous2String2)), null));
            AppMethodBeat.o(137475);
          }
          ...
          public final void a(int paramAnonymous2Int1, String paramAnonymous2String1, String paramAnonymous2String2, String paramAnonymous2String3, int paramAnonymous2Int2, long paramAnonymous2Long, int paramAnonymous2Int3, int paramAnonymous2Int4)
          {
            ...
            if (paramAnonymous2Int1 == 0)
            {
              ...
              n.1.this.ktT.h(n.1.this.cjQ, n.this.m("ok", paramAnonymous2String1));
              AppMethodBeat.o(137477);
              return;
            }
            n.1.this.ktT.h(n.1.this.cjQ, n.this.e("fail:".concat(String.valueOf(paramAnonymous2String1)), null));
            AppMethodBeat.o(137477);
          }
          
          public final void ag(int paramAnonymous2Int, String paramAnonymous2String)
          {
            AppMethodBeat.i(137476);
            if (paramAnonymous2Int == 0)
            {
              n.1.this.ktT.h(n.1.this.cjQ, n.this.e("ok", null));
              AppMethodBeat.o(137476);
              return;
            }
            n.1.this.ktT.h(n.1.this.cjQ, n.this.e("fail:".concat(String.valueOf(paramAnonymous2String)), null));
            AppMethodBeat.o(137476);
          }
          ...
          public final void h(String paramAnonymous2String, int paramAnonymous2Int1, int paramAnonymous2Int2, int paramAnonymous2Int3)
          {
            ...
            n.1.this.ktT.h(n.1.this.cjQ, n.this.m("ok", paramAnonymous2String));
            AppMethodBeat.o(137478);
          }
        });
        i = -1;
        ...
        AppMethodBeat.o(137479);
        return;
        float f = ((f)localObject).az((float)paramJSONObject.optDouble("zoom"));
        if (f < 1.0F)
        {
        ...
        paramc.h(paramInt, n.this.m("ok", (Map)localObject));
        AppMethodBeat.o(137479);
        return;
        ((f)localObject).bjO();
        AppMethodBeat.o(137479);
