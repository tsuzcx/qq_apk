  ...
  extends ContentObserver
{
  ...
  public final void onChange(boolean paramBoolean)
  {
    ...
    ae.i("SettingsContentObserver", "Volume now ".concat(String.valueOf(this.audioManager.getStreamVolume(3))));
    AppMethodBeat.o(139676);
  }
  
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/plugin/appbrand/jsapi/xwebplugin/video/VolumeObserver$Companion;", "", "()V", "TAG", "", "luggage-xweb-ext_release"})
  public static final class a {}
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mm\classes2.jar
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ad.e.i
