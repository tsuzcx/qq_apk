  ...
  extends c
{
  ...
  public final boolean c(e parame, int paramInt, View paramView, JSONObject paramJSONObject)
  {
    ...
    try
    {
      paramView.setBackgroundColor(g.Rr(paramJSONObject.getString("backgroundColor")));
      label43:
      paramJSONObject = paramJSONObject.optString("src", "");
      ac.i("MicroMsg.AppBrand.JsApiUpdateHTMLWebView", "onUpdateView appId[%s] viewId[%d] viewHash[%d] src[%s]", new Object[] { parame.getAppId(), Integer.valueOf(paramInt), Integer.valueOf(paramView.hashCode()), paramJSONObject });
