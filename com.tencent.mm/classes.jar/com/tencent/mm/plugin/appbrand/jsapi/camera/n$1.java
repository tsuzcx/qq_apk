...
final class n$1
  implements Runnable
{
  n$1(n paramn, JSONObject paramJSONObject, com.tencent.mm.plugin.appbrand.jsapi.f paramf, int paramInt) {}
  
  public final void run()
  {
    AppMethodBeat.i(137479);
    int i = this.cvS.optInt("cameraId");
    String str = this.cvS.optString("type");
    Log.i("MicroMsg.JsApiOperateCamera", "cameraId=%d type=%s", new Object[] { Integer.valueOf(i), str });
    Object localObject = a.a.bFI();
    if (((a)localObject).lOX.indexOfKey(i) >= 0)
    {
      localObject = (WeakReference)((a)localObject).lOX.get(i);
      if (localObject != null) {
    ...
    {
      this.lBw.i(this.cvP, this.lQl.h("fail:no such camera", null));
    ...
    ((f)localObject).setOperateCallBack(new c()
    {
      public final void a(int paramAnonymousInt1, String paramAnonymousString1, String paramAnonymousString2, int paramAnonymousInt2, int paramAnonymousInt3)
      {
        ...
        if (paramAnonymousInt1 == 0)
        {
          ...
          n.1.this.lBw.i(n.1.this.cvP, n.1.this.lQl.n("ok", paramAnonymousString2));
          AppMethodBeat.o(137475);
          return;
        }
        n.1.this.lBw.i(n.1.this.cvP, n.1.this.lQl.h("fail:".concat(String.valueOf(paramAnonymousString2)), null));
        AppMethodBeat.o(137475);
      }
      ...
      public final void a(int paramAnonymousInt1, String paramAnonymousString1, String paramAnonymousString2, String paramAnonymousString3, int paramAnonymousInt2, long paramAnonymousLong, int paramAnonymousInt3, int paramAnonymousInt4)
      {
        ...
        Log.d("MicroMsg.JsApiOperateCamera", "onStopRecord ret %d, thumbPath %s,tempVideoPath %s,duration %d,size %d,width %d,height %d", new Object[] { Integer.valueOf(paramAnonymousInt1), paramAnonymousString2, paramAnonymousString3, Integer.valueOf(paramAnonymousInt2), Long.valueOf(paramAnonymousLong), Integer.valueOf(paramAnonymousInt3), Integer.valueOf(paramAnonymousInt4) });
        if (paramAnonymousInt1 == 0)
        {
          ...
          n.1.this.lBw.i(n.1.this.cvP, n.1.this.lQl.n("ok", paramAnonymousString1));
          AppMethodBeat.o(137477);
          return;
        }
        n.1.this.lBw.i(n.1.this.cvP, n.1.this.lQl.h("fail:".concat(String.valueOf(paramAnonymousString1)), null));
        AppMethodBeat.o(137477);
      }
      ...
      public final void aj(int paramAnonymousInt, String paramAnonymousString)
      {
        ...
        {
          n.1.this.lBw.i(n.1.this.cvP, n.1.this.lQl.h("ok", null));
          AppMethodBeat.o(137476);
          return;
        }
        n.1.this.lBw.i(n.1.this.cvP, n.1.this.lQl.h("fail:".concat(String.valueOf(paramAnonymousString)), null));
        AppMethodBeat.o(137476);
      }
      ...
      public final void h(String paramAnonymousString, int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3)
      {
        ...
        Log.d("MicroMsg.JsApiOperateCamera", "onListenFrameChange bufferId:%d width:%d height:%d", new Object[] { Integer.valueOf(paramAnonymousInt1), Integer.valueOf(paramAnonymousInt2), Integer.valueOf(paramAnonymousInt3) });
        ...
        n.1.this.lBw.i(n.1.this.cvP, n.1.this.lQl.n("ok", paramAnonymousString));
        AppMethodBeat.o(137478);
      }
    });
    i = -1;
    ...
    for (;;)
    {
      ...
      default: 
        ...
        this.lBw.i(this.cvP, this.lQl.h("fail:operateType not supported", null));
        AppMethodBeat.o(137479);
        return;
    ...
    ((f)localObject).setQuality(this.cvS.optString("quality", "high"));
    ((f)localObject).bFK();
    AppMethodBeat.o(137479);
    return;
    float f = ((f)localObject).aJ((float)this.cvS.optDouble("zoom"));
    if (f < 1.0F)
    {
      this.lBw.i(this.cvP, this.lQl.h("fail: zoom multiple not support", null));
      AppMethodBeat.o(137479);
      return;
    }
    localObject = new HashMap(1);
    ((Map)localObject).put("zoom", Float.valueOf(f));
    this.lBw.i(this.cvP, this.lQl.n("ok", (Map)localObject));
    AppMethodBeat.o(137479);
    return;
    ((f)localObject).bFT();
    AppMethodBeat.o(137479);
    return;
    ((f)localObject).setCompressRecord(this.cvS.optBoolean("compressed"));
    ((f)localObject).bFU();
    AppMethodBeat.o(137479);
    return;
    this.cvS.optString("size");
    ((f)localObject).o(this.lBw);
    AppMethodBeat.o(137479);
    return;
    ((f)localObject).bFN();
    this.lBw.i(this.cvP, this.lQl.h("ok", null));
    AppMethodBeat.o(137479);
  }
}
