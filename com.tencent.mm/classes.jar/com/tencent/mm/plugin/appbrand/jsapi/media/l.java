  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a<com.tencent.mm.plugin.appbrand.q>
{
  ...
  private String a(Context paramContext, aa paramaa, String paramString, JSONObject paramJSONObject)
  {
    ...
    while (i < ((JSONArray)localObject2).length())
    {
      ...
      ((AppBrandMediaSource)localObject3).gSN = ((JSONObject)localObject4).optString("type");
      ((AppBrandMediaSource)localObject3).gSO = ((JSONObject)localObject4).optString("poster");
      arrayOfString[i] = ((AppBrandMediaSource)localObject3).url;
      if (!TextUtils.isEmpty(((AppBrandMediaSource)localObject3).gSO))
      {
        localObject4 = paramaa.DH().IS(((AppBrandMediaSource)localObject3).gSO);
        if (localObject4 != null) {
          ((AppBrandMediaSource)localObject3).gSO = com.tencent.mm.vfs.q.B(((com.tencent.mm.vfs.e)localObject4).fxV());
        }
      }
      if (!TextUtils.isEmpty(((AppBrandMediaSource)localObject3).url))
      {
        localObject4 = paramaa.DH().IS(((AppBrandMediaSource)localObject3).url);
        if (localObject4 != null)
        {
          arrayOfString[i] = com.tencent.mm.vfs.q.B(((com.tencent.mm.vfs.e)localObject4).fxV());
          ((AppBrandMediaSource)localObject3).url = com.tencent.mm.vfs.q.B(((com.tencent.mm.vfs.e)localObject4).fxV());
        }
      }
    ...
    for (j = ((Integer)localObject2).intValue();; j = k)
    {
      ...
      localObject3 = com.tencent.mm.plugin.appbrand.jsapi.w.a.o(arrayOfString);
      arrayOfString = com.tencent.mm.plugin.appbrand.jsapi.w.a.a((String[])localObject3, arrayOfString);
      j = i;
      ...
      else
      {
        ...
        ac.i("MicroMsg.JsApiPreviewMedia", "showmenu:%b", new Object[] { Boolean.valueOf(bool) });
        ...
        localObject1 = (com.tencent.mm.plugin.appbrand.p.a)paramaa.ar(com.tencent.mm.plugin.appbrand.p.a.class);
        if ((localObject1 != null) && (!bs.isNullOrNil(((com.tencent.mm.plugin.appbrand.p.a)localObject1).referer))) {
          r.a(paramaa, paramJSONObject, (Intent)localObject2, ((com.tencent.mm.plugin.appbrand.p.a)localObject1).referer);
        }
        for (;;)
        {
          ...
          try
          {
            ...
            ac.e("MicroMsg.JsApiPreviewMedia", "data too large size:%d", new Object[] { Integer.valueOf(i) });
          ...
          {
            ac.printErrStackTrace("MicroMsg.JsApiPreviewMedia", paramContext, "JsApiPreviewImage get size error", new Object[0]);
            paramContext = e("fail", null);
            AppMethodBeat.o(180249);
            return paramContext;
          }
          ac.w("MicroMsg.JsApiPreviewMedia", "config.referer is null");
        }
        com.tencent.luggage.h.e.aA(paramContext).b(new e.b()
        {
          public final boolean b(int paramAnonymousInt1, int paramAnonymousInt2, Intent paramAnonymousIntent)
          {
            ...
            if (l.this.kyS == paramAnonymousInt1)
            {
        ...
        d.a(paramContext, "subapp", ".ui.gallery.GestureGalleryUI", (Intent)localObject2, this.kyS, false);
