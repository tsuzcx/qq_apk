  ...
  extends c<e>
{
  ...
  public final void a(e parame, JSONObject paramJSONObject, int paramInt)
  {
    ...
    Object localObject1 = ((com.tencent.mm.plugin.appbrand.jsapi.g)localObject1).hl(paramJSONObject.optBoolean("independent", false)).bg(i7);
    if (localObject1 == null)
    {
          ...
          for (int i3 = 0;; i3 = i4)
          {
            ...
            for (;;)
            {
              ...
              catch (Exception paramJSONObject)
              {
                ...
                parame.j(paramInt, h("fail:create bitmap failed", null));
                AppMethodBeat.o(145524);
                return;
              }
              try
              {
                ...
                parame.j(paramInt, a(parame, "ok", d((int[])localObject2, k, i1)));
                AppMethodBeat.o(145524);
                return;
              }
              catch (Exception localException)
              {
                ...
                parame.j(paramInt, h("fail: getPixels failed", null));
                AppMethodBeat.o(145524);
                return;
              }
              if (j < i) {
              ...
              parame.j(paramInt, a(parame, "ok", d(new int[k * i1], k, i1)));
              AppMethodBeat.o(145524);
              return;
              if (i4 < i8) {
                break label1057;
