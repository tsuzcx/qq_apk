  ...
  extends b
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < localJSONArray.length())
        {
          ...
          if (localJSONObject2 != null) {
            paramJSONObject = new b.h(bt.getDouble(localJSONObject2.optString("latitude"), 0.0D), bt.getDouble(localJSONObject2.optString("longitude"), 0.0D));
          }
          if (paramJSONObject == null) {
            break label347;
          }
      ...
      a(paramc, paramInt, e("fail:invalid data", null), false, localb.bat());
      AppMethodBeat.o(143663);
      return;
      label347:
      i += 1;
