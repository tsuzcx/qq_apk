...
@l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/plugin/appbrand/jsapi/xwebplugin/video/AppBrandVideoCastHandler$Companion;", "", "()V", "TAG", "", "getFormatTime", "timeMs", "", "getMsTime", "", "formatTime", "luggage-xweb-ext_release"})
public final class b$c
{
  public static long Sh(String paramString)
  {
    ...
    for (localObject = j.b((Iterable)localObject, localListIterator.nextIndex() + 1);; localObject = (List)d.a.v.NhH)
    {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ad.e.b.c
