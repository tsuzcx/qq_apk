 ...
 enum b$a
{
  ...
  static
  {
    ...
    ldF = new a("YEAR", 0, new SimpleDateFormat("yyyy", Locale.US));
    ldG = new a("MONTH", 1, new SimpleDateFormat("yyyy-MM", Locale.US));
    ldH = new a("DAY", 2, new SimpleDateFormat("yyyy-MM-dd", Locale.US));
    ldI = new a[] { ldF, ldG, ldH };
  ...
  static a Qs(String paramString)
  {
    int i = 0;
