  ...
  extends c<C>
{
  ...
  public void a(C paramC, JSONObject paramJSONObject, int paramInt)
  {
    ...
    if (paramC.getAppState() != b.nKP)
    {
      paramC.j(paramInt, h("fail:not allowed in background", null));
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramJSONObject == null)
        {
          paramC.j(paramInt, h("fail: vibrate is not support", null));
          AppMethodBeat.o(137690);
          return;
        ...
        if (-2 == i)
        {
          ...
          paramC.j(paramInt, h(paramJSONObject, null));
          AppMethodBeat.o(137690);
          return;
        }
        if (-1 == i)
      ...
      catch (Exception paramJSONObject)
      {
        ...
        paramC.j(paramInt, h("fail: system internal error", null));
        AppMethodBeat.o(137690);
        return;
      }
      paramJSONObject.vibrate(15L);
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ab.u
