    ...
    a(new JsApiAppBrandNFCBase.a()
    {
      public final void y(int paramAnonymousInt, String paramAnonymousString)
      {
        ...
        if (paramAnonymousInt == 0)
        {
          ...
          f.a((c)localObject, paramAnonymousInt, paramAnonymousString.k("ok", localHashMap));
          AppMethodBeat.o(136118);
          return;
        }
        f.a(paramc, paramInt, f.this.k("fail: ".concat(String.valueOf(paramAnonymousString)), (Map)localObject));
        AppMethodBeat.o(136118);
      }
    });
