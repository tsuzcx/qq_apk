...
class JsApiLaunchApplicationDirectly$AddDownloadTaskStraightTask
  extends MainProcessTask
{
  ...
  public JsApiLaunchApplicationDirectly$AddDownloadTaskStraightTask(m paramm, r paramr, int paramInt, JSONObject paramJSONObject)
  {
  ...
  public final void ata()
  {
    ...
    for (;;)
    {
      ...
      {
        ab.i("MicroMsg.JsApiLaunchApplicationDirectly", "runInMainProcess taskUrl:%s md5:%s", new Object[] { this.hyC, this.hyD });
