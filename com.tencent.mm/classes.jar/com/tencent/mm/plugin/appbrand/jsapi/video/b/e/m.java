...
{
  public static void H(ArrayList<Runnable> paramArrayList)
  {
    try
    {
      ...
      for (paramArrayList = Long.valueOf(1L); localIterator.hasNext(); paramArrayList = Long.valueOf(l + 1L))
      {
        ...
        localc.j(localRunnable, paramArrayList.longValue());
      }
      localc.shutdown();
  ...
  public static Future<?> c(Runnable paramRunnable, String paramString)
  {
    ...
    extends ThreadPoolExecutor
  {
    ...
    protected final void afterExecute(Runnable paramRunnable, Throwable paramThrowable)
    {
      ...
      if (localThrowable1 != null) {
        h.log(6, "ThreadUtils", this.pyy + " error occurred during processing request:" + h.i(localThrowable1));
      }
