  ...
  extends b
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    {
      ac.e("MicroMsg.JsApiAddMapMarkers", "data is null");
      paramc.h(paramInt, e("fail:invalid data", null));
      AppMethodBeat.o(143661);
      return;
    }
    ac.i("MicroMsg.JsApiAddMapMarkers", "data:%s", new Object[] { paramJSONObject });
    com.tencent.mm.plugin.appbrand.jsapi.f.a.b localb = h(paramc, paramJSONObject);
    if (localb == null)
    {
      ac.e("MicroMsg.JsApiAddMapMarkers", "mapView is null, return");
      paramc.h(paramInt, e("fail:mapview is null", null));
      AppMethodBeat.o(143661);
      return;
    }
    boolean bool = paramJSONObject.optBoolean("clear", true);
    ac.i("MicroMsg.JsApiAddMapMarkers", "clear:%b", new Object[] { Boolean.valueOf(bool) });
    if (bool) {
      localb.bhr();
    }
    if (paramJSONObject.has("markers"))
    {
      ...
      try
      {
        ...
        {
          ac.e("MicroMsg.JsApiAddMapMarkers", "markersArray is null, return");
      ...
      for (;;)
      {
        if (i < localObject1.length()) {
          ...
          catch (JSONException localJSONException2)
          {
            for (;;)
            {
              ac.printErrStackTrace("MicroMsg.JsApiAddMapMarkers", localJSONException2, "", new Object[0]);
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.f.g
