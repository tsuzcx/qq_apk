  ...
  implements com.tencent.luggage.xweb_ext.extendplugin.component.a.b.a.b
{
  ...
  private void a(at paramat, JSONObject paramJSONObject)
  {
    ...
    if ((!paramat.getName().equalsIgnoreCase("onXWebLivePusherEvent")) && (!paramat.getName().equalsIgnoreCase("onXWebLivePusherNetStatus"))) {
      ae.i("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "dispatch event:%s, data:%s", new Object[] { paramat.getName(), paramJSONObject.toString() });
    }
    ...
    if (this.lCs != null)
    {
      ...
      if (paramJSONObject != null)
      {
        ...
        {
          ((r)paramJSONObject).b(paramat);
          AppMethodBeat.o(139526);
          return;
        }
        if ((paramJSONObject instanceof z))
        {
          ((z)paramJSONObject).b(paramat);
          AppMethodBeat.o(139526);
          return;
        }
  ...
  public final void a(int paramInt1, int paramInt2, String paramString, HashMap<String, Object> paramHashMap)
  {
    ...
    {
      ae.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherError fail", new Object[] { paramString });
      AppMethodBeat.o(139525);
    }
  }
  ...
  public final void b(int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    {
      ae.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherEvent fail", new Object[] { paramBundle });
      AppMethodBeat.o(139520);
    }
  }
  ...
  public final void bX(int paramInt1, int paramInt2)
  {
    ...
    {
      ae.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherBGMComplete fail", new Object[] { localJSONException });
      AppMethodBeat.o(139524);
    }
  }
  ...
  public final void bY(int paramInt1, int paramInt2)
  {
    ...
    {
      ae.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherAudioVolume fail", new Object[] { localJSONException });
      AppMethodBeat.o(178856);
    }
  }
  ...
  public final void e(int paramInt, Bundle paramBundle)
  {
    ...
    {
      ae.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherNetStatus fail", new Object[] { paramBundle });
  ...
  public final void f(int paramInt, long paramLong1, long paramLong2)
  {
    ...
    {
      ae.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherBGMProgress fail", new Object[] { localJSONException });
      AppMethodBeat.o(139523);
    }
  }
  ...
  public final void gM(int paramInt)
  {
    ...
    {
      ae.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherBGMStart fail", new Object[] { localJSONException });
      AppMethodBeat.o(139522);
    }
  }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ad.c.b.b
