  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.base.b
{
  ...
  public final View a(h paramh, JSONObject paramJSONObject)
  {
    ...
    localAppBrandDrawableView.getDrawContext().kZr = ((e)paramh.M(e.class));
    localAppBrandDrawableView.getDrawContext().czm = paramh;
    localAppBrandDrawableView.setContentDescription(paramJSONObject.getString(2131755321));
    paramh.a(new i.b()
    {
      public final void onBackground()
      {
        ...
        com.tencent.mm.plugin.appbrand.canvas.b localb = localAppBrandDrawableView.laI;
        localb.kYV = 0L;
        localb.kYS.U(localb.kYT);
        localAppBrandDrawableView.bzx();
