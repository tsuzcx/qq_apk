  ...
  implements c
{
  ...
  public final void ca(int paramInt1, int paramInt2)
  {
    ...
    ac.i("MicroMsg.SameLayer.AppBrandVideoErrorHandler", "onVideoError(%d, %d)", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
    c.a locala;
    String str;
    if (this.lbX != null)
    {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.z.e.d
