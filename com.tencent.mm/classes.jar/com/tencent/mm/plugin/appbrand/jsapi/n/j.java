  ...
  extends e
{
  ...
  final void S(final JSONObject paramJSONObject)
  {
    ...
    {
      ad.e("MicroMsg.AppBrand.JsApi.OptionsPickerHandler", "opt data.array, exp = %s", new Object[] { bt.m(paramJSONObject) });
      n("fail", null);
      AppMethodBeat.o(137611);
      return;
    }
    ...
    try
    {
      ...
      L(new Runnable()
      {
        public final void run()
        {
          ...
          localAppBrandOptionsPickerV3.miu = i;
