  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a
{
  ...
  public final void a(final com.tencent.mm.plugin.appbrand.jsapi.c paramc, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    com.tencent.mm.plugin.appbrand.jsapi.bluetooth.c.md(41);
    if (paramJSONObject == null)
    {
      ae.e("MicroMsg.JsApiReadBLECharacteristicValue", "JsApiReadBLECharacteristicValue data is null");
    ...
    ae.i("MicroMsg.JsApiReadBLECharacteristicValue", "appId:%s readBLECharacteristicValue data %s", new Object[] { paramc.getAppId(), paramJSONObject.toString() });
    ...
    if (localb == null)
    {
      ae.e("MicroMsg.JsApiReadBLECharacteristicValue", "bleWorker is null, may not open ble");
      paramJSONObject = new HashMap();
    ...
    {
      ae.e("MicroMsg.JsApiReadBLECharacteristicValue", "adapter is null or not enabled!");
      paramJSONObject = new HashMap();
    ...
    localb.a(str1, paramJSONObject, new com.tencent.mm.plugin.appbrand.jsapi.bluetooth.sdk.c.b()
    {
      public final void a(j paramAnonymousj)
      {
        ...
        default: 
          ...
          paramc.h(paramInt, m.this.n(paramAnonymousj.errMsg, localHashMap));
        ...
        paramc.h(paramInt, m.this.n("ok", paramAnonymousj));
