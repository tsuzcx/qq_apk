...
{
  AtomicBoolean kLG = new AtomicBoolean(false);
  a kLH;
  aq kLI = new aq("MicroMsg.appbrand.ScanDecoder");
  ...
  {
    ae.d("MicroMsg.appbrand.ScanDecoder", "result:%b, resultText:%s, resultType:%d, codeType:%d, codeVersion:%d", new Object[] { Boolean.TRUE, paramString, Integer.valueOf(paramInt1), Integer.valueOf(0), Integer.valueOf(paramInt2) });
    ar.f(new Runnable()
    {
      public final void run()
      {
        ...
        if (b.this.kLH != null) {
          b.this.kLH.a(paramInt1, paramString, paramInt2, paramArrayOfByte, paramQBarPoint);
        }
