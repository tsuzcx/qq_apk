  ...
  extends a
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    ac.d("MicroMsg.JsApiOperateUploadTask", "JsApiOperateUploadTask");
    if (paramJSONObject == null)
    {
      paramc.h(paramInt, e("fail:data is null", null));
      ac.e("MicroMsg.JsApiOperateUploadTask", "data is null");
    ...
    {
      ac.e("MicroMsg.JsApiOperateUploadTask", "uploadTaskId is null");
    ...
    {
      ac.e("MicroMsg.JsApiOperateUploadTask", "operationType is null");
    ...
    {
      paramJSONObject = i.bpl().Pl(paramc.getAppId());
      if (paramJSONObject == null)
      {
        ac.i("MicroMsg.JsApiOperateUploadTask", "upload is null");
        paramc.h(paramInt, e("fail:no task", null));
        AppMethodBeat.o(179549);
        return;
      }
      h localh = paramJSONObject.Pk(str);
      if (localh == null)
      {
        ac.i("MicroMsg.JsApiOperateUploadTask", "uploadInfo is null %s", new Object[] { str });
        paramc.h(paramInt, e("fail:no task", null));
        AppMethodBeat.o(179549);
        return;
      }
      ...
      ac.d("MicroMsg.JsApiOperateUploadTask", "abortTask finish %s", new Object[] { str });
      AppMethodBeat.o(179549);
      return;
    }
