package com.tencent.mm.plugin.appbrand.jsapi.aa.d;

import android.graphics.SurfaceTexture;
import android.os.Looper;
import android.view.MotionEvent;
import com.tencent.matrix.trace.core.AppMethodBeat;
import com.tencent.mm.plugin.appbrand.jsapi.aa.d.a.d;
...
{
  ap kzR;
  volatile com.tencent.mm.plugin.appbrand.jsapi.g.a.b kzS;
  private ap mHandler;
  ...
  public final void e(SurfaceTexture paramSurfaceTexture)
  {
    ...
    paramSurfaceTexture = new Runnable()
    {
      public final void run()
      {
        ...
        a.this.kzS.g(a.this.mSurfaceTexture);
        AppMethodBeat.o(139527);
      }
    };
  ...
  public final String i(com.tencent.luggage.k.a.a parama)
  {
    ...
    if ((parama instanceof com.tencent.mm.plugin.appbrand.i.b))
    {
      ...
      final com.tencent.mm.plugin.appbrand.jsapi.c localc = parama.joJ;
      final m localm = parama.joI;
      final JSONObject localJSONObject = parama.jmy;
      final int i = parama.joH;
      ad.i("MicroMsg.AppBrand.SameLayer.AppBrandMapPluginHandler", "*** handler(%s) handleJsApi(%s), data:%s", new Object[] { AL(), localm.getName(), localJSONObject.toString() });
      parama = new Runnable()
      {
        public final void run()
        {
          ...
          Object localObject;
          if ((localm instanceof com.tencent.mm.plugin.appbrand.jsapi.aa.d.a.b))
          {
            ad.i("MicroMsg.AppBrand.SameLayer.AppBrandMapPluginHandler", "Tummy insert");
            com.tencent.mm.plugin.appbrand.jsapi.g.a.e.rO(9);
            new bo() {}.b(a.this.kzR);
            locala = a.this;
            localc = localc;
            ...
            com.tencent.mm.plugin.appbrand.jsapi.g.a.e.rO(10);
          ...
          if ((localm instanceof d))
          {
            ...
            com.tencent.mm.plugin.appbrand.jsapi.g.a.e.rO(12);
            locala = a.this;
            localc = localc;
            localJSONObject = localJSONObject;
            localObject = localm;
            i = i;
            if ((locala.kzS != null) && (d.j(localc, localJSONObject)))
            {
              localc.h(i, ((m)localObject).e("ok", null));
              com.tencent.mm.plugin.appbrand.jsapi.g.a.e.rO(13);
              AppMethodBeat.o(139529);
              return;
            }
            ad.e("MicroMsg.AppBrand.SameLayer.AppBrandMapPluginHandler", "update fail");
            com.tencent.mm.plugin.appbrand.jsapi.g.a.e.rO(14);
            localc.h(i, ((m)localObject).e("fail:internal error", null));
            AppMethodBeat.o(139529);
            return;
          }
          int j;
          if ((localm instanceof com.tencent.mm.plugin.appbrand.jsapi.aa.d.a.c))
          {
            com.tencent.mm.plugin.appbrand.jsapi.g.a.e.rO(15);
            locala = a.this;
            localc = localc;
            localJSONObject = localJSONObject;
            localObject = localm;
            ...
            locala.kzS = null;
            com.tencent.mm.plugin.appbrand.jsapi.g.a.e.rO(16);
          }
          for (;;)
          {
            locala.release();
            ...
            g.cV(localc.getAppId(), f.i(localc, localJSONObject));
            i = 1;
            break;
            label429:
            ad.e("MicroMsg.AppBrand.SameLayer.AppBrandMapPluginHandler", "remove fail");
            com.tencent.mm.plugin.appbrand.jsapi.g.a.e.rO(17);
  ...
  public final void n(MotionEvent paramMotionEvent)
  {
    ...
    if (this.kzS != null) {
      this.kzS.onTouchEvent(paramMotionEvent);
    }
