  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.p
{
  ...
  public final void a(p.a parama)
  {
    ...
    ae.i("MicroMsg.OpenVoice.OnVoIPChatInterruptedJsEvent", "hy: dispath reason: %s", new Object[] { parama });
    HashMap localHashMap = new HashMap(2);
    parama = b(parama);
    localHashMap.put("errMsg", parama.cHu + ", room id: " + com.tencent.mm.plugin.cloudvoip.cloudvoice.d.p.pdY.peC);
    localHashMap.put("errCode", Integer.valueOf(parama.errCode));
    localHashMap.put("reason", parama.cHu);
    H(localHashMap).bja();
