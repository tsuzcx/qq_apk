  ...
  extends a<c>
{
  ...
  public static Intent O(JSONObject paramJSONObject)
  {
    ...
    ae.i("MicroMsg.JsApiOpenLocation", "data:%s", new Object[] { paramJSONObject });
    try
    {
      float f1 = bu.getFloat(paramJSONObject.optString("latitude"), 0.0F);
      float f2 = bu.getFloat(paramJSONObject.optString("longitude"), 0.0F);
      String str1 = f.VL(paramJSONObject.optString("name"));
      String str2 = f.VL(paramJSONObject.optString("address"));
      try
      {
        i = bu.getInt(paramJSONObject.optString("scale"), 0);
