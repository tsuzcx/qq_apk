  ...
  implements d.a
{
  ...
  public final void k(long paramLong1, long paramLong2)
  {
    ...
    ae.d("MicroMsg.SameLayer.ExoVideoCacheHandler", "onCachedBytesRead, cacheSpace:%s, totalCachedBytesRead:%s", new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2) });
