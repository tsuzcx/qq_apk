  ...
  implements d.a
{
  ...
  public final void m(long paramLong1, long paramLong2)
  {
    ...
    ad.d("MicroMsg.SameLayer.ExoVideoCacheHandler", "onCachedBytesRead, cacheSpace:%s, totalCachedBytesRead:%s", new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2) });
