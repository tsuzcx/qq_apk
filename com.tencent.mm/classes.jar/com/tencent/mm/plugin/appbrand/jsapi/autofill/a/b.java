  ...
  implements k
{
  ...
  public b(m paramm, String paramString1, String paramString2, Context paramContext, int paramInt1, int paramInt2, d.g.a.b<? super String, z> paramb)
  {
    ...
    this.kBS = paramm;
    paramm = this.kBS.findViewById(2131303220);
    p.g(paramm, "rootView.findViewById(R.…e_number_explain_content)");
    this.kBQ = paramm;
    this.kBQ.setLayoutParams((ViewGroup.LayoutParams)new LinearLayout.LayoutParams(-1, -2));
    this.kBQ.setMinimumHeight(this.minHeight);
    this.kBQ.addOnLayoutChangeListener((View.OnLayoutChangeListener)new View.OnLayoutChangeListener()
    {
      public final void onLayoutChange(View paramAnonymousView, int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3, int paramAnonymousInt4, int paramAnonymousInt5, int paramAnonymousInt6, int paramAnonymousInt7, int paramAnonymousInt8)
      {
        AppMethodBeat.i(50479);
        if ((Math.abs(paramAnonymousInt4 - paramAnonymousInt2) > this.kBV.maxHeight) && (this.kBV.maxHeight > this.kBV.minHeight)) {
          b.a(this.kBV).post((Runnable)new Runnable()
          {
            public final void run()
            {
              AppMethodBeat.i(50478);
              b.a(this.kBW.kBV).setLayoutParams((ViewGroup.LayoutParams)new LinearLayout.LayoutParams(-1, this.kBW.kBV.maxHeight));
    ...
    paramm = this.kBS.findViewById(2131303221);
    p.g(paramm, "rootView.findViewById(R.…mber_explain_dialog_back)");
    this.kBR = ((ImageView)paramm);
    paramm = this.kBR;
    if (paramm != null) {
      paramm.setOnClickListener((View.OnClickListener)new View.OnClickListener()
      {
        public final void onClick(View paramAnonymousView)
        {
          ...
          a.b("com/tencent/mm/plugin/appbrand/jsapi/autofill/realname_auth/RealnameAuthExplainDialog$2", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
          paramAnonymousView = b.b(this.kBV);
          if (paramAnonymousView != null) {
            paramAnonymousView.c((k)this.kBV);
          }
    ...
    paramm = this.kBS.findViewById(2131303223);
