      ...
      try
      {
        if (paramJSONObject.has("controls"))
        {
          ...
          if (i < localJSONArray.length())
          {
            ...
            b.c localc = new b.c();
            localc.jUR = ((com.tencent.mm.plugin.appbrand.g.b)paramc.K(com.tencent.mm.plugin.appbrand.g.b.class)).b(paramc, localJSONObject1.optString("iconPath"));
            localc.jUS = localJSONObject1.optBoolean("clickable");
            ...
            if (localJSONObject1.optBoolean("clickable")) {
              localb.a(localc, new d.1(this, f.Q(paramJSONObject), paramc), (a)paramc.K(a.class));
            } else {
