...
public final class c
{
  ...
  public static void a(android.widget.TextView paramTextView, JSONObject paramJSONObject)
  {
    ...
    //   33: aload_0
    //   34: aload_3
    //   35: invokestatic 67	com/tencent/mm/plugin/appbrand/z/g:UW	(Ljava/lang/String;)I
    ...
    //   49: d2f
    //   50: invokestatic 82	com/tencent/mm/plugin/appbrand/z/g:aJ	(F)F
  ...
  public static void a(com.tencent.mm.plugin.appbrand.jsapi.e parame, com.tencent.mm.plugin.appbrand.widget.b.a parama, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty(paramJSONObject))
      {
        ...
        {
          ad.i("Luggage.ViewAttributeHelper", "it is data:image/ format file, iconPath:%s", new Object[] { paramJSONObject });
          parame = Base64.decode(paramJSONObject.substring(paramJSONObject.indexOf("base64,") + 7).trim(), 0);
          if ((parame == null) || (parame.length == 0))
          {
            ad.i("Luggage.ViewAttributeHelper", "bytes is empty");
            AppMethodBeat.o(137889);
            return;
          }
        ...
        ((com.tencent.mm.plugin.appbrand.f.a)parame.K(com.tencent.mm.plugin.appbrand.f.a.class)).a(paramJSONObject, d.Qv(str), new a.c()
        {
          public final void D(InputStream paramAnonymousInputStream)
          {
            ...
            {
              ad.e("Luggage.ViewAttributeHelper", "attachImageViewAttribute, openRead failed, url=%s", new Object[] { this.hQB });
            ...
            c.bke().b(paramAnonymousInputStream, (BitmapFactory.Options)localObject);
            ...
            for (;;)
            {
              ...
              try
              {
                ...
                localObject = c.bke().decodeStream(paramAnonymousInputStream);
                org.apache.commons.a.e.Z(paramAnonymousInputStream);
                if ((localObject != null) && (!((Bitmap)localObject).isRecycled()))
                {
                  paramAnonymousInputStream = (com.tencent.mm.plugin.appbrand.jsapi.c)this.cZC.get();
                  locala = (com.tencent.mm.plugin.appbrand.widget.b.a)this.ltH.get();
                  if ((paramAnonymousInputStream != null) && (locala != null)) {
                    paramAnonymousInputStream.M(new Runnable()
                    {
              ...
              catch (Throwable paramAnonymousInputStream)
              {
                ...
                ad.e("Luggage.ViewAttributeHelper", "attachImageViewAttribute, setImageBitmap failed, url=%s", new Object[] { this.hQB });
                AppMethodBeat.o(195044);
              }
              ...
              if ((paramAnonymousInputStream != null) && (locala != null)) {
                paramAnonymousInputStream.M(new Runnable()
                {
                  public final void run()
                  {
                    ...
                    locala.setImageByteArray(this.ltJ);
            ...
            {
              ad.e("Luggage.ViewAttributeHelper", "attachImageViewAttribute, setImageByteArray failed, url=%s", new Object[] { this.hQB });
              AppMethodBeat.o(195044);
              return;
            }
          }
    ...
    extends FilterInputStream
  {
    ...
    public final void mark(int paramInt)
    {
      try
      {
        ...
        try
        {
          this.gus = ((FileInputStream)this.in).getChannel().position();
    ...
    public final void reset()
    {
      try
      {
        ...
        if (this.gus < 0L)
        {
          IOException localIOException = new IOException("Illegal marked position: " + this.gus);
          AppMethodBeat.o(195046);
          throw localIOException;
        }
      }
      finally {}
      ((FileInputStream)this.in).getChannel().position(this.gus);
      AppMethodBeat.o(195046);
    }
  }
}
