    ...
    for (;;)
    {
      if (paramList.hasNext())
      {
        ...
        try
        {
          ...
          if ((Util.nullAsNil(localaoe.processName).equals(MMApplicationContext.getProcessName())) && (ab.a(this.lVq) != null)) {
            ab.a(this.lVq).acQ("");
          }
        }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.file.ab.4
