  ...
  extends a
{
  ...
  public final void a(com.tencent.mm.plugin.appbrand.jsapi.c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    if (paramc == null)
    {
      ac.w("MicroMsg.JsApiGetBackgroundFetchData", "fail:component is null");
      AppMethodBeat.o(46819);
      return;
    }
    if (paramJSONObject == null)
    {
      ac.w("MicroMsg.JsApiGetBackgroundFetchData", "fail:data is null");
    ...
    {
      ac.w("MicroMsg.JsApiGetBackgroundFetchData", "fail:fetchType is null");
      paramc.h(paramInt, e("fail:invalid data", null));
      AppMethodBeat.o(46819);
      return;
    }
    ...
    {
      ac.w("MicroMsg.JsApiGetBackgroundFetchData", "fail:appid is null");
    ...
    {
      ac.w("MicroMsg.JsApiGetBackgroundFetchData", "worker fail:IAppBrandBackgroundFetchDataStorage is null");
      paramc.h(paramInt, e("fail:internal error", null));
      AppMethodBeat.o(46819);
      return;
    }
    localObject = ((k)g.ab(k.class)).bl(paramJSONObject, i);
    if (localObject == null)
    {
      ac.w("MicroMsg.JsApiGetBackgroundFetchData", "worker fail:record is null");
    ...
    {
      ac.w("MicroMsg.JsApiGetBackgroundFetchData", "worker fail:fetched data is null");
    ...
    localHashMap.put("timeStamp", Long.valueOf(((AppBrandBackgroundFetchDataParcel)localObject).fto));
    ac.i("MicroMsg.JsApiGetBackgroundFetchData", "JsApiGetBackgroundFetchData, app(%s_%d)", new Object[] { paramJSONObject, Integer.valueOf(i) });
