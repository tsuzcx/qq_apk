  ...
  extends a
{
  ...
  public final void a(com.tencent.mm.plugin.appbrand.jsapi.c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    if (paramc == null)
    {
      ae.w("MicroMsg.JsApiGetBackgroundFetchData", "fail:component is null");
      AppMethodBeat.o(46819);
      return;
    }
    if (paramJSONObject == null)
    {
      ae.w("MicroMsg.JsApiGetBackgroundFetchData", "fail:data is null");
    ...
    {
      ae.w("MicroMsg.JsApiGetBackgroundFetchData", "fail:fetchType is null");
      paramc.h(paramInt, e("fail:invalid data", null));
      AppMethodBeat.o(46819);
      return;
    }
    ...
    {
      ae.w("MicroMsg.JsApiGetBackgroundFetchData", "fail:appid is null");
    ...
    {
      ae.w("MicroMsg.JsApiGetBackgroundFetchData", "worker fail:IAppBrandBackgroundFetchDataStorage is null");
      paramc.h(paramInt, e("fail:internal error", null));
      AppMethodBeat.o(46819);
      return;
    }
    localObject = ((k)g.ab(k.class)).bq(paramJSONObject, i);
    if (localObject == null)
    {
      ae.w("MicroMsg.JsApiGetBackgroundFetchData", "worker fail:record is null");
    ...
    {
      ae.w("MicroMsg.JsApiGetBackgroundFetchData", "worker fail:fetched data is null");
    ...
    localHashMap.put("timeStamp", Long.valueOf(((AppBrandBackgroundFetchDataParcel)localObject).fOl));
    ae.i("MicroMsg.JsApiGetBackgroundFetchData", "JsApiGetBackgroundFetchData, app(%s_%d)", new Object[] { paramJSONObject, Integer.valueOf(i) });
