  ...
  implements com.tencent.luggage.xweb_ext.extendplugin.component.live.livepusher.a.b
{
  ...
  private void a(az paramaz, JSONObject paramJSONObject)
  {
    ...
    if ((!paramaz.getName().equalsIgnoreCase("onXWebLivePusherEvent")) && (!paramaz.getName().equalsIgnoreCase("onXWebLivePusherNetStatus"))) {
      Log.i("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "dispatch event:%s, data:%s", new Object[] { paramaz.getName(), paramJSONObject.toString() });
    }
    ...
    if (this.pKP != null)
    {
      ...
      if (paramJSONObject != null)
      {
        ...
        {
          ((v)paramJSONObject).a(paramaz, null);
          AppMethodBeat.o(139526);
          return;
        }
        if ((paramJSONObject instanceof ad))
        {
          ((ad)paramJSONObject).a(paramaz, null);
          AppMethodBeat.o(139526);
          return;
        }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ai.c.b.b
