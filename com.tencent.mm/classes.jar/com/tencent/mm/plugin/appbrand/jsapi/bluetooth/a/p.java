  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a
{
  ...
  public final void a(com.tencent.mm.plugin.appbrand.jsapi.c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    com.tencent.mm.plugin.appbrand.jsapi.bluetooth.c.lA(101);
    String str = paramc.getAppId();
    Object localObject = paramJSONObject;
    if (paramJSONObject == null) {
      localObject = "";
    }
    ac.i("MicroMsg.JsApiStopBluetoothDevicesDiscovery", "appId:%s stopBluetoothDevicesDiscovery data:%s", new Object[] { str, localObject });
    paramJSONObject = com.tencent.mm.plugin.appbrand.jsapi.bluetooth.a.LX(str);
    if (paramJSONObject == null)
    {
      ac.e("MicroMsg.JsApiStopBluetoothDevicesDiscovery", "bleWorker is null, may not open ble");
    ...
    {
      ac.e("MicroMsg.JsApiStopBluetoothDevicesDiscovery", "adapter is null or not enabled!");
      paramJSONObject = new HashMap();
    ...
    if (paramJSONObject.kid != null)
    {
      ...
      if (paramJSONObject.kjD != null) {
        paramJSONObject = paramJSONObject.kjD.bfN();
      }
    }
    for (;;)
    {
      ac.i("MicroMsg.JsApiStopBluetoothDevicesDiscovery", "stopBleScan result:%s", new Object[] { paramJSONObject });
      ...
      default: 
        ...
        com.tencent.mm.plugin.appbrand.jsapi.bluetooth.c.lA(103);
        AppMethodBeat.o(144525);
        return;
        paramJSONObject = j.kkB;
        continue;
        paramJSONObject = j.kkB;
      }
    }
    ...
    com.tencent.mm.plugin.appbrand.jsapi.bluetooth.c.lA(102);
