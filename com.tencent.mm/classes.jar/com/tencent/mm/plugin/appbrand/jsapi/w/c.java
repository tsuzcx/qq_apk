...
{
  public static InputStream C(InputStream paramInputStream)
  {
  ...
  public static void a(android.widget.TextView paramTextView, JSONObject paramJSONObject)
  {
    ...
    //   10: ifnonnull +9 -> 19
    //   13: ldc 47
    //   15: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   18: return
    //   19: aload_1
    //   20: ldc 49
    ...
    //   25: astore_3
    //   26: aload_3
    //   27: invokestatic 61	com/tencent/mm/sdk/platformtools/bs:isNullOrNil	(Ljava/lang/String;)Z
    //   30: ifne +11 -> 41
    //   33: aload_0
    //   34: aload_3
    //   35: invokestatic 67	com/tencent/mm/plugin/appbrand/z/g:Rq	(Ljava/lang/String;)I
    ...
    //   49: d2f
    //   50: invokestatic 82	com/tencent/mm/plugin/appbrand/z/g:aG	(F)F
    ...
    //   114: invokestatic 129	com/tencent/mm/plugin/appbrand/z/g:a	(Lorg/json/JSONObject;Ljava/lang/String;I)I
    //   117: istore_2
    //   118: aload_0
    //   119: instanceof 131
    //   122: ifeq +11 -> 133
  ...
  public static void a(com.tencent.mm.plugin.appbrand.jsapi.e parame, com.tencent.mm.plugin.appbrand.widget.b.a parama, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        String str = com.tencent.mm.plugin.appbrand.jsapi.p.d.a(parame, parama, paramJSONObject);
        paramJSONObject = paramJSONObject.optString("iconPath");
        if (!TextUtils.isEmpty(paramJSONObject))
        {
          if (paramJSONObject.startsWith("data:image/"))
          {
            ac.i("Luggage.ViewAttributeHelper", "it is data:image/ format file");
            paramJSONObject = a.NI(paramJSONObject);
            paramJSONObject = ((b)parame.K(b.class)).b(parame, paramJSONObject);
            ((com.tencent.mm.plugin.appbrand.g.a)parame.K(com.tencent.mm.plugin.appbrand.g.a.class)).a(paramJSONObject, com.tencent.mm.plugin.appbrand.jsapi.p.d.MY(str), new a.c()
            {
              public final void z(InputStream paramAnonymousInputStream)
              {
                AppMethodBeat.i(206836);
                if (paramAnonymousInputStream == null)
                {
                  ac.e("Luggage.ViewAttributeHelper", "attachImageViewAttribute, openRead failed, url=%s", new Object[] { this.hyh });
                  AppMethodBeat.o(206836);
                  return;
                }
                paramAnonymousInputStream = c.C(paramAnonymousInputStream);
                paramAnonymousInputStream.mark(c.getCompatibleRewindBufferSize());
                Object localObject = new BitmapFactory.Options();
                ((BitmapFactory.Options)localObject).inJustDecodeBounds = true;
                c.bgA().b(paramAnonymousInputStream, (BitmapFactory.Options)localObject);
                ...
                for (;;)
                {
                  ...
                  try
                  {
                    ...
                    localObject = c.bgA().decodeStream(paramAnonymousInputStream);
                    org.apache.commons.a.e.W(paramAnonymousInputStream);
                    if ((localObject != null) && (!((Bitmap)localObject).isRecycled()))
                    {
                      paramAnonymousInputStream = (com.tencent.mm.plugin.appbrand.jsapi.c)this.cOm.get();
                      locala = (com.tencent.mm.plugin.appbrand.widget.b.a)this.kWI.get();
                      if ((paramAnonymousInputStream != null) && (locala != null)) {
                        paramAnonymousInputStream.N(new Runnable()
                        {
                  ...
                  catch (Throwable paramAnonymousInputStream)
                  {
                    ...
                    ac.e("Luggage.ViewAttributeHelper", "attachImageViewAttribute, setImageBitmap failed, url=%s", new Object[] { this.hyh });
                    AppMethodBeat.o(206836);
                  }
                  ...
                  if ((paramAnonymousInputStream != null) && (locala != null)) {
                    paramAnonymousInputStream.N(new Runnable()
                    {
                      public final void run()
                      {
                        ...
                        locala.setImageByteArray(this.kWK);
                ...
                {
                  ac.e("Luggage.ViewAttributeHelper", "attachImageViewAttribute, setImageByteArray failed, url=%s", new Object[] { this.hyh });
                  AppMethodBeat.o(206836);
                  return;
                }
              }
      ...
      {
        ac.printErrStackTrace("Luggage.ViewAttributeHelper", parame, "attachImageViewAttribute", new Object[0]);
        AppMethodBeat.o(137889);
        return;
      }
    }
