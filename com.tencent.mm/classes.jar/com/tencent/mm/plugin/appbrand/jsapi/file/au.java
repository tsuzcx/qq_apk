...
public final class au
{
    ...
    if (Looper.myLooper() != Looper.getMainLooper())
    {
      m.runOnUiThread(new Runnable()
      {
        public final void run()
        {
          ...
          au.c(this.lVv, paramContext, paramString1, paramString2, paramString3, paramBoolean, paramHashMap, paramValueCallback, paramValueCallback1);
    ...
    int i = paramav.a(paramContext, paramBundle, new ITbsReaderCallback()
    {
      public final void onCallBackAction(Integer paramAnonymousInteger, Object paramAnonymousObject1, Object paramAnonymousObject2)
      {
        ...
        if (10 == paramAnonymousInteger.intValue()) {
          this.lVA.onReceiveValue("plugin success");
        }
        for (;;)
        {
          if ((13 == paramAnonymousInteger.intValue()) && (!paramAnonymousObject1.equals("fileReaderClosed"))) {
            this.lVA.onReceiveValue((String)paramAnonymousObject1);
          }
          ...
          if (11 == paramAnonymousInteger.intValue()) {
            this.lVA.onReceiveValue("plugin failed");
          }
        }
      }
    });
    ...
    if (Looper.myLooper() != Looper.getMainLooper())
    {
      m.runOnUiThread(new Runnable()
      {
        public final void run()
        {
          ...
          au.q(this.val$context, paramString1, paramString2);
  ...
  private static void p(Context paramContext, String paramString1, String paramString2)
  {
    ...
    paramContext = av.dP(paramContext);
    try
    {
