...
{
  private static SparseArray<WeakReference<SkiaCanvasView>> pKi;
  ...
  /* Error */
  public static SkiaCanvasView Bs(int paramInt)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   8: getstatic 23	com/tencent/mm/plugin/appbrand/jsapi/ai/b/b:pKi	Landroid/util/SparseArray;
    //   11: iload_0
    ...
    //   28: aload_1
    //   29: areturn
    //   30: getstatic 23	com/tencent/mm/plugin/appbrand/jsapi/ai/b/b:pKi	Landroid/util/SparseArray;
    //   33: iload_0
  ...
  public static void a(int paramInt, SkiaCanvasView paramSkiaCanvasView)
  {
    try
    {
      ...
      pKi.put(paramInt, new WeakReference(paramSkiaCanvasView));
  ...
  public static void remove(int paramInt)
  {
    ...
    //   5: invokestatic 16	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   8: iload_0
    //   9: invokestatic 70	com/tencent/mm/plugin/appbrand/jsapi/ai/b/b:Bs	(I)Lcom/tencent/xweb/skia_canvas/SkiaCanvasView;
    //   12: astore_1
    //   13: aload_1
    //   14: ifnull +41 -> 55
    //   17: getstatic 23	com/tencent/mm/plugin/appbrand/jsapi/ai/b/b:pKi	Landroid/util/SparseArray;
    //   20: iload_0
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ai.b.b
