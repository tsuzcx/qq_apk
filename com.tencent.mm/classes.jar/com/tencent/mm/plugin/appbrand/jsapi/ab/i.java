  ...
  extends d
{
  ...
  public final boolean c(e parame, int paramInt, View paramView, JSONObject paramJSONObject)
  {
    ...
    try
    {
      paramView.setBackgroundColor(g.UX(paramJSONObject.getString("backgroundColor")));
      label43:
      ...
      if ((paramJSONObject.indexOf("#") >= 0) && (!TextUtils.isEmpty(parame.getUrl()))) {
        parame.evaluateJavascript(String.format("window.location=\"%s\"", new Object[] { p.Vc(paramJSONObject) }), null);
      }
      for (;;)
      {
        AppMethodBeat.o(47020);
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ab.i
