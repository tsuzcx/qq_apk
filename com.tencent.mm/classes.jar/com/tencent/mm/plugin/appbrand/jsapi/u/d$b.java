  ...
  implements SensorEventListener
{
  ...
  d$b(final c paramc)
  {
    ...
    this.kiY = new n(i.kjA.bbO(), new n.a()
    {
      public final boolean j(Object... paramAnonymousVarArgs)
      {
        ...
        d.b.this.kjk.C(localHashMap);
        boolean bool = k.a.kjH.a(d.b.this.kjk, paramc);
  ...
  public void onSensorChanged(SensorEvent paramSensorEvent)
  {
    ...
    ad.v("MicroMsg.JsApiEnableDeviceMotion", "try to do frequency limit action(%s).", new Object[] { Boolean.valueOf(this.kiY.l(new Object[] { paramSensorEvent })) });
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mm\classes5.jar
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.u.d.b
