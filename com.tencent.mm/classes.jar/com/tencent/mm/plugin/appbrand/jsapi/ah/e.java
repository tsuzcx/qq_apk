...
public final class e
{
  public static void a(ViewGroup paramViewGroup, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if ((AppBrandViewMotionCompat.dS(localView)) && (AppBrandViewMotionCompat.a(paramViewGroup, f1, f2, localView)) && (localView.isDuplicateParentStateEnabled()))
      {
  ...
  public static boolean a(ViewGroup paramViewGroup, MotionEvent paramMotionEvent, View paramView, int paramInt)
  {
    ...
    i = AppBrandViewMotionCompat.M(paramMotionEvent);
    paramInt = i & paramInt;
    if (paramInt == 0)
    {
    ...
    boolean bool = AppBrandViewMotionCompat.dT(paramView);
    Object localObject;
    if (paramInt == i)
    {
      if (bool)
    ...
    for (;;)
    {
      ...
      if (!bool) {
        ((MotionEvent)localObject).transform(AppBrandViewMotionCompat.dU(paramView));
      }
      bool = paramView.dispatchTouchEvent((MotionEvent)localObject);
      ((MotionEvent)localObject).recycle();
      AppMethodBeat.o(140691);
      return bool;
      MotionEvent localMotionEvent = AppBrandViewMotionCompat.h(paramMotionEvent, paramInt);
  ...
  public static f dw(View paramView)
  {
  ...
  public static final class f
  {
    ...
    public final JSONObject aZh()
    {
      ...
      try
      {
        ...
        localJSONObject.put("x", i.bV(this.x));
        localJSONObject.put("y", i.bV(this.y));
        label54:
