  ...
  extends ab<C>
{
  ...
  protected Map<String, Object> a(C paramC)
  {
    ...
    localHashMap.put("screenWidth", Integer.valueOf(g.zB(paramC.widthPixels)));
    localHashMap.put("screenHeight", Integer.valueOf(g.zB(paramC.heightPixels)));
