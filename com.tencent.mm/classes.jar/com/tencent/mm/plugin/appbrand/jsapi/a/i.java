  ...
  extends y
{
  ...
  public final String a(c paramc, JSONObject paramJSONObject)
  {
    ...
    {
      ae.e("MicroMsg.JsApiMeasureText", "measureText, data is null");
    ...
    ae.i("MicroMsg.JsApiMeasureText", "measureText data:%s", new Object[] { paramJSONObject.toString() });
    if ((TextUtils.isEmpty(paramc)) || (f1 <= 0.0F))
    {
      ae.e("MicroMsg.JsApiMeasureText", "measureText, param is illegal");
    ...
    try
    {
      locala.Nx(paramJSONObject.getString("fontFamily"));
      try
      {
      ...
      catch (JSONException localJSONException2)
      {
        for (;;)
        {
          label284:
          float f2;
          ae.i("MicroMsg.JsApiMeasureText", "get 'fontStyle' error.");
          continue;
          locala.si(2);
          continue;
          locala.si(0);
      ...
      {
        ae.i("MicroMsg.JsApiMeasureText", "get 'fontWeight' error.");
        break label284;
      ...
      ae.i("MicroMsg.JsApiMeasureText", "fontMetrics.bottom : %f, fontMetrics.top : %f, width : %f, height : %f", new Object[] { Float.valueOf(paramc.bottom), Float.valueOf(paramc.top), Float.valueOf(f2), Float.valueOf(f1) });
      f2 = g.aI(f2);
      f1 = g.aI(f1);
      paramc = new HashMap();
      paramc.put("width", Float.valueOf(f2));
      paramc.put("height", Float.valueOf(f1));
      ae.i("MicroMsg.JsApiMeasureText", "map:%s", new Object[] { paramc.toString() });
      paramc = n("ok", paramc);
      AppMethodBeat.o(145541);
      return paramc;
    }
    catch (JSONException localJSONException1)
    {
      for (;;)
      {
        ae.i("MicroMsg.JsApiMeasureText", "get 'fontFamily' error");
        continue;
