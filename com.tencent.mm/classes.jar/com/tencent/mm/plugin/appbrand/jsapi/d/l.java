  ...
  extends a<CONTEXT>
{
  ...
  public final void d(final CONTEXT paramCONTEXT, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    Object localObject2 = bs.nullAsNil(paramJSONObject.optString("type", "wgs84")).trim();
    Object localObject1 = localObject2;
    if (bs.isNullOrNil((String)localObject2)) {
      localObject1 = "wgs84";
    }
    final boolean bool = paramJSONObject.optBoolean("altitude", false);
    ac.i("MicroMsg.JsApiGetLocation", "getLocation data:%s", new Object[] { paramJSONObject });
    if ((!"wgs84".equals(localObject1)) && (!"gcj02".equals(localObject1)))
    {
      ac.e("MicroMsg.JsApiGetLocation", "doGeoLocation fail, unsupported type = %s", new Object[] { localObject1 });
    ...
    if (localObject2 != null) {
      ((com.tencent.mm.plugin.appbrand.utils.b.a)localObject2).a((String)localObject1, new a.b()
      {
        public final void a(int paramAnonymousInt, String paramAnonymousString, a.a paramAnonymousa)
        {
          ...
          ac.i("MicroMsg.JsApiGetLocation", "errCode:%d, errStr:%s, location:%s", new Object[] { Integer.valueOf(paramAnonymousInt), paramAnonymousString, paramAnonymousa });
          l.this.bgU();
          if (paramAnonymousInt == 0)
          {
            paramAnonymousString = new HashMap(4);
            paramAnonymousString.put("type", this.ktb);
            ...
            paramAnonymousString.put("speed", Double.valueOf(paramAnonymousa.cUo));
            paramAnonymousString.put("accuracy", Double.valueOf(paramAnonymousa.mpk));
            if (bool) {
            ...
            paramAnonymousString.put("horizontalAccuracy", Double.valueOf(paramAnonymousa.mpk));
            if (!bs.isNullOrNil(paramAnonymousa.buildingId))
            {
            ...
            paramAnonymousString.put("indoorLocationType", Integer.valueOf(paramAnonymousa.mpl));
            paramAnonymousString.put("direction", Float.valueOf(paramAnonymousa.mpm));
            paramAnonymousString.put("steps", Double.valueOf(paramAnonymousa.mpn));
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.d.l
