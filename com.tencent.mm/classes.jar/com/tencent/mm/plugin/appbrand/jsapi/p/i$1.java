  ...
  extends e
{
  ...
  final void U(final JSONObject paramJSONObject)
  {
      ...
      K(new Runnable()
      {
        public final void run()
        {
          ...
          if ((i >= 0) && (i < localAppBrandMultiOptionsPicker.getPickersCount()) && (locala != null))
          {
            ...
            localAppBrandMultiOptionsPicker.wL(i).setOptionsArray(locala.npP);
            if (!bu.V(locala.npP)) {
              localAppBrandMultiOptionsPicker.wL(i).setValue(locala.selected);
            }
    ...
    {
      ae.printErrStackTrace("MicroMsg.AppBrand.JsApiUpdateMultiPickerView", paramJSONObject, "opt params", new Object[0]);
      q("fail:invalid data", null);
      AppMethodBeat.o(137598);
    }
  }
      ...
      K(new Runnable()
      {
        public final void run()
        {
          ...
          if ((i >= 0) && (i < localAppBrandMultiOptionsPickerV2.getPickersCount()) && (locala != null))
          {
            ...
            localAppBrandMultiOptionsPickerV2.wN(i).setOptionsArray(locala.npP);
            if (!bu.V(locala.npP))
            {
              AppBrandOptionsPickerV3 localAppBrandOptionsPickerV3 = localAppBrandMultiOptionsPickerV2.wN(i);
              i = locala.selected;
              localAppBrandOptionsPickerV3.npW.aQC().setCurrentItem(i);
            }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.p.i.1
