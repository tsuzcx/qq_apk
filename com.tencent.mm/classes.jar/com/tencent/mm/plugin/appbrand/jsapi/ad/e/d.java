  ...
  implements c
{
  ...
  public final void cd(int paramInt1, int paramInt2)
  {
    ...
    ae.i("MicroMsg.SameLayer.AppBrandVideoErrorHandler", "onVideoError(%d, %d)", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
    c.a locala;
    String str;
    if (this.lDv != null)
    {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ad.e.d
