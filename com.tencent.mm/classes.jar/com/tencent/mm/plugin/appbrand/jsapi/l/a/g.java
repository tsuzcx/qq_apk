...
{
  private static Map<String, HashMap<String, b>> oZo;
  private static Set<b> oZp;
  private static Set<b> oZq;
  public static a oZr;
  private static Runnable oZs;
  ...
  public static boolean a(String paramString1, String paramString2, b paramb)
  {
    ...
    //   34: iload_3
    //   35: ireturn
    //   36: getstatic 41	com/tencent/mm/plugin/appbrand/jsapi/l/a/g:oZo	Ljava/util/Map;
    //   39: aload_0
    ...
    //   66: astore 4
    //   68: getstatic 41	com/tencent/mm/plugin/appbrand/jsapi/l/a/g:oZo	Ljava/util/Map;
    //   71: aload_0
    //   72: aload 4
  ...
  public static b dK(String paramString1, String paramString2)
  {
    ...
    //   68: checkcast 142	com/tencent/mm/plugin/appbrand/jsapi/l/a/b
    //   71: astore_0
    //   72: ldc 160
  ...
  public static boolean dL(String paramString1, String paramString2)
  {
    ...
    //   3: ldc 166
    //   5: invokestatic 34	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   8: getstatic 41	com/tencent/mm/plugin/appbrand/jsapi/l/a/g:oZo	Ljava/util/Map;
    //   11: aload_0
    ...
    //   42: checkcast 142	com/tencent/mm/plugin/appbrand/jsapi/l/a/b
    //   45: astore 4
    //   47: aload 4
    //   49: ifnonnull +20 -> 69
    //   52: ldc 62
    ...
    //   90: pop
    //   91: aload 4
    //   93: invokestatic 174	com/tencent/mm/plugin/appbrand/jsapi/l/a/g:b	(Lcom/tencent/mm/plugin/appbrand/jsapi/l/a/b;)V
    //   96: aload_3
    //   97: invokevirtual 175	java/util/HashMap:size	()I
    //   100: ifgt +13 -> 113
    //   103: getstatic 41	com/tencent/mm/plugin/appbrand/jsapi/l/a/g:oZo	Ljava/util/Map;
    //   106: aload_0
    //   107: invokeinterface 176 2 0
    //   112: pop
    //   113: getstatic 51	com/tencent/mm/plugin/appbrand/jsapi/l/a/g:oZp	Ljava/util/Set;
    //   116: aload 4
    //   118: invokeinterface 75 2 0
    //   123: pop
    //   124: getstatic 54	com/tencent/mm/plugin/appbrand/jsapi/l/a/g:oZs	Ljava/lang/Runnable;
    //   127: invokestatic 182	com/tencent/mm/sdk/platformtools/MMHandlerThread:removeRunnable	(Ljava/lang/Runnable;)V
    //   130: getstatic 54	com/tencent/mm/plugin/appbrand/jsapi/l/a/g:oZs	Ljava/lang/Runnable;
    //   133: ldc2_w 183
    //   136: invokestatic 188	com/tencent/mm/sdk/platformtools/MMHandlerThread:postToMainThreadDelayed	(Ljava/lang/Runnable;J)V
    //   139: ldc 62
    //   141: ldc 190
    //   143: iconst_2
    ...
    //   157: invokestatic 196	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   160: aastore
  ...
  private static void init()
  {
    try
    {
      ...
      if (oZr == null)
      {
        ...
        sensorManager.registerListener(oZr, (Sensor)localObject1, 1);
      }
  ...
  private static void uninit()
  {
    try
    {
      ...
      if ((oZr != null) && (sensorManager != null))
      {
        Log.i("MicroMsg.AppBrandMapManager", "sensorListener uninit");
        sensorManager.unregisterListener(oZr);
        sensorManager = null;
        oZr = null;
      }
    ...
    implements SensorEventListener
  {
    ...
    public final void onSensorChanged(SensorEvent arg1)
    {
      ...
      if (???.sensor.getType() == 3)
      {
        ...
        if ((l1 - l2 > 200L) && (Math.abs(f - this.oZt) > 3.0F))
        {
          synchronized (g.avo())
          {
            Iterator localIterator1 = g.avo().values().iterator();
            b localb;
            do
            {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.l.a.g
