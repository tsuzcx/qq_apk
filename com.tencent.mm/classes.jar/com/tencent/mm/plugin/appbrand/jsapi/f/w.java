  ...
  extends b
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    {
      ac.e("MicroMsg.JsApiRemoveMapMarkers", "data is null");
      paramc.h(paramInt, e("fail:invalid data", null));
      AppMethodBeat.o(143690);
      return;
    }
    ac.i("MicroMsg.JsApiRemoveMapMarkers", "data:%s", new Object[] { paramJSONObject });
    com.tencent.mm.plugin.appbrand.jsapi.f.a.b localb = h(paramc, paramJSONObject);
    if (localb == null)
    {
      ac.e("MicroMsg.JsApiRemoveMapMarkers", "mapView is null, return");
    ...
    if (paramJSONObject.has("markers")) {
      try
      {
        ...
        {
          localb.Mq(paramJSONObject.getString(i));
          i += 1;
        }
      ...
      {
        ac.printErrStackTrace("MicroMsg.JsApiRemoveMapMarkers", paramJSONObject, "", new Object[0]);
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.f.w
