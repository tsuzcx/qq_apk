...
@l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/appbrand/jsapi/xwebplugin/video/AppBrandVideoCastHandler$Companion;", "", "()V", "TAG", "", "getFormatTime", "timeMs", "", "getMsTime", "", "formatTime", "luggage-xweb-ext_release"})
public final class b$c
{
  public static long abN(String paramString)
  {
    ...
    for (localObject = j.b((Iterable)localObject, localListIterator.nextIndex() + 1);; localObject = (List)v.SXr)
    {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ag.e.b.c
