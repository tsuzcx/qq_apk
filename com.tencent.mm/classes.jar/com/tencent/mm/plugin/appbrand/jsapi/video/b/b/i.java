...
{
  private com.tencent.mm.plugin.appbrand.jsapi.video.b.a.a kPL;
  private k kQv;
  private j kQw;
  private com.tencent.mm.plugin.appbrand.jsapi.video.b.a.b kQx;
  ...
  public i(com.tencent.mm.plugin.appbrand.jsapi.video.b.a.a parama, com.tencent.mm.plugin.appbrand.jsapi.video.b.c.e parame, com.tencent.mm.plugin.appbrand.jsapi.video.b.c.n paramn)
  {
    ...
    if (this.kQz == null) {
      this.kQz = new h((byte)0);
    }
    this.kQw = new n("com.tencent.mm.video", new g(), this.kQz, parame, new d(paramn.kRV, paramn.getLogTag()), paramn);
    this.kQv = new k();
    this.kPL = parama;
    if (parama != null) {
      this.kQx = new com.tencent.mm.plugin.appbrand.jsapi.video.b.a.b(parama, com.tencent.mm.plugin.appbrand.jsapi.video.b.a.bjM().kPF);
    }
    this.kQy = paramn;
    AppMethodBeat.o(194225);
  }
  
  public final e dv(String paramString1, String paramString2)
  {
    AppMethodBeat.i(194226);
    this.kQw.No(paramString2);
    if (this.kQx != null) {
      this.kQx.kPQ = paramString2;
    }
    this.kQv.No(paramString2);
    int i;
    boolean bool2;
    if (!URLUtil.isNetworkUrl(paramString1))
    {
      i = 1;
      boolean bool1 = com.tencent.mm.plugin.appbrand.jsapi.video.b.e.h.NF(paramString1);
      bool2 = com.tencent.mm.plugin.appbrand.jsapi.video.b.e.h.NG(paramString1);
      if (!bool1) {
        break label127;
      }
      paramString1 = new a(com.tencent.mm.plugin.appbrand.jsapi.video.b.a.bjM().appContext);
      paramString1.No(paramString2);
    ...
    for (;;)
    {
      ...
      if (bool2)
      {
        paramString1 = new o(com.tencent.mm.plugin.appbrand.jsapi.video.b.a.bjM().appContext);
        paramString1.No(paramString2);
      ...
      {
        if ((this.kPL != null) && (com.tencent.mm.plugin.appbrand.jsapi.video.b.a.bjM().kPy)) {
          break label288;
        }
        paramString1 = this.kQw;
    ...
    label288:
    a locala = new a();
    com.tencent.mm.plugin.appbrand.jsapi.video.b.a.a locala1 = this.kPL;
    j localj = this.kQw;
    k localk = this.kQv;
    if (this.kQy.kRS) {}
    for (paramString1 = this.kQx;; paramString1 = null)
    {
    ...
    implements c.a
  {
    ...
    public final void a(String paramString, int paramInt, long paramLong1, long paramLong2, long paramLong3)
    {
      ...
      if (com.tencent.mm.plugin.appbrand.jsapi.video.b.a.bjM().kPI != null) {
        com.tencent.mm.plugin.appbrand.jsapi.video.b.a.bjM();
      }
