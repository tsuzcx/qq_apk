  ...
  extends d
{
  ...
  public final boolean b(final e parame, int paramInt, View paramView, JSONObject paramJSONObject, final com.tencent.mm.plugin.appbrand.jsapi.base.i parami)
  {
    ...
    ae.i("MicroMsg.JsApiOperateLivePlayer", "onOperateView : livePlayerId=%d", new Object[] { Integer.valueOf(paramInt) });
    if (!(paramView instanceof CoverViewContainer))
    {
      ae.w("MicroMsg.JsApiOperateLivePlayer", "the view(%s) is not a instance of CoverViewContainer", new Object[] { Integer.valueOf(paramInt) });
    ...
    {
      ae.e("MicroMsg.JsApiOperateLivePlayer", "targetView not AppBrandLivePlayerView");
      AppMethodBeat.o(145886);
      return false;
    }
    localObject1 = (AppBrandLivePlayerView)localObject1;
    Object localObject2 = paramJSONObject.optString("type");
    ae.i("MicroMsg.JsApiOperateLivePlayer", "onOperateView operateType=%s", new Object[] { localObject2 });
    if (((String)localObject2).equalsIgnoreCase("snapshot"))
    {
      ((AppBrandLivePlayerView)localObject1).setSnapshotListener(new TXLivePlayer.ITXSnapshotListener()
      {
        public final void onSnapshot(Bitmap paramAnonymousBitmap)
        {
          ...
          {
            ae.e("MicroMsg.JsApiOperateLivePlayer", "onSnapshot: bitmap nil");
            parami.PZ(c.this.e("fail:snapshot error", null));
          ...
          {
            ae.e("MicroMsg.JsApiOperateLivePlayer", "onSnapshot: exception %s", new Object[] { paramAnonymousBitmap.getMessage() });
            parami.PZ(c.this.e("fail:snapshot error", null));
            AppMethodBeat.o(145884);
            return;
          }
          if ((paramAnonymousBitmap != null) && (!paramAnonymousBitmap.isRecycled()))
          {
            ae.i("MicroMsg.JsApiOperateLivePlayer", "bitmap recycle " + paramAnonymousBitmap.toString());
            paramAnonymousBitmap.recycle();
          }
          ae.i("MicroMsg.JsApiOperateLivePlayer", "onSnapshot: actualPath:%s path:%s", new Object[] { str, locali.value });
          ...
          parami.PZ(c.this.n("ok", paramAnonymousBitmap));
          AppMethodBeat.o(145884);
        }
      });
    ...
    if (((String)localObject2).equalsIgnoreCase("requestFullScreen"))
    {
      ...
      {
        ae.w("MicroMsg.JsApiOperateLivePlayer", "onOperateView directionArr nil");
        i = 0;
        label242:
        ae.i("MicroMsg.AppBrandLivePlayerView", "enterFullScreen direction:%s", new Object[] { Integer.valueOf(i) });
        if (((AppBrandLivePlayerView)localObject1).kSx != null) {
          break label315;
        }
        ae.w("MicroMsg.AppBrandLivePlayerView", "enterFullScreen mFullScreenDelegate null");
        i = 0;
        label279:
        if (i == 0) {
          break label374;
      ...
      {
        parami.PZ(e((String)localObject1, null));
        break;
        i = ((JSONArray)localObject2).optInt(0, 0);
        break label242;
        if (((AppBrandLivePlayerView)localObject1).kSx.isFullScreen())
        {
          ae.i("MicroMsg.AppBrandLivePlayerView", "enterFullScreen already full screen");
          i = j;
          break label279;
        }
        ((AppBrandLivePlayerView)localObject1).kSx.th(i);
        ((AppBrandLivePlayerView)localObject1).kSz = i;
        ((AppBrandLivePlayerView)localObject1).gw(true);
        i = j;
        break label279;
      }
    }
    ...
    {
      ae.i("MicroMsg.AppBrandLivePlayerView", "quitFullScreen");
      if (((AppBrandLivePlayerView)localObject1).kSx == null)
      {
        ae.w("MicroMsg.AppBrandLivePlayerView", "quitFullScreen mFullScreenDelegate null");
        label413:
        if (i == 0) {
          break label479;
        }
      ...
      for (localObject1 = "ok";; localObject1 = "fail")
      {
        ...
        if (!((AppBrandLivePlayerView)localObject1).kSx.isFullScreen())
        {
          ae.i("MicroMsg.AppBrandLivePlayerView", "quitFullScreen already quit full screen");
          i = 1;
          break label413;
        }
        ((AppBrandLivePlayerView)localObject1).kSx.blp();
        i = 1;
        break label413;
      }
    }
