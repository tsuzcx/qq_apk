...
public final class a
{
  ...
  public static BroadcastReceiver oGW;
  public static boolean oGX;
  ...
  public static void a(String paramString, a parama)
  {
    ...
    if (oGW == null)
    {
            ...
            while (((a.oGX) && (!bool1)) || ((!a.oGX) && (bool1)))
            {
              ...
              while (paramAnonymousContext.hasNext())
              {
                ...
                if ((paramAnonymousIntent.isStart()) && (!bool1)) {
                  paramAnonymousIntent.TV();
                }
                if (paramAnonymousIntent.oTX != null) {
                  paramAnonymousIntent.oTX.jdMethod_if(bool1);
                }
              }
              bool1 = bool2;
              if (i == 10) {
      ...
      MMApplicationContext.getContext().registerReceiver(oGW, paramString);
    }
    AppMethodBeat.o(144670);
  }
  
  public static a ahC(String paramString)
  {
  ...
  public static void remove(String paramString)
  {
    ...
    if ((map.size() == 0) && (oGW != null))
    {
      Log.i("MicroMsg.BeaconManager", "bluetoothStateListener uninit");
      MMApplicationContext.getContext().unregisterReceiver(oGW);
      oGW = null;
    }
  ...
  public static final class a
  {
    ...
    BluetoothAdapter oTU;
    Map<String, JSONObject> oTV;
    UUID[] oTW;
    a oTX;
    long oTY;
    Map<String, JSONObject> oTZ;
    BluetoothAdapter.LeScanCallback oUa;
    
    public a()
    {
      AppMethodBeat.i(144668);
      this.oTV = new ConcurrentHashMap();
      this.oTW = null;
      this.isStart = false;
      this.oTY = 0L;
      this.oTZ = new ConcurrentHashMap();
      this.oUa = new BluetoothAdapter.LeScanCallback()
      {
        public final void onLeScan(BluetoothDevice paramAnonymousBluetoothDevice, int paramAnonymousInt, byte[] paramAnonymousArrayOfByte)
        {
          ...
          int m = 0;
          Object localObject2 = a.a.this.oTW;
          ...
          for (;;)
          {
            ...
            try
            {
              ...
              a.a.this.oTV.put(paramAnonymousBluetoothDevice, paramAnonymousArrayOfByte);
              a.a.this.oTZ.put(paramAnonymousBluetoothDevice, paramAnonymousArrayOfByte);
              Log.d("MicroMsg.BeaconManager", "found device ibeacon %s", new Object[] { paramAnonymousArrayOfByte });
              long l = System.currentTimeMillis();
              if (l - a.a.this.oTY > 500L)
              {
                if (a.a.this.oTX != null) {
                  a.a.this.oTX.H(a.a.this.oTZ);
                }
                a.a.this.oTY = l;
                a.a.this.oTZ.clear();
              }
      ...
      this.oTU = localBluetoothManager.getAdapter();
      if (this.oTU == null)
      {
    ...
    {
      public abstract void H(Map<String, JSONObject> paramMap);
