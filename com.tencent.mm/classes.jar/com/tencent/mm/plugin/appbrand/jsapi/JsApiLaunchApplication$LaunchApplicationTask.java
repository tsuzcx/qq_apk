  ...
  extends AppBrandProxyTransparentUIProcessTask
{
  ...
  public final void a(Context paramContext, final AppBrandProxyTransparentUIProcessTask.a parama)
  {
    ...
    JsApiLaunchApplication.a locala = new JsApiLaunchApplication.a(new JsApiLaunchApplication.a.a()
    {
      public final void u(boolean paramAnonymousBoolean1, boolean paramAnonymousBoolean2)
      {
        ...
        ae.i("MicroMsg.JsApiLaunchApplication", "onLaunchAppCallback(launchRet : %s, launchSuccess : %s)", new Object[] { Boolean.valueOf(paramAnonymousBoolean1), Boolean.valueOf(paramAnonymousBoolean2) });
    ...
    if (!bool1)
    {
      ...
      ae.i("MicroMsg.JsApiLaunchApplication", "launchApplication by opensdk failed, try to launch by scheme(%s).", new Object[] { parama });
    ...
    for (;;)
    {
      for (bool2 = bool1;; bool2 = bool1)
      {
        ...
        break;
        label379:
        ae.i("MicroMsg.JsApiLaunchApplication", "launchApplication nil appId or parameter.");
      }
    }
  }
  ...
  public final void aOY()
  {
    ...
    ae.i("MicroMsg.JsApiLaunchApplication", "runInClientProcess");
    if (this.kuv != null)
    {
      ae.i("MicroMsg.JsApiLaunchApplication", "runInClientProcess asyncCallback != null");
      this.kuv.run();
    }
