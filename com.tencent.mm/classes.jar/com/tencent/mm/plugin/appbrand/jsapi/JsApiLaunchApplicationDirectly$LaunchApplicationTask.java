  ...
  extends AppBrandProxyTransparentUIProcessTask
{
  ...
  public final void a(Context paramContext, final AppBrandProxyTransparentUIProcessTask.a parama)
  {
    ...
    JsApiLaunchApplicationDirectly.a locala = new JsApiLaunchApplicationDirectly.a(new JsApiLaunchApplicationDirectly.a.a()
    {
      public final void u(boolean paramAnonymousBoolean1, boolean paramAnonymousBoolean2)
      {
        ...
        ac.i("MicroMsg.JsApiLaunchApplicationDirectly", "onLaunchAppCallback(launchRet : %s, launchSuccess : %s)", new Object[] { Boolean.valueOf(paramAnonymousBoolean1), Boolean.valueOf(paramAnonymousBoolean2) });
    ...
    if (!bool1)
    {
      ...
      ac.i("MicroMsg.JsApiLaunchApplicationDirectly", "launchApplication by opensdk failed, try to launch by scheme(%s).", new Object[] { parama });
    ...
    for (;;)
    {
      for (bool2 = bool1;; bool2 = bool1)
      {
        ...
        break;
        label379:
        ac.i("MicroMsg.JsApiLaunchApplicationDirectly", "launchApplication nil appId or parameter.");
      }
    }
  }
  ...
  public final void aLr()
  {
    ...
    ac.i("MicroMsg.JsApiLaunchApplicationDirectly", "runInClientProcess");
    if (this.jWP != null)
    {
      ac.i("MicroMsg.JsApiLaunchApplicationDirectly", "runInClientProcess asyncCallback != null");
      this.jWP.run();
    }
