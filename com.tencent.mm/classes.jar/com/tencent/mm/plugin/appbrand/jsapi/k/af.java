  ...
  extends b
{
  ...
  private List<Runnable> lYs;
  private AtomicBoolean lYt;
  
  public af()
  {
    AppMethodBeat.i(143695);
    this.lYs = new ArrayList();
    this.lYt = new AtomicBoolean(false);
  ...
  private void bGQ()
  {
    for (;;)
    {
      try
      {
        ...
        localRunnable = (Runnable)this.lYs.remove(0);
      }
      finally {}
      Runnable localRunnable;
      if (localRunnable != null) {
        m.bZn().postToWorker(localRunnable);
      }
      AppMethodBeat.o(143697);
    }
  }
  ...
  public final void a(final f paramf, final JSONObject paramJSONObject, final int paramInt)
  {
    ...
    paramf = new Runnable()
    {
      public final void run()
      {
        ...
        af.this.e(paramf, paramJSONObject, paramInt);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < paramJSONObject.length())
        {
          ...
          {
            localh.mat = ((float)((JSONObject)localObject).optDouble("rotate", 0.0D));
      ...
      localb.a(str1, localLinkedList, new b.r()
      {
        ...
        public final void hv(boolean paramAnonymousBoolean)
        {
          ...
          {
            af.a(af.this, paramf, paramInt, "ok", localb.bGX());
            AppMethodBeat.o(143694);
            return;
          }
          af.a(af.this, paramf, paramInt, "fail", localb.bGX());
          AppMethodBeat.o(143694);
        }
      });
      AppMethodBeat.o(143698);
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.k.af
