  ...
  extends a
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    try
    {
      f1 = bs.getFloat(paramJSONObject.optString("latitude"), 0.0F);
      f2 = bs.getFloat(paramJSONObject.optString("longitude"), 0.0F);
      localObject = e.Ru(paramJSONObject.optString("name"));
      str = e.Ru(paramJSONObject.optString("address"));
    }
    catch (Exception paramJSONObject)
    {
      ...
      int j;
      label70:
      paramc.h(paramInt, e("invalid_coordinate", null));
      AppMethodBeat.o(46385);
      return;
    }
    try
    {
      j = bs.getInt(paramJSONObject.optString("scale"), 0);
      i = j;
    }
    catch (Exception paramJSONObject)
    {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.d.o
