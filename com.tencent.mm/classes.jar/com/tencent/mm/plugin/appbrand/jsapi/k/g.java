...
import com.tencent.mm.plugin.appbrand.jsapi.k.a.b.k;
      ...
      if (paramJSONObject.has("lines"))
      {
        ...
        while (i < paramJSONObject.length())
        {
          ...
          if (((JSONObject)localObject1).has("colorList"))
          {
            ...
            while (j < ((JSONArray)localObject3).length())
            {
              localArrayList.add(Integer.valueOf(com.tencent.mm.plugin.appbrand.ac.g.cu(((JSONArray)localObject3).getString(j), Color.parseColor("#000000"))));
              j += 1;
            }
          ...
          j = com.tencent.mm.plugin.appbrand.ac.g.cu(((JSONObject)localObject1).optString("color", ""), Color.parseColor("#000000"));
          ...
          int n = com.tencent.mm.plugin.appbrand.ac.g.cu(((JSONObject)localObject1).optString("borderColor", ""), Color.parseColor("#000000"));
          ...
          ((b.k)localObject4).maG = new ArrayList();
          ((b.k)localObject4).maG.addAll((Collection)localObject2);
          ((b.k)localObject4).maL = localArrayList;
          ((b.k)localObject4).color = j;
          ((b.k)localObject4).width = m;
          ((b.k)localObject4).maH = bool1;
          ((b.k)localObject4).borderColor = n;
          ((b.k)localObject4).rc = i1;
          ((b.k)localObject4).maI = bool2;
          ((b.k)localObject4).maK = i2;
          if (bool2) {
            ((b.k)localObject4).maJ = ((com.tencent.mm.plugin.appbrand.f.b)paramf.M(com.tencent.mm.plugin.appbrand.f.b.class)).b(paramf, str2);
          }
          ...
          ((b.k)localObject4).mau = ((String)localObject3);
          localb.a((b.k)localObject4, (a)paramf.M(a.class));
          i += 1;
        }
      }
