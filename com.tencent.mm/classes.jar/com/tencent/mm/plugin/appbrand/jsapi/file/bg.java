  ...
  extends g
{
  i.a a(c paramc, String paramString, JSONObject paramJSONObject)
  {
    ...
    v.a(paramc.aYh(), null, paramJSONObject, (v.a)paramc.ar(v.a.class));
    Object localObject = paramJSONObject.opt("data");
    if ((localObject instanceof String)) {
      if (bt.isNullOrNil(str)) {
        paramJSONObject = (h)h.a.kMz.get("utf8");
      }
    }
    for (;;)
    {
      try
      {
        paramJSONObject = paramJSONObject.PC((String)localObject);
        paramJSONObject = new a(paramJSONObject);
        paramc = paramc.Fg().a(paramString, paramJSONObject, bool);
      ...
      paramJSONObject = (h)h.a.kMz.get(str.toLowerCase());
