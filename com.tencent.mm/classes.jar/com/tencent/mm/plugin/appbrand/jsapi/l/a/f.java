...
public final class f
{
  ...
  public static int a(Map<String, Object> paramMap, String paramString, int paramInt)
  {
    ...
    paramMap = cH(paramMap.get(paramString));
    if (paramMap != null)
    {
  ...
  public static boolean a(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, String paramString, double paramDouble5)
  {
    ...
    boolean bool = false;
    if (f.a.oZl.name().equalsIgnoreCase(paramString))
    {
    ...
    for (;;)
    {
      bool = true;
      break;
      if (!f.a.oZm.name().equalsIgnoreCase(paramString)) {
        break;
      }
      int i;
  ...
  public static int af(JSONObject paramJSONObject)
  {
  ...
  private static Integer cH(Object paramObject)
  {
  ...
  public static String h(e parame, JSONObject paramJSONObject)
  {
    AppMethodBeat.i(143713);
    int i = af(paramJSONObject);
    if (i == -1)
    {
      AppMethodBeat.o(143713);
      return "invalid_map_id";
    }
    parame = parame.getComponentId() + "&" + i;
    AppMethodBeat.o(143713);
    return parame;
  }
}
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.l.a.f
