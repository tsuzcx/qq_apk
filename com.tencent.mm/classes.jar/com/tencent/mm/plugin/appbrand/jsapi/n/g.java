  ...
  extends a
{
  ...
  public final void b(com.tencent.mm.plugin.appbrand.jsapi.e parame, JSONObject paramJSONObject, int paramInt)
  {
    ...
    if (this.kgn)
    {
      new c((byte)0).a(this, parame, paramJSONObject, paramInt, this.kgn);
      AppMethodBeat.o(137590);
      return;
    }
    new b((byte)0).a(this, parame, paramJSONObject, paramInt, this.kgn);
    AppMethodBeat.o(137590);
  }
  ...
  final class b
    ...
    implements Runnable
  {
    private final AtomicReference<AppBrandMultiOptionsPicker.a[]> kgF;
    
    private b()
    {
      AppMethodBeat.i(194751);
      this.kgF = new AtomicReference();
    ...
    public final void run()
    {
      ...
      AppBrandMultiOptionsPicker.a[] arrayOfa = (AppBrandMultiOptionsPicker.a[])this.kgF.get();
      ...
      for (;;)
      {
        ...
        this.mhO.setOnValueUpdateListener(new c.b() {});
        this.mhO.show();
        AppMethodBeat.o(194753);
        return;
        ...
        if (i < arrayOfa.length)
        {
          ...
          if (i > 0) {
            while (i > 0)
            {
              ...
              ((AppBrandOptionsPickerV2)localObject).setOnValueChangedListener(localAppBrandMultiOptionsPicker.mii);
              ...
              ((AppBrandOptionsPickerV2)localObject).setTag(2131296775, Integer.valueOf(localAppBrandMultiOptionsPicker.mif.getChildCount()));
              localAppBrandMultiOptionsPicker.mif.addView((View)localObject, new LinearLayout.LayoutParams(0, -1, 1.0F));
              i -= 1;
            }
          }
        }
        ...
        {
          localAppBrandMultiOptionsPicker.vl(i - arrayOfa.length);
        }
        i = 0;
        while (i < arrayOfa.length)
        {
          localObject = localAppBrandMultiOptionsPicker.vk(i);
          AppBrandMultiOptionsPicker.a locala = arrayOfa[i];
          ((AppBrandOptionsPickerV2)localObject).setOptionsArray(locala.mik);
          ((AppBrandOptionsPickerV2)localObject).setValue(locala.selected);
          ((AppBrandOptionsPickerV2)localObject).setOnValueChangedListener(localAppBrandMultiOptionsPicker.mii);
          i += 1;
        }
        localAppBrandMultiOptionsPicker.mif.setWeightSum(localAppBrandMultiOptionsPicker.getPickersCount());
  ...
  final class c
    ...
    implements Runnable
  {
    private final AtomicReference<AppBrandMultiOptionsPickerV2.a[]> kgF;
    ...
    public final void run()
    {
      ...
      AppBrandMultiOptionsPickerV2.a[] arrayOfa = (AppBrandMultiOptionsPickerV2.a[])this.kgF.get();
      if ((arrayOfa == null) || (arrayOfa.length <= 0))
      {
        n("fail error data", null);
        AppMethodBeat.o(137588);
        ...
        if (i < arrayOfa.length)
        {
          ...
          if (j > 0)
          {
            ...
            while (i < j)
            {
              ...
              localAppBrandOptionsPickerV3.miu = k;
              ...
              localAppBrandMultiOptionsPickerV2.mil.add(localAppBrandOptionsPickerV3);
              localAppBrandMultiOptionsPickerV2.addView(localAppBrandOptionsPickerV3.mis.aGf(), new LinearLayout.LayoutParams(-1, -2, 1.0F));
              i += 1;
            }
            localAppBrandMultiOptionsPickerV2.buj();
          }
        }
        for (;;)
        {
          ...
          while (i < arrayOfa.length)
          {
            localAppBrandOptionsPickerV3 = localAppBrandMultiOptionsPickerV2.vm(i);
            Object localObject = arrayOfa[i];
            localAppBrandOptionsPickerV3.setOptionsArray(((AppBrandMultiOptionsPickerV2.a)localObject).mik);
            localAppBrandOptionsPickerV3.miu = ((AppBrandMultiOptionsPickerV2.a)localObject).selected;
            localObject = new AppBrandMultiOptionsPickerV2.1(localAppBrandMultiOptionsPickerV2, i);
            localAppBrandOptionsPickerV3.mis.a((com.tencent.mm.picker.d.b)localObject);
            i += 1;
          }
          if (i > arrayOfa.length) {
            localAppBrandMultiOptionsPickerV2.vl(i - arrayOfa.length);
          }
        }
