  ...
  extends b
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    {
      ae.e("MicroMsg.JsApiUpdateMapGroundOverlay", "data is null");
      paramc.h(paramInt, e("fail:invalid data", null));
      AppMethodBeat.o(206473);
      return;
    }
    ae.i("MicroMsg.JsApiUpdateMapGroundOverlay", "data:%s", new Object[] { paramJSONObject });
    com.tencent.mm.plugin.appbrand.jsapi.i.a.b localb = h(paramc, paramJSONObject);
    if (localb == null)
    {
      ae.e("MicroMsg.JsApiUpdateMapGroundOverlay", "mapView is null, return");
    ...
    try
    {
      ...
      {
        ae.i("MicroMsg.JsApiUpdateMapGroundOverlay", "updateGroundOverlay ok");
    ...
    {
      ae.i("MicroMsg.JsApiUpdateMapGroundOverlay", "");
      ae.e("MicroMsg.JsApiUpdateMapGroundOverlay", "parse update groundOverlay error, exception : %s", new Object[] { paramJSONObject });
      a(paramc, paramInt, e("fail:internal error", null), false, localb.blB());
      AppMethodBeat.o(206473);
      return;
    }
    ae.i("MicroMsg.JsApiUpdateMapGroundOverlay", "updateGroundOverlay fail");
