...
{
  public static final j.b lFs;
  private final com.tencent.mm.plugin.appbrand.g.b.c lFj;
  private final d.i.c lFk;
  final ArrayList<e> lFl;
  final ArrayList<e> lFm;
  d.g.a.a<d.z> lFn;
  final rx.f.b lFo;
  d.g.a.b<? super Boolean, d.z> lFp;
  private final d lFq;
  private final c lFr;
  ...
  static
  {
    ...
    cxA = new k[] { (k)d.g.b.z.a(new u(d.g.b.z.bp(j.class), "currentSelectedDevice", "getCurrentSelectedDevice()Lcom/tencent/mm/plugin/appbrand/dlna/device/MRDevice;")) };
    lFs = new j.b((byte)0);
  ...
  public j()
  {
    ...
    this.lFj = new com.tencent.mm.plugin.appbrand.g.b.c(null);
    Object localObject = d.i.a.Njd;
    localObject = this.lFj;
    this.lFk = ((d.i.c)new a(localObject, localObject, this));
  ...
  private void bqJ()
  {
    ...
    String str1 = g.Fy();
    String str2 = g.aE(ak.getContext());
    if ((w.isIPv6Address(str1)) && (w.isIPv6Address(str2))) {}
    for (boolean bool = true;; bool = false)
    {
      ae.i("MicroMsg.VideoCast.VideoCastDeviceManager", "searchDevice: selfIp = [%s], wifiIp = [%s], ipv6 = [%b]", new Object[] { str1, str2, Boolean.valueOf(bool) });
      this.lFo.b(d.a(TimeUnit.MILLISECONDS, Schedulers.computation()).gDr().a(com.tencent.mm.plugin.appbrand.g.d.a.bgm()).a((rx.b.b)new e(bool)));
  ...
  private static boolean bqL()
  {
    ...
    try
    {
      ...
      com.tencent.mm.plugin.appbrand.g.c.h.bgi().enable();
      com.tencent.mm.plugin.appbrand.g.c.c.bgd().enable();
      AppMethodBeat.o(220397);
      return true;
    }
    catch (com.tencent.mm.plugin.appbrand.g.c.c.a locala)
    {
      ae.e("MicroMsg.VideoCast.VideoCastDeviceManager", "prepareAndSearchDevice: RouterException = " + locala.getMessage());
      AppMethodBeat.o(220397);
    }
    return false;
  }
  
  public final com.tencent.mm.plugin.appbrand.g.b.c bqH()
  {
    AppMethodBeat.i(139797);
    com.tencent.mm.plugin.appbrand.g.b.c localc = (com.tencent.mm.plugin.appbrand.g.b.c)this.lFk.a(cxA[0]);
  ...
  public final void bqI()
  {
    ...
    ae.i("MicroMsg.VideoCast.VideoCastDeviceManager", "prepare");
    if (!bqL())
    {
      AppMethodBeat.o(139799);
      return;
    }
    com.tencent.mm.plugin.appbrand.g.b.a.bfS().a((a.a)this.lFr);
    bqJ();
    a(this);
    AppMethodBeat.o(139799);
  }
  ...
  public final void bqM()
  {
    ...
    Iterator localIterator = ((Iterable)this.lFl).iterator();
    e locale;
    label57:
    Object localObject2;
    label108:
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject1 = locale.lDX.bfV();
      if (localObject1 != null)
      {
        localObject1 = ((com.tencent.mm.plugin.appbrand.g.b.b)localObject1).kgj;
        localObject2 = bqH().bfV();
        if (localObject2 == null) {
          break label108;
        }
      }
      for (localObject2 = ((com.tencent.mm.plugin.appbrand.g.b.b)localObject2).kgj;; localObject2 = null)
      {
    ...
    localIterator = ((Iterable)this.lFm).iterator();
    label164:
    label215:
    label218:
    while (localIterator.hasNext())
  ...
  public final void clear()
  {
    ...
    try
    {
      ...
      this.lFm.clear();
      this.lFl.clear();
      com.tencent.mm.plugin.appbrand.g.b.a locala = com.tencent.mm.plugin.appbrand.g.b.a.bfS();
      locala.bfU();
      p.g(locala, "deviceManager");
      Iterator localIterator = locala.bfT().iterator();
      while (localIterator.hasNext())
      {
      ...
      localException.b((a.a)this.lFr);
    }
    catch (Exception localException)
    {
      ae.e("MicroMsg.VideoCast.VideoCastDeviceManager", "Error happen while cleaning up " + localException.getMessage());
      AppMethodBeat.o(139804);
      return;
    }
    localException.b((a.a)this.lFq);
    localException.destroy();
    try
    {
      com.tencent.mm.plugin.appbrand.g.c.h.bgi().disable();
      label153:
      com.tencent.mm.plugin.appbrand.g.c.c.bgd().disable();
      AppMethodBeat.o(139804);
      return;
    }
  ...
  public final void u(d.g.a.b<? super Boolean, d.z> paramb)
  {
    ...
    for (;;)
    {
      ae.i("MicroMsg.VideoCast.VideoCastDeviceManager", "reconnect: not enableRouter");
      ...
      try
      {
        ...
        label174:
        this.lFp = paramb;
        com.tencent.mm.plugin.appbrand.g.b.a.bfS().a((a.a)this.lFq);
        bqJ();
        a(this);
        AppMethodBeat.o(178860);
        return;
    ...
    extends d.i.b<com.tencent.mm.plugin.appbrand.g.b.c>
  {
    ...
    public final void a(k<?> paramk, com.tencent.mm.plugin.appbrand.g.b.c paramc1, com.tencent.mm.plugin.appbrand.g.b.c paramc2)
    {
      ...
      if (((p.i((com.tencent.mm.plugin.appbrand.g.b.c)paramc1, paramk) ^ true)) && (paramk.bfV() != null))
      {
        p.h(paramk, "$this$saveDevice");
        paramc1 = ay.fpb();
        com.tencent.e.h.MqF.aO((Runnable)new k.a(paramk, paramc1));
        paramc2 = ((Iterable)jdField_this.lFl).iterator();
        e locale;
        label133:
        label187:
        label190:
        while (paramc2.hasNext())
        {
          ...
          locale.gAg = false;
          paramk = locale.lDX.bfV();
          if (paramk != null)
          {
            paramk = paramk.kgj;
            paramc1 = jdField_this.bqH().bfV();
            if (paramc1 == null) {
              break label187;
            }
          }
          for (paramc1 = paramc1.kgj;; paramc1 = null)
          {
        ...
        paramc2 = ((Iterable)jdField_this.lFm).iterator();
        label258:
        label312:
        label315:
        while (paramc2.hasNext())
    ...
    implements a.a
  {
    public final void a(com.tencent.mm.plugin.appbrand.g.b.c paramc)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ae.i("MicroMsg.VideoCast.VideoCastDeviceManager", "onAddDevice: ".concat(String.valueOf(paramc)));
          p.h(paramc, "$this$isRecentDevice");
          localObject4 = ay.fpb();
          Object localObject1 = paramc.bfV();
          if (localObject1 != null)
          {
            localObject1 = ((com.tencent.mm.plugin.appbrand.g.b.b)localObject1).kgj;
            if (((ay)localObject4).getLong((String)localObject1, 0L) == 0L) {
              continue;
            }
            i = 1;
            if (i == 0) {
            ...
            localObject1 = (Iterable)this.lFt.lFm;
            ...
            localObject4 = ((e)((Iterator)localObject1).next()).lDX.bfV();
            if (localObject4 == null) {
              p.gkB();
            }
            localObject4 = ((com.tencent.mm.plugin.appbrand.g.b.b)localObject4).kgj;
            localb = paramc.bfV();
            if (localb == null) {
              p.gkB();
            }
            if (!p.i(localObject4, localb.kgj)) {
              continue;
            }
            i = j;
            if (i != 0) {
              this.lFt.lFm.add(new e(paramc));
            }
            localObject1 = this.lFt.lFn;
            if (localObject1 != null) {
              ((d.g.a.a)localObject1).invoke();
            }
            localObject1 = new StringBuilder("onAddDevice: ");
            localObject4 = paramc.bfV();
            paramc = localObject3;
            if (localObject4 != null) {
              paramc = ((com.tencent.mm.plugin.appbrand.g.b.b)localObject4).kgg;
            }
            ae.i("MicroMsg.VideoCast.VideoCastDeviceManager", paramc);
            AppMethodBeat.o(139788);
          }
        }
        catch (Exception localException)
        {
          ae.e("MicroMsg.VideoCast.VideoCastDeviceManager", "onAddDevice", new Object[] { localException });
          continue;
          localObject2 = null;
          continue;
          i = 0;
          ...
          i = 1;
          continue;
          localObject2 = (Iterable)this.lFt.lFl;
        ...
        if (!((Collection)localObject2).isEmpty())
        {
          ...
          do
          {
            ...
            localObject4 = ((e)((Iterator)localObject2).next()).lDX.bfV();
            if (localObject4 == null) {
              p.gkB();
            }
            localObject4 = ((com.tencent.mm.plugin.appbrand.g.b.b)localObject4).kgj;
          ...
          } while (!p.i(localObject4, localb.kgj));
        }
        for (int i = 0;; i = 1)
        {
          if (i == 0) {
    ...
    public final void b(com.tencent.mm.plugin.appbrand.g.b.c paramc)
    {
      ...
      p.h(paramc, "device");
      this.lFt.lFl.remove(new e(paramc));
      this.lFt.lFm.remove(new e(paramc));
      Object localObject = this.lFt.lFn;
      if (localObject != null) {
      ...
      paramc = paramc.bfV();
      if (paramc != null) {}
      for (paramc = paramc.kgg;; paramc = null)
      {
        ae.i("MicroMsg.VideoCast.VideoCastDeviceManager", paramc);
    ...
    public final void c(com.tencent.mm.plugin.appbrand.g.b.c paramc)
    {
      ...
      try
      {
        ae.i("MicroMsg.VideoCast.VideoCastDeviceManager", "onUpdateDevice: ".concat(String.valueOf(paramc)));
        AppMethodBeat.o(139790);
        return;
      }
      catch (Exception paramc)
      {
        ae.e("MicroMsg.VideoCast.VideoCastDeviceManager", "onUpdateDevice", new Object[] { paramc });
        AppMethodBeat.o(139790);
      }
    }
  }
    ...
    implements a.a
  {
    public final void a(com.tencent.mm.plugin.appbrand.g.b.c paramc)
    {
      ...
      if (paramc != null)
      {
        localObject1 = paramc.bfV();
        if (localObject1 != null)
        {
          localObject2 = ((com.tencent.mm.plugin.appbrand.g.b.b)localObject1).kgj;
      ...
      Object localObject1 = "";
      label32:
      ae.i("MicroMsg.VideoCast.VideoCastDeviceManager", "onAddDevice: udn = ".concat(String.valueOf(localObject1)));
      ...
      Object localObject2 = this.lFt.bqH().bfV();
      if (localObject2 != null) {}
      for (localObject2 = ((com.tencent.mm.plugin.appbrand.g.b.b)localObject2).kgj;; localObject2 = null)
      {
        if (p.i(localObject1, localObject2))
        {
          localObject1 = this.lFt.lFp;
          if (localObject1 != null) {
    ...
    public final void b(com.tencent.mm.plugin.appbrand.g.b.c paramc)
    {
      ...
      ae.i("MicroMsg.VideoCast.VideoCastDeviceManager", "reconnect: onRemoveDevice");
    ...
    public final void c(com.tencent.mm.plugin.appbrand.g.b.c paramc)
    {
      ...
      ae.i("MicroMsg.VideoCast.VideoCastDeviceManager", "reconnect: onUpdateDevice");
      AppMethodBeat.o(161191);
    }
  }
  
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"<anonymous>", "", "it", "", "kotlin.jvm.PlatformType", "call", "(Ljava/lang/Long;)V"})
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ad.e.a.j
