  ...
  extends d
{
  ...
  public final boolean c(final e parame, final int paramInt, View paramView, final JSONObject paramJSONObject)
  {
    ...
    ae.d("MicroMsg.JsApiUpdateScrollView", "onUpdateView(viewId : %s, %s)", new Object[] { Integer.valueOf(paramInt), paramJSONObject });
    if (!(paramView instanceof WxaScrollView))
    {
      ae.w("MicroMsg.JsApiUpdateScrollView", "the view(%s) is not a instance of WxaScrollView", new Object[] { Integer.valueOf(paramInt) });
    ...
    try
    {
      if (paramJSONObject.getBoolean("needScrollEvent")) {
        localWxaScrollView.setOnScrollChangedListener(new q()
        {
          public final void p(View paramAnonymousView, int paramAnonymousInt1, int paramAnonymousInt2)
          {
            ...
            Object localObject = parame.fF(paramJSONObject.optBoolean("independent", false)).H(paramInt, false);
            if (localObject == null)
            {
              AppMethodBeat.o(137544);
              return;
      ...
      for (;;)
      {
        ...
        if (paramJSONObject.has("scrollX"))
        {
          ...
          ae.i("MicroMsg.JsApiUpdateScrollView", "scrollHorizontal:%b", new Object[] { Boolean.valueOf(bool) });
          localWxaScrollView.setScrollHorizontal(bool);
        }
        if (paramJSONObject.has("scrollY"))
        {
          bool = paramJSONObject.optBoolean("scrollY", true);
          ae.i("MicroMsg.JsApiUpdateScrollView", "scrollVertical:%b", new Object[] { Boolean.valueOf(bool) });
        ...
        if (paramJSONObject.has("scrollTop"))
        {
          ...
          ae.i("MicroMsg.JsApiUpdateScrollView", "scrollTop:%d", new Object[] { Integer.valueOf(i) });
