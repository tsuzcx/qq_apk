...
public final class c
{
  public static void O(String paramString, int paramInt1, int paramInt2)
  {
    ...
    ad.i("MicroMsg.HCEReportManager", "alvinluo reportStartHCEResult appId: %s, result: %d, diff: %d", new Object[] { paramString, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
