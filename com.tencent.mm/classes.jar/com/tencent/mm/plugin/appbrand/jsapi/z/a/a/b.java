  ...
  extends a
{
  ...
  public final boolean a(final c paramc, final f paramf, final a parama)
  {
    ...
    o.b(String.valueOf(paramc.getAppId()), new android.support.v4.app.a.a()
    {
      public final void onRequestPermissionsResult(int paramAnonymousInt, String[] paramAnonymousArrayOfString, int[] paramAnonymousArrayOfInt)
      {
        ...
        if (paramAnonymousInt == 16)
        {
          ...
          {
            com.tencent.mm.plugin.appbrand.jsapi.camera.a.a.bfZ().kma = true;
          ...
          new i().h(paramc).LO(paramAnonymousArrayOfString).beN();
          com.tencent.mm.plugin.appbrand.jsapi.camera.a.a.bfZ().kma = false;
          AppMethodBeat.o(139416);
          return;
        }
        if (paramAnonymousInt == 18)
        {
          if ((paramAnonymousArrayOfInt != null) && (paramAnonymousArrayOfInt.length > 0) && (paramAnonymousArrayOfInt[0] == 0))
          {
            com.tencent.mm.plugin.appbrand.jsapi.camera.a.a.bfZ().kmb = true;
            b.this.a(paramc, paramf, parama);
            AppMethodBeat.o(139416);
            return;
          }
          ...
          paramAnonymousArrayOfString = new JSONObject(paramAnonymousArrayOfString).toString();
          new i().h(paramc).LO(paramAnonymousArrayOfString).beN();
          com.tencent.mm.plugin.appbrand.jsapi.camera.a.a.bfZ().kmb = false;
        }
        AppMethodBeat.o(139416);
      }
    });
    ...
    com.tencent.mm.plugin.appbrand.jsapi.camera.a.a.bfZ().kma = bool;
    if (!bool)
    {
      AppMethodBeat.o(139417);
      return false;
    ...
    com.tencent.mm.plugin.appbrand.jsapi.camera.a.a.bfZ().kmb = bool;
    if (!bool)
    {
      AppMethodBeat.o(139417);
      return false;
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.z.a.a.b
