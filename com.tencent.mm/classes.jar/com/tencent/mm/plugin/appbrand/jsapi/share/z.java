...
public final class z
{
  public static String a(com.tencent.luggage.sdk.b.a.c paramc, final String paramString, boolean paramBoolean)
  {
    ...
    if (Util.isNullOrNil(paramString))
    {
      ...
      paramString = paramc.getFileSystem().adN("share_" + System.nanoTime());
      if (paramString == null)
      {
        AppMethodBeat.o(46812);
        return null;
      ...
      if (paramc.R(com.tencent.luggage.game.page.d.class) != null)
      {
        a(paramc, paramString, paramc.ces());
        AppMethodBeat.o(46812);
        return paramString;
      }
      ...
      paramc.QQ().a(com.tencent.mm.vending.h.d.HEAVY_WORK, new d.b() {});
    ...
    {
      paramString = paramc.getFileSystem().adL(paramString);
      ...
      label254:
      for (paramc = (com.tencent.luggage.sdk.b.a.c)localObject;; paramc = "file://" + paramString.bOF())
      {
        AppMethodBeat.o(46812);
        return paramc;
      }
    ...
    if ((!paramString.startsWith("http://")) && (!paramString.startsWith("https://")))
    {
      ...
      paramc = com.tencent.mm.plugin.appbrand.page.aa.l(paramc.QM(), paramString);
  ...
  public static void a(String paramString1, int paramInt1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, int paramInt2, String paramString9, String paramString10, int paramInt3, String paramString11, int paramInt4, int paramInt5, String paramString12)
  {
    ...
    try
    {
      localObject2 = com.tencent.mm.compatible.util.q.an(Util.nullAsNil(paramString6), "UTF-8");
    ...
    catch (UnsupportedEncodingException paramString10)
    {
      try
      {
        str1 = com.tencent.mm.compatible.util.q.an(Util.nullAsNil(paramString7), "UTF-8");
        localObject2 = str1;
      }
      catch (UnsupportedEncodingException paramString10)
      {
        try
        {
          str1 = com.tencent.mm.compatible.util.q.an(Util.nullAsNil(paramString10), "UTF-8");
        }
        catch (UnsupportedEncodingException paramString10)
        {
          try
          {
            paramString11 = com.tencent.mm.compatible.util.q.an(Util.nullAsNil(paramString11), "UTF-8");
          }
          catch (UnsupportedEncodingException paramString10)
          {
            try
            {
              for (;;)
              {
                Object localObject2;
                String str1;
                str3 = com.tencent.mm.compatible.util.q.an(Util.nullAsNil(paramString5), "UTF-8");
                int j = paramInt3 + 1000;
                paramString5 = "";
                try
                {
                  String str4 = com.tencent.mm.compatible.util.q.an(Util.nullAsNil(paramString12), "UTF-8");
                  paramString10 = str4;
                  paramString5 = str4;
                  if (str4.length() >= 1024)
                  {
                ...
                catch (UnsupportedEncodingException paramString10)
                {
                  for (;;)
                  {
                    ...
                    continue;
                    paramInt3 = paramString5.pqV;
                    continue;
                    int i = paramString5.pqZ;
                  }
                }
                paramString5 = ab.aiE(paramString9);
                ...
                com.tencent.mm.plugin.report.service.h.IzE.a(14077, new Object[] { paramString1, Integer.valueOf(paramInt1), paramString2, paramString3, localObject2, paramString8, str3, localObject1, paramString9, "", Integer.valueOf(paramInt2), paramString4, str1, Integer.valueOf(j), paramString11, Integer.valueOf(paramInt4), Integer.valueOf(paramInt5), paramString10, Integer.valueOf(paramInt3), Integer.valueOf(i) });
                AppMethodBeat.o(277157);
                return;
  ...
  public static StringBuilder ck(String paramString, int paramInt)
  {
    AppMethodBeat.i(180275);
    int i = ((com.tencent.mm.plugin.appbrand.appstorage.a.a)com.tencent.mm.kernel.h.ae(com.tencent.mm.plugin.appbrand.appstorage.a.a.class)).aee(paramString);
