  ...
  implements com.tencent.luggage.k.a.a.a.b.a.b
{
  ...
  private void a(ar paramar, JSONObject paramJSONObject)
  {
    ...
    if ((!paramar.getName().equalsIgnoreCase("onXWebLivePusherEvent")) && (!paramar.getName().equalsIgnoreCase("onXWebLivePusherNetStatus"))) {
      ac.i("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "dispatch event:%s, data:%s", new Object[] { paramar.getName(), paramJSONObject.toString() });
    }
  ...
  public final void a(int paramInt1, int paramInt2, String paramString, HashMap<String, Object> paramHashMap)
  {
    ...
    try
    {
      ...
      localJSONObject.put("errMsg", bs.nullAsNil(paramString));
    ...
    {
      ac.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherError fail", new Object[] { paramString });
      AppMethodBeat.o(139525);
    }
  }
  ...
  public final void b(int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    {
      ac.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherEvent fail", new Object[] { paramBundle });
      AppMethodBeat.o(139520);
    }
  }
  ...
  public final void bV(int paramInt1, int paramInt2)
  {
    ...
    {
      ac.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherBGMComplete fail", new Object[] { localJSONException });
      AppMethodBeat.o(139524);
    }
  }
  ...
  public final void bW(int paramInt1, int paramInt2)
  {
    ...
    {
      ac.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherAudioVolume fail", new Object[] { localJSONException });
      AppMethodBeat.o(178856);
    }
  }
  ...
  public final void e(int paramInt, Bundle paramBundle)
  {
    ...
    {
      ac.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherNetStatus fail", new Object[] { paramBundle });
  ...
  public final void f(int paramInt, long paramLong1, long paramLong2)
  {
    ...
    {
      ac.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherBGMProgress fail", new Object[] { localJSONException });
      AppMethodBeat.o(139523);
    }
  }
  ...
  public final void gG(int paramInt)
  {
    ...
    {
      ac.e("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "onXWebLivePusherBGMStart fail", new Object[] { localJSONException });
      AppMethodBeat.o(139522);
    }
  }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.z.c.b.b
