...
public final class c
{
  ...
  public static NdefMessage N(Map<String, ? extends Object> paramMap)
  {
    int i = 0;
    Object localObject2 = null;
    AppMethodBeat.i(183700);
    p.h(paramMap, "messageMap");
    com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.AppBrand.NdefMessageConverter", "map2Message, messageMap: ".concat(String.valueOf(paramMap)));
    ...
    while (localIterator.hasNext())
    {
      ...
      com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.AppBrand.NdefMessageConverter", "map2Message, index: " + i + ", map: " + localMap);
      ...
      com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.AppBrand.NdefMessageConverter", "map2Message, byteBuffer: ".concat(String.valueOf(localObject1)));
      localCollection.add(a(u.R(localMap, localObject1)));
      i += 1;
    }
    paramMap = (List)localCollection;
    com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.AppBrand.NdefMessageConverter", "map2Message, records: ".concat(String.valueOf(paramMap)));
    try
    {
      paramMap = ((Collection)paramMap).toArray(new NdefRecord[0]);
      if (paramMap == null)
      {
        paramMap = new v("null cannot be cast to non-null type kotlin.Array<T>");
        AppMethodBeat.o(183700);
        throw paramMap;
      }
    }
    ...
    {
      com.tencent.mm.sdk.platformtools.ae.w("MicroMsg.AppBrand.NdefMessageConverter", "create NdefMessage failed since ".concat(String.valueOf(paramMap)));
  ...
  private static NdefRecord a(o<? extends Map<String, ? extends Object>, ? extends ByteBuffer> paramo)
  {
    ...
    com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.AppBrand.NdefMessageConverter", "recordMap2Record, recordMap: ".concat(String.valueOf(paramo)));
    ...
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          paramo = new NdefRecord((short)i, paramo, (byte[])localObject1, d.p(localByteBuffer));
      ...
      catch (Exception paramo)
      {
        for (;;)
        {
          com.tencent.mm.sdk.platformtools.ae.w("MicroMsg.AppBrand.NdefMessageConverter", "recordMap2Record failed since ".concat(String.valueOf(paramo)));
          paramo = localObject2;
        }
      }
    }
  ...
  private static o<List<Map<String, Object>>, List<ByteBuffer>> a(NdefMessage paramNdefMessage)
  {
    ...
    com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.AppBrand.NdefMessageConverter", "message2MessageMap, message: ".concat(String.valueOf(paramNdefMessage)));
    paramNdefMessage = paramNdefMessage.getRecords();
    p.g(paramNdefMessage, "message.records");
    ...
    while (i < j)
    {
      ...
      p.g(localObject2, "it");
      com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.AppBrand.NdefMessageConverter", "record2RecordMap, record: ".concat(String.valueOf(localObject2)));
      Object localObject3 = u.R("tnf", Short.valueOf(((NdefRecord)localObject2).getTnf()));
      Object localObject4 = Base64.encode(((NdefRecord)localObject2).getType(), 2);
      p.g(localObject4, "Base64.encode(record.type, Base64.NO_WRAP)");
      Object localObject5 = StandardCharsets.UTF_8;
      p.g(localObject5, "StandardCharsets.UTF_8");
      localObject4 = u.R("type", new String((byte[])localObject4, (Charset)localObject5));
      localObject5 = Base64.encode(((NdefRecord)localObject2).getId(), 2);
      p.g(localObject5, "Base64.encode(record.id, Base64.NO_WRAP)");
      Charset localCharset = StandardCharsets.UTF_8;
      p.g(localCharset, "StandardCharsets.UTF_8");
      localObject3 = d.a.ae.a(new o[] { localObject3, localObject4, u.R("id", new String((byte[])localObject5, localCharset)) });
      com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.AppBrand.NdefMessageConverter", "record2RecordMap, map: ".concat(String.valueOf(localObject3)));
      ((Collection)localObject1).add(u.R(localObject3, x.ay(((NdefRecord)localObject2).getPayload())));
      i += 1;
    }
    ...
    paramNdefMessage = u.R(localObject1, (List)paramNdefMessage);
    com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.AppBrand.NdefMessageConverter", "message2MessageMap, messageMap: ".concat(String.valueOf(paramNdefMessage)));
    AppMethodBeat.o(183703);
    return paramNdefMessage;
  }
  
  public static Map<String, Object> bs(List<NdefMessage> paramList)
  {
    AppMethodBeat.i(183699);
    p.h(paramList, "messages");
    com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.AppBrand.NdefMessageConverter", "messages2Map, messages: ".concat(String.valueOf(paramList)));
    ...
    paramList = d.a.ae.b(new o[] { u.R("messages", (List)paramList) });
    localObject1 = ((Iterable)localObject1).iterator();
    int i = 0;
    while (((Iterator)localObject1).hasNext())
    {
    ...
    com.tencent.mm.sdk.platformtools.ae.d("MicroMsg.AppBrand.NdefMessageConverter", "messages2Map, map: ".concat(String.valueOf(paramList)));
    AppMethodBeat.o(183699);
    return paramList;
  }
  
  public static NdefMessage bt(List<String> paramList)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      {
        com.tencent.mm.sdk.platformtools.ae.w("MicroMsg.AppBrand.NdefMessageConverter", "createUri failed since ".concat(String.valueOf(paramList)));
    ...
    if (paramList == null)
    {
      paramList = new v("null cannot be cast to non-null type kotlin.Array<T>");
      AppMethodBeat.o(183701);
      throw paramList;
    }
    ...
    catch (Exception paramList)
    {
      for (;;)
      {
        com.tencent.mm.sdk.platformtools.ae.w("MicroMsg.AppBrand.NdefMessageConverter", "create NdefMessage failed since ".concat(String.valueOf(paramList)));
        paramList = null;
      }
    }
  }
  
  public static NdefMessage bu(List<? extends Map<String, String>> paramList)
  {
    AppMethodBeat.i(183702);
    p.h(paramList, "textAndLanguages");
    Object localObject1 = (Iterable)paramList;
    paramList = (Collection)new ArrayList(j.a((Iterable)localObject1, 10));
    localObject1 = ((Iterable)localObject1).iterator();
    while (((Iterator)localObject1).hasNext())
    {
      ...
      {
        com.tencent.mm.sdk.platformtools.ae.w("MicroMsg.AppBrand.NdefMessageConverter", "createTextRecord failed since ".concat(String.valueOf(paramList)));
        AppMethodBeat.o(183702);
        return null;
      }
    }
