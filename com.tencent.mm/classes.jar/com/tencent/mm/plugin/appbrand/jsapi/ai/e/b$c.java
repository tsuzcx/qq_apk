...
@l(iBK={1, 1, 16}, iBL={""}, iBM={"Lcom/tencent/mm/plugin/appbrand/jsapi/xwebplugin/video/AppBrandVideoCastHandler$Companion;", "", "()V", "TAG", "", "getFormatTime", "timeMs", "", "getMsTime", "", "formatTime", "luggage-xweb-ext_release"})
public final class b$c
{
  public static String Bu(int paramInt)
  {
    ...
    p.j(localObject, "formatter.format(\"%02d:%…utes, seconds).toString()");
    AppMethodBeat.o(139655);
    return localObject;
  }
  
  public static long ajI(String paramString)
  {
    ...
    localObject = new k(":").u((CharSequence)localObject, 0);
    ...
    for (localObject = j.c((Iterable)localObject, localListIterator.nextIndex() + 1);; localObject = (List)v.aaAd)
    {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ai.e.b.c
