  ...
  extends b
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    {
      ae.e("MicroMsg.JsApiSetMapCenterOffset", "data is null");
      paramc.h(paramInt, e("fail:invalid data", null));
      AppMethodBeat.o(143691);
      return;
    }
    ae.i("MicroMsg.JsApiSetMapCenterOffset", "data:%s", new Object[] { paramJSONObject });
    com.tencent.mm.plugin.appbrand.jsapi.i.a.b localb = h(paramc, paramJSONObject);
    if (localb == null)
    {
      ae.e("MicroMsg.JsApiSetMapCenterOffset", "mapView is null, return");
    ...
    catch (JSONException paramJSONObject)
    {
      for (;;)
      {
        ae.e("MicroMsg.JsApiSetMapCenterOffset", "parse offset err:%s", new Object[] { paramJSONObject });
      }
    }
  }
}
