  ...
  extends a
{
  ...
  public final void B(MotionEvent paramMotionEvent)
  {
    ...
    if (this.oWp != null) {
      this.oWp.onTouchEvent(paramMotionEvent);
    }
    AppMethodBeat.o(139540);
  }
  
  public final TencentMapOptions I(Map<String, Object> paramMap)
  {
    AppMethodBeat.i(139539);
    TencentMapOptions localTencentMapOptions = super.I(paramMap);
    if (paramMap != null)
    {
  ...
  public final void h(SurfaceTexture paramSurfaceTexture)
  {
    ...
    if ((paramSurfaceTexture != null) && (this.mSurfaceTexture != paramSurfaceTexture))
    {
      ...
      this.oWp.onSurfaceChanged(this.mSurfaceTexture, this.mWidth, this.mHeight);
      this.mSurfaceTexture.setDefaultBufferSize(this.mWidth, this.mHeight);
  ...
  public final void onSizeChanged(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      this.oWp.onSizeChanged(paramInt1, paramInt2, paramInt1, paramInt2);
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ai.d.b
