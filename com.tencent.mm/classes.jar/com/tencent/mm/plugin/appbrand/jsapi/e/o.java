  ...
  extends a
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    try
    {
      f1 = bt.getFloat(paramJSONObject.optString("latitude"), 0.0F);
      f2 = bt.getFloat(paramJSONObject.optString("longitude"), 0.0F);
      localObject = e.Nl(paramJSONObject.optString("name"));
      str = e.Nl(paramJSONObject.optString("address"));
    }
    ...
    try
    {
      j = bt.getInt(paramJSONObject.optString("scale"), 0);
      i = j;
    }
    catch (Exception paramJSONObject)
    {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.e.o
