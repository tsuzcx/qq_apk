  ...
  extends b
{
  ...
  private List<Runnable> oWl;
  private AtomicBoolean oWm;
  
  public ag()
  {
    AppMethodBeat.i(143695);
    this.oWl = new ArrayList();
    this.oWm = new AtomicBoolean(false);
  ...
  private void bSy()
  {
    for (;;)
    {
      try
      {
        ...
        localRunnable = (Runnable)this.oWl.remove(0);
      }
      finally {}
      Runnable localRunnable;
      if (localRunnable != null) {
        m.clV().postToWorker(localRunnable);
      }
      AppMethodBeat.o(143697);
    }
  }
  ...
  public final void a(final e parame, final JSONObject paramJSONObject, final int paramInt)
  {
    ...
    parame = new Runnable()
    {
      public final void run()
      {
        ...
        ag.this.d(parame, paramJSONObject, paramInt);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < paramJSONObject.length())
        {
          ...
          {
            localh.oYk = ((float)((JSONObject)localObject).optDouble("rotate", 0.0D));
      ...
      localb.a(str1, localLinkedList, new b.r()
      {
        ...
        public final void il(boolean paramAnonymousBoolean)
        {
          ...
          {
            ag.a(ag.this, parame, paramInt, "ok", localb.bSF());
            AppMethodBeat.o(143694);
            return;
          }
          ag.a(ag.this, parame, paramInt, "fail", localb.bSF());
          AppMethodBeat.o(143694);
        }
      });
      AppMethodBeat.o(143698);
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.l.ag
