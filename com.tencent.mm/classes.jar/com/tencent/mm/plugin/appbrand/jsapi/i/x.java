  ...
  extends c
{
  ...
  public final boolean b(com.tencent.mm.plugin.appbrand.jsapi.e parame, int paramInt, View paramView, JSONObject paramJSONObject)
  {
    ...
    {
      ae.e("MicroMsg.JsApiRemoveMap", "data is null");
      AppMethodBeat.o(143688);
      return false;
    }
    com.tencent.mm.plugin.appbrand.jsapi.i.a.e.tk(6);
    if (g.dl(parame.getAppId(), f.i(parame, paramJSONObject))) {
      com.tencent.mm.plugin.appbrand.jsapi.i.a.e.tk(7);
    }
    for (;;)
    {
      AppMethodBeat.o(143688);
      return true;
      com.tencent.mm.plugin.appbrand.jsapi.i.a.e.tk(8);
    }
  }
}
