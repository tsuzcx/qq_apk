  ...
  extends a
{
  ...
  public final TencentMapOptions M(Map<String, Object> paramMap)
  {
    AppMethodBeat.i(139539);
    TencentMapOptions localTencentMapOptions = super.M(paramMap);
    if (paramMap != null)
    {
    ...
    for (Object localObject = (SurfaceTexture)localObject;; localObject = null)
    {
      ...
      {
        ae.e("MicroMsg.SameLayerMapView", "mSurface is null, return");
      ...
      ae.i("MicroMsg.SameLayerMapView", "handler insert, position:[%d, %d]", new Object[] { Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight) });
  ...
  public final void g(SurfaceTexture paramSurfaceTexture)
  {
    ...
    if ((paramSurfaceTexture != null) && (this.mSurfaceTexture != paramSurfaceTexture))
    {
      ...
      this.kTr.onSurfaceChanged(this.mSurfaceTexture, this.mWidth, this.mHeight);
      this.mSurfaceTexture.setDefaultBufferSize(this.mWidth, this.mHeight);
  ...
  public final void onSizeChanged(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      this.kTr.onSizeChanged(paramInt1, paramInt2, paramInt1, paramInt2);
      AppMethodBeat.o(139541);
      return;
    }
    catch (Exception localException)
    {
      ae.e("MicroMsg.SameLayerMapView", "onSizeChanged :%s", new Object[] { localException });
  ...
  public final void onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (this.kTr != null) {
      this.kTr.onTouchEvent(paramMotionEvent);
    }
    AppMethodBeat.o(139540);
  }
}
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ad.d.b
