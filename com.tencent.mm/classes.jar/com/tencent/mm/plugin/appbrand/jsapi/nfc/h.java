    ...
    a(new JsApiAppBrandNFCBase.a()
    {
      public final void onResult(int paramAnonymousInt, String paramAnonymousString)
      {
        ...
        if (paramAnonymousInt == 0)
        {
          ...
          HCEEventLogic.abk(((f)localObject).getAppId());
          HCEEventLogic.a(((f)localObject).getAppId(), 13, null);
          HashMap localHashMap = new HashMap(2);
          localHashMap.put("errCode", Integer.valueOf(0));
          h.a((f)localObject, paramAnonymousInt, j.a(paramAnonymousString, 0, "ok", localHashMap));
          AppMethodBeat.o(136118);
          return;
        }
        h.a(paramf, paramInt, j.a(h.this, paramAnonymousInt, "fail: ".concat(String.valueOf(paramAnonymousString)), (Map)localObject));
        AppMethodBeat.o(136118);
      }
    });
