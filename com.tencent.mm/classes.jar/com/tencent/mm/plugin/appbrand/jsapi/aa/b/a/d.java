  ...
  public d(Context paramContext, IXWebWorkingHandler paramIXWebWorkingHandler, int paramInt1, String paramString, int paramInt2, int paramInt3)
  {
    ...
    setSurfaceTextureListener(new TextureView.SurfaceTextureListener()
    {
      public final void onSurfaceTextureAvailable(SurfaceTexture paramAnonymousSurfaceTexture, int paramAnonymousInt1, int paramAnonymousInt2)
      {
        ...
        ad.i("Luggage.SkiaCanvasTextureView", "surface:%s width:%d height:%d viewId%d", new Object[] { paramAnonymousSurfaceTexture, Integer.valueOf(paramAnonymousInt1), Integer.valueOf(paramAnonymousInt2), Integer.valueOf(d.c(d.this)) });
        if (d.a(d.this) == null)
        {
      ...
      public final boolean onSurfaceTextureDestroyed(SurfaceTexture paramAnonymousSurfaceTexture)
      {
        ...
        ad.i("Luggage.SkiaCanvasTextureView", "onSurfaceTextureDestroyed:%s", new Object[] { paramAnonymousSurfaceTexture });
        if (d.a(d.this) != null) {
          d.a(d.this).recycle();
        }
      ...
      public final void onSurfaceTextureSizeChanged(SurfaceTexture paramAnonymousSurfaceTexture, int paramAnonymousInt1, int paramAnonymousInt2)
      {
        ...
        ad.i("Luggage.SkiaCanvasTextureView", "onSurfaceTextureSizeChanged:%s width:%d height:%d viewId%d", new Object[] { paramAnonymousSurfaceTexture, Integer.valueOf(paramAnonymousInt1), Integer.valueOf(paramAnonymousInt2), Integer.valueOf(d.c(d.this)) });
        if (d.a(d.this) != null) {
          d.a(d.this).notifyTextureSizeChanged(g.ul(paramAnonymousInt1), g.ul(paramAnonymousInt2));
        }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.aa.b.a.d
