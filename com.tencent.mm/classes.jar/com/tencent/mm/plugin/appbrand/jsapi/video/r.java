...
public final class r
{
  ...
  private static int biU()
  {
    ...
    try
    {
      ...
      j = i;
      ac.d("MicroMsg.VideoPlayerUtils", "getMaxBrightness %d", new Object[] { Integer.valueOf(i) });
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ac.i("MicroMsg.VideoPlayerUtils", "get max brightness fail, fallback to 255");
        int i = j;
      }
    }
  ...
  private static float dw(Context paramContext)
  {
    ...
    catch (Settings.SettingNotFoundException paramContext)
    {
      for (;;)
      {
        ac.printErrStackTrace("MicroMsg.VideoPlayerUtils", paramContext, "", new Object[0]);
      }
    }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.video.r
