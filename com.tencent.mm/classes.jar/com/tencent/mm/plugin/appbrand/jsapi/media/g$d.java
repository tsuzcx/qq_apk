  ...
  implements g.c
{
  public final g.a a(c paramc, String paramString, int paramInt)
  {
    ...
    InputStream localInputStream = ax.f(((r)paramc).getRuntime(), paramString);
    ...
    try
    {
      ...
      localBitmap = d.a.a((d)paramc.q(d.class)).b(localInputStream, localOptions);
      if (localBitmap == null)
      {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.media.g.d
