  ...
  extends b
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    {
      ac.e("MicroMsg.JsApiIncludeMapPoints", "data is null");
      paramc.h(paramInt, e("fail:invalid data", null));
      AppMethodBeat.o(143670);
      return;
    }
    ac.i("MicroMsg.JsApiIncludeMapPoints", "data:%s", new Object[] { paramJSONObject });
    com.tencent.mm.plugin.appbrand.jsapi.f.a.b localb = h(paramc, paramJSONObject);
    if (localb == null)
    {
      ac.e("MicroMsg.JsApiIncludeMapPoints", "mapView is null, return");
    ...
    {
      ac.e("MicroMsg.JsApiIncludeMapPoints", "parse points error, exception : %s", new Object[] { paramJSONObject });
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.f.p
