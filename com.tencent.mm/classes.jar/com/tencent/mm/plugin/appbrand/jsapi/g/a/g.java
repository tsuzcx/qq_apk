...
{
  private static Map<String, HashMap<String, b>> hPY;
  private static Set<b> hPZ;
  private static Set<b> hQa;
  public static a hQb;
  private static Runnable hQc;
  ...
  public static boolean a(String paramString1, String paramString2, b paramb)
  {
    ...
    //   17: ldc 62
    //   19: ldc 93
    //   21: invokestatic 97	com/tencent/mm/sdk/platformtools/ab:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   24: ldc 84
    ...
    //   34: iload_3
    //   35: ireturn
    //   36: getstatic 39	com/tencent/mm/plugin/appbrand/jsapi/g/a/g:hPY	Ljava/util/Map;
    //   39: aload_0
    //   40: invokeinterface 103 2 0
    //   45: checkcast 34	java/util/HashMap
    //   48: astore 5
    //   50: aload 5
    //   52: astore 4
    //   54: aload 5
    //   56: ifnonnull +24 -> 80
    //   59: new 34	java/util/HashMap
    //   62: dup
    //   63: invokespecial 37	java/util/HashMap:<init>	()V
    //   66: astore 4
    //   68: getstatic 39	com/tencent/mm/plugin/appbrand/jsapi/g/a/g:hPY	Ljava/util/Map;
    //   71: aload_0
    //   72: aload 4
    ...
    //   89: ldc 62
    //   91: ldc 112
    //   93: invokestatic 115	com/tencent/mm/sdk/platformtools/ab:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   96: ldc 84
    ...
    //   128: aload_1
    //   129: aastore
    //   130: invokestatic 69	com/tencent/mm/sdk/platformtools/ab:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   133: ldc 84
  ...
  /* Error */
  public static b cl(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   68: checkcast 142	com/tencent/mm/plugin/appbrand/jsapi/g/a/b
    //   71: astore_0
    //   72: ldc 160
  ...
  public static boolean cm(String paramString1, String paramString2)
  {
    ...
    //   3: ldc 166
    //   5: invokestatic 32	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   8: getstatic 39	com/tencent/mm/plugin/appbrand/jsapi/g/a/g:hPY	Ljava/util/Map;
    //   11: aload_0
    //   12: invokeinterface 103 2 0
    //   17: checkcast 34	java/util/HashMap
    //   20: astore_3
    //   21: aload_3
    //   22: ifnonnull +15 -> 37
    //   25: ldc 166
    ...
    //   42: checkcast 142	com/tencent/mm/plugin/appbrand/jsapi/g/a/b
    //   45: astore 4
    //   47: aload 4
    //   49: ifnonnull +20 -> 69
    //   52: ldc 62
    //   54: ldc 168
    //   56: invokestatic 97	com/tencent/mm/sdk/platformtools/ab:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   59: ldc 166
    ...
    //   79: aload 4
    //   81: aastore
    //   82: invokestatic 69	com/tencent/mm/sdk/platformtools/ab:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   85: aload_3
    //   86: aload_1
    ...
    //   100: ifgt +13 -> 113
    //   103: getstatic 39	com/tencent/mm/plugin/appbrand/jsapi/g/a/g:hPY	Ljava/util/Map;
    //   106: aload_0
    //   107: invokeinterface 176 2 0
    //   112: pop
    //   113: getstatic 49	com/tencent/mm/plugin/appbrand/jsapi/g/a/g:hPZ	Ljava/util/Set;
    //   116: aload 4
    //   118: invokeinterface 75 2 0
    //   123: pop
    //   124: getstatic 54	com/tencent/mm/plugin/appbrand/jsapi/g/a/g:hQc	Ljava/lang/Runnable;
    //   127: invokestatic 182	com/tencent/mm/sdk/platformtools/al:ae	(Ljava/lang/Runnable;)V
    //   130: getstatic 54	com/tencent/mm/plugin/appbrand/jsapi/g/a/g:hQc	Ljava/lang/Runnable;
    //   133: ldc2_w 183
    //   136: invokestatic 188	com/tencent/mm/sdk/platformtools/al:p	(Ljava/lang/Runnable;J)V
    //   139: ldc 62
    //   141: ldc 190
    //   143: iconst_2
    ...
    //   160: aastore
    //   161: invokestatic 69	com/tencent/mm/sdk/platformtools/ab:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   164: ldc 166
  ...
  private static void init()
  {
    try
    {
      ...
      {
        hQb = new a();
        Object localObject1 = (SensorManager)ah.getContext().getSystemService("sensor");
        sensorManager = (SensorManager)localObject1;
        localObject1 = ((SensorManager)localObject1).getDefaultSensor(3);
        sensorManager.registerListener(hQb, (Sensor)localObject1, 1);
      }
  ...
  private static void uninit()
  {
    try
    {
      ...
      if ((hQb != null) && (sensorManager != null))
      {
        ab.i("MicroMsg.AppBrandMapManager", "sensorListener uninit");
        sensorManager.unregisterListener(hQb);
        sensorManager = null;
        hQb = null;
      }
    ...
    implements SensorEventListener
  {
    ...
    public final void onSensorChanged(SensorEvent arg1)
    {
      ...
      if (???.sensor.getType() == 3)
      {
        ...
        float f = f.av(???.values[0]);
        if ((l1 - l2 > 200L) && (Math.abs(f - this.hQd) > 3.0F))
        {
          synchronized (g.ajx())
          {
            Iterator localIterator1 = g.ajx().values().iterator();
            b localb;
            do
            {
