...
import com.tencent.mm.plugin.cloudvoip.cloudvoice.d.p.10;
  ...
  extends h
{
  ...
  public j()
  {
    ...
    com.tencent.mm.plugin.appbrand.permission.c.Qk("subscribeVoIPMembers");
  ...
  public final void a(final com.tencent.mm.plugin.appbrand.service.c paramc, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    ac.i(TAG, "hy: appId:" + (String)localObject + ", parmas:" + paramJSONObject.toString());
    localObject = p.otZ;
    ((p)localObject).ag(new p.10((p)localObject, paramJSONObject, new b() {}));
    AppMethodBeat.o(180258);
  }
}
