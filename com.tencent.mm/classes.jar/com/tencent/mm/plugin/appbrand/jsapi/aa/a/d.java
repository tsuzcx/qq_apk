  ...
  extends a
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    for (paramJSONObject = paramJSONObject.toString();; paramJSONObject = "")
    {
      ...
      ((List)localObject).add(c.a.lug.lun);
      ((List)localObject).add(c.a.luh.lun);
      ((List)localObject).add(c.a.lui.lun);
      ((List)localObject).add(c.a.luj.lun);
      ((List)localObject).add(c.a.luk.lun);
      if (com.tencent.mm.compatible.util.d.ly(24)) {
        ((List)localObject).add(c.a.lul.lun);
      }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.aa.a.d
