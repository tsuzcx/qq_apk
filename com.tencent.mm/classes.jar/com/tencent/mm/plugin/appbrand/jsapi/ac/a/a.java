...
import com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.b.1;
import com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.b.2;
import com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.b.a;
import com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.d;
...
{
  public static a lxa;
  com.tencent.mm.plugin.appbrand.jsapi.c cnl;
  com.tencent.mm.plugin.appbrand.jsapi.camera.g lwZ;
  List<Runnable> lxb;
  ...
  final void a(com.tencent.mm.plugin.appbrand.jsapi.c paramc, JSONObject paramJSONObject, m paramm, int paramInt)
  {
    for (;;)
    {
      try
      {
        ...
        com.tencent.mm.plugin.appbrand.jsapi.camera.g localg = this.lwZ;
        ...
        else
        {
          ...
          if ((localObject != null) && (((JSONArray)localObject).length() == 4))
          {
            ...
            localg.x(com.tencent.mm.plugin.appbrand.z.g.vJ(((JSONArray)localObject).optInt(0)), com.tencent.mm.plugin.appbrand.z.g.vJ(((JSONArray)localObject).optInt(1)), com.tencent.mm.plugin.appbrand.z.g.vJ(((JSONArray)localObject).optInt(2)), com.tencent.mm.plugin.appbrand.z.g.vJ(((JSONArray)localObject).optInt(3)));
          }
  ...
  public final void e(SurfaceTexture paramSurfaceTexture)
  {
    ...
    ad.i("MicroMsg.AppBrand.SameLayer.AppBrandCameraPluginHandler", "preTask size: %d", new Object[] { Integer.valueOf(this.lxb.size()) });
    paramSurfaceTexture = this.lxb.iterator();
  ...
  public final String h(final com.tencent.luggage.xweb_ext.extendplugin.a parama)
  {
    ...
    if ((parama instanceof com.tencent.mm.plugin.appbrand.h.b))
    {
      ...
      ad.i("MicroMsg.AppBrand.SameLayer.AppBrandCameraPluginHandler", "*** handler(%s) handleJsApi(%s), data:%s", new Object[] { BM(), localm.getName(), localJSONObject.toString() });
      localc.M(new Runnable()
      {
        public final void run()
        {
          ...
          int j;
          int i;
          if ((localm instanceof com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.b))
          {
            ...
            ((a)localObject2).lwZ = ((com.tencent.mm.plugin.appbrand.jsapi.camera.g)a.lxa.dq((Context)localObject5));
            Object localObject8;
            Object localObject7;
            String str4;
            if ((localObject3 instanceof e))
            {
              ...
              localObject8 = (com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.b)localObject6;
              localObject7 = ((a)localObject2).lwZ;
              Object localObject9 = ((a)localObject2).mSurfaceTexture;
              ((com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.b)localObject8).kIf = false;
              ...
              default: 
                ...
                default: 
                  ...
                  {
                    localObject9 = af.f((aa)localObject5);
                  ...
                  if ((localObject9 != null) && (((JSONArray)localObject9).length() == 4))
                  {
                    ...
                    ((com.tencent.mm.plugin.appbrand.jsapi.camera.g)localObject7).x(com.tencent.mm.plugin.appbrand.z.g.vJ(((JSONArray)localObject9).optInt(0)), com.tencent.mm.plugin.appbrand.z.g.vJ(((JSONArray)localObject9).optInt(1)), com.tencent.mm.plugin.appbrand.z.g.vJ(((JSONArray)localObject9).optInt(2)), com.tencent.mm.plugin.appbrand.z.g.vJ(((JSONArray)localObject9).optInt(3)));
                    label586:
                    ...
                    localObject1 = (com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.b)localObject6;
                    localObject7 = ((a)localObject2).lwZ;
            ...
            for (;;)
            {
              ((com.tencent.mm.plugin.appbrand.jsapi.c)localObject3).M(new a.4((a)localObject2, (e)localObject5));
              ...
              break label689;
              label889:
              ((com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.b)localObject1).a((com.tencent.mm.plugin.appbrand.jsapi.c)localObject5, (f)localObject7, (b.a)localObject6);
              com.tencent.mm.plugin.appbrand.jsapi.camera.a.a.bjD().a(((f)localObject7).getCameraId(), (f)localObject7);
              ...
              com.tencent.mm.plugin.appbrand.g.a(((e)localObject5).getAppId(), new b.1((com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.b)localObject1, (WeakReference)localObject6, (e)localObject5));
              ((f)localObject7).setOutPutCallBack(new b.2((com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.b)localObject1));
            }
          }
          ...
          if ((localm instanceof com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.c))
          {
            ...
            localObject2 = localm;
            j = i;
            localObject3 = ((a)localObject3).lwZ;
      ...
      }
      {
        public final void run()
        {
          ...
          if ((a.this.mSurfaceTexture == null) && ((localm instanceof com.tencent.mm.plugin.appbrand.jsapi.ac.a.a.b)))
          {
            a.this.lxb.add(this.val$runnable);
