  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    if (paramJSONObject == null)
    {
      ...
      ac.w("MicroMsg.JsApiCheckNetworkAPIURL", "data is null");
    ...
    {
      ac.w("MicroMsg.JsApiCheckNetworkAPIURL", "invalid api:%s,url:%s", new Object[] { str, paramJSONObject });
    ...
    {
      bool = j.b(((com.tencent.mm.plugin.appbrand.p.a)localObject).ccE, paramJSONObject, false);
      localObject = (String)j.Pm(paramJSONObject).get("host");
      if (bs.isNullOrNil((String)localObject)) {
        break label574;
      }
      ac.i("MicroMsg.JsApiCheckNetworkAPIURL", "ipHost:%s", new Object[] { localObject });
    }
    label267:
    label574:
    for (int i = j.Po((String)localObject);; i = 0)
    {
      ac.i("MicroMsg.JsApiCheckNetworkAPIURL", "checkRet:%b,ipCheckRet:%d,api:%s,url:%s", new Object[] { Boolean.valueOf(bool), Integer.valueOf(i), str, paramJSONObject });
      if (bool)
      {
      ...
      for (;;)
      {
        ...
        {
          bool = j.b(((com.tencent.mm.plugin.appbrand.p.a)localObject).ccF, paramJSONObject, ((com.tencent.mm.plugin.appbrand.p.a)localObject).ccA);
          break;
        }
        if (str.equalsIgnoreCase("downloadFile"))
        {
          bool = j.b(((com.tencent.mm.plugin.appbrand.p.a)localObject).ccH, paramJSONObject, false);
          break;
        }
        if (str.equalsIgnoreCase("uploadFile"))
        {
          bool = j.b(((com.tencent.mm.plugin.appbrand.p.a)localObject).ccG, paramJSONObject, false);
          break;
        }
        if (str.equalsIgnoreCase("udp"))
        {
          bool = j.b(((com.tencent.mm.plugin.appbrand.p.a)localObject).ccI, paramJSONObject, false);
          break;
        }
        ac.w("MicroMsg.JsApiCheckNetworkAPIURL", "hy: unknown api: %s", new Object[] { str });
        localHashMap.put("isValid", Boolean.FALSE);
