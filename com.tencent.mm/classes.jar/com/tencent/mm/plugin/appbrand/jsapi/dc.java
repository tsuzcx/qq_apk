...
@l(iBK={1, 1, 16}, iBL={""}, iBM={"TAG", "", "parseFileName", "filePath", "fileExt", "fileName", "plugin-appbrand-integration_release"})
public final class dc
{
  public static final String E(String paramString1, String paramString2, String paramString3)
  {
    ...
    paramString3 = new StringBuilder().append(new q(paramString1).getName());
