  ...
  implements com.tencent.luggage.xweb_ext.extendplugin.component.a.b.a.b
{
  ...
  private void a(at paramat, JSONObject paramJSONObject)
  {
    ...
    if ((!paramat.getName().equalsIgnoreCase("onXWebLivePusherEvent")) && (!paramat.getName().equalsIgnoreCase("onXWebLivePusherNetStatus"))) {
      ad.i("MicroMsg.SameLayer.AppBrandLivePusherEventHandler", "dispatch event:%s, data:%s", new Object[] { paramat.getName(), paramJSONObject.toString() });
    }
    ...
    if (this.lxU != null)
    {
      ...
      if (paramJSONObject != null)
      {
        ...
        {
          ((q)paramJSONObject).b(paramat);
          AppMethodBeat.o(139526);
          return;
        }
        if ((paramJSONObject instanceof aa))
        {
          ((aa)paramJSONObject).b(paramat);
          AppMethodBeat.o(139526);
          return;
        }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.ac.c.b.b
