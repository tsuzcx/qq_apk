...
{
  f$5(f paramf, WeakReference paramWeakReference, int paramInt, String paramString) {}
  ...
  public final void onBackspacePressedWhileValueNoChange(String paramString)
  {
    ...
    try
    {
      int i = getInputId();
      f.a locala = new f.a();
      paramString = new JSONObject().put("value", com.tencent.mm.plugin.appbrand.v.c.wH(paramString)).put("data", f.lr(i)).put("cursor", 0).put("inputId", i).put("keyCode", 8);
      locala.a(localq.getRuntime().Zy(), localq.hashCode()).tL(paramString.toString()).dispatch();
      return;
    }
    catch (Exception paramString)
    {
      y.e("MicroMsg.JsApiShowKeyboard", "onBackspacePressedWhileValueNoChange, e = %s", new Object[] { paramString });
    }
  }
  ...
  public final void onInputDone(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    catch (JSONException paramString)
    {
      for (;;)
      {
        y.e("MicroMsg.JsApiShowKeyboard", "dispatch input done, exp = %s", new Object[] { bk.j(paramString) });
      }
    }
    if (!paramBoolean2) {
      aiX();
  ...
  public final void onInputInitialized()
  {
    if (this.gro.get() != null)
    {
      ...
      ((q)this.gro.get()).C(this.dIS, this.gru.h("ok", localHashMap));
      f.I(i, this.grp);
      f.a(i, (q)this.gro.get());
    }
  }
  ...
  public final void onRuntimeFail()
  {
    ...
    if (this.gro.get() != null)
    {
      ((q)this.gro.get()).C(this.dIS, this.gru.h("fail", null));
      aiX();
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.d.f.5
