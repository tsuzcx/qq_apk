  ...
  extends h
{
  ...
  public a()
  {
    ...
    com.tencent.mm.plugin.appbrand.permission.c.Qk("exitVoIPChat");
  ...
  public final void a(final com.tencent.mm.plugin.appbrand.service.c paramc, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    ac.i("MicroMsg.OpenVoice.JsApiCloudVoiceExitVoIPChat", "hy: invoke JsApiCloudVoiceExitVoIPChat");
    gl(false);
    paramJSONObject = paramc.getAppId();
    final long l = bs.Gn();
    p.otZ.a(new b() {}, p.a.ovI);
