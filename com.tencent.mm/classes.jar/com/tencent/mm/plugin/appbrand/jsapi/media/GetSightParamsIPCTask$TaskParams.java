  ...
  implements Parcelable
{
  ...
  public final boolean equals(Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof TaskParams))
      {
        ...
        if ((this.kWQ != paramObject.kWQ) || (this.maxDuration != paramObject.maxDuration) || (this.isFront != paramObject.isFront)) {}
      }
    }
    else {
      return true;
  ...
  public final String toString()
  {
    ...
    String str = "TaskParams(sightMode=" + this.kWQ + ", maxDuration=" + this.maxDuration + ", isFront=" + this.isFront + ")";
