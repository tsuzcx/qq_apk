  ...
  implements h.c
{
  public final h.a a(c paramc, String paramString, int paramInt)
  {
    ...
    if (localq == null)
    {
      ae.w("MicroMsg.JsApiCompressImage.javayhu", "compressImage fail:fileSystem is null");
      paramc = new h.a(false, "fail:runtime fileSystem is null");
      AppMethodBeat.o(139868);
      return paramc;
    }
    k localk = paramc.Fl().MP(paramString);
    if (localk == null)
    {
    ...
    try
    {
      ...
      localBitmap = e.a.a((e)paramc.K(e.class)).decodeFile(w.B(localk.fTh()), localOptions);
      if (localBitmap == null)
      {
    ...
    catch (OutOfMemoryError paramc)
    {
      try
      {
        ...
        for (paramString = Bitmap.CompressFormat.JPEG;; paramString = Bitmap.CompressFormat.PNG)
        {
          ...
          if (a.d(localOptions)) {
            com.tencent.mm.plugin.appbrand.l.b.cV(w.B(localk.fTh()), str);
          }
          paramString = new i();
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.media.h.b
