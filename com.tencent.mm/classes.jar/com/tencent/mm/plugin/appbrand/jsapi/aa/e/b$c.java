...
@l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/appbrand/jsapi/xwebplugin/video/AppBrandVideoCastHandler$Companion;", "", "()V", "TAG", "", "getFormatTime", "timeMs", "", "getMsTime", "", "formatTime", "luggage-xweb-ext_release"})
public final class b$c
{
  public static long JT(String paramString)
  {
    ...
    if (n.e((CharSequence)localObject, ".") != -1)
    {
      i = n.e((CharSequence)localObject, ".");
      if (localObject == null)
      {
    ...
    localObject = new d.n.k(":").r((CharSequence)localObject, 0);
    ...
    for (localObject = j.b((Iterable)localObject, localListIterator.nextIndex() + 1);; localObject = (List)d.a.v.Jgl)
    {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.jsapi.aa.e.b.c
