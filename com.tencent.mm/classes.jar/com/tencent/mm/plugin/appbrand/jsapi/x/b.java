...
public final class b
{
  ...
  public static void a(android.widget.TextView paramTextView, JSONObject paramJSONObject)
  {
    ...
    //   25: astore_3
    //   26: aload_3
    //   27: invokestatic 61	com/tencent/mm/sdk/platformtools/bt:isNullOrNil	(Ljava/lang/String;)Z
    //   30: ifne +11 -> 41
    //   33: aload_0
    //   34: aload_3
    //   35: invokestatic 67	com/tencent/mm/plugin/appbrand/aa/g:Nh	(Ljava/lang/String;)I
    ...
    //   49: d2f
    //   50: invokestatic 82	com/tencent/mm/plugin/appbrand/aa/g:aC	(F)F
    ...
    //   114: invokestatic 129	com/tencent/mm/plugin/appbrand/aa/g:a	(Lorg/json/JSONObject;Ljava/lang/String;I)I
    //   117: istore_2
    //   118: aload_0
    //   119: instanceof 131
    //   122: ifeq +11 -> 133
  ...
  public static void a(e parame, com.tencent.mm.plugin.appbrand.widget.b.a parama, JSONObject paramJSONObject)
  {
    ...
    try
    {
      String str = com.tencent.mm.plugin.appbrand.jsapi.q.d.a(parame, parama, paramJSONObject);
      paramJSONObject = paramJSONObject.optString("iconPath");
      if (!TextUtils.isEmpty(paramJSONObject))
      {
        paramJSONObject = ((com.tencent.mm.plugin.appbrand.g.b)parame.K(com.tencent.mm.plugin.appbrand.g.b.class)).b(parame, paramJSONObject);
        ((com.tencent.mm.plugin.appbrand.g.a)parame.K(com.tencent.mm.plugin.appbrand.g.a.class)).a(paramJSONObject, com.tencent.mm.plugin.appbrand.jsapi.q.d.IV(str), new a.c()
        {
          public final void A(InputStream paramAnonymousInputStream)
          {
            ...
            {
              ad.e("Luggage.ViewAttributeHelper", "attachImageViewAttribute, openRead failed, url=%s", new Object[] { this.gXI });
              AppMethodBeat.o(194772);
              return;
            }
            paramAnonymousInputStream = b.D(paramAnonymousInputStream);
            paramAnonymousInputStream.mark(b.getCompatibleRewindBufferSize());
            Object localObject = new BitmapFactory.Options();
            ((BitmapFactory.Options)localObject).inJustDecodeBounds = true;
            b.aZI().b(paramAnonymousInputStream, (BitmapFactory.Options)localObject);
            ...
            for (;;)
            {
              ...
              try
              {
                ...
                localObject = b.aZI().decodeStream(paramAnonymousInputStream);
                org.apache.commons.a.d.X(paramAnonymousInputStream);
                if ((localObject != null) && (!((Bitmap)localObject).isRecycled()))
                {
                  paramAnonymousInputStream = (c)this.cQR.get();
                  locala = (com.tencent.mm.plugin.appbrand.widget.b.a)this.kvu.get();
                  if ((paramAnonymousInputStream != null) && (locala != null)) {
                    paramAnonymousInputStream.L(new Runnable()
                    {
              ...
              catch (Throwable paramAnonymousInputStream)
              {
                ...
                ad.e("Luggage.ViewAttributeHelper", "attachImageViewAttribute, setImageBitmap failed, url=%s", new Object[] { this.gXI });
                AppMethodBeat.o(194772);
              }
            ...
            {
              paramAnonymousInputStream.reset();
              localObject = org.apache.commons.a.d.toByteArray(paramAnonymousInputStream);
              org.apache.commons.a.d.X(paramAnonymousInputStream);
              paramAnonymousInputStream = (c)this.cQR.get();
              locala = (com.tencent.mm.plugin.appbrand.widget.b.a)this.kvu.get();
              if ((paramAnonymousInputStream != null) && (locala != null)) {
                paramAnonymousInputStream.L(new Runnable()
                {
                  public final void run()
                  {
                    ...
                    locala.setImageByteArray(this.kvw);
            ...
            {
              ad.e("Luggage.ViewAttributeHelper", "attachImageViewAttribute, setImageByteArray failed, url=%s", new Object[] { this.gXI });
              AppMethodBeat.o(194772);
              return;
            }
          }
    ...
    {
      ad.printErrStackTrace("Luggage.ViewAttributeHelper", parame, "attachImageViewAttribute", new Object[0]);
      AppMethodBeat.o(137889);
    }
  }
