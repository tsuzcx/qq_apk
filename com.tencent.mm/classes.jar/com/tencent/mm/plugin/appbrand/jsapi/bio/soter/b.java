  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a
{
  ...
  public final void a(c paramc, JSONObject paramJSONObject, int paramInt)
  {
    ...
    ac.i("MicroMsg.JsApiLuggageStartSoterAuthentication", "hy: JsApiStartSoterAuthentication");
    Activity localActivity = (Activity)paramc.getContext();
    if (localActivity == null)
    {
      ac.e("MicroMsg.JsApiLuggageStartSoterAuthentication", "JsApiStartSoterAuthentication context is null, appId is %s", new Object[] { paramc.getAppId() });
    ...
    if (this.khQ == null)
    {
      ac.e("MicroMsg.JsApiLuggageStartSoterAuthentication", "JsApiStartSoterAuthentication ui is null!");
    ...
    Intent localIntent = new Intent(localActivity, this.khQ);
    ...
    try
    {
      ...
      com.tencent.mm.hellhoundlib.a.a.a(localActivity, paramc.aeD(), "com/tencent/mm/plugin/appbrand/jsapi/bio/soter/JsApiLuggageStartSoterAuthentication", "invoke", "(Lcom/tencent/mm/plugin/appbrand/jsapi/AppBrandComponent;Lorg/json/JSONObject;I)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
      localActivity.startActivity((Intent)paramc.lR(0));
    ...
    catch (JSONException paramJSONObject)
    {
      for (;;)
      {
        ac.i("MicroMsg.JsApiLuggageStartSoterAuthentication", "hy: soter authentication scene null");
      }
    }
  }
}
