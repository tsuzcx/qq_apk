  ...
  implements com.tencent.mm.msgsubscription.util.a.a
{
  ...
  public static void di(String paramString1, String paramString2)
  {
    ...
    ((Map)kAs).put(paramString1, paramString2);
  ...
  public final int a(a.c paramc, final com.tencent.mm.msgsubscription.util.a.b paramb, final com.tencent.mm.msgsubscription.util.a parama)
  {
    ...
    kAs.get(((b)parama).username);
    locala.a(paramc.getUri(), (com.tencent.mm.bw.a)paramc.aLo(), paramc.aLp().getClass()).a((d.b)new a(paramc, paramb, parama)).a((d.a)new b(paramb, parama));
    AppMethodBeat.o(169630);
    return 0;
  }
  
  @l(fNY={1, 1, 16}, fNZ={""}, fOa={"<anonymous>", "", "resp", "Lcom/tencent/mm/protocal/protobuf/ResponseProtoBuf;", "kotlin.jvm.PlatformType", "onTerminate"})
  ...
  @l(fNY={1, 1, 16}, fNZ={""}, fOa={"<anonymous>", "", "err", "", "kotlin.jvm.PlatformType", "onInterrupt"})
    ...
    implements d.a<Object>
  {
    ...
    public final void cc(Object paramObject)
    {
      ...
      {
        com.tencent.mm.msgsubscription.util.a.b localb = this.iht;
        if (localb == null) {
          break;
        }
