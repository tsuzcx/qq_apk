...
public abstract class j<R>
{
  ...
  long csK;
  boolean csL = false;
  public final Runnable csM = new Runnable()
  {
    public final void run()
    {
      AppMethodBeat.i(162078);
      ad.i("MicroMsg.SDK.SyncTask", "task run manualFinish = " + j.this.csL);
      if (j.this.csL) {
        j.this.run();
      }
      for (;;)
      {
        j.this.csK = bt.aS(j.this.csJ);
        AppMethodBeat.o(162078);
        return;
        j.this.aH(j.this.run());
      }
    }
  };
  ...
  public final R b(ap paramap)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: putfield 68	com/tencent/mm/plugin/appbrand/b/j:mHandler	Lcom/tencent/mm/sdk/platformtools/ap;
    //   5: ldc 48
    //   7: ldc 70
    ...
    //   43: areturn
    //   44: aload_0
    //   45: invokestatic 102	com/tencent/mm/sdk/platformtools/bt:GC	()J
    //   48: putfield 104	com/tencent/mm/plugin/appbrand/b/j:csJ	J
    //   51: aload_0
    ...
    //   67: aload_1
    //   68: aload_0
    //   69: getfield 38	com/tencent/mm/plugin/appbrand/b/j:csM	Ljava/lang/Runnable;
    ...
    //   80: aload_0
    //   81: getfield 40	com/tencent/mm/plugin/appbrand/b/j:csI	J
    //   84: invokevirtual 114	java/lang/Object:wait	(J)V
    //   87: aload 4
    //   89: monitorexit
    //   90: aload_0
    //   91: getfield 104	com/tencent/mm/plugin/appbrand/b/j:csJ	J
    //   94: invokestatic 118	com/tencent/mm/sdk/platformtools/bt:aS	(J)J
    //   97: lstore_2
    //   98: ldc 48
    //   100: ldc 120
    //   102: iconst_4
    ...
    //   134: iconst_2
    //   135: aload_0
    //   136: getfield 139	com/tencent/mm/plugin/appbrand/b/j:csK	J
    ...
    //   145: lload_2
    //   146: aload_0
    //   147: getfield 139	com/tencent/mm/plugin/appbrand/b/j:csK	J
    //   150: lsub
