...
public class b
{
  private static b.c jTA;
  private static volatile Map<String, b> jTz;
  public ao jTB;
  public a.a jTC;
  private MediaSdk jTD;
  private e jTE;
  private c.a jTF;
  private c.a jTG;
  private final Runnable jTH;
  ...
  private b(MagicBrushView paramMagicBrushView)
  {
    ...
    this.jTH = new Runnable()
    {
      public final void run()
      {
        ...
        if (b.b(b.this) == b.e.jUg)
        {
          ac.i("MicroMsg.GameRecorderMgr", "hy: trigger uninit");
          b.j(b.this).uint();
          b.i(b.this);
          b.a(b.this, b.e.jUf);
        ...
        ac.w("MicroMsg.GameRecorderMgr", "hy: current not idle. abort uninit");
        AppMethodBeat.o(174740);
      }
    };
    this.jTB = new ao("wegame_screen_recorder_worker");
    if (jTA != b.c.jUc) {
      this.jTC = new a.b(paramMagicBrushView);
    }
    this.jTB.postToWorker(new Runnable()
    {
      public final void run()
      {
  ...
  public static b a(String paramString, MagicBrushView paramMagicBrushView)
  {
    ...
    try
    {
      if (!jTz.containsKey(paramString))
      {
        ...
        jTz.put(paramString, localObject1);
      }
      paramMagicBrushView = (MagicBrushView)localObject1;
      if (localObject1 == null) {
        paramMagicBrushView = (b)jTz.get(paramString);
      }
      AppMethodBeat.o(45367);
  ...
  public final void a(final String paramString, final d<a> paramd)
  {
    ...
    this.jTB.postToWorker(new Runnable()
    {
      public final void run()
      {
        ...
        try
        {
          ac.i("MicroMsg.GameRecorderMgr", "hy: requestAnalyze %s", new Object[] { paramString });
          ...
          b.j(b.this).analysis(localJSONObject.toString().getBytes(), new MediaSdk.MediaCallbacker()
          {
            public final void onResult(byte[] paramAnonymous2ArrayOfByte)
            {
              ...
              try
              {
                ...
                ac.i("MicroMsg.GameRecorderMgr", "hy: duration is %d, size is %d", new Object[] { Long.valueOf(locala.duration), Long.valueOf(locala.fileSize) });
                b.2.this.jTy.a(0, 0, "ok", locala);
                AppMethodBeat.o(174731);
                return;
              }
              catch (JSONException paramAnonymous2ArrayOfByte)
              {
                b.2.this.jTy.a(1, -1, "analysis error: " + paramAnonymous2ArrayOfByte.getMessage(), null);
                AppMethodBeat.o(174731);
                return;
              }
  ...
  public final void a(final JSONObject paramJSONObject, final d<JSONObject> paramd)
  {
    ...
    this.jTB.postToWorker(new Runnable()
    {
      public final void run()
      {
        ...
        try
        {
          ac.i("MicroMsg.GameRecorderMgr", "hy: trigger remux " + paramJSONObject.toString());
          b.j(b.this).remux(paramJSONObject.toString().getBytes(), new MediaSdk.MediaCallbacker()
          {
            public final void onResult(byte[] paramAnonymous2ArrayOfByte)
            {
              ...
              try
              {
                ...
                if (i == 0)
                {
                  b.3.this.jTy.a(0, 0, "ok", paramAnonymous2ArrayOfByte);
                  AppMethodBeat.o(174732);
                  return;
                }
                b.3.this.jTy.a(1, i, String.format("remux failed!: errCode: %d", new Object[] { Integer.valueOf(i) }), paramAnonymous2ArrayOfByte);
                AppMethodBeat.o(174732);
                return;
              }
              catch (JSONException paramAnonymous2ArrayOfByte)
              {
                b.3.this.jTy.a(1, -1, "remux error: " + paramAnonymous2ArrayOfByte.getMessage(), new JSONObject());
                AppMethodBeat.o(174732);
                return;
              }
              catch (Exception paramAnonymous2ArrayOfByte)
  ...
  public final void e(final d<String> paramd)
  {
    ...
    ac.i("MicroMsg.GameRecorderMgr", "hy: trigger pause");
    this.jTB.postToWorker(new Runnable()
    {
      public final void run()
      {
        ...
        if (!b.f(b.this))
        {
          ac.w("MicroMsg.GameRecorderMgr", "hy: pause failed: not started");
          paramd.a(2, 201, "not start yet!", null);
          AppMethodBeat.o(45352);
          return;
        }
        if (b.b(b.this) == b.e.jUi)
        {
          ac.w("MicroMsg.GameRecorderMgr", "hy: pause failed: already paused!");
  ...
  public final void f(final d<String> paramd)
  {
    ...
    ac.i("MicroMsg.GameRecorderMgr", "hy: trigger resume");
    this.jTB.postToWorker(new Runnable()
    {
      public final void run()
      {
        ...
        if (!b.f(b.this))
        {
          ac.w("MicroMsg.GameRecorderMgr", "hy: resume failed: not started");
          paramd.a(2, 301, "not start yet!", null);
          AppMethodBeat.o(45354);
          return;
        }
        if (b.b(b.this) == b.e.jUh)
        {
          ac.w("MicroMsg.GameRecorderMgr", "hy: resume failed: already running!");
  ...
  {
    public abstract void qM(long paramLong);
  }
  ...
  public final class d
  {
    ...
    public final String toString()
    {
      ...
      String str = "RemuxResult{audioBitrate=" + this.audioBitrate + ", audioSampleRate=" + this.audioSampleRate + ", audioChannelCount=" + this.gOt + '}';
