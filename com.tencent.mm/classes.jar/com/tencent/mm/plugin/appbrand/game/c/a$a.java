  ...
  implements com.tencent.magicbrush.a.a.a
{
  ...
  public final int q(String paramString, int paramInt)
  {
  ...
  public final Drawable r(String paramString, int paramInt)
  {
    AppMethodBeat.i(45100);
    i locali = new i();
    a(paramString, paramInt, locali);
    paramString = b.gxI().a((c)locali.value, true);
