  ...
  implements com.tencent.mm.plugin.appbrand.jsapi.video.b.d.a
{
  ...
  public final void C(String paramString1, String paramString2, int paramInt)
  {
    ...
    ac.i("MicroMsg.SameLayer.VideoReporter", "reportPreloadError, uuid:%s, url:%s, code:%s", new Object[] { paramString1, paramString2, Integer.valueOf(paramInt) });
    this.mQP.add(paramString1);
    if (paramInt == -101)
    {
      h.wUl.idkeyStat(1234L, 27L, 1L, false);
      AppMethodBeat.o(50029);
      return;
    }
    if (paramInt == -102)
    {
      h.wUl.idkeyStat(1234L, 28L, 1L, false);
      AppMethodBeat.o(50029);
      return;
    }
    if (paramInt == -103)
    {
      h.wUl.idkeyStat(1234L, 29L, 1L, false);
      AppMethodBeat.o(50029);
      return;
    }
    if (paramInt == -104)
    {
      h.wUl.idkeyStat(1234L, 30L, 1L, false);
      AppMethodBeat.o(50029);
      return;
    }
    if (paramInt == -105) {
      h.wUl.idkeyStat(1234L, 31L, 1L, false);
    }
    AppMethodBeat.o(50029);
  }
  ...
  public final void bkb()
  {
    ...
    h.wUl.idkeyStat(1234L, 36L, 1L, false);
  ...
  public final void dw(String paramString1, String paramString2)
  {
    ...
    ac.i("MicroMsg.SameLayer.VideoReporter", "reportPreloadStart, uuid:%s, url:%s", new Object[] { paramString1, paramString2 });
    h.wUl.idkeyStat(1234L, 26L, 1L, false);
  ...
  public final void dx(String paramString1, String paramString2)
  {
    ...
    ac.i("MicroMsg.SameLayer.VideoReporter", "reportPreloadEnd, uuid:%s, url:%s", new Object[] { paramString1, paramString2 });
    if (!this.mQP.contains(paramString1))
    {
      h.wUl.idkeyStat(1234L, 32L, 1L, false);
      AppMethodBeat.o(50030);
      return;
    }
    this.mQP.remove(paramString1);
    AppMethodBeat.o(50030);
  }
  ...
  public final void qR(long paramLong)
  {
    ...
    h.wUl.idkeyStat(1234L, 37L, paramLong, false);
  ...
  public final void sR(int paramInt)
  {
    ...
    ac.i("MicroMsg.SameLayer.VideoReporter", "startProxyResult, reason:%s", new Object[] { Integer.valueOf(paramInt) });
    if (paramInt >= 0)
    {
      h.wUl.idkeyStat(1234L, 16L, 1L, false);
      AppMethodBeat.o(50027);
      return;
    }
    if (paramInt == -1)
    {
      h.wUl.idkeyStat(1234L, 17L, 1L, false);
      AppMethodBeat.o(50027);
      return;
    }
    if (paramInt == -2) {
      h.wUl.idkeyStat(1234L, 18L, 1L, false);
    }
    AppMethodBeat.o(50027);
  }
}
