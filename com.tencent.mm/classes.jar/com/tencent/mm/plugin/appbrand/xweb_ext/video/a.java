...
{
  private static a nro;
  private Set<String> nrp;
  ...
  public final void D(String paramString1, String paramString2, int paramInt)
  {
    ...
    this.nrp.add(paramString1);
    if (paramInt == -101)
    {
      g.yhR.idkeyStat(1234L, 27L, 1L, false);
      AppMethodBeat.o(50029);
      return;
    }
    if (paramInt == -102)
    {
      g.yhR.idkeyStat(1234L, 28L, 1L, false);
      AppMethodBeat.o(50029);
      return;
    }
    if (paramInt == -103)
    {
      g.yhR.idkeyStat(1234L, 29L, 1L, false);
      AppMethodBeat.o(50029);
      return;
    }
    if (paramInt == -104)
    {
      g.yhR.idkeyStat(1234L, 30L, 1L, false);
      AppMethodBeat.o(50029);
      return;
    }
    if (paramInt == -105) {
      g.yhR.idkeyStat(1234L, 31L, 1L, false);
    }
    AppMethodBeat.o(50029);
  }
  ...
  public final void a(String paramString1, String paramString2, int paramInt1, long paramLong1, long paramLong2, long paramLong3, int paramInt2, String paramString3, long paramLong4, long paramLong5, long paramLong6, long paramLong7, String paramString4, int paramInt3)
  {
    ...
    g.yhR.f(18693, new Object[] { paramString1, paramString2, Integer.valueOf(paramInt1), Long.valueOf(paramLong7), Integer.valueOf(paramInt3), Long.valueOf(paramLong5), Long.valueOf(paramLong6), paramString4, Long.valueOf(paramLong1), Long.valueOf(paramLong2), Long.valueOf(paramLong3), Integer.valueOf(paramInt2), paramString3, Long.valueOf(paramLong4) });
  ...
  public final void bnM()
  {
    ...
    g.yhR.idkeyStat(1234L, 36L, 1L, false);
  ...
  public final void dy(String paramString1, String paramString2)
  {
    ...
    g.yhR.idkeyStat(1234L, 26L, 1L, false);
  ...
  public final void dz(String paramString1, String paramString2)
  {
    ...
    if (!this.nrp.contains(paramString1))
    {
      g.yhR.idkeyStat(1234L, 32L, 1L, false);
      AppMethodBeat.o(50030);
      return;
    }
    this.nrp.remove(paramString1);
    AppMethodBeat.o(50030);
  }
  ...
  public final void sQ(long paramLong)
  {
    ...
    g.yhR.idkeyStat(1234L, 37L, paramLong, false);
  ...
  public final void tu(int paramInt)
  {
    ...
    if (paramInt >= 0)
    {
      g.yhR.idkeyStat(1234L, 16L, 1L, false);
      AppMethodBeat.o(50027);
      return;
    }
    if (paramInt == -1)
    {
      g.yhR.idkeyStat(1234L, 17L, 1L, false);
      AppMethodBeat.o(50027);
      return;
    }
    if (paramInt == -2) {
      g.yhR.idkeyStat(1234L, 18L, 1L, false);
    }
    AppMethodBeat.o(50027);
  }
}
