  ...
  implements j
{
  public final boolean bne()
  {
    ...
    int i = ax.aFC("xweb_abtest_command").decodeInt("xweb_video_preload_command_value", -1);
    if (i >= 0)
    {
    ...
    if (((b)g.ab(b.class)).a(b.a.pnC, 0) == 1)
    {
      AppMethodBeat.o(50046);
      return true;
    }
  ...
  public final int bnf()
  {
    ...
    int i = ax.aFC("xweb_abtest_command").decodeInt("xweb_video_weishi_ps_command_value", -1);
    if (i >= 0)
    {
