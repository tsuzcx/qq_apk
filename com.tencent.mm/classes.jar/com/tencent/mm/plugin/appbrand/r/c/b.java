  ...
  public final String b(i parami, c paramc)
  {
    ...
    if (this.kWH == null)
    {
      ...
      if (i < ((List)localObject1).size())
      {
        ...
        this.kWH = ((n)localObject2);
      }
    }
    Object localObject2 = this.kWH;
    localObject1 = null;
    if (localObject2 != null) {
      localObject1 = ((n)localObject2).EY(parami.optString("path"));
    }
    for (;;)
    {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.r.c.b
