  ...
  extends d
{
  ...
  public final void buM()
  {
    ...
    if (this.mns != null)
    {
      com.tencent.e.h.Iye.aP(new com.tencent.e.i.h()
      {
        ...
        public final void run()
        {
          ...
          {
            b localb = b.this;
            Object localObject = Base64.decode(b.this.mns, 0);
            localObject = BitmapFactory.decodeByteArray((byte[])localObject, 0, localObject.length);
            if (localObject == null) {
              localb.mnt.a("Failed to load icon via base64 icon", localb);
            }
          ...
          {
            b.this.mnt.a("Failed to load icon via base64 icon", b.this);
            AppMethodBeat.o(135540);
          }
        }
      });
    ...
    this.mnt.a("Failed to load icon via base64 icon", this);
    AppMethodBeat.o(135541);
  }
}
