  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bd(paramView);
    a.b("com/tencent/mm/plugin/appbrand/widget/desktop/AppBrandDesktopContainer$3", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahF());
    if ((AppBrandDesktopContainer.a(this.nbv) != null) && (AppBrandDesktopContainer.a(this.nbv).bDr())) {
      AppBrandDesktopContainer.a(this.nbv).wc(14);
    }
    a.a(this, "com/tencent/mm/plugin/appbrand/widget/desktop/AppBrandDesktopContainer$3", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
