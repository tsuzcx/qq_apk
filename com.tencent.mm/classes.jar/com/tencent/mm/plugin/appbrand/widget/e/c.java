...
@l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/plugin/appbrand/widget/prompt/AppBrandPopupToast;", "Lcom/tencent/mm/ui/base/MMPopupWindow;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "mIconImage", "Landroid/widget/ImageView;", "mMessageText", "Landroid/widget/TextView;", "setIconDrawable", "drawable", "Landroid/graphics/drawable/Drawable;", "setMessage", "message", "", "show", "", "plugin-appbrand-integration_release"})
public final class c
  extends o
{
  private final TextView nrY;
  private final ImageView nrZ;
  ...
  public final c G(CharSequence paramCharSequence)
  {
    ...
    if ((paramCharSequence == null) || (paramCharSequence.length() == 0))
    {
      ...
      this.nrY.setLineSpacing(0.0F, 1.0F);
      TextView localTextView = this.nrY;
      ...
      this.nrY.setText(paramCharSequence, TextView.BufferType.SPANNABLE);
  ...
  public final void show()
  {
    ...
    localObject = com.tencent.mm.ui.statusbar.d.kH(((View)localObject).getContext());
    if (localObject != null)
    {
      super.showAtLocation(((Activity)localObject).findViewById(16908290), 17, 0, 0);
      ar.o((Runnable)new d(this), 1500L);
