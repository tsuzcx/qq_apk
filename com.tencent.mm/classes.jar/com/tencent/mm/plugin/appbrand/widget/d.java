  ...
  implements c.a, f
{
  ...
  public d(Context paramContext)
  {
    ...
    super.setSpannableFactory(new Spannable.Factory()
    {
      public final Spannable newSpannable(CharSequence paramAnonymousCharSequence)
      {
        ...
        if ((d.a(d.this) != null) && (!TextUtils.isEmpty(paramAnonymousCharSequence))) {
          paramAnonymousCharSequence.setSpan(d.a(d.this), 0, paramAnonymousCharSequence.length(), 18);
        }
  ...
  public void setLineHeight(int paramInt)
  {
    ...
    if (this.lSQ == null) {
      this.lSQ = new a(paramInt, 17);
    }
    if (!this.lSQ.aX(paramInt))
    {
