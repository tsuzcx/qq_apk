...
{
  public static double rBt = 6378137.0D;
  final double rBu;
  
  public f()
  {
    AppMethodBeat.i(146599);
    this.rBu = (6.283185307179586D * rBt);
  ...
  public final e b(LatLng paramLatLng)
  {
    ...
    paramLatLng = new e((d1 + 0.5D) * this.rBu, (d2 + 0.5D) * this.rBu);
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.widget.f.f
