  ...
  extends Drawable
{
  ...
  public a(Drawable paramDrawable)
  {
    ...
    this.nkj = com.tencent.mm.cc.a.ay(aj.getContext(), 2131165289);
    this.nkh = paramDrawable;
  ...
  public final void draw(Canvas paramCanvas)
  {
    ...
    Drawable localDrawable = this.nkh;
    ...
    float f2 = k - m;
    i = paramCanvas.save();
    paramCanvas.rotate(this.nki, f1 * 0.5F + localRect.left, localRect.top + f2 * 0.5F);
  ...
  public final void setBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.nkh != null) {
      this.nkh.setBounds(paramInt1, paramInt2, paramInt3, paramInt4);
    }
