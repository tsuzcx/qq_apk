...
import com.tencent.luggage.i.b.a.a;
import com.tencent.luggage.i.b.a.b;
  ...
  extends Drawable
{
  ...
  public a(Drawable paramDrawable)
  {
    ...
    this.rBF = com.tencent.mm.ci.a.aZ(MMApplicationContext.getContext(), a.b.Edge_2A);
    this.rBD = paramDrawable;
  ...
  public final void draw(Canvas paramCanvas)
  {
    ...
    Drawable localDrawable = this.rBD;
    ...
    float f2 = k - m;
    i = paramCanvas.save();
    paramCanvas.rotate(this.rBE, f1 * 0.5F + localRect.left, localRect.top + f2 * 0.5F);
    paramCanvas.drawOval(this.byj, this.paint);
  ...
  public final void setBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.rBD != null) {
      this.rBD.setBounds(paramInt1, paramInt2, paramInt3, paramInt4);
    }
    this.byj = new RectF(paramInt1, paramInt2, paramInt3, paramInt4);
