  ...
  extends d
{
  ...
  public final void buM()
  {
    ...
    final AppBrandRuntime localAppBrandRuntime = this.iIL.getRuntime();
    if ((localAppBrandRuntime != null) && (this.mns != null)) {
      com.tencent.e.h.Iye.aP(new com.tencent.e.i.h()
      {
        ...
        public final void run()
        {
          ...
          InputStream localInputStream = be.f(localAppBrandRuntime, h.this.mns);
          Bitmap localBitmap = BitmapFactory.decodeStream(localInputStream);
          if (localBitmap == null) {
            h.this.mnt.a("Failed to load icon via package path", h.this);
          }
          for (;;)
          {
