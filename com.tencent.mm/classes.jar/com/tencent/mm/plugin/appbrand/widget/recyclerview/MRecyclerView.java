  ...
  extends RecyclerView
{
  ...
  public void addFooterView(View paramView)
  {
    ...
    this.oEr.addFooterView(paramView);
  ...
  public void setAdapter(RecyclerView.a parama)
  {
    ...
    if (locala.adj != null)
    {
      if (!locala.adj.equals(parama)) {
        locala.adj.b(locala.oEj);
      }
    }
    else
    {
