...
public final class ap
{
  ...
  private static long G(byte[] paramArrayOfByte, int paramInt)
  {
    long l = 0L;
    int i = paramInt;
    while (i < paramInt + 4)
  ...
  private byte[] b(byte[] paramArrayOfByte1, int paramInt, byte[] paramArrayOfByte2)
  {
    ...
    this.prePlain = bd(paramArrayOfByte1);
    if (this.prePlain == null)
    {
      AppMethodBeat.o(140862);
      return null;
    ...
    for (;;)
    {
      if (this.padding <= 2)
      {
        ...
        if (!H(paramArrayOfByte1, paramInt))
        {
          AppMethodBeat.o(140862);
          return null;
        }
  ...
  private byte[] bd(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        l3 = G(paramArrayOfByte, 0);
        l2 = G(paramArrayOfByte, 4);
        l4 = G(this.key, 0);
        l5 = G(this.key, 4);
        l6 = G(this.key, 8);
        l7 = G(this.key, 12);
  ...
  private byte[] c(byte[] paramArrayOfByte1, int paramInt, byte[] paramArrayOfByte2)
  {
  ...
  public final byte[] encrypt(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    paramArrayOfByte1 = c(paramArrayOfByte1, paramArrayOfByte1.length, paramArrayOfByte2);
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.utils.ap
