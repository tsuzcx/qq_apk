...
public enum a
  implements e, h.a
{
  public static final c mUM;
  private final e mUN;
  private final AtomicBoolean mUO;
  ...
  private a()
  {
    ...
    this.mUO = new AtomicBoolean(false);
    this.mUN = new b();
  ...
  public final void init(Context paramContext)
  {
    ...
    if (!this.mUO.getAndSet(true)) {
      this.mUN.init(paramContext);
    }
