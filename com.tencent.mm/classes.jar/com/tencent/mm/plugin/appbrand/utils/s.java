  ...
  implements a, Runnable
{
  ...
  private s(o<? super a> paramo, Runnable paramRunnable, String paramString)
  {
    ...
    this.lMC = paramString;
    this.lMA = new AtomicBoolean(false);
  ...
  public final void run()
  {
    ...
    ad.w("Luggage.WXA.LifeCycleWrappedRunnable", "run() but dead, <init> stackTrace = " + this.lMC);
    AppMethodBeat.o(135608);
  }
  
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/appbrand/utils/LifeCycleWrappedRunnable$Companion;", "", "()V", "obtain", "Lcom/tencent/mm/plugin/appbrand/utils/LifeCycleWrappedRunnable;", "registry", "Lcom/tencent/mm/plugin/appbrand/utils/ILifeCycleRegistry;", "Lcom/tencent/mm/vending/lifecycle/ILifeCycle;", "runnable", "Ljava/lang/Runnable;", "luggage-wxa-app_release"})
