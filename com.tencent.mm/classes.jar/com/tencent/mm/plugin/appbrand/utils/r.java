...
{
  public static <I> I k(String paramString, Class<I> paramClass)
  {
    ...
    paramString = new r()
    {
      public final Object invoke(Object paramAnonymousObject, Method paramAnonymousMethod, Object[] paramAnonymousArrayOfObject)
      {
        ...
        Log.i(r.this, "dummy invoke method(%s) args(%s)", new Object[] { paramAnonymousMethod.getName(), a.w(paramAnonymousArrayOfObject, "NULL") });
