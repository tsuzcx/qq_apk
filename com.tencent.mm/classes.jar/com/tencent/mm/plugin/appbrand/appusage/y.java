  ...
  extends k
{
  ...
  static
  {
    ...
    gLs = new String[] { com.tencent.mm.sdk.e.j.getCreateSQLs(y.a.gLr, "AppBrandLauncherLayoutItem") };
  ...
  public y(h paramh)
  {
    ...
    this.iVr = new c((byte)0);
    this.iVg = paramh;
    this.iVq = new y.b(paramh);
  ...
  private boolean a(String paramString1, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    localObject = this.iVg.a((String)localObject, new String[] { "2" }, 0);
    long l;
    int i;
    label172:
    boolean bool2;
    ...
    {
      l = 0L;
      l = Math.max(l + 1L, bt.aGK());
      int j = G(paramString1, paramInt1, 2);
      localObject = new ContentValues(1);
      ((ContentValues)localObject).put("updateTime", Long.valueOf(l));
      if (this.iVg.update("AppBrandLauncherLayoutItem", (ContentValues)localObject, String.format(Locale.US, "%s=?", new Object[] { "recordId" }), new String[] { String.valueOf(j) }) <= 0) {
        break label425;
      }
      i = 1;
      if (i != 0) {
      ...
      {
        localObject = ((b)com.tencent.mm.plugin.appbrand.app.j.T(b.class)).E(paramString1, 3, paramInt2);
        ...
        paramString2 = a.iQw;
        a.D(((Integer)((Pair)localObject).second).intValue(), 165L);
      }
    }
    for (;;)
    {
      if (bool2) {
        aa.aC(paramString1, paramInt1);
      }
      if (bool1) {
        aSc();
      }
      if (bool2) {
        ((n)com.tencent.mm.plugin.appbrand.app.j.T(n.class)).a(paramString1, paramInt1, n.a.iUB);
      }
      AppMethodBeat.o(44617);
      return bool2;
      l = 0L;
      ...
      break label257;
      label440:
      new ac(paramInt2, paramBoolean2, paramInt1, 1, paramString1, paramInt3, paramString2).auK();
    }
  }
  ...
  private void aSc()
  {
    ...
    Object localObject1 = this.iVg.a(String.format(Locale.US, "select count(*) from %s where %s=?", new Object[] { "AppBrandLauncherLayoutItem", "scene" }), new String[] { "2" }, 0);
    int i;
    ...
    while (i > 10000)
    {
      ...
      else
      {
        ...
        long l = this.iVg.rb(Thread.currentThread().getId());
        localObject2 = ((List)localObject1).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          localObject3 = (String)((Iterator)localObject2).next();
          this.iVg.delete("AppBrandLauncherLayoutItem", String.format(Locale.US, "%s=?", new Object[] { "recordId" }), new String[] { localObject3 });
        }
        this.iVg.mX(l);
        ...
        {
          String str = u.Gh((String)localArrayList1.get(i));
        ...
        if (com.tencent.mm.plugin.appbrand.app.j.aOK() != null) {
          com.tencent.mm.plugin.appbrand.app.j.aOK().e((List)localObject2, (List)localObject3);
        }
  ...
  private boolean aZ(String paramString, int paramInt)
  {
    boolean bool = true;
    ...
    if (this.iVg.delete("AppBrandLauncherLayoutItem", String.format(Locale.US, "%s=?", new Object[] { "recordId" }), new String[] { String.valueOf(G(paramString, paramInt, 2)) }) > 0) {}
    for (;;)
    {
      if (bool) {
        ((n)com.tencent.mm.plugin.appbrand.app.j.T(n.class)).b(paramString, paramInt, n.a.iUB);
      }
      AppMethodBeat.o(44619);
      return bool;
      bool = false;
  ...
  /* Error */
  public static ArrayList<AppBrandRecentTaskInfo> e(Cursor paramCursor)
  {
    // Byte code:
    //   0: ldc_w 378
    ...
    //   51: aload_1
    //   52: aload_0
    //   53: invokevirtual 383	com/tencent/mm/plugin/appbrand/appusage/y$a:convertFrom	(Landroid/database/Cursor;)V
    //   56: aload_1
    //   57: getfield 172	com/tencent/mm/plugin/appbrand/appusage/y$a:field_brandId	Ljava/lang/String;
    //   60: invokestatic 106	com/tencent/mm/sdk/platformtools/bt:isNullOrNil	(Ljava/lang/String;)Z
    //   63: ifne +30 -> 93
    //   66: aload_2
    //   67: aload_1
    //   68: getfield 386	com/tencent/mm/plugin/appbrand/appusage/y$a:field_recordId	I
    ...
    //   86: invokestatic 389	com/tencent/mm/plugin/appbrand/config/u:a	(Ljava/lang/String;Ljava/lang/String;IJ)Lcom/tencent/mm/plugin/appbrand/appusage/AppBrandRecentTaskInfo;
    //   89: invokevirtual 390	java/util/LinkedList:add	(Ljava/lang/Object;)Z
    //   92: pop
    //   93: aload_0
    ...
    //   105: dup
    //   106: aload_2
    //   107: invokevirtual 391	java/util/LinkedList:size	()I
    //   110: invokespecial 291	java/util/ArrayList:<init>	(I)V
    //   113: astore_1
    //   114: aload_1
    //   115: aload_2
    //   116: invokevirtual 395	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   119: pop
    //   120: aload_0
    ...
    //   137: dup
    //   138: invokespecial 379	java/util/ArrayList:<init>	()V
    //   141: astore_1
    //   142: goto -22 -> 120
    //   145: astore_1
    //   146: ldc 204
    ...
    //   157: aload_1
    //   158: aastore
    //   159: invokestatic 399	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
  ...
  final Cursor a(String[] paramArrayOfString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      paramArrayOfString = this.iVg.query("AppBrandLauncherLayoutItem", paramArrayOfString, str, arrayOfString, null, null, null);
  ...
  final boolean a(y.a parama)
  {
    ...
    long l = this.iVg.a("AppBrandLauncherLayoutItem", "", parama.convertTo());
  ...
  public final boolean aY(String paramString, int paramInt)
  {
    ...
    paramString = this.iVg.a(String.format(Locale.US, "select count(*) from %s where %s=? and %s=? and %s=?", new Object[] { "AppBrandLauncherLayoutItem", "brandId", "versionType", "scene" }), new String[] { paramString, String.valueOf(paramInt), "2" }, 0);
    if (paramString == null)
    {
      AppMethodBeat.o(44611);
      return false;
  ...
  public final boolean bb(String paramString, int paramInt)
  {
    ...
    boolean bool = aZ(paramString, paramInt);
    if (bool)
    {
      ac.bd(paramString, paramInt).auK();
      doNotify("single", 5, String.valueOf(G(paramString, paramInt, 2)));
    }
  ...
  public final boolean bc(String paramString, int paramInt)
  {
    ...
    paramString = this.iVg.a(str, new String[] { String.valueOf(G(paramString, paramInt, 2)) }, 2);
  ...
  public final ArrayList<AppBrandRecentTaskInfo> qO(int paramInt)
  {
    AppMethodBeat.i(44615);
    ArrayList localArrayList = e(a(null, paramInt, 0));
  ...
  public final class c
  {
    ...
    public final ArrayList<AppBrandRecentTaskInfo> mT(long paramLong)
    {
      ...
      localObject = y.e(((h)localObject).a("AppBrandLauncherLayoutItem", null, str1, new String[] { "2", String.valueOf(paramLong) }, null, null, str2, 2));
