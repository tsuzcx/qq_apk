...
{
  private static final Map<String, List<n.a>> fZD;
  private static final Map<String, DebuggerInfo> jlJ;
  
  static
  {
    AppMethodBeat.i(121294);
    fZD = new ConcurrentHashMap();
    jlJ = new ConcurrentHashMap();
    AppMethodBeat.o(121294);
  }
  
  public static DebuggerInfo He(String paramString)
  {
    ...
    paramString = (DebuggerInfo)jlJ.get(paramString);
    AppMethodBeat.o(121289);
    return paramString;
  }
  ...
  public static void M(String paramString, int paramInt)
  {
    ...
    paramString = (List)fZD.get(paramString);
    if (paramString == null)
    {
      AppMethodBeat.o(121293);
      return;
    ...
    while (paramString.hasNext()) {
      ((n.a)paramString.next()).nA(paramInt);
    }
    AppMethodBeat.o(121293);
  }
  ...
  public static void a(String paramString, DebuggerInfo paramDebuggerInfo)
  {
    ...
    jlJ.put(paramString, paramDebuggerInfo);
    AppMethodBeat.o(121290);
  }
  ...
  public static boolean c(String paramString, n.a parama)
  {
    ...
    Object localObject = (List)fZD.get(paramString);
    if (localObject == null)
    {
  ...
  public static boolean d(String paramString, n.a parama)
  {
    ...
    List localList = (List)fZD.get(paramString);
    if (localList == null)
    {
      AppMethodBeat.o(121292);
      return false;
