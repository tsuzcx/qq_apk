...
public final class a
{
  public static <T extends com.tencent.mm.kernel.c.a> T aw(Class<T> paramClass)
  {
    ...
    if (!com.tencent.mm.kernel.g.ajS().gEt.gEN)
    {
      ...
      com.tencent.mm.kernel.g.ajS().a((com.tencent.mm.kernel.api.g)localObject);
      try
      {
        localCountDownLatch.await();
        com.tencent.mm.kernel.g.ajS().b((com.tencent.mm.kernel.api.g)localObject);
      }
      catch (InterruptedException localInterruptedException)
      {
        for (;;)
        {
          ae.printErrStackTrace("MicroMsg.SyncGetter", localInterruptedException, "", new Object[0]);
          com.tencent.mm.kernel.g.ajS().b((com.tencent.mm.kernel.api.g)localObject);
        }
      }
      finally
