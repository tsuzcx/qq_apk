  ...
  extends com.tencent.mm.plugin.appbrand.dynamic.d.a.a
{
  ...
  public final void a(com.tencent.mm.ab.c.a parama, JSONObject paramJSONObject, Bundle paramBundle, b.a<JSONObject> parama1)
  {
    ...
    c.cn(com.tencent.mm.plugin.appbrand.dynamic.h.d.z(paramJSONObject), "before_jsapi_invoke");
    parama = parama.aej();
    ...
    if (com.tencent.mm.plugin.appbrand.dynamic.d.aVe().GR(str1) == null)
    {
      ad.w("MicroMsg.JsApiFunc_DrawCanvas", "get view by viewId(%s) return null.", new Object[] { str1 });
      parama1.bl(a(false, "got 'null' when get view by the given viewId", null));
    ...
    e locale = com.tencent.mm.plugin.appbrand.dynamic.d.b.a.bt(str1, i);
    if (paramBundle != null) {}
    for (parama = paramBundle.getString("rawJsapiData");; parama = System.currentTimeMillis())
    {
      ...
      com.tencent.mm.plugin.appbrand.dynamic.d.b.a.bt(str1, i).a(localb);
      AppMethodBeat.o(121308);
      return;
    }
  }
