  ...
  extends com.tencent.mm.plugin.appbrand.dynamic.d.a.a
{
  ...
  public final void a(com.tencent.mm.aa.c.a parama, JSONObject paramJSONObject, Bundle paramBundle, b.a<JSONObject> parama1)
  {
    ...
    c.cP(com.tencent.mm.plugin.appbrand.dynamic.h.d.G(paramJSONObject), "before_jsapi_invoke");
    parama = parama.ayQ();
    ...
    if (com.tencent.mm.plugin.appbrand.dynamic.d.bBH().Yi(str1) == null)
    {
      Log.w("MicroMsg.JsApiFunc_DrawCanvas", "get view by viewId(%s) return null.", new Object[] { str1 });
      parama1.bt(a(false, "got 'null' when get view by the given viewId", null));
    ...
    e locale = com.tencent.mm.plugin.appbrand.dynamic.d.b.a.bH(str1, i);
    if (paramBundle != null) {}
    for (parama = paramBundle.getString("rawJsapiData");; parama = System.currentTimeMillis())
    {
      ...
      com.tencent.mm.plugin.appbrand.dynamic.d.b.a.bH(str1, i).a(localb);
      AppMethodBeat.o(121308);
      return;
    }
  }
