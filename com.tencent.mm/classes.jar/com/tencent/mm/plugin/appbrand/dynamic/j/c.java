...
{
  private static final String[] qGk = bc.qGk;
  ...
  private static WebResourceResponse dF(String paramString1, String paramString2)
  {
    ...
    //   13: astore_3
    //   14: aload_3
    //   15: invokevirtual 35	com/tencent/mm/plugin/appbrand/appcache/WxaPkg:cfK	()Z
    //   18: pop
    //   19: aload_3
    //   20: aload_1
    //   21: invokevirtual 39	com/tencent/mm/plugin/appbrand/appcache/WxaPkg:Va	(Ljava/lang/String;)Ljava/io/InputStream;
    //   24: astore_2
    //   25: aload_1
  ...
  private static WebResourceResponse dG(String paramString1, String paramString2)
  {
    AppMethodBeat.i(121479);
    Object localObject = k.Zc(paramString1);
    if (localObject != null) {}
    for (localObject = ((WxaWidgetContext)localObject).cnz(); localObject == null; localObject = null)
    {
    ...
    paramString1 = dF((String)localObject, paramString2);
    AppMethodBeat.o(121479);
    return paramString1;
  }
  
  private static WebResourceResponse dH(String paramString1, String paramString2)
  {
    AppMethodBeat.i(121480);
    Object localObject = k.Zc(paramString1);
    if (localObject != null) {}
    for (localObject = ((WxaWidgetContext)localObject).cnA(); localObject == null; localObject = null)
    {
    ...
    {
      paramString1 = bc.Lh(paramString2);
    ...
    paramString1 = dF(((WxaPkgWrappingInfo)localObject).pkgPath, paramString2);
    AppMethodBeat.o(121480);
    return paramString1;
  }
  ...
  public static String dI(String paramString1, String paramString2)
  {
    ...
    WebResourceResponse localWebResourceResponse = dJ(paramString1, paramString2);
  ...
  public static WebResourceResponse dJ(String paramString1, String paramString2)
  {
    ...
    if (aa.M(paramString2, "about:blank"))
    {
      AppMethodBeat.o(121482);
      return null;
    }
    if (!d.agu(paramString2))
    {
      paramString2 = t.as(paramString2, true);
      if (a.contains(qGk, paramString2))
      {
        paramString1 = dH(paramString1, paramString2);
        AppMethodBeat.o(121482);
        return paramString1;
      }
      paramString2 = dG(paramString1, paramString2);
      if (paramString2 == null)
      {
        Bundle localBundle = new Bundle();
        localBundle.putString("id", paramString1);
        localBundle.putInt("widgetState", 2102);
        j.a(i.cnw().YX(paramString1), localBundle, f.a.class, null);
      }
      AppMethodBeat.o(121482);
      return paramString2;
    }
