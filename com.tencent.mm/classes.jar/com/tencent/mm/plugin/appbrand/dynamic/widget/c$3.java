...
{
  c$3(MSurfaceView paramMSurfaceView) {}
  
  public final void adR()
  {
    v.jdMethod_if(20);
    r localr = new r();
    localr.cjv = u.jy(this.fYi.getTraceId());
    localr.cjw = u.jx(this.fYi.getTraceId());
    localr.cjs = 12L;
    localr.cju = 1L;
    localr.cjr = this.fYi.getTraceId();
  ...
  {
    c.b(paramFloat, 2, this.fYi.getTraceId());
  }
  
  public final void af(float paramFloat)
  {
    c.b(paramFloat, 3, this.fYi.getTraceId());
  }
  
  public final void b(long paramLong1, long paramLong2, int paramInt)
  {
    com.tencent.mm.plugin.appbrand.widget.f.a.c(2, paramLong1, paramLong2, paramInt);
  }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.dynamic.widget.c.3
