  ...
  extends com.tencent.mm.plugin.appbrand.dynamic.d.a.a
{
  ...
  public final void a(com.tencent.mm.ab.c.a parama, JSONObject paramJSONObject, b.a<JSONObject> parama1)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < paramJSONObject.length())
        {
          ...
          if (localJSONObject != null)
          {
            ...
            localLogInfo.gRD = localJSONObject.optLong("ts");
            ...
            ad.d("MicroMsg.JsApiFunc_Log", "ts : %s, level : %d, msg : %s", new Object[] { Util.getTimeFormat(localLogInfo.gRD), Integer.valueOf(localLogInfo.level), localLogInfo.message });
          }
        }
        else
        {
          com.tencent.mm.plugin.appbrand.dynamic.debugger.a.c(parama.aej().getString("__page_view_id", null), localArrayList);
          parama1.bl(a(true, "", null));
      ...
      {
        parama1.bl(a(false, "dataArray is null", null));
        AppMethodBeat.o(121312);
        return;
      }
      i += 1;
