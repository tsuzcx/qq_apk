      ...
      try
      {
        ...
        if (i < paramJSONObject.length())
        {
          ...
          if (localJSONObject != null)
          {
            ...
            localLogInfo.hsd = localJSONObject.optLong("ts");
            ...
            ac.d("MicroMsg.JsApiFunc_Log", "ts : %s, level : %d, msg : %s", new Object[] { Util.getTimeFormat(localLogInfo.hsd), Integer.valueOf(localLogInfo.level), localLogInfo.message });
          }
        }
        else
        {
          com.tencent.mm.plugin.appbrand.dynamic.debugger.a.c(parama.afz().getString("__page_view_id", null), localArrayList);
