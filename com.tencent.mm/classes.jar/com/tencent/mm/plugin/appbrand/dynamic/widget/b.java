...
{
  private static volatile int joB = 0;
  ...
  public static View cq(Context paramContext)
  {
    AppMethodBeat.i(121603);
    if (!sInitialized) {
      initialize();
    }
    ad.d("MicroMsg.WidgetDrawableViewFactory", "inflate(mode : %d)", new Object[] { Integer.valueOf(joB) });
    switch (joB)
    {
    default: 
      paramContext = new MHardwareAccelerateDrawableView(paramContext);
      paramContext.getDrawContext().iYR = com.tencent.mm.plugin.appbrand.dynamic.b.b.aVu();
      paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
      {
        public final void aTc()
        {
          AppMethodBeat.i(121601);
          u.va(this.joG.getTraceId());
        ...
        public final void aq(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 2, this.joG.getTraceId());
        ...
        public final void ar(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 3, this.joG.getTraceId());
        ...
        public final void mV(long paramAnonymousLong)
        {
          AppMethodBeat.i(121596);
          com.tencent.mm.plugin.appbrand.widget.f.a.G(667, paramAnonymousLong);
        ...
        public final void mW(long paramAnonymousLong)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.f.a.H(668, paramAnonymousLong);
    ...
    case 1: 
      ...
      paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
      {
        ...
        public final void aq(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 2, this.joC.getTraceId());
        ...
        public final void ar(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 3, this.joC.getTraceId());
        ...
        public final void mV(long paramAnonymousLong)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.f.a.G(682, paramAnonymousLong);
        ...
        public final void mW(long paramAnonymousLong)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.f.a.H(683, paramAnonymousLong);
    ...
    case 2: 
      ...
      paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
      {
        ...
        public final void aq(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 2, this.joD.getTraceId());
        ...
        public final void ar(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 3, this.joD.getTraceId());
    ...
    case 3: 
      ...
      paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
      {
        ...
        public final void aq(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 2, this.joE.getTraceId());
        ...
        public final void ar(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 3, this.joE.getTraceId());
        ...
        public final void mV(long paramAnonymousLong)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.f.a.G(685, paramAnonymousLong);
        ...
        public final void mW(long paramAnonymousLong)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.f.a.H(684, paramAnonymousLong);
    ...
    paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
    {
      ...
      public final void aq(float paramAnonymousFloat)
      {
        ...
        b.b(paramAnonymousFloat, 2, this.joF.getTraceId());
      ...
      public final void ar(float paramAnonymousFloat)
      {
        ...
        b.b(paramAnonymousFloat, 3, this.joF.getTraceId());
  ...
  public static void initialize()
  {
    ...
    com.tencent.mm.cj.a.post(new b.1());
