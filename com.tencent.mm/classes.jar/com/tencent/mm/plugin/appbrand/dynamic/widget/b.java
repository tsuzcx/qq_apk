...
{
  private static volatile int kmo = 0;
  ...
  public static View cy(Context paramContext)
  {
    AppMethodBeat.i(121603);
    if (!sInitialized) {
      initialize();
    }
    ae.d("MicroMsg.WidgetDrawableViewFactory", "inflate(mode : %d)", new Object[] { Integer.valueOf(kmo) });
    switch (kmo)
    {
    default: 
      paramContext = new MHardwareAccelerateDrawableView(paramContext);
      paramContext.getDrawContext().jWv = com.tencent.mm.plugin.appbrand.dynamic.b.b.bgE();
      paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
      {
        public final void ax(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 2, this.kmt.getTraceId());
        ...
        public final void ay(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 3, this.kmt.getTraceId());
        ...
        public final void sU(long paramAnonymousLong)
        {
    ...
    case 1: 
      ...
      paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
      {
        public final void ax(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 2, this.kmp.getTraceId());
        ...
        public final void ay(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 3, this.kmp.getTraceId());
    ...
    case 2: 
      ...
      paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
      {
        public final void ax(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 2, this.kmq.getTraceId());
        ...
        public final void ay(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 3, this.kmq.getTraceId());
    ...
    case 3: 
      ...
      paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
      {
        public final void ax(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 2, this.kmr.getTraceId());
        ...
        public final void ay(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 3, this.kmr.getTraceId());
    ...
    paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
    {
      public final void ax(float paramAnonymousFloat)
      {
        ...
        b.b(paramAnonymousFloat, 2, this.kms.getTraceId());
      ...
      public final void ay(float paramAnonymousFloat)
      {
        ...
        b.b(paramAnonymousFloat, 3, this.kms.getTraceId());
