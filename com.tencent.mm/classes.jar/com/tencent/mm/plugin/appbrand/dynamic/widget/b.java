...
{
  private static volatile int okI = 0;
  ...
  public static View cR(Context paramContext)
  {
    AppMethodBeat.i(121603);
    if (!sInitialized) {
      initialize();
    }
    com.tencent.mm.sdk.platformtools.Log.d("MicroMsg.WidgetDrawableViewFactory", "inflate(mode : %d)", new Object[] { Integer.valueOf(okI) });
    switch (okI)
    {
    default: 
      paramContext = new MHardwareAccelerateDrawableView(paramContext);
      paramContext.getDrawContext().nTC = com.tencent.mm.plugin.appbrand.dynamic.b.b.bNt();
      paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
      {
        public final void Hm(long paramAnonymousLong)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.h.a.J(667, paramAnonymousLong);
        ...
        public final void Hn(long paramAnonymousLong)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.h.a.K(668, paramAnonymousLong);
        ...
        public final void aH(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 2, this.okN.getTraceId());
        ...
        public final void aI(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 3, this.okN.getTraceId());
        ...
        public final void bKL()
        {
          ...
          u.SL(this.okN.getTraceId());
          AppMethodBeat.o(121601);
        }
        
        public final void e(long paramAnonymousLong1, long paramAnonymousLong2, int paramAnonymousInt)
        {
          AppMethodBeat.i(121598);
          com.tencent.mm.plugin.appbrand.widget.h.a.d(0, paramAnonymousLong1, paramAnonymousLong2, paramAnonymousInt);
    ...
    case 1: 
      ...
      paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
      {
        public final void Hm(long paramAnonymousLong)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.h.a.J(682, paramAnonymousLong);
        ...
        public final void Hn(long paramAnonymousLong)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.h.a.K(683, paramAnonymousLong);
        ...
        public final void aH(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 2, this.okJ.getTraceId());
        ...
        public final void aI(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 3, this.okJ.getTraceId());
        ...
        public final void e(long paramAnonymousLong1, long paramAnonymousLong2, int paramAnonymousInt)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.h.a.d(1, paramAnonymousLong1, paramAnonymousLong2, paramAnonymousInt);
    ...
    case 2: 
      ...
      paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
      {
        ...
        public final void aH(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 2, this.okK.getTraceId());
        ...
        public final void aI(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 3, this.okK.getTraceId());
        ...
        public final void e(long paramAnonymousLong1, long paramAnonymousLong2, int paramAnonymousInt)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.h.a.d(2, paramAnonymousLong1, paramAnonymousLong2, paramAnonymousInt);
    ...
    case 3: 
      ...
      paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
      {
        public final void Hm(long paramAnonymousLong)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.h.a.J(685, paramAnonymousLong);
        ...
        public final void Hn(long paramAnonymousLong)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.h.a.K(684, paramAnonymousLong);
        ...
        public final void aH(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 2, this.okL.getTraceId());
        ...
        public final void aI(float paramAnonymousFloat)
        {
          ...
          b.b(paramAnonymousFloat, 3, this.okL.getTraceId());
        ...
        public final void e(long paramAnonymousLong1, long paramAnonymousLong2, int paramAnonymousInt)
        {
          ...
          com.tencent.mm.plugin.appbrand.widget.h.a.d(3, paramAnonymousLong1, paramAnonymousLong2, paramAnonymousInt);
    ...
    paramContext.setDrawActionReportable(new com.tencent.mm.plugin.appbrand.canvas.c.a()
    {
      ...
      public final void aH(float paramAnonymousFloat)
      {
        ...
        b.b(paramAnonymousFloat, 2, this.okM.getTraceId());
      ...
      public final void aI(float paramAnonymousFloat)
      {
        ...
        b.b(paramAnonymousFloat, 3, this.okM.getTraceId());
      ...
      public final void e(long paramAnonymousLong1, long paramAnonymousLong2, int paramAnonymousInt)
      {
        ...
        com.tencent.mm.plugin.appbrand.widget.h.a.d(4, paramAnonymousLong1, paramAnonymousLong2, paramAnonymousInt);
  ...
  public static void initialize()
  {
    ...
    com.tencent.mm.co.a.post(new Runnable()
    {
      public final void run()
      {
        ...
        localObject = com.tencent.mm.ipcinvoker.wx_extension.a.a.Mu("100284");
        if (localObject == null)
        {
        ...
        try
        {
          b.zG(Util.getInt((String)((c)localObject).hvz().get("mode"), 0));
          com.tencent.mm.sdk.platformtools.Log.i("MicroMsg.WidgetDrawableViewFactory", "current canvas mode is : %d", new Object[] { Integer.valueOf(b.okI) });
          AppMethodBeat.o(121571);
          return;
        }
