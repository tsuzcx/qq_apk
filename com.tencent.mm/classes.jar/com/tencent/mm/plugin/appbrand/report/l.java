...
{
  public static int k(int paramInt, Bundle paramBundle)
  {
    AppMethodBeat.i(48066);
    if ((paramBundle == null) || (!tM(paramInt)))
    {
  ...
  public static String l(int paramInt, Bundle paramBundle)
  {
  ...
  private static boolean tM(int paramInt)
  {
    switch (paramInt)
    {
    default: 
