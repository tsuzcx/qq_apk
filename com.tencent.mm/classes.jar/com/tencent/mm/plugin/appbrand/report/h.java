...
{
  public static final String lpB = e.c.klF.value;
  public static final String lpC = e.c.klE.value;
  public static final String lpD = e.c.klA.value;
  public static final String lpE = e.c.klB.value;
  public static final String lpF = e.c.klC.value;
  
  public static void D(String paramString1, String paramString2, int paramInt)
  {
    AppMethodBeat.i(48064);
    AppBrandStatObject localAppBrandStatObject = com.tencent.mm.plugin.appbrand.a.CT(paramString1);
    ...
    if (localObject == null) {}
    for (int i = 0;; i = ((k)localObject).jdS.iOQ + 1)
    {
      int j = Mt(paramString1);
      String str2 = bt.nullAsNil(localAppBrandStatObject.dbt);
      ...
      try
      {
        String str1 = p.encode(bt.nullAsNil(paramString2), "UTF-8");
        localObject = str1;
      }
      ...
      com.tencent.mm.plugin.report.service.h.vKh.f(18189, new Object[] { paramString1, Integer.valueOf(i), Integer.valueOf(j), Long.valueOf(l), Integer.valueOf(localAppBrandStatObject.scene), str2, localObject, Integer.valueOf(paramInt) });
      AppMethodBeat.o(48064);
      return;
    }
  }
  ...
  public static int Mt(String paramString)
  {
    ...
    if (j < 0)
    {
      ...
      localObject = j.aOC().e(paramString, new String[] { "appInfo" });
      if (localObject == null) {
        break label83;
      }
      i = ((WxaAttributes)localObject).aTN().cIB;
      i.bM(paramString, i);
    }
    for (;;)
    {
      ...
      continue;
      label95:
      localObject = com.tencent.mm.plugin.appbrand.a.CR(paramString);
      if (localObject == null) {}
      for (localObject = null;; localObject = ((o)localObject).aNc())
      {
        if (localObject == null) {
          break label131;
        }
        i = ((AppBrandInitConfigWC)localObject).cfd;
        i.bM(paramString, i);
        break;
      }
      label131:
  ...
  public static void R(String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      localObject = com.tencent.mm.plugin.appbrand.a.CT(paramString);
      if (localObject != null) {
        if (((AppBrandStatObject)localObject).scene == 0)
        {
          i = 1000;
          str = bt.nullAsNil(((AppBrandStatObject)localObject).dbt);
          j = ((AppBrandStatObject)localObject).lpL;
          localObject = com.tencent.mm.plugin.appbrand.a.CS(paramString);
          k = m;
          if (localObject != null)
          {
            k = m;
            if (((k)localObject).jdS != null) {
              k = ((k)localObject).jdS.pkgVersion;
            }
          }
          m = paramInt2;
          if (paramInt2 == 0)
    ...
    for (;;)
    {
      ...
      com.tencent.mm.plugin.report.service.h.vKh.f(13541, new Object[] { Integer.valueOf(i), str, paramString, Integer.valueOf(m), Integer.valueOf(paramInt2), Integer.valueOf(k), Integer.valueOf(paramInt1), Integer.valueOf(3), "", Integer.valueOf(j) });
      ...
      if (("wxb6d22f922f37b35a".equals(paramString)) && (paramInt2 <= 1)) {
        com.tencent.mm.plugin.report.service.h.vKh.dB(1089, paramInt1);
      }
      AppMethodBeat.o(48053);
      return;
  ...
  public static void a(int paramInt1, String paramString1, String paramString2, int paramInt2, String paramString3, String paramString4)
  {
    ...
    com.tencent.mm.plugin.report.service.h.vKh.f(13533, new Object[] { Integer.valueOf(paramInt1), bt.nullAsNil(paramString1), Integer.valueOf(0), paramString2, Integer.valueOf(paramInt2), paramString3, Integer.valueOf(0), paramString4 });
  ...
  public static void a(String paramString, int paramInt1, int paramInt2, long paramLong, boolean paramBoolean)
  {
    ...
    Object localObject2 = q.dC(aj.getContext());
    Object localObject1 = localObject2;
    if (bt.isNullOrNil((String)localObject2)) {
      localObject1 = lpB;
    }
    int j = Mt(paramString);
    long l = bt.aGK();
    ...
    for (int i = 1;; i = 0)
    {
      ((com.tencent.mm.plugin.report.service.h)localObject2).f(13537, new Object[] { Integer.valueOf(1000), "", "", paramString, Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), "", localObject1, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(0), Long.valueOf(paramLong), Long.valueOf(l), Integer.valueOf(i), Integer.valueOf(j) });
  ...
  public static void a(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, int paramInt3, String paramString5, long paramLong, int paramInt4, int paramInt5)
  {
    ...
    try
    {
      str2 = p.encode(bt.nullAsNil(str1), "UTF-8");
      paramString4 = str2;
    }
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
    ...
    {
      i = paramInt1 - 1;
      bool = j.aOI().aY(paramString1, i);
      if (j.aOJ().aV(paramString1, i)) {
        i = 1;
      }
    }
    else
  ...
  public static void a(String paramString1, String paramString2, int paramInt1, String paramString3, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    try
    {
      paramString2 = p.encode(bt.nullAsNil(str1), "UTF-8");
      str2 = paramString2;
    }
    catch (UnsupportedEncodingException paramString2)
    {
      for (;;)
      {
        ...
        continue;
        int i = paramString2.jdS.pkgVersion;
        continue;
        int j = paramString2.jdS.iOQ + 1;
      }
    }
    paramString2 = com.tencent.mm.plugin.appbrand.a.CS(paramString1);
    ...
    try
    {
      paramString3 = p.encode(bt.nullAsNil(paramString2), "UTF-8");
    ...
    str4 = bt.nullAsNil(localAppBrandStatObject.dbt);
    paramString3 = null;
    try
    {
      str3 = bt.nullAsNil(com.tencent.mm.plugin.appbrand.a.CR(paramString1).aNc().Da());
      paramString3 = str3;
    }
    ...
    k = localAppBrandStatObject.dzS;
    str3 = localAppBrandStatObject.dzT;
    m = Mt(paramString1);
    ad.d("MicroMsg.AppBrandReporterManager", "stev report(%s), scene : %d, sceneNote : %s, sessionId : %s, appid : %s, appversion : %d, appState : %d, usedState : %d, pagePath : %s, action : %d, actionNote : %s,actionTime : %s, actionResult : %d, actionErrorcode : %d, preScene : %d, preSceneNote : %s, appType : %d", new Object[] { Integer.valueOf(13539), Integer.valueOf(localAppBrandStatObject.scene), str4, paramString3, paramString1, Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(localAppBrandStatObject.lpL), str1, Integer.valueOf(paramInt1), paramString2, Long.valueOf(paramLong), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), Integer.valueOf(k), str3, Integer.valueOf(m) });
    com.tencent.mm.plugin.report.service.h.vKh.f(13539, new Object[] { Integer.valueOf(localAppBrandStatObject.scene), str4, paramString3, paramString1, Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(localAppBrandStatObject.lpL), str2, Integer.valueOf(paramInt1), paramString2, Long.valueOf(paramLong), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), Integer.valueOf(k), str3, Integer.valueOf(m) });
    AppMethodBeat.o(48050);
  }
  ...
  public static void an(int paramInt, String paramString)
  {
    ...
    List localList = ((ah)com.tencent.mm.kernel.g.ab(ah.class)).a(2147483647, ah.a.iVL);
    StringBuilder localStringBuilder = new StringBuilder();
    localList = b.L(localList);
    ...
    com.tencent.mm.plugin.report.service.h.vKh.f(13800, new Object[] { Integer.valueOf(paramInt), Integer.valueOf(((ah)com.tencent.mm.kernel.g.ab(ah.class)).getCount()), localStringBuilder.toString(), Long.valueOf(System.currentTimeMillis()), paramString });
  ...
  public static void ao(int paramInt, String paramString)
  {
    ...
    com.tencent.mm.plugin.report.service.h.vKh.f(15651, new Object[] { Integer.valueOf(paramInt), bt.nullAsNil(paramString) });
  ...
  public static void bmj()
  {
    ...
    int i = bt.iT(((com.tencent.mm.kernel.b.h)com.tencent.mm.kernel.g.afy().aeZ()).ca);
    ad.i("MicroMsg.AppBrandReporterManager", "report now process mem : %d", new Object[] { Integer.valueOf(bt.iT(((com.tencent.mm.kernel.b.h)com.tencent.mm.kernel.g.afy().aeZ()).ca)) });
    if (i <= 90) {
      i = 2;
    }
    for (;;)
    {
      com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(386L, 1L, 1L, false);
      com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(386L, i, 1L, false);
  ...
  public static void c(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (int j = 775;; j = 367)
    {
      ...
      if (paramLong <= 2000L) {
        ...
        {
          i = 8;
          com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(j, i, 1L, false);
          if (!paramBoolean1) {
            break label346;
          }
          com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(j, 7L, 1L, false);
        }
      }
      for (;;)
      {
        ...
        break;
        label346:
        com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(j, 0L, 1L, false);
      }
    }
  }
  ...
  public static String getNetworkType(Context paramContext)
  {
    ...
    paramContext = q.dC(paramContext);
  ...
  public static void tL(int paramInt)
  {
    ...
    com.tencent.mm.plugin.report.service.h.vKh.dB(891, paramInt);
  ...
  public static void u(boolean paramBoolean, int paramInt)
  {
    ...
    case 10: 
      if (paramBoolean) {
        com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(386L, 13L, 1L, false);
      }
      for (;;)
      {
        com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(386L, 8L, 1L, false);
        AppMethodBeat.o(196075);
        return;
        com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(386L, 12L, 1L, false);
      }
    case 15: 
      if (paramBoolean) {
        com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(386L, 11L, 1L, false);
      }
      for (;;)
      {
        com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(386L, 7L, 1L, false);
        AppMethodBeat.o(196075);
        return;
        com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(386L, 10L, 1L, false);
      }
    }
    if (paramBoolean) {
      com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(386L, 15L, 1L, false);
    }
    for (;;)
    {
      com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(386L, 9L, 1L, false);
      break;
      com.tencent.mm.plugin.report.service.h.vKh.idkeyStat(386L, 14L, 1L, false);
    }
  }
}
