...
@l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/appbrand/report/AppBrandServiceWCScriptReporter;", "", "()V", "TAG", "", "reportEvaluateResult", "", "service", "Lcom/tencent/mm/plugin/appbrand/service/AppBrandServiceWC;", "scriptInfo", "Lcom/tencent/luggage/sdk/jsapi/component/IAppBrandComponentWxaSharedLU$JavascriptInfo;", "succeed", "", "startTimeMs", "", "endTimeMs", "extraParams", "reportJSError", "message", "stackTrace", "plugin-appbrand-integration_release"})
public final class j
{
  ...
  public static void a(com.tencent.mm.plugin.appbrand.service.c paramc, d.a parama, boolean paramBoolean, long paramLong1, long paramLong2, Object paramObject)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if ((parama.cgj <= 0) && (localObject1 != null)) {}
    }
    else
    {
    ...
    for (;;)
    {
      if (n.mB((String)localObject1, "/app-service.js"))
      {
        com.tencent.mm.plugin.report.service.h.vKh.dB(370, 30);
        if (paramBoolean)
        {
          com.tencent.mm.plugin.report.service.h.vKh.dB(370, 31);
          AppMethodBeat.o(175210);
          return;
          ...
          case -979125780: 
            ...
            com.tencent.mm.plugin.report.service.h.vKh.dB(370, 73);
            break;
          case 2071195020: 
            if (!((String)localObject1).equals("WAService.js")) {
              break;
            }
            com.tencent.mm.plugin.report.service.h.vKh.dB(370, 72);
            break;
            switch (((String)localObject1).hashCode())
            {
            default: 
            ...
            case -979125780: 
              if (((String)localObject1).equals("WAServiceMainContext.js"))
              {
                ...
                {
                  a.bmM();
                  b.a(paramc, (String)localObject1, parama.cgj, paramLong1, paramLong2, paramObject);
                  switch (((String)localObject1).hashCode())
                  {
                  default: 
                    ...
                    j = ((Number)parama.JfT).intValue();
                    com.tencent.mm.plugin.report.service.h.vKh.dB(370, i);
                    if (paramBoolean)
                    {
                      com.tencent.mm.plugin.report.service.h.vKh.dB(370, j);
                      AppMethodBeat.o(175210);
                      return;
                    }
                    break;
            ...
            case 452806299: 
              if (((String)localObject1).equals("WAGame.js")) {
                if (!paramBoolean)
                {
                  ...
                  h.b(parama, i, paramc.aLI(), 778, 14);
                  AppMethodBeat.o(175210);
                  return;
                }
              }
            ...
            case 293174862: 
              ...
              {
                com.tencent.mm.plugin.report.service.h.vKh.dB(370, 9);
                if (paramBoolean) {
    ...
    for (;;)
    {
      ...
      for (i = ((AppBrandRuntime)localObject2).hashCode();; i = -1)
      {
        ...
        com.tencent.mm.plugin.report.service.h.vKh.dB(370, 11);
        AppMethodBeat.o(175210);
        return;
        if (!((String)localObject1).equals("WAService.js")) {
          break;
        ...
        break label444;
        com.tencent.mm.plugin.report.service.h.vKh.dB(370, k);
        h.bL(paramc.getAppId(), 24);
        if (paramc.getRuntime() != null)
        {
      ...
      try
      {
        com.tencent.mm.plugin.report.service.h.vKh.dB(370, 10);
        h.bL(paramc.getAppId(), 24);
        h.b(paramc.getAppId(), paramc.getRuntime().aNb().jdS.pkgVersion, paramc.getRuntime().aNb().jdS.iOQ, 370, 10);
        AppMethodBeat.o(175210);
        return;
      }
      ...
      com.tencent.mm.plugin.report.service.h.vKh.dB(370, 32);
      AppMethodBeat.o(175210);
      return;
    }
  }
  ...
  public static final void b(com.tencent.mm.plugin.appbrand.service.c paramc, String paramString1, String paramString2)
  {
    ...
    k.h(paramc, "service");
    QualitySessionRuntime localQualitySessionRuntime = a.ME(paramc.getAppId());
    if (localQualitySessionRuntime != null)
    {
      gn localgn = new gn();
      localgn.mb(localQualitySessionRuntime.appId);
      localgn.kg(localQualitySessionRuntime.lty);
      localgn.kh(localQualitySessionRuntime.lrW);
      localgn.Sl();
      localgn.mc(paramString1);
      localgn.md(paramString2);
      paramString1 = paramc.aLC();
      if (paramString1 == null) {
        k.fvU();
      }
      localgn.me(paramString1.aPa());
      localgn.ki(localQualitySessionRuntime.apptype);
      localgn.kj(localQualitySessionRuntime.ltL.get());
      paramString1 = paramc.aMZ();
      k.g(paramString1, "page");
      paramc = paramString1.getURL();
      paramString1 = paramString1.bjJ();
