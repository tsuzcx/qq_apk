...
public final class KSProcessWeAppLaunch
{
  ...
  static
  {
    ...
    stepInitRuntimeGroup = new e("WeAppLaunch", "InitRuntimeGroup", true, false, "", 3, 1, 5, "mp");
    sStepNodes.add((d)stepInitRuntimeGroup);
    stepServiceInit = new e("WeAppLaunch", "ServiceInit", true, false, "", 2, 5, 6, "");
    sStepNodes.add((d)stepServiceInit);
    stepInjectJSWAMainContext = new e("WeAppLaunch", "InjectJSWAMainContext", true, true, "注入WAMainContext.js (Service)", 1, 6, -2147483648, "");
    sStepNodes.add((d)stepInjectJSWAMainContext);
    stepInjectJSWASubContext = new e("WeAppLaunch", "InjectJSWASubContext", true, true, "注入WASubContext.js (Service)", 1, 6, -2147483648, "");
    sStepNodes.add((d)stepInjectJSWASubContext);
    stepInjectJSAppService = new e("WeAppLaunch", "InjectJSAppService", true, true, "注入appservice.js (Service)", 1, 6, -2147483648, "");
    sStepNodes.add((d)stepInjectJSAppService);
    stepInjectWxConfig = new e("WeAppLaunch", "InjectWxConfig", true, true, "注入wxConfig (Service)", 1, 6, -2147483648, "");
    sStepNodes.add((d)stepInjectWxConfig);
    stepPageInit = new e("WeAppLaunch", "PageInit", true, false, "", 2, 5, 7, "");
    sStepNodes.add((d)stepPageInit);
    stepPageInitUIGroup = new e("WeAppLaunch", "PageInitUIGroup", true, false, "", 3, 7, 8, "");
    sStepNodes.add((d)stepPageInitUIGroup);
    stepCreatePageUI = new e("WeAppLaunch", "CreatePageUI", true, false, "首页界面创建", 1, 8, -2147483648, "");
    sStepNodes.add((d)stepCreatePageUI);
    stepCreateWebViewInstance = new e("WeAppLaunch", "CreateWebViewInstance", true, true, "", 1, 8, -2147483648, "");
    sStepNodes.add((d)stepCreateWebViewInstance);
    stepInjectWAPageFrameHtml = new e("WeAppLaunch", "InjectWAPageFrameHtml", true, true, "注入WAPageframe.html (View)", 1, 7, -2147483648, "");
    sStepNodes.add((d)stepInjectWAPageFrameHtml);
    stepInjectJSWAWebview = new e("WeAppLaunch", "InjectJSWAWebview", true, true, "注入WAWebview.js (View)", 1, 7, -2147483648, "");
    sStepNodes.add((d)stepInjectJSWAWebview);
    stepInjectJSPageScript = new e("WeAppLaunch", "InjectJSPageScript", true, false, "页面js注入 (View)", 1, 7, -2147483648, "");
    sStepNodes.add((d)stepInjectJSPageScript);
    stepGenerateFuncReadyRespond = new e("WeAppLaunch", "GenerateFuncReadyRespond", false, false, "webview发出的GenerateFuncReady被appservice响应 (View)", 1, 7, -2147483648, "");
    sStepNodes.add((d)stepGenerateFuncReadyRespond);
    stepVdSync = new e("WeAppLaunch", "VdSync", true, false, "第一次VdSync (View) ", 1, 7, -2147483648, "");
    sStepNodes.add((d)stepVdSync);
    stepPageReady = new e("WeAppLaunch", "PageReady", true, false, "page ready (View)", 1, 7, -2147483648, "");
    sStepNodes.add((d)stepPageReady);
    stepInitRuntimeGroup_Game = new e("WeAppLaunch", "InitRuntimeGroup_Game", true, false, "", 3, 1, 9, "game");
    sStepNodes.add((d)stepInitRuntimeGroup_Game);
    stepServiceInit_Game = new e("WeAppLaunch", "ServiceInit_Game", true, false, "", 2, 9, 10, "");
    sStepNodes.add((d)stepServiceInit_Game);
    stepInjectWAGameContext = new e("WeAppLaunch", "InjectWAGameContext", true, true, "注入 WAGame.js (Service)", 1, 10, -2147483648, "");
    sStepNodes.add((d)stepInjectWAGameContext);
    stepInjectWAGameSubContext = new e("WeAppLaunch", "InjectWAGameSubContext", true, true, "注入 WAGameSubContext.js (Service) ", 1, 10, -2147483648, "");
    sStepNodes.add((d)stepInjectWAGameSubContext);
    stepInjectJSGame = new e("WeAppLaunch", "InjectJSGame", true, true, "注入game.js (Service)", 1, 10, -2147483648, "");
    sStepNodes.add((d)stepInjectJSGame);
    stepInjectWxConfig_Game = new e("WeAppLaunch", "InjectWxConfig_Game", true, true, "注入wxConfig (Service)", 1, 10, -2147483648, "");
    sStepNodes.add((d)stepInjectWxConfig_Game);
    stepPageInit_Game = new e("WeAppLaunch", "PageInit_Game", true, false, "", 2, 9, 11, "");
    sStepNodes.add((d)stepPageInit_Game);
    stepPageInitUIGroup_Game = new e("WeAppLaunch", "PageInitUIGroup_Game", true, false, "", 3, 11, 12, "");
    sStepNodes.add((d)stepPageInitUIGroup_Game);
    stepCreatePageUI_Game = new e("WeAppLaunch", "CreatePageUI_Game", true, false, "首页界面创建", 1, 12, -2147483648, "");
    sStepNodes.add((d)stepCreatePageUI_Game);
    stepCreateMagicBrushView = new e("WeAppLaunch", "CreateMagicBrushView", true, true, "", 1, 12, -2147483648, "");
    sStepNodes.add((d)stepCreateMagicBrushView);
    stepSurfaceAvailable = new e("WeAppLaunch", "SurfaceAvailable", true, false, "SurfaceAvailable (View)", 1, 11, -2147483648, "");
    sStepNodes.add((d)stepSurfaceAvailable);
    stepPageReady_Game = new e("WeAppLaunch", "PageReady_Game", true, false, "page ready (View)", 1, 11, -2147483648, "");
