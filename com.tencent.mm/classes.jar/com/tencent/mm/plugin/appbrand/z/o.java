...
public final class o
{
  public static <T extends a> String a(Context paramContext, String paramString, T paramT)
  {
    ...
    String str = "Luggage.UserAgentUtil, appendUserAgent fail, context is null, stack = " + bs.eWi();
    boolean bool;
    ...
    for (paramContext = "arm64";; paramContext = "arm32")
    {
      ...
      ac.i("Luggage.UserAgentUtil", "appendUserAgent, uaStr = ".concat(String.valueOf(paramContext)));
      AppMethodBeat.o(140851);
      return paramContext;
      bool = false;
      break;
      paramContext = paramString + paramT.Cx();
      break label48;
    }
  }
