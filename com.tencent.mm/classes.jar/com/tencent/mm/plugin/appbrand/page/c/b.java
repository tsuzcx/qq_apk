  ...
  extends c<o>
{
  ...
  private static void a(o paramo, int paramInt)
  {
    ...
    Object localObject = paramo.aNd();
    k.g(localObject, "runtime.pageContainer");
    localObject = ((u)localObject).getCurrentPage();
    if (localObject != null)
    {
      e locale = ((q)localObject).getNavigateBackInterceptionInfo();
      if (locale != null)
      {
        h localh = h.vKh;
        ...
        if (paramInt == 1) {}
        for (localObject = locale.lgT;; localObject = "")
        {
  ...
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/appbrand/page/navigation/AppBrandPageNavigateBackInterceptorWC$Companion;", "", "()V", "REPORT_EVENT_CLICK_LEAVE_BUTTON", "", "REPORT_EVENT_CLICK_STAY_BUTTON", "REPORT_EVENT_SHOW_DIALOG", "TAG", "", "plugin-appbrand-integration_release"})
