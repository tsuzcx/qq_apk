  ...
  implements DialogInterface
{
  ...
  public m(final Context paramContext)
  {
    ...
    a((SwipeBackLayout.a)new SwipeBackLayout.b()
    {
      ...
      public final void cdv()
      {
        ...
        this.qpU.post((Runnable)new a(this));
        ...
        implements Runnable
      {
        ...
        public final void run()
        {
          ...
          ViewParent localViewParent = this.qpV.qpU.getParent();
          ...
          if (localObject != null)
          {
            ((ViewGroup)localObject).removeView((View)this.qpV.qpU);
    ...
    ((com.tencent.mm.ui.statusbar.b)localObject1).GZ(false);
    ((com.tencent.mm.ui.statusbar.b)localObject1).T(0, true);
    this.qpS = ((com.tencent.mm.ui.statusbar.b)localObject1);
    addView((View)this.qpS, new ViewGroup.LayoutParams(-1, -1));
    setContentView((View)this.qpS);
    ...
    Object localObject2 = this.qpS;
    if (localObject2 == null) {
      p.iCn();
    }
    ((com.tencent.mm.ui.statusbar.b)localObject2).addView((View)localObject1, (ViewGroup.LayoutParams)new FrameLayout.LayoutParams(-1, com.tencent.mm.plugin.appbrand.widget.b.ew(paramContext)));
    this.nzU = ((com.tencent.mm.plugin.appbrand.widget.actionbar.b)localObject1);
    localObject1 = LayoutInflater.from(paramContext).inflate(au.g.app_brand_modularizing_error_view, (ViewGroup)this.qpS, false);
    ((TextView)((View)localObject1).findViewById(au.f.app_brand_error_page_reason)).setText(au.i.app_brand_modularizing_error_replay_tips);
    ((TextView)((View)localObject1).findViewById(au.f.app_brand_error_page_index)).setText(au.i.app_brand_modularizing_error_replay_confirm_tips);
    localObject2 = this.qpS;
    if (localObject2 == null) {
      p.iCn();
    }
    ...
    if (localObject1 != null) {
      ((ViewGroup.MarginLayoutParams)localObject1).topMargin = com.tencent.mm.plugin.appbrand.widget.b.ew(paramContext);
    }
    this.qpT = ((ImageView)findViewById(au.f.app_brand_error_page_iv));
    findViewById(au.f.app_brand_error_page_index).setOnClickListener((View.OnClickListener)new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        ...
        a.c("com/tencent/mm/plugin/appbrand/page/AppBrandModularizingErrorReplayView$5", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aFi());
        paramAnonymousView = this.qpU.getPositiveButton();
        if (paramAnonymousView != null) {
          paramAnonymousView.onClick((DialogInterface)this.qpU, -1);
        }
  ...
  public final void cancel()
  {
    ...
    dismiss();
    DialogInterface.OnClickListener localOnClickListener = this.qpP;
  ...
  public final void dismiss()
  {
    ...
    Animation localAnimation = this.qpQ;
    if (localAnimation != null) {
      localAnimation.cancel();
    }
    this.qpQ = AnimationUtils.loadAnimation(getContext(), MMFragmentActivity.a.rib);
    localAnimation = this.qpQ;
    if (localAnimation == null) {
      p.iCn();
    }
  ...
  public final boolean dispatchKeyEventPreIme(KeyEvent paramKeyEvent)
  {
    ...
    if ((this.qpQ != null) || (this.qpR != null))
    {
  ...
  {
    this.qpP = paramOnClickListener;
  }
  
  public final void setPositiveButton(DialogInterface.OnClickListener paramOnClickListener)
  {
    this.qpO = paramOnClickListener;
  }
  
  @l(iBK={1, 1, 16}, iBL={""}, iBM={"<anonymous>", "", "it", "Landroid/view/View;", "kotlin.jvm.PlatformType", "onClick", "com/tencent/mm/plugin/appbrand/page/AppBrandModularizingErrorReplayView$3$1"})
  static final class a
    implements View.OnClickListener
  {
    ...
    public final void onClick(View paramView)
    {
      ...
      com.tencent.mm.hellhoundlib.b.b localb = new com.tencent.mm.hellhoundlib.b.b();
      localb.bn(paramView);
      a.c("com/tencent/mm/plugin/appbrand/page/AppBrandModularizingErrorReplayView$$special$$inlined$apply$lambda$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aFi());
      this.qpU.dismiss();
  ...
  @l(iBK={1, 1, 16}, iBL={""}, iBM={"<anonymous>", "", "it", "Landroid/view/View;", "kotlin.jvm.PlatformType", "onClick", "com/tencent/mm/plugin/appbrand/page/AppBrandModularizingErrorReplayView$3$2"})
  static final class b
    implements View.OnClickListener
  {
    b(m paramm, Context paramContext) {}
    ...
    public final void onClick(View paramView)
    {
      ...
      com.tencent.mm.hellhoundlib.b.b localb = new com.tencent.mm.hellhoundlib.b.b();
      localb.bn(paramView);
      a.c("com/tencent/mm/plugin/appbrand/page/AppBrandModularizingErrorReplayView$$special$$inlined$apply$lambda$2", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aFi());
      paramView = m.b(this.qpU);
      if (paramView != null)
      {
        paramView = paramView.getRuntime();
        if (paramView != null)
        {
          k.a(paramView.getAppId(), k.d.ntb);
          paramView.close();
        }
      }
  ...
  @l(iBK={1, 1, 16}, iBL={""}, iBM={"com/tencent/mm/plugin/appbrand/page/AppBrandModularizingErrorReplayView$dismiss$1", "Lcom/tencent/mm/ui/widget/MMAnimationListenerAdapter;", "onAnimationEnd", "", "animation", "Landroid/view/animation/Animation;", "plugin-appbrand-integration_release"})
    ...
    extends e
  {
      ...
      implements Runnable
    {
      ...
      public final void run()
      {
        ...
        this.qpW.qpU.cleanup();
        AppMethodBeat.o(50918);
      }
    }
  }
  
  @l(iBK={1, 1, 16}, iBL={""}, iBM={"com/tencent/mm/plugin/appbrand/page/AppBrandModularizingErrorReplayView$show$1", "Lcom/tencent/mm/ui/widget/MMAnimationListenerAdapter;", "onAnimationEnd", "", "animation", "Landroid/view/animation/Animation;", "plugin-appbrand-integration_release"})
