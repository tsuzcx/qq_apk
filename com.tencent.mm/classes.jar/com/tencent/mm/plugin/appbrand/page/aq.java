...
public class aq
{
  ...
  public final WebResourceResponse LJ(String paramString)
  {
    ...
    {
      localObject2 = be.e(this.cdz.getRuntime(), paramString.replaceFirst((String)localObject2, ""));
    ...
    for (;;)
    {
      ...
      localObject2 = new i();
      this.cdz.getRuntime().Ee().b(paramString, (i)localObject2);
  ...
  public final boolean a(SslCertificate paramSslCertificate)
  {
    ...
    if (this.cdz.getRuntime() == null)
    {
      AppMethodBeat.o(135249);
      return false;
    }
    if (this.lek == null) {
      this.lek = j.b((com.tencent.mm.plugin.appbrand.q.a)this.cdz.getRuntime().ar(com.tencent.mm.plugin.appbrand.q.a.class));
    }
    if (this.lek == null)
    {
      AppMethodBeat.o(135249);
    ...
    for (;;)
    {
      ...
      try
      {
        this.lek.checkServerTrusted(new X509Certificate[] { paramSslCertificate }, "generic");
        bool = true;
      }
      catch (Exception paramSslCertificate)
      {
