  ...
  implements d<T>
{
  ...
  public final boolean a(final T paramT, String paramString, final Runnable paramRunnable)
  {
    ...
    Object localObject1 = paramT.aSA();
    d.g.b.k.g(localObject1, "runtime.pageContainer");
    localObject1 = ((u)localObject1).getCurrentPage();
    if (localObject1 != null) {}
    for (localObject1 = ((r)localObject1).getNavigateBackInterceptionInfo(); localObject1 == null; localObject1 = null)
    {
      ac.i("MicroMsg.BaseAppBrandPageNavigateBackInterceptor", "navigateBackInterceptionInfo is null");
      AppMethodBeat.o(176463);
      return false;
    }
    if (!((e)localObject1).enable)
    {
      ac.i("MicroMsg.BaseAppBrandPageNavigateBackInterceptor", "navigateBackInterceptionInfo.enable = " + ((e)localObject1).enable);
      AppMethodBeat.o(176463);
      return false;
    }
    ...
    {
      ac.i("MicroMsg.BaseAppBrandPageNavigateBackInterceptor", "scene[" + paramString + "], no necessary to intercept");
      AppMethodBeat.o(176463);
      return false;
    }
    Object localObject2 = paramT.aSA();
    d.g.b.k.g(localObject2, "runtime.pageContainer");
    if (((u)localObject2).getPageCount() <= 1)
    {
      ac.i("MicroMsg.BaseAppBrandPageNavigateBackInterceptor", "leave current wxa, can't intercept");
      AppMethodBeat.o(176463);
      return false;
    }
    if (!l(paramT, paramString))
    {
      ac.i("MicroMsg.BaseAppBrandPageNavigateBackInterceptor", "custom intercept return false");
      AppMethodBeat.o(176463);
      return false;
    }
    ac.i("MicroMsg.BaseAppBrandPageNavigateBackInterceptor", "show navigate back interception dialog");
    localObject2 = new b((Context)paramT.getContext());
    if (bs.isNullOrNil(((e)localObject1).lGN)) {}
    for (paramString = "";; paramString = ((e)localObject1).lGN)
    {
  ...
  @l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lcom/tencent/mm/plugin/appbrand/page/navigation/BaseAppBrandPageNavigateBackInterceptor$Companion;", "", "()V", "TAG", "", "luggage-wxa-app_release"})
  public static final class a {}
  
  @l(fNY={1, 1, 16}, fNZ={""}, fOa={"<anonymous>", "", "T", "Lcom/tencent/mm/plugin/appbrand/AppBrandRuntime;", "dialog", "Landroid/content/DialogInterface;", "kotlin.jvm.PlatformType", "<anonymous parameter 1>", "", "onClick"})
    ...
    implements DialogInterface.OnClickListener
  {
    ...
    public final void onClick(DialogInterface paramDialogInterface, int paramInt)
    {
      ...
      c localc = this.lGK;
      paramRunnable.run();
      ac.i("MicroMsg.BaseAppBrandPageNavigateBackInterceptor", "dialog confirm to navigate back");
      localc.ap(paramT);
    ...
    implements DialogInterface.OnClickListener
  {
    ...
    public final void onClick(DialogInterface paramDialogInterface, int paramInt)
    {
      ...
      c localc = this.lGK;
      ac.i("MicroMsg.BaseAppBrandPageNavigateBackInterceptor", "keep staying current page");
      localc.ao(paramT);
      paramDialogInterface.dismiss();
