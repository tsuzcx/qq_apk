...
{
  AppBrandMenuHeader$4(AppBrandMenuHeader paramAppBrandMenuHeader, l paraml, ah paramah) {}
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bn(paramView);
    a.c("com/tencent/mm/plugin/appbrand/page/AppBrandMenuHeader$4", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aFi());
    new l.6(this.qpA, this.qpB).run();
