...
@l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/appbrand/page/MPPageViewActionBarExtensionImpl;", "Lcom/tencent/mm/plugin/appbrand/page/extensions/AppBrandPageViewActionBarExtension;", "page", "Lcom/tencent/mm/plugin/appbrand/page/AppBrandPageView;", "(Lcom/tencent/mm/plugin/appbrand/page/AppBrandPageView;)V", "applyActionBarSizeProperty", "", "actionBar", "Lcom/tencent/mm/plugin/appbrand/widget/actionbar/AppBrandActionBar;", "onActionbarInstalled", "onBackground", "onConfigurationChanged", "newConfig", "Landroid/content/res/Configuration;", "onDestroy", "onForeground", "Companion", "luggage-wechat-full-sdk_release"})
public final class bh
  implements a
{
  public static final bh.a meH;
  ...
  private static void c(b paramb)
  {
    ...
    label238:
    for (int i = ((b.c)localObject2).buX();; i = b.c.mTY)
    {
      paramb.bCk();
      p.g(localObject1, "context");
  ...
  public final void onConfigurationChanged(Configuration paramConfiguration)
  {
    ...
    paramConfiguration = this.clu.bux();
