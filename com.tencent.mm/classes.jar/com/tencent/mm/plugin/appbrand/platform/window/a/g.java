...
public final class g
  implements c
{
  private static final SparseArray<g> nEQ;
  private int mCurrentOrientation;
  public boolean mFinished;
  private b nER;
  private b nES;
  private ContentObserver nET;
  private e.b nEU;
  private h nEV;
  ...
  private g(Activity paramActivity)
  {
    ...
    this.nhy = new WeakReference(paramActivity);
    a(paramActivity, iz(bTQ()));
  ...
  public static g E(Activity paramActivity)
  {
    ...
    synchronized (nEQ)
    {
      g localg2 = (g)nEQ.get(paramActivity.hashCode());
      g localg1 = localg2;
      if (localg2 == null)
      {
        localg1 = new g(paramActivity);
        nEQ.put(paramActivity.hashCode(), localg1);
      }
  ...
  private e.b Q(int paramInt, boolean paramBoolean)
  {
  ...
  private static void a(Activity paramActivity, e.b paramb)
  {
    ...
    paramActivity.setRequestedOrientation(paramb.nEr);
  ...
  private void a(final b paramb)
  {
    ...
    final Activity localActivity = (Activity)this.nhy.get();
    if (localActivity == null)
    {
      Log.w("MicroMsg.AppBrandDeviceOrientationHandler", "hy: ui already released!");
      if (paramb.nEY != null) {
        paramb.nEY.a(paramb.nEZ, false);
      }
      AppMethodBeat.o(176724);
      return;
    }
    a(localActivity, paramb.nEZ);
    if (b(paramb))
    {
      d(paramb.nEZ);
      AppMethodBeat.o(176724);
  ...
  private void a(e.b paramb, List<a> paramList)
  {
    ...
    if (paramb == this.nES.nEZ)
    {
      if (this.nES.nEY != null) {
        paramList.add(new a(this.nES.nEY, paramb, true, "PendingRequest.Listener orientation equal direct", (byte)0));
      }
      this.nES = null;
      AppMethodBeat.o(176730);
      return;
    }
    if ((Activity)this.nhy.get() == null)
    {
      Log.e("MicroMsg.AppBrandDeviceOrientationHandler", "No Activity when handle pending request");
      if (this.nES.nEY != null) {
        paramList.add(new a(this.nES.nEY, paramb, false, "PendingRequest.Listener activity == null", (byte)0));
      }
      AppMethodBeat.o(176730);
      return;
    }
  ...
  private boolean b(b paramb)
  {
    ...
    Log.i("MicroMsg.AppBrandDeviceOrientationHandler", "current orientation=" + this.mCurrentOrientation + "  request orientation=" + paramb.nEZ);
    if ((this.mCurrentOrientation == 2) && ((paramb.nEZ.b(e.b.nEn)) || (paramb.nEZ.b(e.b.nEp)) || (paramb.nEZ.b(e.b.nEq))))
    {
      Log.d("MicroMsg.AppBrandDeviceOrientationHandler", "hy: same landscape");
      AppMethodBeat.o(176725);
      return true;
    }
    if ((this.mCurrentOrientation == 1) && (paramb.nEZ.b(e.b.nEl)))
    {
  ...
  private void d(e.b paramb)
  {
    ...
    Object localObject1 = (Activity)this.nhy.get();
    Object localObject2;
    boolean bool1;
      ...
      try
      {
        ...
        else
        {
          ...
          for (localObject1 = "null";; localObject1 = paramb.name())
          {
            ...
            if (this.nER.nEY != null)
            {
              localObject1 = this.nER.nEY;
              bool1 = bool3;
              if (paramb != null)
              {
                bool1 = bool3;
                if (paramb.b(this.nER.nEZ)) {
                  bool1 = true;
                }
              }
  ...
  public final void a(e.b paramb, e.a parama)
  {
    ...
    Object localObject = (Activity)this.nhy.get();
    e.b localb = iz(bTQ());
    Log.i("MicroMsg.AppBrandDeviceOrientationHandler", "requestDeviceOrientation reqOrientation = [%s], listener = [%s] currentOrientation = [%s], latestOrientation = [%s]", new Object[] { paramb, parama, localb, this.nEU });
    if (localObject == null)
    {
    ...
    if ((paramb == localb) && (this.nEU != e.b.nEm))
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.nES != null)
        {
          ...
          this.nES = new b(paramb, parama, (byte)0);
        }
        else
        {
          localObject = null;
  ...
  public final void onResume()
  {
    ...
    try
    {
      localContentResolver.registerContentObserver(localUri, false, this.nET);
  ...
  public final void release()
  {
    ...
    try
    {
      ...
      Log.i("MicroMsg.AppBrandDeviceOrientationHandler", "Still has request not executed current[%s] pending[%s]", new Object[] { this.nER, this.nES });
      this.nER = null;
      this.nES = null;
      this.mFinished = true;
      return;
