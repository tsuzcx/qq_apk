  ...
  extends com.tencent.luggage.f.a.b
{
  ...
  private static int getMapType()
  {
    ...
    kPp = Integer.valueOf(bt.getInt((String)((com.tencent.mm.storage.c)localObject).eJy().get("MapType"), 1));
    ad.i("MicroMsg.WxaMapViewFactory", "sMapType:%d", new Object[] { kPp });
    int i = kPp.intValue();
    AppMethodBeat.o(47493);
    return i;
  }
  ...
  public final com.tencent.mm.plugin.appbrand.jsapi.g.a.b a(Context paramContext, String paramString, Map<String, Object> paramMap)
  {
    ...
    for (;;)
    {
      ...
      if (k == 2)
      {
        paramContext = new com.tencent.mm.plugin.appbrand.jsapi.aa.d.b(paramContext, paramString, paramMap);
        AppMethodBeat.o(47495);
        return paramContext;
      }
