...
public final class u
{
  ...
  private boolean E(byte[] paramArrayOfByte, int paramInt)
  {
  ...
  private byte[] b(byte[] paramArrayOfByte1, int paramInt, byte[] paramArrayOfByte2)
  {
    ...
    this.prePlain = al(paramArrayOfByte1);
    if (this.prePlain == null)
    {
      AppMethodBeat.o(91188);
      return null;
    ...
    for (;;)
    {
      if (this.padding <= 2)
      {
        ...
        if (!E(paramArrayOfByte1, paramInt))
        {
          AppMethodBeat.o(91188);
          return null;
        }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.t.u
