...
@l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/appbrand/shortlink/UploadResult;", "Landroid/os/Parcelable;", "ret", "", "fileUrl", "", "(ZLjava/lang/String;)V", "getFileUrl", "()Ljava/lang/String;", "getRet", "()Z", "component1", "component2", "copy", "describeContents", "", "equals", "other", "", "hashCode", "toString", "writeToParcel", "", "parcel", "Landroid/os/Parcel;", "flags", "plugin-appbrand-integration_release"})
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (this != paramObject)
    {
      if ((paramObject instanceof UploadResult))
      {
        ...
        if ((this.dFE != paramObject.dFE) || (!p.j(this.fileUrl, paramObject.fileUrl))) {}
      }
    }
    else
    {
