...
@l(iBK={1, 1, 16}, iBL={""}, iBM={"Lcom/tencent/mm/plugin/appbrand/shortlink/UploadResult;", "Landroid/os/Parcelable;", "ret", "", "fileUrl", "", "(ZLjava/lang/String;)V", "getFileUrl", "()Ljava/lang/String;", "getRet", "()Z", "component1", "component2", "copy", "describeContents", "", "equals", "other", "", "hashCode", "toString", "writeToParcel", "", "parcel", "Landroid/os/Parcel;", "flags", "plugin-appbrand-integration_release"})
  ...
  implements Parcelable
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (this != paramObject)
    {
      if ((paramObject instanceof UploadResult))
      {
        ...
        if ((this.fyl != paramObject.fyl) || (!p.h(this.fileUrl, paramObject.fileUrl))) {}
      }
    }
    else
    {
  ...
  public final String toString()
  {
    ...
    String str = "UploadResult(ret=" + this.fyl + ", fileUrl=" + this.fileUrl + ")";
    ...
    implements Parcelable.Creator
  {
    public final Object createFromParcel(Parcel paramParcel)
    {
      ...
      {
        paramParcel = new UploadResult(bool, paramParcel.readString());
    ...
    {
      return new UploadResult[paramInt];
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.shortlink.UploadResult
