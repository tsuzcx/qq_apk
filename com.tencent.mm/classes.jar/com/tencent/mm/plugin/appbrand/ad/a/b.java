  ...
  extends p
{
  ...
  public final void c(q paramq)
  {
    ...
    localHashMap.put("buttonType", bt.by(this.type, "close"));
    ad.i("MicroMsg.JsApiEventOnSplashAdButtonClicked", "dispatch, source:%s, buttonType:%s", new Object[] { this.source, this.type });
