  ...
  implements o
{
  ...
  public static Long dH(String paramString1, String paramString2)
  {
    AppMethodBeat.i(47744);
    String str = j.Dh().get(dI(paramString1, paramString2), "");
    ...
    {
      j.Dh().vv(dI(paramString1, paramString2));
  ...
  private static String dI(String paramString1, String paramString2)
  {
  ...
  public final f.b a(String paramString, Map<String, String> paramMap, f.a parama)
  {
    ...
    for (;;)
    {
      ...
      for (paramString = ".sysmsg.WeAppPushCommand.weapp";; paramString = ".sysmsg.WeAppPushCommand.weapp" + i)
      {
        ...
        j.Dh().cl(dI(str, "copypath"), String.valueOf(l * 1000L + System.currentTimeMillis()));
        break label192;
      }
    }
  }
