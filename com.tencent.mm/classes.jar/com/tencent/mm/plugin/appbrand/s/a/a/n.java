...
final class n
{
  static ActivityManager.TaskDescription a(c.b paramb)
  {
    ...
    if (paramb.kYl > 0)
    {
      ...
      {
        paramb = new ActivityManager.TaskDescription(paramb.label, paramb.kYl, i);
        AppMethodBeat.o(176758);
        return paramb;
      }
      try
      {
        Object localObject = MMBitmapFactory.decodeResource(aj.getResources(), paramb.kYl);
    ...
    paramb = new ActivityManager.TaskDescription(paramb.label, paramb.lmN, i);
    AppMethodBeat.o(176758);
    return paramb;
  }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.s.a.a.n
