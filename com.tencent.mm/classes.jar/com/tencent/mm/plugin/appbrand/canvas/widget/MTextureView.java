  ...
  implements TextureView.SurfaceTextureListener, a
{
    ...
    this.laN = new Runnable()
    {
      public final void run()
      {
        ...
        synchronized (MTextureView.a(MTextureView.this))
        {
          ...
          MTextureView.this.o(localCanvas);
  ...
  public void onSurfaceTextureAvailable(SurfaceTexture paramSurfaceTexture, int paramInt1, int paramInt2)
  {
    ...
    if (this.laM == null)
    {
      paramSurfaceTexture = com.tencent.f.c.d.hz("MTextureView#Rending-Thread", -19);
      paramSurfaceTexture.start();
      this.laM = new MMHandler(paramSurfaceTexture.getLooper());
    }
