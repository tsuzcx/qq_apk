...
{
  public static final Parcelable.Creator<RealSetStrokeStyleActionLinearArg> CREATOR = new RealSetStrokeStyleActionLinearArg.1();
  public float fLI;
  public float fLJ;
  public float fLK;
  public float fLL;
  ...
  public final boolean a(d paramd, Canvas paramCanvas)
  {
    ...
    paramCanvas = new LinearGradient(this.fLI, this.fLJ, this.fLK, this.fLL, this.fLM, this.positions, Shader.TileMode.CLAMP);
