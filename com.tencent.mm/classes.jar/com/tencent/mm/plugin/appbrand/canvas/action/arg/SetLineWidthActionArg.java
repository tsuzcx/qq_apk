  ...
  extends BaseDrawActionArg
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if (Float.compare(((SetLineWidthActionArg)paramObject).qTK, this.qTK) == 0)
    {
      AppMethodBeat.o(145214);
      return true;
    }
  ...
  public int hashCode()
  {
    ...
    int i = Objects.hash(new Object[] { Integer.valueOf(super.hashCode()), Float.valueOf(this.qTK) });
  ...
  public final void k(Parcel paramParcel)
  {
    ...
    super.k(paramParcel);
    this.qTK = paramParcel.readFloat();
  ...
  public final void parse(JSONObject paramJSONObject)
  {
    ...
    this.qTK = i.f(paramJSONObject.optJSONArray("data"), 0);
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    paramParcel.writeFloat(this.qTK);
