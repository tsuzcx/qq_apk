  ...
  extends BaseDrawActionArg
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((Float.compare(paramObject.x, this.x) == 0) && (Float.compare(paramObject.y, this.y) == 0) && (Float.compare(paramObject.jzH, this.jzH) == 0) && (this.color == paramObject.color))
    {
      AppMethodBeat.o(145228);
      return true;
    }
  ...
  public final void h(Parcel paramParcel)
  {
    ...
    this.jzH = paramParcel.readFloat();
  ...
  public int hashCode()
  {
    ...
    int i = Objects.hash(new Object[] { Integer.valueOf(super.hashCode()), Float.valueOf(this.x), Float.valueOf(this.y), Float.valueOf(this.jzH), Integer.valueOf(this.color) });
  ...
  public final void parse(JSONObject paramJSONObject)
  {
    ...
    this.jzH = g.f(paramJSONObject, 2);
    ...
    this.color = g.p(paramJSONObject);
    AppMethodBeat.o(145227);
  }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    paramParcel.writeFloat(this.jzH);
