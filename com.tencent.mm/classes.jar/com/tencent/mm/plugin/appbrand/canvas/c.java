...
{
  public Map<String, com.tencent.mm.plugin.appbrand.canvas.action.d> iYK;
  ...
  private void a(com.tencent.mm.plugin.appbrand.canvas.action.d paramd)
  {
    ...
    this.iYK.put(paramd.getMethod(), paramd);
  ...
  public final boolean a(d paramd, Canvas paramCanvas, JSONObject paramJSONObject)
  {
    ...
    localObject = (com.tencent.mm.plugin.appbrand.canvas.action.d)this.iYK.get(localObject);
    if (localObject == null)
    {
