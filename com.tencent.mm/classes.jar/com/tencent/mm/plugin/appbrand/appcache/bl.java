  ...
  extends c<bk>
{
  ...
  public bl(ISQLiteDatabaseEx paramISQLiteDatabaseEx)
  {
    super((ISQLiteDatabase)paramISQLiteDatabaseEx, bk.iBg, "WxaPluginCodeVersionInfo", bk.INDEX_CREATE);
  ...
  /* Error */
  private final boolean a(bk parambk)
  {
    // Byte code:
    //   0: ldc 93
    ...
    //   14: aload_0
    //   15: invokevirtual 104	com/tencent/mm/plugin/appbrand/appcache/bl:getTableName	()Ljava/lang/String;
    ...
    //   29: astore 4
    //   31: aload_0
    //   32: getfield 89	com/tencent/mm/plugin/appbrand/appcache/bl:kOg	Lcom/tencent/mm/sdk/storage/ISQLiteDatabaseEx;
    //   35: aload 4
    //   37: iconst_2
    ...
    //   42: iconst_0
    //   43: aload_1
    //   44: getfield 119	com/tencent/mm/plugin/appbrand/appcache/bk:field_pluginAppID	Ljava/lang/String;
    //   47: aastore
    //   48: dup
    //   49: iconst_1
    //   50: aload_1
    //   51: getfield 123	com/tencent/mm/plugin/appbrand/appcache/bk:field_pluginAppVersion	I
  ...
  public final String ba(String paramString, int paramInt)
  {
    AppMethodBeat.i(182794);
    p.h(paramString, "id");
    Object localObject = new bk();
    ((bk)localObject).field_pluginAppID = paramString;
    ((bk)localObject).field_pluginAppVersion = paramInt;
    if (get((IAutoDBItem)localObject, new String[0])) {}
    for (localObject = ((bk)localObject).field_pluginStringVersion;; localObject = null)
    {
  ...
  public final <R> R s(a<? extends R> parama)
  {
    AppMethodBeat.i(229802);
    ISQLiteDatabaseEx localISQLiteDatabaseEx = this.kOg;
    ...
    {
      this.kOg.endTransaction(l);
      AppMethodBeat.o(229802);
    }
  }
  
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/appbrand/appcache/WxaPluginCodeVersionInfoStorage$Companion;", "", "()V", "TAG", "", "data-storage_release"})
  ...
  {
    public b(bl parambl, bk parambk)
    {
      super();
    }
  }
