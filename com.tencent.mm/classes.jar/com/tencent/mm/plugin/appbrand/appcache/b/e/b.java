  ...
  extends j<a>
{
  ...
  static
  {
    ...
    hlS = new String[] { j.getCreateSQLs(a.hlR, "PredownloadBlockCgiRequest") };
    AppMethodBeat.o(44436);
  }
  
  public b(e parame)
  {
    super(parame, a.hlR, "PredownloadBlockCgiRequest", a.INDEX_CREATE);
    this.jnc = parame;
  }
  ...
  private Pair<Boolean, Integer> c(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    paramString1 = this.jnc.rawQuery(paramString1, new String[] { paramString2 });
  ...
  public final Pair<Boolean, Integer> D(String paramString, int paramInt1, int paramInt2)
  {
  ...
  public final Pair<Boolean, Integer> E(String paramString, int paramInt1, int paramInt2)
  {
