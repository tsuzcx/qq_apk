  ...
  extends j<a>
{
  ...
  static
  {
    ...
    gLs = new String[] { j.getCreateSQLs(a.gLr, "PredownloadBlockCgiRequest") };
    AppMethodBeat.o(44436);
  }
  
  public b(e parame)
  {
    super(parame, a.gLr, "PredownloadBlockCgiRequest", a.INDEX_CREATE);
    this.iMV = parame;
  }
  ...
  private Pair<Boolean, Integer> c(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    paramString1 = this.iMV.rawQuery(paramString1, new String[] { paramString2 });
