  ...
  extends l
{
  ...
  public volatile boolean gXk = true;
  ...
  {
    return getClass().getSimpleName() + String.format(Locale.US, "[%s|%d|%d]", new Object[] { this.appId, Integer.valueOf(this.version), Integer.valueOf(this.cvs) });
  }
}
