  ...
  extends a
{
  ...
  {
    super(str1, str2 + String.format("debug_%d_%d_%d", new Object[] { Integer.valueOf(paramString1.hashCode()), Integer.valueOf(paramInt), Integer.valueOf(bt.nullAsNil(parama.aPJ()).hashCode()) }), paramString2, paramString1, String.format("%s_%d_%s", new Object[] { paramString1, Integer.valueOf(paramInt), bt.nullAsNil(parama.aPJ()) }).hashCode(), paramInt);
