  ...
  implements aa
{
  private static void a(final AppBrandRuntime paramAppBrandRuntime, final int paramInt, final Runnable paramRunnable)
  {
    ...
    if (!t.ay(paramAppBrandRuntime.jwJ))
    {
      paramAppBrandRuntime.jwJ.setWillNotDraw(true);
      paramAppBrandRuntime.jwJ.post(new Runnable()
      {
        public final void run()
        {
          AppMethodBeat.i(175084);
          n.b(this.jIG, paramInt, paramRunnable);
    ...
    localAnimation.setAnimationListener(new Animation.AnimationListener()
    {
      ...
      public final void onAnimationStart(Animation paramAnonymousAnimation)
      {
        ...
        paramAppBrandRuntime.jwJ.setWillNotDraw(false);
        AppMethodBeat.o(175086);
      }
    });
    paramAppBrandRuntime.jwJ.startAnimation(localAnimation);
    AppMethodBeat.o(48868);
  }
  ...
  public static boolean al(AppBrandRuntime paramAppBrandRuntime)
  {
    ...
    if ((paramAppBrandRuntime instanceof o))
    {
      ...
      if ((paramAppBrandRuntime.aWT()) || (paramAppBrandRuntime.Fb().cmC.scene == 1099))
      {
  ...
  public final void a(Activity paramActivity, AppBrandInitConfig paramAppBrandInitConfig)
  {
    ...
    AppBrandStatObject localAppBrandStatObject = ((AppBrandInitConfigWC)paramAppBrandInitConfig).cmC;
    try
    {
    ...
    catch (Throwable localThrowable)
    {
      ...
      if ((((AppBrandInitConfigWC)paramAppBrandInitConfig).jXu) || (((AppBrandInitConfigWC)paramAppBrandInitConfig).launchMode == 1))
      {
      ...
      for (i = 1;; i = 0)
      {
        ...
        paramActivity.overridePendingTransition(MMFragmentActivity.a.mOg, MMFragmentActivity.a.mOh);
        AppMethodBeat.o(48864);
        return;
  ...
  public final void a(final AppBrandRuntime paramAppBrandRuntime1, AppBrandRuntime paramAppBrandRuntime2)
  {
    ...
    label73:
    for (int i = MMFragmentActivity.a.mOf;; i = 2130771986)
    {
  ...
  public final void a(AppBrandRuntime paramAppBrandRuntime1, AppBrandRuntime paramAppBrandRuntime2, Runnable paramRunnable)
  {
    ...
    label70:
    for (int i = MMFragmentActivity.a.mOg;; i = 2130771986)
    {
