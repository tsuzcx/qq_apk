  ...
  extends f
{
  ...
  public final void onClick(View paramView)
  {
    ...
    for (int i = 2;; i = 0)
    {
      paramView = AppBrandLauncherFolderUI.lzA;
      paramView = getActivity();
      k.g(paramView, "activity");
      ...
      h.vKh.f(19468, new Object[] { Integer.valueOf(5), "", "", "", "", "", Long.valueOf(paramView.mSessionId) });
