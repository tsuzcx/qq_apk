...
{
  AppBrandProfileUI$9(AppBrandProfileUI paramAppBrandProfileUI, ehv paramehv) {}
  ...
  public final void onClick(View paramView)
  {
    ...
    com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/appbrand/ui/AppBrandProfileUI$17", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).ahq());
    if (!this.mEg.HSm.isEmpty())
    {
      paramView = new ArrayList();
      localObject = this.mEg.HSm.iterator();
      while (((Iterator)localObject).hasNext())
      {
        ehu localehu = (ehu)((Iterator)localObject).next();
        WxaAttributes.WxaEntryInfo localWxaEntryInfo = new WxaAttributes.WxaEntryInfo();
        localWxaEntryInfo.username = localehu.username;
        localWxaEntryInfo.title = localehu.title;
        localWxaEntryInfo.jZS = localehu.desc;
        localWxaEntryInfo.iconUrl = localehu.pkr;
        paramView.add(localWxaEntryInfo);
      }
      localObject = new Intent(this.mDY.getContext(), WxaBindBizInfoUI.class);
      ((Intent)localObject).putExtra("register", this.mEg.HSl);
      ...
      com.tencent.mm.hellhoundlib.a.a.a(paramView, ((com.tencent.mm.hellhoundlib.b.a)localObject).ahp(), "com/tencent/mm/plugin/appbrand/ui/AppBrandProfileUI$17", "onClick", "(Landroid/view/View;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
      ...
      AppBrandProfileUI.a(this.mDY, 3, 1);
    }
