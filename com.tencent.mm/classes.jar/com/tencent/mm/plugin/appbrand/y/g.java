...
public final class g
{
  ...
  public static int VI(String paramString)
  {
    ...
    if (f.mTs.containsKey(paramString))
    {
      i = ((Integer)f.mTs.get(paramString)).intValue();
      AppMethodBeat.o(140812);
      return i;
    }
    if (paramString.charAt(0) == '#')
    {
      ...
      for (long l = Long.parseLong(((String)localObject).substring(1), 16) | 0xFF000000;; l = Long.parseLong(((String)localObject).substring(1, 7), 16) | Long.parseLong(((String)localObject).substring(7, 9), 16) << 24)
      {
        ...
        {
          ae.m("MicroMsg.JsValueUtil", "hy: Unknown color, given string is %s", new Object[] { localObject });
  ...
  public static int a(JSONObject paramJSONObject, String paramString, int paramInt)
  {
    ...
    try
    {
      int i = Math.round((float)paramJSONObject.getDouble(paramString) * bCg());
      AppMethodBeat.o(140819);
      return i;
    }
    catch (Exception paramJSONObject)
  ...
  private static int d(JSONArray paramJSONArray, int paramInt)
  {
    ...
    try
    {
      paramInt = Math.round((float)paramJSONArray.getDouble(paramInt) * bCg());
      AppMethodBeat.o(140824);
      return paramInt;
    }
  ...
  public static int s(JSONArray paramJSONArray)
  {
    ...
    int i = Math.round((float)paramJSONArray.getDouble(0) * bCg());
  ...
  public static int vM(int paramInt)
  {
    ...
    paramInt = (int)Math.ceil(paramInt / bCg());
  ...
  public static int vN(int paramInt)
  {
    ...
    paramInt = (int)(paramInt / bCg());
    AppMethodBeat.o(140814);
    return paramInt;
  }
  
  public static int vO(int paramInt)
  {
    AppMethodBeat.i(140816);
    paramInt = Math.round(bCg() * paramInt);
