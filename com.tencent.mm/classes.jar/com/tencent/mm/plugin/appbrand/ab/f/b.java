...
{
  public static CodingErrorAction lOP = CodingErrorAction.REPORT;
  ...
  public static String B(ByteBuffer paramByteBuffer)
  {
    ...
    ((CharsetDecoder)localObject).onMalformedInput(lOP);
    ((CharsetDecoder)localObject).onUnmappableCharacter(lOP);
    try
    {
    ...
    {
      paramByteBuffer = new com.tencent.mm.plugin.appbrand.ab.c.b(1007, paramByteBuffer);
      AppMethodBeat.o(156675);
  ...
  public static byte[] Nx(String paramString)
  {
  ...
  public static byte[] Ny(String paramString)
  {
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.ab.f.b
