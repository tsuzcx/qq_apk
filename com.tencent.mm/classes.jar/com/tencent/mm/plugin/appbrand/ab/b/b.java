...
import com.tencent.mm.plugin.appbrand.ab.d.e;
...
public class b
  extends a
{
  private ByteBuffer lOm;
  private com.tencent.mm.plugin.appbrand.ab.d.d lOn;
  private final Random lOo;
  ...
  private static String Ns(String paramString)
  {
    ...
    try
    {
      ...
      paramString = com.tencent.mm.plugin.appbrand.ab.f.a.aB(localMessageDigest.digest(paramString.getBytes()));
  ...
  public static int g(f paramf)
  {
    ...
    paramf = paramf.Nv("Sec-WebSocket-Version");
    if (paramf.length() > 0) {
      try
      {
  ...
  private static byte[] j(long paramLong, int paramInt)
  {
  ...
  private com.tencent.mm.plugin.appbrand.ab.d.d z(ByteBuffer paramByteBuffer)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramByteBuffer = new com.tencent.mm.plugin.appbrand.ab.c.c("bad rsv ".concat(String.valueOf(i)));
      AppMethodBeat.o(156642);
      throw paramByteBuffer;
    }
    ...
    for (int k = 1;; k = 0)
    {
      ...
      case 7: 
      default: 
        paramByteBuffer = new com.tencent.mm.plugin.appbrand.ab.c.c("unknow optcode " + (short)m);
        AppMethodBeat.o(156642);
        throw paramByteBuffer;
      }
    }
    d.a locala = d.a.lOu;
    while ((!bool) && ((locala == d.a.lOx) || (locala == d.a.lOy) || (locala == d.a.lOz)))
    {
      paramByteBuffer = new com.tencent.mm.plugin.appbrand.ab.c.c("control frames may no be fragmented");
      AppMethodBeat.o(156642);
      throw paramByteBuffer;
      locala = d.a.lOv;
      continue;
    ...
    if ((i < 0) || (i > 125))
    {
      if ((locala == d.a.lOx) || (locala == d.a.lOy) || (locala == d.a.lOz))
      {
        paramByteBuffer = new com.tencent.mm.plugin.appbrand.ab.c.c("more than 125 octets");
        AppMethodBeat.o(156642);
        throw paramByteBuffer;
      }
      if (i == 126)
    ...
    for (;;)
    {
      ...
      label578:
      localObject = ByteBuffer.allocate(up(i));
      if (k != 0)
      {
      ...
      if (locala == d.a.lOz) {
        paramByteBuffer = new com.tencent.mm.plugin.appbrand.ab.d.b();
      }
      for (;;)
      {
        ...
        paramByteBuffer.hk(bool);
        paramByteBuffer.a(locala);
      }
    }
  }
  
  public final a.b a(com.tencent.mm.plugin.appbrand.ab.e.a parama, h paramh)
  {
    int j = 1;
    AppMethodBeat.i(156633);
    Object localObject = parama.Nv("Sec-WebSocket-Protocol");
    String str = paramh.Nv("Sec-WebSocket-Protocol");
    ...
    for (int i = j;; i = 0)
    {
      ...
      if ((!parama.Nw("Sec-WebSocket-Key")) || (!paramh.Nw("Sec-WebSocket-Accept")))
      {
        parama = a.b.lOk;
        AppMethodBeat.o(156633);
        return parama;
      }
      paramh = paramh.Nv("Sec-WebSocket-Accept");
      if (Ns(parama.Nv("Sec-WebSocket-Key")).equals(paramh))
      {
        parama = a.b.lOj;
        AppMethodBeat.o(156633);
        return parama;
  ...
  public com.tencent.mm.plugin.appbrand.ab.e.b a(com.tencent.mm.plugin.appbrand.ab.e.b paramb)
  {
    ...
    this.lOo.nextBytes(arrayOfByte);
    paramb.put("Sec-WebSocket-Key", com.tencent.mm.plugin.appbrand.ab.f.a.aB(arrayOfByte));
    AppMethodBeat.o(156639);
    return paramb;
  }
  
  public com.tencent.mm.plugin.appbrand.ab.e.c a(com.tencent.mm.plugin.appbrand.ab.e.a parama, i parami)
  {
    AppMethodBeat.i(156640);
    parami.put("Upgrade", "websocket");
    parami.put("Connection", parama.Nv("Connection"));
    parami.Nu("Switching Protocols");
    parama = parama.Nv("Sec-WebSocket-Key");
    if (parama == null)
    {
      parama = new com.tencent.mm.plugin.appbrand.ab.c.d("missing Sec-WebSocket-Key");
      AppMethodBeat.o(156640);
      throw parama;
    }
    parami.put("Sec-WebSocket-Accept", Ns(parama));
    AppMethodBeat.o(156640);
    return parami;
  }
  
  public final List<com.tencent.mm.plugin.appbrand.ab.d.d> a(ByteBuffer paramByteBuffer, boolean paramBoolean)
  {
  ...
  public final List<com.tencent.mm.plugin.appbrand.ab.d.d> ay(String paramString, boolean paramBoolean)
  {
    AppMethodBeat.i(156637);
    e locale = new e();
    try
    {
      locale.A(ByteBuffer.wrap(com.tencent.mm.plugin.appbrand.ab.f.b.Nx(paramString)));
      locale.hk(true);
      locale.a(d.a.lOv);
      locale.hl(paramBoolean);
    ...
    catch (com.tencent.mm.plugin.appbrand.ab.c.b paramString)
    {
      for (;;)
      {
  ...
  public final a.a bqz()
  {
    return a.a.lOh;
  }
  
  public a.b c(com.tencent.mm.plugin.appbrand.ab.e.a parama)
  {
    AppMethodBeat.i(156634);
    int i = g(parama);
    if ((i == 7) || (i == 8))
    {
      if ((parama.Nv("Upgrade").equalsIgnoreCase("websocket")) && (parama.Nv("Connection").toLowerCase(Locale.ENGLISH).contains("upgrade"))) {}
      for (i = 1; i != 0; i = 0)
      {
        parama = a.b.lOj;
  ...
  public final ByteBuffer d(com.tencent.mm.plugin.appbrand.ab.d.d paramd)
  {
    int k = -128;
    int i1 = 0;
    ...
    d.a locala;
    if (this.lNJ == com.tencent.mm.plugin.appbrand.ab.a.b.lNu)
    {
      m = 1;
      ...
      paramd = j(localByteBuffer1.remaining(), j);
      if (j != 1) {
        break label380;
      }
      i = paramd[0];
    ...
    for (;;)
    {
      ...
      paramd.putInt(this.lOo.nextInt());
  ...
  public final List<com.tencent.mm.plugin.appbrand.ab.d.d> x(ByteBuffer paramByteBuffer)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        int j = this.lOm.remaining();
        if (j > i)
        {
          this.lOm.put(paramByteBuffer.array(), paramByteBuffer.position(), i);
          paramByteBuffer.position(i + paramByteBuffer.position());
          localObject = Collections.emptyList();
          AppMethodBeat.o(156641);
          return localObject;
        }
        this.lOm.put(paramByteBuffer.array(), paramByteBuffer.position(), j);
        paramByteBuffer.position(paramByteBuffer.position() + j);
        ((List)localObject).add(z((ByteBuffer)this.lOm.duplicate().position(0)));
        this.lOm = null;
        while (paramByteBuffer.hasRemaining())
        {
          ...
          catch (a locala2)
          {
            ...
            this.lOm = ByteBuffer.allocate(up(locala2.lOp));
            this.lOm.put(paramByteBuffer);
          }
        }
        AppMethodBeat.o(156641);
        return localObject;
      ...
      {
        this.lOm.limit();
        ByteBuffer localByteBuffer = ByteBuffer.allocate(up(locala1.lOp));
        this.lOm.rewind();
        localByteBuffer.put(this.lOm);
        this.lOm = localByteBuffer;
      }
    }
  }
 ...
 * Qualified Name:     com.tencent.mm.plugin.appbrand.ab.b.b
