  ...
  implements d.a
{
  ...
  {
    y.i("MicroMsg.WXBizEntryActivity", "DeepLinkHelper.DeepLinkCallback, %d, %d, %s, %b", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), paramString, Boolean.valueOf(paramBoolean) });
    if ((paramm != null) && (paramInt1 != 0) && (paramInt2 != 0) && ((paramm instanceof aa)))
    {
      ...
      {
        h.a(this.hSd, bk.pm(paramString.tOY), this.hSd.getString(R.l.app_tip), this.hSd.getString(R.l.app_ok), false, new DialogInterface.OnClickListener()
        {
          public final void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
          {
            WXBizEntryActivity.a(WXBizEntryActivity.3.this.hSd);
            WXBizEntryActivity.3.this.hSd.finish();
          }
        });
        return;
      }
