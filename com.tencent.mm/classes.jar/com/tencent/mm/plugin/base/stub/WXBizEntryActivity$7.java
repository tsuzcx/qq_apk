  ...
  implements e.a
{
  ...
  public final void a(int paramInt1, int paramInt2, String paramString, m paramm, boolean paramBoolean)
  {
    ...
    com.tencent.mm.sdk.platformtools.ab.i("MicroMsg.WXBizEntryActivity", "offline pay, DeepLinkHelper.DeepLinkCallback, %d, %d, %s, %b", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), paramString, Boolean.valueOf(paramBoolean) });
    if ((paramm != null) && (paramInt1 != 0) && (paramInt2 != 0) && ((paramm instanceof com.tencent.mm.modelsimple.ab)))
    {
      ...
      {
        h.a(this.jLI, bo.nullAsNil(paramString.xVH), this.jLI.getString(2131297087), this.jLI.getString(2131297018), false, new WXBizEntryActivity.7.1(this));
