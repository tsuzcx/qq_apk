...
{
  private static final UriMatcher nSA;
  private c nSz;
  ...
  public int delete(Uri paramUri, String paramString, String[] paramArrayOfString)
  {
    ...
    ae.v("MicroMsg.MMPluginProvider", "plugin delete".concat(String.valueOf(paramUri)));
    switch (nSA.match(paramUri))
    {
    default: 
      ae.e("MicroMsg.MMPluginProvider", "Unknown URI ".concat(String.valueOf(paramUri)));
  ...
  public Uri insert(Uri paramUri, ContentValues paramContentValues)
  {
    ...
    ae.v("MicroMsg.MMPluginProvider", "plugin insert".concat(String.valueOf(paramUri)));
    switch (nSA.match(paramUri))
    {
    default: 
      ae.e("MicroMsg.MMPluginProvider", "Unknown URI ".concat(String.valueOf(paramUri)));
  ...
  public boolean onCreate()
  {
    ...
    ae.i("MicroMsg.MMPluginProvider", "onCreate");
    this.nSz.eq(getContext());
  ...
  public Cursor query(Uri paramUri, String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2)
  {
    ...
    ae.i("MicroMsg.MMPluginProvider", "plugin query".concat(String.valueOf(paramUri)));
    switch (nSA.match(paramUri))
    {
    default: 
      ae.e("MicroMsg.MMPluginProvider", "Unknown URI ".concat(String.valueOf(paramUri)));
  ...
  public int update(Uri paramUri, ContentValues paramContentValues, String paramString, String[] paramArrayOfString)
  {
    ...
    ae.d("MicroMsg.MMPluginProvider", "plugin update".concat(String.valueOf(paramUri)));
    switch (nSA.match(paramUri))
    {
    default: 
      ae.e("MicroMsg.MMPluginProvider", "Unknown URI ".concat(String.valueOf(paramUri)));
  ...
  protected static abstract class a
  {
    ...
    public boolean eq(Context paramContext)
    {
