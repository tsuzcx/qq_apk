  ...
  extends RecyclerView.a<com.tencent.mm.plugin.editor.adapter.a.a>
{
  ...
  private j okB;
  private com.tencent.mm.plugin.editor.adapter.a.c olg;
  ...
  public b(j paramj)
  {
    ...
    this.okB = paramj;
    this.olg = new com.tencent.mm.plugin.editor.adapter.a.c();
  ...
  private void a(com.tencent.mm.plugin.editor.adapter.a.a parama, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        com.tencent.mm.plugin.editor.model.a.a locala = com.tencent.mm.plugin.editor.model.nativenote.manager.c.bSq().Aa(paramInt);
        if ((locala != null) && (locala.getType() == parama.bSa()))
        {
