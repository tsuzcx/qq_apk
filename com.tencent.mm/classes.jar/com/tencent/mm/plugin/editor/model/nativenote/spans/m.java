  ...
  extends t<V, C>
{
  ...
  protected final ArrayList<Object> a(Spannable paramSpannable, g paramg, q paramq)
  {
    ...
    localObject1 = paramSpannable.getSpans(paramg.asw, paramg.Mc, (Class)localObject1);
  ...
  {
    paramn.a(a(paramSpannable, paraml, q.oqw), paraml);
  }
  ...
  public final void a(WXRTEditText paramWXRTEditText, V paramV)
  {
    ...
    if ((paramWXRTEditText.ook) && (paramWXRTEditText.getSelection().asw == localg.asw) && (localg.asw > 1))
    {
      Object localObject1 = a(paramWXRTEditText.getText(), localg, q.oqx);
      if ((!((ArrayList)localObject1).isEmpty()) && (paramWXRTEditText.getLayout().getPrimaryHorizontal(paramWXRTEditText.getSelection().asw) == f.bSG()))
      {
        ...
        paramWXRTEditText.getText().insert(localg.asw - 1, "\n");
      }
    }
