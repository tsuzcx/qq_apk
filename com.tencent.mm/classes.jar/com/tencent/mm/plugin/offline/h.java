  ...
  extends d
{
  public final void R(Activity paramActivity)
  {
    ...
    {
      j = this.dyY.getInt("offline_from_scene", -1);
      if (j != 1) {
        break label96;
      }
    }
    for (;;)
    {
      com.tencent.mm.plugin.report.service.g.yxI.f(14096, new Object[] { Integer.valueOf(i) });
      ...
      paramMMActivity = new com.tencent.mm.wallet_core.d.g(paramMMActivity, parami)
      {
        ...
        public final boolean onSceneEnd(final int paramAnonymousInt1, int paramAnonymousInt2, String paramAnonymousString, com.tencent.mm.ak.n paramAnonymousn)
        {
          ...
          if ((paramAnonymousInt1 == 0) && (paramAnonymousInt2 == 0))
          {
            ...
            {
              ae.i("MicroMsg.OfflineProcess", "Offline is Create ");
              dzE();
            ...
            for (;;)
            {
              ...
              {
                ae.i("MicroMsg.OfflineProcess", "OfflineQueryUser is ok ");
                paramAnonymousString = this.LVJ;
                ...
                for (;;)
                {
                  ...
                  paramAnonymousString.dNW.scene = 8;
                  paramAnonymousString.dNX.dNO = new Runnable()
                  {
                    public final void run()
                    {
                      AppMethodBeat.i(66226);
                      ae.d("MicroMsg.OfflineProcess", "tofutest do callback");
                      h.this.a(h.1.this.activity, 0, h.b(h.this));
                      h.1.this.LVJ.closeTipDialog();
              ...
              if ((paramAnonymousn instanceof com.tencent.mm.plugin.offline.a.i))
              {
                ...
                if ("1".equals(paramAnonymousn.wNR))
                {
                  paramAnonymousString = this.activity;
                  paramAnonymousn = paramAnonymousn.dAs;
        ...
        public final boolean r(Object... paramAnonymousVarArgs)
        {
          ...
          Object localObject2 = com.tencent.mm.plugin.offline.c.a.dAB();
          Object localObject1 = localObject2;
          if (localObject2 == null)
          {
            ae.e("MicroMsg.OfflineProcess", "no support bank car for offline");
            localObject1 = com.tencent.mm.plugin.offline.c.a.dAC();
          }
          if (localObject1 == null)
          {
            ae.e("MicroMsg.OfflineProcess", "no any bank car for offline");
          ...
          {
            ae.i("MicroMsg.OfflineProcess", "Offline is not Create ");
            this.LVJ.a(new com.tencent.mm.plugin.offline.a.k((Bankcard)localObject1, (String)paramAnonymousVarArgs[0], h.g(h.this).getInt("offline_chg_fee", 0)), true, 1);
          }
          for (;;)
          {
            AppMethodBeat.o(66230);
            ...
            if (localObject2 != null)
            {
              ae.i("MicroMsg.OfflineProcess", "oper == ".concat(String.valueOf(localObject2)));
              if (((String)localObject2).equals("create"))
              {
                this.LVJ.a(new com.tencent.mm.plugin.offline.a.k((Bankcard)localObject1, (String)paramAnonymousVarArgs[0], h.h(h.this).getInt("offline_chg_fee", 0)), true, 1);
              }
              else if (((String)localObject2).equals("clr"))
              {
                this.LVJ.a(new com.tencent.mm.plugin.offline.a.i((Bankcard)localObject1, str, "clr", 0, ""), true, 1);
              }
              else if (((String)localObject2).equals("changeto"))
              {
                this.LVJ.a(new com.tencent.mm.plugin.offline.a.i((Bankcard)localObject1, str, "changeto", h.i(h.this).getInt("offline_chg_fee"), ""), true, 1);
              }
              else
              {
  ...
  public final void b(Activity paramActivity, Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && (paramBundle.getBoolean("is_offline_create"))) {
      com.tencent.mm.plugin.offline.c.a.az((WalletBaseUI)paramActivity);
    }
