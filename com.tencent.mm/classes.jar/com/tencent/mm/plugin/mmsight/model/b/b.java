  ...
  extends com.tencent.mm.plugin.mmsight.api.a
{
  ...
  public b(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    com.tencent.mm.plugin.sight.base.a locala = com.tencent.mm.plugin.sight.base.e.axx(paramString1);
    if (locala != null)
    {
    ...
    ad.i("MicroMsg.MMSightFFMpegMediaCodecRemuxer", "create MMSightFFMpegMediaCodecRemuxer, filePath: %s, outputFilePath: %s, inputWidth: %s, inputHeight: %s, videoRotate: %s, outputWidth: %s, outputHeight: %s", new Object[] { paramString1, paramString2, Integer.valueOf(this.hlH), Integer.valueOf(this.hlI), Integer.valueOf(this.hlJ), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
    AppMethodBeat.o(89609);
  }
  ...
  public b(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong1, long paramLong2)
  {
    ...
    ad.i("MicroMsg.MMSightFFMpegMediaCodecRemuxer", "create MMSightFFMpegMediaCodecRemuxer, filePath: %s, outputFilePath: %s, inputWidth: %s, inputHeight: %s, videoRotate: %s, outputWidth: %s, outputHeight: %s, startTimeMs: %s, endTimeMs: %s", new Object[] { paramString1, paramString2, Integer.valueOf(this.hlH), Integer.valueOf(this.hlI), Integer.valueOf(this.hlJ), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(paramLong1), Long.valueOf(paramLong2) });
    AppMethodBeat.o(89610);
  }
  ...
  public final int atP()
  {
    ...
    if (this.hlK >= 0L)
    {
      ...
      if (this.remuxEndTime >= 0L) {
        i = Math.round((float)(this.remuxEndTime - this.hlK) / 1000.0F) + 1;
      }
    }
    ...
    for (i = this.vQJ.e(this.filePath, 0L, this.videoDuration, this.videoFps);; i = this.vQJ.e(this.filePath, this.hlK, this.remuxEndTime, this.videoFps))
    {
      ...
      break;
      label175:
      if ((this.hlK < 0L) || (this.remuxEndTime < 0L)) {
        break label222;
      }
    }
    label222:
    ad.e("MicroMsg.MMSightFFMpegMediaCodecRemuxer", "remux time error, videoDuration: %s, remuxStartTime: %s, remuxEndTime: %s", new Object[] { Integer.valueOf(this.videoDuration), Long.valueOf(this.hlK), Long.valueOf(this.remuxEndTime) });
    MP4MuxerJNI.releaseDataBufLock(this.bufId);
    AppMethodBeat.o(89611);
    return -1;
    label277:
    if ((this.hmr > 0) && (this.hmr < this.videoFps)) {
      this.vQJ.qm((int)Math.ceil(this.videoFps / this.hmr));
    }
    if (this.hmr > 0)
    {
      i = Math.min(this.hmr, this.videoFps);
      this.vQK = new f(this.hlH, this.hlI, this.outputWidth, this.outputHeight, this.hmn, i);
      this.vQJ.a(new h()
      {
        public final void a(byte[] paramAnonymousArrayOfByte, boolean paramAnonymousBoolean, long paramAnonymousLong)
        {
          ...
          if (b.a(b.this) == null)
          {
            b.a(b.this, com.tencent.e.c.d.gY("remuxer_encode", -2));
            b.a(b.this).start();
          ...
          if (b.b(b.this) != null)
          {
            ...
            arrayOfByte = k.vQc.g(Integer.valueOf(paramAnonymousArrayOfByte.length));
            if (arrayOfByte != null) {
    ...
    for (;;)
    {
      ...
      try
      {
        this.vQK.qn(this.bufId);
        Object localObject1 = this.vQK;
        ...
        try
        {
          this.ddy.vx(this.filePath);
          localObject1 = null;
          i = 0;
          if (i >= this.ddy.gdS.getTrackCount()) {
            break label1003;
          }
          localObject2 = this.ddy.getTrackFormat(i);
        ...
        l = this.remuxEndTime - this.hlK;
        i = MP4MuxerJNI.muxingLock(this.bufId, this.hit, 1024, 2, this.channelCount, (String)localObject1, this.vQK.frameCount * 1000.0F / (float)l, null, 0);
        ad.i("MicroMsg.MMSightFFMpegMediaCodecRemuxer", "muxing ret: %s", new Object[] { Integer.valueOf(i) });
        if (this.hlJ > 0)
        {
          SightVideoJNI.tagRotateVideoVFS((String)localObject1, this.outputFilePath, this.hlJ);
      ...
      continue;
      label922:
      if (this.ddy.gdS.getSampleTime() < this.remuxEndTime * 1000L) {
        if (this.ddy.gdS.getSampleTrackIndex() != i)
        {
    ...
    extends ap
  {
    ...
    public final void handleMessage(Message paramMessage)
    {
      ...
      if (paramMessage.what == 1)
      {
        ...
        {
          if (b.d(b.this) == null) {
            b.a(b.this, b.e(b.this).aNh());
          }
          if (b.f(b.this) != null)
          {
            paramMessage = b.f(b.this).dmF();
          ...
          if (b.h(b.this) != null)
          {
            if (b.g(b.this) == null)
            {
              ...
              b.a(b.this, g.a(b.h(b.this), 360 - b.i(b.this)));
          ...
          bool = false;
          label491:
          ad.d("MicroMsg.MMSightRemuxMediaCodecEncoder", "writeData, needScale: %s, srcSize: [%s, %s], targetSize: [%s, %s], pts: %s", new Object[] { Boolean.valueOf(bool), Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(paramMessage.targetWidth), Integer.valueOf(paramMessage.targetHeight), Long.valueOf(l) });
          if (paramMessage.ivd == null) {
            paramMessage.ivd = new byte[paramMessage.targetWidth * paramMessage.targetHeight * 3 >> 1];
          }
          if ((paramMessage.hhQ != 19) || (bool)) {
            break label690;
          }
          System.arraycopy(arrayOfByte, 0, paramMessage.ivd, 0, arrayOfByte.length);
          label608:
          paramMessage.iuZ += 1;
          paramMessage.b(paramMessage.ivd, false, l);
        }
      }
      for (;;)
      {
        ...
        b.a(b.this, g.a(b.h(b.this), 180.0F));
        break label286;
        label684:
        bool = true;
        break label491;
        label690:
        MP4MuxerJNI.yuv420pTo420XXAndScaleLock(arrayOfByte, 2, paramMessage.ivd, paramMessage.ive, j, k, j, k, paramMessage.targetWidth, paramMessage.targetHeight);
        break label608;
        label721:
        paramMessage.b(paramMessage.ivd, true, l);
      }
    }
  }
}
