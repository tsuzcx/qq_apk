  ...
  implements a
{
  ...
  public final void eTP()
  {
    ...
    do
    {
      ...
      long l = Util.currentTicks();
      this.Fcv = MP4MuxerJNI.ffmpegGetNextVideoFrameDataLock(this.Fcv);
      ...
      this.frameCount += 1;
    } while ((this.kTg > 1) && (this.frameCount % this.kTg == 0));
    h localh;
    byte[] arrayOfByte;
    if (this.Fcu != null)
    {
      localh = this.Fcu;
      arrayOfByte = this.Fcv;
      if ((this.Fcv != null) && (!bool2)) {
        break label227;
      }
    }
    label227:
    ...
    {
      localh.a(arrayOfByte, bool1, (this.frameCount * this.Fcw * 1000.0D));
      if ((this.Fcv != null) && (!bool2)) {
        break;
      }
