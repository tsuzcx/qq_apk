...
public abstract interface d
{
  ...
  {
    private LinkedBlockingQueue<d> KZd;
    private final int KZe;
    private Callable<d> KZf;
    private Lock KZg;
    ...
    public a(int paramInt, Callable<d> paramCallable)
    {
      ...
      this.size = 0;
      this.KZg = new ReentrantLock();
      this.KZe = paramInt;
      this.KZd = new LinkedBlockingQueue(paramInt);
      this.KZf = paramCallable;
    ...
    public final void destroy()
    {
      ...
      //   5: aload_0
      //   6: getfield 45	com/tencent/mm/plugin/mmsight/segment/d$a:KZd	Ljava/util/concurrent/LinkedBlockingQueue;
      //   9: ifnonnull +9 -> 18
      //   12: ldc 133
      //   14: invokestatic 50	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
      //   17: return
      //   18: aload_0
      //   19: getfield 37	com/tencent/mm/plugin/mmsight/segment/d$a:KZg	Ljava/util/concurrent/locks/Lock;
      //   22: invokeinterface 138 1 0
      //   27: aload_0
      //   28: getfield 45	com/tencent/mm/plugin/mmsight/segment/d$a:KZd	Ljava/util/concurrent/LinkedBlockingQueue;
      //   31: ifnonnull +18 -> 49
      //   34: aload_0
      //   35: getfield 37	com/tencent/mm/plugin/mmsight/segment/d$a:KZg	Ljava/util/concurrent/locks/Lock;
      //   38: invokeinterface 141 1 0
      //   43: ldc 133
      //   45: invokestatic 50	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
      //   48: return
      //   49: aload_0
      //   50: getfield 45	com/tencent/mm/plugin/mmsight/segment/d$a:KZd	Ljava/util/concurrent/LinkedBlockingQueue;
      ...
      //   103: aload_0
      //   104: aconst_null
      //   105: putfield 45	com/tencent/mm/plugin/mmsight/segment/d$a:KZd	Ljava/util/concurrent/LinkedBlockingQueue;
      //   108: aload_0
      //   109: getfield 37	com/tencent/mm/plugin/mmsight/segment/d$a:KZg	Ljava/util/concurrent/locks/Lock;
      ...
      //   123: aload_0
      //   124: aconst_null
      //   125: putfield 45	com/tencent/mm/plugin/mmsight/segment/d$a:KZd	Ljava/util/concurrent/LinkedBlockingQueue;
      //   128: aload_0
      //   129: getfield 37	com/tencent/mm/plugin/mmsight/segment/d$a:KZg	Ljava/util/concurrent/locks/Lock;
      ...
      //   144: aload_0
      //   145: aconst_null
      //   146: putfield 45	com/tencent/mm/plugin/mmsight/segment/d$a:KZd	Ljava/util/concurrent/LinkedBlockingQueue;
      //   149: aload_0
      //   150: getfield 37	com/tencent/mm/plugin/mmsight/segment/d$a:KZg	Ljava/util/concurrent/locks/Lock;
    ...
    public final d gcQ()
    {
      ...
      this.KZg.lock();
      Log.d("FetcherPool", "pool.size() %d, size %d, maxFetcherSize %d", new Object[] { Integer.valueOf(this.KZd.size()), Integer.valueOf(this.size), Integer.valueOf(this.KZe) });
      if (this.KZd == null)
      {
        this.KZg.unlock();
        AppMethodBeat.o(107639);
      ...
      if ((this.KZd.isEmpty()) && (this.size < this.KZe))
      {
        Log.d("FetcherPool", "new fetcher");
        this.size += 1;
        this.KZg.unlock();
      }
      for (d locald = gcR();; locald = (d)this.KZd.poll(5L, TimeUnit.SECONDS))
      {
