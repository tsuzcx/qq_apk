  ...
  implements h
{
  private b nTf;
  private a nTg;
  private volatile boolean nTk;
  private volatile Runnable nTl;
  private OutputStream nTm;
  private final LinkedList<byte[]> nTn;
  private final LinkedList<byte[]> nTo;
  ...
  public c$c(b paramb, a parama, BluetoothSocket paramBluetoothSocket)
  {
    ...
    this.nTl = null;
    this.nTm = null;
    this.nTn = new LinkedList();
    this.nTo = new LinkedList();
    this.nTf = null;
    this.nTg = null;
    this.nTk = false;
    this.nTf = paramb;
    ...
    catch (IOException paramb)
    {
      ...
      this.nTm = null;
      if (this.nTg != null) {
        this.nTg.nSW.c(this.nTf.mSessionId, 11, "Can not get write stream");
      }
      AppMethodBeat.o(22603);
    }
  }
  ...
  public final void run()
  {
    ...
    //   13: aload_0
    //   14: getfield 40	com/tencent/mm/plugin/d/a/c/c$c:nTm	Ljava/io/OutputStream;
    //   17: ifnonnull +36 -> 53
    //   20: sipush 22604
    ...
    //   27: astore_1
    //   28: aload_0
    //   29: getfield 51	com/tencent/mm/plugin/d/a/c/c$c:nTg	Lcom/tencent/mm/plugin/d/a/c/a;
    //   32: ifnull +21 -> 53
    //   35: aload_0
    //   36: getfield 51	com/tencent/mm/plugin/d/a/c/c$c:nTg	Lcom/tencent/mm/plugin/d/a/c/a;
    //   39: getfield 78	com/tencent/mm/plugin/d/a/c/a:nSW	Lcom/tencent/mm/plugin/d/a/c/a$a;
    //   42: aload_0
    //   43: getfield 49	com/tencent/mm/plugin/d/a/c/c$c:nTf	Lcom/tencent/mm/plugin/d/a/c/b;
    //   46: getfield 84	com/tencent/mm/plugin/d/a/c/b:mSessionId	J
    //   49: iconst_0
    //   50: invokevirtual 135	com/tencent/mm/plugin/d/a/c/a$a:m	(JZ)V
    //   53: aload_0
    //   54: getfield 53	com/tencent/mm/plugin/d/a/c/c$c:nTk	Z
    //   57: ifne +180 -> 237
    //   60: aload_0
    //   61: getfield 38	com/tencent/mm/plugin/d/a/c/c$c:nTl	Ljava/lang/Runnable;
    //   64: ifnonnull +17 -> 81
    //   67: ldc 64
    //   69: ldc 137
    ...
    //   80: return
    //   81: aload_0
    //   82: getfield 47	com/tencent/mm/plugin/d/a/c/c$c:nTo	Ljava/util/LinkedList;
    //   85: invokevirtual 144	java/util/LinkedList:isEmpty	()Z
    //   88: ifne +50 -> 138
    //   91: aload_0
    //   92: getfield 47	com/tencent/mm/plugin/d/a/c/c$c:nTo	Ljava/util/LinkedList;
    //   95: invokevirtual 148	java/util/LinkedList:pop	()Ljava/lang/Object;
    //   98: checkcast 150	[B
    //   101: astore_1
    //   102: aload_0
    //   103: getfield 40	com/tencent/mm/plugin/d/a/c/c$c:nTm	Ljava/io/OutputStream;
    //   106: aload_1
    //   107: invokevirtual 156	java/io/OutputStream:write	([B)V
    //   110: aload_0
    //   111: getfield 51	com/tencent/mm/plugin/d/a/c/c$c:nTg	Lcom/tencent/mm/plugin/d/a/c/a;
    //   114: ifnull -61 -> 53
    //   117: aload_0
    //   118: getfield 51	com/tencent/mm/plugin/d/a/c/c$c:nTg	Lcom/tencent/mm/plugin/d/a/c/a;
    //   121: getfield 78	com/tencent/mm/plugin/d/a/c/a:nSW	Lcom/tencent/mm/plugin/d/a/c/a$a;
    //   124: aload_0
    //   125: getfield 49	com/tencent/mm/plugin/d/a/c/c$c:nTf	Lcom/tencent/mm/plugin/d/a/c/b;
    //   128: getfield 84	com/tencent/mm/plugin/d/a/c/b:mSessionId	J
    //   131: iconst_1
    //   132: invokevirtual 135	com/tencent/mm/plugin/d/a/c/a$a:m	(JZ)V
    //   135: goto -82 -> 53
    //   138: aload_0
    //   139: getfield 45	com/tencent/mm/plugin/d/a/c/c$c:nTn	Ljava/util/LinkedList;
    //   142: invokevirtual 144	java/util/LinkedList:isEmpty	()Z
    //   145: ifne +47 -> 192
    //   148: aload_0
    //   149: getfield 45	com/tencent/mm/plugin/d/a/c/c$c:nTn	Ljava/util/LinkedList;
    //   152: astore_1
    //   153: aload_1
    //   154: monitorenter
    //   155: aload_0
    //   156: getfield 47	com/tencent/mm/plugin/d/a/c/c$c:nTo	Ljava/util/LinkedList;
    //   159: aload_0
    //   160: getfield 45	com/tencent/mm/plugin/d/a/c/c$c:nTn	Ljava/util/LinkedList;
    ...
    //   169: aload_0
    //   170: getfield 45	com/tencent/mm/plugin/d/a/c/c$c:nTn	Ljava/util/LinkedList;
