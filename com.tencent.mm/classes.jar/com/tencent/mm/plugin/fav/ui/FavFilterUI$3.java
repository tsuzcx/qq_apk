...
final class FavFilterUI$3
  implements View.OnCreateContextMenuListener
{
  FavFilterUI$3(FavFilterUI paramFavFilterUI, int paramInt) {}
  
  public final void onCreateContextMenu(ContextMenu paramContextMenu, View paramView, ContextMenu.ContextMenuInfo paramContextMenuInfo)
  {
    AppMethodBeat.i(235284);
    paramContextMenuInfo = new k();
    paramView = FavFilterUI.f(this.tek).Id(this.vi - FavFilterUI.b(this.tek).getHeaderViewsCount() - 1);
 ...
 * Qualified Name:     com.tencent.mm.plugin.fav.ui.FavFilterUI.3
