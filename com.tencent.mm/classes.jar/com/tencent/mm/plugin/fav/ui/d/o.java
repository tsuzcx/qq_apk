  ...
  extends b
{
  ...
  public final View a(View paramView, ViewGroup paramViewGroup, com.tencent.mm.plugin.fav.a.g paramg)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.thK = ((MMImageView)paramView.findViewById(2131300468));
      ...
      ank localank = paramg.field_favProto.LwW;
      if (localank == null) {
        break label218;
      }
      paramViewGroup.jVO.setText(Util.nullAsNil(localank.title));
      paramViewGroup.jBR.setText(Util.nullAsNil(localank.desc));
    }
    for (;;)
    {
      ...
      this.tdg.a(paramViewGroup.thK, null, paramg, 2131689580, this.tlc, this.tlc);
      AppMethodBeat.o(107487);
      return paramView;
      paramViewGroup = (a)paramView.getTag();
      break;
      label218:
      paramViewGroup.jVO.setText("");
      paramViewGroup.jBR.setText("");
    }
  }
