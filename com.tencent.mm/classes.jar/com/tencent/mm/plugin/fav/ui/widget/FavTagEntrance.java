  ...
  implements k.a
{
  ...
  public FavTagEntrance(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.dCD = -1L;
    this.rNc = String.valueOf(this.dCD);
  ...
  public final void a(String paramString, m paramm)
  {
    ...
    ae.d("MicroMsg.FavTagEntrence", "on notify change event %s, favIDStr %s", new Object[] { paramString, this.rNc });
    if (this.rNc.equals(paramString))
    {
      paramString = ((af)com.tencent.mm.kernel.g.ad(af.class)).getFavItemInfoStorage().vU(this.dCD);
      if (paramString == null)
      {
        ae.w("MicroMsg.FavTagEntrence", "id[%d] info is null, return", new Object[] { Long.valueOf(this.dCD) });
        AppMethodBeat.o(107550);
        return;
      }
      setTagContent(paramString.field_tagProto.GCs);
    }
    AppMethodBeat.o(107550);
  }
  ...
  protected void onFinishInflate()
  {
    ...
    this.rNb = ((TextView)findViewById(2131305622));
    setOnClickListener(new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        ...
        a.b("com/tencent/mm/plugin/fav/ui/widget/FavTagEntrance$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahF());
  ...
  public void setFavItemID(long paramLong)
  {
    ...
    this.dCD = paramLong;
    this.rNc = String.valueOf(paramLong);
  ...
  public void setTagContent(List<String> paramList)
  {
    ...
    this.rNb.setText(k.b(getContext(), (CharSequence)localObject, this.rNb.getTextSize()));
    AppMethodBeat.o(107549);
  }
}
