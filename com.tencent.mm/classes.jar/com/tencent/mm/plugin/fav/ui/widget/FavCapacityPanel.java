  ...
  public FavCapacityPanel(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.cBW = new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        ...
        if (FavCapacityPanel.this.qTZ == 0) {
    ...
    this.qTY = ((TextView)paramContext.findViewById(2131299763));
    ...
    localView.setOnClickListener(this.cBW);
    paramAttributeSet = new LinearLayout.LayoutParams(0, -2);
    paramAttributeSet.weight = 1.0F;
    this.qTW.addView(paramContext, paramAttributeSet);
    this.qTX = (b.coY() / 1048576L);
    this.qUa = (b.coZ() / 1048576L);
    paramContext = this.qTY;
    paramAttributeSet = this.qTY.getContext();
    if (this.qUa - this.qTX > 0L) {}
    for (long l = this.qUa - this.qTX;; l = 0L)
    {
      paramContext.setText(paramAttributeSet.getString(2131758820, new Object[] { Long.valueOf(l), Long.valueOf(this.qTX) }));
