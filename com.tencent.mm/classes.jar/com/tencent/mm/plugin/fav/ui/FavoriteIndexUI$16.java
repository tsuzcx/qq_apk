  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    List localList = ((af)com.tencent.mm.kernel.g.ah(af.class)).getFavItemInfoStorage().cUW();
    if (localList != null)
    {
      ...
      while (i < j)
      {
        ((af)com.tencent.mm.kernel.g.ah(af.class)).getFavItemInfoStorage().A((com.tencent.mm.plugin.fav.a.g)localList.get(i));
        i += 1;
      }
