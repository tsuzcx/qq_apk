...
{
  private static String lKI = "";
  public static Set<String> wHO;
  public static int wHP = 1;
  ...
  public static int bkM()
  {
    ...
    //   12: dup
    //   13: invokestatic 39	com/tencent/mm/plugin/fav/a/ap:dkn	()Ljava/lang/String;
    //   16: ldc 41
  ...
  public static String dkm()
  {
    ...
    for (Object localObject = new File(nL(false), "wenote/res");; localObject = new File(b.aSL(), "wenote/res"))
    {
  ...
  public static String dkn()
  {
    ...
    Object localObject = new File(nL(false), "wenote/res");
    ...
    localObject = new File(b.aSL(), "wenote/res");
    if (new File((File)localObject, "WNNote.zip").exists())
    {
      localObject = ((File)localObject).getAbsolutePath();
      AppMethodBeat.o(127422);
  ...
  public static String dko()
  {
    ...
    Object localObject = new File(nL(true), "wenote/loc/data");
  ...
  public static String dkp()
  {
    ...
    File localFile = new File(nL(false), "wenote/html/upload");
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  ...
  public static String dkq()
  {
    ...
    Object localObject = new File(nL(true), "wenote/image/localpath");
    if (!((File)localObject).exists()) {
      ((File)localObject).mkdirs();
    }
    localObject = ((File)localObject).getAbsolutePath();
  ...
  public static String dkr()
  {
    ...
    Object localObject = new File(nL(true), "wenote/voice/data");
    if (!((File)localObject).exists()) {
      ((File)localObject).mkdirs();
    }
    localObject = ((File)localObject).getAbsolutePath();
  ...
  private static String nL(boolean paramBoolean)
  {
