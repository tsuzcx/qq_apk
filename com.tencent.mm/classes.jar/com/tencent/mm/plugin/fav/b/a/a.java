  ...
  extends com.tencent.mm.plugin.fts.a.a
{
  ...
  public final void a(int paramInt1, long paramLong1, String paramString1, long paramLong2, String paramString2, int paramInt2)
  {
    ...
    try
    {
      ...
      eqL().execute();
      this.wHS.bindLong(1, 196608L);
      this.wHS.bindLong(2, paramInt1);
      this.wHS.bindLong(3, paramLong1);
      this.wHS.bindString(4, paramString1);
      this.wHS.bindLong(5, paramLong2);
      this.wHS.bindLong(6, paramInt2);
      this.wHS.execute();
      if (!bool) {
        this.BGp.commit();
      }
  ...
  public final void aEr()
  {
    ...
    String str = String.format("INSERT INTO %s (docid, type, subtype, entity_id, aux_index, timestamp, fav_type) VALUES (last_insert_rowid(), ?, ?, ?, ?, ?, ?);", new Object[] { eqI() });
    this.wHS = this.BGp.compileStatement(str);
  ...
  public final String dkv()
  {
    ...
    String str = String.format("CREATE TABLE IF NOT EXISTS %s (docid INTEGER PRIMARY KEY, type INT, subtype INT DEFAULT 0, entity_id INTEGER, aux_index TEXT, timestamp INTEGER, status INT DEFAULT 0, fav_type INT DEFAULT 0);", new Object[] { eqI() });
