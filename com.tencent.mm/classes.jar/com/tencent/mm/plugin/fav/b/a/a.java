  ...
  extends com.tencent.mm.plugin.fts.a.a
{
  ...
  public final void a(int paramInt1, long paramLong1, String paramString1, long paramLong2, String paramString2, int paramInt2)
  {
    ...
    try
    {
      ...
      this.tsE.execute();
      this.rtW.bindLong(1, 196608L);
      this.rtW.bindLong(2, paramInt1);
      this.rtW.bindLong(3, paramLong1);
      this.rtW.bindString(4, paramString1);
      this.rtW.bindLong(5, paramLong2);
      this.rtW.bindLong(6, paramInt2);
      this.rtW.execute();
      if (!bool) {
        this.tsD.commit();
      }
  ...
  public final void agy()
  {
    ...
    String str = String.format("INSERT INTO %s (docid, type, subtype, entity_id, aux_index, timestamp, fav_type) VALUES (last_insert_rowid(), ?, ?, ?, ?, ?, ?);", new Object[] { cSF() });
    this.rtW = this.tsD.compileStatement(str);
  ...
  public final String cvK()
  {
    ...
    String str = String.format("CREATE TABLE IF NOT EXISTS %s (docid INTEGER PRIMARY KEY, type INT, subtype INT DEFAULT 0, entity_id INTEGER, aux_index TEXT, timestamp INTEGER, status INT DEFAULT 0, fav_type INT DEFAULT 0);", new Object[] { cSF() });
