  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        Object localObject1 = new e(ah.GDu + "SdcardInfo.cfg");
        Object localObject2 = h.wUl;
        if (((e)localObject1).exists())
        {
          l1 = 10L;
          ((h)localObject2).idkeyStat(340L, l1, 1L, true);
          boolean bool1 = bh.eVR();
          ...
          boolean bool2 = com.tencent.mm.loader.j.b.apb().equals(str1);
          if (bool2) {
            break label1230;
          }
          ...
          l3 = l2;
          l2 = l6;
          localObject3 = bh.aLf(com.tencent.mm.loader.j.b.apb());
          String str2 = bh.aLf((String)localObject2);
          Object localObject4 = com.tencent.mm.loader.j.b.apb();
          if (((e)localObject1).exists())
          {
            m = 1;
            ac.i("MicroMsg.SubCoreBaseMonitor", "summerStorage [%s, %s, %s] [%s] [%b] [%d,%d,%d,%d,%d,%d] [%d,%d,%d,%d,%d,%d] [%b] [%d,%d,%d,%d,%d,%d], [%d][%s]", new Object[] { localObject2, str1, localObject4, localObject3, Boolean.valueOf(bool1), Long.valueOf(l12), Long.valueOf(l13), Long.valueOf(l14), Long.valueOf(l15), Long.valueOf(l16), Integer.valueOf(k), Long.valueOf(l7), Long.valueOf(l8), Long.valueOf(l9), Long.valueOf(l10), Long.valueOf(l11), Integer.valueOf(i), Boolean.valueOf(bool2), Long.valueOf(l5), Long.valueOf(l4), Long.valueOf(l3), Long.valueOf(l2), Long.valueOf(l1), Integer.valueOf(j), Integer.valueOf(m), str2 });
            h.wUl.idkeyStat(340L, 0L, 1L, true);
            localObject4 = h.wUl;
            if (!bool1) {
              continue;
            }
            ...
            ((h)localObject4).idkeyStat(340L, l6, 1L, true);
            localObject4 = h.wUl;
            String str3 = com.tencent.mm.loader.j.b.apb();
            if (!bool1) {
              continue;
            }
            m = 1;
            ...
            h.wUl.f(11098, new Object[] { Integer.valueOf(5001), (String)localObject2 + ";" + str2 });
            h.wUl.f(11098, new Object[] { Integer.valueOf(5002), com.tencent.mm.loader.j.b.apb() + ";" + (String)localObject3 });
            localObject2 = h.wUl;
            if (!((e)localObject1).exists()) {
              continue;
            }
            ...
            h.wUl.idkeyStat(340L, 7L, 1L, true);
      ...
      {
        ac.printErrStackTrace("MicroMsg.SubCoreBaseMonitor", localException, "reportSDStatus err!", new Object[0]);
        h.wUl.idkeyStat(340L, 8L, 1L, true);
        AppMethodBeat.o(51505);
        return;
      }
      label1217:
