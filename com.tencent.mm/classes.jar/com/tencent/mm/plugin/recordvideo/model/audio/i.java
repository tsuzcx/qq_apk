  ...
  implements m
{
  ...
  public i(b paramb)
  {
    ...
    localays.finderUsername = z.bAW();
    localays.hJx = 0;
    paramb = new atz();
    paramb.scene = 101;
    ah localah = ah.aiuX;
    localays.ZEc = paramb;
    locala.otE = ((a)localays);
    locala.funcId = getType();
    locala.otF = ((a)new ayt());
    locala.uri = "/cgi-bin/micromsg-bin/findergetfavlist";
    paramb = locala.bEF();
    kotlin.g.b.s.s(paramb, "builder.buildInstance()");
    this.rr = paramb;
    Log.i(this.TAG, kotlin.g.b.s.X(" init:NetSceneAudioPanelGetFinderFavList ", localays.finderUsername));
