  ...
  extends b
{
  ...
  public final Bitmap b(k paramk)
  {
    ...
    ((TextView)localObject3).setText((CharSequence)paramk.xOD);
    ((TextView)localObject2).setText((CharSequence)paramk.jDf);
    ((ImageView)localObject4).setImageDrawable(ao.k(getContext(), 2131690422, -1));
    localObject4 = paramk.jDf;
    ...
    if (i >= e.dEN().left)
    {
      ...
      ad.i(this.TAG, paramk + " parent.measuredWidth:" + ((View)localObject1).getMeasuredWidth() + " , parent.measuredHeight:" + ((View)localObject1).getMeasuredHeight());
    ...
    label646:
    for (int j = e.dEN().height();; j = ((View)localObject1).getMeasuredHeight())
    {
  ...
  {
    return com.tencent.mm.plugin.recordvideo.ui.editor.view.b.xQK;
  }
  ...
  public final void setLocation(csd paramcsd)
  {
    AppMethodBeat.i(76165);
    d.g.b.p.h(paramcsd, "location");
    String str1 = paramcsd.jde;
    d.g.b.p.g(str1, "location.City");
    String str2 = paramcsd.jDf;
    d.g.b.p.g(str2, "location.poiName");
    b(new k(str1, str2, paramcsd.FOA, paramcsd.FOB));
    paramcsd = getBitmap();
    if (paramcsd != null)
    {
      float f2 = getValidRect().height() - aq.fromDPToPix(getContext(), 128) - ar.ej(getContext());
      float f3 = paramcsd.getHeight();
      int i = this.api;
      paramcsd = e.xuo;
      if (i >= e.dEN().left) {}
