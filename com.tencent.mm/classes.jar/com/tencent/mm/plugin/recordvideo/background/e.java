  ...
  extends j<d>
{
  ...
  static
  {
    ...
    Object localObject = d.vdA;
    localObject = d.dgD();
    d.a locala = d.vdA;
    SQL_CREATE = new String[] { j.getCreateSQLs((c.a)localObject, d.dgE()) };
    localObject = d.vdA;
    TABLE = d.dgE();
  ...
  {
    super(parame, (c.a)localObject1, (String)localObject2, d.dgF());
  ...
  public final int a(String paramString, d paramd)
  {
    ...
    paramd.remove("rowid");
    int i = this.db.update(TABLE, paramd, "taskId=?", new String[] { String.valueOf(paramString) });
    AppMethodBeat.o(75184);
    return i;
  }
  
  /* Error */
  public final d aly(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   7: aload_1
    //   8: ldc 114
    //   10: invokestatic 100	d/g/b/k:h	(Ljava/lang/Object;Ljava/lang/String;)V
    //   13: getstatic 150	d/g/b/z:Jhz	Ld/g/b/z;
    //   16: astore_3
    //   17: ldc 152
    //   19: iconst_3
    ...
    //   23: dup
    //   24: iconst_0
    //   25: getstatic 88	com/tencent/mm/plugin/recordvideo/background/e:TABLE	Ljava/lang/String;
    //   28: aastore
    //   29: dup
    //   30: iconst_1
    //   31: ldc 114
    ...
    //   58: invokevirtual 173	com/tencent/mm/plugin/recordvideo/background/e:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   61: astore_1
    //   62: aload_1
    //   63: ifnull +59 -> 122
    //   66: aload_1
    ...
    //   82: ifeq +31 -> 113
    //   85: new 66	com/tencent/mm/plugin/recordvideo/background/d
    //   88: dup
    //   89: invokespecial 183	com/tencent/mm/plugin/recordvideo/background/d:<init>	()V
    //   92: astore 4
    //   94: aload 4
    //   96: aload_1
    //   97: invokevirtual 187	com/tencent/mm/plugin/recordvideo/background/d:convertFrom	(Landroid/database/Cursor;)V
    //   100: aload_3
    //   101: aconst_null
    ...
    //   110: aload 4
    //   112: areturn
    //   113: getstatic 198	d/y:JfV	Ld/y;
    //   116: astore_1
    //   117: aload_3
    //   118: aconst_null
  ...
  /* Error */
  public final d rT(long paramLong)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
    ...
    //   8: getstatic 150	d/g/b/z:Jhz	Ld/g/b/z;
    //   11: astore 4
    //   13: getstatic 88	com/tencent/mm/plugin/recordvideo/background/e:TABLE	Ljava/lang/String;
    //   16: astore 4
    //   18: getstatic 227	com/tencent/mm/plugin/recordvideo/background/d$b:vdD	Lcom/tencent/mm/plugin/recordvideo/background/d$b;
    //   21: astore 6
    //   23: invokestatic 231	com/tencent/mm/plugin/recordvideo/background/d$b:blq	()I
    //   26: istore_3
    //   27: getstatic 227	com/tencent/mm/plugin/recordvideo/background/d$b:vdD	Lcom/tencent/mm/plugin/recordvideo/background/d$b;
    //   30: astore 6
    //   32: ldc 233
    //   34: bipush 8
    ...
    //   56: dup
    //   57: iconst_3
    //   58: invokestatic 243	com/tencent/mm/plugin/recordvideo/background/d$b:dgH	()I
    ...
    //   113: invokevirtual 173	com/tencent/mm/plugin/recordvideo/background/e:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   116: astore 4
    //   118: aload 4
    //   120: ifnull +68 -> 188
    //   123: aload 4
    ...
    //   144: ifeq +33 -> 177
    //   147: new 66	com/tencent/mm/plugin/recordvideo/background/d
    //   150: dup
    //   151: invokespecial 183	com/tencent/mm/plugin/recordvideo/background/d:<init>	()V
    //   154: astore 7
    //   156: aload 7
    //   158: aload 4
    //   160: invokevirtual 187	com/tencent/mm/plugin/recordvideo/background/d:convertFrom	(Landroid/database/Cursor;)V
    //   163: aload 6
    //   165: aconst_null
    ...
    //   174: aload 7
    //   176: areturn
    //   177: getstatic 198	d/y:JfV	Ld/y;
    //   180: astore 4
    //   182: aload 6
    //   184: aconst_null
  ...
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/recordvideo/background/VideoEditDataStorage$Companion;", "", "()V", "SQL_CREATE", "", "", "kotlin.jvm.PlatformType", "getSQL_CREATE", "()[Ljava/lang/String;", "[Ljava/lang/String;", "TABLE", "getTABLE", "()Ljava/lang/String;", "TAG", "getTAG", "plugin-recordvideo_release"})
