...
@l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/recordvideo/appcamera/PluginMMSight;", "Lcom/tencent/mm/kernel/plugin/Plugin;", "Lcom/tencent/mm/plugin/recordvideo/appcamera/IPluginMMSight;", "()V", "execute", "", "profile", "Lcom/tencent/mm/kernel/plugin/ProcessProfile;", "name", "", "Companion", "plugin-recordvideo_release"})
public final class PluginMMSight
  extends f
  implements e
{
  private static final String TAG = "MicroMsg.PluginMMSight";
  public static final PluginMMSight.a vdn;
  
  static
  {
    AppMethodBeat.i(75153);
    vdn = new PluginMMSight.a((byte)0);
  ...
  public final void execute(g paramg)
  {
    ...
    com.tencent.mm.plugin.mmsight.api.b.tBr = (com.tencent.mm.plugin.mmsight.api.b.a)new com.tencent.mm.plugin.api.b.a();
    com.tencent.mm.plugin.mmsight.api.MMSightRecordView.tBq = (MMSightRecordView.b)new c();
    com.tencent.mm.plugin.mmsight.api.a.tBo = (a.b)new a();
    if (paramg != null)
    {
      if (paramg.agu() == true) {
