...
@l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/recordvideo/report/StoryRemuxIDKeyStat;", "", "()V", "ID", "", "TAG", "", "markCreateThumbFailed", "", "markRemuxProcessType", "isForeground", "", "markStoryRemuxHitBitrateExceed", "markStoryRemuxResult", "isLocalCapture", "bitrate", "", "fps", "plugin-recordvideo_release"})
public final class f
{
  ...
  public static void j(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    {
      h.CyF.n(986L, 56L, 1L);
      h.CyF.n(986L, 60L, paramInt1);
      h.CyF.n(986L, 63L, paramInt2);
      AppMethodBeat.o(75855);
      return;
    }
    h.CyF.n(986L, 57L, 1L);
    h.CyF.n(986L, 66L, paramInt1);
    h.CyF.n(986L, 69L, paramInt2);
    AppMethodBeat.o(75855);
  }
