...
@l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/recordvideo/util/WeSeeUtil;", "", "()V", "TAG", "", "buildCameraEntranceSessionId", "timestamp", "", "bytesToHexString", "bArray", "", "checkWeishiInstalled", "", "context", "Landroid/content/Context;", "doCpatureWeSeeSight", "", "videoPath", "doDownloadWeSee", "plugin-recordvideo_release"})
public final class e
{
  public static final e vtS;
  ...
  public static boolean fK(Context paramContext)
  {
    ...
    bool2 = bt.kU(paramContext, "2A281593D71DF33374E6124E9106DF08");
    if (bool2)
    {
  ...
  public static String rV(long paramLong)
  {
    AppMethodBeat.i(76228);
    Object localObject = new StringBuilder();
    k.g(g.afz(), "MMKernel.account()");
    localObject = a.aeo() + "_" + paramLong;
