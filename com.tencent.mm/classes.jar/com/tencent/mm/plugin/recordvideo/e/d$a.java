...
public final class d$a
{
  ...
  public d$a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean, int paramInt7, int paramInt8, int paramInt9)
  {
  ...
  public final boolean equals(Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof a))
      {
        ...
        if ((this.width != paramObject.width) || (this.height != paramObject.height) || (this.duration != paramObject.duration) || (this.dYT != paramObject.dYT) || (this.videoBitrate != paramObject.videoBitrate) || (this.fps != paramObject.fps) || (this.Cio != paramObject.Cio) || (this.Cip != paramObject.Cip) || (this.Ciq != paramObject.Ciq) || (this.Cir != paramObject.Cir)) {}
      }
    }
    else {
      return true;
 ...
 * Qualified Name:     com.tencent.mm.plugin.recordvideo.e.d.a
