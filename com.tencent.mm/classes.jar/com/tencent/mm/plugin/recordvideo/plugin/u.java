  ...
  implements View.OnClickListener, t
{
  ...
  public u(ImageView paramImageView, d paramd)
  {
    ...
    this.rCL.setImageDrawable(ao.k(this.rCL.getContext(), 2131690348, -1));
    this.enable = true;
  ...
  public final void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt1 == 1000) && (paramInt2 == -1))
    {
      ...
      for (ArrayList localArrayList1 = paramIntent.getStringArrayListExtra("key_select_video_list");; localArrayList1 = null)
      {
        ...
        paramIntent = com.tencent.mm.plugin.recordvideo.activity.a.b.xtA;
        ...
        this.sQE.a(d.c.xEk, localBundle);
  ...
  public final void onClick(View paramView)
  {
    ...
    com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/recordvideo/plugin/RecordAlbumPlugin", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((com.tencent.mm.hellhoundlib.b.b)localObject).ahq());
    ...
    default: 
      ...
      localObject = this.rCL.getContext();
      if (localObject == null)
      {
      ...
      break;
    case 3: 
      paramView.putExtra("key_edit_video_max_time_length", ((a.a)com.tencent.mm.plugin.recordvideo.b.a.a.xxI.ate()).xxS);
      paramView.putExtra("key_edit_text_color", "#0E9CE6");
      boolean bool2 = ((com.tencent.mm.plugin.expt.b.b)g.ab(com.tencent.mm.plugin.expt.b.b.class)).a(com.tencent.mm.plugin.expt.b.b.a.qzi, false);
      localObject = g.ajC();
      p.g(localObject, "storage()");
      if ((((e)localObject).ajl().getInt(al.a.IDh, 0) == 1) || (bool2)) {}
      for (int i = 1;; i = 0)
      {
        if (i == 0) {
          bool1 = true;
        ...
        if (!((a.a)com.tencent.mm.plugin.recordvideo.b.a.a.xxI.ate()).xxO) {
          break label342;
        }
        localObject = this.rCL.getContext();
        if (localObject != null) {
