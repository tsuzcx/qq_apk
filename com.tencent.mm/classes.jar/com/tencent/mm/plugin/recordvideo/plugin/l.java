  ...
  implements View.OnClickListener, t
{
  ...
  public l(ImageView paramImageView, d paramd)
  {
    ...
    this.rCL.setImageDrawable(ao.k(this.rCL.getContext(), 2131690370, -1));
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bd(paramView);
    a.b("com/tencent/mm/plugin/recordvideo/plugin/EditPhotoCropPlugin", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.ahq());
    d.b.a(this.sQE, d.c.xEZ);
    paramView = c.xHa;
    c.NM(10);
    paramView = c.xHa;
    c.avN("KEY_CLICK_CROP_COUNT_INT");
