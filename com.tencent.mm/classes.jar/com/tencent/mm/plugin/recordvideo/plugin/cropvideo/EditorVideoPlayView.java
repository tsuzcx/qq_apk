  ...
  extends VideoPlayerTextureView
{
  ...
  public final void k(SurfaceTexture paramSurfaceTexture)
  {
    ...
    paramSurfaceTexture = this.oNM;
    if (paramSurfaceTexture != null)
    {
      paramSurfaceTexture.eM(getCurrentPosition(), getDuration());
