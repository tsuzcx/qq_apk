...
{
  private static boolean tss;
  private static List<a> tst;
  ...
  public static void a(a parama)
  {
    ...
    ad.d("MicroMsg.QueryWeChatWalletManager", "remove ret: %s", new Object[] { Boolean.valueOf(tst.remove(parama)) });
  ...
  public static void a(a parama, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    String str = (String)((com.tencent.mm.plugin.wxpay.a.a)com.tencent.mm.kernel.g.ad(com.tencent.mm.plugin.wxpay.a.a.class)).getWalletCacheStg().get(ae.a.FuF, null);
    if (!bt.isNullOrNil(str)) {}
    try
    {
      localcfp.parseFrom(str.getBytes(org.apache.commons.a.a.ISO_8859_1));
      if (paramBoolean2)
      {
        if (parama != null) {
          parama.b(localcfp);
        ...
        {
          if ((parama != null) && (!tst.contains(parama))) {
            tst.add(parama);
          }
          if (!tss) {
            break label209;
  ...
  {
    public abstract void b(cfp paramcfp);
    
    public abstract void c(cfp paramcfp);
  }
}
