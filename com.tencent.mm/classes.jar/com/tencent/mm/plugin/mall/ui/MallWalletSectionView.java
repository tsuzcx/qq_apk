  ...
  extends LinearLayout
{
  ...
  public final void a(bif parambif, boolean paramBoolean)
  {
    AppMethodBeat.i(66162);
    if (parambif.DFN != null)
    {
      g.afC();
      String str1 = (String)g.afB().afk().get(ae.a.Fsb, "");
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localdav = (dav)parambif.DFN.get(i);
          str1 = null;
          if (!"balance_cell".equals(localdav.CDW)) {
            break label279;
          }
          l = ((Long)((a)g.ad(a.class)).getWalletCacheStg().get(ae.a.Fsw, Long.valueOf(0L))).longValue();
          str1 = getContext().getString(2131765813) + com.tencent.mm.wallet_core.ui.e.D(com.tencent.mm.wallet_core.ui.e.a(String.valueOf(l), "100", 2, RoundingMode.HALF_UP).doubleValue());
          if (i >= j) {
            break;
          }
          ...
          bool = true;
          localMallWalletSectionCellView.a(localdav, localJSONObject, bool, str1, paramBoolean);
          i += 1;
          continue;
        ...
        continue;
        if ("lqt_cell".equals(localdav.CDW))
        {
          l = ((Long)((a)g.ad(a.class)).getWalletCacheStg().get(ae.a.Fsx, Long.valueOf(0L))).longValue();
          str2 = getContext().getString(2131765813) + com.tencent.mm.wallet_core.ui.e.D(com.tencent.mm.wallet_core.ui.e.a(String.valueOf(l), "100", 2, RoundingMode.HALF_UP).doubleValue());
          continue;
          label373:
          bool = false;
        }
      ...
      {
        localMallWalletSectionCellView.a(localdav, localJSONObject, bool, str2, paramBoolean);
