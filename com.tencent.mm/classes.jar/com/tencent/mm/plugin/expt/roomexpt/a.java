...
public final class a
  implements c, d
{
  private static final float[] raO = { 0.0F, 0.3F, 0.45F, 0.55F, 0.67F, 0.75F, 0.85F, 1.0F };
  private static final float[] raP = { 0.0F, 0.0F, 0.0F, 0.0F, 0.1F, 0.2F, 0.3F, 0.4F };
  private static final float[] raQ = { 0.0F, 0.1F, 0.2F, 0.3F, 0.4F, 0.5F, 0.6F, 0.7F, 0.8F, 0.9F, 1.0F };
  private static final int[] raR = { 15, 35, 83, 140, 209, 297, 417, 599, 926, 1720 };
  private static final float[] raS = { 0.0F, 0.3F, 0.5F, 0.6F, 0.7F, 0.7F, 0.8F, 0.8F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 1.0F };
  private static final float[] raT = { 0.0F, 0.3F, 0.45F, 0.55F, 0.6F, 0.7F, 0.7F, 0.8F, 0.8F, 0.8F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 1.0F };
  private static final float[] raU = { 0.1F, 0.2F, 0.3F, 0.4F, 0.5F, 0.6F, 0.7F, 0.8F, 0.9F, 1.0F };
  private static final int[] raV = { 2400, 7500, 13000, 21500, 41000, 65000, 116000, 215000, 455000 };
  private static final float[] raW = { 0.0F, 0.35F, 0.5F, 0.6F, 0.7F, 0.7F, 0.8F, 0.8F, 0.8F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 0.9F, 1.0F };
  private static a raY;
  private SimpleDateFormat raX;
  public b raZ;
  private ed rba;
  private String[] rbb;
  private boolean rbc;
  ...
  private void crr()
  {
    ...
    String str = this.rba.RD();
    com.tencent.mm.kernel.g.ajC().ajl().set(al.a.IDP, str);
    ad.i("MicroMsg.ChatRoomExptService", "save expt info[%s]", new Object[] { this.rba.RE() });
    AppMethodBeat.o(122402);
  }
  ...
  public final void a(final String paramString1, final String paramString2, final long paramLong, final int paramInt1, int paramInt2, final boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      break;
      label73:
      com.tencent.mm.plugin.report.service.g.yhR.dD(869, 1);
      long l = this.rba.ehF;
      if (l >= 3L)
      {
      ...
      else
      {
        ...
        for (l = 1L | l;; l = 0x2 | l)
        {
          ...
          com.tencent.mm.plugin.report.service.g.yhR.dD(869, 2);
          crr();
          i = 0;
          break;
          i = 0;
    ...
    com.tencent.mm.kernel.g.ajF().ay(new Runnable()
    {
      public final void run()
      {
        ...
        label102:
        int i;
        if (a.a(a.this).ehG <= 0L)
        {
          a.a(a.this).Ti();
          a.c(a.this);
          str1 = a.e(a.this);
          bool1 = a.x(paramLong, paramString1);
          locale = a.f(a.this).ga(paramInt1, str1);
        ...
        {
          if (!bool2) {
            com.tencent.mm.plugin.report.service.g.yhR.dD(869, 32);
          }
          ad.i("MicroMsg.ChatRoomExptService", "noteroominfo isUpdate[%b] dbOpRet[%b] cost[%d] item[%s]", new Object[] { Boolean.valueOf(bool1), Boolean.valueOf(bool2), Long.valueOf(bt.aO(l1)), locale });
          AppMethodBeat.o(122397);
          return;
          if (l2 - a.a(a.this).ehG < 604800L) {
            break;
          }
          a.d(a.this);
          AppMethodBeat.o(122397);
          ...
          locale.field_nickname = this.rbk;
  ...
  public final void aV(final String paramString, final boolean paramBoolean)
  {
    ...
    if (this.rba.ehF >= 5L)
    {
      ad.d("MicroMsg.ChatRoomExptService", "exptInfo is finish [%d]", new Object[] { Long.valueOf(this.rba.ehF) });
      AppMethodBeat.o(122405);
      return;
    }
    com.tencent.mm.kernel.g.ajF().ay(new Runnable()
    {
      public final void run()
      {
        ...
        b.a locala = b.a.qpK;
        if (a.a(a.this) != null) {}
        for (boolean bool = a.a(a.this).ehI; !localb.a(locala, bool); bool = false)
        {
  ...
  final java.util.List<c> crs()
  {
    ...
    //   8: aload_0
    //   9: getfield 124	com/tencent/mm/plugin/expt/roomexpt/a:rba	Lcom/tencent/mm/g/b/a/ed;
    //   12: ifnonnull +19 -> 31
    //   15: ldc 216
    //   17: ldc_w 497
    ...
    //   30: areturn
    //   31: aload_0
    //   32: getfield 124	com/tencent/mm/plugin/expt/roomexpt/a:rba	Lcom/tencent/mm/g/b/a/ed;
    //   35: getfield 439	com/tencent/mm/g/b/a/ed:ehF	J
    //   38: ldc2_w 440
    //   41: lcmp
    //   42: iflt +36 -> 78
    //   45: ldc 216
    ...
    //   55: iconst_0
    //   56: aload_0
    //   57: getfield 124	com/tencent/mm/plugin/expt/roomexpt/a:rba	Lcom/tencent/mm/g/b/a/ed;
    //   60: getfield 439	com/tencent/mm/g/b/a/ed:ehF	J
    ...
    //   87: astore 9
    //   89: getstatic 430	com/tencent/mm/plugin/expt/b/b$a:qpK	Lcom/tencent/mm/plugin/expt/b/b$a;
    //   92: astore 10
    //   94: aload_0
    //   95: getfield 124	com/tencent/mm/plugin/expt/roomexpt/a:rba	Lcom/tencent/mm/g/b/a/ed;
    //   98: ifnull +42 -> 140
    //   101: aload_0
    //   102: getfield 124	com/tencent/mm/plugin/expt/roomexpt/a:rba	Lcom/tencent/mm/g/b/a/ed;
    //   105: getfield 433	com/tencent/mm/g/b/a/ed:ehI	Z
    //   108: istore 6
    //   110: aload 9
    //   112: aload 10
    //   114: iload 6
    ...
    //   143: goto -33 -> 110
    //   146: aload_0
    //   147: getfield 312	com/tencent/mm/plugin/expt/roomexpt/a:rbb	[Ljava/lang/String;
    //   150: ifnull +27 -> 177
    //   153: aload_0
    //   154: getfield 312	com/tencent/mm/plugin/expt/roomexpt/a:rbb	[Ljava/lang/String;
    //   157: arraylength
    //   158: ifle +19 -> 177
    //   161: ldc 216
    //   163: ldc_w 508
    ...
    //   176: areturn
    //   177: aload_0
    //   178: getfield 100	com/tencent/mm/plugin/expt/roomexpt/a:rbc	Z
    //   181: ifeq +19 -> 200
    //   184: ldc 216
    //   186: ldc_w 510
    ...
    //   198: aconst_null
    //   199: areturn
    //   200: invokestatic 513	com/tencent/mm/sdk/platformtools/bt:HI	()J
    //   203: lstore 7
    //   205: aload_0
    //   206: iconst_1
    //   207: putfield 100	com/tencent/mm/plugin/expt/roomexpt/a:rbc	Z
    //   210: getstatic 303	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
    //   213: sipush 869
    //   216: bipush 21
    //   218: invokevirtual 307	com/tencent/mm/plugin/report/service/g:dD	(II)V
    //   221: aload_0
    //   222: getfield 412	com/tencent/mm/plugin/expt/roomexpt/a:raZ	Lcom/tencent/mm/plugin/expt/roomexpt/b;
    //   225: invokevirtual 519	com/tencent/mm/plugin/expt/roomexpt/b:crw	()Landroid/database/Cursor;
    //   228: astore 10
    ...
    //   382: aload 14
    //   384: getfield 565	com/tencent/mm/plugin/expt/roomexpt/c:dmU	Ljava/lang/String;
    ...
    //   395: ldc 161
    //   397: aload 14
    //   399: getfield 565	com/tencent/mm/plugin/expt/roomexpt/c:dmU	Ljava/lang/String;
    //   402: iconst_1
    //   403: invokevirtual 566	com/tencent/mm/g/b/a/n:t	(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    //   406: putfield 567	com/tencent/mm/g/b/a/n:dSm	Ljava/lang/String;
    //   409: aload 13
    //   411: aload 13
    //   413: ldc_w 569
    ...
    //   438: putfield 572	com/tencent/mm/g/b/a/n:dSn	Ljava/lang/String;
    //   441: aload 13
    //   443: aload_0
    //   444: getfield 124	com/tencent/mm/plugin/expt/roomexpt/a:rba	Lcom/tencent/mm/g/b/a/ed;
    //   447: getfield 439	com/tencent/mm/g/b/a/ed:ehF	J
    //   450: l2i
    //   451: putfield 575	com/tencent/mm/g/b/a/n:dSo	I
    //   454: aload 13
    //   456: invokevirtual 576	com/tencent/mm/g/b/a/n:aLk	()Z
    //   459: pop
    //   460: aload 9
    //   462: astore 11
    //   464: goto +434 -> 898
    ...
    //   532: aload 13
    //   534: aload 9
    //   536: putfield 565	com/tencent/mm/plugin/expt/roomexpt/c:dmU	Ljava/lang/String;
    //   539: aload 13
    //   541: aload 11
    ...
    //   578: aload 9
    //   580: aload 14
    //   582: getfield 565	com/tencent/mm/plugin/expt/roomexpt/c:dmU	Ljava/lang/String;
    ...
    //   646: ifnull +142 -> 788
    //   649: aload_0
    //   650: getfield 124	com/tencent/mm/plugin/expt/roomexpt/a:rba	Lcom/tencent/mm/g/b/a/ed;
    //   653: aload 9
    //   655: invokevirtual 290	java/lang/StringBuffer:toString	()Ljava/lang/String;
    //   658: invokevirtual 610	com/tencent/mm/g/b/a/ed:nu	(Ljava/lang/String;)Lcom/tencent/mm/g/b/a/ed;
    //   661: pop
    //   662: aload_0
    //   663: getfield 124	com/tencent/mm/plugin/expt/roomexpt/a:rba	Lcom/tencent/mm/g/b/a/ed;
    //   666: ldc2_w 611
    //   669: putfield 439	com/tencent/mm/g/b/a/ed:ehF	J
    //   672: aload_0
    //   673: aload_0
    //   674: getfield 124	com/tencent/mm/plugin/expt/roomexpt/a:rba	Lcom/tencent/mm/g/b/a/ed;
    //   677: getfield 615	com/tencent/mm/g/b/a/ed:ehH	Ljava/lang/String;
    //   680: ldc_w 562
    //   683: invokevirtual 621	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   686: putfield 312	com/tencent/mm/plugin/expt/roomexpt/a:rbb	[Ljava/lang/String;
    //   689: getstatic 303	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
    //   692: sipush 869
    //   695: bipush 22
    //   697: invokevirtual 307	com/tencent/mm/plugin/report/service/g:dD	(II)V
    //   700: aload_0
    //   701: invokespecial 317	com/tencent/mm/plugin/expt/roomexpt/a:crr	()V
    //   704: aload_0
    //   705: iconst_0
    //   706: putfield 100	com/tencent/mm/plugin/expt/roomexpt/a:rbc	Z
    //   709: aload_0
    //   710: getfield 124	com/tencent/mm/plugin/expt/roomexpt/a:rba	Lcom/tencent/mm/g/b/a/ed;
    //   713: invokevirtual 358	com/tencent/mm/g/b/a/ed:RE	()Ljava/lang/String;
    //   716: astore 11
    //   718: aload_0
    //   719: getfield 312	com/tencent/mm/plugin/expt/roomexpt/a:rbb	[Ljava/lang/String;
    //   722: ifnull +129 -> 851
    //   725: aload_0
    //   726: getfield 312	com/tencent/mm/plugin/expt/roomexpt/a:rbb	[Ljava/lang/String;
    ...
    //   754: iconst_2
    //   755: lload 7
    //   757: invokestatic 632	com/tencent/mm/sdk/platformtools/bt:aO	(J)J
    ...
    //   787: areturn
    //   788: aload_0
    //   789: getfield 124	com/tencent/mm/plugin/expt/roomexpt/a:rba	Lcom/tencent/mm/g/b/a/ed;
    //   792: ldc2_w 485
    //   795: putfield 439	com/tencent/mm/g/b/a/ed:ehF	J
    //   798: aload_0
    //   799: getfield 124	com/tencent/mm/plugin/expt/roomexpt/a:rba	Lcom/tencent/mm/g/b/a/ed;
    //   802: ldc_w 634
    //   805: invokevirtual 610	com/tencent/mm/g/b/a/ed:nu	(Ljava/lang/String;)Lcom/tencent/mm/g/b/a/ed;
    //   808: pop
    //   809: aload_0
    //   810: aconst_null
    //   811: putfield 312	com/tencent/mm/plugin/expt/roomexpt/a:rbb	[Ljava/lang/String;
    //   814: getstatic 303	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
    //   817: sipush 869
    //   820: bipush 23
  ...
  protected final String crv()
  {
    AppMethodBeat.i(122414);
    if (this.rba != null)
    {
      String str = this.rba.RE();
  ...
  public final void onAccountInitialized(e.c paramc)
  {
    ...
    if (this.rba == null)
    {
      paramc = (String)com.tencent.mm.kernel.g.ajC().ajl().get(al.a.IDP, "");
    ...
    for (;;)
    {
      ad.i("MicroMsg.ChatRoomExptService", "load expt roomnameList[%s] info[%s]", new Object[] { this.rbb, this.rba.RE() });
      paramc = (k)com.tencent.mm.kernel.g.ab(k.class);
      if (paramc != null) {
        paramc.addSyncDoCmdCallback(this.rbe);
      }
      AppMethodBeat.o(122407);
      return;
      label118:
      this.rba = new ed(paramc);
      if (!bt.isNullOrNil(this.rba.ehH)) {
        this.rbb = this.rba.ehH.split(";");
      }
    }
  }
  ...
  public final void onAccountRelease()
  {
    ...
    if (localk != null) {
      localk.removeSyncDoCmdCallback(this.rbe);
    }
  ...
  public final void u(Context paramContext, Intent paramIntent)
  {
    ...
    com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramIntent.ahp(), "com/tencent/mm/plugin/expt/roomexpt/ChatRoomExptService", "showDebugUI", "(Landroid/content/Context;Landroid/content/Intent;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
