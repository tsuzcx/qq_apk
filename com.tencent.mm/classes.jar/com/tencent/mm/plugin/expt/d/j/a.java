...
import com.tencent.mm.plugin.expt.d.f.b;
...
public final class a
{
  ...
  private String wev;
  private List<com.tencent.mm.plugin.expt.d.f.a.a> wew;
  
  public a(ISQLiteDatabase paramISQLiteDatabase, String paramString, List<com.tencent.mm.plugin.expt.d.f.a.a> paramList)
  {
    this.nFQ = paramISQLiteDatabase;
    this.wev = paramString;
    this.wew = paramList;
  }
  ...
  private boolean awr(String paramString)
  {
    ...
    if ((this.nFQ == null) || (g.fK(this.wev)) || (g.fK(paramString)))
    {
      AppMethodBeat.o(252565);
      return false;
    }
    String str2 = awt(this.wev);
    if (g.fK(str2))
    {
      AppMethodBeat.o(252565);
      return false;
    ...
    for (;;)
    {
      try
      {
        paramString = this.nFQ.rawQuery("select * from sqlite_master where name = ? and sql like ?;", new String[] { str2, "%" + paramString + "%" });
        if (paramString == null) {
          continue;
        }
        str1 = paramString;
  ...
  public final boolean JB(long paramLong)
  {
    AppMethodBeat.i(252561);
    if ((this.nFQ == null) || (g.fK(this.wev)))
    {
      AppMethodBeat.o(252561);
      return false;
    }
    String str = awt(this.wev);
    if (g.fK(str))
    {
      AppMethodBeat.o(252561);
      return false;
    ...
    for (h localh = (h)this.nFQ;; localh = null)
    {
      long l;
      if (localh != null) {
      ...
      for (;;)
      {
        try
        {
          i = localh.delete(str, aws("report_time_ec") + " < ?", new String[] { String.valueOf(paramLong) });
  ...
  public final boolean dbU()
  {
    ...
    Object localObject4 = awt(this.wev);
    ...
    try
    {
      localObject4 = this.nFQ.rawQuery("SELECT 1 FROM sqlite_master WHERE type='table' AND name=?;", new String[] { localObject4 });
  ...
  public final boolean dbV()
  {
    ...
    if ((this.nFQ == null) || (g.fK(this.wev)) || (this.wew == null) || (this.wew.size() <= 0))
    {
      AppMethodBeat.o(252554);
      return false;
    }
    String str1 = awt(this.wev);
    if (g.fK(str1))
    {
      AppMethodBeat.o(252554);
      return false;
    ...
    Object localObject1 = this.wew.iterator();
    while (((Iterator)localObject1).hasNext())
    {
      Object localObject3 = (com.tencent.mm.plugin.expt.d.f.a.a)((Iterator)localObject1).next();
      String str2 = Kw(((com.tencent.mm.plugin.expt.d.f.a.a)localObject3).type);
      localObject3 = aws(((com.tencent.mm.plugin.expt.d.f.a.a)localObject3).name);
      if ((!g.fK(str2)) && (!g.fK((String)localObject3))) {
    ...
    if ((this.nFQ instanceof h)) {}
    for (localObject1 = (h)this.nFQ;; localObject1 = null)
    {
      long l;
      if (localObject1 != null) {
  ...
  public final boolean dbW()
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("CREATE INDEX ").append("report_time_ec_index_" + this.wev).append(" ON " + str + " ( ").append(aws("report_time_ec")).append(" );");
  ...
  public final void dbX()
  {
    ...
    for (h localh = (h)this.nFQ;; localh = null)
    {
      if (localh != null)
      {
        Iterator localIterator = this.wew.iterator();
        while (localIterator.hasNext())
        {
          Object localObject2 = (com.tencent.mm.plugin.expt.d.f.a.a)localIterator.next();
          String str2 = Kw(((com.tencent.mm.plugin.expt.d.f.a.a)localObject2).type);
          localObject2 = aws(((com.tencent.mm.plugin.expt.d.f.a.a)localObject2).name);
          if ((!g.fK(str2)) && (!g.fK((String)localObject2)) && (!awr((String)localObject2)))
          {
            StringBuilder localStringBuilder = new StringBuilder();
  ...
  /* Error */
  public final List<List<b>> dbZ()
  {
    // Byte code:
    //   0: ldc_w 287
    //   3: invokestatic 42	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: aload_0
    //   7: getfield 18	com/tencent/mm/plugin/expt/d/j/a:nFQ	Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;
    //   10: ifnull +32 -> 42
    //   13: aload_0
    //   14: getfield 20	com/tencent/mm/plugin/expt/d/j/a:wev	Ljava/lang/String;
    //   17: invokestatic 47	org/apache/commons/b/g:fK	(Ljava/lang/String;)Z
    //   20: ifne +22 -> 42
    //   23: aload_0
    //   24: getfield 22	com/tencent/mm/plugin/expt/d/j/a:wew	Ljava/util/List;
    //   27: ifnull +15 -> 42
    //   30: aload_0
    //   31: getfield 22	com/tencent/mm/plugin/expt/d/j/a:wew	Ljava/util/List;
    ...
    //   49: areturn
    //   50: aload_0
    //   51: getfield 20	com/tencent/mm/plugin/expt/d/j/a:wev	Ljava/lang/String;
    //   54: invokestatic 54	com/tencent/mm/plugin/expt/d/j/a:awt	(Ljava/lang/String;)Ljava/lang/String;
    //   57: astore 6
    //   59: aload 6
    //   61: invokestatic 47	org/apache/commons/b/g:fK	(Ljava/lang/String;)Z
    //   64: ifeq +11 -> 75
    //   67: ldc_w 287
    ...
    //   74: areturn
    //   75: aload_0
    //   76: getfield 18	com/tencent/mm/plugin/expt/d/j/a:nFQ	Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;
    //   79: aload 6
    //   81: aconst_null
    //   82: aconst_null
    //   83: aconst_null
    ...
    //   133: astore 4
    //   135: aload_0
    //   136: getfield 22	com/tencent/mm/plugin/expt/d/j/a:wew	Ljava/util/List;
    ...
    //   169: checkcast 194	com/tencent/mm/plugin/expt/d/f/a/a
    //   172: astore 8
    //   174: aload_3
    //   175: astore 4
    //   177: new 299	com/tencent/mm/plugin/expt/d/f/b
    //   180: dup
    //   181: invokespecial 300	com/tencent/mm/plugin/expt/d/f/b:<init>	()V
    //   184: astore 9
    //   186: aload_3
    //   187: astore 4
    //   189: aload 9
    //   191: aload 8
    //   193: getfield 203	com/tencent/mm/plugin/expt/d/f/a/a:name	Ljava/lang/String;
    //   196: putfield 301	com/tencent/mm/plugin/expt/d/f/b:name	Ljava/lang/String;
    //   199: aload_3
    //   200: astore 4
    //   202: aload 9
    //   204: aload 8
    //   206: getfield 304	com/tencent/mm/plugin/expt/d/f/a/a:index	I
    //   209: putfield 305	com/tencent/mm/plugin/expt/d/f/b:index	I
    //   212: aload_3
    //   213: astore 4
    //   215: aload 9
    //   217: aload 8
    //   219: getfield 198	com/tencent/mm/plugin/expt/d/f/a/a:type	I
    //   222: putfield 306	com/tencent/mm/plugin/expt/d/f/b:type	I
    //   225: aload_3
    //   226: astore 4
    //   228: aload 8
    //   230: getfield 198	com/tencent/mm/plugin/expt/d/f/a/a:type	I
    //   233: ifne +122 -> 355
    //   236: aload_3
    //   237: astore 4
    //   239: aload 9
    //   241: aload_3
    //   242: aload 8
    //   244: getfield 304	com/tencent/mm/plugin/expt/d/f/a/a:index	I
    //   247: invokeinterface 309 2 0
    //   252: putfield 312	com/tencent/mm/plugin/expt/d/f/b:stringValue	Ljava/lang/String;
    //   255: aload_3
    //   256: astore 4
    //   258: aload 5
    //   260: aload 9
    ...
    //   356: astore 4
    //   358: aload 8
    //   360: getfield 198	com/tencent/mm/plugin/expt/d/f/a/a:type	I
    //   363: iconst_1
    ...
    //   372: aload_3
    //   373: aload 8
    //   375: getfield 304	com/tencent/mm/plugin/expt/d/f/a/a:index	I
    //   378: invokeinterface 324 2 0
    //   383: putfield 327	com/tencent/mm/plugin/expt/d/f/b:intValue	I
    //   386: goto -131 -> 255
    //   389: astore 4
    //   391: iconst_1
    //   392: istore_1
    ...
    //   444: astore 4
    //   446: aload 8
    //   448: getfield 198	com/tencent/mm/plugin/expt/d/f/a/a:type	I
    //   451: iconst_2
    ...
    //   460: aload_3
    //   461: aload 8
    //   463: getfield 304	com/tencent/mm/plugin/expt/d/f/a/a:index	I
    //   466: invokeinterface 331 2 0
    //   471: putfield 335	com/tencent/mm/plugin/expt/d/f/b:wea	J
    //   474: goto -219 -> 255
    //   477: iconst_1
    //   478: istore_1
    //   479: goto -86 -> 393
    ...
    //   172	290	8	locala	com.tencent.mm.plugin.expt.d.f.a.a
    //   184	275	9	localb	b
    // Exception table:
    //   from	to	target	type
  ...
  public final boolean dv(List<List<b>> paramList)
  {
    boolean bool2 = false;
    AppMethodBeat.i(252560);
    if ((this.nFQ == null) || (g.fK(this.wev)) || (paramList == null) || (paramList.size() <= 0))
    {
    ...
    int i = 0;
    while (i < this.wew.size())
    {
      localStringBuilder.append(aws(((com.tencent.mm.plugin.expt.d.f.a.a)this.wew.get(i)).name)).append(",");
      i += 1;
    }
    if (localStringBuilder.toString().endsWith(",")) {
      localStringBuilder.deleteCharAt(localStringBuilder.length() - 1);
    ...
    if ((this.nFQ instanceof h)) {}
    boolean bool1;
    for (paramList = (h)this.nFQ;; paramList = null)
    {
      bool1 = bool2;
      if (paramList != null) {
      ...
      try
      {
        bool1 = this.nFQ.execSQL(str, localStringBuilder.toString());
 ...
 * Qualified Name:     com.tencent.mm.plugin.expt.d.j.a
