...
public final class c
{
  ...
  public static void Dn(int paramInt)
  {
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = (WeakReference)qZl.get(Integer.valueOf(paramInt));
  ...
  public static void Do(int paramInt)
  {
    for (;;)
    {
      ...
      chk localchk;
      if (localchk != null) {
        b(localObject2, localchk, false);
      }
      AppMethodBeat.o(122206);
    }
  }
  
  private static void a(Object paramObject, chj paramchj, chk paramchk, boolean paramBoolean)
  {
    AppMethodBeat.i(122213);
    paramchk = com.tencent.mm.plugin.expt.hellhound.a.f.d.b.fX(paramchk.sessionId, paramObject.getClass().getSimpleName());
    if (paramchk == null)
    {
      AppMethodBeat.o(122213);
      return;
    }
    boc localboc = (boc)paramchk.get(0);
    b.a(paramObject, paramchj, localboc, true, paramBoolean);
    com.tencent.mm.plugin.expt.hellhound.a.f.d.b.a(localboc, ((Integer)paramchk.get(1)).intValue());
    AppMethodBeat.o(122213);
  }
  
  private static void a(Object paramObject, dbr paramdbr, chk paramchk, boolean paramBoolean)
  {
    AppMethodBeat.i(122212);
    paramdbr = paramdbr.FJw.iterator();
    while (paramdbr.hasNext())
    {
      chj localchj = (chj)paramdbr.next();
      if (localchj != null) {
        a(paramObject, localchj, paramchk, paramBoolean);
      }
    }
  ...
  private static void aj(Activity paramActivity)
  {
    ...
    //   12: istore_1
    //   13: getstatic 23	com/tencent/mm/plugin/expt/hellhound/a/f/e/c:qZl	Ljava/util/Map;
    //   16: iload_1
    ...
    //   36: astore_0
    //   37: getstatic 23	com/tencent/mm/plugin/expt/hellhound/a/f/e/c:qZl	Ljava/util/Map;
    //   40: iload_1
    //   41: invokestatic 35	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   44: aload_0
    //   45: invokeinterface 154 3 0
    //   50: pop
    //   51: invokestatic 160	com/tencent/mm/plugin/expt/hellhound/core/a/a/c:cnO	()Lcom/tencent/mm/plugin/expt/hellhound/core/a/a/c;
    //   54: sipush 402
    //   57: iload_1
    ...
    //   71: monitorexit
    //   72: return
    //   73: getstatic 23	com/tencent/mm/plugin/expt/hellhound/a/f/e/c:qZl	Ljava/util/Map;
    //   76: iload_1
    ...
    //   97: ifnonnull -46 -> 51
    //   100: getstatic 23	com/tencent/mm/plugin/expt/hellhound/a/f/e/c:qZl	Ljava/util/Map;
    //   103: iload_1
    ...
    //   121: astore_0
    //   122: getstatic 23	com/tencent/mm/plugin/expt/hellhound/a/f/e/c:qZl	Ljava/util/Map;
    //   125: iload_1
  ...
  public static void b(Fragment paramFragment, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localchk != null) {
        b(paramFragment, localchk, true);
      }
      AppMethodBeat.o(122208);
      return;
      localchk = com.tencent.mm.plugin.expt.hellhound.a.f.c.c.cqe();
      if (localchk != null) {
        b(paramFragment, localchk, false);
      }
    }
  }
  
  private static void b(Object paramObject, chk paramchk, boolean paramBoolean)
  {
    AppMethodBeat.i(122211);
    e.cpW();
    Object localObject = e.cpX();
    if ((localObject == null) || (((dbq)localObject).fRb))
    {
      AppMethodBeat.o(122211);
      return;
    }
    localObject = ((dbq)localObject).hDb.iterator();
    while (((Iterator)localObject).hasNext())
    {
      dbr localdbr = (dbr)((Iterator)localObject).next();
      if (localdbr != null) {
        a(paramObject, localdbr, paramchk, paramBoolean);
      }
    }
    AppMethodBeat.o(122211);
  }
  ...
  /* Error */
  public static void df(java.lang.String paramString, int paramInt)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: ldc 198
    //   5: invokestatic 16	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   8: getstatic 23	com/tencent/mm/plugin/expt/hellhound/a/f/e/c:qZl	Ljava/util/Map;
    ...
    //   28: iload_1
    //   29: ifle +58 -> 87
    //   32: getstatic 23	com/tencent/mm/plugin/expt/hellhound/a/f/e/c:qZl	Ljava/util/Map;
    //   35: iload_1
    ...
    //   75: aastore
    //   76: invokestatic 214	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   79: ldc 198
    ...
    //   94: astore_2
    //   95: getstatic 23	com/tencent/mm/plugin/expt/hellhound/a/f/e/c:qZl	Ljava/util/Map;
    ...
    //   249: istore_1
    //   250: getstatic 23	com/tencent/mm/plugin/expt/hellhound/a/f/e/c:qZl	Ljava/util/Map;
    //   253: iload_1
