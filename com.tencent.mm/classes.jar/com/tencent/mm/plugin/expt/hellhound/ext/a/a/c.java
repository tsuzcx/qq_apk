  ...
  implements b
{
  ...
  public c()
  {
    ...
    try
    {
      ...
      this.zDP = this.zDO.getDeclaredField("timeLineObject");
      this.zDP.setAccessible(true);
      this.zEi = this.zDO.getDeclaredField("isAd");
      this.zEi.setAccessible(true);
      this.zDQ = Class.forName("com.tencent.mm.protocal.protobuf.TimeLineObject").getDeclaredField("Id");
      this.zDQ.setAccessible(true);
      this.zEj = this.zDO.getDeclaredField("snsobj");
      this.zEj.setAccessible(true);
      Class localClass = Class.forName("com.tencent.mm.protocal.protobuf.SnsObject");
      this.zEl = localClass.getDeclaredField("CommentUserList");
      this.zEl.setAccessible(true);
      this.zEk = localClass.getDeclaredField("LikeCount");
      this.zEk.setAccessible(true);
      this.zEm = localClass.getDeclaredField("Username");
      this.zEm.setAccessible(true);
      this.zEn = localClass.getDeclaredField("Nickname");
      this.zEn.setAccessible(true);
  ...
  public final void a(View paramView, com.tencent.mm.pointers.PInt paramPInt1, com.tencent.mm.pointers.PInt paramPInt2, int paramInt)
  {
    ...
    //   29: return
    //   30: aload_0
    //   31: getfield 69	com/tencent/mm/plugin/expt/hellhound/ext/a/a/c:zEj	Ljava/lang/reflect/Field;
    //   34: astore 7
    //   36: aload 7
    //   38: ifnonnull +9 -> 47
    //   41: ldc 96
    ...
    //   46: return
    //   47: aload_0
    //   48: getfield 69	com/tencent/mm/plugin/expt/hellhound/ext/a/a/c:zEj	Ljava/lang/reflect/Field;
    //   51: aload_1
    ...
    //   57: ifnull +101 -> 158
    //   60: aload_0
    //   61: getfield 79	com/tencent/mm/plugin/expt/hellhound/ext/a/a/c:zEk	Ljava/lang/reflect/Field;
    //   64: aload_1
    ...
    //   74: istore 4
    //   76: aload_0
    //   77: getfield 75	com/tencent/mm/plugin/expt/hellhound/ext/a/a/c:zEl	Ljava/lang/reflect/Field;
    //   80: aload_1
  ...
  public final String aj(View paramView, int paramInt)
  {
    ...
    try
    {
      boolean bool = this.zDO.isInstance(paramView);
      if (!bool)
      {
        AppMethodBeat.o(169315);
        return null;
      }
      paramView = this.zDP.get(paramView);
      if (paramView == null)
      {
        AppMethodBeat.o(169315);
        return null;
    ...
    try
    {
      paramView = (String)this.zDQ.get(paramView);
      AppMethodBeat.o(169315);
      return paramView;
    }
    catch (Exception paramView)
  ...
  public final String ak(View paramView, int paramInt)
  {
    ...
    try
    {
      Field localField = this.zEj;
      if (localField == null)
      {
        AppMethodBeat.o(169317);
        return null;
      }
      paramView = this.zEj.get(paramView);
      if (paramView == null) {
        break label82;
      }
      paramView = (String)this.zEm.get(paramView);
    }
    catch (Exception paramView)
    {
      for (;;)
  ...
  public final String al(View paramView, int paramInt)
  {
    ...
    try
    {
      ...
      paramView = (String)this.zEn.get(paramView);
    }
    catch (Exception paramView)
    {
      for (;;)
  ...
  public final boolean fh(View paramView)
  {
    ...
    try
    {
      bool = this.zDO.isInstance(paramView);
      if (!bool)
      {
        AppMethodBeat.o(184357);
        return false;
      }
      bool = ((Boolean)this.zEi.get(paramView)).booleanValue();
    }
    catch (Exception paramView)
    {
      for (;;)
 ...
 * Qualified Name:     com.tencent.mm.plugin.expt.hellhound.ext.a.a.c
