...
{
  public static final e.a rfR;
  private Field rbF;
  private WeakReference<RecyclerView> ren;
  private Method reo;
  private Field rep;
  private Field rfE;
  private WeakReference<Object> rfN;
  private Field rfO;
  private Field rfP;
  private Field rfQ;
  ...
  public e(Activity paramActivity)
  {
    ...
    try
    {
      ...
      this.rfN = new WeakReference(localField.get(paramActivity));
      ...
      paramActivity = this.rfO;
      if (paramActivity == null) {
        p.bdF("feedList_Field");
      }
    ...
    {
      ae.printErrStackTrace("HABBYGE-MALI.MixSearchParamsCatcher", (Throwable)paramActivity, "init, reflect exception: " + paramActivity.getMessage(), new Object[0]);
      AppMethodBeat.o(196572);
    }
  }
  ...
  private final Object Du(int paramInt)
  {
    ...
    try
    {
      Object localObject = this.rfO;
      if (localObject == null) {
        p.bdF("feedList_Field");
      }
      WeakReference localWeakReference = this.rfN;
    ...
    {
      ae.printErrStackTrace("HABBYGE-MALI.MixSearchParamsCatcher", (Throwable)localException, "getfeedItem, reflect exception: " + localException.getMessage(), new Object[0]);
      AppMethodBeat.o(196571);
    }
  }
  ...
  public final String Dn(int paramInt)
  {
    ...
    if (localObject1 != null) {
      ...
      {
        ae.printErrStackTrace("HABBYGE-MALI.MixSearchParamsCatcher", (Throwable)localException, "MixSearchParamsCatcher, getSessionBuffer crash: " + localException.getMessage(), new Object[0]);
        AppMethodBeat.o(196570);
        return null;
      }
    }
  ...
  public final String ad(View paramView, int paramInt)
  {
    ...
    if (paramView != null)
    {
      ...
      {
        ae.printErrStackTrace("HABBYGE-MALI.MixSearchParamsCatcher", (Throwable)paramView, "MixSearchParamsCatcher, getFeedId crash: " + paramView.getMessage(), new Object[0]);
        AppMethodBeat.o(196566);
        return null;
      }
  ...
  public final String ae(View paramView, int paramInt)
  {
    ...
    if (paramView != null) {
      ...
      {
        ae.printErrStackTrace("HABBYGE-MALI.MixSearchParamsCatcher", (Throwable)paramView, "MixSearchParamsCatcher, getFeedUserName crash: " + paramView.getMessage(), new Object[0]);
        AppMethodBeat.o(196567);
        return null;
      }
    }
  ...
  public final String af(View paramView, int paramInt)
  {
    ...
    if (paramView != null) {
      ...
      {
        ae.printErrStackTrace("HABBYGE-MALI.MixSearchParamsCatcher", (Throwable)paramView, "MixSearchParamsCatcher, getFeedNickName crash: " + paramView.getMessage(), new Object[0]);
        AppMethodBeat.o(196568);
        return null;
      }
    }
