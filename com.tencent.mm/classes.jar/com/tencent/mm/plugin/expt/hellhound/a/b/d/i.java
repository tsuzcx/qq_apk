...
public final class i
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (this != paramObject)
    {
      if ((paramObject instanceof i))
      {
        ...
        if ((!k.g(this.sessionId, paramObject.sessionId)) || (this.qoS != paramObject.qoS) || (this.qoT != paramObject.qoT) || (this.qoU != paramObject.qoU) || (Float.compare(this.qos, paramObject.qos) != 0) || (Float.compare(this.qot, paramObject.qot) != 0) || (!k.g(this.qox, paramObject.qox)) || (this.scene != paramObject.scene) || (this.qoq != paramObject.qoq) || (this.qoV != paramObject.qoV) || (this.cBT != paramObject.cBT) || (this.x != paramObject.x) || (this.y != paramObject.y) || (Float.compare(this.height, paramObject.height) != 0) || (Float.compare(this.width, paramObject.width) != 0) || (this.position != paramObject.position) || (this.ij != paramObject.ij) || (this.qoW != paramObject.qoW) || (this.qoz != paramObject.qoz) || (!k.g(this.feedId, paramObject.feedId)) || (!k.g(this.userName, paramObject.userName)) || (!k.g(this.bLs, paramObject.bLs)) || (this.commentCount != paramObject.commentCount) || (this.likeCount != paramObject.likeCount) || (!k.g(this.qoy, paramObject.qoy))) {}
      }
    }
    else
    {
  ...
  public final String toString()
  {
    ...
    String str = "WaterFeed(sessionId=" + this.sessionId + ", startExposureMs=" + this.qoS + ", endExposureMs=" + this.qoT + ", disAppearType=" + this.qoU + ", itemExposureAreaWeigth=" + this.qos + ", screenExposureAreaWeigth=" + this.qot + ", contextId=" + this.qox + ", scene=" + this.scene + ", updateTimeMs=" + this.qoq + ", itemExposureTimeMs=" + this.qoV + ", isShowing=" + this.cBT + ", x=" + this.x + ", y=" + this.y + ", height=" + this.height + ", width=" + this.width + ", position=" + this.position + ", itemPosition=" + this.ij + ", itemPos=" + this.qoW + ", itemArrayIndex=" + this.qoz + ", feedId=" + this.feedId + ", userName=" + this.userName + ", nickName=" + this.bLs + ", commentCount=" + this.commentCount + ", likeCount=" + this.likeCount + ", itemBufffer=" + this.qoy + ")";
