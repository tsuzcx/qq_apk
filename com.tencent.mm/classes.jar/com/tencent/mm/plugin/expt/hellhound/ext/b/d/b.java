...
@Metadata(d1={""}, d2={"Lcom/tencent/mm/plugin/expt/hellhound/ext/finder/statistics/FavParamsCatcher;", "Lcom/tencent/mm/plugin/expt/hellhound/ext/feed/params/IFeedParamCatcher;", "()V", "recyclerViewRef", "Ljava/lang/ref/WeakReference;", "Landroidx/recyclerview/widget/RecyclerView;", "getFeedId", "", "view", "Landroid/view/View;", "position", "", "getFeedInfo", "", "pLikeCount", "Lcom/tencent/mm/pointers/PInt;", "pCommentCount", "getFeedNickName", "getFeedUserName", "getSessionBuffer", "isAd", "", "setRecyclerView", "recyclerView", "Companion", "plugin-expt_release"}, k=1, mv={1, 5, 1}, xi=48)
  ...
  implements com.tencent.mm.plugin.expt.hellhound.ext.a.a.b
{
  ...
  public static final b.a zIR;
  private WeakReference<RecyclerView> zHB;
  
  static
  {
    AppMethodBeat.i(300310);
    zIR = new b.a((byte)0);
    AppMethodBeat.o(300310);
  }
  ...
  public final String LH(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        {
          Log.printErrStackTrace("HABBYGE-MALI.FavParamsCatcher", (Throwable)localException2, s.X("getSessionBuffer crash: ", localException2.getMessage()), new Object[0]);
          AppMethodBeat.o(300359);
          return null;
        }
        String str = (String)localException2;
        AppMethodBeat.o(300359);
        return str;
      }
      localObject4 = zHG;
  ...
  public final String aj(View paramView, int paramInt)
  {
    ...
    if (this.zHB != null)
    {
      ...
      for (;;)
      {
        ...
        {
          Log.printErrStackTrace("HABBYGE-MALI.FavParamsCatcher", (Throwable)paramView, s.X("_getFeedId, e2, crash: ", paramView.getMessage()), new Object[0]);
          AppMethodBeat.o(300317);
          return null;
        }
      }
      ...
      if ((paramView instanceof a))
      {
        for (;;)
        {
          ...
          {
            Log.printErrStackTrace("HABBYGE-MALI.FavParamsCatcher", (Throwable)paramView, s.X("_getFeedId, e1, crash: ", paramView.getMessage()), new Object[0]);
            AppMethodBeat.o(300317);
            return null;
          }
  ...
  public final String ak(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        Log.printErrStackTrace("HABBYGE-MALI.FavParamsCatcher", (Throwable)paramView, s.X("getFeedUserName e1: ", paramView.getMessage()), new Object[0]);
        AppMethodBeat.o(300331);
        return null;
      }
      paramView = ((Field)localObject).get(paramView);
      ...
      if ((paramView instanceof a))
      {
        for (;;)
        {
          ...
          {
            Log.printErrStackTrace("HABBYGE-MALI.FavParamsCatcher", (Throwable)paramView, s.X("getFeedUserName e2: ", paramView.getMessage()), new Object[0]);
            AppMethodBeat.o(300331);
            return null;
          }
          paramView = ((Method)localObject).invoke(paramView, new Object[0]);
  ...
  public final String al(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        Log.printErrStackTrace("HABBYGE-MALI.FavParamsCatcher", (Throwable)paramView, s.X("getFeedNickName e1: ", paramView.getMessage()), new Object[0]);
        AppMethodBeat.o(300338);
        return null;
      }
      paramView = ((Field)localObject).get(paramView);
      ...
      if ((paramView instanceof a))
      {
        for (;;)
        {
          ...
          {
            Log.printErrStackTrace("HABBYGE-MALI.FavParamsCatcher", (Throwable)paramView, s.X("getFeedNickName e2: ", paramView.getMessage()), new Object[0]);
            AppMethodBeat.o(300338);
            return null;
          }
          paramView = ((Method)localObject).invoke(paramView, new Object[0]);
 ...
 * Qualified Name:     com.tencent.mm.plugin.expt.hellhound.ext.b.d.b
