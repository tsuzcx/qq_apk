...
public final class b
{
  ...
  public static boolean hd(String paramString1, String paramString2)
  {
    ...
    boolean bool = bs.lr(paramString1.replaceAll(com.tencent.mm.plugin.groupsolitaire.b.b.cSk(), "").replace(" ", "").toLowerCase(), paramString2.replaceAll(com.tencent.mm.plugin.groupsolitaire.b.b.cSk(), "").replace(" ", "").toLowerCase());
    AppMethodBeat.o(193000);
    return bool;
  }
  ...
  public final b cSo()
  {
    ...
    //   21: aload_1
    //   22: aload_0
    //   23: getfield 23	com/tencent/mm/plugin/groupsolitaire/c/b:tyV	I
    //   26: putfield 23	com/tencent/mm/plugin/groupsolitaire/c/b:tyV	I
    //   29: aload_1
    //   30: aload_0
    ...
    //   53: aload_1
    //   54: aload_0
    //   55: getfield 35	com/tencent/mm/plugin/groupsolitaire/c/b:tyW	I
    //   58: putfield 35	com/tencent/mm/plugin/groupsolitaire/c/b:tyW	I
    //   61: ldc 81
    ...
    //   92: aastore
    //   93: invokestatic 98	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   96: goto -35 -> 61
    //   99: astore_2
    //   100: goto -29 -> 71
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (bs.lr(this.username, paramObject.username))
    {
      if (bs.lr(this.content.trim(), paramObject.content.trim()))
      {
    ...
    boolean bool = hd(this.content.trim(), paramObject.content.trim());
    AppMethodBeat.o(110401);
    return bool;
  }
  ...
  public final int hashCode()
  {
    ...
    if ((bs.isNullOrNil(this.content)) || (bs.isNullOrNil(this.content.trim())))
    {
      AppMethodBeat.o(110400);
      return 0;
    }
    int i = this.content.trim().replaceAll(com.tencent.mm.plugin.groupsolitaire.b.b.cSk(), "").replace(" ", "").toLowerCase().hashCode();
    AppMethodBeat.o(110400);
    return i;
  }
  ...
  public final String toString()
  {
    ...
    String str = "GroupSolitatireItem{username='" + this.username + '\'' + ", asheader=" + this.tyV + ", separator='" + this.separator + '\'' + ", createtime=" + this.createtime + ", content='" + this.content + '\'' + ", orderNum='" + this.tyW + '\'' + '}';
