...
@l(hxD={1, 1, 16}, hxE={""}, hxF={"TAG", "", "kvCommand", "Lcom/tencent/mm/sdk/platformtools/MultiProcessMMKV;", "getKvCommand", "()Lcom/tencent/mm/sdk/platformtools/MultiProcessMMKV;", "canDebug", "", "showToast", "", "content", "tag", "webview-sdk_release"})
public final class h
{
  static final MultiProcessMMKV cdi()
  {
    ...
    p.g(localMultiProcessMMKV, "MultiProcessMMKV.getMMKV(\"__webcompt_command\")");
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      Toast.makeText(MMApplicationContext.getContext(), (CharSequence)this.grJ, 0).show();
