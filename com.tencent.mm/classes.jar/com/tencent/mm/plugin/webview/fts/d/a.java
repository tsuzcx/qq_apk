  ...
  implements n
{
  ...
  {
    this.PNe = paramWebView;
  }
  
  public final void addView(View paramView)
  {
    AppMethodBeat.i(78177);
    ViewGroup localViewGroup = this.PNe.getTopView();
  ...
  public final void b(String paramString1, boolean paramBoolean, String paramString2, String paramString3)
  {
    ...
    this.PvJ.b(paramString1, paramBoolean, paramString2, paramString3);
  ...
  public final void biL(String paramString)
  {
    ...
    MMHandlerThread.postToMainThread(new h.51(localh, n.a.b("onSearchWAWidgetReloadData", localHashMap, localh.PNx, localh.EVx)));
    AppMethodBeat.o(78181);
  }
  ...
  public final void gM(String paramString, int paramInt)
  {
    ...
    MMHandlerThread.postToMainThread(new h.53(localh, n.a.b("onSearchWAWidgetStateChange", localHashMap, localh.PNx, localh.EVx)));
    AppMethodBeat.o(78179);
  }
  ...
  public final void gN(String paramString, int paramInt)
  {
    ...
    MMHandlerThread.postToMainThread(new h.37(localh, n.a.b("onSearchWAWidgetAttrChanged", localHashMap, localh.PNx, localh.EVx)));
    AppMethodBeat.o(78185);
  }
  ...
  public final void h(String paramString1, boolean paramBoolean, String paramString2)
  {
    ...
    this.PvJ.b(paramString1, paramBoolean, "", paramString2);
    AppMethodBeat.o(78180);
  }
  
  public final void i(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    MMHandlerThread.postToMainThread(new h.50(localh, n.a.b("onSearchWAWidgetOpenApp", localHashMap, localh.PNx, localh.EVx)));
    AppMethodBeat.o(78183);
  }
  
  public final void mg(String paramString1, String paramString2)
  {
    ...
    MMHandlerThread.postToMainThread(new h.54(localh, n.a.b("onSearchWAWidgetDataPush", localHashMap, localh.PNx, localh.EVx)));
    AppMethodBeat.o(78182);
  }
