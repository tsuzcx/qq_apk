  ...
  extends a
{
  ...
  public void computeScroll(View paramView)
  {
    ...
    this.PQs.computeScroll(paramView);
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent, View paramView)
  {
    ...
    boolean bool = this.PQs.dispatchTouchEvent(paramMotionEvent, paramView);
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent, View paramView)
  {
    ...
    boolean bool = this.PQs.onInterceptTouchEvent(paramMotionEvent, paramView);
  ...
  public Object onMiscCallBack(String paramString, Bundle paramBundle)
  {
    ...
    paramString = this.PQs.onMiscCallBack(paramString, paramBundle);
  ...
  public void onOverScrolled(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, View paramView)
  {
    ...
    this.PQs.onOverScrolled(paramInt1, paramInt2, paramBoolean1, paramBoolean2, paramView);
  ...
  public void onScrollChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4, View paramView)
  {
    ...
    this.PQs.onScrollChanged(paramInt1, paramInt2, paramInt3, paramInt4, paramView);
  ...
  public boolean onShowLongClickPopupMenu()
  {
    ...
    boolean bool = this.PQs.onShowLongClickPopupMenu();
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent, View paramView)
  {
    ...
    boolean bool = this.PQs.onTouchEvent(paramMotionEvent, paramView);
  ...
  public boolean overScrollBy(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, boolean paramBoolean, View paramView)
  {
    ...
    paramBoolean = this.PQs.overScrollBy(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramInt8, paramBoolean, paramView);
