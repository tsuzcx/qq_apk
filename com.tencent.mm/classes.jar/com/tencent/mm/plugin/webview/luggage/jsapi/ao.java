  ...
  extends br<com.tencent.mm.plugin.webview.luggage.g>
{
  ...
  public final void b(b<com.tencent.mm.plugin.webview.luggage.g>.a paramb)
  {
    ...
    ae.i("MicroMsg.JsApiOpenWeAppPage", "invokeInOwn %s", new Object[] { paramb.chh.cgn });
    ...
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        ...
        String str6;
        String str7;
        ae.printErrStackTrace("MicroMsg.JsApiOpenWeAppPage", localJSONException, "", new Object[0]);
        continue;
        if (k == 3) {
          localf.scene = 1005;
        } else if (k == 16) {
    ...
    if ((k == 201) || (k == 14) || (k == 22))
    {
      ...
      localf.dlj = (str5 + ":" + str6 + ":" + str2 + ":" + (String)localObject + ":" + j + ":" + str7);
      localf.jFU = new AppBrandLaunchReferrer();
      localf.jFU.kbh = str4;
      localf.username = str3;
      localf.version = i;
      localf.jFL = str1;
      ((p)com.tencent.mm.kernel.g.ab(p.class)).a(((com.tencent.mm.plugin.webview.luggage.g)paramb.chg).mContext, localf);
      paramb.a("", null);
