...
public class az<T extends a>
  extends br<T>
{
  private static JSONObject bT(Map<String, String> paramMap)
  {
  ...
  public final void b(final b<T>.a paramb)
  {
    ...
    h.ZvG.be(new Runnable()
    {
      ...
      public final void run()
      {
        ...
        //   5: aload_0
        //   6: getfield 21	com/tencent/mm/plugin/webview/luggage/jsapi/az$1:CAL	Lcom/tencent/luggage/d/b$a;
        //   9: getfield 45	com/tencent/luggage/d/b$a:crh	Lcom/tencent/luggage/bridge/k;
        //   12: getfield 51	com/tencent/luggage/bridge/k:cqn	Lorg/json/JSONObject;
        //   15: astore_1
        //   16: aload_1
        //   17: ldc 53
        ...
        //   29: ifeq +19 -> 48
        //   32: aload_0
        //   33: getfield 21	com/tencent/mm/plugin/webview/luggage/jsapi/az$1:CAL	Lcom/tencent/luggage/d/b$a;
        //   36: ldc 67
        //   38: aconst_null
        ...
        //   79: iconst_1
        //   80: iconst_0
        //   81: invokevirtual 89	com/tencent/mm/plugin/wepkg/f:m	(Ljava/lang/String;ZZ)Z
        //   84: ifeq +197 -> 281
        //   87: ldc 91
        //   89: ldc 93
        ...
        //   115: invokestatic 115	com/tencent/mm/plugin/webview/k/c:L	(Ljava/io/InputStream;)[B
        //   118: astore 5
        //   120: aload_3
        //   121: ldc 117
        //   123: aload_2
        //   124: getfield 121	com/tencent/xweb/WebResourceResponse:mResponseHeaders	Ljava/util/Map;
        //   127: invokestatic 125	com/tencent/mm/plugin/webview/luggage/jsapi/az:bU	(Ljava/util/Map;)Lorg/json/JSONObject;
        ...
        //   168: pop
        //   169: aload_0
        //   170: getfield 21	com/tencent/mm/plugin/webview/luggage/jsapi/az$1:CAL	Lcom/tencent/luggage/d/b$a;
        //   173: ldc 103
        //   175: aload_3
        //   176: invokevirtual 71	com/tencent/luggage/d/b$a:a	(Ljava/lang/String;Lorg/json/JSONObject;)V
        //   179: aload 4
        //   181: iconst_1
        //   182: invokevirtual 152	com/tencent/mm/plugin/wepkg/f:DD	(Z)V
        //   185: ldc 33
        ...
        //   236: astore_1
        //   237: aload_0
        //   238: getfield 21	com/tencent/mm/plugin/webview/luggage/jsapi/az$1:CAL	Lcom/tencent/luggage/d/b$a;
        //   241: ldc 67
        //   243: aconst_null
        ...
        //   281: aload 5
        //   283: aconst_null
        //   284: invokestatic 183	com/tencent/mm/plugin/webview/k/c:W	(Ljava/lang/String;Ljava/util/Map;)Lcom/tencent/mm/plugin/webview/k/c$a;
        //   287: astore 7
        //   289: aload 7
        //   291: ifnull +304 -> 595
        ...
        //   305: ldc 117
        //   307: aload 7
        //   309: getfield 188	com/tencent/mm/plugin/webview/k/c$a:qjY	Ljava/util/Map;
        //   312: invokestatic 125	com/tencent/mm/plugin/webview/luggage/jsapi/az:bU	(Ljava/util/Map;)Lorg/json/JSONObject;
        ...
        //   325: astore_1
        //   326: aload 7
        //   328: getfield 192	com/tencent/mm/plugin/webview/k/c$a:QzN	[B
        ...
        //   354: astore_1
        //   355: aload 7
        //   357: getfield 192	com/tencent/mm/plugin/webview/k/c$a:QzN	[B
        //   360: iconst_2
        ...
        //   384: pop
        //   385: aload_0
        //   386: getfield 21	com/tencent/mm/plugin/webview/luggage/jsapi/az$1:CAL	Lcom/tencent/luggage/d/b$a;
        //   389: ldc 103
        //   391: aload 4
        ...
        //   409: dup
        //   410: aload 7
        //   412: getfield 192	com/tencent/mm/plugin/webview/k/c$a:QzN	[B
        //   415: ldc 154
        ...
        //   444: astore_1
        //   445: aload 7
        //   447: getfield 204	com/tencent/mm/plugin/webview/k/c$a:data	Ljava/lang/String;
        ...
        //   473: astore_1
        //   474: aload 7
        //   476: getfield 204	com/tencent/mm/plugin/webview/k/c$a:data	Ljava/lang/String;
        ...
        //   518: dup
        //   519: aload 7
        //   521: getfield 204	com/tencent/mm/plugin/webview/k/c$a:data	Ljava/lang/String;
        ...
        //   592: goto -225 -> 367
        //   595: aload_0
        //   596: getfield 21	com/tencent/mm/plugin/webview/luggage/jsapi/az$1:CAL	Lcom/tencent/luggage/d/b$a;
        //   599: ldc 67
        //   601: aconst_null
        ...
        //   287	233	7	locala	com.tencent.mm.plugin.webview.k.c.a
        // Exception table:
        //   from	to	target	type
