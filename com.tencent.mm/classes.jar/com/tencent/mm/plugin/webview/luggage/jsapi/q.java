  ...
  extends bo<f>
{
  ...
  public final void a(Context paramContext, String paramString, final bn.a parama)
  {
    ...
    Object localObject = b.HG(paramString);
    if (localObject == null)
    {
    ...
    localObject = new f.b()
    {
      public final void a(boolean paramAnonymousBoolean, int paramAnonymousInt, String paramAnonymousString1, String paramAnonymousString2, String paramAnonymousString3, String paramAnonymousString4)
      {
        ...
        if ((!bt.isNullOrNil(paramAnonymousString2)) && (paramAnonymousString2.equals(str)))
        {
          ...
          paramAnonymousString2 = g.emF().awC(paramAnonymousString1);
          if (((paramAnonymousString2 instanceof WebViewJSSDKImageItem)) && (bt.isNullOrNil(paramAnonymousString2.jMa))) {
            ((WebViewJSSDKImageItem)paramAnonymousString2).fZz();
          }
    ...
    g.emE().a(paramString, str, (f.b)localObject);
    ad.i("MicroMsg.JsApiDownLoadImage", "doDownLoadImage, add cdn download task result : %b", new Object[] { Boolean.TRUE });
    if (i != 0)
    {
      paramContext.getString(2131755906);
      this.fpP = h.b(paramContext, paramContext.getString(2131766263), true, new DialogInterface.OnCancelListener()
      {
