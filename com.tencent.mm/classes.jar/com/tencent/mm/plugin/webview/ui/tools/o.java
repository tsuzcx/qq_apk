...
@l(iBK={1, 1, 16}, iBL={""}, iBM={"Lcom/tencent/mm/plugin/webview/ui/tools/WebViewThirdAdReporter;", "", "()V", "TAG", "", "TYPE_PAGE_LOAD_FINISHED", "", "TYPE_PAGE_LOAD_START", "errCode", "getErrCode", "()I", "setErrCode", "(I)V", "doThirdAdReport", "", "intent", "Landroid/content/Intent;", "url", "done", "", "plugin-webview_release"})
public final class o
{
  public static final o QeQ;
  ...
  public static void a(Intent paramIntent, String paramString, boolean paramBoolean)
  {
    ...
    for (paramIntent = paramIntent.getString("ad_report_sns_id");; paramIntent = "")
    {
      try
      {
        String str1 = q.an(paramString, "UTF-8");
        p.j(str1, "URLEncoder.encode(url, \"UTF-8\")");
        paramString = str1;
      }
      ...
      i = 1;
      h.IzE.a(16972, new Object[] { paramIntent, Integer.valueOf(j), str2, Integer.valueOf(k), "", paramString, Integer.valueOf(i), Integer.valueOf(errCode), Long.valueOf(l) });
