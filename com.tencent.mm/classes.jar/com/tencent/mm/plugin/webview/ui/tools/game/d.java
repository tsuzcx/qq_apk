...
{
  public static WebResourceResponse tw(boolean paramBoolean)
  {
    ...
    Object localObject1 = com.tencent.mm.plugin.appbrand.aa.d.Ne("game.js");
    if (!bt.isNullOrNil((String)localObject1))
    {
      ...
      {
        localObject1 = ((String)localObject1).replaceFirst("#__lowPowerMode__#", String.valueOf(paramBoolean)).replaceFirst("#__lowPower__#", String.valueOf(BatteryManager.Bmq));
        try
        {
