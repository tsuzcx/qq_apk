  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      WebViewJSSDKFileItem localWebViewJSSDKFileItem = WebViewJSSDKFileItem.bxe(str1);
      String str2 = localWebViewJSSDKFileItem.dJX;
      localWebViewJSSDKFileItem.laV = bool2;
      g.gdv().a(localWebViewJSSDKFileItem);
      Log.i("MicroMsg.OpenFileChooserUI", "now filepath is : %s, local id is : %s", new Object[] { str1, str2 });
      ((ArrayList)localObject1).add(str2);
    }
    localObject1 = ay.bb((ArrayList)localObject1);
    ...
    for (localObject1 = "camera";; localObject1 = "album")
    {
      ...
      ((Intent)localObject2).putExtra("key_pick_local_media_show_memory_warning", OpenFileChooserUI.a(this.JeA));
      this.JeA.setResult(this.val$resultCode, (Intent)localObject2);
      this.JeA.finish();
