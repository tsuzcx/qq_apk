...
@l(hxD={1, 1, 16}, hxE={""}, hxF={"Lcom/tencent/mm/plugin/webview/ui/tools/WebViewThirdAdReporter;", "", "()V", "TAG", "", "TYPE_PAGE_LOAD_FINISHED", "", "TYPE_PAGE_LOAD_START", "errCode", "getErrCode", "()I", "setErrCode", "(I)V", "doThirdAdReport", "", "intent", "Landroid/content/Intent;", "url", "done", "", "plugin-webview_release"})
public final class n
{
  public static final n JhS;
  ...
  public static void a(Intent paramIntent, String paramString, boolean paramBoolean)
  {
    ...
    for (paramIntent = paramIntent.getString("ad_report_sns_id");; paramIntent = "")
    {
      ...
      i = 1;
      h.CyF.a(16972, new Object[] { paramIntent, Integer.valueOf(j), str2, Integer.valueOf(k), "", paramString, Integer.valueOf(i), Integer.valueOf(errCode), Long.valueOf(l) });
