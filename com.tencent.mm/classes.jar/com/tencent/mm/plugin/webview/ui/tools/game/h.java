...
public final class h
{
  ...
  public h(Intent paramIntent)
  {
    ...
    dHu = bt.nullAsNil(paramIntent.getStringExtra("KPublisherId"));
    Ekc = bt.nullAsNil(paramIntent.getStringExtra("geta8key_username"));
    dOE = bt.n(Integer.valueOf(paramIntent.getIntExtra("geta8key_scene", 0)));
    AppMethodBeat.o(80955);
  }
}
