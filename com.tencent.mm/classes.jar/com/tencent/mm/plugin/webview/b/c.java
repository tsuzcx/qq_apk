  ...
  extends MAutoStorage<a>
{
  ...
  private Cursor lP(String paramString1, String paramString2)
  {
    AppMethodBeat.i(77847);
    paramString1 = String.format("select * from %s where %s=\"%s\"", new Object[] { "WebViewData", "appIdKey", lQ(paramString1, paramString2) });
  ...
  private static String lQ(String paramString1, String paramString2)
  {
  ...
  public final void a(String paramString1, String paramString2, String paramString3, String paramString4, long paramLong, String paramString5)
  {
    ...
    locala.field_appIdKey = lQ(paramString1, paramString2);
    ...
    if (paramString != null)
    {
      if (paramString.moveToFirst()) {
        do
        {
          ...
          {
            bool = new o(gao() + locala.field_localFile).delete();
  ...
  public final long aXU(String paramString)
  {
    AppMethodBeat.i(77852);
    paramString = String.format("select %s from %s where %s=\"%s\"", new Object[] { "size", "WebViewData", "appIdKey", bc(paramString, "###@@@@TOTAL@@@###SIZE####", "_") });
  ...
  public final void b(String paramString, JSONArray paramJSONArray)
  {
    ...
    {
      ((List)localObject).add(lQ(paramString, paramJSONArray.optString(i)));
      i += 1;
    }
  ...
  public final void by(String paramString, long paramLong)
  {
    AppMethodBeat.i(77850);
    a locala = new a();
    locala.field_appId = paramString;
    locala.field_appIdKey = bc(paramString, "###@@@@TOTAL@@@###SIZE####", "_");
  ...
  public final long bz(String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      while (paramString.hasNext())
      {
        ...
        {
          bool = new o(gao() + ((a)localObject2).field_localFile).delete();
  ...
  public final a lN(String paramString1, String paramString2)
  {
    ...
    paramString1 = lP(paramString1, paramString2);
    paramString2 = new a();
  ...
  public final long lO(String paramString1, String paramString2)
  {
    long l = 0L;
    AppMethodBeat.i(77845);
    paramString1 = rawQuery(String.format("select %s from %s where %s=\"%s\"", new Object[] { "size", "WebViewData", "appIdKey", lQ(paramString1, paramString2) }), new String[0]);
    if (paramString1 == null)
    {
