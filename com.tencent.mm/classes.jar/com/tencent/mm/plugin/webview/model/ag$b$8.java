...
final class ag$b$8
  implements Runnable
{
  ag$b$8(Context paramContext, LinkedList paramLinkedList, String paramString1, String paramString2, r.a parama) {}
  
  public final void run()
  {
    AppMethodBeat.i(188330);
    new r(this.val$context).a(this.kdV, this.joE, this.jMh, this.val$context.getString(2131766191), this.CpT);
