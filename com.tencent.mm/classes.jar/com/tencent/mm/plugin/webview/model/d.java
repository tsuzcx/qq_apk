  ...
  extends com.tencent.mm.plugin.x.a
{
  ...
  public final void k(Context paramContext, Intent paramIntent)
  {
    ...
    final String str1 = com.tencent.mm.plugin.base.model.c.OO(y.getStringExtra(paramIntent, "id"));
    final String str2 = com.tencent.mm.plugin.base.model.c.OO(y.getStringExtra(paramIntent, "ext_info"));
    ...
    if (!((String)localObject1).equals(e.ej(str2, com.tencent.mm.kernel.a.getUin())))
    {
      ...
      while (((Iterator)localObject3).hasNext()) {
        ((Set)localObject2).add(com.tencent.mm.plugin.base.model.c.ej(str2, (String)((Iterator)localObject3).next()));
      }
    ...
    if (!bt.isNullOrNil(AWM)) {
      localObject1 = (String)localObject2 + "&" + AWM;
    }
    ...
    com.tencent.mm.am.af.awq().ws(str1);
    ...
    localObject2 = ((k)com.tencent.mm.kernel.g.ab(k.class)).apM().aHY(str1);
    if ((localObject2 == null) || (bt.isNullOrNil(((com.tencent.mm.storage.af)localObject2).ZW())))
    {
      ad.i("MicroMsg.WebViewShortcutEntry", "no need update, displayName is null");
      AppMethodBeat.o(78840);
      return;
    }
    localObject2 = ((com.tencent.mm.storage.af)localObject2).ZW();
    Object localObject3 = p.auF().we(str1);
    if ((localObject3 == null) || (bt.isNullOrNil(((i)localObject3).auy())))
    {
      ad.i("MicroMsg.WebViewShortcutEntry", "no need update, imgFlag is null");
      AppMethodBeat.o(78840);
      return;
    }
    if (((String)localObject1).equals(com.tencent.mm.b.g.getMessageDigest(((String)localObject2 + ((i)localObject3).auy()).getBytes())))
    {
    ...
    e.d(paramContext, str1, str2, com.tencent.mm.plugin.base.model.c.OO(y.getStringExtra(paramIntent, "ext_info_1")));
    aq.n(new Runnable()
    {
