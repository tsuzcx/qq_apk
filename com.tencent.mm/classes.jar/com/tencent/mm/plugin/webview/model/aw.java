...
{
  public static String aA(ArrayList<String> paramArrayList)
  {
  ...
  public static String aB(ArrayList<String> paramArrayList)
  {
    ...
    try
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        WebViewJSSDKFileItem localWebViewJSSDKFileItem = g.emF().awC(str);
        if ((localWebViewJSSDKFileItem instanceof WebViewJSSDKImageItem))
        {
          ...
          localJSONStringer.value(((WebViewJSSDKImageItem)localWebViewJSSDKFileItem).rEo);
          localJSONStringer.endObject();
        }
      }
      localJSONStringer.endArray();
  ...
  public static Intent aJ(String paramString1, String paramString2, String paramString3)
  {
    int i = 1;
    ...
    for (;;)
    {
      if ((i != 0) || (paramString1 == null) || (paramString1.length == 0))
      {
        ...
        if (paramString1.equalsIgnoreCase("image/*"))
        {
          ...
          paramString1[0] = awG(paramString3);
  ...
  public static String awF(String paramString)
  {
    ...
    if (!((e)localObject).exists()) {
      ad.e("MicroMsg.WebviewJSSDKUtil", "camera storage path do not exist.(%s)", new Object[] { b.ais() });
    }
  ...
  private static Intent awG(String paramString)
  {
  ...
  public static String awH(String paramString)
  {
    ...
    String str = "weixin://resourceid/" + ai.du(paramString);
  ...
  public static String awI(String paramString)
  {
    ...
    WebViewJSSDKFileItem localWebViewJSSDKFileItem = g.emF().awC(paramString);
    if (localWebViewJSSDKFileItem != null)
    {
      ad.i("MicroMsg.WebviewJSSDKUtil", "get local thumb filepath from local id :%s", new Object[] { localWebViewJSSDKFileItem.jMa });
      paramString = localWebViewJSSDKFileItem.jMa;
  ...
  public static String awJ(String paramString)
  {
    ...
    if (localWebViewJSSDKFileItem != null)
    {
      ad.i("MicroMsg.WebviewJSSDKUtil", "get orignal filepath from local id :%s", new Object[] { localWebViewJSSDKFileItem.jau });
      paramString = localWebViewJSSDKFileItem.jau;
  ...
  static InputStream awK(String paramString)
  {
    AppMethodBeat.i(79058);
    ad.i("MicroMsg.WebviewJSSDKUtil", "getDataFromLocalId : %s", new Object[] { paramString });
    if (bt.isNullOrNil(paramString))
    {
    ...
    if ((!bt.isNullOrNil(paramString)) && (i.eK(paramString))) {
      ...
      {
        ad.e("MicroMsg.WebviewJSSDKUtil", "init file input stream error : %s", new Object[] { paramString.getMessage() });
      }
    }
    AppMethodBeat.o(79058);
    return null;
  ...
  public static String awL(String paramString)
  {
    ...
    paramString = "_USER_FOR_WEBVIEW_JSAPI" + s.t(paramString, bt.eGO());
    AppMethodBeat.o(79059);
    return paramString;
  }
  
  public static String az(ArrayList<String> paramArrayList)
  {
