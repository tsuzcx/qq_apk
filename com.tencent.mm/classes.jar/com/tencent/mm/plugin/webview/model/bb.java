...
{
  private static Map<String, String> WNl;
  ...
  public static String bkG(String paramString)
  {
    ...
    Object localObject2 = (String)WNl.get(paramString);
    ...
    {
      localObject1 = (String)WNl.get(localObject1);
      ...
      if (Util.isNullOrNil((String)localObject1))
      {
        ...
        if (paramString.startsWith("https://" + WeChatHosts.domainString(c.i.host_mp_weixin_qq_com) + "/"))
        {
          ...
          localObject2 = (String)WNl.get(localObject1);
        }
      }
      if (!Util.isNullOrNil((String)localObject2)) {
        break;
  ...
  public static void or(String paramString1, String paramString2)
  {
    ...
    if (WNl.containsKey(paramString1))
    {
      Log.i("MicroMsg.WebviewSharedUrlCache", "has add this rawurl");
      AppMethodBeat.o(79098);
      return;
    }
    WNl.put(paramString1, paramString2);
    AppMethodBeat.o(79098);
  }
}
