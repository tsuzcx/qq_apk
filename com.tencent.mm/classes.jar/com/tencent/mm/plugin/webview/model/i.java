  ...
  implements k
{
  ...
  public i(String paramString1, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    ((ce)localObject).dwb = paramString1;
    ((ce)localObject).nickname = paramString2;
    ((ce)localObject).FNc = new com.tencent.mm.bw.b(paramArrayOfByte);
    ((ce)localObject).FNd = 0;
