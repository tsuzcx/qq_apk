...
public final class h
{
    ...
    this.Bar = new ap.a()
    {
      public final boolean handleMessage(Message paramAnonymousMessage)
      {
        ...
        for (;;)
        {
          ...
          return false;
          paramAnonymousMessage = h.this.Bao.getBitmap();
          if (paramAnonymousMessage != null)
          {
            ...
            continue;
            if (h.this.Baq != null) {
              h.this.Baq.JL(h.this.Bap);
            }
          }
        }
      }
    };
    this.iDu = new ap(Looper.getMainLooper(), this.Bar);
  ...
  public final void a(MMWebView paramMMWebView, c paramc)
  {
    ...
    this.Bao = paramMMWebView;
    this.Baq = paramc;
    this.iDu.sendEmptyMessage(1);
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      e[] arrayOfe = new e(h.this.Bap).fhT().b(new m()
      {
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      h.this.Bap = String.format(Locale.US, "%s%s_%08x.jpg", new Object[] { com.tencent.mm.loader.j.b.aih(), Long.valueOf(System.currentTimeMillis()), Integer.valueOf(this.mBitmap.hashCode()) });
      try
      {
        f.a(this.mBitmap, 100, Bitmap.CompressFormat.JPEG, h.this.Bap, true);
        ad.i("MicroMsg.ViewCaptureHelper", "bitmap recycle %s", new Object[] { this.mBitmap.toString() });
        this.mBitmap.recycle();
        h.this.iDu.sendEmptyMessage(2);
