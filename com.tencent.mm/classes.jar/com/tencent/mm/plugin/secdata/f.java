...
@l(iBK={1, 1, 16}, iBL={""}, iBM={"Lcom/tencent/mm/plugin/secdata/IListSecData;", "T", "Lcom/tencent/mm/protobuf/BaseProtoBuf;", "", "copyItemObj", "", "fromKey", "", "toKey", "getItemObj", "key", "(Ljava/lang/String;)Lcom/tencent/mm/protobuf/BaseProtoBuf;", "getListItemObjMap", "", "getType", "", "moveItemObj", "putItemObj", "value", "(Ljava/lang/String;Lcom/tencent/mm/protobuf/BaseProtoBuf;)V", "plugin-sec-data_release"})
public abstract interface f<T extends a>
{
  public abstract void c(String paramString, T paramT);
  
  public abstract Map<String, T> fFq();
