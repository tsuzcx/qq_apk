...
public final class c
{
  ...
  public final long caW()
  {
    ...
    localCalendar.setTimeInMillis(this.iwX);
  ...
  public final String toString()
  {
    ...
    default: 
      ...
      return "";
    case 1: 
      str = String.format("%-8s    %-10s  %s\r\n", new Object[] { "IMG", bu.DB(this.size), this.filePath });
      AppMethodBeat.o(22825);
      return str;
    case 3: 
      str = String.format("%-8s    %-10s  %s\r\n", new Object[] { "VIDEO", bu.DB(this.size), this.filePath });
      AppMethodBeat.o(22825);
      return str;
    case 2: 
      str = String.format("%-8s    %-10s  %s\r\n", new Object[] { "VOICE", bu.DB(this.size), this.filePath });
      AppMethodBeat.o(22825);
      return str;
    }
    String str = String.format("%-8s    %-10s  %s\r\n", new Object[] { "ATTACH", bu.DB(this.size), this.filePath });
    AppMethodBeat.o(22825);
    return str;
  }
}
