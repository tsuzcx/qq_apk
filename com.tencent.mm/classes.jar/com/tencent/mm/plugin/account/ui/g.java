...
public final class g
{
  ...
  public final void a(MMActivity paramMMActivity, int paramInt1, int paramInt2, String paramString, n paramn)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((i != 0) || ((paramInt1 == 0) && (paramInt2 == 0)))
      {
        ...
        t.cU(paramMMActivity);
        y.IW(this.account);
        y.showAddrBookUploadConfirm(paramMMActivity, new g.3(this, paramMMActivity), false, 2);
        if (this.jlT)
        {
          paramMMActivity = aj.getContext().getSharedPreferences("randomid_prefs", com.tencent.mm.compatible.util.g.abm()).getString("randomID", "");
          com.tencent.mm.plugin.report.service.g.yhR.f(11930, new Object[] { paramMMActivity, Integer.valueOf(4) });
        }
      ...
      if (com.tencent.mm.plugin.account.a.a.iRH.a(paramMMActivity, paramInt1, paramInt2, paramString)) {
        i = 1;
      }
      while (i != 0)
      {
        ...
        case -100: 
          ...
          for (paramString = com.tencent.mm.cc.a.az(paramMMActivity, 2131761063);; paramString = com.tencent.mm.kernel.a.ais())
          {
        ...
        case -140: 
          if (!bt.isNullOrNil(this.dKk)) {
            y.n(paramMMActivity, paramString, this.dKk);
          }
          i = 1;
        }
      }
  ...
  public final void b(MMActivity paramMMActivity)
  {
    ...
    localObject = new s((String)localObject, this.jme, 0, "", "", "", 0, "", false, true);
