  ...
  extends k
{
  ...
  private boolean a(p paramp)
  {
    ...
    if ((int)this.hpA.a("invitefriendopen", "username", paramp) != -1)
    {
      AppMethodBeat.o(131063);
      return true;
    }
  ...
  private boolean c(p paramp)
  {
    ...
    if (this.hpA.update("invitefriendopen", localContentValues, "username=?", new String[] { paramp.getUsername() }) > 0)
    {
  ...
  public final boolean Gt(String paramString)
  {
    ...
    paramString = "select invitefriendopen.username,invitefriendopen.friendtype,invitefriendopen.updatetime,invitefriendopen.reserved1,invitefriendopen.reserved2,invitefriendopen.reserved3,invitefriendopen.reserved4 from invitefriendopen   where invitefriendopen.username = \"" + bs.aLh(String.valueOf(paramString)) + "\"";
