  ...
  implements f
{
  ...
  final void Kn(final String paramString)
  {
    ...
    this.hQb = com.tencent.mm.ui.base.h.b((Context)localObject, this.context.getString(2131760376), true, new DialogInterface.OnCancelListener()
    {
    ...
    com.tencent.mm.ui.base.h.a(paramCursor, (String)localObject, localArrayList1, localArrayList2, new h.d()
    {
      public final void cv(int paramAnonymousInt1, int paramAnonymousInt2)
      {
        ...
        if (paramAnonymousInt2 != -1) {
          h.this.Kn(((com.tencent.mm.plugin.account.friend.a.n)localArrayList3.get(paramAnonymousInt2)).field_googlegmail);
        }
  ...
  public final void onSceneEnd(int paramInt1, int paramInt2, String paramString, com.tencent.mm.ak.n paramn)
  {
    ...
    ae.i("MicroMsg.SendInviteGoogleContact", "[onSceneEnd] errType:%d,errCode:%d,errMsg:%s", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), str });
    ...
    {
      ae.i("MicroMsg.SendInviteGoogleContact", "dealSendInviteSuccess");
    ...
    ae.i("MicroMsg.SendInviteGoogleContact", "dealSendInviteFail");
    this.jjJ.fu(false);
    AppMethodBeat.o(131317);
  }
