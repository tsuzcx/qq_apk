  ...
  extends MStorageEx
{
  ...
  public final String SX(String paramString)
  {
    ...
    //   9: ifne +91 -> 100
    //   12: aload_0
    //   13: getfield 34	com/tencent/mm/plugin/account/friend/model/b:omV	Lcom/tencent/mm/storagebase/h;
    //   16: ldc 43
    //   18: aconst_null
    //   19: ldc_w 256
    //   22: iconst_1
    ...
    //   32: aconst_null
    //   33: iconst_2
    //   34: invokevirtual 260	com/tencent/mm/storagebase/h:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Landroid/database/Cursor;
    //   37: astore_2
    //   38: aload_2
    //   39: astore_1
    //   40: aload_2
    ...
    //   49: aload_2
    //   50: astore_1
    //   51: new 109	com/tencent/mm/plugin/account/friend/model/a
    //   54: dup
    //   55: invokespecial 110	com/tencent/mm/plugin/account/friend/model/a:<init>	()V
    //   58: astore_3
    //   59: aload_2
    //   60: astore_1
    //   61: aload_3
    //   62: aload_2
    //   63: invokevirtual 142	com/tencent/mm/plugin/account/friend/model/a:convertFrom	(Landroid/database/Cursor;)V
    //   66: aload_2
    //   67: astore_1
    //   68: aload_3
    //   69: invokevirtual 250	com/tencent/mm/plugin/account/friend/model/a:getUsername	()Ljava/lang/String;
    //   72: astore_3
    //   73: aload_2
    //   74: ifnull +9 -> 83
    //   77: aload_2
    ...
    //   114: ldc_w 262
    //   117: iconst_1
    //   118: anewarray 264	java/lang/Object
    //   121: dup
    //   122: iconst_0
    //   123: aload_3
    //   124: invokevirtual 267	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   127: aastore
    //   128: invokestatic 271	com/tencent/mm/sdk/platformtools/Log:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   131: aload_2
    //   132: ifnull -32 -> 100
    //   135: aload_2
  ...
  public final int a(String paramString, a parama)
  {
    ...
    if (localContentValues.size() > 0) {
      i = this.omV.update("addr_upload2", localContentValues, "id=?", new String[] { a.SQ(paramString) });
    }
    if (i > 0)
    {
  ...
  public final List<String[]> bWQ()
  {
    AppMethodBeat.i(130983);
    Cursor localCursor = this.omV.rawQuery("select addr_upload2.moblie , addr_upload2.md5 from addr_upload2 where addr_upload2.type = 0", null, 2);
    ArrayList localArrayList = new ArrayList();
    while (localCursor.moveToNext()) {
  ...
  public final boolean bY(List<a> paramList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((int)this.omV.insert("addr_upload2", "id", (ContentValues)localObject) != -1) {
          continue;
        }
        Log.i("MicroMsg.AddrUploadStorage", "batchSet insert failed, num:%s email:%s", new Object[] { locala.bWN(), locala.getEmail() });
        bool = true;
      }
      catch (Exception paramList)
      {
        ...
        j = this.omV.update("addr_upload2", (ContentValues)localObject, "id=?", new String[] { String.valueOf(k) });
        if (j != 0) {
          continue;
        }
        Log.i("MicroMsg.AddrUploadStorage", "batchSet update result=0, num:%s email:%s", new Object[] { locala.bWN(), locala.getEmail() });
        continue;
        if (j >= 0) {
          continue;
        }
        Log.i("MicroMsg.AddrUploadStorage", "batchSet update failed, num:%s email:%s", new Object[] { locala.bWN(), locala.getEmail() });
        bool = true;
        continue;
  ...
  public final boolean cw(List<String> paramList)
  {
    ...
    try
    {
      ...
      while (paramList.hasNext())
      {
        ...
        {
          int i = this.omV.delete("addr_upload2", "id =?", new String[] { a.SQ(str) });
  ...
  public final boolean cx(List<String> paramList)
  {
    ...
    try
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((str != null) && (str.length() > 0))
        {
          ...
          ((a)localObject).eQp = 8;
          ((a)localObject).pRV = Util.nowSecond();
          localObject = ((a)localObject).convertTo();
          int i = 0;
          if (((ContentValues)localObject).size() > 0) {
            i = this.omV.update("addr_upload2", (ContentValues)localObject, "id=?", new String[] { a.SQ(str) });
          }
 ...
 * Qualified Name:     com.tencent.mm.plugin.account.friend.model.b
