  ...
  extends k
{
  ...
  public final boolean a(g paramg)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      long l = paramg.evr;
      localObject = "select facebookfriend.fbid,facebookfriend.fbname,facebookfriend.fbimgkey,facebookfriend.status,facebookfriend.username,facebookfriend.nickname,facebookfriend.nicknamepyinitial,facebookfriend.nicknamequanpin,facebookfriend.sex,facebookfriend.personalcard,facebookfriend.province,facebookfriend.city,facebookfriend.signature,facebookfriend.alias,facebookfriend.type,facebookfriend.email from facebookfriend   where facebookfriend.fbid = \"" + bt.aFQ(String.valueOf(l)) + "\"";
      ...
      if ((int)this.gPa.a("facebookfriend", "fbid", paramg) == -1) {
        break;
      }
    ...
    int i = this.gPa.update("facebookfriend", (ContentValues)localObject, "fbid=?", new String[] { paramg.evr });
    if (i > 0) {
      doNotify();
    }
    if (i > 0)
  ...
  public final boolean aIG()
  {
    ...
    boolean bool = this.gPa.execSQL("facebookfriend", "delete from facebookfriend");
