  ...
  implements com.tencent.mm.al.g
{
  ...
  public void initView()
  {
    ...
    this.ioM = getIntent().getStringExtra("safe_device_name");
    this.ioO = getIntent().getStringExtra("safe_device_uid");
    this.dfF = getIntent().getStringExtra("safe_device_type");
    setMMTitle(com.tencent.mm.cd.a.aq(this, 2131762759));
    ...
    addTextOptionMenu(0, getString(2131755880), new MenuItem.OnMenuItemClickListener()
    {
      public final boolean onMenuItemClick(final MenuItem paramAnonymousMenuItem)
      {
        ...
        ModSafeDeviceNameUI.a(ModSafeDeviceNameUI.this, h.b(ModSafeDeviceNameUI.this, com.tencent.mm.cd.a.aq(ModSafeDeviceNameUI.this, 2131755936), true, new DialogInterface.OnCancelListener()
        {
    ...
    this.ioL = ((EditText)findViewById(2131302423));
    MMEditText.c localc = new MMEditText.c(this.ioL, null, 32);
    localc.Hzz = local3;
    this.ioL.addTextChangedListener(localc);
    if (!bt.isNullOrNil(this.ioM))
    {
      this.ioL.setText(this.ioM);
  ...
  public void onSceneEnd(int paramInt1, int paramInt2, String paramString, n paramn)
  {
    ...
    {
      paramString = new d();
      paramString.field_devicetype = this.dfF;
      paramString.field_name = this.ioN;
      paramString.field_uid = this.ioO;
      paramString.field_createtime = this.createTime;
      com.tencent.mm.plugin.account.security.a.g.aJD().update(paramString, new String[0]);
