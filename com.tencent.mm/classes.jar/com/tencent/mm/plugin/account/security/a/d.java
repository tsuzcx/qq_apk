  ...
  extends ez
{
  ...
  public d(bmu parambmu)
  {
    AppMethodBeat.i(125519);
    this.field_uid = parambmu.uuid;
    this.field_devicetype = parambmu.devicetype;
    this.field_name = parambmu.devicename;
    this.field_createtime = parambmu.DKh;
