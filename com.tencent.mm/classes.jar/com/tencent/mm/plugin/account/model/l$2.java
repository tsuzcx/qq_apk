  ...
  implements au.a
{
  public final boolean onTimerExpired()
  {
    ...
    Object localObject1;
    Object localObject2;
    if ((l.access$000() == 1) || (l.access$000() == 16) || (l.access$000() % 96 == 0))
    {
      ...
      ac.d("MicroMsg.SubCoreAccountSync", "[oneliang][showMobileRegNoVerifyCodeNotification]:%s", new Object[] { ((ComponentName)localObject2).getClassName() });
    ...
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
        ...
        s.c localc = com.tencent.mm.bq.a.bE((Context)localObject1, "reminder_channel_id");
        localc.f(((Context)localObject1).getString(2131755866));
        localc.as(com.tencent.mm.bq.a.dlN());
        localc.i(System.currentTimeMillis());
        localc.Fu = ((PendingIntent)localObject2);
 ...
 * Qualified Name:     com.tencent.mm.plugin.account.model.l.2
