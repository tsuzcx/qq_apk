  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bn(paramView);
    a.c("com/tencent/mm/plugin/account/bind/ui/BindLinkedInUI$4", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.aFi());
    com.tencent.mm.ui.base.h.a(this.mRO, this.mRO.getString(a.i.contact_info_linkedin_account_unbind_alert), null, new DialogInterface.OnClickListener()new DialogInterface.OnClickListener
    {
      public final void onClick(final DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
      {
        AppMethodBeat.i(109822);
        paramAnonymousDialogInterface = new d();
        BindLinkedInUI.a(BindLinkedInUI.8.this.mRO, com.tencent.mm.ui.base.h.a(BindLinkedInUI.8.this.mRO, BindLinkedInUI.8.this.mRO.getString(a.i.loading_tips), false, new DialogInterface.OnCancelListener()
        {
