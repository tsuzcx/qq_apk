...
{
  private static final Application.ActivityLifecycleCallbacks MHW;
  
  static
  {
    AppMethodBeat.i(116071);
    MHW = new com.tencent.mm.plugin.appbrand.af.a()
    {
      public final void onActivityCreated(Activity paramAnonymousActivity, Bundle paramAnonymousBundle)
      {
        ...
        try
        {
          ...
          label59:
          for (paramAnonymousActivity = null;; paramAnonymousActivity = paramAnonymousActivity.getIntent().getStringExtra(f.s.adxe))
          {
  ...
  public static void E(String paramString1, String paramString2, String paramString3, String paramString4)
  {
  ...
  public static void p(Application paramApplication)
  {
    ...
    paramApplication.registerActivityLifecycleCallbacks(MHW);
