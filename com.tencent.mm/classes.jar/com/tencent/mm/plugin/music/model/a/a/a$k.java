  ...
  implements k<IPCAudioParamRequest, IPCVoid>
{
  private static IPCVoid a(IPCAudioParamRequest paramIPCAudioParamRequest)
  {
    ...
    for (;;)
    {
      try
      {
        Object localObject = paramIPCAudioParamRequest.dqm;
        if (paramIPCAudioParamRequest.hnR == null) {
          continue;
        }
        ...
        localObject = paramIPCAudioParamRequest.dqm;
        paramIPCAudioParamRequest = paramIPCAudioParamRequest.hnR;
        d locald = com.tencent.mm.plugin.music.model.f.cVp();
        ...
        localObject = (c)locald.tXI.get(localObject);
        if (localObject != null) {
