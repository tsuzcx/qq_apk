  ...
  implements Runnable
{
  ...
  public b(f paramf, a parama)
  {
    ...
    int i;
    int j;
    if ((parama.vek == 0L) && (parama.vel == 0L) && (parama.endFlag == 0))
    {
      i = 1;
      if ((parama.vem != 0L) || (parama.veo != 0L) || (parama.ven != 0)) {
        break label154;
      }
      j = 1;
      label110:
      ...
      ac.e("MicroMsg.Music.MusicDownloadTask", "downloadInfo is invalid");
    }
    for (;;)
    {
      ...
      break label122;
      label165:
      ac.i("MicroMsg.Music.MusicDownloadTask", "downloadInfo is valid");
    }
  }
  ...
  private HttpURLConnection A(String paramString, Map<String, String> paramMap)
  {
    ...
    {
      ac.i("MicroMsg.Music.MusicDownloadTask", "use previous temp redirect URL to download , avoid to request source url and than redirect to 302 resp code");
      paramString = this.vep;
      localObject1 = null;
    }
    for (int i = 0;; i = 0)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          ac.i("MicroMsg.Music.MusicDownloadTask", "getUrlConnect, downloadUrl:%s", new Object[] { paramString });
          Object localObject2 = k.diO().veU;
          localObject1 = new URL(paramString);
          if (localObject2 != null) {
            localObject1 = ((com.tencent.mm.plugin.music.e.a)localObject2).anC(paramString);
          }
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ac.e("MicroMsg.Music.MusicDownloadTask", localException.getMessage());
          }
          int j = ((HttpURLConnection)localObject1).getResponseCode();
          ac.i("MicroMsg.Music.MusicDownloadTask", "getUrlConnect response:%d, redirectCount:%d", new Object[] { Integer.valueOf(j), Integer.valueOf(i) });
          if ((j == 300) || (j == 301) || (j == 302) || (j == 303) || (j == 307))
          {
            ...
            if (paramString == null)
            {
              ac.e("MicroMsg.Music.MusicDownloadTask", "Invalid redirect,  response:%d", new Object[] { Integer.valueOf(j) });
              AppMethodBeat.o(137219);
              return localObject1;
            }
            URL localURL = new URL(((HttpURLConnection)localObject1).getURL(), paramString);
            ac.i("MicroMsg.Music.MusicDownloadTask", "location:%s", new Object[] { paramString });
            ac.i("MicroMsg.Music.MusicDownloadTask", "tempUrl:%s", new Object[] { localURL.toString() });
            if ((!localURL.getProtocol().equals("https")) && (!localURL.getProtocol().equals("http")))
            {
              ac.e("MicroMsg.Music.MusicDownloadTask", "Unsupported protocol redirect,  response:%d", new Object[] { Integer.valueOf(j) });
              AppMethodBeat.o(137219);
              return localObject1;
            }
            i += 1;
            if (i > 5)
            {
              ac.e("MicroMsg.Music.MusicDownloadTask", "Too many redirects: ".concat(String.valueOf(i)));
              AppMethodBeat.o(137219);
              return localObject1;
            }
            paramString = localURL.toString();
            this.vep = paramString;
          }
          else
          {
            if ((j != 200) && (j != 206)) {
  ...
  private static void JE(int paramInt)
  {
  ...
  private void Y(long paramLong1, long paramLong2)
  {
    ...
    if (this.qKm)
    {
      this.ves.vem = paramLong1;
      this.ves.ven = 0;
      this.ves.veo = paramLong2;
      e.a(this.veq.hNS, this.ves);
    }
    for (;;)
    {
      ap.f(new a(3));
      ...
      return;
      this.ves.vek = paramLong1;
      this.ves.endFlag = 0;
      this.ves.vel = paramLong2;
      e.a(this.veq.hNS, this.ves);
    }
  }
  
  private static long[] anA(String paramString)
  {
  ...
  private void wb(long paramLong)
  {
    AppMethodBeat.i(137222);
    if (this.qKm)
    {
      this.ves.vem = paramLong;
      this.ves.ven = 1;
      this.ves.veo = paramLong;
      e.a(this.veq.hNS, this.ves);
    }
    for (;;)
    {
      ...
      return;
      this.ves.vek = paramLong;
      this.ves.endFlag = 1;
      this.ves.vel = paramLong;
      e.a(this.veq.hNS, this.ves);
    }
  }
  ...
  public final void run()
  {
    ...
    //   23: aconst_null
    //   24: astore 34
    //   26: invokestatic 99	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   29: invokestatic 377	com/tencent/mm/sdk/platformtools/ax:isNetworkConnected	(Landroid/content/Context;)Z
    //   32: istore 32
    //   34: aload_0
    //   35: iconst_0
    //   36: putfield 59	com/tencent/mm/plugin/music/c/b:cRY	I
    //   39: aload_0
    //   40: iconst_0
    //   41: putfield 57	com/tencent/mm/plugin/music/c/b:vev	I
    //   44: invokestatic 153	com/tencent/mm/plugin/music/e/k:diO	()Lcom/tencent/mm/plugin/music/e/k;
    //   47: getfield 157	com/tencent/mm/plugin/music/e/k:veU	Lcom/tencent/mm/plugin/music/e/a;
    //   50: astore 35
    //   52: iload 32
    //   54: ifeq +510 -> 564
    //   57: aload_0
    //   58: getfield 107	com/tencent/mm/plugin/music/c/b:qKm	Z
    //   61: ifeq +362 -> 423
    //   64: aload_0
    //   65: getfield 61	com/tencent/mm/plugin/music/c/b:veq	Lcom/tencent/mm/ay/f;
    //   68: getfield 380	com/tencent/mm/ay/f:playUrl	Ljava/lang/String;
    //   71: invokestatic 385	com/tencent/mm/plugin/music/cache/g:anq	(Ljava/lang/String;)Z
    //   74: istore 32
    //   76: aload 34
    //   78: astore 33
    //   80: aload 35
    ...
    //   85: aload 35
    //   87: aload_0
    //   88: getfield 61	com/tencent/mm/plugin/music/c/b:veq	Lcom/tencent/mm/ay/f;
    //   91: getfield 380	com/tencent/mm/ay/f:playUrl	Ljava/lang/String;
    //   94: invokeinterface 388 2 0
    //   99: astore 33
    //   101: ldc 85
    //   103: ldc_w 390
    //   106: iconst_1
    ...
    //   112: aload 33
    //   114: aastore
    //   115: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   118: aload_0
    //   119: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   122: getfield 77	com/tencent/mm/plugin/music/c/a:vem	J
    //   125: lstore 6
    //   127: aload_0
    //   128: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   131: getfield 80	com/tencent/mm/plugin/music/c/a:veo	J
    //   134: lstore 4
    //   136: lload 4
    //   138: lconst_0
    //   139: lcmp
    ...
    //   146: ldc2_w 391
    //   149: ldiv
    //   150: putfield 49	com/tencent/mm/plugin/music/c/b:veu	J
    //   153: lload 6
    //   155: aload_0
    //   156: getfield 49	com/tencent/mm/plugin/music/c/b:veu	J
    //   159: lcmp
    //   160: ifge +233 -> 393
    //   163: aload_0
    //   164: getfield 49	com/tencent/mm/plugin/music/c/b:veu	J
    //   167: lstore_2
    //   168: aload_0
    //   169: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   172: getfield 83	com/tencent/mm/plugin/music/c/a:ven	I
    //   175: iconst_1
    ...
    //   183: astore 40
    //   185: aload_0
    //   186: getfield 49	com/tencent/mm/plugin/music/c/b:veu	J
    //   189: ldc2_w 393
    //   192: lcmp
    //   193: ifge +18 -> 211
    //   196: aload_0
    //   197: ldc2_w 393
    //   200: putfield 49	com/tencent/mm/plugin/music/c/b:veu	J
    //   203: ldc 85
    //   205: ldc_w 396
    //   208: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   211: new 398	com/tencent/mm/vfs/e
    //   214: dup
    //   215: aload_0
    //   216: getfield 61	com/tencent/mm/plugin/music/c/b:veq	Lcom/tencent/mm/ay/f;
    //   219: getfield 321	com/tencent/mm/ay/f:hNS	Ljava/lang/String;
    //   222: aload_0
    //   223: getfield 107	com/tencent/mm/plugin/music/c/b:qKm	Z
    //   226: invokestatic 404	com/tencent/mm/plugin/music/h/b:bs	(Ljava/lang/String;Z)Ljava/lang/String;
    //   229: invokespecial 405	com/tencent/mm/vfs/e:<init>	(Ljava/lang/String;)V
    //   232: astore 52
    //   234: lload_2
    //   235: lstore 8
    //   237: lload 6
    //   239: lstore_2
    //   240: aload 52
    //   242: invokevirtual 408	com/tencent/mm/vfs/e:exists	()Z
    //   245: ifne +56 -> 301
    //   248: ldc 85
    //   250: ldc_w 410
    //   253: iconst_1
    ...
    //   258: iconst_0
    //   259: aload 52
    //   261: invokevirtual 413	com/tencent/mm/vfs/e:createNewFile	()Z
    //   264: invokestatic 418	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   267: aastore
    //   268: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   271: lconst_0
    //   272: lstore_2
    //   273: aload_0
    //   274: getfield 49	com/tencent/mm/plugin/music/c/b:veu	J
    //   277: lstore 8
    //   279: iconst_0
    //   280: istore_1
    //   281: ldc 85
    ...
    //   291: iconst_0
    //   292: lload 8
    //   294: invokestatic 423	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   297: aastore
    //   298: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   301: ldc 85
    //   303: ldc_w 425
    //   306: iconst_3
    ...
    //   311: iconst_0
    //   312: lload_2
    //   313: invokestatic 423	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   316: aastore
    //   317: dup
    //   318: iconst_1
    //   319: aload 52
    //   321: invokevirtual 428	com/tencent/mm/vfs/e:length	()J
    //   324: invokestatic 423	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   327: aastore
    //   328: dup
    //   329: iconst_2
    //   330: lload 8
    //   332: invokestatic 423	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   335: aastore
    //   336: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   339: lload_2
    //   340: aload_0
    //   341: getfield 49	com/tencent/mm/plugin/music/c/b:veu	J
    //   344: lcmp
    //   345: iflt +12 -> 357
    //   348: aload_0
    //   349: getfield 430	com/tencent/mm/plugin/music/c/b:vet	F
    //   352: fconst_0
    //   353: fcmpl
    //   354: ifeq +7 -> 361
    //   357: iload_1
    ...
    //   361: ldc 85
    //   363: ldc_w 432
    //   366: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   369: aload_0
    //   370: iconst_1
    ...
    //   383: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   386: ldc_w 374
    ...
    //   396: ldc_w 433
    //   399: aload_0
    //   400: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   403: getfield 80	com/tencent/mm/plugin/music/c/a:veo	J
    //   406: l2f
    //   407: fmul
    //   408: fadd
    //   409: f2l
    ...
    //   428: aload 35
    //   430: aload_0
    //   431: getfield 61	com/tencent/mm/plugin/music/c/b:veq	Lcom/tencent/mm/ay/f;
    ...
    //   455: aload 33
    //   457: aastore
    //   458: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   461: iconst_0
    //   462: istore 32
    //   464: aload_0
    //   465: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   468: getfield 68	com/tencent/mm/plugin/music/c/a:vek	J
    //   471: lstore 6
    //   473: aload_0
    //   474: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   477: getfield 71	com/tencent/mm/plugin/music/c/a:vel	J
    //   480: lstore 4
    //   482: lload 4
    //   484: lconst_0
    //   485: lcmp
    ...
    //   492: ldc2_w 391
    //   495: ldiv
    //   496: putfield 49	com/tencent/mm/plugin/music/c/b:veu	J
    //   499: lload 6
    //   501: aload_0
    //   502: getfield 49	com/tencent/mm/plugin/music/c/b:veu	J
    //   505: lcmp
    //   506: ifge +28 -> 534
    //   509: aload_0
    //   510: getfield 49	com/tencent/mm/plugin/music/c/b:veu	J
    //   513: lstore_2
    //   514: aload_0
    //   515: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    ...
    //   537: ldc_w 433
    //   540: aload_0
    //   541: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   544: getfield 71	com/tencent/mm/plugin/music/c/a:vel	J
    //   547: l2f
    //   548: fmul
    //   549: fadd
    //   550: f2l
    ...
    //   561: goto -376 -> 185
    //   564: aload_0
    //   565: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   568: getfield 77	com/tencent/mm/plugin/music/c/a:vem	J
    //   571: lconst_0
    //   572: lcmp
    //   573: ifeq +102 -> 675
    //   576: aload_0
    //   577: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   580: getfield 77	com/tencent/mm/plugin/music/c/a:vem	J
    //   583: aload_0
    //   584: getfield 49	com/tencent/mm/plugin/music/c/b:veu	J
    //   587: lcmp
    //   588: ifge +21 -> 609
    //   591: aload_0
    //   592: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   595: getfield 77	com/tencent/mm/plugin/music/c/a:vem	J
    //   598: aload_0
    //   599: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   602: getfield 80	com/tencent/mm/plugin/music/c/a:veo	J
    //   605: lcmp
    //   606: ifne +69 -> 675
    //   609: aload_0
    //   610: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   613: getfield 77	com/tencent/mm/plugin/music/c/a:vem	J
    //   616: l2f
    //   617: aload_0
    //   618: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   621: getfield 80	com/tencent/mm/plugin/music/c/a:veo	J
    //   624: l2f
    //   625: fdiv
    //   626: aload_0
    //   627: getfield 430	com/tencent/mm/plugin/music/c/b:vet	F
    //   630: fsub
    //   631: ldc_w 433
    //   634: fcmpl
    //   635: iflt +40 -> 675
    //   638: ldc 85
    //   640: ldc_w 432
    //   643: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   646: aload_0
    //   647: iconst_1
    //   648: putfield 51	com/tencent/mm/plugin/music/c/b:isStop	Z
    //   651: aload_0
    //   652: iconst_1
    //   653: putfield 107	com/tencent/mm/plugin/music/c/b:qKm	Z
    ...
    //   665: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   668: ldc_w 374
    //   671: invokestatic 110	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   674: return
    //   675: aload_0
    //   676: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   679: getfield 68	com/tencent/mm/plugin/music/c/a:vek	J
    //   682: lconst_0
    //   683: lcmp
    //   684: ifeq +102 -> 786
    //   687: aload_0
    //   688: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   691: getfield 68	com/tencent/mm/plugin/music/c/a:vek	J
    //   694: aload_0
    //   695: getfield 49	com/tencent/mm/plugin/music/c/b:veu	J
    //   698: lcmp
    //   699: ifge +21 -> 720
    //   702: aload_0
    //   703: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   706: getfield 68	com/tencent/mm/plugin/music/c/a:vek	J
    //   709: aload_0
    //   710: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   713: getfield 71	com/tencent/mm/plugin/music/c/a:vel	J
    //   716: lcmp
    //   717: ifne +69 -> 786
    //   720: aload_0
    //   721: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   724: getfield 68	com/tencent/mm/plugin/music/c/a:vek	J
    //   727: l2f
    //   728: aload_0
    //   729: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   732: getfield 71	com/tencent/mm/plugin/music/c/a:vel	J
    //   735: l2f
    //   736: fdiv
    //   737: aload_0
    //   738: getfield 430	com/tencent/mm/plugin/music/c/b:vet	F
    //   741: fsub
    //   742: ldc_w 433
    //   745: fcmpl
    //   746: iflt +40 -> 786
    //   749: ldc 85
    //   751: ldc_w 432
    //   754: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   757: aload_0
    //   758: iconst_1
    //   759: putfield 51	com/tencent/mm/plugin/music/c/b:isStop	Z
    //   762: aload_0
    //   763: iconst_0
    //   764: putfield 107	com/tencent/mm/plugin/music/c/b:qKm	Z
    ...
    //   776: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   779: ldc_w 374
    //   782: invokestatic 110	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   785: return
    //   786: ldc 85
    //   788: ldc_w 435
    //   791: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   794: aload_0
    //   795: iconst_1
    //   796: putfield 51	com/tencent/mm/plugin/music/c/b:isStop	Z
    //   799: aload_0
    //   800: iconst_4
    //   801: invokespecial 437	com/tencent/mm/plugin/music/c/b:JF	(I)V
    //   804: ldc_w 374
    ...
    //   825: iconst_0
    //   826: aload 52
    //   828: invokevirtual 443	com/tencent/mm/vfs/e:fxV	()Landroid/net/Uri;
    //   831: invokestatic 449	com/tencent/mm/vfs/q:B	(Landroid/net/Uri;)Ljava/lang/String;
    //   834: aastore
    //   835: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   838: goto -567 -> 271
    //   841: aload 40
    //   843: invokestatic 335	com/tencent/mm/sdk/platformtools/bs:isNullOrNil	(Ljava/lang/String;)Z
    //   846: ifeq +36 -> 882
    //   849: ldc 85
    //   851: ldc_w 455
    //   854: invokestatic 93	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   857: aload_0
    //   858: iconst_1
    ...
    //   872: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   875: ldc_w 374
    ...
    //   1013: iconst_0
    //   1014: aload 52
    //   1016: invokevirtual 443	com/tencent/mm/vfs/e:fxV	()Landroid/net/Uri;
    //   1019: invokestatic 449	com/tencent/mm/vfs/q:B	(Landroid/net/Uri;)Ljava/lang/String;
    //   1022: aastore
    //   1023: invokestatic 257	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1026: aload 49
    //   1028: astore 37
    //   1030: aload 48
    //   1032: astore 36
    ...
    //   1050: aload_0
    //   1051: bipush 19
    //   1053: invokespecial 437	com/tencent/mm/plugin/music/c/b:JF	(I)V
    //   1056: lload 4
    //   1058: lconst_0
    //   1059: lcmp
    //   1060: ifne +89 -> 1149
    ...
    //   1069: ldc 85
    //   1071: ldc_w 459
    //   1074: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   1085: aload_0
    //   1086: lload_2
    //   1087: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   1090: lload_2
    //   1091: ldc2_w 393
    //   1094: lcmp
    //   1095: ifge +15 -> 1110
    ...
    //   1107: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   1110: aload_0
    //   1111: iconst_1
    //   1112: putfield 51	com/tencent/mm/plugin/music/c/b:isStop	Z
    //   1115: ldc 85
    //   1117: ldc_w 466
    //   1120: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   1123: ldc_w 374
    ...
    //   1143: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1146: goto -61 -> 1085
    //   1149: lload 4
    //   1151: lconst_0
    //   1152: lcmp
    ...
    //   1186: aastore
    //   1187: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1190: aload_0
    //   1191: lload_2
    //   1192: lload 4
    ...
    //   1237: aastore
    //   1238: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1241: aload_0
    //   1242: lload 4
    //   1244: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   1247: lload_2
    //   1248: ldc2_w 393
    //   1251: lcmp
    //   1252: ifge -142 -> 1110
    ...
    //   1264: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   1267: goto -157 -> 1110
    //   1270: ldc 85
    //   1272: ldc_w 476
    //   1275: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   1278: goto -168 -> 1110
    //   1281: aload 49
    //   1283: astore 37
    //   1285: aload 48
    ...
    //   1313: iconst_1
    //   1314: invokestatic 486	com/tencent/mm/vfs/i:cY	(Ljava/lang/String;Z)Ljava/io/RandomAccessFile;
    //   1317: astore 33
    //   1319: aload 33
    //   1321: astore 37
    //   1323: aload 33
    ...
    //   1354: aload 40
    //   1356: aastore
    //   1357: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1360: aload 33
    //   1362: astore 37
    //   1364: aload 33
    //   1366: astore 36
    ...
    //   1487: aastore
    //   1488: invokestatic 505	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1491: aload 33
    //   1493: astore 37
    //   1495: aload 33
    //   1497: astore 36
    ...
    //   1581: astore 35
    //   1583: aload 40
    //   1585: invokestatic 525	com/tencent/mm/plugin/music/h/e:anS	(Ljava/lang/String;)Z
    //   1588: ifeq +35 -> 1623
    //   1591: aload 33
    //   1593: astore 37
    //   1595: aload 33
    ...
    //   1615: ldc 85
    //   1617: ldc_w 527
    //   1620: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   1623: aload 33
    //   1625: astore 37
    //   1627: aload 33
    //   1629: astore 36
    ...
    //   1674: invokestatic 99	com/tencent/mm/sdk/platformtools/ai:getContext	()Landroid/content/Context;
    //   1677: invokestatic 543	com/tencent/mm/plugin/music/h/e:fO	(Landroid/content/Context;)Ljava/lang/String;
    ...
    //   1717: aload 40
    //   1719: aload 47
    //   1721: invokespecial 545	com/tencent/mm/plugin/music/c/b:A	(Ljava/lang/String;Ljava/util/Map;)Ljava/net/HttpURLConnection;
    //   1724: astore 40
    //   1726: aload 40
    //   1728: astore 34
    //   1730: aload 33
    ...
    //   1856: lstore 12
    //   1858: iload_1
    //   1859: invokestatic 238	com/tencent/mm/plugin/music/c/b:JE	(I)V
    //   1862: aload 33
    //   1864: astore 37
    //   1866: aload 34
    //   1868: astore 36
    ...
    //   1931: aastore
    //   1932: invokestatic 257	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1935: aload 33
    //   1937: astore 37
    //   1939: aload 34
    //   1941: astore 36
    ...
    //   1989: aload_0
    //   1990: iload_1
    //   1991: putfield 57	com/tencent/mm/plugin/music/c/b:vev	I
    //   1994: aload 33
    //   1996: astore 37
    //   1998: aload 34
    //   2000: astore 36
    ...
    //   2048: aload_0
    //   2049: iconst_m1
    //   2050: invokespecial 437	com/tencent/mm/plugin/music/c/b:JF	(I)V
    //   2053: lload 4
    //   2055: lconst_0
    //   2056: lcmp
    //   2057: ifne +115 -> 2172
    ...
    //   2066: ldc 85
    //   2068: ldc_w 459
    //   2071: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   2074: aload 33
    //   2076: lload_2
    //   2077: invokevirtual 552	java/io/RandomAccessFile:setLength	(J)V
    //   2080: aload_0
    //   2081: lload_2
    //   2082: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   2085: lload_2
    //   2086: ldc2_w 393
    //   2089: lcmp
    //   2090: ifge +15 -> 2105
    ...
    //   2102: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   2105: aload 33
    //   2107: ifnull +8 -> 2115
    //   2110: aload 33
    ...
    //   2138: ldc 85
    //   2140: ldc_w 466
    //   2143: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   2146: ldc_w 374
    ...
    //   2166: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2169: goto -89 -> 2080
    //   2172: lload 4
    //   2174: lconst_0
    //   2175: lcmp
    ...
    //   2209: aastore
    //   2210: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2213: aload_0
    //   2214: lload_2
    //   2215: lload 4
    ...
    //   2260: aastore
    //   2261: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2264: aload_0
    //   2265: lload 4
    //   2267: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   2270: lload_2
    //   2271: ldc2_w 393
    //   2274: lcmp
    //   2275: ifge -170 -> 2105
    ...
    //   2287: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   2290: goto -185 -> 2105
    //   2293: ldc 85
    //   2295: ldc_w 476
    //   2298: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   2301: goto -196 -> 2105
    //   2304: astore 33
    //   2306: ldc 85
    //   2308: aload 33
    ...
    //   2317: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2320: goto -205 -> 2115
    //   2323: astore 33
    //   2325: ldc 85
    //   2327: aload 33
    //   2329: invokevirtual 223	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   2332: invokestatic 93	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   2335: goto -207 -> 2128
    //   2338: aload 33
    //   2340: astore 37
    //   2342: aload 34
    ...
    //   2407: aastore
    //   2408: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2411: aload 33
    //   2413: astore 37
    //   2415: aload 34
    //   2417: astore 36
    ...
    //   2491: invokestatic 562	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   2494: aload 33
    //   2496: astore 37
    //   2498: aload 34
    //   2500: astore 36
    ...
    //   2620: aload 38
    //   2622: aastore
    //   2623: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   2626: aload 33
    //   2628: astore 37
    //   2630: aload 34
    //   2632: astore 36
    ...
    //   2802: lstore 12
    //   2804: aload_0
    //   2805: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    ...
    //   2869: lstore 12
    //   2871: aload_0
    //   2872: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   2875: aload_0
    ...
    //   2934: lstore 12
    //   2936: aload_0
    //   2937: getfield 61	com/tencent/mm/plugin/music/c/b:veq	Lcom/tencent/mm/ay/f;
    //   2940: getfield 321	com/tencent/mm/ay/f:hNS	Ljava/lang/String;
    //   2943: astore 39
    //   2945: aload 33
    //   2947: astore 37
    //   2949: aload 34
    ...
    //   3056: lload_2
    //   3057: lstore 12
    //   3059: invokestatic 571	com/tencent/mm/plugin/music/cache/e:dip	()Z
    //   3062: ifeq +1375 -> 4437
    //   3065: aload 33
    //   3067: astore 37
    //   3069: aload 34
    ...
    //   3253: lstore 12
    //   3255: aload 38
    //   3257: invokestatic 580	com/tencent/mm/plugin/music/c/b:anA	(Ljava/lang/String;)[J
    //   3260: astore 39
    //   3262: aload 33
    //   3264: astore 37
    //   3266: aload 34
    ...
    //   3324: lconst_0
    //   3325: invokestatic 586	com/tencent/mm/sdk/platformtools/bs:getLong	(Ljava/lang/String;J)J
    //   3328: lstore 30
    //   3330: aload 33
    //   3332: astore 37
    //   3334: aload 34
    ...
    //   3405: aastore
    //   3406: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   3409: aload 39
    ...
    //   3468: ldc 85
    //   3470: ldc_w 590
    //   3473: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   3476: lload_2
    //   3477: lstore 4
    //   3479: lload_2
    //   3480: lconst_0
    ...
    //   3578: aastore
    //   3579: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   3582: aload 33
    //   3584: astore 37
    //   3586: aload 34
    //   3588: astore 36
    ...
    //   4009: aastore
    //   4010: invokestatic 608	com/tencent/mm/sdk/platformtools/ac:v	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4013: lload 6
    //   4015: lstore 18
    //   4017: lload 6
    //   4019: lstore 16
    ...
    //   4051: lstore 10
    //   4053: aload_0
    //   4054: getfield 107	com/tencent/mm/plugin/music/c/b:qKm	Z
    //   4057: ifeq +877 -> 4934
    //   4060: lload 6
    //   4062: lstore 18
    //   4064: lload 6
    ...
    //   4098: lstore 10
    //   4100: aload_0
    //   4101: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   4104: lload 6
    //   4106: putfield 77	com/tencent/mm/plugin/music/c/a:vem	J
    //   4109: lload 6
    //   4111: lstore 18
    //   4113: lload 6
    //   4115: lstore 16
    ...
    //   4147: lstore 10
    //   4149: aload_0
    //   4150: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   4153: lload 30
    //   4155: putfield 80	com/tencent/mm/plugin/music/c/a:veo	J
    //   4158: lload 6
    //   4160: lstore_2
    //   4161: lload 6
    //   4163: ldc2_w 393
    ...
    //   4219: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   4222: lload 6
    //   4224: lstore_2
    //   4225: goto -416 -> 3809
    //   4228: astore 38
    ...
    //   4264: iconst_0
    //   4265: aload 52
    //   4267: invokevirtual 443	com/tencent/mm/vfs/e:fxV	()Landroid/net/Uri;
    //   4270: invokestatic 449	com/tencent/mm/vfs/q:B	(Landroid/net/Uri;)Ljava/lang/String;
    //   4273: aastore
    //   4274: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4277: aload 33
    //   4279: astore 37
    //   4281: aload 35
    //   4283: astore 39
    ...
    //   4296: aload_0
    //   4297: sipush 750
    //   4300: putfield 59	com/tencent/mm/plugin/music/c/b:cRY	I
    //   4303: aload 33
    //   4305: astore 37
    //   4307: aload 35
    //   4309: astore 39
    ...
    //   4322: aload_0
    //   4323: iconst_5
    //   4324: invokespecial 437	com/tencent/mm/plugin/music/c/b:JF	(I)V
    //   4327: lload 4
    //   4329: lconst_0
    //   4330: lcmp
    //   4331: ifne +1384 -> 5715
    ...
    //   4340: ldc 85
    //   4342: ldc_w 459
    //   4345: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   4348: aload 33
    //   4350: lload_2
    //   4351: invokevirtual 552	java/io/RandomAccessFile:setLength	(J)V
    //   4354: aload_0
    //   4355: lload_2
    //   4356: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   4359: lload_2
    //   4360: ldc2_w 393
    //   4363: lcmp
    //   4364: ifge +15 -> 4379
    ...
    //   4376: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   4379: aload 35
    //   4381: ifnull +8 -> 4389
    //   4384: aload 35
    ...
    //   4422: ldc 85
    //   4424: ldc_w 466
    //   4427: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   4430: ldc_w 374
    ...
    //   4491: ldc_w 612
    //   4494: ldc_w 614
    //   4497: invokestatic 93	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   4500: goto -1363 -> 3137
    //   4503: lload_2
    //   4504: lconst_0
    //   4505: lcmp
    ...
    //   4572: ldc 85
    //   4574: ldc_w 616
    //   4577: invokestatic 93	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   4580: aload 33
    //   4582: astore 37
    //   4584: aload 34
    //   4586: astore 36
    ...
    //   4634: aload_0
    //   4635: bipush 6
    //   4637: invokespecial 437	com/tencent/mm/plugin/music/c/b:JF	(I)V
    //   4640: lload 4
    //   4642: lconst_0
    //   4643: lcmp
    //   4644: ifne +115 -> 4759
    ...
    //   4653: ldc 85
    //   4655: ldc_w 459
    //   4658: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   4661: aload 33
    //   4663: lload_2
    //   4664: invokevirtual 552	java/io/RandomAccessFile:setLength	(J)V
    //   4667: aload_0
    //   4668: lload_2
    //   4669: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   4672: lload_2
    //   4673: ldc2_w 393
    //   4676: lcmp
    //   4677: ifge +15 -> 4692
    ...
    //   4689: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   4692: aload 33
    //   4694: ifnull +8 -> 4702
    //   4697: aload 33
    ...
    //   4725: ldc 85
    //   4727: ldc_w 466
    //   4730: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   4733: ldc_w 374
    ...
    //   4753: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4756: goto -89 -> 4667
    //   4759: lload 4
    //   4761: lconst_0
    //   4762: lcmp
    ...
    //   4796: aastore
    //   4797: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4800: aload_0
    //   4801: lload_2
    //   4802: lload 4
    ...
    //   4847: aastore
    //   4848: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4851: aload_0
    //   4852: lload 4
    //   4854: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   4857: lload_2
    //   4858: ldc2_w 393
    //   4861: lcmp
    //   4862: ifge -170 -> 4692
    ...
    //   4874: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   4877: goto -185 -> 4692
    //   4880: ldc 85
    //   4882: ldc_w 476
    //   4885: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   4888: goto -196 -> 4692
    //   4891: astore 33
    //   4893: ldc 85
    //   4895: aload 33
    ...
    //   4904: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   4907: goto -205 -> 4702
    //   4910: astore 33
    //   4912: ldc 85
    //   4914: aload 33
    //   4916: invokevirtual 223	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   4919: invokestatic 93	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   4922: goto -207 -> 4715
    //   4925: aload 39
    //   4927: iconst_2
    //   4928: laload
    ...
    //   4972: lstore 10
    //   4974: aload_0
    //   4975: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   4978: lload 6
    //   4980: putfield 68	com/tencent/mm/plugin/music/c/a:vek	J
    //   4983: lload 6
    //   4985: lstore 18
    //   4987: lload 6
    //   4989: lstore 16
    ...
    //   5021: lstore 10
    //   5023: aload_0
    //   5024: getfield 63	com/tencent/mm/plugin/music/c/b:ves	Lcom/tencent/mm/plugin/music/c/a;
    //   5027: lload 30
    //   5029: putfield 71	com/tencent/mm/plugin/music/c/a:vel	J
    //   5032: goto -874 -> 4158
    //   5035: astore 38
    //   5037: aload 35
    //   5039: astore 39
    ...
    //   5075: iconst_0
    //   5076: aload 52
    //   5078: invokevirtual 443	com/tencent/mm/vfs/e:fxV	()Landroid/net/Uri;
    //   5081: invokestatic 449	com/tencent/mm/vfs/q:B	(Landroid/net/Uri;)Ljava/lang/String;
    //   5084: aastore
    //   5085: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5088: aload 33
    //   5090: astore 37
    //   5092: aload 34
    //   5094: astore 36
    ...
    //   5107: aload_0
    //   5108: sipush 751
    //   5111: putfield 59	com/tencent/mm/plugin/music/c/b:cRY	I
    //   5114: aload 33
    //   5116: astore 37
    //   5118: aload 34
    //   5120: astore 36
    ...
    //   5133: aload_0
    //   5134: iconst_5
    //   5135: invokespecial 437	com/tencent/mm/plugin/music/c/b:JF	(I)V
    //   5138: lload 4
    //   5140: lconst_0
    //   5141: lcmp
    //   5142: ifne +777 -> 5919
    ...
    //   5151: ldc 85
    //   5153: ldc_w 459
    //   5156: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   5159: aload 33
    //   5161: lload_2
    //   5162: invokevirtual 552	java/io/RandomAccessFile:setLength	(J)V
    //   5165: aload_0
    //   5166: lload_2
    //   5167: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   5170: lload_2
    //   5171: ldc2_w 393
    //   5174: lcmp
    //   5175: ifge +15 -> 5190
    ...
    //   5187: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   5190: aload 39
    //   5192: ifnull +8 -> 5200
    //   5195: aload 39
    ...
    //   5233: ldc 85
    //   5235: ldc_w 466
    //   5238: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   5241: ldc_w 374
    ...
    //   5322: aastore
    //   5323: invokestatic 257	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5326: lload_2
    //   5327: lstore 18
    //   5329: lload_2
    //   5330: lstore 16
    ...
    //   5378: aastore
    //   5379: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5382: lload 4
    //   5384: lconst_0
    //   5385: lcmp
    //   5386: ifne +125 -> 5511
    ...
    //   5395: ldc 85
    //   5397: ldc_w 459
    //   5400: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   5403: aload 33
    //   5405: lload_2
    //   5406: invokevirtual 552	java/io/RandomAccessFile:setLength	(J)V
    //   5409: aload_0
    //   5410: lload_2
    //   5411: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   5414: lload_2
    //   5415: ldc2_w 393
    //   5418: lcmp
    //   5419: ifge +15 -> 5434
    ...
    //   5431: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   5434: aload 35
    //   5436: ifnull +8 -> 5444
    //   5439: aload 35
    ...
    //   5477: ldc 85
    //   5479: ldc_w 466
    //   5482: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   5485: ldc_w 374
    ...
    //   5505: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5508: goto -99 -> 5409
    //   5511: lload 4
    //   5513: lconst_0
    //   5514: lcmp
    ...
    //   5548: aastore
    //   5549: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5552: aload_0
    //   5553: lload_2
    //   5554: lload 4
    ...
    //   5599: aastore
    //   5600: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5603: aload_0
    //   5604: lload 4
    //   5606: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   5609: lload_2
    //   5610: ldc2_w 393
    //   5613: lcmp
    //   5614: ifge -180 -> 5434
    ...
    //   5626: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   5629: goto -195 -> 5434
    //   5632: ldc 85
    //   5634: ldc_w 476
    //   5637: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   5640: goto -206 -> 5434
    //   5643: astore 35
    //   5645: ldc 85
    //   5647: aload 35
    ...
    //   5656: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5659: goto -215 -> 5444
    //   5662: astore 33
    //   5664: ldc 85
    //   5666: aload 33
    ...
    //   5675: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5678: goto -224 -> 5454
    //   5681: astore 33
    //   5683: ldc 85
    //   5685: aload 33
    //   5687: invokevirtual 223	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   5690: invokestatic 93	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   5693: goto -226 -> 5467
    //   5696: astore 36
    //   5698: ldc 85
    //   5700: aload 36
    ...
    //   5709: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5712: goto -1358 -> 4354
    //   5715: lload 4
    //   5717: lconst_0
    //   5718: lcmp
    ...
    //   5752: aastore
    //   5753: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5756: aload_0
    //   5757: lload_2
    //   5758: lload 4
    ...
    //   5803: aastore
    //   5804: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5807: aload_0
    //   5808: lload 4
    //   5810: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   5813: lload_2
    //   5814: ldc2_w 393
    //   5817: lcmp
    //   5818: ifge -1439 -> 4379
    ...
    //   5830: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   5833: goto -1454 -> 4379
    //   5836: ldc 85
    //   5838: ldc_w 476
    //   5841: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   5844: goto -1465 -> 4379
    //   5847: astore 35
    //   5849: ldc 85
    //   5851: aload 35
    ...
    //   5860: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5863: goto -1474 -> 4389
    //   5866: astore 33
    //   5868: ldc 85
    //   5870: aload 33
    ...
    //   5879: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5882: goto -1483 -> 4399
    //   5885: astore 33
    //   5887: ldc 85
    //   5889: aload 33
    //   5891: invokevirtual 223	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   5894: invokestatic 93	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   5897: goto -1485 -> 4412
    //   5900: astore 35
    //   5902: ldc 85
    //   5904: aload 35
    ...
    //   5913: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5916: goto -751 -> 5165
    //   5919: lload 4
    //   5921: lconst_0
    //   5922: lcmp
    ...
    //   5956: aastore
    //   5957: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   5960: aload_0
    //   5961: lload_2
    //   5962: lload 4
    ...
    //   6007: aastore
    //   6008: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6011: aload_0
    //   6012: lload 4
    //   6014: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   6017: lload_2
    //   6018: ldc2_w 393
    //   6021: lcmp
    //   6022: ifge -832 -> 5190
    ...
    //   6034: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   6037: goto -847 -> 5190
    //   6040: ldc 85
    //   6042: ldc_w 476
    //   6045: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   6048: goto -858 -> 5190
    //   6051: astore 35
    //   6053: ldc 85
    //   6055: aload 35
    ...
    //   6064: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6067: goto -867 -> 5200
    //   6070: astore 33
    //   6072: ldc 85
    //   6074: aload 33
    ...
    //   6083: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6086: goto -876 -> 5210
    //   6089: astore 33
    //   6091: ldc 85
    //   6093: aload 33
    //   6095: invokevirtual 223	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   6098: invokestatic 93	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   6101: goto -878 -> 5223
    //   6104: astore 38
    //   6106: aconst_null
    //   6107: astore 34
    ...
    //   6148: iconst_0
    //   6149: aload 52
    //   6151: invokevirtual 443	com/tencent/mm/vfs/e:fxV	()Landroid/net/Uri;
    //   6154: invokestatic 449	com/tencent/mm/vfs/q:B	(Landroid/net/Uri;)Ljava/lang/String;
    //   6157: aastore
    //   6158: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6161: aload 33
    //   6163: astore 37
    //   6165: aload 34
    //   6167: astore 36
    ...
    //   6180: aload_0
    //   6181: sipush 752
    //   6184: putfield 59	com/tencent/mm/plugin/music/c/b:cRY	I
    //   6187: aload 33
    //   6189: astore 37
    //   6191: aload 34
    //   6193: astore 36
    ...
    //   6206: aload_0
    //   6207: iconst_5
    //   6208: invokespecial 437	com/tencent/mm/plugin/music/c/b:JF	(I)V
    //   6211: lload 4
    //   6213: lconst_0
    //   6214: lcmp
    //   6215: ifne +125 -> 6340
    ...
    //   6224: ldc 85
    //   6226: ldc_w 459
    //   6229: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   6232: aload 33
    //   6234: lload_2
    //   6235: invokevirtual 552	java/io/RandomAccessFile:setLength	(J)V
    //   6238: aload_0
    //   6239: lload_2
    //   6240: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   6243: lload_2
    //   6244: ldc2_w 393
    //   6247: lcmp
    //   6248: ifge +15 -> 6263
    ...
    //   6260: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   6263: aload 39
    //   6265: ifnull +8 -> 6273
    //   6268: aload 39
    ...
    //   6306: ldc 85
    //   6308: ldc_w 466
    //   6311: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   6314: ldc_w 374
    ...
    //   6334: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6337: goto -99 -> 6238
    //   6340: lload 4
    //   6342: lconst_0
    //   6343: lcmp
    ...
    //   6377: aastore
    //   6378: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6381: aload_0
    //   6382: lload_2
    //   6383: lload 4
    ...
    //   6428: aastore
    //   6429: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6432: aload_0
    //   6433: lload 4
    //   6435: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   6438: lload_2
    //   6439: ldc2_w 393
    //   6442: lcmp
    //   6443: ifge -180 -> 6263
    ...
    //   6455: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   6458: goto -195 -> 6263
    //   6461: ldc 85
    //   6463: ldc_w 476
    //   6466: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   6469: goto -206 -> 6263
    //   6472: astore 35
    //   6474: ldc 85
    //   6476: aload 35
    ...
    //   6485: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6488: goto -215 -> 6273
    //   6491: astore 33
    //   6493: ldc 85
    //   6495: aload 33
    ...
    //   6504: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6507: goto -224 -> 6283
    //   6510: astore 33
    //   6512: ldc 85
    //   6514: aload 33
    //   6516: invokevirtual 223	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   6519: invokestatic 93	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   6522: goto -226 -> 6296
    //   6525: astore 38
    //   6527: aconst_null
    //   6528: astore 34
    ...
    //   6569: iconst_0
    //   6570: aload 52
    //   6572: invokevirtual 443	com/tencent/mm/vfs/e:fxV	()Landroid/net/Uri;
    //   6575: invokestatic 449	com/tencent/mm/vfs/q:B	(Landroid/net/Uri;)Ljava/lang/String;
    //   6578: aastore
    //   6579: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6582: aload 33
    //   6584: astore 37
    //   6586: aload 34
    //   6588: astore 36
    ...
    //   6601: aload_0
    //   6602: sipush 753
    //   6605: putfield 59	com/tencent/mm/plugin/music/c/b:cRY	I
    //   6608: aload 33
    //   6610: astore 37
    //   6612: aload 34
    //   6614: astore 36
    ...
    //   6627: aload_0
    //   6628: iconst_5
    //   6629: invokespecial 437	com/tencent/mm/plugin/music/c/b:JF	(I)V
    //   6632: lload 4
    //   6634: lconst_0
    //   6635: lcmp
    //   6636: ifne +125 -> 6761
    ...
    //   6645: ldc 85
    //   6647: ldc_w 459
    //   6650: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   6653: aload 33
    //   6655: lload_2
    //   6656: invokevirtual 552	java/io/RandomAccessFile:setLength	(J)V
    //   6659: aload_0
    //   6660: lload_2
    //   6661: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   6664: lload_2
    //   6665: ldc2_w 393
    //   6668: lcmp
    //   6669: ifge +15 -> 6684
    ...
    //   6681: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   6684: aload 39
    //   6686: ifnull +8 -> 6694
    //   6689: aload 39
    ...
    //   6727: ldc 85
    //   6729: ldc_w 466
    //   6732: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   6735: ldc_w 374
    ...
    //   6755: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6758: goto -99 -> 6659
    //   6761: lload 4
    //   6763: lconst_0
    //   6764: lcmp
    ...
    //   6798: aastore
    //   6799: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6802: aload_0
    //   6803: lload_2
    //   6804: lload 4
    ...
    //   6849: aastore
    //   6850: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6853: aload_0
    //   6854: lload 4
    //   6856: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   6859: lload_2
    //   6860: ldc2_w 393
    //   6863: lcmp
    //   6864: ifge -180 -> 6684
    ...
    //   6876: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   6879: goto -195 -> 6684
    //   6882: ldc 85
    //   6884: ldc_w 476
    //   6887: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   6890: goto -206 -> 6684
    //   6893: astore 35
    //   6895: ldc 85
    //   6897: aload 35
    ...
    //   6906: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6909: goto -215 -> 6694
    //   6912: astore 33
    //   6914: ldc 85
    //   6916: aload 33
    ...
    //   6925: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   6928: goto -224 -> 6704
    //   6931: astore 33
    //   6933: ldc 85
    //   6935: aload 33
    //   6937: invokevirtual 223	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   6940: invokestatic 93	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   6943: goto -226 -> 6717
    //   6946: astore 40
    //   6948: aconst_null
    //   6949: astore 33
    ...
    //   6990: iconst_0
    //   6991: aload 52
    //   6993: invokevirtual 443	com/tencent/mm/vfs/e:fxV	()Landroid/net/Uri;
    //   6996: invokestatic 449	com/tencent/mm/vfs/q:B	(Landroid/net/Uri;)Ljava/lang/String;
    //   6999: aastore
    //   7000: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7003: aload 38
    //   7005: astore 37
    //   7007: aload 33
    //   7009: astore 36
    ...
    //   7022: aload_0
    //   7023: sipush 754
    //   7026: putfield 59	com/tencent/mm/plugin/music/c/b:cRY	I
    //   7029: aload 38
    //   7031: astore 37
    //   7033: aload 33
    //   7035: astore 36
    ...
    //   7048: aload_0
    //   7049: iconst_5
    //   7050: invokespecial 437	com/tencent/mm/plugin/music/c/b:JF	(I)V
    //   7053: lload 4
    //   7055: lconst_0
    //   7056: lcmp
    //   7057: ifne +125 -> 7182
    ...
    //   7066: ldc 85
    //   7068: ldc_w 459
    //   7071: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   7074: aload 38
    //   7076: lload_2
    //   7077: invokevirtual 552	java/io/RandomAccessFile:setLength	(J)V
    //   7080: aload_0
    //   7081: lload_2
    //   7082: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   7085: lload_2
    //   7086: ldc2_w 393
    //   7089: lcmp
    //   7090: ifge +15 -> 7105
    ...
    //   7097: aload_0
    //   7098: iconst_1
    //   7099: invokespecial 307	com/tencent/mm/plugin/music/c/b$a:<init>	(Lcom/tencent/mm/plugin/music/c/b;I)V
    //   7102: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   7105: aload 39
    //   7107: ifnull +8 -> 7115
    //   7110: aload 39
    //   7112: invokevirtual 139	java/io/InputStream:close	()V
    //   7115: aload 38
    //   7117: ifnull +8 -> 7125
    //   7120: aload 38
    //   7122: invokevirtual 553	java/io/RandomAccessFile:close	()V
    //   7125: aload 33
    //   7127: ifnull +16 -> 7143
    //   7130: aload 33
    //   7132: invokevirtual 134	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   7135: invokevirtual 139	java/io/InputStream:close	()V
    //   7138: aload 33
    //   7140: invokevirtual 142	java/net/HttpURLConnection:disconnect	()V
    //   7143: aload_0
    //   7144: iconst_1
    //   7145: putfield 51	com/tencent/mm/plugin/music/c/b:isStop	Z
    //   7148: ldc 85
    //   7150: ldc_w 466
    //   7153: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   7156: ldc_w 374
    ...
    //   7176: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7179: goto -99 -> 7080
    //   7182: lload 4
    //   7184: lconst_0
    //   7185: lcmp
    ...
    //   7206: iconst_0
    //   7207: lload 4
    //   7209: invokestatic 423	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   7212: aastore
    //   7213: dup
    //   7214: iconst_1
    //   7215: lload_2
    //   7216: invokestatic 423	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   7219: aastore
    //   7220: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7223: aload_0
    //   7224: lload_2
    //   7225: lload 4
    //   7227: invokespecial 472	com/tencent/mm/plugin/music/c/b:Y	(JJ)V
    //   7230: goto -125 -> 7105
    //   7233: lload 4
    //   7235: lconst_0
    //   7236: lcmp
    ...
    //   7257: iconst_0
    //   7258: lload 4
    //   7260: invokestatic 423	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   7263: aastore
    //   7264: dup
    //   7265: iconst_1
    //   7266: lload_2
    //   7267: invokestatic 423	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   7270: aastore
    //   7271: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7274: aload_0
    //   7275: lload 4
    //   7277: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   7280: lload_2
    //   7281: ldc2_w 393
    //   7284: lcmp
    //   7285: ifge -180 -> 7105
    ...
    //   7292: aload_0
    //   7293: iconst_1
    //   7294: invokespecial 307	com/tencent/mm/plugin/music/c/b$a:<init>	(Lcom/tencent/mm/plugin/music/c/b;I)V
    //   7297: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   7300: goto -195 -> 7105
    //   7303: ldc 85
    //   7305: ldc_w 476
    //   7308: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   7311: goto -206 -> 7105
    //   7314: astore 34
    //   7316: ldc 85
    //   7318: aload 34
    ...
    //   7327: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7330: goto -215 -> 7115
    //   7333: astore 34
    //   7335: ldc 85
    //   7337: aload 34
    ...
    //   7346: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7349: goto -224 -> 7125
    //   7352: astore 34
    //   7354: ldc 85
    //   7356: aload 34
    //   7358: invokevirtual 223	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   7361: invokestatic 93	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   7364: goto -226 -> 7138
    //   7367: astore 33
    //   7369: aconst_null
    //   7370: astore 36
    ...
    //   7393: ldc 85
    //   7395: ldc_w 459
    //   7398: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   7401: aload 37
    //   7403: lload_2
    //   7404: invokevirtual 552	java/io/RandomAccessFile:setLength	(J)V
    //   7407: aload_0
    //   7408: lload_2
    //   7409: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   7412: lload_2
    //   7413: ldc2_w 393
    //   7416: lcmp
    //   7417: ifge +15 -> 7432
    ...
    //   7429: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   7432: aload 35
    //   7434: ifnull +8 -> 7442
    //   7437: aload 35
    ...
    //   7475: ldc 85
    //   7477: ldc_w 466
    //   7480: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   7483: ldc_w 374
    ...
    //   7505: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7508: goto -101 -> 7407
    //   7511: lload 4
    //   7513: lconst_0
    //   7514: lcmp
    ...
    //   7548: aastore
    //   7549: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7552: aload_0
    //   7553: lload_2
    //   7554: lload 4
    ...
    //   7599: aastore
    //   7600: invokestatic 147	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7603: aload_0
    //   7604: lload 4
    //   7606: invokespecial 464	com/tencent/mm/plugin/music/c/b:wb	(J)V
    //   7609: lload_2
    //   7610: ldc2_w 393
    //   7613: lcmp
    //   7614: ifge -182 -> 7432
    ...
    //   7626: invokestatic 313	com/tencent/mm/sdk/platformtools/ap:f	(Ljava/lang/Runnable;)V
    //   7629: goto -197 -> 7432
    //   7632: ldc 85
    //   7634: ldc_w 476
    //   7637: invokestatic 114	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   7640: goto -208 -> 7432
    //   7643: astore 34
    //   7645: ldc 85
    //   7647: aload 34
    ...
    //   7656: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7659: goto -217 -> 7442
    //   7662: astore 34
    //   7664: ldc 85
    //   7666: aload 34
    ...
    //   7675: invokestatic 453	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   7678: goto -226 -> 7452
    //   7681: astore 34
    //   7683: ldc 85
    //   7685: aload 34
    //   7687: invokevirtual 223	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   7690: invokestatic 93	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   7693: goto -228 -> 7465
    //   7696: astore 33
    //   7698: lload 8
    //   7700: lstore 4
    ...
    //   125	7758	6	l3	long
    //   235	7484	8	l4	long
    //   1761	6054	10	l5	long
    //   1782	6133	12	l6	long
    //   1775	6072	14	l7	long
    //   1768	6035	16	l8	long
    //   1754	5985	18	l9	long
    //   1758	6013	20	l10	long
    //   1779	6132	22	l11	long
    //   1765	6034	24	l12	long
    //   1751	5984	26	l13	long
    ...
    //   904	131	33	localObject2	Object
    //   1130	160	33	localIOException2	java.io.IOException
    ...
    //   6536	164	33	localObject4	Object
    //   6912	5	33	localIOException9	java.io.IOException
    //   6931	5	33	localException7	Exception
    //   6949	190	33	localObject5	Object
    //   7367	123	33	localObject6	Object
    //   7696	1	33	localObject7	Object
    //   7708	19	33	localObject8	Object
    //   7732	135	33	localObject9	Object
    //   24	6932	34	localObject10	Object
    //   7163	5	34	localIOException10	java.io.IOException
    //   7314	5	34	localIOException11	java.io.IOException
    //   7333	5	34	localIOException12	java.io.IOException
    //   7352	5	34	localException8	Exception
    ...
    //   7681	74	34	localException9	Exception
    ...
    //   6555	71	35	localObject16	Object
    //   6742	5	35	localIOException24	java.io.IOException
    //   6893	5	35	localIOException25	java.io.IOException
    //   6976	933	35	localObject17	Object
    ...
    //   920	6528	37	localObject20	Object
    ...
    //   6525	35	38	localIOException28	java.io.IOException
    //   6957	796	38	localObject22	Object
    //   7768	1	38	localIOException29	java.io.IOException
    //   7784	1	38	localIOException30	java.io.IOException
    ...
    //   936	6916	39	localObject23	Object
    //   183	1544	40	localObject24	Object
    //   6946	35	40	localException10	Exception
    //   7724	1	40	localException11	Exception
    //   7748	1	40	localException12	Exception
    //   883	6923	41	localObject25	Object
    //   886	6892	42	localObject26	Object
    //   889	6853	43	localObject27	Object
    //   898	6952	44	localObject28	Object
    //   895	3701	45	localObject29	Object
    //   892	6481	46	localObject30	Object
    //   907	813	47	localHashMap	java.util.HashMap
    //   901	385	48	localObject31	Object
    //   916	366	49	localObject32	Object
    //   913	389	50	localObject33	Object
    //   910	388	51	localObject34	Object
    //   232	6760	52	locale	com.tencent.mm.vfs.e
    // Exception table:
    //   from	to	target	type
    ...
    //   1784	1790	7768	java/io/IOException
    //   1858	1862	7768	java/io/IOException
    //   1916	1935	7768	java/io/IOException
    //   1989	1994	7768	java/io/IOException
    //   2048	2053	7768	java/io/IOException
    //   2392	2411	7768	java/io/IOException
    //   2465	2494	7768	java/io/IOException
    //   2548	2555	7768	java/io/IOException
    //   2609	2626	7768	java/io/IOException
    //   2680	2686	7768	java/io/IOException
    //   2740	2750	7768	java/io/IOException
    //   2804	2817	7768	java/io/IOException
    //   2871	2882	7768	java/io/IOException
    //   2936	2945	7768	java/io/IOException
    //   2999	3005	7768	java/io/IOException
    //   3059	3065	7768	java/io/IOException
    //   3119	3137	7768	java/io/IOException
    //   3191	3201	7768	java/io/IOException
    //   3255	3262	7768	java/io/IOException
    //   3316	3330	7768	java/io/IOException
    //   3384	3409	7768	java/io/IOException
    //   3468	3476	7768	java/io/IOException
    //   3545	3582	7768	java/io/IOException
    //   3636	3643	7768	java/io/IOException
    //   3697	3703	7768	java/io/IOException
    //   3757	3764	7768	java/io/IOException
    //   4491	4500	7768	java/io/IOException
    //   4572	4580	7768	java/io/IOException
    //   4634	4640	7768	java/io/IOException
    //   3802	3809	7784	java/io/IOException
    //   3843	3850	7784	java/io/IOException
    //   3884	3892	7784	java/io/IOException
    //   3930	3939	7784	java/io/IOException
    //   3985	4013	7784	java/io/IOException
    //   4053	4060	7784	java/io/IOException
    //   4100	4109	7784	java/io/IOException
    //   4149	4158	7784	java/io/IOException
    //   4210	4222	7784	java/io/IOException
    //   4974	4983	7784	java/io/IOException
    //   5023	5032	7784	java/io/IOException
    //   5282	5326	7784	java/io/IOException
    //   5360	5382	7784	java/io/IOException
