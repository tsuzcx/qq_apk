package com.tencent.mm.plugin.music.e.b;
...
public final class a
{
    ...
    if (i < paramMetadata.cXu.length)
    {
      ...
      for (;;)
      {
        ...
        else if ((localObject instanceof PrivFrame))
        {
          ...
          Log.d("MicroMsg.ExoPlayer", paramString + String.format("%s: owner=%s", new Object[] { ((PrivFrame)localObject).id, ((PrivFrame)localObject).cXV }));
        }
        ...
        else if ((localObject instanceof EventMessage))
        {
          ...
          Log.d("MicroMsg.ExoPlayer", paramString + String.format("EMSG: scheme=%s, id=%d, value=%s", new Object[] { ((EventMessage)localObject).cXF, Long.valueOf(((EventMessage)localObject).id), ((EventMessage)localObject).value }));
        }
      }
    }
  ...
  public static String adL(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  public static String jM(long paramLong)
  {
 ...
 * Qualified Name:     com.tencent.mm.plugin.music.e.b.a
