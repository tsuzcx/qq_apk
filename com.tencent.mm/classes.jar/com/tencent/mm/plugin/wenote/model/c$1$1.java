  ...
  public final void bo(List<BallInfo> paramList)
  {
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((localBallInfo.type == 3) && (localBallInfo.hsl.getInt("eventType") == 1) && (localBallInfo.key != null) && (localBallInfo.key.startsWith(this.oeT)))
        {
          ((c)g.ab(c.class)).k(localBallInfo);
