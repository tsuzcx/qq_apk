...
public class c
{
  private static volatile c QHu = null;
  public com.tencent.mm.plugin.wenote.model.nativenote.b.a QHv = null;
  public boolean QHw = false;
  ...
  private void a(com.tencent.mm.plugin.wenote.model.a.c paramc, boolean paramBoolean)
  {
    ...
    if (paramc.getType() == 1)
    {
      int i = com.tencent.mm.plugin.wenote.d.c.atC(((i)paramc).content);
      if (paramBoolean)
      {
        this.usy = (i + this.usy);
        AppMethodBeat.o(30441);
  ...
  private void b(com.tencent.mm.plugin.wenote.model.a.c paramc)
  {
    ...
    if (localo.getType() > 1)
    {
      ...
      locald = com.tencent.mm.plugin.wenote.model.c.hdm().QGd;
      if (locald != null) {
        break label105;
      }
    ...
    for (;;)
    {
      if (Util.isNullOrNil(paramc.fEa)) {
        paramc.fEa = com.tencent.mm.plugin.wenote.model.f.atK(paramc.toString());
      }
      AppMethodBeat.o(30437);
      return;
      label105:
      if (locald.QGk == null) {
        ...
        locald.QGk.put(localo.urT, localo);
      }
    }
  }
  ...
  private String cSa()
  {
    ...
    if ((this.usx == 0) && (this.mDataList != null))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (localo.urT.startsWith("WeNote_"))
        {
          i = Util.getInt(localo.urT.substring(7), -1);
          if (i > this.usx) {}
          for (;;)
          {
            this.usx = i;
  ...
  public final boolean U(ArrayList<com.tencent.mm.plugin.wenote.model.a.c> paramArrayList)
  {
    ...
    boolean bool = fT(com.tencent.mm.plugin.wenote.d.c.atC(localStringBuilder.toString()), i);
  ...
  public final int a(ArrayList<com.tencent.mm.plugin.wenote.model.a.c> paramArrayList, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    ((com.tencent.mm.plugin.wenote.model.a.c)localObject1).urI = -1;
    ((com.tencent.mm.plugin.wenote.model.a.c)localObject1).urG = true;
    ((com.tencent.mm.plugin.wenote.model.a.c)localObject1).urM = false;
    Object localObject3 = aph(paramInt2);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject2 = com.tencent.mm.plugin.wenote.model.nativenote.a.a.atL(((i)localObject3).content);
        ...
        if (!Util.isNullOrNil((String)localObject2))
        {
          ...
          ((i)localObject3).content = ((String)localObject2);
          ((i)localObject3).urI = 0;
          ((i)localObject3).urG = false;
          ((i)localObject3).urM = false;
        ...
        if ((j - 1 >= 0) && (j - 1 < hdz().size()))
        {
          ...
          if (this.QHv != null)
          {
            ...
            if ((i >= 0) && (paramInt2 > 0)) {
              this.QHv.fQ(i, paramInt2);
            }
            if (i <= 0) {
              break label840;
            }
            this.QHv.fR(i - 1, hdz().size() - (i - 1));
            this.QHv.Jb(paramInt1);
          }
          cSd();
          AppMethodBeat.o(30436);
          return paramInt1;
      ...
      paramInt1 = hdz().size() - 1;
      continue;
      label840:
      if (i == 0)
      {
        this.QHv.fR(i, hdz().size() - i);
        continue;
        label868:
        break label908;
        label876:
  ...
  public final int a(ArrayList<com.tencent.mm.plugin.wenote.model.a.c> paramArrayList, WXRTEditText paramWXRTEditText, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    if ((paramBoolean2) && (U(paramArrayList)) && (this.QHv != null))
    {
      this.QHv.cRc();
      AppMethodBeat.o(30435);
      return -1;
    ...
    if (paramBoolean1)
    {
      ...
      if ((paramWXRTEditText != null) && (paramWXRTEditText.utx))
      {
        ...
        ((com.tencent.mm.plugin.wenote.model.a.c)localObject1).urP = 2;
      }
    }
    label194:
    int n;
    ...
    for (;;)
    {
      ...
      ((com.tencent.mm.plugin.wenote.model.a.c)localObject1).urQ = paramWXRTEditText.urQ;
      ...
      try
      {
        ...
        for (;;)
        {
          if (paramArrayList.hasNext())
          {
            ...
            ((com.tencent.mm.plugin.wenote.model.a.c)localObject1).urP = 1;
            break;
    ...
    if ((paramWXRTEditText.getEditTextType() == 0) && (((com.tencent.mm.plugin.wenote.model.a.c)localObject2).getType() == 1))
    {
      ...
      paramWXRTEditText = ((Editable)localObject3).subSequence(0, ((e)localObject1).tH);
      localObject3 = ((Editable)localObject3).subSequence(((e)localObject1).tI, ((Editable)localObject3).length());
  ...
  public final void a(String paramString, com.tencent.mm.plugin.wenote.model.a.c paramc)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          if (!((com.tencent.mm.plugin.wenote.model.a.c)this.mDataList.get(i)).hdt().equals(paramString)) {
            continue;
          }
          a((com.tencent.mm.plugin.wenote.model.a.c)this.mDataList.get(i), false);
          this.mDataList.set(i, paramc);
          a(paramc, true);
          if ((i != -1) && (this.QHv != null)) {
            this.QHv.IY(i);
          }
  ...
  public final boolean a(int paramInt, com.tencent.mm.plugin.wenote.model.a.c paramc)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.mDataList.add(paramInt, paramc);
        a(paramc, true);
        if ((bool) && (this.QHv != null))
        {
          this.QHv.IZ(paramInt);
          if (paramInt > 0) {
            this.QHv.fR(paramInt - 1, this.mDataList.size() - (paramInt - 1));
          }
        }
        else
        {
      ...
      this.QHv.fR(paramInt, this.mDataList.size() - paramInt);
      continue;
      label138:
      bool = false;
    }
  ...
  public final boolean ae(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((bool1) && (paramBoolean) && (this.QHv != null))
        {
          this.QHv.Ja(paramInt);
          if (paramInt > 0) {
            this.QHv.fR(paramInt - 1, this.mDataList.size() - (paramInt - 1));
          }
        }
  ...
  public final void af(int paramInt, boolean paramBoolean)
  {
    ...
    //   52: ifnull +33 -> 85
    //   55: aload_3
    //   56: getfield 421	com/tencent/mm/plugin/wenote/model/a/c:urN	Z
    //   59: iload_2
    //   60: if_icmpeq +25 -> 85
    //   63: aload_3
    //   64: iload_2
    //   65: putfield 421	com/tencent/mm/plugin/wenote/model/a/c:urN	Z
    //   68: aload_0
    //   69: getfield 37	com/tencent/mm/plugin/wenote/model/nativenote/manager/c:QHv	Lcom/tencent/mm/plugin/wenote/model/nativenote/b/a;
    //   72: ifnull +13 -> 85
    //   75: aload_0
    //   76: getfield 37	com/tencent/mm/plugin/wenote/model/nativenote/manager/c:QHv	Lcom/tencent/mm/plugin/wenote/model/nativenote/b/a;
    //   79: iload_1
    ...
    //   125: ifnull +33 -> 158
    //   128: aload_3
    //   129: getfield 421	com/tencent/mm/plugin/wenote/model/a/c:urN	Z
    //   132: iload_2
    //   133: if_icmpeq +25 -> 158
    //   136: aload_3
    //   137: iload_2
    //   138: putfield 421	com/tencent/mm/plugin/wenote/model/a/c:urN	Z
    //   141: aload_0
    //   142: getfield 37	com/tencent/mm/plugin/wenote/model/nativenote/manager/c:QHv	Lcom/tencent/mm/plugin/wenote/model/nativenote/b/a;
    //   145: ifnull +13 -> 158
    //   148: aload_0
    //   149: getfield 37	com/tencent/mm/plugin/wenote/model/nativenote/manager/c:QHv	Lcom/tencent/mm/plugin/wenote/model/nativenote/b/a;
    //   152: iload_1
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < this.mDataList.size()) {
          if (i == paramInt)
          {
            ((com.tencent.mm.plugin.wenote.model.a.c)this.mDataList.get(i)).urG = true;
            ((com.tencent.mm.plugin.wenote.model.a.c)this.mDataList.get(i)).urM = paramBoolean;
          }
          else
          {
            ((com.tencent.mm.plugin.wenote.model.a.c)this.mDataList.get(i)).urG = false;
            ((com.tencent.mm.plugin.wenote.model.a.c)this.mDataList.get(i)).urM = false;
          }
        }
      }
      finally
  ...
  public final com.tencent.mm.plugin.wenote.model.a.c aph(int paramInt)
  {
  ...
  public final aoc atO(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (Util.isNullOrNil(((com.tencent.mm.plugin.wenote.model.a.c)localObject1).fEa)) {
          ((com.tencent.mm.plugin.wenote.model.a.c)localObject1).fEa = com.tencent.mm.plugin.wenote.model.f.atK(localObject1.toString());
        }
        if (((com.tencent.mm.plugin.wenote.model.a.c)localObject1).getType() == -1) {
          ...
          else
          {
            localObject2 = new i();
            ((i)localObject2).content = "\n";
            ((i)localObject2).fEa = ((com.tencent.mm.plugin.wenote.model.a.c)localObject1).fEa;
            ((i)localObject2).urT = "-1";
            ((i)localObject2).type = 1;
            ((i)localObject2).urS = null;
      ...
      if (((com.tencent.mm.plugin.wenote.model.a.c)localObject1).getType() >= -1)
      {
        if (((((com.tencent.mm.plugin.wenote.model.a.c)localObject1).getType() == 6) || (((com.tencent.mm.plugin.wenote.model.a.c)localObject1).getType() == 4)) && (Util.isNullOrNil(((o)localObject1).fNU)))
        {
          localObject2 = new anm();
          ((anm)localObject2).bsK(((com.tencent.mm.plugin.wenote.model.a.c)localObject1).fEa);
          ((anm)localObject2).bsH(((com.tencent.mm.plugin.wenote.model.a.c)localObject1).cRL());
          localObject2 = com.tencent.mm.plugin.wenote.model.f.b((anm)localObject2);
          if (u.agG((String)localObject2))
          {
            ...
            ((o)localObject1).fNU = ((String)localObject2);
          }
        }
        if (((com.tencent.mm.plugin.wenote.model.a.c)localObject1).getType() != 1)
        {
        ...
        else
        {
          ...
          if (Util.isNullOrNil(((i)localObject1).content))
          {
            ...
            else
            {
              localObject2 = new i();
              ((i)localObject2).content = "<br/>";
              ((i)localObject2).fEa = ((i)localObject1).fEa;
              ((i)localObject2).urT = ((i)localObject1).urT;
          ...
          else
          {
            ...
            while ((i + 1 < this.mDataList.size()) && (((com.tencent.mm.plugin.wenote.model.a.c)this.mDataList.get(i + 1)).getType() == 1) && (!Util.isNullOrNil(((i)this.mDataList.get(i + 1)).content)))
            {
              ...
              catch (UnsupportedEncodingException paramString)
              {
                for (;;)
                {
                  try
                  {
                    ...
                    paramString = com.tencent.mm.plugin.wenote.model.d.a((String)localObject1, localArrayList, this.usw);
                    AppMethodBeat.o(30433);
                    return paramString;
                  }
              ...
              this.usw.Ey(true);
              this.usw.bsH(".htm");
              this.usw.bsK(com.tencent.mm.plugin.wenote.model.f.atK(this.usw.toString()));
              localObject2 = com.tencent.mm.plugin.wenote.model.f.b(this.usw);
  ...
  public final boolean b(int paramInt, ArrayList<com.tencent.mm.plugin.wenote.model.a.c> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      if ((bool) && (this.QHv != null)) {
        this.QHv.fQ(i - paramInt, paramInt);
      }
      AppMethodBeat.o(30414);
      return bool;
      label174:
  ...
  public final void bnU(String paramString)
  {
    ...
    Object localObject = com.tencent.mm.plugin.wenote.d.b.atG(paramString);
    if ((localObject != null) && (((ArrayList)localObject).size() > 0)) {
      for (;;)
      {
        try
        {
          Log.i("MicroMsg.Note.NoteDataManager", "updateDataByHtml, mHasInitDataListFinish :％B", new Object[] { Boolean.valueOf(this.QHw) });
          paramString = bh.aHJ();
          localObject = new Runnable()
          {
            public final void run()
            {
              ...
              ArrayList localArrayList = h.a(c.d(c.this), this.QHy, false);
  ...
  public final String bnV(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject = com.tencent.mm.plugin.wenote.d.b.atH(((i)this.mDataList.get(i)).content).replace("&lt;", "<").replace("&gt;", ">").replace(" ", " ");
    ...
    for (;;)
    {
      try
      {
        if (this.mDataList != null)
        {
          ...
          if (i < this.mDataList.size())
          {
            if (((com.tencent.mm.plugin.wenote.model.a.c)this.mDataList.get(i)).urG) {
              return i;
            }
            i += 1;
            continue;
    ...
    for (;;)
    {
      try
      {
        if (this.mDataList != null)
        {
          ...
          if (i < this.mDataList.size())
          {
            if ((((com.tencent.mm.plugin.wenote.model.a.c)this.mDataList.get(i)).getType() == 4) && (((l)this.mDataList.get(i)).usd.booleanValue())) {
              return i;
            }
            i += 1;
            continue;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        case 2: 
          ...
          localObject1 = (String)localObject1 + ds(((com.tencent.mm.plugin.wenote.model.a.f)localObject3).urT, 2);
          break;
        case 6: 
          localObject3 = (k)localObject3;
          localObject1 = (String)localObject1 + ds(((k)localObject3).urT, 6);
          break;
        case 20: 
          localObject3 = (com.tencent.mm.plugin.wenote.model.a.b)localObject3;
          localObject1 = (String)localObject1 + ds(((com.tencent.mm.plugin.wenote.model.a.b)localObject3).urT, 20);
          break;
        case 4: 
          localObject3 = (l)localObject3;
          localObject1 = (String)localObject1 + ds(((l)localObject3).urT, ((l)localObject3).getType());
          break;
        case 3: 
          localObject3 = (g)localObject3;
          localObject1 = (String)localObject1 + ds(((g)localObject3).urT, 3);
          break;
        case 5: 
          localObject3 = (com.tencent.mm.plugin.wenote.model.a.d)localObject3;
          localObject1 = (String)localObject1 + ds(((com.tencent.mm.plugin.wenote.model.a.d)localObject3).urT, 5);
          break;
        case -1: 
  ...
  public final ArrayList<com.tencent.mm.plugin.wenote.model.a.c> cSc()
  {
    ...
    try
    {
      Iterator localIterator = this.mDataList.iterator();
      while (localIterator.hasNext()) {
        localArrayList.add(com.tencent.mm.plugin.wenote.d.c.c((com.tencent.mm.plugin.wenote.model.a.c)localIterator.next()));
      }
    }
    finally
    {
  ...
  public final void cSd()
  {
    ...
    bh.aHJ().postToWorker(new Runnable()
    {
      public final void run()
      {
        ...
        c.a(c.this, com.tencent.mm.plugin.wenote.d.c.atC(localObject.toString()));
        c.b(c.this, i);
        AppMethodBeat.o(30409);
      }
    });
  ...
  public final void fU(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Spanned localSpanned1 = com.tencent.mm.plugin.wenote.model.nativenote.a.a.atL(((i)localObject1).content);
        localSpanned2 = com.tencent.mm.plugin.wenote.model.nativenote.a.a.atL(((i)localObject3).content);
        ((i)localObject3).content = (((i)localObject3).content + "<br/>" + ((i)localObject1).content);
        if (((i)localObject1).urG)
        {
          ((i)localObject3).urG = true;
          ((i)localObject3).urM = false;
          if ((((i)localObject1).urI == -1) || (((i)localObject1).urI >= localSpanned1.length()))
          {
            ((i)localObject3).urI = -1;
          ...
          ((i)localObject1).urI += i + 1;
          continue;
        }
        if (!((i)localObject3).urG) {
          continue;
        }
      }
      finally
      ...
      if (((i)localObject3).urI == -1)
      {
        ((i)localObject3).urI = localSpanned2.length();
        continue;
        label414:
        if (localObject2.urG)
        {
          ...
          continue;
          label443:
          if ((paramInt1 != -1) && (this.QHv != null)) {
            this.QHv.fR(paramInt1, this.mDataList.size() - paramInt1);
          }
          cSd();
          AppMethodBeat.o(30442);
          return;
