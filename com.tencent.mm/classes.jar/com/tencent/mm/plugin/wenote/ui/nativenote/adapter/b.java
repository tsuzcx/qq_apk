  ...
  extends RecyclerView.a<a>
{
  ...
  private void a(a parama, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        com.tencent.mm.plugin.wenote.model.a.c localc = com.tencent.mm.plugin.wenote.model.nativenote.manager.c.eIb().Wh(paramInt);
        if ((localc != null) && (localc.getType() == parama.bZp()))
        {
        ...
        if (localc == null)
        {
          ac.e("MicroMsg.Note.NoteRecyclerViewAdapter", "onBindViewHolder, item is null %b, position is %d", new Object[] { Boolean.valueOf(bool), Integer.valueOf(paramInt) });
          AppMethodBeat.o(30842);
        }
        else
        {
  ...
  public final int getItemCount()
  {
    ...
    if (this.CYA)
    {
      i = com.tencent.mm.plugin.wenote.model.nativenote.manager.c.eIb().size();
  ...
  public final int getItemViewType(int paramInt)
  {
    ...
    if ((this.CYA) && (paramInt == com.tencent.mm.plugin.wenote.model.nativenote.manager.c.eIb().size()))
    {
      AppMethodBeat.o(30843);
      return 30;
    }
    ac.e("MicroMsg.Note.NoteRecyclerViewAdapter", "getItemViewType, item is null, position is %d", new Object[] { Integer.valueOf(paramInt) });
    AppMethodBeat.o(30843);
    return 0;
  }
}
