...
{
  public static HashMap<String, String> QIJ;
  public static HashMap<String, r> QIK;
  public static c QIL;
  private static com.tencent.mm.b.f<String, Integer> upu;
  ...
  static
  {
    ...
    QIK = new HashMap();
    QIL = null;
    upu = new com.tencent.mm.memory.a.c(30);
  ...
  public static String a(Context paramContext, com.tencent.mm.plugin.wenote.model.a.c paramc)
  {
    ...
    if (i == 3)
    {
      paramContext = paramContext.getString(R.l.eVZ);
      AppMethodBeat.o(30685);
      return paramContext;
    }
    if (i == 2)
    {
      paramContext = paramContext.getString(R.l.eVY);
      AppMethodBeat.o(30685);
      return paramContext;
    }
    if (i == 6)
    {
      paramContext = paramContext.getString(R.l.eWa);
      AppMethodBeat.o(30685);
      return paramContext;
    }
    if (i == 4)
    {
      paramContext = paramContext.getString(R.l.eWb);
      AppMethodBeat.o(30685);
      return paramContext;
    }
    if (i == 5)
    {
      paramContext = paramContext.getString(R.l.eVX);
      AppMethodBeat.o(30685);
      return paramContext;
    }
    AppMethodBeat.o(30685);
  ...
  public static com.tencent.mm.plugin.wenote.model.a.c c(com.tencent.mm.plugin.wenote.model.a.c paramc)
  {
    ...
    while (localObject1 == null)
    {
      ...
      ((com.tencent.mm.plugin.wenote.model.a.g)localObject2).QHt = ((com.tencent.mm.plugin.wenote.model.a.g)localObject3).QHt;
      ((com.tencent.mm.plugin.wenote.model.a.g)localObject2).lLg = ((com.tencent.mm.plugin.wenote.model.a.g)localObject3).lLg;
      ...
      ((com.tencent.mm.plugin.wenote.model.a.f)localObject1).urR = ((com.tencent.mm.plugin.wenote.model.a.f)paramc).urR;
      continue;
      localObject1 = new k();
      ...
      ((k)localObject2).urV = ((k)localObject3).urV;
      continue;
      localObject1 = new l();
      localObject2 = (l)localObject1;
      localObject3 = (l)paramc;
      ((l)localObject2).urY = ((l)localObject3).urY;
      ((l)localObject2).length = ((l)localObject3).length;
      ((l)localObject2).urX = ((l)localObject3).urX;
      ((l)localObject2).oYm = ((l)localObject3).oYm;
      ((l)localObject2).fEj = ((l)localObject3).fEj;
      ((l)localObject2).fEi = ((l)localObject3).fEi;
      ...
      ((d)localObject2).oYm = ((d)localObject3).oYm;
      ((d)localObject2).urV = ((d)localObject3).urV;
      continue;
      localObject1 = new h();
    }
    ((o)localObject1).type = ((o)paramc).type;
    ((o)localObject1).urU = ((o)paramc).urU;
    ((o)localObject1).fNU = ((o)paramc).fNU;
    AppMethodBeat.o(30678);
    return localObject1;
  }
  ...
  public static String d(com.tencent.mm.plugin.wenote.model.a.c paramc)
  {
    ...
    if (paramc.getType() == 2)
    {
      paramc = ((com.tencent.mm.plugin.wenote.model.a.f)paramc).urR;
      AppMethodBeat.o(30679);
      return paramc;
    }
    paramc = ((o)paramc).fNU;
  ...
  public static String e(com.tencent.mm.plugin.wenote.model.a.c paramc)
  {
    ...
    if (paramc.getType() == 2)
    {
      paramc = ((com.tencent.mm.plugin.wenote.model.a.f)paramc).fNU;
      AppMethodBeat.o(30680);
      return paramc;
    }
    if (paramc.getType() == 6)
 ...
 * Qualified Name:     com.tencent.mm.plugin.wenote.d.c
