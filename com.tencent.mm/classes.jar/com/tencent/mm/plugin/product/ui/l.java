  ...
  extends BaseAdapter
{
  ...
  private n.a Jd(int paramInt)
  {
    AppMethodBeat.i(67041);
    n.a locala = (n.a)this.uyv.get(paramInt);
  ...
  public final View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject = Jd(paramInt);
    if ((paramView == null) || (paramView.getTag() == null))
    {
      ...
      paramViewGroup.fxT = ((ImageView)paramView.findViewById(2131302109));
      paramView.setTag(paramViewGroup);
    }
    for (;;)
    {
      paramViewGroup.uyw = ((n.a)localObject);
      paramViewGroup.titleTv.setText(((n.a)localObject).title);
      localObject = u.a(new c(((n.a)localObject).iconUrl));
      paramViewGroup.fxT.setImageBitmap((Bitmap)localObject);
      u.a(paramViewGroup);
