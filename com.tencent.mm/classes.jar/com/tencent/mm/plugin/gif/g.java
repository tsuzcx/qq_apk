  ...
  implements a
{
  ...
  public final boolean c(byte[] paramArrayOfByte, long paramLong)
  {
    ...
    if ((this.uAI != 0L) && (!bt.cC(paramArrayOfByte)) && (paramArrayOfByte.length == this.width * this.height * 4))
    {
      ...
      int i = MMWXGFJNI.nativeAddGifEncodeRgbaFrame(this.uAI, this.width, this.height, paramArrayOfByte, l);
      if (i < 0)
      {
  ...
  public final boolean daW()
  {
    ...
    if (this.uAI != 0L)
    {
      byte[] arrayOfByte = MMWXGFJNI.nativeFinishGifEncode(this.uAI);
  ...
  public final boolean init()
  {
    ...
    this.uAI = MMWXGFJNI.nativeInitGifEncode(this.width, this.height, this.uAJ);
    if (this.uAI == 0L)
    {
      com.tencent.mm.plugin.report.service.g.yhR.dD(852, 11);
      ad.e("MicroMsg.MMGifEncoder", "init gif encoder failed! %s", new Object[] { Long.valueOf(this.uAI) });
      AppMethodBeat.o(104656);
      return false;
    }
    ad.i("MicroMsg.MMGifEncoder", "successfully init wxam encoder: %s", new Object[] { Long.valueOf(this.uAI) });
    AppMethodBeat.o(104656);
    return true;
  }
}
