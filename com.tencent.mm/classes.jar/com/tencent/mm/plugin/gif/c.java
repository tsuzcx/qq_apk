...
public class c
{
  ...
  f<String, WeakReference<e>> ydJ;
  f<String, WeakReference<b>> ydK;
  
  public c()
  {
    AppMethodBeat.i(104585);
    this.ydJ = new com.tencent.mm.memory.a.c(10);
    this.ydK = new com.tencent.mm.memory.a.c(new f.b() {});
  ...
  public static c dXx()
  {
    ...
    //   8: getstatic 47	com/tencent/mm/plugin/gif/c:ydI	Lcom/tencent/mm/plugin/gif/c;
    //   11: ifnonnull +25 -> 36
    //   14: ldc 2
    //   16: monitorenter
    //   17: getstatic 47	com/tencent/mm/plugin/gif/c:ydI	Lcom/tencent/mm/plugin/gif/c;
    //   20: ifnonnull +13 -> 33
    //   23: new 2	com/tencent/mm/plugin/gif/c
    //   26: dup
    //   27: invokespecial 48	com/tencent/mm/plugin/gif/c:<init>	()V
    //   30: putstatic 47	com/tencent/mm/plugin/gif/c:ydI	Lcom/tencent/mm/plugin/gif/c;
    //   33: ldc 2
    //   35: monitorexit
    //   36: getstatic 47	com/tencent/mm/plugin/gif/c:ydI	Lcom/tencent/mm/plugin/gif/c;
    //   39: astore_0
    //   40: ldc 45
  ...
  public final b aBd(String paramString)
  {
    AppMethodBeat.i(104587);
    b localb = null;
    if (this.ydK.get(paramString) != null) {
      localb = (b)((WeakReference)this.ydK.get(paramString)).get();
    }
  ...
  public final b c(Resources paramResources, int paramInt)
  {
    ...
    for (b localb = (b)((WeakReference)this.ydK.get(null)).get();; localb = null)
    {
      Object localObject = localb;
      if (localb == null)
      {
        localObject = new d(paramResources, paramInt);
        this.ydK.put(null, new WeakReference(localObject));
      }
  ...
  public final b hT(String paramString1, String paramString2)
  {
    AppMethodBeat.i(104588);
    b localb = null;
    if (this.ydK.get(paramString1) != null) {
      localb = (b)((WeakReference)this.ydK.get(paramString1)).get();
    }
    Object localObject = localb;
    long l;
    if (localb == null)
    ...
    for (paramString2 = new h(paramString2);; paramString2 = new d(paramString2))
    {
      ...
      this.ydK.put(paramString1, new WeakReference(paramString2));
  ...
  public final b s(String paramString, byte[] paramArrayOfByte)
  {
    ...
    Object localObject = localb;
    if (localb == null) {
      if ((!ImgUtil.isWXGF(paramArrayOfByte)) || (!((PluginEmoji)g.ah(PluginEmoji.class)).getEmojiMgr().cFP())) {
        break label136;
      }
    }
    label136:
    ...
    {
      this.ydK.put(paramString, new WeakReference(paramArrayOfByte));
