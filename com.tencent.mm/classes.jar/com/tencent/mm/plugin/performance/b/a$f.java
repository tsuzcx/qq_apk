...
public final class a$f
{
  ...
  public final boolean equals(Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof f))
      {
        ...
        if ((this.utN != paramObject.utN) || (this.time != paramObject.time) || (this.utu != paramObject.utu) || (this.state != paramObject.state)) {}
      }
    }
    else {
      return true;
  ...
  public final String toString()
  {
    ...
    String str = "TimeRecord(isMain=" + this.utN + ", time=" + this.time + ", threadTime=" + this.utu + ", state=" + this.state + ")";
