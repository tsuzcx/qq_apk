...
{
  private static o U(o paramo)
  {
    AppMethodBeat.i(176895);
    paramo = new o(aa.z(paramo.her()));
  ...
  static o V(o paramo)
  {
    ...
    if (!paramo.canRead())
    {
      paramo = new IOException("cannot read file: " + aa.z(paramo.her()));
  ...
  /* Error */
  public static void a(o paramo1, o paramo2, com.tencent.mm.vfs.q paramq)
  {
    // Byte code:
    //   0: ldc 58
    ...
    //   12: dup
    //   13: aload_1
    //   14: invokestatic 68	com/tencent/mm/vfs/s:ap	(Lcom/tencent/mm/vfs/o;)Ljava/io/OutputStream;
    ...
    //   31: astore 4
    //   33: aload_0
    //   34: invokestatic 79	com/tencent/mm/plugin/performance/diagnostic/a/b:U	(Lcom/tencent/mm/vfs/o;)Lcom/tencent/mm/vfs/o;
    //   37: astore 5
    //   39: aload 5
    //   41: invokevirtual 82	com/tencent/mm/vfs/o:isDirectory	()Z
    //   44: ifeq +167 -> 211
    //   47: aload 4
    //   49: aload 5
    //   51: aload_2
    //   52: invokevirtual 85	com/tencent/mm/vfs/o:a	(Lcom/tencent/mm/vfs/q;)[Lcom/tencent/mm/vfs/o;
    ...
    //   82: checkcast 15	com/tencent/mm/vfs/o
    //   85: invokestatic 79	com/tencent/mm/plugin/performance/diagnostic/a/b:U	(Lcom/tencent/mm/vfs/o;)Lcom/tencent/mm/vfs/o;
    //   88: astore 6
    //   90: aload 6
    //   92: invokevirtual 19	com/tencent/mm/vfs/o:her	()Landroid/net/Uri;
    //   95: invokestatic 25	com/tencent/mm/vfs/aa:z	(Landroid/net/Uri;)Ljava/lang/String;
    //   98: aload 5
    //   100: invokevirtual 19	com/tencent/mm/vfs/o:her	()Landroid/net/Uri;
    //   103: invokestatic 25	com/tencent/mm/vfs/aa:z	(Landroid/net/Uri;)Ljava/lang/String;
    ...
    //   136: ifeq +9 -> 145
    //   139: aload 6
    //   141: invokevirtual 124	com/tencent/mm/vfs/o:getName	()Ljava/lang/String;
    //   144: astore_1
    ...
    //   165: aload 6
    //   167: invokevirtual 82	com/tencent/mm/vfs/o:isDirectory	()Z
    //   170: ifeq +54 -> 224
    //   173: aload 4
    //   175: aload 6
    //   177: aload_2
    //   178: invokevirtual 85	com/tencent/mm/vfs/o:a	(Lcom/tencent/mm/vfs/q;)[Lcom/tencent/mm/vfs/o;
    ...
    //   199: astore_1
    //   200: aload_1
    //   201: invokestatic 142	org/apache/commons/a/e:e	(Ljava/io/OutputStream;)V
    //   204: ldc 58
    ...
    //   224: aload 6
    //   226: aload_3
    //   227: invokestatic 149	com/tencent/mm/plugin/performance/diagnostic/a/b:a	(Lcom/tencent/mm/vfs/o;Ljava/io/OutputStream;)V
    //   230: goto -40 -> 190
    //   233: astore_0
    //   234: aload_3
    ...
    //   244: athrow
    //   245: aload_3
    //   246: invokestatic 142	org/apache/commons/a/e:e	(Ljava/io/OutputStream;)V
    //   249: ldc 58
    ...
    //   0	261	0	paramo1	o
    //   0	261	1	paramo2	o
    //   0	261	2	paramq	com.tencent.mm.vfs.q
  ...
  private static void a(o paramo, OutputStream paramOutputStream)
  {
    ...
    try
    {
      localBufferedInputStream = new BufferedInputStream(s.ao(paramo));
      try
      {
        for (;;)
        {
  ...
  static String aJS(String paramString)
  {
  ...
  /* Error */
  static int aJT(String paramString)
  {
    // Byte code:
    //   0: ldc 221
    //   2: invokestatic 13	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   5: invokestatic 227	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   8: ldc 229
    ...
    //   89: iload_1
    //   90: ireturn
    //   91: new 15	com/tencent/mm/vfs/o
    //   94: dup
    //   95: ldc_w 266
    //   98: invokespecial 29	com/tencent/mm/vfs/o:<init>	(Ljava/lang/String;)V
    //   101: invokevirtual 270	com/tencent/mm/vfs/o:het	()[Lcom/tencent/mm/vfs/o;
    //   104: astore 6
    //   106: aload 6
    //   108: arraylength
    //   109: istore_2
    ...
    //   121: astore 7
    //   123: aload 7
    //   125: invokevirtual 124	com/tencent/mm/vfs/o:getName	()Ljava/lang/String;
    //   128: invokestatic 274	android/text/TextUtils:isDigitsOnly	(Ljava/lang/CharSequence;)Z
    //   131: ifeq +115 -> 246
    //   134: aload 7
    //   136: invokevirtual 39	com/tencent/mm/vfs/o:canRead	()Z
    //   139: ifeq +107 -> 246
    //   142: new 15	com/tencent/mm/vfs/o
    //   145: dup
    //   146: aload 7
    //   148: ldc_w 276
    //   151: invokespecial 279	com/tencent/mm/vfs/o:<init>	(Lcom/tencent/mm/vfs/o;Ljava/lang/String;)V
    //   154: astore 4
    //   156: aload 4
    //   158: invokevirtual 39	com/tencent/mm/vfs/o:canRead	()Z
    //   161: ifeq +85 -> 246
    //   164: aconst_null
    //   165: astore 5
    //   167: new 281	java/io/BufferedReader
    //   170: dup
    //   171: new 283	com/tencent/mm/vfs/u
    //   174: dup
    //   175: aload 4
    //   177: invokespecial 286	com/tencent/mm/vfs/u:<init>	(Lcom/tencent/mm/vfs/o;)V
    ...
    //   199: ifeq +42 -> 241
    //   202: aload 7
    //   204: invokevirtual 124	com/tencent/mm/vfs/o:getName	()Ljava/lang/String;
    ...
    //   215: istore_1
    //   216: aload 4
    //   218: invokestatic 305	org/apache/commons/a/e:a	(Ljava/io/Reader;)V
    //   221: ldc 221
    ...
    //   228: astore_0
    //   229: aload 4
    //   231: invokestatic 305	org/apache/commons/a/e:a	(Ljava/io/Reader;)V
    //   234: ldc 221
    //   236: invokestatic 32	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   239: iconst_0
    //   240: ireturn
    //   241: aload 4
    //   243: invokestatic 305	org/apache/commons/a/e:a	(Ljava/io/Reader;)V
    //   246: iload_1
    //   247: iconst_1
    //   248: iadd
    //   249: istore_1
    ...
    //   257: astore 4
    //   259: aload 4
    //   261: invokestatic 305	org/apache/commons/a/e:a	(Ljava/io/Reader;)V
    //   264: goto -18 -> 246
    //   267: astore_0
    //   268: aconst_null
    //   269: astore 4
    //   271: aload 4
    //   273: invokestatic 305	org/apache/commons/a/e:a	(Ljava/io/Reader;)V
    //   276: ldc 221
