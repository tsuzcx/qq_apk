...
public final class a$g
{
  ...
  public final boolean equals(Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof g))
      {
        ...
        if ((this.GPn != paramObject.GPn) || (this.time != paramObject.time) || (this.GOR != paramObject.GOR) || (this.state != paramObject.state)) {}
      }
    }
    else {
      return true;
  ...
  public final String toString()
  {
    ...
    String str = "TimeRecord(isMain=" + this.GPn + ", time=" + this.time + ", threadTime=" + this.GOR + ", state=" + this.state + ")";
 ...
 * Qualified Name:     com.tencent.mm.plugin.performance.c.a.g
