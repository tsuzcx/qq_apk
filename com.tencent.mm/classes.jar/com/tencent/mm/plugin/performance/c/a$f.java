...
public final class a$f
{
  ...
  public final boolean equals(Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof f))
      {
        ...
        if ((this.vDk != paramObject.vDk) || (this.time != paramObject.time) || (this.vCR != paramObject.vCR) || (this.state != paramObject.state)) {}
      }
    }
    else {
      return true;
  ...
  public final String toString()
  {
    ...
    String str = "TimeRecord(isMain=" + this.vDk + ", time=" + this.time + ", threadTime=" + this.vCR + ", state=" + this.state + ")";
