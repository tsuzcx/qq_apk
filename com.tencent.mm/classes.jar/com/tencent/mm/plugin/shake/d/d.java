...
public final class d
{
  public static String a(Context paramContext, a parama)
  {
    ...
    for (localb.description = parama.field_topic;; localb.description = parama.field_subtitle)
    {
      ...
      if (n.gXa())
      {
        localb.appName = paramContext.getString(R.l.gUo);
  ...
  public static a aVU(String paramString)
  {
 ...
 * Qualified Name:     com.tencent.mm.plugin.shake.d.d
