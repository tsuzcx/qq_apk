...
public final class m$b
{
  ...
  public static b anf(String paramString)
  {
    AppMethodBeat.i(28342);
    Map localMap = bw.K(paramString, "nativepay");
    if (localMap != null) {}
    for (;;)
    {
      try
      {
        ...
        paramString.wnZ = bt.nullAsNil((String)localMap.get(".nativepay.wx_pay_url"));
        paramString.upC = bt.nullAsNil((String)localMap.get(".nativepay.price"));
