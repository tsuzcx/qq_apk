  ...
  implements com.tencent.mm.ak.i, u.a
{
  ...
  private com.tencent.mm.plugin.shake.e.b DlF;
  ...
  private void a(final c.a parama)
  {
    ...
    for (;;)
    {
      this.qbE = ((ImageView)findViewById(2131309548));
      if (!Util.isNullOrNil(parama.field_playurl))
      {
        ImageView localImageView = (ImageView)findViewById(2131309547);
        ...
        localImageView.setOnClickListener(new View.OnClickListener()
        {
          public final void onClick(View paramAnonymousView)
          {
            ...
            com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/shake/ui/TVInfoUI$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.axR());
            h.CyF.a(10987, new Object[] { Integer.valueOf(2), parama.field_playstatid, "", "" });
        ...
        this.qbE.setOnClickListener(new View.OnClickListener()
        {
          public final void onClick(View paramAnonymousView)
          {
            ...
            com.tencent.mm.hellhoundlib.b.b localb = new com.tencent.mm.hellhoundlib.b.b();
            localb.bm(paramAnonymousView);
            com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/shake/ui/TVInfoUI$2", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.axR());
            h.CyF.a(10987, new Object[] { Integer.valueOf(2), parama.field_playstatid, "", "" });
            TVInfoUI.a(TVInfoUI.this, parama.field_playurl);
      ...
      if ((!Util.isNullOrNil(parama.field_id)) && (!this.DlE) && (!getIntent().getBooleanExtra("key_TV_come_from_shake", false)))
      {
        ...
        bg.azz().a(new com.tencent.mm.plugin.shake.d.a.b(parama.field_id, i), 0);
        this.DlE = true;
      }
      ...
      AppMethodBeat.o(28592);
      return;
      this.DlC.setText(parama.field_topic);
    }
  }
  ...
  private void eQK()
  {
    ...
    if ((this.msgId > 0L) && (bg.aAc()))
    {
      bg.aVF();
      ca localca = com.tencent.mm.model.c.aSQ().Hb(this.msgId);
      if (localca.field_msgId > 0L)
      {
        localca.Cz(this.DlF.blA());
        bg.aVF();
        com.tencent.mm.model.c.aSQ().a(this.msgId, localca);
      }
    }
  ...
  public void initView()
  {
    ...
    setMMTitle(2131764995);
    this.screen = getPreferenceScreen();
    this.titleTv = ((TextView)findViewById(2131309549));
    this.DlC = ((TextView)findViewById(2131309550));
    ...
    this.DlD = com.tencent.mm.plugin.shake.e.c.aNu(str1);
    if (this.DlD == null)
    {
  ...
  public boolean onPreferenceTreeClick(com.tencent.mm.ui.base.preference.f paramf, Preference paramPreference)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((j < 0) || (j >= this.DlD.CUx.size()))
        {
          Log.w("MicroMsg.TVInfoUI", "index out of bounds, ii=[%s], list Size=[%s]", new Object[] { Integer.valueOf(j), Integer.valueOf(this.DlD.CUx.size()) });
          AppMethodBeat.o(28594);
          return false;
        }
        paramf = (com.tencent.mm.plugin.shake.e.a)this.DlD.CUx.get(j);
        if (paramf == null)
        {
        ...
        if ((k < 0) || (k >= paramf.mRG.size()))
        {
          Log.w("MicroMsg.TVInfoUI", "index out of bounds, jj=[%s], actions Size=[%s]", new Object[] { Integer.valueOf(k), Integer.valueOf(paramf.mRG.size()) });
          AppMethodBeat.o(28594);
          return false;
        }
        paramf = (a.a)paramf.mRG.get(k);
        if (paramf == null)
        {
        ...
        Log.v("MicroMsg.TVInfoUI", "action type:" + paramf.type + ", target:" + paramf.daA + ", targetDesc:" + paramf.DlP + ", targetDesc2:" + paramf.DlQ);
        if (paramf.type == 3)
        {
          paramPreference = new Intent();
          paramPreference.putExtra("rawUrl", paramf.daA);
          paramPreference.putExtra("show_bottom", false);
          paramPreference.putExtra("geta8key_scene", 10);
          paramPreference.putExtra("srcUsername", paramf.DlQ);
          com.tencent.mm.plugin.shake.a.jRt.i(paramPreference, this);
          AppMethodBeat.o(28594);
          return true;
        }
        if (paramf.type != 4) {
        ...
        bg.aVF();
        paramPreference = com.tencent.mm.model.c.aSN().Kn(paramf.daA);
        if (paramPreference == null) {
          continue;
        }
        localIntent = new Intent();
        if ((com.tencent.mm.contact.c.oR(paramPreference.field_type)) && (paramPreference.gBM()))
        {
          ag.bah().MT(paramf.daA);
          if (paramf.DlP.equals("1"))
          {
            localIntent.putExtra("Chat_User", paramf.daA);
            localIntent.putExtra("finish_direct", true);
            com.tencent.mm.plugin.shake.a.jRt.d(localIntent, this);
            continue;
          }
        }
        localIntent.putExtra("Contact_User", paramf.daA);
      }
      ...
      if (paramf.type == 5)
      {
        paramPreference = new je();
        paramPreference.dNT.actionCode = 11;
        paramPreference.dNT.result = paramf.daA;
        paramPreference.dNT.context = this;
      ...
      {
        paramPreference = new Intent();
        paramPreference.putExtra("key_product_id", paramf.daA);
  ...
  public void onSceneEnd(int paramInt1, int paramInt2, String paramString, q paramq)
  {
    ...
    if (paramq.getType() == 552)
    {
      if ((paramInt1 != 0) || (paramInt2 != 0))
      {
        ...
        Toast.makeText(this, 2131764996, 0).show();
        AppMethodBeat.o(28596);
        return;
      }
      if (this.DlD == null)
      ...
      for (paramString = (bvy)paramString.rr.iLL.iLR; paramString == null; paramString = null)
      {
        Log.w("MicroMsg.TVInfoUI", "onSceneEnd tvInfo == null");
        AppMethodBeat.o(28596);
        return;
      }
      if (paramString.MbV != null)
      {
        Log.d("MicroMsg.TVInfoUI", "onSceneEnd  tvInfo.DescriptionXML != null, res:" + paramString.MbV);
        paramString = com.tencent.mm.plugin.shake.e.c.aNu(paramString.MbV);
        if ((this.DlD != null) && (this.DlD.field_xml != null) && (paramString != null) && (paramString.field_xml != null) && (!this.DlD.field_xml.equals(paramString.field_xml)))
        {
