  ...
  implements com.tencent.mm.plugin.zero.a.b
{
  public final void a(long paramLong, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    ...
    if (Util.isNullOrNil(paramString2))
    {
      ...
      if (!com.tencent.mm.n.g.Lj(paramString1)) {
        break label161;
      }
      i = R.l.ewS;
    }
    ...
    for (;;)
    {
      ...
      paramString2 = g.a.arf().iSt;
      if (!com.tencent.mm.n.g.awj()) {
        f.cancel();
      }
      try
      {
        locald = paramString2.iSl;
        localContext = MMApplicationContext.getContext();
        MMApplicationContext.getContext();
        bool2 = com.tencent.mm.booter.notification.a.e.arq();
        MMApplicationContext.getContext();
        bool1 = com.tencent.mm.booter.notification.a.e.arn();
        ...
        else if ((com.tencent.mm.n.g.awW()) && (!com.tencent.mm.n.g.awX()))
        {
    ...
    if (!com.tencent.mm.n.g.awg())
    {
      Log.i("MicroMsg.Notification.AppMsg.Handle", "[NO NOTIFICATION]new MsgNotification setting no notification");
      AppMethodBeat.o(22366);
      return;
    }
    if (com.tencent.mm.booter.notification.d.EQ(paramLong))
    {
      Log.i("MicroMsg.Notification.AppMsg.Handle", "[NO NOTIFICATION]already notify");
      AppMethodBeat.o(22366);
      return;
    }
    com.tencent.mm.booter.notification.queue.b.arh().restore();
    int j = com.tencent.mm.booter.notification.d.arb() + 1;
    paramString2 = com.tencent.mm.booter.notification.d.c(com.tencent.mm.booter.notification.d.arc(), paramString1);
    Object localObject;
    label365:
    int k;
    int m;
    ...
    if (paramString2 == null)
    {
      i = 0;
      i += 1;
      localObject = com.tencent.mm.booter.notification.d.arc();
      ...
      ((d.a)localObject).fId = 1;
      paramString2.add(localObject);
      com.tencent.mm.booter.notification.d.h(paramString2);
      com.tencent.mm.booter.notification.d.qi(com.tencent.mm.booter.notification.d.arb() + 1);
      k = paramString2.size();
      if (com.tencent.mm.booter.notification.a.e.arm())
      {
        bool1 = false;
        bool2 = false;
      }
      localObject = com.tencent.mm.booter.notification.d.ara();
      m = com.tencent.mm.booter.notification.queue.b.arh().JR(paramString1);
      locald.ffH.iSZ = j;
      locald.ffH.iSY = k;
      locald.ffH.iTf = bool2;
      locald.ffH.iTe = bool1;
      boolean bool3 = com.tencent.mm.n.g.awj();
      n = com.tencent.mm.bx.a.fkG();
      paramString2 = locald.ffH;
      paramString2.iSR.a(paramString2.mContext, bool1, bool2, (Notification)localObject, null);
      i1 = paramString2.iSR.iSD;
    ...
    label841:
    label884:
    for (paramString2 = com.tencent.mm.booter.notification.a.a.a(localContext, com.tencent.mm.booter.notification.a.a.aa(paramString1, paramString4));; paramString2 = null)
    {
      ...
      paramString2.iSo = paramLong;
      paramString2.iSp = i;
      locald.a(paramString2, locald.ffH);
      com.tencent.mm.booter.notification.e.qj(locald.ffH.aru());
      com.tencent.mm.booter.notification.e.V(paramString1, i);
      AppMethodBeat.o(22366);
      return;
      i = paramString2.fId;
      break;
