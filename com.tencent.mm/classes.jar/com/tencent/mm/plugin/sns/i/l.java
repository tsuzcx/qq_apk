...
{
  public LinkedList<m> zIc;
  public LinkedList<m> zId;
  public boolean zIe;
  
  public l()
  {
    AppMethodBeat.i(96162);
    this.zIc = new LinkedList();
    this.zId = new LinkedList();
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.e(1, 8, this.zIc);
      paramVarArgs.e(2, 8, this.zId);
      paramVarArgs.bC(3, this.zIe);
    ...
    if (paramInt == 1)
    {
      paramInt = f.a.a.a.c(1, 8, this.zIc);
      i = f.a.a.a.c(2, 8, this.zId);
    ...
    if (paramInt == 3)
    {
      ...
      case 2: 
        ...
        while (paramInt < i)
        {
          ...
          localObject2 = new f.a.a.a.a((byte[])localObject2, unknownTagHandler);
          for (bool = true; bool; bool = ((m)localObject1).populateBuilderWithField((f.a.a.a.a)localObject2, (com.tencent.mm.bw.a)localObject1, com.tencent.mm.bw.a.getNextFieldNumber((f.a.a.a.a)localObject2))) {}
          locall.zId.add(localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(96163);
        return 0;
      }
      locall.zIe = ((f.a.a.a.a)localObject1).OmT.gvY();
      AppMethodBeat.o(96163);
      return 0;
    }
    AppMethodBeat.o(96163);
