  ...
  extends a
{
  ...
  protected final void c(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    paramInt2 = paramInt2 - this.zsj - paramInt3 / 2;
    if (paramInt2 > 0) {
  ...
  protected final Rect dVJ()
  {
    ...
    int k = (int)f.ae(this.zsj / 2, this.zsj + this.zsh * 4);
 ...
 * Qualified Name:     com.tencent.mm.plugin.sns.ad.g.a.d
