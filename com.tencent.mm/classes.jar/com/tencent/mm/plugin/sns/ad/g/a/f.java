  ...
  extends a
{
  ...
  protected final void c(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    paramInt1 = (int)com.tencent.mm.plugin.sns.ad.f.f.ae(0.0F, 0.8F * this.atW);
    localObjectAnimator1.setInterpolator(new AccelerateInterpolator());
    localObjectAnimator1.setDuration(paramInt1);
    ObjectAnimator localObjectAnimator2 = ObjectAnimator.ofFloat(paramView, "rotation", new float[] { 0.0F, this.atW / 1000.0F * 180.0F });
    localObjectAnimator2.setInterpolator(new LinearInterpolator());
    localObjectAnimator2.setDuration(this.atW);
  ...
  protected final Rect dVJ()
  {
    ...
    int i = 0;
    int j = (int)com.tencent.mm.plugin.sns.ad.f.f.ae(this.zsg, this.zsh);
    a(localRect, (int)com.tencent.mm.plugin.sns.ad.f.f.ae(j / 2, this.zsi - j / 2), (int)com.tencent.mm.plugin.sns.ad.f.f.ae(j / 2, this.zsj - j / 2), j);
    j = 0;
    label72:
    if (j < this.zsm.size()) {
 ...
 * Qualified Name:     com.tencent.mm.plugin.sns.ad.g.a.f
