  ...
  extends a
{
  ...
  protected final void c(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    paramInt1 = (int)com.tencent.mm.plugin.sns.ad.e.f.ae(0.0F, 0.8F * this.atW);
  ...
  protected final Rect dSl()
  {
    ...
    int i = 0;
    int j = (int)com.tencent.mm.plugin.sns.ad.e.f.ae(this.zbD, this.zbE);
    a(localRect, (int)com.tencent.mm.plugin.sns.ad.e.f.ae(j / 2, this.zbF - j / 2), (int)com.tencent.mm.plugin.sns.ad.e.f.ae(j / 2, this.zbG - j / 2), j);
    j = 0;
    label72:
    if (j < this.zbJ.size()) {
 ...
 * Qualified Name:     com.tencent.mm.plugin.sns.ad.f.a.f
