  ...
  extends a
{
  ...
  protected final void c(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    paramInt2 = paramInt2 - this.zbG - paramInt3 / 2;
    if (paramInt2 > 0) {
  ...
  protected final Rect dSl()
  {
    ...
    int k = (int)f.ae(this.zbG / 2, this.zbG + this.zbE * 4);
 ...
 * Qualified Name:     com.tencent.mm.plugin.sns.ad.f.a.d
