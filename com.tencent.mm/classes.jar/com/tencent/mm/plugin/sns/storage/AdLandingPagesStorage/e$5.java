  ...
  implements c.a
{
  ...
  public final void Hn(final String paramString)
  {
    ...
    Log.i("MicroMsg.AdLandingPageDownloadFileHelper", " download success big file for %s", new Object[] { this.val$url });
    MMHandlerThread.postToMainThread(new Runnable()
    {
      public final void run()
      {
        AppMethodBeat.i(97302);
        e.5.this.Ela.Hn(paramString);
  ...
  public final void aas(final String paramString)
  {
    ...
    Log.e("MicroMsg.AdLandingPageDownloadFileHelper", " download error for big file %s", new Object[] { this.val$url });
    MMHandlerThread.postToMainThread(new Runnable()
    {
      public final void run()
      {
        AppMethodBeat.i(97301);
        e.5.this.Ela.aas(paramString);
  ...
  public final void dx(final String paramString, final int paramInt)
  {
    ...
    MMHandlerThread.postToMainThread(new Runnable()
    {
      public final void run()
      {
        ...
        e.5.this.Ela.dx(paramString, paramInt);
