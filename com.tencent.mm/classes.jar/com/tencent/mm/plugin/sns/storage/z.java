...
public final class z
{
  ...
  public static int a(h paramh1, h paramh2, String paramString)
  {
    ...
    if (paramh1 == null)
    {
      ac.w("MicroMsg.TrimSnsDb", "diskDB has not this table !");
      AppMethodBeat.o(97649);
      return -1;
    }
    ac.i("MicroMsg.TrimSnsDb", "create sql %s", new Object[] { paramh1 });
    ac.i("MicroMsg.TrimSnsDb", "create result ".concat(String.valueOf(paramh2.execSQL("", paramh1))));
    AppMethodBeat.o(97649);
    return 1;
  }
  ...
  public static boolean a(h paramh1, h paramh2)
  {
    ...
    try
    {
      if (bs.isNullOrNil(paramh1.getKey())) {
        paramh2.execSQL("", "ATTACH DATABASE '" + paramh1.getPath() + "' AS old ");
      }
      for (;;)
      {
        ac.i("MicroMsg.TrimSnsDb", "ATTACH DATABASE " + paramh1.getKey());
    ...
    {
      ac.e("MicroMsg.TrimSnsDb", "ERROR : attach disk db [%s] , will do again !", new Object[] { paramh1.getMessage() });
      ac.printErrStackTrace("MicroMsg.TrimSnsDb", paramh1, "", new Object[0]);
      AppMethodBeat.o(97648);
    }
  }
  ...
  public static void avt(String paramString)
  {
    ...
    Object localObject = i.cZ(paramString, false);
    if (localObject == null)
    {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((!locala.Jsg) && (locala.name.startsWith("SnsMicroMsg.dberr")))
      {
        ac.i("MicroMsg.TrimSnsDb", "find error %s", new Object[] { paramString + locala.name });
        locala.delete();
      }
    }
    AppMethodBeat.o(97650);
