  ...
  implements b
{
  ...
  public final void fo(String paramString)
  {
    ...
    ac.i("MicroMsg.AdLandingOnlineVideoProxy", "%s, stop stream[%s]", new Object[] { Integer.valueOf(hashCode()), paramString });
  ...
  public final boolean isVideoDataAvailable(String paramString, int paramInt1, int paramInt2)
  {
    ...
    ac.i("MicroMsg.AdLandingOnlineVideoProxy", "%s, check video data available[%s, %s, %s]", new Object[] { Integer.valueOf(hashCode()), paramString, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
    if (this.tbJ.equals(paramString))
    {
  ...
  public final void q(String paramString1, String paramString2, String paramString3)
  {
    ...
    ac.i("MicroMsg.AdLandingOnlineVideoProxy", "%s start http stream[%s, %s, %s]", new Object[] { Integer.valueOf(hashCode()), paramString1, paramString3, paramString2 });
  ...
  public final void requestVideoData(String paramString, int paramInt1, int paramInt2)
  {
    ...
    ac.d("MicroMsg.AdLandingOnlineVideoProxy", "%s, request video data[%s, %s, %s]", new Object[] { Integer.valueOf(hashCode()), paramString, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
    if (this.tbJ.equals(paramString)) {
    ...
    implements h.a
  {
    ...
    public final void a(final String paramString, final int paramInt, d paramd)
    {
      ...
      if ((a.this.oWd != null) && (a.this.tbJ.equals(paramString))) {
        ap.f(new Runnable()
        {
          public final void run()
          {
            ...
            h.wUl.dB(955, 31);
            a.this.oWd.aq(paramString, paramInt);
    ...
    public final void a(final String paramString1, final long paramLong1, long paramLong2, final String paramString2)
    {
      ...
      if ((a.this.oWd != null) && (a.this.tbJ.equals(paramString1))) {
        ap.f(new Runnable()
        {
          public final void run()
          {
      ...
      if ((a.this.oWd != null) && (a.this.tbJ.equals(paramString))) {
        ap.f(new Runnable()
        {
          public final void run()
          {
            ...
            a.this.oWd.i(paramString, paramLong1, this.tbg);
      ...
      if ((a.this.oWd != null) && (a.this.tbJ.equals(paramString))) {
        ap.f(new Runnable()
        {
          public final void run()
          {
            ...
            h.wUl.dB(955, 29);
            a.this.oWd.onDataAvailable(paramString, paramLong1, this.kPh);
