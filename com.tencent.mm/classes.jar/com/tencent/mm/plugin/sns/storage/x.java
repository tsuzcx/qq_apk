...
public final class x
{
  ...
  public static int aqg(String paramString)
  {
    ...
    if (paramString.startsWith("ad_table_"))
    {
      i = bt.aGh(paramString.substring(9));
      AppMethodBeat.o(97641);
      return i;
    }
    int i = bt.aGh(paramString.substring(10));
    AppMethodBeat.o(97641);
    return i;
  }
  ...
  public static boolean aqh(String paramString)
  {
    ...
    if (paramString.startsWith("ad_table_"))
    {
      if (bt.aGi(paramString.substring(9)) != 0L)
      {
    ...
    if (bt.aGi(paramString.substring(10)) != 0L)
    {
      AppMethodBeat.o(97642);
      return true;
    }
  ...
  public static String aqj(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        g.afz();
        String str2 = a.aeo();
        if (bt.T(new String[] { paramString, str2 }))
        {
  ...
  public static int ay(String paramString1, String paramString2, String paramString3)
  {
    ...
    paramString1 = az(paramString1, paramString2, paramString3);
    int j = k;
    int i;
  ...
  public static String bh(String paramString, long paramLong)
  {
  ...
  public static void c(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4)
  {
  ...
  public static int jh(String paramString1, String paramString2)
  {
    AppMethodBeat.i(97644);
    g.afz();
    int i = ay(paramString1, paramString2, a.aeo());
