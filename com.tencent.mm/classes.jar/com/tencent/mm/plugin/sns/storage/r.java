...
import com.tencent.mm.plugin.sns.k.d.a;
  ...
  extends MStorage
{
  ...
  private int a(com.tencent.mm.plugin.sns.data.q paramq)
  {
    ...
    str3 = com.tencent.mm.plugin.sns.data.r.aOj(str4);
    ...
    j = ((com.tencent.mm.plugin.sns.data.q)localObject3).width;
    int k = ((com.tencent.mm.plugin.sns.data.q)localObject3).height;
    int m = ((com.tencent.mm.plugin.sns.data.q)localObject3).fileSize;
    ((com.tencent.mm.plugin.image.b)localObject2).ynE = str1;
    ((com.tencent.mm.plugin.image.b)localObject2).ynG = j;
    ((com.tencent.mm.plugin.image.b)localObject2).ynH = k;
    ((com.tencent.mm.plugin.image.b)localObject2).ynI = m;
    if (!f(str2, str1, str3, true))
    {
      AppMethodBeat.o(97607);
      return -1;
    }
    ...
    str1 = str2 + str3;
    j = (int)s.boW(str1);
    if (com.tencent.mm.plugin.sns.data.r.aBO(str1) == 2)
    {
      localObject4 = BitmapUtil.getYUVType(s.aW(str1, 0, j));
    ...
    try
    {
      localObject1 = s.k(str1, false);
      paramq = (com.tencent.mm.plugin.sns.data.q)localObject1;
    ...
    catch (Exception paramq)
    {
      try
      {
        ((q)localObject1).EmR = paramq.toByteArray();
        ((q)localObject1).feZ();
        ((q)localObject1).EmM = j;
        Log.i("MicroMsg.snsMediaStorage", "insert a local snsMedia  totallen  :" + j + " filepath: " + str2 + str3);
        i = (int)this.iFy.insert("SnsMedia", "local_id", ((q)localObject1).feY());
        Log.d("MicroMsg.snsMediaStorage", "insert localId ".concat(String.valueOf(i)));
        str4 = "Locall_path".concat(String.valueOf(i));
        ((com.tencent.mm.plugin.image.b)localObject2).ynF = String.valueOf(i);
        ((com.tencent.mm.plugin.image.b)localObject2).md5 = paramq.md5;
        localObject3 = Exif.fromFile(((com.tencent.mm.plugin.image.b)localObject2).ynE);
        j = com.tencent.mm.plugin.image.b.aBO(((com.tencent.mm.plugin.image.b)localObject2).ynE);
        paramq = ((Exif)localObject3).dateTimeOriginal;
        localObject4 = ((com.tencent.mm.plugin.image.b)localObject2).ynE;
        if (Util.isNullOrNil(paramq)) {
          break label1924;
        }
        paramq = com.tencent.mm.plugin.image.b.aBP(paramq);
        localObject4 = new m();
        ((m)localObject4).n("20 localID", ((com.tencent.mm.plugin.image.b)localObject2).ynF + ",");
        ((m)localObject4).n("21 MediaType", j + ",");
        ((m)localObject4).n("22 OriginWidth", ((com.tencent.mm.plugin.image.b)localObject2).ynG + ",");
        ((m)localObject4).n("23 OriginHeight", ((com.tencent.mm.plugin.image.b)localObject2).ynH + ",");
        ((m)localObject4).n("24 CompressedWidth", ((com.tencent.mm.plugin.image.b)localObject2).ynJ + ",");
        ((m)localObject4).n("25 CompressedHeight", ((com.tencent.mm.plugin.image.b)localObject2).ynK + ",");
        ((m)localObject4).n("26 OriginSize", ((com.tencent.mm.plugin.image.b)localObject2).ynI + ",");
        ((m)localObject4).n("27 CompressedSize", ((com.tencent.mm.plugin.image.b)localObject2).ynL + ",");
        ((m)localObject4).n("28 FNumber", ((Exif)localObject3).fNumber + ",");
        ((m)localObject4).n("29 ExposureTime", ((Exif)localObject3).exposureTime + ",");
        ((m)localObject4).n("30 ISO", ((Exif)localObject3).isoSpeedRatings + ",");
        ((m)localObject4).n("31 Flash", ((Exif)localObject3).flash + ",");
        ((m)localObject4).n("32 LensModel", com.tencent.mm.plugin.image.b.aBP(((Exif)localObject3).model) + ",");
        ((m)localObject4).n("33 CreatTime", paramq + ",");
        ((m)localObject4).n("34 IsFromWeChat", "0,");
        ((m)localObject4).n("35 Scene", ",");
        ((m)localObject4).n("36 sceneType", ((Exif)localObject3).sceneType + ",");
        ((m)localObject4).n("37 fileSource", ((Exif)localObject3).fileSource + ",");
        ((m)localObject4).n("38 make", ((Exif)localObject3).make + ",");
        ((m)localObject4).n("39 software", ((Exif)localObject3).software + ",");
        ((m)localObject4).n("40 fileExt", com.tencent.mm.plugin.image.b.akC(((com.tencent.mm.plugin.image.b)localObject2).ynE) + ",");
        ((m)localObject4).n("41 faceCount", "0,");
        ((m)localObject4).n("42 YCbCrSubSampling", ((Exif)localObject3).yCbCrSubSampling + ",");
        ((m)localObject4).n("43 md5", ((com.tencent.mm.plugin.image.b)localObject2).md5 + ',');
        Log.v("MicroMsg.ImgExtInfoReport", "report logbuffer MMImageExifInfo(14525): %s, orgPath:%s", new Object[] { ((m)localObject4).abW(), ((com.tencent.mm.plugin.image.b)localObject2).ynE });
        com.tencent.mm.plugin.report.service.h.CyF.a(14525, new Object[] { localObject4 });
        paramq = ((m)localObject4).toString();
        localObject2 = d.fcs();
        j = com.tencent.mm.plugin.image.b.aBO(str1);
        ((d)localObject2).DUL.put(Integer.valueOf(i), new d.a((d)localObject2, j, paramq));
        paramq = com.tencent.mm.plugin.sns.data.r.aOj(str4);
        str1 = aQD(str4);
        s.boN(str1);
        Log.i("MicroMsg.snsMediaStorage", "checkcntpath ".concat(String.valueOf(str1)));
        s.nw(str2 + str3, str1 + paramq);
        str2 = str1 + com.tencent.mm.plugin.sns.data.r.aOf(str4);
        str3 = str1 + com.tencent.mm.plugin.sns.data.r.aOg(str4);
        s.deleteFile(str2);
        s.deleteFile(str3);
        Log.i("MicroMsg.snsMediaStorage", "insert done " + (System.currentTimeMillis() - l) + " targetPath : " + str1 + paramq + " totalLen:" + s.boW(new StringBuilder().append(str1).append(paramq).toString()) + "  now delete...:" + str2 + " & " + str3);
        ((q)localObject1).EmN = str4;
        a(i, (q)localObject1);
        AppMethodBeat.o(97607);
        return i;
        paramq = paramq;
        Log.printErrStackTrace("MicroMsg.snsMediaStorage", paramq, "", new Object[0]);
      }
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          continue;
          paramq = com.tencent.mm.plugin.image.b.aBP(new SimpleDateFormat("yyyy:MM:dd HH:mm:ss").format(new Date(new o((String)localObject4).lastModified())));
        }
      }
    }
    j = (int)s.boW(str2 + str3);
    localObject3 = a((com.tencent.mm.plugin.sns.data.q)localObject3, str2 + str3);
    k = ((com.tencent.mm.plugin.sns.data.q)localObject3).width;
    m = ((com.tencent.mm.plugin.sns.data.q)localObject3).height;
    ((com.tencent.mm.plugin.image.b)localObject2).ynJ = k;
    ((com.tencent.mm.plugin.image.b)localObject2).ynK = m;
    ((com.tencent.mm.plugin.image.b)localObject2).ynL = j;
    localObject1 = new q();
    ((q)localObject1).EmN = str4;
    ((q)localObject1).createTime = ((int)Util.nowSecond());
    ((q)localObject1).type = i;
    paramq = new cne();
    paramq.Privated = ((com.tencent.mm.plugin.sns.data.q)localObject3).DEB;
    paramq.MsV = ((com.tencent.mm.plugin.sns.data.q)localObject3).DEA;
    paramq.token = ((com.tencent.mm.plugin.sns.data.q)localObject3).DEC;
    paramq.Mte = ((com.tencent.mm.plugin.sns.data.q)localObject3).DED;
    paramq.Mts = 0;
    paramq.Mtr = new cmw();
    paramq.ibG = 0;
    paramq.Desc = ((com.tencent.mm.plugin.sns.data.q)localObject3).desc;
    Log.d("MicroMsg.snsMediaStorage", "upload.filterId " + ((com.tencent.mm.plugin.sns.data.q)localObject3).DEz);
    paramq.MsU = ((com.tencent.mm.plugin.sns.data.q)localObject3).DEz;
    paramq.Mpa = 2;
    paramq.md5 = s.bhK(str2 + str3);
  }
  
  private static com.tencent.mm.plugin.sns.data.q a(com.tencent.mm.plugin.sns.data.q paramq, String paramString)
  {
    n = 0;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject4 = localObject1;
        localObject2 = localObject5;
        localObject5 = s.openRead(paramString);
      ...
      paramq.width = m;
      paramq.height = k;
      paramq.fileSize = ((int)s.boW(paramString));
      AppMethodBeat.o(97606);
      return paramq;
      localObject4 = localObject1;
      localObject2 = localObject1;
  ...
  private static boolean a(Bitmap paramBitmap, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      byte[] arrayOfByte = aB(paramBitmap);
      e.cEM();
      if (e.a(arrayOfByte, paramString1, paramString2, paramBitmap.getWidth(), paramBitmap.getHeight(), paramInt1, paramInt2) == 0)
      {
  ...
  private static boolean a(BitmapFactory.Options paramOptions, String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Bitmap.CompressFormat paramCompressFormat, int paramInt5, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    //   194: iconst_1
    //   195: ldc_w 708
    //   198: invokestatic 714	com/tencent/mm/kernel/g:af	(Ljava/lang/Class;)Lcom/tencent/mm/kernel/c/a;
    //   201: checkcast 708	com/tencent/mm/plugin/expt/b/b
    //   204: getstatic 720	com/tencent/mm/plugin/expt/b/b$a:rPP	Lcom/tencent/mm/plugin/expt/b/b$a;
    //   207: iconst_0
    ...
    //   262: ldc_w 708
    //   265: invokestatic 714	com/tencent/mm/kernel/g:af	(Ljava/lang/Class;)Lcom/tencent/mm/kernel/c/a;
    //   268: checkcast 708	com/tencent/mm/plugin/expt/b/b
    //   271: getstatic 737	com/tencent/mm/plugin/expt/b/b$a:rPQ	Lcom/tencent/mm/plugin/expt/b/b$a;
    //   274: ldc_w 738
    ...
    //   343: getstatic 484	com/tencent/mm/plugin/report/service/h:CyF	Lcom/tencent/mm/plugin/report/service/h;
    //   346: ldc2_w 741
    //   349: lconst_1
    //   350: lconst_1
    //   351: invokevirtual 745	com/tencent/mm/plugin/report/service/h:n	(JJJ)V
    //   354: aload_1
    //   355: ifnull +7 -> 362
    //   358: aload_1
    //   359: invokevirtual 748	java/io/OutputStream:close	()V
    //   362: ldc_w 664
    ...
    //   445: i2d
    //   446: ddiv
    //   447: invokestatic 756	java/lang/Math:ceil	(D)D
    //   450: d2i
    //   451: istore_3
    //   452: iload 5
    //   454: istore_2
    //   455: aload_1
    //   456: invokestatic 761	com/tencent/mm/sdk/platformtools/BackwardSupportUtil$ExifHelper:getExifOrientation	(Ljava/lang/String;)I
    //   459: istore 4
    //   461: iload 4
    //   463: bipush 90
    //   465: if_icmpeq +526 -> 991
    //   468: iload 4
    //   470: sipush 270
    //   473: if_icmpne +467 -> 940
    //   476: goto +515 -> 991
    //   479: ldc 65
    //   481: ldc_w 763
    //   484: iconst_4
    ...
    //   527: iload_3
    //   528: iconst_1
    //   529: invokestatic 767	android/graphics/Bitmap:createScaledBitmap	(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    //   532: astore 23
    //   534: aload_0
    //   535: astore 21
    //   537: aload 23
    ...
    //   542: aload_0
    //   543: aload 23
    //   545: if_acmpeq +457 -> 1002
    //   548: invokestatic 773	com/tencent/mm/memory/l:aRY	()Lcom/tencent/mm/memory/l;
    //   551: aload_0
    //   552: invokevirtual 777	com/tencent/mm/memory/l:x	(Landroid/graphics/Bitmap;)V
    //   555: goto +447 -> 1002
    //   558: ldc 65
    //   560: ldc_w 779
    //   563: iconst_2
    ...
    //   592: invokestatic 782	com/tencent/mm/plugin/sns/storage/r:ffd	()Z
    //   595: ifeq +235 -> 830
    //   598: iload 10
    //   600: ifeq +230 -> 830
    //   603: aload 21
    ...
    //   626: invokestatic 785	com/tencent/mm/plugin/sns/storage/r:b	(Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;)Z
    //   629: ifne +308 -> 937
    ...
    //   652: invokestatic 532	com/tencent/mm/vfs/s:deleteFile	(Ljava/lang/String;)Z
    //   655: pop
    ...
    //   676: iconst_0
    //   677: invokestatic 789	com/tencent/mm/vfs/s:dw	(Ljava/lang/String;Z)Ljava/io/OutputStream;
    //   680: astore 8
    //   682: aload 8
    //   684: astore_0
    //   685: aload 8
    ...
    //   694: aload 8
    //   696: iconst_0
    //   697: invokestatic 793	com/tencent/mm/sdk/platformtools/BitmapUtil:saveBitmapToStream	(Landroid/graphics/Bitmap;ILandroid/graphics/Bitmap$CompressFormat;Ljava/io/OutputStream;Z)Z
    //   700: pop
    //   701: aload 8
    //   703: astore_0
    //   704: aload 8
    //   706: astore_1
    //   707: aload 8
    //   709: invokevirtual 748	java/io/OutputStream:close	()V
    //   712: invokestatic 773	com/tencent/mm/memory/l:aRY	()Lcom/tencent/mm/memory/l;
    //   715: aload 21
    //   717: invokevirtual 777	com/tencent/mm/memory/l:x	(Landroid/graphics/Bitmap;)V
    //   720: ldc_w 664
    //   723: invokestatic 44	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   726: iconst_1
    //   727: ireturn
    //   728: iload 4
    //   730: i2d
    ...
    //   739: dstore 11
    //   741: dload 11
    //   743: invokestatic 756	java/lang/Math:ceil	(D)D
    //   746: d2i
    //   747: istore_2
    //   748: iload 4
    //   750: istore_3
    ...
    //   756: ldc_w 795
    //   759: iconst_2
    //   760: anewarray 69	java/lang/Object
    //   763: dup
    //   764: iconst_0
    //   765: aload_0
    //   766: invokevirtual 651	android/graphics/Bitmap:getWidth	()I
    //   769: invokestatic 503	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   772: aastore
    //   773: dup
    //   774: iconst_1
    //   775: aload_0
    //   776: invokevirtual 654	android/graphics/Bitmap:getHeight	()I
    //   779: invokestatic 503	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   782: aastore
    //   783: invokestatic 74	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   786: aload_0
    //   787: astore 21
    //   789: goto -197 -> 592
    //   792: astore_0
    ...
    //   799: ldc_w 740
    //   802: iconst_1
    //   803: anewarray 69	java/lang/Object
    //   806: dup
    //   807: iconst_0
    //   808: aload 9
    //   810: aastore
    //   811: invokestatic 551	com/tencent/mm/sdk/platformtools/Log:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   814: aload_1
    //   815: ifnull +7 -> 822
    //   818: aload_1
    //   819: invokevirtual 748	java/io/OutputStream:close	()V
    //   822: ldc_w 664
    //   825: invokestatic 44	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   828: iconst_0
    //   829: ireturn
    //   830: new 97	java/lang/StringBuilder
    //   833: dup
    //   834: invokespecial 98	java/lang/StringBuilder:<init>	()V
    //   837: aload 8
    //   839: invokevirtual 102	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   842: aload 9
    //   844: invokevirtual 102	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   847: invokevirtual 108	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   850: iconst_0
    //   851: invokestatic 789	com/tencent/mm/vfs/s:dw	(Ljava/lang/String;Z)Ljava/io/OutputStream;
    //   854: astore 8
    //   856: aload 8
    //   858: astore_0
    //   859: aload 8
    ...
    //   868: aload 8
    //   870: iconst_0
    //   871: invokestatic 793	com/tencent/mm/sdk/platformtools/BitmapUtil:saveBitmapToStream	(Landroid/graphics/Bitmap;ILandroid/graphics/Bitmap$CompressFormat;Ljava/io/OutputStream;Z)Z
    //   874: pop
    //   875: aload 8
    //   877: astore_0
    //   878: aload 8
    //   880: astore_1
    //   881: invokestatic 773	com/tencent/mm/memory/l:aRY	()Lcom/tencent/mm/memory/l;
    //   884: aload 21
    //   886: invokevirtual 777	com/tencent/mm/memory/l:x	(Landroid/graphics/Bitmap;)V
    //   889: aload 8
    //   891: astore_0
    //   892: aload 8
    //   894: astore_1
    //   895: aload 8
    //   897: invokevirtual 748	java/io/OutputStream:close	()V
    //   900: goto -180 -> 720
    //   903: astore 6
    //   905: aload_0
    //   906: astore_1
    ...
    //   0	1009	0	paramOptions	BitmapFactory.Options
    //   0	1009	1	paramString1	String
    //   0	1009	2	paramInt1	int
    //   0	1009	3	paramInt2	int
    //   0	1009	4	paramInt3	int
    //   0	1009	5	paramInt4	int
    //   0	1009	6	paramCompressFormat	Bitmap.CompressFormat
    //   0	1009	7	paramInt5	int
    //   0	1009	8	paramString2	String
    //   0	1009	9	paramString3	String
    //   0	1009	10	paramBoolean	boolean
    //   117	863	11	d1	double
    //   127	847	13	d2	double
    //   378	606	15	d3	double
    //   217	750	17	i	int
    //   242	745	18	j	int
    //   283	19	19	l	long
    //   58	947	21	localObject1	Object
    //   7	787	22	localObject2	Object
    //   532	471	23	localBitmap	Bitmap
    // Exception table:
    //   from	to	target	type
    ...
    //   603	682	322	java/lang/OutOfMemoryError
    //   741	748	322	java/lang/OutOfMemoryError
    //   754	786	322	java/lang/OutOfMemoryError
    //   830	856	322	java/lang/OutOfMemoryError
    //   9	68	792	java/io/IOException
    //   72	98	792	java/io/IOException
    //   98	109	792	java/io/IOException
    //   109	129	792	java/io/IOException
    //   141	148	792	java/io/IOException
    //   148	164	792	java/io/IOException
    //   176	182	792	java/io/IOException
    //   194	216	792	java/io/IOException
    //   219	237	792	java/io/IOException
    //   240	262	792	java/io/IOException
    //   262	285	792	java/io/IOException
    //   285	319	792	java/io/IOException
    //   390	420	792	java/io/IOException
    //   436	452	792	java/io/IOException
    //   455	461	792	java/io/IOException
    //   479	534	792	java/io/IOException
    //   548	555	792	java/io/IOException
    //   558	592	792	java/io/IOException
    //   592	598	792	java/io/IOException
    //   603	682	792	java/io/IOException
    //   741	748	792	java/io/IOException
    //   754	786	792	java/io/IOException
    //   830	856	792	java/io/IOException
    //   688	701	903	java/lang/OutOfMemoryError
    //   707	712	903	java/lang/OutOfMemoryError
    //   862	875	903	java/lang/OutOfMemoryError
    //   881	889	903	java/lang/OutOfMemoryError
    //   895	900	903	java/lang/OutOfMemoryError
    //   358	362	913	java/io/IOException
    //   818	822	917	java/io/IOException
    //   688	701	921	java/io/IOException
    //   707	712	921	java/io/IOException
    //   862	875	921	java/io/IOException
    //   881	889	921	java/io/IOException
    //   895	900	921	java/io/IOException
    //   712	720	925	java/io/IOException
    //   712	720	931	java/lang/OutOfMemoryError
  }
  ...
  private static boolean a(BitmapFactory.Options paramOptions, String paramString1, int paramInt1, int paramInt2, int paramInt3, Bitmap.CompressFormat paramCompressFormat, int paramInt4, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      catch (OutOfMemoryError paramOptions)
      {
        ...
        com.tencent.mm.plugin.report.service.h.CyF.n(1487L, 0L, 1L);
      ...
      catch (IOException paramOptions)
      {
        try
        {
          ...
          if ((ffd()) && (paramBoolean))
          {
            ...
            {
              localObject1 = localObject3;
              s.deleteFile(paramString2 + paramString3);
              localObject1 = localObject3;
              paramString1 = s.dw(paramString2 + paramString3, false);
          ...
          try
          {
            ...
            localObject1 = null;
            Log.i("MicroMsg.snsMediaStorage", "createThumbNailUnScaleFixShort saving to %s, size:%d", new Object[] { paramString2 + paramString3, Long.valueOf(s.boW(paramString2 + paramString3)) });
            AppMethodBeat.o(203214);
            return true;
          }
    ...
    localObject1 = localObject3;
    l = ((com.tencent.mm.plugin.expt.b.b)com.tencent.mm.kernel.g.af(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.rPQ, 10240000);
    for (;;)
    {
      localObject1 = localObject3;
  ...
  private boolean a(q paramq)
  {
    ...
    paramq = paramq.feY();
    if ((int)this.iFy.insert("SnsMedia", "local_id", paramq) != -1)
    {
      AppMethodBeat.o(97599);
      return true;
    }
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, float paramFloat)
  {
    ...
    try
    {
      localObject3 = s.openRead(paramString1 + paramString2);
    }
    catch (Exception localException1)
    {
      for (;;)
  ...
  private static byte[] aB(Bitmap paramBitmap)
  {
  ...
  private static String aQD(String paramString)
  {
  ...
  public static boolean aQF(String paramString)
  {
    ...
    //   8: aload_0
    //   9: invokestatic 590	com/tencent/mm/vfs/s:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   12: astore_0
    //   13: aload_0
    //   14: astore_2
    ...
    //   33: aconst_null
    //   34: aload_3
    //   35: invokestatic 832	com/tencent/mm/graphics/MMBitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   38: pop
    //   39: aload_0
    //   40: astore_2
    //   41: aload_3
    //   42: getfield 837	android/graphics/BitmapFactory$Options:outMimeType	Ljava/lang/String;
    //   45: astore_3
    //   46: aload_0
    //   47: astore_2
    //   48: ldc 65
    ...
    //   64: astore_2
    //   65: aload_3
    //   66: invokevirtual 889	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   69: ldc_w 891
    //   72: invokevirtual 894	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   75: istore_1
    //   76: iload_1
    //   77: iflt +19 -> 96
    //   80: aload_0
  ...
  public static boolean aR(String paramString1, String paramString2, String paramString3)
  {
    AppMethodBeat.i(258599);
    boolean bool = f(paramString1, paramString2, paramString3, true);
  ...
  private static boolean b(Bitmap paramBitmap, String paramString1, String paramString2)
  {
    ...
    try
    {
      byte[] arrayOfByte = aB(paramBitmap);
      e.cEM();
      if (e.a(arrayOfByte, paramString1, paramString2, paramBitmap.getWidth(), paramBitmap.getHeight(), paramBitmap.getWidth(), paramBitmap.getHeight()) == 0)
      {
  ...
  private boolean b(String paramString, q paramq)
  {
    ...
    paramq = paramq.feY();
    if (this.iFy.update("SnsMedia", paramq, "StrId=?", new String[] { String.valueOf(paramString) }) > 0)
    {
  ...
  public static boolean b(String paramString1, String paramString2, String paramString3, float paramFloat)
  {
    ...
    for (;;)
    {
      try
      {
        s.deleteFile(paramString1 + paramString3);
      ...
      catch (OutOfMemoryError paramString1)
      {
        ...
        com.tencent.mm.plugin.report.service.h.CyF.n(1487L, 2L, 1L);
        AppMethodBeat.o(97618);
        return false;
        ...
        localObject2 = l.aRY().a(str, (Rect)localObject2, (BitmapFactory.Options)localObject1);
        localObject1 = localObject2;
        if (localObject2 == null) {
          continue;
        }
        localObject1 = com.tencent.mm.plugin.sns.data.r.t(str, (Bitmap)localObject2);
      ...
      s.deleteFile(paramString1 + paramString2);
      AppMethodBeat.o(97618);
      return false;
  ...
  public static boolean f(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    //   3: invokestatic 22	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: aload_1
    //   7: invokestatic 822	com/tencent/mm/sdk/platformtools/BitmapUtil:getImageOptions	(Ljava/lang/String;)Landroid/graphics/BitmapFactory$Options;
    //   10: astore 20
    //   12: aload 20
    //   14: ifnull +1047 -> 1061
    //   17: aload 20
    //   19: getfield 837	android/graphics/BitmapFactory$Options:outMimeType	Ljava/lang/String;
    //   22: astore 21
    //   24: ldc 65
    //   26: ldc_w 1003
    //   29: aload 21
    ...
    //   42: ifnull +1019 -> 1061
    //   45: aload 21
    //   47: invokevirtual 889	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   50: astore 21
    //   52: aload 21
    //   54: ldc_w 1005
    //   57: invokevirtual 894	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   60: iflt +967 -> 1027
    //   63: iconst_1
    //   64: istore 16
    //   66: aload 20
    //   68: ifnull +1016 -> 1084
    //   71: aload 20
    //   73: getfield 837	android/graphics/BitmapFactory$Options:outMimeType	Ljava/lang/String;
    //   76: astore 21
    //   78: aload 21
    //   80: ifnull +1004 -> 1084
    //   83: aload 21
    //   85: invokevirtual 889	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   88: astore 21
    //   90: aload 21
    //   92: ldc_w 1005
    //   95: invokevirtual 894	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   98: iflt +969 -> 1067
    //   101: iconst_1
    //   102: istore 17
    //   104: aload 20
    //   106: ifnull +27 -> 133
    //   109: aload 20
    //   111: getfield 837	android/graphics/BitmapFactory$Options:outMimeType	Ljava/lang/String;
    //   114: astore 21
    //   116: aload 21
    //   118: ifnull +15 -> 133
    //   121: aload 21
    //   123: invokevirtual 889	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   126: ldc_w 931
    //   129: invokevirtual 894	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   132: pop
    //   133: iconst_m1
    //   134: istore 8
    //   136: bipush 100
    ...
    //   144: iload_3
    //   145: ifeq +242 -> 387
    //   148: invokestatic 1011	com/tencent/mm/an/f:baQ	()Lcom/tencent/mm/an/b;
    //   151: pop
    //   152: bipush 64
    //   154: invokestatic 1017	com/tencent/mm/an/b:sS	(I)Z
    //   157: ifne +21 -> 178
    //   160: invokestatic 1020	com/tencent/mm/plugin/sns/storage/r:ffc	()Z
    //   163: ifne +15 -> 178
    //   166: invokestatic 1023	com/tencent/mm/plugin/sns/storage/r:ffe	()Z
    //   169: ifne +9 -> 178
    //   172: invokestatic 782	com/tencent/mm/plugin/sns/storage/r:ffd	()Z
    //   175: ifeq +990 -> 1165
    //   178: invokestatic 1029	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   181: invokestatic 1035	com/tencent/mm/sdk/platformtools/NetStatusUtil:isWifi	(Landroid/content/Context;)Z
    //   184: ifeq +906 -> 1090
    //   187: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   190: ldc_w 1043
    //   193: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   196: bipush 70
    //   198: invokestatic 1052	com/tencent/mm/sdk/platformtools/Util:getInt	(Ljava/lang/String;I)I
    //   201: istore 7
    //   203: ldc 65
    //   205: ldc_w 1054
    //   208: bipush 7
    ...
    //   213: dup
    //   214: iconst_0
    //   215: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   218: ldc_w 1043
    //   221: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   224: aastore
    //   225: dup
    //   226: iconst_1
    //   227: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   230: ldc_w 1056
    //   233: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   236: aastore
    //   237: dup
    //   238: iconst_2
    //   239: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   242: ldc_w 1058
    //   245: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   248: aastore
    //   249: dup
    //   250: iconst_3
    //   251: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   254: ldc_w 1060
    //   257: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   260: aastore
    //   261: dup
    //   262: iconst_4
    //   263: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   266: ldc_w 1062
    //   269: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   272: aastore
    //   273: dup
    //   274: iconst_5
    //   275: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   278: ldc_w 1064
    //   281: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   284: aastore
    //   285: dup
    //   286: bipush 6
    //   288: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   291: ldc_w 1066
    //   294: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   297: aastore
    //   298: invokestatic 939	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   301: ldc 65
    //   303: ldc_w 1068
    //   306: iconst_2
    ...
    //   319: iconst_1
    //   320: iload_3
    //   321: invokestatic 1073	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   324: aastore
    ...
    //   356: ifeq +31 -> 387
    //   359: aload_1
    //   360: invokestatic 1078	com/tencent/mm/sdk/platformtools/MMNativeJpeg:queryQuality	(Ljava/lang/String;)I
    //   363: istore 8
    //   365: iload 8
    //   367: iload 7
    ...
    //   385: istore 10
    //   387: aload_1
    //   388: invokestatic 188	com/tencent/mm/vfs/s:boW	(Ljava/lang/String;)J
    //   391: l2i
    //   392: istore 14
    //   394: sipush 1080
    //   397: istore 8
    //   399: aload_1
    //   400: invokestatic 1083	com/tencent/mm/plugin/facedetect/FaceProNative:detectFaceCnt	(Ljava/lang/String;)I
    //   403: istore 7
    //   405: ldc 65
    //   407: ldc_w 1085
    //   410: iconst_1
    ...
    //   445: iload 11
    //   447: istore 7
    //   449: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   452: ldc_w 1087
    //   455: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   458: astore 21
    //   460: iload 11
    //   462: istore 7
    //   464: aload 21
    //   466: ldc_w 1089
    //   469: invokevirtual 1093	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   472: iconst_0
    //   473: aaload
    //   474: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   477: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   480: istore 11
    //   482: iload 11
    //   484: istore 7
    //   486: aload 21
    //   488: ldc_w 1089
    //   491: invokevirtual 1093	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   494: iconst_1
    //   495: aaload
    //   496: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   499: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   502: istore 12
    //   504: iload 12
    //   506: istore 8
    //   508: iload 11
    ...
    //   538: dup
    //   539: iconst_2
    //   540: getstatic 34	com/tencent/mm/plugin/sns/storage/r:DuA	I
    //   543: invokestatic 503	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   546: aastore
    //   547: dup
    //   548: iconst_3
    //   549: getstatic 32	com/tencent/mm/plugin/sns/storage/r:Dvt	I
    ...
    //   565: iconst_5
    //   566: iload_3
    //   567: invokestatic 1073	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   570: aastore
    ...
    //   587: sipush 1080
    //   590: istore 8
    //   592: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   595: ldc_w 1103
    //   598: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   601: bipush 100
    //   603: invokestatic 1052	com/tencent/mm/sdk/platformtools/Util:getInt	(Ljava/lang/String;I)I
    //   606: istore 12
    //   608: iload 12
    //   610: istore 11
    //   612: iload 12
    ...
    //   626: imul
    //   627: istore 13
    //   629: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   632: ldc_w 1105
    //   635: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   638: sipush 200
    //   641: invokestatic 1052	com/tencent/mm/sdk/platformtools/Util:getInt	(Ljava/lang/String;I)I
    //   644: istore 12
    //   646: iload 12
    //   648: istore 11
    //   650: iload 12
    ...
    //   665: imul
    //   666: istore 15
    //   668: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   671: ldc_w 1107
    //   674: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   677: bipush 10
    //   679: invokestatic 1052	com/tencent/mm/sdk/platformtools/Util:getInt	(Ljava/lang/String;I)I
    //   682: istore 12
    //   684: iload 12
    //   686: ifle +10 -> 696
    //   689: iload 12
    ...
    //   770: iload 16
    //   772: invokevirtual 1114	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   775: ldc_w 1116
    ...
    //   836: iload 17
    //   838: invokevirtual 1114	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    ...
    //   847: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   850: ldc_w 1126
    //   853: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   856: bipush 10
    //   858: invokestatic 1052	com/tencent/mm/sdk/platformtools/Util:getInt	(Ljava/lang/String;I)I
    //   861: pop
    //   862: aload 20
    ...
    //   921: iload 11
    //   923: ifne +789 -> 1712
    //   926: invokestatic 782	com/tencent/mm/plugin/sns/storage/r:ffd	()Z
    //   929: ifeq +724 -> 1653
    //   932: iload_3
    //   933: ifeq +720 -> 1653
    //   936: aload_1
    ...
    //   955: invokestatic 1130	com/tencent/mm/plugin/sns/storage/r:kM	(Ljava/lang/String;Ljava/lang/String;)Z
    //   958: istore 16
    //   960: iload 16
    //   962: istore_3
    //   963: iload 16
    ...
    //   986: invokestatic 532	com/tencent/mm/vfs/s:deleteFile	(Ljava/lang/String;)Z
    //   989: pop
    //   990: aload_1
    ...
    //   1009: invokestatic 523	com/tencent/mm/vfs/s:nw	(Ljava/lang/String;Ljava/lang/String;)J
    //   1012: lconst_0
    //   1013: lcmp
    //   1014: iflt +634 -> 1648
    //   1017: iconst_1
    ...
    //   1027: aload 21
    //   1029: ldc_w 1132
    //   1032: invokevirtual 894	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   1035: iflt +9 -> 1044
    //   1038: iconst_1
    //   1039: istore 16
    //   1041: goto -975 -> 66
    //   1044: aload 21
    //   1046: ldc_w 924
    //   1049: invokevirtual 894	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   1052: iflt +9 -> 1061
    //   1055: iconst_1
    //   1056: istore 16
    //   1058: goto -992 -> 66
    ...
    //   1067: aload 21
    //   1069: ldc_w 1132
    //   1072: invokevirtual 894	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   1075: iflt +9 -> 1084
    //   1078: iconst_1
    //   1079: istore 17
    //   1081: goto -977 -> 104
    ...
    //   1085: istore 17
    //   1087: goto -983 -> 104
    //   1090: invokestatic 1029	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   1093: invokestatic 1135	com/tencent/mm/sdk/platformtools/NetStatusUtil:is2G	(Landroid/content/Context;)Z
    //   1096: ifeq +22 -> 1118
    //   1099: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   1102: ldc_w 1056
    //   1105: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   1108: bipush 70
    //   1110: invokestatic 1052	com/tencent/mm/sdk/platformtools/Util:getInt	(Ljava/lang/String;I)I
    //   1113: istore 7
    //   1115: goto -912 -> 203
    //   1118: invokestatic 1029	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   1121: invokestatic 1138	com/tencent/mm/sdk/platformtools/NetStatusUtil:is3G	(Landroid/content/Context;)Z
    //   1124: ifeq +22 -> 1146
    //   1127: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   1130: ldc_w 1058
    //   1133: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   1136: bipush 60
    //   1138: invokestatic 1052	com/tencent/mm/sdk/platformtools/Util:getInt	(Ljava/lang/String;I)I
    //   1141: istore 7
    //   1143: goto -940 -> 203
    //   1146: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   1149: ldc_w 1060
    //   1152: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   1155: bipush 60
    //   1157: invokestatic 1052	com/tencent/mm/sdk/platformtools/Util:getInt	(Ljava/lang/String;I)I
    //   1160: istore 7
    //   1162: goto -959 -> 203
    //   1165: invokestatic 1029	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   1168: invokestatic 1035	com/tencent/mm/sdk/platformtools/NetStatusUtil:isWifi	(Landroid/content/Context;)Z
    //   1171: ifeq +23 -> 1194
    //   1174: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   1177: ldc_w 1062
    //   1180: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   1183: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   1186: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   1189: istore 7
    //   1191: goto -988 -> 203
    //   1194: invokestatic 1029	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   1197: invokestatic 1135	com/tencent/mm/sdk/platformtools/NetStatusUtil:is2G	(Landroid/content/Context;)Z
    //   1200: ifeq +23 -> 1223
    //   1203: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   1206: ldc_w 1064
    //   1209: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   1212: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   1215: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   1218: istore 7
    //   1220: goto -1017 -> 203
    //   1223: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   1226: ldc_w 1066
    //   1229: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   1232: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   1235: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   1238: istore 7
    //   1240: goto -1037 -> 203
    //   1243: iload 11
    //   1245: istore 7
    //   1247: invokestatic 1029	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   1250: invokestatic 1035	com/tencent/mm/sdk/platformtools/NetStatusUtil:isWifi	(Landroid/content/Context;)Z
    //   1253: ifeq +73 -> 1326
    //   1256: iload 11
    //   1258: istore 7
    //   1260: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   1263: ldc_w 1140
    //   1266: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   1269: astore 21
    //   1271: iload 11
    //   1273: istore 7
    //   1275: aload 21
    //   1277: ldc_w 1089
    //   1280: invokevirtual 1093	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   1283: iconst_0
    //   1284: aaload
    //   1285: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   1288: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   1291: istore 11
    //   1293: iload 11
    //   1295: istore 7
    //   1297: aload 21
    //   1299: ldc_w 1089
    //   1302: invokevirtual 1093	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   1305: iconst_1
    //   1306: aaload
    //   1307: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   1310: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   1313: istore 12
    //   1315: iload 12
    //   1317: istore 8
    //   1319: iload 11
    ...
    //   1326: iload 11
    //   1328: istore 7
    //   1330: invokestatic 1029	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   1333: invokestatic 1135	com/tencent/mm/sdk/platformtools/NetStatusUtil:is2G	(Landroid/content/Context;)Z
    //   1336: ifeq +73 -> 1409
    //   1339: iload 11
    //   1341: istore 7
    //   1343: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   1346: ldc_w 1142
    //   1349: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   1352: astore 21
    //   1354: iload 11
    //   1356: istore 7
    //   1358: aload 21
    //   1360: ldc_w 1089
    //   1363: invokevirtual 1093	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   1366: iconst_0
    //   1367: aaload
    //   1368: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   1371: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   1374: istore 11
    //   1376: iload 11
    //   1378: istore 7
    //   1380: aload 21
    //   1382: ldc_w 1089
    //   1385: invokevirtual 1093	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   1388: iconst_1
    //   1389: aaload
    //   1390: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   1393: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   1396: istore 12
    //   1398: iload 12
    //   1400: istore 8
    //   1402: iload 11
    ...
    //   1409: iload 11
    //   1411: istore 7
    //   1413: invokestatic 1029	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    //   1416: invokestatic 1138	com/tencent/mm/sdk/platformtools/NetStatusUtil:is3G	(Landroid/content/Context;)Z
    //   1419: ifeq +73 -> 1492
    //   1422: iload 11
    //   1424: istore 7
    //   1426: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   1429: ldc_w 1144
    //   1432: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   1435: astore 21
    //   1437: iload 11
    //   1439: istore 7
    //   1441: aload 21
    //   1443: ldc_w 1089
    //   1446: invokevirtual 1093	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   1449: iconst_0
    //   1450: aaload
    //   1451: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   1454: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   1457: istore 11
    //   1459: iload 11
    //   1461: istore 7
    //   1463: aload 21
    //   1465: ldc_w 1089
    //   1468: invokevirtual 1093	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   1471: iconst_1
    //   1472: aaload
    //   1473: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   1476: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   1479: istore 12
    //   1481: iload 12
    //   1483: istore 8
    //   1485: iload 11
    ...
    //   1492: iload 11
    //   1494: istore 7
    //   1496: invokestatic 1041	com/tencent/mm/n/h:aqJ	()Lcom/tencent/mm/n/f;
    //   1499: ldc_w 1146
    //   1502: invokevirtual 1048	com/tencent/mm/n/f:getValue	(Ljava/lang/String;)Ljava/lang/String;
    //   1505: astore 21
    //   1507: iload 11
    //   1509: istore 7
    //   1511: aload 21
    //   1513: ldc_w 1089
    //   1516: invokevirtual 1093	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   1519: iconst_0
    //   1520: aaload
    //   1521: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   1524: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   1527: istore 11
    //   1529: iload 11
    //   1531: istore 7
    //   1533: aload 21
    //   1535: ldc_w 1089
    //   1538: invokevirtual 1093	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   1541: iconst_1
    //   1542: aaload
    //   1543: invokestatic 1096	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   1546: invokevirtual 1099	java/lang/Integer:intValue	()I
    //   1549: istore 12
    //   1551: iload 12
    //   1553: istore 8
    //   1555: iload 11
    ...
    //   1619: aload 21
    //   1621: invokevirtual 998	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   1636: goto -906 -> 730
    //   1639: aload_1
    //   1640: invokestatic 761	com/tencent/mm/sdk/platformtools/BackwardSupportUtil$ExifHelper:getExifOrientation	(Ljava/lang/String;)I
    //   1643: istore 11
    //   1645: goto -915 -> 730
    //   1648: iconst_0
    //   1649: istore_3
    ...
    //   1688: invokestatic 523	com/tencent/mm/vfs/s:nw	(Ljava/lang/String;Ljava/lang/String;)J
    //   1691: lconst_0
    //   1692: lcmp
    //   1693: iflt +11 -> 1704
    //   1696: ldc_w 1001
    ...
    //   1719: astore 24
    //   1721: aload 24
    //   1723: invokestatic 1154	com/tencent/mm/sdk/platformtools/BitmapUtil:bindlowMemeryOption	(Landroid/graphics/BitmapFactory$Options;)V
    //   1726: aconst_null
    //   1727: astore 21
    //   1729: aconst_null
    //   1730: astore 20
    //   1732: aload_1
    //   1733: invokestatic 590	com/tencent/mm/vfs/s:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   1736: astore 23
    //   1738: aload 23
    //   1740: astore 22
    //   1742: aload 23
    ...
    //   1803: aconst_null
    //   1804: aload 24
    //   1806: invokestatic 832	com/tencent/mm/graphics/MMBitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   1809: astore 23
    //   1811: aload 22
    //   1813: astore 20
    //   1815: aload 22
    ...
    //   1860: aload 23
    //   1862: fload 6
    //   1864: invokestatic 905	com/tencent/mm/sdk/platformtools/BitmapUtil:rotate	(Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;
    //   1867: astore 23
    //   1869: aload 22
    //   1871: astore 20
    //   1873: aload 22
    //   1875: astore 21
    //   1877: invokestatic 782	com/tencent/mm/plugin/sns/storage/r:ffd	()Z
    //   1880: ifeq +396 -> 2276
    //   1883: iload_3
    //   1884: ifeq +392 -> 2276
    //   1887: aload 22
    ...
    //   1916: invokestatic 785	com/tencent/mm/plugin/sns/storage/r:b	(Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;)Z
    //   1919: ifne +71 -> 1990
    //   1922: aload 22
    //   1924: astore 20
    //   1926: aload 22
    ...
    //   1948: invokestatic 532	com/tencent/mm/vfs/s:deleteFile	(Ljava/lang/String;)Z
    //   1951: pop
    //   1952: aload 22
    //   1954: astore 20
    //   1956: aload 22
    ...
    //   1960: aload 23
    //   1962: iload 9
    //   1964: getstatic 855	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    ...
    //   1985: iconst_1
    //   1986: invokestatic 993	com/tencent/mm/sdk/platformtools/BitmapUtil:saveBitmapToImage	(Landroid/graphics/Bitmap;ILandroid/graphics/Bitmap$CompressFormat;Ljava/lang/String;Z)Z
    //   1989: pop
    //   1990: aload 23
    //   1992: ifnull +32 -> 2024
    //   1995: aload 22
    ...
    //   2001: astore 21
    //   2003: aload 23
    //   2005: invokevirtual 1157	android/graphics/Bitmap:isRecycled	()Z
    //   2008: ifne +16 -> 2024
    //   2011: aload 22
    //   2013: astore 20
    //   2015: aload 22
    //   2017: astore 21
    //   2019: aload 23
    //   2021: invokevirtual 1160	android/graphics/Bitmap:recycle	()V
    //   2024: iload 16
    //   2026: ifeq +421 -> 2447
    //   2029: iload 11
    //   2031: ifne +416 -> 2447
    ...
    //   2060: invokestatic 188	com/tencent/mm/vfs/s:boW	(Ljava/lang/String;)J
    //   2063: lstore 18
    //   2065: aload 22
    //   2067: astore 20
    //   2069: aload 22
    ...
    //   2091: iconst_1
    //   2092: lload 18
    //   2094: invokestatic 812	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   2097: aastore
    //   2098: dup
    //   2099: iconst_2
    //   2100: iload 12
    ...
    //   2155: invokestatic 532	com/tencent/mm/vfs/s:deleteFile	(Ljava/lang/String;)Z
    //   2158: pop
    //   2159: aload 22
    //   2161: astore 20
    //   2163: aload 22
    //   2165: astore 21
    //   2167: invokestatic 782	com/tencent/mm/plugin/sns/storage/r:ffd	()Z
    //   2170: ifeq +195 -> 2365
    //   2173: iload_3
    //   2174: ifeq +191 -> 2365
    //   2177: aload 22
    ...
    //   2204: invokestatic 1130	com/tencent/mm/plugin/sns/storage/r:kM	(Ljava/lang/String;Ljava/lang/String;)Z
    //   2207: istore 16
    //   2209: iload 16
    //   2211: istore_3
    //   2212: iload 16
    ...
    //   2244: invokestatic 523	com/tencent/mm/vfs/s:nw	(Ljava/lang/String;Ljava/lang/String;)J
    //   2247: lstore 18
    //   2249: lload 18
    //   2251: lconst_0
    //   2252: lcmp
    ...
    //   2284: aload 23
    //   2286: iload 9
    //   2288: getstatic 855	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    ...
    //   2309: iconst_1
    //   2310: invokestatic 993	com/tencent/mm/sdk/platformtools/BitmapUtil:saveBitmapToImage	(Landroid/graphics/Bitmap;ILandroid/graphics/Bitmap$CompressFormat;Ljava/lang/String;Z)Z
    //   2313: pop
    //   2314: goto -290 -> 2024
    //   2317: astore_0
    //   2318: aload 20
    ...
    //   2392: invokestatic 523	com/tencent/mm/vfs/s:nw	(Ljava/lang/String;Ljava/lang/String;)J
    //   2395: lstore 18
    //   2397: lload 18
    //   2399: lconst_0
    //   2400: lcmp
    ...
    //   2595: idiv
    //   2596: i2d
    //   2597: invokestatic 1171	java/lang/Math:sqrt	(D)D
    //   2600: d2i
    //   2601: istore 7
    //   2603: aload 20
    ...
    //   2669: iload 7
    //   2671: iload 10
    //   2673: getstatic 855	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   2676: iload 9
    //   2678: aload_0
    //   2679: aload_2
    //   2680: iload_3
    //   2681: invokestatic 1175	com/tencent/mm/plugin/sns/storage/r:a	(Ljava/lang/String;IILandroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;Ljava/lang/String;Z)Z
    //   2684: istore_3
    //   2685: ldc_w 1001
    ...
    //   2760: invokestatic 782	com/tencent/mm/plugin/sns/storage/r:ffd	()Z
    //   2763: ifeq +103 -> 2866
    //   2766: iload_3
    //   2767: ifeq +99 -> 2866
    //   2770: aload_1
    ...
    //   2789: invokestatic 1130	com/tencent/mm/plugin/sns/storage/r:kM	(Ljava/lang/String;Ljava/lang/String;)Z
    //   2792: istore 16
    //   2794: iload 16
    //   2796: istore_3
    //   2797: iload 16
    ...
    //   2820: invokestatic 532	com/tencent/mm/vfs/s:deleteFile	(Ljava/lang/String;)Z
    //   2823: pop
    //   2824: aload_1
    ...
    //   2843: invokestatic 523	com/tencent/mm/vfs/s:nw	(Ljava/lang/String;Ljava/lang/String;)J
    //   2846: lconst_0
    //   2847: lcmp
    //   2848: iflt +13 -> 2861
    //   2851: iconst_1
    ...
    //   2885: invokestatic 523	com/tencent/mm/vfs/s:nw	(Ljava/lang/String;Ljava/lang/String;)J
    //   2888: lconst_0
    //   2889: lcmp
    //   2890: iflt +11 -> 2901
    //   2893: ldc_w 1001
    ...
    //   3015: aload_1
    //   3016: invokestatic 188	com/tencent/mm/vfs/s:boW	(Ljava/lang/String;)J
    //   3019: ldc2_w 1180
    //   3022: lcmp
    //   3023: ifge +246 -> 3269
    //   3026: iload 16
    ...
    //   3047: invokestatic 782	com/tencent/mm/plugin/sns/storage/r:ffd	()Z
    //   3050: ifeq +123 -> 3173
    //   3053: iload_3
    //   3054: ifeq +119 -> 3173
    //   3057: aload_1
    ...
    //   3076: invokestatic 1130	com/tencent/mm/plugin/sns/storage/r:kM	(Ljava/lang/String;Ljava/lang/String;)Z
    //   3079: istore 16
    //   3081: iload 16
    //   3083: istore_3
    //   3084: iload 16
    ...
    //   3107: invokestatic 532	com/tencent/mm/vfs/s:deleteFile	(Ljava/lang/String;)Z
    //   3110: pop
    //   3111: aload_1
    ...
    //   3130: invokestatic 523	com/tencent/mm/vfs/s:nw	(Ljava/lang/String;Ljava/lang/String;)J
    //   3133: lconst_0
    //   3134: lcmp
    //   3135: iflt +33 -> 3168
    //   3138: iconst_1
    ...
    //   3192: invokestatic 523	com/tencent/mm/vfs/s:nw	(Ljava/lang/String;Ljava/lang/String;)J
    //   3195: lconst_0
    //   3196: lcmp
    //   3197: iflt +11 -> 3208
    //   3200: ldc_w 1001
    ...
    //   3249: getstatic 850	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   3252: iload 9
    //   3254: aload_0
    //   3255: aload_2
    //   3256: iload_3
    //   3257: invokestatic 1175	com/tencent/mm/plugin/sns/storage/r:a	(Ljava/lang/String;IILandroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;Ljava/lang/String;Z)Z
    //   3260: istore_3
    //   3261: ldc_w 1001
    ...
    //   3280: getstatic 855	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   3283: iload 9
    //   3285: aload_0
    //   3286: aload_2
    //   3287: iload_3
    //   3288: invokestatic 1175	com/tencent/mm/plugin/sns/storage/r:a	(Ljava/lang/String;IILandroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;Ljava/lang/String;Z)Z
    //   3291: istore 17
    //   3293: iload 16
    //   3295: ifeq +245 -> 3540
    //   3298: iload 11
    ...
    //   3321: invokestatic 188	com/tencent/mm/vfs/s:boW	(Ljava/lang/String;)J
    //   3324: lstore 18
    //   3326: ldc 65
    //   3328: ldc_w 1162
    //   3331: iconst_3
    ...
    //   3344: iconst_1
    //   3345: lload 18
    //   3347: invokestatic 812	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   3350: aastore
    //   3351: dup
    //   3352: iconst_2
    //   3353: iload 12
    ...
    //   3400: invokestatic 532	com/tencent/mm/vfs/s:deleteFile	(Ljava/lang/String;)Z
    //   3403: pop
    //   3404: invokestatic 782	com/tencent/mm/plugin/sns/storage/r:ffd	()Z
    //   3407: ifeq +81 -> 3488
    //   3410: iload_3
    //   3411: ifeq +77 -> 3488
    //   3414: aload_1
    ...
    //   3433: invokestatic 1130	com/tencent/mm/plugin/sns/storage/r:kM	(Ljava/lang/String;Ljava/lang/String;)Z
    //   3436: istore 16
    //   3438: iload 16
    //   3440: istore_3
    //   3441: iload 16
    ...
    //   3465: invokestatic 523	com/tencent/mm/vfs/s:nw	(Ljava/lang/String;Ljava/lang/String;)J
    //   3468: lconst_0
    //   3469: lcmp
    //   3470: iflt +13 -> 3483
    //   3473: iconst_1
    ...
    //   3507: invokestatic 523	com/tencent/mm/vfs/s:nw	(Ljava/lang/String;Ljava/lang/String;)J
    //   3510: lconst_0
    //   3511: lcmp
    //   3512: iflt +11 -> 3523
    //   3515: ldc_w 1001
    ...
    //   3567: iload 8
    //   3569: getstatic 855	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   3572: iload 9
    //   3574: aload_0
    //   3575: aload_2
    //   3576: iload_3
    //   3577: invokestatic 1185	com/tencent/mm/plugin/sns/storage/r:a	(Landroid/graphics/BitmapFactory$Options;Ljava/lang/String;IIILandroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;Ljava/lang/String;Z)Z
    //   3580: istore 17
    //   3582: iload 16
    //   3584: ifeq +288 -> 3872
    //   3587: iload 11
    ...
    //   3610: invokestatic 188	com/tencent/mm/vfs/s:boW	(Ljava/lang/String;)J
    //   3613: lstore 18
    //   3615: ldc 65
    //   3617: ldc_w 1162
    //   3620: iconst_3
    ...
    //   3633: iconst_1
    //   3634: lload 18
    //   3636: invokestatic 812	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   3639: aastore
    //   3640: dup
    //   3641: iconst_2
    //   3642: iload 12
    ...
    //   3689: invokestatic 532	com/tencent/mm/vfs/s:deleteFile	(Ljava/lang/String;)Z
    //   3692: pop
    //   3693: invokestatic 782	com/tencent/mm/plugin/sns/storage/r:ffd	()Z
    //   3696: ifeq +133 -> 3829
    //   3699: iload_3
    //   3700: ifeq +129 -> 3829
    //   3703: aload_1
    ...
    //   3722: invokestatic 1130	com/tencent/mm/plugin/sns/storage/r:kM	(Ljava/lang/String;Ljava/lang/String;)Z
    //   3725: istore 16
    //   3727: iload 16
    //   3729: istore_3
    //   3730: iload 16
    ...
    //   3754: invokestatic 523	com/tencent/mm/vfs/s:nw	(Ljava/lang/String;Ljava/lang/String;)J
    //   3757: lconst_0
    //   3758: lcmp
    //   3759: iflt +65 -> 3824
    //   3762: iconst_1
    ...
    //   3805: d2i
    //   3806: iload 7
    //   3808: getstatic 855	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   3811: iload 9
    //   3813: aload_0
    //   3814: aload_2
    //   3815: iload_3
    //   3816: invokestatic 1175	com/tencent/mm/plugin/sns/storage/r:a	(Ljava/lang/String;IILandroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;Ljava/lang/String;Z)Z
    //   3819: istore 17
    //   3821: goto -239 -> 3582
    //   3824: iconst_0
    //   3825: istore_3
    ...
    //   3848: invokestatic 523	com/tencent/mm/vfs/s:nw	(Ljava/lang/String;Ljava/lang/String;)J
    //   3851: lconst_0
    //   3852: lcmp
    //   3853: iflt +11 -> 3864
    //   3856: ldc_w 1001
  ...
  private static boolean kM(String paramString1, String paramString2)
  {
    AppMethodBeat.i(203210);
    try
    {
      Bitmap localBitmap = com.tencent.mm.plugin.sns.d.a.k(paramString1, 0.0F);
      byte[] arrayOfByte = aB(localBitmap);
      localBitmap.recycle();
      e.cEM();
      if (e.a(arrayOfByte, paramString1, paramString2, localBitmap.getWidth(), localBitmap.getHeight(), localBitmap.getWidth(), localBitmap.getHeight()) == 0)
      {
  ...
  public final q JK(long paramLong)
  {
    AppMethodBeat.i(97604);
    q localq = new q();
    Cursor localCursor = this.iFy.query("SnsMedia", null, "local_id=?", new String[] { String.valueOf(paramLong) }, null, null, null, 2);
  ...
  public final int a(int paramInt, q paramq)
  {
    ...
    paramq = paramq.feY();
    paramInt = this.iFy.update("SnsMedia", paramq, "local_id=?", new String[] { String.valueOf(paramInt) });
    AppMethodBeat.o(97602);
    return paramInt;
  }
  
  public final com.tencent.mm.plugin.sns.data.q a(com.tencent.mm.plugin.sns.data.q paramq, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    AppMethodBeat.i(97608);
    q localq = new q();
    localq.createTime = ((int)Util.nowSecond());
    localq.type = paramq.type;
    cne localcne = new cne();
    localcne.Privated = paramq.DEB;
    localcne.MsV = paramq.DEA;
    localcne.token = paramq.DEC;
    localcne.Mte = paramq.DED;
    localcne.Mts = 0;
    localcne.Mtr = new cmw();
    localcne.ibG = 0;
    localcne.Desc = paramq.desc;
    Log.d("MicroMsg.snsMediaStorage", "upload.filterId " + paramq.DEz);
    localcne.MsU = paramq.DEz;
    localcne.Mpa = 2;
    localcne.videoPath = paramString1;
    localcne.Mtv = paramString2;
    localcne.md5 = paramq.DEE;
    for (;;)
    {
      try
      {
        ...
        localq.feZ();
        i = (int)this.iFy.insert("SnsMedia", "local_id", localq.feY());
        str1 = "Locall_path".concat(String.valueOf(i));
        Log.d("MicroMsg.snsMediaStorage", "insert localId ".concat(String.valueOf(i)));
        String str2 = com.tencent.mm.plugin.sns.data.r.aOj(str1);
        String str3 = com.tencent.mm.plugin.sns.data.r.aOk(str1);
        String str4 = com.tencent.mm.plugin.sns.data.r.aOi(str1);
        String str5 = com.tencent.mm.plugin.sns.data.r.aOl(str1);
        String str6 = aQD(str1);
        s.boN(str6);
        s.nw(paramString2, str6 + str2);
        s.nw(paramString2, str6 + str3);
        s.nw(paramString2, str6 + str4);
        s.nw(paramString1, str6 + str5);
        localcne.videoPath = (str6 + str5);
        localcne.Mtv = (str6 + str3);
        localcne.md5 = paramq.DEE;
      }
      catch (Exception localException)
      {
        ...
        catch (Exception paramString2)
        {
          Log.e("MicroMsg.snsMediaStorage", "uploadInfo to byteArray error");
          continue;
          paramString2 = new cmw();
          paramString2.oUv = 1;
          paramString2.Url = paramString3;
          localcne.Mtr = paramString2;
          localcne.Mpa = 0;
          f.baR();
          localcne.MsS = com.tencent.mm.an.a.NX(paramString1);
          if (!Util.isNullOrNil(paramString4))
          {
            paramString1 = new cmw();
            paramString1.oUv = 1;
            paramString1.Url = paramString4;
            localcne.Mtt.add(paramString1);
          }
        }
      }
      try
  ...
  public final boolean a(String paramString, q paramq)
  {
    ...
    Cursor localCursor = this.iFy.query("SnsMedia", null, "StrId=?", new String[] { String.valueOf(paramString) }, null, null, null, 2);
    if (localCursor.moveToFirst())
    {
      localCursor.close();
      bool = a(paramq);
  ...
  public final q aQE(String paramString)
  {
    AppMethodBeat.i(97603);
    q localq = new q();
    paramString = this.iFy.query("SnsMedia", null, "StrId=?", new String[] { String.valueOf(paramString) }, null, null, null, 2);
  ...
  public final List<com.tencent.mm.plugin.sns.data.q> gW(List<com.tencent.mm.plugin.sns.data.q> paramList)
  {
    ...
    {
      com.tencent.mm.plugin.sns.data.q localq1 = (com.tencent.mm.plugin.sns.data.q)paramList.next();
      int i = a(localq1);
      if (i == -1)
      {
        AppMethodBeat.o(97605);
      ...
      com.tencent.mm.plugin.sns.data.q localq2 = new com.tencent.mm.plugin.sns.data.q(i, localq1.type);
