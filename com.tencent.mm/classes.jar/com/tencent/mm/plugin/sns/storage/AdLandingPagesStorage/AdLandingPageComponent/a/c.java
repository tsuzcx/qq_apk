  ...
  implements k
{
  ...
  public c(long paramLong, int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    ...
    ((b.a)localObject).hvt = new ayo();
    ((b.a)localObject).hvu = new ayp();
    ((b.a)localObject).uri = "/cgi-bin/mmoc-bin/adplayinfo/get_landpage_smartphone";
    ((b.a)localObject).funcId = 2605;
    this.rr = ((b.a)localObject).aAz();
    localObject = (ayo)this.rr.hvr.hvw;
    ((ayo)localObject).yiH = paramLong;
    ((ayo)localObject).EPT = paramInt1;
    ((ayo)localObject).EOI = paramString1;
    ((ayo)localObject).xID = paramString2;
    ((ayo)localObject).yiF = paramInt2;
  ...
  public final void onGYNetEnd(int paramInt1, int paramInt2, int paramInt3, String paramString, q paramq, byte[] paramArrayOfByte)
  {
    ...
    ac.i("NetSceneAdGetSmartPhoneNumber", "errType=" + paramInt2 + ", errCode=" + paramInt3 + ", errMsg=" + paramString);
