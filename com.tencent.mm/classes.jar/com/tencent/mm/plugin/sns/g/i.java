...
{
  public LinkedList<h> oxe = new LinkedList();
  public g oxf;
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      paramVarArgs.d(1, 8, this.oxe);
      if (this.oxf != null)
      {
        paramVarArgs.gD(2, this.oxf.btq());
        this.oxf.a(paramVarArgs);
      }
      paramInt = 0;
    }
    int i;
    do
    {
      ...
      i = d.a.a.a.c(1, 8, this.oxe) + 0;
      paramInt = i;
    } while (this.oxf == null);
    return i + d.a.a.a.gA(2, this.oxf.btq());
    if (paramInt == 2)
    {
 ...
 * Qualified Name:     com.tencent.mm.plugin.sns.g.i
