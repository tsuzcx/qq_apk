  ...
  public final void afterTextChanged(Editable paramEditable)
  {
    ...
    if (((com.tencent.mm.plugin.websearch.api.c)h.ag(com.tencent.mm.plugin.websearch.api.c.class)).isOpenInlineSnsTag())
    {
      ...
      while (((Matcher)localObject).find())
      {
        ...
        ForegroundColorSpan localForegroundColorSpan = new ForegroundColorSpan(this.KQR.getResources().getColor(i.c.Link_100));
