  ...
  implements AdLandingPagesProxy.e
{
  ...
  public final void h(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    ac.i("MicroMsg.SnsAdNativeLandingPagesUI", "doUpdateUxInfoScene end, errType=" + paramInt1 + ", errNo=" + paramInt2 + ", newUxInfo=" + paramObject);
    if ((paramInt1 == 0) && (paramInt2 == 0) && ((paramObject instanceof String))) {
      SnsAdNativeLandingPagesUI.a(this.yHq, (String)paramObject);
    }
