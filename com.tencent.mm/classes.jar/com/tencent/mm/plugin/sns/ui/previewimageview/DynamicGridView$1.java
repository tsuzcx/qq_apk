  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public final void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    localb.mr(paramInt);
    localb.qY(paramLong);
    a.b("com/tencent/mm/plugin/sns/ui/previewimageview/DynamicGridView$1", "android/widget/AdapterView$OnItemClickListener", "onItemClick", "(Landroid/widget/AdapterView;Landroid/view/View;IJ)V", this, localb.ahq());
    if ((!this.AAE.qkC) && (this.AAE.isEnabled()) && (DynamicGridView.a(this.AAE) != null)) {
      DynamicGridView.a(this.AAE).onItemClick(paramAdapterView, paramView, paramInt, paramLong);
    }
