  ...
  extends OfflineVideoView
{
  ...
  public final void b(boolean paramBoolean, float paramFloat)
  {
    ...
    super.b(paramBoolean, paramFloat);
  ...
  public Drawable getThumbDrawable()
  {
    ...
    if (this.qir != null)
    {
      Drawable localDrawable = this.qir.getDrawable();
  ...
  public final boolean isError()
  {
    ...
    ad.i("MicroMsg.SnsAdTimelineVideoView", "isError=" + this.qmn);
    boolean bool = this.qmn;
  ...
  public final void restart()
  {
    ...
    ad.i("MicroMsg.SnsAdTimelineVideoView", "restart, hasPrepared=" + this.xXC);
    if (this.xXC) {
      super.at(0, true);
    }
  ...
  public final void rq()
  {
    ...
    ad.i("MicroMsg.SnsAdTimelineVideoView", "onPrepared, path=%s , shouldPlayWhenPrepared=%s", new Object[] { getVideoPath(), Boolean.valueOf(this.xpx) });
    if (this.xpx) {
      super.rq();
    }
    this.xcP = true;
  ...
  public void setThumbBmp(Bitmap paramBitmap)
  {
    ...
    if (this.qir != null) {
      this.qir.setImageBitmap(paramBitmap);
    }
  ...
  public void setThumbDrawable(Drawable paramDrawable)
  {
    ...
    if (this.qir != null) {
      this.qir.setImageDrawable(paramDrawable);
    }
  ...
  public void setVideoPath(String paramString)
  {
    ...
    ad.i("MicroMsg.SnsAdTimelineVideoView", "setVideoPath, hasPrepared=" + this.xXC + ", path=" + paramString + ", oldPath=" + str);
    if ((!this.xXC) || ((paramString != null) && (!paramString.equals(str))))
    {
      super.YI(paramString);
      this.xXC = true;
    }
  ...
  public final void start()
  {
    ...
    boolean bool = dzx();
    ad.i("MicroMsg.SnsAdTimelineVideoView", "start, hasPrepared=" + this.xcP + ", shouldPlayWhenPrepared=" + this.xpx + ", isPlaying=" + bool);
    if ((!this.xcP) && (this.xpx))
    {
