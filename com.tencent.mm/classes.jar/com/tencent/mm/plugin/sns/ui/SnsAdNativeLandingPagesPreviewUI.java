  ...
  extends MMActivity
{
  ...
  private static boolean h(Intent paramIntent, String paramString)
  {
    ...
    if ((!bt.isNullOrNil(paramString)) && (al.apz(paramString)))
    {
      paramString = al.apA(paramString);
  ...
  private boolean i(Intent paramIntent, String paramString)
  {
    ...
    if (i.apF(paramString))
    {
      paramIntent.setClass(this, SnsAdNativeLandingPagesUI.class);
      paramString = new com.tencent.mm.hellhoundlib.b.a().bd(paramIntent);
      com.tencent.mm.hellhoundlib.a.a.a(this, paramString.adn(), "com/tencent/mm/plugin/sns/ui/SnsAdNativeLandingPagesPreviewUI", "openCanvas", "(Landroid/content/Intent;Ljava/lang/String;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
    ...
    String str = aA(paramString, "adxml", ".adxml.adActionLink");
    paramIntent = str;
    if (TextUtils.isEmpty(str))
    {
      ad.e("SnsAdNativeLandingPagesPreviewUI", "adActionLink is empty");
      paramIntent = aA(paramString, "adxml", ".adxml.adCanvasInfo.shareWebUrl");
    }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (localIntent.hasExtra("sns_landing_pages_canvasid"))
    {
      ...
      if (localIntent.getIntExtra("sns_landing_pages_no_store", 0) != 1)
      {
        ...
        paramBundle = m.dxr().m(str1, str2, 0, 0);
        label124:
        ...
        public final int a(int paramAnonymousInt1, int paramAnonymousInt2, String paramAnonymousString, com.tencent.mm.al.b paramAnonymousb, n paramAnonymousn)
        {
          ...
          do
          {
            do
            {
              ...
              paramAnonymousn = ((awu)paramAnonymousb.gUT.gUX).DvY.eBA();
          ...
          {
            localm.xit.put(paramAnonymousString, paramAnonymousn);
            ...
            localm.xis.a(paramAnonymousString);
            break;
            paramAnonymousString = (aos)paramAnonymousb.gUT.gUX;
            ad.i("SnsAdNativeLandingPagesPreviewUI", "getCanvasInfo pageid %d ,xml %s", new Object[] { Long.valueOf(l), paramAnonymousString.Dqw });
            if (TextUtils.isEmpty(paramAnonymousString.Dqw)) {
              break;
            }
            this.val$intent.putExtra("sns_landing_pages_xml", paramAnonymousString.Dqw);
            if (!SnsAdNativeLandingPagesPreviewUI.j(this.val$intent, paramAnonymousString.Dqw))
            {
              SnsAdNativeLandingPagesPreviewUI.this.finish();
              AppMethodBeat.o(98309);
              return 0;
            }
            SnsAdNativeLandingPagesPreviewUI.a(SnsAdNativeLandingPagesPreviewUI.this, this.val$intent, paramAnonymousString.Dqw);
            m.dxr().A(l, paramAnonymousString.Dqw);
            break;
          }
        }
      }, false, this);
