  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    a.b("com/tencent/mm/plugin/sns/ui/TimeLineClickEvent$7", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).axR());
    long l1;
    if ((paramView.getTag() != null) && ((paramView.getTag() instanceof TimeLineObject)))
    {
      ...
      {
        a.a(this, "com/tencent/mm/plugin/sns/ui/TimeLineClickEvent$7", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
    ...
    for (;;)
    {
      ...
      if ((paramView.ContentObj != null) && (paramView.ContentObj.Lpd != null))
      {
        ...
        if (l1 != 0L)
        {
          ...
          ((aj)g.ah(aj.class)).fillContextIdToIntent(4, 2, 53, (Intent)localObject);
          ((aj)g.ah(aj.class)).enterFinderShareFeedUI(this.ERz.context, (Intent)localObject);
        }
      }
    }
 ...
 * Qualified Name:     com.tencent.mm.plugin.sns.ui.br.22
