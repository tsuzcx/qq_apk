...
public final class d
{
  ...
  public final com.tencent.mm.kiss.widget.textview.a.a getTextViewConfig()
  {
    ...
    if ((this.LtJ == null) || ((int)this.LtJ.textSize != i)) {
      this.LtJ = b.aIT().as(i).sL(MMApplicationContext.getContext().getResources().getColor(i.c.sns_comment_color)).sK(16).kgG;
    }
  ...
  public final int getViewWidth()
  {
    ...
    if (this.LtK <= 0)
    {
      ...
      if (this.LtK <= 0)
      {
        ...
        this.LtK = (i - k - j - m);
        Log.i("MicroMsg.SnsCommentPreloadTextViewConfig", "try again, screenWidth " + i + " textViewWidth " + this.LtK + " padding: " + j + " marginLeft: " + k + " thisviewPadding: " + m);
      }
      Log.i("MicroMsg.SnsCommentPreloadTextViewConfig", "screenWidth " + i + " textViewWidth " + this.LtK + " padding: " + j + " marginLeft: " + k + " thisviewPadding: " + m);
    }
    int i = this.LtK;
