  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    a.b("com/tencent/mm/plugin/sns/ui/listener/TimelineClickListener$36", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).ahF());
    if ((paramView.getTag() instanceof TimeLineObject))
    {
      localObject = (TimeLineObject)paramView.getTag();
      ary localary = ((TimeLineObject)localObject).HUG.GtB;
      Intent localIntent = new Intent();
      localIntent.putExtra("feed_object_id", r.azz(localary.objectId));
      localIntent.putExtra("feed_object_nonceId", localary.objectNonceId);
      localIntent.putExtra("report_scene", 3);
      localIntent.putExtra("from_user", ((TimeLineObject)localObject).nIJ);
