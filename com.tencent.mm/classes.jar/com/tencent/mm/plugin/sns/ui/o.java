  ...
  implements y
{
  ...
  public final boolean a(int paramInt1, int paramInt2, org.c.d.i parami, String paramString1, List<String> paramList1, aui paramaui, int paramInt3, boolean paramBoolean, List<String> paramList2, PInt paramPInt, String paramString2, int paramInt4, int paramInt5)
  {
    ...
    if (!bk.bl(this.imgPath))
    {
      ...
      if (!bool1)
      {
        com.tencent.mm.sdk.platformtools.y.i("MicroMsg.EmojiShareWidget", "set userData user imgurl ");
        bool2 = paramString2.b(this.oOp, this.oOp, this.oOx, this.oOv, this.oOw);
      }
      if (!bool2) {
        com.tencent.mm.sdk.platformtools.y.e("MicroMsg.EmojiShareWidget", "set userData faild");
      }
    ...
    for (;;)
    {
      ...
      bool1 = bool2;
      if (com.tencent.mm.as.o.OI() == null) {
        break;
      }
    ...
    label442:
    paramString2.am(parami).xU(paramInt1);
    ...
    af.bDB().bCp();
    this.bER.finish();
    parami = ((com.tencent.mm.plugin.emoji.b.d)g.t(com.tencent.mm.plugin.emoji.b.d.class)).getEmojiMgr().AA(this.oOw);
    com.tencent.mm.plugin.report.service.h.nFQ.f(10993, new Object[] { Integer.valueOf(1), parami });
    return false;
  }
