  ...
  implements ac
{
  ...
  public final boolean a(int paramInt1, int paramInt2, org.b.d.i parami, String paramString1, List<String> paramList1, bwk parambwk, LinkedList<Long> paramLinkedList, int paramInt3, boolean paramBoolean, List<String> paramList2, PInt paramPInt, String paramString2, int paramInt4, int paramInt5)
  {
    ...
    {
      bool1 = paramLinkedList.a(com.tencent.mm.vfs.o.bb(this.dzD, 0, -1), this.Ahp, this.title, this.Ahn, this.Aho);
      bool2 = bool1;
      if (!bool1)
      {
        ae.i("MicroMsg.EmojiDesignerShareWidget", "set userData user imgurl ");
        bool2 = paramLinkedList.c(this.rSl, this.rSl, this.Ahp, this.Ahn, this.Aho);
      }
      if (!bool2) {
        ae.e("MicroMsg.EmojiDesignerShareWidget", "set userData faild");
      }
    ...
    ah.dXA().dWc();
    this.fNT.finish();
    ((com.tencent.mm.plugin.emoji.b.d)com.tencent.mm.kernel.g.ad(com.tencent.mm.plugin.emoji.b.d.class)).getEmojiMgr().acr(this.Aho);
    ((com.tencent.mm.plugin.emoji.b.d)com.tencent.mm.kernel.g.ad(com.tencent.mm.plugin.emoji.b.d.class)).getEmojiMgr().acs(this.Aho);
