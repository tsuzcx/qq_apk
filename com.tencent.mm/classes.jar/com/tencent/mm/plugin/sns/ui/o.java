  ...
  implements ab
{
  ...
  public final boolean a(int paramInt1, int paramInt2, org.b.d.i parami, String paramString1, List<String> paramList1, brd parambrd, LinkedList<Long> paramLinkedList, int paramInt3, boolean paramBoolean, List<String> paramList2, PInt paramPInt, String paramString2, int paramInt4, int paramInt5)
  {
    ...
    if (!bs.isNullOrNil(this.dmK))
    {
      ...
      if (!bool1)
      {
        ac.i("MicroMsg.EmojiDesignerShareWidget", "set userData user imgurl ");
        bool2 = paramLinkedList.c(this.qYH, this.qYH, this.yyW, this.yyU, this.yyV);
      }
      if (!bool2) {
        ac.e("MicroMsg.EmojiDesignerShareWidget", "set userData faild");
      }
    ...
    for (;;)
    {
      ...
      bool1 = bool2;
      if (com.tencent.mm.av.o.aFw() == null) {
        break;
      }
      com.tencent.mm.av.o.aFw();
    ...
    af.dHN().dGr();
    this.iMV.finish();
    ((com.tencent.mm.plugin.emoji.b.d)g.ad(com.tencent.mm.plugin.emoji.b.d.class)).getEmojiMgr().XU(this.yyV);
    ((com.tencent.mm.plugin.emoji.b.d)g.ad(com.tencent.mm.plugin.emoji.b.d.class)).getEmojiMgr().XV(this.yyV);
