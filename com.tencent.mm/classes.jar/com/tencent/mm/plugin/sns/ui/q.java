  ...
  implements ac
{
  ...
  public final boolean a(int paramInt1, int paramInt2, org.b.d.i parami, String paramString1, List<String> paramList1, bvq parambvq, LinkedList<Long> paramLinkedList, int paramInt3, boolean paramBoolean, List<String> paramList2, PInt paramPInt, String paramString2, int paramInt4, int paramInt5)
  {
    ...
    label461:
    paramLinkedList.aU(parami).Qe(paramInt1);
    ...
    ag.dUa().dSE();
    this.fLP.finish();
    parami = ((com.tencent.mm.plugin.emoji.b.d)com.tencent.mm.kernel.g.ad(com.tencent.mm.plugin.emoji.b.d.class)).getEmojiMgr().abz(this.zQh);
    com.tencent.mm.plugin.report.service.g.yhR.f(10993, new Object[] { Integer.valueOf(1), parami });
