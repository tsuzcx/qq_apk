  ...
  implements ac
{
  ...
  public final boolean a(int paramInt1, int paramInt2, org.b.d.i parami, String paramString1, List<String> paramList1, bwk parambwk, LinkedList<Long> paramLinkedList, int paramInt3, boolean paramBoolean, List<String> paramList2, PInt paramPInt, String paramString2, int paramInt4, int paramInt5)
  {
    ...
    if (!bu.isNullOrNil(this.dzD))
    {
      ...
      if (!bool1)
      {
        ae.i("MicroMsg.EmojiShareWidget", "set userData user imgurl ");
        bool2 = paramLinkedList.c(this.rSl, this.rSl, this.Ahp, this.Ahn, this.Aho);
      }
      if (!bool2) {
        ae.e("MicroMsg.EmojiShareWidget", "set userData faild");
      }
    ...
    for (;;)
    {
      ...
      bool1 = bool2;
      if (com.tencent.mm.av.q.aIW() == null) {
        break;
      }
    ...
    label461:
    paramLinkedList.aV(parami).QL(paramInt1);
    ...
    ah.dXA().dWc();
    this.fNT.finish();
    parami = ((com.tencent.mm.plugin.emoji.b.d)com.tencent.mm.kernel.g.ad(com.tencent.mm.plugin.emoji.b.d.class)).getEmojiMgr().acq(this.Aho);
    com.tencent.mm.plugin.report.service.g.yxI.f(10993, new Object[] { Integer.valueOf(1), parami });
