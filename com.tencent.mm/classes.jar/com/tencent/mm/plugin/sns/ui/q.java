  ...
  implements ag
{
  ...
  public final boolean a(int paramInt1, int paramInt2, i parami, String paramString1, List<String> paramList1, djv paramdjv, LinkedList<Long> paramLinkedList, int paramInt3, boolean paramBoolean, List<String> paramList2, PInt paramPInt, String paramString2, int paramInt4, int paramInt5)
  {
    ...
    paramLinkedList = new bg(10, this.lzt);
    ...
    label470:
    paramLinkedList.bU(parami).akO(paramInt1);
    ...
    al.hgx().hej();
    this.lzt.finish();
    parami = ((com.tencent.mm.plugin.emoji.c.d)com.tencent.mm.kernel.h.az(com.tencent.mm.plugin.emoji.c.d.class)).getEmojiMgr().aom(this.RcB);
    com.tencent.mm.plugin.report.service.h.OAn.b(10993, new Object[] { Integer.valueOf(1), parami });
