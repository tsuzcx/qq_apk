...
public final class q
{
  ...
  public static Bitmap asW(String paramString)
  {
    ...
    //   33: ifnull +667 -> 700
    //   36: aload 13
    //   38: getfield 474	android/graphics/BitmapFactory$Options:outWidth	I
    //   41: istore 5
    //   43: aload 13
    ...
    //   144: idiv
    //   145: i2d
    //   146: invokestatic 502	java/lang/Math:sqrt	(D)D
    //   149: d2i
    //   150: istore 6
    //   152: iload 7
    //   154: iload 8
    ...
    //   350: astore 14
    //   352: aload 15
    //   354: invokestatic 539	com/tencent/mm/plugin/sns/data/q:I	(Landroid/graphics/Bitmap;)Z
    //   357: ifeq +17 -> 374
    //   360: aload_0
    //   361: aload 15
    //   363: invokestatic 543	com/tencent/mm/plugin/sns/data/q:t	(Ljava/lang/String;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   366: astore 14
    //   368: aload_0
    //   369: lload 11
    ...
    //   376: ifnull +8 -> 384
    //   379: aload 13
    //   381: invokevirtual 554	java/io/InputStream:close	()V
    //   384: ldc_w 471
    ...
    //   606: aload 16
    //   608: aload 16
    //   610: getfield 513	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   613: iconst_1
    //   614: iadd
    //   615: putfield 513	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   618: aload 13
    //   620: ifnull -358 -> 262
    //   623: aload 13
    //   625: invokevirtual 554	java/io/InputStream:close	()V
    //   628: goto -366 -> 262
    //   631: astore 13
    //   633: goto -371 -> 262
    //   636: astore_0
    ...
    //   639: ifnull +8 -> 647
    //   642: aload 13
    //   644: invokevirtual 554	java/io/InputStream:close	()V
    //   647: ldc_w 471
  ...
  public static void b(View paramView, Context paramContext)
  {
    ...
    int i;
    int k;
    if ((paramView != null) && (com.tencent.mm.cc.a.eb(paramContext) > 1.0F))
    {
      float f = com.tencent.mm.cc.a.eb(paramContext);
      localLayoutParams = paramView.getLayoutParams();
      i = com.tencent.mm.cc.a.fromDPToPix(paramContext, 60);
