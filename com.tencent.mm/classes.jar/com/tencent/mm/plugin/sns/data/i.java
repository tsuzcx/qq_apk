...
public final class i
{
  public static void a(int paramInt, long paramLong, ADInfo paramADInfo, ADXml paramADXml)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        str1 = aNZ(paramADInfo.uxInfo);
        paramADInfo = str2;
        if (paramADXml != null) {
          paramADInfo = Util.nullAsNil(paramADXml.adExtInfo);
        }
        Log.i("SnsAdReportAnalyseUtils", "reportAdDel: snsId = " + r.Jb(paramLong) + ", uxInfo = " + str1 + ", adExtInfo = " + paramADInfo + ", reportType = " + i + ", extInfo = " + "");
        h.CyF.a(19553, new Object[] { Long.valueOf(paramLong), str1, paramADInfo, Integer.valueOf(i), "" });
  ...
  public static void a(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, int paramInt3)
  {
    ...
    try
    {
      ...
      h.CyF.a(19693, new Object[] { Long.valueOf(System.currentTimeMillis()), paramString1, aNZ(paramString3), paramString4, paramString2, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) });
  ...
  public static void d(long paramLong, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = aNZ(paramString1.uxInfo);
      ...
      h.CyF.a(19553, new Object[] { Long.valueOf(paramLong), paramString1, paramString2, Integer.valueOf(1), "" });
