...
public final class a
{
  public static n a(Bitmap paramBitmap, String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (paramBitmap != null) {
      new Canvas(paramBitmap.apb()).drawColor(paramInt1);
    }
    try
    {
      f.a(paramBitmap.apb(), 70, Bitmap.CompressFormat.JPEG, paramString, false);
  ...
  public static n iA(String paramString1, String paramString2)
  {
    AppMethodBeat.i(95174);
    int i = Color.argb(51, 255, 255, 255);
    paramString1 = q.anJ(paramString1);
    ...
    paramString1 = a(paramString1.apb(), paramString2, i, 55);
    AppMethodBeat.o(95174);
    return paramString1;
  }
}
