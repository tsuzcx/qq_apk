  ...
  extends LinearLayout
{
  ...
  private void init()
  {
    ...
    this.jGG = localView.findViewById(2131296591);
    this.wCR = ((TextView)localView.findViewById(2131296573));
    this.wCS = ((LinearLayout)localView.findViewById(2131296574));
    this.wCT = getLinearSeparator();
  ...
  public final void a(p paramp, b paramb)
  {
    ...
    if ((localObject1 == null) || (((cvp)localObject1).Enk.size() == 0))
    {
      setVisibility(8);
    ...
    localObject2 = getContext().getString(2131763903, new Object[] { Integer.valueOf(((SnsObject)localObject2).SnsRedEnvelops.Enj), bt.D(d * 1.0D / 100.0D) });
    this.wCR.setText((CharSequence)localObject2);
    this.jGG.setTag(paramp);
    this.jGG.setOnClickListener(paramb.xTF);
    paramp = ((cvp)localObject1).Enk;
    boolean bool = ((cvp)localObject1).Enk.isEmpty();
    ...
    if (this.wCS != null)
    {
      ...
      if (this.wCS.getParent() != null) {
        this.wCS.setVisibility(8);
      }
      this.wCS.removeAllViews();
      this.wCS.setVisibility(8);
      paramp = this.wCS;
      i = 8;
    }
    for (;;)
    {
      ...
      this.wCS.addView((View)localObject1);
      n = a.fromDPToPix(getContext(), SnsCommentDetailUI.xwQ);
      j = (int)(f - n) / (m + k);
      i = j;
      if ((int)(f - n) % (m + k) > k) {
        i = j + 1;
      ...
      while (i < paramp.size())
      {
        ...
        localTouchImageView.setTag(((cux)localObject2).Username);
        a.b.w(localTouchImageView, ((cux)localObject2).Username);
        localTouchImageView.setOnClickListener(paramb.xTu);
  ...
  public void setVisibility(int paramInt)
  {
    ...
    if (this.jGG != null) {
      this.jGG.setVisibility(paramInt);
    }
