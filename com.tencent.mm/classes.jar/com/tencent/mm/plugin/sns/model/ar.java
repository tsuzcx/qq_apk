...
{
  private static final Map<String, String> DMG;
  ...
  public static String ki(String paramString1, String paramString2)
  {
    ...
    if ((bool) && (DMG.containsKey(paramString1 + paramString2)))
    {
      str = (String)DMG.get(paramString1 + paramString2);
    ...
    if (bool) {
      DMG.put(paramString1 + paramString2, localStringBuffer.toString());
    }
