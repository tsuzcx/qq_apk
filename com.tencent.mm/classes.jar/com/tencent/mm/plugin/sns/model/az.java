  ...
  implements f.a
{
  ...
  public final boolean G(SnsInfo paramSnsInfo)
  {
    ...
    this.DOm = com.tencent.mm.plugin.sns.model.b.a.fcg();
    this.DOn = com.tencent.mm.plugin.sns.model.b.a.fcf();
    synchronized (this.DOk)
    {
      if ((this.DOk.size() >= this.DOn) && (!paramSnsInfo.isAd()))
      {
  ...
  public final void H(SnsInfo paramSnsInfo)
  {
    ...
    {
      Object localObject = this.DOl.iterator();
      while (((Iterator)localObject).hasNext())
      {
        f localf = (f)((Iterator)localObject).next();
        if (localf.dHp.equals(paramSnsInfo.getLocalid()))
        {
          localf.jqJ = System.currentTimeMillis();
          Collections.sort(this.DOl, new Comparator() {});
          Log.i("MicroMsg.SnsVideoService", "SNS_PRELOAD_ADD sns:[%s] is downloading. [already in queue]", new Object[] { paramSnsInfo.getLocalid() });
          AppMethodBeat.o(176274);
          return;
        }
      }
      if (this.DOl.size() >= this.DOm)
      {
        localObject = (f)this.DOl.poll();
        if (localObject != null)
        {
          ((f)localObject).stop();
  ...
  public final void a(f paramf, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      synchronized (this.DOl)
      {
        localObject1 = this.DOl.iterator();
      ...
      if (??? != null)
      {
        ((com.tencent.mm.modelvideo.s)???).iKP = paramInt2;
        u.f((com.tencent.mm.modelvideo.s)???);
      }
      Log.i("MicroMsg.SnsVideoService", "SNS_PRELOAD_DONE  preload video[%s] finish success[%b] range[%d, %d]  hash:[%d]", new Object[] { paramf.bha(), Boolean.valueOf(paramBoolean), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(hashCode()) });
      g.aAk().postToWorker(new Runnable()
      {
        public final void run()
        {
          AppMethodBeat.i(95968);
          com.tencent.mm.plugin.sns.model.b.a.YO(1);
          o.bhl().fQ(false);
          this.DOq.jqL = null;
          synchronized (az.this.DOl)
          {
            az.this.DOl.remove(this.DOq);
            az.this.fbP();
            az.this.fbO();
  ...
  final boolean a(bg parambg, boolean paramBoolean)
  {
    AppMethodBeat.i(95984);
    Object localObject1 = ay.a(parambg.dHp, parambg.ebR);
    if (!Util.isNullOrNil((String)localObject1))
    {
      Log.i("MicroMsg.SnsVideoService", "this sns:[%s] video[%s] already download finish, do nothing. [%s, %s]", new Object[] { parambg.dHp, parambg.jpT, parambg.dHp, localObject1 });
      AppMethodBeat.o(95984);
      return false;
    }
    boolean bool = com.tencent.mm.vfs.s.boN(ay.aPr(parambg.ebR.Id));
    localObject1 = ay.E(parambg.ebR);
    Object localObject2 = ay.aPs(parambg.dHp);
    if (localObject2 == null) {
      ay.fE(parambg.dHp, parambg.gqW);
    }
    for (;;)
    {
      Log.i("MicroMsg.SnsVideoService", "prepare stream download sns video %s mkDir %b", new Object[] { localObject1, Boolean.valueOf(bool) });
      localObject2 = new com.tencent.mm.plugin.sns.model.a.a(parambg.ebR.Id);
      ((com.tencent.mm.plugin.sns.model.a.a)localObject2).DIq = parambg.ebR;
      bp localbp = bp.gCZ();
      localbp.hXs = parambg.iXu;
      ((com.tencent.mm.plugin.sns.model.a.a)localObject2).DPp = localbp;
      ((com.tencent.mm.plugin.sns.model.a.a)localObject2).DPn = true;
      ((com.tencent.mm.plugin.sns.model.a.a)localObject2).url = parambg.ebR.Url;
      ((com.tencent.mm.plugin.sns.model.a.a)localObject2).DPm = false;
      com.tencent.mm.modelvideo.n.bhh();
      o.bhk();
      localObject1 = com.tencent.mm.an.e.a(((com.tencent.mm.plugin.sns.model.a.a)localObject2).DPp, ((com.tencent.mm.plugin.sns.model.a.a)localObject2).url, (String)localObject1, ay.Qv(parambg.dHp), parambg.gqU, parambg.ebR.isAd);
      if (localObject1 != null) {
        break;
      }
      AppMethodBeat.o(95984);
      return false;
      ay.c((com.tencent.mm.modelvideo.s)localObject2, parambg.gqW);
    }
    localObject2 = parambg.DPl;
    ((h)localObject1).gqV = ((String)localObject2);
    ((h)localObject1).dRL = ((String)localObject2);
    try
    {
      localObject2 = an.B(aj.faO().aQm(parambg.dHp));
      if (localObject2 != null)
      {
        ((h)localObject1).dRS = ((SnsObject)localObject2).Id;
        ((h)localObject1).gqZ = ((SnsObject)localObject2).PreDownloadInfo.MIW;
      }
    }
    ...
    this.DOh = parambg;
    this.DOh.jpT = ((h)localObject1).field_mediaId;
    Log.i("MicroMsg.SnsVideoService", "start stream download sns video cdnMediaId %s delay %b", new Object[] { this.DOh.jpT, Boolean.valueOf(paramBoolean) });
    o.bhk().a((h)localObject1, paramBoolean);
    AppMethodBeat.o(95984);
    return true;
  }
  
  public final boolean a(cnb paramcnb, int paramInt1, String paramString, boolean paramBoolean1, final boolean paramBoolean2, int paramInt2)
  {
    ...
    if ((((b)g.af(b.class)).a(b.a.rZA, true)) && (this.DOh != null) && (!TextUtils.isEmpty(this.DOh.dHp)) && (this.DOh.dHp.equals(paramString)))
    {
      Log.e("MicroMsg.SnsVideoService", "[%s]task is downloading now.", new Object[] { paramString });
      AppMethodBeat.o(95981);
      return true;
    }
    final bg localbg = new bg();
    localbg.jpT = ay.cs(paramInt1, paramcnb.Url);
    localbg.ebR = paramcnb;
    localbg.iXu = paramInt1;
    localbg.dHp = paramString;
    if (paramBoolean1) {}
    for (paramInt1 = 1;; paramInt1 = 0)
    {
      localbg.gqU = paramInt1;
      localbg.gqW = paramInt2;
      g.aAi();
      g.aAk().postToWorker(new Runnable()
      {
        public final void run()
        {
          ...
          Object localObject = aj.faO().aQm(localbg.dHp);
          bg localbg = localbg;
          if (localObject != null)
          {
            localObject = ((SnsInfo)localObject).getUserName();
            localbg.DPl = ((String)localObject);
            Log.i("MicroMsg.SnsVideoService", "offer [%b] video task[%s] to queue ", new Object[] { Boolean.valueOf(paramBoolean2), localbg });
            if (!paramBoolean2) {
              break label124;
            }
            az.this.DOi.offerFirst(localbg);
          }
          for (;;)
          {
            az.this.DOj.put(localbg.jpT, localbg);
            AppMethodBeat.o(95970);
            return;
            localObject = "";
            break;
            label124:
            az.this.DOi.offerLast(localbg);
          }
        }
      });
      if (paramBoolean2) {
  ...
  public final void fbN()
  {
    ...
    g.aAk().postToWorker(new Runnable()
    {
      public final void run()
      {
        ...
        synchronized (az.this.DOl)
        {
          if (az.this.DOl.size() > 0) {
            ((f)az.this.DOl.poll()).stop();
          }
        }
  ...
  final void fbO()
  {
    try
    {
      ...
      Log.i("MicroMsg.SnsVideoService", "SNS_PRELOAD_LOAD preload size:%d  queue size:%d", new Object[] { Integer.valueOf(this.DOl.size()), Integer.valueOf(this.DOk.size()) });
      g.aAk().postToWorker(new Runnable()
      {
        /* Error */
        public final void run()
        {
          ...
          //   5: aload_0
          //   6: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   9: getfield 34	com/tencent/mm/plugin/sns/model/az:DOh	Lcom/tencent/mm/plugin/sns/model/bg;
          //   12: ifnull +9 -> 21
          //   15: ldc 24
          //   17: invokestatic 37	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
          //   20: return
          //   21: aload_0
          //   22: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   25: getfield 41	com/tencent/mm/plugin/sns/model/az:DOi	Ljava/util/LinkedList;
          ...
          //   39: return
          //   40: aload_0
          //   41: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   44: getfield 50	com/tencent/mm/plugin/sns/model/az:DOl	Ljava/util/LinkedList;
          //   47: astore 6
          //   49: aload 6
          //   51: monitorenter
          //   52: aload_0
          //   53: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   56: getfield 50	com/tencent/mm/plugin/sns/model/az:DOl	Ljava/util/LinkedList;
          //   59: invokevirtual 54	java/util/LinkedList:size	()I
          //   62: aload_0
          //   63: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   66: getfield 58	com/tencent/mm/plugin/sns/model/az:DOm	I
          //   69: if_icmplt +19 -> 88
          //   72: ldc 60
          //   74: ldc 62
          ...
          //   90: monitorexit
          //   91: aload_0
          //   92: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   95: getfield 71	com/tencent/mm/plugin/sns/model/az:jre	Z
          //   98: ifne +19 -> 117
          //   101: aload_0
          //   102: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   105: getfield 74	com/tencent/mm/plugin/sns/model/az:jrf	Z
          //   108: ifeq +1777 -> 1885
          //   111: invokestatic 79	com/tencent/mm/plugin/sns/model/b/a:fce	()Z
          //   114: ifne +1771 -> 1885
          //   117: ldc 60
          //   119: ldc 81
          //   121: iconst_2
          ...
          //   126: iconst_0
          //   127: aload_0
          //   128: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   131: getfield 71	com/tencent/mm/plugin/sns/model/az:jre	Z
          //   134: invokestatic 87	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
          //   137: aastore
          //   138: dup
          //   139: iconst_1
          //   140: invokestatic 79	com/tencent/mm/plugin/sns/model/b/a:fce	()Z
          ...
          //   183: astore 14
          //   185: aload_0
          //   186: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   189: getfield 102	com/tencent/mm/plugin/sns/model/az:DOk	Ljava/util/LinkedList;
          //   192: astore 12
          //   194: aload 12
          //   196: monitorenter
          //   197: aload_0
          //   198: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   201: getfield 102	com/tencent/mm/plugin/sns/model/az:DOk	Ljava/util/LinkedList;
          ...
          //   283: athrow
          //   284: aload_0
          //   285: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   288: getfield 74	com/tencent/mm/plugin/sns/model/az:jrf	Z
          //   291: ifeq +285 -> 576
          //   294: aload_0
          //   295: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   298: astore 6
          //   300: aload 9
          ...
          //   329: ifeq +1572 -> 1901
          //   332: aload_0
          //   333: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   336: astore 17
          //   338: aload 14
          ...
          //   355: getfield 147	com/tencent/mm/protocal/protobuf/TimeLineObject:ContentObj	Lcom/tencent/mm/protocal/protobuf/adp;
          ...
          //   366: getfield 147	com/tencent/mm/protocal/protobuf/TimeLineObject:ContentObj	Lcom/tencent/mm/protocal/protobuf/adp;
          //   369: getfield 152	com/tencent/mm/protocal/protobuf/adp:LoV	Ljava/util/LinkedList;
          ...
          //   409: ifne +156 -> 565
          //   412: invokestatic 164	com/tencent/mm/modelvideo/o:bhl	()Lcom/tencent/mm/modelvideo/i;
          //   415: iconst_0
          //   416: invokevirtual 170	com/tencent/mm/modelvideo/i:fR	(Z)Z
          //   419: ifeq +14 -> 433
          //   422: aload 13
          //   424: iconst_1
          ...
          //   430: goto -117 -> 313
          //   433: aload 9
          //   435: invokestatic 176	com/tencent/mm/plugin/sns/model/an:B	(Lcom/tencent/mm/plugin/sns/storage/SnsInfo;)Lcom/tencent/mm/protocal/protobuf/SnsObject;
          //   438: astore 10
          //   440: aload 10
          //   442: ifnull +11 -> 453
          //   445: aload 10
          //   447: getfield 182	com/tencent/mm/protocal/protobuf/SnsObject:PreDownloadInfo	Lcom/tencent/mm/protocal/protobuf/ddw;
          ...
          //   467: istore_1
          //   468: goto -155 -> 313
          //   471: invokestatic 187	com/tencent/mm/plugin/sns/model/b/a:fch	()I
          //   474: istore_1
          //   475: iload_1
          //   476: ifgt +36 -> 512
          //   479: ldc 60
          ...
          //   541: invokestatic 79	com/tencent/mm/plugin/sns/model/b/a:fce	()Z
          //   544: ifne +21 -> 565
          //   547: ldc 60
          //   549: ldc 215
          ...
          //   573: goto -260 -> 313
          //   576: aload_0
          //   577: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   580: astore 6
          //   582: aload 9
          ...
          //   640: istore_1
          //   641: goto -328 -> 313
          //   644: invokestatic 164	com/tencent/mm/modelvideo/o:bhl	()Lcom/tencent/mm/modelvideo/i;
          //   647: iconst_0
          //   648: invokevirtual 170	com/tencent/mm/modelvideo/i:fR	(Z)Z
          //   651: ifeq +14 -> 665
          //   654: aload 13
          //   656: iconst_1
          ...
          //   662: goto -349 -> 313
          //   665: aload 9
          //   667: invokestatic 176	com/tencent/mm/plugin/sns/model/an:B	(Lcom/tencent/mm/plugin/sns/storage/SnsInfo;)Lcom/tencent/mm/protocal/protobuf/SnsObject;
          //   670: astore 10
          //   672: aload 10
          //   674: ifnull +11 -> 685
          //   677: aload 10
          //   679: getfield 182	com/tencent/mm/protocal/protobuf/SnsObject:PreDownloadInfo	Lcom/tencent/mm/protocal/protobuf/ddw;
          ...
          //   731: iconst_2
          //   732: aload 10
          //   734: getfield 182	com/tencent/mm/protocal/protobuf/SnsObject:PreDownloadInfo	Lcom/tencent/mm/protocal/protobuf/ddw;
          //   737: getfield 231	com/tencent/mm/protocal/protobuf/ddw:MIW	I
          //   740: invokestatic 197	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
          //   743: aastore
          //   744: dup
          //   745: iconst_3
          //   746: aload 10
          //   748: getfield 182	com/tencent/mm/protocal/protobuf/SnsObject:PreDownloadInfo	Lcom/tencent/mm/protocal/protobuf/ddw;
          //   751: getfield 234	com/tencent/mm/protocal/protobuf/ddw:MIX	I
          //   754: invokestatic 197	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
          //   757: aastore
          //   758: dup
          //   759: iconst_4
          //   760: aload 10
          //   762: getfield 182	com/tencent/mm/protocal/protobuf/SnsObject:PreDownloadInfo	Lcom/tencent/mm/protocal/protobuf/ddw;
          //   765: getfield 237	com/tencent/mm/protocal/protobuf/ddw:MIY	Ljava/lang/String;
          //   768: aastore
          //   769: invokestatic 90	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
          //   772: aload 10
          //   774: getfield 182	com/tencent/mm/protocal/protobuf/SnsObject:PreDownloadInfo	Lcom/tencent/mm/protocal/protobuf/ddw;
          //   777: getfield 231	com/tencent/mm/protocal/protobuf/ddw:MIW	I
          //   780: ifgt +36 -> 816
          //   783: ldc 60
          //   785: ldc 189
          //   787: iconst_1
          ...
          //   839: aload 11
          //   841: aload 10
          //   843: getfield 182	com/tencent/mm/protocal/protobuf/SnsObject:PreDownloadInfo	Lcom/tencent/mm/protocal/protobuf/ddw;
          //   846: getfield 231	com/tencent/mm/protocal/protobuf/ddw:MIW	I
          //   849: putfield 213	com/tencent/mm/pointers/PInt:value	I
          //   852: aload 10
          //   854: getfield 182	com/tencent/mm/protocal/protobuf/SnsObject:PreDownloadInfo	Lcom/tencent/mm/protocal/protobuf/ddw;
          //   857: getfield 237	com/tencent/mm/protocal/protobuf/ddw:MIY	Ljava/lang/String;
          //   860: invokestatic 243	com/tencent/mm/modelcontrol/b:Of	(Ljava/lang/String;)Z
          //   863: ifne +95 -> 958
          ...
          //   872: ifeq +29 -> 901
          //   875: aload 10
          //   877: getfield 182	com/tencent/mm/protocal/protobuf/SnsObject:PreDownloadInfo	Lcom/tencent/mm/protocal/protobuf/ddw;
          //   880: getfield 234	com/tencent/mm/protocal/protobuf/ddw:MIX	I
          //   883: iconst_1
          //   884: iand
          //   885: istore_1
          //   886: iload_1
          ...
          //   907: ifeq +17 -> 924
          //   910: aload 10
          //   912: getfield 182	com/tencent/mm/protocal/protobuf/SnsObject:PreDownloadInfo	Lcom/tencent/mm/protocal/protobuf/ddw;
          //   915: getfield 234	com/tencent/mm/protocal/protobuf/ddw:MIX	I
          //   918: iconst_2
          //   919: iand
          //   920: istore_1
          //   921: goto -35 -> 886
          ...
          //   930: ifeq +17 -> 947
          //   933: aload 10
          //   935: getfield 182	com/tencent/mm/protocal/protobuf/SnsObject:PreDownloadInfo	Lcom/tencent/mm/protocal/protobuf/ddw;
          //   938: getfield 234	com/tencent/mm/protocal/protobuf/ddw:MIX	I
          //   941: iconst_4
          //   942: iand
          //   943: istore_1
          //   944: goto -58 -> 886
          ...
          //   974: getfield 147	com/tencent/mm/protocal/protobuf/TimeLineObject:ContentObj	Lcom/tencent/mm/protocal/protobuf/adp;
          //   977: getfield 152	com/tencent/mm/protocal/protobuf/adp:LoV	Ljava/util/LinkedList;
          //   980: iconst_0
          //   981: invokevirtual 265	java/util/LinkedList:get	(I)Ljava/lang/Object;
          //   984: checkcast 267	com/tencent/mm/protocal/protobuf/cnb
          //   987: astore 10
          //   989: aload 9
          ...
          //   996: aload 6
          //   998: aload 10
          //   1000: invokestatic 273	com/tencent/mm/plugin/sns/model/ay:a	(Ljava/lang/String;Lcom/tencent/mm/protocal/protobuf/cnb;)Ljava/lang/String;
          //   1003: astore 16
          //   1005: aload 16
          ...
          //   1038: aload 10
          //   1040: getfield 280	com/tencent/mm/protocal/protobuf/cnb:MsS	Ljava/lang/String;
          //   1043: astore 6
          //   1045: aload 16
          //   1047: invokestatic 286	com/tencent/mm/vfs/s:boW	(Ljava/lang/String;)J
          //   1050: lstore_3
          //   1051: aload 17
          //   1053: getfield 74	com/tencent/mm/plugin/sns/model/az:jrf	Z
          //   1056: ifeq +840 -> 1896
          //   1059: iconst_4
          //   1060: istore_1
          //   1061: invokestatic 164	com/tencent/mm/modelvideo/o:bhl	()Lcom/tencent/mm/modelvideo/i;
          //   1064: aload 6
          //   1066: iload_1
          //   1067: lload_3
          //   1068: aload 9
          ...
          //   1076: ldc 108
          //   1078: aload 10
          //   1080: getfield 292	com/tencent/mm/protocal/protobuf/cnb:Url	Ljava/lang/String;
          //   1083: aload 8
          //   1085: invokevirtual 295	com/tencent/mm/modelvideo/i:a	(Ljava/lang/String;IJLjava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
          //   1088: getstatic 301	com/tencent/mm/plugin/report/service/h:CyF	Lcom/tencent/mm/plugin/report/service/h;
          //   1091: ldc2_w 302
          //   1094: ldc2_w 304
          //   1097: lconst_1
          //   1098: iconst_0
          ...
          //   1105: goto -724 -> 381
          //   1108: aload 10
          //   1110: getfield 311	com/tencent/mm/protocal/protobuf/cnb:Id	Ljava/lang/String;
          //   1113: invokestatic 315	com/tencent/mm/plugin/sns/model/ay:aPr	(Ljava/lang/String;)Ljava/lang/String;
          //   1116: invokestatic 318	com/tencent/mm/vfs/s:boN	(Ljava/lang/String;)Z
          //   1119: istore 5
          //   1121: aload 10
          //   1123: invokestatic 322	com/tencent/mm/plugin/sns/model/ay:E	(Lcom/tencent/mm/protocal/protobuf/cnb;)Ljava/lang/String;
          //   1126: astore 17
          //   1128: aload 6
          //   1130: invokestatic 326	com/tencent/mm/plugin/sns/model/ay:aPs	(Ljava/lang/String;)Lcom/tencent/mm/modelvideo/s;
          //   1133: astore 18
          //   1135: aload 9
          ...
          //   1170: iconst_1
          //   1171: aload 10
          //   1173: getfield 332	com/tencent/mm/protocal/protobuf/cnb:MsT	F
          ...
          //   1209: iconst_0
          //   1210: aload 18
          //   1212: invokevirtual 342	com/tencent/mm/modelvideo/s:toString	()Ljava/lang/String;
          //   1215: aastore
          //   1216: invokestatic 90	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
          //   1219: aload 18
          //   1221: getfield 345	com/tencent/mm/modelvideo/s:iKP	I
          //   1224: ifle +70 -> 1294
          //   1227: aload 18
          //   1229: getfield 348	com/tencent/mm/modelvideo/s:dRQ	I
          //   1232: bipush 100
          //   1234: imul
          //   1235: aload 18
          //   1237: getfield 345	com/tencent/mm/modelvideo/s:iKP	I
          //   1240: idiv
          //   1241: aload 11
          ...
          //   1287: invokestatic 353	com/tencent/mm/plugin/sns/model/b/a:a	(Lcom/tencent/mm/protocal/protobuf/cnb;I)I
          //   1290: istore_1
          //   1291: goto -145 -> 1146
          //   1294: aload 18
          ...
          //   1299: aload 6
          //   1301: bipush 30
          //   1303: invokestatic 357	com/tencent/mm/plugin/sns/model/ay:fE	(Ljava/lang/String;I)Z
          //   1306: pop
          //   1307: ldc 60
          //   1309: ldc_w 359
          //   1312: iconst_3
          ...
          //   1343: dup
          //   1344: aload 10
          //   1346: getfield 311	com/tencent/mm/protocal/protobuf/cnb:Id	Ljava/lang/String;
          //   1349: invokespecial 364	com/tencent/mm/plugin/sns/model/a/a:<init>	(Ljava/lang/String;)V
          //   1352: astore 16
          //   1354: aload 16
          //   1356: aload 10
          //   1358: putfield 368	com/tencent/mm/plugin/sns/model/a/a:DIq	Lcom/tencent/mm/protocal/protobuf/cnb;
          //   1361: invokestatic 374	com/tencent/mm/storage/bp:gCZ	()Lcom/tencent/mm/storage/bp;
          //   1364: astore 18
          //   1366: aload 18
          //   1368: aload 9
          //   1370: invokevirtual 218	com/tencent/mm/plugin/sns/storage/SnsInfo:getCreateTime	()I
          //   1373: putfield 377	com/tencent/mm/storage/bp:hXs	I
          //   1376: aload 16
          //   1378: aload 18
          //   1380: putfield 381	com/tencent/mm/plugin/sns/model/a/a:DPp	Lcom/tencent/mm/storage/bp;
          //   1383: aload 16
          //   1385: iconst_1
          //   1386: putfield 384	com/tencent/mm/plugin/sns/model/a/a:DPn	Z
          //   1389: aload 16
          //   1391: aload 10
          //   1393: getfield 292	com/tencent/mm/protocal/protobuf/cnb:Url	Ljava/lang/String;
          //   1396: putfield 387	com/tencent/mm/plugin/sns/model/a/a:url	Ljava/lang/String;
          //   1399: aload 16
          //   1401: iconst_0
          //   1402: putfield 390	com/tencent/mm/plugin/sns/model/a/a:DPm	Z
          //   1405: invokestatic 396	com/tencent/mm/modelvideo/n:bhh	()Lcom/tencent/mm/modelvideo/n;
          //   1408: pop
          //   1409: invokestatic 400	com/tencent/mm/modelvideo/o:bhk	()Lcom/tencent/mm/an/e;
          //   1412: pop
          //   1413: aload 16
          //   1415: getfield 381	com/tencent/mm/plugin/sns/model/a/a:DPp	Lcom/tencent/mm/storage/bp;
          //   1418: aload 16
          //   1420: getfield 387	com/tencent/mm/plugin/sns/model/a/a:url	Ljava/lang/String;
          //   1423: aload 17
          //   1425: aload 6
          //   1427: invokestatic 403	com/tencent/mm/plugin/sns/model/ay:Qv	(Ljava/lang/String;)Ljava/lang/String;
          //   1430: iconst_2
          //   1431: aload 10
          //   1433: getfield 405	com/tencent/mm/protocal/protobuf/cnb:isAd	Z
          //   1436: invokestatic 410	com/tencent/mm/an/e:a	(Lcom/tencent/mm/storage/bp;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IZ)Lcom/tencent/mm/i/h;
          //   1439: astore 6
          //   1441: aload 6
          ...
          //   1452: aload 18
          //   1454: bipush 30
          //   1456: invokestatic 414	com/tencent/mm/plugin/sns/model/ay:c	(Lcom/tencent/mm/modelvideo/s;I)Z
          //   1459: pop
          //   1460: goto -153 -> 1307
          //   1463: astore 6
          //   1465: aload 12
          ...
          //   1476: aload 6
          //   1478: aload 10
          //   1480: getfield 280	com/tencent/mm/protocal/protobuf/cnb:MsS	Ljava/lang/String;
          //   1483: putfield 419	com/tencent/mm/i/h:djw	Ljava/lang/String;
          //   1486: aload 6
          //   1488: aload 11
          ...
          //   1496: aload 6
          //   1498: aload 8
          //   1500: putfield 425	com/tencent/mm/i/h:dRS	Ljava/lang/String;
          //   1503: aload 9
          //   1505: invokevirtual 289	com/tencent/mm/plugin/sns/storage/SnsInfo:getUserName	()Ljava/lang/String;
          //   1508: astore 8
          //   1510: aload 6
          //   1512: aload 8
          //   1514: putfield 428	com/tencent/mm/i/h:gqV	Ljava/lang/String;
          //   1517: aload 6
          //   1519: aload 8
          //   1521: putfield 431	com/tencent/mm/i/h:dRL	Ljava/lang/String;
          //   1524: goto -1143 -> 381
          //   1527: aload 12
          //   1529: monitorexit
          //   1530: aload 6
          ...
          //   1576: return
          //   1577: new 437	com/tencent/mm/modelvideo/f
          //   1580: dup
          //   1581: aload 10
          //   1583: aload 6
          //   1585: invokevirtual 123	com/tencent/mm/plugin/sns/storage/SnsInfo:getLocalid	()Ljava/lang/String;
          //   1588: invokespecial 440	com/tencent/mm/modelvideo/f:<init>	(Lcom/tencent/mm/i/h;Ljava/lang/String;)V
          //   1591: astore 7
          //   1593: aload 7
          //   1595: aload_0
          //   1596: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   1599: getfield 74	com/tencent/mm/plugin/sns/model/az:jrf	Z
          //   1602: putfield 443	com/tencent/mm/modelvideo/f:jqK	Z
          //   1605: aload 7
          //   1607: aload_0
          //   1608: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   1611: invokevirtual 446	com/tencent/mm/modelvideo/f:a	(Lcom/tencent/mm/modelvideo/f$a;)I
          //   1614: ifge +179 -> 1793
          //   1617: ldc 60
          //   1619: ldc_w 448
          //   1622: iconst_1
          ...
          //   1627: iconst_0
          //   1628: aload_0
          //   1629: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          ...
          //   1642: aload_0
          //   1643: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   1646: getfield 102	com/tencent/mm/plugin/sns/model/az:DOk	Ljava/util/LinkedList;
          //   1649: astore 7
          //   1651: aload 7
          //   1653: monitorenter
          //   1654: aload_0
          //   1655: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   1658: getfield 102	com/tencent/mm/plugin/sns/model/az:DOk	Ljava/util/LinkedList;
          ...
          //   1727: iconst_1
          //   1728: aload_0
          //   1729: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          ...
          //   1780: aload_0
          //   1781: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   1784: invokevirtual 462	com/tencent/mm/plugin/sns/model/az:fbO	()V
          //   1787: ldc 24
          ...
          //   1803: iconst_0
          //   1804: aload 7
          //   1806: getfield 467	com/tencent/mm/modelvideo/f:dHp	Ljava/lang/String;
          //   1809: aastore
          //   1810: dup
          //   1811: iconst_1
          //   1812: aload 11
          ...
          //   1829: putfield 476	com/tencent/mm/modelvideo/f:jqJ	J
          //   1832: aload_0
          //   1833: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   1836: getfield 50	com/tencent/mm/plugin/sns/model/az:DOl	Ljava/util/LinkedList;
          //   1839: astore 8
          //   1841: aload 8
          //   1843: monitorenter
          //   1844: aload_0
          //   1845: getfield 17	com/tencent/mm/plugin/sns/model/az$5:DOp	Lcom/tencent/mm/plugin/sns/model/az;
          //   1848: getfield 50	com/tencent/mm/plugin/sns/model/az:DOl	Ljava/util/LinkedList;
          //   1851: iconst_0
          //   1852: aload 7
  ...
  final boolean fbP()
  {
    ...
    //   6: invokestatic 564	com/tencent/mm/sdk/platformtools/Util:currentTicks	()J
    //   9: lstore_2
    //   10: invokestatic 567	com/tencent/mm/plugin/sns/model/b/a:fck	()I
    //   13: istore_1
    //   14: invokestatic 570	com/tencent/mm/sdk/platformtools/Util:nowSecond	()J
    //   17: iload_1
    //   18: i2l
    //   19: ldc2_w 571
    //   22: lmul
    ...
    //   62: iconst_3
    //   63: lload 4
    //   65: invokestatic 579	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   68: aastore
    //   69: invokestatic 210	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   72: invokestatic 583	com/tencent/mm/modelvideo/o:bhj	()Lcom/tencent/mm/modelvideo/t;
    //   75: sipush 130
    //   78: iconst_1
    //   79: lload 4
    //   81: invokevirtual 588	com/tencent/mm/modelvideo/t:e	(IIJ)Ljava/util/List;
    //   84: astore 6
    //   86: aload 6
    //   88: invokeinterface 592 1 0
    //   93: ifeq +11 -> 104
    //   96: ldc_w 561
    ...
    //   132: checkcast 318	com/tencent/mm/modelvideo/s
    //   135: astore 8
    //   137: aload 8
    //   139: ifnull -24 -> 115
    //   142: aload 8
    //   144: invokevirtual 596	com/tencent/mm/modelvideo/s:getFileName	()Ljava/lang/String;
    //   147: invokestatic 599	com/tencent/mm/plugin/sns/model/ay:aPq	(Ljava/lang/String;)Ljava/lang/String;
    //   150: astore 9
    //   152: invokestatic 153	com/tencent/mm/plugin/sns/model/aj:faO	()Lcom/tencent/mm/plugin/sns/storage/n;
    //   155: aload 9
    //   157: invokevirtual 163	com/tencent/mm/plugin/sns/storage/n:aQm	(Ljava/lang/String;)Lcom/tencent/mm/plugin/sns/storage/SnsInfo;
    //   160: astore 9
    //   162: aload 9
    //   164: ifnull -49 -> 115
    //   167: aload 9
    ...
    //   172: getfield 175	com/tencent/mm/protocal/protobuf/TimeLineObject:ContentObj	Lcom/tencent/mm/protocal/protobuf/adp;
    //   175: ifnull -60 -> 115
    //   178: aload 9
    ...
    //   183: getfield 175	com/tencent/mm/protocal/protobuf/TimeLineObject:ContentObj	Lcom/tencent/mm/protocal/protobuf/adp;
    //   186: getfield 180	com/tencent/mm/protocal/protobuf/adp:LoV	Ljava/util/LinkedList;
    //   189: invokestatic 602	com/tencent/mm/sdk/platformtools/Util:isNullOrNil	(Ljava/util/List;)Z
    //   192: ifne -77 -> 115
    //   195: aload 9
    ...
    //   200: getfield 175	com/tencent/mm/protocal/protobuf/TimeLineObject:ContentObj	Lcom/tencent/mm/protocal/protobuf/adp;
    //   203: getfield 180	com/tencent/mm/protocal/protobuf/adp:LoV	Ljava/util/LinkedList;
    //   206: iconst_0
    //   207: invokevirtual 184	java/util/LinkedList:get	(I)Ljava/lang/Object;
    //   210: checkcast 186	com/tencent/mm/protocal/protobuf/cnb
    //   213: invokestatic 372	com/tencent/mm/plugin/sns/model/ay:E	(Lcom/tencent/mm/protocal/protobuf/cnb;)Ljava/lang/String;
    //   216: astore 9
    //   218: aload 9
    //   220: invokestatic 201	com/tencent/mm/sdk/platformtools/Util:isNullOrNil	(Ljava/lang/String;)Z
    //   223: ifne +219 -> 442
    //   226: new 604	com/tencent/mm/vfs/o
    //   229: dup
    //   230: aload 9
    //   232: invokespecial 605	com/tencent/mm/vfs/o:<init>	(Ljava/lang/String;)V
    //   235: astore 10
    //   237: aload 10
    //   239: invokevirtual 608	com/tencent/mm/vfs/o:exists	()Z
    //   242: ifeq +200 -> 442
    //   245: aload 10
    //   247: invokevirtual 611	com/tencent/mm/vfs/o:length	()J
    //   250: lstore 4
    //   252: ldc 203
    //   254: ldc_w 613
    //   257: iconst_5
    ...
    //   262: iconst_0
    //   263: aload 8
    //   265: invokevirtual 596	com/tencent/mm/modelvideo/s:getFileName	()Ljava/lang/String;
    //   268: aastore
    //   269: dup
    //   270: iconst_1
    //   271: lload 4
    //   273: invokestatic 579	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   276: aastore
    //   277: dup
    //   278: iconst_2
    //   279: aload 8
    //   281: getfield 616	com/tencent/mm/modelvideo/s:dRQ	I
    //   284: invokestatic 230	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   287: aastore
    //   288: dup
    //   289: iconst_3
    //   290: aload 8
    //   292: getfield 619	com/tencent/mm/modelvideo/s:jsm	J
    //   295: invokestatic 579	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   298: aastore
    //   299: dup
    //   300: iconst_4
    //   301: aload 9
    ...
    //   314: lload 4
    //   316: aload 8
    //   318: getfield 616	com/tencent/mm/modelvideo/s:dRQ	I
    //   321: i2l
    //   322: lcmp
    //   323: ifgt +119 -> 442
    //   326: aload 10
    //   328: invokevirtual 622	com/tencent/mm/vfs/o:delete	()Z
    //   331: pop
    //   332: iload_1
    //   333: iconst_1
    //   334: iadd
    ...
    //   336: aload 8
    //   338: iconst_0
    //   339: putfield 616	com/tencent/mm/modelvideo/s:dRQ	I
    //   342: aload 8
    //   344: iconst_1
    //   345: putfield 625	com/tencent/mm/modelvideo/s:cSx	I
    //   348: aload 8
    //   350: invokestatic 327	com/tencent/mm/modelvideo/u:f	(Lcom/tencent/mm/modelvideo/s;)Z
    //   353: pop
    //   354: goto -239 -> 115
    //   357: astore 8
    //   359: goto -244 -> 115
    //   362: getstatic 631	com/tencent/mm/plugin/report/service/h:CyF	Lcom/tencent/mm/plugin/report/service/h;
    //   365: ldc2_w 632
    //   368: ldc2_w 634
    //   371: iload_1
    //   372: i2l
    //   373: iconst_0
    //   374: invokevirtual 639	com/tencent/mm/plugin/report/service/h:idkeyStat	(JJJZ)V
    //   377: ldc 203
    //   379: ldc_w 641
    //   382: iconst_4
    ...
    //   417: iconst_3
    //   418: lload_2
    //   419: invokestatic 646	com/tencent/mm/sdk/platformtools/Util:ticksToNow	(J)J
    //   422: invokestatic 579	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   425: aastore
  ...
  final void fbQ()
  {
    ...
    g.aAk().postToWorker(new Runnable()
    {
      public final void run()
      {
        ...
        bg localbg1 = (bg)az.this.DOi.poll();
        if (localbg1 == null)
        {
          Log.w("MicroMsg.SnsVideoService", "try start download video task is null. queue size %d", new Object[] { Integer.valueOf(az.this.DOi.size()) });
          az.b(az.this);
          AppMethodBeat.o(95971);
          return;
        }
        ...
        {
          bool1 = bool2;
          if (localbg1.jpT.equals(az.this.DOh.jpT)) {
            bool1 = true;
          }
        }
        Object localObject = az.this;
        synchronized (((az)localObject).DOl)
        {
          localObject = ((az)localObject).DOl.iterator();
          if (((Iterator)localObject).hasNext())
          {
            f localf = (f)((Iterator)localObject).next();
            Log.i("MicroMsg.SnsVideoService", "SNS_PRELOAD_PAUSE pause preload sns:[%s]", new Object[] { localf.dHp });
            localf.stop();
          }
        }
        az.this.a(localbg2, bool1);
        AppMethodBeat.o(95971);
      }
    });
  ...
  public final boolean q(final String paramString, final Object[] paramArrayOfObject)
  {
    ...
    g.aAk().postToWorker(new Runnable()
    {
      public final void run()
      {
        ...
        o.bhk().m(paramString, paramArrayOfObject);
        if ((az.this.DOh != null) && (Util.isEqual(az.this.DOh.jpT, paramString))) {
          az.a(az.this);
        }
        bg localbg = (bg)az.this.DOj.get(paramString);
        az.this.DOi.remove(localbg);
