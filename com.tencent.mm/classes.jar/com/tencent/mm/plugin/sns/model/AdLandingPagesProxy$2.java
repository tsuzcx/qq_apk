  ...
  implements a.b
{
  ...
  public final void failed(long paramLong)
  {
    ...
    this.zwg.CLIENT_CALL("failed", new Object[] { Long.valueOf(paramLong) });
  ...
  public final void paused(long paramLong)
  {
    ...
    this.zwg.CLIENT_CALL("paused", new Object[] { Long.valueOf(paramLong) });
  ...
  public final void progress(long paramLong, int paramInt)
  {
    ...
    ae.v("AdLandingPagesProxy", "progress %d", new Object[] { Integer.valueOf(paramInt) });
    this.zwg.CLIENT_CALL("progress", new Object[] { Long.valueOf(paramLong), Integer.valueOf(paramInt) });
  ...
  public final void resumed(long paramLong)
  {
    ...
    this.zwg.CLIENT_CALL("resumed", new Object[] { Long.valueOf(paramLong) });
  ...
  public final void stopped(long paramLong)
  {
    ...
    this.zwg.CLIENT_CALL("stopped", new Object[] { Long.valueOf(paramLong) });
  ...
  public final void succeed(long paramLong)
  {
    ...
    this.zwg.CLIENT_CALL("succeed", new Object[] { Long.valueOf(paramLong) });
