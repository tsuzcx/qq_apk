  ...
  implements aw, com.tencent.mm.plugin.q.c
{
  ...
  public static boolean wVg = false;
  
  public SubCoreSandBox()
  {
    AppMethodBeat.i(28049);
    ac.i("MicroMsg.SubCoreSandBox", "SubCoreSandBox constructor at: " + System.currentTimeMillis());
  ...
  public final void W(Context paramContext, Intent paramIntent)
  {
    ...
    if (paramContext != null)
    {
      ...
      ac.i("MicroMsg.CrashSecondReport", "reportCrash() process:mm");
      h.wUl.idkeyStat(1185L, 0L, 1L, true);
      paramIntent.putExtra("exceptionProcess", "mm");
    }
    for (;;)
    {
      String str = com.tencent.mm.sandbox.monitor.a.bb(paramIntent);
      ac.i("MicroMsg.SubCoreSandBox", "startExceptionMonitorService() crashPreventPath:%s", new Object[] { str });
      paramIntent.putExtra("exceptionPreventPath", str);
      try
      {
        paramIntent.setClass(paramContext, ExceptionMonitorService.class);
        ai.getContext().startService(paramIntent);
        ...
        if (ai.eVb())
        {
          ac.i("MicroMsg.CrashSecondReport", "reportCrash() process:push");
          h.wUl.idkeyStat(1185L, 1L, 1L, true);
          paramIntent.putExtra("exceptionProcess", "push");
          continue;
        }
        ac.i("MicroMsg.CrashSecondReport", "reportCrash() process:other");
        h.wUl.idkeyStat(1185L, 2L, 1L, true);
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ac.e("MicroMsg.SubCoreSandBox", "startExceptionMonitorService() %s %s", new Object[] { localException.getClass().getSimpleName(), localException.getMessage() });
          paramIntent.setClass(paramContext, ExceptionMonitorBroadcastReceiver.class);
          ai.getContext().sendBroadcast(paramIntent);
        }
      }
    }
  }
  ...
  public final void X(Context paramContext, Intent paramIntent)
  {
    ...
    com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramIntent.aeD(), "com/tencent/mm/plugin/sandbox/SubCoreSandBox", "startAppUpdateUI", "(Landroid/content/Context;Landroid/content/Intent;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
  ...
  public final String amd(String paramString)
  {
    AppMethodBeat.i(28062);
    paramString = com.tencent.mm.sandbox.monitor.c.amd(paramString);
  ...
  public void clearPluginData(int paramInt)
  {
    ...
    ac.i("MicroMsg.SubCoreSandBox", "SubCoreSandBox clearPluginData at: " + System.currentTimeMillis());
  ...
  public final com.tencent.mm.plugin.q.a fL(Context paramContext)
  {
    AppMethodBeat.i(28058);
    paramContext = Updater.ik(paramContext);
  ...
  public HashMap<Integer, h.b> getBaseDBFactories()
  {
    ...
    ac.i("MicroMsg.SubCoreSandBox", "SubCoreSandBox getBaseDBFactories at: " + System.currentTimeMillis());
  ...
  public void onAccountPostReset(boolean paramBoolean)
  {
    ...
    ac.i("MicroMsg.SubCoreSandBox", "SubCoreSandBox onAccountPostReset at: " + System.currentTimeMillis());
  ...
  public void onAccountRelease()
  {
    ...
    ac.i("MicroMsg.SubCoreSandBox", "SubCoreSandBox onAccountRelease at: " + System.currentTimeMillis());
  ...
  public void onSdcardMount(boolean paramBoolean)
  {
    ...
    ac.i("MicroMsg.SubCoreSandBox", "SubCoreSandBox onSdcardMount at: " + System.currentTimeMillis());
