...
public final class f
{
  ...
  public static boolean ejc()
  {
    ...
    if (Util.milliSecondsToNow(zrm) > 86400000L)
    {
  ...
  public static String ejd()
  {
    ...
    Log.d("MicroMsg.MediaCodecUtil", "check hevc info last rpt time[%d]", new Object[] { Long.valueOf(zrm) });
    for (;;)
    {
      int i;
      int i5;
