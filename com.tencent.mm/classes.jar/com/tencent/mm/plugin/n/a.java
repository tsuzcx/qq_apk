  ...
  extends i
{
  ...
  final boolean a(long paramLong1, long paramLong2, z paramz, ByteBuffer paramByteBuffer, int paramInt, MediaCodec.BufferInfo paramBufferInfo)
  {
    ...
    if (this.bfn == null)
    {
      ...
      if (getChannels() == 1)
      {
        ...
        this.bfn = new com.tencent.mm.compatible.b.e(3, getSampleRate(), i, j);
        if ((this.bfn == null) || (this.bfn.getState() == 1)) {
          break label271;
        }
        Log.w("MicroMsg.AudioTrackDataSource", "%s can not create audio track [%d]", new Object[] { info(), Integer.valueOf(this.bfn.getState()) });
        this.bfn.release();
        this.bfn = null;
      }
      for (int i = 0;; i = 1)
    ...
    try
    {
      this.zrC.zru = paramBufferInfo.presentationTimeUs;
      byte[] arrayOfByte = new byte[paramBufferInfo.size];
      paramByteBuffer.get(arrayOfByte);
      paramByteBuffer.clear();
      paramLong1 = Util.currentTicks();
      if (arrayOfByte.length > 0) {
        this.bfn.write(arrayOfByte, 0, arrayOfByte.length);
      }
      Log.d("MicroMsg.AudioTrackDataSource", "%s finish to process index[%d] time[%d] to audio track, size:%s, cost:%s", new Object[] { info(), Integer.valueOf(paramInt), Long.valueOf(this.zrC.zru), Integer.valueOf(paramBufferInfo.size), Long.valueOf(Util.ticksToNow(paramLong1)) });
    ...
    catch (Exception paramz)
    {
      for (;;)
      {
        Log.e("MicroMsg.AudioTrackDataSource", "%s audio release output buffer error %s", new Object[] { info(), paramz.toString() });
      }
    }
    AppMethodBeat.o(133893);
    return true;
  ...
  final boolean a(z paramz)
  {
    ...
    MediaFormat localMediaFormat = ejl();
    int i = ((b)com.tencent.mm.kernel.g.af(b.class)).a(b.a.rYE, false) | WeChatEnvironment.hasDebugger();
    if (com.tencent.mm.compatible.util.d.oE(28)) {
      i = 0;
    }
    Object localObject1;
    if (i != 0)
    {
      ...
      boolean bool = ((com.tencent.mm.plugin.a.h)localObject1).Sy(this.path);
      long l2 = System.currentTimeMillis();
      if (bool)
      {
        Object localObject2 = ((com.tencent.mm.plugin.a.h)localObject1).jQz;
        Iterator localIterator = ((com.tencent.mm.plugin.a.h)localObject1).jQA.iterator();
        for (;;)
        {
          label185:
          label189:
          ...
          if (localIterator.hasNext())
          {
            ...
            if (((p)localObject1).jRq != null) {
              if (((p)localObject1).jRq.jQt == com.tencent.mm.plugin.a.g.jQq)
              {
                i = 1;
                if (i == 0) {
                  break label600;
                }
                l7 = ((m)localObject2).jQs;
                if ((((p)localObject1).jRr != null) && (((p)localObject1).jRr.jQb.size() == 1))
                {
                  localObject2 = ((p)localObject1).jRr;
                  localObject1 = ((p)localObject1).jRq;
                  l3 = ((com.tencent.mm.plugin.a.g)localObject1).duration;
                  l6 = ((com.tencent.mm.plugin.a.g)localObject1).jQs;
                  l4 = ((Long)((com.tencent.mm.plugin.a.d)localObject2).jQb.get(0)).longValue();
                  l5 = ((Long)((com.tencent.mm.plugin.a.d)localObject2).jQa.get(0)).longValue();
                  l7 = l4 + l5 * l6 / l7;
                  m = getSampleRate();
                  l8 = l3 - l7;
                  l9 = m * l4 / l6;
          ...
          com.tencent.mm.plugin.report.service.h.CyF.dN(1117, 0);
          com.tencent.mm.plugin.report.service.h.CyF.n(1117L, 1L, l2 - l1);
          com.tencent.mm.plugin.report.service.h.CyF.n(1117L, 3L, i);
          com.tencent.mm.plugin.report.service.h.CyF.n(1117L, 4L, (int)l9);
          com.tencent.mm.plugin.report.service.h.CyF.n(1117L, 5L, (int)l9 - i);
        }
      }
    }
    for (;;)
