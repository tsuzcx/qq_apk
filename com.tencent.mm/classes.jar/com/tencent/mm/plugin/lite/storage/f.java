  ...
  implements g.a
{
  ...
  {
    this(paramISQLiteDatabase, e.info, "LiteAppInfo");
  }
  
  private f(ISQLiteDatabase paramISQLiteDatabase, IAutoDBItem.MAutoDBInfo paramMAutoDBInfo, String paramString)
  {
  ...
  /* Error */
  public final e aCV(String paramString)
  {
    // Byte code:
    //   0: ldc 71
    ...
    //   39: astore_1
    //   40: aload_0
    //   41: getfield 50	com/tencent/mm/plugin/lite/storage/f:db	Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;
    //   44: aload_1
    //   45: iconst_0
    //   46: anewarray 22	java/lang/String
    //   49: iconst_2
    //   50: invokeinterface 83 4 0
    //   55: astore_2
    //   56: aload_2
    //   57: ifnull +48 -> 105
    //   60: aload_2
    ...
    //   71: aload_2
    //   72: astore_1
    //   73: new 24	com/tencent/mm/plugin/lite/storage/e
    //   76: dup
    //   77: invokespecial 91	com/tencent/mm/plugin/lite/storage/e:<init>	()V
    //   80: astore_3
    //   81: aload_2
    //   82: astore_1
    //   83: aload_3
    //   84: aload_2
    //   85: invokevirtual 95	com/tencent/mm/plugin/lite/storage/e:convertFrom	(Landroid/database/Cursor;)V
    //   88: aload_2
    //   89: ifnull +9 -> 98
    //   92: aload_2
    ...
    //   136: iconst_0
    //   137: aload_3
    //   138: invokestatic 108	com/tencent/mm/sdk/platformtools/Util:stackTraceToString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   141: aastore
    //   142: invokestatic 114	com/tencent/mm/sdk/platformtools/Log:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   145: aload_2
    //   146: ifnull -31 -> 115
    //   149: aload_2
    //   150: invokeinterface 98 1 0
    //   155: goto -40 -> 115
    //   158: astore_2
    //   159: aconst_null
    //   160: astore_1
