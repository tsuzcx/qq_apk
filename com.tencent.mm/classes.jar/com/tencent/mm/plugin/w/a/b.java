...
final class b
  extends a.a
{
  private final Map<String, a.b> qSf;
  
  b()
  {
    AppMethodBeat.i(156002);
    this.qSf = new HashMap();
    this.qSf.put("xiaomi", new a.b()
    {
    ...
    this.qSf.put("vivo", new b.3(this));
  ...
  private static String getManufacturer()
  {
    ...
    String str = ac.bH(ah.getContext()).toLowerCase();
  ...
  public final int cmq()
  {
    ...
    //   11: invokestatic 59	com/tencent/mm/sdk/platformtools/ah:getContext	()Landroid/content/Context;
    //   14: astore 6
    //   16: invokestatic 77	com/tencent/mm/plugin/w/a/b:getManufacturer	()Ljava/lang/String;
    //   19: astore_3
    //   20: ldc 79
    //   22: ldc 81
    //   24: iconst_1
    ...
    //   30: aload_3
    //   31: aastore
    //   32: invokestatic 88	com/tencent/mm/sdk/platformtools/ab:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   35: aload_3
    ...
    //   376: dup
    //   377: invokestatic 59	com/tencent/mm/sdk/platformtools/ah:getContext	()Landroid/content/Context;
    //   380: ldc 173
    ...
    //   503: invokestatic 221	com/tencent/mm/sdk/platformtools/ab:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   506: iload_1
    //   507: bipush 16
    ...
    //   580: invokestatic 232	com/tencent/mm/sdk/platformtools/ab:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   583: aload 4
    //   585: ifnull +10 -> 595
    //   588: aload 4
  ...
  public final boolean cmr()
  {
    ...
    a.b localb = (a.b)this.qSf.get(str);
    if ((this.qSf.containsKey(str)) && (localb.cms()))
    {
  ...
  public final void eR(Context paramContext)
  {
    ...
    Object localObject = ac.bH(paramContext).toLowerCase();
    ab.i("MicroMsg.AppPermissionSettingAdapterFactory", "[jumpPermissionSettingPage] manufacturer = %s", new Object[] { localObject });
    localObject = (a.b)this.qSf.get(localObject);
    if (localObject != null) {
      ((a.b)localObject).eS(paramContext);
    }
 ...
 * Qualified Name:     com.tencent.mm.plugin.w.a.b
