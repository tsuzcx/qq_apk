  ...
  extends LinearLayout
{
  ...
  public final void gC(List<Bundle> paramList)
  {
      ...
      for (;;)
      {
        ...
        localView.setOnClickListener(new View.OnClickListener()
        {
          public final void onClick(View paramAnonymousView)
          {
            ...
            com.tencent.mm.hellhoundlib.a.a.c("com/tencent/mm/plugin/qqmail/ui/MailAttachListLinearLayout$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).aFi());
            ...
            ((Intent)localObject).putExtra("attach_id", this.HqL);
            ((Intent)localObject).putExtra("total_size", j);
            ((Intent)localObject).putExtra("attach_url", this.HqM);
            ((Intent)localObject).putExtra("is_compress", MailAttachListLinearLayout.aVm(this.HqM));
            ((Intent)localObject).putExtra("is_preview", 1);
            ((Intent)localObject).putExtra("qqmail_cookie", c.ivX().getCookie(v.fss()));
            paramAnonymousView = MailAttachListLinearLayout.a(MailAttachListLinearLayout.this);
            localObject = new com.tencent.mm.hellhoundlib.b.a().bm(localObject);
            com.tencent.mm.hellhoundlib.a.a.b(paramAnonymousView, ((com.tencent.mm.hellhoundlib.b.a)localObject).aFh(), "com/tencent/mm/plugin/qqmail/ui/MailAttachListLinearLayout$1", "onClick", "(Landroid/view/View;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
        ...
        ((ImageView)localView.findViewById(e.e.readmail_attach_item_icon_iv)).setImageResource(FileExplorerUI.brL(str));
        i += 1;
        break;
