  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 1)
    {
      ...
      paramInt = i;
      if (this.xdh != null) {
        paramInt = i + f.a.a.b.b.a.e(4, this.xdh);
      }
      i = paramInt;
      if (this.md5 != null) {
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localao.uin = locala.NPN.zd();
        AppMethodBeat.o(215231);
        return 0;
      case 2: 
        localao.name = locala.NPN.readString();
        AppMethodBeat.o(215231);
        return 0;
      case 3: 
        localao.size = locala.NPN.zc();
        AppMethodBeat.o(215231);
        return 0;
      case 4: 
        localao.xdh = locala.NPN.readString();
        AppMethodBeat.o(215231);
        return 0;
      }
      localao.md5 = locala.NPN.readString();
      AppMethodBeat.o(215231);
      return 0;
    }
    AppMethodBeat.o(215231);
