  ...
  implements com.tencent.mm.plugin.welab.a.a.b
{
  public final String eWu()
  {
    ...
    String str = af.aFP("discoverRecommendEntry").optString("labIcon");
  ...
  public final String eWv()
  {
    ...
    String str = af.aFP("discoverRecommendEntry").optString("wording");
  ...
  public final void i(final Activity paramActivity, final String paramString)
  {
    ...
    {
      com.tencent.mm.sdk.platformtools.ad.e("MicroMsg.FTS.LookOneLookOpener", "fts h5 template not avail");
      AppMethodBeat.o(30249);
      return;
    }
    paramString = af.aFP("discoverRecommendEntry").optString("wording");
    if (bt.isNullOrNil(paramString))
    {
      com.tencent.mm.sdk.platformtools.ad.e("MicroMsg.FTS.LookOneLookOpener", "empty query");
      AppMethodBeat.o(30249);
      return;
    }
    ((i)g.ab(i.class)).a(aj.getContext(), new Runnable()
    {
      public final void run()
      {
        ...
        Object localObject = com.tencent.mm.plugin.websearch.api.ad.f(21, false, 2);
        ((Map)localObject).put("query", paramString);
        ((Map)localObject).put("sceneActionType", "2");
        localIntent.putExtra("rawUrl", com.tencent.mm.plugin.websearch.api.ad.e((Map)localObject, 1));
        localObject = new nt();
        ((nt)localObject).dBE.scene = 0;
