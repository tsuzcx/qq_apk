  ...
  implements MMSwitchBtn.a
{
  ...
  public final void onStatusChange(boolean paramBoolean)
  {
    ...
    if (WelabAppInfoUI.a(this.JGp).field_Switch == 2)
    {
      WelabAppInfoUI.a(this.JGp).field_Switch = 1;
      AppMethodBeat.o(146271);
      return;
    }
    if (WelabAppInfoUI.a(this.JGp).field_Switch == 1) {
      WelabAppInfoUI.a(this.JGp).field_Switch = 2;
    }
    AppMethodBeat.o(146271);
  }
}
