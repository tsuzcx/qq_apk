  ...
  extends HellActivity
{
  ...
  private com.tencent.mm.plugin.gwallet.a.b uOC;
    ...
    this.mReceiver = new BroadcastReceiver()
    {
      public final void onReceive(Context paramAnonymousContext, Intent paramAnonymousIntent)
      {
        ...
        if ("com.tencent.mm.gwallet.ACTION_CONSUME_REQUEST".equals(paramAnonymousIntent.getAction()))
        {
          ...
          com.tencent.mm.sdk.g.b.c(new b.2(GWalletUI.b(GWalletUI.this), paramAnonymousContext, new b.b()new aq
          {
            public final void b(c paramAnonymous2c, Intent paramAnonymous2Intent)
            {
              AppMethodBeat.i(64572);
              ae.d("MicroMsg.GWalletUI", "Purchase finished: " + paramAnonymous2c + ", purchase: " + paramAnonymous2Intent);
  ...
  public final void nu(final boolean paramBoolean)
  {
    AppMethodBeat.i(64577);
    com.tencent.mm.plugin.gwallet.a.b localb = this.uOC;
    b.b local4 = new b.b()
    {
      ...
      public final void b(c paramAnonymousc, Intent paramAnonymousIntent)
      {
        ...
        ae.d("MicroMsg.GWalletUI", "Query inventory finished. data : ".concat(String.valueOf(paramAnonymousIntent)));
        if (paramAnonymousIntent == null)
        {
          paramAnonymousIntent = new Intent("com.tencent.mm.gwallet.ACTION_QUERY_RESPONSE");
          paramAnonymousIntent.putExtra("RESPONSE_CODE", paramAnonymousc.dez());
        }
        for (;;)
        {
          if (!paramBoolean) {
    ...
    aq localaq = new aq();
    localb.aob("queryInventory");
    com.tencent.mm.sdk.g.b.c(new b.3(localb, "inapp", localaq, local4), "IabHelper_queryInventoryAsync");
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    {
      localb.aob("handleActivityResult");
      if (paramIntent == null)
      {
        com.tencent.mm.plugin.gwallet.a.b.aoc("Null data in IAB activity result.");
        paramIntent = new c(-1002, "Null data in IAB result");
        if (localb.uOT != null) {
          localb.uOT.b(paramIntent, null);
        }
      ...
      com.tencent.mm.plugin.gwallet.a.b.aoc("Intent with no response code, assuming OK (known issue)");
      paramInt1 = 0;
    }
    for (;;)
    {
      ...
      ae.d("MicroMsg.IabHelper", "Purchase data: ".concat(String.valueOf(localObject)));
      ae.d("MicroMsg.IabHelper", "Data signature: ".concat(String.valueOf(str)));
      ae.d("MicroMsg.IabHelper", "Extras: " + paramIntent.getExtras());
      ae.d("MicroMsg.IabHelper", "Expected item type: " + localb.uOU);
      localObject = new c(paramInt1, "Null data in IAB result");
      if (localb.uOT != null) {
        localb.uOT.b((c)localObject, paramIntent);
      }
      AppMethodBeat.o(64581);
      return;
      label247:
    ...
    com.tencent.mm.plugin.gwallet.a.b.aoc("Unexpected type for intent response code.");
    com.tencent.mm.plugin.gwallet.a.b.aoc(localObject.getClass().getName());
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    ae.d("MicroMsg.GWalletUI", "Creating IAB helper.");
    this.uOC = new com.tencent.mm.plugin.gwallet.a.b(this);
    ae.d("MicroMsg.GWalletUI", "Starting setup.");
    this.uOC.a(new b.a()
    {
      public final void a(c paramAnonymousc)
      {
        AppMethodBeat.i(64570);
        ae.d("MicroMsg.GWalletUI", "Setup finished.");
        if (!paramAnonymousc.isSuccess())
        {
          ae.e("MicroMsg.GWalletUI", "Problem setting up in-app billing: ".concat(String.valueOf(paramAnonymousc)));
          Intent localIntent = new Intent();
          localIntent.putExtra("RESPONSE_CODE", paramAnonymousc.dez());
        ...
        GWalletUI.this.nu(GWalletUI.this.getIntent().getBooleanExtra("is_direct", true));
        AppMethodBeat.o(64570);
      }
    });
  ...
  public void onDestroy()
  {
    ...
    ae.d("MicroMsg.GWalletUI", "Destroying helper.");
    if (this.uOC != null) {
      this.uOC.dispose();
    }
    this.uOC = null;
  ...
  public void onNewIntent(Intent paramIntent)
  {
    ...
    if ("com.tencent.mm.gwallet.ACTION_QUERY_REQUEST".equals(paramIntent.getAction())) {
      nu(paramIntent.getBooleanExtra("is_direct", true));
    }
