  ...
  extends HellActivity
{
  ...
  private com.tencent.mm.plugin.gwallet.a.b ssy;
    ...
    this.mPQ = new BroadcastReceiver()
    {
      public final void onReceive(Context paramAnonymousContext, Intent paramAnonymousIntent)
      {
        ...
        if ("com.tencent.mm.gwallet.ACTION_CONSUME_REQUEST".equals(paramAnonymousIntent.getAction()))
        {
          ...
          com.tencent.mm.sdk.g.b.c(new b.2(GWalletUI.b(GWalletUI.this), paramAnonymousContext, new b.b()new ap
          {
            public final void b(c paramAnonymous2c, Intent paramAnonymous2Intent)
            {
              AppMethodBeat.i(64572);
              ad.d("MicroMsg.GWalletUI", "Purchase finished: " + paramAnonymous2c + ", purchase: " + paramAnonymous2Intent);
  ...
  public final void md(final boolean paramBoolean)
  {
    AppMethodBeat.i(64577);
    com.tencent.mm.plugin.gwallet.a.b localb = this.ssy;
    b.b local4 = new b.b()
    {
      ...
      public final void b(c paramAnonymousc, Intent paramAnonymousIntent)
      {
        ...
        ad.d("MicroMsg.GWalletUI", "Query inventory finished. data : ".concat(String.valueOf(paramAnonymousIntent)));
        if (paramAnonymousIntent == null)
        {
          paramAnonymousIntent = new Intent("com.tencent.mm.gwallet.ACTION_QUERY_RESPONSE");
          paramAnonymousIntent.putExtra("RESPONSE_CODE", paramAnonymousc.cFr());
        }
        for (;;)
        {
          if (!paramBoolean) {
    ...
    ap localap = new ap();
    localb.adv("queryInventory");
    com.tencent.mm.sdk.g.b.c(new b.3(localb, "inapp", localap, local4), "IabHelper_queryInventoryAsync");
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    {
      localb.adv("handleActivityResult");
      if (paramIntent == null)
      {
        com.tencent.mm.plugin.gwallet.a.b.adw("Null data in IAB activity result.");
        paramIntent = new c(-1002, "Null data in IAB result");
        if (localb.ssP != null) {
          localb.ssP.b(paramIntent, null);
        }
      ...
      com.tencent.mm.plugin.gwallet.a.b.adw("Intent with no response code, assuming OK (known issue)");
      paramInt1 = 0;
    }
    for (;;)
    {
      ...
      ad.d("MicroMsg.IabHelper", "Purchase data: ".concat(String.valueOf(localObject)));
      ad.d("MicroMsg.IabHelper", "Data signature: ".concat(String.valueOf(str)));
      ad.d("MicroMsg.IabHelper", "Extras: " + paramIntent.getExtras());
      ad.d("MicroMsg.IabHelper", "Expected item type: " + localb.ssQ);
      localObject = new c(paramInt1, "Null data in IAB result");
      if (localb.ssP != null) {
        localb.ssP.b((c)localObject, paramIntent);
      }
      AppMethodBeat.o(64581);
      return;
      label247:
    ...
    com.tencent.mm.plugin.gwallet.a.b.adw("Unexpected type for intent response code.");
    com.tencent.mm.plugin.gwallet.a.b.adw(localObject.getClass().getName());
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    ad.d("MicroMsg.GWalletUI", "Creating IAB helper.");
    this.ssy = new com.tencent.mm.plugin.gwallet.a.b(this);
    ad.d("MicroMsg.GWalletUI", "Starting setup.");
    this.ssy.a(new b.a()
    {
      public final void a(c paramAnonymousc)
      {
        AppMethodBeat.i(64570);
        ad.d("MicroMsg.GWalletUI", "Setup finished.");
        if (!paramAnonymousc.isSuccess())
        {
          ad.e("MicroMsg.GWalletUI", "Problem setting up in-app billing: ".concat(String.valueOf(paramAnonymousc)));
          Intent localIntent = new Intent();
          localIntent.putExtra("RESPONSE_CODE", paramAnonymousc.cFr());
        ...
        GWalletUI.this.md(GWalletUI.this.getIntent().getBooleanExtra("is_direct", true));
        AppMethodBeat.o(64570);
      }
    });
  ...
  public void onDestroy()
  {
    ...
    ad.d("MicroMsg.GWalletUI", "Destroying helper.");
    if (this.ssy != null) {
      this.ssy.dispose();
    }
    this.ssy = null;
  ...
  public void onNewIntent(Intent paramIntent)
  {
    ...
    if ("com.tencent.mm.gwallet.ACTION_QUERY_REQUEST".equals(paramIntent.getAction())) {
      md(paramIntent.getBooleanExtra("is_direct", true));
    }
