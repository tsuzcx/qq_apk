  ...
  extends HellActivity
{
  ...
  private com.tencent.mm.plugin.gwallet.a.b uCX;
  ...
  public final void nq(final boolean paramBoolean)
  {
    AppMethodBeat.i(64577);
    com.tencent.mm.plugin.gwallet.a.b localb = this.uCX;
    b.b local4 = new b.b()
    {
      ...
      public final void b(c paramAnonymousc, Intent paramAnonymousIntent)
      {
        ...
        if (paramAnonymousIntent == null)
        {
          ...
          paramAnonymousIntent.putExtra("RESPONSE_CODE", paramAnonymousc.dbI());
        }
        for (;;)
        {
          if (!paramBoolean) {
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    {
      localb.ana("handleActivityResult");
      if (paramIntent == null)
      {
        com.tencent.mm.plugin.gwallet.a.b.anb("Null data in IAB activity result.");
        paramIntent = new c(-1002, "Null data in IAB result");
        if (localb.uDo != null) {
          localb.uDo.b(paramIntent, null);
        }
      ...
      com.tencent.mm.plugin.gwallet.a.b.anb("Intent with no response code, assuming OK (known issue)");
      paramInt1 = 0;
    }
    for (;;)
    {
      ...
      ad.d("MicroMsg.IabHelper", "Expected item type: " + localb.uDp);
      localObject = new c(paramInt1, "Null data in IAB result");
      if (localb.uDo != null) {
        localb.uDo.b((c)localObject, paramIntent);
      }
      AppMethodBeat.o(64581);
      return;
      label247:
    ...
    com.tencent.mm.plugin.gwallet.a.b.anb("Unexpected type for intent response code.");
    com.tencent.mm.plugin.gwallet.a.b.anb(localObject.getClass().getName());
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.uCX = new com.tencent.mm.plugin.gwallet.a.b(this);
    ...
    this.uCX.a(new b.a()
    {
      public final void a(c paramAnonymousc)
      {
        ...
        if (!paramAnonymousc.isSuccess())
        {
          ...
          localIntent.putExtra("RESPONSE_CODE", paramAnonymousc.dbI());
        ...
        GWalletUI.this.nq(GWalletUI.this.getIntent().getBooleanExtra("is_direct", true));
        AppMethodBeat.o(64570);
      }
    });
  ...
  public void onNewIntent(Intent paramIntent)
  {
    ...
    if ("com.tencent.mm.gwallet.ACTION_QUERY_REQUEST".equals(paramIntent.getAction())) {
      nq(paramIntent.getBooleanExtra("is_direct", true));
    }
