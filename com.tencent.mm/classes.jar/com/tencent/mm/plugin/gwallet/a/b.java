...
public final class b
{
  ...
  public IInAppBillingService ssL;
  private ServiceConnection ssM;
  boolean ssN = false;
  ...
  public static int ab(Bundle paramBundle)
  {
    ...
    adw("Unexpected type for bundle response code.");
    adw(paramBundle.getClass().getName());
  ...
  public final void a(final a parama)
  {
    ...
    this.ssM = new ServiceConnection()
    {
      public final void onServiceConnected(ComponentName paramAnonymousComponentName, IBinder paramAnonymousIBinder)
      {
        ...
        try
        {
          ...
          i = b.this.ssL.b(3, paramAnonymousComponentName, "subs");
          if (i == 0)
          {
    ...
    {
      this.mContext.bindService(localIntent, this.ssM, 1);
      AppMethodBeat.o(64593);
      return;
    }
  ...
  public final boolean a(ArrayList<String> paramArrayList, c paramc)
  {
    ...
    try
    {
      ...
      paramArrayList = this.ssL.getSkuDetails(3, this.mContext.getPackageName(), "inapp", (Bundle)localObject);
      int i = ab(paramArrayList);
    ...
    {
      adw("RemoteException while launching query details ");
  ...
  public final void dispose()
  {
    ...
    try
    {
      if (this.mContext != null) {
        this.mContext.unbindService(this.ssM);
      }
      this.ssM = null;
      this.ssL = null;
