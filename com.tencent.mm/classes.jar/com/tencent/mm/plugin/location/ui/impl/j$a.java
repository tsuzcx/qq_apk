...
{
  private final WeakReference<Context> vig;
  private final WeakReference<View> vih;
  
  j$a(Context paramContext, View paramView)
  {
    AppMethodBeat.i(56163);
    this.vig = new WeakReference(paramContext);
    this.vih = new WeakReference(paramView);
  ...
  protected final void onPreExecute()
  {
    ...
    View localView = (View)this.vih.get();
    if (localView != null) {
