  ...
  extends RelativeLayout
{
  ...
  public PoiHeaderView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramContext = View.inflate(this.context, 2131495938, this);
    this.gyt = ((TextView)paramContext.findViewById(2131302309));
    this.yHZ = ((SimpleImageView)paramContext.findViewById(2131302296));
    ...
    setOnClickListener(new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        ...
        a.b("com/tencent/mm/plugin/location/ui/PoiHeaderView$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).axR());
