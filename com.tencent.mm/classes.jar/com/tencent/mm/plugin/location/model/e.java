...
public final class e
{
  public static String a(LocationInfo paramLocationInfo)
  {
    ...
    if (paramLocationInfo.hVI == null) {
      paramLocationInfo.hVI = "";
    }
    paramLocationInfo = "<msg><location x=\"" + paramLocationInfo.KbW + "\" y=\"" + paramLocationInfo.KbX + "\" scale=\"" + paramLocationInfo.KbY + "\" label=\"" + Util.escapeStringForXml(paramLocationInfo.KbZ) + "\" poiname=\"" + Util.escapeStringForXml(paramLocationInfo.hVI) + "\" maptype=\"0\" /></msg>";
  ...
  public static String b(String paramString1, String paramString2, View paramView)
  {
    ...
    try
    {
      ...
      paramString1 = new u(paramString1 + paramString2 + ".png");
      paramString1.jKZ();
      try
      {
        paramString1 = y.ap(paramString1);
  ...
  public static PackageInfo bu(Context paramContext, String paramString)
  {
  ...
  public static boolean m(double paramDouble1, double paramDouble2)
  {
