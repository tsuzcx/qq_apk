...
public final class e
{
  public static String a(LocationInfo paramLocationInfo)
  {
    ...
    if (paramLocationInfo.dtN == null) {
      paramLocationInfo.dtN = "";
    }
    paramLocationInfo = "<msg><location x=\"" + paramLocationInfo.sOv + "\" y=\"" + paramLocationInfo.sOw + "\" scale=\"" + paramLocationInfo.sOx + "\" label=\"" + bt.aGf(paramLocationInfo.sOy) + "\" poiname=\"" + bt.aGf(paramLocationInfo.dtN) + "\" maptype=\"0\" /></msg>";
  ...
  public static String a(String paramString1, String paramString2, View paramView)
  {
    ...
    try
    {
      ...
      try
      {
        paramString1 = i.ai(paramString1);
