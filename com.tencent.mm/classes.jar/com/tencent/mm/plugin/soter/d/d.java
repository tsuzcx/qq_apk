...
public final class d
{
  public static e dEQ()
  {
    ...
    dER();
    Object localObject2 = ax.aFC(aj.eFD());
    ...
    if (localObject2 != null)
    {
      localObject1 = ((i)localObject2).yaF;
      localObject2 = String.valueOf(((i)localObject2).uid);
      if ((!bt.isNullOrNil((String)localObject1)) && (!bt.isNullOrNil((String)localObject2)))
      {
        jn((String)localObject1, (String)localObject2);
        localObject1 = new e((String)localObject1, (String)localObject2);
        AppMethodBeat.o(130840);
        return localObject1;
      }
  ...
  public static void jn(String paramString1, String paramString2)
  {
    ...
    Object localObject = ax.aFC(aj.eFD());
    if (localObject == null)
    {
