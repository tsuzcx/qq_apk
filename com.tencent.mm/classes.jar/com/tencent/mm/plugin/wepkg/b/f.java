  ...
  extends j<e>
{
  ...
  static
  {
    ...
    SQL_CREATE = new String[] { j.getCreateSQLs(e.gLr, "WepkgVersion") };
    BHA = null;
  ...
  private f(h paramh)
  {
    super(paramh, e.gLr, "WepkgVersion", e.INDEX_CREATE);
  ...
  public final boolean A(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    if ((!this.jqw) || (bt.isNullOrNil(paramString1)))
    {
      AppMethodBeat.o(110582);
      return false;
    }
    e locale = azH(paramString1);
    if (locale == null)
    {
      AppMethodBeat.o(110582);
      return false;
  ...
  public final boolean a(e parame, WePkgDiffInfo paramWePkgDiffInfo)
  {
    ...
    if ((!this.jqw) || (bt.isNullOrNil(parame.field_pkgId)))
    {
      AppMethodBeat.o(110581);
      return false;
    }
    Object localObject = azH(parame.field_pkgId);
    if (localObject == null) {}
    for (long l = com.tencent.mm.plugin.wepkg.utils.d.bqp();; l = ((e)localObject).field_accessTime)
    {
      if ((paramWePkgDiffInfo != null) && (!bt.isNullOrNil(paramWePkgDiffInfo.downloadUrl)))
      {
        localObject = etA().azH(parame.field_pkgId);
        if ((localObject != null) && (i.eK(((e)localObject).field_pkgPath)))
        {
          paramWePkgDiffInfo.fUW = ((e)localObject).field_pkgId;
          paramWePkgDiffInfo.oldVersion = ((e)localObject).field_version;
          paramWePkgDiffInfo.BIC = ((e)localObject).field_pkgPath;
          b.ety().vv(paramWePkgDiffInfo.fUW);
          localObject = b.ety();
          a locala = new a();
          locala.field_pkgId = paramWePkgDiffInfo.fUW;
          locala.field_oldVersion = paramWePkgDiffInfo.oldVersion;
          locala.field_oldPath = paramWePkgDiffInfo.BIC;
          ...
          locala.field_downloadNetType = paramWePkgDiffInfo.BID;
          ((b)localObject).insert(locala);
          ad.i("MicroMsg.Wepkg.WepkgVersionStorage", "insertDiffPkg");
        }
      }
      etA().azG(parame.field_pkgId);
      d.etz().azG(parame.field_pkgId);
      parame.field_nextCheckTime = (com.tencent.mm.plugin.wepkg.utils.d.bqp() + parame.field_checkIntervalTime);
      parame.field_createTime = com.tencent.mm.plugin.wepkg.utils.d.bqp();
  ...
  public final e azH(String paramString)
  {
  ...
  public final e azI(String paramString)
  {
    ...
    if (localCursor.moveToFirst())
    {
      ...
      paramString.field_accessTime = com.tencent.mm.plugin.wepkg.utils.d.bqp();
  ...
  public final boolean azJ(String paramString)
  {
    ...
    locale.field_nextCheckTime = (com.tencent.mm.plugin.wepkg.utils.d.bqp() + locale.field_checkIntervalTime);
    boolean bool = super.update(locale, new String[0]);
  ...
  public final boolean cl(String paramString, boolean paramBoolean)
  {
  ...
  public final List<String> etB()
  {
    ...
    Cursor localCursor = rawQuery(String.format("select %s from %s where %s < ?", new Object[] { "pkgId", "WepkgVersion", "nextCheckTime" }), new String[] { String.valueOf(com.tencent.mm.plugin.wepkg.utils.d.bqp()) });
  ...
  public final List<WepkgVersion> etC()
  {
    ...
    Cursor localCursor = rawQuery((String)localObject, new String[] { String.valueOf(com.tencent.mm.plugin.wepkg.utils.d.bqp()) });
