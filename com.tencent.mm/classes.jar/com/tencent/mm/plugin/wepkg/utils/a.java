...
public final class a
{
  ...
  public static String aAf(String paramString)
  {
    ...
    {
      ad.e("MicroMsg.WePkgReport", paramString.getMessage());
      AppMethodBeat.o(110784);
      return "";
    }
  ...
  public static void b(String paramString1, String paramString2, String paramString3, String paramString4, long paramLong1, long paramLong2, String paramString5)
  {
    ...
    ad.d("MicroMsg.WePkgReport", "reportWepkgLogicKv, scene = %s, url = %s, pkgId = %s, version = %s, resultCode = %d, costTime = %d, extInfo = %s", new Object[] { paramString1, paramString2, paramString3, paramString4, Long.valueOf(paramLong1), Long.valueOf(paramLong2), paramString5 });
    for (;;)
    {
      try
      {
        if (bt.isNullOrNil(paramString5))
        {
          ...
          ((JSONObject)localObject).put("netType", ay.iw(aj.getContext()));
          localObject = URLEncoder.encode(((JSONObject)localObject).toString(), "UTF-8");
      ...
      h.vKh.f(13980, new Object[] { paramString1, str3, paramString3, paramString4, Long.valueOf(paramLong1), localObject, Long.valueOf(paramLong2) });
  ...
  public static void c(String paramString1, int paramInt, String paramString2, long paramLong)
  {
    ...
    com.tencent.mm.plugin.wepkg.b.a locala = com.tencent.mm.plugin.wepkg.b.b.ety().azE(paramString1);
    if (locala != null)
    {
      paramString1 = r(new Object[] { paramString1, locala.field_version, Integer.valueOf(0), Integer.valueOf(paramInt), Integer.valueOf(0), Integer.valueOf(0), paramString2, "", locala.field_oldVersion, Integer.valueOf(4), Long.valueOf(paramLong), Integer.valueOf(locala.field_pkgSize) });
      com.tencent.mm.game.report.api.a.fUK.a(new com.tencent.mm.game.report.api.b(14229, paramString1));
    }
    AppMethodBeat.o(110782);
  }
  
  public static String r(Object... paramVarArgs)
  {
