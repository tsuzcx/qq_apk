  ...
  extends HandOffMP
{
  ...
  public final HandOff dbN()
  {
    ...
    Object localObject = new HandOffMG(this.dDH, this.title, this.kuy, this.uDT, this.dtE, this.uDJ, this.dET, this.hEw, this.key);
    ((HandOffMG)localObject).setId(this.id);
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/handoff/model/HandOffMG$Companion;", "", "()V", "CREATOR", "Landroid/os/Parcelable$Creator;", "Lcom/tencent/mm/plugin/handoff/model/HandOffMG;", "api-handoff_release"})
  public static final class a {}
  
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"com/tencent/mm/plugin/handoff/model/HandOffMG$Companion$CREATOR$1", "Landroid/os/Parcelable$Creator;", "Lcom/tencent/mm/plugin/handoff/model/HandOffMG;", "createFromParcel", "source", "Landroid/os/Parcel;", "newArray", "", "size", "", "(I)[Lcom/tencent/mm/plugin/handoff/model/HandOffMG;", "api-handoff_release"})
