  ...
  implements Parcelable
{
  ...
  public final BallInfo createBallInfo()
  {
    ...
    {
      localBallInfo.jkf.putString("handoff#id", this.id);
  ...
  protected abstract o<cru, byte[]> doCreateMultiTaskInfo();
