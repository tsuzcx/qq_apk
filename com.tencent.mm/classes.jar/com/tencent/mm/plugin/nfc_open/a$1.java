  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    int k;
    int i;
    if (bt.aO(((SharedPreferences)localObject).getLong("NFC_REPORT_TIME", 0L)) > 86400000L)
    {
      k = com.tencent.mm.plugin.nfc.b.a.a.duy().fV(aj.getContext());
      if (k != 0) {
        break label171;
      }
      i = 0;
    ...
    for (int j = 1;; j = 0)
    {
      ...
      g.yhR.f(12779, new Object[] { q.cH(true), Integer.valueOf(i), Integer.valueOf(j) });
      localObject = ((SharedPreferences)localObject).edit();
      ((SharedPreferences.Editor)localObject).putLong("NFC_REPORT_TIME", bt.HI());
