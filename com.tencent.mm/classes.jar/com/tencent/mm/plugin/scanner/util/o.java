...
public final class o
{
  public static String aE(Context paramContext, int paramInt)
  {
    ...
    if (paramInt == 0) {
      paramContext.getString(l.i.IFo);
    }
    for (;;)
    {
      paramContext = paramContext.getString(l.i.IFo);
      AppMethodBeat.o(52063);
      return paramContext;
      if (paramInt == 1) {
        paramContext.getString(l.i.IFl);
      } else if (paramInt == 2) {
        paramContext.getString(l.i.IFn);
      } else if (paramInt == 3) {
        paramContext.getString(l.i.IFm);
      }
    }
  }
  
  public static int aXB(String paramString)
  {
  ...
  public static a aXC(String paramString)
  {
    ...
    locala.IZR = a.o(localMap, ".search");
    AppMethodBeat.o(52066);
    return locala;
  }
  ...
  public static a fQ(String paramString, int paramInt)
  {
    ...
    if (!Util.isNullOrNil((String)((Map)localObject).get(str + ".product.$type")))
    {
      ...
      locala.IZR = a.o((Map)localObject, str + ".product");
  ...
  public static final class a
  {
      ...
      if (paramMap != null)
      {
        ...
        if (i < 1000)
        {
          ...
          for (localObject1 = Integer.valueOf(i);; localObject1 = "")
          {
            ...
            ((o.a.a.a)localObject3).link = ((String)localObject1);
            this.IZS.IZT.add(localObject3);
            i += 1;
            break;
          }
        }
        label182:
        this.IZS.IZU = new LinkedList();
        ...
        if (i < 1000)
        {
          ...
          for (paramString = Integer.valueOf(i);; paramString = "")
          {
            ...
            localObject3 = new o.a.a.b();
            ((o.a.a.b)localObject3).title = paramString;
            ((o.a.a.b)localObject3).desc = ((String)localObject2);
            this.IZS.IZU.add(localObject3);
            i += 1;
            break;
          }
        }
    ...
    public static final class a
    {
      public LinkedList<a> IZT;
      public LinkedList<b> IZU;
