...
public final class m
{
  ...
  public m()
  {
    ...
    this.ieg = new g.a()
    {
      public final int a(String paramAnonymousString, int paramAnonymousInt, c paramAnonymousc, d paramAnonymousd, boolean paramAnonymousBoolean)
      {
        ...
        {
          ae.i("MicroMsg.ScannerCdnService", "on cdn callback mediaId = %s, startRet = %d, keep_ProgressInfo = %s, keep_SceneResult = %s", new Object[] { paramAnonymousString, Integer.valueOf(paramAnonymousInt), paramAnonymousc, str });
          paramAnonymousc = new m.b(m.this);
          if (paramAnonymousInt == 0) {
            break label129;
          }
          ae.e("MicroMsg.ScannerCdnService", "start failed : %d, media id is :%s", new Object[] { Integer.valueOf(paramAnonymousInt), paramAnonymousString });
        ...
        if (paramAnonymousd != null)
        {
          ...
          ae.e("MicroMsg.ScannerCdnService", "cdntra clientid:%s sceneResult.retCode:%d sceneResult[%s]", new Object[] { paramAnonymousString, Integer.valueOf(paramAnonymousd.field_retCode), paramAnonymousd });
        }
        for (;;)
        {
          m.a(m.this, paramAnonymousString, paramAnonymousc);
          ...
          return 0;
          label198:
          ae.i("MicroMsg.ScannerCdnService", "cdn trans suceess, media id : %s", new Object[] { paramAnonymousString });
      ...
      public final void a(String paramAnonymousString, ByteArrayOutputStream paramAnonymousByteArrayOutputStream)
      {
        ...
        ae.i("MicroMsg.ScannerCdnService", "getCdnAuthInfo, mediaId = %s", new Object[] { paramAnonymousString });
      ...
      public final byte[] f(String paramAnonymousString, byte[] paramAnonymousArrayOfByte)
      {
        ...
        ae.i("MicroMsg.ScannerCdnService", "decodePrepareResponse, mediaId = %s", new Object[] { paramAnonymousString });
  ...
  public static String ayo(String paramString)
  {
    ...
    paramString = v.aAC() + "_" + paramString + "_" + System.currentTimeMillis();
  ...
  public final void a(String paramString1, String paramString2, int paramInt, a parama)
  {
    ...
    g localg = new g();
    localg.fLl = "task_ScannerCdnService";
    localg.fLm = this.ieg;
    ...
    this.nEq.put(paramString1, parama);
    f.aGZ().f(localg);
