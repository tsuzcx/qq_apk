...
public final class q
{
  ...
  public static boolean b(List<a> paramList, Map<String, a.a> paramMap)
  {
    ...
    for (boolean bool1 = false; i < paramList.size(); bool1 = bool2)
    {
      ...
      {
        LinkedList localLinkedList = ((a)paramList.get(i)).lFr;
        int j = 0;
        bool2 = false;
  ...
  public static LinkedList<String> fu(List<a> paramList)
  {
    ...
    {
      LinkedList localLinkedList2 = ((a)paramList.get(i)).lFr;
      int j = 0;
  ...
  public static Map<String, a.a> fv(List<String> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      localObject = a.o(bw.M((String)localObject, "action"), ".action");
      if ((localObject != null) && (((a.a)localObject).dlp != 2)) {
