  ...
  extends MMService
{
  ...
  public final int onStartCommand(Intent paramIntent, int paramInt1, int paramInt2)
  {
    ...
    if (str.contains("mm.gj.qq.com"))
    {
      ...
      d.aY(new Intent(aj.getContext(), BakOldUSBService.class).putExtra("url", paramIntent.getStringExtra("url")).putExtra("isFromWifi", true));
      stopSelf();
      AppMethodBeat.o(21624);
      return 2;
    }
    this.mvW = paramIntent.getBooleanExtra("isFromWifi", false);
    this.jVE = paramIntent.getBooleanExtra("isMove", false);
    ad.i("MicroMsg.BackupPcService", "onStartCommand Broadcast url:%s, isFromWifi:%b, isMove:%b", new Object[] { str, Boolean.valueOf(this.mvW), Boolean.valueOf(this.jVE) });
    if ((!this.jVE) && (!az.arW()))
    {
      ...
      com.tencent.mm.hellhoundlib.a.a.a(this, paramIntent.adn(), "com/tencent/mm/plugin/backup/backuppcmodel/BackupPcService", "onStartCommand", "(Landroid/content/Intent;II)I", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
