  ...
  implements DialogInterface.OnClickListener
{
  ...
  public final void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    if (paramDialogInterface.hOf == 1)
    {
      paramDialogInterface.hOb.resume();
      return;
    }
    if (paramDialogInterface.hOf == 6)
    {
      paramDialogInterface.hOc.resume();
      return;
    }
    y.e("MicroMsg.BakPcProcessMgr", "cancel in error state, %d", new Object[] { Integer.valueOf(paramDialogInterface.hOf) });
  }
}
