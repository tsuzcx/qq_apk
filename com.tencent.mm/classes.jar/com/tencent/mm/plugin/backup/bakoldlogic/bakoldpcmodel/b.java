  ...
  implements b.a
{
  ...
  public b()
  {
    ...
    this.nGl = Boolean.FALSE;
    this.serverSocket = null;
    this.socket = null;
    this.nGm = null;
    this.nGn = new aq(Looper.getMainLooper());
    this.nGo = null;
  ...
  private void a(DataInputStream paramDataInputStream)
  {
    ...
    try
    {
      ...
      {
        int j;
        if ((!this.nGl.booleanValue()) && (this.nGp != 4))
        {
        ...
        try
        {
          ...
          if (this.nGq - (l1 - l2) < 10L)
          {
            ...
            if (i == 0)
            {
              str = String.format("GSMW in the %dth step error:expect:%02X, butGet:%02X", new Object[] { Integer.valueOf(this.nGp + 1), Integer.valueOf(nyA[this.nGp] & 0xFF), Integer.valueOf(j & 0xFF) });
              ae.e("MicroMsg.BakOldJavaEngine", str);
            ...
            if (k > 16777216)
            {
              ...
              ae.e("MicroMsg.BakOldJavaEngine", str);
              this.nGl = Boolean.TRUE;
              a(true, 0, 10007, str.getBytes());
              AppMethodBeat.o(21877);
              return;
            }
            int m = paramDataInputStream.readInt();
            ae.i("MicroMsg.BakOldJavaEngine", "read buf size:".concat(String.valueOf(k)));
            ...
            if (s1 != 1)
            {
              ...
              ae.e("MicroMsg.BakOldPacker", (String)localObject1);
              localPByteArray.value = ((String)localObject1).getBytes();
              i = -1;
              ae.d("MicroMsg.BakOldJavaEngine", "summerbak loopRead unpack ret[%d]", new Object[] { Integer.valueOf(i) });
              if (i == 0) {
                break label756;
              }
            ...
            for (localObject1 = "";; localObject1 = new String(localPByteArray.value))
            {
              ...
              AppMethodBeat.o(21877);
              return;
              if (com.tencent.mm.plugin.backup.g.b.bHY() != 1) {
                break label821;
              }
              ...
              for (;;)
              {
                ...
                i = 0;
                break;
                localObject1 = l.d((byte[])localObject2, d.bHZ());
              }
            }
            ae.d("MicroMsg.BakOldJavaEngine", "summerbak loopRead unpack ret[%d], seq[%d], type[%d]", new Object[] { Integer.valueOf(i), Integer.valueOf(j), Short.valueOf(s2) });
    ...
    {
      ae.e("MicroMsg.BakOldJavaEngine", "loopRead %s", new Object[] { localException });
    }
  }
  ...
  private void bKl()
  {
    ...
    //   6: aload_0
    //   7: iconst_0
    //   8: putfield 91	com/tencent/mm/plugin/backup/bakoldlogic/bakoldpcmodel/b:nGp	I
    //   11: aload_0
    //   12: iconst_0
    //   13: putfield 93	com/tencent/mm/plugin/backup/bakoldlogic/bakoldpcmodel/b:nGq	I
    //   16: aload_0
    //   17: lconst_0
    //   18: putfield 95	com/tencent/mm/plugin/backup/bakoldlogic/bakoldpcmodel/b:nGr	J
    //   21: aload_0
    //   22: getstatic 287	java/lang/Boolean:TRUE	Ljava/lang/Boolean;
    //   25: putfield 66	com/tencent/mm/plugin/backup/bakoldlogic/bakoldpcmodel/b:nGl	Ljava/lang/Boolean;
    //   28: aload_0
    ...
    //   34: monitorenter
    //   35: aload_0
    //   36: getfield 87	com/tencent/mm/plugin/backup/bakoldlogic/bakoldpcmodel/b:nGo	Ljava/io/DataOutputStream;
    //   39: ifnull +10 -> 49
    //   42: aload_0
    //   43: getfield 87	com/tencent/mm/plugin/backup/bakoldlogic/bakoldpcmodel/b:nGo	Ljava/io/DataOutputStream;
  ...
  private void bKm()
  {
    ...
    if ((this.nGm == null) || (this.nGm.isQuit())) {
      this.nGm = new aq("BackupJavaEngine_handler");
    }
  ...
  public final void aD(final byte[] paramArrayOfByte)
  {
    ...
    if (this.nGl.booleanValue())
    {
      ae.e("MicroMsg.BakOldJavaEngine", "engine has stop");
      AppMethodBeat.o(21875);
      return;
    }
    this.nGm.post(new Runnable()
    {
      public final void run()
      {
        ...
        {
          ae.e("MicroMsg.BakOldJavaEngine", "send_error %s", new Object[] { localException });
          b.c(b.this);
  ...
  public final void bKk()
  {
    ...
    ae.i("MicroMsg.BakOldJavaEngine", "close connect");
    bKl();
    a(true, 0, 10003, null);
    AppMethodBeat.o(21871);
  }
  
  public final void f(final int paramInt, final List<abj> paramList)
  {
    AppMethodBeat.i(21870);
    ae.i("MicroMsg.BakOldJavaEngine", "connect type:%d", new Object[] { Integer.valueOf(paramInt) });
    bKm();
    com.tencent.mm.sdk.g.b.c(new Runnable()
    {
      public final void run()
      {
        ...
        default: 
          ...
          return;
        case 1: 
          localObject = (WifiManager)ak.getContext().getSystemService("wifi");
          ...
          ae.e("MicroMsg.BakOldJavaEngine", "localip:%s, mask:%d", new Object[] { str, Integer.valueOf(k) });
          localObject = null;
          i = 0;
          ...
          {
            abj localabj = (abj)localIterator.next();
            ae.i("MicroMsg.BakOldJavaEngine", "try ip:%s", new Object[] { localabj.Gpn });
            if (localabj.Gpn != null)
            {
              String[] arrayOfString = localabj.Gpn.split("\\.");
              if (arrayOfString.length >= 4)
              {
                int m = o.E(new byte[] { (byte)(bu.getInt(arrayOfString[0], 0) & 0xFF), (byte)(bu.getInt(arrayOfString[1], 0) & 0xFF), (byte)(bu.getInt(arrayOfString[2], 0) & 0xFF), (byte)(bu.getInt(arrayOfString[3], 0) & 0xFF) });
                if ((k & m) == (k & j))
                {
                  b.a(b.this, localabj.Gpn, ((Integer)localabj.Gtd.getFirst()).intValue());
                  AppMethodBeat.o(21864);
                  return;
                }
                ...
                localObject = localabj.Gpn;
                i = ((Integer)localabj.Gtd.getFirst()).intValue();
              }
            }
          }
        }
        ...
        for (;;)
        {
          ...
          if (localObject != null)
          {
            ae.w("MicroMsg.BakOldJavaEngine", "try to connect to secondary:%s, port:%d", new Object[] { localObject, Integer.valueOf(i) });
          ...
          ae.e("MicroMsg.BakOldJavaEngine", "not match ip mask:%d, localip:%s", new Object[] { Integer.valueOf(k), str });
          AppMethodBeat.o(21864);
          return;
          b.a(b.this, ((Integer)((abj)paramList.get(0)).Gtd.getFirst()).intValue());
          break;
        }
      }
  ...
  public final void l(final int paramInt, final byte[] paramArrayOfByte)
  {
    ...
    this.nGn.postDelayed(new Runnable()
    {
      public final void run()
      {
