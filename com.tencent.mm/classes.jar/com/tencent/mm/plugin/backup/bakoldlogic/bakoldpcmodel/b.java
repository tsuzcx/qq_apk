  ...
  implements b.a
{
  ...
  public b()
  {
    ...
    this.nAQ = Boolean.FALSE;
    this.serverSocket = null;
    this.socket = null;
    this.nAR = null;
    this.nAS = new ap(Looper.getMainLooper());
    this.nAT = null;
  ...
  private void a(DataInputStream paramDataInputStream)
  {
    ...
    try
    {
      ...
      {
        int j;
        if ((!this.nAQ.booleanValue()) && (this.nAU != 4))
        {
        ...
        try
        {
          ...
          if (this.nAV - (l1 - l2) < 10L)
          {
            ...
            if (i == 0)
            {
              str = String.format("GSMW in the %dth step error:expect:%02X, butGet:%02X", new Object[] { Integer.valueOf(this.nAU + 1), Integer.valueOf(ntf[this.nAU] & 0xFF), Integer.valueOf(j & 0xFF) });
            ...
            for (localObject1 = "";; localObject1 = new String(localPByteArray.value))
            {
              ...
              AppMethodBeat.o(21877);
              return;
              if (com.tencent.mm.plugin.backup.g.b.bHa() != 1) {
                break label821;
              }
              ...
              for (;;)
              {
                ...
                i = 0;
                break;
                localObject1 = l.d((byte[])localObject2, d.bHb());
              }
            }
  ...
  private void bJn()
  {
    ...
    //   6: aload_0
    //   7: iconst_0
    //   8: putfield 91	com/tencent/mm/plugin/backup/bakoldlogic/bakoldpcmodel/b:nAU	I
    //   11: aload_0
    //   12: iconst_0
    //   13: putfield 93	com/tencent/mm/plugin/backup/bakoldlogic/bakoldpcmodel/b:nAV	I
    //   16: aload_0
    //   17: lconst_0
    //   18: putfield 95	com/tencent/mm/plugin/backup/bakoldlogic/bakoldpcmodel/b:nAW	J
    //   21: aload_0
    //   22: getstatic 287	java/lang/Boolean:TRUE	Ljava/lang/Boolean;
    //   25: putfield 66	com/tencent/mm/plugin/backup/bakoldlogic/bakoldpcmodel/b:nAQ	Ljava/lang/Boolean;
    //   28: aload_0
    ...
    //   34: monitorenter
    //   35: aload_0
    //   36: getfield 87	com/tencent/mm/plugin/backup/bakoldlogic/bakoldpcmodel/b:nAT	Ljava/io/DataOutputStream;
    //   39: ifnull +10 -> 49
    //   42: aload_0
    //   43: getfield 87	com/tencent/mm/plugin/backup/bakoldlogic/bakoldpcmodel/b:nAT	Ljava/io/DataOutputStream;
  ...
  private void bJo()
  {
    ...
    if ((this.nAR == null) || (this.nAR.isQuit())) {
      this.nAR = new ap("BackupJavaEngine_handler");
    }
  ...
  public final void f(final int paramInt, final List<aba> paramList)
  {
      ...
      public final void run()
      {
        ...
        case 1: 
          ...
          while (localIterator.hasNext())
          {
            ...
            ad.i("MicroMsg.BakOldJavaEngine", "try ip:%s", new Object[] { localaba.FWO });
            if (localaba.FWO != null)
            {
              String[] arrayOfString = localaba.FWO.split("\\.");
              if (arrayOfString.length >= 4)
              {
                int m = o.E(new byte[] { (byte)(bt.getInt(arrayOfString[0], 0) & 0xFF), (byte)(bt.getInt(arrayOfString[1], 0) & 0xFF), (byte)(bt.getInt(arrayOfString[2], 0) & 0xFF), (byte)(bt.getInt(arrayOfString[3], 0) & 0xFF) });
                if ((k & m) == (k & j))
                {
                  b.a(b.this, localaba.FWO, ((Integer)localaba.Gaw.getFirst()).intValue());
                  AppMethodBeat.o(21864);
                  return;
                }
                ...
                localObject = localaba.FWO;
                i = ((Integer)localaba.Gaw.getFirst()).intValue();
              }
            }
          }
        }
        ...
        for (;;)
        {
          ...
          AppMethodBeat.o(21864);
          return;
          b.a(b.this, ((Integer)((aba)paramList.get(0)).Gaw.getFirst()).intValue());
          break;
        }
      }
  ...
  public final void l(final int paramInt, final byte[] paramArrayOfByte)
  {
    ...
    this.nAS.postDelayed(new Runnable()
    {
      public final void run()
      {
