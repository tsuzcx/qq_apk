  ...
  extends a
{
  ...
  private Map<String, k.a> hKj = null;
  ...
  private void auu()
  {
    ...
    //   12: putfield 50	com/tencent/mm/plugin/backup/f/k:hKj	Ljava/util/Map;
    ...
    //   72: astore 6
    //   74: aload 7
    //   76: getstatic 24	com/tencent/mm/plugin/backup/f/k:hKd	Ljava/lang/String;
    ...
    //   89: aload_3
    //   90: astore 6
    //   92: new 6	com/tencent/mm/plugin/backup/f/k$a
    //   95: dup
    //   96: invokespecial 103	com/tencent/mm/plugin/backup/f/k$a:<init>	()V
    //   99: astore 7
    //   101: aload 4
    //   103: astore 5
    //   105: aload_3
    ...
    //   125: astore 6
    //   127: aload 8
    //   129: getstatic 28	com/tencent/mm/plugin/backup/f/k:END	Ljava/lang/String;
    ...
    //   193: astore 6
    //   195: aload 8
    //   197: getstatic 32	com/tencent/mm/plugin/backup/f/k:hKe	Ljava/lang/String;
    ...
    //   213: aload 7
    //   215: aload 9
    //   217: putfield 124	com/tencent/mm/plugin/backup/f/k$a:hKl	Ljava/lang/String;
    //   220: aload 4
    //   222: astore 5
    //   224: aload_3
    //   225: astore 6
    //   227: aload_0
    //   228: getfield 50	com/tencent/mm/plugin/backup/f/k:hKj	Ljava/util/Map;
    //   231: aload 7
    //   233: getfield 127	com/tencent/mm/plugin/backup/f/k$a:hKk	Ljava/lang/String;
    //   236: aload 7
    ...
    //   318: astore 6
    //   320: aload 8
    //   322: getstatic 36	com/tencent/mm/plugin/backup/f/k:hKf	Ljava/lang/String;
    ...
    //   338: aload 7
    //   340: aload 9
    //   342: putfield 127	com/tencent/mm/plugin/backup/f/k$a:hKk	Ljava/lang/String;
    //   345: goto -125 -> 220
    //   348: astore 4
    //   350: aload 6
    //   352: astore_3
    ...
    //   379: astore 6
    //   381: aload 8
    //   383: getstatic 40	com/tencent/mm/plugin/backup/f/k:hKg	Ljava/lang/String;
    ...
    //   399: aload 7
    //   401: aload 9
    //   403: putfield 172	com/tencent/mm/plugin/backup/f/k$a:hKm	Ljava/lang/String;
    //   406: goto -186 -> 220
    //   409: aload 4
    //   411: astore 5
    //   413: aload_3
    //   414: astore 6
    //   416: aload 8
    //   418: getstatic 44	com/tencent/mm/plugin/backup/f/k:hKh	Ljava/lang/String;
    ...
    //   434: aload 7
    //   436: aload 9
    //   438: putfield 175	com/tencent/mm/plugin/backup/f/k$a:hKn	Ljava/lang/String;
    //   441: goto -221 -> 220
    //   444: aload 4
    //   446: astore 5
    //   448: aload_3
    ...
    //   460: iconst_0
    //   461: aload 7
    //   463: invokevirtual 178	com/tencent/mm/plugin/backup/f/k$a:toString	()Ljava/lang/String;
    //   466: aastore
  ...
  public static k.a xy(String paramString)
  {
    if (hKi == null) {
      hKi = new k();
    }
    Object localObject = hKi;
    if (((k)localObject).hKj == null) {
      ((k)localObject).auu();
    }
    localObject = ((k)localObject).hKj.values().iterator();
  ...
  public static k.a xz(String paramString)
  {
    if (hKi == null)
    {
      localk = new k();
    ...
    return (k.a)localk.hKj.get(paramString);
  }
