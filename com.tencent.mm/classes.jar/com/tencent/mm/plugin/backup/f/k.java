...
public final class k
  extends a
{
  private static String vbb = "icon_";
  private static String vbc = "img";
  private static String vbd = "iphone";
  private static String vbe = "android";
  private static String vbf = "s60v3";
  private static String vbg = "s60v5";
  private static k vbh;
  private Map<String, a> vbi;
  ...
  public static a ahH(String paramString)
  {
    AppMethodBeat.i(21532);
    if (vbh == null) {
      vbh = new k();
    }
    Object localObject = vbh;
    if (((k)localObject).vbi == null) {
      ((k)localObject).cVU();
    }
    localObject = ((k)localObject).vbi.values().iterator();
    while (((Iterator)localObject).hasNext())
    {
      a locala = (a)((Iterator)localObject).next();
      if ((locala.vbk != null) && (locala.vbk.equals(paramString)))
      {
  ...
  public static a ahI(String paramString)
  {
    ...
    paramString = (a)localk.vbi.get(paramString);
  ...
  private void cVU()
  {
    ...
    //   18: putfield 57	com/tencent/mm/plugin/backup/f/k:vbi	Ljava/util/Map;
    //   21: invokestatic 120	com/tencent/mm/sdk/platformtools/MMApplicationContext:getContext	()Landroid/content/Context;
    ...
    //   78: astore 6
    //   80: aload 7
    //   82: getstatic 25	com/tencent/mm/plugin/backup/f/k:vbb	Ljava/lang/String;
    ...
    //   95: aload_3
    //   96: astore 6
    //   98: new 6	com/tencent/mm/plugin/backup/f/k$a
    //   101: dup
    //   102: invokespecial 155	com/tencent/mm/plugin/backup/f/k$a:<init>	()V
    //   105: astore 7
    //   107: aload 4
    //   109: astore 5
    //   111: aload_3
    ...
    //   131: astore 6
    //   133: aload 8
    //   135: getstatic 29	com/tencent/mm/plugin/backup/f/k:vbc	Ljava/lang/String;
    ...
    //   199: astore 6
    //   201: aload 8
    //   203: getstatic 33	com/tencent/mm/plugin/backup/f/k:vbd	Ljava/lang/String;
    ...
    //   219: aload 7
    //   221: aload 9
    //   223: putfield 93	com/tencent/mm/plugin/backup/f/k$a:vbk	Ljava/lang/String;
    //   226: aload 4
    //   228: astore 5
    //   230: aload_3
    //   231: astore 6
    //   233: aload_0
    //   234: getfield 57	com/tencent/mm/plugin/backup/f/k:vbi	Ljava/util/Map;
    //   237: aload 7
    //   239: getfield 176	com/tencent/mm/plugin/backup/f/k$a:vbj	Ljava/lang/String;
    //   242: aload 7
    ...
    //   272: invokestatic 192	com/tencent/mm/sdk/platformtools/Log:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   275: aload 4
    //   277: ifnull +8 -> 285
    //   280: aload 4
    ...
    //   308: invokestatic 211	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   311: sipush 21535
    ...
    //   323: astore 6
    //   325: aload 8
    //   327: getstatic 37	com/tencent/mm/plugin/backup/f/k:vbe	Ljava/lang/String;
    ...
    //   343: aload 7
    //   345: aload 9
    //   347: putfield 176	com/tencent/mm/plugin/backup/f/k$a:vbj	Ljava/lang/String;
    //   350: goto -124 -> 226
    //   353: astore 4
    //   355: aload 6
    //   357: astore_3
    ...
    //   390: astore 6
    //   392: aload 8
    //   394: getstatic 41	com/tencent/mm/plugin/backup/f/k:vbf	Ljava/lang/String;
    ...
    //   410: aload 7
    //   412: aload 9
    //   414: putfield 214	com/tencent/mm/plugin/backup/f/k$a:vbl	Ljava/lang/String;
    //   417: goto -191 -> 226
    //   420: aload 4
    //   422: astore 5
    //   424: aload_3
    //   425: astore 6
    //   427: aload 8
    //   429: getstatic 45	com/tencent/mm/plugin/backup/f/k:vbg	Ljava/lang/String;
    ...
    //   445: aload 7
    //   447: aload 9
    //   449: putfield 217	com/tencent/mm/plugin/backup/f/k$a:vbm	Ljava/lang/String;
    //   452: goto -226 -> 226
    //   455: aload 4
    //   457: astore 5
    //   459: aload_3
    ...
    //   477: aastore
    //   478: invokestatic 225	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   481: iload_1
    //   482: iconst_1
    //   483: iadd
    //   484: istore_1
  ...
  public static final class a
  {
    ...
    {
      this.vbj = paramString1;
      this.vbk = paramString2;
      this.vbl = paramString3;
      this.vbm = paramString4;
    }
    
    public final String toString()
    {
      AppMethodBeat.i(21531);
      String str = this.vbj + " " + this.vbk + " " + this.vbl + " " + this.vbm;
 ...
 * Qualified Name:     com.tencent.mm.plugin.backup.f.k
