...
import com.tencent.mm.plugin.report.c.a;
...
public class e
{
  private static boolean wSU;
  private static Map<Long, Long> wTT;
  private static a wTU;
  private static int wTV;
  private static boolean wTW;
  ...
  public static void a(long paramLong1, long paramLong2, String paramString, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (wSU) {
          k.dyU().w(paramLong1, paramString);
        }
      ...
      {
        ac.e("MicroMsg.KVEasyReport", "localReport :%s", new Object[] { bs.m(localException) });
        continue;
      }
      try
      {
      ...
      {
        ac.printErrStackTrace("MicroMsg.KVEasyReport", localThrowable, "", new Object[0]);
        if (d.la(20))
        {
          SmcLogic.writeKvDataWithType(paramLong1, paramLong2, paramString, paramBoolean1, paramBoolean3);
          continue;
  ...
  public static void a(long paramLong, byte[] paramArrayOfByte, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean2) {
      ...
      {
        ac.e("MicroMsg.KVEasyReport", "localReport :%s", new Object[] { bs.m(paramArrayOfByte) });
        AppMethodBeat.o(143836);
        return;
      }
    }
  ...
  public static void b(long paramLong1, long paramLong2, long paramLong3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (e.class.getClassLoader() == null)
      {
        ...
        j = -1;
        ac.i("MicroMsg.KVEasyReport", "SmcLogic.reportIDKey class loader %s, %s ", new Object[] { Integer.valueOf(i), Integer.valueOf(j) });
      }
      try
      {
        ...
        if (wTW)
        {
          ...
          long l = bs.a((Long)wTT.get(Long.valueOf(paramLong1)), 0L);
          paramLong1 = l;
          if (l > 0L) {
            continue;
          }
  ...
  public static void dyO()
  {
    ...
    //   8: getstatic 146	com/tencent/mm/plugin/report/service/e:wTT	Ljava/util/Map;
    //   11: ifnonnull +15 -> 26
    //   14: new 192	java/util/HashMap
    //   17: dup
    //   18: bipush 20
    //   20: invokespecial 194	java/util/HashMap:<init>	(I)V
    //   23: putstatic 146	com/tencent/mm/plugin/report/service/e:wTT	Ljava/util/Map;
    //   26: invokestatic 198	com/tencent/mm/plugin/report/c/a:dyI	()Lcom/tencent/mm/protocal/protobuf/bjq;
    //   29: astore_0
    //   30: aload_0
    //   31: ifnull +103 -> 134
    //   34: aload_0
    //   35: getfield 203	com/tencent/mm/protocal/protobuf/bjq:EYZ	I
    //   38: getstatic 32	com/tencent/mm/plugin/report/service/e:wTV	I
    //   41: if_icmpeq +93 -> 134
    //   44: aload_0
    //   45: getfield 203	com/tencent/mm/protocal/protobuf/bjq:EYZ	I
    //   48: putstatic 32	com/tencent/mm/plugin/report/service/e:wTV	I
    //   51: getstatic 146	com/tencent/mm/plugin/report/service/e:wTT	Ljava/util/Map;
    //   54: invokeinterface 206 1 0
    //   59: aload_0
    //   60: getfield 210	com/tencent/mm/protocal/protobuf/bjq:EZa	Ljava/util/LinkedList;
    //   63: astore_0
    //   64: aload_0
    //   65: ifnull +69 -> 134
    //   68: aload_0
    ...
    //   88: checkcast 228	com/tencent/mm/protocal/protobuf/bwr
    //   91: astore_1
    //   92: getstatic 146	com/tencent/mm/plugin/report/service/e:wTT	Ljava/util/Map;
    //   95: new 151	java/lang/Long
    //   98: dup
    //   99: aload_1
    //   100: getfield 231	com/tencent/mm/protocal/protobuf/bwr:FlP	I
    //   103: i2l
    //   104: invokespecial 234	java/lang/Long:<init>	(J)V
    //   107: new 151	java/lang/Long
    //   110: dup
    //   111: aload_1
    //   112: getfield 237	com/tencent/mm/protocal/protobuf/bwr:FlQ	I
    //   115: i2l
    ...
    //   142: dup
    //   143: iconst_0
    //   144: getstatic 32	com/tencent/mm/plugin/report/service/e:wTV	I
    //   147: invokestatic 139	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   150: aastore
    //   151: dup
    //   152: iconst_1
    //   153: getstatic 146	com/tencent/mm/plugin/report/service/e:wTT	Ljava/util/Map;
    //   156: invokeinterface 244 1 0
    //   161: invokestatic 139	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   164: aastore
    //   165: dup
    //   166: iconst_2
    //   167: getstatic 146	com/tencent/mm/plugin/report/service/e:wTT	Ljava/util/Map;
    //   170: aastore
    //   171: dup
    //   172: iconst_3
    //   173: invokestatic 248	com/tencent/mm/sdk/platformtools/bs:eWi	()Lcom/tencent/mm/sdk/platformtools/as;
    //   176: aastore
    //   177: invokestatic 141	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   180: ldc 190
    ...
    //   91	21	1	localbwr	com.tencent.mm.protocal.protobuf.bwr
    // Exception table:
    //   from	to	target	type
    //   3	26	128	finally
    //   26	30	128	finally
  ...
  public static void pP(boolean paramBoolean)
  {
    ...
    ac.i("MicroMsg.KVEasyReport", "summerhv setHeavyUser [%b %b], stack[%s]", new Object[] { Boolean.valueOf(wTW), Boolean.valueOf(paramBoolean), bs.eWi() });
    wTW = paramBoolean;
