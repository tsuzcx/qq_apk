  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      {
        paramVarArgs.lJ(2, this.chattingOp.computeSize());
        this.chattingOp.writeFields(paramVarArgs);
      }
      if (this.msgOp != null)
      {
        paramVarArgs.lJ(3, this.msgOp.computeSize());
    ...
    if (paramInt == 1)
    {
      ...
      paramInt = i;
      if (this.chattingOp != null) {
        paramInt = i + f.a.a.a.lI(2, this.chattingOp.computeSize());
      }
      i = paramInt;
      if (this.msgOp != null) {
        i = paramInt + f.a.a.a.lI(3, this.msgOp.computeSize());
      }
      AppMethodBeat.o(151535);
      return i;
    }
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        localIMBehavior.opType = ((f.a.a.a.a)localObject1).OmT.zc();
        AppMethodBeat.o(151535);
        return 0;
      case 2: 
