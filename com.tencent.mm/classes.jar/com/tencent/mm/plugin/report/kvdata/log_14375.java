  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      {
        paramVarArgs.ln(8, this.dbStatusInfo_.computeSize());
        this.dbStatusInfo_.writeFields(paramVarArgs);
      }
      if (this.sdStatusInfo_ != null)
      {
        paramVarArgs.ln(9, this.sdStatusInfo_.computeSize());
        this.sdStatusInfo_.writeFields(paramVarArgs);
      }
      if (this.heavyDetailInfo_ != null)
      {
        paramVarArgs.ln(10, this.heavyDetailInfo_.computeSize());
    ...
    if (paramInt == 1)
    {
      i = f.a.a.b.b.a.bx(1, this.import_ds_) + 0 + f.a.a.b.b.a.bx(2, this.ds_) + f.a.a.b.b.a.p(3, this.uin_) + f.a.a.b.b.a.bx(4, this.device_) + f.a.a.b.b.a.bx(5, this.clientVersion_) + f.a.a.b.b.a.p(6, this.time_stamp_) + f.a.a.b.b.a.bx(7, this.type_);
      paramInt = i;
      if (this.dbStatusInfo_ != null) {
        paramInt = i + f.a.a.a.lm(8, this.dbStatusInfo_.computeSize());
      }
      i = paramInt;
      if (this.sdStatusInfo_ != null) {
        i = paramInt + f.a.a.a.lm(9, this.sdStatusInfo_.computeSize());
      }
      paramInt = i;
      if (this.heavyDetailInfo_ != null) {
        paramInt = i + f.a.a.a.lm(10, this.heavyDetailInfo_.computeSize());
      }
      AppMethodBeat.o(151549);
      return paramInt;
    }
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        locallog_14375.import_ds_ = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(151549);
        return 0;
      case 2: 
        locallog_14375.ds_ = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(151549);
        return 0;
      case 3: 
        locallog_14375.uin_ = ((f.a.a.a.a)localObject1).LVo.xG();
        AppMethodBeat.o(151549);
        return 0;
      case 4: 
        locallog_14375.device_ = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(151549);
        return 0;
      case 5: 
        locallog_14375.clientVersion_ = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(151549);
        return 0;
      case 6: 
        locallog_14375.time_stamp_ = ((f.a.a.a.a)localObject1).LVo.xG();
        AppMethodBeat.o(151549);
        return 0;
      case 7: 
        locallog_14375.type_ = ((f.a.a.a.a)localObject1).LVo.xF();
        AppMethodBeat.o(151549);
        return 0;
      case 8: 
