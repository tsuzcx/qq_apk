  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aR(7, this.type_);
      if (this.dbStatusInfo_ != null)
      {
        paramVarArgs.kX(8, this.dbStatusInfo_.computeSize());
        this.dbStatusInfo_.writeFields(paramVarArgs);
      }
      if (this.sdStatusInfo_ != null)
      {
        paramVarArgs.kX(9, this.sdStatusInfo_.computeSize());
        this.sdStatusInfo_.writeFields(paramVarArgs);
      }
      if (this.heavyDetailInfo_ != null)
      {
        paramVarArgs.kX(10, this.heavyDetailInfo_.computeSize());
    ...
    if (paramInt == 1)
    {
      i = f.a.a.b.b.a.bA(1, this.import_ds_) + 0 + f.a.a.b.b.a.bA(2, this.ds_) + f.a.a.b.b.a.q(3, this.uin_) + f.a.a.b.b.a.bA(4, this.device_) + f.a.a.b.b.a.bA(5, this.clientVersion_) + f.a.a.b.b.a.q(6, this.time_stamp_) + f.a.a.b.b.a.bA(7, this.type_);
      paramInt = i;
      if (this.dbStatusInfo_ != null) {
        paramInt = i + f.a.a.a.kW(8, this.dbStatusInfo_.computeSize());
      }
      i = paramInt;
      if (this.sdStatusInfo_ != null) {
        i = paramInt + f.a.a.a.kW(9, this.sdStatusInfo_.computeSize());
      }
      paramInt = i;
      if (this.heavyDetailInfo_ != null) {
        paramInt = i + f.a.a.a.kW(10, this.heavyDetailInfo_.computeSize());
      }
      AppMethodBeat.o(151549);
      return paramInt;
    }
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        ...
        return -1;
      case 1: 
        locallog_14375.import_ds_ = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(151549);
        return 0;
      case 2: 
        locallog_14375.ds_ = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(151549);
        return 0;
      case 3: 
        locallog_14375.uin_ = ((f.a.a.a.a)localObject1).KhF.xT();
        AppMethodBeat.o(151549);
        return 0;
      case 4: 
        locallog_14375.device_ = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(151549);
        return 0;
      case 5: 
        locallog_14375.clientVersion_ = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(151549);
        return 0;
      case 6: 
        locallog_14375.time_stamp_ = ((f.a.a.a.a)localObject1).KhF.xT();
        AppMethodBeat.o(151549);
        return 0;
      case 7: 
        locallog_14375.type_ = ((f.a.a.a.a)localObject1).KhF.xS();
        AppMethodBeat.o(151549);
        return 0;
      case 8: 
