  ...
  implements d
{
  ...
  public final void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean)
  {
    ...
    ae.d("MicroMsg.ReportService", "idkeyGroupForPair [%d, %d] -> %d / [%d, %d] -> %d", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt3), Integer.valueOf(paramInt5), Integer.valueOf(paramInt2), Integer.valueOf(paramInt4), Integer.valueOf(paramInt6) });
    this.ywA.a(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramBoolean);
  ...
  public final void a(int paramInt, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.ywA.a(paramInt, paramString, paramBoolean1, paramBoolean2);
  ...
  public final void a(int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, Object... paramVarArgs)
  {
    ...
    this.ywA.a(paramInt, paramBoolean1, paramBoolean2, paramBoolean3, paramVarArgs);
  ...
  public final void a(int paramInt, boolean paramBoolean1, boolean paramBoolean2, Object... paramVarArgs)
  {
    ...
    this.ywA.a(paramInt, paramBoolean1, paramBoolean2, paramVarArgs);
  ...
  public final void b(ArrayList<IDKey> paramArrayList, boolean paramBoolean)
  {
    ...
    this.ywA.b(paramArrayList, paramBoolean);
  ...
  public final void c(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    ...
    ae.d("MicroMsg.ReportService", "idkeyGroupForPairAverger [%d, %d] -> %d / [%d, %d] -> 1", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt4), Integer.valueOf(paramInt1), Integer.valueOf(paramInt3) });
    this.ywA.c(paramInt1, paramInt2, paramInt3, paramInt4, paramBoolean);
  ...
  public final void f(int paramInt, Object... paramVarArgs)
  {
    ...
    this.ywA.f(paramInt, paramVarArgs);
  ...
  public final void g(String paramString1, String paramString2, Map<String, Object> paramMap)
  {
    ...
    this.ywA.g(paramString1, paramString2, paramMap);
  ...
  public final void idkeyStat(long paramLong1, long paramLong2, long paramLong3, boolean paramBoolean)
  {
    ...
    ae.d("MicroMsg.ReportService", "idkeyStat [%d, %d] -> %d", new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), Long.valueOf(paramLong3) });
    this.ywA.idkeyStat(paramLong1, paramLong2, paramLong3, paramBoolean);
  ...
  public final void kvStat(int paramInt, String paramString)
  {
    ...
    this.ywA.kvStat(paramInt, paramString);
    ...
    implements d
  {
    public final void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean)
    {
      ...
      ae.i("MicroMsg.ReportService", "this is DummyReportService");
