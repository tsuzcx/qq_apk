  ...
  extends MMActivity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.sHC = new g(this, getContext(), getIntent().getIntExtra("IPCallFeedbackDialogUI_KRoomId", 0), getIntent().getLongExtra("IPCallFeedbackDialogUI_KCallseq", 0L));
    this.sHC.setOnDismissListener(new DialogInterface.OnDismissListener()
    {
    ...
    this.sHC.getWindow().setSoftInputMode(16);
    this.sHC.show();
