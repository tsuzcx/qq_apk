  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    localb.bm(paramView);
    a.b("com/tencent/mm/plugin/ipcall/ui/DialPadController$8", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.axR());
    this.ytr.ysZ.setCursorVisible(true);
    this.ytr.gte.hideVKB();
    this.ytr.yto = true;
