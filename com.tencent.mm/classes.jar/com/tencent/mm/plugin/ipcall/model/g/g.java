  ...
  extends a
{
  ...
  public final void b(c paramc)
  {
    ...
    if (paramc != null)
    {
      l locall = new l(paramc.roomId, paramc.sAZ, paramc.sBC);
      az.aeS().a(locall, 0);
      ad.i("MicroMsg.IPCallReportService", "start report, roomid: %d, callseq: %d, isAccept: %b", new Object[] { Integer.valueOf(paramc.roomId), Long.valueOf(paramc.sAZ), Boolean.valueOf(paramc.sBC) });
    }
