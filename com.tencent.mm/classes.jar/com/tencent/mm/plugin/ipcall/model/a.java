...
{
  private static a szI = null;
  private long endTime;
  ap handler;
  private boolean isLoading;
  private long startTime;
  public ArrayList<a> szH;
  
  private a()
  {
    AppMethodBeat.i(25329);
    this.isLoading = false;
    this.szH = new ArrayList();
    this.startTime = -1L;
    this.endTime = -1L;
    this.handler = new ap(Looper.getMainLooper())
    {
      public final void handleMessage(Message paramAnonymousMessage)
      {
        ...
        Object localObject1 = i.cHq();
        Object localObject2 = (ArrayList)paramAnonymousMessage.obj;
        if ((localObject2 != null) && (((List)localObject2).size() > 0))
        {
          long l2 = ((d)localObject1).rb(Thread.currentThread().getId());
        ...
        a.a(a.this, -1L);
        a.d(a.this);
        paramAnonymousMessage = a.this.szH.iterator();
        while (paramAnonymousMessage.hasNext())
        {
          localObject1 = (a.a)paramAnonymousMessage.next();
          if (localObject1 != null) {
            ((a.a)localObject1).cGU();
          }
        }
        a.this.szH.clear();
