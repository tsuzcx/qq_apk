...
@l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/plugin/findersdk/api/NetSceneFinderGetUser;", "Lcom/tencent/mm/modelbase/NetSceneBase;", "Lcom/tencent/mm/network/IOnGYNetEnd;", "urlList", "", "", "(Ljava/util/List;)V", "TAG", "callback", "Lcom/tencent/mm/modelbase/IOnSceneEnd;", "comRR", "Lcom/tencent/mm/modelbase/CommReqResp;", "doScene", "", "dispatcher", "Lcom/tencent/mm/network/IDispatcher;", "getType", "onGYNetEnd", "", "netId", "errType", "errCode", "errMsg", "rr", "Lcom/tencent/mm/network/IReqResp;", "cookie", "", "finder-sdk_release"})
  ...
  implements com.tencent.mm.network.k
{
  ...
  public k(List<String> paramList)
  {
    ...
    localajj.Dly.addAll((Collection)paramList);
    paramList = new ajk();
    locala.c((a)localajj);
    locala.d((a)paramList);
    locala.nB(getType());
    locala.wg("/cgi-bin/micromsg-bin/findergetuser");
    this.qpm = locala.atI();
