...
public final class b
{
  ...
  private static Map<String, Long> ohx;
  private static Map<String, Integer> ohy;
  ...
  private static PendingIntent SB(String paramString)
  {
  ...
  private static void cancelNotification(String paramString)
  {
    ...
    synchronized (lock)
    {
      Integer localInteger = (Integer)ohy.get(paramString);
      ...
      ohy.remove(paramString);
      ohx.remove(paramString);
      AppMethodBeat.o(8837);
      return;
    }
  }
  ...
  public static void l(com.tencent.mm.plugin.downloader.g.a parama)
  {
    ...
    {
      Object localObject3 = com.tencent.mm.br.a.bD(aj.getContext(), "reminder_channel_id");
      Object localObject2 = (Long)ohx.get(parama.field_downloadUrl);
      ??? = localObject2;
      if (localObject2 == null)
      {
        ??? = Long.valueOf(System.currentTimeMillis());
        ohx.put(parama.field_downloadUrl, ???);
      }
      ...
      default: 
        ...
        return;
      case 1: 
        ((s.c)localObject3).as(com.tencent.mm.br.a.cYf());
        int j = i;
        if (i == 0) {
          j = 1;
        }
      ...
      for (;;)
      {
        ...
        ((s.c)localObject3).Ew = SB(parama.field_appId);
        synchronized (lock)
        {
          localObject2 = (Integer)ohy.get(parama.field_downloadUrl);
          if (localObject2 == null)
          {
            ...
            ohy.put(parama.field_downloadUrl, Integer.valueOf(i));
            if (parama.field_status == 4)
            {
              ohy.remove(parama.field_downloadUrl);
              ohx.remove(parama.field_downloadUrl);
            }
            AppMethodBeat.o(8836);
            return;
            ...
            ((s.c)localObject3).Ew = SB(parama.field_appId);
            if ((parama.field_errCode == com.tencent.mm.plugin.downloader.a.a.ocj) || (parama.field_errCode == com.tencent.mm.plugin.downloader.a.a.ocf)) {
            ...
            for (;;)
            {
              ((s.c)localObject3).Ew = SB(parama.field_appId);
              break;
              if (com.tencent.mm.plugin.downloader.model.a.oe(parama.field_downloadId))
              {
            ...
            cancelNotification(parama.field_downloadUrl);
            ??? = aj.getContext();
            localObject2 = com.tencent.mm.br.a.bD((Context)???, "reminder_channel_id");
            ((s.c)localObject2).f(parama.field_fileName);
            ((s.c)localObject2).as(com.tencent.mm.br.a.cYf());
            ((s.c)localObject2).F(true);
            localObject3 = new Intent();
            Context localContext = aj.getContext();
            ((Intent)localObject3).setClass(localContext, FileDownloadPendingReceive.class);
            ((Intent)localObject3).putExtra(FileDownloadService.ofH, 3);
            ((Intent)localObject3).putExtra(FileDownloadService.ofI, parama.field_filePath);
            ((Intent)localObject3).putExtra(FileDownloadService.ofJ, parama.field_md5);
            ((Intent)localObject3).putExtra("downloadId", parama.field_downloadId);
            ((s.c)localObject2).Ew = PendingIntent.getBroadcast(localContext, (int)System.currentTimeMillis(), (Intent)localObject3, 0);
            if (parama.field_reserveInWifi) {
