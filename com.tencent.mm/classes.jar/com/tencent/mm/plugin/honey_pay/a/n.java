  ...
  extends r
{
  ...
  public n(String paramString1, String paramString2)
  {
    ...
    ((b.a)localObject).gUU = new dff();
    ((b.a)localObject).gUV = new dfg();
    ((b.a)localObject).funcId = getType();
    ((b.a)localObject).uri = "/cgi-bin/mmpay-bin/unbindhpcard";
    ((b.a)localObject).reqCmdId = 0;
    ((b.a)localObject).respCmdId = 0;
    this.rr = ((b.a)localObject).atI();
    localObject = (dff)this.rr.gUS.gUX;
    ((dff)localObject).Duy = paramString1;
    ((dff)localObject).Dbd = paramString2;
  ...
  public final void b(int paramInt1, int paramInt2, String paramString, q paramq)
  {
    ...
    this.suW = ((dfg)((b)paramq).gUT.gUX);
    ad.i("MicroMsg.NetSceneUnbindHoneyPayCard", "retcode: %s, retmsg: %s", new Object[] { Integer.valueOf(this.suW.ntx), this.suW.nty });
