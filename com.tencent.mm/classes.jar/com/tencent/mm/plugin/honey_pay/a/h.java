  ...
  extends r
{
  ...
  public h(long paramLong, String paramString1, String paramString2)
  {
    ...
    ((b.a)localObject).hNM = new cav();
    ((b.a)localObject).hNN = new caw();
    ((b.a)localObject).funcId = getType();
    ((b.a)localObject).uri = "/cgi-bin/mmpay-bin/modifyhppayercreditline";
    ((b.a)localObject).hNO = 0;
    ((b.a)localObject).respCmdId = 0;
    this.rr = ((b.a)localObject).aDC();
    localObject = (cav)this.rr.hNK.hNQ;
    ((cav)localObject).Gbu = paramLong;
    ((cav)localObject).Gbt = paramString1;
    ((cav)localObject).GyY = paramString2;
    this.uFo = paramLong;
  ...
  public final void b(int paramInt1, int paramInt2, String paramString, q paramq)
  {
    ...
    this.uFn = ((caw)((b)paramq).hNL.hNQ);
    ad.i("MicroMsg.NetSceneModifyHoneyPayerCreditLine", "retcode: %s, retmsg: %s", new Object[] { Integer.valueOf(this.uFn.ozR), this.uFn.ozS });
