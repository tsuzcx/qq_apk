...
public final class j
{
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt)
  {
    ...
    paramString1 = z.Br("emoje_stroe");
    z.aBG().F(paramString1, true).k("prePublishId", "emoje_stroe");
    localIntent.putExtra("reportSessionId", paramString1);
    com.tencent.mm.br.d.c(paramContext, "sns", ".ui.SnsUploadUI", localIntent);
    ...
    ((com.tencent.mm.pluginsdk.j)com.tencent.mm.kernel.g.ab(com.tencent.mm.pluginsdk.j.class)).b(paramMMActivity.getController(), paramString2, paramString4, paramString3, "", paramMMActivity.getString(2131755884), new y.a()
    {
      public final void a(boolean paramAnonymousBoolean, String paramAnonymousString, int paramAnonymousInt)
      {
        ...
        if (paramAnonymousBoolean)
        {
          ...
          ae.d("MicroMsg.emoji.EmojiSharedMgr", "doSharedToFriend");
          ...
          q.aIW();
          localObject2 = com.tencent.mm.av.d.wA(str2);
          if ((localObject2 != null) && (!((Bitmap)localObject2).isRecycled()))
          {
            ae.i("MicroMsg.emoji.EmojiSharedMgr", "thumb image is not null");
          ...
          ((sv)localObject2).dIs.toUser = str1;
          ((sv)localObject2).dIs.dvf = 49;
          ((sv)localObject2).dIs.dIt = str1;
          ((sv)localObject2).dIs.dIu = "";
          a.IvT.l((b)localObject2);
          if (!TextUtils.isEmpty(paramAnonymousString))
          {
            localObject1 = new sy();
            ((sy)localObject1).dID.cUB = str1;
            ((sy)localObject1).dID.content = paramAnonymousString;
            ((sy)localObject1).dID.type = x.Bb(str1);
            ((sy)localObject1).dID.flags = 0;
            a.IvT.l((b)localObject1);
          }
          h.cm(paramMMActivity, paramMMActivity.getString(2131755894));
    ...
    ((com.tencent.mm.pluginsdk.j)com.tencent.mm.kernel.g.ab(com.tencent.mm.pluginsdk.j.class)).a(paramMMActivity, paramString1, str1, str2, str3, paramString5, new y.a()
    {
      public final void a(boolean paramAnonymousBoolean, String paramAnonymousString, int paramAnonymousInt)
      {
        ...
        if (paramAnonymousBoolean)
        {
          ...
          q.aIW();
          localObject2 = com.tencent.mm.av.d.wA((String)localObject2);
          if ((localObject2 != null) && (!((Bitmap)localObject2).isRecycled()))
          {
            ae.i("MicroMsg.emoji.EmojiSharedMgr", "thumb image is not null");
            localObject3 = new ByteArrayOutputStream();
          ...
          com.tencent.mm.plugin.report.service.g.yxI.f(10993, new Object[] { Integer.valueOf(0), str2 });
          h.cm(paramMMActivity, paramMMActivity.getString(2131755894));
        }
  ...
  public static void eD(Context paramContext)
  {
    ...
    com.tencent.mm.br.d.c(paramContext, ".ui.transmit.SelectConversationUI", localIntent, 2002);
