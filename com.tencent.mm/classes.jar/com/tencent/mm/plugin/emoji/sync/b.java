...
public final class b
{
    ...
    implements j
  {
    ...
    public b(int paramInt1, int paramInt2, BlockingQueue<Runnable> paramBlockingQueue)
    {
      ...
      this.rdw = this.ibI.newCondition();
    ...
    public final void beforeExecute(java.lang.Thread paramThread, Runnable paramRunnable)
    {
      ...
      //   6: aload_1
      //   7: aload_2
      //   8: invokespecial 59	com/tencent/f/b:beforeExecute	(Ljava/lang/Thread;Ljava/lang/Runnable;)V
      //   11: aload_0
      //   12: getfield 36	com/tencent/mm/plugin/emoji/sync/b$b:ibI	Ljava/util/concurrent/locks/ReentrantLock;
      ...
      //   22: ifeq +51 -> 73
      //   25: aload_0
      //   26: getfield 42	com/tencent/mm/plugin/emoji/sync/b$b:rdw	Ljava/util/concurrent/locks/Condition;
      ...
      //   60: aload_0
      //   61: getfield 36	com/tencent/mm/plugin/emoji/sync/b$b:ibI	Ljava/util/concurrent/locks/ReentrantLock;
      ...
      //   72: return
      //   73: aload_0
      //   74: getfield 36	com/tencent/mm/plugin/emoji/sync/b$b:ibI	Ljava/util/concurrent/locks/ReentrantLock;
      ...
      //   86: astore_1
      //   87: aload_0
      //   88: getfield 36	com/tencent/mm/plugin/emoji/sync/b$b:ibI	Ljava/util/concurrent/locks/ReentrantLock;
