...
{
  public static ArrayList<EmojiGroupInfo> aoM(String paramString)
  {
    ...
    for (;;)
    {
      ...
      else if ((localObject2 != null) && (((Node)localObject2).getNodeName() != null) && (((Node)localObject2).getNodeName().equals("ButtonType")))
      {
        ...
        if (!Util.isNullOrNil(localEmojiGroupInfo.field_productID))
        {
          ...
          h.OAn.b(12068, new Object[] { Integer.valueOf(1), localEmojiGroupInfo.field_productID, Integer.valueOf(localEmojiGroupInfo.field_recommandType) });
