  ...
  implements k
{
  ...
  public l(String paramString, int paramInt1, int paramInt2)
  {
    ...
    this.cR = paramInt2;
    paramString = new b.a();
    paramString.hvt = new GetEmotionDetailRequest();
    paramString.hvu = new GetEmotionDetailResponse();
  ...
  public final EmotionDetail ccC()
  {
    AppMethodBeat.i(108702);
    new EmotionDetail();
    EmotionDetail localEmotionDetail = ((GetEmotionDetailResponse)this.rr.hvs.hvw).EmotionDetail;
    AppMethodBeat.o(108702);
    return localEmotionDetail;
  }
  
  public final GetEmotionDetailResponse ccD()
  {
    return (GetEmotionDetailResponse)this.rr.hvs.hvw;
  }
  
  public int doScene(e parame, com.tencent.mm.ak.g paramg)
  {
    AppMethodBeat.i(108700);
    ac.i("MicroMsg.emoji.NetSceneGetEmotionDetail", "ProductID:%s, Scene:%d, Version:%d", new Object[] { this.pbW, Integer.valueOf(this.mScene), Integer.valueOf(this.cR) });
    this.callback = paramg;
    paramg = (GetEmotionDetailRequest)this.rr.hvr.hvw;
  ...
  public void onGYNetEnd(int paramInt1, int paramInt2, int paramInt3, String paramString, q paramq, byte[] paramArrayOfByte)
  {
    ...
    ac.i("MicroMsg.emoji.NetSceneGetEmotionDetail", "ErrType:" + paramInt2 + "   errCode:" + paramInt3);
    ...
    if ((paramInt2 == 0) && (paramInt3 == 0)) {
      ((d)com.tencent.mm.kernel.g.ad(d.class)).getEmojiStorageMgr().GYd.a(this.pbW, ccD(), ab.iC(ai.getContext()));
    }
    this.callback.onSceneEnd(paramInt2, paramInt3, paramString, this);
    AppMethodBeat.o(108701);
  }
