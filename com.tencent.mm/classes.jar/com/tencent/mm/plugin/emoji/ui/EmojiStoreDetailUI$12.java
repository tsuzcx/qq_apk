  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    a.b("com/tencent/mm/plugin/emoji/ui/EmojiStoreDetailUI$2", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).ahq());
    ad.d("MicroMsg.emoji.EmojiStoreDetailUI", "ApplicationLanguage" + ac.fks());
    paramView = this.pKS.getString(2131758289) + ac.fks();
