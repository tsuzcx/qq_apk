  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    a.b("com/tencent/mm/plugin/emoji/ui/EmojiStoreDetailUI$2", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, ((b)localObject).ahF());
    ae.d("MicroMsg.emoji.EmojiStoreDetailUI", "ApplicationLanguage" + ad.fom());
    paramView = this.pRx.getString(2131758289) + ad.fom();
