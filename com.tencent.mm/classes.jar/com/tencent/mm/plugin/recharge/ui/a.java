...
{
  public static MallRechargeProduct eI(List<MallRechargeProduct> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        ac.d("MicroMsg.MallRechargeLogic", "find the defaultProduct");
        AppMethodBeat.o(67155);
        return localMallRechargeProduct;
      }
    }
    ac.d("MicroMsg.MallRechargeLogic", "products.get(0)");
