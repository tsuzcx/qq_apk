...
{
  public static MallRechargeProduct ff(List<MallRechargeProduct> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        ae.d("MicroMsg.MallRechargeLogic", "find the defaultProduct");
        AppMethodBeat.o(67155);
        return localMallRechargeProduct;
      }
    }
    ae.d("MicroMsg.MallRechargeLogic", "products.get(0)");
