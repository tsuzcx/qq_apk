  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bm(paramView);
    a.b("com/tencent/mm/plugin/recharge/ui/RechargeUI$7", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.axR());
    if (!Util.isNullOrNil(RechargeUI.h(this.BFe).Icf.Ico))
    {
      paramView = new Intent();
      paramView.putExtra("rawUrl", RechargeUI.h(this.BFe).Icf.Ico);
      paramView.putExtra("geta8key_username", z.aTY());
      c.b(this.BFe, "webview", "com.tencent.mm.plugin.webview.ui.tools.WebViewUI", paramView);
    }
