...
public final class MallOrderDetailObject
{
  public String dkB;
  public String peD;
  public MallTransactionObject unM;
  public b unN;
  public ArrayList<ProductSectionItem> unO;
  public List<a> unP;
  public List<HelpCenter> unQ;
  int unR;
  public String unS;
  public String unT;
  public int unU;
  ...
  static ArrayList<ProductSectionItem> az(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      if (i < paramJSONObject.length())
      {
        ...
        try
        {
          localProductSectionItem.upB = aA(localJSONObject);
          localProductSectionItem.count = localJSONObject.optInt("count");
          localProductSectionItem.upC = localJSONObject.optString("price");
          localProductSectionItem.jumpUrl = localJSONObject.optString("jump_url");
          localProductSectionItem.upD = localJSONObject.optString("pid");
