...
@Metadata(d1={""}, d2={"Lcom/tencent/mm/plugin/hld/view/GridItemDecoration;", "Landroidx/recyclerview/widget/RecyclerView$ItemDecoration;", "mHorizonSpan", "", "mVerticalSpan", "color", "mShowLastLine", "", "(IIIZ)V", "mDivider", "Landroid/graphics/drawable/Drawable;", "drawHorizontal", "", "c", "Landroid/graphics/Canvas;", "parent", "Landroidx/recyclerview/widget/RecyclerView;", "drawVertical", "getItemOffsets", "outRect", "Landroid/graphics/Rect;", "view", "Landroid/view/View;", "state", "Landroidx/recyclerview/widget/RecyclerView$State;", "getResult", "pos", "spanCount", "childCount", "getSpanCount", "isLastRaw", "onDrawOver", "Builder", "Companion", "plugin-hld_release"}, k=1, mv={1, 5, 1}, xi=48)
public final class a
  extends RecyclerView.h
{
  public static final a.b JyX;
  ...
  @Metadata(d1={""}, d2={"Lcom/tencent/mm/plugin/hld/view/GridItemDecoration$Builder;", "", "mContext", "Landroid/content/Context;", "(Landroid/content/Context;)V", "mColor", "", "mHorizonSpan", "mResources", "Landroid/content/res/Resources;", "mShowLastLine", "", "mVerticalSpan", "build", "Lcom/tencent/mm/plugin/hld/view/GridItemDecoration;", "setColor", "color", "setColorResource", "resource", "setHorizontalSpan", "horizontal", "", "setShowLastLine", "show", "setVerticalSpan", "mVertical", "vertical", "plugin-hld_release"}, k=1, mv={1, 5, 1}, xi=48)
  public static final class a
  {
    ...
    public a(Context paramContext)
    {
      ...
      this.HNU = 0;
      this.mColor = -1;
      AppMethodBeat.o(312625);
    }
    
    public final a YJ(int paramInt)
    {
      AppMethodBeat.i(312630);
      this.mColor = androidx.core.content.a.w(this.mContext, paramInt);
      AppMethodBeat.o(312630);
      return this;
    }
    ...
    public final a fPp()
    {
      ...
      a locala = new a(this.HNT, this.HNU, this.mColor, this.HNS, (byte)0);
