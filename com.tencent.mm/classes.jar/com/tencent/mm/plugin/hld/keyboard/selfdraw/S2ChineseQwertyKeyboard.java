...
@Metadata(d1={""}, d2={"Lcom/tencent/mm/plugin/hld/keyboard/selfdraw/S2ChineseQwertyKeyboard;", "Lcom/tencent/mm/plugin/hld/keyboard/selfdraw/KeyboardView;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "attrs", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "defStyleAttr", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "defStyleRes", "(Landroid/content/Context;Landroid/util/AttributeSet;II)V", "currentKeyArea", "Lcom/tencent/mm/plugin/hld/keyboard/selfdraw/KeyboardView$KeyArea;", "enterKey", "Lcom/tencent/mm/plugin/hld/keyboard/selfdraw/ImeButton;", "lastKeyOperation", "Lcom/tencent/mm/plugin/hld/keyboard/selfdraw/KeyboardView$KeyOperation;", "fetchOriginConfig", "Lcom/tencent/mm/plugin/hld/keyboard/selfdraw/bean/KeyboardData;", "getEnterKey", "getKeyboardType", "Lcom/tencent/mm/plugin/hld/keyboard/KeyboardType;", "getViewText", "", "button", "handleClickUpperKey", "", "doubleClick", "", "handleNormalTouch", "event", "Landroid/view/MotionEvent;", "initButtonDrawer", "Lcom/tencent/mm/plugin/hld/keyboard/selfdraw/ButtonDrawer;", "isEnterKey", "isOnlySupportClickFloatViewKey", "btn", "onButtonClick", "onButtonLongClick", "onButtonUp", "onClickForSupportDoubleClick", "onDoubleClick", "onTextKeyClick", "onTouch", "onUpperSlide", "supportDoubleClick", "transparentBg", "transparent", "updateUpperKeyImp", "Companion", "plugin-hld_release"}, k=1, mv={1, 5, 1}, xi=48)
public final class S2ChineseQwertyKeyboard
  extends KeyboardView
{
  public static final S2ChineseQwertyKeyboard.a JtD;
  ...
  static
  {
    ...
    JtD = new S2ChineseQwertyKeyboard.a((byte)0);
  ...
  public final boolean Z(MotionEvent paramMotionEvent)
  {
    ...
    if (localObject2 != null)
    {
      ...
      l.jC("WxIme.S2ChineseQwertyKeyboard", "onTouch action " + k + ' ' + i + ' ' + j + ' ' + l + ' ' + (String)localObject1);
      if (this.JtB != null)
      {
        ...
        if ((!Util.isEqual((String)localObject3, str)) && (k != 5) && (k != 0))
        {
          ...
          l.jC("WxIme.S2ChineseQwertyKeyboard", ((KeyboardView.c)localObject2).Jrk + " currentKey:" + (String)localObject1 + " action:" + k);
        }
      }
      label564:
      label822:
        ...
        do
        {
          for (;;)
          {
            ...
            case 5: 
              ...
              {
                localObject3 = l.JyV;
                l.jC("WxIme.S2ChineseQwertyKeyboard", s.X("process no ACTION_UP input:", paramMotionEvent.Jrk));
              ...
              for (;;)
              {
                ...
                paramMotionEvent = l.JyV;
                l.jC("WxIme.S2ChineseQwertyKeyboard", "onTextKeyClick:" + ((b)localObject2).type + ' ' + ((b)localObject2).mainText + ' ' + ((b)localObject2).floatText + ' ' + ((b)localObject2).JsU);
            ...
            case 2: 
              ...
              if (paramMotionEvent != null)
              {
                ...
                {
                  l.jC("WxIme.S2ChineseQwertyKeyboard", bool + " diff:" + (l - paramMotionEvent.time) + " yOffset:" + (paramMotionEvent.y - j) + " minHeight:" + com.tencent.mm.cd.a.bs(getContext(), a.d.ime_upper_slide_min_height));
                ...
                {
                  paramMotionEvent = l.JyV;
                  l.jC("WxIme.S2ChineseQwertyKeyboard", "onUpperSlide:" + ((b)localObject2).type + ' ' + ((b)localObject2).mainText + ' ' + ((b)localObject2).floatText + ' ' + ((b)localObject2).JsU);
                  paramMotionEvent = new ArrayList();
                  paramMotionEvent.add(k((b)localObject2));
                  localObject1 = ((b)localObject2).floatText;
                  if (localObject1 == null)
                  {
                    paramMotionEvent = new NullPointerException("null cannot be cast to non-null type kotlin.CharSequence");
                    AppMethodBeat.o(313217);
                    throw paramMotionEvent;
                  }
                  paramMotionEvent.add(n.bq((CharSequence)localObject1).toString());
                  localObject1 = f.JuH;
  ...
  {
    AppMethodBeat.i(313232);
    s.u(paramb, "button");
    boolean bool = s.p(paramb.id, "enter");
    AppMethodBeat.o(313232);
    return bool;
  }
  ...
  public final a fLR()
  {
    ...
    locala.a((com.tencent.mm.plugin.hld.keyboard.selfdraw.a.b)new com.tencent.mm.plugin.hld.keyboard.selfdraw.a.a(locala.JsC));
  ...
  {
    return com.tencent.mm.plugin.hld.keyboard.c.Jrq;
  }
  ...
  public final void h(b paramb)
  {
    ...
    l.jC("WxIme.S2ChineseQwertyKeyboard", "onClick:" + paramb.id + ' ' + paramb.mainText + ' ' + paramb.floatText + ' ' + paramb.JsQ);
    if (e(paramb))
    {
  ...
  public final boolean i(b paramb)
  {
    ...
    s.u(paramb, "button");
    Object localObject1 = l.JyV;
    l.jC("WxIme.S2ChineseQwertyKeyboard", "onLongClick:" + paramb.type + ' ' + paramb.mainText + ' ' + paramb.floatText + ' ' + paramb.JsU);
    if (d(paramb))
    {
    ...
    ((ArrayList)localObject1).add(n.bq((CharSequence)localObject2).toString());
    localObject2 = f.JuH;
    f.a(3, (ArrayList)localObject1, (KeyboardView)this, paramb, this.JtB);
    AppMethodBeat.o(313225);
    return true;
  }
