  ...
  extends MAutoStorage<MultiTaskInfo>
{
  ...
  public final boolean a(MultiTaskInfo paramMultiTaskInfo, String... paramVarArgs)
  {
    ...
    if (paramMultiTaskInfo != null)
    {
      ...
      if (paramMultiTaskInfo != null)
      {
        dar localdar = paramMultiTaskInfo.fbc();
        paramVarArgs = localObject;
        if (localdar != null) {
          paramVarArgs = localdar.title;
        }
      }
  ...
  public final MultiTaskInfo aRb(String paramString)
  {
  ...
  public final boolean m(MultiTaskInfo paramMultiTaskInfo)
  {
    ...
    p.k(paramMultiTaskInfo, "item");
    Log.i("MicroMsg.TaskBarStorage", "insert:" + paramMultiTaskInfo.field_type + ' ' + paramMultiTaskInfo.field_id + ' ' + paramMultiTaskInfo.fbc().title);
