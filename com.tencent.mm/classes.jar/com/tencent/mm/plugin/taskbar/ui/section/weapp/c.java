  ...
  extends w
{
          ...
          public final void run()
          {
            ...
            if (localIterator.hasNext())
            {
              ...
              for (Object localObject2 = ((RecyclerView.v)localObject2).caK;; localObject2 = null)
              {
                if (localObject1 != null)
                {
                  ViewPropertyAnimator localViewPropertyAnimator = ((View)localObject1).animate().setDuration(localc.bZL);
                  localc.bUP.add(locala.bVc);
                ...
                localc.bUP.add(locala.bVd);
                ((ViewPropertyAnimator)localObject1).translationX(0.0F).translationY(0.0F).setDuration(localc.bZL).alpha(1.0F).setListener(new c.8(localc, locala, (ViewPropertyAnimator)localObject1, (View)localObject2)).start();
                break;
      ...
      localObject2 = new Runnable()
      {
        public final void run()
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            localView.setAlpha(1.0F);
            localViewPropertyAnimator.scaleX(1.0F).scaleY(1.0F).setDuration(localc.Kt()).setListener(new c.5(localc, localv, localView, localViewPropertyAnimator)).start();
          }
          this.bUT.clear();
  ...
  public final boolean a(RecyclerView.v paramv)
  {
    ...
    Log.i("MicroMsg.AppBrandDesktopSectionWeAppItemAnimator", "alvinluo animateRemove %d", new Object[] { Integer.valueOf(paramv.KJ()) });
    d(paramv);
  ...
  public final boolean a(RecyclerView.v paramv1, RecyclerView.v paramv2, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    Log.i("MicroMsg.AppBrandDesktopSectionWeAppItemAnimator", "alvinluo animateChange lastPos: %d", new Object[] { Integer.valueOf(paramv1.KJ()) });
    if (paramv1 == paramv2)
    {
  ...
  public final boolean b(RecyclerView.v paramv)
  {
    ...
    d(paramv);
    paramv.caK.setAlpha(0.0F);
    paramv.caK.setScaleX(0.75F);
    paramv.caK.setScaleY(0.75F);
    this.bUG.add(paramv);
