  ...
  extends com.tencent.mm.kernel.b.a
{
  ...
  public abstract void registerMultiTaskUIC(int paramInt, Class<? extends MultiTaskUIComponent> paramClass);
  
  public abstract void removeTaskInfoAndCoverImg(String paramString);
  
  public abstract void reportMultiTaskInfo(int paramInt, crt paramcrt);
  
  public abstract void sendMultiTaskEvent(int paramInt1, String paramString, int paramInt2);
  
  public abstract void updateTaskInfoByBitmap(String paramString, int paramInt, cru paramcru, Bitmap paramBitmap, byte[] paramArrayOfByte);
  
  public abstract void updateTaskInfoByTitle(String paramString, int paramInt, cru paramcru, byte[] paramArrayOfByte);
