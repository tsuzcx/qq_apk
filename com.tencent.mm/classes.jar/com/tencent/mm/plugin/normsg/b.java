  ...
  implements com.tencent.mm.plugin.normsg.a.a
{
  ...
  private static String cWN()
  {
    ...
    for (;;)
    {
      ...
      {
        Object localObject;
        ad.e("MicroMsg.NormsgSourceImpl", "getNetTypeStr: %s", new Object[] { bt.m(localException) });
        String str = "";
        continue;
      }
  ...
  private static String gp(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        {
          com.tencent.mm.plugin.report.e.vIY.idkeyStat(322L, 13L, 1L, true);
          com.tencent.mm.plugin.report.e.vIY.f(11098, new Object[] { Integer.valueOf(4013), String.format("%s|%s", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }) });
          localObject1 = localObject2;
        }
      }
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          localObject1 = "0";
          com.tencent.mm.plugin.report.e.vIY.idkeyStat(322L, 12L, 1L, true);
          com.tencent.mm.plugin.report.e.vIY.f(11098, new Object[] { Integer.valueOf(4012), String.format("%s|%s|%s", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), localException.getMessage() }) });
        }
      }
  ...
  public final String Ix(int paramInt)
  {
    ...
    if (com.tencent.mm.kernel.g.afw()) {
      localObject2 = (String)com.tencent.mm.kernel.g.afB().afk().get(79, "");
    }
        ...
        try
        {
          ...
          for (localObject = str + String.format("<k28>%s</k28><k29>%s</k29>", new Object[] { com.tencent.mm.plugin.normsg.c.d.A(arrayOfByte, 0, 4), com.tencent.mm.plugin.normsg.c.d.A(arrayOfByte, 4, 8) });; localObject = str + String.format("<k27>%s</k27>", new Object[] { com.tencent.mm.plugin.normsg.c.d.A(arrayOfByte, 0, arrayOfByte.length) }))
          {
            ...
            catch (Exception localException2)
            {
              ...
              {
                label336:
                ad.e("MicroMsg.NormsgSourceImpl", "exception:%s", new Object[] { bt.m(localException2) });
              }
            }
            ad.i("MicroMsg.NormsgSourceImpl", "checkSoftType2 [time: " + (l2 - l1) + ", value: " + (String)localObject + "]");
            com.tencent.mm.kernel.g.afB().afk().set(79, localObject);
            AppMethodBeat.o(148938);
            return;
          }
          return;
    ...
    if (com.tencent.mm.kernel.g.afw())
    {
      if (com.tencent.mm.kernel.g.afB().gda.FCI.FCd) {
        str1 = "1";
      }
    }
    else
    {
      ...
      String str3 = ay.iA(localContext);
      String str4 = ay.iB(localContext);
      ...
      k = 1;
      if ((!com.tencent.mm.plugin.normsg.c.f.ugK) && (!com.tencent.mm.plugin.normsg.c.f.ugL) && (!com.tencent.mm.plugin.normsg.c.f.ugM)) {
        break label1286;
      }
      m = 1;
      if (!com.tencent.mm.plugin.normsg.c.e.ugG) {
        break label1292;
      }
      n = 1;
      if (!com.tencent.mm.plugin.normsg.c.g.ugN) {
        break label1298;
      }
      i1 = 1;
      localObject1 = c.p.ad();
      ...
      localStringBuilder2 = localStringBuilder2.append(ajq((String)localObject2)).append("</k1><k2>").append(ajq(q.Xf())).append("</k2><k3>").append(ajq(Build.VERSION.RELEASE)).append("</k3><k4>").append(ajq(q.cG(true))).append("</k4><k5>").append(ajq(q.WU())).append("</k5><k6>").append(ajq(q.WW())).append("</k6><k7>").append(ajq(q.getAndroidId())).append("</k7><k8>").append(ajq(q.WV())).append("</k8><k9>").append(ajq(Build.MODEL)).append("</k9><k10>").append(q.Xi()).append("</k10><k11>").append(bt.nullAsNil(ajq((String)localMap.get("hardware")))).append("</k11><k12>").append(bt.nullAsNil(ajq((String)localMap.get("revision")))).append("</k12><k13>").append(bt.nullAsNil(ajq((String)localMap.get("serial")))).append("</k13><k14>").append(ajq(q.WX())).append("</k14><k15>").append(ajq(q.WY())).append("</k15><k16>");
      localObject3 = (String)localMap.get("features");
      localObject2 = localObject3;
      if (localObject3 == null) {
        localObject2 = (String)localMap.get("flags");
      }
      localObject2 = localStringBuilder2.append(bt.nullAsNil(ajq((String)localObject2))).append("</k16><k18>").append((String)localObject1).append("</k18><k21>").append(bt.nullAsNil(ajq(str3))).append("</k21><k22>").append(bt.nullAsNil(ajq(q.bV(localContext)))).append("</k22><k24>").append(bt.nullAsNil(ajq(str4))).append("</k24><k26>").append(k).append("</k26><k30>");
    ...
    {
      localObject3 = ((StringBuilder)localObject2).append(bt.nullAsNil(ajq((String)localObject1))).append("</k30><k33>").append(ajq(aj.getPackageName())).append("</k33><k34>").append(bt.nullAsNil(ajq(af.get("ro.build.fingerprint")))).append("</k34><k35>").append(bt.nullAsNil(ajq(Build.BOARD))).append("</k35><k36>").append(bt.nullAsNil(ajq(Build.BOOTLOADER))).append("</k36><k37>").append(bt.nullAsNil(ajq(Build.BRAND))).append("</k37><k38>").append(bt.nullAsNil(ajq(Build.DEVICE))).append("</k38><k39>").append(bt.nullAsNil(ajq(Build.HARDWARE))).append("</k39><k40>").append(bt.nullAsNil(ajq(Build.PRODUCT))).append("</k40><k41>").append(m).append("</k41><k42>").append(bt.nullAsNil(ajq(af.get("ro.product.manufacturer")))).append("</k42><k43>").append(Settings.System.getString(aj.getContext().getContentResolver(), "89884a87498ef44f")).append("</k43><k44>0</k44><k45>");
      ad.d("MicroMsg.NormsgSourceImpl", "READ_PHONE_STATE.getLine1Number %s", new Object[] { bt.eGN() });
      localObject2 = bt.nullAsNil(bt.iK(aj.getContext()));
      localObject1 = localObject2;
      if (((String)localObject2).length() > 0) {
        localObject1 = com.tencent.mm.b.g.getMessageDigest(((String)localObject2).getBytes());
      }
      localObject1 = ((StringBuilder)localObject3).append((String)localObject1).append("</k45><k46>").append(str1).append("</k46><k47>").append(ajq(cWN())).append("</k47><k48>").append(q.cG(true)).append("</k48><k49>").append(com.tencent.mm.loader.j.b.ahY()).append("</k49><k52>").append(n).append("</k52><k53>").append(i1).append("</k53><k57>").append(i2).append("</k57><k58>").append(bt.nullAsNil(ajq(str2))).append("</k58><k59>").append(paramInt).append("</k59><k60>").append(ajq(com.tencent.mm.sdk.platformtools.h.ETs.getString("FEATURE_ID"))).append("</k60><k61>").append(q.Xc()).append("</k61><k62>");
      str1 = com.tencent.mm.plugin.soter.d.d.dEQ().yaF;
      if (str1 != null) {}
      for (;;)
      {
        ((StringBuilder)localObject1).append(str1).append("</k62><k63>").append(q.Xa()).append("</k63><k64>").append(q.Xd()).append("</k64><k65>").append(q.getOAID()).append("</k65></softtype>");
  ...
  public final void Iy(int paramInt)
  {
    ...
    com.tencent.mm.plugin.normsg.c.a.cWZ().Iy(paramInt);
  ...
  public final boolean a(int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, PByteArray paramPByteArray)
  {
    ...
    if (bool)
    {
      paramArrayOfByte = new coo();
      paramArrayOfByte.Eiw = ((Integer)localPValue1.getValue(Integer.valueOf(0))).intValue();
      paramArrayOfByte.Eix = ((Integer)localPValue2.getValue(Integer.valueOf(0))).intValue();
      paramArrayOfByte.Eiy = com.tencent.mm.bx.b.cd((byte[])localPValue3.value);
    }
    try
    {
  ...
  public final void am(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (l < com.tencent.d.e.a.a.f.IrV) {
      ((d.a)localObject).IrA = com.tencent.d.e.a.a.f.IrV;
    }
    for (;;)
    {
      ((d.a)localObject).IrA = l;
      localObject = new com.tencent.d.e.a.d((d.a)localObject, (byte)0);
      com.tencent.d.e.a.e.fmk().a((com.tencent.d.e.a.d)localObject);
      AppMethodBeat.o(148944);
      return;
      if (l > com.tencent.d.e.a.a.f.IrS * 12L) {
        ((d.a)localObject).IrA = (com.tencent.d.e.a.a.f.IrS * 12L);
      }
    }
  }
  ...
  public final byte[] cWV()
  {
    ...
    com.tencent.d.e.a.e.fmk().Ft();
    Context localContext = aj.getContext();
    String str = q.cG(true);
      ...
      public final boolean p(int paramAnonymousInt, byte[] paramAnonymousArrayOfByte)
      {
        ...
        if (paramAnonymousInt == 0)
        {
          if ((paramAnonymousArrayOfByte != null) && (paramAnonymousArrayOfByte.length > 0)) {
            this.ufl.write(paramAnonymousArrayOfByte, 0, paramAnonymousArrayOfByte.length);
          }
          bool = true;
        }
    ...
    com.tencent.d.e.a.e.fmk().a(localContext, str, new d.1(local2, localc));
    try
    {
  ...
  public final String getOAID()
  {
    ...
    try
    {
      Object localObject = com.tencent.d.e.b.a.a.b.ku(aj.getContext());
      if (((com.tencent.d.e.b.a.a.c)localObject).errorCode == 0)
      {
        localObject = bt.nullAsNil(((com.tencent.d.e.b.a.a.c)localObject).Cwn);
