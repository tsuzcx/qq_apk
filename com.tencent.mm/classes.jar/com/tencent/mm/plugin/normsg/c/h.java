...
{
  private static final LruCache<String, LruCache<String, Field>> ugO;
  private static final LruCache<String, LruCache<String, Method>> ugP;
  private static final LruCache<String, LruCache<String, Constructor<?>>> ugQ;
  ...
  private static Method b(Class<?> paramClass, String paramString, Class<?>... paramVarArgs)
  {
    ...
    LruCache localLruCache = (LruCache)ugP.get(paramClass.getName());
    if (localLruCache == null)
    {
      localLruCache = new LruCache(30);
      ugP.put(paramClass.getName(), localLruCache);
    }
    for (;;)
    {
  ...
  private static Field d(Class<?> paramClass, String paramString)
  {
    ...
    LruCache localLruCache = (LruCache)ugO.get(paramClass.getName());
    if (localLruCache == null)
    {
      localLruCache = new LruCache(30);
      ugO.put(paramClass.getName(), localLruCache);
    }
    for (;;)
    {
  ...
  public static <T> T hM(String paramString1, String paramString2)
  {
