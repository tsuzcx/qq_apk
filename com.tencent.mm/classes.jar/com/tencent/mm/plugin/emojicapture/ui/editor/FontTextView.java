...
@l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/plugin/emojicapture/ui/editor/FontTextView;", "Landroid/view/View;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "(Landroid/content/Context;)V", "defStyleAttr", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "alignment", "Landroid/text/Layout$Alignment;", "contentLeft", "", "contentPadding", "defaultText", "", "drawStroke", "", "getDrawStroke", "()Z", "setDrawStroke", "(Z)V", "includePadding", "layout", "Landroid/text/StaticLayout;", "lineHeight", "lineSpacing", "maxWidth", "newLayout", "spacingAddition", "spacingMultiplier", "strokePaint", "Landroid/text/TextPaint;", "text", "", "textDrawer", "Lcom/tencent/mm/plugin/emojicapture/ui/editor/text/TextDrawer;", "getTextDrawer", "()Lcom/tencent/mm/plugin/emojicapture/ui/editor/text/TextDrawer;", "setTextDrawer", "(Lcom/tencent/mm/plugin/emojicapture/ui/editor/text/TextDrawer;)V", "textPaint", "drawLine", "", "canvas", "Landroid/graphics/Canvas;", "line", "lineSpace", "makeNewLayout", "width", "onDraw", "onMeasure", "widthMeasureSpec", "heightMeasureSpec", "setMaxWidth", "setTypeface", "typeface", "Landroid/graphics/Typeface;", "updateText", "color", "strokeColor", "change", "plugin-emojicapture_release"})
public final class FontTextView
  extends View
{
  private final Layout.Alignment gFb;
  private final int gnP;
  private TextPaint iU;
  private StaticLayout layout;
  private float maxWidth;
  private String pXA;
  private final float pXB;
  private final float pXC;
  private final boolean pXD;
  private TextPaint pXE;
  private float pXF;
  private float pXG;
  private float pXH;
  private boolean pXI;
  ...
  public FontTextView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.pXE = new TextPaint();
    this.text = ((CharSequence)"");
    if (paramContext == null) {
      p.gfZ();
    }
    float f = paramContext.getResources().getDimension(2131166194);
    this.pXG = paramContext.getResources().getDimension(2131166196);
    this.pXH = paramContext.getResources().getDimension(2131166197);
    ...
    this.pXA = paramAttributeSet;
    this.gnP = com.tencent.mm.cc.a.fromDPToPix(paramContext, 2);
    ...
    this.pXE.setStrokeWidth(paramContext.getResources().getDimension(2131166198));
    this.pXE.setAntiAlias(true);
    this.pXE.setTextSize(this.iU.getTextSize());
    this.pXE.setStyle(Paint.Style.STROKE);
    this.layout = new StaticLayout(this.text, this.iU, getWidth(), this.gFb, this.pXB, this.pXC, this.pXD);
    this.pXJ = ((c)new com.tencent.mm.plugin.emojicapture.ui.editor.text.a());
    this.text = ((CharSequence)this.pXA);
    paramContext = this.pXJ;
    if (paramContext != null)
    {
  ...
  private final void a(Canvas paramCanvas, int paramInt, float paramFloat)
  {
    ...
    for (int i = this.layout.getLineStart(paramInt) + this.layout.getEllipsisStart(paramInt);; i = this.layout.getLineEnd(paramInt))
    {
      if (this.pXK)
      {
        localc = this.pXJ;
        if (localc != null) {
          localc.a(paramCanvas, this.layout.getLineStart(paramInt), i, f, paramFloat, (Paint)this.pXE, bool);
        }
      }
      c localc = this.pXJ;
      if (localc == null) {
  ...
  public final void d(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      this.pXE.setColor(paramInt2);
      paramCharSequence = this.pXJ;
  ...
  protected final void onDraw(Canvas paramCanvas)
  {
    ...
    paramCanvas.save();
    paramCanvas.translate(-this.pXF, 0.0F);
    a(paramCanvas, 0, 0.0F);
    a(paramCanvas, 1, this.pXH);
    paramCanvas.restore();
    AppMethodBeat.o(780);
  }
  ...
  protected final void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    label425:
    for (paramInt1 = (int)this.pXG;; paramInt1 = (int)(2.0F * this.pXG + this.pXH))
    {
      ...
      this.pXF = (f3 - this.gnP);
      setMeasuredDimension((int)(f4 - f3 + this.gnP * 2), paramInt1 + (paramInt2 + i));
      AppMethodBeat.o(782);
      return;
      localObject = this.pXJ;
      if (localObject != null) {
        ((c)localObject).refresh();
      }
      if (Build.VERSION.SDK_INT >= 23)
      {
        localObject = StaticLayout.Builder.obtain(this.text, 0, this.text.length(), this.iU, paramInt1).setAlignment(this.gFb).setIncludePad(this.pXD).setMaxLines(2).setLineSpacing(this.pXC, this.pXB).setEllipsize(TextUtils.TruncateAt.END).build();
      ...
      for (;;)
      {
        this.pXI = false;
        break;
        localObject = new StaticLayout(this.text, this.iU, paramInt1, this.gFb, this.pXB, this.pXC, this.pXD);
      }
    }
  }
  ...
  public final void setTypeface(Typeface paramTypeface)
  {
    ...
    this.pXE.setTypeface(paramTypeface);
    AppMethodBeat.o(779);
  }
}
