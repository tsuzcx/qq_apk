  ...
  extends RelativeLayout
{
  ...
  public EditorItemContainer(final Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.vau = true;
    this.vav = new RectF();
    this.vax = ((Runnable)new d(this));
    this.vaz = new LinkedList();
    View.inflate(paramContext, a.g.uRK, (ViewGroup)this);
    paramAttributeSet = findViewById(a.f.uRI);
    p.j(paramAttributeSet, "findViewById(R.id.editor_valid_area)");
    this.uYR = paramAttributeSet;
    paramAttributeSet = findViewById(a.f.editor_delete_view);
    p.j(paramAttributeSet, "findViewById(R.id.editor_delete_view)");
    this.vaq = ((TextView)paramAttributeSet);
    this.vaq.setTextColor(getResources().getColor(a.c.uRc));
    paramAttributeSet = findViewById(a.f.uRL);
    p.j(paramAttributeSet, "findViewById(R.id.emoji_capture_editor_layout)");
    this.var = ((ViewGroup)paramAttributeSet);
    paramAttributeSet = findViewById(a.f.uRM);
    p.j(paramAttributeSet, "findViewById(R.id.emoji_capture_editor_mask)");
    this.vas = ((EditorOutsideView)paramAttributeSet);
    aq((Runnable)new Runnable()
    {
      public final void run()
      {
        AppMethodBeat.i(736);
        EditorItemContainer.h(this.vaB).a(this.vaB.getValidRect(), paramContext.getResources().getDimension(a.d.uRm));
        AppMethodBeat.o(736);
      }
    });
    AppMethodBeat.o(760);
  ...
  private final void mX(boolean paramBoolean)
  {
    ...
    for (int i = 0;; i = 8)
    {
      ...
      if (this.vat != null)
      {
        localObject = this.vat;
        if (localObject == null) {
          p.iCn();
        }
        ((b)localObject).mW(paramBoolean);
      }
      AppMethodBeat.o(757);
      return;
    }
  ...
  {
    AppMethodBeat.i(758);
    this.vaq.setActivated(paramBoolean);
    if (paramBoolean)
    {
      this.vaq.setText(a.i.editor_item_release_to_delete);
      AppMethodBeat.o(758);
      return;
    }
    this.vaq.setText(a.i.editor_item_drag_to_delete);
    AppMethodBeat.o(758);
  }
  ...
  public final void a(final a parama, final Matrix paramMatrix)
  {
    AppMethodBeat.i(741);
    p.k(parama, "itemView");
    aq((Runnable)new c(this, parama, paramMatrix));
    AppMethodBeat.o(741);
  }
  ...
  public final void a(a parama, MotionEvent paramMotionEvent)
  {
    ...
    this.var.bringChildToFront((View)getTextItem());
    if (this.vay != null) {
  ...
  public final ArrayList<String> getAllEmojiMd5()
  {
    ...
    while (i < j)
    {
      Object localObject = this.var.getChildAt(i);
  ...
  {
    AppMethodBeat.i(753);
    this.vav.set(this.uYR.getLeft(), this.uYR.getTop(), this.uYR.getRight(), this.uYR.getBottom());
    RectF localRectF = this.vav;
    AppMethodBeat.o(753);
    return localRectF;
  }
  ...
  public final WindowInsets onApplyWindowInsets(WindowInsets paramWindowInsets)
  {
    ...
    Object localObject2 = this.uYR.getLayoutParams();
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (localObject1 != null)
      {
        ((ViewGroup.MarginLayoutParams)localObject1).topMargin = (getResources().getDimensionPixelSize(a.d.uRq) + paramWindowInsets.getSystemWindowInsetTop());
        this.uYR.setLayoutParams((ViewGroup.LayoutParams)localObject1);
      }
      paramWindowInsets = super.onApplyWindowInsets(paramWindowInsets);
      p.j(paramWindowInsets, "super.onApplyWindowInsets(insets)");
      AppMethodBeat.o(201222);
  ...
  public final boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if ((paramMotionEvent.getActionMasked() == 0) && (!this.vav.contains(paramMotionEvent.getX(), paramMotionEvent.getY())))
    {
      AppMethodBeat.o(744);
      return true;
    }
  ...
  public final boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    {
      if (!this.vav.contains(paramMotionEvent.getX(), paramMotionEvent.getY()))
      {
        AppMethodBeat.o(745);
        return false;
      }
  ...
  @l(iBK={1, 1, 16}, iBL={""}, iBM={"Lcom/tencent/mm/plugin/emojicapture/ui/editor/EditorItemContainer$Companion;", "", "()V", "ClearActiveDelay", "", "plugin-emojicapture_release"})
  public static final class a {}
  
  @l(iBK={1, 1, 16}, iBL={""}, iBM={"Lcom/tencent/mm/plugin/emojicapture/ui/editor/EditorItemContainer$OnStateChangeListener;", "", "onStateChange", "", "showDelete", "", "plugin-emojicapture_release"})
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      Object localObject2 = EditorItemContainer.a(this.vaB);
      ...
      localObject1 = parama;
      localObject2 = this.vaB.getValidRect();
      localObject3 = this.vaB.getContext();
      p.j(localObject3, "context");
      ((a)localObject1).a((RectF)localObject2, ((Context)localObject3).getResources().getDimension(a.d.uRm));
      this.vaB.setEditing(parama);
      EditorItemContainer.a(this.vaB).bringChildToFront((View)this.vaB.getTextItem());
      if ((paramMatrix != null) && ((parama instanceof EmojiEditorItemView)))
      {
        localObject1 = (EmojiEditorItemView)parama;
        localObject2 = paramMatrix;
        p.k(localObject2, "m");
        ((EmojiEditorItemView)localObject1).vaG.getTouchTracker().aHZ.set((Matrix)localObject2);
      }
      AppMethodBeat.o(737);
    }
  }
    ...
    implements Runnable
  {
    ...
    {
      AppMethodBeat.i(738);
      if (EditorItemContainer.d(this.vaB) != null)
      {
        EditorItemContainer localEditorItemContainer = this.vaB;
        a locala = EditorItemContainer.d(this.vaB);
        if (locala == null) {
          p.iCn();
        }
    ...
    implements Runnable
  {
    ...
    {
      AppMethodBeat.i(739);
      if (EditorItemContainer.b(this.vaB) != null)
      {
        Object localObject = EditorItemContainer.b(this.vaB);
        if (localObject == null) {
          p.iCn();
        }
        if (!((a)localObject).cYz())
        {
          localObject = EditorItemContainer.a(this.vaB);
          a locala = EditorItemContainer.b(this.vaB);
          if (locala == null)
          {
      ...
      EditorItemContainer.c(this.vaB);
      EditorItemContainer.e(this.vaB);
      AppMethodBeat.o(739);
    }
  }
    ...
    implements Runnable
  {
    ...
    {
      AppMethodBeat.i(740);
      this.vaB.getValidRect();
      if (!EditorItemContainer.f(this.vaB).isEmpty())
      {
        Iterator localIterator = ((Iterable)EditorItemContainer.g(this.vaB)).iterator();
