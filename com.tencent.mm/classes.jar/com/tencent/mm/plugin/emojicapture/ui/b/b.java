...
@l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lcom/tencent/mm/plugin/emojicapture/ui/gl/EmojiCaptureGLUtil;", "", "()V", "Companion", "plugin-emojicapture_release"})
public final class b
{
  public static final float[] gWC;
  public static final float[] gWD;
  public static final float[] gWE;
  public static final a puK;
  ...
  public static final class a
  {
    private static int V(String paramString, int paramInt)
    {
      ...
      if (arrayOfInt[0] == 0)
      {
        ac.e("MicroMsg.EmojiCaptureGLUtil", "loadShader error, infoLog: %s", new Object[] { GLES20.glGetShaderInfoLog(paramInt) });
        AppMethodBeat.o(831);
        return 0;
      }
      AppMethodBeat.o(831);
    ...
    public static int ax(String paramString1, String paramString2)
    {
      ...
      if (i == 0)
      {
        ac.e("MicroMsg.EmojiCaptureGLUtil", "load vertex shader failed");
        AppMethodBeat.o(832);
        return 0;
      }
      ...
      if (j == 0)
      {
        ac.e("MicroMsg.EmojiCaptureGLUtil", "load fragment shader failed");
        AppMethodBeat.o(832);
        return 0;
      }
      ...
      if (arrayOfInt[0] <= 0)
      {
        ac.e("MicroMsg.EmojiCaptureGLUtil", "link program failed");
        AppMethodBeat.o(832);
        return 0;
      }
    ...
    public static int cfY()
    {
      ...
      if (arrayOfInt[0] == 0)
      {
        ac.e("MicroMsg.EmojiCaptureGLUtil", "gen frame buffer error");
        AppMethodBeat.o(833);
        return 0;
      }
      int i = arrayOfInt[0];
