...
public final class a$a
{
  ...
  public final boolean equals(Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof a))
      {
        ...
        if ((this.gKf != paramObject.gKf) || (this.hrS != paramObject.hrS) || (this.pXb != paramObject.pXb) || (this.pXc != paramObject.pXc) || (this.pXd != paramObject.pXd)) {}
      }
    }
    else {
      return true;
  ...
  {
    AppMethodBeat.i(129);
    String str = "CameraPreviewConfig(resolution=" + this.gKf + ", useCpuCrop=" + this.hrS + ", previewSize=" + this.pXb + ", stickerSampleSize=" + this.pXc + ", useCameraApi2=" + this.pXd + ")";
    AppMethodBeat.o(129);
    return str;
  }
}
