...
{
  SparseArray<Long> rhe;
  private g rhf;
  
  public a()
  {
    AppMethodBeat.i(24761);
    this.rhe = new SparseArray();
    this.rhf = new g();
  ...
  public final void a(String paramString, g.b paramb, int paramInt, Intent paramIntent)
  {
    ...
    g localg = this.rhf;
    j.cwb().cvK().post(new g.1(localg, paramString, paramIntent, paramb, paramInt));
  ...
  public final void a(String paramString1, String paramString2, Intent paramIntent)
  {
    ...
    g localg = this.rhf;
    j.cwb().cvK().post(new g.2(localg, paramString2, paramString1, paramIntent));
  ...
  public final void cvH()
  {
    ...
    label146:
    com.tencent.mm.plugin.freewifi.g.c localc = j.cvY().aaI(str2);
    String str1;
    label165:
    boolean bool;
    if (localc == null)
    {
      ...
      if ((str3.equalsIgnoreCase(localc.field_mac)) && (localc.field_expiredTime - bt.aGK() >= 0L)) {
        break label564;
      }
    ...
    for (;;)
    {
      ...
      if (bool)
      {
        ...
        if (System.currentTimeMillis() - i.a.cvp().aa("LOCAL_CONFIG_LAST_APCHECK_SAVE_DELAY_CRD_TIMEMILLIS") <= i.a.cvp().getInt("LOCAL_CONFIG_APCHECK_DELAY_CRD_EXPIRED_DAYS", 7) * 24 * 60 * 60 * 1000) {
          break label559;
        }
      }
      label559:
      ...
      {
        i = j;
        if (i.a.cvp().getInt("LOCAL_CONFIG_FEATURES_DEFINE_ONCE_BAR_APPEARED", 0) == 1) {
          i = j | 0x2;
        }
        j = i;
        if (i.a.cvp().getInt("LOCAL_CONFIG_FEATURES_DEFINE_ONCE_USE_WECHAT_FREEWIFI", 0) == 1) {
          j = i | 0x4;
        }
        i = j;
        if (i.a.cvp().getInt("LOCAL_CONFIG_FEATURES_DEFINE_ONCE_RECV_FREEWIFI_SYSMSG", 0) == 1) {
          i = j | 0x8;
        }
        ad.i("MicroMsg.FreeWifi.FreeWifiAuthManager", "features : ".concat(String.valueOf(i)));
        new b(str3, str2, k, i).c(new com.tencent.mm.al.g()
        {
          public final void onSceneEnd(int paramAnonymousInt1, int paramAnonymousInt2, String paramAnonymousString, n paramAnonymousn)
          {
            AppMethodBeat.i(24760);
            paramAnonymousString = ((b)paramAnonymousn).mac;
            if (m.dq(paramAnonymousString))
            {
            ...
            {
              a.this.rhe.put(paramAnonymousString.hashCode(), Long.valueOf(bt.eGO()));
              AppMethodBeat.o(24760);
              return;
            }
            a.this.rhe.remove(paramAnonymousString.hashCode());
            AppMethodBeat.o(24760);
          }
        });
        AppMethodBeat.o(24764);
        ...
        break label165;
        label469:
        if (this.rhe.indexOfKey(str3.hashCode()) >= 0)
        {
          long l = ((Long)this.rhe.get(str3.hashCode())).longValue();
          ad.i("MicroMsg.FreeWifi.FreeWifiAuthManager", "has checked this mac, now time - last check time = %d", new Object[] { Long.valueOf(bt.eGO() - l) });
          if (bt.eGO() - l <= 43200000L) {
            break label564;
          }
          bool = true;
          break label250;
