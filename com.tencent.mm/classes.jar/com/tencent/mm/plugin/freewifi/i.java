...
public final class i
{
  ...
  public final long aa(String paramString)
  {
    ...
    //   10: aload_1
    //   11: invokestatic 43	com/tencent/mm/plugin/freewifi/m:dq	(Ljava/lang/String;)Z
    //   14: ifeq +13 -> 27
    //   17: sipush 24678
    ...
    //   26: lreturn
    //   27: aload_0
    //   28: getfield 27	com/tencent/mm/plugin/freewifi/i:rfw	Lcom/tencent/mm/plugin/freewifi/g/b;
    //   31: aload_1
    //   32: invokevirtual 49	com/tencent/mm/plugin/freewifi/g/b:aaG	(Ljava/lang/String;)Ljava/lang/String;
    //   35: astore_1
    //   36: aload_1
    //   37: invokestatic 43	com/tencent/mm/plugin/freewifi/m:dq	(Ljava/lang/String;)Z
    //   40: istore 6
    //   42: iload 6
    //   44: ifeq +17 -> 61
    //   47: sipush 24678
    ...
    //   60: athrow
    //   61: aload_1
    //   62: invokestatic 55	java/lang/Long:valueOf	(Ljava/lang/String;)Ljava/lang/Long;
    //   65: invokevirtual 59	java/lang/Long:longValue	()J
    //   68: lstore 4
    //   70: lload 4
    //   72: lstore_2
    //   73: sipush 24678
  ...
  public final void ao(String paramString, long paramLong)
  {
    try
    {
      ...
      this.rfw.gi(paramString, String.valueOf(paramLong));
  ...
  public final void df(String paramString, int paramInt)
  {
    try
    {
      ...
      this.rfw.gi(paramString, String.valueOf(paramInt));
  ...
  public final int getInt(String paramString, int paramInt)
  {
    ...
    //   8: aload_1
    //   9: invokestatic 43	com/tencent/mm/plugin/freewifi/m:dq	(Ljava/lang/String;)Z
    //   12: ifeq +13 -> 25
    //   15: sipush 24679
    ...
    //   24: ireturn
    //   25: aload_0
    //   26: getfield 27	com/tencent/mm/plugin/freewifi/i:rfw	Lcom/tencent/mm/plugin/freewifi/g/b;
    //   29: aload_1
    //   30: invokevirtual 49	com/tencent/mm/plugin/freewifi/g/b:aaG	(Ljava/lang/String;)Ljava/lang/String;
    //   33: astore_1
    //   34: aload_1
    //   35: invokestatic 43	com/tencent/mm/plugin/freewifi/m:dq	(Ljava/lang/String;)Z
    //   38: istore 4
    //   40: iload 4
    //   42: ifeq +17 -> 59
    //   45: sipush 24679
    ...
    //   58: athrow
    //   59: aload_1
    //   60: invokestatic 82	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   63: invokevirtual 86	java/lang/Integer:intValue	()I
    //   66: istore_3
    //   67: iload_3
    //   68: istore_2
    //   69: sipush 24679
