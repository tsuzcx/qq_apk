  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bm(paramView);
    a.b("com/tencent/mm/plugin/freewifi/ui/ProtocolThreeOneUI$4", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, localb.axR());
    paramView = new Intent();
    paramView.putExtra("rawUrl", this.wTb.wRE);
    paramView.putExtra("showShare", false);
    paramView.putExtra("show_bottom", false);
    c.b(this.wTb.getContext(), "webview", ".ui.tools.WebViewUI", paramView);
