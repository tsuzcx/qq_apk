  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    String str = ac.f(this.rjH.getSharedPreferences(aj.eFD(), 0));
    localIntent.putExtra("rawUrl", this.rjI.field_showUrl + "&lang=" + str);
    localIntent.putExtra("show_bottom", false);
    localIntent.putExtra("stastic_scene", 7);
    d.b(this.rjH, "webview", ".ui.tools.WebViewUI", localIntent);
