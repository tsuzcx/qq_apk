  ...
  extends MMActivity
{
  ...
  public ProtocolThreeTwoUI()
  {
    ...
    this.crJ = 1;
    this.mLr = 0;
    this.mOV = new ap(new ProtocolThreeTwoUI.1(this), false);
    c.a locala = new c.a();
    locala.eNK = true;
    locala.eNL = true;
  ...
  protected final void connect()
  {
    ...
    this.crJ = bBm();
    ab.i("MicroMsg.FreeWifi.Protocol32UI", "sessionKey=%s, step=%d, method=connect, desc=it starts connecting wifi by protocol 3.1. current connect state=%s", new Object[] { m.U(getIntent()), Integer.valueOf(m.V(getIntent())), com.tencent.mm.plugin.freewifi.model.d.wl(this.crJ) });
    if (this.crJ != 2)
    {
      this.mOV.ag(45000L, 45000L);
      ab.i("MicroMsg.FreeWifi.Protocol32UI", "sessionKey=%s, step=%d, method=connect, desc=it starts connectTimeoutHandler. timeout=%d s", new Object[] { m.U(getIntent()), Integer.valueOf(m.V(getIntent())), Integer.valueOf(60) });
      this.mLl = new com.tencent.mm.plugin.freewifi.a(this.ssid, this);
      j.bAN().bAw().post(new ProtocolThreeTwoUI.8(this));
  ...
  public void initView()
  {
    ...
    this.mNt.setOnClickListener(new ProtocolThreeTwoUI.5(this));
    this.mNu = ((Button)findViewById(2131824261));
    this.mNu.setOnClickListener(new ProtocolThreeTwoUI.6(this));
    if (bo.isNullOrNil(this.ssid))
    {
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.mLC = getIntent().getStringExtra("free_wifi_tid");
    this.cqf = getIntent().getStringExtra("ConstantsFreeWifi.FREE_WIFI_TIMESTAMP");
    this.sign = getIntent().getStringExtra("ConstantsFreeWifi.FREE_WIFI_SIGN");
    ab.i("MicroMsg.FreeWifi.Protocol32UI", "sessionKey=%s, step=%d, method=Protocol32UI.onCreate, desc=it goes into Protocol32 connect frontpage. apKey=%s", new Object[] { m.U(getIntent()), Integer.valueOf(m.V(getIntent())), this.coX });
    initView();
    if (bo.isNullOrNil(this.ssid))
    {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ab.i("MicroMsg.FreeWifi.Protocol32UI", "ssid : %s, mid : %s, source : %d", new Object[] { this.ssid, this.mMw, Integer.valueOf(this.cpt) });
        this.mMC = new ProtocolThreeTwoUI.7(this);
        j.bAK().add(this.mMC);
        ab.i("MicroMsg.FreeWifi.Protocol32UI", "sessionKey=%s, step=%d, method=Protocol32UI.initModel, desc=Initializing the model behind the view, so anything that changes the model will notify the view. model : field_ssidmd5=%s, field_ssid=%s, field_url=%s, field_mid=%s, field_wifiType=%d, field_connectState=%d", new Object[] { m.U(getIntent()), Integer.valueOf(m.V(getIntent())), paramBundle.field_ssidmd5, paramBundle.field_ssid, paramBundle.field_url, paramBundle.field_mid, Integer.valueOf(paramBundle.field_wifiType), Integer.valueOf(paramBundle.field_connectState) });
        ab.i("MicroMsg.FreeWifi.Protocol32UI", "sessionKey=%s, step=%d, method=Protocol32UI.initModel, desc=it initializes the front page. ", new Object[] { m.U(getIntent()), Integer.valueOf(m.V(getIntent())) });
  ...
  protected final void wn(int paramInt)
  {
    ...
    ab.i("MicroMsg.FreeWifi.Protocol32UI", "sessionKey=%s, step=%d, method=Protocol32UI.onConnectStateChange, desc=it receives notifications whenever the connect state of model changes and then updates the view accordingly. state=%d", new Object[] { m.U(getIntent()), Integer.valueOf(m.V(getIntent())), Integer.valueOf(paramInt) });
    switch (paramInt)
    {
    default: 
    ...
    case 4: 
      ...
      for (;;)
      {
        ...
        ab.i("MicroMsg.FreeWifi.Protocol32UI", "sessionKey=%s, step=%d, method=Protocol32UI.toConnectStart, desc=it initializes the connect front page.", new Object[] { m.U(getIntent()), Integer.valueOf(m.V(getIntent())) });
        AppMethodBeat.o(21199);
        return;
    ...
    case 1: 
      ...
      this.mOt = h.b(getContext(), getString(2131298512), true, new ProtocolThreeTwoUI.3(this));
      ab.i("MicroMsg.FreeWifi.Protocol32UI", "sessionKey=%s, step=%d, method=Protocol32UI.toConnecting, desc=it adds a loading ui on the connect front page.", new Object[] { m.U(getIntent()), Integer.valueOf(m.V(getIntent())) });
      AppMethodBeat.o(21199);
      return;
    case 3: 
      if (this.mOt != null) {
      ...
      ab.i("MicroMsg.FreeWifi.Protocol32UI", "sessionKey=%s, step=%d, method=Protocol32UI.toFail, desc=connect failed.", new Object[] { m.U(getIntent()), Integer.valueOf(m.V(getIntent())) });
      AppMethodBeat.o(21199);
      return;
    }
    if (this.mOt != null) {
    ...
    for (;;)
    {
      ...
      d.IE();
      ab.i("MicroMsg.FreeWifi.Protocol32UI", "sessionKey=%s, step=%d, method=Protocol32UI.toSuccess, desc=connect succeeded.", new Object[] { m.U(getIntent()), Integer.valueOf(m.V(getIntent())) });
      break;
