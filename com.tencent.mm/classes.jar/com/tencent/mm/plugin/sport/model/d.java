  ...
  implements k
{
  ...
  public d()
  {
    ...
    ((b.a)localObject).hNM = new bis();
    ((b.a)localObject).hNN = new bit();
    this.hWL = ((b.a)localObject).aDC();
    this.AGR = ((bis)this.hWL.hNK.hNQ);
    ...
    this.AGR.Gdb = ((int)(l2 / 1000L));
    this.AGR.Gdc = ((int)(l1 / 1000L));
