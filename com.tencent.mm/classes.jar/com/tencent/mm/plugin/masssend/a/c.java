...
public final class c
{
  ...
  private static String dkQ()
  {
    ...
    {
      ba.aBQ();
      String str = String.format("%s/masssend_%s.ini", new Object[] { com.tencent.mm.model.c.ajh(), ac.fks() });
  ...
  private boolean dkR()
  {
    ...
    {
      localObject = dkQ();
      arrayOfByte = i.aY((String)localObject, 0, -1);
      if (arrayOfByte == null)
      {
    ...
    try
    {
      this.vHi = ((e)new e().parseFrom(arrayOfByte)).vHj;
      if (this.vHi == null)
      {
    ...
    ad.i("MicroMsg.MassSendService", "info list[%s]", new Object[] { this.vHi.toString() });
    long l = bt.aQJ();
    Object localObject = this.vHi.iterator();
  ...
  public static void xX(long paramLong)
  {
    ...
    ba.aBQ();
    com.tencent.mm.model.c.ajl().set(102409, Long.valueOf(paramLong));
  ...
  public final void apm(String paramString)
  {
    ...
    Object localObject1 = bw.M(paramString, "Festivals");
    ...
    for (paramString = "";; paramString = String.valueOf(i))
    {
      ...
      localObject2 = new d();
      ((d)localObject2).begin = bt.aQX((String)((Map)localObject1).get(paramString + ".StartTime"));
      ((d)localObject2).end = (bt.aQX((String)((Map)localObject1).get(paramString + ".EndTime")) + 86400000);
      locale.vHj.add(localObject2);
      i += 1;
      break;
    }
    label200:
    locale.count = locale.vHj.size();
    this.vHi = locale.vHj;
    for (;;)
    {
      try
      {
        ...
        {
          ba.aBQ();
          com.tencent.mm.model.c.ajl().set(102408, Boolean.FALSE);
        ...
        if (!i.aPK(q.B(((com.tencent.mm.vfs.e)localObject2).mUri)).equals(com.tencent.mm.b.g.getMessageDigest(paramString)))
        {
          i = 1;
          if (i != 0)
          {
  ...
  public final void dkP()
  {
    ...
    boolean bool1 = dkR();
    ba.aBQ();
    boolean bool2 = ((Boolean)com.tencent.mm.model.c.ajl().get(102408, Boolean.FALSE)).booleanValue();
    int i;
    if ((u.aAy() & 0x10000) == 0)
    {
      i = 1;
      ...
      {
        localObject1 = new at();
        ((at)localObject1).setUsername("masssendapp");
        ((at)localObject1).setContent(aj.getContext().getResources().getString(2131757722));
        ((at)localObject1).qu(bt.flT() + 2000L);
        ((at)localObject1).kr(0);
        ((at)localObject1).kp(0);
        ba.aBQ();
        com.tencent.mm.model.c.azv().e((at)localObject1);
      }
    }
    label252:
    Object localObject2;
    for (;;)
    {
      com.tencent.mm.plugin.report.service.g.yhR.kvStat(10425, "");
      ba.aBQ();
      com.tencent.mm.model.c.ajl().set(102409, Long.valueOf(bt.flT()));
      ba.aBQ();
      com.tencent.mm.model.c.ajl().set(102408, Boolean.TRUE);
      AppMethodBeat.o(26352);
      return;
      i = 0;
      break;
      localObject2 = h.dkT().hHS.a("select * from massendinfo ORDER BY createtime DESC  limit 1", null, 2);
      ...
      ((at)localObject2).setContent((String)localObject1);
      ((at)localObject2).qu(bt.flT() + 2000L);
