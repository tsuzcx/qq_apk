...
public final class f
{
  ...
  private static com.tencent.mm.plugin.fts.a.a.f a(Spannable paramSpannable, e.b paramb, e parame)
  {
    ...
    float f1 = parame.tFj - parame.iU.getTextSize() * 2.0F;
    float f2 = parame.iU.measureText("…");
    float f3 = parame.iU.measureText(paramSpannable, 0, paramb.tFt);
    float f4 = parame.iU.measureText(paramSpannable, paramb.tFt, paramb.tFu);
    float f5 = parame.iU.measureText(paramSpannable, paramb.tFu, paramSpannable.length());
    if (f3 + f4 + f5 < f1)
    {
    ...
    Object localObject2 = paramSpannable.subSequence(paramb.tFt, paramb.tFu);
    Object localObject1;
    if (parame.tFh == e.a.tFq)
    {
      localObject1 = new SpannableString(TextUtils.concat(new CharSequence[] { parame.tFm, localObject2, parame.tFn }));
      if (f3 + f4 + f2 >= f1) {
        break label389;
      }
      localObject2 = new SpannableStringBuilder(paramSpannable, 0, paramb.tFt);
      ((SpannableStringBuilder)localObject2).append((CharSequence)localObject1);
      ((SpannableStringBuilder)localObject2).append(TextUtils.ellipsize(paramSpannable.subSequence(paramb.tFu, paramSpannable.length()), parame.iU, f1 - f3 - f4, TextUtils.TruncateAt.END));
      localf.tFv = ((CharSequence)localObject2);
    }
    for (;;)
    {
      localf.bZU = 0;
      AppMethodBeat.o(131656);
      return localf;
      if (parame.tFh == e.a.tFp) {}
      for (localObject1 = new BackgroundColorSpan(parame.tFi);; localObject1 = new ForegroundColorSpan(parame.tFi)) {
        for (;;)
        {
          ...
          {
            ae.printErrStackTrace("MicroMsg.FTS.FTSUIHLLogic", parame, "setSpan %s", new Object[] { paramb.toString() });
            localf.bZU = -1;
            localf.tFv = paramSpannable;
            AppMethodBeat.o(131656);
            return localf;
          }
        }
      ...
      if (f2 + f4 + f5 < f1)
      {
        ...
        ((SpannableStringBuilder)localObject2).append(TextUtils.ellipsize(paramSpannable.subSequence(0, paramb.tFt), parame.iU, f1 - f4 - f5, TextUtils.TruncateAt.START));
        ((SpannableStringBuilder)localObject2).append((CharSequence)localObject1);
        ((SpannableStringBuilder)localObject2).append(paramSpannable, paramb.tFu, paramSpannable.length());
        localf.tFv = ((CharSequence)localObject2);
      }
      else if (f2 + f4 + f2 >= f1)
      {
      ...
      else
      {
        localObject2 = new SpannableStringBuilder();
        f1 = (f1 - f4) / 2.0F;
        CharSequence localCharSequence = paramSpannable.subSequence(0, paramb.tFt);
        paramSpannable = paramSpannable.subSequence(paramb.tFu, paramSpannable.length());
  ...
  public static final com.tencent.mm.plugin.fts.a.a.f a(e parame)
  {
    ...
    SpannableString localSpannableString = new SpannableString(TextUtils.concat(new CharSequence[] { parame.tFk, parame.tFd, parame.tFl }));
    ((com.tencent.mm.plugin.fts.a.a.f)localObject1).bZU = -1;
    ((com.tencent.mm.plugin.fts.a.a.f)localObject1).tFv = localSpannableString;
    if ((!bu.ah(parame.tFd)) && (parame.tFe != null)) {}
    for (int i = 1; i == 0; i = 0)
    {
      AppMethodBeat.o(131654);
      return localObject1;
    }
    Object localObject4 = d.alm(parame.tFd.toString());
    Object localObject2 = new ArrayList();
    if (parame.tFf) {
      localObject2 = bo((String)localObject4, parame.tFg);
    }
    for (;;)
    {
      Object localObject6;
      if ((parame.tFe.tFG.size() == 1) || (a(localSpannableString, parame)))
      {
        localObject6 = new e.b();
        if (parame.tFe.tFG.size() == 1)
        {
          ((e.b)localObject6).tFs = ((h.c)parame.tFe.tFG.get(0));
          if (parame.tFf) {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localObject7 = ((com.tencent.mm.plugin.fts.a.a.f)localObject2).tFv.toString();
          localObject1 = new ArrayList();
          if (!parame.tFf) {
            break label857;
          }
          localObject1 = bo((String)localObject7, parame.tFg);
          i = j;
          if (i < parame.tFe.tFG.size())
          {
            ((e.b)localObject6).tFs = ((h.c)parame.tFe.tFG.get(i));
            if (parame.tFf)
            {
        ...
        catch (Exception localException1)
        {
          try
          {
            localObject4 = b((Spannable)((com.tencent.mm.plugin.fts.a.a.f)localObject2).tFv, (e.b)localObject6, parame);
            i += 1;
          ...
          {
            ((com.tencent.mm.plugin.fts.a.a.f)localObject3).tFv = localSpannableString;
        ...
        localObject6 = new e.b();
        ((e.b)localObject6).tFs = new h.c();
        Object localObject7 = new h.b();
        ((h.b)localObject7).tFI = h.d.tFN;
        ((h.b)localObject7).content = parame.tFe.tFD;
        ((e.b)localObject6).tFs.tFK.add(localObject7);
        if (parame.tFf) {
        ...
        localObject7 = parame.tFe.tFG.iterator();
        Object localObject8;
        while (((Iterator)localObject7).hasNext())
        {
          localObject8 = (h.c)((Iterator)localObject7).next();
          e.b localb = new e.b();
          localb.tFs = ((h.c)localObject8);
  ...
  public static final com.tencent.mm.plugin.fts.a.a.f a(String paramString1, String paramString2, e parame)
  {
    ...
    parame = a(parame);
    parame.tFv = TextUtils.concat(new CharSequence[] { paramString1, parame.tFv, paramString2 });
  ...
  private static void a(String paramString, e.b paramb, e parame)
  {
    ...
    {
      paramb.tFt = i;
      paramb.tFu = (str.length() + i);
    }
    if ((paramb.isAvailable()) && (parame.tFk != null))
    {
      paramb.tFt += parame.tFk.length();
      paramb.tFu += parame.tFk.length();
    }
    AppMethodBeat.o(131659);
  }
  ...
  private static void a(List<List<String>> paramList, e.b paramb, e parame)
  {
    ...
    if (parame.tFg)
    {
      localObject2 = paramb.tFs.tFK.iterator();
      do
      {
      ...
      } while (((h.b)localObject1).tFI != h.d.tFM);
    }
    for (;;)
    {
      ...
      int i = m(paramList, ((h.b)localObject1).tFJ);
      if (i >= 0)
      {
        paramb.tFt = i;
        paramb.tFu = (((h.b)localObject1).tFJ.size() + i);
        break label178;
      }
      for (;;)
      {
        ...
        AppMethodBeat.o(131660);
        return;
        localObject1 = paramb.tFs.tFK.iterator();
        label178:
        if (((Iterator)localObject1).hasNext())
        {
          localObject2 = (h.b)((Iterator)localObject1).next();
          if (((h.b)localObject2).tFI != h.d.tFL) {
            break;
          }
          i = m(paramList, ((h.b)localObject2).tFJ);
          if (i < 0) {
            break;
          }
          paramb.tFt = i;
          paramb.tFu = (((h.b)localObject2).tFJ.size() + i);
        }
      }
      localObject1 = null;
    }
  ...
  private static boolean a(Spannable paramSpannable, e parame)
  {
    ...
    if ((parame.tFj > 0.0F) && (parame.iU != null))
    {
      if (parame.tFj - parame.iU.getTextSize() * 2.0F < parame.iU.measureText(paramSpannable.toString()))
      {
  ...
  public static CharSequence alr(String paramString)
  {
  ...
  public static Spannable b(CharSequence paramCharSequence, String paramString)
  {
    ...
    if ((paramCharSequence.tFv instanceof Spannable))
    {
      paramCharSequence = (Spannable)paramCharSequence.tFv;
      AppMethodBeat.o(131663);
      return paramCharSequence;
    }
    paramCharSequence = new SpannableString(paramCharSequence.tFv);
    AppMethodBeat.o(131663);
    return paramCharSequence;
  }
  ...
  private static List<List<String>> bo(String paramString, boolean paramBoolean)
  {
  ...
  private static com.tencent.mm.plugin.fts.a.a.f c(Spannable paramSpannable, e.b paramb, e parame)
  {
    ...
    if (parame.tFh == e.a.tFq)
    {
      ...
      localStringBuffer.append(paramSpannable.substring(0, paramb.tFt));
      localStringBuffer.append(parame.tFm);
      localStringBuffer.append(paramSpannable.substring(paramb.tFt, paramb.tFu));
      localStringBuffer.append(parame.tFn);
      if (paramb.tFu < paramSpannable.length()) {
        localStringBuffer.append(paramSpannable.substring(paramb.tFu, paramSpannable.length()));
      }
      localf.tFv = localStringBuffer.toString();
      localf.bZU = 0;
      AppMethodBeat.o(131658);
      return localf;
    }
    if (parame.tFh == e.a.tFp) {}
    for (parame = new BackgroundColorSpan(parame.tFi);; parame = new ForegroundColorSpan(parame.tFi))
    {
      try
      {
        paramSpannable.setSpan(parame, paramb.tFt, paramb.tFu, 33);
        localf.tFv = paramSpannable;
        localf.bZU = 0;
      }
      catch (Exception parame)
  ...
  public static final SpannableString f(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    ...
    e.b localb = new e.b();
    localb.tFt = paramInt1;
    localb.tFu = paramInt2;
