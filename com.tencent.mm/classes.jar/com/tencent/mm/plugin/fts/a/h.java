...
{
  public abstract Cursor aHA(String paramString);
  
  public abstract boolean aHB(String paramString);
  
  public abstract long ac(long paramLong1, long paramLong2);
  ...
  public abstract boolean hw(int paramInt1, int paramInt2);
