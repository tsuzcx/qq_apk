  ...
  implements aq
{
  public final void aBP()
  {
    ...
    ae.i("MicroMsg.FTS.FTSDeleteMsgLogic", "start to delete all msg");
    if (!g.ajM())
    {
      b localb = new b();
    ...
    ae.i("MicroMsg.FTS.FTSDeleteMsgLogic", "syncDeleteAllMsg post task to fts task daemon");
    AppMethodBeat.o(176905);
  }
  ...
  public final void rU(long paramLong)
  {
    ...
    try
    {
      ...
      ae.i("MicroMsg.FTS.FTSDeleteMsgLogic", "syncDeleteSingleMsg post task to fts task daemon %d", new Object[] { Long.valueOf(paramLong) });
      AppMethodBeat.o(52764);
      return;
    }
    catch (Exception localException)
    {
      ae.printErrStackTrace("MicroMsg.FTS.FTSDeleteMsgLogic", localException, "syncDeleteSingleMsg", new Object[0]);
      AppMethodBeat.o(52764);
    }
  }
  ...
  public final void z(String paramString, long paramLong)
  {
    ...
    ae.i("MicroMsg.FTS.FTSDeleteMsgLogic", "start to delete fts talker msg %s %s", new Object[] { paramString, i.formatTime("yyyy-MM-dd HH:mm:ss", paramLong / 1000L) });
    if (!g.ajM())
    {
      paramString = new b();
    ...
    try
    {
      ...
      ae.i("MicroMsg.FTS.FTSDeleteMsgLogic", "syncDeleteTalkerMsg post task to fts task daemon %s %s", new Object[] { paramString, Long.valueOf(paramLong) });
      AppMethodBeat.o(52765);
      return;
    }
    catch (Exception paramString)
    {
      ae.printErrStackTrace("MicroMsg.FTS.FTSDeleteMsgLogic", paramString, "syncDeleteTalkerMsg", new Object[0]);
      AppMethodBeat.o(52765);
    }
  }
    ...
    extends a
  {
    ...
    public final boolean execute()
    {
      ...
      if (locald != null)
      {
        ...
        ae.i("MicroMsg.FTS.FTSIndexDB", "deleteAllMsg use time %d", new Object[] { Long.valueOf(System.currentTimeMillis() - l) });
      }
    ...
    extends a
  {
    ...
    public final boolean execute()
    {
      ...
      d locald = ((PluginFTS)g.ad(PluginFTS.class)).getFTSIndexDB();
      if (locald != null) {
        locald.au(this.talker, this.tIv);
      }
