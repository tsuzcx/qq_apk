  ...
  extends VoiceInputLayout
{
  ...
  public FTSVoiceInputLayoutImpl(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.aYD = new View.OnLongClickListener()
    {
      public final boolean onLongClick(View paramAnonymousView)
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/fts/ui/widget/FTSVoiceInputLayoutImpl$2", "android/view/View$OnLongClickListener", "onLongClick", "(Landroid/view/View;)Z", this, localb.ahF());
        ae.d("MicroMsg.FTSVoiceInputLayoutImpl", "btn onLongClickListener currentState %s", new Object[] { Integer.valueOf(FTSVoiceInputLayoutImpl.this.currentState) });
        ...
        ae.d("MicroMsg.FTSVoiceInputDrawable", "longClickState %s", new Object[] { Integer.valueOf(paramAnonymousView.currentState) });
    ...
    this.tOH = new View.OnTouchListener()
    {
      public final boolean onTouch(View paramAnonymousView, MotionEvent paramAnonymousMotionEvent)
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/fts/ui/widget/FTSVoiceInputLayoutImpl$3", "android/view/View$OnTouchListener", "onTouch", "(Landroid/view/View;Landroid/view/MotionEvent;)Z", this, localb.ahF());
        ...
        for (;;)
        {
          ...
          return false;
          if (!az.isConnected(FTSVoiceInputLayoutImpl.this.getContext()))
          {
            FTSVoiceInputLayoutImpl.b(FTSVoiceInputLayoutImpl.this, true);
            FTSVoiceInputLayoutImpl.this.tPV.Hx(12);
          }
          else
          {
            FTSVoiceInputLayoutImpl.b(FTSVoiceInputLayoutImpl.this, false);
            FTSVoiceInputLayoutImpl.a(FTSVoiceInputLayoutImpl.this, false);
            FTSVoiceInputLayoutImpl.a(FTSVoiceInputLayoutImpl.this, bu.HQ());
            ((FTSVoiceInputLayoutImpl.a)FTSVoiceInputLayoutImpl.this.tPV).cWF();
            ae.d("MicroMsg.FTSVoiceInputLayoutImpl", "btn onTouch ACTION_DOWN currentState %s longClickStartTime %s", new Object[] { Integer.valueOf(FTSVoiceInputLayoutImpl.this.currentState), Long.valueOf(FTSVoiceInputLayoutImpl.c(FTSVoiceInputLayoutImpl.this)) });
            paramAnonymousView = FTSVoiceInputLayoutImpl.b(FTSVoiceInputLayoutImpl.this);
            ae.d("MicroMsg.FTSVoiceInputDrawable", "readyPressState %s", new Object[] { Integer.valueOf(paramAnonymousView.currentState) });
            paramAnonymousView.currentState = 6;
            paramAnonymousView.invalidateSelf();
            FTSVoiceInputLayoutImpl.this.Q(false, false);
        ...
        ae.d("MicroMsg.FTSVoiceInputLayoutImpl", "btn onTouch ACTION_UP currentState %s longClickDown %s", new Object[] { Integer.valueOf(FTSVoiceInputLayoutImpl.this.currentState), Boolean.valueOf(FTSVoiceInputLayoutImpl.f(FTSVoiceInputLayoutImpl.this)) });
        if (FTSVoiceInputLayoutImpl.f(FTSVoiceInputLayoutImpl.this))
        {
          FTSVoiceInputLayoutImpl.this.Q(true, false);
          FTSVoiceInputLayoutImpl.a(FTSVoiceInputLayoutImpl.this, false);
        ...
        for (;;)
        {
          ...
          ((FTSVoiceInputLayoutImpl.a)FTSVoiceInputLayoutImpl.this.tPV).cWE();
          break;
          FTSVoiceInputLayoutImpl.this.Q(false, true);
        }
      }
    };
    init(paramContext);
  ...
  private void cWN()
  {
    ...
    runOnUiThread(new Runnable()
    {
      public final void run()
      {
        ...
        ae.d("MicroMsg.FTSVoiceInputDrawable", "disableState %s", new Object[] { Integer.valueOf(locala.currentState) });
  ...
  private void init(Context paramContext)
  {
    ...
    this.tOB = localView.findViewById(2131306533);
    this.tOB.setLayerType(1, null);
    this.tOD = new a(paramContext);
    this.tOB.setBackground(this.tOD);
    this.tOB.setEnabled(true);
    this.tOB.setOnTouchListener(this.tOH);
    this.tOB.setOnLongClickListener(this.aYD);
    this.tOC = ((TextView)localView.findViewById(2131300319));
    reset(true);
    if (isInEditMode())
    {
  ...
  protected final void Hy(final int paramInt)
  {
    ...
    runOnUiThread(new Runnable()
    {
      public final void run()
      {
        ...
        a locala = FTSVoiceInputLayoutImpl.b(FTSVoiceInputLayoutImpl.this);
        int i = paramInt;
        ae.d("MicroMsg.FTSVoiceInputDrawable", "recordingState() called with: maxAmplitudeRate = [%s]", new Object[] { Integer.valueOf(i) });
        locala.tOk = a.Hw(i);
        locala.invalidateSelf();
        locala.tOm = i;
  ...
  public final void Q(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    ae.d("MicroMsg.FTSVoiceInputLayoutImpl", "directStart currentState = %s longUp = %s clickUp = %s", new Object[] { Integer.valueOf(this.currentState), Boolean.valueOf(paramBoolean1), Boolean.valueOf(paramBoolean2) });
  ...
  protected final void cWQ()
  {
    ...
    runOnUiThread(new Runnable()
    {
      public final void run()
      {
        ...
        a locala = FTSVoiceInputLayoutImpl.b(FTSVoiceInputLayoutImpl.this);
        boolean bool = this.tOJ;
        ae.d("MicroMsg.FTSVoiceInputDrawable", "recordingStartState() called with: maxAmplitudeRate = [%s] fromLongCkick = %s", new Object[] { Integer.valueOf(0), Boolean.valueOf(bool) });
        if (!bool) {
  ...
  protected final void cWR()
  {
    ...
    runOnUiThread(new Runnable()
    {
      public final void run()
      {
        ...
        a locala = FTSVoiceInputLayoutImpl.b(FTSVoiceInputLayoutImpl.this);
        ae.d("MicroMsg.FTSVoiceInputDrawable", "recognizingState %s", new Object[] { Integer.valueOf(locala.currentState) });
  ...
  protected final void onReset()
  {
    ...
    runOnUiThread(new Runnable()
    {
      public final void run()
      {
        ...
        FTSVoiceInputLayoutImpl.g(FTSVoiceInputLayoutImpl.this);
        FTSVoiceInputLayoutImpl.b(FTSVoiceInputLayoutImpl.this).cWB();
