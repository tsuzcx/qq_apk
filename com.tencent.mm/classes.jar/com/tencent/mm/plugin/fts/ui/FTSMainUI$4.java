  ...
  public final void onClick(View paramView)
  {
    ...
    try
    {
      if (paramView.getTag() != null)
      {
        ...
        if (!paramView.equals(this.ruJ.getString(2131762938))) {
          break label110;
        }
        i = 2;
        if (i != 0)
        {
          paramView = FTSMainUI.b(this.ruJ);
          ((i)g.ab(i.class)).a(paramView.ryk, new d.3(paramView, i));
        }
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        ...
        continue;
        label110:
        if (paramView.equals(this.ruJ.getString(2131762942))) {
          i = 8;
        } else if (paramView.equals(this.ruJ.getString(2131762939))) {
          i = 1;
        }
      }
    }
