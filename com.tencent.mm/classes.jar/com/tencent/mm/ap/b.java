  ...
  extends au
{
  ...
  public final void vb(int paramInt)
  {
    ...
    if (vc(paramInt))
    {
      ...
      com.tencent.mm.plugin.report.service.h.OAn.idkeyStat(336L, 0L, 1L, true);
      bh.bCz();
      ...
      {
        com.tencent.mm.plugin.report.service.h.OAn.idkeyStat(336L, 1L, 1L, true);
      ...
      com.tencent.mm.plugin.report.service.h.OAn.idkeyStat(336L, 2L, 1L, true);
    }
    for (;;)
    {
      ...
      return;
      label628:
      com.tencent.mm.plugin.report.service.h.OAn.idkeyStat(336L, 3L, 1L, true);
    }
  }
