  ...
  extends al
{
  ...
  public final void transfer(int paramInt)
  {
    ...
    ad.d("MicroMsg.App.BizInfoDataTransfer", "the previous version is %d", new Object[] { Integer.valueOf(paramInt) });
    if ((paramInt != 0) && (paramInt < 604372991))
    {
      com.tencent.mm.plugin.report.service.h.vKh.dB(336, 12);
      az.arV();
      Object localObject2 = com.tencent.mm.model.c.afg();
      ...
      ad.d("MicroMsg.App.BizInfoDataTransfer", "sql %s", new Object[] { str });
      ...
      if (localObject2 != null)
      {
        while (((Cursor)localObject2).moveToNext())
        {
          ...
          if (((com.tencent.mm.api.c)localObject3).bU(false).getServiceType() == 1) {
      ...
      if (((List)localObject1).size() > 0)
      {
        ...
        ad.d("MicroMsg.App.BizInfoDataTransfer", "update sql %s", new Object[] { localObject1 });
        af.awe().execSQL("BizInfo", (String)localObject1);
      }
    }
