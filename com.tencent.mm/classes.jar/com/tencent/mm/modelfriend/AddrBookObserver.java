  ...
  extends ContentObserver
{
  ...
  private static boolean hdF;
  private static Intent hdG;
  ...
  static
  {
    ...
    handler = new ap(Looper.getMainLooper())
    {
      public final void handleMessage(Message paramAnonymousMessage)
      {
        ...
        if (AddrBookObserver.axx() == null)
        {
          AddrBookObserver.v(new Intent());
          AddrBookObserver.axx().setClass(paramAnonymousMessage, AddrBookObserver.AddrBookService.class);
        }
        float f = new Random(System.currentTimeMillis()).nextFloat();
        AddrBookObserver.axx().putExtra(AddrBookObserver.AddrBookService.hdH, f);
        try
        {
          ad.i("MicroMsg.AddrBookObserver", "time's up, start AddrBookObserver, session:%f", new Object[] { Float.valueOf(f) });
          d.aY(AddrBookObserver.axx());
  ...
  public final void onChange(boolean paramBoolean)
  {
    ...
    ad.e("MicroMsg.AddrBookObserver", "isSyncing:" + hdF + ", is time to sync:" + l.aIP() + " , return");
    AppMethodBeat.o(127660);
  }
    ...
    extends MMService
  {
    ...
    public static String hdH = "key_sync_session";
      ...
      this.hdI = new b()
      {
        public final void er(boolean paramAnonymousBoolean)
        {
          ...
          if (!paramAnonymousBoolean)
          {
            ...
            AddrBookObserver.AddrBookService.hdF = false;
    ...
    public final int onStartCommand(Intent paramIntent, int paramInt1, int paramInt2)
    {
      ...
      float f1 = paramIntent.getFloatExtra(hdH, -1.0F);
      if (f1 == -1.0F)
      {
      ...
      paramIntent = aj.getContext().getSharedPreferences(aj.eFD(), 0);
      float f2 = paramIntent.getFloat(hdH, 0.0F);
      if (f2 == f1)
      {
      ...
      paramIntent.edit().putFloat(hdH, f1).commit();
      ...
      for (;;)
      {
        try
        {
          ...
          if (t.cR(aj.getContext())) {
            continue;
          }
          hdF = true;
          com.tencent.mm.platformtools.a.syncAddrBook(this.hdI);
        }
