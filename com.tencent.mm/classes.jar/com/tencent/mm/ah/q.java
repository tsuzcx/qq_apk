  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.aR(3, this.hkQ);
      if (this.hkR != null) {
        paramVarArgs.d(4, this.hkR);
      }
      paramVarArgs.aO(5, this.msgId);
    ...
    {
      int i = paramInt + f.a.a.b.b.a.bx(2, this.ReqType) + f.a.a.b.b.a.bx(3, this.hkQ);
      paramInt = i;
      if (this.hkR != null) {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          return 0;
        case 2: 
          localq.ReqType = locala.LVo.xF();
          AppMethodBeat.o(116412);
          return 0;
        case 3: 
          localq.hkQ = locala.LVo.xF();
          AppMethodBeat.o(116412);
          return 0;
        case 4: 
          localq.hkR = locala.LVo.readString();
          AppMethodBeat.o(116412);
          return 0;
        }
        localq.msgId = locala.LVo.xG();
        AppMethodBeat.o(116412);
        return 0;
      }
      AppMethodBeat.o(116412);
