  ...
  extends s
{
  ...
  private String awr()
  {
    ...
    String str = r.aGc(b.q(this.hkX.hld, 4));
  ...
  public final void s(Bundle paramBundle)
  {
    ...
    try
    {
      if ((((h)g.agO().agp()).ahL()) && ((this.hkX.type == 5) || (this.hkX.type == 8)) && (this.hkY.size() == 0)) {
        this.hkY.add(awr());
      }
      paramBundle.putByteArray("biz_mp_msg_info", toByteArray());
      paramBundle.putString("rawUrl", this.hkX.url);
      AppMethodBeat.o(116421);
      return;
    }
    catch (IOException paramBundle)
    {
      ac.e("MicroMsg.MPMsgInfo", "writeToIntent %s", new Object[] { paramBundle.getMessage() });
      AppMethodBeat.o(116421);
    }
  }
  ...
  public final void t(Intent paramIntent)
  {
    ...
    try
    {
      ...
      paramIntent.putExtra("rawUrl", this.hkX.url);
      AppMethodBeat.o(116420);
      return;
    }
    catch (IOException paramIntent)
    {
      ac.e("MicroMsg.MPMsgInfo", "writeToIntent %s", new Object[] { paramIntent.getMessage() });
      AppMethodBeat.o(116420);
    }
  }
  ...
  public final void t(Bundle paramBundle)
  {
    ...
    {
      ac.e("MicroMsg.MPMsgInfo", "parseFromBundle %s", new Object[] { paramBundle.getMessage() });
      AppMethodBeat.o(116424);
      return;
    }
  ...
  public final void u(Intent paramIntent)
  {
    ...
    {
      ac.e("MicroMsg.MPMsgInfo", "parseFromIntent %s", new Object[] { paramIntent.getMessage() });
      AppMethodBeat.o(116423);
      return;
    }
