...
public final class a
  implements com.tencent.mm.modelimage.loader.b.b
{
  private g oKQ;
  
  private String a(String paramString, com.tencent.mm.modelimage.loader.a.c paramc)
  {
    ...
    else
    {
      ...
      if (localObject2 != null)
      {
        localObject1 = localObject2;
        if (((String)localObject2).length() != 0) {
          localObject1 = (String)localObject2 + "/" + this.oKQ.Ou(paramString);
        }
      }
    }
    ...
    if (paramc.oKo)
    {
      ...
      if (Util.isNullOrNil((String)localObject1)) {
        localObject2 = com.tencent.mm.modelimage.loader.f.b.bnI() + "/" + this.oKQ.Ou(paramString);
      }
    }
  ...
  private String b(String paramString, com.tencent.mm.modelimage.loader.a.c paramc)
  {
    AppMethodBeat.i(130406);
    String str1 = paramc.oKr;
    Object localObject;
    if (str1 != null)
    {
      localObject = str1;
    ...
    if (localObject != null)
    {
      paramc = (com.tencent.mm.modelimage.loader.a.c)localObject;
      if (((String)localObject).length() != 0) {}
    }
    else
    {
      paramc = this.oKQ.Ou(paramString);
    }
  ...
  /* Error */
  public final boolean a(String paramString, byte[] paramArrayOfByte, com.tencent.mm.modelimage.loader.a.c paramc)
  {
    // Byte code:
    //   0: ldc 119
    //   2: invokestatic 22	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   5: aload_3
    //   6: getfield 123	com/tencent/mm/modelimage/loader/a/c:oKH	Lcom/tencent/mm/modelsfs/SFSContext;
    //   9: astore 11
    //   11: aload 11
    //   13: ifnull +371 -> 384
    //   16: aload_0
    //   17: aload_1
    //   18: aload_3
    //   19: invokespecial 125	com/tencent/mm/modelimage/loader/impr/a:b	(Ljava/lang/String;Lcom/tencent/mm/modelimage/loader/a/c;)Ljava/lang/String;
    //   22: astore 7
    //   24: aload 7
    //   26: ifnonnull +10 -> 36
    //   29: ldc 119
    ...
    //   102: astore 8
    //   104: aload 7
    //   106: invokestatic 143	com/tencent/mm/modelsfs/e:OS	(Ljava/lang/String;)Z
    //   109: ifeq +409 -> 518
    //   112: aload 10
    //   114: astore 8
    //   116: aload 7
    ...
    //   150: astore 8
    //   152: aload 7
    //   154: invokestatic 155	com/tencent/mm/modelsfs/e:OT	(Ljava/lang/String;)Ljava/lang/String;
    //   157: astore 9
    //   159: aload 10
    //   161: astore 8
    //   163: aload 11
    ...
    //   385: aload_1
    //   386: aload_3
    //   387: invokespecial 195	com/tencent/mm/modelimage/loader/impr/a:a	(Ljava/lang/String;Lcom/tencent/mm/modelimage/loader/a/c;)Ljava/lang/String;
    //   390: astore_3
    //   391: aload_3
    ...
    //   400: iconst_0
    //   401: ireturn
    //   402: new 197	com/tencent/mm/vfs/u
    //   405: dup
    //   406: aload_3
    //   407: invokespecial 198	com/tencent/mm/vfs/u:<init>	(Ljava/lang/String;)V
    //   410: invokevirtual 202	com/tencent/mm/vfs/u:jKP	()Lcom/tencent/mm/vfs/u;
    //   413: astore 7
    //   415: aload 7
    //   417: ifnull +17 -> 434
    //   420: aload 7
    //   422: invokevirtual 206	com/tencent/mm/vfs/u:jKS	()Z
    //   425: ifne +9 -> 434
    //   428: aload 7
    //   430: invokevirtual 209	com/tencent/mm/vfs/u:jKY	()Z
    //   433: pop
    //   434: new 197	com/tencent/mm/vfs/u
    //   437: dup
    //   438: aload_3
    //   439: invokespecial 198	com/tencent/mm/vfs/u:<init>	(Ljava/lang/String;)V
    //   442: astore 7
    //   444: aload 7
    //   446: invokevirtual 206	com/tencent/mm/vfs/u:jKS	()Z
    //   449: ifne +9 -> 458
    //   452: aload 7
    //   454: invokevirtual 212	com/tencent/mm/vfs/u:jKZ	()Z
    //   457: pop
    //   458: aload_3
    //   459: astore 7
    //   461: aload_2
    ...
    //   470: aload_2
    //   471: arraylength
    //   472: invokestatic 218	com/tencent/mm/vfs/y:f	(Ljava/lang/String;[BI)I
    //   475: ifge -135 -> 340
    //   478: ldc 119
    ...
    //   0	528	3	paramc	com.tencent.mm.modelimage.loader.a.c
    //   123	18	4	i	int
    //   240	136	5	l	long
  ...
  public final void bKy()
  {
    ...
    com.tencent.mm.modelimage.loader.f.b.bKH();
    AppMethodBeat.o(130409);
  }
  
  public final boolean c(String paramString, com.tencent.mm.modelimage.loader.a.c paramc)
  {
    AppMethodBeat.i(130408);
    SFSContext localSFSContext = paramc.oKH;
  ...
  public final InputStream d(String paramString, com.tencent.mm.modelimage.loader.a.c paramc)
  {
    AppMethodBeat.i(130410);
    SFSContext localSFSContext;
    try
    {
      localSFSContext = paramc.oKH;
      if (localSFSContext == null) {
        break label185;
      }
 ...
 * Qualified Name:     com.tencent.mm.modelimage.loader.impr.a
