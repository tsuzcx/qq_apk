...
public final class d
{
  ...
  HashMap<String, HashMap<String, String>> ggC;
  public Map<String, String> ggD;
  private int id;
  int version;
  ...
  public static LinkedList<a> q(Map<String, String> paramMap)
  {
    ...
    if (localObject3 != null)
    {
      ...
      {
        ae.d("MicroMsg.ConfigListInfo", "has menuItem2, %s, %s", new Object[] { Integer.valueOf(((LinkedList)localObject2).size()), Integer.valueOf(((LinkedList)localObject3).size()) });
  ...
  static boolean vV(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!bu.isNullOrNil(paramString))
        {
          ...
          if ((paramString != null) && (paramString.length > 0))
          {
            ...
            {
              if (bu.isNullOrNil(paramString[i])) {
                break label267;
              }
        ...
        ae.d("MicroMsg.ConfigListInfo", "locale is ".concat(String.valueOf(paramString)));
        ...
        if (((Iterator)localObject).hasNext())
        {
          ...
          {
            ae.d("MicroMsg.ConfigListInfo", "find other");
            AppMethodBeat.o(131989);
            return true;
          }
          ...
          ae.d("MicroMsg.ConfigListInfo", "find ");
          AppMethodBeat.o(131989);
          return true;
        }
      }
      ...
      {
        ae.e("MicroMsg.ConfigListInfo", "exception:%s", new Object[] { bu.o(paramString) });
        ae.d("MicroMsg.ConfigListInfo", "isContainLocale failed " + paramString.getMessage());
        AppMethodBeat.o(131989);
        return false;
      }
      label267:
