  ...
  implements a
{
  ...
  public final boolean a(Context paramContext, String[] paramArrayOfString, String paramString)
  {
    ...
    for (;;)
    {
      ...
      i = 3;
      break;
      com.tencent.mm.platformtools.ac.iSB = true;
      com.tencent.mm.platformtools.ac.iSA = true;
      continue;
      com.tencent.mm.platformtools.ac.iSB = false;
      com.tencent.mm.platformtools.ac.iSA = false;
      continue;
      i = 8888;
      if (paramArrayOfString.length >= 3) {
        i = bu.getInt(paramArrayOfString[2], 8888);
      }
      try
      {
        ...
        Toast.makeText(ak.getContext(), "start server on ".concat(String.valueOf(i)), 1).show();
      }
      catch (Exception paramContext)
      {
        ae.printErrStackTrace("MicroMsg.WarpgateCommand", paramContext, "", new Object[0]);
      }
      continue;
      try
      {
        ...
        Toast.makeText(ak.getContext(), "stop server", 1).show();
      }
      catch (Exception paramContext)
      {
        ae.printErrStackTrace("MicroMsg.WarpgateCommand", paramContext, "", new Object[0]);
