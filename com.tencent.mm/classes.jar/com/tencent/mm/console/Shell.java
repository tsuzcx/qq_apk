...
import com.tencent.mm.model.ct.d;
...
{
  private static HashMap<String, a> man;
  private static IntentFilter mao;
  private static Runnable maq;
  private Receiver mam = null;
  
  static
  {
    AppMethodBeat.i(20168);
    man = new HashMap();
    mao = new IntentFilter();
    a("wechat.shell.SET_NEXTRET", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
    ...
    a("wechat.shell.SET_CDNTRANS", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        z.pCg = paramAnonymousIntent.getBooleanExtra("value", false);
        Log.w("MicroMsg.Shell", "kiro set Test.forceCDNTrans=%b", new Object[] { Boolean.valueOf(z.pCg) });
    ...
    a("wechat.shell.NET_DNS_TEST", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        z.pCl = paramAnonymousIntent.getIntExtra("value", 0);
        Log.w("MicroMsg.Shell", "dkdnstd set Test.netDnsSimulateFault=%s", new Object[] { Integer.toBinaryString(z.pCl) });
    ...
    a("wechat.shell.IDC_ERROR", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        z.pCp = paramAnonymousIntent.getStringExtra("errmsg");
        Log.w("MicroMsg.Shell", "tiger set tigerIDCErrMsg =%s", new Object[] { z.pCp });
    ...
    a("wechat.shell.SET_DK_WT_TEST", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        z.pCq = paramAnonymousIntent.getStringExtra("acc");
        z.pCr = paramAnonymousIntent.getStringExtra("pass");
        Log.w("MicroMsg.Shell", "dkwt shell [%s %s]", new Object[] { z.pCq, z.pCr });
    ...
    a("wechat.shell.SET_MUTE_ROOM_TEST", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        z.pCU = paramAnonymousIntent.getIntExtra("flag", 0);
        Log.w("MicroMsg.Shell", "dkwt shell [%d]", new Object[] { Integer.valueOf(z.pCU) });
    ...
    a("wechat.shell.HOTPATCH_TEST", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        mr localmr = new mr();
        localmr.hON.hOS = paramAnonymousIntent.getExtras().getString("path", "/data/local/tmp/test.apk");
        Log.w("MicroMsg.Shell", "hotpatch test [%s]", new Object[] { localmr.hON.hOS });
        localmr.publish();
    ...
    a("wechat.shell.EXEC_STATUSDB_SQL", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        if (paramAnonymousIntent != null) {
          ((com.tencent.mm.plugin.textstatus.a.f)com.tencent.mm.kernel.h.az(com.tencent.mm.plugin.textstatus.a.f.class)).execSQL(paramAnonymousIntent);
        }
    ...
    {
      public final void v(final Intent paramAnonymousIntent)
      {
        ...
        if ((paramAnonymousIntent != null) && (paramAnonymousIntent.length() > 0)) {
          com.tencent.mm.kernel.h.baH().postToWorker(new Runnable()
          {
            ...
            public final void run()
            {
              ...
              //   5: invokestatic 45	com/tencent/mm/kernel/h:baE	()Lcom/tencent/mm/kernel/f;
              //   8: getfield 51	com/tencent/mm/kernel/f:mCN	Lcom/tencent/mm/storagebase/h;
              //   11: invokevirtual 57	com/tencent/mm/storagebase/h:jef	()Lcom/tencent/wcdb/database/SQLiteDatabase;
              //   14: astore 6
              //   16: invokestatic 63	java/lang/System:currentTimeMillis	()J
              //   19: lstore_1
              //   20: new 65	java/io/BufferedReader
              //   23: dup
              //   24: new 67	com/tencent/mm/vfs/ab
              //   27: dup
              //   28: aload_0
              //   29: getfield 21	com/tencent/mm/console/Shell$3$2:val$file	Ljava/lang/String;
              //   32: invokespecial 70	com/tencent/mm/vfs/ab:<init>	(Ljava/lang/String;)V
    ...
    a("wechat.shell.DUMP_HPROF", new b()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        paramAnonymousIntent = new u(MMApplicationContext.getContext().getExternalCacheDir() + "/hprofs");
        Log.i("MicroMsg.Shell", "prepare hprof dir %s", new Object[] { paramAnonymousIntent });
        if (!paramAnonymousIntent.jKS()) {
          Log.e("MicroMsg.Shell", "dir not exists, mkdir: %s", new Object[] { Boolean.valueOf(paramAnonymousIntent.jKY()) });
        }
        paramAnonymousIntent = new u(paramAnonymousIntent, MMApplicationContext.getProcessName().replace(".", "_").replace(":", "_") + "_" + new SimpleDateFormat("yyyyMMddHHmmss", Locale.getDefault()).format(new Date()) + ".hprof");
        Log.i("MicroMsg.Shell", "hprof file path is %s", new Object[] { ah.v(paramAnonymousIntent.jKT()) });
        try
        {
          Debug.dumpHprofData(ah.v(paramAnonymousIntent.jKT()));
          Toast.makeText(MMApplicationContext.getContext(), "Done. cost " + (System.currentTimeMillis() - l) + "ms, file:\n" + ah.v(paramAnonymousIntent.jKT()), 1).show();
          AppMethodBeat.o(20146);
          return;
        }
    ...
    a("wechat.shell.HOOK_ALL", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        com.tencent.mm.plugin.performance.a.a.MIk.aRq("<cmd><diagnostic><MemoryHook enable='1' source='push' multiprocess='0' duration='24' hook='.*\\.so$' stack='0' min='0' max='0' force='1' enableExpt='0' sampling='1'/></diagnostic></cmd>");
    ...
    a("wechat.shell.HOOK_MM", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        for (paramAnonymousIntent = ".*com\\.tencent\\.mm.*\\.so$;.*libhwui\\.so$;.*libEGL\\.so$;.*libGLES.*\\.so$";; paramAnonymousIntent = ".*com\\.tencent\\.mm.*\\.so$")
        {
          ...
          com.tencent.mm.plugin.performance.a.a.MIk.aRq(paramAnonymousIntent);
    ...
    a("wechat.shell.DISABLE_HOOK_TOAST", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
    ...
    a("wechat.shell.HOOK_DISABLE", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        com.tencent.mm.plugin.performance.a.a.MIk.aRq("<cmd><diagnostic><MemoryHook enable='0' source='push' enableExpt='0' force='1'/></diagnostic></cmd>");
    ...
    a("wechat.shell.HOOK_REPORT", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        com.tencent.mm.plugin.performance.a.a.MIk.aRq("<cmd><diagnostic><report><memory/></report></diagnostic></cmd>");
    ...
    a("wechat.shell.MEMORY_HOOK", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        paramAnonymousIntent = "<cmd><diagnostic><MemoryHook enable='" + Shell.au(paramAnonymousIntent.getStringExtra("enable"), "0") + "' source='push' multiprocess='" + Shell.au(paramAnonymousIntent.getStringExtra("multiprocess"), "0") + "' duration='" + Shell.au(paramAnonymousIntent.getStringExtra("duration"), "1") + "' hook='" + Shell.au(paramAnonymousIntent.getStringExtra("hook"), ".*com\\.tencent\\.mm.*\\.so$") + "' ignore='" + Shell.au(paramAnonymousIntent.getStringExtra("ignore"), "") + "' stack='" + Shell.au(paramAnonymousIntent.getStringExtra("stack"), "0") + "' min='" + Shell.au(paramAnonymousIntent.getStringExtra("min"), "0") + "' max='" + Shell.au(paramAnonymousIntent.getStringExtra("max"), "0") + "' force='" + Shell.au(paramAnonymousIntent.getStringExtra("force"), "0") + "' sampling='" + Shell.au(paramAnonymousIntent.getStringExtra("sampling"), "1") + "' extreme='" + Shell.au(paramAnonymousIntent.getStringExtra("extreme"), "0") + "' mmap='" + Shell.au(paramAnonymousIntent.getStringExtra("mmap"), "0") + "'/></diagnostic></cmd>";
        com.tencent.mm.plugin.performance.a.a.MIk.aRq(paramAnonymousIntent);
        Toast.makeText(MMApplicationContext.getContext(), paramAnonymousIntent, 0).show();
        AppMethodBeat.o(20152);
      }
    }, true);
    a("wechat.shell." + com.tencent.mm.plugin.performance.a.b.aRr(""), new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        AppMethodBeat.i(20154);
        paramAnonymousIntent = "<cmd><diagnostic>" + String.format("<fetch target='%s' network='any' />", new Object[] { com.tencent.mm.plugin.performance.a.b.aRr("©¥¶£ê¯¥§»") }) + "</diagnostic></cmd>";
        com.tencent.mm.plugin.performance.a.a.MIk.aRq(paramAnonymousIntent);
    ...
    a("wechat.shell." + com.tencent.mm.plugin.performance.a.b.aRr(""), new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        paramAnonymousIntent = "<cmd><diagnostic>" + String.format("<fetch target='%s' name_regex='%s' network='any' />", new Object[] { com.tencent.mm.plugin.performance.a.b.aRr("§§´¥ì±¬"), paramAnonymousIntent }) + "</diagnostic></cmd>";
        com.tencent.mm.plugin.performance.a.a.MIk.aRq(paramAnonymousIntent);
    ...
    a("wechat.shell." + com.tencent.mm.plugin.performance.a.b.aRr(""), new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        paramAnonymousIntent = "<cmd><diagnostic>" + String.format("<fetch target='%s' process='%s' network='any' />", new Object[] { com.tencent.mm.plugin.performance.a.b.aRr("­ ²°"), paramAnonymousIntent }) + "</diagnostic></cmd>";
        com.tencent.mm.plugin.performance.a.a.MIk.aRq(paramAnonymousIntent);
    ...
    a("wechat.shell.RECOVERY_LAUNCH_UI", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.b(paramAnonymousIntent, ((com.tencent.mm.hellhoundlib.b.a)localObject).aYi(), "com/tencent/mm/console/Shell$25", "exec", "(Landroid/content/Intent;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
        paramAnonymousIntent.startActivity((Intent)((com.tencent.mm.hellhoundlib.b.a)localObject).sb(0));
        com.tencent.mm.hellhoundlib.a.a.c(paramAnonymousIntent, "com/tencent/mm/console/Shell$25", "exec", "(Landroid/content/Intent;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
        AppMethodBeat.o(231958);
      }
    }, true);
    ...
    a("wechat.shell.RECOVERY_EXERCISE_START", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        paramAnonymousIntent = paramAnonymousIntent.getStringExtra("entry");
        Log.i("MicroMsg.Shell", "#RECOVERY_EXERCISE, entry = ".concat(String.valueOf(paramAnonymousIntent)));
        Toast.makeText(MMApplicationContext.getContext(), "开启 Recovery 演练: ".concat(String.valueOf(paramAnonymousIntent)), 1).show();
        MMApplicationContext.getContext();
        AppMethodBeat.o(231976);
      }
    }, true);
    a("wechat.shell.RECOVERY_EXERCISE_START_TIMER", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        paramAnonymousIntent = paramAnonymousIntent.getStringExtra("entry");
        Log.i("MicroMsg.Shell", "#RECOVERY_EXERCISE_START_TIMER, entry = ".concat(String.valueOf(paramAnonymousIntent)));
        Toast.makeText(MMApplicationContext.getContext(), "开启 Recovery 演练: ".concat(String.valueOf(paramAnonymousIntent)), 1).show();
        MMApplicationContext.getContext();
        AppMethodBeat.o(231974);
      }
    }, true);
    a("wechat.shell.RECOVERY_EXERCISE_SET_TIMER_RATIO", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        int i = paramAnonymousIntent.getIntExtra("ratio", -1);
        if ((i <= 0) || (i > 10))
        {
          Toast.makeText(MMApplicationContext.getContext(), "Timer ratio should be [1, 10], actual: ".concat(String.valueOf(i)), 1).show();
          AppMethodBeat.o(231969);
          return;
        }
        Log.i("MicroMsg.Shell", "#RECOVERY_EXERCISE_SET_TIMER_RATIO, ratio = ".concat(String.valueOf(i)));
        Toast.makeText(MMApplicationContext.getContext(), "设置 Recovery 演练 Timer Ratio: ".concat(String.valueOf(i)), 1).show();
        MMApplicationContext.getContext();
        AppMethodBeat.o(231969);
      }
    }, true);
    a("wechat.shell.THREAD_HOOK", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        com.tencent.mm.plugin.performance.a.a.MIk.aRq("<cmd><diagnostic><PthreadHook enable='1' source='push' multiprocess='0' duration='24' hook='.*\\.so$' force='1' thread='.*'/></diagnostic></cmd>");
    ...
    a("wechat.shell.THREAD_DUMP", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        com.tencent.mm.plugin.performance.a.a.MIk.aRq("<cmd><diagnostic><report><pthread/></report></diagnostic></cmd>");
        Toast.makeText(MMApplicationContext.getContext(), "PthreadHook report", 1).show();
        AppMethodBeat.o(231970);
      }
    }, true);
    a("wechat.shell.FINDER_SHELL", new Shell.26(), true);
    a("wechat.shell.WATCH_MEM", new Shell.27(), true);
    a("wechat.shell.TRIM_MEM", new Shell.28(), true);
    a("wechat.shell.WATCH_PROC", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        AppMethodBeat.i(231966);
        Log.d("MicroMsg.ProcessWatchDog", "DumpProcesses: %s", new Object[] { Arrays.toString(com.tencent.mm.plugin.performance.watchdogs.e.gzB().gzC().toArray()) });
    ...
    a local31 = new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        com.tencent.mm.plugin.appbrand.debugger.f localf = (com.tencent.mm.plugin.appbrand.debugger.f)com.tencent.mm.kernel.h.ax(com.tencent.mm.plugin.appbrand.debugger.f.class);
        MMApplicationContext.getContext();
        localf.Yc(paramAnonymousIntent);
        AppMethodBeat.o(231924);
      }
    };
    a("wechat.shell.OpenWeApp", local31, true);
    a("wechat.shell.KillWeApp", local31, true);
    a("wechat.shell.FINDER_VIDEO_TEST", new Shell.32(), true);
    a("wechat.shell.EXPT_TEST", new Shell.33(), true);
    a("wechat.shell.DUMP_MAPS", new b()
    {
      ...
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        //   108: astore_1
        //   109: new 90	com/tencent/mm/vfs/u
        //   112: dup
        //   113: new 92	java/lang/StringBuilder
        //   116: dup
        //   117: invokespecial 93	java/lang/StringBuilder:<init>	()V
        //   120: invokestatic 98	com/tencent/mm/loader/i/b:bmz	()Ljava/lang/String;
        ...
        //   134: invokespecial 110	com/tencent/mm/vfs/u:<init>	(Ljava/lang/String;)V
        //   137: astore_2
        //   138: aload_2
        //   139: invokevirtual 113	com/tencent/mm/vfs/u:jKS	()Z
        //   142: ifne +8 -> 150
        //   145: aload_2
        //   146: invokevirtual 116	com/tencent/mm/vfs/u:jKY	()Z
        //   149: pop
        //   150: ldc 118
        //   152: iconst_2
    ...
    a("wechat.shell.WATCH_FD", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        com.tencent.mm.plugin.performance.watchdogs.b.gzp().run();
        AppMethodBeat.o(231956);
      }
    }, true);
    a("wechat.shell.DISABLE_ACTIVITY_NOTIFIER", new Shell.41(), true);
    a("wechat.shell.WATCH_THREAD", new Shell.42(), true);
    a("wechat.shell.CLASSLOADER_DUMP", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
    ...
    a("wechat.shell.LIVE_STREAM_LOCAL_VIDEO", new a()
    {
      public final void v(Intent paramAnonymousIntent)
      {
        ...
        paramAnonymousIntent = paramAnonymousIntent.getStringExtra("video_path");
        Toast.makeText(MMApplicationContext.getContext(), "开启 直播本地推流: ".concat(String.valueOf(paramAnonymousIntent)), 1).show();
        ((com.tencent.d.a.a.a.b)com.tencent.mm.kernel.h.az(com.tencent.d.a.a.a.b.class)).enableLocalPushStream(paramAnonymousIntent);
        AppMethodBeat.o(231954);
      }
    }, true);
    maq = new Runnable()
  ...
  private static void a(String paramString, a parama, boolean paramBoolean)
  {
    ...
    {
      mao.addAction(paramString);
      man.put(paramString, parama);
    }
    AppMethodBeat.o(231943);
  }
  ...
  public final void init(Context paramContext)
  {
    ...
    if (this.mam == null)
    {
      this.mam = new Receiver();
      localReceiver = this.mam;
      localIntentFilter = mao;
    ...
    extends BroadcastReceiver
  {
    public void onReceive(Context paramContext, Intent paramIntent)
    {
      ...
      Shell.a locala = (Shell.a)Shell.aRF().get(paramContext);
      if (locala == null)
      {
  ...
  {
    public abstract void v(Intent paramIntent);
  }
