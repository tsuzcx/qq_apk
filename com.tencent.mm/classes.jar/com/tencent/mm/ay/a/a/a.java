...
{
  public static Executor bmt()
  {
    AppMethodBeat.i(182800);
    b localb = h.ZvG.bDi("image_loader_ImageTempFile");
    AppMethodBeat.o(182800);
    return localb;
  }
  
  public static j wv(int paramInt)
  {
    AppMethodBeat.i(182799);
    a locala = new a("image_loader_default", paramInt, paramInt, new com.tencent.mm.ay.a.e.a());
    ...
    implements j
  {
    ...
    private Condition kQq;
    private BlockingQueue<Runnable> kQr;
    ...
    public a(String paramString, int paramInt1, int paramInt2, BlockingQueue<Runnable> paramBlockingQueue)
    {
      ...
      this.kQq = this.kQp.newCondition();
      this.kQr = paramBlockingQueue;
    ...
    public final void beforeExecute(java.lang.Thread paramThread, Runnable paramRunnable)
    {
      ...
      //   11: aload_0
      //   12: getfield 37	com/tencent/mm/ay/a/a/a$a:kQp	Ljava/util/concurrent/locks/ReentrantLock;
      //   15: invokevirtual 70	java/util/concurrent/locks/ReentrantLock:lock	()V
      //   18: aload_0
      //   19: getfield 55	com/tencent/mm/ay/a/a/a$a:isPaused	Z
      //   22: ifeq +51 -> 73
      //   25: aload_0
      //   26: getfield 43	com/tencent/mm/ay/a/a/a$a:kQq	Ljava/util/concurrent/locks/Condition;
      ...
      //   60: aload_0
      //   61: getfield 37	com/tencent/mm/ay/a/a/a$a:kQp	Ljava/util/concurrent/locks/ReentrantLock;
      ...
      //   72: return
      //   73: aload_0
      //   74: getfield 37	com/tencent/mm/ay/a/a/a$a:kQp	Ljava/util/concurrent/locks/ReentrantLock;
      ...
      //   86: astore_1
      //   87: aload_0
      //   88: getfield 37	com/tencent/mm/ay/a/a/a$a:kQp	Ljava/util/concurrent/locks/ReentrantLock;
 ...
 * Qualified Name:     com.tencent.mm.ay.a.a.a
