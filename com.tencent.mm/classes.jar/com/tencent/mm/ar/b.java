  ...
  extends at
{
  ...
  public final void uP(int paramInt)
  {
    ...
    if (uQ(paramInt))
    {
      ...
      com.tencent.mm.plugin.report.service.h.IzE.idkeyStat(336L, 0L, 1L, true);
      bh.beI();
      ...
      {
        com.tencent.mm.plugin.report.service.h.IzE.idkeyStat(336L, 1L, 1L, true);
      ...
      com.tencent.mm.plugin.report.service.h.IzE.idkeyStat(336L, 2L, 1L, true);
    }
    for (;;)
    {
      ...
      return;
      label628:
      com.tencent.mm.plugin.report.service.h.IzE.idkeyStat(336L, 3L, 1L, true);
    }
  }
