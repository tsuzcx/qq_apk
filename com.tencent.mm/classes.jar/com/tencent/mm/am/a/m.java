  ...
  implements k
{
  ...
  public m(String paramString1, String paramString2, int paramInt)
  {
    ...
    ((b.a)localObject).hNM = new ne();
    ((b.a)localObject).hNN = new nf();
    ((b.a)localObject).uri = "/cgi-bin/mmocbiz-bin/bizchatsearchcontact";
    ((b.a)localObject).funcId = 1364;
    ((b.a)localObject).hNO = 0;
    ((b.a)localObject).respCmdId = 0;
    this.rr = ((b.a)localObject).aDC();
    localObject = (ne)this.rr.hNK.hNQ;
    ((ne)localObject).FHb = paramString1;
    ((ne)localObject).dld = paramString2;
    ((ne)localObject).offset = paramInt;
    this.data = null;
