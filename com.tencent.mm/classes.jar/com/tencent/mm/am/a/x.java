  ...
  implements k
{
  ...
  public x(String paramString, md parammd, Object paramObject)
  {
    AppMethodBeat.i(124325);
    Object localObject = new b.a();
    ((b.a)localObject).gUU = new dfq();
    ((b.a)localObject).gUV = new dfr();
    ((b.a)localObject).uri = "/cgi-bin/mmocbiz-bin/updatebizchat";
    ((b.a)localObject).funcId = 1356;
    ((b.a)localObject).reqCmdId = 0;
    ((b.a)localObject).respCmdId = 0;
    this.rr = ((b.a)localObject).atI();
    localObject = (dfq)this.rr.gUS.gUX;
    ((dfq)localObject).CIQ = paramString;
    ((dfq)localObject).DnW = parammd;
