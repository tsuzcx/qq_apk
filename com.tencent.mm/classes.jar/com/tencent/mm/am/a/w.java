  ...
  implements k
{
  ...
  public w(String paramString1, String paramString2, int paramInt)
  {
    ...
    ((b.a)localObject).hNM = new cqa();
    ((b.a)localObject).hNN = new cqb();
    ((b.a)localObject).uri = "/cgi-bin/mmocbiz-bin/qymsgstatenotify";
    ((b.a)localObject).funcId = 1361;
    ((b.a)localObject).hNO = 0;
    ((b.a)localObject).respCmdId = 0;
    this.rr = ((b.a)localObject).aDC();
    localObject = (cqa)this.rr.hNK.hNQ;
    ((cqa)localObject).FHb = paramString1;
    ((cqa)localObject).FGU = paramString2;
    ((cqa)localObject).time_stamp = paramInt;
