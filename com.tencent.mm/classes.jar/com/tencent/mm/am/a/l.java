  ...
  extends j<k>
{
  ...
  public e db;
  final com.tencent.mm.sdk.e.l<l.a, a.b> gWR;
  Map<String, String> gYH;
  ...
  public l(e parame)
  {
    ...
    this.gWR = new com.tencent.mm.sdk.e.l() {};
    this.db = parame;
  ...
  public final boolean b(k paramk)
  {
    ...
    for (;;)
    {
      ...
      AppMethodBeat.o(124284);
      return bool;
      paramk.field_userNamePY = com.tencent.mm.platformtools.f.Br(paramk.field_userName);
    }
  }
  ...
  public final void c(k paramk)
  {
    ...
    k localk = ea(paramk.field_userId);
    if (localk != null)
    {
  ...
  public final k ea(String paramString)
  {
  ...
  public final String eb(String paramString)
  {
    ...
    {
      paramString = (String)this.gYH.get(paramString);
      AppMethodBeat.o(124287);
      return paramString;
    }
    f localf = af.awj().xt(paramString);
    if (localf != null)
    {
      ...
      this.gYH.put(paramString, localf.field_userId);
  ...
  public final int xv(String paramString)
  {
  ...
  public final k xw(String paramString)
  {
