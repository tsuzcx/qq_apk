  ...
  extends MStorage
{
  ...
  private boolean c(j paramj)
  {
    ...
    if ((paramj != null) && (paramj.getUsername() != null))
    {
      ...
      paramj.lBc = ((int)(System.currentTimeMillis() / 1000L));
      paramj.bhJ();
      paramj.cUP = -1;
      ContentValues localContentValues = paramj.bhE();
      if ((int)this.lvy.insert("img_flag", "username", localContentValues) < 0) {
        break label99;
      }
    }
    label99:
  ...
  private boolean d(j paramj)
  {
    ...
    if ((paramj != null) && (paramj.getUsername() != null))
    {
      ...
      paramj.cUP |= 0x4;
      ContentValues localContentValues = paramj.bhE();
      if (this.lvy.update("img_flag", localContentValues, "username=?", new String[] { paramj.getUsername() }) <= 0) {
        break label123;
      }
    }
    label123:
  ...
  public final j TS(String paramString)
  {
    AppMethodBeat.i(150288);
    Object localObject = (j)this.lBh.aX(paramString);
    ...
    Cursor localCursor = this.lvy.rawQuery((String)localObject, null, 2);
    if (localCursor == null)
    {
      AppMethodBeat.o(150288);
      return null;
    ...
    {
      localCursor.close();
      this.lBh.q(paramString, localObject);
      AppMethodBeat.o(150288);
      return localObject;
      localObject = null;
    }
  ...
  public final void TT(String paramString)
  {
    ...
    this.lBh.remove(paramString);
    this.lvy.delete("img_flag", "username=?", new String[] { String.valueOf(paramString) });
    AppMethodBeat.o(150293);
  }
  ...
  public final boolean b(j paramj)
  {
    ...
    Log.i("MicroMsg.ImgFlagStorage", "new smallImageUrl = %s, bigImageUrl = %s", new Object[] { paramj.bhI(), paramj.bhH() });
    j localj = TS(paramj.getUsername());
    if (localj == null)
    {
      this.lBh.q(paramj.getUsername(), paramj);
      bool = c(paramj);
      AppMethodBeat.o(150289);
      return bool;
    }
    Log.i("MicroMsg.ImgFlagStorage", "old, smallImageUrl = %s, bigImageUrl = %s", new Object[] { localj.bhI(), localj.bhH() });
    this.lBh.remove(paramj.getUsername());
