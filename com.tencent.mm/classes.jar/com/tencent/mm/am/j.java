...
{
  public static String gXo = "menu_click";
  public static String gXp = "menu_action_start";
  public static String gXq = "menu_action_success";
  public String content;
  public String dDM;
  public List<j> gXr = null;
  public int gXs;
  public int id;
  public String key;
  public String name;
    ...
    if (paramJSONArray != null) {
      try
      {
        ...
        for (;;)
        {
          ...
          localj.dDM = ((JSONObject)localObject).optString("native_url");
          ad.d("MicroMsg.BizMenuItem", "menuItem.nativeurl : " + localj.dDM);
          localj.gXr = e(((JSONObject)localObject).optJSONArray("sub_button_list"));
          localj.gXs = ((JSONObject)localObject).optInt("acttype");
      ...
      {
        ad.e("MicroMsg.BizMenuItem", "exception:%s", new Object[] { bt.m(paramJSONArray) });
  ...
  public static LinkedList<j> v(Map<String, String> paramMap)
  {
    ...
    if (j > 0) {
      try
      {
        ...
        if (i < j)
        {
          ...
          {
            str = str;
            localj.id = bt.getInt((String)paramMap.get(str + ".id"), 0);
            localj.type = bt.getInt((String)paramMap.get(str + ".type"), 0);
            localj.name = ((String)paramMap.get(str + ".name"));
            localj.key = ((String)paramMap.get(str + ".key"));
            localj.value = ((String)paramMap.get(str + ".value"));
            localj.gXs = bt.getInt((String)paramMap.get(str + ".acttype"), 0);
      ...
      {
        ad.e("MicroMsg.BizMenuItem", "exception:%s", new Object[] { bt.m(paramMap) });
        AppMethodBeat.o(116433);
        return null;
      }
    }
  ...
  public final String getInfo()
  {
    ...
    label97:
    for (this.state = gXp;; this.state = gXo)
    {
  ...
  public final void l(ArrayList<String> paramArrayList)
  {
