  ...
  extends com.tencent.mm.sdk.e.j<h>
{
  ...
  private boolean b(h paramh)
  {
    ...
    if ((paramh == null) || (bt.isNullOrNil(paramh.field_openId)) || (bt.isNullOrNil(paramh.field_brandUsername)))
    {
    ...
    if (this.db.replace("BizKF", h.info.IhB, localContentValues) > 0L) {}
    for (boolean bool = true;; bool = false)
    {
      ad.i("MicroMsg.BizKFStorage", "replace: openId=%s, brandUsername=%s, ret=%s ", new Object[] { paramh.field_openId, paramh.field_brandUsername, Boolean.valueOf(bool) });
      AppMethodBeat.o(124080);
      return bool;
    }
  }
  
  public final h DW(String paramString)
  {
  ...
  public final h DX(String paramString)
  {
  ...
  public final int f(LinkedList<h> paramLinkedList)
  {
    ...
    for (long l = ((com.tencent.mm.storagebase.h)this.db).xO(Thread.currentThread().getId());; l = 0L)
    {
