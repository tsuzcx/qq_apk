  ...
  implements e
{
  public final e.b b(e.a parama)
  {
    ...
    {
      ae.f("MicroMsg.UpdatePackageMsgExtension", "[oneliang]UpdatePackageMsgExtension failed, invalid cmdAM");
      AppMethodBeat.o(150190);
      return null;
    }
    ae.i("MicroMsg.UpdatePackageMsgExtension", "[oneliang]UpdatePackageMsgExtension start");
      ...
      try
      {
        ...
        if ((parama != null) && (parama.getLength() == 1))
        {
          ...
          if (i < j)
          {
            ...
            localObject = new l(bu.getInt(((Node)localObject).getNodeValue(), 0));
            g.ajQ().gDv.a((n)localObject, 0);
            break label290;
          }
        }
        ae.i("MicroMsg.UpdatePackageMsgExtension", "[oneliang]UpdatePackageMsgExtension end");
        AppMethodBeat.o(150190);
        return null;
      }
      catch (Exception parama)
      {
        ae.e("MicroMsg.UpdatePackageMsgExtension", "exception:%s", new Object[] { bu.o(parama) });
        AppMethodBeat.o(150190);
        return null;
      }
      label290:
