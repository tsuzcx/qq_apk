...
public final class bi
{
  public static SharedPreferences aVK()
  {
    ...
    {
      e.Cxv.idkeyStat(148L, 12L, 1L, true);
      Object localObject = new an(ar.NSe + "autoauth.cfg");
      if ((!((an)localObject).NRI) && (((an)localObject).get(3) != null))
      {
        ...
        e.Cxv.idkeyStat(148L, 51L, 1L, true);
        AppMethodBeat.o(132249);
        return localSharedPreferences;
      }
      localObject = MMApplicationContext.getContext().getSharedPreferences("auto_auth_key_prefs", g.aps());
      ...
      localEditor.putString("server_id", MMApplicationContext.getContext().getSharedPreferences("server_id_prefs", g.aps()).getString("server_id", ""));
