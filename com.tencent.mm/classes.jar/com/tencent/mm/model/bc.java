...
public final class bc
{
  public static SharedPreferences aBV()
  {
    ...
    {
      e.ygI.idkeyStat(148L, 12L, 1L, true);
      Object localObject = new ah(al.IpN + "autoauth.cfg");
      if ((!((ah)localObject).Ipr) && (((ah)localObject).get(3) != null))
      {
        localEditor = localSharedPreferences.edit();
        localEditor.putBoolean("key_auth_info_prefs_created", true);
        localEditor.putInt("key_auth_update_version", ((Integer)((ah)localObject).get(1)).intValue());
        localEditor.putInt("_auth_uin", ((Integer)((ah)localObject).get(2)).intValue());
        localEditor.putString("_auth_key", (String)((ah)localObject).get(3));
        localEditor.putString("server_id", (String)((ah)localObject).get(4));
        ...
        e.ygI.idkeyStat(148L, 51L, 1L, true);
        AppMethodBeat.o(132249);
        return localSharedPreferences;
      }
      localObject = aj.getContext().getSharedPreferences("auto_auth_key_prefs", g.abm());
      ...
      localEditor.putString("server_id", aj.getContext().getSharedPreferences("server_id_prefs", g.abm()).getString("server_id", ""));
    ...
    for (;;)
    {
      ...
      return localSharedPreferences;
      label525:
      ad.i("MicroMsg.MMReqRespAuthComm", "summerauth auth_info_key_prefs not exit! neither autoauthcfg nor oldAAKsp existed just install! stack[%s]", new Object[] { bt.flS() });
    }
  }
}
