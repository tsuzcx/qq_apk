...
{
  public static ch iFO;
  private SharedPreferences iFA;
  private SharedPreferences iFP;
  ...
  private ch()
  {
    ...
    this.iFA = MMApplicationContext.getContext().getSharedPreferences(MMApplicationContext.getDefaultPreferencePath() + "_account_history", 0);
    this.iFP = MMApplicationContext.getContext().getSharedPreferences(MMApplicationContext.getDefaultPreferencePath() + "_account_switch", 0);
  ...
  private void KK(String paramString)
  {
    ...
    try
    {
      s.deleteFile(getString(paramString, "last_avatar_path"));
      this.iFA.edit().remove(paramString).commit();
  ...
  public final void KH(String paramString)
  {
    ...
    if (KI(paramString))
    {
      Set localSet = this.iFP.getStringSet("first_switch_group", null);
      if (localSet != null)
      {
        localSet.remove(paramString);
        SharedPreferences.Editor localEditor = this.iFP.edit();
  ...
  public final boolean KJ(String paramString)
  {
    ...
    boolean bool = this.iFA.contains(paramString);
  ...
  public final void aR(String paramString1, String paramString2)
  {
    ...
    Object localObject = this.iFP.getStringSet("first_switch_group", null);
    if (localObject == null) {
  ...
  public final void l(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        if (this.iFA.contains(paramString1))
        {
          localObject = this.iFA.getString(paramString1, "");
          if (!Util.isNullOrNil((String)localObject))
          {
            localObject = new JSONObject(new String(Base64.decode((String)localObject, 0)));
            if (!Util.isNullOrNil(new String[] { paramString2, paramString3 }))
            {
              ...
              this.iFA.edit().putString(paramString1, Base64.encodeToString(((JSONObject)localObject).toString().getBytes(), 0)).commit();
            }
