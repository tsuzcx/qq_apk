...
public final class bw
{
  ...
  public final Cursor a(String paramString1, String paramString2, List<String> paramList1, boolean paramBoolean, int paramInt, List<String> paramList2)
  {
    ...
    paramString2 = (String)localObject + this.hKP.f(paramString2, null, paramList1) + this.hKP.aUT(paramString1) + this.hKP.aFL();
    ae.v("Micro.SimpleSearchConversationModel", paramString2);
