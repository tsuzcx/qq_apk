...
public final class c
{
  ...
  final void uA(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localObject3 != null) && (((Node)localObject3).getNodeName() != null) && (((Node)localObject3).getNodeName().equals("testpoint")))
        {
          ...
          if (localObject4 != null)
          {
            ...
            if (localObject4 != null)
            {
              ...
              ((e)localObject2).gPO = ((String)localObject4);
            }
          }
          ...
          ((b)localObject1).gPL.put(localObject3, localObject2);
        }
        else if ((localObject3 != null) && (((Node)localObject3).getNodeName() != null) && (((Node)localObject3).getNodeName().equals("verifymd5")))
        {
          ...
          ((b)localObject1).fMu = ((String)localObject2);
        }
      }
      ...
      if ((localObject3 != null) && (((Node)localObject3).getNodeName() != null) && (((Node)localObject3).getNodeName().equals("testcaseid")))
      {
        ...
        ((b)localObject1).gPI = ((String)localObject2);
      }
      else if ((localObject3 != null) && (((Node)localObject3).getNodeName() != null) && (((Node)localObject3).getNodeName().equals("starttime")))
      {
        ...
        ((b)localObject1).gPJ = ((String)localObject2);
      }
      else if ((localObject3 != null) && (((Node)localObject3).getNodeName() != null) && (((Node)localObject3).getNodeName().equals("endtime")))
      {
        ...
        ((b)localObject1).gPK = ((String)localObject2);
        break label695;
        label647:
        if ((!bt.isNullOrNil(((b)localObject1).gPI)) && ("0".equals(((b)localObject1).gPI)))
        {
          this.gPN = ((b)localObject1);
          break label702;
        }
        this.gPM = ((b)localObject1);
        break label702;
        label689:
        AppMethodBeat.o(153091);
        return;
  ...
  public final e uz(String paramString)
  {
    ...
    e locale1 = null;
    if (this.gPM != null) {
      locale1 = this.gPM.uz(paramString);
    }
    e locale2 = locale1;
    if (locale1 == null)
    {
      locale2 = locale1;
      if (this.gPN != null) {
        locale2 = this.gPN.uz(paramString);
      }
    }
