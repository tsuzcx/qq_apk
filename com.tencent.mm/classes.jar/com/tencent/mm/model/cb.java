...
public final class cb
{
  ...
  public cb(ISQLiteDatabase paramISQLiteDatabase, bw parambw)
  {
    this.db = paramISQLiteDatabase;
    this.iFE = parambw;
  }
  
  private String KF(String paramString)
  {
    AppMethodBeat.i(20392);
    Object localObject1 = new ArrayList();
    String str = "select username from rcontact where (username like '%" + paramString + "%' or nickname like '%" + paramString + "%' or alias like '%" + paramString + "%' or pyInitial like '%" + paramString + "%' or quanPin like '%" + paramString + "%' or conRemark like '%" + paramString + "%' )and username not like '%@%' and type & " + c.aru() + "=0 ";
  ...
  public final Cursor a(String paramString1, List<String> paramList, String paramString2)
  {
    ...
    if (paramString2 != null)
    {
      paramString1 = paramList;
      if (paramString2.length() > 0) {
        paramString1 = paramList + KF(paramString2);
      }
    }
