...
public final class g
{
  ...
  public static boolean a(int paramInt1, int paramInt2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      qI(7L);
      continue;
      if ((bt.cC(paramArrayOfByte1)) || (paramArrayOfByte1.length <= 8))
      {
        ...
        else
        {
          ...
          try
          {
            ...
            if (paramArrayOfByte1.value != 0)
            {
              ...
              paramArrayOfByte2.dvB.dvC = paramArrayOfByte1.value;
            ...
            if ((localPInt3.value == 13) && (com.tencent.mm.network.ad.aPm() != null) && (com.tencent.mm.network.ad.aPm().iEM != null))
            {
              paramArrayOfByte2 = com.tencent.mm.network.ad.aPm().iEM.mO(3);
          ...
          while (paramArrayOfByte1.value != 0)
          {
            paramArrayOfByte2 = new iw();
            paramArrayOfByte2.dvB.dvC = paramArrayOfByte1.value;
            bool1 = com.tencent.mm.sdk.b.a.IbL.l(paramArrayOfByte2);
            ...
            paramArrayOfByte2 = bt.aRa(aj.getContext().getSharedPreferences("notify_sync_pref", com.tencent.mm.compatible.util.g.abm()).getString("notify_sync_key_keybuf", ""));
            arrayOfByte = z.a(localb.Foy.FRr);
            if ((bt.cC(arrayOfByte)) || (!com.tencent.mm.protocal.ad.l(paramArrayOfByte2, arrayOfByte)))
            {
              com.tencent.mm.sdk.platformtools.ad.e("MicroMsg.NotifySyncMgr", "compareKeybuf syncKey failed");
              break;
            }
            new com.tencent.mm.modelmulti.b(localb, i, paramLong).doScene(com.tencent.mm.network.ad.aPm(), new g.1());
          }
  ...
  public static byte[] a(PInt paramPInt, int paramInt)
  {
    ...
    while (i <= j)
    {
      ...
      {
        Object localObject2 = i.aY((String)localObject3, 0, -1);
        ...
        if (bt.cC((byte[])localObject2))
        {
          ...
          localObject1 = i.aY((String)localObject3, 0, -1);
        }
        ...
        com.tencent.mm.sdk.platformtools.ad.i("MicroMsg.NotifySyncMgr", "readFile, index:[%d of %d], dump data:%s -> %s, key:%s", new Object[] { Integer.valueOf(i), Integer.valueOf(j), N((byte[])localObject1), N((byte[])localObject3), N(((String)localObject2).getBytes()) });
  ...
  public static String kM(int paramInt)
  {
    AppMethodBeat.i(131935);
    String str = e.mP(paramInt) + "pushSyncResp";
    i.aYg(str);
    AppMethodBeat.o(131935);
    return str;
  }
  
  private static void qI(long paramLong)
  {
    ...
    {
      localObject = new vc();
      ((vc)localObject).dJn.sourceType = 4;
    ...
    if ((0xFEFFFFFF & paramLong & 0xFFFFFFDF & 0xFFFFFEFF & 0xFFDFFFFF & 0x2) != 0L) {
      new com.tencent.mm.modelmulti.b().doScene(com.tencent.mm.network.ad.aPm(), new g.2());
    }
  ...
  public static int uf(String paramString)
  {
    ...
    paramString = i.aY(paramString + "/syncResp.ini", 0, -1);
