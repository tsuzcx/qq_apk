...
{
  private static b fDP = null;
  private t fDN;
  private f fDO;
  private boolean fDQ;
  private a fDR;
  private final ah.b fDS;
  private int fDT;
  private int fDU;
  private long fDV;
  private long fDW;
  ...
  public CoreService()
  {
    ...
    this.fEa = new av(new av.a()
    {
      public final boolean onTimerExpired()
      {
        ...
        int i;
        if (bt.aO(localq.iNn) < localq.iNl)
        {
          com.tencent.mm.sdk.platformtools.ad.i("MicroMsg.FrequncyLimiter", "frequency limited, last=" + localq.iNn + ", cur=" + bt.HI() + ", retries=" + localq.iNo);
          if (localq.iNo <= 0)
          {
            i = 0;
            if (i != 0) {
        ...
        for (;;)
        {
          com.tencent.mm.sdk.platformtools.ad.i("MicroMsg.CoreService", "setNetworkAvailable finish lockCount:%d delayCount:%d delayDur:%d", new Object[] { Long.valueOf(CoreService.c(CoreService.this)), Long.valueOf(CoreService.d(CoreService.this)), Long.valueOf(bt.flT() - CoreService.e(CoreService.this)) });
          ...
          return true;
          for (localq.iNo -= 1;; localq.iNo = localq.iNm)
          {
            localq.iNn = bt.HI();
            i = 1;
            break;
          ...
          label249:
          boolean bool1 = CoreService.b(CoreService.this).iEM.aEW();
          boolean bool2 = com.tencent.mm.network.ad.aPm().aOP();
          ...
          if ((bool1) && (!bool2) && (g.a(1, 0, null, CoreService.b(CoreService.this).iEM.mO(1), bt.flT())))
          {
  ...
  public static void Ww()
  {
    ...
    localIntent.putExtra("notify_uin", com.tencent.mm.network.ad.aPm().iEM.getUin());
    long l = Wy();
    ...
    try
    {
      ...
      if (bt.lQ(com.tencent.mm.plugin.expt.h.d.crP().b("clicfg_android_receive_msg_use_mmservice_switch", "0", false, true), "1"))
      {
        localIntent.setClass(com.tencent.mm.network.ad.getContext(), NotifyReceiver.NotifyReceiverService.class);
        localIntent.putExtra("notfiy_recv_time", bt.flT());
        com.tencent.mm.service.c.a(localIntent, "mm", true, new Intent(com.tencent.mm.sdk.platformtools.aj.getContext(), ProcessService.MMProcessService.class));
        e.ygI.idkeyStat(1042L, 62L, 1L, false);
      }
  ...
  private void Wx()
  {
    ...
    com.tencent.mm.network.ad.aPn().m(3, 10000, "");
    Mars.onDestroy();
    try
    {
      ...
      com.tencent.mm.hellhoundlib.a.a.a(localObject, locala.ahp(), "com/tencent/mm/booter/CoreService", "doExit", "()V", "android/os/Process_EXEC_", "killProcess", "(I)V");
  ...
  private static long Wy()
  {
    ...
    ax localax = ax.aQz("msg_receive_number");
  ...
  public static void Wz()
  {
    ...
    if (l3 > 0L)
    {
      ...
      e.ygI.f(19779, new Object[] { Long.valueOf(l1), Long.valueOf(l2), Long.valueOf(l3) });
  ...
  public static long qF(long paramLong)
  {
  ...
  public final void cx(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      com.tencent.mm.network.ad.aPi().iGv = false;
      com.tencent.mm.network.ad.aPj().qH(0);
      if (this.fDQ)
      {
        com.tencent.mm.network.ad.aPm().aOI();
        f localf = this.fDO;
        localf.fEn = null;
        localf.fEp = "";
        localf.fEo = "";
    ...
    com.tencent.mm.network.ad.aPi().iGv = true;
    paramBoolean = this.fDO.WG();
    com.tencent.mm.sdk.platformtools.ad.i("MicroMsg.CoreService", "lastConnected %s, isNetWorkChange %s", new Object[] { Boolean.valueOf(this.fDQ), Boolean.valueOf(paramBoolean) });
    if ((this.fDQ) && (!paramBoolean))
    {
    ...
    this.fDQ = true;
    com.tencent.mm.network.ad.aPj().qH(6);
    if (this.fDY == null) {
      this.fDY = new WakerLock(getApplicationContext(), "MicroMsg.CoreService");
    }
    if (!this.fDY.isLocking())
    {
      this.fDY.lock(6000L, "CoreService.setNetworkAvailable");
      this.fDV += 1L;
    }
    if (0L == this.fDX) {
      this.fDW = bt.flT();
    ...
    this.fDX += 1L;
    com.tencent.mm.sdk.platformtools.ad.i("MicroMsg.CoreService", "setNetworkAvailable start lockCount:%d delayCount:%d delayDur:%d", new Object[] { Long.valueOf(this.fDV), Long.valueOf(this.fDX), Long.valueOf(bt.flT() - this.fDW) });
    this.fEa.az(3000L, 3000L);
    AppMethodBeat.o(131853);
  }
  ...
  public final boolean f(int paramInt, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      boolean bool1 = com.tencent.mm.network.ad.aPf().getBoolean("is_in_notify_mode", false);
      boolean bool2 = this.fDN.iEM.aEW();
      boolean bool3 = com.tencent.mm.network.ad.aPm().aOP();
      if ((bool1) && (bool2) && (!bool3) && (g.a(2, paramInt, paramArrayOfByte, this.fDN.iEM.mO(1), bt.flT())))
      {
      ...
      localIntent.putExtra("notify_uin", this.fDN.iEM.getUin());
      localIntent.putExtra("notify_respType", paramInt);
      localIntent.putExtra("notify_respBuf", paramArrayOfByte);
      localIntent.putExtra("notify_skey", this.fDN.iEM.mO(1));
      ...
      try
      {
        ...
        e.ygI.idkeyStat(1042L, 60L, 1L, false);
      ...
      catch (Throwable paramArrayOfByte)
      {
        for (;;)
        {
          com.tencent.mm.sdk.platformtools.ad.e("MicroMsg.CoreService", "dknot sendBroadcast  failed:%s", new Object[] { bt.n(paramArrayOfByte) });
        }
      }
    }
  }
  ...
  public IBinder onBind(Intent paramIntent)
  {
    ...
    int i = Process.myPid();
    com.tencent.mm.sdk.platformtools.ad.d("MicroMsg.CoreService", "onBind~~~ lastpid:%d  pid:%d threadID:" + Thread.currentThread(), new Object[] { Integer.valueOf(this.fDU), Integer.valueOf(i) });
    if (i != this.fDU)
    {
      this.fDU = i;
      e.ygI.idkeyStat(99L, 147L, 1L, false);
      if ((paramIntent != null) && ("auto".equals(paramIntent.getStringExtra("START_TYPE")))) {
        e.ygI.idkeyStat(99L, 146L, 1L, false);
      }
      i = (int)(SystemClock.elapsedRealtime() - j.ajI());
  ...
  public void onCreate()
  {
    ...
    try
    {
      this.fDR = ((a)Class.forName("com.tencent.mm.platformtools.BroadcastHelper").newInstance());
      com.tencent.mm.sdk.platformtools.ad.d("MicroMsg.CoreService", "broadcastRegisterHelper = %s", new Object[] { this.fDR });
      this.fDR.registerBroadcasts();
      if ((com.tencent.mm.compatible.util.d.lz(26)) && (Build.VERSION.SDK_INT < 24) && (!com.tencent.mm.compatible.util.g.abk()))
      {
      ...
      else
      {
        ...
        this.fDN = com.tencent.mm.network.ad.aPm();
        if (this.fDN != null) {
          break label774;
        }
        com.tencent.mm.sdk.platformtools.ad.i("MicroMsg.CoreService", "autoAuth is null and new one");
        this.fDN = new t(com.tencent.mm.network.ad.aPk());
        com.tencent.mm.network.ad.g(this.fDN);
        Mars.onCreate(true);
        if (com.tencent.mm.network.ad.aPn() != null) {
          break label792;
        }
        ...
        if (com.tencent.mm.network.ad.aPo() == null)
        {
          ...
          com.tencent.mm.network.ad.aPo().iGc = this;
        }
        localObject4 = ((com.tencent.mm.kernel.b.h)com.tencent.mm.kernel.g.ajz().ajb()).fFy;
        localObject1 = localObject4;
        if (localObject4 == null)
        {
          ((com.tencent.mm.kernel.b.h)com.tencent.mm.kernel.g.ajz().ajb()).fFy = d.bJ(getApplicationContext());
          localObject1 = ((com.tencent.mm.kernel.b.h)com.tencent.mm.kernel.g.ajz().ajb()).fFy;
        ...
        if (localObject1 != null)
        {
          ...
          this.fDN.e((String)localObject4, str1, (String)localObject6, str2);
          ...
          localObject6 = this.fDN;
          if ((!bt.isNullOrNil((String)localObject4)) && (!bt.V(new String[0]))) {
            break label809;
          }
        }
        if (localObject1 != null) {
        ...
        this.fDN.setNewDnsDebugHost((String)localObject4, (String)localObject1);
        MMReceivers.AlarmReceiver.bN(getApplicationContext());
    ...
    catch (Exception localException1)
    {
      try
      {
        for (;;)
        {
          ...
          com.tencent.mm.network.ad.aPi().iGv = false;
          com.tencent.mm.network.ad.aPj().qH(0);
          ((PluginZero)com.tencent.mm.kernel.g.ad(PluginZero.class)).Oeq.a(this);
          aq.o(new Runnable()
          {
            public final void run()
            {
              ...
              if (Build.VERSION.SDK_INT > 23) {
                com.tencent.mm.sdk.platformtools.ad.i("MicroMsg.CoreService", "KeepAliveService.scheduleKeepAliveJob() flag:%s", new Object[] { Boolean.valueOf(KeepAliveService.WF()) });
              }
          ...
          continue;
          if (getSharedPreferences("system_config_prefs", com.tencent.mm.compatible.util.g.abm()).getBoolean("set_service", false))
          {
            startForeground(-1213, new Notification());
            ...
            com.tencent.mm.network.ad.aPn().reset();
            continue;
            label809:
  ...
  public void onDestroy()
  {
    ...
    try
    {
      ((PluginZero)com.tencent.mm.kernel.g.ad(PluginZero.class)).Oeq.b(this);
  ...
  public int onStartCommand(Intent paramIntent, int paramInt1, int paramInt2)
  {
    ...
    int i = Process.myPid();
    com.tencent.mm.sdk.platformtools.ad.i("MicroMsg.CoreService", "onStartCommand lastpid:%d  pid:%d flags:%d startId:%d", new Object[] { Integer.valueOf(this.fDT), Integer.valueOf(i), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
    if (i != this.fDT)
    {
      this.fDT = i;
      e.ygI.idkeyStat(99L, 141L, 1L, false);
      if ((paramIntent != null) && ("auto".equals(paramIntent.getStringExtra("START_TYPE")))) {
        e.ygI.idkeyStat(99L, 140L, 1L, false);
      }
    }
  ...
  public boolean onUnbind(Intent paramIntent)
  {
    ...
    com.tencent.mm.network.ad.aPi().iGu = null;
    com.tencent.mm.network.ad.aPp().iFW = null;
  ...
  public void reportIdkey()
  {
    ...
    ax localax = ax.aQz("alarm_crash");
    long l = localax.getLong("report_time", 0L);
    if (cf.aCK() - l > 86400000L)
    {
      localax.edit().putLong("report_time", cf.aCK());
      e.ygI.idkeyStat(1204L, 0L, 1L, false);
    }
