...
public final class b
{
  ...
  public static boolean c(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    if (((!paramString.equals("noop")) || ((i.ETy) && (i.ETx))) && (l.cj(paramContext)))
    {
    ...
    if (c.Tt())
    {
      ...
      ad.i("MicroMsg.CoreServiceUtil", "if_26_num=%s  if_ignore_false=%s  ignore_true=%s", new Object[] { Boolean.valueOf(ax.aFC("service_launch_way").getBoolean("if_26_num", true)), Boolean.valueOf(ax.aFC("service_launch_way").getBoolean("if_ignore_false", true)), Boolean.valueOf(ax.aFC("service_launch_way").getBoolean("ignore_true", false)) });
      if ((d.lf(26)) && (ax.aFC("service_launch_way").getBoolean("if_26_num", true)))
      {
        ax.aFC("service_launch_way").edit().putBoolean("if_26_num", false).commit();
        e.vIY.idkeyStat(954L, 92L, 1L, false);
      }
      if (d.lf(26))
      {
        if (c.bG(paramContext)) {
          break label963;
        }
        if (ax.aFC("service_launch_way").getBoolean("if_ignore_false", true))
        {
          ax.aFC("service_launch_way").edit().putBoolean("if_ignore_false", false).commit();
          e.vIY.idkeyStat(954L, 90L, 1L, false);
          if (ax.aFC("service_launch_way").getBoolean("ignore_true", false)) {
            e.vIY.idkeyStat(954L, 91L, 1L, false);
          }
        }
      }
    }
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (d.lf(26))
          {
            ad.i("MicroMsg.CoreServiceUtil", "ensureServiceInstance() startService crash_not_ignore=%s service_IllegalStateException=%s", new Object[] { Boolean.valueOf(ax.aFC("service_launch_way").getBoolean("crash_not_ignore", false)), Boolean.valueOf(c.bG(paramContext)) });
            if ((ax.aFC("service_launch_way").getBoolean("crash_not_ignore", false)) && (c.bG(paramContext)) && (i == 0))
            {
              ax.aFC("service_launch_way").edit().putBoolean("crash_not_ignore", false);
              e.vIY.idkeyStat(954L, 85L, 1L, false);
            }
          }
          if (j == 0) {
            break;
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            if (d.lf(26))
            {
              ax localax = ax.aFC("service_launch_way");
              boolean bool = c.bG(paramContext);
              if (localax.getBoolean("service_first_crash", true))
              {
                ...
                e.vIY.idkeyStat(954L, 80L, 1L, false);
                if ((localException instanceof IllegalStateException))
                {
                  c.cv(false);
                  localax.edit().putBoolean("service_IllegalStateException", true).commit();
                  e.vIY.idkeyStat(954L, 81L, 1L, false);
                  if (bool)
                  {
                    e.vIY.idkeyStat(954L, 82L, 1L, false);
                    k = 1;
                    j = i;
                    i = k;
                    continue;
                  ...
                  e.vIY.idkeyStat(954L, 83L, 1L, false);
                  k = 1;
                  j = i;
                  i = k;
                  continue;
                }
                e.vIY.idkeyStat(954L, 86L, 1L, false);
                k = 1;
                j = i;
                i = k;
                continue;
              ...
              if ((localException instanceof IllegalStateException))
              {
                ...
                if (!localax.getBoolean("service_IllegalStateException", false))
                {
                  ...
                  localax.edit().putBoolean("service_IllegalStateException", true).commit();
                  e.vIY.idkeyStat(954L, 87L, 1L, false);
                  if (bool)
                  {
                    e.vIY.idkeyStat(954L, 82L, 1L, false);
                    k = 1;
      ...
      label963:
      ax.aFC("service_launch_way").edit().putBoolean("ignore_true", true).commit();
    }
  }
}
