...
public final class f
{
  ...
  private f()
  {
    ...
    this.flE = false;
    this.flF = null;
    this.flG = new ap(Looper.getMainLooper())
    {
      public final void handleMessage(Message paramAnonymousMessage)
      {
        AppMethodBeat.i(20056);
        ad.i("MicroMsg.Notification.Tool.Sound", "play sound handler, try to stop notify mediaplayer playerIsInit:%s", new Object[] { Boolean.valueOf(f.this.flE) });
        try
        {
          if (f.this.flF != null)
          {
            if (f.this.flF.isPlaying()) {
              f.this.flF.stop();
            }
            f.this.flF.release();
            f.this.flE = false;
            ad.i("MicroMsg.Notification.Tool.Sound", "play sound handler, try to stop notify mediaplayer done playerIsInit:%s", new Object[] { Boolean.valueOf(f.this.flE) });
          }
        ...
        {
          ad.w("MicroMsg.Notification.Tool.Sound", "Exception in playSoundHander,playerIsInit:%s", new Object[] { Boolean.valueOf(f.this.flE) });
          if (f.this.flF != null) {
            f.this.flF.release();
          }
          AppMethodBeat.o(20056);
    ...
    Object localObject1 = com.tencent.mm.storage.ae.FfH + "deviceconfig.cfg";
    ad.i("MicroMsg.ServerConfigInfoStorage", "readConfigFromLocalFile, path: %s, isExist: %s", new Object[] { localObject1, Boolean.valueOf(i.eK((String)localObject1)) });
    if (!i.eK((String)localObject1)) {
      localObject1 = localObject2;
    }
    for (;;)
    {
      com.tencent.mm.compatible.deviceinfo.ae.ph((String)localObject1);
      AppMethodBeat.o(20065);
      return;
      Object localObject3 = i.aR((String)localObject1, 0, -1);
      localObject1 = localObject2;
  ...
  public final void oA(final String paramString)
  {
    try
    {
      ...
      if (this.flH == null)
      {
        ...
        HandlerThread localHandlerThread = d.gv("playSoundThread", 0);
        localHandlerThread.start();
        this.flH = new ap(localHandlerThread.getLooper());
      }
      this.flH.post(new Runnable()
      {
        /* Error */
        public final void run()
        {
          ...
          //   6: aload_0
          //   7: getfield 21	com/tencent/mm/booter/notification/a/f$2:flI	Lcom/tencent/mm/booter/notification/a/f;
          //   10: astore 14
          //   12: aload_0
          //   13: getfield 23	com/tencent/mm/booter/notification/a/f$2:flJ	Ljava/lang/String;
          //   16: astore 15
          //   18: aload_0
          //   19: getfield 25	com/tencent/mm/booter/notification/a/f$2:flK	Z
          //   22: istore 8
          //   24: aload 14
          ...
          //   96: return
          //   97: aload 14
          //   99: getfield 83	com/tencent/mm/booter/notification/a/f:flG	Lcom/tencent/mm/sdk/platformtools/ap;
          //   102: ldc 84
          //   104: invokevirtual 89	com/tencent/mm/sdk/platformtools/ap:removeMessages	(I)V
          //   107: aload 14
          //   109: getfield 83	com/tencent/mm/booter/notification/a/f:flG	Lcom/tencent/mm/sdk/platformtools/ap;
          //   112: ldc 84
          //   114: ldc2_w 90
          ...
          //   130: iconst_0
          //   131: aload 14
          //   133: getfield 100	com/tencent/mm/booter/notification/a/f:flE	Z
          ...
          //   143: aload 14
          //   145: getfield 100	com/tencent/mm/booter/notification/a/f:flE	Z
          //   148: istore 9
          //   150: iload 9
          //   152: ifeq +66 -> 218
          //   155: aload 14
          //   157: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   160: ifnull +52 -> 212
          //   163: aload 14
          //   165: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   168: invokevirtual 119	android/media/MediaPlayer:isPlaying	()Z
          //   171: ifeq +11 -> 182
          //   174: aload 14
          //   176: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   179: invokevirtual 122	android/media/MediaPlayer:stop	()V
          //   182: aload 14
          //   184: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          ...
          //   199: iconst_0
          //   200: aload 14
          //   202: getfield 100	com/tencent/mm/booter/notification/a/f:flE	Z
          ...
          //   212: aload 14
          //   214: iconst_0
          //   215: putfield 100	com/tencent/mm/booter/notification/a/f:flE	Z
          //   218: aload 14
          //   220: new 129	com/tencent/mm/compatible/b/k
          //   223: dup
          //   224: invokespecial 130	com/tencent/mm/compatible/b/k:<init>	()V
          //   227: putfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   230: ldc 54
          //   232: ldc 132
          //   234: iconst_1
          ...
          //   239: iconst_0
          //   240: aload 14
          //   242: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   245: aastore
          //   246: invokestatic 109	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
          //   249: aload 14
          //   251: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   254: astore 17
          ...
          //   332: ifeq +573 -> 905
          //   335: iconst_0
          //   336: invokestatic 179	com/tencent/mm/plugin/audio/c/a:hO	(Z)I
          //   339: istore 7
          //   341: ldc 54
          //   343: ldc 181
          //   345: iconst_1
          ...
          //   525: dup
          //   526: iconst_0
          //   527: getstatic 219	com/tencent/mm/compatible/deviceinfo/ae:fFH	Lcom/tencent/mm/compatible/deviceinfo/k;
          //   530: getfield 225	com/tencent/mm/compatible/deviceinfo/k:fCW	I
          ...
          //   540: getstatic 219	com/tencent/mm/compatible/deviceinfo/ae:fFH	Lcom/tencent/mm/compatible/deviceinfo/k;
          //   543: getfield 225	com/tencent/mm/compatible/deviceinfo/k:fCW	I
          //   546: iconst_1
          ...
          //   571: aload 14
          //   573: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          ...
          //   590: aload 14
          //   592: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          ...
          //   609: aload 14
          //   611: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   614: iload 7
          //   616: invokevirtual 253	android/media/MediaPlayer:setAudioStreamType	(I)V
          //   619: aload 14
          //   621: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   624: iconst_1
          //   625: invokevirtual 256	android/media/MediaPlayer:setLooping	(Z)V
          //   628: aload 14
          //   630: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   633: invokevirtual 259	android/media/MediaPlayer:prepare	()V
          //   636: aload 14
          //   638: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   641: fload_1
          //   642: fload_2
          //   643: fdiv
          //   644: fload_1
          ...
          //   650: aload 14
          //   652: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   655: iconst_0
          //   656: invokevirtual 256	android/media/MediaPlayer:setLooping	(Z)V
          //   659: aload 14
          //   661: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   664: invokevirtual 266	android/media/MediaPlayer:start	()V
          //   667: aload 14
          //   669: iconst_1
          //   670: putfield 100	com/tencent/mm/booter/notification/a/f:flE	Z
          //   673: sipush 20057
          ...
          //   696: aload 14
          //   698: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   701: ifnull +11 -> 712
          //   704: aload 14
          //   706: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          ...
          //   729: aload 14
          //   731: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   734: ifnull -522 -> 212
          //   737: aload 14
          //   739: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          ...
          //   865: goto -573 -> 292
          //   868: aload 14
          //   870: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          ...
          //   885: aload 14
          //   887: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          ...
          //   934: aload 14
          //   936: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          ...
          //   951: aload 14
          //   953: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          ...
          //   968: aload 14
          //   970: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   973: iconst_5
          //   974: invokevirtual 253	android/media/MediaPlayer:setAudioStreamType	(I)V
          //   977: aload 14
          //   979: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   982: iconst_1
          //   983: invokevirtual 256	android/media/MediaPlayer:setLooping	(Z)V
          //   986: aload 14
          //   988: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   991: invokevirtual 259	android/media/MediaPlayer:prepare	()V
          //   994: aload 14
          //   996: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   999: iconst_0
          //   1000: invokevirtual 256	android/media/MediaPlayer:setLooping	(Z)V
          //   1003: aload 14
          //   1005: getfield 113	com/tencent/mm/booter/notification/a/f:flF	Landroid/media/MediaPlayer;
          //   1008: invokevirtual 266	android/media/MediaPlayer:start	()V
          //   1011: aload 14
          //   1013: iconst_1
          //   1014: putfield 100	com/tencent/mm/booter/notification/a/f:flE	Z
          //   1017: aload 14
          //   1019: getfield 100	com/tencent/mm/booter/notification/a/f:flE	Z
          //   1022: istore 10
