...
public final class c
{
  public static String a(Serializable paramSerializable)
  {
    ...
    ae.d("MicroMsg.NotificationQueueTool", "serialize consume: %s", new Object[] { Long.valueOf(System.currentTimeMillis() - l) });
    AppMethodBeat.o(20034);
    return paramSerializable;
  }
  
  public static Serializable uL(String paramString)
  {
    ...
    paramString.close();
    ae.d("MicroMsg.NotificationQueueTool", "de serialize consume: %s", new Object[] { Long.valueOf(System.currentTimeMillis() - l) });
    AppMethodBeat.o(20035);
