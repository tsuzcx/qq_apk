  ...
  implements com.tencent.mm.sdk.e.f
{
  ...
  public c FCK;
  public String FCL;
  private final LinkedList<Object> FCM;
  private ap FCN;
  protected f FCb;
  private String TAG;
  ...
  private void aJL(String paramString)
  {
  ...
  public final long a(String paramString1, String paramString2, ContentValues paramContentValues)
  {
    ...
    if (!isOpen())
    {
      ad.e(this.TAG, "DB IS CLOSED ! {%s}", new Object[] { bt.eGN() });
    ...
    try
    {
      long l = this.FCb.insert(paramString1, paramString2, paramContentValues);
      c.a(paramString1, null, this.mrY);
      return l;
    }
    catch (Exception paramString1)
    {
      e.vIY.idkeyStat(181L, 11L, 1L, false);
  ...
  public final Cursor a(String paramString, String[] paramArrayOfString, int paramInt)
  {
    ...
    try
    {
      paramArrayOfString = this.FCb.a(paramString, paramArrayOfString, paramInt);
      c.a(paramString, paramArrayOfString, this.mrY);
      return paramArrayOfString;
    }
    catch (Exception paramString)
    {
      e.vIY.idkeyStat(181L, 10L, 1L, false);
  ...
  public final Cursor a(String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3, String paramString4, String paramString5, int paramInt)
  {
    ...
    for (i = g.afE().eFQ();; i = 0)
    {
      ...
      try
      {
        paramArrayOfString1 = this.FCb.a(paramString1, paramArrayOfString1, paramString2, paramArrayOfString2, paramString3, paramString4, paramString5, paramInt);
        c.a(paramString1, paramArrayOfString1, this.mrY);
  ...
  public final boolean a(String paramString1, String paramString2, String paramString3, List<String> paramList, DBDumpUtil.ExecuteSqlCallback paramExecuteSqlCallback)
  {
    ...
    boolean bool = DBDumpUtil.doRecoveryDb(this.FCb.FCl, paramString1, paramString2, paramString3, paramList, null, paramExecuteSqlCallback, true);
    AppMethodBeat.o(133415);
    return bool;
  }
  ...
  public final boolean b(String paramString1, String paramString2, String paramString3, long paramLong, HashMap<Integer, b> paramHashMap, boolean paramBoolean)
  {
    ...
    aJL(paramString2);
    if ((this.FCI.a(paramString1, paramString2, paramString3, paramLong, paramHashMap, paramBoolean)) && (this.FCI.FCb != null))
    {
      this.FCL = this.FCI.getError();
      this.FCb = this.FCI.FCb;
    ...
    this.FCb = null;
    this.FCI = null;
    ad.i(this.TAG, "initDB failed. %s", new Object[] { this.FCL });
    AppMethodBeat.o(133406);
    return false;
  }
  ...
  public final boolean b(String paramString, HashMap<Integer, b> paramHashMap, boolean paramBoolean)
  {
    ...
    aJL(paramString);
    if ((this.FCI.a(paramString, paramHashMap, paramBoolean)) && (this.FCI.FCb != null))
    {
      this.FCb = this.FCI.FCb;
      ad.i(this.TAG, "SqliteDB db %s", new Object[] { this.FCb });
  ...
  public final int delete(String paramString1, String paramString2, String[] paramArrayOfString)
  {
    ...
    try
    {
      j = this.FCb.delete(paramString1, paramString2, paramArrayOfString);
      c.a(paramString1, null, this.mrY);
      return j;
    }
    catch (Exception paramString1)
  ...
  public final SQLiteDatabase eOh()
  {
    f localf = this.FCb;
    if (localf.FCl != null) {
      return localf.FCl;
  ...
  public final boolean execSQL(String paramString1, String paramString2)
  {
    ...
    for (int i = g.afE().eFQ();; i = 0)
    {
      ...
      try
      {
        ...
        c.a(paramString2, null, this.mrY);
        return true;
      }
      catch (Exception paramString1)
      {
        ...
        paramString2 = this.FCI;
        ad.d("MicroMsg.DBInit", "resetIniCache iniFilename:%s", new Object[] { paramString2.FCc });
        i.deleteFile(paramString2.FCc);
        if (this.FCK == null) {
          break;
        }
        this.FCK.afu();
  ...
  public final long getPageSize()
  {
    ...
    long l = this.FCb.FCl.getPageSize();
  ...
  public final boolean inTransaction()
  {
    ...
    //   27: dup
    //   28: iconst_0
    //   29: invokestatic 159	com/tencent/mm/sdk/platformtools/bt:eGN	()Lcom/tencent/mm/sdk/platformtools/at;
    //   32: aastore
    ...
    //   45: ireturn
    //   46: aload_0
    //   47: getfield 79	com/tencent/mm/storagebase/h:mrY	J
    //   50: lconst_0
    //   51: lcmp
    //   52: ifle +14 -> 66
    //   55: ldc_w 416
  ...
  public final boolean isOpen()
  {
    ...
    Assert.assertTrue("DB has been closed :[" + this.FCJ + "]", bt.isNullOrNil(this.FCJ));
    AppMethodBeat.o(133408);
    return false;
  }
  
  public final int mX(long paramLong)
  {
    int i = 0;
    for (;;)
    {
      ...
      try
      {
        ...
        ad.i(this.TAG, "endTransaction thr:%d ticket:(%d,%d) db:%b", new Object[] { Long.valueOf(l2), Long.valueOf(paramLong), Long.valueOf(this.mrY), Boolean.valueOf(isOpen()) });
        if (!isOpen())
        {
          ad.e(this.TAG, "DB IS CLOSED ! {%s}", new Object[] { bt.eGN() });
          i = -4;
        ...
        if (paramLong != this.mrY)
        {
          ad.e(this.TAG, "ERROR endTransaction ticket:" + paramLong + " transactionTicket:" + this.mrY);
          i = -1;
          AppMethodBeat.o(133425);
          continue;
        }
      ...
      else
      {
        try
        {
          ...
          ad.i(this.TAG, "endTransaction Succ Time:%d thr:%d ticket:(%d,%d) db:%b", new Object[] { Long.valueOf(bt.vM(l1)), Long.valueOf(l2), Long.valueOf(paramLong), Long.valueOf(this.mrY), Boolean.valueOf(isOpen()) });
        ...
        catch (Exception localException)
        {
          ...
          e.vIY.idkeyStat(181L, 9L, 1L, false);
          c.p(localException);
          i = -3;
          AppMethodBeat.o(133425);
        }
  ...
  public void oi(String paramString)
  {
    ...
    ad.w(this.TAG, "begin close db, inTrans:%b ticket:%s  thr:%d {%s}", new Object[] { Boolean.valueOf(inTransaction()), Long.toHexString(this.mrY), Long.valueOf(Thread.currentThread().getId()), bt.eGN() });
    f.a locala = new f.a();
    if (paramString != null) {
      this.FCJ = paramString;
    }
    this.FCb.close();
    this.FCb = null;
    ad.d(this.TAG, "end close db time:%d", new Object[] { Long.valueOf(locala.XK()) });
    AppMethodBeat.o(133402);
  }
  ...
  public final long rb(long paramLong)
  {
    long l1 = -1L;
    for (;;)
    {
      ...
      try
      {
        ...
        l2 = Thread.currentThread().getId();
        ad.i(this.TAG, "beginTransaction thr:(%d,%d) ticket:%d db:%b", new Object[] { Long.valueOf(paramLong), Long.valueOf(l2), Long.valueOf(this.mrY), Boolean.valueOf(isOpen()) });
        if (!isOpen())
        {
          ad.e(this.TAG, "DB IS CLOSED ! {%s}", new Object[] { bt.eGN() });
          paramLong = -4L;
        ...
        if (this.mrY > 0L)
        {
          ad.e(this.TAG, "ERROR beginTransaction transactionTicket:" + this.mrY);
          AppMethodBeat.o(133424);
          paramLong = l1;
          continue;
        }
      ...
      else
      {
        try
        {
          ...
          this.mrY = (bt.eGO() & 0x7FFFFFFF);
          this.mrY |= (l2 & 0x7FFFFFFF) << 32;
          if (this.FCH != null) {
            this.FCH.afs();
          }
          paramLong = this.mrY;
        ...
        {
          e.vIY.idkeyStat(181L, 8L, 1L, false);
  ...
  public final long replace(String paramString1, String paramString2, ContentValues paramContentValues)
  {
    ...
    try
    {
      long l = this.FCb.replace(paramString1, paramString2, paramContentValues);
      c.a(paramString1, null, this.mrY);
      return l;
    }
    catch (Exception paramString1)
  ...
  public final int update(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString)
  {
    ...
    for (i = g.afE().eFQ();; i = 0)
    {
      ...
      try
      {
        j = this.FCb.update(paramString1, paramContentValues, paramString2, paramArrayOfString);
        c.a(paramString1, null, this.mrY);
        return j;
      }
      catch (Exception paramString1)
