...
public enum k$a
{
  static
  {
    ...
    hzH = new a("BUSINESS_MY_LIFE_AROUND", 0);
    hzI = new a("BUSINESS_OTHER", 1);
    hzJ = new a("BUSINESS_MAX", 2);
    hzK = new a[] { hzH, hzI, hzJ };
  ...
  public static String b(int paramInt, String paramString, Context paramContext)
  {
    ...
    if (isValid(paramInt))
    {
      ...
      if (!bt.isNullOrNil(paramString))
      {
        ...
        ad.d("MicroMsg.AppMessage", "id: %d.", new Object[] { Integer.valueOf(paramInt) });
        str1 = str2;
        if (paramInt > 0) {
    ...
    ad.d("MicroMsg.AppMessage", "txt: %s.", new Object[] { str1 });
  ...
  public static boolean isValid(int paramInt)
  {
    ...
    if ((paramInt >= hzH.ordinal()) && (paramInt < hzJ.ordinal()))
    {
 ...
 * Qualified Name:     com.tencent.mm.ai.k.a
