...
public enum k$a
{
  static
  {
    ...
    gGX = new a("BUSINESS_MY_LIFE_AROUND", 0);
    gGY = new a("BUSINESS_OTHER", 1);
    gGZ = new a("BUSINESS_MAX", 2);
    gHa = new a[] { gGX, gGY, gGZ };
  ...
  public static boolean isValid(int paramInt)
  {
    ...
    if ((paramInt >= gGX.ordinal()) && (paramInt < gGZ.ordinal()))
    {
