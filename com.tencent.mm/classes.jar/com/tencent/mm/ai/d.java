  ...
  extends f
{
  ...
  public final void a(Map<String, String> paramMap, k.b paramb)
  {
    ...
    if (paramb.type == 2001)
    {
      ...
      paramb.field_temp = 1;
      paramb.field_catalog = EmojiInfo.LBQ;
      paramb.field_state = EmojiInfo.LCg;
      this.fLP = paramb;
      this.dDP = bt.getInt((String)paramMap.get(".msg.appmsg.emoji.localreceivestatus"), 0);
      if (k.getEmojiStorageMgr().FyY.aJx(paramb.field_md5) == null) {
        k.getEmojiStorageMgr().FyY.J(this.fLP);
      }
      ad.d("MicroMsg.AppContentLuckyMoneyEmogiPiece", "EmojiInfo: %s", new Object[] { this.fLP });
    }
  ...
  public final void b(StringBuilder paramStringBuilder, k.b paramb, String paramString, com.tencent.mm.i.d paramd, int paramInt1, int paramInt2)
  {
    ...
    label47:
    for (paramb = new EmojiInfo();; paramb = this.fLP)
    {
      e.a(paramStringBuilder, paramb, this.dDP);
