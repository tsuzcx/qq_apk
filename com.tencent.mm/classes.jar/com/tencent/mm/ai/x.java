  ...
  extends s
{
  ...
  private String aze()
  {
    ...
    String str = r.aLC(b.s(this.hDg.hDm, 4));
  ...
  public final void s(Bundle paramBundle)
  {
    ...
    try
    {
      if ((((h)g.ajz().ajb()).akw()) && ((this.hDg.type == 5) || (this.hDg.type == 8)) && (this.hDh.size() == 0)) {
        this.hDh.add(aze());
      }
      paramBundle.putByteArray("biz_mp_msg_info", toByteArray());
      paramBundle.putString("rawUrl", this.hDg.url);
  ...
  public final void t(Intent paramIntent)
  {
    ...
    try
    {
      ...
      paramIntent.putExtra("rawUrl", this.hDg.url);
