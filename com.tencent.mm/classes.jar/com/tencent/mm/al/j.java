...
{
  public static String hxN = "menu_click";
  public static String hxO = "menu_action_start";
  public static String hxP = "menu_action_success";
  public String content;
  public String dBy;
  public List<j> hxQ = null;
  public int hxR;
  public int id;
  public String key;
  public String name;
    ...
    if (paramJSONArray != null) {
      try
      {
        ...
        for (;;)
        {
          ...
          localj.dBy = ((JSONObject)localObject).optString("native_url");
          ac.d("MicroMsg.BizMenuItem", "menuItem.nativeurl : " + localj.dBy);
          localj.hxQ = e(((JSONObject)localObject).optJSONArray("sub_button_list"));
          localj.hxR = ((JSONObject)localObject).optInt("acttype");
      ...
      {
        ac.e("MicroMsg.BizMenuItem", "exception:%s", new Object[] { bs.m(paramJSONArray) });
  ...
  public static LinkedList<j> u(Map<String, String> paramMap)
  {
    ...
    int j = bs.getInt((String)paramMap.get(".msg.appmsg.buttonlist.$count"), 0);
    if (j > 0) {
      try
      {
        LinkedList localLinkedList = new LinkedList();
        ac.v("MicroMsg.BizMenuItem", "menuItem.jsonArray.length : ".concat(String.valueOf(j)));
        int i = 0;
        if (i < j)
        {
          j localj = new j();
          ...
          {
            str = str;
            localj.id = bs.getInt((String)paramMap.get(str + ".id"), 0);
            localj.type = bs.getInt((String)paramMap.get(str + ".type"), 0);
            localj.name = ((String)paramMap.get(str + ".name"));
            localj.key = ((String)paramMap.get(str + ".key"));
            localj.value = ((String)paramMap.get(str + ".value"));
            localj.hxR = bs.getInt((String)paramMap.get(str + ".acttype"), 0);
      ...
      {
        ac.e("MicroMsg.BizMenuItem", "exception:%s", new Object[] { bs.m(paramMap) });
        AppMethodBeat.o(116433);
        return null;
      }
    }
  ...
  public final void a(double paramDouble1, double paramDouble2, int paramInt, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      ac.v("MicroMsg.BizMenuItem", this.content);
      AppMethodBeat.o(116429);
      return;
    }
    catch (JSONException paramString1)
    {
      ac.e("MicroMsg.BizMenuItem", paramString1.toString());
      AppMethodBeat.o(116429);
    }
  }
  ...
  public final void ba(String paramString1, String paramString2)
  {
    ...
    ac.v("MicroMsg.BizMenuItem", "type is %s , result is %s", new Object[] { paramString1, paramString2 });
    try
    {
      JSONObject localJSONObject = new JSONObject();
      ...
      this.content = paramString1.toString();
      ac.v("MicroMsg.BizMenuItem", "content: %s", new Object[] { this.content });
  ...
  public final String getInfo()
  {
    ...
    label97:
    for (this.state = hxO;; this.state = hxN)
    {
  ...
  public final void q(ArrayList<String> paramArrayList)
  {
    ...
    {
      ac.e("MicroMsg.BizMenuItem", "value null!");
    ...
    {
      ac.e("MicroMsg.BizMenuItem", paramArrayList.toString());
      AppMethodBeat.o(116428);
      return;
    }
