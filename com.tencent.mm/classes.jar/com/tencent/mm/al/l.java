  ...
  implements com.tencent.mm.network.q
{
  ...
  {
    paramd.setDeviceID(com.tencent.mm.compatible.deviceinfo.q.aay());
    paramd.setDeviceType(d.hgH);
    paramd.setClientVersion(d.Fnj);
    paramd.setUin(j.e.a.FnO.aBU());
    if (g.ajx())
    {
      ...
      int k;
      int i;
      if (((a)g.ab(a.class)).acA().getInt("UseAesGcmSessionKeySwitch", 1) == 0)
      {
        bool = true;
        ...
        if (bool)
        {
          paramd = ((a)g.ab(a.class)).acA().getValue("UseAesGcmSessionKeyCgiList");
    ...
    ad.i("MicroMsg.MMReqRespBase", "summerauths check cgi[%s] USE_ECDH[%s] accHasReady[%s] ", new Object[] { Integer.valueOf(paramd.getCmdId()), Boolean.valueOf(f.Fns), Boolean.valueOf(g.ajx()) });
  }
