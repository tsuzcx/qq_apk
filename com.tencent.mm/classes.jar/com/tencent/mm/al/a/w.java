  ...
  implements k
{
  ...
  public w(String paramString1, String paramString2, int paramInt)
  {
    ...
    ((b.a)localObject).hvt = new cla();
    ((b.a)localObject).hvu = new clb();
    ((b.a)localObject).uri = "/cgi-bin/mmocbiz-bin/qymsgstatenotify";
    ((b.a)localObject).funcId = 1361;
    ((b.a)localObject).reqCmdId = 0;
    ((b.a)localObject).respCmdId = 0;
    this.rr = ((b.a)localObject).aAz();
    localObject = (cla)this.rr.hvr.hvw;
    ((cla)localObject).Ebs = paramString1;
    ((cla)localObject).Ebl = paramString2;
    ((cla)localObject).time_stamp = paramInt;
  ...
  public final int doScene(e parame, g paramg)
  {
    ...
    ac.i("MicroMsg.NetSceneQyMsgStateNotify", "do scene");
  ...
  public final void onGYNetEnd(int paramInt1, int paramInt2, int paramInt3, String paramString, q paramq, byte[] paramArrayOfByte)
  {
    ...
    ac.d("MicroMsg.NetSceneQyMsgStateNotify", "onGYNetEnd code(%d, %d)", new Object[] { Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) });
