  ...
  extends IAutoDBItem
{
  ...
  private static final StorageObserverOwner<r> observerOwner = new StorageObserverOwner();
  ...
  static
  {
    ...
    INDEX_CREATE = new String[] { "CREATE INDEX IF NOT EXISTS AppBrandLocalUsageRecordUpdateTimeIndex ON AppBrandLocalUsageRecord(updateTime)" };
  ...
  public StorageObserverOwner<? extends r> getObserverOwner()
  {
 ...
 * Qualified Name:     com.tencent.mm.autogen.b.r
