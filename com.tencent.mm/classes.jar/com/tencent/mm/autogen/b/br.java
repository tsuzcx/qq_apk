  ...
  extends IAutoDBItem
{
  ...
  public static final Column kgI;
  private static final int kgK;
  private static final StorageObserverOwner<br> observerOwner = new StorageObserverOwner();
  ...
  static
  {
    ...
    kgI = new Column("lan", "string", TABLE.getName(), "");
  ...
  public void convertFrom(ContentValues paramContentValues, boolean paramBoolean)
  {
    ...
    if (paramContentValues.containsKey("lan"))
    {
      this.field_lan = paramContentValues.getAsString("lan");
      if (paramBoolean) {
        this.kgJ = true;
      }
    }
  ...
  public StorageObserverOwner<? extends br> getObserverOwner()
  {
 ...
 * Qualified Name:     com.tencent.mm.autogen.b.br
