  ...
  extends IAutoDBItem
{
  ...
  private static final int lhy;
  private static final StorageObserverOwner<ih> observerOwner = new StorageObserverOwner();
  ...
  static
  {
    ...
    lhw = new Column("fakePk", "int", TABLE.getName(), "");
    ...
    INDEX_CREATE = new String[] { "CREATE INDEX IF NOT EXISTS bankcard_scene_index ON WalletBankcardScene(scene)" };
    lhy = "fakePk".hashCode();
  ...
  {
    if (paramContentValues.containsKey("fakePk"))
    {
      this.field_fakePk = paramContentValues.getAsInteger("fakePk").intValue();
      if (paramBoolean) {
        this.lhx = true;
      }
    }
  ...
  public StorageObserverOwner<? extends ih> getObserverOwner()
  {
 ...
 * Qualified Name:     com.tencent.mm.autogen.b.ih
