  ...
  extends IAutoDBItem
{
  ...
  private static final int kcb;
  private static final StorageObserverOwner<bf> observerOwner = new StorageObserverOwner();
  ...
  static
  {
    ...
    kbZ = new Column("extJson", "string", TABLE.getName(), "");
    INDEX_CREATE = new String[0];
    jKX = "appId".hashCode();
    jLL = "versionType".hashCode();
    kcb = "extJson".hashCode();
  ...
  public static IAutoDBItem.MAutoDBInfo aJm()
  {
    ...
    localStringBuilder.append(", ");
    localMAutoDBInfo.columns[2] = "extJson";
    localMAutoDBInfo.colsMap.put("extJson", "TEXT");
  ...
  public void convertFrom(ContentValues paramContentValues, boolean paramBoolean)
  {
    ...
    if (paramContentValues.containsKey("extJson"))
    {
      this.field_extJson = paramContentValues.getAsString("extJson");
      if (paramBoolean) {
        this.kca = true;
      }
    }
  ...
  public StorageObserverOwner<? extends bf> getObserverOwner()
  {
 ...
 * Qualified Name:     com.tencent.mm.autogen.b.bf
