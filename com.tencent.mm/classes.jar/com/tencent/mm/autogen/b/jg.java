  ...
  extends IAutoDBItem
{
  ...
  public static final Column lpq;
  private static final int lps;
  private static final StorageObserverOwner<jg> observerOwner = new StorageObserverOwner();
  ...
  static
  {
    ...
    lpq = new Column("permissionProtoBlob", "byte[]", TABLE.getName(), "");
    INDEX_CREATE = new String[0];
    jKX = "appId".hashCode();
    lps = "permissionProtoBlob".hashCode();
  ...
  public void convertFrom(ContentValues paramContentValues, boolean paramBoolean)
  {
    ...
    if (paramContentValues.containsKey("permissionProtoBlob"))
    {
      this.field_permissionProtoBlob = paramContentValues.getAsByteArray("permissionProtoBlob");
      if (paramBoolean) {
        this.lpr = true;
      }
    }
  ...
  public StorageObserverOwner<? extends jg> getObserverOwner()
  {
 ...
 * Qualified Name:     com.tencent.mm.autogen.b.jg
