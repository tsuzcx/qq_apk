  ...
  extends am
{
  ...
  public static boolean X(ca paramca)
  {
    ...
    if ((!Util.isNullOrNil(paramca.ilp)) && (g.Ux(paramca.field_talker)))
    {
      paramca = af.bju().UI(paramca.ilp);
 ...
 * Qualified Name:     com.tencent.mm.ao.h
