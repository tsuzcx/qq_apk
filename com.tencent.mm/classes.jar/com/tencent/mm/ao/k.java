...
{
  public static String lEF = "menu_click";
  public static String lEG = "menu_action_start";
  public static String lEH = "menu_action_success";
  public String content;
  public String gbn;
  public int id;
  public String key;
  public List<k> lEI = null;
  public int lEJ;
  public String name;
  public String state;
  public int type;
    ...
    if (paramJSONArray != null) {
      try
      {
        ...
        for (;;)
        {
          ...
          localk.gbn = ((JSONObject)localObject).optString("native_url");
          Log.d("MicroMsg.BizMenuItem", "menuItem.nativeurl : " + localk.gbn);
          localk.lEI = e(((JSONObject)localObject).optJSONArray("sub_button_list"));
          localk.lEJ = ((JSONObject)localObject).optInt("acttype");
  ...
  public static LinkedList<k> x(Map<String, String> paramMap)
  {
      ...
      try
      {
        ...
        if (i < j)
        {
          ...
          for (String str = "";; str = String.valueOf(i))
          {
            ...
            localk.lEJ = Util.getInt((String)paramMap.get(str + ".acttype"), 0);
  ...
  public final String getInfo()
  {
    ...
    label97:
    for (this.state = lEG;; this.state = lEF)
    {
 ...
 * Qualified Name:     com.tencent.mm.ao.k
