...
{
  static String Vo(String paramString)
  {
  ...
  private static void a(Activity paramActivity, SendMessageToWX.Req paramReq, Bundle paramBundle, String paramString)
  {
    ...
    for (;;)
    {
      ...
      paramReq = new com.tencent.mm.hellhoundlib.b.a().bm(localIntent);
      com.tencent.mm.hellhoundlib.a.a.b(paramActivity, paramReq.aFh(), "com/tencent/mm/modelbiz/ww/OpenSdkBridge", "dealSendMsgToWx", "(Landroid/app/Activity;Lcom/tencent/mm/opensdk/modelmsg/SendMessageToWX$Req;Landroid/os/Bundle;Ljava/lang/String;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
      paramActivity.startActivity((Intent)paramReq.sf(0));
  ...
  public static void a(final Activity paramActivity, fhj paramfhj)
  {
    ...
    String str = paramfhj.zaK;
    if (Util.isNullOrNil(str)) {}
    for (str = null; str == null; str = ((StringBuilder)localObject).toString())
    {
      Log.w("MicroMsg.OpenSdkBridge", "doSendImage bad img_url=" + paramfhj.zaK);
      AppMethodBeat.o(208848);
      return;
      localObject = new StringBuilder(com.tencent.mm.plugin.image.d.bbX());
    ...
    q.bml().a(paramfhj.zaK, ((c.a)localObject).bmL(), new com.tencent.mm.ay.a.c.d()
    {
      public final void a(boolean paramAnonymousBoolean, Object... paramAnonymousVarArgs)
      {
        AppMethodBeat.i(205778);
        Log.w("MicroMsg.OpenSdkBridge", "doSendImage onImageDownload success? %s=%b", new Object[] { this.lHc, Boolean.valueOf(paramAnonymousBoolean) });
        if (paramAnonymousBoolean)
        {
          Object localObject1 = BitmapUtil.decodeFile(this.lHc, null);
          ...
          ((SendMessageToWX.Req)localObject2).transaction = a.Vo("img");
  ...
  public static void a(Activity paramActivity, fhk paramfhk)
  {
    AppMethodBeat.i(208849);
    Object localObject = new WXWebpageObject();
    ((WXWebpageObject)localObject).webpageUrl = paramfhk.vhY;
    localObject = new WXMediaMessage((WXMediaMessage.IMediaObject)localObject);
    ((WXMediaMessage)localObject).title = paramfhk.title;
    ((WXMediaMessage)localObject).description = paramfhk.description;
    try
    {
      ((WXMediaMessage)localObject).thumbData = Base64.decode(paramfhk.UHr.UH, 0);
      label62:
      paramfhk = new SendMessageToWX.Req();
      paramfhk.transaction = Vo("webpage");
      paramfhk.message = ((WXMediaMessage)localObject);
      paramfhk.scene = 0;
      a(paramActivity, paramfhk);
      AppMethodBeat.o(208849);
      return;
    }
    catch (Throwable paramfhk)
    {
      break label62;
    }
  }
