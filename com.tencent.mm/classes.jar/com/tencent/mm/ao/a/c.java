  ...
  extends ah
{
  ...
  private void UZ(String paramString)
  {
    ...
    paramString = ((l)h.ae(l.class)).gm(paramString);
    if (paramString != null) {
      this.lFW.put(paramString.field_userId, paramString);
    }
  ...
  public final k UY(String paramString)
  {
    ...
    if (this.lFW.containsKey(paramString))
    {
      paramString = (k)this.lFW.get(paramString);
  ...
  public final List<String> bjL()
  {
    ...
    this.lFX = Util.stringsToList(((String)localObject).split(";"));
    localObject = this.lFX;
    AppMethodBeat.o(116435);
    return localObject;
  }
  ...
  public final boolean bjN()
  {
    ...
    if ((bjM()) && (Util.isNullOrNil(this.field_userList)))
    {
      AppMethodBeat.o(116440);
      return true;
    }
 ...
 * Qualified Name:     com.tencent.mm.ao.a.c
