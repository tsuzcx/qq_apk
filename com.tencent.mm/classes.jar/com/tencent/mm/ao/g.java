  ...
  extends ao
{
  ...
  public final void transfer(int paramInt)
  {
    ...
    ae.d("MicroMsg.App.SyncTopConversation", "the previous version is %d", new Object[] { Integer.valueOf(paramInt) });
    com.tencent.mm.plugin.report.service.g.yxI.dD(336, 15);
    bc.aCg();
    ...
    ae.d("MicroMsg.App.SyncTopConversation", "sql:%s", new Object[] { localObject2 });
    ...
    if (localObject1 != null)
    {
      while (((Cursor)localObject1).moveToNext())
      {
        ...
        ae.v("MicroMsg.App.SyncTopConversation", "userName %s", new Object[] { localObject2 });
        x.D((String)localObject2, false);
      }
