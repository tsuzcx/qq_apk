...
public class h
{
  public static final ArrayList<i> IEI;
  public static final ArrayList<Message> IEJ;
  static String IEK;
  static e IEL;
  static b IEM;
  static f IEN;
  static Set<SplashActivity> IEO;
  private static boolean IEP;
  private static volatile boolean IEQ;
  private static boolean IER;
  private static o IES;
  private static boolean IET;
  static c IEU;
  private static Class<? extends SplashActivity> IEV;
  private static Set<String> IEW;
  private static Class<? extends Activity> IEX;
  private static n IEY;
  private static HashSet<String> IEZ;
  private static boolean IFa;
  @SuppressLint({"HandlerLeak"})
  private static Handler IFb;
  static Application IoX;
  static d cVK;
  ...
  static
  {
    ...
    IEZ = new HashSet();
    IFa = false;
    IFb = new Handler(Looper.getMainLooper())
    {
  ...
  public static void a(i parami)
  {
    ...
    {
      parami.recreate();
      b("WxSplash.Splash", "do recreate for %s", new Object[] { parami.IFj });
      AppMethodBeat.o(40644);
      return;
    }
    parami.finish();
    b("WxSplash.Splash", "eat activity, %s", new Object[] { parami.IFj });
    AppMethodBeat.o(40644);
  }
  ...
  public static void a(Throwable paramThrowable, String paramString)
  {
    ...
    if (IEU != null) {
      IEU.a(paramThrowable, paramString);
    }
  ...
  static void b(SplashActivity paramSplashActivity)
  {
    ...
    IEO.remove(paramSplashActivity);
  ...
  public static void b(String paramString1, String paramString2, Object... paramVarArgs)
  {
    ...
    if (IEU != null) {
      IEU.b(paramString1, paramString2, paramVarArgs);
    }
  ...
  public static void dCa()
  {
    ...
    com.tencent.mm.hellhoundlib.a.a.a(localObject, locala.ahE(), "com/tencent/mm/splash/Splash", "killSelf", "()V", "android/os/Process_EXEC_", "killProcess", "(I)V");
  ...
  public static void frh()
  {
    ...
    if (IER) {
      try
      {
        Handler.Callback localCallback = (Handler.Callback)l.IFD.get(l.IFx);
        if (localCallback == l.IFC) {}
        for (;;)
        {
        ...
        Object localObject = l.IFD;
        l.IFC.wKq = localCallback;
        ((Field)localObject).setAccessible(true);
        ((Field)localObject).set(l.IFx, l.IFC);
        IEY.idkey(675L, 31L, 1L);
        l.IFx.sendEmptyMessage(987654321);
        AppMethodBeat.o(40636);
        return;
      }
  ...
  public static void frl()
  {
    ...
    if (!g.zz)
    {
      boolean bool = a.jA(IoX);
      Handler localHandler = IFb;
      if (bool) {
        i = 1;
      }
    ...
    IFb.sendEmptyMessage(0);
    AppMethodBeat.o(40638);
  }
  
  private static void frm()
  {
    AppMethodBeat.i(40640);
    b("WxSplash.Splash", "Gonna replay %s pending message(s).", new Object[] { Integer.valueOf(IEJ.size()) });
    Iterator localIterator = IEJ.iterator();
  ...
  private static void frn()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localSplashActivity.frt();
    }
    if (i == 0)
    {
      b("WxSplash.Splash", "no splash activity found, so we terminate hacked activities manually.", new Object[0]);
      localObject1 = IEI.iterator();
      while (((Iterator)localObject1).hasNext()) {
        a((i)((Iterator)localObject1).next());
      }
    }
    b("WxSplash.Splash", "resend all %s pending message. ", new Object[] { Integer.valueOf(IEJ.size()) });
    if (!IEQ) {
      frm();
    }
    IES = null;
  ...
  private static void fro()
  {
    ...
    //   9: getstatic 217	com/tencent/mm/splash/h:IoX	Landroid/app/Application;
    //   12: invokestatic 473	com/tencent/mm/splash/a:jB	(Landroid/content/Context;)V
    //   15: ldc 2
    //   17: monitorenter
    //   18: getstatic 92	com/tencent/mm/splash/h:IET	Z
    //   21: ifeq +16 -> 37
    //   24: ldc 2
    //   26: monitorexit
    //   27: ldc_w 469
    ...
    //   36: return
    //   37: iconst_1
    //   38: putstatic 92	com/tencent/mm/splash/h:IET	Z
    //   41: ldc 2
    //   43: monitorexit
    //   44: getstatic 90	com/tencent/mm/splash/h:IER	Z
    //   47: ifne +51 -> 98
    //   50: ldc 166
    //   52: ldc_w 475
    //   55: iconst_0
    ...
    //   62: getstatic 180	com/tencent/mm/splash/h:IES	Lcom/tencent/mm/splash/o;
    //   65: ifnonnull +257 -> 322
    //   68: invokestatic 126	com/tencent/mm/splash/h:frn	()V
    //   71: ldc_w 469
    ...
    //   116: goto -54 -> 62
    //   119: astore_0
    //   120: getstatic 99	com/tencent/mm/splash/h:IEY	Lcom/tencent/mm/splash/n;
    //   123: ldc2_w 369
    //   126: ldc2_w 478
    //   129: lconst_1
    ...
    //   140: goto -78 -> 62
    //   143: getstatic 485	com/tencent/mm/splash/l:IFA	Ljava/util/List;
    //   146: ifnull -84 -> 62
    //   149: getstatic 485	com/tencent/mm/splash/l:IFA	Ljava/util/List;
    //   152: invokeinterface 488 1 0
    //   157: ifeq -95 -> 62
    //   160: getstatic 99	com/tencent/mm/splash/h:IEY	Lcom/tencent/mm/splash/n;
    //   163: ldc2_w 369
    //   166: ldc2_w 489
    //   169: lconst_1
    //   170: invokevirtual 376	com/tencent/mm/splash/n:idkey	(JJJ)V
    //   173: getstatic 227	com/tencent/mm/splash/l:cWk	Ljava/lang/Object;
    //   176: astore_2
    //   177: aload_2
    ...
    //   203: putstatic 497	com/tencent/mm/splash/l:IFz	Landroid/app/Application;
    //   206: aload_1
    //   207: astore_0
    //   208: aload_1
    ...
    //   224: getstatic 217	com/tencent/mm/splash/h:IoX	Landroid/app/Application;
    //   227: astore_0
    //   228: ldc_w 501
    ...
    //   266: getstatic 515	com/tencent/mm/splash/l:IFB	Ljava/lang/reflect/Method;
    //   269: aload_2
    //   270: iconst_2
    ...
    //   278: dup
    //   279: iconst_1
    //   280: getstatic 485	com/tencent/mm/splash/l:IFA	Ljava/util/List;
    //   283: aastore
    ...
    //   300: getstatic 485	com/tencent/mm/splash/l:IFA	Ljava/util/List;
    ...
    //   319: goto -65 -> 254
    //   322: getstatic 180	com/tencent/mm/splash/h:IES	Lcom/tencent/mm/splash/o;
  ...
  public static Class<? extends Activity> frp()
  {
    return IEV;
  }
  ...
  private static boolean fu(String paramString)
  {
    ...
    if (cVK != null)
    {
      boolean bool = cVK.fu(paramString);
  ...
  public static void jG(Context paramContext)
  {
    int i = 1;
    ...
    for (;;)
    {
      try
      {
        localObject = bu.js(paramContext);
        if ((localObject != null) && (((ComponentName)localObject).getPackageName().equals(paramContext.getPackageName())) && (IEK != null) && (((ComponentName)localObject).getClassName().equals(IEK)))
        {
      ...
      Object localObject = a.fra();
      com.tencent.mm.vfs.k localk = new com.tencent.mm.vfs.k((String)localObject);
      if (!localk.exists()) {
        localk.mkdirs();
      }
      localObject = new com.tencent.mm.vfs.k((String)localObject + "/main-process-blocking");
      if (((com.tencent.mm.vfs.k)localObject).exists()) {
        ((com.tencent.mm.vfs.k)localObject).delete();
      }
      if (((com.tencent.mm.vfs.k)localObject).createNewFile())
      {
        localObject = new Intent(paramContext, IEX);
        ((Intent)localObject).addFlags(268435456);
        localObject = new com.tencent.mm.hellhoundlib.b.a().bc(localObject);
        com.tencent.mm.hellhoundlib.a.a.a(paramContext, ((com.tencent.mm.hellhoundlib.b.a)localObject).ahE(), "com/tencent/mm/splash/Splash", "startFigLeafActivityIfNeed", "(Landroid/content/Context;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
  ...
  private static Object jH(Context paramContext)
  {
  ...
  public static boolean q(Application paramApplication)
  {
    ...
    finally
    {
      for (;;)
      {
        ...
        try
        {
          localObject1 = jH(paramApplication);
    ...
    if ((localObject5 == null) || (!(localObject5 instanceof j)))
    {
      ...
      ((Field)localObject2).setAccessible(true);
      l.IFA = (List)((Field)localObject2).get(paramApplication);
      localObject2 = IEZ.iterator();
      label991:
      if (!((Iterator)localObject2).hasNext()) {
        break label1091;
      }
      localObject3 = (String)((Iterator)localObject2).next();
      localObject4 = l.IFA.iterator();
      do
      {
  ...
  public static void t(Message paramMessage)
  {
    ...
    l.IFx.sendMessage(paramMessage);
