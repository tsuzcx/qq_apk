  ...
  extends MMBaseActivity
{
  ...
  public PermissionWarningDialog()
  {
    ...
    this.Vb = new DialogInterface.OnCancelListener()
    {
  ...
  private boolean aFQ()
  {
    ...
    {
      locala = new d.a(this);
      locala.aMf(((Bundle)localObject).getString("warning_title"));
      locala.aMg(((Bundle)localObject).getString("warning_content"));
      locala.aaB(2131755793).b(new DialogInterface.OnClickListener()
      {
    ...
    for (;;)
    {
      ...
      if (2 == i)
      {
        ...
        locala.aau(2131755852);
        locala.aMg(getString(2131755847));
        locala.aaB(2131755841).b(new DialogInterface.OnClickListener()
        {
          public final void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
          {
      ...
      else
      {
        ...
        ((f.a)localObject).wZ(false);
        ((f.a)localObject).aMo(getString(2131755812)).aMt(getString(2131755795)).aMs(getString(2131755813)).c(new f.c()
        {
  ...
  public static void b(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    com.tencent.mm.hellhoundlib.a.a.a(paramContext, ((com.tencent.mm.hellhoundlib.b.a)localObject).adn(), "com/tencent/mm/permission/PermissionWarningDialog", "showReportAppListAlert", "(Landroid/content/Context;ZZ)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
  ...
  public static void cL(Context paramContext)
  {
    ...
    ((Intent)localObject).addFlags(805306368);
    localObject = new com.tencent.mm.hellhoundlib.b.a().bd(localObject);
    com.tencent.mm.hellhoundlib.a.a.a(paramContext, ((com.tencent.mm.hellhoundlib.b.a)localObject).adn(), "com/tencent/mm/permission/PermissionWarningDialog", "showMicroPhoneMuteAlert", "(Landroid/content/Context;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
    paramContext.startActivity((Intent)((com.tencent.mm.hellhoundlib.b.a)localObject).lS(0));
