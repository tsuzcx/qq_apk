  ...
  implements h
{
  ...
  protected short[][] dwL = (short[][])Array.newInstance(Short.TYPE, new int[] { 1, 1 });
  protected int dwM = 1;
  protected int dwN = 1;
  protected short[] dwO = new short[1];
  protected int dwP = 1;
  protected com.tencent.mm.audio.mix.a.b dwQ;
  ...
  public final boolean a(com.tencent.mm.audio.mix.a.b paramb, List<e> paramList)
  {
    ...
    {
      localObject1[i] = ((e)paramList.get(i)).dtQ;
      i += 1;
    }
    this.dwQ = paramb;
    ...
    while (localObject1 == null)
    {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          {
            com.tencent.mm.audio.mix.i.b.e("MicroMsg.Mix.BaseAudioMixAlgorithm", "column of the road of audio + " + i + " is different.");
            localObject1 = null;
            break;
          }
          i += 1;
        ...
        if ((k != this.dwM) || (m != this.dwN))
        {
          this.dwL = ((short[][])Array.newInstance(Short.TYPE, new int[] { k, m }));
          this.dwM = k;
          this.dwN = m;
        }
        i = 0;
        while (i < k)
        {
          Arrays.fill(this.dwL[i], 0, m - 1, (short)0);
          int j = 0;
          while (j < m)
          {
            this.dwL[i][j] = ((short)(localObject1[i][(j * 2)] & 0xFF | (localObject1[i][(j * 2 + 1)] & 0xFF) << 8));
            j += 1;
          }
          i += 1;
        }
        ...
        {
          this.dwP = m;
          this.dwO = new short[m];
        }
        Arrays.fill(this.dwO, 0, m - 1, (short)0);
        localObject1 = H(k, m, localObject2.length);
      }
    }
    paramb.dtQ = ((byte[])localObject1);
    paramb.channels = ((e)paramList.get(0)).channels;
    paramb.sampleRate = ((e)paramList.get(0)).sampleRate;
    return true;
  }
  
  protected final byte[] ci(int paramInt1, int paramInt2)
  {
    byte[] arrayOfByte2 = ZD();
    byte[] arrayOfByte1;
    ...
    {
      arrayOfByte1[(paramInt1 * 2)] = ((byte)(this.dwO[paramInt1] & 0xFF));
      arrayOfByte1[(paramInt1 * 2 + 1)] = ((byte)((this.dwO[paramInt1] & 0xFF00) >> 8));
      paramInt1 += 1;
    }
    return arrayOfByte1;
  }
  
  protected final short jf(int paramInt)
  {
