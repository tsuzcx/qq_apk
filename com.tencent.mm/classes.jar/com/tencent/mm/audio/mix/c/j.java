  ...
  implements i
{
  ...
  public final byte[] ae(byte[] paramArrayOfByte)
  {
    ...
    int k = localObject.length * this.hrS / this.hrR;
    i = k;
    if (this.hrS % this.hrR != 0) {
      i = k + 1;
    }
    paramArrayOfByte = new short[i];
    if (SilkResampleJni.resamplePcm(this.fileName, this.hrR, this.hrS, (short[])localObject, localObject.length, paramArrayOfByte) == -1)
    {
