...
public final class d
  implements a
{
  private com.tencent.qqpinyin.voicerecoapi.a daB;
  private a daC;
  BlockingQueue<g.a> dam;
  boolean dan;
  String dao;
  ...
  public static boolean Q(String paramString1, String paramString2)
  {
    ...
    ad.i("MicroMsg.SpeexWriter", "[voiceControl] decodePCMToSpeex pcmLen = " + ((com.tencent.mm.vfs.e)localObject).length());
    try
    {
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          localObject = paramString1;
          arrayOfByte1 = locala.ac(arrayOfByte2, i);
          ...
          localObject = paramString1;
          ad.i("MicroMsg.SpeexWriter", "[voiceControl] appendToFile " + j + ", readLen = " + i);
        }
        localObject = paramString1;
      }
      ...
      locala.flZ();
      localObject = paramString1;
      ad.i("MicroMsg.SpeexWriter", "[voiceControl] decodePCMToSpeex = " + (System.currentTimeMillis() - l));
      AppMethodBeat.o(130030);
      return true;
    }
    catch (Exception paramString1)
    {
      ad.e("MicroMsg.SpeexWriter", "[voiceControl] Exception in decodePCMToSpeex, " + paramString1.getMessage());
      AppMethodBeat.o(130030);
    }
    return false;
  }
  ...
  public final void PQ()
  {
    ...
    //   5: ldc 64
    //   7: ldc 163
    //   9: invokestatic 98	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   12: aload_0
    //   13: monitorenter
    //   14: aload_0
    //   15: iconst_1
    //   16: putfield 41	com/tencent/mm/audio/e/d:dan	Z
    //   19: aload_0
    //   20: monitorexit
    //   21: aload_0
    //   22: getfield 165	com/tencent/mm/audio/e/d:daC	Lcom/tencent/mm/audio/e/d$a;
    //   25: ifnull +30 -> 55
    //   28: aload_0
    //   29: getfield 165	com/tencent/mm/audio/e/d:daC	Lcom/tencent/mm/audio/e/d$a;
    //   32: astore_1
    //   33: aload_1
    //   34: getfield 169	com/tencent/mm/audio/e/d$a:daz	Ljava/util/concurrent/Future;
    //   37: ifnull +13 -> 50
    //   40: aload_1
    //   41: getfield 169	com/tencent/mm/audio/e/d$a:daz	Ljava/util/concurrent/Future;
    //   44: invokeinterface 175 1 0
    //   49: pop
    //   50: aload_0
    //   51: aconst_null
    //   52: putfield 165	com/tencent/mm/audio/e/d:daC	Lcom/tencent/mm/audio/e/d$a;
    //   55: aload_0
    //   56: getfield 177	com/tencent/mm/audio/e/d:daB	Lcom/tencent/qqpinyin/voicerecoapi/a;
    //   59: ifnull +16 -> 75
    //   62: aload_0
    //   63: getfield 177	com/tencent/mm/audio/e/d:daB	Lcom/tencent/qqpinyin/voicerecoapi/a;
    //   66: invokevirtual 109	com/tencent/qqpinyin/voicerecoapi/a:flZ	()I
    //   69: pop
    //   70: aload_0
    //   71: aconst_null
    //   72: putfield 177	com/tencent/mm/audio/e/d:daB	Lcom/tencent/qqpinyin/voicerecoapi/a;
    //   75: aload_0
    ...
    //   111: ldc 64
    //   113: ldc 184
    //   115: invokestatic 72	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   118: goto -63 -> 55
    //   121: astore_1
    //   122: ldc 64
    //   124: ldc 186
    ...
    //   136: aastore
    //   137: invokestatic 190	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   140: goto -85 -> 55
    //   143: astore_1
    //   144: ldc 64
    ...
    //   155: aload_0
    //   156: getfield 194	com/tencent/mm/audio/e/d:dao	Ljava/lang/String;
    ...
    //   177: invokestatic 72	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   180: goto -91 -> 89
  ...
  public final boolean PR()
  {
    ...
    this.daB = new com.tencent.qqpinyin.voicerecoapi.a();
    int i = this.daB.flY();
    if (i != 0)
    {
      ad.e("MicroMsg.SpeexWriter", "resetWriter speexInit failed: ".concat(String.valueOf(i)));
  ...
  public final int a(g.a parama, int paramInt, boolean paramBoolean)
  {
    ...
    if ((this.daB == null) || (parama.buf == null) || (parama.cZc == 0))
    {
    ...
    try
    {
      parama = this.daB.ac(parama.buf, parama.cZc);
      if ((parama != null) && (parama.length > 0))
      {
        ad.d("MicroMsg.SpeexWriter", "write to file, len: %d", new Object[] { Integer.valueOf(parama.length) });
      ...
      {
        ad.e("MicroMsg.SpeexWriter", parama);
        AppMethodBeat.o(130027);
        return -1;
      }
      return -1;
    ...
    {
      ad.e("MicroMsg.SpeexWriter", "write to file failed", new Object[] { parama });
      AppMethodBeat.o(130027);
    }
  }
  ...
  public final boolean fR(String paramString)
  {
    ...
    ad.i("MicroMsg.SpeexWriter", "initWriter, path: ".concat(String.valueOf(paramString)));
    if (paramString == null)
    {
    ...
    try
    {
      ...
      if (i != 0)
      {
        ad.e("MicroMsg.SpeexWriter", "speexInit failed: ".concat(String.valueOf(i)));
        AppMethodBeat.o(130025);
        return false;
      }
    }
    ...
    try
    {
      ...
      label105:
      ad.e("MicroMsg.SpeexWriter", "Error on init file: ", new Object[] { paramString });
      AppMethodBeat.o(130025);
      return false;
      AppMethodBeat.o(130025);
      return true;
    ...
    implements com.tencent.e.i.e, h
  {
    ...
    public final void run()
    {
      ...
      for (;;)
      {
        ...
        {
          boolean bool = this.daD.dan;
          ad.d("MicroMsg.SpeexWriter", "ThreadSpeex in: " + bool + " queueLen: " + this.daD.dam.size());
          if (bool) {
            if (this.daD.dam.isEmpty()) {
              break;
            }
          }
        }
        try
        {
          ??? = (g.a)this.daD.dam.poll(200L, TimeUnit.MILLISECONDS);
          if (??? != null) {
            break label159;
          }
          ad.e("MicroMsg.SpeexWriter", "poll byteBuf is null, " + this.daD.dao);
        }
        ...
        continue;
        label159:
        this.daD.a(localInterruptedException, 0, false);
      }
      AppMethodBeat.o(130023);
    }
  }
