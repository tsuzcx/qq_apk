...
public final class d
{
  ...
  public SparseArray<e> lZL;
  
  static
  {
    AppMethodBeat.i(131986);
    lZM = at.acHq + "configlist/";
  ...
  public static int aRq()
  {
    ...
    String str = ((a)h.ax(a.class)).aRC().getValue("VoiceVOIPSwitch");
  ...
  public static String rh(int paramInt)
  {
    ...
    String str = lZM + "config_" + paramInt + ".xml";
  ...
  private void ri(int paramInt)
  {
    ...
    try
    {
      Object localObject4 = new u(rh(paramInt));
      ...
      if (((u)localObject4).jKS())
      {
        localObject2 = localInputStreamReader;
        localObject1 = localBufferedReader;
        localInputStream = y.ao((u)localObject4);
  ...
  public final boolean a(u paramu1, u paramu2)
  {
    ...
    //   5: aload_1
    //   6: invokevirtual 140	com/tencent/mm/vfs/u:jKS	()Z
    //   9: ifeq +434 -> 443
    //   12: aload_1
    //   13: invokevirtual 185	com/tencent/mm/vfs/u:isDirectory	()Z
    //   16: ifeq +91 -> 107
    //   19: aload_2
    //   20: invokevirtual 140	com/tencent/mm/vfs/u:jKS	()Z
    //   23: ifne +8 -> 31
    //   26: aload_2
    //   27: invokevirtual 188	com/tencent/mm/vfs/u:jKY	()Z
    //   30: pop
    //   31: aload_1
    //   32: invokevirtual 192	com/tencent/mm/vfs/u:jKX	()[Lcom/tencent/mm/vfs/u;
    //   35: astore 5
    //   37: iconst_0
    //   38: istore_3
    //   39: iconst_0
    ...
    //   55: aload_0
    //   56: aload 6
    //   58: new 131	com/tencent/mm/vfs/u
    //   61: dup
    //   62: aload_2
    //   63: getfield 196	com/tencent/mm/vfs/u:mUri	Landroid/net/Uri;
    //   66: invokestatic 202	com/tencent/mm/vfs/ah:v	(Landroid/net/Uri;)Ljava/lang/String;
    //   69: aload 6
    //   71: invokevirtual 205	com/tencent/mm/vfs/u:getName	()Ljava/lang/String;
    //   74: invokespecial 207	com/tencent/mm/vfs/u:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   77: invokevirtual 209	com/tencent/mm/k/d:a	(Lcom/tencent/mm/vfs/u;Lcom/tencent/mm/vfs/u;)Z
    //   80: istore 4
    //   82: iload 4
    //   84: ifeq +8 -> 92
    //   87: aload_1
    //   88: invokevirtual 212	com/tencent/mm/vfs/u:diJ	()Z
    //   91: pop
    //   92: iload_3
    //   93: iconst_1
    //   94: iadd
    ...
    //   106: ireturn
    //   107: aload_1
    //   108: invokestatic 146	com/tencent/mm/vfs/y:ao	(Lcom/tencent/mm/vfs/u;)Ljava/io/InputStream;
    //   111: astore 5
    //   113: aload_2
    //   114: invokestatic 216	com/tencent/mm/vfs/y:ap	(Lcom/tencent/mm/vfs/u;)Ljava/io/OutputStream;
    //   117: astore 7
    //   119: aload 7
    //   121: astore 6
    //   123: aload 5
    ...
    //   247: astore_2
    //   248: aload_1
    //   249: invokevirtual 212	com/tencent/mm/vfs/u:diJ	()Z
    //   252: pop
    //   253: aload 5
    //   255: ifnull +8 -> 263
    //   258: aload 5
  ...
  public final e aRp()
  {
    ...
    if (this.lZL.get(1) == null) {
      ri(1);
    }
    e locale = (e)this.lZL.get(1);
  ...
  public final boolean aRr()
  {
    ...
    if (Util.getInt(at("ShowConfig", "hidePoiOversea"), 1) == 1) {}
    for (;;)
    {
  ...
  public final boolean aRs()
  {
    ...
    if (Util.getInt(at("ShowConfig", "showRecvTmpMsgBtn"), 0) == 1) {}
    for (;;)
    {
  ...
  public final List<String> aRt()
  {
    ...
    Object localObject3 = at("IBeacon", "Content");
    Object localObject2;
  ...
  public final int aRu()
  {
    ...
    int i = Util.getInt(at("MailApp", "ShowMailAppRecommend"), 0);
  ...
  public final String aRv()
  {
    ...
    String str = at("MailApp", "MailAppRedirectUrAndroid");
    AppMethodBeat.o(131984);
    return str;
  }
  
  public final String at(String paramString1, String paramString2)
  {
    ...
    if (locale.lZO.containsKey(paramString1))
    {
      paramString1 = (String)((HashMap)locale.lZO.get(paramString1)).get(paramString2);
      AppMethodBeat.o(131975);
      return paramString1;
    }
    AppMethodBeat.o(131975);
  ...
  public final String getMailAppEnterUlAndroid()
  {
    ...
    String str = at("MailApp", "MailAppEnterMailAppUrlAndroid");
  ...
  public final void z(int paramInt, String paramString)
  {
    ...
    locale.lZP = XmlParser.parseXml(paramString, "ConfigList", null);
    if (locale.lZP.containsKey(".ConfigList.$version")) {
      locale.version = Util.getInt((String)locale.lZP.get(".ConfigList.$version"), 0);
    }
    int i = 0;
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        if (locale.lZP.get((String)localObject1 + ".$name") == null) {
          break;
        }
        str = (String)locale.lZP.get((String)localObject1 + ".$name");
      ...
      for (paramString = "";; paramString = Integer.valueOf(j))
      {
        ...
        if (!locale.lZP.containsKey(localObject2)) {
          break label534;
        }
        localObject3 = (String)locale.lZP.get(localObject3);
        localObject2 = (String)locale.lZP.get(localObject2);
        paramString = (String)locale.lZP.get(paramString);
        Log.d("MicroMsg.ConfigListInfo", "itemKey " + (String)localObject3 + " itemValue " + (String)localObject2 + " itemLang " + paramString);
        if ((paramString == null) || (e.DK(paramString)))
        {
          if (!locale.lZO.containsKey(str)) {
            locale.lZO.put(str, new HashMap());
          }
          ((HashMap)locale.lZO.get(str)).put(localObject3, localObject2);
        }
        j += 1;
        break label187;
