...
{
  public static int gfq = -1;
  public static final long[] gfr = { 17179869184L, 34359738368L, 68719476736L, 137438953472L, 274877906944L };
  public static final long[] gfs = { 104857600L, 314572800L, 314572800L, 314572800L, 314572800L };
  ...
  public static int adB()
  {
    ...
    if (l3 > 0L) {
      ...
      {
        i = 2;
        ad.i("MicroMsg.DbChecker", "checkRomSparespace[%d] available:%d all:%d freeSize :%d availPercent %f mobileSizeIndex %d", new Object[] { Integer.valueOf(i), Long.valueOf(l1), Long.valueOf(l3), Long.valueOf(l4), Double.valueOf(d), Integer.valueOf(gfq) });
