  ...
  implements k
{
  ...
  private a(String paramString, LinkedList<String> paramLinkedList, int paramInt1, int paramInt2)
  {
    ...
    localObject = (biy)this.rr.gUS.gUX;
    if (paramInt2 > 0)
    {
      ((biy)localObject).DGy = new dvc();
      ((biy)localObject).DGy.scene = paramInt2;
    }
    ((biy)localObject).hnC = paramString;
    ((biy)localObject).DGv = paramLinkedList;
    ((biy)localObject).DGx = paramInt1;
  ...
  public final biy aea()
  {
    if (this.rr == null) {
      return null;
    }
    return (biy)this.rr.gUS.gUX;
  }
  
  public final biz aeb()
  {
    return (biz)this.rr.gUT.gUX;
  }
  ...
  public final void onGYNetEnd(int paramInt1, int paramInt2, int paramInt3, String paramString, q paramq, byte[] paramArrayOfByte)
  {
    ...
    if (this.gbs != null) {
      this.gbs.a(paramInt2, paramInt3, paramString, this);
    }
