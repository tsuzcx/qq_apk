  ...
  implements a
{
  ...
  public f(String paramString)
  {
    ...
    this.ggt = h.tV(paramString);
    AppMethodBeat.o(158498);
  }
  
  private f bk(Object paramObject)
  {
    AppMethodBeat.i(158505);
    this.ggt.bj(paramObject);
    AppMethodBeat.o(158505);
    return this;
  }
  
  private f cL(int paramInt1, int paramInt2)
  {
    AppMethodBeat.i(158508);
    this.ggt.cK(paramInt1, paramInt2);
  ...
  private f d(int paramInt, double paramDouble)
  {
    ...
    this.ggt.c(paramInt, paramDouble);
  ...
  private f g(int paramInt, Object paramObject)
  {
    ...
    this.ggt.f(paramInt, paramObject);
  ...
  private f k(double paramDouble)
  {
    ...
    this.ggt.j(paramDouble);
    AppMethodBeat.o(158502);
    return this;
  }
  
  private f mg(int paramInt)
  {
    AppMethodBeat.i(158503);
    this.ggt.mb(paramInt);
  ...
  private f mi(int paramInt)
  {
    ...
    f localf = new f(this.ggt.md(paramInt));
    AppMethodBeat.o(158531);
    return localf;
  }
  
  private i mj(int paramInt)
  {
    AppMethodBeat.i(158532);
    i locali = new i(this.ggt.me(paramInt));
    AppMethodBeat.o(158532);
    return locali;
  }
  
  private f oZ(long paramLong)
  {
    AppMethodBeat.i(158504);
    this.ggt.oY(paramLong);
  ...
  private f z(int paramInt, boolean paramBoolean)
  {
    ...
    this.ggt.y(paramInt, paramBoolean);
  ...
  public final Object get(int paramInt)
  {
    ...
    Object localObject = this.ggt.get(paramInt);
  ...
  public final boolean getBoolean(int paramInt)
  {
    ...
    boolean bool = this.ggt.getBoolean(paramInt);
  ...
  public final double getDouble(int paramInt)
  {
    ...
    double d = this.ggt.getDouble(paramInt);
  ...
  public final int getInt(int paramInt)
  {
    ...
    paramInt = this.ggt.getInt(paramInt);
  ...
  public final long getLong(int paramInt)
  {
    ...
    long l = this.ggt.getLong(paramInt);
  ...
  public final String getString(int paramInt)
  {
    ...
    String str = this.ggt.getString(paramInt);
  ...
  public final boolean isNull(int paramInt)
  {
    ...
    boolean bool = this.ggt.isNull(paramInt);
  ...
  public final int length()
  {
    ...
    int i = this.ggt.length();
    AppMethodBeat.o(158500);
    return i;
  }
  
  public final f mh(int paramInt)
  {
    AppMethodBeat.i(158530);
    f localf = new f(this.ggt.mc(paramInt));
    AppMethodBeat.o(158530);
    return localf;
  }
  
  public final i mk(int paramInt)
  {
    AppMethodBeat.i(158533);
    i locali = new i(this.ggt.mf(paramInt));
  ...
  public final Object opt(int paramInt)
  {
    ...
    Object localObject = this.ggt.opt(paramInt);
  ...
  public final boolean optBoolean(int paramInt)
  {
    ...
    boolean bool = this.ggt.optBoolean(paramInt);
  ...
  public final boolean optBoolean(int paramInt, boolean paramBoolean)
  {
    ...
    paramBoolean = this.ggt.optBoolean(paramInt, paramBoolean);
  ...
  public final double optDouble(int paramInt)
  {
    ...
    double d = this.ggt.optDouble(paramInt);
  ...
  public final double optDouble(int paramInt, double paramDouble)
  {
    ...
    paramDouble = this.ggt.optDouble(paramInt, paramDouble);
  ...
  public final int optInt(int paramInt)
  {
    ...
    paramInt = this.ggt.optInt(paramInt);
  ...
  public final int optInt(int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = this.ggt.optInt(paramInt1, paramInt2);
  ...
  public final long optLong(int paramInt)
  {
    ...
    long l = this.ggt.optLong(paramInt);
  ...
  public final long optLong(int paramInt, long paramLong)
  {
    ...
    paramLong = this.ggt.optLong(paramInt, paramLong);
  ...
  public final String optString(int paramInt)
  {
    ...
    String str = this.ggt.optString(paramInt);
  ...
  public final String optString(int paramInt, String paramString)
  {
    ...
    paramString = this.ggt.optString(paramInt, paramString);
  ...
  public final Object remove(int paramInt)
  {
    ...
    Object localObject = this.ggt.remove(paramInt);
  ...
  public final String toString(int paramInt)
  {
    ...
    String str = this.ggt.toString(paramInt);
