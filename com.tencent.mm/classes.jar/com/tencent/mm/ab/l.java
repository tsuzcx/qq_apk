  ...
  implements c
{
  ...
  public l(String paramString)
  {
    ...
    this.ggy = com.eclipsesource.a.a.Y(paramString).qH();
  ...
  public final c N(String paramString, int paramInt)
  {
    ...
    this.ggy.a(paramString, com.eclipsesource.a.a.dB(paramInt));
  ...
  public final c b(String paramString, double paramDouble)
  {
    ...
    this.ggy.a(paramString, com.eclipsesource.a.a.d(paramDouble));
  ...
  public final c g(String paramString, Object paramObject)
  {
    ...
    j.a(this.ggy, paramString, paramObject);
  ...
  public final boolean getBoolean(String paramString)
  {
    ...
    h localh = this.ggy.ab(paramString);
    if (localh == null)
    {
  ...
  public final boolean has(String paramString)
  {
    ...
    if (this.ggy.ab(paramString) != null)
    {
  ...
  public final Iterator<String> keys()
  {
    ...
    Iterator localIterator = Collections.unmodifiableList(this.ggy.aPu).iterator();
  ...
  public final Object opt(String paramString)
  {
    ...
    paramString = this.ggy.ab(paramString);
    if (paramString == null)
    {
    ...
    {
      boolean bool = paramString.qD();
      AppMethodBeat.o(158689);
      return Boolean.valueOf(bool);
    }
    if (paramString.isArray())
    {
      paramString = new k(paramString.qC());
      AppMethodBeat.o(158689);
      return paramString;
    }
    if (paramString.isObject())
    {
      paramString = new l(paramString.qH());
      AppMethodBeat.o(158689);
      return paramString;
    }
  ...
  public final String optString(String paramString1, String paramString2)
  {
    ...
    paramString1 = this.ggy.ab(paramString1);
  ...
  public final c r(String paramString, long paramLong)
  {
    ...
    this.ggy.a(paramString, com.eclipsesource.a.a.s(paramLong));
  ...
  public final Object remove(String paramString)
  {
    ...
    if (locale.isBoolean())
    {
      boolean bool = locale.qD();
      AppMethodBeat.o(158685);
      return Boolean.valueOf(bool);
    }
    if (locale.isArray())
    {
      paramString = new k(locale.qC());
      AppMethodBeat.o(158685);
      return paramString;
    }
    if (locale.isObject())
    {
      paramString = new l(locale.qH());
      AppMethodBeat.o(158685);
      return paramString;
    }
    if (locale.isString())
    {
      paramString = locale.rf();
      AppMethodBeat.o(158685);
      return paramString;
    }
    AppMethodBeat.o(158685);
  ...
  public final c u(String paramString, boolean paramBoolean)
  {
    ...
    this.ggy.a(paramString, com.eclipsesource.a.a.aL(paramBoolean));
