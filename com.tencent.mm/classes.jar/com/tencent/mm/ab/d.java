  ...
  implements c
{
  ...
  public d(String paramString)
  {
    ...
    try
    {
      this.hpx = new JSONObject(paramString);
  ...
  public d(Map paramMap)
  {
    ...
    this.hpx = new JSONObject(paramMap);
  ...
  public final a FA(String paramString)
  {
    ...
    try
    {
      paramString = this.hpx.getJSONArray(paramString);
      if (paramString == null)
      {
  ...
  public final a FB(String paramString)
  {
    ...
    paramString = this.hpx.optJSONArray(paramString);
    if (paramString == null)
    {
  ...
  public final c FC(String paramString)
  {
    ...
    try
    {
      paramString = this.hpx.getJSONObject(paramString);
      if (paramString == null)
      {
  ...
  public final c FD(String paramString)
  {
    ...
    paramString = this.hpx.optJSONObject(paramString);
    if (paramString == null)
    {
  ...
  public final c T(String paramString, int paramInt)
  {
    ...
    try
    {
      this.hpx.put(paramString, paramInt);
  ...
  public final c b(String paramString, double paramDouble)
  {
    ...
    try
    {
      this.hpx.put(paramString, paramDouble);
  ...
  public final c f(String paramString, Object paramObject)
  {
    ...
    //   9: ifeq +26 -> 35
    //   12: aload_0
    //   13: getfield 24	com/tencent/mm/ab/d:hpx	Lorg/json/JSONObject;
    //   16: aload_1
    //   17: aload_2
    //   18: checkcast 2	com/tencent/mm/ab/d
    //   21: getfield 24	com/tencent/mm/ab/d:hpx	Lorg/json/JSONObject;
    ...
    //   34: areturn
    //   35: aload_0
    //   36: getfield 24	com/tencent/mm/ab/d:hpx	Lorg/json/JSONObject;
    //   39: aload_1
    //   40: aload_2
  ...
  public final Object get(String paramString)
  {
    ...
    try
    {
      paramString = this.hpx.get(paramString);
  ...
  public final boolean getBoolean(String paramString)
  {
    ...
    try
    {
      boolean bool = this.hpx.getBoolean(paramString);
  ...
  public final double getDouble(String paramString)
  {
    ...
    try
    {
      double d = this.hpx.getDouble(paramString);
  ...
  public final int getInt(String paramString)
  {
    ...
    try
    {
      int i = this.hpx.getInt(paramString);
  ...
  public final long getLong(String paramString)
  {
    ...
    try
    {
      long l = this.hpx.getLong(paramString);
  ...
  public final String getString(String paramString)
  {
    ...
    try
    {
      paramString = this.hpx.getString(paramString);
  ...
  public final boolean has(String paramString)
  {
    ...
    boolean bool = this.hpx.has(paramString);
  ...
  public final boolean isNull(String paramString)
  {
    ...
    boolean bool = this.hpx.isNull(paramString);
  ...
  public final Iterator<String> keys()
  {
    ...
    Iterator localIterator = this.hpx.keys();
  ...
  public final boolean optBoolean(String paramString, boolean paramBoolean)
  {
    ...
    paramBoolean = this.hpx.optBoolean(paramString, paramBoolean);
  ...
  public final double optDouble(String paramString, double paramDouble)
  {
    ...
    paramDouble = this.hpx.optDouble(paramString, paramDouble);
  ...
  public final int optInt(String paramString, int paramInt)
  {
    ...
    paramInt = this.hpx.optInt(paramString, paramInt);
  ...
  public final long optLong(String paramString, long paramLong)
  {
    ...
    paramLong = this.hpx.optLong(paramString, paramLong);
  ...
  public final String optString(String paramString)
  {
    ...
    paramString = this.hpx.optString(paramString);
  ...
  public final String optString(String paramString1, String paramString2)
  {
    ...
    paramString1 = this.hpx.optString(paramString1, paramString2);
  ...
  public final Object remove(String paramString)
  {
    ...
    paramString = this.hpx.remove(paramString);
  ...
  public final c u(String paramString, long paramLong)
  {
    ...
    try
    {
      this.hpx.put(paramString, paramLong);
  ...
  public final c v(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      this.hpx.put(paramString, paramBoolean);
