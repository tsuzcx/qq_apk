  ...
  implements Cloneable
{
  ...
  private static Paint kas;
  private Path auD;
  private float eYO;
  private LinkedList<b> fmf;
  public a fmg;
  private Bitmap kar;
  ...
  static
  {
    ...
    kas.setStyle(Paint.Style.STROKE);
    kas.setColor(-16776961);
    kas.setStrokeCap(Paint.Cap.ROUND);
  ...
  public e(a parama, Path paramPath, float paramFloat, Bitmap paramBitmap)
  {
    ...
    this.fmg = parama;
    this.kar = paramBitmap;
    this.auD = paramPath;
    this.eYO = paramFloat;
    kas.setStrokeWidth(a.an(24.0F) * paramFloat);
  ...
  public final void draw(Canvas paramCanvas)
  {
    ...
    if (this.fmg == a.kat)
    {
      localObject1 = this.kar;
      if ((localObject1 != null) && (!((Bitmap)localObject1).isRecycled()))
      {
        paramCanvas.saveLayer(0.0F, 0.0F, ((Bitmap)localObject1).getWidth(), ((Bitmap)localObject1).getHeight(), null, 31);
        paramCanvas.drawColor(0, PorterDuff.Mode.CLEAR);
        paramCanvas.drawPath(this.auD, kas);
        kas.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_IN));
        paramCanvas.drawBitmap((Bitmap)localObject1, 0.0F, 0.0F, kas);
        kas.setXfermode(null);
        paramCanvas.restore();
      }
    ...
    if (this.fmg == a.kau)
    {
      ...
      localObject1 = (b)this.fmf.getLast();
      ...
      kas.setStyle(Paint.Style.FILL);
      kas.setColorFilter(new LightingColorFilter(i, 1));
      if (localObject2 == null) {
        break label462;
      }
      f2 = ((b)localObject1).aGt - ((Bitmap)localObject2).getWidth() * 1.0F / 2.0F;
      f1 = ((b)localObject1).aGu - ((Bitmap)localObject2).getHeight() * 1.0F / 2.0F;
    }
    for (;;)
    {
      if ((j > 0) && (j <= 20))
      ...
      {
        paramCanvas.save();
        paramCanvas.rotate(-((b)localObject1).rotation, ((b)localObject1).aGt, ((b)localObject1).aGu);
        if (localObject2 != null) {
          paramCanvas.drawBitmap((Bitmap)localObject2, f2, f1, kas);
        }
        paramCanvas.restore();
        kas.setStyle(Paint.Style.STROKE);
        kas.setColorFilter(null);
        AppMethodBeat.o(9271);
        return;
        if (80 < j)
        {
  ...
  public static final class b
  {
    ...
    public b(float paramFloat1, int paramInt, float paramFloat2, float paramFloat3, float paramFloat4)
    {
      ...
      this.aGt = paramFloat3;
      this.aGu = paramFloat4;
    }
  }
}
