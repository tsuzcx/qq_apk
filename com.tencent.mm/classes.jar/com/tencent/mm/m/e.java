...
public class e
{
  private HashMap<String, String> fKW;
  ...
  private void a(Map<String, String> paramMap, boolean paramBoolean)
  {
    ...
    if (i < 10000)
    {
      ...
      if (paramBoolean)
      {
        ...
        if (i == 0)
        {
          ...
          if ((str1 == null) || (bs.isNullOrNil(str1.trim()))) {
            break label256;
          }
          localHashMap = this.fKW;
          str2 = str1.trim();
      ...
      for (Object localObject1 = localObject2;; localObject1 = "")
      {
        ...
        ac.d("MicroMsg.DynamicConfig", "put %s %s", new Object[] { str1.trim(), localObject2 });
        i += 1;
        break;
    ...
    label256:
    ac.d("MicroMsg.DynamicConfig", "All dynamicConfig:%s", new Object[] { this.fKW.toString() });
    AppMethodBeat.o(132000);
  }
  ...
  public final void a(String paramString, Map<String, String> paramMap, boolean paramBoolean)
  {
    for (;;)
    {
      try
      {
        ...
        ac.i("MicroMsg.DynamicConfig", "update dynacfg. increment:%b, md5:%s", new Object[] { Boolean.valueOf(paramBoolean), i.aKe(paramString) });
        if (paramBoolean)
        {
          g.agS();
          g.agR().agA().set(278530, paramString);
          if (paramMap == null) {
            break label142;
          }
      ...
      g.agR().agA().set(278529, paramString);
      g.agS();
      g.agR().agA().set(278530, "");
      continue;
      label142:
  ...
  public final int getInt(String paramString, int paramInt)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ac.e("MicroMsg.DynamicConfig", "parseInt failed, val: ".concat(String.valueOf(paramString)));
      }
    }
  ...
  public final String getValue(String paramString)
  {
    try
    {
      ...
      if (!this.fKX)
      {
        ac.e("MicroMsg.DynamicConfig", "DynamicConfig hadnot load");
        tX();
      }
      ac.d("MicroMsg.DynamicConfig", "get configs.get(config) %s %s", new Object[] { paramString.trim(), this.fKW.get(paramString) });
      paramString = (String)this.fKW.get(paramString);
  ...
  public final void put(String paramString1, String paramString2)
  {
    try
    {
      ...
      {
        ac.d("MicroMsg.DynamicConfig", "put configs.put(key,value) %s %s", new Object[] { paramString1.trim(), paramString2 });
        this.fKW.put(paramString1, paramString2);
      }
  ...
  protected final void r(String paramString, boolean paramBoolean)
  {
    ...
    a(bv.L(paramString, "sysmsg"), paramBoolean);
    AppMethodBeat.o(131999);
  }
  
  /* Error */
  public final java.util.List<String> sL(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   7: aload_0
    //   8: getfield 27	com/tencent/mm/m/e:fKX	Z
    //   11: ifne +14 -> 25
    //   14: ldc 83
    //   16: ldc 192
    //   18: invokestatic 189	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   21: aload_0
    //   22: invokevirtual 195	com/tencent/mm/m/e:tX	()V
    //   25: new 217	java/util/ArrayList
    //   28: dup
    //   29: invokespecial 218	java/util/ArrayList:<init>	()V
    //   32: astore_2
    //   33: aload_1
    //   34: invokestatic 77	com/tencent/mm/sdk/platformtools/bs:isNullOrNil	(Ljava/lang/String;)Z
    //   37: ifne +69 -> 106
    //   40: aload_0
    //   41: getfield 25	com/tencent/mm/m/e:fKW	Ljava/util/HashMap;
    ...
    //   82: aload_2
    //   83: aload_0
    //   84: getfield 25	com/tencent/mm/m/e:fKW	Ljava/util/HashMap;
    //   87: aload 4
    ...
    //   129: aastore
    //   130: invokestatic 91	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   133: ldc 215
    ...
    try
    {
      ...
      if (g.agR() != null)
      {
        ...
        if (g.agR().agA() != null)
        {
          this.fKX = true;
          g.agS();
          r((String)g.agR().agA().get(278529, null), false);
        }
      }
      g.agS();
      if (g.agR() != null)
      {
        ...
        if (g.agR().agA() != null)
        {
          this.fKX = true;
          g.agS();
          r((String)g.agR().agA().get(278530, null), true);
        }
      }
