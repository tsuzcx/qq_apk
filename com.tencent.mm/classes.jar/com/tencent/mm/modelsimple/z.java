  ...
  implements k
{
  ...
  public z(String paramString1, String paramString2, int paramInt, SKBuiltinBuffer_t paramSKBuiltinBuffer_t)
  {
    ...
    ((b.a)localObject).gUU = new crs();
    ((b.a)localObject).gUV = new crt();
    ...
    localObject = (crs)this.rr.gUS.gUX;
    ((crs)localObject).oXj = bt.aGb(paramString1);
    ((crs)localObject).Ddo = paramString2;
    ((crs)localObject).EjU = paramInt;
    ((crs)localObject).CBc = paramSKBuiltinBuffer_t;
    ad.d("MicroMsg.NetSceneSetPwd", "summersetpwd md5:%s ticket:%s, type:%d, authkey:%s", new Object[] { paramString1, paramString2, Integer.valueOf(paramInt), bt.cv(com.tencent.mm.platformtools.z.a(paramSKBuiltinBuffer_t)) });
