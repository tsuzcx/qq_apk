  ...
  implements ScaleGestureDetector.OnScaleGestureListener
{
  ...
  public final boolean onScale(ScaleGestureDetector paramScaleGestureDetector)
  {
    ...
    PhotoView.c(this.agIr, f);
    PhotoView.b(this.agIr).postScale(f, f, paramScaleGestureDetector.getFocusX(), paramScaleGestureDetector.getFocusY());
    PhotoView.f(this.agIr);
    AppMethodBeat.o(164251);
    return true;
  }
