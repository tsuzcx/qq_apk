...
public final class f
{
  ...
  public boolean JCv;
  public boolean JCw;
  public LongSparseArray<h> JCx;
  public WeakReference<WxRecyclerAdapter<?>> JCy;
  ...
  public final boolean equals(Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof f))
      {
        ...
        if ((this.JCz != paramObject.JCz) || (this.width != paramObject.width) || (this.height != paramObject.height)) {}
      }
    }
    else {
      return true;
  ...
  {
    return (this.JCz * 31 + this.width) * 31 + this.height;
  }
  
  public final String toString()
  {
    AppMethodBeat.i(197337);
    String str = "WxItemShowInfo(spanIndex=" + this.JCz + ", width=" + this.width + ", height=" + this.height + ")";
