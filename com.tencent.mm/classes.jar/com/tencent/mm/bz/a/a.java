...
public final class a
{
  ...
  public static Bitmap b(Context paramContext, Bitmap paramBitmap, String paramString)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramContext == null) {
        ad.i("MicroMsg.QRCodeBitmapFactory", "createBitmap bm is error result %d %s", new Object[] { Integer.valueOf(i), bt.eGN().toString() });
      }
      for (;;)
      {
    ...
    ad.i("MicroMsg.QRCodeBitmapFactory", "result %d %s", new Object[] { Integer.valueOf(i), bt.eGN().toString() });
    AppMethodBeat.o(168778);
    return null;
  }
  ...
  public static Bitmap bT(Context paramContext, String paramString)
  {
 ...
 * Qualified Name:     com.tencent.mm.bz.a.a
