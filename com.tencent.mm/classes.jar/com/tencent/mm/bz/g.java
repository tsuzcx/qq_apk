...
public final class g
{
  ...
  private g(Context paramContext)
  {
    ...
    this.GiL = new f.b(paramContext, "recovery_setting");
    this.GiL.eRR();
    this.GiG = Math.max(this.GiL.getInt("setting_threshold_1", 3), 2);
    this.GiH = Math.max(this.GiL.getInt("setting_threshold_2", 4), 3);
    if (this.GiH < this.GiG) {
      this.GiH = this.GiG;
    }
    this.GiI = Math.max(this.GiL.getLong("setting_crash_interval", 10000L), 5000L);
    this.GiJ = Math.max(this.GiL.getLong("setting_crash_minimal_interval", 1000L), 0L);
    this.GiK = Math.max(this.GiL.getLong("setting_reset_delay", 5000L), 1000L);
    AppMethodBeat.o(194812);
  }
  
  public static g hG(Context paramContext)
  {
  ...
  public static final class a
  {
    ...
    private a(Context paramContext)
    {
      ...
      this.GiL = new f.a(paramContext, "recovery_enable").eRR();
      this.mEnabled = this.GiL.getBoolean("enable", true);
  ...
  public static final class b
  {
    ...
    private b(Context paramContext)
    {
      ...
      this.GiL = new f.b(paramContext, "recovery_log").eRU();
      this.GiM = this.GiL.getString("setting_log_path", new File(k.hM(paramContext), ".log").getAbsolutePath());
      AppMethodBeat.o(194808);
    }
    
    public static b hI(Context paramContext)
    {
    ...
    public final String eRY()
    {
      ...
      //   8: dup
      //   9: aload_0
      //   10: getfield 67	com/tencent/mm/bz/g$b:GiM	Ljava/lang/String;
      ...
      //   94: ldc 121
      //   96: aload_3
      //   97: invokestatic 127	com/tencent/mm/bz/a:w	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
      //   100: aload_2
      //   101: invokestatic 133	com/tencent/mm/bz/k$b:closeQuietly	(Ljava/lang/Object;)V
      //   104: ldc 91
      //   106: invokestatic 70	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
      //   109: aconst_null
      //   110: areturn
      //   111: aload_2
      //   112: invokestatic 133	com/tencent/mm/bz/k$b:closeQuietly	(Ljava/lang/Object;)V
      //   115: aload_3
      ...
      //   129: astore_1
      //   130: aload_1
      //   131: invokestatic 133	com/tencent/mm/bz/k$b:closeQuietly	(Ljava/lang/Object;)V
      //   134: ldc 91
 ...
 * Qualified Name:     com.tencent.mm.bz.g
