  ...
  extends MediaPlayer
{
  ...
  public final void setDataSource(Context paramContext, Uri paramUri, java.util.Map<java.lang.String, java.lang.String> paramMap)
  {
    ...
    //   8: bipush 26
    //   10: invokestatic 71	com/tencent/mm/compatible/util/d:ly	(I)Z
    //   13: ifeq +17 -> 30
    //   16: aload_0
    //   17: aload_1
    //   18: aload_2
    ...
    //   72: aconst_null
    //   73: ldc 100
    //   75: invokestatic 106	com/tencent/mm/vfs/i:a	(Landroid/net/Uri;Lcom/tencent/mm/vfs/a$e;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    //   78: astore_3
    //   79: aload_0
    //   80: aload_3
  ...
  public final void setDataSource(Context paramContext, Uri paramUri, java.util.Map<java.lang.String, java.lang.String> paramMap, java.util.List<java.net.HttpCookie> paramList)
  {
    ...
    //   50: aconst_null
    //   51: ldc 100
    //   53: invokestatic 106	com/tencent/mm/vfs/i:a	(Landroid/net/Uri;Lcom/tencent/mm/vfs/a$e;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    //   56: astore_3
    //   57: aload_0
    //   58: aload_3
  ...
  public final void setDataSource(java.lang.String paramString)
  {
    ...
    //   5: aload_1
    //   6: ldc 100
    //   8: invokestatic 136	com/tencent/mm/vfs/i:my	(Ljava/lang/String;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    //   11: astore 4
    //   13: aconst_null
    //   14: astore_3
    //   15: aload_0
    ...
    //   101: invokestatic 158	com/tencent/mm/sdk/platformtools/ad:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   104: aload_0
    //   105: aload_1
