...
public final class d
{
  public static int Xx()
  {
    ...
    if (i < j)
    {
      ...
      if (localCameraInfo.facing == 0) {
        ac.d("MicroMsg.CameraUtil", "tigercam get bid %d", new Object[] { Integer.valueOf(i) });
      }
    }
    for (;;)
    {
      ac.d("MicroMsg.CameraUtil", "tigercam getBackCameraId %d", new Object[] { Integer.valueOf(i) });
      AppMethodBeat.o(155645);
      return i;
      i += 1;
      break;
  ...
  public static int Xy()
  {
    ...
    if (i < j)
    {
      ...
      if (localCameraInfo.facing == 1) {
        ac.d("MicroMsg.CameraUtil", "tigercam get fid %d", new Object[] { Integer.valueOf(i) });
      }
    }
    for (;;)
    {
  ...
  public static d.a.a a(Context paramContext, int paramInt, Looper paramLooper)
  {
    ...
    if (ae.fJd.fEU == 1)
    {
      ac.d("MicroMsg.CameraUtil", "openCamera(), CameraUtilImpl20, cameraId = ".concat(String.valueOf(paramInt)));
      new e();
    ...
    if (ae.fJd.fEM)
    {
      ac.d("MicroMsg.CameraUtil", "openCamera(), CameraUtilImplConfig, cameraId = ".concat(String.valueOf(paramInt)));
      new i();
    ...
    {
      ac.d("MicroMsg.CameraUtil", "openCamera(), CameraUtilImpl23, cameraId = ".concat(String.valueOf(paramInt)));
      new g();
