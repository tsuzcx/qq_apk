  ...
  implements Parcelable
{
  ...
  List<MediaCodecProxyUtils.MediaCodecRetryInfo> gJZ;
  ...
  protected MediaCodecProxyUtils$MediaCodecRetryInfoWrapper(Parcel paramParcel)
  {
    ...
    this.gJZ = paramParcel.createTypedArrayList(MediaCodecProxyUtils.MediaCodecRetryInfo.CREATOR);
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    paramParcel.writeTypedList(this.gJZ);
