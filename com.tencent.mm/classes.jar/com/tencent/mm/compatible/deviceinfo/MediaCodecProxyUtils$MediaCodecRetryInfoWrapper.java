  ...
  implements Parcelable
{
  ...
  List<MediaCodecProxyUtils.MediaCodecRetryInfo> fFi;
  ...
  protected MediaCodecProxyUtils$MediaCodecRetryInfoWrapper(Parcel paramParcel)
  {
    ...
    this.fFi = paramParcel.createTypedArrayList(MediaCodecProxyUtils.MediaCodecRetryInfo.CREATOR);
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    paramParcel.writeTypedList(this.fFi);
