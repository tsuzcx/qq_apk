...
public final class LiveAnchorMicUserListView$c
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (this != paramObject)
    {
      if ((paramObject instanceof c))
      {
        ...
        if ((this.type != paramObject.type) || (!p.i(this.gZC, paramObject.gZC)) || (!p.i(this.title, paramObject.title))) {}
      }
    }
    else
    {
  ...
  public final String toString()
  {
    ...
    String str = "LiveMicListItem(type=" + this.type + ", user=" + this.gZC + ", title=" + this.title + ")";
