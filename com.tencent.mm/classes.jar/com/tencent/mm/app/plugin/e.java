  ...
  implements p
{
  ...
  public final String B(Context paramContext, String paramString)
  {
    ...
    paramContext = b.cK(paramContext, paramString);
  ...
  public final boolean a(Context paramContext, String paramString, DialogInterface.OnDismissListener paramOnDismissListener)
  {
    ...
    if (paramString.endsWith("@mailto@")) {
      r.b(paramContext, paramString.substring(0, paramString.length() - 8), paramOnDismissListener);
    }
    for (;;)
    {
      AppMethodBeat.o(19666);
      ...
      r.a(paramContext, paramString, paramOnDismissListener, localBundle);
    }
    AppMethodBeat.o(19666);
    return false;
  }
