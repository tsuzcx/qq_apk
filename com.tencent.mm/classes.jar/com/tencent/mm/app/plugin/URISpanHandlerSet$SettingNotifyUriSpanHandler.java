  ...
  extends URISpanHandlerSet.BaseUriSpanHandler
{
  ...
  final boolean a(m paramm, g paramg)
  {
    if (paramm.type == 9)
    {
      ...
      d.x(URISpanHandlerSet.a(this.byk), "setting", ".ui.setting.SettingsNotificationUI");
      if (paramg != null) {
        paramg.b(paramm);
      }
      return true;
  ...
  final boolean a(String paramString, boolean paramBoolean, s params, Bundle paramBundle)
  {
    if (paramString.equals("weixin://setting/notify"))
    {
      ...
      d.b(URISpanHandlerSet.a(this.byk), "setting", ".ui.setting.SettingsNotificationUI", paramString);
      return true;
    }
    return false;
  }
  ...
  final m cA(String paramString)
  {
    if (paramString.trim().startsWith("weixin://setting/notify")) {
      return new m(paramString, 9, null);
    }
    return null;
  }
