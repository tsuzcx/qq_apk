...
public final class x
{
  ...
  public static void f(Throwable paramThrowable)
  {
    ...
    ApplicationLike localApplicationLike = b.bXD;
    ...
    for (;;)
    {
      ...
      for (int j = 1;; j = 0)
      {
        if (j != 0)
        {
          ...
          ShareTinkerInternals.jJ(localApplicationLike.getApplication());
          com.tencent.tinker.lib.e.b.e(localApplicationLike);
          ShareTinkerInternals.jD(localApplicationLike.getApplication());
          AppMethodBeat.o(115035);
          return;
          i = 0;
          break;
