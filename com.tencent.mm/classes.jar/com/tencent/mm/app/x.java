...
{
  public static final com.tencent.mm.splash.d cMp;
  private static final HashSet cMq;
  
  static
  {
    AppMethodBeat.i(160106);
    cMp = new com.tencent.mm.splash.d()
    {
      public final boolean eD(String paramAnonymousString)
      {
        AppMethodBeat.i(160130);
        boolean bool = x.eE(paramAnonymousString);
  ...
  public static void KU()
  {
    ...
    Iterator localIterator = com.tencent.mm.splash.h.Fbn.iterator();
    ...
    com.tencent.mm.splash.h.Fbn.clear();
    com.tencent.mm.splash.h.Fbn.addAll(localArrayList);
    AppMethodBeat.o(160103);
  }
  
  private static boolean cc(boolean paramBoolean)
  {
    ...
    if ((com.tencent.mm.kernel.g.afC().gdG) && (com.tencent.mm.kernel.g.afz().aeI()))
    {
      if (paramBoolean) {
  ...
  private static boolean eD(String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      try
      {
        com.tencent.mm.kernel.g.afy();
        Object localObject = new ComponentName(aj.getPackageName(), paramString);
        localObject = ((com.tencent.mm.kernel.b.h)com.tencent.mm.kernel.g.afy().aeZ()).ca.getPackageManager().getActivityInfo((ComponentName)localObject, 128);
        if (localObject != null)
        {
