...
{
  public static com.tencent.mm.kernel.b.h cMQ;
  ...
  private static void Lf()
  {
    ...
    com.tencent.mm.splash.h.a(new c()
    {
      public final void a(Throwable paramAnonymousThrowable, String paramAnonymousString)
      {
        ...
        com.tencent.mm.splash.h.eIr().Fcn.add(paramAnonymousThrowable);
      ...
      public final void r(Activity paramAnonymousActivity)
      {
        ...
        if ((ah.cMQ != null) && (ah.cMQ.agu()))
        {
          paramAnonymousActivity = paramAnonymousActivity.getSharedPreferences("system_config_prefs", com.tencent.mm.compatible.util.g.XN());
    ...
    com.tencent.mm.splash.h.a(new b()
    {
      public final boolean bs(Context paramAnonymousContext)
      {
        ...
        boolean bool = com.tencent.mm.f.a.bD(paramAnonymousContext);
        AppMethodBeat.o(160072);
        return bool;
      }
      
      public final boolean bt(Context paramAnonymousContext)
      {
        AppMethodBeat.i(160073);
        boolean bool = com.tencent.mm.f.a.bt(paramAnonymousContext);
      ...
      public final void bu(Context paramAnonymousContext)
      {
        ...
        com.tencent.mm.f.a.bu(paramAnonymousContext);
    ...
    com.tencent.mm.splash.h.a(new f()
    {
      ...
      public final void Lh()
      {
        ...
        com.tencent.mm.blink.a.kp(1);
        AppMethodBeat.o(160087);
      }
      
      public final void eJ(String paramAnonymousString)
      {
        AppMethodBeat.i(160086);
        com.tencent.mm.blink.a.eJ(paramAnonymousString);
  ...
  public static void a(com.tencent.mm.kernel.b.h paramh, String paramString)
  {
    ...
    com.tencent.mm.blink.a.x(paramh.gfO.getApplicationStartMillisTime(), paramh.gfO.getApplicationStartElapsedTime());
    com.tencent.mm.splash.h.aGV(aj.eFB());
    com.tencent.mm.splash.h.aY(WeChatSplashActivity.class);
    com.tencent.mm.splash.h.aZ(WeChatSplashFallbackActivity.class);
    if (d.e(paramh)) {
      com.tencent.mm.splash.h.aGU("com.google.firebase.provider.FirebaseInitProvider");
    }
