...
public final class ag
{
  ...
  public ag()
  {
    ...
    this.cJT = new at.c()
    {
      public final void a(at arg1, String paramAnonymousString, Throwable paramAnonymousThrowable)
      {
        ...
        synchronized (ag.this)
        {
          ...
          if (!ag.this.cJR)
          {
            ...
            if (i > 3)
            {
              paramAnonymousThrowable = a.gMJ + "_clean_patch_count";
              ...
              ac.w("MicroMsg.TinkerEnsuranceOnFault", "[tomys] clean patch by ensurance logic!!");
              ac.eUR();
            }
          }
          else
  ...
  private boolean KX()
  {
    ...
    //   29: getstatic 71	com/tencent/mm/loader/j/a:gMJ	Ljava/lang/String;
    ...
    //   72: aastore
    //   73: invokestatic 103	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   76: ldc 48
    ...
    //   90: ldc 89
    //   92: ldc 105
    //   94: invokestatic 108	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   97: goto -21 -> 76
    //   100: astore_3
    //   101: aload_0
    //   102: monitorexit
  ...
  public final boolean KW()
  {
    ...
    //   59: ldc 89
    //   61: ldc 122
    //   63: invokestatic 108	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   66: ldc 120
    ...
    //   75: ldc 89
    //   77: ldc 124
    //   79: invokestatic 126	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   82: goto -16 -> 66
    //   85: astore_2
    //   86: aload_0
    //   87: monitorexit
  ...
  public final void La()
  {
    try
    {
      ...
      if ((!KY()) && (KX()))
      {
        e.wTc.idkeyStat(338L, 231L, 1L, false);
        localSharedPreferences.edit().putInt(a.gMJ + "_clean_patch_reported", 1).apply();
      }
      if ((!KZ()) && (!KW()))
      {
        e.wTc.idkeyStat(338L, 232L, 1L, false);
        localSharedPreferences.edit().putInt(a.gMJ + "_block_apply_patch_reported", 1).apply();
      }
  ...
  public final void b(ApplicationLike paramApplicationLike)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        at.a(this.cJT);
        this.cJS = this.mAppLike.getApplication().getPackageName().equals(this.mAppLike.getApplication().getApplicationInfo().processName);
        ...
        if (str == null)
        {
          paramApplicationLike.edit().putString("tinker_last_clientversion", a.gMJ).commit();
      ...
      paramApplicationLike.edit().remove(str + "_clean_patch_count").putString("tinker_last_clientversion", a.gMJ).commit();
    }
  }
  
  public static final class a
  {
    public static final ag cJV;
