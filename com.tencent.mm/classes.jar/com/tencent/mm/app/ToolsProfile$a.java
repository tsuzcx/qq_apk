...
{
  private static final AtomicInteger dmG;
  ...
  private static boolean WS()
  {
    ...
    try
    {
      if (dmH == null)
      {
        ...
        {
          dmH = localObject1;
          localObject1 = (ArrayMap)org.a.a.gG(localObject1).bvr("mServices").object;
    ...
    if (dmG.get() <= 0)
    {
      ...
      for (;;)
      {
        if (((Iterator)localObject).hasNext())
        {
          ...
          if (((h)com.tencent.mm.kernel.g.aAe().azG()).mProcessName.equals(localRunningAppProcessInfo.processName))
          {
            i = localRunningAppProcessInfo.importance;
            if (!com.tencent.mm.compatible.loader.a.contains(new int[] { 100 }, i))
            {
              i = localRunningAppProcessInfo.importance;
              if ((!com.tencent.mm.compatible.loader.a.contains(new int[] { 300, 125 }, i)) || (WS()))
              {
