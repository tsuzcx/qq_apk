...
{
  private static final AtomicInteger cWj;
  private static Object cWk;
  
  static
  {
    AppMethodBeat.i(19497);
    cWj = new AtomicInteger(0);
  ...
  private static boolean ME()
  {
    ...
    try
    {
      if (cWk == null)
      {
        ...
        {
          cWk = localObject1;
          localObject1 = (ArrayMap)org.a.a.gB(localObject1).bfB("mServices").object;
    ...
    {
      ae.e("MicroMsg.ToolsProcessLocker", "skipServiceConditionIfOnlyIPCServiceAlive, hack ActivityThread_mServices e=%s", new Object[] { localThrowable });
      AppMethodBeat.o(19493);
    }
    return false;
  }
    ...
    if (cWj.get() <= 0)
    {
      ...
      for (;;)
      {
        if (((Iterator)localObject).hasNext())
        {
          ...
          if (((h)com.tencent.mm.kernel.g.ajO().ajq()).mProcessName.equals(localRunningAppProcessInfo.processName))
          {
            i = localRunningAppProcessInfo.importance;
            if (!com.tencent.mm.compatible.loader.a.contains(new int[] { 100 }, i))
            {
              i = localRunningAppProcessInfo.importance;
              if ((!com.tencent.mm.compatible.loader.a.contains(new int[] { 300, 125 }, i)) || (ME()))
              {
            ...
            bool = true;
            ae.i("MicroMsg.ToolsProcessLocker", "hasRunningServicesOrProviders:%b %d %d", new Object[] { Boolean.valueOf(bool), Integer.valueOf(localRunningAppProcessInfo.importance), Integer.valueOf(localRunningAppProcessInfo.importanceReasonCode) });
            if (!bool) {}
          }
        }
      }
