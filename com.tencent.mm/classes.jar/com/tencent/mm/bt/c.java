...
{
  private static String aDe(String paramString)
  {
  ...
  public static String eBl()
  {
    ...
    //   13: dup
    //   14: ldc 49
    //   16: invokestatic 55	com/tencent/mm/vfs/i:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   19: ldc 57
    //   21: invokespecial 61	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   24: invokespecial 64	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   27: astore_1
    //   28: aload_1
    //   29: astore_0
    ...
    //   33: dup
    //   34: sipush 256
    //   37: invokespecial 68	java/lang/StringBuilder:<init>	(I)V
    //   40: astore_2
    //   41: aload_1
    //   42: astore_0
    //   43: aload_1
    //   44: invokevirtual 71	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   47: astore_3
    //   48: aload_3
    //   49: ifnull +59 -> 108
    //   52: aload_1
    //   53: astore_0
    //   54: aload_3
    //   55: invokestatic 18	com/tencent/mm/sdk/platformtools/bt:isNullOrNil	(Ljava/lang/String;)Z
    //   58: ifne -17 -> 41
    //   61: aload_1
    //   62: astore_0
    //   63: aload_2
    //   64: aload_3
    //   65: invokestatic 73	com/tencent/mm/bt/c:aDe	(Ljava/lang/String;)Ljava/lang/String;
    //   68: invokevirtual 77	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   71: bipush 59
    //   73: invokevirtual 80	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   76: pop
    //   77: goto -36 -> 41
    //   80: astore_2
    //   81: aload_1
    ...
    //   92: invokestatic 90	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   95: aload_1
    //   96: invokestatic 94	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   99: sipush 32074
    ...
    //   114: bipush 44
    //   116: bipush 95
    //   118: invokevirtual 101	java/lang/String:replace	(CC)Ljava/lang/String;
    //   121: astore_2
    //   122: aload_1
    //   123: invokestatic 94	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   126: sipush 32074
    ...
    //   136: astore_0
    //   137: aload_0
    //   138: invokestatic 94	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   141: sipush 32074
  ...
  public static String eBn()
  {
    ...
    {
      new DisplayMetrics();
      Object localObject2 = aj.getContext().getResources().getDisplayMetrics();
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ad.e("MicroMsg.PostTaskHardwareInfo", "exception:%s", new Object[] { bt.m(localException) });
      }
    }
  ...
  public static String eBo()
  {
    ...
    try
    {
      StatFs localStatFs = new StatFs(b.aih());
      str1 = str2;
  ...
  public static String eBp()
  {
    ...
    az.arV();
    String str = (String)com.tencent.mm.model.c.afk().get(71, null);
 ...
 * Qualified Name:     com.tencent.mm.bt.c
