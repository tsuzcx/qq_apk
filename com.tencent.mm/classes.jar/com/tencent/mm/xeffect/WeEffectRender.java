...
public class WeEffectRender
{
  ...
  public static long gZ(String paramString, int paramInt)
  {
    AppMethodBeat.i(216798);
    long l = nInit(paramInt, paramString + "/FaceDetectV2.1.0.21.xnet", paramString + "/FaceTrackV1.0.0.21.xnet", paramString + "/FaceAlignmentWeChatV2.0.0.21.xnet", paramString + "/model_sticker.xbin", paramString + "/Params_FaceSticker.json", paramString + "/SegmentationPortraitV1.0.14.21.xnet", paramString + "/GestureDetectV1.0.0.21.xnet", paramString + "/GestureClassifyV1.0.0.21.xnet", null);
  ...
  public static native long nInit(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9);
