  ...
  protected final void a(final m paramm, V8Object paramV8Object)
  {
    ...
    paramV8Object.registerJavaMethod(new JavaCallback()
    {
      public final Object invoke(V8Object paramAnonymousV8Object, V8Array paramAnonymousV8Array)
      {
        ...
        paramAnonymousV8Object = Integer.valueOf(p.this.cMg.generateId());
        ac.d("V8DirectApiBuffer", "generateId:%d", new Object[] { paramAnonymousV8Object });
    ...
    paramV8Object.registerJavaMethod(new JavaCallback()
    {
      public final Object invoke(V8Object paramAnonymousV8Object, V8Array paramAnonymousV8Array)
      {
        ...
        {
          ac.w("V8DirectApiBuffer", "getNativeBuffer invalid parameters");
          AppMethodBeat.o(144074);
          return null;
        }
        ac.d("V8DirectApiBuffer", "getNativeBuffer, id:%d", new Object[] { Integer.valueOf(paramAnonymousV8Array.getInteger(0)) });
        paramAnonymousV8Object = p.this.cMg.getBuffer(paramAnonymousV8Array.getInteger(0));
        if (paramAnonymousV8Object == null)
        {
          ac.w("V8DirectApiBuffer", "getNativeBuffer bb null");
          AppMethodBeat.o(144074);
          return null;
        }
        paramAnonymousV8Object = paramm.LR().newV8ArrayBuffer(paramAnonymousV8Object);
        AppMethodBeat.o(144074);
        return paramAnonymousV8Object;
      }
    }, "getNativeBuffer");
    paramV8Object.registerJavaMethod(new JavaVoidCallback()
    {
      public final void invoke(V8Object paramAnonymousV8Object, V8Array paramAnonymousV8Array)
      {
        ...
        {
          ac.w("V8DirectApiBuffer", "setNativeBuffer invalid parameters");
          AppMethodBeat.o(144075);
          return;
        }
        ac.d("V8DirectApiBuffer", "setNativeBuffer, id:%d", new Object[] { Integer.valueOf(paramAnonymousV8Array.getInteger(0)) });
        paramAnonymousV8Object = (V8ArrayBuffer)paramAnonymousV8Array.get(1);
        if (paramAnonymousV8Object != null)
        {
          p.this.cMg.setBuffer(paramAnonymousV8Array.getInteger(0), paramAnonymousV8Object.getBackingStore());
          paramAnonymousV8Object.release();
          AppMethodBeat.o(144075);
          return;
        }
        ac.w("V8DirectApiBuffer", "setNativeBuffer buffer null");
        AppMethodBeat.o(144075);
      }
    }, "setNativeBuffer");
