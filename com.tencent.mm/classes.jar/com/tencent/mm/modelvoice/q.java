...
public final class q
{
  public static int DX(String paramString)
  {
    ...
    switch (Ez(paramString))
    {
    default: 
      i = EA(s.getFullPath(paramString));
  ...
  public static int Ez(String paramString)
  {
    ...
    ac.d("MicroMsg.VoiceFile", "fileName ".concat(String.valueOf(paramString)));
  ...
  private static boolean g(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    //   11: ldc 94
    //   13: aload_0
    //   14: invokestatic 70	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   17: invokevirtual 73	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   20: invokestatic 79	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   23: aload_0
    //   24: iconst_0
    //   25: invokestatic 100	com/tencent/mm/vfs/i:cY	(Ljava/lang/String;Z)Ljava/io/RandomAccessFile;
    //   28: astore_3
    //   29: aload_3
    //   30: astore_0
    //   31: bipush 6
    ...
    //   54: ldc 64
    //   56: ldc 108
    //   58: invokestatic 111	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   61: aload_3
    ...
    //   108: iconst_0
    //   109: aload 4
    //   111: invokestatic 126	com/tencent/mm/sdk/platformtools/bs:cu	([B)Ljava/lang/String;
    //   114: aastore
    //   115: dup
    //   116: iconst_1
    //   117: aload 5
    ...
    //   122: ldc 128
    //   124: aastore
    //   125: invokestatic 131	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   128: aload_3
    //   129: astore_0
    //   130: aload 5
    //   132: ldc 128
    ...
    //   180: invokestatic 140	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   183: aload_3
  ...
  public static boolean h(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (Object localObject2 = paramString;; localObject2 = null)
    {
      for (;;)
      {
        ac.d("MicroMsg.VoiceFile", "isSilkHeader path ".concat(String.valueOf(localObject2)));
        paramString = arrayOfByte;
        try
        {
          localObject2 = i.cY((String)localObject2, false);
          ...
          if (paramInt == -1)
          {
            ...
            else
            {
              ...
              ac.e("MicroMsg.VoiceFile", "isSilkHeader usertype error, TYPE_RECOGNIZER_BIZ fileName:%s", new Object[] { paramString });
              AppMethodBeat.o(148449);
              return false;
            }
          }
          else
          {
            ...
            paramString = (String)localObject2;
            localObject1 = localObject2;
            ac.i("MicroMsg.VoiceFile", "isSilkHeader voice file headHex:|%s| headStr:|%s| AmrFileOperator.AMR_NB_HEAD:|%s|", new Object[] { bs.cu(arrayOfByte), str2, "#!SILK_V3" });
            paramString = (String)localObject2;
            localObject1 = localObject2;
        ...
        catch (Exception localException)
        {
          ...
          {
            str1 = paramString;
            ac.d("MicroMsg.VoiceFile", "isSilkHeader file not found");
