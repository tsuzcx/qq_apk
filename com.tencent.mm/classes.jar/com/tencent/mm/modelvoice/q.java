...
public final class q
{
  ...
  private static boolean g(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    //   23: aload_0
    //   24: iconst_0
    //   25: invokestatic 89	com/tencent/mm/vfs/i:cS	(Ljava/lang/String;Z)Ljava/io/RandomAccessFile;
    //   28: astore_3
    //   29: aload_3
    //   30: astore_0
    //   31: bipush 6
    ...
    //   42: iconst_0
    //   43: bipush 6
    //   45: invokevirtual 95	java/io/RandomAccessFile:read	([BII)I
    //   48: iconst_m1
    //   49: if_icmpne +35 -> 84
    //   52: aload_3
    //   53: astore_0
    //   54: ldc 24
    //   56: ldc 97
    //   58: invokestatic 100	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   61: aload_3
    //   62: invokestatic 106	com/tencent/mm/vfs/q:closeQuietly	(Ljava/io/Closeable;)V
    //   65: ldc 81
    ...
    //   73: ifne +140 -> 213
    //   76: aload_0
    //   77: invokestatic 111	com/tencent/mm/modelvoice/s:getFullPath	(Ljava/lang/String;)Ljava/lang/String;
    //   80: astore_0
    //   81: goto -72 -> 9
    //   84: aload_3
    //   85: astore_0
    ...
    //   89: dup
    //   90: aload 4
    //   92: invokespecial 114	java/lang/String:<init>	([B)V
    //   95: astore 5
    //   97: aload_3
    //   98: astore_0
    //   99: ldc 24
    ...
    //   108: iconst_0
    //   109: aload 4
    //   111: invokestatic 120	com/tencent/mm/sdk/platformtools/bt:cv	([B)Ljava/lang/String;
    //   114: aastore
    //   115: dup
    //   116: iconst_1
    //   117: aload 5
    ...
    //   122: ldc 122
    //   124: aastore
    //   125: invokestatic 125	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   128: aload_3
    //   129: astore_0
    //   130: aload 5
    //   132: ldc 122
    //   134: invokevirtual 128	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   137: istore_2
    //   138: iload_2
    //   139: ifeq +14 -> 153
    //   142: aload_3
    //   143: invokestatic 106	com/tencent/mm/vfs/q:closeQuietly	(Ljava/io/Closeable;)V
    //   146: ldc 81
    //   148: invokestatic 22	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   151: iconst_1
    //   152: ireturn
    //   153: aload_3
    //   154: invokestatic 106	com/tencent/mm/vfs/q:closeQuietly	(Ljava/io/Closeable;)V
    //   157: ldc 81
    ...
    //   180: invokestatic 134	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   183: aload_3
    //   184: invokestatic 106	com/tencent/mm/vfs/q:closeQuietly	(Ljava/io/Closeable;)V
    //   187: goto -30 -> 157
    //   190: astore_3
    //   191: aconst_null
    //   192: astore_0
    //   193: aload_0
    //   194: invokestatic 106	com/tencent/mm/vfs/q:closeQuietly	(Ljava/io/Closeable;)V
    //   197: ldc 81
  ...
  public static boolean h(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (Object localObject2 = paramString;; localObject2 = null)
    {
      for (;;)
      {
        ...
        try
        {
          localObject2 = i.cS((String)localObject2, false);
          ...
          else
          {
            ...
            paramString = (String)localObject2;
            localObject1 = localObject2;
            ad.i("MicroMsg.VoiceFile", "isSilkHeader voice file headHex:|%s| headStr:|%s| AmrFileOperator.AMR_NB_HEAD:|%s|", new Object[] { bt.cv(arrayOfByte), str2, "#!SILK_V3" });
            paramString = (String)localObject2;
            localObject1 = localObject2;
  ...
  public static int zS(String paramString)
  {
    ...
    switch (Au(paramString))
    {
    default: 
      i = Av(s.getFullPath(paramString));
