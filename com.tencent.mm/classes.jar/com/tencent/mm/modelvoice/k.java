...
public final class k
  implements d
{
  private static Object iwA;
  private static int iwB;
  private static int iwC;
  private static int iwJ;
  public int dhl;
  private int iwD;
  private int iwE;
  private com.tencent.mm.audio.e.b iwF;
  private com.tencent.mm.audio.c.a.a iwG;
  private int iwH;
  private boolean iwI;
  private h iwK;
  private MediaPlayer.OnCompletionListener iwL;
  private MediaPlayer.OnErrorListener iwM;
  private a iws;
  private com.tencent.mm.compatible.util.b iwt;
  private d.a iwu;
  private d.b iwv;
  private int iww;
  private volatile boolean iwx;
  private String iwy;
  private String iwz;
  ...
  public k()
  {
    ...
    this.iwH = 8;
    this.iwI = true;
    this.iwL = new MediaPlayer.OnCompletionListener()
    {
      public final void onCompletion(MediaPlayer paramAnonymousMediaPlayer)
      {
        ...
        {
          ad.e("MicroMsg.SilkPlayer", "exception:%s", new Object[] { bt.n(paramAnonymousMediaPlayer) });
          ad.e("MicroMsg.SilkPlayer", "setCompletion File[" + k.e(k.this) + "] ErrMsg[" + paramAnonymousMediaPlayer.getStackTrace() + "]");
          AppMethodBeat.o(130046);
        }
      }
    };
    this.iwM = new MediaPlayer.OnErrorListener()
    {
    ...
    iwB += 1;
    this.iwD = iwB;
    ad.i("MicroMsg.SilkPlayer", "[%d] new Instance", new Object[] { Integer.valueOf(this.iwD) });
  ...
  public k(Context paramContext)
  {
    ...
    this.iwt = new com.tencent.mm.compatible.util.b(paramContext);
  ...
  private void HM(String paramString)
  {
    ...
    iwC = this.iwD;
    ad.i("MicroMsg.SilkPlayer", "[%d] SilkDecInit", new Object[] { Integer.valueOf(this.iwD) });
    for (;;)
    {
      try
      {
        ...
        if ((!com.tencent.mm.plugin.audio.c.a.bGD()) || (j >= k * 2)) {
          continue;
        }
        this.iwH = 1;
        ...
        if (this.iwK != null) {
          ad.i("MicroMsg.SilkPlayer", "silkdec uninit success: %d".concat(String.valueOf(MediaRecorder.SilkDecUnInit(this.iwK.decodeHandle))));
        }
        this.iwK = new h(this.mSampleRate, (byte[])localObject, j);
        j = -1;
        localObject = com.tencent.mm.model.c.d.aDs().wz("100268");
        if (!((c)localObject).isValid()) {
          break label473;
        }
        j = bt.getInt((String)((c)localObject).foF().get("SilkAudioPlayerAgcOn"), 0);
      }
      catch (Exception paramString)
      {
        ...
        long l;
        short s;
        com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(161L, 0L, 1L, false);
        com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(161L, 1L, 1L, false);
        ad.e("MicroMsg.SilkPlayer", "exception:%s", new Object[] { bt.n(paramString) });
        continue;
        j += 1;
        continue;
      ...
      paramString.close();
      ad.d("MicroMsg.SilkPlayer", "[%d] skip %d frames", new Object[] { Integer.valueOf(this.iwD), Integer.valueOf(this.iwE) });
      ...
      if (j < this.iwE) {
        if (this.iwK != null)
        {
          k = this.iwK.a(paramString, s);
          if (k <= 0)
          {
            ad.e("MicroMsg.SilkPlayer", "[%d], skip frame failed: %d", new Object[] { Integer.valueOf(this.iwD), Integer.valueOf(k) });
            AppMethodBeat.o(130057);
            return;
            this.iwH = 8;
            continue;
  ...
  private boolean X(String paramString, boolean paramBoolean)
  {
    ...
    if (ac.iPt) {
      bz(paramString, com.tencent.mm.audio.b.g.dhN);
    }
    ...
    for (;;)
    {
      ...
      synchronized (iwA)
      {
        ...
        if (ac.iPt)
        {
          paramString = com.tencent.mm.audio.b.g.dhM;
          if (this.dhl == 2)
          {
            i = 1;
            this.iwF = new com.tencent.mm.audio.e.b(paramString, i, this.mSampleRate);
          }
        }
        else
        {
  ...
  private String a(String paramString, h paramh)
  {
    ...
    //   18: invokestatic 409	com/tencent/mm/vfs/i:fv	(Ljava/lang/String;)Z
    //   21: ifne +30 -> 51
    //   24: ldc 120
    //   26: ldc_w 411
    //   29: iconst_1
    ...
    //   91: istore_3
    //   92: aload_1
    //   93: invokestatic 420	com/tencent/mm/modelvoice/k:HN	(Ljava/lang/String;)Z
    //   96: pop
    //   97: aload_1
    //   98: iconst_0
    //   99: invokestatic 424	com/tencent/mm/vfs/i:cX	(Ljava/lang/String;Z)Ljava/io/OutputStream;
    //   102: astore 5
    //   104: aload_0
    ...
    //   178: iconst_0
    //   179: aload_1
    //   180: invokestatic 294	com/tencent/mm/sdk/platformtools/bt:n	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   183: aastore
    ...
    //   209: areturn
    //   210: aload_0
    //   211: getfield 96	com/tencent/mm/modelvoice/k:iwx	Z
    //   214: ifeq +12 -> 226
    //   217: ldc2_w 430
    ...
    //   287: iconst_0
    //   288: aload_0
    //   289: getfield 118	com/tencent/mm/modelvoice/k:iwD	I
    ...
    //   380: iconst_0
    //   381: aload_1
    //   382: invokestatic 294	com/tencent/mm/sdk/platformtools/bt:n	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   385: aastore
  ...
  private boolean aNr()
  {
    ...
    if (this.mAudioTrack != null) {
      try
      {
        ...
        this.iws = new a((byte)0);
        com.tencent.e.h.LTJ.aR(this.iws);
      ...
      catch (Exception localException)
      {
        ...
        com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(161L, 0L, 1L, false);
        com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(161L, 3L, 1L, false);
        AppMethodBeat.o(130059);
        return false;
      }
    }
  ...
  private void fa(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      this.mAudioTrack = com.tencent.mm.audio.c.a.a(paramBoolean, this.mSampleRate, this.dhl, this.iwH);
      if ((this.mAudioTrack == null) || (this.mAudioTrack.getState() == 0))
      {
        com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(161L, 0L, 1L, false);
        com.tencent.mm.plugin.report.service.g.yhR.idkeyStat(161L, 2L, 1L, false);
      }
    }
  ...
  private boolean fb(boolean paramBoolean)
  {
    ...
    if (!com.tencent.mm.vfs.i.fv(this.mFileName))
    {
    ...
    try
    {
      ...
      if (this.mAudioTrack != null)
      {
        if ((this.iwt != null) && (this.iwI)) {
          this.iwt.requestFocus();
        }
        paramBoolean = aNr();
        AppMethodBeat.o(130058);
        return paramBoolean;
    ...
    catch (Exception localException)
    {
      ...
      ad.e("MicroMsg.SilkPlayer", "exception:%s", new Object[] { bt.n(localException) });
      AppMethodBeat.o(130058);
    }
    return false;
  }
  ...
  public final boolean Gv()
  {
    ...
    //   85: aload_0
    //   86: getfield 98	com/tencent/mm/modelvoice/k:iwy	Ljava/lang/String;
    //   89: astore_1
    //   90: aload_1
    //   91: monitorenter
    //   92: aload_0
    //   93: getfield 98	com/tencent/mm/modelvoice/k:iwy	Ljava/lang/String;
    //   96: invokevirtual 568	java/lang/Object:notify	()V
    //   99: aload_0
    //   100: getfield 142	com/tencent/mm/modelvoice/k:iwt	Lcom/tencent/mm/compatible/util/b;
    //   103: ifnull +18 -> 121
    //   106: aload_0
    //   107: getfield 108	com/tencent/mm/modelvoice/k:iwI	Z
    //   110: ifeq +11 -> 121
    //   113: aload_0
    //   114: getfield 142	com/tencent/mm/modelvoice/k:iwt	Lcom/tencent/mm/compatible/util/b;
    //   117: invokevirtual 537	com/tencent/mm/compatible/util/b:abe	()Z
    //   120: pop
    //   121: aload_1
    //   122: monitorexit
    //   123: ldc_w 561
    ...
    //   142: iconst_0
    //   143: aload_2
    //   144: invokestatic 294	com/tencent/mm/sdk/platformtools/bt:n	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   147: aastore
    //   148: invokestatic 276	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   151: aload_0
    //   152: getfield 142	com/tencent/mm/modelvoice/k:iwt	Lcom/tencent/mm/compatible/util/b;
    //   155: ifnull +18 -> 173
    //   158: aload_0
    //   159: getfield 108	com/tencent/mm/modelvoice/k:iwI	Z
    //   162: ifeq +11 -> 173
    //   165: aload_0
    //   166: getfield 142	com/tencent/mm/modelvoice/k:iwt	Lcom/tencent/mm/compatible/util/b;
    //   169: invokevirtual 537	com/tencent/mm/compatible/util/b:abe	()Z
    //   172: pop
    //   173: aload_1
    //   174: monitorexit
    //   175: ldc_w 561
    ...
    //   183: astore_2
    //   184: aload_0
    //   185: getfield 142	com/tencent/mm/modelvoice/k:iwt	Lcom/tencent/mm/compatible/util/b;
    //   188: ifnull +18 -> 206
    //   191: aload_0
    //   192: getfield 108	com/tencent/mm/modelvoice/k:iwI	Z
    //   195: ifeq +11 -> 206
    //   198: aload_0
    //   199: getfield 142	com/tencent/mm/modelvoice/k:iwt	Lcom/tencent/mm/compatible/util/b;
    //   202: invokevirtual 537	com/tencent/mm/compatible/util/b:abe	()Z
    //   205: pop
    //   206: ldc_w 561
  ...
  public final String bz(String paramString1, String paramString2)
  {
    ...
    //   86: baload
    //   87: istore_3
    //   88: getstatic 190	com/tencent/mm/modelvoice/MediaRecorder:ivY	J
    //   91: lstore 5
    //   93: aload_0
    //   94: iconst_1
    //   95: newarray byte
    ...
    //   136: iconst_0
    //   137: aload_0
    //   138: getfield 118	com/tencent/mm/modelvoice/k:iwD	I
    ...
    //   207: iconst_0
    //   208: aload_2
    //   209: invokestatic 294	com/tencent/mm/sdk/platformtools/bt:n	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   212: aastore
  ...
  public final boolean isPlaying()
  {
    ...
    if (this.mStatus == 1)
    {
      bool1 = true;
      locala = this.iws;
      if ((this.iws != null) && (!this.iws.isDone())) {
        break label116;
      }
    }
    label116:
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      if ((this.mStatus != 1) && ((this.mStatus == 1) || (this.iws == null) || (this.iws.isDone()))) {
        break label121;
      }
    ...
    extends com.tencent.e.i.b
  {
    ...
    public final void run()
    {
      ...
      //   10: aload_0
      //   11: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   28: astore_3
      //   29: aload_0
      //   30: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   77: aload_0
      //   78: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   81: invokestatic 100	com/tencent/mm/modelvoice/k:h	(Lcom/tencent/mm/modelvoice/k;)I
      //   84: iconst_1
      //   85: if_icmpeq +14 -> 99
      //   88: aload_0
      //   89: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   104: aload 4
      //   106: monitorenter
      //   107: invokestatic 108	com/tencent/mm/modelvoice/k:aNt	()I
      //   110: aload_0
      //   111: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   129: iconst_0
      //   130: aload_0
      //   131: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   141: dup
      //   142: iconst_1
      //   143: invokestatic 108	com/tencent/mm/modelvoice/k:aNt	()I
      ...
      //   153: aload_0
      //   154: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   157: invokestatic 115	com/tencent/mm/modelvoice/k:j	(Lcom/tencent/mm/modelvoice/k;)I
      //   160: pop
      //   161: aload_0
      //   162: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   165: invokestatic 118	com/tencent/mm/modelvoice/k:k	(Lcom/tencent/mm/modelvoice/k;)I
      //   168: iconst_3
      //   169: if_icmple +17 -> 186
      //   172: getstatic 124	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
      //   175: ldc2_w 125
      //   178: ldc2_w 127
      //   181: lconst_1
      //   182: iconst_0
      ...
      //   186: aload_0
      //   187: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   190: aload_0
      //   191: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   202: monitorexit
      //   203: aload_0
      //   204: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   226: goto -23 -> 203
      //   229: astore_3
      //   230: getstatic 124	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
      //   233: ldc2_w 125
      //   236: lconst_0
      //   237: lconst_1
      //   238: iconst_0
      ...
      //   251: iconst_0
      //   252: aload_3
      //   253: invokestatic 163	com/tencent/mm/sdk/platformtools/bt:n	(Ljava/lang/Throwable;)Ljava/lang/String;
      //   256: aastore
      //   257: invokestatic 165	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   260: aload_0
      //   261: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   267: ifnull +19 -> 286
      //   270: aload_0
      //   271: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   285: pop
      //   286: aload_0
      //   287: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   290: iconst_0
      ...
      //   299: aload_3
      //   300: monitorenter
      //   301: invokestatic 108	com/tencent/mm/modelvoice/k:aNt	()I
      //   304: aload_0
      //   305: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   308: invokestatic 41	com/tencent/mm/modelvoice/k:i	(Lcom/tencent/mm/modelvoice/k;)I
      //   311: if_icmpne +63 -> 374
      //   314: aload_0
      //   315: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   318: invokestatic 182	com/tencent/mm/modelvoice/k:m	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/modelvoice/h;
      //   321: ifnull +53 -> 374
      //   324: aload_0
      //   325: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   347: iconst_0
      //   348: aload_0
      //   349: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   362: invokestatic 199	com/tencent/mm/modelvoice/k:aNu	()I
      //   365: pop
      //   366: aload_0
      //   367: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   370: invokestatic 202	com/tencent/mm/modelvoice/k:t	(Lcom/tencent/mm/modelvoice/k;)I
      //   373: pop
      //   374: aload_3
      //   375: monitorexit
      //   376: aload_0
      //   377: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   380: invokestatic 100	com/tencent/mm/modelvoice/k:h	(Lcom/tencent/mm/modelvoice/k;)I
      //   383: iconst_3
      //   384: if_icmpeq +847 -> 1231
      //   387: aload_0
      //   388: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   391: invokestatic 206	com/tencent/mm/modelvoice/k:u	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/modelvoice/d$a;
      //   394: ifnull +15 -> 409
      //   397: aload_0
      //   398: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   409: aload_0
      //   410: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   416: ifnull +16 -> 432
      //   419: aload_0
      //   420: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   432: aload_0
      //   433: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   436: invokestatic 223	com/tencent/mm/modelvoice/k:n	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/audio/c/a/a;
      //   439: ifnull +61 -> 500
      //   442: aload_0
      //   443: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   446: invokestatic 223	com/tencent/mm/modelvoice/k:n	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/audio/c/a/a;
      //   449: iconst_0
      //   450: aload_0
      //   451: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   454: invokestatic 136	com/tencent/mm/modelvoice/k:e	(Lcom/tencent/mm/modelvoice/k;)Ljava/lang/String;
      //   457: aload_0
      //   458: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   461: invokevirtual 226	com/tencent/mm/modelvoice/k:aNs	()I
      //   464: invokevirtual 232	com/tencent/mm/audio/c/a/a:b	(ILjava/lang/String;I)V
      //   467: aload_0
      //   468: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   471: invokestatic 223	com/tencent/mm/modelvoice/k:n	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/audio/c/a/a;
      //   474: iconst_0
      //   475: invokevirtual 235	com/tencent/mm/audio/c/a/a:hQ	(I)V
      //   478: aload_0
      //   479: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   482: invokestatic 223	com/tencent/mm/modelvoice/k:n	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/audio/c/a/a;
      //   485: iconst_0
      //   486: invokevirtual 238	com/tencent/mm/audio/c/a/a:hR	(I)V
      //   489: aload_0
      //   490: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   493: invokestatic 223	com/tencent/mm/modelvoice/k:n	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/audio/c/a/a;
      //   496: iconst_0
      //   497: invokevirtual 241	com/tencent/mm/audio/c/a/a:hS	(I)V
      //   500: ldc 55
      ...
      //   516: athrow
      //   517: aload_0
      //   518: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   521: invokestatic 182	com/tencent/mm/modelvoice/k:m	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/modelvoice/h;
      //   524: ifnull +185 -> 709
      //   527: aload_0
      //   528: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   531: invokestatic 223	com/tencent/mm/modelvoice/k:n	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/audio/c/a/a;
      //   534: ifnull +62 -> 596
      //   537: aload_0
      //   538: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   549: aload_0
      //   550: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   553: invokestatic 223	com/tencent/mm/modelvoice/k:n	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/audio/c/a/a;
      //   556: iconst_0
      //   557: invokestatic 250	com/tencent/mm/plugin/audio/c/a:bGC	()Lcom/tencent/mm/plugin/audio/b/a;
      //   560: getfield 256	com/tencent/mm/plugin/audio/b/a:audioManager	Landroid/media/AudioManager;
      //   563: aload_0
      //   564: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   567: invokevirtual 226	com/tencent/mm/modelvoice/k:aNs	()I
      //   570: invokevirtual 262	android/media/AudioManager:getStreamVolume	(I)I
      //   573: bipush 100
      //   575: imul
      //   576: invokestatic 250	com/tencent/mm/plugin/audio/c/a:bGC	()Lcom/tencent/mm/plugin/audio/b/a;
      //   579: getfield 256	com/tencent/mm/plugin/audio/b/a:audioManager	Landroid/media/AudioManager;
      //   582: aload_0
      //   583: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   586: invokevirtual 226	com/tencent/mm/modelvoice/k:aNs	()I
      ...
      //   596: aload_0
      //   597: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   610: ifge +162 -> 772
      //   613: aload_0
      //   614: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   617: iconst_0
      //   618: invokestatic 178	com/tencent/mm/modelvoice/k:a	(Lcom/tencent/mm/modelvoice/k;I)I
      //   621: pop
      //   622: getstatic 124	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
      //   625: ldc2_w 125
      //   628: lconst_0
      //   629: lconst_1
      //   630: iconst_0
      //   631: invokevirtual 132	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
      //   634: getstatic 124	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
      //   637: ldc2_w 125
      //   640: ldc2_w 273
      //   643: lconst_1
      //   644: iconst_0
      ...
      //   658: iconst_0
      //   659: aload_0
      //   660: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   680: aload_0
      //   681: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   684: invokestatic 279	com/tencent/mm/modelvoice/k:o	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/audio/e/b;
      //   687: ifnull -610 -> 77
      //   690: getstatic 285	com/tencent/mm/platformtools/ac:iPt	Z
      //   693: ifeq -616 -> 77
      //   696: aload_0
      //   697: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   706: goto -629 -> 77
      //   709: aload_0
      //   710: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   713: iconst_0
      ...
      //   728: iconst_0
      //   729: aload_0
      //   730: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   743: aload_0
      //   744: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   747: invokestatic 279	com/tencent/mm/modelvoice/k:o	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/audio/e/b;
      //   750: ifnull -673 -> 77
      //   753: getstatic 285	com/tencent/mm/platformtools/ac:iPt	Z
      //   756: ifeq -679 -> 77
      //   759: aload_0
      //   760: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   769: goto -692 -> 77
      //   772: getstatic 285	com/tencent/mm/platformtools/ac:iPt	Z
      //   775: ifeq +28 -> 803
      //   778: aload_0
      //   779: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   782: invokestatic 279	com/tencent/mm/modelvoice/k:o	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/audio/e/b;
      //   785: ifnull +18 -> 803
      //   788: aload_0
      //   789: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   802: pop
      //   803: aload_0
      //   804: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   818: pop
      //   819: aload_0
      //   820: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   823: invokestatic 307	com/tencent/mm/modelvoice/k:p	(Lcom/tencent/mm/modelvoice/k;)I
      //   826: pop
      //   827: iload_2
      //   828: ifne +128 -> 956
      //   831: aload_0
      //   832: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   835: iconst_0
      ...
      //   850: iconst_0
      //   851: aload_0
      //   852: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   865: aload_0
      //   866: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   869: invokestatic 279	com/tencent/mm/modelvoice/k:o	(Lcom/tencent/mm/modelvoice/k;)Lcom/tencent/mm/audio/e/b;
      //   872: ifnull -795 -> 77
      //   875: getstatic 285	com/tencent/mm/platformtools/ac:iPt	Z
      //   878: ifeq -801 -> 77
      //   881: aload_0
      //   882: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   927: getstatic 124	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
      //   930: ldc2_w 125
      //   933: lconst_0
      //   934: lconst_1
      //   935: iconst_0
      //   936: invokevirtual 132	com/tencent/mm/plugin/report/service/g:idkeyStat	(JJJZ)V
      //   939: getstatic 124	com/tencent/mm/plugin/report/service/g:yhR	Lcom/tencent/mm/plugin/report/service/g;
      //   942: ldc2_w 125
      //   945: ldc2_w 324
      //   948: lconst_1
      //   949: iconst_0
      ...
      //   953: goto -134 -> 819
      //   956: aload_0
      //   957: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   960: invokestatic 100	com/tencent/mm/modelvoice/k:h	(Lcom/tencent/mm/modelvoice/k;)I
      //   963: iconst_2
      //   964: if_icmpne +158 -> 1122
      //   967: aload_0
      //   968: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   987: aload_0
      //   988: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   1007: monitorexit
      //   1008: aload_0
      //   1009: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   1028: aload_0
      //   1029: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   1074: iconst_0
      //   1075: aload 5
      //   1077: invokestatic 163	com/tencent/mm/sdk/platformtools/bt:n	(Ljava/lang/Throwable;)Ljava/lang/String;
      //   1080: aastore
      ...
      //   1109: iconst_0
      //   1110: aload 5
      //   1112: invokestatic 163	com/tencent/mm/sdk/platformtools/bt:n	(Ljava/lang/Throwable;)Ljava/lang/String;
      //   1115: aastore
      //   1116: invokestatic 165	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   1119: goto -73 -> 1046
      //   1122: aload_0
      //   1123: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   1126: invokestatic 328	com/tencent/mm/modelvoice/k:q	(Lcom/tencent/mm/modelvoice/k;)Ljava/lang/String;
      //   1129: astore 4
      //   1131: aload 4
      //   1133: monitorenter
      //   1134: aload_0
      //   1135: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   1172: iconst_0
      //   1173: aload 5
      //   1175: invokestatic 163	com/tencent/mm/sdk/platformtools/bt:n	(Ljava/lang/Throwable;)Ljava/lang/String;
      //   1178: aastore
      //   1179: invokestatic 165	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   1182: goto -38 -> 1144
      //   1185: aload_0
      //   1186: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      //   1189: invokestatic 100	com/tencent/mm/modelvoice/k:h	(Lcom/tencent/mm/modelvoice/k;)I
      //   1192: iconst_3
      //   1193: if_icmpeq -898 -> 295
      //   1196: aload_0
      //   1197: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   1230: athrow
      //   1231: aload_0
      //   1232: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   1249: aload_0
      //   1250: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   1259: aload_0
      //   1260: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
      ...
      //   1269: aload_0
      //   1270: getfield 15	com/tencent/mm/modelvoice/k$a:iwN	Lcom/tencent/mm/modelvoice/k;
