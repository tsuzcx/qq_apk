  ...
  implements b
{
  ...
  private boolean eX(boolean paramBoolean)
  {
    ...
    {
      Assert.assertTrue(bool);
      ac.d("MicroMsg.SpxFileOperator", "Open file:" + this.file + " forWrite:" + paramBoolean);
      try
      {
  ...
  public final g dp(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      ac.d("MicroMsg.SpxFileOperator", "DBG: ReadFile[" + this.fileName + "] readOffset:" + paramInt1 + " readRet:" + i + " fileNow:" + this.file.getFilePointer() + " fileSize:" + l);
      paramInt2 = i;
      if (i < 0) {
        paramInt2 = 0;
      }
    ...
    {
      ac.e("MicroMsg.SpxFileOperator", "ERR: ReadFile[" + this.fileName + "] Offset:" + paramInt1 + "  failed:[" + localException.getMessage() + "] ");
      aKd();
      localg.ret = -1;
      AppMethodBeat.o(130089);
    }
  ...
  public final int write(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        ac.e("MicroMsg.SpxFileOperator", "ERR: WriteFile[" + this.fileName + "] Offset:" + paramInt2 + " failed:[" + paramArrayOfByte.getMessage() + "]");
        aKd();
        AppMethodBeat.o(130090);
        return -3;
      }
