...
public final class i
{
  ...
  public i(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.hCu = MediaRecorder.SilkEncInit(paramInt1, paramInt2, paramInt3, MediaRecorder.hCb);
  ...
  public final int dq(int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = MediaRecorder.SetVoiceSilkControl(paramInt1, paramInt2, this.hCu);
