  ...
  implements bd
{
  ...
  public static i bid()
  {
    ...
    Log.i("MicroMsg.SubCoreVoice", "getVoiceService %s", new Object[] { bia().jvo.toString() });
    i locali = bia().jvo;
  ...
  public void onAccountPostReset(boolean paramBoolean)
  {
    ...
    h.d.a(Integer.valueOf(34), this.jvp);
  ...
  public void onAccountRelease()
  {
    ...
    h.d.b(Integer.valueOf(34), this.jvp);
    EventCenter.instance.removeListener(this.jvq);
    com.tencent.mm.pluginsdk.cmd.b.V(new String[] { "//voicetrymore" });
