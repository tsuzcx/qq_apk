  ...
  implements b
{
  ...
  private boolean ch(boolean paramBoolean)
  {
    ...
    {
      Assert.assertTrue(bool);
      y.d("MicroMsg.SpxFileOperator", "Open file:" + this.aRL + " forWrite:" + paramBoolean);
      try
      {
      ...
      {
        y.e("MicroMsg.SpxFileOperator", "ERR: OpenFile[" + this.fileName + "] failed:[" + localException.getMessage() + "]");
        this.aRL = null;
      }
      bool = false;
      break;
  ...
  public final g bz(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      y.d("MicroMsg.SpxFileOperator", "DBG: ReadFile[" + this.fileName + "] readOffset:" + paramInt1 + " readRet:" + i + " fileNow:" + this.aRL.getFilePointer() + " fileSize:" + l);
      paramInt2 = i;
      if (i < 0) {
        paramInt2 = 0;
      }
    ...
    {
      y.e("MicroMsg.SpxFileOperator", "ERR: ReadFile[" + this.fileName + "] Offset:" + paramInt1 + "  failed:[" + localException.getMessage() + "] ");
      SW();
      localg.ret = -1;
    }
    return localg;
  ...
  public final int write(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        y.e("MicroMsg.SpxFileOperator", "ERR: WriteFile[" + this.fileName + "] Offset:" + paramInt2 + " failed:[" + paramArrayOfByte.getMessage() + "]");
        SW();
        return -3;
      }
      bool1 = false;
