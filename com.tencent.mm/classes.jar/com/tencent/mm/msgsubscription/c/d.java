...
@l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/msgsubscription/task/GetSubscribeMsgUIStatusTask;", "Lcom/tencent/mm/msgsubscription/task/BaseSubscribeMsgTask;", "username", "", "templateIds", "", "storageManager", "Lcom/tencent/mm/msgsubscription/storage/ISubscribeStorageManager;", "callback", "Lcom/tencent/mm/msgsubscription/storage/SubscribeMsgDataLoader$SubscribeMsgOpCallback;", "(Ljava/lang/String;Ljava/util/List;Lcom/tencent/mm/msgsubscription/storage/ISubscribeStorageManager;Lcom/tencent/mm/msgsubscription/storage/SubscribeMsgDataLoader$SubscribeMsgOpCallback;)V", "bizUsername", "(Ljava/lang/String;)V", "mCallback", "templateIdList", "getType", "", "run", "", "Companion", "plugin-comm_release"})
public final class d
  extends a
{
  public static final a iFe;
  private e.b iEU;
  private com.tencent.mm.msgsubscription.storage.d iEV;
  private List<String> iFd;
  ...
  public d(String paramString, List<String> paramList, com.tencent.mm.msgsubscription.storage.d paramd, e.b paramb)
  {
    ...
    this.iEV = paramd;
    this.iEU = paramb;
    this.iFd.addAll((Collection)paramList);
  ...
  public final void run()
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      localdlp.FZa = ((String)localObject1);
      localdlp.Hkk = ((String)localObject3);
      localList.add(localdlp);
    }
    b(localb);
    AppMethodBeat.o(149679);
  }
  
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/msgsubscription/task/GetSubscribeMsgUIStatusTask$Companion;", "", "()V", "TAG", "", "plugin-comm_release"})
  public static final class a {}
  
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"com/tencent/mm/msgsubscription/task/GetSubscribeMsgUIStatusTask$run$netScene$1", "Lcom/tencent/mm/msgsubscription/cgi/NetSceneSubscribeMsg$IOnNetSceneSubscribeEndCallback;", "onNetSceneEndCallback", "", "errType", "", "errCode", "errMsg", "", "result", "Lcom/tencent/mm/msgsubscription/SubscribeMsgRequestResult;", "plugin-comm_release"})
    ...
    implements b.c
  {
    public final void a(final int paramInt1, final int paramInt2, final String paramString, final SubscribeMsgRequestResult paramSubscribeMsgRequestResult)
    {
      ...
      ae.i("MicroMsg.GetSubscribeMsgUIStatusTask", "alvinluo getSubscribeStatus end errType: %d, errCode: %d, errMsg: %s", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), paramString });
      ...
      implements Runnable
    {
      ...
      public final void run()
      {
        ...
        {
          localb = d.a(this.iFg.iFf);
          if (localb != null)
          {
            String str = this.iFg.iFf.dDG;
