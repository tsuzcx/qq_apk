    ...
    implements b.c
  {
      ...
      implements Runnable
    {
      ...
      public final void run()
      {
        ...
        {
          localb = c.a(this.iCj.iCi);
          if (localb != null)
          {
            String str = this.iCj.iCi.dCB;
