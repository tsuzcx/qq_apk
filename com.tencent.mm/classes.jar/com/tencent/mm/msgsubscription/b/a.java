...
public final class a
{
  ...
  static
  {
    ...
    hHk = new a();
    sessionId = -1L;
    hHh = (List)new ArrayList();
    hHi = (List)new ArrayList();
    AppMethodBeat.o(149597);
  }
  
  private static String D(String paramString, long paramLong)
  {
    AppMethodBeat.i(149596);
    paramString = u.aqG() + "#" + paramString + "#" + String.valueOf(paramLong);
  ...
  public static void a(String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3)
  {
    ...
    h.vKh.f(17638, new Object[] { paramString1, Integer.valueOf(paramInt1), paramString2, Integer.valueOf(paramInt2), paramString3, Integer.valueOf(1) });
  ...
  public static void a(String paramString1, int paramInt, String paramString2, long paramLong)
  {
    ...
    paramString1 = D(paramString1, paramLong);
    h.vKh.f(17639, new Object[] { paramString1, Integer.valueOf(paramInt), paramString2 });
  ...
  public static void a(String paramString, int paramInt, List<SubscribeMsgTmpItem> paramList, long paramLong)
  {
    ...
    Object localObject3 = (Iterable)hHi;
    int i = 0;
    ...
    paramList = aC(paramList);
    localObject2 = D(paramString, paramLong);
    ...
    h.vKh.f(17524, new Object[] { Integer.valueOf(0), paramList, Integer.valueOf(paramInt), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), paramString, "", ((o)localObject1).first, ((o)localObject1).second, Integer.valueOf(2), localObject2 });
    AppMethodBeat.o(149591);
  }
  
  private static String aC(List<SubscribeMsgTmpItem> paramList)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      localJSONObject.put("templateId", localSubscribeMsgTmpItem.gIj);
      localJSONObject.put("templateType", localSubscribeMsgTmpItem.hGu);
  ...
  public static void b(String paramString, boolean paramBoolean, List<SubscribeMsgTmpItem> paramList)
  {
    ...
    if (paramList.hasNext())
    {
      SubscribeMsgTmpItem localSubscribeMsgTmpItem = (SubscribeMsgTmpItem)paramList.next();
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("scopeID", localSubscribeMsgTmpItem.gIj);
      localJSONObject.put("scopeName", localSubscribeMsgTmpItem.title);
      if (localSubscribeMsgTmpItem.hGw == 1) {}
      for (boolean bool = true;; bool = false)
      {
        localJSONObject.put("selected", bool);
        localJSONArray.put(localJSONObject);
