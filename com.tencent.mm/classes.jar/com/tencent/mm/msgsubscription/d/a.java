...
@l(iBK={1, 1, 16}, iBL={""}, iBM={"Lcom/tencent/mm/msgsubscription/storage/ISubscribeStorageManager;", "", "clearStorage", "", "getSubscribeMsgListWrapper", "Lcom/tencent/mm/msgsubscription/api/ISubscribeMsgService$Companion$SubscribeMsgListWrapper;", "bizUsername", "", "getSubscribeSwitchOpened", "", "getSubscribeTmpByTemplateId", "Lcom/tencent/mm/msgsubscription/SubscribeMsgTmpItem;", "templateId", "saveSubscribeMsgList", "scene", "", "subscribeMsgList", "", "subscribeSwitchOpened", "updateSubscribeStatus", "toSaveList", "switchOpened", "needUpdateSwitchOpen", "needUpdateTimestamp", "updateSubscribeStatusTimestamp", "plugin-comm_release"})
public abstract interface a
{
  public abstract boolean YY(String paramString);
  
  public abstract ISubscribeMsgService.Companion.SubscribeMsgListWrapper YZ(String paramString);
  ...
  public abstract SubscribeMsgTmpItem bL(String paramString1, String paramString2);
