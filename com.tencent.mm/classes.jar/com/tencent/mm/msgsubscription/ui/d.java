...
@l(iBK={1, 1, 16}, iBL={""}, iBM={"getAppropriateLargeScreenRequestDialogWidth", "", "context", "Landroid/content/Context;", "dialogMeasuredWidth", "dp2Px", "dp", "isLargeScreenEnv", "", "onPreDrawOnce", "", "Landroid/view/View;", "block", "Lkotlin/Function0;", "postRequestLayout", "wxbiz-msgsubscription-sdk_release"})
public final class d
{
  static final void b(View paramView, final kotlin.g.a.a<x> parama)
  {
  ...
  static final int dg(Context paramContext)
  {
    AppMethodBeat.i(174570);
    paramContext = paramContext.getResources();
    p.j(paramContext, "this.resources");
    int i = kotlin.h.a.dm(paramContext.getDisplayMetrics().density * 375.0F);
    AppMethodBeat.o(174570);
    return i;
  }
  
  static final boolean dh(Context paramContext)
  {
  ...
  @l(iBK={1, 1, 16}, iBL={""}, iBM={"com/tencent/mm/msgsubscription/ui/SubscribeMsgRequestDialogKt$onPreDrawOnce$1", "Landroid/view/ViewTreeObserver$OnPreDrawListener;", "onPreDraw", "", "wxbiz-msgsubscription-sdk_release"})
