  ...
  extends MMActivity
{
  ...
  static
  {
    ...
    $$delegatedProperties = new d.l.k[] { (d.l.k)w.a(new u(w.bn(SubscribeMsgRequestProxyUI.class), "bizUsername", "getBizUsername()Ljava/lang/String;")), (d.l.k)w.a(new u(w.bn(SubscribeMsgRequestProxyUI.class), "action", "getAction()I")), (d.l.k)w.a(new u(w.bn(SubscribeMsgRequestProxyUI.class), "subscribeUrl", "getSubscribeUrl()Ljava/lang/String;")), (d.l.k)w.a(new u(w.bn(SubscribeMsgRequestProxyUI.class), "content", "getContent()Ljava/lang/String;")) };
    ikE = new a((byte)0);
  ...
  public SubscribeMsgRequestProxyUI()
  {
    ...
    this.ikA = g.K((d.g.a.a)new c(this));
    this.ikB = g.K((d.g.a.a)new b(this));
    this.ikC = g.K((d.g.a.a)new g(this));
    this.ikD = g.K((d.g.a.a)new d(this));
  ...
  private final String aLn()
  {
    ...
    String str = (String)this.ikA.getValue();
  ...
  private final int getAction()
  {
    ...
    int i = ((Number)this.ikB.getValue()).intValue();
  ...
  public final void onBackPressed()
  {
    ...
    ac.v("MicroMsg.SubscribeMsgRequestProxyUI", "alvinluo onBackPressed currentAction: %d", new Object[] { Integer.valueOf(this.ikz) });
    if (this.ikz == 1)
    {
      e locale = this.iky;
      if (locale != null)
  ...
  public final void onCreate(Bundle paramBundle)
  {
    ...
    this.fxw = h.b((Context)this, getResources().getString(2131760706), false, null);
    paramBundle = getContext();
    d.g.b.k.g(paramBundle, "context");
    paramBundle = new b.b((Context)paramBundle, getAction(), aLn(), (String)this.ikC.getValue(), (String)this.ikD.getValue(), (b.a)new e(this));
    if (getAction() == 3) {
      this.ikz = 1;
    }
    b localb = b.ihZ;
  ...
  @d.l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lcom/tencent/mm/msgsubscription/ui/SubscribeMsgRequestProxyUI$Companion;", "", "()V", "TAG", "", "plugin-comm_release"})
    ...
    implements b.a
  {
    public final void a(int paramInt1, int paramInt2, int paramInt3, String paramString)
    {
      ...
      ac.e("MicroMsg.SubscribeMsgRequestProxyUI", "alvinluo subscribeMsgRequest onError bizUsername: %s, action: %d, errType: %d, errCode: %d, errMsg: %s", new Object[] { SubscribeMsgRequestProxyUI.c(this.ikF), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), paramString });
      paramString = (Context)this.ikF.getContext();
      Object localObject = z.KUT;
      localObject = this.ikF.getString(2131764318);
      ...
      paramString = SubscribeMsgRequestProxyUI.b(this.ikF);
      if (paramString != null) {
        paramString.dismiss();
      }
      SubscribeMsgRequestProxyUI.a(this.ikF);
    ...
    public final void a(SubscribeMsgRequestResult paramSubscribeMsgRequestResult)
    {
      ...
      ac.i("MicroMsg.SubscribeMsgRequestProxyUI", "alvinluo onSubscribeMsgSuccess bizUsername: %s, %d", new Object[] { SubscribeMsgRequestProxyUI.c(this.ikF), Integer.valueOf(paramSubscribeMsgRequestResult.igI.size()) });
      SubscribeMsgRequestProxyUI.d(this.ikF);
      SubscribeMsgRequestProxyUI.a(this.ikF);
    ...
    public final void a(com.tencent.mm.plugin.appbrand.widget.dialog.k paramk, e parame)
    {
      ...
      ac.i("MicroMsg.SubscribeMsgRequestProxyUI", "alvinluo subscribeMsgRequest onShowDialog");
      SubscribeMsgRequestProxyUI.a(this.ikF, paramk);
      SubscribeMsgRequestProxyUI.a(this.ikF, parame);
    ...
    public final void a(boolean paramBoolean, SubscribeMsgRequestResult paramSubscribeMsgRequestResult)
    {
      ...
      d.g.b.k.h(paramSubscribeMsgRequestResult, "result");
      ac.i("MicroMsg.SubscribeMsgRequestProxyUI", "alvinluo onGetSubscribeListSuccess bizUsername: %s, %d, showDialog: %b", new Object[] { SubscribeMsgRequestProxyUI.c(this.ikF), Integer.valueOf(paramSubscribeMsgRequestResult.igI.size()), Boolean.valueOf(paramBoolean) });
      paramSubscribeMsgRequestResult = SubscribeMsgRequestProxyUI.b(this.ikF);
      if (paramSubscribeMsgRequestResult != null) {
        paramSubscribeMsgRequestResult.dismiss();
      }
      SubscribeMsgRequestProxyUI.d(this.ikF);
      if ((SubscribeMsgRequestProxyUI.e(this.ikF) == 1) || (!paramBoolean)) {
        SubscribeMsgRequestProxyUI.a(this.ikF);
      }
    ...
    public final void aLh()
    {
      ...
      ac.i("MicroMsg.SubscribeMsgRequestProxyUI", "alvinluo subscribeMsgRequest onDismissDialog");
      SubscribeMsgRequestProxyUI.a(this.ikF, null);
    ...
    public final void aLi()
    {
      ...
      p localp = SubscribeMsgRequestProxyUI.b(this.ikF);
      if (localp != null)
      {
        localp.dismiss();
    ...
    public final void onCancel()
    {
      ...
      ac.i("MicroMsg.SubscribeMsgRequestProxyUI", "alvinluo subscribeMsgRequest onCancel");
      SubscribeMsgRequestProxyUI.f(this.ikF);
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      SubscribeMsgRequestProxyUI.g(this.ikF);
