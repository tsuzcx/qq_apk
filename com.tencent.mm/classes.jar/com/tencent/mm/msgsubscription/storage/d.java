...
@l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lcom/tencent/mm/msgsubscription/storage/ISubscribeStorageManager;", "", "clearStorage", "", "getSubscribeMsgListWrapper", "Lcom/tencent/mm/msgsubscription/storage/IBrandSubscribeMsgService$Companion$SubscribeMsgListWrapper;", "bizUsername", "", "getSubscribeSwitchOpened", "", "getSubscribeTmpByTemplateId", "Lcom/tencent/mm/msgsubscription/SubscribeMsgTmpItem;", "templateId", "saveSubscribeMsgList", "scene", "", "subscribeMsgList", "", "subscribeSwitchOpened", "saveSubscribeMsgSubscribeStatus", "toSaveList", "isOpened", "saveSubscribeMsgUiStatus", "switchOpened", "needUpdateSwitchOpen", "needUpdateTimestamp", "plugin-comm_release"})
public abstract interface d
{
  public abstract boolean BD(String paramString);
  
  public abstract IBrandSubscribeMsgService.Companion.SubscribeMsgListWrapper BE(String paramString);
