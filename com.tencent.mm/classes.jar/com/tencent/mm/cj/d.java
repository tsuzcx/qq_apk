...
{
  public static d IRB;
  private static int IRC;
  public static final String IRE;
  public static a IRw;
  static ap gIf;
  private volatile boolean IRD;
  private LinkedBlockingQueue<a> IRF;
  ExecutorService IRG;
  public WeakReference<b> IRH;
  ...
  static
  {
    ...
    IRC = 5242880;
    IRE = Environment.getExternalStorageDirectory() + "/tencent/MicroMsg/tracedog/";
    IRw = null;
    gIf = new ap()
    {
      public final void handleMessage(Message paramAnonymousMessage)
      {
        ...
        if (paramAnonymousMessage.what == 0) {
          d.IRB.b((d.a)paramAnonymousMessage.obj);
        }
        for (;;)
        {
          ...
          if (paramAnonymousMessage.what == 1)
          {
            ...
            d.a(d.IRB, (d.a)paramAnonymousMessage.obj);
          }
        }
      }
    };
  ...
  private void a(a parama)
  {
    ...
    for (;;)
    {
      try
      {
        Object localObject = new e(IRE);
        if ((parama.dLg != 6) && (((e)localObject).exists()))
        {
          ad.i("MicroMsg.TraceDebugManager", "TRACE delete all file ");
          i.cZ(q.B(((e)localObject).mUri), true);
        }
      ...
      catch (Throwable localThrowable)
      {
        ...
        if ((!bt.isNullOrNil(parama.className)) && (parama.dLg != 5)) {
          continue;
        }
        gIf.sendMessageDelayed(localMessage, 15000L);
        AppMethodBeat.o(145601);
        return;
        gIf.sendMessageDelayed(localMessage, 10000L);
        AppMethodBeat.o(145601);
      }
      if (parama.dLg != 6) {
        continue;
  ...
  private void abp(final int paramInt)
  {
    AppMethodBeat.i(145609);
    this.IRG.execute(new Runnable()
    {
      public final void run()
      {
        ...
        d locald = d.this;
        if (paramInt == 4) {}
        for (String str = "/data/anr/";; str = d.IRE)
        {
          d.a(locald, str);
  ...
  private static String ad(e parame)
  {
    ...
    if (parame.isDirectory())
    {
      ...
      {
        localArrayList.add(q.B(parame[i].fOK()));
        i += 1;
      }
    }
    localArrayList.add(q.B(parame.fOK()));
    parame = new e(IRE + bt.flT() + ".zip");
    try
    {
      i.u(localArrayList, q.B(parame.fOK()));
      i = 0;
    ...
    {
      ad.e("MicroMsg.TraceDebugManager", "exception:%s", new Object[] { bt.n(parame) });
  ...
  private static void fuy()
  {
    AppMethodBeat.i(145602);
    gIf.removeMessages(0);
    gIf.removeMessages(2);
    gIf.removeMessages(1);
    AppMethodBeat.o(145602);
  }
  
  final void aVf(String paramString)
  {
      ...
      else
      {
        ...
        else
        {
          ...
          if ((paramString != null) && (new e(paramString).length() >= 131072L)) {
            ...
            {
              boolean bool = IRw.aun(paramString);
  ...
  public final boolean b(final a parama)
  {
    ...
    fuy();
    if ((!this.IRD) || (this.imJ))
    {
      ad.i("MicroMsg.TraceDebugManager", "TRACE stopTrace hasStartTrace : %b ,isUploading :%b  ", new Object[] { Boolean.valueOf(this.IRD), Boolean.valueOf(this.imJ) });
    ...
    this.IRG.execute(new Runnable()
    {
      ...
      public final void run()
      {
        ...
        //   8: aload_0
        //   9: getfield 21	com/tencent/mm/cj/d$1:IRI	Lcom/tencent/mm/cj/d$a;
        //   12: getfield 50	com/tencent/mm/cj/d$a:savePath	Ljava/lang/String;
        //   15: astore 4
        //   17: aload_0
        //   18: getfield 21	com/tencent/mm/cj/d$1:IRI	Lcom/tencent/mm/cj/d$a;
        //   21: getfield 54	com/tencent/mm/cj/d$a:IRL	I
        //   24: istore_1
        //   25: aload_0
        //   26: getfield 21	com/tencent/mm/cj/d$1:IRI	Lcom/tencent/mm/cj/d$a;
        //   29: getfield 50	com/tencent/mm/cj/d$a:savePath	Ljava/lang/String;
        //   32: astore 5
        //   34: aload 5
        //   36: ifnonnull +17 -> 53
        //   39: aload_0
        //   40: getfield 19	com/tencent/mm/cj/d$1:IRJ	Lcom/tencent/mm/cj/d;
        ...
        //   108: aload 5
        //   110: aload 4
        //   112: invokevirtual 98	com/tencent/mm/vfs/e:ag	(Lcom/tencent/mm/vfs/e;)Z
        //   115: pop
        //   116: aload 5
        ...
        //   152: aload_0
        //   153: getfield 21	com/tencent/mm/cj/d$1:IRI	Lcom/tencent/mm/cj/d$a;
        //   156: getfield 123	com/tencent/mm/cj/d$a:dLg	I
        //   159: bipush 6
        ...
        //   173: aload 5
        //   175: aload 4
        //   177: invokevirtual 130	com/tencent/mm/vfs/e:fOK	()Landroid/net/Uri;
        ...
        //   194: aload 4
        //   196: invokevirtual 130	com/tencent/mm/vfs/e:fOK	()Landroid/net/Uri;
        ...
        //   222: pop
        //   223: getstatic 152	com/tencent/mm/cj/d:gIf	Lcom/tencent/mm/sdk/platformtools/ap;
        //   226: iconst_1
        //   227: invokevirtual 158	com/tencent/mm/sdk/platformtools/ap:sendEmptyMessage	(I)Z
        //   230: pop
        //   231: aload_0
        //   232: getfield 19	com/tencent/mm/cj/d$1:IRJ	Lcom/tencent/mm/cj/d;
        ...
        //   256: iconst_0
        //   257: aload 4
        //   259: invokestatic 166	com/tencent/mm/sdk/platformtools/bt:n	(Ljava/lang/Throwable;)Ljava/lang/String;
        //   262: aastore
        ...
        //   285: aload_0
        //   286: getfield 19	com/tencent/mm/cj/d$1:IRJ	Lcom/tencent/mm/cj/d;
        ...
        //   298: return
        //   299: aload_0
        //   300: getfield 19	com/tencent/mm/cj/d$1:IRJ	Lcom/tencent/mm/cj/d;
        //   303: invokestatic 179	com/tencent/mm/cj/d:a	(Lcom/tencent/mm/cj/d;)Ljava/util/concurrent/LinkedBlockingQueue;
        //   306: ifnull +16 -> 322
        //   309: aload_0
        //   310: getfield 19	com/tencent/mm/cj/d$1:IRJ	Lcom/tencent/mm/cj/d;
        ...
        //   319: ifne +50 -> 369
        //   322: aload 4
        //   324: invokestatic 189	com/tencent/mm/cj/d:ae	(Lcom/tencent/mm/vfs/e;)Ljava/lang/String;
        //   327: astore 4
        //   329: aload 4
        //   331: invokestatic 193	com/tencent/mm/sdk/platformtools/bt:isNullOrNil	(Ljava/lang/String;)Z
        //   334: ifne +35 -> 369
        //   337: aload_0
        //   338: getfield 19	com/tencent/mm/cj/d$1:IRJ	Lcom/tencent/mm/cj/d;
        //   341: astore 5
        //   343: iload_1
        //   344: iconst_1
        ...
        //   362: aload 5
        //   364: aload 4
        //   366: invokevirtual 208	com/tencent/mm/cj/d:aVf	(Ljava/lang/String;)V
        //   369: aload_0
        //   370: getfield 19	com/tencent/mm/cj/d$1:IRJ	Lcom/tencent/mm/cj/d;
        ...
        //   428: astore 4
        //   430: aload_0
        //   431: getfield 19	com/tencent/mm/cj/d$1:IRJ	Lcom/tencent/mm/cj/d;
        ...
        //   461: aload_0
        //   462: getfield 19	com/tencent/mm/cj/d$1:IRJ	Lcom/tencent/mm/cj/d;
  ...
  public final void c(a parama)
  {
    ...
    if (this.IRG == null) {
      this.IRG = Executors.newSingleThreadExecutor();
    }
    if ((this.imJ) || (this.IRD))
    {
      ad.i("MicroMsg.TraceDebugManager", "TRACE isUloading or hasStartTrace %b %b", new Object[] { Boolean.valueOf(this.imJ), Boolean.valueOf(this.IRD) });
      AppMethodBeat.o(145608);
      return;
    }
    gIf.removeMessages(0);
    if ((parama.IRL == 4) || (parama.IRL == 5)) {
      abp(parama.IRL);
    }
    for (;;)
    {
      ad.i("MicroMsg.TraceDebugManager", "TRACE PUSH : class : %s  code :%s type :%s", new Object[] { parama.className, Integer.valueOf(parama.dLg), Integer.valueOf(parama.IRL) });
      AppMethodBeat.o(145608);
      return;
      if ((parama.dLg == 6) || (parama.dLg == 5))
      {
        Message localMessage = Message.obtain();
        localMessage.what = 2;
        localMessage.obj = parama;
        if (parama.dLg == 5) {
          gIf.sendMessage(localMessage);
        } else {
          gIf.sendMessageDelayed(localMessage, 500L);
        }
      }
      else
      {
        if (this.IRF == null) {
          this.IRF = new LinkedBlockingQueue();
        }
        this.IRF.clear();
        this.IRF.add(parama);
      }
  ...
  public final void gt(String paramString, int paramInt)
  {
    ...
    if ((this.IRF != null) && (this.IRF.size() > 0))
    {
      ad.i("MicroMsg.TraceDebugManager", "TRACE gatherData : isUploading : %b  hasStart :%b currentClass : %s currentCode %d ", new Object[] { Boolean.valueOf(this.imJ), Boolean.valueOf(this.IRD), paramString, Integer.valueOf(paramInt) });
      if ((!this.imJ) && (!this.IRD))
      {
        Iterator localIterator = this.IRF.iterator();
        while (localIterator.hasNext())
        {
          a locala = (a)localIterator.next();
          if (locala.className != null)
          {
            if ((locala.className.equals(paramString)) && (locala.dLg == paramInt))
            {
              a(locala);
              this.IRF.remove(locala);
  ...
  public static final class a
  {
    ...
    public a(String paramString, int paramInt1, int paramInt2, int paramInt3)
    {
      ...
      if (bt.isNullOrNil(paramString))
      {
        localStringBuilder1.append(d.IRE).append("WEIXIN_").append(System.currentTimeMillis()).append(".trace");
      ...
      StringBuilder localStringBuilder2 = localStringBuilder1.append(d.IRE).append(paramString).append("_");
      paramString = "";
      switch (paramInt1)
      {
      }
