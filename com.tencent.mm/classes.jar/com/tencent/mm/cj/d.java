...
public final class d
{
  ...
  public final String getQuantityString(int paramInt1, int paramInt2, Object... paramVarArgs)
  {
    ...
    try
    {
      j = this.UQO.indexOfKey(paramInt1);
      if (j < 0)
      {
        AppMethodBeat.o(141241);
        return null;
      }
      localObject1 = (a)this.UQO.valueAt(j);
      k = ((a)localObject1).UQQ.length;
      paramInt1 = 0;
      i = 0;
    }
    ...
    if (paramInt1 < k)
    {
      if (localObject1.UQQ[paramInt1] == paramInt2) {
        i = paramInt1;
      }
    }
    else
    {
      if (j <= this.UQO.size() - 1) {
        if (i >= k - 1)
        {
          localObject2 = (a)this.UQO.valueAt(j + 1);
          localObject1 = new String(this.mData, localObject1.UQR[i], localObject2.UQR[0] - localObject1.UQR[i]);
        }
      }
      for (;;)
      {
        ...
        localObject1 = new String(this.mData, localObject1.UQR[i], localObject1.UQR[(i + 1)] - localObject1.UQR[i]);
        continue;
        if (i >= k - 1) {
          localObject1 = new String(this.mData, localObject1.UQR[i], this.mData.length - localObject1.UQR[i]);
        } else {
          localObject1 = new String(this.mData, localObject1.UQR[i], localObject1.UQR[(i + 1)] - localObject1.UQR[i]);
        }
      }
  ...
  static final class a
  {
    ...
    {
      this.UQP = paramInt;
      this.UQQ = paramArrayOfInt1;
      this.UQR = paramArrayOfInt2;
    }
  }
}
