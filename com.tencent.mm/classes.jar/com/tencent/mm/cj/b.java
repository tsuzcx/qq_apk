...
{
  public static final String IRu;
  
  static
  {
    AppMethodBeat.i(145591);
    IRu = Environment.getExternalStorageDirectory() + "/tencent/MicroMsg/memory/";
    AppMethodBeat.o(145591);
  }
  
  private static boolean aR(boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public static String aS(boolean paramBoolean1, boolean paramBoolean2)
  {
    AppMethodBeat.i(145585);
    if (!aR(paramBoolean1, paramBoolean2))
    {
    ...
    ((StringBuffer)localObject).append(IRu).append(str).append(".hprof");
    localObject = ((StringBuffer)localObject).toString();
    if (!ac(new e((String)localObject).fOJ()))
    {
    ...
    try
    {
      ...
      ad.i("MicroMsg.MemoryDumpManager", "dump file %s, use time %d", new Object[] { str, Long.valueOf(bt.Df(l)) });
      AppMethodBeat.o(145585);
      return localObject;
    }
  ...
  public static String aVe(String paramString)
  {
    ...
    long l = System.currentTimeMillis();
    Object localObject = new StringBuffer();
    ((StringBuffer)localObject).append(IRu).append(paramString).append(".hprof");
    localObject = ((StringBuffer)localObject).toString();
    if (!ac(new e((String)localObject).fOJ()))
    {
      ad.i("MicroMsg.MemoryDumpManager", "failed to create dir for hprof file: %s", new Object[] { localObject });
    ...
    try
    {
      ...
      Debug.dumpHprofData((String)localObject);
      Toast.makeText(aj.getContext(), (String)localObject + " hprof file has saved ", 0).show();
      ad.i("MicroMsg.MemoryDumpManager", "dump file %s, use time %d", new Object[] { paramString, Long.valueOf(bt.Df(l)) });
  ...
  private static boolean ac(e parame)
  {
  ...
  public static void fuw()
  {
    ...
    //   8: bipush 14
    //   10: if_icmplt +17 -> 27
    //   13: getstatic 262	com/tencent/mm/performance/a/a:iJX	Lcom/tencent/mm/performance/a/a$a;
    ...
    //   97: ldc 99
    //   99: aload 5
    //   101: invokestatic 231	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   104: goto -26 -> 78
    //   107: astore_1
    //   108: aload_3
    //   109: astore_2
    ...
    //   112: ldc 99
    //   114: ldc_w 300
    //   117: invokestatic 201	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   120: aload_3
    //   121: ifnull +7 -> 128
    //   124: aload_3
    ...
    //   198: ldc 99
    //   200: ldc_w 312
    //   203: invokestatic 201	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   206: aload_3
    //   207: ifnull +7 -> 214
    //   210: aload_3
