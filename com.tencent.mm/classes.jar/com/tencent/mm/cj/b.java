...
{
  public static final String Hee;
  
  static
  {
    AppMethodBeat.i(145591);
    Hee = Environment.getExternalStorageDirectory() + "/tencent/MicroMsg/memory/";
    AppMethodBeat.o(145591);
  }
  
  private static boolean aK(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        {
          ac.e("MicroMsg.MemoryDumpManager", "hprofFileCheck parse date fail %s", new Object[] { str });
          locale.delete();
          boolean bool2 = bool1;
          continue;
    ...
    {
      if (paramBoolean2) {
        Toast.makeText(ai.getContext(), "dump fail, hprof file size exceed", 0).show();
      }
      ac.w("MicroMsg.MemoryDumpManager", "hprofFileCheck hprofFileDir.length() too large " + localObject.length);
      AppMethodBeat.o(145584);
      return false;
    }
    AppMethodBeat.o(145584);
  ...
  public static String aL(boolean paramBoolean1, boolean paramBoolean2)
  {
    AppMethodBeat.i(145585);
    if (!aK(paramBoolean1, paramBoolean2))
    {
    ...
    ((StringBuffer)localObject).append(Hee).append(str).append(".hprof");
    localObject = ((StringBuffer)localObject).toString();
    if (!aa(new e((String)localObject).fxU()))
    {
      ac.i("MicroMsg.MemoryDumpManager", "failed to create dir for hprof file: %s", new Object[] { localObject });
      AppMethodBeat.o(145585);
      return null;
    }
    try
    {
      ...
      if (paramBoolean2) {
        Toast.makeText(ai.getContext(), (String)localObject + " hprof file has saved ", 0).show();
      }
      ac.i("MicroMsg.MemoryDumpManager", "dump file %s, use time %d", new Object[] { str, Long.valueOf(bs.Ap(l)) });
      AppMethodBeat.o(145585);
      return localObject;
    }
    catch (Exception localException)
    {
      ac.e("MicroMsg.MemoryDumpManager", " dumpHprofFile Exception");
      AppMethodBeat.o(145585);
    }
    return null;
  }
  ...
  public static String aPn(String paramString)
  {
    ...
    long l = System.currentTimeMillis();
    Object localObject = new StringBuffer();
    ((StringBuffer)localObject).append(Hee).append(paramString).append(".hprof");
    localObject = ((StringBuffer)localObject).toString();
    if (!aa(new e((String)localObject).fxU()))
    {
      ac.i("MicroMsg.MemoryDumpManager", "failed to create dir for hprof file: %s", new Object[] { localObject });
    ...
    try
    {
      ...
      Debug.dumpHprofData((String)localObject);
      Toast.makeText(ai.getContext(), (String)localObject + " hprof file has saved ", 0).show();
      ac.i("MicroMsg.MemoryDumpManager", "dump file %s, use time %d", new Object[] { paramString, Long.valueOf(bs.Ap(l)) });
      paramString = new e((String)localObject);
      if (!paramString.exists())
      {
        ac.e("MicroMsg.MemoryDumpManager", "Hprof dump file is not exist");
        AppMethodBeat.o(145586);
        return null;
      }
    }
    ...
    if (paramString == null)
    {
      ac.e("MicroMsg.MemoryDumpManager", "zip hprof file fail");
      AppMethodBeat.o(145586);
      return null;
    }
    AppMethodBeat.o(145586);
  ...
  private static boolean aa(e parame)
  {
  ...
  private static boolean fem()
  {
    ...
    if (!c.YD())
    {
      ac.i("MicroMsg.MemoryDumpManager", "Hprof sdcard is invalid");
  ...
  public static void feo()
  {
    ...
    //   8: bipush 14
    //   10: if_icmplt +18 -> 28
    //   13: invokestatic 262	com/tencent/mm/performance/a/a:aMA	()Lcom/tencent/mm/performance/a/a;
    //   16: iconst_1
    //   17: iconst_0
    //   18: invokevirtual 266	com/tencent/mm/performance/a/a:m	(ZI)Lcom/tencent/mm/performance/a/a$a;
    //   21: pop
    //   22: ldc 250
    ...
    //   98: ldc 99
    //   100: aload 5
    //   102: invokestatic 231	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   105: goto -26 -> 79
    //   108: astore_1
    //   109: aload_3
    //   110: astore_2
    ...
    //   113: ldc 99
    //   115: ldc_w 299
    //   118: invokestatic 201	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   121: aload_3
    //   122: ifnull +7 -> 129
    //   125: aload_3
    ...
    //   199: ldc 99
    //   201: ldc_w 311
    //   204: invokestatic 201	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   207: aload_3
    //   208: ifnull +7 -> 215
    //   211: aload_3
