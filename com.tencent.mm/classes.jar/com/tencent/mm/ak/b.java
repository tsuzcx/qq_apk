  ...
  extends l
{
  ...
  private b(a parama1, a parama2, String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean1, int paramInt4, int paramInt5, boolean paramBoolean2, int paramInt6)
  {
    ...
    this.hvs = null;
    this.option = 0;
    if ((paramBoolean1) && ((parama1 instanceof cpx))) {}
    for (boolean bool = true;; bool = false)
    {
      this.hvr = new b(parama1, paramInt1, paramInt2, bool, paramInt5);
      this.hvs = new c(parama2, paramInt3, paramBoolean1);
  ...
  public static final class a
  {
    ...
    public final b aAz()
    {
      ...
      if ((this.hvt == null) || (this.hvu == null) || (bs.isNullOrNil(this.uri)) || (this.funcId <= 0) || (this.reqCmdId == -2147483648) || (this.respCmdId == -2147483648))
      {
        boolean bool1;
        boolean bool2;
        label75:
      ...
      Object localObject = new b(this.hvt, this.hvu, this.uri, this.funcId, this.reqCmdId, this.respCmdId, this.hvv, this.timeout, this.routeInfo, this.longPolling, this.longPollingTimeout, (byte)0);
      AppMethodBeat.o(132301);
      return localObject;
    }
    ...
    implements l.b
  {
    ...
    public final byte[] toProtoBuf()
    {
      ...
      if ((this.hvw instanceof cpx)) {
        ((cpx)this.hvw).setBaseRequest(com.tencent.mm.protocal.l.a(this));
      }
      byte[] arrayOfByte = this.hvw.toByteArray();
    ...
    implements l.c
  {
    ...
    public final int fromProtoBuf(byte[] paramArrayOfByte)
    {
      ...
      this.hvw = this.hvw.parseFrom(paramArrayOfByte);
      if (!(this.hvw instanceof czb))
      {
        com.tencent.mm.protocal.l.a(this, ((cqk)this.hvw).getBaseResponse());
        i = ((cqk)this.hvw).getBaseResponse().Ret;
        AppMethodBeat.o(132304);
        return i;
      }
      int i = ((czb)this.hvw).getRet();
      AppMethodBeat.o(132304);
      return i;
    }
