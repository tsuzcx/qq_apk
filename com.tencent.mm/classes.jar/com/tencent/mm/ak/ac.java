...
public final class ac
{
  public static a iNB;
  private long iNA;
  private oicq.wlogin_sdk.request.b iNz;
  ...
  public ac()
  {
    ...
    try
    {
      ...
      byte[] arrayOfByte = util.lZ(MMApplicationContext.getContext());
      if ((arrayOfByte == null) || (arrayOfByte.length == 0)) {
        util.b(MMApplicationContext.getContext(), q.aoG().getBytes());
      }
      this.iNz = new oicq.wlogin_sdk.request.b(MMApplicationContext.getContext(), com.tencent.mm.protocal.d.KyO);
      util.gQV = 1;
      util.Ueq = new b();
  ...
  public final byte[] Ai(long paramLong)
  {
    ...
    if (paramLong != this.iNA)
    {
      Log.e("MicroMsg.WtloginMgr", "dkwt getVerifyImg Error uin ReqUin:%d RespUin:%d", new Object[] { Long.valueOf(this.iNA), Long.valueOf(paramLong) });
      AppMethodBeat.o(132507);
      return new byte[0];
    }
    try
    {
      byte[] arrayOfByte = this.iNz.Pr(paramLong);
      AppMethodBeat.o(132507);
      return arrayOfByte;
    }
    catch (Exception localException)
  ...
  public final byte[] Aj(long paramLong)
  {
    AppMethodBeat.i(132509);
    if (paramLong != this.iNA)
    {
      Log.e("MicroMsg.WtloginMgr", "dkwt getA2KeyByRespBuf Error uin ReqUin:%d RespUin:%d", new Object[] { Long.valueOf(this.iNA), Long.valueOf(paramLong) });
    ...
    for (;;)
    {
      ...
      try
      {
        localWloginSigInfo = this.iNz.UbW.Pu(paramLong);
  ...
  public final void Ak(long paramLong)
  {
    ...
    if (paramLong != this.iNA)
    {
      Log.e("MicroMsg.WtloginMgr", "dkwt clearUserWtInfo Error uin ReqUin:%d RespUin:%d", new Object[] { Long.valueOf(this.iNA), Long.valueOf(paramLong) });
      AppMethodBeat.o(132510);
      return;
    }
    try
    {
      this.iNz.Ps(paramLong);
      AppMethodBeat.o(132510);
      return;
    }
    catch (Exception localException)
  ...
  public final boolean a(long paramLong, byte[] paramArrayOfByte)
  {
    ...
    if (paramLong != this.iNA)
    {
      Log.e("MicroMsg.WtloginMgr", "dkwt parseRespLoginBuf Error uin ReqUin:%d RespUin:%d", new Object[] { Long.valueOf(this.iNA), Long.valueOf(paramLong) });
    ...
    for (;;)
    {
      try
      {
        oicq.wlogin_sdk.request.b localb = this.iNz;
        ...
        {
          util.buY("user:" + localb.UbW._uin + " ResolveSvrData ...");
          i = localb.Ucc.ai(paramArrayOfByte, paramArrayOfByte.length);
          if (i == 1) {
            localb.Ps(localb.UbW._uin);
          }
          util.buY("user:" + localb.UbW._uin + " ResolveSvrData ret=" + i);
          continue;
        }
        AppMethodBeat.o(132506);
      }
  ...
  public final byte[] a(long paramLong, String paramString, boolean paramBoolean)
  {
    ...
    {
      Log.d("MicroMsg.WtloginMgr", "dkwt isTestWtLogin:%b val:%d", new Object[] { Boolean.valueOf(bool), Integer.valueOf(com.tencent.mm.platformtools.ac.jOD) });
      if (com.tencent.mm.platformtools.ac.jOC != 10006) {
        break label96;
      }
    ...
    if (com.tencent.mm.platformtools.ac.jOD == 2)
    {
      AppMethodBeat.o(132505);
      return new byte[0];
    }
    ...
    for (;;)
    {
      try
      {
        if ((g.aAc()) && (iNB != null) && (iNB.aZy()) && (!g.aAh().azQ().getBoolean(ar.a.Oou, true)))
        {
          AppMethodBeat.o(132505);
          return new byte[0];
        }
        ...
        {
          arrayOfByte = this.iNz.a(paramLong, b.a.Uci, "");
          continue;
        }
        paramString = this.iNz.a(paramLong, b.a.Uch, new String(Util.decodeHexString(paramString), "ISO-8859-1"));
        AppMethodBeat.o(132505);
        return paramString;
      }
  ...
  public final byte[] e(long paramLong, String paramString)
  {
    ...
    if (paramLong != this.iNA)
    {
      Log.e("MicroMsg.WtloginMgr", "dkwt getReqLoginBufbyVerifyImg Error uin ReqUin:%d RespUin:%d", new Object[] { Long.valueOf(this.iNA), Long.valueOf(paramLong) });
    ...
    for (paramString = "****".getBytes();; paramString = paramString.getBytes()) {
      try
      {
        paramString = this.iNz.f(paramLong, paramString);
        AppMethodBeat.o(132508);
        return paramString;
      }
      catch (Exception paramString)
 ...
 * Qualified Name:     com.tencent.mm.ak.ac
