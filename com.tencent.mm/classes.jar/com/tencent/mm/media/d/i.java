  ...
  extends f
{
  ...
  private final boolean atp()
  {
    ...
    if (i >= 0)
    {
      ...
      l2 = this.hix.getSampleTime();
      k = this.hix.sampleSize;
      ((ByteBuffer)localObject2).position(0);
      ad.i(this.TAG, "sampleTime : " + l2 + " us");
      if ((k < 0) || (l2 >= this.hiy * 1000L))
      {
        this.hiY = true;
    ...
    for (j = 4;; j = 0)
    {
      ...
      {
        bool = atq();
        ad.i(this.TAG, "inputDecoder cost " + bt.aO(l1));
        if (!bool) {
          break;
        }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((l < this.startTimeMs * 1000L) && ((this.bufferInfo.flags & 0x4) == 0))
        {
          ...
          ad.i(this.TAG, "decoder pts: " + l + ", not reach start: " + this.startTimeMs * 1000L);
          AppMethodBeat.o(93546);
          return false;
        }
        ...
        {
          a(i, this.bufferInfo);
          if ((this.hiy * 1000L != 1L) && (l >= this.hiy * 1000L))
          {
