  ...
  implements GLSurfaceView.EGLConfigChooser
{
  ...
  public a()
  {
    ...
    this.ggH = 0;
    this.ggI = 0;
    this.gio = "MicroMsg.RenderConfigChooser";
    this.EGL_OPENGL_ES2_BIT = 4;
    this.hns = new int[] { 12324, 4, 12323, 4, 12322, 4, 12352, this.EGL_OPENGL_ES2_BIT, 12344 };
    this.ggC = new int[1];
  ...
  private EGLConfig b(EGL10 paramEGL10, EGLDisplay paramEGLDisplay, EGLConfig[] paramArrayOfEGLConfig)
  {
    ...
    p.h(paramArrayOfEGLConfig, "configs");
    ...
    if (i < j)
    {
      ...
      } while ((k != this.ggD) || (m != this.ggE) || (n != this.ggF) || (i1 != this.ggG));
  ...
  private final void c(EGL10 paramEGL10, EGLDisplay paramEGLDisplay, EGLConfig[] paramArrayOfEGLConfig)
  {
    ...
    com.tencent.mm.sdk.platformtools.ad.i((String)localObject1, (String)localObject2);
    int i = 0;
    while (i < k)
    {
      localObject1 = this.gio;
  ...
  public final EGLConfig chooseConfig(EGL10 paramEGL10, EGLDisplay paramEGLDisplay)
  {
    ...
    paramEGL10.eglChooseConfig(paramEGLDisplay, this.hns, null, 0, arrayOfInt);
    int i = arrayOfInt[0];
    if (i <= 0)
    {
    ...
    paramEGL10.eglChooseConfig(paramEGLDisplay, this.hns, arrayOfEGLConfig, i, arrayOfInt);
