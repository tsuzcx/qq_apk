...
{
  private String TAG;
  private com.tencent.mm.media.widget.camerarecordview.preview.b gAY;
  ...
  public b(Context paramContext, SurfaceTexture paramSurfaceTexture, int paramInt1, int paramInt2)
  {
    ...
    this.gAY = new com.tencent.mm.media.widget.camerarecordview.preview.b();
  ...
  public final void a(com.tencent.mm.media.i.a parama, boolean paramBoolean)
  {
    ...
    k.h(parama, "renderer");
    com.tencent.mm.media.widget.camerarecordview.preview.b localb = this.gAY;
    if (localb != null) {
      localb.a(parama, false);
    }
    parama = this.gAY;
    if (parama != null) {
      parama.onSurfaceTextureAvailable(this.gAZ, this.mWidth, this.mHeight);
    }
    parama = this.gAY;
    if (parama != null) {
      parama.onSurfaceTextureSizeChanged(this.gAZ, this.mWidth, this.mHeight);
    }
    parama = this.gAY;
    if (parama != null)
    {
      parama.onSurfaceTextureUpdated(this.gAZ);
  ...
  public final void release()
  {
    ...
    com.tencent.mm.media.widget.camerarecordview.preview.b localb = this.gAY;
    if (localb != null) {
      localb.onSurfaceTextureDestroyed(this.gAZ);
    }
    localb = this.gAY;
    if (localb != null) {
      localb.release();
