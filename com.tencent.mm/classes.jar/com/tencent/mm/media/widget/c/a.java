  ...
  extends h
{
  ...
  public final int E(int paramInt, String paramString)
  {
    ...
    ac.d(this.TAG, "bufferId:" + paramInt + " ,tempPath:" + paramString);
    this.hcC.clear();
  ...
  public final void a(ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      ac.d(this.TAG, "writeAACDataWithADTSLock  ,bufferInfo.size : " + paramBufferInfo.size + ", pts: " + paramBufferInfo.presentationTimeUs);
      Iterator localIterator = ((Iterable)this.hcC).iterator();
  ...
  public final void h(ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    ...
    k.h(paramBufferInfo, "info");
    if ((this.hcC.size() >= 0) && (!this.uMH))
    {
      Iterator localIterator = ((Iterable)this.hcC).iterator();
      while (localIterator.hasNext())
      {
        int i = ((Number)localIterator.next()).intValue();
        ac.d(this.TAG, "writeAACDataLock  ,bufferInfo.size : " + paramBufferInfo.size + ", pts: " + paramBufferInfo.presentationTimeUs);
