...
public final class a
{
  ...
  public final boolean n(ArrayList<String> paramArrayList)
  {
    ...
    if (localIterator1.hasNext())
    {
      ...
      Iterator localIterator2 = ((Iterable)this.haV).iterator();
  ...
  public final void q(JSONObject paramJSONObject)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        this.haT = paramJSONObject.optString((String)localObject1);
      }
      else if (k.g(localObject1, this.haR))
      {
        this.haU = paramJSONObject.optInt((String)localObject1);
      }
      else if (k.g(localObject1, this.haS))
      {
        ...
        for (;;)
        {
          this.haV = ((ArrayList)localObject1);
          break;
          if (str.equals("array"))
          {
