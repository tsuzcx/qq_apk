...
public final class b
{
  ...
  static
  {
    ...
    gAq = "cameraeffect.result.hdrdetected";
  ...
  public b(CaptureResult paramCaptureResult, String paramString, ArrayList<a> paramArrayList)
  {
    ...
    this.gAo = paramCaptureResult;
    this.gAp = paramArrayList;
    if (k.g(paramString, "0")) {
      paramCaptureResult = com.tencent.mm.media.widget.b.a.b.gzx;
    }
  ...
  public final CaptureResult.Key<?> rq(String paramString)
  {
    AppMethodBeat.i(94206);
    k.h(paramString, "key");
    Object localObject1 = this.gAp;
    int i;
    if (localObject1 != null)
    {
      ...
      localObject2 = ((a)localObject2).gzS;
      if ((localObject2 != null) && ((((Integer)localObject2).intValue() & this.gzX) == 0)) {
        break label116;
      }
      i = 1;
      label94:
  ...
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/media/widget/camera2/effect/result/WCCaptureResult$Companion;", "", "()V", "TAG", "", "getTAG", "()Ljava/lang/String;", "WCCAMERA_EFFECT_HDRDetected", "getWCCAMERA_EFFECT_HDRDetected", "plugin-mediaeditor_release"})
