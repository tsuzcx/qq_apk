    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      if ((localObject != null) && (!k.g(localObject, "")))
      {
        ...
        int i = HardCoderJNI.initHardCoder((String)localObject, 0, ".hardcoder.client.sock", (HardCoderJNI.HCPerfManagerThread)b.gzI, null);
        ad.i(this.gzF.TAG, "Read remote persist.sys.hardcoder.name:" + (String)localObject + " initHardCoder:" + i);
    ...
    @d.l(fvt={1, 1, 16}, fvu={""}, fvv={"<anonymous>", "", "type", "", "jsonParameters", "Lorg/json/JSONObject;", "kotlin.jvm.PlatformType", "onGetParameters"})
      ...
      implements WXHardCoderJNI.GetParametersCallback
    {
      ...
      public final void onGetParameters(int paramInt, JSONObject paramJSONObject)
      {
        ...
        if (paramInt == 2)
        {
          this.gzH.gzF.gzz = paramJSONObject.optJSONArray("CameraRequestTags");
          this.gzH.gzF.gzA = paramJSONObject.optJSONArray("CameraResultTags");
          this.gzH.gzF.gzB = paramJSONObject.optJSONArray("CaptureSessionType");
          this.gzH.gzG.invoke();
        }
    ...
    @d.l(fvt={1, 1, 16}, fvu={""}, fvv={"<anonymous>", "Ljava/lang/Thread;", "r", "Ljava/lang/Runnable;", "kotlin.jvm.PlatformType", "name", "", "<anonymous parameter 2>", "", "newThread"})
    static final class b
      implements HardCoderJNI.HCPerfManagerThread
    {
      public static final b gzI;
