...
@l(iBK={1, 1, 16}, iBL={""}, iBM={"Lcom/tencent/mm/media/encoder/MediaCodecAACEncoder;", "Lcom/tencent/mm/media/encoder/IAudioEncoder;", "mediaFormat", "Landroid/media/MediaFormat;", "frameEncodeCallback", "Lkotlin/Function3;", "Ljava/nio/ByteBuffer;", "Lkotlin/ParameterName;", "name", "data", "Landroid/media/MediaCodec$BufferInfo;", "bufferInfo", "format", "", "frameEncodeEndCallback", "Lkotlin/Function0;", "(Landroid/media/MediaFormat;Lkotlin/jvm/functions/Function3;Lkotlin/jvm/functions/Function0;)V", "currentPts", "", "drainEncoder", "sendDataToEncoder", "pcmData", "", "pts", "isLast", "", "startEncoder", "Companion", "plugin-mediaeditor_release"})
  ...
  extends a
{
  ...
  private final void aUD()
  {
    ...
    //   5: aload_0
    //   6: invokevirtual 96	com/tencent/mm/media/e/c:aUl	()Ljava/lang/Object;
    //   9: astore_2
    //   10: aload_2
    //   11: monitorenter
    //   12: aload_0
    //   13: getfield 100	com/tencent/mm/media/e/a:kSa	Z
    //   16: ifeq +18 -> 34
    //   19: ldc 102
    //   21: ldc 104
    //   23: invokestatic 109	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   26: aload_2
    //   27: monitorexit
    //   28: ldc 92
    //   30: invokestatic 60	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   33: return
    //   34: getstatic 115	kotlin/x:aazN	Lkotlin/x;
    //   37: astore_3
    //   38: aload_2
    //   39: monitorexit
    //   40: new 117	android/media/MediaCodec$BufferInfo
    //   43: dup
    //   44: invokespecial 119	android/media/MediaCodec$BufferInfo:<init>	()V
    //   47: astore_2
    //   48: aload_0
    //   49: getfield 78	com/tencent/mm/media/e/a:kTH	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   52: aload_2
    //   53: ldc2_w 120
    //   56: invokevirtual 124	com/tencent/mm/compatible/deviceinfo/aa:a	(Landroid/media/MediaCodec$BufferInfo;J)I
    //   59: istore_1
    //   60: ldc 102
    //   62: ldc 126
    //   64: iconst_1
    ...
    //   127: monitorexit
    //   128: ldc 92
    //   130: invokestatic 60	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   133: aload_3
    //   134: athrow
    //   135: iload_1
    //   136: bipush 254
    ...
    //   141: aload_0
    //   142: getfield 78	com/tencent/mm/media/e/a:kTH	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   145: invokevirtual 158	com/tencent/mm/compatible/deviceinfo/aa:avi	()Landroid/media/MediaFormat;
    //   148: astore_3
    //   149: aload_3
    //   150: ldc 160
    //   152: invokestatic 163	kotlin/g/b/p:j	(Ljava/lang/Object;Ljava/lang/String;)V
    //   155: aload_0
    //   156: aload_3
    ...
    //   169: iconst_0
    //   170: aload_0
    //   171: getfield 171	com/tencent/mm/media/e/a:kTI	Landroid/media/MediaFormat;
    //   174: aastore
    ...
    //   254: aload_0
    //   255: getfield 78	com/tencent/mm/media/e/a:kTH	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   258: invokevirtual 204	com/tencent/mm/compatible/deviceinfo/aa:avk	()[Ljava/nio/ByteBuffer;
    //   261: iload_1
    //   262: aaload
    //   263: astore_3
    //   264: aload_3
    ...
    //   294: aload_0
    //   295: getfield 78	com/tencent/mm/media/e/a:kTH	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   298: iload_1
    //   299: iconst_0
    ...
    //   312: ldc 102
    //   314: ldc 218
    //   316: invokestatic 109	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   319: aload_0
    //   320: getfield 78	com/tencent/mm/media/e/a:kTH	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   323: invokevirtual 221	com/tencent/mm/compatible/deviceinfo/aa:stop	()V
    //   326: aload_0
    //   327: getfield 78	com/tencent/mm/media/e/a:kTH	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   330: invokevirtual 224	com/tencent/mm/compatible/deviceinfo/aa:release	()V
    //   333: ldc 92
    //   335: invokestatic 60	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   338: return
    ...
    //   37	1	3	localx	x
    //   125	9	3	localObject2	Object
    //   148	142	3	localObject3	Object
    // Exception table:
    //   from	to	target	type
  ...
  public final void b(byte[] paramArrayOfByte, long paramLong, boolean paramBoolean)
  {
    ...
    //   5: aload_1
    //   6: ldc 229
    //   8: invokestatic 69	kotlin/g/b/p:k	(Ljava/lang/Object;Ljava/lang/String;)V
    //   11: aload_1
    //   12: ifnonnull +16 -> 28
    //   15: ldc 102
    //   17: ldc 231
    ...
    //   22: ldc 228
    //   24: invokestatic 60	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   27: return
    //   28: aload_0
    //   29: invokevirtual 96	com/tencent/mm/media/e/c:aUl	()Ljava/lang/Object;
    //   32: astore 7
    //   34: aload 7
    //   36: monitorenter
    //   37: aload_0
    //   38: getfield 100	com/tencent/mm/media/e/a:kSa	Z
    //   41: ifeq +41 -> 82
    //   44: ldc 102
    //   46: ldc 233
    //   48: invokestatic 109	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   51: aload 7
    //   53: monitorexit
    //   54: ldc 228
    //   56: invokestatic 60	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   59: return
    //   60: astore_1
    //   61: ldc 102
    //   63: aload_1
    ...
    //   76: ldc 228
    //   78: invokestatic 60	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   81: return
    //   82: getstatic 115	kotlin/x:aazN	Lkotlin/x;
    //   85: astore 8
    //   87: aload 7
    //   89: monitorexit
    //   90: aload_0
    //   91: invokestatic 240	com/tencent/mm/sdk/platformtools/Util:currentTicks	()J
    //   94: putfield 244	com/tencent/mm/media/e/a:kTJ	J
    //   97: ldc 102
    ...
    //   137: invokestatic 109	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   140: aload_0
    //   141: getfield 78	com/tencent/mm/media/e/a:kTH	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   144: ldc2_w 120
    //   147: invokevirtual 275	com/tencent/mm/compatible/deviceinfo/aa:EX	(J)I
    //   150: istore 6
    //   152: iload 6
    //   154: ifge +15 -> 169
    //   157: ldc 102
    ...
    //   165: aload_0
    //   166: invokespecial 279	com/tencent/mm/media/e/c:aUD	()V
    //   169: iload 6
    //   171: iflt +96 -> 267
    //   174: aload_0
    //   175: getfield 78	com/tencent/mm/media/e/a:kTH	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   178: invokevirtual 282	com/tencent/mm/compatible/deviceinfo/aa:avj	()[Ljava/nio/ByteBuffer;
    //   181: iload 6
    //   183: aaload
    //   184: astore 7
    //   186: aload 7
    ...
    //   226: ldc 102
    //   228: ldc_w 298
    //   231: invokestatic 109	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   234: iconst_1
    //   235: istore 5
    //   237: aload_0
    //   238: invokevirtual 301	com/tencent/mm/media/e/c:aUy	()V
    //   241: iload 5
    //   243: ifeq +45 -> 288
    //   246: ldc 102
    //   248: ldc_w 303
    //   251: invokestatic 109	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   254: aload_0
    //   255: getfield 78	com/tencent/mm/media/e/a:kTH	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   258: iload 6
    //   260: aload_1
    ...
    //   267: aload_0
    //   268: invokespecial 279	com/tencent/mm/media/e/c:aUD	()V
    //   271: ldc 228
    ...
    //   280: monitorexit
    //   281: ldc 228
    //   283: invokestatic 60	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   286: aload_1
    //   287: athrow
    //   288: aload_0
    //   289: getfield 78	com/tencent/mm/media/e/a:kTH	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   292: iload 6
    //   294: aload_1
    //   295: arraylength
    //   296: lload_2
  ...
  @l(iBK={1, 1, 16}, iBL={""}, iBM={"Lcom/tencent/mm/media/encoder/MediaCodecAACEncoder$Companion;", "", "()V", "TAG", "", "TIMEOUT", "", "plugin-mediaeditor_release"})
