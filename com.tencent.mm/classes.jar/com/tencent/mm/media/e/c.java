...
@Metadata(d1={""}, d2={"Lcom/tencent/mm/media/encoder/MediaCodecAACEncoder;", "Lcom/tencent/mm/media/encoder/IAudioEncoder;", "mediaFormat", "Landroid/media/MediaFormat;", "frameEncodeCallback", "Lkotlin/Function3;", "Ljava/nio/ByteBuffer;", "Lkotlin/ParameterName;", "name", "data", "Landroid/media/MediaCodec$BufferInfo;", "bufferInfo", "format", "", "frameEncodeEndCallback", "Lkotlin/Function0;", "(Landroid/media/MediaFormat;Lkotlin/jvm/functions/Function3;Lkotlin/jvm/functions/Function0;)V", "currentPts", "", "drainEncoder", "sendDataToEncoder", "pcmData", "", "pts", "isLast", "", "startEncoder", "Companion", "plugin-mediaeditor_release"}, k=1, mv={1, 5, 1}, xi=48)
public final class c
  extends a
{
  public static final c.a nzD;
  ...
  public c(MediaFormat paramMediaFormat, q<? super ByteBuffer, ? super MediaCodec.BufferInfo, ? super MediaFormat, ah> paramq, kotlin.g.a.a<ah> parama)
  {
  ...
  private final void bpk()
  {
    ...
    //   5: aload_0
    //   6: invokevirtual 95	com/tencent/mm/media/e/c:boO	()Ljava/lang/Object;
    //   9: astore_2
    //   10: aload_2
    //   11: monitorenter
    //   12: aload_0
    //   13: getfield 99	com/tencent/mm/media/e/a:nxG	Z
    //   16: ifeq +18 -> 34
    //   19: ldc 101
    //   21: ldc 103
    ...
    //   27: monitorexit
    //   28: ldc 91
    //   30: invokestatic 62	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   33: return
    //   34: getstatic 114	kotlin/ah:aiuX	Lkotlin/ah;
    //   37: astore_3
    //   38: aload_2
    //   39: monitorexit
    ...
    //   47: astore_2
    //   48: aload_0
    //   49: getfield 80	com/tencent/mm/media/e/a:nzs	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   52: aload_2
    //   53: ldc2_w 119
    //   56: invokevirtual 124	com/tencent/mm/compatible/deviceinfo/aa:dequeueOutputBuffer	(Landroid/media/MediaCodec$BufferInfo;J)I
    //   59: istore_1
    //   60: ldc 101
    //   62: ldc 126
    //   64: iconst_1
    ...
    //   119: ldc 91
    //   121: invokestatic 62	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   124: return
    //   125: astore_3
    //   126: aload_2
    //   127: monitorexit
    //   128: ldc 91
    //   130: invokestatic 62	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   133: aload_3
    //   134: athrow
    //   135: iload_1
    //   136: bipush 254
    ...
    //   141: aload_0
    //   142: getfield 80	com/tencent/mm/media/e/a:nzs	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   145: invokevirtual 158	com/tencent/mm/compatible/deviceinfo/aa:getOutputFormat	()Landroid/media/MediaFormat;
    //   148: astore_3
    //   149: aload_3
    //   150: ldc 160
    //   152: invokestatic 163	kotlin/g/b/s:s	(Ljava/lang/Object;Ljava/lang/String;)V
    //   155: aload_0
    //   156: aload_3
    ...
    //   169: iconst_0
    //   170: aload_0
    //   171: getfield 171	com/tencent/mm/media/e/a:nzt	Landroid/media/MediaFormat;
    //   174: aastore
    ...
    //   254: aload_0
    //   255: getfield 80	com/tencent/mm/media/e/a:nzs	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   258: invokevirtual 204	com/tencent/mm/compatible/deviceinfo/aa:aPE	()[Ljava/nio/ByteBuffer;
    //   261: iload_1
    //   262: aaload
    //   263: astore_3
    //   264: aload_3
    ...
    //   294: aload_0
    //   295: getfield 80	com/tencent/mm/media/e/a:nzs	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   298: iload_1
    //   299: iconst_0
    //   300: invokevirtual 216	com/tencent/mm/compatible/deviceinfo/aa:releaseOutputBuffer	(IZ)V
    //   303: aload_2
    ...
    //   319: aload_0
    //   320: getfield 80	com/tencent/mm/media/e/a:nzs	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   323: invokevirtual 221	com/tencent/mm/compatible/deviceinfo/aa:stop	()V
    //   326: aload_0
    //   327: getfield 80	com/tencent/mm/media/e/a:nzs	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   330: invokevirtual 224	com/tencent/mm/compatible/deviceinfo/aa:release	()V
    //   333: ldc 91
    //   335: invokestatic 62	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   338: return
  ...
  public final void b(byte[] paramArrayOfByte, long paramLong, boolean paramBoolean)
  {
    ...
    //   27: return
    //   28: aload_0
    //   29: invokevirtual 95	com/tencent/mm/media/e/c:boO	()Ljava/lang/Object;
    //   32: astore 7
    //   34: aload 7
    //   36: monitorenter
    //   37: aload_0
    //   38: getfield 99	com/tencent/mm/media/e/a:nxG	Z
    //   41: ifeq +41 -> 82
    //   44: ldc 101
    //   46: ldc 232
    ...
    //   81: return
    //   82: getstatic 114	kotlin/ah:aiuX	Lkotlin/ah;
    //   85: astore 8
    //   87: aload 7
    //   89: monitorexit
    //   90: aload_0
    //   91: invokestatic 239	com/tencent/mm/sdk/platformtools/Util:currentTicks	()J
    //   94: putfield 243	com/tencent/mm/media/e/a:nzu	J
    //   97: ldc 101
    //   99: new 245	java/lang/StringBuilder
    //   102: dup
    //   103: ldc 247
    //   105: invokespecial 250	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   108: aload_1
    //   109: arraylength
    //   110: invokevirtual 254	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   113: ldc_w 256
    //   116: invokevirtual 259	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   119: lload_2
    //   120: invokevirtual 262	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   123: ldc_w 264
    //   126: invokevirtual 259	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   129: iload 4
    //   131: invokevirtual 267	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    ...
    //   140: aload_0
    //   141: getfield 80	com/tencent/mm/media/e/a:nzs	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   144: ldc2_w 119
    //   147: invokevirtual 274	com/tencent/mm/compatible/deviceinfo/aa:dequeueInputBuffer	(J)I
    //   150: istore 6
    //   152: iload 6
    //   154: ifge +15 -> 169
    //   157: ldc 101
    ...
    //   165: aload_0
    //   166: invokespecial 278	com/tencent/mm/media/e/c:bpk	()V
    //   169: iload 6
    //   171: iflt +96 -> 267
    //   174: aload_0
    //   175: getfield 80	com/tencent/mm/media/e/a:nzs	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   178: invokevirtual 281	com/tencent/mm/compatible/deviceinfo/aa:aPD	()[Ljava/nio/ByteBuffer;
    //   181: iload 6
    //   183: aaload
    //   184: astore 7
    //   186: aload 7
    //   188: ifnull +9 -> 197
    //   191: aload 7
    //   193: invokevirtual 287	java/nio/ByteBuffer:clear	()Ljava/nio/Buffer;
    //   196: pop
    //   197: aload 7
    //   199: ifnull +10 -> 209
    //   202: aload 7
    //   204: iconst_0
    //   205: invokevirtual 291	java/nio/ByteBuffer:position	(I)Ljava/nio/Buffer;
    //   208: pop
    //   209: aload 7
    //   211: ifnull +10 -> 221
    //   214: aload 7
    //   216: aload_1
    //   217: invokevirtual 295	java/nio/ByteBuffer:put	([B)Ljava/nio/ByteBuffer;
    //   220: pop
    //   221: iload 4
    //   223: ifeq +81 -> 304
    //   226: ldc 101
    ...
    //   235: istore 5
    //   237: aload_0
    //   238: invokevirtual 300	com/tencent/mm/media/e/c:bpa	()V
    //   241: iload 5
    //   243: ifeq +45 -> 288
    //   246: ldc 101
    //   248: ldc_w 302
    ...
    //   262: lload_2
    //   263: iconst_4
    //   264: invokevirtual 306	com/tencent/mm/compatible/deviceinfo/aa:a	(IIJI)V
    //   267: aload_0
    //   268: invokespecial 278	com/tencent/mm/media/e/c:bpk	()V
    //   271: ldc 227
    ...
    //   280: monitorexit
    //   281: ldc 227
    //   283: invokestatic 62	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   286: aload_1
    //   287: athrow
    //   288: aload_0
    //   289: getfield 80	com/tencent/mm/media/e/a:nzs	Lcom/tencent/mm/compatible/deviceinfo/aa;
    //   292: iload 6
    //   294: aload_1
    //   295: arraylength
    //   296: lload_2
    //   297: iconst_0
    //   298: invokevirtual 306	com/tencent/mm/compatible/deviceinfo/aa:a	(IIJI)V
    //   301: goto -34 -> 267
    //   304: iconst_0
    //   305: istore 5
    //   307: goto -66 -> 241
