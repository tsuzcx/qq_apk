...
public final class i
{
  ...
  public i(long paramLong1, long paramLong2, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean1, float paramFloat, boolean paramBoolean2)
  {
    ...
    label237:
    label243:
    for (this.bufId = SightVideoJNI.initDataBufferForMMSightLock(paramInt2, paramInt3, 0, paramInt2, paramInt3, paramFloat, paramInt1, i, 8, 2, 23.0F, false, true, this.duration, false, paramBoolean2, b.aj(true, paramBoolean2));; this.bufId = SightVideoJNI.initDataBufferForRemux(paramBoolean2))
    {
      this.ife = false;
      this.ijm = b.aj(paramBoolean1, paramBoolean2);
  ...
  private void a(com.tencent.mm.media.f.a parama, long paramLong1, long paramLong2)
  {
    ...
    Object localObject = parama.aMt();
    MediaFormat localMediaFormat = parama.igi;
    if ((j >= 0) && (localMediaFormat != null) && (!Util.isNullOrNil((String)localObject)))
    {
      ...
      for (;;)
      {
        ...
        if (parama.igg.getSampleTrackIndex() != j)
        {
  ...
  public final int a(com.tencent.mm.media.f.a parama, String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        Log.i(this.TAG, "output, fps:" + f + ", frameCount:" + this.frameCount + ", outputBitrate:" + this.iix + ", finalChannelCount:" + paramInt2 + ", finalSampleRate:" + paramInt1 + ", outputPath:" + paramString + ", bufId:" + this.bufId + ", mute:" + paramBoolean + ", videoMute:" + bool + ", mediaExtractor:" + parama);
        i = this.bufId;
        int j = Math.max(1000, this.duration);
        int k = this.iix;
        int m = com.tencent.mm.plugin.sight.base.c.Dma;
        if ((paramBoolean) || (bool)) {}
        for (paramBoolean = true;; paramBoolean = false)
        {
          paramInt1 = SightVideoJNI.muxingLock(i, null, paramInt1, 1024, 2, paramInt2, 0L, paramString, f, j, k, m, 8, 2, 23.0F, null, 0, false, paramBoolean, this.iiC, this.iiD, b.aj(this.iiC, this.iiD));
          release();
          if (paramInt1 < 0)
          {
            parama = e.ilC;
  ...
  public final void a(ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo, MediaFormat paramMediaFormat)
  {
    ...
    if (this.ijm)
    {
      ...
      label184:
      for (int j = com.tencent.mm.plugin.mmsight.model.a.QL(paramMediaFormat.getInteger("sample-rate"));; j = 4)
      {
        int k = m;
