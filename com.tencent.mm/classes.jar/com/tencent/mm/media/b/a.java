...
public class a
{
  ...
  public a()
  {
    ...
    this.gnb = ";";
    this.gnc = new String[] { "OMX.oppo.h264.encoder" };
    Object localObject = ((com.tencent.mm.plugin.expt.a.b)g.ab(com.tencent.mm.plugin.expt.a.b.class)).a(b.a.pqr, "");
    k.g(localObject, "supportedHardcodeEncoderList");
    Object[] arrayOfObject = ((Collection)n.b((CharSequence)localObject, new String[] { this.gnb })).toArray(new String[0]);
    ...
    this.gnc = ((String[])arrayOfObject);
    ad.i("MicroMsg.VideoCodecConfig", "supportedHardcodeEncoderList : " + (String)localObject + "  supportedHardcodeEncoder size:" + this.gnc.length);
    if (this.gnc.length == 0) {}
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
  ...
  public final MediaCodecInfo selectCodec(String paramString)
  {
    ...
    while (i < m)
    {
      ...
      {
        ad.i("MicroMsg.VideoCodecConfig", "config to use supportedHardcodeEncoder:" + Arrays.toString(this.gnc));
        arrayOfString = this.gnc;
        ...
        while (j < n)
        {
          ...
          if ((localMediaCodecInfo != null) && (n.I(localMediaCodecInfo.getName(), (String)localObject, true)))
          {
            ...
            ad.i("MicroMsg.VideoCodecConfig", "selectCodec from hardcodeEncoder " + this.gnc + ": " + localMediaCodecInfo.getName());
          }
          j += 1;
        }
      }
