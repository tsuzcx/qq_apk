  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    ad.d("MicroMsg.ClickFlowStatReceiver", "onReceive op:%d ui:%s hash:0x%x time:%d, elapsed time:%d", new Object[] { Integer.valueOf(j), str, Integer.valueOf(i), Long.valueOf(bt.vM(l1)), Long.valueOf(l2) });
    if (2147483632 == j)
    {
      c.a(this.huL);
