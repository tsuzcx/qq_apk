...
public class g
{
  ...
  private static g EMV;
  private static h EMW;
  private static d EMX;
  private static f EMY;
  private static String EMZ;
  private static boolean ENa;
  private static boolean ENb;
  private static a<String, Boolean> ENc;
  
  static
  {
    AppMethodBeat.i(141263);
    EMU = Arrays.asList(new String[] { "zh_CN", "en" });
    EMZ = "";
    ENa = false;
    ENb = true;
    ENc = new a() {};
  ...
  private static int a(DataInputStream paramDataInputStream, SparseArray<d.a> paramSparseArray, int paramInt1, int paramInt2)
  {
    ...
    {
      ad.e("MicroMsg.language.StringResouces", "exception:%s", new Object[] { bt.m(paramDataInputStream) });
      AppMethodBeat.o(141261);
    }
    return 0;
  }
  
  private static boolean aEH(String paramString)
  {
    AppMethodBeat.i(141250);
    if (EMU.contains(paramString))
    {
  ...
  public static g bV(Context paramContext, String paramString)
  {
    ...
    for (paramContext = paramString;; paramContext = ac.aFt(paramString))
    {
      paramContext = paramContext.toString();
      eDm();
      boolean bool = aEH(paramContext);
      ENa = bool;
      if (!bool) {
        break;
      }
  ...
  private static void c(AssetManager paramAssetManager, String paramString)
  {
    ...
    //   5: aload_1
    //   6: invokestatic 146	com/tencent/mm/sdk/platformtools/bt:isNullOrNil	(Ljava/lang/String;)Z
    //   9: ifeq +16 -> 25
    //   12: ldc 94
    //   14: ldc 182
    //   16: invokestatic 185	com/tencent/mm/sdk/platformtools/ad:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   19: ldc 180
    //   21: invokestatic 64	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   24: return
    //   25: aload_1
    //   26: getstatic 52	com/tencent/mm/ce/g:EMZ	Ljava/lang/String;
    ...
    //   45: aload_1
    //   46: aastore
    //   47: invokestatic 192	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   50: ldc 180
    ...
    //   105: aload 10
    //   107: aastore
    //   108: invokestatic 209	com/tencent/mm/sdk/platformtools/ad:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   111: aload 10
    //   113: astore 12
    //   115: invokestatic 179	com/tencent/mm/ce/g:clean	()V
    //   118: aload 12
    //   120: putstatic 52	com/tencent/mm/ce/g:EMZ	Ljava/lang/String;
    //   123: ldc 94
    //   125: ldc 211
    //   127: invokestatic 213	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   237: invokestatic 213	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   240: aload 11
    //   242: astore 10
    //   244: aload_0
    //   245: astore_1
    ...
    //   339: aload 11
    //   341: iload_3
    //   342: invokestatic 267	com/tencent/mm/ce/h:a	(Landroid/util/SparseIntArray;Ljava/io/InputStream;I)Lcom/tencent/mm/ce/h;
    //   345: putstatic 269	com/tencent/mm/ce/g:EMW	Lcom/tencent/mm/ce/h;
    //   348: iconst_0
    //   349: istore_2
    //   350: aload 11
    //   352: astore 10
    ...
    //   385: aastore
    //   386: invokestatic 192	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   389: iload 5
    //   391: ifle +100 -> 491
    //   394: aload 11
    //   396: astore 10
    ...
    //   459: iload 4
    //   461: iload_3
    //   462: invokestatic 279	com/tencent/mm/ce/g:a	(Ljava/io/DataInputStream;Landroid/util/SparseArray;II)I
    //   465: iadd
    //   466: istore_3
    //   467: iload_2
    //   468: iconst_1
    ...
    //   482: aload 11
    //   484: iload_3
    //   485: invokestatic 284	com/tencent/mm/ce/d:a	(Landroid/util/SparseArray;Ljava/io/InputStream;I)Lcom/tencent/mm/ce/d;
    //   488: putstatic 286	com/tencent/mm/ce/g:EMX	Lcom/tencent/mm/ce/d;
    //   491: aload 11
    //   493: astore 10
    //   495: aload_0
    //   496: astore_1
    ...
    //   539: aastore
    //   540: invokestatic 192	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   543: iload 6
    //   545: ifle +162 -> 707
    //   548: aload 11
    //   550: astore 10
    ...
    //   661: aload 13
    //   663: iload 5
    //   665: new 290	com/tencent/mm/ce/f$a
    //   668: dup
    //   669: iload 5
    //   671: aload 14
    //   673: invokespecial 293	com/tencent/mm/ce/f$a:<init>	(I[I)V
    ...
    //   698: aload 11
    //   700: iload_3
    //   701: invokestatic 299	com/tencent/mm/ce/f:b	(Landroid/util/SparseArray;Ljava/io/InputStream;I)Lcom/tencent/mm/ce/f;
    //   704: putstatic 301	com/tencent/mm/ce/g:EMY	Lcom/tencent/mm/ce/f;
    //   707: aload_0
    //   708: ifnull +7 -> 715
    //   711: aload_0
    ...
    //   744: invokestatic 213	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   747: ldc 180
    ...
    //   763: iconst_0
    //   764: aload_0
    //   765: invokestatic 102	com/tencent/mm/sdk/platformtools/bt:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   768: aastore
    //   769: invokestatic 108	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   772: goto -57 -> 715
    //   775: astore_0
    //   776: ldc 94
    //   778: ldc 96
    ...
    //   785: iconst_0
    //   786: aload_0
    //   787: invokestatic 102	com/tencent/mm/sdk/platformtools/bt:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   790: aastore
    //   791: invokestatic 108	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   794: goto -74 -> 720
    //   797: astore 13
    //   799: aconst_null
    //   800: astore 11
    ...
    //   823: aload 12
    //   825: aastore
    //   826: invokestatic 318	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   829: aload_0
    //   830: ifnull +7 -> 837
    //   833: aload_0
    ...
    //   860: iconst_0
    //   861: aload_0
    //   862: invokestatic 102	com/tencent/mm/sdk/platformtools/bt:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   865: aastore
    //   866: invokestatic 108	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   869: goto -149 -> 720
    //   872: astore_0
    //   873: ldc 94
    //   875: ldc 96
    ...
    //   882: iconst_0
    //   883: aload_0
    //   884: invokestatic 102	com/tencent/mm/sdk/platformtools/bt:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   887: aastore
    //   888: invokestatic 108	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   891: goto -54 -> 837
    //   894: astore_0
    //   895: aconst_null
    //   896: astore 11
    ...
    //   940: iconst_0
    //   941: aload_1
    //   942: invokestatic 102	com/tencent/mm/sdk/platformtools/bt:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   945: aastore
    //   946: invokestatic 108	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   949: goto -36 -> 913
    //   952: astore_1
    //   953: ldc 94
    //   955: ldc 96
    ...
    //   962: iconst_0
    //   963: aload_1
    //   964: invokestatic 102	com/tencent/mm/sdk/platformtools/bt:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   967: aastore
    //   968: invokestatic 108	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   971: goto -48 -> 923
    //   974: astore_0
    //   975: goto -70 -> 905
    //   978: astore 13
  ...
  private static void clean()
  {
    ...
    {
      localObject = EMW;
      if (((h)localObject).ENd != null) {
        ((h)localObject).ENd.clear();
      }
      if (((h)localObject).ENe != null) {
        ((h)localObject).ENe = null;
      }
    }
    if (EMX != null)
    {
      localObject = EMX;
      if (((d)localObject).EMO != null) {
        ((d)localObject).EMO.clear();
      }
    ...
    {
      localObject = EMY;
      if (((f)localObject).EMS != null) {
        ((f)localObject).EMS.clear();
      }
  ...
  public static String getQuantityString(int paramInt1, int paramInt2)
  {
    ...
    String str = EMX.getQuantityString(paramInt1, paramInt2, new Object[0]);
    AppMethodBeat.o(141258);
    return str;
  }
  ...
  public static String getQuantityString(int paramInt1, int paramInt2, Object... paramVarArgs)
  {
    ...
    paramVarArgs = EMX.getQuantityString(paramInt1, paramInt2, paramVarArgs);
    AppMethodBeat.o(141259);
    return paramVarArgs;
  }
  ...
  public static String getString(int paramInt)
  {
    ...
    String str = EMW.getString(paramInt);
    AppMethodBeat.o(141257);
    return str;
  }
  ...
  public static String[] getStringArray(int paramInt)
  {
    ...
    f localf = EMY;
    int j = localf.EMS.indexOfKey(paramInt);
    if (j < 0)
    {
      AppMethodBeat.o(141260);
      return null;
    ...
    if (j < localf.EMS.size() - 1)
    {
      paramInt = ((f.a)localf.EMS.valueAt(j + 1)).EMT[0];
      locala = (f.a)localf.EMS.valueAt(j);
      j = locala.EMT.length;
      if (j <= 0) {
        break label223;
      }
      ...
      arrayOfString[i] = new String(localf.mData, locala.EMT[i], locala.EMT[(i + 1)] - locala.EMT[i]);
    }
    for (;;)
    {
      i += 1;
      ...
      break;
      label181:
      arrayOfString[i] = new String(localf.mData, locala.EMT[i], paramInt - locala.EMT[i]);
    }
    for (;;)
    {
      label215:
  ...
  public static g hX(Context paramContext)
  {
    AppMethodBeat.i(141252);
    paramContext = bV(paramContext, ac.f(paramContext.getSharedPreferences(aj.eFD(), 0)));
