...
public final class b
  extends Resources
{
  private static Method EML = null;
  private static Method EMM = null;
  private g EMH;
  private e EMI;
  private boolean EMJ;
  public a EMK;
  ...
  private b(Resources paramResources, g paramg, e parame, a parama)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        this.EMJ = aj.eFE().getBoolean("ShowStringName", false);
  ...
  public static Resources a(Resources paramResources, Context paramContext, String paramString)
  {
    ...
    paramResources = new b(paramResources, g.bV(paramContext, paramString), new e(), new a(paramResources.getDisplayMetrics()));
  ...
  public static Resources a(Resources paramResources, Context paramContext, boolean paramBoolean)
  {
    ...
    paramContext = g.hX(paramContext);
    e locale = new e();
    if (paramBoolean)
    {
  ...
  private Drawable d(Drawable paramDrawable, int paramInt)
  {
    ...
    try
    {
      if (this.EMI.mGX.i(this, paramInt)) {
  ...
  public final DisplayMetrics getDisplayMetrics()
  {
    ...
    if (this.EMK != null)
    {
      localDisplayMetrics = this.EMK.getDisplayMetrics();
  ...
  public final Drawable getDrawable(int paramInt)
  {
    ...
    if (paramInt != 0)
    {
      localDrawable = this.EMI.g(this.mResources, paramInt);
  ...
  public final Drawable getDrawable(int paramInt, Resources.Theme paramTheme)
  {
    ...
    if (paramInt != 0)
    {
      Drawable localDrawable = this.EMI.g(this.mResources, paramInt);
      if (localDrawable != null)
      {
  ...
  public final Drawable getDrawableForDensity(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 != 0)
    {
      localDrawable = this.EMI.g(this.mResources, paramInt1);
      if (localDrawable != null)
      {
  ...
  public final Drawable getDrawableForDensity(int paramInt1, int paramInt2, Resources.Theme paramTheme)
  {
    ...
    if (paramInt1 != 0)
    {
      Drawable localDrawable = this.EMI.g(this.mResources, paramInt1);
      if (localDrawable != null)
      {
  ...
  public final void onConfigurationChanged(Configuration paramConfiguration)
  {
    ...
    if (a.eDb())
    {
      localDisplayMetrics.density = locala.aGM.density;
      localDisplayMetrics.densityDpi = locala.aGM.densityDpi;
      localDisplayMetrics.scaledDensity = locala.aGM.scaledDensity;
      locala.aGM.setTo(localDisplayMetrics);
    }
    super.updateConfiguration(this.EMK.f(paramConfiguration), getDisplayMetrics());
  ...
  public final void updateConfiguration(Configuration paramConfiguration, DisplayMetrics paramDisplayMetrics)
  {
    ...
    {
      locala = this.EMK;
      i = ax.aFC(aj.eFD()).getInt(a.EMq, 0);
      ai.eRR();
      j = ai.eRR().densityDpi;
      if (i == 0) {
        ax.aFC(aj.eFD()).putInt(a.EMq, j);
      }
      ...
      if (i == 0)
      {
        ...
        i = com.tencent.mm.cd.a.hP(aj.getContext());
      ...
      {
      default: 
        com.tencent.mm.cd.a.h(aj.getContext(), f1);
        j = 400;
        switch (i)
        {
        default: 
          ...
          if (i != 0)
          {
            ad.i("MicroMsg.MMDensityManager", "checkDensity density change, mIcheckDensitylistener:%s", new Object[] { a.EMy });
            if (a.EMy != null) {
              a.EMy.KM();
            }
          }
          boolean bool1 = ax.aFC(aj.eFD()).getBoolean(a.EMs, false);
          bool2 = ax.aFC(aj.eFD()).getBoolean(a.EMt, false);
          if (bool1) {}
          break;
        }
        break;
    ...
    try
    {
      ...
      h.vKh.f(17089, new Object[] { Integer.valueOf(i), Integer.valueOf(j), Float.toString(f1), Float.toString(f2), Integer.valueOf(k), Integer.valueOf(ai.eRS()), Integer.valueOf(ai.eRT()), Integer.valueOf(a.olA), Integer.valueOf(Math.min(locala.EMo.widthPixels, locala.EMo.heightPixels)), Float.valueOf(a.EMw) });
      ax.aFC(aj.eFD()).putBoolean(a.EMs, true);
      if (ai.eRS() == 0) {
        break label1148;
      }
      i = Math.round(a.olA / (ai.eRS() / 160.0F));
    }
    catch (Exception localException)
    {
      do
    ...
    for (;;)
    {
      if (!bool2)
      {
        ...
        h.vKh.f(17305, new Object[] { Integer.valueOf(i), Integer.valueOf(m), Integer.valueOf(j), Integer.valueOf(k), Float.toString(f1), Float.toString(f2), Integer.valueOf(n), Integer.valueOf(ai.eRS()), Integer.valueOf(ai.eRT()), Integer.valueOf(a.olA), Integer.valueOf(Math.min(locala.EMo.widthPixels, locala.EMo.heightPixels)), Float.valueOf(a.EMw) });
        ax.aFC(aj.eFD()).putBoolean(a.EMt, true);
      }
      label1018:
      label1148:
      do
      {
        if (a.eDb())
        {
          ...
          localDisplayMetrics = new DisplayMetrics();
          ((WindowManager)aj.getContext().getSystemService("window")).getDefaultDisplay().getMetrics(localDisplayMetrics);
          ad.i("MicroMsg.MMDensityManager", " \n************************************************************************* \nTarget -> %s \nCurrent -> %s \nWindowManager -> %s \nConfiguration -> %s fontScale -> %s \noriginalMetric -> [%s]", new Object[] { a.d(locala.aGM), a.d(paramDisplayMetrics), a.d(localDisplayMetrics), Integer.valueOf(paramConfiguration.densityDpi), Float.valueOf(paramConfiguration.fontScale), locala.EMo });
        }
