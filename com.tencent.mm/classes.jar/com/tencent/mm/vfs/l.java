...
@d.l(gjZ={1, 1, 16}, gka={""}, gkb={"forEachLine", "", "Lcom/tencent/mm/vfs/VFSFile;", "charset", "Ljava/nio/charset/Charset;", "action", "Lkotlin/Function1;", "", "Lkotlin/ParameterName;", "name", "line", "inputStream", "Ljava/io/InputStream;", "readText", "reader", "Ljava/io/InputStreamReader;", "writeBytes", "array", "", "writeText", "text", "mmkernel_release"})
public final class l
{
  /* Error */
  private static java.lang.String a(k paramk, java.nio.charset.Charset paramCharset)
  {
    // Byte code:
    //   0: ldc 36
    ...
    //   29: aload_0
    //   30: invokestatic 59	com/tencent/mm/vfs/o:ai	(Lcom/tencent/mm/vfs/k;)Ljava/io/InputStream;
    //   33: astore_0
    //   34: aload_0
    //   35: ldc 61
  ...
  /* Error */
  public static final void b(k paramk, byte[] paramArrayOfByte)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   19: aload_0
    //   20: invokestatic 121	com/tencent/mm/vfs/o:aj	(Lcom/tencent/mm/vfs/k;)Ljava/io/OutputStream;
