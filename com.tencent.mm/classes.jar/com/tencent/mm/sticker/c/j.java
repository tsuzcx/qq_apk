  ...
  extends i
{
  public j(int paramInt, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, com.tencent.mm.vending.e.b<com.tencent.mm.vending.e.a> paramb, h paramh)
  {
    ...
    paramArrayOfByte1 = new b(paramInt, paramArrayOfByte1, paramArrayOfByte2).auK().j((com.tencent.mm.vending.c.a)new a(paramh));
    if (paramb != null) {
  ...
  @l(fvt={1, 1, 16}, fvu={""}, fvv={"<anonymous>", "", "it", "Lcom/tencent/mm/modelbase/DeprecatedCgi$CgiBack;", "Lcom/tencent/mm/protocal/protobuf/GetLensListResponse;", "kotlin.jvm.PlatformType", "call", "(Lcom/tencent/mm/modelbase/DeprecatedCgi$CgiBack;)Lkotlin/Unit;"})
