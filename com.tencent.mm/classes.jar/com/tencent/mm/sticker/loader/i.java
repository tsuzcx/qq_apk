  ...
  extends g
{
  ...
  public i(StickerLoadInfo paramStickerLoadInfo)
  {
    ...
    this.md5 = paramStickerLoadInfo.Ap();
    paramStickerLoadInfo = new StringBuilder();
    e locale = e.GAP;
    this.poB = (e.eYv() + "preview/");
    paramStickerLoadInfo = new StringBuilder();
    locale = e.GAP;
    this.GAY = (e.eYv() + "preview.zip");
  ...
  public final void call()
  {
    ...
    //   8: dup
    //   9: aload_0
    //   10: getfield 112	com/tencent/mm/sticker/loader/g:GAW	Lcom/tencent/mm/sticker/loader/StickerLoadInfo;
    ...
    //   19: astore 4
    //   21: aload_0
    //   22: getfield 112	com/tencent/mm/sticker/loader/g:GAW	Lcom/tencent/mm/sticker/loader/StickerLoadInfo;
    ...
    //   92: invokestatic 155	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   95: iload_1
    //   96: sipush 200
    //   99: if_icmpeq +43 -> 142
    //   102: aload 8
    ...
    //   107: aload_0
    //   108: getfield 112	com/tencent/mm/sticker/loader/g:GAW	Lcom/tencent/mm/sticker/loader/StickerLoadInfo;
    //   111: iconst_1
    //   112: putfield 162	com/tencent/mm/sticker/loader/StickerLoadInfo:errType	I
    //   115: aload_0
    //   116: iconst_0
    //   117: invokevirtual 166	com/tencent/mm/sticker/loader/i:de	(Z)V
    //   120: aload 4
    //   122: ifnull +14 -> 136
    //   125: aload 4
    ...
    //   141: return
    //   142: aload_0
    //   143: getfield 99	com/tencent/mm/sticker/loader/i:poB	Ljava/lang/String;
    //   146: invokestatic 177	com/tencent/mm/vfs/i:aSh	(Ljava/lang/String;)Z
    //   149: pop
    //   150: aload_0
    //   151: getfield 103	com/tencent/mm/sticker/loader/i:GAY	Ljava/lang/String;
    //   154: invokestatic 181	com/tencent/mm/vfs/i:zA	(Ljava/lang/String;)Ljava/io/OutputStream;
    //   157: astore 5
    //   159: aload 5
    //   161: astore 6
    //   163: aload 4
    ...
    //   226: invokestatic 155	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   229: aload 5
    //   231: astore 6
    //   233: aload 4
    //   235: astore 7
    ...
    //   266: astore 7
    //   268: aload_0
    //   269: getfield 99	com/tencent/mm/sticker/loader/i:poB	Ljava/lang/String;
    ...
    //   282: astore 7
    //   284: aload_0
    //   285: getfield 99	com/tencent/mm/sticker/loader/i:poB	Ljava/lang/String;
    //   288: invokestatic 177	com/tencent/mm/vfs/i:aSh	(Ljava/lang/String;)Z
    //   291: pop
    //   292: aload 5
    //   294: astore 6
    //   296: aload 4
    //   298: astore 7
    //   300: aload_0
    //   301: getfield 103	com/tencent/mm/sticker/loader/i:GAY	Ljava/lang/String;
    //   304: aload_0
    //   305: getfield 99	com/tencent/mm/sticker/loader/i:poB	Ljava/lang/String;
    //   308: invokestatic 214	com/tencent/mm/vfs/i:fp	(Ljava/lang/String;Ljava/lang/String;)I
    //   311: ifeq +48 -> 359
    //   314: aload 5
    //   316: astore 6
    //   318: aload 4
    //   320: astore 7
    //   322: aload_0
    //   323: getfield 112	com/tencent/mm/sticker/loader/g:GAW	Lcom/tencent/mm/sticker/loader/StickerLoadInfo;
    //   326: iconst_2
    ...
    //   338: aload_0
    //   339: iconst_0
    //   340: invokevirtual 166	com/tencent/mm/sticker/loader/i:de	(Z)V
    //   343: aload 4
    ...
    //   384: aload 8
    //   386: aload_0
    //   387: getfield 99	com/tencent/mm/sticker/loader/i:poB	Ljava/lang/String;
    //   390: invokevirtual 223	com/tencent/mm/sticker/f:aMs	(Ljava/lang/String;)V
    //   393: aload 5
    //   395: astore 6
    //   397: aload 4
    //   399: astore 7
    //   401: aload 8
    //   403: aload_0
    //   404: getfield 99	com/tencent/mm/sticker/loader/i:poB	Ljava/lang/String;
    //   407: invokevirtual 226	com/tencent/mm/sticker/f:aMu	(Ljava/lang/String;)V
    //   410: aload 5
    //   412: astore 6
    //   414: aload 4
    //   416: astore 7
    ...
    //   434: aload_0
    //   435: iconst_1
    //   436: invokevirtual 166	com/tencent/mm/sticker/loader/i:de	(Z)V
    //   439: aload 4
    ...
    //   461: astore 7
    //   463: aload_0
    //   464: getfield 112	com/tencent/mm/sticker/loader/g:GAW	Lcom/tencent/mm/sticker/loader/StickerLoadInfo;
    //   467: iconst_2
    ...
    //   479: aload_0
    //   480: iconst_0
    //   481: invokevirtual 166	com/tencent/mm/sticker/loader/i:de	(Z)V
    //   484: goto -45 -> 439
    //   487: astore 8
    //   489: aload 5
    //   491: astore 6
    ...
    //   512: invokestatic 239	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   515: aload 5
    //   517: astore 6
    //   519: aload 4
    //   521: astore 7
    //   523: aload_0
    //   524: getfield 112	com/tencent/mm/sticker/loader/g:GAW	Lcom/tencent/mm/sticker/loader/StickerLoadInfo;
    //   527: iconst_1
    ...
    //   539: aload_0
    //   540: iconst_0
    //   541: invokevirtual 166	com/tencent/mm/sticker/loader/i:de	(Z)V
    //   544: aload 4
    //   546: ifnull +8 -> 554
    //   549: aload 4
    ...
    //   576: astore 7
    //   578: aload_0
    //   579: getfield 103	com/tencent/mm/sticker/loader/i:GAY	Ljava/lang/String;
    //   582: invokestatic 242	com/tencent/mm/vfs/i:aSr	(Ljava/lang/String;)Ljava/lang/String;
    //   585: astore 8
    //   587: aload 5
    //   589: astore 6
    //   591: aload 4
    ...
    //   609: invokestatic 155	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   612: aload 5
    //   614: astore 6
    //   616: aload 4
    //   618: astore 7
    ...
    //   670: astore 7
    //   672: aload_0
    //   673: getfield 112	com/tencent/mm/sticker/loader/g:GAW	Lcom/tencent/mm/sticker/loader/StickerLoadInfo;
    //   676: iconst_2
    ...
    //   688: aload_0
    //   689: iconst_0
    //   690: invokevirtual 166	com/tencent/mm/sticker/loader/i:de	(Z)V
    //   693: goto -254 -> 439
    //   696: astore 5
    //   698: aload 7
    //   700: astore 4
    ...
    //   736: astore 7
    //   738: aload_0
    //   739: getfield 112	com/tencent/mm/sticker/loader/g:GAW	Lcom/tencent/mm/sticker/loader/StickerLoadInfo;
    //   742: iconst_4
    ...
    //   755: astore 7
    //   757: aload_0
    //   758: getfield 112	com/tencent/mm/sticker/loader/g:GAW	Lcom/tencent/mm/sticker/loader/StickerLoadInfo;
    //   761: iconst_5
  ...
  public final void de(boolean paramBoolean)
  {
    ...
    ac.i(this.TAG, "onResult: " + paramBoolean + ", " + this.GAW.errType);
