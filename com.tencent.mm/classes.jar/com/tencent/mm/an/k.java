...
public final class k
{
  ...
  public static String owm = "menu_click";
  public static String own = "menu_action_success";
  public String content;
  public int id;
  public String ihx;
  public String key;
  public String name;
  public List<k> owo = null;
  public int owp;
  public String state;
  public int type;
  public String value;
      ...
      try
      {
        ...
        if (i < j)
        {
          ...
          for (String str = "";; str = String.valueOf(i))
          {
            ...
            localk.owp = Util.getInt((String)paramMap.get(str + ".acttype"), 0);
  ...
  public static List<k> h(JSONArray paramJSONArray)
  {
    ...
    if (paramJSONArray != null) {
      try
      {
        ...
        for (;;)
        {
          ...
          localk.ihx = ((JSONObject)localObject).optString("native_url");
          Log.d("MicroMsg.BizMenuItem", "menuItem.nativeurl : " + localk.ihx);
          localk.owo = h(((JSONObject)localObject).optJSONArray("sub_button_list"));
          localk.owp = ((JSONObject)localObject).optInt("acttype");
  ...
  public final String getInfo()
  {
    ...
    label97:
    for (this.state = STATE_START;; this.state = owm)
    {
