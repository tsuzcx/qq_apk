...
public final class a
{
  ...
  public static String bBs(String paramString)
  {
    ...
    paramString = b.aSU() + String.format("%s%d.%s", new Object[] { "wx_photo_edit_", Long.valueOf(System.currentTimeMillis()), paramString });
    AppMethodBeat.o(9345);
    return paramString;
  }
  
  public static void bBt(String paramString)
  {
    int i = 0;
    ...
    if (paramString.ifE())
    {
      ...
      if (paramString != null)
      {
        ...
        while (i < j)
        {
          ...
          if ((localObject.ifH()) && (!Util.isNullOrNil(localObject.getName())) && (localObject.getName().startsWith("wx_photo_edit_"))) {
            localObject.cFq();
          }
          i += 1;
        }
