...
{
  private static final k djm;
  private static final k djn;
  ...
  public static String B(File paramFile)
  {
    ...
    finally
    {
      try
      {
        ...
        locala = new a((byte)0);
        locala.W(paramFile);
        paramFile = locala.djq.getProperty("apkSecurityCode");
        localRandomAccessFile.close();
        System.err.println("exit getSecurityCode");
        AppMethodBeat.o(976);
        return paramFile;
  ...
  private static byte[] d(RandomAccessFile paramRandomAccessFile)
  {
    ...
    System.err.println("readComment:length bytes data = " + V(arrayOfByte));
  ...
  public static void g(File paramFile, String paramString)
  {
    ...
    //   42: aload 4
    //   44: aload_0
    //   45: invokevirtual 107	com/tencent/mm/d/c$a:W	([B)V
    //   48: aload 4
    //   50: getfield 111	com/tencent/mm/d/c$a:djq	Ljava/util/Properties;
    //   53: ldc 113
    //   55: aload_1
    //   56: invokevirtual 181	java/util/Properties:setProperty	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;
    //   59: pop
    //   60: aload 4
    //   62: invokevirtual 184	com/tencent/mm/d/c$a:IJ	()[B
    //   65: astore_0
    //   66: aload_3
    //   67: getstatic 37	com/tencent/mm/d/c:djo	I
    //   70: i2l
    ...
    //   95: getstatic 37	com/tencent/mm/d/c:djo	I
    //   98: istore_2
    //   99: aload_3
    //   100: aload_0
    //   101: arraylength
    ...
    //   172: pop
    //   173: getstatic 31	com/tencent/mm/d/c:djm	Lcom/tencent/mm/d/k;
    ...
    //   188: ifeq +6 -> 194
    //   191: goto -159 -> 32
    //   194: getstatic 35	com/tencent/mm/d/c:djn	Lcom/tencent/mm/d/k;
    ...
    //   222: astore 4
    //   224: aload 4
    //   226: getstatic 35	com/tencent/mm/d/c:djn	Lcom/tencent/mm/d/k;
  ...
  static final class a
  {
    ...
    final byte[] IJ()
    {
      ...
      if (this.djq.size() > 0)
      {
        localByteArrayOutputStream.write(c.VM().getBytes());
        localIterator = this.djq.keySet().iterator();
      }
      Object localObject2;
      for (Object localObject1 = "";; localObject1 = localObject1 + localObject2 + "=" + this.djq.getProperty((String)localObject2) + "\r\n")
      {
        if (!localIterator.hasNext())
        {
          ...
          {
            localByteArrayOutputStream.write(c.VN().getBytes());
            localByteArrayOutputStream.write(new l(this.djr.length).getBytes());
            localByteArrayOutputStream.write(this.djr);
          }
    ...
    final void W(byte[] paramArrayOfByte)
    {
      AppMethodBeat.i(971);
      ...
      int i;
      if (c.VM().equals(new k(arrayOfByte)))
      {
        ...
        arrayOfByte = new byte[i];
        localByteBuffer.get(arrayOfByte);
        this.djq.load(new ByteArrayInputStream(arrayOfByte));
        ...
        if (i > 0)
        {
          ...
          if (c.VN().equals(new k(paramArrayOfByte)))
          {
            if (i - 4 <= 2)
            {
      ...
      {
        if (c.VN().equals(new k(arrayOfByte)))
        {
          c.VN();
          if (paramArrayOfByte.length - 4 <= 2)
          {
