...
public final class l
{
  public static boolean azs()
  {
    ...
    g.afC();
    if (bt.nullAsNil((String)g.afB().afk().get(8195, null)).length() > 0)
    {
      g.afC();
  ...
  public static void b(int paramInt, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, long paramLong)
  {
    ...
    try
    {
      ...
      if (localPInt1.value != 0)
      {
        ...
        paramArrayOfByte2.dmg.dmh = localPInt1.value;
      ...
      g.afC();
      paramArrayOfByte1 = bt.aGd(bt.nullAsNil((String)g.afB().afk().get(8195, null)));
      paramArrayOfByte2 = z.a(localb.CqZ.CRx);
      g.afC();
      g.afz().cO(localb.CqZ.mBi, localb.CqZ.DQU);
      com.tencent.mm.kernel.a.mo(localb.CqZ.mBi);
      if ((bt.cw(paramArrayOfByte2)) || (!com.tencent.mm.protocal.ad.l(paramArrayOfByte1, paramArrayOfByte2)))
      {
        com.tencent.mm.sdk.platformtools.ad.e("MicroMsg.NewSyncMgr", "compareKeybuf syncKey failed");
        AppMethodBeat.o(132585);
        return;
      }
      ((com.tencent.mm.plugin.zero.b.b)g.ab(com.tencent.mm.plugin.zero.b.b.class)).azv().a(localb, paramInt, paramLong);
    }
    ...
    if (localPInt1.value != 0)
    {
      ...
      paramArrayOfByte1.dmg.dmh = localPInt1.value;
      bool1 = com.tencent.mm.sdk.b.a.ESL.l(paramArrayOfByte1);
