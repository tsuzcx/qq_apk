  ...
  extends k
{
  ...
  public static String T(String paramString, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramString = a.azH() + paramString + "_chatting_bg_vertical.jpg";
      AppMethodBeat.o(150850);
      return paramString;
    }
    paramString = a.azH() + paramString + "_chatting_bg_horizontal.jpg";
    AppMethodBeat.o(150850);
    return paramString;
  }
  ...
  public final boolean a(o paramo)
  {
    ...
    if ((int)this.hHS.a("packageinfo2", "localId", paramo) != -1)
    {
      doNotify();
      AppMethodBeat.o(150837);
      return true;
  ...
  public final boolean b(o paramo)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.hHS.update("packageinfo2", localContentValues, "id= ? and type =?", new String[] { paramo.id, paramo.dtF }) <= 0) {
        break;
      }
      doNotify();
  ...
  public final o dj(int paramInt1, int paramInt2)
  {
    ...
    Object localObject = "select packageinfo2.localId,packageinfo2.id,packageinfo2.version,packageinfo2.name,packageinfo2.size,packageinfo2.packname,packageinfo2.status,packageinfo2.type,packageinfo2.reserved1,packageinfo2.reserved2,packageinfo2.reserved3,packageinfo2.reserved4 from packageinfo2   where packageinfo2.id = \"" + bt.aQN(String.valueOf(paramInt1)) + "\" and packageinfo2.type = \"" + bt.aQN(String.valueOf(paramInt2)) + "\"";
  ...
  public final String dm(int paramInt1, int paramInt2)
  {
    ...
    case 0: 
      ...
      return "";
    case 1: 
      str = a.azH() + paramInt1 + "_session_bg/";
      try
      {
        e locale = new e(str);
        if (!locale.exists()) {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ad.e("MicroMsg.PackageInfoStorage", "exception:%s", new Object[] { bt.n(localException) });
  ...
  public final void dn(int paramInt1, int paramInt2)
  {
    ...
    i.deleteFile(a.azH() + dl(paramInt1, paramInt2));
  ...
  public final boolean pP(int paramInt)
  {
    ...
    boolean bool = this.hHS.execSQL("packageinfo2", str);
    doNotify();
  ...
  public final boolean pQ(int paramInt)
  {
    ...
    if (this.hHS.delete("packageinfo2", "type =?", new String[] { String.valueOf(paramInt) }) > 0)
    {
      doNotify();
  ...
  public final o[] pR(int paramInt)
  {
