  ...
  extends com.tencent.mm.bx.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.e(1, 8, this.hph);
      paramVarArgs.e(2, this.bFX);
    ...
    if (paramInt == 1)
    {
      paramInt = f.a.a.a.c(1, 8, this.hph);
      i = f.a.a.b.b.a.fY(2);
      AppMethodBeat.o(150798);
    ...
    if (paramInt == 3)
    {
      ...
      case 1: 
        ...
        while (paramInt < i)
        {
          ...
          localf.hph.add(localObject1);
          paramInt += 1;
        }
        AppMethodBeat.o(150798);
        return 0;
      }
      localf.bFX = Double.longBitsToDouble(((f.a.a.a.a)localObject1).KhF.fHy());
      AppMethodBeat.o(150798);
      return 0;
    }
    AppMethodBeat.o(150798);
