  ...
  extends k
{
  ...
  public final boolean a(a parama)
  {
    ...
    if ((int)this.gPa.a("chattingbginfo", "username", localContentValues) != -1)
    {
  ...
  public final boolean b(a parama)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.gPa.update("chattingbginfo", localContentValues, "username= ?", new String[] { parama.getUsername() }) <= 0) {
        break;
      }
      doNotify(parama.getUsername());
  ...
  public final a yR(String paramString)
  {
    Object localObject = null;
    AppMethodBeat.i(150789);
    paramString = "select chattingbginfo.username,chattingbginfo.bgflag,chattingbginfo.path,chattingbginfo.reserved1,chattingbginfo.reserved2,chattingbginfo.reserved3,chattingbginfo.reserved4 from chattingbginfo   where chattingbginfo.username = \"" + bt.aFQ(String.valueOf(paramString)) + "\"";
