  ...
  extends k
{
  ...
  public final a Gb(String paramString)
  {
    ...
    paramString = "select chattingbginfo.username,chattingbginfo.bgflag,chattingbginfo.path,chattingbginfo.reserved1,chattingbginfo.reserved2,chattingbginfo.reserved3,chattingbginfo.reserved4 from chattingbginfo   where chattingbginfo.username = \"" + bt.aQN(String.valueOf(paramString)) + "\"";
  ...
  public final boolean a(a parama)
  {
    ...
    if ((int)this.hHS.a("chattingbginfo", "username", localContentValues) != -1)
    {
  ...
  public final boolean b(a parama)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.hHS.update("chattingbginfo", localContentValues, "username= ?", new String[] { parama.getUsername() }) <= 0) {
        break;
      }
      doNotify(parama.getUsername());
