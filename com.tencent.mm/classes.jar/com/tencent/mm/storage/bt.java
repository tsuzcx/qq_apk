  ...
  extends k
{
  ...
  public static boolean aJi(String paramString)
  {
    ...
    {
      ad.e("MicroMsg.ServerConfigInfoStorage", "exception:%s", new Object[] { com.tencent.mm.sdk.platformtools.bt.m(paramString) });
      AppMethodBeat.o(133306);
      return false;
    }
    if (!g.afw())
    ...
    g.afC();
    g.afB().afl().aJh(paramString);
    AppMethodBeat.o(133306);
    return true;
  }
  
  /* Error */
  private static boolean aJj(String paramString)
  {
    // Byte code:
    //   0: iconst_1
    //   1: istore_1
    ...
    //   10: dup
    //   11: getstatic 91	com/tencent/mm/storage/ae:FfH	Ljava/lang/String;
    ...
    //   49: getstatic 91	com/tencent/mm/storage/ae:FfH	Ljava/lang/String;
    ...
    //   82: getstatic 91	com/tencent/mm/storage/ae:FfH	Ljava/lang/String;
    ...
    //   134: iconst_0
    //   135: aload_0
    //   136: invokestatic 51	com/tencent/mm/sdk/platformtools/bt:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   139: aastore
    ...
    //   162: iconst_0
    //   163: aload_0
    //   164: invokestatic 51	com/tencent/mm/sdk/platformtools/bt:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   167: aastore
    ...
    //   192: iconst_0
    //   193: aload_0
    //   194: invokestatic 51	com/tencent/mm/sdk/platformtools/bt:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   197: aastore
    ...
    //   230: iconst_0
    //   231: aload_2
    //   232: invokestatic 51	com/tencent/mm/sdk/platformtools/bt:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   235: aastore
  ...
  private boolean eMU()
  {
    ...
    String str = (String)this.FAM.get(77825, null);
  ...
  private int eMV()
  {
    ...
    if (!eMU())
    {
      Object localObject = ae.FfH + "deviceconfig.cfg";
      if (!i.eK((String)localObject))
      {
        AppMethodBeat.o(133301);
        return -1;
      }
      localObject = i.aR((String)localObject, 0, -1);
      if (com.tencent.mm.sdk.platformtools.bt.cw((byte[])localObject))
      {
        AppMethodBeat.o(133301);
        return -2;
      }
  ...
  public static String eMX()
  {
    ...
    str1 = com.tencent.mm.sdk.platformtools.bt.a(localLinkedHashMap);
  ...
  public final int aJh(String paramString)
  {
    ...
    this.FAM.set(77825, paramString);
    aJj(paramString);
  ...
  public final void eMT()
  {
    ...
    ad.i("MicroMsg.ServerConfigInfoStorage", "hy: read from local retcode: %d", new Object[] { Integer.valueOf(eMV()) });
