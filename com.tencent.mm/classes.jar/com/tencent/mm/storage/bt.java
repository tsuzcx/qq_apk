  ...
  extends n
{
  ...
  /* Error */
  public bt(com.tencent.mm.storagebase.h paramh)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 11
    ...
    //   12: aload_0
    //   13: aload_1
    //   14: putfield 36	com/tencent/mm/storage/bt:db	Lcom/tencent/mm/sdk/e/e;
    //   17: aload_0
    //   18: getfield 36	com/tencent/mm/storage/bt:db	Lcom/tencent/mm/sdk/e/e;
    ...
    //   170: invokestatic 96	com/tencent/mm/kernel/g:ajC	()Lcom/tencent/mm/kernel/e;
    //   173: getfield 102	com/tencent/mm/kernel/e:gBq	Lcom/tencent/mm/storagebase/h;
    //   176: invokestatic 108	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   179: invokevirtual 112	java/lang/Thread:getId	()J
    //   182: invokevirtual 118	com/tencent/mm/storagebase/h:xO	(J)J
    //   185: lstore 6
    //   187: iload_2
    //   188: ifne +24 -> 212
    //   191: ldc 120
    //   193: ldc 122
    //   195: invokestatic 127	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   198: aload_0
    //   199: getfield 36	com/tencent/mm/storage/bt:db	Lcom/tencent/mm/sdk/e/e;
    //   202: ldc 45
    //   204: ldc 129
    ...
    //   216: ldc 120
    //   218: ldc 135
    //   220: invokestatic 127	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   223: aload_0
    //   224: getfield 36	com/tencent/mm/storage/bt:db	Lcom/tencent/mm/sdk/e/e;
    //   227: ldc 45
    //   229: ldc 137
    ...
    //   242: ldc 120
    //   244: ldc 139
    //   246: invokestatic 127	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   249: aload_0
    //   250: getfield 36	com/tencent/mm/storage/bt:db	Lcom/tencent/mm/sdk/e/e;
    //   253: ldc 45
    //   255: ldc 141
    ...
    //   266: lcmp
    //   267: ifle +15 -> 282
    //   270: invokestatic 96	com/tencent/mm/kernel/g:ajC	()Lcom/tencent/mm/kernel/e;
    //   273: getfield 102	com/tencent/mm/kernel/e:gBq	Lcom/tencent/mm/storagebase/h;
    //   276: lload 6
    //   278: invokevirtual 145	com/tencent/mm/storagebase/h:sJ	(J)I
    //   281: pop
    //   282: lconst_0
    //   283: lstore 8
    //   285: aload_0
    //   286: getfield 36	com/tencent/mm/storage/bt:db	Lcom/tencent/mm/sdk/e/e;
    //   289: ldc 147
    //   291: ldc 45
    ...
    //   359: aload_0
    //   360: getfield 36	com/tencent/mm/storage/bt:db	Lcom/tencent/mm/sdk/e/e;
    //   363: ldc 45
    //   365: aconst_null
    //   366: aconst_null
    ...
    //   410: aastore
    //   411: invokestatic 183	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   414: ldc 28
    ...
    //   438: invokestatic 192	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   441: aload 10
    //   443: astore_1
    //   444: ldc 120
    ...
    //   466: invokestatic 198	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   469: aload 10
    //   471: ifnull -189 -> 282
    //   474: aload 10
    ...
    //   527: invokestatic 192	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   530: aload 10
    //   532: astore 11
    //   534: ldc 120
    ...
    //   555: invokestatic 198	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   558: iload_2
    //   559: istore_3
    //   560: lload 8
    //   562: lstore 6
  ...
  public final boolean E(String paramString1, int paramInt, String paramString2)
  {
    AppMethodBeat.i(152801);
    if (com.tencent.mm.sdk.platformtools.bt.isNullOrNil(paramString2))
    {
      ad.e("MicroMsg.MediaCheckDuplicationStorage", "insert path is null");
    ...
    if (paramInt <= 0)
    {
      l2 = (int)i.aYo(paramString2);
      l1 = l2;
      if (l2 <= 0L)
      {
        ad.e("MicroMsg.MediaCheckDuplicationStorage", "insert path insize:%d size:%d  path:%s", new Object[] { Integer.valueOf(paramInt), Long.valueOf(l2), paramString2 });
        AppMethodBeat.o(152801);
        return false;
      }
    }
    ...
    {
      paramString1 = i.aPK(paramString2);
      str = paramString1;
      if (com.tencent.mm.sdk.platformtools.bt.isNullOrNil(paramString1))
      {
        ad.e("MicroMsg.MediaCheckDuplicationStorage", "insert path read md5 failed  path:%s", new Object[] { paramString2 });
        AppMethodBeat.o(152801);
        return false;
      }
    }
    ...
    paramString1.put("createtime", Long.valueOf(com.tencent.mm.sdk.platformtools.bt.flT()));
    paramString1.put("status", Integer.valueOf(101));
    long l2 = this.db.insert("MediaDuplication", "", paramString1);
    ad.i("MicroMsg.MediaCheckDuplicationStorage", "insert Ret:%d size:%d md5:%s path:%s", new Object[] { Long.valueOf(l2), Long.valueOf(l1), str, paramString2 });
    if (l2 > 0L)
    {
      AppMethodBeat.o(152801);
      return true;
  ...
  public final boolean a(String paramString, PString paramPString, PInt paramPInt)
  {
    ...
    {
      ad.d("MicroMsg.MediaCheckDuplicationStorage", "check video remuxing, but import path is null.");
      AppMethodBeat.o(152804);
      return false;
    }
    int i = (int)i.aYo(paramString);
    if (i <= 0)
    {
      ad.w("MicroMsg.MediaCheckDuplicationStorage", "check video remuxing, but file size is zero. path : ".concat(String.valueOf(paramString)));
      AppMethodBeat.o(152804);
      return false;
    }
    String str = i.aPK(paramString);
    if (com.tencent.mm.sdk.platformtools.bt.isNullOrNil(str))
    {
      ad.w("MicroMsg.MediaCheckDuplicationStorage", "check video remuxing, but md5 is null. path : ".concat(String.valueOf(paramString)));
      AppMethodBeat.o(152804);
      return false;
    }
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        ad.printErrStackTrace("MicroMsg.MediaCheckDuplicationStorage", localException, "", new Object[0]);
        localObject1 = paramString;
        ad.e("MicroMsg.MediaCheckDuplicationStorage", "check video remuxing error: " + localException.toString());
        if (paramString != null) {
          paramString.close();
        }
      }
    ...
    if (com.tencent.mm.sdk.platformtools.bt.isNullOrNil(paramPString.value))
    {
      ad.d("MicroMsg.MediaCheckDuplicationStorage", "it has no remuxing path.");
      AppMethodBeat.o(152804);
      return false;
    }
    label334:
    if ((int)i.aYo(paramPString.value) <= 0)
    {
      ad.w("MicroMsg.MediaCheckDuplicationStorage", "remuxing file size is zero, delete db record now. remuxing path : " + paramPString.value);
      this.db.delete("MediaDuplication", "md5=? AND size=? AND status=?", new String[] { str, String.valueOf(i), "100" });
      paramPString.value = null;
      AppMethodBeat.o(152804);
      return false;
    }
    ad.i("MicroMsg.MediaCheckDuplicationStorage", "check remuxing file success. remuxing path[%s], duration [%d], cost time[%d]", new Object[] { paramPString.value, Integer.valueOf(paramPInt.value), Long.valueOf(com.tencent.mm.sdk.platformtools.bt.aO(l)) });
    AppMethodBeat.o(152804);
    return true;
  }
  ...
  public final boolean al(String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      ad.w("MicroMsg.MediaCheckDuplicationStorage", "insert video remuxing info, but path is null. [%s, %s] ", new Object[] { paramString1, paramString2 });
      AppMethodBeat.o(152803);
      return false;
    }
    int i = (int)i.aYo(paramString1);
    int j = (int)i.aYo(paramString2);
    if ((i <= 0) || (j <= 0))
    {
      ad.w("MicroMsg.MediaCheckDuplicationStorage", "insert video remuxing info, but file size is zero.[%d, %d]", new Object[] { Integer.valueOf(i), Integer.valueOf(j) });
      AppMethodBeat.o(152803);
      return false;
    }
    String str = i.aPK(paramString1);
    if (com.tencent.mm.sdk.platformtools.bt.isNullOrNil(str))
    {
      ad.w("MicroMsg.MediaCheckDuplicationStorage", "import file is not null, but md5 is null, path " + paramString1 + " size : " + i);
      AppMethodBeat.o(152803);
      return false;
    }
    long l1 = com.tencent.mm.sdk.platformtools.bt.HI();
    ContentValues localContentValues = new ContentValues();
    localContentValues.put("md5", str);
    localContentValues.put("size", Integer.valueOf(i));
    localContentValues.put("createtime", Long.valueOf(com.tencent.mm.sdk.platformtools.bt.flT()));
    ...
    ad.i("MicroMsg.MediaCheckDuplicationStorage", "insert video remuxing ret[%d], size[%d], md5[%s], remuxingPath[%s], importPath[%s], duration[%d], cost time[%d]", new Object[] { Long.valueOf(l2), Integer.valueOf(i), str, paramString2, paramString1, Integer.valueOf(paramInt), Long.valueOf(com.tencent.mm.sdk.platformtools.bt.aO(l1)) });
    if (l2 > 0L)
    {
      AppMethodBeat.o(152803);
      return true;
  ...
  public final String gq(String paramString, int paramInt)
  {
    ...
    if ((com.tencent.mm.sdk.platformtools.bt.isNullOrNil(paramString)) || (paramInt <= 0))
    {
      ad.e("MicroMsg.MediaCheckDuplicationStorage", "check  md5:%s size:%d", new Object[] { paramString, Integer.valueOf(paramInt) });
    ...
    if (localObject == null)
    {
      ad.e("MicroMsg.MediaCheckDuplicationStorage", "check query return null sql:%s", new Object[] { str });
      AppMethodBeat.o(152802);
      return null;
    }
    str = "";
    ...
    if (!com.tencent.mm.sdk.platformtools.bt.isNullOrNil(str))
    {
      ...
      if (i <= 0)
      {
        ad.w("MicroMsg.MediaCheckDuplicationStorage", "check file size is zero, delete db record now. path[%s], fileSize[%d], size[%d]", new Object[] { str, Integer.valueOf(i), Integer.valueOf(paramInt) });
