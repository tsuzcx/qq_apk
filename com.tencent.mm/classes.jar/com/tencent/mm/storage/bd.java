  ...
  extends j<com.tencent.mm.api.h>
{
  ...
  static
  {
    ...
    gPa = (com.tencent.mm.storagebase.h)localObject;
    AppMethodBeat.o(114155);
  }
  
  private bd()
  {
    super((com.tencent.mm.sdk.e.e)locale.afg(), com.tencent.mm.api.h.info, "FunctionMsgItem", new String[] { "CREATE INDEX IF NOT EXISTS functionIdIndex ON FunctionMsgItem(functionmsgid)" });
  ...
  public static void a(String paramString, com.tencent.mm.api.h paramh)
  {
    ...
    ad.i("FunctionMsg.FunctionMsgStorage", "updateByFunctionMsgId, functionMsgId: %s", new Object[] { paramString });
    Object localObject = aIK(paramString);
    if (localObject != null) {
      try
      {
        boolean bool1;
        ...
        {
          bool1 = true;
          if (((com.tencent.mm.api.h)localObject).JN() != null) {
            break label186;
          }
        }
        label186:
        ...
        {
          ad.i("FunctionMsg.FunctionMsgStorage", "updateByFunctionMsgId, functionMsgId: %s, newFunctionMsgItem.msgContent==null: %s,oldFunctionMsgItem.msgContent==null: %s", new Object[] { paramString, Boolean.valueOf(bool1), Boolean.valueOf(bool2) });
          paramh = paramh.convertTo();
          if ((paramh.get("addMsg") == null) && (((com.tencent.mm.api.h)localObject).JN() != null))
          {
            localObject = ((com.tencent.mm.api.h)localObject).JN();
            if (localObject == null) {
              k.fvU();
            }
            paramh.put("addMsg", ((cs)localObject).toByteArray());
          }
          ad.i("FunctionMsg.FunctionMsgStorage", "updateByFunctionMsgId, ret: %s", new Object[] { Integer.valueOf(gPa.update("FunctionMsgItem", paramh, "functionmsgid=?", new String[] { paramString })) });
      ...
      {
        ad.e("FunctionMsg.FunctionMsgStorage", "updateByFunctionMsgId error: %s", new Object[] { paramString.getMessage() });
      }
    }
  }
  
  /* Error */
  public static com.tencent.mm.api.h aIK(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    ...
    //   13: aload_0
    //   14: invokestatic 195	com/tencent/mm/sdk/platformtools/bt:isNullOrNil	(Ljava/lang/String;)Z
    //   17: ifeq +10 -> 27
    //   20: ldc 189
    ...
    //   37: aload_0
    //   38: aastore
    //   39: invokestatic 124	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   42: getstatic 83	com/tencent/mm/storage/bd:gPa	Lcom/tencent/mm/storagebase/h;
    //   45: ldc 97
    //   47: getstatic 58	com/tencent/mm/storage/bd:FzK	[Ljava/lang/String;
    //   50: ldc 166
    //   52: iconst_1
    ...
    //   73: aload_0
    //   74: ifnonnull +6 -> 80
    //   77: invokestatic 81	d/g/b/k:fvU	()V
    //   80: aload_0
    ...
    //   112: aload_3
    //   113: areturn
    //   114: getstatic 224	d/y:JfV	Ld/y;
    //   117: astore_0
    //   118: aload_2
    //   119: aconst_null
  ...
  /* Error */
  public static java.util.List<com.tencent.mm.api.h> eLN()
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    //   2: ldc 227
    //   4: invokestatic 45	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   7: getstatic 83	com/tencent/mm/storage/bd:gPa	Lcom/tencent/mm/storagebase/h;
    //   10: ldc 97
    //   12: getstatic 58	com/tencent/mm/storage/bd:FzK	[Ljava/lang/String;
    //   15: ldc 229
    //   17: iconst_1
  ...
  public static void eLO()
  {
    ...
    int i = gPa.delete("FunctionMsgItem", "status=?", new String[] { "100" });
    int j = gPa.delete("FunctionMsgItem", "status=?", new String[] { "3" });
    ad.i("FunctionMsg.FunctionMsgStorage", "[deleteAllHandleFunctionMsg] ret1:" + i + " ret2:" + j);
