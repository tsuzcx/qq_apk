  ...
  extends MStorageEx
{
  ...
  private a<Integer> NRU;
  private a<String> NRV;
  ...
  public ao(h paramh)
  {
    ...
    this.NRU = new a("userinfo", "id");
    this.NRV = new a("userinfo2", "sid");
    ...
    this.NRZ = new Runnable()
    {
      ...
      public final void run()
      {
        ...
        //   16: aload_0
        //   17: getfield 14	com/tencent/mm/storage/ao$1:NSa	Lcom/tencent/mm/storage/ao;
        //   20: invokestatic 32	com/tencent/mm/storage/ao:a	(Lcom/tencent/mm/storage/ao;)Lcom/tencent/mm/storagebase/h;
        //   23: ifnull +722 -> 745
        //   26: aload_0
        //   27: getfield 14	com/tencent/mm/storage/ao$1:NSa	Lcom/tencent/mm/storage/ao;
        //   30: invokestatic 32	com/tencent/mm/storage/ao:a	(Lcom/tencent/mm/storage/ao;)Lcom/tencent/mm/storagebase/h;
        //   33: invokevirtual 38	com/tencent/mm/storagebase/h:gFH	()Lcom/tencent/wcdb/database/SQLiteDatabase;
        //   36: astore 8
        //   38: aload 8
        //   40: ifnull +11 -> 51
        //   43: aload 8
        ...
        //   103: istore_3
        //   104: aload_0
        //   105: getfield 14	com/tencent/mm/storage/ao$1:NSa	Lcom/tencent/mm/storage/ao;
        //   108: astore 11
        //   110: iload 5
        //   112: istore_2
        //   113: iload 6
        ...
        //   118: monitorenter
        //   119: aload_0
        //   120: getfield 14	com/tencent/mm/storage/ao$1:NSa	Lcom/tencent/mm/storage/ao;
        //   123: invokestatic 67	com/tencent/mm/storage/ao:b	(Lcom/tencent/mm/storage/ao;)Ljava/util/HashMap;
        //   126: astore 12
        //   128: aload_0
        //   129: getfield 14	com/tencent/mm/storage/ao$1:NSa	Lcom/tencent/mm/storage/ao;
        //   132: invokestatic 70	com/tencent/mm/storage/ao:c	(Lcom/tencent/mm/storage/ao;)Ljava/util/HashMap;
        //   135: astore 10
        //   137: aload_0
        //   138: getfield 14	com/tencent/mm/storage/ao$1:NSa	Lcom/tencent/mm/storage/ao;
        ...
        //   151: pop
        //   152: aload_0
        //   153: getfield 14	com/tencent/mm/storage/ao$1:NSa	Lcom/tencent/mm/storage/ao;
        ...
        //   166: pop
        //   167: aload_0
        //   168: getfield 14	com/tencent/mm/storage/ao$1:NSa	Lcom/tencent/mm/storage/ao;
        ...
        //   325: invokestatic 123	com/tencent/mm/sdk/platformtools/Log:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
        //   328: iload_2
        //   329: ifeq +16 -> 345
        //   332: aload 8
        ...
        //   373: invokestatic 154	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
        //   376: ldc 22
        ...
        //   403: iconst_1
        //   404: aload 13
        //   406: getfield 158	com/tencent/mm/storage/ao$b:type	I
        ...
        //   419: iconst_2
        //   420: aload 13
        //   422: getfield 168	com/tencent/mm/storage/ao$b:iFF	Ljava/lang/String;
        //   425: aastore
        //   426: iload_1
        //   427: istore_2
        //   428: iload_1
        ...
        //   494: invokestatic 154	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
        //   497: ldc 22
        ...
        //   562: checkcast 108	com/tencent/mm/storage/ao$b
        //   565: astore 12
        //   567: aload 12
        ...
        //   624: iconst_1
        //   625: aload 12
        //   627: getfield 158	com/tencent/mm/storage/ao$b:type	I
        ...
        //   640: iconst_2
        //   641: aload 12
        //   643: getfield 168	com/tencent/mm/storage/ao$b:iFF	Ljava/lang/String;
        //   646: aastore
        //   647: iload_1
        //   648: istore_2
        //   649: iload_1
        ...
        //   713: invokestatic 154	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
        //   716: ldc 22
  ...
  private Object get(String paramString, Object paramObject)
  {
    ...
    paramString = this.NRV.get(paramString);
  ...
  public final long akg(int paramInt)
  {
  ...
  public final Object get(int paramInt, Object paramObject)
  {
    ...
    Assert.assertNotNull("db is null", this.iFy);
    Object localObject = this.NRU.get(Integer.valueOf(paramInt));
    if ((localObject == null) || (localObject == NRT))
    {
  ...
  public final Object i(ar.a parama)
  {
  ...
  public final void set(int paramInt, Object paramObject)
  {
    ...
    if (!localObject1.equals(this.NRU.put(Integer.valueOf(paramInt), localObject1)))
    {
      if (localObject1 != NRT) {
        break label177;
      }
    ...
    for (;;)
    {
      try
      {
        this.NRW.put(Integer.valueOf(paramInt), paramObject);
        if (!this.NRY)
        {
          this.NRY = true;
      ...
      localObject2 = b.ec(localObject1);
  ...
  public final void set(ar.a parama, Object paramObject)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (!parama.equals(this.NRV.put(localObject2, parama)))
      {
        if (parama != NRT) {
          break label245;
        }
    ...
    extends LruCache<K, Object>
  {
    ...
    public final Object create(K paramK)
    {
      ...
      //   5: aload_0
      //   6: getfield 16	com/tencent/mm/storage/ao$a:NSa	Lcom/tencent/mm/storage/ao;
      //   9: invokestatic 60	com/tencent/mm/storage/ao:a	(Lcom/tencent/mm/storage/ao;)Lcom/tencent/mm/storagebase/h;
      //   12: aload_0
      //   13: getfield 46	com/tencent/mm/storage/ao$a:NSb	Ljava/lang/String;
      //   16: iconst_1
      ...
      //   90: aload_2
      //   91: getfield 99	com/tencent/mm/storage/ao$b:iFF	Ljava/lang/String;
      ...
      //   103: aload_2
      //   104: invokevirtual 108	com/tencent/mm/storage/ao$b:bmp	()Ljava/lang/Object;
      //   107: astore_2
      //   108: aload 4
      //   110: ifnull +10 -> 120
      //   113: aload 4
      ...
      //   156: invokestatic 117	com/tencent/mm/storage/ao:fKQ	()Ljava/lang/Object;
      //   159: astore_2
      //   160: aload 4
      //   162: ifnull +10 -> 172
      //   165: aload 4
  ...
  static final class b
  {
    ...
    static b ec(Object paramObject)
    {
