  ...
  implements g.a
{
  ...
  private HashMap<String, int[]> GWK;
  public HashMap<Integer, ArrayList<String>> GWL;
  private e db;
  
  static
  {
    AppMethodBeat.i(32877);
    SQL_CREATE = new String[] { j.getCreateSQLs(ak.info, "ContactLabel") };
    AppMethodBeat.o(32877);
  }
  
  public an(e parame)
  {
    this(parame, ak.info, "ContactLabel");
  }
  
  private an(e parame, c.a parama, String paramString)
  {
  ...
  private static String B(String paramString, List<ak> paramList)
  {
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (i < j)
      {
        paramString = (ak)paramList.get(i);
        if (paramString != null)
        {
      ...
      ac.i("MicroMsg.Label.ContactLabelStorage", "cpan[genNotifyString] event:%s", new Object[] { localStringBuilder.toString() });
  ...
  private static String a(String paramString, ak paramak)
  {
    ...
    if (paramak != null)
    {
      ...
      paramString = B(paramString, localArrayList);
  ...
  private boolean a(boolean paramBoolean, ak paramak)
  {
    AppMethodBeat.i(32855);
    boolean bool = super.insert(paramak);
    if ((bool) && (paramBoolean)) {
      doNotify(a("insert", paramak));
    }
    AppMethodBeat.o(32855);
    return bool;
  }
  
  private boolean a(boolean paramBoolean, ak paramak, String... paramVarArgs)
  {
    AppMethodBeat.i(32857);
    boolean bool = super.delete(paramak, paramVarArgs);
    if ((bool) && (paramBoolean))
    {
      doNotify(a("delete", paramak));
      fao();
    }
    alK();
  ...
  private a b(ak paramak)
  {
    AppMethodBeat.i(32866);
    localObject2 = null;
    localObject1 = null;
    Object localObject3 = paramak.field_labelID;
    try
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (((Cursor)localObject3).moveToFirst())
        {
          localObject1 = localObject3;
          localObject2 = localObject3;
          String str = bs.bG(((Cursor)localObject3).getString(((Cursor)localObject3).getColumnIndex("labelName")), "");
          localObject1 = localObject3;
          localObject2 = localObject3;
          if (paramak.field_labelName.equalsIgnoreCase(str))
          {
            localObject1 = localObject3;
            localObject2 = localObject3;
            paramak = a.GWN;
    ...
    catch (Exception paramak)
    {
      for (;;)
      {
        ...
        ac.w("MicroMsg.Label.ContactLabelStorage", "cpan[checkEqualsName] exception %s", new Object[] { paramak.toString() });
  ...
  private String c(ak paramak)
  {
    ...
    //   12: aload_1
    //   13: getfield 195	com/tencent/mm/storage/ak:field_labelName	Ljava/lang/String;
    ...
    //   22: astore_3
    //   23: aload_0
    //   24: getfield 65	com/tencent/mm/storage/an:db	Lcom/tencent/mm/sdk/e/e;
    //   27: ldc 223
    //   29: iconst_2
    ...
    //   87: ldc 185
    //   89: invokestatic 191	com/tencent/mm/sdk/platformtools/bs:bG	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   92: astore 5
    //   94: aload 4
    //   96: astore_3
    //   97: aload_1
    //   98: getfield 195	com/tencent/mm/storage/ak:field_labelName	Ljava/lang/String;
    //   101: aload 5
    ...
    //   127: aload_1
    //   128: getfield 195	com/tencent/mm/storage/ak:field_labelName	Ljava/lang/String;
    ...
    //   145: aastore
    //   146: invokestatic 118	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   149: iload_2
    //   150: ifeq +42 -> 192
    //   153: aload 4
    //   155: astore_3
    ...
    //   232: aastore
    //   233: invokestatic 218	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   236: aload 4
    //   238: ifnull -34 -> 204
    //   241: aload 4
  ...
  private static void fao()
  {
    ...
    ac.i("MicroMsg.Label.ContactLabelStorage", "cpan[publishUpdateSearchIndexEvent]");
    wt localwt = new wt();
    localwt.dzD.fe = 3000L;
    a.GpY.l(localwt);
    AppMethodBeat.o(32870);
  }
  
  /* Error */
  public final ArrayList<String> A(String paramString, List<String> paramList)
  {
    // Byte code:
    //   0: ldc_w 267
    ...
    //   17: ldc_w 271
    //   20: aastore
    //   21: invokestatic 274	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    //   97: astore_1
    //   98: aload_0
    //   99: getfield 65	com/tencent/mm/storage/an:db	Lcom/tencent/mm/sdk/e/e;
    //   102: ldc_w 271
    //   105: iconst_3
    ...
    //   303: aastore
    //   304: invokestatic 218	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   307: aload 5
    //   309: ifnull -36 -> 273
    //   312: aload 5
  ...
  public final ArrayList<String> U(String[] paramArrayOfString)
  {
    ...
    //   140: aload_1
    //   141: aastore
    //   142: invokestatic 274	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   145: aload_0
    //   146: getfield 65	com/tencent/mm/storage/an:db	Lcom/tencent/mm/sdk/e/e;
    //   149: aload_1
    //   150: aconst_null
    //   151: iconst_2
    ...
    //   249: aastore
    //   250: invokestatic 274	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   253: aload 4
    //   255: ifnull +10 -> 265
    //   258: aload 4
    ...
    //   318: aastore
    //   319: invokestatic 218	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   322: aload 4
    //   324: ifnull -38 -> 286
    //   327: aload 4
  ...
  public final boolean a(ak paramak, String... paramVarArgs)
  {
    ...
    boolean bool = a(true, paramak, paramVarArgs);
    AppMethodBeat.o(32858);
    return bool;
  }
  
  public final ArrayList<String> aNi(String paramString)
  {
    int i = -1;
    AppMethodBeat.i(32851);
    long l = bs.eWj();
    int j = bs.getInt(paramString, -1);
    if (j == -1)
    {
      ac.e("MicroMsg.Label.ContactLabelStorage", "getUserNameListById  failed id:%s", new Object[] { paramString });
      AppMethodBeat.o(32851);
      return null;
    }
    fan();
    ArrayList localArrayList = (ArrayList)this.GWL.get(Integer.valueOf(j));
    l = bs.Ap(l);
    if (localArrayList == null) {}
    for (;;)
    {
      ac.i("MicroMsg.Label.ContactLabelStorage", "getUserNameListById time:%s id:%s count:%s stack:%s", new Object[] { Long.valueOf(l), paramString, Integer.valueOf(i), bs.eWi() });
      AppMethodBeat.o(32851);
  ...
  /* Error */
  public final ak aNj(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   8: aload_0
    //   9: getfield 65	com/tencent/mm/storage/an:db	Lcom/tencent/mm/sdk/e/e;
    //   12: ldc 40
    //   14: bipush 6
    ...
    //   91: aload_2
    //   92: astore_1
    //   93: new 34	com/tencent/mm/storage/ak
    //   96: dup
    //   97: invokespecial 376	com/tencent/mm/storage/ak:<init>	()V
    //   100: astore_3
    //   101: aload_2
    //   102: astore_1
    //   103: aload_3
    //   104: aload_2
    //   105: invokevirtual 380	com/tencent/mm/storage/ak:convertFrom	(Landroid/database/Cursor;)V
    //   108: aload_2
    //   109: ifnull +9 -> 118
    //   112: aload_2
    ...
    //   164: aastore
    //   165: invokestatic 218	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   168: aload_2
    //   169: ifnull -33 -> 136
    //   172: aload_2
  ...
  /* Error */
  public final ak aNk(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
  ...
  /* Error */
  public final ArrayList<String> aS(ArrayList<String> paramArrayList)
  {
    // Byte code:
    //   0: ldc_w 391
    //   3: invokestatic 30	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    //   76: aload_1
    //   77: iload_2
    //   78: invokevirtual 396	java/util/ArrayList:get	(I)Ljava/lang/Object;
    ...
    //   158: aload_1
    //   159: aastore
    //   160: invokestatic 274	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   163: aload_0
    //   164: getfield 65	com/tencent/mm/storage/an:db	Lcom/tencent/mm/sdk/e/e;
    //   167: aload_1
    //   168: aconst_null
    //   169: iconst_2
    ...
    //   267: aastore
    //   268: invokestatic 274	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   271: aload 4
    //   273: ifnull +10 -> 283
    //   276: aload 4
    ...
    //   336: aastore
    //   337: invokestatic 218	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   340: aload 4
    //   342: ifnull -38 -> 304
    //   345: aload 4
  ...
  public final String ajA(String paramString)
  {
    ...
    //   3: invokestatic 30	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: aload_0
    //   7: getfield 65	com/tencent/mm/storage/an:db	Lcom/tencent/mm/sdk/e/e;
    //   10: ldc 40
    //   12: iconst_1
    ...
    //   91: aastore
    //   92: invokestatic 118	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   95: aload_2
    //   96: ifnull +9 -> 105
    //   99: aload_2
    ...
    //   151: aastore
    //   152: invokestatic 218	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   155: aload_2
    //   156: ifnull -33 -> 123
    //   159: aload_2
  ...
  public final void alK()
  {
    ...
    ac.v("MicroMsg.Label.ContactLabelStorage", "cleanCache %s", new Object[] { bs.eWi() });
    this.GWK = null;
    this.GWL = null;
    AppMethodBeat.o(32849);
  }
  
  public final boolean b(boolean paramBoolean, ak paramak, String... paramVarArgs)
  {
    AppMethodBeat.i(32859);
    boolean bool = super.update(paramak, paramVarArgs);
    if ((bool) && (paramBoolean)) {
      doNotify(a("update", paramak));
    }
    alK();
  ...
  public final ArrayList<String> fal()
  {
    ...
    localCursor.close();
    ac.i("MicroMsg.Label.ContactLabelStorage", "getAllLabel time:%s count:%s stack:%s", new Object[] { Long.valueOf(bs.Ap(l)), Integer.valueOf(localArrayList.size()), bs.eWi() });
    AppMethodBeat.o(32847);
    return localArrayList;
  }
  
  public final ArrayList<ak> fam()
  {
    ...
    localCursor.close();
    ac.i("MicroMsg.Label.ContactLabelStorage", "getAllContactLable time:%s count:%s stack:%s", new Object[] { Long.valueOf(bs.Ap(l)), Integer.valueOf(localArrayList.size()), bs.eWi() });
    AppMethodBeat.o(32848);
    return localArrayList;
  }
  ...
  public final void fan()
  {
    ...
    if ((this.GWK != null) && (this.GWL != null))
    {
    ...
    long l = bs.eWj();
    Object localObject1 = "select username , contactLabelIds from rcontact where (type & " + b.aay() + " !=0 ) and ( contactLabelIds != '') ;";
    localObject1 = this.db.a((String)localObject1, null, 2);
    Object localObject2;
    Object localObject3;
    if (localObject1 == null)
    {
      this.GWK = localHashMap1;
      this.GWL = localHashMap2;
      AppMethodBeat.o(32850);
      return;
    ...
    while (((Cursor)localObject1).moveToNext())
    {
      ...
      {
        String[] arrayOfString = bs.nullAsNil(((Cursor)localObject1).getString(1)).split(",");
        if ((arrayOfString != null) && (arrayOfString.length > 0))
        {
          ...
          {
            localObject3[i] = bs.getInt(arrayOfString[i], -1);
    ...
    ac.i("MicroMsg.Label.ContactLabelStorage", "checkRebuildCache time:%s user:%s label:%s stack:%s", new Object[] { Long.valueOf(bs.Ap(l)), Integer.valueOf(localHashMap1.size()), Integer.valueOf(localHashMap2.size()), bs.eWi() });
    this.GWK = localHashMap1;
    this.GWL = localHashMap2;
    AppMethodBeat.o(32850);
  }
  
  public final boolean hf(List<ak> paramList)
  {
    AppMethodBeat.i(32860);
    if (paramList.size() <= 0)
    {
      ac.i("MicroMsg.Label.ContactLabelStorage", "cpan[insertAddLabel] list is null.");
    ...
    if ((this.db instanceof h))
    {
      ...
      ac.i("MicroMsg.Label.ContactLabelStorage", "begin insertOrUpdateList in a transaction, ticket = %d", new Object[] { Long.valueOf(l) });
    }
    for (;;)
    {
      int j = paramList.size();
      ...
      while (i < j)
      {
        String str = c((ak)paramList.get(i));
      ...
      {
        localh.qL(l);
        ac.i("MicroMsg.Label.ContactLabelStorage", "end deleteLocalLabel transaction");
      }
      alK();
      AppMethodBeat.o(32860);
      return false;
  ...
  public final boolean hg(List<ak> paramList)
  {
    AppMethodBeat.i(32861);
    if (paramList.size() <= 0)
    {
      ac.i("MicroMsg.Label.ContactLabelStorage", "cpan[insertOrUpdateList] list is null.");
    ...
    for (;;)
    {
      ...
      if (i < j)
      {
        ak localak = (ak)paramList.get(i);
        if (localak != null)
        {
          a locala = b(localak);
          switch (1.GWM[locala.ordinal()])
          {
          default: 
            ac.w("MicroMsg.Label.ContactLabelStorage", "cpan[insertOrUpdateList] unknow result.");
          }
        }
        for (;;)
        {
          i += 1;
          break;
          b(false, localak, new String[] { "labelID" });
          localArrayList2.add(localak);
          continue;
          localak.field_createTime = System.currentTimeMillis();
          a(false, localak);
          localArrayList1.add(localak);
        }
      }
      if (localh != null)
      {
        localh.qL(l);
        ac.i("MicroMsg.Label.ContactLabelStorage", "end insertOrUpdateList transaction");
      }
      if (localArrayList1.size() > 0) {
        doNotify(B("insert", localArrayList1));
      }
      if (localArrayList2.size() > 0) {
        doNotify(B("update", localArrayList2));
      }
      alK();
      AppMethodBeat.o(32861);
      return false;
  ...
  public final boolean hh(List<ak> paramList)
  {
    AppMethodBeat.i(32871);
    if ((paramList == null) || (paramList.size() <= 0))
    {
      ac.w("MicroMsg.Label.ContactLabelStorage", "cpan[deleteList] list is null.");
    ...
    if ((this.db instanceof h))
    {
      localh = (h)this.db;
      l = localh.vE(Thread.currentThread().getId());
      ac.i("MicroMsg.Label.ContactLabelStorage", "begin deleteList in a transaction, ticket = %d", new Object[] { Long.valueOf(l) });
    }
    for (;;)
    {
      int j = paramList.size();
      ...
      while (i < j)
      {
        a(false, (ak)paramList.get(i), new String[] { "labelID" });
        i += 1;
      }
      if (localh != null)
      {
  ...
  /* Error */
  public final ArrayList<ak> hi(List<ak> paramList)
  {
    // Byte code:
    //   0: ldc_w 549
    //   3: invokestatic 30	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    //   83: checkcast 34	com/tencent/mm/storage/ak
    //   86: getfield 100	com/tencent/mm/storage/ak:field_labelID	I
    ...
    //   163: aload_1
    //   164: aastore
    //   165: invokestatic 274	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   168: aload_0
    //   169: getfield 65	com/tencent/mm/storage/an:db	Lcom/tencent/mm/sdk/e/e;
    //   172: aload_1
    //   173: aconst_null
    //   174: iconst_2
    ...
    //   207: aload 4
    //   209: astore_1
    //   210: new 34	com/tencent/mm/storage/ak
    //   213: dup
    //   214: invokespecial 376	com/tencent/mm/storage/ak:<init>	()V
    //   217: astore 6
    //   219: aload 4
    //   221: astore_1
    //   222: aload 6
    //   224: aload 4
    //   226: invokevirtual 380	com/tencent/mm/storage/ak:convertFrom	(Landroid/database/Cursor;)V
    //   229: aload 4
    //   231: astore_1
    //   232: aload 5
    //   234: aload 6
    ...
    //   275: aastore
    //   276: invokestatic 274	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   279: aload 4
    //   281: ifnull +10 -> 291
    //   284: aload 4
    ...
    //   344: aastore
    //   345: invokestatic 218	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   348: aload 4
    //   350: ifnull -38 -> 312
    //   353: aload 4
  ...
  public final boolean zB(String paramString)
  {
    ...
    ac.i("MicroMsg.Label.ContactLabelStorage", "cpan[delete] labelID:%s", new Object[] { String.valueOf(paramString) });
    ac.d("MicroMsg.Label.ContactLabelStorage", "cpan[query] SQL:%s", new Object[] { "labelID =? " });
    try
    {
    ...
    catch (Exception paramString)
    {
      for (;;)
      {
        ac.w("MicroMsg.Label.ContactLabelStorage", "cpan[delete] exception %s", new Object[] { paramString.toString() });
        int i = -1;
      }
      AppMethodBeat.o(32856);
    }
  ...
  public static enum a
  {
    static
    {
      ...
      GWN = new a("EQUAL", 0);
      GWO = new a("NOEQUAL", 1);
      GWP = new a("NOEXISTS", 2);
      GWQ = new a[] { GWN, GWO, GWP };
