  ...
  extends MAutoStorage<au>
{
  ...
  private HashMap<String, int[]> VEs;
  public HashMap<Integer, ArrayList<String>> VEt;
  ...
  public ax(ISQLiteDatabase paramISQLiteDatabase, IAutoDBItem.MAutoDBInfo paramMAutoDBInfo, String paramString, String[] paramArrayOfString)
  {
  ...
  private static String J(String paramString, List<au> paramList)
  {
  ...
  private static String a(String paramString, au paramau)
  {
    ...
    if (paramau != null)
    {
      ...
      paramString = J(paramString, localArrayList);
  ...
  private String c(au paramau)
  {
    ...
    //   5: new 74	java/lang/StringBuilder
    //   8: dup
    //   9: invokespecial 76	java/lang/StringBuilder:<init>	()V
    //   12: aload_1
    //   13: getfield 192	com/tencent/mm/storage/au:field_labelName	Ljava/lang/String;
    ...
    //   22: astore_3
    //   23: aload_0
    //   24: getfield 61	com/tencent/mm/storage/ax:db	Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;
    //   27: ldc 220
    //   29: iconst_2
    ...
    //   82: invokeinterface 180 2 0
    //   87: ldc 182
    //   89: invokestatic 188	com/tencent/mm/sdk/platformtools/Util:nullAs	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   92: astore 5
    //   94: aload 4
    //   96: astore_3
    //   97: aload_1
    //   98: getfield 192	com/tencent/mm/storage/au:field_labelName	Ljava/lang/String;
    //   101: aload 5
    //   103: invokevirtual 196	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   106: istore_2
    //   107: aload 4
    //   109: astore_3
    //   110: ldc 101
    //   112: ldc 224
    //   114: iconst_2
    //   115: anewarray 105	java/lang/Object
    //   118: dup
    //   119: iconst_0
    //   120: new 74	java/lang/StringBuilder
    //   123: dup
    //   124: invokespecial 76	java/lang/StringBuilder:<init>	()V
    //   127: aload_1
    //   128: getfield 192	com/tencent/mm/storage/au:field_labelName	Ljava/lang/String;
    ...
    //   139: iconst_1
    //   140: aload 5
    //   142: invokestatic 228	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   145: aastore
    //   146: invokestatic 114	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   149: iload_2
    //   150: ifeq +42 -> 192
    //   153: aload 4
    //   155: astore_3
    ...
    //   220: ldc 211
    //   222: iconst_1
    //   223: anewarray 105	java/lang/Object
    //   226: dup
    //   227: iconst_0
    //   228: aload_1
    //   229: invokevirtual 212	java/lang/Exception:toString	()Ljava/lang/String;
    //   232: aastore
    //   233: invokestatic 215	com/tencent/mm/sdk/platformtools/Log:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   236: aload 4
    //   238: ifnull -34 -> 204
    //   241: aload 4
  ...
  private static void hyj()
  {
    AppMethodBeat.i(32870);
    Log.i("MicroMsg.Label.ContactLabelStorage", "cpan[publishUpdateSearchIndexEvent]");
    zy localzy = new zy();
    localzy.fZl.delay = 3000L;
    EventCenter.instance.publish(localzy);
    AppMethodBeat.o(32870);
  }
  
  /* Error */
  public final ArrayList<String> I(String paramString, List<String> paramList)
  {
    // Byte code:
    //   0: ldc_w 262
    ...
    //   8: ldc_w 264
    //   11: iconst_1
    //   12: anewarray 105	java/lang/Object
    //   15: dup
    //   16: iconst_0
    //   17: ldc_w 266
    //   20: aastore
    //   21: invokestatic 269	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   24: new 74	java/lang/StringBuilder
    //   27: dup
    //   28: ldc_w 271
    //   31: invokespecial 273	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   34: aload_1
    ...
    //   44: invokevirtual 109	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   47: astore 5
    ...
    //   77: dup
    //   78: ldc_w 271
    //   81: invokespecial 273	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   84: aload_1
    ...
    //   97: astore_1
    //   98: aload_0
    //   99: getfield 61	com/tencent/mm/storage/ax:db	Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;
    //   102: ldc_w 266
    //   105: iconst_3
    //   106: anewarray 30	java/lang/String
    //   109: dup
    //   110: iconst_0
    //   111: aload 5
    //   113: aastore
    ...
    //   122: aastore
    //   123: iconst_2
    //   124: invokeinterface 164 4 0
    //   129: astore 5
    //   131: aload 5
    //   133: astore_1
    //   134: aload 5
    //   136: ldc 172
    //   138: invokeinterface 176 2 0
    //   143: istore_3
    //   144: aload 5
    //   146: astore_1
    //   147: aload 5
    //   149: invokeinterface 170 1 0
    //   154: ifeq +107 -> 261
    //   157: aload 5
    //   159: astore_1
    //   160: new 120	java/util/ArrayList
    //   163: dup
    //   164: invokespecial 121	java/util/ArrayList:<init>	()V
    //   167: astore 6
    //   169: aload 5
    //   171: astore_1
    //   172: aload 5
    //   174: iload_3
    //   175: invokeinterface 180 2 0
    //   180: astore 7
    //   182: aload_2
    //   183: ifnull +29 -> 212
    //   186: aload 5
    ...
    //   201: aload_2
    //   202: aload 7
    //   204: invokeinterface 276 2 0
    //   209: ifne +14 -> 223
    //   212: aload 5
    //   214: astore_1
    //   215: aload 6
    //   217: aload 7
    //   219: invokevirtual 277	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   222: pop
    //   223: aload 5
    //   225: astore_1
    //   226: aload 5
    //   228: invokeinterface 280 1 0
    //   233: istore 4
    //   235: iload 4
    //   237: ifne -68 -> 169
    //   240: aload 5
    ...
    //   263: ifnull +10 -> 273
    //   266: aload 5
    //   268: invokeinterface 203 1 0
    //   273: ldc_w 262
    //   276: invokestatic 47	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   279: aconst_null
    //   280: areturn
    //   281: astore_2
    //   282: aconst_null
    ...
    //   290: ldc_w 282
    //   293: iconst_1
    //   294: anewarray 105	java/lang/Object
    //   297: dup
    //   298: iconst_0
    //   299: aload_2
    //   300: invokevirtual 212	java/lang/Exception:toString	()Ljava/lang/String;
    //   303: aastore
    //   304: invokestatic 215	com/tencent/mm/sdk/platformtools/Log:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   307: aload 5
    //   309: ifnull -36 -> 273
    //   312: aload 5
    //   314: invokeinterface 203 1 0
    //   319: goto -46 -> 273
    //   322: astore_2
    //   323: aconst_null
    //   324: astore_1
  ...
  /* Error */
  public final ArrayList<String> Y(String[] paramArrayOfString)
  {
    // Byte code:
    //   0: ldc_w 286
    //   3: invokestatic 28	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    //   65: dup
    //   66: ldc_w 292
    //   69: invokespecial 273	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   72: aload_1
    //   73: iload_2
    //   74: aaload
    ...
    //   84: invokevirtual 109	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   131: ldc_w 298
    //   134: iconst_1
    //   135: anewarray 105	java/lang/Object
    //   138: dup
    //   139: iconst_0
    //   140: aload_1
    //   141: aastore
    //   142: invokestatic 269	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   145: aload_0
    //   146: getfield 61	com/tencent/mm/storage/ax:db	Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;
    //   149: aload_1
    //   150: aconst_null
    //   151: iconst_2
    //   152: invokeinterface 164 4 0
    //   157: astore 4
    //   159: aload 4
    //   161: astore_1
    //   162: aload 4
    //   164: ldc 172
    //   166: invokeinterface 176 2 0
    //   171: istore_2
    //   172: aload 4
    //   174: astore_1
    //   175: aload 4
    //   177: invokeinterface 170 1 0
    //   182: ifeq +92 -> 274
    //   185: aload 4
    //   187: astore_1
    //   188: new 120	java/util/ArrayList
    //   191: dup
    //   192: invokespecial 121	java/util/ArrayList:<init>	()V
    //   195: astore 5
    //   197: aload 4
    //   199: astore_1
    //   200: aload 5
    ...
    //   210: invokevirtual 277	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   213: pop
    //   214: aload 4
    //   216: astore_1
    //   217: aload 4
    //   219: invokeinterface 280 1 0
    //   224: ifne -27 -> 197
    //   227: aload 4
    //   229: astore_1
    //   230: ldc 101
    //   232: ldc_w 300
    //   235: iconst_1
    //   236: anewarray 105	java/lang/Object
    //   239: dup
    //   240: iconst_0
    //   241: aload 5
    //   243: invokevirtual 301	java/util/ArrayList:size	()I
    //   246: invokestatic 306	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   249: aastore
    //   250: invokestatic 269	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   253: aload 4
    //   255: ifnull +10 -> 265
    //   258: aload 4
    //   260: invokeinterface 203 1 0
    //   265: ldc_w 286
    ...
    //   304: ldc_w 308
    //   307: iconst_1
    //   308: anewarray 105	java/lang/Object
    //   311: dup
    //   312: iconst_0
    //   313: aload 5
    //   315: invokevirtual 212	java/lang/Exception:toString	()Ljava/lang/String;
    //   318: aastore
    //   319: invokestatic 215	com/tencent/mm/sdk/platformtools/Log:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   322: aload 4
    //   324: ifnull -38 -> 286
    //   327: aload 4
    //   329: invokeinterface 203 1 0
    //   334: goto -48 -> 286
    //   337: astore 4
    //   339: aconst_null
    //   340: astore_1
  ...
  public final String aMN(String paramString)
  {
    ...
    //   3: invokestatic 28	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: aload_0
    //   7: getfield 61	com/tencent/mm/storage/ax:db	Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;
    //   10: ldc 38
    //   12: iconst_1
    ...
    //   78: ldc_w 324
    //   81: iconst_1
    //   82: anewarray 105	java/lang/Object
    //   85: dup
    //   86: iconst_0
    //   87: aload_3
    //   88: invokestatic 228	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   91: aastore
    //   92: invokestatic 114	com/tencent/mm/sdk/platformtools/Log:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   95: aload_2
    //   96: ifnull +9 -> 105
    //   99: aload_2
    ...
    //   138: ldc_w 326
    //   141: iconst_1
    //   142: anewarray 105	java/lang/Object
    //   145: dup
    //   146: iconst_0
    //   147: aload_3
    //   148: invokevirtual 212	java/lang/Exception:toString	()Ljava/lang/String;
    //   151: aastore
    //   152: invokestatic 215	com/tencent/mm/sdk/platformtools/Log:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   155: aload_2
    //   156: ifnull -33 -> 123
    //   159: aload_2
    //   160: invokeinterface 203 1 0
    //   165: goto -42 -> 123
    //   168: astore_2
    //   169: aconst_null
    //   170: astore_1
  ...
  public final ArrayList<String> bvX(String paramString)
  {
    int i = -1;
    ...
    hyi();
    ArrayList localArrayList = (ArrayList)this.VEt.get(Integer.valueOf(j));
  ...
  /* Error */
  public final au bvY(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   8: aload_0
    //   9: getfield 61	com/tencent/mm/storage/ax:db	Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;
    //   12: ldc 38
    //   14: bipush 6
    ...
    //   91: aload_2
    //   92: astore_1
    //   93: new 32	com/tencent/mm/storage/au
    //   96: dup
    //   97: invokespecial 397	com/tencent/mm/storage/au:<init>	()V
    //   100: astore_3
    //   101: aload_2
    //   102: astore_1
    //   103: aload_3
    //   104: aload_2
    //   105: invokevirtual 401	com/tencent/mm/storage/au:convertFrom	(Landroid/database/Cursor;)V
    //   108: aload_2
    //   109: ifnull +9 -> 118
    //   112: aload_2
    //   113: invokeinterface 203 1 0
    //   118: ldc_w 388
    ...
    //   151: ldc_w 334
    //   154: iconst_1
    //   155: anewarray 105	java/lang/Object
    //   158: dup
    //   159: iconst_0
    //   160: aload_3
    //   161: invokevirtual 212	java/lang/Exception:toString	()Ljava/lang/String;
    //   164: aastore
    //   165: invokestatic 215	com/tencent/mm/sdk/platformtools/Log:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   168: aload_2
    //   169: ifnull -33 -> 136
    //   172: aload_2
    //   173: invokeinterface 203 1 0
    //   178: goto -42 -> 136
    //   181: astore_1
    //   182: aload_2
    //   183: ifnull +9 -> 192
  ...
  /* Error */
  public final au bvZ(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
  ...
  /* Error */
  public final ArrayList<String> bx(ArrayList<String> paramArrayList)
  {
    // Byte code:
    //   0: ldc_w 408
    //   3: invokestatic 28	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    //   7: ifnull +10 -> 17
    //   10: aload_1
    //   11: invokevirtual 301	java/util/ArrayList:size	()I
    //   14: ifgt +11 -> 25
    //   17: ldc_w 408
    ...
    //   24: areturn
    //   25: aload_1
    //   26: invokevirtual 301	java/util/ArrayList:size	()I
    //   29: istore_3
    ...
    //   69: dup
    //   70: ldc_w 412
    //   73: invokespecial 273	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   76: aload_1
    //   77: iload_2
    //   78: invokevirtual 413	java/util/ArrayList:get	(I)Ljava/lang/Object;
    ...
    //   149: ldc_w 417
    //   152: iconst_1
    //   153: anewarray 105	java/lang/Object
    //   156: dup
    //   157: iconst_0
    //   158: aload_1
    //   159: aastore
    //   160: invokestatic 269	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   163: aload_0
    //   164: getfield 61	com/tencent/mm/storage/ax:db	Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;
    //   167: aload_1
    //   168: aconst_null
    //   169: iconst_2
    //   170: invokeinterface 164 4 0
    //   175: astore 4
    //   177: aload 4
    //   179: astore_1
    //   180: aload 4
    //   182: ldc 230
    //   184: invokeinterface 176 2 0
    //   189: istore_2
    //   190: aload 4
    //   192: astore_1
    //   193: aload 4
    //   195: invokeinterface 170 1 0
    //   200: ifeq +92 -> 292
    //   203: aload 4
    //   205: astore_1
    //   206: new 120	java/util/ArrayList
    //   209: dup
    //   210: invokespecial 121	java/util/ArrayList:<init>	()V
    //   213: astore 5
    //   215: aload 4
    //   217: astore_1
    //   218: aload 5
    //   220: aload 4
    //   222: iload_2
    //   223: invokeinterface 180 2 0
    //   228: invokevirtual 277	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   231: pop
    //   232: aload 4
    //   234: astore_1
    //   235: aload 4
    //   237: invokeinterface 280 1 0
    //   242: ifne -27 -> 215
    //   245: aload 4
    //   247: astore_1
    //   248: ldc 101
    //   250: ldc_w 419
    //   253: iconst_1
    //   254: anewarray 105	java/lang/Object
    //   257: dup
    //   258: iconst_0
    //   259: aload 5
    //   261: invokevirtual 301	java/util/ArrayList:size	()I
    //   264: invokestatic 306	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   267: aastore
    //   268: invokestatic 269	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   271: aload 4
    //   273: ifnull +10 -> 283
    //   276: aload 4
    ...
    //   322: ldc_w 421
    //   325: iconst_1
    //   326: anewarray 105	java/lang/Object
    //   329: dup
    //   330: iconst_0
    //   331: aload 5
    //   333: invokevirtual 212	java/lang/Exception:toString	()Ljava/lang/String;
    //   336: aastore
    //   337: invokestatic 215	com/tencent/mm/sdk/platformtools/Log:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   340: aload 4
    //   342: ifnull -38 -> 304
    //   345: aload 4
    //   347: invokeinterface 203 1 0
    //   352: goto -48 -> 304
    //   355: astore 4
    //   357: aconst_null
    //   358: astore_1
  ...
  public final ArrayList<String> hyg()
  {
  ...
  public final void hyi()
  {
    ...
    if ((this.VEs != null) && (this.VEt != null))
    {
    ...
    long l = Util.nowMilliSecond();
    Object localObject1 = "select username , contactLabelIds from rcontact where (type & " + d.axN() + " !=0 ) and ( contactLabelIds != '') ;";
    localObject1 = this.db.rawQuery((String)localObject1, null, 2);
    Object localObject2;
    Object localObject3;
    if (localObject1 == null)
    {
      this.VEs = localHashMap1;
      this.VEt = localHashMap2;
      AppMethodBeat.o(32850);
      return;
  ...
  /* Error */
  public final ArrayList<au> jA(List<au> paramList)
  {
    // Byte code:
    //   0: ldc_w 486
    //   3: invokestatic 28	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    //   76: aload_1
    //   77: iload_2
    //   78: invokeinterface 92 2 0
    //   83: checkcast 32	com/tencent/mm/storage/au
    //   86: getfield 96	com/tencent/mm/storage/au:field_labelID	I
    ...
    //   154: ldc_w 490
    //   157: iconst_1
    //   158: anewarray 105	java/lang/Object
    //   161: dup
    //   162: iconst_0
    //   163: aload_1
    //   164: aastore
    //   165: invokestatic 269	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   168: aload_0
    //   169: getfield 61	com/tencent/mm/storage/ax:db	Lcom/tencent/mm/sdk/storage/ISQLiteDatabase;
    //   172: aload_1
    //   173: aconst_null
    //   174: iconst_2
    //   175: invokeinterface 164 4 0
    //   180: astore 4
    //   182: aload 4
    //   184: astore_1
    //   185: aload 4
    //   187: invokeinterface 170 1 0
    //   192: ifeq +108 -> 300
    //   195: aload 4
    //   197: astore_1
    //   198: new 120	java/util/ArrayList
    //   201: dup
    //   202: invokespecial 121	java/util/ArrayList:<init>	()V
    //   205: astore 5
    //   207: aload 4
    //   209: astore_1
    //   210: new 32	com/tencent/mm/storage/au
    //   213: dup
    //   214: invokespecial 397	com/tencent/mm/storage/au:<init>	()V
    //   217: astore 6
    //   219: aload 4
    //   221: astore_1
    //   222: aload 6
    //   224: aload 4
    //   226: invokevirtual 401	com/tencent/mm/storage/au:convertFrom	(Landroid/database/Cursor;)V
    //   229: aload 4
    //   231: astore_1
    //   232: aload 5
    //   234: aload 6
    //   236: invokevirtual 277	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   239: pop
    //   240: aload 4
    //   242: astore_1
    //   243: aload 4
    ...
    //   258: ldc_w 492
    //   261: iconst_1
    //   262: anewarray 105	java/lang/Object
    //   265: dup
    //   266: iconst_0
    //   267: aload 5
    //   269: invokevirtual 301	java/util/ArrayList:size	()I
    //   272: invokestatic 306	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   275: aastore
    //   276: invokestatic 269	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   279: aload 4
    //   281: ifnull +10 -> 291
    //   284: aload 4
    //   286: invokeinterface 203 1 0
    //   291: ldc_w 486
    ...
    //   330: ldc_w 494
    //   333: iconst_1
    //   334: anewarray 105	java/lang/Object
    //   337: dup
    //   338: iconst_0
    //   339: aload 5
    //   341: invokevirtual 212	java/lang/Exception:toString	()Ljava/lang/String;
    //   344: aastore
    //   345: invokestatic 215	com/tencent/mm/sdk/platformtools/Log:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   348: aload 4
    //   350: ifnull -38 -> 312
    //   353: aload 4
    //   355: invokeinterface 203 1 0
    //   360: goto -48 -> 312
    //   363: astore 4
    //   365: aconst_null
    //   366: astore_1
  ...
  public final boolean jx(List<au> paramList)
  {
  ...
  public final boolean jy(List<au> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (localArrayList1.size() > 0) {
        doNotify(J("insert", localArrayList1));
      }
      if (localArrayList2.size() > 0) {
        doNotify(J("update", localArrayList2));
      }
      aPn();
      AppMethodBeat.o(32861);
      return false;
  ...
  public final boolean jz(List<au> paramList)
  {
  ...
  public static enum a
  {
    static
    {
      ...
      VEv = new a("EQUAL", 0);
      VEw = new a("NOEQUAL", 1);
      VEx = new a("NOEXISTS", 2);
      VEy = new a[] { VEv, VEw, VEx };
