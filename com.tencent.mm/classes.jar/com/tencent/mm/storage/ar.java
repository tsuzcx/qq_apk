  ...
  implements g.a
{
  ...
  private HashMap<String, int[]> IJX;
  public HashMap<Integer, ArrayList<String>> IJY;
  private e db;
  
  static
  {
    AppMethodBeat.i(32877);
    SQL_CREATE = new String[] { j.getCreateSQLs(ao.info, "ContactLabel") };
    AppMethodBeat.o(32877);
  }
  
  public ar(e parame)
  {
    this(parame, ao.info, "ContactLabel");
  }
  
  private ar(e parame, c.a parama, String paramString)
  {
  ...
  private static String D(String paramString, List<ao> paramList)
  {
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (i < j)
      {
        paramString = (ao)paramList.get(i);
        if (paramString != null)
        {
  ...
  private static String a(String paramString, ao paramao)
  {
    AppMethodBeat.i(32868);
    if (paramao != null)
    {
      ArrayList localArrayList = new ArrayList();
      localArrayList.add(paramao);
      paramString = D(paramString, localArrayList);
  ...
  private boolean a(boolean paramBoolean, ao paramao)
  {
    AppMethodBeat.i(32855);
    boolean bool = super.insert(paramao);
    if ((bool) && (paramBoolean)) {
      doNotify(a("insert", paramao));
    }
    AppMethodBeat.o(32855);
    return bool;
  }
  
  private boolean a(boolean paramBoolean, ao paramao, String... paramVarArgs)
  {
    AppMethodBeat.i(32857);
    boolean bool = super.delete(paramao, paramVarArgs);
    if ((bool) && (paramBoolean))
    {
      doNotify(a("delete", paramao));
      fqr();
    }
    aox();
  ...
  private a b(ao paramao)
  {
    AppMethodBeat.i(32866);
    localObject2 = null;
    localObject1 = null;
    Object localObject3 = paramao.field_labelID;
    try
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (((Cursor)localObject3).moveToFirst())
        {
          localObject1 = localObject3;
          localObject2 = localObject3;
          String str = bt.bI(((Cursor)localObject3).getString(((Cursor)localObject3).getColumnIndex("labelName")), "");
          localObject1 = localObject3;
          localObject2 = localObject3;
          if (paramao.field_labelName.equalsIgnoreCase(str))
          {
            localObject1 = localObject3;
            localObject2 = localObject3;
            paramao = a.IKa;
    ...
    catch (Exception paramao)
    {
      for (;;)
      {
        ...
        ad.w("MicroMsg.Label.ContactLabelStorage", "cpan[checkEqualsName] exception %s", new Object[] { paramao.toString() });
  ...
  private String c(ao paramao)
  {
    ...
    //   12: aload_1
    //   13: getfield 195	com/tencent/mm/storage/ao:field_labelName	Ljava/lang/String;
    ...
    //   22: astore_3
    //   23: aload_0
    //   24: getfield 65	com/tencent/mm/storage/ar:db	Lcom/tencent/mm/sdk/e/e;
    //   27: ldc 223
    //   29: iconst_2
    ...
    //   87: ldc 185
    //   89: invokestatic 191	com/tencent/mm/sdk/platformtools/bt:bI	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   92: astore 5
    //   94: aload 4
    //   96: astore_3
    //   97: aload_1
    //   98: getfield 195	com/tencent/mm/storage/ao:field_labelName	Ljava/lang/String;
    //   101: aload 5
    ...
    //   127: aload_1
    //   128: getfield 195	com/tencent/mm/storage/ao:field_labelName	Ljava/lang/String;
  ...
  public final ArrayList<String> C(String paramString, List<String> paramList)
  {
    ...
    //   97: astore_1
    //   98: aload_0
    //   99: getfield 65	com/tencent/mm/storage/ar:db	Lcom/tencent/mm/sdk/e/e;
    //   102: ldc_w 271
    //   105: iconst_3
  ...
  public final ArrayList<String> W(String[] paramArrayOfString)
  {
    ...
    //   145: aload_0
    //   146: getfield 65	com/tencent/mm/storage/ar:db	Lcom/tencent/mm/sdk/e/e;
    //   149: aload_1
    //   150: aconst_null
    //   151: iconst_2
  ...
  public final boolean a(ao paramao, String... paramVarArgs)
  {
    AppMethodBeat.i(32858);
    boolean bool = a(true, paramao, paramVarArgs);
    AppMethodBeat.o(32858);
    return bool;
  }
  
  /* Error */
  public final ArrayList<String> aP(ArrayList<String> paramArrayList)
  {
    // Byte code:
    //   0: ldc_w 333
    //   3: invokestatic 30	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    //   163: aload_0
    //   164: getfield 65	com/tencent/mm/storage/ar:db	Lcom/tencent/mm/sdk/e/e;
    //   167: aload_1
    //   168: aconst_null
    //   169: iconst_2
  ...
  public final ArrayList<String> aTa(String paramString)
  {
    int i = -1;
    ...
    fqq();
    ArrayList localArrayList = (ArrayList)this.IJY.get(Integer.valueOf(j));
    l = bt.Df(l);
    if (localArrayList == null) {}
    for (;;)
    {
      ad.i("MicroMsg.Label.ContactLabelStorage", "getUserNameListById time:%s id:%s count:%s stack:%s", new Object[] { Long.valueOf(l), paramString, Integer.valueOf(i), bt.flS() });
      AppMethodBeat.o(32851);
  ...
  /* Error */
  public final ao aTb(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   8: aload_0
    //   9: getfield 65	com/tencent/mm/storage/ar:db	Lcom/tencent/mm/sdk/e/e;
    //   12: ldc 40
    //   14: bipush 6
    ...
    //   91: aload_2
    //   92: astore_1
    //   93: new 34	com/tencent/mm/storage/ao
    //   96: dup
    //   97: invokespecial 404	com/tencent/mm/storage/ao:<init>	()V
    //   100: astore_3
    //   101: aload_2
    //   102: astore_1
    //   103: aload_3
    //   104: aload_2
    //   105: invokevirtual 408	com/tencent/mm/storage/ao:convertFrom	(Landroid/database/Cursor;)V
    //   108: aload_2
    //   109: ifnull +9 -> 118
    //   112: aload_2
  ...
  /* Error */
  public final ao aTc(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
  ...
  public final String aol(String paramString)
  {
    ...
    //   3: invokestatic 30	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: aload_0
    //   7: getfield 65	com/tencent/mm/storage/ar:db	Lcom/tencent/mm/sdk/e/e;
    //   10: ldc 40
    //   12: iconst_1
  ...
  public final void aox()
  {
    ...
    ad.v("MicroMsg.Label.ContactLabelStorage", "cleanCache %s", new Object[] { bt.flS() });
    this.IJX = null;
    this.IJY = null;
    AppMethodBeat.o(32849);
  }
  
  public final boolean b(boolean paramBoolean, ao paramao, String... paramVarArgs)
  {
    AppMethodBeat.i(32859);
    boolean bool = super.update(paramao, paramVarArgs);
    if ((bool) && (paramBoolean)) {
      doNotify(a("update", paramao));
    }
    aox();
  ...
  public final ArrayList<String> fqo()
  {
    ...
    localCursor.close();
    ad.i("MicroMsg.Label.ContactLabelStorage", "getAllLabel time:%s count:%s stack:%s", new Object[] { Long.valueOf(bt.Df(l)), Integer.valueOf(localArrayList.size()), bt.flS() });
    AppMethodBeat.o(32847);
    return localArrayList;
  }
  
  public final ArrayList<ao> fqp()
  {
    ...
    localCursor.close();
    ad.i("MicroMsg.Label.ContactLabelStorage", "getAllContactLable time:%s count:%s stack:%s", new Object[] { Long.valueOf(bt.Df(l)), Integer.valueOf(localArrayList.size()), bt.flS() });
    AppMethodBeat.o(32848);
    return localArrayList;
  }
  ...
  public final void fqq()
  {
    ...
    if ((this.IJX != null) && (this.IJY != null))
    {
    ...
    long l = bt.flT();
    Object localObject1 = "select username , contactLabelIds from rcontact where (type & " + b.ada() + " !=0 ) and ( contactLabelIds != '') ;";
    localObject1 = this.db.a((String)localObject1, null, 2);
    Object localObject2;
    Object localObject3;
    if (localObject1 == null)
    {
      this.IJX = localHashMap1;
      this.IJY = localHashMap2;
      AppMethodBeat.o(32850);
      return;
    ...
    ad.i("MicroMsg.Label.ContactLabelStorage", "checkRebuildCache time:%s user:%s label:%s stack:%s", new Object[] { Long.valueOf(bt.Df(l)), Integer.valueOf(localHashMap1.size()), Integer.valueOf(localHashMap2.size()), bt.flS() });
    this.IJX = localHashMap1;
    this.IJY = localHashMap2;
    AppMethodBeat.o(32850);
  }
  
  public final boolean hr(List<ao> paramList)
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        String str = c((ao)paramList.get(i));
  ...
  public final boolean hs(List<ao> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          b(false, localao, new String[] { "labelID" });
          localArrayList2.add(localao);
          continue;
          localao.field_createTime = System.currentTimeMillis();
          a(false, localao);
          localArrayList1.add(localao);
        }
      }
      if (localh != null)
      {
      ...
      if (localArrayList1.size() > 0) {
        doNotify(D("insert", localArrayList1));
      }
      if (localArrayList2.size() > 0) {
        doNotify(D("update", localArrayList2));
      }
      aox();
      AppMethodBeat.o(32861);
      return false;
  ...
  public final boolean ht(List<ao> paramList)
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        a(false, (ao)paramList.get(i), new String[] { "labelID" });
        i += 1;
      }
      if (localh != null)
      {
  ...
  /* Error */
  public final ArrayList<ao> hu(List<ao> paramList)
  {
    // Byte code:
    //   0: ldc_w 559
    //   3: invokestatic 30	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    //   83: checkcast 34	com/tencent/mm/storage/ao
    //   86: getfield 100	com/tencent/mm/storage/ao:field_labelID	I
    ...
    //   168: aload_0
    //   169: getfield 65	com/tencent/mm/storage/ar:db	Lcom/tencent/mm/sdk/e/e;
    //   172: aload_1
    //   173: aconst_null
    //   174: iconst_2
    ...
    //   207: aload 4
    //   209: astore_1
    //   210: new 34	com/tencent/mm/storage/ao
    //   213: dup
    //   214: invokespecial 404	com/tencent/mm/storage/ao:<init>	()V
    //   217: astore 6
    //   219: aload 4
    //   221: astore_1
    //   222: aload 6
    //   224: aload 4
    //   226: invokevirtual 408	com/tencent/mm/storage/ao:convertFrom	(Landroid/database/Cursor;)V
    //   229: aload 4
    //   231: astore_1
    //   232: aload 5
    //   234: aload 6
  ...
  public static enum a
  {
    static
    {
      ...
      IKa = new a("EQUAL", 0);
      IKb = new a("NOEQUAL", 1);
      IKc = new a("NOEXISTS", 2);
      IKd = new a[] { IKa, IKb, IKc };
