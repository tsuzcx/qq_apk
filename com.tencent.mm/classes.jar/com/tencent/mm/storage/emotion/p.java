  ...
  implements g.a
{
  ...
  static
  {
    ...
    SQL_CREATE = new String[] { j.getCreateSQLs(o.info, "EmotionRewardTipInfo") };
    AppMethodBeat.o(105125);
  }
  
  public p(e parame)
  {
    this(parame, o.info, "EmotionRewardTipInfo");
  }
  ...
  public final boolean a(o paramo)
  {
    ...
    long l = this.db.replace("EmotionRewardTipInfo", "prodcutID", paramo.convertTo());
    if (l > 0L) {
  ...
  public final o eNQ()
  {
    ...
    //   37: aload_2
    //   38: astore_1
    //   39: new 24	com/tencent/mm/storage/emotion/o
    //   42: dup
    //   43: invokespecial 100	com/tencent/mm/storage/emotion/o:<init>	()V
    //   46: astore_3
    //   47: aload_2
    //   48: astore_1
    //   49: aload_3
    //   50: aload_2
    //   51: invokevirtual 104	com/tencent/mm/storage/emotion/o:convertFrom	(Landroid/database/Cursor;)V
    //   54: aload_2
    //   55: ifnull +9 -> 64
    //   58: aload_2
    ...
    //   102: iconst_0
    //   103: aload_3
    //   104: invokestatic 117	com/tencent/mm/sdk/platformtools/bt:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   107: aastore
  ...
  public final boolean fR(String paramString, int paramInt)
  {
