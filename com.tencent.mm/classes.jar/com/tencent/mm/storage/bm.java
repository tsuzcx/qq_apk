  ...
  extends j<com.tencent.mm.api.h>
{
  ...
  static
  {
    ...
    hHS = (com.tencent.mm.storagebase.h)localObject;
  ...
  public static void a(String paramString, com.tencent.mm.api.h paramh)
  {
    ...
    Object localObject = aTX(paramString);
    if (localObject != null) {
      try
      {
        boolean bool1;
        ...
        {
          bool1 = true;
          if (((com.tencent.mm.api.h)localObject).KV() != null) {
            break label186;
          }
        }
        label186:
        for (boolean bool2 = true;; bool2 = false)
        {
          ...
          if ((paramh.get("addMsg") == null) && (((com.tencent.mm.api.h)localObject).KV() != null))
          {
            localObject = ((com.tencent.mm.api.h)localObject).KV();
            if (localObject == null) {
              p.gfZ();
            }
            paramh.put("addMsg", ((cv)localObject).toByteArray());
          }
          ad.i("FunctionMsg.FunctionMsgStorage", "updateByFunctionMsgId, ret: %s", new Object[] { Integer.valueOf(hHS.update("FunctionMsgItem", paramh, "functionmsgid=?", new String[] { paramString })) });
  ...
  /* Error */
  public static com.tencent.mm.api.h aTX(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    ...
    //   42: getstatic 83	com/tencent/mm/storage/bm:hHS	Lcom/tencent/mm/storagebase/h;
    //   45: ldc 97
    //   47: getstatic 58	com/tencent/mm/storage/bm:IMb	[Ljava/lang/String;
    //   50: ldc 166
    //   52: iconst_1
    ...
    //   73: aload_0
    //   74: ifnonnull +6 -> 80
    //   77: invokestatic 81	d/g/b/p:gfZ	()V
    //   80: aload_0
    ...
    //   112: aload_3
    //   113: areturn
    //   114: getstatic 224	d/z:MKo	Ld/z;
    //   117: astore_0
    //   118: aload_2
    //   119: aconst_null
  ...
  /* Error */
  public static java.util.List<com.tencent.mm.api.h> fru()
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    //   2: ldc 227
    //   4: invokestatic 45	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   7: getstatic 83	com/tencent/mm/storage/bm:hHS	Lcom/tencent/mm/storagebase/h;
    //   10: ldc 97
    //   12: getstatic 58	com/tencent/mm/storage/bm:IMb	[Ljava/lang/String;
    //   15: ldc 229
    //   17: iconst_1
  ...
  public static void frv()
  {
    AppMethodBeat.i(114153);
    int i = hHS.delete("FunctionMsgItem", "status=?", new String[] { "100" });
    int j = hHS.delete("FunctionMsgItem", "status=?", new String[] { "3" });
