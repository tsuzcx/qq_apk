  ...
  extends j<com.tencent.mm.api.h>
{
  ...
  static
  {
    ...
    hKK = (com.tencent.mm.storagebase.h)localObject;
    AppMethodBeat.o(114155);
  }
  
  private bn()
  {
    super((com.tencent.mm.sdk.e.e)locale.getDataDB(), com.tencent.mm.api.h.info, "FunctionMsgItem", new String[] { "CREATE INDEX IF NOT EXISTS functionIdIndex ON FunctionMsgItem(functionmsgid)" });
  ...
  public static void a(String paramString, com.tencent.mm.api.h paramh)
  {
    ...
    p.h(paramh, "newFunctionMsgItem");
    ae.i("FunctionMsg.FunctionMsgStorage", "updateByFunctionMsgId, functionMsgId: %s", new Object[] { paramString });
    ...
    if (localObject != null) {
      try
      {
        ...
        {
          bool1 = true;
          if (((com.tencent.mm.api.h)localObject).Ld() != null) {
            break label186;
          }
        }
        label186:
        ...
        {
          ae.i("FunctionMsg.FunctionMsgStorage", "updateByFunctionMsgId, functionMsgId: %s, newFunctionMsgItem.msgContent==null: %s,oldFunctionMsgItem.msgContent==null: %s", new Object[] { paramString, Boolean.valueOf(bool1), Boolean.valueOf(bool2) });
          paramh = paramh.convertTo();
          if ((paramh.get("addMsg") == null) && (((com.tencent.mm.api.h)localObject).Ld() != null))
          {
            localObject = ((com.tencent.mm.api.h)localObject).Ld();
            if (localObject == null) {
              p.gkB();
            }
            paramh.put("addMsg", ((cv)localObject).toByteArray());
          }
          ae.i("FunctionMsg.FunctionMsgStorage", "updateByFunctionMsgId, ret: %s", new Object[] { Integer.valueOf(hKK.update("FunctionMsgItem", paramh, "functionmsgid=?", new String[] { paramString })) });
      ...
      {
        ae.e("FunctionMsg.FunctionMsgStorage", "updateByFunctionMsgId error: %s", new Object[] { paramString.getMessage() });
      }
    }
  }
  
  /* Error */
  public static com.tencent.mm.api.h aVy(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    ...
    //   7: aload_0
    //   8: ldc 109
    //   10: invokestatic 112	d/g/b/p:h	(Ljava/lang/Object;Ljava/lang/String;)V
    //   13: aload_0
    //   14: invokestatic 195	com/tencent/mm/sdk/platformtools/bu:isNullOrNil	(Ljava/lang/String;)Z
    //   17: ifeq +10 -> 27
    //   20: ldc 189
    ...
    //   37: aload_0
    //   38: aastore
    //   39: invokestatic 124	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   42: getstatic 83	com/tencent/mm/storage/bn:hKK	Lcom/tencent/mm/storagebase/h;
    //   45: ldc 97
    //   47: getstatic 58	com/tencent/mm/storage/bn:JgI	[Ljava/lang/String;
    //   50: ldc 166
    //   52: iconst_1
    ...
    //   73: aload_0
    //   74: ifnonnull +6 -> 80
    //   77: invokestatic 81	d/g/b/p:gkB	()V
    //   80: aload_0
    ...
    //   112: aload_3
    //   113: areturn
    //   114: getstatic 224	d/z:Nhr	Ld/z;
    //   117: astore_0
    //   118: aload_2
    //   119: aconst_null
  ...
  /* Error */
  public static java.util.List<com.tencent.mm.api.h> fvu()
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    //   2: ldc 227
    //   4: invokestatic 45	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   7: getstatic 83	com/tencent/mm/storage/bn:hKK	Lcom/tencent/mm/storagebase/h;
    //   10: ldc 97
    //   12: getstatic 58	com/tencent/mm/storage/bn:JgI	[Ljava/lang/String;
    //   15: ldc 229
    //   17: iconst_1
    ...
    //   57: aload_0
    //   58: ldc 236
    //   60: invokestatic 72	d/g/b/p:g	(Ljava/lang/Object;Ljava/lang/String;)V
    //   63: aload_0
  ...
  public static void fvv()
  {
    ...
    int i = hKK.delete("FunctionMsgItem", "status=?", new String[] { "100" });
    int j = hKK.delete("FunctionMsgItem", "status=?", new String[] { "3" });
    ae.i("FunctionMsg.FunctionMsgStorage", "[deleteAllHandleFunctionMsg] ret1:" + i + " ret2:" + j);
