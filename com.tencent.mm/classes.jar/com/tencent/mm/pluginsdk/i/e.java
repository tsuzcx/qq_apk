...
public final class e
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramCharSequence != null)
        {
          ...
          paramCharSequence = kB(paramTime.monthDay, j);
          continue;
          ...
          continue;
          paramCharSequence = kB(paramTime.hour, j);
          continue;
          paramCharSequence = kB(paramTime.minute, j);
          continue;
          k = paramTime.month;
          if (j >= 4)
          {
          ...
          {
            paramCharSequence = kB(k + 1, j);
            continue;
            paramCharSequence = kB(paramTime.second, j);
            continue;
            ...
            if (j < 2)
            {
              ...
              for (;;)
              {
                k = (int)(l / 3600L);
                n = (int)(l % 3600L / 60L);
                paramCharSequence.append(kB(k, 2));
                paramCharSequence.append(kB(n, 2));
  ...
  private static String kB(int paramInt1, int paramInt2)
  {
