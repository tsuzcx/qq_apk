...
public final class i
{
  ...
  private static CharSequence as(Context paramContext, int paramInt)
  {
  ...
  public static CharSequence c(Context paramContext, long paramLong, boolean paramBoolean)
  {
    ...
    if ((((Time)localObject2).year == ((Time)localObject1).year) && (((Time)localObject2).yearDay == ((Time)localObject1).yearDay))
    {
      ...
      paramContext = as(paramContext, ((Time)localObject2).hour) + h.a(paramContext.getString(2131759528), (Time)localObject2);
      AppMethodBeat.o(151908);
      return paramContext;
    }
    if ((((Time)localObject2).year == ((Time)localObject1).year) && (((Time)localObject1).yearDay - ((Time)localObject2).yearDay == 1))
    {
      ...
      if (bool) {}
      for (paramContext = h.a(paramContext.getString(2131759529), (Time)localObject2);; paramContext = as(paramContext, ((Time)localObject2).hour) + h.a(paramContext.getString(2131759528), (Time)localObject2))
      {
    ...
    {
      localObject1 = h.a("E ", (Time)localObject2);
      if (paramBoolean)
      {
        AppMethodBeat.o(151908);
        return localObject1;
      }
      paramContext = (String)localObject1 + h.a(paramContext.getString(2131759530), (Time)localObject2);
      AppMethodBeat.o(151908);
      return paramContext;
    }
    if (((Time)localObject2).year == ((Time)localObject1).year)
    {
      if (paramBoolean)
      {
        paramContext = h.a(paramContext.getString(2131759498), (Time)localObject2);
        AppMethodBeat.o(151908);
        return paramContext;
      }
    ...
    if (paramBoolean)
    {
      paramContext = h.a(paramContext.getString(2131759517), (Time)localObject2);
      AppMethodBeat.o(151908);
      return paramContext;
    }
