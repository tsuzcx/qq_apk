...
{
  public static final String[] BNM = { "retCode", "url" };
  
  public static MatrixCursor Ue(int paramInt)
  {
    AppMethodBeat.i(30931);
    ad.i("MicroMsg.ExtCommonUtils", "returnMatrix = ".concat(String.valueOf(paramInt)));
    MatrixCursor localMatrixCursor = new MatrixCursor(com.tencent.mm.plugin.ext.b.a.pKr);
    localMatrixCursor.addRow(new Object[] { Integer.valueOf(paramInt) });
    AppMethodBeat.o(30931);
    return localMatrixCursor;
  }
  
  public static MatrixCursor aAz(String paramString)
  {
    AppMethodBeat.i(30932);
    ad.i("MicroMsg.ExtCommonUtils", "returnMatrix = 4207");
    MatrixCursor localMatrixCursor = new MatrixCursor(BNM);
