  ...
  implements com.tencent.mm.pluginsdk.h.a.c.h
{
  private static void a(s params, boolean paramBoolean)
  {
    ...
    q.a.ewL().HF(params.field_urlKey);
    a.aBt(params.field_filePath);
    a.aBt(params.field_filePath + ".decompressed");
    a.aBt(params.field_filePath + ".decrypted");
  ...
  private static boolean e(s params)
  {
    ...
    boolean bool = bt.nullAsNil(i.aEN(params.field_filePath)).equals(params.field_md5);
  ...
  private static void f(s params)
  {
    ...
    {
      b.ewn().a(params.field_resType, params.field_subType, params.field_filePath, bt.getInt(params.field_fileVersion, 0), params.field_originalMd5);
  ...
  public final void a(s params, int paramInt)
  {
    ...
    Object localObject1;
    Object localObject2;
    if ((params.field_expireTime != 0L) && (params.field_expireTime <= bt.aGK()))
    {
      ...
      localObject1 = q.a.ewL();
      localObject2 = params.field_urlKey;
      if (((q)localObject1).jqw) {
        ((q)localObject1).BTE.vv((String)localObject2);
      }
      a.aBt(params.field_filePath);
      a.aBt(params.field_filePath + ".decompressed");
      a.aBt(params.field_filePath + ".decrypted");
    ...
    {
      long l = a.fN(params.field_filePath);
    ...
    if ((params.field_status == 1) || (params.field_status == 0))
    {
      ...
      if (!q.a.ewL().aBr(params.field_urlKey))
      {
        ...
        if (e(params))
        {
          ...
          params.field_contentLength = a.fN(params.field_filePath);
          q.a.ewL().h(params);
          f(params);
          AppMethodBeat.o(151963);
          return;
        }
        if (0L == a.fN(params.field_filePath))
        {
          params.field_fileUpdated = true;
          q.a.ewL().h(params);
          b.ewn().f(params.field_resType, params.field_subType, 0, bt.nullAsNil(params.field_groupId2).equals("NewXml"));
