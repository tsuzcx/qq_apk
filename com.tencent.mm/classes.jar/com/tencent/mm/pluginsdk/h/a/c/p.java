...
final class p
{
  public static void acJ()
  {
    ...
    long l = bt.aGK();
    if (bt.a((Long)com.tencent.mm.kernel.g.afB().afk().get(ae.a.Fjp, null), 0L) < l)
    {
      com.tencent.mm.kernel.g.afB().afk().set(ae.a.Fjp, Long.valueOf(7200L + l));
      ad.i("MicroMsg.PostTaskCheckResume", "doCheckResume");
      q.a.ewL().bNl().postToWorker(new Runnable()
      {
        public final void run()
        {
          ...
          catch (android.database.sqlite.SQLiteDatabaseCorruptException localSQLiteDatabaseCorruptException)
          {
            ...
            {
              l = bt.eGO();
              localObject3 = ((q)localObject3).BTE.getAll();
            ...
            for (;;)
            {
              ad.i("MicroMsg.ResDownloaderCore", "queryAll: cost = %d", new Object[] { Long.valueOf(bt.vM(l)) });
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              if (!bt.isNullOrNil(locals.field_groupId1))
              {
                ...
                localObject3 = r.ewM().iterator();
                while (((Iterator)localObject3).hasNext())
                {
                  g localg = (g)((Iterator)localObject3).next();
                  if (j == bt.nullAsNil(localg.asy()).hashCode()) {
                    localg.ewq().a(locals, i);
                  }
                }
              }
            }
  ...
  static int getNetworkType()
  {
    ...
    switch (com.tencent.mm.compatible.deviceinfo.ab.Xx())
    {
    default: 
