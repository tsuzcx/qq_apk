...
final class f$b
{
  static void a(s params, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!bool2)
    {
      if (paramBoolean1)
      {
        j.D(params.field_reportId, 53L);
        j.D(params.field_reportId, 45L);
      }
      if (!bool1)
      {
    ...
    if ((!bt.isNullOrNil(str3)) && (!bt.isNullOrNil(str2)))
    {
      ...
      if (!bt.nullAsNil(i.aEN(str2)).equals(str3))
      {
      ...
      if (!q.a.ewL().aBr(str1))
      {
        ...
        b.ewn().f(params.field_resType, params.field_subType, 1, bt.nullAsNil(params.field_groupId2).equals("NewXml"));
        if (paramBoolean2)
        {
          b.ewn();
          b.c(params);
