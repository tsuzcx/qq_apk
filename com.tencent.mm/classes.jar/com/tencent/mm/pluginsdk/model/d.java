  ...
  implements a
{
  public final void j(Bundle paramBundle)
  {
    ...
    for (int j = 1;; j = 0)
    {
      ...
      y.d("MicroMsg.FavWebRptCallback", "FavWebRptCallback uiBrowseTime[%d] isScrollBottom[%b] sendToFriendCount[%d] shareSnsCount[%d]  isDelFav[%b] clickEditFavTagCount[%d] favId[%s]", new Object[] { Long.valueOf(l2), Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(j), Integer.valueOf(i4), Integer.valueOf(k) });
      localg = ((ae)com.tencent.mm.kernel.g.t(ae.class)).getFavItemInfoStorage().eF(k);
      if (localg != null) {
        break label251;
      }
      y.w("MicroMsg.FavWebRptCallback", "fav web rpt but favitem info is null favid[%d]", new Object[] { Integer.valueOf(k) });
      return;
      i = 0;
      break;
    }
    ...
    for (long l1 = localg.field_sourceCreateTime / 1000L;; l1 = localg.field_updateTime / 1000L)
    {
      ...
      i = ((PluginFav)com.tencent.mm.kernel.g.t(PluginFav.class)).getFavItemInfoStorage().qZ(k) + 1;
      localStringBuffer.append(i).append(",");
      localStringBuffer.append(str1).append(",");
      localStringBuffer.append(paramBundle);
      y.d("MicroMsg.FavWebRptCallback", String.format("lxl, 15098, sid:%s, sourcepos:%s, query:%s, tag:%s", new Object[] { str2, Integer.valueOf(i), str1, paramBundle }));
      y.v("MicroMsg.FavWebRptCallback", "FavWebRptCallback rpt id[%d] [%s]", new Object[] { Integer.valueOf(15098), localStringBuffer.toString() });
      f.nEG.aC(15098, localStringBuffer.toString());
      return;
    }
  }
}
