  ...
  extends x
{
  ...
  public final y.a hgP()
  {
    ...
    y.a locala = new y.a();
    locala.QVO = a.f.tencent_map_desc;
    String str = h.axc().getValue("QQMapDownloadTips");
    if (!Util.isNullOrNil(str)) {
      locala.QVP = str;
    }
    locala.QVQ = a.f.tencent_map_label;
    locala.QVN = a.b.icon_tencent_map;
 ...
 * Qualified Name:     com.tencent.mm.pluginsdk.model.ac
