...
public final class w$a
{
  ...
  static
  {
    ...
    ae.i("TBSDownloadChecker", "TRACE_ORDER:TBSHelper.java");
    aj.a(ak.getContext(), new w.a.1());
    FeR = false;
  ...
  public static void YX(int paramInt)
  {
    ...
    localIntent.setClassName(ak.getPackageName(), "com.tencent.mm.sandbox.updater.UpdaterService");
    localIntent.putExtra("intent_extra_download_type", paramInt);
    com.tencent.mm.br.d.l(localIntent, "sandbox");
    ae.i("MicroMsg.TBSDownloadChecker", "start UpdaterService to download xwalk now");
  ...
  public static int fdy()
  {
    AppMethodBeat.i(133682);
    if ((com.tencent.mm.compatible.util.d.lA(19)) || (com.tencent.mm.compatible.util.d.lB(16)))
    {
      AppMethodBeat.o(133682);
      return 1;
    }
    if (WebView.getInstalledTbsCoreVersion(ak.getContext()) > 0)
    {
      AppMethodBeat.o(133682);
      return 4;
    }
    ...
    boolean bool = ak.getContext().getSharedPreferences("com.tencent.mm_webview_x5_preferences", 4).getBoolean("tbs_download_oversea", false);
    ae.i("MicroMsg.TBSDownloadChecker", "oversea = %b", new Object[] { Boolean.valueOf(bool) });
    if (bool)
    {
      AppMethodBeat.o(133682);
      return 2;
    }
    ae.e("MicroMsg.TBSDownloadChecker", "WTF, how could it be?");
    AppMethodBeat.o(133682);
    return 0;
  }
  ...
  public static void fdz()
  {
    ...
    ((Intent)localObject).setClassName(ak.getPackageName(), "com.tencent.mm.sandbox.updater.UpdaterService");
    ...
    ae.i("MicroMsg.TBSDownloadChecker", "start UpdaterService to download tbs");
  ...
  public static void hx(Context paramContext)
  {
    ...
    ae.i("MicroMsg.TBSDownloadChecker", "webview start check tbs");
    ...
    ae.i("MicroMsg.TBSDownloadChecker", "user hasDownloadOverSea = %b", new Object[] { Boolean.valueOf(bool) });
    if (bool) {}
    for (int i = 2;; i = 1)
    {
      ...
      {
        ae.i("MicroMsg.TBSDownloadChecker", "tbsDownload switch is off, value = %s", new Object[] { localObject2 });
        AppMethodBeat.o(133678);
        return;
        if (k.fnT())
        {
          ae.i("MicroMsg.TBSDownloadChecker", "isGPVersion, ignore this request");
          AppMethodBeat.o(133678);
        }
      }
      else
      {
        com.tencent.xweb.x5.sdk.d.setUploadCode(ak.getContext(), 130);
        bool = az.isWifi(paramContext);
        ae.i("MicroMsg.TBSDownloadChecker", "check, tbsDownload = %s, isWifi = %b", new Object[] { localObject2, Boolean.valueOf(bool) });
        if (!bool)
        {
          ae.i("MicroMsg.TBSDownloadChecker", "check, net type is not wifi");
          com.tencent.xweb.x5.sdk.d.setUploadCode(ak.getContext(), 131);
          AppMethodBeat.o(133678);
          return;
        }
        if (localObject1 == null) {
          ae.e("MicroMsg.TBSDownloadChecker", "sp is null");
        }
        for (int j = 0;; j = 1)
        {
          if (j != 0) {
          ...
          ae.i("MicroMsg.TBSDownloadChecker", "check expired false, tbsCoreVersion = %d", new Object[] { Integer.valueOf(j) });
          if (j <= 0) {
            break label391;
          }
          com.tencent.xweb.x5.sdk.d.setUploadCode(ak.getContext(), 132);
          AppMethodBeat.o(133678);
          return;
        ...
        paramContext.setClassName(ak.getPackageName(), "com.tencent.mm.sandbox.updater.UpdaterService");
  ...
  public static void vN(boolean paramBoolean)
  {
    ...
    if (k.fnT())
    {
      ae.d("MicroMsg.TBSDownloadChecker", "preCheck isGPVersion, ignore this request");
      AppMethodBeat.o(182769);
      return;
    }
    if ((f.lF(ak.getContext())) && (WebView.getInstalledTbsCoreVersion(ak.getContext()) <= 0))
    {
      Intent localIntent = new Intent();
      localIntent.setClassName(ak.getPackageName(), "com.tencent.mm.sandbox.updater.UpdaterService");
