...
{
  Map<Integer, Set<u>> gVL;
  
  public e()
  {
    AppMethodBeat.i(151661);
    this.gVL = new HashMap();
    com.tencent.mm.kernel.g.afA().gcy.a(452, this);
  ...
  public static void a(int paramInt, aa paramaa)
  {
    ...
    com.tencent.mm.kernel.g.afA().gcy.a(paramaa, 0);
  ...
  public final void a(final int paramInt, final u paramu)
  {
    ...
    aq.f(new Runnable()
    {
      public final void run()
      {
        ...
        if (!e.this.gVL.containsKey(Integer.valueOf(paramInt))) {
          e.this.gVL.put(Integer.valueOf(paramInt), new HashSet());
        }
        if ((e.this.gVL.get(Integer.valueOf(paramInt)) != null) && (!((Set)e.this.gVL.get(Integer.valueOf(paramInt))).contains(paramu))) {
          ((Set)e.this.gVL.get(Integer.valueOf(paramInt))).add(paramu);
        }
  ...
  public final void b(final int paramInt, final u paramu)
  {
    ...
    aq.f(new Runnable()
    {
      public final void run()
      {
        ...
        if (e.this.gVL.get(Integer.valueOf(paramInt)) != null) {
          ((Set)e.this.gVL.get(Integer.valueOf(paramInt))).remove(paramu);
        }
  ...
  public final void onSceneEnd(int paramInt1, int paramInt2, String paramString, n paramn)
  {
    ...
    paramn = (ab)paramn;
    Set localSet = (Set)this.gVL.get(Integer.valueOf(paramn.BQg));
    if ((localSet != null) && (localSet.size() > 0))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localu != null) && (localSet.contains(localu))) {
          localu.a(paramInt1, paramInt2, paramString, paramn.BQh);
        }
      }
    }
    AppMethodBeat.o(151665);
