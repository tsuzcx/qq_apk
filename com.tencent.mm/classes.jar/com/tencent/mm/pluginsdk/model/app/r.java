...
public final class r
{
  private static void a(Context paramContext, final Intent paramIntent, final com.tencent.mm.pluginsdk.permission.a parama, boolean paramBoolean)
  {
    ...
    ae.i("MicroMsg.ApplicationUtil", "installApp");
    if ((paramBoolean) && (Build.BRAND.equals("vivo")))
    {
      paramIntent.putExtra("installDir", true);
      ae.i("MicroMsg.ApplicationUtil", "is vivo, try to prevent the interception");
    }
    try
    {
      if ((Build.VERSION.SDK_INT >= 26) && (!paramContext.getPackageManager().canRequestPackageInstalls()))
      {
        ae.i("MicroMsg.ApplicationUtil", "request install apk permission");
        b.a(new Intent("android.settings.MANAGE_UNKNOWN_APP_SOURCES", Uri.parse("package:" + paramContext.getPackageName())), ak.getContext().getString(2131761885), ak.getContext().getString(2131760344), new com.tencent.mm.pluginsdk.permission.d()
        {
          public final void PN(int paramAnonymousInt)
          {
            AppMethodBeat.i(151777);
            ae.i("MicroMsg.ApplicationUtil", "onRequestPermissionsResult, resultCode = %d", new Object[] { Integer.valueOf(paramAnonymousInt) });
            if (paramAnonymousInt == -1)
            {
              try
              {
                ...
                com.tencent.mm.hellhoundlib.a.a.a(localContext, ((com.tencent.mm.hellhoundlib.b.a)localObject).ahE(), "com/tencent/mm/pluginsdk/model/app/ApplicationUtil$1", "onRequestPermissionsResult", "(IILandroid/content/Intent;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
              ...
              catch (Exception localException)
              {
                for (;;)
                {
                  ae.printErrStackTrace("MicroMsg.ApplicationUtil", localException, "install app failed! %s", new Object[] { paramIntent });
                }
              }
            }
            else
            {
              ae.e("MicroMsg.ApplicationUtil", "no get!!!");
      ...
      ae.i("MicroMsg.ApplicationUtil", "install directly");
      com.tencent.mm.hellhoundlib.b.a locala = new com.tencent.mm.hellhoundlib.b.a().bc(paramIntent);
      com.tencent.mm.hellhoundlib.a.a.a(paramContext, locala.ahE(), "com/tencent/mm/pluginsdk/model/app/ApplicationUtil", "installApp", "(Landroid/content/Context;Landroid/content/Intent;Lcom/tencent/mm/pluginsdk/permission/InstallApkListener;Z)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
      paramContext.startActivity((Intent)locala.mt(0));
    ...
    catch (Exception paramContext)
    {
      for (;;)
      {
        ae.printErrStackTrace("MicroMsg.ApplicationUtil", paramContext, "install app failed! %s", new Object[] { paramIntent });
        if (parama != null) {
          parama.gn(false);
        }
      }
  ...
  protected static void a(Context paramContext, Uri paramUri, com.tencent.mm.pluginsdk.permission.a parama, boolean paramBoolean)
  {
    ...
    o.a(paramContext, localIntent, paramUri, "application/vnd.android.package-archive");
  ...
  protected static void a(Context paramContext, String paramString, com.tencent.mm.pluginsdk.permission.a parama, boolean paramBoolean)
  {
    ...
    Intent localIntent = new Intent("android.intent.action.VIEW");
    o.a(paramContext, localIntent, new k(paramString), "application/vnd.android.package-archive");
    localIntent.addFlags(268435456);
    a(paramContext, localIntent, parama, paramBoolean);
  ...
  public static String aNn(String paramString)
  {
    ...
    Object localObject = ak.getContext().getPackageManager();
    try
    {
    ...
    {
      ae.e("MicroMsg.ApplicationUtil", "get package name from archive file path, failed : %s", new Object[] { paramString.getMessage() });
      AppMethodBeat.o(151789);
      return null;
    }
    ae.i("MicroMsg.ApplicationUtil", "get package name from archive filepath  :%s, package name is : %s", new Object[] { paramString, ((PackageInfo)localObject).packageName });
    paramString = ((PackageInfo)localObject).packageName;
    AppMethodBeat.o(151789);
    return paramString;
  }
  
  public static int aNo(String paramString)
  {
    ...
    {
      ae.e("MicroMsg.ApplicationUtil", "get package version code from archive file path, failed : %s", new Object[] { paramString.getMessage() });
      AppMethodBeat.o(151790);
      return 0;
    }
    ae.i("MicroMsg.ApplicationUtil", "get package version code from archive filepath  :%s, package version code is : %d", new Object[] { paramString, Integer.valueOf(((PackageInfo)localObject).versionCode) });
  ...
  public static boolean bQ(Context paramContext, String paramString)
  {
    ...
    {
      ae.v("MicroMsg.ApplicationUtil", "installAppWithGP, gp is installed, url = %s", new Object[] { paramString });
    ...
    for (;;)
    {
      try
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramString.ahE(), "com/tencent/mm/pluginsdk/model/app/ApplicationUtil", "installAppWithGP", "(Landroid/content/Context;Ljava/lang/String;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
      ...
      {
        ae.e("MicroMsg.ApplicationUtil", "installAppWithGP first, ex = %s", new Object[] { paramString.getMessage() });
        try
        {
        ...
        {
          ae.e("MicroMsg.ApplicationUtil", "installAppWithGP second, ex = %s", new Object[] { paramContext.getMessage() });
          AppMethodBeat.o(151786);
        }
      }
      ae.v("MicroMsg.ApplicationUtil", "installAppWithGP, gp is not installed, url = %s", new Object[] { paramString });
    }
    return false;
  }
  ...
  private static PackageInfo getPackageInfo(Context paramContext, String paramString)
  {
    ...
    {
      ae.e("MicroMsg.ApplicationUtil", "getPackageInfo, packageName is null");
    ...
    catch (PackageManager.NameNotFoundException paramContext)
    {
      for (;;)
      {
        ae.w("MicroMsg.ApplicationUtil", "app not installed, packageName = ".concat(String.valueOf(paramString)));
