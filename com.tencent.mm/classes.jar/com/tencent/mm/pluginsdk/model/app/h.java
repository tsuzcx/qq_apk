...
public final class h
{
  ...
  public static List<g> a(Context paramContext, boolean paramBoolean, int paramInt)
  {
    ...
    localObject = a.a.fmG().G((int[])localObject);
    if (localObject != null)
    {
      while (((Cursor)localObject).moveToNext())
      {
        ...
        {
          if (u(paramContext, localg.field_appId))
          {
  ...
  public static void a(final String paramString1, final String paramString2, a parama)
  {
    ...
    com.tencent.e.h.ZvG.d(new Runnable()
    {
      public final void run()
      {
        ...
        localObject = h.dl(paramString1, true);
        this.QWi.a((g)localObject);
        AppMethodBeat.o(151679);
      }
  ...
  public static boolean a(final Context paramContext, final Intent paramIntent, String paramString, int paramInt, final al paramal, final Bundle paramBundle)
  {
    ...
    boolean bool = ((Boolean)e.ipM().ipR().a(new com.tencent.e.e.a() {}).ipQ()).booleanValue();
    AppMethodBeat.o(151723);
    return bool;
    label417:
  ...
  public static boolean a(Context paramContext, g paramg)
  {
    ...
    boolean bool = q.u(paramContext, paramg.field_packageName);
    AppMethodBeat.o(151702);
    return bool;
  }
  ...
  public static boolean a(Context paramContext, String paramString, WXMediaMessage paramWXMediaMessage, int paramInt, al paramal, Bundle paramBundle)
  {
    ...
    for (g localg = hn(paramString, 2147483647); localg == null; localg = dl(paramString, false))
    {
  ...
  public static boolean a(final Context paramContext, final String paramString1, final String paramString2, final ShowMessageFromWX.Req paramReq, int paramInt, final al paramal, final Bundle paramBundle)
  {
    ...
    if ((TextUtils.isEmpty(paramString1)) || (!q.u(paramContext, paramString1)))
    {
      ...
      com.tencent.e.h.ZvG.bc(new Runnable()
      {
        public final void run()
        {
          ...
          com.tencent.mm.ui.base.h.cO(this.val$context, this.val$context.getString(c.h.chatting_send_app_not_installed));
    ...
    if (paramBundle != null)
    {
      ...
      locala.bBl((String)localObject).bBp(paramContext.getString(c.h.launch_3rd_app_confirm)).bBq(paramContext.getString(c.h.app_cancel)).b(new f.c()
      {
        public final void g(boolean paramAnonymousBoolean, String paramAnonymousString)
        {
          AppMethodBeat.i(184259);
          com.tencent.mm.plugin.report.service.h.IzE.a(14102, new Object[] { Integer.valueOf(0), Integer.valueOf(1), "", Integer.valueOf(1), this.ack, paramReq, paramBundle, str1, str2 });
          if ("wx073f4a4daff0abe8".equalsIgnoreCase(paramString2)) {
            com.tencent.mm.plugin.report.service.h.IzE.a(15413, new Object[] { Integer.valueOf(2), "", "" });
          }
          local3.run();
      ...
      }).a(new f.c()
      {
        public final void g(boolean paramAnonymousBoolean, String paramAnonymousString)
        {
          ...
          com.tencent.mm.plugin.report.service.h.IzE.a(14102, new Object[] { Integer.valueOf(0), Integer.valueOf(0), "", Integer.valueOf(0), this.ack, paramReq, paramBundle, str1, str2 });
          if ("wx073f4a4daff0abe8".equalsIgnoreCase(paramString2)) {
            com.tencent.mm.plugin.report.service.h.IzE.a(15413, new Object[] { Integer.valueOf(3), "", "" });
          }
          if (paramal != null) {
            paramal.y(false, true);
          }
    ...
    for (;;)
    {
      ...
      break label323;
      label486:
      e.ipM().ipR().a(new com.tencent.e.e.a() {}).ipQ();
    }
  }
  ...
  public static boolean aQ(Context paramContext, int paramInt)
  {
    ...
    Long localLong = com.tencent.mm.pluginsdk.e.a.boU(String.valueOf(paramInt));
    if (localLong == null)
    {
      AppMethodBeat.o(151695);
      return false;
    }
    if (c(paramContext, localLong.longValue(), true).size() == 0)
    {
      AppMethodBeat.o(151695);
      return false;
    }
  ...
  public static g aTS(String paramString)
  {
  ...
  private static List<g> apJ(int paramInt)
  {
    ...
    Cursor localCursor = a.a.fmG().iL(1, paramInt);
    if (localCursor == null)
    {
      AppMethodBeat.o(189801);
      return localArrayList;
  ...
  public static int apK(int paramInt)
  {
    if (paramInt == 1) {
      return 19;
    }
  ...
  public static String b(Context paramContext, g paramg)
  {
    AppMethodBeat.i(292727);
    paramContext = a(paramContext, paramg, null);
  ...
  public static g bpS(String paramString)
  {
    AppMethodBeat.i(189757);
    paramString = o(paramString, false, false);
  ...
  private static void bpW(String paramString)
  {
    AppMethodBeat.i(151719);
    if ("wx073f4a4daff0abe8".equalsIgnoreCase(paramString)) {
      com.tencent.mm.plugin.report.service.h.IzE.a(15413, new Object[] { Integer.valueOf(1), "", "" });
    }
    AppMethodBeat.o(151719);
  }
  
  public static boolean bpX(String paramString)
  {
    ...
    try
    {
      ...
      if ((paramString.ifE()) && (paramString.ifC()))
      {
  ...
  public static boolean bpY(String paramString)
  {
    ...
    {
      if ((bpZ(paramString)) && (bpX(paramString)))
      {
        AppMethodBeat.o(189948);
        return true;
      }
    ...
    if ((Util.isFilePathSafeToBeCopySrc(paramString)) && (bpX(paramString)))
    {
      AppMethodBeat.o(189948);
      return true;
    }
  ...
  private static boolean bpZ(String paramString)
  {
  ...
  public static Bitmap c(String paramString, int paramInt, float paramFloat)
  {
    ...
    Bitmap localBitmap = a.a.fmG().a(paramString, paramInt, paramFloat);
    if (localBitmap == null)
    {
      Log.w("MicroMsg.AppInfoLogic", "getAppIcon, bm does not exist or has been recycled");
      a.a.fmG().fA(paramString, paramInt);
      AppMethodBeat.o(151692);
      return null;
    }
  ...
  public static ShowMessageFromWX.Req c(Context paramContext, WXMediaMessage paramWXMediaMessage, String paramString)
  {
    ...
    localReq.country = ((String)com.tencent.mm.kernel.h.aHG().aHp().b(274436, null));
  ...
  public static List<g> c(Context paramContext, long paramLong, boolean paramBoolean)
  {
    ...
    ArrayList localArrayList = new ArrayList();
    Object localObject1 = com.tencent.mm.plugin.ab.a.fmz();
    ...
    while (((Cursor)localObject1).moveToNext())
    {
      ...
      {
        if (u(paramContext, ((g)localObject2).field_appId))
        {
  ...
  public static g dl(String paramString, boolean paramBoolean)
  {
    ...
    com.tencent.mm.plugin.ab.a.a locala = a.a.fmG();
    if (locala == null)
    {
      Log.e("MicroMsg.AppInfoLogic", "getISubCorePluginBase() == null");
      AppMethodBeat.o(151688);
    ...
    if (paramBoolean)
    {
      paramString = locala.aTT(paramString);
      AppMethodBeat.o(151688);
      return paramString;
    }
    g localg = locala.aTS(paramString);
    if (localg == null)
    {
      paramString = locala.aTT(paramString);
      AppMethodBeat.o(151688);
  ...
  public static boolean ha(String paramString)
  {
    ...
    boolean bool = localg.Qv();
    AppMethodBeat.o(151709);
    return bool;
  }
  
  public static List<g> hhv()
  {
    ...
    Cursor localCursor = a.a.fmG().fmF();
    if (localCursor == null)
    {
      AppMethodBeat.o(151700);
      return localArrayList;
  ...
  public static g hn(String paramString, int paramInt)
  {
    ...
    g localg = a.a.fmG().aTS(paramString);
    if (a(localg, paramInt)) {
      a.a.fmG().aTV(paramString);
    }
    AppMethodBeat.o(151687);
    return localg;
  }
  ...
  public static List<g> jv(Context paramContext)
  {
    ...
    Cursor localCursor = a.a.fmG().fmD();
    if (localCursor == null)
    {
      AppMethodBeat.o(151696);
      return localArrayList;
  ...
  public static boolean p(g paramg)
  {
    ...
    while (1 == i)
    {
      paramg = z.PG(paramg.field_appId);
  ...
  public static String s(Context paramContext, String paramString, int paramInt)
  {
    AppMethodBeat.i(151704);
    paramContext = a(paramContext, hn(paramString, paramInt), null);
  ...
  public static boolean u(Context paramContext, long paramLong)
  {
    AppMethodBeat.i(151694);
    if (c(paramContext, paramLong, true).size() == 0)
    {
