...
public final class l
{
  ...
  {
    this(parame.aCt(), parame.hig(), parame.btD(), parame.getFilePath(), paramLong, paramString, 2, null, -1);
  ...
  {
    this(parame.aCt(), parame.hig(), parame.btD(), parame.getFilePath(), -1L, null, paramInt2, paramException, paramInt1);
  ...
  {
    this(paramk.aCt(), paramk.QYU, paramk.url, paramk.getFilePath(), paramLong, null, 2, null, -1);
  ...
  public final String toString()
  {
    ...
    String str = "NetworkResponse{urlKey='" + this.QYU + '\'' + ", url='" + this.url + '\'' + ", filePath='" + this.filePath + '\'' + ", contentLength=" + this.contentLength + ", contentType='" + this.contentType + '\'' + ", status=" + this.status + ", e=" + this.RaE + '}';
 ...
 * Qualified Name:     com.tencent.mm.pluginsdk.k.a.c.l
