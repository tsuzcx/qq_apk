  ...
  extends AppCompatActivity
{
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (this.scene == 2)
    {
      paramIntent = b.aLU(this.key);
      if (paramIntent != null) {
        paramIntent.Pg(paramInt2);
      }
      finish();
    ...
    if (this.scene == 3)
    {
      if (paramInt2 == -1)
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.a(this, paramIntent.ahp(), "com/tencent/mm/pluginsdk/permission/PermissionActivity", "onActivityResult", "(IILandroid/content/Intent;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
    ...
    if (this.scene == 4)
    {
      ...
      {
        boolean bool = com.tencent.mm.booter.c.bI(this);
        if (bool)
        {
          if (ax.aQz("service_launch_way").getBoolean("954_84_first", true))
          {
            e.ygI.idkeyStat(954L, 84L, 1L, false);
            ax.aQz("service_launch_way").edit().putBoolean("954_84_first", false);
          }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (this.scene == 1)
    {
      this.EOs = getIntent().getStringArrayExtra("permission");
      this.requestCode = getIntent().getIntExtra("requestCode", 0);
      if (!bt.V(this.EOs))
      {
        ad.i("MicroMsg.PermissionActivity", "scene: %d, permission: %s, requestCode: %d", new Object[] { Integer.valueOf(this.scene), this.EOs.toString(), Integer.valueOf(this.requestCode) });
        AppMethodBeat.o(151871);
      }
    }
    else if (this.scene == 2)
    {
      ...
      this.EOu = getIntent().getStringExtra("reasonTitle");
      this.EOv = getIntent().getStringExtra("reasonMsg");
      if ((!bt.isNullOrNil(this.EOu)) && (!bt.isNullOrNil(this.EOv)))
      {
        ad.i("MicroMsg.PermissionActivity", "scene: %d, reasonTitle: %s, reasonMsg: %s", new Object[] { Integer.valueOf(this.scene), this.EOu, this.EOv });
        AppMethodBeat.o(151871);
      }
    }
  ...
  public void onRequestPermissionsResult(int paramInt, String[] paramArrayOfString, int[] paramArrayOfInt)
  {
    ...
    if (this.scene == 1)
    {
      paramArrayOfString = b.aLT(this.key);
  ...
  public void onResume()
  {
    ...
    {
      if (this.scene == 1) {
        b.a(this, this.EOs, this.requestCode);
      }
      for (;;)
      {
        this.EOt = false;
        ...
        if (this.scene == 2)
        {
          if ((bt.isNullOrNil(this.EOv)) && (bt.isNullOrNil(this.EOu))) {
            try
            {
            ...
            h.a(this, false, this.EOv, this.EOu, getString(2131760598), getString(2131755691), new DialogInterface.OnClickListener()new DialogInterface.OnClickListener
            {
        ...
        else if (this.scene == 3)
        {
          ...
          if (Build.VERSION.SDK_INT >= 26)
          {
            ...
            else
            {
              ...
              com.tencent.mm.hellhoundlib.a.a.a(this, ((com.tencent.mm.hellhoundlib.b.a)localObject).ahp(), "com/tencent/mm/pluginsdk/permission/PermissionActivity", "onResume", "()V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
        ...
        {
          if (ax.aQz("service_launch_way").getBoolean("954_95_first", true))
          {
            e.ygI.idkeyStat(954L, 95L, 1L, false);
            ax.aQz("service_launch_way").edit().putBoolean("954_95_first", false);
          }
          e.ygI.idkeyStat(954L, 96L, 1L, false);
