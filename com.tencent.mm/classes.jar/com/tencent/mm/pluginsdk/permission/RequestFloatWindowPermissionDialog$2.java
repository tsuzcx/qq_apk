  ...
  public final void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    if (d.oD(23)) {
      try
      {
        ...
        {
          this.JYb.startActivityForResult(new Intent("android.settings.action.MANAGE_OVERLAY_PERMISSION", Uri.parse("package:" + MMApplicationContext.getPackageName())), RequestFloatWindowPermissionDialog.JXZ);
    ...
    paramDialogInterface = this.JYb.getString(2131760779);
    Intent localIntent = new Intent();
    localIntent.putExtra("rawUrl", paramDialogInterface);
    localIntent.putExtra("useJs", true);
    localIntent.putExtra("vertical_scroll", true);
    c.b(this.JYb, "webview", ".ui.tools.WebViewUI", localIntent);
    this.JYb.finish();
    AppMethodBeat.o(151878);
  }
}
