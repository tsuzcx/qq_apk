...
{
  private static p.a Flq;
  private static final Pattern Flr;
  private static int Fls;
  private static int Flt;
  private static int Flu;
  private static be iNz;
  ...
  static
  {
    ...
    Flq = null;
    iNz = null;
    Flr = Pattern.compile("data:(image|img)/\\S+;base64,\\S+");
    Fls = -1;
    Flt = -1;
    Flu = -1;
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, boolean paramBoolean, a parama)
  {
    ...
    if (iNz == null) {
      iNz = new be(1, "webview-save-image", 1);
    }
    iNz.c(new c(paramContext, paramString1, paramString2, paramBoolean, 1, parama));
  ...
  private static void a(b paramb)
  {
    ...
    aq.f(new Runnable()
    {
      public final void run()
      {
        ...
        this.Fly.cB("javascript:var edw_iframe = document.getElementById('_edw_iframe_');if (edw_iframe === null) {edw_iframe = document.createElement('iframe');edw_iframe.id = '_edw_iframe_';edw_iframe.style.display = 'none';document.documentElement.appendChild(edw_iframe);}");
  ...
  private static void a(final b paramb, final String paramString1, final String paramString2, boolean paramBoolean)
  {
    ...
    aq.f(new Runnable()
    {
      public final void run()
      {
        ...
        if (this.Flz)
        {
          paramb.cB("javascript:document.getElementById('_edw_iframe_').src = '" + paramString1 + "' + " + paramString2);
          AppMethodBeat.o(214013);
          return;
        }
        paramb.cB("javascript:console.log('" + paramString1 + "' + " + paramString2 + ")");
        AppMethodBeat.o(214013);
      }
    });
    AppMethodBeat.o(103165);
  ...
  public static void a(WebView paramWebView, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    a(new b()
    {
      public final void cB(String paramAnonymousString)
      {
        ...
        this.Flx.evaluateJavascript(paramAnonymousString, null);
  ...
  public static final String aNF(String paramString)
  {
  ...
  public static final String aNG(String paramString)
  {
  ...
  public static String aNH(String paramString)
  {
    ...
    if (!Flr.matcher(paramString).matches())
    {
      AppMethodBeat.o(103172);
      return null;
    }
  ...
  public static String aNK(String paramString)
  {
    ...
    paramString = String.format("preverify://url=%s", new Object[] { URLEncoder.encode(aHc(bt.nullAsNil(paramString))) });
  ...
  public static boolean aNM(String paramString)
  {
    ...
    {
      ad.e("MicroMsg.WebViewUtil", "create url fail : " + paramString.getLocalizedMessage());
      AppMethodBeat.o(214019);
      return false;
    }
    AppMethodBeat.o(214019);
  ...
  public static void b(Context paramContext, final String paramString1, final String paramString2, final boolean paramBoolean)
  {
    ...
    com.tencent.mm.platformtools.p.a(paramContext, new Runnable()new Runnable
    {
      public final void run()
      {
        ...
        x.ffx().c(new x.c(this.val$context, paramString1, paramString2, paramBoolean));
  ...
  public static final String bH(Map<String, Object> paramMap)
  {
  ...
  public static String bW(Context paramContext, String paramString)
  {
    ...
    paramContext = com.tencent.mm.plugin.appbrand.z.p.a(paramContext, paramString, (p.a)e.K(p.a.class));
  ...
  public static boolean ffu()
  {
    ...
    int i = ax.aQz("bizCommand").decodeInt("sameLayerOpen", -1);
    Fls = i;
    if (i != -1)
    {
      if (Fls == 1)
    ...
    Fls = ((com.tencent.mm.plugin.expt.b.b)g.ab(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.qtW, 0);
    ad.i("MicroMsg.WebViewUtil", "useSameLayerForVideo useSameLayer=%d", new Object[] { Integer.valueOf(Fls) });
    if (Fls == 1)
    {
      AppMethodBeat.o(214016);
      return true;
  ...
  public static boolean ffv()
  {
    ...
    Flt = ((com.tencent.mm.plugin.expt.b.b)g.ab(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.qtM, 1);
    ad.i("MicroMsg.WebViewUtil", "updateRandomStr updateRandomStr=%d", new Object[] { Integer.valueOf(Flt) });
    if (Flt == 1)
    {
      AppMethodBeat.o(214017);
      return true;
  ...
  public static boolean ffw()
  {
    ...
    if ((com.tencent.mm.sdk.platformtools.i.IS_FLAVOR_RED) || ((bu.flY()) && (1 > ad.getLogLevel())))
    {
      AppMethodBeat.o(214018);
      return true;
    }
    Flu = ((com.tencent.mm.plugin.expt.b.b)g.ab(com.tencent.mm.plugin.expt.b.b.class)).a(b.a.qtX, 0);
    ad.i("MicroMsg.WebViewUtil", "mpVideoShareToSns open=%d", new Object[] { Integer.valueOf(Flu) });
    if (Flu == 1)
    {
      AppMethodBeat.o(214018);
      return true;
  ...
  static final class c
    implements be.a
  {
    private static Pattern FlB;
    private static Pattern FlC;
    private String FlD;
    private String FlE;
    private x.a FlF;
    ...
    static
    {
      ...
      FlB = Pattern.compile("image/[A-Za-z0-9]+");
      FlC = Pattern.compile("filename=[A-Za-z0-9@.]+.[A-Za-z0-9]+");
    ...
    private void a(String paramString1, String paramString2, InputStream paramInputStream)
    {
      ...
      {
        paramString1 = FlB.matcher(paramString1);
      ...
      if (bt.isNullOrNil((String)localObject1))
      {
        ...
        {
          paramString2 = FlC.matcher(paramString2);
          paramString1 = (String)localObject1;
      ...
      {
        this.imagePath = aNN(paramString2);
        paramString1 = com.tencent.mm.vfs.i.cX(this.imagePath, false);
      ...
      try
      {
        ...
        if (this.opType == 0)
        {
          this.FlD = this.context.getString(2131757969, new Object[] { q.ffp() });
    ...
    private String aNN(String paramString)
    {
      AppMethodBeat.i(214014);
      this.imagePath = (q.ffo() + String.format(Locale.US, "mmexport%s.%s", new Object[] { ai.ee(this.hym), paramString }));
      if (com.tencent.mm.vfs.i.fv(this.imagePath)) {
        com.tencent.mm.vfs.i.deleteFile(this.imagePath);
      }
    ...
    private void ffy()
    {
      ...
      //   8: dup
      //   9: aload_0
      //   10: getfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      ...
      //   30: ldc 255
      //   32: aload_0
      //   33: getfield 65	com/tencent/mm/pluginsdk/ui/tools/x$c:FlE	Ljava/lang/String;
      ...
      //   106: aload_3
      //   107: aastore
      //   108: invokestatic 85	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   111: aload_3
      //   112: invokestatic 91	com/tencent/mm/sdk/platformtools/bt:isNullOrNil	(Ljava/lang/String;)Z
      //   115: ifne +23 -> 138
      //   118: aload_0
      //   119: aload_3
      //   120: putfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      //   123: aload_0
      //   124: invokespecial 277	com/tencent/mm/pluginsdk/ui/tools/x$c:ffy	()V
      //   127: aload_2
      //   128: aconst_null
      ...
      //   149: putfield 169	com/tencent/mm/pluginsdk/ui/tools/x$c:FlD	Ljava/lang/String;
      //   152: aload_2
      //   153: aconst_null
      ...
      //   221: aastore
      //   222: invokestatic 181	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   225: aload_3
      //   226: aload_2
    ...
    public final boolean aEm()
    {
      ...
      //   12: aload_0
      //   13: getfield 67	com/tencent/mm/pluginsdk/ui/tools/x$c:oSO	Z
      //   16: ifne +25 -> 41
      //   19: aload_0
      //   20: aload_0
      ...
      //   30: putfield 169	com/tencent/mm/pluginsdk/ui/tools/x$c:FlD	Ljava/lang/String;
      //   33: ldc_w 293
      //   36: invokestatic 51	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
      //   39: iconst_1
      //   40: ireturn
      //   41: aload_0
      //   42: getfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      ...
      //   58: ireturn
      //   59: aload_0
      //   60: getfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      //   63: invokestatic 299	android/webkit/URLUtil:isDataUrl	(Ljava/lang/String;)Z
      //   66: ifeq +357 -> 423
      //   69: ldc 125
      //   71: astore_2
      //   72: aload_0
      //   73: getfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      //   76: invokestatic 91	com/tencent/mm/sdk/platformtools/bt:isNullOrNil	(Ljava/lang/String;)Z
      //   79: ifne +16 -> 95
      //   82: aload_0
      //   83: getfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      //   86: ldc_w 301
      //   89: invokevirtual 304	java/lang/String:startsWith	(Ljava/lang/String;)Z
      //   92: ifne +19 -> 111
      //   95: aload_0
      //   96: getfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      //   99: ldc_w 301
      ...
      //   116: aload_0
      //   117: aload_2
      //   118: invokespecial 129	com/tencent/mm/pluginsdk/ui/tools/x$c:aNN	(Ljava/lang/String;)Ljava/lang/String;
      ...
      //   129: astore_2
      //   130: aload_0
      //   131: getfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      //   134: ldc_w 311
      ...
      //   151: aload_0
      //   152: aload_0
      //   153: getfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      //   156: iload_1
      //   157: bipush 7
      //   159: iadd
      //   160: invokevirtual 115	java/lang/String:substring	(I)Ljava/lang/String;
      //   163: putfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      //   166: aload 4
      //   168: astore_3
      //   169: aload 5
      //   171: astore_2
      ...
      //   176: iconst_0
      //   177: invokestatic 137	com/tencent/mm/vfs/i:cX	(Ljava/lang/String;Z)Ljava/io/OutputStream;
      //   180: astore 4
      //   182: aload 4
      //   184: astore_3
      //   185: aload 4
      //   187: astore_2
      //   188: aload_0
      //   189: getfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      //   192: iconst_0
      ...
      //   255: dup
      //   256: iconst_0
      //   257: invokestatic 161	com/tencent/mm/pluginsdk/ui/tools/q:ffp	()Ljava/lang/String;
      //   260: aastore
      //   261: invokevirtual 167	android/content/Context:getString	(I[Ljava/lang/Object;)Ljava/lang/String;
      //   264: putfield 169	com/tencent/mm/pluginsdk/ui/tools/x$c:FlD	Ljava/lang/String;
      //   267: aload 4
      //   269: astore_3
      //   270: aload 4
      //   272: astore_2
      ...
      //   318: aastore
      //   319: invokestatic 181	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   322: goto -28 -> 294
      //   325: astore 4
      //   327: aload_3
      //   328: astore_2
      ...
      //   345: aastore
      //   346: invokestatic 181	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   349: aload_3
      //   350: ifnull -56 -> 294
      //   353: aload_3
      ...
      //   376: aastore
      //   377: invokestatic 181	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   380: goto -86 -> 294
      //   383: astore_3
      //   384: aload_2
      //   385: ifnull +7 -> 392
      ...
      //   416: aastore
      //   417: invokestatic 181	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   420: goto -28 -> 392
      //   423: aload_0
      //   424: getfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      //   427: invokestatic 331	android/webkit/URLUtil:isHttpsUrl	(Ljava/lang/String;)Z
      //   430: ifeq +242 -> 672
      //   433: new 243	java/net/URL
      //   436: dup
      //   437: aload_0
      //   438: getfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      ...
      //   458: ldc 255
      //   460: aload_0
      //   461: getfield 65	com/tencent/mm/pluginsdk/ui/tools/x$c:FlE	Ljava/lang/String;
      ...
      //   534: aload_3
      //   535: aastore
      //   536: invokestatic 85	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   539: aload_3
      //   540: invokestatic 91	com/tencent/mm/sdk/platformtools/bt:isNullOrNil	(Ljava/lang/String;)Z
      //   543: ifne +20 -> 563
      //   546: aload_0
      //   547: aload_3
      //   548: putfield 63	com/tencent/mm/pluginsdk/ui/tools/x$c:hym	Ljava/lang/String;
      //   551: aload_0
      //   552: invokespecial 277	com/tencent/mm/pluginsdk/ui/tools/x$c:ffy	()V
      //   555: aload_2
      //   556: aconst_null
      ...
      //   574: putfield 169	com/tencent/mm/pluginsdk/ui/tools/x$c:FlD	Ljava/lang/String;
      //   577: aload_2
      //   578: aconst_null
      ...
      //   640: aastore
      //   641: invokestatic 181	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   644: aload_3
      //   645: aload_2
      ...
      //   671: athrow
      //   672: aload_0
      //   673: invokespecial 277	com/tencent/mm/pluginsdk/ui/tools/x$c:ffy	()V
      //   676: goto -382 -> 294
      //   679: astore 4
      //   681: aconst_null
      //   682: astore 5
    ...
    public final boolean aEn()
    {
      ...
      if (1 == this.opType)
      {
        this.FlF.Rq(this.imagePath);
        AppMethodBeat.o(103149);
        return true;
      }
      if (!bt.isNullOrNil(this.FlD)) {
        Toast.makeText(this.context, this.FlD, 1).show();
      }
      for (;;)
      {
        AppMethodBeat.o(103149);
