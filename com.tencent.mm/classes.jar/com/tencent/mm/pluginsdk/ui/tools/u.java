          ...
          if ((paramAnonymousInt1 > 0) && (paramAnonymousInt8 - paramAnonymousInt6 != paramAnonymousInt1)) {
            paramAnonymousView.post(new Runnable()
            {
              public final void run()
              {
                ...
                int i = (int)(j / 1.618D - (u.1.this.KwH.getHeight() >>> 1));
                if (i >= 0)
                {
                  if (u.KwG < 0) {
                    u.access$002(BackwardSupportUtil.BitmapFactory.fromDPToPix(paramAnonymousView.getContext(), 20.0F));
                  }
                  if (u.1.this.KwH.getHeight() + i + u.KwG <= j) {
                    break label192;
                  }
                  i -= u.1.this.KwH.getHeight() + i + u.KwG - j;
                }
                label192:
                for (;;)
                {
                  RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)u.1.this.KwH.getLayoutParams();
                  if ((i > 0) && (i != localLayoutParams.bottomMargin))
                  {
                    ...
                    u.1.this.KwH.setLayoutParams(localLayoutParams);
                  }
