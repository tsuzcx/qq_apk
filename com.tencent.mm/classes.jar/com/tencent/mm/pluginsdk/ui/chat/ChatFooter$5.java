  ...
  implements View.OnLongClickListener
{
  ...
  public final boolean onLongClick(View paramView)
  {
    ...
    b localb = new b();
    localb.bn(paramView);
    com.tencent.mm.hellhoundlib.a.a.c("com/tencent/mm/pluginsdk/ui/chat/ChatFooter$13", "android/view/View$OnLongClickListener", "onLongClick", "(Landroid/view/View;)Z", this, localb.aFi());
    paramView = ClipboardHelper.getText(this.val$context);
    h.IzE.p(1014L, 0L, 1L);
    com.tencent.mm.plugin.c.a.bBt();
    if (com.tencent.mm.plugin.c.a.K(paramView))
    {
      h.IzE.p(1014L, 1L, 1L);
      Log.i("MicroMsg.ChatFooter", "anti paste text %s", new Object[] { paramView });
