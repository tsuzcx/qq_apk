...
public final class f
{
  ...
  public static void YM(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 1L, 1L);
      AppMethodBeat.o(124840);
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 2L, 1L);
      AppMethodBeat.o(124840);
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 31L, 1L);
    }
  }
  ...
  public static void YN(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 14L, 1L);
      AppMethodBeat.o(124845);
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 40L, 1L);
    }
  }
  
  public static void aH(String paramString, int paramInt1, int paramInt2)
  {
    ...
    com.tencent.mm.plugin.report.service.g.yhR.f(17492, new Object[] { paramString, Integer.valueOf(2), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
    AppMethodBeat.o(124851);
  }
  
  public static void aMJ(String paramString)
  {
    AppMethodBeat.i(124843);
    g localg = g.EVk;
    int i = g.aMN(paramString);
    ...
    for (;;)
    {
      ...
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 11L, 1L);
      AppMethodBeat.o(124843);
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 47L, 1L);
      AppMethodBeat.o(124843);
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 43L, 1L);
    }
  }
  
  public static void aW(int paramInt, boolean paramBoolean)
  {
  ...
  public static void bP(String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      AppMethodBeat.o(124849);
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 18L, paramLong);
      AppMethodBeat.o(124849);
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 20L, paramLong);
      AppMethodBeat.o(124849);
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 37L, paramLong);
    }
  }
  ...
  public static void bQ(String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      AppMethodBeat.o(124850);
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 50L, paramLong);
      AppMethodBeat.o(124850);
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 21L, paramLong);
      AppMethodBeat.o(124850);
      return;
      com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 46L, paramLong);
    }
  }
  
  public static void cB(String paramString, boolean paramBoolean)
  {
  ...
  public static void fck()
  {
    ...
    com.tencent.mm.plugin.report.service.g.yhR.n(1111L, 0L, 1L);
    AppMethodBeat.o(124839);
  }
  
  public static void vM(boolean paramBoolean)
  {
