...
public final class f
{
  ...
  public static CharSequence A(Context paramContext, long paramLong)
  {
    ...
    if (!LocaleUtil.isSimplifiedChineseAppLang())
    {
      ...
      paramContext = z(paramContext, paramLong);
      AppMethodBeat.o(197251);
      return paramContext;
    }
    if (paramLong < 3600000L)
  ...
  public static String aR(Context paramContext, int paramInt)
  {
    ...
    {
      paramContext = x(paramContext, l2) + ";" + bX(paramContext.getString(c.h.fmt_normal_time), l1);
      AppMethodBeat.o(151900);
      return paramContext;
    }
    ...
    if ((l2 >= 0L) && (l2 < 86400000L))
    {
      paramContext = paramContext.getString(c.h.fmt_pre_yesterday) + " " + x(paramContext, l2) + ";" + bX(paramContext.getString(c.h.fmt_normal_time), l1);
      AppMethodBeat.o(151900);
      return paramContext;
    }
    ...
    if ((l2 >= 0L) && (l2 < 86400000L))
    {
      paramContext = paramContext.getString(c.h.fmt_pre_daybeforyesterday) + " " + x(paramContext, l2) + ";" + bX(paramContext.getString(c.h.fmt_normal_time), l1);
      AppMethodBeat.o(151900);
      return paramContext;
    }
    l2 = l1 - (((GregorianCalendar)localObject2).getTimeInMillis() + 86400000L);
    if ((l2 >= 0L) && (l2 < 86400000L))
    {
      paramContext = paramContext.getString(c.h.fmt_pre_tomorrow) + " " + x(paramContext, l2) + ";" + bX(paramContext.getString(c.h.fmt_normal_time), l1);
      AppMethodBeat.o(151900);
      return paramContext;
    }
    l2 = l1 - (((GregorianCalendar)localObject2).getTimeInMillis() + 172800000L);
    if ((l2 >= 0L) && (l2 < 86400000L))
    {
      paramContext = paramContext.getString(c.h.fmt_pre_dayaftertomorrow) + " " + x(paramContext, l2) + ";" + bX(paramContext.getString(c.h.fmt_normal_time), l1);
      AppMethodBeat.o(151900);
      return paramContext;
    }
    ...
    if ((((GregorianCalendar)localObject1).get(1) == ((GregorianCalendar)localObject2).get(1)) && (((GregorianCalendar)localObject1).get(3) == ((GregorianCalendar)localObject2).get(3)))
    {
      ...
      paramContext = aS(paramContext, i) + " " + aT(paramContext, paramInt) + ";" + bX(paramContext.getString(c.h.fmt_normal_time), l1);
      AppMethodBeat.o(151900);
      return paramContext;
    }
    if ((((GregorianCalendar)localObject1).get(1) == ((GregorianCalendar)localObject2).get(1)) && (((GregorianCalendar)localObject1).get(3) + 1 == ((GregorianCalendar)localObject2).get(3)))
    {
      ...
      for (;;)
      {
        paramContext = (String)localObject1 + " " + aT(paramContext, paramInt) + ";" + bX(paramContext.getString(c.h.fmt_normal_time), l1);
        AppMethodBeat.o(151900);
        return paramContext;
    ...
    {
      paramContext = android.text.format.DateFormat.format(paramContext.getString(c.h.fmt_date), l1) + " " + aT(paramContext, paramInt) + ";" + bX(paramContext.getString(c.h.fmt_normal_time), l1);
      AppMethodBeat.o(151900);
      return paramContext;
    }
    paramContext = android.text.format.DateFormat.format(paramContext.getString(c.h.fmt_longdate), l1) + " " + aT(paramContext, paramInt) + ";" + bX(paramContext.getString(c.h.fmt_normal_time), l1);
    AppMethodBeat.o(151900);
    return paramContext;
  }
  
  public static String aS(Context paramContext, int paramInt)
  {
  ...
  private static CharSequence aT(Context paramContext, int paramInt)
  {
  ...
  private static String apO(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  public static String bX(String paramString, long paramLong)
  {
  ...
  public static CharSequence d(Context paramContext, long paramLong, boolean paramBoolean)
  {
    ...
    if ((localTime.year == ((Time)localObject).year) && (localTime.yearDay == ((Time)localObject).yearDay))
    {
      ...
      paramContext = aT(paramContext, localTime.hour) + e.a(paramContext.getString(c.h.fmt_normal_time), localTime);
      AppMethodBeat.o(151908);
      return paramContext;
    }
    if ((localTime.year == ((Time)localObject).year) && (((Time)localObject).yearDay - localTime.yearDay == 1))
    {
      ...
      if (bool) {}
      for (paramContext = e.a(paramContext.getString(c.h.fmt_normal_time_24), localTime);; paramContext = aT(paramContext, localTime.hour) + e.a(paramContext.getString(c.h.fmt_normal_time), localTime))
      {
    ...
    if (localTime.year == ((Time)localObject).year)
    {
      ...
      paramContext = e.a(paramContext.getString(c.h.fmt_datetime, new Object[] { x(paramContext, localTime.hour * 3600000L) }).toString(), localTime);
      AppMethodBeat.o(151908);
      return paramContext;
    }
    if (paramBoolean)
    ...
    paramContext = e.a(paramContext.getString(c.h.fmt_longtime, new Object[] { x(paramContext, localTime.hour * 3600000L) }).toString(), localTime);
    AppMethodBeat.o(151908);
    return paramContext;
  }
  ...
  public static boolean hhY()
  {
    ...
    if (System.currentTimeMillis() - QYR > 30000L) {}
    try
    {
      QYS = android.text.format.DateFormat.is24HourFormat(MMApplicationContext.getContext());
      boolean bool = QYS;
  ...
  public static CharSequence w(Context paramContext, long paramLong)
  {
  ...
  public static CharSequence x(Context paramContext, long paramLong)
  {
  ...
  public static String y(Context paramContext, long paramLong)
  {
  ...
  private static String z(Context paramContext, long paramLong)
  {
    ...
    if (localGregorianCalendar1.get(1) == paramContext.get(1))
    {
      paramContext = apO(localGregorianCalendar1.get(2));
      AppMethodBeat.o(197244);
      return paramContext;
    }
