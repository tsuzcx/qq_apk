  ...
  extends a
{
  ...
  public u(String paramString)
  {
    ...
    for (;;)
    {
      this.cQA = t("FileId", paramString[0], true);
      this.cST = t("FileAesKey", paramString[1], true);
      ...
      this.cPD = t("ChatName", paramString[14], true);
      this.cPE = bo.getLong(paramString[15], 0L);
      ...
      this.cQN = t("CDNIp", paramString[34], true);
      this.cTw = bo.getLong(paramString[35], 0L);
      this.cTx = bo.getLong(paramString[36], 0L);
      this.cTy = bo.getLong(paramString[37], 0L);
      this.cTz = bo.getInt(paramString[38], 0);
      this.cTA = t("XClientIp", paramString[39], true);
      this.cTB = bo.getInt(paramString[40], 0);
      this.cTC = bo.getLong(paramString[41], 0L);
      this.cQP = bo.getLong(paramString[42], 0L);
      this.cQQ = bo.getLong(paramString[43], 0L);
  ...
  public final String Fg()
  {
    ...
    ((StringBuffer)localObject).append("\r\n");
    ((StringBuffer)localObject).append("FileAesKey:").append(this.cST);
    ((StringBuffer)localObject).append("\r\n");
    ...
    ((StringBuffer)localObject).append("\r\n");
    ((StringBuffer)localObject).append("MessageCreateTime:").append(this.cTw);
    ((StringBuffer)localObject).append("\r\n");
    ((StringBuffer)localObject).append("NewMsgId:").append(this.cTx);
    ((StringBuffer)localObject).append("\r\n");
    ((StringBuffer)localObject).append("InitialDownloadLength:").append(this.cTy);
    ((StringBuffer)localObject).append("\r\n");
    ((StringBuffer)localObject).append("VideoFormat:").append(this.cTz);
    ((StringBuffer)localObject).append("\r\n");
