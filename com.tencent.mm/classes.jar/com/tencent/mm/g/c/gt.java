  ...
  extends c
{
  ...
  private static final int fzT = "fakePk".hashCode();
  ...
  static
  {
    ...
    flk = "tips".hashCode();
    fzH = "forbid_title".hashCode();
    fzI = "forbid_url".hashCode();
    fzJ = "no_micro_word".hashCode();
    fzK = "card_bottom_wording".hashCode();
    fzL = "support_lqt_turn_in".hashCode();
    fzM = "support_lqt_turn_out".hashCode();
    fzN = "is_hightlight_pre_arrive_time_wording".hashCode();
    fzO = "card_state_name".hashCode();
    fzP = "prompt_info_prompt_text".hashCode();
    fzQ = "prompt_info_jump_text".hashCode();
    fzR = "prompt_info_jump_url".hashCode();
  }
