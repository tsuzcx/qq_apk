  ...
  extends c
{
  ...
  private static final int fxT = "fakePk".hashCode();
  ...
  static
  {
    ...
    fjn = "tips".hashCode();
    fxH = "forbid_title".hashCode();
    fxI = "forbid_url".hashCode();
    fxJ = "no_micro_word".hashCode();
    fxK = "card_bottom_wording".hashCode();
    fxL = "support_lqt_turn_in".hashCode();
    fxM = "support_lqt_turn_out".hashCode();
    fxN = "is_hightlight_pre_arrive_time_wording".hashCode();
    fxO = "card_state_name".hashCode();
    fxP = "prompt_info_prompt_text".hashCode();
    fxQ = "prompt_info_jump_text".hashCode();
    fxR = "prompt_info_jump_url".hashCode();
  }
