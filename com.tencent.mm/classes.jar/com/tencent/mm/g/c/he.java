  ...
  extends IAutoDBItem
{
  ...
  private static final int geL = "fakePk".hashCode();
  private static final int gea;
  private static final int geb;
  private static final int gec;
  private static final int ged;
  ...
  static
  {
    gdV = "bindSerial".hashCode();
    gdW = "cardType".hashCode();
    gdX = "bankcardState".hashCode();
    gdY = "forbidWord".hashCode();
    gdZ = "bankName".hashCode();
    gea = "bankcardType".hashCode();
    geb = "bankcardTypeName".hashCode();
    gec = "bankcardTag".hashCode();
    ged = "bankcardTail".hashCode();
    gee = "supportTag".hashCode();
    gef = "mobile".hashCode();
    geg = "trueName".hashCode();
    fyW = "desc".hashCode();
    ...
    geA = "forbid_url".hashCode();
    geB = "no_micro_word".hashCode();
    geC = "card_bottom_wording".hashCode();
    geD = "support_lqt_turn_in".hashCode();
    geE = "support_lqt_turn_out".hashCode();
    geF = "is_hightlight_pre_arrive_time_wording".hashCode();
    geG = "card_state_name".hashCode();
    geH = "prompt_info_prompt_text".hashCode();
    geI = "prompt_info_jump_text".hashCode();
    geJ = "prompt_info_jump_url".hashCode();
  }
