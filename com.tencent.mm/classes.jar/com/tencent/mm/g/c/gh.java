  ...
  extends c
{
  ...
  private static final int feV = "bindSerial".hashCode();
  private static final int feW = "cardType".hashCode();
  private static final int feX = "bankcardState".hashCode();
  private static final int feY = "forbidWord".hashCode();
  private static final int feZ = "bankName".hashCode();
  private static final int ffA = "forbid_url".hashCode();
  private static final int ffB = "no_micro_word".hashCode();
  private static final int ffC = "card_bottom_wording".hashCode();
  private static final int ffD = "support_lqt_turn_in".hashCode();
  private static final int ffE = "support_lqt_turn_out".hashCode();
  private static final int ffF = "is_hightlight_pre_arrive_time_wording".hashCode();
  private static final int ffG = "card_state_name".hashCode();
  private static final int ffH = "prompt_info_prompt_text".hashCode();
  private static final int ffI = "prompt_info_jump_text".hashCode();
  private static final int ffJ = "prompt_info_jump_url".hashCode();
  private static final int ffa = "bankcardType".hashCode();
  private static final int ffb = "bankcardTypeName".hashCode();
  private static final int ffc = "bankcardTag".hashCode();
  private static final int ffd = "bankcardTail".hashCode();
  private static final int ffe = "supportTag".hashCode();
  private static final int fff = "mobile".hashCode();
  private static final int ffg = "trueName".hashCode();
