...
public final class b$q
{
  ...
  private b$q(String paramString)
  {
    ...
    this.iJx = paramString;
    this.iJy = b.LL(paramString);
    AppMethodBeat.o(204414);
  }
  ...
  final InputStream D(final Map<String, String> paramMap)
  {
    ...
    //   5: aload_0
    //   6: getfield 38	com/tencent/mm/modelappbrand/a/b$q:iJx	Ljava/lang/String;
    //   9: ldc 113
    //   11: invokevirtual 117	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   14: ifne +15 -> 29
    //   17: aload_0
    //   18: getfield 38	com/tencent/mm/modelappbrand/a/b$q:iJx	Ljava/lang/String;
    //   21: ldc 119
    //   23: invokevirtual 117	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   26: ifeq +45 -> 71
    //   29: aload_0
    //   30: getfield 38	com/tencent/mm/modelappbrand/a/b$q:iJx	Ljava/lang/String;
    //   33: invokestatic 125	com/tencent/mm/vfs/s:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   36: astore_1
    //   37: ldc 111
    ...
    //   55: iconst_0
    //   56: aload_0
    //   57: getfield 38	com/tencent/mm/modelappbrand/a/b$q:iJx	Ljava/lang/String;
    //   60: aastore
    //   61: invokestatic 131	com/tencent/mm/sdk/platformtools/Log:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   64: ldc 111
    ...
    //   74: dup
    //   75: aload_0
    //   76: getfield 38	com/tencent/mm/modelappbrand/a/b$q:iJx	Ljava/lang/String;
    ...
    //   89: aload_3
    //   90: aload_1
    //   91: invokestatic 140	com/tencent/mm/modelappbrand/a/b$q:a	(Ljava/net/HttpURLConnection;Ljava/util/Map;)V
    //   94: aload_3
    ...
    //   159: iconst_0
    //   160: aload_0
    //   161: getfield 38	com/tencent/mm/modelappbrand/a/b$q:iJx	Ljava/lang/String;
    //   164: aastore
    //   165: dup
    //   166: iconst_1
    //   167: aload_2
    ...
    //   220: aload_2
    //   221: aload_1
    //   222: invokestatic 140	com/tencent/mm/modelappbrand/a/b$q:a	(Ljava/net/HttpURLConnection;Ljava/util/Map;)V
    //   225: new 189	com/tencent/mm/plugin/appbrand/ac/i
    //   228: dup
    //   229: aload_2
    //   230: invokespecial 192	com/tencent/mm/plugin/appbrand/ac/i:<init>	(Ljava/lang/Object;)V
    //   233: astore_1
    //   234: new 9	com/tencent/mm/modelappbrand/a/b$q$1
    //   237: dup
    //   238: aload_0
    //   239: aload_2
    //   240: invokevirtual 153	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   243: aload_1
    //   244: invokespecial 195	com/tencent/mm/modelappbrand/a/b$q$1:<init>	(Lcom/tencent/mm/modelappbrand/a/b$q;Ljava/io/InputStream;Lcom/tencent/mm/plugin/appbrand/ac/i;)V
    //   247: astore_1
    //   248: ldc 111
