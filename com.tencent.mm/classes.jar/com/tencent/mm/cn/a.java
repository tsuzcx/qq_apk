...
public final class a
{
  ...
  public static String aMv(String paramString)
  {
    ...
    paramString = b.aip() + String.format("%s%d.%s", new Object[] { "wx_photo_edit_", Long.valueOf(System.currentTimeMillis()), paramString });
  ...
  public static int bP(float paramFloat)
  {
