  ...
  extends BroadcastReceiver
{
  ...
  c(Context paramContext)
  {
    ...
    this.Vaq = new a("charging", Boolean.valueOf(bool1));
    this.Var = new a("interactive", Boolean.valueOf(((PowerManager)paramContext.getSystemService("power")).isScreenOn()));
  ...
  public final void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      i = 3;
      break;
      this.Var.set(Boolean.TRUE);
      paramContext = this.Var;
      continue;
      this.Var.set(Boolean.FALSE);
      paramContext = this.Var;
      continue;
      this.Vaq.set(Boolean.TRUE);
      paramContext = this.Vaq;
      continue;
      this.Vaq.set(Boolean.FALSE);
      paramContext = this.Vaq;
    }
  }
}
