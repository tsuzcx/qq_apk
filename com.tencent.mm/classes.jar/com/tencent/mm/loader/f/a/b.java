...
public final class b
  extends com.tencent.threadpool.b
  implements a
{
  private boolean isPaused;
  private ReentrantLock nrS = new ReentrantLock();
  private Condition nrT = this.nrS.newCondition();
  ...
  public final void beforeExecute(java.lang.Thread paramThread, Runnable paramRunnable)
  {
    ...
    //   1: aload_1
    //   2: aload_2
    //   3: invokespecial 43	com/tencent/threadpool/b:beforeExecute	(Ljava/lang/Thread;Ljava/lang/Runnable;)V
    //   6: aload_0
    //   7: getfield 26	com/tencent/mm/loader/f/a/b:nrS	Ljava/util/concurrent/locks/ReentrantLock;
    //   10: invokevirtual 46	java/util/concurrent/locks/ReentrantLock:lock	()V
    //   13: aload_0
    //   14: getfield 48	com/tencent/mm/loader/f/a/b:isPaused	Z
    //   17: ifeq +46 -> 63
    //   20: aload_0
    //   21: getfield 32	com/tencent/mm/loader/f/a/b:nrT	Ljava/util/concurrent/locks/Condition;
    ...
    //   51: aastore
    //   52: invokestatic 74	com/tencent/mm/sdk/platformtools/Log:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   55: aload_0
    //   56: getfield 26	com/tencent/mm/loader/f/a/b:nrS	Ljava/util/concurrent/locks/ReentrantLock;
    //   59: invokevirtual 77	java/util/concurrent/locks/ReentrantLock:unlock	()V
    //   62: return
    //   63: aload_0
    //   64: getfield 26	com/tencent/mm/loader/f/a/b:nrS	Ljava/util/concurrent/locks/ReentrantLock;
    //   67: invokevirtual 77	java/util/concurrent/locks/ReentrantLock:unlock	()V
    //   70: return
    //   71: astore_1
    //   72: aload_0
    //   73: getfield 26	com/tencent/mm/loader/f/a/b:nrS	Ljava/util/concurrent/locks/ReentrantLock;
 ...
 * Qualified Name:     com.tencent.mm.loader.f.a.b
