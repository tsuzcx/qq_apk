...
public final class ab
{
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong, int paramInt5, String paramString)
  {
    ...
    int i;
    int j;
    if ((kn(paramInt1, paramInt2)) || (ko(paramInt1, paramInt2)) || (kp(paramInt1, paramInt2)) || (adN(paramInt1)) || (kq(paramInt1, paramInt2)))
    {
      ac.i("MicroMsg.WalletReportUtil", "reportIDKeyWalletPay the cmdType is for idkey report cmdType:" + paramInt1 + " cmdid:" + paramInt2);
      i = -1;
      if (paramInt5 != 4) {
        break label394;
      }
      ...
      if (i == -1)
      {
        ac.e("MicroMsg.WalletReportUtil", "reportIDKeyWalletPay get ID by scene is -1, the scene is ".concat(String.valueOf(paramInt5)));
        paramInt5 = -1;
        j = paramInt5;
        if (paramInt1 == 385)
        {
      ...
      if (j == -1)
      {
        ac.e("MicroMsg.WalletReportUtil", "reportIDKeyWalletPay the cmdType is for idkey report cmdType:" + paramInt1 + " cmdid:" + paramInt2 + " , ID is -1");
        paramInt5 = -1;
    ...
    for (;;)
    {
      ...
      ac.e("MicroMsg.WalletReportUtil", "reportIDKeyWalletPay the processName is for idkey report processName:" + paramString + " , ID is -1");
    ...
    if (kn(paramInt1, paramInt2))
    {
      ...
      h.wUl.b((ArrayList)localObject1, true);
      localObject1 = new ArrayList();
      if ((paramInt3 != 0) || (paramInt4 != 0))
      {
  ...
  private static boolean adN(int paramInt)
  {
    return (paramInt == 1581) || (paramInt == 1685);
  }
  
  public static void e(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        paramString3 = (String)localObject3;
        ac.e("MicroMsg.WalletReportUtil", "", new Object[] { localException1 });
        localObject5 = localObject4;
        localObject6 = paramString3;
        h.wUl.f(10756, new Object[] { paramString1, paramString2, localObject5, localObject6, Integer.valueOf(paramInt), paramString4 });
        AppMethodBeat.o(72808);
        return;
      }
      try
  ...
  public static int fAr()
  {
    ...
    int i = (int)((System.currentTimeMillis() - JFA) / 1000L);
  ...
  public static void km(int paramInt1, int paramInt2)
  {
    ...
    h.wUl.f(12097, new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(System.currentTimeMillis()) });
    AppMethodBeat.o(72809);
  }
  
  private static boolean kn(int paramInt1, int paramInt2)
  {
  ...
  private static boolean kq(int paramInt1, int paramInt2)
  {
