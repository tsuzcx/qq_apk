...
public final class ab
{
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong, int paramInt5, String paramString)
  {
    ...
    int i;
    int j;
    if ((kC(paramInt1, paramInt2)) || (kD(paramInt1, paramInt2)) || (kE(paramInt1, paramInt2)) || (agn(paramInt1)) || (kF(paramInt1, paramInt2)))
    {
    ...
    if (kC(paramInt1, paramInt2))
    {
      ...
      g.yhR.b((ArrayList)localObject1, true);
      localObject1 = new ArrayList();
      if ((paramInt3 != 0) || (paramInt4 != 0))
      {
  ...
  private static boolean agn(int paramInt)
  {
  ...
  public static void e(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        g.yhR.f(10756, new Object[] { paramString1, paramString2, localObject5, localObject6, Integer.valueOf(paramInt), paramString4 });
        AppMethodBeat.o(72808);
        return;
      }
      try
  ...
  public static int fRB()
  {
    ...
    int i = (int)((System.currentTimeMillis() - LyE) / 1000L);
    AppMethodBeat.o(72807);
    return i;
  }
  
  public static void kB(int paramInt1, int paramInt2)
  {
    AppMethodBeat.i(72809);
    g.yhR.f(12097, new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(System.currentTimeMillis()) });
  ...
  private static boolean kE(int paramInt1, int paramInt2)
  {
  ...
  private static boolean kF(int paramInt1, int paramInt2)
  {
