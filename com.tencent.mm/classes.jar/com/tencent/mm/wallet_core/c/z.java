...
public final class z
{
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong, int paramInt5, String paramString)
  {
    ...
    int i;
    int j;
    if ((ie(paramInt1, paramInt2)) || (jdMethod_if(paramInt1, paramInt2)) || (ig(paramInt1, paramInt2)) || (RU(paramInt1)) || (ih(paramInt1, paramInt2)))
    {
    ...
    if (ie(paramInt1, paramInt2))
    {
      ...
      h.qsU.b((ArrayList)localObject1, true);
      localObject1 = new ArrayList();
      if ((paramInt3 != 0) || (paramInt4 != 0))
      {
    ...
    for (;;)
    {
      ...
      AppMethodBeat.o(49091);
      return;
      if (jdMethod_if(paramInt1, paramInt2))
      {
  ...
  public static void d(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        paramString3 = (String)localObject3;
        ab.e("MicroMsg.WalletReportUtil", "", new Object[] { localException1 });
        localObject5 = localObject4;
        localObject6 = paramString3;
        h.qsU.e(10756, new Object[] { paramString1, paramString2, localObject5, localObject6, Integer.valueOf(paramInt), paramString4 });
        AppMethodBeat.o(49089);
        return;
      }
      try
  ...
  public static int dSu()
  {
    ...
    int i = (int)((System.currentTimeMillis() - AXl) / 1000L);
  ...
  public static void id(int paramInt1, int paramInt2)
  {
    ...
    h.qsU.e(12097, new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(System.currentTimeMillis()) });
    AppMethodBeat.o(49090);
  }
  
  private static boolean ie(int paramInt1, int paramInt2)
  {
    return (paramInt1 == 385) && (paramInt2 == 112);
  }
  
  private static boolean jdMethod_if(int paramInt1, int paramInt2)
  {
    return (paramInt1 == 385) && ((paramInt2 == 0) || (paramInt2 == 1) || (paramInt2 == 16));
  }
  
  private static boolean ig(int paramInt1, int paramInt2)
  {
  ...
  private static boolean ih(int paramInt1, int paramInt2)
  {
