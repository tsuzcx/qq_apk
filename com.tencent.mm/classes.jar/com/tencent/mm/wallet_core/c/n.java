  ...
  extends w
{
  ...
  public n(String paramString1, String paramString2)
  {
    ...
    ((b.a)localObject).hNM = new si();
    ((b.a)localObject).hNN = new sj();
    ((b.a)localObject).uri = "/cgi-bin/mmpay-bin/cancelqrpay";
    ((b.a)localObject).funcId = 410;
    ((b.a)localObject).hNO = 198;
    ((b.a)localObject).respCmdId = 1000000198;
    ((b.a)localObject).routeInfo = com.tencent.mm.wallet_core.ui.e.aYP(paramString2);
    this.rr = ((b.a)localObject).aDC();
    localObject = (si)this.rr.hNK.hNQ;
    ((si)localObject).FOZ = paramString1;
    ((si)localObject).FyM = paramString2;
    ((si)localObject).FPa = k.eFo();
