  ...
  extends t
{
  ...
  private i(Context paramContext, int paramInt)
  {
    ...
    if (this.mContentView == null)
    {
      ...
      this.mContentView = View.inflate(this.mContext, paramInt, null);
      this.UWd = ((TextView)this.mContentView.findViewById(a.f.mm_progress_dialog_msg));
      this.ros = ((ProgressBar)this.mContentView.findViewById(a.f.mm_progress_dialog_icon));
  ...
  public static Dialog a(Context paramContext, String paramString, DialogInterface.OnCancelListener paramOnCancelListener)
  {
    ...
    paramContext = new com.tencent.mm.ui.base.i(paramContext, a.j.WalletProgressDialogStyle);
  ...
  public static Dialog c(Context paramContext, CharSequence paramCharSequence, boolean paramBoolean, DialogInterface.OnCancelListener paramOnCancelListener)
  {
    ...
    paramContext = new i(paramContext, a.j.mmalertdialog);
  ...
  public static Dialog c(Context paramContext, boolean paramBoolean, DialogInterface.OnCancelListener paramOnCancelListener)
  {
    ...
    paramContext = h.a(paramContext, paramContext.getString(a.i.wallet_pay_loading), paramBoolean, paramOnCancelListener);
  ...
  private static void h(Context paramContext, View paramView)
  {
    ...
    float f1 = com.tencent.mm.ci.a.ez(paramContext);
    if (f1 > 1.4F) {
      f1 = 1.4F;
    }
    for (;;)
    {
      float f4 = com.tencent.mm.ci.a.fromDPToPix(paramContext, 8.0F);
      ...
      float f6 = com.tencent.mm.cj.a.hrd();
      if ((f5 - f2) * f6 / 2.0F < f4)
      {
