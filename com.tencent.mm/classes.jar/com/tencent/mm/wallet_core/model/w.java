  ...
  implements m
{
  ...
  private long reportCostTime(int paramInt1, int paramInt2)
  {
    ...
    h.OAn.b(11170, new Object[] { Integer.valueOf(getType()), Integer.valueOf(this.mCmdId), Long.valueOf(l1), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(NetStatusUtil.getNetType(MMApplicationContext.getContext())), this.mProcessName, localObject2, localObject1, Long.valueOf(this.sessionId), Long.valueOf(l2) });
    ac.a(getType(), getCgicmdForKV(), paramInt1, paramInt2, l1, this.mScene, this.mProcessName);
    return l1;
  }
  ...
  public int dispatch(com.tencent.mm.network.g paramg, s params, m paramm)
  {
    ...
    c.gxP().An(false);
    com.tencent.mm.wallet_core.ui.g.aGt(params.getType());
 ...
 * Qualified Name:     com.tencent.mm.wallet_core.model.w
