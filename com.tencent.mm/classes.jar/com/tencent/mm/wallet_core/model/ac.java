...
public final class ac
{
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong, int paramInt5, String paramString)
  {
    ...
    int i;
    int j;
    if ((pv(paramInt1, paramInt2)) || (pw(paramInt1, paramInt2)) || (px(paramInt1, paramInt2)) || (aGr(paramInt1)) || (py(paramInt1, paramInt2)))
    {
    ...
    if (pv(paramInt1, paramInt2))
    {
      ...
      h.OAn.b((ArrayList)localObject1, true);
      localObject1 = new ArrayList();
      if ((paramInt3 != 0) || (paramInt4 != 0))
      {
  ...
  private static boolean aGr(int paramInt)
  {
  ...
  public static void e(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        h.OAn.b(10756, new Object[] { paramString1, paramString2, localObject5, localObject6, Integer.valueOf(paramInt), paramString4 });
        AppMethodBeat.o(72808);
        return;
      }
      try
  ...
  public static void jOR()
  {
    AppMethodBeat.i(72806);
    agTC = System.currentTimeMillis();
    AppMethodBeat.o(72806);
  }
  
  public static int jOS()
  {
    AppMethodBeat.i(72807);
    int i = (int)((System.currentTimeMillis() - agTC) / 1000L);
    AppMethodBeat.o(72807);
    return i;
  }
  
  public static void pu(int paramInt1, int paramInt2)
  {
    AppMethodBeat.i(72809);
    h.OAn.b(12097, new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(System.currentTimeMillis()) });
    AppMethodBeat.o(72809);
  }
  
  private static boolean pv(int paramInt1, int paramInt2)
  {
    return (paramInt1 == 385) && (paramInt2 == 112);
  }
  
  private static boolean pw(int paramInt1, int paramInt2)
  {
    return (paramInt1 == 385) && ((paramInt2 == 0) || (paramInt2 == 1) || (paramInt2 == 16));
  }
  
  private static boolean px(int paramInt1, int paramInt2)
  {
  ...
  private static boolean py(int paramInt1, int paramInt2)
  {
 ...
 * Qualified Name:     com.tencent.mm.wallet_core.model.ac
