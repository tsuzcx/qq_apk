...
public final class c
{
  ...
  private void aMn()
  {
    ...
    this.jtk = this.ieT.dequeueOutputBuffer(this.bufferInfo, 600L);
    Log.v("MicroMsg.MediaCodecTransCodeEncoder", "outputBufferIndex-->" + this.jtk);
    if (this.jtk == -1)
    {
      Log.d("MicroMsg.MediaCodecTransCodeEncoder", "no output from encoder available, break encoderEndStream %s", new Object[] { Boolean.valueOf(this.jtl) });
      if (!this.jtl) {}
    }
    label245:
    do
    {
      for (;;)
      {
        this.jtk = this.ieT.dequeueOutputBuffer(this.bufferInfo, 600L);
        if (this.jtk <= 0) {
          Log.v("MicroMsg.MediaCodecTransCodeEncoder", "get outputBufferIndex %d", new Object[] { Integer.valueOf(this.jtk) });
        }
    ...
    Log.w("MicroMsg.MediaCodecTransCodeEncoder", "do stop encoder, frameCount: %s, writeFrameCount: %s", new Object[] { Integer.valueOf(this.frameCount), Integer.valueOf(this.jti) });
    try
    {
      this.ieT.stop();
      this.ieT.release();
  ...
  private void b(byte[] paramArrayOfByte, boolean paramBoolean, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.ieT != null)
        {
          int j = this.ieT.dequeueInputBuffer(600L);
          this.jtj = j;
          if ((j < 0) && (i < 10))
          {
        ...
        Log.v("MicroMsg.MediaCodecTransCodeEncoder", "inputBufferIndex: %s", new Object[] { Integer.valueOf(this.jtj) });
        ...
        if (this.jtj >= 0)
        {
          if ((this.isStart) && (!paramBoolean) && (paramArrayOfByte != null))
          {
            ...
            ByteBuffer localByteBuffer = this.btv[this.jtj];
            localByteBuffer.clear();
            localByteBuffer.put(paramArrayOfByte);
            localByteBuffer.position(0);
            this.ieT.a(this.jtj, paramArrayOfByte.length, paramLong, 0);
            aMn();
          ...
          this.jtl = true;
          this.ieT.a(this.jtj, 0, paramLong, 4);
          this.dyL = true;
          continue;
        }
  ...
  private int bhL()
  {
    ...
    for (this.jtn = 2;; this.jtn = 1)
    {
      ...
      this.ieT = z.Eb(localMediaCodecInfo.getName());
  ...
  private void i(ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    ...
    if ((paramByteBuffer != null) && (paramBufferInfo != null) && (this.jth != null)) {
      this.jth.a(this.bufId, paramByteBuffer, paramBufferInfo.size);
    }
  ...
  public final void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean, long paramLong, int paramInt5)
  {
    ...
    if ((!paramBoolean) && (paramArrayOfByte != null))
    {
      ...
      {
        paramBoolean = false;
        Log.d("MicroMsg.MediaCodecTransCodeEncoder", "writeData, needScale: %s, srcSize: [%s, %s] [%s, %s], targetSize: [%s, %s], pts: %s, srcColorFormat: %s, dstColorFormat: %s, data.size:%s", new Object[] { Boolean.valueOf(paramBoolean), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), Integer.valueOf(paramInt4), Integer.valueOf(this.targetWidth), Integer.valueOf(this.targetHeight), Long.valueOf(paramLong), Integer.valueOf(paramInt5), Integer.valueOf(this.jtn), Integer.valueOf(paramArrayOfByte.length) });
        if (this.jtm == null) {
          this.jtm = new byte[this.targetWidth * this.targetHeight * 3 >> 1];
        }
        if (this.jtm.length != paramArrayOfByte.length) {
          this.jtm = new byte[paramArrayOfByte.length];
        }
        if ((this.colorFormat != 19) || (paramBoolean)) {
          break label250;
        }
        System.arraycopy(paramArrayOfByte, 0, this.jtm, 0, paramArrayOfByte.length);
      }
      for (;;)
      {
        this.jti += 1;
        b(this.jtm, false, paramLong);
        AppMethodBeat.o(127072);
        return;
        paramBoolean = true;
        break;
        label250:
        MP4MuxerJNI.yuv420pTo420XXAndScaleLock(paramArrayOfByte, paramInt5, this.jtm, this.jtn, paramInt1, paramInt2, paramInt3, paramInt4, this.targetWidth, this.targetHeight);
      }
    }
    b(this.jtm, true, paramLong);
    AppMethodBeat.o(127072);
  }
