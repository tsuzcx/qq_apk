...
public final class aa
{
  ...
  static boolean a(String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
    ...
    //   44: ireturn
    //   45: aload_0
    //   46: invokestatic 42	com/tencent/mm/vfs/i:aMN	(Ljava/lang/String;)J
    //   49: l2i
    //   50: istore 5
    //   52: iload 5
    //   54: ifgt +33 -> 87
    ...
    //   95: iconst_0
    //   96: iconst_m1
    //   97: invokestatic 55	com/tencent/mm/vfs/i:aR	(Ljava/lang/String;II)[B
    //   100: astore 10
    //   102: aload 10
    //   104: aload_0
    //   105: aload_1
    ...
    //   160: aload_0
    //   161: iconst_1
    //   162: invokestatic 72	com/tencent/mm/vfs/i:cO	(Ljava/lang/String;Z)Z
    //   165: pop
    //   166: ldc 11
    ...
    //   190: newarray byte
    //   192: astore 13
    //   194: invokestatic 77	com/tencent/mm/sdk/platformtools/bt:eGO	()J
    //   197: l2i
    //   198: istore 7
    //   200: aconst_null
    //   201: astore 11
    ...
    //   204: astore 10
    //   206: aload_0
    //   207: invokestatic 81	com/tencent/mm/vfs/i:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   210: astore 12
    //   212: iconst_0
    //   213: istore 4
    //   215: iload 4
    ...
    //   508: aload_0
    //   509: iconst_1
    //   510: invokestatic 72	com/tencent/mm/vfs/i:cO	(Ljava/lang/String;Z)Z
    //   513: pop
    //   514: aload 12
    //   516: ifnull +8 -> 524
    //   519: aload 12
    ...
    //   545: iconst_0
    //   546: aload_1
    //   547: invokestatic 110	com/tencent/mm/sdk/platformtools/bt:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   550: aastore
  ...
  private static boolean a(byte[] paramArrayOfByte, String paramString1, String paramString2, int paramInt)
  {
    ...
    String str = g.getMessageDigest(String.format("weixin#$()%d%d", new Object[] { Integer.valueOf(d.CpK), Integer.valueOf(i) }).getBytes()).toLowerCase();
    ...
    paramString1.append(Integer.toHexString(d.CpK));
    paramString1.append("&devicetype=");
    paramString1.append(d.glX);
    ...
    paramString1.append(bt.eGO() + ".0.1");
    ...
    {
      ad.e("MicroMsg.StackReportUploader", "exception:%s", new Object[] { bt.m(paramArrayOfByte) });
