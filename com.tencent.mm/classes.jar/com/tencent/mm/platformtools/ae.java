...
public final class ae
{
  ...
  private static final long[] iwT;
  
  static
  {
    AppMethodBeat.i(20749);
    iwT = new long[] { 300L, 200L, 300L, 200L };
  ...
  public static boolean a(Context paramContext, View paramView)
  {
    ...
    catch (IllegalArgumentException paramContext)
    {
      for (;;)
      {
        ac.e("MicroMsg.Util", "hide VKB(View) exception %s", new Object[] { paramContext });
        boolean bool = false;
      }
    }
  }
  ...
  public static void aNy()
  {
    ...
    ac.w("MicroMsg.Util", "memory usage: h=%s/%s, e=%s/%s, n=%s/%s", new Object[] { qz(Debug.getGlobalAllocSize()), qz(Debug.getGlobalAllocSize() + Debug.getGlobalFreedSize()), qz(Debug.getGlobalExternalAllocSize()), qz(Debug.getGlobalExternalAllocSize() + Debug.getGlobalExternalFreedSize()), qz(Debug.getNativeHeapAllocatedSize()), qz(Debug.getNativeHeapSize()) });
    AppMethodBeat.o(20732);
  }
  
  public static ae.a aNz()
  {
  ...
  public static List<String> bH(String paramString1, String paramString2)
  {
  ...
  public static int ca(Object paramObject)
  {
  ...
  public static boolean df(Context paramContext)
  {
    ...
    if ((i.cHa & 0x1) != 0)
    {
      ac.e("MicroMsg.Util", "package has set external update mode");
      Object localObject = Uri.parse(i.GqI);
      ...
      {
        ac.e("MicroMsg.Util", "parse market uri failed, jump to weixin.qq.com");
        localObject = new Intent("android.intent.action.VIEW", Uri.parse("http://weixin.qq.com")).addFlags(268435456);
        localObject = new com.tencent.mm.hellhoundlib.b.a().ba(localObject);
        com.tencent.mm.hellhoundlib.a.a.a(paramContext, ((com.tencent.mm.hellhoundlib.b.a)localObject).aeD(), "com/tencent/mm/platformtools/Util", "checkUpdate", "(Landroid/content/Context;Ljava/lang/Runnable;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
      ...
      for (;;)
      {
        ...
        break;
        label194:
        ac.i("MicroMsg.Util", "parse market uri ok");
    ...
    ai.getContext().getSharedPreferences("system_config_prefs", 0).edit().putLong("recomended_update_ignore", System.currentTimeMillis() / 1000L).commit();
    if (d.dfa() != null)
    {
      paramContext = d.dfa().c(paramContext, new DialogInterface.OnCancelListener()
      {
  ...
  public static int getInt(String paramString, int paramInt)
  {
    ...
    {
      ac.printErrStackTrace("MicroMsg.Util", paramString, "", new Object[0]);
      AppMethodBeat.o(20742);
    }
    return paramInt;
  }
  ...
  public static String qz(long paramLong)
  {
  ...
  public static boolean qz(int paramInt)
  {
    ...
    ac.d("MicroMsg.Util", "time " + l1 + "  systime " + System.currentTimeMillis() + " diff " + l2);
    if (l2 < 0L)
    {
  ...
  @Deprecated
  public static long tx(String paramString)
  {
