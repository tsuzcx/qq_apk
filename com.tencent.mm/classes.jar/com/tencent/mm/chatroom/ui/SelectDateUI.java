  ...
  implements com.tencent.mm.chatroom.a.a
{
  private long fPP = -1L;
  private p fSP = null;
  private DayPickerView fVf;
  private String fVg;
  private HashMap<String, com.tencent.mm.chatroom.d.a> fVh;
  ...
  public final void a(com.tencent.mm.chatroom.d.a parama)
  {
    ...
    if (parama == null)
    {
      ae.e("MicroMsg.SelectDateUI", "null == calendarDay");
      AppMethodBeat.o(12925);
      return;
    }
    ae.i("MicroMsg.SelectDateUI", "Day Selected timestamp:%s day:%s month:%s year:%s", new Object[] { Long.valueOf(parama.fMK), Integer.valueOf(parama.fMJ), Integer.valueOf(parama.month), Integer.valueOf(parama.year) });
    long l = parama.msgId;
    ae.i("MicroMsg.SelectDateUI", "[goToChattingUI] msgLocalId:%s", new Object[] { Long.valueOf(l) });
    d.f(this, ".ui.chatting.ChattingUI", new Intent().putExtra("Chat_User", this.fVg).putExtra("finish_direct", true).putExtra("from_date_search", true).putExtra("msg_local_id", l));
    AppMethodBeat.o(12925);
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.fVf = ((DayPickerView)findViewById(2131303265));
    this.fVi = ((TextView)findViewById(2131304436));
    this.fVh = new HashMap();
    this.mHandler = new aq(getMainLooper());
    this.fVg = getIntent().getStringExtra("detail_username");
    b.c(new Runnable()
    {
