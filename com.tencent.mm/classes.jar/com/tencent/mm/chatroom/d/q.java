  ...
  implements m
{
  ...
  public q(String paramString1, String paramString2)
  {
    ...
    ((d.a)localObject).lBU = new dze();
    ((d.a)localObject).lBV = new dzf();
    ((d.a)localObject).uri = "/cgi-bin/micromsg-bin/revokechatroomqrcode";
    ((d.a)localObject).funcId = 700;
    ((d.a)localObject).lBW = 0;
    ((d.a)localObject).respCmdId = 0;
    this.rr = ((d.a)localObject).bgN();
    localObject = (dze)d.b.b(this.rr.lBR);
    ((dze)localObject).UeM = paramString1;
    ((dze)localObject).UeN = paramString2;
