  ...
  extends g
{
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          ad.i("MicroMsg.WXHardCoderJNI", "readServerAddr, serverprop[%s], result[%s], stack[%s]", new Object[] { "persist.sys.hardcoder.name", localObject1, bt.eGN() });
          if (paramBoolean)
          {
  ...
  public static int registerGetParametersCallback(int paramInt, GetParametersCallback paramGetParametersCallback, String... paramVarArgs)
  {
    ...
    {
      ad.i("MicroMsg.WXHardCoderJNI", "registerGetParametersCallback, type:%d, callback:%s, stack[%s]", new Object[] { Integer.valueOf(paramInt), localObject, bt.eGN() });
  ...
  public static long registerSystemEventCallback(SystemEventCallback paramSystemEventCallback)
  {
    ...
    ad.i("MicroMsg.WXHardCoderJNI", "registerSystemEventCallback, stack[%s]", new Object[] { bt.eGN() });
  ...
  public static void reloadSPConfig(int paramInt)
  {
    ...
    ad.i("MicroMsg.WXHardCoderJNI", "reloadSPConfig scene:%d, hcDebug:%b, hcEnable:%b, hcUinHash:%d, checkEnv:%b, stack[%s]", new Object[] { Integer.valueOf(paramInt), Boolean.valueOf(HardCoderJNI.isHcDebug()), Boolean.valueOf(HardCoderJNI.isHcEnable()), Integer.valueOf(hcUinHash), Boolean.valueOf(HardCoderJNI.isCheckEnv()), bt.eGN() });
