...
public final class d
{
  ...
  public static Bitmap EP(String paramString)
  {
    ...
    paramString = (Bitmap)g.a.X("local_cdn_img_cache", paramString);
    AppMethodBeat.o(150528);
    return paramString;
  }
  ...
  public final void a(String paramString, c paramc)
  {
    ...
    Bitmap localBitmap = EP(paramString);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (!this.iWZ.containsKey(paramString)) {
        break;
      }
    ...
    this.iWZ.put(paramString, paramc);
    ThreadPool.post(new b(paramString, this.iWZ), "CdnImageService_download");
    AppMethodBeat.o(150530);
  }
  ...
  {
    private byte[] data;
    private HashMap<String, d.c> iWZ;
    private Bitmap iXa;
    private String url;
    ...
    public a(String paramString, Bitmap paramBitmap, HashMap<String, d.c> paramHashMap, byte[] paramArrayOfByte)
    {
      ...
      this.iXa = paramBitmap;
      this.iWZ = paramHashMap;
    ...
    public final void run()
    {
      ...
      if (this.iWZ != null)
      {
        localObject = (d.c)this.iWZ.remove(this.url);
        if (localObject != null) {
          ((d.c)localObject).a(this.iXa, this.data);
        }
      }
      if (this.url == null) {}
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      try
      {
        ...
        MMHandlerThread.postToMainThread(new d.a(this.url, localBitmap, this.iWZ, arrayOfByte));
        AppMethodBeat.o(150524);
        return;
      }
