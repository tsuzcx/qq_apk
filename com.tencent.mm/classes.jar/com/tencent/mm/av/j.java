  ...
  extends e
{
  public static int a(int paramInt1, d paramd, ca paramca, String paramString1, long paramLong1, String paramString2, String paramString3, int paramInt2, long paramLong2, String paramString4)
  {
    ...
    if (paramInt1 != 0)
    {
      ...
      paramca.setStatus(5);
      ((l)com.tencent.mm.kernel.g.af(l.class)).eiy().b(paramca.field_msgSvrId, paramca);
      paramd = com.tencent.mm.plugin.report.a.t(new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(2), Long.valueOf(paramLong2), Long.valueOf(Util.nowMilliSecond()), Integer.valueOf(com.tencent.mm.an.c.cY(MMApplicationContext.getContext())), Integer.valueOf(com.tencent.mm.i.a.MediaType_THUMBIMAGE), Integer.valueOf(paramInt2), "" });
      new y(paramd).bfK();
      new w(paramd).bfK();
      q.bcR().doNotify();
    ...
    if (paramd.field_retCode != 0)
    {
      ...
      j = com.tencent.mm.an.c.cY(MMApplicationContext.getContext());
      ...
      paramString1 = "";
      label328:
      new y(com.tencent.mm.plugin.report.a.t(new Object[] { Integer.valueOf(i), Integer.valueOf(2), Long.valueOf(paramLong2), Long.valueOf(paramLong1), Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(paramInt2), paramca, "", "", "", "", "", "", "", paramString1 })).bfK();
    ...
    {
      new w(com.tencent.mm.plugin.report.a.t(new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(2), Long.valueOf(paramLong2), Long.valueOf(paramLong1), Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(paramInt2), paramca, "", "", "", "", "", "", "", paramd })).bfK();
      q.bcR().doNotify();
      AppMethodBeat.o(150640);
      return 0;
      if (ImgUtil.isWXGF(paramString4))
      {
        ...
        s.nx(paramString4, (String)localObject);
        if (!s.YS(paramString2)) {
          s.bpa(paramString2);
        }
        ((com.tencent.mm.plugin.emoji.b.c)com.tencent.mm.kernel.g.af(com.tencent.mm.plugin.emoji.b.c.class)).nativeWxam2Pic((String)localObject, paramString2);
        paramca.setStatus(6);
        paramString4 = new PInt();
        localObject = new PInt();
        BitmapUtil.getRent(paramString2, paramString4, (PInt)localObject);
        paramca.nG(paramString4.value);
        paramca.nH(((PInt)localObject).value);
        ...
        com.tencent.mm.plugin.report.service.h.CyF.idkeyStat(198L, 1L, paramInt2, false);
        com.tencent.mm.plugin.report.service.h.CyF.idkeyStat(198L, 2L, 1L, false);
        paramca = com.tencent.mm.plugin.report.service.h.CyF;
      ...
      for (paramLong1 = 4L;; paramLong1 = 3L)
      {
        ...
        break;
        s.nx(paramString4, paramString2);
        break label711;
      }
  ...
  public final ca a(h.a parama, final String paramString1, final String paramString2, final String paramString3)
  {
    ...
    final long l1 = ((de)localObject2).Brn;
    paramString3 = ((i)localObject1).G(parama, l1);
    if (paramString3.dTS == l1)
    {
      s.deleteFile(((i)localObject1).o(paramString3.iXm, "", ""));
      s.deleteFile(((i)localObject1).o(paramString3.iXr, "", ""));
      s.deleteFile(((i)localObject1).o(paramString3.iXo, "", ""));
      s.deleteFile(((i)localObject1).o(paramString3.iXo, "", "") + "hd");
      ((i)localObject1).iFy.delete(i.d.OH(parama), "msgSvrId=?", new String[] { String.valueOf(l1) });
      if (paramString3.bcv())
      {
        paramString3 = ((i)localObject1).tl(paramString3.iXx);
        if (paramString3 != null)
        {
          ...
          s.deleteFile(((i)localObject1).o(paramString3.iXo, "", ""));
          s.deleteFile(((i)localObject1).o(paramString3.iXo, "", "") + "hd");
          ((i)localObject1).iFy.delete(i.d.OH(parama), "id=?", new String[] { paramString3.localId });
        }
      }
    }
    if (((de)localObject2).KHo != 2)
    {
      Log.e("MicroMsg.ImgMsgExtension", "data type img, but has no imgstatus_hasimg ?!");
      AppMethodBeat.o(223610);
      return paramString2;
    }
    parama = z.a(((de)localObject2).KHp);
    if (ac.jOI)
    {
    ...
    for (;;)
    {
      ...
      if (!Util.isNullOrNil(paramString2.field_content))
      {
        ...
        if (localObject3 == null) {
          com.tencent.mm.plugin.report.service.h.CyF.idkeyStat(111L, 190L, 1L, false);
        }
        if (localObject3 != null)
        {
          ...
          if (i > 0)
          {
            l1 = ((i)localObject1).a(paramString2.field_talker, parama, ((de)localObject2).Brn, true, paramString2.field_content, new PString(), new PInt(), new PInt());
            paramString3 = XmlParser.parseXml(paramString2.field_content, "msgoperation", null);
            if (paramString3 != null)
            {
              paramString2.CI((String)paramString3.get(".msgoperation.expinfo.expidstr"));
              paramString2.nL(Util.getInt((String)paramString3.get(".msgoperation.imagemsg.downloadcontroltype"), 0));
              Log.i("MicroMsg.ImgMsgExtension", "[chatting_exp] expidstr:%s, downloadcontroltype:%d", new Object[] { paramString2.fRa, Integer.valueOf(paramString2.fRb) });
            }
          }
        }
      }
      for (;;)
      {
        ...
        final long l2 = ((i)localObject1).a(paramString2.field_talker, parama, ((de)localObject2).Brn, false, paramString2.field_content, (PString)localObject4, localPInt1, localPInt2);
        ...
        if (l2 > 0L)
        {
          paramString2.Cz(((PString)localObject4).value);
          paramString2.nG(localPInt1.value);
          paramString2.nH(localPInt2.value);
          if (l1 > 0L)
          {
            localObject2 = q.bcR().c(Long.valueOf(l2));
            ((g)localObject2).tk(1);
            ((g)localObject2).tg((int)l1);
            q.bcR().a(Long.valueOf(l2), (g)localObject2);
          }
        }
        if ((Util.isNullOrNil(parama)) && (localObject3 != null) && (!Util.isNullOrNil(paramString3)))
        {
          ...
          ((com.tencent.mm.i.g)localObject4).gqB = paramString3;
          if (((com.tencent.mm.plugin.emoji.b.c)com.tencent.mm.kernel.g.af(com.tencent.mm.plugin.emoji.b.c.class)).cEP())
          {
            i = 2;
            ((com.tencent.mm.i.g)localObject4).expectImageFormat = i;
            ((com.tencent.mm.i.g)localObject4).gqy = new g.a()
            {
              public final int a(String paramAnonymousString, int paramAnonymousInt, com.tencent.mm.i.c paramAnonymousc, d paramAnonymousd, boolean paramAnonymousBoolean)
              {
                ...
                j.a(paramAnonymousInt, paramAnonymousd, paramString2, paramString1, l1, paramString3, j, l2, this.val$startTime, this.iYz);
            ...
            f.baQ().b((com.tencent.mm.i.g)localObject4, -1);
          }
        }
        ...
        ((com.tencent.mm.i.g)localObject3).field_priority = com.tencent.mm.i.a.gpN;
        if (ab.Eq(paramString1))
        {
          i = 1;
          label1488:
        ...
        for (i = 2;; i = 1)
        {
          ...
          ((com.tencent.mm.i.g)localObject3).gqy = new g.a()
          {
            public final int a(String paramAnonymousString, int paramAnonymousInt, com.tencent.mm.i.c paramAnonymousc, d paramAnonymousd, boolean paramAnonymousBoolean)
            {
          ...
          paramString2.setStatus(4);
          f.baQ().b((com.tencent.mm.i.g)localObject3, -1);
          break;
          i = 0;
          break label1488;
        }
