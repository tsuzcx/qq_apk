...
public final class a
{
  public static Executor aFH()
  {
    ...
    b localb = h.JZN.aTA("image_loader_ImageTempFile");
    AppMethodBeat.o(182800);
    return localb;
  }
  
  public static j pb(int paramInt)
  {
    ...
    implements j
  {
    ...
    public a(String paramString, int paramInt1, int paramInt2, BlockingQueue<Runnable> paramBlockingQueue)
    {
      ...
      this.gMb = this.gMa.newCondition();
    ...
    public final void beforeExecute(java.lang.Thread paramThread, Runnable paramRunnable)
    {
      ...
      //   11: aload_0
      //   12: getfield 37	com/tencent/mm/av/a/a/a$a:gMa	Ljava/util/concurrent/locks/ReentrantLock;
      //   15: invokevirtual 70	java/util/concurrent/locks/ReentrantLock:lock	()V
      //   18: aload_0
      //   19: getfield 55	com/tencent/mm/av/a/a/a$a:isPaused	Z
      //   22: ifeq +51 -> 73
      //   25: aload_0
      //   26: getfield 43	com/tencent/mm/av/a/a/a$a:gMb	Ljava/util/concurrent/locks/Condition;
      ...
      //   56: aastore
      //   57: invokestatic 96	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   60: aload_0
      //   61: getfield 37	com/tencent/mm/av/a/a/a$a:gMa	Ljava/util/concurrent/locks/ReentrantLock;
      ...
      //   72: return
      //   73: aload_0
      //   74: getfield 37	com/tencent/mm/av/a/a/a$a:gMa	Ljava/util/concurrent/locks/ReentrantLock;
      ...
      //   86: astore_1
      //   87: aload_0
      //   88: getfield 37	com/tencent/mm/av/a/a/a$a:gMa	Ljava/util/concurrent/locks/ReentrantLock;
