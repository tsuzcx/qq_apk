  ...
  implements com.tencent.mm.av.a.c.b
{
  ...
  private String a(String paramString, com.tencent.mm.av.a.a.c paramc)
  {
    ...
    else
    {
      ...
      if (localObject2 != null)
      {
        localObject1 = localObject2;
        if (((String)localObject2).length() != 0) {
          localObject1 = (String)localObject2 + "/" + this.hKX.CF(paramString);
        }
      }
    }
    ...
    if (paramc.hKw)
    {
      ...
      if (bs.isNullOrNil((String)localObject1)) {
        localObject2 = com.tencent.mm.av.a.g.b.aqj() + "/" + this.hKX.CF(paramString);
      }
    }
  ...
  private String b(String paramString, com.tencent.mm.av.a.a.c paramc)
  {
    ...
    else
    {
      ...
      if (str2 != null)
      {
        ...
        if (str2.length() > 0)
        {
          ...
          {
            ac.e("MicroMsg.imageloader.DefaultImageDiskCache", "[johnw] SFS can't deal with absolute path: %s", new Object[] { str2 });
    ...
    {
      paramc = this.hKX.CF(paramString);
    }
  ...
  public final boolean a(String paramString, byte[] paramArrayOfByte, com.tencent.mm.av.a.a.c paramc)
  {
    ...
    //   5: aload_3
    //   6: getfield 123	com/tencent/mm/av/a/a/c:hKO	Lcom/tencent/mm/modelsfs/SFSContext;
    //   9: astore 11
    //   11: aload 11
    //   13: ifnull +411 -> 424
    //   16: aload_0
    ...
    //   118: astore 7
    //   120: aload 8
    //   122: invokestatic 143	com/tencent/mm/modelsfs/e:Dc	(Ljava/lang/String;)Z
    //   125: ifeq +412 -> 537
    //   128: aload 9
    //   130: astore_3
    //   131: aload 10
    ...
    //   175: astore 7
    //   177: aload 8
    //   179: invokestatic 155	com/tencent/mm/modelsfs/e:Dd	(Ljava/lang/String;)Ljava/lang/String;
    //   182: astore 8
    //   184: aload 9
    //   186: astore_3
    //   187: aload 10
    ...
    //   450: invokevirtual 196	com/tencent/mm/vfs/e:fxU	()Lcom/tencent/mm/vfs/e;
    //   453: astore_3
    //   454: aload_3
    //   455: ifnull +15 -> 470
    //   458: aload_3
    ...
    //   513: ldc 86
    //   515: aload_3
    //   516: invokestatic 216	com/tencent/mm/sdk/platformtools/bs:m	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   519: invokestatic 219	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   522: goto -31 -> 491
    //   525: astore_1
    //   526: goto -129 -> 397
    //   529: astore_1
  ...
  public final boolean c(String paramString, com.tencent.mm.av.a.a.c paramc)
  {
    ...
    SFSContext localSFSContext = paramc.hKO;
    if (localSFSContext != null)
    {
      ...
      paramString = paramc;
      if (com.tencent.mm.modelsfs.e.Dc(paramc))
      {
        com.tencent.mm.modelsfs.e.De(paramc);
        paramString = com.tencent.mm.modelsfs.e.Dd(paramc);
      }
  ...
  public final InputStream d(String paramString, com.tencent.mm.av.a.a.c paramc)
  {
    ...
    long l1;
    if (com.tencent.mm.modelsfs.e.Dc(paramString))
    {
      l1 = com.tencent.mm.modelsfs.e.De(paramString);
      paramString = com.tencent.mm.modelsfs.e.Dd(paramString);
    }
    for (;;)
    {
