  ...
  implements c
{
  public final com.tencent.mm.av.a.d.b CD(String paramString)
  {
    ...
    ac.d("MicroMsg.imageload.DefaultImageDownloader", "[cpan] get image data from url:%s", new Object[] { paramString });
    try
    {
      paramString = a.CE(paramString);
      AppMethodBeat.o(130412);
      return paramString;
    }
    catch (InterruptedException paramString)
    {
      ac.e("MicroMsg.imageload.DefaultImageDownloader", "[cpan] get image data failed.:%s", new Object[] { bs.m(paramString) });
  ...
  {
    /* Error */
    public static com.tencent.mm.av.a.d.b CE(String paramString)
    {
      // Byte code:
      //   0: aconst_null
      //   1: astore_2
      ...
      //   40: ldc 38
      //   42: ldc 40
      //   44: invokestatic 45	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;)V
      //   47: aload_0
      ...
      //   68: ldc 38
      //   70: ldc 64
      //   72: invokestatic 67	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;)V
      //   75: ldc 12
      ...
      //   89: invokestatic 77	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
      //   92: goto -28 -> 64
      //   95: aload_0
      ...
      //   104: astore_2
      //   105: aload_1
      //   106: invokestatic 85	com/tencent/mm/av/a/b/e:o	(Ljava/io/InputStream;)[B
      //   109: astore_3
      //   110: aload_0
      ...
      //   121: new 87	com/tencent/mm/av/a/d/b
      //   124: dup
      //   125: aload_3
      //   126: aload_2
      //   127: invokespecial 90	com/tencent/mm/av/a/d/b:<init>	([BLjava/lang/String;)V
      //   130: astore_0
      //   131: aload_1
      //   132: ifnull +7 -> 139
      //   135: aload_1
      ...
      //   155: invokestatic 77	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
      //   158: goto -41 -> 117
      //   161: astore_0
      //   162: aload_1
      //   163: ifnull +7 -> 170
