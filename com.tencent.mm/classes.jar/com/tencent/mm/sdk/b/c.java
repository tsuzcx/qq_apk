...
public abstract class c<T extends b>
{
  ...
  int __getEventID()
  {
    if (this.__eventId == 0)
    {
      ...
      ae.v("IListener", "genEventID, %s<%s>, useTime:%d", new Object[] { getClass().getName(), localType1, Long.valueOf(System.currentTimeMillis() - l) });
    }
  ...
  public com.tencent.mm.vending.b.b<c> alive()
  {
    try
    {
      ...
      {
        ListenerInstanceMonitor.dS(this);
        this.mCallbackProperty = a.IvT.b(this);
      }
  ...
  public void dead()
  {
    try
    {
      if (this.mCallbackProperty != null)
      {
        ListenerInstanceMonitor.dT((c)this.mCallbackProperty.LEn);
