...
public class LruCache<K, V>
{
  ...
  public boolean checkAndUpTime(K paramK)
  {
    ...
    //   7: aload_0
    //   8: aload_1
    //   9: invokevirtual 90	com/tencent/mm/sdk/platformtools/LruCache:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   12: ifnull +14 -> 26
    //   15: iconst_1
    //   16: istore_2
    //   17: ldc 86
  ...
  public final V get(K paramK)
  {
    ...
    if (paramK == null)
    {
      Log.e("MicroMsg.LruMap", "key == null %s", new Object[] { Util.getStack().toString() });
  ...
  public final V put(K paramK, V paramV)
  {
    ...
    if ((paramK == null) || (paramV == null)) {
      Log.e("MicroMsg.LruMap", "put key == null or value == null [%s, %s], %s", new Object[] { paramK, paramV, Util.getStack().toString() });
    }
    try
    {
      this.putCount += 1;
  ...
  public void setMaxSize(int paramInt)
  {
    ...
    Log.i("LruCache", "setMaxSize %s", new Object[] { Integer.valueOf(paramInt) });
    this.maxSize = paramInt;
    AppMethodBeat.o(157590);
  }
