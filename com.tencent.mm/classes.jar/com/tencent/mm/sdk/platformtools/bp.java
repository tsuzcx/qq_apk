...
{
  private final d Gus;
  private af<String, String> Gut;
  
  public bp(String paramString)
  {
    AppMethodBeat.i(157841);
    this.Gut = new af(256);
    this.Gus = new d(paramString);
  ...
  public final String decryptTag(String paramString)
  {
    ...
    try
    {
      ...
      if (this.Gut.aK(paramString))
      {
        str1 = (String)this.Gut.get(paramString);
      ...
      String str2;
      int i;
      ac.printErrStackTrace("MicroMsg.TagDecrypter", localException1, "", new Object[0]);
    }
    catch (Exception localException1)
    {
      try
      {
        ...
        str2 = this.Gus.ds((String)localObject2) + str2;
        this.Gut.put(paramString, str2);
        AppMethodBeat.o(157842);
        return str2;
      }
