...
{
  protected static ThreadLocal<MessageDigest> cXc;
  ...
  public static String D(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = ((MessageDigest)cXc.get()).digest(paramArrayOfByte);
    paramArrayOfByte = Y(paramArrayOfByte, paramArrayOfByte.length);
    AppMethodBeat.o(157611);
    return paramArrayOfByte;
  }
  
  private static String Y(byte[] paramArrayOfByte, int paramInt)
  {
