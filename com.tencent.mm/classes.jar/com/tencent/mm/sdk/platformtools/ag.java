...
public class ag<K, V>
{
  ...
  public final V get(K paramK)
  {
    ...
    if (paramK == null)
    {
      ad.e("MicroMsg.LruMap", "key == null %s", new Object[] { bt.flS().toString() });
  ...
  public final V put(K paramK, V paramV)
  {
    ...
    if ((paramK == null) || (paramV == null)) {
      ad.e("MicroMsg.LruMap", "put key == null or value == null [%s, %s], %s", new Object[] { paramK, paramV, bt.flS().toString() });
    }
    try
    {
      this.putCount += 1;
