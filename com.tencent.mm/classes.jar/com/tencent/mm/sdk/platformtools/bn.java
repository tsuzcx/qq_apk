...
final class bn
{
  ...
  public static void c(ListView paramListView)
  {
    ...
    if (Build.VERSION.SDK_INT >= 8)
    {
      ...
      com.tencent.mm.hellhoundlib.a.a.a(paramListView, locala.ahp(), "com/tencent/mm/sdk/platformtools/SmoothScrollToPosition22", "doScroll", "(Landroid/widget/ListView;)V", "Undefined", "smoothScrollToPosition", "(I)V");
      paramListView.smoothScrollToPosition(((Integer)locala.mq(0)).intValue());
  ...
  public static void c(ListView paramListView, int paramInt)
  {
    ...
    for (;;)
    {
      if (Build.VERSION.SDK_INT >= 8)
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.a(paramListView, locala.ahp(), "com/tencent/mm/sdk/platformtools/SmoothScrollToPosition22", "doScroll", "(Landroid/widget/ListView;I)V", "Undefined", "smoothScrollToPosition", "(I)V");
        paramListView.smoothScrollToPosition(((Integer)locala.mq(0)).intValue());
