...
{
  private static final WeakHashMap<Bitmap, a> Iwv;
  ...
  static
  {
    ...
    {
      handler = null;
      aw localaw = new aw("BitmapBriefTracer", new aw.a()
      {
      ...
      localaw.ay(120000L, 120000L);
      localaw.setLogging(false);
    }
    for (;;)
    {
      av.a(new av.c()
      ...
      return;
      handler = new aq("BitmapTracer", new aq.a()
      {
        boolean Iwx = false;
        long Iwy = 0L;
        ...
        public final boolean handleMessage(android.os.Message paramAnonymousMessage)
        {
          ...
          //   5: invokestatic 36	com/tencent/mm/sdk/platformtools/g:JG	()Z
          //   8: pop
          ...
          //   41: lload 4
          //   43: lsub
          //   44: invokestatic 60	com/tencent/mm/sdk/platformtools/g:Dr	(J)Ljava/lang/String;
          //   47: aastore
          //   48: dup
          //   49: iconst_1
          //   50: lload 4
          //   52: invokestatic 60	com/tencent/mm/sdk/platformtools/g:Dr	(J)Ljava/lang/String;
          //   55: aastore
          //   56: dup
          //   57: iconst_2
          //   58: lload 6
          //   60: invokestatic 60	com/tencent/mm/sdk/platformtools/g:Dr	(J)Ljava/lang/String;
          //   63: aastore
          //   64: invokestatic 65	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
          //   67: aload_0
          //   68: getfield 18	com/tencent/mm/sdk/platformtools/g$2:Iwx	Z
          //   71: ifne +131 -> 202
          //   74: lload_2
          //   75: lload 4
          //   77: lsub
          ...
          //   89: lload_2
          //   90: aload_0
          //   91: getfield 20	com/tencent/mm/sdk/platformtools/g$2:Iwy	J
          //   94: lsub
          //   95: ldc2_w 73
          //   98: lcmp
          //   99: ifle +18 -> 117
          ...
          //   105: aload_0
          //   106: lload_2
          //   107: putfield 20	com/tencent/mm/sdk/platformtools/g$2:Iwy	J
          //   110: ldc 26
          ...
          //   134: invokestatic 93	com/tencent/mm/loader/j/b:asj	()Ljava/lang/String;
          ...
          //   148: iconst_0
          //   149: invokestatic 108	com/tencent/mm/vfs/o:db	(Ljava/lang/String;Z)Ljava/io/OutputStream;
          ...
          //   162: astore_1
          //   163: aload 8
          //   165: invokestatic 116	com/tencent/mm/sdk/platformtools/g:a	(Ljava/io/PrintWriter;)V
          //   168: aload 8
          //   170: invokestatic 122	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
          //   173: new 86	java/lang/StringBuilder
          //   176: dup
          //   177: invokespecial 87	java/lang/StringBuilder:<init>	()V
          //   180: invokestatic 93	com/tencent/mm/loader/j/b:asj	()Ljava/lang/String;
          ...
          //   197: aload_0
          //   198: iconst_1
          //   199: putfield 18	com/tencent/mm/sdk/platformtools/g$2:Iwx	Z
          //   202: ldc 26
          ...
          //   227: invokestatic 136	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
          //   230: aload 8
          //   232: invokestatic 122	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
          //   235: goto -62 -> 173
          //   238: astore 9
          //   240: aload_1
          //   241: astore 8
          ...
          //   245: astore_1
          //   246: aload 8
          //   248: invokestatic 122	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
          //   251: ldc 26
          ...
          //   268: invokestatic 136	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
          //   271: goto -74 -> 197
          //   274: astore 9
          //   276: aload_1
          //   277: astore 8
    ...
    for (;;)
    {
      ...
      synchronized (Iwv)
      {
        for (;;)
        {
          ...
          try
          {
            ((List)localObject1).addAll(Iwv.entrySet());
        ...
        paramPrintWriter.format("\n\nLiving Bitmaps: %d, %s\n", new Object[] { Integer.valueOf(i), Dq(l2) });
  ...
  private static void a(PrintWriter paramPrintWriter, Bitmap paramBitmap, a parama, long paramLong)
  {
    ...
    String str = Dq(paramBitmap.getAllocationByteCount());
    ...
    for (paramBitmap = "UNKNOWN";; paramBitmap = localConfig.name())
    {
      ...
      paramPrintWriter.format("Acquired: %d seconds ago\n", new Object[] { Long.valueOf((paramLong - parama.IwC) / 1000L) });
      paramPrintWriter.print("Stack:\n");
      a(parama.IwA, paramPrintWriter);
  ...
  private static void ak(long paramLong, int paramInt)
  {
    ...
    a(new PrintWriter(new Writer()
    {
      ...
      public final void flush()
      {
        ...
        String str = this.Iwz.toString();
        this.Iwz = null;
        ae.w("MicroMsg.BitmapTracer", str);
        AppMethodBeat.o(156082);
      }
      ...
      public final void write(char[] paramAnonymousArrayOfChar, int paramAnonymousInt1, int paramAnonymousInt2)
      {
        ...
        if (this.Iwz == null) {
          this.Iwz = new StringWriter();
        }
        this.Iwz.write(paramAnonymousArrayOfChar, paramAnonymousInt1, paramAnonymousInt2);
  ...
  private static Bitmap j(Bitmap paramBitmap, String arg1)
  {
    ...
    if ((paramBitmap.getAllocationByteCount() < 1048576) && (!bv.fnD()))
    {
      AppMethodBeat.o(156089);
      return paramBitmap;
    }
  ...
  {
    final StackTraceElement[] IwA;
    final BitmapFactory.Options IwB;
    final long IwC;
    final String source;
    ...
    a(String paramString)
    {
      ...
      this.IwA = ((StackTraceElement[])Arrays.copyOfRange(arrayOfStackTraceElement, 4, arrayOfStackTraceElement.length));
      this.source = paramString;
      this.IwB = null;
      this.IwC = System.currentTimeMillis();
