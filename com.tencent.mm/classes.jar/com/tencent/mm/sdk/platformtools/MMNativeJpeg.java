...
public class MMNativeJpeg
{
  ...
  public static boolean Convert2Baseline(String paramString, int paramInt)
  {
    ...
    //   171: aload 11
    //   173: iconst_0
    //   174: invokestatic 83	com/tencent/mm/vfs/i:cX	(Ljava/lang/String;Z)Ljava/io/OutputStream;
    //   177: astore 4
    //   179: aload 4
    //   181: astore 8
    //   183: aload 4
    ...
    //   247: aload_0
    //   248: iconst_1
    //   249: invokestatic 99	com/tencent/mm/sdk/platformtools/p:C	(Ljava/lang/String;Ljava/lang/String;Z)Z
    //   252: istore_2
    //   253: aload 4
    //   255: ifnull +8 -> 263
    //   258: aload 4
  ...
  public static boolean convertToProgressive(String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      boolean bool = i.mA(str, paramString);
