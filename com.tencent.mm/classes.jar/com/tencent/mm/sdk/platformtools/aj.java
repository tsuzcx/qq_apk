...
public final class aj
{
  ...
  public static String B(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = ((MessageDigest)dgQ.get()).digest(paramArrayOfByte);
    paramArrayOfByte = ac(paramArrayOfByte, paramArrayOfByte.length);
  ...
  private static String ac(byte[] paramArrayOfByte, int paramInt)
  {
