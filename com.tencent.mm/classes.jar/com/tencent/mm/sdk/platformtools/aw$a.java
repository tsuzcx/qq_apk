...
{
  private static SharedPreferences AHu;
  ...
  static
  {
    ...
    AHu = aj.getContext().getSharedPreferences("pref_MultiProcSP_dyncfg", 4);
    EVt = "pref_key_is_enable_MultiProcSP";
    EVu = "pref_key_is_disabled_MultiProcSP_manually";
  ...
  private static boolean aFB(String paramString)
  {
    ...
    boolean bool = AHu.getBoolean(paramString, false);
  ...
  public static void setValue(String paramString, boolean paramBoolean)
  {
    ...
    SharedPreferences.Editor localEditor = AHu.edit();
    localEditor.putBoolean(paramString, paramBoolean);
    localEditor.commit();
    AppMethodBeat.o(156207);
  }
  
  public static void uT(boolean paramBoolean)
  {
    AppMethodBeat.i(156203);
    setValue(EVu, paramBoolean);
