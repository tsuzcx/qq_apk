...
final class bm
{
  ...
  public static void c(ListView paramListView)
  {
    ...
    if (Build.VERSION.SDK_INT >= 8)
    {
      ...
      com.tencent.mm.hellhoundlib.a.a.a(paramListView, locala.aeD(), "com/tencent/mm/sdk/platformtools/SmoothScrollToPosition22", "doScroll", "(Landroid/widget/ListView;)V", "Undefined", "smoothScrollToPosition", "(I)V");
      paramListView.smoothScrollToPosition(((Integer)locala.lR(0)).intValue());
  ...
  public static void d(ListView paramListView, int paramInt)
  {
    ...
    for (;;)
    {
      if (Build.VERSION.SDK_INT >= 8)
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.a(paramListView, locala.aeD(), "com/tencent/mm/sdk/platformtools/SmoothScrollToPosition22", "doScroll", "(Landroid/widget/ListView;I)V", "Undefined", "smoothScrollToPosition", "(I)V");
        paramListView.smoothScrollToPosition(((Integer)locala.lR(0)).intValue());
