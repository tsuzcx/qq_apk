...
public class bm<T>
{
  ...
  public bm(int paramInt)
  {
    ...
    if (paramInt <= 0)
    {
      ae.e("MicroMsg.SimpleObjectPool", "The max pool size must be > 0");
  ...
  public boolean release(T paramT)
  {
    ...
    ae.e("MicroMsg.SimpleObjectPool", "error index %d %d", new Object[] { Integer.valueOf(this.mPoolSize), Integer.valueOf(this.mPool.length) });
    AppMethodBeat.o(157836);
    return false;
  }
}
