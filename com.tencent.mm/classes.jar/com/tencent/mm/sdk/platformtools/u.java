...
{
  /* Error */
  public static boolean aE(android.content.Context paramContext, int paramInt)
  {
    // Byte code:
    //   0: ldc 11
    //   2: invokestatic 17	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   5: aload_0
    //   6: invokevirtual 23	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   9: iload_1
    //   10: invokevirtual 29	android/content/res/Resources:openRawResource	(I)Ljava/io/InputStream;
    //   13: astore_2
    //   14: ldc 31
    //   16: astore_0
    //   17: iconst_0
    ...
    //   20: bipush 6
    //   22: if_icmpge +49 -> 71
    //   25: new 33	java/lang/StringBuilder
    //   28: dup
    ...
    //   36: aload_2
    //   37: invokevirtual 47	java/io/InputStream:read	()I
    //   40: i2c
    //   41: invokevirtual 50	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    ...
    //   55: astore_0
    //   56: ldc 11
    //   58: invokestatic 57	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   61: iconst_0
    //   62: ireturn
    //   63: astore_0
    //   64: ldc 11
    ...
    //   79: aload_0
    //   80: ldc 62
    //   82: invokevirtual 68	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   85: ifne +10 -> 95
    //   88: ldc 11
    //   90: invokestatic 57	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   93: iconst_0
    //   94: ireturn
    //   95: ldc 11
  ...
  public static boolean aRF(String paramString)
  {
    ...
    //   6: astore 6
    //   8: ldc 73
    //   10: invokestatic 17	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   13: aload_0
    //   14: ifnull +10 -> 24
    //   17: aload_0
    //   18: invokevirtual 76	java/lang/String:length	()I
    //   21: ifne +17 -> 38
    //   24: ldc 78
    //   26: ldc 80
    //   28: invokestatic 86	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   31: ldc 73
    //   33: invokestatic 57	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   36: iconst_0
    //   37: ireturn
    //   38: aload_0
    //   39: invokevirtual 76	java/lang/String:length	()I
    //   42: iconst_3
    //   43: if_icmpge +10 -> 53
    //   46: ldc 73
    ...
    //   51: iconst_0
    //   52: ireturn
    //   53: new 88	android/graphics/BitmapFactory$Options
    //   56: dup
    //   57: invokespecial 89	android/graphics/BitmapFactory$Options:<init>	()V
    //   60: astore 8
    //   62: aload 8
    //   64: iconst_1
    //   65: putfield 93	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   68: aload 6
    //   70: astore 5
    //   72: aload 7
    //   74: astore 4
    //   76: aload_0
    //   77: invokestatic 98	com/tencent/mm/vfs/o:fB	(Ljava/lang/String;)Z
    //   80: istore_3
    //   81: iload_3
    //   82: ifne +14 -> 96
    //   85: aconst_null
    //   86: invokestatic 104	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   89: ldc 73
    ...
    //   102: astore 4
    //   104: aload_0
    //   105: invokestatic 108	com/tencent/mm/vfs/o:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   108: astore_0
    //   109: aload_0
    //   110: astore 5
    //   112: aload_0
    ...
    //   116: aconst_null
    //   117: aload 8
    //   119: invokestatic 114	com/tencent/mm/graphics/MMBitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   122: pop
    //   123: aload_0
    //   124: astore 5
    //   126: aload_0
    //   127: astore 4
    //   129: aload 8
    //   131: getfield 118	android/graphics/BitmapFactory$Options:outWidth	I
    //   134: ifle +30 -> 164
    //   137: aload_0
    //   138: astore 5
    //   140: aload_0
    //   141: astore 4
    //   143: aload 8
    //   145: getfield 121	android/graphics/BitmapFactory$Options:outHeight	I
    //   148: istore_1
    //   149: iload_1
    //   150: ifle +14 -> 164
    //   153: aload_0
    //   154: invokestatic 104	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   157: ldc 73
    ...
    //   183: invokestatic 127	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   186: aload 5
    //   188: invokestatic 104	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   191: ldc 73
    ...
    //   198: astore_0
    //   199: aload 4
    //   201: invokestatic 104	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   204: ldc 73
    //   206: invokestatic 57	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   209: aload_0
    //   210: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public static boolean aRG(String paramString)
  {
    ...
    //   9: astore_3
    //   10: aload_0
    //   11: invokestatic 108	com/tencent/mm/vfs/o:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   14: astore_0
    //   15: aload_0
    //   16: astore_3
    //   17: aload_0
    ...
    //   35: aload_0
    //   36: aload 6
    //   38: invokevirtual 132	java/io/InputStream:read	([B)I
    //   41: pop
    //   42: iconst_0
    //   43: istore_1
    //   44: iload_1
    ...
    //   70: baload
    //   71: i2c
    //   72: invokevirtual 50	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   75: invokevirtual 54	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   78: astore 5
    //   80: iload_1
    //   81: iconst_1
    //   82: iadd
    ...
    //   92: aload 5
    //   94: ldc 62
    //   96: invokevirtual 68	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   99: istore_2
    //   100: iload_2
    //   101: ifne +18 -> 119
    //   104: aload_0
    //   105: ifnull +7 -> 112
    //   108: aload_0
    //   109: invokevirtual 60	java/io/InputStream:close	()V
    //   112: ldc 129
    ...
    //   120: ifnull +7 -> 127
    //   123: aload_0
    //   124: invokevirtual 60	java/io/InputStream:close	()V
    //   127: ldc 129
    ...
    //   136: ifnull +7 -> 143
    //   139: aload_3
    //   140: invokevirtual 60	java/io/InputStream:close	()V
    //   143: ldc 129
    ...
    //   153: ifnull +8 -> 161
    //   156: aload 4
    //   158: invokevirtual 60	java/io/InputStream:close	()V
    //   161: ldc 129
  ...
  public static String aRI(String paramString)
  {
    ...
    paramString = cz(o.bb(paramString, 0, 2));
    AppMethodBeat.o(156188);
    return paramString;
  }
  ...
  public static boolean cx(byte[] paramArrayOfByte)
  {
    boolean bool2 = true;
    boolean bool1;
  ...
  public static boolean cy(byte[] paramArrayOfByte)
  {
  ...
  private static String cz(byte[] paramArrayOfByte)
  {
