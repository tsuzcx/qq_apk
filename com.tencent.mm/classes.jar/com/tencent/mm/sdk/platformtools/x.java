...
public class x
{
  public static void b(Intent paramIntent, String paramString, boolean paramBoolean)
  {
    ...
    {
      ac.printErrStackTrace("MicroMsg.IntentUtil", paramIntent, "", new Object[0]);
      AppMethodBeat.o(157573);
    }
  }
  
  public static Bundle bf(Intent paramIntent)
  {
    ...
    catch (Exception paramIntent)
    {
      for (;;)
      {
        ac.e("MicroMsg.IntentUtil", "getExtras exception:%s", new Object[] { paramIntent.getMessage() });
  ...
  public static boolean getBooleanExtra(Intent paramIntent, String paramString, boolean paramBoolean)
  {
    ...
    catch (Exception paramIntent)
    {
      for (;;)
      {
        ac.e("MicroMsg.IntentUtil", "getBooleanExtra exception:%s", new Object[] { paramIntent.getMessage() });
      }
    }
    AppMethodBeat.o(157568);
    return paramBoolean;
  ...
  public static int getIntExtra(Intent paramIntent, String paramString, int paramInt)
  {
    ...
    catch (Exception paramIntent)
    {
      for (;;)
      {
        ac.e("MicroMsg.IntentUtil", "getIntExtra exception:%s", new Object[] { paramIntent.getMessage() });
      }
    }
    AppMethodBeat.o(157564);
    return paramInt;
  ...
  public static String getStringExtra(Intent paramIntent, String paramString)
  {
    ...
    catch (Exception paramIntent)
    {
      for (;;)
      {
        ac.e("MicroMsg.IntentUtil", "getStringExtra exception:%s", new Object[] { paramIntent.getMessage() });
        paramIntent = localObject;
      }
    }
  }
  
  public static int l(Bundle paramBundle, String paramString)
  {
    int i = 0;
    ...
    catch (Exception paramBundle)
    {
      for (;;)
      {
        ac.e("MicroMsg.IntentUtil", "getIntExtra exception:%s", new Object[] { paramBundle.getMessage() });
      }
    }
    AppMethodBeat.o(157565);
    return i;
  ...
  public static boolean m(Bundle paramBundle, String paramString)
  {
    boolean bool1 = false;
    ...
    catch (Exception paramBundle)
    {
      for (;;)
      {
        ac.e("MicroMsg.IntentUtil", "getBooleanExtra exception:%s", new Object[] { paramBundle.getMessage() });
      }
    }
    AppMethodBeat.o(182935);
    return bool1;
  ...
  public static String n(Bundle paramBundle, String paramString)
  {
    Object localObject = null;
    ...
    catch (Exception paramBundle)
    {
      for (;;)
      {
        ac.e("MicroMsg.IntentUtil", "getStringExtra exception:%s", new Object[] { paramBundle.getMessage() });
  ...
  public static byte[] q(Intent paramIntent, String paramString)
  {
    ...
    catch (Exception paramIntent)
    {
      for (;;)
      {
        ac.e("MicroMsg.IntentUtil", "getByteArrayExtra exception:%s", new Object[] { paramIntent.getMessage() });
        paramIntent = localObject;
      }
    }
  }
  ...
  public static Parcelable r(Intent paramIntent, String paramString)
  {
    ...
    catch (Exception paramIntent)
    {
      for (;;)
      {
        ac.e("MicroMsg.IntentUtil", "getParcelableExtra exception:%s", new Object[] { paramIntent.getMessage() });
        paramIntent = localObject;
      }
    }
  }
