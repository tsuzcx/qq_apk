...
public class af<K, V>
{
  ...
  /* Error */
  public final boolean aL(K paramK)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   7: aload_0
    //   8: aload_1
    //   9: invokevirtual 90	com/tencent/mm/sdk/platformtools/af:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   12: ifnull +14 -> 26
    //   15: iconst_1
    //   16: istore_2
    //   17: ldc 86
  ...
  public final V get(K paramK)
  {
    ...
    if (paramK == null)
    {
      ac.e("MicroMsg.LruMap", "key == null %s", new Object[] { bs.eWi().toString() });
  ...
  public final V put(K paramK, V paramV)
  {
    ...
    if ((paramK == null) || (paramV == null)) {
      ac.e("MicroMsg.LruMap", "put key == null or value == null [%s, %s], %s", new Object[] { paramK, paramV, bs.eWi().toString() });
    }
    try
    {
      this.putCount += 1;
  ...
  public final void setMaxSize(int paramInt)
  {
    ...
    ac.i("LruCache", "setMaxSize %s", new Object[] { Integer.valueOf(paramInt) });
    this.maxSize = paramInt;
    AppMethodBeat.o(157590);
  }
