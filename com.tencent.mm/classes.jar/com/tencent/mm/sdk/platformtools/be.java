...
{
  public LinkedBlockingQueue<be.a> EWq;
  private int EWr;
  Vector<b> EWs;
  ap EWt;
  boolean dsU;
  ...
  public be(int paramInt1, String paramString, int paramInt2, Looper paramLooper)
  {
    ...
    this.EWq = new LinkedBlockingQueue();
    this.dsU = false;
    this.EWr = 1;
    this.priority = 1;
    this.name = "";
    ...
    this.EWt = new be.1(this, paramString);
  ...
  public final int c(be.a parama)
  {
    ...
    try
    {
      if (!this.EWq.offer(parama, 1L, TimeUnit.MILLISECONDS))
      {
    ...
    if ((this.EWs.size() == 0) || ((this.EWq.size() > 0) && (this.EWr > this.EWs.size()))) {
      new b((byte)0).start();
    }
    AppMethodBeat.o(157797);
    return 0;
    ...
    extends Thread
  {
    ...
    public final void run()
    {
      ...
      //   5: aload_0
      //   6: getfield 31	com/tencent/mm/sdk/platformtools/be$b:Bdb	I
      //   9: ifle +157 -> 166
      //   12: aload_0
      //   13: getfield 15	com/tencent/mm/sdk/platformtools/be$b:EWu	Lcom/tencent/mm/sdk/platformtools/be;
      //   16: getfield 63	com/tencent/mm/sdk/platformtools/be:lock	Ljava/lang/Object;
      //   19: astore_1
      //   20: aload_1
      //   21: monitorenter
      //   22: aload_0
      //   23: getfield 15	com/tencent/mm/sdk/platformtools/be$b:EWu	Lcom/tencent/mm/sdk/platformtools/be;
      //   26: getfield 67	com/tencent/mm/sdk/platformtools/be:dsU	Z
      //   29: ifeq +13 -> 42
      //   32: aload_0
      //   33: getfield 15	com/tencent/mm/sdk/platformtools/be$b:EWu	Lcom/tencent/mm/sdk/platformtools/be;
      //   36: getfield 63	com/tencent/mm/sdk/platformtools/be:lock	Ljava/lang/Object;
      //   39: invokevirtual 72	java/lang/Object:wait	()V
      //   42: aload_1
      //   43: monitorexit
      //   44: aload_0
      //   45: getfield 15	com/tencent/mm/sdk/platformtools/be$b:EWu	Lcom/tencent/mm/sdk/platformtools/be;
      //   48: getfield 76	com/tencent/mm/sdk/platformtools/be:EWq	Ljava/util/concurrent/LinkedBlockingQueue;
      //   51: ldc2_w 77
      ...
      //   68: aload_0
      //   69: aload_0
      //   70: getfield 31	com/tencent/mm/sdk/platformtools/be$b:Bdb	I
      //   73: iconst_1
      //   74: isub
      //   75: putfield 31	com/tencent/mm/sdk/platformtools/be$b:Bdb	I
      //   78: goto -73 -> 5
      //   81: astore_2
      //   82: ldc 94
      //   84: aload_2
      ...
      //   125: aload_0
      //   126: bipush 60
      //   128: putfield 31	com/tencent/mm/sdk/platformtools/be$b:Bdb	I
      //   131: aload_1
      //   132: invokeinterface 106 1 0
      //   137: ifeq -132 -> 5
      //   140: aload_0
      //   141: getfield 15	com/tencent/mm/sdk/platformtools/be$b:EWu	Lcom/tencent/mm/sdk/platformtools/be;
      //   144: getfield 110	com/tencent/mm/sdk/platformtools/be:EWt	Lcom/tencent/mm/sdk/platformtools/ap;
      //   147: aload_0
      //   148: getfield 15	com/tencent/mm/sdk/platformtools/be$b:EWu	Lcom/tencent/mm/sdk/platformtools/be;
      //   151: getfield 110	com/tencent/mm/sdk/platformtools/be:EWt	Lcom/tencent/mm/sdk/platformtools/ap;
      //   154: iconst_0
      //   155: aload_1
      ...
      //   163: goto -158 -> 5
      //   166: aload_0
      //   167: getfield 15	com/tencent/mm/sdk/platformtools/be$b:EWu	Lcom/tencent/mm/sdk/platformtools/be;
      //   170: getfield 41	com/tencent/mm/sdk/platformtools/be:EWs	Ljava/util/Vector;
      //   173: aload_0
      ...
      //   189: aload_0
      //   190: getfield 15	com/tencent/mm/sdk/platformtools/be$b:EWu	Lcom/tencent/mm/sdk/platformtools/be;
      //   193: getfield 76	com/tencent/mm/sdk/platformtools/be:EWq	Ljava/util/concurrent/LinkedBlockingQueue;
      ...
      //   207: aload_0
      //   208: getfield 15	com/tencent/mm/sdk/platformtools/be$b:EWu	Lcom/tencent/mm/sdk/platformtools/be;
      //   211: getfield 41	com/tencent/mm/sdk/platformtools/be:EWs	Ljava/util/Vector;
