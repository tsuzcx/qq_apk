...
public abstract class bo<R>
{
  ...
  private Runnable cAL = new Runnable()
  {
    public final void run()
    {
      ...
      ad.i("MicroMsg.SDK.SyncTask", "task run manualFinish = " + bo.this.cAK);
      if (bo.this.cAK) {
        bo.this.run();
      }
      for (;;)
      {
        bo.this.cAJ = bt.aO(bo.this.cAI);
        AppMethodBeat.o(157837);
        return;
        bo.this.aG(bo.this.run());
      }
    }
  };
  ...
  public final R b(ap paramap)
  {
    ...
    //   77: invokestatic 109	com/tencent/e/j/a:fVV	()Ljava/lang/String;
    //   80: invokevirtual 115	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   83: istore_2
    //   84: goto -32 -> 52
    //   87: aload_0
    //   88: invokestatic 120	com/tencent/mm/sdk/platformtools/bt:HI	()J
    //   91: putfield 122	com/tencent/mm/sdk/platformtools/bo:cAI	J
    //   94: aload_0
    ...
    //   110: aload_1
    //   111: aload_0
    //   112: getfield 37	com/tencent/mm/sdk/platformtools/bo:cAL	Ljava/lang/Runnable;
    ...
    //   123: aload_0
    //   124: getfield 39	com/tencent/mm/sdk/platformtools/bo:cAH	J
    //   127: invokevirtual 132	java/lang/Object:wait	(J)V
    //   130: aload 5
    //   132: monitorexit
    //   133: aload_0
    //   134: getfield 122	com/tencent/mm/sdk/platformtools/bo:cAI	J
    //   137: invokestatic 136	com/tencent/mm/sdk/platformtools/bt:aO	(J)J
    //   140: lstore_3
    //   141: ldc 48
    //   143: ldc 138
    //   145: iconst_4
    ...
    //   177: iconst_2
    //   178: aload_0
    //   179: getfield 156	com/tencent/mm/sdk/platformtools/bo:cAJ	J
    ...
    //   188: lload_3
    //   189: aload_0
    //   190: getfield 156	com/tencent/mm/sdk/platformtools/bo:cAJ	J
    //   193: lsub
