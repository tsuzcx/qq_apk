...
public final class aa
{
  ...
  private static int cx(byte[] paramArrayOfByte)
  {
    int i = 0;
  ...
  public final int aQp(String paramString)
  {
  ...
  public final int cy(byte[] paramArrayOfByte)
  {
    AppMethodBeat.i(157574);
    if (cx(paramArrayOfByte) != 0)
    {
