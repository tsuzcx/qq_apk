...
public final class bu
{
  ...
  private static final long[] IAQ;
  public static final long[] iSV;
  ...
  static
  {
    ...
    IAQ = new long[] { 300L, 50L, 300L, 50L };
    GMT = TimeZone.getTimeZone("GMT");
    syS = BigInteger.ONE.shiftLeft(64);
    mTF = new char[] { 60, 62, 34, 39, 38, 13, 10, 32, 9 };
    mTG = new String[] { "&lt;", "&gt;", "&quot;", "&apos;", "&amp;", "&#x0D;", "&#x0A;", "&#x20;", "&#x09;" };
  ...
  public static long DD(long paramLong)
  {
  ...
  public static int DE(long paramLong)
  {
  ...
  public static String Dz(long paramLong)
  {
  ...
  public static void F(Context paramContext, boolean paramBoolean)
  {
    ...
    {
      ae.w("MicroMsg.Util", "shake:vibrator is null!");
      AppMethodBeat.o(157883);
      return;
    }
    if (paramBoolean)
    {
      paramContext.vibrate(iSV, -1);
      AppMethodBeat.o(157883);
      return;
    }
    paramContext.cancel();
  ...
  public static String S(InputStream paramInputStream)
  {
    ...
    try
    {
      ...
      catch (IOException paramInputStream)
      {
        for (;;)
        {
          ae.printErrStackTrace("MicroMsg.Util", paramInputStream, "", new Object[0]);
        }
      }
    }
  ...
  public static final String XY(String paramString)
  {
    ...
    {
      ae.printErrStackTrace("MicroMsg.Util", localMalformedURLException, "", new Object[0]);
      ae.w("MicroMsg.Util", "get host error");
      AppMethodBeat.o(157935);
    }
    return paramString;
  }
  ...
  private static String a(Context paramContext, Uri paramUri, String paramString, String[] paramArrayOfString)
  {
    ...
    //   9: aload_0
    //   10: invokevirtual 384	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   13: aload_1
    //   14: iconst_1
    ...
    //   25: aload_3
    //   26: aconst_null
    //   27: invokevirtual 392	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   30: astore_0
    //   31: aload_0
    //   32: ifnull +88 -> 120
    //   35: aload_0
    //   36: invokeinterface 398 1 0
    //   41: ifeq +79 -> 120
    //   44: aload_0
    //   45: ldc_w 386
    //   48: invokeinterface 402 2 0
    //   53: istore 4
    //   55: iload 4
    //   57: iconst_m1
    //   58: if_icmpne +35 -> 93
    //   61: ldc 224
    //   63: ldc_w 404
    //   66: invokestatic 407	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   69: aload_0
    ...
    //   93: aload_0
    //   94: iload 4
    //   96: invokeinterface 412 2 0
    //   101: astore_2
    //   102: aload_0
    //   103: ifnull +9 -> 112
    //   106: aload_0
    //   107: invokeinterface 408 1 0
    //   112: ldc_w 380
    ...
    //   141: astore_0
    //   142: aload_1
    //   143: invokevirtual 417	android/net/Uri:getPath	()Ljava/lang/String;
    //   146: astore_2
    //   147: aload_2
    //   148: astore_1
    //   149: bipush 24
    //   151: invokestatic 423	com/tencent/mm/compatible/util/d:lA	(I)Z
    //   154: ifeq +14 -> 168
    //   157: aload_2
    //   158: ldc_w 425
    //   161: ldc_w 286
    //   164: invokevirtual 429	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   167: astore_1
    //   168: aload_0
    //   169: ifnull +9 -> 178
    //   172: aload_0
    //   173: invokeinterface 408 1 0
    //   178: ldc_w 380
  ...
  public static byte[] aG(Bitmap paramBitmap)
  {
    AppMethodBeat.i(157872);
    ByteArrayOutputStream localByteArrayOutputStream = new ByteArrayOutputStream();
    paramBitmap.compress(Bitmap.CompressFormat.JPEG, 100, localByteArrayOutputStream);
    ae.i("MicroMsg.Util", "recycle bitmap:%s", new Object[] { paramBitmap });
    paramBitmap.recycle();
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ae.printErrStackTrace("MicroMsg.Util", localException, "", new Object[0]);
      }
    }
  }
  ...
  public static int aSB(String paramString)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (paramString != null)
        {
          ae.e("MicroMsg.Util", "parserInt error ".concat(String.valueOf(paramString)));
          i = j;
        }
      }
    }
  ...
  public static long aSC(String paramString)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (paramString != null)
        {
          ae.e("MicroMsg.Util", "parseLong error ".concat(String.valueOf(paramString)));
          l1 = l2;
        }
      }
    }
  ...
  public static double aSD(String paramString)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (paramString != null)
        {
          ae.e("MicroMsg.Util", "parseDouble error ".concat(String.valueOf(paramString)));
          d1 = d2;
        }
      }
    }
  ...
  public static float aSE(String paramString)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (paramString != null)
        {
          ae.e("MicroMsg.Util", "parseFloat error ".concat(String.valueOf(paramString)));
          f1 = f2;
        }
      }
    }
  ...
  public static byte[] aSF(String paramString)
  {
    AppMethodBeat.i(157954);
    if ((paramString == null) || (paramString.length() == 0))
    {
      ae.e("MicroMsg.Util", "httpGet, url is null");
  ...
  /* Error */
  private static byte[] aSG(String paramString)
  {
    // Byte code:
    //   0: ldc_w 628
    //   3: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: new 329	java/net/URL
    //   9: dup
    //   10: aload_0
    //   11: invokespecial 330	java/net/URL:<init>	(Ljava/lang/String;)V
    //   14: invokevirtual 632	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   17: checkcast 634	java/net/HttpURLConnection
    //   20: astore_0
    //   21: aload_0
    //   22: ldc_w 636
    //   25: invokevirtual 639	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   28: aload_0
    //   29: invokevirtual 642	java/net/HttpURLConnection:getResponseCode	()I
    //   32: istore_1
    //   33: iload_1
    //   34: sipush 200
    //   37: if_icmpeq +46 -> 83
    ...
    //   50: iconst_0
    //   51: iload_1
    //   52: invokestatic 647	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   55: aastore
    //   56: invokestatic 649	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   59: aconst_null
    //   60: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   63: aconst_null
    //   64: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   67: aload_0
    //   68: ifnull +7 -> 75
    //   71: aload_0
    //   72: invokevirtual 656	java/net/HttpURLConnection:disconnect	()V
    //   75: ldc_w 628
    //   78: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   81: aconst_null
    //   82: areturn
    //   83: new 658	java/io/BufferedInputStream
    //   86: dup
    //   87: aload_0
    //   88: invokevirtual 662	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   91: invokespecial 665	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   94: astore 4
    //   96: new 489	java/io/ByteArrayOutputStream
    //   99: dup
    //   100: invokespecial 490	java/io/ByteArrayOutputStream:<init>	()V
    //   103: astore_2
    //   104: sipush 4096
    //   107: newarray byte
    //   109: astore_3
    //   110: aload 4
    //   112: aload_3
    //   113: invokevirtual 666	java/io/BufferedInputStream:read	([B)I
    //   116: istore_1
    //   117: iload_1
    //   118: ifle +20 -> 138
    //   121: aload_2
    ...
    //   123: iconst_0
    //   124: iload_1
    //   125: invokevirtual 669	java/io/ByteArrayOutputStream:write	([BII)V
    //   128: aload 4
    //   130: aload_3
    //   131: invokevirtual 666	java/io/BufferedInputStream:read	([B)I
    //   134: istore_1
    //   135: goto -18 -> 117
    //   138: aload_2
    //   139: invokevirtual 514	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   142: astore_3
    //   143: aload 4
    //   145: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   148: aload_2
    //   149: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   152: aload_0
    //   153: ifnull +7 -> 160
    //   156: aload_0
    //   157: invokevirtual 656	java/net/HttpURLConnection:disconnect	()V
    //   160: ldc_w 628
    ...
    //   186: iconst_0
    //   187: aload_0
    //   188: invokevirtual 674	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   191: aastore
    //   192: invokestatic 649	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   195: aload 4
    //   197: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   200: aload_2
    //   201: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   204: aload_3
    //   205: ifnull +7 -> 212
    //   208: aload_3
    //   209: invokevirtual 656	java/net/HttpURLConnection:disconnect	()V
    //   212: ldc_w 628
    ...
    //   227: astore_3
    //   228: aload 4
    //   230: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   233: aload_2
    //   234: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   237: aload_3
    //   238: ifnull +7 -> 245
    //   241: aload_3
    //   242: invokevirtual 656	java/net/HttpURLConnection:disconnect	()V
    //   245: ldc_w 628
  ...
  /* Error */
  private static byte[] aSH(String paramString)
  {
    // Byte code:
    //   0: ldc_w 675
    //   3: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    //   11: invokespecial 330	java/net/URL:<init>	(Ljava/lang/String;)V
    //   14: invokevirtual 632	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   17: checkcast 677	javax/net/ssl/HttpsURLConnection
    //   20: astore_0
    //   21: aload_0
    //   22: ldc_w 636
    //   25: invokevirtual 639	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    ...
    //   142: astore_3
    //   143: aload 4
    //   145: invokevirtual 680	java/io/BufferedInputStream:close	()V
    //   148: aload_2
    //   149: invokevirtual 515	java/io/ByteArrayOutputStream:close	()V
    //   152: aload 4
    //   154: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   157: aload_2
    //   158: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   161: aload_0
    //   162: ifnull +7 -> 169
    //   165: aload_0
    //   166: invokevirtual 656	java/net/HttpURLConnection:disconnect	()V
    //   169: ldc_w 675
    ...
    //   195: iconst_0
    //   196: aload_0
    //   197: invokevirtual 674	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   200: aastore
    //   201: invokestatic 649	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   204: aload 4
    //   206: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   209: aload_2
    //   210: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   213: aload_3
    //   214: ifnull +7 -> 221
    //   217: aload_3
    //   218: invokevirtual 656	java/net/HttpURLConnection:disconnect	()V
    //   221: ldc_w 675
    ...
    //   236: astore_3
    //   237: aload 4
    //   239: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   242: aload_2
    //   243: invokestatic 653	com/tencent/mm/sdk/platformtools/bu:d	(Ljava/io/Closeable;)V
    //   246: aload_3
    //   247: ifnull +7 -> 254
    //   250: aload_3
    //   251: invokevirtual 656	java/net/HttpURLConnection:disconnect	()V
    //   254: ldc_w 675
  ...
  private static byte[] aSI(String paramString)
  {
    ...
    {
      ae.e("MicroMsg.Util", "decode base64 url failed : %s", new Object[] { paramString.getMessage() });
      AppMethodBeat.o(157957);
    }
    return null;
  }
  ...
  public static boolean aSN(String paramString)
  {
    ...
    try
    {
      String str = new File(o.k(paramString, false)).getCanonicalPath();
      boolean bool = aSO(str);
      AppMethodBeat.o(157970);
      return bool;
    }
    catch (NullPointerException localNullPointerException)
    {
      ae.printErrStackTrace("MicroMsg.Util", localNullPointerException, "[-] Fail to resolve canonical path of %s", new Object[] { paramString });
      AppMethodBeat.o(157970);
      return false;
    }
    catch (IOException localIOException)
    {
      ae.printErrStackTrace("MicroMsg.Util", localIOException, "[-] Fail to resolve canonical path of %s", new Object[] { paramString });
      AppMethodBeat.o(157970);
    }
    return false;
  }
  ...
  public static boolean aSO(String paramString)
  {
    ...
    String str1 = e.fnL().getPackageName();
  ...
  public static boolean aSP(String paramString)
  {
    ...
    boolean bool = aSQ(paramString.substring(i + 1));
    AppMethodBeat.o(157971);
    return bool;
  }
  ...
  public static int aSs(String paramString)
  {
  ...
  public static byte[] aSx(String paramString)
  {
  ...
  public static int[] aSy(String paramString)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        catch (Exception localException)
        {
          ...
          {
            ae.printErrStackTrace("MicroMsg.Util", localException, "", new Object[0]);
            ae.e("MicroMsg.Util", "invalid port num, ignore");
          }
        }
      }
    }
    ...
    if (j < n)
    {
      ...
      for (;;)
      {
        ...
        if (k >= 0)
        {
          if (mTF[k] == c)
          {
            localStringBuffer.append(mTG[k]);
            i = 0;
          }
        }
        else
  ...
  public static String abf(int paramInt)
  {
  ...
  public static String ad(byte[] paramArrayOfByte, int paramInt)
  {
  ...
  public static boolean ah(CharSequence paramCharSequence)
  {
  ...
  public static Intent ak(Context paramContext, Intent paramIntent)
  {
    ...
    ae.d("MicroMsg.Util", "createExplicitFromImplicitIntent pa:%s, cl:%s", new Object[] { paramContext, localObject });
  ...
  public static boolean az(long paramLong1, long paramLong2)
  {
  ...
  public static String cD(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = ad(paramArrayOfByte, 0);
  ...
  public static String cK(Context paramContext)
  {
    ...
    {
      ae.printErrStackTrace("MicroMsg.Util", paramContext, "", new Object[0]);
      AppMethodBeat.o(157900);
    }
    return "(null)";
  }
  ...
  public static int cN(String paramString, int paramInt)
  {
    ...
    {
      ae.printErrStackTrace("MicroMsg.Util", localException, "colorString:%s", new Object[] { paramString });
      AppMethodBeat.o(157999);
    }
    return paramInt;
  }
  ...
  public static boolean cd(Context paramContext, String paramString)
  {
    ...
    while (paramContext.hasNext())
    {
      ...
      {
        ae.w("MicroMsg.Util", "service " + paramString + " is running");
        AppMethodBeat.o(157898);
        return true;
      }
    }
    ae.w("MicroMsg.Util", "service " + paramString + " is not running");
    AppMethodBeat.o(157898);
    return false;
  }
  ...
  public static boolean ce(Context paramContext, String paramString)
  {
    ...
    {
      ae.e("MicroMsg.Util", "jump to url failed, ".concat(String.valueOf(paramString)));
      AppMethodBeat.o(157937);
      return false;
    }
    paramString = new com.tencent.mm.hellhoundlib.b.a().bc(localIntent);
    com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramString.ahE(), "com/tencent/mm/sdk/platformtools/Util", "jump", "(Landroid/content/Context;Ljava/lang/String;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
  ...
  public static boolean checkPermission(Context paramContext, String paramString)
  {
    ...
    {
      ae.d("MicroMsg.Util", paramContext + paramString);
  ...
  public static String convertStreamToString(InputStream paramInputStream)
  {
    ...
    catch (IOException localIOException)
    {
      ...
      ae.printErrStackTrace("MicroMsg.Util", localIOException, "", new Object[0]);
      try
      {
        paramInputStream.close();
        for (;;)
  ...
  public static void d(Closeable paramCloseable)
  {
    ...
    {
      ae.printErrStackTrace("MicroMsg.Util", paramCloseable, "qualityClose", new Object[0]);
      AppMethodBeat.o(157985);
    }
  }
  
  public static String dU(Object paramObject)
  {
  ...
  public static long dV(Object paramObject)
  {
  ...
  public static byte[] fpG()
  {
    AppMethodBeat.i(157863);
    try
    {
      InputStream localInputStream = o.openRead("/dev/urandom");
  ...
  public static long fpK()
  {
    ...
    {
      ae.e("MicroMsg.Util", "getDataAvailableSize exception:%s", new Object[] { localException.getMessage() });
      AppMethodBeat.o(157893);
    }
    return 0L;
  }
  
  public static View.OnTouchListener fpL()
  {
    ...
    View.OnTouchListener local1 = new View.OnTouchListener()
    {
      public final boolean onTouch(final View paramAnonymousView, MotionEvent paramAnonymousMotionEvent)
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/sdk/platformtools/Util$1", "android/view/View$OnTouchListener", "onTouch", "(Landroid/view/View;Landroid/view/MotionEvent;)Z", this, localb.ahF());
  ...
  /* Error */
  private static List<String> fpQ()
  {
    // Byte code:
    //   0: ldc_w 1400
    //   3: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: new 310	java/util/ArrayList
    //   9: dup
    //   10: invokespecial 311	java/util/ArrayList:<init>	()V
    //   13: astore_3
    ...
    //   57: astore_0
    //   58: aload 4
    //   60: invokevirtual 544	java/lang/String:length	()I
    //   63: ifle -20 -> 43
    //   66: aload_1
    //   67: astore_0
    //   68: aload_3
    //   69: aload 4
    //   71: invokeinterface 971 2 0
    //   76: pop
    //   77: goto -34 -> 43
    //   80: astore_2
    //   81: aload_1
    ...
    //   93: iconst_0
    //   94: aload_2
    //   95: invokevirtual 674	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   98: aastore
    //   99: invokestatic 649	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   102: aload_1
    //   103: ifnull +7 -> 110
    //   106: aload_1
    ...
    //   120: iconst_0
    //   121: aload_3
    //   122: invokeinterface 976 1 0
    //   127: invokestatic 647	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   130: aastore
    //   131: invokestatic 507	com/tencent/mm/sdk/platformtools/ae:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   134: ldc_w 1400
    ...
    //   173: iconst_0
    //   174: aload_0
    //   175: invokevirtual 674	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   178: aastore
    //   179: invokestatic 649	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   182: goto -72 -> 110
    //   185: astore_0
    //   186: ldc 224
    //   188: ldc_w 1432
    ...
    //   196: iconst_0
    //   197: aload_0
    //   198: invokevirtual 674	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   201: aastore
    //   202: invokestatic 649	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   205: goto -95 -> 110
    //   208: astore_1
    //   209: aconst_null
    //   210: astore_0
    ...
    //   238: iconst_0
    //   239: aload_0
    //   240: invokevirtual 674	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   243: aastore
    //   244: invokestatic 649	com/tencent/mm/sdk/platformtools/ae:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   247: goto -28 -> 219
    //   250: astore_1
    //   251: goto -40 -> 211
    //   254: astore_2
  ...
  public static String getProcessNameByPid(Context paramContext, int paramInt)
  {
    ...
    //   31: checkcast 522	android/app/ActivityManager
    //   34: invokevirtual 1459	android/app/ActivityManager:getRunningAppProcesses	()Ljava/util/List;
    //   37: invokeinterface 529 1 0
    //   42: astore_0
    //   43: aload_0
    //   44: invokeinterface 450 1 0
    //   49: ifeq +73 -> 122
    //   52: aload_0
    //   53: invokeinterface 454 1 0
    //   58: checkcast 1461	android/app/ActivityManager$RunningAppProcessInfo
    //   61: astore 4
    //   63: aload 4
    //   65: getfield 1464	android/app/ActivityManager$RunningAppProcessInfo:pid	I
    //   68: iload_1
    //   69: if_icmpne -26 -> 43
    //   72: aload 4
    //   74: getfield 1467	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   77: ifnull -34 -> 43
    //   80: aload 4
    //   82: getfield 1467	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   85: ldc_w 286
    //   88: invokevirtual 830	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   91: ifne -48 -> 43
    //   94: aload 4
    //   96: getfield 1467	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   99: astore_0
    //   100: ldc_w 1456
    ...
    //   115: iconst_0
    //   116: anewarray 4	java/lang/Object
    //   119: invokestatic 290	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   122: sipush 128
    //   125: newarray byte
    //   127: astore 5
    //   129: aconst_null
    //   130: astore_0
    //   131: new 658	java/io/BufferedInputStream
    //   134: dup
    //   135: new 1469	java/io/FileInputStream
    //   138: dup
    //   139: new 368	java/lang/StringBuilder
    //   142: dup
    //   143: ldc_w 1471
    //   146: invokespecial 467	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   149: iload_1
    //   150: invokevirtual 764	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   153: ldc_w 1473
    //   156: invokevirtual 377	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   159: invokevirtual 378	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   162: invokespecial 1474	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   165: invokespecial 665	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   168: astore 4
    //   170: aload 4
    //   172: astore_0
    //   173: aload 4
    ...
    //   261: invokestatic 290	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   264: aload 4
    //   266: ifnull -34 -> 232
    //   269: aload 4
  ...
  public static int gs(String paramString, int paramInt)
  {
  ...
  public static boolean hideVKB(View paramView)
  {
    ...
    catch (Exception paramView)
    {
      for (;;)
      {
        ae.printErrStackTrace("MicroMsg.Util", paramView, "", new Object[0]);
        ae.e("MicroMsg.Util", "hide VKB exception %s", new Object[] { paramView });
        boolean bool = false;
      }
    }
    ae.v("MicroMsg.Util", "hide VKB result %B", new Object[] { Boolean.valueOf(bool) });
    AppMethodBeat.o(157928);
    return bool;
  }
  
  public static String[] hs(List<String> paramList)
  {
  ...
  public static boolean ht(List paramList)
  {
  ...
  public static boolean isProcessRunning(Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      {
        ae.i("MicroMsg.Util", "isProcessRunning, use ActivityManager. process = %s", new Object[] { paramString });
      ...
      while (paramContext.hasNext())
      {
        ...
        {
          ae.w("MicroMsg.Util", "process " + paramString + " is running");
          AppMethodBeat.o(157899);
          return true;
          ae.i("MicroMsg.Util", "isProcessRunning, use ps command. process = %s", new Object[] { paramString });
          paramContext = fpQ().iterator();
          while (paramContext.hasNext())
          {
            localObject = (String)paramContext.next();
            ae.d("MicroMsg.Util", "isProcessRunning, process command line = %s", new Object[] { localObject });
            if ((localObject != null) && (((String)localObject).contains(paramString)))
            {
              ...
              while (i < localObject.length)
              {
                ...
                {
                  ae.i("MicroMsg.Util", "process %s is running", new Object[] { paramString });
                  AppMethodBeat.o(157899);
                  return true;
                }
                i += 1;
      ...
      ae.w("MicroMsg.Util", "process " + paramString + " is not running");
    }
    catch (Exception paramContext)
    {
      for (;;)
  ...
  public static int jA(int paramInt1, int paramInt2)
  {
  ...
  public static boolean jB(int paramInt1, int paramInt2)
  {
    return paramInt1 == paramInt2;
  }
  ...
  public static void jj(Context paramContext)
  {
    ...
    paramContext.vibrate(IAQ, -1);
    AppMethodBeat.o(157884);
  }
  
  public static long jk(Context paramContext)
  {
  ...
  public static String jl(Context paramContext)
  {
    ...
    try
    {
      ...
      if (paramContext == null)
      {
        ae.e("MicroMsg.Util", "getLine1Number failed, null tm");
        AppMethodBeat.o(157895);
        return null;
      }
    ...
    {
      ae.e("MicroMsg.Util", "getLine1Number failed:%s ", new Object[] { au.o(paramContext) });
      AppMethodBeat.o(157895);
    }
    return null;
  }
  
  public static String jm(Context paramContext)
  {
    AppMethodBeat.i(157896);
    if (paramContext == null)
    {
      ae.w("MicroMsg.Util", "getSimCountryCode context is null.");
  ...
  public static boolean jn(Context paramContext)
  {
    ...
    ae.d("MicroMsg.Util", "top activity=" + paramContext + ", context=" + str);
    boolean bool = paramContext.equalsIgnoreCase(str);
    AppMethodBeat.o(157897);
    return bool;
  }
  
  public static boolean jo(Context paramContext)
  {
    ...
    try
    {
      ...
      ae.d("MicroMsg.Util", "top activity=" + str + ", context=" + paramContext);
  ...
  public static String jp(Context paramContext)
  {
  ...
  public static boolean jq(Context paramContext)
  {
    ...
    if (paramContext == null)
    {
      ae.w("MicroMsg.Util", "isOverseasUser context is null");
      AppMethodBeat.o(157952);
      return false;
    }
    paramContext = (TelephonyManager)paramContext.getSystemService("phone");
  ...
  public static a jr(Context paramContext)
  {
  ...
  public static ComponentName js(Context paramContext)
  {
    ...
    {
      ae.e("MicroMsg.Util", "get Top Activity Exception:%s", new Object[] { paramContext.getMessage() });
      AppMethodBeat.o(157974);
    }
    return null;
  }
  
  public static String jt(Context paramContext)
  {
    ...
    {
      ae.e("MicroMsg.Util", "getTopActivityName Exception:%s stack:%s", new Object[] { paramContext.getMessage(), au.o(paramContext) });
      AppMethodBeat.o(157975);
    }
    return "";
  }
  ...
  public static int ju(Context paramContext)
  {
    ...
    if (paramContext == null)
    {
      ae.i("MicroMsg.Util", "getSelfMemInMB context is null.");
  ...
  public static String k(Context paramContext, Uri paramUri)
  {
    ...
    {
      ae.e("MicroMsg.Util", "getFilePath : context is null or uri is null");
    ...
    if (isNullOrNil(str1))
    {
      ae.e("MicroMsg.Util", "input uri error. %s", new Object[] { paramUri });
      AppMethodBeat.o(157968);
      return null;
    }
    if (str1.equalsIgnoreCase("file"))
    {
      ae.i("MicroMsg.Util", "getFilePath : scheme is SCHEME_FILE");
    ...
    {
      ae.i("MicroMsg.Util", "getFilePath : scheme is SCHEME_CONTENT: " + paramUri.toString());
      ...
      catch (SecurityException localSecurityException)
      {
        for (;;)
        {
          ae.e("MicroMsg.Util", "getFilePath : exception = ".concat(String.valueOf(localSecurityException)));
          arrayOfString = null;
        }
    ...
    label469:
    ae.e("MicroMsg.Util", "unknown scheme");
    AppMethodBeat.o(157968);
    return null;
  }
  ...
  public static List<String> lV(String paramString1, String paramString2)
  {
  ...
  public static int lW(String paramString1, String paramString2)
  {
    AppMethodBeat.i(157934);
    int i = o.fD(paramString1, paramString2);
    AppMethodBeat.o(157934);
    return i;
  }
  
  public static boolean lX(String paramString1, String paramString2)
  {
  ...
  public static int o(Integer paramInteger)
  {
  ...
  public static String o(Throwable paramThrowable)
  {
    ...
    paramThrowable = au.o(paramThrowable);
  ...
  public static byte[] readFromFile(String paramString)
  {
    ...
    //   3: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: aload_0
    //   7: invokestatic 322	com/tencent/mm/sdk/platformtools/bu:isNullOrNil	(Ljava/lang/String;)Z
    //   10: ifeq +19 -> 29
    //   13: ldc 224
    //   15: ldc_w 1901
    //   18: invokestatic 232	com/tencent/mm/sdk/platformtools/ae:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   21: ldc_w 1899
    //   24: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   27: aconst_null
    //   28: areturn
    //   29: new 1281	com/tencent/mm/vfs/k
    //   32: dup
    //   33: aload_0
    //   34: invokespecial 1282	com/tencent/mm/vfs/k:<init>	(Ljava/lang/String;)V
    //   37: astore_3
    //   38: aload_3
    //   39: invokevirtual 1285	com/tencent/mm/vfs/k:exists	()Z
    //   42: ifne +27 -> 69
    //   45: ldc 224
    //   47: ldc_w 1903
    //   50: iconst_1
    ...
    //   56: aload_0
    //   57: aastore
    //   58: invokestatic 1905	com/tencent/mm/sdk/platformtools/ae:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   61: ldc_w 1899
    //   64: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   67: aconst_null
    //   68: areturn
    //   69: aload_3
    //   70: invokevirtual 1907	com/tencent/mm/vfs/k:length	()J
    //   73: l2i
    //   74: istore_1
    //   75: aload_3
    //   76: invokestatic 1910	com/tencent/mm/vfs/o:ai	(Lcom/tencent/mm/vfs/k;)Ljava/io/InputStream;
    //   79: astore 4
    //   81: aload 4
    //   83: astore_3
    //   84: iload_1
    ...
    //   122: iconst_1
    //   123: iload_1
    //   124: invokestatic 647	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   127: aastore
    //   128: dup
    //   129: iconst_2
    //   130: iload_2
    //   131: invokestatic 647	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   134: aastore
    //   135: invokestatic 1905	com/tencent/mm/sdk/platformtools/ae:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   138: aload 4
    //   140: ifnull +8 -> 148
    //   143: aload 4
    ...
    //   167: invokestatic 290	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   170: goto -22 -> 148
    //   173: aload 4
    //   175: astore_3
    //   176: ldc 224
    //   178: ldc_w 1914
    //   181: invokestatic 1246	com/tencent/mm/sdk/platformtools/ae:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   184: aload 4
    //   186: ifnull +8 -> 194
    //   189: aload 4
    ...
    //   214: invokestatic 290	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   217: goto -23 -> 194
    //   220: astore_0
    //   221: aconst_null
    //   222: astore 4
    ...
    //   233: iconst_0
    //   234: anewarray 4	java/lang/Object
    //   237: invokestatic 290	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   240: aload 4
    //   242: ifnull +8 -> 250
    //   245: aload 4
    ...
    //   269: invokestatic 290	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   272: goto -22 -> 250
    //   275: astore_0
    //   276: aconst_null
    //   277: astore_3
    ...
    //   305: invokestatic 290	com/tencent/mm/sdk/platformtools/ae:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   308: goto -22 -> 286
    //   311: astore_0
    //   312: goto -34 -> 278
    //   315: astore_0
  ...
  public static boolean u(String paramString, byte[] paramArrayOfByte)
  {
    ...
    if ((isNullOrNil(paramString)) || (cF(paramArrayOfByte)))
    {
      ae.w("MicroMsg.Util", "write to file error, path is null or empty, or data is empty");
    ...
    try
    {
      paramString = o.db(paramString, false);
      str = paramString;
      ...
      {
        paramString.close();
        ae.d("MicroMsg.Util", "writeToFile ok!");
        AppMethodBeat.o(157949);
        return true;
      }
      ...
      catch (IOException paramArrayOfByte)
      {
        for (;;)
        {
          ae.printErrStackTrace("MicroMsg.Util", paramArrayOfByte, "", new Object[0]);
        }
      }
    }
    catch (Exception paramString)
    {
      ...
      ae.printErrStackTrace("MicroMsg.Util", paramString, "", new Object[0]);
      localObject = str;
      ae.w("MicroMsg.Util", "write to file error");
      if (str != null) {}
      try
      {
        str.close();
  ...
  public static String x(String paramString, Object... paramVarArgs)
  {
    ...
    catch (Exception paramVarArgs)
    {
      for (;;)
      {
        ae.i("MicroMsg.Util", "error safeFormatString %s", new Object[] { paramVarArgs.getMessage() });
      }
    }
  ...
  public static boolean z(Uri paramUri)
  {
    ...
    boolean bool = aSN(paramUri.getPath());
    AppMethodBeat.o(157969);
    return bool;
  }
  ...
  public static final class a
  {
    ...
    private static String jv(Context paramContext)
    {
      ...
      paramContext = paramContext.getPackageName();
      if ((localObject1 == null) || (bu.isNullOrNil(paramContext)))
      {
        AppMethodBeat.o(157855);
        return null;
      }
