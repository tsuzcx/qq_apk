...
{
  public static Locale Grx;
  
  static
  {
    AppMethodBeat.i(125269);
    if (Build.VERSION.SDK_INT < 24) {}
    for (Grx = Locale.getDefault();; Grx = LocaleList.getDefault().get(0))
    {
      Locale.setDefault(Grx);
  ...
  public static void a(Context paramContext, Locale paramLocale)
  {
    ...
    {
      ac.printErrStackTrace("MicroMsg.LocaleUtil", paramContext, "updateApplicationResourceLocale err~~~", new Object[0]);
      AppMethodBeat.o(125257);
    }
  }
  
  public static Locale aKK(String paramString)
  {
    ...
    ac.e("MicroMsg.LocaleUtil", "transLanguageToLocale country = ".concat(String.valueOf(paramString)));
    paramString = Locale.ENGLISH;
    AppMethodBeat.o(125259);
    return paramString;
  }
  ...
  public static void c(SharedPreferences paramSharedPreferences, String paramString)
  {
    ...
    {
      bo.setProperty("language_key", paramString);
      ac.w("MicroMsg.LocaleUtil", "save application lang as:".concat(String.valueOf(paramString)));
      AppMethodBeat.o(125265);
      return;
    }
    ac.e("MicroMsg.LocaleUtil", "saving application lang failed");
    AppMethodBeat.o(125265);
  }
  ...
  public static boolean eUM()
  {
    ...
    if ((eUO().equals("zh_TW")) || (eUO().equals("zh_HK")))
    {
  ...
  public static String eUO()
  {
    ...
    String str = bs.nullAsNil(bo.getProperty("language_key"));
  ...
  public static String f(SharedPreferences paramSharedPreferences)
  {
    ...
    paramSharedPreferences = bs.nullAsNil(paramSharedPreferences.getString("language_key", null));
    if ((paramSharedPreferences.length() > 0) && (!paramSharedPreferences.equals("language_default")))
    {
      bo.setProperty("language_key", paramSharedPreferences);
      AppMethodBeat.o(125263);
      return paramSharedPreferences;
    }
    paramSharedPreferences = aKL("en");
    bo.setProperty("language_key", paramSharedPreferences);
    AppMethodBeat.o(125263);
    return paramSharedPreferences;
  }
  ...
  public static String g(SharedPreferences paramSharedPreferences)
  {
    ...
    paramSharedPreferences = bs.nullAsNil(paramSharedPreferences.getString("language_key", null));
    if (!bs.isNullOrNil(paramSharedPreferences))
    {
  ...
  public static String iC(Context paramContext)
  {
    ...
    paramContext = g(paramContext.getSharedPreferences(ai.eUX(), 0));
    String str = eUO();
  ...
  public static String iD(Context paramContext)
  {
    ...
    String str = g(paramContext.getSharedPreferences(ai.eUX(), 0));
    if (str == null)
    {
  ...
  public static Locale initLanguage(Context paramContext)
  {
    ...
    Object localObject = f(paramContext.getSharedPreferences(ai.eUX(), 0));
    ...
    localObject = aKK((String)localObject);
