...
public final class bs
{
  ...
  private static final long[] GuK;
  public static final long[] iwT;
  ...
  static
  {
    ...
    GuK = new long[] { 300L, 50L, 300L, 50L };
    GMT = TimeZone.getTimeZone("GMT");
    rxq = BigInteger.ONE.shiftLeft(64);
    mnY = new char[] { 60, 62, 34, 39, 38, 13, 10, 32, 9 };
    mnZ = new String[] { "&lt;", "&gt;", "&quot;", "&apos;", "&amp;", "&#x0D;", "&#x0A;", "&#x20;", "&#x09;" };
  ...
  public static long Ap(long paramLong)
  {
  ...
  public static void D(Context paramContext, boolean paramBoolean)
  {
    ...
    {
      ac.w("MicroMsg.Util", "shake:vibrator is null!");
      AppMethodBeat.o(157883);
      return;
    }
    if (paramBoolean)
    {
      paramContext.vibrate(iwT, -1);
      AppMethodBeat.o(157883);
      return;
    }
    paramContext.cancel();
  ...
  public static String P(InputStream paramInputStream)
  {
    ...
    try
    {
      ...
      catch (IOException paramInputStream)
      {
        for (;;)
        {
          ac.printErrStackTrace("MicroMsg.Util", paramInputStream, "", new Object[0]);
        }
      }
    }
  ...
  public static final String TE(String paramString)
  {
    ...
    {
      ac.printErrStackTrace("MicroMsg.Util", localMalformedURLException, "", new Object[0]);
      ac.w("MicroMsg.Util", "get host error");
      AppMethodBeat.o(157935);
    }
    return paramString;
  }
  ...
  private static String a(Context paramContext, Uri paramUri, String paramString, String[] paramArrayOfString)
  {
    ...
    //   9: aload_0
    //   10: invokevirtual 425	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   13: aload_1
    //   14: iconst_1
    ...
    //   25: aload_3
    //   26: aconst_null
    //   27: invokevirtual 433	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   30: astore_0
    //   31: aload_0
    //   32: ifnull +88 -> 120
    //   35: aload_0
    //   36: invokeinterface 439 1 0
    //   41: ifeq +79 -> 120
    //   44: aload_0
    //   45: ldc_w 427
    //   48: invokeinterface 443 2 0
    //   53: istore 4
    //   55: iload 4
    //   57: iconst_m1
    //   58: if_icmpne +35 -> 93
    //   61: ldc 223
    //   63: ldc_w 445
    //   66: invokestatic 448	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   69: aload_0
    //   70: invokeinterface 449 1 0
    //   75: aload_0
    //   76: ifnull +9 -> 85
    //   79: aload_0
    //   80: invokeinterface 449 1 0
    //   85: ldc_w 421
    ...
    //   93: aload_0
    //   94: iload 4
    //   96: invokeinterface 452 2 0
    //   101: astore_2
    //   102: aload_0
    //   103: ifnull +9 -> 112
    //   106: aload_0
    //   107: invokeinterface 449 1 0
    //   112: ldc_w 421
    ...
    //   141: astore_0
    //   142: aload_1
    //   143: invokevirtual 457	android/net/Uri:getPath	()Ljava/lang/String;
    //   146: astore_2
    //   147: aload_2
    //   148: astore_1
    //   149: bipush 24
    //   151: invokestatic 463	com/tencent/mm/compatible/util/d:kZ	(I)Z
    //   154: ifeq +14 -> 168
    //   157: aload_2
    //   158: ldc_w 465
    //   161: ldc_w 285
    //   164: invokevirtual 469	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   167: astore_1
    //   168: aload_0
    //   169: ifnull +9 -> 178
    //   172: aload_0
    //   173: invokeinterface 449 1 0
    //   178: ldc_w 421
  ...
  public static byte[] aD(Bitmap paramBitmap)
  {
    ...
    ac.i("MicroMsg.Util", "recycle bitmap:%s", new Object[] { paramBitmap });
    paramBitmap.recycle();
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ac.printErrStackTrace("MicroMsg.Util", localException, "", new Object[0]);
      }
    }
  }
  
  public static ActivityManager.RunningTaskInfo aG(Context paramContext, int paramInt)
  {
  ...
  public static double aLA(String paramString)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (paramString != null)
        {
          ac.e("MicroMsg.Util", "parseDouble error ".concat(String.valueOf(paramString)));
          d1 = d2;
        }
      }
    }
  ...
  public static float aLB(String paramString)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (paramString != null)
        {
          ac.e("MicroMsg.Util", "parseFloat error ".concat(String.valueOf(paramString)));
          f1 = f2;
        }
      }
    }
  ...
  public static byte[] aLC(String paramString)
  {
    AppMethodBeat.i(157954);
    if ((paramString == null) || (paramString.length() == 0))
    {
      ac.e("MicroMsg.Util", "httpGet, url is null");
      AppMethodBeat.o(157954);
      return null;
    }
    if (URLUtil.isDataUrl(paramString))
    {
      paramString = aLF(paramString);
      AppMethodBeat.o(157954);
      return paramString;
    }
  ...
  /* Error */
  private static byte[] aLD(String paramString)
  {
    // Byte code:
    //   0: ldc_w 624
    //   3: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: new 328	java/net/URL
    //   9: dup
    //   10: aload_0
    //   11: invokespecial 329	java/net/URL:<init>	(Ljava/lang/String;)V
    //   14: invokevirtual 628	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   17: checkcast 630	java/net/HttpURLConnection
    //   20: astore_0
    //   21: aload_0
    //   22: ldc_w 632
    //   25: invokevirtual 635	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   28: aload_0
    //   29: invokevirtual 638	java/net/HttpURLConnection:getResponseCode	()I
    //   32: istore_1
    //   33: iload_1
    //   34: sipush 200
    //   37: if_icmpeq +46 -> 83
    ...
    //   50: iconst_0
    //   51: iload_1
    //   52: invokestatic 643	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   55: aastore
    //   56: invokestatic 645	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   59: aconst_null
    //   60: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   63: aconst_null
    //   64: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   67: aload_0
    //   68: ifnull +7 -> 75
    //   71: aload_0
    //   72: invokevirtual 652	java/net/HttpURLConnection:disconnect	()V
    //   75: ldc_w 624
    //   78: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   81: aconst_null
    //   82: areturn
    //   83: new 654	java/io/BufferedInputStream
    //   86: dup
    //   87: aload_0
    //   88: invokevirtual 658	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   91: invokespecial 661	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   94: astore 4
    //   96: new 529	java/io/ByteArrayOutputStream
    //   99: dup
    //   100: invokespecial 530	java/io/ByteArrayOutputStream:<init>	()V
    //   103: astore_2
    //   104: sipush 4096
    //   107: newarray byte
    //   109: astore_3
    //   110: aload 4
    //   112: aload_3
    //   113: invokevirtual 662	java/io/BufferedInputStream:read	([B)I
    //   116: istore_1
    //   117: iload_1
    //   118: ifle +20 -> 138
    //   121: aload_2
    ...
    //   123: iconst_0
    //   124: iload_1
    //   125: invokevirtual 665	java/io/ByteArrayOutputStream:write	([BII)V
    //   128: aload 4
    //   130: aload_3
    //   131: invokevirtual 662	java/io/BufferedInputStream:read	([B)I
    //   134: istore_1
    //   135: goto -18 -> 117
    //   138: aload_2
    //   139: invokevirtual 554	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   142: astore_3
    //   143: aload 4
    //   145: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   148: aload_2
    //   149: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   152: aload_0
    //   153: ifnull +7 -> 160
    //   156: aload_0
    //   157: invokevirtual 652	java/net/HttpURLConnection:disconnect	()V
    //   160: ldc_w 624
    ...
    //   186: iconst_0
    //   187: aload_0
    //   188: invokevirtual 670	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   191: aastore
    //   192: invokestatic 645	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   195: aload 4
    //   197: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   200: aload_2
    //   201: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   204: aload_3
    //   205: ifnull +7 -> 212
    //   208: aload_3
    //   209: invokevirtual 652	java/net/HttpURLConnection:disconnect	()V
    //   212: ldc_w 624
    ...
    //   227: astore_3
    //   228: aload 4
    //   230: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   233: aload_2
    //   234: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   237: aload_3
    //   238: ifnull +7 -> 245
    //   241: aload_3
    //   242: invokevirtual 652	java/net/HttpURLConnection:disconnect	()V
    //   245: ldc_w 624
  ...
  /* Error */
  private static byte[] aLE(String paramString)
  {
    // Byte code:
    //   0: ldc_w 671
    //   3: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    //   11: invokespecial 329	java/net/URL:<init>	(Ljava/lang/String;)V
    //   14: invokevirtual 628	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   17: checkcast 673	javax/net/ssl/HttpsURLConnection
    //   20: astore_0
    //   21: aload_0
    //   22: ldc_w 632
    //   25: invokevirtual 635	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    ...
    //   142: astore_3
    //   143: aload 4
    //   145: invokevirtual 676	java/io/BufferedInputStream:close	()V
    //   148: aload_2
    //   149: invokevirtual 555	java/io/ByteArrayOutputStream:close	()V
    //   152: aload 4
    //   154: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   157: aload_2
    //   158: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   161: aload_0
    //   162: ifnull +7 -> 169
    //   165: aload_0
    //   166: invokevirtual 652	java/net/HttpURLConnection:disconnect	()V
    //   169: ldc_w 671
    ...
    //   195: iconst_0
    //   196: aload_0
    //   197: invokevirtual 670	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   200: aastore
    //   201: invokestatic 645	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   204: aload 4
    //   206: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   209: aload_2
    //   210: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   213: aload_3
    //   214: ifnull +7 -> 221
    //   217: aload_3
    //   218: invokevirtual 652	java/net/HttpURLConnection:disconnect	()V
    //   221: ldc_w 671
    ...
    //   236: astore_3
    //   237: aload 4
    //   239: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   242: aload_2
    //   243: invokestatic 649	com/tencent/mm/sdk/platformtools/bs:d	(Ljava/io/Closeable;)V
    //   246: aload_3
    //   247: ifnull +7 -> 254
    //   250: aload_3
    //   251: invokevirtual 652	java/net/HttpURLConnection:disconnect	()V
    //   254: ldc_w 671
  ...
  private static byte[] aLF(String paramString)
  {
    ...
    {
      ac.e("MicroMsg.Util", "decode base64 url failed : %s", new Object[] { paramString.getMessage() });
      AppMethodBeat.o(157957);
    }
    return null;
  }
  ...
  public static String aLJ(String paramString)
  {
  ...
  public static boolean aLK(String paramString)
  {
    ...
    {
      ac.printErrStackTrace("MicroMsg.Util", localNullPointerException, "[-] Fail to resolve canonical path of %s", new Object[] { paramString });
      AppMethodBeat.o(157970);
      return false;
    }
    catch (IOException localIOException)
    {
      ac.printErrStackTrace("MicroMsg.Util", localIOException, "[-] Fail to resolve canonical path of %s", new Object[] { paramString });
      AppMethodBeat.o(157970);
      return false;
    }
  ...
  public static boolean aLL(String paramString)
  {
    ...
    boolean bool = aLM(paramString.substring(i + 1));
    AppMethodBeat.o(157971);
    return bool;
  }
  
  public static boolean aLM(String paramString)
  {
  ...
  public static final String aLP(String paramString)
  {
  ...
  public static boolean aLn(String paramString)
  {
  ...
  public static int aLp(String paramString)
  {
  ...
  public static int aLq(String paramString)
  {
  ...
  public static int aLr(String paramString)
  {
  ...
  public static byte[] aLu(String paramString)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        catch (Exception localException)
        {
          ...
          {
            ac.printErrStackTrace("MicroMsg.Util", localException, "", new Object[0]);
            ac.e("MicroMsg.Util", "invalid port num, ignore");
          }
        }
      }
    }
    ...
    if (j < n)
    {
      ...
      for (;;)
      {
        ...
        if (k >= 0)
        {
          if (mnY[k] == c)
          {
            localStringBuffer.append(mnZ[k]);
            i = 0;
          }
        }
        else
  ...
  public static int aLy(String paramString)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (paramString != null)
        {
          ac.e("MicroMsg.Util", "parserInt error ".concat(String.valueOf(paramString)));
          i = j;
        }
      }
    }
  ...
  public static long aLz(String paramString)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (paramString != null)
        {
          ac.e("MicroMsg.Util", "parseLong error ".concat(String.valueOf(paramString)));
          l1 = l2;
        }
      }
    }
  ...
  public static boolean ah(Context paramContext, Intent paramIntent)
  {
  ...
  public static Intent ai(Context paramContext, Intent paramIntent)
  {
    ...
    ac.d("MicroMsg.Util", "createExplicitFromImplicitIntent pa:%s, cl:%s", new Object[] { paramContext, localObject });
  ...
  public static boolean aj(CharSequence paramCharSequence)
  {
  ...
  public static CharSequence ak(CharSequence paramCharSequence)
  {
  ...
  public static boolean bX(Context paramContext, String paramString)
  {
    ...
    while (paramContext.hasNext())
    {
      ...
      {
        ac.w("MicroMsg.Util", "service " + paramString + " is running");
        AppMethodBeat.o(157898);
        return true;
      }
    }
    ac.w("MicroMsg.Util", "service " + paramString + " is not running");
    AppMethodBeat.o(157898);
    return false;
  }
  ...
  public static boolean bY(Context paramContext, String paramString)
  {
    ...
    if (!ah(paramContext, localIntent))
    {
      ac.e("MicroMsg.Util", "jump to url failed, ".concat(String.valueOf(paramString)));
      AppMethodBeat.o(157937);
      return false;
    }
    paramString = new com.tencent.mm.hellhoundlib.b.a().ba(localIntent);
    com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramString.aeD(), "com/tencent/mm/sdk/platformtools/Util", "jump", "(Landroid/content/Context;Ljava/lang/String;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
  ...
  public static int cG(String paramString, int paramInt)
  {
    ...
    {
      ac.printErrStackTrace("MicroMsg.Util", localException, "colorString:%s", new Object[] { paramString });
      AppMethodBeat.o(157999);
    }
    return paramInt;
  }
  ...
  public static String cL(Context paramContext)
  {
    ...
    {
      ac.printErrStackTrace("MicroMsg.Util", paramContext, "", new Object[0]);
      AppMethodBeat.o(157900);
    }
    return "(null)";
  }
  ...
  public static boolean checkPermission(Context paramContext, String paramString)
  {
    ...
    {
      ac.d("MicroMsg.Util", paramContext + paramString);
  ...
  public static String convertStreamToString(InputStream paramInputStream)
  {
    ...
    catch (IOException localIOException)
    {
      ...
      ac.printErrStackTrace("MicroMsg.Util", localIOException, "", new Object[0]);
      try
      {
        paramInputStream.close();
        for (;;)
  ...
  public static String ct(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = Y(paramArrayOfByte, 0);
  ...
  public static boolean cv(byte[] paramArrayOfByte)
  {
    return (paramArrayOfByte == null) || (paramArrayOfByte.length <= 0);
  }
  
  public static int cw(byte[] paramArrayOfByte)
  {
    if (paramArrayOfByte == null) {
      return -1;
    }
  ...
  public static void d(Closeable paramCloseable)
  {
    ...
    {
      ac.printErrStackTrace("MicroMsg.Util", paramCloseable, "qualityClose", new Object[0]);
      AppMethodBeat.o(157985);
    }
  }
  
  public static String dQ(Object paramObject)
  {
  ...
  public static long dR(Object paramObject)
  {
  ...
  public static long eWf()
  {
    ...
    {
      ac.e("MicroMsg.Util", "getDataAvailableSize exception:%s", new Object[] { localException.getMessage() });
      AppMethodBeat.o(157893);
    }
    return 0L;
  }
  
  public static View.OnTouchListener eWg()
  {
  ...
  /* Error */
  private static List<String> eWl()
  {
    // Byte code:
    //   0: ldc_w 1389
    //   3: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: new 294	java/util/ArrayList
    //   9: dup
    //   10: invokespecial 295	java/util/ArrayList:<init>	()V
    //   13: astore_3
    //   14: invokestatic 1395	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   17: ldc_w 1397
    //   20: invokevirtual 1401	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   23: astore_2
    //   24: new 1403	java/io/LineNumberReader
    //   27: dup
    //   28: new 1230	java/io/InputStreamReader
    //   31: dup
    //   32: aload_2
    //   33: invokevirtual 1406	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   36: invokespecial 1231	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   39: invokespecial 1407	java/io/LineNumberReader:<init>	(Ljava/io/Reader;)V
    //   42: astore_1
    //   43: aload_1
    //   44: astore_0
    //   45: aload_1
    //   46: invokevirtual 1408	java/io/LineNumberReader:readLine	()Ljava/lang/String;
    //   49: astore 4
    //   51: aload 4
    //   53: ifnull +89 -> 142
    //   56: aload_1
    //   57: astore_0
    //   58: aload 4
    //   60: invokevirtual 604	java/lang/String:length	()I
    //   63: ifle -20 -> 43
    //   66: aload_1
    //   67: astore_0
    //   68: aload_3
    //   69: aload 4
    //   71: invokeinterface 962 2 0
    //   76: pop
    //   77: goto -34 -> 43
    //   80: astore_2
    //   81: aload_1
    ...
    //   93: iconst_0
    //   94: aload_2
    //   95: invokevirtual 670	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   98: aastore
    //   99: invokestatic 645	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   102: aload_1
    //   103: ifnull +7 -> 110
    //   106: aload_1
    //   107: invokevirtual 1411	java/io/LineNumberReader:close	()V
    //   110: ldc 223
    //   112: ldc_w 1413
    //   115: iconst_1
    ...
    //   120: iconst_0
    //   121: aload_3
    //   122: invokeinterface 967 1 0
    //   127: invokestatic 643	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   130: aastore
    //   131: invokestatic 547	com/tencent/mm/sdk/platformtools/ac:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   134: ldc_w 1389
    ...
    //   143: astore_0
    //   144: aload_2
    //   145: invokevirtual 1416	java/lang/Process:waitFor	()I
    //   148: pop
    //   149: aload_1
    //   150: astore_0
    //   151: aload_2
    //   152: invokevirtual 1419	java/lang/Process:destroy	()V
    //   155: aload_1
    //   156: invokevirtual 1411	java/io/LineNumberReader:close	()V
    //   159: goto -49 -> 110
    //   162: astore_0
    //   163: ldc 223
    //   165: ldc_w 1421
    ...
    //   173: iconst_0
    //   174: aload_0
    //   175: invokevirtual 670	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   178: aastore
    //   179: invokestatic 645	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   182: goto -72 -> 110
    //   185: astore_0
    //   186: ldc 223
    //   188: ldc_w 1421
    ...
    //   196: iconst_0
    //   197: aload_0
    //   198: invokevirtual 670	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   201: aastore
    //   202: invokestatic 645	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   205: goto -95 -> 110
    //   208: astore_1
    //   209: aconst_null
    //   210: astore_0
    ...
    //   212: ifnull +7 -> 219
    //   215: aload_0
    //   216: invokevirtual 1411	java/io/LineNumberReader:close	()V
    //   219: ldc_w 1389
    ...
    //   238: iconst_0
    //   239: aload_0
    //   240: invokevirtual 670	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   243: aastore
    //   244: invokestatic 645	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   247: goto -28 -> 219
    //   250: astore_1
    //   251: goto -40 -> 211
    //   254: astore_2
  ...
  public static int fM(String paramString, int paramInt)
  {
  ...
  public static String[] gX(List<String> paramList)
  {
  ...
  public static boolean gY(List paramList)
  {
  ...
  public static String getProcessNameByPid(Context paramContext, int paramInt)
  {
    ...
    //   24: aload_0
    //   25: ldc_w 560
    //   28: invokevirtual 219	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   31: checkcast 562	android/app/ActivityManager
    //   34: invokevirtual 1460	android/app/ActivityManager:getRunningAppProcesses	()Ljava/util/List;
    ...
    //   58: checkcast 1462	android/app/ActivityManager$RunningAppProcessInfo
    //   61: astore 4
    //   63: aload 4
    //   65: getfield 1465	android/app/ActivityManager$RunningAppProcessInfo:pid	I
    //   68: iload_1
    //   69: if_icmpne -26 -> 43
    //   72: aload 4
    //   74: getfield 1468	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   77: ifnull -34 -> 43
    //   80: aload 4
    //   82: getfield 1468	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   85: ldc_w 285
    //   88: invokevirtual 812	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   91: ifne -48 -> 43
    //   94: aload 4
    //   96: getfield 1468	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   99: astore_0
    //   100: ldc_w 1457
    ...
    //   115: iconst_0
    //   116: anewarray 4	java/lang/Object
    //   119: invokestatic 289	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   122: sipush 128
    //   125: newarray byte
    //   127: astore 6
    //   129: aconst_null
    ...
    //   132: aconst_null
    //   133: astore_0
    //   134: new 409	java/lang/StringBuilder
    //   137: dup
    //   138: ldc_w 1470
    //   141: invokespecial 507	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   144: iload_1
    //   145: invokevirtual 757	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   148: ldc_w 1472
    //   151: invokevirtual 418	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   154: invokevirtual 419	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   157: invokestatic 1288	com/tencent/mm/vfs/i:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   160: astore 5
    //   162: aload 5
    //   164: astore_0
    //   165: aload 5
    ...
    //   169: aload 5
    //   171: aload 6
    //   173: invokevirtual 272	java/io/InputStream:read	([B)I
    //   176: istore_3
    //   177: iload_3
    //   178: ifle +54 -> 232
    //   181: iconst_0
    ...
    //   199: iconst_0
    //   200: iload_2
    //   201: invokespecial 275	java/lang/String:<init>	([BII)V
    //   204: astore 6
    //   206: aload 5
    //   208: ifnull +8 -> 216
    //   211: aload 5
    //   213: invokevirtual 282	java/io/InputStream:close	()V
    //   216: ldc_w 1457
    //   219: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   222: aload 6
    //   224: areturn
    //   225: iload_1
    //   226: iconst_1
    ...
    //   234: ifnull +8 -> 242
    //   237: aload 5
    //   239: invokevirtual 282	java/io/InputStream:close	()V
    //   242: ldc_w 1457
    ...
    //   268: invokestatic 289	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   271: aload_0
    //   272: ifnull -30 -> 242
    //   275: aload_0
    //   276: invokevirtual 282	java/io/InputStream:close	()V
    //   279: goto -37 -> 242
    //   282: astore_0
    //   283: goto -41 -> 242
    //   286: astore_0
    ...
    //   289: ifnull +8 -> 297
    //   292: aload 4
    //   294: invokevirtual 282	java/io/InputStream:close	()V
    //   297: ldc_w 1457
    //   300: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   303: aload_0
    //   304: athrow
    //   305: astore_0
    //   306: goto -90 -> 216
    ...
    //   200	144	2	i	int
    //   176	147	3	j	int
    //   61	232	4	localObject1	Object
    //   313	1	4	localException1	Exception
    //   160	78	5	localInputStream	InputStream
    //   252	8	5	localException2	Exception
    //   127	209	6	localObject2	Object
    // Exception table:
    //   from	to	target	type
    //   24	43	108	java/lang/Exception
    //   43	100	108	java/lang/Exception
    //   134	162	252	java/lang/Exception
    //   169	177	252	java/lang/Exception
    //   193	206	252	java/lang/Exception
    //   275	279	282	java/lang/Exception
    //   134	162	286	finally
    //   169	177	286	finally
    //   193	206	286	finally
    //   257	271	286	finally
    //   211	216	305	java/lang/Exception
    //   237	242	309	java/lang/Exception
    //   292	297	313	java/lang/Exception
  }
  ...
  public static boolean hideVKB(View paramView)
  {
    ...
    catch (Exception paramView)
    {
      for (;;)
      {
        ac.printErrStackTrace("MicroMsg.Util", paramView, "", new Object[0]);
        ac.e("MicroMsg.Util", "hide VKB exception %s", new Object[] { paramView });
        boolean bool = false;
      }
    }
    ac.v("MicroMsg.Util", "hide VKB result %B", new Object[] { Boolean.valueOf(bool) });
    AppMethodBeat.o(157928);
    return bool;
  }
  ...
  public static void iT(Context paramContext)
  {
    ...
    paramContext.vibrate(GuK, -1);
    AppMethodBeat.o(157884);
  }
  
  public static long iU(Context paramContext)
  {
  ...
  public static String iV(Context paramContext)
  {
    ...
    try
    {
      ...
      if (paramContext == null)
      {
        ac.e("MicroMsg.Util", "getLine1Number failed, null tm");
        AppMethodBeat.o(157895);
        return null;
      }
    ...
    {
      ac.e("MicroMsg.Util", "getLine1Number failed:%s ", new Object[] { as.m(paramContext) });
      AppMethodBeat.o(157895);
    }
    return null;
  }
  ...
  public static String iW(Context paramContext)
  {
    ...
    if (paramContext == null)
    {
      ac.w("MicroMsg.Util", "getSimCountryCode context is null.");
  ...
  public static boolean iX(Context paramContext)
  {
    AppMethodBeat.i(157897);
    String str = paramContext.getClass().getName();
    paramContext = cL(paramContext);
    ac.d("MicroMsg.Util", "top activity=" + paramContext + ", context=" + str);
  ...
  public static boolean iY(Context paramContext)
  {
    ...
    try
    {
      ...
      ac.d("MicroMsg.Util", "top activity=" + str + ", context=" + paramContext);
  ...
  public static boolean isProcessRunning(Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      {
        ac.i("MicroMsg.Util", "isProcessRunning, use ActivityManager. process = %s", new Object[] { paramString });
      ...
      while (paramContext.hasNext())
      {
        ...
        {
          ac.w("MicroMsg.Util", "process " + paramString + " is running");
          AppMethodBeat.o(157899);
          return true;
          ac.i("MicroMsg.Util", "isProcessRunning, use ps command. process = %s", new Object[] { paramString });
          paramContext = eWl().iterator();
          while (paramContext.hasNext())
          {
            localObject = (String)paramContext.next();
            ac.d("MicroMsg.Util", "isProcessRunning, process command line = %s", new Object[] { localObject });
            if ((localObject != null) && (((String)localObject).contains(paramString)))
            {
              ...
              while (i < localObject.length)
              {
                ...
                {
                  ac.i("MicroMsg.Util", "process %s is running", new Object[] { paramString });
                  AppMethodBeat.o(157899);
                  return true;
                }
                i += 1;
      ...
      ac.w("MicroMsg.Util", "process " + paramString + " is not running");
    }
    catch (Exception paramContext)
    {
      for (;;)
  ...
  public static String j(Context paramContext, Uri paramUri)
  {
    ...
    {
      ac.e("MicroMsg.Util", "getFilePath : context is null or uri is null");
    ...
    if (isNullOrNil(str1))
    {
      ac.e("MicroMsg.Util", "input uri error. %s", new Object[] { paramUri });
      AppMethodBeat.o(157968);
      return null;
    }
    if (str1.equalsIgnoreCase("file"))
    {
      ac.i("MicroMsg.Util", "getFilePath : scheme is SCHEME_FILE");
    ...
    {
      ac.i("MicroMsg.Util", "getFilePath : scheme is SCHEME_CONTENT: " + paramUri.toString());
      ...
      catch (SecurityException localSecurityException)
      {
        for (;;)
        {
          ac.e("MicroMsg.Util", "getFilePath : exception = ".concat(String.valueOf(localSecurityException)));
          arrayOfString = null;
        }
    ...
    label469:
    ac.e("MicroMsg.Util", "unknown scheme");
    AppMethodBeat.o(157968);
    return null;
  }
  ...
  public static boolean ja(Context paramContext)
  {
    ...
    if (paramContext == null)
    {
      ac.w("MicroMsg.Util", "isOverseasUser context is null");
      AppMethodBeat.o(157952);
      return false;
    }
    paramContext = (TelephonyManager)paramContext.getSystemService("phone");
  ...
  public static a jb(Context paramContext)
  {
  ...
  public static ComponentName jc(Context paramContext)
  {
    ...
    {
      ac.e("MicroMsg.Util", "get Top Activity Exception:%s", new Object[] { paramContext.getMessage() });
      AppMethodBeat.o(157974);
    }
    return null;
  }
  
  public static String jd(Context paramContext)
  {
    ...
    {
      ac.e("MicroMsg.Util", "getTopActivityName Exception:%s stack:%s", new Object[] { paramContext.getMessage(), as.m(paramContext) });
      AppMethodBeat.o(157975);
    }
    return "";
  }
  
  public static int je(Context paramContext)
  {
    AppMethodBeat.i(157996);
    if (paramContext == null)
    {
      ac.i("MicroMsg.Util", "getSelfMemInMB context is null.");
  ...
  public static int jk(int paramInt1, int paramInt2)
  {
  ...
  public static boolean jl(int paramInt1, int paramInt2)
  {
    return paramInt1 == paramInt2;
  }
  ...
  public static int l(Object paramObject, int paramInt)
  {
  ...
  public static List<String> lp(String paramString1, String paramString2)
  {
  ...
  public static int lq(String paramString1, String paramString2)
  {
    ...
    int i = i.fp(paramString1, paramString2);
    AppMethodBeat.o(157934);
    return i;
  }
  
  public static boolean lr(String paramString1, String paramString2)
  {
  ...
  public static int m(Integer paramInteger)
  {
  ...
  public static String m(Throwable paramThrowable)
  {
    ...
    paramThrowable = as.m(paramThrowable);
  ...
  public static byte[] readFromFile(String paramString)
  {
    ...
    //   3: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: aload_0
    //   7: invokestatic 321	com/tencent/mm/sdk/platformtools/bs:isNullOrNil	(Ljava/lang/String;)Z
    //   10: ifeq +19 -> 29
    //   13: ldc 223
    //   15: ldc_w 1891
    //   18: invokestatic 231	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   21: ldc_w 1889
    //   24: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   27: aconst_null
    //   28: areturn
    //   29: new 1270	com/tencent/mm/vfs/e
    //   32: dup
    //   33: aload_0
    //   34: invokespecial 1271	com/tencent/mm/vfs/e:<init>	(Ljava/lang/String;)V
    //   37: astore_3
    //   38: aload_3
    //   39: invokevirtual 1274	com/tencent/mm/vfs/e:exists	()Z
    //   42: ifne +27 -> 69
    //   45: ldc 223
    //   47: ldc_w 1893
    //   50: iconst_1
    ...
    //   56: aload_0
    //   57: aastore
    //   58: invokestatic 1895	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   61: ldc_w 1889
    //   64: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   67: aconst_null
    //   68: areturn
    //   69: aload_3
    //   70: invokevirtual 1897	com/tencent/mm/vfs/e:length	()J
    //   73: l2i
    //   74: istore_1
    //   75: aload_3
    //   76: invokestatic 1901	com/tencent/mm/vfs/i:ag	(Lcom/tencent/mm/vfs/e;)Ljava/io/InputStream;
    //   79: astore 4
    //   81: aload 4
    //   83: astore_3
    //   84: iload_1
    ...
    //   92: aload 4
    //   94: aload 5
    //   96: invokevirtual 272	java/io/InputStream:read	([B)I
    //   99: istore_2
    //   100: iload_2
    //   101: iload_1
    ...
    //   122: iconst_1
    //   123: iload_1
    //   124: invokestatic 643	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   127: aastore
    //   128: dup
    //   129: iconst_2
    //   130: iload_2
    //   131: invokestatic 643	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   134: aastore
    //   135: invokestatic 1895	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   138: aload 4
    //   140: ifnull +8 -> 148
    //   143: aload 4
    //   145: invokevirtual 282	java/io/InputStream:close	()V
    //   148: ldc_w 1889
    ...
    //   167: invokestatic 289	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   170: goto -22 -> 148
    //   173: aload 4
    //   175: astore_3
    //   176: ldc 223
    //   178: ldc_w 1905
    //   181: invokestatic 1222	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   184: aload 4
    //   186: ifnull +8 -> 194
    //   189: aload 4
    //   191: invokevirtual 282	java/io/InputStream:close	()V
    //   194: ldc_w 1889
    ...
    //   214: invokestatic 289	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   217: goto -23 -> 194
    //   220: astore_0
    //   221: aconst_null
    //   222: astore 4
    ...
    //   233: iconst_0
    //   234: anewarray 4	java/lang/Object
    //   237: invokestatic 289	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   240: aload 4
    //   242: ifnull +8 -> 250
    //   245: aload 4
    //   247: invokevirtual 282	java/io/InputStream:close	()V
    //   250: ldc_w 1889
    ...
    //   269: invokestatic 289	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   272: goto -22 -> 250
    //   275: astore_0
    //   276: aconst_null
    //   277: astore_3
    ...
    //   279: ifnull +7 -> 286
    //   282: aload_3
    //   283: invokevirtual 282	java/io/InputStream:close	()V
    //   286: ldc_w 1889
    ...
    //   305: invokestatic 289	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   308: goto -22 -> 286
    //   311: astore_0
    //   312: goto -34 -> 278
    //   315: astore_0
  ...
  public static boolean t(String paramString, byte[] paramArrayOfByte)
  {
    ...
    if ((isNullOrNil(paramString)) || (cv(paramArrayOfByte)))
    {
      ac.w("MicroMsg.Util", "write to file error, path is null or empty, or data is empty");
    ...
    try
    {
      ...
      {
        paramString.close();
        ac.d("MicroMsg.Util", "writeToFile ok!");
        AppMethodBeat.o(157949);
        return true;
      }
      ...
      catch (IOException paramArrayOfByte)
      {
        for (;;)
        {
          ac.printErrStackTrace("MicroMsg.Util", paramArrayOfByte, "", new Object[0]);
        }
      }
    }
    catch (Exception paramString)
    {
      ...
      ac.printErrStackTrace("MicroMsg.Util", paramString, "", new Object[0]);
      localObject = str;
      ac.w("MicroMsg.Util", "write to file error");
      if (str != null) {}
      try
      {
        str.close();
  ...
  public static String u(String paramString, Object... paramVarArgs)
  {
    ...
    catch (Exception paramVarArgs)
    {
      for (;;)
      {
        ac.i("MicroMsg.Util", "error safeFormatString %s", new Object[] { paramVarArgs.getMessage() });
      }
    }
  ...
  public static boolean z(Uri paramUri)
  {
    ...
    boolean bool = aLK(paramUri.getPath());
    AppMethodBeat.o(157969);
    return bool;
  }
  ...
  public static final class a
  {
    ...
    private static String jf(Context paramContext)
    {
      ...
      paramContext = paramContext.getPackageName();
      if ((localObject1 == null) || (bs.isNullOrNil(paramContext)))
      {
        AppMethodBeat.o(157855);
        return null;
      }
