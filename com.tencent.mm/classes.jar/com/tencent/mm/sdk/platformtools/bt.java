...
{
  private static final long[] EXy;
  private static final TimeZone GMT;
  public static final long[] hWP;
  ...
  static
  {
    ...
    EXy = new long[] { 300L, 50L, 300L, 50L };
    GMT = TimeZone.getTimeZone("GMT");
    qFp = BigInteger.ONE.shiftLeft(64);
    lMb = new char[] { 60, 62, 34, 39, 38, 13, 10, 32, 9 };
    lMc = new String[] { "&lt;", "&gt;", "&quot;", "&apos;", "&amp;", "&#x0D;", "&#x0A;", "&#x20;", "&#x09;" };
  ...
  public static ArrayList<String> S(String[] paramArrayOfString)
  {
  ...
  public static boolean T(String... paramVarArgs)
  {
    boolean bool2 = false;
  ...
  public static Intent U(Context paramContext, Intent paramIntent)
  {
  ...
  private static String a(Context paramContext, Uri paramUri, String paramString, String[] paramArrayOfString)
  {
    ...
    //   9: aload_0
    //   10: invokevirtual 439	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   13: aload_1
    //   14: iconst_1
    ...
    //   25: aload_3
    //   26: aconst_null
    //   27: invokevirtual 447	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   30: astore_0
    //   31: aload_0
    //   32: ifnull +88 -> 120
    //   35: aload_0
    //   36: invokeinterface 453 1 0
    //   41: ifeq +79 -> 120
    //   44: aload_0
    //   45: ldc_w 441
    //   48: invokeinterface 457 2 0
    //   53: istore 4
    //   55: iload 4
    //   57: iconst_m1
    //   58: if_icmpne +35 -> 93
    //   61: ldc 113
    //   63: ldc_w 459
    //   66: invokestatic 462	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   69: aload_0
    //   70: invokeinterface 463 1 0
    //   75: aload_0
    //   76: ifnull +9 -> 85
    //   79: aload_0
    //   80: invokeinterface 463 1 0
    //   85: ldc_w 435
    ...
    //   93: aload_0
    //   94: iload 4
    //   96: invokeinterface 466 2 0
    //   101: astore_2
    //   102: aload_0
    //   103: ifnull +9 -> 112
    //   106: aload_0
    //   107: invokeinterface 463 1 0
    //   112: ldc_w 435
    ...
    //   141: astore_0
    //   142: aload_1
    //   143: invokevirtual 471	android/net/Uri:getPath	()Ljava/lang/String;
    //   146: astore_2
    //   147: aload_2
    //   148: astore_1
    //   149: bipush 24
    //   151: invokestatic 477	com/tencent/mm/compatible/util/d:lf	(I)Z
    //   154: ifeq +13 -> 167
    //   157: aload_2
    //   158: ldc_w 479
    //   161: ldc 217
    //   163: invokevirtual 483	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   166: astore_1
    //   167: aload_0
    //   168: ifnull +9 -> 177
    //   171: aload_0
    //   172: invokeinterface 463 1 0
    //   177: ldc_w 435
  ...
  public static int aFY(String paramString)
  {
  ...
  public static int aFZ(String paramString)
  {
  ...
  public static byte[] aGd(String paramString)
  {
  ...
  public static int[] aGe(String paramString)
  {
    ...
    if (j < n)
    {
      ...
      for (;;)
      {
        ...
        if (k >= 0)
        {
          if (lMb[k] == c)
          {
            localStringBuffer.append(lMc[k]);
            i = 0;
          }
        }
        else
  ...
  public static int aGh(String paramString)
  {
  ...
  public static double aGj(String paramString)
  {
  ...
  public static float aGk(String paramString)
  {
  ...
  public static byte[] aGl(String paramString)
  {
    ...
    {
      paramString = aGo(paramString);
      AppMethodBeat.o(157954);
      return paramString;
    }
    if (URLUtil.isHttpsUrl(paramString))
    {
      paramString = aGn(paramString);
      AppMethodBeat.o(157954);
      return paramString;
    }
    paramString = aGm(paramString);
    AppMethodBeat.o(157954);
    return paramString;
  }
  
  /* Error */
  private static byte[] aGm(String paramString)
  {
    // Byte code:
    //   0: ldc_w 823
    //   3: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   6: new 219	java/net/URL
    //   9: dup
    //   10: aload_0
    //   11: invokespecial 223	java/net/URL:<init>	(Ljava/lang/String;)V
    //   14: invokevirtual 827	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   17: checkcast 829	java/net/HttpURLConnection
    //   20: astore_0
    //   21: aload_0
    //   22: ldc_w 831
    //   25: invokevirtual 834	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   28: aload_0
    //   29: invokevirtual 837	java/net/HttpURLConnection:getResponseCode	()I
    //   32: istore_1
    //   33: iload_1
    //   34: sipush 200
    //   37: if_icmpeq +46 -> 83
    ...
    //   50: iconst_0
    //   51: iload_1
    //   52: invokestatic 739	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   55: aastore
    //   56: invokestatic 841	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   59: aconst_null
    //   60: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   63: aconst_null
    //   64: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   67: aload_0
    //   68: ifnull +7 -> 75
    //   71: aload_0
    //   72: invokevirtual 847	java/net/HttpURLConnection:disconnect	()V
    //   75: ldc_w 823
    //   78: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   81: aconst_null
    //   82: areturn
    //   83: new 849	java/io/BufferedInputStream
    //   86: dup
    //   87: aload_0
    //   88: invokevirtual 853	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   91: invokespecial 856	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   94: astore 4
    //   96: new 560	java/io/ByteArrayOutputStream
    //   99: dup
    //   100: invokespecial 561	java/io/ByteArrayOutputStream:<init>	()V
    //   103: astore_2
    //   104: sipush 4096
    //   107: newarray byte
    //   109: astore_3
    //   110: aload 4
    //   112: aload_3
    //   113: invokevirtual 857	java/io/BufferedInputStream:read	([B)I
    //   116: istore_1
    //   117: iload_1
    //   118: ifle +20 -> 138
    //   121: aload_2
    ...
    //   123: iconst_0
    //   124: iload_1
    //   125: invokevirtual 860	java/io/ByteArrayOutputStream:write	([BII)V
    //   128: aload 4
    //   130: aload_3
    //   131: invokevirtual 857	java/io/BufferedInputStream:read	([B)I
    //   134: istore_1
    //   135: goto -18 -> 117
    //   138: aload_2
    //   139: invokevirtual 584	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   142: astore_3
    //   143: aload 4
    //   145: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   148: aload_2
    //   149: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   152: aload_0
    //   153: ifnull +7 -> 160
    //   156: aload_0
    //   157: invokevirtual 847	java/net/HttpURLConnection:disconnect	()V
    //   160: ldc_w 823
    ...
    //   186: iconst_0
    //   187: aload_0
    //   188: invokevirtual 865	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   191: aastore
    //   192: invokestatic 841	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   195: aload 4
    //   197: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   200: aload_2
    //   201: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   204: aload_3
    //   205: ifnull +7 -> 212
    //   208: aload_3
    //   209: invokevirtual 847	java/net/HttpURLConnection:disconnect	()V
    //   212: ldc_w 823
    ...
    //   227: astore_3
    //   228: aload 4
    //   230: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   233: aload_2
    //   234: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   237: aload_3
    //   238: ifnull +7 -> 245
    //   241: aload_3
    //   242: invokevirtual 847	java/net/HttpURLConnection:disconnect	()V
    //   245: ldc_w 823
  ...
  /* Error */
  private static byte[] aGn(String paramString)
  {
    // Byte code:
    //   0: ldc_w 866
    //   3: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    //   11: invokespecial 223	java/net/URL:<init>	(Ljava/lang/String;)V
    //   14: invokevirtual 827	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   17: checkcast 868	javax/net/ssl/HttpsURLConnection
    //   20: astore_0
    //   21: aload_0
    //   22: ldc_w 831
    //   25: invokevirtual 834	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    ...
    //   142: astore_3
    //   143: aload 4
    //   145: invokevirtual 871	java/io/BufferedInputStream:close	()V
    //   148: aload_2
    //   149: invokevirtual 585	java/io/ByteArrayOutputStream:close	()V
    //   152: aload 4
    //   154: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   157: aload_2
    //   158: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   161: aload_0
    //   162: ifnull +7 -> 169
    //   165: aload_0
    //   166: invokevirtual 847	java/net/HttpURLConnection:disconnect	()V
    //   169: ldc_w 866
    ...
    //   195: iconst_0
    //   196: aload_0
    //   197: invokevirtual 865	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   200: aastore
    //   201: invokestatic 841	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   204: aload 4
    //   206: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   209: aload_2
    //   210: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   213: aload_3
    //   214: ifnull +7 -> 221
    //   217: aload_3
    //   218: invokevirtual 847	java/net/HttpURLConnection:disconnect	()V
    //   221: ldc_w 866
    ...
    //   236: astore_3
    //   237: aload 4
    //   239: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   242: aload_2
    //   243: invokestatic 844	com/tencent/mm/sdk/platformtools/bt:d	(Ljava/io/Closeable;)V
    //   246: aload_3
    //   247: ifnull +7 -> 254
    //   250: aload_3
    //   251: invokevirtual 847	java/net/HttpURLConnection:disconnect	()V
    //   254: ldc_w 866
  ...
  private static byte[] aGo(String paramString)
  {
  ...
  public static boolean aGt(String paramString)
  {
    ...
    try
    {
      ...
      if (str.contains("/com.tencent.mm/cache/"))
      {
        AppMethodBeat.o(157970);
        return true;
      }
    ...
    int i = localIOException.indexOf("/com.tencent.mm-");
    if ((i >= 0) && (localIOException.startsWith("/cache/", localIOException.indexOf("/", i + 16))))
    {
      AppMethodBeat.o(157970);
      return true;
    }
    if ((localIOException.contains("/data/data/")) || (localIOException.contains("/data/user/")))
    {
      if ((!localIOException.contains("/com.tencent.mm/")) && (!localIOException.contains("/com.tencent.mm-")))
      {
        AppMethodBeat.o(157970);
        return true;
      }
  ...
  public static boolean aGu(String paramString)
  {
    ...
    boolean bool = aGv(paramString.substring(i + 1));
    AppMethodBeat.o(157971);
    return bool;
  }
  ...
  public static final String aGy(String paramString)
  {
  ...
  public static long aS(long paramLong)
  {
  ...
  public static boolean aw(long paramLong1, long paramLong2)
  {
  ...
  public static boolean bX(Context paramContext, String paramString)
  {
    ...
    com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramString.adn(), "com/tencent/mm/sdk/platformtools/Util", "jump", "(Landroid/content/Context;Ljava/lang/String;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
  ...
  public static int bw(byte[] paramArrayOfByte)
  {
  ...
  public static String cu(byte[] paramArrayOfByte)
  {
  ...
  public static String cv(byte[] paramArrayOfByte)
  {
  ...
  public static int cx(byte[] paramArrayOfByte)
  {
    if (paramArrayOfByte == null) {
      return -1;
    }
  ...
  public static String cy(byte[] paramArrayOfByte)
  {
  ...
  public static String dP(Object paramObject)
  {
  ...
  public static long dQ(Object paramObject)
  {
  ...
  public static byte[] eGG()
  {
    ...
    catch (Exception localException)
    {
      ...
      localObject = g.E((((UUID)localObject).toString() + System.currentTimeMillis()).getBytes());
      AppMethodBeat.o(157863);
      return localObject;
    }
  }
  ...
  public static View.OnTouchListener eGL()
  {
  ...
  /* Error */
  private static List<String> eGQ()
  {
    // Byte code:
    //   0: ldc_w 1328
    //   3: invokestatic 31	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    //   13: astore_3
    //   14: invokestatic 1334	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   17: ldc_w 1336
    //   20: invokevirtual 1340	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   23: astore_2
    //   24: new 1342	java/io/LineNumberReader
    //   27: dup
    //   28: new 1168	java/io/InputStreamReader
    //   31: dup
    //   32: aload_2
    //   33: invokevirtual 1345	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   36: invokespecial 1169	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   39: invokespecial 1346	java/io/LineNumberReader:<init>	(Ljava/io/Reader;)V
    //   42: astore_1
    //   43: aload_1
    //   44: astore_0
    //   45: aload_1
    //   46: invokevirtual 1347	java/io/LineNumberReader:readLine	()Ljava/lang/String;
    //   49: astore 4
    //   51: aload 4
    //   53: ifnull +89 -> 142
    //   56: aload_1
    //   57: astore_0
    //   58: aload 4
    //   60: invokevirtual 637	java/lang/String:length	()I
    //   63: ifle -20 -> 43
    //   66: aload_1
    //   67: astore_0
    //   68: aload_3
    //   69: aload 4
    //   71: invokeinterface 740 2 0
    //   76: pop
    //   77: goto -34 -> 43
    //   80: astore_2
    //   81: aload_1
    ...
    //   93: iconst_0
    //   94: aload_2
    //   95: invokevirtual 865	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   98: aastore
    //   99: invokestatic 841	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   102: aload_1
    //   103: ifnull +7 -> 110
    //   106: aload_1
    //   107: invokevirtual 1350	java/io/LineNumberReader:close	()V
    //   110: ldc 113
    //   112: ldc_w 1352
    //   115: iconst_1
    ...
    //   120: iconst_0
    //   121: aload_3
    //   122: invokeinterface 282 1 0
    //   127: invokestatic 739	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   130: aastore
    //   131: invokestatic 577	com/tencent/mm/sdk/platformtools/ad:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   134: ldc_w 1328
    ...
    //   143: astore_0
    //   144: aload_2
    //   145: invokevirtual 1355	java/lang/Process:waitFor	()I
    //   148: pop
    //   149: aload_1
    //   150: astore_0
    //   151: aload_2
    //   152: invokevirtual 1358	java/lang/Process:destroy	()V
    //   155: aload_1
    //   156: invokevirtual 1350	java/io/LineNumberReader:close	()V
    //   159: goto -49 -> 110
    //   162: astore_0
    //   163: ldc 113
    //   165: ldc_w 1360
    ...
    //   173: iconst_0
    //   174: aload_0
    //   175: invokevirtual 865	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   178: aastore
    //   179: invokestatic 841	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   182: goto -72 -> 110
    //   185: astore_0
    //   186: ldc 113
    //   188: ldc_w 1360
    ...
    //   196: iconst_0
    //   197: aload_0
    //   198: invokevirtual 865	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   201: aastore
    //   202: invokestatic 841	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   205: goto -95 -> 110
    //   208: astore_1
    //   209: aconst_null
    //   210: astore_0
    ...
    //   212: ifnull +7 -> 219
    //   215: aload_0
    //   216: invokevirtual 1350	java/io/LineNumberReader:close	()V
    //   219: ldc_w 1328
    ...
    //   238: iconst_0
    //   239: aload_0
    //   240: invokevirtual 865	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   243: aastore
    //   244: invokestatic 841	com/tencent/mm/sdk/platformtools/ad:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   247: goto -28 -> 219
    //   250: astore_1
    //   251: goto -40 -> 211
    //   254: astore_2
  ...
  public static int fH(String paramString, int paramInt)
  {
  ...
  public static String[] gK(List<String> paramList)
  {
  ...
  public static boolean gL(List paramList)
  {
  ...
  public static String getProcessNameByPid(Context paramContext, int paramInt)
  {
    ...
    //   23: aload_0
    //   24: ldc_w 543
    //   27: invokevirtual 109	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   30: checkcast 545	android/app/ActivityManager
    //   33: invokevirtual 1399	android/app/ActivityManager:getRunningAppProcesses	()Ljava/util/List;
    //   36: invokeinterface 550 1 0
    //   41: astore_0
    //   42: aload_0
    //   43: invokeinterface 504 1 0
    //   48: ifeq +71 -> 119
    //   51: aload_0
    //   52: invokeinterface 508 1 0
    //   57: checkcast 1401	android/app/ActivityManager$RunningAppProcessInfo
    //   60: astore 4
    //   62: aload 4
    //   64: getfield 1404	android/app/ActivityManager$RunningAppProcessInfo:pid	I
    //   67: iload_1
    //   68: if_icmpne -26 -> 42
    //   71: aload 4
    //   73: getfield 1407	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   76: ifnull -34 -> 42
    //   79: aload 4
    //   81: getfield 1407	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   84: ldc 217
    //   86: invokevirtual 990	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   89: ifne -47 -> 42
    //   92: aload 4
    //   94: getfield 1407	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   97: astore_0
    //   98: ldc_w 1396
    ...
    //   116: invokestatic 231	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   119: sipush 128
    //   122: newarray byte
    //   124: astore 6
    //   126: aconst_null
    ...
    //   134: dup
    //   135: ldc_w 1409
    //   138: invokespecial 521	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   141: iload_1
    //   142: invokevirtual 935	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   145: ldc_w 1411
    //   148: invokevirtual 432	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   151: invokevirtual 433	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   154: invokestatic 1226	com/tencent/mm/vfs/i:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   157: astore 5
    //   159: aload 5
    //   161: astore_0
    //   162: aload 5
    ...
    //   166: aload 5
    //   168: aload 6
    //   170: invokevirtual 250	java/io/InputStream:read	([B)I
    //   173: istore_3
    //   174: iload_3
    //   175: ifle +54 -> 229
    //   178: iconst_0
    ...
    //   186: aload 5
    //   188: astore 4
    //   190: new 74	java/lang/String
    //   193: dup
    //   194: aload 6
    //   196: iconst_0
    //   197: iload_2
    //   198: invokespecial 253	java/lang/String:<init>	([BII)V
    //   201: astore 6
    //   203: aload 5
    //   205: ifnull +8 -> 213
    //   208: aload 5
    //   210: invokevirtual 260	java/io/InputStream:close	()V
    //   213: ldc_w 1396
    //   216: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   219: aload 6
    //   221: areturn
    //   222: iload_1
    //   223: iconst_1
    ...
    //   231: ifnull +8 -> 239
    //   234: aload 5
    //   236: invokevirtual 260	java/io/InputStream:close	()V
    //   239: ldc_w 1396
    ...
    //   263: invokestatic 231	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   266: aload_0
    //   267: ifnull -28 -> 239
    //   270: aload_0
    //   271: invokevirtual 260	java/io/InputStream:close	()V
    //   274: goto -35 -> 239
    //   277: astore_0
    //   278: goto -39 -> 239
    //   281: astore_0
    ...
    //   284: ifnull +8 -> 292
    //   287: aload 4
    //   289: invokevirtual 260	java/io/InputStream:close	()V
    //   292: ldc_w 1396
    //   295: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   298: aload_0
    //   299: athrow
    //   300: astore_0
    //   301: goto -88 -> 213
    ...
    //   315: iload_1
    //   316: iload_3
    //   317: if_icmpge -134 -> 183
    //   320: aload 6
    //   322: iload_1
    //   323: baload
    //   324: sipush 128
    //   327: if_icmpgt +10 -> 337
    //   330: aload 6
    //   332: iload_1
    //   333: baload
    //   334: ifgt -112 -> 222
    ...
    //   308	1	4	localException1	Exception
    //   157	78	5	localInputStream	InputStream
    //   248	8	5	localException2	Exception
    //   124	207	6	localObject2	Object
    // Exception table:
    //   from	to	target	type
    //   23	42	106	java/lang/Exception
    //   42	98	106	java/lang/Exception
    //   131	159	248	java/lang/Exception
    //   166	174	248	java/lang/Exception
    //   190	203	248	java/lang/Exception
    //   270	274	277	java/lang/Exception
    //   131	159	281	finally
    //   166	174	281	finally
    //   190	203	281	finally
    //   253	266	281	finally
    //   208	213	300	java/lang/Exception
    //   234	239	304	java/lang/Exception
    //   287	292	308	java/lang/Exception
  }
  ...
  public static int i(Object paramObject, int paramInt)
  {
  ...
  public static void iI(Context paramContext)
  {
    ...
    paramContext.vibrate(EXy, -1);
    AppMethodBeat.o(157884);
  }
  
  public static long iJ(Context paramContext)
  {
  ...
  public static String iK(Context paramContext)
  {
    ...
    {
      ad.e("MicroMsg.Util", "getLine1Number failed:%s ", new Object[] { at.m(paramContext) });
      AppMethodBeat.o(157895);
    }
    return null;
  }
  ...
  public static a iQ(Context paramContext)
  {
  ...
  public static ComponentName iR(Context paramContext)
  {
  ...
  public static String iS(Context paramContext)
  {
    ...
    {
      ad.e("MicroMsg.Util", "getTopActivityName Exception:%s stack:%s", new Object[] { paramContext.getMessage(), at.m(paramContext) });
      AppMethodBeat.o(157975);
    }
    return "";
  }
  ...
  @TargetApi(19)
  public static String j(Context paramContext, Uri paramUri)
  {
  ...
  public static List<String> kS(String paramString1, String paramString2)
  {
  ...
  public static int kT(String paramString1, String paramString2)
  {
    AppMethodBeat.i(157934);
    int i = i.fc(paramString1, paramString2);
    AppMethodBeat.o(157934);
    return i;
  }
  
  public static boolean kU(String paramString1, String paramString2)
  {
  ...
  public static String m(Throwable paramThrowable)
  {
    ...
    paramThrowable = at.m(paramThrowable);
  ...
  public static String n(List<String> paramList, String paramString)
  {
  ...
  public static byte[] readFromFile(String paramString)
  {
    ...
    //   13: ldc 113
    //   15: ldc_w 1858
    //   18: invokestatic 121	com/tencent/mm/sdk/platformtools/ad:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   21: ldc_w 1856
    //   24: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   27: aconst_null
    //   28: areturn
    //   29: new 1208	com/tencent/mm/vfs/e
    //   32: dup
    //   33: aload_0
    //   34: invokespecial 1209	com/tencent/mm/vfs/e:<init>	(Ljava/lang/String;)V
    //   37: astore_3
    //   38: aload_3
    //   39: invokevirtual 1212	com/tencent/mm/vfs/e:exists	()Z
    //   42: ifne +27 -> 69
    //   45: ldc 113
    //   47: ldc_w 1860
    //   50: iconst_1
    ...
    //   56: aload_0
    //   57: aastore
    //   58: invokestatic 1862	com/tencent/mm/sdk/platformtools/ad:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   61: ldc_w 1856
    //   64: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   67: aconst_null
    //   68: areturn
    //   69: aload_3
    //   70: invokevirtual 1864	com/tencent/mm/vfs/e:length	()J
    //   73: l2i
    //   74: istore_1
    //   75: aload_3
    //   76: invokestatic 1868	com/tencent/mm/vfs/i:ah	(Lcom/tencent/mm/vfs/e;)Ljava/io/InputStream;
    //   79: astore 4
    //   81: aload 4
    //   83: astore_3
    //   84: iload_1
    ...
    //   92: aload 4
    //   94: aload 5
    //   96: invokevirtual 250	java/io/InputStream:read	([B)I
    //   99: istore_2
    //   100: iload_2
    //   101: iload_1
    ...
    //   122: iconst_1
    //   123: iload_1
    //   124: invokestatic 739	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   127: aastore
    //   128: dup
    //   129: iconst_2
    //   130: iload_2
    //   131: invokestatic 739	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   134: aastore
    //   135: invokestatic 1862	com/tencent/mm/sdk/platformtools/ad:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   138: aload 4
    //   140: ifnull +8 -> 148
    //   143: aload 4
    //   145: invokevirtual 260	java/io/InputStream:close	()V
    //   148: ldc_w 1856
    ...
    //   166: invokestatic 231	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   169: goto -21 -> 148
    //   172: aload 4
    //   174: astore_3
    //   175: ldc 113
    //   177: ldc_w 1872
    //   180: invokestatic 1508	com/tencent/mm/sdk/platformtools/ad:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   183: aload 4
    //   185: ifnull +8 -> 193
    //   188: aload 4
    //   190: invokevirtual 260	java/io/InputStream:close	()V
    //   193: ldc_w 1856
    //   196: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   199: aload 5
    //   201: areturn
    //   202: astore_0
    //   203: ldc 113
    ...
    //   212: invokestatic 231	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   215: goto -22 -> 193
    //   218: astore_0
    //   219: aconst_null
    //   220: astore 4
    ...
    //   234: invokestatic 231	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   237: aload 4
    //   239: ifnull +8 -> 247
    //   242: aload 4
    //   244: invokevirtual 260	java/io/InputStream:close	()V
    //   247: ldc_w 1856
    ...
    //   265: invokestatic 231	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   268: goto -21 -> 247
    //   271: astore_0
    //   272: aconst_null
    //   273: astore_3
    ...
    //   275: ifnull +7 -> 282
    //   278: aload_3
    //   279: invokevirtual 260	java/io/InputStream:close	()V
    //   282: ldc_w 1856
    ...
    //   300: invokestatic 231	com/tencent/mm/sdk/platformtools/ad:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   303: goto -21 -> 282
    //   306: astore_0
    //   307: goto -33 -> 274
    //   310: astore_0
  ...
  public static boolean t(String paramString, byte[] paramArrayOfByte)
  {
    ...
    if ((isNullOrNil(paramString)) || (cw(paramArrayOfByte)))
    {
  ...
  public static String vI(long paramLong)
  {
  ...
  public static String vJ(long paramLong)
  {
  ...
  public static long vM(long paramLong)
  {
  ...
  public static int vN(long paramLong)
  {
  ...
  public static void z(String paramString1, String paramString2, long paramLong)
  {
  ...
  public static boolean z(Uri paramUri)
  {
    ...
    boolean bool = aGt(paramUri.getPath());
    AppMethodBeat.o(157969);
    return bool;
  }
