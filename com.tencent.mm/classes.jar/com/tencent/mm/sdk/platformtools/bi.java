...
{
  static String[] EWH = { "sysfs", "rootfs", "binfmt_misc", "anon_inodefs", "bdev", "proc", "cgroup", "tmpfs", "debugfs", "sockfs", "pipefs", "rpc_pipefs", "devpts", "ramfs", "fuseblk", "fusectl", "selinuxfs" };
  static String[] EWI = { "vfat", "exfat", "fuse", "sdcardfs" };
  static String[] EWJ = { "/mnt/secure", "/mnt/asec", "/mnt/obb", "/dev/mapper", "/data/" };
  static String[] EWK = { "/dev/block/vold" };
  ...
  private static void a(a parama)
  {
    ...
    try
    {
      StatFs localStatFs = new StatFs(parama.EWM);
      parama.EWR = localStatFs.getBlockSize();
      parama.EWQ = localStatFs.getAvailableBlocks();
      parama.EWO = localStatFs.getBlockCount();
      parama.EWP = localStatFs.getFreeBlocks();
  ...
  public static String aFO(String paramString)
  {
    ...
    } while (!paramString.equals(((a)localObject1).EWM));
    Object localObject1 = ((a)localObject1).EWN;
      ...
      if (paramString.contains("emulated"))
      {
        ...
        if (i != -1)
        {
          ...
          if (!bt.isNullOrNil((String)localObject4))
          {
            ...
            } while (!((String)localObject4).equals(((a)localObject2).EWM));
            localObject2 = ((a)localObject2).EWN;
  ...
  private static boolean b(a parama)
  {
    ...
    e locale = new e(parama.EWM, "test_writable");
    ...
    for (;;)
    {
      ...
      catch (IOException localIOException4)
      {
        ...
        ad.e("MicroMsg.SdcardUtil", "createNewFile: " + localIOException4.getMessage() + " dir: " + parama.EWM);
  ...
  /* Error */
  private static ArrayList<a> eGq()
  {
    // Byte code:
    //   0: ldc_w 287
    ...
    //   129: dup
    //   130: invokespecial 320	com/tencent/mm/sdk/platformtools/bi$a:<init>	()V
    //   133: astore 4
    //   135: aload_1
    //   136: astore_0
    //   137: aload 4
    ...
    //   140: iconst_0
    //   141: aaload
    //   142: putfield 323	com/tencent/mm/sdk/platformtools/bi$a:EWL	Ljava/lang/String;
    //   145: aload_1
    //   146: astore_0
    //   147: aload 4
    //   149: aload_2
    //   150: iconst_1
    //   151: aaload
    //   152: putfield 95	com/tencent/mm/sdk/platformtools/bi$a:EWM	Ljava/lang/String;
    //   155: aload_1
    //   156: astore_0
    //   157: aload 4
    //   159: aload_2
    //   160: iconst_2
    //   161: aaload
    //   162: putfield 176	com/tencent/mm/sdk/platformtools/bi$a:EWN	Ljava/lang/String;
    //   165: aload_1
    //   166: astore_0
    //   167: aload_3
    //   168: aload 4
  ...
  private static a eGr()
  {
    ...
    } while (!((a)localObject1).EWM.equals(str));
    for (;;)
    {
      localObject2 = localObject1;
      ...
      {
        localObject2 = new a();
        ((a)localObject2).EWM = str;
        ((a)localObject2).EWL = "Unknown";
        ((a)localObject2).EWN = "Unknown";
      }
      a((a)localObject2);
  ...
  public static ArrayList<a> eGt()
  {
    AppMethodBeat.i(157818);
    ArrayList localArrayList = eGq();
    int i = localArrayList.size();
    Object localObject1 = Arrays.asList(EWI);
    Object localObject2 = Arrays.asList(EWJ);
    Object localObject3 = Arrays.asList(EWK);
    i -= 1;
    if (i >= 0)
    {
      a locala = (a)localArrayList.get(i);
      if (!((List)localObject1).contains(locala.EWN))
      {
        localArrayList.remove(i);
        ad.d("MicroMsg.SdcardUtil", "Remove with filesystem mismatch: " + locala.EWN);
      }
      for (;;)
      {
        i -= 1;
        ...
        String str;
        for (boolean bool = false; localIterator.hasNext(); bool = locala.EWM.startsWith(str) | bool) {
          str = (String)localIterator.next();
        }
        if (bool)
        {
          localArrayList.remove(i);
          ad.d("MicroMsg.SdcardUtil", "Remove with bad mount dir1: " + locala.EWM);
        }
        else if ((locala.EWN.equals("fuse")) || (locala.EWN.equals("sdcardfs")))
        {
          if (locala.EWL.startsWith("/data/"))
          {
            localArrayList.remove(i);
            ad.d("MicroMsg.SdcardUtil", "Remove with bad mount dir2: " + locala.EWL);
          }
        }
        else if ((!locala.EWN.equals("fuse")) && (!locala.EWN.equals("sdcardfs")))
        {
          localIterator = ((List)localObject3).iterator();
          for (bool = false; localIterator.hasNext(); bool = locala.EWL.startsWith(str) | bool) {
            str = (String)localIterator.next();
          }
          if (!bool)
          {
            localArrayList.remove(i);
            ad.d("MicroMsg.SdcardUtil", "Remove with bad device name: " + locala.EWL);
          }
        }
      }
    }
    ...
    if (i >= 0)
    {
      ...
      if (((a)localObject2).EWM.equals(localObject1))
      {
        localArrayList.remove(i);
    ...
    for (i = 1;; i = 0)
    {
      ...
      {
        localObject2 = new a();
        ((a)localObject2).EWM = ((String)localObject1);
        ((a)localObject2).EWN = "unknown";
        ((a)localObject2).EWL = "unknown";
        localArrayList.add(0, localObject2);
      }
      ...
      for (;;)
      {
        if (i >= 0)
        {
          ...
          localObject2 = new e(((a)localObject1).EWM);
      ...
      if (!localArrayList.isEmpty())
      {
        ...
        {
          localObject2 = (a)localArrayList.get(i);
          if (!((a)localObject1).EWL.equals(((a)localObject2).EWL)) {
            break label913;
          }
          localArrayList.remove(i);
          ad.d("MicroMsg.SdcardUtil", "Duplicate with same DevName:" + ((a)localObject1).EWL);
          if ((((a)localObject1).cGF) || (!((a)localObject2).cGF)) {
            break label913;
          }
  ...
  public static boolean eGw()
  {
    ...
    for (;;)
    {
      ...
      if ((localObject3 == null) && (((a)localObject2).EWM.equals(str2)))
      {
        if (localObject1 != null) {
          break label492;
        }
      ...
      {
        if ((localObject1 != null) || (!((a)localObject2).EWM.equals(str1))) {
          break label485;
        }
    ...
    for (;;)
    {
      ...
      if ((localObject4 != null) && (localObject2 == null) && (!bt.isNullOrNil(str1)) && (str1.contains("emulated")))
      {
        ...
        if (i != -1)
        {
          ...
          if (!bt.isNullOrNil((String)localObject3))
          {
            ...
            } while (!((a)localObject1).EWM.equals(localObject3));
          }
        }
      }
      for (;;)
      {
        if ((localObject4 != null) && (localObject1 != null))
        {
          ...
          if (((!((a)localObject1).EWN.equals("fuse")) && (!((a)localObject1).EWN.equals("sdcardfs")) && (!((a)localObject1).EWN.equals("esdfs"))) || (localObject4.EWO < ((a)localObject1).EWO) || (((a)localObject1).EWO <= 0L) || (localObject4.EWR < ((a)localObject1).EWR) || (((a)localObject1).EWR <= 0L) || (localObject4.EWQ < ((a)localObject1).EWQ)) {}
        }
  ...
  public static final class a
  {
    ...
    public final boolean equals(Object paramObject)
    {
      ...
      if (this.EWR != paramObject.EWR)
      {
        AppMethodBeat.o(157812);
        return false;
      }
      long l1 = this.EWO - paramObject.EWO;
      long l2 = this.EWP - paramObject.EWP;
      long l3 = this.EWQ - paramObject.EWQ;
    ...
    public final String toString()
    {
      ...
      Object localObject = new StringBuilder("{DevName=").append(this.EWL).append(", MountDir=").append(this.EWM).append(", FileSystem=").append(this.EWN).append(", TotalBlocks=").append(this.EWO).append(", FreeBlocks=").append(this.EWP).append(", AvailableBlocks=").append(this.EWQ).append(", BlockSize=").append(this.EWR).append(", Shared=");
      if (this.EWS != null) {}
      for (boolean bool = true;; bool = false)
      {
        localObject = bool + "}";
