...
{
  public ArrayMap<String, Object> GqY;
  public boolean GqZ;
  ...
  private static void a(String paramString1, Object paramObject1, String paramString2, Object paramObject2, ClassCastException paramClassCastException)
  {
    ...
    ac.w("MicroMsg.ImmutableBundle", localStringBuilder.toString());
    ac.w("MicroMsg.ImmutableBundle", "Attempt to cast generated internal exception:", new Object[] { paramClassCastException });
  ...
  public final boolean aKG(String paramString)
  {
    ...
    Object localObject = this.GqY.get(paramString);
    if (localObject == null)
    {
