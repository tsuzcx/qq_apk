  ...
  implements d<T>
{
  ...
  public j(e parame, c.a parama, String paramString, String[] paramArrayOfString)
  {
    ...
    this.dbInfo = parama;
    parama = this.dbInfo;
    if (bu.isNullOrNil(this.dbInfo.IBM)) {}
    for (parame = "rowid";; parame = this.dbInfo.IBM)
    {
      parama.IBM = parame;
  ...
  {
    ae.d("MicroMsg.SDK.MAutoStorage", getTableName() + ":" + paramString);
  }
  
  private void LOGE(String paramString)
  {
    ae.e("MicroMsg.SDK.MAutoStorage", getTableName() + ":" + paramString);
  }
  ...
  {
    Cursor localCursor = this.db.query(getTableName(), this.dbInfo.columns, this.dbInfo.IBM + " = ?", new String[] { bu.nullAsNil(paramContentValues.getAsString(this.dbInfo.IBM)) }, null, null, null);
  ...
  public static List<String> getUpdateSQLs(c.a parama, String paramString, e parame)
  {
    ...
    if ((parame == null) || (paramString == null))
    {
      ...
      {
        ae.e("MicroMsg.SDK.MAutoStorage", "dk getUpdateSQLs db==null :%b  table:%s", new Object[] { Boolean.valueOf(bool), paramString });
    ...
    parama = parama.IBN.entrySet().iterator();
    while (parama.hasNext())
    {
      ...
      if ((localObject1 != null) && (((String)localObject1).length() > 0))
      {
        ...
        {
          ae.e("MicroMsg.SDK.MAutoStorage", "conflicting alter table on column: " + (String)localObject2 + ", " + str + "<o-n>" + (String)localObject1);
          parame.remove(localObject2);
        }
      }
    }
  ...
  private void updateColumnSQLs(String[] paramArrayOfString)
  {
    ...
    while (i < localList.size())
    {
      if (!this.db.execSQL(this.table, (String)localList.get(i))) {
        ae.i("MicroMsg.SDK.MAutoStorage", "updateColumnSQLs table failed %s, sql %s", new Object[] { this.table, localList.get(i) });
      }
      i += 1;
    }
  ...
  private static String[] valuesFromKeys(String[] paramArrayOfString, ContentValues paramContentValues)
  {
    ...
    {
      arrayOfString[i] = bu.nullAsNil(paramContentValues.getAsString(paramArrayOfString[i]));
      i += 1;
    }
  ...
  public boolean delete(T paramT, boolean paramBoolean, String... paramVarArgs)
  {
    ...
    do
    {
      do
      {
        ...
        if (this.db.delete(getTableName(), this.dbInfo.IBM + " = ?", new String[] { bu.nullAsNil(paramT.getAsString(this.dbInfo.IBM)) }) > 0) {
          bool1 = true;
        }
        bool2 = bool1;
      } while (!bool1);
  ...
  public boolean get(T paramT, String... paramVarArgs)
  {
    ...
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0))
    {
      ...
      paramVarArgs = this.db.a(getTableName(), this.dbInfo.columns, this.dbInfo.IBM + " = ?", new String[] { bu.nullAsNil(localContentValues.getAsString(this.dbInfo.IBM)) }, null, null, null, 2);
  ...
  public boolean insertNotify(T paramT, boolean paramBoolean)
  {
    ...
    paramT.systemRowid = this.db.insert(getTableName(), this.dbInfo.IBM, localContentValues);
    ...
    if (paramBoolean) {
      doNotify(localContentValues.getAsString(this.dbInfo.IBM));
    }
    return true;
  }
  ...
  public boolean replace(T paramT, boolean paramBoolean)
  {
    ...
    boolean bool1 = bool2;
    if (this.db.replace(getTableName(), this.dbInfo.IBM, localContentValues) > 0L) {
      bool1 = true;
    }
  ...
  public boolean updateNotify(T paramT, boolean paramBoolean, String... paramVarArgs)
  {
    ...
    do
    {
      do
      {
        ...
        if (this.db.update(getTableName(), paramT, this.dbInfo.IBM + " = ?", new String[] { bu.nullAsNil(paramT.getAsString(this.dbInfo.IBM)) }) > 0) {
          bool1 = true;
        }
        bool2 = bool1;
      } while (!bool1);
    ...
    {
      if (paramBoolean) {
        doNotify(paramT.getAsString(this.dbInfo.IBM));
      }
      return true;
    }
    LOGE("update failed");
