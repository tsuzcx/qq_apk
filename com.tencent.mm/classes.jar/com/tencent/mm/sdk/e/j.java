  ...
  implements d<T>
{
  ...
  public j(e parame, c.a parama, String paramString, String[] paramArrayOfString)
  {
    ...
    this.dbInfo = parama;
    parama = this.dbInfo;
    if (bt.isNullOrNil(this.dbInfo.IhB)) {}
    for (parame = "rowid";; parame = this.dbInfo.IhB)
    {
      parama.IhB = parame;
  ...
  {
    Cursor localCursor = this.db.query(getTableName(), this.dbInfo.columns, this.dbInfo.IhB + " = ?", new String[] { bt.nullAsNil(paramContentValues.getAsString(this.dbInfo.IhB)) }, null, null, null);
  ...
  public static List<String> getUpdateSQLs(c.a parama, String paramString, e parame)
  {
    ...
    parama = parama.IhC.entrySet().iterator();
  ...
  public boolean delete(T paramT, boolean paramBoolean, String... paramVarArgs)
  {
    ...
    do
    {
      do
      {
        ...
        if (this.db.delete(getTableName(), this.dbInfo.IhB + " = ?", new String[] { bt.nullAsNil(paramT.getAsString(this.dbInfo.IhB)) }) > 0) {
          bool1 = true;
        }
        bool2 = bool1;
      } while (!bool1);
  ...
  public boolean get(T paramT, String... paramVarArgs)
  {
    ...
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0))
    {
      ...
      paramVarArgs = this.db.a(getTableName(), this.dbInfo.columns, this.dbInfo.IhB + " = ?", new String[] { bt.nullAsNil(localContentValues.getAsString(this.dbInfo.IhB)) }, null, null, null, 2);
  ...
  public boolean insertNotify(T paramT, boolean paramBoolean)
  {
    ...
    paramT.systemRowid = this.db.insert(getTableName(), this.dbInfo.IhB, localContentValues);
    ...
    if (paramBoolean) {
      doNotify(localContentValues.getAsString(this.dbInfo.IhB));
    }
    return true;
  }
  ...
  public boolean replace(T paramT, boolean paramBoolean)
  {
    ...
    boolean bool1 = bool2;
    if (this.db.replace(getTableName(), this.dbInfo.IhB, localContentValues) > 0L) {
      bool1 = true;
    }
  ...
  public boolean updateNotify(T paramT, boolean paramBoolean, String... paramVarArgs)
  {
    ...
    do
    {
      do
      {
        ...
        if (this.db.update(getTableName(), paramT, this.dbInfo.IhB + " = ?", new String[] { bt.nullAsNil(paramT.getAsString(this.dbInfo.IhB)) }) > 0) {
          bool1 = true;
        }
        bool2 = bool1;
      } while (!bool1);
    ...
    {
      if (paramBoolean) {
        doNotify(paramT.getAsString(this.dbInfo.IhB));
      }
      return true;
    }
    LOGE("update failed");
