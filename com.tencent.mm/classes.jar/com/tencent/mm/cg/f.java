...
{
  private static volatile f FaK;
  public static Pattern FaW;
  private static final Comparator<a> FaX;
  ...
  public String[] FaP;
  public String[] FaQ;
  public ArrayList<SmileyInfo> FaR;
  private final List<a> FaS;
  private HashMap<String, SmileyInfo> FaT;
  ...
  private f(Context paramContext)
  {
    ...
    this.FaP = null;
    this.FaQ = null;
    this.FaS = Collections.synchronizedList(new LinkedList());
    this.FaT = new HashMap();
    this.FaU = new SparseArray();
    this.FaV = new com.tencent.mm.memory.a.b(100, getClass());
    long l = System.currentTimeMillis();
    this.FaL = paramContext.getResources().getStringArray(2130903086);
    this.FaM = paramContext.getResources().getStringArray(2130903089);
    this.FaN = paramContext.getResources().getStringArray(2130903087);
    this.FaO = paramContext.getResources().getStringArray(2130903091);
    this.FaP = paramContext.getResources().getStringArray(2130903088);
    this.FaQ = paramContext.getResources().getStringArray(2130903090);
    eHX();
  ...
  private Drawable a(a parama)
  {
    ...
    int i = parama.pos;
    if (i >= 0) {}
    for (parama = b.eHL().vc(i);; parama = aGR(parama.name))
    {
  ...
  private boolean a(int paramInt1, SpannableString paramSpannableString, int paramInt2)
  {
    ...
    a locala = aGQ(paramSpannableString.subSequence(paramInt1, paramSpannableString.length()));
    if (locala != null)
    {
      ...
      {
        b.eHL().a(paramSpannableString, localDrawable, paramInt1, paramInt1 + locala.text.length(), paramInt2);
  ...
  /* Error */
  private Drawable aGR(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
    ...
    //   15: invokestatic 230	com/tencent/mm/ar/a:axo	()Ljava/lang/String;
    ...
    //   37: astore 6
    //   39: aload_0
    //   40: getfield 109	com/tencent/mm/cg/f:FaV	Lcom/tencent/mm/b/f;
    //   43: aload_1
    ...
    //   59: aload 7
    //   61: invokestatic 250	com/tencent/mm/vfs/i:eK	(Ljava/lang/String;)Z
    //   64: ifeq +422 -> 486
    //   67: aload 7
    ...
    //   122: invokestatic 275	com/tencent/mm/sdk/platformtools/aj:cbe	()Z
    //   125: ifne +176 -> 301
    //   128: ldc 139
    //   130: ldc_w 277
    ...
    //   189: ifnull +17 -> 206
    //   192: aload_0
    //   193: getfield 109	com/tencent/mm/cg/f:FaV	Lcom/tencent/mm/b/f;
    //   196: aload_1
    //   197: aload_2
    ...
    //   310: dup
    //   311: iconst_0
    //   312: getstatic 58	com/tencent/mm/cg/f:FaY	Z
    ...
    //   322: getstatic 58	com/tencent/mm/cg/f:FaY	Z
    //   325: ifne -189 -> 136
    //   328: iconst_1
    //   329: putstatic 58	com/tencent/mm/cg/f:FaY	Z
    //   332: invokestatic 334	com/tencent/mm/pluginsdk/h/a/a/b:ewn	()Lcom/tencent/mm/pluginsdk/h/a/a/b;
    //   335: bipush 37
    //   337: iconst_1
    //   338: iconst_m1
    //   339: iconst_0
    //   340: invokevirtual 338	com/tencent/mm/pluginsdk/h/a/a/b:e	(IIIZ)V
    //   343: invokestatic 344	com/tencent/mm/kernel/g:afB	()Lcom/tencent/mm/kernel/e;
    //   346: invokevirtual 350	com/tencent/mm/kernel/e:afk	()Lcom/tencent/mm/storage/ab;
    //   349: getstatic 356	com/tencent/mm/storage/ae$a:FgA	Lcom/tencent/mm/storage/ae$a;
    //   352: iconst_0
    //   353: invokestatic 361	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   356: invokevirtual 367	com/tencent/mm/storage/ab:set	(Lcom/tencent/mm/storage/ae$a;Ljava/lang/Object;)V
    //   359: new 369	com/tencent/mm/pluginsdk/h/a/a/m
    //   362: dup
    //   363: bipush 37
    //   365: invokespecial 371	com/tencent/mm/pluginsdk/h/a/a/m:<init>	(I)V
    //   368: astore_3
    //   369: invokestatic 375	com/tencent/mm/kernel/g:afA	()Lcom/tencent/mm/kernel/b;
    //   372: getfield 381	com/tencent/mm/kernel/b:gcy	Lcom/tencent/mm/al/q;
    //   375: aload_3
    //   376: iconst_0
  ...
  private int eHW()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.FaS.clear();
        if ((this.FaL != null) && (this.FaN != null) && (this.FaL.length == this.FaN.length))
        {
          j = this.FaL.length;
          i = 0;
          if (i >= j) {
          ...
          String str6 = this.FaL[i];
          String str7 = this.FaN[i];
          if ((this.FaM != null) && (this.FaM.length > i))
          {
            String str1 = this.FaM[i];
            if ((this.FaO == null) || (this.FaO.length <= i)) {
              break label424;
            }
            str3 = this.FaO[i];
            if ((this.FaP == null) || (this.FaP.length <= i)) {
              break label432;
            }
            str4 = this.FaP[i];
            if ((this.FaQ == null) || (this.FaQ.length <= i)) {
              break label440;
            }
            str5 = this.FaQ[i];
            SmileyInfo localSmileyInfo = new SmileyInfo(str6, str1, str7, str3, str4, str5, i);
            this.FaS.add(new a(i, str6, ""));
            this.FaS.add(new a(i, str7, ""));
            this.FaS.add(new a(i, str1, ""));
            this.FaS.add(new a(i, str3, ""));
            this.FaS.add(new a(i, str4, ""));
            this.FaS.add(new a(i, str5, ""));
            this.FaT.put(str6, localSmileyInfo);
            this.FaU.put(localSmileyInfo.field_eggIndex, localSmileyInfo.field_key);
            i += 1;
            continue;
            if ((this.FaR == null) || (this.FaR.isEmpty())) {
              Collections.sort(this.FaS, FaX);
            }
  ...
  private static void gN(List<SmileyInfo> paramList)
  {
  ...
  public final Drawable a(SmileyInfo paramSmileyInfo)
  {
    ...
    if (i >= 0) {}
    for (paramSmileyInfo = b.eHL().vc(i);; paramSmileyInfo = aGR(paramSmileyInfo.field_fileName))
    {
  ...
  public final a aGQ(String paramString)
  {
    ...
    for (;;)
    {
      synchronized (this.FaS)
      {
        ...
        int i = Collections.binarySearch(this.FaS, locala, FaX);
        if (i < 0)
        {
          i = -i - 2;
          if ((i >= 0) && (i < this.FaS.size()))
          {
            locala = (a)this.FaS.get(i);
            if ((locala != null) && (paramString != null) && (paramString.startsWith(locala.text)))
            {
              paramString = (a)this.FaS.get(i);
  ...
  public final SmileyInfo aGS(String paramString)
  {
    AppMethodBeat.i(104943);
    if ((this.FaT != null) && (this.FaT.containsKey(paramString)))
    {
      paramString = (SmileyInfo)this.FaT.get(paramString);
  ...
  public final boolean eHX()
  {
    ...
    ArrayList localArrayList = ((d)g.ad(d.class)).getProvider().bUE();
  ...
  public final void eHY()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ad.i("MicroMsg.QQSmileyManager", "updateSmiley " + bt.eGN());
        l = System.currentTimeMillis();
        this.FaT.clear();
        this.FaU.clear();
        this.FaV.clear();
        eHW();
        this.FaR = ((PluginEmoji)g.ad(PluginEmoji.class)).getProvider().bUE();
        if ((this.FaR == null) || (this.FaR.isEmpty())) {
          this.FaR = com.tencent.mm.emoji.d.b.e(new com.tencent.mm.vfs.e("assets:///newemoji/newemoji-config.xml"));
        }
        if ((this.FaR == null) || (this.FaR.isEmpty())) {
          break;
        }
        ...
        this.FaT.put(localSmileyInfo.field_key, localSmileyInfo);
        this.FaU.put(localSmileyInfo.field_eggIndex, localSmileyInfo.field_key);
        this.FaS.add(new a(-1, localSmileyInfo.field_key, localSmileyInfo.field_fileName));
        ...
        this.FaS.add(new a(-1, localSmileyInfo.field_cnValue, localSmileyInfo.field_fileName));
      }
      finally {}
      continue;
      label528:
      this.FaS.add(new a(-1, localSmileyInfo.field_qqValue, localSmileyInfo.field_fileName));
      continue;
      label559:
      this.FaS.add(new a(-1, localSmileyInfo.field_twValue, localSmileyInfo.field_fileName));
      continue;
      label590:
      this.FaS.add(new a(-1, localSmileyInfo.field_enValue, localSmileyInfo.field_fileName));
      continue;
      label621:
      this.FaS.add(new a(-1, localSmileyInfo.field_thValue, localSmileyInfo.field_fileName));
    }
  ...
  public final ArrayList<String> eHZ()
  {
 ...
 * Qualified Name:     com.tencent.mm.cg.f
