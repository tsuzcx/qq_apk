...
public final class j
{
  ...
  public static long L(String paramString, long paramLong1, long paramLong2)
  {
    ...
    SharedPreferences localSharedPreferences = MultiProcessSharedPreferences.getSharedPreferences(MMApplicationContext.getContext(), "update_flowstat_prefs", com.tencent.mm.compatible.util.g.aps());
  ...
  public static void aL(Context paramContext, int paramInt)
  {
    ...
    l(paramContext, paramInt, 0);
    AppMethodBeat.o(32727);
  }
  
  public static boolean bhM(String paramString)
  {
    AppMethodBeat.i(32736);
    String[] arrayOfString = gwr();
  ...
  public static long bhN(String paramString)
  {
    AppMethodBeat.i(32743);
    long l = MultiProcessSharedPreferences.getSharedPreferences(MMApplicationContext.getContext(), "update_flowstat_prefs", com.tencent.mm.compatible.util.g.aps()).getLong(paramString, 0L);
  ...
  public static String gnt()
  {
    ...
    String str = MultiProcessSharedPreferences.getSharedPreferences(MMApplicationContext.getContext(), "update_config_prefs", com.tencent.mm.compatible.util.g.aps()).getString("update_downloaded_pack_md5_key", null);
  ...
  public static String gwm()
  {
    ...
    String str = MultiProcessSharedPreferences.getSharedPreferences(MMApplicationContext.getContext(), "update_config_prefs", com.tencent.mm.compatible.util.g.aps()).getString("update_downloaded_pack_sig_key", null);
  ...
  public static String gwn()
  {
    ...
    String str = MultiProcessSharedPreferences.getSharedPreferences(MMApplicationContext.getContext(), "update_config_prefs", com.tencent.mm.compatible.util.g.aps()).getString("update_downloaded_pack_desc_key", null);
  ...
  public static int gwo()
  {
    ...
    int i = MultiProcessSharedPreferences.getSharedPreferences(MMApplicationContext.getContext(), "update_config_prefs", com.tencent.mm.compatible.util.g.aps()).getInt("update_downloaded_pack_download_mode", 0);
  ...
  public static int gwp()
  {
    ...
    int i = MultiProcessSharedPreferences.getSharedPreferences(MMApplicationContext.getContext(), "update_config_prefs", com.tencent.mm.compatible.util.g.aps()).getInt("update_downloaded_cancel_times", 0);
  ...
  public static void gwq()
  {
    ...
    SharedPreferences localSharedPreferences = MultiProcessSharedPreferences.getSharedPreferences(MMApplicationContext.getContext(), "update_config_prefs", com.tencent.mm.compatible.util.g.aps());
  ...
  private static String[] gwr()
  {
    ...
    Object localObject = MultiProcessSharedPreferences.getSharedPreferences(MMApplicationContext.getContext(), "update_config_prefs", com.tencent.mm.compatible.util.g.aps()).getString("update_downloaded_ignored_pack", null);
  ...
  public static int h(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    int i = h.a(com.tencent.mm.pluginsdk.i.g.gp(paramContext), paramString1, paramString2, paramString3);
