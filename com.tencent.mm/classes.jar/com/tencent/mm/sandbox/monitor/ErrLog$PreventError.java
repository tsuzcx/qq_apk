  ...
  implements Parcelable
{
  ...
  protected ErrLog$PreventError(Parcel paramParcel)
  {
    ...
    this.acmO = ((ErrLog.Error)paramParcel.readParcelable(ErrLog.Error.class.getClassLoader()));
  ...
  public String toString()
  {
    ...
    String str = "PreventError{username='" + this.username + '\'' + ", tag='" + this.tag + '\'' + ", err=" + this.acmO + ", processName='" + this.processName + '\'' + '}';
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    paramParcel.writeParcelable(this.acmO, paramInt);
