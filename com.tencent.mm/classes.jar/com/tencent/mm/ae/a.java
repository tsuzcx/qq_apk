...
{
  private static final WeakHashMap<Activity, Integer> gFW;
  ...
  public static String akR()
  {
    ...
    synchronized (gFW)
    {
      ...
      localStringBuilder.append(gFW.size());
      localObject2 = new ArrayList();
    }
    try
    {
      ((List)localObject2).addAll(gFW.keySet());
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (localActivity != null)
        {
          ...
          localStringBuilder.append(":");
          localStringBuilder.append(gFW.get(localActivity));
        }
      }
  ...
  public final void onActivityCreated(Activity paramActivity, Bundle arg2)
  {
    ...
    synchronized (gFW)
    {
      gFW.put(paramActivity, Integer.valueOf(0));
  ...
  public final void onActivityDestroyed(Activity paramActivity)
  {
    ...
    synchronized (gFW)
    {
      gFW.put(paramActivity, Integer.valueOf(5));
  ...
  public final void onActivityPaused(Activity paramActivity)
  {
    ...
    synchronized (gFW)
    {
      gFW.put(paramActivity, Integer.valueOf(3));
  ...
  public final void onActivityResumed(Activity paramActivity)
  {
    ...
    synchronized (gFW)
    {
      gFW.put(paramActivity, Integer.valueOf(2));
  ...
  public final void onActivityStarted(Activity paramActivity)
  {
    ...
    synchronized (gFW)
    {
      gFW.put(paramActivity, Integer.valueOf(1));
  ...
  public final void onActivityStopped(Activity paramActivity)
  {
    ...
    synchronized (gFW)
    {
      gFW.put(paramActivity, Integer.valueOf(4));
