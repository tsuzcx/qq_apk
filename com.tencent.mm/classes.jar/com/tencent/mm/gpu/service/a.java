  ...
  implements Thread.UncaughtExceptionHandler
{
  ...
  public final void uncaughtException(Thread paramThread, Throwable paramThrowable)
  {
    ...
    ac.i("Gpu.GpuExceptionHandler", "threadName = ".concat(String.valueOf(paramThread.getName())));
    ...
    ac.e("Gpu.GpuExceptionHandler", "crashTime = ".concat(String.valueOf(System.nanoTime())));
    int i = 0;
    if (i < j + 1)
    {
      ...
      {
        ac.e("Gpu.GpuExceptionHandler", "segToReport = ".concat(String.valueOf(paramThread)));
        i += 1;
        break;
      }
    }
    ac.e("Gpu.GpuExceptionHandler", paramThrowable);
