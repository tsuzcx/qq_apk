  ...
  implements Thread.UncaughtExceptionHandler
{
  ...
  public final void uncaughtException(Thread paramThread, Throwable paramThrowable)
  {
    ...
    Log.i("Gpu.GpuExceptionHandler", "threadName = ".concat(String.valueOf(paramThread.getName())));
    ...
    if (i < j + 1)
    {
      ...
      {
        Log.e("Gpu.GpuExceptionHandler", "segToReport = ".concat(String.valueOf(paramThread)));
        i += 1;
        break;
      }
    }
    Log.e("Gpu.GpuExceptionHandler", paramThrowable);
