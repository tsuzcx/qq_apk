  ...
  implements Thread.UncaughtExceptionHandler
{
  ...
  public final void uncaughtException(Thread paramThread, Throwable paramThrowable)
  {
    ...
    ae.i("Gpu.GpuExceptionHandler", "threadName = ".concat(String.valueOf(paramThread.getName())));
    ...
    ae.e("Gpu.GpuExceptionHandler", "crashTime = ".concat(String.valueOf(System.nanoTime())));
    int i = 0;
    if (i < j + 1)
    {
      ...
      {
        ae.e("Gpu.GpuExceptionHandler", "segToReport = ".concat(String.valueOf(paramThread)));
        i += 1;
        break;
      }
    }
    ae.e("Gpu.GpuExceptionHandler", paramThrowable);
