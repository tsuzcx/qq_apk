...
public final class c
  implements INetworkApi, com.tencent.mm.ak.g
{
  private float dmL;
  private float doB;
  private int doC;
  ...
  public c(float paramFloat1, float paramFloat2, int paramInt1, int paramInt2, String paramString1, String paramString2, int paramInt3, int paramInt4)
  {
    ...
    this.timerHandler = new au(com.tencent.mm.kernel.g.agU().GrZ.getLooper(), new au.a()
    {
      public final boolean onTimerExpired()
      {
        AppMethodBeat.i(150904);
        ac.w("MicroMsg.SenseWhereHttpUtil", "it is time up, has no sense where response.");
        if (c.a(c.this) != null) {
          com.tencent.mm.kernel.g.agQ().ghe.a(c.a(c.this));
        }
        c.b(c.this);
        c.c(c.this);
    ...
    com.tencent.mm.kernel.g.agQ().ghe.a(752, this);
  ...
  private void aHe()
  {
    ...
    com.tencent.mm.kernel.g.agQ().ghe.b(752, this);
  ...
  public final void finish()
  {
    ...
    if (this.hRv != null) {
      com.tencent.mm.kernel.g.agQ().ghe.a(this.hRv);
    }
    this.hRv = null;
    this.hRw = null;
  ...
  public final byte[] httpRequest(String paramString, byte[] paramArrayOfByte)
  {
    ...
    ac.w("MicroMsg.SenseWhereHttpUtil", "why use this method? sense where sdk has something warn.");
  ...
  public final byte[] httpRequest(byte[] arg1)
  {
    ...
    for (;;)
    {
      ...
      {
        ??? = new String(???, "UTF-8");
        ac.d("MicroMsg.SenseWhereHttpUtil", "sense where http request content : ".concat(String.valueOf(???)));
        this.hRw = null;
        this.hRv = new a(this.doB, this.dmL, this.doC, this.doD, this.doE, this.doF, this.hRx, this.scene, ???);
        com.tencent.mm.kernel.g.agQ().ghe.a(this.hRv, 0);
        this.timerHandler.au(60000L, 60000L);
      }
      catch (Exception ???)
      {
        ac.printErrStackTrace("MicroMsg.SenseWhereHttpUtil", ???, "", new Object[0]);
        ac.e("MicroMsg.SenseWhereHttpUtil", "sense where http request error: " + ???.toString());
        continue;
      }
      synchronized (this.lock)
      {
        this.lock.wait();
        ac.i("MicroMsg.SenseWhereHttpUtil", "upload sense where info finish. it is response is null? %b", new Object[] { Boolean.valueOf(bs.cv(this.hRw)) });
        ??? = this.hRw;
  ...
  public final void onSceneEnd(int paramInt1, int paramInt2, String arg3, com.tencent.mm.ak.n paramn)
  {
    ...
    //   5: aload_0
    //   6: getfield 75	com/tencent/mm/bf/c:timerHandler	Lcom/tencent/mm/sdk/platformtools/au;
    //   9: invokevirtual 130	com/tencent/mm/sdk/platformtools/au:stopTimer	()V
    //   12: iload_1
    //   13: ifne +140 -> 153
    //   16: iload_2
    //   17: ifne +136 -> 153
    ...
    //   33: getfield 238	com/tencent/mm/bf/a:hQW	Ljava/lang/String;
    //   36: ldc 209
    //   38: invokestatic 242	com/tencent/mm/sdk/platformtools/bs:bG	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   41: astore_3
    //   42: ldc 143
    //   44: ldc 244
    //   46: aload_3
    ...
    //   53: invokestatic 174	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   56: aload_0
    //   57: aload_3
    //   58: ldc 159
    //   60: invokevirtual 248	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   63: putfield 123	com/tencent/mm/bf/c:hRw	[B
    //   66: aload_0
    ...
    //   82: aload_0
    //   83: aconst_null
    //   84: putfield 114	com/tencent/mm/bf/c:hRv	Lcom/tencent/mm/bf/a;
    //   87: ldc 235
    ...
    //   103: invokestatic 213	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   106: ldc 143
    ...
    //   127: invokestatic 232	com/tencent/mm/sdk/platformtools/ac:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   130: goto -64 -> 66
    //   133: aload_0
    //   134: aconst_null
    //   135: putfield 123	com/tencent/mm/bf/c:hRw	[B
    //   138: goto -72 -> 66
    //   141: astore 4
    //   143: aload_3
    //   144: monitorexit
    ...
    //   177: aload_3
    //   178: aastore
    //   179: invokestatic 259	com/tencent/mm/sdk/platformtools/ac:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   182: aload_0
    //   183: aconst_null
    //   184: putfield 123	com/tencent/mm/bf/c:hRw	[B
    //   187: aload_0
    ...
    //   201: aload_3
    //   202: monitorexit
    //   203: invokestatic 265	com/tencent/mm/bf/b:aGU	()Lcom/tencent/mm/bf/b;
    //   206: invokevirtual 268	com/tencent/mm/bf/b:aGW	()V
    //   209: getstatic 274	com/tencent/mm/plugin/report/service/h:wUl	Lcom/tencent/mm/plugin/report/service/h;
    //   212: ldc2_w 275
    //   215: ldc2_w 277
    //   218: lconst_1
    //   219: iconst_0
