  ...
  extends f
{
  ...
  public final void a(StringBuilder paramStringBuilder, k.b paramb, String paramString, com.tencent.mm.i.d paramd, int paramInt1, int paramInt2)
  {
    ...
    label47:
    for (paramb = new EmojiInfo();; paramb = this.jHh)
    {
      e.a(paramStringBuilder, paramb, this.gbq);
  ...
  public final void a(Map<String, String> paramMap, k.b paramb)
  {
    ...
    if (paramb.type == 2001)
    {
      ...
      paramb.field_temp = 1;
      paramb.field_catalog = EmojiInfo.YCx;
      paramb.field_state = EmojiInfo.ZuH;
      this.jHh = paramb;
      this.gbq = Util.getInt((String)paramMap.get(".msg.appmsg.emoji.localreceivestatus"), 0);
      if (p.getEmojiStorageMgr().VFH.bxK(paramb.field_md5) == null) {
        p.getEmojiStorageMgr().VFH.K(this.jHh);
      }
      Log.d("MicroMsg.AppContentLuckyMoneyEmogiPiece", "EmojiInfo: %s", new Object[] { this.jHh });
    }
