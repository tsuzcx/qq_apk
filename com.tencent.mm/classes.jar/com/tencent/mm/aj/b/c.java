...
public final class c
{
  ...
  public static c Pb(String paramString)
  {
    ...
    localc.lqH = ((String)paramString.get(".sysmsg.subscribesysmsg.content_template.template"));
    localc.title = ((String)paramString.get(".sysmsg.subscribesysmsg.content_template.link_list.link.title"));
    localc.content = localc.lqH.replace("$wxaapp_view$", localc.title);
    ...
    localc.cwU = ((String)paramString.get(".sysmsg.subscribesysmsg.content_template.link_list.link.share_key"));
    localc.lqI = Util.getInt((String)paramString.get(".sysmsg.subscribesysmsg.content_template.link_list.link.forbids"), 0);
    localc.lqJ = Util.getInt((String)paramString.get(".sysmsg.subscribesysmsg.content_template.link_list.link.wxaapp_type"), 1);
    AppMethodBeat.o(2615);
    return localc;
  }
}
