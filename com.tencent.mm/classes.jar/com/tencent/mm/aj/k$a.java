...
public enum k$a
{
  static
  {
    ...
    llQ = new a("BUSINESS_MY_LIFE_AROUND", 0);
    llR = new a("BUSINESS_OTHER", 1);
    llS = new a("BUSINESS_MAX", 2);
    llT = new a[] { llQ, llR, llS };
  ...
  public static boolean uB(int paramInt)
  {
    ...
    if ((paramInt >= llQ.ordinal()) && (paramInt < llS.ordinal()))
    {
 ...
 * Qualified Name:     com.tencent.mm.aj.k.a
