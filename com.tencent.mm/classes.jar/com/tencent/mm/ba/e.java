  ...
  extends a
{
  ...
  protected final boolean aAc()
  {
    ...
    if ((!bt.isNullOrNil(this.TYPE)) && (this.TYPE.equalsIgnoreCase("delchatroommember")))
    {
      ...
      this.dAD = bt.nullAsNil((String)this.values.get(".sysmsg.delchatroommember.link.qrcode"));
      this.iid.add(this.values.get(".sysmsg.delchatroommember.link.memberlist.username"));
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (((String)localObject2).startsWith(".sysmsg.delchatroommember.link.memberlist.username#")) {
          this.iid.add(this.values.get(localObject2));
        }
      }
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        else
        {
          ...
          ((StringBuilder)localObject1).append((String)this.values.get(str));
          this.ihQ.add(this.values.get(str));
    ...
    {
      break;
      this.ihR.addFirst(Integer.valueOf(((StringBuilder)localObject1).length() - i));
      this.ihS.add(Integer.valueOf(((StringBuilder)localObject1).length()));
      this.ihO = ((StringBuilder)localObject1).toString();
      ad.i("MicroMsg.DelChatroomMemberNewXmlMsg", "[parseXml] url:%s, qrcode:%s, members size :%s", new Object[] { this.url, this.dAD, Integer.valueOf(this.iid.size()) });
      AppMethodBeat.o(101788);
      return true;
