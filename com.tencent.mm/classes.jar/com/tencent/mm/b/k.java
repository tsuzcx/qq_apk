...
public final class k
{
  ...
  private static void a(j paramj1, j paramj2, j paramj3, j paramj4)
  {
    ...
    byte[][] arrayOfByte6 = { { 4, 11, 2, 14, 15, 0, 8, 13, 3, 12, 9, 7, 5, 10, 6, 1 }, { 13, 0, 11, 7, 4, 9, 1, 10, 14, 3, 5, 12, 2, 15, 8, 6 }, { 1, 4, 11, 13, 12, 3, 7, 14, 10, 15, 6, 8, 0, 5, 9, 2 }, { 6, 11, 13, 8, 1, 4, 10, 7, 9, 5, 0, 15, 14, 2, 3, 12 } };
    Object localObject3 = { 1, 15, 13, 8, 10, 3, 7, 4, 12, 5, 6, 11, 0, 14, 9, 2 };
    localObject3 = new byte[][] { { 13, 2, 8, 4, 6, 15, 11, 1, 10, 9, 3, 14, 5, 0, 12, 7 }, localObject3, { 7, 11, 4, 1, 9, 12, 14, 2, 0, 6, 10, 13, 15, 3, 5, 8 }, { 2, 1, 14, 7, 4, 10, 8, 13, 15, 12, 9, 0, 3, 5, 6, 11 } };
    int j = paramj3.begin;
    int k = paramj1.begin;
    while (i < 8)
    {
      ...
      b(paramj1, new j(new byte[][][] { { arrayOfByte1, { 0, 15, 7, 4, 14, 2, 13, 1, 10, 6, 12, 11, 9, 5, 3, 8 }, arrayOfByte2, arrayOfByte3 }, paramj2, localObject1, localObject2, arrayOfByte4, arrayOfByte5, arrayOfByte6, localObject3 }[i][m][n]), 4);
      i = (byte)(i + 1);
      paramj3.begin += 6;
      paramj1.begin += 4;
    }
