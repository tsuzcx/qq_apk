...
public final class k
{
  ...
  private static void a(j paramj1, j paramj2, j paramj3, j paramj4)
  {
    ...
    paramj2 = new byte[] { 14, 4, 13, 1, 2, 15, 11, 8, 3, 10, 6, 12, 5, 9, 0, 7 };
    ...
    byte[] arrayOfByte3 = { 10, 0, 9, 14, 6, 3, 15, 5, 1, 13, 12, 7, 11, 4, 2, 8 };
    ...
    localObject4 = new byte[][] { localObject4, { 10, 15, 4, 2, 7, 12, 9, 5, 6, 1, 13, 14, 0, 11, 3, 8 }, localObject5, { 4, 3, 2, 12, 9, 5, 15, 10, 11, 14, 1, 7, 6, 0, 8, 13 } };
    localObject5 = new byte[] { 6, 11, 13, 8, 1, 4, 10, 7, 9, 5, 0, 15, 14, 2, 3, 12 };
    localObject5 = new byte[][] { { 4, 11, 2, 14, 15, 0, 8, 13, 3, 12, 9, 7, 5, 10, 6, 1 }, { 13, 0, 11, 7, 4, 9, 1, 10, 14, 3, 5, 12, 2, 15, 8, 6 }, { 1, 4, 11, 13, 12, 3, 7, 14, 10, 15, 6, 8, 0, 5, 9, 2 }, localObject5 };
    ...
    while (i < 8)
    {
      ...
      b(paramj1, new j(new byte[][][] { { paramj2, arrayOfByte1, { 4, 1, 14, 8, 13, 6, 2, 11, 15, 12, 9, 7, 3, 10, 5, 0 }, arrayOfByte2 }, localObject1, { arrayOfByte3, arrayOfByte4, arrayOfByte5, arrayOfByte6 }, localObject2, localObject3, localObject4, localObject5, arrayOfByte }[i][m][n]), 4);
      i = (byte)(i + 1);
      paramj3.begin += 6;
      paramj1.begin += 4;
    }
