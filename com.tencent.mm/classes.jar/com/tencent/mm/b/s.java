...
{
  public static byte[] aa(byte[] paramArrayOfByte)
  {
    ...
    {
      Log.printErrStackTrace("MicroMsg.Zlib", localException, "exception when loop read byte", new Object[0]);
      try
      {
        ...
        for (;;)
        {
          ...
          {
            Log.printErrStackTrace("MicroMsg.Zlib", localIOException2, "", new Object[0]);
          }
        }
      }
      catch (IOException localIOException3)
      {
        for (;;)
        {
          Log.printErrStackTrace("MicroMsg.Zlib", localIOException3, "", new Object[0]);
        }
      }
    }
    finally
    {
      ...
      catch (IOException localIOException1)
      {
        for (;;)
        {
          Log.printErrStackTrace("MicroMsg.Zlib", localIOException1, "", new Object[0]);
        }
      }
    }
  }
  ...
  public static byte[] compress(byte[] paramArrayOfByte)
  {
    ...
    //   82: invokestatic 50	com/tencent/mm/sdk/platformtools/Log:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   85: aload_0
    //   86: astore_1
    //   87: aload_2
    //   88: ifnull +9 -> 97
    ...
    //   130: invokestatic 50	com/tencent/mm/sdk/platformtools/Log:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   133: goto -36 -> 97
    //   136: astore_1
    //   137: ldc 42
    //   139: aload_1
    ...
    //   146: invokestatic 50	com/tencent/mm/sdk/platformtools/Log:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   149: aload_0
    //   150: astore_1
    //   151: goto -54 -> 97
    //   154: astore_1
    ...
    //   203: invokestatic 50	com/tencent/mm/sdk/platformtools/Log:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   206: goto -15 -> 191
    //   209: astore_0
    //   210: aconst_null
    //   211: astore_1
 ...
 * Qualified Name:     com.tencent.mm.b.s
