...
{
  public static Set<String> hTs;
  
  private static Bitmap Dl(String paramString)
  {
    AppMethodBeat.i(20652);
    tv localtv = new tv();
    localtv.dwA.dwC = paramString;
    com.tencent.mm.sdk.b.a.GpY.l(localtv);
    paramString = (Bitmap)localtv.dwB.result;
  ...
  public static Intent a(int paramInt, WXMediaMessage paramWXMediaMessage, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    ac.d("MicroMsg.ShareSnsImpl", "appmsg.description " + paramWXMediaMessage.description);
    ac.d("MicroMsg.ShareSnsImpl", "appmsg.title " + paramWXMediaMessage.title);
    ...
    for (;;)
    {
      ...
      ac.d("MicroMsg.ShareSnsImpl", "TimeLineType " + i + " " + ((WXMediaMessage.IMediaObject)localObject1).type());
      ...
      ac.d("MicroMsg.ShareSnsImpl", "timeLineType is invalid");
    ...
    {
    default: 
      ac.e("MicroMsg.ShareSnsImpl", "none type not support!");
      AppMethodBeat.o(20651);
      return null;
    case 1: 
    ...
    case 3: 
      ...
      if (!bs.isNullOrNil(paramString1.musicUrl))
      {
        paramWXMediaMessage = paramString1.musicUrl;
        paramString2 = bs.bG(paramWXMediaMessage, "");
        if (bs.isNullOrNil(paramString1.musicDataUrl)) {
          break label624;
        }
        paramWXMediaMessage = paramString1.musicDataUrl;
        bs.bG(paramWXMediaMessage, "");
        if (bs.isNullOrNil(paramString1.musicLowBandDataUrl)) {
          break label632;
        }
      }
    ...
    case 38: 
      ...
      paramWXMediaMessage = "";
      paramString2 = i.aKe(paramString1);
      if ((bs.isNullOrNil("")) || (!i.eA("")))
      {
      ...
      try
      {
        localObject1 = Dl(paramString1);
        if (localObject1 == null) {
          break label1061;
        }
        ac.i("MicroMsg.ShareSnsImpl", "getBitmap1 %d %d", new Object[] { Integer.valueOf(((Bitmap)localObject1).getWidth()), Integer.valueOf(((Bitmap)localObject1).getHeight()) });
        f.a((Bitmap)localObject1, 80, Bitmap.CompressFormat.JPEG, paramWXMediaMessage, true);
        localObject1 = f.aKw(paramWXMediaMessage);
        ac.i("MicroMsg.ShareSnsImpl", "getBitmap2 %d %d", new Object[] { Integer.valueOf(((BitmapFactory.Options)localObject1).outWidth), Integer.valueOf(((BitmapFactory.Options)localObject1).outHeight) });
      }
      catch (Exception localException1)
      {
        for (;;)
        {
          ac.e("MicroMsg.ShareSnsImpl", "savebitmap error %s", new Object[] { localException1.getMessage() });
        }
      }
      ...
      AppMethodBeat.o(20651);
      return localIntent;
      ac.e("MicroMsg.ShareSnsImpl", "thumb null , videoPath %s ", new Object[] { paramString1 });
      AppMethodBeat.o(20651);
      return null;
    case 39: 
      ...
      ac.i("MicroMsg.ShareSnsImpl", "videoPath %s,thumbPath %s,cdnUrl %s,cdnThumbUrl %s", new Object[] { paramString1, "", paramString2, str1 });
      str2 = i.aKe(paramString1);
      if ((bs.isNullOrNil("")) || (!i.eA("")))
      {
        paramWXMediaMessage = new StringBuilder();
        az.ayM();
    ...
    for (paramWXMediaMessage = c.getAccSnsTmpPath() + str2;; paramWXMediaMessage = "")
    {
      try
      {
        Object localObject2 = Dl(paramString1);
        if (localObject2 == null) {
          break label1390;
        }
        ac.i("MicroMsg.ShareSnsImpl", "getBitmap1 %d %d", new Object[] { Integer.valueOf(((Bitmap)localObject2).getWidth()), Integer.valueOf(((Bitmap)localObject2).getHeight()) });
        f.a((Bitmap)localObject2, 80, Bitmap.CompressFormat.JPEG, paramWXMediaMessage, true);
        localObject2 = f.aKw(paramWXMediaMessage);
        ac.i("MicroMsg.ShareSnsImpl", "getBitmap2 %d %d", new Object[] { Integer.valueOf(((BitmapFactory.Options)localObject2).outWidth), Integer.valueOf(((BitmapFactory.Options)localObject2).outHeight) });
      }
      catch (Exception localException2)
      {
        ...
        {
          label1390:
          ac.e("MicroMsg.ShareSnsImpl", "savebitmap error %s", new Object[] { localException2.getMessage() });
        }
      }
      localIntent.putExtra("KSightPath", paramString1);
      localIntent.putExtra("KSightThumbPath", paramWXMediaMessage);
