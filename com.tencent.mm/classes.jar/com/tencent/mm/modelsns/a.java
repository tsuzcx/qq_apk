...
import com.tencent.mm.f.a.wv.b;
...
{
  public static Set<String> maP;
  
  private static Bitmap Xd(String paramString)
  {
    AppMethodBeat.i(20652);
    wv localwv = new wv();
    localwv.fVP.fVR = paramString;
    EventCenter.instance.publish(localwv);
    paramString = (Bitmap)localwv.fVQ.result;
  ...
  public static Intent a(int paramInt, WXMediaMessage paramWXMediaMessage, String paramString1, String paramString2, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    case 38: 
      ...
      paramWXMediaMessage = "";
      paramString2 = u.buc(paramString1);
      if ((Util.isNullOrNil("")) || (!u.agG("")))
      {
    ...
    case 39: 
      ...
      localObject1 = u.buc(paramString1);
      if ((Util.isNullOrNil("")) || (!u.agG("")))
      {
        paramWXMediaMessage = new StringBuilder();
        bh.beI();
    ...
    for (paramWXMediaMessage = c.getAccSnsTmpPath() + (String)localObject1;; paramWXMediaMessage = "")
    {
      try
      {
        Object localObject2 = Xd(paramString1);
