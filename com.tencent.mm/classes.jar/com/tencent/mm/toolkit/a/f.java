  ...
  implements com.tencent.mm.toolkit.a.a.f
{
  ...
  {
    this.OvJ = paramString;
  }
  
  /* Error */
  private static boolean h(java.io.File paramFile, String paramString)
  {
    // Byte code:
    //   0: ldc 23
    ...
    //   19: aconst_null
    //   20: astore 4
    //   22: new 37	java/io/BufferedInputStream
    //   25: dup
    //   26: new 39	java/io/FileInputStream
    //   29: dup
    //   30: aload_0
    //   31: invokespecial 42	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   34: invokespecial 45	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   37: astore_2
    //   38: new 47	java/security/DigestInputStream
    //   41: dup
    //   42: aload_2
    //   43: ldc 49
    //   45: invokestatic 55	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   48: invokespecial 58	java/security/DigestInputStream:<init>	(Ljava/io/InputStream;Ljava/security/MessageDigest;)V
    //   51: astore_3
    //   52: aload_3
    //   53: astore 4
    //   55: aload_3
    ...
    //   70: aload_3
    //   71: aload_2
    //   72: invokevirtual 62	java/security/DigestInputStream:read	([B)I
    //   75: ifgt -11 -> 64
    //   78: aload_3
    //   79: astore 4
    //   81: aload_3
    ...
    //   91: invokestatic 76	com/tencent/mm/toolkit/a/d$a:toHexString	([B)Ljava/lang/String;
    //   94: aload_1
    ...
    //   139: aload_3
    //   140: astore 5
    //   142: invokestatic 105	com/tencent/mm/toolkit/a/e:gGd	()V
    //   145: aload_3
    ...
    //   202: pop
    //   203: invokestatic 125	com/tencent/mm/toolkit/a/e:gGe	()V
    //   206: ldc 23
