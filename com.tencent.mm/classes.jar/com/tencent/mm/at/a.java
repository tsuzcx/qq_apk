...
public final class a
{
  ...
  private static boolean VF(String paramString)
  {
    ...
    //   51: astore_2
    //   52: goto -33 -> 19
    //   55: new 69	com/tencent/mm/vfs/q
    //   58: dup
    //   59: aload_0
    //   60: invokespecial 73	com/tencent/mm/vfs/q:<init>	(Ljava/lang/String;)V
    //   63: astore_0
    //   64: aload_0
    //   65: invokevirtual 77	com/tencent/mm/vfs/q:ifE	()Z
    //   68: ifeq +8 -> 76
    //   71: aload_0
    //   72: invokevirtual 80	com/tencent/mm/vfs/q:cFq	()Z
    //   75: pop
    //   76: aload_0
    //   77: invokevirtual 84	com/tencent/mm/vfs/q:ifB	()Lcom/tencent/mm/vfs/q;
    //   80: invokevirtual 87	com/tencent/mm/vfs/q:ifL	()Z
    //   83: pop
    //   84: aload_0
    //   85: invokestatic 93	com/tencent/mm/vfs/u:an	(Lcom/tencent/mm/vfs/q;)Ljava/io/OutputStream;
    //   88: astore_0
    //   89: aload_0
    //   90: ifnull +107 -> 197
    //   93: sipush 1024
  ...
  public static String bkK()
  {
    ...
    Object localObject = new q(bkJ(), "emoji/res");
  ...
  public static int bkM()
  {
    ...
    try
    {
      InputStream localInputStream = u.al(new q(bkK(), "config.conf"));
  ...
  private static int bkN()
  {
    ...
    //   15: invokevirtual 50	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   18: astore_2
    //   19: new 168	java/io/InputStreamReader
    //   22: dup
    //   23: aload_2
    //   24: invokespecial 171	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   27: astore 4
    //   29: new 166	java/io/BufferedReader
    //   32: dup
    //   33: aload 4
    ...
    //   50: astore 5
    //   52: aload_1
    //   53: invokevirtual 177	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   56: astore 8
    //   58: aload 8
    //   60: ifnull +36 -> 96
    //   63: aload_1
    ...
    //   70: aload_2
    //   71: astore 5
    //   73: new 140	java/lang/StringBuilder
    //   76: dup
    //   77: invokespecial 142	java/lang/StringBuilder:<init>	()V
    //   80: aload_3
    ...
    //   103: aload_2
    //   104: astore 5
    //   106: new 179	org/json/JSONObject
    //   109: dup
    //   110: aload_3
    //   111: invokespecial 180	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   114: ldc 182
    //   116: invokevirtual 186	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   119: istore_0
    //   120: aload_1
    //   121: astore 7
    //   123: aload 4
    ...
    //   143: iconst_1
    //   144: iload_0
    //   145: invokestatic 194	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   148: aastore
    //   149: invokestatic 198	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   152: aload_2
  ...
  public static void gq(boolean paramBoolean)
  {
    ...
    q localq = new q(bkK());
    Log.i("MicroMsg.emoji.EmojiStoreExportLogic", "copy search template file to path: %s", new Object[] { localq.ifG() });
    if (d.RAG)
    {
    ...
    for (;;)
    {
      ...
      {
        int i = bkN();
        Log.i("MicroMsg.emoji.EmojiStoreExportLogic", "need update assetVersion=%d currentVersion=%d", new Object[] { Integer.valueOf(i), Integer.valueOf(lKH) });
        if (lKH < i)
        {
          u.deleteDir(localq.getPath());
          j(localq);
      ...
      {
        Log.i("MicroMsg.emoji.EmojiStoreExportLogic", "no need update currentVersion=%d", new Object[] { Integer.valueOf(lKH) });
        u.deleteDir(localq.getPath());
        j(localq);
      }
    }
  ...
  private static void j(q paramq)
  {
    AppMethodBeat.i(104508);
    if (!paramq.ifE()) {
      paramq.ifL();
    }
    q localq = new q(paramq, ".nomedia");
    if (!localq.ifE()) {}
    try
    {
      localq.ifM();
      paramq = new q(paramq, "emoji_template.zip");
      if (VF(paramq.bOF()))
      {
        int i = u.gj(paramq.bOF(), paramq.ifA());
        if (i < 0)
        {
          Log.e("MicroMsg.emoji.EmojiStoreExportLogic", "unzip fail, ret = " + i + ", zipFilePath = " + paramq.bOF() + ", unzipPath = " + paramq.ifA());
    ...
    catch (IOException localIOException)
    {
      ...
      lKH = bkM();
      Log.i("MicroMsg.emoji.EmojiStoreExportLogic", "Unzip Path%s version=%d", new Object[] { paramq.ifA(), Integer.valueOf(lKH) });
      AppMethodBeat.o(104508);
      return;
    }
    Log.i("MicroMsg.emoji.EmojiStoreExportLogic", "copy template file from asset fail %s", new Object[] { paramq.bOF() });
    AppMethodBeat.o(104508);
  }
  
  public static void k(q paramq)
  {
    AppMethodBeat.i(104509);
    q localq1 = new q(bkK());
    u.deleteDir(localq1.getPath());
    localq1.ifL();
    q localq2 = new q(localq1, ".nomedia");
    if (!localq2.ifE()) {}
    try
    {
      localq2.ifM();
      localq1 = new q(localq1, "emoji_template.zip");
      u.on(paramq.getPath(), localq1.getPath());
      int i = Util.UnZipFolder(localq1.getPath(), localq1.ifA());
      if (i < 0)
      {
        Log.e("MicroMsg.emoji.EmojiStoreExportLogic", "unzip fail, ret = " + i + ", zipFilePath = " + localq1.bOF() + ", unzipPath = " + localq1.ifA());
    ...
    catch (IOException localIOException)
    {
      ...
      lKH = bkM();
      Log.i("MicroMsg.emoji.EmojiStoreExportLogic", "Unzip Path%s version=%d", new Object[] { localq1.ifA(), Integer.valueOf(lKH) });
      AppMethodBeat.o(104509);
    }
  }
}
