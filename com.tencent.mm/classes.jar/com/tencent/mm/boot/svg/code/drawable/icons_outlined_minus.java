...
public class icons_outlined_minus
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ((Paint)localObject).setColor(-1052689);
      ...
      ((Path)localObject).close();
      ((Path)localObject).moveTo(51.0F, 34.199982F);
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.icons_outlined_minus
