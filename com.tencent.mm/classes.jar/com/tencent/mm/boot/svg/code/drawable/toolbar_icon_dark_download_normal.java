...
public class toolbar_icon_dark_download_normal
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      localCanvas.drawPath(localPath, c.instancePaint((Paint)localObject3, paramVarArgs));
      localCanvas.restore();
      ...
      localObject3 = c.setMatrixFloatArray((float[])localObject2, 1.0F, 0.0F, 12.0F, 0.0F, 1.0F, 12.0F, 0.0F, 0.0F, 1.0F);
      ...
      localObject3 = c.setMatrixFloatArray((float[])localObject3, 1.0F, 0.0F, 0.0F, 0.0F, -1.0F, 53.63604F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject3);
      localCanvas.concat((Matrix)localObject1);
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.toolbar_icon_dark_download_normal
