...
public class appbrand_menu_send_to_desktop
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      localPaint.setColor(-7220480);
      localCanvas.save();
      localPaint = c.instancePaint(localPaint, paramVarArgs);
      localObject = c.instancePath(paramVarArgs);
      ((Path)localObject).moveTo(54.0F, 6.0F);
      ...
      ((Path)localObject).lineTo(54.0F, 66.0F);
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.appbrand_menu_send_to_desktop
