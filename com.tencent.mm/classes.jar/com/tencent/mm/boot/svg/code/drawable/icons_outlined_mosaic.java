...
public class icons_outlined_mosaic
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ((Path)localObject).moveTo(21.0F, 45.0F);
      ...
      ((Path)localObject).lineTo(27.0F, 39.0F);
      ((Path)localObject).lineTo(21.0F, 39.0F);
      ((Path)localObject).lineTo(21.0F, 33.0F);
      ((Path)localObject).close();
      ...
      ((Path)localObject).close();
      ((Path)localObject).moveTo(27.0F, 39.0F);
      ...
      ((Path)localObject).lineTo(27.0F, 27.0F);
      ((Path)localObject).close();
      ((Path)localObject).moveTo(39.0F, 39.0F);
      ...
      ((Path)localObject).close();
      ((Path)localObject).moveTo(33.0F, 21.0F);
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.icons_outlined_mosaic
