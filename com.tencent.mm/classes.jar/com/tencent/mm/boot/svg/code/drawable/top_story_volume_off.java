...
public class top_story_volume_off
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      localObject4 = c.setMatrixFloatArray((float[])localObject3, 1.0F, 0.0F, 2.0F, 0.0F, 1.0F, 4.0F, 0.0F, 0.0F, 1.0F);
      ...
      localObject4 = c.setMatrixFloatArray((float[])localObject4, 1.0F, 0.0F, 39.0F, 0.0F, 1.0F, 18.0F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject4);
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
      Paint localPaint = c.instancePaint((Paint)localObject3, paramVarArgs);
      ...
      localObject4 = c.setMatrixFloatArray((float[])localObject4, 1.0F, 0.0F, 0.0F, 0.0F, -1.0F, 18.0F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject4);
      localCanvas.concat((Matrix)localObject1);
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.top_story_volume_off
