...
public class translation_download_press
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      localObject4 = c.setMatrixFloatArray((float[])localObject3, 1.0F, 0.0F, 34.0F, 0.0F, 1.0F, 28.0F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject4);
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
      localObject3 = c.instancePaint((Paint)localObject2, paramVarArgs);
      localObject4 = c.setMatrixFloatArray((float[])localObject4, 1.0F, 0.0F, 0.0F, 0.0F, -1.0F, 45.694771F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject4);
      localCanvas.concat((Matrix)localObject1);
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.translation_download_press
