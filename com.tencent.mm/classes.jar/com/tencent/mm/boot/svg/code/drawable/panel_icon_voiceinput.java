...
public class panel_icon_voiceinput
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      localObject2 = c.setMatrixFloatArray((float[])localObject2, 1.0F, 0.0F, 30.0F, 0.0F, 1.0F, 36.0F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject2);
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
      localObject2 = c.setMatrixFloatArray((float[])localObject2, 0.8660254F, -0.5F, 48.0F, 0.5F, 0.8660254F, 0.0F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject2);
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.panel_icon_voiceinput
