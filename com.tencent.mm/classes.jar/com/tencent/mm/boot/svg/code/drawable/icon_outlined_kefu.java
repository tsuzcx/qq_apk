...
public class icon_outlined_kefu
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ((Path)localObject).moveTo(36.0F, 12.6F);
      ...
      ((Path)localObject).close();
      ((Path)localObject).moveTo(24.0F, 31.5F);
      ((Path)localObject).cubicTo(25.656855F, 31.5F, 27.0F, 32.843147F, 27.0F, 34.5F);
      ((Path)localObject).cubicTo(27.0F, 36.156853F, 25.656855F, 37.5F, 24.0F, 37.5F);
      ((Path)localObject).cubicTo(22.343145F, 37.5F, 21.0F, 36.156853F, 21.0F, 34.5F);
      ((Path)localObject).cubicTo(21.0F, 32.843147F, 22.343145F, 31.5F, 24.0F, 31.5F);
      ((Path)localObject).close();
      ((Path)localObject).moveTo(36.0F, 31.5F);
      ((Path)localObject).cubicTo(37.656853F, 31.5F, 39.0F, 32.843147F, 39.0F, 34.5F);
      ((Path)localObject).cubicTo(39.0F, 36.156853F, 37.656853F, 37.5F, 36.0F, 37.5F);
      ((Path)localObject).cubicTo(34.343147F, 37.5F, 33.0F, 36.156853F, 33.0F, 34.5F);
      ((Path)localObject).cubicTo(33.0F, 32.843147F, 34.343147F, 31.5F, 36.0F, 31.5F);
      ((Path)localObject).close();
      ((Path)localObject).moveTo(48.0F, 31.5F);
      ((Path)localObject).cubicTo(49.656853F, 31.5F, 51.0F, 32.843147F, 51.0F, 34.5F);
      ((Path)localObject).cubicTo(51.0F, 36.156853F, 49.656853F, 37.5F, 48.0F, 37.5F);
      ((Path)localObject).cubicTo(46.343147F, 37.5F, 45.0F, 36.156853F, 45.0F, 34.5F);
      ((Path)localObject).cubicTo(45.0F, 32.843147F, 46.343147F, 31.5F, 48.0F, 31.5F);
      ((Path)localObject).close();
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.icon_outlined_kefu
