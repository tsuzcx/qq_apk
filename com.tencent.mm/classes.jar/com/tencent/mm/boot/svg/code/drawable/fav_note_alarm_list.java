...
public class fav_note_alarm_list
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      localPaint = c.instancePaint((Paint)localObject2, paramVarArgs);
      localPaint.setStrokeCap(Paint.Cap.SQUARE);
      localObject3 = c.setMatrixFloatArray((float[])localObject3, -1.0F, 0.0F, 8.777304F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject3);
      localCanvas.concat((Matrix)localObject1);
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.fav_note_alarm_list
