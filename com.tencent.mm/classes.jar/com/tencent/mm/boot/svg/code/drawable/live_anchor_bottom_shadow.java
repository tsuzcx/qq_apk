...
public class live_anchor_bottom_shadow
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      localCanvas.save();
      localObject1 = c.setMatrixFloatArray((float[])localObject1, 1.0F, 0.0F, -362.0F, 0.0F, 1.0F, -115.0F, 0.0F, 0.0F, 1.0F);
      localMatrix.reset();
      localMatrix.setValues((float[])localObject1);
      localCanvas.concat(localMatrix);
      localCanvas.save();
      localObject1 = c.setMatrixFloatArray((float[])localObject1, 1.0F, 0.0F, 362.0F, 0.0F, -1.0F, 331.0F, 0.0F, 0.0F, 1.0F);
      localMatrix.reset();
      localMatrix.setValues((float[])localObject1);
      localCanvas.concat(localMatrix);
      localCanvas.save();
      localPaint1 = c.instancePaint(localPaint1, paramVarArgs);
      localObject2 = c.setMatrixFloatArray((float[])localObject1, 1.0F, 0.0F, 0.0F, 0.0F, -1.0F, 216.0F, 0.0F, 0.0F, 1.0F);
      localMatrix.reset();
      ...
      localObject2 = c.setMatrixFloatArray((float[])localObject2, 16.0F, 0.0F, 0.0F, 0.0F, 216.0F, 0.0F, 0.0F, 0.0F, 1.0F);
      localMatrix.reset();
      localMatrix.setValues((float[])localObject2);
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.live_anchor_bottom_shadow
