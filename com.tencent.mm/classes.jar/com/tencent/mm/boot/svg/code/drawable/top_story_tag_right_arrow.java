...
public class top_story_tag_right_arrow
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      localObject2 = c.setMatrixFloatArray((float[])localObject2, 1.0F, 0.0F, -80.0F, 0.0F, 1.0F, -322.0F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject2);
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
      localObject4 = c.setMatrixFloatArray((float[])localObject2, 1.0F, 0.0F, 34.0F, 0.0F, 1.0F, 318.0F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject4);
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
      localObject2 = c.instancePaint((Paint)localObject3, paramVarArgs);
      localObject3 = c.setMatrixFloatArray((float[])localObject4, -1.0F, 0.0F, 98.0F, 0.0F, -1.0F, 19.0F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.top_story_tag_right_arrow
