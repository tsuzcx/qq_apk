...
public class icons_outlined_official_accounts
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ((Path)localObject).close();
      ((Path)localObject).moveTo(33.0F, 54.0F);
      ((Path)localObject).lineTo(36.0F, 45.0F);
      ((Path)localObject).lineTo(39.0F, 54.0F);
      ((Path)localObject).lineTo(36.0F, 57.0F);
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.icons_outlined_official_accounts
