...
public class icons_filled_capslocked
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ((Path)localObject).cubicTo(17.0F, 17.552284F, 16.552284F, 18.0F, 16.0F, 18.0F);
      ((Path)localObject).lineTo(8.0F, 18.0F);
      ((Path)localObject).cubicTo(7.447715F, 18.0F, 7.0F, 17.552284F, 7.0F, 17.0F);
      ...
      ((Path)localObject).moveTo(7.5F, 19.5F);
      ((Path)localObject).lineTo(16.5F, 19.5F);
      ((Path)localObject).cubicTo(16.776142F, 19.5F, 17.0F, 19.723858F, 17.0F, 20.0F);
      ((Path)localObject).lineTo(17.0F, 21.0F);
      ((Path)localObject).cubicTo(17.0F, 21.276142F, 16.776142F, 21.5F, 16.5F, 21.5F);
      ((Path)localObject).lineTo(7.5F, 21.5F);
      ((Path)localObject).cubicTo(7.223857F, 21.5F, 7.0F, 21.276142F, 7.0F, 21.0F);
      ((Path)localObject).lineTo(7.0F, 20.0F);
      ((Path)localObject).cubicTo(7.0F, 19.723858F, 7.223857F, 19.5F, 7.5F, 19.5F);
      ((Path)localObject).close();
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.icons_filled_capslocked
