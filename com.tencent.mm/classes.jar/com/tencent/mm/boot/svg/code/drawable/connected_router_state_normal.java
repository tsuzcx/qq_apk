...
public class connected_router_state_normal
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      localCanvas.restore();
      localCanvas.save();
      arrayOfFloat = c.setMatrixFloatArray(arrayOfFloat, 1.0F, 0.0F, 58.0F, 0.0F, 1.0F, 75.0F, 0.0F, 0.0F, 1.0F);
      localMatrix.reset();
      ...
      localCanvas.restore();
      localCanvas.save();
      localObject1 = c.setMatrixFloatArray(arrayOfFloat, 1.0F, 0.0F, 0.095238F, 0.0F, 1.0F, 0.652174F, 0.0F, 0.0F, 1.0F);
      localMatrix.reset();
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.connected_router_state_normal
