...
public class websearch_icon_product
  extends c
{
  ...
  public int doCommand(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      localObject3 = c.setMatrixFloatArray((float[])localObject3, 1.0F, 0.0F, -396.0F, 0.0F, 1.0F, -671.0F, 0.0F, 0.0F, 1.0F);
      ...
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
      localObject3 = c.setMatrixFloatArray((float[])localObject3, 1.0F, 0.0F, 327.0F, 0.0F, 1.0F, 68.0F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject3);
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
      localObject3 = c.setMatrixFloatArray((float[])localObject3, 1.0F, 0.0F, 3.0F, 0.0F, 1.0F, 1.5F, 0.0F, 0.0F, 1.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject3);
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.code.drawable.websearch_icon_product
