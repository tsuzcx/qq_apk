  ...
  extends c
{
  ...
  public final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ((Path)localObject2).cubicTo(23.459999F, 7.016F, 21.764999F, 9.183F, 20.671F, 11.576F);
      ((Path)localObject2).cubicTo(19.128F, 14.973F, 18.74F, 18.853001F, 19.431F, 22.509001F);
      ((Path)localObject2).cubicTo(20.011F, 25.530001F, 21.374001F, 28.444F, 23.542999F, 30.649F);
      ((Path)localObject2).cubicTo(24.104F, 31.232F, 24.743999F, 31.729F, 25.386F, 32.219002F);
      ((Path)localObject2).cubicTo(26.474001F, 33.063999F, 27.114F, 34.432999F, 27.105F, 35.806999F);
      ((Path)localObject2).cubicTo(27.091999F, 36.905998F, 27.108F, 38.006001F, 27.096001F, 39.105999F);
      ((Path)localObject2).cubicTo(27.087999F, 39.931999F, 26.799F, 40.747002F, 26.302F, 41.404999F);
      ((Path)localObject2).cubicTo(25.540001F, 42.433998F, 24.384001F, 43.041F, 23.333F, 43.724998F);
      ((Path)localObject2).cubicTo(18.229F, 46.960999F, 13.133F, 50.210999F, 7.997F, 53.396999F);
      ((Path)localObject2).cubicTo(7.212F, 53.904999F, 6.348F, 54.314999F, 5.687F, 54.991001F);
      ((Path)localObject2).cubicTo(4.887F, 55.77F, 4.364F, 56.868F, 4.424F, 57.998001F);
      ((Path)localObject2).cubicTo(22.208F, 58.0F, 39.993F, 58.002998F, 57.777F, 57.997002F);
      ((Path)localObject2).cubicTo(57.797001F, 56.210999F, 56.486F, 54.729F, 55.007999F, 53.891998F);
      ((Path)localObject2).cubicTo(49.227001F, 50.324001F, 43.506001F, 46.662998F, 37.768002F, 43.027F);
      ((Path)localObject2).cubicTo(36.747002F, 42.387001F, 35.761002F, 41.551998F, 35.341F, 40.386002F);
      ((Path)localObject2).cubicTo(35.055F, 39.659F, 35.098999F, 38.867001F, 35.099998F, 38.102001F);
      ((Path)localObject2).cubicTo(35.098F, 37.333F, 35.104F, 36.564999F, 35.095001F, 35.796001F);
      ((Path)localObject2).cubicTo(35.094002F, 34.665001F, 35.522999F, 33.534F, 36.292F, 32.702F);
      ((Path)localObject2).cubicTo(36.728001F, 32.226002F, 37.282001F, 31.886F, 37.769001F, 31.469F);
      ((Path)localObject2).cubicTo(39.748001F, 29.809F, 41.181F, 27.561001F, 42.050999F, 25.142F);
      ((Path)localObject2).cubicTo(43.416F, 21.301001F, 43.449001F, 17.000999F, 42.147999F, 13.139F);
      ((Path)localObject2).cubicTo(41.223F, 10.411F, 39.583F, 7.874F, 37.265999F, 6.13F);
      ((Path)localObject2).cubicTo(35.610001F, 4.881F, 33.59F, 4.089F, 31.509001F, 4.012F);
      ((Path)localObject2).cubicTo(29.466999F, 3.916F, 27.42F, 4.509F, 25.701F, 5.603F);
 ...
 * Qualified Name:     com.tencent.mm.boot.svg.a.a.bda
