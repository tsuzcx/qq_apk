...
public class CoverEmojiStatusView
  ...
  implements i.a
{
  public static final CoverEmojiStatusView.a gsR;
  ...
  static
  {
    ...
    gsR = new CoverEmojiStatusView.a((byte)0);
  ...
  protected void onDetachedFromWindow()
  {
    ...
    ae.i("MicroMsg.CoverEmojiStatusView", "destroy: ".concat(String.valueOf(this)));
    e locale = e.gkR;
    e.cv((View)this);
    this.gsP = null;
  ...
  @l(gjZ={1, 1, 16}, gka={""}, gkb={"Lcom/tencent/mm/emoji/view/CoverEmojiStatusView$StatusListener;", "", "onStatus", "", "status", "", "plugin-emojisdk_release"})
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      CoverEmojiStatusView localCoverEmojiStatusView = this.gsS;
      Object localObject = localCoverEmojiStatusView.getEmojiInfo();
      if (localObject != null)
      {
        ae.i("MicroMsg.CoverEmojiStatusView", "reload: " + ((EmojiInfo)localObject).Lj());
        if ((localCoverEmojiStatusView.gsQ) && ((((EmojiInfo)localObject).getGroup() == EmojiGroupInfo.OzS) || (((EmojiInfo)localObject).getGroup() == EmojiInfo.OzZ) || (((EmojiInfo)localObject).getGroup() == EmojiInfo.OzY)))
        {
      ...
      ae.i("MicroMsg.CoverEmojiStatusView", "reload: emojiInfo is null");
      localObject = e.gkR;
