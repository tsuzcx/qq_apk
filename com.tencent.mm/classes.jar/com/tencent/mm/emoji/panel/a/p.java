  ...
  extends GridLayoutManager.b
{
  ...
  public p(RecyclerView.a<?> parama, GridLayoutManager paramGridLayoutManager)
  {
    ...
    this.fQu = parama;
    this.fQe = paramGridLayoutManager;
  ...
  public final int bW(int paramInt)
  {
    ...
    switch (this.fQu.getItemViewType(paramInt))
    {
    case 2: 
    case 4: 
    case 5: 
    default: 
      paramInt = this.fQe.jB();
