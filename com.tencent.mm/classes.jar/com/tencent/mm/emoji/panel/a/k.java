  ...
  extends q<h>
{
  ...
  public void a(y paramy)
  {
    ...
    if (paramy != null)
    {
      ...
      com.tencent.mm.emoji.loader.e.a(paramy.fPB, this.ig);
      if (paramy.fRp == 2)
      {
        this.fUk.setVisibility(0);
        localObject = g.ad(d.class);
        d.g.b.k.g(localObject, "MMKernel.plugin(IPluginEmoji::class.java)");
        paramy = ((d)localObject).getProvider().XP(paramy.fPB.JC());
        this.fUk.setText((CharSequence)paramy);
        AppMethodBeat.o(105669);
        return;
      }
      if (d.g.b.k.g(paramy.fPB.getName(), "dice"))
      {
        paramy = this.ig;
      ...
      for (;;)
      {
        ...
        AppMethodBeat.o(105669);
        return;
        if (d.g.b.k.g(paramy.fPB.getName(), "jsb"))
        {
          paramy = this.ig;
          localObject = this.asD;
          d.g.b.k.g(localObject, "itemView");
