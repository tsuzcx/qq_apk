...
@l(fvt={1, 1, 16}, fvu={""}, fvv={"Lcom/tencent/mm/emoji/panel/layout/SmileyLayoutManager;", "Landroid/support/v7/widget/GridLayoutManager;", "context", "Landroid/content/Context;", "spanCount", "", "(Landroid/content/Context;I)V", "hideRect", "Landroid/graphics/Rect;", "onLayoutChildren", "", "recycler", "Landroid/support/v7/widget/RecyclerView$Recycler;", "Landroid/support/v7/widget/RecyclerView;", "state", "Landroid/support/v7/widget/RecyclerView$State;", "scrollHorizontallyBy", "dx", "scrollVerticallyBy", "dy", "updateChildren", "updateHideArea", "rect", "plugin-emojisdk_release"})
    ...
    while (i < j)
    {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          int m = bI(localView);
          int k = bJ(localView);
          if ((m > this.fPA.left) && (k > this.fPA.top)) {
            m = bH(localView);
          }
          for (float f = 1.0F - (k - this.fPA.top) / ((k - m) * 0.4F);; f = 1.0F)
          {
