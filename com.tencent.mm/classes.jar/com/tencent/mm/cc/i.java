...
public final class i
{
  ...
  {
    this.NDG = paramSparseIntArray;
    this.NDH = paramArrayOfByte;
  }
  ...
  public final String getString(int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        paramInt = this.NDG.indexOfKey(paramInt);
        if (paramInt < 0)
        {
          AppMethodBeat.o(141265);
          return null;
        }
        i = this.NDG.valueAt(paramInt);
        if (paramInt >= this.NDG.size() - 1) {
          continue;
        }
        paramInt = this.NDG.valueAt(paramInt + 1) - i;
        str = new String(this.NDH, i, paramInt, "UTF-8");
      }
 ...
 * Qualified Name:     com.tencent.mm.cc.i
