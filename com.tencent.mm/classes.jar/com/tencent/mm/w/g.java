...
@l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/mm/executor/OpUpdateExecutor;", "Lcom/tencent/mm/executor/IOpExecutor;", "()V", "execute", "", "timer", "Lcom/tencent/mm/engine/FunctionMsgTimer;", "dispatcher", "Lcom/tencent/mm/api/IFunctionMsgDispatcher;", "storage", "Lcom/tencent/mm/storage/FunctionMsgStorage;", "newFunctionMsgItem", "Lcom/tencent/mm/api/FunctionMsgItem;", "oldFunctionMsgItem", "newXmlCreateTime", "", "onTaskExpired", "task", "Lcom/tencent/mm/engine/FunctionMsgTask;", "Companion", "plugin-functionmsg_release"})
public final class g
  implements b
{
  public static final g.a gqY;
  ...
  public final void a(e parame, q paramq, bm parambm, h paramh1, h paramh2, long paramLong)
  {
    ...
    if (paramh2.getVersion() >= paramh1.getVersion()) {
      ad.e("FunctionMsg.OpUpdateExecutor", "[OpUpdateExecutor], id:%s old:new [%s:%s]", new Object[] { paramh2.KS(), Long.valueOf(paramh2.getVersion()), Long.valueOf(paramh1.getVersion()) });
    }
    AppMethodBeat.o(114147);
  }
  ...
  public final void a(e parame, final q paramq, final d paramd)
  {
    ...
    {
      ad.i("FunctionMsg.OpUpdateExecutor", "[onTaskExpired] id" + localh.KS() + " actionTime:" + localh.KY());
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"com/tencent/mm/executor/OpUpdateExecutor$onTaskExpired$1", "Lcom/tencent/mm/engine/FunctionMsgFetcher$IFunctionMsgFetcherCallback;", "onFailFetch", "", "item", "Lcom/tencent/mm/api/FunctionMsgItem;", "onSuccessFetch", "plugin-functionmsg_release"})
    ...
    implements b.a
  {
    ...
    public final void a(h paramh)
    {
      ...
      {
        this.gqR.a(0, paramh, paramd.gqL);
        AppMethodBeat.o(114146);
        return;
      }
      ad.i("FunctionMsg.OpUpdateExecutor", "[onTaskExpired] to show! id:" + localh.KS());
