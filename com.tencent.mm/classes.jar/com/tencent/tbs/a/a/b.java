...
{
  private b IwY;
  private volatile a IwZ;
  private com.tencent.tbs.a.a.c.b Ixa;
  private com.tencent.tbs.a.a.b.a Ixb;
  private com.tencent.tbs.a.a.a.a Ixc;
  private boolean a;
  boolean b;
  private Context h;
  ...
  public b(Context paramContext, com.tencent.tbs.a.a.c.b paramb, com.tencent.tbs.a.a.b.a parama, com.tencent.tbs.a.a.a.a parama1)
  {
    ...
    this.IwY = new b((byte)0);
    this.IwZ = new a((byte)0);
    this.a = true;
    this.b = true;
    this.Ixa = paramb;
    this.Ixb = parama;
  ...
  private boolean c(com.tencent.tbs.a.b paramb)
  {
    ...
    try
    {
      localObject = this.IwY.d;
      paramb = this.Ixa.d(paramb);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if (i < j)
        {
          ...
          if (this.Ixb.a(localFile)) {
            localFile.delete();
          }
        }
        else
        {
          boolean bool = this.IwY.a(paramb);
          if (!bool)
          {
            AppMethodBeat.o(174286);
            return false;
          }
          localObject = this.IwY.b;
          if ((localObject != null) && (this.Ixc.a((File)localObject)))
          {
            this.IwY.d();
  ...
  final void b(com.tencent.tbs.a.b paramb)
  {
    ...
    this.IwY.b(com.tencent.tbs.a.a.d(paramb));
    AppMethodBeat.o(174285);
  }
  ...
  final class a
    implements Runnable
  {
    BlockingQueue<com.tencent.tbs.a.b> Ixd;
    volatile boolean c;
    
    private a()
    {
      AppMethodBeat.i(53062);
      this.Ixd = new LinkedBlockingQueue();
    ...
    public final void run()
    {
      ...
      //   5: aload_0
      //   6: getfield 35	com/tencent/tbs/a/a/b$a:Ixd	Ljava/util/concurrent/BlockingQueue;
      ...
      //   19: ifnull +30 -> 49
      //   22: aload_0
      //   23: getfield 20	com/tencent/tbs/a/a/b$a:Ixe	Lcom/tencent/tbs/a/a/b;
      //   26: aload_1
  ...
  final class b
  {
    ...
    final boolean a(String paramString)
    {
      ...
      catch (IOException paramString)
      {
        try
        {
          this.Ixf = new BufferedOutputStream(new FileOutputStream(this.b, true));
    ...
    final void b(String paramString)
    {
      ...
      //   5: aload_0
      //   6: getfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
      //   9: ifnull +148 -> 157
      //   12: aload_0
      //   13: getfield 18	com/tencent/tbs/a/a/b$b:Ixe	Lcom/tencent/tbs/a/a/b;
      ...
      //   29: ldc 98
      //   31: aload_2
      //   32: invokestatic 104	com/tencent/tbs/a/a/a:lT	(Ljava/lang/String;Ljava/lang/String;)[B
      //   35: astore_3
      //   36: aload_3
      //   37: ifnull +22 -> 59
      //   40: aload_2
      ...
      //   48: ifnull +11 -> 59
      //   51: aload_0
      //   52: getfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
      //   55: aload_1
      //   56: invokevirtual 114	java/io/OutputStream:write	([B)V
      //   59: aload_0
      //   60: getfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
      //   63: ifnull +94 -> 157
      //   66: aload_0
      //   67: getfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
      ...
      //   83: ifne -24 -> 59
      //   86: aload_0
      //   87: getfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
      //   90: aload_1
      ...
      //   100: astore_1
      //   101: aload_0
      //   102: getfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
      //   105: ifnull +52 -> 157
      //   108: aload_0
      //   109: getfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
      ...
      //   135: astore_1
      //   136: aload_0
      //   137: getfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
      //   140: ifnull +10 -> 150
      //   143: aload_0
      //   144: getfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
    ...
    final boolean d()
    {
      ...
      //   9: ifnull +20 -> 29
      //   12: aload_0
      //   13: getfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
      //   16: invokevirtual 131	java/io/OutputStream:close	()V
      //   19: aload_0
      //   20: aconst_null
      //   21: putfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
      //   24: aload_0
      //   25: aconst_null
      ...
      //   37: aload_0
      //   38: aconst_null
      //   39: putfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
      //   42: aload_0
      //   43: aconst_null
      ...
      //   55: aload_0
      //   56: aconst_null
      //   57: putfield 76	com/tencent/tbs/a/a/b$b:Ixf	Ljava/io/OutputStream;
      //   60: aload_0
      //   61: aconst_null
