...
{
  private static long WT(long paramLong)
  {
  ...
  public static long a(long paramLong, TimeUnit paramTimeUnit)
  {
    ...
    paramLong = WT(paramTimeUnit.toNanos(l));
    AppMethodBeat.o(183191);
    return paramLong;
  }
  ...
  public static <E> k<E> a(Callable<E> paramCallable, long paramLong, String paramString)
  {
    ...
    {
      paramCallable = new k(paramCallable, a(paramLong, TimeUnit.MILLISECONDS), eI(paramCallable));
      AppMethodBeat.o(183190);
      return paramCallable;
    }
    paramCallable = new e(paramCallable, a(paramLong, TimeUnit.MILLISECONDS), paramString, eI(paramCallable));
    AppMethodBeat.o(183190);
    return paramCallable;
  }
  ...
  public static k<?> e(Runnable paramRunnable, long paramLong, String paramString)
  {
    ...
    if ((paramString == null) || (paramString.isEmpty()))
    {
      paramRunnable = new k(paramRunnable, a(paramLong, TimeUnit.MILLISECONDS), eI(paramRunnable));
      AppMethodBeat.o(183189);
      return paramRunnable;
    }
    paramRunnable = new e(paramRunnable, a(paramLong, TimeUnit.MILLISECONDS), paramString, eI(paramRunnable));
    AppMethodBeat.o(183189);
    return paramRunnable;
  }
  
  public static boolean eI(Object paramObject)
  {
