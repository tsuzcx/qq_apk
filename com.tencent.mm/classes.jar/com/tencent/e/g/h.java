...
public final class h
{
  ...
  public static b b(com.tencent.e.a parama)
  {
    ...
    int i = Math.max(1, parama.MpT / 2);
    int j = Math.max(1, i / 3);
    switch (1.MrJ[parama.MpX.ordinal()])
    {
    default: 
      parama = new d();
      AppMethodBeat.o(183339);
  ...
  public static enum a
  {
    static
    {
      ...
      MrK = new a("FS_POLICY", 0);
      MrL = new a("LINEAR_POLICY", 1);
      MrM = new a("CONST_POLICY", 2);
      MrN = new a("THROW_POLICY", 3);
      MrO = new a("BLOCK_INVOKER_POLICY", 4);
      MrP = new a("DEFAULT", 5);
      MrQ = new a[] { MrK, MrL, MrM, MrN, MrO, MrP };
