...
public final class e
{
  ...
  public e(com.tencent.e.a parama)
  {
    ...
    this.Zxb = new b(parama.ZuV, parama.ZuU);
    this.Zxc = new c(parama.ZuW);
    this.Zxd = new f();
  ...
  public static <V> com.tencent.e.i.d<V> a(k<V> paramk, boolean paramBoolean, d paramd)
  {
    ...
    if ((paramk instanceof com.tencent.e.j.e))
    {
      ...
      com.tencent.e.j.d locald = paramd.serial.Zxu;
      if (paramBoolean)
      {
        l = -2147483648L;
        locald.a(l, paramd);
  ...
  private d k(k<?> paramk)
  {
    ...
    {
      if (com.tencent.e.c.b.Zwh.fs(paramk.getKey()))
      {
        paramk = this.Zxb;
  ...
  public final Map<String, List<String>> ipE()
  {
    AppMethodBeat.i(183366);
    localLinkedHashMap = new LinkedHashMap();
    try
    {
      Object localObject1 = this.Zxd.Zxe;
      Object localObject2 = new LinkedList();
      ((f.a)localObject1).die.dump(new f.a.2((f.a)localObject1, (List)localObject2), "");
      localLinkedHashMap.put("UIPool", localObject2);
      localLinkedHashMap.put("HotPool", this.Zxc.ipY());
      localLinkedHashMap.put("ColdPool", this.Zxb.ipY());
      localObject1 = com.tencent.e.j.a.iqi().iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (com.tencent.e.j.a)((Iterator)localObject1).next();
        List localList = ((com.tencent.e.j.a)localObject2).Zxu.iqj();
        if (localList.size() > 0) {
    ...
    {
      com.tencent.e.d.Zvw.e("PoolAdapter", "[dumpWaitingTask] e=%s", new Object[] { localNullPointerException });
      AppMethodBeat.o(183366);
    }
  }
  
  public final <V> com.tencent.e.i.d<V> j(k<V> paramk)
  {
    AppMethodBeat.i(244373);
    paramk = a(paramk, false, this.Zxc);
