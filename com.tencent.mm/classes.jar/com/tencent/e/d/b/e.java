...
public final class e
{
  ...
  private static a aqA(int paramInt)
  {
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        {
          String str1;
          Object localObject2 = new String(b.aVb(String.format(Locale.ENGLISH, "/proc/%d/attr/current", new Object[] { Integer.valueOf(paramInt) }))).trim();
    ...
    for (;;)
    {
      try
      {
        localObject2 = b.hv(String.format(Locale.ENGLISH, "/proc/%d/status", new Object[] { Integer.valueOf(paramInt) }), 150);
  ...
  private static String aqz(int paramInt)
  {
    AppMethodBeat.i(138365);
    String str = "";
    try
    {
      Object localObject = b.hv(String.format(Locale.ENGLISH, "/proc/%d/cmdline", new Object[] { Integer.valueOf(paramInt) }), 100);
      if (localObject != null) {
      ...
      {
        byte[] arrayOfByte = b.hv(String.format(Locale.ENGLISH, "/proc/%d/status", new Object[] { Integer.valueOf(paramInt) }), 150);
        localObject = str;
        if (arrayOfByte != null)
        {
      ...
      if (i < j)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject)) {
          try
          {
            ...
            localObject = aqA(Integer.parseInt((String)localObject));
            if (localObject == null) {
              break label125;
            }
