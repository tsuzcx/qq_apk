...
public final class f
{
  public static Method a(String paramString1, String paramString2, Class<?>... paramVarArgs)
  {
    ...
    try
    {
      paramString1 = e(bqc(paramString1), paramString2, paramVarArgs);
  ...
  private static Class<?> bqc(String paramString)
  {
  ...
  public static Object c(Class<?> paramClass, String paramString, Object paramObject)
  {
    ...
    try
    {
      paramClass = k(paramClass, paramString);
      if (paramClass == null)
      {
  ...
  public static Object nH(String paramString1, String paramString2)
  {
    AppMethodBeat.i(138370);
    try
    {
      paramString1 = c(bqc(paramString1), paramString2, null);
