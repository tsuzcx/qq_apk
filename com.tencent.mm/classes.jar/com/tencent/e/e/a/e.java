...
{
  private static final j<e> AEL;
  private g RMB;
  private final List<k> RMC;
  private d RMD;
  private b RME;
  private com.tencent.e.e.a.a.d RMF;
  ...
  private e()
  {
    ...
    this.RMG = new com.tencent.e.e.a.a.c()
    {
      public final void boF()
      {
        ...
        synchronized (e.this)
        {
          ...
          if (e.g(e.this).Ox(e.a(e.this).Gfd))
          {
            long l = e.g(e.this).RMY.hkI();
            e.a locala = e.d(e.this);
            int i = (int)(e.a(e.this).Gfd / f.RMR);
            locala.mCount = 1;
            locala.mMaxCount = i;
            locala.RMO = l;
            l = l + f.RMR - System.currentTimeMillis();
            if (l > 0L) {
  ...
  public final boolean Qt()
  {
    ...
    for (;;)
    {
      ...
      {
        this.RMB.hkG();
        if ((int)(this.RMB.RMY.hkJ() / f.RMR) < 3) {
          AppMethodBeat.o(138388);
        }
      }
      else
      ...
      SparseArray localSparseArray1 = this.RMB.hkH();
      ...
      else
      {
        ...
        {
          localArrayList = new ArrayList(this.RMC);
          if (localArrayList.size() < 3) {
            AppMethodBeat.o(138388);
          }
        }
        final int i = this.RMD.RMA;
        final int j = this.RMD.action;
        final int k = this.RMD.requestType;
        this.mHandler.post(new com.tencent.e.e.a.a.c()
        {
          /* Error */
          public final void boF()
          {
            ...
            //   5: aload_0
            //   6: getfield 23	com/tencent/e/e/a/e$3:RMI	Lcom/tencent/e/e/a/e;
            //   9: astore_3
            //   10: aload_3
            //   11: monitorenter
            //   12: aload_0
            //   13: getfield 25	com/tencent/e/e/a/e$3:RMJ	I
            //   16: aload_0
            //   17: getfield 27	com/tencent/e/e/a/e$3:dos	I
            //   20: aload_0
            //   21: getfield 23	com/tencent/e/e/a/e$3:RMI	Lcom/tencent/e/e/a/e;
            ...
            //   30: aload_0
            //   31: getfield 29	com/tencent/e/e/a/e$3:Jnp	I
            //   34: aload_0
            //   35: getfield 31	com/tencent/e/e/a/e$3:RMK	Landroid/util/SparseArray;
            //   38: aload_0
            //   39: getfield 33	com/tencent/e/e/a/e$3:RML	Ljava/util/List;
            ...
            //   47: aload_3
            //   48: monitorexit
            //   49: invokestatic 70	com/tencent/e/e/a/a/h:hkK	()Lcom/tencent/e/e/a/a/h;
            //   52: astore 5
            //   54: aload_0
            //   55: getfield 25	com/tencent/e/e/a/e$3:RMJ	I
            //   58: istore_1
            //   59: aload_0
            //   60: getfield 27	com/tencent/e/e/a/e$3:dos	I
            //   63: istore_2
            //   64: aload 4
            //   66: invokevirtual 76	com/tencent/e/e/a/b/a:toByteArray	()[B
            //   69: invokestatic 82	com/tencent/e/f/b:compress	([B)[B
            //   72: invokestatic 87	com/tencent/e/f/c:hkP	()[B
            //   75: invokestatic 91	com/tencent/e/f/c:n	([B[B)[B
            //   78: astore 6
            //   80: aload 6
            //   82: ifnull +89 -> 171
            //   85: aload 5
            ...
            //   146: iload_1
            //   147: iload_2
            //   148: invokevirtual 137	com/tencent/e/e/a/a/h:ms	(II)Ljava/lang/String;
            //   151: astore_3
            //   152: aload_3
            ...
            //   170: pop
            //   171: aload_0
            //   172: getfield 23	com/tencent/e/e/a/e$3:RMI	Lcom/tencent/e/e/a/e;
            //   175: invokestatic 147	com/tencent/e/e/a/e:h	(Lcom/tencent/e/e/a/e;)Lcom/tencent/e/e/a/b;
            //   178: ifnull +11 -> 189
            //   181: aload_0
            //   182: getfield 23	com/tencent/e/e/a/e$3:RMI	Lcom/tencent/e/e/a/e;
            ...
            //   234: iload_1
            //   235: iload_2
            //   236: invokestatic 168	com/tencent/e/e/a/a/h:mt	(II)Ljava/lang/String;
        ...
        public final void boF()
        {
          ...
          if (((Map)localObject1).size() != 0)
          {
            ...
            if (localObject2 != null) {
              localHashMap.put(((h.a)localObject2).RNd, ((h.a)localObject2).RNe);
            }
            ...
            if (localObject1 != null) {
              localHashMap.put(((h.a)localObject1).RNd, ((h.a)localObject1).RNe);
            }
          }
          ...
          for (;;)
          {
            ...
            if (((Iterator)localObject1).hasNext())
            {
              ...
              ((com.tencent.e.e.a.b.a)localObject2).RNm = System.currentTimeMillis();
              ((com.tencent.e.e.a.b.a)localObject2).dUb = paramString;
              if ((parame instanceof a)) {
                bool = e.a((a)parame, (com.tencent.e.e.a.b.a)localObject2);
              }
            }
            for (;;)
            {
              ...
              {
                bool = e.a((c)parame, (com.tencent.e.e.a.b.a)localObject2);
                continue;
                AppMethodBeat.o(138381);
              }
              else
  ...
  public final boolean a(d paramd)
  {
    ...
    //   9: aload_1
    //   10: getfield 247	com/tencent/e/e/a/d:context	Landroid/content/Context;
    //   13: astore_3
    //   14: aload_3
    //   15: ifnonnull +14 -> 29
    //   18: iconst_0
    ...
    //   27: iload_2
    //   28: ireturn
    //   29: invokestatic 231	com/tencent/e/e/a/a/h:hkK	()Lcom/tencent/e/e/a/a/h;
    //   32: astore 4
    //   34: aload 4
    //   36: getfield 234	com/tencent/e/e/a/a/h:mInit	Z
    //   39: ifne +9 -> 48
    //   42: aload 4
    //   44: aload_3
    //   45: invokevirtual 238	com/tencent/e/e/a/a/h:init	(Landroid/content/Context;)V
    //   48: aload_0
    //   49: getfield 59	com/tencent/e/e/a/e:gc	Z
    //   52: ifeq +8 -> 60
    //   55: aload_0
    //   56: invokevirtual 249	com/tencent/e/e/a/e:Qt	()Z
    //   59: pop
    //   60: aload_0
    //   61: aload_1
    //   62: putfield 88	com/tencent/e/e/a/e:RMD	Lcom/tencent/e/e/a/d;
    //   65: aload_0
    //   66: iconst_1
    //   67: putfield 59	com/tencent/e/e/a/e:gc	Z
    //   70: aload_0
    //   71: getfield 150	com/tencent/e/e/a/e:RMB	Lcom/tencent/e/e/a/a/g;
    //   74: ifnonnull +14 -> 88
    //   77: aload_0
    //   78: new 172	com/tencent/e/e/a/a/g
    //   81: dup
    //   82: invokespecial 250	com/tencent/e/e/a/a/g:<init>	()V
    //   85: putfield 150	com/tencent/e/e/a/e:RMB	Lcom/tencent/e/e/a/a/g;
    //   88: aload_0
    //   89: getfield 150	com/tencent/e/e/a/e:RMB	Lcom/tencent/e/e/a/a/g;
    //   92: ifnull +27 -> 119
    //   95: aload_0
    //   96: getfield 150	com/tencent/e/e/a/e:RMB	Lcom/tencent/e/e/a/a/g;
    //   99: astore 4
    //   101: aload 4
    //   103: getfield 254	com/tencent/e/e/a/a/g:RMW	Landroid/util/SparseArray;
    //   106: astore_3
    //   107: aload_3
    //   108: monitorenter
    //   109: aload 4
    //   111: getfield 254	com/tencent/e/e/a/a/g:RMW	Landroid/util/SparseArray;
    //   114: invokevirtual 257	android/util/SparseArray:clear	()V
    //   117: aload_3
    //   118: monitorexit
    //   119: aload_0
    //   120: getfield 64	com/tencent/e/e/a/e:RMC	Ljava/util/List;
    //   123: astore_3
    //   124: aload_3
    //   125: monitorenter
    //   126: aload_0
    //   127: getfield 64	com/tencent/e/e/a/e:RMC	Ljava/util/List;
    ...
    //   141: aload_0
    //   142: getfield 69	com/tencent/e/e/a/e:RMG	Ljava/lang/Runnable;
    //   145: aload_1
    //   146: getfield 261	com/tencent/e/e/a/d:delayTime	J
    ...
    extends com.tencent.e.e.a.a.c
  {
    ...
    public final void boF()
    {
      ...
      //   12: astore 7
      //   14: aload_0
      //   15: getfield 18	com/tencent/e/e/a/e$a:RMI	Lcom/tencent/e/e/a/e;
      //   18: astore 8
      //   20: aload 8
      //   22: monitorenter
      //   23: aload_0
      //   24: getfield 18	com/tencent/e/e/a/e$a:RMI	Lcom/tencent/e/e/a/e;
      ...
      //   92: aload 7
      //   94: iload_1
      //   95: putfield 99	com/tencent/e/e/a/a/k:RNi	I
      //   98: new 101	java/io/File
      //   101: dup
      //   102: ldc 103
      //   104: invokespecial 106	java/io/File:<init>	(Ljava/lang/String;)V
      //   107: invokestatic 112	com/tencent/e/f/f:Z	(Ljava/io/File;)Ljava/lang/String;
      //   110: astore 10
      //   112: aload 10
      ...
      //   130: aload 7
      //   132: iconst_1
      //   133: putfield 127	com/tencent/e/e/a/a/k:RNk	I
      //   136: aload 9
      //   138: aconst_null
      ...
      //   184: aload 7
      //   186: iconst_1
      //   187: putfield 147	com/tencent/e/e/a/a/k:RNl	I
      //   190: aload 8
      //   192: monitorexit
      //   193: aload_0
      //   194: getfield 18	com/tencent/e/e/a/e$a:RMI	Lcom/tencent/e/e/a/e;
      //   197: invokestatic 151	com/tencent/e/e/a/e:b	(Lcom/tencent/e/e/a/e;)Ljava/util/List;
      //   200: astore 8
      //   202: aload 8
      //   204: monitorenter
      //   205: aload_0
      //   206: getfield 18	com/tencent/e/e/a/e$a:RMI	Lcom/tencent/e/e/a/e;
      ...
      //   234: aload_0
      //   235: getfield 18	com/tencent/e/e/a/e$a:RMI	Lcom/tencent/e/e/a/e;
      //   238: astore 7
      //   240: aload 7
      //   242: monitorenter
      //   243: aload_0
      //   244: getfield 18	com/tencent/e/e/a/e$a:RMI	Lcom/tencent/e/e/a/e;
      ...
      //   399: aload 7
      //   401: iload_1
      //   402: putfield 99	com/tencent/e/e/a/a/k:RNi	I
      //   405: aload 7
      //   407: getfield 99	com/tencent/e/e/a/a/k:RNi	I
      //   410: istore_1
      //   411: goto -319 -> 92
      //   414: aload 9
      //   416: ldc 196
      ...
      //   441: aload 7
      //   443: iload_1
      //   444: putfield 99	com/tencent/e/e/a/a/k:RNi	I
      //   447: goto -349 -> 98
      //   450: astore 10
      //   452: goto -354 -> 98
      //   455: iconst_2
      ...
      //   470: aload 7
      //   472: iconst_2
      //   473: putfield 127	com/tencent/e/e/a/a/k:RNk	I
      //   476: goto -340 -> 136
      //   479: astore 7
      //   481: aload 8
      //   483: monitorexit
      ...
      //   502: aload 7
      //   504: iconst_3
      //   505: putfield 127	com/tencent/e/e/a/a/k:RNk	I
      //   508: goto -372 -> 136
      //   511: aload 9
      //   513: ldc 208
      //   515: iconst_m1
      ...
      //   525: aload 7
      //   527: iconst_3
      //   528: putfield 147	com/tencent/e/e/a/a/k:RNl	I
      //   531: goto -341 -> 190
      //   534: iload_1
      //   535: iconst_1
      ...
      //   539: aload 7
      //   541: iconst_2
      //   542: putfield 147	com/tencent/e/e/a/a/k:RNl	I
      //   545: goto -355 -> 190
      //   548: aload 7
      //   550: iconst_0
      //   551: putfield 147	com/tencent/e/e/a/a/k:RNl	I
      //   554: goto -364 -> 190
      //   557: astore 7
      //   559: aload 8
      //   561: monitorexit
      ...
      //   569: athrow
      //   570: aload_0
      //   571: getfield 18	com/tencent/e/e/a/e$a:RMI	Lcom/tencent/e/e/a/e;
      //   574: invokevirtual 211	com/tencent/e/e/a/e:Qt	()Z
      //   577: pop
      //   578: aload 7
      //   580: monitorexit
      //   581: ldc 35
      ...
      //   610: aload_0
      //   611: getfield 27	com/tencent/e/e/a/e$a:RMO	J
      //   614: getstatic 216	com/tencent/e/e/a/a/f:RMR	J
      //   617: aload_0
      ...
      //   634: ifle +29 -> 663
      //   637: aload_0
      //   638: getfield 18	com/tencent/e/e/a/e$a:RMI	Lcom/tencent/e/e/a/e;
      //   641: invokestatic 226	com/tencent/e/e/a/e:e	(Lcom/tencent/e/e/a/e;)Lcom/tencent/mm/sdk/platformtools/MMHandler;
      //   644: aload_0
      //   645: getfield 18	com/tencent/e/e/a/e$a:RMI	Lcom/tencent/e/e/a/e;
      ...
      //   662: return
      //   663: aload_0
      //   664: getfield 18	com/tencent/e/e/a/e$a:RMI	Lcom/tencent/e/e/a/e;
      //   667: invokestatic 226	com/tencent/e/e/a/e:e	(Lcom/tencent/e/e/a/e;)Lcom/tencent/mm/sdk/platformtools/MMHandler;
      //   670: aload_0
      //   671: getfield 18	com/tencent/e/e/a/e$a:RMI	Lcom/tencent/e/e/a/e;
