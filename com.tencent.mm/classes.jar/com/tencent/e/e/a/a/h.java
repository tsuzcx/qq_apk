...
public final class h
{
  ...
  public static a i(Map<String, a> paramMap, int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((locala != null) && (locala.requestType == paramInt))
      {
        ...
        if (localObject == null) {
          ...
          localObject.RNn.addAll(locala.RNn);
        }
      }
    }
    if (localObject != null)
    {
      ...
      paramMap.RNd = localObject;
      paramMap.RNe = localArrayList;
      AppMethodBeat.o(138407);
      return paramMap;
    }
    AppMethodBeat.o(138407);
  ...
  public static String mt(int paramInt1, int paramInt2)
  {
  ...
  public final Map<String, a> hkL()
  {
    ...
    if (i < j)
    {
      ...
      try
      {
        localObject = c.o(f.aa(new File(localFile.getAbsolutePath())), c.hkP());
        if (localObject == null)
        {
          localObject = null;
          label101:
      ...
      for (;;)
      {
        i += 1;
        break;
        byte[] arrayOfByte = b.cV(localThrowable);
        if (arrayOfByte == null)
        {
          locala = null;
          break label101;
  ...
  public final String ms(int paramInt1, int paramInt2)
  {
    AppMethodBeat.i(138405);
    String str = mt(paramInt1, paramInt2);
