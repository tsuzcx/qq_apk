  ...
  implements a
{
  ...
  private int a(Context paramContext, final AtomicReference<IBinder> paramAtomicReference, final AtomicReference<ServiceConnection> paramAtomicReference1)
  {
    ...
    //   9: aload_1
    //   10: aload_0
    //   11: invokevirtual 25	com/tencent/e/e/b/a/a/e:getIntent	()Landroid/content/Intent;
    ...
    //   20: aload_3
    //   21: aload 4
    //   23: invokespecial 28	com/tencent/e/e/b/a/a/e$1:<init>	(Lcom/tencent/e/e/b/a/a/e;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;)V
    //   26: iconst_1
  ...
  private int a(final Context paramContext, final AtomicReference<IBinder> paramAtomicReference, final AtomicReference<ServiceConnection> paramAtomicReference1, final AtomicReference<String> paramAtomicReference2)
  {
    ...
    //   20: astore 6
    //   22: getstatic 64	com/tencent/f/h:RTc	Lcom/tencent/f/i;
    ...
    //   36: aload_3
    //   37: aload 5
    //   39: invokespecial 67	com/tencent/e/e/b/a/a/e$2:<init>	(Lcom/tencent/e/e/b/a/a/e;Landroid/content/Context;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;)V
  ...
  private c kX(Context paramContext)
  {
    int j = -1;
  ...
  public final c kV(Context paramContext)
  {
    if ((this.RNM == null) || (this.RNM.errorCode != 0)) {
      this.RNM = kX(paramContext);
    }
    return this.RNM;
  }
}
