...
{
  private static final d Zwi;
  private static final ConcurrentHashMap<Looper, WeakReference<Handler>> Zwj;
  ...
  public static Handler a(String paramString, Handler.Callback paramCallback)
  {
    ...
    paramString = new a(paramString, Zwi.looper, paramCallback);
    Zwj.put(Zwi.looper, new WeakReference(paramString));
  ...
  public static void release()
  {
    ...
    Iterator localIterator = Zwj.values().iterator();
