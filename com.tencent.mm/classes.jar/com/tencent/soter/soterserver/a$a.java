  ...
  implements a
{
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 1: 
      ...
      paramInt1 = aek(paramParcel1.readInt());
      paramParcel2.writeNoException();
      paramParcel2.writeInt(paramInt1);
      return true;
    case 2: 
      paramParcel1.enforceInterface("com.tencent.soter.soterserver.ISoterService");
      paramParcel1 = ael(paramParcel1.readInt());
      paramParcel2.writeNoException();
    ...
    case 4: 
      paramParcel1.enforceInterface("com.tencent.soter.soterserver.ISoterService");
      paramInt1 = cP(paramParcel1.readInt(), paramParcel1.readString());
      paramParcel2.writeNoException();
      paramParcel2.writeInt(paramInt1);
      return true;
    case 5: 
      paramParcel1.enforceInterface("com.tencent.soter.soterserver.ISoterService");
      paramInt1 = cQ(paramParcel1.readInt(), paramParcel1.readString());
      paramParcel2.writeNoException();
      paramParcel2.writeInt(paramInt1);
      return true;
    case 6: 
      paramParcel1.enforceInterface("com.tencent.soter.soterserver.ISoterService");
      paramParcel1 = cR(paramParcel1.readInt(), paramParcel1.readString());
      paramParcel2.writeNoException();
      if (paramParcel1 != null)
      {
        paramParcel2.writeInt(1);
    ...
    case 7: 
      paramParcel1.enforceInterface("com.tencent.soter.soterserver.ISoterService");
      paramInt1 = aen(paramParcel1.readInt());
      paramParcel2.writeNoException();
      paramParcel2.writeInt(paramInt1);
      return true;
    case 8: 
      paramParcel1.enforceInterface("com.tencent.soter.soterserver.ISoterService");
      bool = cS(paramParcel1.readInt(), paramParcel1.readString());
      paramParcel2.writeNoException();
      paramInt1 = j;
      if (bool) {
        paramInt1 = 1;
    ...
    case 10: 
      paramParcel1.enforceInterface("com.tencent.soter.soterserver.ISoterService");
      paramParcel1 = BV(paramParcel1.readLong());
      paramParcel2.writeNoException();
      if (paramParcel1 != null)
      {
        paramParcel2.writeInt(1);
    ...
    implements a
  {
    ...
    /* Error */
    public final SoterSignResult BV(long paramLong)
    {
      // Byte code:
      //   0: ldc 22
    ...
    public final int aek(int paramInt)
    {
    ...
    /* Error */
    public final SoterExportResult ael(int paramInt)
    {
      // Byte code:
      //   0: ldc 93
      //   2: invokestatic 28	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    public final boolean aem(int paramInt)
    {
      boolean bool = false;
    ...
    public final int aen(int paramInt)
    {
    ...
    public final int cP(int paramInt, String paramString)
    {
    ...
    public final int cQ(int paramInt, String paramString)
    {
    ...
    /* Error */
    public final SoterExportResult cR(int paramInt, String paramString)
    {
      // Byte code:
      //   0: ldc 111
      //   2: invokestatic 28	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    public final boolean cS(int paramInt, String paramString)
    {
      boolean bool = false;
    ...
    /* Error */
    public final SoterDeviceResult fDz()
    {
      // Byte code:
      //   0: ldc 117
      //   2: invokestatic 28	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
 ...
 * Qualified Name:     com.tencent.soter.soterserver.a.a
