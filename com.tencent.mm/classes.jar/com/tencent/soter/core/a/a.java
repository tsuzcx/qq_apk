...
public final class a
{
  ...
  public static a oq(Context paramContext)
  {
  ...
  public final void a(d paramd, CancellationSignal paramCancellationSignal, b paramb)
  {
    ...
    ahwD.a(this.mContext, paramd, paramCancellationSignal, paramb);
    AppMethodBeat.o(88613);
  }
  
  public final boolean jYc()
  {
    AppMethodBeat.i(88612);
    boolean bool = ahwD.hasEnrolledFingerprints(this.mContext);
        ...
        paramb = new b.a()
        {
          ...
          public final void a(b.b paramAnonymousb)
          {
            ...
            if (!a.a.a(this, paramContext))
            {
              ...
              localb = this.ahwE;
              paramAnonymousb = paramAnonymousb.ahwH;
          ...
          public final void onAuthenticationError(int paramAnonymousInt, CharSequence paramAnonymousCharSequence)
          {
            ...
            for (;;)
            {
              ...
              if (paramAnonymousInt == 5)
              {
                ...
                this.ahwE.onAuthenticationCancelled();
                AppMethodBeat.o(88602);
                return;
              }
            ...
            this.ahwE.onAuthenticationError(paramAnonymousInt, paramAnonymousCharSequence);
            AppMethodBeat.o(88602);
          }
          ...
          public final void onAuthenticationFailed()
          {
            ...
            if (!a.a.a(this, paramContext))
            {
              ...
              this.ahwE.onAuthenticationFailed();
            }
            AppMethodBeat.o(88605);
          }
          ...
          public final void onAuthenticationHelp(int paramAnonymousInt, CharSequence paramAnonymousCharSequence)
          {
            ...
            if (!a.a.a(this, paramContext)) {
              this.ahwE.onAuthenticationHelp(paramAnonymousInt, paramAnonymousCharSequence);
            }
            AppMethodBeat.o(88603);
          }
        };
