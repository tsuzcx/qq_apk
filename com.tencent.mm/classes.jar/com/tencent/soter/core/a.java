...
{
  private static e Iuj;
  private static com.tencent.soter.core.d.b Iuk;
  ...
  public static boolean aL(Context paramContext, int paramInt)
  {
  ...
  public static f aNO(String paramString)
  {
    ...
    paramString = Iuk.aNO(paramString);
    AppMethodBeat.o(88506);
    return paramString;
  }
  ...
  public static boolean aNP(String paramString)
  {
    ...
    boolean bool = Iuk.aNP(paramString);
    AppMethodBeat.o(88508);
    return bool;
  }
  ...
  public static boolean aNQ(String paramString)
  {
    ...
    boolean bool = Iuk.aNQ(paramString);
    AppMethodBeat.o(88509);
    return bool;
  }
  
  public static i aNR(String paramString)
  {
    ...
    paramString = Iuk.aNR(paramString);
    AppMethodBeat.o(88510);
    return paramString;
  }
  
  public static Signature aNS(String paramString)
  {
    ...
    paramString = Iuk.aNS(paramString);
    AppMethodBeat.o(88511);
    return paramString;
  }
  
  public static j cL(byte[] paramArrayOfByte)
  {
    ...
    localObject = j.aNT(new String((byte[])localObject));
  ...
  public static f cU(String paramString, boolean paramBoolean)
  {
    ...
    paramString = Iuk.cU(paramString, paramBoolean);
    AppMethodBeat.o(88507);
    return paramString;
  }
  ...
  public static int fmN()
  {
    ...
    if ((Iuk instanceof com.tencent.soter.core.d.d))
    {
  ...
  private static com.tencent.soter.core.d.b fmO()
  {
  ...
  public static void kC(Context paramContext)
  {
    ...
    //   9: getstatic 34	com/tencent/soter/core/a:Iuk	Lcom/tencent/soter/core/d/b;
    //   12: ifnonnull +88 -> 100
    //   15: ldc 21
    //   17: ldc_w 375
    //   20: iconst_0
    ...
    //   27: invokestatic 378	com/tencent/soter/core/d/d:isInitializing	()Z
    //   30: ifne +58 -> 88
    //   33: new 241	com/tencent/soter/core/d/d
    //   36: dup
    //   37: invokespecial 379	com/tencent/soter/core/d/d:<init>	()V
    //   40: astore_1
    //   41: aload_1
    //   42: putstatic 34	com/tencent/soter/core/a:Iuk	Lcom/tencent/soter/core/d/b;
    //   45: aload_1
    //   46: getstatic 51	com/tencent/soter/core/a:Iuj	Lcom/tencent/soter/core/d/e;
    //   49: invokevirtual 60	com/tencent/soter/core/d/b:a	(Lcom/tencent/soter/core/d/e;)V
    //   52: getstatic 34	com/tencent/soter/core/a:Iuk	Lcom/tencent/soter/core/d/b;
    //   55: aload_0
    //   56: invokevirtual 382	com/tencent/soter/core/d/b:kG	(Landroid/content/Context;)Z
    //   59: ifne +41 -> 100
    //   62: aconst_null
    //   63: putstatic 34	com/tencent/soter/core/a:Iuk	Lcom/tencent/soter/core/d/b;
    //   66: ldc 21
    //   68: ldc_w 384
    //   71: iconst_0
  ...
  @Deprecated
  public static boolean kE(Context paramContext)
  {
  ...
  public static SoterSessionResult lQ(String paramString1, String paramString2)
  {
    ...
    paramString1 = Iuk.lQ(paramString1, paramString2);
    AppMethodBeat.o(88512);
    return paramString1;
  }
  
  public static byte[] xi(long paramLong)
  {
    ...
    byte[] arrayOfByte = Iuk.xi(paramLong);
    AppMethodBeat.o(88513);
    return arrayOfByte;
  }
}
