...
{
  public static final String[] ahUM = { "csd-0", "csd-1", "csd-2" };
  private static boolean ahUN;
  private static boolean ahUO;
  ...
  private static int aJa(int paramInt)
  {
  ...
  public static int b(f paramf, e parame)
  {
    ...
    if (parame.cGO != -1)
    {
      i = 0;
      j = 0;
      while (i < parame.ahTl.size())
      {
        j += ((byte[])parame.ahTl.get(i)).length;
        i += 1;
      }
    }
    for (int i = parame.cGO + j;; i = d(parame.cGN, parame.width, parame.height, paramf.cWw))
    {
  ...
  public static int d(String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      paramInt1 = aJa(paramInt1) * aJa(paramInt2) * 16 * 16;
      paramInt2 = j;
      continue;
      paramInt1 *= paramInt2;
      paramInt2 = j;
  ...
  public static ArrayList<byte[]> h(MediaFormat paramMediaFormat)
  {
    ...
    while (i < ahUM.length)
    {
      ByteBuffer localByteBuffer = paramMediaFormat.getByteBuffer(ahUM[i]);
  ...
  public static boolean isAdaptive(MediaCodecInfo.CodecCapabilities paramCodecCapabilities)
  {
  ...
  public static boolean isSecure(MediaCodecInfo.CodecCapabilities paramCodecCapabilities)
  {
      ...
      try
      {
        ...
        case 1513190: 
          ...
          case 2006354: 
            if (b.isLogEnable())
            {
              new StringBuilder("deviceNeedsSetOutputSurfaceWorkaround:").append(ahUO);
              b.O("TUtils");
            }
            ahUN = true;
            boolean bool = ahUO;
  ...
  public static String x(Surface paramSurface)
  {
    AppMethodBeat.i(210842);
    try
    {
      Field localField = c.m(Surface.class, "mName");
