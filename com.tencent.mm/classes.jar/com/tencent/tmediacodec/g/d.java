...
public final class d
{
  ...
  private static int asx(int paramInt)
  {
  ...
  public static int b(f paramf, e parame)
  {
    ...
    if (parame.bdr != -1)
    {
      i = 0;
      j = 0;
      while (i < parame.Slz.size())
      {
        j += ((byte[])parame.Slz.get(i)).length;
        i += 1;
      }
    }
    for (int i = parame.bdr + j;; i = d(parame.bdq, parame.width, parame.height, paramf.bsY))
    {
  ...
  public static int d(String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      paramInt1 = asx(paramInt1) * asx(paramInt2) * 16 * 16;
      paramInt2 = j;
      continue;
      paramInt1 *= paramInt2;
      paramInt2 = j;
      ...
      try
      {
        ...
        case 1513190: 
          ...
          case 2006354: 
            if (b.isLogEnable())
            {
              new StringBuilder("deviceNeedsSetOutputSurfaceWorkaround:").append(Snc);
              b.bqQ("TUtils");
            }
            Snb = true;
            boolean bool = Snc;
  ...
  public static ArrayList<byte[]> j(MediaFormat paramMediaFormat)
  {
    ...
    while (i < Sna.length)
    {
      ByteBuffer localByteBuffer = paramMediaFormat.getByteBuffer(Sna[i]);
  ...
  public static String n(Surface paramSurface)
  {
    AppMethodBeat.i(190195);
    try
    {
      Field localField = c.k(Surface.class, "mName");
