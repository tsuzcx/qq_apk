...
class MP3Header
{
  ...
  MP3Header()
  {
    ...
    this.bitrate = new int[][][] { { { 0, 32, 64, 96, 128, 160, 192, 224, 256, 288, 320, 352, 384, 416, 448 }, { 0, 32, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, 320, 384 }, { 0, 32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, 320 } }, { { 0, 32, 48, 56, 64, 80, 96, 112, 128, 144, 160, 176, 192, 224, 256 }, { 0, 8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, 128, 144, 160 }, { 0, 8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, 128, 144, 160 } } };
    int[] arrayOfInt1 = { 11025, 12000, 8000, 0 };
    int[] arrayOfInt2 = { 22050, 24000, 16000, 0 };
    int[] arrayOfInt3 = { 44100, 48000, 32000, 0 };
    this.samplingRate = new int[][] { arrayOfInt1, { 0, 0, 0, 0 }, arrayOfInt2, arrayOfInt3 };
