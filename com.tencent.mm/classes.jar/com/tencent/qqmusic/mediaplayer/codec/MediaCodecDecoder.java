  ...
  extends BaseDecoder
{
  ...
  private boolean initAudioInformation(String paramString, int paramInt, MediaFormat paramMediaFormat, IDataSource paramIDataSource, AudioFormat.AudioType paramAudioType)
  {
    ...
    //   6: aload_0
    //   7: getfield 73	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mMediaExtractor	Landroid/media/MediaExtractor;
    //   10: iload_2
    //   11: invokevirtual 340	android/media/MediaExtractor:selectTrack	(I)V
    //   14: aload_0
    //   15: aload_1
    //   16: invokestatic 344	android/media/MediaCodec:createDecoderByType	(Ljava/lang/String;)Landroid/media/MediaCodec;
    //   19: putfield 75	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mMediaCodec	Landroid/media/MediaCodec;
    //   22: aload_0
    //   23: getfield 75	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mMediaCodec	Landroid/media/MediaCodec;
    //   26: aload_3
    //   27: aconst_null
    //   28: aconst_null
    //   29: iconst_0
    //   30: invokevirtual 348	android/media/MediaCodec:configure	(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;I)V
    //   33: aload_0
    //   34: getfield 75	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mMediaCodec	Landroid/media/MediaCodec;
    //   37: invokevirtual 351	android/media/MediaCodec:start	()V
    //   40: iconst_m1
    //   41: istore 6
    //   43: iconst_0
    //   44: istore_2
    ...
    //   65: aload_0
    //   66: new 108	android/media/MediaCodec$BufferInfo
    //   69: dup
    //   70: invokespecial 109	android/media/MediaCodec$BufferInfo:<init>	()V
    //   73: invokespecial 113	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:processInputOutputBuffer	(Landroid/media/MediaCodec$BufferInfo;)I
    //   76: istore 7
    //   78: iload 7
    //   80: istore 6
    //   82: iload 7
    ...
    //   89: aload_0
    //   90: getfield 75	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mMediaCodec	Landroid/media/MediaCodec;
    //   93: invokevirtual 191	android/media/MediaCodec:getOutputFormat	()Landroid/media/MediaFormat;
    //   96: astore_1
    //   97: aload_1
    //   98: ifnull +277 -> 375
    //   101: ldc 23
    //   103: new 353	java/lang/StringBuilder
    //   106: dup
    //   107: ldc_w 355
    //   110: invokespecial 356	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   113: aload_3
    //   114: invokevirtual 360	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   117: ldc_w 362
    //   120: invokevirtual 365	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   123: aload_1
    //   124: invokevirtual 360	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   127: invokevirtual 369	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   130: invokestatic 185	com/tencent/qqmusic/mediaplayer/util/Logger:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   133: aload_1
    //   134: getstatic 57	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:KEY_PCM_ENCODING	Ljava/lang/String;
    //   137: invokevirtual 372	android/media/MediaFormat:containsKey	(Ljava/lang/String;)Z
    //   140: ifeq +17 -> 157
    //   143: aload_3
    //   144: getstatic 57	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:KEY_PCM_ENCODING	Ljava/lang/String;
    //   147: aload_1
    //   148: getstatic 57	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:KEY_PCM_ENCODING	Ljava/lang/String;
    //   151: invokevirtual 204	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   154: invokevirtual 376	android/media/MediaFormat:setInteger	(Ljava/lang/String;I)V
    //   157: aload_1
    //   158: ldc 198
    //   160: invokevirtual 372	android/media/MediaFormat:containsKey	(Ljava/lang/String;)Z
    //   163: ifeq +15 -> 178
    //   166: aload_3
    //   167: ldc 198
    //   169: aload_1
    //   170: ldc 198
    //   172: invokevirtual 204	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   175: invokevirtual 376	android/media/MediaFormat:setInteger	(Ljava/lang/String;I)V
    //   178: aload_1
    //   179: ldc_w 378
    //   182: invokevirtual 372	android/media/MediaFormat:containsKey	(Ljava/lang/String;)Z
    //   185: ifeq +17 -> 202
    //   188: aload_3
    //   189: ldc_w 378
    //   192: aload_1
    //   193: ldc_w 378
    //   196: invokevirtual 204	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   199: invokevirtual 376	android/media/MediaFormat:setInteger	(Ljava/lang/String;I)V
    //   202: aload_0
    //   203: getfield 77	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mInfo	Lcom/tencent/qqmusic/mediaplayer/AudioInformation;
    //   206: aload_3
    //   207: aload 4
    //   209: invokeinterface 383 1 0
    //   214: invokestatic 387	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:setAudioInformationByMediaFormat	(Lcom/tencent/qqmusic/mediaplayer/AudioInformation;Landroid/media/MediaFormat;J)V
    //   217: aload 5
    //   219: getstatic 276	com/tencent/qqmusic/mediaplayer/AudioFormat$AudioType:FLAC	Lcom/tencent/qqmusic/mediaplayer/AudioFormat$AudioType;
    //   222: if_acmpne +83 -> 305
    //   225: aload_0
    //   226: new 389	com/tencent/qqmusic/mediaplayer/seektable/flac/FlacSeekTable
    //   229: dup
    //   230: aload_0
    //   231: getfield 77	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mInfo	Lcom/tencent/qqmusic/mediaplayer/AudioInformation;
    //   234: invokevirtual 163	com/tencent/qqmusic/mediaplayer/AudioInformation:getSampleRate	()J
    //   237: l2i
    //   238: invokespecial 391	com/tencent/qqmusic/mediaplayer/seektable/flac/FlacSeekTable:<init>	(I)V
    //   241: putfield 85	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mSeekTable	Lcom/tencent/qqmusic/mediaplayer/seektable/SeekTable;
    //   244: aload_0
    //   245: getfield 85	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mSeekTable	Lcom/tencent/qqmusic/mediaplayer/seektable/SeekTable;
    //   248: ifnull +14 -> 262
    //   251: aload_0
    //   252: getfield 85	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mSeekTable	Lcom/tencent/qqmusic/mediaplayer/seektable/SeekTable;
    //   255: aload 4
    //   257: invokeinterface 397 2 0
    //   262: aload_0
    //   263: getfield 77	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mInfo	Lcom/tencent/qqmusic/mediaplayer/AudioInformation;
    //   266: invokevirtual 398	com/tencent/qqmusic/mediaplayer/AudioInformation:getDuration	()J
    //   269: lconst_0
    //   270: lcmp
    //   271: ifle +111 -> 382
    //   274: aload_0
    //   275: getfield 77	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mInfo	Lcom/tencent/qqmusic/mediaplayer/AudioInformation;
    //   278: invokevirtual 159	com/tencent/qqmusic/mediaplayer/AudioInformation:getChannels	()I
    //   281: iconst_2
    //   282: if_icmplt +100 -> 382
    //   285: iconst_1
    //   286: istore 8
    //   288: ldc_w 337
    //   291: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   294: iload 8
    //   296: ireturn
    //   297: astore_1
    //   298: iload_2
    ...
    //   302: goto -257 -> 45
    //   305: aload 5
    //   307: getstatic 298	com/tencent/qqmusic/mediaplayer/AudioFormat$AudioType:M4A	Lcom/tencent/qqmusic/mediaplayer/AudioFormat$AudioType;
    //   310: if_acmpeq +11 -> 321
    //   313: aload 5
    //   315: getstatic 401	com/tencent/qqmusic/mediaplayer/AudioFormat$AudioType:MP4	Lcom/tencent/qqmusic/mediaplayer/AudioFormat$AudioType;
    //   318: if_acmpne +17 -> 335
    //   321: aload_0
    //   322: new 403	com/tencent/qqmusic/mediaplayer/seektable/mpeg4/Mp4SeekTable
    //   325: dup
    //   326: invokespecial 404	com/tencent/qqmusic/mediaplayer/seektable/mpeg4/Mp4SeekTable:<init>	()V
    //   329: putfield 85	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mSeekTable	Lcom/tencent/qqmusic/mediaplayer/seektable/SeekTable;
    //   332: goto -88 -> 244
    //   335: aload 5
    //   337: getstatic 301	com/tencent/qqmusic/mediaplayer/AudioFormat$AudioType:MP3	Lcom/tencent/qqmusic/mediaplayer/AudioFormat$AudioType;
    //   340: if_acmpne -96 -> 244
    //   343: aload_0
    //   344: new 406	com/tencent/qqmusic/mediaplayer/seektable/mp3/Mp3SeekTable
    //   347: dup
    //   348: invokespecial 407	com/tencent/qqmusic/mediaplayer/seektable/mp3/Mp3SeekTable:<init>	()V
    //   351: putfield 85	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mSeekTable	Lcom/tencent/qqmusic/mediaplayer/seektable/SeekTable;
    //   354: goto -110 -> 244
    //   357: astore_1
    //   358: aload_0
    //   359: aconst_null
    //   360: putfield 85	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mSeekTable	Lcom/tencent/qqmusic/mediaplayer/seektable/SeekTable;
    //   363: ldc 23
    //   365: ldc_w 409
    //   368: aload_1
    //   369: invokestatic 324	com/tencent/qqmusic/mediaplayer/util/Logger:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   372: goto -110 -> 262
    //   375: aload_0
    //   376: getfield 75	com/tencent/qqmusic/mediaplayer/codec/MediaCodecDecoder:mMediaCodec	Landroid/media/MediaCodec;
    //   379: invokevirtual 412	android/media/MediaCodec:release	()V
    //   382: iconst_0
    //   383: istore 8
    //   385: goto -97 -> 288
    //   388: aconst_null
