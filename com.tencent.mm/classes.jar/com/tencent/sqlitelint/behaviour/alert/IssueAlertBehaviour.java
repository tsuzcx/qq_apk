  ...
  extends BaseBehaviour
{
  ...
  private static void createShortCut(Context paramContext)
  {
    ...
    ((Intent)localObject).putExtra("android.intent.extra.shortcut.ICON_RESOURCE", Intent.ShortcutIconResource.fromContext(paramContext, 2131234174));
  ...
  public void onPublish(List<SQLiteLintIssue> paramList)
  {
    ...
    sMainHandler.post(new Runnable()
    {
      ...
      public void run()
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.a(localContext, ((com.tencent.mm.hellhoundlib.b.a)localObject).ahE(), "com/tencent/sqlitelint/behaviour/alert/IssueAlertBehaviour$1", "run", "()V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
