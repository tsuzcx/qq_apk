...
public final class b
{
  ...
  public static byte[] compress(byte[] paramArrayOfByte)
  {
    ...
    //   58: invokevirtual 58	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   61: invokestatic 64	com/tencent/d/f/h:eF	(Ljava/lang/Object;)V
    //   64: aload_1
    //   65: invokevirtual 42	java/io/ByteArrayOutputStream:close	()V
    //   68: aload_2
    //   69: invokevirtual 43	java/util/zip/DeflaterOutputStream:close	()V
    //   72: ldc 11
    ...
    //   79: astore_0
    //   80: aload_1
    //   81: invokevirtual 42	java/io/ByteArrayOutputStream:close	()V
    //   84: aload_2
    //   85: invokevirtual 43	java/util/zip/DeflaterOutputStream:close	()V
    //   88: ldc 11
  ...
  public static byte[] dt(byte[] paramArrayOfByte)
  {
    ...
    //   0: ldc 67
    //   2: invokestatic 17	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   5: new 69	java/io/ByteArrayInputStream
    //   8: dup
    //   9: aload_0
    //   10: invokespecial 71	java/io/ByteArrayInputStream:<init>	([B)V
    //   13: astore_0
    //   14: new 73	java/util/zip/InflaterInputStream
    //   17: dup
    //   18: aload_0
    //   19: invokespecial 76	java/util/zip/InflaterInputStream:<init>	(Ljava/io/InputStream;)V
    //   22: astore_2
    ...
    //   30: astore_3
    //   31: aload_2
    //   32: invokevirtual 80	java/util/zip/InflaterInputStream:read	()I
    //   35: istore_1
    //   36: iload_1
    //   37: iconst_m1
    //   38: if_icmpeq +45 -> 83
    //   41: aload_3
    //   42: iload_1
    //   43: invokevirtual 82	java/io/ByteArrayOutputStream:write	(I)V
    //   46: goto -15 -> 31
    //   49: astore 4
    //   51: ldc 84
    //   53: aload 4
    ...
    //   61: invokestatic 64	com/tencent/d/f/h:eF	(Ljava/lang/Object;)V
    //   64: aload_0
    //   65: invokevirtual 85	java/io/ByteArrayInputStream:close	()V
    //   68: aload_2
    //   69: invokevirtual 86	java/util/zip/InflaterInputStream:close	()V
    //   72: aload_3
    //   73: invokevirtual 42	java/io/ByteArrayOutputStream:close	()V
    //   76: ldc 67
    //   78: invokestatic 46	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   81: aconst_null
    //   82: areturn
    //   83: aload_3
    //   84: invokevirtual 39	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   87: astore 4
    //   89: aload_0
    //   90: invokevirtual 85	java/io/ByteArrayInputStream:close	()V
    //   93: aload_2
    //   94: invokevirtual 86	java/util/zip/InflaterInputStream:close	()V
    //   97: aload_3
    //   98: invokevirtual 42	java/io/ByteArrayOutputStream:close	()V
    //   101: ldc 67
    ...
    //   109: astore 4
    //   111: aload_0
    //   112: invokevirtual 85	java/io/ByteArrayInputStream:close	()V
    //   115: aload_2
    //   116: invokevirtual 86	java/util/zip/InflaterInputStream:close	()V
    //   119: aload_3
    //   120: invokevirtual 42	java/io/ByteArrayOutputStream:close	()V
    //   123: ldc 67
