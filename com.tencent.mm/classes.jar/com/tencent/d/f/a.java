...
public final class a
{
  ...
  public static List<byte[]> dd(Context paramContext, String paramString)
  {
        ...
        for (;;)
        {
          if ((i < paramContext.length) && (i < 5))
          {
            ...
            catch (CertificateEncodingException paramString)
            {
              for (;;)
              {
                h.eG("extractPkgCertMd5s(), CertificateEncodingException: ".concat(String.valueOf(paramString)));
              }
            }
          }
        }
    ...
    {
      h.eG("extractPkgCertMd5s(), Exception: ".concat(String.valueOf(paramContext)));
      AppMethodBeat.o(138452);
    }
  }
  
  public static com.tencent.d.a.a de(Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      if (paramContext != null) {
        locala.Znx = e.aC(e.md5(paramContext.getEncoded()));
      }
    }
    catch (Throwable paramContext)
    {
  ...
  public static List<com.tencent.d.a.a> lV(Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        i = 1;
        locala = de(paramContext, localApplicationInfo.packageName);
        locala.Znw = localPackageManager.getApplicationLabel(localApplicationInfo).toString();
        if (locala.Znw != null) {
          break label236;
        }
        locala.Znw = "";
      ...
      catch (Throwable paramContext)
      {
        ...
        h.eF("getAllAppInfos(), exception: ".concat(String.valueOf(paramContext)));
        AppMethodBeat.o(138451);
        return localArrayList;
      }
      locala.appType = i;
      locala.fileSize = new File(localApplicationInfo.sourceDir).length();
      locala.Zny = localApplicationInfo.sourceDir;
