...
import com.tencent.d.d.b.b;
import com.tencent.d.d.b.d;
import com.tencent.d.d.b.g;
...
{
  private static boolean R(File paramFile)
  {
    AppMethodBeat.i(138351);
    try
    {
      if ((d.bCT(paramFile.getAbsolutePath()) & 0x800) > 0)
      {
  ...
  public static boolean inW()
  {
    ...
    try
    {
      Object localObject = new String(b.bgK("/proc/mounts"));
    ...
    if (arrayOfFile != null)
    {
      ...
      while (i < j)
      {
        ...
        if ((!"run-as".equals(localFile.getName())) && (R(localFile)))
        {
