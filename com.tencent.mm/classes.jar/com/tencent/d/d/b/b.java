...
{
  private static final byte[] ZoY = { 127, 69, 76, 70 };
  
  public static boolean bCR(String paramString)
  {
    AppMethodBeat.i(138356);
    byte[] arrayOfByte = new byte[ZoY.length];
    try
    {
      localFileInputStream = new FileInputStream(paramString);
      try
      {
        if (localFileInputStream.read(arrayOfByte, 0, ZoY.length) == arrayOfByte.length) {
          break label87;
        }
  ...
  /* Error */
  public static byte[] bgK(String paramString)
  {
    // Byte code:
    //   0: ldc 64
    ...
    //   26: aload_2
    //   27: aload_1
    //   28: invokestatic 76	com/tencent/d/d/b/c:d	(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    //   31: pop2
    //   32: aload_1
    ...
    //   38: ifnull +18 -> 56
    //   41: aload_2
    //   42: invokestatic 61	com/tencent/d/d/b/c:closeQuietly	(Ljava/io/Closeable;)V
    //   45: aload_1
    //   46: invokestatic 61	com/tencent/d/d/b/c:closeQuietly	(Ljava/io/Closeable;)V
    //   49: ldc 64
    ...
    //   69: astore_2
    //   70: aload_2
    //   71: invokestatic 61	com/tencent/d/d/b/c:closeQuietly	(Ljava/io/Closeable;)V
    //   74: aload_1
    //   75: invokestatic 61	com/tencent/d/d/b/c:closeQuietly	(Ljava/io/Closeable;)V
    //   78: ldc 64
  ...
  /* Error */
  public static byte[] jdMethod_if(String paramString, int paramInt)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore_2
    ...
    //   77: ifne +14 -> 91
    //   80: aload_0
    //   81: invokestatic 61	com/tencent/d/d/b/c:closeQuietly	(Ljava/io/Closeable;)V
    //   84: ldc 92
    ...
    //   113: astore 5
    //   115: aload_0
    //   116: invokestatic 61	com/tencent/d/d/b/c:closeQuietly	(Ljava/io/Closeable;)V
    //   119: ldc 92
    ...
    //   129: astore_0
    //   130: aload_0
    //   131: invokestatic 61	com/tencent/d/d/b/c:closeQuietly	(Ljava/io/Closeable;)V
    //   134: ldc 92
    ...
    //   144: astore_0
    //   145: aload_0
    //   146: invokestatic 61	com/tencent/d/d/b/c:closeQuietly	(Ljava/io/Closeable;)V
    //   149: ldc 92
