...
public final class e
{
  ...
  private static String aAm(int paramInt)
  {
    AppMethodBeat.i(138365);
    String str = "";
    try
    {
      Object localObject = b.jdMethod_if(String.format(Locale.ENGLISH, "/proc/%d/cmdline", new Object[] { Integer.valueOf(paramInt) }), 100);
      if (localObject != null) {
      ...
      {
        byte[] arrayOfByte = b.jdMethod_if(String.format(Locale.ENGLISH, "/proc/%d/status", new Object[] { Integer.valueOf(paramInt) }), 150);
        localObject = str;
        if (arrayOfByte != null)
        {
  ...
  private static a aAn(int paramInt)
  {
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        {
          String str1;
          Object localObject2 = new String(b.bgK(String.format(Locale.ENGLISH, "/proc/%d/attr/current", new Object[] { Integer.valueOf(paramInt) }))).trim();
    ...
    for (;;)
    {
      try
      {
        localObject2 = b.jdMethod_if(String.format(Locale.ENGLISH, "/proc/%d/status", new Object[] { Integer.valueOf(paramInt) }), 150);
      ...
      if (i < j)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject)) {
          try
          {
            ...
            localObject = aAn(Integer.parseInt((String)localObject));
            if (localObject == null) {
              break label125;
            }
  ...
  public static final class a
  {
    ...
    public final String toString()
    {
      ...
      String str = "PID=" + this.pid + " PPID=" + this.Zpc + " NAME=" + this.name + " UID=" + this.uid + " CONTEXT=" + this.Zpd;
