  ...
  implements a
{
  ...
  private int a(Context paramContext, final AtomicReference<IBinder> paramAtomicReference, final AtomicReference<ServiceConnection> paramAtomicReference1)
  {
    ...
    //   9: aload_1
    //   10: aload_0
    //   11: invokevirtual 25	com/tencent/d/e/b/a/a/e:getIntent	()Landroid/content/Intent;
    //   14: new 8	com/tencent/d/e/b/a/a/e$1
    //   17: dup
    //   18: aload_0
    //   19: aload_2
    //   20: aload_3
    //   21: aload 4
    //   23: invokespecial 28	com/tencent/d/e/b/a/a/e$1:<init>	(Lcom/tencent/d/e/b/a/a/e;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;)V
    //   26: iconst_1
  ...
  private int a(final Context paramContext, final AtomicReference<IBinder> paramAtomicReference, final AtomicReference<ServiceConnection> paramAtomicReference1, final AtomicReference<String> paramAtomicReference2)
  {
    ...
    //   20: astore 6
    //   22: getstatic 64	com/tencent/e/h:ZvG	Lcom/tencent/e/i;
    //   25: new 10	com/tencent/d/e/b/a/a/e$2
    //   28: dup
    //   29: aload_0
    //   30: aload_1
    //   31: aload_2
    ...
    //   36: aload_3
    //   37: aload 5
    //   39: invokespecial 67	com/tencent/d/e/b/a/a/e$2:<init>	(Lcom/tencent/d/e/b/a/a/e;Landroid/content/Context;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;)V
  ...
  private c lU(Context paramContext)
  {
    int j = -1;
  ...
  public final c lS(Context paramContext)
  {
    if ((this.Zqs == null) || (this.Zqs.errorCode != 0)) {
      this.Zqs = lU(paramContext);
    }
    return this.Zqs;
  }
}
 ...
 * Qualified Name:     com.tencent.d.e.b.a.a.e
