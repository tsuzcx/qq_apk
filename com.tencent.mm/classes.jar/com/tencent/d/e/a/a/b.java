...
{
  private static final int[] IrQ = { 1, 5, 4, 8, 9, 2 };
  ...
  public static com.tencent.d.e.a.b.a a(int paramInt1, int paramInt2, Context paramContext, int paramInt3, SparseArray<i> paramSparseArray, List<k> paramList)
  {
    ...
    locala.Isn = 0L;
    locala.drI = "";
    locala.AHj = com.tencent.d.f.i.cu(paramContext, paramContext.getPackageName()).versionCode;
    locala.Iqe = "14D6ACDE3C2F2F48";
    locala.channel = 500000;
    locala.requestType = paramInt3;
    locala.Isp = aND(paramContext.getPackageName());
    ArrayList localArrayList = new ArrayList();
    paramInt3 = 0;
    while (paramInt3 < paramSparseArray.size())
    {
      localArrayList.addAll(((i)paramSparseArray.valueAt(paramInt3)).ip(paramList));
      paramInt3 += 1;
    }
    ...
    paramSparseArray.Isx = ((g)localArrayList.get(0)).IsC;
    paramSparseArray.Isy = localArrayList;
    paramSparseArray.Irz = paramInt1;
    paramSparseArray.action = paramInt2;
    paramList = new ArrayList();
    paramList.add(paramSparseArray);
    locala.Iso = paramList;
    locala.imei = aND(d.getIMEI(paramContext));
    locala.imsi = aND(d.kx(paramContext));
    locala.gXN = aND(Build.BRAND);
    locala.model = aND(Build.MODEL);
    locala.Isq = aND(Build.FINGERPRINT);
    locala.Isr = fmm();
  ...
  private static int fmm()
  {
    ...
    if (IrR == -1)
    {
      ...
      if (i < IrQ.length)
      {
        if (localSensorManager.getDefaultSensor(IrQ[i]) == null) {}
        for (int k = 0;; k = 1)
        {
          j |= k << i;
          i += 1;
