...
{
  private static final int[] ZpD = { 1, 4, 9 };
  private final HashSet<Sensor> ZpB;
  public final SparseArray<i> ZpC;
  public a ZpE;
  ...
  private static boolean h(SparseArray<i> paramSparseArray)
  {
    ...
    while (i < paramSparseArray.size())
    {
      ...
      if (localObject != null)
      {
        Object[] arrayOfObject = ((i)localObject).iok();
        if ((arrayOfObject != null) && (arrayOfObject.length != 0))
        {
          int j = 0;
          int m;
          for (int k = 0; j < ((i)localObject).zL.length; k = m)
          {
            m = k;
            if ((List)localObject.zL[j] != null) {
              m = k + 1;
            }
            j += 1;
          }
          ...
          while (j < arrayOfObject.length)
          {
            ...
            if ((localObject != null) && (((List)localObject).size() < f.Zpz / 2))
            {
              AppMethodBeat.o(138402);
              return false;
            }
  ...
  /* Error */
  public final boolean WN(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   26: ireturn
    //   27: aload_0
    //   28: getfield 49	com/tencent/d/e/a/a/g:ZpE	Lcom/tencent/d/e/a/a/g$a;
    //   31: astore 9
    //   33: aload 9
    //   35: getfield 110	com/tencent/d/e/a/a/g$a:ZpF	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   38: astore 8
    //   40: aload 8
    //   42: monitorenter
    //   43: aload 9
    //   45: getfield 110	com/tencent/d/e/a/a/g$a:ZpF	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   48: invokevirtual 116	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   51: ifeq +126 -> 177
    //   54: aload 8
    //   56: monitorexit
    //   57: aload_0
    //   58: getfield 39	com/tencent/d/e/a/a/g:ZpB	Ljava/util/HashSet;
    //   61: astore 8
    //   63: aload 8
    //   65: monitorenter
    //   66: aload_0
    //   67: getfield 39	com/tencent/d/e/a/a/g:ZpB	Ljava/util/HashSet;
    //   70: invokevirtual 119	java/util/HashSet:clear	()V
    //   73: aload 8
    //   75: monitorexit
    //   76: aload_0
    //   77: getfield 39	com/tencent/d/e/a/a/g:ZpB	Ljava/util/HashSet;
    //   80: astore 8
    //   82: aload 8
    //   84: monitorenter
    //   85: getstatic 23	com/tencent/d/e/a/a/g:ZpD	[I
    //   88: astore 9
    //   90: aload 9
    //   92: arraylength
    //   93: istore 4
    ...
    //   140: aload_0
    //   141: getfield 49	com/tencent/d/e/a/a/g:ZpE	Lcom/tencent/d/e/a/a/g$a;
    //   144: aload 10
    //   146: iconst_0
    ...
    //   150: ifeq +16 -> 166
    //   153: aload_0
    //   154: getfield 39	com/tencent/d/e/a/a/g:ZpB	Ljava/util/HashSet;
    //   157: aload 10
    ...
    //   174: goto -74 -> 100
    //   177: aload 9
    //   179: getfield 110	com/tencent/d/e/a/a/g$a:ZpF	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   182: iconst_1
    ...
    //   191: putfield 145	com/tencent/d/e/a/a/g$a:Zpu	J
    //   194: aload 9
    //   196: lload_1
    //   197: l2d
    //   198: getstatic 148	com/tencent/d/e/a/a/f:Zpy	J
    //   201: l2d
    //   202: ddiv
    //   203: invokestatic 154	java/lang/Math:ceil	(D)D
    //   206: d2i
    //   207: putfield 157	com/tencent/d/e/a/a/g$a:ZpG	I
    //   210: aload 8
    //   212: monitorexit
    //   213: goto -156 -> 57
    //   216: astore 9
    ...
    //   254: ifne +7 -> 261
    //   257: aload_0
    //   258: invokevirtual 160	com/tencent/d/e/a/a/g:ioe	()V
    //   261: ldc 106
  ...
  public final void ioe()
  {
    for (;;)
    {
      try
      {
        ...
        {
          Iterator localIterator = this.ZpB.iterator();
          if (localIterator.hasNext())
          {
            Sensor localSensor = (Sensor)localIterator.next();
            this.mSensorManager.unregisterListener(this.ZpE, localSensor);
          }
        }
        this.ZpB.clear();
      }
      ...
      synchronized (locala.ZpF)
      {
        ...
        locala.ZpF.set(false);
        locala.ZpH = (System.currentTimeMillis() - locala.Zpu);
        if (locala.ZpH < 0L) {
          locala.ZpH = 0L;
        }
        locala.Zpu = 0L;
  ...
  public final SparseArray<i> iof()
  {
    ...
    synchronized (this.ZpC)
    {
      ...
      int i = 0;
      while (i < this.ZpC.size())
      {
        localSparseArray2.append(this.ZpC.keyAt(i), (i)this.ZpC.valueAt(i));
        i += 1;
      }
    ...
    implements SensorEventListener
  {
    ...
    a()
    {
      ...
      this.ZpF = new AtomicBoolean(false);
      this.Zpu = 0L;
      this.ZpG = 0;
      this.ZpH = 0L;
    ...
    public final long iog()
    {
      synchronized (this.ZpF)
      {
        long l = this.Zpu;
        return l;
      }
    ...
    public final void onSensorChanged(SensorEvent arg1)
    {
      ...
      synchronized (this.ZpF)
      {
        long l = localj.timestamp - this.Zpu;
        if (l < 0L)
        {
          AppMethodBeat.o(138397);
          return;
      ...
      for (;;)
      {
        synchronized (g.a(g.this))
        {
          ...
          if (??? == null)
          {
            ??? = new i(j, f.Zpz, this.ZpG);
            g.a(g.this).put(j, ???);
            if ((i < ???.fip) && (i > ???.iU))
            {
              j = i / ???.ZpM;
              List localList = (List)???.zL[j];
              ??? = localList;
              if (localList == null)
              {
                ??? = new ArrayList();
