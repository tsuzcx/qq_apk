...
public final class h
{
  ...
  public static a i(Map<String, a> paramMap, int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((locala != null) && (locala.requestType == paramInt))
      {
        ...
        if (localObject == null) {
          ...
          localObject.ZpT.addAll(locala.ZpT);
        }
      }
    }
    if (localObject != null)
    {
      ...
      paramMap.ZpJ = localObject;
      paramMap.ZpK = localArrayList;
      AppMethodBeat.o(138407);
      return paramMap;
    }
    AppMethodBeat.o(138407);
  ...
  public final Map<String, a> ioj()
  {
    ...
    if (i < j)
    {
      ...
      try
      {
        localObject = c.q(f.T(new File(localFile.getAbsolutePath())), c.ion());
        if (localObject == null)
        {
          localObject = null;
          label101:
      ...
      for (;;)
      {
        i += 1;
        break;
        byte[] arrayOfByte = b.dt(localThrowable);
        if (arrayOfByte == null)
        {
          locala = null;
          break label101;
  ...
  public final String nJ(int paramInt1, int paramInt2)
  {
    AppMethodBeat.i(138405);
    String str = nK(paramInt1, paramInt2);
