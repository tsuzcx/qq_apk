...
{
  private static final j<e> IrB;
  private g IrC;
  private final List<k> IrD;
  private d IrE;
  private b IrF;
  private com.tencent.d.e.a.a.d IrG;
  private final Runnable IrH;
  private final a IrI;
  private boolean arf;
  ...
  private e()
  {
    ...
    this.IrH = new com.tencent.d.e.a.a.c()
    {
      public final void aJr()
      {
        ...
        synchronized (e.this)
        {
          ...
          if (e.g(e.this).xg(e.a(e.this).IrA))
          {
            long l = e.g(e.this).IrZ.fmp();
            e.a locala = e.d(e.this);
            int i = (int)(e.a(e.this).IrA / f.IrS);
            locala.mCount = 1;
            locala.mMaxCount = i;
            locala.IrP = l;
            l = l + f.IrS - System.currentTimeMillis();
            if (l > 0L) {
  ...
  public final boolean Ft()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.mHandler.removeCallbacks(this.IrH);
      }
      finally {}
      this.mHandler.removeCallbacks(this.IrI);
      if (this.IrC != null)
      {
        this.IrC.fmn();
        if ((int)(this.IrC.IrZ.fmq() / f.IrS) < 3) {
          AppMethodBeat.o(138388);
        }
      }
      else
      ...
      SparseArray localSparseArray1 = this.IrC.fmo();
      ...
      else
      {
        ...
        synchronized (this.IrD)
        {
          localArrayList = new ArrayList(this.IrD);
          if (localArrayList.size() < 3) {
            AppMethodBeat.o(138388);
          }
        }
        final int i = this.IrE.Irz;
        final int j = this.IrE.action;
        final int k = this.IrE.requestType;
        this.mHandler.post(new com.tencent.d.e.a.a.c()
        {
          ...
          public final void aJr()
          {
            ...
            //   5: aload_0
            //   6: getfield 23	com/tencent/d/e/a/e$3:IrJ	Lcom/tencent/d/e/a/e;
            //   9: astore_3
            //   10: aload_3
            //   11: monitorenter
            //   12: aload_0
            //   13: getfield 25	com/tencent/d/e/a/e$3:IrK	I
            //   16: aload_0
            //   17: getfield 27	com/tencent/d/e/a/e$3:cOj	I
            //   20: aload_0
            //   21: getfield 23	com/tencent/d/e/a/e$3:IrJ	Lcom/tencent/d/e/a/e;
            ...
            //   30: aload_0
            //   31: getfield 29	com/tencent/d/e/a/e$3:Bko	I
            //   34: aload_0
            //   35: getfield 31	com/tencent/d/e/a/e$3:IrL	Landroid/util/SparseArray;
            //   38: aload_0
            //   39: getfield 33	com/tencent/d/e/a/e$3:IrM	Ljava/util/List;
            ...
            //   47: aload_3
            //   48: monitorexit
            //   49: invokestatic 70	com/tencent/d/e/a/a/h:fmr	()Lcom/tencent/d/e/a/a/h;
            //   52: astore 5
            //   54: aload_0
            //   55: getfield 25	com/tencent/d/e/a/e$3:IrK	I
            //   58: istore_1
            //   59: aload_0
            //   60: getfield 27	com/tencent/d/e/a/e$3:cOj	I
            //   63: istore_2
            //   64: aload 4
            //   66: invokevirtual 76	com/tencent/d/e/a/b/a:toByteArray	()[B
            //   69: invokestatic 82	com/tencent/d/f/b:compress	([B)[B
            //   72: invokestatic 87	com/tencent/d/f/c:fmu	()[B
            ...
            //   146: iload_1
            //   147: iload_2
            //   148: invokevirtual 137	com/tencent/d/e/a/a/h:kk	(II)Ljava/lang/String;
            //   151: astore_3
            //   152: aload_3
            ...
            //   170: pop
            //   171: aload_0
            //   172: getfield 23	com/tencent/d/e/a/e$3:IrJ	Lcom/tencent/d/e/a/e;
            //   175: invokestatic 147	com/tencent/d/e/a/e:h	(Lcom/tencent/d/e/a/e;)Lcom/tencent/d/e/a/b;
            //   178: ifnull +11 -> 189
            //   181: aload_0
            //   182: getfield 23	com/tencent/d/e/a/e$3:IrJ	Lcom/tencent/d/e/a/e;
            ...
            //   234: iload_1
            //   235: iload_2
            //   236: invokestatic 168	com/tencent/d/e/a/a/h:kl	(II)Ljava/lang/String;
        ...
        public final void aJr()
        {
          ...
          if (((Map)localObject1).size() != 0)
          {
            ...
            if (localObject2 != null) {
              localHashMap.put(((h.a)localObject2).Ise, ((h.a)localObject2).Isf);
            }
            ...
            if (localObject1 != null) {
              localHashMap.put(((h.a)localObject1).Ise, ((h.a)localObject1).Isf);
            }
          }
          ...
          for (;;)
          {
            ...
            if (((Iterator)localObject1).hasNext())
            {
              ...
              ((com.tencent.d.e.a.b.a)localObject2).Isn = System.currentTimeMillis();
              ((com.tencent.d.e.a.b.a)localObject2).drI = paramString;
  ...
  public final boolean a(d paramd)
  {
    ...
    //   27: iload_2
    //   28: ireturn
    //   29: invokestatic 231	com/tencent/d/e/a/a/h:fmr	()Lcom/tencent/d/e/a/a/h;
    //   32: astore 4
    //   34: aload 4
    ...
    //   48: aload_0
    //   49: getfield 59	com/tencent/d/e/a/e:arf	Z
    //   52: ifeq +8 -> 60
    //   55: aload_0
    //   56: invokevirtual 249	com/tencent/d/e/a/e:Ft	()Z
    //   59: pop
    //   60: aload_0
    //   61: aload_1
    //   62: putfield 88	com/tencent/d/e/a/e:IrE	Lcom/tencent/d/e/a/d;
    //   65: aload_0
    //   66: iconst_1
    //   67: putfield 59	com/tencent/d/e/a/e:arf	Z
    //   70: aload_0
    //   71: getfield 159	com/tencent/d/e/a/e:IrC	Lcom/tencent/d/e/a/a/g;
    //   74: ifnonnull +14 -> 88
    //   77: aload_0
    //   78: new 172	com/tencent/d/e/a/a/g
    //   81: dup
    //   82: invokespecial 250	com/tencent/d/e/a/a/g:<init>	()V
    //   85: putfield 159	com/tencent/d/e/a/e:IrC	Lcom/tencent/d/e/a/a/g;
    //   88: aload_0
    //   89: getfield 159	com/tencent/d/e/a/e:IrC	Lcom/tencent/d/e/a/a/g;
    //   92: ifnull +27 -> 119
    //   95: aload_0
    //   96: getfield 159	com/tencent/d/e/a/e:IrC	Lcom/tencent/d/e/a/a/g;
    //   99: astore 4
    //   101: aload 4
    //   103: getfield 254	com/tencent/d/e/a/a/g:IrX	Landroid/util/SparseArray;
    //   106: astore_3
    //   107: aload_3
    //   108: monitorenter
    //   109: aload 4
    //   111: getfield 254	com/tencent/d/e/a/a/g:IrX	Landroid/util/SparseArray;
    //   114: invokevirtual 257	android/util/SparseArray:clear	()V
    //   117: aload_3
    //   118: monitorexit
    //   119: aload_0
    //   120: getfield 64	com/tencent/d/e/a/e:IrD	Ljava/util/List;
    //   123: astore_3
    //   124: aload_3
    //   125: monitorenter
    //   126: aload_0
    //   127: getfield 64	com/tencent/d/e/a/e:IrD	Ljava/util/List;
    ...
    //   141: aload_0
    //   142: getfield 69	com/tencent/d/e/a/e:IrH	Ljava/lang/Runnable;
    //   145: aload_1
    //   146: getfield 261	com/tencent/d/e/a/d:HOv	J
    ...
    extends com.tencent.d.e.a.a.c
  {
    ...
    public final void aJr()
    {
      ...
      //   12: astore 7
      //   14: aload_0
      //   15: getfield 18	com/tencent/d/e/a/e$a:IrJ	Lcom/tencent/d/e/a/e;
      //   18: astore 8
      //   20: aload 8
      //   22: monitorenter
      //   23: aload_0
      //   24: getfield 18	com/tencent/d/e/a/e$a:IrJ	Lcom/tencent/d/e/a/e;
      ...
      //   92: aload 7
      //   94: iload_1
      //   95: putfield 99	com/tencent/d/e/a/a/k:Isj	I
      //   98: new 101	java/io/File
      //   101: dup
      //   102: ldc 103
      //   104: invokespecial 106	java/io/File:<init>	(Ljava/lang/String;)V
      //   107: invokestatic 112	com/tencent/d/f/f:T	(Ljava/io/File;)Ljava/lang/String;
      //   110: astore 10
      //   112: aload 10
      ...
      //   130: aload 7
      //   132: iconst_1
      //   133: putfield 127	com/tencent/d/e/a/a/k:Isl	I
      //   136: aload 9
      //   138: aconst_null
      ...
      //   184: aload 7
      //   186: iconst_1
      //   187: putfield 147	com/tencent/d/e/a/a/k:Ism	I
      //   190: aload 8
      //   192: monitorexit
      //   193: aload_0
      //   194: getfield 18	com/tencent/d/e/a/e$a:IrJ	Lcom/tencent/d/e/a/e;
      //   197: invokestatic 151	com/tencent/d/e/a/e:b	(Lcom/tencent/d/e/a/e;)Ljava/util/List;
      //   200: astore 8
      //   202: aload 8
      //   204: monitorenter
      //   205: aload_0
      //   206: getfield 18	com/tencent/d/e/a/e$a:IrJ	Lcom/tencent/d/e/a/e;
      ...
      //   234: aload_0
      //   235: getfield 18	com/tencent/d/e/a/e$a:IrJ	Lcom/tencent/d/e/a/e;
      //   238: astore 7
      //   240: aload 7
      //   242: monitorenter
      //   243: aload_0
      //   244: getfield 18	com/tencent/d/e/a/e$a:IrJ	Lcom/tencent/d/e/a/e;
      ...
      //   399: aload 7
      //   401: iload_1
      //   402: putfield 99	com/tencent/d/e/a/a/k:Isj	I
      //   405: aload 7
      //   407: getfield 99	com/tencent/d/e/a/a/k:Isj	I
      //   410: istore_1
      //   411: goto -319 -> 92
      //   414: aload 9
      //   416: ldc 196
      ...
      //   441: aload 7
      //   443: iload_1
      //   444: putfield 99	com/tencent/d/e/a/a/k:Isj	I
      //   447: goto -349 -> 98
      //   450: astore 10
      //   452: goto -354 -> 98
      //   455: iconst_2
      ...
      //   470: aload 7
      //   472: iconst_2
      //   473: putfield 127	com/tencent/d/e/a/a/k:Isl	I
      //   476: goto -340 -> 136
      //   479: astore 7
      //   481: aload 8
      //   483: monitorexit
      ...
      //   502: aload 7
      //   504: iconst_3
      //   505: putfield 127	com/tencent/d/e/a/a/k:Isl	I
      //   508: goto -372 -> 136
      //   511: aload 9
      //   513: ldc 208
      //   515: iconst_m1
      ...
      //   525: aload 7
      //   527: iconst_3
      //   528: putfield 147	com/tencent/d/e/a/a/k:Ism	I
      //   531: goto -341 -> 190
      //   534: iload_1
      //   535: iconst_1
      ...
      //   539: aload 7
      //   541: iconst_2
      //   542: putfield 147	com/tencent/d/e/a/a/k:Ism	I
      //   545: goto -355 -> 190
      //   548: aload 7
      //   550: iconst_0
      //   551: putfield 147	com/tencent/d/e/a/a/k:Ism	I
      //   554: goto -364 -> 190
      //   557: astore 7
      //   559: aload 8
      //   561: monitorexit
      ...
      //   569: athrow
      //   570: aload_0
      //   571: getfield 18	com/tencent/d/e/a/e$a:IrJ	Lcom/tencent/d/e/a/e;
      //   574: invokevirtual 211	com/tencent/d/e/a/e:Ft	()Z
      //   577: pop
      //   578: aload 7
      //   580: monitorexit
      //   581: ldc 35
      ...
      //   610: aload_0
      //   611: getfield 27	com/tencent/d/e/a/e$a:IrP	J
      //   614: getstatic 216	com/tencent/d/e/a/a/f:IrS	J
      //   617: aload_0
      ...
      //   634: ifle +29 -> 663
      //   637: aload_0
      //   638: getfield 18	com/tencent/d/e/a/e$a:IrJ	Lcom/tencent/d/e/a/e;
      //   641: invokestatic 226	com/tencent/d/e/a/e:e	(Lcom/tencent/d/e/a/e;)Lcom/tencent/mm/sdk/platformtools/ap;
      //   644: aload_0
      //   645: getfield 18	com/tencent/d/e/a/e$a:IrJ	Lcom/tencent/d/e/a/e;
      ...
      //   662: return
      //   663: aload_0
      //   664: getfield 18	com/tencent/d/e/a/e$a:IrJ	Lcom/tencent/d/e/a/e;
      //   667: invokestatic 226	com/tencent/d/e/a/e:e	(Lcom/tencent/d/e/a/e;)Lcom/tencent/mm/sdk/platformtools/ap;
      //   670: aload_0
      //   671: getfield 18	com/tencent/d/e/a/e$a:IrJ	Lcom/tencent/d/e/a/e;
