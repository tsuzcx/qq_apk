...
public class MyDES
{
  ...
  private static void S_BOXF(MyByteArray paramMyByteArray1, MyByteArray paramMyByteArray2)
  {
    ...
    byte[][] arrayOfByte2 = { { 15, 1, 8, 14, 6, 11, 3, 4, 9, 7, 2, 13, 12, 0, 5, 10 }, { 3, 13, 4, 7, 15, 2, 8, 14, 12, 0, 1, 10, 6, 9, 11, 5 }, { 0, 14, 7, 11, 10, 4, 13, 1, 5, 8, 12, 6, 9, 3, 2, 15 }, { 13, 8, 10, 1, 3, 15, 4, 2, 11, 6, 7, 12, 0, 5, 14, 9 } };
    ...
    localObject1 = new byte[][] { { 10, 0, 9, 14, 6, 3, 15, 5, 1, 13, 12, 7, 11, 4, 2, 8 }, localObject1, arrayOfByte3, arrayOfByte4 };
    byte[] arrayOfByte7 = { 13, 8, 11, 5, 6, 15, 0, 3, 4, 7, 2, 12, 1, 10, 14, 9 };
    byte[] arrayOfByte8 = { 10, 6, 9, 0, 12, 11, 7, 13, 15, 1, 3, 14, 5, 2, 8, 4 };
    byte[] arrayOfByte9 = { 3, 15, 0, 6, 10, 1, 13, 8, 9, 4, 5, 11, 12, 7, 2, 14 };
    arrayOfByte3 = new byte[] { 2, 12, 4, 1, 7, 10, 11, 6, 8, 5, 3, 15, 13, 0, 14, 9 };
    arrayOfByte4 = new byte[] { 14, 11, 2, 12, 4, 7, 13, 1, 5, 0, 15, 10, 3, 9, 8, 6 };
    ...
    localObject2 = new byte[][] { { 12, 1, 10, 15, 9, 2, 6, 8, 0, 13, 3, 4, 14, 7, 5, 11 }, { 10, 15, 4, 2, 7, 12, 9, 5, 6, 1, 13, 14, 0, 11, 3, 8 }, localObject2, localObject3 };
    ...
    while (i < 8)
    {
      ...
      ByteToBit(paramMyByteArray1, new MyByteArray(new byte[][][] { arrayOfByte1, arrayOfByte2, localObject1, { { 7, 13, 14, 3, 0, 6, 9, 10, 1, 2, 8, 5, 11, 12, 4, 15 }, arrayOfByte7, arrayOfByte8, arrayOfByte9 }, { arrayOfByte3, arrayOfByte4, arrayOfByte5, arrayOfByte6 }, localObject2, { arrayOfByte10, arrayOfByte11, arrayOfByte12, arrayOfByte13 }, localObject3 }[i][m][n]), 4);
      i = (byte)(i + 1);
