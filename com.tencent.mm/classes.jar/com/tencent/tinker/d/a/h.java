...
{
  public String CzS;
  private final LinkedHashMap<String, g> IFI = new LinkedHashMap();
  private File IFJ;
  private RandomAccessFile IFK;
  ...
  private h(File paramFile, byte paramByte)
  {
    ...
    this.IFJ = null;
    this.IFK = new RandomAccessFile(this.filename, "r");
    fpg();
  }
  ...
  {
    long l1 = 0L;
    long l2 = this.IFK.length() - 22L;
    if (l2 < 0L) {
      throw new ZipException("File too short to be a zip file: " + this.IFK.length());
    }
    this.IFK.seek(0L);
    if (Integer.reverseBytes(this.IFK.readInt()) != 67324752L) {
    ...
    {
      this.IFK.seek(l2);
      if (Integer.reverseBytes(this.IFK.readInt()) != 101010256L)
      {
        l2 -= 1L;
        if (l2 < l1) {
      ...
      else
      {
        ...
        this.IFK.readFully((byte[])localObject);
        ...
        if (n > 0)
        {
          ...
          this.IFK.readFully((byte[])localObject);
          this.CzS = new String((byte[])localObject, 0, localObject.length, e.UTF_8);
        }
        localObject = new BufferedInputStream(new a(this.IFK, l1), 4096);
        ...
        while (i < j)
        {
          ...
          if (this.IFI.put(str, localg) != null) {
  ...
  public final InputStream a(g arg1)
  {
    ...
    synchronized (this.IFK)
    {
      locala = new a(???, localg.IFG);
      localDataInputStream = new DataInputStream(locala);
      i = Integer.reverseBytes(localDataInputStream.readInt());
      if (i != 67324752L) {
        a(this.filename, ???.length(), localg.name, localg.IFG, "Local File Header", i);
      }
    ...
    if (localObject.IFD == 0) {
      a.a(locala, a.a(locala) + localObject.size);
    }
    for (;;)
    {
      return locala;
      a.a(locala, a.a(locala) + localObject.IFC);
    }
  }
  
  public final g aOk(String paramString)
  {
    ns();
    if (paramString == null) {
      throw new NullPointerException("entryName == null");
    }
    g localg2 = (g)this.IFI.get(paramString);
    g localg1 = localg2;
    if (localg2 == null) {
      localg1 = (g)this.IFI.get(paramString + "/");
    }
    return localg1;
  }
  ...
  {
    RandomAccessFile localRandomAccessFile = this.IFK;
  ...
  public static final class a
    extends InputStream
  {
    private final RandomAccessFile IFM;
    private long bjx;
    private long offset;
    ...
    {
      this.IFM = paramRandomAccessFile;
    ...
    public final int read(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
    {
      ...
      {
        long l = this.bjx - this.offset;
        int i = paramInt2;
        if (paramInt2 > l) {
          i = (int)l;
        }
        this.IFM.seek(this.offset);
        paramInt1 = this.IFM.read(paramArrayOfByte, paramInt1, i);
        if (paramInt1 > 0)
        {
    ...
    {
      long l = paramLong;
      if (paramLong > this.bjx - this.offset) {
        l = this.bjx - this.offset;
      }
      this.offset += l;
      return l;
    }
