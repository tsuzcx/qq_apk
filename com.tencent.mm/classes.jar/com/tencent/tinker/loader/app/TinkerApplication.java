  ...
  extends Application
{
  ...
  private void onBaseContextAttached(Context paramContext)
  {
    ...
    if (this.useSafeMode)
    {
      paramContext = ShareTinkerInternals.ak(this);
  ...
  public void onCreate()
  {
    ...
    try
    {
      ComponentHotplug.cQL();
      this.applicationLike.onCreate();
      return;
    }
    catch (UnsupportedEnvironmentException localUnsupportedEnvironmentException)
    {
      throw new TinkerRuntimeException("failed to make sure that ComponentHotplug logic is fine.", localUnsupportedEnvironmentException);
    }
  }
