...
public final class b
{
  ...
  public final short[] a(short[] paramArrayOfShort)
  {
    ...
    System.arraycopy(localh.Shs, 0, paramArrayOfShort, 0, i);
    ...
    extends e
  {
    ...
    private int mK(int paramInt1, int paramInt2)
    {
      ...
      default: 
        return paramInt1;
      case 3: 
        return b.this.SiV.asg(paramInt1);
      case 2: 
        return b.this.SiV.ash(paramInt1);
      case 5: 
        return b.this.SiV.asj(paramInt1);
      }
      return b.this.SiV.ask(paramInt1);
    }
    
    public final void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, long paramLong)
    {
      super.a(paramInt1, paramInt2, mK(paramInt3, paramInt4), paramInt4, paramInt5, paramLong);
    }
    
    public final void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, long paramLong, int paramInt6)
    {
      super.a(paramInt1, paramInt2, mK(paramInt3, paramInt4), paramInt4, paramInt5, paramLong, paramInt6);
    }
    ...
    {
      super.a(paramInt1, paramInt2, mK(paramInt3, paramInt4), paramInt4, paramInt5, paramLong, paramInt6, paramInt7);
    }
    ...
    {
      super.a(paramInt1, paramInt2, mK(paramInt3, paramInt4), paramInt4, paramInt5, paramLong, paramInt6, paramInt7, paramInt8);
    }
    ...
    {
      super.a(paramInt1, paramInt2, mK(paramInt3, paramInt4), paramInt4, paramInt5, paramLong, paramInt6, paramInt7, paramInt8, paramInt9);
    }
    ...
    {
      super.a(paramInt1, paramInt2, mK(paramInt3, paramInt4), paramInt4, paramInt5, paramLong, paramInt6, paramInt7, paramInt8, paramInt9, paramInt10);
    }
    ...
    {
      super.b(paramInt1, paramInt2, mK(paramInt3, paramInt4), paramInt4, paramInt5, paramLong, paramInt6, paramInt7);
    }
  }
}
