...
public class b
  implements d
{
  private static boolean ZMt = false;
  ...
  public void a(File paramFile1, File paramFile2, String paramString, int paramInt)
  {
    ...
    a.mi(this.context).Y(paramFile1);
  }
  ...
  public void a(File paramFile, Throwable paramThrowable)
  {
    ...
    a.mi(this.context).tinkerFlags = 0;
    a.mi(this.context).Y(paramFile);
  }
  ...
  public void a(File paramFile, boolean paramBoolean, long paramLong)
  {
    ...
    label65:
    while (!paramFile.ZNg.exists()) {
      return;
    }
    SharePatchFileUtil.safeDeleteFile(paramFile.ZNg);
  }
  ...
  public void aC(Intent paramIntent)
  {
    ...
    paramIntent = TinkerPatchService.bO(paramIntent);
    if (paramIntent == null)
    {
    ...
    if (localc.ZNf.exists())
    {
      paramIntent = c.a.aa(localc.ZNf);
      if ((paramIntent.md5 == null) || (paramIntent.ZNh == null) || (!str.equals(paramIntent.md5)))
      {
        localc.Z(localFile);
        paramIntent.md5 = str;
        paramIntent.ZNh = "1";
    ...
    for (;;)
    {
      c.a.a(localc.ZNf, paramIntent);
      return;
      int i = Integer.parseInt(paramIntent.ZNh);
      if (i >= localc.DsT)
      {
        SharePatchFileUtil.safeDeleteFile(localc.ZNg);
      ...
      paramIntent.ZNh = String.valueOf(i + 1);
      continue;
      localc.Z(localFile);
