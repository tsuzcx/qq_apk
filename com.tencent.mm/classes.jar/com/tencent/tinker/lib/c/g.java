  ...
  extends a
{
  ...
  {
    com.tencent.tinker.lib.e.a locala = com.tencent.tinker.lib.e.a.kX(paramContext);
    ...
    parama.KqM = str1;
    ShareTinkerLog.i("Tinker.UpgradePatch", "UpgradePatch tryPatch:patchMd5:%s", new Object[] { str1 });
    Object localObject2 = locala.KqS.getAbsolutePath();
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      locala.KqV.b(localFile1, ((SharePatchInfo)localObject3).oldVersion, ((SharePatchInfo)localObject3).newVersion);
      return false;
    }
    if (!SharePatchFileUtil.checkIfMd5Valid(str1))
    {
      ShareTinkerLog.e("Tinker.UpgradePatch", "UpgradePatch tryPatch:onPatchVersionCheckFail md5 %s is valid", new Object[] { str1 });
      locala.KqV.a(localFile1, (SharePatchInfo)localObject3, str1);
      return false;
    }
    ...
    {
      ShareTinkerLog.e("Tinker.UpgradePatch", "patch already applied, md5: %s", new Object[] { str1 });
      c.lc(paramContext).aTU(str1);
      return true;
    }
    if (bool2) {
    ...
    for (paramString = new SharePatchInfo(((SharePatchInfo)localObject3).oldVersion, str1, bool1, false, Build.FINGERPRINT, paramString);; paramString = new SharePatchInfo("", str1, bool1, false, Build.FINGERPRINT, "odex"))
    {
      ...
      ShareTinkerLog.i("Tinker.UpgradePatch", "UpgradePatch tryPatch:patchVersionDirectory:%s", new Object[] { localObject3 });
      ...
      try
      {
        if (!str1.equals(SharePatchFileUtil.getMD5((File)localObject2)))
        {
          ...
          ShareTinkerLog.w("Tinker.UpgradePatch", "UpgradePatch copy patch file, src file: %s size: %d, dest file: %s size:%d", new Object[] { localFile1.getAbsolutePath(), Long.valueOf(localFile1.length()), ((File)localObject2).getAbsolutePath(), Long.valueOf(((File)localObject2).length()) });
        }
      ...
      {
        ShareTinkerLog.e("Tinker.UpgradePatch", "UpgradePatch tryPatch:copy patch file fail from %s to %s", new Object[] { localFile1.getPath(), ((File)localObject2).getPath() });
        locala.KqV.a(localFile1, (File)localObject2, localFile1.getName(), 1);
        return false;
      }
    ...
    if (!SharePatchInfo.rewritePatchInfoFileWithLock(localFile2, paramString, parama))
    {
      ...
      locala.KqV.b(localFile1, paramString.oldVersion, paramString.newVersion);
      return false;
    }
    c.lc(paramContext).aTU(str1);
