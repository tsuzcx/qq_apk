...
public class a
{
  ...
  public static boolean a(ApplicationLike paramApplicationLike, String paramString)
  {
    ...
    File localFile = SharePatchFileUtil.hX(paramApplicationLike.getApplication());
    if (localFile == null)
    {
      com.tencent.tinker.lib.f.a.e("Tinker.LoadLibrary", "failed to get current patch directory.", new Object[0]);
      return false;
    }
    localObject = new File(localFile.getAbsolutePath() + "/" + SharePatchFileUtil.agk((String)localObject));
