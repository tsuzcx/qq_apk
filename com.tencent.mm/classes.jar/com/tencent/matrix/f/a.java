...
{
  private static long[] cBc = new long[0];
  private static int cBd = 0;
  private a cBa;
  private List<List<d>> cBb;
  private long cBe;
  private long cBf;
  private long cBg;
  private int cBh;
  ...
  public static List<d> HN()
  {
    Object localObject = a(new c()new b
    {
      public final void a(a.e paramAnonymouse)
      {
        a.e locale = (a.e)this.cBk.get(paramAnonymouse.tid);
        if (locale != null)
        {
          paramAnonymouse.name = (locale.name.replaceAll("-?[0-9]\\d*", "?") + "J");
          paramAnonymouse.cBo = locale.cBo;
          paramAnonymouse.cBn = locale.cBn;
          paramAnonymouse.cBp = locale.cBp;
          paramAnonymouse.cBq = true;
          return;
        }
  ...
  public void onForeground(boolean paramBoolean)
  {
    ...
    {
      if (paramBoolean) {
        this.handler.postDelayed(this.cBa, this.cBe);
      }
    }
    else {
      return;
    }
    this.handler.postDelayed(this.cBa, this.cBf);
  }
  ...
  public void start()
  {
    ...
    com.tencent.matrix.trace.core.AppMethodBeat.sMethodEnterListener = new AppMethodBeat.b()
    {
      ...
      {
        if ((paramAnonymousLong < a.cBd) && (a.HO()[((int)paramAnonymousLong)] == 0L))
        {
          long l1 = Process.myTid();
          long l2 = paramAnonymousInt;
          a.HO()[((int)paramAnonymousLong)] = (l1 << 32 | l2);
        }
      }
    };
    com.tencent.matrix.g.b.Io().post(new Runnable()
    {
  ...
  public void stop()
  {
    ...
    this.handler.removeCallbacks(this.cBa);
    ...
    implements Runnable
  {
    ...
    {
      int i = a.HM();
      c.i("Matrix.ThreadMonitor", "[DumpThreadJiffiesTask] run...[%s] limit:%s", new Object[] { Integer.valueOf(i), Integer.valueOf(a.c(this.cBj)) });
      if (a.c(this.cBj) >= i) {
        return;
      }
      ...
      }, new a.b()
      {
        public final boolean b(a.e paramAnonymouse)
        {
          return a.d(a.a.this.cBj).b(paramAnonymouse);
        }
      });
      HashMap localHashMap = new HashMap();
      ...
      if ((this.cBj.isForeground()) && (l - a.e(this.cBj) > a.f(this.cBj)))
      {
        localObject1 = a.g(this.cBj).iterator();
        while (((Iterator)localObject1).hasNext())
        {
          localObject2 = (List)((Iterator)localObject1).next();
          a.a(this.cBj, (List)localObject2);
        }
        a.a(this.cBj, l);
        a.g(this.cBj).clear();
        localObject1 = a.b(this.cBj);
        if (!com.tencent.matrix.a.csS.csU) {
          break label399;
        }
      }
      label399:
      for (l = a.h(this.cBj);; l = a.i(this.cBj))
      {
        ((Handler)localObject1).postDelayed(this, l);
        return;
        if (a.g(this.cBj).size() >= 10) {
          a.g(this.cBj).remove(0);
        }
        a.g(this.cBj).add(localObject1);
        break;
      }
    }
  }
  ...
  public static final class e
  {
    ...
    public final String toString()
    {
      return String.format("name=%s tid=%s state=%s isHandlerThread=%s isJavaThread=%s", new Object[] { this.name, Long.valueOf(this.tid), this.state, Boolean.valueOf(this.cBn), Boolean.valueOf(this.cBq) });
    }
  }
}
