  ...
  extends BroadcastReceiver
{
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    Object localObject1 = x.getStringExtra(paramIntent, "strategy");
    c.i("Matrix.StrategyNotifyBroadcast", "receive MatrixStrategyNotifyBroadcast, process: %s, strategy:%s action:%s", new Object[] { ai.getProcessName(), localObject1, paramContext });
    ...
    if (paramContext.equals("statusNotify"))
    {
      ...
      if ((localObject1 == null) || (paramIntent == null))
      {
        ...
        for (bool1 = true;; bool1 = false)
        {
          ...
          ac.w("Matrix.StrategyNotifyBroadcast", "keys=%s values=%s", new Object[] { Boolean.valueOf(bool1), Boolean.valueOf(bool2) });
          return;
        }
      }
      if (((List)localObject1).size() != paramIntent.size())
      {
        ac.w("Matrix.StrategyNotifyBroadcast", "keys.size(%s) != values.size(%s)", new Object[] { Integer.valueOf(((List)localObject1).size()), Integer.valueOf(paramIntent.size()) });
        return;
      }
      int i = 0;
