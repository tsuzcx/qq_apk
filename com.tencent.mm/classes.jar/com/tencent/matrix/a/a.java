  ...
  extends com.tencent.matrix.e.b
{
  ...
  private com.tencent.matrix.a.b.c ctv;
  private boolean ctw;
  ...
  public final void init(Application paramApplication, com.tencent.matrix.e.c paramc)
  {
    ...
    this.ctv = new com.tencent.matrix.a.b.c(this);
  }
  ...
  public final void onForeground(boolean paramBoolean)
  {
    try
    {
      ...
      com.tencent.matrix.a.b.c localc = this.ctv;
      if (localc.cud != null) {
        localc.cud.ctF = paramBoolean;
      }
      return;
    }
    finally
  ...
  public final void start()
  {
    ...
    try
    {
      if ((isPluginStarted()) || (this.ctw)) {
        break label178;
      }
      super.start();
      com.tencent.matrix.a.b.c localc1 = this.ctv;
      localObject1 = localc1.cua;
      if (!((com.tencent.matrix.a.b.d)localObject1).started)
      {
        ((com.tencent.matrix.a.b.d)localObject1).cus = new Handler(com.tencent.matrix.g.b.Ip().getLooper());
        ((com.tencent.matrix.a.b.d)localObject1).started = true;
      }
      localObject1 = localc1.ctu;
      if (localObject1 == null) {
        throw new RuntimeException("batteryConfig is null");
      }
    }
    finally {}
    if (((com.tencent.matrix.a.a.a)localObject1).GN())
    {
      localc2.cuc = new f(localc2, (com.tencent.matrix.a.a.a)localObject1, new c.3(localc2));
      e.a(localc2);
    }
    if (((com.tencent.matrix.a.a.a)localObject1).cty.get(a.a.Ihx.name(), true))
    {
      localc2.cud = new com.tencent.matrix.a.b.a(localc2, localc2.ctu);
      localc2.cua.p(new c.4(localc2));
  ...
  public final void stop()
  {
    ...
    //   2: aload_0
    //   3: iconst_0
    //   4: putfield 89	com/tencent/matrix/a/a:ctw	Z
    //   7: aload_0
    ...
    //   18: aload_0
    //   19: getfield 47	com/tencent/matrix/a/a:ctv	Lcom/tencent/matrix/a/b/c;
    //   22: astore_1
    //   23: aload_1
    //   24: monitorenter
    //   25: aload_1
    ...
    //   40: aload_1
    //   41: getfield 95	com/tencent/matrix/a/b/c:cua	Lcom/tencent/matrix/a/b/d;
    //   44: astore_2
    //   45: aload_2
    //   46: getfield 100	com/tencent/matrix/a/b/d:started	Z
    //   49: ifeq +16 -> 65
    //   52: aload_2
    //   53: getfield 121	com/tencent/matrix/a/b/d:cus	Landroid/os/Handler;
    //   56: aconst_null
    ...
    //   65: aload_1
    //   66: aconst_null
    //   67: putfield 148	com/tencent/matrix/a/b/c:cuc	Lcom/tencent/matrix/a/b/f;
    //   70: aload_0
    //   71: monitorexit
    //   72: return
    //   73: astore_2
