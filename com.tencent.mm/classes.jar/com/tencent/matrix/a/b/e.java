...
public final class e
{
  ...
  private static j.b cXm = new j.b()
  {
    ...
    public final void b(Method paramAnonymousMethod, Object[] paramAnonymousArrayOfObject)
    {
      ...
      for (;;)
      {
        ...
        catch (Throwable paramAnonymousMethod)
        {
          l1 = l2;
  ...
  private static j cXn = new j("location", "android.location.ILocationManager", cXm);
  ...
  public static void a(a parama)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        c.i("Matrix.battery.LocationHooker", "checkHook hookRet:%b", new Object[] { Boolean.valueOf(cXn.doHook()) });
        cXl = true;
      }
      finally {}
    }
  ...
  public static void b(a parama)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        c.i("Matrix.battery.LocationHooker", "checkUnHook unHookRet:%b", new Object[] { Boolean.valueOf(cXn.doUnHook()) });
        cXl = false;
      }
      finally {}
    }
