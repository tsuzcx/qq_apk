...
{
  public final com.tencent.matrix.a.a.a ctu;
  public final d cua;
  private final com.tencent.matrix.a.a cub;
  public f cuc;
  public a cud = null;
  ...
  public final void a(final int paramInt1, final long paramLong1, long paramLong2, final long paramLong3, int paramInt2, final PendingIntent paramPendingIntent, AlarmManager.OnAlarmListener paramOnAlarmListener)
  {
    ...
    paramPendingIntent = new Runnable()
    {
      public final void run()
      {
        ...
        int m = this.cue;
        Object localObject = this.cuq;
        AlarmManager.OnAlarmListener localOnAlarmListener = this.cur;
        String str1 = this.cuj;
        if (locala.ctF)
        {
        ...
        for (int j = -1;; j = localOnAlarmListener.hashCode())
        {
          ...
          locala.a(((a.a)localObject).ctJ, ((a.a)localObject).ctI);
          locala.ctD.add(localObject);
          locala.GQ();
          return;
  ...
  public final void a(final IBinder paramIBinder, final int paramInt)
  {
    ...
    paramIBinder = new Runnable()
    {
      public final void run()
      {
        ...
        if (localf.cuC != null)
        {
          localObject2 = localf.cuC;
          String str1 = localObject1.toString();
          String str2 = com.tencent.matrix.g.d.formatTime("yyyy-MM-dd HH:mm", l);
          ((f.e)localObject2).cuS.append(str2).append(" onReleaseWakeLock token:").append(str1).append(" flags:").append(j).append("\n\n");
          ((f.e)localObject2).cuR += 1;
          ((f.e)localObject2).GX();
        }
        localObject1 = localObject1.toString();
        if (localf.cuv.containsKey(localObject1))
        {
          localObject2 = ((f.d)localf.cuv.get(localObject1)).tag;
          if (localf.cuw.containsKey(localObject2))
          {
            localObject2 = (f.c)localf.cuw.get(localObject2);
            ((f.c)localObject2).GW();
            ((f.c)localObject2).cuL.remove(localObject1);
            if (((f.c)localObject2).cuL.isEmpty()) {
              break label261;
            }
            if (i == 0) {
              ((f.c)localObject2).cuM = -1L;
            }
          }
        }
        for (;;)
        {
          localf.GT();
          localf.cuv.remove(localObject1);
          return;
          label261:
          i = 0;
          break;
    ...
    paramIBinder = new Runnable()
    {
      public final void run()
      {
        ...
        if (localf.cuC != null)
        {
          ...
          ((f.e)localObject2).cuS.append(str4).append(" onAcquireWakeLock token:").append(str3).append(" flags:").append(i).append(" tag:").append(str2).append('\n').append(str1).append('\n');
          ((f.e)localObject2).cuR += 1;
          ((f.e)localObject2).GX();
        }
        Object localObject2 = localObject1.toString();
        if (!localf.cuv.containsKey(localObject2))
        {
          localObject1 = new f.d((String)localObject2, str2, i, l);
          localf.cuv.put(localObject2, localObject1);
        }
        for (;;)
        {
          ((f.d)localObject1).cuK.cU(str1);
          if (!localf.cuw.containsKey(str2)) {
            localf.cuw.put(str2, new f.c(str2));
          }
          localObject1 = (f.c)localf.cuw.get(str2);
          boolean bool = localf.cuA.isScreenOn();
          ((f.c)localObject1).cuN = bool;
          ((f.c)localObject1).cuI += 1;
          if (!bool) {
            ((f.c)localObject1).cuJ += 1;
          }
          ((f.c)localObject1).cuL.put(localObject2, Boolean.TRUE);
          if (((f.c)localObject1).cuM < 0L) {
            ((f.c)localObject1).cuM = SystemClock.uptimeMillis();
          }
          ((f.c)localObject1).cuK.cU(str1);
          localf.cuA.d(localf.cuB, localf.cux);
          return;
          localObject1 = (f.d)localf.cuv.get(localObject2);
        }
      }
    };
    this.cua.p(paramIBinder);
