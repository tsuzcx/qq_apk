...
{
  private static final a cKF = new a();
  ...
  private void Jh()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!cKG)
        {
          localPrinter = (Printer)f.a(this.cKD.getClass(), "mLogging", this.cKD);
      ...
      catch (Exception localException2)
      {
        ...
        cKG = true;
        if (this.cKC != null) {
          c.w("Matrix.LooperMonitor", "maybe thread:%s printer[%s] was replace other[%s]!", new Object[] { this.cKD.getThread().getName(), this.cKC, localObject1 });
        }
        localLooper = this.cKD;
        localb = new b(localObject1);
        this.cKC = localb;
        localLooper.setMessageLogging(localb);
        if (localObject1 != null) {
          c.i("Matrix.LooperMonitor", "reset printer, originPrinter[%s] in %s", new Object[] { localObject1, this.cKD.getThread().getName() });
        }
      }
      finally {}
    }
  ...
  public final void onRelease()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 83	com/tencent/matrix/trace/core/a:cKC	Lcom/tencent/matrix/trace/core/a$b;
    //   6: ifnull +85 -> 91
    //   9: aload_0
    ...
    //   34: iconst_0
    //   35: aload_0
    //   36: getfield 60	com/tencent/matrix/trace/core/a:cKD	Landroid/os/Looper;
    ...
    //   47: iconst_1
    //   48: aload_0
    //   49: getfield 83	com/tencent/matrix/trace/core/a:cKC	Lcom/tencent/matrix/trace/core/a$b;
    //   52: getfield 182	com/tencent/matrix/trace/core/a$b:cKI	Landroid/util/Printer;
    //   55: aastore
    //   56: invokestatic 185	com/tencent/matrix/g/c:v	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   59: aload_0
    //   60: getfield 60	com/tencent/matrix/trace/core/a:cKD	Landroid/os/Looper;
    //   63: aload_0
    //   64: getfield 83	com/tencent/matrix/trace/core/a:cKC	Lcom/tencent/matrix/trace/core/a$b;
    //   67: getfield 182	com/tencent/matrix/trace/core/a$b:cKI	Landroid/util/Printer;
    //   70: invokevirtual 110	android/os/Looper:setMessageLogging	(Landroid/util/Printer;)V
    //   73: aload_0
    //   74: aload_0
    //   75: getfield 60	com/tencent/matrix/trace/core/a:cKD	Landroid/os/Looper;
    //   78: invokespecial 187	com/tencent/matrix/trace/core/a:b	(Landroid/os/Looper;)V
    //   81: aload_0
    //   82: aconst_null
    //   83: putfield 60	com/tencent/matrix/trace/core/a:cKD	Landroid/os/Looper;
    //   86: aload_0
    //   87: aconst_null
    //   88: putfield 83	com/tencent/matrix/trace/core/a:cKC	Lcom/tencent/matrix/trace/core/a$b;
    //   91: aload_0
    //   92: monitorexit
    //   93: return
    //   94: astore_2
  ...
  {
    if (SystemClock.uptimeMillis() - this.cKE >= 60000L)
    {
      Jh();
      this.cKE = SystemClock.uptimeMillis();
    }
    return true;
  }
