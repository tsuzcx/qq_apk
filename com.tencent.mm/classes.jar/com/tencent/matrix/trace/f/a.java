...
public final class a
  extends f
{
  private final com.tencent.matrix.trace.a.b cyA;
  private Handler czV;
  private volatile a czW;
  private boolean czX;
  ...
  public final void a(long paramLong1, long paramLong2, long paramLong3, long paramLong4, long paramLong5, boolean paramBoolean)
  {
    ...
    if (this.czW != null)
    {
      this.czW.czY.release();
      this.czV.removeCallbacks(this.czW);
    }
  }
  ...
  public final void d(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    this.czW = new a(AppMethodBeat.getInstance().maskIndex("AnrTracer#dispatchBegin"), paramLong3);
    if (this.cyA.cyM) {
      com.tencent.matrix.g.c.v("Matrix.AnrTracer", "* [dispatchBegin] token:%s index:%s", new Object[] { Long.valueOf(paramLong3), Integer.valueOf(this.czW.czY.index) });
    }
    this.czV.postDelayed(this.czW, 5000L - (System.nanoTime() - paramLong3) / 1000000L);
  }
  ...
  public final void onAlive()
  {
    ...
    if (this.czX)
    {
      ...
      this.czV = new Handler(com.tencent.matrix.g.b.HZ().getLooper());
    }
  }
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      boolean bool = com.tencent.matrix.a.cqa.cqc;
      Object localObject2 = com.tencent.matrix.trace.g.b.gX(Process.myPid());
      Object localObject5 = AppMethodBeat.getInstance().copyData(this.czY);
      this.czY.release();
      ...
      localObject1[2] = com.tencent.matrix.g.a.HW();
      ...
      Object localObject6 = com.tencent.matrix.trace.core.b.HF();
      long l2 = ((com.tencent.matrix.trace.core.b)localObject6).s(0, this.czj);
      long l3 = ((com.tencent.matrix.trace.core.b)localObject6).s(1, this.czj);
      long l4 = ((com.tencent.matrix.trace.core.b)localObject6).s(2, this.czj);
      ...
      if (l6 > 0L)
      {
        ...
        com.tencent.matrix.g.c.w("Matrix.AnrTracer", "%s \npostTime:%s curTime:%s", new Object[] { ((StringBuilder)localObject7).toString(), Long.valueOf(this.czj / 1000000L), Long.valueOf(l1) });
        if (l5 < 6000L) {
          break label661;
        }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          {
            localObject4 = com.tencent.matrix.g.a.a(new JSONObject(), com.tencent.matrix.b.Gq().application);
            ((JSONObject)localObject4).put("detail", com.tencent.matrix.trace.b.a.a.cyS);
            ...
            ((com.tencent.matrix.report.c)localObject1).key = this.czj;
            ((com.tencent.matrix.report.c)localObject1).tag = "Trace_EvilMethod";
            ((com.tencent.matrix.report.c)localObject1).cue = ((JSONObject)localObject4);
