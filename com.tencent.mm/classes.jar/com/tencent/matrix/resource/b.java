...
{
  public final com.tencent.matrix.resource.b.a cWP;
  ...
  public void init(Application paramApplication, com.tencent.matrix.e.c paramc)
  {
    ...
    this.cWQ = new com.tencent.matrix.resource.e.b(paramApplication, this);
  }
  ...
  public void start()
  {
    ...
    do
    {
      ...
      localb = this.cWQ;
      localb.Tf();
      localApplication = localb.cZD.getApplication();
    } while (localApplication == null);
    localApplication.registerActivityLifecycleCallbacks(localb.cZN);
    com.tencent.matrix.a.cPA.a(localb);
    localb.cZE.a(localb.cZO, 0);
