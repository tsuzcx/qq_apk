...
{
  public final AtomicReference<T> cAr = new AtomicReference();
  public final CountDownLatch cAs = new CountDownLatch(1);
  
  public final boolean a(TimeUnit paramTimeUnit)
  {
    try
    {
      boolean bool = this.cAs.await(5L, paramTimeUnit);
      return bool;
    }
