...
public final class c
{
  ...
  public final File HG()
  {
    File localFile = this.cAy.HH();
    if (localFile == null)
    {
    ...
    this.mMainHandler.post(new Runnable()
    {
      public final void run()
      {
        ...
        Looper.myQueue().addIdleHandler(new MessageQueue.IdleHandler()
        {
          ...
          {
            a locala = c.1.this.cAH;
            Toast localToast = localToast;
            locala.cAr.set(localToast);
            locala.cAs.countDown();
            return false;
          }
        });
      }
    ...
    try
    {
      ...
      if (((a)localObject).cAs.getCount() > 0L) {
    ...
    final Toast localToast = (Toast)localException.cAr.get();
    this.mMainHandler.post(new Runnable()
    {
      public final void run()
      {
