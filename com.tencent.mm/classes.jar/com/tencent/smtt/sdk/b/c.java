...
public class c
{
  ...
  public static int a(Context paramContext, String paramString, HashMap<String, String> paramHashMap, WebView paramWebView)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramString.adn(), "com/tencent/smtt/sdk/b/c", "a", "(Landroid/content/Context;Ljava/lang/String;Ljava/util/HashMap;Lcom/tencent/smtt/sdk/WebView;)I", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
  ...
  public static int a(Context paramContext, String paramString1, HashMap<String, String> paramHashMap, String paramString2, WebView paramWebView)
  {
    ...
    if (i != 0)
    {
      ...
      localStringBuilder.append("mttbrowser://url=").append(paramString1).append(",product=TBS,packagename=").append(paramContext.getPackageName()).append(",from=").append(paramString2).append(",version=4.4.0.0005").append((String)localObject);
  ...
  public static boolean a(Context paramContext, String paramString1, int paramInt, String paramString2, HashMap<String, String> paramHashMap, Bundle paramBundle)
  {
    ...
    com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramString1.adn(), "com/tencent/smtt/sdk/b/c", "a", "(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;Ljava/util/HashMap;Landroid/os/Bundle;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
  ...
  public static boolean a(Context paramContext, String paramString, HashMap<String, String> paramHashMap)
  {
    ...
    try
    {
      ...
      paramHashMap = new com.tencent.mm.hellhoundlib.b.a().bd(paramString);
      com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramHashMap.adn(), "com/tencent/smtt/sdk/b/c", "a", "(Landroid/content/Context;Ljava/lang/String;Ljava/util/HashMap;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
      paramContext.startActivity((Intent)paramHashMap.lS(0));
    ...
    catch (Throwable paramHashMap)
    {
      for (;;)
      {
        try
        {
          ...
          paramString = new com.tencent.mm.hellhoundlib.b.a().bd(paramString);
          com.tencent.mm.hellhoundlib.a.a.a(paramContext, paramString.adn(), "com/tencent/smtt/sdk/b/c", "a", "(Landroid/content/Context;Ljava/lang/String;Ljava/util/HashMap;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
          paramContext.startActivity((Intent)paramString.lS(0));
          com.tencent.mm.hellhoundlib.a.a.a(paramContext, "com/tencent/smtt/sdk/b/c", "a", "(Landroid/content/Context;Ljava/lang/String;Ljava/util/HashMap;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
