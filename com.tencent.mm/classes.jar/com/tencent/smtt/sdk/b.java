  ...
  public void onDownloadStart(String paramString1, String paramString2, byte[] paramArrayOfByte, String paramString3, String paramString4, String paramString5, long paramLong, String paramString6, String paramString7)
  {
    ...
    if (this.a == null)
    {
      if (QbSdk.canOpenMimeFileType(this.b.getContext(), paramString5))
      {
        ...
        com.tencent.mm.hellhoundlib.a.a.a(paramString1, paramString2.adn(), "com/tencent/smtt/sdk/b", "onDownloadStart", "(Ljava/lang/String;Ljava/lang/String;[BLjava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;Ljava/lang/String;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
