  ...
  implements f
{
  ...
  public static int J(List<Integer> paramList, int paramInt)
  {
  ...
  private void hkY()
  {
    ...
    try
    {
      ...
      List localList = this.gII.getParameters().getSupportedFocusModes();
      if (localList == null) {
        break label188;
      }
  ...
  private Point o(Point paramPoint)
  {
    ...
    int j = (this.ROh.x - this.sRG.x) / 2;
    int i = (this.ROh.y - this.sRG.y) / 2;
    Point localPoint1 = new Point(paramPoint.x + j, paramPoint.y + i);
    if (this.sRH)
    {
      j = (this.ROh.y - this.sRG.x) / 2;
      i = (this.ROh.x - this.sRG.y) / 2;
      localPoint1 = new Point(paramPoint.y + i, this.sRG.x - paramPoint.x + j);
    }
    Log.d("BaseScanCamera", String.format("dx %d, dy %d", new Object[] { Integer.valueOf(j), Integer.valueOf(i) }));
    Point localPoint2 = new Point((int)(localPoint1.x / this.ROi), (int)(localPoint1.y / this.ROi));
  ...
  private Point r(Point paramPoint)
  {
    ...
    float f2;
    if (this.sRH) {
      f2 = this.sRG.x * 1.0F / paramPoint.y;
    }
    for (float f1 = this.sRG.y * 1.0F / paramPoint.x;; f1 = this.sRG.y * 1.0F / paramPoint.y)
    {
      this.ROi = Math.max(f2, f1);
      paramPoint = new Point((int)(paramPoint.x * this.ROi), (int)(paramPoint.y * this.ROi));
      AppMethodBeat.o(3519);
      return paramPoint;
      f2 = this.sRG.x * 1.0F / paramPoint.x;
    }
  }
  ...
  public final void a(Camera.PreviewCallback paramPreviewCallback)
  {
    ...
    if (this.gII != null) {
      try
      {
        this.gII.setOneShotPreviewCallback(paramPreviewCallback);
  ...
  public final void aqD(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (localObject1 = e.hla();; localObject1 = d.mu(i, paramInt))
      {
      ...
      this.ztW = false;
      this.ROj = -1;
      this.sRI = ((g.a.a)localObject1).dYT;
      if (((g.a.a)localObject1).dYT % 180 != 0) {}
      for (boolean bool = true;; bool = false)
      {
        this.sRH = bool;
        Log.d("BaseScanCamera", String.format("openCamera done, cameraId=[%s] costTime=[%s] rotation[%d]", new Object[] { Integer.valueOf(i), Long.valueOf(System.currentTimeMillis() - l), Integer.valueOf(this.sRI) }));
        this.gII = ((g.a.a)localObject1).gII;
        if (this.gII != null) {
          break;
        }
      ...
      this.VC = true;
      localObject1 = this.gII.getParameters();
      for (;;)
      {
        try
        {
        ...
        catch (Exception localException2)
        {
          ...
          this.mMaxZoom = J(localException2, 400);
          continue;
          paramInt = j;
        ...
        this.gII.setParameters((Camera.Parameters)localObject1);
        try
        {
          hkY();
          AppMethodBeat.o(3513);
        ...
        if ((localObject2 != null) && (((List)localObject2).size() > 0))
        {
          ...
          Log.i("BaseScanCamera", String.format("default zoom:%d,default ratio:%d,max zoom:%d,max ratio:%d", new Object[] { Integer.valueOf(this.ROl), ((List)localObject2).get(this.ROl), Integer.valueOf(this.mMaxZoom), ((List)localObject2).get(this.mMaxZoom) }));
        }
      }
      i = 0;
    }
  ...
  public final void aqE(int paramInt)
  {
    ...
    if ((this.gII != null) && (this.sRE) && (paramInt > 0)) {
      try
      {
        Camera.Parameters localParameters = this.gII.getParameters();
        ...
        if ((paramInt >= ((Integer)localList.get(this.ROl)).intValue()) && (paramInt <= ((Integer)localList.get(this.mMaxZoom)).intValue())) {
          paramInt = J(localList, paramInt);
        }
        for (;;)
        {
          ...
          AppMethodBeat.o(3522);
          return;
          if (paramInt < ((Integer)localList.get(this.ROl)).intValue())
          {
            paramInt = this.ROl;
          }
          else
          {
            ...
            i = this.ROk + (this.mMaxZoom - this.ROk) / 5;
            paramInt = i;
            if (i > this.mMaxZoom) {
  ...
  public final void aqF(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
        case 0: 
          localParameters.setZoom(this.ROk);
          this.gII.setParameters(localParameters);
      ...
      if (this.ROk < this.mMaxZoom)
      {
        this.ROk += 1;
        if (this.ROk > this.mMaxZoom) {}
        for (i = this.mMaxZoom;; i = this.ROk)
        {
          this.ROk = i;
          break;
        }
  ...
  public final String getFocusMode()
  {
    ...
    try
    {
      if (this.gII != null)
      {
        String str = this.gII.getParameters().getFocusMode();
  ...
  public final int hkX()
  {
    ...
    {
      int i = ((Integer)this.gII.getParameters().getZoomRatios().get(this.ROk)).intValue();
  ...
  public final void p(Point paramPoint)
  {
    AppMethodBeat.i(3517);
    this.sRG = new Point(paramPoint);
  ...
  public final void r(SurfaceTexture paramSurfaceTexture)
  {
    ...
    if ((this.gII != null) && (!this.sRE))
    {
      ...
      paramSurfaceTexture = this.gII.getParameters();
      paramSurfaceTexture.setPreviewSize(this.sRF.x, this.sRF.y);
      this.gII.setParameters(paramSurfaceTexture);
  ...
  public final Rect w(Rect paramRect)
  {
    ...
    Log.i("BaseScanCamera", String.format("visibleResolution:%s, previewResolution:%s", new Object[] { this.sRG, this.ROh }));
    Point localPoint2;
    if (this.sRH)
    {
      localPoint1 = new Point(paramRect.right, paramRect.top);
      localPoint2 = o(localPoint1);
      if (!this.sRH) {
        break label174;
      }
    }
