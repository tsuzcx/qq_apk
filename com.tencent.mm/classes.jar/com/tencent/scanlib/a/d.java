...
final class d
  implements g.a
{
  public static g.a.a km(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      locala.fDV = Camera.open(paramInt1);
    ...
    for (paramInt1 = (360 - localCameraInfo.orientation % 360) % 360;; paramInt1 = (localCameraInfo.orientation - paramInt1 + 360) % 360)
    {
      ...
      localException.fDV.setDisplayOrientation(paramInt1);
