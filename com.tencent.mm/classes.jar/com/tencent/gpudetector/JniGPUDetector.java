...
public final class JniGPUDetector
{
  ...
  static
  {
    ...
    gpuDetailList = ae.c(new o[] { u.S(Integer.valueOf(-1), "GpuDeviceArchUnknown"), u.S(Integer.valueOf(0), "GpuDeviceArchAMDGeneric"), u.S(Integer.valueOf(1), "GpuDeviceArchAppleGeneric"), u.S(Integer.valueOf(2), "GpuDeviceArchAppleA"), u.S(Integer.valueOf(3), "GpuDeviceArchARMGeneric"), u.S(Integer.valueOf(4), "GpuDeviceArchMaliMidgardT"), u.S(Integer.valueOf(5), "GpuDeviceArchMaliBifrostG"), u.S(Integer.valueOf(6), "GpuDeviceArchMaliValhallG"), u.S(Integer.valueOf(7), "GpuDeviceArchImaginationGeneric"), u.S(Integer.valueOf(8), "GpuDeviceArchPowerVRSGX"), u.S(Integer.valueOf(9), "GpuDeviceArchPowerVRRogueGeneric"), u.S(Integer.valueOf(10), "GpuDeviceArchPowerVRRogueG"), u.S(Integer.valueOf(11), "GpuDeviceArchPowerVRRogueGX"), u.S(Integer.valueOf(12), "GpuDeviceArchPowerVRRogueGT"), u.S(Integer.valueOf(13), "GpuDeviceArchPowerVRRogueGE"), u.S(Integer.valueOf(14), "GpuDeviceArchPowerVRRogueGM"), u.S(Integer.valueOf(15), "GpuDeviceArchPowerVRFurianBegin"), u.S(Integer.valueOf(16), "GpuDeviceArchPowerVRFurianGT"), u.S(Integer.valueOf(17), "GpuDeviceArchImgAlbiorixGeneric"), u.S(Integer.valueOf(18), "GpuDeviceArchImgAlbiorixAXE"), u.S(Integer.valueOf(19), "GpuDeviceArchImgAlbiorixAXM"), u.S(Integer.valueOf(20), "GpuDeviceArchImgAlbiorixAXT"), u.S(Integer.valueOf(21), "GpuDeviceArchIntelGeneric"), u.S(Integer.valueOf(22), "GpuDeviceArchNVIDIAGeneric"), u.S(Integer.valueOf(23), "GpuDeviceArchQualcommGeneric"), u.S(Integer.valueOf(24), "GpuDeviceArchAdreno3XX"), u.S(Integer.valueOf(25), "GpuDeviceArchAdreno4XX"), u.S(Integer.valueOf(26), "GpuDeviceArchAdreno5XX"), u.S(Integer.valueOf(27), "GpuDeviceArchAdreno6XX") });
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"Lcom/tencent/gpudetector/JniGPUDetector$Companion;", "", "()V", "gpuDetailList", "Ljava/util/HashMap;", "", "", "Lkotlin/collections/HashMap;", "getGpuDetailList", "()Ljava/util/HashMap;", "getArchNameDetail", "arch", "showGpuDeviceModel", "gpudetector_release"})
