...
public class y
{
  ...
  private static HashMap<String, x> i;
  ...
  public static List<p> a(String paramString)
  {
    ...
    //   109: invokestatic 244	com/tencent/map/tools/internal/y:a	(I)Z
    //   112: ifeq +81 -> 193
    //   115: aload 6
    ...
    //   198: invokestatic 244	com/tencent/map/tools/internal/y:a	(I)Z
    //   201: ifne -45 -> 156
    //   204: aload 6
  ...
  {
    return (paramInt >= 2) && (paramInt <= u.F.length - 1);
  }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      if (paramBoolean2) {
        paramString1 = a(q.b(paramContext, "dwMmNhTC43xDnMGp"));
      }
      if (paramString1 != null)
      {
        new x(paramString2).a(paramString1);
        AppMethodBeat.o(180900);
        return true;
      }
      AppMethodBeat.o(180900);
  ...
  public static byte[] a(byte[] paramArrayOfByte)
  {
    ...
    //   24: aconst_null
    //   25: areturn
    //   26: new 393	java/io/ByteArrayOutputStream
    //   29: dup
    //   30: invokespecial 394	java/io/ByteArrayOutputStream:<init>	()V
    //   33: astore_2
    //   34: new 396	java/io/ByteArrayInputStream
    //   37: dup
    //   38: aload_0
    //   39: invokespecial 399	java/io/ByteArrayInputStream:<init>	([B)V
    //   42: astore_3
    //   43: new 401	java/util/zip/GZIPInputStream
    //   46: dup
    //   47: aload_3
    //   48: invokespecial 404	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   51: astore_0
    //   52: ldc_w 405
    //   55: newarray byte
    //   57: astore 4
    //   59: aload_0
    //   60: aload 4
    //   62: invokevirtual 408	java/util/zip/GZIPInputStream:read	([B)I
    //   65: istore_1
    //   66: iload_1
    //   67: iflt +57 -> 124
    //   70: aload_2
    ...
    //   73: iconst_0
    //   74: iload_1
    //   75: invokevirtual 411	java/io/ByteArrayOutputStream:write	([BII)V
    //   78: goto -19 -> 59
    //   81: astore 4
    //   83: aload_0
    //   84: ifnull +7 -> 91
    //   87: aload_0
    //   88: invokevirtual 412	java/util/zip/GZIPInputStream:close	()V
    //   91: aload_3
    //   92: ifnull +7 -> 99
    //   95: aload_3
    //   96: invokevirtual 413	java/io/ByteArrayInputStream:close	()V
    //   99: aload 5
    //   101: astore 4
    //   103: aload_2
    //   104: ifnull +11 -> 115
    //   107: aload_2
    //   108: invokevirtual 414	java/io/ByteArrayOutputStream:close	()V
    //   111: aload 5
    //   113: astore 4
    //   115: ldc_w 391
    ...
    //   123: areturn
    //   124: aload_2
    //   125: invokevirtual 417	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   128: astore 4
    //   130: aload_0
    //   131: invokevirtual 412	java/util/zip/GZIPInputStream:close	()V
    //   134: aload_3
    //   135: invokevirtual 413	java/io/ByteArrayInputStream:close	()V
    //   138: aload_2
    //   139: invokevirtual 414	java/io/ByteArrayOutputStream:close	()V
    //   142: goto -27 -> 115
    //   145: astore_0
    //   146: goto -31 -> 115
    //   149: astore_0
    ...
    //   157: ifnull +7 -> 164
    //   160: aload_0
    //   161: invokevirtual 412	java/util/zip/GZIPInputStream:close	()V
    //   164: aload_3
    //   165: ifnull +7 -> 172
    //   168: aload_3
    //   169: invokevirtual 413	java/io/ByteArrayInputStream:close	()V
    //   172: aload 5
    //   174: astore 4
    //   176: aload_2
    //   177: ifnull -62 -> 115
    //   180: aload_2
    //   181: invokevirtual 414	java/io/ByteArrayOutputStream:close	()V
    //   184: aload 5
    //   186: astore 4
    //   188: goto -73 -> 115
    //   191: astore_0
    ...
    //   208: ifnull +7 -> 215
    //   211: aload_2
    //   212: invokevirtual 412	java/util/zip/GZIPInputStream:close	()V
    //   215: aload_3
    //   216: ifnull +7 -> 223
    //   219: aload_3
    //   220: invokevirtual 413	java/io/ByteArrayInputStream:close	()V
    //   223: aload 4
    //   225: ifnull +8 -> 233
    //   228: aload 4
    //   230: invokevirtual 414	java/io/ByteArrayOutputStream:close	()V
    //   233: ldc_w 391
  ...
  private static byte[] b(String paramString)
  {
    ...
    //   6: new 393	java/io/ByteArrayOutputStream
    //   9: dup
    //   10: invokespecial 394	java/io/ByteArrayOutputStream:<init>	()V
    //   13: astore 4
    //   15: new 210	java/io/FileInputStream
    //   18: dup
    //   19: aload_0
    //   20: invokespecial 506	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   23: astore_2
    //   24: aload_2
    //   25: astore_0
    //   26: sipush 10240
    ...
    //   34: aload_2
    //   35: aload_3
    //   36: invokevirtual 507	java/io/FileInputStream:read	([B)I
    //   39: istore_1
    //   40: iload_1
    //   41: iconst_m1
    //   42: if_icmpeq +47 -> 89
    ...
    //   50: iconst_0
    //   51: iload_1
    //   52: invokevirtual 411	java/io/ByteArrayOutputStream:write	([BII)V
    //   55: goto -23 -> 32
    //   58: astore_0
    //   59: aload_2
    //   60: astore_0
    ...
    //   66: astore_0
    //   67: aload 4
    //   69: invokevirtual 414	java/io/ByteArrayOutputStream:close	()V
    //   72: aload_2
    ...
    //   90: astore_0
    //   91: aload 4
    //   93: invokevirtual 414	java/io/ByteArrayOutputStream:close	()V
    //   96: aload_2
    //   97: astore_0
    //   98: aload_2
    ...
    //   103: astore_0
    //   104: aload 4
    //   106: invokevirtual 417	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   109: astore_3
    //   110: aload_2
    //   111: invokevirtual 224	java/io/FileInputStream:close	()V
    //   114: aload 4
    //   116: invokevirtual 414	java/io/ByteArrayOutputStream:close	()V
    //   119: ldc_w 505
  ...
  public static String c(Context paramContext)
  {
    ...
    try
    {
      ...
      {
        z.d = g(paramContext);
        if (z.c.equals("01234567890ABCDEF")) {}
      }
      for (z.d = z.c;; z.d = localTelephonyManager.getImei())
      {
        paramContext = z.d;
    ...
    catch (Throwable paramContext)
    {
      for (;;)
      {
        ...
        z.d = "01234567890ABCDEF";
        continue;
        z.d = localTelephonyManager.getDeviceId();
      }
    }
  }
  ...
  public static int d(Context paramContext)
  {
    ...
    Object localObject = b(paramContext, u.A, "default");
  ...
  private static x d(Context paramContext, String paramString)
  {
    AppMethodBeat.i(180874);
    if (i.containsKey(paramString))
    {
      paramContext = (x)i.get(paramString);
      AppMethodBeat.o(180874);
      return paramContext;
    }
    paramContext = new x(paramContext.getFilesDir().getAbsolutePath() + "/" + u.D + "/" + paramString);
  ...
  public static void e(Context paramContext)
  {
    ...
    Object localObject1 = b(paramContext, u.A, "default");
    if (((String)localObject1).equals("default"))
    {
      localObject1 = i1 + "&" + str + "#";
      a(paramContext, u.A, (String)localObject1);
      AppMethodBeat.o(180892);
      return;
    }
    for (;;)
 ...
 * Qualified Name:     com.tencent.map.tools.internal.y
