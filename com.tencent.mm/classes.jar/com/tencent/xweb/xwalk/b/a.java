...
public final class a
{
  ...
  private static void a(com.tencent.xweb.internal.a.b paramb, Element paramElement)
  {
    ...
    paramb.aadU = a(paramElement, "apkMin");
    paramb.aadV = a(paramElement, "apkMax");
    paramb.aadW = a(paramElement, "preDownApkMin");
    paramb.aadX = a(paramElement, "preDownApkMax");
    paramb.aadS = a(paramElement, "sdkMin");
    paramb.aadT = a(paramElement, "sdkMax");
    paramb.aadY = a(paramElement, "apiMin");
    paramb.aadZ = a(paramElement, "apiMax");
    paramb.aaea = a(paramElement, "targetApiMin");
    paramb.aaeb = a(paramElement, "targetApiMax");
    paramb.aaec = paramElement.getAttribute("forbidDeviceRegex");
    paramb.aaed = paramElement.getAttribute("whiteDeviceRegex");
    paramb.aaen = paramElement.getAttribute("forbidAppRegex");
    paramb.aaeo = paramElement.getAttribute("whiteAppRegex");
    paramb.aaee = a(paramElement, "grayMin");
    paramb.aaef = a(paramElement, "grayMax");
    paramb.aaeg = a(paramElement, "dayGrayMin");
    paramb.aaeh = a(paramElement, "dayGrayMax");
    paramb.aaei = a(paramElement, "chromeMin");
    paramb.aaej = a(paramElement, "chromeMax");
    paramb.aaek = a(paramElement, "usertype");
    paramb.aaep = a(paramElement, "x5sdkmin");
    paramb.aaeq = a(paramElement, "x5sdkmax");
    paramb.aaer = a(paramElement, "x5coremin");
    paramb.aaes = a(paramElement, "x5coremax");
    paramb.aael = c(paramElement, "hoursStart");
    paramb.aaem = c(paramElement, "hoursEnd");
    paramb.aaeu = paramElement.getAttribute("runtimeAbis");
    paramb.aaew = paramElement.getAttribute("blackRuntimeAbis");
    paramb.aaet = paramElement.getAttribute("deviceAbis");
    paramb.aaev = paramElement.getAttribute("blackDeviceAbis");
    paramb.aaex = b(paramElement, "appClientVerMin");
    paramb.aaey = b(paramElement, "appClientVerMax");
    paramb.aaez = paramElement.getAttribute("appInfoWhiteList");
    paramb.aaeA = paramElement.getAttribute("appInfoBlackList");
  ...
  private static c[] a(Element paramElement)
  {
    ...
    if ((paramElement != null) && (paramElement.getLength() != 0))
    {
      ...
      while (i < paramElement.getLength())
      {
        ...
        localc.aako = localElement.getAttribute("url");
        localc.aakE = a(localElement, "targetVersion");
        localc.aakv = localElement.getAttribute("md5");
        localc.aakw = e(localElement, "useCellular");
        localc.aajx = e(localElement, "useCdn");
        arrayOfc[i] = localc;
        i += 1;
      }
    ...
    try
    {
      ...
      if ((paramElement != null) && (paramElement.getLength() != 0))
      {
        ...
        while (i < paramElement.getLength())
        {
          ...
          Element localElement = (Element)paramElement.item(i);
          locala.aadP = localElement.getAttribute("optype");
          locala.aadQ = localElement.getAttribute("opvalue");
          locala.aadR = localElement.getAttribute("module");
          a(locala.aadO, localElement);
          arrayOfa[i] = locala;
          i += 1;
        }
        AppMethodBeat.o(154542);
  ...
  public static b bFT(String paramString)
  {
    ...
    paramString = l(paramString, a(paramString, (int)paramString.length(), "<Versions>"));
    AppMethodBeat.o(154536);
    return paramString;
  }
  ...
  /* Error */
  private static b l(File paramFile, String paramString)
  {
    // Byte code:
    //   0: ldc_w 488
    ...
    //   21: aload 4
    //   23: astore_0
    //   24: new 9	com/tencent/xweb/xwalk/b/a$b
    //   27: dup
    //   28: invokespecial 495	com/tencent/xweb/xwalk/b/a$b:<init>	()V
    //   31: astore_3
    //   32: aload 4
    //   34: astore_0
    //   35: aload 5
    ...
    //   105: putfield 518	com/tencent/xweb/xwalk/b/a$b:aakv	Ljava/lang/String;
    //   108: aload 4
    //   110: astore_0
    //   111: aload_3
    //   112: aload 5
    ...
    //   122: putfield 522	com/tencent/xweb/xwalk/b/a$b:signature	Ljava/lang/String;
    //   125: aload 4
    //   127: astore_0
    //   128: aload_3
    //   129: getfield 518	com/tencent/xweb/xwalk/b/a$b:aakv	Ljava/lang/String;
    //   132: ifnull +17 -> 149
    //   135: aload 4
    //   137: astore_0
    //   138: aload_3
    //   139: getfield 518	com/tencent/xweb/xwalk/b/a$b:aakv	Ljava/lang/String;
    //   142: aload_1
    ...
    //   151: astore_0
    //   152: ldc2_w 526
    //   155: invokestatic 533	com/tencent/xweb/util/h:Xg	(J)V
    //   158: aload 4
    //   160: astore_0
    //   161: ldc_w 535
    ...
    //   194: astore_0
    //   195: aload_3
    //   196: getfield 518	com/tencent/xweb/xwalk/b/a$b:aakv	Ljava/lang/String;
    //   199: aload_3
    //   200: getfield 522	com/tencent/xweb/xwalk/b/a$b:signature	Ljava/lang/String;
    //   203: ldc_w 537
    //   206: invokestatic 543	com/tencent/xweb/util/b:bu	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    //   209: ifne +46 -> 255
    //   212: aload 4
    //   214: astore_0
    //   215: ldc2_w 544
    //   218: invokestatic 533	com/tencent/xweb/util/h:Xg	(J)V
    //   221: aload 4
    //   223: astore_0
    //   224: ldc_w 547
    ...
    //   269: putfield 552	com/tencent/xweb/xwalk/b/a$b:aakB	Ljava/lang/String;
    //   272: aload 4
    //   274: astore_0
    //   275: aload_3
    //   276: aload 5
    //   278: invokestatic 554	com/tencent/xweb/xwalk/b/a:b	(Lorg/w3c/dom/Element;)[Lcom/tencent/xweb/internal/a$a;
    //   281: putfield 558	com/tencent/xweb/xwalk/b/a$b:aakD	[Lcom/tencent/xweb/internal/a$a;
    //   284: aload 4
    //   286: astore_0
    //   287: aload 5
    //   289: ldc_w 560
    ...
    //   324: anewarray 21	com/tencent/xweb/xwalk/b/a$f
    //   327: putfield 564	com/tencent/xweb/xwalk/b/a$b:aakC	[Lcom/tencent/xweb/xwalk/b/a$f;
    //   330: iconst_0
    //   331: istore_2
    //   332: aload 4
    //   334: astore_0
    ...
    //   345: aload 4
    //   347: astore_0
    //   348: new 21	com/tencent/xweb/xwalk/b/a$f
    //   351: dup
    //   352: invokespecial 565	com/tencent/xweb/xwalk/b/a$f:<init>	()V
    //   355: astore 5
    //   357: aload 4
    //   359: astore_0
    //   360: aload_1
    ...
    //   387: putfield 568	com/tencent/xweb/xwalk/b/a$f:aako	Ljava/lang/String;
    //   390: aload 4
    //   392: astore_0
    //   393: aload 5
    //   395: aload 6
    ...
    //   405: putfield 569	com/tencent/xweb/xwalk/b/a$f:aakv	Ljava/lang/String;
    //   408: aload 4
    //   410: astore_0
    //   411: aload 5
    //   413: getfield 570	com/tencent/xweb/xwalk/b/a$f:aadO	Lcom/tencent/xweb/internal/a$b;
    //   416: aload 6
    //   418: invokestatic 421	com/tencent/xweb/xwalk/b/a:a	(Lcom/tencent/xweb/internal/a$b;Lorg/w3c/dom/Element;)V
    //   421: aload 4
    //   423: astore_0
    //   424: aload 5
    //   426: aload 6
    //   428: ldc_w 572
    //   431: invokestatic 147	com/tencent/xweb/xwalk/b/a:a	(Lorg/w3c/dom/Element;Ljava/lang/String;)I
    //   434: putfield 575	com/tencent/xweb/xwalk/b/a$f:aaku	I
    //   437: aload 4
    //   439: astore_0
    //   440: aload 5
    //   442: aload 6
    //   444: ldc_w 577
    //   447: invokestatic 147	com/tencent/xweb/xwalk/b/a:a	(Lorg/w3c/dom/Element;Ljava/lang/String;)I
    //   450: putfield 579	com/tencent/xweb/xwalk/b/a$f:version	I
    //   453: aload 4
    //   455: astore_0
    //   456: aload 5
    //   458: aload 6
    //   460: ldc_w 366
    //   463: invokestatic 369	com/tencent/xweb/xwalk/b/a:e	(Lorg/w3c/dom/Element;Ljava/lang/String;)Z
    //   466: putfield 580	com/tencent/xweb/xwalk/b/a$f:aakw	Z
    //   469: aload 4
    //   471: astore_0
    //   472: aload 5
    //   474: aload 6
    //   476: ldc_w 582
    //   479: invokestatic 369	com/tencent/xweb/xwalk/b/a:e	(Lorg/w3c/dom/Element;Ljava/lang/String;)Z
    //   482: putfield 585	com/tencent/xweb/xwalk/b/a$f:aakx	Z
    //   485: aload 4
    //   487: astore_0
    //   488: aload 5
    //   490: aload 6
    //   492: ldc_w 375
    //   495: invokestatic 369	com/tencent/xweb/xwalk/b/a:e	(Lorg/w3c/dom/Element;Ljava/lang/String;)Z
    //   498: putfield 586	com/tencent/xweb/xwalk/b/a$f:aajx	Z
    //   501: aload 4
    //   503: astore_0
    //   504: aload 5
    //   506: aload 6
    //   508: ldc_w 588
    //   511: invokestatic 147	com/tencent/xweb/xwalk/b/a:a	(Lorg/w3c/dom/Element;Ljava/lang/String;)I
    //   514: putfield 591	com/tencent/xweb/xwalk/b/a$f:aakn	I
    //   517: aload 4
    //   519: astore_0
    //   520: aload 5
    //   522: aload 6
    ...
    //   532: putfield 596	com/tencent/xweb/xwalk/b/a$f:aakr	Ljava/lang/String;
    //   535: aload 4
    //   537: astore_0
    //   538: aload 5
    //   540: aload 6
    ...
    //   550: putfield 601	com/tencent/xweb/xwalk/b/a$f:aaks	Ljava/lang/String;
    //   553: aload 4
    //   555: astore_0
    //   556: aload 5
    //   558: aload 6
    ...
    //   568: putfield 606	com/tencent/xweb/xwalk/b/a$f:aakJ	Ljava/lang/String;
    //   571: aload 4
    //   573: astore_0
    //   574: aload 5
    //   576: aload 6
    ...
    //   586: putfield 611	com/tencent/xweb/xwalk/b/a$f:aaky	Ljava/lang/String;
    //   589: aload 4
    //   591: astore_0
    //   592: aload 5
    //   594: aload 6
    ...
    //   604: putfield 616	com/tencent/xweb/xwalk/b/a$f:aakz	Ljava/lang/String;
    //   607: aload 4
    //   609: astore_0
    //   610: aload 5
    //   612: aload 6
    ...
    //   622: putfield 621	com/tencent/xweb/xwalk/b/a$f:aakA	Ljava/lang/String;
    //   625: aload 4
    //   627: astore_0
    //   628: aload 5
    //   630: aload 6
    //   632: ldc_w 623
    //   635: invokestatic 625	com/tencent/xweb/xwalk/b/a:d	(Lorg/w3c/dom/Element;Ljava/lang/String;)F
    //   638: putfield 629	com/tencent/xweb/xwalk/b/a$f:aakp	F
    //   641: aload 4
    //   643: astore_0
    //   644: aload 5
    //   646: aload 6
    //   648: ldc_w 631
    //   651: invokestatic 625	com/tencent/xweb/xwalk/b/a:d	(Lorg/w3c/dom/Element;Ljava/lang/String;)F
    //   654: putfield 634	com/tencent/xweb/xwalk/b/a$f:aakq	F
    //   657: aload 4
    //   659: astore_0
    //   660: aload 6
    //   662: ldc_w 636
    ...
    //   698: putfield 639	com/tencent/xweb/xwalk/b/a$f:aajy	Z
    //   701: aload 4
    //   703: astore_0
    //   704: aload 5
    //   706: aload 6
    //   708: ldc_w 641
    //   711: invokestatic 369	com/tencent/xweb/xwalk/b/a:e	(Lorg/w3c/dom/Element;Ljava/lang/String;)Z
    //   714: putfield 644	com/tencent/xweb/xwalk/b/a$f:aakI	Z
    //   717: aload 4
    //   719: astore_0
    //   720: aload 5
    //   722: getfield 648	com/tencent/xweb/xwalk/b/a$f:aakH	Lcom/tencent/xweb/xwalk/b/a$g;
    //   725: astore 7
    //   727: aload 7
    //   729: ifnull +63 -> 792
    //   732: aload 4
    ...
    //   789: putfield 655	com/tencent/xweb/xwalk/b/a$g:aakK	Ljava/lang/String;
    //   792: aload 4
    //   794: astore_0
    //   795: aload 5
    //   797: aload 6
    //   799: invokestatic 657	com/tencent/xweb/xwalk/b/a:a	(Lorg/w3c/dom/Element;)[Lcom/tencent/xweb/xwalk/b/a$c;
    //   802: putfield 661	com/tencent/xweb/xwalk/b/a$f:aakt	[Lcom/tencent/xweb/xwalk/b/a$c;
    //   805: aload 4
    //   807: astore_0
    //   808: aload_3
    //   809: getfield 564	com/tencent/xweb/xwalk/b/a$b:aakC	[Lcom/tencent/xweb/xwalk/b/a$f;
    //   812: iload_2
    //   813: aload 5
    //   815: aastore
    //   816: iload_2
  ...
  /* Error */
  public static d m(File paramFile, String paramString)
  {
    // Byte code:
    //   0: ldc_w 664
    //   3: invokestatic 35	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    ...
    //   21: aload 4
    //   23: astore_0
    //   24: new 15	com/tencent/xweb/xwalk/b/a$d
    //   27: dup
    //   28: invokespecial 665	com/tencent/xweb/xwalk/b/a$d:<init>	()V
    //   31: astore_3
    //   32: aload 4
    //   34: astore_0
    //   35: aload 5
    ...
    //   97: ldc_w 517
    //   100: invokeinterface 44 2 0
    //   105: putfield 670	com/tencent/xweb/xwalk/b/a$d:aakv	Ljava/lang/String;
    //   108: aload 4
    //   110: astore_0
    //   111: aload_3
    //   112: aload 5
    //   114: ldc_w 520
    //   117: invokeinterface 44 2 0
    //   122: putfield 671	com/tencent/xweb/xwalk/b/a$d:signature	Ljava/lang/String;
    //   125: aload 4
    //   127: astore_0
    //   128: aload_3
    //   129: getfield 670	com/tencent/xweb/xwalk/b/a$d:aakv	Ljava/lang/String;
    //   132: ifnull +17 -> 149
    //   135: aload 4
    //   137: astore_0
    //   138: aload_3
    //   139: getfield 670	com/tencent/xweb/xwalk/b/a$d:aakv	Ljava/lang/String;
    //   142: aload_1
    //   143: invokevirtual 525	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   146: ifne +37 -> 183
    //   149: aload 4
    ...
    //   185: astore_0
    //   186: aload_3
    //   187: getfield 670	com/tencent/xweb/xwalk/b/a$d:aakv	Ljava/lang/String;
    //   190: aload_3
    //   191: getfield 671	com/tencent/xweb/xwalk/b/a$d:signature	Ljava/lang/String;
    //   194: ldc_w 537
    //   197: invokestatic 543	com/tencent/xweb/util/b:bu	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    //   200: ifne +46 -> 246
    //   203: aload 4
    //   205: astore_0
    //   206: ldc2_w 544
    //   209: invokestatic 533	com/tencent/xweb/util/h:Xg	(J)V
    //   212: aload 4
    //   214: astore_0
    //   215: ldc_w 675
    ...
    //   260: putfield 676	com/tencent/xweb/xwalk/b/a$d:aakB	Ljava/lang/String;
    //   263: aload 4
    //   265: astore_0
    //   266: aload_3
    //   267: aload 5
    //   269: invokestatic 554	com/tencent/xweb/xwalk/b/a:b	(Lorg/w3c/dom/Element;)[Lcom/tencent/xweb/internal/a$a;
    //   272: putfield 677	com/tencent/xweb/xwalk/b/a$d:aakD	[Lcom/tencent/xweb/internal/a$a;
    //   275: aload 4
    //   277: astore_0
    //   278: aload 5
    //   280: ldc_w 679
    ...
    //   315: anewarray 18	com/tencent/xweb/xwalk/b/a$e
    //   318: putfield 683	com/tencent/xweb/xwalk/b/a$d:aakF	[Lcom/tencent/xweb/xwalk/b/a$e;
    //   321: iconst_0
    //   322: istore_2
    //   323: aload 4
    //   325: astore_0
    ...
    //   351: aload 4
    //   353: astore_0
    //   354: new 18	com/tencent/xweb/xwalk/b/a$e
    //   357: dup
    //   358: invokespecial 684	com/tencent/xweb/xwalk/b/a$e:<init>	()V
    //   361: astore 6
    //   363: aload 4
    //   365: astore_0
    //   366: aload 6
    ...
    //   378: putfield 689	com/tencent/xweb/xwalk/b/a$e:aakG	Ljava/lang/String;
    //   381: aload 4
    //   383: astore_0
    //   384: aload 6
    //   386: aload 5
    //   388: ldc_w 577
    //   391: invokestatic 147	com/tencent/xweb/xwalk/b/a:a	(Lorg/w3c/dom/Element;Ljava/lang/String;)I
    //   394: putfield 690	com/tencent/xweb/xwalk/b/a$e:version	I
    //   397: aload 4
    //   399: astore_0
    //   400: aload 6
    //   402: aload 5
    ...
    //   412: putfield 691	com/tencent/xweb/xwalk/b/a$e:aako	Ljava/lang/String;
    //   415: aload 4
    //   417: astore_0
    //   418: aload 6
    //   420: aload 5
    ...
    //   430: putfield 692	com/tencent/xweb/xwalk/b/a$e:aakv	Ljava/lang/String;
    //   433: aload 4
    //   435: astore_0
    //   436: aload 6
    //   438: aload 5
    //   440: ldc_w 366
    //   443: invokestatic 369	com/tencent/xweb/xwalk/b/a:e	(Lorg/w3c/dom/Element;Ljava/lang/String;)Z
    //   446: putfield 693	com/tencent/xweb/xwalk/b/a$e:aakw	Z
    //   449: aload 4
    //   451: astore_0
    //   452: aload 6
    //   454: aload 5
    //   456: ldc_w 582
    //   459: invokestatic 369	com/tencent/xweb/xwalk/b/a:e	(Lorg/w3c/dom/Element;Ljava/lang/String;)Z
    //   462: putfield 694	com/tencent/xweb/xwalk/b/a$e:aakx	Z
    //   465: aload 4
    //   467: astore_0
    //   468: aload 6
    //   470: aload 5
    //   472: ldc_w 375
    //   475: invokestatic 369	com/tencent/xweb/xwalk/b/a:e	(Lorg/w3c/dom/Element;Ljava/lang/String;)Z
    //   478: putfield 695	com/tencent/xweb/xwalk/b/a$e:aajx	Z
    //   481: aload 4
    //   483: astore_0
    //   484: aload 6
    //   486: aload 5
    //   488: ldc_w 572
    //   491: invokestatic 147	com/tencent/xweb/xwalk/b/a:a	(Lorg/w3c/dom/Element;Ljava/lang/String;)I
    //   494: putfield 696	com/tencent/xweb/xwalk/b/a$e:aaku	I
    //   497: aload 4
    //   499: astore_0
    //   500: aload 6
    //   502: aload 5
    //   504: ldc_w 588
    //   507: invokestatic 147	com/tencent/xweb/xwalk/b/a:a	(Lorg/w3c/dom/Element;Ljava/lang/String;)I
    //   510: putfield 697	com/tencent/xweb/xwalk/b/a$e:aakn	I
    //   513: aload 4
    //   515: astore_0
    //   516: aload 6
    //   518: aload 5
    ...
    //   528: putfield 698	com/tencent/xweb/xwalk/b/a$e:aakr	Ljava/lang/String;
    //   531: aload 4
    //   533: astore_0
    //   534: aload 6
    //   536: aload 5
    ...
    //   546: putfield 699	com/tencent/xweb/xwalk/b/a$e:aaks	Ljava/lang/String;
    //   549: aload 4
    //   551: astore_0
    //   552: aload 6
    //   554: aload 5
    ...
    //   564: putfield 700	com/tencent/xweb/xwalk/b/a$e:aaky	Ljava/lang/String;
    //   567: aload 4
    //   569: astore_0
    //   570: aload 6
    //   572: aload 5
    ...
    //   582: putfield 701	com/tencent/xweb/xwalk/b/a$e:aakz	Ljava/lang/String;
    //   585: aload 4
    //   587: astore_0
    //   588: aload 6
    //   590: aload 5
    ...
    //   600: putfield 702	com/tencent/xweb/xwalk/b/a$e:aakA	Ljava/lang/String;
    //   603: aload 4
    //   605: astore_0
    //   606: aload 6
    //   608: aload 5
    //   610: ldc_w 623
    //   613: invokestatic 625	com/tencent/xweb/xwalk/b/a:d	(Lorg/w3c/dom/Element;Ljava/lang/String;)F
    //   616: putfield 703	com/tencent/xweb/xwalk/b/a$e:aakp	F
    //   619: aload 4
    //   621: astore_0
    //   622: aload 6
    //   624: aload 5
    //   626: ldc_w 631
    //   629: invokestatic 625	com/tencent/xweb/xwalk/b/a:d	(Lorg/w3c/dom/Element;Ljava/lang/String;)F
    //   632: putfield 704	com/tencent/xweb/xwalk/b/a$e:aakq	F
    //   635: aload 4
    //   637: astore_0
    //   638: aload 6
    //   640: getfield 705	com/tencent/xweb/xwalk/b/a$e:aadO	Lcom/tencent/xweb/internal/a$b;
    //   643: aload 5
    //   645: invokestatic 421	com/tencent/xweb/xwalk/b/a:a	(Lcom/tencent/xweb/internal/a$b;Lorg/w3c/dom/Element;)V
    //   648: aload 4
    //   650: astore_0
    //   651: aload 6
    //   653: aload 5
    //   655: invokestatic 657	com/tencent/xweb/xwalk/b/a:a	(Lorg/w3c/dom/Element;)[Lcom/tencent/xweb/xwalk/b/a$c;
    //   658: putfield 706	com/tencent/xweb/xwalk/b/a$e:aakt	[Lcom/tencent/xweb/xwalk/b/a$c;
    //   661: aload 4
    //   663: astore_0
    //   664: aload_3
    //   665: getfield 683	com/tencent/xweb/xwalk/b/a$d:aakF	[Lcom/tencent/xweb/xwalk/b/a$e;
    //   668: iload_2
    //   669: aload 6
    //   671: aastore
    //   672: iload_2
  ...
  {
    public com.tencent.xweb.internal.a.b aadO;
    public boolean aajx;
    public String aakA;
    public int aakn;
    public String aako;
    ...
    public a()
    {
      ...
      this.aadO = new com.tencent.xweb.internal.a.c();
      this.aakp = -1.0F;
      this.aakq = -1.0F;
  ...
  public static final class b
  {
    public String aakB;
    public a.f[] aakC;
    public com.tencent.xweb.internal.a.a[] aakD;
    public String aakv;
