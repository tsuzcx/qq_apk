  ...
  extends AsyncTask<a, b, c>
{
  ...
  private c a(a... paramVarArgs)
  {
    ...
    //   45: areturn
    //   46: aload_0
    //   47: getfield 32	com/tencent/xweb/xwalk/updater/f:IWa	Lcom/tencent/xweb/xwalk/updater/b;
    //   50: ifnull +12 -> 62
    //   53: aload_0
    //   54: getfield 32	com/tencent/xweb/xwalk/updater/f:IWa	Lcom/tencent/xweb/xwalk/updater/b;
    //   57: invokeinterface 62 1 0
    //   62: new 15	com/tencent/xweb/xwalk/updater/f$c
    //   65: dup
    //   66: invokespecial 63	com/tencent/xweb/xwalk/updater/f$c:<init>	()V
    //   69: astore 21
    //   71: aload 21
    //   73: aload 22
    //   75: getfield 67	com/tencent/xweb/xwalk/updater/f$a:mUrl	Ljava/lang/String;
    //   78: putfield 68	com/tencent/xweb/xwalk/updater/f$c:mUrl	Ljava/lang/String;
    //   81: aload 21
    //   83: aload 22
    //   85: getfield 71	com/tencent/xweb/xwalk/updater/f$a:mFilePath	Ljava/lang/String;
    //   88: putfield 72	com/tencent/xweb/xwalk/updater/f$c:mFilePath	Ljava/lang/String;
    //   91: aload 21
    //   93: iconst_0
    //   94: putfield 75	com/tencent/xweb/xwalk/updater/f$c:IWh	I
    //   97: aload 21
    //   99: ldc 77
    //   101: putfield 80	com/tencent/xweb/xwalk/updater/f$c:jyg	Ljava/lang/String;
    //   104: aload 21
    //   106: aload_0
    //   107: getfield 36	com/tencent/xweb/xwalk/updater/f:IWc	I
    //   110: putfield 83	com/tencent/xweb/xwalk/updater/f$c:mRetryTimes	I
    //   113: aload 21
    //   115: lconst_0
    //   116: putfield 86	com/tencent/xweb/xwalk/updater/f$c:aPH	J
    //   119: aload 21
    //   121: lconst_0
    //   122: putfield 89	com/tencent/xweb/xwalk/updater/f$c:mTotalSize	J
    //   125: aload 21
    //   127: iconst_0
    //   128: putfield 92	com/tencent/xweb/xwalk/updater/f$c:IWi	I
    //   131: aload 21
    ...
    //   139: putfield 107	com/tencent/xweb/xwalk/updater/f$c:mNetWorkType	I
    //   142: aload 22
    //   144: getfield 67	com/tencent/xweb/xwalk/updater/f$a:mUrl	Ljava/lang/String;
    //   147: ifnull +40 -> 187
    //   150: aload 22
    //   152: getfield 71	com/tencent/xweb/xwalk/updater/f$a:mFilePath	Ljava/lang/String;
    //   155: ifnull +32 -> 187
    //   158: aload 22
    //   160: getfield 67	com/tencent/xweb/xwalk/updater/f$a:mUrl	Ljava/lang/String;
    //   163: invokevirtual 113	java/lang/String:length	()I
    //   166: ifeq +21 -> 187
    //   169: aload 22
    //   171: getfield 71	com/tencent/xweb/xwalk/updater/f$a:mFilePath	Ljava/lang/String;
    //   174: invokevirtual 113	java/lang/String:length	()I
    //   177: ifeq +10 -> 187
    //   180: aload_0
    //   181: getfield 32	com/tencent/xweb/xwalk/updater/f:IWa	Lcom/tencent/xweb/xwalk/updater/b;
    //   184: ifnonnull +24 -> 208
    //   187: ldc 115
    //   189: invokestatic 121	org/xwalk/core/XWalkInitializer:addXWalkInitializeLog	(Ljava/lang/String;)V
    //   192: aload 21
    //   194: sipush -10001
    //   197: putfield 75	com/tencent/xweb/xwalk/updater/f$c:IWh	I
    //   200: ldc 48
    ...
    //   246: dup
    //   247: aload 22
    //   249: getfield 67	com/tencent/xweb/xwalk/updater/f$a:mUrl	Ljava/lang/String;
    ...
    //   417: astore 13
    //   419: aload 22
    //   421: getfield 71	com/tencent/xweb/xwalk/updater/f$a:mFilePath	Ljava/lang/String;
    //   424: astore 11
    //   426: aload_1
    //   427: astore 9
    //   429: aload 14
    ...
    //   525: lconst_0
    //   526: lstore 4
    //   528: new 12	com/tencent/xweb/xwalk/updater/f$b
    //   531: dup
    //   532: invokespecial 166	com/tencent/xweb/xwalk/updater/f$b:<init>	()V
    //   535: astore 10
    //   537: aload 10
    //   539: aload 22
    //   541: getfield 67	com/tencent/xweb/xwalk/updater/f$a:mUrl	Ljava/lang/String;
    //   544: putfield 167	com/tencent/xweb/xwalk/updater/f$b:mUrl	Ljava/lang/String;
    //   547: aload 10
    //   549: iload_2
    //   550: i2l
    //   551: putfield 168	com/tencent/xweb/xwalk/updater/f$b:mTotalSize	J
    //   554: aload_1
    //   555: aload 9
    ...
    //   566: aload_0
    //   567: invokevirtual 177	com/tencent/xweb/xwalk/updater/f:isCancelled	()Z
    //   570: ifeq +76 -> 646
    //   573: aload_1
    ...
    //   630: aload 21
    //   632: sipush -10003
    //   635: putfield 75	com/tencent/xweb/xwalk/updater/f$c:IWh	I
    //   638: ldc 48
    ...
    //   662: aload 10
    //   664: lload 6
    //   666: putfield 207	com/tencent/xweb/xwalk/updater/f$b:IWg	J
    //   669: lload 6
    //   671: lstore 4
    //   673: iload_2
    //   674: ifle -120 -> 554
    //   677: aload_0
    //   678: iconst_1
    //   679: anewarray 12	com/tencent/xweb/xwalk/updater/f$b
    //   682: dup
    //   683: iconst_0
    //   684: aload 10
    //   686: aastore
    //   687: invokevirtual 211	com/tencent/xweb/xwalk/updater/f:publishProgress	([Ljava/lang/Object;)V
    //   690: lload 6
    //   692: lstore 4
    //   694: goto -140 -> 554
    //   697: astore 13
    ...
    //   758: aload 21
    //   760: sipush -10002
    //   763: putfield 75	com/tencent/xweb/xwalk/updater/f$c:IWh	I
    //   766: aload 8
    //   768: ifnull +8 -> 776
    //   771: aload 8
    ...
    //   802: aload 21
    //   804: lload 4
    //   806: putfield 89	com/tencent/xweb/xwalk/updater/f$c:mTotalSize	J
    //   809: aload 21
    //   811: invokestatic 220	java/lang/System:currentTimeMillis	()J
    //   814: aload_0
    //   815: getfield 40	com/tencent/xweb/xwalk/updater/f:IWd	J
    //   818: lsub
    //   819: putfield 86	com/tencent/xweb/xwalk/updater/f$c:aPH	J
    //   822: aload_1
    //   823: astore 9
    //   825: aload 11
    //   827: astore 12
    ...
    //   893: aload 21
    //   895: sipush -10005
    //   898: putfield 75	com/tencent/xweb/xwalk/updater/f$c:IWh	I
    //   901: aload 18
    //   903: astore 9
    //   905: aload 14
    //   907: astore 12
    ...
    //   928: putfield 80	com/tencent/xweb/xwalk/updater/f$c:jyg	Ljava/lang/String;
    //   931: aload 17
    //   933: astore 11
    //   935: goto -113 -> 822
    //   938: astore 13
    ...
    //   973: aload 21
    //   975: sipush -10003
    //   978: putfield 75	com/tencent/xweb/xwalk/updater/f$c:IWh	I
    //   981: ldc 48
    ...
    //   1012: aload 21
    //   1014: sipush -10003
    //   1017: putfield 75	com/tencent/xweb/xwalk/updater/f$c:IWh	I
    //   1020: ldc 48
    ...
    //   1096: aload 21
    //   1098: sipush -10003
    //   1101: putfield 75	com/tencent/xweb/xwalk/updater/f$c:IWh	I
    //   1104: ldc 48
  ...
  public static void a(a parama, b paramb)
  {
    ...
    localf.IWb = parama;
    localf.IWc = 0;
    localf.IWd = System.currentTimeMillis();
    localf.execute(new a[] { localf.IWb });
