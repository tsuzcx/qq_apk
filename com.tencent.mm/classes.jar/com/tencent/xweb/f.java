...
{
  public static final String[] KyK = { "ppt", "pptx", "xls", "xlsx", "doc", "docx", "pdf" };
  public static String KyL = "open_x5_from_scene";
  ...
  public static a a(String paramString, a parama, boolean paramBoolean, Intent paramIntent)
  {
    ...
    if (paramString.KHj < 0)
    {
      Log.i("XFilesReaderHelper", "getReaderType invalid version, try again");
      paramString.fLP();
    }
    if ((paramString.KHj < 0) || (paramString.KHj < paramString.fLM()))
    {
      if (ai.fJV())
      {
      ...
      if (!b.fIY())
      {
        Log.i("XFilesReaderHelper", "getReaderType plugin version: " + paramString.KHj + ", require: " + paramString.fLM() + ", canDownloadWhenNotInstall: false, use x5");
        if (paramString.KHj < 0) {}
        for (int i = 45;; i = 46)
        {
          d(paramIntent, i);
      ...
      Log.i("XFilesReaderHelper", "getReaderType plugin version: " + paramString.KHj + ", require: " + paramString.fLM() + ", canDownloadWhenNotInstall: true, use xweb");
      paramString = a.KyN;
      AppMethodBeat.o(156735);
      return paramString;
    }
    if (paramString.jdMethod_do(str, paramBoolean))
    {
  ...
  public static void a(String paramString1, int paramInt, String paramString2, Exception paramException)
  {
    ...
    try
    {
      ...
      com.tencent.xweb.util.g.cU(17565, paramString1);
      AppMethodBeat.o(156744);
      return;
    }
  ...
  public static com.tencent.xweb.xwalk.a.f aUJ(String paramString)
  {
    ...
    {
      paramString = com.tencent.xweb.xwalk.a.g.aUJ("XFilesPPTReader");
      AppMethodBeat.o(156736);
      return paramString;
    }
    if (paramString.equalsIgnoreCase("pdf"))
    {
      paramString = com.tencent.xweb.xwalk.a.g.aUJ("XFilesPDFReader");
      AppMethodBeat.o(156736);
      return paramString;
    }
    if ((paramString.equalsIgnoreCase("doc")) || (paramString.equalsIgnoreCase("docx")))
    {
      paramString = com.tencent.xweb.xwalk.a.g.aUJ("XFilesWordReader");
      AppMethodBeat.o(156736);
      return paramString;
    }
    if ((paramString.equalsIgnoreCase("xls")) || (paramString.equalsIgnoreCase("xlsx")))
    {
      paramString = com.tencent.xweb.xwalk.a.g.aUJ("XFilesExcelReader");
      AppMethodBeat.o(156736);
      return paramString;
    }
    AppMethodBeat.o(156736);
  ...
  private static b aUK(String paramString)
  {
  ...
  public static void aX(String paramString, int paramInt1, int paramInt2)
  {
    ...
    com.tencent.xweb.util.g.cU(17566, str);
    if (paramString.KyR) {}
    for (paramInt1 = 13;; paramInt1 = 12)
    {
      Log.d("XFilesReaderHelper", "reportXWebErrorCode first idkey id:" + paramString.KyQ + ", key:" + paramInt1);
      com.tencent.xweb.util.g.r(paramString.KyQ, paramInt1, 1L);
      switch (paramInt2)
      {
      default: 
    ...
    for (;;)
    {
      Log.d("XFilesReaderHelper", "reportXWebErrorCode second idkey id:" + paramString.KyQ + ", key:" + paramInt1);
      com.tencent.xweb.util.g.r(paramString.KyQ, paramInt1, 1L);
      AppMethodBeat.o(156743);
      return;
      paramInt1 = 152;
  ...
  public static void b(String paramString, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    if (paramInt1 != 0)
    {
      if (paramBoolean)
      {
        ...
        com.tencent.xweb.util.g.cU(17566, paramString);
      }
    }
    else if ((paramBoolean) || (paramInt1 == -102))
    {
      ...
      paramInt1 = 15;
      label154:
      Log.d("XFilesReaderHelper", "reportX5ErrorCode idkey id:" + localb.KyQ + ", key:" + paramInt1);
      com.tencent.xweb.util.g.r(localb.KyQ, paramInt1, 1L);
      if (paramInt2 == 49) {
        if (!localb.KyR) {
          break label316;
        }
    ...
    {
      Log.d("XFilesReaderHelper", "reportX5ErrorCode XWeb and X5 All failed id:" + localb.KyQ + ", key:" + paramInt1);
      com.tencent.xweb.util.g.r(localb.KyQ, paramInt1, 1L);
      AppMethodBeat.o(156742);
      return;
  ...
  private static void d(Intent paramIntent, int paramInt)
  {
    ...
    if (paramIntent != null) {
      paramIntent.putExtra(KyL, paramInt);
    }
  ...
  public static void gI(String paramString, int paramInt)
  {
    ...
    com.tencent.xweb.util.g.cU(17563, str);
    Log.d("XFilesReaderHelper", "reportReadByX5Scene idkey id:" + paramString.KyQ + ", key:" + paramInt);
    com.tencent.xweb.util.g.r(paramString.KyQ, paramInt, 1L);
    AppMethodBeat.o(156740);
  }
  
  private static void gJ(String paramString, int paramInt)
  {
    ...
    Log.d("XFilesReaderHelper", "reportIDKeyByFileExt id:" + localb.KyQ + ", key:" + paramInt);
    com.tencent.xweb.util.g.r(localb.KyQ, paramInt, 1L);
    AppMethodBeat.o(205046);
  }
  ...
  public static void gK(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      Log.d("XFilesReaderHelper", "reportDownloadErrorCode idkey id:" + localb.KyQ + ", key:" + paramInt);
      com.tencent.xweb.util.g.r(localb.KyQ, paramInt, 1L);
      AppMethodBeat.o(205053);
      return;
      paramInt = 81;
  ...
  public static long lj(Context paramContext)
  {
  ...
  public static void mA(String paramString1, String paramString2)
  {
    ...
    Object localObject1 = aUK((String)localObject2);
    ...
    label137:
    int k;
    if (a.KyN.name().equalsIgnoreCase(paramString2)) {
      if (((b)localObject1).KyR)
      {
        i = 1;
        if (!((b)localObject1).KyR) {
          break label375;
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          k = m;
          Log.d("XFilesReaderHelper", "reportPV id:" + ((b)localObject1).KyQ + ", key:" + j);
          com.tencent.xweb.util.g.r(((b)localObject1).KyQ, j, 1L);
          if (k == 0) {
            continue;
          }
          Log.d("XFilesReaderHelper", "reportUV id:" + ((b)localObject1).KyQ + ", key:" + i);
          com.tencent.xweb.util.g.r(((b)localObject1).KyQ, i, 1L);
          ...
          j = 2;
          break label137;
          if (a.KyO.name().equalsIgnoreCase(paramString2))
          {
            if (((b)localObject1).KyR)
            {
              i = 5;
  ...
  public static void mz(String paramString1, String paramString2)
  {
    ...
    for (paramString1 = paramString2.substring(0, 50);; paramString1 = paramString2)
    {
      ...
      com.tencent.xweb.util.g.cU(17562, paramString1);
      paramString1 = aUK(paramString2);
    ...
    if (l1 <= 10L)
    {
      ...
      for (i = 24;; i = 20)
      {
        Log.d("XFilesReaderHelper", "reportFileSize idkey id:" + paramString1.KyQ + ", key:" + i);
        com.tencent.xweb.util.g.r(paramString1.KyQ, i, 1L);
        AppMethodBeat.o(156739);
        return;
      }
    }
