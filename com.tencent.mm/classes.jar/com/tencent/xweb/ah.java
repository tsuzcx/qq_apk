...
{
  static boolean IOd = false;
  static boolean IOe = false;
  ...
  public static void a(Context paramContext, IXWebLogClient paramIXWebLogClient, ISharedPreferenceProvider paramISharedPreferenceProvider, ad paramad, WebViewExtensionListener paramWebViewExtensionListener)
  {
    try
    {
      ...
      if (paramISharedPreferenceProvider != null) {
        af.setSharedPreferenceProvider(paramISharedPreferenceProvider);
      }
      kX(paramContext);
      if (paramWebViewExtensionListener != null) {
        j.g(WebView.c.INC).initCallback(paramWebViewExtensionListener);
      }
      XWebCoreContentProvider.frl();
  ...
  public static void initInterface()
  {
    ...
    //   8: getstatic 11	com/tencent/xweb/ah:IOd	Z
    //   11: ifeq +12 -> 23
    //   14: ldc 76
    ...
    //   22: return
    //   23: iconst_1
    //   24: putstatic 11	com/tencent/xweb/ah:IOd	Z
    //   27: getstatic 57	com/tencent/xweb/WebView$c:INC	Lcom/tencent/xweb/WebView$c;
    ...
    //   44: getstatic 81	com/tencent/xweb/WebView$c:IND	Lcom/tencent/xweb/WebView$c;
