  ...
  implements SurfaceHolder.Callback, TXCRenderAndDec.b, b, com.tencent.liteav.audio.c, com.tencent.liteav.audio.d, com.tencent.liteav.audio.e, com.tencent.liteav.audio.f, com.tencent.liteav.basic.c.a, c.a, com.tencent.liteav.n
{
    ...
    this.mRoomInfo.forEachUser(new TRTCRoomInfo.UserAction()
    {
      public void accept(String paramAnonymousString, TRTCRoomInfo.UserInfo paramAnonymousUserInfo)
      {
        ...
        if (paramAnonymousUserInfo.mainRender.render != null) {
          TRTCCloudImpl.access$10700(TRTCCloudImpl.this, paramAnonymousUserInfo.mainRender.render, paramAnonymousUserInfo, localTRTCStatistics, localArrayList);
        }
        if ((paramAnonymousUserInfo.subRender.render != null) && (paramAnonymousUserInfo.subRender.render.isRendering())) {
          TRTCCloudImpl.access$10700(TRTCCloudImpl.this, paramAnonymousUserInfo.subRender.render, paramAnonymousUserInfo, localTRTCStatistics, localArrayList);
        }
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        if (localUserInfo != null)
        {
          ...
          TRTCCloudImpl.access$9800(TRTCCloudImpl.this, paramInt3, paramLong, this.val$streamState, paramInt2);
        }
        AppMethodBeat.o(15628);
      }
    });
      ...
      public void run()
      {
        ...
        for (;;)
        {
          ...
          if (TRTCCloudImpl.this.mCurrentRole == 20)
          {
            ...
            TXCRenderAndDec localTXCRenderAndDec = TRTCCloudImpl.access$9600(TRTCCloudImpl.this, paramLong, TRTCCloudImpl.this.mPriorStreamType);
            ...
            if (localRenderListenerAdapter != null)
            {
              ...
              if (localRenderListenerAdapter.listener != null) {
                localTXCRenderAndDec.setVideoFrameListener(TRTCCloudImpl.this, localRenderListenerAdapter.pixelFormat);
              }
            }
            ...
            if (((TRTCRoomInfo.UserInfo)localObject1).mainRender.view != null)
            {
              TRTCCloudImpl.this.runOnMainThread(new Runnable()
              {
                public void run()
                {
                  ...
                  TRTCCloudImpl.access$4400(TRTCCloudImpl.this, TRTCCloudImpl.118.this.val$userID, this.val$finalUserInfo.mainRender, this.val$finalUserInfo.mainRender.view, this.val$finalUserInfo.debugMargin);
            ...
            label578:
            localObject2 = TRTCCloudImpl.access$9600(TRTCCloudImpl.this, paramLong, 7);
            ...
            if (((TRTCRoomInfo.UserInfo)localObject1).subRender.view != null)
            {
              TRTCCloudImpl.this.runOnMainThread(new Runnable()
              {
                public void run()
                {
                  ...
                  TRTCCloudImpl.access$4400(TRTCCloudImpl.this, TRTCCloudImpl.118.this.val$userID, this.val$finalUserInfo1.subRender, this.val$finalUserInfo1.subRender.view, this.val$finalUserInfo1.debugMargin);
            ...
            TRTCCloudImpl.this.runOnListenerThread(new Runnable()
            {
              public void run()
              {
                ...
                if (this.val$listener != null) {
                  this.val$listener.onUserEnter(TRTCCloudImpl.118.this.val$userID);
                }
            ...
            if (bool)
            {
              TRTCCloudImpl.this.runOnListenerThread(new Runnable()
              {
                public void run()
                {
                  ...
                  if (this.val$listener != null) {
                    this.val$listener.onUserAudioAvailable(TRTCCloudImpl.118.this.val$userID, bool);
                  }
                  Monitor.a(2, String.format("onUserAudioAvailable userID:%s, bAvailable:%b", new Object[] { TRTCCloudImpl.118.this.val$userID, Boolean.valueOf(bool) }), "", 0);
                  AppMethodBeat.o(182414);
                }
              });
              TRTCCloudImpl.access$9700(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), 0, String.format("[%s]audio Available[true]", new Object[] { paramString }));
            }
            ...
            if ((bool) && (TRTCCloudImpl.this.mRoomInfo.hasRecvFirstIFrame(paramLong)))
            {
              TRTCCloudImpl.this.runOnListenerThread(new Runnable()
              {
                public void run()
                {
                  ...
                  TXCLog.i("TRTCCloudImpl", "notify onUserVideoAvailable:" + TRTCCloudImpl.118.this.val$tinyID + " [" + bool + "] by bit state");
                  if (this.val$listener != null) {
                    this.val$listener.onUserVideoAvailable(TRTCCloudImpl.118.this.val$userID, bool);
                  }
                  Monitor.a(2, String.format("onUserVideoAvailable userID:%s, bAvailable:%b", new Object[] { TRTCCloudImpl.118.this.val$userID, Boolean.valueOf(bool) }), "", 0);
                  AppMethodBeat.o(182293);
                }
              });
              TRTCCloudImpl.access$9700(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), 0, String.format("[%s]video Available[true]", new Object[] { paramString }));
            }
            ...
            if (bool)
            {
              TRTCCloudImpl.this.runOnListenerThread(new Runnable()
              {
                public void run()
                {
                  ...
                  if (this.val$listener != null) {
                    this.val$listener.onUserSubStreamAvailable(TRTCCloudImpl.118.this.val$userID, bool);
                  }
                  Monitor.a(2, String.format("onUserSubStreamAvailable userID:%s, bAvailable:%b", new Object[] { TRTCCloudImpl.118.this.val$userID, Boolean.valueOf(bool) }), "", 0);
                  AppMethodBeat.o(182305);
                }
              });
              TRTCCloudImpl.access$9700(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), 0, String.format("[%s]subvideo Available[true]", new Object[] { paramString }));
            }
            TRTCCloudImpl.access$9300(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), 0, String.format("[%s]加入房间", new Object[] { paramString }));
            AppMethodBeat.o(15611);
            return;
  ...
  private void onAVMemberExit(final long paramLong, final String paramString, int paramInt1, int paramInt2)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        if (localUserInfo != null)
        {
          TRTCCloudImpl.access$3600(TRTCCloudImpl.this, localUserInfo);
        ...
        for (;;)
        {
          ...
          TRTCCloudImpl.this.runOnListenerThread(new Runnable()
          {
            public void run()
            {
              ...
              TRTCCloudImpl.this.apiLog("onAVMemberExit " + TRTCCloudImpl.119.this.val$tinyID + ", " + TRTCCloudImpl.119.this.val$userID + ", " + TRTCCloudImpl.119.this.val$videoState);
              TRTCCloudListener localTRTCCloudListener = TRTCCloudImpl.this.mTRTCListener;
              if (localTRTCCloudListener != null)
              {
                if ((TRTCRoomInfo.hasAudio(TRTCCloudImpl.119.this.val$videoState)) && (!TRTCRoomInfo.isMuteAudio(TRTCCloudImpl.119.this.val$videoState)))
                {
                  localTRTCCloudListener.onUserAudioAvailable(TRTCCloudImpl.119.this.val$userID, false);
                  TRTCCloudImpl.access$9700(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), 0, String.format("[%s]audio Available[%b]", new Object[] { TRTCCloudImpl.119.this.val$userID, Boolean.FALSE }));
                  Monitor.a(2, String.format("onUserAudioAvailable userID:%s, bAvailable:%b", new Object[] { TRTCCloudImpl.119.this.val$userID, Boolean.FALSE }), "", 0);
                }
                if (((TRTCRoomInfo.hasMainVideo(TRTCCloudImpl.119.this.val$videoState)) || (TRTCRoomInfo.hasSmallVideo(TRTCCloudImpl.119.this.val$videoState))) && (!TRTCRoomInfo.isMuteMainVideo(TRTCCloudImpl.119.this.val$videoState)))
                {
                  localTRTCCloudListener.onUserVideoAvailable(TRTCCloudImpl.119.this.val$userID, false);
                  TRTCCloudImpl.access$9700(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), 0, String.format("[%s]video Available[%b]", new Object[] { TRTCCloudImpl.119.this.val$userID, Boolean.FALSE }));
                  Monitor.a(2, String.format("onUserVideoAvailable userID:%s, bAvailable:%b", new Object[] { TRTCCloudImpl.119.this.val$userID, Boolean.FALSE }), "", 0);
                }
                if ((TRTCRoomInfo.hasSubVideo(TRTCCloudImpl.119.this.val$videoState)) && (!TRTCRoomInfo.isMuteSubVideo(TRTCCloudImpl.119.this.val$videoState)))
                {
                  localTRTCCloudListener.onUserSubStreamAvailable(TRTCCloudImpl.119.this.val$userID, false);
                  TRTCCloudImpl.access$9700(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), 0, String.format("[%s]subVideo Available[%b]", new Object[] { TRTCCloudImpl.119.this.val$userID, Boolean.FALSE }));
                  Monitor.a(2, String.format("onUserSubStreamAvailable userID:%s, bAvailable:%b", new Object[] { TRTCCloudImpl.119.this.val$userID, Boolean.FALSE }), "", 0);
                }
                localTRTCCloudListener.onUserExit(TRTCCloudImpl.119.this.val$userID, 0);
              }
    ...
    runOnListenerThread(new Runnable()
    {
      public void run()
      {
        ...
        for (;;)
        {
          ...
          TRTCCloudImpl.access$9300(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), 0, "onChangeRole:" + paramInt);
      ...
      public void run()
      {
        ...
        TRTCCloudImpl.this.mRoomInfo.forEachUser(new TRTCRoomInfo.UserAction()
        {
          public void accept(String paramAnonymous2String, TRTCRoomInfo.UserInfo paramAnonymous2UserInfo)
          {
            ...
            if (paramAnonymous2UserInfo.mainRender.render != null) {
              paramAnonymous2UserInfo.mainRender.render.setBlockInterval(TRTCCloudImpl.126.this.val$blockIntervalMs);
            }
            if (paramAnonymous2UserInfo.subRender.render != null) {
              paramAnonymous2UserInfo.subRender.render.setBlockInterval(TRTCCloudImpl.126.this.val$blockIntervalMs);
            }
      ...
      runOnSDKThread(new Runnable()
      {
        public void run()
        {
          ...
          if (paramInt == 0)
          {
            ...
            TRTCCloudImpl.access$5100(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, 2, TRTCCloudImpl.this.mRoomInfo.muteLocalVideo);
            TRTCCloudImpl.access$5100(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, 1, TRTCCloudImpl.this.mRoomInfo.muteLocalAudio);
            TRTCCloudImpl.access$9300(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), 0, "进房成功");
            AppMethodBeat.o(15705);
            return;
          }
          TRTCCloudImpl.access$302(TRTCCloudImpl.this, 0);
          TRTCCloudImpl.access$9300(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), paramInt, "进房失败" + paramString);
          AppMethodBeat.o(15705);
        }
      });
      runOnListenerThread(new Runnable()
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        if (TRTCCloudImpl.this.mRoomInfo.isMicStard())
        {
          ...
          TRTCCloudImpl.access$9400(TRTCCloudImpl.this, new Runnable()
          {
            public void run()
            {
        ...
        TRTCCloudImpl.this.runOnListenerThread(new Runnable()
        {
          public void run()
          {
            ...
            TRTCCloudListener localTRTCCloudListener = TRTCCloudImpl.this.mTRTCListener;
            if (localTRTCCloudListener != null) {
              localTRTCCloudListener.onExitRoom(TRTCCloudImpl.111.this.val$err);
            }
  ...
  private void onKickOut(final int paramInt, final String paramString)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$9500(TRTCCloudImpl.this, paramInt, paramString);
        ...
        if (((TRTCRoomInfo.hasMainVideo(((TRTCRoomInfo.UserInfo)localObject).streamState)) || (TRTCRoomInfo.hasSmallVideo(((TRTCRoomInfo.UserInfo)localObject).streamState))) && (!TRTCRoomInfo.isMuteMainVideo(((TRTCRoomInfo.UserInfo)localObject).streamState))) {
          TRTCCloudImpl.this.runOnListenerThread(new Runnable()
          {
            public void run()
            {
              ...
              TRTCCloudListener localTRTCCloudListener = TRTCCloudImpl.this.mTRTCListener;
              TXCLog.i("TRTCCloudImpl", "notify onUserVideoAvailable:" + TRTCCloudImpl.135.this.val$tinyId + " [true] by IDR");
              if (localTRTCCloudListener != null)
              {
                localTRTCCloudListener.onUserVideoAvailable(str2, true);
                TRTCCloudImpl.access$9700(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), 0, String.format("[%s]video Available[%b]", new Object[] { str2, Boolean.TRUE }));
              }
      ...
      public void run()
      {
        ...
        TRTCCloudImpl.this.mRoomInfo.forEachUser(new TRTCRoomInfo.UserAction()
        {
          public void accept(String paramAnonymous2String, TRTCRoomInfo.UserInfo paramAnonymous2UserInfo)
          {
            ...
            if ((TRTCCloudImpl.117.this.val$stream != 1) && (TRTCCloudImpl.117.this.val$tinyID == paramAnonymous2UserInfo.tinyID))
            {
              TRTCCloudImpl.this.apiLog("onRequestDownStream " + paramAnonymous2UserInfo.tinyID + ", " + paramAnonymous2UserInfo.userID + ", " + TRTCCloudImpl.117.this.val$stream);
              if (TRTCCloudImpl.117.this.val$stream == 7)
              {
                if ((paramAnonymous2UserInfo.subRender.render != null) && (paramAnonymous2UserInfo.subRender.render.getStreamType() != TRTCCloudImpl.117.this.val$stream))
                {
                  paramAnonymous2UserInfo.subRender.render.stopVideo();
                  paramAnonymous2UserInfo.subRender.render.setStreamType(TRTCCloudImpl.117.this.val$stream);
                  paramAnonymous2UserInfo.subRender.render.startVideo();
                  AppMethodBeat.o(182294);
                }
              }
              else if ((paramAnonymous2UserInfo.mainRender.render != null) && (paramAnonymous2UserInfo.mainRender.render.getStreamType() != TRTCCloudImpl.117.this.val$stream))
              {
                paramAnonymous2UserInfo.mainRender.render.stopVideo();
                paramAnonymous2UserInfo.mainRender.render.setStreamType(TRTCCloudImpl.117.this.val$stream);
  ...
  private void setOrientation(final int paramInt)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$10800(TRTCCloudImpl.this, paramInt);
        if (TRTCCloudImpl.this.mSensorMode != 0) {
          TRTCCloudImpl.access$10900(TRTCCloudImpl.this, paramInt);
        }
  ...
  private void setRenderView(String paramString, TRTCRoomInfo.RenderInfo paramRenderInfo, TXCloudVideoView paramTXCloudVideoView, TRTCCloud.TRTCViewMargin paramTRTCViewMargin)
  {
    ...
    if (paramTXCloudVideoView != null)
    {
      ...
      if (localObject != null)
      {
        ...
        paramString = ((SurfaceView)localObject).getHolder();
        paramString.removeCallback(paramRenderInfo);
        paramString.addCallback(paramRenderInfo);
        if (paramString.getSurface().isValid())
        {
          apiLog("startRemoteView with valid surface " + paramString.getSurface() + " width " + ((SurfaceView)localObject).getWidth() + ", height " + ((SurfaceView)localObject).getHeight());
          paramRenderInfo.render.getVideoRender().a(paramString.getSurface());
          paramRenderInfo.render.getVideoRender().c(((SurfaceView)localObject).getWidth(), ((SurfaceView)localObject).getHeight());
          AppMethodBeat.o(15956);
          return;
        }
        apiLog("startRemoteView with surfaceView add callback ".concat(String.valueOf(paramRenderInfo)));
        AppMethodBeat.o(15956);
        return;
      }
      ...
      paramTXCloudVideoView.showVideoDebugLog(this.mDebugType);
      ...
      paramRenderInfo.render.getVideoRender().a((TextureView)localObject);
    }
    AppMethodBeat.o(15956);
  }
  ...
  private void stopRemoteRender(TRTCRoomInfo.UserInfo paramUserInfo)
  {
    ...
    if (paramUserInfo.mainRender.render != null)
    {
      paramUserInfo.mainRender.render.setVideoFrameListener(null, 0);
      paramUserInfo.mainRender.render.stop();
    }
    if (paramUserInfo.subRender.render != null)
    {
      paramUserInfo.subRender.render.setVideoFrameListener(null, 0);
  ...
  private void updateBigStreamEncoder(boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean2)
  {
    ...
    label260:
    for (this.mConfig.h = 20;; this.mConfig.h = paramInt3)
    {
      if (paramInt4 > 0) {
  ...
  public void ConnectOtherRoom(final String paramString)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$3700(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, paramString);
  ...
  public void DisconnectOtherRoom()
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$3800(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext);
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        try
        {
          ...
          {
            TRTCCloudImpl.access$6600(TRTCCloudImpl.this, localJSONObject1);
            AppMethodBeat.o(15561);
            return;
          }
        }
        ...
        {
          TRTCCloudImpl.access$6700(TRTCCloudImpl.this, localException);
          AppMethodBeat.o(15561);
          return;
        }
        if (str.equals("setVideoEncodeParamEx"))
        {
          TRTCCloudImpl.access$6800(TRTCCloudImpl.this, localException);
          AppMethodBeat.o(15561);
          return;
        }
        if (str.equals("setAudioSampleRate"))
        {
          TRTCCloudImpl.access$6900(TRTCCloudImpl.this, localException);
          AppMethodBeat.o(15561);
          return;
        }
        if (str.equals("muteRemoteAudioInSpeaker"))
        {
          TRTCCloudImpl.access$7000(TRTCCloudImpl.this, localException);
          AppMethodBeat.o(15561);
          return;
        }
        if (str.equals("enableAudioAGC"))
        {
          TRTCCloudImpl.access$7100(TRTCCloudImpl.this, localException);
          AppMethodBeat.o(15561);
          return;
        }
        if (str.equals("enableAudioAEC"))
        {
          TRTCCloudImpl.access$7200(TRTCCloudImpl.this, localException);
          AppMethodBeat.o(15561);
          return;
        }
        if (str.equals("enableAudioANS"))
        {
          TRTCCloudImpl.access$7300(TRTCCloudImpl.this, localException);
          AppMethodBeat.o(15561);
          return;
        }
        if (str.equals("setPerformanceMode"))
        {
          TRTCCloudImpl.access$7400(TRTCCloudImpl.this, localException);
          AppMethodBeat.o(15561);
          return;
        }
        ...
        {
          TRTCCloudImpl.access$7700(TRTCCloudImpl.this, localException, paramString);
          AppMethodBeat.o(15561);
          return;
        }
  ...
  public void enableAudioVolumeEvaluation(final int paramInt)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$6002(TRTCCloudImpl.this, i);
      ...
      public void run()
      {
        ...
        for (;;)
        {
          ...
          if (!TRTCCloudImpl.this.mIsAudioCapturing) {
            TRTCCloudImpl.access$5900(TRTCCloudImpl.this, paramBoolean);
          }
  ...
  public void enableCustomVideoCapture(final boolean paramBoolean)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        if (TRTCCloudImpl.this.mEnableCustomVideoCapture == paramBoolean)
        {
          AppMethodBeat.o(15772);
          return;
        }
        TRTCCloudImpl.access$3102(TRTCCloudImpl.this, paramBoolean);
        com.tencent.liteav.f localf;
        if (TRTCCloudImpl.this.mEnableCustomVideoCapture)
        {
          localf = TRTCCloudImpl.this.mConfig;
          localf.R |= 0x2;
          TRTCCloudImpl.access$6402(TRTCCloudImpl.this, 0L);
          if (TRTCCloudImpl.this.mCurrentRole == 21)
          {
            TRTCCloudImpl.this.runOnListenerThread(new Runnable()
            {
        ...
        for (;;)
        {
          ...
          if (!TRTCCloudImpl.this.mIsVideoCapturing) {
            TRTCCloudImpl.access$4200(TRTCCloudImpl.this, TRTCCloudImpl.this.mEnableCustomVideoCapture);
          }
          AppMethodBeat.o(15772);
          return;
          localf = TRTCCloudImpl.this.mConfig;
          ...
          try
          {
            if (TRTCCloudImpl.this.mCustomVideoUtil != null)
            {
              ...
              TRTCCloudImpl.access$6502(TRTCCloudImpl.this, null);
            }
          }
          finally
          {
  ...
  public int enableEncSmallVideoStream(final boolean paramBoolean, final TRTCCloudDef.TRTCVideoEncParam paramTRTCVideoEncParam)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        if (TRTCCloudImpl.this.mEnableSmallStream == paramBoolean)
        {
        ...
        TRTCCloudImpl.access$2700(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, TRTCCloudImpl.this.mEnableSmallStream);
        ...
        TRTCCloudImpl.this.mRoomInfo.smallEncSize = TRTCCloudImpl.access$5200(TRTCCloudImpl.this, TRTCCloudImpl.this.mSmallEncParam.videoResolution, TRTCCloudImpl.this.mSmallEncParam.videoResolutionMode);
        ...
        TRTCCloudImpl.access$5500(TRTCCloudImpl.this, 3);
        AppMethodBeat.o(16060);
      }
    });
  ...
  public void enterRoom(final TRTCCloudDef.TRTCParams paramTRTCParams, int paramInt)
  {
    ...
    if ((paramTRTCParams.sdkAppId == 0) || (TextUtils.isEmpty(paramTRTCParams.userId)) || (TextUtils.isEmpty(paramTRTCParams.userSig)))
    {
      apiLog("enterRoom param invalid:".concat(String.valueOf(paramTRTCParams)));
      if (paramTRTCParams.sdkAppId == 0) {
        onEnterRoom(-3317, "enter room sdkAppId invalid.");
      }
      if (TextUtils.isEmpty(paramTRTCParams.userSig)) {
        onEnterRoom(-3320, "enter room userSig invalid.");
      }
      if (TextUtils.isEmpty(paramTRTCParams.userId)) {
        onEnterRoom(-3319, "enter room userId invalid.");
      }
      AppMethodBeat.o(15785);
      return;
    }
    final long l = paramTRTCParams.roomId & 0xFFFFFFFF;
    if (l == 0L)
    {
    ...
    String str3 = "";
    Object localObject2 = paramTRTCParams.businessInfo;
    final String str2 = str3;
    Object localObject1 = localObject2;
    if (paramTRTCParams.roomId == -1)
    {
      str2 = str3;
      localObject1 = localObject2;
      if (!TextUtils.isEmpty(paramTRTCParams.businessInfo))
      {
        try
        {
          localObject2 = new JSONObject(paramTRTCParams.businessInfo);
          str3 = ((JSONObject)localObject2).optString("strGroupId");
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            apiLog("enter room, room id error, busInfo " + paramTRTCParams.businessInfo);
            str2 = "";
            str1 = "";
          }
        }
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        String str1 = paramTRTCParams.userId;
        int i = paramTRTCParams.sdkAppId;
        if (TextUtils.isEmpty(str2)) {}
        for (Object localObject1 = l;; localObject1 = str2)
        {
          Monitor.a(str1, i, (String)localObject1);
          if (TRTCCloudImpl.this.mRoomState == 0) {
            break label218;
          }
          if (((TextUtils.isEmpty(str2)) || (!str2.equalsIgnoreCase(TRTCCloudImpl.this.mRoomInfo.strRoomId))) && (TRTCCloudImpl.this.mRoomInfo.roomId != l)) {
            break;
          }
        ...
        TRTCCloudImpl.this.apiLog("========================================================================================================");
        TRTCCloudImpl.this.apiLog(String.format("============= SDK Version:%s Device Name:%s System Version:%s =============", new Object[] { TXCCommonUtil.getSDKVersionStr(), com.tencent.liteav.basic.util.d.c(), com.tencent.liteav.basic.util.d.d() }));
        TRTCCloudImpl.this.apiLog("========================================================================================================");
        TRTCCloudImpl.this.apiLog("========================================================================================================");
        TRTCCloudImpl.this.apiLog(String.format("enterRoom roomId:%d(%s)  userId:%s sdkAppId:%d scene:%d", new Object[] { Long.valueOf(l), str2, paramTRTCParams.userId, Integer.valueOf(paramTRTCParams.sdkAppId), Integer.valueOf(str1) }));
        TRTCCloudImpl.this.apiLog(TRTCCloudImpl.this);
        Object localObject2 = "enterRoom:" + TRTCCloudImpl.this.hashCode();
        i = str1;
        ...
        {
        default: 
          TXCLog.w("TRTCCloudImpl", "enter room scene:%u error! default to VideoCall! " + str1);
          i = 0;
          if (!TRTCCloudImpl.this.mIsSetVolumeType)
          {
          ...
          {
            localObject3 = this.val$finalStrBussInfo;
            if (this.val$finalRole != 20) {
              break label1383;
            }
            str1 = "Anchor";
            Monitor.a(1, (String)localObject2, String.format("bussInfo:%s, appScene:%s, role:%s, streamid:%s", new Object[] { localObject3, localObject1, str1, paramTRTCParams.streamId }), 0);
            ...
            boolean bool = true;
            i = 1;
            if ((str1 != 0) || (TRTCCloudImpl.this.mCodecType != 2))
            {
              bool = false;
              i = 0;
            }
            ...
            label899:
            TRTCCloudImpl.this.mCaptureAndEnc.a(TRTCCloudImpl.this.mEnableSmallStream, TRTCCloudImpl.this.mRoomInfo.smallEncSize.a, TRTCCloudImpl.this.mRoomInfo.smallEncSize.b, TRTCCloudImpl.this.mSmallEncParam.videoFps, TRTCCloudImpl.this.mSmallEncParam.videoBitrate);
            str1 = com.tencent.liteav.basic.util.d.d();
            localObject2 = com.tencent.liteav.basic.util.d.c();
            TRTCCloudImpl.access$1700(TRTCCloudImpl.this, (String)localObject2, str1, paramTRTCParams.sdkAppId);
            j = paramTRTCParams.sdkAppId;
            localObject3 = TXCCommonUtil.getSDKVersionStr();
            if (TRTCCloudImpl.this.mContext == null) {
              break label1440;
            }
            localObject1 = TRTCCloudImpl.this.mContext.getPackageName();
            label1026:
            TXCKeyPointReportProxy.a((String)localObject2, str1, j, (String)localObject3, (String)localObject1);
            ...
            TRTCCloudImpl.access$2100(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, paramTRTCParams.sdkAppId, paramTRTCParams.userId, paramTRTCParams.userSig, (byte[])localObject1);
            if (paramTRTCParams.privateMapKey == null) {
              break label1447;
            }
            localObject1 = paramTRTCParams.privateMapKey;
            label1135:
            if (str2 == null) {
              break label1454;
            }
            ...
            localObject2 = this.val$finalStrBussInfo;
            label1161:
            if (paramTRTCParams.userDefineRecordId == null) {
              break label1468;
            }
            localObject3 = paramTRTCParams.userDefineRecordId;
            label1180:
            if (paramTRTCParams.streamId == null) {
              break label1475;
            }
          }
          break;
        ...
        label1468:
        label1475:
        for (String str2 = paramTRTCParams.streamId;; str2 = "")
        {
          TRTCCloudImpl.access$2400(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, l, (String)localObject2, (String)localObject1, str1, this.val$finalRole, 255, i, str1, TRTCCloudImpl.this.mPerformanceMode, com.tencent.liteav.basic.util.d.c(), com.tencent.liteav.basic.util.d.d(), TRTCCloudImpl.this.mRecvMode, (String)localObject3, str2);
          localObject2 = TRTCCloudImpl.this.mStreamTypes.iterator();
          while (((Iterator)localObject2).hasNext())
          {
            localObject3 = (Integer)((Iterator)localObject2).next();
            TRTCCloudImpl.access$2600(TRTCCloudImpl.this, ((Integer)localObject3).intValue());
          }
          localObject1 = "VideoCall";
          break;
          localObject1 = "Live";
        ...
        TRTCCloudImpl.access$2700(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, TRTCCloudImpl.this.mEnableSmallStream);
        TRTCCloudImpl.access$2800(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, TRTCCloudImpl.this.mCaptureAndEnc.i());
        ...
        TRTCCloudImpl.access$3400(TRTCCloudImpl.this);
        TRTCCloudImpl.access$3502(TRTCCloudImpl.this, 0L);
        TRTCCloudImpl.this.mRoomInfo.init(l, paramTRTCParams.userId);
        TRTCCloudImpl.this.mRoomInfo.strRoomId = str1;
        TRTCCloudImpl.this.mRoomInfo.sdkAppId = paramTRTCParams.sdkAppId;
        TRTCCloudImpl.this.mRoomInfo.userSig = paramTRTCParams.userSig;
  ...
  protected void exitRoomInternal(boolean paramBoolean)
  {
    ...
    this.mRoomInfo.forEachUser(new TRTCRoomInfo.UserAction()
    {
      public void accept(String paramAnonymousString, TRTCRoomInfo.UserInfo paramAnonymousUserInfo)
      {
        ...
        TRTCCloudImpl.access$3600(TRTCCloudImpl.this, paramAnonymousUserInfo);
        com.tencent.liteav.audio.a.a().d(String.valueOf(paramAnonymousUserInfo.tinyID));
        if (paramAnonymousUserInfo.mainRender.render != null) {
          paramAnonymousUserInfo.mainRender.render.setVideoFrameListener(null, 0);
        }
        if (paramAnonymousUserInfo.subRender.render != null) {
          paramAnonymousUserInfo.subRender.render.setVideoFrameListener(null, 0);
        }
      ...
      public void run()
      {
        ...
        TRTCCloudImpl.this.mRoomInfo.forEachUser(new TRTCRoomInfo.UserAction()
        {
          public void accept(String paramAnonymous2String, TRTCRoomInfo.UserInfo paramAnonymous2UserInfo)
          {
            ...
            paramAnonymous2UserInfo.mainRender.muteAudio = TRTCCloudImpl.41.this.val$mute;
            com.tencent.liteav.audio.a.a().c(String.valueOf(paramAnonymous2UserInfo.tinyID), TRTCCloudImpl.41.this.val$mute);
            if (TRTCCloudImpl.41.this.val$mute)
            {
      ...
      public void run()
      {
        ...
        TRTCCloudImpl.this.mRoomInfo.forEachUser(new TRTCRoomInfo.UserAction()
        {
          public void accept(String paramAnonymous2String, TRTCRoomInfo.UserInfo paramAnonymous2UserInfo)
          {
            ...
            paramAnonymous2UserInfo.mainRender.muteVideo = TRTCCloudImpl.22.this.val$mute;
            TRTCCloudImpl.this.apiLog("muteRemoteVideoStream " + paramAnonymous2UserInfo.userID + ", mute " + TRTCCloudImpl.22.this.val$mute);
            if (paramAnonymous2UserInfo.mainRender.render != null) {
              paramAnonymous2UserInfo.mainRender.render.muteVideo(TRTCCloudImpl.22.this.val$mute);
            }
            if (TRTCCloudImpl.22.this.val$mute)
            {
  ...
  public void muteLocalAudio(final boolean paramBoolean)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$5100(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, 1, paramBoolean);
        if (paramBoolean)
        {
  ...
  public void muteLocalVideo(final boolean paramBoolean)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        {
          TRTCCloudImpl.access$4200(localTRTCCloudImpl, bool);
          TRTCCloudImpl.access$2800(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, TRTCCloudImpl.this.mCaptureAndEnc.i());
          TRTCCloudImpl.access$5100(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, 2, paramBoolean);
  ...
  protected void notifyEvent(final String paramString, final int paramInt, final Bundle paramBundle)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$10100(TRTCCloudImpl.this, paramString, paramBundle.getInt("EVT_STREAM_TYPE", 2), paramBundle.getString("EVT_MSG", ""), String.format("event %d, ", new Object[] { Integer.valueOf(paramInt) }));
        final int i;
        if (paramInt == 2029)
        {
        ...
        for (;;)
        {
          ...
          TRTCCloudImpl.this.runOnListenerThread(new Runnable()
          {
            public void run()
            {
              ...
              if (TRTCCloudImpl.148.this.val$eventCode == 2003)
              {
                if ((TRTCCloudImpl.148.this.val$userId != null) && (TRTCCloudImpl.148.this.val$userId.equals(TRTCCloudImpl.this.mRoomInfo.getUserId())))
                {
                  TRTCCloudImpl.this.apiLog("onFirstVideoFrame local");
                  localTRTCCloudListener.onFirstVideoFrame(null, i, TRTCCloudImpl.148.this.val$eventParam.getInt("EVT_PARAM1"), TRTCCloudImpl.148.this.val$eventParam.getInt("EVT_PARAM2"));
                  AppMethodBeat.o(182292);
                  return;
                }
                TRTCCloudImpl.this.apiLog("onFirstVideoFrame " + TRTCCloudImpl.148.this.val$userId);
                localTRTCCloudListener.onFirstVideoFrame(TRTCCloudImpl.148.this.val$userId, i, TRTCCloudImpl.148.this.val$eventParam.getInt("EVT_PARAM1"), TRTCCloudImpl.148.this.val$eventParam.getInt("EVT_PARAM2"));
                AppMethodBeat.o(182292);
                return;
              }
              if (TRTCCloudImpl.148.this.val$eventCode == 2026)
              {
                TRTCCloudImpl.this.apiLog("onFirstAudioFrame " + TRTCCloudImpl.148.this.val$userId);
                localTRTCCloudListener.onFirstAudioFrame(TRTCCloudImpl.148.this.val$userId);
                AppMethodBeat.o(182292);
                return;
              }
              if (TRTCCloudImpl.148.this.val$eventCode == 1003)
              {
              ...
              if (TRTCCloudImpl.148.this.val$eventCode == 2027)
              {
              ...
              if (TRTCCloudImpl.148.this.val$eventCode < 0)
              {
                localTRTCCloudListener.onError(TRTCCloudImpl.148.this.val$eventCode, TRTCCloudImpl.148.this.val$eventParam.getString("EVT_MSG", ""), TRTCCloudImpl.148.this.val$eventParam);
                Monitor.a(3, String.format("onError event:%d, msg:%s", new Object[] { Integer.valueOf(TRTCCloudImpl.148.this.val$eventCode), TRTCCloudImpl.148.this.val$eventParam }), "", 0);
                AppMethodBeat.o(182292);
                return;
              }
              if (((TRTCCloudImpl.148.this.val$eventCode > 1100) && (TRTCCloudImpl.148.this.val$eventCode < 1110)) || ((TRTCCloudImpl.148.this.val$eventCode > 2100) && (TRTCCloudImpl.148.this.val$eventCode < 2110)) || ((TRTCCloudImpl.148.this.val$eventCode > 3001) && (TRTCCloudImpl.148.this.val$eventCode < 3011)) || ((TRTCCloudImpl.148.this.val$eventCode > 5100) && (TRTCCloudImpl.148.this.val$eventCode < 5104)))
              {
                localTRTCCloudListener.onWarning(TRTCCloudImpl.148.this.val$eventCode, TRTCCloudImpl.148.this.val$eventParam.getString("EVT_MSG", ""), TRTCCloudImpl.148.this.val$eventParam);
                if (TRTCCloudImpl.148.this.val$eventCode != 2105) {
                  Monitor.a(1, String.format("onWarning event:%d, msg:%s", new Object[] { Integer.valueOf(TRTCCloudImpl.148.this.val$eventCode), TRTCCloudImpl.148.this.val$eventParam }), "", 0);
                }
              }
              AppMethodBeat.o(182292);
            }
  ...
  public void onAudioJitterBufferNotify(final String paramString1, final int paramInt, final String paramString2)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        localBundle.putLong("EVT_TIME", System.currentTimeMillis());
        localBundle.putString("EVT_MSG", paramString2);
        TRTCCloudImpl.access$9100(TRTCCloudImpl.this, paramString1, paramInt, localBundle);
  ...
  public void onNotifyEvent(final int paramInt, final Bundle paramBundle)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$9100(TRTCCloudImpl.this, str, paramInt, paramBundle);
        AppMethodBeat.o(15571);
      }
    });
  ...
  public void onRequestKeyFrame(final String paramString, final int paramInt)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$9200(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, Long.valueOf(paramString).longValue(), paramInt);
  ...
  protected void onSendFirstLocalAudioFrame()
  {
    ...
    runOnListenerThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$9700(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), 0, "onSendFirstLocalAudioFrame");
        TRTCCloudListener localTRTCCloudListener = TRTCCloudImpl.this.mTRTCListener;
        if (localTRTCCloudListener != null) {
  ...
  protected void onSendFirstLocalVideoFrame(final int paramInt)
  {
    ...
    runOnListenerThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$9700(TRTCCloudImpl.this, TRTCCloudImpl.this.mRoomInfo.getUserId(), 0, "onSendFirstLocalVideoFrame:".concat(String.valueOf(i)));
        TRTCCloudListener localTRTCCloudListener = TRTCCloudImpl.this.mTRTCListener;
        if (localTRTCCloudListener != null) {
  ...
  public void selectMotionTmpl(final String paramString)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        com.tencent.liteav.basic.b.e.a().a(null, TRTCCloudImpl.this.mContext);
        TRTCCloudImpl.this.mCaptureAndEnc.a(paramString);
      ...
      if (bool) {
        runOnSDKThread(new Runnable()
        {
          public void run()
          {
            ...
            TRTCCloudImpl.access$8900(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, paramInt, paramArrayOfByte, paramBoolean1, paramBoolean2);
      ...
      if (bool) {
        runOnSDKThread(new Runnable()
        {
          public void run()
          {
            ...
            TRTCCloudImpl.access$9000(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, paramArrayOfByte, paramInt);
      ...
      public void run()
      {
        ...
        TRTCCloudImpl.this.mRoomInfo.forEachUser(new TRTCRoomInfo.UserAction()
        {
          public void accept(String paramAnonymous2String, TRTCRoomInfo.UserInfo paramAnonymous2UserInfo)
          {
            ...
            com.tencent.liteav.audio.a.a().a(String.valueOf(paramAnonymous2UserInfo.tinyID), TRTCCloudImpl.100.this.val$refThis);
  ...
  public void setBeautyStyle(final int paramInt1, final int paramInt2, final int paramInt3, final int paramInt4)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.this.mCaptureAndEnc.i(paramInt1);
        TRTCCloudImpl.this.mCaptureAndEnc.b(paramInt2, paramInt3, paramInt4);
  ...
  public void setChinLevel(final int paramInt)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        com.tencent.liteav.basic.b.e.a().a(null, TRTCCloudImpl.this.mContext);
        TRTCCloudImpl.this.mCaptureAndEnc.n(paramInt);
        ...
        if ((localTXCloudVideoView != null) && (paramString.equalsIgnoreCase(localTXCloudVideoView.getUserId()))) {
          TRTCCloudImpl.this.runOnMainThread(new Runnable()
          {
            public void run()
            {
              ...
              localTXCloudVideoView.setLogMarginRatio(TRTCCloudImpl.90.this.val$margin.leftMargin, TRTCCloudImpl.90.this.val$margin.rightMargin, TRTCCloudImpl.90.this.val$margin.topMargin, TRTCCloudImpl.90.this.val$margin.bottomMargin);
            ...
            TRTCCloudImpl.this.runOnMainThread(new Runnable()
            {
              public void run()
              {
                ...
                if (this.val$remoteSubView != null) {
                  this.val$remoteSubView.setLogMarginRatio(TRTCCloudImpl.90.this.val$margin.leftMargin, TRTCCloudImpl.90.this.val$margin.rightMargin, TRTCCloudImpl.90.this.val$margin.topMargin, TRTCCloudImpl.90.this.val$margin.bottomMargin);
                }
  ...
  public void setFaceShortLevel(final int paramInt)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        com.tencent.liteav.basic.b.e.a().a(null, TRTCCloudImpl.this.mContext);
        TRTCCloudImpl.this.mCaptureAndEnc.m(paramInt);
  ...
  public void setFaceSlimLevel(final int paramInt)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        com.tencent.liteav.basic.b.e.a().a(null, TRTCCloudImpl.this.mContext);
        TRTCCloudImpl.this.mCaptureAndEnc.k(paramInt);
  ...
  public void setFaceVLevel(final int paramInt)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        com.tencent.liteav.basic.b.e.a().a(null, TRTCCloudImpl.this.mContext);
        TRTCCloudImpl.this.mCaptureAndEnc.l(paramInt);
  ...
  public void setFilter(final Bitmap paramBitmap)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.this.mCaptureAndEnc.a(paramBitmap);
  ...
  public void setFilterConcentration(final float paramFloat)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.this.mCaptureAndEnc.a(paramFloat);
  ...
  public void setGSensorMode(final int paramInt)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$5402(TRTCCloudImpl.this, paramInt);
  ...
  public boolean setGreenScreenFile(final String paramString)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        com.tencent.liteav.basic.b.e.a().a(null, TRTCCloudImpl.this.mContext);
        TRTCCloudImpl.this.mCaptureAndEnc.b(paramString);
  ...
  public void setLocalViewMirror(final int paramInt)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$5602(TRTCCloudImpl.this, paramInt);
  ...
  public void setMixTranscodingConfig(final TRTCCloudDef.TRTCTranscodingConfig paramTRTCTranscodingConfig)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$8800(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, paramTRTCTranscodingConfig);
  ...
  public void setNoseSlimLevel(final int paramInt)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        com.tencent.liteav.basic.b.e.a().a(null, TRTCCloudImpl.this.mContext);
        TRTCCloudImpl.this.mCaptureAndEnc.o(paramInt);
        ...
        for (;;)
        {
          TRTCCloudImpl.this.mRoomInfo.forEachUser(new TRTCRoomInfo.UserAction()
          {
            public void accept(String paramAnonymous2String, TRTCRoomInfo.UserInfo paramAnonymous2UserInfo)
            {
              ...
              if (paramAnonymous2String.equalsIgnoreCase(TRTCCloudImpl.66.this.val$userId))
              {
                localRenderListenerAdapter = (TRTCCloudImpl.RenderListenerAdapter)TRTCCloudImpl.this.mRenderListenerMap.get(TRTCCloudImpl.66.this.val$userId);
                if (localRenderListenerAdapter != null) {
                  localRenderListenerAdapter.strTinyID = String.valueOf(paramAnonymous2UserInfo.tinyID);
                }
                if (TRTCCloudImpl.66.this.val$listener == null) {
                  break label132;
                }
              }
              label132:
              ...
              {
                if (paramAnonymous2UserInfo.mainRender.render != null) {
                  paramAnonymous2UserInfo.mainRender.render.setVideoFrameListener(paramAnonymous2String, localRenderListenerAdapter.pixelFormat);
                }
                if (paramAnonymous2UserInfo.subRender.render != null) {
                  paramAnonymous2UserInfo.subRender.render.setVideoFrameListener(paramAnonymous2String, localRenderListenerAdapter.pixelFormat);
                }
          ...
          TRTCCloudImpl.access$8002(TRTCCloudImpl.this, true);
        }
      }
    });
    AppMethodBeat.o(15870);
  ...
  public void setVideoEncoderParam(final TRTCCloudDef.TRTCVideoEncParam paramTRTCVideoEncParam)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        if (paramTRTCVideoEncParam != null)
        {
          f.a locala = TRTCCloudImpl.access$5200(TRTCCloudImpl.this, paramTRTCVideoEncParam.videoResolution, paramTRTCVideoEncParam.videoResolutionMode);
          TRTCCloudImpl localTRTCCloudImpl = TRTCCloudImpl.this;
          if (paramTRTCVideoEncParam.videoResolutionMode == 1) {}
          for (boolean bool = true;; bool = false)
          {
            TRTCCloudImpl.access$5300(localTRTCCloudImpl, bool, locala.a, locala.b, paramTRTCVideoEncParam.videoFps, paramTRTCVideoEncParam.videoBitrate, paramTRTCVideoEncParam.enableAdjustRes);
            TRTCCloudImpl.this.apiLog("vsize setVideoEncoderParam->width:" + TRTCCloudImpl.this.mRoomInfo.bigEncSize.a + ", height:" + TRTCCloudImpl.this.mRoomInfo.bigEncSize.b + ", fps:" + paramTRTCVideoEncParam.videoFps + ", bitrate:" + paramTRTCVideoEncParam.videoBitrate + ", mode:" + paramTRTCVideoEncParam.videoResolutionMode);
            Monitor.a(1, String.format("setVideoEncoderParam width:%d, height:%d, fps:%d, bitrate:%d, mode:%d", new Object[] { Integer.valueOf(TRTCCloudImpl.this.mRoomInfo.bigEncSize.a), Integer.valueOf(TRTCCloudImpl.this.mRoomInfo.bigEncSize.b), Integer.valueOf(paramTRTCVideoEncParam.videoFps), Integer.valueOf(paramTRTCVideoEncParam.videoBitrate), Integer.valueOf(paramTRTCVideoEncParam.videoResolutionMode) }), "", 0);
            TRTCCloudImpl.access$4100(TRTCCloudImpl.this);
  ...
  public void setZoom(final int paramInt)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.this.mCaptureAndEnc.p(paramInt);
        ...
        if (localTXCloudVideoView != null) {
          TRTCCloudImpl.this.runOnMainThread(new Runnable()
          {
            public void run()
            {
              ...
              localTXCloudVideoView.showVideoDebugLog(TRTCCloudImpl.89.this.val$showType);
              ...
              TRTCCloudImpl.this.runOnMainThread(new Runnable()
              {
                public void run()
                {
                  ...
                  if (paramAnonymous2String != null) {
                    paramAnonymous2String.showVideoDebugLog(TRTCCloudImpl.89.this.val$showType);
                  }
                  if (paramAnonymous2UserInfo != null) {
                    paramAnonymous2UserInfo.showVideoDebugLog(TRTCCloudImpl.89.this.val$showType);
                  }
  ...
  public void startLocalAudio()
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$3302(TRTCCloudImpl.this, true);
        TRTCCloudImpl.this.mCaptureAndEnc.a(TRTCCloudImpl.this.mConfig);
        ...
        TXCEventRecorderProxy.a("18446744073709551615", 3003, 11L, -1L, "", 0);
        TRTCCloudImpl.access$5900(TRTCCloudImpl.this, true);
        AppMethodBeat.o(15625);
      }
    });
  ...
  public void startLocalPreview(final boolean paramBoolean, final TXCloudVideoView paramTXCloudVideoView)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        final boolean bool2 = TRTCCloudImpl.this.mIsVideoCapturing;
        if (TRTCCloudImpl.this.mCurrentRole == 21)
        {
          TRTCCloudImpl.this.runOnListenerThread(new Runnable()
          {
        ...
        StringBuilder localStringBuilder = new StringBuilder("startLocalPreview front:").append(paramBoolean).append(", view:");
        Object localObject;
        if (paramTXCloudVideoView != null)
        {
          localObject = Integer.valueOf(paramTXCloudVideoView.hashCode());
          localObject = localObject + " " + TRTCCloudImpl.this.hashCode();
          TRTCCloudImpl.this.apiLog((String)localObject);
          Monitor.a(1, (String)localObject, "", 0);
          TRTCCloudImpl.access$3202(TRTCCloudImpl.this, true);
          TRTCCloudImpl.this.mRoomInfo.localView = paramTXCloudVideoView;
          TRTCCloudImpl.this.mConfig.m = paramBoolean;
          localObject = TRTCCloudImpl.this.mConfig;
        ...
        {
          ((com.tencent.liteav.f)localObject).W = bool1;
          TRTCCloudImpl.this.mCaptureAndEnc.a(TRTCCloudImpl.this.mConfig);
          TRTCCloudImpl.this.mOrientationEventListener.enable();
          TRTCCloudImpl.access$4100(TRTCCloudImpl.this);
          TRTCCloudImpl.access$4200(TRTCCloudImpl.this, true);
          TRTCCloudImpl.this.runOnMainThread(new Runnable()
          {
            public void run()
            {
              ...
              for (SurfaceView localSurfaceView = TRTCCloudImpl.10.this.val$view.getSurfaceView();; localSurfaceView = null)
              {
                if (localSurfaceView != null) {
                  if ((!bool2) && (!TRTCCloudImpl.this.mEnableCustomVideoCapture))
                  {
                    ...
                    TRTCCloudImpl.this.apiLog("startLocalPreview with valid surface " + localSurfaceHolder.getSurface() + " width " + localSurfaceView.getWidth() + ", height " + localSurfaceView.getHeight());
                    TRTCCloudImpl.this.mCaptureAndEnc.a(localSurfaceHolder.getSurface());
                    TRTCCloudImpl.this.mCaptureAndEnc.a(localSurfaceView.getWidth(), localSurfaceView.getHeight());
                  }
                }
                for (;;)
                {
                  ...
                  continue;
                  if (!bool2) {
                    TRTCCloudImpl.this.mCaptureAndEnc.a(TRTCCloudImpl.10.this.val$view);
                  } else {
  ...
  public void startPublishCDNStream(final TRTCCloudDef.TRTCPublishCDNParam paramTRTCPublishCDNParam)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$8400(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, paramTRTCPublishCDNParam);
  ...
  public void startPublishing(final String paramString, final int paramInt)
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$8700(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, paramString, i);
      ...
      public void run()
      {
        ...
        TRTCCloudImpl.this.runOnMainThread(new Runnable()
        {
          public void run()
          {
            ...
            TRTCCloudImpl.access$4400(TRTCCloudImpl.this, TRTCCloudImpl.14.this.val$userId, localUserInfo.subRender, TRTCCloudImpl.14.this.val$view, localUserInfo.debugMargin);
      ...
      public void run()
      {
        ...
        TRTCCloudImpl.this.runOnMainThread(new Runnable()
        {
          public void run()
          {
            ...
            TRTCCloudImpl.access$4400(TRTCCloudImpl.this, TRTCCloudImpl.12.this.val$userId, localUserInfo.mainRender, TRTCCloudImpl.12.this.val$view, localUserInfo.debugMargin);
            AppMethodBeat.o(15622);
          }
        });
        Object localObject = String.format("Remote-startRemoteView userID:%s tinyID:%d streamType:%d", new Object[] { paramString, Long.valueOf(localUserInfo.tinyID), Integer.valueOf(localUserInfo.streamType) });
        TRTCCloudImpl.this.apiLog((String)localObject);
        Monitor.a(1, (String)localObject, "", 0);
        ...
        if ((paramTXCloudVideoView == null) && (localUserInfo.mainRender.render != null))
        {
          localObject = localUserInfo.mainRender.render.getConfig();
          if (localObject != null) {
            ((g)localObject).h = false;
          }
        }
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        if (TRTCCloudImpl.this.mSpeedTestHandler == null)
        {
          ...
          TRTCCloudImpl.access$8102(TRTCCloudImpl.this, new Handler(localHandlerThread.getLooper()));
        }
  ...
  public void stopLocalAudio()
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$3302(TRTCCloudImpl.this, false);
        com.tencent.liteav.audio.a.a().c();
        TRTCCloudImpl.access$5900(TRTCCloudImpl.this, false);
        AppMethodBeat.o(15601);
      }
    });
  ...
  public void stopLocalPreview()
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$3202(TRTCCloudImpl.this, false);
        ...
        TRTCCloudImpl.access$4200(TRTCCloudImpl.this, false);
        AppMethodBeat.o(15691);
      }
    });
  ...
  public void stopPublishCDNStream()
  {
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        TRTCCloudImpl.access$8600(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext);
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        if (TRTCCloudImpl.this.mSpeedTestHandler != null)
        {
          ...
          TRTCCloudImpl.access$8102(TRTCCloudImpl.this, null);
        }
    ...
    runOnSDKThread(new Runnable()
    {
      public void run()
      {
        ...
        for (String str = "Anchor";; str = "Audience")
        {
          ...
          TRTCCloudImpl.access$3900(TRTCCloudImpl.this, TRTCCloudImpl.this.mNativeRtcContext, paramInt);
    ...
    extends OrientationEventListener
  {
    ...
    public void checkOrientation()
    {
      ...
      {
        int i = TRTCCloudImpl.access$11000(localTRTCCloudImpl);
        if (this.mCurrentDisplayRotation != i)
        {
          this.mCurrentDisplayRotation = i;
          TRTCCloudImpl.access$11100(localTRTCCloudImpl, this.mCurOrientation);
        }
      }
    ...
    public void onOrientationChanged(int paramInt)
    {
      ...
      for (;;)
      {
        if (this.mCurOrientation != i)
        {
          ...
          if (localTRTCCloudImpl != null)
          {
            this.mCurrentDisplayRotation = TRTCCloudImpl.access$11000(localTRTCCloudImpl);
            TRTCCloudImpl.access$11100(localTRTCCloudImpl, this.mCurOrientation);
          }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      int j = com.tencent.liteav.basic.util.d.e(localTRTCCloudImpl.mContext);
      int[] arrayOfInt = com.tencent.liteav.basic.util.d.a();
      int i = com.tencent.liteav.basic.util.d.b();
      ...
      long l;
      if (com.tencent.liteav.basic.util.d.a(localTRTCCloudImpl.mContext))
      {
        TXCStatus.a("18446744073709551615", 11004, Integer.valueOf(1));
        i = 1;
        if (TRTCCloudImpl.access$10200(localTRTCCloudImpl) != j)
        {
          if ((TRTCCloudImpl.access$10200(localTRTCCloudImpl) >= 0) && (j > 0)) {
            TRTCCloudImpl.access$10300(localTRTCCloudImpl, localTRTCCloudImpl.mNativeRtcContext, 100);
          }
          if (j != 0) {
            break label363;
          }
          ...
          Monitor.a(2, String.format("network switch from:%d to %d", new Object[] { Integer.valueOf(TRTCCloudImpl.access$10200(localTRTCCloudImpl)), Integer.valueOf(j) }), "1:wifi网络/2:4G网络/3:3G网络/4:2G网络/5:有线网络", 0);
          TRTCCloudImpl.access$10202(localTRTCCloudImpl, j);
        }
        if (localTRTCCloudImpl.mBackground != i)
        {
          TXCEventRecorderProxy.a("18446744073709551615", 2001, i, -1L, "", 0);
          TRTCCloudImpl.access$10402(localTRTCCloudImpl, i);
          if (i != 0) {
            break label369;
          }
      ...
      for (;;)
      {
        ...
        TRTCCloudImpl.access$10500(localTRTCCloudImpl);
        localTRTCCloudImpl.checkDashBoard();
        TRTCCloudImpl.access$10600(localTRTCCloudImpl);
        TRTCCloudImpl.access$3400(localTRTCCloudImpl);
