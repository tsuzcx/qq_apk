...
public class MainThreadHandler
{
  ...
  public static void post(long paramLong1, long paramLong2, int paramInt)
  {
    ...
    f.GA().post(new a(paramInt, paramLong1, paramLong2, (byte)0));
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      if (this.cqq <= 1)
      {
        MainThreadHandler.access$000(this.cqr, this.data);
        AppMethodBeat.o(140002);
        return;
      }
      MainThreadHandler.post(this.cqr, this.data, this.cqq - 1);
      AppMethodBeat.o(140002);
    }
  }
}
