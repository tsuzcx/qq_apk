  ...
  implements d
{
  ...
  public final void a(int paramInt1, int paramInt2, Rect paramRect)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localb1 = (d.b)this.mNodes.get(i1);
        int i3 = m;
        if (localb1.y > m) {
          i3 = localb1.y;
        }
      ...
      while ((localc.x < 0) || (localc.y < 0))
      {
        ...
        {
          localb1 = (d.b)this.mNodes.get(i);
          localb2 = (d.b)this.mNodes.get(i - 1);
  ...
  public final void reset()
  {
    ...
    d.b localb = this.cNO.Ry();
    localb.im(this.mWidth - 2);
