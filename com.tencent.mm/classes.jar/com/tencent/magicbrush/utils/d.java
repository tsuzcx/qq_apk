...
public abstract class d<R>
{
  ...
  private Runnable csM = new Runnable()
  {
    public final void run()
    {
      ...
      c.c.i("MicroMsg.SDK.SyncTask", "task run manualFinish = " + d.this.csL, new Object[0]);
      if (d.this.csL) {
        d.this.run();
      }
      for (;;)
      {
        d.this.csK = h.aS(d.this.csJ);
        AppMethodBeat.o(161137);
        return;
        d.this.aH(d.this.run());
      }
    }
  };
  ...
  public final R b(com.tencent.magicbrush.handler.a parama)
  {
    ...
    //   31: aload_0
    //   32: invokestatic 78	com/tencent/magicbrush/utils/h:GC	()J
    //   35: putfield 80	com/tencent/magicbrush/utils/d:csJ	J
    //   38: aload_0
    ...
    //   58: aload_1
    //   59: aload_0
    //   60: getfield 33	com/tencent/magicbrush/utils/d:csM	Ljava/lang/Runnable;
    //   63: iconst_0
    //   64: invokeinterface 88 3 0
    //   69: aload_0
    //   70: getfield 26	com/tencent/magicbrush/utils/d:lock	Ljava/lang/Object;
    //   73: aload_0
    //   74: getfield 35	com/tencent/magicbrush/utils/d:csI	J
    //   77: invokevirtual 91	java/lang/Object:wait	(J)V
    //   80: aload 4
    //   82: monitorexit
    //   83: aload_0
    //   84: getfield 80	com/tencent/magicbrush/utils/d:csJ	J
    //   87: invokestatic 95	com/tencent/magicbrush/utils/h:aS	(J)J
    //   90: lstore_2
    //   91: ldc 43
    //   93: ldc 97
    //   95: iconst_4
    ...
    //   127: iconst_2
    //   128: aload_0
    //   129: getfield 116	com/tencent/magicbrush/utils/d:csK	J
    ...
    //   138: lload_2
    //   139: aload_0
    //   140: getfield 116	com/tencent/magicbrush/utils/d:csK	J
    //   143: lsub
