...
public final class b
{
  ...
  public static void a(a parama)
  {
    ...
    a.a(new a.a()
    {
      public final void loadLibrary(String paramAnonymousString)
      {
        ...
        this.cqe.loadLibrary(paramAnonymousString);
  ...
  public static void loadLibraries()
  {
    ...
    cqd.loadLibrary("mmavmedia");
    cqd.loadLibrary("mmmediasdk");
    cqd.loadLibrary("mmbox2d");
    long l1 = h.GC();
    cqd.loadLibrary("mmv8");
    long l2 = h.GC();
    cqd.loadLibrary("magicbrush");
    sLibraryLoaded = true;
    c.c.i("MagicBrush", "load mmv8 cost [%d]ms, load magicbrush cost [%d]ms", new Object[] { Long.valueOf(h.aS(l2)), Long.valueOf(l2 - l1) });
    AppMethodBeat.o(139959);
  }
