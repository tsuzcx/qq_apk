...
public class VideoDecoderManager
{
  ...
  public IVideoDecoder createDecoder(String paramString, int paramInt, VideoDecoderManager.DECODE_TYPE paramDECODE_TYPE)
  {
    if (paramDECODE_TYPE == VideoDecoderManager.DECODE_TYPE.SOFTWARE) {
