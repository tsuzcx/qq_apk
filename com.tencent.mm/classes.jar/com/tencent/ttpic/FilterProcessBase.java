...
public class FilterProcessBase
{
  ...
  BaseFilter mFilter = a.dY(0);
  int mHaveFrameCount = 0;
  protected CameraFilterParamSDK mParam = new CameraFilterParamSDK();
  com.tencent.filter.h mPreviewFrame = new com.tencent.filter.h();
  ...
  static
  {
    int i = 0;
    SHOW_DELAY_COUNT = 0;
    SHOW_DELAY_COUNT = com.tencent.util.h.cRm().xcN;
    if (!com.tencent.util.h.cRm().xcP)
    {
      com.tencent.util.h localh = com.tencent.util.h.cRm();
      if ((localh.xcK) || (localh.xcL)) {
        i = 1;
      }
      if (i != 0) {}
    }
  ...
  public boolean changeFilter(String paramString, int paramInt1, int paramInt2)
  {
    ...
    this.mFilter = a.dY(this.filterId);
