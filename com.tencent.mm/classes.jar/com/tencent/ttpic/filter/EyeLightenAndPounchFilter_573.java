...
public class EyeLightenAndPounchFilter_573
  extends VideoFilterBase
{
  ...
  public void initParams()
  {
    ...
    addParam(new m.f("contrast", 1.0F));
    addParam(new m.f("saturation", 1.0F));
    addParam(new m.f("brightness", 1.0F));
  ...
  public void setContrastOpacity(float paramFloat)
  {
    ...
    this.contrastOpacity = paramFloat;
    addParam(new m.f("contrastOpacity", this.contrastOpacity));
 ...
 * Qualified Name:     com.tencent.ttpic.filter.EyeLightenAndPounchFilter_573
