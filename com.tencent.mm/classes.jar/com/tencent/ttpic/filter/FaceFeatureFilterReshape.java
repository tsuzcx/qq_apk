  ...
  extends VideoFilterBase
{
  ...
  static
  {
    ...
    TAG = FaceFeatureFilterReshape.class.getSimpleName();
    ...
    FRAGMENT_SHADER = FileUtils.loadAssetsString(VideoGlobalContext.getContext(), "camera/camera_video/shader/FaceFeatureFragmentShaderReshape.dat");
