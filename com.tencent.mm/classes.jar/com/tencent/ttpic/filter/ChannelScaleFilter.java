  ...
  extends BaseFilter
{
  ...
  private void initParams()
  {
    ...
    addParam(new m.f("redCenterX", 0.5F));
    addParam(new m.f("redCenterY", 0.5F));
    addParam(new m.f("redScaleX", 1.0F));
    addParam(new m.f("redScaleY", 1.0F));
    addParam(new m.f("greenCenterX", 0.5F));
    addParam(new m.f("greenCenterY", 0.5F));
    addParam(new m.f("greenScaleX", 1.0F));
    addParam(new m.f("greenScaleY", 1.0F));
    addParam(new m.f("blueCenterX", 0.5F));
    addParam(new m.f("blueCenterY", 0.5F));
    addParam(new m.f("blueScaleX", 1.0F));
    addParam(new m.f("blueScaleY", 1.0F));
  ...
  public void setBlueCenterX(float paramFloat)
  {
    ...
    addParam(new m.f("blueCenterX", paramFloat));
  ...
  public void setBlueCenterY(float paramFloat)
  {
    ...
    addParam(new m.f("blueCenterY", paramFloat));
  ...
  public void setBlueScaleX(float paramFloat)
  {
    ...
    addParam(new m.f("blueScaleX", paramFloat));
  ...
  public void setBlueScaleY(float paramFloat)
  {
    ...
    addParam(new m.f("blueScaleY", paramFloat));
  ...
  public void setGreenCenterX(float paramFloat)
  {
    ...
    addParam(new m.f("greenCenterX", paramFloat));
  ...
  public void setGreenCenterY(float paramFloat)
  {
    ...
    addParam(new m.f("greenCenterY", paramFloat));
  ...
  public void setGreenScaleX(float paramFloat)
  {
    ...
    addParam(new m.f("greenScaleX", paramFloat));
  ...
  public void setGreenScaleY(float paramFloat)
  {
    ...
    addParam(new m.f("greenScaleY", paramFloat));
  ...
  public void setRedCenterX(float paramFloat)
  {
    ...
    addParam(new m.f("redCenterX", paramFloat));
  ...
  public void setRedCenterY(float paramFloat)
  {
    ...
    addParam(new m.f("redCenterY", paramFloat));
  ...
  public void setRedScaleX(float paramFloat)
  {
    ...
    addParam(new m.f("redScaleX", paramFloat));
  ...
  public void setRedScaleY(float paramFloat)
  {
    ...
    addParam(new m.f("redScaleY", paramFloat));
 ...
 * Qualified Name:     com.tencent.ttpic.filter.ChannelScaleFilter
