...
public class FaceOffUtil
{
  ...
  public static Bitmap getGrayBitmap(FaceOffUtil.FEATURE_TYPE paramFEATURE_TYPE)
  {
    ...
    do
    {
      ...
      if (paramFEATURE_TYPE.equals(FaceOffUtil.FEATURE_TYPE.CRAZY_FACE)) {
        return VideoBitmapUtil.decodeSampleBitmap(VideoGlobalContext.getContext(), GRAY_FILE_CRAZY_FACE, 2147483647, 2147483647);
      }
    } while (!paramFEATURE_TYPE.equals(FaceOffUtil.FEATURE_TYPE.FACE_HEAD_CROP));
    return VideoBitmapUtil.decodeSampleBitmap(VideoGlobalContext.getContext(), GRAY_FILE_CROP_HEAD_FACE, 2147483647, 2147483647);
  }
  ...
  {
    float[] arrayOfFloat;
    if ((VideoUtil.isEmpty(paramList)) || (paramArrayOfFloat == null) || (paramInt1 <= 0) || (paramInt2 <= 0) || (paramArrayOfFloat.length != 1380))
    {
      arrayOfFloat = new float[0];
      return arrayOfFloat;
    }
  ...
  {
    float[] arrayOfFloat;
    if ((VideoUtil.isEmpty(paramList)) || (paramArrayOfFloat == null) || (paramInt1 <= 0) || (paramInt2 <= 0) || (paramArrayOfFloat.length != 1104))
    {
      arrayOfFloat = new float[0];
      return arrayOfFloat;
    }
