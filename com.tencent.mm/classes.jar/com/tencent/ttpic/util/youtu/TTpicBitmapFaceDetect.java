  ...
  extends b
{
  ...
  public TTpicBitmapFaceDetect()
  {
    ...
    {
      g.i("TTpicBitmapFaceDetect", "nativeConstructor failed");
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          if (paramRect == null)
          {
            ...
            paramRect.bcq = new Point(paramPoint1.leftEyeX * i, paramPoint1.leftEyeY * i);
            Rect localRect1 = new Rect();
            paramRect.bcp = localRect1;
            ...
            paramRect.bcr = new Point(paramPoint1.rightEyeX * i, paramPoint1.rightEyeY * i);
            Rect localRect2 = new Rect();
            paramRect.bcs = localRect2;
  ...
  private boolean initModel()
  {
    try
    {
      String str = VideoCacheUtil.getTempDiskCacheDir().toString() + "/";
      int i = 0;
      while (i < 6)
      {
        localObject = new String[] { "net_1.rpnmodel", "net_1_bin.rpnproto", "net_2.rpnmodel", "net_2_bin.rpnproto", "net_3.rpnmodel", "net_3_bin.rpnproto" }[i];
        VideoFileUtil.copyAssets(VideoGlobalContext.getContext(), "detector/" + (String)localObject, str + File.separator + (String)localObject);
        i += 1;
      }
      Object localObject = VideoGlobalContext.getContext().getAssets().open("ufat.bin");
      byte[] arrayOfByte = new byte[((InputStream)localObject).available()];
      ((InputStream)localObject).read(arrayOfByte);
      ((InputStream)localObject).close();
      boolean bool = nativeInit(str, arrayOfByte);
      return bool;
    }
  ...
  public native boolean nativeInit(String paramString, byte[] paramArrayOfByte);
