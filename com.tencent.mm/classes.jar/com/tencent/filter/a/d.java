...
public final class d
  extends BaseFilter
{
  private BaseFilter bgK = null;
  private d.a bgL = null;
  private d.a bgM = null;
  float[] bgN = new float[7];
  float bgO = 0.3F;
  ...
  private void setRadius(float paramFloat)
  {
    ...
    if (this.bgM != null)
    {
      this.bgL.W(this.radius);
      this.bgM.W(this.radius);
    }
  }
  ...
  public final void ApplyGLSLFilter(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    this.bgL = new d.a(true);
    this.bgL.W(this.radius);
    setNextFilter(this.bgL, null);
    this.bgM = new d.a(false);
    this.bgM.W(this.radius);
    this.bgL.setNextFilter(this.bgM, null);
    this.bgK = new BaseFilter(GLSLRender.beV);
    this.bgK.addParam(new m.m("inputImageTexture2", this.curve_static, 33986));
    this.bgK.addParam(new m.m("inputImageTexture3", this.meitu_whiten, 33987));
    this.bgK.addParam(new m.f("whiten", this.whitenmag));
    this.bgK.addParam(new m.f("opttype", this.opttype));
    this.bgK.addParam(new m.f("skinFilter", this.skinFilter));
    this.bgK.addParam(new m.f("smoothMag", this.bgO));
    this.bgM.setNextFilter(this.bgK, null);
    super.ApplyGLSLFilter(paramBoolean, paramFloat1, paramFloat2);
  }
  ...
  public final void setParameterDic(Map<String, Object> paramMap)
  {
    ...
    {
      this.bgO = ((Float)paramMap.get("smoothMag")).floatValue();
      if (this.bgK != null) {
        this.bgK.addParam(new m.f("smoothMag", this.bgO));
      }
    }
