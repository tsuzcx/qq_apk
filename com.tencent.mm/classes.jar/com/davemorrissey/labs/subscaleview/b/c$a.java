  ...
  implements b
{
  ...
  private c aqY;
  private final WeakReference<d> arb;
  private final WeakReference<e> arc;
  ...
  c$a(SubsamplingScaleImageView paramSubsamplingScaleImageView, d paramd, e parame)
  {
    ...
    this.arb = new WeakReference(paramd);
    this.arc = new WeakReference(parame);
    parame.are = true;
  ...
  private void a(SubsamplingScaleImageView paramSubsamplingScaleImageView, e parame)
  {
    ...
    if ((paramSubsamplingScaleImageView != null) && (parame != null) && (this.mStartTime != -1L) && (paramSubsamplingScaleImageView.getFullImageSampleSize() == parame.sampleSize)) {
      paramSubsamplingScaleImageView.cQ((int)(System.currentTimeMillis() - this.mStartTime));
    }
  ...
  private Bitmap lq()
  {
    ...
    //   5: aload_0
    //   6: getfield 50	com/davemorrissey/labs/subscaleview/b/c$a:aqT	Ljava/lang/ref/WeakReference;
    //   9: invokevirtual 98	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   12: ifnull +49 -> 61
    //   15: aload_0
    //   16: getfield 54	com/davemorrissey/labs/subscaleview/b/c$a:arc	Ljava/lang/ref/WeakReference;
    //   19: invokevirtual 98	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   22: ifnull +39 -> 61
    //   25: aload_0
    //   26: getfield 50	com/davemorrissey/labs/subscaleview/b/c$a:aqT	Ljava/lang/ref/WeakReference;
    ...
    //   38: aload_0
    //   39: getfield 54	com/davemorrissey/labs/subscaleview/b/c$a:arc	Ljava/lang/ref/WeakReference;
    ...
    //   61: aload_0
    //   62: getfield 50	com/davemorrissey/labs/subscaleview/b/c$a:aqT	Ljava/lang/ref/WeakReference;
    ...
    //   71: astore_1
    //   72: aload_0
    //   73: getfield 52	com/davemorrissey/labs/subscaleview/b/c$a:arb	Ljava/lang/ref/WeakReference;
    ...
    //   82: astore_3
    //   83: aload_0
    //   84: getfield 54	com/davemorrissey/labs/subscaleview/b/c$a:arc	Ljava/lang/ref/WeakReference;
    ...
    //   112: ifeq +477 -> 589
    //   115: aload_2
    //   116: getfield 107	com/davemorrissey/labs/subscaleview/c/e:arf	Z
    //   119: ifeq +470 -> 589
    //   122: ldc 109
    //   124: ldc 111
    //   126: iconst_2
    ...
    //   131: iconst_0
    //   132: aload_2
    //   133: getfield 117	com/davemorrissey/labs/subscaleview/c/e:ard	Landroid/graphics/Rect;
    //   136: aastore
    //   137: dup
    //   138: iconst_1
    //   139: aload_2
    ...
    //   146: aastore
    //   147: invokestatic 129	com/tencent/mm/sdk/platformtools/ab:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   150: aload_1
    ...
    //   170: ifeq +348 -> 518
    //   173: aload_2
    //   174: getfield 117	com/davemorrissey/labs/subscaleview/c/e:ard	Landroid/graphics/Rect;
    //   177: astore 4
    //   179: aload_2
    //   180: getfield 147	com/davemorrissey/labs/subscaleview/c/e:arh	Landroid/graphics/Rect;
    //   183: astore 5
    //   185: aload_1
    ...
    //   203: ifnull +24 -> 227
    //   206: aload_2
    //   207: getfield 147	com/davemorrissey/labs/subscaleview/c/e:arh	Landroid/graphics/Rect;
    //   210: aload_1
    ...
    //   244: aastore
    //   245: invokestatic 129	com/tencent/mm/sdk/platformtools/ab:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   248: aload_3
    //   249: aload_2
    //   250: getfield 147	com/davemorrissey/labs/subscaleview/c/e:arh	Landroid/graphics/Rect;
    //   253: aload_2
    //   254: getfield 75	com/davemorrissey/labs/subscaleview/c/e:sampleSize	I
    //   257: invokeinterface 176 3 0
    //   262: astore_3
    //   263: aload_0
    //   264: aload_1
    //   265: aload_2
    //   266: invokespecial 178	com/davemorrissey/labs/subscaleview/b/c$a:a	(Lcom/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView;Lcom/davemorrissey/labs/subscaleview/c/e;)V
    //   269: aload_1
    ...
    //   306: aload_1
    //   307: getfield 184	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:aro	I
    //   310: aload 4
    //   312: getfield 187	android/graphics/Rect:right	I
    //   315: isub
    //   316: aload 4
    //   318: getfield 190	android/graphics/Rect:bottom	I
    //   321: aload_1
    //   322: getfield 184	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:aro	I
    //   325: aload 4
    //   327: getfield 163	android/graphics/Rect:left	I
    //   330: isub
    //   331: invokevirtual 193	android/graphics/Rect:set	(IIII)V
    //   334: goto -135 -> 199
    //   337: astore_2
    //   338: aload_1
    ...
    //   369: invokestatic 199	com/tencent/mm/sdk/platformtools/ab:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   372: aload_0
    //   373: aload_1
    //   374: putfield 201	com/davemorrissey/labs/subscaleview/b/c$a:exception	Ljava/lang/Exception;
    //   377: aload_0
    //   378: new 203	com/davemorrissey/labs/subscaleview/a/c
    //   381: dup
    //   382: iconst_5
    //   383: ldc 205
    //   385: invokespecial 208	com/davemorrissey/labs/subscaleview/a/c:<init>	(ILjava/lang/String;)V
    //   388: putfield 210	com/davemorrissey/labs/subscaleview/b/c$a:aqY	Lcom/davemorrissey/labs/subscaleview/a/c;
    //   391: aload_0
    //   392: aload_0
    //   393: getfield 50	com/davemorrissey/labs/subscaleview/b/c$a:aqT	Ljava/lang/ref/WeakReference;
    ...
    //   402: aload_0
    //   403: getfield 54	com/davemorrissey/labs/subscaleview/b/c$a:arc	Ljava/lang/ref/WeakReference;
    ...
    //   412: invokespecial 178	com/davemorrissey/labs/subscaleview/b/c$a:a	(Lcom/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView;Lcom/davemorrissey/labs/subscaleview/c/e;)V
    //   415: ldc 94
    ...
    //   432: aload 5
    //   434: aload_1
    //   435: getfield 213	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:arn	I
    //   438: aload 4
    //   440: getfield 187	android/graphics/Rect:right	I
    //   443: isub
    //   444: aload_1
    //   445: getfield 184	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:aro	I
    //   448: aload 4
    //   450: getfield 190	android/graphics/Rect:bottom	I
    //   453: isub
    //   454: aload_1
    //   455: getfield 213	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:arn	I
    //   458: aload 4
    //   460: getfield 163	android/graphics/Rect:left	I
    //   463: isub
    //   464: aload_1
    //   465: getfield 184	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:aro	I
    //   468: aload 4
    //   470: getfield 166	android/graphics/Rect:top	I
    //   473: isub
    //   474: invokevirtual 193	android/graphics/Rect:set	(IIII)V
    //   477: goto -278 -> 199
    //   480: aload 5
    //   482: aload_1
    //   483: getfield 213	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:arn	I
    //   486: aload 4
    //   488: getfield 190	android/graphics/Rect:bottom	I
    //   491: isub
    //   492: aload 4
    //   494: getfield 163	android/graphics/Rect:left	I
    //   497: aload_1
    //   498: getfield 213	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:arn	I
    //   501: aload 4
    //   503: getfield 166	android/graphics/Rect:top	I
    //   506: isub
    //   507: aload 4
    //   509: getfield 187	android/graphics/Rect:right	I
    //   512: invokevirtual 193	android/graphics/Rect:set	(IIII)V
    //   515: goto -316 -> 199
    //   518: aload_2
    //   519: iconst_0
    //   520: putfield 59	com/davemorrissey/labs/subscaleview/c/e:are	Z
    //   523: aload_1
    ...
    //   550: invokestatic 199	com/tencent/mm/sdk/platformtools/ab:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   553: aload_0
    //   554: new 217	java/lang/RuntimeException
    //   557: dup
    //   558: aload_1
    //   559: invokespecial 220	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
    //   562: putfield 201	com/davemorrissey/labs/subscaleview/b/c$a:exception	Ljava/lang/Exception;
    //   565: aload_0
    //   566: new 203	com/davemorrissey/labs/subscaleview/a/c
    //   569: dup
    //   570: bipush 6
    //   572: ldc 222
    //   574: invokespecial 208	com/davemorrissey/labs/subscaleview/a/c:<init>	(ILjava/lang/String;)V
    //   577: putfield 210	com/davemorrissey/labs/subscaleview/b/c$a:aqY	Lcom/davemorrissey/labs/subscaleview/a/c;
    //   580: getstatic 228	android/graphics/Bitmap$Config:RGB_565	Landroid/graphics/Bitmap$Config;
    //   583: invokestatic 232	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:setPreferredBitmapConfig	(Landroid/graphics/Bitmap$Config;)V
    //   586: goto -195 -> 391
    //   589: aload_2
    //   590: ifnull -199 -> 391
    //   593: aload_2
    //   594: iconst_0
    //   595: putfield 59	com/davemorrissey/labs/subscaleview/c/e:are	Z
    //   598: goto -207 -> 391
