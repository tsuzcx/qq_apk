  ...
  implements com.davemorrissey.labs.subscaleview.c.d
{
    ...
    implements b
  {
    ...
    private final WeakReference<com.davemorrissey.labs.subscaleview.a.d> aMD;
    private final WeakReference<e> aME;
    ...
    a(SubsamplingScaleImageView paramSubsamplingScaleImageView, com.davemorrissey.labs.subscaleview.a.d paramd, e parame)
    {
      ...
      this.aMD = new WeakReference(paramd);
      this.aME = new WeakReference(parame);
      parame.aMG = true;
    ...
    private void a(SubsamplingScaleImageView paramSubsamplingScaleImageView, e parame)
    {
      ...
      if ((paramSubsamplingScaleImageView != null) && (parame != null) && (this.mStartTime != -1L) && (paramSubsamplingScaleImageView.getFullImageSampleSize() == parame.sampleSize)) {
        paramSubsamplingScaleImageView.dA((int)(System.currentTimeMillis() - this.mStartTime));
      }
    ...
    private Bitmap qk()
    {
      ...
      //   5: aload_0
      //   6: getfield 50	com/davemorrissey/labs/subscaleview/b/c$a:mn	Ljava/lang/ref/WeakReference;
      //   9: invokevirtual 98	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
      //   12: ifnull +49 -> 61
      //   15: aload_0
      //   16: getfield 54	com/davemorrissey/labs/subscaleview/b/c$a:aME	Ljava/lang/ref/WeakReference;
      //   19: invokevirtual 98	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
      //   22: ifnull +39 -> 61
      //   25: aload_0
      //   26: getfield 50	com/davemorrissey/labs/subscaleview/b/c$a:mn	Ljava/lang/ref/WeakReference;
      ...
      //   38: aload_0
      //   39: getfield 54	com/davemorrissey/labs/subscaleview/b/c$a:aME	Ljava/lang/ref/WeakReference;
      ...
      //   61: aload_0
      //   62: getfield 50	com/davemorrissey/labs/subscaleview/b/c$a:mn	Ljava/lang/ref/WeakReference;
      ...
      //   71: astore_1
      //   72: aload_0
      //   73: getfield 52	com/davemorrissey/labs/subscaleview/b/c$a:aMD	Ljava/lang/ref/WeakReference;
      ...
      //   82: astore_3
      //   83: aload_0
      //   84: getfield 54	com/davemorrissey/labs/subscaleview/b/c$a:aME	Ljava/lang/ref/WeakReference;
      ...
      //   131: iconst_0
      //   132: aload_2
      //   133: getfield 117	com/davemorrissey/labs/subscaleview/c/e:aMF	Landroid/graphics/Rect;
      //   136: aastore
      //   137: dup
      //   138: iconst_1
      //   139: aload_2
      ...
      //   146: aastore
      //   147: invokestatic 129	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   150: aload_1
      ...
      //   170: ifeq +348 -> 518
      //   173: aload_2
      //   174: getfield 117	com/davemorrissey/labs/subscaleview/c/e:aMF	Landroid/graphics/Rect;
      //   177: astore 4
      //   179: aload_2
      //   180: getfield 147	com/davemorrissey/labs/subscaleview/c/e:aMI	Landroid/graphics/Rect;
      //   183: astore 5
      //   185: aload_1
      ...
      //   203: ifnull +24 -> 227
      //   206: aload_2
      //   207: getfield 147	com/davemorrissey/labs/subscaleview/c/e:aMI	Landroid/graphics/Rect;
      //   210: aload_1
      ...
      //   244: aastore
      //   245: invokestatic 129	com/tencent/mm/sdk/platformtools/ac:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
      //   248: aload_3
      //   249: aload_2
      //   250: getfield 147	com/davemorrissey/labs/subscaleview/c/e:aMI	Landroid/graphics/Rect;
      //   253: aload_2
      ...
      //   306: aload_1
      //   307: getfield 183	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:aMP	I
      //   310: aload 4
      ...
      //   321: aload_1
      //   322: getfield 183	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:aMP	I
      //   325: aload 4
      ...
      //   369: invokestatic 198	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
      //   372: aload_0
      //   373: aload_1
      ...
      //   388: putfield 209	com/davemorrissey/labs/subscaleview/b/c$a:aMA	Lcom/davemorrissey/labs/subscaleview/a/c;
      //   391: aload_0
      //   392: aload_0
      //   393: getfield 50	com/davemorrissey/labs/subscaleview/b/c$a:mn	Ljava/lang/ref/WeakReference;
      ...
      //   402: aload_0
      //   403: getfield 54	com/davemorrissey/labs/subscaleview/b/c$a:aME	Ljava/lang/ref/WeakReference;
      ...
      //   432: aload 5
      //   434: aload_1
      //   435: getfield 212	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:aMO	I
      //   438: aload 4
      //   440: getfield 186	android/graphics/Rect:right	I
      //   443: isub
      //   444: aload_1
      //   445: getfield 183	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:aMP	I
      //   448: aload 4
      //   450: getfield 189	android/graphics/Rect:bottom	I
      //   453: isub
      //   454: aload_1
      //   455: getfield 212	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:aMO	I
      //   458: aload 4
      //   460: getfield 163	android/graphics/Rect:left	I
      //   463: isub
      //   464: aload_1
      //   465: getfield 183	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:aMP	I
      //   468: aload 4
      ...
      //   480: aload 5
      //   482: aload_1
      //   483: getfield 212	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:aMO	I
      //   486: aload 4
      ...
      //   497: aload_1
      //   498: getfield 212	com/davemorrissey/labs/subscaleview/view/SubsamplingScaleImageView:aMO	I
      //   501: aload 4
      ...
      //   518: aload_2
      //   519: iconst_0
      //   520: putfield 59	com/davemorrissey/labs/subscaleview/c/e:aMG	Z
      //   523: aload_1
      ...
      //   550: invokestatic 198	com/tencent/mm/sdk/platformtools/ac:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
      //   553: aload_0
      ...
      //   577: putfield 209	com/davemorrissey/labs/subscaleview/b/c$a:aMA	Lcom/davemorrissey/labs/subscaleview/a/c;
      ...
      //   593: aload_2
      //   594: iconst_0
      //   595: putfield 59	com/davemorrissey/labs/subscaleview/c/e:aMG	Z
      //   598: goto -207 -> 391
    ...
    public final void cancel()
    {
      ...
      {
        ac.printErrStackTrace("MicroMsg.LegacyTileLoaderFactory", localException, "alvinluo TileLoaderTask cancel exception", new Object[0]);
        AppMethodBeat.o(157367);
      }
    }
