...
public final class k
{
  ...
  private static final char[] aNZ;
  
  static
  {
    AppMethodBeat.i(77784);
    aNY = "0123456789abcdef".toCharArray();
    aNZ = new char[64];
  ...
  private static boolean dr(int paramInt)
  {
    return (paramInt > 0) || (paramInt == -2147483648);
  }
  
  public static <T> Queue<T> ds(int paramInt)
  {
  ...
  public static String m(byte[] paramArrayOfByte)
  {
    ...
    synchronized (aNZ)
    {
      char[] arrayOfChar2 = aNZ;
      int i = 0;
      while (i < paramArrayOfByte.length)
      {
        int j = paramArrayOfByte[i] & 0xFF;
        arrayOfChar2[(i * 2)] = aNY[(j >>> 4)];
        arrayOfChar2[(i * 2 + 1)] = aNY[(j & 0xF)];
        i += 1;
      }
 ...
 * Qualified Name:     com.bumptech.glide.g.k
