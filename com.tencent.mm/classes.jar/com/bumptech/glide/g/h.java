  ...
  extends FilterInputStream
{
  ...
  private long q(long paramLong)
  {
    ...
    do
    {
      do
      {
        return l;
        l = paramLong;
      } while (this.aNU == -2147483648);
      l = paramLong;
    } while (paramLong <= this.aNU);
    return this.aNU;
  }
  
  private void r(long paramLong)
  {
    if ((this.aNU != -2147483648) && (paramLong != -1L)) {
      this.aNU = ((int)(this.aNU - paramLong));
    }
  }
  ...
  public final int available()
  {
    ...
    if (this.aNU == -2147483648)
    {
      i = super.available();
      AppMethodBeat.o(77760);
      return i;
    }
    int i = Math.min(this.aNU, super.available());
    AppMethodBeat.o(77760);
    return i;
  }
 ...
 * Qualified Name:     com.bumptech.glide.g.h
