  ...
  extends FilterInputStream
{
  ...
  private int dq(int paramInt)
  {
    ...
    while (this.contentLength - this.aNM <= 0L)
    {
      AppMethodBeat.o(77733);
      return paramInt;
    }
    IOException localIOException = new IOException("Failed to read all expected data, expected: " + this.contentLength + ", but read: " + this.aNM);
    AppMethodBeat.o(77733);
  ...
  public final int available()
  {
    try
    {
      ...
      int i = (int)Math.max(this.contentLength - this.aNM, this.in.available());
  ...
  public final int read()
  {
    ...
    //   18: aload_0
    //   19: iload_1
    //   20: invokespecial 84	com/bumptech/glide/g/c:dq	(I)I
    //   23: pop
    //   24: ldc 80
  ...
  public final int read(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    try
    {
      ...
      paramInt1 = dq(super.read(paramArrayOfByte, paramInt1, paramInt2));
 ...
 * Qualified Name:     com.bumptech.glide.g.c
