...
{
  private static final e.a<?> aCF;
  private final Map<Class<?>, e.a<?>> aCE;
  ...
  static
  {
    ...
    aCF = new e.a()
    {
      public final e<Object> Q(Object paramAnonymousObject)
      {
  ...
  public final <T> e<T> Q(T paramT)
  {
    try
    {
      AppMethodBeat.i(76877);
      i.checkNotNull(paramT, "Argument must not be null");
      Object localObject2 = (e.a)this.aCE.get(paramT.getClass());
      Object localObject1 = localObject2;
      if (localObject2 == null)
      {
        Iterator localIterator = this.aCE.values().iterator();
        do
        {
        ...
        } while (!((e.a)localObject1).nK().isAssignableFrom(paramT.getClass()));
      }
      localObject2 = localObject1;
      if (localObject1 == null) {
        localObject2 = aCF;
      }
      paramT = ((e.a)localObject2).Q(paramT);
