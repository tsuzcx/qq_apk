...
final class e
{
  ...
  {
    this(paramList, aFE, paramd, paramb, paramContentResolver);
  }
  
  private String k(Uri paramUri)
  {
    AppMethodBeat.i(76912);
    paramUri = this.aFG.h(paramUri);
    if (paramUri != null) {}
    try
    {
  ...
  final int i(Uri paramUri)
  {
    ...
    //   6: astore_3
    //   7: aload_0
    //   8: getfield 46	com/bumptech/glide/c/a/a/e:aFz	Landroid/content/ContentResolver;
    //   11: aload_1
    ...
    //   21: astore 4
    //   23: aload_0
    //   24: getfield 48	com/bumptech/glide/c/a/a/e:aFH	Ljava/util/List;
    //   27: aload_3
    //   28: aload_0
    //   29: getfield 44	com/bumptech/glide/c/a/a/e:aFy	Lcom/bumptech/glide/c/b/a/b;
  ...
  public final InputStream j(Uri paramUri)
  {
    ...
    try
    {
      InputStream localInputStream = this.aFz.openInputStream((Uri)localObject);
      AppMethodBeat.o(76911);
