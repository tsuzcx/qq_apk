...
{
  private final Class<Data> aEv;
  private final l.a<List<Throwable>> aEy;
  private final String aEz;
  private final List<? extends h<Data, ResourceType, Transcode>> aFu;
  ...
  public s(Class<Data> paramClass, Class<ResourceType> paramClass1, Class<Transcode> paramClass2, List<h<Data, ResourceType, Transcode>> paramList, l.a<List<Throwable>> parama)
  {
    ...
    this.aEv = paramClass;
    this.aEy = parama;
    this.aFu = ((List)i.b(paramList));
    this.aEz = ("Failed LoadPath{" + paramClass.getSimpleName() + "->" + paramClass1.getSimpleName() + "->" + paramClass2.getSimpleName() + "}");
  ...
  private u<Transcode> a(com.bumptech.glide.c.a.e<Data> parame, j paramj, int paramInt1, int paramInt2, h.a<ResourceType> parama, List<Throwable> paramList)
  {
    ...
    for (;;)
    {
      ...
      Object localObject2 = (h)this.aFu.get(i);
      try
      {
        u localu = parama.a(((h)localObject2).a(parame, paramInt1, paramInt2, paramj));
        localObject2 = ((h)localObject2).aEx.a(localu, paramj);
  ...
  public final String toString()
  {
    ...
    String str = "LoadPath{decodePaths=" + Arrays.toString(this.aFu.toArray()) + '}';
