...
final class e
{
  ...
  private e(List<ImageHeaderParser> paramList, a parama, d paramd, b paramb, ContentResolver paramContentResolver)
  {
    this.aFv = parama;
    this.aFw = paramd;
    this.aFo = paramb;
  ...
  {
    this(paramList, aFu, paramd, paramb, paramContentResolver);
  }
  
  private String k(Uri paramUri)
  {
    AppMethodBeat.i(76912);
    paramUri = this.aFw.h(paramUri);
    if (paramUri != null) {}
    try
    {
  ...
  final int i(Uri paramUri)
  {
    ...
    //   6: astore_3
    //   7: aload_0
    //   8: getfield 46	com/bumptech/glide/load/a/a/e:aFp	Landroid/content/ContentResolver;
    //   11: aload_1
    ...
    //   21: astore 4
    //   23: aload_0
    //   24: getfield 48	com/bumptech/glide/load/a/a/e:aFx	Ljava/util/List;
    //   27: aload_3
    //   28: aload_0
    //   29: getfield 44	com/bumptech/glide/load/a/a/e:aFo	Lcom/bumptech/glide/load/b/a/b;
    //   32: invokestatic 94	com/bumptech/glide/load/f:b	(Ljava/util/List;Ljava/io/InputStream;Lcom/bumptech/glide/load/b/a/b;)I
    //   35: istore_2
    //   36: aload_3
    //   37: ifnull +7 -> 44
    //   40: aload_3
  ...
  public final InputStream j(Uri paramUri)
  {
    ...
    try
    {
      InputStream localInputStream = this.aFp.openInputStream((Uri)localObject);
      AppMethodBeat.o(76911);
 ...
 * Qualified Name:     com.bumptech.glide.load.a.a.e
