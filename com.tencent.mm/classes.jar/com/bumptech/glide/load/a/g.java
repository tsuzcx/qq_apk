  ...
  extends FilterInputStream
{
  ...
  public final int read(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (this.position == aFg)
      {
        paramArrayOfByte[paramInt1] = this.aFh;
        paramInt1 = 1;
      }
      ...
      {
        paramInt2 = Math.min(aFg - this.position, paramInt2);
        System.arraycopy(aFe, this.position - 2, paramArrayOfByte, paramInt1, paramInt2);
        paramInt1 = paramInt2;
      }
    }
  }
 ...
 * Qualified Name:     com.bumptech.glide.load.a.g
