  ...
  extends FilterInputStream
{
  ...
  public n(InputStream paramInputStream, b paramb)
  {
    this(paramInputStream, paramb, (byte)0);
  }
  
  private n(InputStream paramInputStream, b paramb, byte paramByte)
  {
  ...
  private int a(InputStream paramInputStream, byte[] paramArrayOfByte)
  {
    ...
    if ((this.markpos == 0) && (this.marklimit > paramArrayOfByte.length) && (this.count == paramArrayOfByte.length))
    {
      ...
      arrayOfByte = (byte[])this.aFo.a(i, [B.class);
      System.arraycopy(paramArrayOfByte, 0, arrayOfByte, 0, paramArrayOfByte.length);
      this.buf = arrayOfByte;
      this.aFo.put(paramArrayOfByte);
 ...
 * Qualified Name:     com.bumptech.glide.load.d.a.n
