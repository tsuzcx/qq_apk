...
{
  static final byte[] aKN;
  private static final int[] aKO;
  
  static
  {
    AppMethodBeat.i(77383);
    aKN = "".getBytes(Charset.forName("UTF-8"));
    aKO = new int[] { 0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8 };
  ...
  private static int a(b paramb)
  {
    ...
    default: 
      ...
      paramb.aKP.order(localByteOrder);
      int j = paramb.dl(10) + 6;
      int k = paramb.dm(j);
      i = 0;
      if (i >= k) {
        break label377;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            if ((i1 >= 0) && (n + i1 <= paramb.aKP.remaining())) {
              break label363;
            }
            if (!Log.isLoggable("DfltImageHeaderParser", 3)) {}
          }
  ...
  private static int a(c paramc, b paramb)
  {
    ...
    //   310: aload 8
    //   312: iload_2
    //   313: invokestatic 165	com/bumptech/glide/load/d/a/f:c	([BI)Z
    //   316: ifeq +20 -> 336
    //   319: new 11	com/bumptech/glide/load/d/a/f$b
    //   322: dup
    //   323: aload 8
    //   325: iload_2
    //   326: invokespecial 168	com/bumptech/glide/load/d/a/f$b:<init>	([BI)V
    //   329: invokestatic 170	com/bumptech/glide/load/d/a/f:a	(Lcom/bumptech/glide/load/d/a/f$b;)I
    //   332: istore_3
    //   333: goto -38 -> 295
    //   336: ldc 66
    //   338: iconst_3
  ...
  private static ImageHeaderParser.ImageType a(c paramc)
  {
    AppMethodBeat.i(77380);
    int i = paramc.py();
    if (i == 65496)
    {
      paramc = ImageHeaderParser.ImageType.JPEG;
      AppMethodBeat.o(77380);
      return paramc;
    }
    i = i << 16 & 0xFFFF0000 | paramc.py() & 0xFFFF;
    if (i == -1991225785)
    {
      paramc.skip(21L);
      if (paramc.pA() >= 3)
      {
        paramc = ImageHeaderParser.ImageType.PNG_A;
        AppMethodBeat.o(77380);
        return paramc;
      }
    ...
    if (i >> 8 == 4671814)
    {
      paramc = ImageHeaderParser.ImageType.GIF;
      AppMethodBeat.o(77380);
      return paramc;
    }
    if (i != 1380533830)
    {
      paramc = ImageHeaderParser.ImageType.UNKNOWN;
      AppMethodBeat.o(77380);
      return paramc;
    }
    paramc.skip(4L);
    if ((paramc.py() << 16 & 0xFFFF0000 | paramc.py() & 0xFFFF) != 1464156752)
    {
      paramc = ImageHeaderParser.ImageType.UNKNOWN;
      AppMethodBeat.o(77380);
      return paramc;
    }
    i = paramc.py() << 16 & 0xFFFF0000 | paramc.py() & 0xFFFF;
    ...
    if ((i & 0xFF) == 88)
    {
      ...
      if ((paramc.pA() & 0x10) != 0)
      {
        paramc = ImageHeaderParser.ImageType.WEBP_A;
        AppMethodBeat.o(77380);
        return paramc;
      }
  ...
  {
    boolean bool;
    if ((paramArrayOfByte != null) && (paramInt > aKN.length))
    {
      bool = true;
      if (bool) {
        paramInt = 0;
    ...
    else
    {
      for (;;)
      {
        if (paramInt >= aKN.length) {
          return bool;
        }
        if (paramArrayOfByte[paramInt] != aKN[paramInt])
        {
          return false;
          bool = false;
          break;
  ...
  public final int a(InputStream paramInputStream, b paramb)
  {
    ...
    int i = a(new d((InputStream)j.checkNotNull(paramInputStream, "Argument must not be null")), (b)j.checkNotNull(paramb, "Argument must not be null"));
  ...
  public final ImageHeaderParser.ImageType a(ByteBuffer paramByteBuffer)
  {
    ...
    paramByteBuffer = a(new a((ByteBuffer)j.checkNotNull(paramByteBuffer, "Argument must not be null")));
  ...
  public final ImageHeaderParser.ImageType c(InputStream paramInputStream)
  {
    ...
    paramInputStream = a(new d((InputStream)j.checkNotNull(paramInputStream, "Argument must not be null")));
  ...
  static final class b
  {
    ...
    b(byte[] paramArrayOfByte, int paramInt)
    {
      ...
      this.aKP = ((ByteBuffer)ByteBuffer.wrap(paramArrayOfByte).order(ByteOrder.BIG_ENDIAN).limit(paramInt));
      AppMethodBeat.o(77368);
    }
    
    private boolean aP(int paramInt1, int paramInt2)
    {
      AppMethodBeat.i(77371);
      if (this.aKP.remaining() - paramInt1 >= paramInt2)
      {
    ...
    final int dl(int paramInt)
    {
      ...
      if (aP(paramInt, 4))
      {
        paramInt = this.aKP.getInt(paramInt);
    ...
    final short dm(int paramInt)
    {
      AppMethodBeat.i(77370);
      if (aP(paramInt, 2))
      {
        short s = this.aKP.getShort(paramInt);
    ...
    implements f.c
  {
    ...
    public final short pz()
    {
      ...
      short s = (short)(this.aKQ.read() & 0xFF);
    ...
    public final int read(byte[] paramArrayOfByte, int paramInt)
    {
      ...
      while (i > 0)
      {
        int j = this.aKQ.read(paramArrayOfByte, paramInt - i, i);
        if (j == -1) {
          break;
        }
        i -= j;
 ...
 * Qualified Name:     com.bumptech.glide.load.d.a.f
