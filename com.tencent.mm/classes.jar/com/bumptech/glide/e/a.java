...
public final class a
{
  ...
  public final <T> void b(Class<T> paramClass, d<T> paramd)
  {
    try
    {
      ...
      this.aKo.add(new a(paramClass, paramd));
  ...
  /* Error */
  public final <T> d<T> t(Class<T> paramClass)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   7: aload_0
    //   8: getfield 26	com/bumptech/glide/e/a:aKo	Ljava/util/List;
    ...
    //   35: astore_3
    //   36: aload_3
    //   37: getfield 64	com/bumptech/glide/e/a$a:aEv	Ljava/lang/Class;
    //   40: aload_1
    //   41: invokevirtual 70	java/lang/Class:isAssignableFrom	(Ljava/lang/Class;)Z
    //   44: ifeq -27 -> 17
    //   47: aload_3
    //   48: getfield 74	com/bumptech/glide/e/a$a:aDu	Lcom/bumptech/glide/c/d;
    //   51: astore_1
    //   52: ldc 46
