...
final class ci
{
  ...
  {
    return cax.s(paramArrayOfByte, 0, paramArrayOfByte.length);
  }
  
  static int a(CharSequence paramCharSequence, byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    return cax.b(paramCharSequence, paramArrayOfByte, paramInt1, paramInt2);
  }
  
  private static int by(int paramInt1, int paramInt2)
  {
  ...
  {
    return cax.s(paramArrayOfByte, paramInt1, paramInt2);
  }
  
  static String t(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    return cax.t(paramArrayOfByte, paramInt1, paramInt2);
  }
  
  static int v(CharSequence paramCharSequence)
  {
    int k = 0;
    ...
    final String t(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
    {
      ...
      if (paramInt2 < m)
      {
        ...
        for (;;)
        {
          ...
          {
            paramInt2 += 1;
            ci.a.a(b1, arrayOfChar, paramInt1);
            paramInt1 += 1;
            break;
            i = 0;
            continue;
            paramInt2 = i + 1;
            ci.a.a(b1, paramArrayOfByte[i], arrayOfChar, paramInt1);
            paramInt1 += 1;
          }
        }
      }
      for (;;)
      {
        if (paramInt2 < m)
        {
          ...
          if (ci.a.j(b1))
          {
            ...
            paramInt2 = j + 1;
            ci.a.a(b1, b2, paramArrayOfByte[j], arrayOfChar, paramInt1);
            paramInt1 += 1;
            continue;
          }
          if (i >= m - 2) {
          ...
          i = paramInt2 + 1;
          ci.a.a(b1, b2, paramArrayOfByte[paramInt2], paramArrayOfByte[i], arrayOfChar, paramInt1);
          int j = paramInt1 + 1 + 1;
          i += 1;
          label385:
          paramInt1 = j;
    ...
    final int v(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          if (i >= paramInt2 - 1) {
            return ci.u(paramArrayOfByte, i, paramInt2);
          }
          k = i + 1;
    ...
    extends ci.b
  {
    private static int a(byte[] paramArrayOfByte, int paramInt1, long paramLong, int paramInt2)
    {
      ...
      case 0: 
        return ci.gW(paramInt1);
      case 1: 
        return ci.bz(paramInt1, ch.c(paramArrayOfByte, paramLong));
      }
      return ci.A(paramInt1, ch.c(paramArrayOfByte, paramLong), ch.c(paramArrayOfByte, 1L + paramLong));
    }
    ...
    private static int a(byte[] paramArrayOfByte, long paramLong, int paramInt)
    {
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            for (;;)
            {
              ...
              l1 = 1L + paramLong;
              i = ch.c(paramArrayOfByte, paramLong);
              if (i < 0) {
                break;
              }
              paramInt -= 1;
            ...
            paramLong = 1L + l1;
          } while (ch.c(paramArrayOfByte, l1) <= -65);
          return -1;
          if (i >= -16) {
            break label249;
          }
          ...
          paramInt -= 2;
          l2 = l1 + 1L;
          j = ch.c(paramArrayOfByte, l1);
          if ((j > -65) || ((i == -32) && (j < -96)) || ((i == -19) && (j >= -96))) {
            break label247;
          }
          paramLong = 1L + l2;
        } while (ch.c(paramArrayOfByte, l2) <= -65);
        return -1;
        if (paramInt < 3) {
          return a(paramArrayOfByte, i, l1, paramInt);
        }
        paramInt -= 3;
        paramLong = 1L + l1;
        int j = ch.c(paramArrayOfByte, l1);
        if ((j > -65) || ((i << 28) + (j + 112) >> 30 != 0)) {
          break label336;
        }
        l1 = 1L + paramLong;
        if (ch.c(paramArrayOfByte, paramLong) > -65) {
          break label336;
        }
        paramLong = 1L + l1;
      } while (ch.c(paramArrayOfByte, l1) <= -65);
    ...
    final int b(CharSequence paramCharSequence, byte[] paramArrayOfByte, int paramInt1, int paramInt2)
    {
      ...
      while (paramInt1 < j)
      {
        ...
        ch.a(paramArrayOfByte, l1, (byte)paramInt2);
        paramInt1 += 1;
        l1 = 1L + l1;
      }
      if (paramInt1 == j) {
      ...
      for (;;)
      {
        if (paramInt1 < j)
        {
          ...
          {
            l2 = 1L + l1;
            ch.a(paramArrayOfByte, l1, (byte)i);
            l1 = l2;
          }
          for (;;)
          {
            ...
            {
              l2 = l1 + 1L;
              ch.a(paramArrayOfByte, l1, (byte)(i >>> 6 | 0x3C0));
              l1 = 1L + l2;
              ch.a(paramArrayOfByte, l2, (byte)(i & 0x3F | 0x80));
            }
            else if (((i < 55296) || (57343 < i)) && (l1 <= l3 - 3L))
            {
              l2 = 1L + l1;
              ch.a(paramArrayOfByte, l1, (byte)(i >>> 12 | 0x1E0));
              long l4 = 1L + l2;
              ch.a(paramArrayOfByte, l2, (byte)(i >>> 6 & 0x3F | 0x80));
              l1 = 1L + l4;
              ch.a(paramArrayOfByte, l4, (byte)(i & 0x3F | 0x80));
            }
            else
            {
              if (l1 > l3 - 4L) {
              ...
              {
                throw new ci.d(paramInt2 - 1, j);
              }
              paramInt2 = Character.toCodePoint(i, c);
              l2 = 1L + l1;
              ch.a(paramArrayOfByte, l1, (byte)(paramInt2 >>> 18 | 0xF0));
              l1 = 1L + l2;
              ch.a(paramArrayOfByte, l2, (byte)(paramInt2 >>> 12 & 0x3F | 0x80));
              l2 = l1 + 1L;
              ch.a(paramArrayOfByte, l1, (byte)(paramInt2 >>> 6 & 0x3F | 0x80));
              l1 = 1L + l2;
              ch.a(paramArrayOfByte, l2, (byte)(paramInt2 & 0x3F | 0x80));
            }
          }
          label529:
          if ((55296 <= i) && (i <= 57343) && ((paramInt1 + 1 == j) || (!Character.isSurrogatePair(i, paramCharSequence.charAt(paramInt1 + 1))))) {
            throw new ci.d(paramInt1, j);
          }
    ...
    final String t(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
    {
      ...
      if (paramInt2 < m)
      {
        b1 = ch.c(paramArrayOfByte, paramInt2);
        if (b1 >= 0) {
          i = 1;
        }
        for (;;)
        {
          if (i != 0)
          {
            ...
            continue;
            paramInt2 = i + 1;
            ci.a.a(b1, ch.c(paramArrayOfByte, i), arrayOfChar, paramInt1);
            paramInt1 += 1;
          }
        }
      }
      for (;;)
      {
        if (paramInt2 < m)
        {
          ...
          if (ci.a.j(b1))
          {
            ...
            j = i + 1;
            b2 = ch.c(paramArrayOfByte, i);
            paramInt2 = j + 1;
            ci.a.a(b1, b2, ch.c(paramArrayOfByte, j), arrayOfChar, paramInt1);
            paramInt1 += 1;
            continue;
          }
          if (i >= m - 2) {
          ...
          paramInt2 = i + 1;
          byte b2 = ch.c(paramArrayOfByte, i);
          i = paramInt2 + 1;
          ci.a.a(b1, b2, ch.c(paramArrayOfByte, paramInt2), ch.c(paramArrayOfByte, i), arrayOfChar, paramInt1);
          int j = paramInt1 + 1 + 1;
          i += 1;
          label412:
          paramInt1 = j;
 ...
 * Qualified Name:     com.google.a.ci
