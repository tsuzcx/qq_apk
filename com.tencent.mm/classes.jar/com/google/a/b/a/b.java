  ...
  implements t
{
  ...
  public final <T> s<T> a(f paramf, a<T> parama)
  {
    ...
    paramf = new a(paramf, localType, paramf.a(a.h(localType)), this.bFb.b(parama));
    AppMethodBeat.o(108047);
    return paramf;
  }
  ...
  {
    private final s<E> bGI;
    private final h<? extends Collection<E>> bGJ;
    
    public a(f paramf, Type paramType, s<E> params, h<? extends Collection<E>> paramh)
    {
      AppMethodBeat.i(108076);
      this.bGI = new l(paramf, params, paramType);
      this.bGJ = paramh;
