  ...
  extends r<Time>
{
  ...
  static
  {
    ...
    bMt = new s()
    {
      public final <T> r<T> a(e paramAnonymouse, com.google.a.c.a<T> paramAnonymousa)
      {
        ...
        if (paramAnonymousa.bOw == Time.class)
        {
  ...
  public k()
  {
    ...
    this.bMW = new SimpleDateFormat("hh:mm:ss a");
    AppMethodBeat.o(108014);
  }
  
  /* Error */
  private void a(com.google.a.d.c paramc, Time paramTime)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   26: return
    //   27: aload_0
    //   28: getfield 40	com/google/a/b/a/k:bMW	Ljava/text/DateFormat;
    //   31: aload_2
  ...
  private Time e(com.google.a.d.a parama)
  {
    ...
    finally
    {
      ...
      {
        label32:
        parama = new Time(this.bMW.parse(parama.zy()).getTime());
        AppMethodBeat.o(222988);
      }
