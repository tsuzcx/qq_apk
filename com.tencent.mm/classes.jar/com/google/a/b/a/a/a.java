...
{
  private static final TimeZone bOr;
  
  static
  {
    AppMethodBeat.i(222956);
    bOr = TimeZone.getTimeZone("UTC");
  ...
  public static Date a(String paramString, ParsePosition paramParsePosition)
  {
    ...
    j = i + 2;
    i3 = h(paramString, i, j);
    if (a(paramString, j, '-'))
    {
      i = j + 1;
      k = i + 2;
      i4 = h(paramString, i, k);
        ...
        if (a(paramString, i, ':'))
        {
          ...
          if (paramString.length() > i)
          {
            ...
            if ((j != 90) && (j != 43) && (j != 45))
            {
              ...
              {
                k += 1;
                i1 = q(paramString, k + 1);
                i5 = Math.min(i1, k + 3);
                j = h(paramString, k, i5);
                switch (i5 - k)
                {
                case 2: 
