...
{
  static final Type[] bLt = new Type[0];
      ...
      if ((localObject1 instanceof WildcardType))
      {
        ...
        else if (localObject2.length == 1)
        {
          ...
          if (paramClass != localObject2[0])
          {
            ...
            for (;;)
            {
              paramType1 = new c(paramType1, bLt);
              AppMethodBeat.o(107904);
              return paramType1;
              paramType1 = new Type[1];
              paramType1[0] = paramClass;
  ...
  static int af(Object paramObject)
  {
    ...
    implements Serializable, ParameterizedType
  {
    ...
    public b(Type paramType1, Type paramType2, Type... paramVarArgs)
    {
      ...
      {
        this.bLv = paramType1;
        this.bLw = b.b(paramType2);
        this.bLx = ((Type[])paramVarArgs.clone());
        int k = this.bLx.length;
        i = j;
        while (i < k)
        {
          a.checkNotNull(this.bLx[i]);
          b.f(this.bLx[i]);
          paramType1 = this.bLx;
    ...
    public final Type[] getActualTypeArguments()
    {
      ...
      Type[] arrayOfType = (Type[])this.bLx.clone();
    ...
    public final int hashCode()
    {
      ...
      int i = Arrays.hashCode(this.bLx);
      int j = this.bLw.hashCode();
      int k = b.af(this.bLv);
    ...
    public final String toString()
    {
      ...
      int j = this.bLx.length;
      if (j == 0)
      {
        localObject = b.d(this.bLw);
        AppMethodBeat.o(107948);
        return localObject;
      }
      Object localObject = new StringBuilder((j + 1) * 30);
      ((StringBuilder)localObject).append(b.d(this.bLw)).append("<").append(b.d(this.bLx[0]));
      int i = 1;
      while (i < j)
      {
        ((StringBuilder)localObject).append(", ").append(b.d(this.bLx[i]));
        i += 1;
      }
      localObject = ">";
      AppMethodBeat.o(107948);
  ...
  {
    private final Type bLy;
    private final Type bLz;
    ...
    public c(Type[] paramArrayOfType1, Type[] paramArrayOfType2)
    {
      ...
      {
        a.checkArgument(bool1);
        this.bLz = b.b(paramArrayOfType2[0]);
        this.bLy = Object.class;
      ...
      this.bLz = null;
      this.bLy = b.b(paramArrayOfType1[0]);
      AppMethodBeat.o(107981);
    }
    ...
    public final int hashCode()
    {
      ...
      if (this.bLz != null) {}
      for (int i = this.bLz.hashCode() + 31;; i = 1)
      {
        int j = this.bLy.hashCode();
    ...
    public final String toString()
    {
      ...
      if (this.bLz != null)
      {
        str = "? super " + b.d(this.bLz);
        AppMethodBeat.o(107984);
        return str;
      }
      if (this.bLy == Object.class)
      {
        AppMethodBeat.o(107984);
        return "?";
      }
      String str = "? extends " + b.d(this.bLy);
      AppMethodBeat.o(107984);
      return str;
    }
  }
