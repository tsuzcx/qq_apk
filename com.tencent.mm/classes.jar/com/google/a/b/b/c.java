  ...
  extends b
{
  ...
  private final Object bOu;
  private final Field bOv;
  ...
  private boolean b(AccessibleObject paramAccessibleObject)
  {
    ...
    if ((this.bOu != null) && (this.bOv != null)) {
      try
      {
        long l = ((Long)bOt.getMethod("objectFieldOffset", new Class[] { Field.class }).invoke(this.bOu, new Object[] { this.bOv })).longValue();
        bOt.getMethod("putBoolean", new Class[] { Object.class, Long.TYPE, Boolean.TYPE }).invoke(this.bOu, new Object[] { paramAccessibleObject, Long.valueOf(l), Boolean.TRUE });
