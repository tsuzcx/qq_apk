...
{
  static void y(Class<?> paramClass)
  {
  ...
  public static l zr()
  {
    try
    {
      ...
      localObject1 = new l()
      {
        public final <T> T x(Class<T> paramAnonymousClass)
        {
          AppMethodBeat.i(108105);
          y(paramAnonymousClass);
          paramAnonymousClass = this.bMp.invoke(localObject4, new Object[] { paramAnonymousClass });
      ...
      try
      {
        ...
        localObject2 = new l()
        {
          public final <T> T x(Class<T> paramAnonymousClass)
          {
            ...
            y(paramAnonymousClass);
            paramAnonymousClass = this.bMr.invoke(null, new Object[] { paramAnonymousClass, Integer.valueOf(i) });
        ...
        try
        {
          ...
          localObject3 = new l()
          {
            public final <T> T x(Class<T> paramAnonymousClass)
            {
              ...
              y(paramAnonymousClass);
              paramAnonymousClass = this.bMr.invoke(null, new Object[] { paramAnonymousClass, Object.class });
  ...
  public abstract <T> T x(Class<T> paramClass);
}
