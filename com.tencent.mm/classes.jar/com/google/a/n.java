...
public final class n
  extends i
{
  private static final Class<?>[] bLo = { Integer.TYPE, Long.TYPE, Short.TYPE, Float.TYPE, Double.TYPE, Byte.TYPE, Boolean.TYPE, Character.TYPE, Integer.class, Long.class, Short.class, Float.class, Double.class, Byte.class, Boolean.class, Character.class };
  public Object value;
  ...
  private static boolean ad(Object paramObject)
  {
  ...
  private void setValue(Object paramObject)
  {
    ...
    if (((paramObject instanceof Number)) || (ad(paramObject))) {}
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    {
      if (yZ().longValue() == paramObject.yZ().longValue())
      {
        AppMethodBeat.o(107886);
        return true;
      }
    ...
    {
      double d1 = yZ().doubleValue();
      double d2 = paramObject.yZ().doubleValue();
  ...
  public final int hashCode()
  {
    ...
    {
      l = Double.doubleToLongBits(yZ().doubleValue());
      i = (int)(l ^ l >>> 32);
      AppMethodBeat.o(107885);
      return i;
    }
  ...
  public final boolean zb()
  {
    ...
    boolean bool = Boolean.parseBoolean(za());
    AppMethodBeat.o(107881);
    return bool;
  }
}
