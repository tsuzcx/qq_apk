...
public final class p
  extends k
{
  private static final Class<?>[] bFC = { Integer.TYPE, Long.TYPE, Short.TYPE, Float.TYPE, Double.TYPE, Byte.TYPE, Boolean.TYPE, Character.TYPE, Integer.class, Long.class, Short.class, Float.class, Double.class, Byte.class, Boolean.class, Character.class };
  public Object value;
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    {
      if (xn().longValue() == paramObject.xn().longValue())
      {
        AppMethodBeat.o(107886);
        return true;
      }
    ...
    {
      double d1 = xn().doubleValue();
      double d2 = paramObject.xn().doubleValue();
  ...
  public final boolean getAsBoolean()
  {
    ...
    boolean bool = Boolean.parseBoolean(xo());
    AppMethodBeat.o(107881);
    return bool;
  }
  ...
  public final int hashCode()
  {
    ...
    {
      l = Double.doubleToLongBits(xn().doubleValue());
      i = (int)(l ^ l >>> 32);
      AppMethodBeat.o(107885);
      return i;
    }
