  ...
  implements a
{
  ...
  public static a al(Context paramContext)
  {
    ...
    {
      if (bCp == null) {
        bCp = new b(AppMeasurement.getInstance(paramContext));
      }
      paramContext = bCp;
  ...
  public final void logEvent(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    if (!com.google.firebase.analytics.connector.internal.b.bc(paramString1))
    {
    ...
    this.bCo.logEventInternal(paramString1, paramString2, paramBundle);
    AppMethodBeat.o(116768);
  }
  ...
  public final void setUserProperty(String paramString1, String paramString2, Object paramObject)
  {
    ...
    if (!com.google.firebase.analytics.connector.internal.b.bd(paramString2))
    {
    ...
    this.bCo.setUserPropertyInternal(paramString1, paramString2, paramObject);
    AppMethodBeat.o(116769);
  }
}
