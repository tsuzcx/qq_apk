...
{
  private final boolean aUt = oA();
  private final long aUu = 1000L;
  private final Intent aUv = new Intent("com.google.android.googlequicksearchbox.SEARCH_ACTION_VERIFICATION_SERVICE").setPackage("com.google.android.googlequicksearchbox");
  private SearchActionVerificationClientService.a aUw;
  private a aUx = null;
  ...
  {
    super.onCreate();
    this.aUw = new SearchActionVerificationClientService.a(this);
    bindService(this.aUv, this.aUw, 1);
  }
  
  public final void onDestroy()
  {
    super.onDestroy();
    unbindService(this.aUw);
  }
  ...
  protected final void onHandleIntent(Intent paramIntent)
  {
    ...
    do
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        while ((!isConnected()) && (System.nanoTime() - l < this.aUu * 1000000L))
        {
          try
          {
            Thread.sleep(50L);
      ...
      if (paramIntent.hasExtra("SearchActionVerificationClientExtraIntent"))
      {
        ...
        try
        {
          int j = this.aUx.getVersion();
          new StringBuilder(24).append("API version: ").append(j);
          localObject = new Bundle();
          if ((i == 0) || (!this.aUx.a(paramIntent, (Bundle)localObject))) {
            continue;
          }
        }
