...
public class zzb
{
  ...
  private static void zza(Parcel paramParcel, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 != paramInt2)
    {
      ...
      throw new zzb.zza(String.valueOf(str).length() + 46 + "Expected size " + paramInt2 + " got " + paramInt1 + " (0x" + str + ")", paramParcel);
    }
  }
  ...
  private static void zza(Parcel paramParcel, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt2 != paramInt3)
    {
      ...
      throw new zzb.zza(String.valueOf(str).length() + 46 + "Expected size " + paramInt3 + " got " + paramInt2 + " (0x" + str + ")", paramParcel);
    }
  }
  ...
  public static int zzaX(Parcel paramParcel)
  {
    return paramParcel.readInt();
  }
  
  public static int zzaY(Parcel paramParcel)
  {
    int j = zzaX(paramParcel);
    ...
    if (zzdc(j) != 20293)
    {
      ...
      for (str = "Expected object header. Got 0x".concat(str);; str = new String("Expected object header. Got 0x")) {
        throw new zzb.zza(str, paramParcel);
      }
    }
    j = i + k;
    if ((j < i) || (j > paramParcel.dataSize())) {
      throw new zzb.zza(54 + "Size read is invalid start=" + i + " end=" + j, paramParcel);
    }
    return j;
  }
  ...
  public static int zzdc(int paramInt)
  {
