  ...
  extends SQLiteOpenHelper
{
  ...
  private long zzbHe = 0L;
  
  zzcg$zzb(zzcg paramzzcg, Context paramContext, String paramString)
  {
  ...
  private boolean zza(String paramString, SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   72: astore_1
    //   73: aload_1
    //   74: invokestatic 71	com/google/android/gms/tagmanager/zzbo:zzbh	(Ljava/lang/String;)V
    //   77: aload_2
    //   78: ifnull +9 -> 87
    //   81: aload_2
  ...
  {
    if ((this.zzbHd) && (this.zzbHe + 3600000L > zzcg.zza(this.zzbHc).currentTimeMillis())) {
      throw new SQLiteException("Database creation failed");
    }
    Object localObject1 = null;
    this.zzbHd = true;
    this.zzbHe = zzcg.zza(this.zzbHc).currentTimeMillis();
    try
    {
    ...
    catch (SQLiteException localSQLiteException)
    {
      ...
      {
        Object localObject2;
        zzcg.zzc(this.zzbHc).getDatabasePath(zzcg.zzb(this.zzbHc)).delete();
      }
    }
  ...
  public void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    try
    {
      ...
      {
        paramSQLiteDatabase.execSQL(zzcg.zzRc());
        return;
      }
    }
    finally
 ...
 * Qualified Name:     com.google.android.gms.tagmanager.zzcg.zzb
