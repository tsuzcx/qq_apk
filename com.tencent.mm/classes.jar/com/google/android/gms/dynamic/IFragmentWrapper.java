    ...
    implements IFragmentWrapper
  {
    ...
    public boolean dispatchTransaction(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
    {
      ...
      for (;;)
      {
        ...
        paramParcel1 = new com.tencent.mm.hellhoundlib.b.a().cG(paramParcel1);
        com.tencent.mm.hellhoundlib.a.a.b(this, paramParcel1.aYi(), "com/google/android/gms/dynamic/IFragmentWrapper$Stub", "dispatchTransaction", "(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
        startActivity((Intent)paramParcel1.sb(0));
