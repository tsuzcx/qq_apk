...
public final class h
{
  ...
  private static final int[] bgu = { -1, 8000, 16000, 32000, -1, -1, 11025, 22050, 44100, -1, -1, 12000, 24000, 48000, -1, -1 };
  private static final int[] bgv = { 64, 112, 128, 192, 224, 256, 384, 448, 512, 640, 768, 896, 1024, 1152, 1280, 1536, 1920, 2048, 2304, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680 };
  ...
  public static Format a(byte[] paramArrayOfByte, String paramString1, String paramString2)
  {
    ...
    paramArrayOfByte.en(60);
    int i = paramArrayOfByte.em(6);
    int k = bgt[i];
    i = paramArrayOfByte.em(4);
    int m = bgu[i];
    i = paramArrayOfByte.em(5);
    if (i >= bgv.length)
    {
      i = -1;
      paramArrayOfByte.en(10);
      if (paramArrayOfByte.em(2) <= 0) {
        break label121;
      }
    }
    label121:
