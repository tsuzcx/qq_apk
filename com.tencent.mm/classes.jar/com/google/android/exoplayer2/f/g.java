...
public abstract interface g
{
  public static final g ddF = new g()
  {
    ...
    public final e k(Format paramAnonymousFormat)
    {
      ...
      String str = paramAnonymousFormat.cGN;
      int i = -1;
      switch (str.hashCode())
      {
      }
      ...
      paramAnonymousFormat = new com.google.android.exoplayer2.f.c.a(paramAnonymousFormat.cGP);
      AppMethodBeat.o(92823);
      return paramAnonymousFormat;
      ...
      AppMethodBeat.o(92823);
      return paramAnonymousFormat;
      paramAnonymousFormat = new com.google.android.exoplayer2.f.f.a(paramAnonymousFormat.cGP);
      AppMethodBeat.o(92823);
      return paramAnonymousFormat;
      paramAnonymousFormat = new com.google.android.exoplayer2.f.a.a(paramAnonymousFormat.cGN, paramAnonymousFormat.cHa);
      AppMethodBeat.o(92823);
      return paramAnonymousFormat;
      paramAnonymousFormat = new c(paramAnonymousFormat.cHa);
      AppMethodBeat.o(92823);
      return paramAnonymousFormat;
      paramAnonymousFormat = new com.google.android.exoplayer2.f.b.a(paramAnonymousFormat.cGP);
      AppMethodBeat.o(92823);
      return paramAnonymousFormat;
    }
  };
