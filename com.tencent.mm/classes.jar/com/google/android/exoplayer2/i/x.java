...
public final class x
{
  ...
  private static final Pattern bxe;
  private static final Pattern bxf;
  ...
  public static ExecutorService aL(String paramString)
  {
  ...
  public static byte[] aN(String paramString)
  {
  ...
  public static long aP(String paramString)
  {
    ...
    Matcher localMatcher = bxd.matcher(paramString);
  ...
  public static byte[] aR(String paramString)
  {
  ...
  public static String aS(String paramString)
  {
    ...
    Matcher localMatcher = bxf.matcher(paramString);
    j = m;
  ...
  public static int m(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    {
      i = i << 8 ^ bxg[((i >>> 24 ^ paramArrayOfByte[paramInt2] & 0xFF) & 0xFF)];
      paramInt2 += 1;
    }
    return i;
  }
