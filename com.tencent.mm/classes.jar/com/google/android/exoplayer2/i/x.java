...
public final class x
{
  ...
  private static final Pattern bHs;
  private static final Pattern bHt;
  ...
  public static long bI(String paramString)
  {
    ...
    Matcher localMatcher = bHr.matcher(paramString);
  ...
  public static String bL(String paramString)
  {
    ...
    Matcher localMatcher = bHt.matcher(paramString);
    j = m;
  ...
  public static int m(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    {
      i = i << 8 ^ bHu[((i >>> 24 ^ paramArrayOfByte[paramInt2] & 0xFF) & 0xFF)];
      paramInt2 += 1;
    }
    return i;
  }
