  ...
  implements g
{
  ...
  private CipherInputStream boG;
  
  public a(g paramg, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    this.boE = paramg;
    this.aXd = paramArrayOfByte1;
    this.boF = paramArrayOfByte2;
  }
  ...
  public final long a(com.google.android.exoplayer2.h.j paramj)
  {
    ...
    //   14: dup
    //   15: aload_0
    //   16: getfield 22	com/google/android/exoplayer2/source/b/a:aXd	[B
    //   19: ldc 54
    ...
    //   28: dup
    //   29: aload_0
    //   30: getfield 24	com/google/android/exoplayer2/source/b/a:boF	[B
    ...
    //   54: dup
    //   55: aload_0
    //   56: getfield 20	com/google/android/exoplayer2/source/b/a:boE	Lcom/google/android/exoplayer2/h/g;
    //   59: aload_1
    ...
    //   67: putfield 78	com/google/android/exoplayer2/source/b/a:boG	Ljavax/crypto/CipherInputStream;
    //   70: ldc 36
  ...
  public final int read(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramInt1 = this.boG.read(paramArrayOfByte, paramInt1, paramInt2);
      if (paramInt1 >= 0) {
        break;
      }
