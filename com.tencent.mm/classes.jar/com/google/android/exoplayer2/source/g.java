...
final class g
  implements com.google.android.exoplayer2.c.g, t.a<a>, t.d, i, l.b
{
  boolean aRL;
  long aSz;
  ...
  final t bkP;
  private final b bkQ;
  final com.google.android.exoplayer2.i.f bkR;
  private final Runnable bkS;
  final Runnable bkT;
  com.google.android.exoplayer2.c.l bkU;
  l[] bkV;
  private int[] bkW;
  boolean bkX;
  private boolean bkY;
  ...
  public g(Uri paramUri, com.google.android.exoplayer2.h.g paramg, com.google.android.exoplayer2.c.e[] paramArrayOfe, int paramInt1, Handler paramHandler, h.a parama, c paramc, b paramb, String paramString, int paramInt2)
  {
    ...
    this.bkL = paramc;
    this.bkM = paramb;
    this.bkN = paramString;
    this.bkO = paramInt2;
    this.bkP = new t("Loader:ExtractorMediaPeriod");
    this.bkQ = new b(paramArrayOfe, this);
    this.bkR = new com.google.android.exoplayer2.i.f();
    this.bkS = new Runnable()
    {
      public final void run()
      {
        ...
        g localg = g.this;
        if ((localg.released) || (localg.aRL) || (localg.bkU == null) || (!localg.bkX))
        {
          AppMethodBeat.o(92643);
          return;
        }
        Object localObject1 = localg.bkV;
        int j = localObject1.length;
        int i = 0;
        while (i < j)
        {
          if (localObject1[i].blN.tU() == null) {
            break label296;
          }
          i += 1;
        }
        localg.bkR.vE();
        j = localg.bkV.length;
        localObject1 = new p[j];
        localg.bld = new boolean[j];
        localg.blc = new boolean[j];
        localg.aSz = localg.bkU.getDurationUs();
        i = 0;
        if (i < j)
        {
          Object localObject2 = localg.bkV[i].blN.tU();
          localObject1[i] = new p(new Format[] { localObject2 });
          localObject2 = ((Format)localObject2).aSd;
          if ((j.aK((String)localObject2)) || (j.aJ((String)localObject2))) {}
          for (int k = 1;; k = 0)
          {
            localg.bld[i] = k;
            localg.ble = (k | localg.ble);
            i += 1;
            break;
          }
        }
        localg.blb = new q((p[])localObject1);
        localg.aRL = true;
        localg.bkL.d(localg.aSz, localg.bkU.sH());
        localg.bkx.a(localg);
        label296:
        AppMethodBeat.o(92643);
      }
    };
    this.bkT = new Runnable()
    {
      public final void run()
      {
  ...
  private boolean Y(long paramLong)
  {
    ...
    while (i < j)
    {
      l locall = this.bkV[i];
      locall.rewind();
      if ((!locall.f(paramLong, false)) && ((this.bld[i] != 0) || (!this.ble)))
      {
  ...
  private void startLoading()
  {
    ...
    a locala = new a(this.uri, this.aWG, this.bkQ, this.bkR);
    if (this.aRL)
    {
      a.checkState(tM());
      if ((this.aSz != -9223372036854775807L) && (this.blg >= this.aSz))
      {
        this.bli = true;
        this.blg = -9223372036854775807L;
      ...
      locala.i(this.bkU.K(this.blg), this.blg);
      this.blg = -9223372036854775807L;
    }
    this.blh = tK();
    int j = this.bkJ;
    int i = j;
    if (j == -1) {
      if ((this.aRL) && (this.length == -1L) && ((this.bkU == null) || (this.bkU.getDurationUs() == -9223372036854775807L))) {
        break label193;
      }
    }
    label193:
  ...
  private long tL()
  {
    ...
    while (i < j)
    {
      l = Math.max(l, arrayOfl[i].blN.tL());
      i += 1;
    }
  ...
  public final void U(long paramLong)
  {
    ...
    while (i < j)
    {
      this.bkV[i].b(paramLong, false, this.blc[i]);
      i += 1;
    }
  ...
  public final boolean W(long paramLong)
  {
    ...
    if ((this.bli) || ((this.aRL) && (this.bla == 0)))
    {
      AppMethodBeat.o(92657);
      return false;
    }
    boolean bool = this.bkR.vD();
    if (!this.bkP.isLoading())
    {
      startLoading();
      bool = true;
  ...
  public final long a(com.google.android.exoplayer2.g.f[] paramArrayOff, boolean[] paramArrayOfBoolean1, m[] paramArrayOfm, boolean[] paramArrayOfBoolean2, long paramLong)
  {
    ...
    a.checkState(this.aRL);
    int j = this.bla;
    int i = 0;
    int n;
    while (i < paramArrayOff.length)
    {
      if ((paramArrayOfm[i] != null) && ((paramArrayOff[i] == null) || (paramArrayOfBoolean1[i] == 0)))
      {
        n = ((d)paramArrayOfm[i]).track;
        a.checkState(this.blc[n]);
        this.bla -= 1;
        this.blc[n] = false;
    ...
    if (this.bkY) {
      if (j == 0)
      {
        ...
        if ((paramArrayOfm[j] != null) || (paramArrayOff[j] == null)) {
          break label536;
        }
        ...
        label167:
        a.checkState(bool);
        if (paramArrayOfBoolean1.ff(0) != 0) {
          break label341;
        }
        bool = true;
        label185:
        a.checkState(bool);
        n = this.blb.a(paramArrayOfBoolean1.va());
        if (this.blc[n] != 0) {
          break label347;
        }
        bool = true;
        ...
        this.bla += 1;
        this.blc[n] = true;
        paramArrayOfm[j] = new d(n);
        paramArrayOfBoolean2[j] = true;
        if (i != 0) {
          break label536;
        }
        paramArrayOfBoolean1 = this.bkV[n];
        paramArrayOfBoolean1.rewind();
        if ((paramArrayOfBoolean1.f(paramLong, true)) || (paramArrayOfBoolean1.blN.tS() == 0)) {
          break label353;
        }
        i = 1;
      }
  ...
  public final com.google.android.exoplayer2.c.m bh(int paramInt1, int paramInt2)
  {
    ...
    int i = this.bkV.length;
    paramInt2 = 0;
    while (paramInt2 < i)
    {
      if (this.bkW[paramInt2] == paramInt1)
      {
        locall = this.bkV[paramInt2];
        AppMethodBeat.o(92661);
        return locall;
      }
      paramInt2 += 1;
    }
    l locall = new l(this.bkM);
    locall.blX = this;
    this.bkW = Arrays.copyOf(this.bkW, i + 1);
    this.bkW[i] = paramInt1;
    this.bkV = ((l[])Arrays.copyOf(this.bkV, i + 1));
    this.bkV[i] = locall;
    AppMethodBeat.o(92661);
    return locall;
  }
  ...
  public final long tD()
  {
    ...
    if (this.ble)
    {
      ...
      for (;;)
      {
        ...
        l2 = l1;
        if (this.bld[i] != 0) {
          l2 = Math.min(l1, this.bkV[i].blN.tL());
        }
        i += 1;
        l1 = l2;
      }
  ...
  public final void tI()
  {
    ...
    if (((b)localObject).blp != null) {
      ((b)localObject).blp = null;
    }
  ...
  {
    private final com.google.android.exoplayer2.h.g aWG;
    private final g.b bkQ;
    private final com.google.android.exoplayer2.i.f bkR;
    private final com.google.android.exoplayer2.c.k blk;
    ...
    public a(Uri paramUri, com.google.android.exoplayer2.h.g paramg, g.b paramb, com.google.android.exoplayer2.i.f paramf)
    {
      ...
      this.aWG = ((com.google.android.exoplayer2.h.g)a.checkNotNull(paramg));
      this.bkQ = ((g.b)a.checkNotNull(paramb));
      this.bkR = paramf;
      this.blk = new com.google.android.exoplayer2.c.k();
      this.blm = true;
      this.length = -1L;
    ...
    public final void tP()
    {
      ...
      //   8: ifne +305 -> 313
      //   11: aload_0
      //   12: getfield 85	com/google/android/exoplayer2/source/g$a:bll	Z
      //   15: ifne +298 -> 313
      //   18: aload_0
      //   19: getfield 66	com/google/android/exoplayer2/source/g$a:blk	Lcom/google/android/exoplayer2/c/k;
      //   22: getfield 80	com/google/android/exoplayer2/c/k:position	J
      //   25: lstore_3
      //   26: aload_0
      //   27: aload_0
      //   28: getfield 55	com/google/android/exoplayer2/source/g$a:aWG	Lcom/google/android/exoplayer2/h/g;
      ...
      //   40: ldc2_w 69
      //   43: aload_0
      //   44: getfield 31	com/google/android/exoplayer2/source/g$a:blj	Lcom/google/android/exoplayer2/source/g;
      //   47: getfield 95	com/google/android/exoplayer2/source/g:bkN	Ljava/lang/String;
      ...
      //   85: dup
      //   86: aload_0
      //   87: getfield 55	com/google/android/exoplayer2/source/g$a:aWG	Lcom/google/android/exoplayer2/h/g;
      //   90: lload_3
      //   91: aload_0
      ...
      //   98: astore 5
      //   100: aload_0
      //   101: getfield 59	com/google/android/exoplayer2/source/g$a:bkQ	Lcom/google/android/exoplayer2/source/g$b;
      //   104: aload 5
      //   106: aload_0
      //   107: getfield 55	com/google/android/exoplayer2/source/g$a:aWG	Lcom/google/android/exoplayer2/h/g;
      ...
      //   118: astore 6
      //   120: aload_0
      //   121: getfield 68	com/google/android/exoplayer2/source/g$a:blm	Z
      //   124: ifeq +20 -> 144
      //   127: aload 6
      //   129: lload_3
      //   130: aload_0
      //   131: getfield 82	com/google/android/exoplayer2/source/g$a:bln	J
      //   134: invokeinterface 118 5 0
      //   139: aload_0
      //   140: iconst_0
      //   141: putfield 68	com/google/android/exoplayer2/source/g$a:blm	Z
      //   144: iload_1
      //   145: ifne +90 -> 235
      //   148: aload_0
      //   149: getfield 85	com/google/android/exoplayer2/source/g$a:bll	Z
      //   152: ifne +83 -> 235
      //   155: aload_0
      //   156: getfield 61	com/google/android/exoplayer2/source/g$a:bkR	Lcom/google/android/exoplayer2/i/f;
      //   159: invokevirtual 123	com/google/android/exoplayer2/i/f:block	()V
      //   162: aload 6
      //   164: aload 5
      //   166: aload_0
      //   167: getfield 66	com/google/android/exoplayer2/source/g$a:blk	Lcom/google/android/exoplayer2/c/k;
      ...
      //   185: aload_0
      //   186: getfield 31	com/google/android/exoplayer2/source/g$a:blj	Lcom/google/android/exoplayer2/source/g;
      //   189: getfield 135	com/google/android/exoplayer2/source/g:bkO	J
      //   192: lload_3
      //   193: ladd
      //   194: lcmp
      //   195: ifle +171 -> 366
      ...
      //   205: lstore_3
      //   206: aload_0
      //   207: getfield 61	com/google/android/exoplayer2/source/g$a:bkR	Lcom/google/android/exoplayer2/i/f;
      //   210: invokevirtual 138	com/google/android/exoplayer2/i/f:vE	()Z
      //   213: pop
      //   214: aload_0
      //   215: getfield 31	com/google/android/exoplayer2/source/g$a:blj	Lcom/google/android/exoplayer2/source/g;
      //   218: getfield 142	com/google/android/exoplayer2/source/g:handler	Landroid/os/Handler;
      //   221: aload_0
      //   222: getfield 31	com/google/android/exoplayer2/source/g$a:blj	Lcom/google/android/exoplayer2/source/g;
      //   225: getfield 146	com/google/android/exoplayer2/source/g:bkT	Ljava/lang/Runnable;
      ...
      //   241: istore_1
      //   242: aload_0
      //   243: getfield 55	com/google/android/exoplayer2/source/g$a:aWG	Lcom/google/android/exoplayer2/h/g;
      //   246: invokestatic 157	com/google/android/exoplayer2/i/x:a	(Lcom/google/android/exoplayer2/h/g;)V
      //   249: goto -242 -> 7
      //   252: aload_0
      //   253: getfield 66	com/google/android/exoplayer2/source/g$a:blk	Lcom/google/android/exoplayer2/c/k;
      //   256: aload 5
      ...
      //   281: ifnull +17 -> 298
      //   284: aload_0
      //   285: getfield 66	com/google/android/exoplayer2/source/g$a:blk	Lcom/google/android/exoplayer2/c/k;
      //   288: aload 6
      //   290: invokeinterface 132 1 0
      //   295: putfield 80	com/google/android/exoplayer2/c/k:position	J
      //   298: aload_0
      //   299: getfield 55	com/google/android/exoplayer2/source/g$a:aWG	Lcom/google/android/exoplayer2/h/g;
  ...
  {
    private final com.google.android.exoplayer2.c.g aXn;
    private final com.google.android.exoplayer2.c.e[] blo;
    com.google.android.exoplayer2.c.e blp;
    
    public b(com.google.android.exoplayer2.c.e[] paramArrayOfe, com.google.android.exoplayer2.c.g paramg)
    {
      this.blo = paramArrayOfe;
      this.aXn = paramg;
    }
    ...
    public final com.google.android.exoplayer2.c.e a(com.google.android.exoplayer2.c.f paramf, Uri paramUri)
    {
      ...
      //   5: aload_0
      //   6: getfield 36	com/google/android/exoplayer2/source/g$b:blp	Lcom/google/android/exoplayer2/c/e;
      //   9: ifnull +15 -> 24
      //   12: aload_0
      //   13: getfield 36	com/google/android/exoplayer2/source/g$b:blp	Lcom/google/android/exoplayer2/c/e;
      //   16: astore_1
      //   17: ldc 28
      ...
      //   23: areturn
      //   24: aload_0
      //   25: getfield 20	com/google/android/exoplayer2/source/g$b:blo	[Lcom/google/android/exoplayer2/c/e;
      //   28: astore 5
      //   30: aload 5
      //   32: arraylength
      //   33: istore 4
      ...
      //   60: aload_0
      //   61: aload 6
      //   63: putfield 36	com/google/android/exoplayer2/source/g$b:blp	Lcom/google/android/exoplayer2/c/e;
      //   66: aload_1
      //   67: invokeinterface 49 1 0
      //   72: aload_0
      //   73: getfield 36	com/google/android/exoplayer2/source/g$b:blp	Lcom/google/android/exoplayer2/c/e;
      //   76: ifnonnull +84 -> 160
      //   79: new 51	com/google/android/exoplayer2/source/r
      //   82: dup
      ...
      //   92: aload_0
      //   93: getfield 20	com/google/android/exoplayer2/source/g$b:blo	[Lcom/google/android/exoplayer2/c/e;
      ...
      //   110: aload_2
      //   111: invokespecial 77	com/google/android/exoplayer2/source/r:<init>	(Ljava/lang/String;Landroid/net/Uri;)V
      //   114: astore_1
      //   115: ldc 28
      ...
      //   159: athrow
      //   160: aload_0
      //   161: getfield 36	com/google/android/exoplayer2/source/g$b:blp	Lcom/google/android/exoplayer2/c/e;
      //   164: aload_0
      //   165: getfield 22	com/google/android/exoplayer2/source/g$b:aXn	Lcom/google/android/exoplayer2/c/g;
      //   168: invokeinterface 80 2 0
      //   173: aload_0
      //   174: getfield 36	com/google/android/exoplayer2/source/g$b:blp	Lcom/google/android/exoplayer2/c/e;
      //   177: astore_1
      //   178: ldc 28
    ...
    implements m
  {
    ...
    public final void X(long paramLong)
    {
      ...
      g localg = g.this;
      int i = this.track;
      l locall = localg.bkV[i];
      if ((localg.bli) && (paramLong > locall.blN.tL()))
      {
        locall.blN.tV();
    ...
    public final int b(com.google.android.exoplayer2.k paramk, com.google.android.exoplayer2.b.e parame, boolean paramBoolean)
    {
      ...
      g localg = g.this;
      int i = this.track;
      if ((localg.bkZ) || (localg.tM()))
      {
        AppMethodBeat.o(92650);
        return -3;
      }
      i = localg.bkV[i].a(paramk, parame, paramBoolean, localg.bli, localg.blf);
      AppMethodBeat.o(92650);
      return i;
    }
    ...
    public final boolean isReady()
    {
      ...
      g localg = g.this;
      int i = this.track;
      if ((localg.bli) || ((!localg.tM()) && (localg.bkV[i].blN.tT())))
      {
