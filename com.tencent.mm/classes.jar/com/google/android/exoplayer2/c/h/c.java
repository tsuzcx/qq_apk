...
final class c
{
  public static b n(f paramf)
  {
    AppMethodBeat.i(92313);
    a.checkNotNull(paramf);
    m localm = new m(16);
    if (a.a(paramf, localm).id != x.aY("RIFF"))
    {
    ...
    for (;;)
    {
      ...
      if (locala.id == x.aY("fmt ")) {
        break;
      }
      paramf.dS((int)locala.size);
    }
    if (locala.size >= 16L) {}
    int i;
    int j;
  ...
  static final class a
  {
    ...
    public static a a(f paramf, m paramm)
    {
      ...
      paramf = new a(paramm.readInt(), paramm.vM());
 ...
 * Qualified Name:     com.google.android.exoplayer2.c.h.c
