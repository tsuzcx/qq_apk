...
final class a
  extends d
{
  private static final int[] aXQ = { 5512, 11025, 22050, 44100 };
  private boolean aXR;
  private boolean aXS;
  ...
  protected final void a(com.google.android.exoplayer2.i.m paramm, long paramLong)
  {
    ...
    if (this.audioFormat == 2)
    {
      i = paramm.vy();
      this.aYi.a(paramm, i);
      this.aYi.a(paramLong, 1, i, 0, null);
    ...
    if ((i == 0) && (!this.aXS))
    {
      byte[] arrayOfByte = new byte[paramm.vy()];
  ...
  protected final boolean a(com.google.android.exoplayer2.i.m paramm)
  {
    ...
    if (!this.aXR)
    {
      ...
      if (this.audioFormat == 2)
      {
        paramm = Format.a(null, "audio/mpeg", -1, -1, 1, aXQ[(j >> 2 & 0x3)], null, null, null);
        this.aYi.f(paramm);
        this.aXS = true;
        this.aXR = true;
      }
