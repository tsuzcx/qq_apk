...
final class s
{
  ...
  public final void a(long paramLong, com.google.android.exoplayer2.i.m paramm)
  {
    ...
    com.google.android.exoplayer2.f.a.g.a(paramLong, paramm, this.bfN);
  ...
  public final void a(com.google.android.exoplayer2.c.g paramg, v.d paramd)
  {
    ...
    if (i < this.bfN.length)
    {
      ...
      Format localFormat = (Format)this.bfK.get(i);
      String str2 = localFormat.aSd;
      boolean bool;
      ...
      label158:
      for (String str1 = localFormat.id;; str1 = paramd.tl())
      {
        localm.f(Format.a(str1, str2, localFormat.aSs, localFormat.aSt, localFormat.aSu));
        this.bfN[i] = localm;
        i += 1;
        break;
        bool = false;
 ...
 * Qualified Name:     com.google.android.exoplayer2.c.g.s
