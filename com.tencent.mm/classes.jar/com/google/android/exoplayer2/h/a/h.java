...
{
  private q aZK;
  final HashMap<String, g> baf;
  final SparseArray<String> bag;
  final b bah;
  private final Cipher bai;
  private final SecretKeySpec baj;
  ...
  public h(File paramFile)
  {
    ...
    this.bah = new b(new File(paramFile, "cached_content_index.exi"));
  ...
  private void a(g paramg)
  {
    ...
    this.baf.put(paramg.key, paramg);
    this.bag.put(paramg.id, paramg.key);
  ...
  public final g aA(String paramString)
  {
    AppMethodBeat.i(151964);
    paramString = (g)this.baf.get(paramString);
  ...
  public final void aC(String paramString)
  {
    ...
    paramString = (g)this.baf.remove(paramString);
    if (paramString != null)
    {
      a.checkState(paramString.bae.isEmpty());
      this.bag.remove(paramString.id);
      this.bal = true;
    }
    AppMethodBeat.o(151966);
  }
  
  public final g az(String paramString)
  {
    AppMethodBeat.i(151963);
    g localg2 = (g)this.baf.get(paramString);
    g localg1 = localg2;
    if (localg2 == null) {
      localg1 = g(paramString, -1L);
    }
    AppMethodBeat.o(151963);
    return localg1;
  }
  
  final g g(String paramString, long paramLong)
  {
    AppMethodBeat.i(151971);
    paramString = new g(a(this.bag), paramString, paramLong);
    b(paramString);
  ...
  public final void qC()
  {
    ...
    //   9: aload_0
    //   10: getfield 104	com/google/android/exoplayer2/h/a/h:bal	Z
    //   13: ifne +9 -> 22
    //   16: ldc 164
    //   18: invokestatic 65	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   21: return
    //   22: aload_0
    //   23: getfield 62	com/google/android/exoplayer2/h/a/h:bah	Lcom/google/android/exoplayer2/i/b;
    //   26: invokevirtual 168	com/google/android/exoplayer2/i/b:qG	()Ljava/io/OutputStream;
    //   29: astore 4
    //   31: aload_0
    //   32: getfield 170	com/google/android/exoplayer2/h/a/h:aZK	Lcom/google/android/exoplayer2/i/q;
    ...
    //   48: putfield 170	com/google/android/exoplayer2/h/a/h:aZK	Lcom/google/android/exoplayer2/i/q;
    //   51: new 177	java/io/DataOutputStream
    //   54: dup
    //   55: aload_0
    //   56: getfield 170	com/google/android/exoplayer2/h/a/h:aZK	Lcom/google/android/exoplayer2/i/q;
    ...
    //   76: astore 4
    //   78: aload_0
    //   79: getfield 35	com/google/android/exoplayer2/h/a/h:bak	Z
    //   82: ifeq +302 -> 384
    //   85: aload 5
    //   87: astore 4
    //   89: aload_0
    //   90: getfield 37	com/google/android/exoplayer2/h/a/h:bai	Ljavax/crypto/Cipher;
    //   93: ifnull +291 -> 384
    //   96: iconst_1
    //   97: istore_1
    //   98: goto +404 -> 502
    ...
    //   167: astore 4
    //   169: aload_0
    //   170: getfield 37	com/google/android/exoplayer2/h/a/h:bai	Ljavax/crypto/Cipher;
    //   173: iconst_1
    //   174: aload_0
    //   175: getfield 39	com/google/android/exoplayer2/h/a/h:baj	Ljavax/crypto/spec/SecretKeySpec;
    //   178: aload_3
    ...
    //   202: dup
    //   203: aload_0
    //   204: getfield 170	com/google/android/exoplayer2/h/a/h:aZK	Lcom/google/android/exoplayer2/i/q;
    //   207: aload_0
    //   208: getfield 37	com/google/android/exoplayer2/h/a/h:bai	Ljavax/crypto/Cipher;
    ...
    //   221: aload_3
    //   222: aload_0
    //   223: getfield 44	com/google/android/exoplayer2/h/a/h:baf	Ljava/util/HashMap;
    //   226: invokevirtual 210	java/util/HashMap:size	()I
    //   229: invokevirtual 181	java/io/DataOutputStream:writeInt	(I)V
    //   232: aload_3
    //   233: astore 4
    //   235: aload_0
    //   236: getfield 44	com/google/android/exoplayer2/h/a/h:baf	Ljava/util/HashMap;
    ...
    //   274: checkcast 83	com/google/android/exoplayer2/h/a/g
    //   277: astore 6
    //   279: aload_3
    //   280: astore 4
    //   282: aload_3
    //   283: aload 6
    //   285: getfield 95	com/google/android/exoplayer2/h/a/g:id	I
    //   288: invokevirtual 181	java/io/DataOutputStream:writeInt	(I)V
    //   291: aload_3
    //   292: astore 4
    //   294: aload_3
    //   295: aload 6
    //   297: getfield 87	com/google/android/exoplayer2/h/a/g:key	Ljava/lang/String;
    //   300: invokevirtual 232	java/io/DataOutputStream:writeUTF	(Ljava/lang/String;)V
    //   303: aload_3
    //   304: astore 4
    //   306: aload_3
    //   307: aload 6
    //   309: getfield 236	com/google/android/exoplayer2/h/a/g:aPF	J
    //   312: invokevirtual 240	java/io/DataOutputStream:writeLong	(J)V
    //   315: aload_3
    //   316: astore 4
    //   318: aload 6
    //   320: invokevirtual 243	com/google/android/exoplayer2/h/a/g:qB	()I
    //   323: istore_2
    //   324: iload_2
    //   325: iload_1
    //   326: iadd
    ...
    //   328: goto -77 -> 251
    //   331: aload_0
    //   332: getfield 170	com/google/android/exoplayer2/h/a/h:aZK	Lcom/google/android/exoplayer2/i/q;
    //   335: aload 4
    ...
    //   440: astore 4
    //   442: aload_0
    //   443: getfield 62	com/google/android/exoplayer2/h/a/h:bah	Lcom/google/android/exoplayer2/i/b;
    //   446: astore 5
    //   448: aload_3
    //   449: astore 4
    //   451: aload_3
    ...
    //   456: astore 4
    //   458: aload 5
    //   460: getfield 270	com/google/android/exoplayer2/i/b:baC	Ljava/io/File;
    ...
    //   471: aload_0
    //   472: iconst_0
    //   473: putfield 104	com/google/android/exoplayer2/h/a/h:bal	Z
    //   476: ldc 164
  ...
  public final void qD()
  {
    ...
    Iterator localIterator = this.baf.values().iterator();
    while (localIterator.hasNext())
    {
      g localg = (g)localIterator.next();
      if (localg.bae.isEmpty()) {
        ((LinkedList)localObject).add(localg.key);
      }
    }
    localObject = ((LinkedList)localObject).iterator();
    while (((Iterator)localObject).hasNext()) {
      aC((String)((Iterator)localObject).next());
    }
  ...
  final boolean qE()
  {
    ...
    //   18: astore 7
    //   20: aload_0
    //   21: getfield 62	com/google/android/exoplayer2/h/a/h:bah	Lcom/google/android/exoplayer2/i/b;
    //   24: astore 9
    //   26: aload 5
    //   28: astore 6
    //   30: aload 8
    //   32: astore 7
    //   34: aload 9
    //   36: getfield 270	com/google/android/exoplayer2/i/b:baC	Ljava/io/File;
    ...
    //   51: astore 7
    //   53: aload 9
    //   55: getfield 297	com/google/android/exoplayer2/i/b:baB	Ljava/io/File;
    ...
    //   68: astore 7
    //   70: aload 9
    //   72: getfield 270	com/google/android/exoplayer2/i/b:baC	Ljava/io/File;
    //   75: aload 9
    //   77: getfield 297	com/google/android/exoplayer2/i/b:baB	Ljava/io/File;
    ...
    //   99: dup
    //   100: aload 9
    //   102: getfield 297	com/google/android/exoplayer2/i/b:baB	Ljava/io/File;
    ...
    //   163: ifeq +216 -> 379
    //   166: aload_0
    //   167: getfield 37	com/google/android/exoplayer2/h/a/h:bai	Ljavax/crypto/Cipher;
    //   170: astore 6
    //   172: aload 6
    ...
    //   212: astore 6
    //   214: aload_0
    //   215: getfield 37	com/google/android/exoplayer2/h/a/h:bai	Ljavax/crypto/Cipher;
    //   218: iconst_2
    //   219: aload_0
    //   220: getfield 39	com/google/android/exoplayer2/h/a/h:baj	Ljavax/crypto/spec/SecretKeySpec;
    //   223: aload 6
    ...
    //   236: aload 9
    //   238: aload_0
    //   239: getfield 37	com/google/android/exoplayer2/h/a/h:bai	Ljavax/crypto/Cipher;
    ...
    //   281: aload 5
    //   283: astore 7
    //   285: new 83	com/google/android/exoplayer2/h/a/g
    //   288: dup
    //   289: aload 5
    //   291: invokespecial 326	com/google/android/exoplayer2/h/a/g:<init>	(Ljava/io/DataInputStream;)V
    //   294: astore 8
    //   296: aload 5
    //   298: astore 6
    //   300: aload 5
    ...
    //   304: aload_0
    //   305: aload 8
    //   307: invokespecial 102	com/google/android/exoplayer2/h/a/h:a	(Lcom/google/android/exoplayer2/h/a/g;)V
    //   310: aload 5
    //   312: astore 6
    //   314: aload 5
    //   316: astore 7
    ...
    //   378: ireturn
    //   379: aload_0
    //   380: getfield 37	com/google/android/exoplayer2/h/a/h:bai	Ljavax/crypto/Cipher;
    //   383: ifnull +8 -> 391
    //   386: aload_0
    //   387: iconst_1
    //   388: putfield 104	com/google/android/exoplayer2/h/a/h:bal	Z
    //   391: goto -137 -> 254
    //   394: aload 5
    //   396: astore 6
    //   398: aload 5
