  ...
  implements g
{
  private int a(h paramh, StringBuilder paramStringBuilder1, StringBuilder paramStringBuilder2, int paramInt)
  {
    ...
    paramh.pos -= 1;
    paramInt = a(paramh.JM(), paramStringBuilder2);
    paramh.cfk = null;
  ...
  static void a(h paramh, StringBuilder paramStringBuilder)
  {
    ...
    paramh.cM(new String(new char[] { (char)(i / 256), (char)(i % 256) }));
  ...
  public void a(h paramh)
  {
    ...
    while (paramh.JN())
    {
      ...
      int i = (localStringBuilder1.length() / 3 << 1) + paramh.cfi.length();
      paramh.hZ(i);
      int k = paramh.cfk.cft - i;
      if (!paramh.JN())
      {
      ...
      {
        i = j.b(paramh.msg, paramh.pos, JJ());
        if (i != JJ()) {
          paramh.cfj = i;
        }
      }
