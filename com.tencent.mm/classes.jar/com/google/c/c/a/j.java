...
{
  private static int I(byte[] paramArrayOfByte)
  {
    int j = 0;
    int k;
  ...
  public static String a(String paramString, l paraml, com.google.c.b paramb1, com.google.c.b paramb2)
  {
    ...
    int k = localh.cfi.length();
    localh.JQ();
    j = localh.cfk.cft;
    if ((k < j) && (i != 0) && (i != 5)) {
      localh.k('þ');
    }
    paramString = localh.cfi;
    ...
    paramString = localh.cfi.toString();
  ...
  static boolean l(char paramChar)
  {
    return (paramChar >= '0') && (paramChar <= '9');
  }
  
  static boolean m(char paramChar)
  {
  ...
  private static boolean n(char paramChar)
  {
    ...
    if ((o(paramChar)) || (paramChar == ' ') || ((paramChar >= '0') && (paramChar <= '9')) || ((paramChar >= 'A') && (paramChar <= 'Z')))
    {
