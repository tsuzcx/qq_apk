...
public final class b
{
  ...
  public b(int paramInt1, int paramInt2)
  {
    ...
    this.chi = ((byte[][])Array.newInstance(Byte.TYPE, new int[] { paramInt2, paramInt1 }));
  ...
  {
    this.chi[paramInt2][paramInt1] = ((byte)paramInt3);
  }
  
  public final byte cg(int paramInt1, int paramInt2)
  {
    return this.chi[paramInt2][paramInt1];
  }
  
  public final void i(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    byte[] arrayOfByte = this.chi[paramInt2];
    if (paramBoolean) {}
