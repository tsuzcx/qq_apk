  ...
  implements g
{
  private static com.google.c.b.b a(f paramf, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    while (paramInt1 < m)
    {
      ...
      while (i < k)
      {
        if (paramf.cg(i, paramInt1) == 1) {
          localb.r(paramInt3, paramInt2, n, n);
        }
        i += 1;
        paramInt3 += n;
      }
  ...
  public final com.google.c.b.b a(String paramString, com.google.c.a parama, int paramInt1, int paramInt2, Map<com.google.c.c, ?> paramMap)
  {
    ...
    if (paramMap != null)
    {
      if (paramMap.containsKey(com.google.c.c.cdq)) {
        parama = com.google.c.f.a.a.valueOf(paramMap.get(com.google.c.c.cdq).toString());
      }
      locala = parama;
      i = j;
