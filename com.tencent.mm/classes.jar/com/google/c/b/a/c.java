  ...
  extends r<Date>
{
  ...
  private final List<DateFormat> dGe;
  ...
  static
  {
    ...
    dFZ = new s()
    {
      public final <T> r<T> a(com.google.c.e paramAnonymouse, a<T> paramAnonymousa)
      {
        AppMethodBeat.i(108025);
        if (paramAnonymousa.dIb == Date.class)
        {
  ...
  public c()
  {
    ...
    this.dGe.add(DateFormat.getDateTimeInstance(2, 2, Locale.US));
    if (!Locale.getDefault().equals(Locale.US)) {
      this.dGe.add(DateFormat.getDateTimeInstance(2, 2));
    }
    if (com.google.c.b.e.Za()) {
      this.dGe.add(new SimpleDateFormat("MMM d, yyyy h:mm:ss a", Locale.US));
    }
    AppMethodBeat.o(108003);
  }
  
  /* Error */
  private void a(com.google.c.d.c paramc, Date paramDate)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   8: ifnonnull +16 -> 24
    //   11: aload_1
    //   12: invokevirtual 96	com/google/c/d/c:Zv	()Lcom/google/c/d/c;
    //   15: pop
    //   16: ldc 90
    ...
    //   24: aload_1
    //   25: aload_0
    //   26: getfield 37	com/google/c/b/a/c:dGe	Ljava/util/List;
    //   29: iconst_0
    ...
    //   42: invokevirtual 108	com/google/c/d/c:dN	(Ljava/lang/String;)Lcom/google/c/d/c;
    //   45: pop
    //   46: ldc 90
    ...
    //   0	59	0	this	c
    //   0	59	1	paramc	com.google.c.d.c
  ...
  /* Error */
  private Date dL(java.lang.String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   4: invokestatic 21	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   7: aload_0
    //   8: getfield 37	com/google/c/b/a/c:dGe	Ljava/util/List;
    ...
    //   62: invokestatic 138	com/google/c/b/a/a/a:a	(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    //   65: astore_2
    //   66: aload_2
    //   67: astore_1
    //   68: ldc 113
    ...
    //   80: athrow
    //   81: astore_2
    //   82: new 140	com/google/c/p
    //   85: dup
    //   86: aload_1
    //   87: aload_2
    //   88: invokespecial 143	com/google/c/p:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   91: astore_1
    //   92: ldc 113
