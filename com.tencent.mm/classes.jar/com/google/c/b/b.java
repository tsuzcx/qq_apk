  ...
  implements Cloneable
{
  ...
  public b(int paramInt1, int paramInt2)
  {
    ...
    this.cec = ((paramInt1 + 31) / 32);
    this.ceb = new int[this.cec * paramInt2];
    AppMethodBeat.o(12330);
  }
  ...
  public final boolean bZ(int paramInt1, int paramInt2)
  {
    int i = this.cec;
    int j = paramInt1 / 32;
    return (this.ceb[(i * paramInt2 + j)] >>> (paramInt1 & 0x1F) & 0x1) != 0;
  }
  
  public final void ca(int paramInt1, int paramInt2)
  {
    paramInt2 = this.cec * paramInt2 + paramInt1 / 32;
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if ((this.width == paramObject.width) && (this.height == paramObject.height) && (this.cec == paramObject.cec) && (Arrays.equals(this.ceb, paramObject.ceb)))
    {
      AppMethodBeat.o(12332);
      return true;
    }
  ...
  public final int hashCode()
  {
    ...
    int k = this.height;
    int m = this.cec;
    int n = Arrays.hashCode(this.ceb);
