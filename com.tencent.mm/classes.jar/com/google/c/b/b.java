...
{
  static final Type[] dFb = new Type[0];
      ...
      if ((localObject1 instanceof WildcardType))
      {
        ...
        else if (localObject2.length == 1)
        {
          ...
          if (paramClass != localObject2[0])
          {
            ...
            for (;;)
            {
              paramType1 = new c(paramType1, dFb);
              AppMethodBeat.o(107904);
              return paramType1;
              paramType1 = new Type[1];
              paramType1[0] = paramClass;
  ...
  static int bn(Object paramObject)
  {
    ...
    implements Serializable, ParameterizedType
  {
    ...
    public b(Type paramType1, Type paramType2, Type... paramVarArgs)
    {
      ...
      {
        this.dFd = paramType1;
        this.dFe = b.b(paramType2);
        this.dFf = ((Type[])paramVarArgs.clone());
        int k = this.dFf.length;
        i = j;
        while (i < k)
        {
          a.checkNotNull(this.dFf[i]);
          b.f(this.dFf[i]);
          paramType1 = this.dFf;
    ...
    public final Type[] getActualTypeArguments()
    {
      ...
      Type[] arrayOfType = (Type[])this.dFf.clone();
    ...
    public final int hashCode()
    {
      ...
      int i = Arrays.hashCode(this.dFf);
      int j = this.dFe.hashCode();
      int k = b.bn(this.dFd);
    ...
    public final String toString()
    {
      ...
      int j = this.dFf.length;
      if (j == 0)
      {
        localObject = b.d(this.dFe);
        AppMethodBeat.o(107948);
        return localObject;
      }
      Object localObject = new StringBuilder((j + 1) * 30);
      ((StringBuilder)localObject).append(b.d(this.dFe)).append("<").append(b.d(this.dFf[0]));
      int i = 1;
      while (i < j)
      {
        ((StringBuilder)localObject).append(", ").append(b.d(this.dFf[i]));
        i += 1;
      }
      localObject = ">";
      AppMethodBeat.o(107948);
    ...
    implements Serializable, WildcardType
  {
    ...
    public c(Type[] paramArrayOfType1, Type[] paramArrayOfType2)
    {
      ...
      {
        a.checkArgument(bool1);
        this.dFh = b.b(paramArrayOfType2[0]);
        this.dFg = Object.class;
      ...
      this.dFh = null;
      this.dFg = b.b(paramArrayOfType1[0]);
      AppMethodBeat.o(107981);
    }
    ...
    public final int hashCode()
    {
      ...
      if (this.dFh != null) {}
      for (int i = this.dFh.hashCode() + 31;; i = 1)
      {
        int j = this.dFg.hashCode();
    ...
    public final String toString()
    {
      ...
      if (this.dFh != null)
      {
        str = "? super " + b.d(this.dFh);
        AppMethodBeat.o(107984);
        return str;
      }
      if (this.dFg == Object.class)
      {
        AppMethodBeat.o(107984);
        return "?";
      }
      String str = "? extends " + b.d(this.dFg);
      AppMethodBeat.o(107984);
      return str;
    }
  }
