  ...
  implements g
{
  ...
  private static b a(boolean[] paramArrayOfBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    while (paramInt2 < i)
    {
      if (paramArrayOfBoolean[paramInt2] != 0) {
        localb.r(paramInt1, 0, j, paramInt3);
      }
      paramInt2 += 1;
      paramInt1 += j;
    }
  ...
  public b a(String paramString, a parama, int paramInt1, int paramInt2, Map<c, ?> paramMap)
  {
    ...
    {
      i = j;
      if (paramMap.containsKey(c.cdv)) {
        i = Integer.parseInt(paramMap.get(c.cdv).toString());
      }
    }
    return a(cN(paramString), paramInt1, paramInt2, i);
  }
