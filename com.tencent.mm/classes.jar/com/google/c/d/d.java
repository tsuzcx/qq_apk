  ...
  extends o
{
  private static int c(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    ...
    a locala2 = f(paramCharSequence, paramInt1);
    if ((locala2 == a.cfM) || (locala2 == a.cfN))
    {
    ...
    if (paramInt2 == 100)
    {
      ...
      locala1 = f(paramCharSequence, paramInt1 + 2);
      if ((locala1 == a.cfM) || (locala1 == a.cfN))
      {
        AppMethodBeat.o(12381);
        return paramInt2;
      }
      if (locala1 == a.cfP)
      {
        if (f(paramCharSequence, paramInt1 + 3) == a.cfO)
        {
          AppMethodBeat.o(12381);
          return 99;
        }
      ...
      for (;;)
      {
        locala1 = f(paramCharSequence, paramInt1);
        if (locala1 != a.cfO) {
          break;
        }
        paramInt1 += 2;
    ...
    a locala1 = locala2;
    if (locala2 == a.cfP) {
      locala1 = f(paramCharSequence, paramInt1 + 1);
    }
    if (locala1 == a.cfO)
    {
      AppMethodBeat.o(12381);
  ...
  private static a f(CharSequence paramCharSequence, int paramInt)
  {
    AppMethodBeat.i(12380);
    int i = paramCharSequence.length();
    if (paramInt >= i)
    {
      paramCharSequence = a.cfM;
  ...
  public final boolean[] cN(String paramString)
  {
      ...
      if (i1 == m) {
        ...
        default: 
          if (m == 100)
          {
            ...
            m = i1;
            label255:
            ((Collection)localObject).add(c.cfL[i]);
            n += i * j;
            if (m == 0) {
              break label563;
            }
    ...
    for (i = j + 1;; i = j)
    {
      ...
      k = i1;
      break label255;
      ((Collection)localObject).add(c.cfL[(n % 103)]);
      ((Collection)localObject).add(c.cfL[106]);
  ...
  static enum a
  {
    static
    {
      ...
      cfM = new a("UNCODABLE", 0);
      cfN = new a("ONE_DIGIT", 1);
      cfO = new a("TWO_DIGITS", 2);
      cfP = new a("FNC_1", 3);
      cfQ = new a[] { cfM, cfN, cfO, cfP };
