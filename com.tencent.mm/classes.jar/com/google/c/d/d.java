  ...
  extends o
{
  private static int c(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    ...
    if ((locala2 == a.bTJ) || (locala2 == a.bTK))
    {
    ...
    if (paramInt2 == 100)
    {
      ...
      if ((locala1 == a.bTJ) || (locala1 == a.bTK))
      {
        AppMethodBeat.o(12381);
        return paramInt2;
      }
      if (locala1 == a.bTM)
      {
        if (d(paramCharSequence, paramInt1 + 3) == a.bTL)
        {
          AppMethodBeat.o(12381);
          return 99;
        }
  ...
  public final boolean[] cg(String paramString)
  {
      ...
      if (i1 == m) {
        ...
        default: 
          if (m == 100)
          {
            ...
            m = i1;
            label255:
            ((Collection)localObject).add(c.bTI[i]);
            n += i * j;
            if (m == 0) {
              break label563;
            }
    ...
    for (i = j + 1;; i = j)
    {
      ...
      k = i1;
      break label255;
      ((Collection)localObject).add(c.bTI[(n % 103)]);
      ((Collection)localObject).add(c.bTI[106]);
  ...
  static enum a
  {
    static
    {
      ...
      bTJ = new a("UNCODABLE", 0);
      bTK = new a("ONE_DIGIT", 1);
      bTL = new a("TWO_DIGITS", 2);
      bTM = new a("FNC_1", 3);
      bTN = new a[] { bTJ, bTK, bTL, bTM };
