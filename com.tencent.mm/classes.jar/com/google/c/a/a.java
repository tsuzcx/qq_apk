...
public final class a
  implements g
{
  private static final Charset cdG;
  
  static
  {
    AppMethodBeat.i(12256);
    cdG = Charset.forName("ISO-8859-1");
  ...
  private static b a(com.google.c.a.a.a parama, int paramInt1, int paramInt2)
  {
    ...
    while (paramInt1 < n)
    {
      ...
      while (j < m)
      {
        if (parama.bZ(j, paramInt1)) {
          localb.r(i, paramInt2, i1, i1);
        }
        j += 1;
        i += i1;
      }
  ...
  public final b a(String paramString, com.google.c.a parama, int paramInt1, int paramInt2, Map<com.google.c.c, ?> paramMap)
  {
    ...
    if (paramMap != null)
    {
      if (paramMap.containsKey(com.google.c.c.cdr)) {
        localCharset1 = Charset.forName(paramMap.get(com.google.c.c.cdr).toString());
      }
      if (paramMap.containsKey(com.google.c.c.cdq)) {
        i = Integer.parseInt(paramMap.get(com.google.c.c.cdq).toString());
      }
      localCharset2 = localCharset1;
      j = i;
      k = m;
      if (paramMap.containsKey(com.google.c.c.cdz))
      {
        k = Integer.parseInt(paramMap.get(com.google.c.c.cdz).toString());
        j = i;
        localCharset2 = localCharset1;
      }
    }
    if (parama != com.google.c.a.ccY)
    {
      paramString = new IllegalArgumentException("Can only encode AZTEC, but got ".concat(String.valueOf(parama)));
      AppMethodBeat.o(12254);
      throw paramString;
    }
    paramString = a(com.google.c.a.a.c.w(paramString.getBytes(localCharset2), j, k), paramInt1, paramInt2);
    AppMethodBeat.o(12254);
    return paramString;
  }
}
