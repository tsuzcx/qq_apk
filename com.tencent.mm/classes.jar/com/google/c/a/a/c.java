...
{
  private static final int[] cdN = { 4, 6, 6, 8, 8, 8, 8, 8, 8, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12 };
  ...
  private static com.google.c.b.a a(com.google.c.b.a parama, int paramInt)
  {
    ...
    if (i < n)
    {
      ...
      for (;;)
      {
        ...
        if ((k & i1) == 0)
        {
          locala.bY(k | 0x1, paramInt);
          i -= 1;
        }
        else
        {
          locala.bY(k, paramInt);
        }
      }
    }
  ...
  private static com.google.c.b.a a(com.google.c.b.a parama, int paramInt1, int paramInt2)
  {
    ...
    default: 
      ...
      throw parama;
    case 4: 
      localObject = com.google.c.b.a.a.ceM;
    }
    for (;;)
    {
      localObject = new com.google.c.b.a.c((com.google.c.b.a.a)localObject);
      int j = paramInt1 / paramInt2;
      parama = b(parama, paramInt2, j);
      ((com.google.c.b.a.c)localObject).e(parama, j - i);
      localObject = new com.google.c.b.a();
      ((com.google.c.b.a)localObject).bY(0, paramInt1 % paramInt2);
      i = parama.length;
      paramInt1 = 0;
      while (paramInt1 < i)
      {
        ((com.google.c.b.a)localObject).bY(parama[paramInt1], paramInt2);
        paramInt1 += 1;
      }
      localObject = com.google.c.b.a.a.ceL;
      continue;
      localObject = com.google.c.b.a.a.ceP;
      continue;
      localObject = com.google.c.b.a.a.ceK;
      continue;
      localObject = com.google.c.b.a.a.ceJ;
    }
    AppMethodBeat.o(12263);
    return localObject;
  }
  ...
  private static void a(b paramb, int paramInt1, int paramInt2)
  {
    ...
    while (i < paramInt2)
    {
      ...
      while (j <= paramInt1 + i)
      {
        paramb.ca(j, paramInt1 - i);
        paramb.ca(j, paramInt1 + i);
        paramb.ca(paramInt1 - i, j);
        paramb.ca(paramInt1 + i, j);
        j += 1;
      }
      i += 2;
    }
    paramb.ca(paramInt1 - paramInt2, paramInt1 - paramInt2);
    paramb.ca(paramInt1 - paramInt2 + 1, paramInt1 - paramInt2);
    paramb.ca(paramInt1 - paramInt2, paramInt1 - paramInt2 + 1);
    paramb.ca(paramInt1 + paramInt2, paramInt1 - paramInt2);
    paramb.ca(paramInt1 + paramInt2, paramInt1 - paramInt2 + 1);
    paramb.ca(paramInt1 + paramInt2, paramInt1 + paramInt2 - 1);
  ...
  private static void a(b paramb, boolean paramBoolean, int paramInt, com.google.c.b.a parama)
  {
    int j = 0;
    int i = 0;
    ...
    if (paramBoolean)
    {
      ...
      {
        i = k - 3 + paramInt;
        if (parama.cr(paramInt)) {
          paramb.ca(i, k - 5);
        }
        if (parama.cr(paramInt + 7)) {
          paramb.ca(k + 5, i);
        }
        if (parama.cr(20 - paramInt)) {
          paramb.ca(i, k + 5);
        }
        if (parama.cr(27 - paramInt)) {
          paramb.ca(k - 5, i);
        }
        paramInt += 1;
      }
    ...
    while (paramInt < 10)
    {
      ...
      if (parama.cr(paramInt + 10)) {
        paramb.ca(k + 7, i);
      }
      if (parama.cr(29 - paramInt)) {
        paramb.ca(i, k + 7);
      }
      if (parama.cr(39 - paramInt)) {
        paramb.ca(k - 7, i);
      }
      paramInt += 1;
    }
  ...
  private static int[] b(com.google.c.b.a parama, int paramInt1, int paramInt2)
  {
    ...
    while (paramInt2 < m)
    {
      ...
      if (i < paramInt1)
      {
        if (parama.cr(paramInt2 * paramInt1 + i)) {}
  ...
  private static int v(int paramInt, boolean paramBoolean)
  {
    if (paramBoolean) {}
    for (int i = 88;; i = 112) {
  ...
  public static a w(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    paramArrayOfByte = Collections.singletonList(f.cdV);
    int j = 0;
    int i;
    if (j < ((d)localObject1).cdS.length)
    {
      if (j + 1 < ((d)localObject1).cdS.length)
      {
        i = localObject1.cdS[(j + 1)];
        label61:
        switch (localObject1.cdS[j])
        {
        default: 
          i = 0;
          label114:
    ...
    Object localObject2 = ((f)Collections.min(paramArrayOfByte, new d.1((d)localObject1))).H(((d)localObject1).cdS);
    ...
    for (;;)
    {
      ...
      if (bool)
      {
        paramArrayOfByte.bY(j - 1, 2);
        paramArrayOfByte.bY(i1 - 1, 6);
      ...
      for (paramInt1 = 11;; paramInt1 = 14)
      {
        ...
        paramArrayOfByte.bY(j - 1, 5);
        paramArrayOfByte.bY(i1 - 1, 11);
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            if (m < 2)
            {
              if (((com.google.c.b.a)localObject1).cr(paramInt2 + i3 + m)) {
                ((b)localObject2).ca(arrayOfInt[((i << 1) + m)], arrayOfInt[((i << 1) + k)]);
              }
              if (((com.google.c.b.a)localObject1).cr((i2 << 1) + paramInt2 + i3 + m)) {
                ((b)localObject2).ca(arrayOfInt[((i << 1) + k)], arrayOfInt[(n - 1 - (i << 1) - m)]);
              }
              if (((com.google.c.b.a)localObject1).cr((i2 << 2) + paramInt2 + i3 + m)) {
                ((b)localObject2).ca(arrayOfInt[(n - 1 - (i << 1) - m)], arrayOfInt[(n - 1 - (i << 1) - k)]);
              }
              if (((com.google.c.b.a)localObject1).cr(i2 * 6 + paramInt2 + i3 + m)) {
                ((b)localObject2).ca(arrayOfInt[(n - 1 - (i << 1) - k)], arrayOfInt[((i << 1) + m)]);
              }
              m += 1;
              continue;
              label1051:
      ...
      for (;;)
      {
        ...
        paramArrayOfByte.cdH = bool;
        paramArrayOfByte.size = paramInt1;
        paramArrayOfByte.cdI = j;
        paramArrayOfByte.cdJ = i1;
        paramArrayOfByte.cdK = ((b)localObject2);
        AppMethodBeat.o(12260);
        ...
        while (i < n / 2 - 1)
        {
          ...
          while (k < paramInt1)
          {
            ((b)localObject2).ca(paramInt1 / 2 - paramInt2, k);
            ((b)localObject2).ca(paramInt1 / 2 + paramInt2, k);
            ((b)localObject2).ca(k, paramInt1 / 2 - paramInt2);
            ((b)localObject2).ca(k, paramInt1 / 2 + paramInt2);
            k += 2;
          }
          i += 15;
