...
public final class i
{
  ...
  {
    int i = 1;
    bju = new int[] { 5, 7, 10, 11, 12, 14, 18, 20, 24, 28, 36, 42, 48, 56, 62, 68 };
    ...
    int[] arrayOfInt14 = { 242, 93, 169, 50, 144, 210, 39, 118, 202, 188, 201, 189, 143, 108, 196, 37, 185, 112, 134, 230, 245, 63, 197, 190, 250, 106, 185, 221, 175, 64, 114, 71, 161, 44, 147, 6, 27, 218, 51, 63, 87, 10, 40, 130, 188, 17, 163, 31, 176, 170, 4, 107, 232, 7, 94, 166, 224, 124, 86, 47, 11, 204 };
    int[] arrayOfInt15 = { 220, 228, 173, 89, 251, 149, 159, 56, 89, 33, 147, 244, 154, 36, 73, 127, 213, 136, 248, 180, 234, 197, 158, 177, 68, 122, 93, 213, 15, 160, 227, 236, 66, 139, 153, 185, 202, 167, 179, 25, 220, 232, 96, 210, 231, 136, 223, 239, 181, 241, 59, 52, 172, 25, 49, 232, 211, 189, 64, 54, 108, 153, 132, 63, 96, 103, 82, 186 };
    bjv = new int[][] { arrayOfInt1, arrayOfInt2, arrayOfInt3, arrayOfInt4, arrayOfInt5, arrayOfInt6, arrayOfInt7, arrayOfInt8, { 52, 190, 88, 205, 109, 39, 176, 21, 155, 197, 251, 223, 155, 21, 5, 172, 254, 124, 12, 181, 184, 96, 50, 193 }, arrayOfInt9, arrayOfInt10, arrayOfInt11, arrayOfInt12, arrayOfInt13, arrayOfInt14, arrayOfInt15 };
    bjw = new int[256];
    bjx = new int['ÿ'];
    int j = 0;
    while (j < 255)
      ...
      if (i < paramInt1 + 0)
      {
        ...
        if (j > 0)
        {
          if ((m != 0) && (arrayOfInt[j] != 0)) {
            arrayOfChar[j] = ((char)(arrayOfChar[(j - 1)] ^ bjx[((bjw[m] + bjw[arrayOfInt[j]]) % 255)]));
          }
          for (;;)
          {
            j -= 1;
        ...
        if ((m != 0) && (arrayOfInt[0] != 0)) {
          arrayOfChar[0] = ((char)bjx[((bjw[m] + bjw[arrayOfInt[0]]) % 255)]);
        }
        for (;;)
        {
          i += 1;
  ...
  public static String a(String paramString, k paramk)
  {
    ...
    if (paramString.length() != paramk.bjB)
    {
      paramString = new IllegalArgumentException("The number of codewords does not match the selected symbol");
      AppMethodBeat.o(57276);
      throw paramString;
    }
    StringBuilder localStringBuilder = new StringBuilder(paramk.bjB + paramk.bjC);
    localStringBuilder.append(paramString);
    int m = paramk.sD();
    if (m == 1) {
      localStringBuilder.append(c(paramString, paramk.bjC));
    }
    for (;;)
    {
      ...
      while (i < m)
      {
        arrayOfInt1[i] = paramk.ff(i + 1);
        arrayOfInt2[i] = paramk.bjH;
        localObject[i] = 0;
        if (i > 0) {
      ...
      while (i < m)
      {
        ...
        {
          localStringBuilder.setCharAt(paramk.bjB + k, ((String)localObject).charAt(j));
          k += m;
          j += 1;
        }
        i += 1;
