  ...
  implements g
{
  private int a(h paramh, StringBuilder paramStringBuilder1, StringBuilder paramStringBuilder2, int paramInt)
  {
    ...
    paramh.pos -= 1;
    paramInt = a(paramh.Im(), paramStringBuilder2);
    paramh.cdG = null;
  ...
  static void a(h paramh, StringBuilder paramStringBuilder)
  {
    ...
    paramh.cs(new String(new char[] { (char)(i / 256), (char)(i % 256) }));
  ...
  public void a(h paramh)
  {
    ...
    while (paramh.In())
    {
      ...
      int i = (localStringBuilder1.length() / 3 << 1) + paramh.cdE.length();
      paramh.hi(i);
      int k = paramh.cdG.cdP - i;
      if (!paramh.In())
      {
      ...
      {
        i = j.b(paramh.msg, paramh.pos, Ij());
        if (i != Ij()) {
          paramh.cdF = i;
        }
      }
