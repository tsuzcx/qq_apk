...
public class k
{
  ...
  public static k a(int paramInt, l paraml, b paramb1, b paramb2)
  {
    ...
    {
      k localk = arrayOfk[i];
      if (((paraml != l.cdX) || (!localk.cdO)) && ((paraml != l.cdY) || (localk.cdO)) && ((paramb1 == null) || ((localk.Iv() >= paramb1.width) && (localk.Iw() >= paramb1.height))) && ((paramb2 == null) || ((localk.Iv() <= paramb2.width) && (localk.Iw() <= paramb2.height))) && (paramInt <= localk.cdP))
      {
  ...
  public final String toString()
  {
    ...
    {
      str = str + " data region " + this.cdR + 'x' + this.cdS + ", symbol size " + Iv() + 'x' + Iw() + ", symbol data size " + It() + 'x' + Iu() + ", codewords " + this.cdP + '+' + this.cdQ;
