...
final class by
{
  static void a(bw parambw, StringBuilder paramStringBuilder, int paramInt)
  {
    Object localObject1 = new HashMap();
    HashMap localHashMap = new HashMap();
    Object localObject2 = new TreeSet();
    Object localObject3 = parambw.getClass().getDeclaredMethods();
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((((String)localObject3).endsWith("List")) && (!((String)localObject3).endsWith("OrBuilderList")) && (!((String)localObject3).equals("List")))
      {
        ...
        {
          a(paramStringBuilder, paramInt, cE((String)localObject5), az.a(localMethod, parambw, new Object[0]));
          continue;
        }
      }
      if ((((String)localObject3).endsWith("Map")) && (!((String)localObject3).equals("Map")))
      {
        ...
        {
          a(paramStringBuilder, paramInt, cE((String)localObject5), az.a((Method)localObject4, parambw, new Object[0]));
          continue;
        }
      }
      if (((Method)localHashMap.get("set".concat(String.valueOf(localObject3))) != null) && ((!((String)localObject3).endsWith("Bytes")) || (!((Map)localObject1).containsKey("get" + ((String)localObject3).substring(0, ((String)localObject3).length() - 5)))))
      {
        ...
        {
          localObject5 = az.a((Method)localObject5, parambw, new Object[0]);
          boolean bool;
          ...
          for (;;)
          {
            ...
            a(paramStringBuilder, paramInt, cE((String)localObject4), localObject5);
            break;
            bool = false;
            break label625;
            ...
            if ((localObject5 instanceof g))
            {
              bool = localObject5.equals(g.bPf);
              break label625;
            }
            if ((localObject5 instanceof bw))
            {
              if (localObject5 == ((bw)localObject5).Cs())
              {
                bool = true;
                break label625;
              }
            ...
            bool = false;
            continue;
            bool = ((Boolean)az.a((Method)localObject3, parambw, new Object[0])).booleanValue();
          }
        }
      }
    }
    label869:
    if ((parambw instanceof az.a))
    {
      localObject1 = ((az.a)parambw).bXY.iterator();
    ...
    if (((az)parambw).bXV != null) {
      ((az)parambw).bXV.a(paramStringBuilder, paramInt);
    }
  }
  ...
  static final void a(StringBuilder paramStringBuilder, int paramInt, String paramString, Object paramObject)
  {
    ...
    {
      paramStringBuilder.append(": \"").append(cw.e(g.ct((String)paramObject))).append('"');
      return;
    }
    if ((paramObject instanceof g))
    {
      paramStringBuilder.append(": \"").append(cw.e((g)paramObject)).append('"');
      return;
    }
    if ((paramObject instanceof az))
    {
      paramStringBuilder.append(" {");
      a((az)paramObject, paramStringBuilder, paramInt + 2);
      paramStringBuilder.append("\n");
      i = j;
      while (i < paramInt)
      {
  ...
  private static final String cE(String paramString)
  {
 ...
 * Qualified Name:     com.google.b.by
