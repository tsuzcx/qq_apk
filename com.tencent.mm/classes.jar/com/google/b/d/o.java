  ...
  implements g
{
  ...
  private static b a(boolean[] paramArrayOfBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    while (paramInt2 < i)
    {
      if (paramArrayOfBoolean[paramInt2] != 0) {
        localb.o(paramInt1, 0, j, paramInt3);
      }
      paramInt2 += 1;
      paramInt1 += j;
    }
  ...
  public b a(String paramString, a parama, int paramInt1, int paramInt2, Map<c, ?> paramMap)
  {
    ...
    {
      i = j;
      if (paramMap.containsKey(c.bhD)) {
        i = Integer.parseInt(paramMap.get(c.bhD).toString());
      }
    }
    return a(bj(paramString), paramInt1, paramInt2, i);
  }
