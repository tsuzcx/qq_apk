...
{
  @Deprecated
  public static final ci<m> bRf = new c() {};
  private static final m bTD = new m();
  private int bQS;
  ...
  private k$m(bb.c<m, ?> paramc)
  {
    super(paramc);
  }
  
  private k$m(h paramh, ap paramap)
  {
    this();
    if (paramap == null) {
  ...
  {
    return k.BR().b(m.class, a.class);
  }
  
  public final ci<m> Co()
  {
    return bRf;
  }
  ...
  public final k.m.b FO()
  {
    k.m.b localb2 = k.m.b.ho(this.bTC);
    k.m.b localb1 = localb2;
    if (localb2 == null) {
      localb1 = k.m.b.bTE;
    }
    return localb1;
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      if ((FN()) && (this.bTC != paramObject.bTC)) {
        return false;
      }
    ...
    implements aa
  {
    ...
    {
      if ((parambt instanceof k.m)) {
        return d((k.m)parambt);
      }
      super.a(parambt);
      return this;
    }
    ...
    /* Error */
    private a t(h paramh, ap paramap)
    {
      // Byte code:
      //   0: aconst_null
      //   1: astore_3
      //   2: getstatic 146	com/google/b/k$m:bRf	Lcom/google/b/ci;
      //   5: aload_1
      //   6: aload_2
      //   7: invokeinterface 151 3 0
      //   12: checkcast 9	com/google/b/k$m
      //   15: astore_1
      //   16: aload_1
      //   17: ifnull +9 -> 26
      //   20: aload_0
      //   21: aload_1
      //   22: invokevirtual 135	com/google/b/k$m$a:d	(Lcom/google/b/k$m;)Lcom/google/b/k$m$a;
      //   25: pop
      //   26: aload_0
      //   27: areturn
      //   28: astore_1
      //   29: aload_1
      //   30: getfield 155	com/google/b/bf:bZj	Lcom/google/b/bw;
      //   33: checkcast 9	com/google/b/k$m
      //   36: astore_2
      //   37: aload_1
      //   38: invokevirtual 159	com/google/b/bf:Im	()Ljava/io/IOException;
      //   41: athrow
      //   42: astore_1
      //   43: aload_2
      //   44: ifnull +9 -> 53
      //   47: aload_0
      //   48: aload_2
      //   49: invokevirtual 135	com/google/b/k$m$a:d	(Lcom/google/b/k$m;)Lcom/google/b/k$m$a;
      //   52: pop
      //   53: aload_1
      //   54: athrow
      //   55: astore_1
    ...
    protected final bb.e Cb()
    {
      return k.BR().b(k.m.class, a.class);
    }
    ...
    public final k.m FS()
    {
      ...
      for (;;)
      {
        ...
        Ib();
        return localm;
        k.m.a(localm, this.bRC.build());
      }
    }
    
    public final a d(k.m paramm)
    {
      co localco = null;
      if (paramm == k.m.FQ()) {
        return this;
      ...
      if (this.bRC == null) {
        if (!k.m.c(paramm).isEmpty())
        {
          if (!this.bRA.isEmpty()) {
            break label117;
          }
          this.bRA = k.m.c(paramm);
          this.bQS &= 0xFFFFFFFB;
          onChanged();
        }
      }
 ...
 * Qualified Name:     com.google.b.k.m
