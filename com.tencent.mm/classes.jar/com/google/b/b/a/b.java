...
final class b
{
  ...
  b(a parama, int[] paramArrayOfInt)
  {
    ...
    if ((j > 1) && (paramArrayOfInt[0] == 0))
    {
      ...
      this.cdv = new int[j - i];
      System.arraycopy(paramArrayOfInt, i, this.cdv, 0, this.cdv.length);
      AppMethodBeat.o(12266);
      return;
    }
    this.cdv = paramArrayOfInt;
    AppMethodBeat.o(12266);
  }
  ...
  private b a(b paramb)
  {
    ...
    for (;;)
    {
      ...
      paramb = new b(this.cdu, (int[])localObject2);
      AppMethodBeat.o(12267);
      return paramb;
      localObject2 = paramb;
  ...
  {
    return this.cdv[(this.cdv.length - 1 - paramInt)];
  }
  ...
  final b[] b(b paramb)
  {
    ...
    b localb1 = this.cdu.cdq;
    int i = paramb.hf(paramb.cdv.length - 1);
    Object localObject1 = this.cdu;
    if (i == 0)
    {
    ...
    i = localObject1.cdo[(localObject1.size - localObject1.cdp[i] - 1)];
    localObject1 = this;
    if ((((b)localObject1).cdv.length - 1 >= paramb.cdv.length - 1) && (!((b)localObject1).isZero()))
    {
      int j = ((b)localObject1).cdv.length - 1 - (paramb.cdv.length - 1);
      int k = this.cdu.bK(((b)localObject1).hf(((b)localObject1).cdv.length - 1), i);
      ...
      if (k == 0) {}
      int[] arrayOfInt;
      for (localObject2 = ((a)localObject2).cdq;; localObject2 = new b((a)localObject2, arrayOfInt))
      {
  ...
  final b bL(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 0)
    {
      localObject = this.cdu.cdq;
      AppMethodBeat.o(12268);
      return localObject;
    }
    int i = this.cdv.length;
    Object localObject = new int[i + paramInt1];
    paramInt1 = 0;
    while (paramInt1 < i)
    {
      localObject[paramInt1] = this.cdu.bK(this.cdv[paramInt1], paramInt2);
      paramInt1 += 1;
    }
    localObject = new b(this.cdu, (int[])localObject);
    AppMethodBeat.o(12268);
    return localObject;
  }
  ...
  public final String toString()
  {
    ...
    Object localObject = new StringBuilder((this.cdv.length - 1) * 8);
    int i = this.cdv.length - 1;
    if (i >= 0)
    {
      int k = hf(i);
      int j;
