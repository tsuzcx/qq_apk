...
public final class c
{
  ...
  static
  {
    ...
    cfs = new int[] { 31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017 };
    cft = Iz();
  ...
  private c(int paramInt, int[] paramArrayOfInt, b... paramVarArgs)
  {
    ...
    this.cfu = paramInt;
    this.cfv = paramArrayOfInt;
    this.cfw = paramVarArgs;
    int j = paramVarArgs[0].cfz;
    paramArrayOfInt = paramVarArgs[0].cfA;
  ...
  private static c[] Iz()
  {
    ...
    localObject1 = new c(1, new int[0], new b[] { localObject1, localObject2, localObject3, localObject4 });
    ...
    localObject2 = new c(2, new int[] { 6, 18 }, new b[] { localObject2, localObject3, localObject4, localObject5 });
    ...
    localObject3 = new c(3, new int[] { 6, 22 }, new b[] { localObject3, localObject4, localObject5, localObject6 });
    ...
    localObject4 = new c(4, new int[] { 6, 26 }, new b[] { localObject4, localObject5, localObject6, localObject7 });
    ...
    localObject5 = new c(5, new int[] { 6, 30 }, new b[] { localObject5, localObject6, localObject7, localObject8 });
    ...
    localObject6 = new c(6, new int[] { 6, 34 }, new b[] { localObject6, localObject7, localObject8, localObject9 });
    ...
    localObject7 = new c(7, new int[] { 6, 22, 38 }, new b[] { localObject7, localObject8, localObject9, localObject10 });
    ...
    localObject8 = new c(8, new int[] { 6, 24, 42 }, new b[] { localObject8, localObject9, localObject10, localObject11 });
    ...
    localObject9 = new c(9, new int[] { 6, 26, 46 }, new b[] { localObject9, localObject10, localObject11, localObject12 });
    ...
    localObject10 = new c(10, new int[] { 6, 28, 50 }, new b[] { localObject10, localObject11, localObject12, localObject13 });
    ...
    localObject11 = new c(11, new int[] { 6, 30, 54 }, new b[] { localObject11, localObject12, localObject13, localObject14 });
    ...
    localObject12 = new c(12, new int[] { 6, 32, 58 }, new b[] { localObject12, localObject13, localObject14, localObject15 });
    ...
    localObject13 = new c(13, new int[] { 6, 34, 62 }, new b[] { localObject13, localObject14, localObject15, localObject16 });
    ...
    localObject14 = new c(14, new int[] { 6, 26, 46, 66 }, new b[] { localObject14, localObject15, localObject16, localObject17 });
    ...
    localObject15 = new c(15, new int[] { 6, 26, 48, 70 }, new b[] { localObject15, localObject16, localObject17, localObject18 });
    ...
    localObject16 = new c(16, new int[] { 6, 26, 50, 74 }, new b[] { localObject16, localObject17, localObject18, localObject19 });
    ...
    localObject17 = new c(17, new int[] { 6, 30, 54, 78 }, new b[] { localObject17, localObject18, localObject19, localObject20 });
    ...
    localObject18 = new c(18, new int[] { 6, 30, 56, 82 }, new b[] { localObject18, localObject19, localObject20, localObject21 });
    ...
    localObject19 = new c(19, new int[] { 6, 30, 58, 86 }, new b[] { localObject19, localObject20, localObject21, localObject22 });
    ...
    localObject20 = new c(20, new int[] { 6, 34, 62, 90 }, new b[] { localObject20, localObject21, localObject22, localObject23 });
    ...
    localObject21 = new c(21, new int[] { 6, 28, 50, 72, 94 }, new b[] { localObject21, localObject22, localObject23, localObject24 });
    ...
    localObject22 = new c(22, new int[] { 6, 26, 50, 74, 98 }, new b[] { localObject22, localObject23, localObject24, localObject25 });
    ...
    localObject23 = new c(23, new int[] { 6, 30, 54, 78, 102 }, new b[] { localObject23, localObject24, localObject25, localObject26 });
    ...
    localObject24 = new c(24, new int[] { 6, 28, 54, 80, 106 }, new b[] { localObject24, localObject25, localObject26, localObject27 });
    ...
    localObject25 = new c(25, new int[] { 6, 32, 58, 84, 110 }, new b[] { localObject25, localObject26, localObject27, localObject28 });
    ...
    localObject26 = new c(26, new int[] { 6, 30, 58, 86, 114 }, new b[] { localObject26, localObject27, localObject28, localObject29 });
    ...
    localObject27 = new c(27, new int[] { 6, 34, 62, 90, 118 }, new b[] { localObject27, localObject28, localObject29, localObject30 });
    ...
    localObject28 = new c(28, new int[] { 6, 26, 50, 74, 98, 122 }, new b[] { localObject28, localObject29, localObject30, localObject31 });
    ...
    localObject29 = new c(29, new int[] { 6, 30, 54, 78, 102, 126 }, new b[] { localObject29, localObject30, localObject31, localObject32 });
    ...
    localObject30 = new c(30, new int[] { 6, 26, 52, 78, 104, 130 }, new b[] { localObject30, localObject31, localObject32, localObject33 });
    ...
    localObject31 = new c(31, new int[] { 6, 30, 56, 82, 108, 134 }, new b[] { localObject31, localObject32, localObject33, localObject34 });
    ...
    localObject32 = new c(32, new int[] { 6, 34, 60, 86, 112, 138 }, new b[] { localObject32, localObject33, localObject34, localObject35 });
    ...
    localObject33 = new c(33, new int[] { 6, 30, 58, 86, 114, 142 }, new b[] { localObject33, localObject34, localObject35, localObject36 });
    ...
    localObject34 = new c(34, new int[] { 6, 34, 62, 90, 118, 146 }, new b[] { localObject34, localObject35, localObject36, localObject37 });
    ...
    localObject35 = new c(35, new int[] { 6, 30, 54, 78, 102, 126, 150 }, new b[] { localObject35, localObject36, localObject37, localObject38 });
    ...
    localObject36 = new c(36, new int[] { 6, 24, 50, 76, 102, 128, 154 }, new b[] { localObject36, localObject37, localObject38, localObject39 });
    ...
    Object localObject40 = new b(30, new a[] { new a(24, 15), new a(46, 16) });
    localObject37 = new c(37, new int[] { 6, 28, 54, 80, 106, 132, 158 }, new b[] { localObject37, localObject38, localObject39, localObject40 });
    localObject38 = new b(30, new a[] { new a(4, 122), new a(18, 123) });
    localObject39 = new b(28, new a[] { new a(13, 46), new a(32, 47) });
    localObject40 = new b(30, new a[] { new a(48, 24), new a(14, 25) });
    b localb1 = new b(30, new a[] { new a(42, 15), new a(32, 16) });
    localObject38 = new c(38, new int[] { 6, 32, 58, 84, 110, 136, 162 }, new b[] { localObject38, localObject39, localObject40, localb1 });
    localObject39 = new b(30, new a[] { new a(20, 117), new a(4, 118) });
    localObject40 = new b(28, new a[] { new a(40, 47), new a(7, 48) });
    localb1 = new b(30, new a[] { new a(43, 24), new a(22, 25) });
    b localb2 = new b(30, new a[] { new a(10, 15), new a(67, 16) });
    localObject39 = new c(39, new int[] { 6, 26, 54, 82, 110, 138, 166 }, new b[] { localObject39, localObject40, localb1, localb2 });
    localObject40 = new b(30, new a[] { new a(19, 118), new a(6, 119) });
    localb1 = new b(28, new a[] { new a(18, 47), new a(31, 48) });
    localb2 = new b(30, new a[] { new a(34, 24), new a(34, 25) });
    b localb3 = new b(30, new a[] { new a(20, 15), new a(61, 16) });
    localObject40 = new c(40, new int[] { 6, 30, 58, 86, 114, 142, 170 }, new b[] { localObject40, localb1, localb2, localb3 });
  ...
  public static c hk(int paramInt)
  {
    ...
    Object localObject = cft[(paramInt - 1)];
    AppMethodBeat.o(12310);
    return localObject;
  }
  ...
  public final b a(a parama)
  {
    ...
    parama = this.cfw[parama.ordinal()];
  ...
  public static final class b
  {
    ...
    {
      this.cfz = paramInt;
      this.cfA = paramVarArgs;
    }
    
    public final int IA()
    {
      c.a[] arrayOfa = this.cfA;
