...
final class s
{
  ...
  private ArrayList<float[]> ckG;
  private ArrayList<double[]> ckH;
  final d ckI;
  Handler ckJ;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((!this.ckG.isEmpty()) && (!this.ckH.isEmpty()))
          {
            if (!paramBoolean) {
              break label144;
            }
            ...
            if (k > 1)
            {
              ...
              this.ckF.subList(0, i).clear();
              this.ckF.trimToSize();
              this.ckG.subList(0, i).clear();
              this.ckG.trimToSize();
              this.ckH.subList(0, k - 1).clear();
              this.ckH.trimToSize();
            }
          }
          ...
          k = this.ckH.size() - 1;
          break;
          arrayOfDouble1 = (double[])this.ckH.get(m - 1);
          arrayOfDouble2 = (double[])this.ckH.get(m);
          ...
          if (d2 < 1.0D)
          {
            ...
            f2 -= f4;
            if ((f2 <= 0.0F) || ((f1 - f3) * d2 / f2 > y.cnw)) {
              break label1438;
            }
            r.Jg().cB(localStringBuilder.toString());
            paramBoolean = true;
            if (y.cnn)
            {
              if (paramBoolean)
          ...
          else
          {
            d1 = 1.0D / d2;
            break label510;
            arrayOfFloat = (float[])this.ckG.get(i);
            ...
            if (arrayOfDouble4[0] > 90.0D)
            {
              ...
              localObject1 = (String)this.ckF.get(i);
  ...
  private void d(p paramp)
  {
    ...
    if (this.ckJ != null) {
      this.ckJ.post(new d(paramp, (byte)0));
    }
  ...
  private static void writeLog(String paramString)
  {
    ...
    o.t("post_processing_log_" + y.cnu, paramString);
  ...
  final void a(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6, double paramDouble7, double paramDouble8)
  {
    for (;;)
    {
      try
      {
        ...
        if (j <= 0)
        {
          this.ckH.add(new double[] { paramDouble1, paramDouble2, paramDouble3, paramDouble4, paramDouble5, paramDouble6, paramDouble7, i, paramDouble8 });
          i = 1;
          if (i != 0)
          {
            i = this.ckH.size();
        ...
        double[] arrayOfDouble1 = (double[])this.ckH.get(j - 1);
        float[] arrayOfFloat;
        if (paramDouble8 - arrayOfDouble1[8] < 30000.0D)
        {
          if (paramDouble4 >= arrayOfDouble1[3])
          {
            ...
            if (j > 1)
            {
              double[] arrayOfDouble2 = (double[])this.ckH.get(j - 2);
  ...
  final void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt, String paramString)
  {
    try
    {
      ...
      this.ckF.add(paramString);
      this.ckG.add(new float[] { paramFloat1, paramFloat2, paramFloat3, 0.0F, paramInt, paramFloat4 });
  ...
  final boolean a(double paramDouble1, double paramDouble2, double paramDouble3, float paramFloat, double paramDouble4, double paramDouble5, double paramDouble6, long paramLong)
  {
    ...
    if ((paramLong - this.ckD < 1000L) && (paramFloat <= this.ckE))
    {
      AppMethodBeat.o(88015);
      return false;
    }
    ...
    implements Runnable
  {
    ...
    private a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt, String paramString)
    {
      this.x = paramFloat1;
      this.y = paramFloat2;
      this.ckK = paramFloat3;
      this.ckL = paramFloat4;
      this.cjR = paramInt;
      this.ckM = paramString;
    }
    ...
    implements Runnable
  {
    ...
    private b(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6, double paramDouble7, double paramDouble8)
    {
      ...
      this.ckO = paramDouble3;
      this.ckP = paramDouble4;
      this.ckQ = paramDouble5;
      this.ckR = paramDouble6;
      this.ckS = paramDouble7;
      this.ckT = paramDouble8;
    }
