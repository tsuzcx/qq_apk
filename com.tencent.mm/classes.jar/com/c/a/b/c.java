  ...
  implements Comparable<c>
{
  ...
  int coE;
  boolean coF = false;
  com.c.a.c.g<a> coG = new com.c.a.c.g();
  ...
  public final Map<d, Object> Kc()
  {
    ...
    while (i < j)
    {
      ...
      Ki();
      readUnsignedByte();
      localHashMap.put(locald, a(locald.cow));
      i += 1;
    }
    return localHashMap;
  }
  ...
  public final List<i> Ke()
  {
    ...
    Object localObject1 = new Object[((com.c.a.c.g)localObject2).size()];
    localObject2 = ((com.c.a.c.g)localObject2).cql;
    ...
    for (;;)
    {
      ...
      if (i > 0)
      {
        if (com.c.a.c.g.b((Object[])localObject2, k))
        {
          localObject1[j] = com.c.a.c.g.aF(localObject2[k]);
          j += 1;
          i = k;
        }
      }
      else
      {
        ...
        while (i < k)
        {
          j += ((a)localObject1[i]).coJ.size();
          i += 1;
        }
        localObject2 = new ArrayList(j);
        int[] arrayOfInt = this.coG.Kv();
        j = arrayOfInt.length;
        i = 0;
        if (i < j)
        {
          k = arrayOfInt[i];
          localObject1 = (a)this.coG.get(k);
          if (localObject1 == null) {}
          for (localObject1 = new ArrayList(0);; localObject1 = ((a)localObject1).coJ)
          {
  ...
  public final List<c> Kg()
  {
    ...
    while (!localStack.isEmpty())
    {
      ...
      localObject = ((c)localObject).coH.iterator();
