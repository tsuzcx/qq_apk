  ...
  implements com.tencent.tencentmap.mapsdk.map.Projection
{
  ...
  public h(TencentMap paramTencentMap)
  {
    ...
    this.SJP = paramTencentMap.getProjection();
  ...
  public final com.tencent.mapsdk.raster.model.LatLng fromScreenLocation(Point paramPoint)
  {
    ...
    paramPoint = l.a(this.SJP.fromScreenLocation(paramPoint));
  ...
  public final double getLatitudeSpan()
  {
    ...
    com.tencent.tencentmap.mapsdk.maps.model.VisibleRegion localVisibleRegion = this.SJP.getVisibleRegion();
  ...
  public final float getScalePerPixel()
  {
    ...
    float f = (float)this.SJP.metersPerPixel(this.mMap.getCameraPosition().target.latitude);
  ...
  public final com.tencent.mapsdk.raster.model.VisibleRegion getVisibleRegion()
  {
    ...
    Object localObject1 = this.SJP.getVisibleRegion();
  ...
  public final float metersToPixels(double paramDouble1, double paramDouble2)
  {
    ...
    float f = (float)(paramDouble2 / this.SJP.metersPerPixel(paramDouble1));
  ...
  public final Point toScreenLocation(com.tencent.mapsdk.raster.model.LatLng paramLatLng)
  {
    ...
    paramLatLng = this.SJP.toScreenLocation(l.c(paramLatLng));
 ...
 * Qualified Name:     com.d.a.a.a.a.h
