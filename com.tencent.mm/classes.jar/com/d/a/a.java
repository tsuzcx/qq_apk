...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/example/home_generator/HomeGeneratorPlugin;", "Lio/flutter/embedding/engine/plugins/FlutterPlugin;", "Lio/flutter/plugin/common/MethodChannel$MethodCallHandler;", "()V", "channel", "Lio/flutter/plugin/common/MethodChannel;", "onAttachedToEngine", "", "flutterPluginBinding", "Lio/flutter/embedding/engine/plugins/FlutterPlugin$FlutterPluginBinding;", "onDetachedFromEngine", "binding", "onMethodCall", "call", "Lio/flutter/plugin/common/MethodCall;", "result", "Lio/flutter/plugin/common/MethodChannel$Result;", "home_generator_release"}, k=1, mv={1, 1, 16})
  ...
  implements FlutterPlugin, MethodChannel.MethodCallHandler
{
  ...
  public final void onAttachedToEngine(FlutterPlugin.FlutterPluginBinding paramFlutterPluginBinding)
  {
    ...
    this.channel = new MethodChannel(paramFlutterPluginBinding.getBinaryMessenger(), "home_generator");
