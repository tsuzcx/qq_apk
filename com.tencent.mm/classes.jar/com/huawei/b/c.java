  ...
  extends IInterface
{
  ...
  public abstract boolean hn(int paramInt);
  
  public abstract int ho(int paramInt);
  
  public static abstract class a
    extends Binder
    implements c
  {
    public static c j(IBinder paramIBinder)
    {
    ...
    public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
    {
      ...
      case 1: 
        ...
        bool = a(b.a.i(paramParcel1.readStrongBinder()), paramParcel1.readInt());
      ...
      case 2: 
        paramParcel1.enforceInterface("com.huawei.securitymgr.IAuthenticationService");
        paramInt1 = a(b.a.i(paramParcel1.readStrongBinder()), paramParcel1.createIntArray(), paramParcel1.createByteArray());
        paramParcel2.writeNoException();
        paramParcel2.writeInt(paramInt1);
        return true;
      case 3: 
      ...
      case 5: 
        paramParcel1.enforceInterface("com.huawei.securitymgr.IAuthenticationService");
        paramParcel1 = c(b.a.i(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
      ...
      case 8: 
        paramParcel1.enforceInterface("com.huawei.securitymgr.IAuthenticationService");
        paramInt1 = ho(paramParcel1.readInt());
        paramParcel2.writeNoException();
        paramParcel2.writeInt(paramInt1);
        return true;
      case 9: 
        paramParcel1.enforceInterface("com.huawei.securitymgr.IAuthenticationService");
        bool = cx(paramParcel1.readString());
        paramParcel2.writeNoException();
        paramInt1 = m;
        if (bool) {
          paramInt1 = 1;
      ...
      case 10: 
        paramParcel1.enforceInterface("com.huawei.securitymgr.IAuthenticationService");
        paramParcel1 = b(b.a.i(paramParcel1.readStrongBinder()), paramParcel1.readInt());
        paramParcel2.writeNoException();
        paramParcel2.writeString(paramParcel1);
        return true;
      case 11: 
        paramParcel1.enforceInterface("com.huawei.securitymgr.IAuthenticationService");
        paramParcel1 = c(b.a.i(paramParcel1.readStrongBinder()), paramParcel1.readInt());
        paramParcel2.writeNoException();
        paramParcel2.writeIntArray(paramParcel1);
        return true;
      case 12: 
        paramParcel1.enforceInterface("com.huawei.securitymgr.IAuthenticationService");
        paramInt1 = d(b.a.i(paramParcel1.readStrongBinder()), paramParcel1.readInt());
        paramParcel2.writeNoException();
        paramParcel2.writeInt(paramInt1);
        return true;
      case 13: 
        paramParcel1.enforceInterface("com.huawei.securitymgr.IAuthenticationService");
        b localb = b.a.i(paramParcel1.readStrongBinder());
      ...
      case 14: 
        paramParcel1.enforceInterface("com.huawei.securitymgr.IAuthenticationService");
        long l = d(b.a.i(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        paramParcel2.writeLong(l);
        return true;
      case 15: 
        paramParcel1.enforceInterface("com.huawei.securitymgr.IAuthenticationService");
        paramInt1 = a(b.a.i(paramParcel1.readStrongBinder()), paramParcel1.createIntArray(), paramParcel1.createByteArray(), paramParcel1.readInt());
        paramParcel2.writeNoException();
        paramParcel2.writeInt(paramInt1);
        return true;
      }
      paramParcel1.enforceInterface("com.huawei.securitymgr.IAuthenticationService");
      paramParcel1 = e(b.a.i(paramParcel1.readStrongBinder()));
      paramParcel2.writeNoException();
      ...
      implements c
    {
      ...
      public final int a(b paramb, int[] paramArrayOfInt, byte[] paramArrayOfByte)
      {
        ...
        //   33: aload 5
        //   35: aload_1
        //   36: invokevirtual 69	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
        //   39: aload 5
        //   41: aload_2
        //   42: invokevirtual 73	android/os/Parcel:writeIntArray	([I)V
        //   45: aload 5
        //   47: aload_3
        //   48: invokevirtual 77	android/os/Parcel:writeByteArray	([B)V
        //   51: aload_0
        //   52: getfield 18	com/huawei/b/c$a$a:mRemote	Landroid/os/IBinder;
        //   55: iconst_2
        //   56: aload 5
        //   58: aload 6
        //   60: iconst_0
        //   61: invokeinterface 46 5 0
        //   66: pop
        //   67: aload 6
        //   69: invokevirtual 49	android/os/Parcel:readException	()V
        //   72: aload 6
        //   74: invokevirtual 81	android/os/Parcel:readInt	()I
        //   77: istore 4
        //   79: aload 6
        ...
        //   113: ldc 60
        //   115: invokestatic 58	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
        //   118: aload_1
        //   119: athrow
      ...
      public final int a(b paramb, int[] paramArrayOfInt, byte[] paramArrayOfByte, int paramInt)
      {
        ...
        //   58: aload_0
        //   59: getfield 18	com/huawei/b/c$a$a:mRemote	Landroid/os/IBinder;
        //   62: bipush 15
        //   64: aload 5
        //   66: aload 6
        //   68: iconst_0
      ...
      public final void a(b paramb)
      {
        ...
        //   30: aload_2
        //   31: aload_1
        //   32: invokevirtual 69	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
        //   35: aload_0
        //   36: getfield 18	com/huawei/b/c$a$a:mRemote	Landroid/os/IBinder;
        //   39: iconst_3
        //   40: aload_2
        //   41: aload_3
        //   42: iconst_0
        ...
        //   61: ldc 88
        //   63: invokestatic 58	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
        //   66: return
        //   67: aconst_null
        //   68: astore_1
        //   69: goto -39 -> 30
      ...
      public final boolean a(b paramb, int paramInt)
      {
        ...
        //   35: aload 4
        //   37: aload_1
        //   38: invokevirtual 69	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
        //   41: aload 4
        //   43: iload_2
        //   44: invokevirtual 86	android/os/Parcel:writeInt	(I)V
        //   47: aload_0
        //   48: getfield 18	com/huawei/b/c$a$a:mRemote	Landroid/os/IBinder;
        //   51: iconst_1
        //   52: aload 4
        //   54: aload 5
        //   56: iconst_0
        ...
        //   68: aload 5
        //   70: invokevirtual 81	android/os/Parcel:readInt	()I
        //   73: istore_2
        //   74: iload_2
        //   75: ifeq +25 -> 100
        //   78: aload 5
        ...
        //   113: invokevirtual 55	android/os/Parcel:recycle	()V
        //   116: ldc 90
        //   118: invokestatic 58	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
        //   121: aload_1
        //   122: athrow
        // Local variable table:
        //   start	length	slot	name	signature
      ...
      public final boolean a(b paramb, int paramInt, boolean paramBoolean)
      {
        ...
        //   60: aload_0
        //   61: getfield 18	com/huawei/b/c$a$a:mRemote	Landroid/os/IBinder;
        //   64: bipush 13
        //   66: aload 5
        //   68: aload 6
        //   70: iconst_0
        //   71: invokeinterface 46 5 0
        //   76: pop
        //   77: aload 6
        //   79: invokevirtual 49	android/os/Parcel:readException	()V
        //   82: aload 6
        //   84: invokevirtual 81	android/os/Parcel:readInt	()I
        //   87: istore_2
        //   88: iload_2
        //   89: ifeq +33 -> 122
        //   92: iload 4
        ...
        //   105: ldc 92
        //   107: invokestatic 58	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
        //   110: iload_3
        //   111: ireturn
        //   112: aconst_null
        //   113: astore_1
      ...
      public final String b(b paramb, int paramInt)
      {
        ...
        //   36: aload_3
        //   37: iload_2
        //   38: invokevirtual 86	android/os/Parcel:writeInt	(I)V
        //   41: aload_0
        //   42: getfield 18	com/huawei/b/c$a$a:mRemote	Landroid/os/IBinder;
        //   45: bipush 10
        //   47: aload_3
        //   48: aload 4
        //   50: iconst_0
        ...
        //   62: aload 4
        //   64: invokevirtual 99	android/os/Parcel:readString	()Ljava/lang/String;
        //   67: astore_1
        //   68: aload 4
        ...
        //   74: invokevirtual 55	android/os/Parcel:recycle	()V
        //   77: ldc 95
        //   79: invokestatic 58	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
        //   82: aload_1
        //   83: areturn
        //   84: aconst_null
        //   85: astore_1
      ...
      public final int[] c(b paramb)
      {
        ...
        //   50: invokevirtual 49	android/os/Parcel:readException	()V
        //   53: aload_3
        //   54: invokevirtual 52	android/os/Parcel:createIntArray	()[I
        //   57: astore_1
        //   58: aload_3
        ...
        //   87: ldc 103
        //   89: invokestatic 58	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
        //   92: aload_1
        //   93: athrow
        // Local variable table:
        //   start	length	slot	name	signature
      ...
      public final int[] c(b paramb, int paramInt)
      {
        ...
        //   59: invokevirtual 49	android/os/Parcel:readException	()V
        //   62: aload 4
        //   64: invokevirtual 52	android/os/Parcel:createIntArray	()[I
        //   67: astore_1
        //   68: aload 4
        //   70: invokevirtual 55	android/os/Parcel:recycle	()V
        //   73: aload_3
      ...
      public final int d(b paramb, int paramInt)
      {
        ...
        //   59: invokevirtual 49	android/os/Parcel:readException	()V
        //   62: aload 4
        //   64: invokevirtual 81	android/os/Parcel:readInt	()I
        //   67: istore_2
        //   68: aload 4
        //   70: invokevirtual 55	android/os/Parcel:recycle	()V
        //   73: aload_3
      ...
      public final long d(b paramb)
      {
        ...
        //   36: invokevirtual 69	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
        //   39: aload_0
        //   40: getfield 18	com/huawei/b/c$a$a:mRemote	Landroid/os/IBinder;
        //   43: bipush 14
        //   45: aload 4
        //   47: aload 5
        //   49: iconst_0
        //   50: invokeinterface 46 5 0
        //   55: pop
        //   56: aload 5
        //   58: invokevirtual 49	android/os/Parcel:readException	()V
        //   61: aload 5
        //   63: invokevirtual 120	android/os/Parcel:readLong	()J
        //   66: lstore_2
        //   67: aload 5
        ...
        //   97: invokevirtual 55	android/os/Parcel:recycle	()V
        //   100: ldc 116
        //   102: invokestatic 58	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
        //   105: aload_1
        //   106: athrow
        // Local variable table:
        //   start	length	slot	name	signature
      ...
      public final byte[] e(b paramb)
      {
        ...
        //   54: aload_3
        //   55: invokevirtual 127	android/os/Parcel:createByteArray	()[B
        //   58: astore_1
        //   59: aload_3
      ...
      public final int ho(int paramInt)
      {
