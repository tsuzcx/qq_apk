...
{
  private static final Map<String, c> aQp;
  ...
  static
  {
    ...
    aQp = localHashMap;
    localHashMap.put("image/jpeg", c.aPZ);
    aQp.put("image/gif", c.aQc);
    aQp.put("image/png", c.aQa);
    aQp.put("image/x-ms-bmp", c.aQb);
    aQp.put("image/bmp", c.aQb);
    aQp.put("image/webp", c.aQd);
  ...
  public static com.github.henryye.nativeiv.bitmap.d g(InputStream paramInputStream)
  {
    ...
    Object localObject = (c)aQp.get(localOptions.outMimeType);
    paramInputStream = (InputStream)localObject;
    if (localObject == null) {
      paramInputStream = c.aQe;
    }
    try
    {
      localInputStream.reset();
      localObject = new com.github.henryye.nativeiv.bitmap.d();
      ((com.github.henryye.nativeiv.bitmap.d)localObject).aQg = paramInputStream;
      ((com.github.henryye.nativeiv.bitmap.d)localObject).aQi = localOptions.outHeight;
      ((com.github.henryye.nativeiv.bitmap.d)localObject).aQh = localOptions.outWidth;
