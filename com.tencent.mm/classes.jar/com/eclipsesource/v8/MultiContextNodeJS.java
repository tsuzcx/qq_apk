...
public final class MultiContextNodeJS
{
  ...
  private static IGetTmpFileDirectory sTmpFileDirectoryDelegate;
  ...
  static
  {
    ...
    sTmpFileDirectoryDelegate = new IGetTmpFileDirectory()
    {
  ...
  public static MultiContextNodeJS createMultiContextNodeJS(int paramInt, String paramString, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    //   7: aload_1
    //   8: aload_2
    //   9: invokestatic 81	com/eclipsesource/v8/MultiContextV8:createMultiContextV8	(Ljava/lang/String;Ljava/lang/String;[B)Lcom/eclipsesource/v8/MultiContextV8;
    //   12: astore_1
    //   13: aload_1
    //   14: iload_0
    //   15: invokevirtual 85	com/eclipsesource/v8/MultiContextV8:createContext	(I)Lcom/eclipsesource/v8/V8Context;
    //   18: astore 4
    //   20: new 2	com/eclipsesource/v8/MultiContextNodeJS
    //   23: dup
    //   24: aload_1
    //   25: aload 4
    //   27: invokespecial 87	com/eclipsesource/v8/MultiContextNodeJS:<init>	(Lcom/eclipsesource/v8/MultiContextV8;Lcom/eclipsesource/v8/V8Context;)V
    //   30: astore_2
    //   31: iload_3
    //   32: ifeq +10 -> 42
    //   35: aload_1
    //   36: invokevirtual 91	com/eclipsesource/v8/MultiContextV8:getV8	()Lcom/eclipsesource/v8/V8;
    //   39: invokevirtual 96	com/eclipsesource/v8/V8:enableNativeTrans	()V
    //   42: aload 4
    //   44: new 6	com/eclipsesource/v8/MultiContextNodeJS$1
    //   47: dup
    //   48: aload_2
    //   49: invokespecial 99	com/eclipsesource/v8/MultiContextNodeJS$1:<init>	(Lcom/eclipsesource/v8/MultiContextNodeJS;)V
    //   52: ldc 18
    //   54: invokeinterface 105 3 0
    //   59: pop
    //   60: ldc 21
    //   62: ldc 107
    //   64: iconst_3
    ...
    //   73: dup
    //   74: iconst_1
    //   75: invokestatic 113	android/os/Process:myPid	()I
    //   78: invokestatic 119	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   81: aastore
    //   82: dup
    //   83: iconst_2
    //   84: invokestatic 125	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   87: invokevirtual 129	java/lang/Thread:getId	()J
    //   90: invokestatic 134	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   93: aastore
    //   94: invokestatic 140	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   97: invokestatic 144	com/eclipsesource/v8/MultiContextNodeJS:createTemporaryScriptFile	(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    //   100: astore 4
    //   102: aload_1
    //   103: invokevirtual 148	com/eclipsesource/v8/MultiContextV8:getV8Locker	()Lcom/eclipsesource/v8/V8Locker;
    //   106: invokevirtual 154	com/eclipsesource/v8/V8Locker:hasLock	()Z
    //   109: ifne +10 -> 119
    //   112: aload_1
    //   113: invokevirtual 148	com/eclipsesource/v8/MultiContextV8:getV8Locker	()Lcom/eclipsesource/v8/V8Locker;
    //   116: invokevirtual 157	com/eclipsesource/v8/V8Locker:acquire	()V
    //   119: aload_1
    //   120: invokevirtual 91	com/eclipsesource/v8/MultiContextV8:getV8	()Lcom/eclipsesource/v8/V8;
    //   123: aload 4
    //   125: invokevirtual 163	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   128: invokevirtual 167	com/eclipsesource/v8/V8:createNodeRuntime	(Ljava/lang/String;)V
    //   131: aload_1
    //   132: invokevirtual 148	com/eclipsesource/v8/MultiContextV8:getV8Locker	()Lcom/eclipsesource/v8/V8Locker;
    //   135: invokevirtual 170	com/eclipsesource/v8/V8Locker:release	()V
    //   138: aload 4
    //   140: invokevirtual 173	java/io/File:delete	()Z
    //   143: pop
    //   144: ldc 75
    //   146: invokestatic 52	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   149: aload_2
    //   150: areturn
    //   151: astore_1
    //   152: aload 4
    //   154: invokevirtual 173	java/io/File:delete	()Z
    //   157: pop
    //   158: ldc 75
    //   160: invokestatic 52	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   163: aload_1
    //   164: athrow
    //   165: astore_1
    //   166: new 175	java/lang/RuntimeException
    //   169: dup
    //   170: aload_1
    //   171: invokespecial 178	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
    //   174: astore_1
    //   175: ldc 75
  ...
  public static void setGetTmpFileDirectoryDelegate(IGetTmpFileDirectory paramIGetTmpFileDirectory)
  {
  ...
  public static abstract interface IGetTmpFileDirectory
  {
