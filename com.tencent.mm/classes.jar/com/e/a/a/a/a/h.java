...
{
  private com.tencent.tencentmap.mapsdk.maps.Projection KIV;
  private TencentMap mMap;
  
  public h(TencentMap paramTencentMap)
  {
    AppMethodBeat.i(205925);
    this.KIV = paramTencentMap.getProjection();
  ...
  public final com.tencent.mapsdk.raster.model.LatLng fromScreenLocation(Point paramPoint)
  {
    ...
    paramPoint = l.a(this.KIV.fromScreenLocation(paramPoint));
  ...
  public final double getLatitudeSpan()
  {
    ...
    com.tencent.tencentmap.mapsdk.maps.model.VisibleRegion localVisibleRegion = this.KIV.getVisibleRegion();
  ...
  public final float getScalePerPixel()
  {
    ...
    float f = (float)this.KIV.metersPerPixel(this.mMap.getCameraPosition().target.latitude);
  ...
  public final com.tencent.mapsdk.raster.model.VisibleRegion getVisibleRegion()
  {
    ...
    Object localObject1 = this.KIV.getVisibleRegion();
  ...
  public final float metersToPixels(double paramDouble1, double paramDouble2)
  {
    ...
    float f = (float)(paramDouble2 / this.KIV.metersPerPixel(paramDouble1));
  ...
  public final Point toScreenLocation(com.tencent.mapsdk.raster.model.LatLng paramLatLng)
  {
    ...
    paramLatLng = this.KIV.toScreenLocation(l.c(paramLatLng));
