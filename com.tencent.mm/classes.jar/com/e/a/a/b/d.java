  ...
  implements k<K, V>
{
  ...
  Iterator<V> AP()
  {
    return j.c(AQ().iterator());
  }
  
  public Collection<Map.Entry<K, V>> AQ()
  {
  ...
  abstract Iterator<Map.Entry<K, V>> AR();
  
  abstract Map<K, Collection<V>> AS();
  
  public boolean containsValue(@Nullable Object paramObject)
  {
    Iterator localIterator = AM().values().iterator();
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    ...
    if ((paramObject instanceof k))
    {
      ...
      return AM().equals(paramObject.AM());
    }
    return false;
  }
  ...
  {
    paramObject1 = (Collection)AM().get(paramObject1);
