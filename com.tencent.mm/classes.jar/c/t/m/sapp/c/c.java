  ...
  implements Runnable
{
  ...
  public final void a()
  {
    ...
    {
      r.b(this.d, "__SP_UPDATE_TencentLoc_COMP_INFO__sapp_", "");
      if (r.a(this.d, this.e))
      {
        r.c(this.d, "__SP_UPDATE_TencentLoc_COMP_SDK_VER__sapp_", h.a);
    ...
    for (boolean bool1 = ((File)localObject3).delete();; bool1 = true)
    {
      ...
      if (i == 0)
      {
        r.c(this.d, "__SP_UPDATE_TencentLoc_COMP_INFO__sapp_", "");
        r.a(this.f);
        a = 2;
        AppMethodBeat.o(186186);
        break;
  ...
  public final boolean a(a parama)
  {
    ...
    //   19: aload_1
    //   20: getfield 210	c/t/m/sapp/c/a:e	Ljava/lang/String;
    ...
    //   45: aload_1
    //   46: getfield 210	c/t/m/sapp/c/a:e	Ljava/lang/String;
    ...
    //   55: invokestatic 195	c/t/m/sapp/c/j:a	(Ljava/lang/String;)V
    //   58: aconst_null
    //   59: astore_3
    //   60: iconst_0
    //   61: istore_2
    ...
    //   67: aload 7
    //   69: invokestatic 217	c/t/m/sapp/c/p:a	(Ljava/lang/String;)[B
    //   72: astore 4
    //   74: aload 4
    //   76: ifnull +492 -> 568
    //   79: aload 4
    //   81: ldc 219
    //   83: invokestatic 224	c/t/m/sapp/c/m:a	([BLjava/lang/String;)[B
    //   86: invokestatic 227	c/t/m/sapp/c/r:c	([B)[B
    //   89: astore 6
    //   91: aload 6
    //   93: ifnull +475 -> 568
    //   96: aload_0
    ...
    //   124: aload_1
    //   125: getfield 152	c/t/m/sapp/c/a:c	Ljava/lang/String;
    ...
    //   137: astore 8
    //   139: new 229	java/io/BufferedOutputStream
    //   142: dup
    //   143: new 231	java/io/FileOutputStream
    //   146: dup
    //   147: aload 8
    //   149: iconst_0
    //   150: invokespecial 234	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   153: sipush 1024
    //   156: invokespecial 237	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   159: astore 4
    //   161: aload 4
    //   163: astore 5
    //   165: aload 4
    //   167: aload 6
    //   169: invokevirtual 241	java/io/BufferedOutputStream:write	([B)V
    //   172: aload 4
    //   174: astore 5
    //   176: aload_0
    //   177: aload_1
    //   178: aload 8
    //   180: invokevirtual 175	c/t/m/sapp/c/c:a	(Lc/t/m/sapp/c/a;Ljava/io/File;)Z
    //   183: ifeq +102 -> 285
    //   186: aload 4
    //   188: astore 5
    ...
    //   208: aload_1
    //   209: getfield 210	c/t/m/sapp/c/a:e	Ljava/lang/String;
    ...
    //   218: invokestatic 195	c/t/m/sapp/c/j:a	(Ljava/lang/String;)V
    //   221: aload 4
    //   223: astore 5
    //   225: aload_0
    //   226: getfield 43	c/t/m/sapp/c/c:d	Landroid/content/Context;
    //   229: invokestatic 183	c/t/m/sapp/c/e:a	(Landroid/content/Context;)Lc/t/m/sapp/c/e;
    //   232: astore_3
    //   233: aload 4
    //   235: astore 5
    ...
    //   260: aload_1
    //   261: getfield 210	c/t/m/sapp/c/a:e	Ljava/lang/String;
    ...
    //   270: invokevirtual 189	c/t/m/sapp/c/e:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   273: aload 4
    //   275: invokevirtual 248	java/io/BufferedOutputStream:close	()V
    //   278: ldc 206
    ...
    //   307: aload_1
    //   308: getfield 210	c/t/m/sapp/c/a:e	Ljava/lang/String;
    ...
    //   317: invokestatic 195	c/t/m/sapp/c/j:a	(Ljava/lang/String;)V
    //   320: aload 4
    //   322: astore 5
    //   324: aload_0
    //   325: getfield 43	c/t/m/sapp/c/c:d	Landroid/content/Context;
    //   328: invokestatic 183	c/t/m/sapp/c/e:a	(Landroid/content/Context;)Lc/t/m/sapp/c/e;
    //   331: astore_3
    //   332: aload 4
    //   334: astore 5
    ...
    //   359: aload_1
    //   360: getfield 210	c/t/m/sapp/c/a:e	Ljava/lang/String;
    ...
    //   369: invokevirtual 189	c/t/m/sapp/c/e:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   372: aload 4
    //   374: astore 5
    //   376: aload 8
    ...
    //   386: astore 5
    //   388: aload 8
    //   390: invokevirtual 201	java/io/File:isFile	()Z
    //   393: ifeq +13 -> 406
    //   396: aload 4
    //   398: astore 5
    //   400: aload 8
    //   402: invokevirtual 163	java/io/File:delete	()Z
    //   405: pop
    //   406: aload 4
    //   408: astore 5
    //   410: aload 4
    ...
    //   417: astore_3
    //   418: ldc2_w 253
    //   421: invokestatic 257	c/t/m/sapp/c/r:a	(J)V
    //   424: iload_2
    //   425: iconst_1
    //   426: iadd
    //   427: istore_2
    ...
    //   448: astore 5
    //   450: aload 8
    //   452: invokevirtual 201	java/io/File:isFile	()Z
    //   455: ifeq +12 -> 467
    //   458: aload_3
    //   459: astore 5
    //   461: aload 8
    //   463: invokevirtual 163	java/io/File:delete	()Z
    //   466: pop
    //   467: aload_3
    //   468: astore 5
    //   470: aload_0
    //   471: getfield 43	c/t/m/sapp/c/c:d	Landroid/content/Context;
    //   474: invokestatic 183	c/t/m/sapp/c/e:a	(Landroid/content/Context;)Lc/t/m/sapp/c/e;
    //   477: astore 4
    //   479: aload_3
    //   480: astore 5
    ...
    //   505: aload 6
    //   507: invokevirtual 258	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   516: invokevirtual 189	c/t/m/sapp/c/e:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   519: aload_3
    //   520: astore 5
    //   522: aload_3
    //   523: invokevirtual 248	java/io/BufferedOutputStream:close	()V
    //   526: goto -108 -> 418
    //   529: astore_3
    //   530: aload 5
    //   532: astore_3
    ...
    //   536: astore_1
    //   537: aload_3
    //   538: invokevirtual 248	java/io/BufferedOutputStream:close	()V
    //   541: ldc 206
