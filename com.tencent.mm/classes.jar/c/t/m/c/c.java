  ...
  implements Runnable
{
  ...
  public c(Context paramContext)
  {
    ...
    this.g = false;
    this.d = paramContext;
    this.f = (this.d.getFilesDir().getAbsolutePath() + File.separator + "TencentLocation/UpCp");
    paramContext = new File(this.d.getFilesDir().getAbsolutePath(), "TencentLocation/UpCp");
  ...
  public final void a()
  {
    ...
    {
      q.a(this.d, "__SP_UPDATE_TencentLoc_COMP_INFO__", "");
      if (q.a(this.d, this.e))
      {
        q.b(this.d, "__SP_UPDATE_TencentLoc_COMP_SDK_VER__", h.a);
    ...
    {
      localObject3 = new File(this.f, ((a)localObject2).c);
      boolean bool2 = new File(this.f, "tmp_" + ((a)localObject2).c).renameTo((File)localObject3);
      ...
      if (i == 0)
      {
        q.b(this.d, "__SP_UPDATE_TencentLoc_COMP_INFO__", "");
        q.a(this.f);
        a = 2;
        AppMethodBeat.o(39894);
        break;
  ...
  public final void a(List<a> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localObject = new File(this.f, "tmp_" + ((a)localObject).c);
  ...
  public final boolean a(a parama)
  {
    ...
    //   19: aload_1
    //   20: getfield 212	c/t/m/c/a:e	Ljava/lang/String;
    ...
    //   45: aload_1
    //   46: getfield 212	c/t/m/c/a:e	Ljava/lang/String;
    ...
    //   55: invokestatic 195	c/t/m/c/j:a	(Ljava/lang/String;)V
    //   58: aconst_null
    //   59: astore_3
    //   60: iconst_0
    //   61: istore_2
    ...
    //   67: aload 7
    //   69: invokestatic 219	c/t/m/c/p:a	(Ljava/lang/String;)[B
    //   72: astore 4
    //   74: aload 4
    //   76: ifnull +492 -> 568
    //   79: aload 4
    //   81: ldc 221
    //   83: invokestatic 226	c/t/m/c/m:a	([BLjava/lang/String;)[B
    //   86: invokestatic 229	c/t/m/c/q:c	([B)[B
    //   89: astore 6
    //   91: aload 6
    //   93: ifnull +475 -> 568
    //   96: aload_0
    //   97: getfield 39	c/t/m/c/c:f	Ljava/lang/String;
    //   100: astore 4
    ...
    //   124: aload_1
    //   125: getfield 152	c/t/m/c/a:c	Ljava/lang/String;
    ...
    //   137: astore 8
    //   139: new 231	java/io/BufferedOutputStream
    //   142: dup
    //   143: new 233	java/io/FileOutputStream
    //   146: dup
    //   147: aload 8
    //   149: iconst_0
    //   150: invokespecial 236	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   153: sipush 1024
    //   156: invokespecial 239	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   159: astore 4
    //   161: aload 4
    //   163: astore 5
    //   165: aload 4
    //   167: aload 6
    //   169: invokevirtual 243	java/io/BufferedOutputStream:write	([B)V
    //   172: aload 4
    //   174: astore 5
    //   176: aload_0
    //   177: aload_1
    //   178: aload 8
    //   180: invokevirtual 175	c/t/m/c/c:a	(Lc/t/m/c/a;Ljava/io/File;)Z
    //   183: ifeq +102 -> 285
    //   186: aload 4
    //   188: astore 5
    ...
    //   208: aload_1
    //   209: getfield 212	c/t/m/c/a:e	Ljava/lang/String;
    ...
    //   218: invokestatic 195	c/t/m/c/j:a	(Ljava/lang/String;)V
    //   221: aload 4
    //   223: astore 5
    //   225: aload_0
    //   226: getfield 43	c/t/m/c/c:d	Landroid/content/Context;
    //   229: invokestatic 183	c/t/m/c/e:a	(Landroid/content/Context;)Lc/t/m/c/e;
    //   232: astore_3
    //   233: aload 4
    //   235: astore 5
    ...
    //   260: aload_1
    //   261: getfield 212	c/t/m/c/a:e	Ljava/lang/String;
    ...
    //   270: invokevirtual 189	c/t/m/c/e:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   273: aload 4
    //   275: invokevirtual 250	java/io/BufferedOutputStream:close	()V
    //   278: ldc 208
    ...
    //   307: aload_1
    //   308: getfield 212	c/t/m/c/a:e	Ljava/lang/String;
    ...
    //   317: invokestatic 195	c/t/m/c/j:a	(Ljava/lang/String;)V
    //   320: aload 4
    //   322: astore 5
    //   324: aload_0
    //   325: getfield 43	c/t/m/c/c:d	Landroid/content/Context;
    //   328: invokestatic 183	c/t/m/c/e:a	(Landroid/content/Context;)Lc/t/m/c/e;
    //   331: astore_3
    //   332: aload 4
    //   334: astore 5
    ...
    //   359: aload_1
    //   360: getfield 212	c/t/m/c/a:e	Ljava/lang/String;
    ...
    //   369: invokevirtual 189	c/t/m/c/e:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   372: aload 4
    //   374: astore 5
    //   376: aload 8
    ...
    //   408: astore 5
    //   410: aload 4
    //   412: invokevirtual 250	java/io/BufferedOutputStream:close	()V
    //   415: aload 4
    //   417: astore_3
    //   418: ldc2_w 255
    //   421: invokestatic 259	c/t/m/c/q:a	(J)V
    //   424: iload_2
    //   425: iconst_1
    //   426: iadd
    //   427: istore_2
    ...
    //   468: astore 5
    //   470: aload_0
    //   471: getfield 43	c/t/m/c/c:d	Landroid/content/Context;
    //   474: invokestatic 183	c/t/m/c/e:a	(Landroid/content/Context;)Lc/t/m/c/e;
    //   477: astore 4
    //   479: aload_3
    //   480: astore 5
    ...
    //   505: aload 6
    //   507: invokevirtual 260	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   516: invokevirtual 189	c/t/m/c/e:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   519: aload_3
    //   520: astore 5
    //   522: aload_3
    //   523: invokevirtual 250	java/io/BufferedOutputStream:close	()V
    //   526: goto -108 -> 418
    //   529: astore_3
    //   530: aload 5
    //   532: astore_3
    ...
    //   536: astore_1
    //   537: aload_3
    //   538: invokevirtual 250	java/io/BufferedOutputStream:close	()V
    //   541: ldc 208
