        ...
        try
        {
          ...
          for (;;)
          {
            if (i < j)
            {
              ...
              this.c = ek.a;
              j.a("DetailsData", 6, "DetailsData: unknown json " + paramJSONObject.toString());
            }
          }
        }
        catch (JSONException paramJSONObject)
        {
          j.a("DetailsData", "json error", paramJSONObject);
        }
      }
    }
  }
  ...
  private static ek a(@Nullable JSONArray paramJSONArray)
  {
    ...
    do
    {
      ...
      if (j > 1)
      {
        ...
        localek.m.putString("addrdesp.name", (String)localObject2);
        ...
        if (localObject2 != null) {
          localek.m.putParcelable("addrdesp.landmark", new ef((JSONObject)localObject2));
        }
        if (localObject1 != null) {
          localek.m.putParcelable("addrdesp.second_landmark", new ef((JSONObject)localObject1));
        }
      }
    ...
    localek.m.putParcelableArrayList("addrdesp.results", (ArrayList)localObject1);
    return localek;
  }
