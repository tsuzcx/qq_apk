...
public final class en
{
  ...
  public static CellLocation a(dg paramdg)
  {
    boolean bool2 = false;
    ...
    if (localTelephonyManager != null) {
      try
      {
        ...
        for (;;)
        {
          ...
          if (a) {
            j.a("Cells", 6, "location permission denied!");
          }
      ...
      {
        j.a("Cells", "cannot get cell location", paramdg);
        a = true;
      }
    }
  }
  ...
  {
    return paramInt != ea.a.c.ordinal();
  }
  ...
  public static boolean a(ea paramea)
  {
    ...
    return a(paramea.a.ordinal(), paramea.b, paramea.c, paramea.d, paramea.e);
  }
  ...
  public static List<NeighboringCellInfo> b(dg paramdg)
  {
    paramdg = paramdg.e;
    if (paramdg != null) {
      try
      {
        paramdg = paramdg.getNeighboringCellInfo();
        return paramdg;
      }
      catch (Exception paramdg)
      {
        j.a("Cells", "cannot get NeighboringCellInfo", paramdg);
      }
    }
