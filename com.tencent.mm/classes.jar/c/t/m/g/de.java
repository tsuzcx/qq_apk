  ...
  implements Observer
{
  ...
  public static de a()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 43	c/t/m/g/de:f	Lc/t/m/g/de;
    //   6: ifnonnull +19 -> 25
    //   9: ldc 2
    //   11: monitorenter
    //   12: new 2	c/t/m/g/de
    //   15: dup
    //   16: invokespecial 105	c/t/m/g/de:<init>	()V
    //   19: putstatic 43	c/t/m/g/de:f	Lc/t/m/g/de;
    //   22: ldc 2
    //   24: monitorexit
    //   25: getstatic 43	c/t/m/g/de:f	Lc/t/m/g/de;
    //   28: astore_0
    //   29: ldc 2
    //   31: monitorexit
    //   32: aload_0
  ...
  private void c()
  {
    ...
    {
      da.a("CC_Set", localThrowable.getMessage(), localThrowable);
    }
  }
  ...
  private void f(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        da.b("CC_Set", paramString.toString());
        return;
      }
    }
  ...
  protected final void b()
  {
    if (df.a().b() == null)
    {
      da.a("CC_Set", "---> read xml: failed,not init finish!");
      return;
    }
    ...
    this.i = true;
    da.a("CC_Set", "---> read xml:" + this.h.toString());
  }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      f(paramObservable);
      da.a("CC_Set", paramObject + (String)this.h.get(paramObservable));
