...
public final class cv
{
  ...
  public static String a(co paramco, Location paramLocation, List<ScanResult> paramList, List<cp> paramList1)
  {
    int i;
    int j;
    if (paramList != null)
    {
      ...
      catch (Throwable paramco)
      {
        ...
        Object localObject;
        label241:
        cq.a("DCUtils", "get write string error!", paramco);
        label333:
        return "";
      }
      ...
      if ((paramList1 != null) && (paramList1.size() > 0))
      {
        ...
        {
          localObject = (cp)paramList1.get(i);
          if (i != 0) {
            break label794;
          }
          paramLocation = "";
          localStringBuilder2.append(paramLocation).append(((cp)localObject).a).append(",").append(((cp)localObject).b).append(",").append(((cp)localObject).c).append(",").append(((cp)localObject).d).append(",").append(((cp)localObject).e);
          i += 1;
        }
      }
    ...
    for (paramLocation = "";; paramLocation = "&")
    {
      ...
      try
      {
        ...
        paramList = co.a(paramco.c).replaceAll("[| _]", "");
        paramList = paramList + "_" + co.a(paramco.b);
        paramList1 = co.a(Build.MANUFACTURER).replaceAll("[| _]", "");
        paramList1 = paramList1 + "_" + co.a(Build.MODEL).replaceAll("[| _]", "");
        localObject = new StringBuilder();
        ((StringBuilder)localObject).append("[").append(c.format(new Date())).append("]:1.2.15|").append(a).append("|").append(co.a(paramco.d)).append("|||||||||").append(localStringBuilder1).append("||").append(localStringBuilder2).append("|").append(localStringBuilder3).append("||||||||||||||||").append(b).append("||||").append(paramLocation).append("|||").append(paramList).append("|||").append(paramList1);
      ...
      for (;;)
      {
        if ((paramco != null) && (paramLocation != null) && ((i != 0) || (j != 0))) {
          break label792;
        }
        return "";
        i = 0;
