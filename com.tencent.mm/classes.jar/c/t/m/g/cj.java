...
public final class cj
{
  ...
  public static cj.a a(int paramInt, Context paramContext, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      if (paramContext != null)
      {
        paramContext = new cj.a(paramInt, paramString1, paramContext.enabled, paramContext.exported, paramContext.processName, paramContext.metaData);
        return paramContext;
      }
    }
    catch (PackageManager.NameNotFoundException paramContext) {}
  ...
  public static String a(Context paramContext)
  {
    ...
    String str2 = cm.a(Process.myPid());
    String str1;
    ...
    {
      str1 = cm.a(paramContext, Process.myPid());
    }
    a = str1;
    return str1;
  }
  ...
  {
    String str2 = "HalleyServicePreferences_" + m.b();
    String str1 = str2;
    if (paramBoolean) {
      str1 = str2 + "_" + m.h();
    }
