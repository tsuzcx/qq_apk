...
public final class x$a
{
  ...
  public static int a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    return cm.a(i, paramInt1, paramInt2, paramInt3);
  }
  
  public static Handler a(String paramString)
  {
    paramString = new HandlerThread("halley_" + m.b() + "_" + paramString, 10);
    paramString.start();
  ...
  public static boolean a(String paramString, boolean paramBoolean, Map<String, String> paramMap)
  {
    ...
    {
      localObject = ay.e();
      paramString = ay.a(paramString, paramBoolean, paramMap);
      try
      {
        if (((ap)localObject).b.getAndIncrement() > ((ap)localObject).c) {
          ((ap)localObject).b.decrementAndGet();
        } else {
          new ap.b((ap)localObject, paramString).a(false);
        }
      }
      catch (Throwable paramString) {}
      return true;
  ...
  {
    String str1 = bk.a().a(x.b());
    String str2 = cj.a(x.g());
    return ((cd)cf.d().a.get("settings")).a(paramString, paramInt, m.e(), m.a, str1, str2);
  }
}
