...
public class XWalkUpdater$FileListMD5Checker
{
  ...
  private static boolean checkFileMd5(int paramInt, String paramString1, String paramString2)
  {
    ...
    for (paramString1 = XWalkEnvironment.getDownloadApkPath(paramInt); d.mi(paramString1, paramString2); paramString1 = XWalkEnvironment.getExtractedCoreFile(paramInt, paramString1))
    {
