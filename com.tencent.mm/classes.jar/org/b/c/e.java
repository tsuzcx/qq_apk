  ...
  implements d
{
  public final String a(org.b.d.c paramc)
  {
    ...
    org.b.g.d.x(paramc, "Cannot extract a header from a null object");
    ...
    for (;;)
    {
      ...
      localStringBuffer.append(String.format("%s=\"%s\"", new Object[] { str, org.b.g.c.cg((String)paramc.get(str)) }));
    }
  }
}
