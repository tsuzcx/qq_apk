...
public final class a
  implements b
{
  public final String bD(String paramString1, String paramString2, String paramString3)
  {
    AppMethodBeat.i(40569);
    try
    {
      org.b.g.d.oM(paramString1, "Base string cant be null or empty string");
      org.b.g.d.oM(paramString2, "Api secret cant be null or empty string");
      ...
      paramString2 = new String(org.b.g.a.dy(paramString3.doFinal(paramString1.getBytes("UTF-8")))).replace("\r\n", "");
