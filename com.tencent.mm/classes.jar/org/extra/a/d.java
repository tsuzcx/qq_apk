...
{
  protected boolean agzT;
  protected final Set<String> ajXR;
  protected final c.b ajXS;
  protected final c.a ajXT;
  ...
  /* Error */
  private void aq(Context paramContext, String paramString1, String paramString2)
  {
    // Byte code:
    //   0: ldc 59
    //   2: invokestatic 35	com/tencent/matrix/trace/core/AppMethodBeat:i	(I)V
    //   5: aload_0
    //   6: getfield 46	org/extra/a/d:ajXR	Ljava/util/Set;
    //   9: aload_2
    //   10: invokeinterface 65 2 0
    //   15: ifeq +29 -> 44
    //   18: aload_0
    //   19: getfield 67	org/extra/a/d:idP	Z
    //   22: ifne +22 -> 44
    //   25: ldc 69
    //   27: iconst_1
    ...
    //   33: aload_2
    //   34: aastore
    //   35: invokestatic 73	org/extra/a/d:x	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   38: ldc 59
    //   40: invokestatic 38	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   43: return
    //   44: aload_0
    //   45: getfield 48	org/extra/a/d:ajXS	Lorg/extra/a/c$b;
    //   48: aload_2
    //   49: invokeinterface 79 2 0
    //   54: aload_0
    //   55: getfield 46	org/extra/a/d:ajXR	Ljava/util/Set;
    //   58: aload_2
    ...
    //   77: aconst_null
    //   78: aastore
    //   79: invokestatic 73	org/extra/a/d:x	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   82: ldc 59
    ...
    //   101: aastore
    //   102: invokestatic 73	org/extra/a/d:x	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   105: ldc 94
    //   107: iconst_2
    ...
    //   117: aconst_null
    //   118: aastore
    //   119: invokestatic 73	org/extra/a/d:x	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   122: aload_0
    //   123: aload_1
    //   124: aload_2
    //   125: aconst_null
    //   126: invokespecial 98	org/extra/a/d:ar	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    //   129: astore 7
    //   131: aload 7
    //   133: invokevirtual 104	java/io/File:exists	()Z
    //   136: ifeq +10 -> 146
    //   139: aload_0
    //   140: getfield 67	org/extra/a/d:idP	Z
    //   143: ifeq +165 -> 308
    //   146: aload_0
    //   147: getfield 67	org/extra/a/d:idP	Z
    //   150: ifeq +20 -> 170
    //   153: ldc 106
    //   155: iconst_2
    ...
    //   165: aconst_null
    //   166: aastore
    //   167: invokestatic 73	org/extra/a/d:x	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   170: aload_1
    //   171: ldc 108
    //   173: iconst_0
    ...
    //   181: aload_2
    //   182: aconst_null
    //   183: invokespecial 98	org/extra/a/d:ar	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    //   186: astore_3
    //   187: aload 8
    ...
    //   193: aload_0
    //   194: aload_0
    //   195: getfield 48	org/extra/a/d:ajXS	Lorg/extra/a/c$b;
    //   198: aload_2
    ...
    //   237: astore 9
    //   239: aload_0
    //   240: getfield 67	org/extra/a/d:idP	Z
    //   243: ifne +18 -> 261
    //   246: aload 9
    ...
    //   273: goto -48 -> 225
    //   276: aload_0
    //   277: getfield 50	org/extra/a/d:ajXT	Lorg/extra/a/c$a;
    //   280: aload_1
    //   281: aload_0
    //   282: getfield 48	org/extra/a/d:ajXS	Lorg/extra/a/c$b;
    //   285: invokeinterface 141 1 0
    //   290: aload_0
    //   291: getfield 48	org/extra/a/d:ajXS	Lorg/extra/a/c$b;
    //   294: aload_2
    ...
    //   308: aload_0
    //   309: getfield 149	org/extra/a/d:agzT	Z
    //   312: istore 6
    //   314: iload 6
    //   316: ifeq +71 -> 387
    ...
    //   328: astore_3
    //   329: aload_3
    //   330: invokevirtual 158	org/extra/a/a/f:kJA	()Ljava/util/List;
    //   333: astore 8
    //   335: aload_3
    ...
    //   368: aload_1
    //   369: aload_0
    //   370: getfield 48	org/extra/a/d:ajXS	Lorg/extra/a/c$b;
    //   373: aload 8
    //   375: invokeinterface 179 2 0
    //   380: invokevirtual 183	org/extra/a/d:dA	(Landroid/content/Context;Ljava/lang/String;)V
    //   383: goto -36 -> 347
    //   386: astore_1
    //   387: aload_0
    //   388: getfield 48	org/extra/a/d:ajXS	Lorg/extra/a/c$b;
    //   391: aload 7
    //   393: invokevirtual 129	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   396: invokeinterface 186 2 0
    //   401: aload_0
    //   402: getfield 46	org/extra/a/d:ajXR	Ljava/util/Set;
    //   405: aload_2
    ...
    //   424: aconst_null
    //   425: aastore
    //   426: invokestatic 73	org/extra/a/d:x	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   429: ldc 59
  ...
  private File ar(Context paramContext, String paramString1, String paramString2)
  {
    AppMethodBeat.i(187316);
    paramString1 = this.ajXS.bLq(paramString1);
    if (f.bB(paramString2))
    {
  ...
  public final void dA(Context paramContext, String paramString)
  {
    ...
    x("Beginning load of %s...", new Object[] { paramString });
    aq(paramContext, paramString, null);
    AppMethodBeat.o(187334);
  }
}
