...
{
  public static final BigInteger Kkh;
  public static final BigInteger Kki;
  public static final BigInteger Kkj;
  public static final BigInteger Kkk;
  public static final BigInteger Kkl;
  public static final BigInteger Kkm;
  public static final BigInteger Kkn;
  public static final File[] Kko;
  ...
  static
  {
    ...
    kCN = localBigInteger;
    Kkh = localBigInteger.multiply(localBigInteger);
    Kki = kCN.multiply(Kkh);
    Kkj = kCN.multiply(Kki);
    Kkk = kCN.multiply(Kkj);
    Kkl = kCN.multiply(Kkk);
    Kkm = BigInteger.valueOf(1024L).multiply(BigInteger.valueOf(1152921504606846976L));
    Kkn = kCN.multiply(Kkm);
    Kko = new File[0];
  ...
  public static void c(java.io.InputStream paramInputStream, File paramFile)
  {
    ...
    //   234: aload_0
    //   235: aload 4
    //   237: invokestatic 127	org/apache/commons/a/d:c	(Ljava/io/InputStream;Ljava/io/OutputStream;)I
    //   240: pop
    //   241: aload 4
    //   243: invokevirtual 130	java/io/OutputStream:close	()V
    //   246: aload_0
    //   247: ifnull +7 -> 254
    //   250: aload_0
    ...
    //   280: ifnull +27 -> 307
    //   283: aload 4
    //   285: invokevirtual 130	java/io/OutputStream:close	()V
    //   288: sipush 10326
    ...
    //   298: aload_2
    //   299: aload 4
    //   301: invokevirtual 134	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   304: goto -16 -> 288
    //   307: aload 4
    //   309: invokevirtual 130	java/io/OutputStream:close	()V
    //   312: goto -24 -> 288
    //   315: astore 4
    //   317: aload_2
    //   318: aload 4
    //   320: invokevirtual 134	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   323: goto -242 -> 81
    //   326: aload_0
    ...
    //   334: aload_2
    //   335: aload_0
    //   336: invokevirtual 134	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   339: goto -228 -> 111
    //   342: aload_0
