...
{
  public static boolean ajXF = true;
  public static boolean ajXG = true;
  public static boolean ajXH = true;
  private Throwable ajXE;
  
  public c(b paramb)
  {
    AppMethodBeat.i(40720);
    this.ajXE = null;
    this.ajXE = ((Throwable)paramb);
    AppMethodBeat.o(40720);
  }
  
  private static void pn(List paramList)
  {
    ...
    while (i > 0)
    {
      ...
      a.ad(localArrayList, new ArrayList(Arrays.asList(arrayOfString2)));
  ...
  public final void printStackTrace(PrintWriter paramPrintWriter)
  {
    ...
    if (localObject1 != null)
    {
      ...
      for (;;)
      {
        ((List)localObject3).add(a.bLn(((StringWriter)localObject4).getBuffer().toString()));
        localObject1 = a.ae((Throwable)localObject1);
        break;
 ...
 * Qualified Name:     org.apache.commons.c.b.c
