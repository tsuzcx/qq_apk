  ...
  implements Comparable<z>
{
  ...
  public static int aKc(int paramInt)
  {
    return paramInt;
  }
  ...
  {
    int i = this.data;
    return ((paramObject instanceof z)) && (i == ((z)paramObject).data);
  }
  ...
  public final String toString()
  {
    ...
    String str = cJ(this.data);
    AppMethodBeat.o(191269);
    return str;
  }
  
  @Metadata(d1={""}, d2={"Lkotlin/UInt$Companion;", "", "()V", "MAX_VALUE", "Lkotlin/UInt;", "I", "MIN_VALUE", "SIZE_BITS", "", "SIZE_BYTES", "kotlin-stdlib"}, k=1, mv={1, 5, 1})
