...
public final class s
{
  ...
  static final kotlin.l.b.a.a.d<?> a(r.a<?, ?> parama, final boolean paramBoolean)
  {
    ...
    Object localObject1 = i.Taw;
    if (i.hyD().aJ((CharSequence)parama.hyF().signature))
    {
      parama = (kotlin.l.b.a.a.d)j.Tct;
    ...
    localObject1 = ac.TbJ;
    d locald = ac.c(parama.hyF().hyO());
    if ((locald instanceof d.c))
    {
      localObject1 = ((d.c)locald).SZG;
      if (paramBoolean) {
        if (((a.c)localObject1).hIA())
        {
          localObject1 = ((a.c)localObject1).TCc;
          if (localObject1 == null) {
            break label318;
          }
          localObject1 = parama.hyF().TaI.oq(((d.c)locald).SZH.getString(((a.b)localObject1).Tyk), ((d.c)locald).SZH.getString(((a.b)localObject1).TBX));
        }
      }
      for (;;)
      {
        if (localObject1 == null) {
          if ((kotlin.l.b.a.b.j.e.a((ax)parama.hyF().hyO())) && (p.j(parama.hyF().hyO().hzE(), az.ThT)))
          {
            localObject1 = h.a(parama.hyF().hyO().hzx());
            if (localObject1 != null)
            {
              localObject1 = h.a((Class)localObject1, (kotlin.l.b.a.b.b.b)parama.hyF().hyO());
              if (localObject1 != null) {}
            }
            else
            {
              parama = (Throwable)new w("Underlying property of inline class " + parama.hyF() + " should have a field");
              AppMethodBeat.o(56487);
              throw parama;
              localObject1 = null;
              break;
              if (((a.c)localObject1).hIB())
              {
                localObject1 = ((a.c)localObject1).TCd;
                break;
              }
              localObject1 = null;
              break;
    ...
    for (;;)
    {
      parama = h.a((kotlin.l.b.a.a.d)localObject1, (kotlin.l.b.a.b.b.b)parama.hyP());
      AppMethodBeat.o(56487);
      return parama;
      localObject1 = (kotlin.l.b.a.a.i)new i.b((Method)localObject1);
      break;
      localObject1 = parama.hyF().hyM();
      if (localObject1 == null)
      {
        parama = (Throwable)new w("No accessors or field is found for property " + parama.hyF());
        AppMethodBeat.o(56487);
        throw parama;
      }
      localObject1 = (kotlin.l.b.a.a.d)((c)localObject2).e((Field)localObject1);
      continue;
      ...
      localObject1 = (kotlin.l.b.a.a.d)((c)localObject2).e(((d.a)locald).bUo);
    }
    label640:
    if ((locald instanceof d.b)) {
      if (paramBoolean) {
        localObject1 = ((d.b)locald).SZC;
      }
    }
    label1041:
    for (;;)
    {
      ...
      for (localObject1 = (e.h)new e.h.a((Method)localObject1, a(parama));; localObject1 = (e.h)new e.h.d((Method)localObject1))
      {
        localObject1 = (kotlin.l.b.a.a.d)localObject1;
        break;
        localObject1 = ((d.b)locald).SZD;
        if (localObject1 != null) {
          break label1041;
        }
        parama = (Throwable)new w("No source found for setter of Java method property: " + ((d.b)locald).SZC);
        AppMethodBeat.o(56487);
        throw parama;
      }
      ...
      {
        if (paramBoolean) {
          localObject1 = ((d.d)locald).SZJ;
        }
        do
        {
          localObject1 = parama.hyF().TaI.oq(((c.e)localObject1).SZB.name, ((c.e)localObject1).SZB.desc);
          if (localObject1 != null) {
            break;
          }
          parama = (Throwable)new w("No accessor found for property " + parama.hyF());
          AppMethodBeat.o(56487);
          throw parama;
          localObject2 = ((d.d)locald).SZK;
          localObject1 = localObject2;
        } while (localObject2 != null);
        parama = (Throwable)new w("No setter found for property " + parama.hyF());
        AppMethodBeat.o(56487);
        throw parama;
        if (!Modifier.isStatic(((Method)localObject1).getModifiers())) {}
        for (int i = 1; (aa.SXc) && (i == 0); i = 0)
        {
          parama = (Throwable)new AssertionError("Mapped property cannot have a static accessor: " + parama.hyF());
          AppMethodBeat.o(56487);
          throw parama;
        }
        if (parama.hyF().isBound())
  ...
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"isJvmStaticProperty", "", "invoke"})
    ...
    implements a<Boolean>
  {
    ...
    public final boolean ij()
    {
      ...
      boolean bool = this.Tbl.hyF().hyO().hzL().h(ae.hyU());
      AppMethodBeat.o(56481);
      return bool;
    }
  }
  
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"isNotNullProperty", "", "invoke"})
  ...
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"computeFieldCaller", "Lkotlin/reflect/jvm/internal/calls/CallerImpl;", "Ljava/lang/reflect/Field;", "field", "invoke"})
    ...
    implements kotlin.g.a.b<Field, kotlin.l.b.a.a.e<? extends Field>>
  {
    ...
    public final kotlin.l.b.a.a.e<Field> e(Field paramField)
    {
      AppMethodBeat.i(56485);
      p.h(paramField, "field");
      if ((s.a(this.Tbl.hyF().hyO())) || (!Modifier.isStatic(paramField.getModifiers())))
      {
        if (paramBoolean)
        {
          if (this.Tbl.hyF().isBound()) {}
          for (paramField = (e.f)new e.f.a(paramField, s.a(this.Tbl));; paramField = (e.f)new e.f.c(paramField))
          {
        ...
        if (this.Tbl.hyF().isBound()) {}
        for (paramField = (e.g)new e.g.a(paramField, this.Tbn.ij(), s.a(this.Tbl));; paramField = (e.g)new e.g.c(paramField, this.Tbn.ij()))
        {
          paramField = (kotlin.l.b.a.a.e)paramField;
          AppMethodBeat.o(56485);
          return paramField;
      ...
      if (locala.ij())
      {
        ...
        if (this.Tbl.hyF().isBound()) {}
        for (paramField = (e.g)new e.g.b(paramField, this.Tbn.ij());; paramField = (e.g)new e.g.d(paramField, this.Tbn.ij()))
        {
          paramField = (kotlin.l.b.a.a.e)paramField;
          AppMethodBeat.o(56485);
          return paramField;
      ...
      paramField = (kotlin.l.b.a.a.e)new e.g.e(paramField, this.Tbn.ij());
      AppMethodBeat.o(56485);
      return paramField;
    }
  }
