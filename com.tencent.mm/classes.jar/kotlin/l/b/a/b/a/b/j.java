...
public final class j
{
  public static final au a(e parame1, e parame2)
  {
    ...
    p.h(parame1, "from");
    p.h(parame2, "to");
    if (parame1.hzO().size() == parame2.hzO().size()) {}
    for (int i = 1; (aa.SXc) && (i == 0); i = 0)
    {
      parame1 = (Throwable)new AssertionError(parame1 + " and " + parame2 + " should have same number of type parameters, but " + parame1.hzO().size() + " / " + parame2.hzO().size() + " found");
      AppMethodBeat.o(56826);
      throw parame1;
    }
    Object localObject1 = au.TOz;
    parame1 = parame1.hzO();
    ...
    while (((Iterator)localObject1).hasNext()) {
      parame1.add(((as)((Iterator)localObject1).next()).hzz());
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      p.g(localObject2, "it");
      localObject2 = ((as)localObject2).hAG();
      p.g(localObject2, "it.defaultType");
      parame2.add(a.aN((ab)localObject2));
    }
    parame1 = au.a.cC(ae.E((Iterable)kotlin.a.j.c(parame1, (Iterable)parame2)));
    AppMethodBeat.o(56826);
    return parame1;
  }
}
