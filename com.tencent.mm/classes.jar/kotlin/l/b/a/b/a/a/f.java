  ...
  extends ae
{
  ...
  {
    super(paraml, paramf, g.a.iGe(), kotlin.l.b.a.b.n.j.abte, parama, an.aaKE);
    AppMethodBeat.i(56742);
    this.aaNG = true;
    this.aaNO = paramBoolean;
    Ji(false);
    AppMethodBeat.o(56742);
  }
  
  private final kotlin.l.b.a.b.b.t lu(List<kotlin.l.b.a.b.f.f> paramList)
  {
    boolean bool = true;
    AppMethodBeat.i(56741);
    int j = iEJ().size() - paramList.size();
    if ((j == 0) || (j == 1)) {}
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject2 = localav.iEU();
      kotlin.g.b.p.j(localObject2, "it.name");
      i = localav.getIndex();
      int k = i - j;
    ...
    for (;;)
    {
      ((p.a)localObject2).aaOn = Boolean.valueOf(bool);
      paramList = ((p.a)localObject2).ly((List)localObject1).f((kotlin.l.b.a.b.b.b)iGK());
      kotlin.g.b.p.j(paramList, "newCopyBuilder(TypeSubst…   .setOriginal(original)");
  ...
  public final kotlin.l.b.a.b.b.c.p a(l paraml, kotlin.l.b.a.b.b.t paramt, b.a parama, kotlin.l.b.a.b.f.f paramf, g paramg, an paraman)
  {
    ...
    paraml = (kotlin.l.b.a.b.b.c.p)new f(paraml, (f)paramt, parama, iFn());
  ...
  public final kotlin.l.b.a.b.b.t a(p.a parama)
  {
    ...
    kotlin.g.b.p.k(parama, "configuration");
    ...
    Object localObject1 = parama.iEJ();
    kotlin.g.b.p.j(localObject1, "substituted.valueParameters");
    localObject1 = (Iterable)localObject1;
    if ((!(localObject1 instanceof Collection)) || (!((Collection)localObject1).isEmpty()))
    {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        kotlin.g.b.p.j(localObject2, "it.type");
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      localObject3 = ((av)localObject3).iFN();
      kotlin.g.b.p.j(localObject3, "it.type");
      ((Collection)localObject1).add(kotlin.l.b.a.b.a.f.k((ab)localObject3));
    }
    parama = parama.lu((List)localObject1);
    AppMethodBeat.o(56739);
    return parama;
  }
  ...
  public static final class a
  {
    public static f a(b paramb, boolean paramBoolean)
    {
      ...
      kotlin.g.b.p.k(paramb, "functionClass");
      List localList1 = paramb.parameters;
      f localf = new f((l)paramb, b.a.aaJQ, paramBoolean);
      paramb = paramb.iFb();
      List localList2 = (List)v.aaAd;
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if (((as)localObject3).iEW() == bh.abrq) {}
        for (int i = 1;; i = 0)
        {
          if (i == 0) {
            break label127;
      ...
      localf.b(null, paramb, localList2, (List)localObject1, (ab)((as)kotlin.a.j.lq(localList1)).iET(), w.aaKl, az.aaKO);
      localf.Jj(true);
    ...
    private static av a(f paramf, int paramInt, as paramas)
    {
      ...
      Object localObject1 = paramas.iEU().qu();
      kotlin.g.b.p.j(localObject1, "typeParameter.name.asString()");
      ...
      {
        paramf = (a)paramf;
        Object localObject2 = g.aaLw;
        localObject2 = g.a.iGe();
        localObject1 = kotlin.l.b.a.b.f.f.bHb((String)localObject1);
        kotlin.g.b.p.j(localObject1, "Name.identifier(name)");
        paramas = paramas.iET();
        kotlin.g.b.p.j(paramas, "typeParameter.defaultType");
        paramas = (ab)paramas;
        an localan = an.aaKE;
        kotlin.g.b.p.j(localan, "SourceElement.NO_SOURCE");
        ...
        kotlin.g.b.p.j(localObject1, "(this as java.lang.String).toLowerCase()");
      }
    }
  }
}
