...
{
  private static final b Ttr;
  
  static
  {
    AppMethodBeat.i(57981);
    Ttr = new b("java.lang.Class");
  ...
  public static final ab a(as paramas1, as paramas2, kotlin.g.a.a<? extends ab> parama)
  {
    ...
    localObject = (ab)j.ks((List)localObject);
    if ((((ab)localObject).hKE().hzS() instanceof e))
    {
    ...
    for (;;)
    {
      paramas2 = ((ab)localObject).hKE().hzS();
      if (paramas2 == null)
      {
      ...
      for (paramas2 = (as)paramas2; (p.j(paramas2, paramas1) ^ true); paramas2 = (as)paramas2)
      {
        paramas2 = paramas2.hyo();
        p.g(paramas2, "current.upperBounds");
        paramas2 = (ab)j.ks(paramas2);
        if ((paramas2.hKE().hzS() instanceof e))
        {
