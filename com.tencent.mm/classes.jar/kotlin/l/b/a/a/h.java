...
public final class h
{
  public static final Class<?> a(kotlin.l.b.a.b.b.l paraml)
  {
    ...
    if (((paraml instanceof kotlin.l.b.a.b.b.e)) && (((kotlin.l.b.a.b.b.e)paraml).iDU()))
    {
      ...
      if (localClass2 == null)
      {
        paraml = (Throwable)new w("Class object for the class " + ((kotlin.l.b.a.b.b.e)paraml).iEU() + " cannot be found (classId=" + kotlin.l.b.a.b.j.d.a.c((kotlin.l.b.a.b.b.h)paraml) + ')');
  ...
  public static final Method a(Class<?> paramClass, b paramb)
  {
    ...
    p.k(paramClass, "$this$getUnboxMethod");
    p.k(paramb, "descriptor");
    try
    {
      Method localMethod = paramClass.getDeclaredMethod("unbox-impl", new Class[0]);
      p.j(localMethod, "getDeclaredMethod(\"unbox…FOR_INLINE_CLASS_MEMBERS)");
  ...
  public static final <M extends Member> d<M> a(d<? extends M> paramd, b paramb, boolean paramBoolean)
  {
    ...
    p.k(paramd, "$this$createInlineClassAwareCallerIfNeeded");
    p.k(paramb, "descriptor");
    if (!kotlin.l.b.a.b.j.e.f((kotlin.l.b.a.b.b.a)paramb))
    {
      Object localObject1 = paramb.iEJ();
      ...
      for (;;)
      {
        if (((Iterator)localObject1).hasNext())
        {
          ...
          p.j(localObject2, "it.type");
          if (kotlin.l.b.a.b.j.e.aa((ab)localObject2))
          {
            i = 1;
            if (i == 0)
            {
              localObject1 = paramb.iEH();
  ...
  public static final Class<?> c(ab paramab)
  {
    ...
    p.k(paramab, "$this$toInlineClass");
    paramab = a((kotlin.l.b.a.b.b.l)paramab.iOU().iEf());
  ...
  private static final ab c(b paramb)
  {
    ...
    Object localObject = paramb.iEE();
    ak localak = paramb.iEF();
    if (localObject != null)
    {
      paramb = ((ak)localObject).iFN();
    ...
    if (paramb != null) {}
    for (paramb = paramb.iET();; paramb = null)
    {
      paramb = (ab)paramb;
      AppMethodBeat.o(56638);
      return paramb;
