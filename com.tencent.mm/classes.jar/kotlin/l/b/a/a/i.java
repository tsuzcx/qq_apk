  ...
  implements d<Method>
{
  ...
  {
    this.Tcs = paramMethod;
    this.TbO = paramList;
    paramMethod = this.Tcs.getReturnType();
    p.g(paramMethod, "unboxMethod.returnType");
    this.Tci = ((Type)paramMethod);
  }
  ...
  {
    p.h(paramArrayOfObject, "args");
    return this.Tcs.invoke(paramObject, Arrays.copyOf(paramArrayOfObject, paramArrayOfObject.length));
  }
  ...
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"Lkotlin/reflect/jvm/internal/calls/InternalUnderlyingValOfInlineClass$Unbound;", "Lkotlin/reflect/jvm/internal/calls/InternalUnderlyingValOfInlineClass;", "unboxMethod", "Ljava/lang/reflect/Method;", "(Ljava/lang/reflect/Method;)V", "call", "", "args", "", "([Ljava/lang/Object;)Ljava/lang/Object;", "kotlin-reflection"})
    ...
    extends i
  {
    ...
    public final Object ag(Object[] paramArrayOfObject)
    {
      ...
      do
      {
        ...
        return paramArrayOfObject;
        localObject1 = kotlin.a.e.copyOfRange(paramArrayOfObject, 1, paramArrayOfObject.length);
