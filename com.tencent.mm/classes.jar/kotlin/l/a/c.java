...
public final class c
{
  public static final <T> T d(b<T> paramb)
  {
    ...
    Iterator localIterator = ((Iterable)paramb.hxW()).iterator();
    int i = 0;
    ...
    if (localIterator.hasNext())
    {
      ...
      if ((!(localObject3 instanceof Collection)) || (!((Collection)localObject3).isEmpty()))
      {
        ...
        while (((Iterator)localObject3).hasNext()) {
          if (!((j)((Iterator)localObject3).next()).FI()) {
            j = 0;
          }
        }
      }
    ...
    for (;;)
    {
      ...
      break label135;
      paramb = ((e)localObject1).cx(ae.emptyMap());
      AppMethodBeat.o(186228);
      return paramb;
    }
  }
