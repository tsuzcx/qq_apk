...
public abstract interface f
{
  ...
  public static final class a
  {
    public static f a(f paramf1, f paramf2)
    {
      ...
      paramf1 = (f)paramf2.fold(paramf1, (m)a.SXJ);
      AppMethodBeat.o(129629);
      return paramf1;
    }
    
    @l(hxD={1, 1, 16}, hxE={""}, hxF={"<anonymous>", "Lkotlin/coroutines/CoroutineContext;", "acc", "element", "Lkotlin/coroutines/CoroutineContext$Element;", "invoke"})
  ...
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"Lkotlin/coroutines/CoroutineContext$Key;", "E", "Lkotlin/coroutines/CoroutineContext$Element;", "", "kotlin-stdlib"})
