  ...
  implements Serializable, f
{
  ...
  private final boolean b(f.b paramb)
  {
    ...
    boolean bool = p.j(get(paramb.getKey()), paramb);
  ...
  private final Object writeReplace()
  {
    ...
    locald.SYE = 0;
    fold(x.SXb, (m)new c((f[])localObject, locald));
    if (locald.SYE == i) {}
    for (i = 1; i == 0; i = 0)
    {
  ...
  public final <R> R fold(R paramR, m<? super R, ? super f.b, ? extends R> paramm)
  {
    ...
    paramR = paramm.invoke(this.SXB.fold(paramR, paramm), this.SXC);
  ...
  public final <E extends f.b> E get(f.c<E> paramc)
  {
    ...
    {
      f.b localb = ((c)localObject).SXC.get(paramc);
      if (localb != null)
      {
        AppMethodBeat.o(129611);
        return localb;
      }
      localObject = ((c)localObject).SXB;
  ...
  public final int hashCode()
  {
    ...
    int i = this.SXB.hashCode();
    int j = this.SXC.hashCode();
  ...
  public final f minusKey(f.c<?> paramc)
  {
    ...
    p.h(paramc, "key");
    if (this.SXC.get(paramc) != null)
    {
      paramc = this.SXB;
      AppMethodBeat.o(129613);
      return paramc;
    }
    paramc = this.SXB.minusKey(paramc);
    if (paramc == this.SXB)
    {
      paramc = (f)this;
      AppMethodBeat.o(129613);
    ...
    paramc = (f)new c(paramc, this.SXC);
    AppMethodBeat.o(129613);
    return paramc;
  }
  ...
  public final String toString()
  {
    ...
    String str = "[" + (String)fold("", (m)c.b.SXF) + "]";
  ...
  {
    public static final c.a.a SXE;
    private final f[] SXD;
    
    static
    {
      AppMethodBeat.i(129633);
      SXE = new c.a.a((byte)0);
  ...
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"<anonymous>", "", "<anonymous parameter 0>", "element", "Lkotlin/coroutines/CoroutineContext$Element;", "invoke", "(Lkotlin/Unit;Lkotlin/coroutines/CoroutineContext$Element;)V"})
  static final class c
    extends q
    implements m<x, f.b, x>
  {
    c(f[] paramArrayOff, z.d paramd)
    {
      super();
    }
  }
