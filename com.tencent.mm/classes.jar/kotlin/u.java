  ...
  implements Comparable<u>
{
  ...
  public static String Pb(long paramLong)
  {
    ...
    String str = z.Pd(paramLong);
    AppMethodBeat.o(258671);
    return str;
  }
  
  public static long Pc(long paramLong)
  {
    return paramLong;
  }
  ...
  {
    long l = this.data;
    return ((paramObject instanceof u)) && (l == ((u)paramObject).data);
  }
  ...
  public final String toString()
  {
    ...
    String str = z.Pd(this.data);
    AppMethodBeat.o(206215);
    return str;
  }
  
  @l(hxD={1, 1, 16}, hxE={""}, hxF={"Lkotlin/ULong$Companion;", "", "()V", "MAX_VALUE", "Lkotlin/ULong;", "J", "MIN_VALUE", "SIZE_BITS", "", "SIZE_BYTES", "kotlin-stdlib"})
