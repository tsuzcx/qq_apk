...
@kotlin.l(hxD={1, 1, 16}, hxE={""}, hxF={"Lkotlin/text/Regex;", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "pattern", "", "(Ljava/lang/String;)V", "option", "Lkotlin/text/RegexOption;", "(Ljava/lang/String;Lkotlin/text/RegexOption;)V", "options", "", "(Ljava/lang/String;Ljava/util/Set;)V", "nativePattern", "Ljava/util/regex/Pattern;", "(Ljava/util/regex/Pattern;)V", "_options", "getOptions", "()Ljava/util/Set;", "getPattern", "()Ljava/lang/String;", "containsMatchIn", "", "input", "", "find", "Lkotlin/text/MatchResult;", "startIndex", "", "findAll", "Lkotlin/sequences/Sequence;", "matchEntire", "matches", "replace", "transform", "Lkotlin/Function1;", "replacement", "replaceFirst", "split", "", "limit", "toPattern", "toString", "writeReplace", "", "Companion", "Serialized", "kotlin-stdlib"})
  ...
  implements Serializable
{
  ...
  private final Object writeReplace()
  {
    ...
    Object localObject = this.TTg.pattern();
    p.g(localObject, "nativePattern.pattern()");
    localObject = new b((String)localObject, this.TTg.flags());
    AppMethodBeat.o(129430);
    return localObject;
  }
  
  public final boolean aJ(CharSequence paramCharSequence)
  {
    AppMethodBeat.i(129423);
    p.h(paramCharSequence, "input");
    boolean bool = this.TTg.matcher(paramCharSequence).matches();
    AppMethodBeat.o(129423);
    return bool;
  }
  
  public final i aK(CharSequence paramCharSequence)
  {
    AppMethodBeat.i(206255);
    p.h(paramCharSequence, "input");
    Matcher localMatcher = this.TTg.matcher(paramCharSequence);
  ...
  public final String e(CharSequence paramCharSequence, String paramString)
  {
    ...
    paramCharSequence = this.TTg.matcher(paramCharSequence).replaceAll(paramString);
  ...
  public final String f(CharSequence paramCharSequence, String paramString)
  {
    ...
    p.h(paramCharSequence, "input");
    p.h(paramString, "replacement");
    paramCharSequence = this.TTg.matcher(paramCharSequence).replaceFirst(paramString);
    p.g(paramCharSequence, "nativePattern.matcher(in…replaceFirst(replacement)");
    AppMethodBeat.o(129427);
    return paramCharSequence;
  }
  
  public final i p(CharSequence paramCharSequence, int paramInt)
  {
  ...
  public final String toString()
  {
    ...
    String str = this.TTg.toString();
    p.g(str, "nativePattern.toString()");
    AppMethodBeat.o(129429);
    return str;
  }
  
  @kotlin.l(hxD={1, 1, 16}, hxE={""}, hxF={"Lkotlin/text/Regex$Companion;", "", "()V", "ensureUnicodeCase", "", "flags", "escape", "", "literal", "escapeReplacement", "fromLiteral", "Lkotlin/text/Regex;", "kotlin-stdlib"})
  public static final class a {}
  
  @kotlin.l(hxD={1, 1, 16}, hxE={""}, hxF={"Lkotlin/text/Regex$Serialized;", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "pattern", "", "flags", "", "(Ljava/lang/String;I)V", "getFlags", "()I", "getPattern", "()Ljava/lang/String;", "readResolve", "", "Companion", "kotlin-stdlib"})
    ...
    implements Serializable
  {
    ...
    @kotlin.l(hxD={1, 1, 16}, hxE={""}, hxF={"Lkotlin/text/Regex$Serialized$Companion;", "", "()V", "serialVersionUID", "", "kotlin-stdlib"})
    public static final class a {}
  }
}
