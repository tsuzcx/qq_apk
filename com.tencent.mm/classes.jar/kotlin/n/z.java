  ...
  extends y
{
  public static final char aS(CharSequence paramCharSequence)
  {
    ...
    char c = paramCharSequence.charAt(n.aO(paramCharSequence));
    AppMethodBeat.o(129440);
    return c;
  }
  
  public static final char aT(CharSequence paramCharSequence)
  {
  ...
  public static final String hV(String paramString, int paramInt)
  {
    ...
    paramString = paramString.substring(j.na(paramInt, paramString.length()));
