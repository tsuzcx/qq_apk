  ...
  extends k
{
  ...
  public static final <T> List<T> eR(T paramT)
  {
  ...
  public static final <T> int kq(List<? extends T> paramList)
  {
  ...
  public static final <T> List<T> kr(List<? extends T> paramList)
  {
  ...
  public static final f r(Collection<?> paramCollection)
  {
