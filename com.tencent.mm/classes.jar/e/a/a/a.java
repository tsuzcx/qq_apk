  ...
  extends com.tencent.mm.bw.a
{
  ...
  public final int op(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.LUB != null)
      {
        paramVarArgs.ln(5, this.LUB.computeSize());
    ...
    for (paramInt = f.a.a.b.b.a.e(1, this.LUy) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.LUB != null) {
        i = paramInt + f.a.a.a.lm(5, this.LUB.computeSize());
      }
      paramInt = i;
      if (this.EQP != null) {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          locala.LUy = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91738);
          return 0;
        case 2: 
          locala.LUz = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91738);
          return 0;
        case 3: 
          locala.LUA = ((f.a.a.a.a)localObject1).LVo.xF();
          AppMethodBeat.o(91738);
          return 0;
        case 4: 
          locala.url = ((f.a.a.a.a)localObject1).LVo.readString();
          AppMethodBeat.o(91738);
          return 0;
        case 5: 
          ...
          while (paramInt < i)
          {
            ...
            locala.LUB = ((g)localObject1);
            paramInt += 1;
          }
          AppMethodBeat.o(91738);
          return 0;
        }
        locala.EQP = ((f.a.a.a.a)localObject1).LVo.readString();
        AppMethodBeat.o(91738);
        return 0;
      }
      AppMethodBeat.o(91738);
