...
public final class f
{
  ...
  public f(DartExecutor paramDartExecutor)
  {
    ...
    this.Nbk = new k.c()
    {
      ...
      public final void a(io.flutter.plugin.a.j paramAnonymousj, io.flutter.plugin.a.k.d paramAnonymousd)
      {
        ...
        //   6: aload_0
        //   7: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   10: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        //   13: ifnonnull +10 -> 23
        //   16: sipush 10217
        ...
        //   27: astore 6
        //   29: aload_1
        //   30: getfield 47	io/flutter/plugin/a/j:gtF	Ljava/lang/Object;
        //   33: astore_1
        ...
        //   53: pop
        //   54: invokestatic 65	io/flutter/a:giD	()V
        //   57: iconst_m1
        //   58: istore_3
        //   59: aload 6
        ...
        //   379: invokestatic 110	io/flutter/embedding/engine/c/f$g:bdy	(Ljava/lang/String;)Lio/flutter/embedding/engine/c/f$g;
        //   382: astore_1
        //   383: aload_0
        //   384: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   387: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        //   390: aload_1
        ...
        //   471: invokestatic 141	io/flutter/embedding/engine/c/f$e:bdw	(Ljava/lang/String;)Lio/flutter/embedding/engine/c/f$e;
        //   474: astore_1
        //   475: aload_0
        //   476: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   479: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        //   482: aload_1
        ...
        //   527: invokestatic 150	io/flutter/embedding/engine/c/f:T	(Lorg/json/JSONArray;)I
        //   530: istore_3
        //   531: aload_0
        //   532: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   535: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        //   538: iload_3
        ...
        //   619: astore_1
        //   620: aload_0
        //   621: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   624: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        //   627: aload_1
        ...
        //   672: invokestatic 183	io/flutter/embedding/engine/c/f:U	(Lorg/json/JSONArray;)Ljava/util/List;
        //   675: astore_1
        //   676: aload_0
        //   677: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   680: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        //   683: aload_1
        ...
        //   722: return
        //   723: aload_0
        //   724: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   727: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        ...
        //   772: invokestatic 202	io/flutter/embedding/engine/c/f$b:bdt	(Ljava/lang/String;)Lio/flutter/embedding/engine/c/f$b;
        //   775: astore_1
        //   776: aload 9
        //   778: ldc 204
        ...
        //   815: invokestatic 202	io/flutter/embedding/engine/c/f$b:bdt	(Ljava/lang/String;)Lio/flutter/embedding/engine/c/f$b;
        //   818: astore 7
        //   820: aload 9
        //   822: ldc 214
        ...
        //   880: astore_1
        //   881: aload_0
        //   882: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   885: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        //   888: aload_1
        ...
        //   927: return
        //   928: aload_0
        //   929: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   932: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        ...
        //   953: return
        //   954: aload_0
        //   955: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   958: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        ...
        //   989: aload_2
        //   990: aload_1
        //   991: invokestatic 237	io/flutter/embedding/engine/c/f:jg	(Ljava/util/List;)Ljava/util/ArrayList;
        ...
        //   1035: invokestatic 245	io/flutter/embedding/engine/c/f:S	(Lorg/json/JSONArray;)Ljava/util/ArrayList;
        //   1038: astore_1
        //   1039: aload_0
        //   1040: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   1043: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        //   1046: aload_1
        ...
        //   1077: aload 6
        //   1079: invokestatic 255	io/flutter/embedding/engine/c/f$c:bdu	(Ljava/lang/String;)Lio/flutter/embedding/engine/c/f$c;
        //   1082: astore_1
        //   1083: aload_0
        //   1084: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   1087: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        //   1090: aload_1
        ...
        //   1183: astore_1
        //   1184: aload_0
        //   1185: getfield 14	io/flutter/embedding/engine/c/f$1:Nbl	Lio/flutter/embedding/engine/c/f;
        //   1188: getfield 34	io/flutter/embedding/engine/c/f:Nbj	Lio/flutter/embedding/engine/c/f$f;
        //   1191: aload_1
    ...
    this.vOr = new k(paramDartExecutor, "flutter/platform", g.Nda);
    this.vOr.a(this.Nbk);
    AppMethodBeat.o(10242);
  }
  
  static ArrayList<Rect> S(JSONArray paramJSONArray)
  {
  ...
  public static enum b
  {
    ...
    static
    {
      ...
      Nbo = new b("LIGHT", 0, "Brightness.light");
      Nbp = new b("DARK", 1, "Brightness.dark");
      Nbr = new b[] { Nbo, Nbp };
    ...
    static b bdt(String paramString)
    {
      ...
      {
        b localb = arrayOfb[i];
        if (localb.Nbq.equals(paramString))
        {
  ...
  public static enum d
  {
    ...
    static
    {
      ...
      Nbu = new d("PORTRAIT_UP", 0, "DeviceOrientation.portraitUp");
      Nbv = new d("PORTRAIT_DOWN", 1, "DeviceOrientation.portraitDown");
      Nbw = new d("LANDSCAPE_LEFT", 2, "DeviceOrientation.landscapeLeft");
      Nbx = new d("LANDSCAPE_RIGHT", 3, "DeviceOrientation.landscapeRight");
      Nby = new d[] { Nbu, Nbv, Nbw, Nbx };
    ...
    static d bdv(String paramString)
    {
      ...
      {
        d locald = arrayOfd[i];
        if (locald.Nbq.equals(paramString))
        {
  ...
  public static enum e
  {
    ...
    static
    {
      ...
      Nbz = new e("STANDARD", 0, null);
      NbA = new e("LIGHT_IMPACT", 1, "HapticFeedbackType.lightImpact");
      NbB = new e("MEDIUM_IMPACT", 2, "HapticFeedbackType.mediumImpact");
      NbC = new e("HEAVY_IMPACT", 3, "HapticFeedbackType.heavyImpact");
      NbD = new e("SELECTION_CLICK", 4, "HapticFeedbackType.selectionClick");
      NbE = new e[] { Nbz, NbA, NbB, NbC, NbD };
    ...
    static e bdw(String paramString)
    {
      ...
      {
        e locale = arrayOfe[i];
        if (((locale.Nbq == null) && (paramString == null)) || ((locale.Nbq != null) && (locale.Nbq.equals(paramString))))
        {
  ...
  public static abstract interface f
  {
    ...
    public abstract void bc(ArrayList<Rect> paramArrayList);
    
    public abstract void bdx(String paramString);
    
    public abstract void gjE();
    
    public abstract void gjF();
    
    public abstract List<Rect> gjG();
    
    public abstract void jh(List<f.i> paramList);
  }
  
  public static final class h
  {
    public final Integer NbH;
    public final f.b NbI;
    public final Integer NbJ;
    public final f.b NbK;
    public final Integer NbL;
    
    public h(Integer paramInteger1, f.b paramb1, Integer paramInteger2, f.b paramb2, Integer paramInteger3)
    {
      this.NbH = paramInteger1;
      this.NbI = paramb1;
      this.NbJ = paramInteger2;
      this.NbK = paramb2;
      this.NbL = paramInteger3;
    }
  }
  ...
  public static enum i
  {
    ...
    static
    {
      ...
      NbM = new i("TOP_OVERLAYS", 0, "SystemUiOverlay.top");
      NbN = new i("BOTTOM_OVERLAYS", 1, "SystemUiOverlay.bottom");
      NbO = new i[] { NbM, NbN };
    ...
    static i bdz(String paramString)
    {
      ...
      {
        i locali = arrayOfi[i];
        if (locali.Nbq.equals(paramString))
        {
