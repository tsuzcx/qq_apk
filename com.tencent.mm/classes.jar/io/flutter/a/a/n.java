  ...
  implements i<Object>
{
  ...
  public static final n Jbx;
  private static final boolean Jby;
  ...
  private Object a(byte paramByte, ByteBuffer paramByteBuffer)
  {
    ...
    case 11: 
      for (;;)
      {
        ...
        continue;
        localObject1 = new BigInteger(new String(M(paramByteBuffer), IhR), 16);
        continue;
        f(paramByteBuffer, 8);
        localObject1 = Double.valueOf(paramByteBuffer.getDouble());
        continue;
        localObject1 = new String(M(paramByteBuffer), IhR);
        continue;
  ...
  protected final void a(ByteArrayOutputStream paramByteArrayOutputStream, Object paramObject)
  {
    ...
    if ((paramObject instanceof Number))
    {
      ...
      if ((paramObject instanceof BigInteger))
      {
        ...
        a(paramByteArrayOutputStream, ((BigInteger)paramObject).toString(16).getBytes(IhR));
        AppMethodBeat.o(9859);
        return;
      }
    ...
    if ((paramObject instanceof String))
    {
      ...
      a(paramByteArrayOutputStream, ((String)paramObject).getBytes(IhR));
      AppMethodBeat.o(9859);
      return;
    }
 ...
 * Qualified Name:     io.flutter.a.a.n
