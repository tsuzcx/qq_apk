  ...
  extends bn
{
  ...
  static
  {
    ...
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        continue;
        Integer localInteger = n.bHC((String)localObject);
  ...
  private static boolean a(Class<?> paramClass, ExecutorService paramExecutorService)
  {
    ...
    paramExecutorService.submit((Runnable)v.b.abwr);
    try
    {
  ...
  private static int iQW()
  {
    AppMethodBeat.i(118251);
    Integer localInteger = Integer.valueOf(abwn);
    ...
    label54:
    int i = i.ov(Runtime.getRuntime().availableProcessors() - 1, 1);
    AppMethodBeat.o(118251);
    return i;
  }
  
  private static ExecutorService iQX()
  {
    AppMethodBeat.i(118252);
    ExecutorService localExecutorService1;
    if (System.getSecurityManager() != null)
    {
      localExecutorService1 = iQY();
    ...
    catch (Throwable localThrowable1)
    {
      ...
      {
        label141:
        localObject3 = ((Class)localObject3).getConstructor(new Class[] { Integer.TYPE }).newInstance(new Object[] { Integer.valueOf(iQW()) });
      ...
      catch (Throwable localThrowable3)
      {
        ...
        ExecutorService localExecutorService2 = iQY();
        AppMethodBeat.o(118252);
  ...
  private static ExecutorService iQY()
  {
    AppMethodBeat.i(118254);
    Object localObject = new AtomicInteger();
    localObject = Executors.newFixedThreadPool(iQW(), (ThreadFactory)new a((AtomicInteger)localObject));
    AppMethodBeat.o(118254);
    return localObject;
  }
  
  private final Executor iQZ()
  {
    try
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramf == null)
        {
          ...
          Runnable localRunnable = ((cw)localObject).iSa();
  ...
  @l(iBK={1, 1, 16}, iBL={""}, iBM={"<anonymous>", "Ljava/lang/Thread;", "it", "Ljava/lang/Runnable;", "kotlin.jvm.PlatformType", "newThread"})
    ...
    implements ThreadFactory
  {
    ...
    public final Thread newThread(Runnable paramRunnable)
    {
      ...
      paramRunnable = new Thread(paramRunnable, "CommonPool-worker-" + this.abwq.incrementAndGet());
