...
{
  public d$c(Constructor paramConstructor)
  {
    super(1);
  }
  ...
  private Throwable D(Throwable paramThrowable)
  {
    ...
    {
      localObject = p.KTg;
      localObject = this.LSG.newInstance(new Object[] { paramThrowable.getMessage() });
      if (localObject == null)
      {
 ...
 * Qualified Name:     kotlinx.coroutines.internal.d.c
