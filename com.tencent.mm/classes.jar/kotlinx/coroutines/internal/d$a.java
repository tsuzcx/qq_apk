...
{
  public d$a(Constructor paramConstructor)
  {
    super(1);
  }
  ...
  private Throwable D(Throwable paramThrowable)
  {
    ...
    {
      localObject = p.KTg;
      paramThrowable = this.LSG.newInstance(new Object[] { paramThrowable.getMessage(), paramThrowable });
 ...
 * Qualified Name:     kotlinx.coroutines.internal.d.a
