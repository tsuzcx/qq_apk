...
@l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lkotlinx/coroutines/internal/FastServiceLoader;", "", "()V", "PREFIX", "", "createInstanceOf", "Lkotlinx/coroutines/internal/MainDispatcherFactory;", "baseClass", "Ljava/lang/Class;", "serviceClass", "getProviderInstance", "S", "name", "loader", "Ljava/lang/ClassLoader;", "service", "(Ljava/lang/String;Ljava/lang/ClassLoader;Ljava/lang/Class;)Ljava/lang/Object;", "load", "", "loadMainDispatcherFactory", "loadMainDispatcherFactory$kotlinx_coroutines_core", "loadProviders", "loadProviders$kotlinx_coroutines_core", "parse", "url", "Ljava/net/URL;", "parseFile", "r", "Ljava/io/BufferedReader;", "use", "R", "Ljava/util/jar/JarFile;", "block", "Lkotlin/Function1;", "(Ljava/util/jar/JarFile;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;", "kotlinx-coroutines-core"})
public final class e
{
  public static final e LSJ;
  ...
  private static <S> List<S> a(Class<S> paramClass, ClassLoader paramClassLoader)
  {
    ...
    try
    {
      ...
      k.g(localObject1, "java.util.Collections.list(this)");
  ...
  private static List<String> f(URL paramURL)
  {
    ...
    //   15: aload_3
    //   16: ldc_w 270
    //   19: invokestatic 274	d/n/n:nb	(Ljava/lang/String;Ljava/lang/String;)Z
    //   22: ifeq +179 -> 201
    //   25: aload_3
    //   26: ldc_w 276
    //   29: invokestatic 279	d/n/n:nf	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   32: bipush 33
    //   34: invokestatic 282	d/n/n:a	(Ljava/lang/String;C)Ljava/lang/String;
    //   37: astore_0
    //   38: aload_3
    //   39: ldc_w 284
    //   42: invokestatic 279	d/n/n:nf	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   45: astore_1
    ...
    //   98: invokestatic 312	kotlinx/coroutines/internal/e:b	(Ljava/io/BufferedReader;)Ljava/util/List;
    //   101: astore_0
    //   102: aload 4
    //   104: aconst_null
    ...
    //   230: invokestatic 312	kotlinx/coroutines/internal/e:b	(Ljava/io/BufferedReader;)Ljava/util/List;
    //   233: astore_0
    //   234: aload_2
    //   235: aconst_null
  ...
  public static List<MainDispatcherFactory> gex()
  {
