...
{
  public j$a(Constructor paramConstructor)
  {
    super(1);
  }
  ...
  private Throwable aa(Throwable paramThrowable)
  {
    ...
    try
    {
      ...
      paramThrowable = this.ajAr.newInstance(new Object[] { paramThrowable.getMessage(), paramThrowable });
 ...
 * Qualified Name:     kotlinx.coroutines.internal.j.a
