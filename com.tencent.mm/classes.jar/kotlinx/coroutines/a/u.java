...
@l(fvt={1, 1, 16}, fvu={""}, fvv={"Lkotlinx/coroutines/internal/FastServiceLoader;", "", "()V", "PREFIX", "", "createInstanceOf", "Lkotlinx/coroutines/internal/MainDispatcherFactory;", "baseClass", "Ljava/lang/Class;", "serviceClass", "getProviderInstance", "S", "name", "loader", "Ljava/lang/ClassLoader;", "service", "(Ljava/lang/String;Ljava/lang/ClassLoader;Ljava/lang/Class;)Ljava/lang/Object;", "load", "", "loadMainDispatcherFactory", "loadMainDispatcherFactory$kotlinx_coroutines_core", "loadProviders", "loadProviders$kotlinx_coroutines_core", "parse", "url", "Ljava/net/URL;", "parseFile", "r", "Ljava/io/BufferedReader;", "use", "R", "Ljava/util/jar/JarFile;", "block", "Lkotlin/Function1;", "(Ljava/util/jar/JarFile;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;", "kotlinx-coroutines-core"})
public final class u
{
  public static final u LEC;
  ...
  private static <S> List<S> a(Class<S> paramClass, ClassLoader paramClassLoader)
  {
    ...
    {
      paramClass = j.m((Iterable)ServiceLoader.load(paramClass, paramClassLoader));
    }
    return paramClass;
    Object localObject2 = j.o((Iterable)localThrowable);
  ...
  private static List<String> b(BufferedReader paramBufferedReader)
  {
    ...
    for (;;)
    {
      ...
      if (str == null)
      {
        paramBufferedReader = j.m((Iterable)localSet);
      ...
      if (str == null)
      {
        paramBufferedReader = new d.v("null cannot be cast to non-null type kotlin.CharSequence");
        AppMethodBeat.o(202349);
  ...
  private static List<String> f(URL paramURL)
  {
    ...
    //   15: aload_3
    //   16: ldc_w 269
    //   19: invokestatic 273	d/n/n:mA	(Ljava/lang/String;Ljava/lang/String;)Z
    //   22: ifeq +179 -> 201
    //   25: aload_3
    //   26: ldc_w 275
    //   29: invokestatic 278	d/n/n:mF	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   32: bipush 33
    //   34: invokestatic 281	d/n/n:b	(Ljava/lang/String;C)Ljava/lang/String;
    //   37: astore_0
    //   38: aload_3
    //   39: ldc_w 283
    //   42: invokestatic 278	d/n/n:mF	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   45: astore_1
    //   46: new 285	java/util/jar/JarFile
    //   49: dup
    //   50: aload_0
    //   51: iconst_0
    //   52: invokespecial 288	java/util/jar/JarFile:<init>	(Ljava/lang/String;Z)V
    //   55: astore_3
    //   56: new 217	java/io/BufferedReader
    //   59: dup
    //   60: new 290	java/io/InputStreamReader
    //   63: dup
    //   64: aload_3
    //   65: new 292	java/util/zip/ZipEntry
    //   68: dup
    //   69: aload_1
    //   70: invokespecial 293	java/util/zip/ZipEntry:<init>	(Ljava/lang/String;)V
    //   73: invokevirtual 297	java/util/jar/JarFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   76: ldc_w 299
    //   79: invokespecial 302	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   82: checkcast 304	java/io/Reader
    //   85: invokespecial 307	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   88: checkcast 309	java/io/Closeable
    //   91: astore 4
    //   93: aload 4
    //   95: checkcast 217	java/io/BufferedReader
    //   98: invokestatic 311	kotlinx/coroutines/a/u:b	(Ljava/io/BufferedReader;)Ljava/util/List;
    //   101: astore_0
    //   102: aload 4
    //   104: aconst_null
    //   105: invokestatic 316	d/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   108: aload_3
    //   109: invokevirtual 319	java/util/jar/JarFile:close	()V
    //   112: ldc_w 266
    ...
    //   139: aload 4
    //   141: aload_1
    //   142: invokestatic 316	d/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   145: ldc_w 266
    ...
    //   162: astore_1
    //   163: aload_3
    //   164: invokevirtual 319	java/util/jar/JarFile:close	()V
    //   167: ldc_w 266
    ...
    //   188: aload_0
    //   189: aload_1
    //   190: invokestatic 324	d/a:a	(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    //   193: ldc_w 266
    //   196: invokestatic 63	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   199: aload_0
    //   200: athrow
    //   201: new 217	java/io/BufferedReader
    //   204: dup
    //   205: new 290	java/io/InputStreamReader
    //   208: dup
    //   209: aload_0
    //   210: invokevirtual 328	java/net/URL:openStream	()Ljava/io/InputStream;
    //   213: invokespecial 331	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   216: checkcast 304	java/io/Reader
    //   219: invokespecial 307	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   222: checkcast 309	java/io/Closeable
    //   225: astore_2
    //   226: aload_2
    //   227: checkcast 217	java/io/BufferedReader
    //   230: invokestatic 311	kotlinx/coroutines/a/u:b	(Ljava/io/BufferedReader;)Ljava/util/List;
    //   233: astore_0
    //   234: aload_2
    //   235: aconst_null
    //   236: invokestatic 316	d/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   239: ldc_w 266
    ...
    //   257: aload_2
    //   258: aload_1
    //   259: invokestatic 316	d/f/b:a	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   262: ldc_w 266
  ...
  public static List<MainDispatcherFactory> gaI()
  {
