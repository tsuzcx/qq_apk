  ...
  extends a<Element, Collection, Builder>
{
  ...
  {
    p.h(parama, "decoder");
    a(paramBuilder, paramInt, parama.a(fWv(), paramInt, (f)this.TYy));
  }
  
  public void a(g paramg, Collection paramCollection)
  {
    p.h(paramg, "encoder");
    int j = gj(paramCollection);
    n localn = fWv();
    h[] arrayOfh = this.TYx;
    ...
    while (i < j)
    {
      paramg.a(fWv(), i, (v)this.TYy, paramCollection.next());
      i += 1;
    }
    paramg.a(fWv());
  }
