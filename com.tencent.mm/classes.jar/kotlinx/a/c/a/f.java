...
public final class f
{
  ...
  private final void be(String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      char[] arrayOfChar = Arrays.copyOf(this.buf, h.lp(paramInt2, this.buf.length * 2));
      p.g(arrayOfChar, "java.util.Arrays.copyOf(this, newSize)");
      this.buf = arrayOfChar;
    }
    paramInt2 = 0;
  ...
  private final void ht(String paramString, int paramInt)
  {
  ...
  private final int hu(String paramString, int paramInt)
  {
    int j = 1;
    ...
    for (int i = 1; i == 0; i = 0)
    {
      hw("Unexpected EOF after escape character", paramInt);
  ...
  private final int hv(String paramString, int paramInt)
  {
    AppMethodBeat.i(191308);
    int j = paramInt + 1;
    paramInt = hx(paramString, paramInt);
    int i = j + 1;
    j = hx(paramString, j);
    int k = i + 1;
    append((char)((j << 8) + (paramInt << 12) + (hx(paramString, i) << 4) + hx(paramString, k)));
    AppMethodBeat.o(191308);
    return k + 1;
  }
  
  private final int hx(String paramString, int paramInt)
  {
    AppMethodBeat.i(191313);
    if (paramInt < paramString.length()) {}
    for (int i = 1; i == 0; i = 0)
    {
      hw("Unexpected EOF during unicode escape", paramInt);
  ...
  public final String gxq()
  {
    ...
    if ((this.NOi != 0) && (this.NOi != 1))
    {
      hw("Expected string or non-null literal", this.NOj);
  ...
  public final String gxr()
  {
    ...
    if (this.NOi != 1)
    {
      hw("Expected string literal with quotes. Use 'JsonConfiguration.isLenient = true' to accept non-compliant JSON", this.NOj);
  ...
  public final void gxu()
  {
    ...
    for (int i = 1; i == 0; i = 0)
    {
      AppMethodBeat.o(191309);
      return;
      ((List)localObject).add(Byte.valueOf(this.NOi));
      break label80;
      if (((Number)j.je((List)localObject)).byteValue() != 8)
      {
        localObject = (Throwable)kotlinx.a.c.l.ac(this.vty, "found ] instead of }", this.source);
        AppMethodBeat.o(191309);
        throw ((Throwable)localObject);
      }
      ((List)localObject).remove(((List)localObject).size() - 1);
      break label80;
      if (((Number)j.je((List)localObject)).byteValue() != 6)
      {
        localObject = (Throwable)kotlinx.a.c.l.ac(this.vty, "found } instead of ]", this.source);
        AppMethodBeat.o(191309);
        throw ((Throwable)localObject);
  ...
  public final String toString()
  {
    ...
    String str = "JsonReader(source='" + this.source + "', currentPosition=" + this.vty + ", tokenClass=" + this.NOi + ", tokenPosition=" + this.NOj + ", offset=" + this.offset + ')';
