  ...
  extends a<E>
{
  ...
  final AtomicLong Ksa;
  final AtomicLong Ksb;
  ...
  public c(int paramInt)
  {
    ...
    this.Ksa = new AtomicLong();
    this.Ksb = new AtomicLong();
  ...
  public final boolean offer(E paramE)
  {
    ...
    AtomicReferenceArray localAtomicReferenceArray = this.Kgy;
    int i = this.mask;
    long l = this.Ksa.get();
    int j = (int)l & i;
  ...
  public final E peek()
  {
    ...
    Object localObject = agt(xV(this.Ksb.get()));
  ...
  public final int size()
  {
    ...
    long l2;
    for (long l1 = this.Ksb.get();; l1 = l2)
    {
      long l3 = this.Ksa.get();
      l2 = this.Ksb.get();
      if (l1 == l2)
      {
        int i = (int)(l3 - l2);
