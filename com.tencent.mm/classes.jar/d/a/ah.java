...
@l(gjZ={1, 1, 16}, gka={""}, gkb={"buildMap", "", "K", "V", "capacity", "", "builderAction", "Lkotlin/Function1;", "", "", "Lkotlin/ExtensionFunctionType;", "emptyMap", "hashMapOf", "Ljava/util/HashMap;", "Lkotlin/collections/HashMap;", "pairs", "", "Lkotlin/Pair;", "([Lkotlin/Pair;)Ljava/util/HashMap;", "linkedMapOf", "Ljava/util/LinkedHashMap;", "Lkotlin/collections/LinkedHashMap;", "([Lkotlin/Pair;)Ljava/util/LinkedHashMap;", "mapOf", "([Lkotlin/Pair;)Ljava/util/Map;", "mutableMapOf", "component1", "", "(Ljava/util/Map$Entry;)Ljava/lang/Object;", "component2", "contains", "", "Lkotlin/internal/OnlyInputTypes;", "key", "(Ljava/util/Map;Ljava/lang/Object;)Z", "containsKey", "containsValue", "value", "filter", "predicate", "filterKeys", "filterNot", "filterNotTo", "M", "destination", "(Ljava/util/Map;Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map;", "filterTo", "filterValues", "get", "(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;", "getOrElse", "defaultValue", "Lkotlin/Function0;", "(Ljava/util/Map;Ljava/lang/Object;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;", "getOrElseNullable", "getOrPut", "getValue", "ifEmpty", "R", "(Ljava/util/Map;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;", "isNotEmpty", "isNullOrEmpty", "iterator", "", "", "", "mutableIterator", "mapKeys", "transform", "mapKeysTo", "mapValues", "mapValuesTo", "minus", "(Ljava/util/Map;Ljava/lang/Object;)Ljava/util/Map;", "keys", "(Ljava/util/Map;[Ljava/lang/Object;)Ljava/util/Map;", "", "Lkotlin/sequences/Sequence;", "minusAssign", "(Ljava/util/Map;Ljava/lang/Object;)V", "(Ljava/util/Map;[Ljava/lang/Object;)V", "optimizeReadOnlyMap", "orEmpty", "plus", "(Ljava/util/Map;[Lkotlin/Pair;)Ljava/util/Map;", "pair", "map", "plusAssign", "(Ljava/util/Map;[Lkotlin/Pair;)V", "putAll", "remove", "set", "(Ljava/util/Map;Ljava/lang/Object;Ljava/lang/Object;)V", "toMap", "([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;", "(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;", "(Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;", "(Lkotlin/sequences/Sequence;Ljava/util/Map;)Ljava/util/Map;", "toMutableMap", "toPair", "kotlin-stdlib"}, gkc=1)
public class ah
  extends ag
{
  public static final <K, V> Map<K, V> A(Iterable<? extends o<? extends K, ? extends V>> paramIterable)
  {
    ...
    if ((paramIterable instanceof Collection))
    {
      ...
      {
      default: 
        paramIterable = ae.a(paramIterable, (Map)new LinkedHashMap(ae.ajS(((Collection)paramIterable).size())));
    ...
    paramIterable = ae.ci(ae.a(paramIterable, (Map)new LinkedHashMap()));
    AppMethodBeat.o(129022);
    return paramIterable;
  }
  ...
  public static final <K, V> Map<K, V> a(o<? extends K, ? extends V>... paramVarArgs)
  {
    ...
    {
      paramVarArgs = ae.a(paramVarArgs, (Map)new LinkedHashMap(ae.ajS(paramVarArgs.length)));
  ...
  public static final <K, V> Map<K, V> b(o<? extends K, ? extends V>... paramVarArgs)
  {
    ...
    p.h(paramVarArgs, "pairs");
    LinkedHashMap localLinkedHashMap = new LinkedHashMap(ae.ajS(paramVarArgs.length));
  ...
  public static final <K, V> HashMap<K, V> c(o<? extends K, ? extends V>... paramVarArgs)
  {
    ...
    p.h(paramVarArgs, "pairs");
    HashMap localHashMap = new HashMap(ae.ajS(paramVarArgs.length));
    ae.a((Map)localHashMap, paramVarArgs);
    AppMethodBeat.o(177352);
    return localHashMap;
  }
  
  public static final <K, V> Map<K, V> ci(Map<K, ? extends V> paramMap)
  {
