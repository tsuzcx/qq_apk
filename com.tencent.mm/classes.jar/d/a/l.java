  ...
  extends k
{
  ...
  public static final <T> List<T> eP(T paramT)
  {
  ...
  public static final <T> int jj(List<? extends T> paramList)
  {
  ...
  public static final <T> List<T> jk(List<? extends T> paramList)
  {
  ...
  public static final f o(Collection<?> paramCollection)
  {
    AppMethodBeat.i(129044);
    p.h(paramCollection, "$this$indices");
    paramCollection = new f(0, paramCollection.size() - 1);
