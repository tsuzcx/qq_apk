  ...
  extends h
{
  ...
  public static final int O(int[] paramArrayOfInt)
  {
    AppMethodBeat.i(129090);
    k.h(paramArrayOfInt, "$this$lastIndex");
  ...
  public static final <T> T O(T[] paramArrayOfT)
  {
    ...
    k.h(paramArrayOfT, "$this$firstOrNull");
    if (paramArrayOfT.length == 0) {}
    for (int i = 1; i != 0; i = 0)
    {
  ...
  public static final <T> T P(T[] paramArrayOfT)
  {
    ...
    paramArrayOfT = paramArrayOfT[e.S(paramArrayOfT)];
    AppMethodBeat.o(129084);
    return paramArrayOfT;
  }
  
  public static final List<Integer> P(int[] paramArrayOfInt)
  {
    AppMethodBeat.i(129096);
    k.h(paramArrayOfInt, "$this$toList");
    switch (paramArrayOfInt.length)
    {
    default: 
      paramArrayOfInt = e.Q(paramArrayOfInt);
      AppMethodBeat.o(129096);
      return paramArrayOfInt;
    case 0: 
      paramArrayOfInt = (List)v.Jgl;
      AppMethodBeat.o(129096);
      return paramArrayOfInt;
    }
  ...
  public static final List<Integer> Q(int[] paramArrayOfInt)
  {
    AppMethodBeat.i(129103);
    k.h(paramArrayOfInt, "$this$toMutableList");
  ...
  public static final <T> List<T> R(T[] paramArrayOfT)
  {
    ...
    k.h(paramArrayOfT, "$this$take");
    if (20 >= paramArrayOfT.length)
    {
      paramArrayOfT = e.T(paramArrayOfT);
  ...
  public static final <T> int S(T[] paramArrayOfT)
  {
    AppMethodBeat.i(129089);
    k.h(paramArrayOfT, "$this$lastIndex");
    int i = paramArrayOfT.length;
    AppMethodBeat.o(129089);
    return i - 1;
  }
  
  public static final <T> List<T> T(T[] paramArrayOfT)
  {
    AppMethodBeat.i(129093);
    k.h(paramArrayOfT, "$this$toList");
    switch (paramArrayOfT.length)
    {
    default: 
      paramArrayOfT = e.U(paramArrayOfT);
      AppMethodBeat.o(129093);
      return paramArrayOfT;
    case 0: 
      paramArrayOfT = (List)v.Jgl;
      AppMethodBeat.o(129093);
      return paramArrayOfT;
    }
  ...
  public static final <T> List<T> U(T[] paramArrayOfT)
  {
    ...
    k.h(paramArrayOfT, "$this$toMutableList");
    paramArrayOfT = (List)new ArrayList(j.Y(paramArrayOfT));
    AppMethodBeat.o(129102);
    return paramArrayOfT;
  }
  
  public static final <T> Set<T> V(T[] paramArrayOfT)
  {
    AppMethodBeat.i(129104);
    k.h(paramArrayOfT, "$this$toSet");
    switch (paramArrayOfT.length)
    {
    default: 
      paramArrayOfT = (Set)e.b(paramArrayOfT, (Collection)new LinkedHashSet(ae.adL(paramArrayOfT.length)));
      AppMethodBeat.o(129104);
      return paramArrayOfT;
    case 0: 
      paramArrayOfT = (Set)x.Jgn;
      AppMethodBeat.o(129104);
      return paramArrayOfT;
    }
  ...
  public static final <T> Iterable<y<T>> W(T[] paramArrayOfT)
  {
    AppMethodBeat.i(129106);
    k.h(paramArrayOfT, "$this$withIndex");
    paramArrayOfT = (Iterable)new z((a)new b(paramArrayOfT));
    AppMethodBeat.o(129106);
    return paramArrayOfT;
  }
  
  public static final <T> d.m.h<T> X(T[] paramArrayOfT)
  {
    AppMethodBeat.i(129113);
    k.h(paramArrayOfT, "$this$asSequence");
    if (paramArrayOfT.length == 0) {}
    for (int i = 1; i != 0; i = 0)
    {
      paramArrayOfT = (d.m.h)d.Kcf;
      AppMethodBeat.o(129113);
      return paramArrayOfT;
    }
    paramArrayOfT = (d.m.h)new a(paramArrayOfT);
    AppMethodBeat.o(129113);
    return paramArrayOfT;
  }
  
  public static final <A extends Appendable> A a(byte[] paramArrayOfByte, A paramA, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, CharSequence paramCharSequence4, d.g.a.b<? super Byte, ? extends CharSequence> paramb)
  {
    AppMethodBeat.i(129108);
    k.h(paramArrayOfByte, "$this$joinTo");
    k.h(paramA, "buffer");
    ...
    if (i < k)
    {
      ...
      if (paramb != null) {
        paramA.append((CharSequence)paramb.aA(Byte.valueOf(b)));
      }
      for (;;)
      {
        i += 1;
  ...
  public static final <T, A extends Appendable> A a(T[] paramArrayOfT, A paramA, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, int paramInt, CharSequence paramCharSequence4, d.g.a.b<? super T, ? extends CharSequence> paramb)
  {
    AppMethodBeat.i(129107);
    k.h(paramArrayOfT, "$this$joinTo");
    k.h(paramA, "buffer");
    k.h(paramCharSequence1, "separator");
    k.h(paramCharSequence2, "prefix");
    k.h(paramCharSequence3, "postfix");
  ...
  public static final String a(byte[] paramArrayOfByte, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, CharSequence paramCharSequence4, d.g.a.b<? super Byte, ? extends CharSequence> paramb)
  {
    AppMethodBeat.i(129111);
    k.h(paramArrayOfByte, "$this$joinToString");
    k.h(paramCharSequence1, "separator");
    k.h(paramCharSequence2, "prefix");
    k.h(paramCharSequence3, "postfix");
    k.h(paramCharSequence4, "truncated");
    paramArrayOfByte = ((StringBuilder)e.a(paramArrayOfByte, (Appendable)new StringBuilder(), paramCharSequence1, paramCharSequence2, paramCharSequence3, paramCharSequence4, paramb)).toString();
    k.g(paramArrayOfByte, "joinTo(StringBuilder(), …ed, transform).toString()");
    AppMethodBeat.o(129111);
    return paramArrayOfByte;
  }
  
  public static final <T> String a(T[] paramArrayOfT, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, int paramInt, CharSequence paramCharSequence4, d.g.a.b<? super T, ? extends CharSequence> paramb)
  {
    AppMethodBeat.i(129109);
    k.h(paramArrayOfT, "$this$joinToString");
    k.h(paramCharSequence1, "separator");
    k.h(paramCharSequence2, "prefix");
    k.h(paramCharSequence3, "postfix");
    k.h(paramCharSequence4, "truncated");
    ...
    k.g(paramArrayOfT, "joinTo(StringBuilder(), …ed, transform).toString()");
  ...
  public static final <C extends Collection<? super T>, T> C a(T[] paramArrayOfT, C paramC)
  {
    ...
    k.h(paramArrayOfT, "$this$filterNotNullTo");
  ...
  public static final <T, R> List<R> a(T[] paramArrayOfT, d.g.a.b<? super T, ? extends R> paramb)
  {
    AppMethodBeat.i(129105);
    k.h(paramArrayOfT, "$this$map");
    ...
    while (i < j)
    {
      localCollection.add(paramb.aA(paramArrayOfT[i]));
      i += 1;
    }
  ...
  public static final <T, C extends Collection<? super T>> C b(T[] paramArrayOfT, C paramC)
  {
    ...
    k.h(paramArrayOfT, "$this$toCollection");
    k.h(paramC, "destination");
    int j = paramArrayOfT.length;
    int i = 0;
    while (i < j)
  ...
  public static final <T> List<T> b(T[] paramArrayOfT, Comparator<? super T> paramComparator)
  {
    ...
    k.h(paramArrayOfT, "$this$sortedWith");
    k.h(paramComparator, "comparator");
    k.h(paramArrayOfT, "$this$sortedArrayWith");
    k.h(paramComparator, "comparator");
    int i;
    if (paramArrayOfT.length == 0)
    {
    ...
    for (;;)
    {
      ...
      k.g(paramArrayOfT, "java.util.Arrays.copyOf(this, size)");
  ...
  public static final List<Short> b(short[] paramArrayOfShort)
  {
    ...
    k.h(paramArrayOfShort, "$this$toList");
    ArrayList localArrayList;
    int j;
    switch (paramArrayOfShort.length)
    {
    default: 
      k.h(paramArrayOfShort, "$this$toMutableList");
  ...
  public static final float[] b(Float[] paramArrayOfFloat)
  {
    ...
    k.h(paramArrayOfFloat, "$this$toFloatArray");
  ...
  public static final char c(char[] paramArrayOfChar)
  {
    ...
    k.h(paramArrayOfChar, "$this$single");
  ...
  public static final List<Byte> cQ(byte[] paramArrayOfByte)
  {
    int i = 0;
    AppMethodBeat.i(129094);
    k.h(paramArrayOfByte, "$this$toList");
    ArrayList localArrayList;
    int j;
    switch (paramArrayOfByte.length)
    {
    default: 
      k.h(paramArrayOfByte, "$this$toMutableList");
  ...
  public static final boolean contains(char[] paramArrayOfChar, char paramChar)
  {
    ...
    k.h(paramArrayOfChar, "$this$contains");
    k.h(paramArrayOfChar, "$this$indexOf");
  ...
  public static final boolean contains(int[] paramArrayOfInt, int paramInt)
  {
    ...
    k.h(paramArrayOfInt, "$this$contains");
  ...
  public static final <T> boolean contains(T[] paramArrayOfT, T paramT)
  {
    ...
    k.h(paramArrayOfT, "$this$contains");
  ...
  public static final List<Character> d(char[] paramArrayOfChar)
  {
    ...
    k.h(paramArrayOfChar, "$this$toList");
    ArrayList localArrayList;
    int j;
    switch (paramArrayOfChar.length)
    {
    default: 
      k.h(paramArrayOfChar, "$this$toMutableList");
  ...
  public static final List<Double> d(double[] paramArrayOfDouble)
  {
    ...
    k.h(paramArrayOfDouble, "$this$toList");
    ArrayList localArrayList;
    int j;
    switch (paramArrayOfDouble.length)
    {
    default: 
      k.h(paramArrayOfDouble, "$this$toMutableList");
  ...
  public static final List<Boolean> d(boolean[] paramArrayOfBoolean)
  {
    int i = 0;
    AppMethodBeat.i(129100);
    k.h(paramArrayOfBoolean, "$this$toList");
    ArrayList localArrayList;
    int j;
    switch (paramArrayOfBoolean.length)
    {
    default: 
      k.h(paramArrayOfBoolean, "$this$toMutableList");
    ...
    while (i < j)
    {
      ...
      i += 1;
      continue;
      paramArrayOfBoolean = (List)v.Jgl;
  ...
  public static final <T> T f(T[] paramArrayOfT, int paramInt)
  {
    ...
    k.h(paramArrayOfT, "$this$getOrNull");
    if ((paramInt >= 0) && (paramInt <= e.S(paramArrayOfT)))
    {
  ...
  public static final List<Long> f(long[] paramArrayOfLong)
  {
    int i = 0;
    AppMethodBeat.i(129097);
    k.h(paramArrayOfLong, "$this$toList");
    ArrayList localArrayList;
    int j;
    switch (paramArrayOfLong.length)
    {
    default: 
      k.h(paramArrayOfLong, "$this$toMutableList");
  ...
  public static final <T> int indexOf(T[] paramArrayOfT, T paramT)
  {
    ...
    k.h(paramArrayOfT, "$this$indexOf");
    if (paramT == null)
    {
  ...
  public static final Integer j(int[] paramArrayOfInt, int paramInt)
  {
    ...
    k.h(paramArrayOfInt, "$this$getOrNull");
    if ((paramInt >= 0) && (paramInt <= e.O(paramArrayOfInt)))
    {
  ...
  public static final int k(int[] paramArrayOfInt, int paramInt)
  {
    ...
    k.h(paramArrayOfInt, "$this$indexOf");
    int i = 0;
    int j = paramArrayOfInt.length;
    while (i < j)
    {
  ...
  public static final List<Float> s(float[] paramArrayOfFloat)
  {
    ...
    k.h(paramArrayOfFloat, "$this$toList");
  ...
  public static final List<Float> t(float[] paramArrayOfFloat)
  {
    ...
    k.h(paramArrayOfFloat, "$this$toMutableList");
    ...
    implements d.m.h<T>
  {
    ...
    public final Iterator<T> iterator()
    {
      ...
      Iterator localIterator = d.g.b.b.ab(this.Jgf);
