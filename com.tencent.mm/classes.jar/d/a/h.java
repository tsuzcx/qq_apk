  ...
  extends g
{
  public static final List<Integer> N(int[] paramArrayOfInt)
  {
    ...
    k.h(paramArrayOfInt, "$this$asList");
  ...
  public static final <T> void a(T[] paramArrayOfT, Comparator<? super T> paramComparator)
  {
    ...
    k.h(paramArrayOfT, "$this$sortWith");
  ...
  public static final <T> List<T> asList(T[] paramArrayOfT)
  {
    ...
    k.h(paramArrayOfT, "$this$asList");
    paramArrayOfT = Arrays.asList(paramArrayOfT);
    k.g(paramArrayOfT, "ArraysUtilJVM.asList(this)");
  ...
  public static final <T> T[] copyOfRange(T[] paramArrayOfT, int paramInt1, int paramInt2)
  {
    ...
    k.h(paramArrayOfT, "$this$copyOfRangeImpl");
    ...
    k.g(paramArrayOfT, "java.util.Arrays.copyOfR…this, fromIndex, toIndex)");
    AppMethodBeat.o(129132);
    return paramArrayOfT;
  }
  ...
  @l(fNY={1, 1, 16}, fNZ={""}, fOa={"kotlin/collections/ArraysKt___ArraysJvmKt$asList$3", "Lkotlin/collections/AbstractList;", "", "Ljava/util/RandomAccess;", "Lkotlin/collections/RandomAccess;", "size", "getSize", "()I", "contains", "", "element", "get", "index", "(I)Ljava/lang/Integer;", "indexOf", "isEmpty", "lastIndexOf", "kotlin-stdlib"})
    ...
    implements RandomAccess
  {
    ...
    public final boolean contains(Object paramObject)
    {
      ...
      boolean bool = e.contains(this.KTy, i);
      AppMethodBeat.o(129237);
      return bool;
    }
    ...
    public final int lastIndexOf(Object paramObject)
    {
      ...
      paramObject = this.KTy;
      k.h(paramObject, "$this$lastIndexOf");
