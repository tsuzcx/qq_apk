  ...
  extends m
{
  ...
  public static final <T, A extends Appendable> A a(h<? extends T> paramh, A paramA, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, CharSequence paramCharSequence4)
  {
    ...
    d.g.b.p.h(paramh, "$this$joinTo");
    d.g.b.p.h(paramA, "buffer");
    d.g.b.p.h(paramCharSequence1, "separator");
    d.g.b.p.h(paramCharSequence2, "prefix");
    d.g.b.p.h(paramCharSequence3, "postfix");
    d.g.b.p.h(paramCharSequence4, "truncated");
  ...
  public static final <T, C extends Collection<? super T>> C a(h<? extends T> paramh, C paramC)
  {
    ...
    d.g.b.p.h(paramh, "$this$toCollection");
    d.g.b.p.h(paramC, "destination");
    paramh = paramh.iterator();
    while (paramh.hasNext()) {
  ...
  public static final <T> h<T> b(h<? extends T> paramh)
  {
    ...
    d.g.b.p.h(paramh, "$this$filterNotNull");
    paramh = i.b(paramh, (b)b.NGO);
  ...
  public static final <T> h<T> b(h<? extends T> paramh, b<? super T, Boolean> paramb)
  {
    ...
    d.g.b.p.h(paramh, "$this$filterNot");
    d.g.b.p.h(paramb, "predicate");
  ...
  public static final <T, R> h<R> c(h<? extends T> paramh, b<? super T, ? extends h<? extends R>> paramb)
  {
    ...
    d.g.b.p.h(paramh, "$this$flatMap");
    d.g.b.p.h(paramb, "transform");
    paramh = (h)new f(paramh, paramb, (b)c.NGP);
  ...
  public static final <T> List<T> c(h<? extends T> paramh)
  {
    ...
    d.g.b.p.h(paramh, "$this$toList");
    paramh = j.jb(i.d(paramh));
  ...
  public static final <T> List<T> d(h<? extends T> paramh)
  {
    ...
    d.g.b.p.h(paramh, "$this$toMutableList");
  ...
  public static final <T, R> h<R> e(h<? extends T> paramh, b<? super T, ? extends R> paramb)
  {
    ...
    d.g.b.p.h(paramh, "$this$mapNotNull");
    d.g.b.p.h(paramb, "transform");
  ...
  public static final <T> Iterable<T> f(h<? extends T> paramh)
  {
    ...
    d.g.b.p.h(paramh, "$this$asIterable");
    paramh = (Iterable)new a(paramh);
    AppMethodBeat.o(129519);
    return paramh;
  }
  
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"kotlin/collections/CollectionsKt__IterablesKt$Iterable$1", "", "iterator", "", "kotlin-stdlib"})
    ...
    implements a, Iterable<T>
  {
    ...
    public final Iterator<T> iterator()
    {
      ...
      Iterator localIterator = this.NGN.iterator();
      AppMethodBeat.o(129474);
      return localIterator;
    }
  }
  
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"<anonymous>", "", "T", "", "it", "invoke", "(Ljava/lang/Object;)Z"})
  static final class b
    extends q
    implements b<T, Boolean>
  {
    public static final b NGO;
  ...
  @l(gfx={1, 1, 16}, gfy={""}, gfz={"<anonymous>", "", "R", "T", "it", "Lkotlin/sequences/Sequence;", "invoke"})
