  ...
  extends m
{
  ...
  public static final <T, R> h<R> c(h<? extends T> paramh, b<? super T, ? extends h<? extends R>> paramb)
  {
    ...
    paramh = (h)new f(paramh, paramb, (b)c.LPU);
  ...
  @d.l(fNY={1, 1, 16}, fNZ={""}, fOa={"kotlin/collections/CollectionsKt__IterablesKt$Iterable$1", "", "iterator", "", "kotlin-stdlib"})
  ...
  @d.l(fNY={1, 1, 16}, fNZ={""}, fOa={"<anonymous>", "", "T", "", "it", "invoke", "(Ljava/lang/Object;)Z"})
  static final class b
    extends d.g.b.l
    implements b<T, Boolean>
  {
    public static final b LPT;
  ...
  @d.l(fNY={1, 1, 16}, fNZ={""}, fOa={"<anonymous>", "", "R", "T", "it", "Lkotlin/sequences/Sequence;", "invoke"})
  static final class c
    extends d.g.b.l
    implements b<h<? extends R>, Iterator<? extends R>>
  {
    public static final c LPU;
