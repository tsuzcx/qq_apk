  ...
  implements g<R>
{
  ...
  public k(i parami, ah paramah)
  {
    ...
    d.g.b.k.g(parami, "ReflectProperties.lazy { Setter(this) }");
    this.KWS = parami;
  ...
  @d.l(fNY={1, 1, 15}, fNZ={""}, fOa={"<anonymous>", "Lkotlin/reflect/jvm/internal/KMutableProperty0Impl$Setter;", "R", "invoke"})
