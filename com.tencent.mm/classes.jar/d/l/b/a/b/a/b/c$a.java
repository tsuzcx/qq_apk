...
public final class c$a
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (this != paramObject)
    {
      if ((paramObject instanceof a))
      {
        ...
        if ((!p.i(this.MTn, paramObject.MTn)) || (!p.i(this.MTo, paramObject.MTo)) || (!p.i(this.MTp, paramObject.MTp))) {}
      }
    }
    else
    {
  ...
  public final String toString()
  {
    ...
    String str = "PlatformMutabilityMapping(javaClass=" + this.MTn + ", kotlinReadOnly=" + this.MTo + ", kotlinMutable=" + this.MTp + ")";
