...
{
  private static final LinkedHashSet<d.l.b.a.b.f.a> MPL;
  public static final c MPM;
  
  static
  {
    AppMethodBeat.i(56653);
    MPM = new c();
    Object localObject1 = h.MRP;
    ...
    localObject2 = (Iterable)j.b((Collection)j.b((Collection)j.b((Collection)localObject1, g.MQb.MQl.grk()), g.MQb.MQn.grk()), g.MQb.MQw.grk());
    localObject1 = (Collection)new LinkedHashSet();
    localObject2 = ((Iterable)localObject2).iterator();
    while (((Iterator)localObject2).hasNext()) {
      ((Collection)localObject1).add(d.l.b.a.b.f.a.p((b)((Iterator)localObject2).next()));
    }
    MPL = (LinkedHashSet)localObject1;
  ...
  public static boolean b(e parame)
  {
    ...
    {
      Iterable localIterable = (Iterable)MPL;
      parame = d.l.b.a.b.j.d.a.c((d.l.b.a.b.b.h)parame);
      if (parame != null) {}
      for (parame = parame.grc(); j.a(localIterable, parame); parame = null)
      {
  ...
  public static Set<d.l.b.a.b.f.a> ggV()
  {
    AppMethodBeat.i(56651);
    Set localSet = Collections.unmodifiableSet((Set)MPL);
