...
{
  public static final bg iS(List<? extends bg> paramList)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = ((v)localObject1).JXH;
      j = 1;
    }
    label216:
    paramList = new m();
    ...
    if (i != 0)
    {
      paramList = u.aQS("Intersection of error types: ".concat(String.valueOf(paramList)));
      k.g(paramList, "ErrorUtils.createErrorTy… of error types: $types\")");
    ...
    if (j == 0)
    {
      paramList = (bg)y.JZq.iT((List)localObject1);
      AppMethodBeat.o(61045);
      return paramList;
    }
    ...
    paramList = ac.a(y.JZq.iT((List)localObject1), y.JZq.iT(paramList));
    AppMethodBeat.o(61045);
    return paramList;
  }
}
