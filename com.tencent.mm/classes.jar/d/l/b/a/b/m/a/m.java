...
public final class m
{
  public static final aj a(aj paramaj, b paramb)
  {
    ...
    if (paramaj.fIT().size() != paramaj.fIW().getParameters().size())
    {
      AppMethodBeat.o(61083);
      return null;
    }
    List localList = paramaj.fIT();
    Object localObject1 = (Iterable)localList;
    if ((!(localObject1 instanceof Collection)) || (!((Collection)localObject1).isEmpty()))
    {
      localObject1 = ((Iterable)localObject1).iterator();
      if (((Iterator)localObject1).hasNext()) {
        if (((av)((Iterator)localObject1).next()).fJZ() == bh.JYC)
        {
          i = 1;
          label126:
          if (i != 0) {
    ...
    while (((Iterator)localObject4).hasNext())
    {
      ...
      {
        if ((!((av)localObject2).fJY()) && (((av)localObject2).fJZ() == bh.JYD)) {}
        for (localObject1 = ((av)localObject2).fzr().fJW();; localObject1 = null)
        {
    ...
    localObject1 = au.JYl;
    localObject1 = au.a.a(paramaj.fIW(), paramb).fKa();
    ...
    while (i < k)
    {
      ...
      if (((av)localObject2).fJZ() != bh.JYC)
      {
        localObject4 = paramaj.fIW().getParameters().get(i);
        d.g.b.k.g(localObject4, "type.constructor.parameters[index]");
        localObject4 = ((as)localObject4).fwf();
        ...
        while (((Iterator)localObject5).hasNext())
        {
          ...
          n.a locala = n.JZb;
          n.a.fKf();
          ((Collection)localObject4).add(o.c(((ba)localObject1).b((ab)localObject6, bh.JYC).fJW()));
        }
        localObject4 = (List)localObject4;
        if ((!((av)localObject2).fJY()) && (((av)localObject2).fJZ() == bh.JYE))
        {
          localObject5 = (Collection)localObject4;
          localObject6 = n.JZb;
          n.a.fKf();
          ((Collection)localObject5).add(o.c(((av)localObject2).fzr().fJW()));
        }
        ...
        localObject2 = ((k)localObject2).JYT;
        d.g.b.k.h(localObject4, "supertypes");
        if (((l)localObject2).JYW == null) {}
        for (int j = 1; (aa.JfW) && (j == 0); j = 0)
        {
          paramaj = (Throwable)new AssertionError("Already initialized! oldValue = " + ((l)localObject2).JYW + ", newValue = " + localObject4);
          AppMethodBeat.o(61083);
          throw paramaj;
        }
        ((l)localObject2).JYW = ((d.g.a.a)new l.b((List)localObject4));
      }
      i += 1;
    }
    paramaj = ac.c(paramaj.fxF(), paramaj.fIW(), paramb, paramaj.fBT());
    AppMethodBeat.o(61083);
    return paramaj;
  }
}
