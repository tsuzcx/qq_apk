...
public final class j$a
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (this != paramObject)
    {
      if ((paramObject instanceof a))
      {
        ...
        if ((!p.i(this.MSw, paramObject.MSw)) || (!p.i(this.Ncn, paramObject.Ncn)) || (!p.i(this.Nco, paramObject.Nco))) {}
      }
    }
    else
    {
  ...
  public final String toString()
  {
    ...
    String str = "Request(classId=" + this.MSw + ", previouslyFoundClassFileContent=" + Arrays.toString(this.Ncn) + ", outerClass=" + this.Nco + ")";
