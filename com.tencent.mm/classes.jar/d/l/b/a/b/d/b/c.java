...
{
  private final d.l.b.a.b.k.a.f NFE;
  private final y NpH;
  ...
  public c(y paramy, aa paramaa, d.l.b.a.b.l.j paramj, n paramn)
  {
    ...
    this.NpH = paramy;
    this.Npj = paramaa;
    this.NFE = new d.l.b.a.b.k.a.f(this.NpH, this.Npj);
  ...
  protected final p.a a(d.l.b.a.b.f.a parama, final an paraman, final List<d.l.b.a.b.b.a.c> paramList)
  {
    ...
    parama = (p.a)new a(this, s.a(this.NpH, parama, this.Npj), paramList, paraman);
  ...
  public static final class a
    implements p.a
  {
    final HashMap<d.l.b.a.b.f.f, g<?>> NFF;
    ...
    static g<?> b(d.l.b.a.b.f.f paramf, Object paramObject)
    {
      ...
      g localg = h.NTy.fv(paramObject);
      paramObject = localg;
      if (localg == null)
      {
        paramObject = k.NTD;
        paramObject = (g)k.a.bet("Unsupported annotation argument: ".concat(String.valueOf(paramf)));
      }
    ...
    public final void IP()
    {
      ...
      paramList.add(new d((ab)this.NFH.gne(), (Map)this.NFF, paraman));
    ...
    public final void a(d.l.b.a.b.f.f paramf1, d.l.b.a.b.f.a parama, d.l.b.a.b.f.f paramf2)
    {
      ...
      ((Map)this.NFF).put(paramf1, new d.l.b.a.b.j.b.j(parama, paramf2));
    ...
    public final void a(d.l.b.a.b.f.f paramf, d.l.b.a.b.j.b.f paramf1)
    {
      ...
      p.h(paramf, "name");
      p.h(paramf1, "value");
      ((Map)this.NFF).put(paramf, new r(paramf1));
    ...
    public final void a(d.l.b.a.b.f.f paramf, Object paramObject)
    {
      ...
      if (paramf != null) {
        ((Map)this.NFF).put(paramf, b(paramf, paramObject));
      }
      ...
      implements p.a
    {
      ...
      public final void IP()
      {
        ...
        this.NFL.IP();
        ((Map)this.NFK.NFF).put(paramf, new d.l.b.a.b.j.b.a((d.l.b.a.b.b.a.c)d.a.j.jp((List)localArrayList)));
      ...
      public final p.a a(d.l.b.a.b.f.f paramf, d.l.b.a.b.f.a parama)
      {
        ...
        p.h(paramf, "name");
        p.h(parama, "classId");
        paramf = this.NFJ.a(paramf, parama);
      ...
      public final void a(d.l.b.a.b.f.f paramf1, d.l.b.a.b.f.a parama, d.l.b.a.b.f.f paramf2)
      {
        ...
        p.h(parama, "enumClassId");
        p.h(paramf2, "enumEntryName");
        this.NFJ.a(paramf1, parama, paramf2);
      ...
      implements p.b
    {
      ...
      public final void IP()
      {
        ...
        Object localObject1 = d.l.b.a.b.d.a.a.a.b(paramf, this.NFK.NFH);
        if (localObject1 != null)
        {
          Map localMap = (Map)this.NFK.NFF;
          d.l.b.a.b.f.f localf = paramf;
          Object localObject2 = h.NTy;
          localObject2 = d.l.b.a.b.o.a.bd(this.NFM);
      ...
      public final void a(d.l.b.a.b.f.a parama, d.l.b.a.b.f.f paramf)
      {
        ...
        this.NFM.add(new d.l.b.a.b.j.b.j(parama, paramf));
      ...
      public final void fm(Object paramObject)
      {
        ...
        this.NFM.add(c.a.b(paramf, paramObject));
