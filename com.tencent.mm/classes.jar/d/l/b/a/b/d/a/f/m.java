...
final class m
{
  final Map<String, j> Lra;
  
  public m()
  {
    AppMethodBeat.i(58117);
    this.Lra = ((Map)new LinkedHashMap());
  ...
  public final class a
  {
    ...
    public final void i(String paramString, b<? super a, d.y> paramb)
    {
      AppMethodBeat.i(58115);
      k.h(paramString, "name");
      k.h(paramb, "block");
      Map localMap = m.this.Lra;
      paramString = new a(paramString);
      paramb.ay(paramString);
      paramString = paramString.fUD();
    ...
    public final class a
    {
      private o<String, r> Lrc;
      private final String lSY;
      private final List<o<String, r>> parameters;
      
      public a()
      {
        AppMethodBeat.i(58114);
        this.lSY = localObject;
      ...
      public final void a(d.l.b.a.b.j.e.d paramd)
      {
        ...
        k.h(paramd, "type");
        this.Lrc = u.Q(paramd.getDesc(), null);
      ...
      public final void a(String paramString, d... paramVarArgs)
      {
        ...
        {
          localCollection.add(u.Q(paramString, paramVarArgs));
          ...
          paramVarArgs = (Map)new LinkedHashMap(h.la(ae.agH(d.a.j.a((Iterable)localObject1, 10)), 16));
      ...
      public final void b(String paramString, d... paramVarArgs)
      {
        ...
        this.Lrc = u.Q(paramString, new r(paramVarArgs));
        AppMethodBeat.o(58111);
      }
      
      public final o<String, j> fUD()
      {
        AppMethodBeat.i(58113);
        Object localObject1 = v.Lsj;
        localObject1 = m.a.this.className;
        Object localObject2 = this.lSY;
        ...
        localObject1 = v.mX((String)localObject1, v.e((String)localObject2, (List)localCollection, (String)this.Lrc.first));
        localObject2 = (r)this.Lrc.second;
        ...
        localObject1 = u.Q(localObject1, new j((r)localObject2, (List)localCollection));
