...
public final class m$a
{
  ...
  public final void h(String paramString, b<? super a, d.y> paramb)
  {
    AppMethodBeat.i(58115);
    k.h(paramString, "name");
    k.h(paramb, "block");
    Map localMap = this.JDI.JDH;
    paramString = new a(paramString);
    paramb.aA(paramString);
    paramString = paramString.fBZ();
  ...
  public final class a
  {
    ...
    public final void a(d.l.b.a.b.j.e.d paramd)
    {
      ...
      k.h(paramd, "type");
      this.JDJ = u.P(paramd.getDesc(), null);
    ...
    public final void a(String paramString, d... paramVarArgs)
    {
      ...
      {
        localCollection.add(u.P(paramString, paramVarArgs));
        AppMethodBeat.o(58110);
        return;
        i = 0;
        break;
        label63:
        Object localObject1 = e.W(paramVarArgs);
        paramVarArgs = (Map)new LinkedHashMap(h.kK(ae.adL(d.a.j.a((Iterable)localObject1, 10)), 16));
        localObject1 = ((Iterable)localObject1).iterator();
        while (((Iterator)localObject1).hasNext())
        {
          Object localObject2 = ((Iterator)localObject1).next();
          paramVarArgs.put(Integer.valueOf(((d.a.y)localObject2).index), (d)((d.a.y)localObject2).value);
        }
      }
    }
    ...
    public final void b(String paramString, d... paramVarArgs)
    {
      ...
      this.JDJ = u.P(paramString, new r(paramVarArgs));
      AppMethodBeat.o(58111);
    }
    
    public final o<String, j> fBZ()
    {
      AppMethodBeat.i(58113);
      Object localObject1 = v.JEQ;
      localObject1 = m.a.this.className;
      Object localObject2 = this.lrd;
      ...
      localObject1 = v.mw((String)localObject1, v.f((String)localObject2, (List)localCollection, (String)this.JDJ.first));
      localObject2 = (r)this.JDJ.second;
      ...
      localObject1 = u.P(localObject1, new j((r)localObject2, (List)localCollection));
