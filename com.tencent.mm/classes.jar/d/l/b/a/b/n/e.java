  ...
  implements b
{
  ...
  public final boolean h(t paramt)
  {
    ...
    Object localObject1 = (av)paramt.fyq().get(1);
    paramt = i.JnQ;
    k.g(localObject1, "secondParameter");
    paramt = d.l.b.a.b.j.d.a.F((l)localObject1);
    k.h(paramt, "module");
    Object localObject2 = d.l.b.a.b.a.g.JlM.Jnb;
    ...
    for (paramt = null; paramt != null; paramt = (ab)ac.a((d.l.b.a.b.b.a.g)localObject2, paramt, j.listOf(new ao((as)localObject3))))
    {
      ...
      localObject2 = d.l.b.a.b.b.a.g.a.fzI();
      localObject3 = paramt.fxs();
      ...
      localObject3 = j.iC((List)localObject3);
