  ...
  extends d.l.b.a.b.b.c.b
{
  ...
  {
    super(locali, locall, localf, aa.b((a.r.b)localObject), paramr.JIO, paramInt, an.JqJ, (aq)aq.a.JqL);
    AppMethodBeat.i(60492);
    this.JUS = paramn;
    this.JWu = paramr;
    this.JWt = new b(this.JUS.JEr.JlL, (d.g.a.a)new a(this));
  ...
  public final List<ab> fzQ()
  {
    ...
    Object localObject4 = this.JWu;
    Object localObject3 = this.JUS.Jiv;
    k.h(localObject4, "$this$upperBounds");
    k.h(localObject3, "typeTable");
    Object localObject1 = ((a.r)localObject4).JIQ;
    int i;
    ...
    for (;;)
    {
      ...
      localObject1 = ((a.r)localObject4).JIR;
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        k.g(localObject4, "it");
        ((Collection)localObject1).add(((h)localObject3).afr(((Integer)localObject4).intValue()));
      }
      i = 0;
      break;
      label157:
    ...
    {
      localObject1 = j.listOf(d.l.b.a.b.j.d.a.G((d.l.b.a.b.b.l)this).fxd());
      AppMethodBeat.o(60490);
      return localObject1;
    }
    localObject3 = (Iterable)localObject2;
    localObject1 = this.JUS.JUE;
