...
{
  private static final Map<Class<? extends d.c<?>>, Integer> Jhk;
  private static final List<d.l.b<? extends Object>> JvV;
  private static final Map<Class<? extends Object>, Class<? extends Object>> JvW;
  private static final Map<Class<? extends Object>, Class<? extends Object>> JvX;
  
  static
  {
    int i = 0;
    AppMethodBeat.i(57407);
    Object localObject1 = d.a.j.listOf(new d.l.b[] { d.g.b.w.bk(Boolean.TYPE), d.g.b.w.bk(Byte.TYPE), d.g.b.w.bk(Character.TYPE), d.g.b.w.bk(Double.TYPE), d.g.b.w.bk(Float.TYPE), d.g.b.w.bk(Integer.TYPE), d.g.b.w.bk(Long.TYPE), d.g.b.w.bk(Short.TYPE) });
    JvV = (List)localObject1;
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      ((Collection)localObject1).add(d.u.P(d.g.a.c((d.l.b)localObject3), d.g.a.b((d.l.b)localObject3)));
    }
    JvW = ae.z((Iterable)localObject1);
    localObject2 = (Iterable)JvV;
    localObject1 = (Collection)new ArrayList(d.a.j.a((Iterable)localObject2, 10));
    localObject2 = ((Iterable)localObject2).iterator();
    while (((Iterator)localObject2).hasNext())
    {
      localObject3 = (d.l.b)((Iterator)localObject2).next();
      ((Collection)localObject1).add(d.u.P(d.g.a.b((d.l.b)localObject3), d.g.a.c((d.l.b)localObject3)));
    }
    JvX = ae.z((Iterable)localObject1);
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      ((Collection)localObject1).add(d.u.P((Class)localObject3, Integer.valueOf(i)));
      i += 1;
    }
    Jhk = ae.z((Iterable)localObject1);
    AppMethodBeat.o(57407);
  }
  
  public static final ClassLoader bs(Class<?> paramClass)
  {
  ...
  public static final boolean bt(Class<?> paramClass)
  {
  ...
  public static final Class<?> bu(Class<?> paramClass)
  {
    AppMethodBeat.i(57401);
    d.g.b.k.h(paramClass, "$this$primitiveByWrapper");
    paramClass = (Class)JvW.get(paramClass);
    AppMethodBeat.o(57401);
    return paramClass;
  }
  
  public static final Class<?> bv(Class<?> paramClass)
  {
    AppMethodBeat.i(57402);
    d.g.b.k.h(paramClass, "$this$wrapperByPrimitive");
    paramClass = (Class)JvX.get(paramClass);
    AppMethodBeat.o(57402);
    return paramClass;
  }
  
  public static final d.l.b.a.b.f.a bw(Class<?> paramClass)
  {
    ...
    for (int i = 1; i != 0; i = 0)
    {
      ...
      paramClass = new d.l.b.a.b.f.a(paramClass.fHd(), d.l.b.a.b.f.b.r(paramClass.fHe()), true);
      AppMethodBeat.o(57403);
      return paramClass;
    }
    ...
    if (localObject != null)
    {
      localObject = bw((Class)localObject);
      if (localObject != null)
      {
        paramClass = ((d.l.b.a.b.f.a)localObject).o(d.l.b.a.b.f.f.aQC(paramClass.getSimpleName()));
        AppMethodBeat.o(57403);
        return paramClass;
      }
    }
  ...
  public static final String bx(Class<?> paramClass)
  {
    ...
    paramClass = by(paramClass).getName();
  ...
  public static final List<Type> i(Type paramType)
  {
    ...
    if (((ParameterizedType)paramType).getOwnerType() == null)
    {
      ...
      paramType = d.a.e.T(paramType);
      AppMethodBeat.o(57406);
      return paramType;
    }
    paramType = d.m.i.c(d.m.i.c(d.m.i.b(paramType, (d.g.a.b)a.JvY), (d.g.a.b)b.JvZ));
    AppMethodBeat.o(57406);
    return paramType;
  }
