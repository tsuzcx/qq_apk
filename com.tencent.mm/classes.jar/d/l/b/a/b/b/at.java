...
public final class at
{
  public static final af a(ab paramab, i parami, int paramInt)
  {
    ...
    int j = parami.fxI().size() + paramInt;
    if (!parami.fxz())
    {
      if ((j == paramab.fIT().size()) || (d.l.b.a.b.j.c.m((l)parami))) {}
      for (int i = 1; (aa.JfW) && (i == 0); i = 0)
      {
        paramab = (Throwable)new AssertionError(paramab.fIT().size() - j + " trailing arguments were found in " + paramab + " type");
        AppMethodBeat.o(56894);
        throw paramab;
      }
      paramab = new af(parami, paramab.fIT().subList(paramInt, paramab.fIT().size()), null);
      AppMethodBeat.o(56894);
      return paramab;
    }
    List localList = paramab.fIT().subList(paramInt, j);
    l locall2 = parami.fxq();
    l locall1 = locall2;
  ...
  public static final List<as> a(i parami)
  {
    ...
    if ((!parami.fxz()) && (!(parami.fxq() instanceof a)))
    {
      AppMethodBeat.o(56893);
      return localList;
    }
    Object localObject1 = d.l.b.a.b.j.d.a.H((l)parami);
    Object localObject3 = (b)at.a.JqM;
    k.h(localObject1, "$this$takeWhile");
    k.h(localObject3, "predicate");
    localObject3 = d.m.i.c(d.m.i.c(d.m.i.a((h)new o((h)localObject1, (b)localObject3), (b)at.b.JqN), (b)at.c.JqO));
    ...
    for (;;)
    {
      ...
      {
        localObject4 = ((e)localObject4).fxs();
        localObject1 = localObject2;
        if (localObject4 != null) {
