...
final class aa$a
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (this != paramObject)
    {
      if ((paramObject instanceof a))
      {
        ...
        if ((!p.i(this.MSw, paramObject.MSw)) || (!p.i(this.MUJ, paramObject.MUJ))) {}
      }
    }
    else
    {
  ...
  public final String toString()
  {
    ...
    String str = "ClassRequest(classId=" + this.MSw + ", typeParametersCount=" + this.MUJ + ")";
