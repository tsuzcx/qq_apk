...
public final class a$v
  ...
  implements y
{
  public static s<v> Ltc;
  private static final v LwL;
  private final d Ltb;
  private byte Ltg = -1;
  private int Lth = -1;
  public List<a.u> LwM;
  ...
  static
  {
    ...
    v localv = new v();
    LwL = localv;
    localv.LwM = Collections.emptyList();
  ...
  private a$v(d.l.b.a.b.h.e parame, d.l.b.a.b.h.g paramg)
  {
    ...
    //   9: aload_0
    //   10: iconst_m1
    //   11: putfield 60	d/l/b/a/b/e/a$v:Ltg	B
    //   14: aload_0
    //   15: iconst_m1
    //   16: putfield 62	d/l/b/a/b/e/a$v:Lth	I
    //   19: aload_0
    //   20: invokestatic 51	java/util/Collections:emptyList	()Ljava/util/List;
    //   23: putfield 53	d/l/b/a/b/e/a$v:LwM	Ljava/util/List;
    ...
    //   147: putfield 53	d/l/b/a/b/e/a$v:LwM	Ljava/util/List;
    //   150: iload_3
    //   151: iconst_1
    //   152: ior
    //   153: istore 4
    ...
    //   165: istore 8
    //   167: aload_0
    //   168: getfield 53	d/l/b/a/b/e/a$v:LwM	Ljava/util/List;
    //   171: aload_1
    //   172: getstatic 100	d/l/b/a/b/e/a$u:Ltc	Ld/l/b/a/b/h/s;
    //   175: aload_2
    ...
    //   225: aload_0
    //   226: aload_0
    //   227: getfield 53	d/l/b/a/b/e/a$v:LwM	Ljava/util/List;
    //   230: invokestatic 117	java/util/Collections:unmodifiableList	(Ljava/util/List;)Ljava/util/List;
    //   233: putfield 53	d/l/b/a/b/e/a$v:LwM	Ljava/util/List;
    //   236: aload 10
    //   238: invokevirtual 120	d/l/b/a/b/h/f:flush	()V
    //   241: aload_0
    //   242: aload 9
    //   244: invokevirtual 126	d/l/b/a/b/h/d$b:fZW	()Ld/l/b/a/b/h/d;
    //   247: putfield 69	d/l/b/a/b/e/a$v:Ltb	Ld/l/b/a/b/h/d;
    //   250: aload_0
    //   251: invokevirtual 129	d/l/b/a/b/e/a$v:gao	()V
    //   254: ldc 75
    ...
    //   268: aload_0
    //   269: aload_0
    //   270: getfield 53	d/l/b/a/b/e/a$v:LwM	Ljava/util/List;
    //   273: invokestatic 117	java/util/Collections:unmodifiableList	(Ljava/util/List;)Ljava/util/List;
    //   276: putfield 53	d/l/b/a/b/e/a$v:LwM	Ljava/util/List;
    //   279: aload 10
    //   281: invokevirtual 120	d/l/b/a/b/h/f:flush	()V
    //   284: aload_0
    //   285: aload 9
    //   287: invokevirtual 126	d/l/b/a/b/h/d$b:fZW	()Ld/l/b/a/b/h/d;
    //   290: putfield 69	d/l/b/a/b/e/a$v:Ltb	Ld/l/b/a/b/h/d;
    //   293: aload_0
    //   294: invokevirtual 129	d/l/b/a/b/e/a$v:gao	()V
    //   297: ldc 75
    ...
    //   310: putfield 69	d/l/b/a/b/e/a$v:Ltb	Ld/l/b/a/b/h/d;
    //   313: goto -20 -> 293
    //   316: astore_1
    //   317: aload_0
    //   318: aload 9
    //   320: invokevirtual 126	d/l/b/a/b/h/d$b:fZW	()Ld/l/b/a/b/h/d;
    //   323: putfield 69	d/l/b/a/b/e/a$v:Ltb	Ld/l/b/a/b/h/d;
    //   326: ldc 75
    ...
    //   381: putfield 69	d/l/b/a/b/e/a$v:Ltb	Ld/l/b/a/b/h/d;
    //   384: goto -134 -> 250
    //   387: astore_1
    //   388: aload_0
    //   389: aload 9
    //   391: invokevirtual 126	d/l/b/a/b/h/d$b:fZW	()Ld/l/b/a/b/h/d;
    //   394: putfield 69	d/l/b/a/b/e/a$v:Ltb	Ld/l/b/a/b/h/d;
    //   397: ldc 75
  ...
  public final void a(f paramf)
  {
    ...
    xS();
    int i = 0;
    while (i < this.LwM.size())
    {
      paramf.a(1, (q)this.LwM.get(i));
      i += 1;
    }
    paramf.e(this.Ltb);
  ...
  {
    private int Ltd;
    private List<a.u> LwM;
    
    private a()
    {
      AppMethodBeat.i(59019);
      this.LwM = Collections.emptyList();
    ...
    private a A(d.l.b.a.b.h.e parame, d.l.b.a.b.h.g paramg)
    {
      ...
      //   5: aconst_null
      //   6: astore_3
      //   7: getstatic 50	d/l/b/a/b/e/a$v:Ltc	Ld/l/b/a/b/h/s;
      //   10: aload_1
      //   11: aload_2
      ...
      //   34: astore_1
      //   35: aload_1
      //   36: getfield 63	d/l/b/a/b/h/k:LAt	Ld/l/b/a/b/h/q;
    ...
    private void fYI()
    {
      ...
      if ((this.Ltd & 0x1) != 1)
      {
        this.LwM = new ArrayList(this.LwM);
        this.Ltd |= 0x1;
      }
    ...
    public final a f(a.v paramv)
    {
      ...
      if (!a.v.d(paramv).isEmpty())
      {
        ...
        this.LwM = a.v.d(paramv);
        this.Ltd &= 0xFFFFFFFE;
      }
      for (;;)
      {
        this.Ltb = this.Ltb.a(a.v.e(paramv));
        AppMethodBeat.o(59022);
        return this;
        label84:
        fYI();
        this.LwM.addAll(a.v.d(paramv));
      }
    }
    
    public final a.v fYH()
    {
      AppMethodBeat.i(59021);
      a.v localv = new a.v(this, (byte)0);
      if ((this.Ltd & 0x1) == 1)
      {
        this.LwM = Collections.unmodifiableList(this.LwM);
        this.Ltd &= 0xFFFFFFFE;
      }
      a.v.a(localv, this.LwM);
