...
public final class f
{
  ...
  public static int afI(int paramInt)
  {
  ...
  public static int cV(byte[] paramArrayOfByte)
  {
    ...
    int i = ga(paramArrayOfByte.length);
  ...
  public static int kN(int paramInt1, int paramInt2)
  {
  ...
  public static int xH(long paramLong)
  {
    AppMethodBeat.i(59422);
    int i = fY(2);
    int j = aB(xJ(paramLong));
  ...
  public final void L(double paramDouble)
  {
    ...
    xI(Double.doubleToRawLongBits(paramDouble));
  ...
  public final void bX(float paramFloat)
  {
    ...
    afH(Float.floatToRawIntBits(paramFloat));
