  ...
  implements s<MessageType>
{
  ...
  private MessageType a(d paramd, g paramg)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 33	d/l/b/a/b/h/d:fHo	()Ld/l/b/a/b/h/e;
    //   4: astore_1
    //   5: aload_0
    //   6: aload_1
    //   7: aload_2
    ...
    //   15: aload_1
    //   16: iconst_0
    //   17: invokevirtual 44	d/l/b/a/b/h/e:fP	(I)V
    //   20: aload_2
    //   21: areturn
    //   22: astore_1
    //   23: aload_1
    //   24: aload_2
    //   25: putfield 48	d/l/b/a/b/h/k:JNa	Ld/l/b/a/b/h/q;
    //   28: aload_1
    //   29: athrow
    //   30: astore_1
    //   31: aload_1
  ...
  private static MessageType a(MessageType paramMessageType)
  {
    if ((paramMessageType != null) && (!paramMessageType.isInitialized()))
    {
      ...
      for (Object localObject = new w();; localObject = new w())
      {
        ...
        ((k)localObject).JNa = paramMessageType;
  ...
  {
    paramInputStream = e.W(paramInputStream);
    paramg = (q)a(paramInputStream, paramg);
    try
    {
      paramInputStream.fP(0);
      return paramg;
    }
    catch (k paramInputStream)
    {
      paramInputStream.JNa = paramg;
