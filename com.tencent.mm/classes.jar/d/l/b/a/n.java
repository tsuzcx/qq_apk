  ...
  implements j
{
  ...
  static
  {
    ...
    cxA = new k[] { (k)z.a(new x(z.bp(n.class), "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/ParameterDescriptor;")), (k)z.a(new x(z.bp(n.class), "annotations", "getAnnotations()Ljava/util/List;")) };
  ...
  public n(e<?> parame, int paramInt, j.a parama, d.g.a.a<? extends ae> parama1)
  {
    ...
    this.index = paramInt;
    this.Nll = parama;
    this.Nko = y.R(parama1);
    this.Nkp = y.R((d.g.a.a)new a(this));
    AppMethodBeat.o(56440);
  }
  
  private final ae gle()
  {
    AppMethodBeat.i(56435);
    ae localae = (ae)this.Nko.invoke();
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (((paramObject instanceof n)) && (p.i(this.Nlk, ((n)paramObject).Nlk)) && (p.i(gle(), ((n)paramObject).gle())))
    {
