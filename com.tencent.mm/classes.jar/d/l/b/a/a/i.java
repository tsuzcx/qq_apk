...
public abstract class i
  implements d<Method>
{
  private final Method KYK;
  private final List<Type> KYe;
  private final Type KYz;
  
  private i(Method paramMethod, List<? extends Type> paramList)
  {
    this.KYK = paramMethod;
    this.KYe = paramList;
    paramMethod = this.KYK.getReturnType();
    k.g(paramMethod, "unboxMethod.returnType");
    this.KYz = ((Type)paramMethod);
  }
  ...
  {
    k.h(paramArrayOfObject, "args");
    return this.KYK.invoke(paramObject, Arrays.copyOf(paramArrayOfObject, paramArrayOfObject.length));
  }
  ...
  @l(fNY={1, 1, 15}, fNZ={""}, fOa={"Lkotlin/reflect/jvm/internal/calls/InternalUnderlyingValOfInlineClass$Unbound;", "Lkotlin/reflect/jvm/internal/calls/InternalUnderlyingValOfInlineClass;", "unboxMethod", "Ljava/lang/reflect/Method;", "(Ljava/lang/reflect/Method;)V", "call", "", "args", "", "([Ljava/lang/Object;)Ljava/lang/Object;", "kotlin-reflection"})
