  ...
  implements d<M>
{
  ...
  private e(M paramM, Type paramType, Class<?> paramClass, Type[] paramArrayOfType)
  {
    ...
    if (paramM != null)
    {
      ...
      paramType.eI(paramArrayOfType);
      paramType = j.listOf((Type[])paramType.toArray(new Type[paramType.cTm.size()]));
      paramM = paramType;
      if (paramType != null) {}
    }
    else
    {
      paramM = d.a.e.T(paramArrayOfType);
    }
    this.JkK = paramM;
  }
  
  public void ad(Object[] paramArrayOfObject)
  {
    k.h(paramArrayOfObject, "args");
    d.a.a(this, paramArrayOfObject);
  }
  
  protected final void eX(Object paramObject)
  {
    if ((paramObject == null) || (!this.Jle.getDeclaringClass().isInstance(paramObject))) {
    ...
    implements c
  {
    ...
    public final Object ac(Object[] paramArrayOfObject)
    {
      ...
      Constructor localConstructor = (Constructor)this.Jle;
      d.g.b.y localy = new d.g.b.y(3);
      localy.add(this.Jli);
      localy.eI(paramArrayOfObject);
      localy.add(null);
      paramArrayOfObject = localConstructor.newInstance(localy.toArray(new Object[localy.cTm.size()]));
      AppMethodBeat.o(56590);
      return paramArrayOfObject;
    }
  }
  
  @l(fvt={1, 1, 15}, fvu={""}, fvv={"Lkotlin/reflect/jvm/internal/calls/CallerImpl$AccessorForHiddenConstructor;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl;", "Ljava/lang/reflect/Constructor;", "constructor", "(Ljava/lang/reflect/Constructor;)V", "call", "", "args", "", "([Ljava/lang/Object;)Ljava/lang/Object;", "kotlin-reflection"})
  ...
  @l(fvt={1, 1, 15}, fvu={""}, fvv={"Lkotlin/reflect/jvm/internal/calls/CallerImpl$Constructor;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl;", "Ljava/lang/reflect/Constructor;", "constructor", "(Ljava/lang/reflect/Constructor;)V", "call", "", "args", "", "([Ljava/lang/Object;)Ljava/lang/Object;", "kotlin-reflection"})
    ...
    extends e<Constructor<?>>
  {
    ...
    public final Object ac(Object[] paramArrayOfObject)
    {
      ...
      k.h(paramArrayOfObject, "args");
      ad(paramArrayOfObject);
      paramArrayOfObject = ((Constructor)this.Jle).newInstance(Arrays.copyOf(paramArrayOfObject, paramArrayOfObject.length));
    ...
    extends e<Field>
  {
    ...
    public Object ac(Object[] paramArrayOfObject)
    {
      k.h(paramArrayOfObject, "args");
      ad(paramArrayOfObject);
      Field localField = (Field)this.Jle;
      if (this.Jlg != null) {}
      for (paramArrayOfObject = d.a.e.N(paramArrayOfObject);; paramArrayOfObject = null) {
      ...
      implements c
    {
      ...
      public final Object ac(Object[] paramArrayOfObject)
      {
        ...
        k.h(paramArrayOfObject, "args");
        ad(paramArrayOfObject);
        paramArrayOfObject = ((Field)this.Jle).get(this.Jli);
        AppMethodBeat.o(56598);
        return paramArrayOfObject;
      }
    }
    
    @l(fvt={1, 1, 15}, fvu={""}, fvv={"Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldGetter$BoundJvmStaticInObject;", "Lkotlin/reflect/jvm/internal/calls/BoundCaller;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldGetter;", "field", "Ljava/lang/reflect/Field;", "(Ljava/lang/reflect/Field;)V", "kotlin-reflection"})
    public static final class b
      extends e.f
      implements c
    {
    ...
    @l(fvt={1, 1, 15}, fvu={""}, fvv={"Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldGetter$Instance;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldGetter;", "field", "Ljava/lang/reflect/Field;", "(Ljava/lang/reflect/Field;)V", "kotlin-reflection"})
    public static final class c
      extends e.f
    {
    ...
    @l(fvt={1, 1, 15}, fvu={""}, fvv={"Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldGetter$JvmStaticInObject;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldGetter;", "field", "Ljava/lang/reflect/Field;", "(Ljava/lang/reflect/Field;)V", "checkArguments", "", "args", "", "([Ljava/lang/Object;)V", "kotlin-reflection"})
      ...
      extends e.f
    {
      ...
      public final void ad(Object[] paramArrayOfObject)
      {
        ...
        k.h(paramArrayOfObject, "args");
        super.ad(paramArrayOfObject);
        eX(d.a.e.O(paramArrayOfObject));
        AppMethodBeat.o(56602);
      }
    }
    
    @l(fvt={1, 1, 15}, fvu={""}, fvv={"Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldGetter$Static;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldGetter;", "field", "Ljava/lang/reflect/Field;", "(Ljava/lang/reflect/Field;)V", "kotlin-reflection"})
    public static final class e
      extends e.f
    {
    ...
    extends e<Field>
  {
    ...
    public Object ac(Object[] paramArrayOfObject)
    {
      ...
      Field localField = (Field)this.Jle;
      if (this.Jlg != null) {}
      for (Object localObject = d.a.e.N(paramArrayOfObject);; localObject = null)
      {
        localField.set(localObject, d.a.e.P(paramArrayOfObject));
        return d.y.JfV;
      }
    }
    ...
    public void ad(Object[] paramArrayOfObject)
    {
      k.h(paramArrayOfObject, "args");
      super.ad(paramArrayOfObject);
      if ((this.Jlj) && (d.a.e.P(paramArrayOfObject) == null)) {
      ...
      implements c
    {
      ...
      public final Object ac(Object[] paramArrayOfObject)
      {
        ...
        k.h(paramArrayOfObject, "args");
        ad(paramArrayOfObject);
        ((Field)this.Jle).set(this.Jli, d.a.e.N(paramArrayOfObject));
        paramArrayOfObject = d.y.JfV;
      ...
      implements c
    {
      ...
      public final Object ac(Object[] paramArrayOfObject)
      {
        ...
        k.h(paramArrayOfObject, "args");
        ad(paramArrayOfObject);
        ((Field)this.Jle).set(null, d.a.e.P(paramArrayOfObject));
        paramArrayOfObject = d.y.JfV;
    ...
    @l(fvt={1, 1, 15}, fvu={""}, fvv={"Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldSetter$Instance;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldSetter;", "field", "Ljava/lang/reflect/Field;", "notNull", "", "(Ljava/lang/reflect/Field;Z)V", "kotlin-reflection"})
    public static final class c
      extends e.g
    {
    ...
    @l(fvt={1, 1, 15}, fvu={""}, fvv={"Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldSetter$JvmStaticInObject;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldSetter;", "field", "Ljava/lang/reflect/Field;", "notNull", "", "(Ljava/lang/reflect/Field;Z)V", "checkArguments", "", "args", "", "([Ljava/lang/Object;)V", "kotlin-reflection"})
    public static final class d
      extends e.g
    {
    ...
    @l(fvt={1, 1, 15}, fvu={""}, fvv={"Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldSetter$Static;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl$FieldSetter;", "field", "Ljava/lang/reflect/Field;", "notNull", "", "(Ljava/lang/reflect/Field;Z)V", "kotlin-reflection"})
    public static final class e
      extends e.g
    {
    ...
    extends e<Method>
  {
    ...
    {
      k.h(paramArrayOfObject, "args");
      paramObject = ((Method)this.Jle).invoke(paramObject, Arrays.copyOf(paramArrayOfObject, paramArrayOfObject.length));
      if (this.Jlk) {
        paramObject = d.y.JfV;
      }
      return paramObject;
      ...
      implements c
    {
      ...
      public final Object ac(Object[] paramArrayOfObject)
      {
        ...
        localy.add(this.Jli);
        localy.eI(paramArrayOfObject);
        paramArrayOfObject = b(null, localy.toArray(new Object[localy.cTm.size()]));
        AppMethodBeat.o(56617);
        return paramArrayOfObject;
      }
    }
    
    @l(fvt={1, 1, 15}, fvu={""}, fvv={"Lkotlin/reflect/jvm/internal/calls/CallerImpl$Method$Instance;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl$Method;", "method", "Ljava/lang/reflect/Method;", "(Ljava/lang/reflect/Method;)V", "call", "", "args", "", "([Ljava/lang/Object;)Ljava/lang/Object;", "kotlin-reflection"})
    public static final class d
      extends e.h
    {
    ...
    @l(fvt={1, 1, 15}, fvu={""}, fvv={"Lkotlin/reflect/jvm/internal/calls/CallerImpl$Method$JvmStaticInObject;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl$Method;", "method", "Ljava/lang/reflect/Method;", "(Ljava/lang/reflect/Method;)V", "call", "", "args", "", "([Ljava/lang/Object;)Ljava/lang/Object;", "kotlin-reflection"})
    public static final class e
      extends e.h
    {
    ...
    @l(fvt={1, 1, 15}, fvu={""}, fvv={"Lkotlin/reflect/jvm/internal/calls/CallerImpl$Method$Static;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl$Method;", "method", "Ljava/lang/reflect/Method;", "(Ljava/lang/reflect/Method;)V", "call", "", "args", "", "([Ljava/lang/Object;)Ljava/lang/Object;", "kotlin-reflection"})
