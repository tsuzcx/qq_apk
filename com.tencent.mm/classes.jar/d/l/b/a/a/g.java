  ...
  implements d<M>
{
  ...
  public g(d.l.b.a.b.b.b paramb, d<? extends M> paramd, boolean paramBoolean)
  {
    ...
    label121:
    Object localObject4;
    for (paramb = new a(d.k.d.gge(), new Method[0], paramd);; paramb = new a((d.k.d)localObject2, (Method[])localObject4, paramd))
    {
      this.MPA = paramb;
      ...
      label146:
      Object localObject1;
      if ((((g)localObject2).MPB instanceof e.h.c))
      {
        i = -1;
        ...
        localObject1 = paramb.gin();
        if (localObject1 == null) {
          break label351;
        }
        localObject1 = ((ak)localObject1).gju();
        label177:
        if (localObject1 == null) {
          break label357;
        }
      ...
      for (;;)
      {
        ...
        if ((paramb.gio() != null) && (!(((g)localObject2).MPB instanceof c)))
        {
          localObject1 = paramb.ghs();
        ...
        if ((paramb instanceof k))
        {
          localObject1 = ((k)paramb).giO();
          p.g(localObject1, "descriptor.constructedClass");
          if (((d.l.b.a.b.b.e)localObject1).ghB())
          {
            localObject1 = ((d.l.b.a.b.b.e)localObject1).ghs();
            if (localObject1 == null)
            {
            ...
            ((ArrayList)localObject3).add(((d.l.b.a.b.b.e)localObject1).giC());
          }
        }
        else
        {
          localObject1 = paramb.ghs();
          p.g(localObject1, "descriptor.containingDeclaration");
          if (((localObject1 instanceof d.l.b.a.b.b.e)) && (((d.l.b.a.b.b.e)localObject1).ghD())) {
            ((ArrayList)localObject3).add(((d.l.b.a.b.b.e)localObject1).giC());
          }
        }
      }
  ...
  public final Object af(Object[] paramArrayOfObject)
  {
    ...
    Object localObject2 = this.MPA;
    Object localObject1 = ((a)localObject2).MPC;
    Method[] arrayOfMethod = ((a)localObject2).MPD;
    Method localMethod1 = ((a)localObject2).MPE;
    ...
    localObject1 = this.MPB.af(arrayOfObject);
  ...
  public final M ggQ()
  {
    ...
    Member localMember = this.MPB.ggQ();
  ...
  public final List<Type> ggS()
  {
    ...
    List localList = this.MPB.ggS();
    AppMethodBeat.o(56629);
    return localList;
  }
  
  @d.l(gfx={1, 1, 16}, gfy={""}, gfz={"Lkotlin/reflect/jvm/internal/calls/InlineClassAwareCaller$BoxUnboxData;", "", "argumentRange", "Lkotlin/ranges/IntRange;", "unbox", "", "Ljava/lang/reflect/Method;", "box", "(Lkotlin/ranges/IntRange;[Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;)V", "getArgumentRange", "()Lkotlin/ranges/IntRange;", "getBox", "()Ljava/lang/reflect/Method;", "getUnbox", "()[Ljava/lang/reflect/Method;", "[Ljava/lang/reflect/Method;", "component1", "component2", "component3", "kotlin-reflection"})
  static final class a
  {
    ...
    public a(d.k.d paramd, Method[] paramArrayOfMethod, Method paramMethod)
    {
      ...
      this.MPC = paramd;
      this.MPD = paramArrayOfMethod;
      this.MPE = paramMethod;
