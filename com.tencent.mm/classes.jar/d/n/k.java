  ...
  implements Serializable
{
  ...
  private final Object writeReplace()
  {
    ...
    Object localObject = this.LQl.pattern();
    d.g.b.k.g(localObject, "nativePattern.pattern()");
    localObject = new b((String)localObject, this.LQl.flags());
  ...
  public final boolean aB(CharSequence paramCharSequence)
  {
    ...
    boolean bool = this.LQl.matcher(paramCharSequence).matches();
  ...
  public final i aC(CharSequence paramCharSequence)
  {
    ...
    d.g.b.k.h(paramCharSequence, "input");
    Matcher localMatcher = this.LQl.matcher(paramCharSequence);
  ...
  public final String d(CharSequence paramCharSequence, String paramString)
  {
    ...
    paramCharSequence = this.LQl.matcher(paramCharSequence).replaceAll(paramString);
  ...
  public final String e(CharSequence paramCharSequence, String paramString)
  {
    ...
    d.g.b.k.h(paramCharSequence, "input");
    d.g.b.k.h(paramString, "replacement");
    paramCharSequence = this.LQl.matcher(paramCharSequence).replaceFirst(paramString);
  ...
  public final String toString()
  {
    ...
    String str = this.LQl.toString();
    d.g.b.k.g(str, "nativePattern.toString()");
    AppMethodBeat.o(129429);
    return str;
  }
  
  @d.l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lkotlin/text/Regex$Companion;", "", "()V", "ensureUnicodeCase", "", "flags", "escape", "", "literal", "escapeReplacement", "fromLiteral", "Lkotlin/text/Regex;", "kotlin-stdlib"})
  public static final class a {}
  
  @d.l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lkotlin/text/Regex$Serialized;", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "pattern", "", "flags", "", "(Ljava/lang/String;I)V", "getFlags", "()I", "getPattern", "()Ljava/lang/String;", "readResolve", "", "Companion", "kotlin-stdlib"})
  static final class b
    implements Serializable
  {
    public static final a LQn;
    ...
    private final Object readResolve()
    {
      ...
      Object localObject = Pattern.compile(this.Gtq, this.flags);
    ...
    @d.l(fNY={1, 1, 16}, fNZ={""}, fOa={"Lkotlin/text/Regex$Serialized$Companion;", "", "()V", "serialVersionUID", "", "kotlin-stdlib"})
    public static final class a {}
  }
}
