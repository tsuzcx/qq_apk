  ...
  extends y
{
  public static final char aJ(CharSequence paramCharSequence)
  {
    ...
    char c = paramCharSequence.charAt(n.aF(paramCharSequence));
    AppMethodBeat.o(129440);
    return c;
  }
  
  public static final String gL(String paramString, int paramInt)
  {
    ...
    paramString = paramString.substring(h.kL(paramInt, paramString.length()));
