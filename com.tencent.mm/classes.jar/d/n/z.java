  ...
  extends y
{
  ...
  public static final String hz(String paramString, int paramInt)
  {
    ...
    paramString = paramString.substring(j.lx(paramInt, paramString.length()));
