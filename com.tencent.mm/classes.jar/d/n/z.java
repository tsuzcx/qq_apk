  ...
  extends y
{
  public static final char aK(CharSequence paramCharSequence)
  {
    ...
    char c = paramCharSequence.charAt(n.aG(paramCharSequence));
    AppMethodBeat.o(129440);
    return c;
  }
  
  public static final String gR(String paramString, int paramInt)
  {
    AppMethodBeat.i(129441);
    k.h(paramString, "$this$drop");
    if (paramInt >= 0) {}
    for (int i = 1; i == 0; i = 0)
    {
    ...
    paramString = paramString.substring(h.lb(paramInt, paramString.length()));
