  ...
  implements bb
{
  ...
  public au F(View paramView)
  {
    return as.E(paramView);
  }
  
  public bf G(View paramView)
  {
    return new bd(paramView.getWindowToken());
  }
  
  public float H(View paramView)
  {
    Float localFloat = (Float)paramView.getTag(z.a.save_non_transition_alpha);
    if (localFloat != null) {
  ...
  {
    if (paramView.getTag(z.a.save_non_transition_alpha) == null) {
      paramView.setTag(z.a.save_non_transition_alpha, Float.valueOf(paramView.getAlpha()));
    }
  }
  ...
  public void J(View paramView)
  {
    if (paramView.getVisibility() == 0) {
      paramView.setTag(z.a.save_non_transition_alpha, null);
    }
  }
