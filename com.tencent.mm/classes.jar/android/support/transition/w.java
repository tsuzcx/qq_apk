...
final class w
{
  static Animator a(View paramView, u paramu, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, TimeInterpolator paramTimeInterpolator)
  {
    float f1 = paramView.getTranslationX();
    float f2 = paramView.getTranslationY();
    Object localObject = (int[])paramu.view.getTag(2131306068);
    if (localObject != null)
    {
    ...
    paramView = new w.a(paramView, paramu.view, paramInt1 + i, paramInt2 + j, f1, f2);
