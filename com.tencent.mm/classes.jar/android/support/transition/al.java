...
class al
{
  ...
  {
    Float localFloat = (Float)paramView.getTag(2131307213);
    if (localFloat != null) {
  ...
  {
    if (paramView.getTag(2131307213) == null) {
      paramView.setTag(2131307213, Float.valueOf(paramView.getAlpha()));
    }
  }
  ...
  public void R(View paramView)
  {
    if (paramView.getVisibility() == 0) {
      paramView.setTag(2131307213, null);
    }
  }
