  ...
  extends Matrix
{
  ...
  public final void setRotate(float paramFloat1, float paramFloat2, float paramFloat3) {}
  
  public final void setScale(float paramFloat1, float paramFloat2) {}
  
  public final void setScale(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4) {}
  
  public final void setSinCos(float paramFloat1, float paramFloat2) {}
  
  public final void setSinCos(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4) {}
  
  public final void setSkew(float paramFloat1, float paramFloat2) {}
  
  public final void setSkew(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4) {}
  
  public final void setTranslate(float paramFloat1, float paramFloat2) {}
  
  public final void setValues(float[] paramArrayOfFloat) {}
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mm\classes7.jar
 * Qualified Name:     android.support.transition.p.1
