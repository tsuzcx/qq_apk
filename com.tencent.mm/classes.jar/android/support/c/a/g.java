  ...
  implements Interpolator
{
  ...
  {
    paramResources = android.support.v4.content.a.c.a(paramResources, paramTheme, paramAttributeSet, a.mx);
    if (android.support.v4.content.a.c.a(paramXmlPullParser, "pathData"))
    {
      paramTheme = android.support.v4.content.a.c.b(paramResources, paramXmlPullParser, "pathData", 4);
      paramAttributeSet = android.support.v4.a.c.I(paramTheme);
  ...
  private void a(Path paramPath)
  {
    ...
    if ((Math.abs(this.mL[0]) > 1.E-005D) || (Math.abs(this.mM[0]) > 1.E-005D) || (Math.abs(this.mL[(k - 1)] - 1.0F) > 1.E-005D) || (Math.abs(this.mM[(k - 1)] - 1.0F) > 1.E-005D)) {
      throw new IllegalArgumentException("The Path must start at (0,0) and end at (1,1) start: " + this.mL[0] + "," + this.mM[0] + " end:" + this.mL[(k - 1)] + "," + this.mM[(k - 1)]);
    }
    f1 = 0.0F;
    i = 0;
    int j = 0;
