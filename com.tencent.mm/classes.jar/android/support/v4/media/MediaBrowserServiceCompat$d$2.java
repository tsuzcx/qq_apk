  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    localObject = (MediaBrowserServiceCompat.b)this.BC.Bm.Bg.remove(localObject);
    if (localObject != null) {
      ((MediaBrowserServiceCompat.b)localObject).Bq.asBinder().unlinkToDeath((IBinder.DeathRecipient)localObject, 0);
    }
  }
}
