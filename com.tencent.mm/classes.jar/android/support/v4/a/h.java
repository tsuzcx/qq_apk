  ...
  implements d.a
{
  ...
  {
    paramContext = i.R(paramContext);
    if (paramContext == null) {
      return null;
    }
    try
    {
      boolean bool = i.a(paramContext, paramInputStream);
      if (!bool) {
        return null;
      }
  ...
  public Typeface a(Context paramContext, Resources paramResources, int paramInt1, String paramString, int paramInt2)
  {
    ...
    try
    {
      boolean bool = i.a(paramContext, paramResources, paramInt1);
      if (!bool) {
        return null;
      }
  ...
  {
    paramb = (a.c)a(paramb.zH, paramInt, new a() {});
    if (paramb == null) {
      return null;
    }
    return d.a(paramContext, paramResources, paramb.zK, paramb.mFileName, paramInt);
  }
  ...
  public Typeface a(Context paramContext, b.b[] paramArrayOfb, int paramInt)
  {
    ...
    //   8: aload_2
    //   9: iload_3
    //   10: invokevirtual 100	android/support/v4/a/h:a	([Landroid/support/v4/d/b$b;I)Landroid/support/v4/d/b$b;
    //   13: astore_2
    //   14: aload_1
    //   15: invokevirtual 106	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   18: aload_2
    //   19: getfield 112	android/support/v4/d/b$b:mUri	Landroid/net/Uri;
    //   22: invokevirtual 118	android/content/ContentResolver:openInputStream	(Landroid/net/Uri;)Ljava/io/InputStream;
    //   25: astore_2
    //   26: aload_1
    //   27: aload_2
    //   28: invokestatic 120	android/support/v4/a/h:a	(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    //   31: astore_1
    //   32: aload_2
    //   33: invokestatic 124	android/support/v4/a/i:closeQuietly	(Ljava/io/Closeable;)V
    //   36: aload_1
    //   37: areturn
    //   38: astore_1
    //   39: aconst_null
    //   40: astore_2
    //   41: aload_2
    //   42: invokestatic 124	android/support/v4/a/i:closeQuietly	(Ljava/io/Closeable;)V
    //   45: aconst_null
    //   46: areturn
    //   47: astore_1
    //   48: aconst_null
    //   49: astore_2
    //   50: aload_2
    //   51: invokestatic 124	android/support/v4/a/i:closeQuietly	(Ljava/io/Closeable;)V
    //   54: aload_1
    //   55: athrow
    //   56: astore_1
    //   57: goto -7 -> 50
  ...
  {
    public abstract boolean r(T paramT);
    
    public abstract int s(T paramT);
  }
}
