...
{
  private static final ThreadLocal<double[]> zS = new ThreadLocal();
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, float[] paramArrayOfFloat)
  {
    ...
    if (f6 == f7)
    {
      ...
      paramArrayOfFloat[0] = t(f2, 360.0F);
      paramArrayOfFloat[1] = t(f1, 1.0F);
      paramArrayOfFloat[2] = t(f4, 1.0F);
      return;
    }
    if (f6 == f1) {
      f1 = (f3 - f5) / f2 % 6.0F;
  ...
  private static double ai(int paramInt)
  {
    double[] arrayOfDouble2 = (double[])zS.get();
    double[] arrayOfDouble1 = arrayOfDouble2;
    if (arrayOfDouble2 == null)
    {
      arrayOfDouble1 = new double[3];
      zS.set(arrayOfDouble1);
    }
  ...
  private static double o(int paramInt1, int paramInt2)
  {
    ...
    double d1 = ai(i) + 0.05D;
    double d2 = ai(paramInt2) + 0.05D;
