...
{
  private Handler.Callback Dp = new Handler.Callback()
  {
    public final boolean handleMessage(Message arg1)
    {
      ...
      case 1: 
        ...
        synchronized (localc1.mLock)
        {
          ...
          localc1.mHandler.sendMessageDelayed(localc1.mHandler.obtainMessage(0), localc1.Dq);
          return true;
        }
      }
      c localc2 = c.this;
  ...
  public final <T> T a(final Callable<T> paramCallable, int paramInt)
  {
    ...
    //   46: aload 10
    //   48: aload 8
    //   50: invokespecial 71	android/support/v4/d/c$3:<init>	(Landroid/support/v4/d/c;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/Callable;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Ljava/util/concurrent/locks/Condition;)V
    //   53: invokevirtual 75	android/support/v4/d/c:f	(Ljava/lang/Runnable;)V
    //   56: aload 7
  ...
  final void f(Runnable paramRunnable)
  {
    synchronized (this.mLock)
    {
      if (this.mThread == null)
      {
        ...
        this.mThread.start();
        this.mHandler = new Handler(this.mThread.getLooper(), this.Dp);
        this.mGeneration += 1;
      }
