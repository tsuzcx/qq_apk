...
public abstract class r
{
  ...
  static ArrayList<String> c(ArrayList<View> paramArrayList)
  {
    ...
    while (i < j)
    {
      ...
      localArrayList.add(q.ab(localView));
      q.a(localView, null);
      i += 1;
    }
  ...
  final void a(View paramView, final ArrayList<View> paramArrayList1, final ArrayList<View> paramArrayList2, final ArrayList<String> paramArrayList, Map<String, String> paramMap)
  {
    ...
    if (i < k)
    {
      ...
      String str = q.ab((View)localObject);
      localArrayList.add(str);
      int j;
      if (str != null)
      {
        q.a((View)localObject, null);
      ...
      for (;;)
      {
        if (j < k)
        {
          if (((String)localObject).equals(paramArrayList.get(j))) {
            q.a((View)paramArrayList2.get(j), str);
          }
        }
        else
        {
    ...
    ab.a(paramView, new Runnable()
    {
      public final void run()
      {
        ...
        while (i < k)
        {
          q.a((View)paramArrayList2.get(i), (String)paramArrayList.get(i));
          q.a((View)paramArrayList1.get(i), (String)localArrayList.get(i));
          i += 1;
        }
      }
    });
