  ...
  implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener
{
  ...
  void dismissInternal(boolean paramBoolean)
  {
    ...
    {
      getFragmentManager().ab(this.mBackStackId);
      this.mBackStackId = -1;
      return;
    }
    o localo = getFragmentManager().bP();
    localo.a(this);
    if (paramBoolean)
    {
      localo.commitAllowingStateLoss();
      return;
    }
    localo.commit();
  }
  ...
  public int show(o paramo, String paramString)
  {
    ...
    this.mViewDestroyed = false;
    this.mBackStackId = paramo.commit();
  ...
  public void show(j paramj, String paramString)
  {
    ...
    this.mShownByMe = true;
    paramj = paramj.bP();
    paramj.a(this, paramString);
    paramj.commit();
  }
  
  public void showNow(j paramj, String paramString)
  {
    this.mDismissed = false;
    this.mShownByMe = true;
    paramj = paramj.bP();
