  ...
  implements s
{
  ...
  public final void a(String paramString1, int paramInt, String paramString2, android.app.Notification paramNotification)
  {
    ...
    //   35: aload 5
    //   37: iconst_1
    //   38: invokevirtual 49	android/os/Parcel:writeInt	(I)V
    //   41: aload 4
    //   43: aload 5
    //   45: iconst_0
    //   46: invokevirtual 55	android/app/Notification:writeToParcel	(Landroid/os/Parcel;I)V
    //   49: aload_0
    //   50: getfield 18	android/support/v4/app/s$a$a:mRemote	Landroid/os/IBinder;
    //   53: iconst_1
    //   54: aload 5
    //   56: aconst_null
    //   57: iconst_1
    ...
    //   70: aload 5
    //   72: iconst_0
    //   73: invokevirtual 49	android/os/Parcel:writeInt	(I)V
    //   76: goto -27 -> 49
    //   79: astore_1
    //   80: aload 5
