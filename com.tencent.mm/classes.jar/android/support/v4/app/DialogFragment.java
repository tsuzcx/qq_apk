  ...
  implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener
{
  ...
  public int show(k paramk, String paramString)
  {
    this.mDismissed = false;
    this.mShownByMe = true;
    paramk.a(this, paramString);
    this.mViewDestroyed = false;
    this.mBackStackId = paramk.commit();
  ...
  public void show(g paramg, String paramString)
  {
    this.mDismissed = false;
    this.mShownByMe = true;
    paramg = paramg.beginTransaction();
    paramg.a(this, paramString);
    paramg.commit();
  }
  
  public void showNow(g paramg, String paramString)
  {
    this.mDismissed = false;
    this.mShownByMe = true;
    paramg = paramg.beginTransaction();
