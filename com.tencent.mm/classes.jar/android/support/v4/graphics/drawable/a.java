...
public final class a
{
  ...
  public static boolean b(Drawable paramDrawable, int paramInt)
  {
    ...
    if ((Build.VERSION.SDK_INT < 17) || (!Kk)) {}
    try
    {
      ...
      if (Kj != null) {
        try
        {
          Kj.invoke(paramDrawable, new Object[] { Integer.valueOf(paramInt) });
          return true;
        }
  ...
  public static void h(Drawable paramDrawable)
  {
    ...
    while ((Build.VERSION.SDK_INT < 23) && (Build.VERSION.SDK_INT >= 21))
    {
      ...
      {
        paramDrawable = ((f)paramDrawable).eF();
      }
      else
      {
  ...
  public static <T extends Drawable> T j(Drawable paramDrawable)
  {
    ...
    if ((paramDrawable instanceof f)) {
      localDrawable = ((f)paramDrawable).eF();
    }
  ...
  public static int k(Drawable paramDrawable)
  {
    ...
    if ((Build.VERSION.SDK_INT < 17) || (!Km)) {}
    try
    {
      ...
      if (Kl != null) {
        try
        {
          int i = ((Integer)Kl.invoke(paramDrawable, new Object[0])).intValue();
          return i;
        }
        catch (Exception paramDrawable)
        {
