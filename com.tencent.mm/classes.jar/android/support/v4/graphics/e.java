  ...
  extends i
{
  ...
  /* Error */
  public android.graphics.Typeface a(android.content.Context paramContext, android.support.v4.c.b.b[] paramArrayOfb, int paramInt)
  {
    // Byte code:
    //   0: aload_2
    //   1: arraylength
    ...
    //   8: aload_2
    //   9: iload_3
    //   10: invokevirtual 67	android/support/v4/graphics/e:a	([Landroid/support/v4/c/b$b;I)Landroid/support/v4/c/b$b;
    //   13: astore_2
    //   14: aload_1
    ...
    //   20: aload 4
    //   22: aload_2
    //   23: getfield 79	android/support/v4/c/b$b:mUri	Landroid/net/Uri;
    //   26: ldc 81
    //   28: aconst_null
    ...
    //   32: astore 4
    //   34: aload 4
    //   36: invokestatic 89	android/support/v4/graphics/e:a	(Landroid/os/ParcelFileDescriptor;)Ljava/io/File;
    //   39: astore_2
    //   40: aload_2
    //   41: ifnull +10 -> 51
    //   44: aload_2
    ...
    //   65: aload_1
    //   66: aload 5
    //   68: invokestatic 105	android/support/v4/graphics/i:a	(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    //   71: astore_1
    //   72: aload 5
    ...
    //   0	197	2	paramArrayOfb	android.support.v4.c.b.b[]
 ...
 * Qualified Name:     android.support.v4.graphics.e
