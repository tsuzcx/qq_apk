...
{
  private Handler.Callback KJ = new Handler.Callback()
  {
    public final boolean handleMessage(Message arg1)
    {
      ...
      case 1: 
        ...
        synchronized (localc1.mLock)
        {
          ...
          localc1.mHandler.sendMessageDelayed(localc1.mHandler.obtainMessage(0), localc1.KK);
          return true;
        }
      }
      c localc2 = c.this;
  ...
  final void post(Runnable paramRunnable)
  {
    synchronized (this.mLock)
    {
      if (this.mThread == null)
      {
        ...
        this.mThread.start();
        this.mHandler = new Handler(this.mThread.getLooper(), this.KJ);
        this.mGeneration += 1;
      }
