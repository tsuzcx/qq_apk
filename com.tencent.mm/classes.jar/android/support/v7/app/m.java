...
final class m
{
  ...
  public final void a(long paramLong, double paramDouble1, double paramDouble2)
  {
    ...
    this.QA = (Math.round((f1 + paramDouble2) * 86400000.0D) + 946728000000L);
    this.QB = (Math.round((paramDouble2 - f1) * 86400000.0D) + 946728000000L);
    if ((this.QB < paramLong) && (this.QA > paramLong))
    {
      this.state = 0;
      return;
    }
