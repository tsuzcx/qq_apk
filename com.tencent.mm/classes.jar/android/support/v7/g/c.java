...
{
  private static final Comparator<c.e> SC = new c.1();
  ...
  public static c.b a(c.a parama, boolean paramBoolean)
  {
    ...
    while (!localArrayList2.isEmpty())
    {
      ...
      c.e locale = a(parama, locald2.SN, locald2.SO, locald2.SP, locald2.SQ, arrayOfInt1, arrayOfInt2, i);
      if (locale != null)
      {
        if (locale.size > 0) {
        ...
        if (localArrayList3.isEmpty())
        {
          locald1 = new c.d();
          label215:
          locald1.SN = locald2.SN;
          locald1.SP = locald2.SP;
          if (!locale.SR) {
            break label360;
          }
          locald1.SO = locale.x;
          ...
          locald2.SN = (locale.x + locale.size + 1);
          locald2.SP = (locale.y + locale.size);
        }
        for (;;)
        {
          ...
          if (locale.SM)
          {
            locald1.SO = (locale.x - 1);
            locald1.SQ = locale.y;
            break label263;
          }
          locald1.SO = locale.x;
          locald1.SQ = (locale.y - 1);
          break label263;
          label418:
          locald2.SN = (locale.x + locale.size);
          locald2.SP = (locale.y + locale.size + 1);
          continue;
          label455:
          locald2.SN = (locale.x + locale.size);
          locald2.SP = (locale.y + locale.size);
    ...
    Collections.sort(localArrayList1, SC);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (bool = false;; bool = true)
        {
          ...
          k = paramInt2;
          paramInt2 = m;
          while ((k < n) && (paramInt2 < i1) && (parama.C(paramInt1 + k, paramInt3 + paramInt2)))
          {
            k += 1;
            paramInt2 += 1;
          }
 ...
 * Qualified Name:     android.support.v7.g.c
