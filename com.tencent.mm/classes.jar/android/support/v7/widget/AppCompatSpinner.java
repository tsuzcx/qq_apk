...
{
  private static final int[] aaR = { 16843505 };
  private ab UV;
  private final Context Xo;
  private final e ZZ;
  private SpinnerAdapter aaS;
  ...
  {
    this(paramContext, paramAttributeSet, 2130772235);
  }
  ...
  private AppCompatSpinner(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    //   39: putfield 82	android/support/v7/widget/AppCompatSpinner:ZZ	Landroid/support/v7/widget/e;
    //   42: aload 8
    //   44: iconst_4
    //   45: iconst_0
    ...
    //   68: aload_0
    //   69: aload 7
    //   71: putfield 93	android/support/v7/widget/AppCompatSpinner:Xo	Landroid/content/Context;
    //   74: aload_0
    //   75: getfield 93	android/support/v7/widget/AppCompatSpinner:Xo	Landroid/content/Context;
    //   78: ifnull +155 -> 233
    //   81: aload_1
    //   82: aload_2
    //   83: getstatic 43	android/support/v7/widget/AppCompatSpinner:aaR	[I
    //   86: iload_3
    //   87: iconst_0
    ...
    //   143: aload_0
    //   144: aload_0
    //   145: getfield 93	android/support/v7/widget/AppCompatSpinner:Xo	Landroid/content/Context;
    //   148: aload_2
    //   149: iload_3
    ...
    //   153: astore 7
    //   155: aload_0
    //   156: getfield 93	android/support/v7/widget/AppCompatSpinner:Xo	Landroid/content/Context;
    //   159: aload_2
    ...
    //   179: putfield 119	android/support/v7/widget/AppCompatSpinner:aaV	I
    //   182: aload 7
    //   184: aload 9
    //   186: iconst_1
    ...
    //   201: putfield 135	android/support/v7/widget/AppCompatSpinner$b:aba	Ljava/lang/CharSequence;
    //   204: aload 9
    //   206: getfield 139	android/support/v7/widget/az:aoo	Landroid/content/res/TypedArray;
    //   209: invokevirtual 111	android/content/res/TypedArray:recycle	()V
    //   212: aload_0
    //   213: aload 7
    //   215: putfield 141	android/support/v7/widget/AppCompatSpinner:aaU	Landroid/support/v7/widget/AppCompatSpinner$b;
    //   218: aload_0
    ...
    //   230: putfield 146	android/support/v7/widget/AppCompatSpinner:UV	Landroid/support/v7/widget/ab;
    //   233: aload 8
    //   235: getfield 139	android/support/v7/widget/az:aoo	Landroid/content/res/TypedArray;
    //   238: iconst_0
    ...
    //   273: aload 8
    //   275: getfield 139	android/support/v7/widget/az:aoo	Landroid/content/res/TypedArray;
    //   278: invokevirtual 111	android/content/res/TypedArray:recycle	()V
    //   281: aload_0
    //   282: iconst_1
    //   283: putfield 167	android/support/v7/widget/AppCompatSpinner:aaT	Z
    //   286: aload_0
    //   287: getfield 169	android/support/v7/widget/AppCompatSpinner:aaS	Landroid/widget/SpinnerAdapter;
    //   290: ifnull +16 -> 306
    //   293: aload_0
    //   294: aload_0
    //   295: getfield 169	android/support/v7/widget/AppCompatSpinner:aaS	Landroid/widget/SpinnerAdapter;
    //   298: invokevirtual 165	android/support/v7/widget/AppCompatSpinner:setAdapter	(Landroid/widget/SpinnerAdapter;)V
    //   301: aload_0
    //   302: aconst_null
    //   303: putfield 169	android/support/v7/widget/AppCompatSpinner:aaS	Landroid/widget/SpinnerAdapter;
    //   306: aload_0
    //   307: getfield 82	android/support/v7/widget/AppCompatSpinner:ZZ	Landroid/support/v7/widget/e;
    //   310: aload_2
    //   311: iload_3
  ...
  {
    if (this.aaU != null) {
      return this.aaU.getVerticalOffset();
    }
    if (Build.VERSION.SDK_INT >= 16) {
  ...
  {
    if (this.aaU != null) {
      return this.aaU.aht.getBackground();
    }
    if (Build.VERSION.SDK_INT >= 16) {
  ...
  protected void onDetachedFromWindow()
  {
    ...
    if ((this.aaU != null) && (this.aaU.aht.isShowing())) {
      this.aaU.dismiss();
    }
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if ((this.aaU != null) && (View.MeasureSpec.getMode(paramInt1) == -2147483648)) {
  ...
  {
    if ((this.UV != null) && (this.UV.onTouch(this, paramMotionEvent))) {
      return true;
    }
  ...
  public void setAdapter(SpinnerAdapter paramSpinnerAdapter)
  {
    ...
    if (this.Xo == null) {}
    for (Context localContext = getContext();; localContext = this.Xo)
    {
      this.aaU.setAdapter(new a(paramSpinnerAdapter, localContext.getTheme()));
      return;
    }
  }
  ...
  {
    if (this.aaU != null) {
      this.aaU.setVerticalOffset(paramInt);
    }
    while (Build.VERSION.SDK_INT < 16) {
      return;
    }
  ...
  {
    if (this.aaU != null) {
      this.aaU.setBackgroundDrawable(paramDrawable);
    }
    while (Build.VERSION.SDK_INT < 16) {
      return;
    }
  ...
  {
    setPopupBackgroundDrawable(a.k(getPopupContext(), paramInt));
  }
  ...
  public void setPrompt(CharSequence paramCharSequence)
  {
    if (this.aaU != null)
    {
      this.aaU.aba = paramCharSequence;
      return;
    }
  ...
  {
    private SpinnerAdapter aaY;
    private ListAdapter aaZ;
    
    public a(SpinnerAdapter paramSpinnerAdapter, Resources.Theme paramTheme)
    {
      this.aaY = paramSpinnerAdapter;
      if ((paramSpinnerAdapter instanceof ListAdapter)) {
        this.aaZ = ((ListAdapter)paramSpinnerAdapter);
      }
    ...
    {
      ListAdapter localListAdapter = this.aaZ;
    ...
    public final View getDropDownView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      return this.aaY.getDropDownView(paramInt, paramView, paramViewGroup);
    }
    ...
    public final Object getItem(int paramInt)
    {
      ...
      return this.aaY.getItem(paramInt);
    }
    ...
    public final long getItemId(int paramInt)
    {
      ...
      return this.aaY.getItemId(paramInt);
    }
    ...
    {
      return (this.aaY != null) && (this.aaY.hasStableIds());
    }
    ...
    {
      if (this.aaY != null) {
        this.aaY.registerDataSetObserver(paramDataSetObserver);
      }
    }
    ...
    {
      if (this.aaY != null) {
        this.aaY.unregisterDataSetObserver(paramDataSetObserver);
      }
    }
  }
  ...
  {
    CharSequence aba;
    final Rect abb = new Rect();
    ListAdapter xw;
    
    public b(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
    {
      super(paramAttributeSet, paramInt);
      this.ahj = AppCompatSpinner.this;
      setModal(true);
      this.ahi = 0;
      this.ahl = new AdapterView.OnItemClickListener()
      {
        public final void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
        {
          AppCompatSpinner.this.setSelection(paramAnonymousInt);
          if (AppCompatSpinner.this.getOnItemClickListener() != null) {
            AppCompatSpinner.this.performItemClick(paramAnonymousView, paramAnonymousInt, AppCompatSpinner.b.this.xw.getItemId(paramAnonymousInt));
          }
    ...
    final void hj()
    {
      Object localObject = this.aht.getBackground();
      int i;
      int m;
      int n;
      int i1;
      ...
      if (localObject != null)
      {
        ...
        if (bh.bY(AppCompatSpinner.this))
        {
          ...
          if (AppCompatSpinner.this.aaV != -2) {
            break label246;
          }
          j = AppCompatSpinner.this.a((SpinnerAdapter)this.xw, this.aht.getBackground());
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          break;
          label246:
          if (AppCompatSpinner.this.aaV == -1)
          {
            setContentWidth(i1 - m - n);
            break label171;
          }
          setContentWidth(AppCompatSpinner.this.aaV);
          break label171;
          i += m;
        }
      }
    ...
    {
      boolean bool = this.aht.isShowing();
      hj();
      iD();
      super.show();
      this.agW.setChoiceMode(1);
      int i = AppCompatSpinner.this.getSelectedItemPosition();
      Object localObject = this.agW;
      if ((this.aht.isShowing()) && (localObject != null))
      {
      ...
      final ViewTreeObserver.OnGlobalLayoutListener local2 = new ViewTreeObserver.OnGlobalLayoutListener()
      {
        public final void onGlobalLayout()
        {
          ...
          if ((t.aw(localAppCompatSpinner)) && (localAppCompatSpinner.getGlobalVisibleRect(localb.abb))) {}
          for (int i = 1; i == 0; i = 0)
          {
            AppCompatSpinner.b.this.dismiss();
            return;
          }
          AppCompatSpinner.b.this.hj();
