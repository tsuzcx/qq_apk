...
{
  private static final int[] ahX = { 16843505 };
  private ab abZ;
  private final Context aet;
  private SpinnerAdapter ahY;
  ...
  private AppCompatSpinner(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    //   39: putfield 82	android/support/v7/widget/AppCompatSpinner:ahe	Landroid/support/v7/widget/e;
    //   42: aload 8
    //   44: iconst_4
    //   45: iconst_0
    ...
    //   68: aload_0
    //   69: aload 7
    //   71: putfield 93	android/support/v7/widget/AppCompatSpinner:aet	Landroid/content/Context;
    //   74: aload_0
    //   75: getfield 93	android/support/v7/widget/AppCompatSpinner:aet	Landroid/content/Context;
    //   78: ifnull +155 -> 233
    //   81: aload_1
    //   82: aload_2
    //   83: getstatic 43	android/support/v7/widget/AppCompatSpinner:ahX	[I
    //   86: iload_3
    //   87: iconst_0
    ...
    //   143: aload_0
    //   144: aload_0
    //   145: getfield 93	android/support/v7/widget/AppCompatSpinner:aet	Landroid/content/Context;
    //   148: aload_2
    //   149: iload_3
    ...
    //   153: astore 7
    //   155: aload_0
    //   156: getfield 93	android/support/v7/widget/AppCompatSpinner:aet	Landroid/content/Context;
    //   159: aload_2
    ...
    //   179: putfield 119	android/support/v7/widget/AppCompatSpinner:aib	I
    //   182: aload 7
    //   184: aload 9
    //   186: iconst_1
    ...
    //   201: putfield 135	android/support/v7/widget/AppCompatSpinner$b:aig	Ljava/lang/CharSequence;
    //   204: aload 9
    //   206: getfield 139	android/support/v7/widget/az:avP	Landroid/content/res/TypedArray;
    //   209: invokevirtual 111	android/content/res/TypedArray:recycle	()V
    //   212: aload_0
    //   213: aload 7
    //   215: putfield 141	android/support/v7/widget/AppCompatSpinner:aia	Landroid/support/v7/widget/AppCompatSpinner$b;
    //   218: aload_0
    ...
    //   230: putfield 146	android/support/v7/widget/AppCompatSpinner:abZ	Landroid/support/v7/widget/ab;
    //   233: aload 8
    //   235: getfield 139	android/support/v7/widget/az:avP	Landroid/content/res/TypedArray;
    //   238: iconst_0
    ...
    //   273: aload 8
    //   275: getfield 139	android/support/v7/widget/az:avP	Landroid/content/res/TypedArray;
    //   278: invokevirtual 111	android/content/res/TypedArray:recycle	()V
    //   281: aload_0
    //   282: iconst_1
    //   283: putfield 167	android/support/v7/widget/AppCompatSpinner:ahZ	Z
    //   286: aload_0
    //   287: getfield 169	android/support/v7/widget/AppCompatSpinner:ahY	Landroid/widget/SpinnerAdapter;
    //   290: ifnull +16 -> 306
    //   293: aload_0
    //   294: aload_0
    //   295: getfield 169	android/support/v7/widget/AppCompatSpinner:ahY	Landroid/widget/SpinnerAdapter;
    //   298: invokevirtual 165	android/support/v7/widget/AppCompatSpinner:setAdapter	(Landroid/widget/SpinnerAdapter;)V
    //   301: aload_0
    //   302: aconst_null
    //   303: putfield 169	android/support/v7/widget/AppCompatSpinner:ahY	Landroid/widget/SpinnerAdapter;
    //   306: aload_0
    //   307: getfield 82	android/support/v7/widget/AppCompatSpinner:ahe	Landroid/support/v7/widget/e;
    //   310: aload_2
    //   311: iload_3
  ...
  {
    if (this.aia != null) {
      return this.aia.getVerticalOffset();
    }
    if (Build.VERSION.SDK_INT >= 16) {
  ...
  {
    if (this.aia != null) {
      return this.aia.aoA.getBackground();
    }
    if (Build.VERSION.SDK_INT >= 16) {
  ...
  protected void onDetachedFromWindow()
  {
    ...
    if ((this.aia != null) && (this.aia.aoA.isShowing())) {
      this.aia.dismiss();
    }
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if ((this.aia != null) && (View.MeasureSpec.getMode(paramInt1) == -2147483648)) {
  ...
  {
    if ((this.abZ != null) && (this.abZ.onTouch(this, paramMotionEvent))) {
      return true;
    }
  ...
  public void setAdapter(SpinnerAdapter paramSpinnerAdapter)
  {
    ...
    if (this.aet == null) {}
    for (Context localContext = getContext();; localContext = this.aet)
    {
      this.aia.setAdapter(new a(paramSpinnerAdapter, localContext.getTheme()));
      return;
    }
  }
  ...
  {
    if (this.aia != null) {
      this.aia.setVerticalOffset(paramInt);
    }
    while (Build.VERSION.SDK_INT < 16) {
      return;
    }
  ...
  {
    if (this.aia != null) {
      this.aia.setBackgroundDrawable(paramDrawable);
    }
    while (Build.VERSION.SDK_INT < 16) {
      return;
    }
  ...
  public void setPrompt(CharSequence paramCharSequence)
  {
    if (this.aia != null)
    {
      this.aia.aig = paramCharSequence;
      return;
    }
  ...
  {
    private SpinnerAdapter aie;
    private ListAdapter aif;
    
    public a(SpinnerAdapter paramSpinnerAdapter, Resources.Theme paramTheme)
    {
      this.aie = paramSpinnerAdapter;
      if ((paramSpinnerAdapter instanceof ListAdapter)) {
        this.aif = ((ListAdapter)paramSpinnerAdapter);
      }
    ...
    {
      ListAdapter localListAdapter = this.aif;
    ...
    public final View getDropDownView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      return this.aie.getDropDownView(paramInt, paramView, paramViewGroup);
    }
    ...
    public final Object getItem(int paramInt)
    {
      ...
      return this.aie.getItem(paramInt);
    }
    ...
    public final long getItemId(int paramInt)
    {
      ...
      return this.aie.getItemId(paramInt);
    }
    ...
    {
      return (this.aie != null) && (this.aie.hasStableIds());
    }
    ...
    {
      if (this.aie != null) {
        this.aie.registerDataSetObserver(paramDataSetObserver);
      }
    }
    ...
    {
      if (this.aie != null) {
        this.aie.unregisterDataSetObserver(paramDataSetObserver);
      }
    }
  }
    ...
    extends ListPopupWindow
  {
      ...
      this.aos = new AdapterView.OnItemClickListener()
      {
        public final void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
        {
          ...
          if (AppCompatSpinner.this.getOnItemClickListener() != null) {
            AppCompatSpinner.this.performItemClick(paramAnonymousView, paramAnonymousInt, AppCompatSpinner.b.this.DP.getItemId(paramAnonymousInt));
          }
    ...
    final void iG()
    {
      Object localObject = this.aoA.getBackground();
      int i;
      int m;
      int n;
      int i1;
      ...
      if (localObject != null)
      {
        ...
        if (bh.d(AppCompatSpinner.this))
        {
          ...
          if (AppCompatSpinner.this.aib != -2) {
            break label246;
          }
          j = AppCompatSpinner.this.a((SpinnerAdapter)this.DP, this.aoA.getBackground());
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          break;
          label246:
          if (AppCompatSpinner.this.aib == -1)
          {
            setContentWidth(i1 - m - n);
            break label171;
          }
          setContentWidth(AppCompatSpinner.this.aib);
          break label171;
          i += m;
        }
      }
    ...
    {
      boolean bool = this.aoA.isShowing();
      iG();
      jY();
      super.show();
      ...
      if ((this.aoA.isShowing()) && (localObject != null))
      {
      ...
      final ViewTreeObserver.OnGlobalLayoutListener local2 = new ViewTreeObserver.OnGlobalLayoutListener()
      {
        public final void onGlobalLayout()
        {
          ...
          if ((t.aC(localAppCompatSpinner)) && (localAppCompatSpinner.getGlobalVisibleRect(localb.aih))) {}
          for (int i = 1; i == 0; i = 0)
          {
            AppCompatSpinner.b.this.dismiss();
            return;
          }
          AppCompatSpinner.b.this.iG();
