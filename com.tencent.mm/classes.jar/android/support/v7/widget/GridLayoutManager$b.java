...
{
  final SparseIntArray amW = new SparseIntArray();
  ...
  final int Z(int paramInt1, int paramInt2)
  {
    ...
    {
      return i;
      j = this.amW.get(paramInt1, -1);
      i = j;
    } while (j != -1);
    paramInt2 = Y(paramInt1, paramInt2);
    this.amW.put(paramInt1, paramInt2);
    return paramInt2;
  }
