...
public class APAppDataInterface
{
  ...
  public void d(int paramInt)
  {
    ...
    try
    {
      ...
      ((StringBuilder)localObject).append("1.7.1f_");
      ((StringBuilder)localObject).append(ed.b().n().a.offerId);
      ((StringBuilder)localObject).append("t4");
      localObject = ((StringBuilder)localObject).toString();
      localfq.a(a.a().d, "TencentUnipay", (String)localObject, i.a(paramInt));
      return;
    }
  ...
  public int u()
  {
    ...
    try
    {
      ...
      ((StringBuilder)localObject2).append("1.7.1f_");
      ((StringBuilder)localObject2).append(ed.b().n().a.offerId);
      ((StringBuilder)localObject2).append("t4");
      localObject2 = ((StringBuilder)localObject2).toString();
      localObject1 = ((fq)localObject1).a(a.a().d, "TencentUnipay", (String)localObject2);
      int i1 = i2;
