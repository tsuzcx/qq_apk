  ...
  extends APActivity
{
  ...
  private void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, byte[] paramArrayOfByte, String paramString5, String paramString6, String paramString7, String paramString8, int paramInt2, String paramString9, String paramString10, int paramInt3)
  {
    ...
    paramString1.mProxyActivityClass = a();
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.b = paramBundle.getInt("channel");
    this.c = paramBundle.getInt("payType");
    localObject1 = paramBundle.getString("saveNum");
    this.d = paramBundle.getString("count");
    ...
    if (!TextUtils.isEmpty(str3))
    {
      ...
      a(this, str1, (String)localObject2, str2, str3, this.c, null, (String)localObject3, (String)localObject1, str4, str5, i, str6, str7, j);
    }
  }
