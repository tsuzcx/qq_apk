  ...
  extends APActivity
{
  ...
  private void a(int paramInt, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      paramString.append(bq.a(paramInt));
      paramString.append(")");
  ...
  private void a(String paramString, long paramLong)
  {
    ...
    ((Hashtable)localObject).put(lx.b, "UTF-8");
    ((Hashtable)localObject).put(lx.a, mj.a);
    ((Hashtable)localObject).put(lx.f, Integer.valueOf(1));
    localObject = mb.a(paramString, this.e, this.e, -16777216, -1, (Hashtable)localObject);
  ...
  private void b()
  {
    ...
    bs.a().m(new kl()
    {
      ...
      {
        int j = ((dx)paramAnonymousjw).a();
        paramAnonymousjw = new StringBuilder();
        paramAnonymousjw.append("mPayResult = ");
        paramAnonymousjw.append(j);
        APLog.d("APChannelQRCodeActivity", paramAnonymousjw.toString());
        int i = j;
        if (j >= 300)
        {
          i = j;
        ...
        if (i != 300)
        {
          if (i != 1000)
          {
            ...
            default: 
              paramAnonymousjw = new StringBuilder();
              paramAnonymousjw.append("onListenning() onSuccess() error code = ");
              paramAnonymousjw.append(i);
              APLog.e("APChannelQRCodeActivity", paramAnonymousjw.toString());
      ...
      public void b(jw paramAnonymousjw)
      {
        ...
        APChannelQRCodeActivity.a(APChannelQRCodeActivity.this, paramAnonymousjw.R(), paramAnonymousjw.T());
      }
  ...
  private void b(String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      this.A = false;
      es.a();
      es.a(this.d).a(this, new ev()new eu
      {
        public void a()
        {
  ...
  private void c(String paramString)
  {
    ...
    if ("qqwallet".equals(this.d)) {
      bs.a().b(paramString, "get_short_url", new kl()
      {
        public void a(jw paramAnonymousjw)
        {
          paramAnonymousjw = (dn)paramAnonymousjw;
          int i = paramAnonymousjw.R();
          if (i == 0)
          {
            long l = paramAnonymousjw.a();
            String str = paramAnonymousjw.b();
            paramAnonymousjw = new StringBuilder();
            paramAnonymousjw.append("shortenUrl resultUrl= ");
            paramAnonymousjw.append(str);
            APLog.d("APChannelQRCodeActivity", paramAnonymousjw.toString());
            paramAnonymousjw = str;
            if (!str.startsWith("http://"))
            {
              paramAnonymousjw = new StringBuilder();
              paramAnonymousjw.append("http://");
              paramAnonymousjw.append(str);
              paramAnonymousjw = paramAnonymousjw.toString();
            }
            APChannelQRCodeActivity.a(APChannelQRCodeActivity.this, l);
            APChannelQRCodeActivity.a(APChannelQRCodeActivity.this, paramAnonymousjw, APChannelQRCodeActivity.e(APChannelQRCodeActivity.this));
            return;
          }
          APChannelQRCodeActivity.a(APChannelQRCodeActivity.this, i, paramAnonymousjw.T());
        }
