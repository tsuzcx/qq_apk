  ...
  extends APActivity
{
        ...
        public void onClick(View paramAnonymousView)
        {
          ...
          while (i < APMCardSelectValueActivity.d(APMCardSelectValueActivity.this).size())
          {
            if (paramAnonymousView.getId() == ((RadioButton)APMCardSelectValueActivity.d(APMCardSelectValueActivity.this).get(i)).getId())
            {
              ...
              APDataReportManager.getInstance().insertData("sdk.mcard.selectvalue.num", APMCardSelectValueActivity.e(APMCardSelectValueActivity.this), ed.b().n().e.l, ed.b().n().e.f, null);
            }
            else
            {
  ...
  protected void a()
  {
    ...
    this.e.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        ...
        APDataReportManager.getInstance().insertData("sdk.mcard.selectvalue.back", APMCardSelectValueActivity.c(APMCardSelectValueActivity.this), ed.b().n().e.l, ed.b().n().e.f, null);
  ...
  protected void b()
  {
    com.pay.paychannel.mcard.APMcardChannel.k = String.valueOf(this.c * 100);
    String str = ed.b().n().e.f;
    APRecoChannelActivity.b = true;
    es.a().a(this, str, this.b, null);
  }
  ...
  public boolean onKeyDown(int paramInt, KeyEvent paramKeyEvent)
  {
    if (paramInt == 4)
    {
      ...
      APDataReportManager.getInstance().insertData("sdk.mcard.selectvalue.keyback", this.f, ed.b().n().e.l, ed.b().n().e.f, null);
      finish();
      APUICommonMethod.b(this);
  ...
  {
    APDataReportManager.getInstance().insertData("sdk.mcard.selectvalue.show", this.f, ed.b().n().e.l, ed.b().n().e.f, null);
    super.onResume();
  }
