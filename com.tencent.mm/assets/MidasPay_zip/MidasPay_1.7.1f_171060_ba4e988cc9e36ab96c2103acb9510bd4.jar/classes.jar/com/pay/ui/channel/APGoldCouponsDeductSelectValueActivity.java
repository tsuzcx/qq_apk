  ...
  implements View.OnClickListener
{
  ...
  private void d()
  {
    ...
    ((StringBuilder)localObject1).append(fp.a().V());
  ...
  public void onClick(View paramView)
  {
    ...
    else
    {
      ...
      {
        a(getString(2131230786).replace("宝券", (String)this.G.getTag()));
        return;
      }
      if (paramView.getId() == this.H.getId()) {
        a(getString(2131230786).replace("宝券", (String)this.H.getTag()));
      }
    }
  }
