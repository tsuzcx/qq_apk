  ...
  implements View.OnClickListener
{
  ...
  private void a()
  {
    ...
    ((ImageButton)findViewById(2131099802)).setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        APDataReportManager.getInstance().insertData("sdk.hf.sendsms.back", APHFSmsOrderActivity.a(APHFSmsOrderActivity.this), ed.b().n().e.l, ed.b().n().e.f, null);
    ...
    locala.b(new gn()
    {
      public void a(APAlertDialog paramAnonymousAPAlertDialog, int paramAnonymousInt, KeyEvent paramAnonymousKeyEvent)
      {
        if (paramAnonymousInt == 4)
        {
          APHFSmsOrderActivity.a(APHFSmsOrderActivity.this, false);
          paramAnonymousAPAlertDialog.a();
          APDataReportManager.getInstance().insertData("sdk.ask.month.keyback", APHFSmsOrderActivity.g(APHFSmsOrderActivity.this), ed.b().n().e.l, ed.b().n().e.f, null);
        }
      }
    });
    try
  ...
  private void b()
  {
    ...
    case 4: 
      ...
      if (!TextUtils.isEmpty(this.y)) {
        ...
        localObject1 = getString(2131230792);
      }
  ...
  private void c()
  {
    ...
    locala.a("已发送", new gn()
    {
      ...
      {
        APHFSmsOrderActivity.a(APHFSmsOrderActivity.this, false);
        APDataReportManager.getInstance().insertData("sdk.ask.sent", APHFSmsOrderActivity.b(APHFSmsOrderActivity.this), ed.b().n().e.l, ed.b().n().e.f, null);
        paramAnonymousAPAlertDialog.a();
        APHFSmsOrderActivity.c(APHFSmsOrderActivity.this);
      }
    });
    locala.b("还没有", new gn()
    {
      ...
      {
        APHFSmsOrderActivity.a(APHFSmsOrderActivity.this, false);
        APDataReportManager.getInstance().insertData("sdk.ask.nonsent", APHFSmsOrderActivity.d(APHFSmsOrderActivity.this), ed.b().n().e.l, ed.b().n().e.f, null);
        paramAnonymousAPAlertDialog.a();
      }
    });
    locala.b(new gn()
    {
      public void a(APAlertDialog paramAnonymousAPAlertDialog, int paramAnonymousInt, KeyEvent paramAnonymousKeyEvent)
      {
        ...
        if ((paramAnonymousInt == 4) && (paramAnonymousKeyEvent.getAction() == 0))
        {
          ...
          APDataReportManager.getInstance().insertData("sdk.ask.keyback", APHFSmsOrderActivity.f(APHFSmsOrderActivity.this), ed.b().n().e.l, ed.b().n().e.f, null);
        }
      }
    });
    try
    {
      locala.c();
      APDataReportManager.getInstance().insertData("sdk.ask.show", this.f, ed.b().n().e.l, ed.b().n().e.f, null);
      return;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      if ((APPermissionActivity.a(this, "android.permission.SEND_SMS")) && ("1".equals(APHFChannel.j)))
      {
        b(this.t, this.u);
        this.z = true;
        ...
        APDataReportManager.getInstance().insertData("sdk.hf.sendsms.sure", this.f, ed.b().n().e.m, "", "sendmethod=background");
        if (this.f == 4)
        {
          if (this.x.equals("2"))
          {
      ...
      paramView.append(this.z);
      APLog.e("APOldHF", paramView.toString());
      APDataReportManager.getInstance().insertData("sdk.hf.sendsms.sure", this.f, ed.b().n().e.m, "", "sendmethod=foreground");
    }
  }
  ...
  public boolean onKeyDown(int paramInt, KeyEvent paramKeyEvent)
  {
    if (paramInt == 4)
    {
      APDataReportManager.getInstance().insertData("sdk.hf.sendsms.keyback", this.f, ed.b().n().e.l, ed.b().n().e.f, null);
      finish();
      APUICommonMethod.b(this);
      return true;
    }
  ...
  {
    super.onResume();
    APDataReportManager.getInstance().insertData("sdk.hf.sendsms.show", this.f, ed.b().n().e.l, ed.b().n().e.f, null);
    StringBuilder localStringBuilder = new StringBuilder();
