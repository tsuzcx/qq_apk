  ...
  private void a()
  {
    ...
    bs.a().g(new kl()
    {
      public void a(jw paramAnonymousjw)
      {
        ...
        {
          paramAnonymousjw = APX5WebMarketActivity.k(APX5WebMarketActivity.this);
          APX5WebMarketActivity.this.a(paramAnonymousjw);
          return;
        }
      ...
      localWebView.setWebViewClient(new WebViewClient()
      {
        ...
        public void onPageStarted(WebView paramAnonymousWebView, String paramAnonymousString, Bitmap paramAnonymousBitmap)
        {
          ...
          if (!APX5WebMarketActivity.g(APX5WebMarketActivity.this))
          {
            ...
            if (paramAnonymousString.startsWith("http://unipay.android.mp.pay")) {
              APDataReportManager.getInstance().insertData("sdk.market.sure", APX5WebMarketActivity.h(APX5WebMarketActivity.this), null, ed.b().n().a.mpInfo.payChannel, fp.a().m());
            }
          }
          try
          {
            es.a().a(APX5WebMarketActivity.this, ed.b().n().a);
          }
          catch (Exception localException)
          {
            label98:
          ...
          {
            APDataReportManager.getInstance().insertData("sdk.market.cancel", APX5WebMarketActivity.i(APX5WebMarketActivity.this), null, ed.b().n().a.mpInfo.payChannel, fp.a().m());
          ...
          {
            APDataReportManager.getInstance().insertData("sdk.market.result.cancel", APX5WebMarketActivity.j(APX5WebMarketActivity.this), null, ed.b().n().a.mpInfo.payChannel, fp.a().m());
            APUICommonMethod.b();
        ...
        public boolean shouldOverrideUrlLoading(WebView paramAnonymousWebView, String paramAnonymousString)
        {
          ...
          if (paramAnonymousString.startsWith("http://unipay.android.mp.pay"))
          {
            ...
            APDataReportManager.getInstance().insertData("sdk.market.sure", APX5WebMarketActivity.a(APX5WebMarketActivity.this), null, ed.b().n().a.mpInfo.payChannel, fp.a().m());
          }
          try
          {
            es.a().a(APX5WebMarketActivity.this, ed.b().n().a);
          ...
          if (paramAnonymousString.startsWith("http://unipay.android.mp.back"))
          {
            APDataReportManager.getInstance().insertData("sdk.market.cancel", APX5WebMarketActivity.b(APX5WebMarketActivity.this), null, ed.b().n().a.mpInfo.payChannel, fp.a().m());
            paramAnonymousWebView.stopLoading();
            fm.a(2, "");
            APX5WebMarketActivity.this.finish();
            APUICommonMethod.b(APX5WebMarketActivity.this);
          ...
          {
            APDataReportManager.getInstance().insertData("sdk.market.result.cancel", APX5WebMarketActivity.c(APX5WebMarketActivity.this), null, ed.b().n().a.mpInfo.payChannel, fp.a().m());
            APUICommonMethod.b();
            if (APX5WebMarketActivity.d(APX5WebMarketActivity.this).equals("showWechatResultActivity")) {
              fm.a(8, 0, 0);
            } else if (APX5WebMarketActivity.d(APX5WebMarketActivity.this).equals("showBankResultActivity")) {
