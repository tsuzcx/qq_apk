  ...
  extends APWebActivity
{
  ...
  public hm v = new hm()
  {
    ...
    public void a(WebView paramAnonymousWebView, String paramAnonymousString)
    {
      ...
      if (paramAnonymousString.startsWith("http://unipay.sdk.android/?")) {
        APWebBuyActivity.a(APWebBuyActivity.this, paramAnonymousString);
      }
    }
    ...
    public void b(WebView paramAnonymousWebView, String paramAnonymousString)
    {
      ...
      if ((paramAnonymousWebView != null) && (("1".equals(paramAnonymousWebView.a())) || ("-1".equals(paramAnonymousWebView.a()))))
      {
        ...
        APLog.i("APWebBuyActivity", paramAnonymousString.toString());
        paramAnonymousString = APWebBuyActivity.this.d;
  ...
  private hl z = new hl()
  {
    ...
    {
      APLog.i("APWebBuyActivity webJsAlert url=", paramAnonymousString1);
      APLog.i("APWebBuyActivity webJsAlert message=", paramAnonymousString2);
      paramAnonymousWebView = paramAnonymousString2.toString();
      if (paramAnonymousWebView.startsWith("http://unipay.sdk.android/?"))
      {
        APWebBuyActivity.a(APWebBuyActivity.this, paramAnonymousWebView);
      }
      else if (j.a(APWebBuyActivity.this, paramAnonymousString1, paramAnonymousString2) == 0)
      {
  ...
  public void c()
  {
    ...
    {
      localhi.a = fp.a().o();
      localhi.p.put("page", hj.s);
      localhi.c = "sdk.gamelist.h5.show";
      localhi.d = "sdk.gamelist.h5.back";
      localhi.e = "sdk.gamelist.h5.click";
      localhi.g = "sdk.gameinput.h5.pay";
      localhi.j = "sdk.gamelist.h5.keyback";
      localhi.k = "sdk.gamelist.h5.error";
      localhi.l = "sdk.gamelist.h5.refresh";
    }
    else if (a.equals(hj.t))
    {
      ...
      localhi.a = str;
      localhi.p.put("page", hj.t);
      localhi.c = "sdk.tuan.h5.show";
      localhi.d = "sdk.tuan.h5.close";
      localhi.g = "sdk.tuan.h5.pay";
      localhi.j = "sdk.tuan.h5.keyback";
      localhi.k = "sdk.tuan.h5.error";
      localhi.l = "sdk.tuan.h5.refresh";
    }
    else if ((!a.equals(hj.u)) && (a.equals(hj.v)))
    {
      ...
      localhi.p.put("page", hj.v);
      localhi.p.put("saveNumber", ed.b().n().e.g);
      localhi.p.put("PortalExtendField", fp.a().L());
      localhi.p.put("appId", this.x);
      localhi.p.put("wxSignUrl", this.y);
      if ((fp.a().A()) && (this.w == 5))
      {
        int i = getIntent().getIntExtra("mcardDepositBalance", 0);
        if (i > 0) {
          localhi.p.put("mcardDepositBalance", APTools.a(i));
        }
      }
      if (!fp.a().B()) {
        localhi.p.put("notShowContinueBuy", "1");
      }
      localhi.h = "sdk.result.h5.pay";
      localhi.d = "sdk.result.h5.back";
      localhi.i = "sdk.result.h5.repay";
      localhi.j = "sdk.result.h5.keyback";
      localhi.c = "sdk.result.h5.show";
      localhi.k = "sdk.result.h5.error";
      localhi.l = "sdk.result.h5.refresh";
    }
    this.q = localhi;
  }
