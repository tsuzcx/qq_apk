  ...
  extends APActivity
{
  ...
  private void b()
  {
    ...
    View localView;
    if (fp.a().g() == "APPayGameInputNumActivity")
    {
      this.d = new hf(this, this.p);
      localView = this.d.a();
      localArrayList.add(localView);
    }
    else
    {
      this.d = new hg(this, this.p);
      localView = this.d.a();
      localArrayList.add(localView);
    }
    new he(this, this.p);
    ...
    if (this.p.a.saveType == 0)
    {
      ...
      ((StringBuilder)localObject).append(((el)this.p.b).b);
    ...
    else if (this.p.a.saveType == 1)
    {
      ...
      ((StringBuilder)localObject).append(((em)this.p.b).b);
      localButton.setText(((StringBuilder)localObject).toString());
    }
    else if (this.p.a.saveType == 5)
    {
      localObject = new StringBuilder();
      ((StringBuilder)localObject).append("购买");
      ((StringBuilder)localObject).append(((en)this.p.b).b);
      localButton.setText(((StringBuilder)localObject).toString());
    }
    else if (this.p.a.saveType == 2)
    {
      localObject = new StringBuilder();
      ((StringBuilder)localObject).append("购买");
      ((StringBuilder)localObject).append(((ep)this.p.b).b);
      localButton.setText(((StringBuilder)localObject).toString());
    }
    else if (this.p.a.saveType == 3)
    {
      localObject = new StringBuilder();
      ((StringBuilder)localObject).append("购买");
      ((StringBuilder)localObject).append(((eo)this.p.b).b);
      localButton.setText(((StringBuilder)localObject).toString());
    }
    this.a.setAdapter(new gu(localArrayList));
