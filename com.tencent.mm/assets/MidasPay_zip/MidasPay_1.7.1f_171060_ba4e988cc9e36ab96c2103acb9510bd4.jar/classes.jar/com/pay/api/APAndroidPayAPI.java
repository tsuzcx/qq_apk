...
public class APAndroidPayAPI
{
  ...
  public static void globalInit(Activity paramActivity, APBaseRequest paramAPBaseRequest)
  {
    ...
    new fq().a(paramActivity.getApplicationContext(), "TencentUnipay", "intCt", "0");
    a.a(env);
    a.a(a);
    System.currentTimeMillis();
    a.a().a(paramActivity, paramAPBaseRequest);
    if (paramAPBaseRequest != null) {
  ...
  public static void launchPay(Activity paramActivity, APBaseRequest paramAPBaseRequest, IAPPayCallBack paramIAPPayCallBack)
  {
    ...
    fv.a();
    APHFChannel.l = APTools.h(paramActivity);
    APHFChannel.k = APHFChannel.l;
    APHFChannel.j = "1";
    APHFChannel.m = APTools.g(paramActivity);
    o.a().i();
    o.a().a(false);
    o.a().f();
    n.b();
