  ...
  implements Cloneable
{
  ...
  private md(int paramInt1, int paramInt2, int paramInt3, int[] paramArrayOfInt)
  {
    this.a = paramInt1;
    this.b = paramInt2;
    this.c = paramInt3;
  ...
  public md a()
  {
    return new md(this.a, this.b, this.c, (int[])this.d.clone());
  }
  ...
  {
    boolean bool1 = paramObject instanceof md;
    boolean bool2 = false;
    if (!bool1) {
      return false;
    }
