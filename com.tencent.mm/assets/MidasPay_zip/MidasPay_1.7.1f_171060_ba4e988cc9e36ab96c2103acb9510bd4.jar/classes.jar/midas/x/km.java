...
public class km
{
  ...
  public void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    paramString3 = kn.a(paramString3, a());
    StringBuilder localStringBuilder = new StringBuilder();
  ...
  public void b(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    paramString3 = kn.a(paramString3, (String)localObject);
  ...
  public boolean b(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    if (TextUtils.isEmpty(paramString2))
    {
      jh.a("HTTP-KeyManager", "Cannot check need change key with empty offer id!");
      return false;
    }
    if (TextUtils.isEmpty(paramString1))
    {
      jh.a("HTTP-KeyManager", "Cannot check need change key with empty open id!");
      return false;
    }
    if (paramContext == null)
    {
      jh.a("HTTP-KeyManager", "Cannot check need change key with null context!");
      return false;
    }
    if (TextUtils.isEmpty(paramString3))
    {
      jh.a("HTTP-KeyManager", "Cannot check need change key with empty sdk version!");
      return false;
    }
    Object localObject = a(paramString1, paramString2);
    ...
    if ((TextUtils.isEmpty((CharSequence)localObject)) || (TextUtils.isEmpty(str1)) || (TextUtils.isEmpty(str2)))
    {
      ...
      ((StringBuilder)localObject).append(paramString2);
      jh.b("HTTP-KeyManager", ((StringBuilder)localObject).toString());
      ...
      if ((!TextUtils.isEmpty((CharSequence)localObject)) && (!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2)))
      {
        ...
        jh.b("HTTP-KeyManager", paramContext.toString());
  ...
  public String c(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    if (TextUtils.isEmpty(paramString1))
    {
      jh.a("HTTP-KeyManager", "Cannot read sec key from disk with empty open id!");
      return "";
    }
    if (TextUtils.isEmpty(paramString2))
    {
      jh.a("HTTP-KeyManager", "Cannot read sec key from disk with empty offer id!");
      return "";
    }
    if (paramContext == null)
    {
      jh.a("HTTP-KeyManager", "Cannot read sec key from disk with null context!");
      return "";
    }
    if (TextUtils.isEmpty(paramString3))
    {
      jh.a("HTTP-KeyManager", "Cannot read sec key from disk with empty sdk version!");
      return "";
    }
    String str2 = a();
    String str1 = "";
    try
    {
      ...
      if (TextUtils.isEmpty(paramContext))
      {
        ...
        paramContext.append(paramString1);
        jh.a("HTTP-KeyManager", paramContext.toString());
        paramContext = str1;
      }
      else
      {
        paramContext = kn.b(paramContext, str2);
      }
      paramString1 = paramContext;
      if (TextUtils.isEmpty(paramContext))
      {
        jh.a("HTTP-KeyManager", "Cannot decode sec key got from disk!");
        paramString1 = "";
      }
      return paramString1;
    }
    catch (Exception paramContext)
    {
      ...
      jh.a("HTTP-KeyManager", paramString1.toString());
    }
    return "";
  }
  ...
  public String d(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    if (TextUtils.isEmpty(paramString1))
    {
      jh.a("HTTP-KeyManager", "Try to read cry key from disk without openid!");
      return "";
    }
    if (paramContext == null)
    {
      jh.a("HTTP-KeyManager", "Try to read cry key from disk with null context!");
      return "";
    }
    if (TextUtils.isEmpty(paramString2))
    {
      jh.a("HTTP-KeyManager", "Try to read cry key from disk without offer id!");
      return "";
    }
    if (TextUtils.isEmpty(paramString3))
    {
      jh.a("HTTP-KeyManager", "Try to read cry key from disk without sdk version!");
      return "";
    }
    String str2 = c(paramContext, paramString1, paramString2, paramString3);
    if (TextUtils.isEmpty(str2))
    {
      jh.a("HTTP-KeyManager", "Cannot read cry key from disk while not able to get sec key!");
      return "";
    }
    String str1 = "";
    try
    ...
    catch (Exception paramContext)
    {
      ...
      jh.a("HTTP-KeyManager", paramString3.toString());
      paramContext = "";
    }
    if (TextUtils.isEmpty(paramContext))
    {
    ...
    if (TextUtils.isEmpty(paramContext))
    {
      jh.a("HTTP-KeyManager", "Read cry key from disk, empty decode result");
      paramString1 = "";
    }
    return paramString1;
  }
