      ...
      if (Integer.parseInt(((JSONObject)localObject1).getString("ret").toString()) == 0)
      {
        ...
        if (((JSONObject)localObject1).has("info"))
        {
          ...
          while (i < ((JSONArray)localObject2).length())
          {
            ...
            localObject3 = new kx((String)localObject3);
            if (TextUtils.isEmpty((CharSequence)localObject4)) {
              ((kx)localObject3).e = Integer.valueOf(0);
            } else if (((String)localObject4).contains("qdiao_best")) {
              ((kx)localObject3).e = Integer.valueOf(1);
            } else if (((String)localObject4).contains("qdiao_better")) {
              ((kx)localObject3).e = Integer.valueOf(2);
            } else {
              ((kx)localObject3).e = Integer.valueOf(3);
            }
        ...
        if (((JSONObject)localObject1).has("info_ipv6"))
        {
          ...
          while (i < ((JSONArray)localObject1).length())
          {
            ...
            localObject2 = new kx((String)localObject2);
            if (TextUtils.isEmpty((CharSequence)localObject3)) {
              ((kx)localObject2).e = Integer.valueOf(0);
            } else if (((String)localObject3).contains("qdiao_best")) {
              ((kx)localObject2).e = Integer.valueOf(1);
            } else if (((String)localObject3).contains("qdiao_better")) {
              ((kx)localObject2).e = Integer.valueOf(2);
            } else {
              ((kx)localObject2).e = Integer.valueOf(3);
            }
