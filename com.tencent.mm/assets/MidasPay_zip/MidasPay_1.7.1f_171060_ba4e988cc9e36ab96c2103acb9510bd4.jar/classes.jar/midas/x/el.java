...
import java.util.List<Lmidas.x.gk;>;

public class el
  extends ek
{
  private String a(List<gk> paramList)
  {
    Object localObject1 = "";
    String str = ed.b().n().e.g;
    ...
    for (int i = 0; j < paramList.size(); i = k)
    {
      ...
      if (i >= localgk.a)
      {
        ...
        ((StringBuilder)localObject2).append(localgk.b);
    ...
    paramList = (List<gk>)localObject1;
  ...
  public String h()
  {
    ...
    {
      Object localObject1 = ed.b().n().a.extendInfo.unit.split("=");
      if (localObject1.length < 2) {
        return ed.b().n().a.extendInfo.unit;
      }
