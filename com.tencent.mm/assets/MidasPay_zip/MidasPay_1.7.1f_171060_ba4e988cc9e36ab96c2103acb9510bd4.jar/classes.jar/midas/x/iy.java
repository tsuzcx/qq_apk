...
public class iy
{
      ...
      new Thread(new Runnable()
      {
        public void run()
        {
          try
          {
            ...
            localix.a(String.valueOf(this.a.length()));
            localix.e("openid", paramString);
            localix.a(this.a);
            new ks().a(localix).a(new ja()
            {
              public void a_(jo paramAnonymous2jo)
              {
                APDataReportManager localAPDataReportManager;
                StringBuilder localStringBuilder;
                if ((paramAnonymous2jo.a != 200) || (paramAnonymous2jo.c != null))
                {
                  localAPDataReportManager = APDataReportManager.getInstance();
                  localStringBuilder = new StringBuilder();
                  localStringBuilder.append("code: ");
                  localStringBuilder.append(paramAnonymous2jo.a);
                  localStringBuilder.append(" exception: ");
                  if (paramAnonymous2jo.c == null) {
                    localObject = "null";
                  } else {
                    localObject = paramAnonymous2jo.c.getMessage();
                  }
                ...
                ((StringBuilder)localObject).append(paramAnonymous2jo.b);
                APLog.d("LOG-UPLOAD", ((StringBuilder)localObject).toString());
                try
                {
                  if (paramAnonymous2jo.b != null)
                  {
                    localObject = new JSONObject(paramAnonymous2jo.b);
                    localAPDataReportManager = APDataReportManager.getInstance();
                    long l = l;
                    localStringBuilder = new StringBuilder();
                ...
                catch (Throwable paramAnonymous2jo)
                {
                  paramAnonymous2jo.printStackTrace();
                }
                try
                {
                  paramAnonymous2jo = iy.3.this.a.getPath();
                  localObject = new StringBuilder();
                  ((StringBuilder)localObject).append(paramAnonymous2jo);
                  ...
                  paramAnonymous2jo = new File(((StringBuilder)localObject).toString());
                  if (paramAnonymous2jo.exists()) {
                    paramAnonymous2jo.delete();
                  }
                }
                catch (Throwable paramAnonymous2jo)
                {
  ...
  private static boolean a()
  {
    ...
    String str1 = ((fq)localObject).a(a.a().d, "TencentUnipay", "logUploadTimes");
    int i;
    ...
    String str2 = ((fq)localObject).a(a.a().d, "TencentUnipay", "logUploadDate");
    localObject = "";
    try
    {
  ...
  private static void b()
  {
    ...
    APLog.e("LOG-UPLOAD", "get today string error");
    str1 = localfq.a(a.a().d, "TencentUnipay", "logUploadDate");
    str2 = localfq.a(a.a().d, "TencentUnipay", "logUploadTimes");
    ...
    if (!((String)localObject).equals(str1)) {
      localfq.a(a.a().d, "TencentUnipay", "logUploadTimes", "1");
    } else {
      i += 1;
    }
    localfq.a(a.a().d, "TencentUnipay", "logUploadDate", (String)localObject);
    localfq.a(a.a().d, "TencentUnipay", "logUploadTimes", String.valueOf(i));
  }
