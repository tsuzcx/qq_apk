...
public class lk
{
  private ExecutorService a = Executors.newSingleThreadExecutor(lo.a("Database"));
  private a b;
  ...
  public void a(final ky paramky)
  {
    lp.a(this.a, new lm()
    {
      /* Error */
      public Object a(Object[] paramAnonymousArrayOfObject)
      {
        ...
        //   1: iconst_0
        //   2: aaload
        //   3: checkcast 29	midas/x/lk$a
        //   6: invokevirtual 33	midas/x/lk$a:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
        //   9: astore_1
        //   10: aload_1
        //   11: astore_2
        ...
        //   31: aload_3
        //   32: aload_0
        //   33: getfield 20	midas/x/lk$2:a	Lmidas/x/ky;
        //   36: getfield 47	midas/x/ky:a	Ljava/lang/String;
        ...
        //   54: aload_3
        //   55: aload_0
        //   56: getfield 20	midas/x/lk$2:a	Lmidas/x/ky;
        //   59: getfield 53	midas/x/ky:e	Ljava/util/concurrent/CopyOnWriteArrayList;
        ...
        //   80: aload_3
        //   81: aload_0
        //   82: getfield 20	midas/x/lk$2:a	Lmidas/x/ky;
        //   85: getfield 53	midas/x/ky:e	Ljava/util/concurrent/CopyOnWriteArrayList;
        ...
        //   103: invokestatic 76	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
        //   106: aload_1
        //   107: astore_2
        //   108: aload_1
        ...
        //   124: iconst_0
        //   125: aload_0
        //   126: getfield 20	midas/x/lk$2:a	Lmidas/x/ky;
        //   129: getfield 47	midas/x/ky:a	Ljava/lang/String;
        //   132: aastore
        ...
        //   138: astore_2
        //   139: aload_0
        //   140: getfield 20	midas/x/lk$2:a	Lmidas/x/ky;
        //   143: getfield 53	midas/x/ky:e	Ljava/util/concurrent/CopyOnWriteArrayList;
        ...
        //   189: ldc 112
        //   191: aload 4
        //   193: getfield 113	midas/x/kx:a	Ljava/lang/String;
        ...
        //   203: ldc 118
        //   205: aload 4
        //   207: invokevirtual 120	midas/x/kx:b	()Ljava/lang/String;
        ...
        //   217: ldc 122
        //   219: aload 4
        //   221: invokevirtual 124	midas/x/kx:a	()Ljava/lang/String;
        ...
        //   231: ldc 126
        //   233: aload 4
        //   235: getfield 130	midas/x/kx:d	Ljava/lang/Integer;
        ...
        //   245: ldc 135
        //   247: aload 4
        //   249: getfield 137	midas/x/kx:e	Ljava/lang/Integer;
        ...
        //   259: ldc 139
        //   261: aload_0
        //   262: getfield 20	midas/x/lk$2:a	Lmidas/x/ky;
        //   265: getfield 47	midas/x/ky:a	Ljava/lang/String;
        ...
        //   299: ldc 145
        //   301: aload_0
        //   302: getfield 20	midas/x/lk$2:a	Lmidas/x/ky;
        //   305: getfield 148	midas/x/ky:b	Ljava/lang/Long;
        ...
        //   314: ldc 153
        //   316: aload_0
        //   317: getfield 20	midas/x/lk$2:a	Lmidas/x/ky;
        //   320: getfield 155	midas/x/ky:d	Ljava/lang/Long;
        ...
        //   339: iconst_0
        //   340: aload_0
        //   341: getfield 20	midas/x/lk$2:a	Lmidas/x/ky;
        //   344: getfield 47	midas/x/ky:a	Ljava/lang/String;
        //   347: aastore
        ...
        //   427: invokestatic 178	midas/x/le:a	(Ljava/lang/String;Ljava/lang/String;)V
        //   430: aload_1
        //   431: astore_2
        //   432: aload_3
  ...
  public void a(final ky paramky, final kx paramkx)
  {
    lp.a(this.a, new lm()
    {
      public Object a(Object[] paramAnonymousArrayOfObject)
      {
        try
        {
          paramAnonymousArrayOfObject = ((lk.a)paramAnonymousArrayOfObject[0]).getWritableDatabase();
          localObject = new ContentValues();
          ((ContentValues)localObject).put("ip", paramkx.a);
          ((ContentValues)localObject).put("measure", paramkx.b());
          ((ContentValues)localObject).put("history", paramkx.a());
          ((ContentValues)localObject).put("historyIndex", paramkx.d);
          ((ContentValues)localObject).put("category", paramkx.e);
          ((ContentValues)localObject).put("netIdentifier", paramky.a);
          paramAnonymousArrayOfObject.update("MidasIPTableVer2", (ContentValues)localObject, "ip=? and netIdentifier=?", new String[] { paramkx.a, paramky.a });
        }
        catch (Exception paramAnonymousArrayOfObject)
        {
          ...
          le.a("database.exception", ((StringBuilder)localObject).toString());
  ...
  public void a(ln paramln)
  {
    lp.a(this.a, new lm()
    {
      ...
      public Object a(Object[] paramAnonymousArrayOfObject)
      {
        ...
        //   10: iconst_0
        //   11: aaload
        //   12: checkcast 28	midas/x/lk$a
        //   15: invokevirtual 32	midas/x/lk$a:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
        //   18: astore 6
        //   20: aload 6
        //   22: ldc 34
        //   24: aconst_null
        ...
        //   112: invokestatic 75	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
        //   115: aload 4
        //   117: ifnull +190 -> 307
        //   120: aload 4
        //   122: astore 5
        ...
        //   187: invokespecial 94	midas/x/ky:<init>	(Ljava/lang/String;)V
        //   190: astore 6
        //   192: aload 4
        //   194: astore 5
        //   196: aload 6
        ...
        //   217: putfield 109	midas/x/ky:b	Ljava/lang/Long;
        //   220: aload 4
        //   222: astore 5
        //   224: aload 6
        //   226: aload 4
        ...
        //   245: putfield 114	midas/x/ky:d	Ljava/lang/Long;
        //   248: aload 4
        //   250: astore 5
        //   252: aload 6
        //   254: aload 4
        ...
        //   273: putfield 119	midas/x/ky:c	Ljava/lang/Long;
        //   276: aload 4
        //   278: astore 5
        //   280: aload 7
        //   282: aload 6
        ...
        //   383: invokestatic 135	midas/x/le:a	(Ljava/lang/String;Ljava/lang/String;)V
        //   386: aload 4
        //   388: astore 5
        //   390: aload 6
        ...
        //   442: invokestatic 75	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
        //   445: aload 7
        ...
        //   484: iconst_0
        //   485: aaload
        //   486: checkcast 28	midas/x/lk$a
        //   489: invokevirtual 32	midas/x/lk$a:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
        //   492: ldc 161
        //   494: aconst_null
        //   495: ldc 163
        //   497: iconst_1
        ...
        //   502: iconst_0
        //   503: aload 9
        //   505: getfield 168	midas/x/ky:a	Ljava/lang/String;
        //   508: aastore
        //   509: aconst_null
        //   510: aconst_null
        //   511: aconst_null
        ...
        //   546: aload 6
        //   548: aload 9
        //   550: getfield 168	midas/x/ky:a	Ljava/lang/String;
        ...
        //   597: invokestatic 75	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
        //   600: aload 4
        //   602: ifnull +206 -> 808
        //   605: aload 4
        //   607: astore 5
        ...
        //   672: invokespecial 177	midas/x/kx:<init>	(Ljava/lang/String;)V
        //   675: astore 6
        //   677: aload 4
        //   679: astore 5
        //   681: aload 6
        ...
        //   699: invokevirtual 181	midas/x/kx:a	(Ljava/lang/String;)V
        //   702: aload 4
        //   704: astore 5
        //   706: aload 4
        //   708: aload 4
        ...
        //   745: iload_3
        //   746: invokevirtual 192	midas/x/kx:a	(Ljava/lang/String;I)V
        //   749: aload 4
        //   751: astore 5
        //   753: aload 6
        //   755: aload 4
        ...
        //   774: putfield 203	midas/x/kx:e	Ljava/lang/Integer;
        //   777: aload 4
        //   779: astore 5
        //   781: aload 10
        //   783: aload 6
        ...
        //   884: invokestatic 135	midas/x/le:a	(Ljava/lang/String;Ljava/lang/String;)V
        //   887: aload 4
        //   889: astore 5
        //   891: aload 6
        ...
        //   908: aload 9
        //   910: getfield 208	midas/x/ky:e	Ljava/util/concurrent/CopyOnWriteArrayList;
        //   913: aload 10
    ...
    }, new Object[] { this.b }, paramln);
  }
  
  /* Error */
  public java.util.ArrayList<ky> b()
  {
    // Byte code:
    ...
    //   7: astore 6
    //   9: aload_0
    //   10: getfield 49	midas/x/lk:b	Lmidas/x/lk$a;
    //   13: invokevirtual 89	midas/x/lk$a:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   16: astore 5
    //   18: aload 5
    //   20: ldc 91
    //   22: aconst_null
    ...
    //   102: invokestatic 131	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   105: aload_3
    //   106: ifnull +169 -> 275
    //   109: aload_3
    //   110: astore 4
    ...
    //   167: invokespecial 149	midas/x/ky:<init>	(Ljava/lang/String;)V
    //   170: astore 5
    //   172: aload_3
    //   173: astore 4
    //   175: aload 5
    ...
    //   194: putfield 164	midas/x/ky:b	Ljava/lang/Long;
    //   197: aload_3
    //   198: astore 4
    //   200: aload 5
    //   202: aload_3
    ...
    //   219: putfield 169	midas/x/ky:c	Ljava/lang/Long;
    //   222: aload_3
    //   223: astore 4
    //   225: aload 5
    //   227: aload_3
    ...
    //   244: putfield 174	midas/x/ky:d	Ljava/lang/Long;
    //   247: aload_3
    //   248: astore 4
    //   250: aload 6
    //   252: aload 5
    ...
    //   345: invokestatic 190	midas/x/le:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   348: aload_3
    //   349: astore 4
    //   351: aload 5
    ...
    //   397: invokestatic 131	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   400: aload 6
    ...
    //   436: astore 9
    //   438: aload_0
    //   439: getfield 49	midas/x/lk:b	Lmidas/x/lk$a;
    //   442: invokevirtual 89	midas/x/lk$a:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   445: ldc 214
    //   447: aconst_null
    //   448: ldc 216
    //   450: iconst_1
    ...
    //   455: iconst_0
    //   456: aload 8
    //   458: getfield 221	midas/x/ky:a	Ljava/lang/String;
    //   461: aastore
    //   462: aconst_null
    //   463: aconst_null
    //   464: aconst_null
    ...
    //   495: aload 5
    //   497: aload 8
    //   499: getfield 221	midas/x/ky:a	Ljava/lang/String;
    ...
    //   542: invokestatic 131	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   545: aload_3
    //   546: ifnull +182 -> 728
    //   549: aload_3
    //   550: astore 4
    ...
    //   607: invokespecial 230	midas/x/kx:<init>	(Ljava/lang/String;)V
    //   610: astore 5
    //   612: aload_3
    //   613: astore 4
    //   615: aload 5
    ...
    //   631: invokevirtual 234	midas/x/kx:a	(Ljava/lang/String;)V
    //   634: aload_3
    //   635: astore 4
    //   637: aload_3
    //   638: aload_3
    ...
    //   671: iload_2
    //   672: invokevirtual 245	midas/x/kx:a	(Ljava/lang/String;I)V
    //   675: aload_3
    //   676: astore 4
    //   678: aload 5
    //   680: aload_3
    ...
    //   697: putfield 256	midas/x/kx:e	Ljava/lang/Integer;
    //   700: aload_3
    //   701: astore 4
    //   703: aload 9
    //   705: aload 5
    ...
    //   799: invokestatic 190	midas/x/le:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   802: aload_3
    //   803: astore 4
    //   805: aload 5
    ...
    //   820: aload 8
    //   822: getfield 261	midas/x/ky:e	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   825: aload 9
  ...
  public void b(final ky paramky)
  {
    lp.a(this.a, new lm()
    {
      /* Error */
      public Object a(Object[] paramAnonymousArrayOfObject)
      {
        ...
        //   8: iconst_0
        //   9: aaload
        //   10: checkcast 29	midas/x/lk$a
        //   13: invokevirtual 33	midas/x/lk$a:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
        //   16: astore 5
        //   18: aload_3
        //   19: astore_2
        //   20: aload 5
        ...
        //   32: iconst_0
        //   33: aload_0
        //   34: getfield 20	midas/x/lk$3:a	Lmidas/x/ky;
        //   37: getfield 44	midas/x/ky:a	Ljava/lang/String;
        //   40: aastore
        //   41: aconst_null
        //   42: aconst_null
        //   43: aconst_null
        ...
        //   73: ldc 61
        //   75: aload_0
        //   76: getfield 20	midas/x/lk$3:a	Lmidas/x/ky;
        //   79: getfield 44	midas/x/ky:a	Ljava/lang/String;
        //   82: invokevirtual 65	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
        //   85: aload_2
        //   86: ldc 67
        //   88: aload_0
        //   89: getfield 20	midas/x/lk$3:a	Lmidas/x/ky;
        //   92: getfield 70	midas/x/ky:b	Ljava/lang/Long;
        //   95: invokevirtual 73	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
        //   98: aload_2
        //   99: ldc 75
        //   101: aload_0
        //   102: getfield 20	midas/x/lk$3:a	Lmidas/x/ky;
        //   105: getfield 78	midas/x/ky:d	Ljava/lang/Long;
        //   108: invokevirtual 73	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
        //   111: aload_2
        //   112: ldc 80
        //   114: aload_0
        //   115: getfield 20	midas/x/lk$3:a	Lmidas/x/ky;
        //   118: getfield 83	midas/x/ky:c	Ljava/lang/Long;
        ...
        //   136: iconst_0
        //   137: aload_0
        //   138: getfield 20	midas/x/lk$3:a	Lmidas/x/ky;
        //   141: getfield 44	midas/x/ky:a	Ljava/lang/String;
        //   144: aastore
        ...
        //   216: invokestatic 110	midas/x/le:a	(Ljava/lang/String;Ljava/lang/String;)V
        //   219: aload_1
        //   220: astore_2
        //   221: aload_3
  ...
  public void c(final ky paramky)
  {
    lp.a(this.a, new lm()
    {
      /* Error */
      public Object a(Object[] paramAnonymousArrayOfObject)
      {
        ...
        //   8: iconst_0
        //   9: aaload
        //   10: checkcast 30	midas/x/lk$a
        //   13: invokevirtual 34	midas/x/lk$a:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
        //   16: astore 5
        //   18: aload_3
        //   19: astore_2
        //   20: aload 5
        ...
        //   32: iconst_0
        //   33: aload_0
        //   34: getfield 21	midas/x/lk$4:a	Lmidas/x/ky;
        //   37: getfield 45	midas/x/ky:a	Ljava/lang/String;
        //   40: aastore
        //   41: aconst_null
        //   42: aconst_null
        //   43: aconst_null
        ...
        //   73: ldc 62
        //   75: aload_0
        //   76: getfield 21	midas/x/lk$4:a	Lmidas/x/ky;
        //   79: getfield 45	midas/x/ky:a	Ljava/lang/String;
        //   82: invokevirtual 66	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
        //   85: aload_2
        //   86: ldc 68
        //   88: aload_0
        //   89: getfield 21	midas/x/lk$4:a	Lmidas/x/ky;
        //   92: getfield 71	midas/x/ky:b	Ljava/lang/Long;
        //   95: invokevirtual 74	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
        //   98: aload_2
        //   99: ldc 76
        //   101: aload_0
        //   102: getfield 21	midas/x/lk$4:a	Lmidas/x/ky;
        //   105: getfield 79	midas/x/ky:d	Ljava/lang/Long;
        //   108: invokevirtual 74	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
        //   111: aload_2
        //   112: ldc 81
        //   114: aload_0
        //   115: getfield 21	midas/x/lk$4:a	Lmidas/x/ky;
        //   118: getfield 83	midas/x/ky:c	Ljava/lang/Long;
        ...
        //   201: invokestatic 110	midas/x/le:a	(Ljava/lang/String;Ljava/lang/String;)V
        //   204: aload_1
        //   205: astore_2
        //   206: aload_3
  ...
  public void d(final ky paramky)
  {
    lp.a(this.a, new lm()
    {
      /* Error */
      public Object a(Object[] paramAnonymousArrayOfObject)
      {
        ...
        //   5: iconst_0
        //   6: aaload
        //   7: checkcast 30	midas/x/lk$a
        //   10: invokevirtual 34	midas/x/lk$a:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
        //   13: astore_1
        //   14: aload_1
        ...
        //   28: iconst_0
        //   29: aload_0
        //   30: getfield 21	midas/x/lk$5:a	Lmidas/x/ky;
        //   33: getfield 50	midas/x/ky:a	Ljava/lang/String;
        //   36: aastore
        ...
        //   51: iconst_0
        //   52: aload_0
        //   53: getfield 21	midas/x/lk$5:a	Lmidas/x/ky;
        //   56: getfield 50	midas/x/ky:a	Ljava/lang/String;
        //   59: aastore
        ...
        //   149: invokestatic 89	midas/x/le:a	(Ljava/lang/String;Ljava/lang/String;)V
        //   152: aload_1
        //   153: astore_2
        //   154: aload_3
