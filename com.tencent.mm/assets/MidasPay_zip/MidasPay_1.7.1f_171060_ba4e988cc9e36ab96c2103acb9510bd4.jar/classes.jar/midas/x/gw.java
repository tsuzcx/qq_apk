  ...
  extends gv
{
  ...
  private TextWatcher o = new TextWatcher()
  {
    ...
    {
      Object localObject = (LinearLayout)gw.b(gw.this).findViewById(2131099860);
      TextView localTextView = (TextView)gw.b(gw.this).findViewById(2131099985);
      int i;
      if (paramAnonymousEditable.toString().length() > 0)
      {
        gw.this.j.setVisibility(0);
        ...
        gw.b(gw.this).setVisibility(0);
        ((LinearLayout)localObject).setVisibility(0);
        localObject = new StringBuilder();
        ((StringBuilder)localObject).append(gw.this.f.getString(2131230878));
        ((StringBuilder)localObject).append(ed.b().n().b.b(paramAnonymousEditable.toString().trim()));
        localTextView.setText(((StringBuilder)localObject).toString());
        i = i.a(paramAnonymousEditable.toString());
        if ((gw.this.a <= 0) || (i <= gw.this.a)) {}
      }
      try
      {
        paramAnonymousEditable.delete(paramAnonymousEditable.length() - 1, paramAnonymousEditable.length());
        label216:
        APUICommonMethod.a(gw.this.f, "购买数量不能超过最大限制");
        i = paramAnonymousEditable.toString().length();
        if (i > 0)
        {
          gw.this.k.setSelection(i);
          break label272;
          gw.this.j.setVisibility(4);
          ((LinearLayout)localObject).setVisibility(8);
        }
        label272:
        if (gw.this.c.a.saveType == 0) {
          gw.a(gw.this, paramAnonymousEditable.toString());
        }
        return;
      }
  ...
  public gw(ScrollView paramScrollView, APGridView paramAPGridView, Activity paramActivity, String[] paramArrayOfString1, String[] paramArrayOfString2, String[] paramArrayOfString3)
  {
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    ((StringBuilder)localObject1).append(ed.b().n().b.b(paramView));
  ...
  private void b(View paramView, int paramInt)
  {
    ...
    if (this.f.getResources().getConfiguration().orientation == 1) {
      this.k.setOnTouchListener(new View.OnTouchListener()
      {
        ...
        {
          gw.this.e.postDelayed(new Runnable()
          {
            public void run()
            {
              gw.this.e.fullScroll(130);
              gw.this.k.requestFocus();
            }
          }, 500L);
          return false;
        }
    ...
    this.j.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        paramAnonymousView = gw.this.k.getText().toString();
        if (!TextUtils.isEmpty(paramAnonymousView))
        {
          gw.this.c.e.g = paramAnonymousView;
          if (gw.this.c.e.g == null) {
            paramAnonymousView = "";
          } else {
            paramAnonymousView = gw.this.c.e.g;
          }
          StringBuilder localStringBuilder = new StringBuilder();
          localStringBuilder.append("a");
          localStringBuilder.append(paramAnonymousView);
          paramAnonymousView = localStringBuilder.toString();
          APDataReportManager.getInstance().insertData("sdk.gamelist.else", gw.this.c.a.saveType, null, paramAnonymousView, null);
        }
        gw.a(gw.this);
      }
    });
