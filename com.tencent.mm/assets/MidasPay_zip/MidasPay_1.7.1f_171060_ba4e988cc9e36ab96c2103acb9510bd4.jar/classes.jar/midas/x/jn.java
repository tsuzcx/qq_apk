...
public class jn
{
  ...
  public void a(SSLSocketFactory paramSSLSocketFactory)
  {
    ...
    {
      jh.b("HTTP-REQUEST", "Set custom SSLSocketFactory!");
      this.s = paramSSLSocketFactory;
      return;
    }
    jh.a("HTTP-REQUEST", "Try to set a null SSLSocketFactory");
  }
  ...
  public final void e(String paramString1, String paramString2)
  {
    ...
    jh.a("HTTP-REQUEST", "Adding Http parameter with empty key!");
  }
  ...
  public void w()
  {
    ...
    jh.b("HTTP-REQUEST", localStringBuilder.toString());
    if (Looper.myLooper() == Looper.getMainLooper())
    {
      new Thread(new Runnable()
      {
        public void run()
        {
          if (jn.this.p != null)
          {
            jn.this.p.disconnect();
            jh.b("HTTP-REQUEST", "Request stop, disconnect connection!");
            return;
          }
          jh.b("HTTP-REQUEST", "Request stop, no connection!");
        }
      }).start();
      return;
    }
