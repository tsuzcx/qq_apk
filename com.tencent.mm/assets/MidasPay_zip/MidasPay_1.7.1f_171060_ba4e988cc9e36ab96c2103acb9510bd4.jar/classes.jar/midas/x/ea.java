  ...
  extends br
{
  ...
  {
    int i = ed.b().g();
    Object localObject3 = ed.b().n();
    if (localObject3 == null)
    {
      APLog.e("QRCodePay-QRCodeReq", "Cannot get qr code with null order info!");
      return;
    }
    Object localObject2 = ((ec)localObject3).a;
    if (localObject2 == null)
    {
      APLog.e("QRCodePay-QRCodeReq", "Cannot get qr code with null request!");
      return;
    }
    Object localObject1 = fp.a();
    e("offer_id", ed.b().f());
    e("openid", ((APBaseRequest)localObject2).openId);
    e("pf", ((ec)localObject3).a.pf);
    e("pfkey", ((ec)localObject3).a.pfKey);
    e("format", "json");
    e("sdkversion", "1.7.1f");
    e("size", "600");
    e("uuid", fp.a().i());
    e("pushtype", "NodeJS");
    e("extend", ((fp)localObject1).y());
    e("user_imei", APTools.a(((fp)localObject1).r(), 1));
    e("user_androidid", APTools.a(((fp)localObject1).s(), 1));
    e("user_mac", APTools.a(((fp)localObject1).t(), 1));
    ...
    default: 
      break;
    case 5: 
      localObject1 = (en)ed.b().n().b;
      f("service_code", ((APMonthRequest)((ec)localObject3).a).serviceCode);
      e("product_id", ((en)localObject1).k);
