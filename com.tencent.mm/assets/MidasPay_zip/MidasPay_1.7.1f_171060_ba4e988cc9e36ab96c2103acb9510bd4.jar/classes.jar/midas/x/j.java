...
public class j
{
  ...
  public static int a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    {
      b = paramString2.substring("midas_js_bridge_".length());
      try
      {
  ...
  private static void a(Activity paramActivity, String paramString, JSONObject paramJSONObject)
  {
