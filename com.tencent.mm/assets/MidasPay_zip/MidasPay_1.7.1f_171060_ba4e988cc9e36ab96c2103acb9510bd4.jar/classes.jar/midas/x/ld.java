...
public class ld
{
      ...
      if ((!TextUtils.isEmpty(paramString2)) && (paramString2.contains("packets transmitted,")))
      {
        ...
        if ((!TextUtils.isEmpty(paramString2)) && (paramString2.startsWith("rtt min/avg/max/mdev")))
        {
          ...
          if (arrayOfString.length > 1)
          {
            ...
            lc.b("IPMeasure", ((StringBuilder)localObject).toString());
  ...
  public static void a(ExecutorService paramExecutorService, ky paramky, ln paramln)
  {
    long l1 = System.currentTimeMillis();
    if ((paramky.e.size() > 0) && (a(l1)))
    {
      b(l1);
      final long l2 = paramky.c.longValue();
      paramky.c = Long.valueOf(l1);
      b(paramExecutorService, paramky, new ln()
      {
    ...
    paramExecutorService.append(paramky.e.size());
    lc.c("IPMeasure", paramExecutorService.toString());
  }
  
  public static void a(ky paramky)
  {
    ...
    lc.b("IPMeasure", localStringBuilder.toString());
    if (paramky != null)
    {
      if (paramky.a == null) {
        return;
      }
      if (d.containsKey(paramky.a)) {
        d.put(paramky.a, Boolean.valueOf(true));
      }
      return;
    }
  }
  ...
  private static boolean a(long paramLong)
  {
    ...
    lc.a("IPMeasure", localStringBuilder.toString());
    return false;
  }
  ...
  private static String b(java.io.InputStream paramInputStream, String paramString)
  {
    ...
    //   158: invokestatic 164	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   161: goto +7 -> 168
    //   164: aload_0
    ...
    //   242: invokestatic 215	midas/x/lc:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   245: goto +10 -> 255
    //   248: aload_3
    //   249: astore_2
    //   250: aload 4
    ...
    //   317: invokestatic 164	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   320: aconst_null
    //   321: areturn
    //   322: aload_0
    ...
    //   398: invokestatic 164	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   401: goto +7 -> 408
    //   404: aload_0
  ...
  private static ArrayList<Pair<String, Long>> b(String paramString1, String paramString2, ArrayList<String> paramArrayList)
  {
    ...
    //   41: aload_0
    //   42: invokestatic 325	midas/x/ld:a	(Ljava/lang/String;)Z
    //   45: ifeq +14 -> 59
    //   48: ldc 156
    //   50: ldc_w 327
    //   53: invokestatic 164	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   56: aload 17
    //   58: areturn
    //   59: aload_2
    ...
    //   112: invokestatic 164	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   115: ldc 90
    //   117: astore 9
    ...
    //   188: invokestatic 349	midas/x/le:a	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   232: invokestatic 164	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   235: aconst_null
    //   236: astore 10
    //   238: iconst_0
    //   239: istore_3
    ...
    //   248: aload_0
    //   249: invokestatic 325	midas/x/ld:a	(Ljava/lang/String;)Z
    //   252: ifeq +24 -> 276
    //   255: ldc 156
    //   257: ldc_w 327
    //   260: invokestatic 164	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   263: aload 10
    //   265: ifnull +8 -> 273
    //   268: aload 10
    ...
    //   284: astore 19
    //   286: getstatic 176	midas/x/ld:e	Lmidas/x/kw$e;
    //   289: ifnull +18 -> 307
    //   292: getstatic 176	midas/x/ld:e	Lmidas/x/kw$e;
    //   295: aload 19
    //   297: invokeinterface 363 2 0
    //   302: astore 9
    //   304: goto +10 -> 314
    //   307: aload 19
    //   309: invokestatic 365	midas/x/ld:b	(Ljava/lang/String;)Ljava/lang/String;
    //   312: astore 9
    ...
    //   630: invokestatic 164	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   633: aload 10
    //   635: astore 13
    //   637: aload 9
    //   639: astore 14
    ...
    //   1024: invokestatic 215	midas/x/lc:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   1027: aload 10
    //   1029: astore 13
    //   1031: aload 9
    //   1033: astore 14
    ...
    //   1227: invokestatic 164	midas/x/lc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   1230: ldc 90
    //   1232: astore_0
    ...
    //   1321: invokestatic 349	midas/x/le:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   1324: aload 17
    //   1326: areturn
    //   1327: astore_0
    //   1328: aload 10
  ...
  private static ArrayList<Pair<String, Long>> b(ExecutorService paramExecutorService, String paramString1, String paramString2, ArrayList<String> paramArrayList)
  {
    ...
    if (a(paramString1))
    {
      lc.b("IPMeasure", "ping Thread isInterrupted");
    ...
    catch (Exception localException1)
    {
      ...
      lc.b("IPMeasure", ((StringBuilder)localObject3).toString());
    }
    ...
    le.a("measure.ping", ((StringBuilder)localObject1).toString());
    long l = c / 1000L;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (a(paramString1))
      {
        ...
        lc.b("IPMeasure", paramExecutorService.toString());
        return localArrayList;
      }
      if (ls.b(str3)) {}
      ...
      try
      {
        ...
        lc.b("IPMeasure", ((StringBuilder)localObject4).toString());
        ...
        try
        {
          ...
          lc.b("IPMeasure", ((StringBuilder)localObject1).toString());
      ...
      try
      {
        localObject4 = new Runnable()
        {
          public void run()
          {
            String str = ld.a(this.a.getErrorStream(), "error");
            StringBuilder localStringBuilder = new StringBuilder();
  ...
  {
    f = paramLong;
    lj.a("lastMeasureTime", f);
  }
  
  private static void b(ExecutorService paramExecutorService, final String paramString1, ArrayList<String> paramArrayList, final String paramString2, ln paramln)
  {
    if (a(paramString1)) {
      return;
    }
    ...
    long l2 = c;
    lp.a(paramExecutorService, paramExecutorService, new lm()
    {
      public Object a(Object[] paramAnonymousArrayOfObject)
      {
        return ld.a(this.a, paramString1, paramString2, (ArrayList)paramAnonymousArrayOfObject[0]);
      }
    }, new Object[] { paramArrayList }, paramln, l1 * l2 + 5000L);
  }
  
  public static void b(final ExecutorService paramExecutorService, final ky paramky, ln paramln)
  {
    int i = ls.b(kv.a, true);
    boolean bool1 = ls.a(i);
    boolean bool2 = ls.b(i);
    if (bool1) {
      localObject1 = "4";
    } else {
      localObject1 = "";
    ...
    Iterator localIterator = paramky.e.iterator();
    while (localIterator.hasNext())
    {
      kx localkx = (kx)localIterator.next();
      if ((bool1) && (bool2)) {
        ((ArrayList)localObject1).add(localkx.a);
      } else if ((bool1) && (!bool2))
      {
        if (ls.a(localkx.a)) {
          ((ArrayList)localObject1).add(localkx.a);
      ...
      else if ((!bool1) && (bool2) && (ls.b(localkx.a))) {
        ((ArrayList)localObject1).add(localkx.a);
      }
    }
    ...
    d.put(paramky.a, Boolean.valueOf(false));
    b(paramExecutorService, paramky.a, (ArrayList)localObject1, (String)localObject2, new ln()
    {
      public void a(int paramAnonymousInt, Object paramAnonymousObject)
      {
        if ((paramAnonymousObject != null) && ((paramAnonymousObject instanceof ArrayList)))
        ...
        paramAnonymousObject.append(ld.a());
        lc.b("IPMeasure", paramAnonymousObject.toString());
        ld.a(paramExecutorService, paramky.a, this.d, this.e, this.a);
      }
    });
  }
  
  public static boolean b(ky paramky)
  {
    if (paramky == null) {
      return false;
    }
    long l1 = System.currentTimeMillis();
    long l2 = paramky.c.longValue();
    ...
    paramky.append(bool);
    lc.b("IPMeasure", paramky.toString());
    return l1 > b;
  }
  
  private static void c(ExecutorService paramExecutorService, String paramString1, ArrayList<String> paramArrayList, final String paramString2, ln paramln)
  {
    long l1 = paramArrayList.size();
    long l2 = c;
    lp.a(paramExecutorService, paramExecutorService, new lm()
    {
      public Object a(Object[] paramAnonymousArrayOfObject)
      {
        return ld.a(this.a, paramString2, (ArrayList)paramAnonymousArrayOfObject[0]);
      }
    }, new Object[] { paramArrayList }, paramln, l1 * l2 + 5000L);
  }
}
