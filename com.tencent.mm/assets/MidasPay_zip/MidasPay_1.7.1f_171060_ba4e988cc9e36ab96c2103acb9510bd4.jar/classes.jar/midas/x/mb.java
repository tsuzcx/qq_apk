...
public class mb
{
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Hashtable<lx, Object> paramHashtable)
  {
  ...
  public static md a(String paramString, int paramInt1, int paramInt2, Hashtable<lx, Object> paramHashtable)
  {
    try
    {
      if (a == null) {
      ...
      paramString = a.a(paramString, lw.l, paramInt1, paramInt2, paramHashtable);
      return paramString;
    }
    catch (ma paramString)
    {
