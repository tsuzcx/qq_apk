...
public class ls
{
  ...
  private static int a(Context paramContext)
  {
    ...
    catch (Exception paramContext)
    {
      ...
      lc.a("NetworkStatus", ((StringBuilder)localObject).toString());
    }
    return -1;
  }
  ...
  public static String a(Context paramContext, boolean paramBoolean)
  {
    ...
    ((StringBuilder)???).append("?");
    lc.a("NetworkStatus", ((StringBuilder)???).toString());
    a = l;
  ...
  public static int b(Context paramContext, boolean paramBoolean)
  {
    ...
    ((StringBuilder)localObject1).append("?");
    lc.a("NetworkStatus", ((StringBuilder)localObject1).toString());
    e = l;
    try
    {
    ...
    if (i < j)
    {
      ...
      if ((localNetworkInfo != null) && (localNetworkInfo.isAvailable()) && (localNetworkInfo.isConnected()))
      {
        ...
        if (j == 0)
        {
          lc.b("NetworkStatus", "getLocalIPvX() by 1.ConnectivityManager");
          if (d != i) {
            d = i;
          }
        }
        ...
        {
          lc.b("NetworkStatus", "getLocalIPvX() by 2.NetworkInterface");
          j = i;
          do
          {
            do
  ...
  private static String b(Context paramContext)
  {
    ...
    if ((localObject1 != null) && (((NetworkInfo)localObject1).getType() == 1))
    {
      ...
      try
      {
        if (lq.a(paramContext, "android.permission.ACCESS_WIFI_STATE")) {
      ...
      if ("<unknown ssid>".equals(localObject4))
      {
        ...
        if ("02:00:00:00:00:00".equals(((WifiInfo)localObject2).getBSSID()))
        {
          ...
          paramContext.append(" !");
          lc.c("NetworkStatus", paramContext.toString());
          paramContext = new StringBuilder();
          ...
          if (Build.VERSION.SDK_INT >= 27)
          {
            ...
            ((StringBuilder)localObject3).append(lr.a("android.permission.ACCESS_COARSE_LOCATION"));
            ...
            localObject3 = new StringBuilder();
            ((StringBuilder)localObject3).append(paramContext);
            ((StringBuilder)localObject3).append(lr.a("android.permission.ACCESS_FINE_LOCATION"));
            paramContext = ((StringBuilder)localObject3).toString();
          }
          localObject3 = paramContext;
          if (Build.VERSION.SDK_INT >= 28)
          {
            localObject3 = (LocationManager)kv.a.getSystemService("location");
          ...
          paramContext.append("&");
          paramContext.append((String)localObject3);
          le.a("wifi.ssid", paramContext.toString());
