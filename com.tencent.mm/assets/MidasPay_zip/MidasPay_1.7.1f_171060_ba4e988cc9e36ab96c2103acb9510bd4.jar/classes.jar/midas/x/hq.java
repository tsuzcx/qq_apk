...
public class hq
{
  ...
  private WebChromeClient o = new WebChromeClient()
  {
    public boolean onJsAlert(WebView paramAnonymousWebView, String paramAnonymousString1, String paramAnonymousString2, JsResult paramAnonymousJsResult)
    {
      ...
      APLog.i("inner onJsAlert mContext", hq.a(hq.this).toString());
      if (j.a(hq.a(hq.this), paramAnonymousString1, paramAnonymousString2) == 0)
      {
      ...
      if ((!paramAnonymousString2.startsWith("http://unipay.sdk.android/?")) && (!paramAnonymousString2.startsWith("https://unipay.sdk.android/?")))
      {
        ...
        {
          hq.b(hq.this).a(paramAnonymousWebView, paramAnonymousString1, paramAnonymousString2, paramAnonymousJsResult);
          paramAnonymousJsResult.cancel();
          return true;
        }
        ...
        {
          hq.a(hq.this, paramAnonymousString2);
          paramAnonymousJsResult.cancel();
          return true;
        }
    ...
    {
      return hq.b(hq.this).a(paramAnonymousWebView, paramAnonymousString1, paramAnonymousString2, paramAnonymousString3, paramAnonymousJsPromptResult);
    }
    ...
    public void onReceivedTitle(WebView paramAnonymousWebView, String paramAnonymousString)
    {
      ...
      if ((paramAnonymousString != null) && (!paramAnonymousString.contains("html")) && (!paramAnonymousString.contains("?"))) {
        hq.b(hq.this).b(paramAnonymousWebView, paramAnonymousString);
      }
    }
  };
  private WebViewClient p = new WebViewClient()
  {
    public void onPageFinished(WebView paramAnonymousWebView, String paramAnonymousString)
    {
      ...
      hq.this.e();
      APX5RoundedWebView localAPX5RoundedWebView = hq.c(hq.this);
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append("javascript:");
      localStringBuilder.append(j.a);
      localAPX5RoundedWebView.loadUrl(localStringBuilder.toString());
      hq.b(hq.this).a(paramAnonymousWebView, paramAnonymousString);
    }
    ...
    public void onPageStarted(WebView paramAnonymousWebView, String paramAnonymousString, Bitmap paramAnonymousBitmap)
    {
      ...
      hq.b(hq.this).a(paramAnonymousWebView, paramAnonymousString, paramAnonymousBitmap);
    }
    ...
    public void onReceivedError(WebView paramAnonymousWebView, int paramAnonymousInt, String paramAnonymousString1, String paramAnonymousString2)
    {
      ...
      if (!paramAnonymousString2.startsWith("http://unipay.sdk.android/?"))
      {
        ...
        if (hq.b(hq.this) != null) {
          hq.b(hq.this).a(paramAnonymousWebView, paramAnonymousInt, paramAnonymousString1, paramAnonymousString2);
        }
        return;
      }
    }
  ...
  public hq(Activity paramActivity, hu paramhu)
  {
