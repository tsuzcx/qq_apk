...
public class ms
{
  ...
  public static ms a(Context paramContext)
  {
        ...
        InvocationHandler local1 = new InvocationHandler()
        {
            ...
            throws Throwable
          {
            ...
            if (???.getName().equals("onResp"))
            {
              ...
              paramAnonymousObject.putInt("type", ((Integer)ms.b.a(???, "getType", new Class[0], new Object[0])).intValue());
              ...
              while (i < j)
              {
                ...
                if (((Field)localObject).getType().isPrimitive()) {
                  ms.b.a(paramAnonymousObject, ???, (Field)localObject);
                  ...
                  if (((Field)localObject).getType().getComponentType().isPrimitive()) {
                    ms.b.b(paramAnonymousObject, ???, (Field)localObject);
              ...
              synchronized (ms.a(ms.this))
              {
                paramAnonymousArrayOfObject = ms.a(ms.this).iterator();
  ...
  public boolean b()
  {
    return lt.a(b.a("modelbiz.WXLaunchMiniProgram$Req"));
  }
  ...
  static class a
  {
    ...
    private static ms b(Context paramContext)
    {
      if (a == null) {
        a = new ms(paramContext, null);
      }
      return a;
    }
  }
