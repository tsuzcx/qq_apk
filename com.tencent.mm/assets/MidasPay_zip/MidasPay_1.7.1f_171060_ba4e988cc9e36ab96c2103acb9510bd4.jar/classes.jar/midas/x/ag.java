...
public class ag
{
  ...
  public void a(ak paramak)
  {
    ...
    //   32: ldc 201
    //   34: invokestatic 206	midas/x/fx:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   37: astore 4
    //   39: aload_1
  ...
  public void a(final ga paramga)
  {
    paramga = new a(new ga()
    {
      ...
      {
        paramga.a(paramAnonymousInt1, paramAnonymousInt2, paramAnonymousInt3, paramAnonymousObject, paramAnonymousBundle);
      }
    });
    this.g.post(new Runnable()
    {
  ...
  public void b(final ga paramga)
  {
    paramga = new a(new ga()
    {
      public void a(int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3, Object paramAnonymousObject, Bundle paramAnonymousBundle)
    ...
    this.g.post(new Runnable()
    {
      ...
      public void run()
      {
        ...
        //   897: aload 9
        //   899: ldc 216
        //   901: invokestatic 221	midas/x/fx:b	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
        //   904: iconst_0
        //   905: iload_3
        ...
        //   944: aload 9
        //   946: ldc 216
        //   948: invokestatic 231	midas/x/fx:c	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
        //   951: iconst_0
        //   952: iload_3
        ...
        //   1036: aload 9
        //   1038: ldc 216
        //   1040: invokestatic 231	midas/x/fx:c	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
        //   1043: iconst_0
        //   1044: iload_3
  ...
  static class a
    extends Handler
  {
    private WeakReference<ga> a;
    
    public a(ga paramga)
    {
      super();
      this.a = new WeakReference(paramga);
    }
    
    public void handleMessage(Message paramMessage)
    {
      ga localga = (ga)this.a.get();
      if (localga != null) {
        localga.a(paramMessage.what, paramMessage.arg1, paramMessage.arg2, paramMessage.obj, paramMessage.getData());
      }
    }
  }
}
