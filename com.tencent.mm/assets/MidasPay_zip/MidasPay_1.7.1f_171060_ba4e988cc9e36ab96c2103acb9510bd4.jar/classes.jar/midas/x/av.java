...
public class av
{
  ...
  public static void b(Context paramContext)
  {
    ...
    fq localfq = new fq();
    if (("true".equals(localfq.a(paramContext.getApplicationContext(), "TencentUnipay", "processUpdateDex"))) && (APAppDataInterface.singleton().x()))
    {
      ...
      localfq.a(paramContext.getApplicationContext(), "TencentUnipay", "processUpdateDex", "false");
    }
  }
  ...
  {
    new fq().a(paramContext.getApplicationContext(), "TencentUnipay", "processUpdateDex", "true");
    if (a.a().l())
    {
