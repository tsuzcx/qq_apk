  ...
  implements Thread.UncaughtExceptionHandler
{
  ...
  {
    if (!(Thread.getDefaultUncaughtExceptionHandler() instanceof fo)) {
      Thread.setDefaultUncaughtExceptionHandler(new fo());
    }
  }
  ...
  public void uncaughtException(Thread paramThread, Throwable paramThrowable)
  {
    ...
    ((StringBuilder)localObject).append(ed.b().f());
    APLog.e("PAY CRASH", ((StringBuilder)localObject).toString());
    localObject = new StringBuilder();
    ((StringBuilder)localObject).append("# CRASH APP OPENID:  ");
    ((StringBuilder)localObject).append(ed.b().e());
    APLog.e("PAY CRASH", ((StringBuilder)localObject).toString());
    localObject = new StringBuilder();
