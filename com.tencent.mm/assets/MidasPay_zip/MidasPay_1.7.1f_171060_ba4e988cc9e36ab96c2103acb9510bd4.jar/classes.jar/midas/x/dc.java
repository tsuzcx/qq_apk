  ...
  extends bx
{
  ...
  {
    this.a = paramString;
    a("https", String.format("/v1/r/%s/mobile_month_info", new Object[] { ed.b().n().a.offerId }), "442");
    b();
  }
  ...
  private void a(eq parameq)
  {
    ...
    if ((a.a().j()) && ((((ec)localObject).a.saveType == 2) || (((ec)localObject).a.saveType == 3))) {
      bool1 = ((ec)localObject).d.e;
    } else if (((!d.a()) || ((((ec)localObject).a.saveType != 2) && (((ec)localObject).a.saveType != 3))) && (d.b()) && (((ec)localObject).a.saveType != 2)) {
      int i = ((ec)localObject).a.saveType;
    }
