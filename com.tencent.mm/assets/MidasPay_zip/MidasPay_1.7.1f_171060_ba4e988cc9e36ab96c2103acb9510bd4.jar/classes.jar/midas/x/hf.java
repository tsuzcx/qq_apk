  ...
  extends hd
{
  ...
  TextWatcher b = new TextWatcher()
  {
    public void afterTextChanged(Editable paramAnonymousEditable)
    {
      ...
      {
        hf.a(hf.this).setText("");
        hf.a(hf.this, "");
      }
      else if (i.a((String)localObject) > hf.b(hf.this))
      {
        if (hf.this.a.a.saveType == 4)
        {
          if (((en)hf.this.a.b).l == 3)
          {
            paramAnonymousEditable = hf.c(hf.this);
            localObject = new StringBuilder();
            ((StringBuilder)localObject).append("升级时长最多不超过");
            ((StringBuilder)localObject).append(hf.b(hf.this));
            ((StringBuilder)localObject).append("个月");
            APUICommonMethod.a(paramAnonymousEditable, ((StringBuilder)localObject).toString());
            hf.a(hf.this).setText(String.valueOf(hf.b(hf.this)));
            return;
          }
          APUICommonMethod.a(hf.c(hf.this), "购买数量不能超过最大限制");
        }
        else if (hf.this.a.a.saveType != 0) {}
      }
      try
      {
        ...
        APUICommonMethod.a(hf.c(hf.this), "购买数量不能超过最大限制");
        label264:
        hf.a(hf.this, (String)localObject);
        int i = hf.a(hf.this).getText().length();
        if (i > 0) {
          hf.a(hf.this).setSelection(i);
        }
        hf.this.e();
        return;
      }
  ...
  public hf(Activity paramActivity, ec paramec)
  {
  ...
  private void f()
  {
    ...
    this.j.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        paramAnonymousView = hf.a(hf.this).getText().toString();
        if (!TextUtils.isEmpty(paramAnonymousView))
        {
          hf.this.a.e.g = paramAnonymousView;
          hf.this.d();
          return;
        }
        Toast.makeText(hf.c(hf.this), "充值数量不能为空", 1).show();
      }
    });
    int i1 = this.c;
    if ((this.a.a.saveType != 0) || (fp.a().ae() <= 0)) {
      ...
      public boolean onEditorAction(TextView paramAnonymousTextView, int paramAnonymousInt, KeyEvent paramAnonymousKeyEvent)
      {
        ...
        if (paramAnonymousInt == 6)
        {
          ...
          if (paramAnonymousTextView != null)
          {
            ...
            paramAnonymousTextView.hideSoftInputFromWindow(hf.c(hf.this).getWindow().getDecorView().getWindowToken(), 0);
          }
          return true;
        }
        return false;
  ...
  private void h()
  {
    ...
    if (((APMonthRequest)this.a.a).autoPay)
    {
      ...
      this.u = true;
      localgi.a(1000, 3000, false, false);
    }
    else
    {
      ((en)this.a.b).n = "0";
    ...
    this.t.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
    {
      public void onCheckedChanged(CompoundButton paramAnonymousCompoundButton, boolean paramAnonymousBoolean)
      {
        ...
        APDataReportManager.getInstance().insertData("sdk.gameinput.auto", hf.this.a.a.saveType, null, paramAnonymousCompoundButton, null);
      }
    });
    return;
  ...
  public View a()
  {
    try
    {
      this.f = this.e.getLayoutInflater().inflate(2131165210, null);
  ...
  public void e()
  {
    ...
    if ((str != null) && (!str.equals("")))
    {
      ...
      localStringBuilder.append(ed.b().n().b.b(str));
