  ...
  extends Thread
{
  ...
  public u0(s0 params0, String paramString, URL paramURL, File paramFile, int paramInt1, int paramInt2, int paramInt3)
  {
    this.g = params0;
    this.h = paramString;
    this.b = paramURL;
  ...
  public void run()
  {
    ...
    //   4: aload_0
    //   5: getfield 33	midas/x/u0:e	I
    //   8: aload_0
    //   9: getfield 29	midas/x/u0:c	I
    ...
    //   38: aload 6
    //   40: aload_0
    //   41: getfield 41	midas/x/u0:h	Ljava/lang/String;
    ...
    //   58: aload_0
    //   59: getfield 27	midas/x/u0:b	Ljava/net/URL;
    ...
    //   103: aload_0
    //   104: getfield 29	midas/x/u0:c	I
    //   107: aload_0
    //   108: getfield 31	midas/x/u0:d	I
    //   111: iconst_1
    //   112: isub
    //   113: imul
    //   114: aload_0
    //   115: getfield 33	midas/x/u0:e	I
    //   118: iadd
    //   119: istore_1
    //   120: aload_0
    //   121: getfield 29	midas/x/u0:c	I
    //   124: istore_2
    //   125: aload_0
    //   126: getfield 31	midas/x/u0:d	I
    //   129: istore_3
    ...
    //   216: aload_0
    //   217: getfield 27	midas/x/u0:b	Ljava/net/URL;
    //   220: invokevirtual 127	java/net/URL:getHost	()Ljava/lang/String;
    //   223: invokestatic 132	midas/x/m0:a	(Ljavax/net/ssl/HttpsURLConnection;Ljava/lang/String;)V
    //   226: aload 6
    ...
    //   248: dup
    //   249: aload_0
    //   250: getfield 25	midas/x/u0:a	Ljava/io/File;
    //   253: ldc 143
    ...
    //   299: aload_0
    //   300: aload_0
    //   301: getfield 33	midas/x/u0:e	I
    //   304: iload_3
    //   305: iadd
    //   306: putfield 33	midas/x/u0:e	I
    //   309: iload_1
    //   310: iload_3
    //   311: iadd
    //   312: istore_2
    //   313: aload_0
    //   314: getfield 37	midas/x/u0:g	Lmidas/x/s0;
    //   317: aload_0
    //   318: getfield 41	midas/x/u0:h	Ljava/lang/String;
    //   321: iload_3
    //   322: invokevirtual 165	midas/x/s0:a	(Ljava/lang/String;I)V
    //   325: iload_2
    //   326: istore_1
    //   327: iload_2
    //   328: sipush 10240
    ...
    //   334: aload_0
    //   335: getfield 37	midas/x/u0:g	Lmidas/x/s0;
    //   338: aload_0
    //   339: getfield 41	midas/x/u0:h	Ljava/lang/String;
    //   342: aload_0
    //   343: getfield 31	midas/x/u0:d	I
    //   346: aload_0
    //   347: getfield 33	midas/x/u0:e	I
    //   350: invokevirtual 168	midas/x/s0:a	(Ljava/lang/String;II)V
    //   353: goto -82 -> 271
    //   356: aload_0
    //   357: getfield 37	midas/x/u0:g	Lmidas/x/s0;
    //   360: astore 8
    //   362: aload_0
    //   363: getfield 41	midas/x/u0:h	Ljava/lang/String;
    //   366: astore 9
    //   368: aload_0
    //   369: getfield 31	midas/x/u0:d	I
    //   372: istore_1
    //   373: aload_0
    //   374: getfield 33	midas/x/u0:e	I
    //   377: istore_2
    //   378: aload 8
    //   380: aload 9
    //   382: iload_1
    //   383: iload_2
    //   384: invokevirtual 168	midas/x/s0:a	(Ljava/lang/String;II)V
    //   387: goto +51 -> 438
    //   390: astore 8
    //   392: goto +67 -> 459
    //   395: astore 8
    ...
    //   402: invokestatic 177	midas/x/r0:p	()Lmidas/x/r0;
    //   405: aload 8
    //   407: invokevirtual 178	java/lang/Exception:toString	()Ljava/lang/String;
    //   410: invokevirtual 180	midas/x/r0:c	(Ljava/lang/String;)V
    //   413: aload_0
    //   414: getfield 37	midas/x/u0:g	Lmidas/x/s0;
    //   417: astore 8
    //   419: aload_0
    //   420: getfield 41	midas/x/u0:h	Ljava/lang/String;
    //   423: astore 9
    //   425: aload_0
    //   426: getfield 31	midas/x/u0:d	I
    //   429: istore_1
    //   430: aload_0
    //   431: getfield 33	midas/x/u0:e	I
    //   434: istore_2
    //   435: goto -57 -> 378
    //   438: aload_0
    //   439: iconst_1
    //   440: putfield 35	midas/x/u0:f	Z
    //   443: aload 6
    //   445: ifnull +8 -> 453
    //   448: aload 6
    //   450: invokevirtual 183	java/io/InputStream:close	()V
    //   453: aload 7
    //   455: invokevirtual 184	java/io/RandomAccessFile:close	()V
    //   458: return
    //   459: aload_0
    //   460: getfield 37	midas/x/u0:g	Lmidas/x/s0;
    //   463: aload_0
    //   464: getfield 41	midas/x/u0:h	Ljava/lang/String;
    //   467: aload_0
    //   468: getfield 31	midas/x/u0:d	I
    //   471: aload_0
    //   472: getfield 33	midas/x/u0:e	I
    //   475: invokevirtual 168	midas/x/s0:a	(Ljava/lang/String;II)V
    //   478: aload 8
    //   480: athrow
    //   481: astore 8
    //   483: goto +13 -> 496
    ...
    //   536: aload_0
    //   537: iconst_m1
    //   538: putfield 33	midas/x/u0:e	I
    //   541: aload 8
    //   543: invokevirtual 171	java/lang/Exception:printStackTrace	()V
    //   546: invokestatic 177	midas/x/r0:p	()Lmidas/x/r0;
    //   549: aload 8
    //   551: invokevirtual 178	java/lang/Exception:toString	()Ljava/lang/String;
    //   554: invokevirtual 186	midas/x/r0:a	(Ljava/lang/String;)V
    ...
    //   574: aload 9
    //   576: aload_0
    //   577: getfield 41	midas/x/u0:h	Ljava/lang/String;
    ...
    //   592: aload 9
    //   594: aload 8
    //   596: invokevirtual 191	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   599: pop
    //   600: ldc 64
    //   602: aload 9
    ...
    //   612: ifnull +11 -> 623
    //   615: aload 6
    //   617: invokevirtual 183	java/io/InputStream:close	()V
    //   620: goto +3 -> 623
    //   623: aload 7
    //   625: ifnull +59 -> 684
    //   628: aload 7
    //   630: invokevirtual 184	java/io/RandomAccessFile:close	()V
    //   633: return
    //   634: aload 6
    //   636: invokevirtual 192	java/io/IOException:printStackTrace	()V
    //   639: return
    //   640: astore 9
    //   642: aload 6
    //   644: astore 8
    ...
    //   652: ifnull +11 -> 663
    //   655: aload 8
    //   657: invokevirtual 183	java/io/InputStream:close	()V
    //   660: goto +3 -> 663
    //   663: aload 7
    //   665: ifnull +16 -> 681
    //   668: aload 7
    //   670: invokevirtual 184	java/io/RandomAccessFile:close	()V
    //   673: goto +8 -> 681
    //   676: aload 7
    //   678: invokevirtual 192	java/io/IOException:printStackTrace	()V
    //   681: aload 6
    //   683: athrow
    //   684: return
    //   685: astore 6
