...
public class f6
{
  ...
  public static File d(String paramString1, String paramString2)
  {
    a(paramString1);
    try
    {
  ...
  public boolean c(String paramString1, String paramString2)
  {
    try
    {
      ...
      localStringBuilder.append("/Tencent/");
      paramString2 = new FileOutputStream(d(localStringBuilder.toString(), paramString2));
