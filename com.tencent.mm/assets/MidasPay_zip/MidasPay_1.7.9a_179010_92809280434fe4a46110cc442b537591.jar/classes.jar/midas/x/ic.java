  ...
  implements cb
{
  ...
  public gb a(fb paramfb, gb paramgb)
  {
    ...
    //   101: aconst_null
    //   102: astore 9
    //   104: new 66	java/io/FileOutputStream
    //   107: dup
    //   108: aload 10
    //   110: invokespecial 67	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   113: astore 6
    //   115: new 69	android/util/Base64OutputStream
    //   118: dup
    //   119: aload 6
    //   121: iconst_2
    //   122: invokespecial 72	android/util/Base64OutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   125: astore 7
    //   127: new 74	java/io/FileInputStream
    //   130: dup
    //   131: aload 8
    //   133: invokespecial 77	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   136: astore 8
    //   138: sipush 3072
    //   141: newarray byte
    //   143: astore 9
    //   145: aload 8
    //   147: aload 9
    //   149: invokevirtual 81	java/io/FileInputStream:read	([B)I
    //   152: istore_3
    //   153: iload_3
    //   154: iconst_m1
    ...
    //   162: iconst_0
    //   163: iload_3
    //   164: invokevirtual 85	android/util/Base64OutputStream:write	([BII)V
    //   167: goto -22 -> 145
    //   170: aload 7
    //   172: invokevirtual 88	android/util/Base64OutputStream:flush	()V
    //   175: aload 6
    //   177: invokevirtual 89	java/io/FileOutputStream:flush	()V
    //   180: aload_1
    //   181: checkcast 19	midas/x/nc
    //   184: new 34	java/io/File
    //   187: dup
    //   188: aload 10
    //   190: invokespecial 57	java/io/File:<init>	(Ljava/lang/String;)V
    //   193: invokevirtual 91	midas/x/nc:a	(Ljava/io/File;)V
    ...
    //   218: ldc 95
    //   220: aload_1
    //   221: invokevirtual 54	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   224: invokestatic 100	midas/x/ya:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   227: aload 7
    ...
    //   337: new 31	java/lang/StringBuilder
    //   340: dup
    //   341: invokespecial 32	java/lang/StringBuilder:<init>	()V
    //   344: astore 9
    //   346: aload 9
    //   348: ldc 111
    //   350: invokevirtual 42	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   353: pop
    //   354: aload 9
    //   356: aload 8
    //   358: invokevirtual 114	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   361: invokevirtual 42	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   364: pop
    //   365: ldc 95
    //   367: aload 9
    //   369: invokevirtual 54	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   372: invokestatic 117	midas/x/ya:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   375: aload_2
    //   376: iconst_1
    //   377: putfield 123	midas/x/gb:e	Z
    //   380: aload 7
    //   382: ifnull +18 -> 400
    //   385: aload 7
    ...
    //   434: new 31	java/lang/StringBuilder
    //   437: dup
    //   438: invokespecial 32	java/lang/StringBuilder:<init>	()V
    //   441: astore_1
    //   442: aload_1
    //   443: ldc 125
    //   445: invokevirtual 42	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   448: pop
    //   449: aload_1
    //   450: invokestatic 25	java/lang/System:currentTimeMillis	()J
    //   453: lload 4
    //   455: lsub
    //   456: invokevirtual 128	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   459: pop
    //   460: ldc 130
    //   462: aload_1
    //   463: invokevirtual 54	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   466: invokestatic 100	midas/x/ya:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   469: aload_2
    //   470: areturn
    //   471: astore_2
    //   472: aload 7
