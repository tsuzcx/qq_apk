...
public class z0
{
  ...
  {
    Object localObject1 = a.r().d.getDir("midaspluginsTemp", 0);
    File localFile = a.r().d.getDir("midasplugins", 0);
  ...
  public static void a(File paramFile1, File paramFile2, int paramInt)
  {
  ...
  public static void a(File[] paramArrayOfFile, File paramFile)
  {
  ...
  public static void a(File[] paramArrayOfFile, File paramFile1, File paramFile2, int paramInt)
  {
    try
    {
