  ...
  public void b()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        bool = ((String)localObject1).equals("hfpay");
        if (bool)
        {
        ...
        bool = "AndroidPay".equals(localObject1);
        if (bool) {
        ...
        if (i == 5)
        {
          localObject3 = ((APSubscribeRequest)p4.p().e().b).serviceCode;
