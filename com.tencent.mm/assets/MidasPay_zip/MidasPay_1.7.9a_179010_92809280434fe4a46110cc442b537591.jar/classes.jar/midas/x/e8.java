...
public class e8
{
  ...
  public APRoundedWebView c = null;
  ...
  public e8(Activity paramActivity, i8 parami8)
  {
  ...
  public void b()
  {
    APRoundedWebView localAPRoundedWebView = this.c;
    if (localAPRoundedWebView != null)
    {
      ((ViewGroup)localAPRoundedWebView.getParent()).removeView(this.c);
      this.c.destroy();
      this.c = null;
    }
  }
    ...
    extends WebChromeClient
  {
    ...
    public boolean onJsAlert(WebView paramWebView, String paramString1, String paramString2, JsResult paramJsResult)
    {
      ...
      APLog.i("inner onJsAlert mContext", e8.a(e8.this).toString());
      if (j.a(e8.a(e8.this), paramString1, paramString2) == 0)
      {
      ...
      if ((!paramString2.startsWith("http://unipay.sdk.android/?")) && (!paramString2.startsWith("https://unipay.sdk.android/?")))
      {
        ...
        {
          e8.b(e8.this).a(paramWebView, paramString1, paramString2, paramJsResult);
          paramJsResult.cancel();
          return true;
        }
    ...
    {
      return e8.b(e8.this).a(paramWebView, paramString1, paramString2, paramString3, paramJsPromptResult);
    }
    ...
    public void onReceivedTitle(WebView paramWebView, String paramString)
    {
      ...
      if ((paramString != null) && (!paramString.contains("html")) && (!paramString.contains("?"))) {
        e8.b(e8.this).b(paramWebView, paramString);
      }
    }
  }
    ...
    extends WebViewClient
  {
    ...
    public void onPageFinished(WebView paramWebView, String paramString)
    {
      ...
      e8.this.i();
      if (e8.c(e8.this) != null)
      {
        APRoundedWebView localAPRoundedWebView = e8.c(e8.this);
        StringBuilder localStringBuilder = new StringBuilder();
      ...
      if (e8.b(e8.this) != null) {
        e8.b(e8.this).a(paramWebView, paramString);
      }
    }
    ...
    public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
    {
      ...
      if (e8.b(e8.this) != null) {
        e8.b(e8.this).a(paramWebView, paramString, paramBitmap);
      }
    }
    ...
    public void onReceivedError(WebView paramWebView, int paramInt, String paramString1, String paramString2)
    {
      ...
      if (!paramString2.startsWith("http://unipay.sdk.android/?"))
      {
        ...
        if (e8.b(e8.this) != null) {
          e8.b(e8.this).a(paramWebView, paramInt, paramString1, paramString2);
        }
      }
    }
