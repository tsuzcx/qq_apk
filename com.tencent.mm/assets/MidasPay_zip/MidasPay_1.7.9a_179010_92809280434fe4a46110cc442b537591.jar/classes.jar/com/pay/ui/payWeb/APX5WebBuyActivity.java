  ...
  extends APX5WebActivity
{
  ...
  public void j()
  {
    ...
    {
      localz7.a = c6.s0().B();
      localz7.n.put("page", y7.q);
      localz7.c = "sdk.gamelist.h5.show";
      localz7.d = "sdk.gamelist.h5.back";
      localz7.e = "sdk.gamelist.h5.click";
      localz7.f = "sdk.gameinput.h5.pay";
      localz7.i = "sdk.gamelist.h5.keyback";
      localz7.j = "sdk.gamelist.h5.error";
      localz7.k = "sdk.gamelist.h5.refresh";
    }
    else if (q.equals(y7.r))
    {
      ...
      localz7.a = str;
      localz7.n.put("page", y7.r);
      localz7.c = "sdk.tuan.h5.show";
      localz7.d = "sdk.tuan.h5.close";
      localz7.f = "sdk.tuan.h5.pay";
      localz7.i = "sdk.tuan.h5.keyback";
      localz7.j = "sdk.tuan.h5.error";
      localz7.k = "sdk.tuan.h5.refresh";
    }
    else if ((!q.equals(y7.s)) && (q.equals(y7.t)))
    {
      ...
      localz7.n.put("page", y7.t);
      localz7.n.put("saveNumber", p4.p().e().f.f);
      localz7.n.put("PortalExtendField", c6.s0().D());
      localz7.n.put("appId", this.n);
      localz7.n.put("wxSignUrl", this.o);
      if ((c6.s0().U()) && (this.l == 5))
      {
        int i = getIntent().getIntExtra("mcardDepositBalance", 0);
        if (i > 0) {
          localz7.n.put("mcardDepositBalance", APTools.b(i));
        }
      }
      if (!c6.s0().z()) {
        localz7.n.put("notShowContinueBuy", "1");
      }
      localz7.g = "sdk.result.h5.pay";
      localz7.d = "sdk.result.h5.back";
      localz7.h = "sdk.result.h5.repay";
      localz7.i = "sdk.result.h5.keyback";
      localz7.c = "sdk.result.h5.show";
      localz7.j = "sdk.result.h5.error";
      localz7.k = "sdk.result.h5.refresh";
    }
    this.f = localz7;
  }
    ...
    implements d8
  {
    ...
    public void a(WebView paramWebView, String paramString)
    {
      ...
      if (paramString.startsWith("http://unipay.sdk.android/?")) {
        APX5WebBuyActivity.a(APX5WebBuyActivity.this, paramString);
      }
    }
    ...
    public void b(WebView paramWebView, String paramString)
    {
      ...
      if ((paramWebView != null) && (("1".equals(paramWebView.a())) || ("-1".equals(paramWebView.a()))))
      {
        ...
        APLog.i("APX5WebBuyActivity", paramString.toString());
        paramString = APX5WebBuyActivity.this.d;
        StringBuilder localStringBuilder = new StringBuilder();
    ...
    implements c8
  {
    ...
    {
      APLog.i("APX5WebBuyActivity webJsAlert url=", paramString1);
      APLog.i("APX5WebBuyActivity webJsAlert message=", paramString2);
      paramWebView = paramString2.toString();
      if (paramWebView.startsWith("http://unipay.sdk.android/?"))
      {
        APX5WebBuyActivity.a(APX5WebBuyActivity.this, paramWebView);
      }
      else if (j.a(APX5WebBuyActivity.this, paramString1, paramString2) == 0)
      {
