  ...
  extends APActivity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    {
      setContentView(2131165238);
      a(p4.p().e().b.mpInfo.discountUrl);
      return;
    }
    if (this.d.equals("showBankResultActivity"))
    {
      setContentView(2131165240);
      f();
      return;
    }
    if (this.d.equals("showWechatResultActivity"))
    ...
    extends WebViewClient
  {
    ...
    public void onPageFinished(WebView paramWebView, String paramString)
    {
      ...
      if (APWebMarketActivity.n(APWebMarketActivity.this) != null) {
    ...
    {
      APWebMarketActivity.a(APWebMarketActivity.this, paramWebView, paramString);
      if (!APWebMarketActivity.m(APWebMarketActivity.this))
      {
        APLog.i("webviewclient == ", "onPageStarted ");
        paramWebView.goBack();
        if (paramString.startsWith("http://unipay.android.mp.pay")) {
          APDataReportManager.getInstance().insertData("sdk.market.sure", APWebMarketActivity.p(APWebMarketActivity.this), null, p4.p().e().b.mpInfo.payChannel, c6.s0().l());
        }
      }
      try
      {
        e5.h().a(APWebMarketActivity.this, p4.p().e().b);
      }
      catch (Exception localException)
      {
        label98:
      ...
      {
        APDataReportManager.getInstance().insertData("sdk.market.cancel", APWebMarketActivity.q(APWebMarketActivity.this), null, p4.p().e().b.mpInfo.payChannel, c6.s0().l());
        paramWebView.stopLoading();
        z5.a(2, "");
        APWebMarketActivity.this.finish();
        APUICommonMethod.a(APWebMarketActivity.this);
      }
      else if (paramString.startsWith("http://unipay.android.mp.retback"))
      {
        APDataReportManager.getInstance().insertData("sdk.market.result.cancel", APWebMarketActivity.b(APWebMarketActivity.this), null, p4.p().e().b.mpInfo.payChannel, c6.s0().l());
        APUICommonMethod.f();
        if (APWebMarketActivity.l(APWebMarketActivity.this).equals("showWechatResultActivity")) {
          z5.a(8, 0, 0);
        } else if (APWebMarketActivity.l(APWebMarketActivity.this).equals("showBankResultActivity")) {
          z5.a(2, 0, 0);
        }
      }
      label278:
    ...
    public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
    {
      ...
      if (paramString.startsWith("http://unipay.android.mp.pay"))
      {
        ...
        APDataReportManager.getInstance().insertData("sdk.market.sure", APWebMarketActivity.a(APWebMarketActivity.this), null, p4.p().e().b.mpInfo.payChannel, c6.s0().l());
      }
      try
      {
        e5.h().a(APWebMarketActivity.this, p4.p().e().b);
      ...
      if (paramString.startsWith("http://unipay.android.mp.back"))
      {
        APDataReportManager.getInstance().insertData("sdk.market.cancel", APWebMarketActivity.j(APWebMarketActivity.this), null, p4.p().e().b.mpInfo.payChannel, c6.s0().l());
        paramWebView.stopLoading();
        z5.a(2, "");
        APWebMarketActivity.this.finish();
        APUICommonMethod.a(APWebMarketActivity.this);
      ...
      {
        APDataReportManager.getInstance().insertData("sdk.market.result.cancel", APWebMarketActivity.k(APWebMarketActivity.this), null, p4.p().e().b.mpInfo.payChannel, c6.s0().l());
        APUICommonMethod.f();
        if (APWebMarketActivity.l(APWebMarketActivity.this).equals("showWechatResultActivity")) {
          z5.a(8, 0, 0);
        } else if (APWebMarketActivity.l(APWebMarketActivity.this).equals("showBankResultActivity")) {
    ...
    implements fc
  {
    ...
    public void a(ob paramob)
    {
      if (paramob.d() == 0)
      {
        paramob = APWebMarketActivity.c(APWebMarketActivity.this);
        APWebMarketActivity.this.a(paramob);
        return;
      }
      APWebMarketActivity.d(APWebMarketActivity.this).dismiss();
      APUICommonMethod.f();
      z5.a(2, 0, -1);
    }
    ...
    {
      APWebMarketActivity.e(APWebMarketActivity.this).dismiss();
      APUICommonMethod.f();
      z5.a(2, 0, -1);
    }
    ...
    implements fc
  {
    ...
    public void a(ob paramob)
    {
      ...
      APWebMarketActivity.g(APWebMarketActivity.this).dismiss();
      APUICommonMethod.f();
      z5.a(8, 0, -1);
    }
    ...
    public void b(ob paramob)
    {
      APWebMarketActivity.h(APWebMarketActivity.this).dismiss();
      APUICommonMethod.f();
      z5.a(8, 0, -1);
    }
    ...
    public void c(ob paramob)
    {
      APWebMarketActivity.i(APWebMarketActivity.this).dismiss();
      APUICommonMethod.f();
      z5.a(8, 0, -1);
    }
  }
