  ...
  implements w7.a
{
  ...
  public void j()
  {
    ...
    localz7.a = localStringBuilder.toString();
    localz7.c = "sdk.vmall.h5.show";
    localz7.f = "sdk.vmall.h5.pay";
    localz7.d = "sdk.vmall.h5.close";
    localz7.i = "sdk.vmall.h5.keyback";
    this.f = localz7;
  }
    ...
    implements c8
  {
    ...
    public void a(WebView paramWebView, String paramString1, String paramString2, JsResult paramJsResult)
    {
      ...
      if (paramWebView.startsWith("http://unipay.sdk.android/?")) {
        APX5VmallBuyActivity.this.b(paramWebView);
      }
