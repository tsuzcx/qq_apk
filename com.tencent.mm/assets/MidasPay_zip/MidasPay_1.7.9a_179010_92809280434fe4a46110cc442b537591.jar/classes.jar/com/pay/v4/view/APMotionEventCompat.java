...
public class APMotionEventCompat
{
  ...
  public static final MotionEventVersionImpl IMPL = new BaseMotionEventVersionImpl();
  ...
  public static class BaseMotionEventVersionImpl
  ...
  public static class EclairMotionEventVersionImpl
    implements APMotionEventCompat.MotionEventVersionImpl
  {
    public int findPointerIndex(MotionEvent paramMotionEvent, int paramInt)
    {
  ...
  public static abstract interface MotionEventVersionImpl
  {
