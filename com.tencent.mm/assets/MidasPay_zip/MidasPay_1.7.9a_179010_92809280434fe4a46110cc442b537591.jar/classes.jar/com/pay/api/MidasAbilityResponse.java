...
public class MidasAbilityResponse
{
  ...
  public static Stack<ResultReceiver> a = new Stack();
  
  public static Bundle a(MidasBaseAbility paramMidasBaseAbility, int paramInt, String paramString, Bundle paramBundle)
  {
  ...
  public static void onCancel(MidasBaseAbility paramMidasBaseAbility, int paramInt, Bundle paramBundle)
  {
    ...
    ((APDataReportManager)localObject).insertData("sdk.ability.callback.cancel", 0, localStringBuilder.toString(), APAppDataInterface.singleton().C(), paramMidasBaseAbility.toString());
    if (paramBundle != null)
    {
  ...
  public static void onFailureCGI(MidasBaseAbility paramMidasBaseAbility, int paramInt, String paramString, Bundle paramBundle)
  {
    ...
    paramBundle.insertData("sdk.ability.callback.fail_cgi", 0, localStringBuilder.toString(), APAppDataInterface.singleton().C(), paramMidasBaseAbility.toString());
    if (paramString != null)
    {
  ...
  public static void onFailureLIB(MidasBaseAbility paramMidasBaseAbility, int paramInt, String paramString, Bundle paramBundle)
  {
    ...
    localStringBuilder.append("receiver=");
    localStringBuilder.append(paramString);
    paramBundle.insertData("sdk.ability.callback.fail_lib", 0, localStringBuilder.toString(), APAppDataInterface.singleton().C(), paramMidasBaseAbility.toString());
    if (paramString != null)
    {
  ...
  public static void onFailureSDK(MidasBaseAbility paramMidasBaseAbility, int paramInt, String paramString, Bundle paramBundle)
  {
    ...
    localStringBuilder.append("receiver=");
    localStringBuilder.append(paramString);
    paramBundle.insertData("sdk.ability.callback.fail_sdk", 0, localStringBuilder.toString(), APAppDataInterface.singleton().C(), paramMidasBaseAbility.toString());
    if (paramString != null)
    {
  ...
  public static void onSuccess(MidasBaseAbility paramMidasBaseAbility, int paramInt, Bundle paramBundle)
  {
    ...
    localStringBuilder.append("receiver=");
    localStringBuilder.append(paramBundle);
    ((APDataReportManager)localObject).insertData("sdk.ability.callback.succ", 0, localStringBuilder.toString(), APAppDataInterface.singleton().C(), paramMidasBaseAbility.toString());
    if (paramBundle != null)
    {
