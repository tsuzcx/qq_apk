...
public class APQRCodeActivity
  extends APActivity
  implements View.OnClickListener, lw
{
  ...
  private void h()
  {
    ...
    try
    {
      ...
      if ((localObject1 != null) && (localObject1.length > 0))
      {
        ...
        Object localObject3 = ((el)localObject2).b;
        ...
        localStringBuilder.append(((et)localObject3).b);
        ...
        if (i != 5)
        {
          ...
          default: 
            ...
            break;
          case 1: 
            localObject1 = ((ev)((el)localObject2).b).a((String)localObject3);
            localObject2 = new StringBuilder();
            ...
            break;
          case 0: 
            localObject1 = ((eu)((el)localObject2).b).a((String)localObject3);
            localObject2 = new StringBuilder();
        ...
        {
          localObject1 = ((ew)((el)localObject2).b).a((String)localObject3);
          localObject2 = new StringBuilder();
  ...
  public void a(lh paramlh)
  {
    ...
    if (i != 1000)
    {
      ...
      {
      default: 
        paramlh = new StringBuilder();
        paramlh.append("getPayResult return error result code = ");
        paramlh.append(i);
        APLog.e("QRCodePay-Activity", paramlh.toString());
        return;
      case 1: 
  ...
  public void b(lh paramlh)
  {
    ...
    else
    {
      ...
      localStringBuilder.append(paramlh.V());
  ...
  {
    paramlh = new StringBuilder();
    paramlh.append("GetPayResult stop! ");
    paramlh.append(this);
    APLog.e("QRCodePay-Activity", paramlh.toString());
  }
