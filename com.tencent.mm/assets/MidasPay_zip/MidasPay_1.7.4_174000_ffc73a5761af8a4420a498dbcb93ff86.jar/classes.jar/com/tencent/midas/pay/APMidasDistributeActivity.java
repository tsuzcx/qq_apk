  ...
  implements IAPPayCallBack
{
  ...
  public static void a(Context paramContext, Bundle paramBundle, ResultReceiver paramResultReceiver)
  {
    ...
    try
    {
      ...
      localStringBuilder.append((String)localObject);
      localObject = (MidasBaseAbility)ne.b(localStringBuilder.toString());
  ...
  public void MidasPayCallBack(APPayResponse paramAPPayResponse)
  {
    ...
    else
    {
      ...
      try
      {
        ne.a(a, c, new Object[] { localAPMidasResponse });
      }
      catch (Throwable paramAPPayResponse)
      {
        paramAPPayResponse.printStackTrace();
  ...
  protected void onResume()
  {
    ...
    if ((fv.f()) && (!n.a().h()))
    {
      ...
      if (((!fy.a().W()) && ("wechat".equals(str))) || ((!fy.a().X()) && ("qqwallet".equals(str))))
      {
        ...
        by.a().h(new lw()
        {
          public void a(lh paramAnonymouslh)
          {
            ...
            localff.a(APMidasDistributeActivity.this, APMidasDistributeActivity.c());
          }
          ...
          public void b(lh paramAnonymouslh)
          {
            ...
            APUICommonMethod.g();
            fb.a();
            fb.a(str).a(APMidasDistributeActivity.this, APMidasDistributeActivity.c());
          }
