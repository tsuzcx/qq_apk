...
public class APWSJChannel
  extends ff
{
  public Handler j = new Handler(new Handler.Callback()
  {
    public boolean handleMessage(Message paramAnonymousMessage)
    {
      ...
      if (TextUtils.equals((CharSequence)localObject, "9000"))
      {
        ...
        {
          APDataReportManager.getInstance().insertData("sdk.wsj.paysucc", em.b().n().a.saveType, em.b().n().e.m, null, null);
          APWSJChannel.this.a(null);
        }
        else
        {
          APDataReportManager.getInstance().insertData("sdk.wsj.signerror", em.b().n().a.saveType, em.b().n().e.m, "9000", null);
      ...
      else if (TextUtils.equals((CharSequence)localObject, "8000"))
      {
        if (APWSJChannel.this.b(paramAnonymousMessage.b))
        {
          APDataReportManager.getInstance().insertData("sdk.wsj.payunkown", em.b().n().a.saveType, em.b().n().e.m, null, null);
          paramAnonymousMessage = new Intent();
          paramAnonymousMessage.putExtra("channel", 12);
          paramAnonymousMessage.putExtra("state", "unkown");
          paramAnonymousMessage.setClass(APWSJChannel.this.d, APPayProgressActivity.class);
          APWSJChannel.this.d.startActivity(paramAnonymousMessage);
        }
        else
        {
          APDataReportManager.getInstance().insertData("sdk.wsj.signerror", em.b().n().a.saveType, em.b().n().e.m, "8000", null);
          APWSJChannel.a(APWSJChannel.this, "很抱歉,本次支付未成功\n建议更换其他方式进行支付");
        }
      }
      else if (TextUtils.equals((CharSequence)localObject, "6001"))
      {
        APDataReportManager.getInstance().insertData("sdk.wsj.paycancel", em.b().n().a.saveType, em.b().n().e.m, null, null);
      }
      else
      {
        APDataReportManager.getInstance().insertData("sdk.wsj.payerror", em.b().n().a.saveType, em.b().n().e.m, null, null);
        APWSJChannel.a(APWSJChannel.this, "很抱歉,本次支付未成功\n建议更换其他方式进行支付");
      }
      try
      {
        APWSJChannel.a(APWSJChannel.this).getClass().getMethod("removeObserver", new Class[] { Handler.class }).invoke(APWSJChannel.a(APWSJChannel.this), new Object[] { APWSJChannel.this.j });
        return false;
      }
  ...
  public void a(Activity paramActivity, String paramString)
  {
    ...
    if (!f())
    {
      ...
      if (id.b(this.d.getApplicationContext())) {
      ...
      localBundle.putSerializable("pageName", hu.w);
    ...
    try
    {
      this.k = Class.forName("com.tencent.midas.wsjchannel.APMidasWSJChannelHelper").getMethod("getInstance", new Class[] { Context.class }).invoke((Class)null, new Object[] { this.d });
    }
    ...
    try
    {
      this.k.getClass().getMethod("toPay", new Class[] { Activity.class, String.class }).invoke(this.k, new Object[] { paramActivity, paramString });
      this.k.getClass().getMethod("addObserver", new Class[] { Handler.class }).invoke(this.k, new Object[] { this.j });
      return;
    }
  ...
  public void b(Context paramContext, dt paramdt)
  {
    ...
    paramdt = paramdt.e();
    a((Activity)paramContext, paramdt);
  }
