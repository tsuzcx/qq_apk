  ...
  extends View
{
  ...
  private Scroller A;
  private int B;
  private List<hb> C = new LinkedList();
  private List<hc> D = new LinkedList();
  ...
  private int getMaxTextLength()
  {
    ...
    while (i1 < Math.min(this.j + this.m, localhd.a()))
    {
      String str = localhd.a(i1);
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    ...
    while (localIterator.hasNext()) {
      ((hb)localIterator.next()).a(this, paramInt1, paramInt2);
    }
  }
  ...
  public void setAdapter(hd paramhd)
  {
    this.i = paramhd;
    d();
    invalidate();
