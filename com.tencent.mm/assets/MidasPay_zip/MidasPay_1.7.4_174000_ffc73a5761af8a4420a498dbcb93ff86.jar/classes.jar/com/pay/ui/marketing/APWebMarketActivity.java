  ...
  private void a()
  {
    ...
    by.a().g(new lw()
    {
      public void a(lh paramAnonymouslh)
      {
        ...
        {
          paramAnonymouslh = APWebMarketActivity.k(APWebMarketActivity.this);
          APWebMarketActivity.this.a(paramAnonymouslh);
          return;
        }
      ...
      localWebView.setWebViewClient(new WebViewClient()
      {
        ...
        public void onPageStarted(WebView paramAnonymousWebView, String paramAnonymousString, Bitmap paramAnonymousBitmap)
        {
          ...
          if (!APWebMarketActivity.g(APWebMarketActivity.this))
          {
            ...
            if (paramAnonymousString.startsWith("http://unipay.android.mp.pay")) {
              APDataReportManager.getInstance().insertData("sdk.market.sure", APWebMarketActivity.h(APWebMarketActivity.this), null, em.b().n().a.mpInfo.payChannel, fy.a().m());
            }
          }
          try
          {
            fb.a().a(APWebMarketActivity.this, em.b().n().a);
          }
          catch (Exception localException)
          {
            label98:
          ...
          {
            APDataReportManager.getInstance().insertData("sdk.market.cancel", APWebMarketActivity.i(APWebMarketActivity.this), null, em.b().n().a.mpInfo.payChannel, fy.a().m());
          ...
          {
            APDataReportManager.getInstance().insertData("sdk.market.result.cancel", APWebMarketActivity.j(APWebMarketActivity.this), null, em.b().n().a.mpInfo.payChannel, fy.a().m());
            APUICommonMethod.b();
        ...
        public boolean shouldOverrideUrlLoading(WebView paramAnonymousWebView, String paramAnonymousString)
        {
          ...
          if (paramAnonymousString.startsWith("http://unipay.android.mp.pay"))
          {
            ...
            APDataReportManager.getInstance().insertData("sdk.market.sure", APWebMarketActivity.a(APWebMarketActivity.this), null, em.b().n().a.mpInfo.payChannel, fy.a().m());
          }
          try
          {
            fb.a().a(APWebMarketActivity.this, em.b().n().a);
          ...
          if (paramAnonymousString.startsWith("http://unipay.android.mp.back"))
          {
            APDataReportManager.getInstance().insertData("sdk.market.cancel", APWebMarketActivity.b(APWebMarketActivity.this), null, em.b().n().a.mpInfo.payChannel, fy.a().m());
            paramAnonymousWebView.stopLoading();
            fv.a(2, "");
            APWebMarketActivity.this.finish();
            APUICommonMethod.b(APWebMarketActivity.this);
          ...
          {
            APDataReportManager.getInstance().insertData("sdk.market.result.cancel", APWebMarketActivity.c(APWebMarketActivity.this), null, em.b().n().a.mpInfo.payChannel, fy.a().m());
            APUICommonMethod.b();
            if (APWebMarketActivity.d(APWebMarketActivity.this).equals("showWechatResultActivity")) {
              fv.a(8, 0, 0);
            } else if (APWebMarketActivity.d(APWebMarketActivity.this).equals("showBankResultActivity")) {
