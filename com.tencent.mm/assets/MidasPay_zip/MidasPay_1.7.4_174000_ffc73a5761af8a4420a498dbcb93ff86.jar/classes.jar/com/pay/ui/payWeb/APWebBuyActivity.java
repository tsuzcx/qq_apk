  ...
  extends APWebActivity
{
  ...
  public void c()
  {
    ...
    {
      localht.a = fy.a().o();
      localht.p.put("page", hu.s);
      localht.c = "sdk.gamelist.h5.show";
      localht.d = "sdk.gamelist.h5.back";
      localht.e = "sdk.gamelist.h5.click";
      localht.g = "sdk.gameinput.h5.pay";
      localht.j = "sdk.gamelist.h5.keyback";
      localht.k = "sdk.gamelist.h5.error";
      localht.l = "sdk.gamelist.h5.refresh";
    }
    else if (a.equals(hu.t))
    {
      ...
      localht.a = str;
      localht.p.put("page", hu.t);
      localht.c = "sdk.tuan.h5.show";
      localht.d = "sdk.tuan.h5.close";
      localht.g = "sdk.tuan.h5.pay";
      localht.j = "sdk.tuan.h5.keyback";
      localht.k = "sdk.tuan.h5.error";
      localht.l = "sdk.tuan.h5.refresh";
    }
    else if ((!a.equals(hu.u)) && (a.equals(hu.v)))
    {
      ...
      localht.p.put("page", hu.v);
      localht.p.put("saveNumber", em.b().n().e.g);
      localht.p.put("PortalExtendField", fy.a().L());
      localht.p.put("appId", this.x);
      localht.p.put("wxSignUrl", this.y);
      if ((fy.a().A()) && (this.w == 5))
      {
        int i = getIntent().getIntExtra("mcardDepositBalance", 0);
        if (i > 0) {
          localht.p.put("mcardDepositBalance", APTools.a(i));
        }
      }
      if (!fy.a().B()) {
        localht.p.put("notShowContinueBuy", "1");
      }
      localht.h = "sdk.result.h5.pay";
      localht.d = "sdk.result.h5.back";
      localht.i = "sdk.result.h5.repay";
      localht.j = "sdk.result.h5.keyback";
      localht.c = "sdk.result.h5.show";
      localht.k = "sdk.result.h5.error";
      localht.l = "sdk.result.h5.refresh";
    }
    this.q = localht;
  }
