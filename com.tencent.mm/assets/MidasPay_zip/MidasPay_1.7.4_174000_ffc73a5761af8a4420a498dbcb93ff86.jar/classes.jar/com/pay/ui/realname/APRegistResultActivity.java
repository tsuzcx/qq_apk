  ...
  extends APActivity
{
  ...
  protected void a()
  {
    ...
    this.a.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        ...
        APDataReportManager.getInstance().insertData("sdk.qcard.pay", APRegistResultActivity.b(APRegistResultActivity.this), em.b().n().e.l, String.valueOf(4), null);
      }
    });
  ...
  public boolean onKeyDown(int paramInt, KeyEvent paramKeyEvent)
  {
    if (paramInt == 4)
    {
      APDataReportManager.getInstance().insertData("sdk.realname.back", this.f, em.b().n().e.l, String.valueOf(4), null);
      APUICommonMethod.b();
      fv.a(13, "");
      return true;
    }
