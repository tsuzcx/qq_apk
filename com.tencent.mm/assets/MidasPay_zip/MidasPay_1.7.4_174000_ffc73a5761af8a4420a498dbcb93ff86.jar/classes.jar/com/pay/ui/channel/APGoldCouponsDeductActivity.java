  ...
  implements View.OnClickListener
{
    ...
    if ((o.a().c(str)) && (a(str)))
    {
      if (!this.p.a.isCanChange)
      {
        if (!TextUtils.isEmpty(str))
        {
          ...
          fb.a().b(this, str, (Bundle)localObject, this.b, null);
          return;
        }
        fb.a().a(this, "channelList", (Bundle)localObject);
        return;
      }
      if (("cft".equals(str)) || ("bank".equals(str))) {
        this.D = true;
      }
      fb.a().a(this, str, (Bundle)localObject);
      return;
    }
    this.p.e.j = "";
    fb.a().a(this, "channelList", (Bundle)localObject);
  ...
  public void onClick(View paramView)
  {
    if (paramView.getId() == 2131099925)
    {
      ...
      {
        this.D = true;
        ((APGoldCouponsDeductChannel)fb.a("goldcouponsdeduct")).a(this, this.b, null);
        return;
      }
      i();
    ...
    else
    {
      ...
      if (paramView.getId() == 2131099870)
      {
        ...
        overridePendingTransition(fv.a(this, "unipay_anim_in_from_right"), fv.a(this, "unipay_anim_out_to_left"));
      }
    }
  }
