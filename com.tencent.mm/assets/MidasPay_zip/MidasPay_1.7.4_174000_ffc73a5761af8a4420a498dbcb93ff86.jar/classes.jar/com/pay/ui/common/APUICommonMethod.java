...
public class APUICommonMethod
{
  ...
  public static gr a(Context paramContext)
  {
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      {
        localgr.b = "黄钻";
        localgr.a = 2131034297;
        return localgr;
      }
      if (str.equals("lanzuan"))
      {
        localgr.b = "蓝钻";
        localgr.a = 2131034261;
        return localgr;
      }
      if (str.equals("huiyuan"))
      {
        localgr.b = "会员";
        localgr.a = 2131034268;
        return localgr;
      }
      if (str.equals("mozuan"))
      {
        localgr.b = "魔钻";
        localgr.a = 2131034277;
        return localgr;
      }
      if (str.equals("fenzuan"))
      {
        localgr.b = "粉钻";
        localgr.a = 2131034266;
        return localgr;
      }
  ...
  public static void a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      ((gu)localProgressDialog).b(true);
      int i = 1;
      if (i == 0)
      {
        localObject = new gu(paramContext);
  ...
  {
    int i = em.b().n().a.resId;
    byte[] arrayOfByte = em.b().n().a.resData;
    if (arrayOfByte != null)
    {
      paramImageView.setBackgroundDrawable(a(arrayOfByte));
      return;
    }
    paramImageView.setBackgroundDrawable(a(fv.a(i)));
  }
  ...
  public static void a(String paramString)
  {
    ...
    ((StringBuilder)localObject).append(fy.a().H());
    APLog.i("showFirstPageInsertDB isShowFirstPage", ((StringBuilder)localObject).toString());
    if ((!fy.a().H()) && (!paramString.contains("APMidasDistributeActivity")))
    {
      int i = em.b().n().a.saveType;
      if ((i != 2) && (i != 3))
      {
        localObject = i();
        APDataReportManager.getInstance().insertData("sdk.apk.time", em.b().n().a.saveType, "", paramString, (String)localObject);
        fy.a().k(true);
      }
    }
  }
  ...
  {
    String str = em.b().n().a.extendInfo.unit;
    int i = em.b().n().a.saveType;
  ...
  private static String i()
  {
    ...
    localStringBuffer.append(em.b().n().e.j);
    localStringBuffer.append("&");
