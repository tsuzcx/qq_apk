  ...
  extends ig
{
  ...
  public void a(ProgressDialog paramProgressDialog)
  {
    ...
    {
    default: 
      ((ViewGroup.MarginLayoutParams)localObject).height = APUICommonMethod.a(this.h, 400.0F);
      break;
    case 4: 
    case 5: 
  ...
  public void a(String paramString)
  {
    ...
    APLog.d("APWebHFPage", ((StringBuilder)localObject1).toString());
    try
    {
    ...
    APLog.d("APWebHFPage", ((StringBuilder)localObject2).toString());
    paramString = APTools.p(paramString);
    if (!paramString.startsWith("unipay.sdk.android"))
    {
      APLog.d("APWebHFPage", "messageBody.startsWith(BASE_CALLBACK_URL) No, return");
      return;
    }
    ...
    APLog.d("APWebHFPage", paramString.toString());
    if (k != 0)
    {
      if (k != 2)
      {
