  ...
  implements View.OnClickListener
{
  ...
  fe f = new fe()
  {
    public void a()
    {
      ...
      ((LinearLayout)je.a(je.this).findViewById(2131099855)).setEnabled(true);
      je.this.e.a();
      je.this.e.setVisibility(8);
    ...
    {
      ((LinearLayout)je.a(je.this).findViewById(2131099855)).setEnabled(true);
      if ("wechat".equals(em.b().n().e.f))
      {
        if (paramAnonymousInt == 0)
        {
          Object localObject = em.b().n().b;
          if (2 == ((et)localObject).e())
          {
            APRecoChannelActivity.b = false;
            localObject = ((et)localObject).g();
            by.a().b((String)localObject, "3", new lw()
            {
              public void a(lh paramAnonymous2lh)
              {
                paramAnonymous2lh = (cg)paramAnonymous2lh;
                if (paramAnonymous2lh.T() == 0)
                {
                  if ((paramAnonymous2lh.a() != 2) && (paramAnonymous2lh.a() != 3) && (paramAnonymous2lh.a() != 4) && (paramAnonymous2lh.a() != 5))
                  {
                    je.b(je.this);
                    return;
                  }
                ...
                if (!TextUtils.isEmpty(paramAnonymous2lh.U()))
                {
                  je.this.a(paramAnonymous2lh.U(), true);
                  return;
                }
                je.b(je.this);
              }
        ...
        if (n.a().h()) {
          je.a(je.this, je.a(je.this));
        }
      }
      else if ("qqwallet".equals(em.b().n().e.f))
      {
        if (n.a().h()) {
          je.a(je.this, je.a(je.this));
        }
  ...
  {
    Object localObject1 = (ew)this.s.b;
  ...
  private void b(View paramView)
  {
    ...
    Object localObject1 = gn.a().d(this.r);
    if (localObject1 == null) {
      localObject1 = "";
    } else {
      localObject1 = ((gm)localObject1).f;
    }
    ...
    ((StringBuilder)localObject3).append(this.z.getString(2131230879));
    ...
    if (this.t == 0)
    {
      ...
      if ("hfpay".equals(this.r))
      {
        ...
        {
          localObject2 = ((eu)this.s.b).b(this.s.e.g, APHFChannel.o);
          localObject1 = this.s.b.a(this.s.e.g);
          StringBuilder localStringBuilder = new StringBuilder();
          localStringBuilder.append(this.z.getString(2131230879));
          localStringBuilder.append((String)localObject1);
          ...
          ((StringBuilder)localObject1).append(this.z.getString(2131230879));
        ...
        if ("hfpay".equals(this.r))
        {
          ...
          if (!TextUtils.isEmpty(APHFChannel.p))
          {
            ...
            if (!"0".equals(APHFChannel.p))
            {
              ...
              int i2 = Integer.parseInt(APHFChannel.p);
              if (i1 != i2)
              {
                a(i2);
                localObject2 = localObject1;
  ...
  private void c()
  {
    ...
    localLinearLayout.setOnClickListener(new gs()
    {
      ...
      {
        APDataReportManager.getInstance().insertData("sdk.coupons.btn.click", em.b().n().a.saveType, null, je.c(je.this).e.f, null);
        paramAnonymousView = new Intent();
        if (id.b(je.d(je.this))) {
          paramAnonymousView.setClass(je.d(je.this), APX5WebJSBridgeActivity.class);
        } else {
          paramAnonymousView.setClass(je.d(je.this), APWebJSBridgeActivity.class);
        }
        Bundle localBundle = new Bundle();
        localBundle.putString("pageName", hu.B);
        paramAnonymousView.putExtras(localBundle);
        ((Activity)je.d(je.this)).startActivityForResult(paramAnonymousView, 1);
      }
    });
  }
  ...
  private void c(View paramView)
  {
    ...
    ((LinearLayout)localObject).setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        if (je.this.d != null)
        {
          paramAnonymousView = new Intent(je.this.d, APGoldCouponsDeductSelectValueActivity.class);
          je.this.d.startActivityForResult(paramAnonymousView, 1001);
          je.this.d.overridePendingTransition(fv.a(je.this.d, "unipay_anim_in_from_right"), fv.a(je.this.d, "unipay_anim_out_to_left"));
          return;
        }
        if (je.d(je.this) != null)
        {
          paramAnonymousView = new Intent(je.d(je.this), APGoldCouponsDeductSelectValueActivity.class);
          if ((je.d(je.this) instanceof Activity))
          {
            ((Activity)je.d(je.this)).startActivityForResult(paramAnonymousView, 1001);
            ((Activity)je.d(je.this)).overridePendingTransition(fv.a(je.d(je.this), "unipay_anim_in_from_right"), fv.a(je.d(je.this), "unipay_anim_out_to_left"));
            return;
          }
  ...
  private void c(String paramString)
  {
    ...
    gm localgm = gn.a().d(this.r);
    this.o.setVisibility(8);
    this.p.setVisibility(8);
    b(this.y);
    this.j.setText(em.b().n().b.a);
    paramString = "";
    ...
    case 4: 
      ...
      {
        paramString = new StringBuilder();
        paramString.append(this.z.getString(2131230829));
        paramString.append(" ");
        paramString.append(this.s.e.g);
        paramString.append(((ew)this.s.b).h());
        paramString = paramString.toString();
      }
      break;
    case 0: 
    ...
    if (localgm != null)
    {
      this.q.setBackgroundResource(localgm.c);
      localObject2 = localgm.b;
    ...
    if (!"hfpay".equals(this.r))
    {
      ...
      } else if (((ew)this.s.b).n.equals("1"))
      {
        if (!APTools.o(this.r))
        {
    ...
    if (localgm != null)
    {
      if (!TextUtils.isEmpty(localgm.g))
      {
        paramString.setVisibility(0);
        paramString.setText(localgm.g);
      }
      else
      {
        paramString.setVisibility(8);
  ...
  private void d()
  {
    ...
    fb.a().a(this.z, str1, null, this.f, null);
  }
  ...
  private void e()
  {
    ...
    fy.a().e(true);
    APDataReportManager.getInstance().insertData("sdk.payexpress.change", this.t, em.b().n().e.l, em.b().n().e.f, null);
  ...
  private void g()
  {
    ...
    if (((this.t == 0) || (this.t == 1)) && ("wechat".equals(this.r)))
    {
      ...
      else if ((localet.e() == 0) || (1 == localet.e()))
      {
    ...
    try
    {
      ...
      ((HashMap)localObject).put("signState", String.valueOf(localet.e()));
      ((HashMap)localObject).put("userSignChoose", String.valueOf(this.s.b.f()));
      APDataReportManager.getInstance().insertData("sdk.wechat.sign.show", this.t, em.b().n().e.l, em.b().n().e.f, fv.a((HashMap)localObject));
      return;
    }
  ...
  public void a()
  {
    try
    {
      ...
      final String str1 = em.b().n().e.f;
      if ((("wechat".equals(str1)) || ("qqwallet".equals(str1))) && (((!fy.a().W()) && ("wechat".equals(str1))) || ((!fy.a().X()) && ("qqwallet".equals(str1)))))
      {
        if (n.a().c(str1)) {
  ...
  public void onClick(View paramView)
  {
    ...
    {
      APDataReportManager.getInstance().insertData("sdk.payexpress.close", this.t, em.b().n().e.l, em.b().n().e.f, null);
      f();
      return;
    }
    ...
    {
      APDataReportManager.getInstance().insertData("sdk.payexpress.sure", this.t, em.b().n().e.l, em.b().n().e.f, null);
      d();
    }
  }
}
