  ...
  implements kv
{
  ...
  public kz a(ky paramky, kz paramkz)
  {
    ...
    //   108: aconst_null
    //   109: astore 9
    //   111: new 65	java/io/FileInputStream
    //   114: dup
    //   115: aload 6
    //   117: invokespecial 68	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   120: astore 8
    //   122: new 70	java/io/FileOutputStream
    //   125: dup
    //   126: aload 7
    //   128: invokespecial 71	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   131: astore 6
    //   133: new 73	java/util/zip/GZIPOutputStream
    //   136: dup
    //   137: aload 6
    //   139: invokespecial 76	java/util/zip/GZIPOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   142: astore 9
    //   144: aload 8
    //   146: aload 10
    //   148: invokevirtual 80	java/io/FileInputStream:read	([B)I
    //   151: istore_3
    //   152: iload_3
    //   153: iconst_m1
    ...
    //   161: iconst_0
    //   162: iload_3
    //   163: invokevirtual 84	java/util/zip/GZIPOutputStream:write	([BII)V
    //   166: goto -22 -> 144
    //   169: aload 9
    //   171: invokevirtual 87	java/util/zip/GZIPOutputStream:flush	()V
    //   174: aload_1
    //   175: checkcast 19	midas/x/me
    //   178: new 33	java/io/File
    //   181: dup
    //   182: aload 7
    //   184: invokespecial 56	java/io/File:<init>	(Ljava/lang/String;)V
    //   187: invokevirtual 89	midas/x/me:a	(Ljava/io/File;)V
    //   190: new 30	java/lang/StringBuilder
    //   193: dup
    //   194: invokespecial 31	java/lang/StringBuilder:<init>	()V
    //   197: astore_1
    //   198: aload_1
    //   199: ldc 91
    //   201: invokevirtual 41	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   204: pop
    //   205: aload_1
    //   206: aload 7
    ...
    //   218: invokestatic 99	midas/x/ks:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   221: aload 8
    ...
    //   351: new 30	java/lang/StringBuilder
    //   354: dup
    //   355: invokespecial 31	java/lang/StringBuilder:<init>	()V
    //   358: astore 9
    //   360: aload 9
    //   362: ldc 110
    //   364: invokevirtual 41	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   367: pop
    //   368: aload 9
    //   370: aload 6
    //   372: invokevirtual 113	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   375: invokevirtual 41	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   378: pop
    //   379: ldc 93
    //   381: aload 9
    //   383: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   386: invokestatic 115	midas/x/ks:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   389: aload_2
    //   390: iconst_1
    //   391: putfield 121	midas/x/kz:d	Z
    //   394: aload 8
    //   396: ifnull +18 -> 414
    //   399: aload 8
    ...
    //   448: new 30	java/lang/StringBuilder
    //   451: dup
    //   452: invokespecial 31	java/lang/StringBuilder:<init>	()V
    //   455: astore_1
    //   456: aload_1
    //   457: ldc 123
    //   459: invokevirtual 41	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   462: pop
    //   463: aload_1
    //   464: invokestatic 25	java/lang/System:currentTimeMillis	()J
    //   467: lload 4
    //   469: lsub
    //   470: invokevirtual 126	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   473: pop
    //   474: ldc 128
    //   476: aload_1
    //   477: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   480: invokestatic 99	midas/x/ks:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   483: aload_2
    //   484: areturn
    //   485: astore_2
    //   486: aload 7
