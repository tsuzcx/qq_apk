...
public class gt
{
  ...
  public gt(Context paramContext, View paramView)
  {
    this.c = paramContext;
    this.d = paramView;
    this.b = new Handler();
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      try
      {
        ...
        {
          gt.b(gt.this).getContentView().measure(-2, -2);
          gt.c(gt.this);
          gt.b(gt.this).showAsDropDown(gt.d(gt.this), gt.e(gt.this), gt.f(gt.this));
          gt.d(gt.this).getViewTreeObserver().addOnGlobalLayoutListener(gt.g(gt.this));
          gt.i(gt.this).postDelayed(new gt.a(gt.this, null), gt.h(gt.this));
          return;
        }
      }
      catch (Exception localException)
