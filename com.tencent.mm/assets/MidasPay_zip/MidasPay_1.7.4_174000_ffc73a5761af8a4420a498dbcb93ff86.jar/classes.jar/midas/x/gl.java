  ...
  extends BaseAdapter
{
  ...
  public gl(Context paramContext, List<gm> paramList)
  {
    this.a = paramContext;
    this.b = paramList;
  }
  ...
  {
    int i = ((gm)this.b.get(paramInt)).c;
    Object localObject2 = ((gm)this.b.get(paramInt)).b;
    Object localObject3 = ((gm)this.b.get(paramInt)).f;
    boolean bool = ((gm)this.b.get(paramInt)).k;
    Object localObject1 = ((gm)this.b.get(paramInt)).e;
    Object localObject4 = ((gm)this.b.get(paramInt)).d;
    parama.a.setBackgroundResource(i);
    parama.b.setText((CharSequence)localObject2);
    if (!TextUtils.isEmpty(((gm)this.b.get(paramInt)).g))
    {
      parama.c.setVisibility(0);
      parama.c.setText(((gm)this.b.get(paramInt)).g);
    }
    else
    {
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject3))
    {
      if ((!((String)localObject3).trim().equals("100")) && (!((String)localObject3).trim().equals("10")))
      {
        ...
        if (((((el)localObject2).a.saveType == 3) || (((el)localObject2).a.saveType == 2)) && ("qqwallet".equals(((gm)this.b.get(paramInt)).a)))
        {
          i = APTools.g(((el)localObject2).b.a());
          try
          {
    ...
    if ("hfpay".equals(((gm)this.b.get(paramInt)).a))
    {
      if ((((el)localObject2).a.saveType == 0) && (!TextUtils.isEmpty(APHFChannel.o)))
      {
        localObject1 = ((eu)((el)localObject2).b).b(((el)localObject2).e.g, APHFChannel.o);
      ...
      if (((el)localObject2).a.saveType == 4)
      {
    ...
    else if ((((el)localObject2).a.saveType != 4) && (((el)localObject2).a.saveType != 5))
    {
      parama.f.setVisibility(8);
    }
    else if (((ew)((el)localObject2).b).n.equals("1"))
    {
      if (!APTools.o(((gm)this.b.get(paramInt)).a))
      {
    ...
    if ((!((gm)this.b.get(paramInt)).a.equals("qdqb")) && (!((gm)this.b.get(paramInt)).a.equals("qbqd")))
    {
  ...
  {
    if (((gm)this.b.get(paramInt)).j == -1) {
      return -1;
    }
    if (((gm)this.b.get(paramInt)).j == -2) {
      return -2;
    }
    return 1;
  }
  ...
  public boolean isEnabled(int paramInt)
  {
    ...
    return ((gm)this.b.get(paramInt)).j != -2;
  }
