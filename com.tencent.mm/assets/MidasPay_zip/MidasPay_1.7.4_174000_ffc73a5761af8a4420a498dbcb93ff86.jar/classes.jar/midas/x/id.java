...
public class id
{
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    if (paramString.equals("0"))
    {
      ...
      localfz.a(paramContext.getApplicationContext(), "TencentUnipay", "enableX5", "0");
      APDataReportManager.getInstance().insertData("sdk.x5.disabled", -1, "", "", "");
      return;
    }
    if (paramString.equals("1"))
    {
      localfz.a(paramContext.getApplicationContext(), "TencentUnipay", "enableX5", "1");
    ...
    {
      localfz.a(paramContext.getApplicationContext(), "TencentUnipay", "enableX5", "2");
  ...
  {
    String str = new fz().a(paramContext.getApplicationContext(), "TencentUnipay", "enableX5");
    boolean bool;
