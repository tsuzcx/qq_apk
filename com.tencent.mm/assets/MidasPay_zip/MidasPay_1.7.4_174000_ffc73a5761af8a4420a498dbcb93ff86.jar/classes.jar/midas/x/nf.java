  ...
  implements IOpenApiListener
{
  ...
  private nf(Context paramContext, String paramString)
  {
    this.a = OpenApiFactory.getInstance(paramContext, paramString);
    this.b = new PayApi();
  }
  
  public static nf a(Context paramContext)
  {
    return c;
  }
  
  public static nf a(Context paramContext, String paramString)
  {
    ...
    if (c == null) {
      ...
      {
        if (c == null) {
          c = new nf(paramContext.getApplicationContext(), paramString);
        }
      }
      finally {}
    }
