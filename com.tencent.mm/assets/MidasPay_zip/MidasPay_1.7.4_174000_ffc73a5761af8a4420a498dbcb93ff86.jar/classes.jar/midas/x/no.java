  ...
  implements Cloneable
{
  ...
  public no(int paramInt1, int paramInt2)
  {
  ...
  private no(int paramInt1, int paramInt2, int paramInt3, int[] paramArrayOfInt)
  {
    this.a = paramInt1;
    this.b = paramInt2;
    this.c = paramInt3;
  ...
  public no a()
  {
    return new no(this.a, this.b, this.c, (int[])this.d.clone());
  }
  ...
  {
    boolean bool1 = paramObject instanceof no;
    boolean bool2 = false;
    if (!bool1) {
      return false;
    }
