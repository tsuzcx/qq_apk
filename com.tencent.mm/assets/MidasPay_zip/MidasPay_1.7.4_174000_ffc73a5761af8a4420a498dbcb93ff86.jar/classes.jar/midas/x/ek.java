...
public class ek
{
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    if ((!APAppDataInterface.singleton().e().equals("release")) && (!APAppDataInterface.singleton().z())) {
      return paramString1;
    }
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        paramString1 = a(gh.b((String)localObject, paramString2), i);
        return paramString1;
      }
      return null;
    }
  ...
  public static JSONArray a(JSONObject paramJSONObject, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      em.b().e();
      em.b().f();
      paramJSONObject = new JSONArray(a(gh.b(paramString1, paramString2), i));
      return paramJSONObject;
    }
  ...
  public static Object b(JSONObject paramJSONObject, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      i = Integer.parseInt(paramJSONObject.substring(i + 1, paramJSONObject.length()));
      paramJSONObject = new JSONObject(a(gh.b(str, paramString2), i)).get(paramString1);
      return paramJSONObject;
    }
    catch (UnsupportedEncodingException paramJSONObject)
    {
  ...
  public static int c(JSONObject paramJSONObject, String paramString1, String paramString2)
  {
    if ((!APAppDataInterface.singleton().e().equals("release")) && (!APAppDataInterface.singleton().z())) {
      try
      {
    ...
    paramJSONObject = b(paramJSONObject, paramString1, paramString2);
