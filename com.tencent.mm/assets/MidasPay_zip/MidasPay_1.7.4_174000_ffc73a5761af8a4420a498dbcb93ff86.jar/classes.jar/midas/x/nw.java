...
public final class nw
{
  ...
  private static final nw[] b = d();
  private final int c;
  private final int[] d;
  private final b[] e;
  private final int f;
  
  private nw(int paramInt, int[] paramArrayOfInt, b... paramVarArgs)
  {
    this.c = paramInt;
  ...
  public static nw a(int paramInt)
  {
  ...
  private static nw[] d()
  {
    ...
    localObject1 = new nw(1, new int[0], new b[] { localObject1, localObject2, localObject3, localObject4 });
    ...
    localObject2 = new nw(2, new int[] { 6, 18 }, new b[] { localObject2, localObject3, localObject4, localObject5 });
    ...
    localObject3 = new nw(3, new int[] { 6, 22 }, new b[] { localObject3, localObject4, localObject5, localObject6 });
    ...
    localObject4 = new nw(4, new int[] { 6, 26 }, new b[] { localObject4, localObject5, localObject6, localObject7 });
    ...
    localObject5 = new nw(5, new int[] { 6, 30 }, new b[] { localObject5, localObject6, localObject7, localObject8 });
    ...
    localObject6 = new nw(6, new int[] { 6, 34 }, new b[] { localObject6, localObject7, localObject8, localObject9 });
    ...
    localObject7 = new nw(7, new int[] { 6, 22, 38 }, new b[] { localObject7, localObject8, localObject9, localObject10 });
    ...
    localObject8 = new nw(8, new int[] { 6, 24, 42 }, new b[] { localObject8, localObject9, localObject10, localObject11 });
    ...
    localObject9 = new nw(9, new int[] { 6, 26, 46 }, new b[] { localObject9, localObject10, localObject11, localObject12 });
    ...
    localObject10 = new nw(10, new int[] { 6, 28, 50 }, new b[] { localObject10, localObject11, localObject12, localObject13 });
    ...
    localObject11 = new nw(11, new int[] { 6, 30, 54 }, new b[] { localObject11, localObject12, localObject13, localObject14 });
    ...
    localObject12 = new nw(12, new int[] { 6, 32, 58 }, new b[] { localObject12, localObject13, localObject14, localObject15 });
    ...
    localObject13 = new nw(13, new int[] { 6, 34, 62 }, new b[] { localObject13, localObject14, localObject15, localObject16 });
    ...
    localObject14 = new nw(14, new int[] { 6, 26, 46, 66 }, new b[] { localObject14, localObject15, localObject16, localObject17 });
    ...
    localObject15 = new nw(15, new int[] { 6, 26, 48, 70 }, new b[] { localObject15, localObject16, localObject17, localObject18 });
    ...
    localObject16 = new nw(16, new int[] { 6, 26, 50, 74 }, new b[] { localObject16, localObject17, localObject18, localObject19 });
    ...
    localObject17 = new nw(17, new int[] { 6, 30, 54, 78 }, new b[] { localObject17, localObject18, localObject19, localObject20 });
    ...
    localObject18 = new nw(18, new int[] { 6, 30, 56, 82 }, new b[] { localObject18, localObject19, localObject20, localObject21 });
    ...
    localObject19 = new nw(19, new int[] { 6, 30, 58, 86 }, new b[] { localObject19, localObject20, localObject21, localObject22 });
    ...
    localObject20 = new nw(20, new int[] { 6, 34, 62, 90 }, new b[] { localObject20, localObject21, localObject22, localObject23 });
    ...
    localObject21 = new nw(21, new int[] { 6, 28, 50, 72, 94 }, new b[] { localObject21, localObject22, localObject23, localObject24 });
    ...
    localObject22 = new nw(22, new int[] { 6, 26, 50, 74, 98 }, new b[] { localObject22, localObject23, localObject24, localObject25 });
    ...
    localObject23 = new nw(23, new int[] { 6, 30, 54, 78, 102 }, new b[] { localObject23, localObject24, localObject25, localObject26 });
    ...
    localObject24 = new nw(24, new int[] { 6, 28, 54, 80, 106 }, new b[] { localObject24, localObject25, localObject26, localObject27 });
    ...
    localObject25 = new nw(25, new int[] { 6, 32, 58, 84, 110 }, new b[] { localObject25, localObject26, localObject27, localObject28 });
    ...
    localObject26 = new nw(26, new int[] { 6, 30, 58, 86, 114 }, new b[] { localObject26, localObject27, localObject28, localObject29 });
    ...
    localObject27 = new nw(27, new int[] { 6, 34, 62, 90, 118 }, new b[] { localObject27, localObject28, localObject29, localObject30 });
    ...
    localObject28 = new nw(28, new int[] { 6, 26, 50, 74, 98, 122 }, new b[] { localObject28, localObject29, localObject30, localObject31 });
    ...
    localObject29 = new nw(29, new int[] { 6, 30, 54, 78, 102, 126 }, new b[] { localObject29, localObject30, localObject31, localObject32 });
    ...
    localObject30 = new nw(30, new int[] { 6, 26, 52, 78, 104, 130 }, new b[] { localObject30, localObject31, localObject32, localObject33 });
    ...
    localObject31 = new nw(31, new int[] { 6, 30, 56, 82, 108, 134 }, new b[] { localObject31, localObject32, localObject33, localObject34 });
    ...
    localObject32 = new nw(32, new int[] { 6, 34, 60, 86, 112, 138 }, new b[] { localObject32, localObject33, localObject34, localObject35 });
    ...
    localObject33 = new nw(33, new int[] { 6, 30, 58, 86, 114, 142 }, new b[] { localObject33, localObject34, localObject35, localObject36 });
    ...
    localObject34 = new nw(34, new int[] { 6, 34, 62, 90, 118, 146 }, new b[] { localObject34, localObject35, localObject36, localObject37 });
    ...
    localObject35 = new nw(35, new int[] { 6, 30, 54, 78, 102, 126, 150 }, new b[] { localObject35, localObject36, localObject37, localObject38 });
    ...
    localObject36 = new nw(36, new int[] { 6, 24, 50, 76, 102, 128, 154 }, new b[] { localObject36, localObject37, localObject38, localObject39 });
    ...
    localObject37 = new nw(37, new int[] { 6, 28, 54, 80, 106, 132, 158 }, new b[] { localObject37, localObject38, localObject39, localb1 });
    ...
    localObject38 = new nw(38, new int[] { 6, 32, 58, 84, 110, 136, 162 }, new b[] { localObject38, localObject39, localb1, localb2 });
    ...
    localObject39 = new nw(39, new int[] { 6, 26, 54, 82, 110, 138, 166 }, new b[] { localObject39, localb1, localb2, localb3 });
  ...
  public b a(nu paramnu)
  {
    return this.e[paramnu.ordinal()];
  }
  ...
  public static final class b
  {
    ...
    b(int paramInt, nw.a... paramVarArgs)
    {
      this.a = paramInt;
      this.b = paramVarArgs;
    }
