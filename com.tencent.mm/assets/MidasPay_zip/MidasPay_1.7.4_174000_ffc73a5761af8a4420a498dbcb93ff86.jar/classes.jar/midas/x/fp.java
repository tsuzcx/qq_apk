...
public class fp
{
  ...
  public Handler e = new Handler(new Handler.Callback()
  {
    public boolean handleMessage(Message paramAnonymousMessage)
    {
      ...
      localStringBuilder.append(fp.a(fp.this));
      APLog.i("APWechatChannel", localStringBuilder.toString());
      if (fp.a(fp.this) != null) {
        fp.a(fp.this).send(i, paramAnonymousMessage);
      }
      try
      {
        fp.b(fp.this).b(fp.this.e);
      }
  ...
  public fp(Context paramContext, String paramString)
  {
    StringBuilder localStringBuilder = new StringBuilder();
  ...
  private void a(int paramInt, Bundle paramBundle)
  {
    ...
    if ((em.b().n() != null) && (em.b().n().a != null)) {
      APDataReportManager.getInstance().insertData("sdk.wechatcallback", em.b().n().a.saveType, em.b().n().e.m, String.valueOf(paramInt), null);
    } else {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.j == 2) {
        if ("v2".equals(fy.a().M().toLowerCase()))
        {
          if ((!TextUtils.isEmpty(fy.a().N())) && (!TextUtils.isEmpty(fy.a().P()))) {
            a(fy.a().N(), fy.a().M(), fy.a().P(), fy.a().O());
          }
        }
        else if ((!TextUtils.isEmpty(fy.a().N())) && (!TextUtils.isEmpty(fy.a().O()))) {
          a(fy.a().N(), fy.a().M(), fy.a().P(), fy.a().O());
        }
      }
      APUICommonMethod.b();
    ...
    {
      APUICommonMethod.b();
      fv.a(paramInt, "系统繁忙,请稍后再试(100-100--1)");
      return;
    }
    if (paramInt == -2)
    {
  ...
  public void a(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    //   294: aload_2
    //   295: aload 4
    //   297: invokestatic 121	midas/x/fy:a	()Lmidas/x/fy;
    //   300: invokevirtual 457	midas/x/fy:i	()Ljava/lang/String;
    ...
    //   539: iconst_0
    //   540: aload_0
    //   541: getfield 63	midas/x/fp:g	Landroid/content/Context;
    //   544: invokevirtual 489	android/content/Context:getApplicationContext	()Landroid/content/Context;
    //   547: aastore
    //   548: dup
    //   549: iconst_1
    //   550: invokestatic 121	midas/x/fy:a	()Lmidas/x/fy;
    //   553: invokevirtual 492	midas/x/fy:z	()Ljava/lang/String;
    //   556: aastore
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12)
  {
    ...
    a(paramString1, paramString2, paramString3, paramString4, paramString5, paramString6, paramString7, new ResultReceiver(new Handler())
    {
      ...
      {
        fp.a(fp.this, paramAnonymousInt, paramAnonymousBundle);
  ...
  public void b()
  {
    ...
    by.a().d(new lw()
    {
      public void a(lh paramAnonymouslh)
      {
        ...
        {
          String str1 = paramAnonymouslh.h();
          String str2 = paramAnonymouslh.f();
          String str3 = paramAnonymouslh.g();
          boolean bool = fp.this.a(str1, fy.a().M(), str3, str2);
          APUICommonMethod.b();
          if (bool)
          {
            fv.a(8, -1, -1);
          ...
          fv.a(3, "launch wechat error", paramAnonymouslh.W());
          return;
        }
        APUICommonMethod.b();
        fv.a(3, "sign getcardbillinfo onFinish err", paramAnonymouslh.W());
      }
      
      public void b(lh paramAnonymouslh)
      {
        APUICommonMethod.b();
        fv.a(3, "sign getcardbillinfo onError");
      }
      
      public void c(lh paramAnonymouslh)
      {
        APUICommonMethod.b();
        fv.a(3, "sign getcardbillinfo stop");
      }
    });
  }
  ...
  public void c()
  {
    by.a().e(new lw()
    {
      public void a(lh paramAnonymouslh)
      {
        ...
        fv.a(3, "unsign getcardbillinfo onFinish err", paramAnonymouslh.W());
      }
      
      public void b(lh paramAnonymouslh)
      {
        APUICommonMethod.b();
        fv.a(3, "unsign getcardbillinfo onError");
      }
