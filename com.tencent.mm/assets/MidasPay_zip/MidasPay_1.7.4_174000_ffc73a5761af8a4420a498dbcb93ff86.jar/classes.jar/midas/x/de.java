  ...
  extends cd
{
  public de()
  {
    a("https", String.format("/v1/r/%s/mobile_buy_page", new Object[] { em.b().n().a.offerId }), "442");
    b();
  }
  ...
  private void a(ez paramez)
  {
    ...
    e("pre_uuid", gf.b().c());
    e("drm_act_type", gf.b().d());
    e("drm_resource", gf.b().e());
    paramez = "0";
  ...
  public void b()
  {
    ...
    e("format", "json");
    e("sdkversion", fv.c());
    e("accounttype", localel.a.acctType);
