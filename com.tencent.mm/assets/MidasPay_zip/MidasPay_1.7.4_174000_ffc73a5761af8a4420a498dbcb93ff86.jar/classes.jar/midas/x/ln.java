  ...
  extends lc
{
  ...
  public ln(String paramString, c paramc)
  {
    this.a = paramString;
    this.b = paramc;
  }
  
  private boolean b(ky paramky)
  {
    boolean bool = false;
    if (paramky == null) {
      return false;
  ...
  private void c(ky paramky)
  {
    try
    {
      ...
      {
        paramky.a(localSSLContext.getSocketFactory());
        this.e.set(Boolean.valueOf(true));
        return;
      }
      paramky.a(new ln.a.a(localSSLContext.getSocketFactory()));
      this.e.set(Boolean.valueOf(true));
      return;
    }
  ...
  public void a(ky paramky)
  {
    ...
    if (b(paramky))
    {
      if (!paramky.c("https.protocols", "TLSv1"))
      {
        paramky.b("https.protocols", "TLSv1");
  ...
  public void a(ky paramky, kz paramkz)
  {
    ...
    if (((Boolean)this.c.get()).booleanValue())
    {
      ...
      paramky.d("https.protocols", "TLSv1");
    }
      ...
      extends SSLSocketFactory
    {
      ...
      private static Socket a(Socket paramSocket)
      {
        ...
        if ((paramSocket instanceof SSLSocket))
        {
          ...
          if (!(paramSocket instanceof ln.a.b))
          {
            localObject = new ln.a.b((SSLSocket)paramSocket, null);
  ...
  {
    private final ln.c a;
    
    private d(ln.c paramc)
    {
      this.a = paramc;
    }
