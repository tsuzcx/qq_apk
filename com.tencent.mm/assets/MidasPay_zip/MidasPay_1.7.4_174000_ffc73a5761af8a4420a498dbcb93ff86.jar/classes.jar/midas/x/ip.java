  ...
  extends ig
{
  ...
  private HashMap<String, String> g()
  {
    ...
    this.d.put("page", hu.B);
    this.d.put("expressChannel", em.b().n().e.f);
    this.d.put("sdkType", "android");
    this.d.put("saveType", String.valueOf(em.b().n().a.saveType));
    if (fv.f()) {
      this.d.put("supportChannel", em.b().n().a.mpInfo.payChannel);
    } else {
      this.d.put("supportChannel", gn.a().h());
    }
  ...
  public void a(ProgressDialog paramProgressDialog)
  {
    ...
    APDataReportManager.getInstance().insertData("sdk.coupons.page.show", em.b().n().a.saveType, null, null, null);
    if (this.h != null) {
      this.h.show();
    }
    if (this.g != null) {
