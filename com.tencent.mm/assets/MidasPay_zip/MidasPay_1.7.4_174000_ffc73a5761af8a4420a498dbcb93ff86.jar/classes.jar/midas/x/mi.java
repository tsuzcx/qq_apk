  ...
  implements Serializable
{
  ...
  public mi(mi parammi)
  {
    this.a = parammi.a;
    this.b = new Pair(parammi.b.first, parammi.b.second);
    this.d = parammi.d;
    this.e = parammi.e;
    this.c = new Pair[parammi.c.length];
    int i = 0;
    while (i < this.c.length)
    {
      this.c[i] = new Pair(parammi.c[i].first, parammi.c[i].second);
      i += 1;
    }
  }
  ...
  private void readObject(ObjectInputStream paramObjectInputStream)
  {
    ...
    mn.b("IPNode", localStringBuilder.toString());
    try
    {
      paramObjectInputStream = paramObjectInputStream.readFields();
      this.a = mk.a((String)paramObjectInputStream.get("ip", mk.b("")));
      a(mk.a((String)paramObjectInputStream.get("measure", mk.b(new mi("").b()))));
      a(mk.a((String)paramObjectInputStream.get("history", mk.b(new mi("").a()))), Integer.valueOf(mk.a((String)paramObjectInputStream.get("index", mk.b("0")))).intValue());
      this.e = Integer.valueOf(mk.a((String)paramObjectInputStream.get("category", mk.b("0"))));
      return;
    }
  ...
  private void writeObject(ObjectOutputStream paramObjectOutputStream)
  {
    ...
    mn.b("IPNode", ((StringBuilder)localObject).toString());
    try
    {
      localObject = paramObjectOutputStream.putFields();
      ((ObjectOutputStream.PutField)localObject).put("ip", mk.b(this.a));
      ((ObjectOutputStream.PutField)localObject).put("measure", mk.b(b()));
      ((ObjectOutputStream.PutField)localObject).put("history", mk.b(a()));
      ((ObjectOutputStream.PutField)localObject).put("index", mk.b(String.valueOf(this.d)));
      ((ObjectOutputStream.PutField)localObject).put("category", mk.b(String.valueOf(this.e)));
