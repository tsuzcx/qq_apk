...
public class fb
{
  ...
  public ArrayList<ff.b> a = null;
  private HashMap<String, ff> c = null;
  private Context d;
  ...
  public static ff a(String paramString)
  {
    if (a().c == null) {
      b.c = new HashMap();
    }
    ff localff = (ff)b.c.get(paramString);
    if (localff == null)
    {
      int j = 0;
      int k;
      ...
      {
        k = i;
        if (((ff.b)b.a.get(j)).a.equals(paramString))
        {
          int m = 1;
          int n = 1;
          int i1 = 1;
          ...
          try
          {
            Object localObject = Class.forName(((ff.b)b.a.get(j)).b);
            try
            {
              localObject = (ff)((Class)localObject).newInstance();
              ((ff)localObject).a(paramString);
          ...
          {
            localStringBuilder = new StringBuilder();
            localStringBuilder.append(((ff.b)b.a.get(j)).b);
  ...
  private void a(Context paramContext, lh paramlh, fe paramfe, fd paramfd)
  {
    Object localObject = (ci)paramlh;
    int i = ((ci)localObject).T();
    String str = em.b().n().e.j;
    APHFChannel.b(((ci)localObject).a());
    if ((i != 0) && (paramfe != null)) {
      paramfe.a(i);
    }
    ...
    if (i != 0)
    {
      ...
      a(paramContext, str, paramlh, paramfe, paramfd);
    }
  }
  ...
  private boolean h()
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        if ("hfpay".equals(((gm)((Iterator)localObject).next()).a)) {
          return true;
        }
      }
    }
  ...
  public void a(Activity paramActivity, APBaseRequest paramAPBaseRequest)
  {
    ...
    em.b().n().c.c(paramActivity, paramAPBaseRequest);
  }
  
  public void a(Activity paramActivity, fl paramfl)
  {
    ((APHFChannel)a("hfpay")).a(paramActivity, paramfl);
  }
  
  public void a(Activity paramActivity, fm paramfm)
  {
    ((APMcardChannel)a("mcard")).a(paramActivity, paramfm);
  }
  
  public void a(Context paramContext, String paramString, lh paramlh, fe paramfe, fd paramfd)
  {
    paramlh = new Bundle();
    ...
    {
      b(paramContext, paramString, paramlh, paramfe, paramfd);
      return;
    }
    a(paramContext, "channelList", null);
  }
  
  public void a(final Context paramContext, final fe paramfe, final fd paramfd)
  {
    this.d = paramContext;
    by.a().i(new lw()
    {
      ...
      {
        fb.a(fb.this, paramContext, paramAnonymouslh, paramfe, paramfd);
      }
      ...
      public void b(lh paramAnonymouslh)
      {
        em.b().n().e.j = "";
        if (paramfe != null) {
          paramfe.a(paramAnonymouslh.T(), "", paramAnonymouslh.U());
        }
        fb.this.a(paramContext, "channelList", null);
      }
  ...
  public void a(Bundle paramBundle, fe paramfe, fd paramfd)
  {
    o.a().a(true);
    gm localgm = (gm)gn.a().d().get(0);
    Object localObject = new StringBuilder();
    ((StringBuilder)localObject).append("gotoOneChannel channelId:");
    ((StringBuilder)localObject).append(localgm.a);
    APLog.e("APPayManager", ((StringBuilder)localObject).toString());
    localObject = a(localgm.a);
    if (localObject != null)
    {
      em.b().n().e.f = localgm.a;
      ((ff)localObject).a(this.d, paramBundle, paramfe, paramfd);
    }
  }
  ...
  public boolean a(Context paramContext, String paramString, Bundle paramBundle, fe paramfe, fd paramfd)
  {
    this.d = paramContext;
    ff localff = a(paramString);
    if (localff != null)
    {
      if (!"goldcouponsdeduct".equals(paramString)) {
        em.b().n().e.f = paramString;
      }
      localff.a(paramContext, paramBundle, paramfe, paramfd);
      return true;
    }
  ...
  public boolean a(Context paramContext, String paramString, fe paramfe, fd paramfd)
  {
    this.d = paramContext;
    Object localObject = new StringBuilder();
    ...
    if (localObject != null)
    {
      if ((paramString != null) && (paramString.equals("hfpay"))) {
        new Thread(new b(paramContext, (ff)localObject, paramfe, paramfd)).start();
      } else {
        ((ff)localObject).a(paramContext, paramfe, paramfd);
      }
      return true;
    }
    if (paramfe != null) {
  ...
  public boolean b(Context paramContext, String paramString, Bundle paramBundle, fe paramfe, fd paramfd)
  {
    this.d = paramContext;
    Object localObject = new StringBuilder();
    ...
    if (localObject != null)
    {
      if (("qqwallet".equals(paramString)) && ((!fn.b()) || (!fn.a())))
      {
        APDataReportManager.getInstance().insertData("sdk.express.qqwallet.nosupport", em.b().n().a.saveType, null, paramString, null);
      ...
      em.b().n().e.f = paramString;
      if ((paramfe == null) && (paramfd == null))
      {
        ((ff)localObject).a(paramContext, paramBundle);
        return true;
      }
      ((ff)localObject).b(paramContext, paramBundle, paramfe, paramfd);
      return true;
    }
    APLog.e("APPayManager", "toPay channel object is null");
    d();
  ...
  public void c()
  {
    ...
    this.a.add(new ff.b("qdqb", "com.pay.paychannel.qdqb.APQDQBChannel", ""));
    this.a.add(new ff.b("qbqd", "com.pay.paychannel.qdqb.APQDQBChannel", ""));
    this.a.add(new ff.b("cft", "com.pay.paychannel.tenpay.APTenpayChannel", ""));
    this.a.add(new ff.b("bank", "com.pay.paychannel.tenpay.APTenpayChannel", ""));
    this.a.add(new ff.b("wechat", "com.pay.paychannel.wx.APWechatChannel", ""));
    this.a.add(new ff.b("qqwallet", "com.pay.paychannel.qqwallet.APQQWalletChannel", ""));
    this.a.add(new ff.b("qqcard", "com.pay.paychannel.qqcard.APQQCardChannel", ""));
    this.a.add(new ff.b("hfpay", "com.pay.paychannel.hfpay.APHFChannel", ""));
    this.a.add(new ff.b("mcard", "com.pay.paychannel.mcard.APMcardChannel", ""));
    this.a.add(new ff.b("gold_coupons", "com.pay.paychannel.goldcoupons.APGoldCouponsChannel", ""));
    this.a.add(new ff.b("yb", "com.pay.paychannel.yuanbao.APYBChannel", ""));
    this.a.add(new ff.b("friends_pay", "com.pay.paychannel.friend.APFriendChannel", ""));
    this.a.add(new ff.b("goldcouponsdeduct", "com.pay.paychannel.goldcouponsdeduct.APGoldCouponsDeductChannel", ""));
  }
  ...
  public void e()
  {
    ...
    try
    {
      ...
      Iterator localIterator = fk.b(APHFChannel.n).iterator();
      while (localIterator.hasNext())
      {
        fi localfi = (fi)localIterator.next();
        if ((!TextUtils.isEmpty(localfi.g)) && (localfi.a()))
        {
          fh localfh = (fh)APHFChannel.a(Integer.valueOf(APHFChannel.E), localfi.c);
          if (localfh != null)
          {
            ((ArrayList)localObject2).add(localfh);
            ((ArrayList)localObject1).add(localfi);
          }
        }
      }
      ...
      fh.G = new CountDownLatch(((ArrayList)localObject1).size());
      fh.H = System.currentTimeMillis();
      int i = 0;
      while (i < ((ArrayList)localObject1).size())
      {
        this.e.execute(new c((fh)((ArrayList)localObject2).get(i), ((fi)((ArrayList)localObject1).get(i)).g));
        i += 1;
      }
  ...
  public boolean g()
  {
    ...
    {
      gm localgm = (gm)gn.a().d().get(0);
      if (("wechat".equals(localgm.a)) || ("qqwallet".equals(localgm.a))) {
        return true;
      }
    }
    return false;
    ...
    implements Runnable
  {
    ...
    private final WeakReference<fd> d;
    
    public a(Context paramContext, ff paramff, fe paramfe, fd paramfd)
    {
      this.a = new WeakReference(paramContext);
      this.b = new WeakReference(paramff);
      this.c = new WeakReference(paramfe);
      this.d = new WeakReference(paramfd);
    }
    
    public void run()
    {
      Context localContext = (Context)this.a.get();
      ff localff = (ff)this.b.get();
      Object localObject = (fe)this.c.get();
      fd localfd = (fd)this.d.get();
      if ((localContext != null) && (localff != null))
      {
        APLog.d("APPayManager", "DoPayRunnable() doPay");
        localff.a(localContext, (fe)localObject, localfd);
        return;
      }
      localObject = new StringBuilder();
      ...
      ((StringBuilder)localObject).append(localff);
    ...
    implements Runnable
  {
    ...
    public b(Context paramContext, ff paramff, fe paramfe, fd paramfd)
    {
      this.a = new WeakReference(paramContext);
      this.b = new WeakReference(paramff);
      this.c = new WeakReference(paramfe);
    ...
    public void run()
    {
      // Byte code:
      //   0: aload_0
      //   1: getfield 29	midas/x/fb$b:a	Ljava/lang/ref/WeakReference;
      //   4: invokevirtual 45	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
      //   7: checkcast 47	android/content/Context
      //   10: astore 12
      //   12: aload_0
      //   13: getfield 31	midas/x/fb$b:b	Ljava/lang/ref/WeakReference;
      //   16: invokevirtual 45	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
      //   19: checkcast 49	midas/x/ff
      //   22: astore 13
      //   24: aload_0
      //   25: getfield 33	midas/x/fb$b:c	Ljava/lang/ref/WeakReference;
      //   28: invokevirtual 45	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
      //   31: checkcast 51	midas/x/fe
      //   34: astore 14
      //   36: aload_0
      //   37: getfield 35	midas/x/fb$b:d	Ljava/lang/ref/WeakReference;
      //   40: invokevirtual 45	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
      //   43: checkcast 53	midas/x/fd
      //   46: astore 15
      //   48: aload 12
      //   50: ifnull +1472 -> 1522
      //   53: aload 13
      //   55: ifnull +1467 -> 1522
      //   58: invokestatic 58	midas/x/fy:a	()Lmidas/x/fy;
      //   61: invokevirtual 62	midas/x/fy:Z	()J
      //   64: lstore_1
      ...
      //   76: iconst_1
      //   77: istore 9
      //   79: getstatic 82	midas/x/fh:G	Ljava/util/concurrent/CountDownLatch;
      //   82: ifnull +24 -> 106
      //   85: getstatic 82	midas/x/fh:G	Ljava/util/concurrent/CountDownLatch;
      //   88: lload_1
      ...
      //   144: getstatic 114	midas/x/fh:H	J
      //   147: lconst_0
      //   148: lcmp
      //   149: ifle +261 -> 410
      ...
      //   164: lstore 5
      //   166: getstatic 114	midas/x/fh:H	J
      //   169: lstore 7
      ...
      //   386: ldc 137
      //   388: invokestatic 142	midas/x/em:b	()Lmidas/x/em;
      //   391: invokevirtual 146	midas/x/em:n	()Lmidas/x/el;
      //   394: getfield 151	midas/x/el:a	Lcom/pay/api/request/APBaseRequest;
      ...
      //   428: astore 11
      //   430: new 165	midas/x/fb$a
      //   433: dup
      //   434: aload 12
      //   436: aload 13
      //   438: aload 14
      //   440: aload 15
      //   442: invokespecial 167	midas/x/fb$a:<init>	(Landroid/content/Context;Lmidas/x/ff;Lmidas/x/fe;Lmidas/x/fd;)V
      //   445: astore 12
      //   447: aload 11
      //   449: aload 12
      ...
      //   459: aload 14
      //   461: aload 15
      //   463: invokevirtual 174	midas/x/ff:a	(Landroid/content/Context;Lmidas/x/fe;Lmidas/x/fd;)V
      //   466: return
      //   467: astore 11
      //   469: iconst_0
      //   470: istore 9
      ...
      //   516: getstatic 114	midas/x/fh:H	J
      //   519: lconst_0
      //   520: lcmp
      //   521: ifle +260 -> 781
      ...
      //   536: lstore 5
      //   538: getstatic 114	midas/x/fh:H	J
      //   541: lstore 7
      ...
      //   757: ldc 137
      //   759: invokestatic 142	midas/x/em:b	()Lmidas/x/em;
      //   762: invokevirtual 146	midas/x/em:n	()Lmidas/x/el;
      //   765: getfield 151	midas/x/el:a	Lcom/pay/api/request/APBaseRequest;
      ...
      //   799: astore 11
      //   801: new 165	midas/x/fb$a
      //   804: dup
      //   805: aload 12
      //   807: aload 13
      //   809: aload 14
      //   811: aload 15
      //   813: invokespecial 167	midas/x/fb$a:<init>	(Landroid/content/Context;Lmidas/x/ff;Lmidas/x/fe;Lmidas/x/fd;)V
      //   816: astore 12
      //   818: goto -371 -> 447
      //   821: astore 11
      //   823: aload 11
      ...
      //   862: getstatic 114	midas/x/fh:H	J
      //   865: lconst_0
      //   866: lcmp
      //   867: ifle +260 -> 1127
      ...
      //   882: lstore 5
      //   884: getstatic 114	midas/x/fh:H	J
      //   887: lstore 7
      ...
      //   1103: ldc 137
      //   1105: invokestatic 142	midas/x/em:b	()Lmidas/x/em;
      //   1108: invokevirtual 146	midas/x/em:n	()Lmidas/x/el;
      //   1111: getfield 151	midas/x/el:a	Lcom/pay/api/request/APBaseRequest;
      ...
      //   1145: astore 11
      //   1147: new 165	midas/x/fb$a
      //   1150: dup
      //   1151: aload 12
      //   1153: aload 13
      //   1155: aload 14
      //   1157: aload 15
      //   1159: invokespecial 167	midas/x/fb$a:<init>	(Landroid/content/Context;Lmidas/x/ff;Lmidas/x/fe;Lmidas/x/fd;)V
      //   1162: astore 12
      //   1164: goto -717 -> 447
      //   1167: astore 11
      ...
      //   1203: getstatic 114	midas/x/fh:H	J
      //   1206: lconst_0
      //   1207: lcmp
      //   1208: ifle +261 -> 1469
      ...
      //   1223: lstore 5
      //   1225: getstatic 114	midas/x/fh:H	J
      //   1228: lstore 7
      ...
      //   1445: ldc 137
      //   1447: invokestatic 142	midas/x/em:b	()Lmidas/x/em;
      //   1450: invokevirtual 146	midas/x/em:n	()Lmidas/x/el;
      //   1453: getfield 151	midas/x/el:a	Lcom/pay/api/request/APBaseRequest;
      ...
      //   1487: new 165	midas/x/fb$a
      //   1490: dup
      //   1491: aload 12
      //   1493: aload 13
      //   1495: aload 14
      //   1497: aload 15
      //   1499: invokespecial 167	midas/x/fb$a:<init>	(Landroid/content/Context;Lmidas/x/ff;Lmidas/x/fe;Lmidas/x/fd;)V
      ...
      //   1512: aload 14
      //   1514: aload 15
      //   1516: invokevirtual 174	midas/x/ff:a	(Landroid/content/Context;Lmidas/x/fe;Lmidas/x/fd;)V
      //   1519: aload 11
      //   1521: athrow
      //   1522: return
      ...
      //   22	1487	13	localff	ff
      //   34	1479	14	localfe	fe
      //   46	1469	15	localfd	fd
    ...
    implements Runnable
  {
    ...
    public c(fh paramfh, String paramString)
    {
      this.a = new WeakReference(paramfh);
      this.b = paramString;
    }
    
    public void run()
    {
      fh localfh = (fh)this.a.get();
      if (localfh != null) {
        localfh.d(this.b);
      }
    }
