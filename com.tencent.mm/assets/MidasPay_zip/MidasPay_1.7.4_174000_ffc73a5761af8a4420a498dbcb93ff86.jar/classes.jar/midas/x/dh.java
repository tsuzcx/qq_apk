  ...
  extends cc
{
  ...
  private void t(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      hn.a().a(arrayOfString1, arrayOfString2, arrayOfString3, arrayOfString4);
      return;
    }
  ...
  private void x(JSONObject paramJSONObject)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        paramJSONObject = ek.a(paramJSONObject, "friends_list", (String)localObject);
        ...
        if (i < k)
        {
          ...
          try
          {
            ...
            if (j < m)
            {
              ...
              hl localhl = new hl();
              localhl.a = localJSONObject.getString("qq");
              localhl.b = URLDecoder.decode(localJSONObject.getString("user_nick"), "utf-8");
              localArrayList3.add(localhl);
              j += 1;
              continue;
            }
        ...
        {
          gc.a().a(localArrayList1);
          gc.a().b(localArrayList2);
          return;
        }
      }
      catch (Exception paramJSONObject)
  ...
  protected boolean a(kz paramkz)
  {
    ...
    if ((em.b().n() != null) && (((em.b().n().a instanceof APMonthRequest)) || ((em.b().n().a instanceof APSubscribeRequest))))
    {
      this.h = em.b().n();
      this.n = this.h.d;
      try
      {
        ...
        this.j = Integer.parseInt(((JSONObject)localObject2).getString("ret"));
        this.k = ((JSONObject)localObject2).getString("msg");
        if (this.j == 0)
        {
          localObject3 = ((JSONObject)localObject2).getJSONObject("info");
          localObject1 = (ew)this.h.b;
          ((ew)localObject1).e = ((JSONObject)localObject3).getString("rate");
          ((ew)localObject1).a = ((JSONObject)localObject3).getString("offer_name");
        }
      }
    ...
    localObject1 = "";
    this.h.e.j = ((String)localObject1);
    this.h.e.k = ((String)localObject1);
    ...
    if (ek.d((JSONObject)localObject3, "is_cft_user", (String)localObject1).equals("1")) {
      this.n.d = true;
    } else {
      this.n.d = false;
    }
    if (ek.d((JSONObject)localObject3, "is_kj", (String)localObject1).equals("1")) {
      this.n.c = true;
    } else {
      this.n.c = false;
    }
    if (ek.d((JSONObject)localObject3, "wc_bind_qq", (String)localObject1).equals("1")) {
      this.n.e = true;
    } else {
      this.n.e = false;
    }
    ...
    ((StringBuilder)localObject4).append(this.h.d.e);
    APLog.w("monthInfoAns", ((StringBuilder)localObject4).toString());
    localObject4 = ek.d((JSONObject)localObject3, "qq_acct_balance", (String)localObject1);
    try
    {
    ...
    ((StringBuilder)localObject4).append(this.h.d.m);
    APLog.w("monthInfoAns", ((StringBuilder)localObject4).toString());
    ...
    i = ek.c((JSONObject)localObject3, "mcard_balance", (String)localObject1);
    this.n.h = i;
    ...
    if (!((String)localObject1).equals(""))
    {
      ...
      this.k = ((StringBuilder)localObject3).toString();
    }
    label910:
