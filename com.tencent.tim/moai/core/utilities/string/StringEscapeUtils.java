...
//            );
    ...
    public static final CharSequenceTranslator UNESCAPE_HTML4 =
            new AggregateTranslator(
                    new LookupTranslator(invert(BASIC_ESCAPE)),
                    new LookupTranslator(invert(ISO8859_1_ESCAPE)),
                    new LookupTranslator(invert(HTML40_EXTENDED_ESCAPE)),
    ...
    private static Escaper initEscaper() {
        ...
        for (String[] strings : BASIC_ESCAPE) {
            builder.addEscape(strings[0].charAt(0), strings[1]);
        }
        for (String[] strings : ISO8859_1_ESCAPE) {
            builder.addEscape(strings[0].charAt(0), strings[1]);
        }
        for (String[] strings : HTML40_EXTENDED_ESCAPE) {
            builder.addEscape(strings[0].charAt(0), strings[1]);
        }
