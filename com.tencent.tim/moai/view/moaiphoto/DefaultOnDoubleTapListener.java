 ...
 * <p>&nbsp;</p>
 * To be used via {@link moai.view.moaiphoto.PhotoViewAttacher#setOnDoubleTapListener(android.view.GestureDetector.OnDoubleTapListener)}
 */
public class DefaultOnDoubleTapListener implements GestureDetector.OnDoubleTapListener {
    ...
    public boolean onDoubleTap(MotionEvent ev) {
        ...
        try {
            ...
            if(scale < IPhotoView.DEFAULT_RESET_SCALE) {
                photoViewAttacher.setScale(IPhotoView.DEFAULT_RESET_SCALE, x, y, true);
