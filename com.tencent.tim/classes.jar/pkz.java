...
public class pkz
{
  public static double a(Bitmap paramBitmap1, Bitmap paramBitmap2)
  {
    ...
    int i = r(d(paramBitmap1));
    int j = r(d(paramBitmap2));
  ...
  private static byte[] d(Bitmap paramBitmap)
  {
  ...
  private static Bitmap h(Bitmap paramBitmap, int paramInt1, int paramInt2)
  {
  ...
  public static Bitmap v(Bitmap paramBitmap)
  {
    ...
    {
      localBitmap = h(paramBitmap, 50, 50);
    }
    return w(localBitmap);
  }
