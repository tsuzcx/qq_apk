...
public class aqik
{
  private static aqhv a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2)
  {
    ...
    {
      paramString2 = decode(paramString1, bool1);
      str1 = paramString2;
    ...
    {
      str2 = decode(paramString2, bool1);
      return a(paramQQAppInterface, paramContext, paramString1, str1, str3, str2, arrayOfString, bool5, bool4, bool6);
    }
  }
  
  private static aqhv a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String[] paramArrayOfString, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    String str = "";
    aqhv localaqhv = new aqhv(paramQQAppInterface, paramContext);
    if (paramString2.startsWith("mqqapi://now/openroom"))
    {
      localaqhv.source = paramString2;
      ...
      localaqhv.fj("attr_original_url", paramString1);
    }
    label144:
    int i;
    for (;;)
    ...
    label387:
    localaqhv.source = paramContext;
    localaqhv.cti = paramQQAppInterface[0];
    ...
    if (paramBoolean1)
    {
      ...
      if (i < paramQQAppInterface.length)
      {
        ...
        {
          paramContext = decode(paramContext, paramBoolean1);
          int j = paramContext.indexOf('=');
          if (j > 0) {
            localaqhv.fj(paramContext.substring(0, j), paramContext.substring(j + 1, paramContext.length()));
          }
          i += 1;
          break;
        }
    ...
    else
    {
      ...
      if (i < paramQQAppInterface.length)
      {
        paramContext = c(paramQQAppInterface[i], "=");
        if (paramContext.length == 2)
        {
          if (!paramBoolean3) {
            break label575;
          }
          localaqhv.fj(paramContext[0], decode(paramContext[1], false));
        }
        for (;;)
        {
          i += 1;
          break;
          label575:
          localaqhv.fj(paramContext[0], paramContext[1]);
        }
      }
    }
    return localaqhv;
  ...
  public static aqhv c(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    catch (Exception paramString)
    {
      ...
      paramQQAppInterface = new aqhv(paramQQAppInterface, paramContext);
      paramQQAppInterface.cti = "";
      paramQQAppInterface.ctj = "";
      paramQQAppInterface.source = "";
      return paramQQAppInterface;
    }
    localObject3 = paramString;
    Object localObject1 = acup.a(paramQQAppInterface, paramContext, paramString);
      ...
      if (AudioHelper.isDev())
      {
        ...
        if (AudioHelper.jY(8) == 1)
        {
          ...
          if (((String)localObject1).startsWith("mqqconferenceflyticket://"))
          {
            ...
            {
              localObject3 = localObject1;
              return ivc.a(paramQQAppInterface, paramContext, paramString);
            }
            localObject3 = localObject1;
            if (paramString.startsWith("mqqapi://qzone/groupalbum"))
            {
              ...
              localObject3 = localObject1;
              localObject4 = new aqhv(paramQQAppInterface, paramContext);
              localObject3 = localObject1;
              ...
              localObject3 = localObject1;
              ((aqhv)localObject4).source = paramString;
              localObject3 = localObject1;
              ((aqhv)localObject4).cti = localObject2[0];
              localObject3 = localObject1;
              ((aqhv)localObject4).ctj = localObject2[1];
              localObject3 = localObject1;
    ...
    for (;;)
    {
      ...
      if (i < paramString.length)
      {
        ...
        try
        {
          ...
          localObject3 = localObject1;
          ((aqhv)localObject4).fj(localObject2[0], localObject2[1]);
        }
  ...
  public static boolean rx(String paramString)
  {
    ...
    {
      return false;
      paramString = decode(paramString, false);
