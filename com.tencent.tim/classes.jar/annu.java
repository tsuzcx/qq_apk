...
public class annu
{
  ...
  {
    paramContext = p(paramContext).iterator();
    while (paramContext.hasNext()) {
      z((File)paramContext.next());
    }
  }
  
  static List<File> p(Context paramContext)
  {
    int i = 0;
  ...
  /* Error */
  static void z(File paramFile)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 102	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   4: astore_1
    ...
    //   30: invokevirtual 144	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   33: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   36: pop
    //   37: new 146	java/io/BufferedReader
    //   40: dup
    //   41: new 148	java/io/FileReader
    //   44: dup
    //   45: aload_0
    //   46: invokespecial 150	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   49: invokespecial 153	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   52: astore_1
    //   53: aload_1
    //   54: astore_0
    //   55: aload_1
    //   56: invokevirtual 156	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   59: astore_2
    //   60: aload_2
    //   61: ifnull +63 -> 124
    //   64: aload_1
    ...
    //   86: astore_0
    //   87: aload_2
    //   88: invokevirtual 159	java/io/FileNotFoundException:printStackTrace	()V
    //   91: aload_1
    //   92: invokestatic 165	aoyb:closeQuietly	(Ljava/io/Closeable;)V
    //   95: ldc 167
    //   97: iconst_1
    //   98: new 134	java/lang/StringBuilder
    //   101: dup
    //   102: invokespecial 135	java/lang/StringBuilder:<init>	()V
    //   105: ldc 169
    //   107: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   110: aload_3
    //   111: invokevirtual 144	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   114: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   117: invokevirtual 144	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   120: invokestatic 175	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   123: return
    //   124: aload_1
    //   125: invokestatic 165	aoyb:closeQuietly	(Ljava/io/Closeable;)V
    //   128: goto -33 -> 95
    //   131: astore_2
    //   132: aconst_null
    //   133: astore_1
    ...
    //   135: astore_0
    //   136: aload_2
    //   137: invokevirtual 176	java/lang/Exception:printStackTrace	()V
    //   140: aload_1
    //   141: invokestatic 165	aoyb:closeQuietly	(Ljava/io/Closeable;)V
    //   144: goto -49 -> 95
    //   147: astore_1
    //   148: aconst_null
    //   149: astore_0
    //   150: aload_0
    //   151: invokestatic 165	aoyb:closeQuietly	(Ljava/io/Closeable;)V
    //   154: aload_1
    //   155: athrow
    //   156: astore_1
    //   157: goto -7 -> 150
