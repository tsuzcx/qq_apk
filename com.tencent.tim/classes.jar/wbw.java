...
public class wbw
  extends Handler
{
  public wbw(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          case 2: 
            for (;;)
            {
              TroopMemberListActivity.a(this.this$0, paramMessage);
              return;
              this.this$0.hg();
            }
          case 13: 
            paramMessage = this.this$0;
            paramMessage.bw += TroopMemberListActivity.bx;
          }
        } while ((this.this$0.bw <= this.this$0.mProgressBar.getProgress()) || (this.this$0.bw >= 90.0D) || (TroopMemberListActivity.a(this.this$0) <= 0));
        int i = (int)this.this$0.bw;
        int j = (int)(TroopMemberListActivity.a(this.this$0) * this.this$0.bw / 100.0D);
        TroopMemberListActivity.a(this.this$0, j, TroopMemberListActivity.a(this.this$0), i);
        ...
        if (this.this$0.hi.getVisibility() == 0)
        {
          ...
          double d = Math.min(0.9D + paramMessage.arg1 * 1.0D / TroopMemberListActivity.a(this.this$0), 1.0D);
          i = (int)(100.0D * d);
          if (i > this.this$0.mProgressBar.getProgress())
          {
            j = (int)(d * TroopMemberListActivity.a(this.this$0));
            TroopMemberListActivity.a(this.this$0, j, TroopMemberListActivity.a(this.this$0), i);
          }
        }
        if (localList != null) {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("TroopMemberListActivityget_troop_member", 2, "handleMessage, mJobCount left:" + TroopMemberListActivity.c(this.this$0) + "mATroopMemberList.size():" + this.this$0.pr.size());
        }
        if (TroopMemberListActivity.c(this.this$0) <= 0) {
          TroopMemberListActivity.b(this.this$0, true);
        }
        if ((TroopMemberListActivity.b(this.this$0)) && (TroopMemberListActivity.d(this.this$0)))
        {
          ...
          this.this$0.hg();
          if (QLog.isColorLevel()) {
            QLog.d("TroopMemberListActivityget_troop_member", 2, "handleMessage real totalTime:" + (System.currentTimeMillis() - TroopMemberListActivity.a(this.this$0)) + "start refreshUI");
          }
        ...
        QQToast.a(this.this$0, this.this$0.getString(2131692496), 0).show(this.this$0.mTitleBar.getHeight());
        TroopMemberListActivity.a(this.this$0);
        return;
        if ((this.this$0.G != null) && (this.this$0.G.isShowing())) {
          this.this$0.G.dismiss();
        }
        QQToast.a(this.this$0, this.this$0.getString(2131692495), 0).show(this.this$0.mTitleBar.getHeight());
        return;
      ...
      ChatSettingForTroop.a(this.this$0, this.this$0.mTroopUin, bool, paramMessage);
      return;
