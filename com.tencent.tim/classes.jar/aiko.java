...
public class aiko
  implements skj.a
{
  public aiko(UiApiPlugin paramUiApiPlugin, Map paramMap) {}
  ...
  public void callback(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        this.this$0.callJs(str, new String[] { paramBundle.toString() });
        return;
      }
      ...
      if ("onCommentLike".equals(str)) {
        try
        {
          ...
          this.this$0.callJs(str, new String[] { ((JSONObject)localObject3).toString() });
          return;
        }
        catch (JSONException paramBundle)
        {
      ...
      if ("onCommentDelete".equals(str)) {
        try
        {
          ...
          this.this$0.callJs(str, new String[] { ((JSONObject)localObject2).toString() });
          return;
        }
        catch (JSONException paramBundle)
        {
    ...
    try
    {
      ...
      this.this$0.callJs(str, new String[] { ((JSONObject)localObject1).toString() });
      return;
    }
    catch (JSONException paramBundle)
    {
