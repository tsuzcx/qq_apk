...
{
  public aanc(LoginView paramLoginView) {}
  ...
  public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramCharSequence.length() > 0) {
      ...
      {
        localObject = (LoginView.a)this.this$0.jdField_a_of_type_AndroidWidgetAutoCompleteTextView.getAdapter();
        if ((localObject != null) && (((LoginView.a)localObject).getCount() != 0)) {
          break label139;
        }
        localObject = (RelativeLayout.LayoutParams)this.this$0.pj.getLayoutParams();
        paramInt1 = (int)(15.0F * LoginView.a(this.this$0) + 0.5F);
    ...
    for (;;)
    {
      ...
      label139:
      localObject = (RelativeLayout.LayoutParams)this.this$0.pj.getLayoutParams();
      paramInt1 = (int)(40.0F * LoginView.a(this.this$0) + 0.5F);
      if (((RelativeLayout.LayoutParams)localObject).rightMargin == paramInt1) {
        break;
      }
      ((RelativeLayout.LayoutParams)localObject).rightMargin = paramInt1;
