...
public class wpa
{
  ...
  public wpa(Context paramContext)
  {
  ...
  public void eV(View paramView)
  {
    ...
    this.Y = ValueAnimator.ofObject(new wpa.a(null), new Object[] { Integer.valueOf(0), Integer.valueOf(0) });
    this.Y.setDuration(3350L);
    this.Y.addUpdateListener(new wpb(this));
  }
