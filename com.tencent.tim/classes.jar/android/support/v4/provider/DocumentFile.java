...
public abstract class DocumentFile
{
  ...
  {
    return new RawDocumentFile((DocumentFile)null, paramFile);
  }
  
  @Nullable
  public static DocumentFile fromSingleUri(@NonNull Context paramContext, @NonNull Uri paramUri)
  {
    SingleDocumentFile localSingleDocumentFile = null;
    if (Build.VERSION.SDK_INT >= 19) {
      localSingleDocumentFile = new SingleDocumentFile((DocumentFile)null, paramContext, paramUri);
    }
  ...
  {
    TreeDocumentFile localTreeDocumentFile = null;
    if (Build.VERSION.SDK_INT >= 21) {
      localTreeDocumentFile = new TreeDocumentFile((DocumentFile)null, paramContext, DocumentsContract.buildDocumentUriUsingTree(paramUri, DocumentsContract.getTreeDocumentId(paramUri)));
    }
