  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  boolean mHasMenu;
  boolean mHidden;
  IFragmentLifecycleCallback mIFragmentLifecycleCallback;
  boolean mInLayout;
  int mIndex = -1;
  View mInnerView;
  ...
  public void setFragmentLifecycleCallback(IFragmentLifecycleCallback paramIFragmentLifecycleCallback)
  {
  ...
  public static abstract interface IFragmentAttachCallback
  {
    public abstract void onFragmentAttached(Fragment paramFragment);
  }
  
  public static abstract interface IFragmentLifecycleCallback
  {
    public abstract void onFragmentHiddenChanged(Fragment paramFragment, boolean paramBoolean);
  }
