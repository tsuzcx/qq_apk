...
public class MQLruCache<K, O>
{
  ...
  public final O get(K paramK)
  {
    ...
    //   11: if_icmpgt +92 -> 103
    //   14: aload_0
    //   15: getfield 39	android/support/v4/util/MQLruCache:mqCaches	[Landroid/support/v4/util/AsyncLruCache;
    //   18: iload_2
    //   19: aaload
    //   20: aload_1
    //   21: invokevirtual 126	android/support/v4/util/AsyncLruCache:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   24: checkcast 7	android/support/v4/util/MQLruCache$CacheItem
    //   27: astore_3
    //   28: aload_3
    //   29: ifnull +89 -> 118
    //   32: aload_3
    ...
    //   63: if_icmpge +40 -> 103
    //   66: aload_0
    //   67: getfield 39	android/support/v4/util/MQLruCache:mqCaches	[Landroid/support/v4/util/AsyncLruCache;
    //   70: iload_2
    //   71: aaload
    //   72: aload_1
  ...
  public void releaseLargeCache()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 50	android/support/v4/util/MQLruCache:largeSizeItem	Ljava/util/HashSet;
    ...
    //   46: goto -22 -> 24
    //   49: aload_0
    //   50: getfield 50	android/support/v4/util/MQLruCache:largeSizeItem	Ljava/util/HashSet;
  ...
  public final O remove(K paramK)
  {
    ...
    //   8: if_icmpge +21 -> 29
    //   11: aload_0
    //   12: getfield 39	android/support/v4/util/MQLruCache:mqCaches	[Landroid/support/v4/util/AsyncLruCache;
    //   15: iload_2
    //   16: aaload
    //   17: aload_1
    //   18: invokevirtual 83	android/support/v4/util/AsyncLruCache:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   21: checkcast 7	android/support/v4/util/MQLruCache$CacheItem
    //   24: astore_3
    //   25: aload_3
    //   26: ifnull +16 -> 42
    //   29: aload_3
    ...
    //   0	59	1	paramK	K
    //   3	43	2	i	int
    //   5	29	3	localCacheItem	CacheItem
    // Exception table:
    //   from	to	target	type
    //   11	25	54	finally
    //   33	38	54	finally
