...
public class aohu
  ...
  implements accv.b
{
  WeakReference<aohu> aZ = new WeakReference(this);
  volatile boolean cLE;
  final Object fe = new Object();
  accv g;
  
  public aohu(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.g = ((accv)paramQQAppInterface.getManager(59));
    this.g.aV(this.aZ);
    ...
    throws JSONException
  {
    ...
    arrayOfString[0] = accv.bi(paramInt1);
    arrayOfString[1] = accv.bi(paramInt2);
    arrayOfString[2] = accv.bi(paramInt3);
    arrayOfString[3] = accv.bi(paramInt4);
    if (!this.cLE) {
    ...
    try
    {
      ...
      String str = this.g.d(arrayOfString);
      ??? = str;
      if (str.equals("不限")) {
        ??? = "";
      }
