...
public class iti
{
  public static RedTouch a(VideoAppInterface paramVideoAppInterface, View paramView, int paramInt)
  {
    ...
    if (a(localAppInfo))
    {
      ...
      {
        ((RedTouch)localObject).e(localAppInfo);
        paramVideoAppInterface.iy(str);
  ...
  public static BusinessInfoCheckUpdate.AppInfo a(VideoAppInterface paramVideoAppInterface, int paramInt)
  {
    ...
    do
    {
      ...
      int j = 0;
      localObject = paramVideoAppInterface.b();
      int i = j;
      if (localObject != null)
      {
        i = j;
        if (((VideoController)localObject).b() != null) {
          i = ((VideoController)localObject).b().amI;
        }
      }
