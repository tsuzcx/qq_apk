...
final class aijd
  extends aklm
{
  aijd(int paramInt, BusinessObserver paramBusinessObserver) {}
  
  public void bi(byte[] paramArrayOfByte)
  {
    for (;;)
    {
      Object localObject2;
      ...
      {
        this.val$observer.onReceive(17, false, null);
        if (QLog.isColorLevel()) {
      ...
      ((FaceDetectForThirdPartyManager.AppConf)localObject1).actionReq = aijc.k(str4);
      ...
      paramArrayOfByte.putInt("app_id", this.Ts);
      paramArrayOfByte.putSerializable("FaceRecognition.AppConf", (Serializable)localObject1);
      this.val$observer.onReceive(17, true, paramArrayOfByte);
  ...
  {
    this.val$observer.onReceive(paramInt, false, null);
  }
}
