...
import com.tencent.tim.filemanager.settings.FMSettings.1;
...
public class audn
{
  ...
  int cYV = 0;
  public Map<String, audn.b> kK = null;
  boolean pq = false;
  ...
  private audn.b a()
  {
    return (audn.b)this.kK.get("sdCard");
  }
  
  public static audn a()
  {
    return audn.a.b();
  }
  
  /* Error */
  private void a(File paramFile1, File paramFile2, audm.a parama)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 9
    ...
    //   25: iconst_1
    //   26: ldc 149
    //   28: invokestatic 68	audn:cu	(ILjava/lang/String;)V
    //   31: iconst_0
    //   32: ifeq +11 -> 43
    ...
    //   134: aload_0
    //   135: getfield 42	audn:bCancel	Z
    //   138: ifne +62 -> 200
    //   141: aload 5
    //   143: aload 7
    //   145: iconst_0
  ...
  private void a(List<String> paramList, audm.a parama)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          this.totalSize += aueh.getFileSize(str1);
        }
    ...
    if (str2.contains("/.tmp/")) {
      localObject = kS(str1) + audx.getFileName(str2);
    }
    for (;;)
    {
      for (;;)
      ...
      if (str2.contains("/.thumbnails/")) {
        localObject = kT(str1) + audx.getFileName(str2);
      } else {
        localObject = kR(str1) + audx.getFileName(str2);
      }
    }
  }
  ...
  private audn.b b()
  {
    ...
    return (audn.b)this.kK.get("externalSdCard");
  }
  ...
  private audn.b c()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject2 = (audn.b)this.kK.get(localObject2);
      ((audn.b)localObject2).log();
      if (((audn.b)localObject2).cfU)
      {
        cu(2, "getDefaultStorage[" + ((audn.b)localObject2).rootPath + "] + ext[" + ((audn.b)localObject2).ext + "]");
        return localObject2;
      }
    }
    cu(2, "getDefaultStorage nothing is default refresh!");
    localObject1 = (audn.b)this.kK.get("sdCard");
    ((audn.b)localObject1).em(BaseApplicationImpl.getContext());
    return localObject1;
  }
  ...
  public void a(long paramLong, List<String> arg3, Activity paramActivity, audm.a parama)
  {
    if (this.pq) {}
    for (;;)
    {
  ...
  public audn.b d()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject = (audn.b)this.kK.get(localObject);
  ...
  public void dkR()
  {
    ...
    Map localMap = audx.k(localBaseApplication);
    cu(1, "qurey strorages[" + localMap.size() + "]");
    String str1 = localBaseApplication.getSharedPreferences("FMSETTING_59", 0).getString("DefaultRootPath", acbn.SDCARD_ROOT);
  ...
  public long gd()
  {
    ...
    localObject = new StatFs(((audn.b)localObject).rootPath);
  ...
  public void remove(String paramString)
  {
    try
    {
      if (this.kK != null)
      {
        ...
        {
          ((audn.b)this.kK.get("sdCard")).em(BaseApplicationImpl.getContext());
          return;
        }
      }
    }
  ...
  public String vZ()
  {
    return kR(c().rootPath + c().ext);
  }
  
  public String wa()
  {
    return kS(c().rootPath + c().ext);
  }
  
  public String wb()
  {
    return kT(c().rootPath + c().ext);
  }
  
  static class a
  {
    private static audn b = new audn(null);
  }
  ...
  public class b
  {
    ...
    {
      paramContext.getSharedPreferences("FMSETTING_59", 0).edit().putString("DefaultRootPath", this.rootPath).commit();
      paramContext = audn.a(audn.this, this.rootPath + this.ext);
      Object localObject = audn.b(audn.this, this.rootPath + this.ext);
      String str = audn.c(audn.this, this.rootPath + this.ext);
      audn.a(audn.this, paramContext);
      audn.a(audn.this, str);
      audn.a(audn.this, (String)localObject);
      paramContext = audn.this.kK.keySet().iterator();
      while (paramContext.hasNext())
      {
        localObject = (String)paramContext.next();
        localObject = (b)audn.this.kK.get(localObject);
        if ((((b)localObject).cfU) && (localObject != this))
        {
          audn.cu(2, "getDefaultStorage[" + ((b)localObject).rootPath + "]");
