  ...
  extends VasWebviewJsPlugin
{
  ...
  private boolean d(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramVarArgs = affz.a("ipc_cmd_share_robot_card", (String)localObject, this.mOnRemoteResp.key, localBundle);
      afjy.a().cq(paramVarArgs);
      return true;
    }
  ...
  private boolean e(String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (paramVarArgs.length < 1)) {
      return false;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject != null)
        {
          ...
          paramVarArgs = affz.a("ipc_cmd_invoke_robot_function", (String)localObject, this.mOnRemoteResp.key, localBundle);
          afjy.a().cq(paramVarArgs);
          return true;
        }
      }
  ...
  private boolean f(String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (paramVarArgs.length < 1)) {
      return false;
    }
    ...
    try
    {
      ...
      paramVarArgs = affz.a("ipc_cmd_robot_member_change_function", (String)localObject, this.mOnRemoteResp.key, localBundle);
      afjy.a().cq(paramVarArgs);
      return true;
    }
    catch (JSONException paramVarArgs)
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    do
    {
      ...
      if ("executecommand".equals(paramString3)) {
        return e(paramVarArgs);
      }
    } while (!"memberchange".equals(paramString3));
    return f(paramVarArgs);
  }
  ...
  public void onResponse(Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        aprg.a(null, (Activity)localObject1, null, paramBundle.getString("robotuin"), paramBundle.getString("robotname"), 21);
        return;
      ...
      if (i == 1)
      {
        aprg.a(localActivity, str5, (String)localObject1, str4, (String)localObject2, paramBundle, str1, str3, str2, i);
        return;
      }
    } while (i != 0);
    aprg.a(localActivity, (String)localObject1, null, str4, (String)localObject2, paramBundle, str1, str3, str2, i);
  }
}
