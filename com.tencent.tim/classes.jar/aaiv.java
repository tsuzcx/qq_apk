  ...
  public static RecentBaseData a(RecentUser paramRecentUser, QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ((RecentBaseData)localObject1).c(paramQQAppInterface, paramContext);
          localObject2 = localObject1;
          ...
          if (QLog.isColorLevel()) {
            QLog.i("Q.recent.cost", 4, "[" + (l - 0L) + ", " + ((RecentBaseData)localObject1).qx() + "," + localObject1.getClass().getName() + "]");
          }
          ((RecentBaseData)localObject1).cuP();
          return localObject1;
        }
        catch (Throwable paramRecentUser)
        {
          aako.a(paramQQAppInterface.getApp(), false, paramRecentUser);
      ...
      continue;
      if (TextUtils.equals(paramRecentUser.uin, acbn.blw))
      {
        localObject1 = localObject3;
  ...
  public static void a(List<RecentUser> paramList, QQAppInterface paramQQAppInterface, Context paramContext, List<RecentBaseData> paramList1, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        j = i;
        if (System.currentTimeMillis() - paramQQAppInterface.a.Ra > 10000L) {
          break label355;
        }
        i = Math.min(90, i);
        j = i;
      ...
      {
        auvk.traceBegin(((RecentUser)localObject2).uin);
        String str = aajt.makeKey(((RecentUser)localObject2).uin, ((RecentUser)localObject2).getType());
        Object localObject1 = aajt.a().a(str);
        if (localObject1 == null)
        {
        ...
        else
        {
          if ((localObject1 instanceof RecentUserBaseData)) {
            ((RecentUserBaseData)localObject1).d((RecentUser)localObject2);
          }
          try
          {
            ((RecentBaseData)localObject1).c(paramQQAppInterface, paramContext);
          ...
          {
            aako.a(paramContext, false, paramList);
