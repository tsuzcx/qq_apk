...
public class awci
{
  public static boolean b(String paramString, double paramDouble1, double paramDouble2)
  {
    ...
    localExifInterface.setAttribute("GPSLatitude", awcr.p(paramDouble2));
    localExifInterface.setAttribute("GPSLongitude", awcr.p(paramDouble1));
    ...
    for (paramString = "N";; paramString = "S")
    {
      ...
      try
      {
        ...
        anpc.a(BaseApplication.getContext()).collectPerformance(null, "gpsComplement", true, 0L, 0L, paramString, null, true);
        return true;
      }
      catch (IOException paramString)
      {
  ...
  public static boolean c(String paramString, double paramDouble1, double paramDouble2)
  {
    if ((QzoneConfig.getInstance().getConfig("QZoneSetting", "QzoneGpsComplement", 1) == 0) || (LocalMultiProcConfig.getInt("Qzone_gps_switch", 1) == 0)) {
      return false;
    }
    ...
    if ((localExifInterface2 != null) && (TextUtils.isEmpty(localExifInterface1.getAttribute("GPSLongitude"))))
    {
      ...
      if ((!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(str)))
      {
        ...
        try
        {
          ...
          anpc.a(BaseApplication.getContext()).collectPerformance(null, "gpsComplement", true, 0L, 0L, paramString1, null, true);
          return true;
        }
