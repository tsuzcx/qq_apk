  ...
  extends acdl
{
  ...
  public aggh(QfileBaseRecentFileTabView paramQfileBaseRecentFileTabView) {}
  ...
  protected void c(boolean paramBoolean, long paramLong, String paramString)
  {
    ...
    if (paramBoolean)
    {
      ...
      QLog.e(QfileBaseRecentFileTabView.TAG, 2, "FMConstants.TYPE_FILE_RECVFILE_SUCCESS in onRecvFile,entity.cloudtype:" + ((FileManagerEntity)localObject).cloudType + ",filepath:" + ((FileManagerEntity)localObject).getFilePath());
  ...
  protected void d(boolean paramBoolean, long paramLong, String paramString)
  {
    ...
    if (paramBoolean)
    {
      ...
      QLog.e(QfileBaseRecentFileTabView.TAG, 2, "FMConstants.TYPE_FILE_RECVFILE_SUCCESS in onSendFile,entity.cloudtype:" + ((FileManagerEntity)localObject).cloudType + ",filepath:" + ((FileManagerEntity)localObject).getFilePath());
