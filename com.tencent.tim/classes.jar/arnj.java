...
class arnj
{
  ...
  static String MANIFEST_NAME = arni.E(arni.he);
  static String cAN;
  
  static
  {
    KEY_TYPE = arni.E(arni.hc);
    cAN = "";
    cAN = arni.E(arni.hd);
    MANIFEST_NAME = "";
  }
  ...
  public static int a(String paramString1, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    //   24: iconst_0
    //   25: istore_3
    //   26: new 68	java/util/jar/JarFile
    //   29: dup
    //   30: aload_0
    //   31: invokespecial 71	java/util/jar/JarFile:<init>	(Ljava/lang/String;)V
    //   34: astore 6
    //   36: aload 10
    //   38: astore 8
    //   40: aload 11
    ...
    //   55: aload 6
    //   57: aload_1
    //   58: invokevirtual 75	java/util/jar/JarFile:getEntry	(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
    //   61: astore_1
    //   62: aload_1
    //   63: ifnonnull +36 -> 99
    //   66: iconst_2
    ...
    //   69: iconst_0
    //   70: ifeq +11 -> 81
    //   73: new 77	java/lang/NullPointerException
    //   76: dup
    //   77: invokespecial 79	java/lang/NullPointerException:<init>	()V
    //   80: athrow
    //   81: iload 4
    //   83: istore_3
    //   84: aload 6
    //   86: ifnull +11 -> 97
    //   89: aload 6
    //   91: invokevirtual 82	java/util/jar/JarFile:close	()V
    //   94: iload 4
    //   96: istore_3
    //   97: iload_3
    //   98: ireturn
    ...
    //   118: aload 6
    //   120: aload_1
    //   121: invokevirtual 86	java/util/jar/JarFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   124: astore_1
    //   125: aload_1
    //   126: astore 8
    //   128: aload_1
    ...
    //   137: aload_1
    //   138: astore 7
    //   140: getstatic 89	arni:gZ	[B
    //   143: invokestatic 24	arni:E	([B)Ljava/lang/String;
    //   146: invokestatic 95	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   149: astore 10
    //   151: aload_1
    //   152: astore 8
    //   154: aload_1
    ...
    //   188: aload_1
    //   189: aload 11
    //   191: invokevirtual 101	java/io/InputStream:read	([B)I
    //   194: istore 4
    //   196: iload 4
    //   198: iconst_m1
    ...
    //   221: iconst_0
    //   222: iload 4
    //   224: invokevirtual 105	java/security/MessageDigest:update	([BII)V
    //   227: goto -54 -> 173
    //   230: astore_1
    //   231: aload 8
    //   233: astore_0
    ...
    //   236: astore 5
    //   238: aload_1
    //   239: invokevirtual 108	java/io/IOException:printStackTrace	()V
    //   242: iconst_3
    //   243: istore_3
    //   244: aload 8
    //   246: ifnull +8 -> 254
    //   249: aload 8
    //   251: invokevirtual 109	java/io/InputStream:close	()V
    //   254: aload 6
    //   256: ifnull -159 -> 97
    //   259: aload 6
    //   261: invokevirtual 82	java/util/jar/JarFile:close	()V
    //   264: iconst_3
    //   265: ireturn
    //   266: astore_0
    //   267: iconst_3
    ...
    //   282: astore 7
    //   284: aload 10
    //   286: invokevirtual 113	java/security/MessageDigest:digest	()[B
    //   289: astore 10
    //   291: aload_1
    //   292: astore 8
    //   294: aload_1
    ...
    //   311: aload 10
    //   313: arraylength
    //   314: invokestatic 119	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   317: aload_1
    //   318: ifnull +7 -> 325
    //   321: aload_1
    //   322: invokevirtual 109	java/io/InputStream:close	()V
    //   325: aload 6
    //   327: ifnull -230 -> 97
    //   330: aload 6
    //   332: invokevirtual 82	java/util/jar/JarFile:close	()V
    //   335: iconst_0
    //   336: ireturn
    //   337: astore_0
    //   338: iconst_0
    ...
    //   349: astore 5
    //   351: aload_1
    //   352: invokevirtual 120	java/lang/OutOfMemoryError:printStackTrace	()V
    //   355: sipush 144
    //   358: istore_3
    //   359: aload 7
    //   361: ifnull +8 -> 369
    //   364: aload 7
    //   366: invokevirtual 109	java/io/InputStream:close	()V
    //   369: aload 6
    //   371: ifnull -274 -> 97
    //   374: aload 6
    //   376: invokevirtual 82	java/util/jar/JarFile:close	()V
    //   379: sipush 144
    //   382: ireturn
    //   383: astore_0
    //   384: sipush 144
    ...
    //   397: astore 5
    //   399: aload_1
    //   400: invokevirtual 121	java/security/NoSuchAlgorithmException:printStackTrace	()V
    //   403: sipush 139
    //   406: istore_3
    //   407: aload 9
    //   409: ifnull +8 -> 417
    //   412: aload 9
    //   414: invokevirtual 109	java/io/InputStream:close	()V
    //   417: aload 6
    //   419: ifnull -322 -> 97
    //   422: aload 6
    //   424: invokevirtual 82	java/util/jar/JarFile:close	()V
    //   427: sipush 139
    //   430: ireturn
    //   431: astore_0
    //   432: sipush 139
    ...
    //   444: ifnull +7 -> 451
    //   447: aload_0
    //   448: invokevirtual 109	java/io/InputStream:close	()V
    //   451: aload 5
    //   453: ifnull +8 -> 461
    //   456: aload 5
    //   458: invokevirtual 82	java/util/jar/JarFile:close	()V
    //   461: aload_1
    //   462: athrow
    //   463: astore_0
    //   464: goto -383 -> 81
    ...
    //   25	382	3	i	int
    //   67	156	4	j	int
    //   1	510	5	localObject1	Object
    //   34	475	6	localJarFile	java.util.jar.JarFile
    //   4	361	7	localObject2	Object
    //   10	503	8	localObject3	Object
    //   7	406	9	localObject4	Object
    //   22	290	10	localObject5	Object
    //   13	207	11	arrayOfByte	byte[]
    //   19	96	12	localObject6	Object
  ...
  public static int a(Map<String, Attributes> paramMap, String paramString1, String paramString2)
  {
    ...
    if (true == paramString2.equals(paramMap.getValue(arni.E(arni.hg)))) {
      return 0;
    }
    return 143;
  }
  ...
  public static Map<String, Attributes> z(String paramString)
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: new 68	java/util/jar/JarFile
    //   5: dup
    //   6: aload_0
    //   7: invokespecial 71	java/util/jar/JarFile:<init>	(Ljava/lang/String;)V
    //   10: astore_1
    //   11: aload_1
    //   12: astore_0
    //   13: aload_1
    //   14: invokevirtual 149	java/util/jar/JarFile:getManifest	()Ljava/util/jar/Manifest;
    //   17: astore_2
    //   18: aload_2
    //   19: ifnonnull +17 -> 36
    //   22: aload_3
    ...
    //   25: ifnull +9 -> 34
    //   28: aload_1
    //   29: invokevirtual 82	java/util/jar/JarFile:close	()V
    //   32: aload_3
    //   33: astore_0
    //   34: aload_0
    //   35: areturn
    ...
    //   37: astore_0
    //   38: aload_2
    //   39: invokevirtual 155	java/util/jar/Manifest:getEntries	()Ljava/util/Map;
    //   42: astore_2
    //   43: aload_2
    //   44: astore_0
    //   45: aload_1
    //   46: ifnull -12 -> 34
    //   49: aload_1
    //   50: invokevirtual 82	java/util/jar/JarFile:close	()V
    //   53: aload_2
    //   54: areturn
    //   55: astore_0
    //   56: aload_2
    ...
    //   62: astore_0
    //   63: aload_2
    //   64: invokevirtual 120	java/lang/OutOfMemoryError:printStackTrace	()V
    //   67: aload_3
    //   68: astore_0
    //   69: aload_1
    //   70: ifnull -36 -> 34
    //   73: aload_1
    //   74: invokevirtual 82	java/util/jar/JarFile:close	()V
    //   77: aconst_null
    //   78: areturn
    //   79: astore_0
    //   80: aconst_null
    ...
    //   86: astore_0
    //   87: aload_2
    //   88: invokevirtual 108	java/io/IOException:printStackTrace	()V
    //   91: aload_3
    //   92: astore_0
    //   93: aload_1
    //   94: ifnull -60 -> 34
    //   97: aload_1
    //   98: invokevirtual 82	java/util/jar/JarFile:close	()V
    //   101: aconst_null
    //   102: areturn
    //   103: astore_0
    //   104: aconst_null
    ...
    //   110: ifnull +7 -> 117
    //   113: aload_0
    //   114: invokevirtual 82	java/util/jar/JarFile:close	()V
    //   117: aload_1
    //   118: athrow
    //   119: astore_0
    //   120: aconst_null
