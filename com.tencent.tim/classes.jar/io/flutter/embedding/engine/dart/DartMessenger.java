  ...
  implements PlatformMessageHandler, BinaryMessenger
{
  ...
  public void handleMessageFromDart(@NonNull String paramString, @Nullable byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (localObject != null) {
      try
      {
        ...
        {
          ((BinaryMessenger.BinaryMessageHandler)localObject).onMessage(paramString, new Reply(this.flutterJNI, paramInt));
          return;
        }
    ...
    implements BinaryMessenger.BinaryReply
  {
    ...
    Reply(@NonNull FlutterJNI paramFlutterJNI, int paramInt)
    {
      this.flutterJNI = paramFlutterJNI;
