  ...
  implements PluginRegistry, ActivityControlSurface, BroadcastReceiverControlSurface, ContentProviderControlSurface, ServiceControlSurface
{
  ...
  public void attachToActivity(@NonNull Activity paramActivity, @NonNull Lifecycle paramLifecycle)
  {
    ...
    if (this.isWaitingForActivityReattachment)
    {
      ...
      this.activityPluginBinding = new FlutterEngineActivityPluginBinding(paramActivity);
  ...
  public void attachToService(@NonNull Service paramService, @NonNull Lifecycle paramLifecycle, boolean paramBoolean)
  {
    ...
    this.servicePluginBinding = new FlutterEngineServicePluginBinding(paramService);
    this.flutterEngineAndroidLifecycle.setBackingLifecycle(paramLifecycle);
    ...
    implements ActivityPluginBinding
  {
    ...
    public FlutterEngineActivityPluginBinding(@NonNull Activity paramActivity)
    {
      this.activity = paramActivity;
    }
    ...
    implements BroadcastReceiverPluginBinding
  {
    ...
    FlutterEngineBroadcastReceiverPluginBinding(@NonNull BroadcastReceiver paramBroadcastReceiver)
    {
      this.broadcastReceiver = paramBroadcastReceiver;
    }
    ...
    implements ContentProviderPluginBinding
  {
    ...
    FlutterEngineContentProviderPluginBinding(@NonNull ContentProvider paramContentProvider)
    {
      this.contentProvider = paramContentProvider;
    }
    ...
    implements ServicePluginBinding
  {
    ...
    FlutterEngineServicePluginBinding(@NonNull Service paramService)
    {
      this.service = paramService;
    }
