  ...
  implements LifecycleOwner, FlutterActivityAndFragmentDelegate.Host
{
  ...
  public static CachedEngineIntentBuilder withCachedEngine(@NonNull String paramString)
  {
  ...
  public static class CachedEngineIntentBuilder
  {
    ...
    protected CachedEngineIntentBuilder(@NonNull Class<? extends FlutterActivity> paramClass, @NonNull String paramString)
    {
  ...
  public static class NewEngineIntentBuilder
  {
    ...
    protected NewEngineIntentBuilder(@NonNull Class<? extends FlutterActivity> paramClass)
    {
      this.activityClass = paramClass;
    }
