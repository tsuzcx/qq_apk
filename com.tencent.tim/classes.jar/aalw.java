...
public class aalw
  extends aalj
{
  public aalw(Context paramContext)
  {
    this.content = acfp.m(2131699667);
  ...
  {
    if ((paramObject instanceof aalw))
    {
      paramObject = (aalw)paramObject;
      paramObject.a.a(paramaozx.b);
      return paramObject;
    }
    paramObject = new aalw(BaseApplication.getContext());
