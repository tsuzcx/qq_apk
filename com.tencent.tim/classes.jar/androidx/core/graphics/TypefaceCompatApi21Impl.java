  ...
  extends TypefaceCompatBaseImpl
{
  ...
  public Typeface createFromFontInfo(Context paramContext, android.os.CancellationSignal paramCancellationSignal, @NonNull androidx.core.provider.FontsContractCompat.FontInfo[] paramArrayOfFontInfo, int paramInt)
  {
    ...
    //   9: aload_3
    //   10: iload 4
    //   12: invokevirtual 249	androidx/core/graphics/TypefaceCompatApi21Impl:findBestInfo	([Landroidx/core/provider/FontsContractCompat$FontInfo;I)Landroidx/core/provider/FontsContractCompat$FontInfo;
    //   15: astore_3
    //   16: aload_1
    ...
    //   45: ifeq +18 -> 63
    //   48: aload_3
    //   49: invokevirtual 272	android/os/ParcelFileDescriptor:close	()V
    //   52: aconst_null
    //   53: areturn
    //   54: astore_1
    //   55: new 274	java/lang/NullPointerException
    //   58: dup
    //   59: invokespecial 275	java/lang/NullPointerException:<init>	()V
    //   62: athrow
    //   63: aload_3
    //   64: invokevirtual 272	android/os/ParcelFileDescriptor:close	()V
    //   67: aconst_null
    //   68: areturn
    //   69: aload_0
    //   70: aload_3
    //   71: invokespecial 277	androidx/core/graphics/TypefaceCompatApi21Impl:getFile	(Landroid/os/ParcelFileDescriptor;)Ljava/io/File;
    //   74: astore_2
    //   75: aload_2
    //   76: ifnull +10 -> 86
    //   79: aload_2
    //   80: invokevirtual 280	java/io/File:canRead	()Z
    //   83: ifne +148 -> 231
    //   86: new 282	java/io/FileInputStream
    //   89: dup
    //   90: aload_3
    //   91: invokevirtual 286	android/os/ParcelFileDescriptor:getFileDescriptor	()Ljava/io/FileDescriptor;
    //   94: invokespecial 289	java/io/FileInputStream:<init>	(Ljava/io/FileDescriptor;)V
    //   97: astore 5
    //   99: aload_0
    //   100: aload_1
    //   101: aload 5
    //   103: invokespecial 293	androidx/core/graphics/TypefaceCompatBaseImpl:createFromInputStream	(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    //   106: astore_1
    //   107: aload 5
    //   109: ifnull +12 -> 121
    //   112: iconst_0
    //   113: ifeq +49 -> 162
    //   116: aload 5
    //   118: invokevirtual 294	java/io/FileInputStream:close	()V
    //   121: aload_3
    //   122: ifnull +11 -> 133
    //   125: iconst_0
    //   126: ifeq +59 -> 185
    //   129: aload_3
    //   130: invokevirtual 272	android/os/ParcelFileDescriptor:close	()V
    //   133: aload_1
    //   134: areturn
    //   135: astore_1
    //   136: new 274	java/lang/NullPointerException
    //   139: dup
    //   140: invokespecial 275	java/lang/NullPointerException:<init>	()V
    //   143: athrow
    //   144: astore_2
    //   145: aload_2
    //   146: athrow
    ...
    //   153: ifnull +122 -> 275
    //   156: aload_3
    //   157: invokevirtual 272	android/os/ParcelFileDescriptor:close	()V
    //   160: aload_1
    //   161: athrow
    //   162: aload 5
    //   164: invokevirtual 294	java/io/FileInputStream:close	()V
    //   167: goto -46 -> 121
    //   170: astore_1
    //   171: aconst_null
    //   172: astore_2
    //   173: goto -25 -> 148
    //   176: astore_1
    //   177: new 274	java/lang/NullPointerException
    //   180: dup
    //   181: invokespecial 275	java/lang/NullPointerException:<init>	()V
    //   184: athrow
    //   185: aload_3
    //   186: invokevirtual 272	android/os/ParcelFileDescriptor:close	()V
    //   189: goto -56 -> 133
    //   192: astore_2
    //   193: aload_2
    //   194: athrow
    ...
    //   202: ifnull +21 -> 223
    //   205: aload 5
    //   207: invokevirtual 294	java/io/FileInputStream:close	()V
    //   210: aload_1
    //   211: athrow
    //   212: astore 5
    //   214: aload_2
    //   215: aload 5
    //   217: invokevirtual 297	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   220: goto -10 -> 210
    //   223: aload 5
    //   225: invokevirtual 294	java/io/FileInputStream:close	()V
    //   228: goto -18 -> 210
    //   231: aload_2
    //   232: invokestatic 301	android/graphics/Typeface:createFromFile	(Ljava/io/File;)Landroid/graphics/Typeface;
    //   235: astore_1
    //   236: aload_3
    //   237: ifnull +11 -> 248
    //   240: iconst_0
    //   241: ifeq +18 -> 259
    //   244: aload_3
    //   245: invokevirtual 272	android/os/ParcelFileDescriptor:close	()V
    //   248: aload_1
    //   249: areturn
    //   250: astore_1
    //   251: new 274	java/lang/NullPointerException
    //   254: dup
    //   255: invokespecial 275	java/lang/NullPointerException:<init>	()V
    //   258: athrow
    //   259: aload_3
    //   260: invokevirtual 272	android/os/ParcelFileDescriptor:close	()V
    //   263: goto -15 -> 248
    //   266: astore_3
    //   267: aload_2
    //   268: aload_3
    //   269: invokevirtual 297	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   272: goto -112 -> 160
    //   275: aload_3
    //   276: invokevirtual 272	android/os/ParcelFileDescriptor:close	()V
    //   279: goto -119 -> 160
    //   282: astore_1
    //   283: aconst_null
    //   284: astore_2
