...
{
  private static final Comparator<LinkSpec> COMPARATOR = new LinkifyCompat.1();
  ...
  private static void gatherMapLinks(ArrayList<LinkSpec> paramArrayList, Spannable paramSpannable)
  {
    ...
    //   6: istore_2
    //   7: aload_1
    //   8: invokestatic 273	androidx/core/text/util/LinkifyCompat:findAddress	(Ljava/lang/String;)Ljava/lang/String;
    //   11: astore 6
    //   13: aload 6
    //   15: ifnull +115 -> 130
    //   18: aload_1
    ...
    //   26: ifge +4 -> 30
    //   29: return
    //   30: new 6	androidx/core/text/util/LinkifyCompat$LinkSpec
    //   33: dup
    //   34: invokespecial 258	androidx/core/text/util/LinkifyCompat$LinkSpec:<init>	()V
    //   37: astore 5
    //   39: aload 6
    //   41: invokevirtual 278	java/lang/String:length	()I
    //   44: iload_3
    //   45: iadd
    //   46: istore 4
    //   48: aload 5
    ...
    //   51: iload_2
    //   52: iadd
    //   53: putfield 177	androidx/core/text/util/LinkifyCompat$LinkSpec:start	I
    //   56: aload 5
    //   58: iload_2
    //   59: iload 4
    //   61: iadd
    //   62: putfield 180	androidx/core/text/util/LinkifyCompat$LinkSpec:end	I
    //   65: aload_1
    //   66: iload 4
    //   68: invokevirtual 281	java/lang/String:substring	(I)Ljava/lang/String;
    //   71: astore_1
    //   72: iload_2
    //   73: iload 4
    //   75: iadd
    ...
    //   77: aload 6
    //   79: ldc_w 283
    //   82: invokestatic 289	java/net/URLEncoder:encode	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   85: astore 6
    //   87: aload 5
    //   89: new 291	java/lang/StringBuilder
    //   92: dup
    //   93: invokespecial 292	java/lang/StringBuilder:<init>	()V
    //   96: ldc_w 294
    //   99: invokevirtual 298	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   102: aload 6
    //   104: invokevirtual 298	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   107: invokevirtual 299	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   110: putfield 173	androidx/core/text/util/LinkifyCompat$LinkSpec:url	Ljava/lang/String;
    //   113: aload_0
    //   114: aload 5
    //   116: invokevirtual 262	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   119: pop
    //   120: goto -113 -> 7
    //   123: astore_0
    //   124: return
