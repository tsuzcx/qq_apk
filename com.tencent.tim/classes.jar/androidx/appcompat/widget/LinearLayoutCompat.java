  ...
  extends ViewGroup
{
  ...
  public LinearLayoutCompat(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = TintTypedArray.obtainStyledAttributes(paramContext, paramAttributeSet, b.a.LinearLayoutCompat, paramInt, 0);
    paramInt = paramContext.getInt(b.a.LinearLayoutCompat_android_orientation, -1);
    if (paramInt >= 0) {
      setOrientation(paramInt);
    }
    paramInt = paramContext.getInt(b.a.LinearLayoutCompat_android_gravity, -1);
    if (paramInt >= 0) {
      setGravity(paramInt);
    }
    boolean bool = paramContext.getBoolean(b.a.LinearLayoutCompat_android_baselineAligned, true);
    if (!bool) {
      setBaselineAligned(bool);
    }
    this.mWeightSum = paramContext.getFloat(b.a.LinearLayoutCompat_android_weightSum, -1.0F);
    this.mBaselineAlignedChildIndex = paramContext.getInt(b.a.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
    this.mUseLargestChild = paramContext.getBoolean(b.a.LinearLayoutCompat_measureWithLargestChild, false);
    setDividerDrawable(paramContext.getDrawable(b.a.LinearLayoutCompat_divider));
    this.mShowDividers = paramContext.getInt(b.a.LinearLayoutCompat_showDividers, 0);
    this.mDividerPadding = paramContext.getDimensionPixelSize(b.a.LinearLayoutCompat_dividerPadding, 0);
    ...
    extends ViewGroup.MarginLayoutParams
  {
    ...
    public LayoutParams(Context paramContext, AttributeSet paramAttributeSet)
    {
      ...
      paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, b.a.LinearLayoutCompat_Layout);
      this.weight = paramContext.getFloat(b.a.LinearLayoutCompat_Layout_android_layout_weight, 0.0F);
      this.gravity = paramContext.getInt(b.a.LinearLayoutCompat_Layout_android_layout_gravity, -1);
      paramContext.recycle();
    }
