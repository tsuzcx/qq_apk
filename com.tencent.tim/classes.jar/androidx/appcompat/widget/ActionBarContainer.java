  ...
  extends FrameLayout
{
  ...
  public ActionBarContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, b.a.ActionBar);
    this.mBackground = paramContext.getDrawable(b.a.ActionBar_background);
    this.mStackedBackground = paramContext.getDrawable(b.a.ActionBar_backgroundStacked);
    this.mHeight = paramContext.getDimensionPixelSize(b.a.ActionBar_height, -1);
    if (getId() == 2131378663)
    {
      this.mIsSplit = true;
      this.mSplitBackground = paramContext.getDrawable(b.a.ActionBar_backgroundSplit);
    }
  ...
  public void onFinishInflate()
  {
    ...
    this.mActionBarView = findViewById(2131361968);
    this.mContextView = findViewById(2131361980);
  }
