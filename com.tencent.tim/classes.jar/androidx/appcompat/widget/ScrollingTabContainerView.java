  ...
  implements AdapterView.OnItemSelectedListener
{
  ...
  {
    AppCompatSpinner localAppCompatSpinner = new AppCompatSpinner(getContext(), null, 2131034130);
  ...
  {
    LinearLayoutCompat localLinearLayoutCompat = new LinearLayoutCompat(getContext(), null, 2131034124);
    ...
    extends LinearLayout
  {
    ...
    {
      super(null, 2131034125);
      this.mTab = paramTab;
      this$1 = TintTypedArray.obtainStyledAttributes(paramContext, null, this.BG_ATTRS, 2131034125, 0);
    ...
    public void update()
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (this.mTextView == null)
        {
          localObject3 = new AppCompatTextView(getContext(), null, 2131034126);
