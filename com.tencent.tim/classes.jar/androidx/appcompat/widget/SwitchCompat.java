  ...
  extends CompoundButton
{
  ...
  public SwitchCompat(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    localObject1 = TintTypedArray.obtainStyledAttributes(paramContext, paramAttributeSet, b.a.SwitchCompat, paramInt, 0);
    this.mThumbDrawable = ((TintTypedArray)localObject1).getDrawable(b.a.SwitchCompat_android_thumb);
    if (this.mThumbDrawable != null) {
      this.mThumbDrawable.setCallback(this);
    }
    this.mTrackDrawable = ((TintTypedArray)localObject1).getDrawable(b.a.SwitchCompat_track);
    if (this.mTrackDrawable != null) {
      this.mTrackDrawable.setCallback(this);
    }
    this.mTextOn = ((TintTypedArray)localObject1).getText(b.a.SwitchCompat_android_textOn);
    this.mTextOff = ((TintTypedArray)localObject1).getText(b.a.SwitchCompat_android_textOff);
    this.mShowText = ((TintTypedArray)localObject1).getBoolean(b.a.SwitchCompat_showText, true);
    this.mThumbTextPadding = ((TintTypedArray)localObject1).getDimensionPixelSize(b.a.SwitchCompat_thumbTextPadding, 0);
    this.mSwitchMinWidth = ((TintTypedArray)localObject1).getDimensionPixelSize(b.a.SwitchCompat_switchMinWidth, 0);
    this.mSwitchPadding = ((TintTypedArray)localObject1).getDimensionPixelSize(b.a.SwitchCompat_switchPadding, 0);
    this.mSplitTrack = ((TintTypedArray)localObject1).getBoolean(b.a.SwitchCompat_splitTrack, false);
    Object localObject2 = ((TintTypedArray)localObject1).getColorStateList(b.a.SwitchCompat_thumbTint);
    if (localObject2 != null)
    {
      this.mThumbTintList = ((ColorStateList)localObject2);
      this.mHasThumbTint = true;
    }
    localObject2 = DrawableUtils.parseTintMode(((TintTypedArray)localObject1).getInt(b.a.SwitchCompat_thumbTintMode, -1), null);
    ...
    localObject2 = ((TintTypedArray)localObject1).getColorStateList(b.a.SwitchCompat_trackTint);
    if (localObject2 != null)
    {
      this.mTrackTintList = ((ColorStateList)localObject2);
      this.mHasTrackTint = true;
    }
    localObject2 = DrawableUtils.parseTintMode(((TintTypedArray)localObject1).getInt(b.a.SwitchCompat_trackTintMode, -1), null);
    ...
    int i = ((TintTypedArray)localObject1).getResourceId(b.a.SwitchCompat_switchTextAppearance, 0);
    if (i != 0) {
  ...
  {
    paramContext = TintTypedArray.obtainStyledAttributes(paramContext, paramInt, b.a.TextAppearance);
    ColorStateList localColorStateList = paramContext.getColorStateList(b.a.TextAppearance_android_textColor);
    if (localColorStateList != null)
    {
      this.mTextColors = localColorStateList;
      paramInt = paramContext.getDimensionPixelSize(b.a.TextAppearance_android_textSize, 0);
      if ((paramInt != 0) && (paramInt != this.mTextPaint.getTextSize()))
      {
        this.mTextPaint.setTextSize(paramInt);
        requestLayout();
      }
      setSwitchTypefaceByIndex(paramContext.getInt(b.a.TextAppearance_android_typeface, -1), paramContext.getInt(b.a.TextAppearance_android_textStyle, -1));
      if (!paramContext.getBoolean(b.a.TextAppearance_textAllCaps, false)) {
        break label127;
      }
    }
    label127:
