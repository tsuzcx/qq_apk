  ...
  extends ViewGroup
{
  ...
  AbsActionBarView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    if ((paramContext.getTheme().resolveAttribute(2131034120, paramAttributeSet, true)) && (paramAttributeSet.resourceId != 0))
    {
  ...
  protected void onConfigurationChanged(Configuration paramConfiguration)
  {
    ...
    TypedArray localTypedArray = getContext().obtainStyledAttributes(null, b.a.ActionBar, 2131034123, 0);
    setContentHeight(localTypedArray.getLayoutDimension(b.a.ActionBar_height, 0));
