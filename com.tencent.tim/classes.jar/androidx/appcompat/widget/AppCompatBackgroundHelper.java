...
class AppCompatBackgroundHelper
{
  ...
  {
    paramAttributeSet = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), paramAttributeSet, b.a.ViewBackgroundHelper, paramInt, 0);
    try
    {
      if (paramAttributeSet.hasValue(b.a.ViewBackgroundHelper_android_background))
      {
        this.mBackgroundResId = paramAttributeSet.getResourceId(b.a.ViewBackgroundHelper_android_background, -1);
      ...
      if (paramAttributeSet.hasValue(b.a.ViewBackgroundHelper_backgroundTint)) {
        ViewCompat.setBackgroundTintList(this.mView, paramAttributeSet.getColorStateList(b.a.ViewBackgroundHelper_backgroundTint));
      }
      if (paramAttributeSet.hasValue(b.a.ViewBackgroundHelper_backgroundTintMode)) {
        ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(paramAttributeSet.getInt(b.a.ViewBackgroundHelper_backgroundTintMode, -1), null));
      }
      return;
    }
    finally
