...
class AlertController
{
  ...
  public AlertController(Context paramContext, AppCompatDialog paramAppCompatDialog, Window paramWindow)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(null, b.a.AlertDialog, 2131034182, 0);
    this.mAlertDialogLayout = paramContext.getResourceId(b.a.AlertDialog_android_layout, 0);
    this.mButtonPanelSideLayout = paramContext.getResourceId(b.a.AlertDialog_buttonPanelSideLayout, 0);
    this.mListLayout = paramContext.getResourceId(b.a.AlertDialog_listLayout, 0);
    this.mMultiChoiceItemLayout = paramContext.getResourceId(b.a.AlertDialog_multiChoiceItemLayout, 0);
    this.mSingleChoiceItemLayout = paramContext.getResourceId(b.a.AlertDialog_singleChoiceItemLayout, 0);
    this.mListItemLayout = paramContext.getResourceId(b.a.AlertDialog_listItemLayout, 0);
    this.mShowTitle = paramContext.getBoolean(b.a.AlertDialog_showTitle, true);
    this.mButtonIconDimen = paramContext.getDimensionPixelSize(b.a.AlertDialog_buttonIconDimen, 0);
  ...
  private void setScrollIndicators(ViewGroup paramViewGroup, View paramView, int paramInt1, int paramInt2)
  {
    ...
    View localView2 = this.mWindow.findViewById(2131377756);
    View localView1 = this.mWindow.findViewById(2131377755);
  ...
  {
    this.mScrollView = ((NestedScrollView)this.mWindow.findViewById(2131377757));
  ...
  private void setupCustomContent(ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      FrameLayout localFrameLayout = (FrameLayout)this.mWindow.findViewById(2131365559);
  ...
  private void setupTitle(ViewGroup paramViewGroup)
  {
    if (this.mCustomTitleView != null)
    {
      ...
      this.mWindow.findViewById(2131379861).setVisibility(8);
      return;
    }
    ...
    {
      this.mTitleView = ((TextView)this.mWindow.findViewById(2131362660));
  ...
  {
    Object localObject4 = this.mWindow.findViewById(2131372859);
    Object localObject3 = ((View)localObject4).findViewById(2131379994);
    Object localObject2 = ((View)localObject4).findViewById(2131365370);
    Object localObject1 = ((View)localObject4).findViewById(2131364091);
    localObject4 = (ViewGroup)((View)localObject4).findViewById(2131365561);
    setupCustomContent((ViewGroup)localObject4);
    View localView3 = ((ViewGroup)localObject4).findViewById(2131379994);
    View localView2 = ((ViewGroup)localObject4).findViewById(2131365370);
    View localView1 = ((ViewGroup)localObject4).findViewById(2131364091);
    ...
    if ((localObject4 != null) && (((ViewGroup)localObject4).getVisibility() != 8))
    {
      ...
      {
        localObject1 = ((ViewGroup)localObject2).findViewById(2131379416);
      ...
      if ((this.mMessage != null) || (this.mListView != null)) {
        localObject1 = ((ViewGroup)localObject3).findViewById(2131379774);
      }
      if (localObject1 != null) {
        ((View)localObject1).setVisibility(0);
      }
    ...
    for (int j = 2;; j = 0)
    {
      ...
      localObject1 = ((ViewGroup)localObject2).findViewById(2131379417);
      if (localObject1 == null) {
        break label279;
      }
      ((View)localObject1).setVisibility(0);
    ...
    extends ListView
  {
    ...
    public RecycleListView(Context paramContext, AttributeSet paramAttributeSet)
    {
      ...
      paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, b.a.RecycleListView);
      this.mPaddingBottomNoButtons = paramContext.getDimensionPixelOffset(b.a.RecycleListView_paddingBottomNoButtons, -1);
      this.mPaddingTopNoTitle = paramContext.getDimensionPixelOffset(b.a.RecycleListView_paddingTopNoTitle, -1);
    }
