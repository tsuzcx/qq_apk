  ...
  implements MenuHelper
{
  ...
  {
    this(paramContext, paramMenuBuilder, null, false, 2131034994, 0);
  }
  
  public MenuPopupHelper(@NonNull Context paramContext, @NonNull MenuBuilder paramMenuBuilder, @NonNull View paramView)
  {
    this(paramContext, paramMenuBuilder, paramView, false, 2131034994, 0);
  }
  ...
  private MenuPopup createPopup()
  {
    ...
    if (Build.VERSION.SDK_INT >= 17)
    {
      ...
      if (Math.min(localPoint.x, localPoint.y) < this.mContext.getResources().getDimensionPixelSize(2131296294)) {
        break label157;
      }
      i = 1;
      label67:
