...
public class AnimatorInflaterCompat
{
    ...
    throws XmlPullParserException, IOException
  {
    ...
    for (;;)
    {
      ...
      if (((String)localObject1).equals("propertyValuesHolder"))
      {
        ...
        if ((localObject1 != null) && ((localObject2 instanceof ValueAnimator))) {
    ...
    throws Resources.NotFoundException
  {
    ...
    //   54: aload 6
    //   56: astore 5
    //   58: new 327	android/content/res/Resources$NotFoundException
    //   61: dup
    //   62: new 133	java/lang/StringBuilder
    //   65: dup
    //   66: invokespecial 134	java/lang/StringBuilder:<init>	()V
    //   69: ldc_w 369
    //   72: invokevirtual 140	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   75: iload_3
    //   76: invokestatic 372	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   79: invokevirtual 140	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   82: invokevirtual 143	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   85: invokespecial 373	android/content/res/Resources$NotFoundException:<init>	(Ljava/lang/String;)V
    //   88: astore_1
    //   89: aload 6
    //   91: astore 5
    //   93: aload_1
    //   94: aload_0
    //   95: invokevirtual 377	android/content/res/Resources$NotFoundException:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   98: pop
    //   99: aload 6
    //   101: astore 5
    //   103: aload_1
    ...
    //   121: aload 7
    //   123: astore 5
    //   125: new 327	android/content/res/Resources$NotFoundException
    //   128: dup
    ...
    //   142: iload_3
    //   143: invokestatic 372	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   146: invokevirtual 140	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   149: invokevirtual 143	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   152: invokespecial 373	android/content/res/Resources$NotFoundException:<init>	(Ljava/lang/String;)V
    //   155: astore_1
    //   156: aload 7
    //   158: astore 5
    //   160: aload_1
    //   161: aload_0
    //   162: invokevirtual 377	android/content/res/Resources$NotFoundException:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   165: pop
    //   166: aload 7
    //   168: astore 5
    //   170: aload_1
