  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.val$enterTransition != null)
    {
      ...
      localArrayList = FragmentTransition.configureEnteringExitingViews(this.val$impl, this.val$enterTransition, this.val$inFragment, this.val$sharedElementsIn, this.val$nonExistentView);
 ...
 * Qualified Name:     androidx.fragment.app.FragmentTransition.2
