...
public class aaqo
{
  private static aaqo jdField_a_of_type_Aaqo;
  private aaqo.a jdField_a_of_type_Aaqo$a = new aaqo.a(null);
  private aaqo.c jdField_a_of_type_Aaqo$c;
  private Handler cn = new Handler(new aaqp(this));
  private AppInterface mAppInterface;
  
  private aaqo(AppInterface paramAppInterface)
  {
    this.mAppInterface = paramAppInterface;
    if (this.mAppInterface != null) {
      this.mAppInterface.registObserver(this.jdField_a_of_type_Aaqo$a);
    }
  }
  
  public static aaqo a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Aaqo == null) {
      jdField_a_of_type_Aaqo = new aaqo(paramAppInterface);
    }
    return jdField_a_of_type_Aaqo;
  }
  ...
  private void a(double paramDouble1, double paramDouble2, int paramInt)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.mAppInterface.getApp(), me.class);
  ...
  private void b(boolean paramBoolean, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Aaqo$c != null)
    {
      Object localObject = paramArrayList;
      if (paramArrayList == null) {
        localObject = new ArrayList(1);
      }
      this.jdField_a_of_type_Aaqo$c.c(paramInt, paramBoolean, (ArrayList)localObject);
    }
  }
  ...
  private void destroy()
  {
    if (this.mAppInterface != null)
    {
      ...
      this.mAppInterface.unRegistObserver(this.jdField_a_of_type_Aaqo$a);
      this.mAppInterface = null;
    }
    this.jdField_a_of_type_Aaqo$c = null;
    if (this.cn != null) {
  ...
  public static void destroyInstance()
  {
    if (jdField_a_of_type_Aaqo != null)
    {
      jdField_a_of_type_Aaqo.destroy();
      jdField_a_of_type_Aaqo = null;
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool2)
        {
          ...
          SosoInterface.a(new aaqo.b(0, true, true, 30000L, false, false, "NewFlowCameraActivity", paramInt));
        }
        if (this.jdField_a_of_type_Aaqo$c != null) {
          this.jdField_a_of_type_Aaqo$c.bb(paramInt, bool2);
        }
        return;
      }
  ...
  public void a(aaqo.c paramc)
  {
    this.jdField_a_of_type_Aaqo$c = paramc;
  }
    ...
    extends md
  {
    ...
    public void a(int paramInt, boolean paramBoolean, ArrayList<String> paramArrayList)
    {
      ...
      if ((aaqo.a(aaqo.this) != null) && (aaqo.a(aaqo.this).hasMessages(paramInt))) {
        aaqo.a(aaqo.this, paramBoolean, paramArrayList, paramInt);
      }
    }
  }
    ...
    extends SosoInterface.a
  {
    ...
    public void onLocationFinish(int paramInt, SosoInterface.SosoLbsInfo paramSosoLbsInfo)
    {
      if ((paramInt == 0) && (paramSosoLbsInfo != null) && (paramSosoLbsInfo.a != null))
      {
        ...
        aaqo.a(aaqo.this, d1, d2, this.ciG);
      }
      do
      {
        return;
      ...
      } while ((aaqo.a(aaqo.this) == null) || (!aaqo.a(aaqo.this).hasMessages(this.ciG)));
      aaqo.a(aaqo.this, false, null, this.ciG);
    }
  }
