      ...
      try
      {
        ...
        if (paramJSONObject.has("oneslicesize"))
        {
          ...
          if (paramJSONObject.has("slicenum"))
          {
            ...
            QLog.i("QFileExcitingGroupDownloadConfigBean<FileAssistant>", 1, "parse Exciting-Group-Download config: enable:" + this.mEnable + " LimitedSize:" + this.WD + " " + this.a.toString());
          }
        }
        else
        {
