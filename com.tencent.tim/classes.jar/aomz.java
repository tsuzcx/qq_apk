...
{
  public aomz(Application paramApplication) {}
  
  public static URL a(String paramString, int paramInt1, int paramInt2)
  {
    return b(paramString, paramInt1, paramInt2, true);
  }
  
  public static URL b(String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    if (paramString == null) {
      return null;
    }
    ...
    throws Exception
  {
    ...
    label58:
    for (paramFile = new zru();; paramFile = new zsg())
    {
