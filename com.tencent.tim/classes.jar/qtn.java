...
public class qtn
  extends qve<qvq>
{
  public qtn(@Nullable qve.d paramd)
  {
    super(paramd);
  }
  ...
  {
    ((qvf)psx.a(11)).S(paramList, paramBoolean);
  }
  ...
  {
    return new qtn.a(paramb);
  }
  
  protected qvq a()
  {
    qvf localqvf = (qvf)psx.a(11);
    List localList = localqvf.bX();
    ...
    extends JobSegment<Integer, qve.c>
  {
    ...
    protected void a(JobContext paramJobContext, Integer paramInteger)
    {
      ...
      localObject = new pza();
      ((pza)localObject).cookie = this.b.mP();
      ((pza)localObject).unionId = QQStoryContext.a().getCurrentUid();
      ppv.a().a((ppw)localObject, new qto(this, paramJobContext, paramInteger));
    }
  }
}
