...
{
  lpf(lot paramlot, VideoView paramVideoView, ViewBean paramViewBean, ViewBase paramViewBase) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    for (paramContext = "video_audio_mute";; paramContext = "video_audio_speak")
    {
      ...
      this.g.bindDynamicValue(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusBeanViewBean);
      return;
      bool = false;
      break;
    }
