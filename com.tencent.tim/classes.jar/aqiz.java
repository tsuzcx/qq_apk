...
public class aqiz
{
  ...
  public static boolean b(Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    try
    {
      if (QLog.isColorLevel()) {
        QLog.d(TAG, 2, "<--startAppWithPkgName pkgName=" + paramString1 + ",openid=" + paramString2);
      }
  ...
  {
    return b(paramContext, paramString1, paramString2, null, 0);
  }
