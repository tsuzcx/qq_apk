  ...
  extends WebViewPlugin
{
  ...
  BroadcastReceiver mReceiver = new aika(this);
  ...
  public static final void ex(Context paramContext)
  {
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      StoryTransitionActivity.cE(localActivity);
      return true;
    }
    ...
    else
    {
      if (("openInfoCard".equals(paramString3)) || ("openMiniSummary".equals(paramString3))) {
        try
        {
          QQStoryMemoriesActivity.c(localActivity, 23, new JSONObject(paramVarArgs[0]).optLong("uin", 0L));
          return true;
        }
        catch (Exception paramJsBridgeListener)
        {
      ...
      for (;;)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramJsBridgeListener))
          {
            ...
            qgg.a(localActivity, new VidListPlayInfo(paramJsBridgeListener, paramString3, paramString2, paramString1), 105, null);
            break;
          }
