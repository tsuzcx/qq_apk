...
public class ajrw
  implements acci
{
  protected void Mn(boolean paramBoolean) {}
        ...
        for (int j = ((Integer)paramObject[3]).intValue();; j = -1)
        {
          ...
          for (int k = ((Integer)paramObject[4]).intValue();; k = -1)
          {
            ...
            for (;;)
            {
              ...
              {
                b(paramBoolean, paramInt, (List)localObject1, (List)paramObject[2]);
                return;
              }
              b(paramBoolean, paramInt, (List)localObject1, null);
              return;
              ...
              for (paramObject = (String)paramObject;; paramObject = "")
              {
                ...
                paramObject = (Object[])paramObject;
                fn((String)paramObject[0], ((Integer)paramObject[1]).intValue());
                return;
              }
              label1353:
              k = -1;
