...
public class anbv
  implements anbs
{
  private void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, anax paramanax, List<MessageRecord> paramList)
  {
    ...
    do
    {
      ...
      do
      {
            ...
            if (QLog.isColorLevel())
            {
              ...
              for (;;)
              {
                try
                {
                  ...
                  paramMessageHandler.app.a().k(String.valueOf(paramanax.friendUin), k, i, paramMsg);
                  return;
                }
              ...
              if (paramMsg.msg_progress_notify.has())
              {
                ...
                for (j = paramMsg.uint32_average_speed.get();; j = 0)
                {
                  ...
                  paramMessageHandler.app.a().l(String.valueOf(paramanax.friendUin), k, i, j);
                  return;
                  if (!QLog.isColorLevel()) {
                    break;
                  }
              ...
              if (QLog.isColorLevel())
              {
                ...
                if (QLog.isColorLevel())
                {
                  ...
                  if (paramanax.cEE)
                  {
                    ...
                    paramMessageHandler.frienduin = Long.toString(paramanax.friendUin);
                  ...
                  paramMessageHandler.app.a().a(paramMessageHandler, paramList, paramMsg, localNotOnlineFile, String.valueOf(paramanax.friendUin), paramanax.isRead, paramanax.cEC, paramanax.vipBubbleID, paramanax.dEN, (hummer_resv_21.FileImgInfo)localObject1, (hummer_resv_21.ResvAttr)localObject2);
                  return;
                  if (QLog.isColorLevel()) {
                  ...
                  try
                  {
                    ...
                    if (!paramanax.cEE)
                    {
                      ((acde)paramMessageHandler.app.getBusinessHandler(8)).a(paramMsg, paramList);
                      return;
                    }
                  }
                  catch (InvalidProtocolBufferMicroException paramMessageHandler) {}
        ...
        try
        {
          ...
          if (paramMsg != null)
          {
            agmz.k(String.valueOf(l1), paramMsg);
            paramanax = paramList;
          }
        }
        ...
        paramMessageHandler.app.a().a(l1, i, l2, l3, paramanax, (byte[])localObject1);
        return;
        if (QLog.isColorLevel()) {
          QLog.d("MsgType0x211Decoder", 2, "<dataline printer> message come: cmd[0x211, 0x9]");
        }
        paramanax = new C2CType0x211_SubC2CType0x9.MsgBody();
        try
        {
          paramanax = (C2CType0x211_SubC2CType0x9.MsgBody)paramanax.mergeFrom((byte[])localObject1);
          ((acde)paramMessageHandler.app.getBusinessHandler(8)).a(paramMsg, paramanax);
          return;
        }
        catch (InvalidProtocolBufferMicroException paramMessageHandler) {}
      } while (!QLog.isColorLevel());
      ...
      ((syw)paramMessageHandler.app.getBusinessHandler(51)).a(l1, l2, i, l3, j, "im_push.msg_push", (byte[])localObject1);
    } while (!QLog.isColorLevel());
  ...
  private void b(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, anax paramanax)
  {
    int i;
    if ((paramMsg.msg_head.c2c_cmd.get() == 6) || (paramMsg.msg_head.c2c_tmp_msg_head.has()))
    {
      i = 1;
      if (i != 0) {
        new ancb().a(paramMessageHandler, paramMsg, paramList, paramanax);
      }
      if (!paramMsg.msg_head.c2c_tmp_msg_head.has())
      {
        paramMessageHandler = (acff)paramMessageHandler.app.getManager(51);
        if (!jou.z(BaseApplicationImpl.getContext(), String.valueOf(((msg_comm.MsgHead)paramMsg.msg_head.get()).from_uin.get()))) {
          break label146;
        }
        if (!paramMessageHandler.isFriend(String.valueOf(((msg_comm.MsgHead)paramMsg.msg_head.get()).from_uin.get()))) {
          paramanax.friendType = 1025;
        }
      }
    }
    label146:
    while ((!jou.z(BaseApplicationImpl.getContext(), String.valueOf(((msg_comm.MsgHead)paramMsg.msg_head.get()).to_uin.get()))) || (paramMessageHandler.isFriend(String.valueOf(((msg_comm.MsgHead)paramMsg.msg_head.get()).to_uin.get()))))
    {
      return;
      i = 0;
      break;
  ...
  {
    b(paramMessageHandler, paramMsg, paramList, paramanax);
    a(paramMessageHandler, paramMsg, paramanax, paramList);
  }
}
