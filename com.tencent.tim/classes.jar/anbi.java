...
public class anbi
{
  ...
  {
    MessageForApollo localMessageForApollo = (MessageForApollo)d(-2039);
    ...
    try
    {
      localMessageForApollo.msg = ApolloUtil.b(localMessageForApollo);
      localMessageForApollo.msgData = aczw.b(paramApolloMessage);
  ...
  public static MessageForArkApp a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, ArkAppMessage paramArkAppMessage)
  {
    ...
    MessageForArkApp localMessageForArkApp = (MessageForArkApp)e(-5008);
  ...
  public static MessageForHiBoom a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, HiBoomMessage paramHiBoomMessage)
  {
    ...
    try
    {
      localMessageForHiBoom.msgData = aczw.b(paramHiBoomMessage);
  ...
  {
    MessageForMarketFace localMessageForMarketFace = (MessageForMarketFace)d(-2007);
    ...
    try
    {
      localMessageForMarketFace.msgData = aczw.b(paramMarkFaceMessage);
  ...
  {
    paramString1 = (MessageForQQStory)d(-2051);
  ...
  public static MessageForReplyText a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, String paramString2)
  {
    ...
    {
      return paramString1;
      MessageForReplyText localMessageForReplyText = (MessageForReplyText)d(-1049);
      ...
      localMessageForReplyText.msgUid = anbk.I(anbk.Ji());
      paramString1 = paramQQAppInterface.b().f(localMessageForReplyText.senderuin, paramInt);
      if ((paramString1 != null) && (!paramString1.isEmpty()))
      {
        localMessageForReplyText.shmsgseq = ((ChatMessage)paramString1.get(paramString1.size() - 1)).shmsgseq;
        localMessageForReplyText.time = anaz.gQ();
      ...
      try
      {
        localMessageForReplyText.saveExtInfoToExtStr("sens_msg_source_msg_info", aqhs.bytes2HexStr(aczw.b(localMessageForReplyText.mSourceMsgInfo)));
        paramString1 = localMessageForReplyText;
        if (!localMessageForReplyText.isSend()) {
          continue;
        }
        ((acle)paramQQAppInterface.getBusinessHandler(13)).W(localMessageForReplyText);
  ...
  public static MessageForShakeWindow a(String paramString1, String paramString2, String paramString3, int paramInt, long paramLong)
  {
    ...
    paramString1.msgUid = anbk.I(i);
    paramString1.shmsgseq = anbk.d(paramLong, paramInt);
  ...
  {
    paramString1 = (MessageForStructing)d(-2011);
  ...
  {
    paramString1 = (MessageForText)d(-1000);
  ...
  {
    paramString1 = (MessageForTribeShortVideo)d(-7002);
  ...
  {
    Object localObject2 = e(paramInt1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        xkr.a().a(paramQQAppInterface, paramString1, -1, 0, -1);
        if (QLog.isColorLevel()) {
      ...
      paramMessageRecord.msgUid = anbk.I(i);
      paramMessageRecord.shmsgseq = anbk.d(l, paramInt);
      paramMessageRecord.issend = 1;
      return;
      if (paramInt == 1006)
      {
        paramString2 = ((ajdo)paramQQAppInterface.getManager(11)).a();
        if (paramString2 != null)
        {
  ...
  private static void c(MessageRecord paramMessageRecord1, MessageRecord paramMessageRecord2)
  {
    ...
    if (jof.a(paramMessageRecord2)) {
      paramMessageRecord1.vipBubbleID = paramMessageRecord2.vipBubbleID;
    }
    paramMessageRecord1.time = ((int)anaz.gQ());
  }
  ...
  public static MessageRecord d(int paramInt)
  {
    MessageRecord localMessageRecord = e(paramInt);
  ...
  private static MessageRecord e(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      break;
      localObject1 = new MessageForToDo();
      break;
      label1916:
  ...
  public static MessageRecord e(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localMessageRecord = d(paramMessageRecord.msgtype);
      localMessageRecord.msgtype = paramMessageRecord.msgtype;
      c(localMessageRecord, paramMessageRecord);
  ...
  {
    tpd localtpd = (tpd)a.get(Integer.valueOf(paramInt));
    if (localtpd != null) {
      return localtpd.a(paramInt);
    }
    return null;
  }
}
