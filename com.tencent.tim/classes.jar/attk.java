...
public class attk
{
  ...
  QQAppInterface app;
  private aghq h = new attl(this);
  
  public attk(QQAppInterface paramQQAppInterface)
  {
  ...
  public long a(String paramString, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 30	attk:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: invokevirtual 121	com/tencent/mobileqq/app/QQAppInterface:a	()Lagkf;
    //   9: lload 4
    //   11: aload_1
    //   12: iload 6
    //   14: invokevirtual 126	agkf:a	(JLjava/lang/String;I)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   17: astore 7
    //   19: aload 7
    //   21: ifnull +45 -> 66
    //   24: aload_0
    //   25: getfield 28	attk:Z	Ljava/util/LinkedHashMap;
    //   28: aload 7
    //   30: getfield 132	com/tencent/mobileqq/filemanager/data/FileManagerEntity:nSessionId	J
    //   33: invokestatic 138	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   36: invokevirtual 142	java/util/LinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   65: lreturn
    //   66: aload_0
    //   67: getfield 30	attk:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   70: invokevirtual 121	com/tencent/mobileqq/app/QQAppInterface:a	()Lagkf;
    //   73: aload_1
    //   74: lload_2
    //   75: lload 4
    //   77: iload 6
    //   79: invokevirtual 147	agkf:a	(Ljava/lang/String;JJI)J
    //   82: lstore_2
    //   83: goto -21 -> 62
    //   86: astore_1
    //   87: aload_0
  ...
  public boolean a(String paramString, long paramLong, int paramInt)
  {
    ...
    //   11: iload 4
    //   13: ldc2_w 149
    //   16: invokevirtual 153	agkf:a	(JLjava/lang/String;IJ)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   19: astore_1
    //   20: aload_1
    //   21: ifnonnull +11 -> 32
    //   24: iconst_0
    ...
    //   32: aload_0
    //   33: aload_1
    //   34: getfield 132	com/tencent/mobileqq/filemanager/data/FileManagerEntity:nSessionId	J
    //   37: invokevirtual 157	attk:cc	(J)Z
    //   40: istore 5
    //   42: goto -15 -> 27
    //   45: astore_1
    //   46: aload_0
  ...
  public boolean cc(long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 28	attk:Z	Ljava/util/LinkedHashMap;
    //   6: lload_1
    //   7: invokestatic 138	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   10: invokevirtual 142	java/util/LinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   13: checkcast 74	agpb
    //   16: astore 4
    //   18: aload 4
    //   20: ifnull +26 -> 46
    //   23: aload 4
    //   25: invokeinterface 268 1 0
    //   30: aload_0
    //   31: getfield 28	attk:Z	Ljava/util/LinkedHashMap;
    //   34: lload_1
    //   35: invokestatic 138	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   38: invokevirtual 271	java/util/LinkedHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   41: pop
    //   42: aload_0
    //   43: invokevirtual 274	attk:dho	()V
    //   46: aload_0
    //   47: getfield 30	attk:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   50: invokevirtual 121	com/tencent/mobileqq/app/QQAppInterface:a	()Lagkf;
    //   53: lload_1
    //   54: invokevirtual 161	agkf:b	(J)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   57: astore 4
    //   59: aload 4
    //   61: ifnull +72 -> 133
    //   64: aload 4
    //   66: getfield 228	com/tencent/mobileqq/filemanager/data/FileManagerEntity:nFileType	I
    //   69: iconst_2
    //   70: if_icmpne +63 -> 133
    //   73: aload 4
    //   75: getfield 132	com/tencent/mobileqq/filemanager/data/FileManagerEntity:nSessionId	J
    //   78: invokestatic 279	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   81: invokestatic 282	agkw:IM	(Ljava/lang/String;)V
    //   84: aload 4
    //   86: getfield 188	com/tencent/mobileqq/filemanager/data/FileManagerEntity:status	I
    //   89: iconst_2
    //   90: if_icmpeq +12 -> 102
    //   93: aload 4
    //   95: getfield 188	com/tencent/mobileqq/filemanager/data/FileManagerEntity:status	I
    //   98: iconst_m1
    //   99: if_icmpne +9 -> 108
    //   102: aload 4
    //   104: iconst_3
    //   105: putfield 188	com/tencent/mobileqq/filemanager/data/FileManagerEntity:status	I
    //   108: aload_0
    //   109: getfield 30	attk:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   112: invokevirtual 121	com/tencent/mobileqq/app/QQAppInterface:a	()Lagkf;
    //   115: aload 4
    //   117: invokevirtual 192	agkf:u	(Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;)V
    //   120: aload_0
    //   121: getfield 30	attk:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   135: ifnull +36 -> 171
    //   138: aload 4
    //   140: getfield 188	com/tencent/mobileqq/filemanager/data/FileManagerEntity:status	I
    //   143: iconst_2
    //   144: if_icmpne +27 -> 171
    //   147: aload 4
    //   149: iconst_3
    //   150: putfield 188	com/tencent/mobileqq/filemanager/data/FileManagerEntity:status	I
    //   153: aload_0
    //   154: getfield 30	attk:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   157: invokevirtual 121	com/tencent/mobileqq/app/QQAppInterface:a	()Lagkf;
    //   160: aload 4
    //   162: invokevirtual 192	agkf:u	(Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;)V
    //   165: iconst_1
    //   166: istore_3
    //   167: aload_0
    //   168: monitorexit
  ...
  public FileManagerEntity f(String paramString)
  {
    ...
    //   20: areturn
    //   21: aload_0
    //   22: getfield 28	attk:Z	Ljava/util/LinkedHashMap;
    //   25: invokevirtual 293	java/util/LinkedHashMap:keySet	()Ljava/util/Set;
    ...
    //   49: checkcast 134	java/lang/Long
    //   52: astore 4
    //   54: aload_0
    //   55: getfield 28	attk:Z	Ljava/util/LinkedHashMap;
    //   58: aload 4
    //   60: invokevirtual 142	java/util/LinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   63: checkcast 74	agpb
    //   66: astore 4
    //   68: aload_1
    //   69: aload 4
    //   71: invokeinterface 351 1 0
    //   76: invokevirtual 354	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   79: ifeq -45 -> 34
    //   82: aload 4
    //   84: invokeinterface 357 1 0
    //   89: astore_1
    //   90: goto -73 -> 17
    //   93: aconst_null
    //   94: astore_1
