...
public class aqqx
{
  public static int[] pd = { 2, 3, 4, 5, 6, 8 };
  public static final int[] pe = { 1, 0, 2, 3, 9, 27 };
  ...
  {
    return a(paramString, paramArrayOfInt, paramDrawable, null, new aqqy(paramArrayOfInt));
  }
  ...
  {
    return aqul.getSDKPrivatePath(new StringBuilder().append(acbn.SDCARD_PATH).append(".vipicon/").toString()) + paramString.hashCode() + ".png";
  }
}
