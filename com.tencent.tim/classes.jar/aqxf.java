...
public class aqxf
  extends accg
{
  final String TAG = "VipSetFunCallHandler";
  private QQAppInterface mApp;
  
  public aqxf(QQAppInterface paramQQAppInterface)
  {
  ...
  public void J(int paramInt, Object paramObject)
  {
    ...
    localTSsoReq.str_qq_ver.set("3.4.4");
    ...
    case 1: 
      ...
      long l = aqwu.a(this.mApp, 1, null).getLong("local_version", 0L);
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((VipFunCallAndRing.TSsoReq)localObject2).i32_cmd.has())
        {
          ...
          QLog.e("VipSetFunCallHandler", 1, "onReceive~ isSuccess=false ,data=" + aqoj.C((byte[])paramObject) + ", funcType=" + j);
          arts.a().a("FunCallSvr.call", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, acfp.m(2131716799), true);
    ...
    paramFromServiceMsg = (aqwu)this.app.getManager(84);
    label457:
    boolean bool;
    if (QLog.isColorLevel())
    {
      ...
      for (;;)
      {
        ...
        paramObject = ((acff)localObject1).a(paramToServiceMsg);
        ...
        ((acff)localObject1).a(paramFromServiceMsg);
        return;
        if (k != 0) {
          break label1647;
        }
        ...
        paramToServiceMsg = aqwu.a(this.mApp, 1, null);
        ...
        else
        {
          ...
          {
            paramFromServiceMsg.a(this.mApp, 0, this.app.getAccount(), ((VipFunCallAndRing.TUserInfo)localObject2).i32_common_id.get(), ((VipFunCallAndRing.TUserInfo)localObject2).i32_ring_id.get(), null, l);
            localObject3 = (VipFunCallAndRing.TSourceInfo)((VipFunCallAndRing.TUserInfo)localObject2).st_src_info.get();
            aqwu.a(this.mApp, ((VipFunCallAndRing.TUserInfo)localObject2).i32_common_id.get(), null, (VipFunCallAndRing.TSourceInfo)localObject3, true);
            ...
            if ((localObject3 != null) && (((List)localObject3).size() > 0))
            {
              ...
              while (((Iterator)localObject3).hasNext())
              {
                ...
                paramFromServiceMsg.a(this.mApp, 1, null, localTGroupInfo.i32_group_id.get(), localTGroupInfo.i32_ring_id.get(), localTGroupInfo.u64_group_uins.get(), 0L);
                VipFunCallAndRing.TSourceInfo localTSourceInfo = (VipFunCallAndRing.TSourceInfo)localTGroupInfo.st_src_info.get();
                aqwu.a(this.mApp, localTGroupInfo.i32_group_id.get(), null, localTSourceInfo, true);
              }
            }
            if (aqwu.aFN()) {
          ...
          m = aqwu.a(this.mApp, paramToServiceMsg, 6, true, null);
          paramFromServiceMsg.a(this.mApp, 0, paramToServiceMsg, i, ((VipFunCallAndRing.TSsoCmd0x2Rsp)localObject3).i32_ring_id.get(), null, 0L);
          aqwu.a(this.mApp, ((VipFunCallAndRing.TSsoCmd0x2Rsp)localObject3).i32_funcall_id.get(), null, (VipFunCallAndRing.TSourceInfo)((VipFunCallAndRing.TSsoCmd0x2Rsp)localObject3).st_src_info.get(), true);
          if (aqwu.aFN()) {
          ...
          if (i != m)
          {
            ...
            aqwu.a(this.mApp, paramToServiceMsg, 2, this.mApp.getAccount(), i);
          }
          for (;;)
          {
            ...
            break;
            label1227:
            aqwu.a(this.mApp, paramToServiceMsg, 1, this.mApp.getAccount(), i);
          }
          ...
          paramFromServiceMsg.a(this.mApp, 0, this.app.getAccount(), ((VipFunCallAndRing.TSsoCmd0x3Req)localObject2).i32_funcall_id.get(), ((VipFunCallAndRing.TSsoCmd0x3Req)localObject2).i32_ring_id.get(), null, 0L);
      ...
      if (k == 0)
      {
        ...
        paramFromServiceMsg.a(this.mApp, 1, null, ((VipFunCallAndRing.TSsoCmd0x4Req)localObject2).i32_funcall_id.get(), ((VipFunCallAndRing.TSsoCmd0x4Req)localObject2).i32_ring_id.get(), ((VipFunCallAndRing.TSsoCmd0x4Req)localObject2).rpt_uins.get(), 0L);
      }
      if (1 != m) {
        break label1647;
      }
    ...
    for (paramToServiceMsg = "0";; paramToServiceMsg = "1")
    {
      ...
      if (k == 0)
      {
        ...
        paramFromServiceMsg.a(this.mApp, 2, null, paramToServiceMsg.i32_funcall_id.get(), 0, null, 0L);
        paramToServiceMsg = null;
        i = -1;
        break label457;
        bool = false;
