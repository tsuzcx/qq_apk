...
public class jot
  extends swr
{
  private static final String[] ba = { "hrtxformqq" };
  public static int seq;
  private QQAppInterface app;
  
  public jot(QQAppInterface paramQQAppInterface)
  {
  ...
  private byte[] b(ToServiceMsg paramToServiceMsg)
  {
    ...
    long l2 = Long.valueOf(this.app.getCurrentAccountUin()).longValue();
    ...
    arrayOfByte[0] = 91;
    System.arraycopy(d(1001), 0, arrayOfByte, 1, 4);
    int m = seq;
    seq = m + 1;
    System.arraycopy(d(m), 0, arrayOfByte, 5, 4);
    System.arraycopy(d(i), 0, arrayOfByte, 9, 4);
    System.arraycopy(d(j), 0, arrayOfByte, 13, 4);
  ...
  public byte[] a(ToServiceMsg paramToServiceMsg)
  {
    ...
    for (paramToServiceMsg = b(paramToServiceMsg);; paramToServiceMsg = null)
    {
      ...
      byte[] arrayOfByte1 = d(paramToServiceMsg.length + 4);
