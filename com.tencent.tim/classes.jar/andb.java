...
public class andb
  implements ancz
{
  private static HashMap<String, Long> ng = new HashMap();
  
  private static void a(QQAppInterface paramQQAppInterface, submsgtype0xb1.InviteInfo paramInviteInfo, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if ((paramBoolean) || (!ng.containsKey(localInviteInfo.str_id.get()))) {
            break;
          }
          l2 = ((Long)ng.get(localInviteInfo.str_id.get())).longValue();
          if (l1 - l2 >= 10L) {
            break;
          }
        ...
        return;
        paramBoolean = paramQQAppInterface.a().au(localInviteInfo.uint64_group_code.get());
        if (QLog.isColorLevel()) {
      ...
      } while ((!paramBoolean) || (((TroopManager)localObject).aD(localInviteInfo.uint64_group_code.get() + "", localInviteInfo.uint64_uin.get() + "")));
      paramBoolean = false;
      if (paramQQAppInterface.a().bG() > 0L) {
        paramBoolean = true;
      }
      if (((TroopManager)localObject).Bc() != 2) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("TroopInviteVideoDecoder.troopgroup_vedio.invite", 2, "只允许同时存在两个邀请框");
    return;
    if (((TroopManager)localObject).Bc() > 0)
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ((TroopManager)localObject).fc(String.valueOf(localInviteInfo.uint64_group_code.get()), String.valueOf(localInviteInfo.uint64_uin.get()));
      ...
      paramInviteInfo.putExtra("memberType", jlk.a(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin(), localInviteInfo.uint64_group_code.get() + ""));
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (localMsgBody.deal_info.has())
      {
        ...
        if (i == 0) {
          paramQQAppInterface.a().g(l1, l2, paramArrayOfByte);
        }
        if (QLog.isColorLevel()) {
      ...
      if (localMsgBody.univite_info.has())
      {
        ...
        paramQQAppInterface.a().h(l1, l2, paramArrayOfByte);
        if (QLog.isColorLevel()) {
        ...
        if (!paramBoolean) {
          ng.put(paramArrayOfByte, Long.valueOf(System.currentTimeMillis() / 1000L));
        }
      }
      return;
    }
