...
public class abzb
{
  ...
  public abzb(String paramString1, String paramString2)
  {
    this.bkg = paramString1;
    this.bkf = paramString2;
  }
  ...
  public static boolean a(byte[] paramArrayOfByte1, String paramString, byte[] paramArrayOfByte2)
  {
    ...
    do
    {
      ...
      try
      {
        paramString = KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(aqgo.decode(paramString.getBytes("UTF-8"), 0)));
  ...
  public boolean il(int paramInt)
  {
    boolean bool = true;
    try
    {
      if ((aqhq.fileExists(this.bkf)) && (aqhq.fileExists(this.bkg)))
      {
        byte[] arrayOfByte1 = aqhq.readFile(this.bkf);
        byte[] arrayOfByte2 = aqhq.readFile(this.bkg);
