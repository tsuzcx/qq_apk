...
public class aokm
  extends aoja
{
  public aokm(BaseApplicationImpl paramBaseApplicationImpl)
  {
    ...
    throws IOException
  {
    ...
    if ((j != 0) && (aqiw.isNetworkAvailable(this.b.getApplicationContext())))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        new aolf().a(paramOutputStream, paramDownloadParams, paramURLDrawableHandler);
        paramOutputStream.close();
        paramURLDrawableHandler = new File(str3);
        localFile = new File(str1);
        if (!paramURLDrawableHandler.renameTo(localFile))
        {
          aqhq.copyFile(paramURLDrawableHandler, localFile);
          paramURLDrawableHandler.delete();
        }
        avjg.a(this.b.waitAppRuntime(null), false, new File(str1).length());
    ...
    throws Exception
  {
    ...
    for (;;)
    {
      ...
      if (5 == ahav.getFileType(paramFile.getName()))
      {
        localObject = ahap.f(this.b, paramFile.getPath());
        if (localObject != null)
        {
