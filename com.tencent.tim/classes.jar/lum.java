...
public class lum
{
  private static Boolean[] a = { Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false) };
  private static String[] bq = new String[0];
  private static Integer[] c = { Integer.valueOf(4779), Integer.valueOf(1166), Integer.valueOf(5293), Integer.valueOf(501), Integer.valueOf(73), Integer.valueOf(5729), Integer.valueOf(1314), Integer.valueOf(3817), Integer.valueOf(3689), Integer.valueOf(3076) };
  ...
  public static List<ChannelInfo> S(List<oidb_cmd0x69f.ChannelInfo> paramList)
  {
  ...
  public static List<TabChannelCoverInfo> T(List<channel_button.Channel> paramList)
  {
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        boolean bool = b(localTabChannelCoverInfo);
  ...
  public static List<mhb> U(List<oidb_cmd0x46f.DislikeResult> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if ((paramList == null) || (paramList.size() == 0)) {
      return localArrayList;
    ...
    while (paramList.hasNext())
    {
      ...
      mhb localmhb = new mhb();
      if (localDislikeResult.uint64_articleid.has()) {
        localmhb.mArticleId = localDislikeResult.uint64_articleid.get();
      }
      if (localDislikeResult.uint32_result.has()) {
        localmhb.mResult = localDislikeResult.uint32_result.get();
      }
      if (localDislikeResult.str_message.has()) {
        localmhb.mMessage = localDislikeResult.str_message.get();
      }
      localArrayList.add(localmhb);
    }
    return localArrayList;
  }
  
  public static List<TagInfo> V(List<oidb_cmd0xb83.TagInfo> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramList != null)
    {
  ...
  public static List<TopicInfo> W(List<oidb_cmd0xbde.TopicInfo> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramList != null)
    {
  ...
  public static ArticleInfo a(articlesummary.ArticleSummary paramArticleSummary, int paramInt1, int paramInt2, ArticleInfo paramArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((paramArticleSummary.bytes_aio_share_url.has()) && (paramArticleSummary.bytes_aio_share_url.get() != null)) {
        localArticleInfo.aioShareUrl = paramArticleSummary.bytes_aio_share_url.get().toStringUtf8();
      }
      if ((paramArticleSummary.bytes_qzone_share_url.has()) && (paramArticleSummary.bytes_qzone_share_url.get() != null)) {
        localArticleInfo.qzoneShareUrl = paramArticleSummary.bytes_qzone_share_url.get().toStringUtf8();
      }
      ...
      catch (Exception paramArticleInfo)
      {
        ...
        catch (InvalidProtocolBufferMicroException paramArticleInfo)
        {
          ...
          localArticleInfo.mDiskLikeInfoString = DislikeInfo.k(localArticleInfo.mDislikeInfos);
          ...
          if (paramArticleSummary.msg_pack_info.has())
          {
            ...
            localArticleInfo.mPolymericInfo = mhs.a(localArticleInfo.mPackInfoObj);
            if (localArticleInfo.mPolymericInfo.aRX == 9) {
              localArticleInfo.businessId = localArticleInfo.mPolymericInfo.vr;
            }
            if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            localArticleInfo.mNewPolymericInfo = mhr.a((articlesummary.NewPackInfo)paramArticleSummary.msg_new_pack_info.get());
            if ((localArticleInfo.mTopicRecommendFeedsInfo != null) && (localArticleInfo.mTopicRecommendFeedsInfo.ld != null) && (localArticleInfo.mTopicRecommendFeedsInfo.ld.size() > 0)) {
              localArticleInfo.businessId = ((mih.b)localArticleInfo.mTopicRecommendFeedsInfo.ld.get(0)).businessId;
            }
          }
          ...
          if (paramArticleSummary.recommend_info.has()) {
            localArticleInfo.mRecommendFollowInfos = mhx.a((articlesummary.RecommendFollowInfos)paramArticleSummary.recommend_info.get());
          }
          if (paramArticleSummary.hot_word_info.has()) {
            localArticleInfo.hotWordInfo = mhi.a((articlesummary.HotWordInfo)paramArticleSummary.hot_word_info.get());
          }
          ...
          else
          {
            ...
            if ((paramArticleSummary.msg_feeds_info.has()) && (paramArticleSummary.msg_feeds_info.msg_aggregated_list.has()))
            {
              ...
              localArticleInfo.mExtraBiuBriefInfo = mhc.a(paramArticleInfo);
              ...
              {
                localArticleInfo.multiBiuSameContentList = MultiBiuSameContent.p(paramArticleInfo.rpt_multi_biu_same_content.get());
            ...
            if (paramArticleSummary.awesome_comment_icon.has())
            {
              ...
              mgt.a(localArticleInfo, (articlesummary.AwesomeCommentInfo)paramArticleSummary.awesome_comment_icon.get());
            }
            if (paramArticleSummary.msg_family_comment_info.has())
            {
              ...
              localObject1 = new mhd();
              if (paramArticleInfo.icon_url.has()) {
                ((mhd)localObject1).agS = paramArticleInfo.icon_url.get().toStringUtf8();
              }
              if (paramArticleInfo.jump_url.has()) {
                ((mhd)localObject1).agT = paramArticleInfo.jump_url.get().toStringUtf8();
              }
              if (paramArticleInfo.medal_urls_width.has()) {
                ((mhd)localObject1).aOw = paramArticleInfo.medal_urls_width.get();
              }
              if (paramArticleInfo.medal_urls_height.has()) {
                ((mhd)localObject1).BT = paramArticleInfo.medal_urls_height.get();
              }
              localArticleInfo.familyCommentInfo = ((mhd)localObject1);
            ...
            if ((paramArticleSummary.msg_feeds_info.has()) && (paramArticleSummary.msg_feeds_info.msg_social_feeds_info.has()))
            {
              ...
              if (paramArticleSummary.msg_feeds_info.msg_social_feeds_info.msg_card_jump_info.bytes_share_url.has()) {
                localArticleInfo.commentShareUrl = paramArticleSummary.msg_feeds_info.msg_social_feeds_info.msg_card_jump_info.bytes_share_url.get().toStringUtf8();
              }
              if (paramArticleSummary.msg_feeds_info.msg_social_feeds_info.msg_fusion_info.has())
              {
                if (paramArticleSummary.msg_feeds_info.msg_social_feeds_info.msg_fusion_info.str_comment_id.has()) {
                  localArticleInfo.commentId = paramArticleSummary.msg_feeds_info.msg_social_feeds_info.msg_fusion_info.str_comment_id.get();
                }
                if (paramArticleSummary.msg_feeds_info.msg_social_feeds_info.msg_fusion_info.uint32_comment_src.has()) {
                  localArticleInfo.commentSrc = paramArticleSummary.msg_feeds_info.msg_social_feeds_info.msg_fusion_info.uint32_comment_src.get();
                }
              }
            }
            ...
            if ((paramArticleSummary.video_multi_column_info.has()) && (paramArticleSummary.video_multi_column_info.get() != null))
            {
              ...
              localArticleInfo.multiVideoColumnInfo = mhq.a((articlesummary.VideoColumnInfo)paramArticleSummary.video_multi_column_info.get());
              if (QLog.isColorLevel()) {
            ...
            {
              localArticleInfo.scripCmsInfo = mhz.a((articlesummary.ScripCmsInfo)paramArticleSummary.msg_scrip_cms_info.get());
              localArticleInfo.scripCmsInfoByte = ((articlesummary.ScripCmsInfo)paramArticleSummary.msg_scrip_cms_info.get()).toByteArray();
              if (paramInt2 != 7) {
                break label5363;
              }
              localArticleInfo.scripCmsInfo.showType = 1;
              paramArticleInfo = BaseApplicationImpl.getApplication().getRuntime().getAccount();
              ljp.i(BaseApplicationImpl.getApplication(), paramArticleInfo, ljp.n(BaseApplicationImpl.getApplication(), paramArticleInfo) + 1);
              if (QLog.isColorLevel()) {
            ...
            if ((paramArticleSummary.msg_kd_live_info.has()) && (paramArticleSummary.msg_kd_live_info.get() != null))
            {
              ...
              localArticleInfo.mKdLiveInfo = mhl.a((articlesummary.KdLiveInfo)paramArticleSummary.msg_kd_live_info.get());
              if (QLog.isColorLevel()) {
            ...
            mgm.i(localArticleInfo);
            if ((!paramArticleSummary.uint32_red_package_flag.has()) || (paramArticleSummary.uint32_red_package_flag.get() != 1)) {
              break label5387;
            }
            bool1 = true;
            ...
            if ((paramArticleSummary.bytes_small_game_rsp_pack.has()) && (paramArticleSummary.bytes_small_game_rsp_pack.get() != null))
            {
              localArticleInfo.smallGameData = paramArticleSummary.bytes_small_game_rsp_pack.get().toStringUtf8();
              localArticleInfo.mSmallMiniGameInfo = kla.a(localArticleInfo.smallGameData);
            }
            ...
            if (localArticleInfo.isWormhole()) {
              nxq.l(localArticleInfo);
            }
            if ((!paramArticleSummary.uint32_forbid_reprint_flag.has()) || (paramArticleSummary.uint32_forbid_reprint_flag.get() != 1)) {
              break label5393;
            }
            bool1 = bool2;
            localArticleInfo.isForbidReprint = bool1;
            paramArticleInfo = localArticleInfo;
            if (!paramArticleSummary.bytes_wechat_share_url.has()) {
              break;
            }
            paramArticleInfo = localArticleInfo;
            if (paramArticleSummary.bytes_wechat_share_url.get() == null) {
              break;
            }
            localArticleInfo.wechatShareUrl = paramArticleSummary.bytes_wechat_share_url.get().toStringUtf8();
        ...
        catch (JSONException paramArticleInfo)
        {
          for (;;)
          {
            ...
            if (QLog.isColorLevel())
            {
              ...
              if (paramInt2 == 6)
              {
                localArticleInfo.scripCmsInfo.showType = 2;
                continue;
                bool1 = false;
                continue;
                bool1 = false;
  ...
  public static ChannelCoverInfo a(oidb_cmd0x69f.ChannelInfo paramChannelInfo, int paramInt)
  {
    ...
    //   0: iconst_1
    //   1: istore_3
    //   2: new 1494	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo
    //   5: dup
    //   6: invokespecial 1495	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:<init>	()V
    //   9: astore 4
    //   11: aload_0
    //   12: getfield 1496	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_channel_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   15: invokevirtual 155	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   18: ifeq +15 -> 33
    //   21: aload 4
    //   23: aload_0
    //   24: getfield 1496	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_channel_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   27: invokevirtual 157	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   30: putfield 1497	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverId	I
    //   33: aload_0
    //   34: getfield 1498	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_name	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   37: invokevirtual 299	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   40: ifeq +28 -> 68
    //   43: aload_0
    //   44: getfield 1498	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_name	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   47: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   50: ifnull +18 -> 68
    //   53: aload 4
    //   55: aload_0
    //   56: getfield 1498	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_name	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   59: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   62: invokevirtual 196	com/tencent/mobileqq/pb/ByteStringMicro:toStringUtf8	()Ljava/lang/String;
    //   65: putfield 1499	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverName	Ljava/lang/String;
    //   68: aload_0
    //   69: getfield 1502	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:enum_channel_cover_style	Lcom/tencent/mobileqq/pb/PBEnumField;
    //   72: invokevirtual 767	com/tencent/mobileqq/pb/PBEnumField:has	()Z
    //   75: ifeq +15 -> 90
    //   78: aload 4
    //   80: aload_0
    //   81: getfield 1502	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:enum_channel_cover_style	Lcom/tencent/mobileqq/pb/PBEnumField;
    //   84: invokevirtual 679	com/tencent/mobileqq/pb/PBEnumField:get	()I
    //   87: putfield 1505	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverStyle	I
    //   90: aload_0
    //   91: getfield 1508	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_wording	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   94: invokevirtual 299	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   97: ifeq +38 -> 135
    //   100: aload_0
    //   101: getfield 1508	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_wording	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   104: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   107: ifnull +28 -> 135
    //   110: aload 4
    //   112: new 14	java/lang/String
    //   115: dup
    //   116: aload_0
    //   117: getfield 1508	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_wording	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   120: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   123: invokevirtual 498	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   126: ldc_w 1510
    //   129: invokespecial 1513	java/lang/String:<init>	([BLjava/lang/String;)V
    //   132: putfield 1516	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverSummary	Ljava/lang/String;
    //   135: aload_0
    //   136: getfield 1519	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_spec	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   139: invokevirtual 299	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   142: ifeq +82 -> 224
    //   145: aload_0
    //   146: getfield 1519	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_spec	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   149: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   152: ifnull +72 -> 224
    //   155: aload 4
    //   157: new 14	java/lang/String
    //   160: dup
    //   161: aload_0
    //   162: getfield 1519	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_spec	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   165: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   168: invokevirtual 498	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   171: ldc_w 1510
    //   174: invokespecial 1513	java/lang/String:<init>	([BLjava/lang/String;)V
    //   177: putfield 1522	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverSpec	Ljava/lang/String;
    //   180: new 439	org/json/JSONObject
    //   183: dup
    //   184: aload 4
    //   186: getfield 1522	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverSpec	Ljava/lang/String;
    //   189: invokespecial 442	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   192: ldc_w 1524
    //   195: invokevirtual 1527	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   198: astore 5
    //   200: aload 5
    //   202: invokestatic 833	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   205: ifne +19 -> 224
    //   208: aload 4
    //   210: iconst_1
    //   211: putfield 1530	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:hasFilterColor	Z
    //   214: aload 4
    //   216: aload 5
    //   218: invokestatic 1535	android/graphics/Color:parseColor	(Ljava/lang/String;)I
    //   221: putfield 1537	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:filterColor	I
    //   224: aload_0
    //   225: getfield 1540	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_jump_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   228: invokevirtual 299	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   231: ifeq +448 -> 679
    //   234: aload_0
    //   235: getfield 1540	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_jump_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   238: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   241: ifnull +438 -> 679
    //   244: aload 4
    //   246: new 14	java/lang/String
    //   249: dup
    //   250: aload_0
    //   251: getfield 1540	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_jump_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   254: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   257: invokevirtual 498	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   260: ldc_w 1510
    //   263: invokespecial 1513	java/lang/String:<init>	([BLjava/lang/String;)V
    //   266: putfield 1543	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelJumpUrl	Ljava/lang/String;
    //   269: aload 4
    //   271: iconst_1
    //   272: putfield 1546	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mColumnType	I
    //   275: aload_0
    //   276: getfield 1549	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_picurl	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   279: invokevirtual 299	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   282: ifeq +38 -> 320
    //   285: aload_0
    //   286: getfield 1549	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_picurl	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   289: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   292: ifnull +28 -> 320
    //   295: aload 4
    //   297: new 14	java/lang/String
    //   300: dup
    //   301: aload_0
    //   302: getfield 1549	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_picurl	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   305: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   308: invokevirtual 498	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   311: ldc_w 1510
    //   314: invokespecial 1513	java/lang/String:<init>	([BLjava/lang/String;)V
    //   317: putfield 1552	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverPicUrl	Ljava/lang/String;
    //   320: aload_0
    //   321: getfield 1555	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_is_followed	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   324: invokevirtual 155	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   327: ifeq +15 -> 342
    //   330: aload 4
    //   332: aload_0
    //   333: getfield 1555	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_is_followed	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   336: invokevirtual 157	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   339: putfield 1558	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mFollowType	I
    //   342: aload_0
    //   343: getfield 1561	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:enum_column_type	Lcom/tencent/mobileqq/pb/PBEnumField;
    //   346: invokevirtual 767	com/tencent/mobileqq/pb/PBEnumField:has	()Z
    //   349: ifeq +15 -> 364
    //   352: aload 4
    //   354: aload_0
    //   355: getfield 1561	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:enum_column_type	Lcom/tencent/mobileqq/pb/PBEnumField;
    //   358: invokevirtual 679	com/tencent/mobileqq/pb/PBEnumField:get	()I
    //   361: putfield 1546	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mColumnType	I
    //   364: aload_0
    //   365: getfield 1565	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:msg_rich_tips	Ltencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips;
    //   368: invokevirtual 1568	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:has	()Z
    //   371: ifeq +389 -> 760
    //   374: aload_0
    //   375: getfield 1565	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:msg_rich_tips	Ltencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips;
    //   378: invokevirtual 1569	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   381: ifnull +379 -> 760
    //   384: aload_0
    //   385: getfield 1565	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:msg_rich_tips	Ltencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips;
    //   388: invokevirtual 1569	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   391: checkcast 1567	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips
    //   394: astore 5
    //   396: aload 5
    //   398: getfield 1572	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:uint32_tips_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   401: invokevirtual 155	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   404: ifeq +16 -> 420
    //   407: aload 4
    //   409: aload 5
    //   411: getfield 1572	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:uint32_tips_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   414: invokevirtual 157	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   417: putfield 1575	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mTipsType	I
    //   420: aload 5
    //   422: getfield 1578	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:bytes_tips_text	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   425: invokevirtual 299	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   428: ifeq +40 -> 468
    //   431: aload 5
    //   433: getfield 1578	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:bytes_tips_text	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   436: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   439: ifnull +29 -> 468
    //   442: aload 4
    //   444: new 14	java/lang/String
    //   447: dup
    //   448: aload 5
    //   450: getfield 1578	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:bytes_tips_text	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   453: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   456: invokevirtual 498	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   459: ldc_w 1510
    //   462: invokespecial 1513	java/lang/String:<init>	([BLjava/lang/String;)V
    //   465: putfield 1581	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mTipsText	Ljava/lang/String;
    //   468: aload 5
    //   470: getfield 1584	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:uint32_latest_sticky_time	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   473: invokevirtual 155	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   476: ifeq +17 -> 493
    //   479: aload 4
    //   481: aload 5
    //   483: getfield 1584	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:uint32_latest_sticky_time	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   486: invokevirtual 157	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   489: i2l
    //   490: putfield 1587	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mUpdateTime	J
    //   493: invokestatic 1592	lbz:a	()Llbz;
    //   496: iload_1
    //   497: invokevirtual 1596	lbz:r	(I)Ljava/util/List;
    //   500: checkcast 44	java/util/ArrayList
    //   503: astore 5
    //   505: aload 5
    //   507: ifnull +253 -> 760
    //   510: aload 5
    //   512: invokevirtual 1597	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   515: astore 5
    //   517: aload 5
    //   519: invokeinterface 61 1 0
    //   524: ifeq +236 -> 760
    //   527: aload 5
    //   529: invokeinterface 65 1 0
    //   534: checkcast 1494	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo
    //   537: astore 6
    //   539: aload 6
    //   541: getfield 1497	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverId	I
    //   544: aload 4
    //   546: getfield 1497	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverId	I
    //   549: if_icmpne -32 -> 517
    //   552: aload 4
    //   554: aload 6
    //   556: getfield 1600	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mPreUpdateTime	J
    //   559: putfield 1600	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mPreUpdateTime	J
    //   562: goto -45 -> 517
    //   565: astore 5
    //   567: ldc_w 1602
    //   570: iconst_1
    //   571: new 265	java/lang/StringBuilder
    //   574: dup
    //   575: invokespecial 266	java/lang/StringBuilder:<init>	()V
    //   578: ldc_w 1604
    //   581: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   584: aload 5
    //   586: invokevirtual 1605	java/lang/Exception:toString	()Ljava/lang/String;
    //   589: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   592: invokevirtual 278	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   595: invokestatic 281	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   598: goto -463 -> 135
    //   601: astore 5
    //   603: ldc_w 1602
    //   606: iconst_1
    //   607: new 265	java/lang/StringBuilder
    //   610: dup
    //   611: invokespecial 266	java/lang/StringBuilder:<init>	()V
    //   614: ldc_w 1607
    //   617: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   620: aload 5
    //   622: invokevirtual 1605	java/lang/Exception:toString	()Ljava/lang/String;
    //   625: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   628: invokevirtual 278	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   631: invokestatic 281	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   634: goto -410 -> 224
    //   637: astore 5
    //   639: ldc_w 1602
    //   642: iconst_1
    //   643: new 265	java/lang/StringBuilder
    //   646: dup
    //   647: invokespecial 266	java/lang/StringBuilder:<init>	()V
    //   650: ldc_w 1609
    //   653: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   656: aload 5
    //   658: invokevirtual 1605	java/lang/Exception:toString	()Ljava/lang/String;
    //   661: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   664: invokevirtual 278	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   667: invokestatic 281	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   670: aload 4
    //   672: iconst_0
    //   673: putfield 1546	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mColumnType	I
    //   676: goto -401 -> 275
    //   679: aload 4
    //   681: iconst_0
    //   682: putfield 1546	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mColumnType	I
    //   685: goto -410 -> 275
    //   688: astore 5
    //   690: ldc_w 1602
    //   693: iconst_1
    //   694: new 265	java/lang/StringBuilder
    //   697: dup
    //   698: invokespecial 266	java/lang/StringBuilder:<init>	()V
    //   701: ldc_w 1611
    //   704: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   707: aload 5
    //   709: invokevirtual 1605	java/lang/Exception:toString	()Ljava/lang/String;
    //   712: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   715: invokevirtual 278	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   718: invokestatic 281	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   721: goto -401 -> 320
    //   724: astore 6
    //   726: ldc_w 1602
    //   729: iconst_1
    //   730: new 265	java/lang/StringBuilder
    //   733: dup
    //   734: invokespecial 266	java/lang/StringBuilder:<init>	()V
    //   737: ldc_w 1613
    //   740: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   743: aload 6
    //   745: invokevirtual 1605	java/lang/Exception:toString	()Ljava/lang/String;
    //   748: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   751: invokevirtual 278	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   754: invokestatic 281	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   757: goto -289 -> 468
    //   760: aload_0
    //   761: getfield 1614	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_icon_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   764: invokevirtual 299	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   767: ifeq +38 -> 805
    //   770: aload_0
    //   771: getfield 1614	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_icon_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   774: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   777: ifnull +28 -> 805
    //   780: aload 4
    //   782: new 14	java/lang/String
    //   785: dup
    //   786: aload_0
    //   787: getfield 1614	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_icon_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   790: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   793: invokevirtual 498	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   796: ldc_w 1510
    //   799: invokespecial 1513	java/lang/String:<init>	([BLjava/lang/String;)V
    //   802: putfield 1617	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mIconUrl	Ljava/lang/String;
    //   805: aload_0
    //   806: getfield 1620	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_fonts_color	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   809: invokevirtual 155	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   812: ifeq +25 -> 837
    //   815: aload_0
    //   816: getfield 1620	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_fonts_color	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   819: invokevirtual 157	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   822: ifeq +15 -> 837
    //   825: aload 4
    //   827: aload_0
    //   828: getfield 1620	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_fonts_color	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   831: invokevirtual 157	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   834: putfield 1623	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mFontColor	I
    //   837: aload_0
    //   838: getfield 1626	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_frame_color	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   841: invokevirtual 155	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   844: ifeq +25 -> 869
    //   847: aload_0
    //   848: getfield 1626	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_frame_color	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   851: invokevirtual 157	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   854: ifeq +15 -> 869
    //   857: aload 4
    //   859: aload_0
    //   860: getfield 1626	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_frame_color	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   863: invokevirtual 157	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   866: putfield 1629	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mFrameColor	I
    //   869: aload 4
    //   871: iload_1
    //   872: putfield 1632	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelId	I
    //   875: aload_0
    //   876: getfield 1635	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint64_channel_cover_article_id	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   879: invokevirtual 141	com/tencent/mobileqq/pb/PBUInt64Field:has	()Z
    //   882: ifeq +15 -> 897
    //   885: aload 4
    //   887: aload_0
    //   888: getfield 1635	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint64_channel_cover_article_id	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   891: invokevirtual 145	com/tencent/mobileqq/pb/PBUInt64Field:get	()J
    //   894: putfield 1636	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mArticleId	J
    //   897: aload_0
    //   898: getfield 1637	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_channel_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   901: invokevirtual 155	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   904: ifeq +15 -> 919
    //   907: aload 4
    //   909: aload_0
    //   910: getfield 1637	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_channel_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   913: invokevirtual 157	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   916: putfield 1640	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelType	I
    //   919: aload_0
    //   920: getfield 1643	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_is_topic	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   923: invokevirtual 155	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   926: ifeq +21 -> 947
    //   929: aload_0
    //   930: getfield 1643	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_is_topic	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   933: invokevirtual 157	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   936: ifle +133 -> 1069
    //   939: iconst_1
    //   940: istore_2
    //   941: aload 4
    //   943: iload_2
    //   944: putfield 1646	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mIsTopic	Z
    //   947: aload_0
    //   948: getfield 1649	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_is_external_expose	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   951: invokevirtual 155	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   954: ifeq +22 -> 976
    //   957: aload_0
    //   958: getfield 1649	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_is_external_expose	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   961: invokevirtual 157	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   964: iconst_1
    ...
    //   970: aload 4
    //   972: iload_2
    //   973: putfield 1652	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:isExternalExposure	Z
    //   976: aload_0
    //   977: getfield 1655	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_is_external_bg_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   980: invokevirtual 299	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   983: ifeq +18 -> 1001
    //   986: aload 4
    //   988: aload_0
    //   989: getfield 1655	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_is_external_bg_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   992: invokevirtual 191	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   995: invokevirtual 196	com/tencent/mobileqq/pb/ByteStringMicro:toStringUtf8	()Ljava/lang/String;
    //   998: putfield 1658	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:externalExposureBackgroundUrl	Ljava/lang/String;
    //   1001: aload_0
    //   1002: getfield 1661	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_has_recommend	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   1005: invokevirtual 155	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   1008: ifeq +22 -> 1030
    //   1011: aload_0
    //   1012: getfield 1661	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_has_recommend	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   1015: invokevirtual 157	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   1018: iconst_1
    ...
    //   1024: aload 4
    //   1026: iload_2
    //   1027: putfield 1664	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:isExternalExposurePersist	Z
    //   1030: aload 4
    //   1032: areturn
    //   1033: astore 5
    //   1035: ldc_w 1602
    //   1038: iconst_1
    //   1039: new 265	java/lang/StringBuilder
    //   1042: dup
    //   1043: invokespecial 266	java/lang/StringBuilder:<init>	()V
    //   1046: ldc_w 1666
    //   1049: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   1052: aload 5
    //   1054: invokevirtual 1605	java/lang/Exception:toString	()Ljava/lang/String;
    //   1057: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   1060: invokevirtual 278	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   1063: invokestatic 281	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   1066: goto -261 -> 805
    //   1069: iconst_0
    //   1070: istore_2
    //   1071: goto -130 -> 941
  ...
  public static TabChannelCoverInfo a(channel_button.Channel paramChannel)
  {
    ...
    {
      localTabChannelCoverInfo.redPoint = new TabChannelCoverInfo.a();
      if (paramChannel.msg_red_point.bool_red_point.has()) {
        localTabChannelCoverInfo.redPoint.isShow = paramChannel.msg_red_point.bool_red_point.get();
      }
      localTabChannelCoverInfo.redPoint.startTimestamp = paramChannel.msg_red_point.uint64_start_time.get();
      localTabChannelCoverInfo.redPoint.endTimestamp = paramChannel.msg_red_point.uint64_end_time.get();
      localTabChannelCoverInfo.redPoint.type = paramChannel.msg_red_point.uint32_type.get();
      if (paramChannel.msg_red_point.str_title_text.has()) {
        localTabChannelCoverInfo.redPoint.titleText = paramChannel.msg_red_point.str_title_text.get();
      }
      localTabChannelCoverInfo.redPoint.titleColor = paramChannel.msg_red_point.uint32_title_color.get();
      localTabChannelCoverInfo.redPoint.wP = paramChannel.msg_red_point.uint32_bg_color.get();
    }
  ...
  public static void a(ArticleInfo paramArticleInfo, articlesummary.FeedsInfo paramFeedsInfo)
  {
    ...
    if ((paramFeedsInfo.uint32_business_id.has()) && ((paramArticleInfo.mPolymericInfo == null) || (paramArticleInfo.mPolymericInfo.aRX != 9))) {
    ...
    if ((paramFeedsInfo.msg_social_feeds_info.has()) && (paramFeedsInfo.msg_social_feeds_info.get() != null))
    {
      ...
      if (paramArticleInfo.mSocialFeedInfo != null) {
        paramArticleInfo.mFeedId = paramArticleInfo.mSocialFeedInfo.mFeedId;
      }
    }
    if (((!paramFeedsInfo.msg_pos_ad_info.has()) || (paramFeedsInfo.msg_pos_ad_info.get() == null)) || ((paramFeedsInfo.msg_topic_recommend_feeds_info.has()) && (paramFeedsInfo.msg_topic_recommend_feeds_info.get() != null)))
    {
      ...
      paramArticleInfo.mTopicRecommendFeedsInfo = mih.a((articlesummary.TopicRecommendFeedsInfo)localObject);
    ...
    label385:
    for (long l = paramArticleInfo.mTopicRecommendFeedsInfo.feedsId;; l = 0L)
    {
      ...
      paramArticleInfo.mArkAppFeedsInfo = mgq.a(paramFeedsInfo);
      paramArticleInfo.mArkAppFeedsInfoBytes = paramFeedsInfo.toByteArray();
      paramArticleInfo.mFeedId = paramArticleInfo.mArkAppFeedsInfo.vd;
      return;
    }
  }
  ...
  public static List<InterestLabelInfo> b(List<oidb_cmd0x6e5.InterestLabelInfo> paramList, List<Integer> paramList1)
  {
    int j = 0;
    ArrayList localArrayList = new ArrayList();
    int i = j;
    ...
    else
    {
      while (i < bq.length)
      {
        ...
        paramList.mInterestLabelNme = bq[i];
        paramList.mInterestLabelID = c[i].intValue();
        paramList.mIsDefault = a[i].booleanValue();
  ...
  private static boolean b(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    for (;;)
    {
      ...
      if (paramTabChannelCoverInfo.bid > 0L)
      {
        ...
        try
        {
          paramTabChannelCoverInfo = ReadInJoyDynamicChannelBaseFragment.a(ReadInJoyDynamicChannelBaseFragment.bl(paramTabChannelCoverInfo.mChannelCoverId));
          if (paramTabChannelCoverInfo != null)
          {
            paramTabChannelCoverInfo = paramTabChannelCoverInfo.a();
            if (paramTabChannelCoverInfo != null)
            {
              paramTabChannelCoverInfo = paramTabChannelCoverInfo.eG("cgi");
  ...
  public static void cF(List<ArticleInfo> paramList)
  {
    if ((paramList == null) || (paramList.size() <= 0)) {}
    for (;;)
    {
      ...
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        kxm.a((ArticleInfo)paramList.next());
      }
    }
  }
  
  private static void h(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    String str = ReadInJoyDynamicChannelBaseFragment.bl(paramTabChannelCoverInfo.mChannelCoverId);
    npl.bM(str, String.valueOf(paramTabChannelCoverInfo.bid));
    npl.ou(str);
    try
    {
  ...
  public static ArrayList<ArticleInfo> o(List<oidb_cmd0x68b.RspGetFollowTabFeeds> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    while (paramList.hasNext())
