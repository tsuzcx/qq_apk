...
public class adwc
{
  ...
  private static int a(Context paramContext, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    //   6: lstore 5
    //   8: new 69	com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer$a
    //   11: dup
    //   12: invokespecial 70	com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer$a:<init>	()V
    //   15: astore 9
    //   17: aload 9
    //   19: iload_3
    //   20: putfield 73	com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer$a:dJo	I
    //   23: aload 9
    //   25: iload_3
    //   26: putfield 76	com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer$a:dJp	I
    //   29: aload 9
    //   31: ldc 78
    //   33: putfield 81	com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer$a:rotate	Ljava/lang/String;
    //   36: aload 9
    //   38: iload 4
    //   40: putfield 84	com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer$a:dJq	I
    //   43: aload_1
    //   44: aload_2
    //   45: aload 9
    //   47: invokestatic 87	adwc:a	(Ljava/lang/String;Ljava/lang/String;Lcom/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer$a;)[Ljava/lang/String;
    //   50: astore_1
    //   51: aload_1
    //   52: ifnonnull +8 -> 60
    //   55: ldc 89
    //   57: invokestatic 91	adwc:GY	(Ljava/lang/String;)V
    //   60: aload_0
    //   61: invokestatic 97	com/tencent/video/decode/ShortVideoSoLoad:getShortVideoSoPath	(Landroid/content/Context;)Ljava/lang/String;
    //   64: astore_0
    //   65: invokestatic 103	com/tencent/mobileqq/shortvideo/VideoEnvironment:zQ	()Ljava/lang/String;
    //   68: astore 9
    ...
    //   99: invokestatic 91	adwc:GY	(Ljava/lang/String;)V
    //   102: new 119	java/lang/ProcessBuilder
    //   105: dup
    //   106: iconst_0
    //   107: anewarray 121	java/lang/String
    //   110: invokespecial 124	java/lang/ProcessBuilder:<init>	([Ljava/lang/String;)V
    //   113: astore 10
    //   115: aload 10
    //   117: iconst_1
    //   118: invokevirtual 128	java/lang/ProcessBuilder:redirectErrorStream	(Z)Ljava/lang/ProcessBuilder;
    //   121: pop
    //   122: new 130	java/util/ArrayList
    //   125: dup
    //   126: invokespecial 131	java/util/ArrayList:<init>	()V
    //   129: astore 12
    //   131: aload 12
    //   133: new 105	java/lang/StringBuilder
    //   136: dup
    ...
    //   144: ldc 133
    //   146: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   149: invokevirtual 117	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   152: invokeinterface 139 2 0
    //   157: pop
    //   158: new 105	java/lang/StringBuilder
    //   161: dup
    //   162: invokespecial 106	java/lang/StringBuilder:<init>	()V
    //   165: ldc 141
    //   167: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   170: aload 12
    //   172: iconst_0
    //   173: invokeinterface 145 2 0
    //   178: checkcast 121	java/lang/String
    //   181: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   184: invokevirtual 117	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   187: invokestatic 91	adwc:GY	(Ljava/lang/String;)V
    //   190: aload_1
    //   191: arraylength
    //   192: istore 4
    //   194: iconst_0
    ...
    //   225: dup
    //   226: invokespecial 106	java/lang/StringBuilder:<init>	()V
    //   229: aload_0
    ...
    //   238: invokevirtual 117	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   241: invokeinterface 139 2 0
    //   246: pop
    //   247: aload 10
    //   249: aload 12
    //   251: invokevirtual 149	java/lang/ProcessBuilder:command	(Ljava/util/List;)Ljava/lang/ProcessBuilder;
    //   254: pop
    //   255: new 105	java/lang/StringBuilder
    //   258: dup
    //   259: invokespecial 106	java/lang/StringBuilder:<init>	()V
    //   262: ldc 151
    //   264: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   267: aload 12
    //   269: aload 12
    //   271: invokeinterface 155 1 0
    //   276: iconst_1
    //   277: isub
    //   278: invokeinterface 145 2 0
    //   283: checkcast 121	java/lang/String
    ...
    //   292: invokestatic 91	adwc:GY	(Ljava/lang/String;)V
    //   295: aload 10
    //   297: invokevirtual 159	java/lang/ProcessBuilder:start	()Ljava/lang/Process;
    //   300: astore 13
    //   302: aload 13
    //   304: invokevirtual 165	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   307: astore_0
    //   308: new 167	java/io/InputStreamReader
    //   311: dup
    //   312: aload_0
    //   313: invokespecial 170	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   316: astore_1
    //   317: new 172	java/io/BufferedReader
    //   320: dup
    //   321: aload_1
    //   322: invokespecial 175	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   325: astore 12
    //   327: aload 12
    //   329: astore 11
    //   331: aload_1
    ...
    //   335: astore 9
    //   337: aload 13
    //   339: invokevirtual 178	java/lang/Process:waitFor	()I
    //   342: pop
    //   343: aload 12
    //   345: astore 11
    //   347: aload_1
    ...
    //   351: astore 9
    //   353: aload 13
    //   355: invokevirtual 181	java/lang/Process:exitValue	()I
    //   358: istore 4
    //   360: aload 12
    //   362: astore 11
    //   364: aload_1
    ...
    //   367: aload_0
    //   368: astore 9
    //   370: new 105	java/lang/StringBuilder
    //   373: dup
    //   374: invokespecial 106	java/lang/StringBuilder:<init>	()V
    //   377: ldc 183
    //   379: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   382: iload 4
    //   384: invokevirtual 186	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   387: invokevirtual 117	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   390: invokestatic 91	adwc:GY	(Ljava/lang/String;)V
    //   393: aload 12
    //   395: astore 11
    //   397: aload_1
    //   398: astore 10
    ...
    //   401: astore 9
    //   403: aload 12
    //   405: invokevirtual 189	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   408: astore 14
    //   410: aload 14
    //   412: ifnull +218 -> 630
    //   415: aload 12
    ...
    //   432: ldc 191
    //   434: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   437: aload 14
    //   439: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   442: invokevirtual 117	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   445: invokestatic 91	adwc:GY	(Ljava/lang/String;)V
    //   448: goto -55 -> 393
    //   451: astore 13
    //   453: sipush -1001
    //   456: istore 4
    ...
    //   466: astore 9
    //   468: aload 13
    //   470: invokevirtual 194	java/io/IOException:printStackTrace	()V
    //   473: aload 12
    //   475: astore 11
    //   477: aload_1
    //   478: astore 10
    //   480: aload_0
    //   481: astore 9
    //   483: new 105	java/lang/StringBuilder
    //   486: dup
    //   487: invokespecial 106	java/lang/StringBuilder:<init>	()V
    //   490: ldc 196
    //   492: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   495: aload 13
    //   497: invokevirtual 197	java/io/IOException:toString	()Ljava/lang/String;
    //   500: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   503: invokevirtual 117	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   506: invokestatic 91	adwc:GY	(Ljava/lang/String;)V
    //   509: aload_0
    //   510: ifnull +7 -> 517
    //   513: aload_0
    //   514: invokevirtual 202	java/io/InputStream:close	()V
    //   517: aload_1
    //   518: ifnull +7 -> 525
    //   521: aload_1
    //   522: invokevirtual 203	java/io/InputStreamReader:close	()V
    //   525: iload 4
    //   527: istore_3
    //   528: aload 12
    //   530: ifnull +11 -> 541
    //   533: aload 12
    //   535: invokevirtual 204	java/io/BufferedReader:close	()V
    //   538: iload 4
    //   540: istore_3
    //   541: invokestatic 41	java/lang/System:currentTimeMillis	()J
    //   544: lstore 7
    //   546: new 105	java/lang/StringBuilder
    //   549: dup
    //   550: invokespecial 106	java/lang/StringBuilder:<init>	()V
    //   553: ldc 206
    //   555: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   558: lload 7
    //   560: lload 5
    //   562: lsub
    //   563: invokevirtual 209	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   566: ldc 211
    //   568: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   571: iload_3
    //   572: invokevirtual 186	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   575: invokevirtual 117	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   578: invokestatic 91	adwc:GY	(Ljava/lang/String;)V
    //   581: iload_3
    //   582: ifeq +46 -> 628
    //   585: new 213	java/io/File
    //   588: dup
    //   589: aload_2
    //   590: invokespecial 215	java/io/File:<init>	(Ljava/lang/String;)V
    //   593: astore_0
    //   594: aload_0
    //   595: invokevirtual 218	java/io/File:exists	()Z
    //   598: ifeq +30 -> 628
    //   601: aload_0
    //   602: invokevirtual 221	java/io/File:delete	()Z
    //   605: pop
    //   606: new 105	java/lang/StringBuilder
    //   609: dup
    //   610: invokespecial 106	java/lang/StringBuilder:<init>	()V
    //   613: ldc 223
    //   615: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   618: iload_3
    //   619: invokevirtual 186	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   622: invokevirtual 117	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   625: invokestatic 91	adwc:GY	(Ljava/lang/String;)V
    //   628: iload_3
    //   629: ireturn
    //   630: aload 12
    //   632: astore 11
    ...
    //   638: astore 9
    //   640: aload 13
    //   642: invokevirtual 226	java/lang/Process:destroy	()V
    //   645: aload 12
    //   647: astore 11
    //   649: aload_1
    //   650: astore 10
    ...
    //   653: astore 9
    //   655: ldc 228
    //   657: invokestatic 91	adwc:GY	(Ljava/lang/String;)V
    //   660: aload_0
    //   661: ifnull +7 -> 668
    //   664: aload_0
    //   665: invokevirtual 202	java/io/InputStream:close	()V
    //   668: aload_1
    //   669: ifnull +7 -> 676
    //   672: aload_1
    //   673: invokevirtual 203	java/io/InputStreamReader:close	()V
    //   676: iload 4
    //   678: istore_3
    //   679: aload 12
    //   681: ifnull -140 -> 541
    //   684: aload 12
    //   686: invokevirtual 204	java/io/BufferedReader:close	()V
    //   689: iload 4
    //   691: istore_3
    //   692: goto -151 -> 541
    //   695: astore_0
    ...
    //   724: astore 9
    //   726: aload 13
    //   728: invokevirtual 229	java/lang/InterruptedException:printStackTrace	()V
    //   731: aload 12
    //   733: astore 11
    //   735: aload_1
    //   736: astore 10
    //   738: aload_0
    //   739: astore 9
    //   741: new 105	java/lang/StringBuilder
    //   744: dup
    //   745: invokespecial 106	java/lang/StringBuilder:<init>	()V
    //   748: ldc 231
    //   750: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   753: aload 13
    //   755: invokevirtual 232	java/lang/InterruptedException:toString	()Ljava/lang/String;
    //   758: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   761: invokevirtual 117	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   764: invokestatic 91	adwc:GY	(Ljava/lang/String;)V
    //   767: aload_0
    //   768: ifnull +7 -> 775
    //   771: aload_0
    //   772: invokevirtual 202	java/io/InputStream:close	()V
    //   775: aload_1
    //   776: ifnull +7 -> 783
    //   779: aload_1
    //   780: invokevirtual 203	java/io/InputStreamReader:close	()V
    //   783: iload 4
    //   785: istore_3
    //   786: aload 12
    //   788: ifnull -247 -> 541
    //   791: aload 12
    //   793: invokevirtual 204	java/io/BufferedReader:close	()V
    //   796: iload 4
    //   798: istore_3
    //   799: goto -258 -> 541
    //   802: astore_0
    ...
    //   831: astore 9
    //   833: aload 13
    //   835: invokevirtual 233	java/lang/Exception:printStackTrace	()V
    //   838: aload 12
    //   840: astore 11
    //   842: aload_1
    //   843: astore 10
    //   845: aload_0
    //   846: astore 9
    //   848: new 105	java/lang/StringBuilder
    //   851: dup
    //   852: invokespecial 106	java/lang/StringBuilder:<init>	()V
    //   855: ldc 235
    //   857: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   860: aload 13
    //   862: invokevirtual 236	java/lang/Exception:toString	()Ljava/lang/String;
    //   865: invokevirtual 112	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   868: invokevirtual 117	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   871: invokestatic 91	adwc:GY	(Ljava/lang/String;)V
    //   874: aload_0
    //   875: ifnull +7 -> 882
    //   878: aload_0
    //   879: invokevirtual 202	java/io/InputStream:close	()V
    //   882: aload_1
    //   883: ifnull +7 -> 890
    //   886: aload_1
    //   887: invokevirtual 203	java/io/InputStreamReader:close	()V
    //   890: iload 4
    //   892: istore_3
    //   893: aload 12
    //   895: ifnull -354 -> 541
    //   898: aload 12
    //   900: invokevirtual 204	java/io/BufferedReader:close	()V
    //   903: iload 4
    //   905: istore_3
    //   906: goto -365 -> 541
    //   909: astore_0
    ...
    //   922: ifnull +7 -> 929
    //   925: aload_0
    //   926: invokevirtual 202	java/io/InputStream:close	()V
    //   929: aload_1
    //   930: ifnull +7 -> 937
    //   933: aload_1
    //   934: invokevirtual 203	java/io/InputStreamReader:close	()V
    //   937: aload 11
    //   939: ifnull +8 -> 947
    //   942: aload 11
    //   944: invokevirtual 204	java/io/BufferedReader:close	()V
    //   947: aload_2
    //   948: athrow
    //   949: astore_0
    //   950: iload_3
  ...
  public static int a(String paramString1, String paramString2, int paramInt1, Context paramContext, int paramInt2)
  {
    ...
    {
      ShortVideoTrimmer.a locala = ShortVideoTrimmer.a(paramString1);
      locala.dJo = paramInt1;
      locala.dJp = paramInt1;
      if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    localaool.dQ = paramString;
    localaool.mUniseq = System.currentTimeMillis();
    localaool.mFileType = paramInt1;
    paramString = new ime();
    paramString.WriteUInt32(paramInt2);
    paramString.WriteUInt32(paramInt3);
    localaool.gb = paramString.Data();
    paramQQAppInterface.a().a(localaool);
  }
  
  private static String[] a(String paramString1, String paramString2, ShortVideoTrimmer.a parama)
  {
    String str1 = "1";
  ...
  public static Bitmap c(int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
  ...
  public static Bitmap j(Bitmap paramBitmap, int paramInt1, int paramInt2)
  {
