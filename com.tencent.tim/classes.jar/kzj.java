...
{
  private final String adR = "reset_kandian_configuration";
  private final String adS = "reset_version";
    ...
    for (;;)
    {
      ...
      if (TextUtils.equals(str, "reset_version"))
      {
        ...
        try
        {
          ...
          aqmj.C(BaseApplicationImpl.getApplication(), paramInt1, kxm.getAccount());
          return true;
        }
