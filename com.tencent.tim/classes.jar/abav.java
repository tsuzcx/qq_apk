...
public class abav
  extends Handler
{
  public abav(QQSpecialCareSettingActivity paramQQSpecialCareSettingActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              QQSpecialCareSettingActivity.a(this.a, new arhz(this.a, this.a.getTitleBarHeight()));
              if ((paramMessage.obj != null) && ((paramMessage.obj instanceof String))) {
                QQSpecialCareSettingActivity.a(this.a).setMessage((String)paramMessage.obj);
              }
            }
    ...
    QQSpecialCareSettingActivity.a(this.a, QQToast.a(this.a, paramMessage.arg1, paramMessage.arg2, 0).show(this.a.getTitleBarHeight()));
  }
}
