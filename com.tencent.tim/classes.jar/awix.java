...
public class awix
{
  ...
  public static void a(Context paramContext, int paramInt1, int paramInt2, Bundle paramBundle, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      continue;
      ntp.b(paramContext, paramInt2, localBundle);
    }
  }
  ...
  private static int d(int paramInt, float paramFloat)
  {
  ...
  public static void f(Context paramContext, HashMap<String, String> paramHashMap)
  {
    int n = 0;
  ...
  private static int ly(int paramInt)
  {
