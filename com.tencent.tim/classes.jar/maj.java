...
public class maj
  extends lwm
{
  public maj(Context paramContext, aqdf paramaqdf, ndi paramndi)
  {
  ...
  {
    this.alM = true;
    return d(this.d, this.c).q().l().g().n().j();
  }
  ...
  public lwm p()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentContentUgcOriginalHeader != null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentContentUgcOriginalHeader.a(this.jdField_a_of_type_Lwm$a);
    }
    return this;
  }
}
