...
public class aafx
{
  ...
  private static boolean changeMeizuFlag(WindowManager.LayoutParams paramLayoutParams, java.lang.String paramString, boolean paramBoolean)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 79	java/lang/Object:getClass	()Ljava/lang/Class;
    //   4: aload_1
    //   5: invokevirtual 82	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   8: astore_1
    //   9: aload_1
    //   10: iconst_1
    //   11: invokevirtual 86	java/lang/reflect/Field:setAccessible	(Z)V
    //   14: aload_1
    //   15: aload_0
    //   16: invokevirtual 61	java/lang/reflect/Field:getInt	(Ljava/lang/Object;)I
    //   19: istore_3
    //   20: aload_0
    //   21: invokevirtual 79	java/lang/Object:getClass	()Ljava/lang/Class;
    //   24: ldc 88
    //   26: invokevirtual 82	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   29: astore_1
    //   30: aload_1
    //   31: iconst_1
    //   32: invokevirtual 86	java/lang/reflect/Field:setAccessible	(Z)V
    //   35: aload_1
    //   36: aload_0
    ...
    //   58: aload_0
    //   59: iload_3
    //   60: invokevirtual 92	java/lang/reflect/Field:setInt	(Ljava/lang/Object;I)V
    //   63: iconst_1
    //   64: ireturn
    //   65: iload_3
    //   66: iconst_m1
    ...
    //   75: astore_0
    //   76: aload_0
    //   77: invokevirtual 67	java/lang/NoSuchFieldException:printStackTrace	()V
    //   80: iconst_0
    //   81: ireturn
    //   82: astore_0
    //   83: aload_0
    //   84: invokevirtual 68	java/lang/IllegalAccessException:printStackTrace	()V
    //   87: goto -7 -> 80
    //   90: astore_0
    //   91: aload_0
    //   92: invokevirtual 93	java/lang/IllegalArgumentException:printStackTrace	()V
    //   95: goto -15 -> 80
    //   98: astore_0
    //   99: aload_0
    //   100: invokevirtual 94	java/lang/Throwable:printStackTrace	()V
    //   103: goto -23 -> 80
