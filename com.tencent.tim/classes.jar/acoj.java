...
public class acoj
  extends FullCache
{
  public acoj(QQAppInterface paramQQAppInterface, DBDelayManager paramDBDelayManager)
  {
  ...
  {
    return (RoamDate)findCache(g(paramString, paramInt1, paramInt2));
  }
  
  public RoamDate a(String paramString1, String paramString2)
  {
    return (RoamDate)findCache(getKey(paramString1, paramString2));
  }
  ...
  public Calendar a(String paramString, Calendar paramCalendar, List<Map.Entry<String, Entity>> paramList)
  {
    ...
    if (!((List)localObject1).isEmpty())
    {
      ...
      if (!((String)((Map.Entry)((List)localObject1).get(i)).getKey()).equals(g(paramString, j, k + 1))) {
        break label250;
      }
    }
    for (;;)
  ...
  public boolean a(String paramString, Calendar paramCalendar, List<Map.Entry<String, Entity>> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (i < paramList.size())
      {
        if ((((String)((Map.Entry)paramList.get(i)).getKey()).equals(g(paramString, j, k + 1))) && (a((RoamDate)((Map.Entry)paramList.get(i)).getValue(), m - 1))) {
          bool1 = true;
        }
      }
      else {
  ...
  public void b(long paramLong, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    RoamDate localRoamDate = a(String.valueOf(paramLong), paramInt1, paramInt2);
    if (localRoamDate == null) {
      localRoamDate = new RoamDate(String.valueOf(paramLong), C(paramInt1, paramInt2), paramInt3, paramInt4);
    }
    for (;;)
    {
      a(localRoamDate);
  ...
  public void c(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
  ...
  public List<Map.Entry<String, Entity>> ej()
  {
    ArrayList localArrayList = new ArrayList(this.cacheMap.entrySet());
    Collections.sort(localArrayList, new acok(this));
    return localArrayList;
  }
  
  public String g(String paramString, int paramInt1, int paramInt2)
  {
    return paramString + "&" + C(paramInt1, paramInt2);
  }
  ...
  public Pair<Calendar, Calendar> n()
  {
    Object localObject2 = ej();
  ...
  public void n(String paramString, long paramLong, int paramInt)
  {
    ...
    if (localRoamDate == null) {
      localObject = new RoamDate(paramString, C(i, j));
    }
    ((RoamDate)localObject).setSerState(k - 1, paramInt);
    a((RoamDate)localObject);
  }
  
  public void o(String paramString, long paramLong, int paramInt)
  {
    Object localObject = Calendar.getInstance();
    ((Calendar)localObject).setTimeInMillis((5L + paramLong) * 1000L);
    int i = ((Calendar)localObject).get(1);
