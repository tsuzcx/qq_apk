  ...
  extends OverScroller
{
  ...
  public ajiy(Context paramContext)
  {
    super(paramContext);
  }
  
  public void a(ajiy.a parama)
  {
    this.a = parama;
  }
  ...
  public boolean springBack(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    ...
    if (this.a != null) {
      this.a.springBack(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6);
    }
  ...
  {
    public abstract boolean springBack(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6);
  }
}
