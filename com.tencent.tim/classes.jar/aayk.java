...
public class aayk
  extends acfd
{
  public aayk(TroopAddFrdsInnerFrame paramTroopAddFrdsInnerFrame) {}
  ...
  public void onAddBatchTroopFrd(boolean paramBoolean, String paramString, ArrayList<cmd0x777.AddFrdInfo> paramArrayList)
  {
    ...
    do
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        this.this$0.a.runOnUiThread(new TroopAddFrdsInnerFrame.1.1(this, paramArrayList));
    ...
    paramArrayList = this.this$0.mSubHandler.obtainMessage(9);
  ...
  protected void onAddFriend(String paramString)
  {
    ...
    paramString = this.this$0.mSubHandler.obtainMessage(9);
