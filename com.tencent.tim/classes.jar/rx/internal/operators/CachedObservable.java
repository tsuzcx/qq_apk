  ...
  extends Observable<T>
{
    ...
    implements Producer, Subscription
  {
    ...
    public void replay()
    {
      ...
      //   72: istore_1
      //   73: aload_0
      //   74: getfield 39	rx/internal/operators/CachedObservable$ReplayProducer:state	Lrx/internal/operators/CachedObservable$CacheState;
      //   77: invokevirtual 70	rx/internal/operators/CachedObservable$CacheState:size	()I
      //   80: istore 9
      //   82: iload 9
      //   84: ifeq +369 -> 453
      //   87: iload 6
      //   89: istore_1
      //   90: aload_0
      //   91: getfield 72	rx/internal/operators/CachedObservable$ReplayProducer:currentBuffer	[Ljava/lang/Object;
      //   94: astore 14
      //   96: aload 14
      //   98: astore 13
      //   100: aload 14
      ...
      //   107: istore_1
      //   108: aload_0
      //   109: getfield 39	rx/internal/operators/CachedObservable$ReplayProducer:state	Lrx/internal/operators/CachedObservable$CacheState;
      //   112: invokevirtual 76	rx/internal/operators/CachedObservable$CacheState:head	()[Ljava/lang/Object;
      //   115: astore 13
      //   117: iload 6
      //   119: istore_1
      //   120: aload_0
      //   121: aload 13
      //   123: putfield 72	rx/internal/operators/CachedObservable$ReplayProducer:currentBuffer	[Ljava/lang/Object;
      //   126: iload 6
      //   128: istore_1
      //   129: aload 13
      //   131: arraylength
      ...
      //   138: istore_1
      //   139: aload_0
      //   140: getfield 78	rx/internal/operators/CachedObservable$ReplayProducer:index	I
      //   143: istore 5
      //   145: iload 6
      //   147: istore_1
      //   148: aload_0
      //   149: getfield 80	rx/internal/operators/CachedObservable$ReplayProducer:currentIndexInBuffer	I
      //   152: istore_2
      //   153: lload 11
      //   155: lconst_0
      //   156: lcmp
      ...
      //   169: aload 15
      //   171: aload 13
      //   173: invokevirtual 86	rx/internal/operators/NotificationLite:isCompleted	(Ljava/lang/Object;)Z
      //   176: ifeq +43 -> 219
      //   179: iload 6
      //   181: istore_1
      //   182: aload 16
      //   184: invokevirtual 91	rx/Subscriber:onCompleted	()V
      //   187: iconst_1
      //   188: istore_1
      //   189: aload_0
      //   190: invokevirtual 94	rx/internal/operators/CachedObservable$ReplayProducer:unsubscribe	()V
      //   193: return
      //   194: astore 13
      //   196: iload_1
      //   197: ifne +12 -> 209
      ...
      //   202: aload_0
      //   203: iconst_0
      //   204: putfield 58	rx/internal/operators/CachedObservable$ReplayProducer:emitting	Z
      //   207: aload_0
      //   208: monitorexit
      //   209: aload 13
      //   211: athrow
      ...
      //   222: aload 15
      //   224: aload 13
      //   226: invokevirtual 97	rx/internal/operators/NotificationLite:isError	(Ljava/lang/Object;)Z
      //   229: ifeq +224 -> 453
      //   232: iload 6
      //   234: istore_1
      //   235: aload 16
      //   237: aload 15
      //   239: aload 13
      //   241: invokevirtual 101	rx/internal/operators/NotificationLite:getError	(Ljava/lang/Object;)Ljava/lang/Throwable;
      //   244: invokevirtual 105	rx/Subscriber:onError	(Ljava/lang/Throwable;)V
      //   247: iconst_1
      //   248: istore_1
      //   249: aload_0
      //   250: invokevirtual 94	rx/internal/operators/CachedObservable$ReplayProducer:unsubscribe	()V
      //   253: return
      //   254: iload 5
      //   256: iload 9
      ...
      //   270: istore_1
      //   271: aload 16
      //   273: invokevirtual 107	rx/Subscriber:isUnsubscribed	()Z
      //   276: ifne +235 -> 511
      //   279: iload_2
      //   280: istore 4
      //   282: aload 14
      ...
      //   297: iload 10
      //   299: aaload
      //   300: checkcast 108	[Ljava/lang/Object;
      //   303: checkcast 108	[Ljava/lang/Object;
      //   306: astore 13
      //   308: iconst_0
      //   309: istore 4
      //   311: aload 13
      ...
      //   326: aload 16
      //   328: aload 14
      //   330: invokevirtual 112	rx/internal/operators/NotificationLite:accept	(Lrx/Observer;Ljava/lang/Object;)Z
      //   333: ifeq +195 -> 528
      //   336: iconst_1
      //   337: istore_2
      //   338: iconst_1
      //   339: istore_1
      //   340: aload_0
      //   341: invokevirtual 94	rx/internal/operators/CachedObservable$ReplayProducer:unsubscribe	()V
      //   344: return
      //   345: astore 13
      //   347: iload_2
      //   348: istore_1
      //   349: aload 13
      //   351: invokestatic 117	rx/exceptions/Exceptions:throwIfFatal	(Ljava/lang/Throwable;)V
      //   354: iconst_1
      //   355: istore_2
      //   356: iload_2
      //   357: istore_1
      //   358: aload_0
      //   359: invokevirtual 94	rx/internal/operators/CachedObservable$ReplayProducer:unsubscribe	()V
      //   362: iload_2
      //   363: istore_1
      //   364: aload 15
      //   366: aload 14
      //   368: invokevirtual 97	rx/internal/operators/NotificationLite:isError	(Ljava/lang/Object;)Z
      //   371: ifne +140 -> 511
      //   374: iload_2
      //   375: istore_1
      //   376: aload 15
      //   378: aload 14
      //   380: invokevirtual 86	rx/internal/operators/NotificationLite:isCompleted	(Ljava/lang/Object;)Z
      //   383: ifne +128 -> 511
      //   386: iload_2
      //   387: istore_1
      //   388: aload 16
      ...
      //   392: aload 15
      //   394: aload 14
      //   396: invokevirtual 121	rx/internal/operators/NotificationLite:getValue	(Ljava/lang/Object;)Ljava/lang/Object;
      //   399: invokestatic 127	rx/exceptions/OnErrorThrowable:addValueAsLastCause	(Ljava/lang/Throwable;Ljava/lang/Object;)Ljava/lang/Throwable;
      //   402: invokevirtual 105	rx/Subscriber:onError	(Ljava/lang/Throwable;)V
      //   405: return
      //   406: iload 6
      //   408: istore_1
      //   409: aload 16
      //   411: invokevirtual 107	rx/Subscriber:isUnsubscribed	()Z
      //   414: ifne +97 -> 511
      //   417: iload 6
      //   419: istore_1
      //   420: aload_0
      //   421: iload 5
      //   423: putfield 78	rx/internal/operators/CachedObservable$ReplayProducer:index	I
      //   426: iload 6
      //   428: istore_1
      //   429: aload_0
      //   430: iload_2
      //   431: putfield 80	rx/internal/operators/CachedObservable$ReplayProducer:currentIndexInBuffer	I
      //   434: iload 6
      //   436: istore_1
      //   437: aload_0
      //   438: aload 14
      //   440: putfield 72	rx/internal/operators/CachedObservable$ReplayProducer:currentBuffer	[Ljava/lang/Object;
      //   443: iload 6
      //   445: istore_1
      //   446: aload_0
      //   447: iload_3
      //   448: i2l
      //   449: invokevirtual 129	rx/internal/operators/CachedObservable$ReplayProducer:produced	(J)J
      //   452: pop2
      //   453: iload 6
      //   455: istore_1
      //   456: aload_0
      ...
      //   460: istore_1
      //   461: aload_0
      //   462: getfield 60	rx/internal/operators/CachedObservable$ReplayProducer:missed	Z
      //   465: ifne +23 -> 488
      //   468: iload 8
      //   470: istore_1
      //   471: aload_0
      //   472: iconst_0
      //   473: putfield 58	rx/internal/operators/CachedObservable$ReplayProducer:emitting	Z
      //   476: iconst_1
      //   477: istore_1
      //   478: aload_0
      //   479: monitorexit
      ...
      //   491: aload_0
      //   492: iconst_0
      //   493: putfield 60	rx/internal/operators/CachedObservable$ReplayProducer:missed	Z
      //   496: iload 8
      //   498: istore_1
      //   499: aload_0
      //   500: monitorexit
      ...
      //   345	46	13	localThrowable	Throwable
