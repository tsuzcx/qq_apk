  ...
  extends ConnectableObservable<T>
{
    ...
    implements Subscription
  {
    ...
    void dispatch()
    {
      ...
      //   1: monitorenter
      //   2: aload_0
      //   3: getfield 144	rx/internal/operators/OperatorPublish$PublishSubscriber:emitting	Z
      //   6: ifeq +11 -> 17
      //   9: aload_0
      //   10: iconst_1
      //   11: putfield 146	rx/internal/operators/OperatorPublish$PublishSubscriber:missed	Z
      //   14: aload_0
      //   15: monitorexit
      //   16: return
      //   17: aload_0
      //   18: iconst_1
      //   19: putfield 144	rx/internal/operators/OperatorPublish$PublishSubscriber:emitting	Z
      //   22: aload_0
      //   23: iconst_0
      //   24: putfield 146	rx/internal/operators/OperatorPublish$PublishSubscriber:missed	Z
      //   27: aload_0
      //   28: monitorexit
      //   29: iconst_0
      //   30: istore 4
      //   32: aload_0
      //   33: getfield 148	rx/internal/operators/OperatorPublish$PublishSubscriber:terminalEvent	Ljava/lang/Object;
      //   36: astore 14
      //   38: aload_0
      //   39: getfield 63	rx/internal/operators/OperatorPublish$PublishSubscriber:queue	Ljava/util/Queue;
      //   42: invokeinterface 153 1 0
      //   47: istore 7
      //   49: aload_0
      //   50: aload 14
      //   52: iload 7
      //   54: invokevirtual 155	rx/internal/operators/OperatorPublish$PublishSubscriber:checkTerminated	(Ljava/lang/Object;Z)Z
      //   57: ifne +410 -> 467
      //   60: iload 7
      //   62: ifne +250 -> 312
      //   65: aload_0
      //   66: getfield 78	rx/internal/operators/OperatorPublish$PublishSubscriber:producers	Ljava/util/concurrent/atomic/AtomicReference;
      //   69: invokevirtual 99	java/util/concurrent/atomic/AtomicReference:get	()Ljava/lang/Object;
      //   72: checkcast 100	[Lrx/internal/operators/OperatorPublish$InnerProducer;
      //   75: astore 14
      //   77: aload 14
      //   79: arraylength
      //   80: istore 5
      ...
      //   104: iload_1
      //   105: aaload
      //   106: invokevirtual 160	rx/internal/operators/OperatorPublish$InnerProducer:get	()J
      //   109: lstore 12
      //   111: lload 12
      //   113: lconst_0
      //   114: lcmp
      ...
      //   118: lload 8
      //   120: lload 12
      //   122: invokestatic 166	java/lang/Math:min	(JJ)J
      //   125: lstore 10
      //   127: iload_2
      //   128: istore_3
      //   129: iload_1
      ...
      //   181: aload_0
      //   182: getfield 148	rx/internal/operators/OperatorPublish$PublishSubscriber:terminalEvent	Ljava/lang/Object;
      //   185: astore 14
      //   187: aload_0
      //   188: getfield 63	rx/internal/operators/OperatorPublish$PublishSubscriber:queue	Ljava/util/Queue;
      //   191: invokeinterface 171 1 0
      ...
      //   203: aload 14
      //   205: iload 7
      //   207: invokevirtual 155	rx/internal/operators/OperatorPublish$PublishSubscriber:checkTerminated	(Ljava/lang/Object;Z)Z
      //   210: ifne +257 -> 467
      //   213: aload_0
      //   214: lconst_1
      //   215: invokevirtual 175	rx/internal/operators/OperatorPublish$PublishSubscriber:request	(J)V
      //   218: goto -186 -> 32
      //   221: astore 14
      //   223: iload 4
      //   225: istore_1
      ...
      //   232: aload_0
      //   233: iconst_0
      //   234: putfield 144	rx/internal/operators/OperatorPublish$PublishSubscriber:emitting	Z
      //   237: aload_0
      //   238: monitorexit
      //   239: aload 14
      //   241: athrow
      ...
      //   255: ifge +209 -> 464
      //   258: aload_0
      //   259: getfield 148	rx/internal/operators/OperatorPublish$PublishSubscriber:terminalEvent	Ljava/lang/Object;
      //   262: astore 15
      //   264: aload_0
      //   265: getfield 63	rx/internal/operators/OperatorPublish$PublishSubscriber:queue	Ljava/util/Queue;
      ...
      //   284: aload 15
      //   286: iload 7
      //   288: invokevirtual 155	rx/internal/operators/OperatorPublish$PublishSubscriber:checkTerminated	(Ljava/lang/Object;Z)Z
      //   291: ifne +176 -> 467
      //   294: iload 7
      //   296: ifeq +53 -> 349
      //   299: iload_1
      ...
      //   304: iload_1
      //   305: i2l
      //   306: invokevirtual 175	rx/internal/operators/OperatorPublish$PublishSubscriber:request	(J)V
      //   309: goto +159 -> 468
      //   312: aload_0
      //   313: monitorenter
      //   314: aload_0
      //   315: getfield 146	rx/internal/operators/OperatorPublish$PublishSubscriber:missed	Z
      //   318: ifne +122 -> 440
      //   321: aload_0
      //   322: iconst_0
      //   323: putfield 144	rx/internal/operators/OperatorPublish$PublishSubscriber:emitting	Z
      //   326: iconst_1
      //   327: istore_2
      //   328: aload_0
      //   329: monitorexit
      ...
      //   346: goto -63 -> 283
      //   349: aload_0
      //   350: getfield 71	rx/internal/operators/OperatorPublish$PublishSubscriber:nl	Lrx/internal/operators/NotificationLite;
      //   353: aload 16
      //   355: invokevirtual 178	rx/internal/operators/NotificationLite:getValue	(Ljava/lang/Object;)Ljava/lang/Object;
      //   358: astore 15
      //   360: aload 14
      //   362: arraylength
      //   363: istore_3
      ...
      //   375: astore 16
      //   377: aload 16
      //   379: invokevirtual 160	rx/internal/operators/OperatorPublish$InnerProducer:get	()J
      //   382: lstore 10
      //   384: lload 10
      //   386: lconst_0
      //   387: lcmp
      //   388: ifle +102 -> 490
      //   391: aload 16
      //   393: getfield 125	rx/internal/operators/OperatorPublish$InnerProducer:child	Lrx/Subscriber;
      //   396: aload 15
      //   398: invokevirtual 181	rx/Subscriber:onNext	(Ljava/lang/Object;)V
      //   401: aload 16
      //   403: lconst_1
      //   404: invokevirtual 185	rx/internal/operators/OperatorPublish$InnerProducer:produced	(J)J
      //   407: pop2
      //   408: goto +82 -> 490
      //   411: astore 17
      //   413: aload 16
      //   415: invokevirtual 186	rx/internal/operators/OperatorPublish$InnerProducer:unsubscribe	()V
      //   418: aload 17
      //   420: aload 16
      //   422: getfield 125	rx/internal/operators/OperatorPublish$InnerProducer:child	Lrx/Subscriber;
      //   425: aload 15
      //   427: invokestatic 192	rx/exceptions/Exceptions:throwOrReport	(Ljava/lang/Throwable;Lrx/Observer;Ljava/lang/Object;)V
      //   430: goto +60 -> 490
      //   433: iload_1
      //   434: iconst_1
      //   435: iadd
      ...
      //   440: aload_0
      //   441: iconst_0
      //   442: putfield 146	rx/internal/operators/OperatorPublish$PublishSubscriber:missed	Z
      //   445: aload_0
      //   446: monitorexit
      //   447: goto -415 -> 32
      //   450: astore 14
