...
public class jrp
{
  ...
  public jrp(QQAppInterface paramQQAppInterface)
  {
  ...
  private void bE(List<Long> paramList)
  {
    ...
    localObject = new NewIntent(this.mApp.getApplication(), jnl.class);
    ((NewIntent)localObject).putExtra("cmd", "OidbSvc.0x8d3_1");
    ((NewIntent)localObject).putExtra("data", paramList.toByteArray());
    ((NewIntent)localObject).setObserver(new jrr(this));
    this.mApp.startServlet((NewIntent)localObject);
  }
  
  private void bI(ArrayList<TroopAppInfo> paramArrayList)
  {
    if (this.a != null) {
      this.a.onSuccess(paramArrayList);
    }
  }
  ...
  public boolean a(String paramString, jrp.a parama)
  {
    return a(paramString, parama, false);
  }
  
  public boolean a(String paramString, jrp.a parama, boolean paramBoolean)
  {
    this.a = parama;
    parama = new oidb_0x8cf.ReqBody();
    try
    {
      parama.opt_uint64_groupcode.set(Long.parseLong(paramString));
      parama.opt_uint32_need_mobile_sysapps.set(1);
      paramString = new oidb_sso.OIDBSSOPkg();
      paramString.uint32_command.set(2255);
      paramString.uint32_service_type.set(6);
      paramString.bytes_bodybuffer.set(ByteStringMicro.copyFrom(parama.toByteArray()));
      parama = new NewIntent(this.mApp.getApplication(), jnl.class);
      parama.putExtra("cmd", "OidbSvc.0x8cf_6");
      parama.putExtra("data", paramString.toByteArray());
      parama.setObserver(new jrq(this, paramBoolean));
      this.mApp.startServlet(parama);
      return true;
    }
  ...
  public static abstract interface a
  {
    ...
    public abstract void onSuccess(ArrayList<TroopAppInfo> paramArrayList);
  }
}
