import com.tencent.mobileqq.activity.richmedia.view.ExtendEditText.a;

public final class aave
  implements ExtendEditText.a
{
  private boolean isChinese(char paramChar)
  {
  ...
  public int a(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        int k = j;
        if (isChinese(paramCharSequence.charAt(paramInt1))) {
          k = j + 1;
        }
        paramInt1 += 1;
        j = k;
