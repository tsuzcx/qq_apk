  ...
  extends agie
{
  ...
  /* Error */
  protected void a(boolean paramBoolean, long paramLong1, java.lang.String paramString1, java.lang.String paramString2, java.lang.String paramString3, int paramInt1, java.lang.String paramString4, java.lang.String paramString5, int paramInt2, long paramLong2, android.os.Bundle paramBundle)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 10
    ...
    //   159: ldc 82
    //   161: aload_0
    //   162: getfield 10	aoaz:a	Laoay;
    //   165: getfield 88	aoay:e	Lcom/tencent/mobileqq/teamwork/TeamWorkFileImportInfo;
    //   168: getfield 94	com/tencent/mobileqq/teamwork/TeamWorkFileImportInfo:fileName	Ljava/lang/String;
    ...
    //   189: istore 10
    //   191: aload_0
    //   192: getfield 10	aoaz:a	Laoay;
    //   195: getfield 100	aoay:entity	Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   198: ifnull +180 -> 378
    //   201: iload 7
    //   203: ifne +21 -> 224
    //   206: aload 5
    //   208: ldc 82
    //   210: aload_0
    //   211: getfield 10	aoaz:a	Laoay;
    //   214: getfield 88	aoay:e	Lcom/tencent/mobileqq/teamwork/TeamWorkFileImportInfo;
    //   217: getfield 94	com/tencent/mobileqq/teamwork/TeamWorkFileImportInfo:fileName	Ljava/lang/String;
    //   220: invokevirtual 80	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   223: pop
    //   224: aload 5
    //   226: ldc 102
    //   228: iconst_2
    //   229: invokevirtual 105	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   232: pop
    //   233: aload 5
    //   235: ldc 107
    //   237: aload_0
    //   238: getfield 10	aoaz:a	Laoay;
    //   241: getfield 100	aoay:entity	Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   244: getfield 112	com/tencent/mobileqq/filemanager/data/FileManagerEntity:Uuid	Ljava/lang/String;
    //   247: invokevirtual 80	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   250: pop
    //   251: aload 5
    //   253: ldc 114
    //   255: aload_0
    //   256: getfield 10	aoaz:a	Laoay;
    //   259: getfield 100	aoay:entity	Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   262: getfield 117	com/tencent/mobileqq/filemanager/data/FileManagerEntity:peerUin	Ljava/lang/String;
    //   265: invokestatic 123	java/lang/Long:valueOf	(Ljava/lang/String;)Ljava/lang/Long;
    //   268: invokevirtual 80	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   271: pop
    //   272: aload 5
    //   274: ldc 125
    //   276: aload_0
    //   277: getfield 10	aoaz:a	Laoay;
    //   280: getfield 100	aoay:entity	Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   283: getfield 128	com/tencent/mobileqq/filemanager/data/FileManagerEntity:strFileMd5	Ljava/lang/String;
    //   286: invokevirtual 80	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   289: pop
    //   290: aload 5
    //   292: ldc 130
    //   294: aload_0
    //   295: getfield 10	aoaz:a	Laoay;
    //   298: getfield 100	aoay:entity	Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   301: getfield 133	com/tencent/mobileqq/filemanager/data/FileManagerEntity:strFileSHA	Ljava/lang/String;
    //   304: invokevirtual 80	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   307: pop
    //   308: aload 5
    //   310: ldc 135
    //   312: aload_0
    //   313: getfield 10	aoaz:a	Laoay;
    //   316: getfield 88	aoay:e	Lcom/tencent/mobileqq/teamwork/TeamWorkFileImportInfo;
    //   319: getfield 139	com/tencent/mobileqq/teamwork/TeamWorkFileImportInfo:dNR	I
    //   322: invokevirtual 105	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   325: pop
    //   326: aload 5
    //   328: ldc 141
    //   330: aload_0
    //   331: getfield 10	aoaz:a	Laoay;
    //   334: getfield 100	aoay:entity	Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   337: getfield 145	com/tencent/mobileqq/filemanager/data/FileManagerEntity:fileSize	J
    //   340: invokevirtual 148	org/json/JSONObject:put	(Ljava/lang/String;J)Lorg/json/JSONObject;
    //   343: pop
    //   344: iconst_1
    //   345: istore 10
    //   347: aload_0
    //   348: getfield 10	aoaz:a	Laoay;
    //   351: getfield 88	aoay:e	Lcom/tencent/mobileqq/teamwork/TeamWorkFileImportInfo;
    //   354: aload_0
    //   355: getfield 10	aoaz:a	Laoay;
    //   358: getfield 100	aoay:entity	Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   361: getfield 112	com/tencent/mobileqq/filemanager/data/FileManagerEntity:Uuid	Ljava/lang/String;
    //   364: putfield 151	com/tencent/mobileqq/teamwork/TeamWorkFileImportInfo:cjG	Ljava/lang/String;
    //   367: aload_0
    //   368: getfield 10	aoaz:a	Laoay;
    //   371: getfield 88	aoay:e	Lcom/tencent/mobileqq/teamwork/TeamWorkFileImportInfo;
    //   374: iconst_2
    //   375: putfield 153	com/tencent/mobileqq/teamwork/TeamWorkFileImportInfo:filetype	I
    //   378: iload 10
    //   380: ifne +8 -> 388
    //   383: iload 7
    //   385: ifeq +179 -> 564
    //   388: aload 5
    //   390: invokestatic 159	aoag:u	(Lorg/json/JSONObject;)Z
    //   393: ifeq +171 -> 564
    //   396: aload_0
    //   397: getfield 10	aoaz:a	Laoay;
    //   400: aload 5
    //   402: invokestatic 162	aoay:a	(Laoay;Lorg/json/JSONObject;)Z
    //   405: ifeq +159 -> 564
    //   408: aload_0
    //   409: getfield 10	aoaz:a	Laoay;
    //   412: getfield 165	aoay:a	Laoar;
    //   415: aload 5
    //   417: aload_0
    //   418: getfield 10	aoaz:a	Laoay;
    //   421: getfield 88	aoay:e	Lcom/tencent/mobileqq/teamwork/TeamWorkFileImportInfo;
    //   424: aload_0
    //   425: getfield 10	aoaz:a	Laoay;
    //   428: invokevirtual 171	java/lang/Object:hashCode	()I
    //   431: invokevirtual 176	aoar:a	(Lorg/json/JSONObject;Lcom/tencent/mobileqq/teamwork/TeamWorkFileImportInfo;I)V
    //   434: return
    //   435: astore 4
    //   437: iconst_0
    //   438: istore 7
    ...
    //   455: aload 4
    //   457: invokevirtual 179	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   466: invokestatic 181	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   469: goto -281 -> 188
    //   472: ldc 28
    //   474: iconst_1
    ...
    //   496: aload_0
    //   497: getfield 10	aoaz:a	Laoay;
    //   500: getfield 88	aoay:e	Lcom/tencent/mobileqq/teamwork/TeamWorkFileImportInfo;
    //   503: getfield 94	com/tencent/mobileqq/teamwork/TeamWorkFileImportInfo:fileName	Ljava/lang/String;
    ...
    //   517: invokestatic 181	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   520: iload 10
    //   522: istore 7
    //   524: goto -336 -> 188
    //   527: astore 4
    ...
    //   544: aload 4
    //   546: invokevirtual 179	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   555: invokestatic 181	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   558: iconst_0
    //   559: istore 10
    //   561: goto -183 -> 378
    //   564: aload_0
    //   565: getfield 10	aoaz:a	Laoay;
    //   568: iconst_1
    //   569: invokevirtual 191	aoay:QI	(Z)V
    //   572: return
