...
{
  public BroadcastReceiver bA = new ankw(this);
  ...
  public void c(Intent paramIntent, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ShortVideoJsApiPlugin", 2, "startNewPTVActivity" + " result:" + ReadInJoyDeliverUGCActivity.eS(paramIntent));
      }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("ptv".equals(paramString2))
    {
      ...
      for (;;)
      {
        ...
        localawtb.cSD = str21;
        localawtb.cSE = str22;
        localawtb.musicId = ((String)localObject2);
        if (!TextUtils.isEmpty(str9))
        {
          anku.a(this.mRuntime.a(), this.mRuntime.getActivity(), str4, str5, str6, str7, str10, str11, str12, str13, str14, str15, str16, str17, str18, str8, str19, paramString3, str9, paramString1, paramJsBridgeListener, paramString2, (String)localObject1, localawtb);
          continue;
          continue;
            ...
            if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
              for (;;)
              {
                try
                {
                  ...
                  bool1 = anku.d(this.mRuntime.a());
                  boolean bool2 = anjg.axy();
                  boolean bool3 = VideoEnvironment.r(this.mRuntime.a());
                  boolean bool4 = ankq.by(BaseApplicationImpl.getContext());
          ...
          else if ("onClickShareBattle".equals(paramString3))
          {
            try
            {
              ...
              rfl.a().cA(paramString1, Integer.valueOf(i).toString());
            }
            catch (JSONException paramJsBridgeListener) {}
            if (QLog.isColorLevel())
            {
          ...
          else if (("startStoryActivity".equals(paramString3)) && (paramVarArgs != null))
          {
            try
            {
              ...
              anku.a(this.mRuntime.a(), this.mRuntime.getActivity(), i);
            }
  ...
  public void onCreate()
  {
    ...
    this.mRuntime.getActivity().registerReceiver(this.bA, localIntentFilter);
  }
  
  public void onDestroy()
  {
    super.onDestroy();
    this.mRuntime.getActivity().unregisterReceiver(this.bA);
  }
}
