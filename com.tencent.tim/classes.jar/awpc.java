...
class awpc
  implements awpw<WeiyunPB.QqSdkFileUploadMsgRsp>
{
  awpc(awov.a parama, WeiyunTransmissionGlobal.UploadServerInfoCallback paramUploadServerInfoCallback, UploadFile paramUploadFile) {}
  ...
  public void a(WeiyunPB.QqSdkFileUploadMsgRsp paramQqSdkFileUploadMsgRsp)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentWeiyunTransmissionWeiyunTransmissionGlobal$UploadServerInfoCallback.onResult(this.jdField_a_of_type_ComTencentWeiyunTransmissionUploadUploadFile, false, 1828004, acfp.m(2131715440));
      return;
    }
    ...
    if (localObject1 == null)
    {
      ...
      awph.jI((String)localObject2, (String)localObject1);
    ...
    for (localObject1 = paramQqSdkFileUploadMsgRsp.inside_upload_ip.get();; localObject1 = paramQqSdkFileUploadMsgRsp.outside_upload_ip.get())
    {
      ...
      return;
      localObject1 = awrh.g((ByteStringMicro)localObject1);
      break;
      localObject2 = awrh.g((ByteStringMicro)localObject3);
      break label57;
    }
  }
}
