...
public class aitz
{
  ...
  {
    return getDistance(paramLatLng1.latitude, paramLatLng1.longitude, paramLatLng2.latitude, paramLatLng2.longitude);
  }
  
  public static void a(TencentMap paramTencentMap)
  {
    if (paramTencentMap != null) {
      c(b(b(b(b(paramTencentMap, "m"), "a"), "b"), "b"), "b", null);
    }
  }
  ...
  public static void a(TencentMap paramTencentMap, int paramInt)
  {
    if (paramTencentMap != null)
    {
      paramTencentMap = b(b(b(b(paramTencentMap.getUiSettings(), "a"), "a"), "d"), "W");
  ...
  public static int av(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      paramContext = alla.getString(paramContext.getContentResolver(), "location_providers_allowed");
      int i = j;
  ...
  static void b(Activity paramActivity, String paramString1, String paramString2, String paramString3, LatLng paramLatLng1, LatLng paramLatLng2)
  {
    if (bp(paramActivity))
    {
      ...
      catch (Exception localException)
      {
        ...
        anot.a(null, "CliOper", "", "", "0X800A972", "0X800A972", 1, 0, "0", "0", "0", "");
      }
    }
    for (;;)
    {
      ...
      return;
      anot.a(null, "CliOper", "", "", "0X800A972", "0X800A972", 2, 0, "0", "0", "0", "");
    }
  }
  ...
  {
    if (az == null) {
      az = Boolean.valueOf(ausc.bb(paramContext, "com.tencent.map"));
    }
    return az.booleanValue();
  }
  
  private static void c(Object paramObject1, String paramString, Object paramObject2)
  {
  ...
  public static void c(String paramString1, String paramString2, TextView paramTextView)
  {
  ...
  private static double getDistance(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4)
  {
  ...
  public static void p(View paramView, String paramString)
  {
