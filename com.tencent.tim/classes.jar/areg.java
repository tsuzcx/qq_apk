...
public class areg
{
  public static String cAh = "com.qq.hotact";
  ...
  public static int b(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    int i = 1;
    if (!areh.ct(paramQQAppInterface)) {
      if (QLog.isColorLevel()) {
    ...
    {
      return 0;
      if ((paramQQAppInterface.a().a != null) && (paramQQAppInterface.a().a.cZm)) {
        break;
      }
  ...
  public static void b(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch)
  {
    Object localObject1;
    Object localObject2;
    int j;
    ...
    {
      localObject1 = (akjp)paramQQAppInterface.getManager(160);
      paramQQAppInterface = ((akjp)localObject1).a(10013);
      localObject2 = ((akjp)localObject1).a(10014);
      if (!((akjp)localObject1).a(paramQQAppInterface, false)) {
        break label1102;
      }
    ...
    for (;;)
    {
      int k = i;
      int m = j;
      if (((akjp)localObject1).a((RedTouchItem)localObject2, false))
      {
        k = i;
        m = j;
        ...
        for (;;)
        {
          ...
          if (m > 0)
          {
            ...
            for (;;)
            {
              ...
              paramRedTouch.e((BusinessInfoCheckUpdate.AppInfo)localObject1);
              return;
          ...
          if ((bool2) && (bool1))
          {
            ...
            paramRedTouch.e((BusinessInfoCheckUpdate.AppInfo)localObject2);
            return;
          }
          if ((!bool2) || (bool1)) {
            break label1031;
          ...
          if (!TextUtils.isEmpty(paramQQAppInterface.icon))
          {
            if (!TextUtils.isEmpty(paramQQAppInterface.tips))
            {
              ...
              localObject2 = new BusinessInfoCheckUpdate.RedTypeInfo();
              ((BusinessInfoCheckUpdate.RedTypeInfo)localObject2).red_content.set(aqcx.dip2px(BaseApplicationImpl.sApplication.getApplicationContext(), 3.0F) + "");
            ...
            try
            {
              ...
              try
              {
                ...
                paramQQAppInterface.setPadding(wja.dp2px(160.0F, paramQQAppInterface.getResources()), paramQQAppInterface.getPaddingTop(), paramQQAppInterface.getPaddingRight(), paramQQAppInterface.getPaddingBottom());
                return;
              }
  ...
  public static EIPCResult g(String paramString, Bundle paramBundle, int paramInt)
  {
    if (QLog.isColorLevel()) {
    ...
    ((akjp)paramString.getManager(160)).RT(10014);
    paramBundle.code = 0;
    return paramBundle;
  }
  
  public static EIPCResult h(String paramString, Bundle paramBundle, int paramInt)
  {
    if (QLog.isColorLevel()) {
    ...
    paramString = (akjp)paramString.getManager(160);
