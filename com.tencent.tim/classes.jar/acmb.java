  ...
  extends accg
{
  ...
  private void dv(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   1: aload_2
    //   2: aload_3
    //   3: invokestatic 66	acmb:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;Ljava/lang/Object;)Ltencent/im/oidb/oidb_sso$OIDBSSOPkg;
    //   6: astore_2
    //   7: aload_2
    //   8: ifnonnull +25 -> 33
    ...
    //   27: iconst_0
    //   28: aconst_null
    //   29: invokevirtual 72	acmb:notifyUI	(IZLjava/lang/Object;)V
    //   32: return
    ...
    //   204: aload_0
    //   205: getfield 142	acmb:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   208: invokevirtual 147	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   211: invokevirtual 153	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   214: astore_2
    //   215: aload_2
    //   216: ldc 155
    //   218: invokevirtual 161	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;)Ljava/util/List;
    //   221: astore 6
    //   223: aload 6
    ...
    //   295: ldc 155
    //   297: aload_3
    //   298: invokevirtual 204	com/tencent/mobileqq/persistence/EntityManager:find	(Ljava/lang/Class;Ljava/lang/String;)Lcom/tencent/mobileqq/persistence/Entity;
    ...
    //   314: dup
    //   315: invokespecial 205	com/tencent/mobileqq/data/Stranger:<init>	()V
    //   318: astore 7
    //   320: aload 7
    //   322: aload_3
    //   323: putfield 208	com/tencent/mobileqq/data/Stranger:uin	Ljava/lang/String;
    //   326: aload 7
    //   328: aload 9
    //   330: putfield 211	com/tencent/mobileqq/data/Stranger:name	Ljava/lang/String;
    //   333: aload_2
    //   334: aload 7
    //   336: invokevirtual 215	com/tencent/mobileqq/persistence/EntityManager:persist	(Lcom/tencent/mobileqq/persistence/Entity;)V
    ...
    //   360: aload 7
    //   362: invokevirtual 220	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   374: aload 7
    //   376: aload 9
    //   378: putfield 211	com/tencent/mobileqq/data/Stranger:name	Ljava/lang/String;
    //   381: aload_2
    //   382: aload 7
    //   384: invokevirtual 224	com/tencent/mobileqq/persistence/EntityManager:update	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   387: pop
    //   388: aload 6
    ...
    //   419: astore_3
    //   420: aload_3
    //   421: getfield 208	com/tencent/mobileqq/data/Stranger:uin	Ljava/lang/String;
    //   424: aload 7
    //   426: getfield 208	com/tencent/mobileqq/data/Stranger:uin	Ljava/lang/String;
    //   429: invokestatic 230	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   432: ifeq -35 -> 397
    //   435: aload 6
    //   437: aload_3
    //   438: invokeinterface 234 2 0
    //   443: pop
    //   444: aload_3
    //   445: astore_1
    //   446: goto -107 -> 339
    ...
    //   497: aload_3
    //   498: invokevirtual 220	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   507: aload_2
    //   508: aload_3
    //   509: invokevirtual 238	com/tencent/mobileqq/persistence/EntityManager:remove	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   512: pop
    //   513: goto -56 -> 457
    //   516: astore_3
    //   517: aload_2
    ...
    //   520: astore_2
    //   521: aload_2
    //   522: invokevirtual 241	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:printStackTrace	()V
    //   525: aload_1
    //   526: ifnull +7 -> 533
    //   529: aload_1
    //   530: invokevirtual 244	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   533: aload_0
    //   534: iconst_2
    //   535: iconst_0
    //   536: aconst_null
    //   537: invokevirtual 72	acmb:notifyUI	(IZLjava/lang/Object;)V
    //   540: return
    //   541: aload_0
    //   542: getfield 142	acmb:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   545: invokevirtual 248	com/tencent/mobileqq/app/QQAppInterface:getPreferences	()Landroid/content/SharedPreferences;
    //   548: invokeinterface 254 1 0
    //   553: astore_1
    //   554: aload_1
    //   555: ldc_w 256
    //   558: iload 4
    //   560: invokeinterface 262 3 0
    //   565: pop
    //   566: aload_1
    //   567: invokeinterface 265 1 0
    //   572: pop
    //   573: aload_2
    //   574: ldc 155
    //   576: invokevirtual 161	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;)Ljava/util/List;
    //   579: astore_3
    //   580: aload_3
    //   581: astore_1
    //   582: aload_3
    //   583: ifnonnull +11 -> 594
    //   586: new 163	java/util/ArrayList
    //   589: dup
    //   590: invokespecial 164	java/util/ArrayList:<init>	()V
    //   593: astore_1
    //   594: aload_0
    //   595: iconst_2
    //   596: iconst_1
    //   597: aload_1
    //   598: invokevirtual 72	acmb:notifyUI	(IZLjava/lang/Object;)V
    //   601: aload_2
    //   602: ifnull -570 -> 32
    //   605: aload_2
    //   606: invokevirtual 244	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   609: return
    //   610: aload_0
    //   611: iconst_2
    //   612: iconst_1
    //   613: aconst_null
    //   614: invokevirtual 72	acmb:notifyUI	(IZLjava/lang/Object;)V
    //   617: iconst_0
    //   618: ifeq -586 -> 32
    //   621: new 267	java/lang/NullPointerException
    //   624: dup
    //   625: invokespecial 268	java/lang/NullPointerException:<init>	()V
    //   628: athrow
    //   629: astore_1
    //   630: aconst_null
    //   631: astore_2
    ...
    //   633: ifnull +7 -> 640
    //   636: aload_2
    //   637: invokevirtual 244	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   640: aload_1
    //   641: athrow
    //   642: astore_1
    //   643: goto -11 -> 632
  ...
  public boolean aW(boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
  ...
  public boolean aj(List<Long> paramList)
  {
  ...
  public void fQ(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
      ...
      try
      {
        ...
        while (paramFromServiceMsg.hasNext())
        {
          ...
          if (((oidb_0x5d4.DelResult)localObject).res.get() == 0)
          {
            ...
            if (localObject != null) {
              paramObject.f((RecentUser)localObject);
            }
          }
        }
      }
