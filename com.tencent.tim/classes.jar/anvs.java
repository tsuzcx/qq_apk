  ...
  extends MSFServlet
{
  ...
  {
    Object localObject = new NewIntent(paramQQAppInterface.getApp(), anvs.class);
    int j = paramMessageForPtt.voiceLength;
    int i = j;
    if (j == 0) {
      i = QQRecorder.n(paramMessageForPtt);
    }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          paramLong = anpc.a(BaseApplication.getContext());
          ...
          if (paramMessageForPtt.istroop == 0)
          {
            ...
            ((HashMap)localObject).put("appversion", "3.4.4");
        ...
        catch (Exception paramQQAppInterface)
        {
          try
          {
            ...
            for (;;)
            {
              paramQQAppInterface = anpc.a(BaseApplication.getContext());
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (bool2 = true;; bool2 = false)
    {
      ...
      notifyObserver(paramIntent, k, bool2, paramFromServiceMsg, anvq.class);
      return;
      break;
    }
  }
