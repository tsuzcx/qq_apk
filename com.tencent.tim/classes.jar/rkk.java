...
public class rkk
  extends auvp
{
  public static final TroopBarPOI c = new TroopBarPOI("-1", "", acfp.m(2131712390), 0, "", 0, "");
  protected TroopBarPOI a;
  protected ArrayList<TroopBarPOI> kd = new ArrayList();
  protected LayoutInflater mInflater;
  
  public rkk(Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      localObject = new rkk.a();
      ((rkk.a)localObject).nt = ((ImageView)paramView.findViewById(2131377968));
      ((rkk.a)localObject).yM = ((TextView)paramView.findViewById(2131370317));
      paramView.setTag(localObject);
      localTroopBarPOI = (TroopBarPOI)this.kd.get(paramInt);
      ((rkk.a)localObject).yM.setText(localTroopBarPOI.name);
      localObject = ((rkk.a)localObject).nt;
    ...
    for (int i = 0;; i = 8)
    {
      ...
      return paramView;
      localObject = (rkk.a)paramView.getTag();
      break;
    }
  }
