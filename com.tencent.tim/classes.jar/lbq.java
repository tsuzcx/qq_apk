...
{
  public lbq(KandianMergeManager paramKandianMergeManager) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!awit.t(KandianMergeManager.a(this.this$0)))
        {
        ...
        this.this$0.mR(paramBoolean);
        paramBundle.mi(paramBoolean);
        continue;
        this.this$0.mR(paramBoolean);
      }
