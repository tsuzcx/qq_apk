...
public class aysy
{
  ...
  private ayic.a jdField_a_of_type_Ayic$a;
  private final aytb jdField_a_of_type_Aytb;
  ...
  public aysy(aytb paramaytb, EntityManager paramEntityManager)
  {
  ...
  public boolean a(ayic.a parama)
  {
    if (this.jdField_a_of_type_Ayic$a != null) {
      if (this.jdField_a_of_type_Ayic$a.equals(parama)) {}
    }
    while (parama != null)
    {
      return true;
  ...
  public void b(@Nonnull ayic.a parama)
  {
    ram.b("EditVideoTagPresenter", "%s refresh data, behavior:%s", this, parama);
    this.jdField_a_of_type_Ayic$a = parama;
    if (parama.aHk) {}
    for (parama = new pzj(parama.musicType, parama.BP, "", 20);; parama = new pzj("", 20))
    {
      ppv.a().a(parama, new aysz(this));
      return;
    }
  }
  
  public void c(@Nonnull ayic.a parama)
  {
  ...
  {
    this.nD.clear();
    this.jdField_a_of_type_Ayic$a = null;
    this.avr = "";
    this.blG = 1;
