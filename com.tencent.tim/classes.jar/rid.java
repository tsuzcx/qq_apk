  ...
  extends VideoFilterBase
{
  ...
  public rid(DoodleItem paramDoodleItem, String paramString)
  {
  ...
  public boolean Lz()
  {
    ...
    for (;;)
    {
      ...
      if (j > 0)
      {
        ...
        int m = (int)((float)rih.a((PointF)localObject1, (PointF)localObject2) / f1 * 18.0F) + 1;
        int k = m;
        if (m < 6) {
          k = 6;
        }
  ...
  void cq(ArrayList<PointF> paramArrayList)
  {
    ...
    {
      f1 = (float)rih.a((PointF)this.mTouchPoints.get(i - 3), (PointF)this.mTouchPoints.get(i - 2));
      f2 = (float)rih.a((PointF)this.mTouchPoints.get(i - 2), (PointF)this.mTouchPoints.get(i - 1));
      f1 = 1.0F / ((int)(((float)rih.a((PointF)this.mTouchPoints.get(i - 1), (PointF)this.mTouchPoints.get(i)) + (f1 + f2)) / (f3 * 1.5F)) * 12 * 1.0F);
      if (f1 > 0.1F) {
        f1 = 0.1F;
      }
    }
