...
{
  public qkl(VideoViewVideoHolder paramVideoViewVideoHolder)
  {
  ...
  public void onError(@NonNull Error paramError)
  {
    ...
    ram.w(this.this$0.TAG, "VideoStartSegment, error=%s", new Object[] { ((ErrorMessage)paramError).getErrorMessage() });
