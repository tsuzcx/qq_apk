  ...
  extends AbstractMediaPlayer
{
  ...
  private void initPlayer(NativeLibLoader paramNativeLibLoader)
  {
    ...
    if (paramNativeLibLoader != null) {
      this.mEventHandler = new EventHandler(this, paramNativeLibLoader);
    }
    for (;;)
    {
  ...
  public static void loadLibrariesOnce(NativeLibLoader paramNativeLibLoader)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 180	tv/danmaku/ijk/media/player/IjkMediaPlayer:sIsLibLoadSuccess	Z
    //   6: ifne +78 -> 84
    //   9: aload_0
    //   10: astore_1
    //   11: aload_0
    //   12: ifnonnull +7 -> 19
    //   15: getstatic 178	tv/danmaku/ijk/media/player/IjkMediaPlayer:sLocalLibLoader	Lcom/tencent/oskplayer/support/loader/NativeLibLoader;
    //   18: astore_1
    //   19: aload_1
    //   20: ldc_w 321
    //   23: invokeinterface 350 2 0
    //   28: aload_1
    //   29: ldc_w 335
    //   32: invokeinterface 350 2 0
    //   37: aload_1
    //   38: ldc_w 337
    //   41: invokeinterface 350 2 0
    //   46: iconst_1
    //   47: putstatic 180	tv/danmaku/ijk/media/player/IjkMediaPlayer:sIsLibLoadSuccess	Z
    //   50: invokestatic 356	com/tencent/oskplayer/support/log/Logger:g	()Lcom/tencent/oskplayer/support/log/ILogger;
    //   53: getstatic 171	tv/danmaku/ijk/media/player/IjkMediaPlayer:TAG	Ljava/lang/String;
    //   56: new 358	java/lang/StringBuilder
    //   59: dup
    //   60: invokespecial 359	java/lang/StringBuilder:<init>	()V
    //   63: ldc_w 361
    //   66: invokevirtual 365	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   69: getstatic 180	tv/danmaku/ijk/media/player/IjkMediaPlayer:sIsLibLoadSuccess	Z
    //   72: invokevirtual 368	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   75: invokevirtual 371	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   78: invokeinterface 377 3 0
    //   83: pop
    //   84: ldc 2
    //   86: monitorexit
    //   87: return
    //   88: astore_0
    //   89: invokestatic 356	com/tencent/oskplayer/support/log/Logger:g	()Lcom/tencent/oskplayer/support/log/ILogger;
    //   92: getstatic 171	tv/danmaku/ijk/media/player/IjkMediaPlayer:TAG	Ljava/lang/String;
    //   95: new 358	java/lang/StringBuilder
    //   98: dup
    //   99: invokespecial 359	java/lang/StringBuilder:<init>	()V
    //   102: ldc_w 379
    //   105: invokevirtual 365	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   108: getstatic 180	tv/danmaku/ijk/media/player/IjkMediaPlayer:sIsLibLoadSuccess	Z
    //   111: invokevirtual 368	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   114: invokevirtual 371	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   117: invokeinterface 382 3 0
    //   122: pop
    //   123: aload_0
    //   124: invokevirtual 385	java/lang/Throwable:printStackTrace	()V
    //   127: goto -77 -> 50
    //   130: astore_0
    //   131: ldc 2
    //   133: monitorexit
  ...
  private static boolean onNativeInvoke(Object paramObject, int paramInt, Bundle paramBundle)
  {
    ...
    OnNativeInvokeListener localOnNativeInvokeListener = paramObject.mOnNativeInvokeListener;
  ...
  private static String onSelectCodec(Object paramObject, String paramString, int paramInt1, int paramInt2)
  {
    ...
    OnMediaCodecSelectListener localOnMediaCodecSelectListener = localIjkMediaPlayer.mOnMediaCodecSelectListener;
    ...
    throws IOException, IllegalArgumentException, SecurityException, IllegalStateException
  {
    // Byte code:
    //   0: aload_2
    //   1: invokevirtual 803	android/net/Uri:getScheme	()Ljava/lang/String;
    //   4: astore 5
    //   6: ldc_w 805
    //   9: aload 5
    //   11: invokevirtual 808	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   14: ifeq +12 -> 26
    //   17: aload_0
    //   18: aload_2
    //   19: invokevirtual 811	android/net/Uri:getPath	()Ljava/lang/String;
    //   22: invokevirtual 813	tv/danmaku/ijk/media/player/IjkMediaPlayer:setDataSource	(Ljava/lang/String;)V
    //   25: return
    //   26: aload_2
    //   27: astore 4
    //   29: ldc_w 815
    //   32: aload 5
    //   34: invokevirtual 808	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   37: ifeq +46 -> 83
    //   40: aload_2
    //   41: astore 4
    //   43: ldc_w 817
    //   46: aload_2
    //   47: invokevirtual 820	android/net/Uri:getAuthority	()Ljava/lang/String;
    //   50: invokevirtual 808	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   53: ifeq +30 -> 83
    //   56: aload_1
    //   57: aload_2
    //   58: invokestatic 826	android/media/RingtoneManager:getDefaultType	(Landroid/net/Uri;)I
    //   61: invokestatic 830	android/media/RingtoneManager:getActualDefaultRingtoneUri	(Landroid/content/Context;I)Landroid/net/Uri;
    //   64: astore_2
    //   65: aload_2
    //   66: astore 4
    //   68: aload_2
    //   69: ifnonnull +14 -> 83
    //   72: new 832	java/io/FileNotFoundException
    //   75: dup
    //   76: ldc_w 834
    //   79: invokespecial 835	java/io/FileNotFoundException:<init>	(Ljava/lang/String;)V
    //   82: athrow
    //   83: aconst_null
    //   84: astore_2
    //   85: aload_1
    //   86: invokevirtual 841	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   89: aload 4
    //   91: ldc_w 843
    //   94: invokevirtual 849	android/content/ContentResolver:openAssetFileDescriptor	(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
    //   97: astore_1
    //   98: aload_1
    //   99: ifnonnull +12 -> 111
    //   102: aload_1
    //   103: ifnull -78 -> 25
    //   106: aload_1
    //   107: invokevirtual 854	android/content/res/AssetFileDescriptor:close	()V
    //   110: return
    //   111: aload_1
    //   112: invokevirtual 857	android/content/res/AssetFileDescriptor:getDeclaredLength	()J
    //   115: lconst_0
    //   116: lcmp
    //   117: ifge +20 -> 137
    //   120: aload_0
    //   121: aload_1
    //   122: invokevirtual 861	android/content/res/AssetFileDescriptor:getFileDescriptor	()Ljava/io/FileDescriptor;
    //   125: invokevirtual 486	tv/danmaku/ijk/media/player/IjkMediaPlayer:setDataSource	(Ljava/io/FileDescriptor;)V
    //   128: aload_1
    //   129: ifnull -104 -> 25
    //   132: aload_1
    //   133: invokevirtual 854	android/content/res/AssetFileDescriptor:close	()V
    //   136: return
    //   137: aload_0
    //   138: aload_1
    //   139: invokevirtual 861	android/content/res/AssetFileDescriptor:getFileDescriptor	()Ljava/io/FileDescriptor;
    //   142: aload_1
    //   143: invokevirtual 864	android/content/res/AssetFileDescriptor:getStartOffset	()J
    //   146: aload_1
    //   147: invokevirtual 857	android/content/res/AssetFileDescriptor:getDeclaredLength	()J
    //   150: invokespecial 866	tv/danmaku/ijk/media/player/IjkMediaPlayer:setDataSource	(Ljava/io/FileDescriptor;JJ)V
    //   153: goto -25 -> 128
    //   156: astore_2
    //   157: aload_1
    //   158: ifnull +7 -> 165
    //   161: aload_1
    //   162: invokevirtual 854	android/content/res/AssetFileDescriptor:close	()V
    //   165: getstatic 171	tv/danmaku/ijk/media/player/IjkMediaPlayer:TAG	Ljava/lang/String;
    //   168: ldc_w 868
    //   171: invokestatic 873	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   174: pop
    //   175: aload_0
    //   176: aload 4
    //   178: invokevirtual 874	android/net/Uri:toString	()Ljava/lang/String;
    //   181: aload_3
    //   182: invokevirtual 877	tv/danmaku/ijk/media/player/IjkMediaPlayer:setDataSource	(Ljava/lang/String;Ljava/util/Map;)V
    //   185: return
    //   186: astore_1
    //   187: aconst_null
    //   188: astore_1
    ...
    //   190: ifnull -25 -> 165
    //   193: aload_1
    //   194: invokevirtual 854	android/content/res/AssetFileDescriptor:close	()V
    //   197: goto -32 -> 165
    //   200: astore_1
    //   201: aconst_null
    //   202: astore_3
    ...
    //   206: ifnull +7 -> 213
    //   209: aload_3
    //   210: invokevirtual 854	android/content/res/AssetFileDescriptor:close	()V
    //   213: aload_2
    //   214: athrow
    //   215: astore_2
    //   216: aload_1
    ...
    implements IjkMediaPlayer.OnMediaCodecSelectListener
  {
    ...
    public String onMediaCodecSelect(IMediaPlayer paramIMediaPlayer, String paramString, int paramInt1, int paramInt2)
    {
      ...
      Log.i(IjkMediaPlayer.TAG, String.format(Locale.US, "onSelectCodec: mime=%s, profile=%d, level=%d", new Object[] { paramString, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }));
      Object localObject1 = new ArrayList();
      ...
      if (paramInt1 < i)
      {
        ...
        Log.d(IjkMediaPlayer.TAG, String.format(Locale.US, "  found codec: %s", new Object[] { paramIMediaPlayer.getName() }));
        ...
        for (;;)
        {
          ...
          break;
          label174:
          Log.d(IjkMediaPlayer.TAG, String.format(Locale.US, "    mime: %s", new Object[] { localObject2 }));
          if (((String)localObject2).equalsIgnoreCase(paramString))
          {
            ...
            if (localObject2 != null)
            {
              ...
              Log.i(IjkMediaPlayer.TAG, String.format(Locale.US, "candidate codec: %s rank=%d", new Object[] { paramIMediaPlayer.getName(), Integer.valueOf(((IjkMediaCodecInfo)localObject2).mRank) }));
      ...
      for (;;)
      {
        ...
        {
          Log.w(IjkMediaPlayer.TAG, String.format(Locale.US, "unaccetable codec: %s", new Object[] { paramIMediaPlayer.mCodecInfo.getName() }));
          return null;
        }
        Log.i(IjkMediaPlayer.TAG, String.format(Locale.US, "selected codec: %s rank=%d", new Object[] { paramIMediaPlayer.mCodecInfo.getName(), Integer.valueOf(paramIMediaPlayer.mRank) }));
    ...
    extends Handler
  {
    ...
    public EventHandler(IjkMediaPlayer paramIjkMediaPlayer, Looper paramLooper)
    {
      super();
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      if ((localIjkMediaPlayer == null) || (localIjkMediaPlayer.mNativeMediaPlayer == 0L))
      {
      ...
      case 0: 
      default: 
        DebugLog.e(IjkMediaPlayer.TAG, "Unknown message type " + paramMessage.what);
        return;
      case 1: 
        localIjkMediaPlayer.notifyOnPrepared();
        return;
      case 2: 
        localIjkMediaPlayer.stayAwake(false);
      ...
      for (long l1 = l1 * 100L / l2;; l1 = 0L)
      {
        ...
        localIjkMediaPlayer.notifyOnVideoSizeChanged(localIjkMediaPlayer.mVideoWidth, localIjkMediaPlayer.mVideoHeight, localIjkMediaPlayer.mVideoSarNum, localIjkMediaPlayer.mVideoSarDen);
        return;
        DebugLog.e(IjkMediaPlayer.TAG, "Error (" + paramMessage.arg1 + "," + paramMessage.arg2 + ")");
        ...
        {
        default: 
          DebugLog.i(IjkMediaPlayer.TAG, "Info: MEDIA_INFO_UNKNOWN arg1=" + paramMessage.arg1 + ", arg2=" + paramMessage.arg2);
        }
        for (;;)
        {
