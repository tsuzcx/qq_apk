  ...
  implements IWebviewWrapper
{
  ...
  private boolean dqk;
  private long iZ = System.currentTimeMillis();
  private Context mContext;
  private TouchWebView mWebview;
  
  public awib(Context paramContext)
  {
    this(paramContext, false);
  }
  
  public awib(Context paramContext, boolean paramBoolean)
  {
    this.dqk = paramBoolean;
  ...
  public void onInit(Activity paramActivity, Intent paramIntent, String paramString, IWebviewListener paramIWebviewListener)
  {
    ...
    this.jdField_a_of_type_Awhy.a(new awic(this, paramIWebviewListener));
