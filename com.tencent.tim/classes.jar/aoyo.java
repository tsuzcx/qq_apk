...
public class aoyo
  extends abdt
  implements ajdo.a, View.OnClickListener, View.OnLongClickListener
{
  private static final aoyo.c jdField_a_of_type_Aoyo$c = new aoyo.c(null);
  ...
  aozi b;
  private final View.OnClickListener cp = new aoyp(this);
  private final QQAppInterface e;
  private final ArrayList<Groups> lj = new ArrayList();
  private final View.OnClickListener mOnClickListener = new aoyq(this);
  private AbsListView.e mOnScrollListener;
  
  public aoyo(NewTroopContactView paramNewTroopContactView, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, boolean paramBoolean)
  {
    ...
    this.J = paramNewTroopContactView.a;
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.J).inflate(2131560607, paramViewGroup, false);
      ...
      if (!this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopContactView.iX(paramViewGroup.uin)) {
        break label389;
      }
      paramViewGroup.checkBox.setChecked(true);
      label254:
      if ((this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopContactView.so == null) || (!this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopContactView.so.contains(localFriends.uin))) {
        break label401;
      }
    ...
    for (;;)
    {
      if ((AppSetting.enableTalkBack) && (paramViewGroup.checkBox.isEnabled()))
      {
        ...
        paramView.setContentDescription((String)localObject + acfp.m(2131704408));
      }
      return paramView;
    ...
    label413:
    paramView.setContentDescription((String)localObject + acfp.m(2131704394));
    return paramView;
  }
    ...
    if (localObject1 != null)
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (!((ArrayList)localObject1).isEmpty())
        {
          ...
          ((Groups)localObject2).group_name = this.J.getString(2131718631);
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.checkBox.setChecked(true);
      label214:
      if ((this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopContactView.so == null) || ("0".equals(localPhoneContact.uin)) || (!this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopContactView.so.contains(localPhoneContact.uin))) {
        break label365;
      }
      paramViewGroup.checkBox.setEnabled(false);
    }
    for (;;)
    {
      if ((AppSetting.enableTalkBack) && (paramViewGroup.checkBox.isEnabled()))
      {
        ...
        paramView.setContentDescription(localPhoneContact.name + acfp.m(2131704402));
      }
      return paramView;
      paramViewGroup = (aoyo.e)paramView.getTag();
      paramViewGroup.rc.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    ...
    label377:
    paramView.setContentDescription(localPhoneContact.name + acfp.m(2131704407));
    return paramView;
  }
  
  private View c(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView == null) || ((paramView.getTag() instanceof aoyo.e)))
    {
      paramView = LayoutInflater.from(this.J).inflate(2131559826, paramViewGroup, false);
      paramViewGroup = new aoyo.d();
      paramViewGroup.pQ = ((ImageView)paramView.findViewById(2131368698));
    ...
    for (;;)
    {
      ...
      paramViewGroup.rc.setTextColor(this.J.getResources().getColorStateList(2131167304));
      if (PublicAccountInfo.isLooker(localPublicAccountInfo))
      {
        ...
        return paramView;
        paramViewGroup = (aoyo.d)paramView.getTag();
        paramViewGroup.rc.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      }
      else
      {
  ...
  private void cO(List<aoyo.a> paramList)
  {
    try
    {
      Collections.sort(paramList, jdField_a_of_type_Aoyo$c);
      return;
    }
    ...
    for (;;)
    {
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        for (localObject2 = new ArrayList();; localObject2 = new ArrayList((Collection)localObject2))
        {
          ...
          while (((Iterator)localObject5).hasNext()) {
            ((ArrayList)localObject4).add(new aoyo.a((Friends)((Iterator)localObject5).next(), -1));
          }
        ...
        while (((Iterator)localObject4).hasNext()) {
          ((List)localObject2).add(((aoyo.a)((Iterator)localObject4).next()).a);
        }
      ...
      for (;;)
      {
        ...
        while (i < ((List)localObject2).size())
        {
          ...
          if ((!((Friends)localObject5).uin.equals(this.e.getCurrentAccountUin())) && (!this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopContactView.sr.contains(((Friends)localObject5).uin)) && (!aqft.rj(((Friends)localObject5).uin)) && (!aprg.V(this.e, ((Friends)localObject5).uin)) && (!asgx.ag(this.e, ((Friends)localObject5).uin))) {
  ...
  {
    return ((ArrayList)this.ap.get(((Groups)this.lj.get(paramInt1)).group_id)).get(paramInt2);
  }
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      else if (R(paramInt1, paramInt2) == 2)
      {
        ...
        paramView = this.jdField_b_of_type_Aozi.a(paramInt1, paramInt2, paramView, paramViewGroup, this.J, this.mOnClickListener, localRelationTroopEntity);
      }
      else
      {
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      localObject = (aoyo.b)paramView.getTag();
    ...
    for (;;)
    {
      ...
      if (AppSetting.enableTalkBack)
      {
        ...
        paramViewGroup.setContentDescription(((Groups)localObject).group_name + acfp.m(2131704396));
      }
      return paramViewGroup;
      paramViewGroup = LayoutInflater.from(this.J).inflate(2131560606, paramViewGroup, false);
      paramView = new aoyo.b();
      paramView.qZ = ((TextView)paramViewGroup.findViewById(2131368187));
      paramViewGroup.setTag(paramView);
      paramViewGroup.setOnClickListener(this);
    }
    paramViewGroup.setContentDescription(((Groups)localObject).group_name + acfp.m(2131704413));
    return paramViewGroup;
  }
  ...
  {
    aoyo.b localb = (aoyo.b)paramView.getTag();
    if (localb == null)
    {
      localb = new aoyo.b();
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    localaqoa.dV(0, this.J.getResources().getString(2131694542));
    aqgq.a(paramView, localaqoa, this.cp, new aoyr(this));
    return true;
  }
  ...
  static class c
    implements Comparator<aoyo.a>
  {
    public int a(aoyo.a parama)
    {
    ...
    public int a(aoyo.a parama1, aoyo.a parama2)
    {
