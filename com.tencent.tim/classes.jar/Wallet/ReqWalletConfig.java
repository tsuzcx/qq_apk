  ...
  extends JceStruct
{
  ...
  public static ReqWalletConfig createReq(long paramLong1, long paramLong2, long paramLong3, String paramString, Map<String, String> paramMap)
  {
    ...
    localReqWalletConfig.platform = ("Android|" + aqgz.getDeviceOSVersion() + "|" + aqgz.getModel());
    localReqWalletConfig.version = aqgz.BX();
    localReqWalletConfig.iNetType = aqiw.getSystemNetwork(BaseApplicationImpl.getContext());
