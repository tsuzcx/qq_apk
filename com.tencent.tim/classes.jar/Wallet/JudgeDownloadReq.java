  ...
  extends JceStruct
{
  ...
  public static JudgeDownloadReq createReq(ArrayList<ResInfo> paramArrayList, long paramLong, int paramInt)
  {
    ...
    localJudgeDownloadReq.sPhoneType = aqgz.getModel();
    localJudgeDownloadReq.sQQVersion = aqgz.getQQVersion();
    localJudgeDownloadReq.fMinCPUFreq = ((float)aqgz.getCpuFrequency());
    localJudgeDownloadReq.fMaxCPUFreq = ((float)aqgz.getCpuMaxFreq());
    localJudgeDownloadReq.iCores = aqgz.getCpuNumber();
    localJudgeDownloadReq.iMemory = (aqgz.getSystemTotalMemory() / 1024L);
