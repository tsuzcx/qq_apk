...
public class aeds
{
  ...
  public static boolean checkOpForVivo(Context paramContext)
  {
    ...
    //   4: astore 4
    //   6: ldc 48
    //   8: invokestatic 54	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   11: astore 5
    //   13: new 56	java/lang/StringBuilder
    //   16: dup
    //   17: invokespecial 60	java/lang/StringBuilder:<init>	()V
    //   20: ldc 62
    //   22: invokevirtual 66	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   25: aload_0
    //   26: invokevirtual 70	android/content/Context:getPackageName	()Ljava/lang/String;
    ...
    //   57: aconst_null
    //   58: aconst_null
    //   59: invokestatic 83	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   62: astore 5
    //   64: aload 5
    //   66: ifnull +97 -> 163
    //   69: aload 5
    ...
    //   119: iconst_1
    //   120: iload_1
    //   121: invokestatic 102	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   124: aastore
    //   125: dup
    //   126: iconst_2
    //   127: ldc 104
    ...
    //   131: iconst_3
    //   132: iload_2
    //   133: invokestatic 109	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   136: aastore
    //   137: invokestatic 115	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   140: iload_2
    //   141: istore_3
    //   142: aload 5
    //   144: ifnull +12 -> 156
    ...
    //   165: astore 4
    //   167: aload_0
    //   168: invokestatic 120	aeds:checkOpForCommon	(Landroid/content/Context;)Z
    //   171: istore_2
    //   172: aload 5
    //   174: astore 4
    //   176: ldc 94
    ...
    //   189: iconst_1
    //   190: iload_2
    //   191: invokestatic 109	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   194: aastore
    //   195: dup
    //   196: iconst_2
    //   197: ldc 124
    ...
    //   202: aload 5
    //   204: aastore
    //   205: invokestatic 115	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   208: goto -68 -> 140
    //   211: astore 6
    //   213: aload 5
    //   215: astore 4
    ...
    //   220: ldc 126
    //   222: aload 6
    //   224: invokestatic 130	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   227: aload 5
    //   229: astore 4
    //   231: aload_0
    //   232: invokestatic 120	aeds:checkOpForCommon	(Landroid/content/Context;)Z
    //   235: istore_2
    //   236: iload_2
    //   237: istore_3
    //   238: aload 5
