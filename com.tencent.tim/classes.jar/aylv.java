...
public class aylv
  implements aykb.a
{
  public aylv(DoodleLayout paramDoodleLayout) {}
  ...
  public boolean a(aykb.b paramb)
  {
    if (this.this$0.a != null)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        rar.a("video_shoot_new", "qa_edit", 1, 0, new String[0]);
        return true;
      }
    }
    return false;
  ...
  public void eRT()
  {
    ram.d("DoodleLayout", "deleteVote.");
    if (DoodleLayout.a(this.this$0) != null)
    {
      ayio localayio = (ayio)DoodleLayout.a(this.this$0).a(ayio.class);
      if (localayio != null) {
        localayio.eRT();
      }
    }
