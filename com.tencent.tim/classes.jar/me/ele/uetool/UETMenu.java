  ...
  extends LinearLayout
{
  ...
  private Handler hideHandler = new MyHandler(this);
  ...
  private void startAnim()
  {
    ...
    label77:
    for (Object localObject = this.defaultInterpolator;; localObject = new ReverseInterpolator(this.defaultInterpolator))
    {
    ...
    extends Handler
  {
    ...
    MyHandler(UETMenu paramUETMenu)
    {
    ...
    {
      if (System.currentTimeMillis() - ((UETMenu)this.uetMenu.get()).curTime < 4500L) {
        return;
      }
      synchronized ((UETMenu)this.uetMenu.get())
      {
        if (((UETMenu)this.uetMenu.get()).isOpen) {
          ((UETMenu)this.uetMenu.get()).hide();
        }
        return;
      }
    }
  ...
  static class ReverseInterpolator
    implements TimeInterpolator
  {
    private TimeInterpolator mWrappedInterpolator;
    
    ReverseInterpolator(TimeInterpolator paramTimeInterpolator)
    {
