...
public class UETool
{
  ...
  {
    this.callbacks = new LifeCallBack(null);
    ...
    implements Application.ActivityLifecycleCallbacks
  {
    ...
    public void onActivityStarted(Activity paramActivity)
    {
      ...
      if ((Build.VERSION.SDK_INT >= 23) && (!Settings.canDrawOverlays(me.ele.uetool.base.Application.getApplicationContext()))) {}
      while ((!UETool.isShow) || (this.currActivity.get() <= 0) || ((UETool.getInstance().getUetMenu() != null) && (UETool.getInstance().getUetMenu().isShown()))) {
        return;
      }
    ...
    public void onActivityStopped(Activity paramActivity)
    {
      ...
      if ((Build.VERSION.SDK_INT >= 23) && (!Settings.canDrawOverlays(me.ele.uetool.base.Application.getApplicationContext()))) {}
      while ((!UETool.isShow) || (this.currActivity.get() > 0)) {
        return;
      }
