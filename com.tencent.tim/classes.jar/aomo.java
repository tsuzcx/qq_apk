  ...
  extends aoiz
{
    ...
    throws Exception
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool1)
        {
          aqhq.copyFile(paramURLDrawableHandler, paramDownloadParams);
          localFile2.delete();
          return localFile1;
        }
      }
    ...
    throws Exception
  {
    ...
    //   36: aload_1
    //   37: invokevirtual 180	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   67: dup
    //   68: invokespecial 183	android/graphics/BitmapFactory$Options:<init>	()V
    //   71: astore 6
    //   73: aload 6
    //   75: iconst_1
    //   76: putfield 187	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   79: aload_1
    //   80: invokevirtual 180	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   83: aload 6
    //   85: invokestatic 192	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   88: pop
    //   89: aload 6
    //   91: aload 6
    //   93: sipush 160
    //   96: sipush 160
    //   99: invokestatic 194	aomo:calculateInSampleSize	(Landroid/graphics/BitmapFactory$Options;II)I
    //   102: putfield 197	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   105: aload 6
    //   107: iconst_0
    //   108: putfield 187	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   111: new 199	java/io/BufferedInputStream
    //   114: dup
    //   115: new 201	java/io/FileInputStream
    //   118: dup
    //   119: aload_1
    //   120: invokevirtual 180	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   123: invokespecial 202	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   126: invokespecial 205	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   129: astore 5
    //   131: aload 5
    //   133: astore 4
    //   135: aload 5
    //   137: aconst_null
    //   138: aload 6
    //   140: invokestatic 209	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   143: astore 6
    //   145: aload 5
    //   147: ifnull +8 -> 155
    //   150: aload 5
    //   152: invokevirtual 214	java/io/InputStream:close	()V
    //   155: aload 6
    //   157: areturn
    //   158: astore 6
    //   160: aconst_null
    ...
    //   192: aload 6
    //   194: invokevirtual 219	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    ...
    //   203: invokestatic 222	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   206: aload 5
    //   208: ifnull +8 -> 216
    //   211: aload 5
    //   213: invokevirtual 214	java/io/InputStream:close	()V
    //   216: aload_0
    //   217: aload_1
    //   218: aload_2
    //   219: aload_3
    //   220: invokespecial 224	aoiz:decodeFile	(Ljava/io/File;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/lang/Object;
    //   223: areturn
    //   224: astore_1
    //   225: aload 4
    //   227: astore_2
    ...
    //   229: ifnull +7 -> 236
    //   232: aload_2
    //   233: invokevirtual 214	java/io/InputStream:close	()V
    //   236: aload_1
    //   237: athrow
    //   238: astore_1
    //   239: aload 6
