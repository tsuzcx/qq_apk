  ...
  extends jnm.d
{
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    {
      label180:
      if ((paramArrayOfByte != null) && (awit.z(paramArrayOfByte)))
      {
        if ((paramInt != 0) || (paramBundle.size() <= 0)) {
          break label262;
        }
        QQToast.a(BaseApplicationImpl.getContext(), 0, "视频发表成功", 0).show();
      }
    }
    for (;;)
    {
      if (this.a != null) {
        this.a.bl(paramBundle);
      }
      return;
      label240:
      ...
      break label180;
      label262:
      QQToast.a(BaseApplicationImpl.getContext(), 0, "视频发表失败，errorCode=" + paramInt, 0).show();
    }
  }
}
