...
public class avqu
  extends Handler
{
  avqu(avqs paramavqs, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    paramMessage = avqs.b(BaseApplicationImpl.getApplication(), "qzone_plugin.apk");
    int i;
    ...
    for (;;)
    {
      ...
      avqs.a(this.a, i, avqs.a(this.a), k);
      ...
      {
        if (j != 0) {
          awcz.h(new CaughtQZonePluginException("start failed. " + paramMessage.getMessage()), localStringBuilder.toString());
        }
        if (i == 0) {
          break;
        }
