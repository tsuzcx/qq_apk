...
public class aetr
{
  ...
  private int cPg;
  private int cPh;
  private SparseArray<aetr.a> ct = new SparseArray();
  private Map<String, String> ka = new HashMap();
  private Map<String, aetr.a> kb = new HashMap();
  private Map<String, String> kc = new HashMap();
  private int mMaxCount;
  private List<aetr.b> za = new ArrayList();
  
  public static aetr a(aeic[] paramArrayOfaeic)
  {
    if ((paramArrayOfaeic == null) || (paramArrayOfaeic.length <= 0)) {
      return null;
    }
    Object localObject1 = paramArrayOfaeic[0].content;
    paramArrayOfaeic = new aetr();
    ...
    do
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        localObject5 = (aetr.a)paramArrayOfaeic.kb.get(localObject3);
        str1 = ((JSONObject)localObject4).optString("key");
        ((aetr.a)localObject5).eH = n(str1);
        if (paramArrayOfaeic.cPg == 1) {
          ((aetr.a)localObject5).strTips = ((JSONObject)localObject4).optString("Tips1");
        }
        for (((aetr.a)localObject5).bBr = ((JSONObject)localObject4).optString("Link1");; ((aetr.a)localObject5).bBr = ((JSONObject)localObject4).optString("Link0"))
        {
          paramArrayOfaeic.kb.put(localObject3, localObject5);
          paramArrayOfaeic.kc.put("key_str_key_words" + (String)localObject3, str1);
          paramArrayOfaeic.kc.put("key_str_key_tips" + (String)localObject3, ((aetr.a)localObject5).strTips);
          paramArrayOfaeic.kc.put("key_str_key_link" + (String)localObject3, ((aetr.a)localObject5).bBr);
          break;
          ((aetr.a)localObject5).strTips = ((JSONObject)localObject4).optString("Tips0");
        }
      }
  ...
  private static void a(JSONObject paramJSONObject, aetr paramaetr)
    throws JSONException
  {
    ...
    if (i < localJSONArray.length())
    {
      ...
      aetr.a locala = new aetr.a();
      paramaetr.cPh = paramJSONObject.optInt("containKeyword");
      if (paramaetr.cPh == 1) {
