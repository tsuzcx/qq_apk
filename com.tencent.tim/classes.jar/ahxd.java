  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, i, bool1, (Bundle)localObject1, ahxc.class);
      return;
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      paramPacket.putSendData(aqnv.I(paramIntent.getByteArrayExtra("RequestBytes")));
      return;
      if (str.equals("QQApkSvc.check_download_apk")) {
        paramPacket.setTimeout(((adxg.a)aeif.a().o(416)).cKy);
      } else if (str.equals("QQApkSvc.check_jump_apk")) {
        paramPacket.setTimeout(((adxg.a)aeif.a().o(416)).cKz);
      }
    }
  }
}
