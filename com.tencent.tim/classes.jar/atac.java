...
public class atac
{
  ...
  public static int bL(Context paramContext, String paramString)
  {
    ...
    //   1: aload_1
    //   2: iconst_0
    //   3: invokevirtual 110	android/content/Context:createPackageContext	(Ljava/lang/String;I)Landroid/content/Context;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnonnull +15 -> 23
    //   11: iconst_0
    ...
    //   13: astore_1
    //   14: aload_1
    //   15: invokevirtual 114	android/content/pm/PackageManager$NameNotFoundException:printStackTrace	()V
    //   18: aconst_null
    //   19: astore_1
    //   20: goto -13 -> 7
    //   23: aload_1
    //   24: invokevirtual 118	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   27: astore 5
    //   29: new 97	android/content/res/Resources
    //   32: dup
    //   33: aload 5
    //   35: aload_0
    //   36: invokevirtual 122	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   39: invokevirtual 126	android/content/res/Resources:getDisplayMetrics	()Landroid/util/DisplayMetrics;
    //   42: aconst_null
    //   43: invokespecial 130	android/content/res/Resources:<init>	(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
    //   46: astore 4
    //   48: aload_1
    //   49: aload 5
    //   51: invokestatic 132	atac:a	(Landroid/content/Context;Landroid/content/res/AssetManager;)Landroid/content/res/XmlResourceParser;
    //   54: astore_0
    //   55: aload_0
    //   56: ifnull -45 -> 11
    //   59: aload_0
    ...
    //   104: astore_0
    //   105: aload_0
    //   106: invokevirtual 140	java/io/IOException:printStackTrace	()V
    //   109: aconst_null
    //   110: astore_0
    //   111: goto -56 -> 55
    //   114: astore_1
    //   115: aload_1
    //   116: invokevirtual 141	org/xmlpull/v1/XmlPullParserException:printStackTrace	()V
    //   119: iconst_0
    //   120: istore_2
    //   121: goto -55 -> 66
    //   124: aload_0
    ...
    //   138: aload_1
    //   139: ldc 152
    //   141: invokevirtual 48	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   144: ifeq -52 -> 92
    //   147: aload_0
    //   148: aload 4
    //   150: ldc 154
    //   152: invokestatic 156	atac:a	(Landroid/content/res/XmlResourceParser;Landroid/content/res/Resources;Ljava/lang/String;)Ljava/lang/String;
    //   155: astore_0
    //   156: aload_0
    //   157: invokestatic 150	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   160: ifne -149 -> 11
    //   163: aload_0
    //   164: invokestatic 95	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   167: ireturn
    //   168: astore_1
    //   169: aload_1
    //   170: invokevirtual 141	org/xmlpull/v1/XmlPullParserException:printStackTrace	()V
    //   173: goto -107 -> 66
    //   176: astore_1
    //   177: aload_1
    //   178: invokevirtual 140	java/io/IOException:printStackTrace	()V
    //   181: goto -115 -> 66
