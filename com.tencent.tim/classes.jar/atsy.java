...
public class atsy
  implements atuq.b
{
  protected LinkedHashMap<Long, atsy.a> Y = new LinkedHashMap();
  protected QQAppInterface app;
  
  public atsy(QQAppInterface paramQQAppInterface)
  {
  ...
  protected final atsy.a a(long paramLong)
  {
    synchronized (this.Y)
    {
      atsy.a locala = (atsy.a)this.Y.get(Long.valueOf(paramLong));
      return locala;
    }
  }
  ...
  protected final void a(long paramLong, boolean paramBoolean, String paramString1, int paramInt, String paramString2, String paramString3, String paramString4)
  {
    QLog.i("BaseThumbDownloader<FileAssistant>", 2, "[downloadThumb]  ID[" + paramLong + "] onGetDownloadUrlResult suc:" + paramBoolean + " strDomain:" + paramString1 + " port:" + paramInt + " urlParam:" + paramString2 + " cookie:" + paramString4);
    this.app.a().a().b(paramLong, paramBoolean, paramString1, paramInt, paramString2, paramString3, paramString4);
  }
  
  protected final void a(atsy.a parama)
  {
    if (parama == null)
    {
  ...
  protected void a(atsy.a parama, String paramString)
  {
