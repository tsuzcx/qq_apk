  ...
  extends zkw
{
  ...
  int cdG = 0;
  private View.OnClickListener clickListener = new zna(this);
  View footerView;
  boolean gV = false;
  LinearLayout hI;
  ...
  public zmw(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void cpP()
  {
    ((ImageButton)findViewById(2131368696)).setOnClickListener(new zmy(this));
    Button localButton = (Button)findViewById(2131363801);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new zmz(this));
  }
  ...
  private void cpQ()
  {
    ...
    this.a = new zjk(this.mContext, this.b, this.sessionInfo, this.app);
    this.F.setAdapter(this.a);
    this.F.setOnScrollListener(new znb(this));
    this.F.setOnTouchListener(new znc(this));
    this.F.setOnItemClickListener(new znd(this));
    this.F.setOnItemLongClickListener(new zne(this));
  }
  ...
  private void gT()
  {
    ...
    this.v.addTextChangedListener(new zmx(this));
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.MS.setText(acfp.m(2131715538));
      ...
      {
        this.MS.setText(acfp.m(2131715540));
        this.hI.findViewById(2131373660).setVisibility(8);
        this.hI.setVisibility(0);
        this.footerView.setVisibility(0);
      }
