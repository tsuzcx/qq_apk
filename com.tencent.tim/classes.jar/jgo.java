...
public class jgo
{
  public static byte[] a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    ...
    for (byte[] arrayOfByte = d(paramArrayOfByte, paramInt2, paramInt5);; arrayOfByte = paramArrayOfByte)
    {
      paramArrayOfByte = arrayOfByte;
      if (paramInt3 != paramInt6) {
        paramArrayOfByte = c(arrayOfByte, paramInt3, paramInt6, paramInt5);
      }
      arrayOfByte = paramArrayOfByte;
      if (paramInt1 != paramInt4) {
        arrayOfByte = d(paramArrayOfByte, paramInt5, paramInt1, paramInt4);
      }
      return arrayOfByte;
    }
  }
