...
public class cz
{
  private static String bK = "9u23fh$jkf^%43hj";
  private static String bL = "1234567890123456";
  ...
  public static byte[] getFileMd5(String paramString)
  {
    ...
    //   5: astore 9
    //   7: ldc 61
    //   9: invokestatic 67	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   12: astore 10
    //   14: new 69	java/io/FileInputStream
    //   17: dup
    //   18: aload_0
    //   19: invokespecial 70	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   22: astore 8
    //   24: aload 8
    //   26: astore 7
    //   28: new 72	com/tencent/mm/vfs/VFSFile
    //   31: dup
    //   32: aload_0
    //   33: invokespecial 73	com/tencent/mm/vfs/VFSFile:<init>	(Ljava/lang/String;)V
    //   36: invokevirtual 77	com/tencent/mm/vfs/VFSFile:length	()J
    //   39: lstore 5
    //   41: lload 5
    //   43: ldc2_w 58
    //   46: lcmp
    ...
    //   70: aload 8
    //   72: aload_0
    //   73: invokevirtual 83	java/io/InputStream:read	([B)I
    //   76: istore_2
    //   77: iload_2
    //   78: iconst_m1
    //   79: if_icmpeq +62 -> 141
    ...
    //   106: iconst_0
    //   107: iload_1
    //   108: invokevirtual 87	java/security/MessageDigest:update	([BII)V
    //   111: goto -51 -> 60
    //   114: astore_0
    //   115: aload 8
    //   117: astore 7
    //   119: aload_0
    //   120: invokevirtual 90	java/security/NoSuchAlgorithmException:printStackTrace	()V
    //   123: aload 9
    //   125: astore_0
    //   126: aload 8
    //   128: ifnull +11 -> 139
    //   131: aload 8
    //   133: invokevirtual 93	java/io/InputStream:close	()V
    //   136: aload 9
    //   138: astore_0
    //   139: aload_0
    //   140: areturn
    ...
    //   143: astore 7
    //   145: aload 8
    //   147: invokevirtual 93	java/io/InputStream:close	()V
    //   150: aload 8
    //   152: astore 7
    //   154: aload 10
    //   156: invokevirtual 97	java/security/MessageDigest:digest	()[B
    //   159: astore_0
    //   160: aload_0
    //   161: astore 7
    //   163: aload 7
    ...
    //   168: ifnull -29 -> 139
    //   171: aload 8
    //   173: invokevirtual 93	java/io/InputStream:close	()V
    //   176: aload 7
    //   178: areturn
    //   179: astore_0
    //   180: aload_0
    //   181: invokevirtual 98	java/io/IOException:printStackTrace	()V
    //   184: aload 7
    //   186: areturn
    //   187: astore_0
    //   188: aload_0
    //   189: invokevirtual 98	java/io/IOException:printStackTrace	()V
    //   192: aconst_null
    //   193: areturn
    //   194: astore_0
    //   195: aconst_null
    ...
    //   200: astore 7
    //   202: aload_0
    //   203: invokevirtual 99	java/io/FileNotFoundException:printStackTrace	()V
    //   206: aload 9
    //   208: astore_0
    //   209: aload 8
    //   211: ifnull -72 -> 139
    //   214: aload 8
    //   216: invokevirtual 93	java/io/InputStream:close	()V
    //   219: aconst_null
    //   220: areturn
    //   221: astore_0
    //   222: aload_0
    //   223: invokevirtual 98	java/io/IOException:printStackTrace	()V
    //   226: aconst_null
    //   227: areturn
    //   228: astore_0
    //   229: aconst_null
    ...
    //   234: astore 7
    //   236: aload_0
    //   237: invokevirtual 98	java/io/IOException:printStackTrace	()V
    //   240: aload 9
    //   242: astore_0
    //   243: aload 8
    //   245: ifnull -106 -> 139
    ...
    //   255: astore_0
    //   256: aload_0
    //   257: invokevirtual 98	java/io/IOException:printStackTrace	()V
    //   260: aconst_null
    //   261: areturn
    //   262: astore_0
    //   263: aconst_null
    ...
    //   268: ifnull +8 -> 276
    //   271: aload 7
    //   273: invokevirtual 93	java/io/InputStream:close	()V
    //   276: aload_0
    //   277: athrow
    //   278: astore 7
    //   280: aload 7
    //   282: invokevirtual 98	java/io/IOException:printStackTrace	()V
    //   285: goto -9 -> 276
    //   288: astore_0
    //   289: goto -23 -> 266
    //   292: astore_0
  ...
  public static long s()
  {
    ...
    try
    {
      int i = alkz.a(localWifiManager).getIpAddress();
      return i;
    }
