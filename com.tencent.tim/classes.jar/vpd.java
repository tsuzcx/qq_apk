...
{
  public vpd(QQMapActivity.MapRuntime paramMapRuntime) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if (paramContext.equals("com.tencent.process.exit"))
      {
        ...
        if ((!QQMapActivity.isLegalBroadcast(paramIntent.getExtras().getString("verify"), paramContext)) || (!aqcv.a(paramContext, MobileQQ.getContext()))) {
          break label144;
        }
        i = j;
      }
