...
public class aaor
  implements ConfigClearableEditText.b
{
  public aaor(TimLoginQQView paramTimLoginQQView, ImageView paramImageView, int paramInt) {}
  
  public void Cx(boolean paramBoolean)
  {
    ImageView localImageView = this.wo;
    if (paramBoolean) {}
    for (int i = 0;; i = 8)
    {
