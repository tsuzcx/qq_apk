...
public class anib
{
  ...
  /* Error */
  public anib.a a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 185	anib:mMediaCodec	Landroid/media/MediaCodec;
    //   4: ifnonnull +5 -> 9
    //   7: aconst_null
    //   8: areturn
    //   9: new 6	anib$a
    //   12: dup
    //   13: aload_0
    //   14: invokespecial 195	anib$a:<init>	(Lanib;)V
    //   17: astore 4
    //   19: aload_0
    //   20: getfield 185	anib:mMediaCodec	Landroid/media/MediaCodec;
    //   23: lload_1
    ...
    //   42: aload 4
    //   44: iload_3
    //   45: putfield 202	anib$a:index	I
    //   48: aload 4
    //   50: aload_0
    //   51: getfield 204	anib:inputBuffers	[Ljava/nio/ByteBuffer;
    //   54: iload_3
    //   55: aaload
    //   56: putfield 208	anib$a:buffer	Ljava/nio/ByteBuffer;
    //   59: aload_0
    //   60: monitorexit
    //   61: aload 4
    //   63: areturn
    ...
    //   73: aload 4
    //   75: iload_3
    //   76: putfield 202	anib$a:index	I
    //   79: aload 4
    //   81: getstatic 144	anib:k	Ljava/lang/reflect/Method;
    //   84: aload_0
    //   85: getfield 185	anib:mMediaCodec	Landroid/media/MediaCodec;
    //   88: iconst_1
    ...
    //   105: putfield 208	anib$a:buffer	Ljava/nio/ByteBuffer;
    //   108: aload_0
    //   109: monitorexit
    //   110: aload 4
    //   112: areturn
    ...
    //   120: aload 4
    //   122: iconst_0
    //   123: putfield 226	anib$a:success	Z
    //   126: goto -18 -> 108
    //   129: astore 4
    //   131: aload_0
    //   132: monitorexit
    ...
    //   143: aload 4
    //   145: iconst_0
    //   146: putfield 226	anib$a:success	Z
    //   149: goto -41 -> 108
    //   152: astore 5
    //   154: aload 5
    ...
    //   159: aload 4
    //   161: iconst_0
    //   162: putfield 226	anib$a:success	Z
    //   165: goto -57 -> 108
    //   168: aload 4
    //   170: iload_3
    //   171: putfield 202	anib$a:index	I
    //   174: aload 4
    //   176: areturn
    ...
    //   27	144	3	i	int
    //   17	45	4	locala1	anib.a
    //   64	57	4	locala2	anib.a
    //   129	46	4	locala3	anib.a
  ...
  public void a(anib.a parama, int paramInt1, long paramLong, int paramInt2)
  {
    try
    {
      if (this.mMediaCodec != null) {
  ...
  public anib.a b(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject5 = new anib.a();
        i = this.mMediaCodec.dequeueOutputBuffer(((anib.a)localObject5).info, paramLong);
        switch (i)
        {
        case -3: 
          if (i < 0) {
          ...
          if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, "dequeueOutputBuffer ok,index = " + i + ",BufferInfo[flags = " + ((anib.a)localObject5).info.flags + ",offset=" + ((anib.a)localObject5).info.offset + ",size= " + ((anib.a)localObject5).info.size + ",TimeUs=" + ((anib.a)localObject5).info.presentationTimeUs + "]");
          }
          if (Build.VERSION.SDK_INT > 20) {
            break label444;
          }
          ((anib.a)localObject5).buffer = this.outputBuffers[i];
          ((anib.a)localObject5).index = i;
          ((anib.a)localObject5).format = this.mOutputFormat;
          ...
          ((anib.a)localObject5).index = -3;
        }
      }
      finally {}
      ((anib.a)localObject5).index = -2;
      ...
      if (this.mOutputFormat != null)
      {
        ...
        else if (QLog.isColorLevel())
        {
          ...
          try
          {
            ((anib.a)localObject5).buffer = ((ByteBuffer)l.invoke(this.mMediaCodec, new Object[] { Integer.valueOf(i) }));
            ((anib.a)localObject5).format = ((MediaFormat)m.invoke(this.mMediaCodec, new Object[] { Integer.valueOf(i) }));
          ...
          catch (IllegalAccessException localIllegalAccessException)
          {
            for (;;)
            {
              ...
              ((anib.a)localObject5).success = false;
            }
          }
