...
public class aopa
{
  ...
  private static String fI(int paramInt)
  {
    switch (paramInt)
    {
    default: 
    ...
    case 1: 
    case 2: 
      return BaseApplicationImpl.getApplication().getResources().getString(2131690217);
    }
    return BaseApplicationImpl.getApplication().getResources().getString(2131690216);
  }
}
