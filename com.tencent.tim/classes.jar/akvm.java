...
{
  public akvm(SQLiteOpenHelper paramSQLiteOpenHelper, String paramString)
  {
  ...
  public List<MessageRecord> a(String paramString1, String paramString2, String paramString3, String[] paramArrayOfString, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((paramString1 != null) && (paramString1.size() > 0))
    {
      ...
      while (paramString2.hasNext())
      {
        ...
        paramQQAppInterface.b().d(paramString3.frienduin, paramString3.istroop, paramString3);
      }
    }
    return paramString1;
  }
  ...
  public List<MessageRecord> a(String paramString, String[] paramArrayOfString, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((paramString != null) && (paramString.size() > 0))
    {
      ...
      while (paramArrayOfString.hasNext())
      {
        ...
        paramQQAppInterface.b().d(localMessageRecord.frienduin, localMessageRecord.istroop, localMessageRecord);
      }
    }
    return paramString;
  }
    ...
    catch (Exception paramNoColumnErrorHandler)
    {
      try
      {
        if (paramClass.getName().equals(MessageRecord.class.getName()))
        {
          ...
          MessageRecord localMessageRecord = anbi.a(i, paramClass, j, paramNoColumnErrorHandler, k);
