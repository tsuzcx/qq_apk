...
public class kdp
  extends accg
{
  public kdp(QQAppInterface paramQQAppInterface)
  {
  ...
  private void J(byte[] paramArrayOfByte)
  {
    ...
    if ((paramArrayOfByte != null) && (paramArrayOfByte.bindlist.has()))
    {
      ...
      if ((paramArrayOfByte != null) && (!paramArrayOfByte.isEmpty()))
      {
        ...
        {
          kdm.da.put(String.valueOf(paramArrayOfByte.puin.get()), String.valueOf(paramArrayOfByte.binduin.get()));
  ...
  public void lV(String paramString)
  {
    ...
    paramString = new NewIntent(this.app.getApp(), kdr.class);
