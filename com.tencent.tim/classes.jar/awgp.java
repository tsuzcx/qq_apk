  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("com.qzone.topic.video.FakeFeed".equals(paramContext)) {
      if (!TextUtils.isEmpty(awgo.a(this.this$0))) {}
    }
    int i;
    do
    {
      ...
      do
      {
        ...
        localObject2 = awfn.c(paramContext, i, j, true);
        ...
        try
        {
          ...
          this.this$0.f.callJs(awgo.a(this.this$0), new String[] { ((JSONObject)localObject1).toString() });
          return;
        }
      ...
      } while (TextUtils.isEmpty(awgo.a(this.this$0)));
      ...
      try
      {
        ...
        this.this$0.f.callJs(awgo.a(this.this$0), new String[] { ((JSONObject)localObject2).toString() });
        return;
      }
      catch (JSONException paramContext)
      {
    ...
    } while ((!"com.qzone.h5.video.recordCallback".equals(paramContext)) || (TextUtils.isEmpty(awgo.b(this.this$0))));
    ...
    Object localObject2 = awfn.c(paramContext, paramIntent.getIntExtra("param.thumbnailWidth", 0), paramIntent.getIntExtra("param.thumbnailHeight", 0), true);
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool)
        {
          ...
          ((JSONObject)localObject1).put("video_info", awgo.a(this.this$0, paramIntent));
          this.this$0.f.callJs(awgo.b(this.this$0), new String[] { ((JSONObject)localObject1).toString() });
          return;
        }
      }
      catch (JSONException paramContext)
