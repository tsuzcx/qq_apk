...
public class ammd
  extends acnl
{
  public ammd(ActiveEntitySearchFragment paramActiveEntitySearchFragment) {}
  ...
  {
    if (!this.b.isAdded()) {
      QLog.e(ActiveEntitySearchFragment.TAG, 1, "Unify handleTabSearchError, fragment is detached ..., reqKeyword=" + paramString1 + " isFirstReq=" + paramBoolean + " reqTime=" + paramString2 + " resultCode=" + paramInt + " errorMsg=" + paramString3);
    }
    ...
    for (;;)
    {
      try
      {
        ...
        this.b.YG.setText(acfp.m(2131701993));
        this.b.CQ.setOnClickListener(new ammf(this));
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w(ActiveEntitySearchFragment.TAG, 2, "Unify handleTabSearchError code=" + paramInt + " mask;" + Arrays.toString(paramArrayOfLong) + " key=" + paramString1 + " name=" + this.b.name);
        return;
      }
      ...
      this.b.YI.setOnClickListener(new ammg(this));
    }
  }
  ...
  public void a(String paramString1, boolean paramBoolean1, String paramString2, byte[] paramArrayOfByte, boolean paramBoolean2, List<ampw> paramList, long[] paramArrayOfLong, String paramString3, List<DynamicTabSearch.SubHotWord> paramList1, boolean paramBoolean3, String paramString4)
  {
    if (!this.b.isAdded())
    {
      QLog.e(ActiveEntitySearchFragment.TAG, 1, "Unify handleTabSearchResult, fragment is detached ..., reqKeyword=" + paramString1 + " keyword=" + this.b.keyword + " reqTime=" + paramString2 + " lastReqTime=" + this.b.caF + " isEnd1=" + paramBoolean2);
      return;
    }
    if (!TextUtils.equals(paramString2, this.b.caF))
    {
      QLog.d(ActiveEntitySearchFragment.TAG, 2, "Unify handleTabSearchResult. reqKeyword=" + paramString1 + " keyword=" + this.b.keyword + " reqTime=" + paramString2 + " lastReqTime=" + this.b.caF + " isEnd1=" + paramBoolean2);
      return;
    }
    if ((!ActiveEntitySearchFragment.a(this.b.as, paramArrayOfLong)) || (!paramString1.equals(this.b.keyword)))
    {
      QLog.d(ActiveEntitySearchFragment.TAG, 2, "Unify handleTabSearchResult. masks=" + this.b.as + " reqMasks=" + paramArrayOfLong + " reqKeyword=" + paramString1 + " keyword=" + this.b.keyword + " isEnd1=" + paramBoolean2);
      return;
    }
    if (paramList == null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(ActiveEntitySearchFragment.TAG, 2, "Unify handleTabSearchResult result=" + paramList);
      }
    ...
    for (;;)
    {
      ...
      if (!paramBoolean1)
      {
        ...
        default: 
          if (QLog.isColorLevel()) {
            QLog.i(ActiveEntitySearchFragment.TAG, 2, "Unify handleTabSearchResult isFirstReq==" + paramBoolean1 + " newSearchDataCount:" + this.b.dCR + "   newSearchIndex:" + this.b.dCQ + " result.size():" + j);
          }
          this.b.GY.setVisibility(8);
      ...
      for (;;)
      {
        ...
        catch (JSONException paramArrayOfByte)
        {
          ...
          QLog.e(ActiveEntitySearchFragment.TAG, 2, "Unify handleTabSearchResult extension parse error! " + QLog.getStackTraceString(paramArrayOfByte));
          paramString3 = "";
        ...
        case 3: 
          ...
          break;
          if (QLog.isColorLevel()) {
            QLog.i(ActiveEntitySearchFragment.TAG, 2, "Unify handleTabSearchResult extension is null");
          }
          bool1 = false;
          paramString2 = "";
          paramArrayOfByte = "";
      ...
      if ((!TextUtils.isEmpty(ActiveEntitySearchFragment.a(this.b))) && (ActiveEntitySearchFragment.a(this.b).size() > 0))
      {
        ...
        if ((paramString3 == null) || (paramString3.isFinishing()))
        {
          ...
          QLog.d(ActiveEntitySearchFragment.TAG, 2, "Unify activity is finished. in handleTabSearchResult.");
          return;
        }
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.i(ActiveEntitySearchFragment.TAG, 2, "Unify handleTabSearchResult isEnd = true mask;" + Arrays.toString(paramArrayOfLong) + " key=" + paramString1 + " name=" + this.b.name + "  fragmentMask=" + Arrays.toString(this.b.as));
            }
          }
          for (;;)
          {
            ...
            if ((paramList == null) || (paramList.isEmpty()))
            {
              ...
              if ((!bool1) && (paramString3.bIf)) {
                if (this.b.c == null)
                {
                  ...
                  paramArrayOfByte.setText(acfp.m(2131701995));
                  ...
                  paramArrayOfByte.setText(acfp.m(2131702001));
                  paramArrayOfByte.setBackgroundResource(2130838901);
                  paramString2.addHeaderView(paramArrayOfByte);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                try
                {
                  ...
                  this.b.YG.setText(acfp.m(2131701990));
                  if (bool1)
                  {
                    this.b.hd.setVisibility(0);
                    this.b.hd.setOnClickListener(new amme(this, paramString2));
            ...
            label3317:
            if (QLog.isColorLevel()) {
              QLog.i(ActiveEntitySearchFragment.TAG, 2, "Unify handleTabSearchResult isEnd = false mask;" + Arrays.toString(paramArrayOfLong) + " key=" + paramString1 + " name=" + this.b.name + "  fragmentMask=" + Arrays.toString(this.b.as));
            }
          }
          k = 0;
        }
