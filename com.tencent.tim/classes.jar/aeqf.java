  ...
  implements aehx<String>, aepn
{
  ...
  private void bb(JSONObject paramJSONObject)
  {
    try
    {
      ...
      for (;;)
      {
        QLog.i("QFileExcitingGroupUploadConfigBean<FileAssistant>", 1, "parse Exciting-Group-Upload config: enable:" + this.mEnable + " LimitedSize:" + this.WD + " " + this.a.toString());
        return;
        this.WD = 20971520L;
