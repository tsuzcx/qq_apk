...
{
  public alaz(CustomCoverFragment paramCustomCoverFragment) {}
  
  public void onClick(View paramView)
  {
    int i = 1;
    if (paramView.getId() == 2131369698) {
      if (CustomCoverFragment.a(this.a) != null)
      {
        ...
        localObject = (acle)CustomCoverFragment.a(this.a).getBusinessHandler(13);
        if (!CustomCoverFragment.b(this.a)) {
          break label171;
        }
        i = 1;
        ((acle)localObject).JR(i);
        CustomCoverFragment.a(this.a).a(0, this.a.getString(2131701247), 0, CustomCoverFragment.a(this.a));
    ...
    for (int j = ((Integer)localObject).intValue();; j = 0)
    {
      if ((paramView instanceof Button))
      {
        if (CustomCoverFragment.c(this.a))
        {
          QQToast.a(this.a.getActivity(), 0, 2131691283, 0).show();
          break;
        }
      ...
      for (i = 2;; i = 0)
      {
        ...
        PublicFragmentActivity.b.startForResult(this.a.getActivity(), (Intent)localObject, PublicFragmentActivity.class, CoverDetailFragment.class, 2001);
        break;
      }
    }
  }
