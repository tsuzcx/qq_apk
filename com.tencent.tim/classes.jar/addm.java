  ...
  extends addc
{
  ...
  public addm(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, String paramString4, ArCloudConfigInfo.a parama, int paramInt3, float paramFloat1, float paramFloat2, float paramFloat3)
  {
  ...
  public String toString()
  {
    ...
    localStringBuilder.append(", mLayout='").append(this.a).append('\'');
