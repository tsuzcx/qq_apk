  ...
  implements Observer
{
  ...
  volatile ConcurrentHashMap<String, List<aj.a>> d = null;
  ...
  public static n a()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 43	c/t/m/g/n:f	Lc/t/m/g/n;
    //   6: ifnonnull +19 -> 25
    //   9: ldc 2
    //   11: monitorenter
    //   12: new 2	c/t/m/g/n
    //   15: dup
    //   16: invokespecial 105	c/t/m/g/n:<init>	()V
    //   19: putstatic 43	c/t/m/g/n:f	Lc/t/m/g/n;
    //   22: ldc 2
    //   24: monitorexit
    //   25: getstatic 43	c/t/m/g/n:f	Lc/t/m/g/n;
    //   28: astore_0
    //   29: ldc 2
    //   31: monitorexit
    //   32: aload_0
  ...
  private void c()
  {
    ...
    {
      ai.a("CC_Set", localThrowable.getMessage(), localThrowable);
    }
  }
  
  private static void d()
  {
    SharedPreferences localSharedPreferences = o.a().b();
    if (localSharedPreferences == null) {}
    String str;
    do
    {
      return;
      str = (String)am.b(localSharedPreferences, "app_version", "");
    } while ((c.length() <= 0) || (c.equals(str)));
    ai.a(3, "CC_Set", "clear sp > pre:" + str + ",now:" + c, null);
    localSharedPreferences.edit().clear().apply();
    am.a(localSharedPreferences, "app_version", c);
  }
  ...
  private void f(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        ai.a("CC_Set", paramString.toString());
      }
    }
  }
  ...
  protected final void b()
  {
    if (o.a().b() == null)
    {
      ai.a(3, "CC_Set", "---> read xml: failed,not init finish!", null);
      return;
    }
    ...
    this.i = true;
    ai.a(3, "CC_Set", "---> read xml:" + this.h.toString(), null);
  }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      f(paramObservable);
      ai.a(3, "CC_Set", paramObject + (String)this.h.get(paramObservable), null);
