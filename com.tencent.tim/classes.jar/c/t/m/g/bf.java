...
{
  static Handler e;
  private static final Comparator<ScanResult> l = new bf.2();
  volatile boolean a;
  final ap b;
  boolean c;
  ...
  private void a(List<ScanResult> paramList)
  {
    ...
    for (;;)
    {
      paramList = new bn(paramList, this.g, this.f.getWifiState());
      this.b.b(paramList);
      return;
      if (cg.a)
      {
