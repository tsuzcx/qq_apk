...
{
  public yxq(TroopNotifyAndRecommendView paramTroopNotifyAndRecommendView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((((ywu)localObject2).bDQ != 2) || (!TroopInfo.isQidianPrivateTroop(((ywu)localObject2).a.msg.uint32_group_flagext3.get())))
      {
        ...
        localObject1 = new Intent(this.this$0.P, AccountDetailActivity.class);
    ...
    default: 
      ...
      label370:
      if (((acff)this.this$0.app.getManager(51)).isFriend((String)localObject1)) {
    ...
    for (;;)
    {
      ...
      anot.a(this.this$0.app, "P_CliOper", "Grp_contacts", "", "notice", "see_fromdata", 0, 0, ((ywu)localObject2).a.msg.group_code.get() + "", "3", "", "");
      break;
