  ...
  implements AladdinConfigHandler
{
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (TextUtils.equals(str1, "on_click"))
      {
        ...
        {
          awit.H("sp_key_biu_button_click_behaviour", Integer.valueOf(paramInt1));
          break;
        }
      }
      if (TextUtils.equals(str1, "on_long_pressed"))
      {
        ...
        for (paramInt1 = 1;; paramInt1 = 0)
        {
          awit.H("sp_key_biu_button_long_click_behaviour", Integer.valueOf(paramInt1));
          break;
        }
      }
    }
  ...
  {
    awit.H("sp_key_biu_button_click_behaviour", Integer.valueOf(0));
    awit.H("sp_key_biu_button_long_click_behaviour", Integer.valueOf(1));
  }
}
