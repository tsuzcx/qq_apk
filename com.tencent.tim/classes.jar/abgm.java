  ...
  extends accg
{
  ...
  public void a(List<Long> paramList, acci paramacci)
  {
    ...
    localAddonReqComm.mqqver.set("3.4.4");
    ...
    paramacci = super.createToServiceMsg("ReadDiyAddonInfo.1", paramacci);
      ...
      do
      {
        ...
        catch (Exception paramFromServiceMsg)
        {
          ...
          if ((paramFromServiceMsg.rspcmd0x01.has()) && (paramFromServiceMsg.rspcmd0x01.userdiyinfo.has()))
          {
            ...
            abgl.a().a(this.app, true, paramFromServiceMsg);
