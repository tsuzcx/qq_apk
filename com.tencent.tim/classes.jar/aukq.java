  ...
  implements acci
{
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
          ...
          do
          {
            do
            {
              do
              {
                ...
                fN((String)paramObject[0], (String)paramObject[1]);
                return;
              } while (paramObject == null);
              paramObject = (Object[])paramObject;
            } while (paramObject.length != 4);
            F((String)paramObject[0], (String)paramObject[1], (String)paramObject[2], (String)paramObject[3]);
            return;
          } while (paramObject == null);
          paramObject = (Object[])paramObject;
        } while (paramObject.length != 2);
    ...
    Ou(((Integer)paramObject[0]).intValue());
  }
}
