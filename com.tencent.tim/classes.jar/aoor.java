  ...
  extends aoiz
{
  ...
  public aoor(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  {
    if ((paramBitmap == null) || (this.b == null)) {
      return null;
    }
    ...
    {
      if (paramBoolean) {
        f1 = 5.0F * this.b.getResources().getDisplayMetrics().density + 0.5F;
      }
      Bitmap localBitmap = Bitmap.createBitmap(i, j, Bitmap.Config.ARGB_8888);
      Canvas localCanvas = new Canvas(localBitmap);
      Paint localPaint = new Paint();
      Rect localRect1 = new Rect((int)f2, (int)0.0F, (int)f5, (int)f6);
  ...
  private File a(String paramString, DownloadParams paramDownloadParams)
  {
    if ((paramDownloadParams.url != null) && (!TextUtils.isEmpty(paramDownloadParams.url.getFile())))
    {
      ...
      {
        str1 = str1;
        str1 = acbn.SDCARD_PATH + paramString + str1 + File.separator + str2;
      ...
      paramDownloadParams = new aquz(paramDownloadParams, paramString);
      paramDownloadParams.akN = afke.cRt;
  ...
  private void gg(String paramString, int paramInt)
  {
    if (("FAVOROTE_PANEL_DYNAMIC".equals(paramString)) || ("FAVORITE_PANEL_THUMB".equals(paramString)) || ("FAVORITE_PANEL_THUMB_NEW".equals(paramString))) {
      ajdg.fe(String.valueOf(paramInt), 6);
    }
  }
    ...
    throws Exception
  {
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        paramURLDrawableHandler = afgc.z(3, paramOutputStream);
      ...
      for (;;)
      {
        try
        {
          ...
          {
            return localObject2;
            paramURLDrawableHandler = afgc.z(4, paramOutputStream);
            break label196;
          }
          if (!bool1) {
            continue;
          ...
          paramOutputStream = afgc.A(3, paramOutputStream);
        }
        ...
        localObject2 = new aquz(paramURLDrawableHandler, (File)localObject1);
        ((aquz)localObject2).akN = afke.cRt;
        i = aqva.a((aquz)localObject2, null);
        gg(str, i);
        if (i != 0) {
          break;
        }
        if (((paramDownloadParams.mExtraInfo instanceof afpg)) && (("FAVORITE_PANEL_THUMB".equals(str)) || ("FAVORITE_PANEL_THUMB_NEW".equals(str)))) {
          a((afpg)paramDownloadParams.mExtraInfo);
        }
        if (QLog.isColorLevel()) {
          QLog.i("VasExtensionDownloader", 2, "download sucessful " + paramURLDrawableHandler + " to path " + paramOutputStream);
        }
        return localObject1;
        paramOutputStream = afgc.A(17, paramOutputStream);
        continue;
        if (!((Boolean)localObject1).booleanValue()) {
          paramOutputStream = afgc.A(4, paramOutputStream);
        } else {
          paramOutputStream = afgc.A(18, paramOutputStream);
        }
      }
      if (("FAVOROTE_PANEL_DYNAMIC".equals(str)) || ("BUSINESS_CAMERA_EMO_PANEL_DYNAMIC".equals(str)))
      {
        ...
        if ((paramDownloadParams.mExtraInfo instanceof afpg))
        {
          localObject1 = ((afpg)paramDownloadParams.mExtraInfo).url;
        ...
        {
          break label257;
          if ((paramDownloadParams.mExtraInfo instanceof aflv))
          {
            localObject1 = ((aflv)paramDownloadParams.mExtraInfo).url;
            paramURLDrawableHandler = (URLDrawableHandler)localObject1;
            if (QLog.isColorLevel())
            {
              QLog.i("VasExtensionDownloader", 2, String.format("File path %s is not exits, now need download %s", new Object[] { paramOutputStream, localObject1 }));
      ...
      if (("FAVORITE_PANEL_THUMB".equals(str)) || ("FAVORITE_PANEL_THUMB_NEW".equals(str)))
      {
        ...
        localObject2 = ((afpg)paramDownloadParams.mExtraInfo).url;
      ...
      for (paramURLDrawableHandler = (URLDrawableHandler)localObject2;; paramURLDrawableHandler = null)
      {
        ...
        if ("BUSINESS_CAMERA_EMO_PANEL_THUMB".equals(str))
        {
          ...
          localObject2 = ((aflv)paramDownloadParams.mExtraInfo).url;
          paramURLDrawableHandler = (URLDrawableHandler)localObject2;
          localObject1 = paramOutputStream;
          if (QLog.isColorLevel())
          {
        ...
        for (paramURLDrawableHandler = (URLDrawableHandler)localObject2;; paramURLDrawableHandler = null)
        {
          ...
          if ("REDPACKET_SEND_PIC".equals(str))
          {
            ...
            catch (Throwable paramOutputStream)
            {
              ...
              paramOutputStream = (acgn)paramOutputStream.getManager(131);
            }
            if (paramOutputStream == null) {
              break;
            }
            paramOutputStream = paramOutputStream.rD();
            if (QLog.isColorLevel()) {
          ...
          if (("COMMERCIAL_DRAINAGE".equals(str)) || ("IP_SITE_IMAGE".equals(str)))
          {
            ...
            for (i = 22;; i = 23)
            {
              paramDownloadParams = afgc.h(i, paramURLDrawableHandler, MD5.toMD5(paramDownloadParams.url.getFile()));
              if (QLog.isColorLevel()) {
            ...
            paramOutputStream = new aquz(paramOutputStream, paramDownloadParams);
            paramOutputStream.akN = afke.cRt;
            if (aqva.a(paramOutputStream, null) != 0) {
              break;
            }
            return paramDownloadParams;
          }
  ...
  public void a(afpg paramafpg)
  {
    if (paramafpg == null) {
      return;
    }
    ThreadManager.post(new VasExtensionDownloader.1(this, paramafpg), 5, null, false);
  }
    ...
    throws Exception
  {
    ...
    //   41: invokevirtual 427	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   54: invokevirtual 247	java/net/URL:getHost	()Ljava/lang/String;
    //   57: astore_3
    //   58: ldc_w 330
    //   61: aload_3
    //   62: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   65: ifeq +160 -> 225
    //   68: aload_2
    ...
    //   106: iconst_1
    //   107: ldc_w 429
    //   110: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   113: aconst_null
    //   114: areturn
    //   115: aload_1
    //   116: invokestatic 434	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   119: invokevirtual 437	java/lang/Integer:intValue	()I
    //   122: istore 4
    //   124: invokestatic 441	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   127: invokevirtual 34	com/tencent/common/app/BaseApplicationImpl:getResources	()Landroid/content/res/Resources;
    //   130: iload 4
    //   132: invokestatic 447	android/graphics/BitmapFactory:decodeResource	(Landroid/content/res/Resources;I)Landroid/graphics/Bitmap;
    //   135: astore_2
    //   136: aload_2
    //   137: areturn
    //   138: astore_2
    ...
    //   162: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   165: aconst_null
    //   166: areturn
    //   167: astore_2
    //   168: ldc 181
    ...
    //   191: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   194: aconst_null
    //   195: areturn
    //   196: astore_2
    //   197: ldc 181
    ...
    //   220: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   223: aconst_null
    //   224: areturn
    //   225: ldc_w 332
    //   228: aload_3
    //   229: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   232: ifeq +227 -> 459
    //   235: aload_2
    ...
    //   242: astore_3
    //   243: aload_3
    //   244: invokestatic 456	afgc:lP	(Ljava/lang/String;)Z
    //   247: ifeq +52 -> 299
    ...
    //   293: iconst_0
    //   294: fconst_0
    //   295: invokestatic 464	com/tencent/image/NativeGifFactory:getNativeGifObject	(Ljava/io/File;ZZIIF)Lcom/tencent/image/AbstractGifImage;
    //   298: areturn
    ...
    //   331: aload_3
    //   332: invokestatic 470	afgc:v	(Ljava/lang/String;)[B
    //   335: astore_1
    //   336: aload_1
    //   337: ifnull +92 -> 429
    //   340: aconst_null
    ...
    //   345: arraylength
    //   346: aconst_null
    //   347: invokestatic 474	android/graphics/BitmapFactory:decodeByteArray	([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   350: astore_1
    //   351: aload_1
    //   352: astore_2
    //   353: aload_2
    ...
    //   382: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   385: aconst_null
    //   386: areturn
    //   387: astore_1
    //   388: ldc_w 478
    ...
    //   412: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   415: goto -62 -> 353
    //   418: astore_1
    //   419: ldc 181
    //   421: iconst_1
    //   422: ldc_w 482
    //   425: aload_1
    //   426: invokestatic 485	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   429: aconst_null
    //   430: areturn
    //   431: astore_1
    //   432: ldc 181
    ...
    //   435: ldc_w 482
    //   438: aload_1
    //   439: invokestatic 485	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   442: goto -13 -> 429
    //   445: astore_1
    //   446: ldc 181
    //   448: iconst_1
    //   449: ldc_w 482
    //   452: aload_1
    //   453: invokestatic 485	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   456: goto -27 -> 429
    //   459: ldc_w 334
    //   462: aload_3
    //   463: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   466: ifeq +146 -> 612
    //   469: aload_1
    ...
    //   475: iconst_1
    //   476: ldc_w 487
    //   479: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   482: aconst_null
    //   483: areturn
    //   484: aload_1
    //   485: invokevirtual 490	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   488: astore_1
    ...
    //   521: new 494	java/io/FileInputStream
    //   524: dup
    //   525: aload_1
    //   526: invokespecial 495	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   529: astore_2
    //   530: new 497	java/io/BufferedInputStream
    //   533: dup
    //   534: aload_2
    //   535: invokespecial 500	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   538: invokestatic 506	com/tencent/image/SafeBitmapFactory:decodeStream	(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    //   541: astore_1
    //   542: aload_2
    //   543: invokevirtual 509	java/io/FileInputStream:close	()V
    //   546: aload_1
    //   547: areturn
    //   548: astore_2
    //   549: ldc 181
    ...
    //   565: aload_2
    //   566: invokevirtual 512	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   575: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   578: aload_1
    //   579: areturn
    //   580: astore_1
    //   581: ldc 181
    ...
    //   597: aload_1
    //   598: invokevirtual 512	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   607: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   610: aconst_null
    //   611: areturn
    //   612: ldc 226
    //   614: aload_3
    //   615: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   618: ifne +22 -> 640
    //   621: ldc_w 287
    //   624: aload_3
    //   625: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   628: ifne +12 -> 640
    //   631: ldc 228
    //   633: aload_3
    //   634: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   637: ifeq +525 -> 1162
    //   640: aload_2
    //   641: getfield 517	com/tencent/image/DownloadParams:tag	Ljava/lang/Object;
    //   644: instanceof 519
    //   647: ifne +34 -> 681
    //   650: ldc 181
    //   652: iconst_1
    ...
    //   670: invokevirtual 427	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   673: invokevirtual 168	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   676: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   679: aconst_null
    //   680: areturn
    //   681: aload_2
    //   682: getfield 517	com/tencent/image/DownloadParams:tag	Ljava/lang/Object;
    //   685: checkcast 519	com/tencent/mobileqq/activity/photo/LocalMediaInfo
    //   688: astore_1
    //   689: aload_1
    //   690: ifnull +441 -> 1131
    //   693: aload_1
    //   694: getfield 524	com/tencent/mobileqq/activity/photo/LocalMediaInfo:path	Ljava/lang/String;
    //   697: astore 6
    ...
    //   708: astore 7
    //   710: aload 7
    //   712: invokestatic 530	com/tencent/image/GifDrawable:isGifFile	(Ljava/io/File;)Z
    //   715: ifeq +87 -> 802
    ...
    //   758: iconst_1
    //   759: aload_2
    //   760: getfield 533	com/tencent/image/DownloadParams:mGifRoundCorner	F
    //   763: invokespecial 536	aoor$a:<init>	(Laoor;Ljava/io/File;ZF)V
    //   766: astore_1
    //   767: aload_1
    //   768: areturn
    //   769: astore_1
    ...
    //   790: invokevirtual 427	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   793: invokevirtual 168	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   796: aload_1
    //   797: invokestatic 485	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   800: aconst_null
    //   801: areturn
    ...
    //   835: new 542	android/graphics/BitmapFactory$Options
    //   838: dup
    //   839: invokespecial 543	android/graphics/BitmapFactory$Options:<init>	()V
    //   842: astore 7
    //   844: aload 7
    //   846: iconst_1
    //   847: putfield 547	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   850: aload_1
    //   851: getfield 524	com/tencent/mobileqq/activity/photo/LocalMediaInfo:path	Ljava/lang/String;
    //   854: aload 7
    //   856: invokestatic 550	com/tencent/image/SafeBitmapFactory:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   859: pop
    //   860: aload 7
    //   862: aload 7
    //   864: aload_1
    //   865: getfield 553	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbWidth	I
    //   868: aload_1
    //   869: getfield 556	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbHeight	I
    //   872: invokestatic 562	aqhu:calculateInSampleSize	(Landroid/graphics/BitmapFactory$Options;II)I
    //   875: putfield 565	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   878: aload 7
    //   880: iconst_0
    //   881: putfield 547	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   884: new 494	java/io/FileInputStream
    //   887: dup
    //   888: aload 6
    //   890: invokespecial 495	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   893: astore 8
    //   895: new 497	java/io/BufferedInputStream
    //   898: dup
    //   899: aload 8
    //   901: invokespecial 500	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   904: aconst_null
    //   905: aload 7
    //   907: invokestatic 568	com/tencent/image/SafeBitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   910: astore 6
    //   912: aload 8
    //   914: invokevirtual 509	java/io/FileInputStream:close	()V
    //   917: aload 6
    ...
    //   942: invokevirtual 427	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   945: invokevirtual 168	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   948: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   951: aconst_null
    //   952: areturn
    //   953: ldc 228
    //   955: aload_3
    //   956: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   959: ifeq +18 -> 977
    //   962: aload_0
    //   963: aload 6
    //   965: aload_1
    //   966: getfield 553	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbWidth	I
    //   969: aload_1
    //   970: getfield 556	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbHeight	I
    //   973: invokevirtual 574	aoor:zoomBitmap	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   976: areturn
    //   977: aload 6
    ...
    //   994: dup
    //   995: invokespecial 575	android/graphics/Rect:<init>	()V
    //   998: astore_3
    ...
    //   1004: fconst_0
    //   1005: aload_1
    //   1006: getfield 553	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbWidth	I
    //   1009: i2f
    //   1010: aload_1
    //   1011: getfield 553	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbWidth	I
    //   1014: i2f
    //   1015: invokespecial 578	android/graphics/RectF:<init>	(FFFF)V
    //   1018: astore 7
    //   1020: iload 4
    //   1022: iload 5
    ...
    //   1047: iconst_0
    //   1048: iadd
    //   1049: invokevirtual 581	android/graphics/Rect:set	(IIII)V
    //   1052: aload_1
    //   1053: getfield 553	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbWidth	I
    //   1056: aload_1
    //   1057: getfield 553	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbWidth	I
    ...
    //   1087: dup
    //   1088: bipush 6
    //   1090: invokespecial 583	android/graphics/Paint:<init>	(I)V
    //   1093: invokevirtual 586	android/graphics/Canvas:drawBitmap	(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    //   1096: aload 6
    //   1098: invokevirtual 589	android/graphics/Bitmap:recycle	()V
    //   1101: aload_1
    //   1102: areturn
    //   1103: iload 5
    //   1105: iload 4
    ...
    //   1122: iload 5
    //   1124: iadd
    //   1125: invokevirtual 581	android/graphics/Rect:set	(IIII)V
    //   1128: goto -76 -> 1052
    //   1131: ldc 181
    //   1133: iconst_1
    ...
    //   1151: invokevirtual 427	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   1154: invokevirtual 168	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   1157: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   1160: aconst_null
    //   1161: areturn
    //   1162: ldc_w 377
    //   1165: aload_3
    //   1166: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1169: ifeq +316 -> 1485
    //   1172: aload_1
    ...
    //   1178: iconst_1
    //   1179: ldc_w 593
    //   1182: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   1185: aconst_null
    //   1186: areturn
    //   1187: aload_1
    //   1188: invokevirtual 490	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   1191: astore_1
    ...
    //   1224: new 494	java/io/FileInputStream
    //   1227: dup
    //   1228: aload_1
    //   1229: invokespecial 495	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   1232: astore_2
    //   1233: new 497	java/io/BufferedInputStream
    //   1236: dup
    //   1237: aload_2
    //   1238: invokespecial 500	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   1241: invokestatic 506	com/tencent/image/SafeBitmapFactory:decodeStream	(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    //   1244: astore_1
    //   1245: aload_2
    //   1246: invokevirtual 509	java/io/FileInputStream:close	()V
    //   1249: aload_1
    ...
    //   1411: ldc_w 599
    //   1414: aload_2
    //   1415: invokestatic 485	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   1418: aload_1
    //   1419: areturn
    //   1420: astore_1
    //   1421: ldc 181
    ...
    //   1437: aload_1
    //   1438: invokevirtual 512	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   1447: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   1450: aconst_null
    //   1451: areturn
    //   1452: astore_2
    //   1453: ldc 181
    ...
    //   1469: aload_2
    //   1470: invokevirtual 512	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   1479: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   1482: goto -233 -> 1249
    //   1485: ldc_w 389
    //   1488: aload_3
    //   1489: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1492: ifne +13 -> 1505
    //   1495: ldc_w 391
    //   1498: aload_3
    //   1499: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1502: ifeq +180 -> 1682
    //   1505: aload_1
    ...
    //   1511: iconst_1
    //   1512: ldc_w 605
    //   1515: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   1518: aconst_null
    //   1519: areturn
    //   1520: aload_1
    //   1521: invokevirtual 490	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   1524: astore_1
    ...
    //   1557: new 494	java/io/FileInputStream
    //   1560: dup
    //   1561: aload_1
    //   1562: invokespecial 495	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   1565: astore_1
    //   1566: new 497	java/io/BufferedInputStream
    //   1569: dup
    //   1570: aload_1
    //   1571: invokespecial 500	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   1574: invokestatic 506	com/tencent/image/SafeBitmapFactory:decodeStream	(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    //   1577: astore_2
    //   1578: aload_1
    //   1579: invokevirtual 509	java/io/FileInputStream:close	()V
    //   1582: ldc_w 389
    //   1585: aload_3
    //   1586: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1589: ifeq +74 -> 1663
    //   1592: aload_0
    //   1593: aload_2
    //   1594: invokespecial 609	aoor:f	(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   1597: areturn
    //   1598: astore_1
    //   1599: ldc 181
    //   1601: iconst_1
    ...
    //   1615: aload_1
    //   1616: invokevirtual 512	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   1625: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   1628: aconst_null
    //   1629: areturn
    //   1630: astore_1
    //   1631: ldc 181
    ...
    //   1647: aload_1
    //   1648: invokevirtual 512	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   1657: invokestatic 359	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   1660: goto -78 -> 1582
    //   1663: aload_2
    //   1664: astore_1
    //   1665: ldc_w 391
    //   1668: aload_3
    //   1669: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1672: ifeq -1659 -> 13
    //   1675: aload_0
    //   1676: aload_2
    //   1677: iconst_1
    //   1678: invokespecial 216	aoor:a	(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    //   1681: areturn
    //   1682: ldc_w 397
    //   1685: aload_3
    //   1686: invokevirtual 224	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1689: ifeq -889 -> 800
    //   1692: aload_1
    //   1693: invokestatic 530	com/tencent/image/GifDrawable:isGifFile	(Ljava/io/File;)Z
    //   1696: ifeq +19 -> 1715
    //   1699: aload_1
    //   1700: iconst_0
    //   1701: iconst_0
    //   1702: aload_2
    //   1703: getfield 616	com/tencent/image/DownloadParams:reqWidth	I
    //   1706: aload_2
    //   1707: getfield 619	com/tencent/image/DownloadParams:reqHeight	I
    //   1710: fconst_0
    //   1711: invokestatic 464	com/tencent/image/NativeGifFactory:getNativeGifObject	(Ljava/io/File;ZZIIF)Lcom/tencent/image/AbstractGifImage;
    //   1714: areturn
    //   1715: new 542	android/graphics/BitmapFactory$Options
    //   1718: dup
    //   1719: invokespecial 543	android/graphics/BitmapFactory$Options:<init>	()V
    //   1722: astore_2
    //   1723: aload_2
    //   1724: aload_0
    //   1725: getfield 16	aoor:b	Lcom/tencent/common/app/BaseApplicationImpl;
    ...
    //   1734: getfield 622	android/util/DisplayMetrics:densityDpi	I
    //   1737: putfield 625	android/graphics/BitmapFactory$Options:inTargetDensity	I
    //   1740: aload_2
    //   1741: aload_2
    //   1742: getfield 625	android/graphics/BitmapFactory$Options:inTargetDensity	I
    //   1745: sipush 320
    //   1748: invokestatic 631	java/lang/Math:max	(II)I
    //   1751: putfield 634	android/graphics/BitmapFactory$Options:inDensity	I
    //   1754: aload_1
    //   1755: invokevirtual 490	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   1758: aload_2
    //   1759: invokestatic 637	aqcu:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   1762: areturn
    //   1763: aload 6
    //   1765: areturn
  ...
  public JobQueue getQueue(URL paramURL)
  {
    try
    {
      ...
      paramURL = (afke)((QQAppInterface)BaseApplicationImpl.getApplication().getAppRuntime(paramURL)).getManager(43);
      if (paramURL != null) {
        return paramURL.a;
      }
    }
  ...
  {
    public a(File paramFile, boolean paramBoolean, float paramFloat)
      throws IOException
    {
      super(paramBoolean, false, 0, 0, paramFloat);
    }
