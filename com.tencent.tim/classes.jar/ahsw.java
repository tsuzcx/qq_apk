  ...
  extends QIPCModule
{
  ...
  public static ahsw a()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 17	ahsw:a	Lahsw;
    //   6: ifnonnull +25 -> 31
    //   9: ldc 2
    //   11: monitorenter
    //   12: getstatic 17	ahsw:a	Lahsw;
    //   15: ifnonnull +13 -> 28
    //   18: new 2	ahsw
    //   21: dup
    //   22: invokespecial 19	ahsw:<init>	()V
    //   25: putstatic 17	ahsw:a	Lahsw;
    //   28: ldc 2
    //   30: monitorexit
    //   31: getstatic 17	ahsw:a	Lahsw;
    //   34: astore_0
    //   35: ldc 2
    //   37: monitorexit
    //   38: aload_0
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("action_check_aio_type".equals(paramString))
    {
      ...
      paramBundle = (acff)paramBundle.getManager(51);
      if ((paramBundle == null) || (TextUtils.isEmpty(paramString)) || (!paramBundle.isFriend(paramString))) {
        break label147;
      }
    }
    label139:
