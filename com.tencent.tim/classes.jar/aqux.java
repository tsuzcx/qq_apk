...
public class aqux
{
  private static final ConcurrentHashMap<String, Boolean> jg = new ConcurrentHashMap();
  
  public static int Mv()
  {
    return fq(BaseApplicationImpl.getApplication().getRuntime().getAccount());
  }
  ...
  public static int a(int paramInt, Context paramContext)
  {
    // Byte code:
    //   0: ldc 50
    //   2: invokestatic 56	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   5: astore_2
    //   6: aload_1
    //   7: invokevirtual 62	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   10: astore_1
    //   11: aload_1
    //   12: aload_2
    //   13: iconst_2
    //   14: anewarray 64	java/lang/String
    //   17: dup
    //   18: iconst_0
    //   19: ldc 66
    //   21: aastore
    ...
    //   27: ldc 70
    //   29: iconst_1
    //   30: anewarray 64	java/lang/String
    //   33: dup
    //   34: iconst_0
    //   35: iload_0
    //   36: invokestatic 74	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   39: aastore
    //   40: aconst_null
    //   41: invokestatic 80	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   44: astore_2
    //   45: aload_2
    //   46: ifnull +43 -> 89
    //   49: aload_2
    ...
    //   112: dup
    //   113: invokespecial 101	java/lang/StringBuilder:<init>	()V
    //   116: ldc 103
    //   118: invokevirtual 107	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   121: aload_3
    //   122: invokevirtual 110	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   125: invokevirtual 113	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   128: invokestatic 119	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   131: aload_2
    //   132: ifnull -33 -> 99
    //   135: aload_2
  ...
  public static aqux.a a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    aqux.a locala = new aqux.a();
    locala.cxV = pT(paramString);
    String str;
    ...
    for (;;)
    {
      ...
      if (localSharedPreferences.getInt("guideToastOpen", 0) == 1)
      {
        ...
        for (;;)
        {
          ...
          QQToast.a(BaseApplicationImpl.getContext(), 2, str, i * 1000).show();
          locala.edc = 1;
          break;
          label258:
          jg.put(paramString, Boolean.TRUE);
        }
      }
  ...
  private static Object a(int paramInt, String paramString, Context paramContext)
  {
    try
    {
      ...
      {
        paramString = paramContext.getClass().getMethod(paramString, b(paramString));
        if (paramInt >= 0)
        {
  ...
  public static void a(TrafficResultInfo paramTrafficResultInfo, Bundle paramBundle)
  {
    ...
    boolean bool1 = paramBundle.getBoolean(acny.bqc);
    boolean bool3 = paramBundle.getBoolean(acny.bqd);
    String str2 = paramBundle.getString(acny.bqe);
    String str1 = paramBundle.getString(acny.bqf);
    ...
    for (bool1 = bool2;; bool1 = false)
    {
      ...
      localEditor.putString("drawerTextID", String.valueOf(paramTrafficResultInfo.iDrawerTextId));
  ...
  public static boolean a(Activity paramActivity, int paramInt, aqux.b paramb, String paramString)
  {
    boolean bool = true;
    ...
    {
      return bool;
      locala = a(paramString, false, true);
      if (QLog.isColorLevel()) {
        QLog.i("CUKingCardHelper", 2, "shouldOverrideDialog, popUpType: " + locala.edc);
      }
    } while (locala.edc == 4);
    if (locala.edc == 1)
    {
    ...
    new aquw(paramActivity, paramb, paramInt, paramString, locala.edc).show();
    return false;
  }
