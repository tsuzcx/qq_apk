...
public class anda
  implements ancz
{
  public static void d(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      if ((TroopNotificationCache)paramArrayOfByte.find(TroopNotificationCache.class, "troopUin=? and feedsId=?", new String[] { String.valueOf(l2), str }) != null)
      {
        ...
        aptr.a(paramQQAppInterface, i, l1, l2, l3, str, j, "OidbSvc.0x852_35", (short)23, false, false);
      }
    }
  ...
  public void a(msg_comm.MsgType0x210 paramMsgType0x210, msg_comm.Msg paramMsg, List<MessageRecord> paramList, anax paramanax, MessageHandler paramMessageHandler)
  {
    ...
    d(paramMessageHandler.app, paramMsgType0x210);
