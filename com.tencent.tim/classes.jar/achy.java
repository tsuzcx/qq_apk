  ...
  extends accg
{
  ...
  public achy(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private void as(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    notifyUI(1021, false, null);
  }
  
  private void at(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    notifyUI(1020, false, new Object[] { Integer.valueOf(paramToServiceMsg.extraData.getInt("session_id")) });
  }
  
  private void au(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    at(paramToServiceMsg, paramFromServiceMsg);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (k == 0)
        {
          ...
          ((acdt)this.app.getBusinessHandler(6)).hk(k);
      ...
      try
      {
        ...
        ((apbc)this.app.getManager(32)).j(paramFromServiceMsg, false, paramToServiceMsg);
        anot.a(this.app, "dc00899", "Grp_create_new", "", "suc_create", "face_create", 0, 0, "" + paramFromServiceMsg, "" + m, "", "");
  ...
  private void v(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if ("NearFieldDiscussSvr.ReqJoinDiscuss".equals(str)) {
      au(paramToServiceMsg, paramFromServiceMsg);
    }
    while (!"NearFieldDiscussSvr.ReqGetList".equals(str)) {
      return;
    }
    as(paramToServiceMsg, paramFromServiceMsg);
  }
  ...
  public void a(String paramString, int paramInt, nearfield_discuss.LBSInfo paramLBSInfo, boolean paramBoolean)
  {
    ...
    if ((!paramBoolean) && (this.cQ != null)) {
      localReqGetList.bytes_cookie.set(ByteStringMicro.copyFrom(this.cQ));
    }
  ...
  protected void fi(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    boolean bool1;
        ...
        try
        {
          ...
          if ((paramToServiceMsg != null) && (bool1))
          {
            ...
            if (paramToServiceMsg.bytes_cookie.has()) {
              this.cQ = paramToServiceMsg.bytes_cookie.get().toByteArray();
            }
            int j = 0;
