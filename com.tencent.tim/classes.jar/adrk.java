...
public class adrk
  implements acci
{
  public adrk(ArkMessageServerLogic.1 param1) {}
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    if ((paramBoolean) && (paramObject != null))
    {
        ...
        if (((ArkAppPanelList.RespBody)localObject1).apps.has())
        {
          ...
          while (paramObject.hasNext())
          {
            ...
            if (localObject2 != null)
            {
              ...
              {
                localArrayList.add(new ArkAppManagerPanel.a((String)localObject1, str, (String)localObject2));
                continue;
                return;
              }
            }
      ...
      {
        ArkAppCenter.r("ArkApp.ArkMessageServerLogic", "requestArkAppManagerPanelList mergeFrom exception=" + paramObject);
        if (this.a.a != null) {
          this.a.a.ch(null);
        }
      }
