...
import com.tencent.mobileqq.filemanager.fileviewer.FileView.LocalTbsViewManager.1.4;
...
{
  agre(agrd paramagrd, Activity paramActivity, agrd.a parama, String paramString) {}
  ...
  public void onCallBackAction(Integer paramInteger, Object paramObject1, Object paramObject2)
  {
    ...
    case 5045: 
      for (;;)
      {
        ...
        if (paramObject1 != null)
        {
          ...
          this.a.a(paramObject1, paramObject2, localDrawable, new agrf(this, i));
          continue;
          ...
          if (((Integer)paramObject1).intValue() == 0)
          {
            ...
            agrd.a(this.b).openFile(paramObject1);
            continue;
            QLog.e("TestTbs", 1, "WEBVIEW_GET_TITLE_HEIGHT");
            if ((paramObject2 != null) && ((paramObject2 instanceof Bundle))) {
              ((Bundle)paramObject2).putInt("TitleHeight", (int)this.val$activity.getResources().getDimension(2131299627));
            }
          }
        }
      }
    ...
    for (;;)
    {
      ...
      aqha.a(this.val$activity, 233, this.val$activity.getString(2131690838), paramInteger, new agrg(this, paramObject1, paramObject2), new agrh(this)).show();
      return;
      paramObject1 = "";
    }
  }
