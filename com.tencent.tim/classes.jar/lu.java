final class lu
{
  private static int a(lr paramlr, boolean paramBoolean)
  {
    int m;
    int n;
    label20:
  ...
  static int b(lr paramlr)
  {
    return a(paramlr, true) + a(paramlr, false);
  }
  ...
  static int c(lr paramlr)
  {
    byte[][] arrayOfByte = paramlr.a();
    int n = paramlr.getWidth();
    int i1 = paramlr.getHeight();
    int i = 0;
    int j = 0;
    while (i < i1 - 1)
    {
