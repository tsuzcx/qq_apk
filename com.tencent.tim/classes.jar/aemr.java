  ...
  extends aehv<axvw.b>
{
  ...
  public axvw.b a(aeic[] paramArrayOfaeic)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QIMFilterConfigProcessor", 2, "handleGetQIMFilterConfig onParsed, content:" + paramArrayOfaeic);
    }
    return new axvw().a(paramArrayOfaeic, igg.gy(), "temp_filter_zip", new aems(this));
  }
  ...
  {
    if (!new File(aywt.bei + "filter_config_new.xml").exists()) {
      return 0;
    }
    return ayva.ak(BaseApplicationImpl.getContext());
  }
