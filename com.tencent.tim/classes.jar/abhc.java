...
public class abhc
{
  public static final LRULinkedHashMap<String, String> k = new LRULinkedHashMap(50);
  private WeakReference<QQAppInterface> mAppRef;
  
  public abhc(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if ((getApp() == null) || (paramMessageForApollo == null)) {
  ...
  private JSONArray a(List<Long> paramList, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = abrj.a((QQAppInterface)localObject, paramInt, str, paramString, true);
      continue;
      label200:
  ...
  public MessageForArkApp a(MessageForApollo paramMessageForApollo, MessageForArkApp paramMessageForArkApp)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localArkAppMessage.appDesc = acfp.m(2131702496);
        ...
        else
        {
          ...
          localObject1 = ((abhh)paramMessageForArkApp.getManager(153)).a();
      ...
      paramMessageForArkApp.put("nickname", ((abmi)localObject1).e.get(paramMessageForApollo.senderuin));
      paramMessageForArkApp.put("avatarUrl", ((abmi)localObject1).f.get(paramMessageForApollo.senderuin));
    ...
    for (paramMessageForArkApp = paramMessageForApollo.frienduin;; paramMessageForArkApp = paramMessageForApollo.selfuin)
    {
      ...
      localJSONObject3.put("nickname", ((abmi)localObject1).e.get(paramMessageForArkApp));
      localJSONObject3.put("avatarUrl", ((abmi)localObject1).f.get(paramMessageForArkApp));
    ...
    for (;;)
    {
      ...
      if ((paramMessageForApollo != null) && (paramMessageForApollo.length() > 0))
      {
        ...
        continue;
        localObject2 = ((abxk)paramMessageForArkApp.getManager(155)).a(paramMessageForApollo.gameId);
        paramMessageForArkApp = acfp.m(2131702497);
  ...
  public void a(MessageForApollo paramMessageForApollo, String paramString1, String paramString2)
  {
    ...
    try
    {
      ArkAppCenter.f(paramMessageForApollo, paramString1, paramString2, "json");
      return;
    }
    catch (Throwable paramMessageForApollo)
    {
  ...
  public void e(MessageForApollo paramMessageForApollo)
  {
  ...
  public void ei(String paramString1, String paramString2)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: getstatic 20	abhc:k	Lcom/tencent/util/LRULinkedHashMap;
    //   5: ifnull +19 -> 24
    //   8: aload_1
    //   9: invokestatic 131	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   12: ifne +12 -> 24
    //   15: aload_2
    //   16: invokestatic 131	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   19: istore_3
    //   20: iload_3
    //   21: ifeq +6 -> 27
    //   24: aload_0
    //   25: monitorexit
    //   26: return
    //   27: getstatic 20	abhc:k	Lcom/tencent/util/LRULinkedHashMap;
    //   30: aload_1
    //   31: aload_2
    //   32: invokevirtual 459	com/tencent/util/LRULinkedHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   35: pop
    //   36: goto -12 -> 24
    //   39: astore_1
    //   40: aload_0
  ...
  /* Error */
  public String ir(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   21: aload_3
    //   22: areturn
    //   23: getstatic 20	abhc:k	Lcom/tencent/util/LRULinkedHashMap;
    //   26: aload_1
    //   27: invokevirtual 462	com/tencent/util/LRULinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   30: checkcast 122	java/lang/String
    //   33: astore 4
    //   35: aload 4
    //   37: astore_3
    //   38: aload 4
    //   40: invokestatic 131	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   43: ifeq -24 -> 19
    //   46: aload_0
    //   47: aload_1
    //   48: invokespecial 464	abhc:BB	(Ljava/lang/String;)V
    //   51: aconst_null
    //   52: astore_3
    //   53: goto -34 -> 19
    //   56: astore_1
