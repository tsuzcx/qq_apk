  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.getResultCode() == 1000))
    {
      ...
      paramIntent = avqn.a(paramIntent, (QQAppInterface)getAppRuntime(), arrayOfInt);
      if (paramIntent != null)
      {
        paramFromServiceMsg = new Bundle();
        paramFromServiceMsg.putSerializable("data", paramIntent);
        notifyObserver(null, 1001, true, paramFromServiceMsg, akln.class);
      }
    }
    while (paramFromServiceMsg == null)
    {
      ...
      notifyObserver(null, 1001, false, new Bundle(), akln.class);
      return;
    }
    if (QLog.isColorLevel()) {
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    localObject2 = new avqn(l1, (ArrayList)localObject2, l2, paramIntent.getStringExtra("refer"), i);
    Object localObject1 = ((avqn)localObject2).encode();
    paramIntent.putExtra("key_cmd_string", ((avqn)localObject2).getCmdString());
