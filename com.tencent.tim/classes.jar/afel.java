...
public class afel
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (!paramClass.isAnnotationPresent(affq.class)) {
            continue;
          }
  ...
  public static XmlData a(Class<? extends XmlData> paramClass, String paramString1, String paramString2, String paramString3, long paramLong, String paramString4, String paramString5)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramClass = new afeo(paramClass);
  ...
  public static void a(XmlData paramXmlData, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramVarArgs = b((Class)localObject2);
      ...
      try
      {
        if ((((Field)localObject2).isAnnotationPresent(affq.class)) && (((affq)((Field)localObject2).getAnnotation(affq.class)).save()))
        {
    ...
    for (;;)
    {
      ...
      if (i < paramVarArgs.length)
      {
        ...
        localObject1[i] = findField((Class)localObject2, (String)localObject3);
        break label465;
  ...
  public static void c(XmlData paramXmlData)
  {
  ...
  /* Error */
  public static Field findField(Class<? extends XmlData> paramClass, String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_3
    ...
    //   16: ifnull +13 -> 29
    //   19: aload_1
    //   20: invokevirtual 163	java/lang/String:length	()I
    //   23: ifne +20 -> 43
    //   26: aload 4
    //   28: astore_2
    //   29: aload_2
    ...
    //   35: ifnonnull -6 -> 29
    //   38: aload_0
    //   39: invokevirtual 372	java/lang/Class:getSuperclass	()Ljava/lang/Class;
    //   42: astore_0
    //   43: aload_3
    //   44: astore_2
    //   45: aload_0
    ...
    //   52: aload_0
    //   53: aload_1
    //   54: invokevirtual 392	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   57: astore_2
    //   58: aload_2
    //   59: astore_3
    //   60: goto -28 -> 32
