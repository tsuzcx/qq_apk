...
public class awnz
{
  ...
  {
    return r(paramString1, paramString2, 8);
  }
  
  public static String cx(String paramString1, String paramString2)
  {
    return s(paramString1, paramString2, 8);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (arrayOfByte != null)
        {
          ...
          {
            paramString2 = new awny().encrypt(arrayOfByte, paramString2.getBytes());
            localObject1 = localObject2;
  ...
  public static String s(String paramString1, String paramString2, int paramInt)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        paramString1 = new awny().decrypt(paramString1, paramString2.getBytes());
