...
public class klt
{
  public static final HashMap<String, List<Long>> dj = new HashMap();
  ...
  public static Pair<List<GiftServiceBean>, List<GiftServiceBean>> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = jqc.a(BaseApplicationImpl.getContext(), paramString, "GET", null, (Bundle)localObject1);
        if (paramString != null)
        {
  ...
  public static Pair<Boolean, String> a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    paramString1 = kxm.getAccount();
    paramString1 = ((TicketManager)((QQAppInterface)kxm.getAppRuntime()).getManager(2)).getSkey(paramString1);
    if (paramString1 == null) {}
    for (paramString1 = "";; paramString1 = ej(paramString1))
    {
      ...
      try
      {
        paramString1 = jqc.a(BaseApplicationImpl.getContext(), localStringBuilder.toString(), "GET", null, paramString1);
        if (paramString1 == null) {
          break;
        }
        bool2 = bool5;
    ...
    throws JSONException
  {
    ...
    localJSONObject.put("net_type", String.valueOf(jxp.na()));
    localJSONObject.put("plat_id", 1);
    localJSONObject.put("imei", kms.getIMEI());
    if (!TextUtils.isEmpty(kxm.getAccount())) {
      localJSONObject.put("uin", Long.valueOf(kxm.getAccount()));
    }
  ...
  public static boolean a(AppInterface paramAppInterface, long paramLong)
  {
    ...
    if ((dj.containsKey(paramAppInterface)) && (((List)dj.get(paramAppInterface)).contains(Long.valueOf(paramLong)))) {}
  ...
  public static void z(String paramString, long paramLong)
  {
    ...
    {
      return;
      if (!dj.containsKey(paramString)) {
        dj.put(paramString, new ArrayList());
      }
      paramString = (List)dj.get(paramString);
