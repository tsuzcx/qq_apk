  ...
  extends atkw
{
  ...
  {
    if (this.fQ != null) {
      return atyv.b((FileManagerEntity)this.fQ);
    }
    return super.a();
  }
  ...
  public boolean a(CloudHistoryInfo paramCloudHistoryInfo, Object paramObject)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("TroopRecentInfo", 1, "create. fileName[" + paramCloudHistoryInfo.fileName + "] filePath[" + paramCloudHistoryInfo.localPath + "]");
    }
  ...
  public void fZ(Context paramContext)
  {
    ...
    {
      atxh.b(null, localFileManagerEntity, (Activity)paramContext).onClick(null);
      return;
    }
  ...
  public void n(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (localFileManagerEntity != null)
    {
      ...
      apca.a((Activity)paramContext, paramQQAppInterface, localFileManagerEntity.TroopUin, localapcy, localFileManagerEntity.selfUin, localFileManagerEntity.lastTime, 3);
      return;
    }
