...
public class vun
  extends accn
{
  public vun(ShowReactiveActivity paramShowReactiveActivity) {}
  ...
  protected void onGetCalReactiveDays(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      ...
      {
        localObject = ((acff)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
  ...
  protected void onSetCalReactiveDays(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      QQToast.a(this.a.app.getApp(), 1, this.a.getString(2131719890), 3000).show(this.a.getTitleBarHeight());
      localObject1 = this.a;
      localObject2 = this.a.aC.a();
      if (this.a.aC.a().isChecked()) {
        break label217;
      }
      bool1 = true;
    ...
    {
      localObject1 = ((acff)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
      localObject2 = this.a;
      localSwitch = this.a.aC.a();
