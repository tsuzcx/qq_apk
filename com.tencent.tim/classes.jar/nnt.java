...
public class nnt
{
  ...
  public static Pair<String, Bitmap> a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        int n = wja.dp2px(0.5F, localResources);
        int i = wja.dp2px(90.0F, localResources);
        ...
        if (k >= paramInt)
        {
          ...
          localCanvas.drawBitmap(BitmapFactory.decodeResource(localResources, 2130842504), wja.dp2px(13.0F, localResources), wja.dp2px(25.0F, localResources) + paramInt, localPaint);
          localPaint.setColor(-16777216);
          localPaint.setTextSize(wja.a(2, 18, localResources));
          localCanvas.drawText("QQ看点", wja.dp2px(60.0F, localResources), wja.dp2px(42.0F, localResources) + paramInt, localPaint);
          localPaint.setColor(Color.parseColor("#777777"));
          localPaint.setTextSize(wja.a(2, 14, localResources));
          localCanvas.drawText(localResources.getString(2131697456), wja.dp2px(60.0F, localResources), wja.dp2px(61.0F, localResources) + paramInt, localPaint);
          ...
          str = (String)jqc.b((HashMap)localObject).get("url");
          ...
          anpc.a(BaseApplication.getContext()).collectPerformance(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "actReadInJoyShortenUrl", true, 0L, 0L, (HashMap)localObject, "");
      ...
      catch (Exception paramString1)
      {
        try
        {
          ...
          paramString1 = apzg.a(paramString2, localResources, wja.dp2px(80.0F, localResources), 0, false);
          paramString2 = paramString1;
          if (paramString1 == null)
          {
            if (QLog.isColorLevel()) {
            ...
            paramString2 = BitmapFactory.decodeResource(localResources, 2130842510);
          }
          localCanvas.drawBitmap(paramString2, j - wja.dp2px(5.0F, localResources) - paramString2.getWidth(), wja.dp2px(5.0F, localResources) + paramInt, localPaint);
          paramString2 = b(localBitmap, paramString3);
      ...
      if (TextUtils.isEmpty(str))
      {
        ...
        anpc.a(BaseApplication.getContext()).collectPerformance(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "actReadInJoyShortenUrl", false, 0L, 0L, (HashMap)localObject, "");
        paramString1 = null;
      }
  ...
  /* Error */
  public static String b(Bitmap paramBitmap, String paramString)
  {
    // Byte code:
    //   0: new 343	java/io/File
    //   3: dup
    //   4: getstatic 349	acbn:bnt	Ljava/lang/String;
    //   7: invokestatic 354	aqul:getSDKPrivatePath	(Ljava/lang/String;)Ljava/lang/String;
    //   10: invokespecial 357	java/io/File:<init>	(Ljava/lang/String;)V
    //   13: astore_3
    //   14: aload_3
    //   15: invokevirtual 360	java/io/File:exists	()Z
    //   18: ifne +8 -> 26
    //   21: aload_3
    //   22: invokevirtual 363	java/io/File:mkdirs	()Z
    //   25: pop
    //   26: new 365	java/text/SimpleDateFormat
    //   29: dup
    //   30: ldc_w 367
    //   33: invokespecial 368	java/text/SimpleDateFormat:<init>	(Ljava/lang/String;)V
    //   36: new 370	java/util/Date
    //   39: dup
    //   40: invokestatic 82	java/lang/System:currentTimeMillis	()J
    //   43: invokespecial 373	java/util/Date:<init>	(J)V
    //   46: invokevirtual 377	java/text/SimpleDateFormat:format	(Ljava/util/Date;)Ljava/lang/String;
    //   49: astore_3
    //   50: new 67	java/lang/StringBuilder
    //   53: dup
    //   54: invokespecial 70	java/lang/StringBuilder:<init>	()V
    //   57: getstatic 349	acbn:bnt	Ljava/lang/String;
    ...
    //   80: invokestatic 354	aqul:getSDKPrivatePath	(Ljava/lang/String;)Ljava/lang/String;
    //   83: astore 4
    //   85: new 343	java/io/File
    //   88: dup
    //   89: aload 4
    //   91: invokespecial 357	java/io/File:<init>	(Ljava/lang/String;)V
    //   94: astore_3
    //   95: aload 4
    //   97: astore_1
    //   98: aload_3
    //   99: invokevirtual 360	java/io/File:exists	()Z
    //   102: ifne +38 -> 140
    //   105: new 381	java/io/FileOutputStream
    //   108: dup
    //   109: aload_3
    //   110: invokespecial 384	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   113: astore_3
    //   114: aload_3
    //   115: astore_1
    //   116: aload_0
    //   117: getstatic 390	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   120: bipush 100
    //   122: aload_3
    //   123: invokevirtual 394	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   126: istore_2
    //   127: iload_2
    //   128: ifeq +53 -> 181
    //   131: aload 4
    //   133: astore_0
    //   134: aload_3
    //   135: invokestatic 400	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/OutputStream;)V
    //   138: aload_0
    //   139: astore_1
    //   140: aload_1
    //   141: areturn
    ...
    //   153: aload_0
    //   154: invokestatic 400	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/OutputStream;)V
    //   157: ldc_w 263
    //   160: areturn
    //   161: astore_0
    //   162: aconst_null
    //   163: astore_1
    //   164: aload_1
    //   165: invokestatic 400	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/OutputStream;)V
    //   168: aload_0
    //   169: athrow
    //   170: astore_0
    //   171: goto -7 -> 164
