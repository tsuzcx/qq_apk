  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, i, bool1, localBundle, aney.class);
      return;
      long l;
      if (paramFromServiceMsg.position() < paramFromServiceMsg.capacity())
      {
        ...
        l = aqoj.getLongData((byte[])localObject2, 0);
      ...
      else
      {
        for (paramFromServiceMsg = paramIntent.getStringExtra("k_uin");; paramFromServiceMsg = null)
        {
          if (paramFromServiceMsg != null)
          {
            ...
            localEditor.putString(yih.hI(paramFromServiceMsg), String.valueOf(l));
            ...
            localEditor.putString(yih.hJ(paramFromServiceMsg), (String)localObject1);
            localEditor.commit();
            if (!QLog.isColorLevel()) {
              break label694;
            }
