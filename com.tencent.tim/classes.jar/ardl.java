  ...
  extends WebViewPlugin
{
  ...
  /* Error */
  private String qm(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 7
    //   3: aload_1
    //   4: iconst_0
    //   5: invokestatic 33	aqgo:decode	(Ljava/lang/String;I)[B
    //   8: astore_2
    //   9: aload_2
    //   10: astore_1
    //   11: aload 7
    ...
    //   15: ifnull +142 -> 157
    //   18: ldc 35
    //   20: invokestatic 41	android/os/Environment:getExternalStorageState	()Ljava/lang/String;
    //   23: invokevirtual 47	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   26: ifeq +165 -> 191
    //   29: new 49	java/io/File
    //   32: dup
    //   33: getstatic 54	acbn:SDCARD_PATH	Ljava/lang/String;
    //   36: invokespecial 57	java/io/File:<init>	(Ljava/lang/String;)V
    //   39: astore_2
    //   40: new 49	java/io/File
    //   43: dup
    //   44: aload_2
    //   45: ldc 12
    //   47: invokespecial 60	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   50: astore_2
    //   51: aload_2
    //   52: invokevirtual 64	java/io/File:exists	()Z
    //   55: ifne +8 -> 63
    //   58: aload_2
    //   59: invokevirtual 67	java/io/File:mkdirs	()Z
    //   62: pop
    //   63: new 49	java/io/File
    //   66: dup
    //   67: aload_2
    //   68: aload_1
    //   69: invokestatic 73	com/tencent/qphone/base/util/MD5:toMD5	([B)Ljava/lang/String;
    //   72: invokespecial 60	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   75: astore 5
    //   77: aload 5
    //   79: invokevirtual 64	java/io/File:exists	()Z
    //   82: ifeq +9 -> 91
    //   85: aload 5
    //   87: invokevirtual 76	java/io/File:delete	()Z
    //   90: pop
    //   91: new 78	java/io/FileOutputStream
    //   94: dup
    //   95: aload 5
    //   97: invokespecial 81	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   100: astore_2
    //   101: new 83	java/io/BufferedOutputStream
    //   104: dup
    //   105: aload_2
    //   106: invokespecial 86	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   109: astore 6
    //   111: aload 6
    //   113: astore 4
    //   115: aload_2
    ...
    //   117: aload 6
    //   119: aload_1
    //   120: invokevirtual 90	java/io/BufferedOutputStream:write	([B)V
    //   123: aload 6
    //   125: astore 4
    //   127: aload_2
    //   128: astore_3
    //   129: aload 5
    //   131: invokevirtual 93	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   134: astore_1
    //   135: aload_2
    //   136: ifnull +7 -> 143
    //   139: aload_2
    //   140: invokevirtual 96	java/io/FileOutputStream:close	()V
    //   143: aload_1
    //   144: astore_2
    //   145: aload 6
    //   147: ifnull +10 -> 157
    //   150: aload 6
    //   152: invokevirtual 97	java/io/BufferedOutputStream:close	()V
    //   155: aload_1
    //   156: astore_2
    //   157: aload_2
    //   158: areturn
    ...
    //   170: ldc 104
    //   172: invokevirtual 108	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   175: aload_1
    ...
    //   182: aload_2
    //   183: invokestatic 117	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   186: aconst_null
    //   187: astore_1
    //   188: goto -177 -> 11
    //   191: invokestatic 123	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   194: invokevirtual 127	com/tencent/common/app/BaseApplicationImpl:getCacheDir	()Ljava/io/File;
    //   197: astore_2
    //   198: goto -158 -> 40
    //   201: astore 5
    //   203: aconst_null
    ...
    //   215: ldc 129
    //   217: aload 5
    //   219: invokestatic 117	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   222: aload_2
    //   223: ifnull +7 -> 230
    //   226: aload_2
    //   227: invokevirtual 96	java/io/FileOutputStream:close	()V
    //   230: aload 7
    //   232: astore_2
    //   233: aload_1
    //   234: ifnull -77 -> 157
    //   237: aload_1
    //   238: invokevirtual 97	java/io/BufferedOutputStream:close	()V
    //   241: aconst_null
    //   242: areturn
    //   243: astore_1
    //   244: aconst_null
    ...
    //   253: ifnull +7 -> 260
    //   256: aload_2
    //   257: invokevirtual 96	java/io/FileOutputStream:close	()V
    //   260: aload 4
    //   262: ifnull +8 -> 270
    //   265: aload 4
    //   267: invokevirtual 97	java/io/BufferedOutputStream:close	()V
    //   270: aload_1
    //   271: athrow
    //   272: astore_2
    //   273: goto -3 -> 270
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("SocialWeeklyWebViewPlugin", 2, "onPostPluginAsyncTask mSharePicLocalPath=" + this.cAe);
    }
    if (!TextUtils.isEmpty(this.cAe))
    {
      ...
      if (localActivity != null)
      {
        ...
        localIntent.putExtra("forward_filepath", this.cAe);
