...
public class apma
  extends accg
{
  public apma(QQAppInterface paramQQAppInterface)
  {
  ...
  public void eaD()
  {
    ...
    Object localObject2 = ((TroopManager)this.mApp.getManager(52)).cE();
  ...
  public void lg(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0) {
      if (localRspBody.honor_list.has())
      {
        ...
        label86:
        ((apmb)this.mApp.getManager(346)).mQ(paramToServiceMsg);
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    lg(paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
}
