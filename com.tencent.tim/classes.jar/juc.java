...
public class juc
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, byte[] paramArrayOfByte, boolean paramBoolean2)
  {
      ...
      try
      {
        ...
        if (((account_detail_dynamic_list.AccountDetailDynamicListResponse)localObject).ret_info.has())
        {
          ...
          if (((account_detail_dynamic_list.AccountDetailDynamicListResponse)localObject).ret_info.ret_code.get() == 0)
          {
            ...
            localArrayList = jub.a(paramQQAppInterface).j(l1);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          i = jub.a(paramQQAppInterface).a(paramArrayOfByte, paramBoolean1, l1, l2, l3, localArrayList, paramBoolean2);
          break;
        }
        i = 5;
        break;
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, acje paramacje)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AccountDetailDynamicListModel", 2, "getAccountDetailDynamicList last_msg_id:" + paramLong2 + "  msg_cnt:" + paramInt + "  mLastMSgID: " + qM);
    }
    ...
    ((account_detail_dynamic_list.AccountDetailDynamicListRequest)localObject).versionInfo.set("3.4.4,3,3058");
    ...
    if (paramLong2 == 0L)
    {
      ...
      localObject = ((acja)localObject).a(String.valueOf(paramLong1));
      if (localObject == null) {
        break label350;
      }
      ...
      paramInt = 1;
      i = kbp.a(paramQQAppInterface, String.valueOf(paramLong1), (AccountDetail)localObject);
    }
    for (;;)
    {
      ...
      {
        kbp.a(null, str1, "0X80077FF", "0X80077FF", 0, 0, "1", str2, (String)localObject, String.valueOf(i), false);
        localNewIntent.setObserver(new jud(paramQQAppInterface, bool, paramacje));
  ...
  public static void b(QQAppInterface paramQQAppInterface, long paramLong, acje paramacje)
  {
    jub.a(paramQQAppInterface).a(paramQQAppInterface, paramLong, paramacje);
    a(paramQQAppInterface, paramLong, 0L, 25, paramacje);
  }
  
  public static void c(QQAppInterface paramQQAppInterface, long paramLong, acje paramacje)
  {
    jtr localjtr = jub.a(paramQQAppInterface).a(paramLong);
    if ((localjtr != null) && (localjtr.qH > 0L))
    {
      if (qM != localjtr.qH) {
        a(paramQQAppInterface, paramLong, localjtr.qH, 25, paramacje);
      }
      return;
    }
    b(paramQQAppInterface, paramLong, paramacje);
  }
}
