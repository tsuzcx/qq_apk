  ...
  implements QfilePinnedHeaderExpandableListView.a
{
  ...
  public agha(QfileRecentPicFileTabView paramQfileRecentPicFileTabView) {}
  ...
  public void Q(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      while (paramInt2 <= i)
      {
        QfileRecentPicFileTabView.a(this.this$0, (FileManagerEntity)this.this$0.b.getChild(paramInt1, paramInt2), this.mIsSelected);
        paramInt2 += 1;
      }
    ...
    if (paramInt2 < paramInt3)
    {
      ...
      localFileManagerEntity = (FileManagerEntity)this.this$0.b.getChild(paramInt1, paramInt2);
      if (!this.mIsSelected) {}
  ...
  public void ag(int paramInt1, int paramInt2)
  {
    ...
    FileManagerEntity localFileManagerEntity = (FileManagerEntity)this.this$0.b.getChild(paramInt1, paramInt2);
