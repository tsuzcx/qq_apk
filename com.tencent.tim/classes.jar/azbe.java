...
public class azbe
{
  private azbe.a a;
  public boolean dCo;
  private int eNA = 1024;
  private int eNz = 0;
  private ArrayList<Float> kr = new ArrayList();
  private int mSampleRate;
  
  private void a(azbe.a parama)
  {
    this.a = parama;
  }
  ...
  {
    // Byte code:
    //   0: new 43	android/media/MediaExtractor
    //   3: dup
    //   4: invokespecial 44	android/media/MediaExtractor:<init>	()V
    //   7: astore 24
    //   9: aload_1
    //   10: invokevirtual 50	java/io/File:length	()J
    //   13: l2i
    //   14: istore 15
    //   16: aload 24
    //   18: aload_1
    //   19: invokevirtual 54	java/io/File:getPath	()Ljava/lang/String;
    //   22: invokevirtual 58	android/media/MediaExtractor:setDataSource	(Ljava/lang/String;)V
    //   25: aload 24
    //   27: invokevirtual 62	android/media/MediaExtractor:getTrackCount	()I
    //   30: istore 9
    //   32: aconst_null
    //   33: astore 18
    //   35: iconst_0
    ...
    //   45: aload 24
    //   47: iload 8
    //   49: invokevirtual 66	android/media/MediaExtractor:getTrackFormat	(I)Landroid/media/MediaFormat;
    //   52: astore 18
    //   54: aload 18
    //   56: ifnull +71 -> 127
    //   59: aload 18
    //   61: ldc 68
    //   63: invokevirtual 74	android/media/MediaFormat:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   66: ldc 76
    //   68: invokevirtual 82	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   71: ifeq +56 -> 127
    //   74: aload 24
    //   76: iload 8
    //   78: invokevirtual 86	android/media/MediaExtractor:selectTrack	(I)V
    //   81: aload 18
    //   83: astore 23
    //   85: iload 8
    //   87: iload 9
    //   89: if_icmpne +47 -> 136
    //   92: new 88	java/lang/RuntimeException
    //   95: dup
    //   96: new 90	java/lang/StringBuilder
    //   99: dup
    //   100: invokespecial 91	java/lang/StringBuilder:<init>	()V
    //   103: ldc 93
    //   105: invokevirtual 97	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   108: aload_1
    //   109: invokevirtual 100	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   112: invokevirtual 103	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   115: invokespecial 105	java/lang/RuntimeException:<init>	(Ljava/lang/String;)V
    //   118: athrow
    //   119: astore_1
    //   120: aload 24
    //   122: invokevirtual 108	android/media/MediaExtractor:release	()V
    //   125: aload_1
    //   126: athrow
    //   127: iload 8
    //   129: iconst_1
    ...
    //   133: goto -95 -> 38
    //   136: aload_3
    //   137: getfield 113	com/tencent/mobileqq/richmedia/capture/data/MusicItemInfo:musicStart	I
    //   140: iload_2
    //   141: iadd
    //   142: istore 8
    //   144: iload 8
    ...
    //   157: lmul
    //   158: iconst_2
    //   159: invokevirtual 119	android/media/MediaExtractor:seekTo	(JI)V
    //   162: aload 23
    //   164: ldc 121
    //   166: invokevirtual 125	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   169: istore 14
    //   171: aload_0
    //   172: aload 23
    //   174: ldc 127
    //   176: invokevirtual 125	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   179: putfield 129	azbe:mSampleRate	I
    //   182: aload_3
    //   183: invokevirtual 133	com/tencent/mobileqq/richmedia/capture/data/MusicItemInfo:isMyMusicInfo	()Z
    //   186: ifeq +81 -> 267
    //   189: aload_3
    //   190: getfield 136	com/tencent/mobileqq/richmedia/capture/data/MusicItemInfo:musicEnd	I
    //   193: aload_3
    //   194: getfield 113	com/tencent/mobileqq/richmedia/capture/data/MusicItemInfo:musicStart	I
    //   197: iload_2
    //   198: iadd
    //   199: isub
    //   200: istore_2
    ...
    //   205: fdiv
    //   206: aload_0
    //   207: getfield 129	azbe:mSampleRate	I
    //   210: i2f
    //   211: fmul
    //   212: ldc 138
    //   214: fadd
    ...
    //   218: aload_0
    //   219: sipush 1024
    //   222: putfield 23	azbe:eNA	I
    //   225: fconst_1
    //   226: aload_0
    //   227: getfield 129	azbe:mSampleRate	I
    //   230: i2f
    //   231: fmul
    //   232: aload_0
    //   233: getfield 23	azbe:eNA	I
    //   236: i2f
    //   237: fdiv
    //   238: ldc 139
    //   240: fcmpg
    //   241: ifge +52 -> 293
    //   244: aload_0
    //   245: getfield 23	azbe:eNA	I
    //   248: sipush 128
    //   251: if_icmple +42 -> 293
    //   254: aload_0
    //   255: aload_0
    //   256: getfield 23	azbe:eNA	I
    //   259: iconst_2
    //   260: idiv
    //   261: putfield 23	azbe:eNA	I
    //   264: goto -39 -> 225
    //   267: aload 23
    //   269: ldc 141
    ...
    //   281: f2i
    //   282: aload_3
    //   283: getfield 113	com/tencent/mobileqq/richmedia/capture/data/MusicItemInfo:musicStart	I
    //   286: iload_2
    //   287: iadd
    //   288: isub
    //   289: istore_2
    ...
    //   293: aload 23
    //   295: ldc 68
    //   297: invokevirtual 74	android/media/MediaFormat:getString	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   356: monitorenter
    //   357: aload_0
    //   358: getfield 30	azbe:kr	Ljava/util/ArrayList;
    //   361: invokevirtual 178	java/util/ArrayList:clear	()V
    //   364: aload_0
    //   365: monitorexit
    //   366: aload_0
    //   367: iconst_0
    //   368: putfield 25	azbe:eNz	I
    //   371: aload_0
    //   372: invokevirtual 181	azbe:Sn	()I
    //   375: iload 14
    //   377: imul
    //   378: newarray short
    //   380: astore 28
    ...
    //   398: istore_2
    //   399: iconst_1
    //   400: invokestatic 190	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   403: astore 18
    //   405: ldc 184
    //   407: fstore 6
    //   409: aload 25
    //   411: ldc2_w 191
    //   414: invokevirtual 196	android/media/MediaCodec:dequeueInputBuffer	(J)I
    //   417: istore 10
    //   419: iload 8
    //   421: ifne +1667 -> 2088
    //   424: iload 10
    ...
    //   435: aaload
    //   436: iconst_0
    //   437: invokevirtual 200	android/media/MediaExtractor:readSampleData	(Ljava/nio/ByteBuffer;I)I
    //   440: istore 11
    //   442: aload 18
    //   444: invokevirtual 203	java/lang/Boolean:booleanValue	()Z
    //   447: ifeq +256 -> 703
    //   450: aload 23
    //   452: ldc 68
    //   454: invokevirtual 74	android/media/MediaFormat:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   457: ldc 205
    //   459: invokevirtual 209	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   462: ifeq +241 -> 703
    //   465: iload 11
    //   467: iconst_2
    //   468: if_icmpne +235 -> 703
    //   471: aload 24
    //   473: invokevirtual 212	android/media/MediaExtractor:advance	()Z
    //   476: pop
    //   477: iload 11
    //   479: iload 9
    //   481: iadd
    //   482: istore 9
    //   484: iconst_0
    //   485: invokestatic 190	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   488: astore 21
    //   490: iload 8
    //   492: istore 10
    //   494: iload 9
    ...
    //   504: aload 27
    //   506: ldc2_w 191
    //   509: invokevirtual 216	android/media/MediaCodec:dequeueOutputBuffer	(Landroid/media/MediaCodec$BufferInfo;J)I
    //   512: istore 12
    //   514: iload 12
    //   516: iflt +731 -> 1247
    //   519: aload 27
    //   521: getfield 219	android/media/MediaCodec$BufferInfo:size	I
    //   524: ifle +723 -> 1247
    //   527: aload_3
    //   528: astore 22
    //   530: iload_2
    ...
    //   533: iload_2
    //   534: aload 27
    //   536: getfield 219	android/media/MediaCodec$BufferInfo:size	I
    //   539: if_icmpge +16 -> 555
    //   542: aload 27
    //   544: getfield 219	android/media/MediaCodec$BufferInfo:size	I
    //   547: istore 10
    //   549: iload 10
    //   551: newarray byte
    //   553: astore 22
    ...
    //   562: iconst_0
    //   563: aload 27
    //   565: getfield 219	android/media/MediaCodec$BufferInfo:size	I
    //   568: invokevirtual 223	java/nio/ByteBuffer:get	([BII)Ljava/nio/ByteBuffer;
    //   571: pop
    //   572: aload 19
    //   574: iload 12
    //   576: aaload
    //   577: invokevirtual 226	java/nio/ByteBuffer:clear	()Ljava/nio/Buffer;
    //   580: pop
    //   581: aload_1
    //   582: invokevirtual 229	java/nio/ByteBuffer:remaining	()I
    //   585: aload 27
    //   587: getfield 219	android/media/MediaCodec$BufferInfo:size	I
    //   590: if_icmpge +1552 -> 2142
    //   593: aload_1
    //   594: invokevirtual 232	java/nio/ByteBuffer:position	()I
    //   597: istore 13
    //   599: iload 13
    //   601: i2d
    //   602: dconst_1
    ...
    //   626: isub
    //   627: aload 27
    //   629: getfield 219	android/media/MediaCodec$BufferInfo:size	I
    //   632: ldc 235
    //   634: iadd
    //   635: if_icmpge +17 -> 652
    //   638: aload 27
    //   640: getfield 219	android/media/MediaCodec$BufferInfo:size	I
    //   643: istore_2
    //   644: iload_2
    //   645: iload 13
    //   647: iadd
    ...
    //   674: ifne +161 -> 835
    //   677: aload_1
    //   678: invokevirtual 226	java/nio/ByteBuffer:clear	()Ljava/nio/Buffer;
    //   681: pop
    //   682: aload 24
    //   684: invokevirtual 108	android/media/MediaExtractor:release	()V
    //   687: aload 25
    //   689: invokevirtual 238	android/media/MediaCodec:stop	()V
    //   692: aload 25
    //   694: invokevirtual 239	android/media/MediaCodec:release	()V
    //   697: return
    //   698: astore_1
    //   699: aload_0
    //   700: monitorexit
    ...
    //   714: ldc2_w 240
    //   717: iconst_4
    //   718: invokevirtual 245	android/media/MediaCodec:queueInputBuffer	(IIIJI)V
    //   721: iconst_1
    //   722: istore 8
    //   724: goto -240 -> 484
    //   727: aload 25
    ...
    //   732: iload 11
    //   734: aload 24
    //   736: invokevirtual 248	android/media/MediaExtractor:getSampleTime	()J
    //   739: iconst_0
    //   740: invokevirtual 245	android/media/MediaCodec:queueInputBuffer	(IIIJI)V
    //   743: aload 24
    //   745: invokevirtual 212	android/media/MediaExtractor:advance	()Z
    //   748: pop
    //   749: iload 11
    //   751: iload 9
    //   753: iadd
    //   754: istore 9
    //   756: aload_0
    //   757: getfield 34	azbe:a	Lazbe$a;
    //   760: ifnull +1325 -> 2085
    //   763: aload_0
    //   764: getfield 34	azbe:a	Lazbe$a;
    //   767: iload 9
    //   769: i2f
    //   770: iload 15
    //   772: i2f
    ...
    //   780: ifne +1305 -> 2085
    //   783: aload_1
    //   784: invokevirtual 226	java/nio/ByteBuffer:clear	()Ljava/nio/Buffer;
    //   787: pop
    //   788: aload 24
    //   790: invokevirtual 108	android/media/MediaExtractor:release	()V
    //   793: aload 25
    //   795: invokevirtual 238	android/media/MediaCodec:stop	()V
    //   798: aload 25
    //   800: invokevirtual 239	android/media/MediaCodec:release	()V
    //   803: aload_1
    //   804: invokevirtual 226	java/nio/ByteBuffer:clear	()Ljava/nio/Buffer;
    //   807: pop
    //   808: aload 24
    //   810: invokevirtual 108	android/media/MediaExtractor:release	()V
    //   813: aload 25
    //   815: invokevirtual 238	android/media/MediaCodec:stop	()V
    //   818: aload 25
    //   820: invokevirtual 239	android/media/MediaCodec:release	()V
    //   823: return
    //   824: astore 18
    //   826: iload 11
    //   828: iconst_1
    ...
    //   873: iconst_0
    //   874: aload 27
    //   876: getfield 219	android/media/MediaCodec$BufferInfo:size	I
    ...
    //   900: astore_3
    //   901: aload_1
    //   902: invokevirtual 232	java/nio/ByteBuffer:position	()I
    //   905: istore 17
    //   907: aload_1
    //   908: astore 20
    //   910: aload_1
    ...
    //   912: iload 17
    //   914: aload_0
    //   915: getfield 25	azbe:eNz	I
    //   918: isub
    //   919: aload_0
    //   920: invokevirtual 181	azbe:Sn	()I
    //   923: iconst_2
    //   924: imul
    //   925: iload 14
    //   927: imul
    ...
    //   983: aload_0
    //   984: aload_0
    //   985: getfield 25	azbe:eNz	I
    //   988: aload_0
    //   989: invokevirtual 181	azbe:Sn	()I
    //   992: iconst_2
    //   993: imul
    //   994: iload 14
    //   996: imul
    //   997: iadd
    //   998: putfield 25	azbe:eNz	I
    //   1001: iconst_m1
    //   1002: istore_2
    //   1003: iconst_0
    //   1004: istore 11
    ...
    //   1051: iadd
    //   1052: saload
    //   1053: invokestatic 293	java/lang/Math:abs	(I)I
    //   1056: iadd
    //   1057: istore 13
    //   1059: iload 12
    //   1061: iconst_1
    ...
    //   1097: iload_2
    //   1098: i2d
    //   1099: invokestatic 297	java/lang/Math:sqrt	(D)D
    //   1102: d2f
    //   1103: fstore 6
    //   1105: aload_1
    //   1106: astore 20
    ...
    //   1148: ifge +24 -> 1172
    //   1151: aload_0
    //   1152: getfield 30	azbe:kr	Ljava/util/ArrayList;
    //   1155: fload 5
    //   1157: fload 6
    //   1159: fadd
    //   1160: fconst_2
    //   1161: fdiv
    //   1162: invokestatic 302	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   1165: invokevirtual 305	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   1168: pop
    //   1169: goto -46 -> 1123
    //   1172: aload_0
    //   1173: getfield 30	azbe:kr	Ljava/util/ArrayList;
    //   1176: fload 4
    //   1178: fload 5
    //   1180: fadd
    //   1181: fload 6
    ...
    //   1184: ldc_w 306
    //   1187: fdiv
    //   1188: invokestatic 302	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   1191: invokevirtual 305	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   1194: pop
    //   1195: goto -72 -> 1123
    //   1198: astore 18
    //   1200: aload_0
    ...
    //   1218: ldc_w 310
    //   1221: aload_1
    //   1222: invokestatic 316	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   1225: aload 20
    //   1227: invokevirtual 226	java/nio/ByteBuffer:clear	()Ljava/nio/Buffer;
    //   1230: pop
    //   1231: aload 24
    //   1233: invokevirtual 108	android/media/MediaExtractor:release	()V
    //   1236: aload 25
    //   1238: invokevirtual 238	android/media/MediaCodec:stop	()V
    //   1241: aload 25
    //   1243: invokevirtual 239	android/media/MediaCodec:release	()V
    //   1246: return
    //   1247: iload 12
    //   1249: bipush 253
    ...
    //   1280: astore_3
    //   1281: aload 27
    //   1283: getfield 319	android/media/MediaCodec$BufferInfo:flags	I
    //   1286: iconst_4
    //   1287: iand
    //   1288: ifne +22 -> 1310
    //   1291: aload_1
    ...
    //   1295: astore_3
    //   1296: aload_1
    //   1297: invokevirtual 232	java/nio/ByteBuffer:position	()I
    //   1300: iload 14
    //   1302: iconst_2
    //   1303: imul
    //   1304: idiv
    ...
    //   1314: astore_3
    //   1315: aload_1
    //   1316: invokevirtual 232	java/nio/ByteBuffer:position	()I
    //   1319: istore 11
    //   1321: aload_1
    //   1322: astore 20
    //   1324: aload_1
    ...
    //   1326: iload 11
    //   1328: aload_0
    //   1329: getfield 25	azbe:eNz	I
    //   1332: isub
    //   1333: aload_0
    //   1334: invokevirtual 181	azbe:Sn	()I
    //   1337: iconst_2
    //   1338: imul
    //   1339: iload 14
    //   1341: imul
    ...
    //   1397: aload_0
    //   1398: aload_0
    //   1399: getfield 25	azbe:eNz	I
    //   1402: aload_0
    //   1403: invokevirtual 181	azbe:Sn	()I
    //   1406: iconst_2
    //   1407: imul
    //   1408: iload 14
    //   1410: imul
    //   1411: iadd
    //   1412: putfield 25	azbe:eNz	I
    //   1415: iconst_m1
    //   1416: istore_2
    //   1417: iconst_0
    //   1418: istore 8
    ...
    //   1465: iadd
    //   1466: saload
    //   1467: invokestatic 293	java/lang/Math:abs	(I)I
    //   1470: iadd
    //   1471: istore 10
    //   1473: iload 9
    //   1475: iconst_1
    ...
    //   1511: iload_2
    //   1512: i2d
    //   1513: invokestatic 297	java/lang/Math:sqrt	(D)D
    //   1516: d2i
    //   1517: i2f
    //   1518: fstore 7
    //   1520: aload_1
    ...
    //   1559: ifge +28 -> 1587
    //   1562: aload_0
    //   1563: getfield 30	azbe:kr	Ljava/util/ArrayList;
    //   1566: fload 5
    //   1568: fload 7
    //   1570: fadd
    //   1571: fconst_2
    //   1572: fdiv
    //   1573: invokestatic 302	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   1576: invokevirtual 305	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   1579: pop
    //   1580: fload 5
    //   1582: fstore 4
    //   1584: goto -46 -> 1538
    //   1587: aload_0
    //   1588: getfield 30	azbe:kr	Ljava/util/ArrayList;
    //   1591: fload 6
    //   1593: fload 5
    //   1595: fadd
    //   1596: fload 7
    ...
    //   1599: ldc_w 306
    //   1602: fdiv
    //   1603: invokestatic 302	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   1606: invokevirtual 305	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   1609: pop
    //   1610: fload 5
    //   1612: fstore 4
    //   1614: goto -76 -> 1538
    ...
    //   1629: astore_1
    //   1630: aload_3
    //   1631: invokevirtual 226	java/nio/ByteBuffer:clear	()Ljava/nio/Buffer;
    //   1634: pop
    //   1635: aload 24
    //   1637: invokevirtual 108	android/media/MediaExtractor:release	()V
    //   1640: aload 25
    //   1642: invokevirtual 238	android/media/MediaCodec:stop	()V
    //   1645: aload 25
    //   1647: invokevirtual 239	android/media/MediaCodec:release	()V
    //   1650: aload_1
    //   1651: athrow
    //   1652: aload_1
    //   1653: astore 20
    ...
    //   1792: iadd
    //   1793: saload
    //   1794: invokestatic 293	java/lang/Math:abs	(I)I
    //   1797: iadd
    //   1798: istore 10
    //   1800: iload 9
    //   1802: iconst_1
    ...
    //   1838: iload_2
    //   1839: i2d
    //   1840: invokestatic 297	java/lang/Math:sqrt	(D)D
    //   1843: d2f
    //   1844: fstore 4
    //   1846: aload_1
    //   1847: astore 20
    ...
    //   1857: ifge +21 -> 1878
    //   1860: aload_0
    //   1861: getfield 30	azbe:kr	Ljava/util/ArrayList;
    //   1864: fload 4
    //   1866: invokestatic 302	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   1869: invokevirtual 305	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   1872: pop
    //   1873: aload_0
    //   1874: monitorexit
    //   1875: goto -1198 -> 677
    ...
    //   1882: ifge +54 -> 1936
    //   1885: aload_0
    //   1886: getfield 30	azbe:kr	Ljava/util/ArrayList;
    //   1889: fload 5
    //   1891: fload 4
    //   1893: fadd
    //   1894: fconst_2
    //   1895: fdiv
    //   1896: invokestatic 302	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   1899: invokevirtual 305	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   1902: pop
    //   1903: aload_0
    //   1904: getfield 30	azbe:kr	Ljava/util/ArrayList;
    //   1907: fload 4
    //   1909: fload 5
    //   1911: fadd
    //   1912: fconst_2
    //   1913: fdiv
    //   1914: invokestatic 302	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   1917: invokevirtual 305	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   1920: pop
    //   1921: goto -48 -> 1873
    //   1924: astore 18
    //   1926: aload_0
    ...
    //   1935: athrow
    //   1936: aload_0
    //   1937: getfield 30	azbe:kr	Ljava/util/ArrayList;
    //   1940: fload 6
    //   1942: fload 5
    //   1944: fadd
    //   1945: fload 4
    ...
    //   1948: ldc_w 306
    //   1951: fdiv
    //   1952: invokestatic 302	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   1955: invokevirtual 305	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   1958: pop
    //   1959: aload_0
    //   1960: getfield 30	azbe:kr	Ljava/util/ArrayList;
    //   1963: fload 4
    //   1965: fload 5
    //   1967: fadd
    //   1968: fconst_2
    //   1969: fdiv
    //   1970: invokestatic 302	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   1973: invokevirtual 305	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   1976: pop
    //   1977: goto -104 -> 1873
    //   1980: aload_1
    //   1981: astore 20
    ...
    //   1986: monitorenter
    //   1987: aload_0
    //   1988: getfield 30	azbe:kr	Ljava/util/ArrayList;
    //   1991: fload 4
    //   1993: fload 5
    //   1995: fadd
    //   1996: fconst_2
    //   1997: fdiv
    //   1998: invokestatic 302	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   2001: invokevirtual 305	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   2004: pop
    //   2005: aload_0
    //   2006: monitorexit
    //   2007: goto -1330 -> 677
  ...
  {
    return (int)(paramInt * 1.0D * this.mSampleRate / (1000.0D * Sn()) + 0.5D);
  }
  ...
  public float B(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        int n = mj(paramInt);
        if ((this.kr == null) || (this.kr.size() <= n)) {
          return -1.0F;
        }
        j = mj(2000);
        int i;
        ...
        if (this.kr.size() < j)
        {
          ...
          if (j < i)
          {
            f2 = ((Float)this.kr.get(j)).floatValue();
            f4 = localObject3;
            if (f2 >= localObject3) {
              break;
            }
        ...
        else
        {
          ...
          paramInt = this.kr.size();
          i = this.kr.size();
          paramInt -= j;
          break label277;
        }
        Object localObject1;
        if ((localObject3 >= localObject1) || (((Float)this.kr.get(n)).floatValue() <= 0.0F)) {
          return -1.0F;
        }
        Object localObject2;
        f2 = localObject2 / (i - paramInt - k);
        f2 = (((Float)this.kr.get(n)).floatValue() - f2) / (localObject1 - f2);
        f1 = f2;
        if (f2 < 0.0F) {
          f1 = -1.0F;
        }
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo, azbe.a parama, int paramInt)
    throws IOException
  {
    ...
    } while ((arrayOfString.length < 2) || (!Arrays.asList(ah()).contains(arrayOfString[(arrayOfString.length - 1)])));
    a(parama);
  ...
  {
    public abstract boolean d(double paramDouble);
  }
}
