...
public class aaml
  extends aamj
{
  private static final byte[] cB = { 1, 2, 3, 0 };
  private static final byte[] cC = { 2, 3, 4, 1 };
  
  private static final boolean c(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    boolean bool2 = false;
    boolean bool1;
