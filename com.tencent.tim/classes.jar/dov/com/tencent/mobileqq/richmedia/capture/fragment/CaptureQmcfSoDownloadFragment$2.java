  ...
  public void run()
  {
    if (CaptureQmcfSoDownloadFragment.a(this.this$0))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("CaptureQmcfSoDownloadFragment", 2, "" + this.val$tag + " setProgress=" + (CaptureQmcfSoDownloadFragment.a(this.this$0) + CaptureQmcfSoDownloadFragment.b(this.this$0)) / 2);
      }
    ...
    QLog.d("CaptureQmcfSoDownloadFragment", 2, "" + this.val$tag + " setProgress=" + CaptureQmcfSoDownloadFragment.c(this.this$0));
  }
}
