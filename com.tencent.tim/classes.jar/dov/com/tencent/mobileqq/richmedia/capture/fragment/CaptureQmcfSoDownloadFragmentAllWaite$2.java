  ...
  public void run()
  {
    if (CaptureQmcfSoDownloadFragmentAllWaite.a(this.this$0))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("CaptureSoDownloadFragmentAllWaite", 2, "" + this.val$tag + " setProgress=" + (CaptureQmcfSoDownloadFragmentAllWaite.a(this.this$0) + CaptureQmcfSoDownloadFragmentAllWaite.b(this.this$0)) / 2);
      }
    ...
    QLog.d("CaptureSoDownloadFragmentAllWaite", 2, "" + this.val$tag + " setProgress=" + CaptureQmcfSoDownloadFragmentAllWaite.c(this.this$0));
  }
}
