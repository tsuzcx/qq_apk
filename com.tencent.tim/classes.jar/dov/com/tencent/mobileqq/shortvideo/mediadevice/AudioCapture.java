  ...
  extends anhn
{
  ...
  private boolean czK;
  private boolean czL;
  public AtomicReference<azbo> d = new AtomicReference(null);
  public int dyr;
  public int dys;
  int dyt = 0;
  int dyu = 0;
  ...
  void a(byte[] paramArrayOfByte, int paramInt1, long paramLong, boolean paramBoolean, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if ((paramArrayOfByte != null) && (paramInt1 > 0))
      {
        ...
        azbb.a().a().handleAudio(arrayOfByte, (AVIOStruct)localObject, (int)paramLong);
  ...
  public boolean aRC()
  {
    ...
    if (!this.isCreate)
    {
      try
      {
        ...
        {
          notify(5, new Object[] { acfp.m(2131702917) });
          return false;
        }
      }
      catch (Exception localException)
      {
        QLog.e(this.TAG, 2, localException, new Object[0]);
        notify(5, new Object[] { acfp.m(2131702915) });
        return false;
      }
      this.isCreate = true;
    }
  ...
  public boolean auC()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if (azbb.a().b().a(this, 3, "init audio failed")) {
            break label187;
          }
  ...
  void b(byte[] paramArrayOfByte, int paramInt1, long paramLong, boolean paramBoolean, int paramInt2)
  {
    if ((paramArrayOfByte != null) && (paramInt1 > 0) && (paramInt1 <= paramArrayOfByte.length))
    {
      ...
      ((azbo)this.d.get()).e(paramArrayOfByte, 0, paramInt1);
    }
    for (;;)
    {
      notify(paramInt2, new Object[] { Integer.valueOf(0) });
  ...
  public void dQg()
  {
    ...
    for (;;)
    {
      ...
      {
        this.a.release();
        notify(6, new Object[] { acfp.m(2131702918) });
      }
      catch (Exception localException)
      {
        for (;;)
