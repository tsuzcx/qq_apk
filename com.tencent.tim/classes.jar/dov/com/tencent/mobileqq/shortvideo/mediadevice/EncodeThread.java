  ...
  implements MaxVideoConst, Runnable
{
  ...
  public void run()
  {
    ...
    if (TextUtils.isEmpty(this.cej))
    {
      ...
      awed.ad(azam.sUin + "", "qzone_video_record", "9", null);
      label67:
      return;
    }
    ...
    if (this.aHe)
    {
      ...
      i = azaz.a(localObject2, localObject1, this.mOrientationDegree, str1);
    ...
    try
    {
      ...
      if ((!((File)localObject4).mkdirs()) && (!((File)localObject4).isDirectory()))
      {
        this.errorCode = 5102;
        dJ(this.errorCode, null);
        awed.ad(azam.sUin + "", "qzone_video_record", "10", null);
        return;
      }
    }
    ...
    Object localObject4 = azcc.w(localFile);
    Object localObject3 = (String)localObject3 + File.separator + (String)localObject4 + ".mp4";
    this.cdZ = ((String)localObject3);
    label1104:
    dQv();
    if (this.cGW) {
      localObject4 = new azar(localObject2, localIOException, this.cej);
    }
    for (;;)
    {
      try
      {
        i = ((azar)localObject4).Ju();
        if (i == 0)
        {
          this.cdZ = ((azar)localObject4).zS();
          ...
          awed.t(azam.sUin + "", "qzone_video_record", "record_hw_success", "0", null);
          if (QLog.isColorLevel()) {
          ...
          if (k == -1)
          {
            ...
            awed.t(azam.sUin + "", "qzone_video_record", "record_sw_success", "0", null);
          }
          if (QLog.isColorLevel())
          {
          ...
          awed.t(azam.sUin + "", "qzone_video_record", "record_success", "0", null);
          switch (i)
          {
          default: 
      ...
      catch (NoSuchMethodError localNoSuchMethodError)
      {
        ...
        i = -1;
        continue;
        awed.t(azam.sUin + "", "qzone_video_record", "record_hw_success", "1", i + "_" + Build.MODEL);
        continue;
        localObject4 = localIOException;
        continue;
        awed.t(azam.sUin + "", "qzone_video_record", "record_sw_success", "1", i + "_" + Build.MODEL);
        continue;
        awed.t(azam.sUin + "", "qzone_video_record", "record_success", "1", i + "_" + Build.MODEL);
        continue;
        this.errorCode = 0;
