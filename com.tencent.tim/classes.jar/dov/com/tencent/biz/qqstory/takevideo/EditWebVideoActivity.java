  ...
  implements Handler.Callback, aomt.a
{
  ...
  {
    this.jdField_a_of_type_Aaza$c = new ayip(this);
  }
  ...
  private void bty()
  {
    ...
    QQToast.a(this, acfp.m(2131705739), 0).show();
    finish();
  }
  
  protected void bsv()
  {
    if (this.jdField_a_of_type_Aygz == null) {
      this.jdField_a_of_type_Aygz = new ayiq();
    }
    ((ayiq)this.jdField_a_of_type_Aygz).a(this.jdField_a_of_type_Aaza$c);
  }
