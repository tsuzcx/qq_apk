...
{
  private Matrix B;
  public final long DURATION = 100L;
  ...
  private void YY()
  {
    ...
    for (;;)
    {
      ...
      this.ns = f1;
      this.nt = (this.ns * 0.9F);
      this.nu = (this.ns * 0.5F);
  ...
  {
    return aylh.a(paramLong, paramFloat1, paramFloat2, new aynw(this));
  }
