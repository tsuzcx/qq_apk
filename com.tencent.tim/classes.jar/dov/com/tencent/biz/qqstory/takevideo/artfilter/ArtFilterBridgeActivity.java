  ...
  extends BaseActivity
{
  ...
  private void btG()
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      Bundle localBundle = EditVideoParams.c(j);
      if (localBundle == null) {
      ...
      for (;;)
      {
        ...
        if (bool2) {
          localBundle.putString("extra_publish_text", acfp.m(2131702882));
        }
        ...
        for (localObject1 = new EditTakePhotoSource(str, 2, 0, 0, d2, d1);; localObject1 = new EditLocalPhotoSource(str, (LocalMediaInfo)localObject1))
        {
          ...
          if (localObject1 != null)
          {
            ((EditVideoParams)localObject1).mMode = m;
            ((EditVideoParams)localObject1).mFrom = localBundle.getInt("extra_edit_video_from");
