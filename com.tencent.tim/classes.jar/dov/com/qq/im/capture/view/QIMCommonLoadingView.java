  ...
  implements axxj.a
{
  ...
  public void a(axxj paramaxxj)
  {
    axxj localaxxj = this.a;
    if (localaxxj != null) {
      localaxxj.a(this);
    }
    this.a = paramaxxj;
    ...
    {
      paramaxxj.b(this);
      setProgress(Math.round(paramaxxj.getProgress() * (float)this.afV));
    }
  }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    {
      return;
      if ((this.mProgress != 0L) && (this.mProgress != this.afV))
      {
        paramCanvas.drawRoundRect(this.aP, this.zc, this.zc, this.ci);
  ...
  public void onUpdate()
  {
    axxj localaxxj = this.a;
    if (localaxxj != null) {
      setProgress(Math.round(localaxxj.getProgress() * (float)this.afV));
    }
  }
