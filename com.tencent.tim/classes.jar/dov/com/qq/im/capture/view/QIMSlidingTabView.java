  ...
  extends HorizontalScrollView
{
  ...
  private void Ua(int paramInt)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        {
          ((QIMSlidingItemView)localObject).cB(this.dzR, true);
          continue;
          label210:
          if ((localView instanceof ImageView))
          {
          ...
          {
            ((QIMSlidingItemView)localObject).cB(this.dzQ, false);
          }
        }
      }
    }
  ...
  private int b(int paramInt, View paramView)
  {
    ...
    paramView.setOnClickListener(new axxq(this, paramInt));
  ...
  private void dLz()
  {
    if (this.dzY != this.mCurrentIndex)
    {
      ...
      ((ValueAnimator)localObject).addUpdateListener(new axxr(this));
  ...
  {
    axiy.d("SlidingTabView", "selected index: " + paramInt);
  ...
  public void eL(ArrayList<b> paramArrayList)
  {
    ...
    while (i < paramArrayList.size())
    {
      ...
      String str = ((b)paramArrayList.get(i)).cWw;
  ...
  public void fD(ArrayList<String> paramArrayList)
  {
    this.mRootLayout.removeAllViews();
    int i = 0;
    while (i < paramArrayList.size())
    {
      ...
      localTextView.setTextSize(0, this.dzT);
  ...
  public void fE(ArrayList<QIMSlidingItemView.a> paramArrayList)
  {
    this.mRootLayout.removeAllViews();
    int i = 0;
    ...
    {
      Object localObject;
      if (((QIMSlidingItemView.a)paramArrayList.get(i)).eIE == 0)
      {
        localObject = new TextView(getContext());
        ((TextView)localObject).setText(((QIMSlidingItemView.a)paramArrayList.get(i)).mText);
        ((TextView)localObject).setGravity(17);
        ((TextView)localObject).setSingleLine();
        ((TextView)localObject).setTextSize(0, this.dzT);
        ((TextView)localObject).setPadding(this.mTabPadding, 0, this.mTabPadding, 0);
        b(i, (View)localObject);
      }
      for (;;)
      {
        i += 1;
        ...
        ((QIMSlidingItemView)localObject).lx(this.dzT, this.mTabPadding);
        ((QIMSlidingItemView)localObject).setData((QIMSlidingItemView.a)paramArrayList.get(i));
        b(i, (View)localObject);
      }
    }
    dLy();
