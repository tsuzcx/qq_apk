  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   5: dup
    //   6: aload_0
    //   7: getfield 14	dov/com/qq/im/capture/data/QIMRedDotConfig$1:val$filePath	Ljava/lang/String;
    //   10: ldc 29
    ...
    //   57: aload_2
    //   58: aload_0
    //   59: getfield 16	dov/com/qq/im/capture/data/QIMRedDotConfig$1:a	Ldov/com/qq/im/capture/data/QIMRedDotConfig;
    //   62: invokevirtual 56	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   65: aload_2
    //   66: astore_1
    //   67: invokestatic 61	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   70: ifeq +13 -> 83
    //   73: aload_2
    //   74: astore_1
    //   75: ldc 63
    ...
    //   98: astore_1
    //   99: aload_3
    //   100: invokevirtual 75	java/lang/Exception:printStackTrace	()V
    //   103: aload_2
    //   104: astore_1
    //   105: ldc 63
    //   107: iconst_2
    //   108: new 77	java/lang/StringBuilder
    //   111: dup
    //   112: invokespecial 78	java/lang/StringBuilder:<init>	()V
    //   115: ldc 80
    //   117: invokevirtual 84	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   120: aload_3
    //   121: invokevirtual 88	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   130: invokestatic 94	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   133: aload_2
    //   134: astore_1
    //   135: aload 4
    //   137: invokevirtual 36	java/io/File:exists	()Z
    //   140: ifeq +11 -> 151
    //   143: aload_2
    //   144: astore_1
    //   145: aload 4
    ...
    //   152: ifnull -61 -> 91
    //   155: aload_2
    //   156: invokevirtual 72	java/io/ObjectOutputStream:close	()V
    //   159: goto -68 -> 91
    //   162: astore_1
    //   163: goto -72 -> 91
    //   166: astore_2
    ...
    //   170: ifnull +7 -> 177
    //   173: aload_1
    //   174: invokevirtual 72	java/io/ObjectOutputStream:close	()V
    //   177: aload_2
    //   178: athrow
    //   179: astore_1
    //   180: aload_0
