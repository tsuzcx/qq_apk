  ...
  implements Serializable
{
  ...
  public static QIMRedDotConfig getRedDotConfigFromFile(String paramString)
  {
    ...
    //   7: aconst_null
    //   8: areturn
    //   9: new 143	java/io/File
    //   12: dup
    //   13: aload_0
    //   14: ldc 16
    //   16: invokespecial 146	java/io/File:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   19: astore_3
    //   20: invokestatic 152	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   23: ifeq +43 -> 66
    //   26: ldc 74
    //   28: iconst_2
    //   29: new 154	java/lang/StringBuilder
    //   32: dup
    //   33: invokespecial 155	java/lang/StringBuilder:<init>	()V
    //   36: ldc 157
    //   38: invokevirtual 161	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   41: aload_3
    //   42: invokevirtual 165	java/io/File:getPath	()Ljava/lang/String;
    //   45: invokevirtual 161	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   48: ldc 167
    //   50: invokevirtual 161	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   53: aload_3
    //   54: invokevirtual 170	java/io/File:exists	()Z
    //   57: invokevirtual 173	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   60: invokevirtual 176	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   63: invokestatic 180	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   66: aload_3
    //   67: invokevirtual 170	java/io/File:exists	()Z
    //   70: ifeq -63 -> 7
    //   73: new 182	java/io/ObjectInputStream
    //   76: dup
    //   77: new 184	java/io/BufferedInputStream
    //   80: dup
    //   81: new 186	java/io/FileInputStream
    //   84: dup
    //   85: aload_3
    //   86: invokespecial 189	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   89: invokespecial 192	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   92: invokespecial 193	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   95: astore_1
    //   96: aload_1
    //   97: astore_0
    //   98: aload_1
    //   99: invokevirtual 197	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   102: checkcast 2	dov/com/qq/im/capture/data/QIMRedDotConfig
    //   105: astore_2
    //   106: aload_1
    //   107: astore_0
    //   108: invokestatic 152	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   111: ifeq +30 -> 141
    //   114: aload_1
    //   115: astore_0
    //   116: ldc 74
    //   118: iconst_2
    //   119: new 154	java/lang/StringBuilder
    //   122: dup
    //   123: invokespecial 155	java/lang/StringBuilder:<init>	()V
    //   126: ldc 199
    //   128: invokevirtual 161	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   131: aload_2
    //   132: invokevirtual 202	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   135: invokevirtual 176	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   138: invokestatic 180	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   141: aload_2
    //   142: astore_0
    //   143: aload_1
    //   144: ifnull +9 -> 153
    //   147: aload_1
    //   148: invokevirtual 205	java/io/ObjectInputStream:close	()V
    //   151: aload_2
    //   152: astore_0
    //   153: aload_0
    //   154: areturn
    ...
    //   159: astore_0
    //   160: aload_3
    //   161: invokevirtual 208	java/io/File:delete	()Z
    //   164: pop
    //   165: aload_1
    //   166: astore_0
    //   167: ldc 74
    ...
    //   170: ldc 210
    //   172: aload_2
    //   173: invokestatic 214	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   176: aload_1
    //   177: ifnull +49 -> 226
    //   180: aload_1
    //   181: invokevirtual 205	java/io/ObjectInputStream:close	()V
    //   184: aconst_null
    //   185: astore_0
    //   186: goto -33 -> 153
    //   189: astore_0
