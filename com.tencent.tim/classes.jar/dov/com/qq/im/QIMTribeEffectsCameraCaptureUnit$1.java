...
public class QIMTribeEffectsCameraCaptureUnit$1
  implements Runnable
{
  public QIMTribeEffectsCameraCaptureUnit$1(awta paramawta, Activity paramActivity) {}
  ...
  public void run()
  {
    if (this.val$context != null)
    {
      ...
      if (localBitmapDrawable != null)
      {
        ...
        this.val$context.runOnUiThread(new QIMTribeEffectsCameraCaptureUnit.1.1(this, localBitmapDrawable));
      }
    }
  }
}
