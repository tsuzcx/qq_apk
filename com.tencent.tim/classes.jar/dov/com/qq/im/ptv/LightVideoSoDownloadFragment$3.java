  ...
  implements Runnable
{
  ...
  public void run()
  {
    this.this$0.f.setProgress(LightVideoSoDownloadFragment.a(this.this$0));
    if (QLog.isColorLevel()) {
      QLog.d("LightVideoSoDownloadFragment", 2, "" + this.val$tag + " setProgress=" + LightVideoSoDownloadFragment.a(this.this$0));
    }
  }
}
