  ...
  implements Runnable
{
  public void run()
  {
    ...
    Intent localIntent = new Intent(AIOLongCaptureCtrl.a(this.this$0).getActivity(), PeakService.class);
    try
    {
      AIOLongCaptureCtrl.a(this.this$0).getActivity().startService(localIntent);
      return;
    }
