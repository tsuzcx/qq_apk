...
public class AENewAlbumListAdapter$1
  implements Runnable
{
  public AENewAlbumListAdapter$1(awum paramawum) {}
  ...
  public void run()
  {
    ...
    int m = 0;
    int k = 0;
    Object localObject = new ArrayList(this.this$0.mDataInfos.size());
    ((List)localObject).addAll(this.this$0.mDataInfos);
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      {
        String str2 = awul.getFileDirectoryOf(localQQAlbumInfo.mCoverInfo.path);
    ...
    zsz.a(i6, i5, i4, j, i, i3, i2, i1, n, m, k);
  }
}
