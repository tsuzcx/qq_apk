  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (TabLayout.a(this.this$0).size() > this.eFI)
    {
      float f = ((TabLayout.TabView)TabLayout.a(this.this$0).get(this.eFI)).getX();
      localLayoutParams.setMargins((int)(((TabLayout.TabView)TabLayout.a(this.this$0).get(this.eFI)).getWidth() / 2.0F + f - TabLayout.a(this.this$0).getWidth() / 2.0F), 0, 0, 0);
    }
    for (;;)
    {
