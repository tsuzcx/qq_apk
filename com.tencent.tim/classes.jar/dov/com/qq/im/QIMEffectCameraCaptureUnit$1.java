  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject = ((ActivityManager)this.val$activity.getSystemService("activity")).getRunningTasks(1);
    ...
    do
    {
      ...
      this.val$activity.setResult(this.val$resultCode, this.val$data);
