...
public class amnk
  ...
  implements aqza
{
  public amnk(Context paramContext, Activity paramActivity, AppInterface paramAppInterface, TouchWebView paramTouchWebView)
  {
  ...
  public void buildWebView(AppInterface paramAppInterface)
  {
    ...
    this.mWebview.setWebViewClient(new amnl(this, this.mWebview.getPluginEngine()));
  }
