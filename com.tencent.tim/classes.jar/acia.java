...
public class acia
  extends accg
{
  public acia(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(int paramInt, SubMsgType0x27.NewComeinUserNotify paramNewComeinUserNotify)
  {
    ...
    if (paramInt == 2) {
      if (paramNewComeinUserNotify.msg_new_group.has())
      {
        ...
        notifyUI(4, true, new Object[] { new agay(l1 + "", paramNewComeinUserNotify, l2 + "", (String)localObject1, (String)localObject2) });
      }
    }
    ...
    notifyUI(5, true, new Object[] { new agbb(l1 + "", paramNewComeinUserNotify, paramInt, i, (String)localObject1) });
  }
  
  protected void as(boolean paramBoolean, Object paramObject)
  {
    if (QLog.isColorLevel()) {
      ...
      if ((paramBoolean) && (paramObject != null))
      {
        ...
        if (paramObject != null)
        {
          ...
          while (i < paramObject.size())
          {
            ...
            localArrayList.add(new agay(l1 + "", str1, l2 + "", str2, (String)localObject2));
            i += 1;
          }
        }
      }
  ...
  protected void at(boolean paramBoolean, Object paramObject)
  {
    if (QLog.isColorLevel()) {
  ...
  protected void au(boolean paramBoolean, Object paramObject)
  {
    if (QLog.isColorLevel()) {
  ...
  public void ay(long paramLong, int paramInt)
  {
  ...
  public void d(long paramLong1, long paramLong2, String paramString, int paramInt)
  {
  ...
  public boolean k(long paramLong, int paramInt)
  {
    boolean bool = true;
    ...
    appoint_define.LBSInfo localLBSInfo = ajpf.a(getClass().getSimpleName());
