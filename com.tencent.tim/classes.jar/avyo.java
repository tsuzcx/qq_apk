...
public class avyo
{
  ...
  public static final String cOu = rU(iZ[0]);
  public static final String cOv = rU(iZ[1]);
  public static final String[] iZ = { "image_filter_common", "image_filter_gpu", "format_convert", "ParticleSystem", "pitu_tools", "YTCommon", "YTIllumination", "YTFaceTrackPro", "algo_youtu_jni" };
  ...
  public static PluginRecord a(File paramFile)
  {
    ...
    //   10: astore_1
    //   11: aload_0
    //   12: invokevirtual 180	java/io/File:length	()J
    //   15: l2i
    //   16: newarray byte
    //   18: astore_0
    //   19: aload_2
    ...
    //   21: aload_2
    //   22: aload_0
    //   23: invokevirtual 184	java/io/FileInputStream:read	([B)I
    //   26: pop
    //   27: aload_2
    //   28: astore_1
    //   29: new 14	java/lang/String
    //   32: dup
    //   33: aload_0
    //   34: iconst_0
    //   35: invokestatic 190	aqgo:decode	([BI)[B
    //   38: invokespecial 193	java/lang/String:<init>	([B)V
    //   41: astore_3
    //   42: aload_2
    //   43: astore_1
    //   44: new 195	cooperation/qzone/plugin/PluginRecord
    //   47: dup
    //   48: invokespecial 196	cooperation/qzone/plugin/PluginRecord:<init>	()V
    //   51: astore_0
    //   52: aload_2
    //   53: astore_1
    //   54: aload_0
    //   55: aload_3
    //   56: invokevirtual 200	cooperation/qzone/plugin/PluginRecord:fromJson	(Ljava/lang/String;)V
    //   59: aload_0
    //   60: astore_1
    //   61: aload_2
    //   62: ifnull +9 -> 71
    //   65: aload_2
    //   66: invokevirtual 203	java/io/FileInputStream:close	()V
    //   69: aload_0
    //   70: astore_1
    //   71: aload_1
    //   72: areturn
    //   73: astore_1
    //   74: aload_1
    //   75: invokevirtual 206	java/io/IOException:printStackTrace	()V
    //   78: aload_0
    //   79: areturn
    //   80: astore_3
    //   81: aconst_null
    ...
    //   86: astore_1
    //   87: aload_3
    //   88: invokevirtual 207	java/io/FileNotFoundException:printStackTrace	()V
    //   91: aload_0
    //   92: astore_1
    //   93: aload_2
    //   94: ifnull -23 -> 71
    //   97: aload_2
    //   98: invokevirtual 203	java/io/FileInputStream:close	()V
    //   101: aload_0
    //   102: areturn
    //   103: astore_1
    //   104: aload_1
    //   105: invokevirtual 206	java/io/IOException:printStackTrace	()V
    //   108: aload_0
    //   109: areturn
    //   110: astore_3
    //   111: aconst_null
    ...
    //   116: astore_1
    //   117: aload_3
    //   118: invokevirtual 206	java/io/IOException:printStackTrace	()V
    //   121: aload_0
    //   122: astore_1
    //   123: aload_2
    //   124: ifnull -53 -> 71
    //   127: aload_2
    //   128: invokevirtual 203	java/io/FileInputStream:close	()V
    //   131: aload_0
    //   132: areturn
    //   133: astore_1
    //   134: aload_1
    //   135: invokevirtual 206	java/io/IOException:printStackTrace	()V
    //   138: aload_0
    //   139: areturn
    //   140: astore_0
    //   141: aconst_null
    ...
    //   144: ifnull +7 -> 151
    //   147: aload_1
    //   148: invokevirtual 203	java/io/FileInputStream:close	()V
    //   151: aload_0
    //   152: athrow
    //   153: astore_1
    //   154: aload_1
    //   155: invokevirtual 206	java/io/IOException:printStackTrace	()V
    //   158: goto -7 -> 151
    //   161: astore_0
    //   162: goto -19 -> 143
    //   165: astore_3
  ...
  public static void a(Context paramContext, Map<String, PluginRecord> paramMap, avyf.d paramd)
  {
    paramContext = e(paramContext.getDir("qzone_installed_plugin", 0));
      ...
      if (i < j)
      {
        ...
        if (localFile.exists())
        {
          ...
          if (localPluginRecord != null)
          {
            boolean bool = true;
            if (paramd != null) {
              bool = paramd.a(localPluginRecord, localFile);
            }
            if (!bool) {
              break label97;
            }
  ...
  private static boolean a(File paramFile, PluginRecord paramPluginRecord)
  {
    ...
    //   6: astore 4
    //   8: aload_1
    //   9: invokevirtual 272	cooperation/qzone/plugin/PluginRecord:toJson	()Ljava/lang/String;
    //   12: astore 6
    //   14: invokestatic 113	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   17: ifeq +29 -> 46
    //   20: ldc 115
    //   22: iconst_2
    ...
    //   36: aload_1
    //   37: invokevirtual 277	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   40: invokevirtual 129	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   43: invokestatic 163	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   46: aload 6
    //   48: invokevirtual 281	java/lang/String:getBytes	()[B
    //   51: iconst_0
    //   52: invokestatic 284	aqgo:encode	([BI)[B
    //   55: astore_1
    //   56: new 286	java/io/FileOutputStream
    //   59: dup
    //   60: aload_0
    //   61: invokespecial 287	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   64: astore_0
    //   65: aload_0
    //   66: aload_1
    //   67: invokevirtual 290	java/io/FileOutputStream:write	([B)V
    //   70: iconst_1
    //   71: istore_3
    //   72: iload_3
    //   73: istore_2
    ...
    //   75: ifnull +9 -> 84
    //   78: aload_0
    //   79: invokevirtual 291	java/io/FileOutputStream:close	()V
    //   82: iload_3
    //   83: istore_2
    //   84: iload_2
    //   85: ireturn
    ...
    //   91: ifnull -7 -> 84
    //   94: aload_0
    //   95: invokevirtual 291	java/io/FileOutputStream:close	()V
    //   98: iconst_0
    //   99: ireturn
    //   100: astore_0
    //   101: iconst_0
    ...
    //   108: ifnull +7 -> 115
    //   111: aload_1
    //   112: invokevirtual 291	java/io/FileOutputStream:close	()V
    //   115: aload_0
    //   116: athrow
    //   117: astore_0
    //   118: iconst_1
  ...
  public static void b(Context paramContext, Map<String, PluginRecord> paramMap)
  {
    int j = 0;
    int i = 0;
    Object localObject = paramContext.getDir("qzone_plugin_info", 0);
    boolean bool = avgf.K((File)localObject);
    paramContext = e((File)localObject);
    if (paramContext != null)
    {
      if (!bool) {
        break label73;
  ...
  public static String bO(Context paramContext)
  {
    ...
    if ("qzone_live_video_plugin.apk".equals(GF())) {
  ...
  {
    boolean bool2 = false;
    paramContext = bO(paramContext);
    boolean bool3 = fileExists(paramContext + cOu);
    boolean bool4 = fileExists(paramContext + cOv);
    boolean bool5 = fileExists(paramContext + "libformat_convert.so");
    boolean bool6 = fileExists(paramContext + "libpitu_tools.so");
  ...
  {
    return paramFile.listFiles(new avyp());
  }
  ...
  public static void g(PluginRecord paramPluginRecord)
  {
    try
    {
      File localFile = e(BaseApplicationImpl.getContext(), paramPluginRecord.id);
  ...
  public static void h(PluginRecord paramPluginRecord)
  {
    try
    {
      File localFile = f(BaseApplicationImpl.getContext(), paramPluginRecord.id);
      if ((localFile.isFile()) && (localFile.exists()))
      {
        localFile.delete();
        localFile.createNewFile();
  ...
  public static void i(PluginRecord paramPluginRecord)
  {
    try
    {
      paramPluginRecord = f(BaseApplicationImpl.getContext(), paramPluginRecord.id);
