...
public class DefaultThumbnailLoader
{
  ...
  public String getOfflineThumbnail(String paramString, IWyFileSystem.ThumbnailType paramThumbnailType)
  {
    ...
    if (this.mCacheInit) {
      paramString = (String)this.mDiskCache.get(paramString);
    }
    do
    {
      return paramString;
      paramThumbnailType = this.mCachePath + paramString;
      paramString = paramThumbnailType;
    } while (Utils.getFileSize(paramThumbnailType) > 0L);
    return null;
  }
  ...
  public String getThumbnail(String paramString1, IWyFileSystem.ThumbnailType paramThumbnailType, String paramString2, long paramLong)
  {
    paramString1 = generateKey(paramString1, paramThumbnailType, paramString2, paramLong);
    if (this.mCacheInit) {
      paramString1 = (String)this.mDiskCache.get(paramString1);
    }
    do
    {
      return paramString1;
      paramThumbnailType = this.mCachePath + paramString1;
      paramString1 = paramThumbnailType;
    } while (Utils.getFileSize(paramThumbnailType) > 0L);
    return null;
  }
    ...
    implements Runnable
  {
    ...
    private void buildCache(String paramString)
    {
      ...
      int i = 0;
      while ((i < paramString.length) && (!this.mCanceled))
      {
    ...
    extends LruCache<K, String>
  {
    ...
    public void clearMemory()
    {
      ...
      while (localIterator.hasNext()) {
        super.remove(localIterator.next());
      }
    }
  ...
  public static class ThumbnailJobProxy
    implements IWyFileSystem.WyCommand, Job.JobListener
  {
