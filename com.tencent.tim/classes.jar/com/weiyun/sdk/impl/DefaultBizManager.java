  ...
  implements IWyBizManager
{
  ...
  public IWyFileSystem.WyCommand reportAlbumStatus(boolean paramBoolean, int paramInt1, int paramInt2, long paramLong, IWyFileSystem.IWyCallback<Boolean> paramIWyCallback)
  {
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      SdkContext.getInstance().getSender().sendRequest("OfflineFilleHandleSvr.pb_weiyun_CMD_REQ_ALBUM_STATUS_REPORT-273", ((Cmd0X31B.ReqBody)localObject).toByteArray(), new DefaultBizManager.1(this, paramIWyCallback));
