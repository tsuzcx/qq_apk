  ...
  extends AbstractSemCameraCaptureProcessor
{
    ...
    extends SemCameraCaptureProcessor.CaptureCallback
  {
    ...
    {
      Log.i(SemCameraCaptureProcessor10_2.TAG, " SemCaptureCallBack onError!!! " + paramInt);
      if (SemCameraCaptureProcessor10_2.this.mSDKCaptureCallback != null) {
        SemCameraCaptureProcessor10_2.this.mSDKCaptureCallback.onError(paramInt);
      }
    }
    
    public void onPictureAvailable(ByteBuffer paramByteBuffer)
    {
      Log.i(SemCameraCaptureProcessor10_2.TAG, " SemCaptureCallBack onPictureAvailable!!! " + paramByteBuffer);
      if (SemCameraCaptureProcessor10_2.this.mSDKCaptureCallback != null) {
        SemCameraCaptureProcessor10_2.this.mSDKCaptureCallback.onPictureAvailable(paramByteBuffer);
      }
    }
