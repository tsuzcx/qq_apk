  ...
  extends AbstractSemCameraCaptureProcessor
{
    ...
    extends SemCameraCaptureProcessor.CaptureCallback
  {
    ...
    {
      Log.i(SemCameraCaptureProcessor10_1.TAG, " SemCaptureCallBack onError!!! " + paramInt);
      if (SemCameraCaptureProcessor10_1.this.mSDKCaptureCallback != null) {
        SemCameraCaptureProcessor10_1.this.mSDKCaptureCallback.onError(paramInt);
      }
    }
    
    public void onPictureAvailable(ByteBuffer paramByteBuffer)
    {
      Log.i(SemCameraCaptureProcessor10_1.TAG, " SemCaptureCallBack onPictureAvailable!!! " + paramByteBuffer);
      if (SemCameraCaptureProcessor10_1.this.mSDKCaptureCallback != null) {
        SemCameraCaptureProcessor10_1.this.mSDKCaptureCallback.onPictureAvailable(paramByteBuffer);
      }
    }
