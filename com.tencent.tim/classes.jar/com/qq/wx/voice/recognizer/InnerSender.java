  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      localObject1 = (a)this.h.removeFirst();
    ...
    {
      this.i.a();
      this.i.a(((a)localObject1).d);
    }
    if (((a)localObject1).c == InnerAudioState.end) {
      this.i.b(((a)localObject1).d);
    }
    label432:
    label453:
    label474:
    ...
    for (int m = 1;; m = 0)
    {
      ...
      this.i.a(((a)localObject1).a, ((a)localObject1).b, m);
      ...
      for (;;)
      {
        if (((a)localObject1).c != InnerAudioState.middle) {
          LogTool.d("offset = " + ((a)localObject1).d + " state = " + ((a)localObject1).c);
        }
        if (((a)localObject1).c != InnerAudioState.stop) {
          break;
        }
      ...
      for (m = i2 | m | 0x0 | n | i1;; m = 0)
      {
        if (m != 0)
        {
          if (((a)this.g.getFirst()).c == InnerAudioState.cancel)
          {
            localObject1 = (a)this.g.removeFirst();
        ...
        for (m = ((a)this.g.getFirst()).d;; m = 0)
        {
          if (((a)this.g.getLast()).c == InnerAudioState.end)
          {
            localObject1 = InnerAudioState.end;
            m = ((a)this.g.getLast()).d;
          }
          if (((a)this.g.getLast()).c == InnerAudioState.stop)
          {
          ...
          for (;;)
          {
            for (;;)
            {
              ...
              try
              {
                ...
                localObject1 = new a(((ByteArrayOutputStream)localObject3).toByteArray(), n, (InnerAudioState)localObject1, m);
                this.h.add(localObject1);
              ...
              if (localObject2 != null)
              {
                ...
                {
                  localObject2 = new a(null, 0, ((a)localObject2).b, ((a)localObject2).c);
                ...
                {
                  locala = new a((byte[])localObject3, ((a)localObject2).a.length, InnerAudioState.end, ((a)localObject2).c);
                  this.g.add(locala);
                  localTRSilk.silkRelease();
                  localTRSilk.silkInit();
                  this.d = 0;
                  this.f = new a(a(localTRSilk, (a)localObject2), ((a)localObject2).a.length, InnerAudioState.begin, ((a)localObject2).c);
                ...
                for (;;)
                {
                  ...
                  break;
                  locala = new a((byte[])localObject3, localIOException2.a.length, localIOException2.b, localIOException2.c);
                  this.g.add(locala);
