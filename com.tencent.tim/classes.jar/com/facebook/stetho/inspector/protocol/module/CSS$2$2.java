  ...
  implements StyleAccumulator
{
  ...
  public void store(String paramString1, String paramString2, boolean paramBoolean)
  {
    if (!paramBoolean)
    {
      ...
      this.this$1.val$accessibilityMatch.rule.style.cssProperties.add(localCSSProperty);
    }
  }
}
 ...
 * Qualified Name:     com.facebook.stetho.inspector.protocol.module.CSS.2.2
