...
public abstract interface b
{
  ...
  public static class a
  {
    ...
    public static String a(String paramString)
    {
      ...
      //   13: aload 5
      //   15: astore_2
      //   16: new 79	org/json/JSONObject
      //   19: dup
      //   20: aload_0
      //   21: invokespecial 82	org/json/JSONObject:<init>	(Ljava/lang/String;)V
      //   24: astore 6
      //   26: aload_3
      //   27: astore_1
      //   28: aload 5
      ...
      //   31: aload 6
      //   33: ldc 84
      //   35: invokevirtual 87	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
      //   38: astore_0
      //   39: aload_3
      //   40: astore_1
      //   41: aload_0
      ...
      //   43: aload 6
      //   45: ldc 89
      //   47: invokevirtual 87	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
      //   50: astore_3
      //   51: aload_3
      //   52: astore_1
      //   53: aload_0
      ...
      //   55: aload 6
      //   57: ldc 91
      //   59: invokevirtual 87	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
      //   62: astore 5
      //   64: aload 5
      //   66: astore_1
      //   67: aload 6
      //   69: ldc 93
      //   71: invokevirtual 87	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
      //   74: astore 5
      //   76: aload_3
      //   77: astore 4
      //   79: aload_1
      ...
      //   81: aload 5
      //   83: astore_3
      //   84: new 79	org/json/JSONObject
      //   87: dup
      //   88: invokespecial 94	org/json/JSONObject:<init>	()V
      //   91: astore_1
      //   92: aload_1
      //   93: ldc 96
      //   95: aload_0
      //   96: invokevirtual 100	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
      //   99: pop
      //   100: aload_1
      //   101: invokevirtual 103	org/json/JSONObject:toString	()Ljava/lang/String;
      //   104: astore_0
      //   105: new 105	com/qq/a/a/a/d
      //   108: dup
      //   109: invokestatic 109	com/b/a/j:e	()Ljava/lang/String;
      //   112: invokestatic 111	com/b/a/j:a	()Ljava/lang/String;
      //   115: invokestatic 113	com/b/a/j:b	()Ljava/lang/String;
      //   118: invokespecial 116	com/qq/a/a/a/d:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
      //   121: aload 4
      //   123: aload_2
      //   124: aload_3
      //   125: aload_0
      //   126: invokevirtual 119	com/qq/a/a/a/d:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
      //   129: astore_0
      //   130: aload_0
      //   131: areturn
      //   132: astore_3
      ...
      //   141: astore_2
      //   142: aload_3
      //   143: invokevirtual 120	org/json/JSONException:printStackTrace	()V
      //   146: aload 4
      //   148: astore_3
      //   149: aload_1
      //   150: astore 4
      ...
      //   155: astore_0
      //   156: aload_0
      //   157: invokevirtual 120	org/json/JSONException:printStackTrace	()V
      //   160: goto -60 -> 100
      //   163: astore_0
      //   164: aload_0
      //   165: invokevirtual 121	com/qq/a/a/a/a:printStackTrace	()V
      //   168: aconst_null
      //   169: areturn
      //   170: astore 5
      //   172: aload_1
    ...
    public static n b()
    {
      try
      {
        if (h == null)
        {
          ...
          com.b.a.a.b localb = new com.b.a.a.b(new g());
