  ...
  extends MediaChunk
{
    ...
    throws IOException, InterruptedException
  {
    ...
    //   8: ifeq +170 -> 178
    //   11: aload_0
    //   12: getfield 160	com/google/android/exoplayer2/source/hls/HlsMediaChunk:dataSpec	Lcom/google/android/exoplayer2/upstream/DataSpec;
    //   15: astore 6
    //   17: aload_0
    //   18: getfield 162	com/google/android/exoplayer2/source/hls/HlsMediaChunk:bytesLoaded	I
    //   21: ifeq +152 -> 173
    //   24: aload_0
    ...
    //   35: invokevirtual 167	com/google/android/exoplayer2/util/TimestampAdjuster:waitUntilInitialized	()V
    //   38: new 169	com/google/android/exoplayer2/extractor/DefaultExtractorInput
    //   41: dup
    //   42: aload_0
    ...
    //   46: aload 6
    //   48: getfield 173	com/google/android/exoplayer2/upstream/DataSpec:absoluteStreamPosition	J
    //   51: aload_0
    ...
    //   55: aload 6
    //   57: invokeinterface 179 2 0
    //   62: invokespecial 182	com/google/android/exoplayer2/extractor/DefaultExtractorInput:<init>	(Lcom/google/android/exoplayer2/upstream/DataSource;JJ)V
    //   65: astore 6
    //   67: aload_0
    //   68: getfield 123	com/google/android/exoplayer2/source/hls/HlsMediaChunk:isPackedAudioExtractor	Z
    //   71: ifeq +56 -> 127
    //   74: aload_0
    //   75: getfield 184	com/google/android/exoplayer2/source/hls/HlsMediaChunk:id3TimestampPeeked	Z
    //   78: ifne +49 -> 127
    //   81: aload_0
    //   82: aload 6
    //   84: invokespecial 188	com/google/android/exoplayer2/source/hls/HlsMediaChunk:peekId3PrivTimestamp	(Lcom/google/android/exoplayer2/extractor/ExtractorInput;)J
    //   87: lstore 4
    //   89: aload_0
    //   90: iconst_1
    //   91: putfield 184	com/google/android/exoplayer2/source/hls/HlsMediaChunk:id3TimestampPeeked	Z
    //   94: aload_0
    //   95: getfield 190	com/google/android/exoplayer2/source/hls/HlsMediaChunk:output	Lcom/google/android/exoplayer2/source/hls/HlsSampleStreamWrapper;
    //   98: astore 7
    //   100: lload 4
    //   102: ldc2_w 191
    //   105: lcmp
    ...
    //   113: lload 4
    //   115: invokevirtual 196	com/google/android/exoplayer2/util/TimestampAdjuster:adjustTsTimestamp	(J)J
    //   118: lstore 4
    //   120: aload 7
    //   122: lload 4
    //   124: invokevirtual 202	com/google/android/exoplayer2/source/hls/HlsSampleStreamWrapper:setSampleOffsetUs	(J)V
    //   127: iload_3
    //   128: istore_2
    //   129: iload_1
    //   130: ifeq +16 -> 146
    //   133: aload 6
    //   135: aload_0
    //   136: getfield 162	com/google/android/exoplayer2/source/hls/HlsMediaChunk:bytesLoaded	I
    //   139: invokeinterface 207 2 0
    //   144: iload_3
    //   145: istore_2
    //   146: iload_2
    //   147: ifne +87 -> 234
    //   150: aload_0
    //   151: getfield 209	com/google/android/exoplayer2/source/hls/HlsMediaChunk:loadCanceled	Z
    //   154: ifne +80 -> 234
    //   157: aload_0
    ...
    //   175: goto -151 -> 24
    //   178: aload_0
    //   179: getfield 160	com/google/android/exoplayer2/source/hls/HlsMediaChunk:dataSpec	Lcom/google/android/exoplayer2/upstream/DataSpec;
    //   182: aload_0
    //   183: getfield 162	com/google/android/exoplayer2/source/hls/HlsMediaChunk:bytesLoaded	I
    //   186: i2l
    //   187: invokevirtual 217	com/google/android/exoplayer2/upstream/DataSpec:subrange	(J)Lcom/google/android/exoplayer2/upstream/DataSpec;
    //   190: astore 6
    //   192: iconst_0
    //   193: istore_1
    //   194: goto -170 -> 24
    ...
    //   201: invokevirtual 221	com/google/android/exoplayer2/util/TimestampAdjuster:getFirstSampleTimestampUs	()J
    //   204: ldc2_w 222
    //   207: lcmp
    //   208: ifne -170 -> 38
    //   211: aload_0
    ...
    //   215: aload_0
    //   216: getfield 226	com/google/android/exoplayer2/source/hls/HlsMediaChunk:startTimeUs	J
    //   219: invokevirtual 229	com/google/android/exoplayer2/util/TimestampAdjuster:setFirstSampleTimestampUs	(J)V
    //   222: goto -184 -> 38
    //   225: aload_0
    //   226: getfield 226	com/google/android/exoplayer2/source/hls/HlsMediaChunk:startTimeUs	J
    //   229: lstore 4
    //   231: goto -111 -> 120
    //   234: aload_0
    //   235: aload 6
    ...
    //   242: aload_0
    //   243: getfield 160	com/google/android/exoplayer2/source/hls/HlsMediaChunk:dataSpec	Lcom/google/android/exoplayer2/upstream/DataSpec;
    //   246: getfield 173	com/google/android/exoplayer2/upstream/DataSpec:absoluteStreamPosition	J
    //   249: lsub
    //   250: l2i
    //   251: putfield 162	com/google/android/exoplayer2/source/hls/HlsMediaChunk:bytesLoaded	I
    //   254: aload_0
    ...
    //   258: invokestatic 238	com/google/android/exoplayer2/util/Util:closeQuietly	(Lcom/google/android/exoplayer2/upstream/DataSource;)V
    //   261: return
    //   262: astore 7
    //   264: aload_0
    //   265: aload 6
    //   267: invokeinterface 232 1 0
    //   272: aload_0
    //   273: getfield 160	com/google/android/exoplayer2/source/hls/HlsMediaChunk:dataSpec	Lcom/google/android/exoplayer2/upstream/DataSpec;
    //   276: getfield 173	com/google/android/exoplayer2/upstream/DataSpec:absoluteStreamPosition	J
    //   279: lsub
    //   280: l2i
    //   281: putfield 162	com/google/android/exoplayer2/source/hls/HlsMediaChunk:bytesLoaded	I
    //   284: aload 7
    //   286: athrow
    //   287: astore 6
    //   289: aload_0
    ...
    //   293: invokestatic 238	com/google/android/exoplayer2/util/Util:closeQuietly	(Lcom/google/android/exoplayer2/upstream/DataSource;)V
    //   296: aload 6
    //   298: athrow
    ...
    throws IOException, InterruptedException
  {
    ...
    //   19: aload_0
    //   20: getfield 242	com/google/android/exoplayer2/source/hls/HlsMediaChunk:initSegmentBytesLoaded	I
    //   23: i2l
    //   24: invokevirtual 217	com/google/android/exoplayer2/upstream/DataSpec:subrange	(J)Lcom/google/android/exoplayer2/upstream/DataSpec;
    //   27: astore_2
    //   28: new 169	com/google/android/exoplayer2/extractor/DefaultExtractorInput
    //   31: dup
    //   32: aload_0
    ...
    //   36: aload_2
    //   37: getfield 173	com/google/android/exoplayer2/upstream/DataSpec:absoluteStreamPosition	J
    //   40: aload_0
    ...
    //   50: invokespecial 182	com/google/android/exoplayer2/extractor/DefaultExtractorInput:<init>	(Lcom/google/android/exoplayer2/upstream/DataSource;JJ)V
    //   53: astore_2
    //   54: iconst_0
    //   55: istore_1
    //   56: iload_1
    //   57: ifne +25 -> 82
    //   60: aload_0
    //   61: getfield 209	com/google/android/exoplayer2/source/hls/HlsMediaChunk:loadCanceled	Z
    //   64: ifne +18 -> 82
    //   67: aload_0
    ...
    //   71: aload_2
    //   72: aconst_null
    //   73: invokeinterface 213 3 0
    //   78: istore_1
    //   79: goto -23 -> 56
    //   82: aload_0
    //   83: aload_2
    //   84: invokeinterface 232 1 0
    //   89: aload_0
    ...
    //   93: getfield 173	com/google/android/exoplayer2/upstream/DataSpec:absoluteStreamPosition	J
    //   96: lsub
    //   97: l2i
    //   98: putfield 242	com/google/android/exoplayer2/source/hls/HlsMediaChunk:initSegmentBytesLoaded	I
    //   101: aload_0
    ...
    //   105: invokestatic 238	com/google/android/exoplayer2/util/Util:closeQuietly	(Lcom/google/android/exoplayer2/upstream/DataSource;)V
    //   108: aload_0
    //   109: iconst_1
    ...
    //   126: getfield 173	com/google/android/exoplayer2/upstream/DataSpec:absoluteStreamPosition	J
    //   129: lsub
    //   130: l2i
    //   131: putfield 242	com/google/android/exoplayer2/source/hls/HlsMediaChunk:initSegmentBytesLoaded	I
    //   134: aload_3
    //   135: athrow
    //   136: astore_2
    //   137: aload_0
    ...
    //   141: invokestatic 238	com/google/android/exoplayer2/util/Util:closeQuietly	(Lcom/google/android/exoplayer2/upstream/DataSource;)V
    //   144: aload_2
    //   145: athrow
    // Local variable table:
    //   start	length	slot	name	signature
