...
public abstract interface MediaSourceEventListener
{
  ...
  public static final class EventDispatcher
  {
    ...
    public EventDispatcher(@Nullable Handler paramHandler, @Nullable MediaSourceEventListener paramMediaSourceEventListener)
    {
      this(paramHandler, paramMediaSourceEventListener, 0L);
    }
    
    public EventDispatcher(@Nullable Handler paramHandler, @Nullable MediaSourceEventListener paramMediaSourceEventListener, long paramLong)
    {
