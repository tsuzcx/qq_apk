  ...
  implements Handler.Callback, DefaultMediaClock.PlaybackParameterListener, PlayerMessage.Sender, MediaPeriod.Callback, MediaSource.Listener, TrackSelector.InvalidationListener
{
    ...
    throws ExoPlaybackException, IOException
  {
    ...
    if ((this.parallelRender) && (this.playbackInfo.playbackState != 3))
    {
      ...
      RendererRunnable[] arrayOfRendererRunnable = new RendererRunnable[this.enabledRenderers.length];
      ...
      while (j < k)
      {
        ...
        RendererRunnable localRendererRunnable = new RendererRunnable(localRenderer, this.rendererPositionUs, l2, localCountDownLatch);
      ...
      try
      {
        ...
        if (((RendererRunnable)localObject).getExceptionThrown() != null) {
          throw ((RendererRunnable)localObject).getExceptionThrown();
        }
      }
    ...
    throws ExoPlaybackException
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localPendingMessageInfo2 = (PendingMessageInfo)this.pendingMessages.get(this.nextPendingMessageIndex);
        break label315;
        break;
        this.nextPendingMessageIndex += 1;
      }
  ...
  public void release()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 961	com/google/android/exoplayer2/ExoPlayerImplInternal:released	Z
    //   6: istore_2
    //   7: iload_2
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 277	com/google/android/exoplayer2/ExoPlayerImplInternal:handler	Lcom/google/android/exoplayer2/util/HandlerWrapper;
    //   18: bipush 7
    //   20: invokeinterface 954 2 0
    //   25: pop
    //   26: iconst_0
    //   27: istore_1
    //   28: aload_0
    //   29: getfield 961	com/google/android/exoplayer2/ExoPlayerImplInternal:released	Z
    //   32: istore_2
    //   33: iload_2
    //   34: ifne +16 -> 50
    //   37: aload_0
    //   38: invokevirtual 1331	java/lang/Object:wait	()V
    //   41: goto -13 -> 28
    //   44: astore_3
    //   45: iconst_1
    //   46: istore_1
    ...
    //   50: iload_1
    //   51: ifeq -40 -> 11
    //   54: invokestatic 475	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   57: invokevirtual 478	java/lang/Thread:interrupt	()V
    //   60: goto -49 -> 11
    //   63: astore_3
    //   64: aload_0
    //   65: monitorexit
  ...
  public void sendMessage(PlayerMessage paramPlayerMessage)
  {
    ...
    //   9: ldc 77
    //   11: ldc_w 1335
    //   14: invokestatic 1339	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   17: pop
    //   18: aload_1
    //   19: iconst_0
    //   20: invokevirtual 317	com/google/android/exoplayer2/PlayerMessage:markAsProcessed	(Z)V
    //   23: aload_0
    //   24: monitorexit
    //   25: return
    //   26: aload_0
    //   27: getfield 277	com/google/android/exoplayer2/ExoPlayerImplInternal:handler	Lcom/google/android/exoplayer2/util/HandlerWrapper;
    //   30: bipush 14
    //   32: aload_1
    //   33: invokeinterface 1132 3 0
    //   38: invokevirtual 869	android/os/Message:sendToTarget	()V
    //   41: goto -18 -> 23
    //   44: astore_1
    //   45: aload_0
    //   46: monitorexit
  ...
  static final class PendingMessageInfo
    ...
    implements Runnable
  {
    ...
    public RendererRunnable(Renderer paramRenderer, long paramLong1, long paramLong2, CountDownLatch paramCountDownLatch)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if ((!this.renderer.isReady()) && (!this.renderer.isEnded())) {
            if (ExoPlayerImplInternal.this.rendererWaitingForNextStream(this.renderer))
            {
              break label147;
