  ...
  implements RenderersFactory
{
  ...
  protected void buildAudioRenderers(Context paramContext, @Nullable DrmSessionManager<FrameworkMediaCrypto> paramDrmSessionManager, AudioProcessor[] paramArrayOfAudioProcessor, Handler paramHandler, AudioRendererEventListener paramAudioRendererEventListener, int paramInt, ArrayList<Renderer> paramArrayList)
  {
    // Byte code:
    //   0: aload 7
    //   2: new 74	com/google/android/exoplayer2/audio/MediaCodecAudioRenderer
    //   5: dup
    //   6: getstatic 80	com/google/android/exoplayer2/mediacodec/MediaCodecSelector:DEFAULT	Lcom/google/android/exoplayer2/mediacodec/MediaCodecSelector;
    //   9: aload_2
    //   10: iconst_1
    //   11: aload 4
    //   13: aload 5
    //   15: aload_1
    //   16: invokestatic 86	com/google/android/exoplayer2/audio/AudioCapabilities:getCapabilities	(Landroid/content/Context;)Lcom/google/android/exoplayer2/audio/AudioCapabilities;
    //   19: aload_3
    //   20: invokespecial 89	com/google/android/exoplayer2/audio/MediaCodecAudioRenderer:<init>	(Lcom/google/android/exoplayer2/mediacodec/MediaCodecSelector;Lcom/google/android/exoplayer2/drm/DrmSessionManager;ZLandroid/os/Handler;Lcom/google/android/exoplayer2/audio/AudioRendererEventListener;Lcom/google/android/exoplayer2/audio/AudioCapabilities;[Lcom/google/android/exoplayer2/audio/AudioProcessor;)V
    //   23: invokevirtual 95	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   26: pop
    //   27: iload 6
    //   29: ifne +4 -> 33
    //   32: return
    //   33: aload 7
    //   35: invokevirtual 99	java/util/ArrayList:size	()I
    //   38: istore 9
    //   40: iload 9
    //   42: istore 8
    //   44: iload 6
    ...
    //   54: istore 8
    //   56: ldc 101
    //   58: invokestatic 107	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   61: iconst_3
    //   62: anewarray 103	java/lang/Class
    //   65: dup
    //   66: iconst_0
    //   67: ldc 109
    //   69: aastore
    ...
    //   77: ldc 113
    //   79: aastore
    //   80: invokevirtual 117	java/lang/Class:getConstructor	([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    //   83: iconst_3
    ...
    //   99: aload_3
    //   100: aastore
    //   101: invokevirtual 123	java/lang/reflect/Constructor:newInstance	([Ljava/lang/Object;)Ljava/lang/Object;
    //   104: checkcast 125	com/google/android/exoplayer2/Renderer
    //   107: astore_1
    //   108: iload 8
    //   110: iconst_1
    //   111: iadd
    ...
    //   116: iload 8
    //   118: aload_1
    //   119: invokevirtual 128	java/util/ArrayList:add	(ILjava/lang/Object;)V
    //   122: ldc 26
    //   124: ldc 130
    //   126: invokestatic 136	android/util/Log:i	(Ljava/lang/String;Ljava/lang/String;)I
    //   129: pop
    //   130: ldc 138
    //   132: invokestatic 107	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   135: iconst_3
    //   136: anewarray 103	java/lang/Class
    //   139: dup
    //   140: iconst_0
    //   141: ldc 109
    //   143: aastore
    ...
    //   151: ldc 113
    //   153: aastore
    //   154: invokevirtual 117	java/lang/Class:getConstructor	([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    //   157: iconst_3
    ...
    //   173: aload_3
    //   174: aastore
    //   175: invokevirtual 123	java/lang/reflect/Constructor:newInstance	([Ljava/lang/Object;)Ljava/lang/Object;
    //   178: checkcast 125	com/google/android/exoplayer2/Renderer
    //   181: astore_1
    //   182: iload 6
    //   184: iconst_1
    //   185: iadd
    ...
    //   190: iload 6
    //   192: aload_1
    //   193: invokevirtual 128	java/util/ArrayList:add	(ILjava/lang/Object;)V
    //   196: ldc 26
    //   198: ldc 140
    //   200: invokestatic 136	android/util/Log:i	(Ljava/lang/String;Ljava/lang/String;)I
    //   203: pop
    //   204: aload 7
    //   206: iload 8
    //   208: ldc 142
    //   210: invokestatic 107	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   213: iconst_3
    //   214: anewarray 103	java/lang/Class
    //   217: dup
    //   218: iconst_0
    //   219: ldc 109
    //   221: aastore
    ...
    //   229: ldc 113
    //   231: aastore
    //   232: invokevirtual 117	java/lang/Class:getConstructor	([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    //   235: iconst_3
    ...
    //   251: aload_3
    //   252: aastore
    //   253: invokevirtual 123	java/lang/reflect/Constructor:newInstance	([Ljava/lang/Object;)Ljava/lang/Object;
    //   256: checkcast 125	com/google/android/exoplayer2/Renderer
    //   259: invokevirtual 128	java/util/ArrayList:add	(ILjava/lang/Object;)V
    //   262: ldc 26
    //   264: ldc 144
    //   266: invokestatic 136	android/util/Log:i	(Ljava/lang/String;Ljava/lang/String;)I
    //   269: pop
    //   270: return
    //   271: astore_1
    //   272: return
    ...
    //   278: goto -148 -> 130
    //   281: astore_1
    //   282: new 146	java/lang/RuntimeException
    //   285: dup
    //   286: ldc 148
    //   288: aload_1
    //   289: invokespecial 151	java/lang/RuntimeException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   292: athrow
    //   293: astore_1
    //   294: iload 6
    //   296: istore 8
    //   298: goto -94 -> 204
    //   301: astore_1
    //   302: new 146	java/lang/RuntimeException
    //   305: dup
    //   306: ldc 153
    //   308: aload_1
    //   309: invokespecial 151	java/lang/RuntimeException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   312: athrow
    //   313: astore_1
    //   314: new 146	java/lang/RuntimeException
    //   317: dup
    //   318: ldc 155
    //   320: aload_1
    //   321: invokespecial 151	java/lang/RuntimeException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   324: athrow
    //   325: astore_1
    //   326: iload 8
    //   328: istore 6
