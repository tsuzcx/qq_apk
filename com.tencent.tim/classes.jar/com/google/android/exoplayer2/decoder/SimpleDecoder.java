  ...
  implements Decoder<I, O, E>
{
    ...
    throws InterruptedException
  {
    ...
    //   38: athrow
    //   39: aload_0
    //   40: getfield 98	com/google/android/exoplayer2/decoder/SimpleDecoder:released	Z
    //   43: ifeq +8 -> 51
    //   46: aload 5
    //   48: monitorexit
    //   49: iconst_0
    ...
    //   55: invokevirtual 107	java/util/LinkedList:removeFirst	()Ljava/lang/Object;
    //   58: checkcast 109	com/google/android/exoplayer2/decoder/DecoderInputBuffer
    //   61: astore_3
    //   62: aload_0
    ...
    //   84: astore 4
    //   86: aload_0
    //   87: getfield 111	com/google/android/exoplayer2/decoder/SimpleDecoder:flushed	Z
    //   90: istore_2
    //   91: aload_0
    //   92: iconst_0
    //   93: putfield 111	com/google/android/exoplayer2/decoder/SimpleDecoder:flushed	Z
    //   96: aload 5
    //   98: monitorexit
    //   99: aload_3
    //   100: invokevirtual 114	com/google/android/exoplayer2/decoder/DecoderInputBuffer:isEndOfStream	()Z
    //   103: ifeq +41 -> 144
    //   106: aload 4
    //   108: iconst_4
    //   109: invokevirtual 120	com/google/android/exoplayer2/decoder/OutputBuffer:addFlag	(I)V
    //   112: aload_0
    ...
    //   120: monitorenter
    //   121: aload_0
    //   122: getfield 111	com/google/android/exoplayer2/decoder/SimpleDecoder:flushed	Z
    //   125: ifeq +100 -> 225
    //   128: aload_0
    //   129: aload 4
    //   131: invokespecial 124	com/google/android/exoplayer2/decoder/SimpleDecoder:releaseOutputBufferInternal	(Lcom/google/android/exoplayer2/decoder/OutputBuffer;)V
    //   134: aload_0
    //   135: aload_3
    //   136: invokespecial 128	com/google/android/exoplayer2/decoder/SimpleDecoder:releaseInputBufferInternal	(Lcom/google/android/exoplayer2/decoder/DecoderInputBuffer;)V
    //   139: aload 5
    //   141: monitorexit
    //   142: iconst_1
    //   143: ireturn
    //   144: aload_3
    //   145: invokevirtual 131	com/google/android/exoplayer2/decoder/DecoderInputBuffer:isDecodeOnly	()Z
    //   148: ifeq +10 -> 158
    //   151: aload 4
    //   153: ldc 132
    //   155: invokevirtual 120	com/google/android/exoplayer2/decoder/OutputBuffer:addFlag	(I)V
    //   158: aload_0
    //   159: aload_0
    //   160: aload_3
    //   161: aload 4
    //   163: iload_2
    //   164: invokevirtual 135	com/google/android/exoplayer2/decoder/SimpleDecoder:decode	(Lcom/google/android/exoplayer2/decoder/DecoderInputBuffer;Lcom/google/android/exoplayer2/decoder/OutputBuffer;Z)Ljava/lang/Exception;
    //   167: putfield 137	com/google/android/exoplayer2/decoder/SimpleDecoder:exception	Ljava/lang/Exception;
    //   170: aload_0
    //   171: getfield 137	com/google/android/exoplayer2/decoder/SimpleDecoder:exception	Ljava/lang/Exception;
    //   174: ifnull -62 -> 112
    //   177: aload_0
    ...
    //   191: aload_0
    //   192: aload 5
    //   194: invokevirtual 141	com/google/android/exoplayer2/decoder/SimpleDecoder:createUnexpectedDecodeException	(Ljava/lang/Throwable;)Ljava/lang/Exception;
    //   197: putfield 137	com/google/android/exoplayer2/decoder/SimpleDecoder:exception	Ljava/lang/Exception;
    //   200: goto -30 -> 170
    //   203: astore 5
    //   205: aload_0
    //   206: aload_0
    //   207: aload 5
    //   209: invokevirtual 141	com/google/android/exoplayer2/decoder/SimpleDecoder:createUnexpectedDecodeException	(Ljava/lang/Throwable;)Ljava/lang/Exception;
    //   212: putfield 137	com/google/android/exoplayer2/decoder/SimpleDecoder:exception	Ljava/lang/Exception;
    //   215: goto -45 -> 170
    //   218: astore 4
    //   220: aload_3
    //   221: monitorexit
    ...
    //   224: athrow
    //   225: aload 4
    //   227: invokevirtual 142	com/google/android/exoplayer2/decoder/OutputBuffer:isDecodeOnly	()Z
    //   230: ifeq +28 -> 258
    //   233: aload_0
    //   234: aload_0
    //   235: getfield 144	com/google/android/exoplayer2/decoder/SimpleDecoder:skippedOutputBufferCount	I
    //   238: iconst_1
    //   239: iadd
    //   240: putfield 144	com/google/android/exoplayer2/decoder/SimpleDecoder:skippedOutputBufferCount	I
    //   243: aload_0
    //   244: aload 4
    //   246: invokespecial 124	com/google/android/exoplayer2/decoder/SimpleDecoder:releaseOutputBufferInternal	(Lcom/google/android/exoplayer2/decoder/OutputBuffer;)V
    //   249: goto -115 -> 134
    //   252: astore_3
    //   253: aload 5
    //   255: monitorexit
    ...
    //   258: aload 4
    //   260: aload_0
    //   261: getfield 144	com/google/android/exoplayer2/decoder/SimpleDecoder:skippedOutputBufferCount	I
    //   264: putfield 145	com/google/android/exoplayer2/decoder/OutputBuffer:skippedOutputBufferCount	I
    //   267: aload_0
    //   268: iconst_0
    //   269: putfield 144	com/google/android/exoplayer2/decoder/SimpleDecoder:skippedOutputBufferCount	I
    //   272: aload_0
    //   273: getfield 49	com/google/android/exoplayer2/decoder/SimpleDecoder:queuedOutputBuffers	Ljava/util/LinkedList;
    //   276: aload 4
    //   278: invokevirtual 149	java/util/LinkedList:addLast	(Ljava/lang/Object;)V
    //   281: goto -147 -> 134
