...
public final class MediaCodecUtil
{
    ...
    throws MediaCodecUtil.DecoderQueryException
  {
    ...
    for (;;)
    {
      try
      {
        CodecKey localCodecKey = new CodecKey(paramString, paramBoolean1);
        ...
        if (Util.SDK_INT >= 21)
        {
          localObject1 = new MediaCodecListCompatV21(paramBoolean1);
            ...
            if (localArrayList2.isEmpty())
            {
              ...
              if (21 <= Util.SDK_INT)
              {
                ...
                if (Util.SDK_INT <= 23)
                {
                  ...
                  localArrayList1 = getDecoderInfosInternal(localCodecKey, (MediaCodecListCompat)localObject2, paramString);
          ...
          if ("audio/eac3-joc".equals(paramString)) {
            localArrayList1.addAll(getDecoderInfosInternal(new CodecKey("audio/eac3", localCodecKey.secure), (MediaCodecListCompat)localObject2, paramString));
          }
  ...
  static abstract interface MediaCodecListCompat
  {
