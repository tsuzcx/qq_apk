...
public class MaterialInstance
{
  ...
  public void setParameter(@NonNull String paramString, @NonNull BooleanElement paramBooleanElement, @NonNull boolean[] paramArrayOfBoolean, @IntRange(from=0L) int paramInt1, @IntRange(from=1L) int paramInt2)
  {
  ...
  public void setParameter(@NonNull String paramString, @NonNull FloatElement paramFloatElement, @NonNull float[] paramArrayOfFloat, @IntRange(from=0L) int paramInt1, @IntRange(from=1L) int paramInt2)
  {
    nSetFloatParameterArray(getNativeObject(), paramString, paramFloatElement.ordinal(), paramArrayOfFloat, paramInt1, paramInt2);
  }
  
  public void setParameter(@NonNull String paramString, @NonNull IntElement paramIntElement, @NonNull int[] paramArrayOfInt, @IntRange(from=0L) int paramInt1, @IntRange(from=1L) int paramInt2)
  {
