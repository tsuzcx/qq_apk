...
public final class CacheStats
{
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    ...
    if ((paramObject instanceof CacheStats))
    {
      ...
      bool1 = bool2;
      if (this.hitCount == paramObject.hitCount)
      {
        bool1 = bool2;
        if (this.missCount == paramObject.missCount)
        {
          bool1 = bool2;
          if (this.loadSuccessCount == paramObject.loadSuccessCount)
          {
            bool1 = bool2;
            if (this.loadExceptionCount == paramObject.loadExceptionCount)
            {
              bool1 = bool2;
              if (this.totalLoadTime == paramObject.totalLoadTime)
              {
                bool1 = bool2;
                if (this.evictionCount == paramObject.evictionCount) {
                  bool1 = true;
                }
              }
            }
