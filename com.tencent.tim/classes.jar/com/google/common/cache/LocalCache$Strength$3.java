 ...
 enum LocalCache$Strength$3
{
  ...
  {
    if (paramInt == 1) {
      return new LocalCache.WeakValueReference(paramSegment.valueReferenceQueue, paramV, paramReferenceEntry);
    }
    return new LocalCache.WeightedWeakValueReference(paramSegment.valueReferenceQueue, paramV, paramReferenceEntry, paramInt);
  }
}
