...
public final class InternetDomainName
{
  ...
  InternetDomainName(String paramString)
  {
    ...
    {
      bool1 = true;
      Preconditions.checkArgument(bool1, "Domain name too long: '%s':", paramString);
    ...
    {
      Preconditions.checkArgument(bool1, "Domain has too many parts: '%s'", paramString);
      Preconditions.checkArgument(validateSyntax(this.parts), "Not a valid domain name: '%s'", paramString);
