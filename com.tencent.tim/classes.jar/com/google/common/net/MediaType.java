...
public final class MediaType
{
  ...
  private String computeToString()
  {
    ...
    if (!this.parameters.isEmpty())
    {
      ...
      ListMultimap localListMultimap = Multimaps.transformValues(this.parameters, new MediaType.2(this));
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    ...
    } while ((this.type.equals(paramObject.type)) && (this.subtype.equals(paramObject.subtype)) && (parametersAsMap().equals(paramObject.parametersAsMap())));
    return false;
    return false;
  }
