...
{
  private static final LoadingCache<Class<?>, ImmutableSet<Class<?>>> flattenHierarchyCache = CacheBuilder.newBuilder().weakKeys().build(new SubscriberRegistry.2());
  private static final LoadingCache<Class<?>, ImmutableList<Method>> subscriberMethodsCache = CacheBuilder.newBuilder().weakKeys().build(new SubscriberRegistry.1());
  @Weak
  ...
  private static ImmutableList<Method> getAnnotatedMethodsNotCached(Class<?> paramClass)
  {
    ...
    if (((Iterator)localObject1).hasNext())
    {
      ...
      {
        Preconditions.checkArgument(bool, "Method %s has @Subscribe annotation but has %s parameters.Subscriber methods must have exactly 1 parameter.", localMethod, localObject2.length);
  ...
  Iterator<Subscriber> getSubscribers(Object paramObject)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if (localObject2 != null) {
        paramObject.add(((CopyOnWriteArraySet)localObject2).iterator());
      }
    }
  ...
  void register(Object paramObject)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      Class localClass = (Class)paramObject.getKey();
      localCollection = (Collection)paramObject.getValue();
      paramObject = (CopyOnWriteArraySet)this.subscribers.get(localClass);
      if (paramObject != null) {
        break label118;
      }
    ...
    for (;;)
    {
      paramObject.addAll(localCollection);
      break;
      return;
    }
  }
  ...
  static final class MethodIdentifier
  {
    ...
    public boolean equals(@Nullable Object paramObject)
    {
      ...
      if ((paramObject instanceof MethodIdentifier))
      {
        ...
        {
          bool1 = bool2;
          if (this.parameterTypes.equals(paramObject.parameterTypes)) {
            bool1 = true;
          }
        }
      }
