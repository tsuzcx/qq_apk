  ...
  implements Serializable
{
  ...
  SipHashFunction(int paramInt1, int paramInt2, long paramLong1, long paramLong2)
  {
    ...
    {
      bool1 = true;
      Preconditions.checkArgument(bool1, "The number of SipRound iterations (c=%s) during Compression must be positive.", paramInt1);
      if (paramInt2 <= 0) {
        break label66;
      }
    }
    ...
    {
      Preconditions.checkArgument(bool1, "The number of SipRound iterations (d=%s) during Finalization must be positive.", paramInt2);
      this.c = paramInt1;
      this.d = paramInt2;
      this.k0 = paramLong1;
      this.k1 = paramLong2;
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    ...
    if ((paramObject instanceof SipHashFunction))
    {
      ...
      if (this.c == paramObject.c)
      {
        ...
        {
          bool1 = bool2;
          if (this.k0 == paramObject.k0)
          {
            bool1 = bool2;
            if (this.k1 == paramObject.k1) {
              bool1 = true;
            }
          }
        }
