...
public abstract class HashCode
{
  ...
  public static HashCode fromString(String paramString)
  {
    ...
    {
      bool1 = true;
      Preconditions.checkArgument(bool1, "input string (%s) must have at least 2 characters", paramString);
    ...
    {
      Preconditions.checkArgument(bool1, "input string (%s) must have an even number of characters", paramString);
  ...
  static final class BytesHashCode
    extends HashCode
  ...
  static final class IntHashCode
    extends HashCode
    implements Serializable
  {
    private static final long serialVersionUID = 0L;
