...
public final class ClassPath
{
  ...
  public static class ResourceInfo
  {
    ...
    {
      return Resources.asCharSource(url(), paramCharset);
    }
    ...
    public boolean equals(Object paramObject)
    {
      ...
      if ((paramObject instanceof ResourceInfo))
      {
        ...
        bool1 = bool2;
        if (this.resourceName.equals(paramObject.resourceName))
        {
          bool1 = bool2;
          if (this.loader == paramObject.loader) {
            bool1 = true;
          }
        }
      }
  ...
  static abstract class Scanner
  {
      ...
      throws IOException
    {
      ...
      {
        ClassPath.logger.warning("Cannot access " + paramFile + ": " + paramClassLoader);
        return;
      }
      if (paramFile.isDirectory())
      {
      ...
      throws IOException
    {
      ...
      //   3: dup
      //   4: aload_1
      //   5: invokespecial 231	java/util/jar/JarFile:<init>	(Ljava/io/File;)V
      //   8: astore_3
      //   9: aload_1
      //   10: aload_3
      //   11: invokevirtual 235	java/util/jar/JarFile:getManifest	()Ljava/util/jar/Manifest;
      //   14: invokestatic 237	com/google/common/reflect/ClassPath$Scanner:getClassPathFromManifest	(Ljava/io/File;Ljava/util/jar/Manifest;)Lcom/google/common/collect/ImmutableSet;
      //   17: invokevirtual 238	com/google/common/collect/ImmutableSet:iterator	()Ljava/util/Iterator;
      //   20: astore_1
      //   21: aload_1
      ...
      //   40: aload_2
      //   41: invokevirtual 241	com/google/common/reflect/ClassPath$Scanner:scan	(Ljava/io/File;Ljava/lang/ClassLoader;)V
      //   44: goto -23 -> 21
      //   47: astore_1
      //   48: aload_3
      //   49: invokevirtual 244	java/util/jar/JarFile:close	()V
      //   52: aload_1
      //   53: athrow
      //   54: aload_0
      //   55: aload_2
      //   56: aload_3
      //   57: invokevirtual 248	com/google/common/reflect/ClassPath$Scanner:scanJarFile	(Ljava/lang/ClassLoader;Ljava/util/jar/JarFile;)V
      //   60: aload_3
      //   61: invokevirtual 244	java/util/jar/JarFile:close	()V
      //   64: return
      //   65: astore_1
      //   66: return
      //   67: astore_2
      ...
      //   48	52	67	java/io/IOException
      //   0	9	71	java/io/IOException
    }
