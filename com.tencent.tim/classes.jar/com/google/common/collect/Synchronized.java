...
final class Synchronized
{
    ...
    extends Synchronized.SynchronizedMap<K, Collection<V>>
  {
    ...
    public Collection<V> get(Object paramObject)
    {
      synchronized (this.mutex)
      {
        ...
        paramObject = Synchronized.typePreservingCollection(paramObject, this.mutex);
      }
    }
  ...
  static final class SynchronizedDeque<E>
  ...
  @GwtIncompatible
  static class SynchronizedEntry<K, V>
    extends Synchronized.SynchronizedObject
  ...
  static class SynchronizedListMultimap<K, V>
  ...
  static class SynchronizedSetMultimap<K, V>
    extends Synchronized.SynchronizedMultimap<K, V>
  ...
  static class SynchronizedSortedSetMultimap<K, V>
