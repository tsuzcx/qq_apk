...
{
  private static final Function<? extends Map<?, ?>, ? extends Map<?, ?>> UNMODIFIABLE_WRAPPER = new Tables.1();
  ...
  static class TransformedTable<R, C, V1, V2>
    extends AbstractTable<R, C, V2>
  {
    ...
    {
      Tables.TransformedTable.3 local3 = new Tables.TransformedTable.3(this);
    ...
    {
      Tables.TransformedTable.2 local2 = new Tables.TransformedTable.2(this);
  ...
  static class TransposeTable<C, R, V>
    extends AbstractTable<C, R, V>
  {
    private static final Function<Table.Cell<?, ?, ?>, Table.Cell<?, ?, ?>> TRANSPOSE_CELL = new Tables.TransposeTable.1();
  ...
  static class UnmodifiableTable<R, C, V>
