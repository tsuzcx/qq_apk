...
public final class Collections2
{
  ...
  static String toStringImpl(Collection<?> paramCollection)
  {
    ...
    STANDARD_JOINER.appendTo(localStringBuilder, Iterables.transform(paramCollection, new Collections2.1(paramCollection)));
    return ']';
  }
  ...
  static final class OrderedPermutationCollection<E>
    extends AbstractCollection<List<E>>
  {
    ...
    public boolean contains(@Nullable Object paramObject)
    {
      if ((paramObject instanceof List))
      {
        ...
        return Collections2.isPermutation(this.inputList, paramObject);
      }
      return false;
    }
  ...
  static final class OrderedPermutationIterator<E>
  ...
  static final class PermutationCollection<E>
    extends AbstractCollection<List<E>>
  {
    final ImmutableList<E> inputList;
  ...
  static class PermutationIterator<E>
    extends AbstractIterator<List<E>>
  {
    final int[] c;
    int j;
    ...
    void calculateNextPermutation()
    {
      ...
      label85:
      Collections.swap(this.list, this.j - this.c[this.j] + i, i + (this.j - k));
      this.c[this.j] = k;
    }
