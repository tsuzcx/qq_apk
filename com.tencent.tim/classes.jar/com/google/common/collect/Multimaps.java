...
public final class Multimaps
{
    ...
    extends Maps.ViewCachingAbstractMap<K, Collection<V>>
  {
      ...
      extends Maps.EntrySet<K, Collection<V>>
    {
      ...
      {
        return Maps.asMapEntryIterator(Multimaps.AsMap.this.multimap.keySet(), new Multimaps.AsMap.EntrySet.1(this));
      }
      ...
      public boolean remove(Object paramObject)
      {
        ...
        Multimaps.AsMap.this.removeValuesForKey(paramObject.getKey());
        return true;
      }
    }
  }
  
  static class CustomListMultimap<K, V>
  ...
  static class CustomMultimap<K, V>
  ...
  static class CustomSetMultimap<K, V>
  ...
  static class CustomSortedSetMultimap<K, V>
    ...
    extends AbstractCollection<Map.Entry<K, V>>
  {
    ...
    public boolean contains(@Nullable Object paramObject)
    {
      ...
      {
        paramObject = (Map.Entry)paramObject;
        return multimap().containsEntry(paramObject.getKey(), paramObject.getValue());
      }
      return false;
    }
    ...
    public boolean remove(@Nullable Object paramObject)
    {
      ...
      {
        paramObject = (Map.Entry)paramObject;
        return multimap().remove(paramObject.getKey(), paramObject.getValue());
      }
      return false;
    }
      ...
      extends Multisets.EntrySet<K>
    {
      ...
      public boolean contains(@Nullable Object paramObject)
      {
        if ((paramObject instanceof Multiset.Entry))
        {
          ...
          Collection localCollection = (Collection)Multimaps.Keys.this.multimap.asMap().get(paramObject.getElement());
          return (localCollection != null) && (localCollection.size() == paramObject.getCount());
        }
        return false;
      }
    ...
    implements SetMultimap<K, V>, Serializable
  {
    ...
    {
      return new Multimaps.MapMultimap.1(this, paramK);
    }
  ...
  static final class TransformedEntriesListMultimap<K, V1, V2>
  ...
  static class TransformedEntriesMultimap<K, V1, V2>
  ...
  static class UnmodifiableListMultimap<K, V>
    ...
    implements Serializable
  {
    ...
    public Map<K, Collection<V>> asMap()
    {
      ...
      if (localMap2 == null)
      {
        localMap1 = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new Multimaps.UnmodifiableMultimap.1(this)));
        this.map = localMap1;
      }
      return localMap1;
    }
  ...
  static class UnmodifiableSetMultimap<K, V>
    extends Multimaps.UnmodifiableMultimap<K, V>
  ...
  static class UnmodifiableSortedSetMultimap<K, V>
