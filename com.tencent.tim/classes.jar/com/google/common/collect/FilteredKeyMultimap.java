    ...
    extends ForwardingCollection<Map.Entry<K, V>>
  {
    ...
    public boolean remove(@Nullable Object paramObject)
    {
      if ((paramObject instanceof Map.Entry))
      {
        ...
        if ((FilteredKeyMultimap.this.unfiltered.containsKey(paramObject.getKey())) && (FilteredKeyMultimap.this.keyPredicate.apply(paramObject.getKey()))) {
          return FilteredKeyMultimap.this.unfiltered.remove(paramObject.getKey(), paramObject.getValue());
        }
      }
      return false;
    }
