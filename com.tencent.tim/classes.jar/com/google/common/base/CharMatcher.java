  ...
  implements Predicate<Character>
{
  ...
  public String collapseFrom(CharSequence paramCharSequence, char paramChar)
  {
    ...
    while (i < k)
    {
      ...
      return finishCollapseFrom(paramCharSequence, i + 1, k, paramChar, new StringBuilder(k).append(paramCharSequence, 0, i).append(paramChar), true);
    }
  ...
  CharMatcher precomputedInternal()
  {
    ...
    for (String str1 = str2.substring(0, str2.length() - ".negate()".length());; str1 = str2 + ".negate()") {
      return new CharMatcher.1(this, precomputedPositive(65536 - i, localBitSet, str1), str2);
    }
  }
  ...
  public String replaceFrom(CharSequence paramCharSequence1, CharSequence paramCharSequence2)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder(n * 3 / 2 + 16);
    int k;
    int m;
    do
    {
      localStringBuilder.append(paramCharSequence1, j, i);
      localStringBuilder.append(paramCharSequence2);
      k = i + 1;
      m = indexIn(paramCharSequence1, k);
      j = k;
      i = m;
    } while (m != -1);
    localStringBuilder.append(paramCharSequence1, k, n);
  ...
  @GwtIncompatible
  static final class BitSetMatcher
    extends CharMatcher.NamedFastMatcher
  {
  ...
  static final class BreakingWhitespace
    extends CharMatcher
  {
  ...
  static final class ForPredicate
    extends CharMatcher
  {
  ...
  static final class SingleWidth
    extends CharMatcher.RangesMatcher
  {
    ...
    private SingleWidth()
    {
      super("".toCharArray(), "ӹ־ת״ۿݿ๿₯℺﷿﻿ￜ".toCharArray());
    }
  }
