...
public class DexClassLoaderUtil
{
  ...
  public static dalvik.system.DexClassLoader createDexClassLoader(String paramString1, String paramString2, String paramString3, java.lang.ClassLoader paramClassLoader)
  {
    ...
    //   204: aconst_null
    //   205: astore_1
    //   206: new 107	java/io/BufferedReader
    //   209: dup
    //   210: new 109	java/io/FileReader
    //   213: dup
    //   214: aload 12
    //   216: invokespecial 112	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   219: invokespecial 115	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   222: astore 8
    //   224: aload 8
    //   226: astore 6
    //   228: aload 8
    //   230: invokevirtual 118	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   233: astore_1
    //   234: aload 7
    //   236: astore 6
    //   238: aload_1
    ...
    //   244: astore 6
    //   246: aload 8
    //   248: invokevirtual 118	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   251: astore 7
    //   253: aload 7
    //   255: astore 6
    //   257: aload 8
    //   259: invokestatic 120	com/tencent/commonsdk/classload/DexClassLoaderUtil:close	(Ljava/io/Closeable;)V
    //   262: aload 13
    //   264: invokevirtual 124	java/io/File:listFiles	()[Ljava/io/File;
    //   267: astore 8
    //   269: aload 8
    //   271: ifnull +392 -> 663
    //   274: aload 8
    ...
    //   294: astore 7
    //   296: aload 7
    //   298: invokevirtual 127	java/io/File:getName	()Ljava/lang/String;
    //   301: ldc 14
    //   303: invokevirtual 131	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   306: ifeq +69 -> 375
    //   309: iload 4
    //   311: iconst_1
    //   312: iadd
    ...
    //   328: goto -264 -> 64
    //   331: aload_0
    //   332: invokevirtual 135	java/lang/String:length	()I
    //   335: istore 5
    //   337: goto -260 -> 77
    //   340: astore 7
    //   342: aconst_null
    ...
    //   349: astore 6
    //   351: aload 7
    //   353: invokevirtual 44	java/lang/Exception:printStackTrace	()V
    //   356: aload 8
    //   358: invokestatic 120	com/tencent/commonsdk/classload/DexClassLoaderUtil:close	(Ljava/io/Closeable;)V
    //   361: aload 9
    //   363: astore 6
    //   365: goto -103 -> 262
    //   368: astore_0
    //   369: aload_1
    //   370: invokestatic 120	com/tencent/commonsdk/classload/DexClassLoaderUtil:close	(Ljava/io/Closeable;)V
    //   373: aload_0
    //   374: athrow
    //   375: new 69	java/lang/StringBuilder
    //   378: dup
    //   379: invokespecial 70	java/lang/StringBuilder:<init>	()V
    //   382: aload 7
    //   384: invokevirtual 127	java/io/File:getName	()Ljava/lang/String;
    //   387: invokevirtual 74	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   390: aload 7
    //   392: invokevirtual 138	java/io/File:length	()J
    //   395: invokevirtual 141	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   398: aload 7
    //   400: invokevirtual 144	java/io/File:lastModified	()J
    //   403: invokevirtual 141	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   406: invokevirtual 83	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   409: invokestatic 148	com/tencent/commonsdk/classload/DexClassLoaderUtil:getBase64String	(Ljava/lang/String;)Ljava/lang/String;
    //   412: invokestatic 153	com/tencent/commonsdk/util/MD5Coding:encodeHexStr	(Ljava/lang/String;)Ljava/lang/String;
    //   415: astore 8
    //   417: aload_1
    //   418: ifnull +22 -> 440
    //   421: aload_1
    //   422: aload 8
    //   424: invokevirtual 156	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   427: ifeq +13 -> 440
    //   430: aload 6
    ...
    //   437: ifnull +226 -> 663
    //   440: aload 7
    //   442: invokevirtual 93	java/io/File:delete	()Z
    //   445: pop
    //   446: aload 12
    //   448: invokevirtual 93	java/io/File:delete	()Z
    //   451: pop
    //   452: aconst_null
    //   453: astore 6
    //   455: aconst_null
    //   456: astore_1
    //   457: new 158	dalvik/system/DexClassLoader
    //   460: dup
    //   461: aload_0
    //   462: aload 14
    //   464: aload_2
    //   465: aload_3
    //   466: invokespecial 161	dalvik/system/DexClassLoader:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/ClassLoader;)V
    //   469: astore_0
    //   470: aload 13
    //   472: invokevirtual 124	java/io/File:listFiles	()[Ljava/io/File;
    //   475: astore_3
    //   476: aload_3
    //   477: ifnull +165 -> 642
    //   480: aload_3
    ...
    //   498: astore_2
    //   499: aload_2
    //   500: invokevirtual 127	java/io/File:getName	()Ljava/lang/String;
    //   503: ldc 14
    //   505: invokevirtual 131	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   508: ifeq +12 -> 520
    //   511: iload 4
    //   513: iconst_1
    //   514: iadd
    //   515: istore 4
    //   517: goto -30 -> 487
    //   520: new 69	java/lang/StringBuilder
    //   523: dup
    //   524: invokespecial 70	java/lang/StringBuilder:<init>	()V
    //   527: aload_2
    //   528: invokevirtual 127	java/io/File:getName	()Ljava/lang/String;
    //   531: invokevirtual 74	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   534: aload_2
    //   535: invokevirtual 138	java/io/File:length	()J
    //   538: invokevirtual 141	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   541: aload_2
    //   542: invokevirtual 144	java/io/File:lastModified	()J
    //   545: invokevirtual 141	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   548: invokevirtual 83	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   551: invokestatic 148	com/tencent/commonsdk/classload/DexClassLoaderUtil:getBase64String	(Ljava/lang/String;)Ljava/lang/String;
    //   554: invokestatic 153	com/tencent/commonsdk/util/MD5Coding:encodeHexStr	(Ljava/lang/String;)Ljava/lang/String;
    //   557: astore_3
    //   558: new 76	java/io/File
    //   561: dup
    //   562: aload 13
    ...
    //   571: ldc 163
    //   573: invokevirtual 74	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   576: aload 11
    ...
    //   589: invokespecial 102	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   592: astore 7
    //   594: aload_1
    //   595: ifnull +11 -> 606
    //   598: aload_1
    //   599: aload_3
    //   600: invokevirtual 167	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   603: ifne +13 -> 616
    //   606: aload 12
    //   608: aload 7
    //   610: aload_3
    //   611: aload 6
    //   613: invokestatic 33	com/tencent/commonsdk/classload/DexClassLoaderUtil:saveInfo	(Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    //   616: aload 10
    //   618: ifnull +24 -> 642
    //   621: aload 10
    //   623: new 6	com/tencent/commonsdk/classload/DexClassLoaderUtil$CheckMD5Task
    //   626: dup
    //   627: aload_2
    //   628: aload_3
    //   629: aload 6
    //   631: aload 12
    //   633: aload 7
    //   635: invokespecial 170	com/tencent/commonsdk/classload/DexClassLoaderUtil$CheckMD5Task:<init>	(Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Ljava/io/File;Ljava/io/File;)V
    //   638: invokevirtual 174	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   641: pop
    //   642: aload_0
    //   643: areturn
    //   644: astore_0
    ...
    //   182	450	12	localFile2	File
    //   123	440	13	localFile3	File
  ...
  {
    // Byte code:
    //   0: new 198	java/io/BufferedWriter
    //   3: dup
    //   4: new 200	java/io/FileWriter
    //   7: dup
    //   8: aload_1
    //   9: invokespecial 201	java/io/FileWriter:<init>	(Ljava/io/File;)V
    //   12: invokespecial 204	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   15: astore 5
    //   17: aload 5
    //   19: astore 4
    //   21: aload 5
    //   23: aload_2
    //   24: invokevirtual 207	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   27: aload 5
    //   29: astore 4
    //   31: aload 5
    //   33: invokevirtual 210	java/io/BufferedWriter:newLine	()V
    //   36: aload_3
    //   37: ifnull +13 -> 50
    //   40: aload 5
    //   42: astore 4
    ...
    //   50: aload 5
    //   52: invokestatic 120	com/tencent/commonsdk/classload/DexClassLoaderUtil:close	(Ljava/io/Closeable;)V
    //   55: aload_0
    //   56: invokevirtual 96	java/io/File:exists	()Z
    //   59: ifeq +8 -> 67
    //   62: aload_0
    //   63: invokevirtual 93	java/io/File:delete	()Z
    //   66: pop
    //   67: aload_1
    //   68: aload_0
    //   69: invokevirtual 214	java/io/File:renameTo	(Ljava/io/File;)Z
    //   72: pop
    //   73: return
    //   74: astore_3
    //   75: aconst_null
    ...
    //   78: astore 4
    //   80: aload_3
    //   81: invokevirtual 44	java/lang/Exception:printStackTrace	()V
    //   84: aload_2
    //   85: invokestatic 120	com/tencent/commonsdk/classload/DexClassLoaderUtil:close	(Ljava/io/Closeable;)V
    //   88: goto -33 -> 55
    //   91: astore_0
    //   92: aconst_null
    //   93: astore 4
    //   95: aload 4
    //   97: invokestatic 120	com/tencent/commonsdk/classload/DexClassLoaderUtil:close	(Ljava/io/Closeable;)V
    //   100: aload_0
    //   101: athrow
    //   102: astore_0
    //   103: goto -8 -> 95
