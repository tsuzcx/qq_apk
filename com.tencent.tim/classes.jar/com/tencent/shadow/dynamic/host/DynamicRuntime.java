...
public class DynamicRuntime
{
  ...
  public static boolean loadRuntime(InstalledApk paramInstalledApk)
  {
    // Byte code:
    //   0: ldc 2
    //   2: invokevirtual 28	java/lang/Class:getClassLoader	()Ljava/lang/ClassLoader;
    //   5: astore_2
    //   6: ldc 2
    //   8: invokevirtual 28	java/lang/Class:getClassLoader	()Ljava/lang/ClassLoader;
    //   11: invokevirtual 33	java/lang/ClassLoader:getParent	()Ljava/lang/ClassLoader;
    //   14: astore_1
    //   15: aload_1
    //   16: ifnull +113 -> 129
    //   19: aload_1
    ...
    //   23: ifeq +98 -> 121
    //   26: aload_1
    //   27: checkcast 35	com/tencent/shadow/proguard/g
    //   30: astore_1
    //   31: aload_1
    //   32: ifnull +126 -> 158
    //   35: aload_1
    //   36: invokestatic 124	com/tencent/shadow/proguard/g:a	(Lcom/tencent/shadow/proguard/g;)Ljava/lang/String;
    //   39: astore_1
    ...
    //   57: dup
    //   58: ldc 131
    //   60: invokespecial 70	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   63: aload_1
    ...
    //   72: aload_0
    //   73: getfield 52	com/tencent/shadow/core/common/InstalledApk:apkFilePath	Ljava/lang/String;
    ...
    //   87: aload_1
    //   88: aload_0
    //   89: getfield 52	com/tencent/shadow/core/common/InstalledApk:apkFilePath	Ljava/lang/String;
    //   92: invokestatic 145	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   95: ifeq +39 -> 134
    ...
    //   112: ldc 147
    //   114: invokeinterface 139 2 0
    //   119: iconst_0
    //   120: ireturn
    //   121: aload_1
    //   122: invokevirtual 33	java/lang/ClassLoader:getParent	()Ljava/lang/ClassLoader;
    //   125: astore_1
    //   126: goto -111 -> 15
    //   129: aconst_null
    //   130: astore_1
    ...
    //   137: invokeinterface 129 1 0
    //   142: ifeq +13 -> 155
    //   145: getstatic 16	com/tencent/shadow/dynamic/host/DynamicRuntime:a	Lcom/tencent/shadow/core/common/Logger;
    //   148: ldc 149
    //   150: invokeinterface 139 2 0
    //   155: invokestatic 151	com/tencent/shadow/dynamic/host/DynamicRuntime:a	()V
    //   158: aload_0
    //   159: aload_2
    //   160: invokestatic 153	com/tencent/shadow/dynamic/host/DynamicRuntime:a	(Lcom/tencent/shadow/core/common/InstalledApk;Ljava/lang/ClassLoader;)V
    //   163: iconst_1
    //   164: ireturn
    //   165: astore_0
    //   166: new 92	java/lang/RuntimeException
    //   169: dup
    //   170: aload_0
    //   171: invokespecial 156	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
    //   174: athrow
    //   175: astore_0
    //   176: new 92	java/lang/RuntimeException
    //   179: dup
    //   180: aload_0
    //   181: invokespecial 156	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
    //   184: athrow
