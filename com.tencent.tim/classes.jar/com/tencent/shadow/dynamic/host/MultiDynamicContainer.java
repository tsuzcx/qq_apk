...
public class MultiDynamicContainer
{
  ...
  public static boolean loadContainerApk(java.lang.String paramString, com.tencent.shadow.core.common.InstalledApk paramInstalledApk)
  {
    // Byte code:
    //   0: ldc 2
    //   2: invokevirtual 29	java/lang/Class:getClassLoader	()Ljava/lang/ClassLoader;
    //   5: invokevirtual 34	java/lang/ClassLoader:getParent	()Ljava/lang/ClassLoader;
    //   8: astore_2
    //   9: aload_2
    //   10: ifnull +135 -> 145
    //   13: aload_2
    ...
    //   17: ifeq +120 -> 137
    //   20: aload_2
    //   21: checkcast 36	com/tencent/shadow/proguard/l
    //   24: astore_3
    //   25: aload_3
    //   26: invokestatic 49	com/tencent/shadow/proguard/l:b	(Lcom/tencent/shadow/proguard/l;)Ljava/lang/String;
    //   29: aload_0
    //   30: invokestatic 55	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   33: ifeq +104 -> 137
    //   36: aload_3
    //   37: astore_2
    //   38: aload_2
    //   39: ifnull +136 -> 175
    //   42: aload_2
    //   43: invokestatic 57	com/tencent/shadow/proguard/l:a	(Lcom/tencent/shadow/proguard/l;)Ljava/lang/String;
    //   46: astore_3
    ...
    //   88: aload_1
    //   89: getfield 84	com/tencent/shadow/core/common/InstalledApk:apkFilePath	Ljava/lang/String;
    ...
    //   98: invokeinterface 91 2 0
    //   103: aload_3
    //   104: aload_1
    //   105: getfield 84	com/tencent/shadow/core/common/InstalledApk:apkFilePath	Ljava/lang/String;
    //   108: invokestatic 55	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   111: ifeq +39 -> 150
    ...
    //   128: ldc 93
    //   130: invokeinterface 91 2 0
    //   135: iconst_0
    //   136: ireturn
    //   137: aload_2
    //   138: invokevirtual 34	java/lang/ClassLoader:getParent	()Ljava/lang/ClassLoader;
    //   141: astore_2
    //   142: goto -133 -> 9
    //   145: aconst_null
    //   146: astore_2
    ...
    //   153: invokeinterface 63 1 0
    //   158: ifeq +13 -> 171
    //   161: getstatic 16	com/tencent/shadow/dynamic/host/MultiDynamicContainer:a	Lcom/tencent/shadow/core/common/Logger;
    //   164: ldc 95
    //   166: invokeinterface 91 2 0
    //   171: aload_2
    //   172: invokestatic 97	com/tencent/shadow/dynamic/host/MultiDynamicContainer:a	(Lcom/tencent/shadow/proguard/l;)V
    //   175: ldc 2
    //   177: invokevirtual 29	java/lang/Class:getClassLoader	()Ljava/lang/ClassLoader;
    //   180: astore_2
    //   181: aload_2
    //   182: new 36	com/tencent/shadow/proguard/l
    //   185: dup
    //   186: aload_0
    //   187: aload_1
    //   188: aload_2
    //   189: invokevirtual 34	java/lang/ClassLoader:getParent	()Ljava/lang/ClassLoader;
    //   192: invokespecial 100	com/tencent/shadow/proguard/l:<init>	(Ljava/lang/String;Lcom/tencent/shadow/core/common/InstalledApk;Ljava/lang/ClassLoader;)V
    //   195: invokestatic 42	com/tencent/shadow/dynamic/host/DynamicRuntime:a	(Ljava/lang/ClassLoader;Ljava/lang/ClassLoader;)V
    //   198: getstatic 16	com/tencent/shadow/dynamic/host/MultiDynamicContainer:a	Lcom/tencent/shadow/core/common/Logger;
    //   201: invokeinterface 63 1 0
    //   206: ifeq +39 -> 245
    ...
    //   230: aload_1
    //   231: getfield 84	com/tencent/shadow/core/common/InstalledApk:apkFilePath	Ljava/lang/String;
    ...
    //   251: ldc 106
    //   253: aload_0
    //   254: invokeinterface 110 3 0
    //   259: new 112	java/lang/RuntimeException
    //   262: dup
    //   263: aload_0
    //   264: invokespecial 115	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
    //   267: athrow
    //   268: astore_0
    //   269: new 112	java/lang/RuntimeException
    //   272: dup
    //   273: aload_0
    //   274: invokespecial 115	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
    //   277: athrow
