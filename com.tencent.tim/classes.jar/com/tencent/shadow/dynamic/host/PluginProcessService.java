  ...
  extends c
{
    ...
    throws FailedException
  {
    ...
    //   11: aload_1
    //   12: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   15: invokevirtual 77	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   18: invokestatic 146	android/util/Log:i	(Ljava/lang/String;Ljava/lang/String;)I
    //   21: pop
    //   22: aload_0
    //   23: invokespecial 148	com/tencent/shadow/dynamic/host/PluginProcessService:b	()V
    //   26: aload_0
    //   27: aload_1
    //   28: invokespecial 150	com/tencent/shadow/dynamic/host/PluginProcessService:c	(Ljava/lang/String;)V
    //   31: aload_0
    //   32: getfield 36	com/tencent/shadow/dynamic/host/PluginProcessService:d	Z
    //   35: ifeq +15 -> 50
    //   38: new 42	com/tencent/shadow/dynamic/host/FailedException
    //   41: dup
    //   42: bipush 7
    //   44: ldc 152
    ...
    //   49: athrow
    //   50: aload_0
    //   51: getfield 92	com/tencent/shadow/dynamic/host/PluginProcessService:a	Lcom/tencent/shadow/core/common/Logger;
    //   54: invokeinterface 97 1 0
    //   59: ifeq +28 -> 87
    //   62: aload_0
    //   63: getfield 92	com/tencent/shadow/dynamic/host/PluginProcessService:a	Lcom/tencent/shadow/core/common/Logger;
    ...
    //   87: ldc 138
    //   89: ldc 156
    //   91: invokestatic 146	android/util/Log:i	(Ljava/lang/String;Ljava/lang/String;)I
    //   94: pop
    //   95: aload_0
    //   96: getfield 44	com/tencent/shadow/dynamic/host/PluginProcessService:b	Lcom/tencent/shadow/dynamic/host/UuidManager;
    //   99: aload_1
    //   100: invokeinterface 162 2 0
    //   105: astore_2
    //   106: new 164	com/tencent/shadow/core/common/InstalledApk
    //   109: dup
    //   110: aload_2
    //   111: getfield 167	com/tencent/shadow/core/common/InstalledApk:apkFilePath	Ljava/lang/String;
    //   114: aload_2
    //   115: getfield 170	com/tencent/shadow/core/common/InstalledApk:oDexPath	Ljava/lang/String;
    //   118: aload_2
    //   119: getfield 173	com/tencent/shadow/core/common/InstalledApk:libraryPath	Ljava/lang/String;
    //   122: invokespecial 176	com/tencent/shadow/core/common/InstalledApk:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   125: astore_1
    //   126: aload_1
    //   127: invokestatic 182	com/tencent/shadow/dynamic/host/DynamicRuntime:loadRuntime	(Lcom/tencent/shadow/core/common/InstalledApk;)Z
    //   130: ifeq +8 -> 138
    //   133: aload_0
    //   134: aload_1
    //   135: invokestatic 186	com/tencent/shadow/dynamic/host/DynamicRuntime:saveLastRuntimeInfo	(Landroid/content/Context;Lcom/tencent/shadow/core/common/InstalledApk;)V
    //   138: aload_0
    //   139: iconst_1
    ...
    //   145: ldc 138
    //   147: ldc 188
    //   149: invokestatic 146	android/util/Log:i	(Ljava/lang/String;Ljava/lang/String;)I
    //   152: pop
    //   153: new 42	com/tencent/shadow/dynamic/host/FailedException
    //   156: dup
    //   157: iconst_5
    //   158: aload_1
    //   159: invokevirtual 191	android/os/RemoteException:getMessage	()Ljava/lang/String;
    //   162: invokespecial 49	com/tencent/shadow/dynamic/host/FailedException:<init>	(ILjava/lang/String;)V
    //   165: athrow
    //   166: astore_1
    //   167: aload_0
    //   168: getfield 92	com/tencent/shadow/dynamic/host/PluginProcessService:a	Lcom/tencent/shadow/core/common/Logger;
    //   171: invokeinterface 194 1 0
    //   176: ifeq +15 -> 191
    //   179: aload_0
    //   180: getfield 92	com/tencent/shadow/dynamic/host/PluginProcessService:a	Lcom/tencent/shadow/core/common/Logger;
    //   183: ldc 196
    //   185: aload_1
    //   186: invokeinterface 200 3 0
    //   191: new 42	com/tencent/shadow/dynamic/host/FailedException
    //   194: dup
    //   195: aload_1
    //   196: invokespecial 203	com/tencent/shadow/dynamic/host/FailedException:<init>	(Ljava/lang/RuntimeException;)V
    //   199: athrow
    //   200: astore_2
    //   201: ldc 138
    //   203: ldc 205
    //   205: invokestatic 146	android/util/Log:i	(Ljava/lang/String;Ljava/lang/String;)I
    //   208: pop
    //   209: new 42	com/tencent/shadow/dynamic/host/FailedException
    //   212: dup
    //   213: iconst_3
    //   214: new 63	java/lang/StringBuilder
    //   217: dup
    //   218: ldc 207
    //   220: invokespecial 67	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   223: aload_1
    ...
    //   232: aload_2
    //   233: invokevirtual 210	com/tencent/shadow/dynamic/host/NotFoundException:getMessage	()Ljava/lang/String;
    //   236: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
