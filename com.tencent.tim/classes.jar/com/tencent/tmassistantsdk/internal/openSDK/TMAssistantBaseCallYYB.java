...
public abstract class TMAssistantBaseCallYYB
{
  ...
  public long addDownloadTaskFromTmast(Bundle paramBundle)
  {
    ...
    ab.c("TMAssistantBaseCallYYB", "addDownloadTaskFromTmast url = " + str);
    ...
    ab.c("TMAssistantBaseCallYYB", "addDownloadTaskFromTmast,hostPackageName=" + this.hostPackageName + "; hostVersionCode=" + this.hostVersionCode + "; hostUserIdentity=" + "" + "; dataItemType=" + 0 + ";dataItemAction=" + str);
    l1 = this.sdkChannel.a(this.hostPackageName, this.hostVersionCode, "", 0, str, l2, l1, 0, null);
    ab.c("TMAssistantBaseCallYYB", "result = " + l1);
    return l1;
  }
  ...
  public long buildAddDBData(TMAssistantCallYYBParamStruct paramTMAssistantCallYYBParamStruct, boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      ab.c("TMAssistantBaseCallYYB", "addDownloadTaskFromTaskList,hostPackageName=" + this.hostPackageName + "; hostVersionCode=" + this.hostVersionCode + "; hostUserIdentity=" + "" + "; dataItemType=" + 0 + ";dataItemAction=" + paramTMAssistantCallYYBParamStruct);
