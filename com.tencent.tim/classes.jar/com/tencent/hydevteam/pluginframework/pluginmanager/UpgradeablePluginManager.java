  ...
  implements PluginManager
{
  ...
  public final List<InstalledPlugin> getCachedLatestPlugin(String paramString)
  {
    ...
    //   8: istore_2
    //   9: aload_0
    //   10: getfield 150	com/tencent/hydevteam/pluginframework/pluginmanager/UpgradeablePluginManager:c	Lcom/tencent/hydevteam/pluginframework/pluginmanager/PluginManager;
    //   13: astore 4
    //   15: aload 4
    //   17: ifnonnull +9 -> 26
    //   20: iconst_1
    //   21: istore_2
    //   22: aload_0
    //   23: invokevirtual 156	com/tencent/hydevteam/pluginframework/pluginmanager/UpgradeablePluginManager:initWithoutUpgrade	()V
    //   26: aload_0
    //   27: getfield 150	com/tencent/hydevteam/pluginframework/pluginmanager/UpgradeablePluginManager:c	Lcom/tencent/hydevteam/pluginframework/pluginmanager/PluginManager;
    //   30: aload_1
    //   31: invokeinterface 158 2 0
    //   36: astore_1
    //   37: iload_2
    //   38: ifeq +8 -> 46
    //   41: aload_0
    //   42: aconst_null
    //   43: putfield 150	com/tencent/hydevteam/pluginframework/pluginmanager/UpgradeablePluginManager:c	Lcom/tencent/hydevteam/pluginframework/pluginmanager/PluginManager;
    //   46: aload_3
    //   47: monitorexit
    //   48: aload_1
    //   49: areturn
    ...
    throws Exception
  {
    ...
    //   24: astore 8
    //   26: aload 8
    //   28: invokevirtual 107	java/io/File:exists	()Z
    //   31: istore 7
    //   33: iload 7
    //   35: ifeq +54 -> 89
    ...
    //   52: aload 10
    //   54: aload 8
    //   56: invokevirtual 101	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   76: aload_3
    //   77: iload 4
    //   79: invokespecial 172	com/tencent/hydevteam/pluginframework/pluginmanager/UpgradeablePluginManager:a	(Ljava/io/File;Ljava/io/File;I)Ljava/lang/String;
    ...
    //   93: invokevirtual 193	java/io/File:lastModified	()J
    //   96: lstore 5
    //   98: lload 5
    //   100: lconst_0
    //   101: lcmp
    ...
    //   156: invokevirtual 176	java/io/File:getParentFile	()Ljava/io/File;
    //   159: ldc 201
    //   161: invokespecial 85	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   164: astore 12
    //   166: new 203	com/tencent/hydevteam/pluginframework/pluginmanager/LengthHashURLConnectionDownloader
    //   169: dup
    //   170: invokespecial 204	com/tencent/hydevteam/pluginframework/pluginmanager/LengthHashURLConnectionDownloader:<init>	()V
    //   173: new 206	com/tencent/hydevteam/pluginframework/pluginmanager/TargetDownloadInfo
    //   176: dup
    //   177: aload 8
    //   179: ldc 208
    //   181: lconst_0
    //   182: invokespecial 211	com/tencent/hydevteam/pluginframework/pluginmanager/TargetDownloadInfo:<init>	(Ljava/lang/String;Ljava/lang/String;J)V
    //   185: aload 11
    //   187: aload 12
    //   189: invokeinterface 215 4 0
    //   194: astore 8
    //   196: aload 10
    //   198: ldc 217
    //   200: invokevirtual 49	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   203: lload 5
    //   205: invokevirtual 220	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   208: ldc 222
    ...
    //   244: dup
    //   245: aload 8
    //   247: invokevirtual 176	java/io/File:getParentFile	()Ljava/io/File;
    //   250: ldc 170
    ...
    //   263: aload 10
    //   265: aload 9
    //   267: invokevirtual 233	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   270: ldc 103
    ...
    //   308: aload 10
    //   310: aload 8
    //   312: invokevirtual 233	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   315: ldc 103
    ...
    //   303	8	8	localException1	Exception
    //   325	59	8	localObject2	Object
    //   390	1	8	localException2	Exception
    //   10	1	9	localObject3	Object
    //   259	47	9	localException3	Exception
    //   333	1	9	localException4	Exception
    //   346	1	9	localException5	Exception
    //   356	1	9	localException6	Exception
    //   364	1	9	localException7	Exception
    //   377	1	9	localException8	Exception
