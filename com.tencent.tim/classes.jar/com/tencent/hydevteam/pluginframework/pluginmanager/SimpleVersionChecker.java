  ...
  implements VersionChecker
{
    ...
    throws VersionCheckException
  {
    ...
    //   40: new 141	com/tencent/commonsdk/zip/QZipInputStream
    //   43: dup
    ...
    //   56: invokespecial 151	com/tencent/commonsdk/zip/QZipInputStream:<init>	(Ljava/io/InputStream;)V
    //   59: astore 6
    //   61: aload 6
    //   63: invokevirtual 155	com/tencent/commonsdk/zip/QZipInputStream:getNextEntry	()Ljava/util/zip/ZipEntry;
    //   66: astore_0
    //   67: aload_0
    //   68: ifnull +313 -> 381
    //   71: aload_0
    //   72: invokevirtual 160	java/util/zip/ZipEntry:getName	()Ljava/lang/String;
    //   75: new 105	java/lang/StringBuilder
    //   78: dup
    //   79: invokespecial 161	java/lang/StringBuilder:<init>	()V
    //   82: aload_1
    ...
    //   104: new 21	com/tencent/hydevteam/pluginframework/pluginmanager/VersionCheckException
    //   107: dup
    ...
    //   133: astore_0
    //   134: aload 6
    //   136: invokevirtual 168	com/tencent/commonsdk/zip/QZipInputStream:close	()V
    //   139: aload_0
    //   140: athrow
    //   141: astore_0
    //   142: new 21	com/tencent/hydevteam/pluginframework/pluginmanager/VersionCheckException
    //   145: dup
    //   146: ldc 170
    //   148: aload_0
    ...
    //   153: astore_0
    //   154: aload 5
    //   156: invokevirtual 173	java/net/HttpURLConnection:disconnect	()V
    //   159: aload_0
    //   160: athrow
    //   161: astore_0
    //   162: new 21	com/tencent/hydevteam/pluginframework/pluginmanager/VersionCheckException
    //   165: dup
    //   166: ldc 175
    //   168: aload_0
    ...
    //   184: athrow
    //   185: aload_0
    //   186: invokevirtual 181	java/util/zip/ZipEntry:getSize	()J
    //   189: lstore_3
    //   190: lload_3
    //   191: ldc2_w 182
    //   194: lcmp
    //   195: ifle +30 -> 225
    //   198: new 21	com/tencent/hydevteam/pluginframework/pluginmanager/VersionCheckException
    //   201: dup
    //   202: new 105	java/lang/StringBuilder
    //   205: dup
    //   206: invokespecial 161	java/lang/StringBuilder:<init>	()V
    //   209: aload_0
    //   210: invokevirtual 186	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   213: ldc 188
    ...
    //   229: lcmp
    //   230: ifeq +78 -> 308
    //   233: new 192	java/io/ByteArrayOutputStream
    //   236: dup
    //   237: lload_3
    //   238: l2i
    //   239: invokespecial 195	java/io/ByteArrayOutputStream:<init>	(I)V
    //   242: astore_0
    //   243: aload 6
    //   245: invokevirtual 198	com/tencent/commonsdk/zip/QZipInputStream:read	()I
    //   248: istore_2
    //   249: iload_2
    //   250: iconst_m1
    ...
    //   254: aload_0
    //   255: iload_2
    //   256: invokevirtual 201	java/io/ByteArrayOutputStream:write	(I)V
    //   259: aload 6
    //   261: invokevirtual 198	com/tencent/commonsdk/zip/QZipInputStream:read	()I
    //   264: istore_2
    //   265: goto -16 -> 249
    //   268: aload 6
    //   270: invokevirtual 204	com/tencent/commonsdk/zip/QZipInputStream:closeEntry	()V
    //   273: new 29	org/json/JSONObject
    //   276: dup
    //   277: aload_0
    //   278: invokevirtual 205	java/io/ByteArrayOutputStream:toString	()Ljava/lang/String;
    //   281: invokespecial 206	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   284: astore_1
    //   285: aload_0
    //   286: invokevirtual 207	java/io/ByteArrayOutputStream:close	()V
    //   289: aload 6
    //   291: invokevirtual 168	com/tencent/commonsdk/zip/QZipInputStream:close	()V
    //   294: aload 5
    //   296: invokevirtual 173	java/net/HttpURLConnection:disconnect	()V
    //   299: aload_1
    //   300: areturn
    //   301: astore_1
    //   302: aload_0
    //   303: invokevirtual 207	java/io/ByteArrayOutputStream:close	()V
    //   306: aload_1
    //   307: athrow
    //   308: new 21	com/tencent/hydevteam/pluginframework/pluginmanager/VersionCheckException
    //   311: dup
    //   312: new 105	java/lang/StringBuilder
    //   315: dup
    //   316: invokespecial 161	java/lang/StringBuilder:<init>	()V
    //   319: aload_0
    //   320: invokevirtual 186	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   323: ldc 209
    ...
    //   334: athrow
    //   335: new 21	com/tencent/hydevteam/pluginframework/pluginmanager/VersionCheckException
    //   338: dup
    ...
    //   358: athrow
    //   359: astore_0
    //   360: new 21	com/tencent/hydevteam/pluginframework/pluginmanager/VersionCheckException
    //   363: dup
    //   364: ldc 213
    //   366: aload_0
    ...
    //   370: athrow
    //   371: new 21	com/tencent/hydevteam/pluginframework/pluginmanager/VersionCheckException
    //   374: dup
    //   375: ldc 215
