...
public class ArkAppCGIMgr
{
  ...
  private static String getAppUpdateReqString(ArrayList<AppNameVersion> paramArrayList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        AppNameVersion localAppNameVersion = (AppNameVersion)paramArrayList.next();
  ...
  private static PublicKey getArkAppPackagePubliceKey()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 277	com/tencent/ark/open/ArkAppCGIMgr:mAppPackagePubKey	Ljava/security/PublicKey;
    //   6: ifnull +12 -> 18
    //   9: getstatic 277	com/tencent/ark/open/ArkAppCGIMgr:mAppPackagePubKey	Ljava/security/PublicKey;
    //   12: astore_0
    //   13: ldc 2
    //   15: monitorexit
    //   16: aload_0
    //   17: areturn
    //   18: new 279	java/security/spec/X509EncodedKeySpec
    //   21: dup
    //   22: ldc_w 281
    //   25: iconst_0
    //   26: invokestatic 287	android/util/Base64:decode	(Ljava/lang/String;I)[B
    //   29: invokespecial 290	java/security/spec/X509EncodedKeySpec:<init>	([B)V
    //   32: astore_0
    //   33: ldc_w 292
    //   36: invokestatic 297	java/security/KeyFactory:getInstance	(Ljava/lang/String;)Ljava/security/KeyFactory;
    //   39: aload_0
    //   40: invokevirtual 301	java/security/KeyFactory:generatePublic	(Ljava/security/spec/KeySpec;)Ljava/security/PublicKey;
    //   43: putstatic 277	com/tencent/ark/open/ArkAppCGIMgr:mAppPackagePubKey	Ljava/security/PublicKey;
    //   46: getstatic 277	com/tencent/ark/open/ArkAppCGIMgr:mAppPackagePubKey	Ljava/security/PublicKey;
    //   49: astore_0
    //   50: goto -37 -> 13
    //   53: astore_0
    //   54: getstatic 67	com/tencent/ark/open/ArkAppCGIMgr:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   57: ldc 51
    //   59: new 112	java/lang/StringBuilder
    //   62: dup
    //   63: invokespecial 113	java/lang/StringBuilder:<init>	()V
    //   66: ldc_w 303
    //   69: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   72: aload_0
    //   73: invokevirtual 304	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   82: invokevirtual 259	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;Ljava/lang/String;)V
    //   85: goto -39 -> 46
    //   88: astore_0
    //   89: ldc 2
    //   91: monitorexit
  ...
  private boolean mergeRequestByUrl(String paramString, long paramLong, Object paramObject, ArkAppCGICallback paramArkAppCGICallback)
  {
    synchronized (this.mTaskList)
    {
      ...
      {
        QueryTask localQueryTask = (QueryTask)localIterator.next();
  ...
  private void onHttpRequestResult(QueryTask paramQueryTask, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    new Handler(Looper.getMainLooper()).post(new ArkAppCGIMgr.5(this, paramQueryTask, paramBoolean, paramArrayOfByte));
  }
  
  private void parseDictList(JSONArray paramJSONArray, ArrayList<AIWordDictInfo> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        AIWordDictInfo localAIWordDictInfo = new AIWordDictInfo();
  ...
  private void parseReply_AppConfig(byte[] paramArrayOfByte, ArrayList<String> paramArrayList, ArrayList<AIWordDictInfo> paramArrayList1)
  {
  ...
  private QueryAppInfoByAppNameBatchResult parserReply_queryAppInfoByAppNameBatch(String paramString)
  {
    if (ArkEnvironmentManager.getInstance().getDebugFlag()) {
    ...
    QueryAppInfoByAppNameBatchResult localQueryAppInfoByAppNameBatchResult = new QueryAppInfoByAppNameBatchResult();
        ...
        while (i < paramString.length())
        {
          ...
          if (localObject1 != null)
          {
            ...
            else
            {
              ...
              QueryAppInfoResult localQueryAppInfoResult;
              if (j != 0)
              {
                localQueryAppInfoResult = new QueryAppInfoResult();
  ...
  private void runTask(QueryTask paramQueryTask, ITaskHttpResult arg2)
  {
  ...
  public void downloadAppIcon(String paramString, Object paramObject, ArkAppCGICallback paramArkAppCGICallback)
  {
    if ((!TextUtils.isEmpty(paramString)) && (paramArkAppCGICallback != null))
    {
      ...
      QueryTask localQueryTask = new QueryTask(null);
  ...
  public void downloadAppPackage(String paramString, byte[] paramArrayOfByte, Object paramObject, ArkAppCGICallback paramArkAppCGICallback)
  {
    if (mergeRequestByUrl(paramString, -1L, paramObject, paramArkAppCGICallback)) {
      return;
    }
    QueryTask_DownloadAppPackage localQueryTask_DownloadAppPackage = new QueryTask_DownloadAppPackage(null);
  ...
  public void getPredownloadAppList(String paramString, Object paramObject, ArkAppCGICallback paramArkAppCGICallback)
  {
  ...
  protected void onDownloadAppPackage(QueryTask_DownloadAppPackage paramQueryTask_DownloadAppPackage, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    int i;
    label34:
    Object localObject;
    ArkAppCGICallback localArkAppCGICallback;
    if (!paramBoolean)
    {
      ...
      localArkAppCGICallback = (ArkAppCGICallback)paramQueryTask_DownloadAppPackage.callback.get(i);
  ...
  public void queryAppInfoByAppNameBatch(ArrayList<AppNameVersion> paramArrayList, Object paramObject, ArkAppCGICallback paramArkAppCGICallback)
  {
    if ((paramArrayList == null) || (paramArrayList.size() == 0)) {
      return;
    }
  ...
  {
    // Byte code:
    //   0: invokestatic 667	com/tencent/ark/open/ArkAppCGIMgr:getArkAppPackagePubliceKey	()Ljava/security/PublicKey;
    //   3: astore 5
    //   5: aload 5
    //   7: ifnonnull +5 -> 12
    //   10: iconst_1
    ...
    //   17: astore 6
    //   19: ldc_w 669
    //   22: invokestatic 674	java/security/Signature:getInstance	(Ljava/lang/String;)Ljava/security/Signature;
    //   25: astore 7
    //   27: aload 7
    //   29: aload 5
    //   31: invokevirtual 678	java/security/Signature:initVerify	(Ljava/security/PublicKey;)V
    //   34: new 680	java/io/BufferedInputStream
    //   37: dup
    //   38: new 682	java/io/FileInputStream
    //   41: dup
    //   42: aload_1
    //   43: invokespecial 685	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   46: invokespecial 688	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   49: astore 5
    //   51: aload 5
    //   53: astore_1
    //   54: aload 5
    ...
    //   58: iconst_0
    //   59: sipush 1024
    //   62: invokevirtual 692	java/io/BufferedInputStream:read	([BII)I
    //   65: istore_3
    //   66: iconst_m1
    //   67: iload_3
    ...
    //   78: iconst_0
    //   79: iload_3
    //   80: invokevirtual 696	java/security/Signature:update	([BII)V
    //   83: goto -32 -> 51
    //   86: astore_1
    //   87: aload 5
    //   89: astore_2
    ...
    //   93: aload_2
    //   94: astore_1
    //   95: getstatic 67	com/tencent/ark/open/ArkAppCGIMgr:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   98: ldc 51
    //   100: new 112	java/lang/StringBuilder
    //   103: dup
    //   104: invokespecial 113	java/lang/StringBuilder:<init>	()V
    //   107: ldc_w 698
    //   110: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   113: aload 5
    //   115: invokevirtual 304	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   128: invokestatic 160	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   131: invokevirtual 259	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;Ljava/lang/String;)V
    //   134: aload_2
    //   135: ifnull -125 -> 10
    //   138: aload_2
    //   139: invokevirtual 701	java/io/BufferedInputStream:close	()V
    //   142: iconst_1
    //   143: ireturn
    //   144: astore_1
    //   145: getstatic 67	com/tencent/ark/open/ArkAppCGIMgr:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   148: ldc 51
    //   150: new 112	java/lang/StringBuilder
    //   153: dup
    //   154: invokespecial 113	java/lang/StringBuilder:<init>	()V
    //   157: ldc_w 703
    //   160: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   163: aload_1
    //   164: invokevirtual 304	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   177: invokestatic 160	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   180: invokevirtual 259	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;Ljava/lang/String;)V
    //   183: iconst_1
    //   184: ireturn
    //   185: aload 5
    //   187: astore_1
    //   188: aload 7
    //   190: aload_2
    //   191: invokevirtual 707	java/security/Signature:verify	([B)Z
    //   194: istore 4
    //   196: iload 4
    //   198: ifeq +58 -> 256
    //   201: ldc_w 709
    ...
    //   205: aload 5
    //   207: astore_1
    //   208: getstatic 67	com/tencent/ark/open/ArkAppCGIMgr:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   211: ldc 51
    //   213: new 112	java/lang/StringBuilder
    //   216: dup
    //   217: invokespecial 113	java/lang/StringBuilder:<init>	()V
    //   220: ldc_w 711
    ...
    //   237: invokestatic 160	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   240: invokevirtual 259	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;Ljava/lang/String;)V
    //   243: aload 5
    //   245: ifnull +8 -> 253
    //   248: aload 5
    //   250: invokevirtual 701	java/io/BufferedInputStream:close	()V
    //   253: iload 4
    //   255: ireturn
    //   256: ldc_w 713
    //   259: astore_2
    //   260: goto -55 -> 205
    //   263: astore_1
    //   264: getstatic 67	com/tencent/ark/open/ArkAppCGIMgr:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   267: ldc 51
    ...
    //   282: aload_1
    //   283: invokevirtual 304	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   286: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   289: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   292: iconst_0
    //   293: anewarray 4	java/lang/Object
    //   296: invokestatic 160	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   299: invokevirtual 259	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;Ljava/lang/String;)V
    //   302: goto -49 -> 253
    //   305: astore_2
    //   306: aconst_null
    //   307: astore_1
    ...
    //   309: ifnull +7 -> 316
    //   312: aload_1
    //   313: invokevirtual 701	java/io/BufferedInputStream:close	()V
    //   316: aload_2
    //   317: athrow
    //   318: astore_1
    //   319: getstatic 67	com/tencent/ark/open/ArkAppCGIMgr:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   322: ldc 51
    //   324: new 112	java/lang/StringBuilder
    //   327: dup
    //   328: invokespecial 113	java/lang/StringBuilder:<init>	()V
    //   331: ldc_w 703
    //   334: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   337: aload_1
    //   338: invokevirtual 304	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   341: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   344: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   347: iconst_0
    //   348: anewarray 4	java/lang/Object
    //   351: invokestatic 160	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   354: invokevirtual 259	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;Ljava/lang/String;)V
    //   357: goto -41 -> 316
    //   360: astore_2
    //   361: goto -53 -> 308
    //   364: astore 5
  ...
  public static class ArkAppCGICallback
  {
    ...
    public void onGetPredownloadAppList(boolean paramBoolean, ArrayList<String> paramArrayList, ArrayList<ArkAppCGIMgr.AIWordDictInfo> paramArrayList1, Object paramObject) {}
  ...
  static abstract interface ITaskHttpResult
  {
    public abstract void onTaskHttpResult(ArkAppCGIMgr.QueryTask paramQueryTask, boolean paramBoolean, byte[] paramArrayOfByte);
  }
  
  public static class QueryAppInfoByAppNameBatchResult
  {
    public final HashMap<String, ArkAppCGIMgr.QueryAppInfoResult> resultList = new HashMap();
  ...
  static class QueryTask_DownloadAppPackage
    extends ArkAppCGIMgr.QueryTask
  {
    public byte[] appSign;
