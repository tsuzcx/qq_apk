  ...
  implements Handler.Callback
{
  ...
  private void beginCheckNetwork(ICheckNetworkCallback paramICheckNetworkCallback)
  {
    ArkDispatchTask.getInstance().postToArkThread(new ArkAppMgr.11(this, paramICheckNetworkCallback));
  }
  
  private void beginEnumInstalledAppName(IEnumInstalledAppCallback paramIEnumInstalledAppCallback)
  {
    EnumInstalledAppTask localEnumInstalledAppTask = new EnumInstalledAppTask(null);
  ...
  private boolean checkSignAfterAppPathCache(String paramString)
  {
    ...
    do
    {
      synchronized (this.mAppPathCache)
      {
        ...
        {
          if (((AppPathInfo)this.mAppPathCache.get(paramString)).path == null)
          {
        ...
        localObject = new File(((AppPathInfo)this.mAppPathCache.get(paramString)).path);
  ...
  private String copyAppPackageToAppInstallDir(String paramString1, String paramString2, String paramString3, byte[] paramArrayOfByte)
  {
    ...
    //   4: ifnull +32 -> 36
    //   7: aload_1
    //   8: invokevirtual 466	java/lang/String:length	()I
    //   11: ifeq +25 -> 36
    //   14: aload_2
    //   15: ifnull +21 -> 36
    //   18: aload_2
    //   19: invokevirtual 466	java/lang/String:length	()I
    //   22: ifeq +14 -> 36
    //   25: aload 4
    //   27: ifnull +9 -> 36
    //   30: aload 4
    ...
    //   38: aload_1
    //   39: areturn
    //   40: new 364	java/io/File
    //   43: dup
    //   44: aload_1
    //   45: invokestatic 470	com/tencent/ark/open/ArkAppMgr:getAppDirByNameAndVersion	(Ljava/lang/String;)Ljava/lang/String;
    //   48: invokespecial 367	java/io/File:<init>	(Ljava/lang/String;)V
    //   51: astore 6
    //   53: aload 6
    //   55: invokevirtual 370	java/io/File:exists	()Z
    //   58: ifne +79 -> 137
    //   61: aload 6
    //   63: invokevirtual 473	java/io/File:delete	()Z
    //   66: pop
    //   67: aload 6
    //   69: invokevirtual 476	java/io/File:mkdirs	()Z
    //   72: pop
    //   73: aload_1
    //   74: aload_2
    //   75: aload_3
    //   76: invokestatic 480	com/tencent/ark/open/ArkAppMgr:getAppPathByNameAndVersion	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   79: astore_3
    //   80: new 482	java/io/FileOutputStream
    //   83: dup
    //   84: aload_3
    //   85: invokespecial 483	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   88: astore_2
    //   89: aload_2
    //   90: astore_1
    //   91: aload_2
    //   92: aload 4
    //   94: invokevirtual 487	java/io/FileOutputStream:write	([B)V
    //   97: aload_3
    //   98: astore_1
    //   99: aload_2
    //   100: ifnull -62 -> 38
    //   103: aload_2
    //   104: invokevirtual 490	java/io/FileOutputStream:close	()V
    //   107: aload_3
    //   108: areturn
    //   109: astore_1
    //   110: getstatic 132	com/tencent/ark/open/ArkAppMgr:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   113: ldc 92
    //   115: iconst_2
    ...
    //   126: iconst_1
    //   127: aload_1
    //   128: invokevirtual 462	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   131: aastore
    //   132: invokevirtual 448	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   135: aload_3
    //   136: areturn
    //   137: aload 6
    //   139: invokevirtual 373	java/io/File:isFile	()Z
    //   142: ifeq -69 -> 73
    //   145: aload 6
    //   147: invokevirtual 473	java/io/File:delete	()Z
    //   150: pop
    //   151: aload 6
    //   153: invokevirtual 476	java/io/File:mkdirs	()Z
    //   156: pop
    //   157: goto -84 -> 73
    //   160: astore_3
    //   161: aconst_null
    ...
    //   164: astore_1
    //   165: aload_3
    //   166: invokevirtual 457	java/lang/Exception:printStackTrace	()V
    //   169: aload_2
    //   170: astore_1
    //   171: getstatic 132	com/tencent/ark/open/ArkAppMgr:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   174: ldc 92
    //   176: iconst_2
    ...
    //   187: iconst_1
    //   188: aload_3
    //   189: invokevirtual 462	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   192: aastore
    //   193: invokevirtual 448	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   196: aload_2
    //   197: ifnull +7 -> 204
    //   200: aload_2
    //   201: invokevirtual 490	java/io/FileOutputStream:close	()V
    //   204: aconst_null
    //   205: areturn
    //   206: astore_1
    //   207: getstatic 132	com/tencent/ark/open/ArkAppMgr:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   210: ldc 92
    //   212: iconst_2
    ...
    //   223: iconst_1
    //   224: aload_1
    //   225: invokevirtual 462	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   228: aastore
    //   229: invokevirtual 448	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   232: goto -28 -> 204
    //   235: astore_1
    //   236: aload 5
    //   238: astore_2
    ...
    //   240: ifnull +7 -> 247
    //   243: aload_2
    //   244: invokevirtual 490	java/io/FileOutputStream:close	()V
    //   247: aload_1
    //   248: athrow
    //   249: astore_2
    //   250: getstatic 132	com/tencent/ark/open/ArkAppMgr:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   253: ldc 92
    //   255: iconst_2
    ...
    //   266: iconst_1
    //   267: aload_2
    //   268: invokevirtual 462	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   271: aastore
    //   272: invokevirtual 448	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   275: goto -28 -> 247
    //   278: astore_3
    //   279: aload_1
    //   280: astore_2
  ...
  private static void deleteOldAppWhenUpdateSuccess(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    //   30: return
    //   31: aload_0
    //   32: invokestatic 470	com/tencent/ark/open/ArkAppMgr:getAppDirByNameAndVersion	(Ljava/lang/String;)Ljava/lang/String;
    //   35: astore_0
    //   36: aload_0
    //   37: ifnull -10 -> 27
    //   40: aload_0
    ...
    //   44: ifeq -17 -> 27
    //   47: new 364	java/io/File
    //   50: dup
    //   51: aload_0
    //   52: invokespecial 367	java/io/File:<init>	(Ljava/lang/String;)V
    //   55: astore_0
    //   56: aload_0
    //   57: invokevirtual 533	java/io/File:isDirectory	()Z
    //   60: ifeq -33 -> 27
    //   63: aload_0
    //   64: invokevirtual 370	java/io/File:exists	()Z
    //   67: ifeq -40 -> 27
    //   70: aload_0
    //   71: new 546	com/tencent/ark/open/ArkAppMgr$6
    //   74: dup
    //   75: aload_1
    //   76: iload_2
    //   77: invokespecial 548	com/tencent/ark/open/ArkAppMgr$6:<init>	(Ljava/lang/String;Z)V
    //   80: invokevirtual 551	java/io/File:listFiles	(Ljava/io/FileFilter;)[Ljava/io/File;
    //   83: pop
    //   84: goto -57 -> 27
    //   87: astore_0
    //   88: ldc 2
  ...
  private void getAppPathByNameReal(String paramString1, String paramString2, String paramString3, Object paramObject, IGetAppPathByNameCallback paramIGetAppPathByNameCallback, Looper paramLooper)
  {
    Object localObject = getAppPathInfoByNameFromLocal(paramString1, paramString2, paramString3, false);
    if ((localObject != null) && ((paramString3 == null) || (compareVersionString(((AppPathInfo)localObject).desc.version, paramString3) >= 0)))
    {
      ENV.logI("ArkApp.ArkAppMgr", String.format("ArkTemp.getAppPathByName, app found at local, update app, app-name=%s,app-appView=%s, min-ver=%s,info.desc.version=%s,form=%d", new Object[] { paramString1, paramString2, paramString3, ((AppPathInfo)localObject).desc.version, Integer.valueOf(((AppPathInfo)localObject).from) }));
      paramString3 = new GetAppPathByNameTask();
      paramString3.appName = paramString1;
      paramString3.appView = paramString2;
      paramString3.retCode = 0;
      paramString3.appPathInfo = ((AppPathInfo)localObject);
    ...
    localObject = new GetAppPathByNameTask();
    ((GetAppPathByNameTask)localObject).retCode = -1;
    ((GetAppPathByNameTask)localObject).appName = paramString1;
    ((GetAppPathByNameTask)localObject).appView = paramString2;
    ((GetAppPathByNameTask)localObject).minAppVersion = paramString3;
    ((GetAppPathByNameTask)localObject).userdata = paramObject;
    ((GetAppPathByNameTask)localObject).callback = paramIGetAppPathByNameCallback;
    ((GetAppPathByNameTask)localObject).appPathInfo = null;
    ((GetAppPathByNameTask)localObject).handler = new WeakReferenceHandler(paramLooper, this);
  ...
  private AppPathInfo getAppPathInfoByNameFromLocalCache(String arg1, String paramString2, boolean paramBoolean)
  {
    for (;;)
    {
      synchronized (this.mTempAppCache)
      {
        ...
        {
          ??? = (AppPathInfo)this.mDebugAppPathCache.get(localObject3);
          if ((??? == null) || (((AppPathInfo)???).path == null)) {
            break label547;
          }
          ??? = new File(((AppPathInfo)???).path);
      ...
      synchronized (this.mAppPathCache)
      {
        ??? = (AppPathInfo)this.mAppPathCache.get(localObject3);
        ??? = ???;
        if (??? != null)
        {
        ...
        do
        {
          ...
          if ((localObject2 != null) && (localObject2.length >= 2))
          {
            ((AppPathInfo)???).desc.name = ???;
            ((AppPathInfo)???).appTempInfo = new ArkAppInfo.AppTemplateView();
            ((AppPathInfo)???).appTempInfo.view = paramString2;
            ((AppPathInfo)???).appTempInfo.template = localObject2[0];
            ((AppPathInfo)???).appTempInfo.templateView = localObject2[1];
          }
          ((AppPathInfo)???).from = 1;
          return ???;
          ??? = finally;
          ...
          ??? = finally;
          throw ???;
          localFile = new File(((AppPathInfo)???).path);
          if (!localFile.exists()) {
            break;
          }
          ??? = ???;
  ...
  private static AppPathInfo getLocalAppPathByAppName(String paramString1, String paramString2)
  {
    ...
    for (String[] arrayOfString = ArkAppConfigMgr.getAppTemplateAndView(localAppConfig, paramString2);; arrayOfString = null)
    {
      ...
      for (Object localObject1 = arrayOfString[0];; localObject1 = paramString1)
      {
        ...
        {
          localObject1 = new AppPathInfo();
          ((AppPathInfo)localObject1).desc.name = paramString1;
          ((AppPathInfo)localObject1).desc.version = str2;
          ((AppPathInfo)localObject1).path = ((File)localObject3).getAbsolutePath();
        }
        for (;;)
        {
          if ((arrayOfString != null) && (arrayOfString.length > 0))
          {
            ((AppPathInfo)localObject1).appTempInfo = new ArkAppInfo.AppTemplateView();
            ((AppPathInfo)localObject1).appTempInfo.view = paramString2;
            ((AppPathInfo)localObject1).appTempInfo.template = arrayOfString[0];
            ((AppPathInfo)localObject1).appTempInfo.templateView = arrayOfString[1];
          ...
          ArkAppCacheMgr.cacheManifestInfo(((AppPathInfo)localObject1).path, paramString1);
          localObject2 = localObject1;
          break;
          if (compareVersionString(str2, ((AppPathInfo)localObject1).desc.version) > 0)
          {
            ((AppPathInfo)localObject1).desc.name = paramString1;
            ((AppPathInfo)localObject1).desc.version = str2;
            ((AppPathInfo)localObject1).path = ((File)localObject3).getAbsolutePath();
  ...
  private void notifyGetAppPathByNameTaskResult(GetAppPathByNameTask paramGetAppPathByNameTask)
  {
    ...
    if (localObject != null)
    {
      ...
      ((IGetAppPathByNameCallback)localObject).onGetAppPathByName(paramGetAppPathByNameTask.retCode, paramGetAppPathByNameTask.errMsg, paramGetAppPathByNameTask.appPathInfo, paramGetAppPathByNameTask.userdata);
    }
  }
  
  private void notifyUpdateAppByNameResult(int paramInt1, int paramInt2, String paramString, UpdateAppByNameTask paramUpdateAppByNameTask)
  {
    boolean bool2 = true;
    boolean bool1 = true;
    int i = 0;
  ...
  private void onUpdateApp_DownloadAppPackageResult(boolean paramBoolean, byte[] paramArrayOfByte, UpdateAppByNameTask paramUpdateAppByNameTask)
  {
  ...
  private void onUpdateApp_QueryAppInfoByAppNameResult(ArkAppCGIMgr.QueryAppInfoByAppNameBatchResult paramQueryAppInfoByAppNameBatchResult, ArrayList<UpdateAppByNameTask> paramArrayList)
  {
    ...
    {
      UpdateAppByNameTask localUpdateAppByNameTask = (UpdateAppByNameTask)localIterator.next();
      ...
      else
      {
        ...
        if ((paramArrayList != null) && (paramArrayList.views != null) && (paramArrayList.views.size() > 0))
        {
          ...
          for (;;)
          {
            synchronized (this.mTempAppCache)
            {
              ...
              if ((localUpdateAppByNameTask.userdata.get(i) instanceof GetAppPathByNameTask))
              {
                ??? = (GetAppPathByNameTask)localUpdateAppByNameTask.userdata.get(i);
                ENV.logI("ArkApp.ArkAppMgr", String.format("ArkTemp.begin to find template app, app=%s, appView=%s", new Object[] { ((GetAppPathByNameTask)???).appName, ((GetAppPathByNameTask)???).appView }));
                localObject2 = ArkAppConfigMgr.getAppTemplateAndView(paramArrayList, ((GetAppPathByNameTask)???).appView);
                if ((localObject2 != null) && (localObject2.length >= 2))
                {
                  ...
                  getAppPathByName(localObject2[0], localObject2[1], "0.0.0.1", "", new ArkAppMgr.8(this, (String[])localObject2, localUpdateAppByNameTask, localQueryAppInfoResult, (GetAppPathByNameTask)???));
                }
              }
              else
              {
        ...
        else if (localQueryAppInfoResult.state == 1)
        {
          ...
          else
          {
            ...
            localUpdateAppByNameTask.appPathInfo = new AppPathInfo();
  ...
  private void runUpdateLocalAppTask(UpdateLocalAppTask paramUpdateLocalAppTask)
  {
  ...
  private void updateAppByNameBatch(ArrayList<ArkAppCGIMgr.AppNameVersion> paramArrayList, Object paramObject, IUpdateAppByNameCallback paramIUpdateAppByNameCallback)
  {
  ...
  public void getAppPathByName(String paramString1, String paramString2, String paramString3, Object paramObject, IGetAppPathByNameCallback paramIGetAppPathByNameCallback)
  {
    int i = 0;
    ...
    if (i != 0)
    {
      ...
      paramString1 = new GetAppPathByNameTask();
  ...
  public void getAppPathByNameFromLocalAsync(String paramString1, String paramString2, String paramString3, IGetLocalAppPath paramIGetLocalAppPath)
  {
    ArkDispatchTask.getInstance().postToArkThread(new GetAppPathTask(this, paramString1, paramString2, paramString3, paramIGetLocalAppPath));
  }
  
  public void getAppPathByNameTimeout(long paramLong, String paramString1, String paramString2, String paramString3, Object paramObject, IGetAppPathByNameCallbackTimeOut paramIGetAppPathByNameCallbackTimeOut)
  {
    GetCallBackResult localGetCallBackResult = new GetCallBackResult(null);
  ...
  public AppPathInfo getAppPathInfoByNameFromLocal(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    if ((paramString1 == null) || (paramString1.length() == 0) || (!ArkUtil.isDeviceSupportArkMsg())) {}
    do
    {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      paramMessage = (GetAppPathByNameTask)paramMessage.obj;
  ...
  {
    AppPathInfo localAppPathInfo = new AppPathInfo();
  ...
  static class EnumInstalledAppTask
  {
    String[] appNameList;
  }
  
  static class GetAppPathByNameTask
  {
  ...
  static final class GetAppPathTask
    implements Runnable
  {
    ...
    public GetAppPathTask(ArkAppMgr paramArkAppMgr, String paramString1, String paramString2, String paramString3, ArkAppMgr.IGetLocalAppPath paramIGetLocalAppPath)
    {
    ...
    public void run()
    {
      ...
      if (localObject == null)
      {
        ArkAppMgr.ENV.logI("ArkApp.ArkAppMgr", "ArkAppMgr.GetAppPathTask.object.null");
        return;
      }
      localObject = ((ArkAppMgr)localObject).getAppPathByNameFromLocal(this.mAppName, this.mAppView, this.mMinVersion, false);
      if (TextUtils.isEmpty((CharSequence)localObject))
      {
        ArkAppMgr.ENV.logI("ArkApp.ArkAppMgr", "ArkAppMgr.GetAppPathTask.path.null");
        return;
      }
  ...
  static class GetCallBackResult
  {
    ArkAppMgr.AppPathInfo appPath;
    boolean hascalled;
    String msg = ArkAppMgr.QueryAppRetCodeToString(this.retCode);
    int retCode = -7;
    Object userdata;
  }
  ...
  static abstract interface ICheckNetworkCallback
  {
    public abstract void onCheckNetwork(boolean paramBoolean);
  }
  
  static abstract interface IEnumInstalledAppCallback
  {
    public abstract void onEnumInstalledApp(String[] paramArrayOfString);
  }
  
  public static abstract interface IGetAppPathByNameCallback
  {
  ...
  public static abstract interface IGetAppPathByNameCallbackTimeOut
  {
    public abstract void onGetAppPathByNameTimeout(int paramInt, String paramString, ArkAppMgr.AppPathInfo paramAppPathInfo, Object paramObject);
  }
  
  public static abstract interface IGetLocalAppPath
  {
    public abstract void callback(String paramString);
  }
  
  static abstract interface IUpdateAppByNameCallback
  {
    public abstract void onUpdateAppByName(ArkAppMgr.UpdateAppByNameTask paramUpdateAppByNameTask, Object paramObject);
  }
  
  static class UpdateAppByNameTask
  {
    public String appName;
    public ArkAppMgr.AppPathInfo appPathInfo;
    public String appView;
  ...
  static class UpdateLocalAppTask
  {
