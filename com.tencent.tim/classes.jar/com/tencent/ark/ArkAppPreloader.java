...
public class ArkAppPreloader
{
  ...
  public static void preloadApp(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, PreloadAppCallback paramPreloadAppCallback, int paramInt)
  {
  ...
  public static void releasePreloadApplicationAndReload(String paramString)
  {
    ...
    for (;;)
    {
      synchronized (sPreLoadApplications)
      {
        localObject2 = (PreloadAppInfo)sPreLoadApplications.get(paramString);
        ...
        {
          str5 = ((PreloadAppInfo)localObject2).appName;
          str4 = ((PreloadAppInfo)localObject2).appPath;
          str3 = ((PreloadAppInfo)localObject2).storagePath;
          str2 = ((PreloadAppInfo)localObject2).resPath;
          str1 = ((PreloadAppInfo)localObject2).cachePath;
          if (((PreloadAppInfo)localObject2).callbackRef != null)
          {
            localObject1 = (PreloadAppCallback)((PreloadAppInfo)localObject2).callbackRef.get();
            ark.Application localApplication = ((PreloadAppInfo)localObject2).application;
            ...
            ((PreloadAppCallback)localObject2).onReleaseAndReload(str5, 2);
            return;
          }
          localObject1 = null;
        }
  ...
  public static abstract interface PreloadAppCallback
  {
  ...
  public static class PreloadAppInfo
  {
    ...
    public WeakReference<ArkAppPreloader.PreloadAppCallback> callbackRef;
