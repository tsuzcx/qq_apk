...
public class ArkAndroidHttpClientStub
{
  ...
  private final RequestOption m_option = new RequestOption(null);
  ...
  private static long computeFormDataLength(FormData paramFormData)
    throws IOException
  {
  ...
  private void httpAsynTask(String paramString1, int paramInt1, byte[] paramArrayOfByte, int paramInt2, FormData paramFormData, String paramString2, long paramLong)
  {
  ...
  private void httpExecuteTask(String paramString1, int paramInt1, byte[] paramArrayOfByte, int paramInt2, FormData paramFormData, String paramString2, long paramLong)
  {
    ...
    paramFormData = (FormData)localObject;
    localObject = null;
  ...
  private static int sendRequest(HttpURLConnection paramHttpURLConnection, RequestOption paramRequestOption, int paramInt1, byte[] paramArrayOfByte, int paramInt2, FormData paramFormData)
  {
    int j = 1;
  ...
  private static void setConnectionOptions(HttpURLConnection paramHttpURLConnection, RequestOption paramRequestOption, int paramInt)
  {
    ...
    for (int i = 15000;; i = paramRequestOption.timeoutInterval)
    {
      ...
      {
        Header localHeader = (Header)paramRequestOption.next();
  ...
  private static void writeFormData(OutputStream paramOutputStream, FormData paramFormData)
    throws IOException
  {
  ...
  private void writeResponse(String paramString1, TimerTask paramTimerTask, long paramLong, String paramString2)
  {
    ...
    //   1: astore 10
    //   3: aload 5
    //   5: invokestatic 234	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   8: ifne +117 -> 125
    //   11: new 632	java/io/FileOutputStream
    //   14: dup
    //   15: aload 5
    //   17: invokespecial 633	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   20: astore 5
    //   22: aload_0
    //   23: getfield 435	com/tencent/ark/ArkAndroidHttpClientStub:mHttpURLConnection	Ljava/net/HttpURLConnection;
    //   26: ifnonnull +123 -> 149
    //   29: getstatic 106	com/tencent/ark/ArkAndroidHttpClientStub:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   32: ldc 72
    //   34: ldc_w 635
    //   37: invokevirtual 303	com/tencent/ark/ArkEnvironmentManager:logE	(Ljava/lang/String;Ljava/lang/String;)V
    //   40: new 160	java/lang/Exception
    //   43: dup
    //   44: ldc_w 637
    //   47: invokespecial 638	java/lang/Exception:<init>	(Ljava/lang/String;)V
    //   50: athrow
    //   51: astore 8
    //   53: aload 10
    //   55: astore 9
    //   57: getstatic 106	com/tencent/ark/ArkAndroidHttpClientStub:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   60: ldc 72
    //   62: new 167	java/lang/StringBuilder
    //   65: dup
    ...
    //   79: ldc_w 642
    //   82: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   85: aload 8
    //   87: invokevirtual 643	java/net/UnknownHostException:getMessage	()Ljava/lang/String;
    //   90: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   93: invokevirtual 181	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   96: invokevirtual 303	com/tencent/ark/ArkEnvironmentManager:logE	(Ljava/lang/String;Ljava/lang/String;)V
    //   99: aload_2
    //   100: invokestatic 645	com/tencent/ark/ArkAndroidHttpClientStub:cancelTimer	(Ljava/util/TimerTask;)V
    //   103: aload_0
    //   104: invokespecial 647	com/tencent/ark/ArkAndroidHttpClientStub:setFlagComplete	()V
    //   107: aload_0
    //   108: lload_3
    //   109: bipush 22
    //   111: invokevirtual 651	com/tencent/ark/ArkAndroidHttpClientStub:OnRequestComplete	(JI)V
    //   114: aload 9
    //   116: invokestatic 653	com/tencent/ark/ArkAndroidHttpClientStub:closeStream	(Ljava/io/InputStream;)V
    //   119: aload 5
    //   121: invokestatic 514	com/tencent/ark/ArkAndroidHttpClientStub:closeStream	(Ljava/io/OutputStream;)V
    //   124: return
    //   125: new 655	java/io/ByteArrayOutputStream
    //   128: dup
    //   129: invokespecial 656	java/io/ByteArrayOutputStream:<init>	()V
    //   132: astore 5
    //   134: goto -112 -> 22
    //   137: astore 8
    //   139: aconst_null
    ...
    //   144: astore 9
    //   146: goto -89 -> 57
    //   149: new 658	java/io/BufferedInputStream
    //   152: dup
    //   153: aload_0
    //   154: getfield 435	com/tencent/ark/ArkAndroidHttpClientStub:mHttpURLConnection	Ljava/net/HttpURLConnection;
    //   157: invokevirtual 662	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   160: invokespecial 664	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   163: astore 9
    //   165: aload 5
    //   167: astore 10
    //   169: aload 9
    ...
    //   188: astore 8
    //   190: aload_0
    //   191: getfield 666	com/tencent/ark/ArkAndroidHttpClientStub:mIsCanceled	Z
    //   194: ifeq +147 -> 341
    //   197: aload 5
    //   199: astore 10
    //   201: aload 9
    //   203: astore 8
    //   205: getstatic 106	com/tencent/ark/ArkAndroidHttpClientStub:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   208: ldc 72
    //   210: new 167	java/lang/StringBuilder
    //   213: dup
    //   214: invokespecial 168	java/lang/StringBuilder:<init>	()V
    //   217: ldc_w 668
    ...
    //   230: invokevirtual 136	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;Ljava/lang/String;)V
    //   233: aload 5
    //   235: astore 10
    //   237: aload 9
    //   239: astore 8
    ...
    //   257: aload_0
    //   258: aload 5
    //   260: checkcast 655	java/io/ByteArrayOutputStream
    //   263: invokevirtual 671	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   266: putfield 673	com/tencent/ark/ArkAndroidHttpClientStub:mResponseBody	[B
    //   269: aload 5
    //   271: astore 10
    //   273: aload 9
    //   275: astore 8
    //   277: getstatic 106	com/tencent/ark/ArkAndroidHttpClientStub:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   280: ldc 72
    //   282: new 167	java/lang/StringBuilder
    //   285: dup
    //   286: invokespecial 168	java/lang/StringBuilder:<init>	()V
    //   289: ldc_w 675
    //   292: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   295: iload 6
    //   297: invokevirtual 678	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   300: ldc_w 680
    //   303: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   306: aload_1
    //   307: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   310: invokevirtual 181	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   313: invokevirtual 136	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;Ljava/lang/String;)V
    //   316: aload_2
    //   317: invokestatic 645	com/tencent/ark/ArkAndroidHttpClientStub:cancelTimer	(Ljava/util/TimerTask;)V
    //   320: aload_0
    //   321: invokespecial 647	com/tencent/ark/ArkAndroidHttpClientStub:setFlagComplete	()V
    //   324: aload_0
    //   325: lload_3
    //   326: iconst_0
    //   327: invokevirtual 651	com/tencent/ark/ArkAndroidHttpClientStub:OnRequestComplete	(JI)V
    //   330: aload 9
    //   332: invokestatic 653	com/tencent/ark/ArkAndroidHttpClientStub:closeStream	(Ljava/io/InputStream;)V
    //   335: aload 5
    //   337: invokestatic 514	com/tencent/ark/ArkAndroidHttpClientStub:closeStream	(Ljava/io/OutputStream;)V
    //   340: return
    //   341: aload 5
    //   343: astore 10
    //   345: aload 9
    //   347: astore 8
    //   349: aload_0
    //   350: getfield 138	com/tencent/ark/ArkAndroidHttpClientStub:mIsTimeout	Z
    //   353: ifeq +42 -> 395
    //   356: aload 5
    //   358: astore 10
    //   360: aload 9
    //   362: astore 8
    //   364: getstatic 106	com/tencent/ark/ArkAndroidHttpClientStub:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   367: ldc 72
    //   369: new 167	java/lang/StringBuilder
    //   372: dup
    //   373: invokespecial 168	java/lang/StringBuilder:<init>	()V
    //   376: ldc_w 682
    //   379: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   382: aload_1
    //   383: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   386: invokevirtual 181	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   389: invokevirtual 136	com/tencent/ark/ArkEnvironmentManager:logI	(Ljava/lang/String;Ljava/lang/String;)V
    //   392: goto -159 -> 233
    //   395: aload 5
    //   397: astore 10
    //   399: aload 9
    ...
    //   403: aload 9
    //   405: aload 11
    //   407: invokevirtual 683	java/io/InputStream:read	([B)I
    //   410: istore 7
    //   412: iload 7
    //   414: iconst_m1
    ...
    //   430: iconst_0
    //   431: iload 7
    //   433: invokevirtual 518	java/io/OutputStream:write	([BII)V
    //   436: iload 7
    //   438: iload 6
    //   440: iadd
    //   441: istore 6
    ...
    //   458: aload 5
    //   460: astore 8
    //   462: getstatic 106	com/tencent/ark/ArkAndroidHttpClientStub:ENV	Lcom/tencent/ark/ArkEnvironmentManager;
    //   465: ldc 72
    //   467: new 167	java/lang/StringBuilder
    //   470: dup
    //   471: invokespecial 168	java/lang/StringBuilder:<init>	()V
    //   474: ldc_w 640
    //   477: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   480: aload_1
    //   481: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   484: ldc_w 642
    //   487: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   490: aload 11
    //   492: invokevirtual 178	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   495: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   498: invokevirtual 181	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   501: invokevirtual 303	com/tencent/ark/ArkEnvironmentManager:logE	(Ljava/lang/String;Ljava/lang/String;)V
    //   504: aload_2
    //   505: invokestatic 645	com/tencent/ark/ArkAndroidHttpClientStub:cancelTimer	(Ljava/util/TimerTask;)V
    //   508: aload_0
    //   509: invokespecial 647	com/tencent/ark/ArkAndroidHttpClientStub:setFlagComplete	()V
    //   512: aload_0
    //   513: lload_3
    //   514: iconst_5
    //   515: invokevirtual 651	com/tencent/ark/ArkAndroidHttpClientStub:OnRequestComplete	(JI)V
    //   518: aload 5
    //   520: invokestatic 653	com/tencent/ark/ArkAndroidHttpClientStub:closeStream	(Ljava/io/InputStream;)V
    //   523: aload 12
    //   525: invokestatic 514	com/tencent/ark/ArkAndroidHttpClientStub:closeStream	(Ljava/io/OutputStream;)V
    //   528: return
    //   529: astore_1
    //   530: aconst_null
    //   531: astore 5
    ...
    //   534: astore 8
    //   536: aload_2
    //   537: invokestatic 645	com/tencent/ark/ArkAndroidHttpClientStub:cancelTimer	(Ljava/util/TimerTask;)V
    //   540: aload_0
    //   541: invokespecial 647	com/tencent/ark/ArkAndroidHttpClientStub:setFlagComplete	()V
    //   544: aload_0
    //   545: lload_3
    //   546: iconst_0
    //   547: invokevirtual 651	com/tencent/ark/ArkAndroidHttpClientStub:OnRequestComplete	(JI)V
    //   550: aload 8
    //   552: invokestatic 653	com/tencent/ark/ArkAndroidHttpClientStub:closeStream	(Ljava/io/InputStream;)V
    //   555: aload 5
    //   557: invokestatic 514	com/tencent/ark/ArkAndroidHttpClientStub:closeStream	(Ljava/io/OutputStream;)V
    //   560: aload_1
    //   561: athrow
    //   562: astore_1
    //   563: aconst_null
  ...
  public void AddFormData(String paramString1, String paramString2)
  {
    ...
    if (this.mFormData == null) {
      this.mFormData = new FormData(null);
    }
  ...
  public int PostForm(String paramString1, String paramString2, long paramLong)
  {
    ...
    FormData localFormData = this.mFormData;
    this.mFormData = null;
  ...
  static class RequestOption
  {
    public String cookie;
    public final List<ArkAndroidHttpClientStub.Header> customHeader = new ArrayList();
