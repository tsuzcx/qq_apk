  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (AEFilterManager.access$100(this.this$0) == null)
    {
      ...
      LogUtils.i(AEFilterManager.access$200(), "create faceTransform action done");
    }
    if ((AEFilterManager.access$300(this.this$0)) && (AEFilterManager.access$100(this.this$0) != null))
    {
      LogUtils.i(AEFilterManager.access$200(), "create faceTransform action done, but GLThread has exited, so do cleaning");
