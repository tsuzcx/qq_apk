...
{
  private static final String[] AEKIT_FORMER_VERSION = { "1.0.0", "1.1.0", "1.2.0", "1.3.0", "1.4.0", "1.5.0", "1.6.0", "1.7.0", "1.7.1", "1.7.2", "1.7.3", "1.7.4", "1.7.5", "1.7.6", "1.7.7" };
  private static final String AEKIT_VERSION = "1.7.7";
  ...
  public static String getVersion(Context paramContext)
  {
    ...
    label29:
    for (aekitVersion = "1.7.7";; aekitVersion = paramContext.split("\n")[0]) {
      return aekitVersion;
    }
  }
