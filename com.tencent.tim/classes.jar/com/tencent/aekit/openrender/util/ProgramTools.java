...
public class ProgramTools
{
  ...
  public static ProgramInfo createProgram(String paramString1, String paramString2)
  {
  ...
  public static class ProgramInfo
  {
    ...
    public ProgramInfo(int paramInt1, int paramInt2, int paramInt3)
    {
