...
public final class c
{
  ...
  private boolean a(java.io.InputStream paramInputStream, long paramLong)
  {
    ...
    //   216: aload_1
    //   217: aload 9
    //   219: invokevirtual 113	java/io/InputStream:read	([B)I
    //   222: pop
    //   223: aload_0
    //   224: getfield 27	com/tencent/apkupdate/b/c:d	[B
    //   227: astore_1
    //   228: aload 9
    //   230: arraylength
    //   231: istore 6
    ...
    //   91	150	6	k	int
    //   34	9	7	l	long
    //   4	246	9	arrayOfByte1	byte[]
    //   24	117	10	localObject	Object
    //   121	13	11	arrayOfByte2	byte[]
    // Exception table:
    //   from	to	target	type
    //   107	117	274	java/lang/Exception
    //   180	187	277	java/lang/Exception
    //   216	223	280	java/lang/Exception
  }
