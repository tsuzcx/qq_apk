...
public class TPPlayerStateStrategy
{
  ...
  {
    return (paramTPPlayerState.is(3)) || (paramTPPlayerState.is(4)) || (paramTPPlayerState.is(5)) || (paramTPPlayerState.is(6)) || (paramTPPlayerState.is(7)) || (paramTPPlayerState.is(8));
  }
