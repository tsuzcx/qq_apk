  ...
  extends BroadcastReceiver
{
  ...
  private ArrayList<OnNetStatusChangeListener> mListeners = null;
  ...
  private void notifyIfNetChanged()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          ((OnNetStatusChangeListener)localIterator.next()).onStatusChanged(lastNetStatus, mNetStatus, 0, mobileNetSubType);
          continue;
        }
  ...
  public void addOnNetStatusChangeListener(OnNetStatusChangeListener paramOnNetStatusChangeListener)
  {
    try
    {
  ...
  public void removeOnNetStatusChangeListener(OnNetStatusChangeListener paramOnNetStatusChangeListener)
  {
    try
    {
      if (this.mListeners != null)
  ...
  {
    private static TPNetworkChangeMonitor instance = new TPNetworkChangeMonitor(null);
  }
  
  public static abstract interface OnNetStatusChangeListener
  {
