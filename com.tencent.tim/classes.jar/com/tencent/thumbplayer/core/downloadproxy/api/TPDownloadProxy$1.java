  ...
  extends ConnectivityManager.NetworkCallback
{
  ...
  public void onAvailable(Network paramNetwork)
  {
    ...
    TPDLProxyLog.i("TPDownloadProxy", 0, "tpdlnative", "cellular_network, net_id_t: " + l);
    this.this$0.setUserData("cellular_interface_id", Long.valueOf(l));
  }
  
  public void onLost(Network paramNetwork)
  {
    super.onLost(paramNetwork);
    this.this$0.setUserData("cellular_interface_id", Integer.valueOf(0));
