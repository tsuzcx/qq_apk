  ...
  implements ITPDownloadProxy
{
  ...
  public int init(Context paramContext, TPDLProxyInitParam paramTPDLProxyInitParam)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          i = TPDownloadProxyNative.getInstance().initService(this.mServiceType, (String)localObject, this.mCurrentStoragePath, paramTPDLProxyInitParam.getConfigStr());
          ...
          localObject = new TPDownloadProxy.2(this);
          if (paramContext != null) {
      ...
      label370:
      i = TPDownloadProxyNative.getInstance().initService(this.mServiceType, str1, paramTPDLProxyInitParam.getDataDir(), paramTPDLProxyInitParam.getConfigStr());
    }
  }
  ...
  public void pushEvent(int paramInt)
  {
    ...
    {
      TPDLProxyLog.e("TPDownloadProxy", 0, "tpdlnative", "cellular_network pushEvent failed, error:" + localThrowable.toString());
    }
  }
