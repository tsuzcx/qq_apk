...
{
  private static final String DEFAULT_LIB_PLAYER_CORE_VERSION = "2.20.0.1086.full";
  private static final String MAIN_PLAYER_CORE_VERSION = "2.20.0";
  ...
  public static String getPlayerCoreVersion()
  {
    ...
    {
      TPNativeLog.printLog(2, "getPlayerCoreVersion: *.so is not loaded yet, return the hard-coded version number:2.20.0.1086.full");
    }
    return "2.20.0.1086.full";
  }
  ...
  private static boolean loadLib(Context paramContext)
  {
    ...
    if (mLibLoader != null) {}
    boolean bool2;
    for (boolean bool1 = mLibLoader.loadLib(str, "2.20.0.1086.full");; bool1 = loadLibDefault(str, paramContext))
    {
      bool2 = bool1;
      if (bool1)
      {
        paramContext = getPlayerCoreVersion();
        bool1 = isMatchJavaAndPlayerCore("2.20.0", paramContext);
        bool2 = bool1;
        if (!bool1)
        {
          TPNativeLog.printLog(4, "nativePlayerCoreVer(" + paramContext + ") doesn't match javaPlayerCoreVer:(" + "2.20.0" + ")");
          bool2 = bool1;
        }
      }
      if (!bool2) {
