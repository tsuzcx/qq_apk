...
public class TPSystemInfo
{
  ...
  private static final String PRODUCT_BOARD;
  private static final String PRODUCT_DEVICE;
  ...
  private static int sCpuArchitecture;
  ...
  private static String sDeviceMacAddr;
  ...
  static
  {
    ...
    sCpuArch = -1;
    sOpenGLVersion = 0;
    if ((Build.VERSION.SDK_INT == 25) && (!TextUtils.isEmpty(Build.VERSION.CODENAME)) && (Build.VERSION.CODENAME.charAt(0) == 'O')) {}
  ...
  public static int getCpuHWProductIndex(String paramString)
  {
    if (sCpuHWProducter < 0) {
      sCpuHWProducter = getCpuHWProducer(paramString);
    }
    if ((sCpuHWProducter >= 0) && (sCpuHWProductIdx < 0))
    {
      String[] arrayOfString = sCpuPerfList[sCpuHWProducter];
      int i = 0;
      int k = -1;
  ...
  public static void getCpuInfo()
  {
    ...
    //   2: aconst_null
    //   3: astore_3
    //   4: new 557	java/io/InputStreamReader
    //   7: dup
    //   8: new 559	java/io/FileInputStream
    //   11: dup
    //   12: ldc_w 561
    //   15: invokespecial 564	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   18: ldc_w 566
    //   21: invokespecial 569	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   24: astore_1
    //   25: new 571	java/io/BufferedReader
    //   28: dup
    //   29: aload_1
    //   30: invokespecial 574	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   33: astore_0
    //   34: aload_0
    //   35: invokevirtual 577	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   38: astore_2
    //   39: aload_2
    //   40: ifnonnull +20 -> 60
    //   43: aload_1
    //   44: ifnull +7 -> 51
    //   47: aload_1
    //   48: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   51: aload_0
    //   52: ifnull +7 -> 59
    //   55: aload_0
    //   56: invokevirtual 581	java/io/BufferedReader:close	()V
    //   59: return
    //   60: aload_2
    //   61: invokestatic 584	com/tencent/thumbplayer/core/common/TPSystemInfo:parseCpuInfoLine	(Ljava/lang/String;)V
    //   64: goto -30 -> 34
    //   67: astore_2
    //   68: ldc_w 586
    //   71: putstatic 102	com/tencent/thumbplayer/core/common/TPSystemInfo:sCpuHardware	Ljava/lang/String;
    //   74: iconst_0
    //   75: putstatic 104	com/tencent/thumbplayer/core/common/TPSystemInfo:sCpuArchitecture	I
    //   78: aload_1
    //   79: ifnull +7 -> 86
    //   82: aload_1
    //   83: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   86: aload_0
    //   87: ifnull -28 -> 59
    //   90: aload_0
    //   91: invokevirtual 581	java/io/BufferedReader:close	()V
    //   94: return
    //   95: astore_0
    //   96: iconst_4
    //   97: aload_0
    //   98: invokevirtual 587	java/io/IOException:getMessage	()Ljava/lang/String;
    //   101: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   104: return
    //   105: astore_0
    //   106: iconst_4
    //   107: aload_0
    //   108: invokevirtual 587	java/io/IOException:getMessage	()Ljava/lang/String;
    //   111: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   114: return
    //   115: astore_0
    //   116: aconst_null
    //   117: astore_1
    ...
    //   119: ifnull +7 -> 126
    //   122: aload_1
    //   123: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   126: aload_2
    //   127: ifnull +7 -> 134
    //   130: aload_2
    //   131: invokevirtual 581	java/io/BufferedReader:close	()V
    //   134: aload_0
    //   135: athrow
    //   136: astore_1
    //   137: iconst_4
    //   138: aload_1
    //   139: invokevirtual 587	java/io/IOException:getMessage	()Ljava/lang/String;
    //   142: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   145: goto -11 -> 134
    //   148: astore_0
    //   149: goto -31 -> 118
    //   152: astore_3
  ...
  {
    // Byte code:
    //   0: getstatic 370	com/tencent/thumbplayer/core/common/TPSystemInfo:sCurrentCpuFreq	J
    //   3: lconst_0
    //   4: lcmp
    //   5: ifle +9 -> 14
    //   8: getstatic 370	com/tencent/thumbplayer/core/common/TPSystemInfo:sCurrentCpuFreq	J
    //   11: lstore_2
    //   12: lload_2
    //   13: lreturn
    //   14: new 557	java/io/InputStreamReader
    //   17: dup
    //   18: new 559	java/io/FileInputStream
    //   21: dup
    //   22: ldc_w 593
    //   25: invokespecial 564	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   28: ldc_w 566
    //   31: invokespecial 569	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   34: astore 4
    //   36: new 571	java/io/BufferedReader
    //   39: dup
    //   40: aload 4
    //   42: invokespecial 574	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   45: astore 7
    //   47: aload 7
    //   49: astore 6
    //   51: aload 4
    //   53: astore 5
    //   55: aload 7
    //   57: invokevirtual 577	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   60: astore 8
    //   62: aload 8
    //   64: ifnonnull +64 -> 128
    //   67: aload 7
    ...
    //   73: astore 5
    //   75: aload 4
    //   77: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   80: aload 7
    //   82: astore 6
    //   84: aload 4
    //   86: astore 5
    //   88: aload 7
    //   90: invokevirtual 581	java/io/BufferedReader:close	()V
    //   93: aload 4
    //   95: ifnull +8 -> 103
    //   98: aload 4
    //   100: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   103: aload 7
    //   105: ifnull +8 -> 113
    //   108: aload 7
    //   110: invokevirtual 581	java/io/BufferedReader:close	()V
    //   113: lconst_0
    //   114: lreturn
    //   115: astore 4
    //   117: iconst_4
    //   118: aload 4
    //   120: invokevirtual 451	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   123: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   126: lconst_0
    //   127: lreturn
    //   128: aload 7
    //   130: astore 6
    ...
    //   134: astore 5
    //   136: aload 8
    //   138: invokevirtual 596	java/lang/String:trim	()Ljava/lang/String;
    //   141: astore 8
    //   143: aload 7
    //   145: astore 6
    //   147: aload 4
    //   149: astore 5
    //   151: aload 8
    //   153: invokevirtual 433	java/lang/String:length	()I
    //   156: ifle +495 -> 651
    //   159: aload 7
    //   161: astore 6
    //   163: aload 4
    //   165: astore 5
    //   167: aload 8
    //   169: invokestatic 602	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   172: lstore_0
    //   173: aload 7
    //   175: astore 6
    //   177: aload 4
    //   179: astore 5
    //   181: lload_0
    //   182: putstatic 370	com/tencent/thumbplayer/core/common/TPSystemInfo:sCurrentCpuFreq	J
    //   185: aload 4
    //   187: ifnull +8 -> 195
    //   190: aload 4
    //   192: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   195: lload_0
    //   196: lstore_2
    //   197: aload 7
    //   199: ifnull -187 -> 12
    //   202: aload 7
    //   204: invokevirtual 581	java/io/BufferedReader:close	()V
    //   207: lload_0
    //   208: lreturn
    //   209: astore 4
    //   211: iconst_4
    //   212: aload 4
    //   214: invokevirtual 451	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   217: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   220: lconst_0
    //   221: lreturn
    //   222: astore 8
    //   224: aconst_null
    ...
    //   242: iconst_4
    //   243: aload 8
    //   245: invokevirtual 605	java/io/FileNotFoundException:getMessage	()Ljava/lang/String;
    //   248: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   251: aload 4
    //   253: ifnull +8 -> 261
    //   256: aload 4
    //   258: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   261: lload_0
    //   262: lstore_2
    //   263: aload 7
    //   265: ifnull -253 -> 12
    //   268: aload 7
    //   270: invokevirtual 581	java/io/BufferedReader:close	()V
    //   273: lload_0
    //   274: lreturn
    //   275: astore 4
    //   277: iconst_4
    //   278: aload 4
    //   280: invokevirtual 451	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   283: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   286: lconst_0
    //   287: lreturn
    //   288: astore 8
    //   290: aconst_null
    ...
    //   308: iconst_4
    //   309: aload 8
    //   311: invokevirtual 587	java/io/IOException:getMessage	()Ljava/lang/String;
    //   314: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   317: aload 4
    //   319: ifnull +8 -> 327
    //   322: aload 4
    //   324: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   327: lload_0
    //   328: lstore_2
    //   329: aload 7
    //   331: ifnull -319 -> 12
    //   334: aload 7
    //   336: invokevirtual 581	java/io/BufferedReader:close	()V
    //   339: lload_0
    //   340: lreturn
    //   341: astore 4
    //   343: iconst_4
    //   344: aload 4
    //   346: invokevirtual 451	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   349: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   352: lconst_0
    //   353: lreturn
    //   354: astore 8
    //   356: aconst_null
    ...
    //   374: iconst_4
    //   375: aload 8
    //   377: invokevirtual 606	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   380: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   383: aload 4
    //   385: ifnull +8 -> 393
    //   388: aload 4
    //   390: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   393: lload_0
    //   394: lstore_2
    //   395: aload 7
    //   397: ifnull -385 -> 12
    //   400: aload 7
    //   402: invokevirtual 581	java/io/BufferedReader:close	()V
    //   405: lload_0
    //   406: lreturn
    //   407: astore 4
    //   409: iconst_4
    //   410: aload 4
    //   412: invokevirtual 451	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   415: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   418: lconst_0
    //   419: lreturn
    //   420: astore 8
    //   422: aconst_null
    ...
    //   440: iconst_4
    //   441: aload 8
    //   443: invokevirtual 451	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   446: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   449: aload 4
    //   451: ifnull +8 -> 459
    //   454: aload 4
    //   456: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   459: lload_0
    //   460: lstore_2
    //   461: aload 7
    //   463: ifnull -451 -> 12
    //   466: aload 7
    //   468: invokevirtual 581	java/io/BufferedReader:close	()V
    //   471: lload_0
    //   472: lreturn
    //   473: astore 4
    //   475: iconst_4
    //   476: aload 4
    //   478: invokevirtual 451	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   481: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   484: lconst_0
    //   485: lreturn
    //   486: astore 7
    //   488: aconst_null
    ...
    //   496: ifnull +8 -> 504
    //   499: aload 4
    //   501: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   504: aload 6
    //   506: ifnull +8 -> 514
    //   509: aload 6
    ...
    //   519: iconst_4
    //   520: aload 4
    //   522: invokevirtual 451	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   525: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   528: lconst_0
    //   529: lreturn
    //   530: astore 7
    //   532: aconst_null
  ...
  public static String getDeviceID(Context paramContext)
  {
    ...
    try
    {
      sDeviceID = Settings.System.getString(paramContext.getContentResolver(), "android_id");
  ...
  public static String getDeviceIMEI(Context paramContext)
  {
    ...
    try
    {
      ...
      if (paramContext != null)
      {
        sDeviceIMEI = alla.a(paramContext);
        if (TextUtils.isEmpty(sDeviceIMEI)) {
          sDeviceIMEI = "NONE";
        }
        paramContext = sDeviceIMEI;
        return paramContext;
      }
    }
    catch (Throwable paramContext)
  ...
  public static String getDeviceIMSI(Context paramContext)
  {
    ...
    try
    {
      ...
      if (paramContext != null)
      {
        sDeviceIMSI = alla.e(paramContext);
        if (sDeviceIMSI == null) {
          sDeviceIMSI = "";
        }
        paramContext = sDeviceIMSI;
        return paramContext;
      }
    }
    catch (Throwable paramContext)
  ...
  public static String getDeviceMacAddr(Context paramContext)
  {
    ...
    sDeviceMacAddr = _getDeviceMacAddr(paramContext);
  ...
  public static long getMaxCpuFreq()
  {
    ...
    //   10: lstore_0
    //   11: ldc2_w 365
    //   14: getstatic 368	com/tencent/thumbplayer/core/common/TPSystemInfo:sMaxCpuFreq	J
    //   17: lcmp
    //   18: ifeq +9 -> 27
    //   21: getstatic 368	com/tencent/thumbplayer/core/common/TPSystemInfo:sMaxCpuFreq	J
    //   24: lstore_0
    //   25: lload_0
    //   26: lreturn
    //   27: new 557	java/io/InputStreamReader
    //   30: dup
    //   31: new 559	java/io/FileInputStream
    //   34: dup
    //   35: ldc_w 674
    //   38: invokespecial 564	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   41: ldc_w 566
    //   44: invokespecial 569	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   47: astore 6
    //   49: new 571	java/io/BufferedReader
    //   52: dup
    //   53: aload 6
    //   55: invokespecial 574	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   58: astore 7
    //   60: aload 7
    //   62: invokevirtual 577	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   65: astore 8
    //   67: aload 8
    //   69: ifnonnull +48 -> 117
    //   72: aload 6
    //   74: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   77: aload 7
    //   79: invokevirtual 581	java/io/BufferedReader:close	()V
    //   82: aload 6
    //   84: ifnull +8 -> 92
    //   87: aload 6
    //   89: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   92: aload 7
    //   94: ifnull -69 -> 25
    //   97: aload 7
    //   99: invokevirtual 581	java/io/BufferedReader:close	()V
    //   102: lconst_0
    //   103: lreturn
    //   104: astore 6
    //   106: iconst_4
    //   107: aload 6
    //   109: invokevirtual 587	java/io/IOException:getMessage	()Ljava/lang/String;
    //   112: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   115: lconst_0
    //   116: lreturn
    //   117: aload 8
    //   119: invokevirtual 596	java/lang/String:trim	()Ljava/lang/String;
    //   122: astore 8
    //   124: lload_0
    //   125: lstore_2
    //   126: aload 8
    //   128: invokevirtual 433	java/lang/String:length	()I
    //   131: ifle +9 -> 140
    //   134: aload 8
    //   136: invokestatic 602	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   139: lstore_2
    //   140: aload 6
    //   142: ifnull +8 -> 150
    //   145: aload 6
    //   147: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   150: lload_2
    //   151: lstore 4
    //   153: aload 7
    //   155: ifnull +11 -> 166
    //   158: aload 7
    //   160: invokevirtual 581	java/io/BufferedReader:close	()V
    //   163: lload_2
    //   164: lstore 4
    //   166: lload 4
    //   168: putstatic 368	com/tencent/thumbplayer/core/common/TPSystemInfo:sMaxCpuFreq	J
    //   171: iconst_2
    //   172: new 422	java/lang/StringBuilder
    //   175: dup
    //   176: invokespecial 423	java/lang/StringBuilder:<init>	()V
    //   179: ldc_w 676
    //   182: invokevirtual 440	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   185: getstatic 368	com/tencent/thumbplayer/core/common/TPSystemInfo:sMaxCpuFreq	J
    //   188: invokevirtual 679	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   191: invokevirtual 443	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   194: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   197: lload 4
    //   199: lreturn
    //   200: astore 6
    //   202: iconst_4
    //   203: aload 6
    //   205: invokevirtual 587	java/io/IOException:getMessage	()Ljava/lang/String;
    //   208: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   211: lload_2
    //   212: lstore 4
    //   214: goto -48 -> 166
    //   217: astore 6
    ...
    //   232: ifnull +8 -> 240
    //   235: aload 6
    //   237: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   240: lload_0
    //   241: lstore 4
    //   243: aload 7
    //   245: ifnull -79 -> 166
    //   248: aload 7
    //   250: invokevirtual 581	java/io/BufferedReader:close	()V
    //   253: lload_0
    //   254: lstore 4
    //   256: goto -90 -> 166
    //   259: astore 6
    //   261: iconst_4
    //   262: aload 6
    //   264: invokevirtual 587	java/io/IOException:getMessage	()Ljava/lang/String;
    //   267: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   270: lload_0
    //   271: lstore 4
    //   273: goto -107 -> 166
    //   276: astore 6
    ...
    //   287: ifnull +8 -> 295
    //   290: aload 6
    //   292: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   295: lload_0
    //   296: lstore 4
    //   298: aload 7
    //   300: ifnull -134 -> 166
    //   303: aload 7
    //   305: invokevirtual 581	java/io/BufferedReader:close	()V
    //   308: lload_0
    //   309: lstore 4
    //   311: goto -145 -> 166
    //   314: astore 6
    //   316: iconst_4
    //   317: aload 6
    //   319: invokevirtual 587	java/io/IOException:getMessage	()Ljava/lang/String;
    //   322: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   325: lload_0
    //   326: lstore 4
    //   328: goto -162 -> 166
    //   331: astore 7
    ...
    //   338: ifnull +8 -> 346
    //   341: aload 6
    //   343: invokevirtual 580	java/io/InputStreamReader:close	()V
    //   346: aload 8
    //   348: ifnull +8 -> 356
    //   351: aload 8
    //   353: invokevirtual 581	java/io/BufferedReader:close	()V
    //   356: aload 7
    //   358: athrow
    //   359: astore 6
    //   361: iconst_4
    //   362: aload 6
    //   364: invokevirtual 587	java/io/IOException:getMessage	()Ljava/lang/String;
    //   367: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   370: goto -14 -> 356
    //   373: astore 7
    //   375: goto -39 -> 336
    //   378: astore 9
  ...
  public static int getNumCores()
  {
    ...
    try
    {
      ...
      sNumOfCores = arrayOfFile.length;
  ...
  public static int getOpenGLSupportVersion(Context paramContext)
  {
    ...
    try
    {
      ...
      sOpenGLVersion = paramContext.getDeviceConfigurationInfo().reqGlEsVersion;
    }
    catch (Throwable paramContext)
    {
      for (;;)
  ...
  public static int getScreenHeight(Context paramContext)
  {
    ...
    try
    {
      sScreenHeight = paramContext.getResources().getDisplayMetrics().heightPixels;
      return sScreenHeight;
    }
    catch (Throwable paramContext)
    {
  ...
  public static int getScreenWidth(Context paramContext)
  {
    ...
    try
    {
      sScreenWidth = paramContext.getResources().getDisplayMetrics().widthPixels;
      return sScreenWidth;
    }
    catch (Throwable paramContext)
    {
  ...
  private static String getWlanName()
  {
    try
    {
      if (sGetWlanMethod == null) {
        sGetWlanMethod = Class.forName("android.os.SystemProperties").getMethod("get", new Class[] { String.class, String.class });
      }
      String str = (String)sGetWlanMethod.invoke(null, new Object[] { "wifi.interface", "wlan0" });
      return str;
    }
  ...
  public static void initAudioBestSettings(Context paramContext)
  {
    ...
    //   3: aload_0
    //   4: ifnull +11 -> 15
    //   7: getstatic 110	com/tencent/thumbplayer/core/common/TPSystemInfo:sAudioBestSampleRate	I
    //   10: istore_1
    //   11: iload_1
    //   12: ifle +7 -> 19
    //   15: ldc 2
    //   17: monitorexit
    //   18: return
    //   19: getstatic 378	android/os/Build$VERSION:SDK_INT	I
    //   22: bipush 17
    //   24: if_icmplt -9 -> 15
    //   27: aload_0
    //   28: ldc_w 788
    //   31: invokevirtual 636	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   34: checkcast 790	android/media/AudioManager
    //   37: astore_2
    //   38: aload_2
    //   39: ldc_w 792
    //   42: invokevirtual 796	android/media/AudioManager:getProperty	(Ljava/lang/String;)Ljava/lang/String;
    //   45: astore_0
    //   46: aload_2
    //   47: ldc_w 798
    //   50: invokevirtual 796	android/media/AudioManager:getProperty	(Ljava/lang/String;)Ljava/lang/String;
    //   53: astore_2
    //   54: aload_0
    //   55: invokestatic 801	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   58: putstatic 110	com/tencent/thumbplayer/core/common/TPSystemInfo:sAudioBestSampleRate	I
    //   61: aload_2
    //   62: invokestatic 801	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   65: putstatic 112	com/tencent/thumbplayer/core/common/TPSystemInfo:sAudioBestFramesPerBust	I
    //   68: goto -53 -> 15
    //   71: astore_0
    //   72: iconst_4
    //   73: aload_0
    //   74: invokevirtual 802	java/lang/NumberFormatException:getMessage	()Ljava/lang/String;
    //   77: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   80: goto -65 -> 15
    //   83: astore_0
    //   84: ldc 2
    //   86: monitorexit
  ...
  private static void parseCpuInfoLine(String paramString)
  {
    ...
    if (paramString.startsWith("Processor"))
    {
      ...
      if (i > 1)
      {
        sProcessorName = paramString.substring(i + 1, paramString.length());
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              } while (sCpuArchitecture != 0);
              i = paramString.indexOf(':');
            } while (i <= 1);
            paramString = paramString.substring(i + 1, paramString.length()).trim();
            if ((paramString.length() > 0) && (paramString.length() < 2))
            {
              sCpuArchitecture = (int)Long.parseLong(paramString);
              return;
            }
          } while (paramString.length() <= 1);
          sCpuArchitecture = (int)Long.parseLong(paramString.substring(0, 1));
          return;
        ...
        sFeature = paramString.substring(i + 1, paramString.length()).trim();
        return;
      } while (!paramString.startsWith("Hardware"));
      i = paramString.indexOf(':');
    } while (i <= 1);
    sCpuHardware = paramString.substring(i + 1, paramString.length()).trim().replace(" ", "");
    ...
    throws java.io.FileNotFoundException
  {
    ...
    //   3: aconst_null
    //   4: astore 5
    //   6: new 571	java/io/BufferedReader
    //   9: dup
    //   10: new 851	java/io/FileReader
    //   13: dup
    //   14: aload_0
    //   15: invokespecial 854	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   18: invokespecial 574	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   21: astore_3
    //   22: aload_3
    //   23: astore 4
    //   25: aload_0
    //   26: invokevirtual 856	java/io/File:length	()J
    //   29: lstore_1
    //   30: lload_1
    //   31: ldc2_w 857
    //   34: lcmp
    ...
    //   43: ifnull +11 -> 54
    //   46: aload_3
    //   47: invokevirtual 581	java/io/BufferedReader:close	()V
    //   50: aload 5
    //   52: astore 4
    //   54: aload 4
    //   56: areturn
    ...
    //   58: astore 4
    //   60: aload_0
    //   61: invokevirtual 856	java/io/File:length	()J
    //   64: l2i
    //   65: newarray char
    //   67: astore 7
    //   69: aload_3
    ...
    //   75: iconst_0
    //   76: aload_0
    //   77: invokevirtual 856	java/io/File:length	()J
    //   80: l2i
    //   81: invokevirtual 862	java/io/BufferedReader:read	([CII)I
    //   84: ifle -46 -> 38
    //   87: aload_3
    //   88: astore 4
    //   90: new 116	java/lang/String
    //   93: dup
    //   94: aload 7
    //   96: invokespecial 865	java/lang/String:<init>	([C)V
    //   99: astore 5
    //   101: goto -63 -> 38
    //   104: astore_0
    //   105: aload_0
    //   106: invokevirtual 756	java/lang/Throwable:printStackTrace	()V
    //   109: aload 5
    //   111: areturn
    //   112: astore_0
    //   113: aconst_null
    ...
    //   123: ifnull +8 -> 131
    //   126: aload 4
    //   128: invokevirtual 581	java/io/BufferedReader:close	()V
    //   131: aload_0
    //   132: athrow
    //   133: astore_3
    //   134: aconst_null
    //   135: astore_0
    //   136: aload_3
    //   137: invokevirtual 756	java/lang/Throwable:printStackTrace	()V
    //   140: aload 6
    //   142: astore 4
    //   144: aload_0
    //   145: ifnull -91 -> 54
    //   148: aload_0
    //   149: invokevirtual 581	java/io/BufferedReader:close	()V
    //   152: aconst_null
    //   153: areturn
    //   154: astore_0
    //   155: aload_0
    //   156: invokevirtual 756	java/lang/Throwable:printStackTrace	()V
    //   159: aconst_null
    //   160: areturn
    //   161: astore_3
    //   162: aload_3
    //   163: invokevirtual 756	java/lang/Throwable:printStackTrace	()V
    //   166: goto -35 -> 131
    //   169: astore_0
    //   170: aconst_null
    //   171: astore 4
  ...
  public static String readSystemStat()
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: new 869	java/io/RandomAccessFile
    //   5: dup
    //   6: ldc_w 871
    //   9: ldc_w 873
    //   12: invokespecial 876	java/io/RandomAccessFile:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   15: astore_1
    //   16: aload_1
    //   17: astore_0
    //   18: aload_1
    //   19: invokevirtual 877	java/io/RandomAccessFile:readLine	()Ljava/lang/String;
    //   22: astore_2
    //   23: aload_2
    //   24: astore_0
    //   25: aload_0
    ...
    //   28: ifnull +9 -> 37
    //   31: aload_1
    //   32: invokevirtual 878	java/io/RandomAccessFile:close	()V
    //   35: aload_0
    //   36: astore_2
    //   37: aload_2
    //   38: areturn
    ...
    //   40: iconst_4
    //   41: aload_1
    //   42: invokevirtual 451	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   45: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   48: aload_0
    //   49: areturn
    //   50: astore_2
    //   51: aconst_null
    ...
    //   54: astore_0
    //   55: aload_2
    //   56: invokevirtual 756	java/lang/Throwable:printStackTrace	()V
    //   59: aload_3
    //   60: astore_2
    //   61: aload_1
    //   62: ifnull -25 -> 37
    //   65: aload_1
    //   66: invokevirtual 878	java/io/RandomAccessFile:close	()V
    //   69: aconst_null
    //   70: areturn
    //   71: astore_0
    //   72: iconst_4
    //   73: aload_0
    //   74: invokevirtual 451	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   77: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   80: aconst_null
    //   81: areturn
    //   82: astore_1
    ...
    //   86: ifnull +7 -> 93
    //   89: aload_0
    //   90: invokevirtual 878	java/io/RandomAccessFile:close	()V
    //   93: aload_1
    //   94: athrow
    //   95: astore_0
    //   96: iconst_4
    //   97: aload_0
    //   98: invokevirtual 451	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   101: invokestatic 457	com/tencent/thumbplayer/core/common/TPNativeLog:printLog	(ILjava/lang/String;)V
    //   104: goto -11 -> 93
    //   107: astore_1
    //   108: goto -23 -> 85
  ...
  {
    sDeviceMacAddr = paramString1;
    sDeviceID = paramString2;
    sDeviceIMEI = paramString3;
    sDeviceIMSI = paramString4;
  }
