...
public final class PicSearchSvr
{
    ...
    extends MessageMicro<ReqBody>
  {
    ...
    static
    {
      ...
      ByteStringMicro localByteStringMicro2 = ByteStringMicro.EMPTY;
      ByteStringMicro localByteStringMicro3 = ByteStringMicro.EMPTY;
      __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 40, 50, 58, 64, 72 }, new String[] { "bytes_session_id", "uint64_src_uin", "uint32_src_term", "uint32_aio_type", "uint64_to_uin", "bytes_user_text", "bytes_key_word", "uin32_gender", "uint32_age" }, new Object[] { localByteStringMicro1, Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0), Long.valueOf(0L), localByteStringMicro2, localByteStringMicro3, Integer.valueOf(0), Integer.valueOf(0) }, ReqBody.class);
    }
  }
 ...
 * Qualified Name:     com.tencent.pb.emosm.PicSearchSvr
