...
public class ReaderEngine
{
  ...
  private boolean canUpdateSkipWifi(Context paramContext)
  {
    boolean bool = true;
    try
    {
      paramContext = paramContext.getSharedPreferences("tbs_file", 0);
      if (paramContext.contains("is_enable_update")) {
        bool = paramContext.getBoolean("is_enable_update", true);
      }
      return bool;
    }
  ...
  private boolean loadFileEngine(TBSOneManager paramTBSOneManager, com.tencent.tbs.one.TBSOneComponent paramTBSOneComponent)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 67	com/tencent/tbs/reader/ReaderEngine:mReaderEntry	Lcom/tencent/tbs/reader/ITbsReaderEntry;
    //   4: ifnull +5 -> 9
    //   7: iconst_1
    //   8: ireturn
    //   9: aload_2
    ...
    //   30: putfield 78	com/tencent/tbs/reader/ReaderEngine:mVersionName	Ljava/lang/String;
    //   33: aload_0
    //   34: aload_2
    //   35: invokeinterface 82 1 0
    //   40: putfield 84	com/tencent/tbs/reader/ReaderEngine:mVersionCode	I
    //   43: aload 4
    //   45: instanceof 86
    //   48: ifeq +133 -> 181
    //   51: aload 4
    //   53: checkcast 86	com/tencent/tbs/reader/ITbsReaderEntry
    //   56: astore_2
    //   57: aload_0
    //   58: aload_2
    //   59: putfield 67	com/tencent/tbs/reader/ReaderEngine:mReaderEntry	Lcom/tencent/tbs/reader/ITbsReaderEntry;
    //   62: aload_2
    ...
    //   75: dup
    //   76: invokespecial 92	java/lang/StringBuilder:<init>	()V
    //   79: ldc 94
    //   81: invokevirtual 98	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   84: getstatic 104	com/tencent/tbs/tbsfile/BuildConfig:SDK_CAN_AUTO_UPDATE	Ljava/lang/Boolean;
    //   87: invokevirtual 107	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   90: invokevirtual 110	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   93: invokestatic 116	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   96: pop
    //   97: getstatic 104	com/tencent/tbs/tbsfile/BuildConfig:SDK_CAN_AUTO_UPDATE	Ljava/lang/Boolean;
    //   100: invokevirtual 122	java/lang/Boolean:booleanValue	()Z
    //   103: ifeq +12 -> 115
    //   106: aload_2
    //   107: ifnonnull +30 -> 137
    //   110: aload_1
    //   111: iconst_1
    //   112: invokevirtual 128	com/tencent/tbs/one/TBSOneManager:setAutoUpdateEnabled	(Z)V
    //   115: iload_3
    //   116: ireturn
    //   117: astore 4
    //   119: aconst_null
    ...
    //   127: ldc 129
    //   129: aload 4
    //   131: invokevirtual 133	com/tencent/tbs/reader/ReaderEngine:report	(ILjava/lang/String;Ljava/lang/Throwable;)V
    //   134: goto -64 -> 70
    //   137: aload_1
    //   138: aload_2
    //   139: invokeinterface 136 1 0
    //   144: invokevirtual 128	com/tencent/tbs/one/TBSOneManager:setAutoUpdateEnabled	(Z)V
    //   147: goto -32 -> 115
    //   150: astore_2
    //   151: aload_2
    //   152: invokevirtual 137	java/lang/Throwable:printStackTrace	()V
    //   155: aload_1
    //   156: iconst_1
    //   157: invokevirtual 128	com/tencent/tbs/one/TBSOneManager:setAutoUpdateEnabled	(Z)V
    //   160: goto -45 -> 115
    //   163: astore_1
    //   164: goto -49 -> 115
    //   167: astore 4
  ...
  public boolean fileEnginePreLoad(Context paramContext, TBSOneCallback paramTBSOneCallback, boolean paramBoolean)
  {
    ...
    for (boolean bool1 = false;; bool1 = bool2)
    {
      try
      {
        bool2 = localTBSOneManager.isComponentInstalled("file");
        bool1 = bool2;
        if (!bool2)
        {
          bool1 = bool2;
          ...
          bool1 = bool2;
          if (canUpdateSkipWifi(paramContext))
          {
            bool1 = bool2;
            localTBSOneManager.configure("is_ignore_update_wifi_network", Boolean.valueOf(true));
          }
          bool1 = bool2;
          localTBSOneManager.installComponent("file", localBundle, paramTBSOneCallback);
          bool1 = bool2;
        }
      }
      ...
      try
      {
        localTBSOneManager.setAutoUpdateEnabled(true);
        return bool1;
      }
      catch (Throwable paramContext) {}
      bool1 = bool2;
  ...
  public boolean initReaderEntry(Context paramContext)
  {
    ...
    try
    {
      ...
      paramContext = localTBSOneManager.loadComponentSync("file", localBundle, 5000L);
    }
    catch (Throwable paramContext)
    {
      for (;;)
