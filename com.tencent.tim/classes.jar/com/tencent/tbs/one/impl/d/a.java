  ...
  extends com.tencent.tbs.one.impl.a.a<Integer>
{
  ...
  private boolean a(HttpURLConnection paramHttpURLConnection, String paramString1, String paramString2, Map<String, String> paramMap, byte[] paramArrayOfByte)
  {
    ...
    //   0: aload_0
    //   1: bipush 10
    //   3: invokevirtual 62	com/tencent/tbs/one/impl/d/a:a	(I)V
    //   6: aload 4
    //   8: ifnull +66 -> 74
    //   11: aload 4
    ...
    //   55: checkcast 192	java/lang/String
    //   58: aload 7
    //   60: invokeinterface 265 1 0
    //   65: checkcast 192	java/lang/String
    //   68: invokevirtual 91	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   71: goto -46 -> 25
    //   74: aconst_null
    //   75: astore 7
    //   77: aload_1
    ...
    //   128: checkcast 192	java/lang/String
    //   131: astore 4
    //   133: aload_1
    //   134: astore 6
    //   136: aload 4
    ...
    //   194: astore 6
    //   196: aload 6
    //   198: invokestatic 210	com/tencent/tbs/one/impl/a/c:a	(Ljava/io/Closeable;)V
    //   201: iconst_1
    //   202: ireturn
    //   203: astore 4
    //   205: aconst_null
    ...
    //   217: dup
    //   218: ldc_w 312
    //   221: invokespecial 96	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   224: aload_3
    ...
    //   241: aload 4
    //   243: invokevirtual 107	com/tencent/tbs/one/impl/d/a:a	(ILjava/lang/String;Ljava/lang/Throwable;)V
    //   246: aload_1
    //   247: invokestatic 210	com/tencent/tbs/one/impl/a/c:a	(Ljava/io/Closeable;)V
    //   250: iconst_0
    //   251: ireturn
    //   252: astore_3
    //   253: aconst_null
    ...
    //   258: aload_0
    //   259: aload_2
    //   260: invokespecial 160	com/tencent/tbs/one/impl/d/a:b	(Ljava/lang/String;)Z
    //   263: ifne +31 -> 294
    //   266: aload_1
    //   267: astore 6
    //   269: aload_0
    //   270: sipush 205
    //   273: new 93	java/lang/StringBuilder
    //   276: dup
    //   277: ldc_w 316
    //   280: invokespecial 96	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   283: aload_2
    ...
    //   290: aload_3
    //   291: invokevirtual 107	com/tencent/tbs/one/impl/d/a:a	(ILjava/lang/String;Ljava/lang/Throwable;)V
    //   294: aload_1
    //   295: invokestatic 210	com/tencent/tbs/one/impl/a/c:a	(Ljava/io/Closeable;)V
    //   298: iconst_0
    //   299: ireturn
    //   300: astore_1
    //   301: aconst_null
    //   302: astore 6
    //   304: aload 6
    //   306: invokestatic 210	com/tencent/tbs/one/impl/a/c:a	(Ljava/io/Closeable;)V
    //   309: aload_1
    //   310: athrow
    //   311: astore_1
    //   312: goto -8 -> 304
