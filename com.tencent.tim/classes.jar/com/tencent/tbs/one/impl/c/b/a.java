  ...
  extends LayoutInflater
{
    ...
    throws ClassNotFoundException, InflateException
  {
    ...
    //   13: iconst_0
    //   14: aload_0
    //   15: invokevirtual 114	com/tencent/tbs/one/impl/c/b/a:getContext	()Landroid/content/Context;
    //   18: aastore
    //   19: aload_0
    //   20: getfield 47	com/tencent/tbs/one/impl/c/b/a:e	Ljava/util/HashMap;
    //   23: aload_1
    //   24: invokevirtual 118	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   27: checkcast 120	java/lang/reflect/Constructor
    //   30: astore 6
    //   32: aconst_null
    //   33: astore 7
    //   35: aload_0
    //   36: invokevirtual 124	com/tencent/tbs/one/impl/c/b/a:getFilter	()Landroid/view/LayoutInflater$Filter;
    //   39: astore 9
    //   41: aload 6
    //   43: ifnonnull +118 -> 161
    //   46: aload_0
    //   47: aload_1
    //   48: invokespecial 126	com/tencent/tbs/one/impl/c/b/a:a	(Ljava/lang/String;)Ljava/lang/Class;
    //   51: astore 4
    //   53: aload 9
    //   55: ifnull +25 -> 80
    //   58: aload 4
    ...
    //   63: aload 9
    //   65: aload 4
    //   67: invokeinterface 132 2 0
    //   72: ifne +8 -> 80
    //   75: aload_1
    //   76: aload_2
    //   77: invokestatic 135	com/tencent/tbs/one/impl/c/b/a:c	(Ljava/lang/String;Landroid/util/AttributeSet;)V
    //   80: aload 4
    //   82: getstatic 32	com/tencent/tbs/one/impl/c/b/a:c	[Ljava/lang/Class;
    //   85: invokevirtual 139	java/lang/Class:getConstructor	([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    //   88: astore 5
    //   90: aload 5
    //   92: iconst_1
    //   93: invokevirtual 143	java/lang/reflect/Constructor:setAccessible	(Z)V
    //   96: aload_0
    //   97: getfield 47	com/tencent/tbs/one/impl/c/b/a:e	Ljava/util/HashMap;
    //   100: aload_1
    //   101: aload 5
    //   103: invokevirtual 147	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   106: pop
    //   107: aload_0
    ...
    //   118: aload 5
    //   120: aload 6
    //   122: invokevirtual 151	java/lang/reflect/Constructor:newInstance	([Ljava/lang/Object;)Ljava/lang/Object;
    //   125: checkcast 64	android/view/View
    //   128: astore 5
    //   130: getstatic 87	android/os/Build$VERSION:SDK_INT	I
    //   133: bipush 16
    ...
    //   143: ifeq +12 -> 155
    //   146: aload 5
    //   148: checkcast 153	android/view/ViewStub
    //   151: aload_0
    //   152: invokevirtual 157	android/view/ViewStub:setLayoutInflater	(Landroid/view/LayoutInflater;)V
    //   155: aload 8
    //   157: monitorexit
    //   158: aload 5
    //   160: areturn
    ...
    //   171: ifnull -64 -> 107
    //   174: aload_0
    //   175: getfield 159	com/tencent/tbs/one/impl/c/b/a:f	Ljava/util/HashMap;
    //   178: aload_1
    //   179: invokevirtual 118	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   182: checkcast 161	java/lang/Boolean
    //   185: astore 10
    //   187: aload 10
    //   189: ifnonnull +63 -> 252
    //   192: aload_0
    //   193: aload_1
    //   194: invokespecial 126	com/tencent/tbs/one/impl/c/b/a:a	(Ljava/lang/String;)Ljava/lang/Class;
    //   197: astore 4
    //   199: aload 4
    //   201: ifnull +46 -> 247
    //   204: aload 9
    ...
    //   217: istore_3
    //   218: aload_0
    //   219: getfield 159	com/tencent/tbs/one/impl/c/b/a:f	Ljava/util/HashMap;
    //   222: aload_1
    //   223: iload_3
    //   224: invokestatic 165	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   227: invokevirtual 147	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   230: pop
    //   231: iload_3
    //   232: ifne +8 -> 240
    //   235: aload_1
    //   236: aload_2
    //   237: invokestatic 135	com/tencent/tbs/one/impl/c/b/a:c	(Ljava/lang/String;Landroid/util/AttributeSet;)V
    //   240: aload 6
    //   242: astore 5
    //   244: goto -137 -> 107
    //   247: iconst_0
    ...
    //   258: astore 4
    //   260: aload 10
    //   262: getstatic 169	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   265: invokevirtual 173	java/lang/Boolean:equals	(Ljava/lang/Object;)Z
    //   268: ifeq -161 -> 107
    //   271: aload_1
    //   272: aload_2
    //   273: invokestatic 135	com/tencent/tbs/one/impl/c/b/a:c	(Ljava/lang/String;Landroid/util/AttributeSet;)V
    //   276: aload 6
    //   278: astore 5
    //   280: aload 7
    //   282: astore 4
    //   284: goto -177 -> 107
    //   287: astore 4
    //   289: new 106	android/view/InflateException
    //   292: dup
    //   293: new 175	java/lang/StringBuilder
    //   296: dup
    //   297: invokespecial 176	java/lang/StringBuilder:<init>	()V
    //   300: aload_2
    //   301: invokeinterface 180 1 0
    //   306: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   309: ldc 186
    //   311: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   314: aload_1
    //   315: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   318: invokevirtual 189	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   321: aload 4
    //   323: invokespecial 192	android/view/InflateException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   326: astore_1
    //   327: aload_1
    //   328: getstatic 24	com/tencent/tbs/one/impl/c/b/a:b	[Ljava/lang/StackTraceElement;
    //   331: invokevirtual 196	android/view/InflateException:setStackTrace	([Ljava/lang/StackTraceElement;)V
    //   334: aload_1
    //   335: athrow
    //   336: astore_1
    //   337: aload 8
    ...
    //   341: athrow
    //   342: astore 4
    //   344: new 106	android/view/InflateException
    //   347: dup
    //   348: new 175	java/lang/StringBuilder
    //   351: dup
    //   352: invokespecial 176	java/lang/StringBuilder:<init>	()V
    //   355: aload_2
    //   356: invokeinterface 180 1 0
    //   361: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   364: ldc 198
    ...
    //   373: invokevirtual 189	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   376: invokespecial 201	android/view/InflateException:<init>	(Ljava/lang/String;)V
    //   379: astore_1
    //   380: aload_1
    //   381: getstatic 24	com/tencent/tbs/one/impl/c/b/a:b	[Ljava/lang/StackTraceElement;
    //   384: invokevirtual 196	android/view/InflateException:setStackTrace	([Ljava/lang/StackTraceElement;)V
    //   387: aload_1
    //   388: athrow
    //   389: astore_1
    //   390: aload_1
    //   391: athrow
    //   392: new 175	java/lang/StringBuilder
    //   395: dup
    //   396: invokespecial 176	java/lang/StringBuilder:<init>	()V
    //   399: aload_2
    //   400: invokeinterface 180 1 0
    //   405: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   408: ldc 186
    //   410: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   413: astore_2
    //   414: aload_1
    //   415: ifnonnull +31 -> 446
    //   418: ldc 203
    //   420: astore_1
    //   421: new 106	android/view/InflateException
    //   424: dup
    //   425: aload_2
    //   426: aload_1
    //   427: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   430: invokevirtual 189	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   433: invokespecial 201	android/view/InflateException:<init>	(Ljava/lang/String;)V
    //   436: astore_1
    //   437: aload_1
    //   438: getstatic 24	com/tencent/tbs/one/impl/c/b/a:b	[Ljava/lang/StackTraceElement;
    //   441: invokevirtual 196	android/view/InflateException:setStackTrace	([Ljava/lang/StackTraceElement;)V
    //   444: aload_1
    //   445: athrow
    //   446: aload_1
    //   447: invokevirtual 206	java/lang/Class:getName	()Ljava/lang/String;
    //   450: astore_1
    //   451: goto -30 -> 421
    //   454: astore_1
    //   455: aload 4
  ...
  public final View a(String paramString, AttributeSet paramAttributeSet)
  {
    ...
    //   7: aload_1
    //   8: bipush 46
    //   10: invokevirtual 216	java/lang/String:indexOf	(I)I
    //   13: if_icmpeq +10 -> 23
    //   16: aload_0
    //   17: aload_1
    //   18: aload_2
    //   19: invokespecial 218	com/tencent/tbs/one/impl/c/b/a:b	(Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    //   22: astore_3
    //   23: aload_3
    //   24: astore 4
    //   26: aload_3
    ...
    //   31: aload_1
    //   32: bipush 46
    //   34: invokevirtual 216	java/lang/String:indexOf	(I)I
    //   37: if_icmpne +38 -> 75
    //   40: aload_0
    //   41: aload_1
    //   42: aload_2
    //   43: invokevirtual 221	com/tencent/tbs/one/impl/c/b/a:onCreateView	(Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    //   46: astore 4
    //   48: aload 4
    //   50: areturn
    //   51: astore_3
    ...
    //   64: aload_3
    //   65: aastore
    //   66: invokestatic 228	com/tencent/tbs/one/impl/a/f:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   69: aload 4
    //   71: astore_3
    //   72: goto -49 -> 23
    //   75: aload_0
    ...
    //   77: aconst_null
    //   78: aload_2
    //   79: invokevirtual 232	com/tencent/tbs/one/impl/c/b/a:createView	(Ljava/lang/String;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    //   82: astore_2
    //   83: aload_2
    //   84: areturn
    //   85: astore_2
    ...
    //   98: aload_2
    //   99: aastore
    //   100: invokestatic 228	com/tencent/tbs/one/impl/a/f:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   103: aload_3
    //   104: areturn
    // Local variable table:
    //   start	length	slot	name	signature
