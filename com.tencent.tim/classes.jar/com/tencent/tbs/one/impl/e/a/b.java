  ...
  implements a.a
{
  ...
  public final void a()
  {
    ...
    //   23: aload 4
    //   25: aload 5
    //   27: invokestatic 161	com/tencent/tbs/one/impl/common/a:a	(Landroid/content/Context;Ljava/lang/String;)Lcom/tencent/tbs/one/optional/TBSOneRuntimeExtension;
    //   30: astore_3
    //   31: aload_3
    //   32: ifnull +50 -> 82
    //   35: aload_3
  ...
  public final void a(int paramInt, Map<String, List<String>> paramMap, InputStream paramInputStream)
  {
    ...
    paramMap = com.tencent.tbs.one.impl.common.a.a(localContext, str);
    if (paramMap != null)
    {
