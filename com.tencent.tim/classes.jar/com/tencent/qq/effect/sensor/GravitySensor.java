  ...
  implements SensorEventListener
{
  ...
  public void addListener(GravitySensorListener paramGravitySensorListener)
  {
    resume();
    try
    {
  ...
  public void onSensorChanged(SensorEvent paramSensorEvent)
  {
    ...
    {
      GravitySensorListener localGravitySensorListener = (GravitySensorListener)((WeakReference)localIterator.next()).get();
  ...
  public void removeListener(GravitySensorListener paramGravitySensorListener)
  {
    resume();
    try
    {
  ...
  public static abstract interface GravitySensorListener
  {
