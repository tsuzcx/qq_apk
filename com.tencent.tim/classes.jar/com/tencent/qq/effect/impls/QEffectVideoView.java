  ...
  implements TextureView.SurfaceTextureListener, IQEffect<QEffectData, String>, GravitySensor.GravitySensorListener
{
  ...
  public void complete(String paramString)
  {
    ...
    {
      this.mPlayThread = new PlayerVideo(null);
    ...
    extends Thread
  {
    ...
    public void run()
    {
      try
      {
        File localFile = new File(QEffectVideoView.this.mFilePath);
        if (!localFile.exists()) {
          return;
        }
        QEffectVideoView.access$202(QEffectVideoView.this, new MediaPlayer());
        QEffectVideoView.this.mMediaPlayer.setDataSource(localFile.getAbsolutePath());
        ...
        QEffectVideoView.this.mMediaPlayer.setOnPreparedListener(new QEffectVideoView.PlayerVideo.1(this));
