  ...
  implements aroa.a
{
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            if (paramDialogInterface != null) {
              this.mResultListener.WC(paramDialogInterface.toString());
            }
            if ((paramInt2 == 2) || (paramInt2 == 3) || (paramInt2 == 6) || (paramInt2 == 8))
            {
              ...
              if (this.mApp != null)
              {
                ...
                aqmj.i(this.mApp.getApp(), this.mApp.getCurrentAccountUin(), false);
              }
  ...
  public void exec(String paramString, arny paramarny)
  {
    ...
    for (;;)
    {
      try
      {
        for (;;)
        {
          ...
          if (paramString.has("toast_config"))
          {
            ...
            if (paramarny != null) {
              this.mResultListener = paramarny;
            }
            paramarny = DocumentBuilderFactory.newInstance();
            try
            {
              localObject1 = paramarny.newDocumentBuilder().parse(new ByteArrayInputStream(paramString.getBytes())).getDocumentElement();
              ...
              paramarny = paramString.getAttribute("text");
              ...
              new Handler(Looper.getMainLooper()).post(new MSFIntChkStrike.4(this, str1, str2, paramString, (DialogInterface.OnClickListener)localObject1, (String)localObject3, paramarny, local3));
              return;
            }
        ...
        for (;;)
        {
          ...
          catch (Exception localException1)
          {
            try
            {
              ...
              if (paramString != null) {
                paramarny.WC(paramString.toString());
              }
      ...
      catch (Exception paramString)
      {
        try
        {
          for (;;)
          {
            ...
            continue;
            if (!aqiz.r(localContext, paramString, this.mApp.getCurrentAccountUin())) {
              break;
            }
            i = 13;
          }
      ...
      if (!aqiz.isAppInstalled(localContext, paramString))
      {
        i = 11;
        if (paramarny == null) {
          break;
