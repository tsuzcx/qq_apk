  ...
  extends Entity
{
  ...
  public String job = "";
  public List<asia> mCompanyShowCaseInfos;
  public List<asib> mGroupItems;
  public List<asic> mPubAccItems;
  public String mail = "";
      ...
      if (this.infoByte != null)
      {
        ...
        if (localExternalInfo.rpt_msg_pubacc_item.has())
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            this.mPubAccItems.add(new asic((mobileqq_qidian.PubAccItem)localObject2));
          }
        }
      }
      else
    ...
    for (;;)
    {
      if (localException.rpt_msg_group_item.has())
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          this.mGroupItems.add(new asib((mobileqq_qidian.GroupItem)localObject2));
        }
      }
      if (localException.rpt_msg_company_show_case_info.has())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          this.mCompanyShowCaseInfos.add(new asia((mobileqq_qidian.CompanyShowCaseInfo)localObject1));
        }
      }
    }
  }
  ...
  public List<asia> getCompanyShowCaseInfos()
  {
  ...
  public List<asib> getGroupItems()
  {
  ...
  public List<asic> getPublicAccountItems()
  {
  ...
  public mobileqq_qidian.ExternalInfo to()
  {
    ...
    if (this.mPubAccItems != null)
    {
      ...
      while (localIterator.hasNext())
      {
        localObject = (asic)localIterator.next();
        localExternalInfo.rpt_msg_pubacc_item.add(((asic)localObject).a());
      }
    }
    if (this.mGroupItems != null)
    {
      ...
      while (localIterator.hasNext())
      {
        localObject = (asib)localIterator.next();
        localExternalInfo.rpt_msg_group_item.add(((asib)localObject).a());
      }
    }
    if (this.mCompanyShowCaseInfos != null)
    {
      ...
      while (localIterator.hasNext())
      {
        localObject = (asia)localIterator.next();
        localExternalInfo.rpt_msg_company_show_case_info.add(((asia)localObject).a());
      }
    }
