...
public class QGReporter
{
  ...
  public static void setReporter(QGReporterImpl paramQGReporterImpl)
  {
    sReporterInstance = paramQGReporterImpl;
  }
  
  public static abstract interface QGReporterImpl
  {
    public abstract void reportEvent(String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2, String paramString5, String paramString6, String paramString7, String paramString8);
  }
}
