...
public class DeviceHeadMgr
{
  ...
  {
    return aroi.a().getContext().getSharedPreferences("sd_http_lastmodify", 0).getString(paramString, "");
  }
  ...
  private void init()
  {
    ...
    try
    {
      localSchemeRegistry.register(new Scheme("https", new aoog(DeviceHeadMgr.class.getSimpleName()), 443));
      label56:
      ...
      jqo.dn(this.mStrCachePath);
      if (aqfo.isExistSDCard()) {}
      for (this.mStrCachePath = acbn.bmH;; this.mStrCachePath = "/data/data/com.tencent.tim/files/head/_dhd/")
      {
  ...
  {
    SharedPreferences.Editor localEditor = aroi.a().getContext().getSharedPreferences("sd_http_lastmodify", 0).edit();
  ...
  public void downloadImage(String arg1, String paramString2, int paramInt, boolean paramBoolean)
  {
    ...
    //   2: ifeq +38 -> 40
    //   5: iload_3
    //   6: invokestatic 238	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   9: invokestatic 240	com/tencent/device/DeviceHeadMgr:getLogoIconUrl	(Ljava/lang/String;)Ljava/lang/String;
    //   12: astore_1
    ...
    //   27: iload_3
    //   28: invokevirtual 243	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   31: ldc 245
    ...
    //   39: astore_2
    //   40: invokestatic 251	java/lang/System:currentTimeMillis	()J
    //   43: lstore 7
    //   45: new 47	java/io/File
    //   48: dup
    //   49: aload_2
    //   50: invokespecial 252	java/io/File:<init>	(Ljava/lang/String;)V
    //   53: astore 12
    //   55: aload 12
    //   57: ifnull +442 -> 499
    //   60: aload 12
    //   62: invokevirtual 255	java/io/File:exists	()Z
    //   65: ifeq +434 -> 499
    //   68: iconst_1
    //   69: istore 5
    //   71: aload 12
    //   73: invokevirtual 258	java/io/File:getParentFile	()Ljava/io/File;
    //   76: astore_2
    //   77: aload_2
    //   78: ifnull +15 -> 93
    //   81: aload_2
    //   82: invokevirtual 255	java/io/File:exists	()Z
    //   85: ifne +8 -> 93
    //   88: aload_2
    //   89: invokevirtual 261	java/io/File:mkdirs	()Z
    //   92: pop
    //   93: ldc 73
    //   95: astore_2
    //   96: new 263	org/apache/http/client/methods/HttpGet
    //   99: dup
    //   100: aload_1
    //   101: invokespecial 264	org/apache/http/client/methods/HttpGet:<init>	(Ljava/lang/String;)V
    //   104: astore 11
    //   106: iload 5
    //   108: ifeq +21 -> 129
    //   111: aload_0
    //   112: aload_1
    //   113: invokestatic 269	com/tencent/image/Utils:Crc64String	(Ljava/lang/String;)Ljava/lang/String;
    //   116: invokespecial 271	com/tencent/device/DeviceHeadMgr:getLastModified	(Ljava/lang/String;)Ljava/lang/String;
    //   119: astore_2
    //   120: aload 11
    //   122: ldc_w 273
    //   125: aload_2
    //   126: invokevirtual 276	org/apache/http/client/methods/HttpGet:addHeader	(Ljava/lang/String;Ljava/lang/String;)V
    //   129: invokestatic 281	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   132: ifeq +29 -> 161
    //   135: ldc 14
    //   137: iconst_2
    ...
    //   158: invokestatic 287	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   161: aload_0
    //   162: getfield 190	com/tencent/device/DeviceHeadMgr:sHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   165: aload 11
    //   167: invokevirtual 291	org/apache/http/impl/client/DefaultHttpClient:execute	(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;
    //   170: astore_2
    //   171: aload_2
    //   172: invokeinterface 297 1 0
    //   177: invokeinterface 302 1 0
    //   182: istore 6
    //   184: invokestatic 281	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   187: ifeq +30 -> 217
    //   190: ldc 14
    //   192: iconst_2
    ...
    //   206: iload 6
    //   208: invokevirtual 243	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   211: invokevirtual 60	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   214: invokestatic 287	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   217: aload_2
    //   218: invokeinterface 308 1 0
    //   223: astore 13
    //   225: iload 6
    //   227: sipush 200
    ...
    //   235: ifeq +9 -> 244
    //   238: aload 12
    //   240: invokevirtual 311	java/io/File:delete	()Z
    //   243: pop
    //   244: new 313	java/io/BufferedOutputStream
    //   247: dup
    //   248: new 315	java/io/FileOutputStream
    //   251: dup
    //   252: aload 12
    //   254: invokespecial 318	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   257: invokespecial 321	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   260: astore 14
    //   262: aload 13
    //   264: aload 14
    //   266: invokeinterface 326 2 0
    //   271: aload 14
    //   273: invokevirtual 331	java/io/OutputStream:flush	()V
    //   276: aload 12
    //   278: invokevirtual 333	java/io/File:length	()J
    //   281: lstore 9
    //   283: aload_2
    //   284: ldc_w 335
    //   287: invokeinterface 338 2 0
    //   292: ifeq +27 -> 319
    //   295: aload_2
    //   296: ldc_w 335
    //   299: invokeinterface 342 2 0
    //   304: invokeinterface 347 1 0
    //   309: astore_2
    //   310: aload_0
    //   311: aload_1
    //   312: invokestatic 269	com/tencent/image/Utils:Crc64String	(Ljava/lang/String;)Ljava/lang/String;
    //   315: aload_2
    //   316: invokespecial 349	com/tencent/device/DeviceHeadMgr:saveLastModified	(Ljava/lang/String;Ljava/lang/String;)V
    //   319: invokestatic 281	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   322: ifeq +55 -> 377
    //   325: ldc 14
    //   327: iconst_2
    ...
    //   341: invokestatic 251	java/lang/System:currentTimeMillis	()J
    //   344: lload 7
    //   346: lsub
    //   347: invokevirtual 354	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   350: ldc_w 356
    //   353: invokevirtual 55	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   356: lload 9
    //   358: invokevirtual 354	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   361: ldc_w 358
    ...
    //   374: invokestatic 361	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   377: iload 4
    //   379: ifeq +54 -> 433
    //   382: aload_0
    //   383: getfield 216	com/tencent/device/DeviceHeadMgr:mDeviceOriginalHeadMap	Ljava/util/HashMap;
    //   386: astore_1
    //   387: aload_1
    //   388: monitorenter
    //   389: aload_0
    //   390: getfield 216	com/tencent/device/DeviceHeadMgr:mDeviceOriginalHeadMap	Ljava/util/HashMap;
    //   393: iload_3
    //   394: invokestatic 366	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   397: invokevirtual 370	java/util/HashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   400: pop
    //   401: aload_1
    //   402: monitorexit
    //   403: aload 11
    //   405: invokevirtual 373	org/apache/http/client/methods/HttpGet:abort	()V
    //   408: return
    //   409: astore_2
    //   410: aload_1
    //   411: monitorexit
    ...
    //   414: astore_1
    //   415: aload_1
    //   416: invokevirtual 376	java/lang/Exception:printStackTrace	()V
    //   419: goto -16 -> 403
    //   422: astore_1
    //   423: aload_1
    //   424: invokevirtual 376	java/lang/Exception:printStackTrace	()V
    //   427: aload 11
    //   429: invokevirtual 373	org/apache/http/client/methods/HttpGet:abort	()V
    //   432: return
    //   433: aload_0
    //   434: getfield 209	com/tencent/device/DeviceHeadMgr:mDeviceHeadMap	Ljava/util/HashMap;
    //   437: astore_1
    //   438: aload_1
    //   439: monitorenter
    //   440: aload_0
    //   441: getfield 209	com/tencent/device/DeviceHeadMgr:mDeviceHeadMap	Ljava/util/HashMap;
    //   444: iload_3
    //   445: invokestatic 366	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   448: invokevirtual 370	java/util/HashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   451: pop
    //   452: aload_1
    //   453: monitorexit
    //   454: new 378	android/content/Intent
    //   457: dup
    //   458: ldc_w 380
    //   461: invokespecial 381	android/content/Intent:<init>	(Ljava/lang/String;)V
    //   464: astore_1
    //   465: aload_1
    //   466: ldc_w 383
    //   469: iload_3
    //   470: invokevirtual 387	android/content/Intent:putExtra	(Ljava/lang/String;I)Landroid/content/Intent;
    //   473: pop
    //   474: invokestatic 393	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   477: aload_1
    //   478: invokevirtual 397	com/tencent/common/app/BaseApplicationImpl:sendBroadcast	(Landroid/content/Intent;)V
    //   481: goto -78 -> 403
    //   484: astore_1
    //   485: aload 11
    //   487: invokevirtual 373	org/apache/http/client/methods/HttpGet:abort	()V
    //   490: aload_1
    //   491: athrow
    //   492: astore_2
    //   493: aload_1
  ...
  {
    paramString = ((syw)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(51)).a(Long.parseLong(paramString));
    if (paramString == null) {
  ...
  public Bitmap getDeviceHeadByPID(int paramInt)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)???))
    {
      ...
      try
      {
        ??? = BitmapFactory.decodeResource(BaseApplication.getContext().getResources(), 2130840079);
        return ???;
      }
    ...
    {
      Bitmap localBitmap1 = aqcu.decodeFile(str);
      ...
      for (;;)
      {
        synchronized (this.mDeviceHeadMap)
        {
          ...
          return aqcu.decodeResource(BaseApplication.getContext().getResources(), 2130840079);
          new Thread(new DeviceHeadMgr.2(this, (String)???, str, paramInt)).start();
          break;
          localBitmap1 = aqhu.r(localBitmap1, 50, 50);
        }
      }
    }
    return ???;
  ...
  {
    if (acbn.bkv.equals(paramString))
    {
      paramString = aqcu.decodeResource(BaseApplication.getContext().getResources(), 2130840081);
      return new BitmapDrawable(BaseApplication.getContext().getResources(), paramString);
    }
    long l = Long.parseLong(paramString);
    DeviceInfo localDeviceInfo = ((syw)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(51)).a(Long.valueOf(l).longValue());
    ...
    if (localDeviceInfo != null)
    {
      ...
      {
        paramString = BaseApplication.getContext().getResources().getDrawable(2130840078);
  ...
  {
    return aqcu.decodeFile(this.mStrCachePath + paramInt);
  }
  
  public Bitmap getDeviceWithLogoByPid(int paramInt)
  {
    if (paramInt == 9971) {
      ??? = aqcu.decodeResource(BaseApplication.getContext().getResources(), 2130840082);
    }
    for (;;)
    {
      return ???;
      synchronized (this.mDeviceOriginalHeadMap)
      {
        ...
        localBitmap = aqcu.decodeFile(this.mStrCachePath + String.valueOf(paramInt) + "_mark");
        ??? = localBitmap;
        if (localBitmap != null) {
          continue;
        }
  ...
  {
    return ((syw)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(51)).bl(Long.parseLong(paramString));
  }
}
