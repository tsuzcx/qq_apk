...
public class ByteData
{
  ...
  public static final String MY_VERSION = "0.4.3";
  ...
  public void init(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    try
    {
      ...
      this.cData = new a.a.a.b.b(paramContext, paramString1, "", paramString2, paramString3, paramString4, sSessionID, paramString5, "0.4.3");
  ...
  public void runTime(int paramInt1, String paramString, int paramInt2)
  {
    ...
    while ((this.filterStatus) && (!processName.equalsIgnoreCase(this.filterName))) {
      return;
    }
    try
    {
