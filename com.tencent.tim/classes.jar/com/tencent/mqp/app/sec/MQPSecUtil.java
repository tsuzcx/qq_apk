...
public class MQPSecUtil
{
  ...
  static
  {
    // Byte code:
    //   0: iconst_1
    //   1: putstatic 14	com/tencent/mqp/app/sec/MQPSecUtil:ekx	I
    ...
    //   81: aload_3
    //   82: aload_1
    //   83: invokestatic 79	com/tencent/mqp/app/sec/MQPSecUtil:cZ	(Landroid/content/Context;Ljava/lang/String;)V
    //   86: aload_2
    //   87: astore_1
    //   88: aload_2
    ...
    //   142: ifeq +82 -> 224
    //   145: aload_1
    //   146: invokevirtual 84	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   149: invokestatic 89	java/lang/System:load	(Ljava/lang/String;)V
    //   152: iconst_1
    //   153: istore_0
    //   154: iload_0
    //   155: ifne +8 -> 163
    //   158: ldc 45
    //   160: invokestatic 92	java/lang/System:loadLibrary	(Ljava/lang/String;)V
    //   163: return
    ...
    //   186: goto -100 -> 86
    //   189: astore_2
    //   190: invokestatic 102	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   193: ifeq +31 -> 224
    //   196: ldc 104
    //   198: iconst_2
    ...
    //   211: aload_1
    //   212: invokevirtual 84	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   221: invokestatic 110	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   224: iconst_0
    //   225: istore_0
    //   226: goto -72 -> 154
    //   229: astore_1
    //   230: invokestatic 102	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   233: ifeq -70 -> 163
    //   236: ldc 104
    //   238: iconst_2
    //   239: ldc 112
    //   241: invokestatic 110	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   244: return
  ...
  /* Error */
  private static void cZ(android.content.Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   98: invokevirtual 129	java/io/File:mkdirs	()Z
    //   101: pop
    //   102: aload_0
    //   103: invokevirtual 133	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   106: aload 5
    //   108: invokevirtual 139	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   111: astore_0
    //   112: new 141	java/io/FileOutputStream
    //   115: dup
    //   116: aload_1
    //   117: invokespecial 142	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   120: astore_3
    //   121: sipush 4096
    //   124: newarray byte
    //   126: astore_1
    //   127: aload_0
    //   128: aload_1
    //   129: invokevirtual 148	java/io/InputStream:read	([B)I
    //   132: istore_2
    //   133: iload_2
    //   134: ifle +35 -> 169
    //   137: aload_3
    ...
    //   139: iconst_0
    //   140: iload_2
    //   141: invokevirtual 154	java/io/OutputStream:write	([BII)V
    //   144: goto -17 -> 127
    //   147: astore_1
    //   148: aload_0
    //   149: astore_1
    ...
    //   161: ifnull +7 -> 168
    //   164: aload_0
    //   165: invokevirtual 158	java/io/OutputStream:close	()V
    //   168: return
    //   169: aload_0
    //   170: ifnull +7 -> 177
    //   173: aload_0
    //   174: invokevirtual 157	java/io/InputStream:close	()V
    //   177: aload_3
    //   178: ifnull -10 -> 168
    //   181: aload_3
    ...
    //   192: astore_0
    //   193: aload_0
    //   194: invokevirtual 159	java/io/IOException:printStackTrace	()V
    //   197: return
    //   198: astore_1
    //   199: aconst_null
    //   200: astore_0
    ...
    //   205: ifnull +7 -> 212
    //   208: aload_0
    //   209: invokevirtual 157	java/io/InputStream:close	()V
    //   212: aload_3
    //   213: ifnull +7 -> 220
    //   216: aload_3
    //   217: invokevirtual 158	java/io/OutputStream:close	()V
    //   220: aload_1
    //   221: athrow
    //   222: astore_0
    //   223: aload_0
    //   224: invokevirtual 159	java/io/IOException:printStackTrace	()V
    //   227: goto -7 -> 220
    //   230: astore_1
    //   231: aload 4
    //   233: astore_3
  ...
  public static void do_report(String paramString)
  {
    ...
    anot.c((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "P_CliOper", "Safe_MQPSecUtil", "", "AntiTrace", paramString, 0, 0, "", "", "", "");
  }
