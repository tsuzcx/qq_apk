...
public class ScConfigManager
{
  ...
  private static final a[] jdField_a_of_type_ArrayOfComTencentMqpAppSecScConfigManager$a = { new a("SecCenterConfig", new arnu()) };
  private HashMap<String, arns> pL = new HashMap();
  private HashMap<String, String> pM = new HashMap();
  
  private ScConfigManager()
  {
    this.pM.put("SecCenterConfig", "qq_security_sccfg");
  }
  
  private void WB(String paramString)
  {
    String str = qt(paramString);
    if (sj(str)) {
      iD(paramString, str);
    }
    sk(str);
  ...
  {
    a[] arrayOfa = jdField_a_of_type_ArrayOfComTencentMqpAppSecScConfigManager$a;
    int j = arrayOfa.length;
    int i = 0;
    while (i < j)
    {
      a locala = arrayOfa[i];
      if (locala.cBb.equals(paramString)) {
        return locala.a;
      }
      i += 1;
    }
  ...
  private arns b(String paramString)
  {
    synchronized (this.pL)
    {
      if (this.pL.containsKey(paramString))
      {
        paramString = (arns)this.pL.get(paramString);
        return paramString;
      }
      return null;
    }
  ...
  private void iD(String paramString1, String paramString2)
  {
    ...
    //   3: aconst_null
    //   4: astore 6
    //   6: invokestatic 105	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   9: invokevirtual 109	com/tencent/qphone/base/util/BaseApplication:getAssets	()Landroid/content/res/AssetManager;
    //   12: new 111	java/lang/StringBuilder
    //   15: dup
    //   16: invokespecial 112	java/lang/StringBuilder:<init>	()V
    //   19: aload_0
    //   20: aload_1
    //   21: invokespecial 115	com/tencent/mqp/app/sec/ScConfigManager:qu	(Ljava/lang/String;)Ljava/lang/String;
  ...
  private String qt(String paramString)
  {
  ...
  {
    return (String)this.pM.get(paramString);
  }
  ...
  {
    return !ahbj.isFileExists(paramString);
  }
  
  private boolean sk(String arg1)
  {
    String str = qv(???);
    Object localObject2 = a(str);
    if (localObject2 != null)
    {
      localObject2 = ((arnm)localObject2).a(???);
      if (localObject2 != null) {
        synchronized (this.pL)
        {
          this.pL.put(str, localObject2);
        }
      }
    }
    else
  ...
  public arns a(String paramString, boolean paramBoolean)
  {
    arns localarns2 = b(paramString);
    arns localarns1 = localarns2;
    if (localarns2 == null)
    {
      localarns1 = localarns2;
      if (paramBoolean)
      {
        WB(paramString);
        localarns1 = b(paramString);
      }
    }
    return localarns1;
  }
  ...
  {
    aqfz.a().bf(paramQQAppInterface, paramString);
  }
  
  public void r(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    if (a(paramString, false) == null) {
      ThreadManager.executeOnFileThread(new LoadLocalConfig(paramQQAppInterface, paramString, paramBoolean));
    }
  }
  
  public boolean sl(String paramString)
  {
    return sk(paramString);
  }
    ...
    implements Runnable
  {
    ...
    public LoadLocalConfig(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
    {
    ...
    public void run()
    {
      ScConfigManager.a(ScConfigManager.this, this.cBc);
      if (this.dcr) {
        ScConfigManager.this.bf(this.mApp, this.cBc);
      }
    }
  }
  ...
  static class a
  {
    ...
    public a(String paramString, arnm paramarnm)
    {
