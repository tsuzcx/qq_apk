...
public class d
{
  ...
  {
    QSecFramework.a().sendCmdToLib(1, 0, paramInt, new Object[] { d.class, paramArrayOfObject, paramArrayOfByte }, null);
  }
  ...
  public static Object[] x()
  {
    ...
    for (;;)
    {
      String str2 = asxv.getDeviceId(2);
      if (str2 == null) {
        str2 = "";
      }
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          {
            Object localObject3 = asxv.getDeviceId(1);
            Object localObject2 = localObject3;
            if (localObject3 == null) {
              localObject2 = "";
            }
            Object localObject4 = asxv.getDeviceId(3);
            ...
            return new Object[] { localBaseApplication, d.class, Build.VERSION.RELEASE, Integer.valueOf(AppSetting.getAppId()), NetConnInfoCenter.GUID, ((String)localObject2).getBytes(), str1.getBytes(), Integer.valueOf(i), "mobileqq.service", localObject1, "req_pb_protocol_flag", ((String)localObject3).getBytes(), str2, localObject4, localObject5 };
