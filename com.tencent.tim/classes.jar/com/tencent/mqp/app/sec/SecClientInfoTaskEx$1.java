  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((ClientInfoB.EnvParamPacket)localObject3).str_qqversion.set("3.4.4.3058");
        ((ClientInfoB.EnvParamPacket)localObject3).u32_appid.set(AppSetting.getAppId());
        ...
        {
          localObject1 = SecClientInfoTaskEx.m(SecClientInfoTaskEx.b(this.this$0));
      ...
      {
        if (!SecClientInfoTaskEx.access$400())
        {
          ...
          if ((localObject3 != null) && (((File)localObject3).exists())) {
            SecClientInfoTaskEx.access$502(SecUtil.getFileMd5((String)localObject2));
          }
          SecClientInfoTaskEx.y(true);
        }
        if ((SecClientInfoTaskEx.access$500() != null) && (SecClientInfoTaskEx.access$500().length() > 0)) {
          localReportDetectResultPacket.str_safemd5.set(SecClientInfoTaskEx.access$500());
        }
        ...
        localObject2 = SecClientInfoTaskEx.m(SecClientInfoTaskEx.b(this.this$0) >> 1 & 0x7FFFFFFF);
