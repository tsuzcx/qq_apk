...
public class AudioPlayerManager
{
  ...
  private SparseArray<AudioManagerListener> mManagerListenerArray = new SparseArray();
  ...
  public void pause(int paramInt)
  {
    if ((this.mCurrentDataSource.equals(this.mAudioUrlArray.get(paramInt))) && (paramInt == this.mCurrentUniqueId) && (this.mMediaPlayer.isPlaying()))
    {
      ...
      AudioManagerListener localAudioManagerListener = (AudioManagerListener)this.mManagerListenerArray.get(this.mCurrentUniqueId);
  ...
  public void play(int paramInt)
  {
    try
    {
      ...
      if ((this.mCurrentUniqueId == paramInt) && (str.equals(this.mCurrentDataSource)))
      {
        ...
        localAudioManagerListener = (AudioManagerListener)this.mManagerListenerArray.get(this.mCurrentUniqueId);
        if (localAudioManagerListener != null)
        {
  ...
  public void prepareData(int paramInt, String paramString, AudioManagerListener paramAudioManagerListener)
  {
  ...
  public static abstract interface AudioManagerListener
  {
