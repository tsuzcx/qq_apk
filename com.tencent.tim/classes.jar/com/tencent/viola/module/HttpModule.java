  ...
  implements Handler.Callback, Destroyable
{
  ...
  private void reuqestHttp(String paramString1, JSONObject paramJSONObject1, JSONObject paramJSONObject2, int paramInt, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    for (localHttpRequset.body = paramJSONObject1.toString();; localHttpRequset.body = ViolaUtils.splittBodyEncodeUrl(paramJSONObject1))
    {
      ...
      this.mAdapter.sendRequest(localHttpRequset, new HttpListener(new HttpModule.1(this, paramString2, paramString1)), paramBoolean);
      return;
    }
  }
    ...
    implements IHttpAdapter.OnHttpListener
  {
    ...
    public HttpListener(HttpModule.ResponseCallback paramResponseCallback)
    {
    ...
    public void onHttpFinish(HttpResponse paramHttpResponse)
    {
      ...
      long l1;
      long l2;
      if ((HttpModule.this.getViolaInstance() != null) && (this.mHttpStartTime != 0L))
      {
        localViolaInstance = HttpModule.this.getViolaInstance();
  ...
  static abstract interface ResponseCallback
  {
