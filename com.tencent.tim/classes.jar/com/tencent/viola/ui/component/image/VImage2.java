  ...
  implements ImageAction
{
  ...
  static class NullDrawableChecker
    extends Handler
  {
    ...
    public NullDrawableChecker(VImage2 paramVImage2)
    {
    ...
    private void checkDrawable()
    {
      ...
      if (localVImage2.mImageUrl != null)
      {
        localObject = localVImage2.mImageUrl;
        ViolaLogUtils.e("VImage2", (String)localObject);
        if (TextUtils.isEmpty(localVImage2.mImageUrl)) {
          break label167;
        }
        localVImage2.requestImage(false, localVImage2.mImageUrl);
      ...
      label161:
      for (Object localObject = localVImage2.mImageUrl;; localObject = "null")
      {
        ViolaLogUtils.e("VImage2", (String)localObject);
        return;
        localObject = "null";
