...
public class DomDiffUtils
{
  ...
  public static void diff(VComponent paramVComponent, DomObject paramDomObject1, DomObject paramDomObject2, DOMActionContext paramDOMActionContext, OnComponentDiffListener paramOnComponentDiffListener, boolean paramBoolean)
  {
    ArrayList localArrayList = new ArrayList();
  ...
  public static void diffComponent(VComponent paramVComponent, DomObject paramDomObject, DOMActionContext paramDOMActionContext, OnComponentDiffListener paramOnComponentDiffListener, boolean paramBoolean)
  {
  ...
  public static void diffComponent(VComponent paramVComponent, DomObject paramDomObject1, DomObject paramDomObject2, DOMActionContext paramDOMActionContext, OnComponentDiffListener paramOnComponentDiffListener, boolean paramBoolean)
  {
  ...
  public static abstract interface OnComponentDiffListener
  {
    public abstract void onCellChange(VCell paramVCell1, VCell paramVCell2);
  }
}
