  ...
  extends RecyclerView.Adapter<VH>
{
  ...
  private void onCreateAndSetRealView(VH paramVH, DomObject paramDomObject)
  {
  ...
  public void setCellEventListener(CellEventListener paramCellEventListener)
  {
    this.mCellEventListener = paramCellEventListener;
  }
  
  public void setDiffItemAnimListener(DiffItemAnimListener paramDiffItemAnimListener)
  {
    this.mDiffItemAnimListener = paramDiffItemAnimListener;
  }
  
  public static abstract interface CellEventListener
  {
    public abstract void onCellAppear(VRecyclerViewAdapter.VH paramVH);
    
    public abstract void onCellDisappear(VRecyclerViewAdapter.VH paramVH);
  }
  
  public static abstract interface DiffItemAnimListener
  {
