  ...
  implements IVView<VRecyclerList>, PagerSnapHelper.PagerEventListener, OverScrollHelper.OverScrollListener, VRefreshContentView.ContentViewProvider<VRecyclerView>
{
  ...
  private void init()
  {
    this.mScrollListener = new ScrollListener(null);
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    {
      OnGestureListener localOnGestureListener = this.mGestureListener;
      if (isVertical())
      {
  ...
  public void performOnScroll(int paramInt1, int paramInt2)
  {
    ...
    int i;
    label55:
    OnGestureListener localOnGestureListener;
    label75:
    int j;
    label86:
    int k;
  ...
  public void setGestureListener(OnGestureListener paramOnGestureListener)
  {
    ...
    extends RecyclerView.OnScrollListener
  {
    ...
    public void onScrollStateChanged(RecyclerView paramRecyclerView, int paramInt)
    {
      ...
      if (paramInt == 0)
      {
        boolean bool = VRecyclerView.this.isVertical();
        VRecyclerView.this.calAndSetContentOffset(bool, 0.0F, 0.0F);
        i = VRecyclerView.this.getLastVisibleItemPosition();
        if ((VRecyclerView.this.getAdapter() != null) && (i != -1) && (i == VRecyclerView.this.getAdapter().getItemCount() - 1) && (!VRecyclerView.this.mIsLoadingMore) && (VRecyclerView.this.mGestureListener != null))
        {
          VRecyclerView.access$302(VRecyclerView.this, true);
          VRecyclerView.this.mGestureListener.onLoadMore(VRecyclerView.this, 0, VRecyclerView.this.mContentOffsetY);
        ...
        {
          paramRecyclerView = VRecyclerView.this.mGestureListener;
          localVRecyclerView = VRecyclerView.this;
          if (bool)
          {
            i = 0;
            if (!bool) {
            ...
            j = VRecyclerView.this.mContentOffsetY;
            label179:
        ...
        {
          VRecyclerView.access$802(VRecyclerView.this, false);
          label199:
          if (VRecyclerView.this.mGestureListener != null)
          {
            paramRecyclerView = VRecyclerView.this.mGestureListener;
            localVRecyclerView = VRecyclerView.this;
            if (VRecyclerView.this.canChildPullDown()) {
              break label285;
            }
            i = 1;
          }
      ...
      for (;;)
      {
        ...
        return;
        i = VRecyclerView.this.mContentOffsetX;
        break;
        label257:
        j = 0;
        break label179;
        ...
        VRecyclerView.access$802(VRecyclerView.this, true);
        break label199;
        label285:
        i = k;
        if (!VRecyclerView.this.canChildPullUp()) {
          i = 2;
        }
      }
    }
    ...
    {
      VRecyclerView.this.performOnScroll(paramInt1, paramInt2);
