  ...
  implements IVView<VPageSlider>
{
  ...
  private List<VPagerSliderScrollListener> listeners = null;
  ...
  private void initVerticalPage(Context paramContext)
  {
    ...
    {
      setPageTransformer(true, new VerticalPageTransformer(null));
      setOverScrollMode(2);
      this.mGestureDetector = new GestureDetectorCompat(paramContext, new YScrollDetector());
    }
  ...
  public void addScrollListener(VPagerSliderScrollListener paramVPagerSliderScrollListener)
  {
  ...
  public void removeScrollListener(VPagerSliderScrollListener paramVPagerSliderScrollListener)
  {
    if (paramVPagerSliderScrollListener == null) {
      return;
    }
