  ...
  extends PaintDrawable
{
  ...
  public static void blurImage(Drawable paramDrawable, ImageView.ScaleType paramScaleType, String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, OnImageDrawableListener paramOnImageDrawableListener)
  {
  ...
  public static void createImageDrawableForRound(Drawable paramDrawable, ImageView.ScaleType paramScaleType, int paramInt1, int paramInt2, String paramString, OnImageDrawableListener paramOnImageDrawableListener)
  {
    if ((paramDrawable == null) || (paramInt1 < 0) || (paramInt2 < 0)) {
      return;
    }
  ...
  public static void createRoundImageAndBlur(Drawable paramDrawable, ImageView.ScaleType paramScaleType, String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, OnImageDrawableListener paramOnImageDrawableListener)
  {
  ...
  private static Matrix createShaderMatrix(@NonNull ImageView.ScaleType paramScaleType, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt3 * paramInt2 > paramInt4 * paramInt1)
    {
      ...
      f3 = (paramInt1 - paramInt3 * f1) * 0.5F;
      f2 = 0.0F;
    ...
    do
    {
      ...
      f2 = (paramInt2 - paramInt4 * f1) * 0.5F;
      f3 = 0.0F;
      break;
    ...
    localMatrix.postTranslate(f3 + 0.5F, f2 + 0.5F);
    return localMatrix;
  }
  ...
  private static void internalBlurImage(Drawable paramDrawable, ImageView.ScaleType paramScaleType, String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, OnImageDrawableListener paramOnImageDrawableListener)
  {
  ...
  private static void internalCreateImageDrawableForRound(Drawable paramDrawable, ImageView.ScaleType paramScaleType, int paramInt1, int paramInt2, String paramString, OnImageDrawableListener paramOnImageDrawableListener)
  {
  ...
  private static void internalRoundImageAndBlur(Drawable paramDrawable, ImageView.ScaleType paramScaleType, String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, OnImageDrawableListener paramOnImageDrawableListener)
  {
  ...
  public static abstract interface OnImageDrawableListener
  {
