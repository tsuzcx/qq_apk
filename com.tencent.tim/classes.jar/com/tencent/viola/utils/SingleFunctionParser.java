...
{
  public SingleFunctionParser(@NonNull String paramString, @NonNull FlatMapper<V> paramFlatMapper)
  {
    super(paramString, new SingleFunctionParser.1(paramFlatMapper));
  }
  
  public SingleFunctionParser(@NonNull String paramString, @NonNull NonUniformMapper<V> paramNonUniformMapper)
  {
  ...
  public static abstract interface FlatMapper<V>
  {
    public abstract V map(String paramString);
  }
  
  public static abstract interface NonUniformMapper<V>
  {
    public abstract List<V> map(List<String> paramList);
  }
}
