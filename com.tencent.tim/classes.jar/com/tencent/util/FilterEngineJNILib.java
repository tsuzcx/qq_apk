...
public class FilterEngineJNILib
{
  ...
  public static byte[] readBundleData(String paramString)
  {
    ...
    //   35: invokestatic 166	com/tencent/ttpic/baseutils/log/LogUtils:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   38: aload_1
    //   39: invokestatic 172	com/tencent/ttpic/baseutils/encrypt/FileEncryptUtils:decryptFile	(Ljava/io/InputStream;)[B
    //   42: astore_0
    //   43: aload_1
    //   44: invokestatic 178	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   47: aload_0
    //   48: areturn
    //   49: astore_1
    //   50: aconst_null
    ...
    //   61: invokestatic 183	com/tencent/ttpic/baseutils/log/LogUtils:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    //   64: aload_0
    //   65: areturn
    //   66: astore_1
    //   67: goto -15 -> 52
  ...
  private static int saveBitmap(Bitmap paramBitmap, String paramString)
  {
    ...
    //   47: astore_2
    //   48: aload 6
    //   50: invokevirtual 223	java/io/File:getParentFile	()Ljava/io/File;
    //   53: astore 7
    //   55: aload 5
    //   57: astore_2
    //   58: aload 7
    ...
    //   117: invokevirtual 228	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    ...
    //   132: dup
    //   133: aload_1
    //   134: invokespecial 229	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   137: astore_1
    //   138: aload_0
    //   139: ifnull +18 -> 157
    //   142: aload_0
    //   143: getstatic 235	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   146: bipush 95
    //   148: aload_1
    //   149: invokevirtual 239	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   152: pop
    //   153: aload_1
    //   154: invokevirtual 242	java/io/FileOutputStream:flush	()V
    //   157: aload_1
    //   158: invokestatic 245	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/OutputStream;)V
    //   161: iconst_1
    //   162: ireturn
    //   163: astore_1
    //   164: aload_3
    ...
    //   167: astore_2
    //   168: aload_1
    //   169: invokevirtual 246	java/lang/Exception:printStackTrace	()V
    //   172: aload_0
    //   173: invokestatic 245	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/OutputStream;)V
    //   176: iconst_0
    //   177: ireturn
    //   178: astore_1
    //   179: aload 4
    ...
    //   183: astore_2
    //   184: aload_1
    //   185: invokevirtual 247	java/lang/OutOfMemoryError:printStackTrace	()V
    //   188: aload_0
    //   189: invokestatic 245	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/OutputStream;)V
    //   192: iconst_0
    //   193: ireturn
    //   194: astore_0
    //   195: aload_2
    //   196: invokestatic 245	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/OutputStream;)V
    //   199: aload_0
    //   200: athrow
    //   201: astore_0
    //   202: aload_1
