  ...
  implements Handler.Callback
{
  ...
  private void doMaintenance(CancellationSignalCompat paramCancellationSignalCompat)
  {
    ...
    if ((paramCancellationSignalCompat instanceof OperationCanceledException))
    {
      ...
      for (;;)
      {
        ...
        if (localFileEntry.isDirectory)
        {
          ...
          if (!((HashMap)localObject2).containsKey(localFileEntry.relPath))
          {
            ...
            m = i;
            l1 = l2;
            ((HashMap)localObject2).put(localFileEntry.relPath, new DirEntry(localFileEntry));
          }
        }
        k = j;
        m = i;
        ...
        if (str != null)
        {
          ...
          m = i;
          l1 = l2;
          localObject3 = (DirEntry)((HashMap)localObject2).get(str);
          ...
          if (localObject3 == null)
          {
            ...
            m = i;
            l1 = l2;
            localObject1 = new DirEntry(localFileEntry);
            k = j;
            m = i;
            l1 = l2;
          ...
          m = i;
          l1 = l2;
          ((DirEntry)localObject1).childCount += 1;
        }
      }
      k = j;
      m = i;
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          try
          {
            localObject4 = (DirEntry)((HashMap)localObject1).get(localObject2);
            ...
            k = ((DirEntry)localObject4).childCount - 1;
            ((DirEntry)localObject4).childCount = k;
            if ((k != 0) || (!this.mFS.deleteDir((String)localObject2, false))) {
              break label2211;
            }
            if (((DirEntry)localObject4).entry.diskSpace < 0L)
            {
              l2 = ((DirEntry)localObject4).entry.size;
              l1 -= l2;
              i -= 1;
            }
          }
        ...
        l2 = ((DirEntry)localObject4).entry.diskSpace;
        continue;
        m = i;
        l3 = l1;
        if (localObject1 != null)
    ...
    for (;;)
    {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        j = i;
        l2 = l1;
        localObject2 = (DirEntry)((Iterator)localObject1).next();
        j = i;
        l2 = l1;
        if (((DirEntry)localObject2).childCount == 0)
        {
          j = i;
          l2 = l1;
          paramCancellationSignalCompat.throwIfCanceled();
          j = i;
          l2 = l1;
          if (this.mFS.deleteDir(((DirEntry)localObject2).entry.relPath, false))
          {
            j = i;
            l2 = l1;
            if (((DirEntry)localObject2).entry.diskSpace < 0L)
            {
              j = i;
              l2 = l1;
              l3 = ((DirEntry)localObject2).entry.size;
              l2 = l3;
              break label2236;
            }
            j = i;
            l2 = l1;
            l3 = ((DirEntry)localObject2).entry.diskSpace;
            l2 = l3;
            break label2236;
          }
        }
  ...
  static final class DirEntry
  {
    ...
    DirEntry(FileSystem.FileEntry paramFileEntry)
    {
