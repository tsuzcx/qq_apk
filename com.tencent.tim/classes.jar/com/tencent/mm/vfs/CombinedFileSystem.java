  ...
  extends DelegateFileSystem
{
  ...
  private CombinedFileSystem(Parcel paramParcel)
  {
    ...
    this.mPatternList = new PatternEntry[j];
    i = k;
    if (i < j)
    {
      ...
      for (localObject = null;; localObject = Pattern.compile((String)localObject))
      {
        ...
        this.mPatternList[i] = new PatternEntry((Pattern)localObject, k, this.mFSList[k]);
        i += 1;
        break;
      }
    }
  ...
  public CombinedFileSystem(FileSystem[] paramArrayOfFileSystem, String[] paramArrayOfString)
  {
    ...
    if (i < paramArrayOfString.length)
    {
      if (paramArrayOfString[i] == null) {
        paramArrayOfFileSystem.add(new PatternEntry(null, i, this.mFSList[i]));
      }
      for (;;)
      {
        i += 1;
        ...
        while (localIterator.hasNext()) {
          paramArrayOfFileSystem.add(new PatternEntry(globToRegexPattern((String)localIterator.next()), i, this.mFSList[i]));
        }
      }
    }
    this.mPatternList = new PatternEntry[paramArrayOfFileSystem.size()];
  ...
  {
    PatternEntry[] arrayOfPatternEntry = this.mPatternList;
    int i = arrayOfPatternEntry.length;
    paramInt = 0;
    while (paramInt < i)
    {
      PatternEntry localPatternEntry = arrayOfPatternEntry[paramInt];
  ...
  static final class PatternEntry
  {
    ...
    PatternEntry(Pattern paramPattern, int paramInt, FileSystem paramFileSystem)
    {
