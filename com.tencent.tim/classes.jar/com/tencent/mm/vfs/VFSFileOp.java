...
public final class VFSFileOp
{
    ...
    throws IOException
  {
    ...
    //   7: astore 4
    //   9: new 415	java/io/InputStreamReader
    //   12: dup
    //   13: aload_0
    //   14: invokestatic 247	com/tencent/mm/vfs/VFSFileOp:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   17: invokespecial 418	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   20: astore_3
    //   21: aload_3
    //   22: astore_2
    //   23: sipush 512
    ...
    //   32: aload_3
    //   33: aload 5
    //   35: invokevirtual 421	java/io/InputStreamReader:read	([C)I
    //   38: istore_1
    //   39: iload_1
    //   40: iconst_m1
    //   41: if_icmpeq +62 -> 103
    ...
    //   50: iconst_0
    //   51: iload_1
    //   52: invokevirtual 424	java/lang/StringBuilder:append	([CII)Ljava/lang/StringBuilder;
    //   55: pop
    //   56: goto -26 -> 30
    //   59: astore 4
    //   61: aload_3
    ...
    //   87: aastore
    //   88: invokestatic 429	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   91: aload_3
    //   92: astore_2
    //   93: aload 4
    //   95: athrow
  ...
  public static byte[] readFromFile(String paramString, int paramInt1, int paramInt2)
  {
    ...
    //   21: sipush 4096
    //   24: istore_3
    //   25: new 434	java/io/ByteArrayOutputStream
    //   28: dup
    //   29: iload_3
    //   30: invokespecial 435	java/io/ByteArrayOutputStream:<init>	(I)V
    //   33: astore 8
    //   35: aload_0
    ...
    //   58: aload 7
    //   60: lload 4
    //   62: invokevirtual 439	java/io/InputStream:skip	(J)J
    //   65: lsub
    //   66: lstore 4
    //   68: goto -23 -> 45
    //   71: aload 7
    ...
    //   102: aload 9
    //   104: arraylength
    //   105: invokestatic 446	java/lang/Math:min	(II)I
    //   108: invokevirtual 449	java/io/InputStream:read	([BII)I
    //   111: istore_2
    //   112: iload_2
    //   113: iconst_m1
    ...
    //   129: iconst_0
    //   130: iload_2
    //   131: invokevirtual 450	java/io/ByteArrayOutputStream:write	([BII)V
    //   134: iload_1
    //   135: iload_2
    //   136: isub
    //   137: istore_1
    ...
    //   146: aload 8
    //   148: invokevirtual 453	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   151: astore 7
    //   153: aload 8
    //   155: invokevirtual 454	java/io/ByteArrayOutputStream:close	()V
    //   158: aload 7
    //   160: astore 6
  ...
  {
    // Byte code:
    //   0: new 506	java/util/zip/ZipInputStream
    //   3: dup
    //   4: aload_0
    //   5: invokestatic 247	com/tencent/mm/vfs/VFSFileOp:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   8: invokespecial 507	java/util/zip/ZipInputStream:<init>	(Ljava/io/InputStream;)V
    //   11: astore_3
    //   12: aload_3
    //   13: astore_0
    //   14: aload_3
    //   15: invokevirtual 511	java/util/zip/ZipInputStream:getNextEntry	()Ljava/util/zip/ZipEntry;
    //   18: astore 4
    //   20: aload 4
    //   22: ifnull +240 -> 262
    //   25: aload_3
    //   26: astore_0
    //   27: aload 4
    //   29: invokevirtual 514	java/util/zip/ZipEntry:getName	()Ljava/lang/String;
    //   32: astore 5
    //   34: aload_3
    //   35: astore_0
    //   36: aload 5
    //   38: ldc_w 516
    //   41: invokevirtual 520	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   44: ifne -32 -> 12
    //   47: aload_3
    //   48: astore_0
    //   49: aload 5
    //   51: ldc_w 522
    //   54: invokevirtual 520	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   57: ifne -45 -> 12
    //   60: aload_3
    //   61: astore_0
    //   62: aload 4
    //   64: invokevirtual 523	java/util/zip/ZipEntry:isDirectory	()Z
    //   67: ifeq +79 -> 146
    //   70: aload_3
    //   71: astore_0
    //   72: aload 5
    ...
    //   133: ldc_w 525
    //   136: aload_1
    //   137: invokestatic 528	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   140: aload_3
    ...
    //   179: invokestatic 530	com/tencent/mm/vfs/VFSFileOp:openWrite	(Lcom/tencent/mm/vfs/VFSFile;)Ljava/io/OutputStream;
    //   182: astore 4
    //   184: aload_3
    //   185: astore_0
    //   186: sipush 1024
    ...
    //   195: aload_3
    //   196: aload 5
    //   198: invokevirtual 531	java/util/zip/ZipInputStream:read	([B)I
    //   201: istore_2
    //   202: iload_2
    //   203: iconst_m1
    ...
    //   227: ldc_w 533
    //   230: aload_1
    //   231: invokestatic 528	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   234: aload_3
  ...
  public static boolean zipFolders(java.util.List<String> paramList, String paramString)
  {
    ...
    //   18: ireturn
    //   19: aload_1
    //   20: invokestatic 553	com/tencent/mm/vfs/VFSFileOp:getParentAbsolutePath	(Ljava/lang/String;)Ljava/lang/String;
    //   23: invokestatic 554	com/tencent/mm/vfs/VFSFileOp:mkdirs	(Ljava/lang/String;)Z
    //   26: pop
    //   27: sipush 4096
    //   30: newarray byte
    //   32: astore 7
    //   34: new 556	java/util/zip/ZipOutputStream
    //   37: dup
    //   38: aload_1
    //   39: invokestatic 538	com/tencent/mm/vfs/VFSFileOp:openWrite	(Ljava/lang/String;)Ljava/io/OutputStream;
    //   42: invokespecial 559	java/util/zip/ZipOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   45: astore_1
    //   46: aload_0
    //   47: invokeinterface 562 1 0
    //   52: astore 8
    //   54: aload 8
    //   56: invokeinterface 479 1 0
    //   61: ifeq +288 -> 349
    //   64: aload 8
    //   66: invokeinterface 483 1 0
    ...
    //   110: ifnull -56 -> 54
    //   113: aload 4
    //   115: getfield 489	com/tencent/mm/vfs/FileSystem$FileEntry:isDirectory	Z
    //   118: ifeq +175 -> 293
    //   121: aload_0
    ...
    //   133: ldc 184
    //   135: invokevirtual 565	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   138: ifeq +150 -> 288
    //   141: iconst_0
    //   142: istore_2
    //   143: aload_0
    ...
    //   165: istore_2
    //   166: aload_0
    //   167: invokeinterface 474 1 0
    //   172: astore 9
    //   174: aload 9
    //   176: invokeinterface 479 1 0
    //   181: ifeq -127 -> 54
    //   184: aload 9
    //   186: invokeinterface 483 1 0
    //   191: checkcast 218	com/tencent/mm/vfs/FileSystem$FileEntry
    //   194: astore_0
    //   195: aload_0
    //   196: getfield 489	com/tencent/mm/vfs/FileSystem$FileEntry:isDirectory	Z
    //   199: ifne -25 -> 174
    //   202: aload_0
    //   203: getfield 486	com/tencent/mm/vfs/FileSystem$FileEntry:relPath	Ljava/lang/String;
    //   206: invokevirtual 114	java/lang/String:length	()I
    //   209: iload_2
    //   210: if_icmpge +106 -> 316
    //   213: aload_0
    //   214: getfield 568	com/tencent/mm/vfs/FileSystem$FileEntry:name	Ljava/lang/String;
    //   217: astore 4
    //   219: aload_0
    //   220: invokevirtual 571	com/tencent/mm/vfs/FileSystem$FileEntry:openRead	()Ljava/io/InputStream;
    //   223: astore_0
    //   224: aload_1
    //   225: new 513	java/util/zip/ZipEntry
    //   228: dup
    //   229: aload 4
    //   231: invokespecial 572	java/util/zip/ZipEntry:<init>	(Ljava/lang/String;)V
    //   234: invokevirtual 576	java/util/zip/ZipOutputStream:putNextEntry	(Ljava/util/zip/ZipEntry;)V
    //   237: aload_0
    //   238: aload 7
    ...
    //   251: iconst_0
    //   252: iload_3
    //   253: invokevirtual 577	java/util/zip/ZipOutputStream:write	([BII)V
    //   256: goto -19 -> 237
    //   259: astore 4
    //   261: aload_1
    //   262: astore 4
    ...
    //   302: istore_2
    //   303: aload 4
    //   305: invokestatic 547	java/util/Collections:singletonList	(Ljava/lang/Object;)Ljava/util/List;
    //   308: astore_0
    //   309: iload_2
    //   310: iconst_1
    //   311: iadd
    ...
    //   313: goto -147 -> 166
    //   316: aload_0
    //   317: getfield 486	com/tencent/mm/vfs/FileSystem$FileEntry:relPath	Ljava/lang/String;
    //   320: iload_2
    //   321: invokevirtual 241	java/lang/String:substring	(I)Ljava/lang/String;
    //   324: astore 4
    //   326: goto -107 -> 219
    //   329: aload_0
    //   330: invokevirtual 580	java/io/InputStream:close	()V
    //   333: aload_1
    //   334: invokevirtual 583	java/util/zip/ZipOutputStream:closeEntry	()V
    //   337: goto -163 -> 174
    //   340: astore_0
    //   341: aload_1
    //   342: astore_0
