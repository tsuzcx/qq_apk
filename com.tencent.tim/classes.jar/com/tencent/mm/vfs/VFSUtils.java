...
public final class VFSUtils
{
  ...
  public static void checkFileSystemVersion(Parcel paramParcel, Class<? extends FileSystem> paramClass, int paramInt)
  {
    ...
    if (i != paramInt) {
      throw new FileSystemVersionException(paramClass, i, paramInt);
    }
  }
    ...
    throws IOException
  {
    ...
    //   39: aload_1
    //   40: aload_3
    //   41: invokevirtual 309	java/io/InputStream:read	([B)I
    //   44: istore 4
    //   46: iload 4
    //   48: iconst_m1
    //   49: if_icmpeq +24 -> 73
    ...
    //   56: iconst_0
    //   57: iload 4
    //   59: invokevirtual 315	java/io/OutputStream:write	([BII)V
    //   62: lload 5
    //   64: iload 4
    //   66: i2l
    //   67: ladd
    ...
    //   70: goto -33 -> 37
    //   73: aload_1
    //   74: invokestatic 317	com/tencent/mm/vfs/VFSUtils:closeQuietly	(Ljava/io/Closeable;)V
    //   77: aload_2
    //   78: invokestatic 317	com/tencent/mm/vfs/VFSUtils:closeQuietly	(Ljava/io/Closeable;)V
    //   81: lload 5
    //   83: lreturn
    //   84: astore_2
    //   85: aconst_null
    ...
    //   89: astore_0
    //   90: aload_1
    //   91: invokestatic 317	com/tencent/mm/vfs/VFSUtils:closeQuietly	(Ljava/io/Closeable;)V
    //   94: aload_0
    //   95: invokestatic 317	com/tencent/mm/vfs/VFSUtils:closeQuietly	(Ljava/io/Closeable;)V
    //   98: aload_2
    //   99: athrow
    //   100: astore_2
    //   101: goto -11 -> 90
  ...
  static abstract class CascadeIterator<From, To>
    implements Iterator<To>
  {
    ...
    CascadeIterator(Iterator<? extends From> paramIterator)
    {
      this.mSource = paramIterator;
      this.mChildrenFirst = false;
    }
    
    CascadeIterator(Iterator<? extends From> paramIterator, boolean paramBoolean)
    {
      this.mSource = paramIterator;
  ...
  static class FileSystemVersionException
    extends RuntimeException
  {
    FileSystemVersionException(Class<?> paramClass, int paramInt1, int paramInt2)
    {
      super();
    }
  }
