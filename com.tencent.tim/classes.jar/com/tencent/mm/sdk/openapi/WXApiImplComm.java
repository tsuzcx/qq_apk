...
class WXApiImplComm
{
  ...
  public static boolean validateAppSignature(Context paramContext, Signature[] paramArrayOfSignature, boolean paramBoolean)
  {
    if (!paramBoolean)
    {
      b.c("MicroMsg.SDK.WXMsgImplComm", "ignore wechat app signature validation");
      return true;
    }
    ...
    while (i < j)
    {
      ...
      b.c("MicroMsg.SDK.WXMsgImplComm", "check signature:" + paramContext);
      ...
      {
        b.c("MicroMsg.SDK.WXMsgImplComm", "pass");
        return true;
      }
      i += 1;
    }
