...
public final class JumpToBizWebview
{
    ...
    extends BaseReq
  {
    ...
    public boolean checkArgs()
    {
      ...
      {
        b.a("MicroMsg.SDK.JumpToBizWebview.Req", "checkArgs fail, toUserName is invalid");
        return false;
      }
      if ((this.extMsg != null) && (this.extMsg.length() > 1024))
      {
        b.a("MicroMsg.SDK.JumpToBizWebview.Req", "ext msg is not null, while the length exceed 1024 bytes");
        return false;
      }
      return true;
    }
