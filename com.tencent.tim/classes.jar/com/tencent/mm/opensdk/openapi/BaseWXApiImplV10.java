  ...
  implements IWXAPI
{
  ...
  private String getTokenFromWX(Context paramContext)
  {
    ...
    Cursor localCursor = alld.query(paramContext.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/genTokenForOpenSdk"), null, null, new String[] { this.appId, "621086464" }, null);
  ...
  {
    launchWXIfNeed();
    paramContext = alld.query(paramContext.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/joinChatroom"), null, null, new String[] { this.appId, paramBundle.getString("_wxapi_basereq_transaction", ""), paramBundle.getString("_wxapi_join_chatroom_group_id", ""), paramBundle.getString("_wxapi_join_chatroom_chatroom_nickname", ""), paramBundle.getString("_wxapi_join_chatroom_ext_msg", ""), paramBundle.getString("_wxapi_basereq_openid", "") }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  {
    launchWXIfNeed();
    paramContext = alld.query(paramContext.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/handleScanResult"), null, null, new String[] { this.appId, paramBundle.getString("_wxapi_scan_qrcode_result") }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  private boolean sendInvoiceAuthInsert(Context paramContext, BaseReq paramBaseReq)
  {
    ...
    paramContext = alld.query(paramContext, localUri, null, null, new String[] { this.appId, "2", paramBaseReq }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  {
    launchWXIfNeed();
    paramContext = alld.query(paramContext.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/jumpToOfflinePay"), null, null, new String[] { this.appId }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  private boolean sendLaunchWXMiniprogram(Context paramContext, BaseReq paramBaseReq)
  {
    ...
    paramContext = alld.query(paramContext.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/launchWXMiniprogram"), null, null, new String[] { this.appId, paramBaseReq.userName, paramBaseReq.path, paramBaseReq.miniprogramType, paramBaseReq.extData }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  private boolean sendLaunchWXMiniprogramWithToken(Context paramContext, BaseReq paramBaseReq)
  {
    ...
    paramContext = alld.query(paramContext.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/launchWXMiniprogramWithToken"), null, null, new String[] { this.appId, paramBaseReq.token }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  private boolean sendNonTaxPay(Context paramContext, BaseReq paramBaseReq)
  {
    ...
    Uri localUri = Uri.parse("content://com.tencent.mm.sdk.comm.provider/openTypeWebview");
    paramBaseReq = URLEncoder.encode(String.format("url=%s", new Object[] { URLEncoder.encode(paramBaseReq.url) }));
    paramContext = alld.query(paramContext, localUri, null, null, new String[] { this.appId, "3", paramBaseReq }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  private boolean sendOpenBusinessView(Context paramContext, BaseReq paramBaseReq)
  {
    ...
    paramContext = alld.query(paramContext.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openBusinessView"), null, null, new String[] { this.appId, paramBaseReq.businessType, paramBaseReq.query, paramBaseReq.extInfo, paramBaseReq.transaction }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  private boolean sendOpenBusinessWebview(Context paramContext, BaseReq paramBaseReq)
  {
    ...
    paramContext = alld.query(localContentResolver, localUri, null, null, new String[] { this.appId, localReq.businessType, paramContext }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  {
    launchWXIfNeed();
    paramContext = alld.query(paramContext.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openWebview"), null, null, new String[] { this.appId, paramBundle.getString("_wxapi_jump_to_webview_url"), paramBundle.getString("_wxapi_basereq_transaction") }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  private boolean sendPayInSurance(Context paramContext, BaseReq paramBaseReq)
  {
    ...
    Uri localUri = Uri.parse("content://com.tencent.mm.sdk.comm.provider/openTypeWebview");
    paramBaseReq = URLEncoder.encode(String.format("url=%s", new Object[] { URLEncoder.encode(paramBaseReq.url) }));
    paramContext = alld.query(paramContext, localUri, null, null, new String[] { this.appId, "4", paramBaseReq }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  private boolean sendPreloadWXMiniprogram(Context paramContext, BaseReq paramBaseReq)
  {
    ...
    paramContext = alld.query(paramContext.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/preloadWXMiniprogram"), null, null, new String[] { this.appId, paramBaseReq.userName, paramBaseReq.path, paramBaseReq.miniprogramType, paramBaseReq.extData }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  private boolean sendSubscribeMessage(Context paramContext, BaseReq paramBaseReq)
  {
    ...
    paramContext = alld.query(paramContext.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openTypeWebview"), null, null, new String[] { this.appId, "1", String.valueOf(paramBaseReq.scene), paramBaseReq.templateID, paramBaseReq.reserved }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  private boolean sendSubscribeMiniProgramMsg(Context paramContext, BaseReq paramBaseReq)
  {
    ...
    paramContext = alld.query(paramContext.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openTypeWebview"), null, null, new String[] { this.appId, "5", paramBaseReq.miniProgramAppId }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
