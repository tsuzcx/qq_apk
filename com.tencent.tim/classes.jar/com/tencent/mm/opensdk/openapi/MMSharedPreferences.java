  ...
  implements SharedPreferences
{
  ...
  private Object getValue(String paramString)
  {
    for (;;)
    {
      try
      {
        Cursor localCursor = alld.query(this.cr, c.b.CONTENT_URI, this.columns, "key = ?", new String[] { paramString }, null);
        if (localCursor == null) {
          return null;
        }
  ...
  public Map<String, ?> getAll()
  {
    try
    {
      Cursor localCursor = alld.query(this.cr, c.b.CONTENT_URI, this.columns, null, null, null);
      if (localCursor == null) {
        return null;
      }
