...
public final class b
{
  ...
  public static void a(Context paramContext, String paramString, boolean paramBoolean, BuglyStrategy paramBuglyStrategy)
  {
    ...
    for (;;)
    {
      ...
      x.a("[init] Bugly complete version: v%s", new Object[] { "3.4.5" });
    ...
    for (;;)
    {
      try
      {
        if (paramBuglyStrategy.isReplaceOldChannel())
        {
          ...
          paramContext = paramBuglyStrategy.getDeviceModel();
          if (paramContext != null)
          {
            locala1.d(paramContext);
            x.a("[param] Set device model: %s", new Object[] { paramContext });
          }
