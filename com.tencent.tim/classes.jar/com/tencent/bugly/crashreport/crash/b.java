...
public final class b
{
          ...
          catch (UnsupportedEncodingException localUnsupportedEncodingException4)
          {
            ...
            catch (UnsupportedEncodingException localUnsupportedEncodingException5)
            {
              ...
              try
              {
                ...
                localak.r.put("A6", parama.n());
                localak.r.put("A5", parama.m());
                ...
                localak.r.put("A15", parama.q());
                localak.r.put("A13", parama.r());
  ...
  private List<a> b()
  {
    ...
    //   5: dup
    //   6: invokespecial 333	java/util/ArrayList:<init>	()V
    //   9: astore 4
    //   11: invokestatic 860	com/tencent/bugly/proguard/p:a	()Lcom/tencent/bugly/proguard/p;
    //   14: ldc_w 862
    //   17: bipush 6
    ...
    //   59: aconst_null
    //   60: iconst_1
    //   61: invokevirtual 865	com/tencent/bugly/proguard/p:a	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Lcom/tencent/bugly/proguard/o;Z)Landroid/database/Cursor;
    //   64: astore_3
    //   65: aload_3
    //   66: astore_2
    //   67: aload_2
    ...
    //   72: ifnull +9 -> 81
    //   75: aload_2
    //   76: invokeinterface 866 1 0
    //   81: aconst_null
    //   82: areturn
    //   83: aload_2
    //   84: invokeinterface 869 1 0
    //   89: istore_1
    //   90: iload_1
    //   91: ifgt +16 -> 107
    //   94: aload_2
    //   95: ifnull +9 -> 104
    //   98: aload_2
    //   99: invokeinterface 866 1 0
    //   104: aload 4
    //   106: areturn
    //   107: new 144	java/lang/StringBuilder
    //   110: dup
    //   111: invokespecial 145	java/lang/StringBuilder:<init>	()V
    //   114: astore_3
    //   115: aload_3
    //   116: ldc_w 871
    ...
    //   130: istore_1
    //   131: aload_2
    //   132: invokeinterface 876 1 0
    //   137: ifeq +119 -> 256
    //   140: aload_2
    //   141: invokestatic 878	com/tencent/bugly/crashreport/crash/b:b	(Landroid/database/Cursor;)Lcom/tencent/bugly/crashreport/crash/a;
    //   144: astore 5
    //   146: aload 5
    //   148: ifnull +41 -> 189
    //   151: aload 4
    //   153: aload 5
    //   155: invokeinterface 117 2 0
    //   160: pop
    //   161: goto -30 -> 131
    //   164: astore_3
    //   165: aload_3
    //   166: invokestatic 79	com/tencent/bugly/proguard/x:a	(Ljava/lang/Throwable;)Z
    //   169: ifne +7 -> 176
    //   172: aload_3
    //   173: invokevirtual 82	java/lang/Throwable:printStackTrace	()V
    //   176: aload_2
    //   177: ifnull +9 -> 186
    //   180: aload_2
    //   181: invokeinterface 866 1 0
    //   186: aload 4
    //   188: areturn
    //   189: aload_3
    //   190: aload_2
    //   191: aload_2
    //   192: ldc 56
    //   194: invokeinterface 50 2 0
    //   199: invokeinterface 60 2 0
    //   204: invokevirtual 172	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   207: ldc_w 880
    ...
    //   230: invokestatic 185	com/tencent/bugly/proguard/x:d	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   233: pop
    //   234: goto -103 -> 131
    //   237: astore 4
    //   239: aload_2
    ...
    //   245: ifnull +9 -> 254
    //   248: aload_3
    //   249: invokeinterface 866 1 0
    //   254: aload_2
    //   255: athrow
    //   256: aload_3
    //   257: invokevirtual 153	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   260: ldc_w 880
    //   263: invokevirtual 157	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   266: ifeq +116 -> 382
    ...
    //   275: aload_3
    //   276: ldc_w 880
    //   279: invokevirtual 885	java/lang/StringBuilder:lastIndexOf	(Ljava/lang/String;)I
    //   282: invokevirtual 889	java/lang/StringBuilder:substring	(II)Ljava/lang/String;
    //   285: invokespecial 691	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   288: astore_3
    //   289: aload_3
    //   290: ldc_w 891
    ...
    //   303: aload_3
    //   304: iconst_0
    //   305: invokevirtual 894	java/lang/StringBuilder:setLength	(I)V
    //   308: iload_1
    //   309: ifle +40 -> 349
    //   312: ldc_w 896
    //   315: iconst_2
    ...
    //   325: dup
    //   326: iconst_1
    //   327: invokestatic 860	com/tencent/bugly/proguard/p:a	()Lcom/tencent/bugly/proguard/p;
    //   330: ldc_w 862
    //   333: aload 5
    //   335: aconst_null
    //   336: aconst_null
    //   337: iconst_1
    //   338: invokevirtual 899	com/tencent/bugly/proguard/p:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Lcom/tencent/bugly/proguard/o;Z)I
    //   341: invokestatic 250	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   344: aastore
    //   345: invokestatic 185	com/tencent/bugly/proguard/x:d	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   348: pop
    //   349: aload_2
    //   350: ifnull +9 -> 359
    //   353: aload_2
    //   354: invokeinterface 866 1 0
    //   359: aload 4
    //   361: areturn
    //   362: astore_2
    //   363: aconst_null
    ...
    //   0	385	0	this	b
    //   89	220	1	i	int
    //   1	353	2	localObject1	Object
    //   362	9	2	localObject2	Object
    //   374	1	2	localObject3	Object
    //   64	52	3	localObject4	Object
    //   164	26	3	localThrowable1	Throwable
    //   240	132	3	localObject5	Object
    //   378	1	3	localThrowable2	Throwable
    //   9	178	4	localArrayList	ArrayList
    //   237	123	4	localList	List<a>
    //   368	5	4	localObject6	Object
    //   144	10	5	locala	a
    //   221	1	5	localThrowable3	Throwable
    //   301	33	5	str	String
    // Exception table:
    //   from	to	target	type
    //   83	90	164	java/lang/Throwable
    //   107	129	164	java/lang/Throwable
    //   131	146	164	java/lang/Throwable
    //   151	161	164	java/lang/Throwable
    //   223	234	164	java/lang/Throwable
    //   256	289	164	java/lang/Throwable
    //   289	308	164	java/lang/Throwable
    //   312	349	164	java/lang/Throwable
    //   189	214	221	java/lang/Throwable
    //   83	90	237	finally
    //   107	129	237	finally
    //   131	146	237	finally
    //   151	161	237	finally
  ...
  private List<CrashDetailBean> b(List<a> paramList)
  {
    ...
    //   63: getfield 833	com/tencent/bugly/crashreport/crash/a:a	J
    ...
    //   98: aload_3
    //   99: ldc_w 880
    //   102: invokevirtual 885	java/lang/StringBuilder:lastIndexOf	(Ljava/lang/String;)I
    //   105: invokevirtual 889	java/lang/StringBuilder:substring	(II)Ljava/lang/String;
    //   108: invokespecial 691	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   111: astore_3
    //   112: aload_3
    //   113: ldc_w 891
    ...
    //   125: aload_3
    //   126: iconst_0
    //   127: invokevirtual 894	java/lang/StringBuilder:setLength	(I)V
    //   130: invokestatic 860	com/tencent/bugly/proguard/p:a	()Lcom/tencent/bugly/proguard/p;
    //   133: ldc_w 862
    //   136: aconst_null
    //   137: aload_1
    //   138: aconst_null
    //   139: aconst_null
    //   140: iconst_1
    //   141: invokevirtual 865	com/tencent/bugly/proguard/p:a	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Lcom/tencent/bugly/proguard/o;Z)Landroid/database/Cursor;
    //   144: astore_1
    //   145: aload_1
    ...
    //   150: ifnull +9 -> 159
    //   153: aload_1
    //   154: invokeinterface 866 1 0
    //   159: aconst_null
    //   160: areturn
    //   161: new 91	java/util/ArrayList
    //   164: dup
    //   165: invokespecial 333	java/util/ArrayList:<init>	()V
    //   168: astore 5
    //   170: aload_3
    //   171: ldc_w 871
    ...
    //   185: istore_2
    //   186: aload_1
    //   187: invokeinterface 876 1 0
    //   192: ifeq +118 -> 310
    //   195: aload_1
    //   196: invokestatic 902	com/tencent/bugly/crashreport/crash/b:a	(Landroid/database/Cursor;)Lcom/tencent/bugly/crashreport/crash/CrashDetailBean;
    //   199: astore 4
    //   201: aload 4
    //   203: ifnull +40 -> 243
    //   206: aload 5
    ...
    //   332: aload_3
    //   333: ldc_w 880
    //   336: invokevirtual 885	java/lang/StringBuilder:lastIndexOf	(Ljava/lang/String;)I
    //   339: invokevirtual 889	java/lang/StringBuilder:substring	(II)Ljava/lang/String;
    //   342: invokespecial 691	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   345: astore 4
    //   347: aload 4
    //   349: ldc_w 891
    ...
    //   379: dup
    //   380: iconst_1
    //   381: invokestatic 860	com/tencent/bugly/proguard/p:a	()Lcom/tencent/bugly/proguard/p;
    //   384: ldc_w 862
    //   387: aload_3
    //   388: aconst_null
    //   389: aconst_null
    //   390: iconst_1
    //   391: invokevirtual 899	com/tencent/bugly/proguard/p:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Lcom/tencent/bugly/proguard/o;Z)I
  ...
  public final void a(List<CrashDetailBean> paramList, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    do
    {
      ...
      try
      {
        localObject1 = ((StrategyBean)localObject1).q;
        str = StrategyBean.b;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        case 7: 
          ...
          if ((z.a((String)((Map.Entry)localObject3).getValue())) || (((String)((Map.Entry)localObject3).getValue()).length() <= 100000)) {
            break label616;
          }
          str1 = ((String)((Map.Entry)localObject3).getValue()).substring(((String)((Map.Entry)localObject3).getValue()).length() - 100000);
