...
public class TraceFileHelper
{
  ...
  public static void readTraceFile(String paramString, b paramb)
  {
    ...
    //   39: aconst_null
    //   40: astore_0
    //   41: new 23	java/io/BufferedReader
    //   44: dup
    ...
    //   100: aload 7
    //   102: iconst_1
    //   103: anewarray 47	java/util/regex/Pattern
    //   106: dup
    //   107: iconst_0
    //   108: aload_0
    //   109: aastore
    ...
    //   147: dup
    //   148: invokespecial 30	java/lang/StringBuilder:<init>	()V
    //   151: aload 12
    //   153: iconst_4
    //   154: aaload
    ...
    //   170: invokevirtual 39	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   181: aload 7
    //   183: iconst_1
    //   184: anewarray 47	java/util/regex/Pattern
    //   187: dup
    //   188: iconst_0
    //   189: aload 9
    //   191: aastore
    ...
    //   230: invokevirtual 51	java/util/regex/Pattern:matcher	(Ljava/lang/CharSequence;)Ljava/util/regex/Matcher;
    //   233: astore 12
    //   235: aload 12
    ...
    //   289: aload 7
    //   291: iconst_2
    //   292: anewarray 47	java/util/regex/Pattern
    //   295: dup
    //   296: iconst_0
    //   297: aload 10
    //   299: aastore
    ...
    //   338: aload 12
    //   340: invokevirtual 51	java/util/regex/Pattern:matcher	(Ljava/lang/CharSequence;)Ljava/util/regex/Matcher;
    //   343: astore 13
    //   345: aload 13
    ...
    //   360: iconst_1
    //   361: aload 13
    //   363: invokevirtual 66	java/lang/String:length	()I
    //   366: iconst_1
    //   367: isub
    ...
    //   386: aload 12
    //   388: invokevirtual 51	java/util/regex/Pattern:matcher	(Ljava/lang/CharSequence;)Ljava/util/regex/Matcher;
    //   391: astore 12
    //   393: aload 12
    ...
    //   476: dup
    //   477: iconst_1
    //   478: new 29	java/lang/StringBuilder
    //   481: dup
    ...
    //   489: invokevirtual 34	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
