...
public final class b
{
  ...
  public static String a(String paramString1, int paramInt, String paramString2, boolean paramBoolean)
  {
    ...
    //   25: dup
    //   26: aload_0
    //   27: invokespecial 339	java/io/File:<init>	(Ljava/lang/String;)V
    //   30: astore 6
    //   32: aload 5
    //   34: astore 4
    //   36: aload 6
    ...
    //   64: iconst_0
    //   65: aload 6
    //   67: invokevirtual 344	java/io/File:length	()J
    //   70: invokestatic 347	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   73: aastore
    //   74: dup
    //   75: iconst_1
    //   76: aload 6
    //   78: invokevirtual 350	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   81: aastore
    //   82: invokestatic 352	com/tencent/bugly/proguard/x:a	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   85: pop
    //   86: getstatic 16	com/tencent/bugly/crashreport/crash/jni/b:a	Ljava/util/List;
    //   89: aload 6
    //   91: invokeinterface 357 2 0
    //   96: pop
    //   97: ldc_w 359
    //   100: iconst_0
    ...
    //   115: dup
    //   116: aload_0
    //   117: invokespecial 339	java/io/File:<init>	(Ljava/lang/String;)V
    //   120: iload_1
    //   121: iload_3
    //   122: invokestatic 362	com/tencent/bugly/proguard/z:a	(Ljava/io/File;IZ)Ljava/lang/String;
    //   125: areturn
    //   126: new 162	java/lang/StringBuilder
    //   129: dup
    //   130: invokespecial 163	java/lang/StringBuilder:<init>	()V
    //   133: astore 5
    //   135: new 364	java/io/BufferedReader
    //   138: dup
    //   139: new 366	java/io/InputStreamReader
    //   142: dup
    ...
    //   152: ldc_w 368
    //   155: invokespecial 371	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   158: invokespecial 374	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   161: astore 4
    //   163: aload 4
    //   165: astore_0
    //   166: aload 4
    //   168: invokevirtual 377	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   171: astore 6
    //   173: aload 6
    //   175: ifnull +91 -> 266
    //   178: aload 4
    ...
    //   201: invokestatic 385	java/util/regex/Pattern:compile	(Ljava/lang/String;)Ljava/util/regex/Pattern;
    //   204: aload 6
    //   206: invokevirtual 389	java/util/regex/Pattern:matcher	(Ljava/lang/CharSequence;)Ljava/util/regex/Matcher;
    //   209: invokevirtual 394	java/util/regex/Matcher:find	()Z
    //   212: ifeq +19 -> 231
    //   215: aload 4
    //   217: astore_0
    //   218: aload 5
    ...
    //   256: iload_1
    //   257: aload 5
    //   259: invokevirtual 395	java/lang/StringBuilder:length	()I
    //   262: invokevirtual 399	java/lang/StringBuilder:delete	(II)Ljava/lang/StringBuilder;
    //   265: pop
    //   266: aload 4
    //   268: astore_0
    //   269: aload 5
    ...
    //   274: astore_2
    //   275: aload 4
    //   277: invokevirtual 400	java/io/BufferedReader:close	()V
    //   280: aload_2
    //   281: areturn
    //   282: astore_0
    //   283: aload_0
    ...
    //   295: iconst_0
    //   296: aload 5
    //   298: invokevirtual 395	java/lang/StringBuilder:length	()I
    //   301: iload_1
    //   302: isub
    //   303: invokevirtual 399	java/lang/StringBuilder:delete	(II)Ljava/lang/StringBuilder;
    //   306: pop
    //   307: goto -144 -> 163
    //   310: astore_0
    //   311: aload 4
    ...
    //   332: dup
    //   333: ldc_w 402
    //   336: invokespecial 403	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   339: aload 4
    //   341: invokevirtual 404	java/lang/Throwable:toString	()Ljava/lang/String;
    ...
    //   371: ifnull -352 -> 19
    //   374: aload_2
    //   375: invokevirtual 400	java/io/BufferedReader:close	()V
    //   378: aload_0
    //   379: areturn
    //   380: astore_2
    //   381: aload_2
    ...
    //   392: ifnull +7 -> 399
    //   395: aload_0
    //   396: invokevirtual 400	java/io/BufferedReader:close	()V
    //   399: aload_2
    //   400: athrow
    //   401: astore_0
    //   402: aload_0
