  ...
  extends DefaultEventListener
{
  ...
  private void setPageClickFlag(PathData paramPathData)
  {
    if (paramPathData == null) {}
    do
    {
      return;
      paramPathData = paramPathData.getPage();
    } while (paramPathData == null);
    DataRWProxy.setInnerParam(paramPathData, "page_click_flag", "1");
  }
  ...
  public void onViewClick(View paramView)
  {
    ...
    do
    {
      ...
      setPageClickFlag((PathData)localObject);
  ...
  {
    private static final ElementClickReporter INSTANCE = new ElementClickReporter(null);
