...
public class VsAppKeyVerify
{
    ...
    throws GeneralSecurityException, IOException
  {
    ...
    if (paramArrayOfByte.length % 384 != 0) {
      throw new IllegalBlockSizeException("The size of data is not a multiple of cipher block size. Data size=" + paramArrayOfByte.length);
    }
  ...
  public VsAppKeyBean verifyVsAppKey(Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      paramContext = new VsAppKeyBean(paramString, str1, paramContext, (String)localObject);
      VsAppKeyUtil.getInstance().add(paramContext);
      return paramContext;
    }
