  ...
  implements Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener, GestureDetector.OnGestureListener
{
  ...
  public void onAnimationEnd(Animator paramAnimator)
  {
    ...
    while ((paramAnimator != this.releaseAnim) || (this.b == null)) {
      return;
    }
  ...
  public boolean onFling(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    if ((this.originRect != null) && (this.curView != null) && (paramMotionEvent1 != null) && (paramMotionEvent1.size() == 4))
    {
      ...
      if (this.a != null)
      {
        paramMotionEvent2 = this.a.onModifyCurViewSize();
        j = m;
        i = k;
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          float f2;
          if (QLog.isColorLevel()) {
            QLog.d("DragView", 2, aurp.getStackTraceAsString(localException));
          }
        }
      }
  ...
  public void setDragChangeListener(a parama)
  {
    this.a = parama;
  }
  ...
  public void setGestureChangeListener(b paramb)
  {
    this.b = paramb;
  }
