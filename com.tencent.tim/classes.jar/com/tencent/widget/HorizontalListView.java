  ...
  extends AdapterView<ListAdapter>
{
  ...
  public static final int TAG_VIEW_TYPE = 2131721057;
  ...
  private b mOnItemScrollEventListener;
  private c mOnScrollLinstener;
  ...
  private void determineIfLowOnData()
  {
    if ((this.mRunningOutOfDataListener != null) && (this.mAdapter != null) && (this.mAdapter.getCount() - (this.mRightViewAdapterIndex + 1) < this.mRunningOutOfDataThreshold) && (!this.mHasNotifiedRunningLowOnData))
    {
      ...
      this.mRunningOutOfDataListener.ewY();
    }
  }
  ...
  private void markViewType(View paramView, int paramInt)
  {
    try
    {
      ...
      if ((paramView != null) && (isItemViewTypeValid(paramInt))) {
        paramView.setTag(2131721057, Integer.valueOf(paramInt));
      }
      return;
    }
  ...
  private View obtainView(int paramInt)
  {
    ...
    setTag(2131368625, Boolean.valueOf(true));
  ...
  {
    View localView1 = getRecycledView(paramInt);
    setTag(2131368625, Boolean.valueOf(paramBoolean));
    View localView2 = this.mAdapter.getView(paramInt, localView1, this);
    markViewType(localView2, paramInt);
    if ((localView1 != null) && (localView2 != localView1)) {
      recycleView(paramInt, localView1);
    ...
    while ((i >= 0) && (i <= j))
    {
      ...
      if (localView != null)
      {
        if (this.mRecycleListener != null) {
          this.mRecycleListener.fG(localView);
        }
    ...
    if (this.mScroller.computeScrollOffset())
    {
      ...
      if (k != m)
      {
        ...
        if ((i == 0) || ((i == 1) && (i1 > 0)))
        {
          ...
          this.mScroller.springBack(getScrollX() + this.mNextX, getScrollY(), this.mNextX, this.mNextX, 0, 0);
          label210:
          if (m >= i2) {
            break label344;
          }
  ...
  public void fling(int paramInt)
  {
    ...
    if (getChildCount() > 0)
    {
      this.mScroller.fling(this.mNextX + getScrollX(), 0, getFlingVelocity(paramInt), 0, this.mMinX, this.mMaxX, 0, 0, Math.max(0, getWidth() / 2), 0);
      requestLayout();
    }
  }
  ...
  {
    this.mScroller = new auup(getContext());
        ...
        if ((int)Math.abs(f - this.mLastMotionX) > this.mTouchSlop)
        {
          ...
          if (localViewParent != null)
          {
            ...
            else
            {
              ...
              recycleVelocityTracker();
              if (this.mScroller.springBack(getScrollX() + this.mNextX, getScrollY(), this.mNextX, this.mNextX, 0, 0))
              {
                this.mTouchMode = 6;
                setCurrentScrollState(4099);
                invalidate();
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        if (this.mOnScrollLinstener != null) {
          this.mOnScrollLinstener.onScroll();
        }
  ...
  protected void recycleView(int paramInt, View paramView)
  {
    try
    {
      Object localObject = paramView.getTag(2131721057);
      ...
      for (;;)
      {
        try
        {
          ...
          if (isItemViewTypeValid(j))
          {
            ...
            if (this.mRecycleListener != null) {
              this.mRecycleListener.fH(paramView);
            }
          }
          return;
        }
  ...
  protected void removeNonVisibleChildren(int paramInt)
  {
    ...
    if ((localView != null) && (localView.getRight() + paramInt <= 0))
    {
      ...
      for (i = localView.getMeasuredWidth();; i = this.mDividerWidth + localView.getMeasuredWidth())
      {
        ...
        if (this.mOnItemScrollEventListener != null) {
          this.mOnItemScrollEventListener.ap(this.mLeftViewAdapterIndex, true);
        }
        this.mLeftViewAdapterIndex += 1;
        localView = getLeftmostChild();
        break;
    ...
    for (localView = getRightmostChild(); (localView != null) && (localView.getLeft() + paramInt >= getWidth()); localView = getRightmostChild())
    {
      ...
      removeViewInLayout(localView);
      if (this.mOnItemScrollEventListener != null) {
        this.mOnItemScrollEventListener.ap(this.mRightViewAdapterIndex, false);
      }
      this.mRightViewAdapterIndex -= 1;
    }
  }
  ...
  public void setOnItemScollEventListener(b paramb)
  {
  ...
  {
    this.mOnScrollLinstener = paramc;
  }
  
  public void setOnScrollStateChangedListener(d paramd)
  {
    this.mOnScrollStateChangedListener = paramd;
  }
  ...
  public void setRecycleListener(e parame)
  {
    this.mRecycleListener = parame;
  }
  ...
  public void setRunningOutOfDataListener(f paramf, int paramInt)
  {
    this.mRunningOutOfDataListener = paramf;
  ...
  public void smoothScrollToPosition(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.mPositionScroller.u(paramInt1, paramInt2, paramInt3);
  }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      if (HorizontalListView.this.needTtransTouchStateToParen()) {
        bool1 = ((View)HorizontalListView.this.getParent()).performLongClick();
      }
      while (bool1)
      {
        ...
        View localView = HorizontalListView.this.getChildAt(i - HorizontalListView.this.getFirstVisiblePosition());
        bool1 = bool2;
        if (localView != null)
        {
          i = HorizontalListView.this.mMotionPosition;
          ...
          if (aJL())
          {
            ...
            if (!HorizontalListView.this.mDataChanged) {
              bool1 = HorizontalListView.this.performLongPress(localView, i, l);
            }
          }
        }
      }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      if (HorizontalListView.this.mTouchMode == 0)
      {
        ...
        localView = (View)HorizontalListView.this.getParent();
        if ((HorizontalListView.this.needTtransTouchStateToParen()) || ((localView != null) && (!localView.hasFocusable())))
        {
          if ((HorizontalListView.this.mDataChanged) && (!HorizontalListView.this.needTtransTouchStateToParen())) {
            break label215;
          }
          HorizontalListView.this.updateTouchedView(localView);
      ...
      label169:
      label195:
      for (boolean bool = localView.isLongClickable();; bool = HorizontalListView.this.isLongClickable())
      {
        if (!bool) {
          break label206;
        }
        if (HorizontalListView.this.mPendingCheckForLongPress == null) {
          HorizontalListView.access$702(HorizontalListView.this, new HorizontalListView.CheckForLongPress(HorizontalListView.this, null));
        }
        HorizontalListView.this.mPendingCheckForLongPress.cCe();
        HorizontalListView.this.postDelayed(HorizontalListView.this.mPendingCheckForLongPress, i);
        return;
        localView = HorizontalListView.this.getChildAt(HorizontalListView.this.mMotionPosition - HorizontalListView.this.getFirstVisiblePosition());
        break;
      }
      label206:
      HorizontalListView.this.mTouchMode = 2;
    ...
    public void run()
    {
      ...
      do
      {
        do
        {
          ...
          {
            return;
          } while (HorizontalListView.this.mDataChanged);
          localListAdapter = HorizontalListView.this.mAdapter;
          i = this.esj;
        } while ((localListAdapter == null) || (i == -1) || (i >= localListAdapter.getCount()) || (!aJL()));
        localView = HorizontalListView.this.getChildAt(i - HorizontalListView.this.getFirstVisiblePosition());
      } while (localView == null);
    ...
    implements Runnable
  {
    ...
    private final int mExtraScroll = ViewConfiguration.get(HorizontalListView.this.getContext()).getScaledFadingEdgeLength();
    ...
    void bo(int paramInt1, int paramInt2, int paramInt3)
    {
      int i = HorizontalListView.this.mLeftViewAdapterIndex;
      int j = HorizontalListView.this.getChildCount();
      View localView = HorizontalListView.this.getChildAt(0);
      if ((paramInt1 < i) || (paramInt1 > j + i - 1)) {}
      for (paramInt1 = (paramInt1 - i) * (HorizontalListView.this.getChildAt(1).getLeft() - localView.getLeft()) + localView.getLeft(); paramInt1 == 0; paramInt1 = HorizontalListView.this.getChildAt(paramInt1 - i).getLeft() - Math.abs(localView.getLeft())) {
        return;
      }
      HorizontalListView.this.smoothScrollBy(-(paramInt1 + paramInt2), paramInt3);
    }
    
    void kZ(int paramInt1, int paramInt2)
    {
      bo(paramInt1, 0, paramInt2);
    }
    ...
    void postOnAnimation(Runnable paramRunnable)
    {
      try
      {
        ...
        {
          HorizontalListView.this.postOnAnimation(paramRunnable);
          return;
        }
    ...
    public void run()
    {
      ...
      if (!HorizontalListView.this.isFromRightToLeft) {}
      for (int j = HorizontalListView.this.mLeftViewAdapterIndex;; j = HorizontalListView.this.mRightViewAdapterIndex) {
        switch (this.mMode)
        {
        default: 
          return;
      ...
      for (i = 1;; i = -1)
      {
        ...
        i = (int)(HorizontalListView.this.getWidth() * f1);
        f2 = this.mScrollDuration;
        j = (int)(Math.abs(f1) * f2);
        HorizontalListView.this.smoothScrollBy(i, j);
        postOnAnimation(this);
        return;
        if (k <= m) {
          break;
      ...
      View localView = HorizontalListView.this.getChildAt(k - j);
      if (!HorizontalListView.this.isFromRightToLeft) {}
      for (i = -localView.getLeft();; i = HorizontalListView.this.getWidth() - localView.getRight())
      {
        i -= this.etz;
        j = (int)(this.mScrollDuration * (Math.abs(i) / HorizontalListView.this.getWidth()));
        HorizontalListView.this.smoothScrollBy(i, j);
        return;
      }
    }
    ...
    void startWithOffset(int paramInt1, int paramInt2, int paramInt3)
    {
      stop();
      if (HorizontalListView.this.mDataChanged) {
        HorizontalListView.this.mPositionScrollAfterLayout = new HorizontalListView.PositionScroller.2(this, paramInt1, paramInt2, paramInt3);
      }
      int j;
      do
      {
        return;
        j = HorizontalListView.this.getChildCount();
      } while (j == 0);
      int i;
      label135:
      label158:
      ...
      if (!HorizontalListView.this.isFromRightToLeft)
      {
        i = HorizontalListView.this.getPaddingLeft();
        paramInt2 += i;
        this.mTargetPos = Math.max(0, Math.min(HorizontalListView.this.mAdapter.getCount() - 1, paramInt1));
        this.etz = paramInt2;
        this.mBoundPos = -1;
        this.mLastSeenPos = -1;
        this.mMode = 5;
        ...
        paramInt1 = HorizontalListView.this.mLeftViewAdapterIndex;
        i = paramInt1 + j - 1;
      ...
      for (;;)
      {
        ...
        postOnAnimation(this);
        return;
        i = HorizontalListView.this.getPaddingRight();
        break;
        label201:
        paramInt1 = HorizontalListView.this.mRightViewAdapterIndex;
        break label135;
        label212:
        ...
        View localView = HorizontalListView.this.getChildAt(this.mTargetPos - paramInt1);
        if (!HorizontalListView.this.isFromRightToLeft) {}
        for (paramInt1 = -localView.getLeft();; paramInt1 = HorizontalListView.this.getWidth() - localView.getRight())
        {
          HorizontalListView.this.smoothScrollBy(paramInt1 - paramInt2, paramInt3);
          return;
        }
    ...
    void u(int paramInt1, int paramInt2, int paramInt3)
    {
      stop();
      if (HorizontalListView.this.mDataChanged) {
        HorizontalListView.this.mPositionScrollAfterLayout = new HorizontalListView.PositionScroller.1(this, paramInt1, paramInt2);
      }
      int j;
      do
      {
      ...
      if (!HorizontalListView.this.isFromRightToLeft)
      {
        i = HorizontalListView.this.mLeftViewAdapterIndex;
        j = j + i - 1;
        k = Math.max(0, Math.min(HorizontalListView.this.mAdapter.getCount() - 1, paramInt1));
        if (k >= i) {
          break label162;
        }
        paramInt1 = i - k + 1;
      ...
      {
        this.mTargetPos = k;
        bo(this.mTargetPos, paramInt2, this.mScrollDuration);
        return;
        i = HorizontalListView.this.mRightViewAdapterIndex;
        break;
        if (k > j)
        {
          paramInt1 = k - j + 1;
    ...
    extends DataSetObserver
  {
    ...
    public void onChanged()
    {
      ...
      HorizontalListView.access$402(HorizontalListView.this, false);
      HorizontalListView.this.unpressTouchedView();
  ...
  public static abstract interface e
  {
    ...
    public abstract void fH(View paramView);
  }
  
  public static abstract interface f
  {
    public abstract void ewY();
  }
  ...
  class g
  {
    ...
    public boolean aJL()
    {
      return (HorizontalListView.this.hasWindowFocus()) && (HorizontalListView.this.getWindowAttachCount() == this.esm);
    }
    
    public void cCe()
    {
      this.esm = HorizontalListView.this.getWindowAttachCount();
    }
  }
}
