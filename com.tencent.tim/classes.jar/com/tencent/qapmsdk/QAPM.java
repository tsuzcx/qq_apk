...
public class QAPM
{
  ...
  public static final int PROPERTY_KEY_BATTERY_LISTENER = 306;
  public static final int PROPERTY_KEY_MONITOR_LISTENER = 305;
  public static final int PROPERTY_KEY_RESOURCE_PUBLIC_MODE = 304;
  public static final int PROPERTY_KEY_USE_AUTHORSIZE = 301;
  public static final int PROPERTY_KEY_USE_BREAD_CRUMB = 303;
  public static final int PROPERTY_KEY_USE_REMOTE_CONFIG = 302;
  ...
  public static QAPM setProperty(int paramInt, @Nullable Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      continue;
      com.tencent.qapmsdk.base.config.RuntimeConfig.resourceMonitorPublicMode = ((Boolean)paramObject).booleanValue();
      continue;
      com.tencent.qapmsdk.base.listener.ListenerManager.batteryReportListener = (IBatteryReportListener)paramObject;
    }
  }
