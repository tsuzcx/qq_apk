...
public class CpuMeta
  extends BaseMeta
{
  public static final String TAG = "CpuMeta";
  ...
  public CpuMeta parse(String paramString)
  {
    try
    {
    ...
    {
      Logger.INSTANCE.exception("CpuMeta", paramString);
    }
    return this;
  }
}
 ...
 * Qualified Name:     com.tencent.qapmsdk.battery.config.CpuMeta
