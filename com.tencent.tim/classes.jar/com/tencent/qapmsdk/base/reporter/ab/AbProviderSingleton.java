...
public class AbProviderSingleton
{
  ...
  public static final String TAG = "AbFactorManger";
  ...
  public void addAbToParams(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      {
        Logger.INSTANCE.exception("AbFactorManger", "addFactorToAPM", paramJSONObject);
        return;
      }
  ...
  public String getAbFactors(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        Logger.INSTANCE.exception("AbFactorManger", "addFactorToAPM", localException);
      }
