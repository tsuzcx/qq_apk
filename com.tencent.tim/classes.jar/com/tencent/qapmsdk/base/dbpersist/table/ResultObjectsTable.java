  ...
  extends BaseTable
{
  ...
  public Object search(@NotNull SQLiteDatabase paramSQLiteDatabase, @NotNull Function0<? extends Object> paramFunction0)
  {
    ...
    //   12: new 232	java/util/ArrayList
    //   15: dup
    //   16: invokespecial 233	java/util/ArrayList:<init>	()V
    //   19: astore 4
    //   21: aload_2
    //   22: invokeinterface 239 1 0
    //   27: iconst_1
    //   28: invokestatic 188	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   31: invokestatic 243	kotlin/jvm/internal/Intrinsics:areEqual	(Ljava/lang/Object;Ljava/lang/Object;)Z
    //   34: ifeq +200 -> 234
    //   37: ldc 245
    //   39: astore_3
    //   40: aload_2
    ...
    //   46: iconst_1
    //   47: invokestatic 188	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   50: invokestatic 243	kotlin/jvm/internal/Intrinsics:areEqual	(Ljava/lang/Object;Ljava/lang/Object;)Z
    //   53: ifeq +188 -> 241
    //   56: iconst_5
    //   57: anewarray 247	java/lang/String
    //   60: astore_2
    //   61: aload_2
    //   62: iconst_0
    //   63: aload_0
    ...
    //   74: invokestatic 249	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   77: aastore
    //   78: aload_2
    //   79: iconst_2
    //   80: aload_0
    ...
    //   85: aload_2
    //   86: iconst_3
    //   87: getstatic 197	com/tencent/qapmsdk/base/dbpersist/DBDataStatus:TO_SEND	Lcom/tencent/qapmsdk/base/dbpersist/DBDataStatus;
    //   90: invokevirtual 201	com/tencent/qapmsdk/base/dbpersist/DBDataStatus:getValue	()I
    //   93: invokestatic 249	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   96: aastore
    //   97: aload_2
    //   98: iconst_4
    //   99: invokestatic 207	java/lang/System:currentTimeMillis	()J
    //   102: ldc 250
    //   104: i2l
    //   105: lsub
    //   106: invokestatic 253	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   109: aastore
    //   110: aload_1
    //   111: ldc 74
    //   113: aconst_null
    ...
    //   117: aconst_null
    //   118: aconst_null
    //   119: invokevirtual 257	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   122: astore_1
    //   123: aload_1
    //   124: ifnull +107 -> 231
    //   127: aload_1
    //   128: checkcast 259	java/io/Closeable
    //   131: astore_3
    //   132: aconst_null
    //   133: checkcast 230	java/lang/Throwable
    //   136: astore_2
    //   137: aload_2
    //   138: astore_1
    //   139: aload_3
    //   140: checkcast 127	android/database/Cursor
    //   143: astore 5
    //   145: aload_2
    //   146: astore_1
    //   147: aload 5
    //   149: invokeinterface 263 1 0
    //   154: pop
    //   155: aload_2
    //   156: astore_1
    //   157: aload 5
    ...
    //   169: aload_0
    //   170: aload 5
    //   172: invokespecial 268	com/tencent/qapmsdk/base/dbpersist/table/ResultObjectsTable:cursorToResultObject	(Landroid/database/Cursor;)Lcom/tencent/qapmsdk/base/reporter/uploaddata/data/ResultObject;
    //   175: astore 6
    //   177: aload 6
    //   179: ifnull +13 -> 192
    //   182: aload_2
    ...
    //   184: aload 4
    //   186: aload 6
    //   188: invokevirtual 272	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   191: pop
    //   192: aload_2
    //   193: astore_1
    //   194: aload 5
    //   196: invokeinterface 275 1 0
    //   201: pop
    //   202: goto -47 -> 155
    //   205: astore_2
    //   206: aload_2
    ...
    //   211: aload_3
    //   212: aload_1
    //   213: invokestatic 281	kotlin/io/CloseableKt:closeFinally	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   216: aload_2
    //   217: athrow
    //   218: astore_1
    //   219: getstatic 287	com/tencent/qapmsdk/common/logger/Logger:INSTANCE	Lcom/tencent/qapmsdk/common/logger/Logger;
    //   222: ldc 77
    //   224: aload_1
    //   225: checkcast 230	java/lang/Throwable
    //   228: invokevirtual 291	com/tencent/qapmsdk/common/logger/Logger:exception	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   231: aload 4
    //   233: areturn
    //   234: ldc_w 293
    //   237: astore_3
    //   238: goto -198 -> 40
    //   241: iconst_3
    //   242: anewarray 247	java/lang/String
    //   245: astore_2
    //   246: aload_2
    //   247: iconst_0
    //   248: aload_0
    ...
    //   259: invokestatic 249	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   262: aastore
    //   263: aload_2
    //   264: iconst_2
    //   265: aload_0
    ...
    //   273: aload_2
    //   274: astore_1
    //   275: getstatic 298	kotlin/Unit:INSTANCE	Lkotlin/Unit;
    //   278: astore 5
    //   280: aload_3
    //   281: aload_2
    //   282: invokestatic 281	kotlin/io/CloseableKt:closeFinally	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    //   285: aload 4
    //   287: areturn
    ...
    //   0	288	2	paramFunction0	Function0<? extends Object>
    //   39	242	3	localObject1	Object
    //   19	267	4	localArrayList	java.util.ArrayList
    //   143	136	5	localObject2	Object
  ...
  @Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/qapmsdk/base/dbpersist/table/ResultObjectsTable$Companion;", "", "()V", "COLUMN_ID", "", "COLUMN_IS_REAL_TIME", "COLUMN_OCCUR_TIME", "COLUMN_PARAMS", "COLUMN_PROCESS_NAME", "COLUMN_PRODUCT_ID", "COLUMN_STATUS", "COLUMN_UIN", "COLUMN_VERSION", "CREATE_RESULT_OBJECTS", "TABLE_RESULT_OBJECTS", "TAG", "qapmbase_release"}, k=1, mv={1, 1, 15})
