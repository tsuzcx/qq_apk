  ...
  extends SSLSocket
{
  ...
  private String getFd()
  {
    try
    {
      Object localObject1 = (Socket)ReflectionHelper.of(OPEN_SSL_SOCKET_IMPL).field("socket").get(this.sslSocket);
  ...
  public byte[] getAlpnSelectedProtocol()
  {
    try
    {
      byte[] arrayOfByte = (byte[])ReflectionHelper.of(OPEN_SSL_SOCKET_IMPL).method("getAlpnSelectedProtocol", new Class[0]).invoke(this.sslSocket, new Object[0]);
      return arrayOfByte;
    }
    catch (Exception localException)
    {
  ...
  public void setAlpnProtocols(byte[] paramArrayOfByte)
  {
    try
    {
      ReflectionHelper.of(OPEN_SSL_SOCKET_IMPL).method("setAlpnProtocols", new Class[] { [B.class }).invoke(this.sslSocket, new Object[] { paramArrayOfByte });
      return;
    }
  ...
  public void setHostname(String paramString)
  {
    try
    {
      ReflectionHelper.of(OPEN_SSL_SOCKET_IMPL).method("setHostname", new Class[] { String.class }).invoke(this.sslSocket, new Object[] { paramString });
      return;
    }
    catch (Exception paramString)
    {
  ...
  public void setUseSessionTickets(boolean paramBoolean)
  {
    try
    {
      ReflectionHelper.of(OPEN_SSL_SOCKET_IMPL).method("setUseSessionTickets", new Class[] { Boolean.TYPE }).invoke(this.sslSocket, new Object[] { Boolean.valueOf(paramBoolean) });
      return;
    }
    catch (Exception localException)
    {
