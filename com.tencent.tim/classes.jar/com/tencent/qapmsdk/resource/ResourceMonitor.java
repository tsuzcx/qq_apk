  ...
  extends QAPMMonitorPlugin
{
  ...
  {
    return RuntimeConfig.resourceMonitorPublicMode;
  }
    ...
    if ((RuntimeConfig.globalMonitorCount == 0) && ((SDKConfig.RES_TYPE & DefaultPluginConfig.ResourcePlugin.ResourceType.OPEN_RESOURCE.getValue()) > 0)) {
      try
      {
        if (RuntimeConfig.globalMonitorCount == 0)
        {
          ...
          new Handler(ThreadManager.getMonitorThreadLooper()).post(MonitorRunnable.getInstance());
        }
  ...
  public void start(String paramString1, String paramString2)
  {
    ...
    currentStage = paramString1;
    currentExtraInfo = paramString2;
    if (!isPublicMode()) {
      tidyStartTagItem(localTagItem);
    }
    for (;;)
    {
      ...
      return;
      MonitorRunnable.getInstance().scheduleDumpOnce();
    }
  }
  ...
  public void stop(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      if (!currentStage.equals(paramString1)) {
        break;
      }
      currentStage = "";
      if (!currentExtraInfo.equals(paramString2)) {
        break;
      }
      currentExtraInfo = "";
      return;
      ...
      {
        SceneMeta localSceneMeta = localTagItem1.sceneMeta;
        localSceneMeta.duration = (System.currentTimeMillis() - localTagItem1.eventTimeMills);
        localSceneMeta.stage = localTagItem1.stage;
        ListenerManager.monitorListener.onMetaGet(localSceneMeta);
      }
    }
  }
}
