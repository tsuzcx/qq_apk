...
public final class FileUtil
{
  ...
  public static final class Companion
  {
    ...
    /* Error */
    @JvmStatic
    public final boolean zipFiles(@NotNull List<String> paramList, @NotNull String paramString)
    {
      // Byte code:
      //   0: aload_1
      //   1: ldc_w 470
      //   4: invokestatic 255	kotlin/jvm/internal/Intrinsics:checkParameterIsNotNull	(Ljava/lang/Object;Ljava/lang/String;)V
      //   7: aload_2
      //   8: ldc_w 431
      //   11: invokestatic 255	kotlin/jvm/internal/Intrinsics:checkParameterIsNotNull	(Ljava/lang/Object;Ljava/lang/String;)V
      //   14: new 472	java/util/zip/ZipOutputStream
      //   17: dup
      //   18: new 378	java/io/BufferedOutputStream
      //   21: dup
      ...
      //   29: dup
      //   30: aload_2
      //   31: invokespecial 147	java/io/File:<init>	(Ljava/lang/String;)V
      //   34: invokespecial 473	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
      //   37: checkcast 385	java/io/OutputStream
      //   40: invokespecial 476	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
      //   43: checkcast 385	java/io/OutputStream
      //   46: invokespecial 477	java/util/zip/ZipOutputStream:<init>	(Ljava/io/OutputStream;)V
      //   49: astore_3
      //   50: aload_3
      //   51: checkcast 390	java/io/Closeable
      //   54: astore 6
      //   56: aconst_null
      //   57: checkcast 75	java/lang/Throwable
      //   60: astore 5
      //   62: aload 5
      //   64: astore_3
      //   65: aload 6
      //   67: checkcast 472	java/util/zip/ZipOutputStream
      //   70: astore 8
      //   72: aload 5
      //   74: astore_3
      //   75: aload_1
      //   76: checkcast 337	java/lang/Iterable
      //   79: astore 4
      //   81: aload 5
      //   83: astore_3
      //   84: new 189	java/util/ArrayList
      //   87: dup
      //   88: invokespecial 190	java/util/ArrayList:<init>	()V
      //   91: checkcast 192	java/util/Collection
      //   94: astore_1
      //   95: aload 5
      //   97: astore_3
      //   98: aload 4
      ...
      //   109: astore_3
      //   110: aload 4
      //   112: invokeinterface 346 1 0
      //   117: ifeq +101 -> 218
      //   120: aload 5
      //   122: astore_3
      //   123: aload 4
      //   125: invokeinterface 350 1 0
      //   130: astore 7
      //   132: aload 5
      //   134: astore_3
      //   135: new 104	java/io/File
      //   138: dup
      //   139: aload 7
      //   141: checkcast 291	java/lang/String
      //   144: invokespecial 147	java/io/File:<init>	(Ljava/lang/String;)V
      //   147: invokevirtual 151	java/io/File:exists	()Z
      //   150: ifeq -43 -> 107
      //   153: aload 5
      //   155: astore_3
      //   156: aload_1
      //   157: aload 7
      //   159: invokeinterface 478 2 0
      //   164: pop
      //   165: goto -58 -> 107
      //   168: astore_1
      //   169: aload_1
      ...
      //   174: aload 6
      //   176: aload_3
      //   177: invokestatic 407	kotlin/io/CloseableKt:closeFinally	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
      //   180: aload_1
      //   181: athrow
      //   182: astore_1
      //   183: getstatic 124	com/tencent/qapmsdk/common/logger/Logger:INSTANCE	Lcom/tencent/qapmsdk/common/logger/Logger;
      //   186: invokestatic 127	com/tencent/qapmsdk/common/util/FileUtil:access$getTAG$cp	()Ljava/lang/String;
      //   189: new 293	java/lang/StringBuilder
      //   192: dup
      //   193: invokespecial 294	java/lang/StringBuilder:<init>	()V
      //   196: ldc_w 480
      //   199: invokevirtual 301	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
      //   202: aload_2
      //   203: invokevirtual 301	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
      //   206: invokevirtual 308	java/lang/StringBuilder:toString	()Ljava/lang/String;
      //   209: aload_1
      //   210: checkcast 75	java/lang/Throwable
      //   213: invokevirtual 414	com/tencent/qapmsdk/common/logger/Logger:exception	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
      //   216: iconst_0
      //   217: ireturn
      //   218: aload 5
      //   220: astore_3
      //   221: aload_1
      //   222: checkcast 482	java/util/List
      //   225: checkcast 337	java/lang/Iterable
      //   228: invokeinterface 341 1 0
      //   233: astore_1
      //   234: aload 5
      //   236: astore_3
      //   237: aload_1
      //   238: invokeinterface 346 1 0
      //   243: ifeq +150 -> 393
      //   246: aload 5
      //   248: astore_3
      ...
      //   259: checkcast 291	java/lang/String
      //   262: invokespecial 147	java/io/File:<init>	(Ljava/lang/String;)V
      //   265: astore 4
      //   267: aload 5
      //   269: astore_3
      //   270: aload 8
      //   272: new 484	java/util/zip/ZipEntry
      //   275: dup
      //   276: aload 4
      //   278: invokevirtual 219	java/io/File:getName	()Ljava/lang/String;
      //   281: invokespecial 485	java/util/zip/ZipEntry:<init>	(Ljava/lang/String;)V
      //   284: invokevirtual 489	java/util/zip/ZipOutputStream:putNextEntry	(Ljava/util/zip/ZipEntry;)V
      //   287: aload 5
      //   289: astore_3
      //   290: aload 8
      //   292: bipush 9
      //   294: invokevirtual 492	java/util/zip/ZipOutputStream:setLevel	(I)V
      //   297: aload 5
      //   299: astore_3
      //   300: new 494	java/io/FileInputStream
      //   303: dup
      //   304: aload 4
      //   306: invokespecial 495	java/io/FileInputStream:<init>	(Ljava/io/File;)V
      //   309: checkcast 390	java/io/Closeable
      //   312: astore 7
      //   314: aload 5
      //   316: astore_3
      //   317: aconst_null
      //   318: checkcast 75	java/lang/Throwable
      //   321: astore 4
      //   323: aload 7
      //   325: checkcast 494	java/io/FileInputStream
      //   328: checkcast 497	java/io/InputStream
      //   331: aload 8
      //   333: checkcast 385	java/io/OutputStream
      //   336: sipush 20480
      //   339: invokestatic 503	kotlin/io/ByteStreamsKt:copyTo	(Ljava/io/InputStream;Ljava/io/OutputStream;I)J
      //   342: pop2
      //   343: aload 5
      //   345: astore_3
      //   346: aload 7
      //   348: aload 4
      //   350: invokestatic 407	kotlin/io/CloseableKt:closeFinally	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
      //   353: aload 5
      //   355: astore_3
      //   356: aload 8
      //   358: invokevirtual 506	java/util/zip/ZipOutputStream:flush	()V
      //   361: aload 5
      //   363: astore_3
      //   364: aload 8
      //   366: invokevirtual 509	java/util/zip/ZipOutputStream:closeEntry	()V
      //   369: goto -135 -> 234
      //   372: astore 4
      //   374: aload 4
      //   376: athrow
      ...
      //   381: aload 7
      //   383: aload 4
      //   385: invokestatic 407	kotlin/io/CloseableKt:closeFinally	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
      //   388: aload 5
      //   390: astore_3
      //   391: aload_1
      //   392: athrow
      //   393: aload 5
      //   395: astore_3
      //   396: getstatic 429	kotlin/Unit:INSTANCE	Lkotlin/Unit;
      //   399: astore_1
      //   400: aload 6
      //   402: aload 5
      //   404: invokestatic 407	kotlin/io/CloseableKt:closeFinally	(Ljava/io/Closeable;Ljava/lang/Throwable;)V
      //   407: iconst_1
      //   408: ireturn
      //   409: astore_1
      //   410: goto -32 -> 378
