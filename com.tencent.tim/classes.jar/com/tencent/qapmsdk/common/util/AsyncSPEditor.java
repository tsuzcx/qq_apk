...
public final class AsyncSPEditor
{
  ...
  public final boolean commit()
  {
    ...
    if (localEditor != null) {
      new Handler(ThreadManager.Companion.getMonitorThreadLooper()).post((Runnable)new CommitRunnable(localEditor));
    }
    return true;
  }
  ...
  final class CommitRunnable
    implements Runnable
  {
    private final SharedPreferences.Editor edit;
    
    public CommitRunnable()
    {
  ...
  @Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/qapmsdk/common/util/AsyncSPEditor$Companion;", "", "()V", "TAG", "", "common_release"}, k=1, mv={1, 1, 15})
