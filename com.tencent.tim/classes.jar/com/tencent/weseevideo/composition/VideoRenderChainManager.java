...
public class VideoRenderChainManager
{
  ...
  public VideoRenderChainManager(int paramInt, @NonNull TAVComposition paramTAVComposition, MediaModel paramMediaModel, IStickerContextInterface paramIStickerContextInterface)
  {
    this(paramInt, paramTAVComposition, paramMediaModel, paramIStickerContextInterface, null);
  }
  
  public VideoRenderChainManager(int paramInt, @NonNull TAVComposition paramTAVComposition, MediaModel paramMediaModel, IStickerContextInterface paramIStickerContextInterface, IEffectNodeInterface paramIEffectNodeInterface)
  {
    this(paramInt, paramTAVComposition, paramMediaModel, paramIStickerContextInterface, paramIEffectNodeInterface, null);
  }
  
  public VideoRenderChainManager(int paramInt, @NonNull TAVComposition paramTAVComposition, MediaModel paramMediaModel, IStickerContextInterface paramIStickerContextInterface, IEffectNodeInterface paramIEffectNodeInterface, VideoRenderChainConfigure paramVideoRenderChainConfigure)
  {
  ...
  public TAVComposition updateRenderChain(@NonNull MediaEffectModel paramMediaEffectModel)
  {
    ...
    this.mComposition.attachVideoEffectChain(new WSVideoEffectContext(null));
    return this.mComposition;
  }
  ...
  public static abstract interface IEffectNodeInterface
  {
    public abstract void insertEffectNode(VideoRenderChainManager paramVideoRenderChainManager, MediaEffectModel paramMediaEffectModel);
  }
  
  public static abstract interface IStickerContextInterface
  {
