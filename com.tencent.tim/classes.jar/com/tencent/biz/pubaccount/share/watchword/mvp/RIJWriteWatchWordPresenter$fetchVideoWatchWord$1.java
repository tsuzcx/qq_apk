...
{
  public RIJWriteWatchWordPresenter$fetchVideoWatchWord$1(nze paramnze, String paramString1, String paramString2)
  {
    super(3);
  }
  ...
  public final void invoke(@Nullable String paramString1, @NotNull String paramString2, boolean paramBoolean)
  {
    ...
    if (paramString1 != null) {
      if (((CharSequence)paramString1).length() > 0)
      {
        ...
        label84:
        locala.a(paramString1, paramString2, (String)localObject, paramBoolean, 1);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.share.watchword.mvp.RIJWriteWatchWordPresenter.fetchVideoWatchWord.1
