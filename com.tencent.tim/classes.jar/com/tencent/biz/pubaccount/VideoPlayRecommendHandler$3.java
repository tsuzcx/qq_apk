...
public class VideoPlayRecommendHandler$3
  implements Runnable
{
  public VideoPlayRecommendHandler$3(kcr paramkcr, kcs paramkcs, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, int paramInt4, int paramInt5, ArrayList paramArrayList2) {}
  
  public void run()
  {
    kcr.a(this.this$0, this.jdField_a_of_type_Kcs, this.val$uin, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo, this.val$type, this.jV, this.XO, this.rH, this.adQ, this.aHy, this.XP, this.lr, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructWeishiRedDotInfo, this.aHz, this.XQ, this.bk, null, 0, 0, this.aHA, this.aHD, this.jY);
  }
}
