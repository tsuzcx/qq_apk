...
public class ArticleInfoModule$40
  implements Runnable
{
  public ArticleInfoModule$40(lhf paramlhf, List paramList, ConcurrentHashMap paramConcurrentHashMap) {}
  
  public void run()
  {
    ArrayList localArrayList2 = new ArrayList();
    ArrayList localArrayList1 = new ArrayList();
    Iterator localIterator1 = this.hE.iterator();
    Object localObject;
    long l;
    int i;
    label161:
    ...
    for (;;)
    {
      if (localIterator1.hasNext())
      {
        ...
        if ((((oidb_cmd0x8c8.FeedsInfo)localObject).feeds_type.has()) && (((oidb_cmd0x8c8.FeedsInfo)localObject).msg_social_fees_info.has()) && (((oidb_cmd0x8c8.FeedsInfo)localObject).msg_social_fees_info.uint64_feeds_id.has()))
        {
          ...
          localObject = l + "" + i;
          localObject = (ArticleInfo)this.bi.get(localObject);
          if (localObject != null)
          {
            this.this$0.b((Entity)localObject);
            localConcurrentHashMap = (ConcurrentHashMap)lhf.a(this.this$0).get(Integer.valueOf(0));
    ...
    for (;;)
    {
      if (localObject != null)
      {
        ...
        lhf.a(this.this$0, Integer.valueOf(0), (ArticleInfo)localObject);
        localArrayList2.add(Long.valueOf(((ArticleInfo)localObject).mRecommendSeq));
      }
      localConcurrentHashMap = (ConcurrentHashMap)lhf.a(this.this$0).get(Integer.valueOf(70));
      if (localConcurrentHashMap == null) {
        break;
      }
      localIterator2 = localConcurrentHashMap.values().iterator();
      ...
      for (;;)
      {
        ...
        localConcurrentHashMap.remove(Long.valueOf(((ArticleInfo)localObject).mRecommendSeq));
        lhf.a(this.this$0, Integer.valueOf(70), (ArticleInfo)localObject);
