  ...
  implements Serializable
{
  ...
  public transient aofk decodedCommentContent;
  ...
  public void createDecodedCommentContent()
  {
    ...
    this.decodedCommentContent = new aofk(anbk.nn(this.commentContent), 7, 16);
  }
  ...
  public void createProcessedAuthorComment()
  {
    if (!TextUtils.isEmpty(this.authorComment))
    {
      ...
      localSpannableStringBuilder.append(new aofk(anbk.nn(this.authorComment), 7, 16));
  ...
  public void createProcessedCommentItemList(BaseActivity paramBaseActivity)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(localCommentInfo.authorNickName))
      {
        ...
        localSpannableStringBuilder.setSpan(new kqv(this, localCommentInfo, paramBaseActivity), 0, localSpannableStringBuilder.length(), 33);
      }
      if ((localCommentInfo.hasTarget) && (!TextUtils.isEmpty(localCommentInfo.toNickName)))
      {
        ...
        localSpannableStringBuilder.setSpan(new kqw(this, localCommentInfo, paramBaseActivity), k, localSpannableStringBuilder.length(), 33);
      }
      localSpannableStringBuilder.append("：");
      if (!TextUtils.isEmpty(localCommentInfo.commentContent)) {
        localSpannableStringBuilder.append(new aofk(anbk.nn(localCommentInfo.commentContent), 7, 16));
      }
