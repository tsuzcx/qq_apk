  ...
  extends CommentInfo
{
  ...
  public static CommentInfo buildFeedsOutsideComment(ArticleInfo paramArticleInfo, String paramString)
  {
    ...
    try
    {
      paramString = new String(aqgo.decode(str, 0));
    ...
    paramArticleInfo = ReadInJoyUserInfoModule.a(Long.parseLong(paramString.authorUin), new kqu(paramString));
    if (paramArticleInfo != null) {}
    for (paramArticleInfo = paramArticleInfo.nick;; paramArticleInfo = ReadInJoyUserInfoModule.getDefaultNickName())
    {
