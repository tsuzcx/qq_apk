  ...
  public void run()
  {
    if (ReadInJoyDeliverUGCActivity.b(this.this$0) != null)
    {
      ...
      if ((ReadInJoyDeliverUGCActivity.g(this.this$0).adapterList != null) && (ReadInJoyDeliverUGCActivity.h(this.this$0).adapterList.size() > 0))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (localPicData != null) {
            if (localPicData.b != null) {
              ((List)localObject).add(localPicData.b);
            } else if ((!TextUtils.isEmpty(localPicData.picPath)) && (new File(localPicData.picPath).exists())) {
              ((List)localObject).add(localPicData.picPath);
            }
          }
        }
      ...
      if (localObject != null)
      {
        ...
        ReadInJoyDeliverUGCActivity.e(this.this$0).getEditableText().insert(0, new aofk((CharSequence)localObject, 7));
      }
