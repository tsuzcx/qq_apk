...
public class RIJUgcVideoPublishManager$5
  implements Runnable
{
  public RIJUgcVideoPublishManager$5(mnw parammnw, UgcVideo paramUgcVideo) {}
  
  public void run()
  {
    QLog.i("RIJUGC.RIJUgcVideoPublishManager", 1, "Publish steps hav all finished. video status =" + this.c.status);
