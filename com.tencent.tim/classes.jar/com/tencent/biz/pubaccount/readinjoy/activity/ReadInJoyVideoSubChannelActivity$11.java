    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.a.mIsTopic)
        {
          ...
          kbp.a(null, "", str1, (String)localObject, 0, 0, "2", "", "", kct.a(this.a.mChannelID, localJSONObject), false);
          return;
        }
      ...
      for (;;)
      {
        try
        {
          ...
          if (this.a.mIsFollowed)
          {
            ...
            kbp.a(null, "", "0X80088BB", "0X80088BB", 0, 0, "3", "", "", kct.a(this.a.mChannelID, (JSONObject)localObject), false);
            return;
          }
        }
