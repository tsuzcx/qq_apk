  ...
  extends EntityManagerFactory
{
  ...
  private String[] a(com.tencent.mobileqq.app.SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   3: ldc 78
    //   5: aconst_null
    //   6: invokevirtual 82	com/tencent/mobileqq/app/SQLiteDatabase:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   9: astore 4
    //   11: aload 4
    //   13: ifnull +177 -> 190
    //   16: aload 4
    ...
    //   59: invokestatic 101	com/tencent/mobileqq/utils/SecurityUtile:decode	(Ljava/lang/String;)Ljava/lang/String;
    //   62: aastore
    //   63: aload 4
    //   65: astore 5
    //   67: aload 4
    ...
    //   109: astore 5
    //   111: aload_0
    //   112: getfield 17	com/tencent/biz/pubaccount/readinjoy/engine/ReadInJoyEntityManagerFactory:TAG	Ljava/lang/String;
    //   115: iconst_1
    //   116: ldc 109
    //   118: aload 6
    //   120: invokestatic 68	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   123: aload 4
    //   125: astore 5
    //   127: aload 6
    //   129: invokestatic 74	com/tencent/mobileqq/app/SQLiteOpenHelper:throwDebugException	(Ljava/lang/Exception;)V
    //   132: aload_1
    //   133: astore 5
    //   135: aload 4
    //   137: ifnull -40 -> 97
  ...
  public SQLiteOpenHelper build(String paramString)
  {
    ...
    {
      this.mInnerDbHelper = new EntityManagerFactory.SQLiteOpenHelperImpl(this, "readinjoy_message_node_" + paramString + ".db", null, 98);
  ...
  public boolean verifyAuthentication()
  {
    try
    {
      if (this.name.matches("^[0-9]*$"))
      {
        ...
        VerifyEntity localVerifyEntity = (VerifyEntity)localEntityManager.find(VerifyEntity.class, "flags=?", new String[] { "readinjoy_message_node_verify_entity" });
