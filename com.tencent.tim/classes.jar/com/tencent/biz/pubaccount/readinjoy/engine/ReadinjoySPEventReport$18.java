  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    localAttributeList1.att_value.set(String.valueOf(this.aNs));
    ...
    localAttributeList2.att_value.set(this.aNt + "");
    ...
    localAttributeList3.att_value.set(this.aHI + "");
    ...
    ocp.y(this.val$type, localArrayList);
  }
}
