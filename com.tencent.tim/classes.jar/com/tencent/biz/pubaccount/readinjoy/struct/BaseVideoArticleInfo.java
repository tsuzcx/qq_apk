...
{
  public static final Parcelable.Creator<BaseVideoArticleInfo> CREATOR = new mgv();
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          this.videoData = myo.a(localVideoData);
        }
  ...
  public void postRead()
  {
    ...
    try
    {
      ...
      if (this.videoDataObj != null) {
        this.videoData = myo.a(this.videoDataObj);
      }
      if ((this.articleListBytes != null) && (this.articleListBytes.length > 0))
      {
        ...
        {
          this.articleList.add(myo.a((Readinjoy.ArticleSummary)this.articleListObj.get(i)));
          i += 1;
        }
      }
    }
  ...
  public void prewrite()
  {
    ...
    {
      this.videoDataObj = myo.a(this.videoData);
      if (this.videoDataObj != null) {
    ...
    if (this.articleList != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null) {
          this.articleListObj.add(myo.a((BaseVideoArticleInfo)localObject2));
        }
      }
