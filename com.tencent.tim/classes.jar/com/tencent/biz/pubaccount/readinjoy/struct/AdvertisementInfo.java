  ...
  implements Parcelable
{
  ...
  public static final Parcelable.Creator<AdvertisementInfo> CREATOR = new mgo();
  ...
  @notColumn
  public kkx mAdvertisementSoftInfo;
  @notColumn
  ...
  public AdvertisementInfo(Parcel paramParcel)
  {
    ...
    this.mAdvertisementExtInfo = new kkw(this.mAdExtInfo);
  ...
  public AdvertisementInfo(articlesummary.AdInfo paramAdInfo)
  {
    ...
    processAdExtraDataInfo(this.mAdExtInfo);
    this.mLocalInfo = new mho(paramAdInfo.local_info);
  ...
  public static int getAdStyle(AdvertisementInfo paramAdvertisementInfo)
  {
    if (isAdvertisementInfo(paramAdvertisementInfo)) {
      return knc.d(paramAdvertisementInfo);
    }
    return 0;
  }
  ...
  public boolean isCommentAd()
  {
    if (this.mCommentAdParams != null) {
      return this.mCommentAdParams.agc;
    }
    return false;
  }
  ...
  {
    return (this.mAdvertisementExtInfo != null) && (this.mAdvertisementExtInfo.aJA == 32768);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          this.mImaxStyle = awit.sn("sp_key_ad_imax_style");
          if ((this.mImaxShowAdType == 1001) && ("1".equals(this.mImaxStyle))) {
            this.isIMaxAndNewStyle = true;
          }
          this.mCommentAdParams = new kky();
          this.mCommentAdParams.agc = paramString.optBoolean("comment_get_ads");
          this.mCommentAdParams.agd = paramString.optBoolean("comment_show_comment");
          this.mCommentAdParams.age = paramString.optBoolean("comment_button_flag");
          this.mCommentAdParams.aJM = paramString.optInt("comment_card_style");
          this.mCommentAdParams.aJN = paramString.optInt("comment_exposure_time_limit");
          this.mCommentAdParams.aJO = paramString.optInt("comment_exposure_count_limit");
          this.mCommentAdParams.sn = paramString.optInt("ad_start_time");
          return;
        }
      }
      catch (Exception paramString)
  ...
  {
    this.mAdvertisementSoftInfo = new kkx(paramString);
  }
  
  public void processSoftDataInfo(JSONObject paramJSONObject)
  {
    this.mAdvertisementSoftInfo = new kkx(paramJSONObject);
  }
