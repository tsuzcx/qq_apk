  ...
  implements Parcelable, Cloneable, Comparable<ArticleInfo>
{
  ...
  private void readFromParcel(ArticleInfo paramArticleInfo, Parcel paramParcel)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      while (i < j)
      {
        paramArticleInfo.mPictures[i] = kxm.b(paramParcel.readString());
        i += 1;
      }
    }
    paramArticleInfo.mSinglePicture = kxm.b(paramParcel.readString());
    paramArticleInfo.mVideoCoverUrl = kxm.b(paramParcel.readString());
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          try
          {
            ...
            paramArticleInfo.mTopicRecommendFeedsInfo = mih.a(localTopicRecommendFeedsInfo);
          }
        ...
        try
        {
          ...
          paramArticleInfo.mArkAppFeedsInfo = mgq.a(localArkAppFeedsInfo);
        }
  ...
  public mha makeDislikeParam(ArrayList<DislikeInfo> paramArrayList)
  {
    return makeDislikeParam(paramArrayList, this.innerUniqueID);
  }
  
  public mha makeDislikeParam(ArrayList<DislikeInfo> paramArrayList, String paramString)
  {
    mha localmha = new mha();
    if ((paramString != null) && (paramString.length() > 0)) {
      localmha.agR = paramString;
    }
    localmha.mArticleId = this.mArticleID;
    localmha.mDislikeInfos = paramArrayList;
    if (this.mSocialFeedInfo != null)
    {
      localmha.mFeedId = this.mSocialFeedInfo.mFeedId;
      localmha.vg = this.mSocialFeedInfo.a.uin;
    }
    if (kxm.u(this))
    {
      localmha.vg = this.mPolymericInfo.uin;
      localmha.topicId = this.mPolymericInfo.vr;
      localmha.mArticleId = 0L;
    }
    return localmha;
  }
