  ...
  implements Serializable
{
  ...
  public static Kandian210Msg0xeeInfo decodeFromPbBytes(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localNotifyInfo = new NotifyInfo();
        ...
        else
        {
          ...
          {
            localNotifyInfo.ordinaryPushInfo = new OrdinaryPushInfo();
            ...
            {
              localNotifyInfo.ordinaryPushInfo.orangeControlInfo = new OrangeControlInfo();
              ...
              ((OrangeControlInfo)localObject3).color = paramArrayOfByte;
              ((OrangeControlInfo)localObject3).fontSize = ((submsgtype0xee.OrangeControlInfo)localObject2).uint32_font_size.get();
            }
          }
          if ((localNotifyInfo1.msg_social_push_info.has()) && (localNotifyInfo1.msg_social_push_info.get() != null))
          {
            localNotifyInfo.socialPushInfo = new SocialPushInfo();
            ...
            ((SocialPushInfo)localObject3).biuReason = paramArrayOfByte;
            localObject3 = localNotifyInfo.socialPushInfo;
            ...
            ((SocialPushInfo)localObject3).biuComment = paramArrayOfByte;
          }
          if ((localNotifyInfo1.msg_ugc_push_info.has()) && (localNotifyInfo1.msg_ugc_push_info.get() != null))
          {
            localNotifyInfo.ugcPushInfo = new UGCPushInfo();
            ...
            ((UGCPushInfo)localObject2).ugcReason = paramArrayOfByte;
          }
  ...
  {
    return (Kandian210Msg0xeeInfo)kxm.a(paramQQAppInterface, "kandian_push_0x210_ee", true);
  }
  
  public static void removeKandian210Msg0xeeInfoFromSp()
  {
    kxm.af("kandian_push_0x210_ee", true);
  }
  
  public static void writeToSpAsync(Kandian210Msg0xeeInfo paramKandian210Msg0xeeInfo)
  {
    kxm.b("kandian_push_0x210_ee", paramKandian210Msg0xeeInfo, true);
  }
  ...
  public static class OrangeControlInfo
    implements Serializable
  {
    public String color;
    public int fontSize;
  ...
  public static class OrdinaryPushInfo
    implements Serializable
  {
    public Kandian210Msg0xeeInfo.OrangeControlInfo orangeControlInfo;
    
    public String toString()
    {
      if (this.orangeControlInfo != null) {
        return this.orangeControlInfo.toString();
      }
      return "";
    }
  }
  
  public static class SocialPushInfo
    implements Serializable
  {
  ...
  public static class UGCPushInfo
    implements Serializable
  {
    public long feedsId;
