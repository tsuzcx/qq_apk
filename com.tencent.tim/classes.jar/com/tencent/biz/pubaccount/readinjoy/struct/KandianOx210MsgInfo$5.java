...
public class KandianOx210MsgInfo$5
  implements Runnable
{
  public KandianOx210MsgInfo$5(mhm parammhm, QQAppInterface paramQQAppInterface) {}
  
  public void run()
  {
    SharedPreferences.Editor localEditor = awit.a(this.val$app, true, false).edit();
    localEditor.putString("kandian_push_0x210_msg_for_follow_show_in_folder", this.this$0.jO());
