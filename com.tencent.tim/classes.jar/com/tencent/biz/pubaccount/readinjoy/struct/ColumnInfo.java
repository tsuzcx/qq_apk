...
{
  public static final Parcelable.Creator<ColumnInfo> CREATOR = new mgx();
  ...
  public ColumnInfo(mmx parammmx)
  {
    String str;
    if (parammmx.coverUrl != null)
    {
      str = parammmx.coverUrl;
      this.coverUrl = str;
      if (parammmx.title == null) {
        break label80;
      }
      str = parammmx.title;
      label51:
      this.title = str;
      if (parammmx.brief == null) {
        break label86;
      }
    }
    label80:
    label86:
    for (parammmx = parammmx.brief;; parammmx = "")
    {
      this.intro = parammmx;
      return;
      str = "";
