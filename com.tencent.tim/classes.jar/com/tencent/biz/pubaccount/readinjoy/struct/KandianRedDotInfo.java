  ...
  implements Serializable
{
    ...
    try
    {
      ...
      try
      {
        ...
        if (paramString != null)
        {
          ...
          DailyFloatingWindowData localDailyFloatingWindowData = localKandianRedDotInfo.floatingWinData;
          if (i != 1) {
            break label507;
          }
          bool = true;
      ...
      paramMessageRecord = kxm.a(paramMessageRecord);
  ...
  {
    return (KandianRedDotInfo)kxm.a(paramAppRuntime, paramString, paramBoolean);
  }
  ...
  {
    kxm.af(this.type, paramBoolean);
  }
  
  public void saveToDiskAsync(boolean paramBoolean)
  {
    kxm.b(this.type, this, true);
  }
  ...
  public static class DailyFloatingWindowData
    implements Serializable
  {
