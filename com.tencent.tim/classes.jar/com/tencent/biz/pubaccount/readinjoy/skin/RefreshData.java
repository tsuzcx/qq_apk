...
public class RefreshData
  extends SkinData
{
  public List<a> adClickReports;
  public List<a> adExposureReports;
  public Long adId;
  public boolean isAD;
  ...
  public RefreshData(JSONObject paramJSONObject)
  {
    ...
    if (localObject1 != null)
    {
      ...
      while (i < ((JSONArray)localObject1).length())
      {
        ...
        {
          a locala = new a();
          locala.reportUrl = ((JSONObject)localObject2).optString("reportUrl", "");
          this.adClickReports.add(locala);
        }
        i += 1;
      }
    }
    ...
    if (paramJSONObject != null)
    {
      ...
      while (i < paramJSONObject.length())
      {
        ...
        {
          localObject2 = new a();
          ((a)localObject2).reportUrl = ((JSONObject)localObject1).optString("reportUrl", "");
  ...
  public RefreshData(oidb_0x5bd.RefreshInfo paramRefreshInfo)
  {
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        this.adClickReports.add(a.a(localAdReport));
      }
      bool = false;
    }
    ...
    if ((paramRefreshInfo != null) && (paramRefreshInfo.size() > 0))
    {
      ...
      while (paramRefreshInfo.hasNext())
      {
        ...
        this.adExposureReports.add(a.a((oidb_0x5bd.AdReport)localObject));
      }
    }
  }
  
  public List<String> getUrls(List<a> paramList)
  {
    ...
    while (paramList.hasNext()) {
      localArrayList.add(((a)paramList.next()).reportUrl);
    }
  ...
  public JSONObject toJson()
  {
    ...
    try
    {
      ...
      while ((this.adClickReports != null) && (i < this.adClickReports.size()))
      {
        ...
        localJSONObject2.put("reportUrl", ((a)this.adClickReports.get(i)).reportUrl);
      ...
      {
        localJSONObject2 = new JSONObject();
        localJSONObject2.put("reportUrl", ((a)this.adExposureReports.get(i)).reportUrl);
        localJSONArray.put(localJSONObject2);
        i += 1;
      }
  ...
  public static class a
  {
    ...
    public static a a(oidb_0x5bd.AdReport paramAdReport)
    {
      a locala = new a();
