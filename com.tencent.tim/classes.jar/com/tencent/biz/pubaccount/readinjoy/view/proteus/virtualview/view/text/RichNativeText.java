  ...
  extends NativeText
{
  ...
  private void dealImgNode(ImgNode paramImgNode, int paramInt1, int paramInt2)
  {
    ...
    Object localObject2 = DrawableUtil.getDrawableFromNet(this.mContext.getContext(), paramImgNode.src, this.GRAY_PLACEHOLDER, this.GRAY_PLACEHOLDER, localRect.right, localRect.bottom, new DrawableCallBack(this));
    ...
    paramImgNode = new MyImageSpan((Drawable)localObject1, 1);
  ...
  class MyImageSpan
    extends ImageSpan
  {
    public MyImageSpan(Drawable paramDrawable, int paramInt)
    {
      super(paramInt);
    }
    ...
    public void draw(@NonNull Canvas paramCanvas, CharSequence paramCharSequence, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, @NonNull Paint paramPaint)
    {
      ...
      paramCanvas.translate(paramFloat, paramInt1 - RichNativeText.this.spaceHeight);
