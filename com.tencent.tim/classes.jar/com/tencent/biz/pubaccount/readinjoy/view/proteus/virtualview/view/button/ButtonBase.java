  ...
  extends TextBase
{
  ...
  private SparseArray<ClickStatus> mClickStatusArr = new SparseArray(4);
  ...
  private void setClickStatus(JSONArray paramJSONArray)
  {
    ...
    try
    {
      if (paramJSONArray.length() >= 4)
      {
        ...
        {
          ClickStatus localClickStatus = getStatus(Integer.valueOf(paramJSONArray.getString(i)).intValue());
  ...
  protected ClickStatus getStatus(int paramInt)
  {
    ClickStatus localClickStatus2 = (ClickStatus)this.mClickStatusArr.get(paramInt);
    ClickStatus localClickStatus1 = localClickStatus2;
    if (localClickStatus2 == null)
    {
      localClickStatus1 = new ClickStatus();
