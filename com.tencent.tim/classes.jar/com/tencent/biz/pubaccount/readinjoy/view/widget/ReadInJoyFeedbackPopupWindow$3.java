...
public class ReadInJoyFeedbackPopupWindow$3
  implements Runnable
{
  public ReadInJoyFeedbackPopupWindow$3(nrl paramnrl) {}
  
  public void run()
  {
    if (!nrl.a(this.this$0, "reportFeeds")) {}
    String str1;
    String str3;
    String str4;
    do
    {
      return;
      str1 = kxm.f(nrl.a(this.this$0));
      str3 = kxm.getAccount();
      str4 = String.valueOf(nrl.a(this.this$0).publishUin);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      try
      {
        ...
        if (i != 0)
        {
          ...
          String str2 = arwv.encodeHexStr(str1 + 200 + str5 + "jubao@article@123");
          localObject2 = str2;
          if (str2 != null)
          {
            localObject2 = str2;
          ...
          localObject2 = new Intent(this.this$0.mActivity, QQBrowserActivity.class);
          ((Intent)localObject2).putExtra("url", str1);
          ((Intent)localObject2).putExtra("hide_more_button", true);
          this.this$0.mActivity.startActivity((Intent)localObject2);
          return;
        }
      }
