...
public class RelativeLayoutHelper
{
  ...
  private List<Node> findRoots(List<ViewBase> paramList, int[] paramArrayOfInt)
  {
    ...
    while (i < k)
    {
      ...
      localObject1 = (Node)this.keyNodes.get(((ViewBase)localObject1).getName());
      String[] arrayOfString = ((RelativeLayout.Params)((Node)localObject1).view.getComLayoutParams()).getRule();
      ...
      if (j < m)
      {
        ...
        {
          localObject2 = (Node)this.keyNodes.get(localObject2);
        ...
        for (;;)
        {
          ...
          break;
          label143:
          ((Node)localObject2).lastItem.add(localObject1);
          ((Node)localObject1).thisRuleNode.add(localObject2);
        }
      }
      i += 1;
    }
    ...
    {
      paramArrayOfInt = (Node)((Map.Entry)paramList.next()).getValue();
  ...
  private static Map<String, Node> getNodes(List<ViewBase> paramList)
  {
  ...
  private RelativeLayout.Params getRelatedViewParams(String[] paramArrayOfString, int paramInt)
  {
    ...
    paramArrayOfString = (Node)this.keyNodes.get(paramArrayOfString[paramInt]);
  ...
  private static void removeNode(List<Node> paramList, String paramString)
  {
  ...
  public List<ViewBase> getSortedViews(int[] paramArrayOfInt)
  {
    ...
    {
      Object localObject1 = (Node)paramArrayOfInt.get(i);
      Object localObject2 = ((Node)localObject1).view;
      String str = ((ViewBase)localObject2).getName();
      localArrayList.add(localObject2);
      localObject1 = ((Node)localObject1).lastItem;
      int k = ((List)localObject1).size();
      int j = 0;
      while (j < k)
      {
        localObject2 = (Node)((List)localObject1).get(j);
        List localList = ((Node)localObject2).thisRuleNode;
