...
public class ProteusParser
{
  ...
  void dealMethod(ValueBean paramValueBean, String paramString, Object paramObject, HasDynamicDataCallback paramHasDynamicDataCallback)
  {
    String str = null;
    if ((paramObject instanceof String)) {
  ...
  static abstract interface HasDynamicDataCallback
  {
