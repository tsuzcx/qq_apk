  ...
  extends ViewBase
{
  ...
  {
    Params localParams = paramViewBase.getComLayoutParams();
  ...
  protected boolean setAttribute(int paramInt, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localGradientColorBg = new GradientColorBg();
      ...
      catch (Exception localException)
      {
        ...
        GradientColorBg localGradientColorBg;
        int j;
        int i;
  ...
  protected void setBackgroundColor(GradientColorBg paramGradientColorBg)
  {
