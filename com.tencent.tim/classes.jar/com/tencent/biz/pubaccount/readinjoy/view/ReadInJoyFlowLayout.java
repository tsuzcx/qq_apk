...
public class ReadInJoyFlowLayout
  extends AdapterView
{
  private final int TOUCH_SLOP = wja.dp2px(8.0F, getResources());
  private AdapterView.b a = new nfc(this);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      f3 = f2 - this.startY;
      f4 = f1 - this.startX;
    } while (f3 * f3 + f4 * f4 > this.TOUCH_SLOP * this.TOUCH_SLOP);
  ...
  {
    if ((this.mAdapter != null) && (this.a != null)) {
  ...
  public void setRangeSelection(int paramInt1, int paramInt2)
  {
    ...
    {
      obtainView(paramInt1).setSelected(true);
      paramInt1 += 1;
    }
  }
  ...
  public void setSelection(int paramInt)
  {
    ...
    if ((paramInt >= 0) && (paramInt < i)) {
      obtainView(paramInt).setSelected(true);
    }
  }
}
