...
public class KdCommentList
  extends VDiv
  implements ReadInJoyCommentListFragment.a, ksj.a, ksk.a, ktr.d
{
  ...
  public void onCommentCreate(boolean paramBoolean, ktm paramktm, List<ktm> paramList, int paramInt)
  {
    ...
    paramktm = new JSONObject();
    try
    {
      paramktm.put("commentChange", 1);
      fireCommentListEvent(paramktm);
      return;
    }
  ...
  public void onViewCreated(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.readInJoyCommentListFragment.a(this);
      this.readInJoyCommentListFragment.aGA();
