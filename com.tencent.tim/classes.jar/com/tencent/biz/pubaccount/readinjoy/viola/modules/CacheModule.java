  ...
  implements Destroyable
{
  ...
  public void getItem(@NonNull String paramString1, String paramString2)
  {
    ...
    paramString1 = aqhq.o("viola_cache_file_" + paramString1 + "_" + localAppRuntime.getAccount());
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramJSONObject = aqhq.o("viola_cache_file_" + str + "_" + localAppRuntime.getAccount());
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (i < paramJSONObject.length())
        {
          ...
          aqhq.deleteFile(BaseApplicationImpl.getContext().getFilesDir() + "/" + "viola_cache_file_" + str + "_" + paramString.getAccount());
          i += 1;
        }
        return;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        while (localIterator.hasNext())
        {
          ...
          aqhq.y("viola_cache_file_" + str1 + "_" + paramString.getAccount(), str2);
        }
        return;
      }
      catch (JSONException paramJSONObject)
  ...
  public void remove(@NonNull String paramString)
  {
    ...
    aqhq.deleteFile(BaseApplicationImpl.getContext().getFilesDir() + "/" + "viola_cache_file_" + paramString + "_" + localAppRuntime.getAccount());
  }
  ...
  public void setItem(@NonNull String paramString1, String paramString2)
  {
    ...
    aqhq.y("viola_cache_file_" + paramString1 + "_" + localAppRuntime.getAccount(), paramString2);
  }
}
