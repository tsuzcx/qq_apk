  ...
  extends VComponentContainer<VVideoView>
{
  ...
  private VComponentAdapter.OnVideoViewMethodListener mVideoViewMethodListener = new nwo(this);
  ...
  public VVideoView.a getVideoViewControlListener()
  {
  ...
  {
    if (getVideoViewControlListener() != null) {
      getVideoViewControlListener().setAccurate(paramBoolean);
    }
  }
  ...
  public void setHostLayoutParams(VVideoView paramVVideoView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    ...
    while ((((VVideoView)getHostView()).qZ() != 1) && (((VVideoView)getHostView()).qZ() != 9)) {
      return;
    }
    super.setHostLayoutParams(paramVVideoView, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6);
  }
  ...
  {
    if (getVideoViewControlListener() != null) {
      getVideoViewControlListener().setLoopBack(paramBoolean);
    }
  }
  ...
  {
    if (getVideoViewControlListener() != null) {
      getVideoViewControlListener().setRate(paramFloat);
    }
  }
