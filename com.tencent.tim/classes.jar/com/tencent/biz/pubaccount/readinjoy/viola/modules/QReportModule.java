  ...
  implements Destroyable
{
  ...
  private HashMap getDTBase()
  {
    ...
    localHashMap.put("av", "3.4.4");
    localHashMap.put("imei", aqgz.getIMEI());
    ...
    localHashMap.put("net_type", Integer.toString(jqc.getNetWorkType()));
    localHashMap.put("client_ip", cz.f(cz.s()));
  ...
  private void reportDTImpl(Context paramContext, String paramString, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      catch (JSONException paramJSONObject)
      {
        ...
        anpc.a(paramContext).collectPerformance(null, paramString, true, -1L, 0L, localHashMap, null);
      }
  ...
  public void reportT(@NonNull String paramString, JSONObject paramJSONObject)
  {
    ...
    {
      kbp.a(null, null, paramString, paramString, 0, 0, str1, str2, str3, paramJSONObject, false);
      return;
    }
  }
}
