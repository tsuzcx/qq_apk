...
public class TaskOfflineUtils
{
  ...
  public static ConfigData checkOffLineConfig(String paramString, int paramInt)
  {
    ConfigData localConfigData = new ConfigData();
    Object localObject = jpe.dO(paramString);
    if (localObject == null) {
  ...
  public static void checkUpdate(String paramString, int paramInt, OfflineCallBack paramOfflineCallBack)
  {
  ...
  {
    // Byte code:
    //   0: new 145	java/io/BufferedReader
    //   3: dup
    //   4: new 147	java/io/InputStreamReader
    //   7: dup
    //   8: aload_0
    //   9: invokespecial 150	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   12: invokespecial 153	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   15: astore_2
    ...
    //   23: astore_1
    //   24: aload_2
    //   25: invokevirtual 156	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   28: astore_3
    //   29: aload_3
    //   30: ifnull +31 -> 61
    //   33: aload_1
    ...
    //   39: goto -15 -> 24
    //   42: astore_2
    //   43: getstatic 27	com/tencent/biz/pubaccount/readinjoy/kandianreport/TaskOfflineUtils:TAG	Ljava/lang/String;
    //   46: iconst_2
    //   47: ldc 158
    //   49: invokestatic 52	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   52: aload_0
    //   53: invokevirtual 163	java/io/InputStream:close	()V
    //   56: aload_1
    ...
    //   69: goto -13 -> 56
    //   72: astore_1
    //   73: getstatic 27	com/tencent/biz/pubaccount/readinjoy/kandianreport/TaskOfflineUtils:TAG	Ljava/lang/String;
    //   76: iconst_2
    //   77: ldc 165
    //   79: invokestatic 52	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   82: aload_0
    //   83: invokevirtual 163	java/io/InputStream:close	()V
    //   86: aconst_null
    //   87: areturn
    //   88: astore_0
    //   89: aconst_null
    ...
    //   91: astore_1
    //   92: aload_0
    //   93: invokevirtual 163	java/io/InputStream:close	()V
    //   96: aload_1
    //   97: athrow
    //   98: astore_0
    //   99: goto -43 -> 56
  ...
  public static abstract interface OfflineCallBack
  {
    public abstract void onStateChange(int paramInt1, int paramInt2);
  }
  
  static class TaskAsyncBack
    implements jox
  {
    ...
    public TaskAsyncBack(String paramString, int paramInt, TaskOfflineUtils.OfflineCallBack paramOfflineCallBack)
    {
