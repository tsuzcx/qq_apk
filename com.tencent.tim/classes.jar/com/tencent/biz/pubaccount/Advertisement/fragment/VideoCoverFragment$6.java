    ...
    do
    {
      do
      {
        do
        {
          ...
          VideoCoverFragment.a(this.this$0).setStreamVolume(3, this.aEi, 0);
        } while (!QLog.isColorLevel());
        QLog.d("VideoCoverFragment", 2, "is broken by user click");
        return;
        if (!PublicAccountAdvertisementActivity.acx) {
          break;
        }
      } while (!QLog.isColorLevel());
      ...
      if (i < this.aEi)
      {
        ...
        VideoCoverFragment.a(this.this$0).postDelayed(this, this.aEj);
        return;
      }
    } while (!QLog.isColorLevel());
    QLog.d("VideoCoverFragment", 2, "smoothAdjustVolume() mTargetMusicVolume = " + this.aEi + ", SET mIsSmoothRaiseFinished = true, FINISHED");
  }
}
