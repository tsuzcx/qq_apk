...
public class HotchatPlugin$2
  implements Runnable
{
  public HotchatPlugin$2(ssx paramssx, String[] paramArrayOfString) {}
  
  public void run()
  {
    Object localObject2 = acfv.a();
    Object localObject1 = acfv.a(false);
    ...
    for (;;)
    {
      ...
      while ((this.val$args != null) && (this.val$args.length > 0))
      {
        localObject1 = new JSONObject(this.val$args[0]).getString("callback");
        ...
        this.this$0.callJs((String)localObject1, new String[] { localJSONException.toString() });
        return;
