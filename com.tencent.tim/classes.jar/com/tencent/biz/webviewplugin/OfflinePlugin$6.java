...
public class OfflinePlugin$6
  implements Runnable
{
  public OfflinePlugin$6(stw paramstw, String paramString1, String paramString2, CustomWebView paramCustomWebView) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      str1 = jpa.getFilePath(this.aGI);
      str2 = str1 + "_register_time";
      l1 = ((SharedPreferences)localObject2).getLong(str2, -1L);
      if ((!"0".equals(this.aGJ)) && (stw.Nl())) {
        break;
      }
    } while (l1 == -1L);
    if (QLog.isColorLevel()) {
      QLog.i("OfflinePluginQQ", 2, "unRegisterServiceWorker, url: " + this.aGI);
    }
    ((SharedPreferences)localObject2).edit().putLong(str2, -1L).commit();
    this.b.getX5WebViewExtension().unRegisterServiceWorker(this.aGI, true);
    return;
    QLog.i("OfflinePluginQQ", 1, String.format("now start registerServiceWorkerOffline, current tbs version: %d, url: %s", new Object[] { Integer.valueOf(i), jqo.filterKeyForLog(this.aGI, new String[0]) }));
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        ...
        if (((List)localObject3).size() > 0)
        {
          ...
          this.b.getX5WebViewExtension().registerServiceWorkerOffline(this.aGI, (List)localObject3, true);
        }
        if ((this.this$0.aq == null) || (this.this$0.aq.size() <= 0)) {
          break;
        }
        this.this$0.aq.clear();
        return;
      }
      label466:
      if (!QLog.isColorLevel()) {
