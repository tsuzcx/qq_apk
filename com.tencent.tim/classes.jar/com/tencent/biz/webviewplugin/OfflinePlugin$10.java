  ...
  implements Runnable
{
  ...
  {
    // Byte code:
    //   0: getstatic 27	stw:cy	Ljava/util/concurrent/ConcurrentHashMap;
    //   3: aload_0
    //   4: getfield 12	com/tencent/biz/webviewplugin/OfflinePlugin$10:val$businessId	Ljava/lang/String;
    ...
    //   18: astore 4
    //   20: aload_0
    //   21: getfield 12	com/tencent/biz/webviewplugin/OfflinePlugin$10:val$businessId	Ljava/lang/String;
    //   24: invokestatic 42	jpe:dO	(Ljava/lang/String;)Ljava/lang/String;
    //   27: astore_2
    //   28: aload_2
    ...
    //   47: aload_0
    //   48: getfield 12	com/tencent/biz/webviewplugin/OfflinePlugin$10:val$businessId	Ljava/lang/String;
    //   51: invokevirtual 55	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   54: getstatic 60	java/io/File:separator	Ljava/lang/String;
    //   57: invokevirtual 55	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   60: invokevirtual 64	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   63: astore 5
    //   65: new 57	java/io/File
    //   68: dup
    ...
    //   89: invokespecial 68	java/io/File:<init>	(Ljava/lang/String;)V
    //   92: astore_2
    //   93: aload_2
    //   94: invokevirtual 72	java/io/File:exists	()Z
    //   97: ifne +75 -> 172
    //   100: invokestatic 77	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   103: ifeq +29 -> 132
    //   106: ldc 79
    //   108: iconst_2
    ...
    //   129: invokestatic 85	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   132: aload 4
    ...
    //   154: invokevirtual 91	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   157: pop
    //   158: getstatic 27	stw:cy	Ljava/util/concurrent/ConcurrentHashMap;
    //   161: aload_0
    //   162: getfield 12	com/tencent/biz/webviewplugin/OfflinePlugin$10:val$businessId	Ljava/lang/String;
    //   165: aload 4
    //   167: invokevirtual 95	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   170: pop
    //   171: return
    //   172: new 97	com/tencent/commonsdk/zip/QZipFile
    //   175: dup
    //   176: aload_2
    //   177: invokespecial 100	com/tencent/commonsdk/zip/QZipFile:<init>	(Ljava/io/File;)V
    //   180: astore_3
    //   181: aload_3
    //   182: astore_2
    //   183: aload_3
    //   184: invokevirtual 104	com/tencent/commonsdk/zip/QZipFile:entries	()Ljava/util/Enumeration;
    //   187: astore 6
    //   189: aload_3
    //   190: astore_2
    //   191: aload_3
    //   192: invokevirtual 108	com/tencent/commonsdk/zip/QZipFile:size	()I
    //   195: ifne +153 -> 348
    //   198: bipush 16
    //   200: istore_1
    //   201: aload_3
    //   202: astore_2
    //   203: new 50	java/lang/StringBuilder
    //   206: dup
    //   207: iload_1
    //   208: invokespecial 111	java/lang/StringBuilder:<init>	(I)V
    //   211: astore 7
    //   213: aload_3
    //   214: astore_2
    //   215: aload 6
    //   217: invokeinterface 116 1 0
    //   222: ifeq +140 -> 362
    //   225: aload_3
    //   226: astore_2
    //   227: aload 6
    //   229: invokeinterface 120 1 0
    //   234: checkcast 122	java/util/zip/ZipEntry
    //   237: astore 8
    //   239: aload_3
    //   240: astore_2
    //   241: aload 8
    //   243: invokevirtual 125	java/util/zip/ZipEntry:isDirectory	()Z
    //   246: ifne -33 -> 213
    //   249: aload_3
    //   250: astore_2
    ...
    //   266: aload 5
    //   268: invokevirtual 55	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   271: aload 8
    //   273: invokevirtual 130	java/util/zip/ZipEntry:getName	()Ljava/lang/String;
    //   276: invokevirtual 55	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   279: ldc 132
    //   281: invokevirtual 55	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   284: pop
    //   285: aload_3
    //   286: astore_2
    //   287: aload 4
    //   289: new 50	java/lang/StringBuilder
    //   292: dup
    //   293: invokespecial 51	java/lang/StringBuilder:<init>	()V
    //   296: aload 5
    ...
    //   312: invokevirtual 91	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   315: pop
    //   316: goto -103 -> 213
    //   319: astore 4
    //   321: aload_3
    ...
    //   326: ldc 134
    //   328: aload 4
    //   330: invokestatic 138	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   333: aload_3
    //   334: ifnull -299 -> 35
    //   337: aload_3
    //   338: invokevirtual 141	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   341: return
    //   342: astore_2
    //   343: aload_2
    ...
    //   349: astore_2
    //   350: aload_3
    //   351: invokevirtual 108	com/tencent/commonsdk/zip/QZipFile:size	()I
    //   354: sipush 128
    //   357: imul
    //   358: istore_1
    //   359: goto -158 -> 201
    ...
    //   380: invokestatic 85	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   383: aload_3
    //   384: astore_2
    //   385: getstatic 27	stw:cy	Ljava/util/concurrent/ConcurrentHashMap;
    //   388: aload_0
    //   389: getfield 12	com/tencent/biz/webviewplugin/OfflinePlugin$10:val$businessId	Ljava/lang/String;
    //   392: aload 4
    //   394: invokevirtual 95	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   397: pop
    //   398: aload_3
    //   399: ifnull -364 -> 35
    //   402: aload_3
    //   403: invokevirtual 141	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   406: return
    //   407: astore_2
    //   408: aload_2
    //   409: invokevirtual 144	java/io/IOException:printStackTrace	()V
    //   412: return
    //   413: astore_3
    //   414: aconst_null
    //   415: astore_2
    ...
    //   417: ifnull +7 -> 424
    //   420: aload_2
    //   421: invokevirtual 141	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   424: aload_3
    //   425: athrow
    //   426: astore_2
    //   427: aload_2
    //   428: invokevirtual 144	java/io/IOException:printStackTrace	()V
    //   431: goto -7 -> 424
    //   434: astore_3
    //   435: goto -19 -> 416
    //   438: astore 4
