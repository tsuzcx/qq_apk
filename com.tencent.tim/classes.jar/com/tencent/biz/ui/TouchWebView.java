  ...
  implements WebViewCallbackClient
{
  ...
  public void addScrollChangedListener(OnScrollChangedListener paramOnScrollChangedListener)
  {
  ...
  public void onScrollChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4, View paramView)
  {
    ...
    if (this.mScrollChangedListenerArrayList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((OnScrollChangedListener)localIterator.next()).onScrollChanged(paramInt1, paramInt2, paramInt3, paramInt4, paramView);
      }
    }
  }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent, View paramView)
  {
    ...
    while ((this.helper != null) && (this.helper.aMr) && (paramMotionEvent.getAction() == 2)) {
      return true;
    }
  ...
  public void removeScrollChangedListener(OnScrollChangedListener paramOnScrollChangedListener)
  {
  ...
  public void setOnOverScrollHandler(OnOverScrollHandler paramOnOverScrollHandler)
  {
  ...
  public void setOnScrollChangedListenerForBiz(OnScrollChangedListener paramOnScrollChangedListener)
  {
    this.mScrollListenerForBiz = paramOnScrollChangedListener;
  }
  
  public void setWebViewHelper(sov paramsov)
  {
    this.helper = paramsov;
  }
  
  public static abstract interface OnOverScrollHandler
  {
