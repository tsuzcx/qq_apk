  ...
  extends View
{
  ...
  public void setProgress(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 < 0) || (paramInt1 >= this.mTotalCount)) {
      throw new IllegalArgumentException("setProgress Exception, progressIndex is < 0 or > mTotalCount, progressIndex = " + paramInt1 + ", mTotalCount = " + this.mTotalCount);
    }
