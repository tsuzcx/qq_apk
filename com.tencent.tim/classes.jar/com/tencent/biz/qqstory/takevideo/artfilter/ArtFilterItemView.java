  ...
  extends RelativeLayout
{
  ...
  public void a(EditVideoArtFilter paramEditVideoArtFilter)
  {
    ...
    localTranslateAnimation.setAnimationListener(new rfc(this, paramEditVideoArtFilter));
  ...
  {
    setVisibility(0);
    TranslateAnimation localTranslateAnimation = new TranslateAnimation(0.0F, 0.0F, wja.dp2px(228.0F, this.context.getResources()), 0.0F);
