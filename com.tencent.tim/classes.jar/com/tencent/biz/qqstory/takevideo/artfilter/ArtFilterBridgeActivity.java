  ...
  private void btG()
  {
    ...
    if (getIntent().getBooleanExtra("USE_FILTER", false))
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        if (localObject3 != null)
        {
          ...
          localIntent.putExtra("FILTER_MAXSIDE", ArtFilterManager.to());
    ...
    for (i = j | 0x10;; i = j)
    {
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        localObject3 = EditVideoParams.c(k);
        if (localObject3 == null) {
        ...
        for (;;)
        {
          ...
          if (bool2) {
            ((Bundle)localObject3).putString("extra_publish_text", acfp.m(2131702881));
          }
