...
{
  private GotoLocationPageDelayRunnable jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoGuide$GotoLocationPageDelayRunnable;
  private InitGuideTypeDelayRunnable jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoGuide$InitGuideTypeDelayRunnable;
  public int aYE;
  ...
  public EditVideoGuide(@NonNull rdc paramrdc)
  {
    super(paramrdc);
  }
  ...
  private boolean eN(int paramInt)
  {
    ...
    default: 
      ...
      return false;
    case 1: 
      this.yn.setText(acfp.m(2131705603));
    ...
    for (;;)
    {
      ...
      return true;
      this.yn.setText(acfp.m(2131705691));
      this.yn.measure(i, k);
      ...
      paramInt -= k;
      continue;
      this.yn.setText(acfp.m(2131705629));
      this.yn.measure(i, k);
      i = this.yn.getMeasuredWidth();
      ...
      paramInt -= k;
      continue;
      this.yn.setText(acfp.m(2131705631));
      this.yn.measure(i, k);
      i = this.yn.getMeasuredWidth();
      paramInt = wja.dp2px(114.0F, getContext().getResources());
      k = i / 2;
  ...
  private void startAnimation()
  {
    ...
    localTranslateAnimation.setAnimationListener(new rct(this));
  }
    ...
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
        ...
        if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoGuide$GotoLocationPageDelayRunnable == null) {
          this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoGuide$GotoLocationPageDelayRunnable = new GotoLocationPageDelayRunnable();
        }
        this.mHandler.postDelayed(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoGuide$GotoLocationPageDelayRunnable, 200L);
      }
      return;
    }
  }
  ...
  public boolean e(Message paramMessage)
  {
    ...
    if ((this.mHandler != null) && (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoGuide$InitGuideTypeDelayRunnable != null))
    {
      this.mHandler.removeCallbacks(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoGuide$InitGuideTypeDelayRunnable);
  ...
  public void onCreate()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoGuide$InitGuideTypeDelayRunnable == null) {
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoGuide$InitGuideTypeDelayRunnable = new InitGuideTypeDelayRunnable(null);
    }
    this.mHandler.postDelayed(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoGuide$InitGuideTypeDelayRunnable, 5000L);
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.mHandler != null)
    {
      if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoGuide$GotoLocationPageDelayRunnable != null)
      {
        this.mHandler.removeCallbacks(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoGuide$GotoLocationPageDelayRunnable);
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  {
                    return;
                    rsu localrsu = new rsu(this.jdField_a_of_type_Rel.getContext());
                    localrsu.sI(acfp.m(2131705633));
                    localrsu.show();
                    localrsu.setOnDismissListener(new rcr(this));
                    paramObject.n("has_show_basal_guide", Boolean.valueOf(true));
                    rar.a("video_edit", "guide_txt", 0, 0, new String[0]);
                    return;
                    paramObject = new rrq(this.jdField_a_of_type_Rel.getContext());
                    paramObject.sI(acfp.m(2131705678));
                  } while (((Activity)getContext()).isFinishing());
                  paramObject.show();
                  paramObject.setOnDismissListener(new rcs(this));
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      rba localrba = (rba)EditVideoGuide.this.a(rba.class);
      if (localrba != null) {
        localrba.bsa();
      }
    }
