  ...
  implements plu
{
  ...
  public static String convertFromItem(AddressItem paramAddressItem)
  {
    ...
    try
    {
      ...
      ram.d("AddressItem convertFromItem: ", localJSONObject.toString());
  ...
  public static AddressItem getAddressFromProtoObject(qqstory_struct.Address paramAddress)
  {
    ...
    ram.d("AddressItem :getAddressFromProtoObject()", "address is null");
    return null;
  }
  ...
  public static final String getQQStoryPoiJson(TroopBarPOI paramTroopBarPOI)
  {
    ...
    do
    {
      ...
      {
        JSONObject localJSONObject = new JSONObject();
        localJSONObject.put("latitude", paramTroopBarPOI.latitude);
        localJSONObject.put("longitude", paramTroopBarPOI.longitude);
        localJSONObject.put("uid", paramTroopBarPOI.uid);
