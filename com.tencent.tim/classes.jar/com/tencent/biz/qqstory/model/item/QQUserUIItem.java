  ...
  implements plu, ptq
{
  ...
  public void convertFrom(qqstory_struct.UserInfo paramUserInfo)
  {
    ...
    ((ptf)psx.a(2)).cq(this.uid, this.qq);
    ...
    for (this.sourceTagType = paramUserInfo.video_source_tag_type.get();; this.sourceTagType = 0)
    {
      if (QLog.isColorLevel()) {
        ram.b("UserManager", "convert %s", this.uid);
      }
      return;
      bool = false;
      break;
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(paramObject.headUrl))
      {
        if ((isMe()) && (!TextUtils.isEmpty(this.headUrl)) && (!TextUtils.equals(this.headUrl, paramObject.headUrl))) {
          ram.d("UserManager", "urlchange: %s -> %s  hashCode = %d -> %d %s", new Object[] { this.headUrl, paramObject.headUrl, Integer.valueOf(hashCode()), Integer.valueOf(paramObject.hashCode()), rov.getStackTrace(8) });
        }
  ...
  public boolean isFriend()
  {
    ...
    QQStoryContext.a();
    return ((acff)QQStoryContext.a().getManager(51)).isFriend(this.qq);
  }
  
  public boolean isMe()
  {
    return QQStoryContext.a().eU(this.uid);
  }
  ...
  {
    return qwr.b(new Object[] { "QQUserUIItem{nickName=", this.nickName, ", uid=", this.uid, ", isVip=", Boolean.valueOf(this.isVip), ",qq=", this.qq, ",isSubscribe=", Integer.valueOf(this.isSubscribe), ", headUrl=", this.headUrl, ", sourceTagType=", Integer.valueOf(this.sourceTagType) });
  }
    ...
    implements plu
  {
    ...
    public boolean IW()
    {
      return (QQStoryContext.a().eU(this.unionId)) || (QQStoryContext.a().eV(this.qq));
    }
    ...
    public qqstory_struct.UserId a()
    {
      ...
      if (!TextUtils.isEmpty(this.qq)) {
        localUserId.uid.set(Long.valueOf(this.qq).longValue());
      }
      localUserId.union_id.set(ByteStringMicro.copyFromUtf8(this.unionId));
      return localUserId;
    }
    ...
    public void copy(Object paramObject)
    {
      ...
      {
        this.qq = ((a)paramObject).qq;
        this.unionId = ((a)paramObject).unionId;
      }
    }
    
    public String toString()
    {
      return "UserID{qq=" + this.qq + ", unionId='" + this.unionId + '\'' + '}';
    }
  }
}
