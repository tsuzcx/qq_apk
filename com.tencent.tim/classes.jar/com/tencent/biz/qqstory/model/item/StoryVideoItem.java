...
public class StoryVideoItem
  extends BaseUIItem
  implements Comparable<StoryVideoItem>, plu
{
  ...
  public ptz mVideoSpreadGroupList;
  ...
  public StoryVideoItem(StoryVideoEntry paramStoryVideoEntry)
  {
    ...
    if (TextUtils.isEmpty(this.mPublishDate)) {
      this.mPublishDate = qvf.c().format(new Date(this.mCreateTime));
    }
    ...
    catch (Exception localInvalidProtocolBufferMicroException1)
    {
      try
      {
        ...
        this.mVideoSpreadGroupList = new ptz((qqstory_struct.VideoSpreadGroupList)localObject);
      ...
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException1)
      {
        try
        {
          ...
          this.mTagInfoBase = new rmw.a((qqstory_struct.TagInfoBase)localObject);
          ...
          try
          {
            do
            {
              for (;;)
              {
                ...
                this.mCompInfoBase = new rmq((qqstory_struct.CompInfoBase)localObject);
                ...
                ram.d("StoryVideoItem ,StoryVideoItem(StoryVideoEntry entry) error :", localException.toString());
                localException.printStackTrace();
                continue;
                localInvalidProtocolBufferMicroException5 = localInvalidProtocolBufferMicroException5;
                if (QLog.isColorLevel()) {
                  ram.d("StoryVideoItem ,StoryVideoItem(StoryVideoEntry entry) error :", localInvalidProtocolBufferMicroException5.toString());
                }
              }
              localInvalidProtocolBufferMicroException1 = localInvalidProtocolBufferMicroException1;
            } while (!QLog.isColorLevel());
            ram.d("StoryVideoItem ,StoryVideoItem(StoryVideoEntry entry) error :", localInvalidProtocolBufferMicroException1.toString());
          }
          catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException2)
          {
            ...
            if ((paramStoryVideoEntry.rateUsersBytes != null) && (paramStoryVideoEntry.rateUsersBytes.length > 0)) {
              try
              {
                ...
                this.mQimVideoInfoItem = ptt.a(paramStoryVideoEntry.mQimBytes);
              }
  ...
  public static boolean convertFromVideoAttr(StoryVideoItem paramStoryVideoItem, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        ram.w(paramString2, "decode json fail", paramStoryVideoItem);
      }
      if (i != 0)
      {
      ...
      {
        paramStoryVideoItem.mPollLayoutAttr = b.a((JSONObject)localObject);
        if (paramStoryVideoItem.mPollLayoutAttr == null)
        {
          ...
          ram.d(paramString2, "pl: " + ((JSONObject)localObject).toString());
        }
      }
      else
      {
        ...
        if (localObject != null)
        {
          paramStoryVideoItem.mInteractLayoutAttr = a.a((JSONObject)localObject);
      ...
      label529:
      for (paramStoryVideoItem.mInteractLayoutJson = null;; paramStoryVideoItem.mInteractLayoutJson = paramStoryVideoItem.mInteractLayoutAttr.getJson())
      {
        ram.d(paramString2, "il: " + ((JSONObject)localObject).toString());
        ...
        paramStoryVideoItem.mGameInfo = ptw.a(paramStoryVideoItem.mGameInfoJson);
        paramStoryVideoItem.comparedLevel = paramString1.optInt("comp_lv");
        break;
        paramStoryVideoItem.mPollLayoutJson = paramStoryVideoItem.mPollLayoutAttr.getJson();
        break label361;
      }
      label543:
      int i = 1;
  ...
  public static String convertToVideoAttr(StoryVideoItem paramStoryVideoItem, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        ram.w(paramString, "encode json fail", paramStoryVideoItem);
        continue;
      }
      try
      {
  ...
  {
    StoryVideoItem localStoryVideoItem = ((psu)psx.a(5)).a(paramString);
  ...
  public static int getPlayableFlag(String paramString, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (qln.a(BaseApplicationImpl.getContext()).JT()) && ((!TextUtils.isEmpty(localStoryVideoItem.mVideoUrl)) || (!TextUtils.isEmpty(localStoryVideoItem.mTempVideoUrl)))) {
      return 2;
    }
    if (pnh.a(paramString, 0, false, false) != null) {
      return 3;
    }
    return 4;
  }
  ...
  public void convertFrom(qqstory_struct.StoryVideoFullInfo paramStoryVideoFullInfo)
  {
    ...
    if ((paramStoryVideoFullInfo.group_list != null) && (paramStoryVideoFullInfo.group_list.has())) {
      this.mVideoSpreadGroupList = new ptz(paramStoryVideoFullInfo.group_list);
    }
    ...
    for (;;)
    {
      ...
      if (paramStoryVideoFullInfo.video_tag.has()) {
        this.mTagInfoBase = new rmw.a((qqstory_struct.TagInfoBase)paramStoryVideoFullInfo.video_tag.get());
      }
      if (paramStoryVideoFullInfo.qim_video_info.has()) {
        this.mQimVideoInfoItem = new ptt((qqstory_struct.QimVideoInfo)paramStoryVideoFullInfo.qim_video_info.get());
      }
  ...
  public void convertFrom(String paramString, qqstory_group.VideoInfoItem paramVideoInfoItem)
  {
    ...
    ((ptf)psx.a(2)).cq(this.mOwnerUid, String.valueOf(paramVideoInfoItem.uin.get()));
  ...
  public void convertFrom(String paramString, qqstory_struct.FeedVideoInfo paramFeedVideoInfo, boolean paramBoolean)
  {
    ...
    if (paramFeedVideoInfo.video_tag.has()) {
      this.mTagInfoBase = new rmw.a((qqstory_struct.TagInfoBase)paramFeedVideoInfo.video_tag.get());
    }
  ...
  public void convertFrom(String paramString, qqstory_struct.StoryVideoBasicInfo paramStoryVideoBasicInfo)
  {
    ...
    if ((paramStoryVideoBasicInfo.group_list != null) && (paramStoryVideoBasicInfo.group_list.has())) {
      this.mVideoSpreadGroupList = new ptz(paramStoryVideoBasicInfo.group_list);
    }
    ...
    if (paramStoryVideoBasicInfo.video_tag.has()) {
      this.mTagInfoBase = new rmw.a((qqstory_struct.TagInfoBase)paramStoryVideoBasicInfo.video_tag.get());
    }
  }
  ...
  public void convertFrom(String paramString, qqstory_struct.StoryVideoSimpleInfo paramStoryVideoSimpleInfo)
  {
    ...
    if ((paramStoryVideoSimpleInfo.group_list != null) && (paramStoryVideoSimpleInfo.group_list.has())) {
      this.mVideoSpreadGroupList = new ptz(paramStoryVideoSimpleInfo.group_list);
    }
  ...
  public StoryVideoEntry cover2StoryEntry()
  {
    ...
    if (localObject1 != null)
    {
      ...
      ((qqstory_struct.TagInfoBase)localObject2).tag_id.set(((rmw.a)localObject1).id);
      ((qqstory_struct.TagInfoBase)localObject2).tag_type.set(((rmw.a)localObject1).type);
      ((qqstory_struct.TagInfoBase)localObject2).tag_name.set(((rmw.a)localObject1).name);
      ((qqstory_struct.TagInfoBase)localObject2).tag_desc.set(((rmw.a)localObject1).desc);
    ...
    if (localObject1 != null)
    {
      ...
      ((qqstory_struct.CompInfoBase)localObject2).title.set(((rmq)localObject1).title);
      ((qqstory_struct.CompInfoBase)localObject2).backgroud_url.set(((rmq)localObject1).linkUrl);
    ...
    for (;;)
    {
      ...
      if (this.mQimVideoInfoItem != null) {
        localStoryVideoEntry.mQimBytes = this.mQimVideoInfoItem.J();
      }
      ...
      if (i != 0)
      {
        ...
        ram.e("StoryVideoItem", "cover2StoryEntry badData: vid=%s, polllist=%s", new Object[] { this.mVid, this.mPollUsers });
        annt.e(rpl.a.a("cover2StoryEntry, " + this.mPollUsers.toString(), null), "StoryVideoItem::cover2StoryEntry bad data");
      }
  ...
  public a getInteractLayout()
  {
    if (!isInteractVideo()) {
      return null;
    }
    if (this.mInteractLayoutAttr == null) {
      this.mInteractLayoutAttr = a.a(this.mInteractLayoutJson);
    }
    return this.mInteractLayoutAttr;
  }
  
  public pty getOALinkInfo()
  {
    if (this.mOALinkInfo == null) {
      this.mOALinkInfo = pty.a(this.mOALinkInfoJson);
    }
  ...
  public String getPollDescription()
  {
    ...
    return String.format("PollItem%s-%s-%s", new Object[] { this.mVid, String.valueOf(rol.toString(this.mPollNumbers)), String.valueOf(this.mPollResult) });
  }
  
  public b getPollLayout()
  {
    ...
    this.mPollLayoutAttr = b.a(this.mPollLayoutJson);
  ...
  public ptw getVideoGameInfo()
  {
    pty localpty = getOALinkInfo();
    if ((localpty != null) && (localpty.a != null)) {
      return localpty.a;
    }
    if (this.mGameInfo == null) {
      this.mGameInfo = ptw.a(this.mGameInfoJson);
    }
    return this.mGameInfo;
  }
  
  public pty getVideoLinkInfo()
  {
    if (this.mVideoLinkInfo == null) {
      this.mVideoLinkInfo = pty.a(this.mLinkInfoJson);
    }
  ...
  public int getVideoMaskType()
  {
    ...
    boolean bool2 = rox.fileExistsAndNotEmpty(this.mAtImagePath);
    if (bool1)
    {
      if (bool2) {
        return 3;
  ...
  public int isMaskDownloaded()
  {
    ...
    while (pnh.a(this.mVid, 1, false, false) != null) {
      return i;
    }
    return 0;
  }
  ...
  {
    return QQStoryContext.a().getCurrentUid().equals(this.mOwnerUid);
  }
  
  public boolean isPollVideo()
  {
    return !aqmr.isEmpty(this.mPollLayoutJson);
  }
  
  public boolean isTroopLocalVideoOnly()
  {
    return (this.mVideoSpreadGroupList != null) && (this.mVideoSpreadGroupList.bkr == 4);
  }
  ...
  public static class a
  {
    ...
    private a(JSONObject paramJSONObject)
    {
      ...
      try
      {
        this.ave = paramJSONObject.toString();
        this.type = paramJSONObject.getInt("t");
        this.rotation = paramJSONObject.getJSONObject("a").getInt("r");
        JSONArray localJSONArray = paramJSONObject.getJSONObject("a").getJSONArray("ss");
        this.screenWidth = localJSONArray.getInt(0);
        this.screenHeight = localJSONArray.getInt(1);
        localJSONArray = paramJSONObject.getJSONObject("a").getJSONArray("ls");
        this.bkn = localJSONArray.getInt(0);
        this.layoutHeight = localJSONArray.getInt(1);
        localJSONArray = paramJSONObject.getJSONObject("a").getJSONArray("lp");
        this.bko = localJSONArray.getInt(0);
        this.bkp = localJSONArray.getInt(1);
      ...
      this.bR = new String[j];
      while (i < j)
      {
        this.bR[i] = paramJSONObject.optString(i, "(NULL)");
        i += 1;
      }
    }
    
    public static a a(@Nullable String paramString)
    {
      try
      {
      ...
      {
        ram.d("StoryVideoItem.PollLayout", "fromJson()", paramString);
        return null;
      }
    ...
    public static a a(JSONObject paramJSONObject)
    {
      ...
      {
        ram.d("StoryVideoItem.PollLayout", "fromJson()", paramJSONObject);
      }
      return null;
    }
    ...
    public String toString()
    {
      return "PollLayout{type=" + this.type + ", screenWidth=" + this.screenWidth + ", screenHeight=" + this.screenHeight + ", layoutWidth=" + this.bkn + ", layoutHeight=" + this.layoutHeight + ", layoutCenterX=" + this.bko + ", layoutCenterY=" + this.bkp + ", rotation=" + this.rotation + ", contents=" + Arrays.toString(this.bR) + '}';
    }
  }
  ...
  public static class b
  {
    ...
    private b(JSONObject paramJSONObject)
    {
      ...
      {
        this.ave = paramJSONObject.toString();
        this.version = paramJSONObject.getInt("v");
    ...
    public static b a(JSONObject paramJSONObject)
    {
      try
      {
        paramJSONObject = new b(paramJSONObject);
        return paramJSONObject;
      }
      catch (IllegalArgumentException paramJSONObject)
      {
    ...
    public String toString()
    {
      return "PollLayout{version=" + this.version + ", id=" + this.id + ", screenWidth=" + this.screenWidth + ", screenHeight=" + this.screenHeight + ", layoutWidth=" + this.bkn + ", layoutHeight=" + this.layoutHeight + ", layoutCenterX=" + this.bko + ", layoutCenterY=" + this.bkp + ", rotation=" + this.rotation + ", contents=" + Arrays.toString(this.bR) + '}';
    }
  }
}
