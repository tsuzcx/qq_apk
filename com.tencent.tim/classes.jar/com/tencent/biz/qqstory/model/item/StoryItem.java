  ...
  implements plu
{
  ...
  public StoryItem(StoryEntry paramStoryEntry)
  {
    ...
    this.user = ((ptf)psx.a(2)).b(this.unionId);
    if (this.user == null)
    {
  ...
  public void convertFrom(int paramInt, qqstory_struct.StoryDes paramStoryDes)
  {
    ...
    this.user = ((ptf)localObject).a(localQQUserUIItem);
    localObject = ((psu)psx.a(5)).a(this.user.uid, paramInt);
    ...
    while (localObject == null)
    {
      ...
      {
        ram.w("Q.qqstory.home.StoryItem", "decode json fail", paramStoryDes);
        return;
      }
      if (localObject != null)
      {
