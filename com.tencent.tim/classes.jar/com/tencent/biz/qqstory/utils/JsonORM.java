...
{
  private static final Map<Class, b[]> sColumnInfoMap = new IdentityHashMap();
  
  private static b[] a(Class<?> paramClass)
    throws JsonORM.JsonParseException
  {
    ...
    paramClass = new b[localArrayList.size()];
  ...
  private static void parseColumnInfo(Class<?> paramClass, ArrayList<b> paramArrayList)
    throws JsonORM.JsonParseException
  {
    ...
    if (i != paramClass.length)
    {
      ...
      a locala = (a)localField.getAnnotation(a.class);
      if (locala == null) {}
      for (;;)
      {
        i += 1;
        break;
        paramArrayList.add(new b(locala.key(), getColumnInfoType(localField.getType()), localField));
      }
    }
  }
    ...
    throws JsonORM.JsonParseException
  {
    ...
    Object localObject2 = (b[])sColumnInfoMap.get(paramClass);
    ...
    throws JsonORM.JsonParseException
  {
    ...
    Object localObject2 = (b[])sColumnInfoMap.get(localClass);
    Object localObject1 = localObject2;
    if (localObject2 == null)
    {
  ...
  static final class b
  {
    ...
    public b(String paramString, int paramInt, Field paramField)
    {
