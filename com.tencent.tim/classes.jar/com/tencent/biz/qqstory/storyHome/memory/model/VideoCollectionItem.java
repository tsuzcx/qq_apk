  ...
  implements plu
{
  ...
  public List<b> collectionVideoUIItemList = new ArrayList();
  ...
  public static VideoCollectionItem getCurrentYearFakeItem(String paramString)
  {
    ...
    localVideoCollectionItem.collectionTime = roq.dW();
  ...
  public static VideoCollectionItem getDoubleTabItem()
  {
    ...
    localVideoCollectionItem.collectionId = "";
    localVideoCollectionItem.key = VideoCollectionEntry.getCollectionKey(localVideoCollectionItem.collectionType, localVideoCollectionItem.collectionId, QQStoryContext.a().getCurrentUid());
    localVideoCollectionItem.collectionTime = roq.dW();
    return localVideoCollectionItem;
  }
  ...
  public static VideoCollectionItem getTodayFakeItem(String paramString)
  {
    VideoCollectionItem localVideoCollectionItem = new VideoCollectionItem();
    localVideoCollectionItem.collectionId = "";
    localVideoCollectionItem.collectionTime = roq.dX();
    localVideoCollectionItem.key = VideoCollectionEntry.getCollectionKey(localVideoCollectionItem.collectionType, localVideoCollectionItem.collectionId, paramString);
    localVideoCollectionItem.collectionVideoUIItemList.add(new quf.b());
    return localVideoCollectionItem;
  }
    ...
    if (this.collectionType == 1)
    {
      ...
      if (paramDateVideoCollection.video_list.has())
      {
        ...
        while (paramString2.hasNext())
        {
          ...
          localObject1 = localpsu.a(((StoryVideoItem)localObject2).mVid, (StoryVideoItem)localObject2);
      ...
      if (paramDateVideoCollection.vid_list.has())
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (paramString2 == null) {
            paramString1 = localpsu.a((String)localObject2);
          }
          paramString1 = new b((String)localObject2, paramString1);
  ...
  public void convertFrom(String paramString1, String paramString2, qqstory_struct.GroupNodeInfo paramGroupNodeInfo)
  {
    ...
    for (paramString2 = paramGroupNodeInfo.more_start_cookie.get().toStringUtf8();; paramString2 = "")
    {
      ...
      while (paramGroupNodeInfo.hasNext())
      {
        ...
        this.videoItemList.add(localObject1);
        localObject2 = new b(((StoryVideoItem)localObject1).mVid, (StoryVideoItem)localObject1);
  ...
  public void copy(Object paramObject)
  {
    ...
    if (paramObject.collectionVideoUIItemList.size() > 0)
    {
      ...
      b localb = (b)this.collectionVideoUIItemList.get(0);
      if ((!(localb instanceof quf.b)) || ((paramObject.collectionVideoUIItemList.get(0) instanceof quf.b))) {
        break label435;
      }
      this.collectionVideoUIItemList.clear();
      this.collectionVideoUIItemList.add(localb);
    ...
    implements Comparator<VideoCollectionItem>
  {
    ...
    {
      if ((paramVideoCollectionItem1.collectionType != paramVideoCollectionItem2.collectionType) && (roq.l(paramVideoCollectionItem1.collectionTime, paramVideoCollectionItem2.collectionTime))) {
  ...
  public static class b
  {
    ...
    public StoryVideoItem l;
    public String mVid;
    
    public b(String paramString, StoryVideoItem paramStoryVideoItem)
    {
    ...
    public boolean equals(Object paramObject)
    {
      if ((paramObject instanceof b)) {
        return TextUtils.equals(this.mVid, ((b)paramObject).mVid);
      }
      return false;
    }
  }
