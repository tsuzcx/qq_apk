...
public class MemoriesVideoListSegment$5
  implements Runnable
{
  public MemoriesVideoListSegment$5(qul paramqul, MemoriesInnerListView paramMemoriesInnerListView, int paramInt, String paramString) {}
  ...
  public void run()
  {
    ...
    if (localView != null)
    {
      ram.b("Q.qqstory.memories.MemoriesVideoListSegment", "doScrollHorizal broadcast close animation2 %s", this.val$vid);
