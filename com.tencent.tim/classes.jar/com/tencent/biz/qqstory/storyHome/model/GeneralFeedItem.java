...
public class GeneralFeedItem
  extends VideoListFeedItem<qvj, QQUserUIItem>
{
  ...
  public static GeneralFeedItem createFakeFeedItem(String paramString)
  {
    ...
    localGeneralFeedItem.feedId = makeFakeFeedId(QQStoryContext.a().getCurrentUid(), paramString);
    localGeneralFeedItem.setDate(paramString);
    localGeneralFeedItem.mUserUIItem = ((ptf)psx.a(2)).a();
    if (localGeneralFeedItem.mUserUIItem == null)
    {
      localGeneralFeedItem.mUserUIItem = new QQUserUIItem();
      localGeneralFeedItem.mUserUIItem.uid = QQStoryContext.a().getCurrentUid();
      localGeneralFeedItem.mUserUIItem.qq = qem.getQQAppInterface().getCurrentAccountUin();
      localGeneralFeedItem.mUserUIItem.nickName = qem.getQQAppInterface().getCurrentNickname();
      localGeneralFeedItem.mUserUIItem.headUrl = "";
      ram.e("VideoListFeedItem", "create fake feed item while QQUserUIItem is null! use fake QQUserUIItem to instead.", new Object[] { localGeneralFeedItem.mUserUIItem.toString() });
    }
  ...
  public void copy(Object paramObject)
  {
    ...
    if (paramObject.mUserUIItem != null)
    {
      ...
      rom.checkNotNull(this.mUserUIItem);
    }
  ...
  public boolean covertFrom(String paramString, qqstory_struct.GeneralFeed paramGeneralFeed)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.mUserUIItem = ((ptf)psx.a(2)).a(paramString);
      rom.checkNotNull(this.mUserUIItem);
  ...
  public boolean isMyFeedItem()
  {
    ...
    return QQStoryContext.a().eU(this.mUserUIItem.getUnionId());
  }
  
  protected void onCovertFromEntry()
  {
    super.onCovertFromEntry();
    this.mUserUIItem = ((ptf)psx.a(2)).b(this.ownerId);
    if (this.mUserUIItem == null)
    {
      this.mUserUIItem = new QQUserUIItem();
      this.mUserUIItem.uid = QQStoryContext.a().getCurrentUid();
      this.mUserUIItem.qq = qem.getQQAppInterface().getCurrentAccountUin();
      this.mUserUIItem.nickName = qem.getQQAppInterface().getCurrentNickname();
      this.mUserUIItem.headUrl = "";
      ram.e("VideoListFeedItem", "create fake feed item while QQUserUIItem is null! use fake QQUserUIItem to instead.", new Object[] { this.mUserUIItem.toString() });
    }
  }
