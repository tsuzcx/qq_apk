...
public class TagFeedItem
  extends VideoListFeedItem<qwb, TagUserItem>
{
  public String blurb;
  ...
  public void covertFrom(String paramString, qqstory_struct.TagFeed paramTagFeed)
  {
    ...
    for (;;)
    {
      ...
      this.tagItem = new rmw((qqstory_struct.TagItem)paramTagFeed.tag_item.get());
  ...
  public byte[] covertToByte()
  {
    ...
    localTagFeed.tag_id.set(this.tagItem.a.id);
    localTagFeed.tag_type.set(this.tagItem.a.type);
    localTagFeed.tag_name.set(this.tagItem.a.name);
    localTagFeed.tag_desc.set(this.tagItem.a.desc);
    localTagFeed.join_count.set(this.tagItem.joinCount);
    localTagFeed.wording.set(this.tagItem.wording);
    ...
    throws InvalidProtocolBufferMicroException
  {
    ...
    this.tagItem = new rmw(new rmw.a(l, paramArrayOfByte, str1, i), j, str2);
