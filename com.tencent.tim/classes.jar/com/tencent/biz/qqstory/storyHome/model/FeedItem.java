...
public abstract class FeedItem<T extends qwa, E extends ptq>
  extends BaseUIItem
  implements plu
{
  ...
  public static FeedItem createFeedItemByType(int paramInt)
  {
    ...
    case 4: 
    default: 
      ram.e("Q.qqstory", "It can not create the illegal type:%s feed!", new Object[] { Integer.valueOf(paramInt) });
      return null;
    case 1: 
  ...
  public abstract void convertFromFeedFeature(ptp paramptp);
  ...
  public void covertFromEntry(FeedEntry paramFeedEntry)
  {
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      {
        for (;;)
        {
          ram.w("Q.qqstory", "invalid pb", localInvalidProtocolBufferMicroException);
        }
      }
    }
  }
  ...
  public void setDate(String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = qvf.c().format(new Date());
    }
    this.date = str;
    try
    {
      this.dateTimeMillis = qvf.c().parse(str).getTime();
      return;
    }
    catch (ParseException paramString)
    {
      ram.e("Q.qqstory.home", "parse date", paramString);
    }
  }
