  ...
  implements plu
{
  ...
  private JSONObject getExtraJson()
  {
    ...
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        ram.e("PublishVideoEntry", "getExtraJson error", localJSONException);
  ...
  public pty getLinkInfo()
  {
    ...
    try
    {
      localObject = (pty)JsonORM.parseFrom(new JSONObject((String)localObject), pty.class);
      return localObject;
    }
    catch (JsonORM.JsonParseException localJsonParseException)
    {
      ram.e("PublishVideoEntry", "getLinkInfo error", localJsonParseException);
      return null;
    }
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        ram.e("PublishVideoEntry", "getLinkInfo error", localJSONException);
      }
    }
  }
  ...
  public boolean putExtra(String paramString, Object paramObject)
  {
    ...
    {
      ram.e("PublishVideoEntry", "putStringExtra error", paramString);
    }
    return false;
  }
  ...
  public void setGameLinkInfo(String paramString)
  {
    ...
    {
      ram.e("PublishVideoEntry", "setGameLinkInfo error", paramString);
    }
  }
  
  public void setLinkInfo(@NonNull pty parampty)
  {
    try
    {
      putExtra("link", JsonORM.toJSON(parampty));
      return;
    }
    catch (JsonORM.JsonParseException parampty)
    {
      ram.e("PublishVideoEntry", "setLinkInfo error", parampty);
    }
  }
