  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   6: invokestatic 28	pxq:access$000	()Ljava/util/ArrayList;
    //   9: astore_1
    //   10: aload_1
    //   11: monitorenter
    //   12: invokestatic 28	pxq:access$000	()Ljava/util/ArrayList;
    //   15: invokevirtual 34	java/util/ArrayList:isEmpty	()Z
    //   18: ifne +32 -> 50
    //   21: new 30	java/util/ArrayList
    //   24: dup
    //   25: invokestatic 28	pxq:access$000	()Ljava/util/ArrayList;
    //   28: invokespecial 37	java/util/ArrayList:<init>	(Ljava/util/Collection;)V
    //   31: astore_2
    //   32: invokestatic 28	pxq:access$000	()Ljava/util/ArrayList;
    //   35: invokevirtual 40	java/util/ArrayList:clear	()V
    //   38: invokestatic 44	pxq:access$100	()Ljava/util/Set;
    //   41: invokeinterface 47 1 0
    //   46: aload_2
    //   47: invokestatic 51	pxq:ck	(Ljava/util/ArrayList;)V
    //   50: aload_1
    //   51: monitorexit
    //   52: iconst_0
    //   53: putstatic 55	pxq:aCB	Z
    //   56: return
    //   57: astore_2
    //   58: aload_1
    //   59: monitorexit
    ...
    //   62: astore_1
    //   63: aload_1
    //   64: invokevirtual 58	java/lang/InterruptedException:printStackTrace	()V
    //   67: iconst_0
    //   68: putstatic 55	pxq:aCB	Z
    //   71: return
    //   72: astore_1
    //   73: iconst_0
    //   74: putstatic 55	pxq:aCB	Z
    //   77: aload_1
    //   78: athrow
