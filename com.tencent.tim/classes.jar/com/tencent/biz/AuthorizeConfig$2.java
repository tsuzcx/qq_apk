...
public class AuthorizeConfig$2
  implements Runnable
{
  public AuthorizeConfig$2(jml paramjml, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    {
      Thread.sleep(5000L);
      str3 = this.this$0.mPref.getString("qqVersion", null);
      localObject3 = BaseApplicationImpl.getApplication().getRuntime();
      if (localObject3 == null) {
        break label350;
      }
      Object localObject1 = this.this$0.mPref.getString("lastVersion", null);
      localObject4 = new mobileqq_mp.WebviewWhiteListRequset();
      if ((!TextUtils.isEmpty((CharSequence)localObject1)) && ("2013 3.4.4".equals(str3)))
      {
      ...
      {
        ((mobileqq_mp.WebviewWhiteListRequset)localObject4).qqversion.set("3.4.4");
        ...
        localObject1 = new NewIntent(this.this$0.mContext, jnl.class);
    ...
    catch (InterruptedException localInterruptedException)
    {
      try
      {
        ...
        ((NewIntent)localObject1).setObserver(new jmm(this));
    ...
    label350:
    Object localObject4 = this.this$0.mPref.getString("lastMod", null);
    ...
    do
    {
      for (;;)
      {
        try
        {
          localObject3 = jqc.a(this.this$0.mContext, (String)localObject4, (String)localObject3, "GET", null, (Bundle)localObject2);
          if (localObject3 != null)
          {
            ...
            localObject2 = null;
            localObject3 = jqc.a((HttpResponse)localObject3);
            this.this$0.E((String)localObject3, (String)localObject2, "lastMod");
            anot.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_success", 1, 1, 0, "", "", "", "");
          }
        }
        catch (Exception localException2)
        {
          ...
          this.this$0.I.set(0);
          anot.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_failed", 1, 1, 0, "", "", "", "");
          return;
        }
    ...
    this.this$0.I.set(2);
    this.this$0.mPref.edit().putLong("lastUpdate", System.currentTimeMillis()).commit();
    anot.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_not_modify", 1, 1, 0, "", "", "", "");
  }
}
