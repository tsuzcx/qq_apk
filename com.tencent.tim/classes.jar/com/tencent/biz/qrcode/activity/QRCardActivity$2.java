  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      localObject1 = jqc.a(this.this$0, this.this$0.mHeaderUrl, "GET", null, null);
    ...
    for (;;)
    {
      m = (int)(75 * this.this$0.mDensity);
      n = (int)(75 * this.this$0.mDensity);
      ...
      localBitmap.recycle();
      i = (int)(6.0D * this.this$0.mDensity);
      ...
      this.this$0.bv.sendMessage((Message)localObject1);
      return;
      label379:
      do
      {
