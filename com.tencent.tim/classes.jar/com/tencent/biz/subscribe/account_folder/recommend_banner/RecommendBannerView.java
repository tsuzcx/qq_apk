  ...
  implements View.OnClickListener, rwx
{
  ...
  {
    setOrientation(1);
    inflate(paramContext, 2131558861, this);
    ...
    this.jdField_a_of_type_Sad.setInNightMode(rze.Mp());
    this.p.setAdapter(this.jdField_a_of_type_Sad);
    this.jdField_a_of_type_Sad.a(new saa(this));
  ...
  public void onClick(View paramView)
  {
    ...
    {
      bxD();
      sqn.b(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "auth_page", "clk_change", 0, 0, new String[0]);
      break;
      label108:
      this.p.smoothScrollToPosition(0);
    }
