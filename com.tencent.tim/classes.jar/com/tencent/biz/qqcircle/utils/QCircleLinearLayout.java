  ...
  extends LinearLayout
{
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    int i2 = aqcx.dip2px(getContext(), 5.0F);
    localPaint.setShadowLayer(aqcx.dip2px(getContext(), 15.0F), 0, i2, Color.parseColor("#99A6ABBD"));
    int i3 = aqcx.dip2px(getContext(), 6.0F);
