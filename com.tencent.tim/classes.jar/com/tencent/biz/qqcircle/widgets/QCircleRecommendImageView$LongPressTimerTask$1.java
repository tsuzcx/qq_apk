  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      {
        if ((QCircleRecommendImageView.a(localQCircleRecommendImageView) != null) && (ovd.a((FeedCloudMeta.StUser)QCircleRecommendImageView.a(localQCircleRecommendImageView).poster.get())))
        {
          QCircleRecommendImageView.h(localQCircleRecommendImageView);
          return;
        }
        if (QCircleRecommendImageView.b(localQCircleRecommendImageView) < QCircleRecommendImageView.gs())
        {
          ...
          FeedCloudMeta.StFeed localStFeed = localQCircleRecommendImageView.b();
          if ((localStFeed != null) && (!TextUtils.isEmpty(localStFeed.id.get()))) {
            rwv.a().a(new QCirclePushAnimationEvent(localStFeed.id.get(), QCircleRecommendImageView.e(localQCircleRecommendImageView), 3, QCircleRecommendImageView.f(localQCircleRecommendImageView)));
          }
