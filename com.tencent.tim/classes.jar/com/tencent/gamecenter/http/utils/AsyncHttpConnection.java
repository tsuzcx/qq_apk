  ...
  implements Runnable
{
    ...
    throws IllegalStateException, IOException
  {
    ...
    if (paramHttpEntity.getContentLength() > 0L)
    {
      ...
      paramHttpEntity = Message.obtain(this.handler, 1, paramHttpEntity);
      label212:
      if (this.handler == null) {
        break label258;
      }
      this.handler.sendMessage(paramHttpEntity);
    }
    for (;;)
    {
      ...
      break;
      label245:
      paramHttpEntity = Message.obtain(this.handler, 2, paramHttpEntity);
      break label212;
      label258:
      if (QLog.isColorLevel()) {
  ...
  public void run()
  {
    ...
    if (this.handler != null)
    {
      ...
      HttpConnectionParams.setConnectionTimeout(this.a.getParams(), 20000);
      localObject = null;
      i = j;
    }
    for (;;)
    {
      try
      {
        this.url = MsfSdkUtils.insertMtype("GameCenter", this.url);
        i = j;
        if (QLog.isColorLevel())
        {
          i = j;
          QLog.d("GameCenter", 2, "Http url= " + jqo.filterKeyForLog(this.url, new String[0]));
        }
        i = j;
        switch (this.method)
        {
        case 0: 
          i = j;
          if ((this.method <= 2) && (localObject != null))
          {
            i = j;
      ...
      break;
      i = j;
      localObject = new HttpGet(this.url);
      i = j;
      localObject = this.a.execute((HttpUriRequest)localObject);
      continue;
      i = j;
      ...
      i = j;
      ((HttpPost)localObject).setEntity(new StringEntity(this.strData, "utf-8"));
      i = j;
