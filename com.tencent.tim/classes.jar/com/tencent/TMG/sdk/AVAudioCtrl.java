...
public class AVAudioCtrl
{
  ...
  public int fillExternalAudioFrame(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 122	com/tencent/TMG/sdk/AVAudioCtrl:isEnableExternalAudioDataInput	Z
    //   6: ifeq +87 -> 93
    //   9: aload_0
    //   10: getfield 120	com/tencent/TMG/sdk/AVAudioCtrl:audioDataByteBuffer	Ljava/nio/ByteBuffer;
    //   13: ifnull +27 -> 40
    //   16: aload_0
    //   17: getfield 120	com/tencent/TMG/sdk/AVAudioCtrl:audioDataByteBuffer	Ljava/nio/ByteBuffer;
    //   20: invokevirtual 209	java/nio/ByteBuffer:capacity	()I
    //   23: iload_2
    //   24: if_icmpeq +16 -> 40
    //   27: aload_0
    //   28: getfield 120	com/tencent/TMG/sdk/AVAudioCtrl:audioDataByteBuffer	Ljava/nio/ByteBuffer;
    //   31: invokestatic 172	com/tencent/TMG/utils/NioUtils:destroyDirectByteBuffer	(Ljava/nio/ByteBuffer;)Z
    //   34: pop
    //   35: aload_0
    //   36: aconst_null
    //   37: putfield 120	com/tencent/TMG/sdk/AVAudioCtrl:audioDataByteBuffer	Ljava/nio/ByteBuffer;
    //   40: aload_0
    //   41: getfield 120	com/tencent/TMG/sdk/AVAudioCtrl:audioDataByteBuffer	Ljava/nio/ByteBuffer;
    //   44: ifnonnull +11 -> 55
    //   47: aload_0
    //   48: iload_2
    //   49: invokestatic 213	com/tencent/TMG/utils/NioUtils:createDirectByteBuffer	(I)Ljava/nio/ByteBuffer;
    //   52: putfield 120	com/tencent/TMG/sdk/AVAudioCtrl:audioDataByteBuffer	Ljava/nio/ByteBuffer;
    //   55: aload_0
    //   56: getfield 120	com/tencent/TMG/sdk/AVAudioCtrl:audioDataByteBuffer	Ljava/nio/ByteBuffer;
    //   59: aload_1
    //   60: iconst_0
    //   61: iload_2
    //   62: invokevirtual 217	java/nio/ByteBuffer:put	([BII)Ljava/nio/ByteBuffer;
    //   65: pop
    //   66: aload_0
    //   67: getfield 120	com/tencent/TMG/sdk/AVAudioCtrl:audioDataByteBuffer	Ljava/nio/ByteBuffer;
    //   70: invokevirtual 221	java/nio/ByteBuffer:clear	()Ljava/nio/Buffer;
    //   73: pop
    //   74: aload_0
    //   75: aload_0
    //   76: getfield 120	com/tencent/TMG/sdk/AVAudioCtrl:audioDataByteBuffer	Ljava/nio/ByteBuffer;
    //   79: iload_2
    //   80: iload_3
    //   81: iload 4
    //   83: iload 5
    //   85: invokespecial 223	com/tencent/TMG/sdk/AVAudioCtrl:nativeFillExternalAudioFrame	(Ljava/nio/ByteBuffer;IIII)I
    //   88: istore_2
    //   89: aload_0
    //   90: monitorexit
    //   91: iload_2
  ...
  void uninit()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 108	com/tencent/TMG/sdk/AVAudioCtrl:mAudioSession	Lcom/tencent/TMG/audio/TraeAudioSession;
    //   4: ifnull +31 -> 35
    //   7: aload_0
    //   8: getfield 108	com/tencent/TMG/sdk/AVAudioCtrl:mAudioSession	Lcom/tencent/TMG/audio/TraeAudioSession;
    //   11: aconst_null
    ...
    //   15: aload_0
    //   16: getfield 108	com/tencent/TMG/sdk/AVAudioCtrl:mAudioSession	Lcom/tencent/TMG/audio/TraeAudioSession;
    //   19: invokevirtual 342	com/tencent/TMG/audio/TraeAudioSession:stopService	()I
    //   22: pop
    //   23: aload_0
    //   24: getfield 108	com/tencent/TMG/sdk/AVAudioCtrl:mAudioSession	Lcom/tencent/TMG/audio/TraeAudioSession;
    //   27: invokevirtual 359	com/tencent/TMG/audio/TraeAudioSession:release	()V
    //   30: aload_0
    //   31: aconst_null
    //   32: putfield 108	com/tencent/TMG/sdk/AVAudioCtrl:mAudioSession	Lcom/tencent/TMG/audio/TraeAudioSession;
    ...
    //   62: aload_0
    //   63: iconst_0
    //   64: putfield 98	com/tencent/TMG/sdk/AVAudioCtrl:mIsPauseByUser	Z
    //   67: aload_0
    ...
    //   74: aload_0
    //   75: aconst_null
    //   76: putfield 108	com/tencent/TMG/sdk/AVAudioCtrl:mAudioSession	Lcom/tencent/TMG/audio/TraeAudioSession;
    //   79: goto -44 -> 35
    //   82: astore_1
    //   83: aload_0
    //   84: aconst_null
    //   85: putfield 108	com/tencent/TMG/sdk/AVAudioCtrl:mAudioSession	Lcom/tencent/TMG/audio/TraeAudioSession;
    //   88: aload_1
    //   89: athrow
    // Local variable table:
    //   start	length	slot	name	signature
