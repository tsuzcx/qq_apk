...
public class RingBuffer
{
  ...
  public boolean Pop(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    for (;;)
    {
      Log.d("WebRtcAudioRecord", "Pop pBuf: " + paramArrayOfByte[0] + " " + paramArrayOfByte[1] + " " + paramArrayOfByte[2] + " " + paramArrayOfByte[3] + " " + paramArrayOfByte[4]);
  ...
  public void Push(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    Log.d("WebRtcAudioRecord", "Push pBuf: " + paramArrayOfByte[0] + " " + paramArrayOfByte[1] + " " + paramArrayOfByte[2] + " " + paramArrayOfByte[3] + " " + paramArrayOfByte[4]);
