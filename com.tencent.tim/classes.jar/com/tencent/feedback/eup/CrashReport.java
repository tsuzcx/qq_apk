  ...
  extends com.tencent.bugly.a
{
  ...
  public static String getUserData(Context paramContext, String paramString)
  {
    ...
    return com.tencent.bugly.crashreport.common.info.a.a(paramContext).k(paramString);
  }
  ...
  public static int getUserDatasSize(Context paramContext)
  {
    ...
    return com.tencent.bugly.crashreport.common.info.a.a(paramContext).v();
  }
  ...
  public static void initNativeCrashReport(Context paramContext, String paramString, boolean paramBoolean, List<File> paramList, File paramFile, long paramLong)
  {
    ...
    do
    {
      ...
      if (paramFile != null)
      {
        ...
        if (!z.a(str)) {
          ((com.tencent.bugly.crashreport.common.info.a)localObject).o = str;
        }
      }
      if (paramFile != null)
      {
      ...
      paramList = com.tencent.bugly.crashreport.crash.anr.b.a();
      if ((paramList != null) && (!z.a(paramString))) {
  ...
  public static void putUserData(Context paramContext, String paramString1, String paramString2)
  {
    ...
    int j = 200;
    if (paramString1.contains("_userParam_")) {
      j = 4000;
    }
    String str = paramString2;
    if (paramString2.length() > j)
    {
      x.d("user data value length over limit %d , has been cutted!", new Object[] { Integer.valueOf(j) });
      str = paramString2.substring(0, j);
    }
    paramString2 = com.tencent.bugly.crashreport.common.info.a.a(paramContext);
    if (paramString2.w().contains(paramString1))
    {
  ...
  {
    com.tencent.bugly.crashreport.common.info.a.a(paramContext).h(paramString);
  }
  ...
  public static String removeUserData(Context paramContext, String paramString)
  {
    ...
    return com.tencent.bugly.crashreport.common.info.a.a(paramContext).j(paramString);
  }
  ...
  {
    com.tencent.bugly.crashreport.common.info.a.a(paramContext).i(paramString);
  }
  ...
  public static void uploadUserInfo()
  {
    if (!com.tencent.bugly.b.a)
    {
      Log.w(x.b, "Can not upload user info because bugly is disable.");
      return;
    }
    if (com.tencent.bugly.crashreport.biz.b.b == null)
    {
      Log.w(x.b, "Can not upload user info because bugly is not init.");
      return;
    }
  ...
  {
    paramBuglyStrategy = c.a(1003, paramContext, com.tencent.bugly.b.c, null, c, null);
    paramBuglyStrategy.c();
    paramBuglyStrategy.a(true);
    if (b != null)
    {
      paramBuglyStrategy.a(b.getCallBackType());
      paramBuglyStrategy.a(b.getCloseErrorCallback());
      if (b.isEnableCatchAnrTrace()) {
