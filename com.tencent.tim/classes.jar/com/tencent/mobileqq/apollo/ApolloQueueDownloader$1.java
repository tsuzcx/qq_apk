...
public class ApolloQueueDownloader$1
  implements Runnable
{
  public ApolloQueueDownloader$1(abhv paramabhv, aquz paramaquz) {}
  
  public void run()
  {
    if (QLog.isColorLevel()) {
      QLog.d("ApolloQueue_Downloader", 2, "doTask | run() downloadLimitCount=" + this.this$0.y.get() + ",task=" + this.a);
    }
  ...
  public String toString()
  {
    try
    {
      ...
      if ((this.a.GP == null) || (this.a.GP.size() == 0))
      {
        ...
        if (abhv.a(this.this$0) != null) {
          break label105;
        }
      }
      label105:
      for (int i = 0;; i = abhv.a(this.this$0).size())
      {
