  ...
  implements Runnable
{
  ...
  public void run()
  {
    anot.b(null, "P_CliOper", "WebStatusReport", "", "", this.bhz, 0, 1, this.this$0.mCurrentStep, this.this$0.YP, Build.VERSION.RELEASE, String.valueOf(this.this$0.mCurrentStepTime - this.this$0.mClickTime), String.valueOf(System.currentTimeMillis() - this.this$0.mClickTime));
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if ((((Map.Entry)localObject2).getValue() instanceof String))
      {
        ...
        if (!((String)((Map.Entry)localObject2).getKey()).equalsIgnoreCase(String.valueOf(this.this$0.mOnCreateMilliTimeStamp)))
        {
          ...
          anot.b(null, "P_CliOper", "WebStatusReport", "", "hard code unknown", this.bhz, 0, 1, 100, (String)localObject2, Build.VERSION.RELEASE, "100", "200");
        }
      }
    }
