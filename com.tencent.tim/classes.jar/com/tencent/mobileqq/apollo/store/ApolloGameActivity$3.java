  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(this.this$0.TAG, 2, " onCreate_doInitLaunchData cost time:" + (SystemClock.uptimeMillis() - l));
    }
    ApolloGameActivity.a(this.this$0).sendEmptyMessage(112);
    l = SystemClock.uptimeMillis();
    ApolloGameActivity.b(this.this$0);
    if (QLog.isColorLevel()) {
      QLog.d(this.this$0.TAG, 2, " onCreate_doInitGameJs cost time:" + (SystemClock.uptimeMillis() - l));
    }
    l = SystemClock.uptimeMillis();
    ApolloGameActivity.c(this.this$0);
    if (QLog.isColorLevel()) {
      QLog.d(this.this$0.TAG, 2, " onCreate_doOnAsyncAfter cost time:" + (SystemClock.uptimeMillis() - l));
    }
  }
}
