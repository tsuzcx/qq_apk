...
public class ApolloStoreStabilityReportManager$3
  implements Runnable
{
  public ApolloStoreStabilityReportManager$3(abim paramabim) {}
  
  public void run()
  {
    ArrayList localArrayList = new ArrayList(abim.a(this.this$0));
    abim.a(this.this$0);
    try
    {
      ...
      localObject2 = abim.getAppInterface();
      if (localObject2 != null)
      {
        localObject3 = new NewIntent(((AppInterface)localObject2).getApp().getApplicationContext(), jnl.class);
