  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ((WebSSOAgent.UniSsoServerReqComm)localObject1).mqqver.set("3.4.4");
        ...
        {
          localObject1 = abor.o(CmGameStartChecker.a(this.this$0).isWhiteUsr);
      ...
      for (;;)
      {
        ...
        try
        {
          bool = new File(abxi.biF + CmGameStartChecker.a(this.this$0).gameId + ".zip").exists();
          if (bool) {
            continue;
          }
          i = j;
      ...
      this.this$0.NK = System.currentTimeMillis();
      j = abmt.gb(CmGameStartChecker.a(this.this$0).gameId);
      localJSONObject.put("pkgMode", j);
      localJSONObject.put("pModel", aqgz.getModel());
      localUniSsoServerReq.reqdata.set(localJSONObject.toString());
      localObject2 = new NewIntent(localAppInterface.getApp(), abka.class);
      ((NewIntent)localObject2).putExtra("key1", String.valueOf(this.cpt));
      ...
      abmt.x(new Object[] { "[checkGame], checkGameWay:", Integer.valueOf(this.cpt), ", localVersion:", Integer.valueOf(i), ", rscType:", Integer.valueOf(j) });
      QLog.i("cmgame_process.CmGameStartChecker", 1, "[checkGame] req gameId:" + CmGameStartChecker.a(this.this$0).gameId + ",checkGameWay:" + this.cpt + ",ver:" + i + ",src:" + CmGameStartChecker.a(this.this$0).src + ",rscType:" + j);
      return;
