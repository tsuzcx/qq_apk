...
public class GeneralEventHandler$2
  implements Runnable
{
  public GeneralEventHandler$2(abon paramabon, String paramString) {}
  
  public void run()
  {
    try
    {
      Object localObject1 = new JSONObject(this.aWQ);
      int i = ((JSONObject)localObject1).getInt("xyId");
      if (abon.a(this.this$0) == i)
      {
      ...
      localObject2 = abmt.a(abon.a(this.this$0));
      ...
      if (this.this$0.mActivityRef.get() != null)
      {
        ApolloGameUtil.a((Context)this.this$0.mActivityRef.get(), (CmGameStartChecker.StartCheckParam)localObject1);
        return;
      }
    }
