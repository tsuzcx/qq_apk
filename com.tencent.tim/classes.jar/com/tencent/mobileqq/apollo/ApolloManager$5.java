...
public class ApolloManager$5
  implements Runnable
{
  public ApolloManager$5(abhh paramabhh) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      Object localObject6;
      for (Object localObject1 = this.this$0.mApp.getApp();; localObject6 = null) {
        for (;;)
        {
          if (localObject1 == null) {
            break label464;
          }
          localObject1 = new File(abxi.bim);
          ...
          try
          {
            for (;;)
            {
              JSONObject localJSONObject = this.this$0.be;
              localObject1 = localObject7;
              try
              {
                String str = this.this$0.be.toString();
                localObject1 = localObject7;
