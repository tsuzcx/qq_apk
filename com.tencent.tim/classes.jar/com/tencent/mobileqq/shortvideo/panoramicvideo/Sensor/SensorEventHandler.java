  ...
  implements SensorEventListener
{
  ...
  public void setSensorHandlerCallback(SensorHandlerCallback paramSensorHandlerCallback)
  {
    this.sensorHandlerCallback = paramSensorHandlerCallback;
  }
  
  public static abstract interface CameraChangedCallBack
  {
    public abstract void onCameraChanged(boolean paramBoolean);
  }
  
  public static abstract interface SensorHandlerCallback
  {
    public abstract void updateSensorMatrix(float[] paramArrayOfFloat);
  }
}
