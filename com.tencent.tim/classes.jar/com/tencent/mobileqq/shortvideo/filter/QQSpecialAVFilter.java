  ...
  extends QQBaseFilter
{
  ...
  public void onDrawFrame()
  {
    ...
    for (;;)
    {
      ...
      float f;
      if ((localQQAVImageFilter instanceof MusicWaveformShaker))
      {
        ...
        ((MusicWaveformShaker)localQQAVImageFilter).setMusicScale(f);
      }
      for (;;)
      {
        ...
        break;
        ((MusicWaveformShaker)localQQAVImageFilter).setMusicScale(0.0F);
      }
  ...
  public void setMusicWaveformSupporter(MusicWaveformSupporter paramMusicWaveformSupporter)
  {
  ...
  public static abstract interface MusicWaveformShaker
  {
    public abstract void setMusicScale(float paramFloat);
  }
  
  public static abstract interface MusicWaveformSupporter
  {
