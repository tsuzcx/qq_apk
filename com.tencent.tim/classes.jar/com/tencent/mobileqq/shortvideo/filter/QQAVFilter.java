  ...
  extends QQBaseFilter
{
  ...
  private List<FragmentFilterDesc> mFragmentFilterDescs = new CopyOnWriteArrayList();
  ...
  public void onDrawFrame()
  {
    ...
    for (;;)
    {
      FragmentFilterDesc localFragmentFilterDesc;
      if (i < this.mFragmentFilterDescs.size())
      {
        if (l >= ((FragmentFilterDesc)this.mFragmentFilterDescs.get(i)).timeSlamp.longValue()) {
          break label273;
        }
        localFragmentFilterDesc = (FragmentFilterDesc)this.mFragmentFilterDescs.get(i);
  ...
  public void setAVListAndTimeSlamp(List<FilterDesc> paramList, List<Long> paramList1)
  {
    ...
    if ((paramList != null) && (paramList1 != null) && (paramList.size() == paramList1.size()))
    {
      ...
      while (i < paramList.size())
      {
        ...
        FragmentFilterDesc localFragmentFilterDesc = new FragmentFilterDesc();
        if (localFilterDesc != null) {
  ...
  static class FragmentFilterDesc
  {
