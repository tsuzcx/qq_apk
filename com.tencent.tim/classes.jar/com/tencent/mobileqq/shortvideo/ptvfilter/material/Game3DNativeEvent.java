  ...
  implements anjh.a
{
  public void a(long paramLong, int paramInt, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    {
      VideoEnvironment.k("GameplayEngine.GameEvent", " gestureRegistered:", localUnsatisfiedLinkError);
    }
  }
  ...
  public void a(long paramLong, int paramInt1, float paramFloat1, float paramFloat2, int paramInt2)
  {
    ...
    {
      VideoEnvironment.k("GameplayEngine.GameEvent", " touchEventInternal:", localUnsatisfiedLinkError);
    }
  }
  ...
  public boolean q(long paramLong, int paramInt)
  {
    try
    {
