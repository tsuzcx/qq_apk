  ...
  implements IFaceDetectCallBack, IGestureDetectCallBack
{
  ...
  private void startExpressionDetect()
  {
    ...
    FaceDetectTaskResult localFaceDetectTaskResult;
    do
    {
      return;
    ...
    if ((!localFaceDetectTaskResult.vaild) || (!((GestureDetectTaskResult)localObject1).vaild))
    {
      loginfo("mFaceDetectResult.vaild =" + localFaceDetectTaskResult.vaild + " and mGestureDetectResult.vaild=" + ((GestureDetectTaskResult)localObject1).vaild);
      notifyTaskEnd();
      return;
    }
    loginfo("mFaceDetectResult.vaild and mGestureDetectResult.vaild mGestureDetectResult.type=" + ((GestureDetectTaskResult)localObject1).type);
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((localObject3 != null) && (((GLLittleBoy)localObject3).needDoMatch()))
      {
        ...
        if ((localObject4 != null) && (((ResourceManager.Posture)localObject4).faceDanceConfig.mGestureType.equals(((GestureDetectTaskResult)localObject1).type)))
        {
    ...
    loginfo("tempBoyList.size() ==" + localArrayList.size() + " mGestureDetectResult.type=" + ((GestureDetectTaskResult)localObject1).type);
  ...
  public void faceDetectEnd(FaceDetectTaskResult paramFaceDetectTaskResult)
  {
  ...
  public void gestureDetectEnd(GestureDetectTaskResult paramGestureDetectTaskResult)
  {
