  ...
  extends QQBaseFilter
{
  ...
  public void config(String paramString1, String paramString2, String paramString3, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.mPKDecodeListener = new PKDecodeListener(null);
    ...
    implements SurfaceTexture.OnFrameAvailableListener
  {
    ...
    public OnFrameAvailableListener(PKFilter paramPKFilter)
    {
  ...
  class PKDecodeListener
    implements HWDecodeListener
  {
    private PKDecodeListener() {}
      ...
      throws InterruptedException
    {
      ...
      PKFilter.access$102(PKFilter.this, paramLong1);
    }
    
    public void onDecodeRepeat()
    {
      PKFilter.access$102(PKFilter.this, 0L);
