...
public class GLShaderManager
{
  ...
  static GLProgram createProgram(String paramString)
  {
    GLProgram localGLProgram2 = (GLProgram)sShaderMgr.get(paramString);
    GLProgram localGLProgram1 = localGLProgram2;
  ...
  private static GLProgram createProgramInit(String paramString)
  {
    int i = buildProgram(paramString);
    DanceLog.printFrameQueue("GLShaderManager", "createProgramInit program=" + i);
    if (i != 0)
    {
      GLProgram localGLProgram = new GLProgram();
