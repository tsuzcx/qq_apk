  ...
  implements SoundPool.OnLoadCompleteListener
{
  ...
  private void calledInGlThread(int paramInt1, int paramInt2)
  {
    ...
    {
      localObject2 = (AudioItem)((Iterator)localObject1).next();
      if (((AudioItem)localObject2).sampleId == paramInt1)
      {
        ((AudioItem)localObject2).loaded = true;
        ((AudioItem)localObject2).status = paramInt2;
      }
    }
    Object localObject2 = this.mPlayCommandList.iterator();
    while (((Iterator)localObject2).hasNext())
    {
      localObject1 = (AudioItem)((Iterator)localObject2).next();
      if (((AudioItem)localObject1).sampleId == paramInt1) {
        playAudioItem((AudioItem)localObject1);
      }
    }
    for (;;)
    {
  ...
  private void playAudioItem(AudioItem paramAudioItem)
  {
  ...
  private void playSoundInternal(String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      AudioItem localAudioItem = new AudioItem(this.mSoundPool.load(paramString, 1));
      this.mSoundPoolIdCache.put(paramString, localAudioItem);
    }
    paramString = (AudioItem)this.mSoundPoolIdCache.get(paramString);
  ...
  public void executeDraw()
  {
    if (this.mLoadItemList.size() > 0) {
      ...
      {
        LoadItem[] arrayOfLoadItem = new LoadItem[this.mLoadItemList.size()];
  ...
  public void loadSoundResource(List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      {
        AudioItem localAudioItem = new AudioItem(this.mSoundPool.load((String)paramList.get(i), 1));
  ...
  {
    LoadItem localLoadItem = new LoadItem();
  ...
  public void releaseSoundResource()
  {
    ...
    do
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localObject = (AudioItem)this.mSoundPoolIdCache.get(localObject);
        this.mSoundPool.unload(((AudioItem)localObject).sampleId);
      }
      this.mSoundPoolIdCache.clear();
