...
public class PoseDataConvert
{
  ...
  static
  {
    ...
    int[] arrayOfInt6 = { 21, 24 };
    int[] arrayOfInt7 = { 26, 29 };
    int[] arrayOfInt8 = { 27, 30 };
    int[] arrayOfInt9 = { 28, 31 };
    mirrorMap = new int[][] { { 14, 15 }, { 16, 17 }, arrayOfInt1, { 3, 6 }, arrayOfInt2, { 8, 11 }, arrayOfInt3, arrayOfInt4, { 32, 33 }, arrayOfInt5, { 20, 23 }, arrayOfInt6, { 22, 25 }, arrayOfInt7, arrayOfInt8, arrayOfInt9 };
  }
