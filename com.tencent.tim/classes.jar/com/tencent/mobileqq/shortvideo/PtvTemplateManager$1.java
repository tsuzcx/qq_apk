  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   4: getfield 31	com/tencent/mobileqq/shortvideo/PtvTemplateManager:As	Ljava/util/ArrayList;
    //   7: invokevirtual 37	java/util/ArrayList:isEmpty	()Z
    //   10: ifne +11 -> 21
    //   13: aload_0
    //   14: getfield 16	com/tencent/mobileqq/shortvideo/PtvTemplateManager$1:czT	Z
    //   17: ifne +4 -> 21
    //   20: return
    //   21: ldc 39
    //   23: astore 4
    ...
    //   27: aconst_null
    //   28: astore_1
    //   29: invokestatic 45	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   32: invokevirtual 49	com/tencent/qphone/base/util/BaseApplication:getAssets	()Landroid/content/res/AssetManager;
    //   35: ldc 51
    //   37: invokevirtual 57	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   40: astore_3
    //   41: aload_3
    //   42: astore_1
    //   43: aload_3
    //   44: astore_2
    //   45: aload_3
    //   46: invokestatic 63	jqo:e	(Ljava/io/InputStream;)Ljava/lang/String;
    //   49: astore 5
    //   51: aload 5
    //   53: astore_1
    //   54: aload_1
    ...
    //   70: aload_2
    //   71: invokestatic 72	com/tencent/mobileqq/shortvideo/PtvTemplateManager:a	(Lcom/tencent/mobileqq/shortvideo/PtvTemplateManager;Ljava/lang/String;)Ljava/util/List;
    //   74: astore_1
    //   75: aload_1
    //   76: ifnull -56 -> 20
    //   79: aload_1
    ...
    //   92: getfield 79	com/tencent/mobileqq/shortvideo/PtvTemplateManager:eI	Ljava/lang/Object;
    //   95: astore_2
    //   96: aload_2
    //   97: monitorenter
    //   98: aload_0
    ...
    //   102: getfield 31	com/tencent/mobileqq/shortvideo/PtvTemplateManager:As	Ljava/util/ArrayList;
    //   105: invokevirtual 37	java/util/ArrayList:isEmpty	()Z
    //   108: ifeq +15 -> 123
    //   111: aload_0
    ...
    //   115: getfield 31	com/tencent/mobileqq/shortvideo/PtvTemplateManager:As	Ljava/util/ArrayList;
    //   118: aload_1
    //   119: invokevirtual 83	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   122: pop
    //   123: aload_2
    //   124: monitorexit
    //   125: aload_0
    ...
    //   129: getfield 86	com/tencent/mobileqq/shortvideo/PtvTemplateManager:Au	Ljava/util/ArrayList;
    //   132: astore_2
    //   133: aload_2
    //   134: monitorenter
    //   135: ldc 88
    ...
    //   154: getfield 86	com/tencent/mobileqq/shortvideo/PtvTemplateManager:Au	Ljava/util/ArrayList;
    //   157: invokevirtual 37	java/util/ArrayList:isEmpty	()Z
    //   160: invokevirtual 100	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   163: ldc 102
    //   165: invokevirtual 97	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   168: aload_1
    //   169: invokeinterface 106 1 0
    //   174: invokevirtual 109	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   177: ldc 111
    ...
    //   185: invokestatic 121	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   188: aload_0
    ...
    //   192: getfield 86	com/tencent/mobileqq/shortvideo/PtvTemplateManager:Au	Ljava/util/ArrayList;
    //   195: invokevirtual 37	java/util/ArrayList:isEmpty	()Z
    //   198: ifeq +15 -> 213
    //   201: aload_0
    ...
    //   205: getfield 86	com/tencent/mobileqq/shortvideo/PtvTemplateManager:Au	Ljava/util/ArrayList;
    //   208: aload_1
    //   209: invokevirtual 83	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   212: pop
    //   213: aload_2
    //   214: monitorexit
    //   215: aload_0
    ...
    //   219: getfield 124	com/tencent/mobileqq/shortvideo/PtvTemplateManager:eJ	Ljava/lang/Object;
    //   222: astore_2
    //   223: aload_2
    //   224: monitorenter
    //   225: aload_0
    ...
    //   229: getfield 127	com/tencent/mobileqq/shortvideo/PtvTemplateManager:At	Ljava/util/ArrayList;
    //   232: invokevirtual 37	java/util/ArrayList:isEmpty	()Z
    //   235: ifeq +15 -> 250
    //   238: aload_0
    ...
    //   242: getfield 127	com/tencent/mobileqq/shortvideo/PtvTemplateManager:At	Ljava/util/ArrayList;
    //   245: aload_1
    //   246: invokevirtual 83	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   249: pop
    //   250: aload_2
    //   251: monitorexit
    //   252: aload_0
    ...
    //   256: getfield 130	com/tencent/mobileqq/shortvideo/PtvTemplateManager:Aw	Ljava/util/ArrayList;
    //   259: astore_2
    //   260: aload_2
    //   261: monitorenter
    //   262: aload_0
    ...
    //   266: getfield 130	com/tencent/mobileqq/shortvideo/PtvTemplateManager:Aw	Ljava/util/ArrayList;
    //   269: invokevirtual 37	java/util/ArrayList:isEmpty	()Z
    //   272: ifeq +15 -> 287
    //   275: aload_0
    ...
    //   279: getfield 130	com/tencent/mobileqq/shortvideo/PtvTemplateManager:Aw	Ljava/util/ArrayList;
    //   282: aload_1
    //   283: invokevirtual 83	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   286: pop
    //   287: aload_2
    //   288: monitorexit
    //   289: return
    ...
    //   296: aload_1
    //   297: astore_2
    //   298: invokestatic 133	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   301: ifeq -235 -> 66
    //   304: aload_3
    //   305: invokevirtual 136	java/lang/Exception:printStackTrace	()V
    //   308: aload_1
    //   309: astore_2
    //   310: goto -244 -> 66
    //   313: astore_3
    ...
    //   323: astore_2
    //   324: aload_3
    //   325: invokevirtual 137	java/io/IOException:printStackTrace	()V
    //   328: aload 4
    //   330: astore_2
    //   331: aload_1
    //   332: ifnull -266 -> 66
    //   335: aload_1
    //   336: invokevirtual 68	java/io/InputStream:close	()V
    //   339: aload 4
    //   341: astore_2
    //   342: goto -276 -> 66
    //   345: astore_1
    ...
    //   352: ifeq -286 -> 66
    //   355: aload_1
    //   356: invokevirtual 136	java/lang/Exception:printStackTrace	()V
    //   359: aload 4
    //   361: astore_2
    //   362: goto -296 -> 66
    //   365: astore_1
    ...
    //   367: ifnull +7 -> 374
    //   370: aload_2
    //   371: invokevirtual 68	java/io/InputStream:close	()V
    //   374: aload_1
    //   375: athrow
    //   376: astore_2
    //   377: invokestatic 133	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   380: ifeq -6 -> 374
    //   383: aload_2
    //   384: invokevirtual 136	java/lang/Exception:printStackTrace	()V
    //   387: goto -13 -> 374
    //   390: astore_1
    //   391: aload_2
    //   392: monitorexit
