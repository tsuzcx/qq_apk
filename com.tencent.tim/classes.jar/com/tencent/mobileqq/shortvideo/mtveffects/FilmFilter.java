  ...
  extends MTVBaseFilter
{
  ...
  private ArrayList<NoiseItem> mNoiseItems = new ArrayList();
  ...
  private boolean isOverlapped(NoiseItem paramNoiseItem1, NoiseItem paramNoiseItem2)
  {
  ...
  private int loadImage(String paramString)
  {
    ...
    //   10: istore_2
    //   11: aload_0
    //   12: invokevirtual 216	com/tencent/mobileqq/shortvideo/mtveffects/FilmFilter:getMaterialPath	()Ljava/lang/String;
    //   15: astore 4
    //   17: aload 4
    //   19: invokestatic 222	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   22: ifeq +12 -> 34
    //   25: ldc 42
    //   27: ldc 224
    //   29: invokestatic 230	com/tencent/sveffects/SLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   32: iload_2
    //   33: ireturn
    //   34: new 232	java/io/FileInputStream
    //   37: dup
    //   38: new 234	java/lang/StringBuilder
    //   41: dup
    //   42: invokespecial 235	java/lang/StringBuilder:<init>	()V
    //   45: aload 4
    //   47: invokevirtual 239	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   50: aload_1
    //   51: invokevirtual 239	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   54: invokevirtual 242	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   57: invokespecial 244	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   60: astore 4
    //   62: new 246	java/io/BufferedInputStream
    //   65: dup
    //   66: aload 4
    //   68: invokespecial 249	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   71: astore 5
    //   73: sipush 3553
    //   76: aload 5
    //   78: invokestatic 255	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    //   81: invokestatic 261	com/tencent/mobileqq/richmedia/mediacodec/utils/GlUtil:createTexture	(ILandroid/graphics/Bitmap;)I
    //   84: istore_3
    //   85: aload 4
    //   87: ifnull +8 -> 95
    //   90: aload 4
    //   92: invokevirtual 266	java/io/InputStream:close	()V
    //   95: iload_3
    //   96: istore_2
    //   97: aload 5
    //   99: ifnull -67 -> 32
    //   102: aload 5
    //   104: invokevirtual 266	java/io/InputStream:close	()V
    //   107: iload_3
    //   108: ireturn
    //   109: astore_1
    //   110: iload_3
    ...
    //   119: astore_1
    //   120: aload 5
    //   122: invokevirtual 269	java/lang/Exception:printStackTrace	()V
    //   125: ldc 42
    //   127: new 234	java/lang/StringBuilder
    //   130: dup
    //   131: invokespecial 235	java/lang/StringBuilder:<init>	()V
    //   134: ldc_w 271
    ...
    //   145: invokevirtual 242	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   148: invokestatic 230	com/tencent/sveffects/SLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   151: aload 4
    //   153: ifnull +8 -> 161
    //   156: aload 4
    //   158: invokevirtual 266	java/io/InputStream:close	()V
    //   161: aload_1
    //   162: ifnull -130 -> 32
    //   165: aload_1
    //   166: invokevirtual 266	java/io/InputStream:close	()V
    //   169: iconst_m1
    //   170: ireturn
    //   171: astore_1
    //   172: iconst_m1
    ...
    //   181: astore 4
    //   183: ldc 42
    //   185: new 234	java/lang/StringBuilder
    //   188: dup
    //   189: invokespecial 235	java/lang/StringBuilder:<init>	()V
    //   192: ldc_w 276
    ...
    //   202: invokevirtual 242	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   205: invokestatic 230	com/tencent/sveffects/SLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   208: aload 4
    //   210: ifnull +8 -> 218
    //   213: aload 4
    //   215: invokevirtual 266	java/io/InputStream:close	()V
    //   218: aload 5
    //   220: ifnull -188 -> 32
    //   223: aload 5
    //   225: invokevirtual 266	java/io/InputStream:close	()V
    //   228: iconst_m1
    //   229: ireturn
    //   230: astore_1
    //   231: iconst_m1
    ...
    //   243: ifnull +8 -> 251
    //   246: aload 4
    //   248: invokevirtual 266	java/io/InputStream:close	()V
    //   251: aload 5
    //   253: ifnull +8 -> 261
    //   256: aload 5
    //   258: invokevirtual 266	java/io/InputStream:close	()V
    //   261: aload_1
    //   262: athrow
    //   263: astore_1
    //   264: goto -169 -> 95
  ...
  private void randomNoiseItems()
  {
    ...
    for (;;)
    {
      ...
      while (i < l)
      {
        NoiseItem localNoiseItem = new NoiseItem();
  ...
  private void tryAddNoiseItem(NoiseItem paramNoiseItem)
  {
    ...
    while (localIterator.hasNext()) {
      if (isOverlapped((NoiseItem)localIterator.next(), paramNoiseItem)) {
        return;
      }
    }
    this.mNoiseItems.add(paramNoiseItem);
