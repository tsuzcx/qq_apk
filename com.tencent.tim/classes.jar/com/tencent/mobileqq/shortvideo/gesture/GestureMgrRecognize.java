...
public class GestureMgrRecognize
{
  ...
  static GestureKeyInfo doProcess(int paramInt1, GestureData paramGestureData, String paramString, long[] paramArrayOfLong, int paramInt2)
  {
  ...
  static void mergeData(int paramInt, GestureInfo paramGestureInfo, GestureKeyInfo paramGestureKeyInfo)
  {
  ...
  public void start()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 103	com/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize:mCurRecognizeRunnableToken	I
    //   6: ifne +76 -> 82
    //   9: aload_0
    //   10: invokestatic 491	com/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize:genToken	()I
    //   13: putfield 103	com/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize:mCurRecognizeRunnableToken	I
    //   16: ldc 31
    //   18: ldc_w 493
    //   21: iconst_1
    ...
    //   26: iconst_0
    //   27: aload_0
    //   28: getfield 103	com/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize:mCurRecognizeRunnableToken	I
    //   31: invokestatic 231	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   34: aastore
    //   35: invokestatic 251	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   38: invokestatic 255	com/tencent/sveffects/SLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   41: aload_0
    //   42: new 12	com/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize$RecognizeRunnable
    //   45: dup
    //   46: aload_0
    //   47: aload_0
    //   48: getfield 103	com/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize:mCurRecognizeRunnableToken	I
    //   51: invokespecial 496	com/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize$RecognizeRunnable:<init>	(Lcom/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize;I)V
    //   54: putfield 105	com/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize:mRecognizeRunnable	Lcom/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize$RecognizeRunnable;
    //   57: new 498	java/lang/Thread
    //   60: dup
    //   61: aload_0
    //   62: getfield 105	com/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize:mRecognizeRunnable	Lcom/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize$RecognizeRunnable;
    //   65: invokespecial 501	java/lang/Thread:<init>	(Ljava/lang/Runnable;)V
    //   68: astore_1
    //   69: aload_1
    //   70: bipush 10
    //   72: invokevirtual 504	java/lang/Thread:setPriority	(I)V
    //   75: aload_1
    //   76: invokevirtual 506	java/lang/Thread:start	()V
    //   79: aload_0
    //   80: monitorexit
    //   81: return
    //   82: ldc 31
    ...
    //   92: iconst_0
    //   93: aload_0
    //   94: getfield 103	com/tencent/mobileqq/shortvideo/gesture/GestureMgrRecognize:mCurRecognizeRunnableToken	I
    //   97: invokestatic 231	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   100: aastore
    //   101: invokestatic 251	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   104: invokestatic 255	com/tencent/sveffects/SLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   107: goto -28 -> 79
    //   110: astore_1
    //   111: aload_0
    //   112: monitorexit
  ...
  void transferRGBAbuffer(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    try
    {
      this.mGestureData = new GestureData(paramArrayOfByte, paramInt1, paramInt2, paramInt3, paramInt4);
      return;
    }
  ...
  class GestureData
  {
    ...
    GestureData(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
    {
  ...
  class RecognizeRunnable
    implements Runnable
  {
    int mToken = 0;
    
    public RecognizeRunnable(int paramInt)
    {
    ...
    public void run()
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (i < 5)
          {
            arrayOfGestureInfo[i] = new GestureMgrRecognize.GestureInfo(GestureMgrRecognize.this);
            i += 1;
            continue;
          }
          ...
          GestureMgrRecognize.this.reportGestrue(localHashMap);
        ...
        catch (Exception localException1)
        {
          ...
          continue;
          localObject2 = GestureMgrRecognize.this.mGestureData;
        ...
        {
          SLog.d("GestureMgrRecognize", String.format("RecognizeRunnable exit1, ThreadId[%s], token[%s], curToken[%s]", new Object[] { Long.valueOf(localThread.getId()), Integer.valueOf(this.mToken), Integer.valueOf(GestureMgrRecognize.this.mCurRecognizeRunnableToken) }));
        }
        else
        {
          localGestureInfo = arrayOfGestureInfo[j];
          GestureMgrRecognize.this.mGestureInfo.copyTo(localGestureInfo);
          synchronized (GestureMgrRecognize.mGestureLock)
          {
            ...
            if (this.mToken != GestureMgrRecognize.this.mCurRecognizeRunnableToken) {
              SLog.d("GestureMgrRecognize", String.format("RecognizeRunnable exit2, ThreadId[%s], token[%s], curToken[%s]", new Object[] { Long.valueOf(localThread.getId()), Integer.valueOf(this.mToken), Integer.valueOf(GestureMgrRecognize.this.mCurRecognizeRunnableToken) }));
            }
          }
        }
      }
      GestureMgrRecognize.mergeData(this.mToken, localGestureInfo, (GestureKeyInfo)localObject2);
      GestureMgrRecognize.this.mGestureInfo = localGestureInfo;
      int k = (j + 1) % 5;
      i += 1;
      if (i == 15) {
