  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (this.this$0.jdField_a_of_type_ComTencentImageVideoDrawable != null)
    {
      ...
      if (this.this$0.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer$b != null) {
        this.this$0.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer$b.No();
      }
    }
  }
}
