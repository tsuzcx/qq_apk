  ...
  implements URLDrawableDownListener, VideoDrawable.OnPlayRepeatListener, VideoDrawable.OnPlayerOneFrameListener
{
  ...
  public boolean a(int paramInt1, int paramInt2, int paramInt3, String paramString, boolean paramBoolean)
  {
    ...
    if (this.cIb)
    {
      this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetPlayerProgressBar.mTotalTime = paramInt1;
      this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetPlayerProgressBar.cqg = paramInt2;
      this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetPlayerProgressBar.aAE = paramInt3;
  ...
  {
    return paramRMVideoStateMgr.hC(11);
  }
  
  public void b(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(paramInt1, paramInt2);
    this.bN.setLayoutParams(localLayoutParams);
    this.cIb = paramBoolean;
  ...
  public void onPlayRepeat(int paramInt)
  {
    ...
    {
      if (this.cIb) {
        this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetPlayerProgressBar.setCurrentProgress(this.dJs, true);
      }
      dRu();
      return;
    }
  ...
  public void oneFrameDrawed()
  {
    ...
    {
      if (this.cIb) {
        this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetPlayerProgressBar.setCurrentProgress(this.dJs, bool);
      }
      if ((bool) && (!this.cIa)) {
        dRu();
      }
      if (this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer$a != null) {
        this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer$a.wR(this.dJs);
      }
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer$a = parama;
  }
  
  public void setIMPlayerEndListener(b paramb)
  {
    this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer$b = paramb;
  }
