  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        localObject9 = new JSONObject(this.val$param);
        j = i2;
        localObject4 = localObject3;
        localObject6 = localAppInfo;
        i = n;
        ...
        if (((JSONObject)localObject9).has("serial"))
        {
          ...
          localObject7 = localObject2;
          localObject8 = localObject1;
          localJSONObject1.put("jsStartTime", this.val$start);
          j = i2;
          localObject4 = localObject3;
          localObject6 = localAppInfo;
          i = n;
      ...
      catch (Exception localException2)
      {
        ...
        try
        {
          ...
          localJSONObject1.put("jsStart", this.val$start);
      ...
      try
      {
        ...
        localObject1 = new altq(this.this$0.mRuntime.a());
        if (localObject1 == null) {
          break label1790;
        }
        localObject1 = ((altq)localObject1).yz();
