  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      localObject8 = new JSONObject(this.val$param);
    ...
    try
    {
      ...
      j = n;
      localJSONObject.put("jsStartTime", this.val$start);
      j = n;
      ...
      localObject5 = new altq(this.this$0.mRuntime.a());
      if (localObject5 == null) {
        break label1338;
      }
      localObject5 = ((altq)localObject5).yz();
    ...
    for (localObject1 = ((BusinessInfoCheckUpdate.AppInfo)((List)localObject1).get(0)).path.get();; localObject1 = "")
    {
      for (;;)
      {
        for (;;)
        {
          ...
          {
            localObject8 = this.this$0.mRuntime.getActivity();
          ...
          try
          {
            ...
            localJSONObject.put("jsStart", this.val$start);
