...
public class FileProvider7Helper
{
  ...
  public static String getRealPathFromContentURI(Context paramContext, Uri paramUri)
  {
    ...
    //   61: aconst_null
    //   62: aconst_null
    //   63: invokestatic 111	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   66: astore_3
    //   67: aload_3
    //   68: astore 4
    //   70: aload_3
