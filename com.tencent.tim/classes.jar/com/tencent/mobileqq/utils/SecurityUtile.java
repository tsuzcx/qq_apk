...
public class SecurityUtile
{
  ...
  public static void setKey(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject2 = alla.a((TelephonyManager)paramContext.getApplicationContext().getSystemService("phone"));
        if (localObject2 != null)
        {
          localObject1 = localObject2;
          if (((String)localObject2).length() >= codeKey.length) {
        ...
        localObject1 = localObject2;
        localObject2 = alkz.c(alkz.a((WifiManager)paramContext.getSystemService("wifi")));
      }
