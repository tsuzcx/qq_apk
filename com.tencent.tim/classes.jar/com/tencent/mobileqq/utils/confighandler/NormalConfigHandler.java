  ...
  extends ConfigHandler<T>
{
  ...
  {
    if ((AudioHelper.isDev()) && (this.mSPName == null)) {
      throw new IllegalArgumentException(this.TAG + "mSPName为空");
    }
    return aqnz.a(this.TAG, this.mUin, this.mSPName);
  }
  
  public T getConfig()
  {
    if ((this.mConfig == null) && (AudioHelper.isDev()))
    {
      QLog.w(this.TAG, 1, "getConfig, 配置还未初始化", new Throwable("打印调用栈"));
      throw new IllegalArgumentException(acfp.m(2131709140));
    }
    return this.mConfig;
  }
  ...
  {
    if ((AudioHelper.isDev()) && (this.mSPKey_Config == null)) {
  ...
  public ReadConfigTask<T> syncGetConfigInfo(AppInterface paramAppInterface, GetConfigListen<T> paramGetConfigListen)
  {
    ...
    if (((ReadConfigTask)localObject1).isNeedRunTask())
    {
      ...
      aqms.requestSyncTask(null, (ArrayList)localObject2, new aqnw(this, paramGetConfigListen, paramAppInterface));
      return localObject1;
    }
  ...
  public static abstract interface GetConfigListen<T extends ConfigInfo>
  {
