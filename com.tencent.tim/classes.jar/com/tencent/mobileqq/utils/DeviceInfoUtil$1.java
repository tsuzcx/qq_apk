  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    aqgz.access$002(System.currentTimeMillis());
    this.val$sp.edit().putLong("device_perf_level_timestamps", aqgz.access$000()).apply();
    for (;;)
    {
      try
      {
        ...
        ((JSONObject)localObject2).put("uin", auri.getIMEI("a4bd32"));
