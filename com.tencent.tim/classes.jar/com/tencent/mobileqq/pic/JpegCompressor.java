...
public final class JpegCompressor
{
  ...
  {
    // Byte code:
    //   0: getstatic 24	com/tencent/mobileqq/pic/JpegCompressor:soLoadStatus	Z
    //   3: ifne +8 -> 11
    //   6: bipush 50
    //   8: invokestatic 103	com/tencent/mobileqq/pic/JpegError:throwException	(I)V
    //   11: new 105	java/io/BufferedInputStream
    //   14: dup
    //   15: new 107	java/io/FileInputStream
    //   18: dup
    //   19: new 109	java/io/File
    //   22: dup
    //   23: aload_0
    //   24: invokespecial 110	java/io/File:<init>	(Ljava/lang/String;)V
    //   27: invokespecial 113	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   30: invokespecial 116	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   33: astore_3
    //   34: aload_3
    //   35: astore_0
    //   36: new 118	java/io/ByteArrayOutputStream
    //   39: dup
    //   40: sipush 1000
    //   43: invokespecial 120	java/io/ByteArrayOutputStream:<init>	(I)V
    //   46: astore 4
    //   48: aload_3
    //   49: astore_0
    //   50: sipush 1000
    ...
    //   59: aload_3
    //   60: aload 5
    //   62: invokevirtual 124	java/io/BufferedInputStream:read	([B)I
    //   65: istore_2
    //   66: iload_2
    //   67: iconst_m1
    //   68: if_icmpeq +48 -> 116
    ...
    //   77: iconst_0
    //   78: iload_2
    //   79: invokevirtual 128	java/io/ByteArrayOutputStream:write	([BII)V
    //   82: goto -25 -> 57
    //   85: astore 4
    //   87: aload_3
    //   88: astore_0
    //   89: aload 4
    //   91: invokevirtual 129	java/io/FileNotFoundException:printStackTrace	()V
    //   94: aload_3
    //   95: ifnull +176 -> 271
    //   98: aload_3
    //   99: invokevirtual 130	java/io/BufferedInputStream:close	()V
    //   102: iconst_0
    //   103: istore_2
    //   104: fconst_0
    //   105: fstore_1
    ...
    //   107: ifeq +7 -> 114
    //   110: iload_2
    //   111: invokestatic 103	com/tencent/mobileqq/pic/JpegError:throwException	(I)V
    //   114: fload_1
    //   115: freturn
    //   116: aload_3
    //   117: astore_0
    ...
    //   124: astore_0
    //   125: aload 4
    //   127: invokevirtual 135	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   130: astore 4
    //   132: aload_3
    //   133: astore_0
    //   134: aload 4
    //   136: aload 4
    //   138: arraylength
    //   139: invokestatic 139	com/tencent/mobileqq/pic/JpegCompressor:getQuality	([BI)F
    //   142: fstore_1
    //   143: aload_3
    //   144: ifnull +134 -> 278
    //   147: aload_3
    ...
    //   182: ifnull +89 -> 271
    //   185: aload_3
    //   186: invokevirtual 130	java/io/BufferedInputStream:close	()V
    //   189: iconst_0
    //   190: istore_2
    //   191: fconst_0
    //   192: fstore_1
    ...
    //   211: ifnull +55 -> 266
    //   214: aload_3
    //   215: invokevirtual 130	java/io/BufferedInputStream:close	()V
    //   218: fconst_0
    //   219: fstore_1
    //   220: goto -114 -> 106
    //   223: astore_0
    ...
    //   233: ifnull +7 -> 240
    //   236: aload_0
    //   237: invokevirtual 130	java/io/BufferedInputStream:close	()V
    //   240: aload_3
    //   241: athrow
    //   242: astore_0
    //   243: goto -3 -> 240
    ...
    //   170	7	4	localIOException1	IOException
    //   254	1	4	localIOException2	IOException
