  ...
  implements Runnable
{
  ...
  public void run()
  {
    ((QQAppInterface)this.val$app).b().a(this.this$0.message.frienduin, this.this$0.message.msgtype, this.this$0.message.uniseq, "extStr", this.this$0.message.extStr);
  }
}
