  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   91: ifeq +165 -> 256
    //   94: invokestatic 96	aqep:BS	()Ljava/lang/String;
    //   97: astore_3
    ...
    //   132: iload_1
    //   133: iload_1
    //   134: invokestatic 115	aqhu:getOptRatio	(Ljava/io/InputStream;II)D
    //   137: d2i
    //   138: putfield 119	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   141: aload 6
    //   143: invokevirtual 124	java/io/InputStream:close	()V
    //   146: aload_3
    //   147: aload 4
    //   149: invokestatic 130	aqcu:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   152: astore_3
    //   153: aload_3
    //   154: astore_2
    //   155: aload_3
    ...
    //   159: aload_3
    //   160: aload_3
    //   161: invokevirtual 136	android/graphics/Bitmap:getWidth	()I
    //   164: aload_3
    //   165: invokevirtual 139	android/graphics/Bitmap:getHeight	()I
    //   168: invokestatic 143	com/tencent/mobileqq/app/QQAppInterface:getCircleFaceBitmap	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   171: astore_2
    //   172: aload_2
    //   173: astore_3
    //   174: aload_2
    ...
    //   187: iconst_1
    //   188: invokevirtual 147	com/tencent/mobileqq/app/QQAppInterface:getFaceBitmap	(Ljava/lang/String;Z)Landroid/graphics/Bitmap;
    //   191: astore_3
    //   192: aload_3
    //   193: ifnull -148 -> 45
    //   196: aload_0
    ...
    //   200: invokestatic 150	com/tencent/mobileqq/richstatus/SignatureHistoryFragment:a	(Lcom/tencent/mobileqq/richstatus/SignatureHistoryFragment;)Landroid/os/Handler;
    //   203: iconst_2
    //   204: invokevirtual 156	android/os/Handler:obtainMessage	(I)Landroid/os/Message;
    //   207: astore_2
    //   208: aload_2
    //   209: aload_3
    //   210: putfield 162	android/os/Message:obj	Ljava/lang/Object;
    //   213: aload_0
    ...
    //   217: invokestatic 150	com/tencent/mobileqq/richstatus/SignatureHistoryFragment:a	(Lcom/tencent/mobileqq/richstatus/SignatureHistoryFragment;)Landroid/os/Handler;
    //   220: aload_2
    //   221: invokevirtual 166	android/os/Handler:sendMessage	(Landroid/os/Message;)Z
    //   224: pop
    //   225: return
    //   226: astore_3
    ...
    //   235: iconst_2
    //   236: aload_3
    //   237: invokevirtual 169	java/lang/Exception:toString	()Ljava/lang/String;
