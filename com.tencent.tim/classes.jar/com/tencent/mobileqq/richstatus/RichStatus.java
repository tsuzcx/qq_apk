  ...
  implements Serializable, Cloneable
{
  ...
  public HashMap<Integer, a> sigZanInfo;
  public int signType;
  public long time;
  ...
  private void b(StringBuilder paramStringBuilder, String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
  ...
  private static int dW(String paramString)
  {
    ...
    for (;;)
    {
      if (localByteBuffer.hasRemaining())
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.richstatus.status", 2, aqhs.bytes2HexStr(paramArrayOfByte));
        }
      }
      for (;;)
      {
        if (localObject1 != null) {
          localRichStatus.PA((String)localObject1);
        }
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if (QLog.isColorLevel())
            {
              QLog.d("Q.richstatus.status", 2, aqhs.bytes2HexStr(paramArrayOfByte) + ",sign feeds id=" + localRichStatus.feedsId);
              continue;
  ...
  public boolean bOnlyHasTopic()
  {
    ...
    do
    {
      ...
      {
        b(localStringBuilder, (String)this.plainText.get(i));
        i += 1;
      }
      if (this.plainText != null) {}
      for (i = this.plainText.size();; i = 0)
      {
        ...
        while (j < i)
        {
          b(localStringBuilder, (String)this.plainText.get(j));
          j += 1;
        }
      }
  ...
  public int countUtfLength()
  {
    ...
    for (int j = dW(this.actionText) + 12 + 0;; j = 0)
    {
      int i = j;
      if (!TextUtils.isEmpty(this.dataText)) {
        i = j + (dW(this.dataText) + 2);
      }
      j = i;
      if (!TextUtils.isEmpty(this.locationText)) {
        j = i + (dW(this.locationText) + 12);
      }
      i = 0;
      Object localObject1;
      ...
      if ((this.mStickerInfos != null) && (this.mStickerInfos.size() > 0))
      {
        ...
        {
          localObject2 = (StickerInfo)this.mStickerInfos.get(i);
          richstatus_sticker.StickerInfo localStickerInfo = new richstatus_sticker.StickerInfo();
          localStickerInfo.uint32_id.set(((StickerInfo)localObject2).id);
          localStickerInfo.float_posX.set(((StickerInfo)localObject2).posX);
          localStickerInfo.float_posY.set(((StickerInfo)localObject2).posY);
          localStickerInfo.float_width.set(((StickerInfo)localObject2).width);
          localStickerInfo.float_height.set(((StickerInfo)localObject2).height);
  ...
  public byte[] encode()
  {
    ...
    if ((this.mStickerInfos != null) && (this.mStickerInfos.size() > 0))
    {
      ...
      while (i < this.mStickerInfos.size())
      {
        StickerInfo localStickerInfo = (StickerInfo)this.mStickerInfos.get(i);
  ...
  public CharSequence getLocSS(Resources paramResources, float paramFloat, CharSequence paramCharSequence)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject2 = BitmapFactory.decodeResource(paramResources, 2130850440);
        if (localObject2 == null) {
          continue;
        }
        int i = (int)(0.9F * paramFloat + 0.5F);
        int j = ((Bitmap)localObject2).getWidth() * i / ((Bitmap)localObject2).getHeight();
        paramResources = new arjh(paramResources, (Bitmap)localObject2, false, true);
        paramResources.setBounds(0, 0, j, i);
        paramResources = new argi(paramResources, 0).a(-0.1F);
        if (paramCharSequence == null) {}
  ...
  public void sortTopicPos()
  {
    if ((this.topicsPos != null) && (this.topicsPos.size() > 1)) {
      Collections.sort(this.topicsPos, new amfm(this));
    }
  }
  ...
  public SpannableString toSpannableString(String paramString, int paramInt1, int paramInt2)
  {
    ...
    b(paramString, this.actionText);
    b(paramString, this.dataText);
    ...
    for (int i = m + 1;; i = m)
    {
      ...
      {
        b(paramString, (String)this.plainText.get(j));
        j += 1;
      }
      if (this.plainText != null) {}
      int k;
      for (j = this.plainText.size();; j = 0)
      {
        ...
        while (k < j)
        {
          b(paramString, (String)this.plainText.get(k));
          k += 1;
        }
      }
      String str2;
  ...
  public CharSequence toSpannableStringWithTopic(String paramString, int paramInt1, int paramInt2, amii.a parama)
  {
    String str1 = paramString;
    if (paramString == null) {
      str1 = "";
    ...
    for (int i = m + 1;; i = m)
    {
      ...
      if (shouldShowAtHead())
      {
        ...
        if (j < this.topics.size())
        {
          ...
          for (;;)
          {
            ...
            localamih = new amih(parama, amin.b(-11692801, -2142399233), new Pair(((Pair)this.topics.get(j)).first, str2));
            paramString.append(str2);
            paramString.setSpan(localamih, k, str2.length() + k, 33);
          }
        }
      }
      int j = 0;
      ...
      for (;;)
      {
        ...
        localamih = new amih(parama, amin.b(-11692801, -2142399233), new Pair(((Pair)this.topicsPos.get(j)).first, str2));
        paramString.insert(k, str2);
        paramString.setSpan(localamih, k, str2.length() + k, 33);
      }
    }
  ...
  @NotNull
  public CharSequence toSpannableStringWithoutAction(amii.a parama)
  {
    int k = 0;
    ...
    if (shouldShowAtHead())
    {
      ...
      if (i < this.topics.size())
      {
        ...
        for (;;)
        {
          ...
          localamih = new amih(parama, amin.b(-11692801, -2142399233), new Pair(((Pair)this.topics.get(i)).first, str));
          localSpannableStringBuilder.append(str);
          localSpannableStringBuilder.setSpan(localamih, j, str.length() + j, 33);
        }
      }
    }
    int i = 0;
    ...
    for (;;)
    {
      ...
      localamih = new amih(parama, amin.b(-11692801, -2142399233), new Pair(((Pair)this.topicsPos.get(i)).first, str));
  ...
  public void topicFromJson(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 110	com/tencent/mobileqq/richstatus/RichStatus:topics	Ljava/util/List;
    //   4: invokeinterface 396 1 0
    //   9: aload_1
    //   10: invokestatic 126	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   13: ifne +132 -> 145
    //   16: new 641	org/json/JSONArray
    //   19: dup
    //   20: aload_1
    //   21: invokespecial 642	org/json/JSONArray:<init>	(Ljava/lang/String;)V
    //   24: astore 4
    //   26: iconst_0
    //   27: istore_2
    //   28: iload_2
    //   29: aload 4
    //   31: invokevirtual 643	org/json/JSONArray:length	()I
    //   34: if_icmpge +111 -> 145
    //   37: aload 4
    //   39: iload_2
    //   40: invokevirtual 644	org/json/JSONArray:get	(I)Ljava/lang/Object;
    //   43: checkcast 646	org/json/JSONObject
    //   46: astore 5
    //   48: aload 5
    //   50: ldc_w 647
    //   53: invokevirtual 650	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   56: istore_3
    //   57: aload 5
    //   59: ldc_w 652
    //   62: invokevirtual 656	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   65: astore 5
    //   67: aload 5
    //   69: invokestatic 126	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   72: ifne +26 -> 98
    //   75: aload_0
    //   76: getfield 110	com/tencent/mobileqq/richstatus/RichStatus:topics	Ljava/util/List;
    //   79: new 360	com/tencent/util/Pair
    //   82: dup
    //   83: iload_3
    //   84: invokestatic 366	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   87: aload 5
    //   89: invokespecial 369	com/tencent/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   92: invokeinterface 372 2 0
    //   97: pop
    //   98: iload_2
    //   99: iconst_1
    //   100: iadd
    ...
    //   119: dup
    //   120: invokespecial 249	java/lang/StringBuilder:<init>	()V
    //   123: ldc_w 657
    //   126: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   129: aload 4
    //   131: invokevirtual 660	org/json/JSONException:getMessage	()Ljava/lang/String;
    //   134: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   137: invokevirtual 253	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   140: aload 4
    //   142: invokestatic 662	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    //   163: aload_1
    //   164: aastore
    //   165: invokestatic 223	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   168: invokestatic 226	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   171: return
    //   172: astore 4
    //   174: invokestatic 194	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   177: ifeq -32 -> 145
    //   180: ldc 213
    //   182: iconst_2
    //   183: new 152	java/lang/StringBuilder
    //   186: dup
    //   187: invokespecial 249	java/lang/StringBuilder:<init>	()V
    //   190: ldc_w 657
    //   193: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   196: aload 4
    //   198: invokevirtual 665	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   201: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   204: invokevirtual 253	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   207: aload 4
    //   209: invokestatic 662	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   212: goto -67 -> 145
  ...
  public void topicPosFromJson(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 112	com/tencent/mobileqq/richstatus/RichStatus:topicsPos	Ljava/util/List;
    //   4: invokeinterface 396 1 0
    //   9: aload_1
    //   10: invokestatic 126	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   13: ifne +127 -> 140
    ...
    //   57: aload 6
    //   59: ldc_w 668
    //   62: invokevirtual 650	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   65: istore 4
    //   67: aload_0
    //   68: getfield 112	com/tencent/mobileqq/richstatus/RichStatus:topicsPos	Ljava/util/List;
    //   71: new 360	com/tencent/util/Pair
    //   74: dup
    //   75: iload_3
    //   76: invokestatic 366	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   79: iload 4
    //   81: invokestatic 366	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   84: invokespecial 369	com/tencent/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   87: invokeinterface 372 2 0
    //   92: pop
    //   93: iload_2
    //   94: iconst_1
    //   95: iadd
    ...
    //   97: goto -69 -> 28
    //   100: astore 5
    //   102: invokestatic 194	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   105: ifeq +35 -> 140
    //   108: ldc 213
    //   110: iconst_2
    //   111: new 152	java/lang/StringBuilder
    //   114: dup
    ...
    //   124: aload 5
    //   126: invokevirtual 660	org/json/JSONException:getMessage	()Ljava/lang/String;
    //   129: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   132: invokevirtual 253	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   135: aload 5
    //   137: invokestatic 662	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   140: invokestatic 194	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   143: ifeq +23 -> 166
    //   146: ldc 213
    //   148: iconst_2
    //   149: ldc_w 671
    ...
    //   158: aload_1
    //   159: aastore
    //   160: invokestatic 223	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   163: invokestatic 226	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   166: return
    //   167: astore 5
    //   169: invokestatic 194	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   172: ifeq -32 -> 140
    //   175: ldc 213
    //   177: iconst_2
    //   178: new 152	java/lang/StringBuilder
    //   181: dup
    //   182: invokespecial 249	java/lang/StringBuilder:<init>	()V
    //   185: ldc_w 669
    //   188: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   191: aload 5
    //   193: invokevirtual 665	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   196: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   199: invokevirtual 253	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   202: aload 5
    //   204: invokestatic 662	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   207: goto -67 -> 140
    // Local variable table:
    //   start	length	slot	name	signature
