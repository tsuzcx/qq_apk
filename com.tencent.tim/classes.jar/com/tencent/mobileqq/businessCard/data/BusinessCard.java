  ...
  implements Parcelable
{
  ...
  public static final Parcelable.Creator<BusinessCard> CREATOR = new adzr();
  ...
  public CardMobileInfo getMobileInfoByMobile(String paramString)
  {
    ...
    if (this.mobileInfos != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (paramString.equals(localCardMobileInfo.mobile)) {
  ...
  public void postRead()
  {
    ...
    if (!TextUtils.isEmpty(this.moblieInfoPacked)) {
      this.mobileInfos = CardMobileInfo.ap(this.moblieInfoPacked);
    }
    if (!TextUtils.isEmpty(this.uinInfoPacked)) {
      this.uinInfos = CardUinInfo.aq(this.uinInfoPacked);
    }
  ...
  public void prewrite()
  {
    ...
    if (this.mobileInfos.size() > 0) {
      this.moblieInfoPacked = CardMobileInfo.D(this.mobileInfos);
    }
    if (this.uinInfos.size() > 0) {
      this.uinInfoPacked = CardUinInfo.E(this.uinInfos);
    }
