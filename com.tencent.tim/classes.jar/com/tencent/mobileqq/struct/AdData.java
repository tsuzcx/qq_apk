  ...
  implements Serializable, Comparable<AdData>
{
  ...
  public static String getWording(int paramInt, String paramString)
  {
    ...
    {
    default: 
      paramString = BaseApplicationImpl.getContext().getString(2131698277);
    }
    for (;;)
    {
      return paramString;
      paramString = BaseApplicationImpl.getContext().getString(2131700955);
      continue;
      paramString = BaseApplicationImpl.getContext().getString(2131692101);
      continue;
      paramString = BaseApplicationImpl.getContext().getString(2131701356);
      continue;
      paramString = BaseApplicationImpl.getContext().getString(2131694638);
    }
  }
