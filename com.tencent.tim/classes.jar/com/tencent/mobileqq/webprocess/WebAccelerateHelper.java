...
public class WebAccelerateHelper
{
  ...
  {
    long l = System.currentTimeMillis();
    paramWebViewPluginEngine.bindFragment(paramWebViewFragment);
    if (QLog.isColorLevel()) {
  ...
  public WebViewPluginEngine createWebViewPluginEngine(AppInterface paramAppInterface, Activity paramActivity, CustomWebView paramCustomWebView, CommonJsPluginFactory paramCommonJsPluginFactory, List<WebViewPlugin> paramList)
  {
    jqo.le("createWebViewPluginEngine");
    ...
    for (;;)
    {
      jqo.lf("createWebViewPluginEngine");
      if (paramAppInterface != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("WebAccelerateHelper", 2, "plugin list:" + paramAppInterface.CJ());
        }
  ...
  {
    return createWebViewPluginEngine(paramAppInterface, paramActivity, paramCustomWebView, new CommonJsPluginFactory(), paramList);
  }
  ...
  public String getTBSDpcParam()
  {
    ...
    {
      if (TextUtils.isEmpty(this.param)) {
        this.param = DeviceProfileManager.b().aJ(DeviceProfileManager.DpcNames.tbs_switch.name(), "1|1");
      }
      return this.param;
    }
  }
  ...
  public ArrayMap<String, String> getWebViewFeatureConfigs()
  {
    ...
    try
    {
      if (sWebViewFeatureConfigs == null)
      {
        Object localObject2 = DeviceProfileManager.b().jf(DeviceProfileManager.DpcNames.WebViewConfig.name());
        if (QLog.isColorLevel()) {
  ...
  public Integer[] getWebViewFeatureParams()
  {
    ...
    try
    {
      if (sWebViewFeatureParams == null)
      {
        String str = DeviceProfileManager.b().jf(DeviceProfileManager.DpcNames.WebViewFeature.name());
        if (QLog.isColorLevel()) {
        ...
        DeviceProfileManager.a(str, arrayOfInteger, new DeviceProfileManager.e());
  ...
  {
    arbl localarbl = arbl.a(paramString);
    if (localarbl != null) {
      localarbl.a(new WebAccelerateHelper.4(this), paramString);
    }
  }
  ...
  public void preFetchResource(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localObject == null) || (!((SwiftBrowserCookieMonster)localObject).isReady())) {
          break label120;
        }
      }
  ...
  {
    preGetKey(arcp.e(paramIntent), paramIntent, paramAppInterface);
  }
    ...
    implements TicketManagerListener
  {
    ...
    public void onTicketRefreshed()
    {
      ...
      SwiftBrowserCookieMonster.m(MobileQQ.sMobileQQ.waitAppRuntime(null));
    }
  }
}
