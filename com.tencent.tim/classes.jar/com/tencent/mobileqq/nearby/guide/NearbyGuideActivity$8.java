  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   33: dup
    //   34: aload_0
    //   35: getfield 16	com/tencent/mobileqq/nearby/guide/NearbyGuideActivity$8:val$filePath	Ljava/lang/String;
    ...
    //   71: iload 4
    //   73: iload 4
    //   75: invokestatic 57	aqhu:getOptRatio	(Ljava/io/InputStream;II)D
    //   78: d2i
    //   79: putfield 61	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   82: iload_3
    //   83: istore_1
    //   84: aload 5
    //   86: astore 6
    //   88: aload 5
    //   90: invokevirtual 66	java/io/InputStream:close	()V
    //   93: aload 8
    //   95: astore 7
    //   97: aload_0
    //   98: getfield 16	com/tencent/mobileqq/nearby/guide/NearbyGuideActivity$8:val$filePath	Ljava/lang/String;
    //   101: aload 9
    //   103: invokestatic 72	aqcu:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   106: astore 8
    //   108: aload 8
    //   110: astore 6
    //   112: aload 8
    ...
    //   121: aload 8
    //   123: aload 8
    //   125: invokevirtual 78	android/graphics/Bitmap:getWidth	()I
    //   128: aload 8
    //   130: invokevirtual 81	android/graphics/Bitmap:getHeight	()I
    //   133: invokestatic 85	aqhu:getCircleFaceBitmap	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   136: astore 6
    //   138: aload 6
    ...
    //   147: iconst_1
    //   148: ldc 86
    //   150: invokestatic 92	acfp:m	(I)Ljava/lang/String;
    //   153: invokevirtual 96	com/tencent/mobileqq/nearby/guide/NearbyGuideActivity:aL	(ILjava/lang/String;)V
    //   156: return
    //   157: astore 8
    //   159: aconst_null
    //   160: astore 5
    ...
    //   164: aload 5
    //   166: astore 6
    //   168: invokestatic 102	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   171: ifeq +20 -> 191
    //   174: iload_2
    //   175: istore_1
    //   176: aload 5
    ...
    //   182: iconst_2
    //   183: aload 8
    //   185: invokevirtual 108	java/lang/Throwable:toString	()Ljava/lang/String;
    //   188: invokestatic 112	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   191: aload 7
    //   193: astore 6
    //   195: iload_2
    //   196: ifne -58 -> 138
    ...
    //   205: ifnull -67 -> 138
    //   208: aload 5
    //   210: invokevirtual 66	java/io/InputStream:close	()V
    //   213: aload 7
    //   215: astore 6
    //   217: goto -79 -> 138
    //   220: astore 5
    //   222: aload 7
    //   224: astore 6
    //   226: invokestatic 115	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   229: ifeq -91 -> 138
    //   232: aload 5
    //   234: invokevirtual 118	java/io/IOException:printStackTrace	()V
    //   237: aload 7
    //   239: astore 6
    //   241: goto -103 -> 138
    //   244: astore 7
    ...
    //   255: ifnull +8 -> 263
    //   258: aload 5
    //   260: invokevirtual 66	java/io/InputStream:close	()V
    //   263: aload 7
    //   265: athrow
    //   266: astore 5
    //   268: invokestatic 115	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   271: ifeq -8 -> 263
    //   274: aload 5
    //   276: invokevirtual 118	java/io/IOException:printStackTrace	()V
    //   279: goto -16 -> 263
    //   282: aload 6
    //   284: ifnull -128 -> 156
    //   287: invokestatic 124	android/os/Message:obtain	()Landroid/os/Message;
    //   290: astore 5
    //   292: aload 5
    //   294: iconst_2
    //   295: putfield 127	android/os/Message:what	I
    //   298: aload 5
    //   300: aload 6
    //   302: putfield 131	android/os/Message:obj	Ljava/lang/Object;
    //   305: aload_0
    ...
    //   309: getfield 135	com/tencent/mobileqq/nearby/guide/NearbyGuideActivity:mUiHandler	Landroid/os/Handler;
    //   312: aload 5
    //   314: invokevirtual 141	android/os/Handler:sendMessage	(Landroid/os/Message;)Z
    //   317: pop
    //   318: return
    //   319: astore 7
    //   321: aload 6
