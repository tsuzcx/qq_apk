...
public class NearbyTribeAppController$1
  implements Runnable
{
  public NearbyTribeAppController$1(ajrf paramajrf) {}
  
  public void run()
  {
    try
    {
      ajrf.a(this.this$0, false);
      ...
      localObject = new JSONObject(jqc.a(ajrf.a(this.this$0), "https://buluo.qq.com/cgi-bin/bar/post/get_entry?entry_ids=[18]", "POST", null, (Bundle)localObject));
      if (((JSONObject)localObject).getInt("retcode") == 0)
      {
        ...
        {
          this.this$0.MU((String)localObject);
          return;
        }
      }
      QLog.e(ajrf.a(this.this$0), 1, "这里已经下架，如果依然发现该log，异常case");
      this.this$0.MU("https://pub.idqqimg.com/pc/misc/files/20170706/c221bf304be44e5a9e0441768beacff0.apk");
      return;
    }
