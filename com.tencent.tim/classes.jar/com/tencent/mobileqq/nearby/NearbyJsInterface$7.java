  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      JSONArray localJSONArray = new JSONArray(new JSONObject(this.val$params).optString("imageArray"));
      int i = j;
    ...
    catch (Exception localException)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("nearby.img.preload", 2, "preloadImage: costTime=" + (System.currentTimeMillis() - this.AG));
      }
    }
  }
}
