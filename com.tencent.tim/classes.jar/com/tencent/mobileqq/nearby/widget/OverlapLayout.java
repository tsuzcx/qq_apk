  ...
  extends ViewGroup
{
  ...
  public OverlapLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, atau.a.rh);
    this.xF = paramAttributeSet.getDimension(1, wja.dp2px(4.0F, paramContext.getResources()));
    this.xG = paramAttributeSet.getDimension(0, wja.dp2px(15.0F, paramContext.getResources()));
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (k < i2)
    {
      ...
      else
      {
        ...
        {
          i1 = getPaddingLeft();
          paramInt2 = (int)(i + (paramInt4 + this.xF));
          n = 0;
          m = 0;
        }
        ...
        paramInt4 = (int)(paramInt4 - this.xG);
      }
    }
    label307:
    for (;;)
