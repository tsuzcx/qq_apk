...
public class PlayOperationViewModel$20$2
  implements Runnable
{
  public PlayOperationViewModel$20$2(akag paramakag, ajpj paramajpj) {}
  
  public void run()
  {
    anov localanov = new anov(this.jdField_a_of_type_Akag.this$0.app).a("dc00899").b("grp_lbs").c("video").d("playpage_focus").e(ajxs.bSM);
