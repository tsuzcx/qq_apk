...
public class PlayOperationViewModel$9$1
  implements Runnable
{
  public PlayOperationViewModel$9$1(akay paramakay, ajpj paramajpj) {}
  
  public void run()
  {
    anov localanov = new anov(this.jdField_a_of_type_Akay.this$0.app).a("dc00899").b("grp_lbs").c("video").d("playpage_like_click").e(ajxs.bSM);
