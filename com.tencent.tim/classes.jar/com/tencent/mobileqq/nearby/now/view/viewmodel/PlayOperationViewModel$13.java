...
public class PlayOperationViewModel$13
  implements Runnable
{
  public PlayOperationViewModel$13(ajzv paramajzv, ajpj paramajpj) {}
  
  public void run()
  {
    anov localanov = new anov(this.this$0.app).a("dc00899").b("grp_lbs").c("video").d("playpage_label_click").e(ajxs.bSM);
    int i = this.a.GA();
