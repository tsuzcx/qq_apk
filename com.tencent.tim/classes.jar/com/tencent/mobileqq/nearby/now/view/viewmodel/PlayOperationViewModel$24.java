...
public class PlayOperationViewModel$24
  implements Runnable
{
  public PlayOperationViewModel$24(ajzv paramajzv, ajpj paramajpj) {}
  
  public void run()
  {
    anov localanov = new anov(this.this$0.app).a("dc00899").b("grp_lbs").c("video").d("playpage_com_click").e(ajxs.bSM);
    int i = this.a.GA();
