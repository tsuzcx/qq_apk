...
public class PlayOperationViewModel$10$1
  implements Runnable
{
  public PlayOperationViewModel$10$1(ajzx paramajzx, ajpj paramajpj) {}
  
  public void run()
  {
    anov localanov = new anov(this.jdField_a_of_type_Ajzx.this$0.app).a("dc00899").b("grp_lbs").c("video").d("playpage_fw_click").e(ajxs.bSM);
