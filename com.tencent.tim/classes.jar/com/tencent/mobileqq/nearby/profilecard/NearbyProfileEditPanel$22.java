...
public class NearbyProfileEditPanel$22
  implements Runnable
{
  public NearbyProfileEditPanel$22(akfk paramakfk) {}
  
  public void run()
  {
    akfk.a(this.this$0, (PicInfo)this.this$0.W.poll());
    if (akfk.a(this.this$0) == null) {
      return;
    }
    CompressInfo localCompressInfo = new CompressInfo(akfk.a(this.this$0).localPath, 0);
    ...
    this.this$0.a.runOnUiThread(new NearbyProfileEditPanel.22.1(this));
  }
}
