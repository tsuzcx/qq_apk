  ...
  extends PublicBaseFragment
{
  ...
  protected View.OnClickListener onBackListener = new ahnb(this);
  ...
  {
    return this.titleRoot.findViewById(2131377361);
  }
  ...
  public void hideTitleBar()
  {
    try
    {
      this.mTitleContainer = this.titleRoot.findViewById(2131377361);
  ...
  protected void init(Bundle paramBundle)
  {
    ...
    {
      return;
      ((FrameLayout)getActivity().findViewById(16908290)).setForeground(getResources().getDrawable(2130851111));
    ...
    this.vg = ((NavBarCommon)this.titleRoot.findViewById(2131377361));
    onCreateLeftView();
    try
    {
  ...
  protected View onCreateLeftView()
  {
    ...
    this.mLeftBackText = ((TextView)this.titleRoot.findViewById(2131380514));
    this.mLeftBackIcon = ((ImageView)this.titleRoot.findViewById(2131369967));
  ...
  {
    View localView = paramLayoutInflater.inflate(2131559121, paramViewGroup, false);
    ...
    try
    {
      this.titleRoot = ((RelativeLayout)localView.findViewById(2131379881));
      ...
      ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131377361);
  ...
  public void setLeftButton(int paramInt, View.OnClickListener paramOnClickListener)
  {
    ...
    this.leftViewNotBack = ((TextView)this.titleRoot.findViewById(2131369581));
  ...
  protected void setRightHighlightButton(int paramInt, View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.rightViewText != null)
    {
      ...
      this.rightHighLView = ((TextView)LayoutInflater.from(getActivity()).inflate(2131559124, null));
  ...
  public void setTextWithTalk(TextView paramTextView, int paramInt)
  {
    ...
    if (AppSetting.enableTalkBack) {
      paramTextView.setContentDescription(paramTextView.getText() + acfp.m(2131707478));
    }
  }
  ...
  public boolean startTitleProgress()
  {
    ...
    {
      localObject1 = (RelativeLayout)this.titleRoot.findViewById(2131379823);
    ...
    for (Object localObject2 = localObject1;; localObject2 = null)
    {
      if ((this.mUseOptimizMode) && (this.mLoadingParent != null))
      {
        ...
        if (this.mLoadingView == null)
        {
          ...
          localObject1 = getActivity().getResources().getDrawable(2130839655);
