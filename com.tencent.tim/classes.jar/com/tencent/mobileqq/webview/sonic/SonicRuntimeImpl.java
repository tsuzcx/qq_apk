  ...
  extends SonicRuntime
{
  ...
  {
    return SwiftBrowserCookieMonster.pZ(paramString);
  }
        ...
        if (localUri.isHierarchical())
        {
          ...
          if (!TextUtils.isEmpty(str))
          {
            ...
            if (1L == (Long.parseLong(str) & 1L))
            {
              ...
              localObject2 = localObject3;
              localObject1 = aopd.a().e(localUri.getHost(), 1013, false);
            }
          }
        }
      }
  ...
  {
    return aqiw.getSystemNetwork(BaseApplicationImpl.getContext()) != 0;
  }
  ...
  public boolean isSonicUrl(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((Build.VERSION.SDK_INT >= 24) && (QbSdk.getTbsVersion(BaseApplicationImpl.sApplication.getApplicationContext()) == 0))
      {
        ...
        Object localObject2 = arcp.getSchemeFromUrl((String)localObject1);
        ...
        if ((((String)localObject2).endsWith(".qq.com")) || (((String)localObject2).endsWith(".tencent.com")))
        {
          ...
          QLog.d("SonicSdkImpl_SonicRuntimeImpl", 2, "isSonicUrl return true! " + jqo.b((String)localObject1, new String[0]));
          break label456;
        }
        if ((localjml.cR(paramString)) || (localjml.cW((String)localObject1)))
        {
          if (!QLog.isColorLevel()) {
            break label458;
          }
          QLog.d("SonicSdkImpl_SonicRuntimeImpl", 2, "isSonicUrl from white list, return true! " + jqo.b((String)localObject1, new String[0]));
          break label458;
        }
        QLog.e("SonicSdkImpl_SonicRuntimeImpl", 1, "isSonicUrl return false! " + jqo.b((String)localObject1, new String[0]));
        return false;
      }
      int i = 1;
    }
  ...
  public void showToast(CharSequence paramCharSequence, int paramInt)
  {
    try
    {
      QQToast.a(BaseApplicationImpl.sApplication.getApplicationContext(), 1, paramCharSequence, 0).show();
      return;
    }
