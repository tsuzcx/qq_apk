  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    acms localacms = (acms)ReceiptMessageReadMemberListContainerFragment.a(this.this$0).getBusinessHandler(20);
    ...
    localacms.b(true, localTroopInfo.troopuin, localTroopInfo.troopcode, 10);
  }
}
