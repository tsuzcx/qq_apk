...
public class OnlineFileSessionWorker$3
  implements Runnable
{
  public OnlineFileSessionWorker$3(aglt paramaglt, float paramFloat) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      if ((localFileManagerEntity.fProgress < this.ww) && (this.this$0.c != null))
      {
        float f = localFileManagerEntity.fProgress + 0.05F;
        if (f > this.ww) {}
        for (localFileManagerEntity.fProgress = this.ww;; localFileManagerEntity.fProgress = f)
        {
          for (;;)
          {
    ...
    } while ((localFileManagerEntity.fProgress < 1.0F) || (this.this$0.c == null));
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + localFileManagerEntity.nSessionId + "] state:" + aglt.a(this.this$0).vh() + " make progress. direct pass to 1.0 and notify make done");
