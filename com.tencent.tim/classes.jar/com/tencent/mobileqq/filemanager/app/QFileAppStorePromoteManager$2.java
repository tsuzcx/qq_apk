...
public class QFileAppStorePromoteManager$2
  implements Runnable
{
  public QFileAppStorePromoteManager$2(agil paramagil, String paramString, agil.c paramc) {}
  
  public void run()
  {
    AppDetailReqParam localAppDetailReqParam = new AppDetailReqParam();
    AppParam localAppParam = new AppParam();
    localAppParam.packageName = this.val$packageName;
    localAppDetailReqParam.apps.add(localAppParam);
    localAppDetailReqParam.biz = "mobileqq_file";
    int i = GetAppInfoManager.get().requestAppInfo(localAppDetailReqParam, agil.a(this.this$0));
