  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject = ExcitingTransferEngine.access$000(this.this$0, this.ZL);
    if (localObject == null) {
      return;
    }
    ...
    {
      ((IExcitingTransferSendListener)localObject).onExcitingSendResult(bool, this.cYC, this.a);
      ExcitingTransferEngine.access$100(this.this$0, this.ZL);
      return;
    }
  }
}
