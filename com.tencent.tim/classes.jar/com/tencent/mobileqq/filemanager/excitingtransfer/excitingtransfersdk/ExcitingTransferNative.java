  ...
  static
  {
    ...
    catch (UnsatisfiedLinkError localUnsatisfiedLinkError1)
    {
      try
      {
        for (;;)
        {
          SoLoadUtil.loadNativeLibrary(BaseApplicationImpl.getContext(), "mbedtlsall", 0, false);
          try
          {
            SoLoadUtil.loadNativeLibrary(BaseApplicationImpl.getContext(), "excitingtransfer", 0, false);
            return;
          }
