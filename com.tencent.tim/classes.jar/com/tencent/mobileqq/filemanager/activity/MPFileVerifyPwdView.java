  ...
  implements View.OnClickListener
{
  ...
  public void ga()
  {
    ...
    this.aZ.addTextChangedListener(new agcn(this));
    if (Build.VERSION.SDK_INT >= 11)
    {
      this.aZ.setTextIsSelectable(false);
      this.aZ.setCustomSelectionActionModeCallback(new agco(this));
    }
    ...
    this.bb.setTextColor(Color.parseColor("#00a5e0"));
    this.bb.setOnClickListener(new agcp(this));
  ...
  public void onClick(View paramView)
  {
    ...
    if ((str == null) || (str.equals(""))) {
      ahao.JD(BaseApplicationImpl.getContext().getString(2131696045));
    }
    for (;;)
    {
      ...
      if (str.length() < 6)
      {
        ahao.JD(BaseApplicationImpl.getContext().getString(2131696046));
      }
