  ...
  implements agdq.a
{
  ...
  public QfileLocalFileDelPicTabView(Context paramContext, List<QfileTabBarView.a> paramList, boolean paramBoolean)
  {
  ...
  public agdq a()
  {
    agex localagex = new agex(a(), this.R, 0);
    localagex.a(this);
    return localagex;
  }
  ...
  public void dfP()
  {
    ...
    anot.a(null, "dc00898", "", "", "0X800A0CB", "0X800A0CB", 3, 0, "" + this.cWP, "" + l, "", "");
    super.dfP();
  }
  ...
  public void m(Set<FileInfo> paramSet)
  {
    ...
    for (;;)
    {
      ...
      refreshUI();
      l2 /= 1048576L;
      anot.a(null, "dc00898", "", "", "0X800A0CC", "0X800A0CC", 3, 0, "" + l1, "" + l2, "", "");
      return;
    }
  }
  ...
  public void setSortType(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      setSelect(0);
      return;
      anot.a(null, "dc00898", "", "", "0X800A0C8", "0X800A0C8", 3, 0, "", "", "", "");
      if (this.AP.size() > 0)
      {
        this.R.put(acfp.m(2131711103), this.AP);
        continue;
        anot.a(null, "dc00898", "", "", "0X800A0C9", "0X800A0C9", 3, 0, "", "", "", "");
