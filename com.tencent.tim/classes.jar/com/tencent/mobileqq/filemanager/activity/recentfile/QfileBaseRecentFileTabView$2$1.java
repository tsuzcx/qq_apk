  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i(QfileBaseRecentFileTabView.TAG, 2, "queryFileEntitiesFromDB end size[" + this.AU.size() + "]");
    }
    this.a.this$0.kF(this.AU);
    if (QLog.isColorLevel()) {
      QLog.i(QfileBaseRecentFileTabView.TAG, 2, "initFileEntities size[" + this.a.this$0.AT.size() + "]");
    }
    this.a.this$0.dfD();
