  ...
  public void run()
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        {
          localObject = localFileInfo.getGroupName();
    ...
    for (;;)
    {
      ...
      break;
      if (("TIMfile_recv".equalsIgnoreCase((String)localObject)) || ("QQ".equalsIgnoreCase((String)localObject)))
      {
        localObject = acfp.m(2131711085);
        continue;
