  ...
  extends Entity
{
  ...
  public static byte[] converPhoto2RawData(List<alde> paramList)
  {
    Object localObject = new ArrayList();
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      alde localalde = (alde)paramList.next();
      if (localalde != null) {
        ((List)localObject).add(localalde.xU());
      }
    }
  ...
  public static List<alde> parseShoppingPhotoJson(String paramString)
  {
          ...
          while (i < k)
          {
            ...
            if (1 == ((JSONObject)localObject).getInt("type"))
            {
              ...
              if ((localObject != null) && (((JSONArray)localObject).length() > 0))
              {
                ...
                while (j < m)
                {
                  alde localalde = new alde();
                  localalde.bVR = ((JSONArray)localObject).getJSONObject(j).getString("url");
                  localalde.bvC = ((JSONArray)localObject).getJSONObject(j).getJSONArray("pic_url").getString(0);
                  localArrayList.add(localalde);
                  j += 1;
                }
              }
            }
  ...
  /* Error */
  public List<alde> getPhotoFromRawData()
  {
    // Byte code:
    ...
    //   7: astore_3
    //   8: aload_0
    //   9: getfield 254	com/tencent/mobileqq/profile/ProfileShoppingPhotoInfo:picByteData	[B
    //   12: ifnonnull +5 -> 17
    //   15: aload_3
    //   16: areturn
    ...
    //   21: aload_2
    //   22: aload_0
    //   23: getfield 254	com/tencent/mobileqq/profile/ProfileShoppingPhotoInfo:picByteData	[B
    //   26: iconst_0
    //   27: aload_0
    //   28: getfield 254	com/tencent/mobileqq/profile/ProfileShoppingPhotoInfo:picByteData	[B
    //   31: arraylength
    //   32: invokevirtual 258	android/os/Parcel:unmarshall	([BII)V
    //   35: aload_2
    //   36: iconst_0
    //   37: invokevirtual 88	android/os/Parcel:setDataPosition	(I)V
    //   40: aload_2
    //   41: aload_0
    //   42: invokevirtual 262	java/lang/Object:getClass	()Ljava/lang/Class;
    //   45: invokevirtual 268	java/lang/Class:getClassLoader	()Ljava/lang/ClassLoader;
    //   48: invokevirtual 272	android/os/Parcel:readArrayList	(Ljava/lang/ClassLoader;)Ljava/util/ArrayList;
    //   51: astore 4
    //   53: aload 4
    //   55: ifnull +15 -> 70
    //   58: aload 4
    //   60: invokeinterface 275 1 0
    //   65: istore_1
    //   66: iload_1
    //   67: ifne +9 -> 76
    //   70: aload_2
    ...
    //   102: checkcast 277	java/lang/String
    //   105: astore 5
    //   107: new 71	alde
    //   110: dup
    //   111: invokespecial 202	alde:<init>	()V
    //   114: astore 6
    //   116: aload 6
    //   118: aload 5
    //   120: invokevirtual 280	alde:NY	(Ljava/lang/String;)V
    //   123: aload_3
    //   124: aload 6
    ...
    //   159: aload 4
    //   161: invokevirtual 224	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   170: invokestatic 227	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   173: aload_2
