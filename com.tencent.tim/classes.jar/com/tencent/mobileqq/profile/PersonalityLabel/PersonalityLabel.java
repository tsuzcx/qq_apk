...
{
  public static final Parcelable.Creator<PersonalityLabel> CREATOR = new albj();
  ...
  public static PersonalityLabel convertFromBytes(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      localPersonalityLabel = (PersonalityLabel)aqja.c(paramArrayOfByte, CREATOR);
  ...
  public static byte[] convertToBytes(PersonalityLabel paramPersonalityLabel)
  {
    if (paramPersonalityLabel != null)
    {
      ...
      return aqja.marshall(paramPersonalityLabel);
    }
    return null;
  }
  ...
  private void dEM()
  {
    if ((this.personalityLabelInfos != null) && (this.personalityLabelInfos.size() > 0))
    {
      ...
      Collections.sort(this.personalityLabelInfos, new a());
      if (QLog.isDevelopLevel()) {
