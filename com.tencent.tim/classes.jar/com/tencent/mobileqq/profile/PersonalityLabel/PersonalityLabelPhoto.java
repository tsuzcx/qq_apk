...
{
  public static final Parcelable.Creator<PersonalityLabelPhoto> CREATOR = new alcc();
  ...
  {
    return aqft.equalsWithNullCheck(((PersonalityLabelPhoto)paramObject).url, this.url);
  }
