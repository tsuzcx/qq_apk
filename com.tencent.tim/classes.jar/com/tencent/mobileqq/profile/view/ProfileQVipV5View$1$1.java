  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      ProfileQVipV5View.a(this.a.this$0).setVisibility(0);
      ...
      if (aqgm.cT(this.a.this$0.pendantId)) {
        localAvatarPendantManager.a(this.a.this$0.pendantId).a(ProfileQVipV5View.a(this.a.this$0), 2, PendantInfo.ebM, this.a.b.e.uin, this.d.pendantDiyId);
      }
      for (;;)
      {
        if (this.a.cwI) {
        ...
        return;
        localAvatarPendantManager.a(this.a.this$0.pendantId).a(ProfileQVipV5View.a(this.a.this$0), 1, PendantInfo.ebM, this.a.b.e.uin, this.d.pendantDiyId);
      }
    }
    ProfileQVipV5View.a(this.a.this$0).setVisibility(8);
