  ...
  implements ajiz, aqdf.a
{
  ...
  private TabPageIndicator.b jdField_a_of_type_ComTencentMobileqqMultiaioWidgetTabPageIndicator$b;
  private TabPageIndicator.d jdField_a_of_type_ComTencentMobileqqMultiaioWidgetTabPageIndicator$d;
  private TabPageIndicator.e jdField_a_of_type_ComTencentMobileqqMultiaioWidgetTabPageIndicator$e;
  private long acT;
  private QQAppInterface app;
  private MultiAIOBaseViewPager.g c;
  private final View.OnClickListener ce = new ajka(this);
  private boolean coT;
  private boolean coU;
  private int count;
  ...
  private List<TabPageIndicator.c> mOnPageChangeListeners;
  ...
  private void a(a parama, ajjg paramajjg, Drawable paramDrawable)
  {
    if ((parama == null) || (paramajjg == null)) {
      return;
    }
    if (paramDrawable == null)
    {
      paramajjg.getType();
      paramDrawable = p(paramajjg.getUin());
    }
    for (;;)
    {
      ...
      b(parama, paramajjg, localDrawable);
      return;
    }
  }
  ...
  private void animateToTab(int paramInt)
  {
    ...
    this.mTabSelector = new MultiCardPageIndicator.4(this, localView);
  ...
  private void b(a parama, ajjg paramajjg, Drawable paramDrawable)
  {
    if ((parama == null) || (paramajjg == null))
    {
      if (QLog.isColorLevel()) {
    ...
    boolean bool;
    if (ku(paramajjg.getType()))
    {
      if (QLog.isColorLevel()) {
        QLog.i("TabPageIndicator", 2, "bindview user:" + paramajjg.getUin());
      }
      int j = ((Integer)aajx.a(this.app, paramajjg.getType(), paramajjg.getUin()).first).intValue();
      int i = j;
      if (j == 103) {
        i = 1;
      }
      ThemeRecentDynamicAvatarView localThemeRecentDynamicAvatarView = parama.a;
      QQAppInterface localQQAppInterface = this.app;
      paramajjg = paramajjg.getUin();
      if (this.app.a.Bd() == 1)
      {
        bool = true;
        label160:
        localThemeRecentDynamicAvatarView.setFaceDrawable(localQQAppInterface, paramDrawable, i, paramajjg, 100, false, bool, 0);
      }
    }
    for (;;)
    {
      parama.arrow.setVisibility(4);
      parama.bRC = String.valueOf(0);
      ...
      bool = false;
      break label160;
      parama.a.setImageDrawable(paramDrawable);
    }
  }
  ...
  private void dispatchOnScrollStateChanged(int paramInt)
  {
    if (this.mOnPageChangeListeners != null)
    {
      ...
      while (i < j)
      {
        TabPageIndicator.c localc = (TabPageIndicator.c)this.mOnPageChangeListeners.get(i);
        if (localc != null) {
  ...
  private void init(Context paramContext, int paramInt)
  {
    ...
    this.mGestureDetector = new GestureDetector(getContext(), new ajkb(this), new Handler(Looper.getMainLooper()));
    addView(this.jdField_a_of_type_ComTencentMobileqqMultiaioWidgetIcsLinearLayout, new ViewGroup.LayoutParams(-2, -1));
    dxO();
    this.jdField_a_of_type_Ajiy.a(new ajkc(this));
    dxP();
  }
  
  private Drawable p(String paramString)
  {
    if (this.jdField_a_of_type_Aqdf == null)
    {
      this.jdField_a_of_type_Aqdf = new aqdf(this.mActivity, this.app);
  ...
  public View O(int paramInt)
  {
    ...
    ajjg localajjg = this.jdField_a_of_type_Ajjj.a(paramInt);
    a locala = new a();
    View localView = this.mInflater.inflate(2131558673, null);
    locala.a = ((ThemeRecentDynamicAvatarView)localView.findViewById(2131379150));
    ...
    Drawable localDrawable2 = p(localajjg.getUin());
    Drawable localDrawable1 = localDrawable2;
    if (localDrawable2 == null) {
      localDrawable1 = aqhu.at();
    }
    b(locala, localajjg, localDrawable1);
    localStringBuilder.append(localajjg.getName());
  ...
  public void a(TabPageIndicator.c paramc)
  {
    if (this.mOnPageChangeListeners == null) {
  ...
  public void computeScroll()
  {
    ...
    if (this.mScrollState == 2)
    {
      ...
      if ((!"HUAWEI".equalsIgnoreCase(Build.MANUFACTURER)) || (!"LYA-AL00".equalsIgnoreCase(Build.MODEL)) || (!this.coU)) {
        break label227;
      }
      i = 1;
      if (i == 0) {
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("TabPageIndicator", 2, "scrollTo() mPendingFinalX = " + this.djs);
        }
        scrollTo(this.djs, getScrollY());
        return;
        dxQ();
        return;
      } while (!QLog.isColorLevel());
  ...
  public void fling(int paramInt)
  {
    ...
    int i = j / this.itemWidth;
    float f = j * 1.0F / this.itemWidth;
    if (QLog.isColorLevel()) {
  ...
  protected boolean ku(int paramInt)
  {
  ...
  public void notifyDataSetChanged()
  {
    ...
    this.count = this.jdField_a_of_type_Ajjj.Go();
    int i = 0;
    while (i < this.count)
    {
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      {
        paramBitmap = this.jdField_a_of_type_Ajjj.a(paramInt1);
        if (paramBitmap == null)
        {
          break label427;
        ...
        int i = paramBitmap.getType();
        i = ((Integer)aajx.a(this.app, i, paramBitmap.getUin()).first).intValue();
        if (i == -2147483648) {
          break label427;
        }
        Object localObject2 = i + ":" + paramBitmap.getUin();
    ...
    if (paramInt1 < paramInt2)
    {
      ...
      for (f = Math.min((float)(Math.cos(f * 1.570796326794897D) * (MAX_SCALE - MIN_SCALE) + d), MAX_SCALE);; f = MIN_SCALE)
      {
        ...
        if ((localObject instanceof a))
        {
          ...
          ((a)localObject).a.setScaleX(f);
          ((a)localObject).a.setScaleY(f);
        }
        paramInt1 += 1;
        break;
      }
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      break;
      label137:
      this.itemWidth = wja.dp2px(56.0F, getResources());
    }
  }
  ...
  public void onPageScrollStateChanged(int paramInt)
  {
    ...
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqMultiaioWidgetIcsLinearLayout.getChildAt(this.mSelectedTabIndex);
    if (localObject == null) {}
    do
    {
      return;
  ...
  public void setMultiCardContext(ajjj paramajjj)
  {
    this.jdField_a_of_type_Ajjj = paramajjj;
  }
  
  public void setOnActionUpNotFling(TabPageIndicator.b paramb)
  {
  ...
  public void setOnTabClickListener(TabPageIndicator.d paramd)
  {
    this.jdField_a_of_type_ComTencentMobileqqMultiaioWidgetTabPageIndicator$d = paramd;
  }
  
  public void setOnTabReselectedListener(TabPageIndicator.e parame)
  {
  ...
  {
    ThemeRecentDynamicAvatarView a;
