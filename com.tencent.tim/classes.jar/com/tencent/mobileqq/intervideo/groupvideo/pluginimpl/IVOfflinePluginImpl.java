  ...
  implements IVOfflineInterface
{
  ...
  public IVOfflinePluginImpl(Context paramContext, WebView paramWebView)
  {
    ...
    jpa.setApplicationContext(paramContext);
    this.mWebView = paramWebView;
    this.mAuthConfig = jml.a(true);
    initHandler();
  ...
  private boolean checkModel()
  {
    if ((!this.isCheckModel) && (this.mBusinessId != null) && (this.mAuthConfig != null))
    {
      ...
      Object localObject1 = this.mAuthConfig.H("ex_offline", "");
  ...
  private void checkOfflineUp(String paramString)
  {
    ...
    jpa.a(paramString, ((BaseApplicationImpl)MobileQQ.getContext()).waitAppRuntime(null), new IVOfflinePluginImpl.1(this));
  }
  ...
  private void checkOfflineUpNotCallback(String paramString)
  {
    ...
    jpa.a(paramString, ((BaseApplicationImpl)MobileQQ.getContext()).waitAppRuntime(null), new IVOfflinePluginImpl.3(this));
  }
  ...
  private String checkOfflineUrl(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          this.mBusinessId = this.mAuthConfig.dF(paramString);
          if (this.mBid == null) {
            this.mBid = this.mBusinessId;
          }
          if (!TextUtils.isEmpty(this.mBusinessId))
  ...
  private boolean isCheckUpByNative(String paramString)
  {
    ...
    try
    {
      ...
      if (TextUtils.isEmpty(str)) {
        localObject2 = this.mAuthConfig.dG(paramString);
      }
  ...
  public void asyncLoadUrl(String paramString)
  {
    ...
    if (!jpa.a(this.mApplicationContext, paramString, new IVOfflinePluginImpl.4(this, l)))
    {
      ...
      for (;;)
      {
        ...
        if ((!TextUtils.isEmpty(this.mBusinessId)) || ((!TextUtils.isEmpty(paramString)) && (paramString.contains("_bid="))))
        {
          ...
          catch (Exception localException)
          {
            ...
            i = 1;
            if (((this.mOfflineLoadMode == 3) || (i != 0)) && (!jpa.C(str2, paramString)))
            {
              reloadCurrentUrl();
              if (QLog.isColorLevel())
              {
            ...
            {
              paramString = jpa.a(str2, paramString);
              if (paramString == null)
              {
                if (QLog.isColorLevel())
                {
              ...
              else
              {
                ...
                return new WebResourceResponse(paramString.mime, "utf-8", paramString.g);
              }
            }
          }
        }
