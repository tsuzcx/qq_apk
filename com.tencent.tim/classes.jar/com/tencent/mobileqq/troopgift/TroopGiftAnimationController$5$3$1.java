...
public class TroopGiftAnimationController$5$3$1
  implements Runnable
{
  public TroopGiftAnimationController$5$3$1(apxf paramapxf, Bitmap paramBitmap) {}
  
  public void run()
  {
    if (this.a.a.this$0.c != null) {
      ((TroopGiftToPersonalSurfaceView)this.a.a.this$0.c).setReceiveHeadBitmap(this.gw);
    }
  }
}
