...
public class MsgBackupNotifier
{
  ...
  public String getFilePathFromURL(String paramString)
  {
    ...
    try
    {
      paramString = ajgp.b().ma(paramString);
      return paramString;
    }
  ...
  {
    if (QLog.isColorLevel()) {
      Log.d("MsgBackup-Notifier", "onHttpRequest ipFrom = " + ajgv.ez(paramInt1) + ", port = " + paramInt2 + ", url = " + paramString);
    }
    ajgo.a().execute(new MsgBackupNotifier.12(this, paramLong, paramInt1, paramInt2, paramString));
  }
  ...
  public void onRecvComplete(long paramLong1, String paramString1, int paramInt1, String paramString2, byte[] paramArrayOfByte, int paramInt2, int paramInt3, long paramLong2)
  {
    ...
    ajgo.a().execute(new MsgBackupNotifier.11(this, paramLong1, paramString1, paramInt1, paramString2, paramArrayOfByte, paramInt2, paramInt3, paramLong2));
  }
  ...
  public void onRecvMessage(int paramInt1, int paramInt2, int paramInt3, String paramString, long paramLong)
  {
    ...
    ajgo.a().execute(new MsgBackupNotifier.8(this, paramInt1, paramInt2, paramInt3, paramString, paramLong));
  }
  ...
  public void onRecvProgress(long paramLong1, String paramString, long paramLong2, long paramLong3, int paramInt1, long paramLong4, int paramInt2, int paramInt3, long paramLong5)
  {
    ...
    ajgo.a().execute(new MsgBackupNotifier.10(this, paramLong1, paramLong3, paramLong4));
  }
  ...
  public void onRecvStart(long paramLong1, String paramString, long paramLong2, long paramLong3, long paramLong4)
  {
    ...
    ajgo.a().execute(new MsgBackupNotifier.9(this, paramLong1, paramString, paramLong2, paramLong3, paramLong4));
  }
  ...
  public void onSendComplete(long paramLong1, boolean paramBoolean, int paramInt1, String paramString, int paramInt2, int paramInt3, long paramLong2)
  {
    ...
    ajgo.a().execute(new MsgBackupNotifier.14(this, paramLong1, paramBoolean, paramInt1, paramString, paramInt2, paramInt3, paramLong2));
  }
  ...
  public void onSendMessage(boolean paramBoolean, long paramLong1, long paramLong2)
  {
    ...
    ajgo.a().execute(new MsgBackupNotifier.7(this, paramBoolean, paramLong1, paramLong2));
  }
  ...
  public void onSendProgress(long paramLong1, String paramString, long paramLong2, long paramLong3, int paramInt1, long paramLong4, int paramInt2, int paramInt3, long paramLong5)
  {
    ...
    ajgo.a().execute(new MsgBackupNotifier.13(this, paramLong1, paramString, paramLong2, paramLong3, paramInt1, paramLong4, paramInt2, paramInt3, paramLong5));
  }
  
  public void onServoPortChanged(int paramInt1, int paramInt2)
  {
    if (QLog.isColorLevel()) {
      Log.d("MsgBackup-Notifier", "onServoPortChanged ipV4 = " + ajgv.ez(paramInt1) + ", port = " + paramInt2);
    }
    ajgo.a().execute(new MsgBackupNotifier.5(this, paramInt1, paramInt2));
  }
  ...
  public void onTcpConnStateChanged(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ajgo.a().execute(new MsgBackupNotifier.6(this, paramInt));
      return;
    }
  }
  ...
  public void onUdpDetected(boolean paramBoolean)
  {
    ...
    ajgo.a().execute(new MsgBackupNotifier.1(this, paramBoolean));
  }
  
  public void onUdpPortChanged(int paramInt1, int paramInt2)
  {
    if (QLog.isColorLevel()) {
      Log.d("MsgBackup-Notifier", "onUdpPortChanged ipV4 = " + ajgv.ez(paramInt1) + ", port = " + paramInt2);
    }
    ajgo.a().execute(new MsgBackupNotifier.2(this, paramInt1, paramInt2));
  }
  
  public void onVersoBind(int paramInt1, int paramInt2)
  {
    if (QLog.isColorLevel()) {
      Log.d("MsgBackup-Notifier", "onVersoBind ipV4 = " + ajgv.ez(paramInt1) + ", port = " + paramInt2);
    }
    ajgo.a().execute(new MsgBackupNotifier.3(this, paramInt1, paramInt2));
  }
  
  public void onVersoPortChanged(int paramInt1, int paramInt2)
  {
    if (QLog.isColorLevel()) {
      Log.d("MsgBackup-Notifier", "onVersoPortChanged ipV4 = " + ajgv.ez(paramInt1) + ", port = " + paramInt2);
    }
    ajgo.a().execute(new MsgBackupNotifier.4(this, paramInt1, paramInt2));
  }
}
