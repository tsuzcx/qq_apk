...
public class ARNativeBridge
{
  ...
  private static boolean initSoEnvirontMent()
  {
    ...
    boolean bool3 = adeq.z("ArMapEngine836", needCheckMd5);
    if (!bool3) {}
    ...
    for (;;)
    {
      ...
      adix.a().au(System.currentTimeMillis() - l, loadSoSuccess);
  ...
  public void fNativeDoActionCallback(int paramInt1, String paramString1, int paramInt2, String paramString2)
  {
    ...
    ActionCallback localActionCallback = this.sActionCallback;
  ...
  public native void native_setARCardAnimationCallback(ARCardAnimationCallback paramARCardAnimationCallback);
  ...
  public native void native_setARWorldCupCallBack(ARWorldCupCallback paramARWorldCupCallback);
  ...
  public void setupActionCallback(ActionCallback paramActionCallback)
  {
  ...
  public static abstract interface ARCardAnimationCallback
  {
    public abstract void onAnimationComplete(int paramInt1, int paramInt2, int paramInt3);
  }
  
  public static abstract interface ARWorldCupCallback
  {
    public abstract void nativeCallBack(int paramInt1, int paramInt2, int paramInt3);
  }
