  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    adjv.C(localHashMap);
    anpc.a(BaseApplication.getContext()).collectPerformance("", "report_tag_detect_init_cost", true, 0L, 0L, localHashMap, "");
    if ((QLog.isColorLevel()) || (adjv.aeJ())) {
      QLog.i("MiniRecog.MiniScanReport", 2, String.format("base_test_scan onDetectInitCost [supportType,timeCost]=[%d,%d]", new Object[] { Integer.valueOf(this.cHy), Integer.valueOf(this.cHC) }));
    }
  }
}
