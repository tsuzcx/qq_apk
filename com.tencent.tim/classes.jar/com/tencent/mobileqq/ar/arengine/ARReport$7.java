...
public class ARReport$7
  implements Runnable
{
  public ARReport$7(adix paramadix, long paramLong, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      anpc.a(BaseApplication.getContext()).collectPerformance("", "ARLocalControlInt", true, 0L, 0L, localHashMap, "");
      return;
