...
public class ARReport$8
  implements Runnable
{
  public ARReport$8(adix paramadix, long paramLong, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      anpc.a(BaseApplication.getContext()).collectPerformance("", "ARCloudControlSo", true, 0L, 0L, localHashMap, "");
      return;
