...
public class ARReport$12
  implements Runnable
{
  public ARReport$12(adix paramadix, long paramLong, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      anpc.a(BaseApplication.getContext()).collectPerformance("", "ARNativeBridgeSo", true, 0L, 0L, localHashMap, "");
      return;
