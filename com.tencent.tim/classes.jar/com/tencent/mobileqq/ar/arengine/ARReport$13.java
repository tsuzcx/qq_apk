...
public class ARReport$13
  implements Runnable
{
  public ARReport$13(adix paramadix, long paramLong, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      anpc.a(BaseApplication.getContext()).collectPerformance("", "ARLocalFaceRecogInit", true, 0L, 0L, localHashMap, "");
      return;
