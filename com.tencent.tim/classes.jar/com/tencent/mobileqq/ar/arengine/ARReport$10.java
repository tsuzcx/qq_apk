...
public class ARReport$10
  implements Runnable
{
  public ARReport$10(adix paramadix, long paramLong, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      anpc.a(BaseApplication.getContext()).collectPerformance("", "ARLocalMarkerRecoglinit", true, 0L, 0L, localHashMap, "");
      return;
