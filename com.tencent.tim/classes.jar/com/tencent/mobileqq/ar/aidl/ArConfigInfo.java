...
{
  public static final Parcelable.Creator<ArConfigInfo> CREATOR = new adgh();
  ...
  public static ArConfigInfo loadConfigFromFile(String paramString1, String paramString2)
  {
    ...
    //   194: astore 7
    //   196: aload 7
    //   198: getfield 251	com/tencent/mobileqq/ar/aidl/ArCloudConfigInfo:flag	Z
    //   201: ifne -27 -> 174
    //   204: aload 5
    //   206: aload 7
  ...
  public static ArConfigInfo parseArConfig(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (str1.equalsIgnoreCase("ScanAR"))
      {
        ...
        if (i != 1)
        {
          ...
          {
            localArConfigInfo.aRBegin = aden.ah(((XmlPullParser)localObject1).nextText());
            i = ((XmlPullParser)localObject1).next();
          }
        }
        else
        ...
        {
          localArConfigInfo.aREnd = aden.ah(((XmlPullParser)localObject1).nextText());
          continue;
          return localObject1;
        }
      ...
      else
      {
        ...
        if (localException1.equalsIgnoreCase("Task"))
        {
          ...
          for (;;)
          {
            try
            {
              ((ArCloudConfigInfo)localObject2).businessId = Integer.parseInt(((XmlPullParser)localObject1).nextText());
              k = i;
            }
            catch (NumberFormatException localNumberFormatException1)
            {
              ((ArCloudConfigInfo)localObject2).businessId = 0;
              k = i;
              continue;
            }
            j = ((XmlPullParser)localObject1).next();
            ...
            if (bool)
            {
              try
              {
                ((ArCloudConfigInfo)localObject2).cFf = Integer.parseInt(((XmlPullParser)localObject1).nextText());
                k = i;
              }
              catch (NumberFormatException localNumberFormatException2)
              {
                ((ArCloudConfigInfo)localObject2).cFf = 0;
                k = i;
              }
            }
            else if (localNumberFormatException2.equalsIgnoreCase("PicId"))
            {
              ((ArCloudConfigInfo)localObject2).picId = ((XmlPullParser)localObject1).nextText();
              k = i;
            }
            else if (localNumberFormatException2.equalsIgnoreCase("SDKVersion"))
            {
              ((ArCloudConfigInfo)localObject2).bsN = ((XmlPullParser)localObject1).nextText();
              k = i;
            }
            else
            {
              ...
              if (bool)
              {
                try
                {
                  ((ArCloudConfigInfo)localObject2).cCF = Integer.parseInt(((XmlPullParser)localObject1).nextText());
                  k = i;
                }
                catch (NumberFormatException localNumberFormatException3)
                {
                  ((ArCloudConfigInfo)localObject2).cCF = 0;
                  k = i;
                }
              }
              else
              {
                ...
                if (bool)
                {
                  try
                  {
                    ((ArCloudConfigInfo)localObject2).type = Integer.parseInt(((XmlPullParser)localObject1).nextText());
                    k = i;
                  }
                  catch (NumberFormatException localNumberFormatException4)
                  {
                    ((ArCloudConfigInfo)localObject2).type = 0;
                    k = i;
                  }
                }
                else
                {
                  ...
                  if (m != 1)
                  {
                    ...
                    if (m == 2)
                    {
                      ...
                      {
                        ((ArFeatureInfo)localObject3).buc = ((XmlPullParser)localObject1).nextText();
                        i = 1;
                      }
                    }
                    label741:
                      ...
                      do
                      {
                        for (;;)
                        {
                          ...
                          if (bool)
                          {
                            try
                            {
                              ((ArFeatureInfo)localObject3).Uq = Long.parseLong(((XmlPullParser)localObject1).nextText());
                              i = 1;
                            }
                            catch (NumberFormatException localNumberFormatException5)
                            {
                              ((ArFeatureInfo)localObject3).Uq = 0L;
                              i = 1;
                            }
                          }
                          else
                          {
                            ...
                            ((ArFeatureInfo)localObject3).bud = ((XmlPullParser)localObject1).nextText();
                            i = 1;
                          }
                        }
                        i = j;
          ...
          if (((String)localObject3).equalsIgnoreCase("Web"))
          {
            ...
            for (j = ((XmlPullParser)localObject1).next();; j = ((XmlPullParser)localObject1).next())
            {
              ...
              try
              {
                ...
                bool = true;
                ((ArWebInfo)localObject3).bOa = bool;
              }
              catch (NumberFormatException localNumberFormatException6)
              {
                for (;;)
                {
                  ((ArWebInfo)localObject3).bOa = false;
                }
              }
            }
    ...
    for (;;)
    {
      try
      {
        ...
        bool = true;
        ((ArWebInfo)localObject3).bNZ = bool;
      }
      catch (NumberFormatException localNumberFormatException7)
      {
        ((ArWebInfo)localObject3).bNZ = false;
      }
      break label957;
      if (!localNumberFormatException7.equalsIgnoreCase("WebJumpUrl")) {
        break label957;
      }
      ((ArWebInfo)localObject3).but = ((XmlPullParser)localObject1).nextText();
      break label957;
      label1058:
      ...
      if (((String)localObject3).equalsIgnoreCase("ModelResource"))
      {
        ...
        while ((j != 3) || (!((XmlPullParser)localObject1).getName().equalsIgnoreCase("ModelResource"))) {
          for (;;)
          {
            ...
            {
              String str5;
              ((ArModelResource)localObject3).Ur = Integer.parseInt(((XmlPullParser)localObject1).nextText());
              j = ((XmlPullParser)localObject1).next();
            }
            catch (NumberFormatException localNumberFormatException8)
            {
              ((ArModelResource)localObject3).Ur = 0L;
              continue;
            }
            ...
            if (bool) {
              try
              {
                ((ArModelResource)localObject3).cIc = Integer.parseInt(((XmlPullParser)localObject1).nextText());
              }
              catch (NumberFormatException localNumberFormatException9)
              {
                ((ArModelResource)localObject3).cIc = 0;
              }
            } else if (localNumberFormatException9.equalsIgnoreCase("ModelResourceMD5")) {
              ((ArModelResource)localObject3).bum = ((XmlPullParser)localObject1).nextText();
            } else if (localNumberFormatException9.equalsIgnoreCase("ModelResourceUrl")) {
              ((ArModelResource)localObject3).bun = ((XmlPullParser)localObject1).nextText();
            } else if (localNumberFormatException9.equalsIgnoreCase("ModelResourceBgMusic")) {
              ((ArModelResource)localObject3).buo = ((XmlPullParser)localObject1).nextText();
            } else if (localNumberFormatException9.equalsIgnoreCase("ModelConfigFile")) {
              ((ArModelResource)localObject3).bup = ((XmlPullParser)localObject1).nextText();
            }
          }
        }
      ...
      if (((String)localObject3).equalsIgnoreCase("Award"))
      {
        ...
        while ((j != 3) || (!((XmlPullParser)localObject1).getName().equalsIgnoreCase("Award"))) {
          for (;;)
          {
            ...
            {
              String str6;
              ((ArAwardInfo)localObject3).cHY = Integer.parseInt(((XmlPullParser)localObject1).nextText());
              j = ((XmlPullParser)localObject1).next();
            }
            catch (NumberFormatException localNumberFormatException10)
            {
              ((ArAwardInfo)localObject3).cHY = 0;
              continue;
            }
            if (localNumberFormatException10.equalsIgnoreCase("NotPlayModel"))
            {
              if (Integer.parseInt(((XmlPullParser)localObject1).nextText()) == 1) {
                ((ArAwardInfo)localObject3).cHZ = 0;
              } else {
                ((ArAwardInfo)localObject3).cHZ = 1;
              }
            }
            else if (localNumberFormatException10.equalsIgnoreCase("BusinessBanner")) {
              ((ArAwardInfo)localObject3).btY = ((XmlPullParser)localObject1).nextText();
            } else if (localNumberFormatException10.equalsIgnoreCase("BusinessLogo")) {
              ((ArAwardInfo)localObject3).businessLogo = ((XmlPullParser)localObject1).nextText();
            } else if (localNumberFormatException10.equalsIgnoreCase("BusinessName")) {
              ((ArAwardInfo)localObject3).businessName = ((XmlPullParser)localObject1).nextText();
            } else if (localNumberFormatException10.equalsIgnoreCase("BusinessWishing")) {
              ((ArAwardInfo)localObject3).btZ = ((XmlPullParser)localObject1).nextText();
            }
          }
        }
      ...
      while ((j != 3) || (!((XmlPullParser)localObject1).getName().equalsIgnoreCase("VideoResource"))) {
        for (;;)
        {
          ...
          {
            String str7;
            ((ArVideoResourceInfo)localObject3).cId = Integer.parseInt(((XmlPullParser)localObject1).nextText());
            j = ((XmlPullParser)localObject1).next();
          }
          catch (NumberFormatException localNumberFormatException11)
          {
            ((ArVideoResourceInfo)localObject3).cId = 0;
            continue;
          }
          ...
          if (bool)
          {
            try
            {
              ((ArVideoResourceInfo)localObject3).cIf = Integer.parseInt(((XmlPullParser)localObject1).nextText());
            }
            catch (NumberFormatException localNumberFormatException12)
            {
              ((ArVideoResourceInfo)localObject3).cIf = 0;
            }
          }
          else if (localNumberFormatException12.equalsIgnoreCase("VideoKeyingConfig"))
          {
            ((ArVideoResourceInfo)localObject3).bur = ((XmlPullParser)localObject1).nextText();
          }
          else if (localNumberFormatException12.equalsIgnoreCase("VideoLayout"))
          {
            ((ArVideoResourceInfo)localObject3).buq = ((XmlPullParser)localObject1).nextText();
          }
          else if (localNumberFormatException12.equalsIgnoreCase("VideoMD5"))
          {
            ((ArVideoResourceInfo)localObject3).videoMd5 = ((XmlPullParser)localObject1).nextText();
          }
          else if (localNumberFormatException12.equalsIgnoreCase("VideoUrl"))
          {
            ((ArVideoResourceInfo)localObject3).videoUrl = ((XmlPullParser)localObject1).nextText();
          }
          else
          {
            ...
            if (bool)
            {
              try
              {
                ((ArVideoResourceInfo)localObject3).cIe = Integer.parseInt(((XmlPullParser)localObject1).nextText());
              }
              catch (NumberFormatException localNumberFormatException13)
              {
                ((ArVideoResourceInfo)localObject3).cIe = 0;
              }
            }
            else
            {
              ...
              if (bool)
              {
                try
                {
                  ((ArVideoResourceInfo)localObject3).videoType = Integer.parseInt(((XmlPullParser)localObject1).nextText());
                }
                catch (NumberFormatException localNumberFormatException14)
                {
                  ((ArVideoResourceInfo)localObject3).videoType = 0;
                }
              }
              else
              {
                ...
                if (bool)
                {
                  try
                  {
                    ((ArVideoResourceInfo)localObject3).videoSize = Long.parseLong(((XmlPullParser)localObject1).nextText());
                  }
                  catch (NumberFormatException localNumberFormatException15)
                  {
                    ((ArVideoResourceInfo)localObject3).videoSize = 0L;
                  }
                }
                else
                {
      ...
      ((ArCloudConfigInfo)localObject2).uk.add(localObject3);
      k = i;
      break label436;
      label2119:
      k = i;
      ...
      if (i != 1)
      {
        ...
        localArConfigInfo.aRCloudBegin = aden.ah(((XmlPullParser)localObject1).nextText());
      }
      label2237:
      while ((i != 3) || (!((XmlPullParser)localObject1).getName().equalsIgnoreCase("Cloud"))) {
        for (;;)
        {
          ...
          {
            localArConfigInfo.aRCloudEnd = aden.ah(((XmlPullParser)localObject1).nextText());
          }
          else
          {
  ...
  public static boolean saveArConfigToFile(ArConfigInfo paramArConfigInfo, String paramString1, String paramString2)
  {
    ...
    //   147: aload 6
    //   149: iconst_0
    //   150: invokevirtual 596	com/tencent/mobileqq/ar/aidl/ArConfigInfo:writeToParcel	(Landroid/os/Parcel;I)V
    //   153: aload 6
    //   155: invokevirtual 599	android/os/Parcel:marshall	()[B
    //   158: astore_0
    //   159: aload 7
    //   161: invokevirtual 602	java/io/File:getParentFile	()Ljava/io/File;
    //   164: astore_1
    //   165: aload_1
    //   166: invokevirtual 184	java/io/File:exists	()Z
    //   169: ifne +8 -> 177
    //   172: aload_1
    //   173: invokevirtual 605	java/io/File:mkdir	()Z
    //   176: pop
    //   177: aload 8
    ...
    //   190: pop
    //   191: new 607	java/io/FileOutputStream
    //   194: dup
    //   195: aload 8
    //   197: invokespecial 608	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   200: astore_2
    //   201: new 610	java/io/BufferedOutputStream
    //   204: dup
    //   205: aload_2
    //   206: invokespecial 613	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   209: astore_1
    //   210: aload_1
    //   211: aload_0
    //   212: invokevirtual 616	java/io/BufferedOutputStream:write	([B)V
    //   215: aload_1
    //   216: invokevirtual 619	java/io/BufferedOutputStream:flush	()V
    //   219: aload 8
    //   221: aload 7
    //   223: invokestatic 625	aqhq:renameFile	(Ljava/io/File;Ljava/io/File;)Z
    //   226: istore_3
    //   227: iload_3
    //   228: istore 4
    //   230: aload 6
    ...
    //   236: ifnull +7 -> 243
    //   239: aload_1
    //   240: invokevirtual 626	java/io/BufferedOutputStream:close	()V
    //   243: iload 4
    //   245: istore_3
    //   246: aload_2
    //   247: ifnull -155 -> 92
    //   250: aload_2
    //   251: invokevirtual 627	java/io/FileOutputStream:close	()V
    //   254: iload 4
    //   256: ireturn
    //   257: astore_0
    //   258: aload_0
    ...
    //   289: ifnull +7 -> 296
    //   292: aload_1
    //   293: invokevirtual 626	java/io/BufferedOutputStream:close	()V
    //   296: iload 4
    //   298: istore_3
    //   299: aload_0
    //   300: ifnull -208 -> 92
    //   303: aload_0
    //   304: invokevirtual 627	java/io/FileOutputStream:close	()V
    //   307: iconst_0
    //   308: ireturn
    //   309: astore_0
    //   310: aload_0
    ...
    //   335: ifnull +7 -> 342
    //   338: aload_1
    //   339: invokevirtual 626	java/io/BufferedOutputStream:close	()V
    //   342: aload_2
    //   343: ifnull +7 -> 350
    //   346: aload_2
    //   347: invokevirtual 627	java/io/FileOutputStream:close	()V
    //   350: aload_0
    //   351: athrow
    //   352: astore_1
    //   353: aload_1
  ...
  public ArCloudConfigInfo getModelResByMd5(String paramString)
  {
    ...
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localArCloudConfigInfo.jdField_a_of_type_ComTencentMobileqqArModelArModelResource != null) && (!TextUtils.isEmpty(localArCloudConfigInfo.jdField_a_of_type_ComTencentMobileqqArModelArModelResource.bum)))
        {
          boolean bool = paramString.equals(localArCloudConfigInfo.jdField_a_of_type_ComTencentMobileqqArModelArModelResource.bum);
          if (bool) {
