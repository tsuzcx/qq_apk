...
{
  public static final Parcelable.Creator<ARCommonConfigInfo> CREATOR = new adgc();
  ...
  public ArrayList<NativeSoRes> nativeSoResList = new ArrayList();
  public String osId;
  ...
  public ARCommonConfigInfo(Parcel paramParcel)
  {
    ...
    try
    {
      ...
      localObject1 = new ArrayList();
      paramParcel.readList((List)localObject1, NativeSoRes.class.getClassLoader());
      localObject1 = ((ArrayList)localObject1).iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (NativeSoRes)((Iterator)localObject1).next();
        if (localObject2 != null) {
    ...
    for (;;)
    {
      ...
      else if (localException3.equalsIgnoreCase("ScanAR"))
      {
        ...
        if (i != 1)
        {
          ...
          ((ARScanAR)localObject1).cDS = Integer.valueOf(localException1.nextText()).intValue();
        }
        label312:
        while ((i != 3) || (!localException1.getName().equalsIgnoreCase("ScanAR"))) {
          for (;;)
          {
            ...
            {
              ((ARScanAR)localObject1).aRBegin = aden.ah(localException1.nextText());
            }
            else if (str5.equalsIgnoreCase("End"))
            {
              ((ARScanAR)localObject1).aREnd = aden.ah(localException1.nextText());
            }
            else if (str5.equalsIgnoreCase("UserGuideBeginTime"))
            {
              ((ARScanAR)localObject1).Su = aden.ah(localException1.nextText());
            }
            else if (str5.equalsIgnoreCase("UserGuideEndTime"))
            {
              ((ARScanAR)localObject1).Sv = aden.ah(localException1.nextText());
            }
            else if (str5.equalsIgnoreCase("ActType"))
            {
              ((ARScanAR)localObject1).cDT = Integer.valueOf(localException1.nextText()).intValue();
            }
            else
            {
              ...
              if (bool)
              {
                try
                {
                  ((ARScanAR)localObject1).cDU = Integer.valueOf(localException1.nextText()).intValue();
                }
                catch (Exception localException7)
                {
                  ((ARScanAR)localObject1).cDU = 0;
                }
                if (QLog.isColorLevel()) {
              ...
              {
                ((ARScanAR)localObject1).bsk = localException1.nextText();
              }
              else if (localException7.equalsIgnoreCase("ScanIconMd5"))
              {
                ((ARScanAR)localObject1).bsl = localException1.nextText();
              }
              else if (localException7.equalsIgnoreCase("ScanIconPressed"))
              {
                ((ARScanAR)localObject1).bsm = localException1.nextText();
              }
              else if (localException7.equalsIgnoreCase("ScanIconPressedMd5"))
              {
                ((ARScanAR)localObject1).bsn = localException1.nextText();
              }
              else if (localException7.equalsIgnoreCase("ScanIconText"))
              {
                ((ARScanAR)localObject1).bso = localException1.nextText();
              }
              else if (localException7.equalsIgnoreCase("Scan_Line1"))
              {
                ((ARScanAR)localObject1).scanLine1 = localException1.nextText();
              }
              else if (localException7.equalsIgnoreCase("Scan_Line2"))
              {
                ((ARScanAR)localObject1).scanLine2 = localException1.nextText();
              }
              else if (localException7.equalsIgnoreCase("Scan_Line3"))
              {
                ((ARScanAR)localObject1).scanLineLink = localException1.nextText();
              }
              else if (localException7.equalsIgnoreCase("Scan_Line3_URL"))
              {
                ((ARScanAR)localObject1).scanLinkUrl = localException1.nextText();
              }
              else if (localException7.equalsIgnoreCase("What2ScanURL"))
              {
                ((ARScanAR)localObject1).bsp = localException1.nextText();
              }
              else if (localException7.equalsIgnoreCase("UserGuideWording"))
              {
                ((ARScanAR)localObject1).bsq = localException1.nextText();
              }
              else if (localException7.equalsIgnoreCase("UserGuideType"))
              {
                ((ARScanAR)localObject1).bsr = localException1.nextText();
              }
            }
          }
        }
      ...
      else if (((String)localObject1).equalsIgnoreCase("Recognition"))
      {
        ...
        if (i != 1)
        {
          ...
          ((ARRecognition)localObject1).type = Integer.valueOf(localException1.nextText()).intValue();
        }
        label996:
        label1264:
        while ((i != 3) || (!localException1.getName().equalsIgnoreCase("Recognition"))) {
          for (;;)
          {
            ...
            if (bool)
            {
              try
              {
                ((ARRecognition)localObject1).cCe = Integer.valueOf(localException1.nextText()).intValue();
              }
              catch (Exception localException8)
              {
                localException8.printStackTrace();
                ((ARRecognition)localObject1).cCe = 1;
              }
            }
            else
            {
              ...
              if (bool)
              {
                try
                {
                  ((ARRecognition)localObject1).cCf = Integer.valueOf(localException1.nextText()).intValue();
                }
                catch (Exception localException9)
                {
                  localException9.printStackTrace();
                  ((ARRecognition)localObject1).cCf = 1;
                }
              }
              else
              {
                ...
                if (bool)
                {
                  try
                  {
                    ((ARRecognition)localObject1).priority = Integer.valueOf(localException1.nextText()).intValue();
                  }
                  catch (Exception localException10)
                  {
                    localException10.printStackTrace();
                    ((ARRecognition)localObject1).priority = 5;
                  }
                }
                else
                {
                  ...
                  if (bool)
                  {
                    try
                    {
                      ((ARRecognition)localObject1).RZ = Long.valueOf(localException1.nextText()).longValue();
                    }
                    catch (Exception localException11)
                    {
                      localException11.printStackTrace();
                      ((ARRecognition)localObject1).RZ = 3000L;
                    }
                  }
                  else if (localException11.equalsIgnoreCase("ImagePreprocess"))
                  {
                    ...
                    if (i != 1)
                    {
                      ...
                      if (localException1.getName().equalsIgnoreCase("Open")) {
                        ((ARRecognition)localObject1).cCg = Integer.valueOf(localException1.nextText()).intValue();
                      }
                    }
      ...
      else
      {
        ...
        else if (((String)localObject1).equalsIgnoreCase("Cloud"))
        {
          ...
          if (i != 1)
          {
            ...
            localARCommonConfigInfo.aRCloudBegin = aden.ah(localException1.nextText());
          }
          label1485:
          label1663:
          while ((i != 3) || (!localException1.getName().equalsIgnoreCase("Cloud"))) {
            for (;;)
            {
              ...
              {
                localARCommonConfigInfo.aRCloudEnd = aden.ah(localException1.nextText());
              }
              else
              {
        ...
        else if (localException6.equalsIgnoreCase("NativeSoRes"))
        {
          ...
          if (i != 1)
          {
            ...
            ((NativeSoRes)localObject2).name = localException1.nextText();
          }
          label1763:
          while ((i != 3) || (!localException1.getName().equalsIgnoreCase("NativeSoRes"))) {
            for (;;)
            {
              ...
              {
                ((NativeSoRes)localObject2).version = localException1.nextText();
              }
              else if (str7.equalsIgnoreCase("Url"))
              {
                ((NativeSoRes)localObject2).url = localException1.nextText();
              }
              else if (str7.equalsIgnoreCase("Md5"))
              {
                ((NativeSoRes)localObject2).md5 = localException1.nextText();
              }
              else
              {
                ...
                if (bool) {
                  try
                  {
                    ((NativeSoRes)localObject2).size = Long.valueOf(localException1.nextText()).longValue();
                  }
                  catch (Exception localException12)
                  {
                    localException12.printStackTrace();
                    ((NativeSoRes)localObject2).size = 0L;
                  }
                }
              }
            }
        ...
        else if (((String)localObject2).equalsIgnoreCase("ARRelationShipAIOMsg"))
        {
          ...
          if (i != 1)
          {
            ...
            ((ARRelationShipAIOMsg)localObject2).brZ = localException1.nextText();
          }
          label1998:
          while ((i != 3) || (!localException1.getName().equalsIgnoreCase("ARRelationShipAIOMsg"))) {
            for (;;)
            {
              ...
              if (str8.equalsIgnoreCase("AIOMsgSourceIconUrl")) {
                ((ARRelationShipAIOMsg)localObject2).bsa = localException1.nextText();
              } else if (str8.equalsIgnoreCase("AIOMsgSourceAction")) {
                ((ARRelationShipAIOMsg)localObject2).bsb = localException1.nextText();
              } else if (str8.equalsIgnoreCase("AIOMsgSourceActionData")) {
                ((ARRelationShipAIOMsg)localObject2).bsc = localException1.nextText();
              } else if (str8.equalsIgnoreCase("AIOMsgSourceUrl")) {
                ((ARRelationShipAIOMsg)localObject2).bsd = localException1.nextText();
              }
            }
          }
          label2098:
  ...
  public static boolean saveArConfigToFile(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   123: aload_0
    //   124: ldc 254
    //   126: invokevirtual 579	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   129: astore_0
    //   130: aload 6
    //   132: invokevirtual 582	java/io/File:getParentFile	()Ljava/io/File;
    //   135: astore_1
    //   136: aload_1
    //   137: invokevirtual 219	java/io/File:exists	()Z
    //   140: ifne +8 -> 148
    //   143: aload_1
    //   144: invokevirtual 585	java/io/File:mkdir	()Z
    //   147: pop
    //   148: aload 7
    ...
    //   161: pop
    //   162: new 587	java/io/FileOutputStream
    //   165: dup
    //   166: aload 7
    //   168: invokespecial 588	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   171: astore_2
    //   172: new 590	java/io/BufferedOutputStream
    //   175: dup
    //   176: aload_2
    //   177: invokespecial 593	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   180: astore_1
    //   181: aload_1
    //   182: aload_0
    //   183: invokevirtual 596	java/io/BufferedOutputStream:write	([B)V
    //   186: aload_1
    //   187: invokevirtual 599	java/io/BufferedOutputStream:flush	()V
    //   190: aload 7
    //   192: aload 6
    //   194: invokestatic 605	aqhq:renameFile	(Ljava/io/File;Ljava/io/File;)Z
    //   197: istore 4
    //   199: aload_1
    //   200: ifnull +7 -> 207
    //   203: aload_1
    //   204: invokevirtual 606	java/io/BufferedOutputStream:close	()V
    //   207: iload 4
    //   209: istore_3
    //   210: aload_2
    //   211: ifnull -135 -> 76
    //   214: aload_2
    //   215: invokevirtual 607	java/io/FileOutputStream:close	()V
    //   218: iload 4
    //   220: ireturn
    //   221: astore_0
    //   222: aload_0
    ...
    //   229: astore_0
    //   230: aload_0
    //   231: invokevirtual 608	java/io/UnsupportedEncodingException:printStackTrace	()V
    //   234: aload_1
    //   235: astore_0
    //   236: goto -106 -> 130
    //   239: astore_0
    ...
    //   258: ifnull +7 -> 265
    //   261: aload_1
    //   262: invokevirtual 606	java/io/BufferedOutputStream:close	()V
    //   265: aload_0
    //   266: ifnull +7 -> 273
    //   269: aload_0
    //   270: invokevirtual 607	java/io/FileOutputStream:close	()V
    //   273: iconst_0
    //   274: ireturn
    //   275: astore_1
    //   276: aload_1
    ...
    //   297: ifnull +7 -> 304
    //   300: aload_1
    //   301: invokevirtual 606	java/io/BufferedOutputStream:close	()V
    //   304: aload_2
    //   305: ifnull +7 -> 312
    //   308: aload_2
    //   309: invokevirtual 607	java/io/FileOutputStream:close	()V
    //   312: aload_0
    //   313: athrow
    //   314: astore_1
    //   315: aload_1
  ...
  public boolean isEnableARCloud()
  {
    ...
    for (;;)
    {
      ...
      {
        if (((ARRecognition)this.recognitions.get(i)).cCe != 0) {
          bool1 = true;
        }
      }
      else
  ...
  public static class NativeSoRes
    implements Parcelable
  {
    public static final Parcelable.Creator<NativeSoRes> CREATOR = new adgd();
    public String md5 = "";
    public String name = "";
    public long size;
    public String url = "";
    ...
    public NativeSoRes(Parcel paramParcel)
    {
    ...
    public String toString()
    {
      ...
      localStringBuffer.append(", size = ").append(this.size);
      localStringBuffer.append('}');
      return localStringBuffer.toString();
    }
