  ...
  implements Runnable
{
  public void run()
  {
    addp.a(this.this$0).native_onTouchBegin(this.val$idPointerDown, this.val$xPointerDown, this.val$yPointerDown, 5, this.val$timestamp, addp.a(this.this$0).mCurrentActiveId);
