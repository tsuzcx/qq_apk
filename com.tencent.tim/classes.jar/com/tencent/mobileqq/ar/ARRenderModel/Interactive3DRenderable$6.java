  ...
  implements Runnable
{
  public void run()
  {
    addp.a(this.this$0).native_onTouchEnd(this.val$idPointerUp, this.val$xPointerUp, this.val$yPointerUp, 6, this.val$timestamp, addp.a(this.this$0).mCurrentActiveId);
