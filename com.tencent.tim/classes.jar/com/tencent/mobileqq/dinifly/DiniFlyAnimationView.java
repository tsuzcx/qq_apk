  ...
  extends ImageView
{
  ...
  private void init(@Nullable AttributeSet paramAttributeSet)
  {
    ...
    for (inDensity = 160;; inDensity = 320)
    {
      ...
      bool1 = paramAttributeSet.hasValue(atau.a.eoN);
      bool2 = paramAttributeSet.hasValue(atau.a.eoJ);
      bool3 = paramAttributeSet.hasValue(atau.a.eoS);
      if ((!bool1) || (!bool2)) {
        break;
      }
    ...
    if (bool1)
    {
      int i = paramAttributeSet.getResourceId(atau.a.eoN, 0);
      if (i != 0) {
        setAnimation(i);
      }
    }
    ...
    {
      label181:
      if (paramAttributeSet.getBoolean(atau.a.eoG, false))
      {
        this.wasAnimatingWhenDetached = true;
        this.autoPlay = true;
      }
      if (paramAttributeSet.getBoolean(atau.a.eoL, false)) {
        this.lottieDrawable.setRepeatCount(-1);
      }
      if (paramAttributeSet.hasValue(atau.a.eoP)) {
        setRepeatMode(paramAttributeSet.getInt(atau.a.eoP, 1));
      }
      if (paramAttributeSet.hasValue(atau.a.eoO)) {
        setRepeatCount(paramAttributeSet.getInt(atau.a.eoO, -1));
      }
      if (paramAttributeSet.hasValue(atau.a.eoR)) {
        setSpeed(paramAttributeSet.getFloat(atau.a.eoR, 1.0F));
      }
      setImageAssetsFolder(paramAttributeSet.getString(atau.a.eoK));
      setProgress(paramAttributeSet.getFloat(atau.a.eoM, 0.0F));
      enableMergePathsForKitKatAndAbove(paramAttributeSet.getBoolean(atau.a.eoI, false));
      Object localObject1;
      if (paramAttributeSet.hasValue(atau.a.eoH))
      {
        Object localObject2 = new SimpleColorFilter(paramAttributeSet.getColor(atau.a.eoH, 0));
      ...
      if (paramAttributeSet.hasValue(atau.a.eoQ)) {
        this.lottieDrawable.setScale(paramAttributeSet.getFloat(atau.a.eoQ, 1.0F), paramAttributeSet.getFloat(atau.a.eoQ, 1.0F));
      }
      ...
      if (bool2)
      {
        localObject1 = paramAttributeSet.getString(atau.a.eoJ);
      ...
      {
        localObject1 = paramAttributeSet.getString(atau.a.eoS);
        if (localObject1 != null) {
