  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      JSONObject localJSONObject1 = AECameraPlugin.a(this.this$0, this.azt, 0);
    ...
    catch (IOException localIOException)
    {
      ...
      this.this$0.callJs(this.val$callbackId, new String[] { localJSONObject2.toString() });
      return;
    }
    catch (JSONException localJSONException)
    {
      JSONObject localJSONObject3 = AECameraPlugin.a(this.this$0, "json exception");
      this.this$0.callJs(this.val$callbackId, new String[] { localJSONObject3.toString() });
      return;
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      JSONObject localJSONObject4 = AECameraPlugin.a(this.this$0, "out of memory");
      this.this$0.callJs(this.val$callbackId, new String[] { localJSONObject4.toString() });
    }
  }
}
