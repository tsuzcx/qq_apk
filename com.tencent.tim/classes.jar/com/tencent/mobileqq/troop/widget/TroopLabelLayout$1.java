  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      synchronized (this.this$0.CA)
      {
        if ((this.this$0.CA != null) && (this.this$0.CA.size() != 0)) {
          break label235;
        }
        return;
        GroupLabel localGroupLabel;
        Object localObject2;
        if (j < this.this$0.CA.size())
        {
          localGroupLabel = (GroupLabel)this.this$0.CA.get(j);
          if (j == 0)
          {
            i = 0;
            break label242;
          }
          localObject2 = (GroupLabel)this.this$0.CA.get(i);
          if (TroopLabelLayout.aj.get((int)((GroupLabel)localObject2).type) <= TroopLabelLayout.aj.get((int)localGroupLabel.type))
          {
            i = j;
            break label242;
          }
        ...
        {
          localGroupLabel = (GroupLabel)this.this$0.CA.get(i);
          i = k;
