  ...
  implements Serializable, Cloneable
{
  ...
  public View getView(Context paramContext, View.OnClickListener paramOnClickListener)
  {
    ...
    View localView = LayoutInflater.from(paramContext).inflate(2131560115, null);
    RelativeLayout localRelativeLayout = (RelativeLayout)localView.findViewById(2131363084);
    ...
    for (localLayoutParams.width = ((int)aqho.convertDpToPixel(paramContext, i));; localLayoutParams.width = ((int)aqho.convertDpToPixel(paramContext, this.mMaxLayoutLength)))
    {
      localLayoutParams.height = ((int)aqho.convertDpToPixel(paramContext, 41.0F));
      localLayoutParams.topMargin = ((int)aqho.convertDpToPixel(paramContext, 12.0F));
      localLayoutParams.leftMargin = ((int)aqho.convertDpToPixel(paramContext, 3.0F));
      localRelativeLayout.setLayoutParams(localLayoutParams);
      i = (int)aqho.convertDpToPixel(paramContext, 5.0F);
      localRelativeLayout.setPadding(i, i, i, i);
      localView.findViewById(2131363087).setOnClickListener(paramOnClickListener);
      this.mAudioIcon = ((ImageView)localView.findViewById(2131363086));
      this.mAudioIcon.setOnClickListener(paramOnClickListener);
      paramContext = (TextView)localView.findViewById(2131363085);
