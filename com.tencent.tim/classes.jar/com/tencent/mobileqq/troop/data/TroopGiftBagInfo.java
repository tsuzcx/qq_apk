  ...
  extends Entity
{
  ...
  @notColumn
  public apda myGrabResult;
  public String myGrabResultData;
  @notColumn
  public List<apda> players;
  ...
  public TroopGiftBagInfo(oidb_0x6c2.GiftBagInfo paramGiftBagInfo, oidb_0x6c2.Player paramPlayer)
  {
    ...
    {
      apda localapda = new apda((oidb_0x6c2.Player)localList.get(i));
      this.players.add(localapda);
      i += 1;
    }
    ...
    if (paramPlayer != null) {
      this.myGrabResult = new apda(paramPlayer);
    }
  }
  
  private List<apda> decodeBagPlayerList(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          localapda.fromJson(paramString.toString());
          localArrayList.add(localapda);
          i += 1;
        }
  ...
  {
    return (this.myGrabResult != null) && (this.myGrabResult.amount > 0);
  }
  ...
  public void prewrite()
  {
    ...
    {
      localJSONArray.put(((apda)this.players.get(i)).toJson());
      i += 1;
    }
    this.playersData = localJSONArray.toString();
    if (this.myGrabResult != null) {
      this.myGrabResultData = this.myGrabResult.toJson();
    }
  }
}
