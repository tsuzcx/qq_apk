...
class TroopAvatarWallPreviewActivity$8
  implements Runnable
{
  TroopAvatarWallPreviewActivity$8(TroopAvatarWallPreviewActivity paramTroopAvatarWallPreviewActivity, URLDrawable paramURLDrawable, ausj paramausj) {}
  ...
  public void run()
  {
    try
    {
      ...
      if (str2 != null)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("TroopAvatarWallPreviewActivity", 2, "Get cookie: " + jqo.b(str2, new String[0]) + " from " + jqo.filterKeyForLog(str1, new String[0]));
        }
      }
