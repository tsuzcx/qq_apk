  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject = adwx.c().query(RockDownloadInfo.class, true, "businessName=? AND packageName=?", new String[] { this.a.getDownloadInfo().businessName, this.a.getDownloadInfo().packageName }, null, null, null, null);
    ...
    if (this.a.getQueryAPKListener() != null)
    {
      if (localArrayList.size() > 0) {
        this.a.getQueryAPKListener().onSuccess(localArrayList);
      }
    }
    else {
      return;
    }
    this.a.getQueryAPKListener().a(this.a.getDownloadInfo(), acfp.m(2131713977), 10002);
  }
}
