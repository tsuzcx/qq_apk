  ...
  implements Serializable
{
  ...
  private static List<MayKnowRecommendLabel> convert0xc26ToMayKnowRecommendLabel(List<oidb_0xc26.Label> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    int k;
    MayKnowRecommendLabel localMayKnowRecommendLabel;
    int i;
    label194:
    int j;
    if ((paramList != null) && (paramList.size() != 0))
    {
      ...
      if (k < paramList.size())
      {
        localMayKnowRecommendLabel = new MayKnowRecommendLabel();
  ...
  public static class MayKnowRecommendLabel
