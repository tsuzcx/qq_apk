  ...
  extends ChatMessage
{
  ...
  private String parseLine(JSONObject paramJSONObject)
  {
    ...
    default: 
      return "";
    case 20002: 
      return line(2131697247, paramJSONObject.optString("key_profile_nickname", ""));
    case 20031: 
      i = paramJSONObject.optInt("key_profile_birthday", 0);
      return line(2131697181, String.format(Locale.getDefault(), "%d-%d-%d", new Object[] { Integer.valueOf((0xFFFF0000 & i) >>> 16), Integer.valueOf((0xFF00 & i) >>> 8), Integer.valueOf(i & 0xFF) }));
    case 27264: 
      return line(2131697184, paramJSONObject.optString("key_profile_education", ""));
    case 20032: 
      return line(2131697242, paramJSONObject.optString("key_profile_location_desc", ""));
    case 24002: 
      return line(2131697238, paramJSONObject.optString("key_profile_location_desc", ""));
    case 24008: 
      return line(2131697196, paramJSONObject.optString("key_profile_company", ""));
    case 27037: 
      i = paramJSONObject.optInt("key_profile_occupation", -1);
      String str = "";
      paramJSONObject = str;
      if (i < aqek.cq.length - 1) {
        if (i > 0) {
          break label267;
        }
      }
      for (paramJSONObject = str;; paramJSONObject = aqek.cq[i]) {
        return line(2131697272, paramJSONObject);
      }
    case 20011: 
      label267:
      return line(2131697229, paramJSONObject.optString("key_profile_email", ""));
    }
    return line(2131697267, paramJSONObject.optString("key_profile_introduction", ""));
  }
