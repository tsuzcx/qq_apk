  ...
  implements Cloneable
{
  ...
  {
    this.selfuin = String.valueOf(acbn.bkw);
    ...
    for (;;)
    {
      ...
      if (paramInt == 105)
      {
        ...
        try
        {
          ...
          paramDataLineMsgRecord.fileMsgStatus = aqft.e((byte[])localObject2);
          ((ByteArrayInputStream)localObject1).read((byte[])localObject2);
          paramDataLineMsgRecord.nWeiyunSessionId = aqft.e((byte[])localObject2);
      ...
      if (paramInt == 104)
      {
        ...
        paramDataLineMsgRecord.fileMsgStatus = aqft.e((byte[])localObject1);
  ...
  public boolean canForward()
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (aqhq.fileExistsAndNotEmpty(this.path))
    {
      bool1 = bool2;
  ...
  public FileManagerEntity trans2Entity()
  {
    ...
    if (this.entityID != 0L) {
      localFileManagerEntity = localQQAppInterface.a().b(this.entityID);
    }
