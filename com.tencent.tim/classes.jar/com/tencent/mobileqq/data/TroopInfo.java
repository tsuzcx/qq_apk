  ...
  implements Serializable
{
  ...
  public static final String QIDIAN_TROOP_MEMBER_DEF_NICK = acfp.m(2131715813);
  ...
  private void coverFrom_TroopMemo(oidb_0x88d.GroupInfo paramGroupInfo)
  {
    ...
    label87:
    this.mRichFingerMemo = jqc.dS(this.mRichFingerMemo);
    this.mRichFingerMemo = jqc.dR(this.mRichFingerMemo);
  }
  ...
  public void coverAdministrators(QQAppInterface paramQQAppInterface, ArrayList<String> paramArrayList)
  {
    ...
    ((TroopManager)paramQQAppInterface.getManager(52)).i(this);
  }
  ...
  public String getAdminShow(Context paramContext)
  {
    if (TextUtils.isEmpty(this.adminNameShow)) {
      return paramContext.getString(2131721282);
    }
  ...
  public String getInviteModeDesWording(Resources paramResources)
  {
    ...
    if ((this.troopPrivilegeFlag & 0x6100000) == 0L) {
      str = paramResources.getString(2131698730);
    }
    ...
    return paramResources.getString(2131698731);
  }
  ...
  public String getInviteModeWording(Resources paramResources)
  {
    ...
    if ((hasPayPrivilege(this.troopPrivilegeFlag, 128)) && (hasPayPrivilege(this.troopPrivilegeFlag, 512)))
    {
      ...
      str = paramResources.getString(2131698735);
    }
    label69:
    do
    {
  ...
  public String getOwnerShow(Context paramContext)
  {
    if (TextUtils.isEmpty(this.ownerNameShow)) {
      return paramContext.getString(2131721451);
    }
  ...
  public String getTroopName()
  {
    ...
    if (!TextUtils.isEmpty(this.newTroopName))
    {
      if (System.currentTimeMillis() - this.newTroopNameTimeStamp > 86400000L) {
        TroopNameHelper.TU(this.troopuin);
      }
  ...
  public void prewrite()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 1298	com/tencent/mobileqq/persistence/Entity:prewrite	()V
    //   4: new 1252	org/json/JSONArray
    //   7: dup
    //   8: invokespecial 1299	org/json/JSONArray:<init>	()V
    //   11: astore_1
    //   12: aload_0
    //   13: getfield 250	com/tencent/mobileqq/data/TroopInfo:mTroopPicList	Ljava/util/List;
    //   16: invokeinterface 445 1 0
    //   21: astore_2
    //   22: aload_2
    //   23: invokeinterface 288 1 0
    //   28: ifeq +83 -> 111
    //   31: aload_2
    //   32: invokeinterface 292 1 0
    //   37: checkcast 447	com/tencent/mobileqq/activity/photo/TroopClipPic
    //   40: astore_3
    //   41: aload_3
    //   42: getfield 1275	com/tencent/mobileqq/activity/photo/TroopClipPic:id	Ljava/lang/String;
    //   45: invokestatic 352	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   48: ifne -26 -> 22
    //   51: new 1263	org/json/JSONObject
    //   54: dup
    //   55: invokespecial 1300	org/json/JSONObject:<init>	()V
    //   58: astore 4
    //   60: aload 4
    //   62: ldc_w 1261
    //   65: aload_3
    //   66: getfield 1275	com/tencent/mobileqq/activity/photo/TroopClipPic:id	Ljava/lang/String;
    //   69: invokevirtual 1303	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   72: pop
    //   73: aload_3
    //   74: getfield 1278	com/tencent/mobileqq/activity/photo/TroopClipPic:clipInfo	Ljava/lang/String;
    //   77: invokestatic 352	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   80: ifne +16 -> 96
    //   83: aload 4
    //   85: ldc_w 1267
    //   88: aload_3
    //   89: getfield 1278	com/tencent/mobileqq/activity/photo/TroopClipPic:clipInfo	Ljava/lang/String;
    //   92: invokevirtual 1303	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   95: pop
    //   96: aload_1
    //   97: aload 4
    //   99: invokevirtual 1306	org/json/JSONArray:put	(Ljava/lang/Object;)Lorg/json/JSONArray;
    //   102: pop
    //   103: goto -81 -> 22
    //   106: astore_2
    //   107: aload_2
    //   108: invokevirtual 1279	org/json/JSONException:printStackTrace	()V
    //   111: aload_0
    //   112: aload_1
    //   113: invokevirtual 1307	org/json/JSONArray:toString	()Ljava/lang/String;
    //   116: putfield 259	com/tencent/mobileqq/data/TroopInfo:mTroopPicListJson	Ljava/lang/String;
    //   119: invokestatic 736	com/tencent/TMG/utils/QLog:isColorLevel	()Z
    //   122: ifeq +43 -> 165
    //   125: ldc 61
    //   127: iconst_0
    //   128: ldc_w 1309
    //   131: iconst_3
    //   132: anewarray 1201	java/lang/Object
    //   135: dup
    //   136: iconst_0
    //   137: aload_0
    //   138: getfield 883	com/tencent/mobileqq/data/TroopInfo:troopuin	Ljava/lang/String;
    //   141: aastore
    //   142: dup
    //   143: iconst_1
    //   144: aload_0
    //   145: getfield 837	com/tencent/mobileqq/data/TroopInfo:mTroopAvatarId	I
    //   148: invokestatic 1110	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   151: aastore
    //   152: dup
    //   153: iconst_2
    //   154: aload_0
    //   155: getfield 259	com/tencent/mobileqq/data/TroopInfo:mTroopPicListJson	Ljava/lang/String;
    //   158: aastore
    //   159: invokestatic 1292	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   162: invokestatic 1294	com/tencent/TMG/utils/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   165: return
    //   166: astore_2
    //   167: aload_2
    //   168: invokevirtual 1295	java/lang/Exception:printStackTrace	()V
    //   171: goto -60 -> 111
  ...
  public void setLastMemoData(oidb_0x8f9.GroupFeedsRecord paramGroupFeedsRecord)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramGroupFeedsRecord = aptr.a(String.valueOf(paramGroupFeedsRecord.uint32_feeds_type.get()), localGroupFeedsMessage.toByteArray(), true);
        if (paramGroupFeedsRecord == null) {
          continue;
        }
        this.strLastAnnouncement = paramGroupFeedsRecord.text;
      }
  ...
  public void updateHeadMemberList(ArrayList<String> paramArrayList)
  {
    ...
    this.mHeaderUinsNew = GroupIconHelper.b(GroupIconHelper.a(paramArrayList, this), false);
  }
  ...
  public void updateHeadMemberUins(List<oidb_0x899.memberlist> paramList)
  {
    ...
    label118:
    this.mHeaderUinsNew = GroupIconHelper.b(GroupIconHelper.a(localArrayList, this), false);
  }
