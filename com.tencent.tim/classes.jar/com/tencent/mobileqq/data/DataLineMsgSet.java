  ...
  implements Cloneable
{
  ...
  public static boolean isCanReciveOrResend(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    while ((paramDataLineMsgRecord.progress == 1.0F) && (paramDataLineMsgRecord.issuc) && ((TextUtils.isEmpty(paramDataLineMsgRecord.path)) || (!ahbj.isFileExists(paramDataLineMsgRecord.path)))) {
      return true;
    }
    return false;
  }
  ...
  {
    return anaz.gQ() - this.mLastArriveTime > 90L;
  }
  ...
  {
    this.mLastArriveTime = (anaz.gQ() - 95L);
    if (QLog.isColorLevel()) {
