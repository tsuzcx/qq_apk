  ...
  extends ChatMessage
{
  ...
  protected void doParse()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localArkContextInfo = new ArkContextInfo();
      ...
      {
        int i;
        ArkContextInfo localArkContextInfo;
  ...
  public void saveRecommendMsg(WeakReference<QQAppInterface> paramWeakReference, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramInt < this.mContextList.size())
        {
          ...
          ArkContextInfo localArkContextInfo = (ArkContextInfo)this.mContextList.get(paramInt);
    ...
    label444:
    ArkRecommendLogic.u().post(new RecommendCommonMessage.1(this, paramWeakReference));
  }
  
  public static class ArkContextInfo
  {
    public String context = "";
    public LinkedList<RecommendCommonMessage.ArkMsgAppInfo> contextAppInfoList = new LinkedList();
