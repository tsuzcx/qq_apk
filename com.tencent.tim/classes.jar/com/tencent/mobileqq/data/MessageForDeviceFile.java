  ...
  extends ChatMessage
{
  ...
  protected void doParse()
  {
    try
    {
      DeviceFileMsgSerial localDeviceFileMsgSerial = (DeviceFileMsgSerial)aczw.c(this.msgData);
  ...
  public void serial()
  {
    DeviceFileMsgSerial localDeviceFileMsgSerial = new DeviceFileMsgSerial(null);
    ...
    try
    {
      this.msgData = aczw.b(localDeviceFileMsgSerial);
      return;
    }
    catch (Exception localException)
    {
  ...
  static class DeviceFileMsgSerial
