  ...
  implements Comparable<DateEventMsg>
{
  ...
  public static DateEventMsg convertFrom(appoint_define.DateEvent paramDateEvent)
  {
    ...
    {
      localDateEventMsg.user_info = afcj.a((appoint_define.StrangerInfo)paramDateEvent.msg_user_info.get());
      label96:
    ...
    if (paramDateEvent.msg_comment.has()) {
      localDateEventMsg.date_comment = afcf.a((appoint_define.DateComment)paramDateEvent.msg_comment.get());
    }
    for (;;)
    {
      afck.l("DateEventMsg.convertFrom", new Object[] { localDateEventMsg.date_comment });
      break;
      afck.m("DateEventMsg.convertFrom", new Object[] { "msg_comment no value" });
    }
    ...
    for (;;)
    {
      afck.l("DateEventMsg.convertFrom", new Object[] { paramDateEvent.str_event_tips.get(), localDateEventMsg.str_event_tips });
      break;
      localDateEventMsg.str_event_tips = acfp.m(2131704652);
      continue;
      localDateEventMsg.str_event_tips = acfp.m(2131704653);
      continue;
      localDateEventMsg.str_event_tips = acfp.m(2131704654);
    }
  }
  ...
  public void init()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        for (this.user_info = null; (this.msg_date_info == null) || (this.msg_date_info.length == 0); this.user_info = afcj.a(new JSONObject(this.msg_user_info)))
        {
          this.date_info = null;
      ...
      catch (Exception localException2)
      {
        ...
        this.date_comment = afcf.a(new JSONObject(this.msg_content));
        afck.l("DateEventMsg.init", new Object[] { Integer.valueOf(this.type), this.date_comment, this.msg_content });
        return;
      }
  ...
  {
    Object localObject = afcj.a(this.user_info);
    if (localObject == null)
    {
      localObject = "";
      ...
      localObject = afcf.a(this.date_comment);
      if (localObject != null) {
        break label91;
      }
      localObject = "";
