  ...
  extends ChatMessage
{
  ...
  protected void doParse()
  {
    try
    {
      this.mMarkFaceMessage = ((MarkFaceMessage)aczw.c(this.msgData));
      if ((EmojiStickerManager.bYE) && (this.mMarkFaceMessage != null) && (this.mMarkFaceMessage.stickerInfo != null))
      {
  ...
  public void prewrite()
  {
    ...
    try
    {
      this.msgData = aczw.b(this.mMarkFaceMessage);
      return;
    }
    catch (Exception localException)
    {
