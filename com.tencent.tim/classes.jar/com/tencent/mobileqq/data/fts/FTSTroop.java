  ...
  extends FTSEntity
{
  ...
  {
    return String.format("FTSTroop type=%d, troopuin|memberuin=%s, troopnick|size=%s, nick|size=%s", new Object[] { Integer.valueOf(this.mType), this.mExt1 + "zzz" + this.mExt6, aqft.pk(this.mExt4), aqft.pk(this.mExt2) });
  }
  ...
  public void doSerialize()
  {
    ...
    for (;;)
    {
      ...
      break label38;
      label130:
      this.mExt3 = aqoe.pJ(this.mExt2);
      this.mSegmentCount += aqoe.fp(this.mExt3);
      break label67;
      label160:
      this.mExt5 = aqoe.pJ(this.mExt4);
      this.mSegmentCount += aqoe.fp(this.mExt5);
    }
  }
