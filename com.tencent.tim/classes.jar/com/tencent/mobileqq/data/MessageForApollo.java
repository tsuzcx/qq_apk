  ...
  extends ChatMessage
{
  ...
  protected void doParse()
  {
    try
    {
      this.mApolloMessage = ((ApolloMessage)aczw.c(this.msgData));
      this.hasPlayed = this.mApolloMessage.isPlayed;
      this.msg = ApolloUtil.b(this);
      if (!TextUtils.isEmpty(this.mApolloMessage.extStr))
      {
        ...
        if (this.gameStatus == 0) {
          this.gameStatus = ApolloUtil.z(this.extendJson, "gameStatus");
        }
    ...
    catch (Throwable localThrowable)
    {
      if (this.mApolloMessage == null)
      {
        ...
        this.mApolloMessage.name = ApolloUtil.P();
  ...
  public void prewrite()
  {
    ...
    try
    {
      ...
      this.msgData = aczw.b(this.mApolloMessage);
      return;
    }
