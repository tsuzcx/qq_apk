  ...
  implements aezc
{
  ...
  protected void doParse()
  {
      ...
      for (;;)
      {
        if (((Iterator)localObject5).hasNext())
        {
          ...
          for (;;)
          {
            ...
            m = k;
            bool3 = bool1;
            bool2 = arnn.a().si((String)localObject1);
            if (bool2) {
              break label983;
            }
            bool1 = true;
          ...
          try
          {
            this.mSourceMsgInfo = ((MessageForReplyText.SourceMsgInfo)aczw.c(HexUtil.hexStr2Bytes(str)));
            k = n;
            bool1 = bool2;
          }
    ...
    for (;;)
    {
      ...
      this.sb = new aofk(this.msg, 13, ChatTextSizeSettingActivity.vp(), this.istroop);
      if (m != 0) {
        this.sb2 = new aofk(localStringBuilder2.toString(), 13, ChatTextSizeSettingActivity.vp(), this.istroop);
      }
      return;
      label983:
      label986:
  ...
  public MessageRecord rebuildLongMsg(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (this.msgtype == -1036)
      {
        ...
        for (;;)
        {
            ...
            while (((Iterator)localObject8).hasNext())
            {
              ...
              else if ((localObject9 instanceof MessageForPic))
              {
                if (!((List)localObject6).isEmpty())
                {
                  ...
                  localObject10 = (MessageForText)anbi.d(-1000);
          ...
          else if ((localObject8 instanceof MessageForPic))
          {
            if (!((List)localObject6).isEmpty())
            {
              ...
              localObject9 = (MessageForText)anbi.d(-1000);
        ...
        ??? = (MessageForMixedMsg)anbi.d(-1035);
