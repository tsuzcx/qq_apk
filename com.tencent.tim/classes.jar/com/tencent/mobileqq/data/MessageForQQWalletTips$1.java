  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject1 = (QQAppInterface)this.eJ.get();
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject3 = ((TroopManager)localObject2).b(this.Ub, (String)localObject3);
      if (localObject3 != null) {
        localLinkedList.add(localObject3);
      }
    }
    if (localLinkedList.size() >= this.zj.size())
    {
      this.this$0.updateMsg((QQAppInterface)localObject1);
      return;
    }
    localObject1 = this.zj.iterator();
    label135:
    label229:
    label232:
    for (;;)
    {
      if (((Iterator)localObject1).hasNext())
      {
        ...
        } while ((localObject3 == null) || (!aagd.j(((TroopMemberInfo)localObject3).memberuin, (String)localObject2)));
      }
      for (int i = 0;; i = 1)
      {
        if (i == 0) {
