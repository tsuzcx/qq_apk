  ...
  extends Entity
{
  ...
  @notColumn
  public List<alck> profileBusiEntry;
  ...
  public void addOrUpdateBuisEntry(alck paramalck)
  {
    int k = 0;
    if (paramalck == null) {
      return;
    ...
    for (;;)
    {
      ...
      {
        if (((alck)this.profileBusiEntry.get(i)).drE == m)
        {
          j = 1;
          this.profileBusiEntry.remove(i);
          this.profileBusiEntry.add(paramalck);
        }
      }
      else
      {
  ...
  public List<alck> getBusiEntrys()
  {
    if (this.profileBusiEntry == null)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < localJSONArray.length())
        {
          ...
          alck localalck = new alck();
          localalck.drE = localJSONObject.getInt("nBusiEntryType");
          localalck.bVk = localJSONObject.getString("strLogoUrl");
          localalck.strTitle = localJSONObject.getString("strTitle");
          localalck.strContent = localJSONObject.getString("strContent");
          localalck.strJumpUrl = localJSONObject.getString("strJumpUrl");
          if (localalck.isEmpty()) {
            break label178;
          }
          this.profileBusiEntry.add(localalck);
        }
      }
  ...
  public ajuu getCommonTagInfos()
  {
    if (this.commonLabels == null) {
      return null;
    }
    ajuu localajuu = new ajuu(8);
  ...
  public ajuu getTagInfos(int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      ajuu localajuu = (ajuu)localIterator.next();
      if ((localajuu != null) && (localajuu.tagType == paramInt)) {
        return localajuu;
      }
    }
    return null;
  ...
  public void getTagInfos(ajuu[] paramArrayOfajuu)
  {
    if ((paramArrayOfajuu == null) || (paramArrayOfajuu.length <= 0)) {
      return;
    }
    int j = paramArrayOfajuu.length;
    int i = 0;
    label15:
    ajuu localajuu1;
    if (i < j)
    {
      localajuu1 = paramArrayOfajuu[i];
      if (localajuu1 != null) {
        break label37;
      }
    }
    for (;;)
    {
      ...
      break;
      label37:
      ajuu localajuu2 = getTagInfos(localajuu1.tagType);
      localajuu1.tagInfos.clear();
      if ((localajuu2 != null) && (localajuu2.tagInfos.size() > 0)) {
        localajuu1.tagInfos.addAll(localajuu2.tagInfos);
      }
    }
  }
  ...
  public boolean hasInterestTag()
  {
    ...
    {
      ajuu localajuu = (ajuu)localIterator.next();
      if ((localajuu.tagInfos != null) && (!localajuu.tagInfos.isEmpty())) {
        return true;
      }
    }
    return false;
  ...
  public boolean hasInterestTag(int paramInt, long paramLong)
  {
    ...
    if (localObject != null)
    {
      localObject = ((ajuu)localObject).tagInfos.iterator();
  ...
  {
    return (!aqmr.isEmpty(this.qzonePicUrl_1)) || (!aqmr.isEmpty(this.qzonePicUrl_2)) || (!aqmr.isEmpty(this.qzonePicUrl_3));
  }
        ...
        for (;;)
        {
          for (;;)
          {
            try
            {
              ...
              localObject = ajuu.a((JSONObject)localObject);
              if (localObject == null) {
                break label649;
              }
            ...
            break;
            this.picList = PicInfo.convertFrom(this.picInfo);
            break label34;
            try
            {
              ...
              if (localJSONObject.has("videoUrl")) {
                this.videoInfo.videoUrl = localJSONObject.getString("videoUrl");
              }
              if (!localJSONObject.has("bigPicUrl")) {
                break label49;
              }
              this.videoInfo.bSZ = localJSONObject.getString("bigPicUrl");
            }
          ...
          try
          {
            ...
            while (i < localJSONArray2.length())
            {
              ...
              HiWanItem localHiWanItem = new HiWanItem();
  ...
  public void removeBuisEntry(alck paramalck)
  {
    if (paramalck == null) {}
    for (;;)
    {
      ...
      {
        if (((alck)this.profileBusiEntry.get(i)).drE == j)
        {
          this.profileBusiEntry.remove(i);
          return;
        }
  ...
  public void saveBusiEntrys(List<alck> paramList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (j < i)
        {
          alck localalck = (alck)paramList.get(j);
          if ((localalck != null) && (!localalck.isEmpty())) {
            localJSONStringer.object().key("nBusiEntryType").value(localalck.drE).key("strLogoUrl").value(localalck.bVk).key("strTitle").value(localalck.strTitle).key("strContent").value(localalck.strContent).key("strJumpUrl").value(localalck.strJumpUrl).endObject();
          }
          j += 1;
          continue;
          i = paramList.size();
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramTVideoHeadInfo)
      {
        ...
        try
        {
          ...
          {
            this.videoInfo = new PicInfo();
            this.videoInfo.videoId = ((GetPhotoList.HeadInfo)paramArrayOfByte.get()).str_video_id.get();
            this.videoInfo.videoUrl = paramArrayOfByte.str_video_url.get();
            this.videoInfo.bSZ = paramArrayOfByte.str_headurl.get();
            paramArrayOfByte = this.videoInfo.ad();
            if (paramArrayOfByte != null) {
              this.videoDetails = paramArrayOfByte.toString();
            }
            if (QLog.isColorLevel()) {
              QLog.d("Q.nearby_people_card.", 2, "updateDisplayPicInfos, videoUrl:" + this.videoInfo.videoUrl + ", bigPicUrl:" + this.videoInfo.bSZ);
            }
            ...
            localPicInfo.photoId = localHeadInfo.uint32_headid.get();
            localPicInfo.bSZ = localHeadInfo.str_headurl.get();
            localPicInfo.thumbUrl = (localPicInfo.bSZ + "250");
            if ((i == 0) || (paramBoolean))
            {
            ...
            paramArrayOfByte = localPicInfo.ad();
            if (paramArrayOfByte != null) {
      ...
      try
      {
        ...
        if (((UpdatePhotoList.RspBody)localObject).rpt_msg_headinfo.has())
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            localPicInfo.photoId = j;
            if (!localHeadInfo.str_headurl.has()) {
              break label625;
            }
            paramArrayOfByte = localHeadInfo.str_headurl.get();
            localPicInfo.bSZ = paramArrayOfByte;
            if (TextUtils.isEmpty(localPicInfo.bSZ)) {}
            for (paramArrayOfByte = "";; paramArrayOfByte = localPicInfo.bSZ + "250")
            {
              localPicInfo.thumbUrl = paramArrayOfByte;
              if ((!localHeadInfo.str_video_url.has()) || (!localHeadInfo.str_video_id.has())) {
                break;
              }
              localPicInfo.videoUrl = localHeadInfo.str_video_url.get();
              localPicInfo.videoLocalPath = advm.jZ(localPicInfo.videoUrl);
              localPicInfo.videoId = localHeadInfo.str_video_id.get();
              if ((paramPicInfo == null) || (paramPicInfo.photoId != localPicInfo.photoId) || (TextUtils.isEmpty(localPicInfo.videoUrl))) {
                break label631;
              }
              boolean bool = localPicInfo.videoLocalPath.equals(paramPicInfo.videoLocalPath);
              if (bool) {
                break label631;
              }
              try
              {
                aqhq.copyFile(paramPicInfo.videoLocalPath, localPicInfo.videoLocalPath);
                i = 1;
                this.picList.add(localPicInfo);
                paramArrayOfByte = localPicInfo.ad();
                if (paramArrayOfByte != null) {
        ...
        if ((this.interestTags != null) && (this.interestTags.size() > 0))
        {
          ...
          for (;;)
          {
            for (;;)
            {
              ...
              paramList.append(((ajuu)((Iterator)localObject1).next()).toString()).append(",");
              continue;
              if (this.interestTags == null) {
              ...
              for (;;)
              {
                ...
                {
                  localObject1 = ajuu.a((appoint_define.InterestTag)paramList.next());
              ...
              try
              {
                ...
                {
                  Object localObject2 = (ajuu)((Iterator)localObject1).next();
                  if ((localObject2 != null) && (((ajuu)localObject2).tagInfos.size() != 0))
                  {
                    localObject2 = ((ajuu)localObject2).ac();
