  ...
  implements Serializable, Cloneable
{
    ...
    throws JSONException
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (QLog.isDevelopLevel()) {
        ajrk.f("PttShow", "createHotChat_JSONObject", new Object[] { localHotChatInfo });
      }
  ...
  public static HotChatInfo createHotChat(Common.WifiPOIInfo paramWifiPOIInfo, boolean paramBoolean, int paramInt)
  {
    ...
    localHotChatInfo.troopUin = String.valueOf(aqft.K(paramWifiPOIInfo.uint32_group_code.get()));
    localHotChatInfo.troopCode = String.valueOf(aqft.K(paramWifiPOIInfo.uint32_group_uin.get()));
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      if (QLog.isDevelopLevel()) {
        ajrk.f("PttShow", "createHotChat_WifiPOIInfo", new Object[] { localHotChatInfo });
      }
      return localHotChatInfo;
      paramBoolean = false;
      break;
  ...
  public static RecentUser createRecentUser(HotChatInfo paramHotChatInfo, boolean paramBoolean)
  {
    ...
    for (localRecentUser.uin = acbn.bkU;; localRecentUser.uin = paramHotChatInfo.troopUin)
    {
  ...
  public static Common.WifiPOIInfo createWifiPOIInfo(HotChatInfo paramHotChatInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localWifiPOIInfo.uint32_group_code.set(aqft.ag(Long.parseLong(paramHotChatInfo.troopUin)));
        localWifiPOIInfo.uint32_group_uin.set(aqft.ag(Long.parseLong(paramHotChatInfo.troopCode)));
        ...
        localWifiPOIInfo.uint64_owner_uin.set(accc.Z(paramHotChatInfo.ownerUin));
      ...
      catch (Exception localException)
      {
        ...
        ajrk.f("PttShow", "createWifiPOIInfo", new Object[] { localException.toString() });
        continue;
      }
      if (QLog.isDevelopLevel()) {
        ajrk.f("PttShow", "createWifiPOIInfo", new Object[] { paramHotChatInfo });
      }
  ...
  {
    if (QLog.isColorLevel()) {
      ajrk.m("Q.hotchat", new Object[] { "onExit", Integer.valueOf(paramInt) });
    }
    this.state = paramInt;
  ...
  public void updateHotChatInfo(HotChatInfo paramHotChatInfo)
  {
    ...
    ajrk.m("PttShow", new Object[] { "updateHotChatInfo", paramHotChatInfo });
  }
  
  public static class ExitedHotChatInfo
