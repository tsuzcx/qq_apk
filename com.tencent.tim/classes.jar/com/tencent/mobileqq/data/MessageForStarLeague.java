  ...
  extends ChatMessage
{
  ...
  public static MessageForStarLeague decodeMsgFromXmlBuff(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong, byte[] paramArrayOfByte, int paramInt2)
  {
    ...
    {
      return null;
      paramQQAppInterface = ansi.d(paramArrayOfByte, paramInt2);
      try
      {
        paramQQAppInterface = anre.nI(new String(paramQQAppInterface, "utf-8"));
  ...
  {
    // Byte code:
    //   0: new 159	java/io/ObjectInputStream
    //   3: dup
    //   4: new 64	java/io/ByteArrayInputStream
    //   7: dup
    //   8: aload_0
    //   9: getfield 163	com/tencent/mobileqq/data/MessageForStarLeague:msgData	[B
    //   12: invokespecial 71	java/io/ByteArrayInputStream:<init>	([B)V
    //   15: invokespecial 166	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   18: astore_2
    //   19: aload_2
    //   20: astore_1
    //   21: aload_0
    //   22: aload_2
    //   23: invokespecial 168	com/tencent/mobileqq/data/MessageForStarLeague:readExternal	(Ljava/io/ObjectInput;)V
    //   26: aload_2
    //   27: astore_1
    //   28: aload_0
    //   29: aload_0
    //   30: invokevirtual 171	com/tencent/mobileqq/data/MessageForStarLeague:getSummaryMsg	()Ljava/lang/String;
    //   33: putfield 174	com/tencent/mobileqq/data/MessageForStarLeague:msg	Ljava/lang/String;
    //   36: aload_2
    //   37: ifnull +7 -> 44
    //   40: aload_2
    //   41: invokevirtual 175	java/io/ObjectInputStream:close	()V
    //   44: return
    //   45: astore_1
    //   46: aload_1
    ...
    //   54: aload_2
    //   55: astore_1
    //   56: invokestatic 36	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   59: ifeq +14 -> 73
    //   62: aload_2
    //   63: astore_1
    //   64: ldc 178
    ...
    //   67: ldc 180
    //   69: aload_3
    //   70: invokestatic 182	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   73: aload_2
    //   74: ifnull -30 -> 44
    //   77: aload_2
    //   78: invokevirtual 175	java/io/ObjectInputStream:close	()V
    //   81: return
    //   82: astore_1
    //   83: aload_1
    ...
    //   92: ifnull +7 -> 99
    //   95: aload_1
    //   96: invokevirtual 175	java/io/ObjectInputStream:close	()V
    //   99: aload_2
    //   100: athrow
    //   101: astore_1
    //   102: aload_1
    ...
    //   51	19	3	localIOException1	IOException
    //   113	1	3	localIOException2	IOException
    // Exception table:
    //   from	to	target	type
  ...
  public void prewrite()
  {
    ...
    //   3: dup
    //   4: invokespecial 197	java/io/ByteArrayOutputStream:<init>	()V
    //   7: astore 4
    //   9: new 199	java/io/ObjectOutputStream
    //   12: dup
    //   13: aload 4
    //   15: invokespecial 202	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   18: astore_2
    //   19: aload_2
    //   20: astore_1
    //   21: aload_0
    //   22: aload_2
    //   23: invokespecial 204	com/tencent/mobileqq/data/MessageForStarLeague:writeExternal	(Ljava/io/ObjectOutput;)V
    //   26: aload_2
    //   27: astore_1
    //   28: aload_2
    //   29: invokevirtual 205	java/io/ObjectOutputStream:close	()V
    //   32: aload_2
    //   33: astore_1
    //   34: aload_0
    //   35: aload 4
    //   37: invokevirtual 208	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   40: putfield 163	com/tencent/mobileqq/data/MessageForStarLeague:msgData	[B
    //   43: aload_2
    //   44: ifnull +7 -> 51
    //   47: aload_2
    //   48: invokevirtual 205	java/io/ObjectOutputStream:close	()V
    //   51: aload 4
    //   53: ifnull +8 -> 61
    //   56: aload 4
    //   58: invokevirtual 209	java/io/ByteArrayOutputStream:close	()V
    //   61: return
    //   62: astore_1
    //   63: invokestatic 36	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   66: ifeq -15 -> 51
    //   69: ldc 178
    //   71: iconst_2
    //   72: ldc 211
    //   74: aload_1
    //   75: invokestatic 182	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   78: goto -27 -> 51
    //   81: astore_1
    //   82: invokestatic 36	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   85: ifeq -24 -> 61
    //   88: ldc 178
    //   90: iconst_2
    //   91: ldc 211
    //   93: aload_1
    //   94: invokestatic 182	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   97: return
    //   98: astore_3
    //   99: aconst_null
    //   100: astore_2
    //   101: aload_2
    //   102: astore_1
    //   103: invokestatic 36	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   106: ifeq +14 -> 120
    //   109: aload_2
    //   110: astore_1
    //   111: ldc 178
    ...
    //   114: ldc 211
    //   116: aload_3
    //   117: invokestatic 182	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   120: aload_2
    //   121: ifnull +7 -> 128
    //   124: aload_2
    //   125: invokevirtual 205	java/io/ObjectOutputStream:close	()V
    //   128: aload 4
    //   130: ifnull -69 -> 61
    //   133: aload 4
    //   135: invokevirtual 209	java/io/ByteArrayOutputStream:close	()V
    //   138: return
    //   139: astore_1
    //   140: invokestatic 36	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   143: ifeq -82 -> 61
    //   146: ldc 178
    //   148: iconst_2
    //   149: ldc 211
    //   151: aload_1
    //   152: invokestatic 182	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   155: return
    //   156: astore_1
    //   157: invokestatic 36	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   160: ifeq -32 -> 128
    //   163: ldc 178
    //   165: iconst_2
    //   166: ldc 211
    //   168: aload_1
    //   169: invokestatic 182	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   172: goto -44 -> 128
    //   175: astore_2
    //   176: aconst_null
    //   177: astore_1
    ...
    //   179: ifnull +7 -> 186
    //   182: aload_1
    //   183: invokevirtual 205	java/io/ObjectOutputStream:close	()V
    //   186: aload 4
    //   188: ifnull +8 -> 196
    //   191: aload 4
    //   193: invokevirtual 209	java/io/ByteArrayOutputStream:close	()V
    //   196: aload_2
    //   197: athrow
    //   198: astore_1
    //   199: invokestatic 36	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   202: ifeq -16 -> 186
    //   205: ldc 178
    //   207: iconst_2
    //   208: ldc 211
    //   210: aload_1
    //   211: invokestatic 182	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   214: goto -28 -> 186
    //   217: astore_1
    //   218: invokestatic 36	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   221: ifeq -25 -> 196
    //   224: ldc 178
    //   226: iconst_2
    //   227: ldc 211
    //   229: aload_1
    //   230: invokestatic 182	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   233: goto -37 -> 196
    //   236: astore_2
    //   237: goto -59 -> 178
    //   240: astore_3
    ...
    //   98	19	3	localIOException1	IOException
  ...
  {
    MessageForStarLeague a = (MessageForStarLeague)anbi.d(-2069);
    public String bCw = "";
      ...
      throws SAXException
    {
      ...
      MessageForStarLeague localMessageForStarLeague = this.a;
