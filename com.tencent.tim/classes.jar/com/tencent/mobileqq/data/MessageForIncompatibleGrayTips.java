  ...
  extends ChatMessage
{
  ...
  public void doParse()
  {
    try
    {
      IncompatibleGrayTipsMessage localIncompatibleGrayTipsMessage = (IncompatibleGrayTipsMessage)aczw.c(this.msgData);
  ...
  {
    serial();
    anot.a(null, "CliOper", "", String.valueOf(this.frienduin), "0X800491A", "0X800491A", 0, 0, "", "", "", "");
  }
  ...
  public void serial()
  {
    ...
    try
    {
      this.msgData = aczw.b(localIncompatibleGrayTipsMessage);
      return;
    }
    catch (Exception localException)
    {
