  ...
  extends Entity
{
  ...
  @notColumn
  public List<jzs> customConfigAttrs;
  public String displayNumber = "";
  public int followType;
  @notColumn
  public List<jzs> fullscreenConfigAttrs;
  public int groupId;
  ...
  void initLbsItem_v5_9()
  {
    ...
    {
      Object localObject = (jzs)localIterator.next();
      if ((((jzs)localObject).type != 1) && (((jzs)localObject).fR != null))
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject).hasNext())
          {
            ...
            default: 
              if (QLog.isColorLevel()) {
                QLog.e("EqqDetail", 2, "Error Eqq lbs state value: " + locala.state);
              }
              i = 1;
              label191:
              j = i;
  ...
  public void parser()
  {
    ...
    try
    {
      ...
      this.paConfigAttrs = jzs.e(localJSONObject.optJSONArray("config_arr"));
      this.customConfigAttrs = jzs.e(localJSONObject.optJSONArray("custom_arr"));
      this.fullscreenConfigAttrs = jzs.e(localJSONObject.optJSONArray("fullscreen_arr"));
