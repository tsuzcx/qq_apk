  ...
  implements Parcelable
{
  ...
  public static final Parcelable.Creator<MessageForShortVideo> CREATOR = new afaa();
  ...
  public void doParse()
  {
    ...
    {
      if (!"1".equals(getExtInfoFromExtStr(anbb.ccW))) {
        break label728;
      }
      this.syncToStory = true;
      this.sendRawVideo = "1".equals(getExtInfoFromExtStr(anbb.cdl));
      return;
    }
  }
  ...
  public anfu getDownloadInfo(int paramInt)
  {
    anfu localanfu = new anfu();
    localanfu.dFl = paramInt;
    localanfu.uniseq = this.uniseq;
    localanfu.uinType = this.istroop;
    localanfu.selfUin = this.selfuin;
    localanfu.peerUin = this.frienduin;
    localanfu.bUG = this.senderuin;
    localanfu.uuid = this.uuid;
    localanfu.md5 = this.md5;
    localanfu.time = this.videoFileTime;
    localanfu.format = this.videoFileFormat;
    localanfu.time = this.videoFileTime;
    localanfu.thumbMD5 = this.thumbMD5;
    return localanfu;
  }
  ...
  public String toLogString()
  {
    ...
    localStringBuilder.append("\n |-").append("fileType:").append(ShortVideoUtils.fe(this.fileType));
    localStringBuilder.append("\n |-").append("videoFileStatus:").append(ShortVideoUtils.ff(this.videoFileStatus));
