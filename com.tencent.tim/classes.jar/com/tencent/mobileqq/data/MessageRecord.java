  ...
  extends Entity
{
  ...
  public static final int MSG_TYPE_TODO = -8002;
  ...
  public static String getOldTableName(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      return "mr_" + str + "_" + top.gY(paramString);
      str = "troop";
      continue;
      str = "discusssion";
      continue;
  ...
  public static String getTableName(String paramString, int paramInt)
  {
    ...
    {
      return "mr_" + str + "_" + top.gY(paramString) + "_New";
      str = "temp_game_msg";
      continue;
      str = "troop_hctopic";
      continue;
  ...
  public String getLongMsgInfoString()
  {
    ...
    for (int i = 69;; i = 0)
    {
      ...
      localStringBuilder.append("MessageRecord LongMsgInfo=friendUin:").append(this.frienduin).append(",istroop:").append(this.istroop).append(",msgType:").append(this.msgtype).append(",msg:").append(aqft.pk(this.msg)).append(",time:").append(this.time);
      if (isLongMsg()) {
        localStringBuilder.append(",longMsgId:").append(this.longMsgId).append(",longMsgCount:").append(this.longMsgCount).append(",longMsgIndex:").append(this.longMsgIndex);
      }
      return localStringBuilder.toString();
  ...
  {
    if ((jof.a(this)) && (jof.b(this))) {}
    while ((aehj.ai(this)) && (aehj.aj(this))) {
      return true;
    }
    return aqiu.ms(this.issend);
  }
  ...
  {
    return aqiu.mt(this.issend);
  }
  
  public boolean isSendFromOtherTerminal()
  {
    return aqiu.mu(this.issend);
  }
  ...
  public void prewrite()
  {
    ...
    try
    {
      if ((this.versionCode > 0) && (this.msg != null)) {
