  ...
  extends ChatMessage
{
        ...
        if ((localObject3 instanceof MessageForPic))
        {
          ...
          do
          {
            do
            {
              ...
              ??? = (anqu)???.mStructMsgItemLists.get(0);
            } while ((??? == null) || (!(??? instanceof anqv)));
            ??? = ((anqv)???).rz.iterator();
            i = 0;
            do
            {
          ...
          label586:
          localObject2 = trim(((StructMsgItemTitle)localObject2).text.replaceFirst(":  ", ":"));
  ...
  public static CharSequence getTextFromMixedMsgForMail(ChatMessage arg0, List<String> paramList1, List<String> paramList2)
  {
    ...
    if ((??? instanceof MessageForMixedMsg))
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          if ((??? instanceof MessageForPic))
          {
            ??? = ajgw.a((MessageForPic)???, paramList1, paramList2);
            if (??? != null) {
              localStringBuilder.append(???);
            }
          }
    ...
    for (;;)
    {
      if (j < m)
      {
        ...
        localObject3 = ajgw.a((MessageForPic)localObject3, paramList1, paramList2);
        ...
        {
          localObject2 = ajgw.a((MessageForPic)localObject2, paramList1, paramList2);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            ((MessageForReplyText)localObject3).mSourceMsgInfo = ((MessageForReplyText.SourceMsgInfo)aczw.c(HexUtil.hexStr2Bytes(((MixedMsg.Elem)localObject6).sourceMsgInfo.get())));
            if (((MixedMsg.Elem)localObject6).textMsg.has())
            {
              ((MessageForReplyText)localObject3).msg = ((MixedMsg.Elem)localObject6).textMsg.get();
              ((MessageForReplyText)localObject3).sb = new aofk(((MessageForReplyText)localObject3).msg, 13, ChatTextSizeSettingActivity.vp(), this);
      ...
      catch (JSONException localJSONException1)
      {
        for (;;)
        {
          ...
          if (((MixedMsg.Elem)localObject6).textMsg.has())
          {
            ...
            if (localObject2 != null)
            {
              ...
              localObject6 = ((JSONObject)localObject2).optJSONArray("" + k);
              if ((localObject6 != null) && (!TextUtils.isEmpty(((JSONArray)localObject6).toString()))) {
                appb.a(3000, ((JSONArray)localObject6).toString(), (ChatMessage)localObject4);
              }
            }
            ((MessageForText)localObject4).doParse(true);
            aptw.aI((MessageRecord)localObject4);
            ...
            for (;;)
            {
              ...
              appb.a(1, ((JSONArray)localObject6).toString(), (ChatMessage)localObject4);
              break label941;
        ...
        catch (Exception localException1)
        {
          ...
          arnn.a(this, this.msgElemList, bool1, HexUtil.hexStr2Bytes(localException1));
          try
          {
  ...
  public String getContentForSearch()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("MessageForMixedMsg", 2, "MessageForMixedMsg.getContentForSearch msg is " + aqft.pk(localThrowable.toString()));
    }
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localMessageRecord instanceof MessageForReplyText))
      {
        if (((MessageForReplyText)localMessageRecord).getSourceMessage() == null) {
          xmb.a(paramQQAppInterface, this.frienduin, this.istroop, localMessageRecord, ((MessageForReplyText)localMessageRecord).mSourceMsgInfo);
        }
        ...
        else
        {
          if ((localObject2 instanceof MessageForReplyText))
          {
            ...
            try
            {
              ...
              localObject1 = aczw.b(((MessageForReplyText)localObject1).mSourceMsgInfo);
  ...
  public MessageRecord rebuildMixedMsg()
  {
    ...
    for (;;)
    {
      ...
      if ((localMessageRecord instanceof MessageForPic))
      {
        if (!localArrayList2.isEmpty())
        {
          ...
          localObject2 = (MessageForText)anbi.d(-1000);
    ...
    Object localObject2 = (MessageForMixedMsg)anbi.d(-1035);
      ...
      if (localIterator.hasNext())
      {
        ...
        if ((localObject3 instanceof MessageForReplyText))
        {
          ...
          try
          {
            ...
            localObject1 = aczw.b(((MessageForReplyText)localObject3).mSourceMsgInfo);
            localElem.sourceMsgInfo.set(HexUtil.bytes2HexStr((byte[])localObject1));
          }
          catch (Exception localException)
          {
