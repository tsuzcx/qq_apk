  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      sendBroadcast(paramBundle, "com.tencent.tim.msg.permission.pushnotify");
    }
    catch (Exception paramBundle)
    {
      try
      {
        awal.a().s(this, getIntent());
      }
      catch (Throwable paramBundle)
      {
        try
        {
          WxShareHelperFromReadInjoy.a().s(this, getIntent());
        }
        catch (Throwable paramBundle)
        {
          try
          {
            for (;;)
            {
              WXMiniProgramHelper.a().s(this, getIntent());
              finish();
              return;
