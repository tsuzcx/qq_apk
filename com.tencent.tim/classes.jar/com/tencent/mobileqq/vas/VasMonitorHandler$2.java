...
public class VasMonitorHandler$2
  implements Runnable
{
  public VasMonitorHandler$2(aqri paramaqri, AppRuntime paramAppRuntime, boolean paramBoolean) {}
  
  public void run()
  {
    boolean bool2 = true;
    int i = 0;
    Object localObject1 = this.val$app;
    boolean bool1;
    Object localObject3;
          ...
          if (i < ((JSONArray)localObject3).length())
          {
            ...
            if (localObject1 != null)
            {
              ...
              if (!TextUtils.isEmpty((CharSequence)localObject1)) {
                this.this$0.as.add(localObject1);
              }
              i += 1;
              continue;
            }
