...
public class GameProxy
{
  ...
  public static void handleMiniAppBack(QQAppInterface paramQQAppInterface)
  {
    try
    {
      ...
      {
        if (!paramQQAppInterface.Yj()) {
          return;
        }
        if ((!paramQQAppInterface.Yh()) && (!paramQQAppInterface.Yi()))
        {
          paramQQAppInterface.bCH = false;
  ...
  public static boolean startGameByMiniApp(Activity paramActivity, String paramString, JSONObject paramJSONObject)
  {
    ...
    if (paramString == null)
    {
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        paramJSONObject = wja.a(new Intent(paramActivity, SplashActivity.class), new int[] { 2 });
