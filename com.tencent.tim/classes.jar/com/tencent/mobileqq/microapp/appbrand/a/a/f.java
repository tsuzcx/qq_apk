  ...
  implements Handler.Callback, WebViewEventListener
{
  ...
  private void d(String paramString1, String paramString2, BaseAppBrandWebview paramBaseAppBrandWebview, int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramBaseAppBrandWebview = new a(paramString1, paramString2, paramBaseAppBrandWebview, paramInt);
    ...
    implements Serializable
  {
    ...
    public a(String paramString1, String paramString2, BaseAppBrandWebview paramBaseAppBrandWebview, int paramInt)
    {
      this.a = paramString1;
      this.b = paramString2;
