  ...
  extends BaseAppBrandWebview
{
  ...
  public PageWebview(Context paramContext, a parama, f paramf, String paramString1, String paramString2, PageWebViewListener paramPageWebViewListener, WebViewEventListener paramWebViewEventListener)
  {
  ...
  private void initEnableDebug()
  {
    if (this.apkgInfo.i())
    {
      ...
      c.a(this.apkgInfo.d, true);
      return;
    }
    c.a(this.apkgInfo.d, false);
  }
  
  private void onWebViewReady(f paramf)
  {
    if (aqmr.isEmpty(this.wxssJsStr))
    {
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    for (;;)
    {
      try
      {
        if (this.apkgInfo.b.c(this.mRouteUrl).a.d)
        {
