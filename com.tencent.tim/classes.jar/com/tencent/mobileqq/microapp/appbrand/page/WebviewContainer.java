  ...
  implements SwipeRefreshLayout.OnRefreshListener, PageWebview.OnWebviewScrollListener
{
  ...
  public void insertHTMLWebView(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    this.innerWebView = h.a().a(this.apkgInfo.d, paramInt1);
  ...
  public void insertImageView(JSONObject paramJSONObject, String paramString1, int paramInt1, int paramInt2, String paramString2, boolean paramBoolean)
  {
    ...
    if ((aqmr.isEmpty(paramString2)) || ((paramString2.startsWith("http")) || (paramString2.startsWith("https")))) {}
    for (;;)
    {
      try
      {
      ...
      if (!aqmr.isEmpty(paramString2)) {
        ((CoverImageView)localObject1).setImageBitmap(c.g(paramString2));
      }
    }
  }
  ...
  public void insertTextView(JSONObject paramJSONObject)
  {
    ...
    if ((localObject3 != null) && (!aqmr.isEmpty(getActualColor(((JSONObject)localObject3).optString("bgColor")))))
    {
    ...
    if (localObject3 != null)
    {
      if (!aqmr.isEmpty(((JSONObject)localObject3).optString("color"))) {
    ...
    for (;;)
    {
      if (!aqmr.isEmpty(((JSONObject)localObject3).optString("content"))) {
  ...
  {
    CoverImageView localCoverImageView = (CoverImageView)this.imageViewSparseArray.get(paramInt);
    if ((localCoverImageView == null) || ((aqmr.isEmpty(paramString)) || ((paramString.startsWith("http")) || (paramString.startsWith("https"))))) {}
    for (;;)
    {
      try
      {
      ...
      if (!aqmr.isEmpty(paramString)) {
        localCoverImageView.setImageBitmap(c.g(paramString));
      }
    }
  }
