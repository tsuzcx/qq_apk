  ...
  implements TabBarView.b
{
  ...
  private void executeDownSubPack(String paramString1, String paramString2)
  {
    ...
    arhz localarhz = new arhz(getContext());
    localarhz.setMessage("正在加载模块...");
    localarhz.setCancelable(false);
    localarhz.show();
    this.appBrandRuntime.c.a(paramString1, new AppBrandPageContainer.1(this, localWeakReference, paramString2, paramString1, localarhz));
  }
