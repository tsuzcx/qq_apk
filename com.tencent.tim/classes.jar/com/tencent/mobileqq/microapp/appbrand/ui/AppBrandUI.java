  ...
  public void doOnResume()
  {
    ...
    catch (Throwable localThrowable1)
    {
      ...
      do
      {
        ...
        a(localObject1);
        if (QLog.isColorLevel()) {
          QLog.d("AppBrandUI", 4, "onResume miniConfig.launchParam.tempState=" + localObject1.launchParam.tempState + "---" + aqgz.getDesity());
        }
      ...
      catch (Throwable localThrowable2)
      {
        ...
        PublicFragmentActivity.b.startForResult(this, (Intent)localObject2, PublicFragmentActivityForMiniApp.class, LoadingFragment.class, 1);
