  ...
  implements Serializable
{
  ...
  public static a a(QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      paramQQAppInterface = (a)aagd.o(str);
    ...
    if (!TextUtils.isEmpty(paramLaunchParam.extraKey))
    {
      ...
      if (paramLaunchParam.scene == 1207)
      {
        ...
        do
        {
          ...
          localApkgConfig = ((a)((Map.Entry)localIterator.next()).getValue()).a;
    ...
    if (paramList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localApkgConfig != null) && (!TextUtils.isEmpty(localApkgConfig.mini_appid))) {
          ...
          {
            paramList = (a)this.d.get(localApkgConfig.mini_appid);
            if ((paramList != null) && (!paramList.a.qq_qr_code.equals(localApkgConfig.qq_qr_code))) {
              a(paramList.a);
            }
            this.d.put(localApkgConfig.mini_appid, new a(localApkgConfig));
          }
          else
          {
            a locala = (a)this.c.get(localApkgConfig.mini_appid);
            paramList = locala;
            if (locala == null)
            {
              paramList = new a();
              this.c.put(localApkgConfig.mini_appid, new a(localApkgConfig));
            }
  ...
  public ApkgConfig b(LaunchParam paramLaunchParam)
  {
    ...
    else
    {
      ...
      {
      default: 
        paramLaunchParam = (a)this.c.get(paramLaunchParam.miniAppId);
        if (paramLaunchParam == null) {
          break;
        }
      }
    ...
    implements Serializable
  {
    ...
    public a(ApkgConfig paramApkgConfig)
    {
