...
public final class g
{
  ...
  {
    this.a = this.f.inflate(R.layout.g, null);
    this.a.setClickable(paramBoolean);
    ImageView localImageView = (ImageView)this.a.findViewById(R.id.bm);
    if (this.g != null)
    {
    ...
    {
      if (this.h != null) {
        ((TextView)this.a.findViewById(R.id.bn)).setText(this.h);
      }
      return;
