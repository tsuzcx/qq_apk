  ...
  extends CameraSurfaceView
{
    ...
    throws java.io.IOException
  {
    ...
    //   3: bipush 100
    //   5: istore_3
    //   6: new 66	java/io/FileOutputStream
    //   9: dup
    //   10: aload_1
    //   11: invokespecial 69	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   14: astore 5
    //   16: new 71	java/io/BufferedOutputStream
    //   19: dup
    //   20: aload 5
    //   22: invokespecial 74	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   25: astore 6
    //   27: ldc 76
    //   29: aload_2
    //   30: invokevirtual 82	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   33: ifeq +68 -> 101
    //   36: bipush 80
    //   38: istore_3
    //   39: aload_0
    //   40: getstatic 88	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   43: bipush 100
    //   45: iload_3
    //   46: invokestatic 94	java/lang/Math:min	(II)I
    //   49: aload 6
    //   51: invokevirtual 100	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   54: pop
    //   55: aload 6
    //   57: invokevirtual 104	java/io/BufferedOutputStream:flush	()V
    //   60: aload_1
    //   61: invokevirtual 109	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   64: aload_1
    //   65: invokevirtual 109	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   68: getstatic 113	com/tencent/mobileqq/microapp/widget/media/MiniAppCamera:h	I
    //   71: getstatic 115	com/tencent/mobileqq/microapp/widget/media/MiniAppCamera:i	I
    //   74: iload_3
    //   75: invokestatic 121	aqhu:compressImageJpg	(Ljava/lang/String;Ljava/lang/String;III)Ljava/lang/String;
    //   78: astore_0
    //   79: aload 6
    //   81: ifnull +8 -> 89
    //   84: aload 6
    //   86: invokevirtual 124	java/io/BufferedOutputStream:close	()V
    //   89: aload 5
    //   91: ifnull +8 -> 99
    //   94: aload 5
    //   96: invokevirtual 125	java/io/FileOutputStream:close	()V
    //   99: aload_0
    //   100: areturn
    //   101: ldc 127
    //   103: aload_2
    //   104: invokevirtual 82	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   107: istore 4
    //   109: iload 4
    //   111: ifeq -72 -> 39
    //   114: bipush 60
    ...
    //   127: ifnull +7 -> 134
    //   130: aload_1
    //   131: invokevirtual 124	java/io/BufferedOutputStream:close	()V
    //   134: aload_2
    //   135: ifnull +7 -> 142
    //   138: aload_2
    //   139: invokevirtual 125	java/io/FileOutputStream:close	()V
    //   142: aload_0
    //   143: athrow
    //   144: astore_1
    //   145: goto -56 -> 89
  ...
  {
    // Byte code:
    //   0: new 136	android/media/MediaMetadataRetriever
    //   3: dup
    //   4: invokespecial 138	android/media/MediaMetadataRetriever:<init>	()V
    //   7: astore 6
    //   9: aload 6
    //   11: aload_0
    //   12: invokevirtual 142	android/media/MediaMetadataRetriever:setDataSource	(Ljava/lang/String;)V
    //   15: aload 6
    //   17: ldc2_w 143
    //   20: iconst_2
    //   21: invokevirtual 148	android/media/MediaMetadataRetriever:getFrameAtTime	(JI)Landroid/graphics/Bitmap;
    //   24: astore_0
    //   25: aload_0
    //   26: ifnull +123 -> 149
    //   29: aload_0
    //   30: invokevirtual 152	android/graphics/Bitmap:getWidth	()I
    //   33: istore_2
    //   34: aload_0
    //   35: invokevirtual 155	android/graphics/Bitmap:getHeight	()I
    //   38: istore_3
    //   39: iload_2
    //   40: iload_3
    //   41: invokestatic 158	java/lang/Math:max	(II)I
    //   44: istore 4
    //   46: iload 4
    //   48: sipush 512
    //   51: if_icmple +98 -> 149
    ...
    //   64: fload_1
    //   65: fmul
    //   66: invokestatic 163	java/lang/Math:round	(F)I
    //   69: iload_3
    //   70: i2f
    //   71: fload_1
    //   72: fmul
    //   73: invokestatic 163	java/lang/Math:round	(F)I
    //   76: iconst_1
    //   77: invokestatic 167	android/graphics/Bitmap:createScaledBitmap	(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    //   80: astore 5
    //   82: aload 5
    //   84: astore_0
    //   85: aload 6
    //   87: invokevirtual 170	android/media/MediaMetadataRetriever:release	()V
    //   90: aload_0
    //   91: areturn
    //   92: astore 5
    //   94: aload 5
    //   96: invokevirtual 173	java/lang/RuntimeException:printStackTrace	()V
    //   99: aload_0
    //   100: areturn
    //   101: astore 5
    //   103: aconst_null
    //   104: astore_0
    //   105: aload 5
    //   107: invokevirtual 174	java/lang/Throwable:printStackTrace	()V
    //   110: aload 6
    //   112: invokevirtual 170	android/media/MediaMetadataRetriever:release	()V
    //   115: aload_0
    //   116: areturn
    //   117: astore 5
    //   119: aload 5
    //   121: invokevirtual 173	java/lang/RuntimeException:printStackTrace	()V
    //   124: aload_0
    //   125: areturn
    //   126: astore_0
    //   127: aload 6
    //   129: invokevirtual 170	android/media/MediaMetadataRetriever:release	()V
    //   132: aload_0
    //   133: athrow
    //   134: astore 5
    //   136: aload 5
    //   138: invokevirtual 173	java/lang/RuntimeException:printStackTrace	()V
    //   141: goto -9 -> 132
    //   144: astore 5
    //   146: goto -41 -> 105
    //   149: goto -64 -> 85
