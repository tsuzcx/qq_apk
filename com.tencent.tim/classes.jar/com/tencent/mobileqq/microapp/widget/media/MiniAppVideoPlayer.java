  ...
  implements View.OnClickListener
{
  ...
  {
    this.z = paramContext;
    this.r = LayoutInflater.from(paramContext).inflate(R.layout.f, null);
    this.t = ((FrameLayout)this.r.findViewById(R.id.ag));
    this.y = ((FrameLayout)this.r.findViewById(R.id.br));
    this.w = ((ImageView)this.r.findViewById(R.id.bq));
    this.x = ((ImageView)this.r.findViewById(R.id.av));
  ...
  private void b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      if ((this.ac <= 0L) || (!aqiw.isWifiConnected(this.z))) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    implements Observer
  {
    ...
    public void update(Observable paramObservable, Object paramObject)
    {
      ...
      do
      {
        ...
        paramObservable = MiniAppVideoPlayer.this.n.appBrandRuntime;
