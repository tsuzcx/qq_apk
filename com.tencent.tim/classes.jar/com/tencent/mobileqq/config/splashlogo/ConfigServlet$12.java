...
public class ConfigServlet$12
  implements Runnable
{
  public ConfigServlet$12(aevk paramaevk, ConfigurationService.Config paramConfig) {}
  
  public void run()
  {
    int n = 0;
    QQAppInterface localQQAppInterface = (QQAppInterface)this.this$0.getAppRuntime();
    zxj localzxj = (zxj)localQQAppInterface.getManager(125);
    HashSet localHashSet = new HashSet();
    int j = aqmj.aq(localQQAppInterface.getApp(), aevk.mCurUin);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          aqmj.T(localQQAppInterface.getApp(), aevk.mCurUin, m);
          localzxj.b(localHashSet);
          i = 1;
        }
