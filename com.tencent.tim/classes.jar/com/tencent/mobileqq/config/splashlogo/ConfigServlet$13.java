...
public class ConfigServlet$13
  implements Runnable
{
  public ConfigServlet$13(aevk paramaevk, ConfigurationService.Config paramConfig, QQAppInterface paramQQAppInterface) {}
  
  public void run()
  {
    boolean bool2 = false;
    ScribbleResMgr localScribbleResMgr = ScribbleResMgr.a();
    int k = this.a.version.get();
    int j = aqmj.bk(this.val$app.getApp());
    if (this.a.msg_content_list != null) {}
    for (int i = this.a.msg_content_list.size();; i = -1)
    {
    ...
    if (i > 0)
    {
      ...
      if (j < i)
      {
        localObject1 = (ConfigurationService.Content)this.a.msg_content_list.get(j);
        ...
        if (((ConfigurationService.Content)localObject1).compress.get() == 1)
        {
          ...
          if (arrayOfByte == null)
          {
            ...
            bool3 = localScribbleResMgr.a((String)localObject1, this.val$app, 2599);
            bool2 = bool1;
            bool1 = bool3;
          }
        }
    ...
    for (;;)
    {
      ...
      if ((m == 2598) || (m == 4448))
      {
        bool3 = localScribbleResMgr.a(str2, this.val$app, 2598);
        bool1 = bool2;
        bool2 = bool3;
        continue;
        if ((bool2) && (bool1)) {
          aqmj.aK(this.val$app.getApp().getBaseContext(), k);
        }
        for (;;)
        {
          localScribbleResMgr.dNV();
          return;
          if (QLog.isColorLevel()) {
