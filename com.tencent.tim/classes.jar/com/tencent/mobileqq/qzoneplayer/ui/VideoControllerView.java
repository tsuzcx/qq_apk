  ...
  extends FrameLayout
{
    ...
    extends Handler
  {
    ...
    MessageHandler(Looper paramLooper, VideoControllerView paramVideoControllerView)
    {
      super();
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      do
      {
        ...
        case 2: 
          ...
          i = localVideoControllerView.setProgress();
        }
      } while ((localVideoControllerView.mDragging) || (localVideoControllerView.getParent() == null) || ((!localVideoControllerView.mShowing) && (localVideoControllerView.getVisibility() != 0)));
      removeMessages(2);
      ...
      return;
      localVideoControllerView.setProgress();
    }
  ...
  public static abstract interface OnControllerEventListener
  {
