  ...
  extends accg
{
    ...
    throws Exception
  {
    ...
    if (i == 0) {
      if ((localRspBody.stInfos.has()) && (localRspBody.stInfos.get().size() > 0))
      {
        ...
        paramIntent = ((acff)this.app.getManager(51)).a(paramOIDBSSOPkg);
        if (paramIntent == null) {
          break label423;
        }
    ...
    for (;;)
    {
      ...
      {
        RichStatus.a locala = new RichStatus.a();
        oidb_0x798.Info localInfo = (oidb_0x798.Info)localList.get(i);
        locala.feedid = str;
        locala.count = localInfo.uint32_count.get();
        locala.type = localInfo.uint32_type.get();
        locala.zanFlag = localInfo.uint32_flag.get();
        paramIntent.sigZanInfo.put(Integer.valueOf(locala.type), locala);
        i += 1;
      }
      long l1 = localRspBody.uint64_sleeptime.get();
      long l2 = System.currentTimeMillis();
      this.app.getPreferences().edit().putLong("sigCommentUpdateTimeStamp_" + paramOIDBSSOPkg, l1 * 1000L + l2).commit();
      if (paramIntent.sigZanInfo.get(Integer.valueOf(255)) == null) {
        break;
      }
      this.pY = 94;
      notifyUI(this.pY, true, paramIntent.sigZanInfo.get(Integer.valueOf(255)));
      return;
  ...
  private boolean a(String[] paramArrayOfString, byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfString = new NewIntent(this.app.getApp(), aclw.class);
    ...
    this.app.startServlet(paramArrayOfString);
    return true;
  }
    ...
    throws Exception
  {
    ...
    ExtensionInfo localExtensionInfo = ((acff)this.app.getManager(51)).a(str2);
    ...
    {
      paramIntent = paramOIDBSSOPkg;
      if (str1.equals(localExtensionInfo.getRichStatus().feedsId))
      {
        paramIntent = paramOIDBSSOPkg;
        if (localExtensionInfo.getRichStatus().sigZanInfo != null)
        {
          paramOIDBSSOPkg = (RichStatus.a)localExtensionInfo.getRichStatus().sigZanInfo.get(Integer.valueOf(255));
          paramIntent = paramOIDBSSOPkg;
          if (localRspBody.uint32_result.get() == 0)
          {
            ...
            paramOIDBSSOPkg.count += 1;
            paramOIDBSSOPkg.zanFlag = 1;
            paramIntent = paramOIDBSSOPkg;
          }
        }
      }
    ...
    if (QLog.isColorLevel()) {
      QLog.i("SignatureHandler", 2, String.format("handleInteractiveSigature[%s %s %d %d]", new Object[] { aqmr.getSimpleUinForPrint(str2), str1, Integer.valueOf(k), Integer.valueOf(j) }));
    }
    int i = this.pY;
    if (localRspBody.uint32_result.get() == 0) {
      bool = true;
    ...
    return;
    label266:
    i = paramOIDBSSOPkg.count - 1;
    paramOIDBSSOPkg.count = i;
    if (i > 0) {}
    for (i = paramOIDBSSOPkg.count;; i = 0)
    {
      paramOIDBSSOPkg.count = i;
      paramOIDBSSOPkg.zanFlag = 0;
      paramIntent = paramOIDBSSOPkg;
      break;
    }
  }
    ...
    throws Exception
  {
    ...
    if (i == 0)
    {
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        if (!bool1) {
          this.app.getPreferences().edit().putLong("sigCommentDetailUin_" + paramOIDBSSOPkg, paramIntent.uint64_uin.get()).putLong("sigCommentDetailTime_" + paramOIDBSSOPkg, paramIntent.uint64_time.get()).commit();
        }
    ...
    throws Exception
  {
    ...
    if (paramOIDBSSOPkg.uint32_result.get() == 0)
    {
      ...
      this.app.getPreferences().edit().putLong("sigNewCommentLastFetchTime", System.currentTimeMillis() + j * 1000);
      if ((i != 0) && (0L != l))
      {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            {
              localObject = localSignatureManager.b(paramIntent.feedsid);
              if (localObject != null)
              {
        ...
        if ((i == 0) && (paramIntent != null)) {
          this.app.getPreferences().edit().putLong("sigNewCommentLastUin_", paramIntent.uin).putLong("sigNewCommentLastFetchTime", paramIntent.time).putString("sigNewCommentLastFeedsId_", paramIntent.feedsid).commit();
        }
    ...
    if (paramOIDBSSOPkg.uint32_result.get() == 0)
    {
      ...
      if (((oidb_0x799.RspBody)localObject1).uint32_result.get() == 0)
      {
        ...
        if (paramOIDBSSOPkg != null) {
          paramOIDBSSOPkg.jh((List)localObject1);
        }
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if (paramOIDBSSOPkg != null)
          {
            localObject4 = paramOIDBSSOPkg.b(((SignatureManager.SigCommentInfo)localObject3).feedsid);
    ...
    throws Exception
  {
    ...
    if (paramOIDBSSOPkg.uint32_result.get() == 0)
    {
      ...
      paramIntent.mergeFrom(paramOIDBSSOPkg.bytes_bodybuffer.get().toByteArray());
      paramOIDBSSOPkg = new RspGetHistorySig();
      if (paramIntent.uint32_is_over.get() != 0) {
        bool = true;
      }
      paramOIDBSSOPkg.over = bool;
      paramOIDBSSOPkg.historySignItems = aO(paramIntent.rpt_info.get());
  ...
  public void FG(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      localObject3 = this.app.getPreferences();
    ...
    localObject2 = new NewIntent(this.app.getApp(), aclw.class);
  ...
  public void G(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    localObject = new NewIntent(this.app.getApp(), aclw.class);
  ...
  public void a(long paramLong1, String paramString1, long paramLong2, long paramLong3, String paramString2)
  {
    ...
    paramString2 = new NewIntent(this.app.getApp(), aclw.class);
  ...
  public List<HistorySignItem> aO(List<oidb_0xde8.NickInfo> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (localHistorySignItem.richStatus != null)
      {
        ...
        if (((oidb_0xde8.NickInfo)localObject).rpt_item.get() != null) {
          localHistorySignItem.commentItemList = c(((oidb_0xde8.NickInfo)localObject).rpt_item.get(), localHistorySignItem.richStatus.feedsId);
        }
        ...
        if (localObject != null)
        {
          ...
          localHistorySignItem.likeItemList = aP(((oidb_0xde8.lightCommentInfo)localObject).rpt_items.get());
        }
  ...
  public List<amhq> aP(List<oidb_0xde8.lightCommentItem> paramList)
  {
    if ((paramList == null) || (paramList.size() <= 0)) {
      return new ArrayList();
    }
    ...
    while (paramList.hasNext())
    {
      ...
      amhq localamhq = new amhq();
      localamhq.timeStamp = locallightCommentItem.uint64_time.get();
      long l = locallightCommentItem.uint64_uin.get();
      localamhq.user = new amhr(String.valueOf(l), bd(l));
      localArrayList.add(localamhq);
    }
    return localArrayList;
  }
  ...
  {
    Friends localFriends = ((acff)this.app.getManager(51)).e(String.valueOf(paramLong));
  ...
  public List<CommentItem> c(List<oidb_0xde8.CommentItem> paramList, String paramString)
  {
    if ((paramList == null) || (paramList.size() <= 0)) {
      return new ArrayList();
    }
    ...
    if (paramList.hasNext())
    {
      ...
      localCommentItem1.user = new amhr(String.valueOf(l), bd(l));
      if (localCommentItem1.targetId != 0L) {
        l = localCommentItem.uint64_target_uin.get();
      }
      for (localCommentItem1.toReplyUser = new amhr(String.valueOf(l), bd(l));; localCommentItem1.toReplyUser = null)
      {
  ...
  public void c(String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {}
    do
    {
      return;
      localObject1 = ((acff)this.app.getManager(51)).a(paramString1);
  ...
  public void cMw()
  {
    long l = this.app.getPreferences().getLong("sigNewCommentLastFetchTime", 0L);
    ...
    ((oidb_0x792.ReqBody)localObject).uint64_uin.set(Long.valueOf(this.app.getAccount()).longValue());
    oidb_sso.OIDBSSOPkg localOIDBSSOPkg = new oidb_sso.OIDBSSOPkg();
  ...
  public void d(String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    if (QLog.isColorLevel()) {
  ...
  public void eT(String paramString1, String paramString2)
  {
    ...
    {
      return;
      l = this.app.getPreferences().getLong("sigCommentUpdateTimeStamp_" + paramString1, 0L);
  ...
  public void h(Intent paramIntent, oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
    throws Exception
  {
    if (paramOIDBSSOPkg.uint32_result.get() == 0)
    {
  ...
  public void i(Intent paramIntent, oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
    throws Exception
  {
    if (paramOIDBSSOPkg.uint32_result.get() == 0)
    {
  ...
  public void l(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    if (QLog.isColorLevel()) {
      QLog.i("SignatureHandler", 2, String.format("InteractiveSignature[%s %s %d %d]", new Object[] { aqmr.getSimpleUinForPrint(paramString1), paramString2, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }));
    }
    ...
    localObject1 = new NewIntent(this.app.getApp(), aclw.class);
  ...
  public static class RspGetHistorySig
    implements Serializable
  {
    public List<HistorySignItem> historySignItems = new ArrayList();
