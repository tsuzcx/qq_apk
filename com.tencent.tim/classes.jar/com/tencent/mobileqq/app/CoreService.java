  ...
  extends Service
{
  ...
  public static Notification fakeNotification(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      ((Notification)localObject).icon = 2130840732;
      ((Notification)localObject).contentView = new RemoteViews(BaseApplicationImpl.sApplication.getPackageName(), 2131559856);
      return localObject;
    }
    ...
    localBuilder.setContentTitle("QQ").setContentText("QQ正在后台运行").setWhen(System.currentTimeMillis()).setSmallIcon(2130840732);
  ...
  public static void startCoreService(boolean paramBoolean)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 94	com/tencent/common/app/BaseApplicationImpl:sApplication	Lcom/tencent/common/app/BaseApplicationImpl;
    //   6: astore_1
    //   7: new 107	android/content/Intent
    //   10: dup
    //   11: aload_1
    //   12: ldc 2
    //   14: invokespecial 112	android/content/Intent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   17: astore_2
    //   18: iload_0
    //   19: putstatic 197	com/tencent/mobileqq/app/CoreService:sDisableForeground	Z
    //   22: aload_1
    //   23: aload_2
    //   24: invokevirtual 203	android/content/Context:startService	(Landroid/content/Intent;)Landroid/content/ComponentName;
    //   27: pop
    //   28: ldc 2
    //   30: monitorexit
    //   31: return
    //   32: astore_1
    //   33: invokestatic 208	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   36: ifeq -8 -> 28
    //   39: ldc 13
    //   41: iconst_2
    //   42: ldc 210
    //   44: aload_1
    //   45: invokestatic 214	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   48: goto -20 -> 28
    //   51: astore_1
    //   52: ldc 2
    //   54: monitorexit
  ...
  public static void stopCoreService()
  {
    ...
    //   6: dup
    //   7: getstatic 94	com/tencent/common/app/BaseApplicationImpl:sApplication	Lcom/tencent/common/app/BaseApplicationImpl;
    //   10: ldc 2
    //   12: invokespecial 112	android/content/Intent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   15: astore_0
    //   16: invokestatic 42	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   19: aload_0
    //   20: invokevirtual 223	com/tencent/qphone/base/util/BaseApplication:stopService	(Landroid/content/Intent;)Z
    //   23: pop
    //   24: ldc 2
    //   26: monitorexit
    //   27: return
    ...
    //   38: ldc 210
    //   40: aload_0
    //   41: invokestatic 214	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   44: goto -20 -> 24
    //   47: astore_0
    //   48: ldc 2
    //   50: monitorexit
