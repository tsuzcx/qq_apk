...
public class QLogReporter$1
  implements Runnable
{
  public QLogReporter$1(acqk paramacqk, SharedPreferences paramSharedPreferences, long paramLong) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        str1 = Environment.getExternalStorageDirectory().getPath() + "/tencent/msflogs/" + "com.tencent.tim".replace(".", "/") + "/";
        ...
        localObject5 = acqk.logFileFormatter.format(((Calendar)localObject1).getTime());
        ((Calendar)localObject1).setTimeInMillis(l - 86400000L);
        localObject1 = acqk.logFileFormatter.format(((Calendar)localObject1).getTime());
        i = 0;
        ...
        else
        {
          ...
          if ((!localObject7.contains((CharSequence)localObject5)) || (!localObject7.contains("com.tencent.tim"))) {
            break label719;
          }
          ...
          localObject3 = (List)((Map)localObject6).get("com.tencent.tim");
          localObject1 = localObject3;
          if (localObject3 == null)
          {
            localObject1 = new LinkedList();
            ((Map)localObject6).put("com.tencent.tim", localObject1);
          }
        ...
        if (!((String)localObject3).contains((CharSequence)localObject1))
        {
          ...
          ((SharedPreferences.Editor)localObject1).putLong("LastLogSizeReportTime", this.cP);
    ...
    for (;;)
    {
      if (j < m)
      {
        ...
        anpc.a(BaseApplicationImpl.getContext()).collectPerformance("", "YesterdayLogSizeCollection", true, 0L, 0L, (HashMap)localObject2, "");
        localObject2 = this.val$sp.edit();
        ((SharedPreferences.Editor)localObject2).putLong("LastLogSizeReportTime", this.cP);
