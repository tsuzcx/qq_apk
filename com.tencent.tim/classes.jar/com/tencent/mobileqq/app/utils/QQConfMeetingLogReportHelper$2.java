...
public class QQConfMeetingLogReportHelper$2
  implements Runnable
{
  public QQConfMeetingLogReportHelper$2(adaa paramadaa, String paramString) {}
  
  public void run()
  {
    long l1 = System.currentTimeMillis();
    Object localObject = ((QQAppInterface)adaa.a(this.this$0).get()).getCurrentAccountUin();
    ...
    if (localObject != null)
    {
      ...
      QLog.syncReportLogSelf(AppSetting.getAppId(), this.val$path, str1, "", str2, (String)localObject);
    }
    long l2 = System.currentTimeMillis();
    QLog.w("QQConfMeetingLogReportHelper", 1, "sendFile, Runnable, path[" + this.val$path + "], Thread[" + Thread.currentThread().getId() + "], cost[" + (l2 - l1) + "]");
  }
}
