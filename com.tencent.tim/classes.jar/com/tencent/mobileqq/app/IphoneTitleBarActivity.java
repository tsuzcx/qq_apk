  ...
  extends FragmentActivity
{
  ...
  protected View.OnClickListener onBackListeger = new acgp(this);
  @Deprecated
  ...
  {
    return findViewById(2131377361);
  }
  ...
  public void setContentView(int paramInt)
  {
    ...
    do
    {
      ...
      Object localObject1 = ((LayoutInflater)localObject2).inflate(2131559121, null);
      try
      {
  ...
  public void setContentView(View paramView)
  {
    ...
    for (;;)
    {
      ...
      init(getIntent());
      return;
      this.titleRoot = ((RelativeLayout)LayoutInflater.from(this).inflate(2131559121, null).findViewById(2131379881));
      if (ImmersiveUtils.isSupporImmersive() == 1)
      {
        this.titleRoot.setFitsSystemWindows(true);
        this.titleRoot.setPadding(0, ImmersiveUtils.getStatusBarHeight(this), 0, 0);
  ...
  {
    BounceScrollView localBounceScrollView = (BounceScrollView)View.inflate(this, 2131558789, null);
  ...
  public void setContentViewNoTitle(int paramInt)
  {
    ...
    try
    {
      this.mTitleContainer = ((View)findViewById(2131367153).getParent());
      this.mTitleContainer.setVisibility(8);
      return;
    }
    catch (Throwable localThrowable) {}
  ...
  public void setLeftViewName(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (AppSetting.enableTalkBack)
      {
        ...
        if (!((String)localObject1).contains(getString(2131691039))) {
          localObject2 = getString(2131691039) + (String)localObject1;
        }
      ...
      try
      {
        ...
        if (i >= 40300)
        {
          ...
          if (i <= 40313)
          {
            ...
            {
              paramIntent = (Intent)localObject;
              if (((String)localObject).contains(acfp.m(2131707479))) {
        ...
        for (;;)
        {
          ...
          paramIntent = (Intent)localObject;
          if (!((String)localObject).contains(getString(2131691039))) {
            paramIntent = getString(2131691039) + (String)localObject;
          }
  ...
  public void setRightButton(int paramInt, View.OnClickListener paramOnClickListener)
  {
    ...
    if (AppSetting.enableTalkBack) {
      this.rightViewText.setContentDescription(this.rightViewText.getText() + acfp.m(2131707480));
    }
  }
  ...
  public void showContentViewTitle(boolean paramBoolean)
  {
    try
    {
      View localView = (View)findViewById(2131377361).getParent();
      if (paramBoolean) {}
      for (int i = 0;; i = 8)
      {
