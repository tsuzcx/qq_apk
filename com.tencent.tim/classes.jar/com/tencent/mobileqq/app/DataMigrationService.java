...
public class DataMigrationService
  extends Service
{
  private Handler mHandler = new acdn(this);
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt1 < i)
        {
          ...
          localObject4 = FileProvider.getUriForFile(this, "com.tencent.tim.fileprovider", (File)localObject3);
          localObject5 = FileProvider.getUriForFile(this, "com.tencent.tim.fileprovider", (File)localObject5);
          localObject6 = FileProvider.getUriForFile(this, "com.tencent.tim.fileprovider", (File)localObject6);
  ...
  private void m(Intent paramIntent, int paramInt)
  {
    ...
    if (("com.tencent.tim".equals(str1)) && (aqiz.s(this, "com.tencent.tim", "775E696D09856872FDD8AB4F3F06B1E0"))) {
      c("com.tencent.tim", str2, str3, i, paramInt);
    }
  ...
  public void c(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      return;
      WtloginHelper localWtloginHelper = new WtloginHelper(this, WtloginPrivacyListenerImpl.getSingleton());
      localWtloginHelper.SetTimeOut(20);
      localWtloginHelper.SetMsfTransportFlag(1);
      localWtloginHelper.SetListener(new acdo(this, paramString1, paramString2, paramString3, paramInt1, paramInt2, localWtloginHelper));
      byte[] arrayOfByte = util.getPkgSigFromApkName(this, "com.tencent.tim");
      i = localWtloginHelper.GetA1WithA1(localAppRuntime.getAccount(), 16L, 16L, "com.tencent.tim".getBytes(), 1L, 16L, 16L, "3.4.4".getBytes(), arrayOfByte, new WUserSigInfo(), new WFastLoginInfo());
      if (QLog.isColorLevel()) {
