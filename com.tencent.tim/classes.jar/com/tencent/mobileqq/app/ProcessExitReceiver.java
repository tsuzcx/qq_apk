  ...
  extends BroadcastReceiver
{
  ...
  protected String getLocalVerify(ArrayList<String> paramArrayList, boolean paramBoolean)
  {
  ...
  protected boolean isContainsProc(ArrayList<String> paramArrayList)
  {
  ...
  protected boolean isLegalBroadcast(String paramString, ArrayList<String> paramArrayList)
  {
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    } while ((!isLegalBroadcast(paramContext.getString("verify"), paramIntent)) || (!isContainsProc(paramIntent)));
    ThreadManager.post(new ProcessExitReceiver.1(this), 8, null, true);
    return;
    this.mAppInterface.getApplication().otherProcessExit(true);
  }
}
