...
public class ThreadExcutor
{
  ...
  void excute(Runnable paramRunnable, int paramInt, IThreadListener paramIThreadListener, boolean paramBoolean)
  {
  ...
  void post(int paramInt, Runnable paramRunnable, IThreadListener paramIThreadListener, boolean paramBoolean)
  {
    if (paramRunnable == null) {
  ...
  void postDownLoadTask(int paramInt, Runnable paramRunnable, IThreadListener paramIThreadListener, boolean paramBoolean)
  {
    if (paramRunnable == null) {
      throw new IllegalArgumentException();
    }
