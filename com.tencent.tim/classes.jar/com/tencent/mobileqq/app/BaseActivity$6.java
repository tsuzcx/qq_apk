  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   0: ldc 29
    //   2: monitorenter
    //   3: invokestatic 33	com/tencent/mobileqq/app/BaseActivity:access$300	()Lacln;
    //   6: ifnonnull +60 -> 66
    //   9: new 35	com/tencent/mobileqq/app/BaseActivity$b
    //   12: dup
    //   13: aconst_null
    //   14: invokespecial 38	com/tencent/mobileqq/app/BaseActivity$b:<init>	(Lcom/tencent/mobileqq/app/BaseActivity$1;)V
    //   17: astore_3
    //   18: aload_0
    ...
    //   39: astore 4
    //   41: invokestatic 62	anpq:a	()Lanpq;
    //   44: invokevirtual 66	anpq:ayH	()Z
    //   47: ifeq +238 -> 285
    //   50: iconst_2
    //   51: istore_1
    //   52: aload_2
    ...
    //   54: aload 4
    //   56: iload_1
    //   57: invokevirtual 70	android/hardware/SensorManager:registerListener	(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;I)Z
    //   60: pop
    //   61: aload_3
    //   62: invokestatic 74	com/tencent/mobileqq/app/BaseActivity:access$302	(Lacln;)Lacln;
    //   65: pop
    //   66: ldc 29
    //   68: monitorexit
    //   69: return
    ...
    //   80: astore 4
    //   82: ldc 83
    //   84: invokestatic 89	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   87: ldc 91
    //   89: invokevirtual 95	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   92: astore 5
    //   94: aload 5
    //   96: iconst_1
    //   97: invokevirtual 101	java/lang/reflect/Field:setAccessible	(Z)V
    //   100: aload 5
    //   102: aload_2
    //   103: invokevirtual 105	java/lang/reflect/Field:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   106: checkcast 107	java/util/HashMap
    //   109: invokevirtual 111	java/util/HashMap:keySet	()Ljava/util/Set;
    ...
    //   151: dup
    //   152: invokespecial 136	java/lang/StringBuilder:<init>	()V
    //   155: ldc 138
    //   157: invokevirtual 135	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   160: aload_2
    //   161: invokevirtual 130	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   164: invokevirtual 142	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   167: astore_2
    //   168: aload_2
    //   169: invokestatic 148	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   172: ifne +17 -> 189
    //   175: aload 4
    //   177: aload_2
    //   178: invokevirtual 135	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   181: pop
    //   182: ldc 150
    //   184: iconst_1
    //   185: aload_2
    //   186: invokestatic 156	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   189: aload_3
    //   190: aload 4
    //   192: invokevirtual 142	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   195: invokestatic 162	annt:e	(Ljava/lang/Throwable;Ljava/lang/String;)V
    //   198: ldc 29
    //   200: monitorexit
    //   201: return
    //   202: astore_2
    ...
    //   226: aload_2
    //   227: invokevirtual 130	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   230: invokevirtual 142	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   233: astore_2
    //   234: goto -66 -> 168
    //   237: astore_2
    //   238: new 76	java/lang/StringBuilder
    //   241: dup
    //   242: invokespecial 136	java/lang/StringBuilder:<init>	()V
    //   245: ldc 166
    //   247: invokevirtual 135	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   250: aload_2
    //   251: invokevirtual 130	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   254: invokevirtual 142	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   257: astore_2
    //   258: goto -90 -> 168
    //   261: astore_2
    //   262: new 76	java/lang/StringBuilder
    //   265: dup
    //   266: invokespecial 136	java/lang/StringBuilder:<init>	()V
    //   269: ldc 168
    //   271: invokevirtual 135	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   274: aload_2
    //   275: invokevirtual 130	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   278: invokevirtual 142	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   281: astore_2
    //   282: goto -114 -> 168
    //   285: iconst_0
    //   286: istore_1
