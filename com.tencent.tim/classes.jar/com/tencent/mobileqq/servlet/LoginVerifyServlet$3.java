...
public final class LoginVerifyServlet$3
  implements Runnable
{
  public LoginVerifyServlet$3(String paramString1, String paramString2, String paramString3, aneg.a parama) {}
  
  public void run()
  {
    try
    {
      Object localObject5 = new URL(this.cdq);
      Object localObject1 = new anej(this, (URL)localObject5);
      ...
      ((HttpsURLConnection)localObject2).setRequestProperty("User-Agent", "android" + "_" + Build.VERSION.SDK + "_" + Build.DEVICE + "_" + Build.VERSION.RELEASE + "_" + "3.4.4" + "_" + "QQ/" + "3.4.43058");
      ((HttpsURLConnection)localObject2).setRequestProperty("Accept", "*/*");
      ((HttpsURLConnection)localObject2).setRequestProperty("Content-Type", this.val$contentType);
      localObject1 = ((HttpsURLConnection)localObject2).getOutputStream();
      ((OutputStream)localObject1).write(this.cdr.getBytes());
