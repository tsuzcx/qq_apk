...
public class EmoticonFromGroupDBManager$3
  implements Runnable
{
  public EmoticonFromGroupDBManager$3(afhj paramafhj, int paramInt, List paramList) {}
  
  public void run()
  {
    if (QLog.isColorLevel()) {
      QLog.i("EmoticonFromGroup_DBManager", 2, "db operation start. opType: " + this.aLU);
    }
    Object localObject3;
    Object localObject1;
    if (this.this$0.mEntityManager != null)
    {
      localObject3 = null;
      localObject1 = null;
    }
    for (;;)
    {
      try
      {
        localEntityTransaction = this.this$0.mEntityManager.getTransaction();
      ...
      catch (Exception localException)
      {
        ...
        localObject1 = localException;
        localObject3 = localException;
        if (this.this$0.mEntityManager.remove(localEmoticonFromGroupEntity)) {
          continue;
        }
        localObject1 = localException;
        localObject3 = localException;
      ...
      localObject1 = localEntityTransaction;
      localObject3 = localEntityTransaction;
      localIterator = this.zH.iterator();
      localObject1 = localEntityTransaction;
      localObject3 = localEntityTransaction;
      if (localIterator.hasNext())
      {
