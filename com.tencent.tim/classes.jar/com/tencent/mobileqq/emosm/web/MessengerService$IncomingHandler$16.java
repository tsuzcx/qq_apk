...
{
  MessengerService$IncomingHandler$16(MessengerService.a parama, Bundle paramBundle, QQAppInterface paramQQAppInterface, MessengerService paramMessengerService) {}
  ...
  public void onDone(List<CustomEmotionData> paramList1, List<CustomEmotionData> paramList2)
  {
    ...
    if (paramList2 != null) {
      for (;;)
      {
        ...
        paramList2 = (afhu)this.val$qqApp.getManager(149);
        localObject = paramList2.ez();
        i2 = afhs.cQV;
        i = 0;
