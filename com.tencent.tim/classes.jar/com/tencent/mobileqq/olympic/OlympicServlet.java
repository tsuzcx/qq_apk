  ...
  extends MSFServlet
{
  ...
  public static void a(AppRuntime paramAppRuntime, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    ...
    {
      akrf.log("OlympicServlet", new Object[] { "reportConfig, runtime is null" });
      return;
    }
  ...
  public static void a(AppRuntime paramAppRuntime, long paramLong, ArrayList<ReportRecord> paramArrayList1, ArrayList<ReportRecord> paramArrayList2, ArrayList<ReportRecord> paramArrayList3, ArrayList<ReportRecord> paramArrayList4, ArrayList<ReportRecord> paramArrayList5)
  {
    if (QLog.isColorLevel()) {
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (int i = localObject2.length;; i = 0)
    {
      ...
      if (i == -1)
      {
        ...
        localObject4 = alab.w((byte[])localObject3);
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        paramIntent = aqnv.I(((Unisso.UniSsoServerReq)localObject1).toByteArray());
        ...
        ((ConfigurationService.Screen)localObject2).width.set((int)aqgz.hI());
        ((ConfigurationService.Screen)localObject2).height.set((int)aqgz.hJ());
        ((ConfigurationService.Screen)localObject2).dpi.set(aqgz.getDispalyDpi());
        ((ConfigurationService.Screen)localObject2).multi_touch.set(aqgz.aCE());
        ...
        paramIntent = aqnv.I(paramIntent.toByteArray());
        ...
        paramIntent = aqnv.I(((ConfigurationService.ReqReportConfig)localObject2).toByteArray());
        break;
        localObject1 = new Unisso.UniSsoServerReq();
      ...
      if ((localObject5 != null) && (((ArrayList)localObject5).size() > 0))
      {
        ...
        {
          localObject6 = (ReportRecord)((Iterator)localObject5).next();
          localReportElem = new PackReport.ReportElem();
          localReportElem.count.set(((ReportRecord)localObject6).count);
          localReportElem.timestamp.set(((ReportRecord)localObject6).time_stamp);
      ...
      if ((localObject4 != null) && (((ArrayList)localObject4).size() > 0))
      {
        ...
        {
          localObject5 = (ReportRecord)((Iterator)localObject4).next();
          localObject6 = new PackReport.ReportElem();
          ((PackReport.ReportElem)localObject6).count.set(((ReportRecord)localObject5).count);
          ((PackReport.ReportElem)localObject6).timestamp.set(((ReportRecord)localObject5).time_stamp);
