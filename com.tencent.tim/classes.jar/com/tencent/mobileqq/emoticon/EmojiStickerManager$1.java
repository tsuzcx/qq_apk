  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((localObject1 instanceof QQAppInterface))
    {
      ...
      localObject1 = ((List)((ArrayList)this.this$0.zO).clone()).iterator();
      Object localObject3;
      ...
      if (this.zP != null) {}
      for (localObject1 = this.zP;; localObject1 = localQQAppInterface.b().b(this.Mu, this.val$type, this.bYI))
      {
      ...
      Object localObject2 = this.this$0.wg.iterator();
      ...
      localObject1 = new File(EmojiStickerManager.uv());
    ...
    {
      EmojiStickerManager.bYG = bool;
      return;
    }
    label352:
    VasQuickUpdateManager.getFileFromLocal(localQQAppInterface, 1004L, "emojiStickerGuideZip_v2", EmojiStickerManager.uv() + "emojiStickerGuideZip_v2.zip", true, null);
    EmojiStickerManager.bYG = false;
  }
}
