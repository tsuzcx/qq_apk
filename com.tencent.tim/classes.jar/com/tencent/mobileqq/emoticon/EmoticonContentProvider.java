  ...
  extends AppContentProvider
{
  ...
  public Bundle call(@NonNull String paramString1, @Nullable String paramString2, @Nullable Bundle paramBundle)
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      if ("vip_type".equals(paramString1)) {
        return afla.a((QQAppInterface)localObject, paramString1);
      }
    }
  ...
  {
    super.onCreate();
    this.d.addURI("qq.emoticon", "emoticon_package", 1000);
    this.d.addURI("qq.emoticon", "emoticon_tab", 1001);
    this.d.addURI("qq.emoticon", "emoticon_fav", 1002);
    this.d.addURI("qq.emoticon", "emoticon", 1003);
    return true;
  }
