...
public class SCFChannel$1$1
  implements Runnable
{
  public SCFChannel$1$1(ahfa paramahfa, String paramString, Boolean paramBoolean, MethodChannel.Result paramResult) {}
  ...
  public void run()
  {
    ...
    localBundle.putBoolean("KEY_SCF_SWITCH_STATUS", this.aw.booleanValue());
