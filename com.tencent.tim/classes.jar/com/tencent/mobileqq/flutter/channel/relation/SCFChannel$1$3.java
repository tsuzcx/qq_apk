...
public class SCFChannel$1$3
  implements Runnable
{
  public SCFChannel$1$3(ahfa paramahfa, String paramString, MethodChannel.Result paramResult) {}
  
  public void run()
  {
    Object localObject = new Bundle();
    ((Bundle)localObject).putString("KEY_UIN", this.val$uin);
    ...
    {
      if (bool) {
        VasWebviewUtil.reportCommercialDrainage(this.a.a.getAccount(), "Care", "RedShow", "", 1, 0, 0, null, null, null);
      }
