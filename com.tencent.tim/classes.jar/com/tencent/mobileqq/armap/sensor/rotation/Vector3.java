  ...
  implements Serializable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      if (advg.floatToIntBits(this.y) != advg.floatToIntBits(paramObject.y)) {
        return false;
      }
    } while (advg.floatToIntBits(this.z) == advg.floatToIntBits(paramObject.z));
    return false;
  }
  
  public int hashCode()
  {
    return ((advg.floatToIntBits(this.x) + 31) * 31 + advg.floatToIntBits(this.y)) * 31 + advg.floatToIntBits(this.z);
  }
  ...
  {
    d.setToRotation(paramVector3, paramFloat);
    return mul(d);
  }
