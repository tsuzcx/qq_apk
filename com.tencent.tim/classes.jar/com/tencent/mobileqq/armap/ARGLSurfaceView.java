...
public class ARGLSurfaceView
  ...
  implements adus.a, GLSurfaceView.Renderer
{
  ...
  private adus.a mSensorListener;
  public adus mSensorManager;
  ...
  public void initSensor(adus.a parama, int paramInt)
  {
    if ((this.mSensorManager == null) && (this.mCurActivity != null))
    {
      this.mSensorManager = new adus(this.mCurActivity, paramInt);
      this.mSensorListener = parama;
    }
  }
  ...
  {
    if (this.mSensorManager != null) {
      return this.mSensorManager.available();
    }
    return false;
  }
  ...
  public void setSurfaceStateListener(SurfaceStateListener paramSurfaceStateListener)
  {
    this.mSurfaceStateListener = paramSurfaceStateListener;
  }
  
  public void setTraceCallback(TraceCallback paramTraceCallback)
  {
  ...
  public static abstract interface SurfaceStateListener
  {
  ...
  public static abstract interface TraceCallback
  {
    public abstract void endTrace();
    
    public abstract void startTrace();
    
    public abstract void trace(long paramLong);
  }
}
