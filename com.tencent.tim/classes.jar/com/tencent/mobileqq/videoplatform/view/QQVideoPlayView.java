  ...
  implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, VideoPlayerInnerCallback, IBaseVideoView
{
  ...
  {
    this.mBufferPanel = ((RelativeLayout)inflate(getContext(), 2131563314, null));
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(13);
    this.mBufferPanel.setVisibility(8);
    addView(this.mBufferPanel, localLayoutParams);
    this.mRateText = ((TextView)this.mBufferPanel.findViewById(2131376618));
  ...
  private void addCenterPlayBtn()
  {
    ...
    this.mCenterPlayBtn.setImageDrawable(getResources().getDrawable(2130851888));
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(13);
  ...
  {
    this.mErrLayout = ((LinearLayout)inflate(getContext(), 2131563315, null));
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -1);
    localLayoutParams.addRule(13);
  ...
  {
    this.mPlayPanel = ((RelativeLayout)inflate(getContext(), 2131563316, null));
    ...
    this.mPlayBar = ((SeekBar)this.mPlayPanel.findViewById(2131377914));
    this.mPlayButton = ((ImageView)this.mPlayPanel.findViewById(2131372728));
    this.mPlayButton.setImageResource(2130851884);
    this.mProgressTime = ((TextView)this.mPlayPanel.findViewById(2131373666));
    this.mTotalTime = ((TextView)this.mPlayPanel.findViewById(2131380108));
    updateTotalTime();
  ...
  {
    String str = getContext().getString(2131721788);
    if (paramInt1 == 1) {
      str = getContext().getString(2131721787);
    }
    if (paramInt3 == 14011001) {
      str = getContext().getString(2131721789);
    }
  ...
  public void play()
  {
    ...
    this.mErrLayout.setVisibility(8);
    this.mCenterPlayBtn.setVisibility(8);
    this.mPlayButton.setImageResource(2130851885);
