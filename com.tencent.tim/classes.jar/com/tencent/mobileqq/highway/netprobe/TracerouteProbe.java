  ...
  extends ProbeItem
{
  ...
  {
    // Byte code:
    //   0: invokestatic 107	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    ...
    //   15: aload_0
    //   16: getfield 40	com/tencent/mobileqq/highway/netprobe/TracerouteProbe:mTimeout	I
    //   19: invokevirtual 119	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   22: ldc 121
    //   24: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   27: iload_2
    //   28: invokevirtual 119	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   31: ldc 81
    //   33: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   36: aload_1
    //   37: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   40: invokevirtual 124	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   43: invokevirtual 128	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   46: astore 4
    //   48: new 130	java/io/BufferedReader
    //   51: dup
    //   52: new 132	java/io/InputStreamReader
    //   55: dup
    //   56: aload 4
    //   58: invokevirtual 138	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   61: invokespecial 141	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   64: invokespecial 144	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   67: astore 5
    //   69: new 59	java/lang/String
    //   72: dup
    //   73: invokespecial 145	java/lang/String:<init>	()V
    //   76: pop
    //   77: ldc 34
    //   79: astore_1
    //   80: aload 5
    //   82: invokevirtual 148	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   85: astore_3
    //   86: aload_3
    //   87: ifnull +27 -> 114
    ...
    //   105: invokevirtual 124	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   108: astore_3
    //   109: aload_3
    //   110: astore_1
    //   111: goto -31 -> 80
    //   114: aload 4
    //   116: invokevirtual 151	java/lang/Process:destroy	()V
    //   119: aload_1
    //   120: invokevirtual 154	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   123: areturn
    //   124: astore_3
    //   125: aload_3
    //   126: invokevirtual 157	java/lang/Exception:printStackTrace	()V
    //   129: goto -10 -> 119
    //   132: astore_3
    //   133: ldc 34
    //   135: astore_1
    //   136: aload_3
    //   137: invokevirtual 157	java/lang/Exception:printStackTrace	()V
    //   140: aload 4
    //   142: invokevirtual 151	java/lang/Process:destroy	()V
    //   145: goto -26 -> 119
    //   148: astore_3
    //   149: aload_3
    //   150: invokevirtual 157	java/lang/Exception:printStackTrace	()V
    //   153: goto -34 -> 119
    //   156: astore_1
    //   157: aload 4
    //   159: invokevirtual 151	java/lang/Process:destroy	()V
    //   162: aload_1
    //   163: athrow
    //   164: astore_3
    //   165: aload_3
