  ...
  implements IProtocolCodecListener, IConnection
{
  ...
  private void handleHttpReqData(HwRequest paramHwRequest, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    //   24: aload_0
    //   25: invokespecial 345	com/tencent/mobileqq/highway/conn/HttpConnection:getBdhConnURL	()Ljava/lang/String;
    //   28: astore 8
    //   30: new 282	java/util/HashMap
    //   33: dup
    //   34: invokespecial 346	java/util/HashMap:<init>	()V
    //   37: astore 12
    //   39: iconst_0
    //   40: istore 4
    //   42: aconst_null
    ...
    //   73: i2l
    //   74: iload_3
    //   75: invokespecial 351	com/tencent/mobileqq/highway/conn/HttpConnection:getConnection	(Ljava/lang/String;Ljava/util/HashMap;JI)Ljava/net/HttpURLConnection;
    //   78: putfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   81: aload_0
    //   82: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   85: invokevirtual 357	java/net/HttpURLConnection:getOutputStream	()Ljava/io/OutputStream;
    //   88: astore 8
    //   90: aload 8
    //   92: astore 7
    //   94: iconst_0
    ...
    //   114: iload 5
    //   116: isub
    //   117: invokestatic 363	java/lang/Math:min	(II)I
    //   120: invokevirtual 369	java/io/OutputStream:write	([BII)V
    //   123: aload 7
    //   125: invokevirtual 372	java/io/OutputStream:flush	()V
    //   128: iload 5
    //   130: sipush 10240
    //   133: iadd
    //   134: istore 5
    ...
    //   154: aload_0
    //   155: invokevirtual 375	com/tencent/mobileqq/highway/conn/HttpConnection:getProtoType	()I
    //   158: invokeinterface 379 3 0
    //   163: ldc 90
    //   165: ldc_w 381
    //   168: invokestatic 98	com/tencent/mobileqq/highway/utils/BdhLogUtil:LogEvent	(Ljava/lang/String;Ljava/lang/String;)V
    //   171: aload_0
    //   172: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   175: invokevirtual 384	java/net/HttpURLConnection:getResponseCode	()I
    //   178: istore 5
    //   180: ldc 90
    ...
    //   222: aload_0
    //   223: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   226: invokevirtual 390	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   229: astore_2
    //   230: new 392	java/io/ByteArrayOutputStream
    //   233: dup
    //   234: invokespecial 393	java/io/ByteArrayOutputStream:<init>	()V
    //   237: astore_1
    //   238: sipush 10240
    //   241: newarray byte
    //   243: astore 8
    ...
    //   257: iload_3
    //   258: isub
    //   259: invokevirtual 399	java/io/InputStream:read	([BII)I
    //   262: istore 6
    //   264: iload 6
    //   266: ifle +46 -> 312
    //   269: iload_3
    ...
    //   297: aload_1
    //   298: aload 8
    //   300: invokevirtual 402	java/io/ByteArrayOutputStream:write	([B)V
    //   303: iconst_0
    //   304: istore_3
    //   305: iload 6
    //   307: istore 4
    ...
    //   319: iconst_0
    //   320: iload_3
    //   321: invokevirtual 403	java/io/ByteArrayOutputStream:write	([BII)V
    //   324: aload_1
    //   325: invokevirtual 404	java/io/ByteArrayOutputStream:flush	()V
    //   328: aload_1
    //   329: invokevirtual 407	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   332: astore 8
    //   334: aload_0
    ...
    //   338: aload 8
    //   340: invokevirtual 411	com/tencent/mobileqq/highway/codec/TcpProtocolDataCodec:decodeS2CData	([B)Z
    //   343: pop
    //   344: ldc 90
    //   346: ldc_w 413
    //   349: invokestatic 98	com/tencent/mobileqq/highway/utils/BdhLogUtil:LogEvent	(Ljava/lang/String;Ljava/lang/String;)V
    //   352: aload_1
    //   353: invokevirtual 415	java/io/ByteArrayOutputStream:close	()V
    //   356: aload_1
    //   357: ifnull +7 -> 364
    //   360: aload_1
    //   361: invokevirtual 415	java/io/ByteArrayOutputStream:close	()V
    //   364: aload_2
    //   365: ifnull +7 -> 372
    //   368: aload_2
    //   369: invokevirtual 416	java/io/InputStream:close	()V
    //   372: aload 7
    //   374: ifnull +8 -> 382
    //   377: aload 7
    //   379: invokevirtual 417	java/io/OutputStream:close	()V
    //   382: aload_0
    //   383: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   386: ifnull -368 -> 18
    //   389: aload_0
    //   390: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   393: invokevirtual 420	java/net/HttpURLConnection:disconnect	()V
    //   396: return
    //   397: astore_1
    //   398: aload_1
    //   399: invokevirtual 423	java/lang/Exception:printStackTrace	()V
    //   402: return
    //   403: iload 5
    //   405: sipush 302
    ...
    //   425: aload_0
    //   426: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   429: ldc_w 425
    //   432: invokevirtual 428	java/net/HttpURLConnection:getHeaderField	(Ljava/lang/String;)Ljava/lang/String;
    //   435: astore 8
    //   437: aload 8
    //   439: ifnull +54 -> 493
    //   442: aload 8
    //   444: invokevirtual 431	java/lang/String:length	()I
    //   447: istore 5
    //   449: iload 5
    //   451: ifle +42 -> 493
    //   454: aload 7
    //   456: ifnull +8 -> 464
    //   459: aload 7
    //   461: invokevirtual 417	java/io/OutputStream:close	()V
    //   464: aload_0
    //   465: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   468: invokevirtual 420	java/net/HttpURLConnection:disconnect	()V
    //   471: aload 12
    //   473: ldc_w 433
    //   476: aload_0
    //   477: invokespecial 345	com/tencent/mobileqq/highway/conn/HttpConnection:getBdhConnURL	()Ljava/lang/String;
    //   480: invokevirtual 437	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   483: pop
    //   484: iload 4
    //   486: iconst_1
    //   487: iadd
    ...
    //   500: aload_0
    //   501: aload_0
    //   502: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   505: invokevirtual 441	java/net/HttpURLConnection:getHeaderFields	()Ljava/util/Map;
    ...
    //   529: aload_0
    //   530: aload_0
    //   531: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   534: invokevirtual 441	java/net/HttpURLConnection:getHeaderFields	()Ljava/util/Map;
    ...
    //   565: aload_0
    //   566: aload_2
    //   567: invokevirtual 445	java/lang/Object:getClass	()Ljava/lang/Class;
    //   570: invokevirtual 450	java/lang/Class:getName	()Ljava/lang/String;
    //   573: putfield 43	com/tencent/mobileqq/highway/conn/HttpConnection:mStrErrInfo	Ljava/lang/String;
    //   576: aload_1
    //   577: ifnull +7 -> 584
    //   580: aload_1
    //   581: invokevirtual 415	java/io/ByteArrayOutputStream:close	()V
    //   584: aload 8
    //   586: ifnull +8 -> 594
    //   589: aload 8
    //   591: invokevirtual 416	java/io/InputStream:close	()V
    //   594: aload 7
    //   596: ifnull +8 -> 604
    //   599: aload 7
    //   601: invokevirtual 417	java/io/OutputStream:close	()V
    //   604: aload_0
    //   605: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   608: ifnull -590 -> 18
    //   611: aload_0
    //   612: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   615: invokevirtual 420	java/net/HttpURLConnection:disconnect	()V
    //   618: return
    //   619: astore_1
    //   620: aload_1
    //   621: invokevirtual 423	java/lang/Exception:printStackTrace	()V
    //   624: return
    //   625: astore_1
    //   626: aconst_null
    //   627: astore_2
    ...
    //   634: ifnull +8 -> 642
    //   637: aload 8
    //   639: invokevirtual 415	java/io/ByteArrayOutputStream:close	()V
    //   642: aload_2
    //   643: ifnull +7 -> 650
    //   646: aload_2
    //   647: invokevirtual 416	java/io/InputStream:close	()V
    //   650: aload 7
    //   652: ifnull +8 -> 660
    //   655: aload 7
    //   657: invokevirtual 417	java/io/OutputStream:close	()V
    //   660: aload_0
    //   661: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   664: ifnull +10 -> 674
    //   667: aload_0
    //   668: getfield 353	com/tencent/mobileqq/highway/conn/HttpConnection:mConnection	Ljava/net/HttpURLConnection;
    //   671: invokevirtual 420	java/net/HttpURLConnection:disconnect	()V
    //   674: aload_1
    //   675: athrow
    //   676: astore_2
    //   677: aload_2
    //   678: invokevirtual 423	java/lang/Exception:printStackTrace	()V
    //   681: goto -7 -> 674
    //   684: astore_1
    //   685: goto -321 -> 364
    //   688: astore_1
