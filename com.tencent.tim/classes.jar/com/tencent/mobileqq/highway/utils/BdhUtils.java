...
public class BdhUtils
{
  ...
  public static String getApnType(Context paramContext)
  {
    ...
    //   9: aconst_null
    //   10: aconst_null
    //   11: invokestatic 174	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   14: astore_1
    //   15: aload_1
    //   16: ifnonnull +16 -> 32
    //   19: aload_1
