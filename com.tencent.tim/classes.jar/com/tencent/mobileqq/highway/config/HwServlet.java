  ...
  extends MSFServlet
{
  ...
  public static void getConfig(AppRuntime paramAppRuntime, String paramString, OnGetConfigListener paramOnGetConfigListener)
  {
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (str.equals("HttpConn.0x6ff_501"))
    {
      ...
      {
        paramIntent = (OnGetConfigListener)mGetConfigListener.get();
        if (paramIntent != null)
        {
  ...
  public static abstract interface OnGetConfigListener
  {
    public abstract void onGetConfig();
  }
}
