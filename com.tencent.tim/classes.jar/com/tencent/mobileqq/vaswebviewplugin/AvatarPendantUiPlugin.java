  ...
  extends VasWebviewUiPlugin
{
  ...
  void OnActivityResume()
  {
    ...
    this.activity.setTitle(acfp.m(2131702996));
  }
  ...
  public String decodeUrl(String paramString)
  {
    ...
    String str = paramString.replace("[client]", "androidQQ").replace("[version]", "3.4.4.3058").replace("[system]", Build.VERSION.RELEASE).replace("[device]", Build.DEVICE);
    ...
    if ((paramLong == 8589934605L) && (paramMap != null))
    {
      ...
      if (paramString != null)
      {
        ...
        if (paramString != null)
        {
          ...
          paramString = affz.a("changeAvatar", sCallbackId, sJsHandler.getIPCResponseKey(), paramMap);
  ...
  public boolean handleEvent(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    if ((paramLong == 32L) && (!TextUtils.isEmpty(paramString)) && (paramString.contains("_bid=160"))) {
      anot.a(null, "CliOper", "", "", "PendantMarket", "StartLoad", 0, 0, "", "", "", "");
    }
  ...
  public boolean onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 1)
    {
      if (paramInt2 == -1)
      {
        ...
        paramIntent = aqhu.getRealPathFromContentURI(this.activity, sUploadPhotoUri);
        paramInt1 = Math.min(482, aqep.v(this.activity));
        localObject = new Intent();
        ((Intent)localObject).putExtra("keyFromPendantPhoto", true);
        ((Intent)localObject).putExtra("Business_Origin", 100);
        PhotoUtils.a((Intent)localObject, this.activity, QQBrowserActivity.class.getName(), paramInt1, paramInt1, 1080, 1080, paramIntent, aqep.BR());
