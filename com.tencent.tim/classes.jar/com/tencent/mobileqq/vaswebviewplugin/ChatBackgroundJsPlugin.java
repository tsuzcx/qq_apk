  ...
  extends VasWebviewJsPlugin
{
  ...
  public static boolean compressBitmapToFile(android.content.Context paramContext, int paramInt1, android.graphics.Bitmap paramBitmap, String paramString, float paramFloat1, float paramFloat2, float paramFloat3, int paramInt2)
  {
    ...
    //   331: astore_2
    //   332: aload_3
    //   333: invokestatic 139	awfn:a	(Ljava/lang/String;)Lawfn$a;
    //   336: astore 14
    //   338: aload 14
    ...
    //   621: iload_1
    //   622: aload 14
    //   624: invokestatic 173	awfx:a	(Landroid/content/Context;ILawfn$a;)D
    //   627: dstore 8
    //   629: dload 8
    //   631: dconst_0
    //   632: dcmpl
    ...
    //   636: aload 14
    //   638: aload 14
    //   640: getfield 178	awfn$a:width	I
    //   643: i2d
    //   644: dload 8
    //   646: ddiv
    //   647: d2i
    //   648: putfield 178	awfn$a:width	I
    //   651: aload 14
    //   653: aload 14
    //   655: getfield 181	awfn$a:height	I
    //   658: i2d
    //   659: dload 8
    //   661: ddiv
    //   662: d2i
    //   663: putfield 181	awfn$a:height	I
    //   666: aload_3
    //   667: aload 14
    //   669: getfield 178	awfn$a:width	I
    //   672: aload 14
    //   674: getfield 181	awfn$a:height	I
    //   677: invokestatic 185	awfn:k	(Ljava/lang/String;II)Ljava/lang/String;
    //   680: iconst_2
    //   681: invokestatic 191	android/util/Base64:decode	(Ljava/lang/String;I)[B
    //   684: astore 14
    ...
    //   697: aload_3
    //   698: aload 14
    //   700: invokevirtual 195	java/io/FileOutputStream:write	([B)V
    //   703: aload_3
    //   704: astore_0
    //   705: aload_3
  ...
  private void custom(String paramString)
  {
    ...
    this.mRuntime.getActivity().getWindow().getDecorView().getWindowVisibleDisplayFrame(localRect);
    ...
    PhotoUtils.a((Intent)localObject, this.mRuntime.getActivity(), QQBrowserActivity.class.getName(), localRect.width() / 5 * 4, localRect.height() / 5 * 4, localRect.width(), localRect.height(), str);
  ...
  {
    return ThemeDiyStyleLogic.getDataDIYDir() + aczs.jH(this.browserApp.getAccount()) + "/" + System.currentTimeMillis() + ".jpg";
  }
  ...
  private void handleCustomPic(String paramString1, int paramInt1, String paramString2, int paramInt2, boolean paramBoolean)
  {
    if ((paramBoolean) && (paramString2 != null) && (this.browserApp != null))
    {
      ...
      QQToast.a(this.mRuntime.getActivity(), 2131697173, 0).show();
      anot.a(null, "CliOper", "", "", "chatbackground", "BjIDShezhi", 0, 0, "1", "", "", "");
    }
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      paramString1 = this.mRuntime.getActivity().getIntent().getStringExtra("chatbg_intent_frinedUin");
      paramJsBridgeListener = paramString1;
      if (paramString1 == null) {
        paramJsBridgeListener = "none";
      }
      j = this.mRuntime.getActivity().getIntent().getIntExtra("uintype", -1);
      i = j;
      if (j == 3000) {
        i = 1;
      }
    ...
    for (;;)
    {
      super.sendRemoteReq(affz.a(paramJsBridgeListener, paramVarArgs, this.mOnRemoteResp.key, this.mReqBundle), false, true);
      return true;
    ...
    if ("setChatBg".equals(paramString3))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramString1 = "null";
          localObject2 = this.mRuntime.getActivity().getIntent();
        ...
        break;
        label803:
        paramString1 = ChatBackgroundManager.c(true, str1);
        continue;
        label813:
        paramJsBridgeListener = "none";
      }
    ...
    if ("openPage".equals(paramString3)) {
      try
      {
        ...
        paramJsBridgeListener.putExtra("selfSet_leftViewText", this.mRuntime.getActivity().getString(2131691039));
        ...
        VasWebviewUtil.openQQBrowserWithoutAD(this.mRuntime.getActivity(), aqqj.o(this.mRuntime.getActivity(), "background", ""), 33554432L, paramJsBridgeListener, false, -1);
    ...
    if ("setDIYConfig".equals(paramString3))
    {
      ...
      i = aqhu.getExifOrientation(str3);
      bool = compressBitmapToFile(this.mRuntime.getActivity(), Integer.parseInt(paramString2), BitmapFactory.decodeFile(str3), str4, Float.parseFloat(str1), Float.parseFloat((String)localObject2), Float.parseFloat((String)localObject1), i);
      if (bool) {
    ...
    for (paramJsBridgeListener = "0";; paramJsBridgeListener = "1")
    {
      try
      {
        ...
        if (!bool) {
          paramString2.put("msg", acfp.m(2131703601));
        }
      }
      catch (JSONException paramJsBridgeListener)
      {
