    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else if ("setFunCallMedia".equals(paramString3))
        {
          ...
          localBundle.putInt("ringId", j);
          localBundle.putInt("feeType", k);
          sendRemoteReq(affz.a("funcall_set", str, this.mOnRemoteResp.key, localBundle), false, false);
        }
      }
      catch (JSONException paramJsBridgeListener)
      {
        ...
        if ("downloadFunCallMedia".equals(paramString3))
        {
          ...
          paramString3 = aqwu.a(null, i, aqwu.getResourceType(), paramJsBridgeListener);
          ...
          if (TextUtils.isEmpty(paramString3))
          {
            ...
            ((JSONObject)localObject1).put("code", aqwu.edp);
            ((JSONObject)localObject1).put("errorMessage", "no mediaUrl , fcPath=null");
            callJs(str, new String[] { ((JSONObject)localObject1).toString() });
            return true;
          }
          paramJsBridgeListener = aqwu.a(null, i, 9, paramString2);
          ...
          if (!aqft.cC())
          {
            ...
            ((JSONObject)localObject1).put("code", aqwu.edr);
          ...
          if (l < 1048576)
          {
            ...
            ((JSONObject)localObject1).put("code", aqwu.edq);
            ((JSONObject)localObject1).put("errorMessage", "SDCard is full");
            callJs(str, new String[] { ((JSONObject)localObject1).toString() });
            return true;
          }
          sendRemoteReq(affz.a("funcall_download", str, this.mOnRemoteResp.key, localBundle), false, false);
      ...
      if ("queryDownloadInfo".equals(paramString3))
      {
        ...
        {
          localObject3 = aqwu.a(null, i, aqwu.getResourceType(), paramJsBridgeListener);
        ...
        {
          paramJsBridgeListener = aqpr.p(j, 3);
      ...
      if ("delFunCallGroup".equals(paramString3))
      {
        ...
        sendRemoteReq(affz.a("funcall_delete", str, this.mOnRemoteResp.key, localBundle), false, false);
      }
      else
      {
