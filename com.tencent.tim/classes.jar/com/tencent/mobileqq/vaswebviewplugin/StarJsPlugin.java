  ...
  extends VasWebviewJsPlugin
{
  ...
  public void createShortcut(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      if (aqlr.hasShortCut(this.browserApp.getApp(), new String[] { str }))
      {
        localJSONObject.put("ret", -2);
        super.callJs(paramString + "(" + localJSONObject.toString() + ");");
        return;
      }
      if (!aqiw.isNetSupport(this.browserApp.getApplication().getApplicationContext()))
      {
    ...
    paramJSONObject = affz.a("createShortcut", paramString, this.mOnRemoteResp.key, this.mReqBundle);
