  ...
  extends VasWebviewJsPlugin
{
  ...
  public static FilenameFilter mHiBoomFontFilter = new aqug();
  ...
  private FontPadding calculateFontPadding(ETFont paramETFont)
  {
    ...
    localObject = new FontPadding();
    if (f > paramETFont.getSize())
    {
      ((FontPadding)localObject).paddingType = 1;
      ((FontPadding)localObject).fontSize = (paramETFont.getSize() * paramETFont.getSize() / f);
      ((FontPadding)localObject).padding = ((paramETFont.getSize() - ((FontPadding)localObject).fontSize) / 2.0F);
      return localObject;
    }
    ((FontPadding)localObject).paddingType = 2;
    ((FontPadding)localObject).fontSize = paramETFont.getSize();
    ((FontPadding)localObject).padding = ((paramETFont.getSize() - f) / 2.0F);
    return localObject;
  }
  ...
  private void checkDiyFontText(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    ETFont localETFont = new ETFont(paramInt1, ku.e(paramInt1, paramInt2), 16.0F);
  ...
  private void getDiyFontInfo(int paramInt1, int paramInt2, String paramString)
  {
    ...
    for (;;)
    {
      ...
      Object localObject1 = new ETFont(paramInt1, ku.e(paramInt1, paramInt2), 16.0F);
  ...
  {
    Object localObject = new File(ahxo.bLY);
  ...
  private void setFontSwitch(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      super.sendRemoteReq(affz.a("setFontSwtich", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
      return;
    }
  ...
  void diyPreview(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3)
  {
    ...
    if (!ETEngine.getInstance().native_isFontLoaded(paramInt1)) {
      ETEngine.getInstance().native_loadFont(ku.e(paramInt1, paramInt2), paramInt1, false);
    }
    ETFont localETFont = new ETFont(paramInt1, ku.e(paramInt1, paramInt2), paramInt3 * 2);
    if (!ETEngine.getInstance().native_diyFontIsDIYFont(localETFont))
    {
      if (QLog.isColorLevel()) {
        QLog.d("ChatFontJsPlugin", 2, "checkDiyFontText fail font is not diy font id = " + paramInt1);
    ...
    localETFont.setSize(((FontPadding)localObject).fontSize);
    ...
    try
    {
      ...
      if (paramInt1 < k)
      {
        ...
        int i = 0;
        if (((FontPadding)localObject).paddingType == 1) {
          paramInt2 = (int)(j + ((FontPadding)localObject).padding);
        }
        for (;;)
        {
          ...
          break;
          paramInt2 = j;
          if (((FontPadding)localObject).paddingType == 2)
          {
            i = (int)(0 + ((FontPadding)localObject).padding);
            paramInt2 = j;
          }
        }
      }
      ...
      paramString2 = aqgo.encodeToString(paramString2.toByteArray(), 2);
  ...
  {
    // Byte code:
    //   0: invokestatic 63	com/etrump/mixlayout/ETEngine:getInstance	()Lcom/etrump/mixlayout/ETEngine;
    //   3: getfield 128	com/etrump/mixlayout/ETEngine:isEngineReady	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   6: invokevirtual 133	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   9: ifne +41 -> 50
    //   12: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   15: ifeq +12 -> 27
    //   18: ldc 19
    //   20: iconst_2
    //   21: ldc_w 371
    //   24: invokestatic 116	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   27: aload_0
    //   28: ldc_w 373
    //   31: invokevirtual 376	com/tencent/mobileqq/vaswebviewplugin/ChatFontJsPlugin:tryInitHYEngine	(Ljava/lang/String;)V
    //   34: aload_0
    //   35: aload_1
    //   36: iconst_1
    //   37: anewarray 118	java/lang/String
    //   40: dup
    //   41: iconst_0
    //   42: ldc_w 469
    //   45: aastore
    //   46: invokespecial 124	com/tencent/mobileqq/vaswebviewplugin/VasWebviewJsPlugin:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   49: return
    //   50: aload 4
    //   52: invokestatic 104	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   55: ifne +8 -> 63
    //   58: iload 6
    //   60: ifgt +98 -> 158
    //   63: aload_0
    //   64: aload_1
    //   65: iconst_1
    //   66: anewarray 118	java/lang/String
    //   69: dup
    //   70: iconst_0
    ...
    //   109: aastore
    //   110: invokespecial 124	com/tencent/mobileqq/vaswebviewplugin/VasWebviewJsPlugin:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   113: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   116: ifeq -67 -> 49
    //   119: ldc 19
    //   121: iconst_2
    ...
    //   154: invokestatic 116	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   157: return
    //   158: iconst_2
    //   159: iload 6
    //   161: i2f
    //   162: aload_0
    //   163: getfield 477	com/tencent/mobileqq/vaswebviewplugin/ChatFontJsPlugin:browserApp	Lcom/tencent/mobileqq/app/BrowserAppInterface;
    //   166: invokevirtual 483	com/tencent/mobileqq/app/BrowserAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   169: invokevirtual 489	com/tencent/qphone/base/util/BaseApplication:getResources	()Landroid/content/res/Resources;
    //   172: invokevirtual 495	android/content/res/Resources:getDisplayMetrics	()Landroid/util/DisplayMetrics;
    //   175: invokestatic 501	android/util/TypedValue:applyDimension	(IFLandroid/util/DisplayMetrics;)F
    //   178: fconst_2
    //   179: fdiv
    //   180: f2i
    //   181: istore 9
    //   183: iload_2
    //   184: iload_3
    //   185: invokestatic 140	ku:d	(II)Z
    //   188: ifne +44 -> 232
    //   191: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   194: ifeq +12 -> 206
    //   197: ldc 19
    //   199: iconst_2
    //   200: ldc_w 382
    //   203: invokestatic 116	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   206: aload_0
    //   207: aload_1
    //   208: iconst_1
    //   209: anewarray 118	java/lang/String
    //   212: dup
    //   213: iconst_0
    //   214: ldc_w 503
    //   217: aastore
    //   218: invokespecial 124	com/tencent/mobileqq/vaswebviewplugin/VasWebviewJsPlugin:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   221: aload_0
    //   222: iload_2
    //   223: iload_3
    //   224: ldc_w 373
    //   227: iconst_0
    //   228: invokevirtual 386	com/tencent/mobileqq/vaswebviewplugin/ChatFontJsPlugin:startDownloadFont	(IILjava/lang/String;I)V
    //   231: return
    //   232: ldc_w 504
    //   235: istore 6
    //   237: aload 7
    //   239: invokestatic 104	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   242: ifne +10 -> 252
    //   245: aload 7
    //   247: invokestatic 509	android/graphics/Color:parseColor	(Ljava/lang/String;)I
    //   250: istore 6
    //   252: invokestatic 63	com/etrump/mixlayout/ETEngine:getInstance	()Lcom/etrump/mixlayout/ETEngine;
    //   255: iload_2
    //   256: invokevirtual 390	com/etrump/mixlayout/ETEngine:native_isFontLoaded	(I)Z
    //   259: ifne +17 -> 276
    //   262: invokestatic 63	com/etrump/mixlayout/ETEngine:getInstance	()Lcom/etrump/mixlayout/ETEngine;
    //   265: iload_2
    //   266: iload_3
    //   267: invokestatic 160	ku:e	(II)Ljava/lang/String;
    //   270: iload_2
    //   271: iconst_0
    //   272: invokevirtual 394	com/etrump/mixlayout/ETEngine:native_loadFont	(Ljava/lang/String;IZ)Z
    //   275: pop
    //   276: new 83	com/etrump/mixlayout/ETFont
    //   279: dup
    //   280: iload_2
    //   281: iload_2
    //   282: iload_3
    //   283: invokestatic 160	ku:e	(II)Ljava/lang/String;
    //   286: iload 9
    //   288: i2f
    //   289: invokespecial 164	com/etrump/mixlayout/ETFont:<init>	(ILjava/lang/String;F)V
    //   292: astore 7
    //   294: aload_0
    //   295: aload 7
    //   297: invokespecial 396	com/tencent/mobileqq/vaswebviewplugin/ChatFontJsPlugin:calculateFontPadding	(Lcom/etrump/mixlayout/ETFont;)Lcom/tencent/mobileqq/vaswebviewplugin/ChatFontJsPlugin$FontPadding;
    //   300: astore 11
    //   302: aload 7
    //   304: aload 11
    //   306: getfield 93	com/tencent/mobileqq/vaswebviewplugin/ChatFontJsPlugin$FontPadding:fontSize	F
    //   309: invokevirtual 221	com/etrump/mixlayout/ETFont:setSize	(F)V
    //   312: aload 7
    //   314: iload 6
    //   316: invokevirtual 513	com/etrump/mixlayout/ETFont:setColor	(I)V
    //   319: aload 7
    //   321: aload 5
    //   323: invokevirtual 399	com/etrump/mixlayout/ETFont:parseDIYJsonString	(Ljava/lang/String;)V
    //   326: aload 4
    //   328: invokevirtual 175	java/lang/String:length	()I
    //   331: istore 10
    //   333: iload 9
    //   335: iload 10
    //   337: imul
    //   338: iload 9
    //   340: getstatic 405	android/graphics/Bitmap$Config:ARGB_8888	Landroid/graphics/Bitmap$Config;
    //   343: invokestatic 411	android/graphics/Bitmap:createBitmap	(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    //   346: astore 5
    //   348: iconst_0
    //   349: istore_2
    //   350: iload_2
    ...
    //   363: istore 6
    //   365: aload 11
    //   367: getfield 90	com/tencent/mobileqq/vaswebviewplugin/ChatFontJsPlugin$FontPadding:paddingType	I
    //   370: iconst_1
    //   371: if_icmpne +86 -> 457
    //   374: iload 8
    //   376: i2f
    //   377: aload 11
    //   379: getfield 96	com/tencent/mobileqq/vaswebviewplugin/ChatFontJsPlugin$FontPadding:padding	F
    //   382: fadd
    //   383: f2i
    //   384: istore_3
    //   385: invokestatic 63	com/etrump/mixlayout/ETEngine:getInstance	()Lcom/etrump/mixlayout/ETEngine;
    //   388: aload 4
    //   390: iload_2
    //   391: iload_2
    //   392: iconst_1
    ...
    //   400: iload 6
    //   402: aload 7
    //   404: invokevirtual 415	com/etrump/mixlayout/ETEngine:native_drawText	(Ljava/lang/String;Landroid/graphics/Bitmap;IILcom/etrump/mixlayout/ETFont;)Z
    //   407: pop
    //   408: iload_2
    //   409: iconst_1
    //   410: iadd
    ...
    //   418: aload_1
    //   419: iconst_1
    //   420: anewarray 118	java/lang/String
    //   423: dup
    //   424: iconst_0
    ...
    //   452: aastore
    //   453: invokespecial 124	com/tencent/mobileqq/vaswebviewplugin/VasWebviewJsPlugin:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   456: return
    //   457: iload 8
    //   459: istore_3
    //   460: aload 11
    //   462: getfield 90	com/tencent/mobileqq/vaswebviewplugin/ChatFontJsPlugin$FontPadding:paddingType	I
    //   465: iconst_2
    //   466: if_icmpne -81 -> 385
    //   469: iconst_0
    //   470: i2f
    //   471: aload 11
    //   473: getfield 96	com/tencent/mobileqq/vaswebviewplugin/ChatFontJsPlugin$FontPadding:padding	F
    //   476: fadd
    //   477: f2i
    //   478: istore 6
    //   480: iload 8
    //   482: istore_3
    //   483: goto -98 -> 385
    //   486: new 417	java/io/ByteArrayOutputStream
    //   489: dup
    //   490: invokespecial 418	java/io/ByteArrayOutputStream:<init>	()V
    //   493: astore 4
    //   495: aload 5
    //   497: getstatic 424	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   500: bipush 100
    //   502: aload 4
    //   504: invokevirtual 428	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   507: pop
    //   508: aload 4
    //   510: invokevirtual 432	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   513: iconst_2
    //   514: invokestatic 438	aqgo:encodeToString	([BI)Ljava/lang/String;
    //   517: astore 4
    //   519: new 223	org/json/JSONObject
    //   522: dup
    //   523: invokespecial 224	org/json/JSONObject:<init>	()V
    //   526: astore 11
    //   528: new 223	org/json/JSONObject
    //   531: dup
    //   532: invokespecial 224	org/json/JSONObject:<init>	()V
    //   535: astore 12
    //   537: aload 12
    //   539: ldc_w 440
    //   542: aload 4
    //   544: invokevirtual 239	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   547: pop
    //   548: aload 12
    //   550: ldc_w 442
    //   553: aload 5
    //   555: invokevirtual 445	android/graphics/Bitmap:getWidth	()I
    //   558: invokevirtual 230	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   561: pop
    //   562: aload 12
    //   564: ldc 234
    //   566: aload 5
    //   568: invokevirtual 448	android/graphics/Bitmap:getHeight	()I
    //   571: invokevirtual 230	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   574: pop
    //   575: aload 11
    //   577: ldc 236
    //   579: aload 12
    //   581: invokevirtual 239	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   584: pop
    //   585: aload 11
    //   587: ldc 226
    //   589: iconst_0
    //   590: invokevirtual 230	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   593: pop
    //   594: aload_0
    //   595: aload_1
    //   596: iconst_1
    //   597: anewarray 118	java/lang/String
    //   600: dup
    //   601: iconst_0
    //   602: aload 11
    //   604: invokevirtual 240	org/json/JSONObject:toString	()Ljava/lang/String;
    //   607: aastore
    //   608: invokespecial 124	com/tencent/mobileqq/vaswebviewplugin/VasWebviewJsPlugin:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   611: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   614: ifeq +33 -> 647
    //   617: ldc 19
    //   619: iconst_2
    ...
    //   633: aload 11
    //   635: invokevirtual 240	org/json/JSONObject:toString	()Ljava/lang/String;
    ...
    //   644: invokestatic 116	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   647: aload 5
    //   649: invokevirtual 453	android/graphics/Bitmap:recycle	()V
    //   652: invokestatic 63	com/etrump/mixlayout/ETEngine:getInstance	()Lcom/etrump/mixlayout/ETEngine;
    //   655: aload 7
    //   657: getfield 457	com/etrump/mixlayout/ETFont:m_diyHandle	J
    //   660: invokevirtual 461	com/etrump/mixlayout/ETEngine:native_diyFontDeleteNativeConfig	(J)V
    //   663: return
    //   664: astore 4
    //   666: ldc 19
    //   668: iconst_1
    //   669: ldc_w 463
    //   672: invokestatic 465	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   675: aload_0
    //   676: aload_1
    //   677: iconst_1
    //   678: anewarray 118	java/lang/String
    //   681: dup
    //   682: iconst_0
    //   683: ldc 205
    //   685: aastore
    //   686: invokespecial 124	com/tencent/mobileqq/vaswebviewplugin/VasWebviewJsPlugin:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   689: goto -37 -> 652
    //   692: astore 4
    //   694: ldc 19
    //   696: iconst_1
    //   697: ldc_w 463
    //   700: invokestatic 465	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   703: aload_0
    //   704: aload_1
    //   705: iconst_1
    //   706: anewarray 118	java/lang/String
    //   709: dup
    //   710: iconst_0
    //   711: ldc 205
    //   713: aastore
    //   714: invokespecial 124	com/tencent/mobileqq/vaswebviewplugin/VasWebviewJsPlugin:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   717: goto -65 -> 652
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramJsBridgeListener.put("message", acfp.m(2131703603));
      ...
      for (;;)
      {
        ...
        super.sendRemoteReq(affz.a(paramJsBridgeListener, paramString1, this.mOnRemoteResp.key, this.mReqBundle), false, true);
        return true;
          ...
          else
          {
            if ("showBlackMsgBox".equals(paramString3))
            {
              ...
              try
              {
                ...
                paramString3 = this.mRuntime.a(this.mRuntime.getActivity());
                if ((paramString3 != null) && ((paramString3 instanceof ardm.n))) {
                  QQToast.a(this.mRuntime.getActivity(), paramString2, 0).show(((ardm.n)paramString3).getTitleBarHeight());
                }
              }
      ...
      if ("fontBubblePaySuccess".equals(paramString3))
      {
        ...
        super.sendRemoteReq(affz.a("fontBubblePaySuccess", paramString1, this.mOnRemoteResp.key, this.mReqBundle), false, true);
        return true;
      }
      if (QLog.isColorLevel()) {
  ...
  {
    int j = -1;
    int k = aqnl.af(aqnl.getSoDir(), "libvipfont808.so");
    if (QLog.isColorLevel()) {
  ...
  {
    boolean bool1 = this.mRuntime.getActivity().getSharedPreferences("font_open_switch", 4).getBoolean("isUserOpenFontSwitch_" + this.mRuntime.a().getAccount(), false);
    boolean bool2 = DeviceProfileManager.a().isFeatureSupported(DeviceProfileManager.DpcNames.chat_font.name());
    if ((bool1) || (bool2)) {}
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      aqju localaqju = aqha.a(this.mRuntime.getActivity(), 230).setTitle(this.mRuntime.getActivity().getString(2131721126)).setMessage(this.mRuntime.getActivity().getString(2131697054)).setPositiveButton(this.mRuntime.getActivity().getString(2131697055), new ChatFontJsPlugin.3(this, localJSONObject, paramString)).setNegativeButton(this.mRuntime.getActivity().getString(2131697050), new ChatFontJsPlugin.2(this, localJSONObject, paramString));
      localaqju.show();
      localaqju.setOnCancelListener(new ChatFontJsPlugin.4(this, localJSONObject, paramString));
      return;
    }
    try
    {
  ...
  public void queryLocal(JSONObject paramJSONObject, String paramString)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        paramJSONObject = new File(ku.dV);
        localObject = new JSONArray();
        searchFontInDir(paramJSONObject, (JSONArray)localObject);
        searchFontInDir(new File(ku.dW), (JSONArray)localObject);
  ...
  public void setSize(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      anot.c(null, "CliOper", "", "", "Font_Mall", "change_" + paramJSONObject, 0, 0, "", "", "", "");
      int i;
  ...
  void startDownloadFont(int paramInt1, int paramInt2, String paramString, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        super.sendRemoteReq(affz.a("font_startDownLoad", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
        return;
        if (ahxo.jX(paramInt1)) {
          localJSONObject = new JSONObject();
        }
        try
        {
          ...
          return;
          this.mReqBundle.putInt("id", paramInt1);
          super.sendRemoteReq(affz.a("ipc_download_hiboom", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
          return;
        }
  ...
  void tryInitHYEngine(String paramString)
  {
    ...
    for (;;)
    {
      ...
      return;
      super.sendRemoteReq(affz.a("ipc_font_download_hy_so", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
      return;
      ETEngine.isSOLoaded.set(true);
      try
      {
