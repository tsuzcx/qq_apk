  ...
  extends VasWebviewJsPlugin
{
  ...
  private void getNumberPic(JSONObject paramJSONObject, String paramString)
  {
    ...
    super.sendRemoteReq(affz.a("getPendantNumberPic", paramString, this.mOnRemoteResp.key, localBundle), false, false);
  }
  ...
  private Bitmap getRoundFaceBitmap(String paramString)
  {
    ...
    {
      Object localObject = aqhu.a(new BitmapFactory.Options(), paramString, 200);
      try
      {
        ...
        localObject = aqhu.b(paramString, i, i, j);
        paramString = (String)localObject;
        if (localObject != null)
        {
          paramString = (String)localObject;
          if (((Bitmap)localObject).getWidth() > 200) {
            paramString = aqhu.scaleBitmap((Bitmap)localObject, 200);
          }
        }
        return paramString;
      }
  ...
  public void changeFace(JSONObject paramJSONObject, String paramString)
  {
    ...
    paramJSONObject = (ausj)auss.a(this.mRuntime.getActivity(), null);
    paramJSONObject.addButton(acfp.m(2131703001));
    paramJSONObject.addButton(acfp.m(2131703003));
    paramJSONObject.addCancelButton(acfp.m(2131702984));
    ...
    if (paramLong == 128L)
    {
      ...
      if ((localObject != null) && ((localObject instanceof Intent)))
      {
        ...
        if (localIntent.getBooleanExtra("keyFromPendantPhoto", false))
        {
          ...
          for (localObject = this.mRuntime.getWebView();; localObject = null)
          {
            if (localObject != null) {
            ...
            if (localWebViewPluginEngine != null)
            {
              ...
              localWebViewPluginEngine.handleEvent(paramString, 8589934605L, paramMap);
            }
            return true;
          }
        }
  ...
  protected void onResponse(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      String str3 = aqgo.encodeToString(((ByteArrayOutputStream)localObject2).toByteArray(), 2);
      ...
      if ((localObject1 != null) && ((localObject1 instanceof ardm.n))) {
        QQToast.a(this.mRuntime.getActivity(), 2131719573, 0).show(((ardm.n)localObject1).getTitleBarHeight());
      }
  ...
  public void showMsgBox(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      {
        aqkf localaqkf = aqha.a(this.mRuntime.getActivity(), 230);
        localaqkf.a(str2);
        localaqkf.b(str1);
        localaqkf.a(paramJSONObject.getString(0), new AvatarPendantJsPlugin.2(this, paramString));
        if (paramJSONObject.length() >= 2) {
          localaqkf.b(paramJSONObject.getString(1), new AvatarPendantJsPlugin.3(this, paramString));
        }
        if (paramJSONObject.length() >= 3) {
          localaqkf.c(paramJSONObject.getString(2), new AvatarPendantJsPlugin.4(this, paramString));
        }
        localaqkf.show();
  ...
  public void updateFaceAddon(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      super.sendRemoteReq(affz.a("updatePendantId", paramString, this.mOnRemoteResp.key, paramJSONObject), false, false);
      return;
    }
    catch (JSONException paramJSONObject)
    {
