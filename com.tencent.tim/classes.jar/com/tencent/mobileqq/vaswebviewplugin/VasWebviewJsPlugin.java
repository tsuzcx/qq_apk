  ...
  extends VasBasePlugin
{
  ...
  jml authCfg;
  public Client.b mOnRemoteResp = new VasWebviewJsPlugin.1(this);
  ...
  public void getDomainIpList(JSONObject paramJSONObject, String paramString)
  {
    ...
    sendRemoteReq(affz.a("getDomainIpList", paramString, this.mOnRemoteResp.key, localBundle), false, false);
  }
  ...
  public void getVipType(JSONObject paramJSONObject, String paramString)
  {
    ...
    sendRemoteReq(affz.a("getUserVipType", paramString, this.mOnRemoteResp.key, localBundle), false, false);
  }
  ...
  protected boolean handleEmojiSchemaRequest(String paramString1, String paramString2)
  {
    ...
    do
    {
      return bool;
      if (QLog.isDevelopLevel()) {
        QLog.d("VasWebviewJsPlugin", 4, "handleSchemaRequest:" + jqo.filterKeyForLog(paramString1, new String[0]));
      }
    ...
    String str = this.mRuntime.getWebView().getUrl();
    if (!this.authCfg.z(str, paramString1 + "." + paramString2)) {
      return false;
    }
        ...
        else
        {
          ...
          if (!paramString3.equals(paramString1))
          {
            ...
            try
            {
              ...
              localObject = this.mRuntime.getWebView().getUrl();
              if (this.authCfg.z((String)localObject, paramString1 + "." + paramString2)) {
  ...
  public void sendRemoteReq(Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      if (paramBoolean2) {
        Toast.makeText(BaseApplicationImpl.getApplication(), acfp.m(2131716323), 0).show();
      }
