  ...
  extends VasWebviewJsPlugin
{
  ...
  private void buyEmoji(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11)
  {
    ...
    {
      return;
      PayBridgeActivity.a(this.mRuntime.getActivity(), paramString1, paramString2, paramString3, paramString4, paramString9, paramString7, paramString8, paramString10, paramString11);
      return;
  ...
  {
    PayBridgeActivity.tenpay(this.mRuntime.getActivity(), paramString2, 7, paramString1);
  }
  ...
  private void collectEmoji(JSONWrapper paramJSONWrapper, String paramString)
  {
    ...
    paramJSONWrapper = affz.a("collectEmoji", paramString, this.mOnRemoteResp.key, paramJSONWrapper);
    afjy.a().cq(paramJSONWrapper);
  }
  
  private void dismissProgressDialog()
  {
    if ((this.mRuntime != null) && (this.mRuntime.getActivity() != null)) {
      this.mRuntime.getActivity().runOnUiThread(new EmojiJsPlugin.9(this));
    }
  }
  ...
  private void emojiStickerAddFavorites(String paramString1, String paramString2)
  {
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      paramString1 = affz.a("emojiStickerAddFavorites", paramString2, this.mOnRemoteResp.key, localBundle);
  ...
  private void emojiStickerRecall(String paramString1, String paramString2)
  {
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      paramString1 = affz.a("emojiStickerRecall", paramString2, this.mOnRemoteResp.key, localBundle);
      afjy.a().cq(paramString1);
      showProgressDialog();
    }
  }
  
  private void getCollectEmojiStatus(JSONWrapper paramJSONWrapper, String paramString)
  {
    Emoticon localEmoticon = new Emoticon();
    localEmoticon.epId = paramJSONWrapper.getString("pkgId");
    localEmoticon.eId = paramJSONWrapper.getString("itemId");
    paramJSONWrapper = new Bundle();
    paramJSONWrapper.putSerializable("emoticon", localEmoticon);
    paramJSONWrapper = affz.a("getCollectEmojiStatus", paramString, this.mOnRemoteResp.key, paramJSONWrapper);
    afjy.a().cq(paramJSONWrapper);
  }
  
  private void getNetwork(String paramString)
  {
    int i = aqiw.getSystemNetwork(this.mRuntime.getActivity().getApplicationContext());
  ...
  {
    QQToast.a(this.mRuntime.getActivity(), paramString, 0).show(this.mRuntime.getActivity().getResources().getDimensionPixelSize(2131299627));
  }
  ...
  {
    PayBridgeActivity.tenpay(this.mRuntime.getActivity(), paramString2, 4, paramString1);
  }
  ...
  private void openSubPage(String paramString1, String paramString2)
  {
    ...
    VasWebviewUtil.openQQBrowserWithoutAD(this.mRuntime.getActivity(), null, 8L, localIntent, false, -1);
  }
  
  private void openTenpayView(String paramString1, String paramString2)
  {
    PayBridgeActivity.tenpay(this.mRuntime.getActivity(), paramString2, 5, paramString1);
  }
  ...
  private void queryEmojiInfo(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    paramString1 = affz.a("queryEmojiInfo", paramString1, this.mOnRemoteResp.key, localBundle);
    afjy.a().cq(paramString1);
  }
  ...
  private void queryEmojiInfos(String paramString, int paramInt)
  {
    ...
    paramString = affz.a("queryEmojiInfos", paramString, this.mOnRemoteResp.key, localBundle);
  ...
  {
    Bundle localBundle = new Bundle();
    paramString = affz.a("queryEmojiStickerInfos", paramString, this.mOnRemoteResp.key, localBundle);
    afjy.a().cq(paramString);
  }
  
  private void rechargeGameCurrency(String paramString1, String paramString2)
  {
    PayBridgeActivity.tenpay(this.mRuntime.getActivity(), paramString2, 6, paramString1);
  }
  
  private void rechargeQb(String paramString1, String paramString2)
  {
    PayBridgeActivity.tenpay(this.mRuntime.getActivity(), paramString2, 8, paramString1);
  }
  ...
  private void sendEmojiToAIO(JSONWrapper paramJSONWrapper, String paramString)
  {
    Emoticon localEmoticon = new Emoticon();
    localEmoticon.epId = paramJSONWrapper.getString("pkgId");
    localEmoticon.eId = paramJSONWrapper.getString("itemId");
    ...
    paramJSONWrapper = new Bundle();
    paramJSONWrapper.putSerializable("emoticon", localEmoticon);
    paramJSONWrapper = affz.a("sendEmojiToAIO", paramString, this.mOnRemoteResp.key, paramJSONWrapper);
    afjy.a().cq(paramJSONWrapper);
  }
  ...
  private void sendEmojiToFriend(int paramInt)
  {
    try
    {
      ...
      int i = getInfoIntent().getExtras().getInt("key_emojimall_detail_chat_type");
      anot.c(null, "CliOper", "", "", "ep_mall", "Clk_send_detail", 0, 0, "", "", "", paramInt + "");
      if (((this.mSrcFromType == 1) || (this.mSrcFromType == 8)) && (localObject != null))
      {
        ...
        localObject = wja.a(new Intent(this.mRuntime.getActivity().getApplicationContext(), SplashActivity.class), new int[] { 2 });
        this.mRuntime.getActivity().getSharedPreferences("mobileQQ", 4).edit().putBoolean("FORWARD_EMOPGK_ID", true).commit();
      ...
      localBundle.putInt("FORWARD_EMOPGK_ID", paramInt);
      localObject = new Intent(this.mRuntime.getActivity().getApplicationContext(), ForwardRecentActivity.class);
  ...
  private void showMsgBox(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    {
      paramString2 = aqha.a(this.mRuntime.getActivity(), 230).a(paramString3).b(paramString2).a(paramString4[0], new EmojiJsPlugin.1(this, paramString1));
  ...
  {
    if ((this.mRuntime != null) && (this.mRuntime.getActivity() != null)) {
      this.mRuntime.getActivity().runOnUiThread(new EmojiJsPlugin.8(this));
    }
  }
  ...
  private void startDownloadEmoji(String paramString, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    catch (JSONException localJSONException1)
    {
      ...
      Object localObject;
      if (aqiw.isNetSupport(this.mRuntime.getActivity().getApplicationContext())) {
        if ((!paramBoolean) || (aqiw.getNetworkType(this.mRuntime.getActivity().getApplicationContext()) == 1))
        {
          ...
          localObject = affz.a("startDownloadEmoji", paramString, this.mOnRemoteResp.key, (Bundle)localObject);
          addDownloadingStateObserver(new Pair(Integer.valueOf(paramInt1), paramString));
          afjy.a().cr((Bundle)localObject);
        }
      }
      for (;;)
      {
        ...
        localObject = aqha.a(this.mRuntime.getActivity(), 230).a(this.mRuntime.getActivity().getString(2131693093)).b(this.mRuntime.getActivity().getString(2131693092)).a(this.mRuntime.getActivity().getString(2131693090), new EmojiJsPlugin.6(this, paramString)).c(this.mRuntime.getActivity().getString(2131693091), new EmojiJsPlugin.5(this, paramInt1, paramInt2, paramInt3, paramString));
        ((aqkf)localObject).setOnKeyListener(new EmojiJsPlugin.7(this, (aqkf)localObject, paramString));
        ...
        afgc.bk(this.mRuntime.getActivity());
      }
    }
  }
  ...
  private void stopDownloadEmoji(String paramString, int paramInt1, int paramInt2)
  {
    ...
    localBundle.putInt("sceneType", paramInt2);
    paramString = affz.a("stopDownloadEmoji", paramString, this.mOnRemoteResp.key, localBundle);
    afjy.a().cq(paramString);
  }
  ...
  public void invoke(String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString3)))
    {
      try
      {
        ...
        localJSONWrapper = new JSONWrapper(localJSONObject);
  ...
  public void onResponse(Bundle paramBundle)
  {
          ...
          if (localObject1 != null)
          {
            ...
            for (;;)
            {
              ...
              try
              {
                ...
                return;
                paramBundle = acfp.m(2131705775);
                i = 0;
                continue;
                paramBundle = acfp.m(2131705772);
                i = 1;
                continue;
                paramBundle = acfp.m(2131705773);
                i = 1;
              }
              catch (JSONException paramBundle)
              {
        ...
        else if ("emojiStickerAddFavorites".equals(localObject2))
        {
          if (localObject1 != null)
          {
            ...
            for (;;)
            {
              ...
              paramBundle = acfp.m(2131705776);
              continue;
              paramBundle = acfp.m(2131705777);
              continue;
              paramBundle = acfp.m(2131705774);
            }
          }
        }
        else
    ...
    if (((String)localObject2).equals("sendEmojiToAIO"))
    {
      ...
      try
      {
        ...
        ahgq.f(this.mRuntime.getActivity(), (Intent)localObject1, 21);
        paramBundle = new JSONObject();
        try
        {
          paramBundle.put("result", i);
  ...
  class MakeDynamicEmojiInfo
  {
    String callbackid;
    int emoPackId;
    
    public MakeDynamicEmojiInfo(String paramString, int paramInt)
    {
      this.callbackid = paramString;
      this.emoPackId = paramInt;
    }
  }
}
