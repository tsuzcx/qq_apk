...
import com.tencent.mobileqq.vas.wallpaper.VipWallpaperService.c;
  ...
  extends VasWebviewJsPluginV2
{
  ...
  public void wallpaperGetChatBg(String paramString)
  {
    try
    {
      ...
      VipWallpaperService.c localc = VipWallpaperService.a(this.mRuntime.getActivity(), true);
      localJSONObject.put("result", "0");
      localJSONObject.put("id", localc.itemId);
  ...
  public void wallpaperSetChatBg(String paramString1, String paramString2, String paramString3)
  {
    for (;;)
    {
      try
      {
        ...
        {
          VipWallpaperService.a(this.mRuntime.getActivity(), new VipWallpaperService.c(), null);
          paramString3.put("result", "0");
          paramString3.put("msg", "恢复系统壁纸");
          super.callJs(paramString1, new String[] { paramString3.toString() });
          return;
        }
        String str = ChatBackgroundManager.c(true, paramString2);
        if (new File(str).exists())
        {
          AtomicBoolean localAtomicBoolean = new AtomicBoolean();
          paramString2 = new VipWallpaperService.c(paramString2, str, "");
          VipWallpaperService.a(this.mRuntime.getActivity(), paramString2, localAtomicBoolean);
          paramString3.put("result", "0");
