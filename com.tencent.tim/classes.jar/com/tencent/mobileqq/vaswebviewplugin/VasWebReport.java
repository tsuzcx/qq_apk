  ...
  extends WebViewPlugin
{
  ...
  private void handleNewPerformanceData(String paramString, JSONObject paramJSONObject)
  {
    ...
    do
    {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            if ((i == 2) && (paramJSONObject.has("first_screen")))
            {
              ...
              paramJSONObject = this.mRuntime.a(this.mRuntime.getActivity());
              if ((paramJSONObject == null) || (!(paramJSONObject instanceof ardm.q))) {
                break label420;
              }
              ((ardm.q)paramJSONObject).setX5Performance(paramString);
      ...
      } while (!(this.mRuntime.getActivity() instanceof aqzs));
      paramJSONObject = (arbz)super.getBrowserComponent(-2);
    } while (paramJSONObject == null);
    paramJSONObject.mX5PerformanceJson = paramString;
    this.mIndexPerformanceObject = null;
    this.mFirstScreenPerformanceObject = null;
  }
  ...
  private void handlePerformanceData(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ((ardm.q)localaqzv).setX5Performance(localJSONObject);
      }
      ...
      try
      {
        ...
        if (i != -1)
        {
          ...
          if (("qqpublic.qpic.cn".equalsIgnoreCase(paramString)) && (!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).startsWith("/qq_public")))
          {
            ...
            int n = aroc.getNetType(null);
            if (QLog.isColorLevel()) {
              QLog.i("PublicAccountWebReport", 2, "urlStr: " + str3 + ",errorcode:" + m + ",netType:" + n + ",DNSCost" + i + ",connectCost:" + j + ",receiveCost:" + k + ",website_address:" + (String)localObject + ",AppSetting.subVersion:" + "3.4.4,3,3058");
            }
          }
          if (!str2.equalsIgnoreCase(str1)) {
            break;
  ...
  public boolean handleEvent(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    ...
    if (paramLong == 32L)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        i = 65535;
        break;
        if ((VipWebViewReportLog.nc(paramString)) && (VipWebViewReportLog.apH())) {
    ...
    for (paramMap = (Integer)paramMap;; paramMap = Integer.valueOf(0))
    {
      ...
      if (paramLong == 8589934594L)
      {
        ...
        if ((paramString.contains("vip.qq.com")) || (paramString.contains("vaswebreport=1")))
        {
          ...
          if (2 != aqiw.getSystemNetwork((Context)localObject1)) {
            break label933;
          }
          paramMap = "2G";
        }
        for (;;)
        {
          ...
          anot.c(null, "P_CliOper", "vasweb", "", "load", "finish", 0, 1, "errocode:" + this.errorMap.get(paramString), paramMap, jqo.filterKeyForLog(paramString, new String[0]), "3.4.4--android--" + Build.VERSION.SDK_INT);
          this.errorMap.remove(paramString);
          this.startTimeMap.remove(paramString);
          paramString = this.mRuntime.getActivity();
          paramMap = this.mRuntime.b();
          if ((paramMap == null) || (paramMap.browserApp == null) || (paramMap.browserApp.a != null)) {
            break;
          }
          paramMap.browserApp.a = new aqqu(paramString);
          break;
          if (3 == aqiw.getSystemNetwork((Context)localObject1)) {
            paramMap = "3G";
          } else if (4 == aqiw.getSystemNetwork((Context)localObject1)) {
            paramMap = "4G";
          } else if (1 == aqiw.getSystemNetwork((Context)localObject1)) {
            paramMap = "WIFI";
          }
        }
        label984:
        ...
        {
          anot.c(null, "P_CliOper", "vasweb", "", "load", "finish", 0, 0, "" + paramLong, paramMap, jqo.filterKeyForLog(paramString, new String[0]), "3.4.4--android--" + Build.VERSION.SDK_INT);
          break;
          if (QLog.isColorLevel()) {
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      paramJsBridgeListener = (arbz)super.getBrowserComponent(-2);
      if (paramJsBridgeListener != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("QQBrowser_report", 2, "try report web status, onNetworkCost,  step: 11, asyncMode: " + paramJsBridgeListener.eeg + ", from loadUrl: " + (System.currentTimeMillis() - paramJsBridgeListener.mTimeBeforeLoadUrl) + ", stepTime: " + (System.currentTimeMillis() - paramJsBridgeListener.mClickTime) + ", totalTime: " + (System.currentTimeMillis() - paramJsBridgeListener.mClickTime) + ", \n " + paramString1);
        }
        return true;
      }
    }
