  ...
  implements adac, aqze
{
  ...
  {
    this.mRuntime.getActivity().runOnUiThread(new MQPSecJsPlugin.2(this));
  }
    ...
    if (("EquipLockManager".equalsIgnoreCase(paramString2)) || ("SetPwdJsInterface".equalsIgnoreCase(paramString2)) || ("CAPTCHA".equalsIgnoreCase(paramString2)))
    {
      ...
      if ("openDevLock".equals(paramString3))
      {
        ...
        try
        {
          ...
          localJSONObject.put("image_res_id", 2130845985);
  ...
  {
    paramString1 = aqft.bW(paramString1, paramString2);
  ...
  void onBindedToClient()
  {
    ...
    do
    {
      ...
      if ((0x8000 & l) != 0L)
      {
        ...
        sendRemoteReq(affz.a("getA2", "", this.mOnRemoteResp.key, localBundle), true, false);
        hideProgressDialog();
        return;
      }
    } while ((0x200000 & l) == 0L);
    sendRemoteReq(affz.a("puzzle_verify_code_clearProgressDialog", "", this.mOnRemoteResp.key, new Bundle()), true, false);
  }
  ...
  public void onLoadIsSetPsw(String paramString)
  {
    ...
    if ((paramString != null) && (paramString.equals("1"))) {
      sendRemoteReq(affz.a("setHasSetPwd", "", this.mOnRemoteResp.key, new Bundle()), true, false);
    }
  }
  ...
  public void onResponse(Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        return;
        localObject2 = jqo.dV((String)localObject1);
      ...
      return;
      CookieSyncManager.createInstance(this.mRuntime.getWebView().getContext());
      ...
      if (((String)localObject1).equalsIgnoreCase("openDevLock"))
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject2).put("sigDA2", aqhs.bytes2HexStr((byte[])localObject1));
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (Integer.parseInt(paramString.getString("result")) == 0)
        {
          ...
          sendRemoteReq(affz.a("puzzle_verify_code_setTicket", "", this.mOnRemoteResp.key, (Bundle)localObject3), true, false);
          if (this.activity != null) {
            this.activity.finish();
          }
          return;
  ...
  public void onWebViewCreated(CustomWebView paramCustomWebView)
  {
    ...
    while ((l & 0x200000) == 0L) {
      try
      {
        ...
        paramCustomWebView = (TextView)this.activity.findViewById(2131369579);
  ...
  public void openDevLock(boolean paramBoolean, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      sendRemoteReq(affz.a("openDevLock", paramString3, this.mOnRemoteResp.key, localBundle), true, false);
      return;
  ...
  public void openEquipmentLock(String paramString1, String paramString2, String paramString3)
  {
    ...
    sendRemoteReq(affz.a("openEquipmentLock", "", this.mOnRemoteResp.key, paramString3), true, false);
  }
  ...
  {
    sendRemoteReq(affz.a("queryDevLockStatus", "", this.mOnRemoteResp.key, null), true, false);
  }
