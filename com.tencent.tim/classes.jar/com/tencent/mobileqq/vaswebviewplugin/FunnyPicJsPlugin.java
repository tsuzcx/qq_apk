  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      if ("getCurrentPkgInfo".equals(paramString3))
      {
        ...
        paramJsBridgeListener = paramString1;
        super.sendRemoteReq(affz.a("ipc_funnypic_query_info", paramString1, this.mOnRemoteResp.key, this.mReqBundle), false, true);
      }
      else
      {
        paramJsBridgeListener = paramString1;
        if ("addQutu".equals(paramString3))
        {
          ...
          {
            paramJsBridgeListener = paramString1;
            if (!aqiw.isNetworkAvailable(paramString2))
            {
              paramJsBridgeListener = paramString1;
          ...
          {
            paramJsBridgeListener = paramString1;
            QQToast.a(paramString2, acfp.m(2131706697), 0).show();
            paramJsBridgeListener = paramString1;
            paramString2 = new JSONObject();
            paramJsBridgeListener = paramString1;
            paramString2.put("result", 1);
          ...
          {
            paramJsBridgeListener = paramString1;
            localObject = new NewIntent(this.mRuntime.a().getApp(), ailu.class);
            paramJsBridgeListener = paramString1;
