  ...
  extends VasWebviewJsPlugin
{
      ...
      try
      {
        ...
        if (paramString2 != null)
        {
          ...
          if ("edit".equals(paramString3))
          {
            ...
            paramString3 = new Intent(this.mRuntime.getActivity(), VipProfileCardDiyActivity.class);
            ...
            this.mRuntime.getActivity().startActivity(paramString3);
            bool1 = bool2;
  ...
  protected void onResponse(Bundle paramBundle)
  {
    if ((paramBundle != null) && (paramBundle.getInt("respkey", 0) == this.mOnRemoteResp.key))
    {
      ...
      if (paramBundle != null) {
        paramBundle.setClassLoader(this.mRuntime.getActivity().getClassLoader());
      }
      if (QLog.isColorLevel()) {
