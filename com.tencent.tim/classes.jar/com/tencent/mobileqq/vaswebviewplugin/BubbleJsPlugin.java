  ...
  extends VasWebviewJsPlugin
{
    ...
    throws JSONException
  {
    ...
    super.sendRemoteReq(affz.a("diy_setup", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
  ...
  protected void onResponse(Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && (paramBundle.getInt("respkey", 0) == this.mOnRemoteResp.key))
    {
      ...
      if (localObject1 != null) {
        ((Bundle)localObject1).setClassLoader(this.mRuntime.getActivity().getClassLoader());
      }
      if (QLog.isColorLevel()) {
    ...
    throws JSONException
  {
    ...
    if (i == 0)
    {
      ...
      paramJSONObject.put("message", acfp.m(2131703264));
      super.callJs(paramString + "(" + paramJSONObject.toString() + ");");
      return;
    }
    this.mReqBundle.clear();
    this.mReqBundle.putInt("id", i);
    super.sendRemoteReq(affz.a("queryBubbleInfo", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
  }
  ...
  public void queryLocal(JSONObject paramJSONObject, String paramString)
  {
    ...
    paramString = affz.a("queryLocal", paramString, this.mOnRemoteResp.key, new Bundle());
    ...
    throws JSONException
  {
    ...
    super.sendRemoteReq(affz.a("setup", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
  }
    ...
    throws JSONException
  {
    ...
    this.mReqBundle.clear();
    this.mReqBundle.putInt("id", i);
    super.sendRemoteReq(affz.a("bubble_startDownLoad", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
  }
    ...
    throws JSONException
  {
    ...
    this.mReqBundle.clear();
    this.mReqBundle.putInt("id", i);
    super.sendRemoteReq(affz.a("bubble_StopDownLoad", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
  }
}
