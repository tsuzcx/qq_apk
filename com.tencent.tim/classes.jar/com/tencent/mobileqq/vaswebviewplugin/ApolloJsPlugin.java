  ...
  implements abja
{
  ...
  private static final int DEFAULT_HEIGHT = (int)(aqgz.getHeight() * 0.4D / aqgz.getDesity());
  private static final int DEFAULT_WIDTH = (int)((float)(aqgz.getWidth() >> 1) / aqgz.getDesity());
  ...
  public ApolloJsPlugin(String paramString)
  {
    ...
    if (abvd.Zl())
    {
      ...
      this.mInterceptor = abvc.a(true, paramString);
      if (QLog.isColorLevel()) {
  ...
  boolean checkSdcard(Context paramContext)
  {
    ...
    {
      QQToast.a(paramContext, acfp.m(2131702573), 0).show();
      return false;
    }
    return true;
  }
  
  public abvc getIntercepter()
  {
  ...
  public Object handleEvent(String paramString, long paramLong)
  {
    ...
    if (paramLong == 8L) {
      try
      {
        ...
        {
          localObject3 = this.mInterceptor.p(paramString);
        ...
        if (this.mRscLoader == null) {
          this.mRscLoader = new abuk(this);
        }
        Object localObject3 = this.mRscLoader.c(paramString);
        if (localObject3 != null)
        {
          localObject1 = localObject3;
          if (!QLog.isColorLevel()) {
  ...
  public boolean handleEvent(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    if (32L == paramLong)
    {
      ...
      if (this.mInterceptor != null)
      {
        this.mInterceptor.a(this.mRuntime.getWebView());
        return this.mInterceptor.jE(paramString);
      }
    }
    else if ((8589934597L == paramLong) && (this.mApolloViewContoller != null))
    {
      this.mApolloViewContoller.onPause();
    }
    ...
    try
    {
      ...
      do
      {
        for (;;)
        {
          ...
          {
            callbackError(paramString2, acfp.m(2131702580));
            return true;
          }
          if ("startRecord".equals(paramString3))
          {
            ...
            else
            {
              ...
              super.sendRemoteReq(affz.a("ipc_apollo_start_record_msg", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
            }
          }
          else if ("stopRecord".equals(paramString3))
          {
            super.sendRemoteReq(affz.a("ipc_apollo_stop_record_msg", paramString2, this.mOnRemoteResp.key, null), false, true);
          }
          else if ("startUploadRecord".equals(paramString3))
          {
            super.sendRemoteReq(affz.a("ipc_apollo_upload_record_msg", paramString2, this.mOnRemoteResp.key, null), false, true);
          }
          else if ("startPlayLastRecord".equals(paramString3))
          {
            ...
            super.sendRemoteReq(affz.a("ipc_apollo_play_last_record_msg", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
          }
          else if ("stopPlayLastRecord".equals(paramString3))
          {
            super.sendRemoteReq(affz.a("ipc_apollo_stop_last_record_msg", paramString2, this.mOnRemoteResp.key, null), false, true);
          }
          else if ("getPlaymateMsgList".equals(paramString3))
          {
            ...
            if (paramJsBridgeListener != null)
            {
              ...
              super.sendRemoteReq(affz.a("ipc_apollo_get_playmate_msg", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
            }
            else
            {
          ...
          else if ("openCmGameAio".equals(paramString3))
          {
            ...
            if (!TextUtils.isEmpty(paramJsBridgeListener))
            {
              ...
              super.sendRemoteReq(affz.a("ipc_apollo_open_cmgame_aio", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
          ...
          else if ("isApolloEngineReady".equals(paramString3))
          {
            ...
            for (;;)
            {
              ...
              QLog.d("ApolloJsPlugin", 2, new Object[] { "isApolloEngineReady:", Boolean.valueOf(ApolloEngine.BJ()) });
              break;
          ...
          {
            paramJsBridgeListener = new File(abxi.bim + "/webview/");
            if (paramJsBridgeListener.exists())
            {
              ...
              if ((paramJsBridgeListener != null) && (paramJsBridgeListener.length > 0))
              {
                ...
                if (i < j)
                {
                  ...
                  aqhq.cn(paramString1.getAbsolutePath());
                  if (!QLog.isColorLevel()) {
                    break label10047;
                  }
          ...
          else
          {
            ...
            if ("startApolloGame".equals(paramString3))
            {
              ...
              {
                callbackError(paramString2, acfp.m(2131702562));
                return true;
              }
              ...
              if ((paramVarArgs != null) && (!paramVarArgs.isFinishing()))
              {
                if (bool2)
                {
                  ...
                  paramJsBridgeListener = wja.a(new Intent(paramVarArgs, SplashActivity.class), new int[] { 2 });
                ...
                else
                {
                  ...
                  {
                    paramJsBridgeListener = ApolloUtil.aI(paramString3, "rbOpenId");
                    if (!TextUtils.isEmpty(paramJsBridgeListener))
                    {
                      paramString1.mRobotOpenId = paramJsBridgeListener;
                      if (ApolloUtil.z(paramString3, "gameId") > 0) {
                        paramString1.gameId = j;
                      }
                      paramString1.src = 318001;
                      paramString1.disableMinGame = true;
                      abmk.Ci((String)localObject2);
                    }
                  }
                  this.mReqBundle.clear();
                  this.mReqBundle.putSerializable("StartCheckParam", paramString1);
                  super.sendRemoteReq(affz.a("ipc_apollo_start_apollo_game", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
              }
              else {
                callbackError(paramString2, acfp.m(2131702556));
              }
            }
            else
            {
              if ("checkGameStatus".equals(paramString3))
              {
                ...
                if (aqhq.bB() < 52428800.0F)
                {
                  callbackError(paramString2, acfp.m(2131702561));
                  return true;
                }
                i = ((JSONObject)localObject1).optInt("gameId");
                this.mReqBundle.clear();
                this.mReqBundle.putInt("gameId", i);
                paramJsBridgeListener = affz.a("IPC_APOLLO_DOWNLOAD_GAME", paramString2, this.mOnRemoteResp.key, this.mReqBundle);
              ...
              {
                i = ((JSONObject)localObject1).optInt("gameId");
                paramJsBridgeListener = new ApolloPanel.b();
                paramJsBridgeListener.gameId = i;
                abxt.a(paramJsBridgeListener, this.mRuntime.getActivity(), 2);
                return true;
              }
              if ("dispatchGameEvent".equals(paramString3))
              {
                paramJsBridgeListener = abmt.b();
                if (paramJsBridgeListener != null) {
                  paramJsBridgeListener.BR(((JSONObject)localObject1).toString());
                }
                callbackOk(paramString2);
              }
              else if ("setBackViewVisibility".equals(paramString3))
              {
                ...
                if ((paramVarArgs instanceof abua))
                {
                  ((abua)paramVarArgs).Ie(i);
                  callbackOk(paramString2);
                }
                else
                {
              ...
              else if ("openApolloShareFloatView".equals(paramString3))
              {
                ...
                if ((this.mRuntime.getActivity() instanceof BaseActivity)) {
                  paramJsBridgeListener = ((BaseActivity)this.mRuntime.getActivity()).getAppInterface();
                }
                ...
                else if ((paramVarArgs instanceof abua))
                {
                  ((abua)paramVarArgs).c(paramVarArgs, paramString1, paramString3);
                  callbackOk(paramString2);
                }
                else
                {
              ...
              else if ("openDiyActionFloatView".equals(paramString3))
              {
                ...
                if ((paramVarArgs instanceof abua)) {
                  ((abua)paramVarArgs).jA(paramJsBridgeListener);
                } else {
                  callbackError(paramString2, acfp.m(2131702590));
                }
              }
              ...
              else if ("setCapsuleOpened".equals(paramString3))
              {
                ...
                else
                {
                  ...
                  super.sendRemoteReq(affz.a("ipc_apollo_setcapsule", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
                }
              }
              else if ("openBox".equals(paramString3))
              {
                ...
                if ((paramVarArgs instanceof abua))
                {
                  paramJsBridgeListener = ((abua)paramVarArgs).iH(paramJsBridgeListener);
                  super.callJs(paramString2 + "&&" + paramString2 + "(" + paramJsBridgeListener + ");");
                }
                else
                {
                  callbackError(paramString2, acfp.m(2131702596));
                }
              }
              else if ("setApolloViewVisibility".equals(paramString3))
              {
                ...
                this.mApolloViewContoller.If(i);
                callbackOk(paramString2);
              }
              else if ("initApolloView".equals(paramString3))
              {
                ...
                if ((this.mApolloViewContoller == null) && ((this.mRuntime.getWebView().getParent() instanceof RelativeLayout)))
                {
                  this.mApolloViewContoller = new abtv((RelativeLayout)this.mRuntime.getWebView().getParent(), null);
                ...
                if ((this.mRuntime.getWebView() instanceof TouchWebView))
                {
                  paramString1 = (TouchWebView)this.mRuntime.getWebView();
                  if (j <= 0) {
                    break label10081;
                  }
                ...
                bool1 = true;
                paramJsBridgeListener.disableTouchEvent(bool1);
                ...
                if (paramString3.roleId > 0) {
                  bool1 = ApolloUtil.ih(paramString3.roleId);
                }
                bool2 = bool1;
                if (paramJsBridgeListener != null)
                {
                ...
                if (!bool2)
                {
                  ...
                  super.sendRemoteReq(affz.a("ipc_apollo_check_avatar_res", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
                  this.mApolloViewContoller.b(true, paramString3.x, paramString3.y);
                }
                else
                {
              ...
              else if ("initAvatar".equals(paramString3))
              {
                ...
                if (!abua.class.isInstance(paramVarArgs))
                {
                  if (QLog.isColorLevel()) {
                  ...
                  if ((paramVarArgs instanceof BaseActivity))
                  {
                    ...
                    ApolloUtil.a(paramVarArgs, null, "share", this.mRuntime.getWebView().getUrl(), paramJsBridgeListener);
                  }
                ...
                if (((ApolloWebAvatarParam)localObject2).roleId > 0) {
                  bool1 = ApolloUtil.ih(((ApolloWebAvatarParam)localObject2).roleId);
                }
                paramJsBridgeListener = ((JSONObject)localObject1).optJSONArray("dressIds");
                ...
                if (i < k)
                {
                  ...
                  bool2 = ApolloUtil.ig(paramString1[i]);
                  break label10092;
                }
                ...
                if ((paramVarArgs instanceof abua))
                {
                  paramVarArgs = (abua)paramVarArgs;
                  if (i != 0)
                  {
                    if (QLog.isColorLevel()) {
                    ...
                    super.sendRemoteReq(affz.a("ipc_apollo_check_avatar_res", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
                    paramVarArgs.b(true, ((ApolloWebAvatarParam)localObject2).x, ((ApolloWebAvatarParam)localObject2).y);
                  }
                }
                for (;;)
                {
                  ...
                  super.sendRemoteReq(affz.a("ipc_apollo_update_avatar_info", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
                  break;
                  ...
                  callbackError(paramString2, acfp.m(2131702579));
                }
              }
                ...
                if ((paramJsBridgeListener != null) && (paramJsBridgeListener.length() > 0))
                {
                  ...
                  if ((TextUtils.isEmpty(paramString3.apolloId)) || (TextUtils.isEmpty(paramString3.uin)))
                  {
                    ...
                    if (j != 0)
                    {
                      ...
                      callbackError(paramString2, acfp.m(2131702582));
                    }
                  }
                  else
                  {
                  ...
                  {
                    paramJsBridgeListener = ((abua)paramVarArgs).p(paramString1);
                    super.callJs(paramString2 + "&&" + paramString2 + "(" + paramJsBridgeListener + ");");
                  }
                  else if (this.mApolloViewContoller != null)
                  {
                    paramJsBridgeListener = this.mApolloViewContoller.p(paramString1);
                    super.callJs(paramString2 + "&&" + paramString2 + "(" + paramJsBridgeListener + ");");
                  }
                  else
                  {
                    QLog.e("ApolloJsPlugin", 1, "addAvatar, controller null");
                    callbackError(paramString2, acfp.m(2131702594));
                  }
                }
                else
                {
                  QLog.e("ApolloJsPlugin", 1, "addAvatar, param list null");
                  callbackError(paramString2, acfp.m(2131702602));
                }
              }
              else if ("destroyAvatar".equals(paramString3))
              {
                ...
                if ((paramJsBridgeListener == null) || (paramJsBridgeListener.length() == 0))
                {
                  callbackError(paramString2, acfp.m(2131702591));
                }
                else
                {
                  ...
                  if ((paramVarArgs instanceof abua))
                  {
                    ((abua)paramVarArgs).du(paramString1);
                    callbackOk(paramString2);
                  }
                  else if (this.mApolloViewContoller != null)
                  {
                    this.mApolloViewContoller.du(paramString1);
                    callbackOk(paramString2);
                  }
                  else
                  {
                    QLog.e("ApolloJsPlugin", 1, "destroyAvatar, controller null");
                    callbackError(paramString2, acfp.m(2131702586));
                  }
                }
              }
              else if ("getRoleId".equals(paramString3))
              {
                if (!this.mDataInited)
                {
                  ...
                  super.sendRemoteReq(affz.a("ipc_apollo_get_apollo_data", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                  return true;
                }
              ...
              else if ("getLocalInfo".equals(paramString3))
              {
                ...
                {
                  callbackError(paramString2, acfp.m(2131702572));
                  if (QLog.isColorLevel()) {
              ...
              else if ("preview".equals(paramString3))
              {
                ...
                if ((paramVarArgs instanceof abua))
                {
                  ...
                  if ((paramJsBridgeListener != null) && (paramJsBridgeListener.length() > 0))
                  {
                    ...
                    if (i != 0)
                    {
                      paramJsBridgeListener = ((abua)paramVarArgs).d(paramString1);
                      super.callJs(paramString2 + "&&" + paramString2 + "(" + paramJsBridgeListener + ");");
                      if (QLog.isColorLevel()) {
                    ...
                    else
                    {
                      ...
                      super.sendRemoteReq(affz.a("ipc_apollo_preview", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
                    }
                  }
                  else
                  {
                ...
                {
                  callbackError(paramString2, acfp.m(2131702587));
                }
              }
              else if (("previewOnFrame".equals(paramString3)) || ("previewAction".equals(paramString3)))
              {
                ...
                super.sendRemoteReq(affz.a("ipc_apollo_preview_action", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
              }
              else if ("setup".equals(paramString3))
              {
                ...
                if ((paramVarArgs instanceof abua))
                {
                  ...
                  ((abua)paramVarArgs).b(this.mRoleId, this.mDressIds);
                  callbackOk(paramString2);
                  this.mReqBundle.clear();
                  ...
                  super.sendRemoteReq(affz.a("ipc_apollo_setup", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
                else
                {
                  callbackError(paramString2, acfp.m(2131702568));
                }
              }
              else if ("changeRole".equals(paramString3))
              {
                ...
                if ((j > 0) && (paramJsBridgeListener != null) && (paramJsBridgeListener.length() > 0))
                {
                  ...
                  this.mReqBundle.putString("apollo_userData", paramJsBridgeListener);
                  super.sendRemoteReq(affz.a("ipc_apollo_changerole", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
                }
                else
                {
                  callbackError(paramString2, acfp.m(2131702575));
                }
              }
              else if ("closeWebview".equals(paramString3))
              {
                super.sendRemoteReq(affz.a("ipc_kandian_hb_close_guid", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                paramVarArgs.finish();
                if (!(paramVarArgs instanceof abua)) {
              ...
              {
                this.mReqBundle.clear();
                super.sendRemoteReq(affz.a("ipc_apollo_get_openapollo_friends", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("sendActionToFrd".equals(paramString3))
              {
                ...
                paramString1 = new Intent(this.mRuntime.getActivity().getApplicationContext(), ForwardRecentActivity.class);
              ...
              {
                this.mReqBundle.clear();
                super.sendRemoteReq(affz.a("ipc_apollo_refresh_action", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                if (QLog.isColorLevel()) {
              ...
              {
                this.mReqBundle.clear();
                super.sendRemoteReq(affz.a("ipc_apollo_getfav_action", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                if (QLog.isColorLevel()) {
              ...
              else if ("addCustomAction".equals(paramString3))
              {
                ...
                super.sendRemoteReq(affz.a("ipc_apollo_add_fav_action", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                if (QLog.isColorLevel()) {
              ...
              else if ("delLocalFavAction".equals(paramString3))
              {
                ...
                super.sendRemoteReq(affz.a("ipc_apollo_del_fav_list", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                if (QLog.isColorLevel()) {
              ...
              else if ("writeLocalData".equals(paramString3))
              {
                ...
                super.sendRemoteReq(affz.a("ipc_apollo_write_local", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                if (QLog.isColorLevel()) {
              ...
              else if ("redbagCallback".equals(paramString3))
              {
                ...
                if (i == 1)
                {
                  ...
                  super.sendRemoteReq(affz.a("ipc_kandian_hb_lottery", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
              }
              else if ("removeBubble".equals(paramString3))
              {
                ...
                super.sendRemoteReq(affz.a("ipc_apollo_clear_bubble", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("downloadImageOnFrame".equals(paramString3))
              {
                ...
                this.mReqBundle.clear();
                this.mReqBundle.putInt("apollo_previewAction", i);
                super.sendRemoteReq(affz.a("ipc_apollo_downloadImageOnFrame", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
              }
              else if ("addGame".equals(paramString3))
              {
                this.mReqBundle.clear();
                this.mReqBundle.putString("gameListJson", ((JSONObject)localObject1).toString());
                super.sendRemoteReq(affz.a("ipc_apollo_add_game", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("delGame".equals(paramString3))
              {
                this.mReqBundle.clear();
                this.mReqBundle.putString("gameListJson", ((JSONObject)localObject1).toString());
                super.sendRemoteReq(affz.a("ipc_apollo_del_game", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("updateGameList".equals(paramString3))
              {
                ...
                this.mReqBundle.clear();
                this.mReqBundle.putString("gameListJson", ((JSONObject)localObject1).toString());
                super.sendRemoteReq(affz.a("ipc_apollo_update_game_list", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("isCmFaceAdded".equals(paramString3))
              {
                ...
                if ((paramJsBridgeListener != null) && (paramJsBridgeListener.length() > 0))
                {
                  ...
                  super.sendRemoteReq(affz.a("ipc_apollo_is_cm_face_added", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
                else
                {
                  paramJsBridgeListener = new JSONObject();
                  paramJsBridgeListener.put("result", 1);
                  paramJsBridgeListener.put("msg", acfp.m(2131702564));
                  super.callJs(paramString2 + "&&" + paramString2 + "(" + paramJsBridgeListener.toString() + ");");
                }
              }
              else if ("addCmFace".equals(paramString3))
              {
                ...
                {
                  this.mReqBundle.putString("faceIdList", paramJsBridgeListener.toString());
                  super.sendRemoteReq(affz.a("ipc_apollo_add_cm_face", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
                else
                {
                  paramJsBridgeListener = new JSONObject();
                  paramJsBridgeListener.put("result", 1);
                  paramJsBridgeListener.put("msg", acfp.m(2131702581));
                  super.callJs(paramString2 + "&&" + paramString2 + "(" + paramJsBridgeListener.toString() + ");");
                }
              }
              else if ("downloadTbs".equals(paramString3))
              {
                ...
                if ((paramJsBridgeListener instanceof BrowserAppInterface)) {
                  ((BrowserAppInterface)paramJsBridgeListener).Ep(true);
                }
              }
              else if ("setLeftViewIcon".equals(paramString3))
              {
                ...
                if (!TextUtils.isEmpty(paramString1))
                {
                  paramJsBridgeListener = (arcd)super.getBrowserComponent(2);
                  if ((paramJsBridgeListener != null) && (paramJsBridgeListener.a != null) && (paramJsBridgeListener.a.leftView != null))
                  {
                    paramString3 = URLDrawable.URLDrawableOptions.obtain();
                    paramString3.mLoadingDrawable = paramVarArgs.getResources().getDrawable(2130851758);
                    paramString1 = URLDrawable.getDrawable(paramString1, paramString3);
                    paramString1.startDownload();
                    paramJsBridgeListener.a.leftView.setBackgroundDrawable(paramString1);
                  }
                }
              }
              ...
              {
                abhh.a(((JSONObject)localObject1).optInt("gameId"), ((JSONObject)localObject1).optString("extraInfo"), this.mRuntime.getActivity());
              }
              else if ("createShortcut".equals(paramString3))
              {
                ApolloGameUtil.bX(((JSONObject)localObject1).optInt("src"), ((JSONObject)localObject1).optString("name"));
                callbackOk(paramString2);
              }
              else if ("openCmGameMatch".equals(paramString3))
              {
                ...
                super.sendRemoteReq(affz.a("ipc_open_cm_game_match_page", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("isTcpConnected".equals(paramString3))
              {
                this.mReqBundle.clear();
                super.sendRemoteReq(affz.a("ipc_cm_game_conn_connected", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("checkCmGameWebView".equals(paramString3))
              {
                if ((paramVarArgs instanceof QQBrowserActivity))
                {
                  paramJsBridgeListener = ((QQBrowserActivity)paramVarArgs).c();
                  paramString1 = getAbsoluteUrl();
                  if ((!(paramJsBridgeListener instanceof CmGameFragment)) && (!TextUtils.isEmpty(paramString1)))
                  {
                    ...
                    callbackOk(paramString2);
                    paramVarArgs.finish();
                    abmt.bo(paramVarArgs, paramString1);
                  }
                  else
                  {
              ...
              else if ("sendGameAppArkMessage".equals(paramString3))
              {
                ...
                if ((!TextUtils.isEmpty(paramJsBridgeListener)) && (paramString1 != null))
                {
                  ...
                  super.sendRemoteReq(affz.a("ipc_open_cm_game_send_game_app_ark_msg", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
                else
                {
              ...
              else
              {
                ...
                if ((!TextUtils.isEmpty(paramVarArgs)) && (!TextUtils.isEmpty(paramJsBridgeListener)) && (!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString3)))
                {
                  ...
                  super.sendRemoteReq(affz.a("ipc_save_game_to_plus", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
                else
                {
                  callbackError(paramString2, "param error");
      ...
      for (i = 1;; i = 0)
      {
        ...
        QLog.d("ApolloJsPlugin", 2, new Object[] { "isX86:", Boolean.valueOf(ApolloGameUtil.yl()) });
        break;
      }
    }
  ...
  public void onDestroy()
  {
    ...
    if (this.mApolloViewContoller != null) {
      this.mApolloViewContoller.onDestroy();
    }
  ...
  protected void onResponse(Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && (paramBundle.getInt("respkey", 0) == this.mOnRemoteResp.key))
    {
      ...
      if ((localObject3 != null) && (localObject2 != null))
      {
        ...
        callbackError(str, acfp.m(2131702560));
      }
    }
    return;
    label101:
    ...
    do
    {
        ...
        do
        {
          for (;;)
          {
            ...
            catch (Throwable paramBundle)
            {
              ...
              callbackError(str, acfp.m(2131702565));
              return;
            }
            callbackError(str, i + "");
            return;
            ...
            if ("ipc_apollo_preview".equals(localObject3))
            {
              ...
              {
                callbackError(str, acfp.m(2131702566));
                return;
              }
              if (this.mApolloViewContoller != null)
              {
                paramBundle = this.mApolloViewContoller.d(paramBundle);
                super.callJs(str + "&&" + str + "(" + paramBundle + ");");
                if (QLog.isColorLevel()) {
                  QLog.e("ApolloJsPlugin", 2, "callbackId->" + str + " callbackOk" + paramBundle);
                }
              }
              else if ((localObject1 instanceof abua))
              {
                paramBundle = ((abua)localObject1).d(paramBundle);
                super.callJs(str + "&&" + str + "(" + paramBundle + ");");
                if (QLog.isColorLevel()) {
                  QLog.e("ApolloJsPlugin", 2, "callbackId->" + str + " callbackOk" + paramBundle);
                }
              ...
              {
                callbackError(str, acfp.m(2131702577));
              }
            }
            else
            {
              ...
              if (("ipc_apollo_preview_action".equals(localObject3)) || ("ipc_apollo_preview_audio_action".equals(localObject3)))
              {
                ...
                localObject2 = new abtv.b();
                ((abtv.b)localObject2).playCount = i5;
                ((abtv.b)localObject2).crP = i;
                ((abtv.b)localObject2).actionType = m;
                ((abtv.b)localObject2).crQ = n;
                ((abtv.b)localObject2).vipLevel = i1;
                ((abtv.b)localObject2).crR = j;
                ((abtv.b)localObject2).crS = k;
                ((abtv.b)localObject2).feeType = i2;
                ((abtv.b)localObject2).crT = i9;
                ((abtv.b)localObject2).crU = i3;
                ((abtv.b)localObject2).textType = i4;
                ((abtv.b)localObject2).text = ((String)localObject6);
                ((abtv.b)localObject2).playOriginalAudio = i6;
                ((abtv.b)localObject2).audioId = i7;
                ((abtv.b)localObject2).audioStartTime = f1;
                ((abtv.b)localObject2).sK = f2;
                ((abtv.b)localObject2).bFz = bool1;
                ((abtv.b)localObject2).title = paramBundle;
                ((abtv.b)localObject2).subTitle = ((String)localObject4);
                ((abtv.b)localObject2).apolloId = ((String)localObject7);
                ((abtv.b)localObject2).bFA = bool2;
                if ((i8 == 0) && (i > 0))
                {
                  if ("ipc_apollo_preview_audio_action".equals(localObject3))
                  {
                    paramBundle = abtv.iJ("ApolloViewController is null or Activity not instanceof IApolloActivityJsCallBack");
                    if (this.mApolloViewContoller != null)
                    {
                      paramBundle = this.mApolloViewContoller.a((abtv.b)localObject2);
                      super.callJs(str + "&&" + str + "(" + paramBundle + ");");
                    }
                    while (QLog.isColorLevel())
                    {
                      ...
                      return;
                      if ((localObject1 instanceof abua))
                      {
                        paramBundle = ((abua)localObject1).a((abtv.b)localObject2);
                        super.callJs(str + "&&" + str + "(" + paramBundle + ");");
                      }
                    }
                  }
                  ...
                  {
                    localObject3 = new File(abto.di(i7));
                    if ((i7 > 0) && (!((File)localObject3).exists()))
                    {
                      ...
                      super.sendRemoteReq(affz.a("ipc_apollo_preview_audio_action", str, this.mOnRemoteResp.key, this.mReqBundle), true, true);
                      return;
                    }
                    paramBundle = abtv.iJ("ApolloViewController is null or Activity not instanceof IApolloActivityJsCallBack");
                    if ((localObject1 instanceof abua))
                    ...
                    while (QLog.isColorLevel())
                    {
                      ...
                      {
                        callbackError(str, acfp.m(2131702595));
                      }
                    }
                  }
                }
                else {
                  callbackError(str, acfp.m(2131702592) + (String)localObject3);
                }
              }
              else if ("ipc_apollo_check_avatar_res".equals(localObject3))
              {
                ...
                if (i == 0)
                {
                  ...
                  {
                    callbackError(str, acfp.m(2131702571));
                    return;
                  }
                    ...
                    if (this.mValidAvatarIdList.contains(((ApolloWebAvatarParam)localObject2).apolloId))
                    {
                      ...
                      for (;;)
                      {
                        ...
                        if (j == 0)
                        {
                          ...
                          paramBundle = ((abua)localObject1).a(this.mApolloStatus, (ApolloWebAvatarParam)localObject2);
                        }
                      }
                    }
                  ...
                  paramBundle = null;
                  if ((this.mRuntime.getActivity() instanceof BaseActivity)) {
                    paramBundle = ((BaseActivity)this.mRuntime.getActivity()).getAppInterface();
                  }
                  if (paramBundle != null)
                  {
                    abto.a(paramBundle, ((ApolloWebAvatarParam)localObject2).uin, new ApolloJsPlugin.4(this, (ApolloWebAvatarParam)localObject2, (Activity)localObject1, j, str), ((ApolloWebAvatarParam)localObject2).roleId, ((ApolloWebAvatarParam)localObject2).dressIds, -1, -1, false);
                    return;
                  }
                    ...
                    while (((Iterator)localObject4).hasNext())
                    {
                      ...
                      if (((ApolloWebAvatarParam)localObject5).isResExist)
                      {
                        ...
                        if (this.mValidAvatarIdList.contains(((ApolloWebAvatarParam)localObject5).apolloId))
                        {
                          ...
                          ((abua)localObject1).p((ArrayList)localObject6);
                        }
                        for (;;)
                        {
                          ...
                          break;
                          if (this.mApolloViewContoller != null) {
                            this.mApolloViewContoller.p((ArrayList)localObject6);
                          }
                        }
                      }
                      if (paramBundle != null)
                      {
                        abto.a(paramBundle, ((ApolloWebAvatarParam)localObject5).uin, new ApolloJsPlugin.5(this, (ApolloWebAvatarParam)localObject5, (Activity)localObject1, (AtomicInteger)localObject2, (ArrayList)localObject3, str), ((ApolloWebAvatarParam)localObject5).roleId, ((ApolloWebAvatarParam)localObject5).dressIds, -1, -1, false);
                      }
                      else
                      {
                        QLog.e("ApolloJsPlugin", 1, new Object[] { "addAvatar, app null, uin=", ApolloUtil.iY(((ApolloWebAvatarParam)localObject5).uin) });
                        ((AtomicInteger)localObject2).getAndIncrement();
                        if (((AtomicInteger)localObject2).get() == ((ArrayList)localObject3).size()) {
                          callbackOk(str);
                        }
                ...
                {
                  if (j != 2) {
                    QQToast.a((Context)localObject1, acfp.m(2131702559), 1).show();
                  }
                  callbackError(str, acfp.m(2131702569));
                  if (QLog.isColorLevel()) {
              ...
              else
              {
                if ("ipc_apollo_changerole".equals(localObject3))
                {
                  ...
                  callbackError(str, acfp.m(2131702555));
                  return;
                }
                if ("ipc_apollo_get_apollo_data".equals(localObject3))
                {
                  ...
                  for (;;)
                  {
                    if (3 == i)
                    {
                      if ((this.mDressIds == null) || (this.mDressIds.length <= 0))
                      {
                        callbackError(str, acfp.m(2131702597));
                        if (!QLog.isColorLevel()) {
                          break;
                        }
                        QLog.d("ApolloJsPlugin", 2, "dressIds.array->默认角色或获取本人信息失败");
                  ...
                  if (2 == i)
                  {
                    if (this.mRoleId <= 0)
                    {
                      callbackError(str, acfp.m(2131702576));
                      return;
                    }
                    paramBundle = new JSONObject();
                    paramBundle.put("result", 0);
                ...
                else
                {
                  ...
                  while (QLog.isColorLevel())
                  {
                    ...
                    return;
                    if (i == 1) {
                      callbackError(str, acfp.m(2131702574));
                    } else if (i == 2) {
                      callbackError(str, acfp.m(2131702583));
                    } else {
                      callbackError(str, acfp.m(2131702570));
                    }
                  }
                }
              }
      ...
      } while (!(localObject1 instanceof abua));
      ((abua)localObject1).iI(str);
      return;
    ...
    if ("ipc_apollo_start_apollo_game".equals(localObject3))
    {
      ...
      callbackError(str, acfp.m(2131702588));
      return;
    }
    if ("ipc_apollo_choose_friend_play_game".equals(localObject3))
    {
      ...
      {
        this.gameDialog = aqha.a((Context)localObject1, 0, "", acfp.m(2131702558), 2131721058, 2131721079, new ApolloJsPlugin.6(this, i, j, (Activity)localObject1), new ApolloJsPlugin.7(this));
      ...
      paramBundle = new ApolloPanel.b();
      paramBundle.gameId = i;
      abxt.a(paramBundle, this.mRuntime.getActivity(), 2);
      return;
    }
    if ("IPC_APOLLO_DOWNLOAD_GAME".equals(localObject3))
    {
      ...
      if (paramBundle == null)
      {
        callbackError(str, acfp.m(2131702599));
        return;
      }
    ...
    extends BroadcastReceiver
  {
    ...
    public void onApolloJsCreated(ApolloJsPlugin paramApolloJsPlugin)
    {
      ...
      if (this.mJsList.isEmpty())
      {
        ...
        BaseApplicationImpl.getContext().registerReceiver(this, (IntentFilter)localObject, "com.tencent.tim.msg.permission.pushnotify", null);
      ...
      if (i < this.mJsList.size())
      {
        ...
        if ((localObject == null) || (((ApolloJsPlugin)localObject).mRuntime == null) || (paramApolloJsPlugin.mRuntime == null) || (((ApolloJsPlugin)localObject).mRuntime.getActivity() != paramApolloJsPlugin.mRuntime.getActivity())) {}
      }
      for (i = 1;; i = 0)
      {
        if (i == 0) {
          ...
          try
          {
            ...
            if (!this.mJsList.isEmpty())
            {
              ...
              while (i >= 0)
              {
                ...
                {
                  CustomWebView localCustomWebView = localApolloJsPlugin.mRuntime.getWebView();
