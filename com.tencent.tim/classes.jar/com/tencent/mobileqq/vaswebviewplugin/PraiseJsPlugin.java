  ...
  extends VasWebviewJsPlugin
{
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    do
    {
      ...
      if ("queryLocal".equals(paramString3))
      {
        ...
        paramString1 = affz.a("queryPraiseLocal", paramString1, this.mOnRemoteResp.key, new Bundle());
        try
        {
    ...
    super.sendRemoteReq(affz.a("setupPraise", paramString1, this.mOnRemoteResp.key, this.mReqBundle), false, true);
    return true;
  }
  ...
  protected void onResponse(Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && (paramBundle.getInt("respkey", 0) == this.mOnRemoteResp.key))
    {
      ...
      if (localObject != null) {
        ((Bundle)localObject).setClassLoader(this.mRuntime.getActivity().getClassLoader());
      }
      if (QLog.isColorLevel()) {
