  ...
  extends VasWebviewJsPlugin
{
  ...
  {
    int i = aqiw.getSystemNetwork(this.mRuntime.getActivity());
    try
    {
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("openSettings".equals(paramString3))
    {
      ...
      super.sendRemoteReq(affz.a("ipc_open_settings", paramString1, this.mOnRemoteResp.key, paramString2), false, true);
      return true;
    }
  ...
  public void openPage(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      VasWebviewUtil.openQQBrowserWithoutAD(this.mRuntime.getActivity(), str, this.mRuntime.getActivity().getIntent().getIntExtra("business", 0), localIntent, false, -1);
      paramJSONObject = new JSONObject();
  ...
  public void openWebView(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      paramJSONObject.setClass(this.mRuntime.getActivity(), QQBrowserActivity.class);
      this.mRuntime.getActivity().startActivity(paramJSONObject);
      paramJSONObject = new JSONObject();
      paramJSONObject.put("result", 0);
      paramJSONObject.put("message", "ok");
      super.callJs(paramString + "(" + paramJSONObject.toString() + ");");
  ...
  public void saveImage(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      paramString.append("&uin=" + ((AppActivity)this.mRuntime.getActivity()).getAppRuntime().getAccount());
      paramJSONObject = afgc.insertMtype("VIP_xingying", paramString.toString());
      if (QLog.isColorLevel()) {
        QLog.i("CommonJsHandler", 2, "CommonJsHandler saveImage imageUrl=" + paramJSONObject);
      }
      paramString = System.currentTimeMillis() + ".jpg";
      ThreadManager.executeOnNetWorkThread(new ThemeAndBubbleCommonJsPlugin.5(this, paramJSONObject, new File(acbn.oM, paramString)));
      return;
    }
    catch (Exception paramJSONObject)
    {
  ...
  public void showMsgBox(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      if (paramJSONObject.length >= 1)
      {
        ...
        ((aqkf)localObject).a(paramJSONObject[0], new ThemeAndBubbleCommonJsPlugin.1(this, paramString));
        if (paramJSONObject.length >= 2) {
          ((aqkf)localObject).b(paramJSONObject[1], new ThemeAndBubbleCommonJsPlugin.2(this, paramString));
        }
        if (paramJSONObject.length >= 3) {
          ((aqkf)localObject).c(paramJSONObject[2], new ThemeAndBubbleCommonJsPlugin.3(this, paramString));
        }
        ((aqkf)localObject).setCanceledOnTouchOutside(false);
        ((aqkf)localObject).setOnKeyListener(new ThemeAndBubbleCommonJsPlugin.4(this, (aqkf)localObject, paramString));
  ...
  {
    Object localObject = new Intent(this.mRuntime.getActivity(), EmosmActivity.class);
