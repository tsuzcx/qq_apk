    ...
    public void update(Observable paramObservable, Object paramObject)
    {
      ...
      if (MiniAppTextArea.this.curWebviewContainer != null) {
        try
        {
          ...
          {
            if (((!"confirm".equals((String)paramObject)) && (!"hideKeyboard".equals((String)paramObject))) || ((MiniAppTextArea.this.isFocused()) || ("hideInput".equals((String)paramObject))))
            {
              MiniAppTextArea.access$802(MiniAppTextArea.this, false);
              if ((MiniAppTextArea.this.curWebviewContainer != null) && (MiniAppTextArea.this.curWebviewContainer.appBrandRuntime != null) && (MiniAppTextArea.this.curWebviewContainer.appBrandRuntime.getCurPage() != null)) {
              ...
              MiniAppTextArea.this.hideCurrentInput((String)paramObject);
              MiniAppTextArea.access$902(MiniAppTextArea.this, 0);
              MiniAppTextArea.access$1102(MiniAppTextArea.this, 0);
            }
          }
          else if ((paramObject instanceof Integer))
          {
            MiniAppTextArea.access$302(MiniAppTextArea.this, (int)(Integer.valueOf(String.valueOf(paramObject)).intValue() * DisplayUtil.getDensity(MiniAppTextArea.this.getContext())));
            if ((DisplayUtil.hasNavBar(MiniAppTextArea.this.curWebviewContainer.appBrandRuntime.activity)) && (DisplayUtil.isNavigationBarExist(MiniAppTextArea.this.curWebviewContainer.appBrandRuntime.activity))) {
              MiniAppTextArea.access$302(MiniAppTextArea.this, MiniAppTextArea.this.showKeyboardHeight + DisplayUtil.getNavigationBarHeight(MiniAppTextArea.this.curWebviewContainer.appBrandRuntime.activity));
            }
            ...
            if (MiniAppTextArea.this.isFocused())
            {
              ...
              {
                j = MiniAppTextArea.this.screenHeight;
                int k = MiniAppTextArea.this.showKeyboardHeight;
                int m = MiniAppTextArea.this.confirmHeight;
                MiniAppTextArea.this.curWebviewContainer.appBrandRuntime.getCurPage().showKeyBoardConfirmView(j - k - m);
              }
              MiniAppTextArea.this.curWebviewContainer.appBrandRuntime.jsPluginEngine.setCurInputId(MiniAppTextArea.this.curInputId);
              paramObservable = new JSONObject();
              paramObservable.put("inputId", MiniAppTextArea.this.curInputId);
              int j = MiniAppTextArea.this.showKeyboardHeight;
              if (MiniAppTextArea.this.hasConfirm) {
                i = MiniAppTextArea.this.confirmHeight;
              }
              paramObservable.put("height", (int)((i + j) / DisplayUtil.getDensity(MiniAppTextArea.this.getContext()) + 0.5F));
              MiniAppTextArea.this.curWebviewContainer.getPageWebview().evaluateSubcribeJS("onKeyboardShow", paramObservable.toString(), MiniAppTextArea.this.curWebviewContainer.getPageWebview().pageWebviewId);
              return;
            }
          }
        }
