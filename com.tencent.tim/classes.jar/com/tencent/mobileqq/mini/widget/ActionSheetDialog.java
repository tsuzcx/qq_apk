  ...
  implements DialogInterface.OnCancelListener
{
  ...
  private void init()
  {
    ...
    this.backgroundLayout = ((RelativeLayout)findViewById(2131363236));
  }
  ...
  private void prepareContentViews()
  {
    ...
    if (k < m)
    {
      ...
      for (;;)
      {
        ...
        i = 2130837661;
        break label63;
        j = this.mContext.getResources().getColor(2131165625);
        ((Button)localObject1).setTextSize(0, this.mContext.getResources().getDimension(2131299578));
        ...
        Object localObject3 = this.mContext.getResources().getDrawable(2130850175);
    ...
    {
      localObject1 = this.mInflater.inflate(2131558465, null);
      ...
      ((Button)localObject2).setText(2131721058);
  ...
  public Button addButton(String paramString, int paramInt1, int paramInt2, View.OnClickListener paramOnClickListener)
  {
    ...
    try
    {
      ...
      localLayoutParams.height = ((int)this.mContext.getResources().getDimension(2131296886));
      localButton.setLayoutParams(localLayoutParams);
      localButton.setTextSize(0, this.mContext.getResources().getDimension(2131299577));
  ...
  public TextView addTitle(String paramString)
  {
    try
    {
      ...
      localLayoutParams.gravity = 17;
      localButton.setLayoutParams(localLayoutParams);
      localButton.setTextSize(0, this.mContext.getResources().getDimension(2131299578));
      localButton.setText(paramString);
      localButton.setTextColor(this.mContext.getResources().getColor(2131165625));
      localButton.setBackgroundResource(2130837675);
  ...
  public void setAddImageButtonText(Button paramButton)
  {
    if (paramButton != null)
    {
      ...
      Drawable localDrawable = this.mContext.getResources().getDrawable(2130850175);
