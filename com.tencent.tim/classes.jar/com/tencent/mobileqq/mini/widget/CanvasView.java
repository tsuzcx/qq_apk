  ...
  extends CoverView
{
    ...
    throws Exception
  {
    ...
    if (i < paramJSONArray.length())
    {
      ...
      if ("drawImage".equals(localObject1))
      {
        ...
        else if (!aqmr.isEmpty((String)localObject6))
        {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        if (!aqmr.isEmpty((String)localObject6))
        {
      ...
      for (f1 = f2;; f1 = f2)
      {
        ...
        if ("setShadow".equals(localObject4))
        {
          ...
          f3 = mpx2px(((JSONArray)localObject7).optDouble(1, 0.0D));
          ((ShadowLayer)localObject4).radius = f1;
          ((ShadowLayer)localObject4).dx = f2;
          ((ShadowLayer)localObject4).dy = f3;
          ((ShadowLayer)localObject4).color = getColor((JSONArray)localObject6);
          this.mFillPaint.setShadowLayer(((ShadowLayer)localObject4).radius, ((ShadowLayer)localObject4).dx, ((ShadowLayer)localObject4).dy, ((ShadowLayer)localObject4).color);
          this.mStrokePaint.setShadowLayer(((ShadowLayer)localObject4).radius, ((ShadowLayer)localObject4).dx, ((ShadowLayer)localObject4).dy, ((ShadowLayer)localObject4).color);
          break;
        }
  ...
  protected void onAttachedToWindow()
  {
    ...
    try
    {
      Object localObject = aqfo.getSystemProperty("ro.vivo.os.version");
