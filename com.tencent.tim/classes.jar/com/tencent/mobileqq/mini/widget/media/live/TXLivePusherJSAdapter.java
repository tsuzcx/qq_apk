  ...
  implements TXLivePushListenerReflect.ITXLivePushListener, TXLivePushListenerReflect.OnBGMNotify
{
  ...
  {
    awcj.callSpecifiedMethod(paramObject, "disableLog", false, awcj.getParamsClass(new Class[] { Boolean.TYPE }), new Object[] { paramBoolean });
  }
  
  private void txCloudVideoView_setVisibility(int paramInt, Object paramObject)
  {
    awcj.callSpecifiedMethod(paramObject, "setVisibility", false, awcj.getParamsClass(new Class[] { Integer.TYPE }), new Object[] { Integer.valueOf(paramInt) });
  }
