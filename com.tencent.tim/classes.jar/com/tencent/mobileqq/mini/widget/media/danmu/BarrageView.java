  ...
  implements Comparator<Barrage>
{
  ...
  {
    Animation localAnimation = AnimationHelper.createTranslateAnim(getContext(), paramInt, -aqnm.getScreenWidth());
  ...
  class RemoveViewOnEndAnimListenerAdapter
    implements Animation.AnimationListener
  {
    private final View view;
    
    private RemoveViewOnEndAnimListenerAdapter(View paramView)
    {
      this.view = paramView;
    }
