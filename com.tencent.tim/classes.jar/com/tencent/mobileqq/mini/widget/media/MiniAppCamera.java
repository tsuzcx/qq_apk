  ...
  extends GlCameraHolderSurfaceView
{
  ...
  private void execCommand(String paramString1, String paramString2, String paramString3, WebviewContainer paramWebviewContainer, String paramString4, int paramInt)
  {
    ...
    paramWebviewContainer.showLoading(acfp.m(2131708358));
    ...
    throws IOException
  {
    ...
    //   0: bipush 100
    //   2: istore_3
    //   3: new 378	java/io/BufferedOutputStream
    //   6: dup
    //   7: new 380	java/io/FileOutputStream
    //   10: dup
    //   11: aload_1
    //   12: invokespecial 383	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   15: invokespecial 386	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   18: astore 5
    //   20: ldc_w 388
    //   23: aload_2
    //   24: invokevirtual 392	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   27: ifeq +58 -> 85
    //   30: bipush 80
    //   32: istore_3
    //   33: aload_0
    //   34: getstatic 398	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   37: bipush 100
    //   39: iload_3
    //   40: invokestatic 404	java/lang/Math:min	(II)I
    //   43: aload 5
    //   45: invokevirtual 410	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   48: pop
    //   49: aload 5
    //   51: invokevirtual 413	java/io/BufferedOutputStream:flush	()V
    //   54: aload_1
    //   55: invokevirtual 418	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   58: aload_1
    //   59: invokevirtual 418	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   62: getstatic 44	com/tencent/mobileqq/mini/widget/media/MiniAppCamera:cameraWidth	I
    //   65: getstatic 46	com/tencent/mobileqq/mini/widget/media/MiniAppCamera:cameraHeight	I
    //   68: iload_3
    //   69: invokestatic 424	aqhu:compressImageJpg	(Ljava/lang/String;Ljava/lang/String;III)Ljava/lang/String;
    //   72: astore_0
    //   73: aload 5
    //   75: ifnull +8 -> 83
    //   78: aload 5
    //   80: invokevirtual 427	java/io/BufferedOutputStream:close	()V
    //   83: aload_0
    //   84: areturn
    //   85: ldc_w 429
    //   88: aload_2
    //   89: invokevirtual 392	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   92: istore 4
    //   94: iload 4
    //   96: ifeq -63 -> 33
    //   99: bipush 60
    ...
    //   109: ifnull +7 -> 116
    //   112: aload_1
    //   113: invokevirtual 427	java/io/BufferedOutputStream:close	()V
    //   116: aload_0
    //   117: athrow
    //   118: astore_1
    //   119: aload_0
