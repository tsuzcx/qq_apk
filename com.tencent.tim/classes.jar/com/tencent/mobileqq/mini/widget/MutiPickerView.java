  ...
  implements DialogInterface.OnCancelListener, View.OnClickListener
{
  ...
  {
    paramContext = LayoutInflater.from(paramContext).inflate(2131559679, null);
    ...
    this.mMutiPickerContainer = ((LinearLayout)paramContext.findViewById(2131372135));
    this.mCancelTextView = ((TextView)paramContext.findViewById(2131372136));
    this.mCancelTextView.setOnClickListener(this);
    this.mConfirmTextView = ((TextView)paramContext.findViewById(2131372137));
