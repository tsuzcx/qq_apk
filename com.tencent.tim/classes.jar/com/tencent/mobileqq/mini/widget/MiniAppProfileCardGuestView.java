...
{
  private IntimatePlayTogetherMiniGameCardView.a adapter;
  ...
  private void init(Context paramContext)
  {
    ...
    this.mRecyclerView = ((RecyclerView)findViewById(2131367706));
  ...
  public void setData(List<MISC.StAppPlayingInfo> paramList, String paramString1, String paramString2)
  {
    ...
    if (this.mRecyclerView != null)
    {
      ...
      this.adapter = new IntimatePlayTogetherMiniGameCardView.a(paramList, paramString2, paramString1);
      this.adapter.Pl(2062);
  ...
  public void setTextColor(int paramInt)
  {
    ...
    this.adapter.setTextColor(paramInt);
  }
  ...
  public void setTextColor(ColorStateList paramColorStateList)
  {
    ...
    this.adapter.setTextColor(paramColorStateList);
  }
}
