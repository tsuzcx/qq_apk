  ...
  implements View.OnClickListener
{
  ...
  private void sendDelRequest(int paramInt)
  {
    if ((getActivity() != null) && (!getActivity().isFinishing()))
    {
      ...
      localaqju.setContentView(2131559131);
      localaqju.setTitle("确认删除此号码？").setMessage("").setPositiveButton("确定", new PhoneNumberManagementFragment.3(this, paramInt)).setNegativeButton("取消", new PhoneNumberManagementFragment.2(this));
      localaqju.show();
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((getActivity() != null) && (!getActivity().isFinishing()))
      {
        ...
        PublicFragmentActivity.b.startForResult(getActivity(), localIntent, PublicFragmentActivityForMini.class, AddPhoneNumberFragment.class, 1090);
      }
    }
  }
  ...
  {
    paramLayoutInflater = LayoutInflater.from(getActivity()).inflate(2131559602, null);
  ...
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    this.mPhoneNumberLayout1 = ((RelativeLayout)paramView.findViewById(2131371637));
    this.mPhoneNumberText1 = ((TextView)paramView.findViewById(2131371644));
    this.mPhoneNumberLayout2 = ((RelativeLayout)paramView.findViewById(2131371638));
    this.mPhoneNumberText2 = ((TextView)paramView.findViewById(2131371645));
    this.mDelPhoneNmber2 = ((TextView)paramView.findViewById(2131371640));
    this.mDelPhoneNmber2.setOnClickListener(this);
    this.mPhoneNumberLayout3 = ((RelativeLayout)paramView.findViewById(2131371639));
    this.mPhoneNumberText3 = ((TextView)paramView.findViewById(2131371646));
    this.mDelPhoneNmber3 = ((TextView)paramView.findViewById(2131371641));
    this.mDelPhoneNmber3.setOnClickListener(this);
    this.mOperatePhoneNumberLayout = ((RelativeLayout)paramView.findViewById(2131371647));
    this.mOperatePhoneNumberLayout.setOnClickListener(this);
    this.mPhoneNumberMaxInfo = ((TextView)paramView.findViewById(2131371636));
    updateView();
  }
}
