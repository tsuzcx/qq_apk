  ...
  extends PublicBaseFragment
{
  ...
  {
    paramLayoutInflater = LayoutInflater.from(getActivity()).inflate(2131559574, null);
  ...
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    this.mLeftBtnView = ((ImageView)paramView.findViewById(2131371650));
    this.mSendSmsCodeBtn = ((Button)paramView.findViewById(2131371540));
    this.mSendSmsCodeBtn.setText("获取验证码");
    this.mSendSmsCodeBtn.setTextColor(Color.parseColor("#B0B3BF"));
    this.mSendSmsCodeBtn.setEnabled(false);
    this.mSendSmsCodeBtn.setClickable(false);
    this.mPhoneNumberLayout = ((RelativeLayout)paramView.findViewById(2131371539));
    this.mPhoneNumberEditText = ((EditText)paramView.findViewById(2131371542));
    this.mSmsCodeLayout = ((RelativeLayout)paramView.findViewById(2131371550));
    this.mSmsCodeEditText = ((EditText)paramView.findViewById(2131371551));
    this.mSaveSwitch = ((Switch)paramView.findViewById(2131371548));
    this.mSaveSwitch.setChecked(false);
    this.mCommitBtn = ((Button)paramView.findViewById(2131371541));
