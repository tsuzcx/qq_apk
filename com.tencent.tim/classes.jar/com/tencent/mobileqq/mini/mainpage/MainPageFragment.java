...
{
  private static final String LIKE_NUM_POSTFIX = acfp.m(2131708016);
  ...
  private android.graphics.drawable.Drawable getIconDrawable(String paramString)
  {
    ...
    //   9: ldc 129
    //   11: invokestatic 135	aqnm:dpToPx	(F)I
    //   14: istore_2
    //   15: aload_3
    //   16: iload_2
    ...
    //   67: iload_2
    //   68: ldc 170
    //   70: invokestatic 135	aqnm:dpToPx	(F)I
    //   73: invokestatic 176	aqbn:d	(III)[I
    //   76: invokevirtual 180	com/tencent/image/URLDrawable:setTag	(Ljava/lang/Object;)V
    //   79: aload_3
    //   80: getstatic 184	aqbn:a	Lcom/tencent/image/DownloadParams$DecodeHandler;
  ...
  private void handleMoreButtonEvent()
  {
    ...
    this.mMiniAppDialog.setContentView(LayoutInflater.from(getActivity()).inflate(2131562576, null));
    TextView localTextView = (TextView)this.mMiniAppDialog.findViewById(2131371839);
    localTextView.setText(acfp.m(2131708008));
    localTextView.setOnClickListener(this);
    localTextView = (TextView)this.mMiniAppDialog.findViewById(2131371833);
    localTextView.setText(acfp.m(2131708003));
    localTextView.setVisibility(0);
    localTextView.setOnClickListener(this);
    ((TextView)this.mMiniAppDialog.findViewById(2131371815)).setOnClickListener(this);
  ...
  private void initUI()
  {
    if (this.mMiniAppInfo != null)
    {
      ...
      if ((bool) || (this.mMiniAppInfo.isLimitedAccessApp()))
      {
        if (getView() != null)
        {
          View localView = getView().findViewById(2131378112);
          if (localView != null) {
    ...
    if (this.isMiniGame)
    {
      this.mSetTopText.setText(acfp.m(2131708007));
      this.mRecommendMiniAppBtn.setText(acfp.m(2131708010));
      this.mEnterMiniAppBtn.setText(acfp.m(2131708006));
      this.mLikeNum.setText(acfp.m(2131708012));
      return;
    }
    if (aekv.needShowMiniAppFullScreen()) {
      this.mSetTopText.setText(acfp.m(2131708007));
    }
    this.mLikeNum.setText(acfp.m(2131708015));
  }
  ...
  public static void launch(Context paramContext, MiniAppConfig paramMiniAppConfig, int paramInt)
  {
    ...
    PublicFragmentActivity.b.start(paramContext, localIntent, PublicFragmentActivityForMini.class, MainPageFragment.class);
  }
  ...
  private void startComplainAndCallback()
  {
    ...
    localObject2 = "https://tucao.qq.com/qq_miniprogram/tucao?appid=" + this.mMiniAppInfo.appId + "&openid=" + getUin() + "&avatar=" + (String)localObject1 + acfp.m(2131708018);
  ...
  private void updateLikeNum(int paramInt)
  {
    if (!this.isLike) {
      if (this.isMiniGame) {
        this.mLikeNum.setText(acfp.m(2131708004));
      }
    }
    while (paramInt <= 0)
    {
      return;
      this.mLikeNum.setText(acfp.m(2131708017));
      return;
    }
    if (paramInt > 9999)
    {
      float f = paramInt / 10000.0F;
      this.mLikeNum.setText(String.format("%.2f", new Object[] { Float.valueOf(f) }) + acfp.m(2131708014) + LIKE_NUM_POSTFIX);
      return;
    }
  ...
  private void updateLikeState(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.mLikeBtn.setImageResource(2130841972);
      return;
    }
    this.mLikeBtn.setImageResource(2130842004);
  }
  ...
  {
    paramLayoutInflater = LayoutInflater.from(getActivity()).inflate(2131562577, null);
  ...
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    this.mAppIcon = ((ImageView)paramView.findViewById(2131371828));
    this.mAppIcon.setOnLongClickListener(this.mLongClickListener);
    this.mAppName = ((TextView)paramView.findViewById(2131371834));
    this.mIntroduction = ((TextView)paramView.findViewById(2131371814));
    this.mLikeNum = ((TextView)paramView.findViewById(2131371827));
    this.mLikeBtn = ((ImageView)paramView.findViewById(2131371826));
    this.mSetTopSwitch = ((Switch)paramView.findViewById(2131371838));
    this.mRecommendMiniAppBtn = ((Button)paramView.findViewById(2131371836));
    this.mEnterMiniAppBtn = ((Button)paramView.findViewById(2131371818));
    this.mRelativePublicAccountContainer = paramView.findViewById(2131371837);
    this.mComplainCallbackContainer = paramView.findViewById(2131371812);
    this.mLikeContainer = paramView.findViewById(2131371825);
    this.mBackView = ((ImageView)paramView.findViewById(2131371842));
    this.mMoreView = ((ImageView)paramView.findViewById(2131371843));
    this.mSetTopText = ((TextView)paramView.findViewById(2131378113));
    this.mSeparator = paramView.findViewById(2131369525);
