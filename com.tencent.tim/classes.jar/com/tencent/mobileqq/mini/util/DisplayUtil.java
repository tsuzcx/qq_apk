...
public class DisplayUtil
{
  ...
  public static JSONObject getDisplayCutoutSafeArea(Activity paramActivity)
  {
    ...
    {
      Rect localRect = awdo.d(paramActivity.getWindow().getDecorView());
      localRect.top = awdo.a(paramActivity, paramActivity);
  ...
  public static int getScreenHeight(Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      if (m != 0)
      {
        j = ankt.getRealHeight(BaseApplication.getContext());
        k = 0;
      }
      i = j;
      if (k != 0) {
  ...
  public static void setSystemUIVisible(BaseActivity paramBaseActivity, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      label100:
      ayxa.enableNotch(paramBaseActivity);
    }
  }
