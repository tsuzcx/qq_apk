...
public class AdUtils
{
  ...
  public static List<GdtAd> convertJson2GdtAds(String paramString)
  {
    ...
    try
    {
      ...
      {
        tkw.e("AdUtils", "convertJson2GdtAds() posAdInfos.isEmpty");
        return null;
      }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramString = (String)localObject2;
          tkw.e("AdUtils", "convertJson2GdtAds() adInfos.isEmpty");
        }
    ...
    tkw.e("AdUtils", "convertJson2GdtAds", localException1);
    return paramString;
    label147:
    paramString = (String)localObject2;
    ...
    {
      paramString = (String)localObject2;
      tkw.d("AdUtils", "convertJson2GdtAds() result = [" + Arrays.toString(((List)localObject2).toArray()) + "]");
    }
    return localObject2;
  }
  ...
  public static MiniAppAd.DeviceInfo getDeviceInfo(Context paramContext, int paramInt)
  {
    ...
    ((tlm.a)localObject1).aJy = "e8d69a";
    long l = System.currentTimeMillis();
    localObject1 = tlm.a(paramContext, (tlm.a)localObject1);
    boolean bool;
    label77:
    ...
    if (localObject1 != null)
    {
      ...
      if (localObject1 != null)
      {
        ...
        localObject2 = aqgz.getAndroidID();
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          localDeviceInfo.android_id.set((String)localObject2);
          localObject2 = arwv.toMD5((String)localObject2);
    ...
    for (Object localObject2 = "";; localObject2 = ((String)localObject2).toLowerCase())
    {
      ...
      paramContext = aqgz.getMacAddress(paramContext);
      if (!TextUtils.isEmpty(paramContext))
      {
        localDeviceInfo.mac.set(paramContext);
        localObject2 = arwv.toMD5(paramContext.replace(":", "").toUpperCase()).toLowerCase();
