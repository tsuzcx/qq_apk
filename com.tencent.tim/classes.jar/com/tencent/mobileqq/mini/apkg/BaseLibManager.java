...
public class BaseLibManager
{
  ...
  private void notifyUpdateResult(int paramInt)
  {
    try
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((UpdateListener)((Iterator)localObject1).next()).onUpdateResult(paramInt);
      }
  ...
  public void doDownloadBaselib(String paramString1, String paramString2, String paramString3, String paramString4, UpdateListener paramUpdateListener)
  {
  ...
  public void forceUpdateBaseLib(UpdateListener paramUpdateListener)
  {
    try
    {
  ...
  public String getBaseLibDir(String paramString1, String paramString2)
  {
    ...
    try
    {
      paramString1 = AppLoaderFactory.BASE_LIB_PATH_DIR + File.separator + arwv.toMD5(paramString1) + "_" + paramString2 + File.separator;
      return paramString1;
    }
  ...
  public BaseLibInfo getBaseLibInfo()
  {
    ...
    localBaseLibInfo.baseLibVersion = StorageUtil.getPreference().getString("version", "1.16.0.00063");
  ...
  public String getBaseLibZipPath(String paramString1, String paramString2)
  {
    ...
    return AppLoaderFactory.BASE_LIB_PATH_DIR + File.separator + arwv.toMD5(paramString1) + "_" + paramString2 + ".zip";
  }
  ...
  public String installMiniGameInnerJsLib()
  {
    for (;;)
    {
      try
      {
        String str = g().getBaseLibDir("mini", "1.16.0.00063");
        if (g().isBaseLibDirValid4MiniGame(str))
        {
          QLog.i("miniapp-process_BaseLibManager[MiniEng]", 1, "installMiniGameInnerJsLib, inner baseLib already installed, version:1.16.0.00063");
          return str;
        }
        ...
        QLog.i("miniapp-process_BaseLibManager[MiniEng]", 1, "installMiniGameInnerJsLib, version:1.16.0.00063, totalCount:" + j);
        int i = 0;
        boolean bool;
        if (i < j)
        {
  ...
  public void updateBaseLib(UpdateListener paramUpdateListener)
  {
    try
    {
  ...
  /* Error */
  public void updateBaseLib(String paramString, boolean paramBoolean, UpdateListener paramUpdateListener)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 56	com/tencent/mobileqq/mini/apkg/BaseLibManager:mListeners	Ljava/util/List;
    //   6: aload_3
    //   7: invokeinterface 463 2 0
    //   12: pop
    //   13: ldc 28
    //   15: iconst_1
    //   16: new 255	java/lang/StringBuilder
    //   19: dup
    //   20: invokespecial 256	java/lang/StringBuilder:<init>	()V
    //   23: ldc_w 465
    //   26: invokevirtual 262	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   29: aload_0
    //   30: getfield 105	com/tencent/mobileqq/mini/apkg/BaseLibManager:isUpdatingBaseLib	Z
    //   33: invokevirtual 419	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   36: invokevirtual 279	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   39: invokestatic 282	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   42: aload_0
    //   43: getfield 105	com/tencent/mobileqq/mini/apkg/BaseLibManager:isUpdatingBaseLib	Z
    //   46: istore 4
    //   48: iload 4
    //   50: ifeq +6 -> 56
    //   53: aload_0
    ...
    //   56: aload_0
    //   57: iconst_1
    //   58: putfield 105	com/tencent/mobileqq/mini/apkg/BaseLibManager:isUpdatingBaseLib	Z
    //   61: new 467	com/tencent/mobileqq/mini/apkg/BaseLibManager$2
    //   64: dup
    //   65: aload_0
    //   66: iload_2
    //   67: aload_1
    //   68: aload_3
    //   69: invokespecial 470	com/tencent/mobileqq/mini/apkg/BaseLibManager$2:<init>	(Lcom/tencent/mobileqq/mini/apkg/BaseLibManager;ZLjava/lang/String;Lcom/tencent/mobileqq/mini/apkg/BaseLibManager$UpdateListener;)V
    //   72: bipush 16
    //   74: aconst_null
    //   75: iconst_0
    //   76: invokestatic 341	com/tencent/mobileqq/app/ThreadManager:excute	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   79: goto -26 -> 53
    //   82: astore_1
    //   83: aload_0
    //   84: monitorexit
    ...
    //   0	87	3	paramUpdateListener	UpdateListener
    //   46	3	4	bool	boolean
    // Exception table:
    //   from	to	target	type
    //   2	48	82	finally
