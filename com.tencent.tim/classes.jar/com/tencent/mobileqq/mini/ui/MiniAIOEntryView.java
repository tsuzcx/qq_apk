  ...
  implements IMiniMsgUnreadCallback, MiniMsgUser.IMiniMsgActionCallback
{
  ...
  {
    this.miniAIOEntryView = ((RelativeLayout)LayoutInflater.from(getContext()).inflate(2131559612, null));
    this.miniAIOIcon = ((ImageView)this.miniAIOEntryView.findViewById(2131371722));
    this.miniAIOUnReadView = ((TextView)this.miniAIOEntryView.findViewById(2131371723));
    if ("black".equals(this.style)) {
      this.miniAIOIcon.setBackgroundResource(2130841862);
    }
    for (;;)
    {
      initMiniMsgUser();
      ...
      return;
      this.miniAIOIcon.setBackgroundResource(2130841863);
    }
  }
