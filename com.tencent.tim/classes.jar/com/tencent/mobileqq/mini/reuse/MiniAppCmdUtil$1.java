  ...
  extends MiniAppObserver
{
  ...
  public void onBatchQueryAppInfoFin(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      try
      {
        ...
        paramBundle = BatchQueryAppInfoRequest.onResponse(aqnv.J(paramBundle.getWupBuffer()));
        JSONObject localJSONObject = new JSONObject();
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          this.this$0.getExtConfigDetail(paramBundle.commonExt, asvo.V(paramBundle.extConfigInfoList), new MiniAppCmdUtil.1.3(this));
          return;
        }
  ...
  public void onGetAppInfoByLinkFin(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        String str = paramBundle.getString("errMsg", acfp.m(2131708351));
        if (paramBoolean)
        {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          this.this$0.getExtConfigDetail(localMiniAppInfo.commonExt, asvo.V(localMiniAppInfo.extConfigInfoList), new MiniAppCmdUtil.1.4(this));
          return;
        }
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      if (paramBoolean)
      {
        try
        {
          ...
          if (localObject != null)
          {
            paramBundle = MiniAppGetGroupShareInfoRequest.onResponse(aqnv.J(((FromServiceMsg)localObject).getWupBuffer()));
  ...
  public void onGetHotSearchApps(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      try
      {
        ...
        str = paramBundle.getString("errMsg", acfp.m(2131708353));
        localJSONObject = new JSONObject();
        localJSONObject.put("retCode", l);
        localJSONObject.put("errMsg", str);
        if (paramBoolean)
        {
          ...
          if (paramBundle != null)
          {
            localJSONObject.put("getHotSearchAppsResponse", GetHotSearchAppsRequest.onResponse(aqnv.J(paramBundle.getWupBuffer())));
            if (localMiniAppCmdInterface == null) {
              return;
            }
            localMiniAppCmdInterface.onCmdListener(true, localJSONObject);
  ...
  public void onGetKuolieAppListServlet(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      {
        long l = paramBundle.getLong("retCode", -1L);
        String str = paramBundle.getString("errMsg", acfp.m(2131708357));
        if (paramBoolean)
        {
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      if (paramBoolean)
      {
        try
        {
          ...
          if (localObject != null)
          {
            paramBundle = PayRequest.onResponse(aqnv.J(((FromServiceMsg)localObject).getWupBuffer()));
            localObject = new JSONObject();
            ((JSONObject)localObject).put("response", paramBundle);
            ((JSONObject)localObject).put("resultCode", paramInt);
            ((JSONObject)localObject).put("errMsg", str);
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      if (paramBoolean)
      {
        try
        {
          ...
          if (localObject != null)
          {
            paramBundle = QueryCurrencyRequest.onResponse(aqnv.J(((FromServiceMsg)localObject).getWupBuffer()));
            localObject = new JSONObject();
            ((JSONObject)localObject).put("response", paramBundle);
            ((JSONObject)localObject).put("resultCode", paramInt);
            ((JSONObject)localObject).put("errMsg", str);
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      if (paramBoolean)
      {
        try
        {
          ...
          if (paramBundle != null)
          {
            paramBundle = rxd.a(aqnv.J(paramBundle.getWupBuffer()));
            JSONObject localJSONObject = new JSONObject();
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      if (paramBoolean)
      {
        try
        {
          ...
          {
            CloudStorage.StGetPotentialFriendListRsp localStGetPotentialFriendListRsp = GetPotentialFriendListRequest.onResponse(aqnv.J(localFromServiceMsg.getWupBuffer()));
            JSONObject localJSONObject = new JSONObject();
  ...
  public void onGetRecommendAppList(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      {
        l = paramBundle.getLong("retCode", -1L);
        str = paramBundle.getString("errMsg", acfp.m(2131708355));
        localJSONObject = new JSONObject();
        localJSONObject.put("retCode", l);
        localJSONObject.put("errMsg", str);
        if (paramBoolean)
        {
          ...
          if (paramBundle != null)
          {
            localJSONObject.put("response", GetRecommendAppListRequest.onResponse(aqnv.J(paramBundle.getWupBuffer())));
            if (localMiniAppCmdInterface == null) {
              return;
            }
            localMiniAppCmdInterface.onCmdListener(true, localJSONObject);
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      if (paramBoolean)
      {
        try
        {
          ...
          if (localFromServiceMsg != null)
          {
            MiniAppAd.StGetAdRsp localStGetAdRsp = MiniAppGetAdRequest.onResponse(aqnv.J(localFromServiceMsg.getWupBuffer()));
            JSONObject localJSONObject = new JSONObject();
  ...
  public void onGetShareInfo(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      {
        l = paramBundle.getLong("retCode", -1L);
        localObject = paramBundle.getString("errMsg", acfp.m(2131708350));
        if (paramBoolean)
        {
      ...
      try
      {
        ...
        ((JSONObject)localObject).put("errMsg", acfp.m(2131708348));
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      if (paramBoolean)
      {
        try
        {
          ...
          if (localObject != null)
          {
            localObject = MiniAppGetSwitchListRequest.onResponse(aqnv.J(((FromServiceMsg)localObject).getWupBuffer()));
            JSONObject localJSONObject = new JSONObject();
  ...
  public void onGetUserAppList(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      {
        l = paramBundle.getLong("retCode", -1L);
        str = paramBundle.getString("errMsg", acfp.m(2131708352));
        localJSONObject = new JSONObject();
        localJSONObject.put("retCode", l);
        localJSONObject.put("errMsg", str);
        if (paramBoolean)
        {
          ...
          if (paramBundle != null)
          {
            localJSONObject.put("response", GetUserAppListRequest.onResponse(aqnv.J(paramBundle.getWupBuffer())));
            if (localMiniAppCmdInterface == null) {
              return;
            }
            localMiniAppCmdInterface.onCmdListener(true, localJSONObject);
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          if (paramBundle != null)
          {
            localJSONObject.put("response", GetUserAppListRequestV2.onResponse(aqnv.J(paramBundle.getWupBuffer())));
            if (localMiniAppCmdInterface == null) {
              return;
            }
            localMiniAppCmdInterface.onCmdListener(true, localJSONObject);
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      if (paramBoolean)
      {
        try
        {
          ...
          if (localFromServiceMsg != null)
          {
            CloudStorage.StGetUserInteractiveStorageRsp localStGetUserInteractiveStorageRsp = GetUserInteractiveStorageRequest.onResponse(aqnv.J(localFromServiceMsg.getWupBuffer()));
            JSONObject localJSONObject = new JSONObject();
      ...
      for (;;)
      {
        ...
        if (paramBoolean)
        {
          ...
          try
          {
            ...
            localJSONObject.put("originalData", new String((byte[])localObject));
            localJSONObject.put("errMsg", paramBundle.getString("errMsg", ""));
            if (localMiniAppCmdInterface != null)
            {
              localMiniAppCmdInterface.onCmdListener(true, localJSONObject);
  ...
  public void onLocalSearchDataFin(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      try
      {
        ...
        paramBundle = LocalSearchDataRequest.onResponse(aqnv.J(paramBundle.getWupBuffer()));
        JSONObject localJSONObject = new JSONObject();
        localJSONObject.put("response", paramBundle);
        if (localMiniAppCmdInterface == null) {
          return;
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      if (paramBoolean)
      {
        try
        {
          ...
          if (localFromServiceMsg != null)
          {
            CloudStorage.StModifyFriendInteractiveStorageRsp localStModifyFriendInteractiveStorageRsp = ModifyFriendInteractiveStorageReq.onResponse(aqnv.J(localFromServiceMsg.getWupBuffer()));
            JSONObject localJSONObject = new JSONObject();
  ...
  public void onRealTimeLogReport(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      {
        long l = paramBundle.getLong("retCode", -1L);
        paramBundle = paramBundle.getString("errMsg", acfp.m(2131708353));
        JSONObject localJSONObject = new JSONObject();
        localJSONObject.put("retCode", l);
        localJSONObject.put("errMsg", paramBundle);
        if (paramBoolean)
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          if (paramBundle != null)
          {
            localJSONObject.put("searchAppResponse", SearchAppRequest.onResponse(aqnv.J(paramBundle.getWupBuffer())));
            if (localMiniAppCmdInterface == null) {
              return;
            }
            localMiniAppCmdInterface.onCmdListener(true, localJSONObject);
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      if (paramBoolean)
      {
        try
        {
          ...
          if (localFromServiceMsg != null)
          {
            MiniProgramShare.StSendArkMsgRsp localStSendArkMsgRsp = MiniAppSendArkMsgRequest.onResponse(aqnv.J(localFromServiceMsg.getWupBuffer()));
            JSONObject localJSONObject = new JSONObject();
  ...
  public void onSetAvatar(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      if (localMiniAppCmdInterface != null)
      {
        localJSONObject = new JSONObject();
        l = paramBundle.getLong("retCode", -1L);
        paramBundle = paramBundle.getString("errMsg", acfp.m(2131708354));
        localJSONObject.put("retCode", l);
        localJSONObject.put("errMsg", paramBundle);
        localMiniAppCmdInterface.onCmdListener(false, localJSONObject);
        return;
    ...
    if ((MiniAppCmdUtil.access$200(this.this$0) != null) && (MiniAppCmdUtil.access$200(this.this$0).containsKey(Integer.valueOf(paramInt))))
    {
      ...
      if (paramBoolean)
      {
        try
        {
          ...
          if (localObject != null)
          {
            localObject = MiniAppSetUserSwitchRequest.onResponse(aqnv.J(((FromServiceMsg)localObject).getWupBuffer()));
            JSONObject localJSONObject = new JSONObject();
