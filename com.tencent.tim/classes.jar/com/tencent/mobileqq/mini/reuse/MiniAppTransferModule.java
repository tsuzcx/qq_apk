  ...
  extends QIPCModule
{
  ...
  private accn cardObserver = new MiniAppTransferModule.3(this);
  ...
  {
    boolean bool = FriendsStatusUtil.bc(BaseApplicationImpl.getContext());
    Object localObject;
    ...
    if (paramBoolean)
    {
      ...
      ((CardHandler)((QQAppInterface)localObject).getBusinessHandler(2)).E((int)(l + 3600L), "", "not_disturb_from_miniapp");
      return;
    }
    ((CardHandler)((QQAppInterface)localObject).getBusinessHandler(2)).E(0, "", "not_disturb_from_miniapp");
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    do
    {
          ...
          else
          {
            ...
            if ("launch_report_sdk_4239".equals(paramString)) {
              try
              {
                ...
                paramBundle = asvo.a(localMiniAppInfo);
                if (paramBundle == null) {
                  continue;
                }
              ...
              try
              {
                ...
                paramString = asvo.a(paramString);
                if (paramString != null)
                {
      ...
      if ("preload_loading_ad".equals(paramString)) {
        try
        {
          paramBundle.setClassLoader(MiniLoadingAdManager.class.getClassLoader());
          MiniLoadingAdManager.requestPreloadLoadingAd((MiniAppConfig)paramBundle.getParcelable("app_config"), paramBundle.getString("uin"));
          return null;
        }
        catch (Exception paramString)
        {
    ...
    } while (!"query_user_troop_info".equals(paramString));
    try
    {
      paramString = new Bundle();
      paramString.putBoolean("hasCreateOrManageTroop", apuh.aBA());
      callbackResult(paramInt, EIPCResult.createResult(0, paramString));
      return null;
    }
    catch (Exception paramString)
