  ...
  extends MSFServlet
{
  ...
  private static void sendRequest(int paramInt1, String paramString, int paramInt2, byte[] paramArrayOfByte, BusinessObserver paramBusinessObserver)
  {
    ...
    paramArrayOfByte = new NewIntent(BaseApplicationImpl.getApplication(), aneg.class);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (localObject2 = aqnv.J(paramFromServiceMsg.getWupBuffer());; localObject2 = null)
    {
