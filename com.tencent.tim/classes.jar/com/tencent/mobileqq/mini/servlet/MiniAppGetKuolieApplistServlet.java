      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (localStExpandItem != null)
        {
          ...
          if (paramArrayOfByte != null)
          {
            ...
            localMiniApp.miniAppInfo = localMiniAppInfo;
            localMiniApp.appId = localMiniAppInfo.appId;
            if (!TextUtils.isEmpty(localStExpandItem.icon.get()))
            {
              paramArrayOfByte = localStExpandItem.icon.get();
              label245:
              localMiniApp.iconUrl = paramArrayOfByte;
            ...
            {
              localMiniApp.appName = paramArrayOfByte;
              localMiniApp.adId = localStExpandItem.adId.get();
