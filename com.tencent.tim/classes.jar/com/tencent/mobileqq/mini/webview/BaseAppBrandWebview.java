  ...
  implements JsRuntime
{
  ...
  public ConcurrentLinkedQueue<RunData> mRunData = new ConcurrentLinkedQueue();
  ...
  public BaseAppBrandWebview(Context paramContext, boolean paramBoolean)
  {
    ...
    this.userAgent = (paramContext.getUserAgentString() + " QQ/MiniApp QQ/" + aqgz.getQQVersion());
  ...
  public void evaluateSubcribeJSInService(String paramString1, String paramString2, int paramInt)
  {
    if (!isReady())
    {
      ...
      this.mRunData.offer(new RunData(paramString1, paramString2, paramInt));
      return;
    }
  ...
  public void initJSGlobalConfig()
  {
    ...
    try
    {
      ...
      str2 = String.format("if (typeof __qqConfig === 'undefined') var __qqConfig = {};var __tempConfig=%1$s;  __qqConfig = extend(__qqConfig, __tempConfig);__qqConfig.accountInfo=JSON.parse('%2$s');  __qqConfig.envVersion='" + str1 + "'; __qqConfig.deviceinfo='" + avpp.a().FY() + "'; __qqConfig.miniapp_version='" + str2 + "';", new Object[] { this.apkgInfo.mConfigStr, localJSONObject.toString() });
      str1 = str2;
  ...
  public void runDelayedEvent()
  {
    ...
    {
      RunData localRunData = (RunData)this.mRunData.poll();
  ...
  public class RunData
  {
    ...
    public RunData(String paramString1, String paramString2, int paramInt)
    {
