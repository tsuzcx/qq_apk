...
public class WxapkgUnpacker
{
  ...
  private static boolean Unpacker(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    //   53: aload_2
    //   54: astore 7
    //   56: new 49	java/io/RandomAccessFile
    //   59: dup
    //   60: aload_0
    //   61: ldc 51
    //   63: invokespecial 54	java/io/RandomAccessFile:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   66: astore_2
    //   67: aload_2
    //   68: invokevirtual 58	java/io/RandomAccessFile:readByte	()B
    //   71: bipush 190
    //   73: if_icmpeq +51 -> 124
    //   76: new 60	java/lang/RuntimeException
    //   79: dup
    //   80: ldc 62
    //   82: invokespecial 63	java/lang/RuntimeException:<init>	(Ljava/lang/String;)V
    //   85: athrow
    //   86: astore_1
    //   87: aload_2
    //   88: astore_0
    ...
    //   92: ldc 65
    //   94: aload_1
    //   95: invokestatic 71	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   98: aload_0
    //   99: ifnull +7 -> 106
    //   102: aload_0
    //   103: invokevirtual 74	java/io/RandomAccessFile:close	()V
    //   106: iconst_0
    //   107: ireturn
    //   108: new 31	java/io/File
    //   111: dup
    //   112: aload_2
    //   113: invokespecial 34	java/io/File:<init>	(Ljava/lang/String;)V
    //   116: invokevirtual 38	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   119: astore 7
    //   121: goto -65 -> 56
    //   124: aload_2
    //   125: ldc2_w 75
    //   128: invokevirtual 80	java/io/RandomAccessFile:seek	(J)V
    //   131: aload_2
    //   132: invokevirtual 84	java/io/RandomAccessFile:readInt	()I
    //   135: istore 5
    //   137: new 86	java/util/ArrayList
    //   140: dup
    //   141: iload 5
    //   143: invokespecial 89	java/util/ArrayList:<init>	(I)V
    //   146: astore 9
    //   148: iconst_0
    //   149: istore 4
    //   151: iload 4
    ...
    //   158: aload_2
    //   159: invokevirtual 84	java/io/RandomAccessFile:readInt	()I
    //   162: istore 6
    //   164: iload 6
    //   166: newarray byte
    //   168: astore_0
    ...
    //   171: iconst_0
    //   172: iload 6
    //   174: invokevirtual 93	java/io/RandomAccessFile:read	([BII)I
    //   177: pop
    //   178: new 31	java/io/File
    //   181: dup
    //   182: new 95	java/lang/String
    //   185: dup
    //   186: aload_0
    //   187: iconst_0
    //   188: iload 6
    //   190: invokespecial 98	java/lang/String:<init>	([BII)V
    //   193: invokespecial 34	java/io/File:<init>	(Ljava/lang/String;)V
    //   196: invokevirtual 38	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   199: astore 8
    //   201: aload 8
    //   203: astore_0
    //   204: aload 7
    //   206: invokestatic 26	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   209: ifne +58 -> 267
    //   212: aload 8
    //   214: aload 7
    //   216: invokevirtual 102	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   219: ifne +124 -> 343
    //   222: iload_3
    //   223: ifeq +110 -> 333
    //   226: aload 7
    //   228: aload 8
    //   230: invokevirtual 102	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   233: ifne +13 -> 246
    //   236: aload 7
    //   238: aload 8
    //   240: invokevirtual 105	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   243: ifeq +55 -> 298
    //   246: new 28	java/lang/StringBuilder
    //   249: dup
    //   250: invokespecial 29	java/lang/StringBuilder:<init>	()V
    //   253: aload 7
    ...
    //   266: astore_0
    //   267: aload 9
    //   269: new 6	com/tencent/mobileqq/mini/utils/WxapkgUnpacker$WxapkgFile
    //   272: dup
    //   273: aload_0
    //   274: aload_2
    //   275: invokevirtual 84	java/io/RandomAccessFile:readInt	()I
    //   278: aload_2
    //   279: invokevirtual 84	java/io/RandomAccessFile:readInt	()I
    //   282: invokespecial 108	com/tencent/mobileqq/mini/utils/WxapkgUnpacker$WxapkgFile:<init>	(Ljava/lang/String;II)V
    //   285: invokevirtual 112	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   288: pop
    //   289: iload 4
    //   291: iconst_1
    //   292: iadd
    //   293: istore 4
    //   295: goto -144 -> 151
    //   298: new 28	java/lang/StringBuilder
    //   301: dup
    //   302: invokespecial 29	java/lang/StringBuilder:<init>	()V
    //   305: aload 7
    //   307: invokevirtual 42	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   310: ldc 44
    //   312: invokevirtual 42	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   315: getstatic 115	java/io/File:separator	Ljava/lang/String;
    ...
    //   334: ifnull +7 -> 341
    //   337: aload_2
    //   338: invokevirtual 74	java/io/RandomAccessFile:close	()V
    //   341: iconst_0
    //   342: ireturn
    //   343: aload 8
    //   345: aload 7
    //   347: new 28	java/lang/StringBuilder
    //   350: dup
    //   351: invokespecial 29	java/lang/StringBuilder:<init>	()V
    //   354: aload 7
    //   356: invokevirtual 42	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   359: ldc 44
    //   361: invokevirtual 42	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   364: invokevirtual 47	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   367: invokevirtual 119	java/lang/String:replaceFirst	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   370: astore_0
    //   371: goto -104 -> 267
    //   374: aload 9
    //   376: invokevirtual 123	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   379: astore_0
    //   380: aload_0
    //   381: invokeinterface 129 1 0
    //   386: ifeq +84 -> 470
    //   389: aload_0
    //   390: invokeinterface 133 1 0
    //   395: checkcast 6	com/tencent/mobileqq/mini/utils/WxapkgUnpacker$WxapkgFile
    //   398: astore 7
    //   400: new 31	java/io/File
    //   403: dup
    //   404: aload_1
    //   405: aload 7
    //   407: getfield 136	com/tencent/mobileqq/mini/utils/WxapkgUnpacker$WxapkgFile:name	Ljava/lang/String;
    //   410: invokespecial 137	java/io/File:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   413: astore 8
    //   415: aload_2
    //   416: aload 7
    //   418: getfield 141	com/tencent/mobileqq/mini/utils/WxapkgUnpacker$WxapkgFile:start	I
    //   421: i2l
    //   422: invokevirtual 80	java/io/RandomAccessFile:seek	(J)V
    //   425: aload 7
    //   427: getfield 144	com/tencent/mobileqq/mini/utils/WxapkgUnpacker$WxapkgFile:length	I
    //   430: newarray byte
    //   432: astore 9
    //   434: aload_2
    //   435: aload 9
    //   437: iconst_0
    //   438: aload 7
    //   440: getfield 144	com/tencent/mobileqq/mini/utils/WxapkgUnpacker$WxapkgFile:length	I
    //   443: invokevirtual 93	java/io/RandomAccessFile:read	([BII)I
    //   446: pop
    //   447: aload 8
    //   449: aload 9
    //   451: invokestatic 148	com/tencent/mobileqq/mini/utils/WxapkgUnpacker:write	(Ljava/io/File;[B)V
    //   454: goto -74 -> 380
    //   457: astore_0
    //   458: aload_2
    //   459: astore_1
    ...
    //   461: ifnull +7 -> 468
    //   464: aload_1
    //   465: invokevirtual 74	java/io/RandomAccessFile:close	()V
    //   468: aload_0
    //   469: athrow
    //   470: aload_2
    //   471: ifnull +7 -> 478
    //   474: aload_2
    //   475: invokevirtual 74	java/io/RandomAccessFile:close	()V
    //   478: iconst_1
    //   479: ireturn
    //   480: astore_0
    //   481: goto -140 -> 341
  ...
  public static File createFileFromInputStream(InputStream paramInputStream, String paramString)
  {
    ...
    //   14: invokestatic 158	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   17: invokevirtual 162	com/tencent/common/app/BaseApplicationImpl:getFilesDir	()Ljava/io/File;
    //   20: invokevirtual 165	java/io/File:getPath	()Ljava/lang/String;
    ...
    //   38: invokespecial 34	java/io/File:<init>	(Ljava/lang/String;)V
    //   41: astore 4
    //   43: new 169	java/io/FileOutputStream
    //   46: dup
    //   47: aload 4
    //   49: invokespecial 172	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   52: astore_3
    //   53: aload_3
    //   54: astore_1
    //   55: sipush 1024
    ...
    //   64: aload_0
    //   65: aload 5
    //   67: invokevirtual 177	java/io/InputStream:read	([B)I
    //   70: istore_2
    //   71: iload_2
    //   72: ifle +60 -> 132
    //   75: aload_3
    ...
    //   80: iconst_0
    //   81: iload_2
    //   82: invokevirtual 181	java/io/OutputStream:write	([BII)V
    //   85: goto -23 -> 62
    //   88: astore_1
    //   89: aload_3
    //   90: astore_0
    ...
    //   105: ldc 183
    //   107: invokevirtual 42	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   110: aload_3
    //   111: invokevirtual 186	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   114: invokevirtual 47	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   117: invokestatic 189	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   120: aload_0
    //   121: ifnull +7 -> 128
    //   124: aload_0
    //   125: invokevirtual 190	java/io/OutputStream:close	()V
    //   128: aconst_null
    //   129: astore_0
    //   130: aload_0
    //   131: areturn
    ...
    //   133: astore_1
    //   134: aload_0
    //   135: invokevirtual 191	java/io/InputStream:close	()V
    //   138: aload 4
    //   140: astore_0
    //   141: aload_3
    //   142: ifnull -12 -> 130
    //   145: aload_3
    //   146: invokevirtual 190	java/io/OutputStream:close	()V
    //   149: aload 4
    //   151: areturn
    //   152: astore_0
    //   153: aload_0
    //   154: invokevirtual 194	java/io/IOException:printStackTrace	()V
    //   157: aload 4
    //   159: areturn
    //   160: astore_0
    //   161: aload_0
    //   162: invokevirtual 194	java/io/IOException:printStackTrace	()V
    //   165: goto -37 -> 128
    //   168: astore_0
    //   169: aload 5
    //   171: astore_1
    ...
    //   173: ifnull +7 -> 180
    //   176: aload_1
    //   177: invokevirtual 190	java/io/OutputStream:close	()V
    //   180: aload_0
    //   181: athrow
    //   182: astore_1
    //   183: aload_1
  ...
  public static boolean unpackSync(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    //   32: aload_1
    //   33: aload_2
    //   34: invokespecial 137	java/io/File:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   37: invokevirtual 238	java/io/File:exists	()Z
    //   40: ifeq +8 -> 48
    //   43: iconst_1
    //   44: istore_3
    //   45: goto -22 -> 23
    ...
    //   50: aload_2
    //   51: iload_3
    //   52: invokestatic 271	com/tencent/mobileqq/mini/utils/WxapkgUnpacker:unpackAtomically	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Z
    //   55: istore_3
    //   56: goto -33 -> 23
    //   59: astore_0
    //   60: ldc 2
