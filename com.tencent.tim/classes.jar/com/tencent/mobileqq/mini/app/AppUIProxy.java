  ...
  implements IAppUIProxy
{
  ...
  {
    MiniLoadingAdManager.getInstance().selectAd(paramMiniAppConfig, String.valueOf(aroi.a().getUin()), new AppUIProxy.3(this, paramBaseActivity, paramMiniAppConfig));
  }
  ...
  private void recoveryIntent(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          MiniAppConfig localMiniAppConfig = asvo.a((com.tencent.qqmini.sdk.launcher.model.MiniAppInfo)paramIntent.getParcelableExtra("KEY_APPINFO"));
          if (localMiniAppConfig != null)
          {
  ...
  public boolean doOnCreate(BaseActivity paramBaseActivity, Bundle paramBundle)
  {
    ...
    if (sCacheAppBrandFragment != null)
    {
      ...
      paramBundle = (ViewGroup)paramBaseActivity.findViewById(2131370813);
      if (paramBundle != null)
      {
      ...
      this.mFragmentManager.beginTransaction().replace(2131367562, this.mAppBrandFragment).commit();
    ...
    for (;;)
    {
      try
      {
        ...
        ajct.a().a(localEngineChannel);
        ajct.a().a(paramBundle, null);
      ...
      initOnIntentChanged();
      this.mColorNoteController = new aeay(paramBaseActivity, false, true);
      this.mColorNoteController.attachToActivity(paramBaseActivity);
      this.mColorNoteController.setServiceInfo(this);
      this.mColorNoteController.a(new AppUIProxy.1(this, paramBaseActivity));
      this.mColorNoteController.setOnColorNoteCurdListener(new AppUIProxy.2(this, paramBaseActivity));
  ...
  public void doOnResume(BaseActivity paramBaseActivity)
  {
    ...
    for (Object localObject1 = localMiniAppConfig.launchParam.entryPath;; localObject1 = "")
    {
      ...
      if (!this.mAppBrandFragment.isAdded()) {
        this.mFragmentManager.beginTransaction().replace(2131367562, this.mAppBrandFragment).commitAllowingStateLoss();
      }
      this.mIntent = null;
  ...
  public ColorNote getColorNote()
  {
    ...
    return new ColorNote.a().a(16842752).a(localMiniAppConfig.config.appId).b(localMiniAppConfig.config.name).c(localMiniAppConfig.config.desc).d(localMiniAppConfig.config.iconUrl).a(arrayOfByte).a();
  }
  ...
  {
    return this.mFragmentManager.findFragmentById(2131367562);
  }
  ...
  public boolean moveTaskToBack(BaseActivity paramBaseActivity, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    boolean bool3 = this.mColorNoteController.isColorNoteExist();
    boolean bool2;
    if (bool3)
    {
  ...
  public class AppBrandCommonReceiver
