  ...
  implements Handler.Callback
{
  ...
  public boolean doOnCreate(BaseActivity paramBaseActivity, Bundle paramBundle)
  {
    ...
    this.mLoadingLayout = this.mActivity.findViewById(2131370805);
    this.mLoadingLayout.setVisibility(8);
    this.mRootView = this.mActivity.findViewById(2131371610);
    return bool;
  }
  ...
  public void startLoading(BaseActivity paramBaseActivity, Bundle paramBundle)
  {
    ...
    {
      Toast.makeText(paramBaseActivity, acfp.m(2131707452), 1).show();
      paramBaseActivity.finish();
      return;
    }
    ...
    localObject = (ViewGroup)this.mLoadingLayout.findViewById(2131365356);
    ...
    for (;;)
    {
      ...
      localObject = (ImageView)this.mLoadingLayout.findViewById(2131363823);
      if (!TextUtils.isEmpty(MiniAppGlobal.CAPSULE_CLOSE_URL)) {
        ((ImageView)localObject).setImageDrawable(MiniAppUtils.getIcon(paramBaseActivity, MiniAppGlobal.CAPSULE_CLOSE_URL, true, 2130842073, 40, 30));
      }
