  ...
  extends AsyncTask
{
  ...
  private void readJsFromFile(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        if ((!BaseLibInfo.needUpdateVersion("1.16.0.00063", str)) && ((TextUtils.isEmpty(paramString)) || (BaseLibManager.verifyBaselib(new File(paramString))))) {
          break label384;
        }
        QLog.e("miniapp-start", 1, "download baselib invalid! use assert baselib. download_version=" + str + " assert_version=" + "1.16.0.00063");
        i = 0;
      ...
      return;
      onTaskFailed(-3, acfp.m(2131703114));
      continue;
      label384:
      int i = 1;
    }
  ...
  public BaseLibInfo getBaseLibInfo()
  {
    ...
    if (mBaseLibInfo == null)
    {
      ...
      str2 = StorageUtil.getPreference().getString("version", "1.16.0.00063");
      if (!"1.16.0.00063".equals(str2)) {
        break label69;
      }
      mBaseLibInfo = new BaseLibInfo();
