...
public class TaskMonitorManager
{
  ...
  public static String TASK_PERFM_SWITCH_PAGE = acfp.m(2131715126);
  ...
  private FpsListener mFpsListener = new FpsListener(null);
    ...
    implements aqda.a
  {
    ...
    {
      TaskMonitorManager.this.mCurrentFps = paramDouble;
    }
  }
}
