  ...
  implements ausj.a
{
  ...
  public MapHelper(Context paramContext)
  {
    ...
    this.mAppNameMap.put("com.tencent.map", acfp.m(2131708031));
    this.mAppNameMap.put("com.baidu.BaiduMap", acfp.m(2131708037));
  ...
  protected void checkInstalledMapApp()
  {
    ...
    if (ausc.bb(this.mContext, "com.tencent.map")) {
      this.mInstalledMapAppSet.add("com.tencent.map");
    }
    if (ausc.bb(this.mContext, "com.baidu.BaiduMap")) {
  ...
  protected void openStreetViewMap()
  {
    ...
    {
      QQToast.a(this.mContext.getApplicationContext(), 0, acfp.m(2131708033), 1).show(this.mContext.getResources().getDimensionPixelSize(2131299627));
      return;
    }
  ...
  public void showActionSheet(LatLng paramLatLng1, LatLng paramLatLng2, String paramString1, String paramString2)
  {
    ...
    {
      QQToast.a(this.mContext, 0, acfp.m(2131708036), 1).show(this.mContext.getResources().getDimensionPixelSize(2131299627));
      return;
    }
    ...
    if (TextUtils.isEmpty(this.mSelfPoiName)) {
      this.mSelfPoiName = acfp.m(2131708032);
    }
    if (TextUtils.isEmpty(this.mTargetPoiName)) {
      this.mTargetPoiName = acfp.m(2131708030);
    }
    ...
    if (d > 1000.0D)
    {
      ...
      this.mActionSheet.addButton(acfp.m(2131708034));
    ...
    for (int i = 1;; i = 0)
    {
      this.mActionSheet.addButton(acfp.m(2131708035));
