    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ("qsubscribe_opendiscover".equals(localObject))
        {
          ...
          avpw.i(paramJSContext.getActivity(), (Intent)localObject, 0);
        ...
        if ("qsubscribe_opendetail".equals(localObject))
        {
          ...
          paramJSONObject = rzd.a(str, (String)localObject, i, paramJSONObject.optInt("width"), paramJSONObject.optInt("height"), l);
          rzd.a(paramJSContext.getActivity(), paramJSONObject, 9001);
          return;
        }
      }
      ...
      if ("qsubscribe_openhomepage".equals(localObject))
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          rzd.i(paramJSContext.getActivity(), paramJSONObject, 9001);
        }
      }
      else if ("qsubscribe_getdeviceinfo".equals(localObject))
      {
        paramJSONObject = new tlm.a();
        paramJSONObject.aJy = "1b0ad2";
        paramJSONObject = tlm.a(BaseApplication.getContext(), paramJSONObject);
        if ((paramJSONObject != null) && (paramJSONObject.b != null))
        {
          localObject = new vac_adv_get.VacFeedsAdvMetaReq();
          ((vac_adv_get.VacFeedsAdvMetaReq)localObject).device_info.set(paramJSONObject.b);
