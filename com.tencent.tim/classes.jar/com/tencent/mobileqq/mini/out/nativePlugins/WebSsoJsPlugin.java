    ...
    if (paramJSContext != null)
    {
      ...
      if ("requestWebSSO".equals(paramJSONObject.optString("api_name"))) {
        try
        {
          ...
          {
            paramJSContext.evaluateCallback(false, new JSONObject(), acfp.m(2131716904));
            return;
          }
          int i = genSeq();
          ...
          awot.a().a(paramJSONObject, localJSONObject, (Bundle)localObject);
          return;
        }
        catch (Throwable paramJSONObject)
        {
          paramJSContext.evaluateCallback(false, new JSONObject(), acfp.m(2131716903));
          if (QLog.isColorLevel()) {
