  ...
  implements NativePlugin
{
  ...
  private void gotoSelectMembers(String paramString1, int paramInt, String paramString2)
  {
    ...
    localJSContext.evaluateCallback(false, new JSONObject(), acfp.m(2131707042));
  }
  ...
  public void onInvoke(JSONObject paramJSONObject, NativePlugin.JSContext paramJSContext)
  {
    ...
    for (;;)
    {
      ...
      {
        paramJSContext.evaluateCallback(false, new JSONObject(), acfp.m(2131707044));
        return;
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      while (localJSONObject != null)
      {
        ...
        paramJSContext.evaluateCallback(false, new JSONObject(), acfp.m(2131707043));
        return;
        if (localJSONObject != null) {
          break label146;
        }
