...
public class MiniProgramReportHelper
{
  ...
  {
    if (PERF_LEVEL == null) {
      PERF_LEVEL = String.valueOf(aqgz.getPerfLevel());
    }
    COMM.Entry localEntry1 = newEntry("uid", String.valueOf(aroi.a().getUin()));
    ...
    if (paramString2 != null)
    {
      ...
      localEntry4 = newEntry("appversion", "3.4.4.3058");
      ...
      localEntry6 = newEntry("qua", avpq.getQUA3());
  ...
  {
    return new ArrayList(Arrays.asList(new COMM.Entry[] { newEntry("uin", String.valueOf(aroi.a().getUin())), newEntry("touin", ""), newEntry("timestamp", String.valueOf(NetConnInfoCenter.getServerTimeMillis())), newEntry("qqversion", avpq.getQUA3()), newEntry("imei", arxr.getImei()), newEntry("idfa", ""), newEntry("idfv", ""), newEntry("android_id", aqgz.getAndroidID()) }));
  }
