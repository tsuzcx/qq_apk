  ...
  implements Manager
{
  ...
  public void checkDB()
  {
    ...
    //   177: aload_0
    //   178: invokespecial 216	com/tencent/mobileqq/mini/apkgEntity/MiniAppEntityManager:deleteDbFile	()V
    //   181: goto -35 -> 146
    //   184: astore 7
    //   186: aload_0
    //   187: monitorexit
  ...
  public boolean clearEntityTable(String paramString)
  {
    ...
    //   40: invokevirtual 222	com/tencent/mobileqq/persistence/EntityManager:execSQL	(Ljava/lang/String;)Z
    //   43: istore_2
    //   44: goto -31 -> 13
    //   47: astore_1
    //   48: aload_0
  ...
  public boolean execSQL(String paramString)
  {
    ...
    //   18: getfield 62	com/tencent/mobileqq/mini/apkgEntity/MiniAppEntityManager:mEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   21: aload_1
    //   22: invokevirtual 222	com/tencent/mobileqq/persistence/EntityManager:execSQL	(Ljava/lang/String;)Z
    //   25: istore_2
    //   26: goto -13 -> 13
    //   29: astore_1
    //   30: aload_0
  ...
  public com.tencent.mobileqq.persistence.Entity find(java.lang.Class<? extends com.tencent.mobileqq.persistence.Entity> paramClass, String paramString, String[] paramArrayOfString)
  {
    ...
    //   29: aconst_null
    //   30: ldc 226
    //   32: invokevirtual 230	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   35: astore_1
    //   36: aload_1
    //   37: ifnull +17 -> 54
    //   40: aload_1
    //   41: iconst_0
    //   42: invokeinterface 236 2 0
    //   47: checkcast 238	com/tencent/mobileqq/persistence/Entity
    //   50: astore_1
    //   51: goto -36 -> 15
    //   54: aconst_null
    //   55: astore_1
  ...
  public boolean insertOrReplaceEntity(com.tencent.mobileqq.persistence.Entity paramEntity)
  {
    ...
    //   16: ireturn
    //   17: aload_1
    //   18: invokevirtual 250	com/tencent/mobileqq/persistence/Entity:getStatus	()I
    //   21: sipush 1000
    //   24: if_icmpne +26 -> 50
    //   27: aload_0
    ...
    //   31: aload_1
    //   32: invokevirtual 254	com/tencent/mobileqq/persistence/EntityManager:persistOrReplace	(Lcom/tencent/mobileqq/persistence/Entity;)V
    //   35: aload_1
    //   36: invokevirtual 250	com/tencent/mobileqq/persistence/Entity:getStatus	()I
    //   39: sipush 1001
    //   42: if_icmpne -29 -> 13
    //   45: iconst_1
    //   46: istore_2
    //   47: goto -34 -> 13
    //   50: aload_1
    //   51: invokevirtual 250	com/tencent/mobileqq/persistence/Entity:getStatus	()I
    //   54: sipush 1001
    //   57: if_icmpeq +13 -> 70
    //   60: aload_1
    //   61: invokevirtual 250	com/tencent/mobileqq/persistence/Entity:getStatus	()I
    //   64: sipush 1002
    //   67: if_icmpne -54 -> 13
    //   70: aload_0
    ...
    //   74: aload_1
    //   75: invokevirtual 257	com/tencent/mobileqq/persistence/EntityManager:update	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   78: istore_2
    //   79: goto -66 -> 13
    //   82: astore_1
    //   83: aload_0
  ...
  public java.util.List<? extends com.tencent.mobileqq.persistence.Entity> queryEntity(java.lang.Class<? extends com.tencent.mobileqq.persistence.Entity> paramClass, boolean paramBoolean, String paramString1, String[] paramArrayOfString, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    //   32: aload 7
    //   34: aload 8
    //   36: invokevirtual 230	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   39: astore_1
    //   40: goto -25 -> 15
    //   43: astore_1
    //   44: aload_0
  ...
  public boolean removeEntity(com.tencent.mobileqq.persistence.Entity paramEntity)
  {
    ...
    //   25: aload_1
    //   26: invokevirtual 268	com/tencent/mobileqq/persistence/EntityManager:remove	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   29: istore_2
    //   30: goto -17 -> 13
    //   33: astore_1
    //   34: aload_0
