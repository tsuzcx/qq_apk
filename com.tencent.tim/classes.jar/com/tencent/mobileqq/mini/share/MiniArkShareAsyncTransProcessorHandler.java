  ...
  extends aook
{
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    Object localObject1 = (aoko)paramMessage.obj;
    if ((localObject1 == null) || (((aoko)localObject1).commandId != 62) || (((aoko)localObject1).fileType != 24)) {}
    for (;;)
    {
      return;
      if ((paramMessage.what == 1007) || (paramMessage.what == 1003))
      {
        ...
        try
        {
          ((Bdh_extinfo.UploadPicExtInfo)localObject2).mergeFrom(((aoko)localObject1).fL);
