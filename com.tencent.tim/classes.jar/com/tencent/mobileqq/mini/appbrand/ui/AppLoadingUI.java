  ...
  implements Handler.Callback, View.OnClickListener
{
  ...
  public void initData(Bundle paramBundle)
  {
    ...
    for (paramBundle = (MiniAppConfig)paramBundle.getParcelable("CONFIG");; paramBundle = null)
    {
      ...
      if (getActivity() != null) {
        Toast.makeText(getActivity(), acfp.m(2131702754), 1).show();
      }
    ...
    if (this.mDeveloperInfoContainer != null)
    {
      ...
      this.mDeveloperInfoDesc.setText(acfp.m(2131702756) + this.appConfig.config.developerDesc + acfp.m(2131702758));
    }
  ...
  public void initUI(ViewGroup paramViewGroup)
  {
    ...
    this.mStatusBar = paramViewGroup.findViewById(2131378716);
    new ImmersionBar(getActivity(), 0, this.mStatusBar);
    this.uiHandler = new Handler(this);
    this.rightContainer = ((RelativeLayout)paramViewGroup.findViewById(2131365356));
    ...
    this.mMoreView = ((ImageView)paramViewGroup.findViewById(2131363912));
    this.mCloseView = ((ImageView)paramViewGroup.findViewById(2131363823));
    if (!TextUtils.isEmpty(MiniAppGlobal.CAPSULE_CLOSE_URL))
    {
      localObject = MiniAppUtils.getIcon(getActivity(), MiniAppGlobal.CAPSULE_CLOSE_URL, true, 2130842073, 40, 30);
      this.mCloseView.setImageDrawable((Drawable)localObject);
    }
    this.mProgressBar = ((ProgressBar)paramViewGroup.findViewById(2131370132));
    this.mContentLayout = ((ViewGroup)paramViewGroup.findViewById(2131365382));
    this.mNameView = ((TextView)paramViewGroup.findViewById(2131367867));
    this.mLogoView = ((ImageView)paramViewGroup.findViewById(2131370909));
    this.mDeveloperInfoContainer = paramViewGroup.findViewById(2131365803);
    this.mDeveloperInfoDesc = ((TextView)paramViewGroup.findViewById(2131365804));
    this.mDeveloperQualifications = ((TextView)paramViewGroup.findViewById(2131365805));
