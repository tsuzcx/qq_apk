  ...
  extends ViewDragHelper.Callback
{
  ...
  public void onViewReleased(View paramView, float paramFloat1, float paramFloat2, MotionEvent paramMotionEvent)
  {
    ...
    else
    {
      ...
      bool = SwipeBackLayout.access$900(this.this$0).u(paramView.getServiceType(), paramView.getSubType());
      j = 0;
      ...
      if (!SwipeBackLayout.access$900(this.this$0).canAddColorNote()) {
        break label341;
      }
      paramView = paramView.parseBundle();
      paramView.putInt("color_note_curd_from_type", 1);
      SwipeBackLayout.access$900(this.this$0).cm(paramView);
      anot.a(null, "dc00898", "", "", "0X800A742", "0X800A742", aeax.gT(SwipeBackLayout.access$1200(this.this$0).getColorNote().mServiceType), 0, "", "", "", "");
      i = 0;
      j = 1;
      label258:
