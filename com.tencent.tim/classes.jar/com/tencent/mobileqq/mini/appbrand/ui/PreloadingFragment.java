  ...
  extends PublicBaseFragment
{
  ...
  private static LruCache<String, MiniAppConfigCache> sMiniAppConfigCache;
  private Bundle mBundle;
  private LinearLayout mLoadingView = (LinearLayout)this.mRootView.findViewById(2131370805);
  private ResultReceiver mResultReceiver;
  private View mRootView = LayoutInflater.from(BaseApplicationImpl.getContext()).inflate(2131559594, null);
  ...
  public static void addAppConfigCache(MiniAppConfig paramMiniAppConfig)
  {
    ...
    MiniAppConfigCache localMiniAppConfigCache = new MiniAppConfigCache();
  ...
  private void doRequestByLink(String paramString1, int paramInt, String paramString2, LaunchParam paramLaunchParam)
  {
    if (mEnableDBCache)
    {
        ...
        if (paramString2 != null)
        {
          ...
          if ((paramString2 != null) && (paramString2.size() == 1))
          {
            ...
            if (paramString2 != null)
            {
              ...
              localMiniAppConfig = getShowInfoFromDB(paramString2, paramString1, paramInt, null, paramLaunchParam);
              if (localMiniAppConfig != null)
              {
      ...
      if (MiniAppLauncher.isMiniAppSchemeV2(paramString1)) {
        try
        {
          paramString2 = (String)aurr.getArgumentsFromURL(paramString1).get("_mappid");
          QLog.d("PreloadingFragment", 4, "scheme: appid:  " + paramString2);
          if (!TextUtils.isEmpty(paramString2))
          {
            localMiniAppConfig = getShowInfoFromDB(paramString2, paramString1, paramInt, "", paramLaunchParam);
            if (localMiniAppConfig != null)
            {
              QLog.d("miniapp-db", 1, "start by showinfo " + paramString2);
              MiniAppController.startApp(getActivity(), localMiniAppConfig, this.mResultReceiver);
  ...
  public static MiniAppConfig findAppConfigFromCache(String paramString)
  {
    ...
    MiniAppConfigCache localMiniAppConfigCache = (MiniAppConfigCache)sMiniAppConfigCache.get(paramString);
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    {
      this.mRootView = LayoutInflater.from(getActivity()).inflate(2131559594, null);
      this.mLoadingView = ((LinearLayout)this.mRootView.findViewById(2131370805));
    }
