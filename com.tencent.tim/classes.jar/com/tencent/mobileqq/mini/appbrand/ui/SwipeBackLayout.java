  ...
  extends FrameLayout
{
  ...
  private void fullDialog()
  {
    ...
    this.mDialog.setTitle(getContext().getString(2131691732));
    this.mDialog.setNegativeButton(getContext().getString(2131691731), new SwipeBackLayout.5(this, (Activity)localObject));
    for (;;)
    {
      this.mDialog.show();
  ...
  private void setColorNoteStateNotice()
  {
    if (this.mColorNoteStateNotice == null)
    {
      ...
      this.mColorNoteCurd.setOnColorNoteCurdListener(new SwipeBackLayout.3(this));
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (Math.abs(i) < aqgz.getDesity() * 30.0F) {}
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if ((this.mColorNoteCurd == null) || (!this.mColorNoteCurd.getSyncState()))
    {
    ...
    {
      bool = this.mColorNoteCurd.u(localColorNote.getServiceType(), localColorNote.getSubType());
