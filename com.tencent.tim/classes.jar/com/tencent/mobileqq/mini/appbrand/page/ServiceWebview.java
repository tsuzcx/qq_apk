  ...
  extends AbstactJsRuntime
{
  ...
  public ServiceWebview(Context paramContext, String paramString, Callback paramCallback)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.mEnableNativeBuffer)
        {
          ...
          localStringBuilder = localStringBuilder.append((String)localObject).append("__qqConfig.appContactInfo.operationInfo = {};__qqConfig.appContactInfo.operationInfo.jsonInfo = {};__qqConfig.appContactInfo.operationInfo.jsonInfo.apiAvailable = {'navigateToMiniProgramConfig':0,'shareCustomImageUrl':1,'share':0,'authorize':0,'navigateToMiniProgram':1,'getUserInfo':0,'openSetting':0};__qqConfig.platform = 'android';__qqConfig.QUA='").append(avpq.getQUA3()).append("';__qqConfig.frameworkInfo = {};__qqConfig.frameworkInfo.isAlpha=");
          if (i == 0)
          {
            localObject = "false";
  ...
  {
    this.mJsContext.addJavascriptInterface(new ServiceInterface(null), "WeixinJSCore");
    this.mJsContext.addJavascriptInterface(new MainWorkerInterface(null), "WeixinWorker");
  }
  ...
  {
    public abstract void onJscoreInited();
  }
  
  class MainWorkerInterface
  {
    ...
    public int create(String paramString)
    {
      ...
      if (ServiceWebview.this.mAppBrandRuntime == null)
      {
        Object localObject = ServiceWebview.this.apkgInfo;
        if (localObject != null)
        {
          ...
          if ((localObject != null) && (((MiniAppConfig)localObject).config != null))
          {
            ...
            if (localAppBrandRuntimeContainer != null)
            {
              ...
              ServiceWebview.this.mAppBrandRuntime = ((AppBrandRuntime)localObject);
            }
          }
        }
      }
      if ((ServiceWebview.this.mAppBrandRuntime != null) && (ServiceWebview.this.mAppBrandRuntime.miniAppWorkerManager != null)) {
        return ServiceWebview.this.mAppBrandRuntime.miniAppWorkerManager.handleCreateWorker(paramString, ServiceWebview.this.apkgInfo);
      }
      return 0;
    }
    ...
    public void postMsgToAppService(String paramString)
    {
      ...
      if ((ServiceWebview.this.mAppBrandRuntime != null) && (ServiceWebview.this.mAppBrandRuntime.miniAppWorkerManager != null)) {
        ServiceWebview.this.mAppBrandRuntime.miniAppWorkerManager.handlePostMsgToServiceWebview(paramString);
      }
    }
    ...
    public void postMsgToWorker(Object paramObject, String paramString)
    {
      ...
      if ((ServiceWebview.this.mAppBrandRuntime != null) && (ServiceWebview.this.mAppBrandRuntime.miniAppWorkerManager != null)) {
        ServiceWebview.this.mAppBrandRuntime.miniAppWorkerManager.handlePostMsgToWorker(paramObject, paramString);
      }
    }
  ...
  class ServiceInterface
  {
    ...
    public String invokeHandler(String paramString1, String paramString2, int paramInt)
    {
      ...
      if (ServiceWebview.this.appBrandEventInterface != null) {
        return ServiceWebview.this.appBrandEventInterface.onServiceNativeRequest(paramString1, paramString2, paramInt);
      }
      return "";
    }
    ...
    public void publishHandler(String paramString1, String paramString2, String paramString3)
    {
      ...
      {
        paramString3 = AppBrandRuntimeContainer.g().getAppBrandRunTime(ServiceWebview.this.apkgInfo.appId, ServiceWebview.this.apkgInfo.appConfig.config.verType);
      ...
      else if (ServiceWebview.this.appBrandEventInterface != null)
      {
        ServiceWebview.this.appBrandEventInterface.onServiceEvent(paramString1, paramString2, JSUtil.jsStringToJavaIntArray(paramString3));
      }
    }
  }
}
