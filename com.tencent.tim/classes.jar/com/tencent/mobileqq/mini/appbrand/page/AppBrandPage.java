  ...
  implements PageWebview.PageWebViewListener, SwipeBackLayout.Callback, NavigationBar.Listener
{
  ...
  {
    return aqnm.dpToPx(44.0F) + ImmersiveUtils.getStatusBarHeight(getContext());
  }
  
  private int getDefaultTabBarHeight()
  {
    return aqnm.dpToPx(54.0F);
  }
    ...
    for (;;)
    {
      ...
      if (i > 1)
      {
        ...
        if ((this.appBrandRuntime.activity instanceof AppBrandUI))
        {
          ...
          setServiceInfo((aebf)localObject2);
  ...
  public void reportPageVisit(String paramString)
  {
    ...
    try
    {
      ...
      label44:
      VACDReportUtil.b(this.appBrandPageContainer.appBrandRuntime.mReportSeqNo, null, "PageVisit", ((JSONObject)localObject).toString(), 0, null);
  ...
  public void showToastView(int paramInt1, String paramString1, String paramString2, CharSequence paramCharSequence, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localQQToast.setToastIcon(new BitmapDrawable(paramString2));
          localQQToast.setToastMsg(paramCharSequence);
          localQQToast.setDuration(paramInt2);
          localQQToast.show();
      ...
      if ("none".equals(paramString1)) {
        ...
        localQQToast.setToastIcon(ToastView.getIconRes(paramString1));
      }
    }
  }
    ...
    extends BroadcastReceiver
  {
    ...
    public void onReceive(Context paramContext, Intent paramIntent)
    {
      ...
      for (paramContext = "show";; paramContext = "hide")
      {
        ...
        if (AppBrandPage.this.mNeedShowMonitorView != bool) {
          AppBrandPage.access$002(AppBrandPage.this, AppBrandPage.this.clickMonitorPanel());
        }
        return;
      }
    }
