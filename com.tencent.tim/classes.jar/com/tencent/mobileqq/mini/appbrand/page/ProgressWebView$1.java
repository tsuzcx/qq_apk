  ...
  extends WebChromeClient
{
  ...
  {
    aqha.a(ProgressWebView.access$100(this.this$0).activity, paramString2, 2131721058, 2131721079, new ProgressWebView.1.2(this, paramJsResult), new ProgressWebView.1.3(this, paramJsResult)).show();
    return true;
  }
  ...
  public boolean onShowFileChooser(WebView paramWebView, ValueCallback<Uri[]> paramValueCallback, WebChromeClient.FileChooserParams paramFileChooserParams)
  {
    if (ProgressWebView.access$200(this.this$0) == null) {
      ProgressWebView.access$202(this.this$0, new jpu());
    }
    if (ProgressWebView.access$300(this.this$0) != null)
    {
      ...
      return ProgressWebView.access$200(this.this$0).onShowFileChooser(ProgressWebView.access$300(this.this$0), 2019, paramValueCallback, paramFileChooserParams);
    }
  ...
  public void openFileChooser(ValueCallback<Uri> paramValueCallback, String paramString1, String paramString2)
  {
    ...
    if (ProgressWebView.access$300(this.this$0) != null)
    {
      ...
      ProgressWebView.access$200(this.this$0).showFileChooser(ProgressWebView.access$300(this.this$0), 2019, paramValueCallback, paramString1, paramString2);
      return;
    }
