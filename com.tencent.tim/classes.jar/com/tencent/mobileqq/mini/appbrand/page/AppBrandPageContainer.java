  ...
  implements TabBarView.OnTabItemClickListener
{
  ...
  private void executeDownSubPack(String paramString1, String paramString2)
  {
    ...
    arhz localarhz = new arhz(this.appBrandRuntime.activity);
    localarhz.setMessage(acfp.m(2131702741));
    localarhz.setCancelable(false);
    localarhz.show();
    this.appBrandRuntime.apkgInfo.downloadSubPack(paramString1, new AppBrandPageContainer.1(this, paramString1, localWeakReference, paramString2, localarhz));
  }
  ...
  public void navigateBack(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        Animation localAnimation = AnimationUtils.loadAnimation(AppLoaderFactory.getAppLoaderManager().getContext(), 2130772346);
  ...
  public void navigateTo(String paramString)
  {
    ...
    {
      Toast.makeText(getContext(), acfp.m(2131702739), 0).show();
    ...
    extends BroadcastReceiver
  {
    ...
    public void onReceive(Context paramContext, Intent paramIntent)
    {
      ...
      for (paramContext = "show";; paramContext = "hide")
      {
        ...
        if (AppBrandPageContainer.this.mNeedShowMonitorView != bool)
        {
          AppBrandPageContainer.access$002(AppBrandPageContainer.this, AppBrandPageContainer.this.clickMonitorPanel());
