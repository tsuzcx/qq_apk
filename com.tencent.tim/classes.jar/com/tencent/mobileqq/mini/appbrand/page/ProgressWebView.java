  ...
  implements JsRuntime
{
  ...
  private jpu mFileChooserHelper;
  ...
  public ProgressWebView(Activity paramActivity, String paramString)
  {
    ...
    paramActivity.setUserAgent(paramActivity.getUserAgentString() + " TIM/" + aqgz.getQQVersion() + " miniProgram miniprogramhtmlwebview QMA/" + paramString);
  ...
  private void savaPicToAlbum(String paramString)
  {
    ...
    if ((this.mActivity == null) || (this.mActivity.isFinishing()))
    {
      ...
      QQToast.a(this.mActivity, 1, acfp.m(2131709978), 0).show();
    }
    if (TextUtils.isEmpty(paramString))
    {
      QLog.e("ProgressWebView", 1, "savaPicToAlbum failed, because of sourceUrl is empty");
      QQToast.a(this.mActivity, 1, acfp.m(2131709981), 0).show();
      return;
    }
    Object localObject;
  ...
  protected static boolean saveByteBufferToLocalFile(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   1: istore_3
    //   2: aload_1
    //   3: invokestatic 342	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifeq +5 -> 11
    //   9: iconst_0
    //   10: ireturn
    //   11: aconst_null
    ...
    //   17: aload 6
    //   19: astore 4
    //   21: new 449	java/io/File
    //   24: dup
    //   25: aload_1
    //   26: invokespecial 451	java/io/File:<init>	(Ljava/lang/String;)V
    //   29: astore_1
    //   30: aload 6
    //   32: astore 4
    //   34: aload_1
    //   35: invokevirtual 454	java/io/File:exists	()Z
    //   38: ifne +12 -> 50
    //   41: aload 6
    //   43: astore 4
    //   45: aload_1
    //   46: invokevirtual 457	java/io/File:createNewFile	()Z
    //   49: pop
    //   50: aload 6
    //   52: astore 4
    //   54: new 459	java/io/FileOutputStream
    //   57: dup
    //   58: aload_1
    //   59: invokespecial 462	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   62: astore_1
    //   63: aload_1
    //   64: aload_0
    //   65: invokevirtual 466	java/io/FileOutputStream:write	([B)V
    //   68: iload_3
    //   69: istore_2
    //   70: aload_1
    //   71: ifnull +9 -> 80
    //   74: aload_1
    //   75: invokevirtual 469	java/io/FileOutputStream:close	()V
    //   78: iload_3
    //   79: istore_2
    //   80: iload_2
    //   81: ireturn
    ...
    //   89: dup
    //   90: invokespecial 119	java/lang/StringBuilder:<init>	()V
    //   93: ldc_w 471
    //   96: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   99: aload_0
    //   100: invokevirtual 474	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   103: invokevirtual 141	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   106: invokestatic 253	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   109: iload_3
    //   110: istore_2
    //   111: goto -31 -> 80
    //   114: astore_1
    ...
    //   121: ldc 76
    //   123: iconst_1
    //   124: new 116	java/lang/StringBuilder
    //   127: dup
    ...
    //   137: aload_1
    //   138: invokevirtual 474	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   141: invokevirtual 141	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   144: invokestatic 253	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   147: aload_0
    //   148: ifnull +104 -> 252
    //   151: aload_0
    //   152: invokevirtual 469	java/io/FileOutputStream:close	()V
    //   155: iconst_0
    //   156: istore_2
    //   157: goto -77 -> 80
    //   160: astore_0
    ...
    //   177: aload_0
    //   178: invokevirtual 474	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   181: invokevirtual 141	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   184: invokestatic 253	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   187: iconst_0
    //   188: istore_2
    //   189: goto -109 -> 80
    //   192: astore_0
    ...
    //   195: ifnull +8 -> 203
    //   198: aload 4
    //   200: invokevirtual 469	java/io/FileOutputStream:close	()V
    //   203: aload_0
    //   204: athrow
    //   205: astore_1
    //   206: ldc 76
    //   208: iconst_1
    //   209: new 116	java/lang/StringBuilder
    //   212: dup
    //   213: invokespecial 119	java/lang/StringBuilder:<init>	()V
    //   216: ldc_w 471
    //   219: invokevirtual 129	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   222: aload_1
    //   223: invokevirtual 474	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   226: invokevirtual 141	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   229: invokestatic 253	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   232: goto -29 -> 203
    //   235: astore_0
    //   236: aload_1
    //   237: astore 4
  ...
  private void saveImageToAlbum(String paramString)
  {
    if ((this.mActivity != null) && (!this.mActivity.isFinishing()))
    {
      ...
      localObject = ShortVideoUtils.getCameraPath() + System.currentTimeMillis() / 1000L + "_" + ((File)localObject).getName();
      if (rox.saveVideoToAlbum(this.mActivity, paramString, (String)localObject))
      {
        if (QLog.isColorLevel()) {
          QLog.d("ProgressWebView", 2, "savaPicToAlbum success.");
        }
        QQToast.a(this.mActivity, 2, acfp.m(2131709968), 0).show();
        return;
      }
      QLog.e("ProgressWebView", 1, "savaPicToAlbum failed.");
      QQToast.a(this.mActivity, 1, acfp.m(2131709971), 0).show();
      return;
    }
    QLog.e("ProgressWebView", 1, "savaPicToAlbum failed. activity error.");
    QQToast.a(this.mActivity, 1, acfp.m(2131709975), 0).show();
  }
  ...
  private void sharePicToQQ(String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      QQToast.a(this.mActivity, 1, acfp.m(2131709979), 0).show();
      return;
    }
    Object localObject;
    if ((paramString.toLowerCase().startsWith("http://")) || (paramString.toLowerCase().startsWith("https://")))
  ...
  public void init(AppBrandRuntime paramAppBrandRuntime)
  {
    ...
    if (aqmr.isEmpty(this.miniAppWebviewStr)) {
  ...
  {
    if ((this.mFileChooserHelper != null) && (this.mFileChooserHelper.doOnActivityResult(paramInt1, paramInt2, paramIntent)) && (QLog.isColorLevel())) {
  ...
  class QQJSCoreInterface
  {
    ...
    public String invokeHandler(String paramString1, String paramString2, int paramInt)
    {
      ...
      if ("preVerifyJSAPI".equals(paramString1)) {
        ProgressWebView.this.handleCallbackOK(paramString1, null, paramInt);
      }
      for (;;)
      {
        return "";
        if ("invokeMiniProgramAPI".equals(paramString1))
        {
          try
          {
            ...
            ProgressWebView.this.mAppBrandRuntime.evaluateServiceSubcribeJS("onWebInvokeAppService", paramString2.toString());
            ProgressWebView.this.handleCallbackOK(paramString1, null, paramInt);
          }
          catch (Exception paramString2)
          {
            ProgressWebView.this.handleCallbackFail(paramString1, null, null, paramInt);
          }
          continue;
          label143:
          ProgressWebView.this.handleCallbackFail(paramString1, null, null, paramInt);
        ...
        else if ("checkJsApi".equals(paramString1))
        {
          try
          {
            ...
            ProgressWebView.this.handleCallbackOK(paramString1, paramString2, paramInt);
          }
          catch (Exception paramString2)
          {
            ProgressWebView.this.handleCallbackFail(paramString1, null, null, paramInt);
        ...
        else if (ProgressWebView.this.mAppBrandRuntime != null)
        {
          ProgressWebView.this.mAppBrandRuntime.jsPluginEngine.handleNativeRequest(paramString1, paramString2, (JsRuntime)ProgressWebView.this.webView, paramInt);
        }
      }
    }
  }
