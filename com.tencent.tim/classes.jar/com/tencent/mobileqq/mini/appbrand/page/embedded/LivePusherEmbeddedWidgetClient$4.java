  ...
  implements Downloader.DownloadListener
{
  ...
  {
    LivePusherEmbeddedWidgetClient.access$300(this.this$0).remove(this.val$downloadId, this.val$BGMUrl);
  ...
  {
    if (LivePusherEmbeddedWidgetClient.access$400(this.this$0))
    {
  ...
  public void onDownloadSucceed(String paramString, DownloadResult paramDownloadResult)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
          ...
          if (localFile.exists())
          {
            ...
            if (localFile.isFile())
            {
              ...
              if (localFile.length() > 0L)
              {
                ...
                localObject = aqhq.createFile(this.val$BGMFilePath);
        ...
        try
        {
          if ((!aqhq.copyFile(localFile, paramString)) || (!paramString.exists()) || (paramString.length() != localFile.length())) {
            continue;
          }
      ...
      LivePusherEmbeddedWidgetClient.access$300(this.this$0).remove(this.val$downloadId);
