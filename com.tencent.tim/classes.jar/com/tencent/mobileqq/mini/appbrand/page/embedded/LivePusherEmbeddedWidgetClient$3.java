  ...
  implements TXLivePushListenerReflect.ITXLivePushListener
{
  ...
  public void onNetStatus(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      this.val$webview.evaluateSubcribeJS("onXWebLivePusherNetStatus", localJSONObject1.toString(), LivePusherEmbeddedWidgetClient.access$200(this.this$0));
      return;
    }
  ...
  public void onPushEvent(int paramInt, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      this.val$webview.evaluateSubcribeJS("onXWebLivePusherEvent", localJSONObject.toString(), LivePusherEmbeddedWidgetClient.access$200(this.this$0));
      return;
    }
    catch (JSONException paramBundle)
    {
