  ...
  public void handleEmbeddedWidgetEvent(JsRuntime paramJsRuntime, String paramString, JSONObject paramJSONObject, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        QLog.e("miniapp-embedded-EmbeddedWidgetClientHolder", 1, "handleEmbeddedWidgetEvent removePositioningContainer, do nothing");
        return;
    ...
    } while (!"updateXWebLivePusher".equals(paramString));
