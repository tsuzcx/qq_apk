  ...
  extends SwipeBackLayout
{
  ...
  {
    this.keyBoardConfirmView = LayoutInflater.from(getContext().getApplicationContext()).inflate(2131559592, null);
    this.keyBoardConfirmView.setVisibility(8);
    ((TextView)this.keyBoardConfirmView.findViewById(2131371616)).setOnClickListener(new AbsAppBrandPage.1(this));
