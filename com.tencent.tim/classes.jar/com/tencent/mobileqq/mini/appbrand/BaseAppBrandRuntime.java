...
public abstract class BaseAppBrandRuntime
{
  ...
  public boolean isColdBootInCurrentLifeCycle;
  public boolean isGettingScreenShot;
  public List<IJsPlugin> pluginList;
  private arhz shareScreenshotProgressDialog;
  ...
  public String cutAndSaveShareScreenshot(Bitmap paramBitmap)
  {
    ...
    for (int i = (int)(((DisplayMetrics)localObject).widthPixels * 0.8D);; i = (int)(aqgz.getHeight() * 0.8D))
    {
  ...
  public void getShareScreenshot(ShareScreenshotCallback paramShareScreenshotCallback) {}
  ...
  public static abstract interface ShareScreenshotCallback
  {
    public abstract void onGetShareScreenshot(String paramString);
  }
}
