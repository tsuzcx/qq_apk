  ...
  extends BaseJsPlugin
{
  ...
  private static HashMap<String, tig> rewardedCallbackData;
  private GdtAd ad;
  ...
  private void initAdInfo(String paramString)
  {
    ...
    try
    {
      this.adInfo = ((qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(tkv.pbFromJson(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(paramString))));
      return;
    }
  ...
  public static GdtMotiveVideoPageData mockMVPageData(GdtAd paramGdtAd, String paramString, int paramInt)
  {
    ...
    label399:
    for (localObject = "";; localObject = paramGdtAd.getImageData().url)
    {
  ...
  public String handleNativeRequest(String paramString1, String paramString2, JsRuntime paramJsRuntime, int paramInt)
  {
    ...
    if (this.ad != null)
    {
      ...
      if (bool2)
      {
        ...
        this.gdtMotiveVideoPageData.resultReceiver = new AdResultReceiver(new Handler(Looper.getMainLooper()), this, localJSONException, (Activity)localObject4, paramString1, paramJsRuntime, paramInt, bool1);
        label592:
        if (bool1)
        {
    ...
    for (Object localObject3 = ((GameRuntimeLoader)localObject3).getGameEngine();; localObject3 = null)
    {
      ...
      GdtMotiveVideoFragment.b((Activity)localObject4, GdtMotiveVideoFragment.class, this.gdtMotiveVideoPageData);
      AdFrequencyLimit.setRewardVideoAdShowing(true);
      this.ad = null;
      this.adInfo = null;
      this.gdtMotiveVideoPageData = null;
      break;
      localObject3 = new tig(this, (String)localObject3, new WeakReference(localObject4), paramString1, paramJsRuntime, paramInt, bool1);
      localObject5 = ((tig)localObject3).createKey();
      if (rewardedCallbackData == null) {
        rewardedCallbackData = new HashMap();
      }
      this.gdtMotiveVideoPageData.motiveBrowsingKey = ((String)localObject5);
      rewardedCallbackData.put(localObject5, localObject3);
      break label592;
  ...
  public void onReceiveVideoClose(int paramInt1, Bundle paramBundle, String paramString1, Activity paramActivity, String paramString2, JsRuntime paramJsRuntime, int paramInt2, boolean paramBoolean)
  {
    ...
    label49:
    for (paramBundle = paramBundle.getGameEngine();; paramBundle = null)
    {
      if (paramBundle != null) {}
  ...
  public void onReceiveVideoClose(Intent paramIntent)
  {
    if ((paramIntent != null) && (rewardedCallbackData != null))
    {
      ...
      tig localtig = (tig)rewardedCallbackData.get(str);
      if (localtig != null)
      {
        Activity localActivity = (Activity)localtig.a().get();
        rewardedCallbackData.remove(str);
        onCloseAd(-1, paramIntent.getExtras(), localtig.om(), localActivity, localtig.on(), localtig.getWebView(), localtig.uV());
        if (localtig.isMiniGame())
        {
    ...
    extends ResultReceiver
  {
    ...
    public AdResultReceiver(Handler paramHandler, RewardedVideoAdPlugin paramRewardedVideoAdPlugin, String paramString1, Activity paramActivity, String paramString2, JsRuntime paramJsRuntime, int paramInt, boolean paramBoolean)
    {
      super();
