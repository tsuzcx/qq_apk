    ...
    for (;;)
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (i == 0)
        {
          ...
          localObject4 = ((JSONObject)localObject2).optString("envVersion");
          ...
          {
            ((LaunchParam)localObject8).scene = i;
            ((LaunchParam)localObject8).entryPath = ((String)localObject7);
            ...
            ((LaunchParam)localObject8).envVersion = ((String)localObject4);
            ...
            MiniAppController.startAppByAppid(this.jsPluginEngine.activityContext, (String)localObject6, (String)localObject7, (String)localObject4, (LaunchParam)localObject8, new NavigationPlugin.6(this, paramJsRuntime, paramString1, paramInt));
            this.jsPluginEngine.callbackJsEventOK(paramJsRuntime, paramString1, null, paramInt);
            break;
            localObject2 = "";
            break label701;
