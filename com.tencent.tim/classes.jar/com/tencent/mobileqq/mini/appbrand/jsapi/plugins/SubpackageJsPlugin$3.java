  ...
  implements GpkgManager.OnInitGpkgListener
{
  ...
  SubpackageJsPlugin$3(SubpackageJsPlugin paramSubpackageJsPlugin, String paramString, WeakReference paramWeakReference, int paramInt1, GameRuntimeLoader paramGameRuntimeLoader, MiniGamePkg paramMiniGamePkg, int paramInt2) {}
  ...
  public void onInitGpkgInfo(int paramInt, MiniGamePkg paramMiniGamePkg, String paramString, GpkgManager.Info paramInfo)
  {
    ...
    if (paramInt != 0)
    {
      SubpackageJsPlugin.access$000(this.this$0, this.val$webviewRef, this.val$taskId, false);
      return;
    }
    ...
    {
      paramString.getJsRuntime(1).runOnJsThread(new SubpackageJsPlugin.3.1(this, paramInfo, paramMiniGamePkg));
      return;
    }
  }
}
