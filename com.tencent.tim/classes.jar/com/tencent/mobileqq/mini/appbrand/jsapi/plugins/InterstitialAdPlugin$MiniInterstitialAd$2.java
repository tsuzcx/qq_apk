  ...
  implements MiniAppCmdInterface
{
  ...
  public void onCmdListener(boolean paramBoolean, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      ((GdtInterstitialParams)localObject).a = InterstitialAdPlugin.MiniInterstitialAd.access$600(this.this$0, paramJSONObject);
      if (InterstitialAdPlugin.MiniInterstitialAd.access$700(this.this$0))
      {
        i = 0;
        ((GdtInterstitialParams)localObject).orientation = i;
        ((GdtInterstitialParams)localObject).aOZ = true;
        InterstitialAdPlugin.MiniInterstitialAd.access$102(this.this$0, new thm(this.val$activity, (GdtInterstitialParams)localObject));
