  ...
  extends ajmi.a
{
    ...
    throws RemoteException
  {
    ...
    onMusicStop();
    QLog.i("[mini] AudioJsPlugin", 2, "onPlaySongChanged title:" + paramSongInfo.title + " url:" + paramSongInfo.url);
  }
  
  public void onPlayStateChanged(int paramInt)
    throws RemoteException
  {
    if ((AudioJsPlugin.access$2100(this.this$0) == null) || ((AudioJsPlugin.access$2100(this.this$0).getToken() != null) && (!AudioJsPlugin.access$2100(this.this$0).getToken().equals(AudioJsPlugin.access$2400(this.this$0))))) {
      return;
    }
    ...
    case 3: 
      onMusicPause();
      AudioJsPlugin.access$3202(this.this$0, Math.max(AudioJsPlugin.access$2100(this.this$0).Gt(), 0));
      return;
    case 4: 
      onMusicStop();
      return;
