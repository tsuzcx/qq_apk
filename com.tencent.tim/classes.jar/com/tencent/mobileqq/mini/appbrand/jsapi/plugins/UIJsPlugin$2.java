    ...
    if ((this.val$webview instanceof GameJsRuntime))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          localQQToast.setToastIcon(new BitmapDrawable(this.val$imagePath));
          localQQToast.setToastMsg(this.val$title);
          localQQToast.setDuration(this.val$duration);
          localQQToast.show();
        ...
        if ("none".equals(this.val$icon)) {
          localThrowable.setType(-1);
        } else {
          localThrowable.setToastIcon(ToastView.getIconRes(this.val$icon));
        }
      }
    }
