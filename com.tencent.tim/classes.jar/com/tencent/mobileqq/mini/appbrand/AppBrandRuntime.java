  ...
  implements AppBrandServiceEventInterface
{
  ...
  private void getScreenshotFromView(BaseAppBrandRuntime.ShareScreenshotCallback paramShareScreenshotCallback, View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      ThreadManagerV2.executeOnFileThread(new AppBrandRuntime.18(this, paramShareScreenshotCallback, paramView));
    }
  }
  ...
  public void getShareScreenshot(BaseAppBrandRuntime.ShareScreenshotCallback paramShareScreenshotCallback)
  {
    ...
    do
    {
      ...
      if ((localView2 instanceof CoverMapView))
      {
        ...
        ((CoverMapView)localView2).captureImage(new AppBrandRuntime.16(this, localFrameLayout, paramShareScreenshotCallback, localView2));
        return;
      }
      ...
      {
        getCurPage().getCurrentPageWebview().shotWebview(new AppBrandRuntime.17(this, paramShareScreenshotCallback, localFrameLayout));
        return;
      }
  ...
  public void moveAppBrandToBack()
  {
    ...
    this.isColdBootInCurrentLifeCycle = false;
  ...
  public void onAppCreate(ApkgInfo paramApkgInfo, String paramString, boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      this.isColdBootInCurrentLifeCycle = true;
  ...
  public static abstract interface JsConsoleMessageListener
  {
    public abstract void onConsoleMessage(ConsoleMessage paramConsoleMessage);
  }
  
  public static abstract interface JsErrorListener
  {
    ...
    public void update(Observable paramObservable, Object paramObject)
    {
      try
      {
        if ((paramObject instanceof String))
        {
          ...
          for (;;)
          {
            if (AppBrandRuntime.this.isKeyboardShowing) {
              ThreadManager.getUIHandler().postDelayed(new AppBrandRuntime.KeyboardObserver.1(this), 50L);
            }
            AppBrandRuntime.access$502(AppBrandRuntime.this, false);
            return;
      ...
      AppBrandRuntime.access$502(AppBrandRuntime.this, true);
    }
  }
