...
public class FileUtils
{
  ...
  public static byte[] encodeFile(String paramString)
  {
    // Byte code:
    //   0: ldc 190
    //   2: invokestatic 196	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   5: astore_3
    //   6: new 68	java/io/FileInputStream
    //   9: dup
    //   10: aload_0
    //   11: invokespecial 197	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   14: astore_2
    //   15: sipush 16384
    //   18: newarray byte
    //   20: astore_0
    //   21: aload_2
    //   22: aload_0
    //   23: invokevirtual 198	java/io/FileInputStream:read	([B)I
    //   26: istore_1
    //   27: iload_1
    //   28: iconst_m1
    //   29: if_icmpeq +22 -> 51
    ...
    //   34: iconst_0
    //   35: iload_1
    //   36: invokevirtual 201	java/security/MessageDigest:update	([BII)V
    //   39: goto -18 -> 21
    //   42: astore_0
    //   43: aload_2
    //   44: invokevirtual 202	java/io/FileInputStream:close	()V
    //   47: aconst_null
    //   48: astore_0
    //   49: aload_0
    //   50: areturn
    //   51: aload_3
    //   52: invokevirtual 206	java/security/MessageDigest:digest	()[B
    //   55: astore_0
    //   56: aload_2
    //   57: invokevirtual 202	java/io/FileInputStream:close	()V
    //   60: goto -11 -> 49
    //   63: astore_2
    //   64: goto -15 -> 49
    //   67: astore_0
    ...
    //   73: astore_0
    //   74: aload_2
    //   75: invokevirtual 202	java/io/FileInputStream:close	()V
    //   78: aload_0
    //   79: athrow
    //   80: astore_0
    //   81: aconst_null
  ...
  public static byte[] fileToBytes(File paramFile)
  {
    ...
    //   24: astore 5
    //   26: aload_0
    //   27: invokevirtual 155	java/io/File:length	()J
    //   30: lstore_3
    //   31: lload_3
    //   32: ldc2_w 222
    //   35: lcmp
    ...
    //   41: lcmp
    //   42: ifgt +53 -> 95
    //   45: invokestatic 226	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   48: ifeq +28 -> 76
    //   51: ldc 228
    //   53: iconst_2
    ...
    //   66: lload_3
    //   67: invokevirtual 233	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    ...
    //   78: ifnull -71 -> 7
    //   81: aload 5
    //   83: invokevirtual 236	java/io/InputStream:close	()V
    //   86: aconst_null
    //   87: areturn
    //   88: astore_0
    //   89: aload_0
    //   90: invokevirtual 239	java/lang/Throwable:printStackTrace	()V
    //   93: aconst_null
    //   94: areturn
    //   95: lload_3
    //   96: l2i
    ...
    //   120: iload_1
    //   121: isub
    //   122: invokevirtual 242	java/io/InputStream:read	([BII)I
    //   125: istore_2
    //   126: iload_2
    //   127: iflt +10 -> 137
    //   130: iload_1
    ...
    //   144: invokestatic 226	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   147: ifeq +28 -> 175
    //   150: ldc 228
    //   152: iconst_2
    ...
    //   165: aload_0
    //   166: invokevirtual 247	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   177: ifnull +8 -> 185
    //   180: aload 5
    //   182: invokevirtual 236	java/io/InputStream:close	()V
    //   185: aload 6
    //   187: areturn
    //   188: astore_0
    //   189: aload_0
    //   190: invokevirtual 239	java/lang/Throwable:printStackTrace	()V
    //   193: goto -8 -> 185
    //   196: astore 5
    //   198: aconst_null
    //   199: astore 5
    //   201: invokestatic 226	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   204: ifeq +28 -> 232
    //   207: ldc 228
    //   209: iconst_2
    ...
    //   222: aload_0
    //   223: invokevirtual 247	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   234: ifnull -227 -> 7
    //   237: aload 5
    //   239: invokevirtual 236	java/io/InputStream:close	()V
    //   242: aconst_null
    //   243: areturn
    //   244: astore_0
    //   245: aload_0
    //   246: invokevirtual 239	java/lang/Throwable:printStackTrace	()V
    //   249: aconst_null
    //   250: areturn
    //   251: astore_0
    //   252: aconst_null
    ...
    //   257: ifnull +8 -> 265
    //   260: aload 5
    //   262: invokevirtual 236	java/io/InputStream:close	()V
    //   265: aload_0
    //   266: athrow
    //   267: astore 5
    //   269: aload 5
    //   271: invokevirtual 239	java/lang/Throwable:printStackTrace	()V
    //   274: goto -9 -> 265
    //   277: astore_0
    //   278: goto -23 -> 255
    //   281: astore_0
    ...
    throws Exception
  {
    ...
    //   7: dup
    //   8: aload_0
    //   9: invokespecial 197	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    ...
    //   21: astore_3
    //   22: aload_1
    //   23: invokestatic 196	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   26: astore_1
    //   27: aload_0
    //   28: aload_3
    //   29: invokevirtual 266	java/io/InputStream:read	([B)I
    //   32: istore_2
    //   33: iload_2
    //   34: ifle +28 -> 62
    //   37: aload_1
    ...
    //   39: iconst_0
    //   40: iload_2
    //   41: invokevirtual 201	java/security/MessageDigest:update	([BII)V
    //   44: goto -17 -> 27
    //   47: astore_3
    //   48: aload_0
    //   49: astore_1
    ...
    //   53: ifnull +7 -> 60
    //   56: aload_1
    //   57: invokevirtual 236	java/io/InputStream:close	()V
    //   60: aload_0
    //   61: athrow
    //   62: aload_0
    //   63: ifnull +7 -> 70
    //   66: aload_0
    //   67: invokevirtual 236	java/io/InputStream:close	()V
    //   70: aload_1
    //   71: invokevirtual 206	java/security/MessageDigest:digest	()[B
    //   74: invokestatic 269	com/tencent/mobileqq/mini/appbrand/utils/FileUtils:toHexString	([B)Ljava/lang/String;
    //   77: areturn
    //   78: astore_0
    //   79: goto -9 -> 70
    //   82: astore_1
  ...
  public static boolean writeFile(byte[] paramArrayOfByte, String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    //   49: aload_1
    //   50: iload_2
    //   51: invokespecial 288	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   54: astore_1
    //   55: aload_1
    //   56: aload_0
    //   57: iconst_0
