...
public class MiniAppFileManager
{
  ...
  {
    aqhq.delete(getMiniFolderPath(0), false);
  }
  ...
  private String getCurAppSdcardDir()
  {
    ...
    return MINI_FILE_SAVE_PATH + arwv.toMD5(this.curMiniAppId) + "/" + arwv.toMD5(str);
  }
  ...
  private static String getCurAppSdcardDir(String paramString)
  {
    ...
    currentUin = str;
    currentAppSdcardDir = MINI_FILE_SAVE_PATH + arwv.toMD5(paramString) + "/" + arwv.toMD5(str);
    return currentAppSdcardDir;
  }
  ...
  {
    return getLoadingAdCacheFolder() + arwv.toMD5(paramString1) + "_" + arwv.toMD5(paramString2);
  }
  ...
  private void renameTmpFolder()
  {
    ...
    aqhq.rename(str1, str2);
    this.mTmpFileNeed2DeleteAsync.add(str2);
  }
  
  public void clearAllCache()
  {
    aqhq.delete(MiniAppGlobal.getMiniCacheFilePath(), false);
  ...
  public String copyTmpFile(String paramString)
  {
    ...
    //   80: aload_0
    //   81: aload 4
    //   83: invokestatic 450	com/tencent/mobileqq/mini/appbrand/utils/MiniAppFileManager:getFileSuffix	(Ljava/io/File;)Ljava/lang/String;
    //   86: invokevirtual 453	com/tencent/mobileqq/mini/appbrand/utils/MiniAppFileManager:getTmpPath	(Ljava/lang/String;)Ljava/lang/String;
    //   89: invokespecial 178	java/io/File:<init>	(Ljava/lang/String;)V
    //   92: astore 9
    //   94: sipush 8192
    //   97: newarray byte
    //   99: astore 7
    //   101: new 455	java/io/BufferedInputStream
    //   104: dup
    //   105: new 457	java/io/FileInputStream
    //   108: dup
    //   109: aload 4
    //   111: invokespecial 460	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   114: invokespecial 463	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   117: astore 4
    //   119: new 465	java/io/BufferedOutputStream
    //   122: dup
    //   123: new 467	java/io/FileOutputStream
    //   126: dup
    //   127: aload 9
    //   129: invokespecial 468	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   132: invokespecial 471	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   135: astore_1
    //   136: aload_1
    //   137: astore 6
    //   139: aload 4
    ...
    //   143: aload 4
    //   145: aload 7
    //   147: invokevirtual 477	java/io/InputStream:read	([B)I
    //   150: istore_2
    //   151: iload_2
    //   152: iconst_m1
    ...
    //   166: iconst_0
    //   167: iload_2
    //   168: invokevirtual 483	java/io/OutputStream:write	([BII)V
    //   171: goto -35 -> 136
    //   174: astore 7
    //   176: aload_1
    //   177: astore 6
    ...
    //   185: ldc_w 485
    //   188: aload 7
    //   190: invokestatic 490	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   193: pop
    //   194: aload_1
    //   195: ifnull +7 -> 202
    //   198: aload_1
    //   199: invokevirtual 493	java/io/OutputStream:close	()V
    //   202: aload 4
    //   204: ifnull +152 -> 356
    //   207: aload 4
    //   209: invokevirtual 494	java/io/InputStream:close	()V
    //   212: iconst_0
    //   213: istore_2
    //   214: aload 8
    //   216: astore_1
    ...
    //   234: astore 5
    //   236: aload_1
    //   237: invokevirtual 497	java/io/OutputStream:flush	()V
    //   240: aload_1
    //   241: ifnull +7 -> 248
    //   244: aload_1
    //   245: invokevirtual 493	java/io/OutputStream:close	()V
    //   248: iload_3
    //   249: istore_2
    //   250: aload 4
    //   252: ifnull -38 -> 214
    //   255: aload 4
    //   257: invokevirtual 494	java/io/InputStream:close	()V
    //   260: iload_3
    //   261: istore_2
    //   262: goto -48 -> 214
    //   265: astore_1
    ...
    //   286: ifnull +8 -> 294
    //   289: aload 6
    //   291: invokevirtual 493	java/io/OutputStream:close	()V
    //   294: aload 4
    //   296: ifnull +8 -> 304
    //   299: aload 4
    //   301: invokevirtual 494	java/io/InputStream:close	()V
    //   304: aload_1
    //   305: athrow
    //   306: astore_1
    //   307: goto -59 -> 248
    ...
    if ((this.mTmpFileNeed2DeleteAsync != null) && (this.mTmpFileNeed2DeleteAsync.size() > 0))
    {
      ...
      synchronized (this.mTmpFileNeed2DeleteAsync)
      {
        ...
        if (i >= 0)
        {
          ...
          {
            aqhq.delete((String)localArrayList2.get(i), false);
  ...
  public String savePath(String paramString)
  {
    ...
    if (new File(str).exists())
    {
      ...
      if (aqhq.copyFile(str, new File(getMiniFolderPath(1), paramString).getAbsolutePath())) {
  ...
  public void updateFolderSize(int paramInt, long paramLong)
  {
    ...
    while (paramInt != 2) {
      try
      {
        ...
        {
          paramLong = aqhq.getFileOrFolderSize(getMiniFolderPath(1));
    ...
    try
    {
      ...
      {
        paramLong = aqhq.getFileOrFolderSize(getMiniFolderPath(2));
