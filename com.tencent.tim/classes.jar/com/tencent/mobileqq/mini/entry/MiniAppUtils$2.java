  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject2 = Storage.open(this.val$jsPluginEngine.activityContext, String.valueOf(aroi.a().getUin()), this.val$jsPluginEngine.appBrandRuntime.getApkgInfo().appId);
