...
{
  private static final int MINI_SEARCH_BAR_HEIGHT = aqnm.dip2px(50.0F);
  ...
  private static final int OFFSET_NODE_SCROLL = aqnm.dip2px(-120.0F);
  ...
  private int refreshHeaderHeight = aqnm.dpToPx(50.0F);
  ...
  static
  {
    MINI_TRANSLATE = aqnm.dip2px(-100.0F);
    MINI_TRIGGER_REFRESH_OFFSET = aqnm.dip2px(30.0F);
  }
  ...
  public MiniAppDesktop(Activity paramActivity, Conversation paramConversation, ListView paramListView, PullRefreshHeader paramPullRefreshHeader, DrawerFrame paramDrawerFrame, ViewGroup paramViewGroup)
  {
    ...
    this.mTitleBarView = ((ViewGroup)paramConversation.aJ());
    this.mHeadView = ((ViewGroup)paramActivity.findViewById(2131370213));
    this.mQQTabWidget = ((QQTabWidget)paramActivity.findViewById(16908307));
    this.mQQBlurView = ((QQBlurView)paramActivity.findViewById(2131381456));
    this.mListViewContainer = ((ViewGroup)paramConversation.aK());
    this.mCareNotificationBar = paramConversation.a;
    this.mTriggerFullScreenScrollY = aekv.hd(OFFSET_NODE_SCROLL);
  }
  
  private void animateOpen()
  {
    if (getCurrentTab() != MainFragment.bIk)
    {
      hideMiniAppEntry();
      return;
    }
  ...
  private void checkIfShowQbossBanner()
  {
    ...
    {
      View localView = this.mTitleBarView.findViewById(2131374494);
      if (localView != null) {
  ...
  private int getCurrentTab()
  {
    ...
    for (int i = ((MainFragment)localFragment).getCurrentTab();; i = -1)
    {
  ...
  private int getTitleBarAndStatusBarHeight()
  {
    ...
    int i = j;
    if (j == 0) {
      i = BaseApplicationImpl.getApplication().getResources().getDimensionPixelSize(2131299627) + ImmersiveUtils.getStatusBarHeight(BaseApplicationImpl.getApplication());
    }
    return i;
  }
  ...
  private void setNightMode()
  {
    try
    {
      ...
      if (localObject != null)
      {
        int i = ((Activity)localObject).getResources().getColor(2131167383);
        this.mChatTopRefresh.setTextColor(i, i, i, i, i);
        localObject = (TextView)this.mChatTopRefresh.findViewById(2131377036);
        if (localObject != null) {
  ...
  private void setNormalMode()
  {
    try
    {
      ...
      if (localObject != null)
      {
        this.mListView.setOverscrollHeader(((Activity)localObject).getResources().getDrawable(2130852004));
        int i = ((Activity)localObject).getResources().getColor(2131167383);
        this.mChatTopRefresh.setTextColor(i, i, i, i, i);
        localObject = (TextView)this.mChatTopRefresh.findViewById(2131377036);
        if (localObject != null) {
  ...
  private void updateRefreshTheme()
  {
    try
    {
      if (this.refreshView != null) {
        this.refreshView.setBackgroundResource(2130838901);
      }
      if (this.refreshProgressBar != null)
      {
        ...
        if (localObject != null)
        {
          localObject = ((Activity)localObject).getResources().getDrawable(2130839657);
  ...
  public void initUI(Activity paramActivity)
  {
    ...
    if (this.mChatTopRefresh != null)
    {
      ...
      this.refreshHeaderHeight = paramActivity.getResources().getDimensionPixelSize(2131299308);
      ...
      localObject = (ViewGroup)this.mChatTopRefresh.findViewById(2131371617);
      ((ViewGroup)localObject).addView(this.mContentView);
      this.refreshView = this.mChatTopRefresh.findViewById(2131377032);
      ...
      this.refreshTextView = ((TextView)this.mChatTopRefresh.findViewById(2131377036));
  ...
  public void onAccountChanged(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.addObserver(new RedDotAppletsObserver(this.mContentView));
  ...
  public void onTouchMoving(ARMapHongBaoListView paramARMapHongBaoListView, boolean paramBoolean, MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      ...
      if ((this.refreshProgressBar != null) && (this.refreshProgressBar.getVisibility() != 0)) {
        if ((f <= -(this.refreshHeaderHeight + MINI_TRIGGER_REFRESH_OFFSET)) && (f > this.mTriggerFullScreenScrollY)) {
          ...
          {
            this.refreshTextView.setText(2131720485);
            this.refreshState = 1;
          }
        }
      }
      for (;;)
      {
        ...
        if (f <= this.mTriggerFullScreenScrollY)
        {
          ...
          {
            this.refreshTextView.setText(2131695925);
            this.refreshState = 2;
          }
        }
        else
    ...
    if (f >= 0.0F)
    {
      ...
      label340:
      if (this.mCareNotificationBar.WH() != paramARMapHongBaoListView.mForStory)
      {
        this.mCareNotificationBar.Ct(paramARMapHongBaoListView.mForStory);
        this.mCareNotificationBar.refresh();
      }
    ...
    extends adah
  {
    ...
    public RedDotAppletsObserver(MiniAppDesktopLayout paramMiniAppDesktopLayout)
    {
    ...
    protected void updateAppletsSettingSwitchState(int paramInt)
    {
      ...
      if ((aekv.aha()) && (this.layoutReference != null))
      {
