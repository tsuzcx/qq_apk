...
public class MiniAppPrePullManager
{
  ...
  private static final String QQ_PROCESS_NAME = "com.tencent.tim";
  ...
  private MiniAppInfoPrePullWrapper getPrePullAppInfoWrapperById(String paramString1, String paramString2)
  {
    if (prePullAppInfoMapForId != null)
    {
      paramString1 = (MiniAppInfoPrePullWrapper)prePullAppInfoMapForId.get(paramString1);
  ...
  private MiniAppInfoPrePullWrapper getPrePullAppInfoWrapperByLink(String paramString)
  {
    if (prePullAppInfoMapForLink != null) {
      return (MiniAppInfoPrePullWrapper)prePullAppInfoMapForLink.get(paramString);
    }
    return null;
  }
  ...
  public void prePullAppinfoById(String paramString1, String paramString2, String paramString3, IPrePullListener paramIPrePullListener)
  {
    ...
    do
    {
      ...
      MiniAppInfoPrePullWrapper localMiniAppInfoPrePullWrapper = getPrePullAppInfoWrapperById(paramString1, paramString2);
  ...
  public void prePullAppinfoByLink(String paramString, int paramInt, boolean paramBoolean, IPrePullListener paramIPrePullListener)
  {
    ...
    do
    {
      ...
      if ((localObject != null) && (!((String)localObject).equals("com.tencent.tim")))
      {
  ...
  public static abstract interface IPrePullListener
  {
    public abstract void onPrePullCallback(boolean paramBoolean, JSONObject paramJSONObject);
  }
  ...
  public static class MiniAppInfoPrePullWrapper
  {
    ...
    public void setPullTimeStamp(long paramLong)
    {
      this.pullTimeStamp = paramLong;
    }
  }
}
