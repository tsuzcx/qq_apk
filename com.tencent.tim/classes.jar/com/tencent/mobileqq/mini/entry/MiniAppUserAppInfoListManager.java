  ...
  implements Manager
{
  ...
  private acci redDotObserver = new MiniAppUserAppInfoListManager.1(this);
  ...
  public void sendUserAppListRequest(long paramLong1, long paramLong2)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        localObject = (adag)((AppInterface)localObject).getBusinessHandler(148);
        if (localObject != null)
        {
          ((adag)localObject).cPu();
