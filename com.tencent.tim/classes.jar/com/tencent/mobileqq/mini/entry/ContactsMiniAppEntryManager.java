...
import com.tencent.mobileqq.activity.contacts.pullrefresh.CommonRefreshLayout.a;
...
public class ContactsMiniAppEntryManager
  implements CommonRefreshLayout.a, DrawerFrame.c, BusinessObserver
{
  ...
  {
    Object localObject = FrameHelperActivity.gg;
    if (localObject != null)
    {
      localObject = (DrawerFrame)((WeakReference)localObject).get();
      if (localObject != null) {
        ((DrawerFrame)localObject).FW(paramInt);
      }
      return;
    }
  ...
  {
    View localView = this.mPullRefreshHeader.findViewById(2131377032);
    if (paramBoolean) {}
    for (int i = 0;; i = 8)
    {
      ...
      if (this.mode == 1)
      {
        ...
        if (paramInt < 0)
        {
          ...
          if (paramInt >= 0)
          {
            ...
            setRefreshLayoutVisible(paramCommonRefreshLayout.Va());
            if ((this.preMode == 1) && (this.mode == 3))
            {
              this.mContentView.recordExposureItem();
              if (this.mCurrentTab != MainFragment.bIm) {
                break label504;
              }
          ...
          for (;;)
          {
            ...
            return;
            if (paramCommonRefreshLayout.Va())
            {
              if (paramInt <= -paramCommonRefreshLayout.getHeaderViewHeight())
              {
                paramMotionEvent = (TextView)this.mPullRefreshHeader.findViewById(2131377036);
                if ((paramMotionEvent.getText().toString() != null) && (paramMotionEvent.getText().toString().contains(acfp.m(2131704480)))) {}
            ...
            break;
            label504:
            if (this.mCurrentTab == MainFragment.bIn) {
