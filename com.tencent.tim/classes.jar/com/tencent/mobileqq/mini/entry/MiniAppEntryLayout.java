  ...
  implements View.OnClickListener
{
  ...
  public MiniAppEntryLayout(@NonNull Context paramContext, ARMapHongBaoListView paramARMapHongBaoListView, int paramInt)
  {
    ...
    inflate(paramContext, 2131562581, this);
    this.mParent = ((ViewGroup)findViewById(2131371819));
    this.mRecyclerView = ((RecyclerView)findViewById(2131371316));
    this.mRecyclerView.setItemAnimator(null);
    this.mAdapter = new MiniAppEntryAdapter((Activity)paramContext, paramInt);
    if (aekv.aha())
    {
      boolean bool = ((aagv)this.mContext.app.getManager(315)).Wl();
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      this.mDefaultStateView = ((ViewGroup)findViewById(2131371571));
      this.mAppStoreEntryText = ((TextView)findViewById(2131371715));
      this.mAppStoreEntryText.setOnClickListener(this);
      this.mDotView = ((MiniAppDotAnimationView)findViewById(2131371817));
      this.mLinearLayoutManager = new MiniAppLinearLayoutManager(paramContext, 0, false);
  ...
  public void setThemeBackgroundDrawable()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 163	com/tencent/mobileqq/mini/entry/MiniAppEntryLayout:mThemeBackgroudView	Landroid/widget/ImageView;
    //   4: ifnull +24 -> 28
    //   7: invokestatic 498	com/tencent/mobileqq/theme/ThemeUtil:isDefaultTheme	()Z
    //   10: ifne +9 -> 19
    //   13: invokestatic 501	com/tencent/mobileqq/mini/entry/MiniAppUtils:isNightMode	()Z
    //   16: ifeq +36 -> 52
    //   19: aload_0
    //   20: getfield 163	com/tencent/mobileqq/mini/entry/MiniAppEntryLayout:mThemeBackgroudView	Landroid/widget/ImageView;
    //   23: bipush 8
    //   25: invokevirtual 504	android/widget/ImageView:setVisibility	(I)V
    //   28: invokestatic 498	com/tencent/mobileqq/theme/ThemeUtil:isDefaultTheme	()Z
    //   31: ifeq +54 -> 85
    //   34: aload_0
    //   35: getfield 169	com/tencent/mobileqq/mini/entry/MiniAppEntryLayout:mDefaultStateView	Landroid/view/ViewGroup;
    //   38: ldc_w 505
    //   41: invokevirtual 508	android/view/ViewGroup:setBackgroundResource	(I)V
    //   44: aload_0
    //   45: getfield 122	com/tencent/mobileqq/mini/entry/MiniAppEntryLayout:mAdapter	Lcom/tencent/mobileqq/mini/entry/MiniAppEntryAdapter;
    //   48: invokevirtual 263	com/tencent/mobileqq/mini/entry/MiniAppEntryAdapter:notifyDataSetChanged	()V
    //   51: return
    //   52: aload_0
    //   53: getfield 163	com/tencent/mobileqq/mini/entry/MiniAppEntryLayout:mThemeBackgroudView	Landroid/widget/ImageView;
    //   56: iconst_0
    //   57: invokevirtual 504	android/widget/ImageView:setVisibility	(I)V
    //   60: aload_0
    //   61: getfield 163	com/tencent/mobileqq/mini/entry/MiniAppEntryLayout:mThemeBackgroudView	Landroid/widget/ImageView;
    //   64: ldc_w 509
    //   67: invokevirtual 512	android/widget/ImageView:setImageResource	(I)V
    //   70: goto -42 -> 28
    //   73: astore_1
    //   74: ldc 20
    //   76: iconst_1
    //   77: ldc_w 514
    //   80: aload_1
    //   81: invokestatic 397	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   84: return
    //   85: aload_0
    //   86: getfield 169	com/tencent/mobileqq/mini/entry/MiniAppEntryLayout:mDefaultStateView	Landroid/view/ViewGroup;
    //   89: iconst_0
    //   90: invokevirtual 517	android/view/ViewGroup:setBackgroundColor	(I)V
    //   93: goto -49 -> 44
    //   96: astore_1
    //   97: ldc 20
    //   99: iconst_1
    //   100: iconst_2
    //   101: anewarray 519	java/lang/Object
    //   104: dup
    //   105: iconst_0
    //   106: ldc_w 521
    //   109: aastore
    ...
    //   111: iconst_1
    //   112: aload_1
    //   113: invokestatic 527	android/util/Log:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   116: aastore
    //   117: invokestatic 530	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   120: goto -76 -> 44
  ...
  static class MiniAppLinearLayoutManager
    extends LinearLayoutManager
  {
    public MiniAppLinearLayoutManager(Context paramContext)
    {
      super();
    }
    
    public MiniAppLinearLayoutManager(Context paramContext, int paramInt, boolean paramBoolean)
    {
      super(paramInt, paramBoolean);
    }
    
    public MiniAppLinearLayoutManager(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
    {
