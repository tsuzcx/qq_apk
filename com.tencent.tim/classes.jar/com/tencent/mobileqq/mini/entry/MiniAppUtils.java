...
public class MiniAppUtils
{
  ...
  {
    if ((aqmr.isEmpty(paramString)) || (paramMiniGamePkg == null)) {}
    for (;;)
    {
      return false;
      try
  ...
  {
    // Byte code:
    //   0: invokestatic 290	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_1
    //   4: aload_1
    //   5: astore_2
    //   6: aload_1
    ...
    //   9: aload_0
    //   10: arraylength
    //   11: invokevirtual 294	android/os/Parcel:unmarshall	([BII)V
    //   14: aload_1
    //   15: astore_2
    //   16: aload_1
    //   17: iconst_0
    //   18: invokevirtual 298	android/os/Parcel:setDataPosition	(I)V
    //   21: aload_1
    //   22: astore_2
    //   23: aload_1
    //   24: ldc_w 300
    //   27: invokevirtual 306	java/lang/Class:getClassLoader	()Ljava/lang/ClassLoader;
    //   30: invokevirtual 310	android/os/Parcel:readParcelable	(Ljava/lang/ClassLoader;)Landroid/os/Parcelable;
    //   33: checkcast 300	com/tencent/mobileqq/mini/apkg/MiniAppInfo
    //   36: astore_0
    //   37: aload_1
    //   38: ifnull +7 -> 45
    //   41: aload_1
    //   42: invokevirtual 313	android/os/Parcel:recycle	()V
    //   45: aload_0
    //   46: areturn
    //   47: astore_0
    //   48: aconst_null
    ...
    //   52: iconst_1
    //   53: ldc_w 315
    //   56: invokestatic 155	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   59: aload_0
    //   60: ifnull +7 -> 67
    //   63: aload_0
    //   64: invokevirtual 313	android/os/Parcel:recycle	()V
    //   67: aconst_null
    //   68: areturn
    //   69: astore_0
    //   70: aconst_null
    ...
    //   74: ldc 32
    //   76: iconst_1
    //   77: new 124	java/lang/StringBuilder
    //   80: dup
    ...
    //   90: aload_0
    //   91: invokestatic 323	android/util/Log:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    //   104: ifnull -37 -> 67
    //   107: aload_1
    //   108: invokevirtual 313	android/os/Parcel:recycle	()V
    //   111: goto -44 -> 67
    //   114: astore_0
    //   115: aconst_null
    //   116: astore_2
    ...
    //   118: ifnull +7 -> 125
    //   121: aload_2
    //   122: invokevirtual 313	android/os/Parcel:recycle	()V
    //   125: aload_0
    //   126: athrow
    //   127: astore_0
    //   128: goto -11 -> 117
  ...
  private static void fetchWnsCgiCacheData(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    locala.url = paramString3;
    locala.method = "GET";
    locala.cZb = false;
    locala.timeout = 0;
    locala.contentType = "application/x-www-form-urlencoded";
    arcz.a().a(locala, new MiniAppUtils.5(ThreadManager.getSubThreadLooper(), paramContext, paramString1, paramString2));
  }
  ...
  public static void fetchWnsCgiPreCacheData(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    paramContext = new arcz.a();
    paramContext.url = paramString2;
    paramContext.method = "GET";
    paramContext.cZb = false;
    paramContext.timeout = 0;
    paramContext.contentType = "application/x-www-form-urlencoded";
    arcz.a().a(paramContext, new MiniAppUtils.4(ThreadManager.getSubThreadLooper(), paramString3, paramString2));
  }
  ...
  public static String getCookie(String paramString)
  {
    ...
    String str1 = SwiftBrowserCookieMonster.pX(BaseApplicationImpl.getApplication().getRuntime().getAccount());
  ...
  public static Drawable getIcon(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    int i = aqnm.dpToPx(48.0F);
    ((URLDrawable.URLDrawableOptions)localObject).mRequestHeight = i;
    ((URLDrawable.URLDrawableOptions)localObject).mRequestWidth = i;
    if (paramBoolean)
    {
      ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = paramContext.getResources().getDrawable(2130841971);
      ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = paramContext.getResources().getDrawable(2130841971);
    }
    label118:
    do
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          paramContext.setTag(aqbn.d(i, i, aqnm.dpToPx(9.0F)));
  ...
  public static Drawable getIcon(Context paramContext, String paramString, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    Object localObject = URLDrawable.URLDrawableOptions.obtain();
    ((URLDrawable.URLDrawableOptions)localObject).mPlayGifImage = false;
    paramInt2 = aqnm.dpToPx(paramInt2);
    ...
    do
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          paramContext.setTag(aqbn.d(paramInt2, paramInt2, aqnm.dpToPx(9.0F)));
          paramContext.setDecodeHandler(aqbn.a);
          localObject = paramContext;
          return localObject;
        }
  ...
  public static Drawable getIcon(Context paramContext, String paramString, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    ((URLDrawable.URLDrawableOptions)localObject).mPlayGifImage = false;
    paramInt2 = aqnm.dpToPx(paramInt2);
    ((URLDrawable.URLDrawableOptions)localObject).mRequestHeight = aqnm.dpToPx(paramInt3);
    ((URLDrawable.URLDrawableOptions)localObject).mRequestWidth = paramInt2;
    if (paramBoolean)
    {
      ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = paramContext.getResources().getDrawable(paramInt1);
  ...
  public static boolean isDebugMiniApp(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).equals(arwv.encodeHexStr(paramString))))
        {
  ...
  public static void miniAppTianShuReport(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    localawmu.eBX = 1;
    localawmu.mAppId = paramString1;
    localawmu.cNQ = paramString2;
    localawmu.cNR = paramString3;
  ...
  public static void notityPullDownEntryInMainProcess(MiniAppConfig paramMiniAppConfig)
  {
    ...
    AppBrandProxy.g().sendCmd("cmd_update_pull_down_entry_list", localBundle, new MiniAppUtils.8());
  }
  ...
  public static byte[] packMiniAppInfo(MiniAppInfo paramMiniAppInfo)
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: invokestatic 290	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   5: astore_1
    //   6: aload_1
    //   7: astore_2
    //   8: aload_1
    //   9: iconst_0
    //   10: invokevirtual 298	android/os/Parcel:setDataPosition	(I)V
    //   13: aload_1
    //   14: astore_2
    //   15: aload_1
    //   16: aload_0
    //   17: iconst_0
    //   18: invokevirtual 910	android/os/Parcel:writeParcelable	(Landroid/os/Parcelable;I)V
    //   21: aload_1
    //   22: astore_2
    //   23: aload_1
    //   24: invokevirtual 914	android/os/Parcel:marshall	()[B
    //   27: astore_0
    //   28: aload_0
    //   29: astore_2
    //   30: aload_2
    ...
    //   33: ifnull +9 -> 42
    //   36: aload_1
    //   37: invokevirtual 313	android/os/Parcel:recycle	()V
    //   40: aload_2
    //   41: astore_0
    //   42: aload_0
    //   43: areturn
    ...
    //   55: dup
    //   56: invokespecial 135	java/lang/StringBuilder:<init>	()V
    //   59: ldc_w 916
    //   62: invokevirtual 128	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   65: aload_0
    //   66: invokestatic 323	android/util/Log:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   69: invokevirtual 128	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    //   81: ifnull -39 -> 42
    //   84: aload_1
    //   85: invokevirtual 313	android/os/Parcel:recycle	()V
    //   88: aconst_null
    //   89: areturn
    //   90: astore_0
    //   91: aconst_null
    ...
    //   94: ifnull +7 -> 101
    //   97: aload_2
    //   98: invokevirtual 313	android/os/Parcel:recycle	()V
    //   101: aload_0
    //   102: athrow
    //   103: astore_0
    //   104: goto -11 -> 93
  ...
  public static void performWnsCgiRequest(String paramString1, JsRuntime paramJsRuntime, String paramString2, int paramInt, BaseJsPluginEngine paramBaseJsPluginEngine)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = new arcz.a();
        ((arcz.a)localObject1).url = ((JSONObject)localObject2).optString("url");
        ((arcz.a)localObject1).jsonHeader = paramString1.toString();
        ((arcz.a)localObject1).timeout = i;
        ((arcz.a)localObject1).contentType = "application/x-www-form-urlencoded";
        ((arcz.a)localObject1).method = ((JSONObject)localObject2).optString("method", "GET");
        ((arcz.a)localObject1).cZb = ((JSONObject)localObject2).optString("responseType").equals("base64");
        ((arcz.a)localObject1).body = null;
        bool = ((JSONObject)localObject2).optString("dataType").equalsIgnoreCase("json");
        if (TextUtils.isEmpty(((arcz.a)localObject1).url))
        {
      ...
      for (((arcz.a)localObject1).body = ((String)paramString1); TextUtils.isEmpty(((arcz.a)localObject1).method); ((arcz.a)localObject1).body = paramString1.toString())
      {
        paramBaseJsPluginEngine.callbackJsEventFail(paramJsRuntime, paramString2, null, "wrong method", paramInt);
        return;
      }
      if (("get".equalsIgnoreCase(((arcz.a)localObject1).method)) || ("post".equalsIgnoreCase(((arcz.a)localObject1).method)))
      {
        ((arcz.a)localObject1).method = ((arcz.a)localObject1).method.toUpperCase();
        if ("post".equalsIgnoreCase(((arcz.a)localObject1).method)) {
          ((arcz.a)localObject1).contentType = "application/json";
        }
        i = -1;
      }
      try
      {
        ...
        localObject2 = localTicketManager.getPskey(paramString1, jml.a().dH(SwiftBrowserCookieMonster.pY(((arcz.a)localObject1).url)));
        ...
        if (i == -1)
        {
          localObject2 = SwiftBrowserCookieMonster.pZ(((arcz.a)localObject1).url);
          j = i;
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            j = i;
      ...
      if (i != -1) {
        if (!((arcz.a)localObject1).url.contains("?")) {
          break label813;
        }
      }
      for (((arcz.a)localObject1).url = (((arcz.a)localObject1).url + "&g_tk=" + i);; ((arcz.a)localObject1).url = (((arcz.a)localObject1).url + "?g_tk=" + i))
      {
        if (QLog.isColorLevel()) {
          QLog.d("MiniAppUtils", 2, "url : " + ((arcz.a)localObject1).url);
        }
        ...
        if (!arcz.a().a((arcz.a)localObject1, paramString1, getCookie(((arcz.a)localObject1).url))) {
          break;
        }
  ...
  public static boolean performWnsCgiRequest(JSONObject paramJSONObject, AsyncResult paramAsyncResult)
  {
    ...
    try
    {
      ...
      for (localObject1 = "{}";; localObject1 = ((JSONObject)localObject1).toString())
      {
        ...
        locala.contentType = "application/x-www-form-urlencoded";
        locala.method = paramJSONObject.optString("method", "GET");
        locala.cZb = paramJSONObject.optString("responseType").equals("base64");
        locala.body = null;
      ...
      if (paramJSONObject.has("data"))
      {
        ...
        locala.body = ((String)paramJSONObject);
      }
      while (TextUtils.isEmpty(locala.method))
      {
        paramAsyncResult.onReceiveResult(false, null);
        return false;
        label231:
        locala.body = paramJSONObject.toString();
        continue;
        return false;
      }
    }
    ...
    for (;;)
    {
      ...
      {
        locala.method = locala.method.toUpperCase();
        if ("post".equalsIgnoreCase(locala.method)) {
      ...
      try
      {
        ...
        localObject1 = localTicketManager.getPskey(paramJSONObject, jml.a().dH(SwiftBrowserCookieMonster.pY(locala.url)));
        ...
        if (i == -1)
        {
          localObject1 = SwiftBrowserCookieMonster.pZ(locala.url);
          j = i;
          if (!TextUtils.isEmpty((CharSequence)localObject1))
          {
            j = i;
        ...
        if (j == -1)
        {
          ...
          label682:
          for (locala.url = (locala.url + "&g_tk=" + i);; locala.url = (locala.url + "?g_tk=" + i))
          {
            if (QLog.isColorLevel()) {
              QLog.d("MiniAppUtils", 2, "url : " + locala.url);
            }
            paramJSONObject = new MiniAppUtils.6(ThreadManagerV2.getSubThreadLooper(), bool, paramAsyncResult);
            if (!arcz.a().a(locala, paramJSONObject, getCookie(locala.url))) {
              break;
            }
            QLog.d("MiniAppUtils", 2, "performWnsCgiRequest  success");
            return true;
  ...
  public static void reportMiniAppAd(String paramString)
  {
    ...
    ThreadManager.executeOnNetWorkThread(new MiniAppUtils.12(paramString));
  }
  ...
  public static void setJump(Activity paramActivity, @NonNull View paramView, @Nullable MiniAppInfo paramMiniAppInfo, int paramInt)
  {
    ...
    {
      paramView.setOnClickListener(new MiniAppUtils.1(paramInt, paramActivity, paramMiniAppInfo));
      return;
    }
  ...
  private static void updateMiniAppMemoryCache(MiniAppConfig paramMiniAppConfig)
  {
    ...
    MiniAppCmdUtil.getInstance().getAppInfoById(null, paramMiniAppConfig.config.appId, paramMiniAppConfig.launchParam.entryPath, paramMiniAppConfig.launchParam.envVersion, new MiniAppUtils.11(paramMiniAppConfig));
  }
  ...
  public static void updatePullDownEntryListData(MiniAppConfig paramMiniAppConfig)
  {
    ...
    ThreadManager.excute(new MiniAppUtils.9(paramMiniAppConfig), 16, null, true);
    ThreadManagerV2.excute(new MiniAppUtils.10(paramMiniAppConfig), 128, null, true);
  }
}
