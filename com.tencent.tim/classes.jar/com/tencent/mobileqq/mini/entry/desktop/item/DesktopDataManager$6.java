        ...
        if (localDesktopItemInfo != null)
        {
          if (localDesktopItemInfo.getModuleType() == 1) {
            if ((localDesktopItemInfo instanceof DesktopAppInfo)) {
              localLinkedHashSet.add(DesktopDataManager.access$1200(((DesktopAppInfo)localDesktopItemInfo).mMiniAppInfo.appId, i, 1));
            }
          }
          for (;;)
          {
            ...
            {
              localLinkedHashSet.add(DesktopDataManager.access$1300(((DesktopAppModuleInfo)localDesktopItemInfo).moduleTitle, i, 1));
              continue;
              if (localDesktopItemInfo.getModuleType() == 2)
              {
                if ((localDesktopItemInfo instanceof DesktopAppInfo)) {
                  localLinkedHashSet.add(DesktopDataManager.access$1200(((DesktopAppInfo)localDesktopItemInfo).mMiniAppInfo.appId, i, 2));
                } else if ((localDesktopItemInfo instanceof DesktopAppModuleInfo)) {
                  localLinkedHashSet.add(DesktopDataManager.access$1300(((DesktopAppModuleInfo)localDesktopItemInfo).moduleTitle, i, 2));
                }
              }
              else if (localDesktopItemInfo.getModuleType() == 3)
              {
                if ((localDesktopItemInfo instanceof DesktopAppInfo)) {
                  localLinkedHashSet.add(DesktopDataManager.access$1200(((DesktopAppInfo)localDesktopItemInfo).mMiniAppInfo.appId, i, 3));
                } else if ((localDesktopItemInfo instanceof DesktopAppModuleInfo)) {
