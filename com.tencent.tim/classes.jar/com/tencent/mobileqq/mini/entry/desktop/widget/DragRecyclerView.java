...
{
  int SCROLL_OFFSET = aqnm.dip2px(20.0F);
  ...
  auwd touchHelper = new MiniItemTouchHelper(new DragRecyclerView.4(this));
  private boolean up;
  ...
  private void onDragMove(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if ((Math.abs(this.lastDragX - paramInt1) >= aqnm.dpToPx(3.0F)) || (Math.abs(this.lastDragY - paramInt2) >= aqnm.dpToPx(3.0F)))
          {
            ...
            if (paramInt2 >= getHeight() - getResources().getDimensionPixelSize(2131297169))
            {
  ...
  public DragRecyclerView setDragChangeListener(OnItemChangeListener paramOnItemChangeListener)
  {
    this.mOnItemChangeListener = paramOnItemChangeListener;
    return this;
  }
  
  public void setDragDeleteListener(DragDeleteListener paramDragDeleteListener)
  {
  ...
  public static abstract interface DragDeleteListener
  {
    public abstract void onDeleteDragComplete();
    
    public abstract void onDeleteDragFinish();
    
    public abstract void onDeleteDragStart();
  }
  
  class MiniItemTouchHelper
    extends auwd
  {
    public MiniItemTouchHelper(auwd.a parama)
    {
      super();
    }
  ...
  public static abstract interface OnItemChangeListener
  {
