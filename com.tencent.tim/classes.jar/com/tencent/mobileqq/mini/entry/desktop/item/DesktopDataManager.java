  ...
  implements Manager
{
  ...
  private acci redDotObserver = new DesktopDataManager.28(this);
  ...
  private void checkData(boolean paramBoolean)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      this.adapterItemInfos.add(new DesktopAppModuleInfo(3, acfp.m(2131704925)));
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject1))
          {
            ...
            if (((String)localObject1).contains("appid"))
            {
              if (arrayOfString1.length > 0)
              {
                ...
                if (!TextUtils.isEmpty((CharSequence)localObject1))
                {
                  localObject2 = new PositionItemInfo(null);
                  ((PositionItemInfo)localObject2).moduleType = j;
                  ((PositionItemInfo)localObject2).appId = ((String)localObject1);
                  ((PositionItemInfo)localObject2).position = k;
            ...
            else if ((((String)localObject1).contains("title")) && (arrayOfString1.length > 0))
            {
              ...
              if (!TextUtils.isEmpty((CharSequence)localObject1))
              {
                localObject2 = new PositionItemInfo(null);
                ((PositionItemInfo)localObject2).moduleType = j;
                ((PositionItemInfo)localObject2).moduleTitle = ((String)localObject1);
                ((PositionItemInfo)localObject2).position = k;
                localArrayList.add(localObject2);
              }
            }
    ...
    if (localObject1 != null)
    {
      ...
      if ((paramAppInterface != null) && (paramAppInterface.size() > 0))
      {
        ...
        for (;;)
        {
          ...
          PositionItemInfo localPositionItemInfo = (PositionItemInfo)((Iterator)localObject2).next();
          Object localObject3;
  ...
  private List<DesktopCardEntity> queryCardModuleData(AppInterface paramAppInterface)
  {
    ...
    if (localEntityManager != null) {
      paramAppInterface = localEntityManager.query(DesktopCardEntity.class, DesktopCardEntity.class.getSimpleName(), false, null, null, null, null, null, null);
    }
  ...
  private void reportToTianshu(DesktopAdData paramDesktopAdData)
  {
    ...
    try
    {
      ...
      localawmu.mTraceId = (aroi.a().getUin() + "_" + i);
      localawmu.eBX = 1;
      localawmu.mActionId = 101;
      localawmu.eBB = 1;
      localawmu.aBn = i;
      localawmu.cNR = String.valueOf(paramDesktopAdData.miniAppInfo.tianshuAdId);
  ...
  private void sendUserAppListRequestV2(COMM.StCommonExt paramStCommonExt, ArrayList<RecommendAppInfo> paramArrayList, ArrayList<Integer> paramArrayList1)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (paramArrayList1 != null)
      {
        ...
        {
          paramArrayList1 = (adag)paramArrayList1.getBusinessHandler(148);
          if (paramArrayList1 != null)
          {
            paramArrayList1.cPu();
  ...
  private boolean updateEntity(EntityManager paramEntityManager, Entity paramEntity)
  {
    ...
    QLog.d("DesktopDataManager", 2, "updateEntity em closed e=" + paramEntity.getTableName());
    return false;
  }
  ...
  public Map<String, Integer> getRedDotData()
  {
    ...
    boolean bool = aekv.agX();
    if (QLog.isColorLevel()) {
      QLog.d("DesktopDataManager", 2, "getRedDotData, showPublicAccountRedDot: " + bool);
    }
    Object localObject = MiniAppUtils.getAppInterface();
    if (localObject != null) {}
    for (localObject = ((aagv)((AppInterface)localObject).getManager(315)).A();; localObject = null)
    {
      int j = 0;
  ...
  public void setHongBaoResBuilder(HongBaoResBuilder paramHongBaoResBuilder)
  {
  ...
  public static class HongBaoResBuilder
  {
    ...
    private int fullScreenRefreshBgColor = 2147483647;
    ...
    private int refreshTextColor = 2147483647;
    private int searchBackgroundResId = -1;
    private int searchIconResId = -1;
    private int searchTitleColor = 2147483647;
    private int textColor = 2147483647;
    ...
    public HongBaoResBuilder setBackgroundFailedResId(int paramInt)
    {
      this.backgroundFailedResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setBackgroundLoadingResId(int paramInt)
    {
      this.backgroundLoadingResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setBackgroundResId(int paramInt)
    {
      this.backgroundResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setBackgroundUrl(String paramString)
    {
      this.backgroundUrl = paramString;
      return this;
    }
    
    public HongBaoResBuilder setCapsuleLeftNormalResId(int paramInt)
    {
      this.capsuleLeftNormalResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setCapsuleLeftPressResId(int paramInt)
    {
      this.capsuleLeftPressResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setCapsuleRightNormalResId(int paramInt)
    {
      this.capsuleRightNormalResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setCapsuleRightPressResId(int paramInt)
    {
      this.capsuleRightPressResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setFullScreenRefreshBgColor(int paramInt)
    {
      this.fullScreenRefreshBgColor = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setModuleMoreIconResId(int paramInt)
    {
      this.moduleMoreIconResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setMoveUpGuideBgIconResId(int paramInt)
    {
      this.moveUpGuideBgIconResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setMoveUpGuideIconResId(int paramInt)
    {
      this.moveUpGuideIconResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setRefreshArrowColor(int paramInt)
    {
      this.refreshArrowColor = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setRefreshProgressResId(int paramInt)
    {
      this.refreshProgressResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setRefreshTextColor(int paramInt)
    {
      this.refreshTextColor = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setSearchBackgroundResId(int paramInt)
    {
      this.searchBackgroundResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setSearchIconResId(int paramInt)
    {
      this.searchIconResId = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setSearchTitleColor(int paramInt)
    {
      this.searchTitleColor = paramInt;
      return this;
    }
    
    public HongBaoResBuilder setTextColor(int paramInt)
    {
