  ...
  implements DragRecyclerView.OnItemChangeListener
{
  ...
  private void doOnDragFinish(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (getItemCount() > aekv.getMaxTopNum())
        {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          if (this.mDragMirrorMarkImage != null)
          {
            ...
            label538:
            if ((Math.abs(paramInt1 - this.lastDragLeft) > aqnm.dpToPx(5.0F)) || (Math.abs(paramInt2 - this.lastDragTop) > aqnm.dpToPx(5.0F)))
            {
          ...
          try
          {
            if (this.mIntertTarget < 0)
            {
              ...
              if ((i != 0) || ((localObject1 != null) && (paramInt1 - ((RecyclerView.ViewHolder)localObject1).itemView.getLeft() >= aqnm.dpToPx(20.0F)) && (paramInt2 - ((RecyclerView.ViewHolder)localObject1).itemView.getTop() >= aqnm.dpToPx(5.0F))))
              {
  ...
  protected boolean isDragCancel()
  {
    ...
    for (int j = this.mDragViewHolder.itemView.getTop();; j = 0)
    {
      ...
      {
        bool1 = bool2;
        if (Math.abs(this.startDragX - i) < aqnm.dpToPx(15.0F))
        {
          bool1 = bool2;
          if (Math.abs(this.startDragY - j) >= aqnm.dpToPx(15.0F)) {}
        }
      }
      else
      {
  ...
  {
    return paramInt2 >= this.mRecyclerView.getHeight() - this.mRecyclerView.getResources().getDimensionPixelSize(2131297161);
  }
  ...
  public void onDragMoveImpl(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 >= this.mRecyclerView.getRight() - aqnm.dip2px(80.0F))
    {
    ...
    {
      if (paramInt1 <= aqnm.dip2px(5.0F) * -1)
      {
  ...
  public void onDragStart(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    this.mDragMirrorMarkImage.setImageResource(2130841777);
  ...
  public void onItemPrepared(int paramInt)
  {
    ...
    if (paramInt >= 0) {
      if (!this.mDeletePrepared)
      {
        ...
        if (this.mDragMirrorMarkImage != null)
        {
          this.mDragMirrorMarkImage.setImageResource(2130841776);
          this.mDragMirrorMarkImage.setVisibility(0);
        }
      }
    }
  ...
  public void setDragMirrorView(View paramView)
  {
    ...
    if (paramView != null)
    {
      this.mDragMirrorImage = ((ImageView)paramView.findViewById(2131371578));
      this.mDragMirrorMarkImage = ((ImageView)paramView.findViewById(2131371580));
      this.mDragMirrorMarkImage.setVisibility(4);
    }
  }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      while ((this.pendingMoveTargetIndex == this.moveTargetIndex) || (DragAdapter.this.mDeletePrepared)) {
        return;
      }
      ...
      DragAdapter.access$202(DragAdapter.this, i);
      DragAdapter.access$302(DragAdapter.this, k);
      DragAdapter.this.doVibrate();
      DesktopAppInfo localDesktopAppInfo1 = (DesktopAppInfo)DragAdapter.this.mData.get(i);
      if (k >= DragAdapter.this.getItemCount())
      {
        QLog.i("DragAdapter", 1, "Desktop-Drag OP_INSERT_BLANK from:" + DragAdapter.this.mDragIndex + " target:" + DragAdapter.this.getItemCount());
        localDesktopAppInfo1 = new DesktopAppInfo(3, localDesktopAppInfo1.mMiniAppInfo);
        localDesktopAppInfo1.setIsTemp(true);
        DragAdapter.this.mData.add(k, localDesktopAppInfo1);
        this.oldMoveTargetIndex = (DragAdapter.this.mData.size() - 1);
        DragAdapter.this.notifyItemInserted(k);
        return;
      }
      DesktopAppInfo localDesktopAppInfo2 = (DesktopAppInfo)DragAdapter.this.mData.get(k);
      if (localDesktopAppInfo1.mModuleType == localDesktopAppInfo2.mModuleType)
      {
        ...
        if (i < k)
        {
          ...
          while (j < k)
          {
            Collections.swap(DragAdapter.this.mData, j, j + 1);
            j += 1;
          }
        }
        int j = i;
        ...
        DragAdapter.this.notifyItemMoved(i, k);
      ...
      if (this.oldMoveTargetIndex > 0)
      {
        if (this.oldMoveTargetIndex < k)
        {
          ...
          while (i < k)
          {
            Collections.swap(DragAdapter.this.mData, i, i + 1);
            i += 1;
          }
        }
        i = this.oldMoveTargetIndex;
        ...
        DragAdapter.this.notifyItemMoved(this.oldMoveTargetIndex, k);
