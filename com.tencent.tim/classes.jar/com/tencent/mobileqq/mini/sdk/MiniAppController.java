...
public class MiniAppController
{
  ...
  private static ahyj hitPluginSession;
  ...
  static
  {
    hitPluginSession = new ahyj("mini_myfile", "com.tencent.mobileqq:mini");
  ...
  private static void launchMiniAppByLink(Context paramContext, String paramString, int paramInt, LaunchParam paramLaunchParam, MiniAppLauncher.MiniAppLaunchListener paramMiniAppLaunchListener)
  {
    ...
    if (paramContext != null)
    {
      ...
      PublicFragmentActivity.b.start(paramContext, localIntent, PublicTransFragmentActivity.class, PreloadingFragment.class);
      if ((paramContext instanceof Activity)) {
  ...
  public String handleNativeRequest(Activity paramActivity, ApkgInfo paramApkgInfo, String paramString1, String paramString2, IBridgeListener paramIBridgeListener)
  {
  ...
  public void notifyResultListener(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    try
    {
      synchronized (this.activityResultListenerList)
      {
        ...
        {
          ActivityResultListener localActivityResultListener = (ActivityResultListener)localIterator.next();
  ...
  public void removeActivityResultListener(ActivityResultListener paramActivityResultListener)
  {
  ...
  static @interface ReportForegroundType {}
}
