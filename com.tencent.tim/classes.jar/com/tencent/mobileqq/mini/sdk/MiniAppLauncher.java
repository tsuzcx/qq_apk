...
public class MiniAppLauncher
{
  ...
  private static void LaunchMiniAppBySchemeRequest(Context paramContext, String paramString, LaunchParam paramLaunchParam, MiniAppLaunchListener paramMiniAppLaunchListener)
  {
  ...
  private static void launchAppByFakeLink(Context paramContext, String paramString, LaunchParam paramLaunchParam, MiniAppLaunchListener paramMiniAppLaunchListener)
  {
    MiniAppController.startAppByLink(paramContext, paramString, 0, paramLaunchParam, paramMiniAppLaunchListener);
  }
  
  public static void launchAppByMiniCode(Context paramContext, String paramString, int paramInt, MiniAppLaunchListener paramMiniAppLaunchListener)
  {
  ...
  private static void launchAppByMiniCode(Context paramContext, String paramString, LaunchParam paramLaunchParam, MiniAppLaunchListener paramMiniAppLaunchListener)
  {
  ...
  public static void launchMiniAppById(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt, MiniAppLaunchListener paramMiniAppLaunchListener)
  {
    LaunchParam localLaunchParam = new LaunchParam();
    localLaunchParam.miniAppId = paramString1;
    localLaunchParam.scene = paramInt;
  ...
  public static boolean launchMiniAppByScheme(Context paramContext, HashMap<String, String> paramHashMap, int paramInt, EntryModel paramEntryModel, MiniAppLaunchListener paramMiniAppLaunchListener)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ("launchMiniAppByScheme appinfo param:" + localLaunchParam == null) {
          break label512;
        }
        paramHashMap = localLaunchParam.toString();
        QLog.i("MiniAppLauncher", 1, paramHashMap);
  ...
  private static boolean openMiniApp(Context paramContext, LaunchParam paramLaunchParam, MiniAppLaunchListener paramMiniAppLaunchListener)
  {
    int i = 0;
    if (QLog.isColorLevel()) {
  ...
  public static boolean startMiniApp(Context paramContext, String paramString, int paramInt, EntryModel paramEntryModel, MiniAppLaunchListener paramMiniAppLaunchListener)
  {
    int i = 2054;
  ...
  public static boolean startMiniApp(Context paramContext, String paramString, int paramInt, MiniAppLaunchListener paramMiniAppLaunchListener)
  {
  ...
  {
    String str1 = aekv.aT("mini_app_outsite_black_list", "");
    for (;;)
    {
      int i;
      try
  ...
  public static abstract interface MiniAppLaunchListener
  {
    public abstract void onLaunchResult(boolean paramBoolean, Bundle paramBundle);
  }
}
