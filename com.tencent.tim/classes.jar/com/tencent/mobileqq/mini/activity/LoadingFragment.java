  ...
  implements DialogInterface.OnDismissListener, Handler.Callback, View.OnClickListener
{
  ...
  private ajct.a mMiniLibLoadListener = new LoadingFragment.2(this);
  ...
  private void checkBaseLibVersionMatch()
  {
    ...
    for (;;)
    {
      if (bool)
      {
        String str3 = StorageUtil.getPreference().getString("version", "1.16.0.00063");
        if (QLog.isColorLevel()) {
  ...
  {
    this.root = ((RelativeLayout)paramView.findViewById(2131370813));
    this.rightContainer = ((RelativeLayout)paramView.findViewById(2131365356));
    ...
    this.mMoreView = ((ImageView)paramView.findViewById(2131363912));
    this.mCloseView = ((ImageView)paramView.findViewById(2131363823));
    this.mNameView = ((TextView)paramView.findViewById(2131367867));
    this.mLogoView = ((ImageView)paramView.findViewById(2131370909));
    this.mDeveloperInfoContainer = paramView.findViewById(2131365803);
    this.mDeveloperInfoDesc = ((TextView)paramView.findViewById(2131365804));
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 303: 
      do
      {
        ...
        initApkgByConfig();
        return false;
        Toast.makeText(getActivity().getApplicationContext(), acfp.m(2131707877), 0).show();
        this.uiHandler.postDelayed(new LoadingFragment.8(this), 1500L);
        return false;
        Toast.makeText(getActivity().getApplicationContext(), acfp.m(2131707879), 0).show();
        this.uiHandler.postDelayed(new LoadingFragment.9(this), 1500L);
        return false;
      } while (this.x5LoadingDialog == null);
      this.x5LoadingDialog.setMessage(acfp.m(2131707880) + paramMessage.arg1 + "%");
      return false;
    case 311: 
      initApkgByConfig();
      return false;
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    {
      this.mRootView = LayoutInflater.from(getActivity()).inflate(2131559573, null);
      initUI(this.mRootView);
    }
  ...
  public void onDestroy()
  {
    ...
    ajct.a().a(this.mMiniLibLoadListener);
  ...
  public void onResume()
  {
    ...
    {
      boolean bool = ImmersiveUtils.setStatusTextColor(true, getActivity().getWindow());
  ...
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    this.mStatusBar = paramView.findViewById(2131378716);
    ...
    for (paramView = (EngineChannel)paramView.getParcelableExtra("engineChannel");; paramView = null)
    {
      ...
      if (getActivity() != null) {
        Toast.makeText(getActivity(), acfp.m(2131707881), 1).show();
      }
      callActivityBackPressed();
      return;
      paramView = null;
    ...
    if (this.mDeveloperInfoContainer != null)
    {
      if ((this.mDeveloperInfoDesc != null) && (!TextUtils.isEmpty(this.appConfig.config.developerDesc)))
      {
        ...
        this.mDeveloperInfoDesc.setText(acfp.m(2131707875) + this.appConfig.config.developerDesc + acfp.m(2131707878));
      }
    }
    else
    {
