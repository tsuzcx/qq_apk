  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramView = this.mInflater.inflate(2131559599, null);
      ((ViewHolder)localObject).tvAuthTitle = ((TextView)paramView.findViewById(2131380562));
      ((ViewHolder)localObject).ivAuthDetail = ((ImageView)paramView.findViewById(2131369662));
      ((ViewHolder)localObject).authSwitcher = ((Switch)paramView.findViewById(2131379039));
