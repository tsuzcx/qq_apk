  ...
  extends OneDReader
{
  ...
  static
  {
    ...
    int[] arrayOfInt3 = { 2, 1, 1, 2, 1 };
    int[] arrayOfInt4 = { 1, 2, 1, 2, 1 };
    int[] arrayOfInt5 = { 1, 3, 1, 1, 3 };
    int[] arrayOfInt6 = { 3, 1, 1, 3, 1 };
    PATTERNS = new int[][] { arrayOfInt1, arrayOfInt2, { 1, 2, 1, 1, 2 }, { 2, 2, 1, 1, 1 }, { 1, 1, 2, 1, 2 }, { 2, 1, 2, 1, 1 }, { 1, 2, 2, 1, 1 }, { 1, 1, 1, 2, 2 }, arrayOfInt3, arrayOfInt4, { 1, 1, 3, 3, 1 }, { 3, 1, 1, 1, 3 }, arrayOfInt5, { 3, 3, 1, 1, 1 }, { 1, 1, 3, 1, 3 }, { 3, 1, 3, 1, 1 }, { 1, 3, 3, 1, 1 }, { 1, 1, 1, 3, 3 }, arrayOfInt6, { 1, 3, 1, 3, 1 } };
  }
    ...
    throws NotFoundException
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 60	com/tencent/mobileqq/mini/zxing/common/BitArray:reverse	()V
    //   4: aload_1
    //   5: invokestatic 64	com/tencent/mobileqq/mini/zxing/oned/ITFReader:skipWhiteSpace	(Lcom/tencent/mobileqq/mini/zxing/common/BitArray;)I
    //   8: istore_2
    //   9: aload_1
    //   10: iload_2
    ...
    //   14: iconst_0
    //   15: aaload
    //   16: invokestatic 68	com/tencent/mobileqq/mini/zxing/oned/ITFReader:findGuardPattern	(Lcom/tencent/mobileqq/mini/zxing/common/BitArray;I[I)[I
    //   19: astore_3
    //   20: aload_0
    //   21: aload_1
    //   22: aload_3
    //   23: iconst_0
    //   24: iaload
    //   25: invokespecial 72	com/tencent/mobileqq/mini/zxing/oned/ITFReader:validateQuietZone	(Lcom/tencent/mobileqq/mini/zxing/common/BitArray;I)V
    //   28: aload_3
    //   29: iconst_0
    //   30: iaload
    //   31: istore_2
    ...
    //   33: iconst_0
    //   34: aload_1
    //   35: invokevirtual 76	com/tencent/mobileqq/mini/zxing/common/BitArray:getSize	()I
    //   38: aload_3
    //   39: iconst_1
    //   40: iaload
    //   41: isub
    ...
    //   44: iconst_1
    //   45: aload_1
    //   46: invokevirtual 76	com/tencent/mobileqq/mini/zxing/common/BitArray:getSize	()I
    //   49: iload_2
    //   50: isub
    //   51: iastore
    //   52: aload_1
    //   53: invokevirtual 60	com/tencent/mobileqq/mini/zxing/common/BitArray:reverse	()V
    //   56: aload_3
    //   57: areturn
    //   58: astore_3
    //   59: aload_1
    ...
    //   64: iconst_1
    //   65: aaload
    //   66: invokestatic 68	com/tencent/mobileqq/mini/zxing/oned/ITFReader:findGuardPattern	(Lcom/tencent/mobileqq/mini/zxing/common/BitArray;I[I)[I
    //   69: astore_3
    //   70: goto -50 -> 20
    //   73: astore_3
    //   74: aload_1
    //   75: invokevirtual 60	com/tencent/mobileqq/mini/zxing/common/BitArray:reverse	()V
    //   78: aload_3
    //   79: athrow
