  ...
  extends RelativeLayout
{
  ...
  public void init(ThemeDIYData paramThemeDIYData, int paramInt1, int paramInt2, int paramInt3, ThemeBackground paramThemeBackground)
  {
    ...
    this.mRLayout = ((RelativeLayout)super.findViewById(2131370279));
    ...
    this.pich = paramInt3;
    this.picw = paramInt2;
    this.mUserBgView = super.findViewById(2131381388);
    this.mMaskColor = super.findViewById(2131371160);
    ...
    for (;;)
    {
      this.mShotView = super.findViewById(2131378278);
      return;
  ...
  {
    Object localObject = this.mRLayout.findViewById(2131362278);
    if (localObject != null)
    {
    ...
    while ((localObject == null) || (((ProgressBar)localObject).getParent() == null) || (((this.bgResData == null) || (this.bgResData.state >= 2)) && ((this.shotResData == null) || (this.shotResData.state >= 2))))
    {
      ...
      ((ProgressBar)localObject).setId(2131362278);
      ((ProgressBar)localObject).setIndeterminateDrawable(super.getResources().getDrawable(2130839651));
      int i = wja.dp2px(16.0F, super.getResources());
