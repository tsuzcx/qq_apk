  ...
  implements ThemeDiyStyleLogic.a
{
  ...
  public int callback(int paramInt1, int paramInt2, Bundle paramBundle, ResData paramResData)
  {
    ...
    try
    {
      ...
      anpc.a(this.this$0.mContext).collectPerformance(this.this$0.app.getAccount(), "ThemeDiyStyleLogicCallback", false, 1L, 0L, (HashMap)localObject, "", false);
      label136:
      ...
      for (;;)
      {
        ...
        if (paramInt2 == 8)
        {
          this.this$0.mHandler.sendMessage(Message.obtain(this.this$0.mHandler, 25, acfp.m(2131715302) + paramInt1));
          ...
          if ((14 == paramInt1) && (paramBundle != null))
          {
            ...
            if (paramInt2 == 4)
            {
              ...
              if (this.this$0.mUpdateUIPicAfterSaved)
              {
                ...
                this.this$0.mContext.sendBroadcast(paramResData, "com.tencent.tim.msg.permission.pushnotify");
                if (QLog.isColorLevel()) {
          ...
          else if (15 == paramInt1)
          {
            ...
            {
              this.this$0.mHandler.sendMessage(Message.obtain(this.this$0.mHandler, 26, acfp.m(2131715289)));
