  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      bool = aqwu.f(this.this$0.app.getApplication(), "ThemeDIYActivity", false);
      l = aqft.hE();
    ...
    if (j < this.this$0.showData.length)
    {
      ...
      if (k < localJSONArray2.length())
      {
        ...
        if ((!aqqi.bV(localJSONObject1.optString("minVersion"), "3.4.4")) || (aqqi.bV(localJSONObject1.optString("maxVersion"), "3.4.4")))
        {
          localObject3 = localObject2;
          m = i;
          if (!QLog.isColorLevel()) {
          ...
          QLog.d("ThemeDIYActivity", 2, "loadResJson style subVersion: 3.4.4, minVersion:" + localJSONObject1.optString("minVersion") + ", maxVersion:" + localJSONObject1.optString("maxVersion") + ", id:" + str2 + ", timeStamp:" + l);
          localObject3 = localObject2;
          m = i;
          break label1639;
        }
