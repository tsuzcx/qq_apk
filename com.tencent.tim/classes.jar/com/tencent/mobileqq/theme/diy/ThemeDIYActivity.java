...
public class ThemeDIYActivity
  ...
  implements DialogInterface.OnClickListener, View.OnClickListener, ScrollLayout.a
{
  ...
  TabBarView.a mTypeTabChangeListener = new ThemeDIYActivity.2(this);
  ...
  arhz progessDialog;
  aquy resDownloadListener = new ThemeDIYActivity.10(this);
  AdapterView.OnItemClickListener resItemClickListener = new ThemeDIYActivity.12(this);
  ThemeDiyStyleLogic.a saveStyleCallback = new ThemeDIYActivity.7(this);
  ...
  {
    return new ThemeDIYData[] { new ThemeDIYData(2130846953, "theme_bg_setting_path", 2131166853, "theme_bg_setting_path_png", -50, 0), new ThemeDIYData(2130848338, "theme_bg_message_path", 2131166855, "theme_bg_message_path_png", 50, 1), new ThemeDIYData(2130851035, "theme_bg_aio_path", 0, "theme_bg_aio_path", 0, 2), new ThemeDIYData(2130848338, "theme_bg_friend_path", 2131166855, "theme_bg_friend_path_png", 50, 3), new ThemeDIYData(2130851035, "theme_bg_dynamic_path", 2131166855, "theme_bg_dynamic_path_png", 50, 4) };
  }
    ...
    for (;;)
    {
      ...
      if ((paramThemeDIYData.tryOnBgBigOrgRD == null) || (paramThemeDIYData.tryOnBgBigRD == null) || ("100".equals(paramThemeDIYData.tryOnBgBigOrgRD.id)))
      {
        ...
        for (String str = "-";; str = paramThemeDIYData.tryOnBgBigOrgRD.id)
        {
          ...
          wkj.i(paramContext, paramString, null, "null");
          return;
        }
      }
      ...
      {
        wkj.i(paramContext, paramString, null, paramThemeDIYData.tryOnBgBigOrgRD.path);
        return;
        label309:
  ...
  void backgroundSave()
  {
          ...
          if (QLog.isColorLevel())
          {
            ...
            if (QLog.isColorLevel())
            {
              ...
              else if (localThemeDIYData2.tryOnBgBigOrgRD.state == 0)
              {
                ...
                localObject3 = new aquz(localThemeDIYData2.tryOnBgBigOrgRD.url, (File)localObject3);
                ((aqva)this.app.getManager(47)).a(1).a((aquz)localObject3, this.resDownloadListener, (Bundle)localObject2);
                continue;
                Bundle localBundle;
                acmi localacmi;
                ...
                if ((this.tryOnStyleRSD != null) && (2 == this.mStyleSetStatus)) {
                  if (this.mStyleSaveStatus == 3)
                  {
                    ...
                    if (localObject2 == null)
                    {
                      ...
                      this.mHandler.sendMessage(Message.obtain(this.mHandler, 25, acfp.m(2131715294) + this.tryOnStyleRSD.id));
                      return;
                    }
                    if (QLog.isColorLevel())
                    {
                    ...
                    if ((this.mUserThemeId == null) || (!this.mUserThemeId.equals(((ThemeUtil.ThemeInfo)localObject2).themeId))) {
                      anot.a(this.app, "CliOper", "", this.app.getCurrentAccountUin(), "theme_mall", "diy_stylesuccess", 0, 0, "", ((ThemeUtil.ThemeInfo)localObject2).themeId, "", "");
                    }
                  }
                  else
                  {
                    ...
                    localacmi = (acmi)this.app.getBusinessHandler(14);
                ...
                localacmi.a((String)localObject2, (String)localObject3, null, localBundle, this.saveStyleCallback);
                break label2158;
                label1435:
                bool1 = bool2;
                if (i < this.showData.length)
    ...
    {
      anot.a((QQAppInterface)localObject3, "CliOper", "", (String)localObject4, "theme_mall", (String)localObject1, 0, 0, String.valueOf(((ThemeDIYData)localObject2).position), String.valueOf(((ThemeDIYData)localObject2).tryOnBgRSD.id), String.valueOf(((ThemeDIYData)localObject2).tryOnBgRSD.from), "");
      ...
      anot.a(this.app, "CliOper", "", this.app.getCurrentAccountUin(), "theme_mall", "diy_savesuccess", 0, 0, "", "", "", "");
      localObject2 = null;
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          this.mContext.sendBroadcast((Intent)localObject1, "com.tencent.tim.msg.permission.pushnotify");
    ...
    for (int j = -1;; j = paramInt1)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          {
            anot.a(this.app, "CliOper", "", this.app.getCurrentAccountUin(), "theme_mall", "Join_nontop", 0, 1, "", "", "", "");
            this.isVip = true;
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    isBacked = false;
    super.setContentViewNoTitle(2131563182);
    this.mblurbgView = super.findViewById(2131363575);
    paramBundle = (TextView)super.findViewById(2131369579);
    Object localObject = (TextView)super.findViewById(2131369587);
    paramBundle.setOnClickListener(this);
    ((TextView)localObject).setOnClickListener(this);
    anot.a(this.app, "CliOper", "", this.app.getCurrentAccountUin(), "theme_mall", "enter_diy2", 0, 0, "", "", "", "");
    this.themeSwitchManager = ((aoha)this.app.getManager(185));
    this.themeSwitchManager.c = this.saveStyleCallback;
    ...
    if (Math.min(j, k) > 640)
    {
      ...
      aqhq.UD(ThemeDiyStyleLogic.getSdcardDIYDir() + ".nomedia");
      this.isDIYThemeBefore = ThemeUtil.getIsDIYTheme(null);
      if (((acle)this.app.getBusinessHandler(13)).AX() < 1) {
        break label498;
      }
    }
    int i;
    ...
    try
    {
      ...
      anpc.a(this.mContext).collectPerformance(this.app.getAccount(), "ThemeDIYActivityRun", true, 1L, 0L, paramBundle, "", false);
      label674:
      this.mScrollLayout = ((ScrollLayout)super.findViewById(2131361819));
      this.mScrollLayout.setOnScreenChangeListener(this);
      paramBundle = new ResSuitData.StyleSuit();
      this.mStyleSuits.add(paramBundle);
      paramBundle.id = "999";
      paramBundle.name = acfp.m(2131715280);
      ...
      this.mUploadBgRSD.resID = 2130846997;
      this.mUploadBgRSD.name = acfp.m(2131715284);
      ApngImage.playByTag(0);
      int m = (int)(Math.max(j, k) - aqho.convertDpToPixel(this.mContext, 305));
      int n = m * 322 / 572;
      ...
      if (i < this.showData.length)
      {
        PageView localPageView = (PageView)localLayoutInflater.inflate(2131563183, null);
        ...
        paramBundle.name = acfp.m(2131715286);
        ...
        if (2 == i)
        {
          localThemeBackground.path = ((ChatBackgroundManager)this.app.getManager(63)).lQ(null);
          j = k;
          ...
          if (localThemeBackground.path.indexOf(acbn.bmX) < 0) {
            break label1663;
          }
          paramBundle = (ChatBackgroundManager)this.app.getManager(63);
          paramBundle = ChatBackgroundManager.lS(localThemeBackground.path);
          ...
          paramBundle.id = i;
          paramBundle.scaleView = localPageView.findViewById(2131370279);
      ...
      this.pageIndicator = ((PageIndicator)super.findViewById(2131369149));
      ...
      paramBundle = (TabBarView)super.findViewById(2131378739);
      paramBundle.setUnderLineHeight(aqcx.dip2px(this, 4.0F));
      paramBundle.setTabTextSize(16);
      paramBundle.setUnselectColor(-8882056);
      paramBundle.setSelectColor(super.getResources().getColor(2131165381));
      paramBundle.setUnselectColor(super.getResources().getColor(2131165381));
      paramBundle.mPaint.setColor(super.getResources().getColor(2131166856));
      paramBundle.a("");
      paramBundle.a(acfp.m(2131715300));
      paramBundle.a("");
      paramBundle.a(acfp.m(2131715291));
      paramBundle.a("");
      paramBundle.setSelectedTab(1, false);
      paramBundle.setOnTabChangeListener(this.mTypeTabChangeListener);
      paramBundle.setBackgroundDrawable(super.getResources().getDrawable(2130848338));
      this.mResHListView = ((HorizontalListView)super.findViewById(2131379607));
      ...
      aogz.a(this.app, "theme_detail", "201", 150, aqiw.getSystemNetwork(null), 1, this.mUserThemeId, ThemeUtil.getUserCurrentThemeVersion(this.app), "2", "");
  ...
  public void doOnDestroy()
  {
    ...
    this.mHandler.removeMessages(24);
    this.themeSwitchManager.c = null;
    if (this.app != null) {
  ...
  Drawable getLocalDrawable(String paramString)
  {
    ...
    if ((localFile.exists()) && (!ChatBackgroundManager.z(localFile)))
    {
      paramString = aqcu.decodeFile(paramString, new BitmapFactory.Options());
      if (paramString != null) {
        return new afeh(this.mContext.getResources(), paramString);
      }
    }
    return null;
  }
  ...
  public boolean onBackEvent()
  {
    ...
    {
      anot.a(this.app, "CliOper", "", this.app.getCurrentAccountUin(), "theme_mall", "diy_out", 0, 0, "", "", "", "");
      if (isNeedSave()) {
        try
        {
          this.exitDialog = aqha.a(this.mContext, 230, super.getResources().getString(2131721126), acfp.m(2131715299), 2131693282, 2131721083, new ThemeDIYActivity.8(this), new ThemeDIYActivity.9(this));
      ...
      anot.a(this.app, "CliOper", "", this.app.getCurrentAccountUin(), "theme_mall", "diy_outsuccess", 0, 1, "0", "", "", "");
    }
    super.onBackEvent();
    return false;
  }
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    for (;;)
    {
      anot.a(this.app, "CliOper", "", this.app.getCurrentAccountUin(), "theme_mall", "diy_save_tips", 0, 0, String.valueOf(paramInt), "", "", "");
      return;
      if (5 == j)
      {
        ...
        {
          anot.a((QQAppInterface)localObject, "CliOper", "", str, "theme_mall", paramDialogInterface, 0, 1, "", "", "", "");
          if (paramInt != 1) {
            break;
          }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      continue;
      saveOperate(true);
      anot.a(this.app, "CliOper", "", this.app.getCurrentAccountUin(), "theme_mall", "diy_save", 0, 0, "", "", "", "");
    }
  }
  ...
  public void onPostThemeChanged()
  {
    ...
    if (this.mIsSaving.get()) {
      showTips(5, 0, null, acfp.m(2131715287), null, acfp.m(2131715281), null);
    }
    this.mIsSaving.set(false);
  ...
  {
    anot.a(this.app, "CliOper", "", this.app.getCurrentAccountUin(), "theme_mall", "skim_page2", 0, 0, String.valueOf(paramInt), "", "", "");
    if (QLog.isColorLevel()) {
  ...
  public void onUpdate(Object paramObject)
  {
    ...
    while (j != 0)
    {
      ...
      if (-404 == j)
      {
        QQToast.a(this.mContext, 2131721023, 3000).show(this.mContext.getResources().getDimensionPixelSize(2131299627));
        return;
        i = 4;
        paramObject = localObject;
        localObject = str1;
        continue;
        paramObject = acfp.m(2131715282);
        if (!TextUtils.isEmpty(str1)) {
          break label446;
        }
        localObject = acfp.m(2131715293);
        i = 1;
        continue;
        paramObject = localObject;
        if (TextUtils.isEmpty((CharSequence)localObject)) {
          paramObject = acfp.m(2131715297);
        }
        if (TextUtils.isEmpty(str1))
        {
          localObject = acfp.m(2131715279);
          i = 2;
        }
      }
      else
      {
        anot.a(this.app, "CliOper", "", this.app.getCurrentAccountUin(), "theme_mall", "diy_save_tips", 0, 0, "0", "", "", "");
  ...
  void saveOperate(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      try
      {
        ...
        {
          this.mHandler.sendMessage(Message.obtain(this.mHandler, 27, acfp.m(2131715305)));
          return;
        }
      }
      finally {}
  ...
  void setProgessDialog(boolean paramBoolean, int paramInt)
  {
    if (paramBoolean)
    {
      ...
      {
        this.progessDialog = new arhz(this.mContext, getTitleBarHeight());
  ...
  void setProgressText(String paramString)
  {
    if ((this.progessDialog != null) && (this.progessDialog.isShowing())) {
      this.progessDialog.setMessage(paramString);
    }
  }
  ...
  boolean showTips(int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    if (TextUtils.isEmpty(paramString1)) {
      paramString1 = acfp.m(2131715285);
    }
    for (;;)
    {
      if (TextUtils.isEmpty(paramString2)) {
        paramString2 = acfp.m(2131715292);
      }
      for (;;)
      {
        if (TextUtils.isEmpty(paramString3)) {
          paramString3 = acfp.m(2131715298);
        }
        for (;;)
        {
          if (TextUtils.isEmpty(paramString4)) {
            paramString4 = acfp.m(2131715303);
          }
          for (;;)
          {
            if (QLog.isColorLevel()) {
            ...
            paramString1 = aqha.a(this.mContext, 0, paramString1, paramString2, paramString3, paramString4, this, this);
