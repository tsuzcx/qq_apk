...
public class DIYThemeUtils
{
  ...
  public static android.graphics.drawable.Drawable getDIYDrawable(android.content.Context paramContext, ResData paramResData, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    //   330: aload 7
    //   332: aload_0
    //   333: invokestatic 179	aszy:cv	(Landroid/content/Context;)Z
  ...
  public static ResData getResData(AppRuntime paramAppRuntime, ResSuitData paramResSuitData, int paramInt, String paramString)
  {
    ...
    default: 
      return localResData;
    case 115: 
      localResData.path = ChatBackgroundManager.c(true, paramResSuitData.id);
      return localResData;
    case 116: 
      localResData.path = (acbn.bne + "deal/" + paramResSuitData.id);
      return localResData;
    case 110: 
      localResData.path = ChatBackgroundManager.c(true, paramResSuitData.id);
      return localResData;
    case 117: 
      localResData.path = (acbn.bnd + localResData.id + "/" + localResData.url.hashCode());
      return localResData;
    case 120: 
    case 121: 
      ...
      {
        paramAppRuntime = "0";
        paramAppRuntime = new StringBuilder().append(ThemeDiyStyleLogic.getDataDIYDir()).append(aczs.jH(paramAppRuntime)).append("/");
        if (120 != paramInt) {
          break label350;
        }
      }
