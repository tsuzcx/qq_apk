  ...
  extends RelativeLayout
{
  ...
  public void init(ResSuitData paramResSuitData1, ResSuitData paramResSuitData2, ResSuitData paramResSuitData3, boolean paramBoolean)
  {
    ...
    {
      this.mThumImg = ((ImageView)super.findViewById(2131379628));
      this.mUsedTv = ((TextView)super.findViewById(2131381381));
      this.mUsedTv.setVisibility(8);
      this.mNameTv = ((TextView)super.findViewById(2131372210));
      this.bgView = super.findViewById(2131381379);
    ...
    if (!paramBoolean)
    {
      ...
      ((ResData)localObject1).resID = 2130846997;
      i = super.getResources().getColor(2131166854);
    }
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        this.mFlagFeetype.setImageResource(2130847936);
        label281:
      ...
      for (;;)
      {
        ...
        if ("100".equals(paramResSuitData1.id))
        {
          ...
          for (i = paramResSuitData1.resID;; i = 2130846997)
          {
        ...
        if ("999".equals(paramResSuitData1.id)) {
          ((ResData)localObject1).resID = 2130846953;
        }
        ...
        {
          this.mFlagFeetype.setImageResource(2130847937);
          break label281;
        }
