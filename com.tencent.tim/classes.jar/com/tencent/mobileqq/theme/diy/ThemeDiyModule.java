...
public class ThemeDiyModule
{
  ...
  private JSONObject getDiyThemePath(int paramInt, String paramString)
  {
    ...
    if ("theme_bg_aio_path".equals(paramString)) {
      localObject3 = wkj.g(this.context, this.app.getAccount(), "");
    }
    paramString = (String)localObject2;
    if (!"null".equals(localObject3))
    {
      paramString = imageFile2Base64((String)localObject3);
      localObject1 = ChatBackgroundManager.lS((String)localObject3);
    }
  ...
  private void saveTheme(JSONObject paramJSONObject, String paramString)
  {
    ...
    aogv.c(str, new ThemeDiyModule.1(this, paramJSONObject, paramString));
  }
  ...
  public void openAlbum(Intent paramIntent, Activity paramActivity, int paramInt1, int paramInt2)
  {
    ...
    ((ResSuitData.BgSuit)localObject).resID = 2130846997;
    ((ResSuitData.BgSuit)localObject).name = acfp.m(2131715283);
  ...
  public void saveDiyTheme(JSONObject paramJSONObject, String paramString)
  {
    ...
    {
      if (this.mThemeDiyImpl != null) {
        this.mThemeDiyImpl.callJs(paramString, new String[] { new aogj(-1, "bginfos is null").toJsonString() });
      }
      return;
    }
    int i = 0;
      ...
      if (i < localJSONArray.length()) {
        ...
        catch (JSONException paramJSONObject)
        {
          for (;;)
          {
            ...
            continue;
            String str = ChatBackgroundManager.c(true, paramJSONObject);
          }
        }
      }
    }
  ...
  public void setThemeDiyImpl(a parama)
  {
    this.mThemeDiyImpl = parama;
  }
    ...
    do
    {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          {
            str = ChatBackgroundManager.c(true, localThemeDIYData.tryOnBgBigRD.id);
