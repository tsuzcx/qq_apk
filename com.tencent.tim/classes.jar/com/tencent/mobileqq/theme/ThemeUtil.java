...
public class ThemeUtil
{
  ...
  public static WeakReference<QQAppInterface> weakApp;
  ...
  {
    boolean bool = true;
    if ((isCustomTheme(true)) && (ImmersiveUtils.isSupporImmersive() != 0) && (ImmersiveUtils.aJW())) {
      if (isColorDark(paramWindow.getDecorView().getResources().getColor(2131167361))) {
        break label47;
      }
    }
    for (;;)
  ...
  public static Drawable drawableTint(Context paramContext, int paramInt1, int paramInt2)
  {
    if (!SkinEngine.getInstances().checkResExist(paramInt1)) {
      return jqg.d(paramContext.getResources().getDrawable(paramInt1), paramInt2);
    }
      ...
      try
      {
        ...
        if ((str != null) && (str.length() > 0))
        {
          ...
          if (((String)localObject1).contains("theme_810"))
          {
            ...
            if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (afgc.lO((String)localObject1)))
            {
  ...
  public static String getIDFromSCID(String paramString)
  {
    ...
    if ((paramString.startsWith("theme.android.")) && (localObject.length > 3)) {
  ...
  public static ThemeInfo getThemeInfo(Context paramContext, String paramString)
  {
    ThemeInfo localThemeInfo = null;
  ...
  public static String getUserCurrentThemeVersion(AppInterface paramAppInterface)
  {
    ...
    long l = localSharedPreferences.getLong("themeSetTimeKey", 0L);
    QLog.d("Theme.ThemeUtil", 2, "getUserCurrentThemeVersion,uin=" + aofy.aA((String)localObject1, 2) + ",currentThemeVersion=" + paramAppInterface + ", oldTime=" + l);
  ...
  private static String getUserThemeIDForReset(AppInterface paramAppInterface)
  {
    ...
    if (((SharedPreferences)localObject2).contains("currentThemeId_6.3.5"))
    {
      ...
      for (paramAppInterface = null; !TextUtils.isEmpty(paramAppInterface); paramAppInterface = getWeekLoopTheme(paramAppInterface))
      {
        if (QLog.isColorLevel()) {
      ...
      if (aqqi.bV("6.0", "3.4.4"))
      {
        ...
        if (!"1000".equals(localObject2))
        {
          ...
          if ((paramAppInterface instanceof QQAppInterface)) {
            ((acmi)((QQAppInterface)paramAppInterface).getBusinessHandler(14)).D((String)localObject2, (String)localObject3, false);
          }
        }
      }
  ...
  public static String getWeekLoopTheme(AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty(localSharedPreferences.getString("seriesID", null))) && (!TextUtils.isEmpty((CharSequence)localObject2)))
        {
  ...
  public static void initTheme(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      paramQQAppInterface = (acmi)localQQAppInterface.getBusinessHandler(14);
      if ((paramQQAppInterface != null) && (!paramQQAppInterface.cJ.compareAndSet(true, false)))
      {
      ...
      ThemeSwitcher.a(localQQAppInterface, str, "206", new aohe(localQQAppInterface));
      paramQQAppInterface = (aqri)localQQAppInterface.getBusinessHandler(103);
      if (!paramQQAppInterface.eu.get()) {
        paramQQAppInterface.c(localQQAppInterface, true);
      }
      return;
      label278:
  ...
  public static boolean isDartStatusBar(Context paramContext)
  {
    ...
    do
    {
      ...
      Color.colorToHSV(paramContext.getResources().getColor(2131166726), arrayOfFloat);
  ...
  {
    return ("1103".equals(paramString)) || (anlm.pp(paramString));
  }
  ...
  public static boolean isNowSimpleThemeUserDarkStatus(AppRuntime paramAppRuntime, boolean paramBoolean, String paramString)
  {
    String str = paramString;
    if (TextUtils.isEmpty(paramString)) {
      if (!paramBoolean) {
    ...
    label36:
    for (str = getUserCurrentThemeId(paramAppRuntime); (anlm.pp(str)) && ("3064".equals(str)); str = getCurrentThemeId()) {
      return true;
    }
    return false;
  }
  ...
  public static boolean isNowThemeIsAnimate()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject3 = aqhq.b((File)localObject5, -1);
        bool1 = bool3;
  ...
  public static boolean isSimpleAndOtherThemeSwitch()
  {
    ...
    return ((anlm.pp(lastThemeId)) || (anlm.pp(curThemeId))) && (!curThemeId.equals(lastThemeId));
  }
  ...
  public static boolean isSkinEngineInitial()
  {
    ...
    } while (((TextUtils.isEmpty(SkinEngine.getInstances().getSkinRootPath())) || (!str2.equals(str1))) && (!"1000".equals(str1)));
    return true;
  }
  ...
  public static void previewAIOTheme(Context paramContext, String paramString)
  {
    ...
    localObject = ((aqsq)localObject).getDir(paramContext, ((aqsq)localObject).getScid(99999));
    ...
    try
    {
      aqhq.W(paramString, "/storage/emulated/0/tencent/skin/aioTmp", false);
      paramString = new File("/storage/emulated/0/tencent/skin/aioTmp", "theme.zip");
      if (new File(paramString.getAbsolutePath()).exists()) {
        aqhq.W(paramString.getAbsolutePath(), "/storage/emulated/0/tencent/skin/aioTmp", false);
      }
      paramString = new File("/storage/emulated/0/tencent/skin/aioTmp", "androidXH.zip");
      if (new File(paramString.getAbsolutePath()).exists())
      {
        if (new File((String)localObject).exists()) {
          aqhq.cn((String)localObject);
        }
        aqhq.W(paramString.getAbsolutePath(), (String)localObject, false);
      }
    }
    catch (Exception paramString)
    {
      for (;;)
      {
        if (QLog.isColorLevel())
        {
          ...
          QQToast.a(paramContext, paramString.getMessage(), 0).show();
        }
      }
      QQToast.a(paramContext, "AIO主题文件不存在", 0).show();
    }
    if (new File((String)localObject).exists())
    {
      aogk.a().gd((String)localObject, 99999);
      QQToast.a(paramContext, "AIO主题切换成功", 0).show();
      return;
    }
  }
  ...
  {
    aqsp localaqsp = aqsp.a;
    paramContext = localaqsp.getDir(paramContext, localaqsp.getScid(99999));
    if ((TextUtils.isEmpty(paramString)) || ("clear".equals(paramString)))
    {
      aogn.a().gd("", 0);
      return;
    ...
    try
    {
      aqhq.W(paramString, paramContext, false);
      aogn.a().gd(paramContext, 99999);
      return;
    }
  ...
  public static Boolean setCurrentThemeIdVersion(AppRuntime paramAppRuntime, String paramString1, String paramString2)
  {
    ...
    QLog.d("Theme.ThemeUtil", 1, "setCurrentThemeIdVersion,uin=" + aofy.aA((String)localObject1, 2) + ",oldUsrThemeId=" + str + ",set new themeId=" + paramString1 + ",set new version=" + paramString2 + ", userSwitchThemeTimes=" + i + ",commitSuss=" + bool1 + ", oldTime=" + l2 + ", commitSussOld:" + bool2);
    try
    {
      paramString2 = new HashMap();
      paramString2.put("param_themeId", paramString1);
      paramString2.put("param_singleSp", String.valueOf(bool1));
      anpc.a(paramAppRuntime.getApplication().getApplicationContext()).collectPerformance((String)localObject1, "VipSetCurrentThemeIdVersion", bool1, 1L, 0L, paramString2, "", false);
      label474:
  ...
  public static Boolean setThemeInfo(Context paramContext, ThemeInfo paramThemeInfo)
  {
  ...
  public static boolean themeFont(Intent paramIntent, String paramString)
  {
    ...
    try
    {
      aqsd.XT(Integer.parseInt(paramIntent));
      return true;
    }
  ...
  private static void validLocalBg3D(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    try
    {
      ...
      aqhq.W(paramString2, (String)localObject, false);
      wkj.i(paramContext, paramString1, null, (String)localObject + "/aioImage");
