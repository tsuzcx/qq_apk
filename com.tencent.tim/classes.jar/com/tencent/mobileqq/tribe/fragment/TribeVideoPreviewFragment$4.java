  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      Object localObject1 = new File(this.val$path);
      Object localObject2 = Environment.getExternalStorageDirectory() + "/tencent/TIMfile_recv/" + ((File)localObject1).getName();
      ...
      aqhq.copyFile(this.val$path, (String)localObject1);
