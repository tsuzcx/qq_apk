...
public class e
{
  ...
  private void j()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 66	com/tencent/mobileqq/triton/audio/e:m	I
    //   4: ifle +121 -> 125
    //   7: aload_0
    //   8: getfield 64	com/tencent/mobileqq/triton/audio/e:l	I
    //   11: i2f
    //   12: fstore_1
    //   13: aload_0
    //   14: getfield 66	com/tencent/mobileqq/triton/audio/e:m	I
    //   17: istore_2
    //   18: fconst_1
    //   19: fload_1
    //   20: fmul
    ...
    //   30: dup
    //   31: invokespecial 83	java/lang/StringBuilder:<init>	()V
    //   34: ldc 183
    //   36: invokevirtual 89	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   39: fload_1
    //   40: invokevirtual 186	java/lang/StringBuilder:append	(F)Ljava/lang/StringBuilder;
    //   43: invokevirtual 96	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   46: invokestatic 101	com/tencent/mobileqq/triton/engine/TTLog:c	(Ljava/lang/String;Ljava/lang/String;)I
    //   49: pop
    //   50: aload_0
    //   51: getfield 53	com/tencent/mobileqq/triton/audio/e:h	Ljava/util/concurrent/ConcurrentHashMap;
    //   54: invokevirtual 154	java/util/concurrent/ConcurrentHashMap:values	()Ljava/util/Collection;
    //   57: invokeinterface 160 1 0
    //   62: astore_3
    //   63: aload_3
    ...
    //   78: checkcast 172	com/tencent/mobileqq/triton/sdk/audio/IAudioPlayer
    //   81: astore 4
    //   83: aload 4
    //   85: ifnull -22 -> 63
    //   88: aload 4
    ...
    //   103: ldc 188
    //   105: aload 4
    //   107: invokestatic 181	com/tencent/mobileqq/triton/engine/TTLog:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   110: pop
    //   111: goto -48 -> 63
    //   114: astore_3
    //   115: ldc 80
    //   117: ldc 190
    //   119: aload_3
    //   120: invokestatic 181	com/tencent/mobileqq/triton/engine/TTLog:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   123: pop
    //   124: return
    //   125: fconst_1
    //   126: fstore_1
  ...
  public int a(MiniGameInfo paramMiniGameInfo, int paramInt, String paramString)
  {
    try
    {
      ...
      {
        localObject = (b)this.i.get(Integer.valueOf(paramInt));
        if (localObject != null) {
          ((b)localObject).a(paramString, paramMiniGameInfo);
        }
  ...
  public void a(int paramInt, IAudioStateChangeListener paramIAudioStateChangeListener)
  {
    ...
    paramIAudioStateChangeListener = new b(this, paramInt, paramIAudioStateChangeListener);
  ...
  public void e()
  {
    ...
    //   0: ldc 80
    //   2: ldc_w 387
    //   5: invokestatic 101	com/tencent/mobileqq/triton/engine/TTLog:c	(Ljava/lang/String;Ljava/lang/String;)I
    //   8: pop
    //   9: aload_0
    //   10: getfield 48	com/tencent/mobileqq/triton/audio/e:g	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   13: iconst_0
    //   14: invokevirtual 360	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   17: aload_0
    //   18: getfield 62	com/tencent/mobileqq/triton/audio/e:k	Z
    //   21: ifne +9 -> 30
    //   24: aload_0
    //   25: iconst_1
    ...
    //   29: pop
    //   30: aload_0
    //   31: getfield 53	com/tencent/mobileqq/triton/audio/e:h	Ljava/util/concurrent/ConcurrentHashMap;
    //   34: invokevirtual 154	java/util/concurrent/ConcurrentHashMap:values	()Ljava/util/Collection;
    //   37: invokeinterface 160 1 0
    //   42: astore_1
    //   43: aload_1
    ...
    //   58: checkcast 172	com/tencent/mobileqq/triton/sdk/audio/IAudioPlayer
    //   61: astore_2
    //   62: aload_2
    //   63: ifnull -20 -> 43
    //   66: aload_2
    ...
    //   87: ldc_w 395
    //   90: aload_2
    //   91: invokestatic 181	com/tencent/mobileqq/triton/engine/TTLog:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   94: pop
    //   95: goto -52 -> 43
    //   98: aload_0
    //   99: iconst_0
    //   100: putfield 68	com/tencent/mobileqq/triton/audio/e:o	I
    //   103: return
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	104	0	this	e
  ...
  {
    Object localObject = (b)this.i.get(Integer.valueOf(paramInt));
    if (localObject != null) {
    ...
    implements IAudioStateChangeListener
  {
    ...
    public b(e parame, int paramInt, IAudioStateChangeListener paramIAudioStateChangeListener)
    {
      this.g = new WeakReference(parame);
      this.a = paramInt;
    ...
    private void b()
    {
      e.c(e.this).l().download(this.c, new e.b.a(this));
      TTLog.c("[audio] TTAudioPlayerManager", "downloadAndPlayAudio rawPath:" + this.c);
    }
    
    private void b(boolean paramBoolean)
    {
      if (a(e.c(e.this).l().getResPath(this.d, null, null)))
      {
