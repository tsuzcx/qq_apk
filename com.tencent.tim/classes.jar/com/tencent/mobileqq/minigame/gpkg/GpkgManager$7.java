  ...
  extends CmdCallback.Stub
{
    ...
    throws RemoteException
  {
    ...
    GpkgManager.access$400(paramBoolean, i, paramBundle.getLong("key_download_progress_size", 0L), paramBundle.getFloat("key_download_process_percent", 0.0F), str, (DownloadResult)paramBundle.getParcelable("key_download_result_object"), this.val$miniGamePkg, this.val$savePath, this.val$subRoot, this.val$listener);
  }
}
