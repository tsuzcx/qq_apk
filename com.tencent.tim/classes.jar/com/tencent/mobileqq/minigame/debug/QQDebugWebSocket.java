...
{
  private static final String DISCONNECT_TIPS = acfp.m(2131711621);
  private static final String DISCONNECT_TIPS_NOT_RECOVERY = acfp.m(2131711620);
  ...
  private static final String RECONNECT_TIPS = acfp.m(2131711622);
  ...
  public ProfileJsPlugin jsPlugin;
  ...
  public QQDebugWebSocket(MiniGameInfo paramMiniGameInfo)
  {
    ...
    this.jsPlugin = new ProfileJsPlugin();
  }
    ...
    public String handleNativeRequest(String paramString1, String paramString2, JsRuntime paramJsRuntime, int paramInt)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          ...
          localObject1 = QQDebugWebSocket.this.covertProfileToIdeData(((JSONObject)localObject2).toString());
          QQDebugWebSocket.this.sendQQDebugMethodMsg("DebugMessageClient", (String)localObject1);
        }
