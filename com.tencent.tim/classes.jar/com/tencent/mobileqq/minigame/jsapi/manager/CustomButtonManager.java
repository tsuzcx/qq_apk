...
public class CustomButtonManager
{
  ...
  private IGameUI mGameContainer;
  private float mScale;
  
  public CustomButtonManager(Activity paramActivity, IGameUI paramIGameUI, float paramFloat)
  {
    this.mGameContainer = paramIGameUI;
  ...
  private void setButtonParam(CustomButton.ButtonParam paramButtonParam, CustomButton.OnClickListener paramOnClickListener, boolean paramBoolean)
  {
    if (paramButtonParam == null) {
      return;
    }
    this.mGameContainer.getGameParent().post(new CustomButtonManager.3(this, paramButtonParam, paramBoolean, paramOnClickListener));
  }
  
  public boolean createCustomButton(JSONObject paramJSONObject, CustomButton.OnClickListener paramOnClickListener)
  {
  ...
  public boolean destroyCustomButton(long paramLong)
  {
    ...
    {
      this.mGameContainer.getGameParent().post(new CustomButtonManager.2(this, paramLong));
      return bool;
    }
  }
  ...
  public boolean setCustomButtonVisible(long paramLong, boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      this.mGameContainer.getGameParent().post(new CustomButtonManager.1(this, paramLong, paramBoolean));
      return bool;
    }
  }
  
  public boolean updateCustomButton(JSONObject paramJSONObject, CustomButton.OnClickListener paramOnClickListener)
  {
 ...
 * Qualified Name:     com.tencent.mobileqq.minigame.jsapi.manager.CustomButtonManager
