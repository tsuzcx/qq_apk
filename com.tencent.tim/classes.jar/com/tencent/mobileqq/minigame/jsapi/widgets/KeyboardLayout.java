  ...
  extends RelativeLayout
{
  ...
  private void init()
  {
    ...
    this.mConfirmBT.setText(acfp.m(2131707583));
    this.mConfirmBT.setTextColor(-1);
    this.mConfirmBT.setBackgroundResource(2130841843);
    ...
    this.mConfirmBT.setId(2131371736);
    localLayoutParams = new RelativeLayout.LayoutParams(-1, -2);
    localLayoutParams.addRule(0, this.mConfirmBT.getId());
    localLayoutParams.leftMargin = DpUtil.dip2px(getContext(), 4.0F);
    this.mInputET.setBackgroundResource(2130841846);
    ...
    if (!TextUtils.isEmpty(paramString)) {
      ...
      for (;;)
      {
        try
        {
          ...
          int i = 6;
          paramString = acfp.m(2131707582);
          if ("send".equals(str))
          {
            i = 4;
            paramString = acfp.m(2131707581);
          ...
          else
          {
            ...
            {
              i = 3;
              paramString = acfp.m(2131707584);
              continue;
            }
            if ("next".equals(str))
            {
              i = 5;
              paramString = acfp.m(2131707580);
              continue;
            }
            if (!"go".equals(str)) {
              continue;
