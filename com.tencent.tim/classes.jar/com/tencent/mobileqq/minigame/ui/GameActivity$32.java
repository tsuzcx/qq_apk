  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((GameActivity.access$4600(this.this$0) != null) && (!TextUtils.isEmpty(this.val$debuggerTxt))) {
      GameActivity.access$4600(this.this$0).setText(this.val$debuggerTxt);
    }
    if (!TextUtils.isEmpty(this.val$debuggerToast)) {
      Toast.makeText(this.this$0, this.val$debuggerToast, 0).show();
    }
    View localView;
    if (GameActivity.access$4700(this.this$0) != null)
    {
      localView = GameActivity.access$4700(this.this$0);
