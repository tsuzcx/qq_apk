...
class GameActivity$16
  implements Runnable
{
  GameActivity$16(GameActivity paramGameActivity, MiniAppConfig paramMiniAppConfig) {}
  ...
  public void run()
  {
    try
    {
      ...
      if (localBitmap != null)
      {
        ...
        {
          localObject = new ActivityManager.TaskDescription(this.val$miniConfig.config.name, aqhu.drawableToBitmap((Drawable)localObject));
