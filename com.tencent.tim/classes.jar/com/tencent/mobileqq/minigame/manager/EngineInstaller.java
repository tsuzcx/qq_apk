...
public class EngineInstaller
{
  ...
  private static String getInstallLibDir(File paramFile, EngineVersion paramEngineVersion)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: new 65	java/io/File
    //   6: dup
    //   7: aload_0
    //   8: aload_1
    //   9: invokevirtual 71	com/tencent/mobileqq/minigame/manager/EngineVersion:toFolderName	()Ljava/lang/String;
    //   12: invokespecial 74	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   15: astore_0
    //   16: ldc 11
    //   18: iconst_1
    //   19: new 76	java/lang/StringBuilder
    //   22: dup
    //   23: invokespecial 77	java/lang/StringBuilder:<init>	()V
    //   26: ldc 79
    //   28: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   31: aload_0
    //   32: invokevirtual 86	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   41: invokestatic 95	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   44: aload_0
    //   45: invokevirtual 99	java/io/File:exists	()Z
    //   48: ifne +45 -> 93
    //   51: aload_0
    //   52: invokevirtual 102	java/io/File:mkdirs	()Z
    //   55: ifne +38 -> 93
    //   58: ldc 11
    //   60: iconst_1
    //   61: new 76	java/lang/StringBuilder
    //   64: dup
    //   65: invokespecial 77	java/lang/StringBuilder:<init>	()V
    //   68: ldc 104
    //   70: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   73: aload_0
    //   74: invokevirtual 86	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   83: invokestatic 107	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   86: aconst_null
    //   87: astore_0
    //   88: ldc 2
    //   90: monitorexit
    ...
    //   92: areturn
    //   93: aload_0
    //   94: invokevirtual 86	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   97: astore_0
    //   98: goto -10 -> 88
    //   101: astore_0
    //   102: ldc 2
  ...
  private static List<InstalledEngine> scanInstalledEngine()
  {
    ...
    //   5: iconst_1
    //   6: ldc_w 342
    //   9: invokestatic 95	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   12: invokestatic 348	java/lang/System:currentTimeMillis	()J
    //   15: lstore 5
    //   17: new 39	java/util/ArrayList
    //   20: dup
    //   21: invokespecial 40	java/util/ArrayList:<init>	()V
    //   24: astore 7
    //   26: invokestatic 350	com/tencent/mobileqq/minigame/manager/EngineInstaller:getRootDir	()Ljava/io/File;
    //   29: astore 8
    //   31: aload 8
    //   33: invokevirtual 99	java/io/File:exists	()Z
    //   36: ifeq +375 -> 411
    //   39: aload 8
    //   41: invokevirtual 253	java/io/File:isDirectory	()Z
    //   44: ifeq +367 -> 411
    //   47: aload 8
    //   49: invokevirtual 257	java/io/File:listFiles	()[Ljava/io/File;
    //   52: ifnull +359 -> 411
    //   55: aload 8
    //   57: invokevirtual 257	java/io/File:listFiles	()[Ljava/io/File;
    //   60: astore 8
    //   62: aload 8
    //   64: arraylength
    //   65: istore_2
    ...
    //   77: astore 9
    //   79: aload 9
    //   81: invokevirtual 99	java/io/File:exists	()Z
    //   84: ifeq +320 -> 404
    //   87: aload 9
    //   89: invokevirtual 253	java/io/File:isDirectory	()Z
    //   92: ifeq +312 -> 404
    //   95: aload 9
    //   97: invokevirtual 257	java/io/File:listFiles	()[Ljava/io/File;
    //   100: astore 10
    //   102: aload 10
    //   104: ifnull +300 -> 404
    //   107: aload 9
    //   109: invokevirtual 230	java/io/File:getName	()Ljava/lang/String;
    //   112: invokestatic 355	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   115: istore_3
    //   116: aload 9
    //   118: invokevirtual 257	java/io/File:listFiles	()[Ljava/io/File;
    //   121: astore 9
    //   123: aload 9
    //   125: arraylength
    //   126: istore 4
    ...
    //   159: aload 10
    //   161: invokevirtual 86	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   170: invokestatic 361	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   173: new 131	com/tencent/mobileqq/minigame/manager/InstalledEngine
    //   176: dup
    //   177: invokespecial 362	com/tencent/mobileqq/minigame/manager/InstalledEngine:<init>	()V
    //   180: astore 11
    //   182: aload 11
    //   184: iload_3
    //   185: putfield 135	com/tencent/mobileqq/minigame/manager/InstalledEngine:engineType	I
    //   188: aload 11
    //   190: aload 10
    //   192: invokevirtual 230	java/io/File:getName	()Ljava/lang/String;
    //   195: invokestatic 234	com/tencent/mobileqq/minigame/manager/EngineVersion:fromFolderName	(Ljava/lang/String;)Lcom/tencent/mobileqq/minigame/manager/EngineVersion;
    //   198: putfield 303	com/tencent/mobileqq/minigame/manager/InstalledEngine:engineVersion	Lcom/tencent/mobileqq/minigame/manager/EngineVersion;
    //   201: aload 11
    //   203: getfield 303	com/tencent/mobileqq/minigame/manager/InstalledEngine:engineVersion	Lcom/tencent/mobileqq/minigame/manager/EngineVersion;
    //   206: ifnonnull +91 -> 297
    //   209: new 364	java/lang/IllegalStateException
    //   212: dup
    ...
    //   226: aload 10
    //   228: invokevirtual 230	java/io/File:getName	()Ljava/lang/String;
    ...
    //   237: invokespecial 367	java/lang/IllegalStateException:<init>	(Ljava/lang/String;)V
    //   240: athrow
    //   241: astore 11
    //   243: ldc 11
    //   245: iconst_1
    ...
    //   249: dup
    //   250: invokespecial 77	java/lang/StringBuilder:<init>	()V
    //   253: ldc_w 369
    //   256: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   259: aload 10
    //   261: invokevirtual 86	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   264: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   267: aload 11
    //   269: invokestatic 375	com/tencent/mobileqq/mini/utils/DebugUtil:getPrintableStackTrace	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   272: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   275: invokevirtual 89	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   278: invokestatic 95	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   281: aload 10
    //   283: invokevirtual 86	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   286: iconst_0
    //   287: invokestatic 381	com/tencent/mobileqq/mini/utils/FileUtils:delete	(Ljava/lang/String;Z)V
    //   290: iload_1
    //   291: iconst_1
    //   292: iadd
    //   293: istore_1
    ...
    //   297: aload 11
    //   299: aload 10
    //   301: invokevirtual 86	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   304: putfield 327	com/tencent/mobileqq/minigame/manager/InstalledEngine:engineDir	Ljava/lang/String;
    //   307: aload 11
    //   309: aload 11
    //   311: invokestatic 385	com/tencent/mobileqq/minigame/manager/EngineInstaller:verifyEngine	(Lcom/tencent/mobileqq/minigame/manager/InstalledEngine;)Z
    //   314: putfield 388	com/tencent/mobileqq/minigame/manager/InstalledEngine:isVerify	Z
    //   317: aload 11
    //   319: getfield 388	com/tencent/mobileqq/minigame/manager/InstalledEngine:isVerify	Z
    //   322: ifne +22 -> 344
    //   325: new 364	java/lang/IllegalStateException
    //   328: dup
    //   329: ldc_w 390
    //   332: invokespecial 367	java/lang/IllegalStateException:<init>	(Ljava/lang/String;)V
    //   335: athrow
    //   336: astore 7
    //   338: ldc 2
    //   340: monitorexit
    ...
    //   343: athrow
    //   344: aload 11
    //   346: getfield 135	com/tencent/mobileqq/minigame/manager/InstalledEngine:engineType	I
    //   349: iconst_2
    //   350: if_icmpne +32 -> 382
    //   353: aload 11
    //   355: ldc_w 392
    //   358: putfield 395	com/tencent/mobileqq/minigame/manager/InstalledEngine:engineName	Ljava/lang/String;
    //   361: aload 11
    //   363: aload 10
    //   365: invokestatic 250	com/tencent/mobileqq/minigame/manager/EngineInstaller:isPersistGameEngine	(Ljava/io/File;)Z
    //   368: putfield 289	com/tencent/mobileqq/minigame/manager/InstalledEngine:isPersist	Z
    //   371: aload 7
    //   373: aload 11
    //   375: invokevirtual 139	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   378: pop
    //   379: goto -89 -> 290
    //   382: aload 11
    //   384: getfield 135	com/tencent/mobileqq/minigame/manager/InstalledEngine:engineType	I
    //   387: iconst_3
    //   388: if_icmpne -17 -> 371
    //   391: aload 11
    //   393: ldc_w 397
    //   396: putfield 395	com/tencent/mobileqq/minigame/manager/InstalledEngine:engineName	Ljava/lang/String;
    //   399: goto -28 -> 371
    //   402: astore 9
    //   404: iload_0
    //   405: iconst_1
    ...
    //   408: goto -340 -> 68
    //   411: aload 7
    //   413: invokestatic 403	java/util/Collections:reverseOrder	()Ljava/util/Comparator;
    //   416: invokestatic 407	java/util/Collections:sort	(Ljava/util/List;Ljava/util/Comparator;)V
    //   419: ldc 11
    //   421: iconst_1
    ...
    //   429: ldc_w 409
    //   432: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   435: invokestatic 348	java/lang/System:currentTimeMillis	()J
    //   438: lload 5
    //   440: lsub
    //   441: invokevirtual 412	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   444: ldc_w 414
    //   447: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   450: aload 7
    //   452: invokevirtual 415	java/util/ArrayList:size	()I
    //   455: invokevirtual 324	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   458: invokevirtual 89	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   461: invokestatic 95	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   464: ldc 2
    //   466: monitorexit
    //   467: aload 7
    //   469: areturn
  ...
  private boolean unzipEngine(File paramFile, String paramString1, EngineVersion paramEngineVersion, String paramString2, boolean paramBoolean)
  {
    ...
    //   8: aload_1
    //   9: aload_3
    //   10: invokestatic 418	com/tencent/mobileqq/minigame/manager/EngineInstaller:getInstallLibDir	(Ljava/io/File;Lcom/tencent/mobileqq/minigame/manager/EngineVersion;)Ljava/lang/String;
    //   13: astore_1
    //   14: aload_1
    //   15: ifnonnull +26 -> 41
    //   18: aload_0
    //   19: invokespecial 49	com/tencent/mobileqq/minigame/manager/EngineInstaller:workFinish	()V
    //   22: aload 4
    //   24: iconst_1
    //   25: invokestatic 381	com/tencent/mobileqq/mini/utils/FileUtils:delete	(Ljava/lang/String;Z)V
    //   28: aload_0
    //   29: invokespecial 49	com/tencent/mobileqq/minigame/manager/EngineInstaller:workFinish	()V
    //   32: iload 9
    //   34: istore 7
    //   36: aload_0
    //   37: monitorexit
    //   38: iload 7
    //   40: ireturn
    //   41: new 65	java/io/File
    //   44: dup
    //   45: aload_1
    //   46: invokespecial 160	java/io/File:<init>	(Ljava/lang/String;)V
    //   49: invokevirtual 99	java/io/File:exists	()Z
    //   52: ifeq +8 -> 60
    //   55: aload_1
    //   56: iconst_0
    //   57: invokestatic 381	com/tencent/mobileqq/mini/utils/FileUtils:delete	(Ljava/lang/String;Z)V
    //   60: aload_0
    //   61: fconst_1
    //   62: ldc_w 419
    //   65: invokestatic 425	acfp:m	(I)Ljava/lang/String;
    //   68: invokespecial 55	com/tencent/mobileqq/minigame/manager/EngineInstaller:updateMessage	(FLjava/lang/String;)V
    //   71: aload 4
    //   73: aload_1
    //   74: invokestatic 431	jqp:unZipFolder	(Ljava/lang/String;Ljava/lang/String;)I
    //   77: istore 6
    //   79: iload 6
    //   81: ifne +346 -> 427
    //   84: ldc2_w 196
    //   87: invokestatic 203	java/lang/Thread:sleep	(J)V
    //   90: aload_0
    //   91: fconst_1
    //   92: ldc_w 432
    //   95: invokestatic 425	acfp:m	(I)Ljava/lang/String;
    //   98: invokespecial 55	com/tencent/mobileqq/minigame/manager/EngineInstaller:updateMessage	(FLjava/lang/String;)V
    //   101: ldc2_w 196
    //   104: invokestatic 203	java/lang/Thread:sleep	(J)V
    //   107: aload_0
    //   108: aload 4
    //   110: aload_1
    //   111: invokespecial 436	com/tencent/mobileqq/minigame/manager/EngineInstaller:verifyBaselib	(Ljava/lang/String;Ljava/lang/String;)Z
    //   114: istore 8
    //   116: iload 6
    //   118: ifne +105 -> 223
    //   121: iload 8
    ...
    //   126: ldc 11
    //   128: iconst_1
    //   129: new 76	java/lang/StringBuilder
    //   132: dup
    //   133: invokespecial 77	java/lang/StringBuilder:<init>	()V
    //   136: ldc_w 438
    ...
    //   156: ldc_w 442
    //   159: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   162: aload_1
    ...
    //   169: invokestatic 95	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   172: invokestatic 112	com/tencent/mobileqq/minigame/manager/EngineInstaller:updateInstalledEngine	()V
    //   175: iconst_1
    //   176: istore 7
    //   178: aload 4
    //   180: iconst_1
    //   181: invokestatic 381	com/tencent/mobileqq/mini/utils/FileUtils:delete	(Ljava/lang/String;Z)V
    //   184: iload 7
    //   186: ifeq +25 -> 211
    //   189: iload 5
    //   191: ifeq +208 -> 399
    ...
    //   195: fconst_1
    //   196: ldc_w 443
    //   199: invokestatic 425	acfp:m	(I)Ljava/lang/String;
    //   202: invokespecial 55	com/tencent/mobileqq/minigame/manager/EngineInstaller:updateMessage	(FLjava/lang/String;)V
    //   205: ldc2_w 196
    //   208: invokestatic 203	java/lang/Thread:sleep	(J)V
    //   211: aload_0
    //   212: invokespecial 49	com/tencent/mobileqq/minigame/manager/EngineInstaller:workFinish	()V
    //   215: goto -179 -> 36
    //   218: astore_1
    //   219: aload_0
    //   220: monitorexit
    ...
    //   239: aload_2
    //   240: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   243: ldc_w 440
    //   246: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   249: aload_3
    //   250: invokevirtual 165	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   253: ldc_w 442
    //   256: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   259: aload_1
    //   260: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   263: invokevirtual 89	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   266: invokestatic 95	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   269: aload_1
    //   270: iconst_0
    //   271: invokestatic 381	com/tencent/mobileqq/mini/utils/FileUtils:delete	(Ljava/lang/String;Z)V
    //   274: iload 6
    //   276: ifeq +83 -> 359
    //   279: aload_0
    //   280: fconst_0
    //   281: ldc_w 446
    //   284: invokestatic 425	acfp:m	(I)Ljava/lang/String;
    //   287: invokespecial 55	com/tencent/mobileqq/minigame/manager/EngineInstaller:updateMessage	(FLjava/lang/String;)V
    //   290: iload 10
    //   292: istore 7
    //   294: goto -116 -> 178
    //   297: astore_1
    ...
    //   314: aload_1
    //   315: invokevirtual 165	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   318: aload_1
    //   319: invokestatic 375	com/tencent/mobileqq/mini/utils/DebugUtil:getPrintableStackTrace	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   322: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   325: invokevirtual 89	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   328: invokestatic 107	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   331: aload_0
    //   332: fconst_0
    //   333: ldc_w 449
    //   336: invokestatic 425	acfp:m	(I)Ljava/lang/String;
    //   339: invokespecial 55	com/tencent/mobileqq/minigame/manager/EngineInstaller:updateMessage	(FLjava/lang/String;)V
    //   342: aload 4
    //   344: iconst_1
    //   345: invokestatic 381	com/tencent/mobileqq/mini/utils/FileUtils:delete	(Ljava/lang/String;Z)V
    //   348: aload_0
    //   349: invokespecial 49	com/tencent/mobileqq/minigame/manager/EngineInstaller:workFinish	()V
    //   352: iload 9
    //   354: istore 7
    //   356: goto -320 -> 36
    //   359: iload 10
    ...
    //   369: fconst_0
    //   370: ldc_w 450
    //   373: invokestatic 425	acfp:m	(I)Ljava/lang/String;
    //   376: invokespecial 55	com/tencent/mobileqq/minigame/manager/EngineInstaller:updateMessage	(FLjava/lang/String;)V
    //   379: iload 10
    //   381: istore 7
    //   383: goto -205 -> 178
    //   386: astore_1
    //   387: aload 4
    //   389: iconst_1
    //   390: invokestatic 381	com/tencent/mobileqq/mini/utils/FileUtils:delete	(Ljava/lang/String;Z)V
    //   393: aload_0
    //   394: invokespecial 49	com/tencent/mobileqq/minigame/manager/EngineInstaller:workFinish	()V
    //   397: aload_1
    //   398: athrow
    //   399: aload_0
    //   400: fconst_1
    //   401: ldc_w 451
    //   404: invokestatic 425	acfp:m	(I)Ljava/lang/String;
    //   407: invokespecial 55	com/tencent/mobileqq/minigame/manager/EngineInstaller:updateMessage	(FLjava/lang/String;)V
    //   410: goto -205 -> 205
    //   413: astore 11
    //   415: goto -325 -> 90
    //   418: astore 11
  ...
  {
    long l1 = jqp.getUncompressedFileSize(paramString1);
    if (l1 <= 0L)
    {
  ...
  public void installWithCallback(BaseLibInfo paramBaseLibInfo, Callback paramCallback)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        workBegin();
        if (bool1) {
          updateMessage(0.0F, acfp.m(2131705887) + paramBaseLibInfo.baseLibVersion + ")");
        }
        for (;;)
        {
          ...
          workFinish();
          break;
          updateMessage(0.0F, acfp.m(2131705892) + paramBaseLibInfo.baseLibVersion + ")");
        }
        label780:
        boolean bool2 = false;
        paramCallback = null;
        ...
        try
        {
          updateMessage(0.0F, acfp.m(2131705888));
          ...
          {
            updateMessage(0.0F, acfp.m(2131705899));
      ...
      {
        updateMessage(0.0F, acfp.m(2131705891));
      ...
      if ((paramCallback[0] == l) || (l < 0L))
      {
        ...
        updateInstalledEngine();
        updateMessage(1.0F, acfp.m(2131705886));
      }
      for (;;)
      {
        workFinish();
        break;
        updateMessage(0.0F, acfp.m(2131705897));
      }
      label1143:
