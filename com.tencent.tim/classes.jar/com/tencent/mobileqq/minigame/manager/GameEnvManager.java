...
public class GameEnvManager
{
  ...
  private static String calcMD5(String paramString)
  {
    ...
    catch (UnsatisfiedLinkError localUnsatisfiedLinkError)
    {
      for (;;)
      {
        ...
        try
        {
          String str4 = aszr.getFileMD5String((File)localObject);
          localObject = str4;
          if (str4 == null) {
            localObject = "";
          }
  ...
  private static void downloadLatestTritonEngine(BaseLibInfo paramBaseLibInfo, Version paramVersion)
  {
    ...
    MiniappDownloadUtil.getInstance().download(paramBaseLibInfo.baseLibUrl, str, true, new GameEnvManager.2(paramBaseLibInfo, paramVersion, str), Downloader.DownloadMode.StrictMode, null);
  ...
  private static String getNewestBaseLib(String paramString1, String paramString2)
  {
    ...
    if ((bool1) && (bool2))
    {
      localVersion1 = getJsVersionByPath(paramString1);
      localVersion2 = getJsVersionByPath(paramString1);
    ...
    while (bool1)
    {
      ...
      do
      {
        return paramString1;
        return paramString2;
      } while ((localVersion1 != null) || (localVersion2 == null));
      return paramString2;
    }
    if (bool2) {
      return paramString2;
  ...
  private static String getTritonPath()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 387	com/tencent/mobileqq/minigame/manager/GameEnvManager:currentTritonPath	Ljava/lang/String;
    //   6: invokestatic 337	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   9: ifne +12 -> 21
    //   12: getstatic 387	com/tencent/mobileqq/minigame/manager/GameEnvManager:currentTritonPath	Ljava/lang/String;
    //   15: astore_0
    //   16: ldc 2
    //   18: monitorexit
    //   19: aload_0
    //   20: areturn
    //   21: invokestatic 83	com/tencent/mobileqq/minigame/manager/GameEnvManager:getLocalTritonVersion	()Lcom/tencent/mobileqq/triton/sdk/Version;
    //   24: astore_0
    //   25: invokestatic 157	com/tencent/mobileqq/minigame/manager/GameEnvManager:getOnlineTritonVersion	()Lcom/tencent/mobileqq/triton/sdk/Version;
    //   28: astore_1
    //   29: aload_0
    //   30: aload_1
    //   31: invokevirtual 163	com/tencent/mobileqq/triton/sdk/Version:compareTo	(Lcom/tencent/mobileqq/triton/sdk/Version;)I
    //   34: iflt +23 -> 57
    //   37: invokestatic 389	com/tencent/mobileqq/minigame/manager/GameEnvManager:getLocalTritonPath	()Ljava/lang/String;
    //   40: putstatic 387	com/tencent/mobileqq/minigame/manager/GameEnvManager:currentTritonPath	Ljava/lang/String;
    //   43: aload_0
    //   44: putstatic 391	com/tencent/mobileqq/minigame/manager/GameEnvManager:currentTritonVersion	Lcom/tencent/mobileqq/triton/sdk/Version;
    //   47: invokestatic 393	com/tencent/mobileqq/minigame/manager/GameEnvManager:checkTritonUpdateOnMainProcess	()V
    //   50: getstatic 387	com/tencent/mobileqq/minigame/manager/GameEnvManager:currentTritonPath	Ljava/lang/String;
    //   53: astore_0
    //   54: goto -38 -> 16
    //   57: invokestatic 395	com/tencent/mobileqq/minigame/manager/GameEnvManager:getOnlineTritonPath	()Ljava/lang/String;
    //   60: putstatic 387	com/tencent/mobileqq/minigame/manager/GameEnvManager:currentTritonPath	Ljava/lang/String;
    //   63: aload_1
    //   64: putstatic 391	com/tencent/mobileqq/minigame/manager/GameEnvManager:currentTritonVersion	Lcom/tencent/mobileqq/triton/sdk/Version;
    //   67: goto -20 -> 47
    //   70: astore_0
    //   71: ldc 2
    //   73: monitorexit
  ...
  private static void onDownloadLatestTritonEngineSuccess(Version paramVersion, String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        int j = jqp.unZipFolder(paramString, str2);
