...
public class GameCloseManager
{
  ...
  public static boolean showAlertViewForBattleGame(GameActivity paramGameActivity, MiniAppConfig paramMiniAppConfig, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramGameActivity = aqha.a(paramGameActivity, 230).setTitle(paramGameActivity.getString(2131721103)).setMessage(paramGameActivity.getString(2131695910)).setNegativeButton(paramGameActivity.getString(2131721058), new GameCloseManager.3()).setPositiveButton(paramGameActivity.getString(2131695909), new GameCloseManager.2(paramOnClickListener));
  ...
  public static boolean showPullDownGuideDialog(GameActivity paramGameActivity, MiniAppConfig paramMiniAppConfig, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((paramMiniAppConfig.launchParam != null) && ((paramMiniAppConfig.launchParam.scene == 2106) || (paramMiniAppConfig.launchParam.scene == 1001) || (MiniAppUtils.isFromPullDownEntry(paramMiniAppConfig)) || (isInWnsBlackList(paramMiniAppConfig.launchParam.scene))));
    ...
    paramMiniAppConfig = aqha.a(paramGameActivity, 230);
    ...
    localTextView.setText(Html.fromHtml(paramGameActivity.getApplicationContext().getString(2131695907)), TextView.BufferType.SPANNABLE);
    ...
    paramMiniAppConfig.setTitle(null).setMessage(null).addView(paramGameActivity, (LinearLayout.LayoutParams)localObject).setPositiveButton(2131696095, new GameCloseManager.1(paramOnClickListener));
