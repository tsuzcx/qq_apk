...
public class LocalGameEngine
{
  ...
  public static final String LOCAL_ENGINE_VERSION = "1.16.0.00063";
  ...
  private void initLocalBaseLibInfo()
  {
    ...
    this.mLocalBaseLibInfo.baseLibVersion = GameWnsUtils.getGameEngineVersion("1.16.0.00063");
  ...
  {
    this.mLocalEngineVersion = new EngineVersion(GameWnsUtils.getGameEngineVersion("1.16.0.00063"));
  }
