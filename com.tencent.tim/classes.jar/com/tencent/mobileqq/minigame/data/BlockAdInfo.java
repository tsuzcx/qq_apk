...
public class BlockAdInfo
{
  ...
  public void adjustGdtAdInfoList(int paramInt)
  {
    if ((paramInt > 0) && (this.mGdtAdInfoList != null) && (paramInt < this.mGdtAdInfoList.size()))
    {
      this.mGdtAdInfoList = this.mGdtAdInfoList.subList(0, paramInt);
