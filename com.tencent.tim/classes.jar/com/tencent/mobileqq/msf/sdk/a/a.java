...
public final class a
{
  ...
  private void u()
  {
    ...
    //   0: aload_0
    //   1: aload_0
    //   2: getfield 80	com/tencent/mobileqq/msf/sdk/a/a:b	Ljava/lang/String;
    //   5: putfield 82	com/tencent/mobileqq/msf/sdk/a/a:c	Ljava/lang/String;
    //   8: invokestatic 516	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   11: ldc_w 531
    //   14: invokevirtual 519	com/tencent/qphone/base/util/BaseApplication:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   17: checkcast 533	android/net/ConnectivityManager
    //   20: astore_2
    //   21: aload_2
    //   22: iconst_0
    //   23: invokevirtual 537	android/net/ConnectivityManager:getNetworkInfo	(I)Landroid/net/NetworkInfo;
    //   26: astore_1
    //   27: aload_1
    //   28: ifnonnull +162 -> 190
    //   31: aload_2
    //   32: bipush 50
    //   34: invokevirtual 537	android/net/ConnectivityManager:getNetworkInfo	(I)Landroid/net/NetworkInfo;
    //   37: astore_1
    //   38: aload_1
    //   39: ifnull +12 -> 51
    //   42: aload_0
    //   43: aload_1
    //   44: invokevirtual 457	android/net/NetworkInfo:getExtraInfo	()Ljava/lang/String;
    //   47: putfield 80	com/tencent/mobileqq/msf/sdk/a/a:b	Ljava/lang/String;
    //   50: return
    //   51: invokestatic 516	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   54: invokevirtual 541	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   57: getstatic 72	com/tencent/mobileqq/msf/sdk/a/a:h	Landroid/net/Uri;
    //   60: aconst_null
    //   61: aconst_null
    //   62: aconst_null
    //   63: aconst_null
    //   64: invokestatic 547	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   67: astore_2
    //   68: aload_2
    //   69: ifnull +100 -> 169
    //   72: aload_2
    ...
    //   87: aload_2
    //   88: ldc_w 554
    //   91: invokeinterface 558 2 0
    //   96: invokeinterface 561 2 0
    //   101: putfield 80	com/tencent/mobileqq/msf/sdk/a/a:b	Ljava/lang/String;
    //   104: goto -36 -> 68
    //   107: astore_3
    //   108: aload_2
    //   109: astore_1
    //   110: aload_3
    //   111: invokevirtual 244	java/lang/Throwable:printStackTrace	()V
    //   114: aload_2
    //   115: ifnull -65 -> 50
    //   118: aload_2
    //   119: invokeinterface 564 1 0
    //   124: return
    //   125: astore_1
    //   126: getstatic 62	com/tencent/mobileqq/msf/sdk/a/a:a	Ljava/lang/String;
    //   129: iconst_1
    //   130: new 298	java/lang/StringBuilder
    //   133: dup
    //   134: invokespecial 299	java/lang/StringBuilder:<init>	()V
    //   137: ldc_w 566
    //   140: invokevirtual 305	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   143: aload_1
    //   144: invokevirtual 308	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   147: invokevirtual 311	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   150: invokestatic 296	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   153: return
    //   154: astore_2
    //   155: aconst_null
    //   156: astore_1
    ...
    //   158: ifnull +9 -> 167
    //   161: aload_1
    //   162: invokeinterface 564 1 0
    //   167: aload_2
    //   168: athrow
    //   169: aload_2
    //   170: ifnull -120 -> 50
    //   173: aload_2
    //   174: invokeinterface 564 1 0
    //   179: return
    //   180: astore_2
    //   181: goto -24 -> 157
    //   184: astore_3
  ...
  private void v()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject4 = alkz.a((WifiManager)localObject4);
        localObject2 = localObject5;
        if (localObject4 == null) {
          continue;
        }
  ...
  public int a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        if ((aa.b == null) || (aa.b.sender == null)) {
          continue;
        }
        String str = aa.b.sender.j();
