  ...
  extends u
{
  ...
  public ToServiceMsg getLoginByWxMsg(String paramString)
  {
    paramString = new ToServiceMsg(getMsfServiceName(), paramString, "login.auth");
    paramString.setMsfCommand(MsfCommand.loginByWx);
    paramString.getAttributes().put("dwSrcAppid", Long.valueOf(16L));
  ...
  public ToServiceMsg getRegisterCommitPassMsg(String paramString1, String paramString2, String paramString3, boolean paramBoolean, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ToServiceMsg localToServiceMsg = new ToServiceMsg(getMsfServiceName(), "0", "wtlogin.trans_emp");
    localToServiceMsg.setMsfCommand(MsfCommand.regUin_commitPass);
    localToServiceMsg.getAttributes().put("To_register_smsCode", paramString1);
    ...
    for (;;)
    {
      ...
      localToServiceMsg.getAttributes().put("To_register_wxtoken", paramString7);
      beforeSend(localToServiceMsg);
      return localToServiceMsg;
  ...
  public ToServiceMsg getReportTrafficeMsg4Highway(Intent paramIntent)
  {
    ...
    localToServiceMsg.extraData.putString("processName", "com.tencent.tim");
