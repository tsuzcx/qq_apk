...
public abstract interface IRegisterUinHandler
  extends IMsfHandler
{
  public abstract void onCheckQuickRegisterResp(int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg);
  
  public abstract void onGetQuickRegisterResp(int paramInt, String paramString1, String paramString2, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg);
  ...
  public abstract void onRegisterQuerySmsStatResp(int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg);
