...
public class MsfMsgUtil
{
  ...
  public static ToServiceMsg get_wt_GetOpenKeyWithoutPasswd(String paramString1, String paramString2, long paramLong1, long paramLong2, long paramLong3)
  {
    paramString1 = new ToServiceMsg(paramString1, paramString2, "cmd_appUseWtLogin");
    paramString1.setMsfCommand(MsfCommand.wt_GetOpenKeyWithoutPasswd);
    paramString1.getAttributes().put("dwSrcAppid", Long.valueOf(paramLong1));
  ...
  public static ToServiceMsg get_wt_SetDevlockMobileType(String paramString, int paramInt, long paramLong)
  {
    ...
    paramString.setMsfCommand(MsfCommand.wt_SetDevlockMobileType);
    paramString.getAttributes().put("mobile_type", Integer.valueOf(paramInt));
