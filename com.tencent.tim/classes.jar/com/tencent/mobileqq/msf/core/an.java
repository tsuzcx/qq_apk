...
public class an
{
  ...
  public an(MsfCore paramMsfCore)
  {
    this.s = paramMsfCore;
  }
  ...
  protected boolean a(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    ...
    if (-10106 == i2)
    {
      CodecWarpper.setDecryptFailN(true, 2);
    ...
    try
    {
      ...
      QLog.e("Crypt.MSF.C.SSORespHandler", 2, "server decrypt fail more time");
      ...
      for (;;)
      {
        ...
        ak.a(i2, paramFromServiceMsg.getRequestSsoSeq(), 0);
        bool1 = bool2;
        if (!bool2)
        {
          bool1 = bool2;
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          try
          {
            ...
            aq.a(paramToServiceMsg, paramFromServiceMsg, false);
          ...
          if (paramFromServiceMsg.getServiceCmd().startsWith("SharpSvr."))
          {
            ...
            if ((ak.J > 0L) && (l1 - ak.J > 0L) && (l1 - ak.J <= 30000L)) {
              paramFromServiceMsg.addAttribute("__timestamp_msf2net_boot_sharp_c2s", Long.valueOf(ak.J));
            }
          }
          else
          {
      ...
      label1003:
      if (((!ak.s) || (!com.tencent.mobileqq.msf.core.net.a.f.a())) || ((paramFromServiceMsg.getServiceCmd().startsWith("wtlogin.")) && (i1 != 0)))
      {
        if (paramToServiceMsg != null)
        {
          com.tencent.mobileqq.msf.core.auth.n.a(paramToServiceMsg, paramFromServiceMsg);
      ...
      else
      {
        ...
        {
          ac.a().a(paramToServiceMsg, paramFromServiceMsg);
          return;
        ...
        switch (ap.a[paramToServiceMsg.getMsfCommand().ordinal()])
        {
        default: 
 ...
 * Qualified Name:     com.tencent.mobileqq.msf.core.an
