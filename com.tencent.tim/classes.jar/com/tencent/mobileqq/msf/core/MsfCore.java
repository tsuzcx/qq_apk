...
public class MsfCore
{
  ...
  private an ssoRespHandler;
  com.tencent.mobileqq.msf.core.d.a standbyModeManager;
  public com.tencent.mobileqq.msf.core.c.k statReporter;
  MsfStore store;
    ...
    if (paramToServiceMsg != null) {
      if (paramFromServiceMsg.isSuccess())
      {
        if ((paramToServiceMsg.getMsfCommand() == MsfCommand.changeUinLogin) || (paramToServiceMsg.getMsfCommand() == MsfCommand.loginAuth) || (paramToServiceMsg.getMsfCommand() == MsfCommand.wt_GetStViaSMSVerifyLogin))
        {
          ...
          l3 = com.tencent.mobileqq.msf.core.c.k.a(paramToServiceMsg, paramFromServiceMsg);
          String str1 = "0";
          str3 = "0";
  ...
  public com.tencent.mobileqq.msf.core.c.k getStatReporter()
  {
  ...
  public boolean init(Context paramContext, boolean paramBoolean)
  {
    ...
    com.tencent.mobileqq.msf.core.c.k localk = new com.tencent.mobileqq.msf.core.c.k(this);
    localk.e();
    ...
    catch (Exception localException3)
    {
      try
      {
        ...
        localFile.delete();
        QLog.i("MSF.C.MsfCore", 1, "check copysolib platform=" + c.c(paramContext) + " installAppVersionCode=" + i + " isNewVersion=" + bool1);
      ...
      catch (Exception localException3)
      {
        try
        {
          int k;
          boolean bool2;
          c.a(paramContext, c.c(paramContext), bool1, i, new String[] { "libcodecwrapperV2.so", "libmsfbootV2.so", "libNativeRQD.so", "libwtecdh.so" });
          for (;;)
          {
            ...
            QLog.e("MSF.C.MsfCore", 1, "checkAppVersionCode error " + localException2, localException2);
            bool1 = true;
            k = -1;
            j = i;
            i = k;
            ...
            QLog.e("MSF.C.MsfCore", 1, "File operation error " + localException3);
            break label248;
            c.a(paramContext, c.c(paramContext), bool1, i, new String[] { "libcodecwrapperV2.so", "libNativeRQD.so" });
          }
        }
        catch (Exception localException4)
        {
          for (;;)
          {
            ...
            QLog.d("MSF.C.MsfCore", 1, "cp txlib error " + localException4);
          }
        }
      }
    }
    ...
    if (Build.VERSION.SDK_INT >= 26) {
      this.mDeepSleepDetector = new com.tencent.mobileqq.msf.core.net.c.a(y.f());
    }
          ...
          catch (Exception localException8)
          {
            try
            {
              for (;;)
              {
                ...
                if (localk.c())
                {
                  this.statReporter = localk;
                  if (com.tencent.mobileqq.msf.service.k.f)
                  {
                    QLog.d("MSF.C.MsfCore", 1, "MSF_Alive_Log do report JobScheduler alive MSF to rdm in msfcore init");
                    com.tencent.mobileqq.msf.service.k.a(true);
                  }
                  this.store.reportLoadCfgTempFile();
                }
                QLog.d("MSF.C.MsfCore", 1, "init beacon Cost=" + (SystemClock.elapsedRealtime() - l2));
                l2 = SystemClock.elapsedRealtime();
                try
                {
                  this.sender = new ak(this);
                ...
                QLog.e("MSF.C.MsfCore", 1, "load mobileQQAppid failed " + localException5);
                continue;
                localException6 = localException6;
                QLog.e("MSF.C.MsfCore", 1, "msfAlarmer init failed " + localException6);
                continue;
                localException7 = localException7;
                QLog.e("MSF.C.MsfCore", 1, "configManager init failed " + localException7);
              }
              localException8 = localException8;
              QLog.e("MSF.C.MsfCore", 1, "SsoListManager init failed " + localException8);
            }
            catch (Exception localException9)
            {
              for (;;)
              {
                QLog.e("MSF.C.MsfCore", 1, "MsfCore init netConnInfoCenter error " + localException9, localException9);
              }
            }
          }
        }
    ...
    l2 = SystemClock.elapsedRealtime();
    this.ssoRespHandler = new an(this);
    try
    {
          ...
          try
          {
            do
            {
              for (;;)
              {
                ...
                QLog.e("MSF.C.MsfCore", 1, "LightSender init failed " + localException1);
                continue;
  ...
  public void loginByWx(ToServiceMsg paramToServiceMsg)
  {
  ...
  {
    if (isUseWtlogin()) {
      return this.wtLoginCenter.g(paramToServiceMsg);
    }
    return -1;
  }
