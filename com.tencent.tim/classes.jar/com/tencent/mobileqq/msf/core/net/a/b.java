...
public class b
{
  ...
  public static boolean a(ToServiceMsg paramToServiceMsg)
  {
    try
    {
      QLog.d("Crypt.ping.HeratbeatProxy", 1, "send heartbeat os.hello, s = " + StringUtils.bytes2Str(b));
  ...
  private static boolean b(ToServiceMsg paramToServiceMsg)
  {
    try
    {
      ...
      paramToServiceMsg.putInt(i).putInt(20200918).putInt(j).put(b1).put("OS.Hello".getBytes()).put((byte)1).putInt(0);
