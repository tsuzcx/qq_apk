...
public class b
{
  ...
  private void b(ArrayList paramArrayList)
  {
    ...
    {
      Object localObject2 = (WloginLoginInfo)((Iterator)localObject1).next();
      String str;
      Object localObject3;
      byte[] arrayOfByte3;
      byte[] arrayOfByte1;
      for (;;)
      {
        try
        {
          str = String.valueOf(((WloginLoginInfo)localObject2).mUin);
          localStringBuilder.append(",uin=").append(MsfSdkUtils.getShortUin(str));
          if (l.e.IsNeedLoginWithPasswd(str, 16L).booleanValue()) {
            break;
          }
          localObject3 = l.e.GetLocalSig(str, 16L);
          arrayOfByte2 = WtloginHelper.GetTicketSig((WUserSigInfo)localObject3, 64);
          arrayOfByte3 = WtloginHelper.GetTicketSig((WUserSigInfo)localObject3, 262144);
          arrayOfByte1 = WtloginHelper.GetTicketSigKey((WUserSigInfo)localObject3, 262144);
          if ((localObject3 != null) && (arrayOfByte2 != null) && (arrayOfByte2.length != 0) && (arrayOfByte3 != null) && (arrayOfByte3.length != 0) && (arrayOfByte1 != null) && (arrayOfByte1.length != 0)) {
            break label257;
          }
          localStringBuilder.append(",invalid token");
          localObject2 = localStringBuilder.append(",sigInfo=");
        ...
        {
          QLog.i("MSF.C.AccountCenter", 1, "loadAccountInfoFromWt", localThrowable);
        }
        break;
        label252:
        boolean bool = false;
      ...
      locala.b(WtloginHelper.GetTicketSig((WUserSigInfo)localObject3, 4096));
      locala.c(WtloginHelper.GetTicketSig((WUserSigInfo)localObject3, 32));
      locala.b(true);
      ...
      if (l1 > l2)
      {
        ...
        localObject3 = new WloginSimpleInfo();
        if (l.e.GetBasicUserInfo(str, (WloginSimpleInfo)localObject3).booleanValue())
        {
          locala.b(localObject3._age[0]);
          locala.n(((WloginSimpleInfo)localObject3)._nick);
          if (localObject3._gender[0] != 1) {
            break label589;
          }
        }
      }
      ...
      {
        locala.c(i1);
        locala.a(util.buf_to_int16(((WloginSimpleInfo)localObject3)._face, 0));
        localStringBuilder.append(",isAlive=").append(locala.o());
        localStringBuilder.append(",mLoginBitmap=").append(localThrowable.mLoginBitmap);
  ...
  private void d(a parama)
  {
    try
    {
      ...
      CodecWarpper.nativeSetAccountKey(parama.d(), parama.e(), parama.g(), parama.h(), parama.i(), parama.j(), parama.k(), parama.l(), parama.m(), null);
      ak.a(parama.d(), false);
      ...
      if (QLog.isColorLevel()) {
        QLog.d("MSF.C.AccountCenter", 2, "handle account " + parama.d() + " logined:" + parama.o() + " len:" + parama.l().length);
      }
      return;
    }
  ...
  private boolean d(String paramString1, String paramString2)
  {
    ...
    try
    {
      bool1 = new WtloginHelper(BaseApplication.getContext(), MsfWtloginPrivacyListenerImpl.getSingleton()).ClearUserLoginData(paramString2, 16L).booleanValue();
      bool2 = bool1;
    ...
    try
    {
      if (!MsfSdkUtils.getNewAppUinStoreFile().exists())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((a)((Map.Entry)localObject).getValue()).z().equals("QQ"))
          {
            localObject = (a)((Map.Entry)localObject).getValue();
            MsfSdkUtils.updateSimpleAccount(((a)localObject).d(), ((a)localObject).o(), ((a)localObject).f());
          }
        }
      }
      return;
  ...
  public int b(ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    ...
    f localf = new f();
    localf.a = l(paramToServiceMsg.getUin()).h();
  ...
  void b(a parama)
  {
    ...
    String str = parama.d();
    byte[] arrayOfByte1 = parama.g();
    byte[] arrayOfByte2 = parama.h();
    byte[] arrayOfByte3 = parama.i();
    byte[] arrayOfByte4 = parama.j();
    byte[] arrayOfByte5 = parama.k();
    byte[] arrayOfByte6 = parama.l();
  ...
  a c(a parama)
  {
    ...
    if ((parama.j() != null) && (parama.j().length > 0)) {
      locala.h(parama.j());
    }
  ...
  public String h()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localStringBuffer.append("UIN=" + locala.d() + ",LOGINED=" + locala.o() + ",A2=" + HexUtil.bytes2HexStr(locala.g()) + ",D2=" + HexUtil.bytes2HexStr(locala.j()) + ",KEY=" + HexUtil.bytes2HexStr(locala.l())).append(";");
    }
  ...
  public void k(String paramString)
  {
    ...
    //   6: aload_1
    //   7: invokevirtual 480	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   10: ifeq +22 -> 32
    //   13: aload_0
    //   14: ldc 54
    //   16: ldc_w 794
    //   19: invokevirtual 796	com/tencent/mobileqq/msf/core/auth/b:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   22: aload_0
    //   23: getfield 64	com/tencent/mobileqq/msf/core/auth/b:a	Lcom/tencent/mobileqq/msf/core/MsfCore;
    //   26: ldc_w 794
    //   29: invokevirtual 799	com/tencent/mobileqq/msf/core/MsfCore:stopPCActivePolling	(Ljava/lang/String;)V
    //   32: aload_0
    //   33: aload_1
    //   34: invokevirtual 585	com/tencent/mobileqq/msf/core/auth/b:l	(Ljava/lang/String;)Lcom/tencent/mobileqq/msf/core/auth/a;
    //   37: astore_2
    //   38: aload_1
    //   39: iconst_0
    //   40: invokestatic 403	com/tencent/mobileqq/msf/core/ak:a	(Ljava/lang/String;Z)V
    //   43: aload_2
    //   44: ifnull +20 -> 64
    //   47: aload_2
    //   48: iconst_0
    //   49: invokevirtual 306	com/tencent/mobileqq/msf/core/auth/a:b	(Z)V
    //   52: aload_0
    //   53: aload_1
    //   54: invokevirtual 587	com/tencent/mobileqq/msf/core/auth/b:m	(Ljava/lang/String;)V
    //   57: aload_1
    //   58: invokestatic 802	com/tencent/qphone/base/util/CodecWarpper:nativeRemoveAccountKey	(Ljava/lang/String;)V
    //   61: aload_0
    //   62: monitorexit
    //   63: return
    //   64: ldc 14
    //   66: iconst_1
    //   67: ldc_w 804
    //   70: invokestatic 806	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   73: aload_1
    //   74: invokestatic 802	com/tencent/qphone/base/util/CodecWarpper:nativeRemoveAccountKey	(Ljava/lang/String;)V
    //   77: goto -16 -> 61
    //   80: astore_1
    //   81: aload_0
    //   82: monitorexit
  ...
  public void o(String paramString)
  {
    ...
    QLog.i("MSF.C.AccountCenter", 1, Thread.currentThread().getName() + " reloadKeys setKey " + MsfSdkUtils.getShortUin(((a)localObject).d()));
    String str = ((a)localObject).d();
    byte[] arrayOfByte1 = ((a)localObject).g();
    byte[] arrayOfByte2 = ((a)localObject).h();
    byte[] arrayOfByte3 = ((a)localObject).i();
    byte[] arrayOfByte4 = ((a)localObject).j();
    byte[] arrayOfByte5 = ((a)localObject).k();
