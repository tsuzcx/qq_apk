...
public class l
{
  ...
  private int a(ToServiceMsg paramToServiceMsg, boolean paramBoolean1, a parama, boolean paramBoolean2)
  {
    for (;;)
    {
      try
      {
        ...
        m = e.GetStWithoutPasswd(parama.d(), 16L, 16L, paramToServiceMsg.getAppId(), n, parama.g(), parama.j(), parama.l(), (WUserSigInfo)localObject);
        continue;
        return 1;
      }
  ...
  {
    if (!"com.tencent.tim:openSdk".equals((String)paramToServiceMsg.getAttribute("process", null))) {
      return;
    }
    Object localObject = paramToServiceMsg.getAttribute("connect_data");
    if ((localObject instanceof byte[]))
    {
      QLog.d("MSF.C.WTLoginCenter", 1, "WTLoginCenter login --> MsfCommand=" + paramToServiceMsg.getMsfCommand() + ", connect_data=" + ((byte[])localObject).length);
      WtloginHelper.setExtraLoginTlvValue(paramWUserSigInfo, 1346, (byte[])localObject);
      return;
    }
    QLog.d("MSF.C.WTLoginCenter", 1, "WTLoginCenter login --> MsfCommand=" + paramToServiceMsg.getMsfCommand());
  }
  ...
  public void G(ToServiceMsg paramToServiceMsg)
  {
    ...
    if ((str != null) && (str.equalsIgnoreCase("ssoAccountAction"))) {}
    for (localWUserSigInfo._login_bitmap = 2;; localWUserSigInfo._login_bitmap = 0)
    {
  ...
  public int a(a parama, int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      else
      {
        ...
        m = e.GetStWithoutPasswd(parama.d(), 16L, 16L, localToServiceMsg.getAppId(), paramInt, parama.g(), parama.j(), arrayOfByte, n.b(m));
  ...
  public int a(ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if ((localObject2 != null) && (((String)localObject2).equalsIgnoreCase("ssoAccountAction")))
      {
        ...
        long l1 = ((Long)paramToServiceMsg.getAttribute("appid", Long.valueOf(16L))).longValue();
        localObject2 = (String)paramToServiceMsg.getAttribute("process", null);
        if ((TextUtils.isEmpty((CharSequence)localObject2)) || (!((String)localObject2).equals("com.tencent.tim:openSdk"))) {
          break label454;
        }
        ...
        QLog.d("MSF.C.WTLoginCenter", 1, "login appid : " + l1);
        ...
        a(paramToServiceMsg, localp, m, "login");
        return m;
      }
    }
  ...
  public void a(MsfCore paramMsfCore)
  {
    ...
    e = new WtloginHelper(BaseApplication.getContext(), MsfWtloginPrivacyListenerImpl.getSingleton());
  ...
  public int b(ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    try
    {
      ...
      QLog.d("MSF.C.WTLoginCenter", 1, "changeTokenAfterLogin checkIsNeedLoginWithPasswd " + m + " process:" + u.b(paramToServiceMsg) + " cmd:" + paramToServiceMsg.getServiceCmd());
      switch (m)
      {
      case -1: 
  ...
  public void d(ToServiceMsg paramToServiceMsg)
  {
    ...
    paramToServiceMsg.addAttribute("login_by_wx", Boolean.valueOf(true));
    a(paramToServiceMsg, localp, e.GetStWithoutPasswd(paramToServiceMsg.getUin(), ((Long)paramToServiceMsg.getAttribute("dwSrcAppid")).longValue(), ((Long)paramToServiceMsg.getAttribute("dwDstAppid")).longValue(), l, 34869344, localWUserSigInfo), "loginByWx");
  }
  ...
  public int i(ToServiceMsg paramToServiceMsg)
  {
    ...
    m = e.RegSubmitMobile(str3, str2.getBytes(), str1.getBytes(), localByte1.byteValue(), localByte2.byteValue(), localByte3.byteValue(), 16L, l, (WUserSigInfo)localObject2, null);
  ...
  public int m(ToServiceMsg paramToServiceMsg)
  {
    ...
    WUserSigInfo localWUserSigInfo = n.b(paramToServiceMsg.getRequestSsoSeq());
    localWUserSigInfo._seqence = localp.f;
    Object localObject = (String)paramToServiceMsg.getAttributes().get("To_register_lh_uin");
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("MSF.C.WTLoginCenter", 2, "RegGetAccount|lhUin= " + (String)localObject);
      }
      a(localWUserSigInfo, 46, (String)localObject);
    }
    for (;;)
    {
      localObject = null;
      str5 = (String)paramToServiceMsg.getAttributes().get("To_register_wxtoken");
      if (!TextUtils.isEmpty(str5)) {
        localObject = str5.getBytes();
      }
      m = e.RegGetAccount(str1.getBytes(), "qqpassport".getBytes(), str2.getBytes(), str3.getBytes(), str4.getBytes(), (byte[])localObject, m, localWUserSigInfo);
      a(paramToServiceMsg, localp, m, "RegGetAccount");
      return m;
      if (!TextUtils.isEmpty(str5))
      {
        if (QLog.isColorLevel()) {
          QLog.d("MSF.C.WTLoginCenter", 2, "RegGetAccount|unBindUin= " + (String)localObject);
        }
  ...
  public int o(ToServiceMsg paramToServiceMsg)
  {
    String str1 = paramToServiceMsg.getUin();
    String str2 = (String)paramToServiceMsg.getAttributes().get("To_register_pass");
    String str3 = (String)paramToServiceMsg.getAttributes().get("To_register_nick");
    ...
    implements ReportListener
  {
    public void onReport(String paramString, HashMap paramHashMap, boolean paramBoolean1, boolean paramBoolean2)
    {
      ...
      paramHashMap.put("account_uin", str1);
