...
class a
{
          ...
          if (i1 < i2)
          {
            ...
            if (((String)localObject2).length() > 0)
            {
              ...
              if (localObject2.length == 2)
              {
                ...
                {
                  localObject1 = paramString;
                  if ("isLoginByWx".equals(localObject2[0]))
                  {
                    localObject1 = paramString;
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      {
                        localObject1 = paramString;
                        paramString.b(Boolean.parseBoolean(localObject2[1]));
                      }
                      else
                      {
                        localObject1 = paramString;
  ...
  public SimpleAccount p()
  {
    ...
    localSimpleAccount.setAttribute("login_by_wx", String.valueOf(this.d));
  ...
  public String q()
  {
    ...
    localStringBuilder.append(",isLoginByWx=").append(this.d);
    if (n() > 0L) {
    ...
    if ((g() != null) && (g().length > 0)) {
      localStringBuilder.append(",A2=").append(HexUtil.bytes2HexStr(g()));
    }
    if ((h() != null) && (h().length > 0)) {
      localStringBuilder.append(",A3=").append(HexUtil.bytes2HexStr(h()));
    }
    if ((i() != null) && (i().length > 0)) {
      localStringBuilder.append(",D1=").append(HexUtil.bytes2HexStr(i()));
    }
    if ((j() != null) && (j().length > 0)) {
      localStringBuilder.append(",D2=").append(HexUtil.bytes2HexStr(j()));
    }
    if ((k() != null) && (k().length > 0)) {
      localStringBuilder.append(",S2=").append(HexUtil.bytes2HexStr(k()));
    }
    if ((l() != null) && (l().length > 0)) {
      localStringBuilder.append(",key=").append(HexUtil.bytes2HexStr(l()));
    }
