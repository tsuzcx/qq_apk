...
public class k
{
  ...
  {
    com.tencent.msf.service.protocol.security.k localk;
    label161:
    Object localObject2;
    if ((paramFromServiceMsg.isSuccess()) && (paramFromServiceMsg.getWupBuffer() != null) && (paramFromServiceMsg.getWupBuffer().length > 0))
    {
      ...
      localk = (com.tencent.msf.service.protocol.security.k)((UniPacket)localObject1).getByClass("RespondHeader", new com.tencent.msf.service.protocol.security.k());
      a locala;
      if (localk != null)
      {
        ...
        case 9: 
          ...
          if (i < localRespondCustomSig.SigList.size())
          {
            ...
            if (((CustomSigContent)localObject1).ulSigType == 13L)
            {
              ...
              {
                localObject4 = this.b.l(localk.d);
                localObject1 = localObject2;
                if (localObject4 != null) {
                  localObject1 = ((a)localObject4).g();
                }
              }
            ...
            for (;;)
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  j.a((byte[])localObject2, 0, (byte[])localObject1, 4);
                  j.a((byte[])localObject3, 0, (byte[])localObject1, 4, 16);
                  j.a(arrayOfByte, 0, (byte[])localObject1, 20, 2);
                  ...
                  else
                  {
                    ...
                    j.a(arrayOfByte, 0, (byte[])localObject1, 22, j);
    ...
    for (Object localObject1 = ((i)localObject1).b;; localObject1 = "password error")
    {
      ...
      for (localObject1 = ((i)localObject1).b;; localObject1 = "loginFailed.")
      {
        ...
        {
          QLog.d("MSF.C.AccountRespHandler", 1, Thread.currentThread().getName() + " HandlerLoginResp setAccountNoLogin uin=" + MsfSdkUtils.getShortUin(paramFromServiceMsg.getUin()));
