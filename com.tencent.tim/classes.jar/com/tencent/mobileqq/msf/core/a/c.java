...
public class c
{
        ...
        else
        {
          if (this.P.size() >= 10)
          {
            ...
            if (localObject1 != null)
            {
              ...
              MsfStore.getNativeConfigStore().n_removeConfig(a.a("Socket", "Wifi", "Ipv4").a() + (String)localObject1);
              MsfStore.getNativeConfigStore().n_removeConfig(a.a("Http", "Wifi", "Ipv4").a() + (String)localObject1);
              MsfStore.getNativeConfigStore().n_removeConfig(a.a("Quic", "Wifi", "Ipv4").a() + (String)localObject1);
              MsfStore.getNativeConfigStore().n_removeConfig(a.a("Socket", "Wifi", "Ipv6").a() + (String)localObject1);
              MsfStore.getNativeConfigStore().n_removeConfig(a.a("Http", "Wifi", "Ipv6").a() + (String)localObject1);
              MsfStore.getNativeConfigStore().n_removeConfig(a.a("Quic", "Wifi", "Ipv6").a() + (String)localObject1);
            }
          }
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    for (Object localObject = "__loginSdk_ssoWifilist";; localObject = "__loginSdk_ssoWifilist_" + paramString)
    {
      ...
      localObject = a.a("Http", "Wifi", "Ipv4");
      a((a)localObject, ((a)localObject).a() + paramString, "__loginSdk_ssoHttpWifilist", paramBoolean);
      localObject = a.a("Quic", "Wifi", "Ipv4");
      a((a)localObject, ((a)localObject).a() + paramString, "__loginSdk_ssoQuicHttpList", paramBoolean);
      localObject = a.a("Socket", "Wifi", "Ipv6");
      boolean bool = this.A;
      this.A = (a((a)localObject, ((a)localObject).a() + paramString, null, paramBoolean) | bool);
      localObject = a.a("Http", "Wifi", "Ipv6");
      bool = this.A;
      this.A = (a((a)localObject, ((a)localObject).a() + paramString, null, paramBoolean) | bool);
      localObject = a.a("Quic", "Wifi", "Ipv6");
      bool = this.A;
      this.A = (a((a)localObject, ((a)localObject).a() + paramString, null, paramBoolean) | bool);
      if (QLog.isColorLevel()) {
  ...
  private boolean a(a parama, String paramString1, String paramString2, boolean paramBoolean)
  {
  ...
  private boolean a(a parama, String paramString1, ArrayList paramArrayList, boolean paramBoolean, String paramString2)
  {
    for (;;)
    {
      Object localObject1;
  ...
  private boolean a(com.tencent.mobileqq.msf.core.d paramd, a parama)
  {
  ...
  private boolean a(List paramList, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    return a(a.a(paramString1, paramString2, paramString3), paramString4, localArrayList, true, paramString5);
  }
  ...
  {
    a locala = a.a("Socket", "Mobile", "Ipv4");
    String str = locala.a() + paramString;
    if (TextUtils.isEmpty(paramString))
    {
      localObject = "__loginSdk_ssoMobilelist";
      a(locala, str, (String)localObject, paramBoolean);
      locala = a.a("Http", "Mobile", "Ipv4");
    ...
    {
      a(locala, str, (String)localObject, paramBoolean);
      localObject = a.a("Quic", "Mobile", "Ipv4");
      a((a)localObject, ((a)localObject).a() + paramString, "__loginSdk_ssoQuicHttpList", paramBoolean);
      localObject = a.a("Socket", "Mobile", "Ipv6");
      boolean bool = this.A;
      this.A = (a((a)localObject, ((a)localObject).a() + paramString, null, paramBoolean) | bool);
      localObject = a.a("Http", "Mobile", "Ipv6");
      bool = this.A;
      this.A = (a((a)localObject, ((a)localObject).a() + paramString, null, paramBoolean) | bool);
      localObject = a.a("Quic", "Mobile", "Ipv6");
      bool = this.A;
      this.A = (a((a)localObject, ((a)localObject).a() + paramString, null, paramBoolean) | bool);
      if (QLog.isColorLevel()) {
  ...
  private boolean b(List paramList, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    return a(a.a(paramString1, paramString2, paramString3), paramString4, localArrayList, false, paramString5);
  }
  ...
  private void h()
  {
    ...
    for (;;)
    {
      ...
      this.N.put(a.a("Socket", "Mobile", "Ipv4"), localCopyOnWriteArrayList);
      localCopyOnWriteArrayList = a(I);
      this.N.put(a.a("Socket", "Wifi", "Ipv4"), localCopyOnWriteArrayList);
      localCopyOnWriteArrayList = a(J);
      this.N.put(a.a("Http", "Mobile", "Ipv4"), localCopyOnWriteArrayList);
      this.N.put(a.a("Http", "Wifi", "Ipv4"), localCopyOnWriteArrayList);
      localCopyOnWriteArrayList = a(K);
      this.N.put(a.a("Quic", "Mobile", "Ipv4"), localCopyOnWriteArrayList);
      this.N.put(a.a("Quic", "Wifi", "Ipv4"), localCopyOnWriteArrayList);
      ...
      this.N.put(a.a("Socket", "Wifi", "Ipv6"), localCopyOnWriteArrayList);
      ...
      this.N.put(a.a("Socket", "Mobile", "Ipv6"), localCopyOnWriteArrayList);
      return;
    }
  }
  ...
  public long a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        l1 = Long.parseLong(MsfStore.getNativeConfigStore().getConfig("DualConnTime" + a.a(paramString1, "Wifi", paramString2) + str));
        return l1;
      }
      ...
      if (NetConnInfoCenter.isMobileConn())
      {
        ...
        if (!TextUtils.isEmpty(str)) {
          try
          {
            l1 = Long.parseLong(MsfStore.getNativeConfigStore().getConfig("DualConnTime" + a.a(paramString1, "Mobile", paramString2) + str));
            return l1;
          }
          catch (NumberFormatException paramString1)
          {
  ...
  public CopyOnWriteArrayList a(a parama, boolean paramBoolean)
  {
  ...
  public void a(com.tencent.mobileqq.msf.core.d paramd)
  {
    for (;;)
    {
      try
      {
        if (NetConnInfoCenter.isWifiConn())
        {
          if (!a(paramd, a.a("Socket", "Wifi", "Ipv4"))) {
            a(paramd, a.a("Socket", "Mobile", "Ipv4"));
          }
          return;
        }
        if (NetConnInfoCenter.isMobileConn())
        {
          if (a(paramd, a.a("Socket", "Mobile", "Ipv4"))) {
            continue;
          }
          a(paramd, a.a("Socket", "Wifi", "Ipv4"));
          continue;
        }
        a(paramd, a.a("Socket", "Wifi", "Ipv4"));
      }
  ...
  public void a(String paramString, int paramInt, long paramLong)
  {
    ...
    if (!TextUtils.isEmpty(str1))
    {
      ...
      if (!TextUtils.isEmpty(str2)) {
        MsfStore.getNativeConfigStore().n_setConfig("DualConnTime" + a.a(paramString, "Wifi", str1) + str2, String.valueOf(paramLong));
      }
    }
    label91:
    do
    ...
    MsfStore.getNativeConfigStore().n_setConfig("DualConnTime" + a.a(paramString, "Mobile", str1) + str2, String.valueOf(paramLong));
  }
  ...
  public void b()
  {
    ...
    //   5: astore_2
    //   6: aload_2
    //   7: invokestatic 329	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   10: istore_1
    //   11: iload_1
    //   12: ifeq +6 -> 18
    //   15: aload_0
  ...
  public String f()
  {
    ...
    if (locald != null)
    {
      ...
      if (!TextUtils.isEmpty(str1))
      {
        ...
        localObject1 = localObject2;
        if (!TextUtils.isEmpty(str2)) {
          localObject1 = MsfStore.getNativeConfigStore().getConfig("policyId" + a.a(locald.b(), "Wifi", str1) + str2);
        }
      }
    }
    label108:
    ...
    return MsfStore.getNativeConfigStore().getConfig("policyId" + a.a(locald.b(), "Mobile", str1) + str2);
  }
