  ...
  public void a(com.tencent.msf.service.protocol.e.f paramf, FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          MsfSdkUtils.writeServerConfig("com.tencent.tim", 0, str1, this.A.sender.j());
        }
    ...
    for (;;)
    {
      try
      {
        MsfSdkUtils.writeServerConfig("com.tencent.tim", 2, paramToServiceMsg, this.A.sender.j());
      }
    ...
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          MsfSdkUtils.writeServerConfig("com.tencent.tim", 1, paramToServiceMsg, this.A.sender.j());
