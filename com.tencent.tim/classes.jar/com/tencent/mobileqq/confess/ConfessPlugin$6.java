  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    do
    {
      ...
      {
        this.this$0.callJs(this.this$0.bxk, new String[] { "\"本群成员不能向好友发起加群邀请。\"" });
        return;
      }
      if ((localObject == null) || (((List)localObject).size() == 0))
      {
        this.this$0.callJs(this.this$0.bxk, new String[] { "\"获取群成员失败，请重试。\"" });
        return;
      }
    } while (ConfessPlugin.a(this.this$0, str, bool1, (ArrayList)localObject));
    this.this$0.callJs(this.this$0.bxk, new String[] { "\"邀请群成员异常。\"" });
    return;
    this.this$0.callJs(this.this$0.bxk, new String[] { "\"邀请群成员异常。\"" });
  }
}
