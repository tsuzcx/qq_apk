  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ArrayList localArrayList = this.val$data.getExtras().getStringArrayList("param_admins");
      this.this$0.b.coverAdministrators(this.this$0.app, localArrayList);
      this.this$0.mUIHandler.post(new ChatSettingForTroop.43.1(this));
      return;
    }
