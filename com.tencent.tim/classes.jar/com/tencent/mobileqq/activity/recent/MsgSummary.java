  ...
  public CharSequence a(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramContext = ((Resources)localObject1).getDrawable(2130850405);
        i = j + "F ".length();
        if (paramContext != null)
        {
      ...
      if (this.nState == 1)
      {
        paramContext = ((Resources)localObject1).getDrawable(2130850406);
        i = "S ".length();
        i = j + i;
        continue;
  ...
  public CharSequence a(Context paramContext, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if (this.nState == 2)
        {
          localObject1 = localResources.getDrawable(2130850405);
          if (paramInt <= 0) {
            break label618;
          }
          paramInt = paramContext.getResources().getColor(2131167410);
          if (!(this.strContent instanceof aofk)) {
            break label369;
          }
          paramContext = (aofk)this.strContent;
          ...
          paramContext = ((aofk)localObject3).a("F ", true, new int[0]);
          if (this.suffix == null) {
            break label615;
          }
        ...
        localObject1 = localResources.getDrawable(2130850406);
        continue;
        localObject2 = null;
      }
      catch (Exception localException)
      ...
      if (this.nState == 1)
      {
        paramContext = ((aofk)localObject3).a("S ", true, new int[0]);
        continue;
        label358:
        paramInt = 0;
        continue;
