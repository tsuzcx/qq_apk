  ...
  extends RecentUserBaseData
{
  ...
  public void c(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    this.mTitleName = paramContext.getString(2131720991);
    this.mMsgExtroInfo = "";
    oidb_0x791.RedDotInfo localRedDotInfo = ((jnv)paramQQAppInterface.getManager(70)).a(46, false);
    if (localRedDotInfo == null)
    {
      this.mUnreadNum = 0;
      this.mDisplayTime = 0L;
      this.mShowTime = "";
      this.mLastMsg = paramContext.getString(2131720992);
