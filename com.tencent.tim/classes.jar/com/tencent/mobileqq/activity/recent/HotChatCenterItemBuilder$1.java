  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      SparseArray localSparseArray = (SparseArray)HotChatCenterItemBuilder.a(this.this$0).get(this.val$gameId);
      if ((localSparseArray != null) && (localSparseArray.size() > 0))
      {
        if ((HotChatCenterItemBuilder.a(this.this$0) != null) && (HotChatCenterItemBuilder.a(this.this$0).get() != null)) {
          ApolloGameUtil.e((EntityManager)???, ApolloUtil.a(localSparseArray));
        }
