  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   28: astore 10
    //   30: aload_0
    //   31: getfield 16	com/tencent/mobileqq/activity/VipProfileCardDiyActivity$11:val$fileName	Ljava/lang/String;
    //   34: aload 9
    ...
    //   66: getfield 69	com/tencent/mobileqq/activity/VipProfileCardDiyActivity:mScreenWidth	I
    //   69: aload_0
    ...
    //   73: getfield 72	com/tencent/mobileqq/activity/VipProfileCardDiyActivity:mScreenHeight	I
    //   76: invokevirtual 76	com/tencent/mobileqq/activity/VipProfileCardDiyActivity:calculateInSampleSize	(Landroid/graphics/BitmapFactory$Options;II)I
    //   79: putfield 79	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   82: new 81	java/io/BufferedInputStream
    //   85: dup
    //   86: new 83	java/io/FileInputStream
    //   89: dup
    //   90: new 85	java/io/File
    //   93: dup
    //   94: aload_0
    //   95: getfield 16	com/tencent/mobileqq/activity/VipProfileCardDiyActivity$11:val$fileName	Ljava/lang/String;
    //   98: invokespecial 88	java/io/File:<init>	(Ljava/lang/String;)V
    //   101: invokespecial 91	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   104: invokespecial 94	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   107: astore 7
    //   109: aload 7
    //   111: astore 6
    //   113: aload 7
    //   115: aconst_null
    //   116: aload 9
    //   118: invokestatic 98	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   121: astore 8
    //   123: aload 8
    ...
    //   130: ifnull +8 -> 138
    //   133: aload 7
    //   135: invokevirtual 101	java/io/BufferedInputStream:close	()V
    //   138: return
    //   139: astore 6
    //   141: ldc 103
    //   143: iconst_1
    //   144: ldc 105
    //   146: aload 6
    //   148: invokestatic 111	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   151: return
    //   152: aload 7
    //   154: astore 6
    //   156: aload 8
    //   158: invokevirtual 117	android/graphics/Bitmap:getHeight	()I
    //   161: istore_2
    //   162: aload 7
    //   164: astore 6
    //   166: aload 8
    //   168: invokevirtual 120	android/graphics/Bitmap:getWidth	()I
    //   171: istore_3
    //   172: aload 7
    //   174: astore 6
    //   176: aload_0
    ...
    //   180: getfield 69	com/tencent/mobileqq/activity/VipProfileCardDiyActivity:mScreenWidth	I
    //   183: i2f
    //   184: aload_0
    ...
    //   188: getfield 72	com/tencent/mobileqq/activity/VipProfileCardDiyActivity:mScreenHeight	I
    //   191: i2f
    //   192: fdiv
    //   193: fstore_1
    //   194: aload 7
    ...
    //   202: fmul
    //   203: f2i
    //   204: invokestatic 126	java/lang/Math:min	(II)I
    //   207: istore 4
    //   209: aload 7
    //   211: astore 6
    //   213: iload 4
    ...
    //   221: aload 7
    //   223: astore 6
    //   225: invokestatic 130	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   228: ifeq +411 -> 639
    //   231: aload 7
    //   233: astore 6
    //   235: ldc 103
    //   237: iconst_2
    //   238: new 132	java/lang/StringBuilder
    //   241: dup
    //   242: invokespecial 133	java/lang/StringBuilder:<init>	()V
    //   245: ldc 135
    //   247: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   250: iload 4
    //   252: invokevirtual 142	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   255: ldc 144
    //   257: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   260: iload 5
    //   262: invokevirtual 142	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   265: ldc 146
    //   267: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   270: aload 9
    //   272: getfield 79	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   275: invokevirtual 142	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   278: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   281: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   284: goto +355 -> 639
    //   287: aload 8
    //   289: ifnull +47 -> 336
    //   292: aload 7
    //   294: astore 6
    //   296: new 156	android/graphics/drawable/BitmapDrawable
    //   299: dup
    //   300: aload 10
    //   302: aload 8
    //   304: invokespecial 159	android/graphics/drawable/BitmapDrawable:<init>	(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)V
    //   307: astore 8
    //   309: aload 7
    //   311: astore 6
    //   313: aload 8
    //   315: aload 10
    //   317: invokevirtual 165	android/content/res/Resources:getDisplayMetrics	()Landroid/util/DisplayMetrics;
    //   320: invokevirtual 169	android/graphics/drawable/BitmapDrawable:setTargetDensity	(Landroid/util/DisplayMetrics;)V
    //   323: aload 7
    //   325: astore 6
    //   327: aload_0
    ...
    //   331: aload 8
    //   333: putfield 173	com/tencent/mobileqq/activity/VipProfileCardDiyActivity:dE	Landroid/graphics/drawable/Drawable;
    //   336: aload 7
    //   338: astore 6
    //   340: aload_0
    ...
    //   344: getfield 173	com/tencent/mobileqq/activity/VipProfileCardDiyActivity:dE	Landroid/graphics/drawable/Drawable;
    //   347: ifnull +21 -> 368
    //   350: aload 7
    //   352: astore 6
    //   354: aload_0
    ...
    //   358: getfield 177	com/tencent/mobileqq/activity/VipProfileCardDiyActivity:a	Lauru;
    //   361: iconst_3
    //   362: invokevirtual 183	auru:obtainMessage	(I)Landroid/os/Message;
    //   365: invokevirtual 188	android/os/Message:sendToTarget	()V
    //   368: aload 7
    //   370: ifnull -232 -> 138
    //   373: aload 7
    //   375: invokevirtual 101	java/io/BufferedInputStream:close	()V
    //   378: return
    //   379: astore 6
    //   381: ldc 103
    //   383: iconst_1
    //   384: ldc 105
    //   386: aload 6
    //   388: invokestatic 111	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   391: return
    //   392: aload 7
    //   394: astore 6
    //   396: aload 8
    ...
    //   400: iload 4
    //   402: iload 5
    //   404: invokestatic 192	android/graphics/Bitmap:createBitmap	(Landroid/graphics/Bitmap;IIII)Landroid/graphics/Bitmap;
    //   407: astore 9
    //   409: aload 7
    //   411: astore 6
    //   413: aload 8
    //   415: invokevirtual 195	android/graphics/Bitmap:recycle	()V
    //   418: aload 7
    //   420: astore 6
    //   422: invokestatic 130	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   425: ifeq +15 -> 440
    //   428: aload 7
    //   430: astore 6
    //   432: ldc 103
    //   434: iconst_2
    //   435: ldc 197
    //   437: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   440: aload 9
    //   442: astore 8
    //   444: goto -157 -> 287
    //   447: astore 8
    ...
    //   452: aload 7
    //   454: astore 6
    //   456: invokestatic 130	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   459: ifeq +36 -> 495
    //   462: aload 7
    //   464: astore 6
    //   466: ldc 103
    //   468: iconst_2
    //   469: new 132	java/lang/StringBuilder
    //   472: dup
    //   473: invokespecial 133	java/lang/StringBuilder:<init>	()V
    //   476: ldc 199
    //   478: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   481: aload 8
    //   483: invokevirtual 202	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    //   486: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   489: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   492: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   495: aload 7
    //   497: ifnull -359 -> 138
    //   500: aload 7
    //   502: invokevirtual 101	java/io/BufferedInputStream:close	()V
    //   505: return
    //   506: astore 6
    //   508: ldc 103
    //   510: iconst_1
    //   511: ldc 105
    //   513: aload 6
    //   515: invokestatic 111	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   518: return
    //   519: astore 8
    //   521: aconst_null
    //   522: astore 7
    //   524: aload 7
    //   526: astore 6
    //   528: invokestatic 130	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   531: ifeq +36 -> 567
    //   534: aload 7
    //   536: astore 6
    //   538: ldc 103
    //   540: iconst_2
    //   541: new 132	java/lang/StringBuilder
    //   544: dup
    //   545: invokespecial 133	java/lang/StringBuilder:<init>	()V
    //   548: ldc 204
    //   550: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   553: aload 8
    //   555: invokevirtual 205	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   558: invokevirtual 139	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   561: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   564: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   567: aload 7
    //   569: ifnull -431 -> 138
    //   572: aload 7
    //   574: invokevirtual 101	java/io/BufferedInputStream:close	()V
    //   577: return
    //   578: astore 6
    //   580: ldc 103
    //   582: iconst_1
    //   583: ldc 105
    //   585: aload 6
    //   587: invokestatic 111	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   590: return
    //   591: astore 7
    //   593: aconst_null
    //   594: astore 6
    ...
    //   598: ifnull +8 -> 606
    //   601: aload 6
    //   603: invokevirtual 101	java/io/BufferedInputStream:close	()V
    //   606: aload 7
    //   608: athrow
    //   609: astore 6
    //   611: ldc 103
    ...
    //   614: ldc 105
    //   616: aload 6
    //   618: invokestatic 111	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   621: goto -15 -> 606
    //   624: astore 7
    //   626: goto -30 -> 596
    //   629: astore 8
