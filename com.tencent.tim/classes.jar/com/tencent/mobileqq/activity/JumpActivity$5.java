  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject2 = this.ab.getString("android.intent.extra.TEXT");
    Object localObject1 = this.this$0.getIntent().getType();
    Object localObject3 = this.ab.getString("pkg_name");
    if (QSecFramework.a().c(1003).booleanValue()) {
      arnv.a().j(this.this$0, null);
    }
    if ("cn.wps.moffice_eng".equals(localObject3)) {
      anot.a(this.this$0.app, "CliOper", "", "", "0X8008810", "0X8008810", 0, 0, "", "", "", "");
    }
    if (TextUtils.isEmpty((CharSequence)localObject1)) {
      return;
    }
    anpb.F(this.this$0.app.getApplication().getApplicationContext(), this.this$0.app.getCurrentAccountUin(), "dl_share_frd");
    if (QLog.isColorLevel()) {
      QLog.d("JumpAction", 2, "forward form JumpActivity doShare type=" + (String)localObject1);
    }
    if ((((String)localObject1).startsWith("text")) && (!this.ab.containsKey("android.intent.extra.STREAM")))
    {
    ...
    for (;;)
    {
      ...
      ahgq.P(this.this$0, (Intent)localObject1);
      this.this$0.finish();
      return;
      ...
      ((Intent)localObject1).putExtra("k_favorites", true);
      ((Intent)localObject1).putExtra("forward_type", -1);
      ((Intent)localObject1).putExtra("forward_text", (SpannableString)this.ab.get("android.intent.extra.TEXT"));
      this.this$0.startActivity((Intent)localObject1);
      this.this$0.finish();
    }
    if (((String)localObject1).startsWith("image"))
    {
      ...
      {
        localObject2 = this.ab.get("android.intent.extra.STREAM");
      ...
      for (;;)
      {
        ((Intent)localObject1).putExtras(this.ab);
        this.this$0.startActivity((Intent)localObject1);
        break;
        ...
        ((Intent)localObject1).putExtra("forward_text", this.this$0.getString(2131691984));
      }
    }
    ...
    {
      localObject3 = this.ab.get("android.intent.extra.STREAM");
      if (localObject3 != null) {
        if ((localObject3 instanceof Uri))
        {
          ...
          if (("text/x-vcard".equals(localObject1)) && ("content".equals(((Uri)localObject3).getScheme())))
          {
            ...
            ((Intent)localObject2).putExtras(this.ab);
            new JumpActivity.h(this.this$0, (Intent)localObject2).execute(new Object[] { this.this$0.getApplicationContext(), localObject3 });
            return;
          }
    ...
    {
      ((Intent)localObject2).putExtras(this.ab);
      ahgq.P(this.this$0, (Intent)localObject2);
      break;
      ...
      ((Intent)localObject2).putExtra("forward_text", this.this$0.getString(2131691984));
    }
    label992:
    this.this$0.finish();
  }
