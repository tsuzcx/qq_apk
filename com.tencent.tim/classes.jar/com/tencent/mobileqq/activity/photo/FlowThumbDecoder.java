  ...
  implements aoow
{
  ...
  public FlowThumbDecoder(Context paramContext, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    sFlowItemHeight = localResources.getDimension(2131297340);
    sFlowItemMaxWidth = localResources.getDimension(2131297338);
    sFlowItemMinWidth = localResources.getDimension(2131297339);
    ...
    if (i == 0) {
      try
      {
        ...
        if ((!paramContext.isInJustDecodeBounds) && (paramContext.needRegionDecode))
        {
          ...
          localanpc.collectPerformance(null, "safeDecode", bool, l, paramContext.rawWidth * i, paramOptions, "");
        }
        return paramLocalMediaInfo;
      }
      catch (OutOfMemoryError paramContext)
  ...
  public Bitmap getBitmap(URL paramURL)
  {
    ...
    int i = aoop.eI(localLocalMediaInfo.path);
