...
{
  public K mActivity;
  IimageAdapterCallback mImageAdapterCallback = null;
  ...
  public static abstract interface IimageAdapterCallback
  {
    public abstract View getView(int paramInt, View paramView, ViewGroup paramViewGroup);
  }
  
  public static abstract interface IonCheckedChangedCallback
  {
    public abstract void flashPicCheckedChanged(boolean paramBoolean);
  }
}
