  ...
  extends BaseAdapter
{
  ...
  QQAlbumInfo queryAllVideoBucket(Context paramContext)
  {
    ...
    //   48: aconst_null
    //   49: ldc 29
    //   51: invokestatic 309	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   54: astore_2
    //   55: aload_2
    //   56: astore_1
    //   57: iconst_2
  ...
  public List<QQAlbumInfo> queryImageBuckets(Context paramContext, int paramInt)
  {
    ...
    //   27: aconst_null
    //   28: ldc 8
    //   30: invokestatic 309	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   33: astore 12
    //   35: aload 12
    //   37: ifnonnull +57 -> 94
    //   40: aconst_null
  ...
  QQAlbumInfo queryRecentVideoBucket(Context paramContext, int paramInt1, int paramInt2, MediaFileFilter paramMediaFileFilter)
  {
    ...
    //   6: iload_3
    //   7: ifgt +14 -> 21
    //   10: new 692	java/lang/IllegalArgumentException
    //   13: dup
    //   14: ldc_w 694
    //   17: invokespecial 695	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   20: athrow
    //   21: new 455	com/tencent/mobileqq/data/QQAlbumInfo
    //   24: dup
    //   25: invokespecial 565	com/tencent/mobileqq/data/QQAlbumInfo:<init>	()V
    //   28: astore 8
    //   30: aload 8
    //   32: ldc_w 666
    //   35: putfield 569	com/tencent/mobileqq/data/QQAlbumInfo:_id	Ljava/lang/String;
    //   38: aload 8
    //   40: getstatic 669	com/tencent/mobileqq/activity/photo/album/QAlbumCustomAlbumConstants:RECENT_ALBUM_NAME	Ljava/lang/String;
    //   43: putfield 577	com/tencent/mobileqq/data/QQAlbumInfo:name	Ljava/lang/String;
    //   46: iload_3
    //   47: ifle +142 -> 189
    ...
    //   90: aconst_null
    //   91: ldc 29
    //   93: invokestatic 309	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   96: astore_1
    //   97: aload 4
    //   99: ifnull +16 -> 115
    //   102: aload_1
    ...
    //   107: iload_3
    //   108: aload 4
    //   110: invokevirtual 591	com/tencent/mobileqq/activity/photo/album/AlbumListAdapter:getVideoList	(Landroid/database/Cursor;ILcom/tencent/mobileqq/activity/photo/MediaFileFilter;)Ljava/util/List;
    //   113: astore 6
    //   115: aload 6
    //   117: ifnull +59 -> 176
    //   120: aload_1
    ...
    //   147: aload 8
    //   149: iload_2
    //   150: putfield 580	com/tencent/mobileqq/data/QQAlbumInfo:mMediaFileCount	I
    //   153: iload_2
    //   154: ifle +22 -> 176
    //   157: aload_1
    //   158: astore 5
    ...
    //   177: ifnull +9 -> 186
    //   180: aload_1
    //   181: invokeinterface 630 1 0
    //   186: aload 8
    //   188: areturn
    //   189: getstatic 583	android/provider/MediaStore$Video$Media:EXTERNAL_CONTENT_URI	Landroid/net/Uri;
    //   192: astore 5
    //   194: goto -116 -> 78
    //   197: astore 4
    //   199: aconst_null
    ...
    //   215: iconst_2
    //   216: aload 4
    //   218: invokevirtual 633	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   221: aload 4
    //   223: invokestatic 637	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   226: aload_1
    //   227: ifnull -41 -> 186
    //   230: aload_1
    //   231: invokeinterface 630 1 0
    //   236: aload 8
    //   238: areturn
    //   239: astore_1
    //   240: aload 7
  ...
  public List<QQAlbumInfo> queryVideoBuckets(Context paramContext, int paramInt, MediaFileFilter paramMediaFileFilter)
  {
    ...
    //   18: aconst_null
    //   19: ldc 8
    //   21: invokestatic 309	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   24: astore_3
    //   25: aload_3
    //   26: ifnonnull +51 -> 77
    //   29: aconst_null
