  ...
  implements PhotoListLogic.IadapterCallback, PhotoListLogic.IcheckBoxCallback, PhotoListLogic.IitemClickCallback
{
  ...
  protected boolean addAndRemovePhotoByGesture(LocalMediaInfo paramLocalMediaInfo, boolean paramBoolean)
  {
    ...
    QQToast.a(this.mActivity, getExceedMaxSelectNumStr(paramLocalMediaInfo), 1000).show(this.mActivity.mTitleBarHeight);
  ...
  protected String getExceedMaxSelectNumStr(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    return this.mActivity.getResources().getString(2131696894, new Object[] { Integer.valueOf(i) });
  }
  ...
  public View getViewCaseCamera(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      paramViewGroup.setImageResource(2130842319);
  ...
  public View getViewCaseImage(int paramInt, View paramView, ViewGroup paramViewGroup, AbstractPhotoListActivity.PhotoListAdapter.Holder paramHolder, AbstractPhotoListActivity.CheckBoxClickedListener paramCheckBoxClickedListener)
  {
    if (paramView == null)
    {
      paramViewGroup = this.mActivity.photoListAdapter.mInflater.inflate(2131561545, null);
      paramViewGroup.setLayoutParams(new AbsListView.LayoutParams(this.mActivity.mImageWidth, this.mActivity.mImageHeight));
      paramHolder.mImageView = ((ImageView)paramViewGroup.findViewById(2131373182));
      paramHolder.mImageViewPanoramaIcon = ((ImageView)paramViewGroup.findViewById(2131373143));
      paramHolder.mMaskView = ((ImageView)paramViewGroup.findViewById(2131369477));
      paramHolder.mSelectedIconView = ((ImageView)paramViewGroup.findViewById(2131373187));
      paramHolder.mSelectedBtn = paramViewGroup.findViewById(2131373184);
      paramHolder.mCheckBox = ((NumberCheckBox)paramViewGroup.findViewById(2131373185));
      paramHolder.mPhotoFlagView = ((ImageView)paramViewGroup.findViewById(2131373113));
    ...
    for (;;)
    {
      ...
      if (paramViewGroup != null)
      {
        ...
        if ((localObject == null) || (!((URLDrawable)localObject).getURL().toString().equals(localStringBuilder.toString())))
        {
          ...
          localObject = aoop.getDrawable((URL)localObject, this.mActivity.photoListAdapter.colorDrawable, this.mActivity.photoListAdapter.mDefaultPhotoDrawable);
  ...
  public View getViewCaseVideo(int paramInt, View paramView, ViewGroup paramViewGroup, AbstractPhotoListActivity.PhotoListAdapter.Holder paramHolder, AbstractPhotoListActivity.CheckBoxClickedListener paramCheckBoxClickedListener)
  {
    ...
    if (paramView == null)
    {
      paramView = this.mActivity.photoListAdapter.mInflater.inflate(2131561786, null);
      paramView.setLayoutParams(new AbsListView.LayoutParams(this.mActivity.mImageWidth, this.mActivity.mImageHeight));
      paramHolder.mImageView = ((ImageView)paramView.findViewById(2131373182));
      paramHolder.mTextView = ((TextView)paramView.findViewById(2131373188));
      paramHolder.mMaskView = ((ImageView)paramView.findViewById(2131369477));
      paramHolder.mSelectedIconView = ((ImageView)paramView.findViewById(2131373187));
      paramHolder.mSelectedBtn = paramView.findViewById(2131373184);
      paramHolder.mCheckBox = ((NumberCheckBox)paramView.findViewById(2131373185));
      if (this.mPhotoCommonData.maxSelectNum > 100) {
        paramHolder.mCheckBox.setTextSize(10.0F);
      }
      paramHolder.checkBoxListener = paramCheckBoxClickedListener;
    ...
    if (paramCheckBoxClickedListener.isSystemMeidaStore)
    {
      ...
      if ((localURLDrawable == null) || (!localURLDrawable.getURL().equals(paramView)))
      {
        ...
        paramView = aoop.getDrawable(paramView, this.mActivity.photoListAdapter.colorDrawable, this.mActivity.photoListAdapter.mDefaultPhotoDrawable);
      ...
      paramView = MediaScanner.getInstance(BaseApplication.getContext());
      if (paramView != null) {
  ...
  public void onCheckBoxClick(View paramView, int paramInt, CheckBox paramCheckBox)
  {
    ...
    QQToast.a(this.mActivity, getExceedMaxSelectNumStr(localLocalMediaInfo), 0).show(this.mActivity.mTitleBarHeight);
  ...
  protected boolean onQueryPhoto(List<LocalMediaInfo> paramList)
  {
    ...
    if (paramList == null)
    {
      ...
      updateButton();
      QQToast.a(this.mActivity, "暂无媒体文件", 1000).show();
      return false;
    }
  ...
  protected List<LocalMediaInfo> queryPhotoList()
  {
    ...
    Object localObject3 = localPhotoCommonBaseData.selectedPhotoList;
    ...
    for (;;)
    {
      ...
      for (int j = ((Integer)QAlbumUtil.sLastAlbumPhotoCountMap.get(localPhotoCommonBaseData.albumId)).intValue();; j = 0)
      {
        Object localObject4;
        Object localObject5;
        if ((this.mPhotoListData.isShowCamera) && (localPhotoCommonBaseData.albumId.equals("$RecentAlbumId")))
        {
        ...
        int i;
        if ((this.mPhotoListData.showCameraInVideo) && (localPhotoCommonBaseData.albumId.equals("$VideoAlbumId")))
        {
          localObject4 = ((List)localObject1).iterator();
          while (((Iterator)localObject4).hasNext())
          {
        ...
        for (;;)
        {
          ...
          if (i < ((List)localObject1).size())
          {
            ...
            for (;;)
            {
              ...
              if (((ArrayList)localObject3).contains(((LocalMediaInfo)localObject5).path))
              {
                ...
                if (!localPhotoCommonBaseData.selectedIndex.contains(((LocalMediaInfo)localObject5).position)) {
                  localPhotoCommonBaseData.selectedIndex.add(((LocalMediaInfo)localObject5).position);
                }
              ...
              else if ((((ArrayList)localObject3).size() < localPhotoCommonBaseData.maxSelectNum) && (((LocalMediaInfo)localObject5).path.equals(this.mPhotoListData.currentPhotoPath)))
              {
                ((LocalMediaInfo)localObject5).selectStatus = 1;
          ...
          if (needVedio())
          {
            ...
            for (;;)
            {
              ...
              while (((Iterator)localObject3).hasNext())
              {
                ...
                if ((localPhotoCommonBaseData.allMediaInfoHashMap.containsKey(localObject5)) && (!((HashMap)localObject2).containsKey(localObject5))) {
                  ((HashMap)localObject2).put(localObject5, localPhotoCommonBaseData.allMediaInfoHashMap.get(localObject5));
                }
              }
          ...
          localPhotoCommonBaseData.mediaPathsList = ((ArrayList)localObject4);
          return localObject1;
        }
      }
    }
  ...
  protected void updateButton()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      return;
      str1 = this.mActivity.getString(2131696878);
      break;
    }
  }
}
