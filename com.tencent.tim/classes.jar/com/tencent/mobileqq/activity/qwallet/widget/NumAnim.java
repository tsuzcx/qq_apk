  ...
  implements Runnable
{
  ...
  public static final String WAN = acfp.m(2131709212);
  ...
  Ruler mRuler = new NumAnim.1(this);
  private double[] nums;
  ...
  public void run()
  {
    if ((this.curr_index < this.nums.length) && (this.mRuler != null))
    {
      ...
      if ((localObject != null) && (!TextUtils.isEmpty(((SpannableValue)localObject).valueStr)))
      {
        SpannableString localSpannableString = new SpannableString(((SpannableValue)localObject).valueStr);
        i = ((SpannableValue)localObject).suffixIndex;
        int j = ((SpannableValue)localObject).preffixLen;
        int k = ((SpannableValue)localObject).valueStr.length();
        if (j > 0)
        {
  ...
  public void setAnimListener(AnimListener paramAnimListener)
  {
  ...
  public void setRuler(Ruler paramRuler)
  {
  ...
  {
    // Byte code:
    //   0: invokestatic 265	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   3: ifeq +50 -> 53
    //   6: ldc 28
    //   8: iconst_4
    ...
    //   22: dload_1
    //   23: invokevirtual 296	java/lang/StringBuilder:append	(D)Ljava/lang/StringBuilder;
    //   26: ldc_w 298
    //   29: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   32: dload_3
    //   33: invokevirtual 296	java/lang/StringBuilder:append	(D)Ljava/lang/StringBuilder;
    //   36: ldc_w 300
    //   39: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   42: lload 5
    //   44: invokevirtual 276	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    ...
    //   53: aload_0
    //   54: invokestatic 273	java/lang/System:currentTimeMillis	()J
    //   57: putfield 126	com/tencent/mobileqq/activity/qwallet/widget/NumAnim:startTime	J
    //   60: aload_0
    //   61: getfield 128	com/tencent/mobileqq/activity/qwallet/widget/NumAnim:view	Landroid/widget/TextView;
    //   64: ifnonnull +4 -> 68
    //   67: return
    //   68: aload_0
    //   69: getfield 128	com/tencent/mobileqq/activity/qwallet/widget/NumAnim:view	Landroid/widget/TextView;
    //   72: aload_0
    //   73: invokevirtual 251	android/widget/TextView:removeCallbacks	(Ljava/lang/Runnable;)Z
    //   76: pop
    //   77: ldc2_w 301
    //   80: dload_1
    //   81: dmul
    //   82: invokestatic 173	com/tencent/mobileqq/activity/qwallet/widget/NumAnim:trimMax	(D)D
    //   85: dstore 7
    //   87: ldc2_w 301
    //   90: dload_3
    //   91: dmul
    //   92: invokestatic 173	com/tencent/mobileqq/activity/qwallet/widget/NumAnim:trimMax	(D)D
    //   95: dstore 9
    //   97: dload_1
    //   98: dload_3
    //   99: dcmpg
    ...
    //   236: aload_0
    //   237: aload 14
    //   239: putfield 171	com/tencent/mobileqq/activity/qwallet/widget/NumAnim:nums	[D
    //   242: aload 14
    //   244: arraylength
    //   245: iconst_1
    ...
    //   261: i2l
    //   262: ldiv
    //   263: putfield 253	com/tencent/mobileqq/activity/qwallet/widget/NumAnim:pertime	J
    //   266: aload_0
    //   267: iconst_0
    //   268: putfield 169	com/tencent/mobileqq/activity/qwallet/widget/NumAnim:curr_index	I
    //   271: aload_0
    //   272: monitorexit
    //   273: aload_0
    //   274: getfield 128	com/tencent/mobileqq/activity/qwallet/widget/NumAnim:view	Landroid/widget/TextView;
    //   277: aload_0
    //   278: invokevirtual 310	android/widget/TextView:post	(Ljava/lang/Runnable;)Z
    //   281: pop
    //   282: return
    //   283: aload 14
    //   285: arraylength
  ...
  public static abstract interface AnimListener
  {
    public abstract void onFinished();
  }
  
  public static abstract interface Ruler
  {
    public abstract NumAnim.SpannableValue getNumber(double paramDouble);
  }
  ...
  public static class SpannableValue
  {
    ...
    public SpannableValue(String paramString, int paramInt1, int paramInt2)
    {
