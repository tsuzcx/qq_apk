  ...
  implements View.OnClickListener
{
  ...
  public static JSONObject getYellowTipsConfig(Context paramContext, String paramString)
  {
    ...
    //   20: getstatic 57	aagi:bcS	Ljava/lang/String;
  ...
  {
    paramContext = LayoutInflater.from(paramContext).inflate(2131560744, this, true);
    paramContext.setClickable(true);
    paramContext.setOnClickListener(this);
    this.mWariningView = ((ImageView)findViewById(2131368807));
    this.mText = ((TextView)findViewById(2131368806));
    this.mArrowView = ((ImageView)findViewById(2131368804));
  }
