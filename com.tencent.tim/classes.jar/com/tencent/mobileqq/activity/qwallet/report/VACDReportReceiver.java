  ...
  extends BroadcastReceiver
{
  public void a(ReportItem paramReportItem)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = ((BridgeHelper)localObject2).getConfig("crash_title");
        String str1 = ((BridgeHelper)localObject2).getConfig("crash_content");
        String str2 = ((BridgeHelper)localObject2).getConfig("crash_btn");
        String str3 = ((BridgeHelper)localObject2).getConfig("crash_url");
        String str4 = ((BridgeHelper)localObject2).getConfig("crash_modelRegex");
        localObject2 = ((BridgeHelper)localObject2).getConfig("crash_crashRegex");
  ...
  public void cS(Intent paramIntent)
  {
    ...
    {
      localObject = (aafp)((QQAppInterface)localObject).getManager(148);
      if (localObject == null) {
        return;
      }
      ...
      ((aafp)localObject).a(paramIntent.getStringExtra("vacdReport_extra:sKey"), (ReportHeader)paramIntent.getSerializableExtra("vacdReport_extra:header"), localReportItem);
    }
    for (;;)
    {
      a(localReportItem);
      ...
      if ("vacdReport_step:add".equals(str)) {
        ((aafp)localObject).a(l, paramIntent.getStringExtra("vacdReport_extra:sKey"), localReportItem);
      } else if ("vacdReport_step:end".equals(str)) {
        ((aafp)localObject).a(l, localReportItem);
      } else if ("vacdReport_step:single".equals(str)) {
        ((aafp)localObject).b(paramIntent.getStringExtra("vacdReport_extra:sKey"), (ReportHeader)paramIntent.getSerializableExtra("vacdReport_extra:header"), localReportItem);
      }
    }
  }
