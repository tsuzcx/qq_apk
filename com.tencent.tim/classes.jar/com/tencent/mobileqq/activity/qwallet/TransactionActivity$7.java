  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    TransactionActivity.b(this.this$0).dispatchTouchEvent(localMotionEvent1);
    MotionEvent localMotionEvent2 = MotionEvent.obtain(SystemClock.uptimeMillis(), SystemClock.uptimeMillis(), 1, 0.0F, 0.0F, 0);
    TransactionActivity.b(this.this$0).dispatchTouchEvent(localMotionEvent2);
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.qwallet.TransactionActivity.7
