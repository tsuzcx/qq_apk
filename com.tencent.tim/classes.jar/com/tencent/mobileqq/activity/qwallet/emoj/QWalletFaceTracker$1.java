    ...
    if ((localList != null) && (localList.size() > 0) && (localObject != null) && (((List)localObject).size() > 0))
    {
      ...
      if ((localList != null) && (localList.size() > 0) && (localObject != null) && (localObject.length > 0)) {
        if (this.this$0.expressionItemList != null)
        {
          ...
          {
            irl.a locala = localExpressionInfo.expressionItem;
            irl.b localb = irl.a(locala, new ArrayList(localList), irl.a((float[])localObject));
            f2 = localb.score;
            if (QLog.isColorLevel()) {
            ...
            if (f2 > this.val$threshold)
            {
              ...
              {
                if ((locala.expressionWeight[0] <= 0.0D) || (locala.expressionWeight[1] <= 0.0D) || (irl.a(localb))) {
                  break label628;
                }
                if (!QLog.isColorLevel()) {
                  break label634;
                ...
                break label634;
                boolean bool = QWalletFaceTracker.access$100(this.this$0, localb.score, localExpressionInfo.coolValue, locala.expressionWeight, locala.cB, this.this$0.normalFaceExpression, localList, irl.a((float[])localObject));
                if (QLog.isColorLevel()) {
