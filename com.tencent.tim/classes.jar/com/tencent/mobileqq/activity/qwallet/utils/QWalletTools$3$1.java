  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      RedDotImageView localRedDotImageView = (RedDotImageView)this.this$0.W.get();
      if (localRedDotImageView != null)
      {
        localRedDotImageView.setReddotXOffsetDp(15);
        localRedDotImageView.setReddotYOffsetDp(10);
        localRedDotImageView.setRedDotDrawable(localRedDotImageView.getResources().getDrawable(2130851401));
        localRedDotImageView.showRedDot(true);
      }
      return;
    }
