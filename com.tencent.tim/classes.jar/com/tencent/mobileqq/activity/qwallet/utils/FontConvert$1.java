...
public class FontConvert$1
  implements Runnable
{
  public FontConvert$1(aafy paramaafy) {}
  ...
  public void run()
  {
    ...
    //   1: istore_2
    //   2: aload_0
    //   3: getfield 12	com/tencent/mobileqq/activity/qwallet/utils/FontConvert$1:this$0	Laafy;
    //   6: invokevirtual 27	aafy:qt	()Ljava/lang/String;
    //   9: astore 5
    //   11: aload 5
    ...
    //   43: return
    //   44: aload_0
    //   45: getfield 12	com/tencent/mobileqq/activity/qwallet/utils/FontConvert$1:this$0	Laafy;
    //   48: iconst_1
    //   49: invokestatic 43	aafy:a	(Laafy;Z)Z
    //   52: pop
    ...
    //   65: getstatic 56	java/io/File:separator	Ljava/lang/String;
    ...
    //   74: astore 5
    //   76: new 61	java/io/BufferedReader
    //   79: dup
    //   80: new 63	java/io/FileReader
    //   83: dup
    //   84: new 52	java/io/File
    //   87: dup
    ...
    //   108: invokespecial 68	java/io/File:<init>	(Ljava/lang/String;)V
    //   111: invokespecial 71	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   114: invokespecial 74	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   117: astore 6
    //   119: aload 6
    //   121: astore 5
    //   123: new 45	java/lang/StringBuilder
    //   126: dup
    //   127: invokespecial 46	java/lang/StringBuilder:<init>	()V
    //   130: astore 7
    //   132: aload 6
    //   134: astore 5
    ...
    //   147: astore 5
    //   149: aload 6
    //   151: invokevirtual 78	java/io/BufferedReader:read	()I
    //   154: istore_3
    //   155: iload_3
    //   156: iconst_m1
    ...
    //   186: aload 7
    //   188: iload_1
    //   189: invokevirtual 81	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   192: pop
    //   193: goto -48 -> 145
    //   196: astore 7
    //   198: aload 6
    //   200: astore 5
    //   202: aload 7
    //   204: invokevirtual 82	java/lang/Throwable:printStackTrace	()V
    //   207: aload 6
    //   209: ifnull -174 -> 35
    //   212: aload 6
    //   214: invokevirtual 85	java/io/BufferedReader:close	()V
    //   217: return
    //   218: astore 5
    //   220: aload 5
    ...
    //   230: aload 8
    //   232: iload_1
    //   233: invokevirtual 81	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   236: pop
    //   237: goto -92 -> 145
    //   240: astore 7
    //   242: aload 5
    ...
    //   252: ifnull +8 -> 260
    //   255: aload 6
    //   257: invokevirtual 85	java/io/BufferedReader:close	()V
    //   260: aload 5
    //   262: athrow
    //   263: aload 6
    //   265: astore 5
    //   267: aload_0
    //   268: getfield 12	com/tencent/mobileqq/activity/qwallet/utils/FontConvert$1:this$0	Laafy;
    //   271: aload 7
    //   273: invokevirtual 59	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   276: invokestatic 88	aafy:a	(Laafy;Ljava/lang/String;)Ljava/lang/String;
    //   279: pop
    //   280: aload 6
    //   282: astore 5
    //   284: aload_0
    //   285: getfield 12	com/tencent/mobileqq/activity/qwallet/utils/FontConvert$1:this$0	Laafy;
    //   288: aload 8
    //   290: invokevirtual 59	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   293: invokestatic 91	aafy:b	(Laafy;Ljava/lang/String;)Ljava/lang/String;
    //   296: pop
    //   297: aload 6
    //   299: astore 5
    //   301: invokestatic 97	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   304: ifeq +73 -> 377
    //   307: aload 6
    //   309: astore 5
    //   311: ldc 99
    //   313: iconst_2
    //   314: new 45	java/lang/StringBuilder
    //   317: dup
    //   318: invokespecial 46	java/lang/StringBuilder:<init>	()V
    //   321: ldc 101
    //   323: invokevirtual 50	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   326: aload_0
    //   327: getfield 12	com/tencent/mobileqq/activity/qwallet/utils/FontConvert$1:this$0	Laafy;
    //   330: invokestatic 104	aafy:a	(Laafy;)Ljava/lang/String;
    //   333: invokevirtual 50	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   336: invokevirtual 59	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   339: invokestatic 108	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   342: aload 6
    //   344: astore 5
    //   346: ldc 99
    //   348: iconst_2
    ...
    //   356: ldc 110
    //   358: invokevirtual 50	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   361: aload_0
    //   362: getfield 12	com/tencent/mobileqq/activity/qwallet/utils/FontConvert$1:this$0	Laafy;
    //   365: invokestatic 112	aafy:b	(Laafy;)Ljava/lang/String;
    //   368: invokevirtual 50	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   371: invokevirtual 59	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   374: invokestatic 108	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   377: aload 6
    //   379: ifnull -344 -> 35
    //   382: aload 6
    //   384: invokevirtual 85	java/io/BufferedReader:close	()V
    //   387: return
    //   388: astore 5
    //   390: aload 5
