  ...
  implements Serializable
{
  ...
  {
    paramAppRuntime = aacl.c(paramAppRuntime, paramString);
    try
    {
      paramString = (PreloadConfig)aagd.o(paramAppRuntime);
      if (paramString == null)
      {
  ...
  public ResourceInfo getResInfoByResId(String paramString)
  {
    ...
    } while (!aagd.j(localPreloadResource.mResId, paramString));
  ...
  public boolean isResInConfig(PreloadResource paramPreloadResource)
  {
    ...
    } while (!aagd.j(((PreloadResource)localIterator2.next()).mResId, paramPreloadResource.mResId));
    return true;
    return false;
  }
