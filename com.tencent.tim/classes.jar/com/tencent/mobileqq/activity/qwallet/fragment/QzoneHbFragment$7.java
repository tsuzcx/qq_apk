  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          this.this$0.parseConfig((JSONObject)localObject1);
          return;
        }
      }
      ...
      Object localObject2 = new File(this.val$path);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          aqds.a().Ur(localException2.toString());
          this.this$0.parseConfig((JSONObject)localObject4);
          return;
        }
