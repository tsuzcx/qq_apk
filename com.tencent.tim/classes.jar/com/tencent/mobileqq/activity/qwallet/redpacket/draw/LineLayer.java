...
public class LineLayer
  extends aadx
  implements aafb, aafc
{
  public static final int brD = Color.parseColor("#ff000000");
  private LoadTempFileJob jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLineLayer$LoadTempFileJob;
  private a jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLineLayer$a;
  ...
  private void cbp()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLineLayer$LoadTempFileJob = new LoadTempFileJob(this.rN.size(), this.hz, this.mSeq, this);
  ...
  public boolean H(MotionEvent paramMotionEvent)
  {
    ...
    {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLineLayer$a != null)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLineLayer$a.fw(2, 10000);
        this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLineLayer$a.cbi();
      }
    ...
    case 2: 
      for (;;)
      {
        return true;
        if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLineLayer$a != null) {
          this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLineLayer$a.ctQ();
        }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLineLayer$a = parama;
  }
    ...
    implements Runnable
  {
    ...
    private WeakReference<aafb> mListenerRef;
    
    public LoadTempFileJob(Map<Integer, String> paramMap, int paramInt, aafb paramaafb)
    {
      Object localObject;
    ...
    implements Runnable
  {
    ...
    private WeakReference<aafc> mListenerRef;
    
    public SaveTempFileJob(int paramInt1, int paramInt2, Bitmap paramBitmap, aafc paramaafc)
    {
      QLog.d("SaveTempFileJob", 2, "SaveTempFileJob begin:");
      this.mListenerRef = new WeakReference(paramaafc);
      if (paramBitmap == null) {
        return;
      }
      this.bRr = paramInt1;
