  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (QLog.isColorLevel()) {
      QLog.d("LoginActivity.LoginView", 2, "mSizeChangeCloseUpdateRunnable isArrowUP = " + LoginView.a(this.this$0) + " isScrolled = " + LoginView.b(this.this$0) + " isDestroyed:" + LoginView.c(this.this$0) + " isInMultiWindow:" + this.this$0.m.isInMultiWindow());
    }
    ...
    localLayoutParams.addRule(2, 2131370175);
    ...
    if ((!this.this$0.m.isInMultiWindow()) && ((this.this$0.wn.getVisibility() != 0) || (this.this$0.wn.getAlpha() < 0.999F))) {
