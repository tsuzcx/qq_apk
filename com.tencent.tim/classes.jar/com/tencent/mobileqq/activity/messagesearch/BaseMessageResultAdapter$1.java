...
public class BaseMessageResultAdapter$1
  implements Runnable
{
  public BaseMessageResultAdapter$1(zkv paramzkv, String paramString, int paramInt, long paramLong) {}
  
  public void run()
  {
    boolean bool = true;
    if (QLog.isColorLevel()) {
      QLog.i(zkv.access$000(), 2, "loadMessageResult, run(), keyword = " + this.val$keyword + ", loadType = " + this.cdt);
    }
    ??? = null;
    Object localObject2;
    Object localObject4;
    if (this.cdt == 1)
    {
      ??? = this.this$0.app.b().a(this.this$0.mSessionInfo, this.val$keyword);
      ...
      if (QLog.isColorLevel()) {
        QLog.i(zkv.access$000(), 2, "loadMessageResult, get: messageItems[] = " + localObject2);
      }
    }
    for (;;)
    {
      synchronized (this.this$0.mLock)
      {
        if (this.this$0.ban.equals(this.val$keyword))
        {
          ...
          localzkv = this.this$0;
          if (((ArrayList)localObject2).size() < 20)
          {
            localzkv.mEnded = bool;
