...
public class TroopMemberListActivity$1
  implements Runnable
{
  TroopMemberListActivity$1(TroopMemberListActivity paramTroopMemberListActivity, Intent paramIntent, acff paramacff, TroopManager paramTroopManager) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      for (boolean bool1 = true;; bool1 = false) {
        for (;;)
        {
          ((TroopMemberListActivity)???).aLZ = bool1;
          if (this.this$0.b != null)
          {
            ...
            ??? = this.this$0;
            if ((this.this$0.b.troopowneruin == null) || (!this.this$0.b.troopowneruin.equals(this.this$0.app.getCurrentAccountUin())))
            {
              bool1 = bool2;
              if (this.this$0.aPX != null)
              {
                bool1 = bool2;
                if (!this.this$0.aPX.contains(this.this$0.app.getCurrentAccountUin())) {}
              }
            }
            else
            {
            ...
            ((TroopMemberListActivity)???).bap = bool1;
            if (QLog.isColorLevel()) {
              QLog.d("TroopMemberListActivityget_troop_member", 2, "onActivityResult, REQUEST_CODE_SHOW_MEMBER_CARD, admins:" + this.this$0.aPX + " owner:" + this.this$0.aPW);
            }
          }
