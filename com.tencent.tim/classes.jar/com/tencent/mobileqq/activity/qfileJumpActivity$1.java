  ...
  implements Runnable
{
  ...
  public void run()
  {
    anpb.F(this.this$0.app.getApplication().getApplicationContext(), this.this$0.app.getCurrentAccountUin(), "dl_share_my_pc");
    ...
    ((Bundle)localObject2).putString("leftBackText", acfp.m(2131711080));
    ...
    ((Intent)localObject1).putExtra("targetUin", this.this$0.baY);
