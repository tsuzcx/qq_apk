  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      return;
      l1 = this.this$0.pref.getLong("key_req_last_login_time", 0L);
      l2 = this.this$0.pref.getLong("key_req_login_interval", 86400000L);
    ...
    } while ((PhoneContactManagerImp.f(this.this$0)) || (!this.this$0.Ur()) || (Math.abs(System.currentTimeMillis() - l1) < l2));
    PhoneContactManagerImp.a(this.this$0, true);
    Object localObject = new NewIntent(PhoneContactManagerImp.a(this.this$0).getApplication(), akwn.class);
    ((NewIntent)localObject).putExtra("req_type", 32);
    long l1 = this.this$0.pref.getLong("key_login_info_timestamp", 0L);
    ((NewIntent)localObject).putExtra("next_flag", 0);
    ((NewIntent)localObject).putExtra("time_stamp", l1);
    ((NewIntent)localObject).putExtra("unique_phone_no", this.this$0.pS());
