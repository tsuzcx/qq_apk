...
public class P2VGlobalConfig
{
  ...
  static
  {
    ...
    P2V_VIDEO_CACHE_ROOT = aasa.SDCARD_ROOT + "/tencent" + File.separator + "dynamic_video_cache" + File.separator;
    P2V_VIDEO_ROOT = aasa.SDCARD_ROOT + "/qzone_dynamic_video" + File.separator;
