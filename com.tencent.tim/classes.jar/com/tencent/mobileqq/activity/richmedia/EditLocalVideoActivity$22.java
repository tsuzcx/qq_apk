  ...
  public void run()
  {
    if (EditLocalVideoActivity.a(this.this$0) != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("EditLocalVideoActivity", 2, "onCurrentRangeTimeChanged, time=" + this.this$0.time2str((int)this.rv));
      }
      EditLocalVideoActivity.a(this.this$0).setText(this.this$0.time2str((int)this.rv));
    }
  }
}
