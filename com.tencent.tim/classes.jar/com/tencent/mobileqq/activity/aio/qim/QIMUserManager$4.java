  ...
  implements Runnable
{
  public void run()
  {
    try
    {
      Drawable localDrawable1 = SkinEngine.getInstances().getDefaultThemeDrawable(2130851119);
      Drawable localDrawable2 = SkinEngine.getInstances().getDefaultThemeDrawable(2130851123);
