...
public class IntimateInfoShareHelper$6
  implements Runnable
{
  public IntimateInfoShareHelper$6(wlh paramwlh, Bitmap paramBitmap) {}
  ...
  public void run()
  {
    ...
    //   3: dup
    //   4: getstatic 33	acbn:oM	Ljava/lang/String;
    ...
    //   99: astore_3
    //   100: aload_0
    //   101: getfield 16	com/tencent/mobileqq/activity/aio/IntimateInfoShareHelper$6:val$bitmap	Landroid/graphics/Bitmap;
    ...
    //   158: astore_3
    //   159: aload_0
    //   160: getfield 14	com/tencent/mobileqq/activity/aio/IntimateInfoShareHelper$6:this$0	Lwlh;
    //   163: invokestatic 115	wlh:a	(Lwlh;)Landroid/support/v4/app/FragmentActivity;
    //   166: new 117	com/tencent/mobileqq/activity/aio/IntimateInfoShareHelper$6$1
    //   169: dup
    //   170: aload_0
    //   171: iload_2
    //   172: aload_3
    //   173: invokespecial 120	com/tencent/mobileqq/activity/aio/IntimateInfoShareHelper$6$1:<init>	(Lcom/tencent/mobileqq/activity/aio/IntimateInfoShareHelper$6;ZLjava/lang/String;)V
    //   176: invokevirtual 126	android/support/v4/app/FragmentActivity:runOnUiThread	(Ljava/lang/Runnable;)V
    //   179: return
    //   180: astore_3
    //   181: invokestatic 131	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   184: ifeq +13 -> 197
    //   187: ldc 133
    //   189: iconst_2
    //   190: aload_3
    //   191: invokevirtual 136	java/io/IOException:getMessage	()Ljava/lang/String;
    //   194: invokestatic 140	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   197: goto -71 -> 126
    //   200: astore 4
    //   202: iconst_0
    //   203: istore_1
    //   204: aconst_null
    //   205: astore_3
    //   206: invokestatic 131	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   209: ifeq +14 -> 223
    //   212: ldc 133
    //   214: iconst_2
    //   215: aload 4
    //   217: invokevirtual 141	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   220: invokestatic 140	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   223: aload_3
    //   224: ifnull +87 -> 311
    //   227: aload_3
    ...
    //   243: iconst_2
    //   244: aload_3
    //   245: invokevirtual 136	java/io/IOException:getMessage	()Ljava/lang/String;
    //   248: invokestatic 140	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   251: goto -125 -> 126
    //   254: astore 4
    //   256: aconst_null
    //   257: astore_3
    ...
    //   268: athrow
    //   269: astore_3
    //   270: invokestatic 131	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   273: ifeq -7 -> 266
    //   276: ldc 133
    //   278: iconst_2
    //   279: aload_3
    //   280: invokevirtual 136	java/io/IOException:getMessage	()Ljava/lang/String;
    //   283: invokestatic 140	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   286: goto -20 -> 266
    //   289: astore 4
    //   291: goto -33 -> 258
    //   294: astore 4
