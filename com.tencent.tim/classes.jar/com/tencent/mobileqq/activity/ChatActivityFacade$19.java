...
public final class ChatActivityFacade$19
  implements Runnable
{
  public ChatActivityFacade$19(QQAppInterface paramQQAppInterface, Emoticon paramEmoticon, Context paramContext, SessionInfo paramSessionInfo, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (((EmoticonPackage)localObject1).isAPNG == 2)
    {
      ...
      if ((((EmoticonPackage)localObject1).copywritingType != ajdf.dhY) || (bool1) || (bool2))
      {
        ...
        ((MarkFaceMessage)localObject2).from = acfp.m(2131703579);
        label813:
    ...
    for (;;)
    {
      ...
      localObject1 = new ChatActivityFacade.19.1(this, (MessageForMarketFace)localObject2, (EmoticonPackage)localObject1);
      ...
      if (bool2)
      {
        ...
        ((MarkFaceMessage)localObject2).beginTime = ((EmoticonPackage)localObject1).beginTime;
        ((MarkFaceMessage)localObject2).endTime = ((EmoticonPackage)localObject1).endTime;
        ((MarkFaceMessage)localObject2).from = acfp.m(2131703581);
        break label813;
      }
