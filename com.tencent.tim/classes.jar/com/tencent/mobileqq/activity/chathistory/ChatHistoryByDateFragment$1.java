  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (k <= m)
    {
      localMessageRecord = ChatHistoryByDateFragment.a(this.this$0, this.bZW, this.Yx, k);
    ...
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d(ChatHistoryByDateFragment.access$100(), 2, "getFirstMessageByDate: " + ChatHistoryByDateFragment.a(this.this$0, this.bZW, this.Yx + 1, k) + " | result: " + localMessageRecord);
      }
      k += 1;
      j += 1;
      break;
      ...
      if (QLog.isColorLevel()) {
        QLog.i(ChatHistoryByDateFragment.access$100(), 2, String.format("queryDB count: %d | message count: %d | cost time %d ", new Object[] { Integer.valueOf(j), Integer.valueOf(i), Long.valueOf(l) }));
      }
      return;
    }
  }
