  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    int n = CalendarDay.getDaysInMonth(this.bZW, this.Yx);
    ...
    while (i <= n)
    {
      MessageRecord localMessageRecord = ChatHistoryC2CDateFragment.a(this.this$0, this.bZW, this.Yx, i);
      int m = k + 1;
      k = j;
    ...
    if (QLog.isColorLevel()) {
      QLog.i(ChatHistoryC2CDateFragment.access$100(), 2, String.format("queryDB count: %d | message count: %d | cost time %d ", new Object[] { Integer.valueOf(k), Integer.valueOf(j), Long.valueOf(l2 - l1) }));
    }
  }
}
