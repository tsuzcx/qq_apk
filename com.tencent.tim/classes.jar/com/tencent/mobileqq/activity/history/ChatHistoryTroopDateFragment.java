...
{
  private static String TAG = "ChatHistoryTroopDateFragment";
  public arkk a;
  ...
  {
    super.doOnResume();
    anot.a(this.mApp, "dc00898", "", "", "0X800A0B9", "0X800A0B9", 6, 0, "", "", "", "");
  }
  ...
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    paramView.putExtra("troop_uin", this.mTroopUin);
    init(paramView.getExtras());
  }
    ...
    implements arkk
  {
    ...
    {
      String str = ChatHistoryTroopDateFragment.this.mTroopUin;
      ChatHistoryBubbleListForTroopFragment.a(ChatHistoryTroopDateFragment.this.getActivity(), str, paramMessageRecord, -1, 3);
      anot.a(ChatHistoryTroopDateFragment.this.mApp, "dc00899", "Grp_chatRecord", "", "chatRecor_date", "date_clk", 0, 0, ChatHistoryTroopDateFragment.this.mTroopUin, "", "", "");
      QLog.i(ChatHistoryTroopDateFragment.TAG, 1, "clickDay: CalendarDay" + paramCalendarDay + " | MessageRecord:" + paramMessageRecord);
    }
    
    public void a(SimpleMonthView paramSimpleMonthView, int paramInt1, int paramInt2)
    {
      if (!ChatHistoryTroopDateFragment.a(ChatHistoryTroopDateFragment.this, paramInt1, paramInt2)) {
        ChatHistoryTroopDateFragment.this.fR(paramInt1, paramInt2);
      }
    }
