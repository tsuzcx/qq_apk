...
public class LinkMessageResultAdapter$2
  implements Runnable
{
  public LinkMessageResultAdapter$2(zjj paramzjj, String paramString, long paramLong, List paramList) {}
  
  public void run()
  {
    int j = 0;
    Object localObject = this.this$0.a(zjj.c(this.this$0), this.val$keyword);
    int i;
    ...
    if ((localObject != null) && (((ChatHistorySearchData)localObject).mSearchData1 != null) && (!((ChatHistorySearchData)localObject).mSearchData1.isEmpty()))
    {
      ...
      while (i < ((ChatHistorySearchData)localObject).mSearchData1.size())
      {
        ...
        if (zjj.a(this.this$0, localMessageRecord)) {
          this.this$0.uk.add(new zmc(zjj.b(this.this$0), localMessageRecord));
        }
        i += 1;
      }
    }
    ...
    {
      localObject = zjj.c(this.this$0).b().a(zjj.d(this.this$0).aTl, zjj.e(this.this$0).cZ, ((ChatHistorySearchData)localObject).mSearchData2);
      if ((localObject != null) && (((ChatHistorySearchData)localObject).mSearchData1 != null))
      {
        ...
        {
          localMessageRecord = (MessageRecord)((ChatHistorySearchData)localObject).mSearchData1.get(i);
          if (zjj.b(this.this$0, localMessageRecord)) {
            this.this$0.uk.add(new zmc(zjj.d(this.this$0), localMessageRecord));
          }
          i += 1;
        }
      }
    ...
    zjj.c(this.this$0).obtainMessage(6, localObject).sendToTarget();
  }
}
