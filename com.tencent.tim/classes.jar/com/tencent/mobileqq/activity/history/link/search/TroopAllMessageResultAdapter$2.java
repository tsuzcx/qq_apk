...
public class TroopAllMessageResultAdapter$2
  implements Runnable
{
  public TroopAllMessageResultAdapter$2(zjk paramzjk, String paramString, long paramLong, List paramList) {}
  
  public void run()
  {
    int j = 0;
    Object localObject = zjk.d(this.this$0).b().a(zjk.c(this.this$0), this.val$keyword);
    int i;
    ...
    if ((localObject != null) && (((ChatHistorySearchData)localObject).mSearchData1 != null) && (!((ChatHistorySearchData)localObject).mSearchData1.isEmpty()))
    {
      ...
      while (i < ((ChatHistorySearchData)localObject).mSearchData1.size())
      {
        ...
        if (zjk.a(this.this$0, localMessageRecord)) {
          this.this$0.uk.add(new zmc(zjk.e(this.this$0), localMessageRecord));
        }
        i += 1;
      }
    }
    ...
    {
      localObject = zjk.f(this.this$0).b().a(zjk.d(this.this$0).aTl, zjk.e(this.this$0).cZ, ((ChatHistorySearchData)localObject).mSearchData2);
      if ((localObject != null) && (((ChatHistorySearchData)localObject).mSearchData1 != null))
      {
        ...
        {
          localMessageRecord = (MessageRecord)((ChatHistorySearchData)localObject).mSearchData1.get(i);
          if (zjk.b(this.this$0, localMessageRecord)) {
            this.this$0.uk.add(new zmc(zjk.g(this.this$0), localMessageRecord));
          }
          i += 1;
        }
      }
    ...
    zjk.c(this.this$0).obtainMessage(6, localObject).sendToTarget();
  }
}
