  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      ChatMessage localChatMessage = ((alvj)this.this$0.mApp.getManager(340)).c(MiniMultiForwardFragment.a(this.this$0));
    ...
    for (;;)
    {
      ...
      {
        localArrayList = MiniMultiForwardFragment.a(this.this$0, ajlc.a().xL);
      }
      else
      {
