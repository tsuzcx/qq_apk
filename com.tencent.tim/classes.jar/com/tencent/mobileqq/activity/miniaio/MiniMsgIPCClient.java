  ...
  extends QIPCModule
{
  ...
  private ConcurrentHashMap<Integer, zns> mBusinessInfoMap = new ConcurrentHashMap();
  ...
  public static void register(int paramInt, String paramString)
  {
    ...
    {
      zns localzns = new zns();
      localzns.name = paramInt;
      paramString.put(Integer.valueOf(paramInt), localzns);
  ...
  public zns getBusinessInfo(int paramInt)
  {
    return (zns)this.mBusinessInfoMap.get(Integer.valueOf(paramInt));
  }
