  ...
  extends Entity
{
  ...
  public static final String DEFAULT_MODULE_TITLE = acfp.m(2131703240);
  ...
  {
    if ("0".equals(this.id)) {
      return paramActivity.getResources().getDrawable(2130838924);
    }
    String str = path + File.separator + this.id + File.separator + this.id + ".png";
    try
    {
      URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
      int i = wja.dp2px(56.0F, paramActivity.getResources());
  ...
  public boolean isComplete()
  {
    if (this.id == "0")
    {
      if ((this.defaultM4aPath == null) || (!ahbj.isFileExists(this.defaultM4aPath))) {}
    }
    else {
      while ((ahbj.isFileExists(getLrcPath())) && (ahbj.isFileExists(getM4aPath())) && (ahbj.isFileExists(getPicPath()))) {
        return true;
      }
    }
    return false;
