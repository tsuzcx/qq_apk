  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject = (afhj)EmoticonGroupStoreFragment.a(this.this$0).getManager(259);
    if (localObject != null) {
      ((afhj)localObject).cZz();
    }
    localObject = new CopyOnWriteArrayList(EmoticonGroupStoreFragment.a(this.this$0).eF());
