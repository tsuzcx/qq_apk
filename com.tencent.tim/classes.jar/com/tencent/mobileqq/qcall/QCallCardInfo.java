  ...
  implements Parcelable, Cloneable
{
  ...
  public static final Parcelable.Creator<QCallCardInfo> CREATOR = new alke();
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("[ qid=").append(alkt.mO(this.uin));
    localStringBuilder.append(",nickname=").append(aqmr.crypticCenter(this.nickname));
    localStringBuilder.append(",in_use_flag=").append(this.in_use_flag);
    localStringBuilder.append(",phoneNum=").append(alkt.mO(this.phonenum));
    localStringBuilder.append(",phone_mask=").append(this.phone_mask);
    localStringBuilder.append(",qqUin=").append(alkt.mO(this.qq));
    localStringBuilder.append(",qqUin2=").append(alkt.mO(this.qqUin2));
