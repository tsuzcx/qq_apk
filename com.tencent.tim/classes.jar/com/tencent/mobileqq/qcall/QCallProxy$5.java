...
public class QCallProxy$5
  implements Runnable
{
  public QCallProxy$5(alkq paramalkq, alkq.a parama) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      synchronized (alkq.a(this.this$0))
      {
        Object localObject1 = new ArrayList();
        localObject8 = new ArrayList();
        localObject7 = new ArrayList();
        localObject6 = new ArrayList();
        localObject5 = (ajdo)alkq.a(this.this$0).getManager(11);
        localObject4 = (acff)alkq.b(this.this$0).getManager(51);
        k = 0;
        i = 0;
        j = k;
        ...
        localObject9 = alkq.a(this.this$0).iterator();
        if (((Iterator)localObject9).hasNext())
        {
          ...
          {
            localObject11 = ((ajdo)localObject5).c(((QCallRecent)localObject10).uin);
            if ((localObject11 == null) || (!((acff)localObject4).isFriend(((PhoneContact)localObject11).uin))) {
              break label1232;
            }
            j = 1;
          ...
          localObject11 = ((ajdo)localObject5).b(((QCallRecent)localObject10).uin);
          if ((localObject11 == null) || (!((acff)localObject4).isFriend(((PhoneContact)localObject11).uin))) {
            break label1242;
          }
          j = 1;
        ...
        localObject1 = ((ajdo)localObject5).c((String)localObject10);
        ...
        {
          m = arrayOfInt[j];
          localObject1 = this.this$0.c((String)localObject11, m);
          if (localObject1 == null) {}
        }
        else
        {
          ...
          this.this$0.g((String)localObject10, 1006, (String)localObject11, ((QCallRecent)localObject1).type);
          this.this$0.f((QCallRecent)localObject1);
        }
      }
      j += 1;
      continue;
    ...
    for (;;)
    {
      ...
      {
        m = localObject10[j];
        localObject3 = this.this$0.c((String)localObject9, m);
        if (localObject3 == null) {}
      }
      else
      {
        ...
        for (;;)
        {
          this.this$0.g((String)localObject8, 1006, (String)localObject9, ((QCallRecent)localObject3).type);
          this.this$0.f((QCallRecent)localObject3);
          break;
        ...
        for (;;)
        {
          ...
          localObject7 = ((ajdo)localObject5).b((String)localObject6);
          if (localObject7 != null)
          {
            this.this$0.d((QCallRecent)localObject4);
            localObject7 = ((PhoneContact)localObject7).mobileCode;
            this.this$0.g((String)localObject6, 56938, (String)localObject7, 1006);
            ((QCallRecent)localObject4).uin = ((String)localObject7);
            ((QCallRecent)localObject4).type = 1006;
            this.this$0.f((QCallRecent)localObject4);
          }
        }
        label1088:
        if ((j != 0) && (this.a != null))
        {
          ...
          localObject4 = alkq.a(this.this$0).iterator();
