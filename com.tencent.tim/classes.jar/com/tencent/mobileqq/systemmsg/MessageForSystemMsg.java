  ...
  extends ChatMessage
{
  ...
  public static String getSysMsgDesc(Resources paramResources, structmsg.StructMsg paramStructMsg)
  {
    ...
    for (;;)
    {
      ...
      paramResources = paramResources.getString(2131689802);
      break label87;
      paramResources = paramResources.getString(2131689600);
      break label87;
      paramResources = paramResources.getString(2131689599);
      break label87;
      paramResources = paramResources.getString(2131718685);
      break label87;
      if (i == 2)
      {
        paramResources = "";
        ...
        for (;;)
        {
          paramResources = apuh.a(paramStructMsg, paramResources + paramStructMsg.msg.msg_describe.get());
          break;
          if (j == 2) {
