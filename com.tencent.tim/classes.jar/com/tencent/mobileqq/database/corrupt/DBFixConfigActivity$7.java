  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   45: getfield 35	com/tencent/mobileqq/database/corrupt/DBFixConfigActivity:fS	Landroid/widget/Button;
    ...
    //   113: getfield 35	com/tencent/mobileqq/database/corrupt/DBFixConfigActivity:fS	Landroid/widget/Button;
    ...
    //   236: ior
    //   237: istore_3
    //   238: getstatic 101	com/tencent/mobileqq/database/corrupt/DBFixConfigActivity:TAG	Ljava/lang/String;
    //   241: iconst_1
    //   242: iconst_2
    ...
    //   252: iconst_1
    //   253: iload_3
    //   254: invokestatic 109	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   257: aastore
    //   258: invokestatic 115	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   261: iload_3
    //   262: bipush 10
    //   264: iadd
    //   265: istore_3
    ...
    //   319: iconst_0
    //   320: iload_2
    //   321: invokevirtual 119	java/io/BufferedOutputStream:write	([BII)V
    //   324: iload_1
    //   325: iload_2
    //   326: iadd
    //   327: istore_1
    ...
    //   335: iconst_0
    //   336: iload_2
    //   337: invokevirtual 119	java/io/BufferedOutputStream:write	([BII)V
    //   340: iload_1
    //   341: iload_2
    //   342: iadd
    //   343: istore_1
    //   344: goto -170 -> 174
    //   347: aload 4
    //   349: invokevirtual 123	com/tencent/mobileqq/app/QQAppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   352: getstatic 128	com/tencent/mobileqq/database/corrupt/DBFixManager:bCE	Ljava/lang/String;
    //   355: iconst_0
    //   356: invokevirtual 134	mqq/app/MobileQQ:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   359: astore 10
    //   361: aload 7
    //   363: invokestatic 140	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   366: ifne +110 -> 476
    //   369: aload 10
    ...
    //   383: getstatic 143	com/tencent/mobileqq/database/corrupt/DBFixManager:bCG	Ljava/lang/String;
    ...
    //   424: getstatic 143	com/tencent/mobileqq/database/corrupt/DBFixManager:bCG	Ljava/lang/String;
    ...
    //   453: getstatic 162	com/tencent/mobileqq/database/corrupt/DBFixManager:bCH	Ljava/lang/String;
    ...
    //   462: invokeinterface 159 2 0
    //   467: pop
    //   468: aload 10
    //   470: invokeinterface 165 1 0
    //   475: pop
    //   476: aload 4
    //   478: sipush 205
    //   481: invokevirtual 169	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   484: checkcast 125	com/tencent/mobileqq/database/corrupt/DBFixManager
    //   487: astore 4
    //   489: aload 4
    //   491: iconst_1
    //   492: invokevirtual 173	com/tencent/mobileqq/database/corrupt/DBFixManager:HG	(Z)V
    //   495: aload 9
    //   497: aload 8
    //   499: invokevirtual 177	java/io/File:renameTo	(Ljava/io/File;)Z
    //   502: pop
    //   503: aload_0
    ...
    //   507: getfield 35	com/tencent/mobileqq/database/corrupt/DBFixConfigActivity:fS	Landroid/widget/Button;
    //   510: new 179	com/tencent/mobileqq/database/corrupt/DBFixConfigActivity$7$3
    //   513: dup
    //   514: aload_0
    //   515: invokespecial 180	com/tencent/mobileqq/database/corrupt/DBFixConfigActivity$7$3:<init>	(Lcom/tencent/mobileqq/database/corrupt/DBFixConfigActivity$7;)V
    //   518: invokevirtual 46	android/widget/Button:post	(Ljava/lang/Runnable;)Z
    //   521: pop
    //   522: aload 4
    //   524: invokevirtual 183	com/tencent/mobileqq/database/corrupt/DBFixManager:cYk	()V
    //   527: aload 5
    //   529: ifnull +8 -> 537
    //   532: aload 5
    //   534: invokevirtual 186	java/io/BufferedInputStream:close	()V
    //   537: aload 6
    //   539: ifnull -479 -> 60
    //   542: aload 6
    //   544: invokevirtual 187	java/io/BufferedOutputStream:close	()V
    //   547: return
    //   548: astore 4
    //   550: aload 4
    //   552: invokevirtual 190	java/io/IOException:printStackTrace	()V
    //   555: return
    //   556: astore 4
    //   558: aload 4
    //   560: invokevirtual 190	java/io/IOException:printStackTrace	()V
    //   563: goto -26 -> 537
    //   566: astore 6
    //   568: aconst_null
    //   569: astore 4
    //   571: aconst_null
    //   572: astore 5
    //   574: getstatic 101	com/tencent/mobileqq/database/corrupt/DBFixConfigActivity:TAG	Ljava/lang/String;
    //   577: iconst_1
    //   578: ldc 192
    //   580: aload 6
    //   582: invokestatic 195	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   585: aload 6
    //   587: invokevirtual 190	java/io/IOException:printStackTrace	()V
    //   590: aload 5
    //   592: ifnull +8 -> 600
    //   595: aload 5
    //   597: invokevirtual 186	java/io/BufferedInputStream:close	()V
    //   600: aload 4
    //   602: ifnull -542 -> 60
    //   605: aload 4
    //   607: invokevirtual 187	java/io/BufferedOutputStream:close	()V
    //   610: return
    //   611: astore 4
    //   613: aload 4
    //   615: invokevirtual 190	java/io/IOException:printStackTrace	()V
    //   618: return
    //   619: astore 5
    //   621: aload 5
    //   623: invokevirtual 190	java/io/IOException:printStackTrace	()V
    //   626: goto -26 -> 600
    //   629: astore 4
    //   631: aconst_null
    //   632: astore 6
    ...
    //   639: ifnull +8 -> 647
    //   642: aload 5
    //   644: invokevirtual 186	java/io/BufferedInputStream:close	()V
    //   647: aload 6
    //   649: ifnull +8 -> 657
    //   652: aload 6
    //   654: invokevirtual 187	java/io/BufferedOutputStream:close	()V
    //   657: aload 4
    //   659: athrow
    //   660: astore 5
    //   662: aload 5
    //   664: invokevirtual 190	java/io/IOException:printStackTrace	()V
    //   667: goto -20 -> 647
    //   670: astore 5
    //   672: aload 5
    //   674: invokevirtual 190	java/io/IOException:printStackTrace	()V
    //   677: goto -20 -> 657
    //   680: astore 4
    //   682: aconst_null
    //   683: astore 5
