  ...
  implements Serializable
{
  ...
  public void updateForTroopChatSetting(TroopInfo paramTroopInfo, Resources paramResources, String paramString)
  {
    ...
    if (paramTroopInfo != null)
    {
      ...
      this.troopAuthen = paramResources.getString(2131721383);
      i = 6;
      if (!aqft.equalsWithNullCheck(this.troopowneruin, paramTroopInfo.troopowneruin))
      {
        this.troopowneruin = paramTroopInfo.troopowneruin;
        this.troopOwnerNick = null;
        updateOwnerFlag(paramString);
      }
      if (!aqft.equalsWithNullCheck(this.Administrator, paramTroopInfo.Administrator))
      {
      ...
      this.inviteModeDescription = paramResources.getString(2131698732);
      this.inviteMode = 4;
      label497:
    ...
    for (this.nViewExtraFlag &= 0xFFFFFFFB;; this.nViewExtraFlag |= 0x4)
    {
      ...
      {
        this.troopAuthen = paramResources.getString(2131721374);
      ...
      default: 
        break;
      case 1: 
        this.troopAuthen = paramResources.getString(2131721375);
        break;
      case 2: 
        this.troopAuthen = paramResources.getString(2131721380);
        break;
      case 4: 
        this.troopAuthen = paramResources.getString(2131721377);
        break;
      case 5: 
        this.troopAuthen = paramResources.getString(2131721376);
        break;
      case 3: 
        this.troopAuthen = paramResources.getString(2131721382);
        break;
        j = 0;
        break label475;
        if (i == 1)
        {
          this.inviteModeDescription = paramResources.getString(2131698729);
          this.inviteMode = 5;
          break label497;
        }
        if (j != 0)
        {
          if (i == 6)
          {
            this.inviteModeDescription = paramResources.getString(2131698728);
            this.inviteMode = 6;
            break label497;
          }
          ...
          this.inviteMode = 8;
          this.inviteModeDescription = paramResources.getString(2131698731);
          break label497;
        }
        this.inviteModeDescription = paramResources.getString(2131698733);
        this.inviteMode = 1;
        break label497;
      }
    }
  ...
  public void updateForTroopInfo(TroopInfo paramTroopInfo, String paramString)
  {
    ...
    if (paramTroopInfo != null)
    {
      ...
      this.hasSetNewTroopName = paramTroopInfo.hasSetNewTroopName;
      this.isUseClassAvatar = paramTroopInfo.isUseClassAvatar();
      if ((!QLog.isColorLevel()) || (!aqft.equalsWithNullCheck(this.troopowneruin, paramTroopInfo.troopowneruin)))
      {
        this.troopowneruin = paramTroopInfo.troopowneruin;
        this.troopOwnerNick = null;
        updateOwnerFlag(paramString);
  ...
  {
    this.bOwner = aqft.equalsWithNullCheck(paramString, this.troopowneruin);
  }
