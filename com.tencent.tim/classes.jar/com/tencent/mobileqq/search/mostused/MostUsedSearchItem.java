...
{
  private static String TAG = "MostUsedSearchItem";
  ...
  public static MostUsedSearchItem fromJson(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        QLog.e(TAG, 2, "MostUsedSearchItem fromJson ERR;" + paramString.toString());
      }
    }
    return localObject;
  }
  ...
  public static JSONObject toJson(MostUsedSearchItem paramMostUsedSearchItem)
  {
    ...
    {
      QLog.e(TAG, 2, "MostUsedSearchItem toJson ERR;" + paramMostUsedSearchItem.toString());
    }
    return localJSONObject;
  }
