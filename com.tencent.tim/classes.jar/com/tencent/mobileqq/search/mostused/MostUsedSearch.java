...
{
  private static String TAG = "MostUsedSearch";
  ...
  public static MostUsedSearch fromJson(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        QLog.e(TAG, 2, "MostUsedSearch fromJson ERR;" + paramString.toString());
      }
    }
  }
  ...
  public static JSONObject toJson(MostUsedSearch paramMostUsedSearch)
  {
    ...
    catch (JSONException paramMostUsedSearch)
    {
      for (;;)
      {
        ...
        QLog.e(TAG, 2, "MostUsedSearch fromJson ERR;" + paramMostUsedSearch.toString());
        continue;
        i += 1;
      }
    }
