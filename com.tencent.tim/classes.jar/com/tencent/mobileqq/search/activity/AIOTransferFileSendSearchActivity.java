...
public class AIOTransferFileSendSearchActivity
  extends AIOTransferFileSearchActivity
{
  protected int mFromType = 33;
  
  public static void a(Context paramContext, String paramString, List<ampx> paramList, int paramInt)
  {
    Intent localIntent = new Intent(paramContext, AIOTransferFileSendSearchActivity.class);
 ...
 * Qualified Name:     com.tencent.mobileqq.search.activity.AIOTransferFileSendSearchActivity
