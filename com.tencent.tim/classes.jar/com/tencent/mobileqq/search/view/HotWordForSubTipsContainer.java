  ...
  extends ReadInJoySearchTipsContainer
{
  ...
  private void c(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      localButton.setPadding(aqnm.dip2px(12.0F), aqnm.dip2px(3.0F), aqnm.dip2px(12.0F), aqnm.dip2px(4.0F));
  ...
  public void c(List<BusinessGroupWord.c> paramList, int paramInt1, int paramInt2, int paramInt3)
  {
    removeAllViews();
    paramList = paramList.iterator();
    while (paramList.hasNext()) {
      c(((BusinessGroupWord.c)paramList.next()).word, paramInt1, paramInt2, paramInt3, null);
    }
  }
  
  public int dB(int paramInt)
  {
    int i6 = (int)aqho.convertDpToPixel(getContext(), 12.0F);
    int i1 = (int)aqho.convertDpToPixel(getContext(), 10.0F);
    int i7 = (int)aqho.convertDpToPixel(getContext(), 10.0F);
    int i8 = (int)aqho.convertDpToPixel(getContext(), 10.0F);
    int m = (int)aqho.convertDpToPixel(getContext(), 15.0F);
    int i9 = (int)aqho.convertDpToPixel(getContext(), 15.0F);
  ...
  {
    int i2 = (int)aqho.convertDpToPixel(getContext(), 12.0F);
    int k = (int)aqho.convertDpToPixel(getContext(), 10.0F);
    int i3 = (int)aqho.convertDpToPixel(getContext(), 10.0F);
    paramInt4 = (int)aqho.convertDpToPixel(getContext(), 15.0F);
    int i4 = (int)aqho.convertDpToPixel(getContext(), 15.0F);
