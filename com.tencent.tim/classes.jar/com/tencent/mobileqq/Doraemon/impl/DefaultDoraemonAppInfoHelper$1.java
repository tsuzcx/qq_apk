...
public class DefaultDoraemonAppInfoHelper$1
  implements Runnable
{
  public DefaultDoraemonAppInfoHelper$1(tzr paramtzr) {}
  ...
  public void run()
  {
    ...
    try
    {
      ??? = "https://cgi.connect.qq.com/mqqapi/privilege_group_config?platform=1&platform_version=3.4.4&data_version=" + this.this$0.Fa;
      ...
      if (this.this$0.Fa == l1)
      {
        QLog.i("DoraemonOpenAPI.permissionHelper", 1, "no update, next=" + l2 + ", ver=" + l1);
        synchronized (this.this$0.bJ)
        {
          this.this$0.EZ = (NetConnInfoCenter.getServerTimeMillis() + Math.max(300000L, l2));
          return;
        }
      }
    ...
    synchronized (this.this$0.bJ)
    {
      ...
      {
        this.this$0.aR = localJSONObject;
        this.this$0.hc.clear();
        BaseApplicationImpl.getApplication().getSharedPreferences("DoraemonApiGroup.json", 4).edit().putString("content", (String)localObject7).putLong("version", l1).putString("app_version", "3.4.4").apply();
        return;
      }
    }
  }
