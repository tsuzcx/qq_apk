  ...
  extends AppContentProvider
{
  ...
  {
    super.onCreate();
    this.d.addURI("tim.friendlist", "group/#", 1000);
    this.d.addURI("tim.friendlist", "friendlist/#", 1001);
    this.d.addURI("tim.friendlist", "trooplist/#", 1002);
    this.d.addURI("tim.friendlist", "troopmemberinfo/#/#/#", 1003);
    this.d.addURI("tim.friendlist", "troopname/#/#", 1004);
    this.d.addURI("tim.friendlist", "discussinfo/#/#", 1005);
    this.d.addURI("tim.friendlist", "discussmenberinfo/#/#/#", 1006);
    this.d.addURI("tim.friendlist", "individuationUserData/#", 1007);
    return true;
  }
  ...
  public android.database.Cursor query(Uri paramUri, String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 17	com/tencent/mobileqq/content/FriendListProvider:d	Landroid/content/UriMatcher;
    //   4: aload_1
    ...
    //   33: new 78	aewg
    //   36: dup
    //   37: invokespecial 79	aewg:<init>	()V
    //   40: aload 10
    //   42: aload 9
    //   44: iconst_1
    //   45: invokevirtual 83	aewg:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Z)Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   48: astore 9
    //   50: aload 9
    //   52: ifnonnull +32 -> 84
    //   55: ldc 85
    ...
    //   77: invokestatic 107	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   80: aconst_null
    //   81: astore_3
    //   82: aload_3
    //   83: areturn
    ...
    //   153: aload_1
    //   154: invokevirtual 97	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   157: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   160: invokestatic 107	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   163: aconst_null
    //   164: astore_2
    //   165: aload_2
    //   166: astore_3
    ...
    //   171: aload_2
    //   172: aload_0
    //   173: invokevirtual 116	com/tencent/mobileqq/content/FriendListProvider:getContext	()Landroid/content/Context;
    //   176: invokevirtual 122	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   179: aload_1
    //   180: invokeinterface 128 3 0
    //   185: aload_2
    //   186: areturn
    //   187: aload 9
    //   189: new 130	com/tencent/mobileqq/data/Groups
    //   192: dup
    //   193: invokespecial 131	com/tencent/mobileqq/data/Groups:<init>	()V
    //   196: invokevirtual 134	com/tencent/mobileqq/data/Groups:getTableName	()Ljava/lang/String;
    //   199: iconst_5
    ...
    //   231: aload 5
    //   233: aconst_null
    //   234: invokevirtual 149	com/tencent/mobileqq/app/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   237: astore_2
    //   238: goto -73 -> 165
    //   241: aload 9
    //   243: new 151	com/tencent/mobileqq/data/Friends
    //   246: dup
    //   247: invokespecial 152	com/tencent/mobileqq/data/Friends:<init>	()V
    //   250: invokevirtual 153	com/tencent/mobileqq/data/Friends:getTableName	()Ljava/lang/String;
    //   253: aload_2
    //   254: aload_3
    //   255: aload 4
    //   257: aload 5
    //   259: aconst_null
    //   260: invokevirtual 149	com/tencent/mobileqq/app/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   263: astore_2
    //   264: goto -99 -> 165
    //   267: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   270: ifeq +34 -> 304
    //   273: ldc 154
    //   275: iconst_2
    //   276: new 87	java/lang/StringBuilder
    //   279: dup
    //   280: invokespecial 88	java/lang/StringBuilder:<init>	()V
    //   283: aload_0
    //   284: invokevirtual 160	java/lang/Object:getClass	()Ljava/lang/Class;
    //   287: invokevirtual 165	java/lang/Class:getName	()Ljava/lang/String;
    //   290: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   293: ldc 167
    //   295: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   298: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   376: aconst_null
    //   377: aconst_null
    //   378: invokevirtual 149	com/tencent/mobileqq/app/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   381: astore_2
    //   382: goto -217 -> 165
    //   385: aload_1
    ...
    //   444: aload 5
    //   446: aconst_null
    //   447: invokevirtual 149	com/tencent/mobileqq/app/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   450: astore_2
    //   451: goto -286 -> 165
    //   454: aload_1
    ...
    //   501: aconst_null
    //   502: aconst_null
    //   503: invokevirtual 149	com/tencent/mobileqq/app/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   506: astore_2
    //   507: goto -342 -> 165
    //   510: aload_1
    ...
    //   572: aconst_null
    //   573: aconst_null
    //   574: invokevirtual 149	com/tencent/mobileqq/app/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   577: astore_2
    //   578: goto -413 -> 165
    //   581: aload 9
    ...
    //   626: aconst_null
    //   627: aconst_null
    //   628: invokevirtual 149	com/tencent/mobileqq/app/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   631: astore_2
    //   632: goto -467 -> 165
    ...
    //   651: ldc 226
    //   653: ldc 228
    //   655: invokevirtual 149	com/tencent/mobileqq/app/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   658: astore_2
    //   659: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   662: ifeq +28 -> 690
    //   665: ldc 85
    //   667: iconst_2
    //   668: new 87	java/lang/StringBuilder
    //   671: dup
    //   672: invokespecial 88	java/lang/StringBuilder:<init>	()V
    //   675: ldc 230
    //   677: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   680: aload_2
    //   681: invokevirtual 97	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   684: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   757: aload_3
    //   758: iconst_2
    //   759: anewarray 156	java/lang/Object
    //   762: dup
    //   763: iconst_0
    //   764: aload 4
    //   766: aastore
    ...
    //   775: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   778: ifeq +56 -> 834
    //   781: ldc 85
    //   783: iconst_2
    //   784: new 87	java/lang/StringBuilder
    //   787: dup
    //   788: invokespecial 88	java/lang/StringBuilder:<init>	()V
    //   791: ldc_w 256
    //   794: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   797: aload_2
    //   798: invokeinterface 259 1 0
    //   803: invokevirtual 262	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   806: ldc_w 264
    //   809: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   812: aload 4
    //   814: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   817: ldc_w 266
    ...
    //   828: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   850: aload 4
    //   852: astore_2
    //   853: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   856: ifeq -691 -> 165
    //   859: ldc 85
    //   861: iconst_2
    //   862: new 87	java/lang/StringBuilder
    //   865: dup
    //   866: invokespecial 88	java/lang/StringBuilder:<init>	()V
    //   869: ldc_w 271
    ...
    //   884: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
  ...
  {
    // Byte code:
    //   0: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   3: ifeq +39 -> 42
    //   6: ldc 85
    //   8: iconst_2
    ...
    //   32: aload_2
    //   33: invokevirtual 97	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   36: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   48: iconst_1
    //   49: ldc_w 287
    //   52: invokestatic 107	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   55: iconst_0
    //   56: istore 5
    //   58: iload 5
    //   60: ireturn
    ...
    //   84: iconst_1
    //   85: ldc_w 295
    //   88: invokestatic 107	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   91: iconst_0
    //   92: ireturn
    //   93: aload_0
    //   94: aload_3
    ...
    //   107: iconst_1
    //   108: ldc_w 297
    //   111: invokestatic 107	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   114: iconst_0
    //   115: ireturn
    //   116: new 78	aewg
    //   119: dup
    //   120: invokespecial 79	aewg:<init>	()V
    //   123: aload 4
    //   125: aload_3
    //   126: iconst_0
    //   127: invokevirtual 83	aewg:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Z)Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   130: astore_3
    //   131: aload_3
    ...
    //   145: ireturn
    //   146: aload_0
    //   147: getfield 17	com/tencent/mobileqq/content/FriendListProvider:d	Landroid/content/UriMatcher;
    //   150: aload_1
    ...
    //   238: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   274: astore_1
    //   275: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   278: ifeq +40 -> 318
    //   281: ldc 85
    //   283: iconst_2
    //   284: new 87	java/lang/StringBuilder
    //   287: dup
    //   288: invokespecial 88	java/lang/StringBuilder:<init>	()V
    //   291: ldc_w 328
    ...
    //   302: ldc_w 330
    //   305: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   308: aload_1
    //   309: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   312: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   353: aconst_null
    //   354: aconst_null
    //   355: invokevirtual 149	com/tencent/mobileqq/app/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   358: astore_1
    //   359: aload_1
    //   360: ifnull +198 -> 558
    //   363: aload_1
    ...
    //   411: astore 14
    //   413: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   416: ifeq +56 -> 472
    //   419: ldc 85
    //   421: iconst_2
    ...
    //   429: ldc_w 336
    //   432: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   435: aload 13
    //   437: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   440: ldc_w 338
    //   443: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   446: aload 14
    ...
    //   466: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   491: istore 6
    //   493: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   496: ifeq +45 -> 541
    //   499: ldc 85
    //   501: iconst_2
    //   502: new 87	java/lang/StringBuilder
    //   505: dup
    //   506: invokespecial 88	java/lang/StringBuilder:<init>	()V
    //   509: ldc_w 345
    ...
    //   535: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   566: lstore 9
    //   568: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   571: ifeq +45 -> 616
    //   574: ldc 85
    //   576: iconst_2
    ...
    //   610: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
