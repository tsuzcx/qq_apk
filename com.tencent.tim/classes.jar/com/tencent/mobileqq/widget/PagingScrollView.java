  ...
  extends ScrollView
{
  ...
  protected a mScrollChangedListener;
  ...
  public void addPagingView(View paramView)
  {
    ...
    paramView.setOnTouchListener(new argo(this));
  }
  ...
  {
    this.mScrollChangedListener = parama;
  }
    ...
    extends GestureDetector.SimpleOnGestureListener
  {
    ...
    public boolean onScroll(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
    {
      ...
      {
        PagingScrollView.access$002(PagingScrollView.this, false);
        ...
        if (paramFloat2 > paramFloat1)
        {
          ...
          PagingScrollView.access$002(PagingScrollView.this, true);
        }
      }
      for (;;)
      {
