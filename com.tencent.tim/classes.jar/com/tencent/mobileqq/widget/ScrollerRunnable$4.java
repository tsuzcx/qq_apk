  ...
  implements Runnable
{
  ...
  public void run()
  {
    ObjectAnimator localObjectAnimator1 = ObjectAnimator.ofInt(this.val$view, "backgroundColor", new int[] { 11580351, 867218367 });
    localObjectAnimator1.setDuration(300L);
    localObjectAnimator1.setEvaluator(new ArgbEvaluator());
    ObjectAnimator localObjectAnimator2 = ObjectAnimator.ofInt(this.val$view, "backgroundColor", new int[] { 867218367, 11580351 });
    localObjectAnimator2.setDuration(400L);
    localObjectAnimator2.setEvaluator(new ArgbEvaluator());
    localObjectAnimator1.addListener(new arit(this, localObjectAnimator2));
    localObjectAnimator2.addListener(new ariu(this));
