  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (QLog.isColorLevel()) {
      QLog.d("OpenApi.Manager", 2, "onRuntimeDisactive, app = " + this.val$app + ", current = " + OpenApiManager.access$000(this.this$0) + ", " + this.cuC);
    }
    if ((OpenApiManager.access$000(this.this$0) != null) && (this.val$app == OpenApiManager.access$000(this.this$0)))
    {
