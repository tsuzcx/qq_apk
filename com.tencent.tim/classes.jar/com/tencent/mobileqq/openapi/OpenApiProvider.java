  ...
  extends ContentProvider
{
  ...
  static
  {
    try
    {
      e.addURI("com.tencent.tim.openapi.provider", "query_msg", 0);
      e.addURI("com.tencent.tim.openapi.provider", "query_face", 1);
      e.addURI("com.tencent.tim.openapi.provider", "query_nick", 2);
      e.addURI("com.tencent.tim.openapi.provider", "reg_receiver", 3);
      e.addURI("com.tencent.tim.openapi.provider", "send_msg", 4);
      e.addURI("com.tencent.tim.openapi.provider", "set_readed", 5);
      e.addURI("com.tencent.tim.openapi.provider", "openaio", 6);
      e.addURI("com.tencent.tim.openapi.provider", "decodesilk", 7);
      e.addURI("com.tencent.tim.openapi.provider", "download_media", 8);
      e.addURI("com.tencent.tim.openapi.provider", "exchange_uin", 9);
      e.addURI("com.tencent.tim.openapi.provider", "paycode_channel", 10);
      return;
    }
  ...
  {
    MatrixCursor localMatrixCursor = new MatrixCursor(akus.a.fP);
  ...
  public Cursor query(Uri paramUri, String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2)
  {
    ...
    case 1: 
      ...
      if (QLog.isColorLevel())
      {
        ...
        paramString1.append("query face, uin = ").append(aqmr.getSimpleUinForPrint(paramArrayOfString1));
        paramString1.append(", type = ").append(i);
        paramString1.append(", rs = ").append(paramUri.dpq);
        paramString1.append(", path = ").append(paramUri.bUs);
        QLog.d("OpenApi.Provider", 2, paramString1.toString());
      }
      if (paramUri.dpq != 0) {
        return a(paramUri.dpq);
      }
      paramArrayOfString1 = new MatrixCursor(akus.a.fR);
      paramArrayOfString1.addRow(new Object[] { paramUri.bUs });
    ...
    if (QLog.isColorLevel())
    {
      ...
      paramString1.append("query msg, uin = ").append(aqmr.getSimpleUinForPrint(paramArrayOfString1));
      paramString1.append(", type = ").append(i);
    ...
    paramArrayOfString1 = new MatrixCursor(akus.a.fQ);
    paramUri = paramUri.iterator();
    while (paramUri.hasNext()) {
      paramArrayOfString1.addRow(((akuu)paramUri.next()).h());
    }
    return paramArrayOfString1;
    paramArrayOfString1 = paramUri.getQueryParameter("uin");
    try
    ...
    {
      paramString1 = new StringBuilder(150);
      paramString1.append("query nick, uin = ").append(aqmr.getSimpleUinForPrint(paramArrayOfString1));
      paramString1.append(", type = ").append(i);
      paramString1.append(", rs = ").append(paramUri.dpq);
      QLog.d("OpenApi.Provider", 2, paramString1.toString());
    }
    ...
    paramArrayOfString1 = new MatrixCursor(akus.a.fS);
    paramArrayOfString1.addRow(new Object[] { paramUri.bUs });
    return paramArrayOfString1;
    i = 0;
    int j = 0;
    ...
    for (;;)
    {
      ...
      label1090:
      if (QLog.isColorLevel()) {
        QLog.d("OpenApi.Provider", 2, "reg, op = " + k + ", filter = " + i + ", rs = " + paramUri.dpq + ", stamp = " + paramUri.aew + ", uin = " + paramUri.currentUin);
      }
      paramArrayOfString1 = new MatrixCursor(akus.a.fT);
      paramArrayOfString1.addRow(new Object[] { Integer.valueOf(paramUri.dpq), Long.valueOf(paramUri.aew), paramUri.currentUin });
      return paramArrayOfString1;
      paramUri = new akuv.a(paramString1.unregisterThirdApp(paramString2, str1), 0L, null);
    }
    paramArrayOfString1 = paramUri.getQueryParameter("uin");
    try
    {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("OpenApi.Provider", 2, "sendMsg, uin = " + paramArrayOfString1 + "msgType = " + j + ", result = " + paramUri.dpq);
    }
    if (paramUri.dpq != 0) {
      return a(paramUri.dpq);
    }
    paramArrayOfString1 = new MatrixCursor(akus.a.fU);
    paramArrayOfString1.addRow(new Object[] { paramUri.bUs });
    return paramArrayOfString1;
    paramArrayOfString1 = paramUri.getQueryParameter("uin");
    ...
    if (QLog.isColorLevel())
    {
      ...
      paramUri.append("set readed, uin = ").append(aqmr.getSimpleUinForPrint(paramArrayOfString1));
    ...
    paramUri = new MatrixCursor(akus.a.fP);
    ...
    try
    {
      ...
      paramUri = new MatrixCursor(akus.a.fW);
    ...
    catch (Exception paramArrayOfString2)
    {
      ...
      paramArrayOfString1 = new MatrixCursor(akus.a.fX);
    ...
    catch (Exception paramUri)
    {
      ...
      paramArrayOfString1 = new MatrixCursor(akus.a.fY);
    ...
    catch (Exception paramUri)
    {
      ...
      QLog.d("OpenApi.Provider", 2, "exchange uin, result = " + paramString1[0].dpq);
      if (paramString1.length == paramArrayOfString2.length) {
        break label2306;
      }
      return a(paramString1[0].dpq);
      paramArrayOfString1 = new MatrixCursor(akus.a.fZ);
    ...
    while (i < j)
    {
      ...
      paramArrayOfString1.addRow(new Object[] { Integer.valueOf(paramUri.dpq), paramUri.bUs });
      i += 1;
    }
    label2306:
    ...
    {
      paramArrayOfString1 = new MatrixCursor(akus.a.ga);
      paramUri = paramUri.iterator();
      for (;;)
      {
        if (paramUri.hasNext())
        {
          paramString1 = (akuv.b)paramUri.next();
          paramArrayOfString1.addRow(new Object[] { Integer.valueOf(paramString1.type), Integer.valueOf(paramString1.dpq), paramString1.bUs });
          continue;
