...
public class ArkAppDeviceModule$ObserverMethod$6
  implements Runnable
{
  public ArkAppDeviceModule$ObserverMethod$6(admn.c paramc, String paramString1, long paramLong, String paramString2) {}
  ...
  public void run()
  {
    ...
    ArkAppCacheMgr.getAppIcon(this.b.this$0.mAppName, new admw(this, localaqju));
    localaqju.setNegativeButton(2131721908, new admx(this, localaqju));
    localaqju.setPositiveButton(2131721897, new admy(this, localaqju));
    try
    {
      localaqju.show();
      label165:
