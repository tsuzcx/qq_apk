...
public class Utils
{
  ...
  private static final String CP_URI_BASE = "content://com.tencent.tim.shared_file_accessor.ContentProviderImpl/save";
  private static final String LOG_TAG = "Utils";
  private static final Uri SAVE_CMD_URI = Uri.parse("content://com.tencent.tim.shared_file_accessor.ContentProviderImpl/save");
  ...
  static StackInfo getMiniStackInfo()
  {
    int i = 0;
    ...
    for (;;)
    {
      ...
      n = j + 1;
      if (n >= 8) {
        return new StackInfo((String)localObject1, (String)localObject2, localStringBuilder.toString());
      }
      j = i;
      if (i == 0)
      {
  ...
  {
    // Byte code:
    //   0: invokestatic 138	android/os/Process:myPid	()I
    //   3: istore_1
    //   4: aload_0
    //   5: ldc 140
    //   7: invokevirtual 146	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   10: checkcast 148	android/app/ActivityManager
    //   13: invokevirtual 152	android/app/ActivityManager:getRunningAppProcesses	()Ljava/util/List;
    //   16: astore_0
    //   17: aload_0
    //   18: ifnull +229 -> 247
    //   21: aload_0
    ...
    //   43: checkcast 169	android/app/ActivityManager$RunningAppProcessInfo
    //   46: astore_2
    //   47: aload_2
    //   48: getfield 172	android/app/ActivityManager$RunningAppProcessInfo:pid	I
    //   51: iload_1
    //   52: if_icmpne -24 -> 28
    //   55: aload_2
    //   56: getfield 175	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   59: astore_0
    //   60: aload_0
    //   61: astore_2
    //   62: aload_0
    //   63: invokestatic 180	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   66: ifeq +112 -> 178
    //   69: ldc 182
    //   71: ldc 184
    //   73: invokestatic 190	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   76: pop
    //   77: new 192	java/io/FileReader
    //   80: dup
    ...
    //   93: iload_1
    //   94: invokevirtual 197	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   97: ldc 199
    ...
    //   105: invokespecial 202	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   108: astore_3
    //   109: aload_3
    //   110: astore_2
    //   111: sipush 512
    ...
    //   120: aload_3
    //   121: aload 4
    //   123: invokevirtual 206	java/io/FileReader:read	([C)I
    //   126: pop
    //   127: iconst_0
    //   128: istore_1
    //   129: aload_3
    ...
    //   145: aload_3
    //   146: astore_2
    //   147: new 90	java/lang/String
    //   150: dup
    //   151: aload 4
    //   153: invokespecial 209	java/lang/String:<init>	([C)V
    //   156: iconst_0
    //   157: iload_1
    //   158: invokevirtual 213	java/lang/String:substring	(II)Ljava/lang/String;
    //   161: astore 4
    //   163: aload 4
    //   165: astore_0
    //   166: aload_0
    ...
    //   169: ifnull +9 -> 178
    //   172: aload_3
    //   173: invokevirtual 216	java/io/FileReader:close	()V
    //   176: aload_0
    //   177: astore_2
    //   178: aload_2
    //   179: areturn
    ...
    //   195: ldc 218
    //   197: aload 4
    //   199: invokestatic 221	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   202: pop
    //   203: aload_0
    //   204: astore_2
    //   205: aload_3
    //   206: ifnull -28 -> 178
    //   209: aload_3
    //   210: invokevirtual 216	java/io/FileReader:close	()V
    //   213: aload_0
    //   214: areturn
    //   215: astore_2
    //   216: aload_0
    ...
    //   222: ifnull +7 -> 229
    //   225: aload_2
    //   226: invokevirtual 216	java/io/FileReader:close	()V
    //   229: aload_0
    //   230: athrow
    //   231: astore_2
    //   232: aload_0
  ...
  public static java.io.Serializable loadData(String paramString)
  {
    ...
    //   5: dup
    //   6: aload_0
    //   7: invokespecial 268	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   10: astore_1
    //   11: new 270	java/io/ObjectInputStream
    //   14: dup
    //   15: aload_1
    //   16: invokespecial 273	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   19: astore_2
    //   20: aload_2
    //   21: invokevirtual 276	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   24: checkcast 278	java/io/Serializable
    //   27: astore_3
    //   28: aload_2
    //   29: invokevirtual 279	java/io/ObjectInputStream:close	()V
    //   32: aload_1
    //   33: invokevirtual 280	java/io/FileInputStream:close	()V
    //   36: iconst_0
    //   37: ifeq +11 -> 48
    //   40: new 282	java/lang/NullPointerException
    //   43: dup
    //   44: invokespecial 283	java/lang/NullPointerException:<init>	()V
    //   47: athrow
    //   48: iconst_0
    //   49: ifeq +11 -> 60
    //   52: new 282	java/lang/NullPointerException
    //   55: dup
    //   56: invokespecial 283	java/lang/NullPointerException:<init>	()V
    //   59: athrow
    //   60: new 285	java/io/File
    //   63: dup
    //   64: aload_0
    //   65: invokespecial 286	java/io/File:<init>	(Ljava/lang/String;)V
    //   68: invokevirtual 289	java/io/File:delete	()Z
    //   71: pop
    //   72: aload_3
    //   73: areturn
    //   74: astore_1
    ...
    //   86: ifnull +7 -> 93
    //   89: aload_2
    //   90: invokevirtual 279	java/io/ObjectInputStream:close	()V
    //   93: aload_1
    //   94: ifnull +7 -> 101
    //   97: aload_1
    //   98: invokevirtual 280	java/io/FileInputStream:close	()V
    //   101: new 285	java/io/File
    //   104: dup
    //   105: aload_0
    //   106: invokespecial 286	java/io/File:<init>	(Ljava/lang/String;)V
    //   109: invokevirtual 289	java/io/File:delete	()Z
    //   112: pop
    //   113: aload_3
    //   114: areturn
    //   115: astore_1
    ...
    //   123: ifnull +7 -> 130
    //   126: aload_2
    //   127: invokevirtual 279	java/io/ObjectInputStream:close	()V
    //   130: aload_1
    //   131: ifnull +7 -> 138
    //   134: aload_1
    //   135: invokevirtual 280	java/io/FileInputStream:close	()V
    //   138: new 285	java/io/File
    //   141: dup
    //   142: aload_0
    //   143: invokespecial 286	java/io/File:<init>	(Ljava/lang/String;)V
    //   146: invokevirtual 289	java/io/File:delete	()Z
    //   149: pop
    //   150: aload_3
    //   151: areturn
    //   152: astore_1
    ...
    //   160: ifnull +7 -> 167
    //   163: aload_2
    //   164: invokevirtual 279	java/io/ObjectInputStream:close	()V
    //   167: aload_1
    //   168: ifnull +7 -> 175
    //   171: aload_1
    //   172: invokevirtual 280	java/io/FileInputStream:close	()V
    //   175: new 285	java/io/File
    //   178: dup
    //   179: aload_0
    //   180: invokespecial 286	java/io/File:<init>	(Ljava/lang/String;)V
    //   183: invokevirtual 289	java/io/File:delete	()Z
    //   186: pop
    //   187: aload_3
    //   188: areturn
    //   189: astore_1
    ...
    //   197: ifnull +7 -> 204
    //   200: aload_2
    //   201: invokevirtual 279	java/io/ObjectInputStream:close	()V
    //   204: aload_1
    //   205: ifnull +7 -> 212
    //   208: aload_1
    //   209: invokevirtual 280	java/io/FileInputStream:close	()V
    //   212: new 285	java/io/File
    //   215: dup
    //   216: aload_0
    //   217: invokespecial 286	java/io/File:<init>	(Ljava/lang/String;)V
    //   220: invokevirtual 289	java/io/File:delete	()Z
    //   223: pop
    //   224: aload_3
    //   225: areturn
    //   226: astore_1
    ...
    //   234: ifnull +7 -> 241
    //   237: aload_2
    //   238: invokevirtual 279	java/io/ObjectInputStream:close	()V
    //   241: aload_1
    //   242: ifnull +7 -> 249
    //   245: aload_1
    //   246: invokevirtual 280	java/io/FileInputStream:close	()V
    //   249: new 285	java/io/File
    //   252: dup
    //   253: aload_0
    //   254: invokespecial 286	java/io/File:<init>	(Ljava/lang/String;)V
    //   257: invokevirtual 289	java/io/File:delete	()Z
    //   260: pop
    //   261: aload_3
    //   262: areturn
    //   263: astore_3
    ...
    //   269: ifnull +7 -> 276
    //   272: aload_2
    //   273: invokevirtual 279	java/io/ObjectInputStream:close	()V
    //   276: aload_1
    //   277: ifnull +7 -> 284
    //   280: aload_1
    //   281: invokevirtual 280	java/io/FileInputStream:close	()V
    //   284: new 285	java/io/File
    //   287: dup
    //   288: aload_0
    //   289: invokespecial 286	java/io/File:<init>	(Ljava/lang/String;)V
    //   292: invokevirtual 289	java/io/File:delete	()Z
    //   295: pop
    //   296: aload_3
    //   297: athrow
    //   298: astore_1
  ...
  public static boolean saveData(java.io.Serializable paramSerializable, String paramString)
  {
    ...
    //   14: aconst_null
    //   15: astore 8
    //   17: invokestatic 338	com/tencent/mqq/shared_file_accessor/Utils:ensureBuffer	()Ljava/io/ByteArrayOutputStream;
    //   20: astore 9
    //   22: aload 9
    //   24: ifnonnull +5 -> 29
    //   27: iload_2
    //   28: ireturn
    //   29: aload 9
    //   31: invokevirtual 341	java/io/ByteArrayOutputStream:reset	()V
    //   34: new 343	java/io/ObjectOutputStream
    //   37: dup
    //   38: aload 9
    //   40: invokespecial 346	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   43: astore_3
    //   44: aload_3
    //   45: aload_0
    //   46: invokevirtual 349	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   49: aload_3
    //   50: invokevirtual 352	java/io/ObjectOutputStream:flush	()V
    //   53: aload_3
    //   54: invokevirtual 353	java/io/ObjectOutputStream:close	()V
    //   57: new 355	java/io/FileOutputStream
    //   60: dup
    //   61: aload_1
    //   62: invokespecial 356	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   65: astore_0
    //   66: aload 9
    //   68: aload_0
    //   69: invokevirtual 359	java/io/ByteArrayOutputStream:writeTo	(Ljava/io/OutputStream;)V
    //   72: aload 9
    //   74: invokevirtual 360	java/io/ByteArrayOutputStream:flush	()V
    //   77: aload 9
    //   79: invokevirtual 361	java/io/ByteArrayOutputStream:close	()V
    //   82: aload_0
    //   83: invokevirtual 362	java/io/FileOutputStream:flush	()V
    //   86: aload_0
    //   87: invokevirtual 363	java/io/FileOutputStream:close	()V
    //   90: iconst_1
    //   91: istore_2
    //   92: iconst_0
    //   93: ifeq +11 -> 104
    //   96: new 282	java/lang/NullPointerException
    //   99: dup
    //   100: invokespecial 283	java/lang/NullPointerException:<init>	()V
    //   103: athrow
    //   104: iconst_0
    //   105: ifeq -78 -> 27
    //   108: new 282	java/lang/NullPointerException
    //   111: dup
    //   112: invokespecial 283	java/lang/NullPointerException:<init>	()V
    //   115: athrow
    //   116: astore_0
    //   117: iconst_1
    //   118: ireturn
    ...
    //   126: ifnull +7 -> 133
    //   129: aload_3
    //   130: invokevirtual 353	java/io/ObjectOutputStream:close	()V
    //   133: aload_0
    //   134: ifnull -107 -> 27
    //   137: aload_0
    //   138: invokevirtual 363	java/io/FileOutputStream:close	()V
    //   141: iconst_0
    //   142: ireturn
    //   143: astore_0
    //   144: iconst_0
    ...
    //   153: ifnull +7 -> 160
    //   156: aload_3
    //   157: invokevirtual 353	java/io/ObjectOutputStream:close	()V
    //   160: aload_0
    //   161: ifnull -134 -> 27
    //   164: aload_0
    //   165: invokevirtual 363	java/io/FileOutputStream:close	()V
    //   168: iconst_0
    //   169: ireturn
    //   170: astore_0
    //   171: iconst_0
    ...
    //   180: ifnull +7 -> 187
    //   183: aload_3
    //   184: invokevirtual 353	java/io/ObjectOutputStream:close	()V
    //   187: aload_0
    //   188: ifnull -161 -> 27
    //   191: aload_0
    //   192: invokevirtual 363	java/io/FileOutputStream:close	()V
    //   195: iconst_0
    //   196: ireturn
    //   197: astore_0
    //   198: iconst_0
    ...
    //   207: ifnull +7 -> 214
    //   210: aload_3
    //   211: invokevirtual 353	java/io/ObjectOutputStream:close	()V
    //   214: aload_0
    //   215: ifnull -188 -> 27
    //   218: aload_0
    //   219: invokevirtual 363	java/io/FileOutputStream:close	()V
    //   222: iconst_0
    //   223: ireturn
    //   224: astore_0
    //   225: iconst_0
    ...
    //   234: ifnull +7 -> 241
    //   237: aload_3
    //   238: invokevirtual 353	java/io/ObjectOutputStream:close	()V
    //   241: aload_1
    //   242: ifnull +7 -> 249
    //   245: aload_1
    //   246: invokevirtual 363	java/io/FileOutputStream:close	()V
    //   249: aload_0
    //   250: athrow
    //   251: astore_0
    //   252: goto -148 -> 104
    ...
    //   6	303	7	localObject5	Object
    //   15	316	8	localObject6	Object
  ...
  static final class StackInfo
  {
    ...
    StackInfo(String paramString1, String paramString2, String paramString3)
    {
