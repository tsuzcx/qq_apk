...
{
  private static final int LEN_SHORT_FOR_LOG = 8;
  ...
  public static String bytes2ShortStr(byte[] paramArrayOfByte)
  {
    if (paramArrayOfByte.length <= 16) {
      return bytes2Str(paramArrayOfByte);
    }
  ...
  public static byte[] str2Bytes(String paramString)
  {
    ...
    while (i < j)
    {
      arrayOfByte[i] = ((byte)Integer.valueOf(paramString[i], 16).intValue());
      i += 1;
    }
    return arrayOfByte;
  }
  ...
  public static int str2Int(String paramString, int paramInt)
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      QLog.d("StringUtils", 2, "str2Int fail, str = " + paramString);
    }
    return paramInt;
  }
}
