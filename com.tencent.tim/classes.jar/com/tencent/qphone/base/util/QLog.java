...
public class QLog
{
  ...
  private static void addLogItem(String arg0, int paramInt1, int paramInt2, String paramString2, byte[] paramArrayOfByte, Throwable paramThrowable)
  {
    ...
    c localc = (c)sPool.obtain(c.class);
    if (localc == null)
    {
  ...
  public static void init(String paramString1, String paramString2, String paramString3, long paramLong)
  {
    ...
    if (sWriteHandler == null)
    {
      ...
      paramString1.start();
      sWriteHandler = new d(paramString1.getLooper());
    ...
    for (;;)
    {
      sPool = new RecyclablePool(c.class, i);
      return;
      label82:
      if (isColorLevel()) {
        i = 256;
  ...
  public static void setOnPrintlnCallback(b paramb)
  {
  ...
  {
    // Byte code:
    //   0: invokestatic 877	com/tencent/qphone/base/util/QLog:isExistSDCard	()Z
    //   3: ifeq +141 -> 144
    //   6: new 360	java/io/File
    //   9: dup
    //   10: getstatic 211	com/tencent/qphone/base/util/QLog:manualLogLevelPath	Ljava/lang/String;
    //   13: invokespecial 361	java/io/File:<init>	(Ljava/lang/String;)V
    //   16: astore_2
    //   17: aload_2
    //   18: invokevirtual 364	java/io/File:exists	()Z
    //   21: ifeq +113 -> 134
    //   24: aload_2
    //   25: invokevirtual 880	java/io/File:isFile	()Z
    //   28: ifeq +106 -> 134
    //   31: new 882	java/io/BufferedReader
    //   34: dup
    //   35: new 884	java/io/FileReader
    //   38: dup
    //   39: getstatic 211	com/tencent/qphone/base/util/QLog:manualLogLevelPath	Ljava/lang/String;
    //   42: invokespecial 885	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   45: invokespecial 888	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   48: astore_3
    //   49: aload_3
    //   50: astore_2
    //   51: aload_3
    //   52: invokevirtual 891	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   55: invokestatic 896	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   58: invokevirtual 899	java/lang/Integer:intValue	()I
    //   61: istore_1
    //   62: aload_3
    //   63: astore_2
    //   64: iload_1
    ...
    //   77: astore_2
    //   78: iload_1
    //   79: putstatic 167	com/tencent/qphone/base/util/QLog:UIN_REPORTLOG_LEVEL	I
    //   82: aload_3
    //   83: astore_2
    //   84: ldc 120
    //   86: iconst_1
    //   87: new 189	java/lang/StringBuilder
    //   90: dup
    //   91: invokespecial 190	java/lang/StringBuilder:<init>	()V
    //   94: invokestatic 863	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   97: invokevirtual 864	java/lang/Thread:getName	()Ljava/lang/String;
    //   100: invokevirtual 205	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   103: ldc_w 866
    //   106: invokevirtual 205	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   109: iload_1
    //   110: invokevirtual 869	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   113: invokevirtual 209	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   116: invokestatic 901	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   119: aload_3
    //   120: ifnull +7 -> 127
    //   123: aload_3
    //   124: invokevirtual 902	java/io/BufferedReader:close	()V
    //   127: return
    //   128: astore_2
    //   129: aload_2
    //   130: invokevirtual 903	java/io/IOException:printStackTrace	()V
    //   133: return
    //   134: aconst_null
    //   135: astore_2
    //   136: aload_2
    //   137: ifnull +7 -> 144
    //   140: aload_2
    //   141: invokevirtual 902	java/io/BufferedReader:close	()V
    //   144: iload_0
    //   145: iconst_1
    ...
    //   154: getstatic 167	com/tencent/qphone/base/util/QLog:UIN_REPORTLOG_LEVEL	I
    //   157: iload_0
    //   158: if_icmpeq -31 -> 127
    //   161: iload_0
    //   162: putstatic 167	com/tencent/qphone/base/util/QLog:UIN_REPORTLOG_LEVEL	I
    //   165: ldc 120
    //   167: iconst_1
    //   168: new 189	java/lang/StringBuilder
    //   171: dup
    //   172: invokespecial 190	java/lang/StringBuilder:<init>	()V
    //   175: invokestatic 863	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   178: invokevirtual 864	java/lang/Thread:getName	()Ljava/lang/String;
    //   181: invokevirtual 205	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   184: ldc_w 905
    //   187: invokevirtual 205	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   190: iload_0
    //   191: invokevirtual 869	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   194: invokevirtual 209	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   197: new 871	java/lang/RuntimeException
    //   200: dup
    //   201: invokespecial 872	java/lang/RuntimeException:<init>	()V
    //   204: invokestatic 391	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   207: return
    //   208: astore_2
    //   209: aload_2
    //   210: invokevirtual 903	java/io/IOException:printStackTrace	()V
    //   213: goto -69 -> 144
    //   216: astore 4
    //   218: aconst_null
    //   219: astore_3
    ...
    //   221: astore_2
    //   222: aload 4
    //   224: invokevirtual 745	java/lang/Throwable:printStackTrace	()V
    //   227: aload_3
    //   228: astore_2
    //   229: ldc 120
    //   231: iconst_1
    //   232: ldc_w 907
    //   235: aload 4
    //   237: invokestatic 479	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   240: aload_3
    //   241: ifnull -97 -> 144
    //   244: aload_3
    //   245: invokevirtual 902	java/io/BufferedReader:close	()V
    //   248: goto -104 -> 144
    //   251: astore_2
    //   252: aload_2
    //   253: invokevirtual 903	java/io/IOException:printStackTrace	()V
    //   256: goto -112 -> 144
    //   259: astore_3
    //   260: aconst_null
    //   261: astore_2
    ...
    //   263: ifnull +7 -> 270
    //   266: aload_2
    //   267: invokevirtual 902	java/io/BufferedReader:close	()V
    //   270: aload_3
    //   271: athrow
    //   272: astore_2
    //   273: aload_2
    //   274: invokevirtual 903	java/io/IOException:printStackTrace	()V
    //   277: goto -7 -> 270
    //   280: astore_3
    //   281: goto -19 -> 262
    //   284: astore 4
    ...
    extends Handler
  {
    ...
    public void handleMessage(android.os.Message arg1)
    {
      ...
      //   37: ldc 26
      //   39: ldc 28
      //   41: invokestatic 33	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
      //   44: pop
      ...
      //   55: pop
      //   56: getstatic 51	com/tencent/qphone/base/util/QLog:sWriteHandler	Lcom/tencent/qphone/base/util/QLog$d;
      //   59: iconst_2
      //   60: invokevirtual 55	com/tencent/qphone/base/util/QLog$d:removeMessages	(I)V
      //   63: getstatic 51	com/tencent/qphone/base/util/QLog:sWriteHandler	Lcom/tencent/qphone/base/util/QLog$d;
      //   66: iconst_2
      //   67: invokevirtual 59	com/tencent/qphone/base/util/QLog$d:sendEmptyMessage	(I)Z
      //   70: pop
      //   71: invokestatic 63	com/tencent/qphone/base/util/QLog:access$000	()I
      //   74: ifle -38 -> 36
      //   77: ldc 26
      //   79: ldc 65
      //   81: invokestatic 33	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
      //   84: pop
      ...
      //   90: monitorenter
      //   91: aconst_null
      //   92: invokestatic 73	com/tencent/qphone/base/util/QLog:access$402	(Lcom/tencent/qphone/base/util/QLog$c;)Lcom/tencent/qphone/base/util/QLog$c;
      //   95: invokestatic 76	com/tencent/qphone/base/util/QLog:access$302	(Lcom/tencent/qphone/base/util/QLog$c;)Lcom/tencent/qphone/base/util/QLog$c;
      //   98: pop
      //   99: aload_1
      //   100: monitorexit
      //   101: getstatic 51	com/tencent/qphone/base/util/QLog:sWriteHandler	Lcom/tencent/qphone/base/util/QLog$d;
      //   104: iconst_3
      //   105: invokevirtual 55	com/tencent/qphone/base/util/QLog$d:removeMessages	(I)V
      //   108: getstatic 51	com/tencent/qphone/base/util/QLog:sWriteHandler	Lcom/tencent/qphone/base/util/QLog$d;
      //   111: iconst_3
      //   112: ldc2_w 17
      //   115: invokevirtual 80	com/tencent/qphone/base/util/QLog$d:sendEmptyMessageDelayed	(IJ)Z
      //   118: pop
      //   119: return
      //   120: astore_1
      //   121: aload_1
      ...
      //   163: invokestatic 33	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
      //   166: pop
      //   167: getstatic 51	com/tencent/qphone/base/util/QLog:sWriteHandler	Lcom/tencent/qphone/base/util/QLog$d;
      //   170: iconst_1
      //   171: invokevirtual 55	com/tencent/qphone/base/util/QLog$d:removeMessages	(I)V
      //   174: getstatic 51	com/tencent/qphone/base/util/QLog:sWriteHandler	Lcom/tencent/qphone/base/util/QLog$d;
      //   177: iconst_1
      ...
      //   185: imul
      //   186: i2l
      //   187: invokevirtual 80	com/tencent/qphone/base/util/QLog$d:sendEmptyMessageDelayed	(IJ)Z
      //   190: pop
      //   191: getstatic 51	com/tencent/qphone/base/util/QLog:sWriteHandler	Lcom/tencent/qphone/base/util/QLog$d;
      //   194: iconst_3
      //   195: invokevirtual 55	com/tencent/qphone/base/util/QLog$d:removeMessages	(I)V
      //   198: getstatic 51	com/tencent/qphone/base/util/QLog:sWriteHandler	Lcom/tencent/qphone/base/util/QLog$d;
      //   201: astore_1
      ...
      //   214: iconst_3
      //   215: lload 4
      //   217: invokevirtual 80	com/tencent/qphone/base/util/QLog$d:sendEmptyMessageDelayed	(IJ)Z
      //   220: pop
      //   221: iload_2
      //   222: iconst_1
      //   223: iadd
      ...
      //   253: ifeq +22 -> 275
      //   256: getstatic 51	com/tencent/qphone/base/util/QLog:sWriteHandler	Lcom/tencent/qphone/base/util/QLog$d;
      //   259: iconst_1
      //   260: invokevirtual 55	com/tencent/qphone/base/util/QLog$d:removeMessages	(I)V
      //   263: getstatic 51	com/tencent/qphone/base/util/QLog:sWriteHandler	Lcom/tencent/qphone/base/util/QLog$d;
      //   266: iconst_1
      //   267: ldc2_w 112
      //   270: invokevirtual 80	com/tencent/qphone/base/util/QLog$d:sendEmptyMessageDelayed	(IJ)Z
      //   273: pop
      //   274: return
      //   275: getstatic 51	com/tencent/qphone/base/util/QLog:sWriteHandler	Lcom/tencent/qphone/base/util/QLog$d;
      //   278: iconst_2
      //   279: invokevirtual 55	com/tencent/qphone/base/util/QLog$d:removeMessages	(I)V
      //   282: getstatic 51	com/tencent/qphone/base/util/QLog:sWriteHandler	Lcom/tencent/qphone/base/util/QLog$d;
      //   285: iconst_2
      //   286: ldc2_w 112
      //   289: invokevirtual 80	com/tencent/qphone/base/util/QLog$d:sendEmptyMessageDelayed	(IJ)Z
      //   292: pop
      //   293: return
      // Local variable table:
      //   start	length	slot	name	signature
