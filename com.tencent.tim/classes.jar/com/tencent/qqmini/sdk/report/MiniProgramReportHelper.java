...
public class MiniProgramReportHelper
{
  ...
  {
    String str = NetworkUtil.getNetWorkTypeByStr(AppLoaderFactory.g().getMiniAppEnv().getContext());
    if (str == null) {
      return "unknown";
    }
