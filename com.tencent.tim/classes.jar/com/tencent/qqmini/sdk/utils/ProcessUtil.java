...
import com.tencent.qqmini.sdk.launcher.AppBrandLaunchManager.MiniAppSubProcessorInfo;
...
public class ProcessUtil
{
  ...
  private static AppBrandLaunchManager.MiniAppSubProcessorInfo getCurrentProcessorInfo(Context paramContext)
  {
    paramContext = getCurrentProcessName(paramContext);
    if (paramContext != null) {
      return (AppBrandLaunchManager.MiniAppSubProcessorInfo)AppBrandLaunchManager.subProcessorInfoMap.get(paramContext);
    }
    return null;
  }
