...
public class JSONUtils
{
  ...
  public static <T> T convertFromJsonObject(JSONObject paramJSONObject, Class<T> paramClass)
  {
    ...
    try
    {
      ...
      if ((localField.isAnnotationPresent(NotKey.class)) || (Modifier.isStatic(localField.getModifiers()))) {
        break label338;
      }
      if (localField.isAnnotationPresent(FieldName.class)) {
        paramClass = ((FieldName)localField.getAnnotation(FieldName.class)).value();
      }
    ...
    if (List.class.isAssignableFrom(localClass2))
    {
      ...
      if (!localField.isAnnotationPresent(GenericType.class)) {
        return null;
      }
      localClass1 = ((GenericType)localField.getAnnotation(GenericType.class)).value();
  ...
  @Retention(RetentionPolicy.RUNTIME)
  @Target({java.lang.annotation.ElementType.FIELD})
  public static @interface NotKey {}
}
