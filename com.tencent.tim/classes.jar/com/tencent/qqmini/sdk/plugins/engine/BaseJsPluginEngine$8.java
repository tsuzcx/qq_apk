...
{
  BaseJsPluginEngine$8(BaseJsPluginEngine paramBaseJsPluginEngine, MiniAppProxy paramMiniAppProxy, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4) {}
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable1)
      {
        try
        {
          ...
          BaseJsPluginEngine.access$300(this.this$0).post(new BaseJsPluginEngine.8.1(this, i, (String)localObject1, j, paramJSONObject));
          return;
        }
