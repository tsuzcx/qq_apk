  ...
  extends MiniBaseFragment
{
  ...
  public static void launch(Activity paramActivity, ShareData paramShareData)
  {
    ...
    localIntent.putExtra(KEY_ORIGIN_TASK_ID, paramActivity.getTaskId());
    localIntent.putExtra(KEY_SHARE_DATA, paramShareData);
    localIntent.setFlags(268435456);
    localIntent.putExtra("public_fragment_window_feature", 1);
    MiniFragmentActivity.Launcher.start(paramActivity, localIntent, MiniTranslucentFragmentActivity.class, ShareTransitiveFragment.class);
  }
