  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        for (paramWebView = paramString.replace("https://jsbridge/", "jsbridge://"); (this.this$0.mBrowerEngin != null) && (this.this$0.mBrowerEngin.shouldOverrideUrlRequest(paramWebView)); paramWebView = paramString.replace("http://jsbridge/", "jsbridge://"))
        {
          return true;
