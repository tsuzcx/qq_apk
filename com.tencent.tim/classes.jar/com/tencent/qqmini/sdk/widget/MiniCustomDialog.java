  ...
  extends ReportDialog
{
  ...
  ListView list;
  private BrandColorManager mBrandColorManager = new BrandColorManager(null);
  ...
  public void dismiss()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 281	android/app/Dialog:dismiss	()V
    //   4: return
    //   5: astore_1
    //   6: aload_1
    //   7: athrow
  ...
  static class BrandColorManager
  {
  ...
  class CustomDialogItemOnClickListener
    implements View.OnClickListener
  {
    int i;
    
    public CustomDialogItemOnClickListener(int paramInt)
    {
      this.i = paramInt;
    }
    ...
    {
      if (MiniCustomDialog.this.onArrayItemClick != null) {
        MiniCustomDialog.this.onArrayItemClick.onClick(MiniCustomDialog.this, MiniCustomDialog.this.customWhichToCallBack(this.i));
      }
      try
      {
