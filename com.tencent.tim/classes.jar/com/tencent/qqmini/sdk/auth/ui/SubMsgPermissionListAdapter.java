  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (localStSubscribeMessage != null)
    {
      ...
      ((ViewHolder)localObject).tvAuthTitle.setText(localStSubscribeMessage.example.title.get());
      ((ViewHolder)localObject).ivAuthDetail.setTag(localStSubscribeMessage);
      ((ViewHolder)localObject).ivAuthDetail.setOnClickListener(this);
      ((ViewHolder)localObject).authSwitcher.setTag(localStSubscribeMessage);
      localSwitch = ((ViewHolder)localObject).authSwitcher;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ((ViewHolder)localObject).authSwitcher.setOnCheckedChangeListener(this);
      ...
      ((ViewHolder)localObject).tvAuthTitle = ((TextView)paramView.findViewById(R.id.tv_auth_title));
      ((ViewHolder)localObject).ivAuthDetail = ((ImageView)paramView.findViewById(R.id.iv_auth_detail));
      ((ViewHolder)localObject).authSwitcher = ((Switch)paramView.findViewById(R.id.sw_auth));
 ...
 * Qualified Name:     com.tencent.qqmini.sdk.auth.ui.SubMsgPermissionListAdapter
