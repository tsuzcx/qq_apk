...
public class FPSCalculator
{
  ...
  public void addListener(GetFPSListener paramGetFPSListener)
  {
  ...
  public boolean isObserved(GetFPSListener paramGetFPSListener)
  {
    return this.mListener.contains(paramGetFPSListener);
  }
  
  public void removeListener(GetFPSListener paramGetFPSListener)
  {
    synchronized (this.mLock)
    {
      if (this.mListener.contains(paramGetFPSListener)) {
  ...
  public static abstract interface GetFPSListener
  {
