...
public abstract class ProtoBufRequest
{
  ...
  public JSONObject getResponse(byte[] paramArrayOfByte)
  {
    try
    {
      ...
      localJSONObject.put("retCode", localStQWebRsp.retCode.get());
      localJSONObject.put("errMsg", localStQWebRsp.errMsg.get().toStringUtf8());
      paramArrayOfByte = getResponse(paramArrayOfByte, localJSONObject);
      return paramArrayOfByte;
    }
    catch (Exception paramArrayOfByte)
    {
