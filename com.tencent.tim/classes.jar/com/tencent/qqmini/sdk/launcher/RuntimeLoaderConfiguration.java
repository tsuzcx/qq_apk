...
public class RuntimeLoaderConfiguration
{
  ...
  RuntimeLoaderConfiguration(AppRuntimeLoaderManager paramAppRuntimeLoaderManager)
  {
    ...
    int i = 0;
    label61:
    RuntimeLoaderInfo localRuntimeLoaderInfo;
    Object localObject2;
    if (i < j)
    {
      ...
      try
      {
        localRuntimeLoaderInfo = new RuntimeLoaderInfo();
  ...
  public String toString()
  {
    ...
    {
      RuntimeLoaderInfo localRuntimeLoaderInfo = (RuntimeLoaderInfo)localIterator.next();
  ...
  static class RuntimeLoaderInfo
  {
 ...
 * Qualified Name:     com.tencent.qqmini.sdk.launcher.RuntimeLoaderConfiguration
