...
class Configuration
{
  ...
  {
    ProcessInfo localProcessInfo = new ProcessInfo();
  ...
  private void ensureProcessInfo(Context paramContext)
  {
    try
    {
      ...
      while (i >= 0)
      {
        ProcessInfo localProcessInfo = (ProcessInfo)this.processInfoList.get(i);
  ...
  private void initCustomConfiguration(Context paramContext)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localObject1 instanceof Map))
      {
        ...
        localProcessInfo = new ProcessInfo();
  ...
  private void initDefaultConfiguration(Context paramContext)
  {
    ...
    addProcessInfo(paramContext + ":mini4", findClass("com.tencent.qqmini.sdk.ui.MiniActivity4"), null, findClass("com.tencent.qqmini.sdk.receiver.AppBrandMainReceiver4"), ProcessType.MINI_GAME, 4);
    addProcessInfo(paramContext + ":mini5", findClass("com.tencent.qqmini.sdk.ui.MiniActivity5"), null, findClass("com.tencent.qqmini.sdk.receiver.AppBrandMainReceiver5"), ProcessType.MINI_GAME, 4);
