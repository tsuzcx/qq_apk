...
public class BaseLibManager
{
  ...
  public String installMiniGameInnerJsLib()
  {
    for (;;)
    {
      try
      {
        ...
        {
          QMLog.i("miniapp-process_BaseLibManager", "[MiniEng] installMiniGameInnerJsLib, inner baseLib already installed, version:1.16.0.00063");
          return str;
        }
        int j = WnsConfig.getConfig("qqminiapp", "mini_app_inner_baselib_retry_count", MINI_APP_INNER_BASELIB_RETRY_COUNT_DEFAULT);
        QMLog.i("miniapp-process_BaseLibManager", "[MiniEng] installMiniGameInnerJsLib, version:1.16.0.00063, totalCount:" + j);
        int i = 0;
        boolean bool;
        if (i < j)
        {
          i += 1;
          bool = AssetsUtil.copyFileOrDir(AppLoaderFactory.g().getMiniAppEnv().getContext(), "mini", str, this.miniGameBaseLibFiles);
  ...
  public void updateBaseLib(String paramString, boolean paramBoolean, UpdateListener paramUpdateListener)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 53	com/tencent/qqmini/sdk/manager/BaseLibManager:mListeners	Ljava/util/List;
    //   6: aload_3
    //   7: invokeinterface 491 2 0
    //   12: pop
    //   13: ldc 25
    //   15: new 127	java/lang/StringBuilder
    //   18: dup
    //   19: invokespecial 128	java/lang/StringBuilder:<init>	()V
    //   22: ldc_w 493
    //   25: invokevirtual 134	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   28: aload_0
    //   29: getfield 55	com/tencent/qqmini/sdk/manager/BaseLibManager:isUpdatingBaseLib	Z
    //   32: invokevirtual 444	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   35: invokevirtual 138	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   38: invokestatic 144	com/tencent/qqmini/sdk/launcher/log/QMLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   41: aload_0
    //   42: getfield 55	com/tencent/qqmini/sdk/manager/BaseLibManager:isUpdatingBaseLib	Z
    //   45: istore 4
    //   47: iload 4
    //   49: ifeq +6 -> 55
    //   52: aload_0
    ...
    //   55: aload_0
    //   56: iconst_1
    //   57: putfield 55	com/tencent/qqmini/sdk/manager/BaseLibManager:isUpdatingBaseLib	Z
    //   60: invokestatic 358	com/tencent/qqmini/sdk/core/manager/ThreadManager:getSubThreadHandler	()Landroid/os/Handler;
    //   63: new 495	com/tencent/qqmini/sdk/manager/BaseLibManager$2
    //   66: dup
    //   67: aload_0
    //   68: iload_2
    //   69: aload_1
    //   70: aload_3
    //   71: invokespecial 498	com/tencent/qqmini/sdk/manager/BaseLibManager$2:<init>	(Lcom/tencent/qqmini/sdk/manager/BaseLibManager;ZLjava/lang/String;Lcom/tencent/qqmini/sdk/manager/BaseLibManager$UpdateListener;)V
    //   74: invokevirtual 369	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   77: pop
    //   78: goto -26 -> 52
    //   81: astore_1
    //   82: aload_0
    ...
    //   0	86	3	paramUpdateListener	UpdateListener
    //   45	3	4	bool	boolean
    // Exception table:
    //   from	to	target	type
    //   2	47	81	finally
