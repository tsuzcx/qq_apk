...
{
  MiniLoadingAdManager$3(MiniLoadingAdManager paramMiniLoadingAdManager, MiniAppInfo paramMiniAppInfo, MiniLoadingAdManager.OnDismissListener paramOnDismissListener, Activity paramActivity) {}
  ...
  public void onAdShow(View paramView)
  {
    ...
    for (;;)
    {
      MiniLoadingAdManager.access$100(this.val$miniAppInfo.appId, str, 0);
