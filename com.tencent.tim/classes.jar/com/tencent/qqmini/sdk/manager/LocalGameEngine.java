...
public class LocalGameEngine
{
  ...
  private void initLocalBaseLibInfo()
  {
    ...
    this.mLocalBaseLibInfo.baseLibVersion = WnsUtil.getGameEngineVersion("1.16.0.00063");
  ...
  {
    this.mLocalEngineVersion = new EngineVersion(WnsUtil.getGameEngineVersion("1.16.0.00063"));
  }
