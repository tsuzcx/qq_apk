  ...
  implements DownloaderProxy.DownloadListener
{
  ...
  EngineInstaller$2(EngineInstaller paramEngineInstaller, String paramString, BaseLibInfo paramBaseLibInfo, long paramLong, File paramFile, EngineVersion paramEngineVersion, boolean paramBoolean) {}
  ...
  public void onDownloadSucceed(int paramInt, String paramString, DownloaderProxy.DownloadListener.DownloadResult paramDownloadResult)
  {
    ...
    if ((paramDownloadResult.length() == this.val$engineFileSize) || (this.val$engineFileSize < 0L))
    {
    ...
    for (;;)
    {
      try
      {
        boolean bool = EngineInstaller.access$200(this.this$0, this.val$engineRootDir, this.val$engineUrl, this.val$engineVersion, paramString, this.val$isUpdate);
        if (this.val$info.baseLibType == 2)
        {
      ...
      QMLog.i("EngineInstaller", "[MiniEng]refuse to unzip " + paramString + " length=" + paramDownloadResult.length() + ", mEngineFileSize=" + this.val$engineFileSize);
      EngineInstaller.access$000(this.this$0);
      return;
      label255:
      paramInt = 1;
