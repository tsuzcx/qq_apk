  ...
  implements VConsoleDragView.Listener, Preloadable<IMiniAppContext>, IPage
{
  ...
  void updateMonitorFPSText(double paramDouble)
  {
    if (isMonitorViewShowing()) {
      this.mMiniAppMonitorInfoView.updateFPSText(paramDouble);
    }
  }
    ...
    extends BroadcastReceiver
  {
    ...
    public void onReceive(Context paramContext, Intent paramIntent)
    {
      ...
      for (paramContext = "show";; paramContext = "hide")
      {
        ...
        if (GamePage.this.isMonitorViewShowing() != bool) {
          GamePage.this.toggleMonitorPanel();
        }
        if (GamePage.this.mRootView != null) {
          GamePage.this.attachVConsoleView(GamePage.this.mRootView);
        }
        return;
      }
    }
