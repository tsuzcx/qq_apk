...
import com.tencent.qqmini.sdk.launcher.AppStateManager;
  ...
  extends BaseRuntimeLoader
{
  ...
  private void sendPreloadBaseLibVersion()
  {
    ...
    if ((localObject != null) && (((EnvConfig)localObject).getTritonVersion() != null)) {}
    for (localObject = ((EnvConfig)localObject).getTritonVersion().getVersion();; localObject = null)
    {
      if (localObject != null)
      {
        ...
        if (QMLog.isColorLevel()) {
          QMLog.i("BaseRuntimeLoader", "[MiniEng]preload engine version:" + (String)localObject);
        }
      }
      return;
    }
