...
public class MD5FileUtil
{
    ...
    throws java.io.IOException
  {
    ...
    //   34: lcmp
    //   35: ifle +129 -> 164
    //   38: new 96	java/io/FileInputStream
    //   41: dup
    //   42: aload_0
    //   43: invokespecial 99	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   46: astore 8
    //   48: aload 8
    //   50: astore 7
    //   52: aload_0
    //   53: invokevirtual 94	java/io/File:length	()J
    //   56: lstore_1
    //   57: aload 8
    //   59: astore 7
    //   61: sipush 4096
    ...
    //   111: aload 8
    //   113: astore 7
    //   115: getstatic 32	com/tencent/qqmini/minigame/utils/MD5FileUtil:messagedigest	Ljava/security/MessageDigest;
    //   118: aload_0
    //   119: iconst_0
    //   120: lload_3
    //   121: l2i
    //   122: invokestatic 111	java/nio/ByteBuffer:wrap	([BII)Ljava/nio/ByteBuffer;
    //   125: invokevirtual 115	java/security/MessageDigest:update	(Ljava/nio/ByteBuffer;)V
    //   128: goto -61 -> 67
    //   131: astore 7
    //   133: aload 8
    //   135: astore_0
    ...
    //   141: astore 7
    //   143: aload 8
    //   145: invokevirtual 118	java/lang/Throwable:printStackTrace	()V
    //   148: aload 9
    //   150: astore 7
    //   152: aload_0
    //   153: ifnull +11 -> 164
    //   156: aload_0
    //   157: invokevirtual 121	java/io/FileInputStream:close	()V
    //   160: aload 9
    //   162: astore 7
    //   164: aload 7
    //   166: areturn
    ...
    //   169: astore 7
    //   171: aload 8
    //   173: invokevirtual 121	java/io/FileInputStream:close	()V
    //   176: aload 8
    //   178: astore 7
    //   180: getstatic 32	com/tencent/qqmini/minigame/utils/MD5FileUtil:messagedigest	Ljava/security/MessageDigest;
    //   183: invokevirtual 125	java/security/MessageDigest:digest	()[B
    //   186: astore 11
    //   188: aload 10
    //   190: astore_0
    //   191: aload 11
    ...
    //   198: astore 7
    //   200: aload 11
    //   202: invokestatic 127	com/tencent/qqmini/minigame/utils/MD5FileUtil:bufferToHex	([B)Ljava/lang/String;
    //   205: astore_0
    //   206: aload_0
    //   207: astore 7
    //   209: aload 8
    //   211: ifnull -47 -> 164
    //   214: aload 8
    //   216: invokevirtual 121	java/io/FileInputStream:close	()V
    //   219: aload_0
    //   220: areturn
    //   221: astore 7
    //   223: aload 7
    //   225: invokevirtual 128	java/io/IOException:printStackTrace	()V
    //   228: aload_0
    //   229: areturn
    //   230: astore_0
    //   231: aload_0
    ...
    //   243: ifnull +8 -> 251
    //   246: aload 7
    //   248: invokevirtual 121	java/io/FileInputStream:close	()V
    //   251: aload_0
    //   252: athrow
    //   253: astore 7
    //   255: aload 7
  ...
  public static String getFileMd5BigFile(String paramString)
  {
    ...
    //   5: astore 9
    //   7: ldc 34
    //   9: invokestatic 40	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   12: astore 10
    //   14: new 96	java/io/FileInputStream
    //   17: dup
    //   18: aload_0
    //   19: invokespecial 139	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   22: astore 8
    //   24: aload 8
    //   26: astore 7
    ...
    //   31: dup
    //   32: aload_0
    //   33: invokespecial 140	java/io/File:<init>	(Ljava/lang/String;)V
    //   36: invokevirtual 94	java/io/File:length	()J
    //   39: lstore 5
    //   41: lload 5
    //   43: ldc2_w 135
    //   46: lcmp
    ...
    //   70: aload 8
    //   72: aload_0
    //   73: invokevirtual 143	java/io/InputStream:read	([B)I
    //   76: istore_2
    //   77: iload_2
    //   78: iconst_m1
    //   79: if_icmpeq +62 -> 141
    ...
    //   106: iconst_0
    //   107: iload_1
    //   108: invokevirtual 146	java/security/MessageDigest:update	([BII)V
    //   111: goto -51 -> 60
    //   114: astore_0
    //   115: aload 8
    //   117: astore 7
    //   119: aload_0
    //   120: invokevirtual 147	java/security/NoSuchAlgorithmException:printStackTrace	()V
    //   123: aload 9
    //   125: astore_0
    //   126: aload 8
    //   128: ifnull +11 -> 139
    //   131: aload 8
    //   133: invokevirtual 148	java/io/InputStream:close	()V
    //   136: aload 9
    //   138: astore_0
    //   139: aload_0
    //   140: areturn
    ...
    //   143: astore 7
    //   145: aload 8
    //   147: invokevirtual 148	java/io/InputStream:close	()V
    //   150: aload 8
    //   152: astore 7
    //   154: aload 10
    //   156: invokevirtual 125	java/security/MessageDigest:digest	()[B
    //   159: invokestatic 127	com/tencent/qqmini/minigame/utils/MD5FileUtil:bufferToHex	([B)Ljava/lang/String;
    //   162: astore_0
    //   163: aload_0
    //   164: astore 7
    //   166: aload 7
    ...
    //   171: ifnull -32 -> 139
    //   174: aload 8
    //   176: invokevirtual 148	java/io/InputStream:close	()V
    //   179: aload 7
    //   181: areturn
    //   182: astore_0
    //   183: aload 7
    ...
    //   192: astore 7
    //   194: aload_0
    //   195: invokevirtual 149	java/io/FileNotFoundException:printStackTrace	()V
    //   198: aload 9
    //   200: astore_0
    //   201: aload 8
    //   203: ifnull -64 -> 139
    ...
    //   233: ifnull -94 -> 139
    //   236: aload 8
    //   238: invokevirtual 148	java/io/InputStream:close	()V
    //   241: aconst_null
    //   242: areturn
    //   243: astore_0
    //   244: aconst_null
    ...
    //   252: astore 7
    //   254: aload_0
    //   255: invokevirtual 118	java/lang/Throwable:printStackTrace	()V
    //   258: aload 9
    //   260: astore_0
    //   261: aload 8
    //   263: ifnull -124 -> 139
    ...
    //   282: ifnull +8 -> 290
    //   285: aload 7
    //   287: invokevirtual 148	java/io/InputStream:close	()V
    //   290: aload_0
    //   291: athrow
    //   292: astore_0
    //   293: aconst_null
