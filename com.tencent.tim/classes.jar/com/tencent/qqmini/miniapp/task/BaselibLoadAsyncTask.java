  ...
  extends AsyncTask
{
  ...
  public void loadBaselib()
  {
    try
    {
      ...
      String str1 = StorageUtil.getPreference().getString("version", "1.16.0.00063");
      ...
      try
      {
        ...
        if ((localMiniAppProxy != null) && (localMiniAppProxy.isDebugVersion()))
        {
          ...
          localBaselibContent.version = "1.16.0.00063";
        }
        int j = 1;
        int i;
        if (!BaseLibInfo.needUpdateVersion("1.16.0.00063", str1))
        {
          i = j;
        ...
        {
          i = 0;
          QMLog.e("BaselibLoadAsyncTask", "download baselib invalid! use assert baselib. download_version=" + str1 + " assert_version=" + "1.16.0.00063");
        }
