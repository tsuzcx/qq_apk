  ...
  implements TXLivePushListenerReflect.ITXLivePushListener, TXLivePushListenerReflect.OnBGMNotify
{
  ...
  private void configLivePusher(Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean1) || (paramBoolean2)) {
      WXLivePusherReflect.setConfig(this.mLivePushConfig, this.mLivePusher);
    }
    paramBoolean2 = paramBundle.getBoolean("enableCamera", this.mEnableCamera);
    if (paramBoolean2 != this.mEnableCamera)
    {
      if (paramBoolean2)
      {
        stopPreview();
        startPreview(paramBoolean2);
      }
    }
    else
    {
      setEnableMic(paramBundle, paramBoolean1);
      ...
      paramBoolean2 = this.mRemoteMirror;
      if (!paramBundle.keySet().contains("remoteMirror")) {
        break label282;
      }
      paramBoolean2 = paramBundle.getBoolean("remoteMirror");
    }
    for (;;)
    {
      if (paramBoolean2 != this.mRemoteMirror) {
        WXLivePusherReflect.setMirror(paramBoolean2, this.mLivePusher);
      }
      this.mRemoteMirror = paramBoolean2;
      ...
      paramBoolean2 = paramBundle.getBoolean("debug", this.mDebug);
      if ((paramBoolean1) || (paramBoolean2 != this.mDebug)) {
        WXLivePusherReflect.showDebugLog(paramBoolean2, this.mLivePusher);
      }
      ...
      if (paramBundle.keySet().contains("mirror")) {
        paramBoolean2 = paramBundle.getBoolean("mirror");
      }
    }
  }
  ...
  private void parseAndApplyParams(Bundle paramBundle, boolean paramBoolean)
  {
    ...
    String str = paramBundle.getString("orientation", this.mOrientation);
    if (!str.equalsIgnoreCase(this.mOrientation))
    {
    ...
    for (;;)
    {
      configLivePusher(paramBundle, paramBoolean, setLivePusherVideoConfig(paramBundle));
      return;
      label113:
  ...
  private boolean setLivePusherVideoConfig(Bundle paramBundle)
  {
    ...
    if (i > k)
    {
      QMLog.e("TXLivePusherJSAdapter", "parseAndApplyParams -> swap min and max bitrate, may be something error. min = " + i + " max = " + k);
      j = k;
    }
    for (;;)
    {
      ...
      for (i = k;; i = m)
      {
        ...
        setRealTimeVideoChatMode(i1, k, m, n, str1, i, j);
        String str2 = paramBundle.getString("localMirror", this.mLocalMirror);
        setLocalVideoMirror(str2);
        String str3 = paramBundle.getString("backgroundImage", this.mPauseImageFilePath);
        WXLivePushConfigReflect.setPauseImg(BitmapFactory.decodeFile(str3), this.mLivePushConfig);
        ...
        WXLivePushConfigReflect.setEnableZoom(bool3, this.mLivePushConfig);
        ...
        String str4 = paramBundle.getString("watermarkImage", this.mWatermarkImage);
        setWaterMark(paramBundle, f1, f2, f3, BitmapFactory.decodeFile(str4));
        boolean bool4 = paramBundle.getBoolean("enableAGC", this.mEnableAgc);
        WXLivePushConfigReflect.enableAGC(bool4, this.mLivePushConfig);
        boolean bool5 = paramBundle.getBoolean("enableANS", this.mEnableAns);
        WXLivePushConfigReflect.enableANS(bool5, this.mLivePushConfig);
        boolean bool6 = paramBundle.getBoolean("enableEarMonitor", this.mEnableEarMonitor);
        WXLivePushConfigReflect.enableAudioEarMonitoring(bool6, this.mLivePushConfig);
        String str5 = paramBundle.getString("audioVolumeType", this.mAudioVolumeType);
        setAudioVolumeType(str5);
        ...
        if (!bool7)
        {
          ...
          i2 = paramBundle.getInt("focusMode", this.mFocusMode);
          if (i2 == 0) {
            break label710;
          }
        }
        ...
        for (boolean bool1 = true;; bool1 = false)
        {
          ...
          bool1 = setFrontCamera(paramBundle, this.mFrontCamera);
          ...
          this.mLocalMirror = str2;
          this.mAudioVolumeType = str5;
          this.mVideoWidth = m;
          this.mVideoHeight = n;
          this.mFrontCamera = bool1;
          this.mOrientation = paramBundle;
          this.mPauseAudio = bool2;
          this.mPauseImageFilePath = str3;
          this.mMinBitrate = i;
          this.mMaxBitrate = j;
          ...
          this.mWatermarkImage = str4;
          return needApplyConfig(k, i, j, i2, bool1, bool2, bool3, bool4, bool5, bool6, bool7, str2, m, n, f1, f2, f3, str5, str3, paramBundle, str1, str4);
          bool1 = false;
          break;
        }
        j = n;
