  ...
  implements View.OnClickListener
{
  ...
  {
    // Byte code:
    //   0: new 369	java/io/BufferedOutputStream
    //   3: dup
    //   4: new 371	java/io/FileOutputStream
    //   7: dup
    //   8: aload_1
    //   9: invokespecial 374	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   12: invokespecial 377	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   15: astore_1
    //   16: aload_0
    //   17: getstatic 383	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   20: bipush 100
    //   22: bipush 100
    //   24: invokestatic 389	java/lang/Math:min	(II)I
    //   27: aload_1
    //   28: invokevirtual 395	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   31: pop
    //   32: aload_1
    //   33: invokevirtual 398	java/io/BufferedOutputStream:flush	()V
    //   36: aload_1
    //   37: ifnull +7 -> 44
    //   40: aload_1
    //   41: invokevirtual 401	java/io/BufferedOutputStream:close	()V
    //   44: return
    //   45: astore_0
    //   46: aconst_null
    //   47: astore_1
    ...
    //   49: ifnull +7 -> 56
    //   52: aload_1
    //   53: invokevirtual 401	java/io/BufferedOutputStream:close	()V
    //   56: aload_0
    //   57: athrow
    //   58: astore_0
    //   59: return
