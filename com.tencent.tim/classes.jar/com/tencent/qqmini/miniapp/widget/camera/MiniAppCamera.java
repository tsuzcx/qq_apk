  ...
  extends GlCameraHolderSurfaceView
{
  ...
  private void nativeTakePhoto(String paramString, boolean paramBoolean, GetPhotoCallback paramGetPhotoCallback)
  {
    ...
    throws IOException
  {
    ...
    //   0: bipush 100
    //   2: istore_3
    //   3: new 343	java/io/BufferedOutputStream
    //   6: dup
    //   7: new 345	java/io/FileOutputStream
    //   10: dup
    //   11: aload_1
    //   12: invokespecial 348	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   15: invokespecial 351	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   18: astore 5
    //   20: ldc_w 353
    //   23: aload_2
    //   24: invokevirtual 357	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   27: ifeq +58 -> 85
    //   30: bipush 80
    //   32: istore_3
    //   33: aload_0
    //   34: getstatic 363	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   37: bipush 100
    //   39: iload_3
    //   40: invokestatic 369	java/lang/Math:min	(II)I
    //   43: aload 5
    //   45: invokevirtual 375	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   48: pop
    //   49: aload 5
    //   51: invokevirtual 378	java/io/BufferedOutputStream:flush	()V
    //   54: aload_1
    //   55: invokevirtual 383	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   58: aload_1
    //   59: invokevirtual 383	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   62: getstatic 55	com/tencent/qqmini/miniapp/widget/camera/MiniAppCamera:cameraWidth	I
    //   65: getstatic 57	com/tencent/qqmini/miniapp/widget/camera/MiniAppCamera:cameraHeight	I
    //   68: iload_3
    //   69: invokestatic 389	com/tencent/qqmini/sdk/core/utils/ImageUtil:compressImageJpg	(Ljava/lang/String;Ljava/lang/String;III)Ljava/lang/String;
    //   72: astore_0
    //   73: aload 5
    //   75: ifnull +8 -> 83
    //   78: aload 5
    //   80: invokevirtual 392	java/io/BufferedOutputStream:close	()V
    //   83: aload_0
    //   84: areturn
    //   85: ldc_w 394
    //   88: aload_2
    //   89: invokevirtual 357	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   92: istore 4
    //   94: iload 4
    //   96: ifeq -63 -> 33
    //   99: bipush 60
    ...
    //   109: ifnull +7 -> 116
    //   112: aload_1
    //   113: invokevirtual 392	java/io/BufferedOutputStream:close	()V
    //   116: aload_0
    //   117: athrow
    //   118: astore_1
    //   119: aload_0
  ...
  static abstract interface GetPhotoCallback
  {
    public abstract void onGetPhoto(String paramString);
  }
}
