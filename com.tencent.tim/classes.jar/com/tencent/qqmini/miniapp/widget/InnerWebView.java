  ...
  implements IJsService
{
  ...
  protected static boolean saveByteBufferToLocalFile(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   1: istore_2
    //   2: aload_1
    //   3: invokestatic 554	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifeq +5 -> 11
    //   9: iload_2
    //   10: ireturn
    //   11: aconst_null
    ...
    //   17: aload 5
    //   19: astore_3
    //   20: new 733	java/io/File
    //   23: dup
    //   24: aload_1
    //   25: invokespecial 734	java/io/File:<init>	(Ljava/lang/String;)V
    //   28: astore_1
    //   29: aload 5
    //   31: astore_3
    //   32: aload_1
    //   33: invokevirtual 737	java/io/File:exists	()Z
    //   36: ifne +11 -> 47
    //   39: aload 5
    //   41: astore_3
    //   42: aload_1
    //   43: invokevirtual 740	java/io/File:createNewFile	()Z
    //   46: pop
    //   47: aload 5
    //   49: astore_3
    //   50: new 742	java/io/FileOutputStream
    //   53: dup
    //   54: aload_1
    //   55: invokespecial 745	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   58: astore_1
    //   59: aload_1
    //   60: aload_0
    //   61: invokevirtual 749	java/io/FileOutputStream:write	([B)V
    //   64: iconst_1
    //   65: istore_2
    //   66: aload_1
    //   67: ifnull -58 -> 9
    //   70: aload_1
    //   71: invokevirtual 752	java/io/FileOutputStream:close	()V
    //   74: iconst_1
    //   75: ireturn
    //   76: astore_0
    //   77: ldc 76
    //   79: new 143	java/lang/StringBuilder
    //   82: dup
    ...
    //   92: aload_0
    //   93: invokevirtual 757	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   96: invokevirtual 173	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   99: invokestatic 286	com/tencent/qqmini/sdk/launcher/log/QMLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   102: iconst_1
    //   103: ireturn
    //   104: astore_1
    //   105: aload 4
    ...
    //   115: dup
    //   116: invokespecial 146	java/lang/StringBuilder:<init>	()V
    //   119: ldc_w 759
    //   122: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   125: aload_1
    //   126: invokevirtual 757	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   129: invokevirtual 173	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   132: invokestatic 286	com/tencent/qqmini/sdk/launcher/log/QMLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   135: aload_0
    //   136: ifnull -127 -> 9
    //   139: aload_0
    //   140: invokevirtual 752	java/io/FileOutputStream:close	()V
    //   143: iconst_0
    //   144: ireturn
    //   145: astore_0
    //   146: ldc 76
    //   148: new 143	java/lang/StringBuilder
    //   151: dup
    ...
    //   161: aload_0
    //   162: invokevirtual 757	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   165: invokevirtual 173	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   168: invokestatic 286	com/tencent/qqmini/sdk/launcher/log/QMLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   171: iconst_0
    //   172: ireturn
    //   173: astore_0
    //   174: aload_3
    //   175: ifnull +7 -> 182
    //   178: aload_3
    //   179: invokevirtual 752	java/io/FileOutputStream:close	()V
    //   182: aload_0
    //   183: athrow
    //   184: astore_1
    //   185: ldc 76
    //   187: new 143	java/lang/StringBuilder
    //   190: dup
    ...
    //   200: aload_1
    //   201: invokevirtual 757	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   204: invokevirtual 173	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   207: invokestatic 286	com/tencent/qqmini/sdk/launcher/log/QMLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   210: goto -28 -> 182
    //   213: astore_0
    //   214: aload_1
    //   215: astore_3
  ...
  public void init(IMiniAppContext paramIMiniAppContext)
  {
    ...
    this.webView = this;
    addJavascriptInterface(new QQJSCoreInterface(null), "QQJSCore");
    initWebChromeClient();
    initWebviewClient();
    setLongClickLisener();
  }
  ...
  class QQJSCoreInterface
  {
    ...
    public String invokeHandler(String paramString1, String paramString2, int paramInt)
    {
      ...
      if ("preVerifyJSAPI".equals(paramString1)) {
        InnerWebView.this.handleCallbackOK(paramString1, null, paramInt);
      }
      for (;;)
      {
        return "";
        if ("invokeMiniProgramAPI".equals(paramString1))
        {
          try
          {
            ...
            InnerWebView.this.mMiniAppContext.performAction(ServiceSubscribeEvent.obtain("onWebInvokeAppService", paramString2.toString(), 0));
            InnerWebView.this.handleCallbackOK(paramString1, null, paramInt);
          }
          catch (Exception paramString2)
          {
            InnerWebView.this.handleCallbackFail(paramString1, null, null, paramInt);
          }
          continue;
          label152:
          InnerWebView.this.handleCallbackFail(paramString1, null, null, paramInt);
        ...
        else if ("checkJsApi".equals(paramString1))
        {
          try
          {
            ...
            InnerWebView.this.handleCallbackOK(paramString1, paramString2, paramInt);
          }
          catch (Exception paramString2)
          {
            InnerWebView.this.handleCallbackFail(paramString1, null, null, paramInt);
        ...
        else if (InnerWebView.this.mMiniAppContext != null)
        {
          InnerWebView.this.mMiniAppContext.performAction(new InnerWebView.QQJSCoreInterface.1(this, paramString1, paramString2, paramInt));
        }
      }
    }
  }
