  ...
  implements Runnable
{
  ...
  public void run()
  {
    CoverView localCoverView = CoverViewAction.obtain(MediaJsPlugin.access$100(this.this$0)).get(this.val$videoPlayerId);
    Object localObject = localCoverView;
    if (localCoverView == null)
    {
      localObject = MediaJsPlugin.access$200(this.this$0).getAttachedActivity();
      if (localObject == null)
      {
        this.val$req.fail();
        return;
      ...
      ((CoverVideoView)localObject).setAtyRef(new WeakReference(MediaJsPlugin.access$300(this.this$0).getAttachedActivity()));
      ...
      ((CoverVideoView)localObject).setPageWebviewId(PageAction.obtain(MediaJsPlugin.access$400(this.this$0)).getPageId());
      ((CoverVideoView)localObject).setVideoPlayerId(this.val$videoPlayerId);
      CoverViewAction.obtain(MediaJsPlugin.access$500(this.this$0)).add(0, this.val$videoPlayerId, (CoverView)localObject);
      ((ObserverManager)MediaJsPlugin.access$600(this.this$0).getManager(ObserverManager.class)).addObserver(((CoverVideoView)localObject).getVideoPlayerStatusObserver());
    }
    if ((localObject instanceof CoverVideoView))
    {
      ((CoverVideoView)localObject).setMiniAppContext(MediaJsPlugin.access$700(this.this$0));
