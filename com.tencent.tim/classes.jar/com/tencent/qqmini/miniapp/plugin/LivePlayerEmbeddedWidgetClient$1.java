  ...
  implements TXLivePlayerJSAdapter.IPlayOuterListener
{
  ...
  public void onNetStatus(Bundle paramBundle)
  {
    try
    {
      ...
      LivePlayerEmbeddedWidgetClient.access$200(this.this$0).evaluateSubscribeJS("xWebLivePlayerStateChange", localJSONObject1.toString(), LivePlayerEmbeddedWidgetClient.access$100(this.this$0));
      LivePlayerEmbeddedWidgetClient.access$300(this.this$0).evaluateSubscribeJS("xWebLivePlayerStateChange", localJSONObject1.toString(), LivePlayerEmbeddedWidgetClient.access$100(this.this$0));
  ...
  public void onPlayEvent(int paramInt, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      LivePlayerEmbeddedWidgetClient.access$200(this.this$0).evaluateSubscribeJS("xWebLivePlayerStateChange", localJSONObject.toString(), LivePlayerEmbeddedWidgetClient.access$100(this.this$0));
      LivePlayerEmbeddedWidgetClient.access$300(this.this$0).evaluateSubscribeJS("xWebLivePlayerStateChange", localJSONObject.toString(), LivePlayerEmbeddedWidgetClient.access$100(this.this$0));
