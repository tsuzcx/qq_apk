...
{
  EmbeddedVideoJsPlugin$3(EmbeddedVideoJsPlugin paramEmbeddedVideoJsPlugin, RequestEvent paramRequestEvent) {}
  ...
  public Void perform(BaseRuntime paramBaseRuntime)
  {
    ...
    {
      AppBrandTask.runTaskOnUiThread(new EmbeddedVideoJsPlugin.3.1(this, paramBaseRuntime));
      return null;
    }
    this.val$req.fail();
    return null;
