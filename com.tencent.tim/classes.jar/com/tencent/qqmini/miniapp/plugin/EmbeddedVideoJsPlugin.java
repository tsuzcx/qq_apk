  ...
  extends BaseJsPlugin
{
  ...
  private void enterSmallScreenMode()
  {
    ...
    try
    {
      if (!localActivity.isFinishing())
      {
        ...
        this.mMiniAppContext.performAction(new EmbeddedVideoJsPlugin.4(this, localWeakReference));
      }
      return;
    }
  ...
  {
    return (EmbeddedWidgetClientFactory)this.mMiniAppContext.performAction(new EmbeddedVideoJsPlugin.5(this));
  }
  ...
  public void insertXwebVideo(RequestEvent paramRequestEvent)
  {
    ...
    IJsService localIJsService = (IJsService)this.mMiniAppContext.performAction(new EmbeddedVideoJsPlugin.1(this));
  ...
  {
    this.mMiniAppContext.performAction(new EmbeddedVideoJsPlugin.3(this, paramRequestEvent));
  }
