  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      LivePusherEmbeddedWidgetClient.access$600(this.val$bitmap, (File)localObject);
      ...
      LivePusherEmbeddedWidgetClient.access$700(this.this$1.this$0, this.this$1.val$callbackId, ((JSONObject)localObject).toString());
      return;
    }
    catch (Exception localException)
    {
      JSONObject localJSONObject1 = ApiUtil.wrapCallbackFail(this.this$1.val$eventName, new JSONObject());
      LivePusherEmbeddedWidgetClient.access$700(this.this$1.this$0, this.this$1.val$callbackId, localJSONObject1.toString());
    }
  }
}
