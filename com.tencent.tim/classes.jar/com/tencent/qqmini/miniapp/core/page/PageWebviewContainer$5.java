...
class PageWebviewContainer$5
  implements Runnable
{
  PageWebviewContainer$5(PageWebviewContainer paramPageWebviewContainer, boolean paramBoolean, NativeViewRequestEvent paramNativeViewRequestEvent) {}
  
  public void run()
  {
    boolean bool2 = true;
    Object localObject;
    if ((PageWebviewContainer.access$400(this.this$0)) && (PageWebviewContainer.access$300(this.this$0) != null) && (!PageWebviewContainer.access$300(this.this$0).isRefreshing()))
    {
