  ...
  extends FrameLayout
{
  ...
  private final List<IConfirmListerner> mConfirmListeners = new ArrayList();
  ...
  private boolean doInsertHTMLWebView(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    {
      paramInt3 = paramInt4 - (ViewUtils.dpToPx(44.0F) + DisplayUtil.getStatusBarHeight(getContext()));
      paramInt2 = paramInt3;
  ...
  public boolean addConfirmListener(IConfirmListerner paramIConfirmListerner)
  {
  ...
  public boolean removeConfirmListener(IConfirmListerner paramIConfirmListerner)
  {
    synchronized (this.mConfirmListeners)
    {
      if (this.mConfirmListeners.contains(paramIConfirmListerner))
  ...
  public static abstract interface IConfirmListerner
  {
