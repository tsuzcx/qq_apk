  ...
  extends BaseRuntimeLoader
{
  ...
  public BaseTask[] createTasks()
  {
    ...
    this.runtimeInitTask.addDependTask(this.preloadFlagTask.addDependTask(this.serviceInitTask.addDependTask(this.baselibLoadTask).addDependTask(this.runtimeCreateTask))).addDependTask(this.apkgLoadTask);
