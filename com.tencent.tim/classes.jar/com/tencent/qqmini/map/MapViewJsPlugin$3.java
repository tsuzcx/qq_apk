...
class MapViewJsPlugin$3
  implements Runnable
{
  MapViewJsPlugin$3(MapViewJsPlugin paramMapViewJsPlugin, RequestEvent paramRequestEvent) {}
  ...
  public void run()
  {
    try
    {
      ...
      {
        localMapContext.addMapPolyline(localJSONObject);
        this.val$req.ok();
        return;
      }
      this.val$req.fail();
 ...
 * Qualified Name:     com.tencent.qqmini.map.MapViewJsPlugin.3
