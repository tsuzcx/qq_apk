...
class MapViewJsPlugin$14
  implements Runnable
{
  MapViewJsPlugin$14(MapViewJsPlugin paramMapViewJsPlugin, RequestEvent paramRequestEvent) {}
  ...
  public void run()
  {
    try
    {
      ...
      {
        localMapContext.addMapControls(localJSONObject);
        this.val$req.ok();
        return;
      }
      this.val$req.fail();
 ...
 * Qualified Name:     com.tencent.qqmini.map.MapViewJsPlugin.14
