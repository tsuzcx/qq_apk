...
public class a
{
  ...
  {
    return a(paramContext, paramFile, 0);
  }
  
  public static int a(Context paramContext, File paramFile, int paramInt)
  {
    for (;;)
    {
      try
      {
        if (Build.VERSION.SDK_INT >= 20)
        {
          ...
          {
            bool = true;
            paramInt = a(paramContext, paramFile, bool, paramInt);
            return paramInt;
          }
          bool = false;
          continue;
  ...
  public static int a(Context paramContext, File paramFile, boolean paramBoolean, int paramInt)
  {
    if (paramFile != null) {}
    for (;;)
    {
      try
      {
        if (paramFile.exists())
        {
          ...
          if ((bool1) || (bool2))
          {
            paramInt = a(bool2, paramFile, paramInt);
            if (paramInt > 0) {
              return paramInt;
            }
          ...
          else
          {
            ...
            i = TbsPVConfig.getInstance(paramContext).getReadApk();
            if (i != 1) {
              continue;
            }
            paramInt = 0;
  ...
  private static int a(boolean paramBoolean, File paramFile, int paramInt)
  {
    try
    {
      ...
      if (paramFile != null)
      {
        ...
        Pattern localPattern = Pattern.compile(a(paramBoolean, paramInt) + "(.*)");
        ...
        while (paramInt < i)
        {
          ...
          {
            paramInt = Integer.parseInt(localObject.getName().substring(localObject.getName().lastIndexOf(".") + 1));
            return paramInt;
          }
          paramInt += 1;
        }
  ...
  public static String a(File paramFile)
  {
    ...
    //   105: astore 7
    //   107: ldc 214
    //   109: invokestatic 219	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   112: astore 8
    //   114: new 221	java/io/FileInputStream
    //   117: dup
    //   118: aload_0
    //   119: invokespecial 224	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   122: astore 5
    //   124: aload 5
    //   126: astore_0
    //   127: sipush 8192
    ...
    //   137: aload 5
    //   139: aload 9
    //   141: invokevirtual 228	java/io/FileInputStream:read	([B)I
    //   144: istore_2
    //   145: iload_2
    //   146: iconst_m1
    ...
    //   157: iconst_0
    //   158: iload_2
    //   159: invokevirtual 232	java/security/MessageDigest:update	([BII)V
    //   162: goto -28 -> 134
    //   165: astore 6
    //   167: aload 5
    //   169: astore_0
    //   170: aload 6
    //   172: invokevirtual 233	java/lang/Exception:printStackTrace	()V
    //   175: aload 5
    //   177: ifnull +8 -> 185
    //   180: aload 5
    //   182: invokevirtual 236	java/io/FileInputStream:close	()V
    //   185: aconst_null
    //   186: astore_0
    //   187: aload_0
    //   188: areturn
    ...
    //   191: astore_0
    //   192: aload 8
    //   194: invokevirtual 240	java/security/MessageDigest:digest	()[B
    //   197: astore 8
    //   199: iconst_0
    //   200: istore_2
    //   201: goto +85 -> 286
    //   204: aload 5
    //   206: astore_0
    //   207: new 63	java/lang/String
    //   210: dup
    //   211: aload 7
    //   213: invokespecial 243	java/lang/String:<init>	([C)V
    //   216: astore 6
    //   218: aload 6
    //   220: astore_0
    //   221: aload 5
    //   223: ifnull -36 -> 187
    //   226: aload 5
    //   228: invokevirtual 236	java/io/FileInputStream:close	()V
    //   231: aload 6
    //   233: areturn
    //   234: astore_0
    //   235: aload_0
    //   236: invokevirtual 244	java/io/IOException:printStackTrace	()V
    //   239: aload 6
    //   241: areturn
    //   242: astore_0
    //   243: aload_0
    //   244: invokevirtual 244	java/io/IOException:printStackTrace	()V
    //   247: goto -62 -> 185
    //   250: astore 5
    //   252: aconst_null
    //   253: astore_0
    ...
    //   255: ifnull +7 -> 262
    //   258: aload_0
    //   259: invokevirtual 236	java/io/FileInputStream:close	()V
    //   262: aload 5
    //   264: athrow
    //   265: astore_0
    //   266: aload_0
    //   267: invokevirtual 244	java/io/IOException:printStackTrace	()V
    //   270: goto -8 -> 262
    //   273: astore 5
    //   275: goto -21 -> 254
    //   278: astore 6
  ...
  public static int b(File paramFile)
  {
    ...
    //   1: astore_2
    //   2: ldc_w 294
    //   5: new 147	java/lang/StringBuilder
    //   8: dup
    //   9: invokespecial 148	java/lang/StringBuilder:<init>	()V
    //   12: ldc_w 296
    //   15: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   18: aload_0
    //   19: invokevirtual 299	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   22: ldc_w 301
    //   25: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   28: aload_0
    //   29: invokevirtual 55	java/io/File:exists	()Z
    //   32: invokevirtual 304	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   35: ldc_w 306
    //   38: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   41: aload_0
    //   42: invokevirtual 309	java/io/File:canRead	()Z
    //   45: invokevirtual 304	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   48: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   51: invokestatic 47	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   54: ldc 2
    //   56: monitorenter
    //   57: new 311	java/util/jar/JarFile
    //   60: dup
    //   61: aload_0
    //   62: invokespecial 312	java/util/jar/JarFile:<init>	(Ljava/io/File;)V
    //   65: astore_3
    //   66: new 314	java/io/BufferedReader
    //   69: dup
    //   70: new 316	java/io/InputStreamReader
    //   73: dup
    //   74: aload_3
    //   75: aload_3
    //   76: ldc_w 318
    //   79: invokevirtual 322	java/util/jar/JarFile:getJarEntry	(Ljava/lang/String;)Ljava/util/jar/JarEntry;
    //   82: invokevirtual 326	java/util/jar/JarFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   85: invokespecial 329	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   88: invokespecial 332	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   91: astore_0
    //   92: aload_0
    //   93: invokevirtual 335	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   96: astore_2
    //   97: aload_2
    //   98: ifnull +90 -> 188
    //   101: aload_2
    //   102: ldc_w 337
    //   105: invokevirtual 67	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   108: ifeq -16 -> 92
    //   111: aload_2
    //   112: ldc_w 339
    //   115: invokevirtual 343	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   118: astore_2
    //   119: aload_2
    //   120: ifnull -28 -> 92
    //   123: aload_2
    ...
    //   130: iconst_1
    //   131: aaload
    //   132: invokevirtual 346	java/lang/String:trim	()Ljava/lang/String;
    //   135: astore_2
    //   136: ldc_w 294
    //   139: new 147	java/lang/StringBuilder
    //   142: dup
    //   143: invokespecial 148	java/lang/StringBuilder:<init>	()V
    //   146: ldc_w 348
    //   149: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   152: aload_2
    ...
    //   159: invokestatic 47	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   162: aload_2
    //   163: invokestatic 193	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   166: istore_1
    //   167: aload_0
    //   168: ifnull +7 -> 175
    //   171: aload_0
    ...
    //   176: ifnull +7 -> 183
    //   179: aload_3
    //   180: invokevirtual 350	java/util/jar/JarFile:close	()V
    //   183: ldc 2
    //   185: monitorexit
    //   186: iload_1
    //   187: ireturn
    ...
    //   189: ifnull +7 -> 196
    //   192: aload_0
    //   193: invokevirtual 349	java/io/BufferedReader:close	()V
    //   196: aload_3
    //   197: ifnull +7 -> 204
    //   200: aload_3
    //   201: invokevirtual 350	java/util/jar/JarFile:close	()V
    //   204: ldc 2
    //   206: monitorexit
    //   207: iconst_m1
    //   208: ireturn
    ...
    //   217: astore_0
    //   218: aload_3
    //   219: invokestatic 353	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/Throwable;)V
    //   222: aload_0
    //   223: ifnull +7 -> 230
    //   226: aload_0
    //   227: invokevirtual 349	java/io/BufferedReader:close	()V
    //   230: aload_2
    //   231: ifnull -27 -> 204
    //   234: aload_2
    //   235: invokevirtual 350	java/util/jar/JarFile:close	()V
    //   238: goto -34 -> 204
    //   241: astore_0
    //   242: goto -38 -> 204
    //   245: astore_2
    ...
    //   251: ifnull +7 -> 258
    //   254: aload_0
    //   255: invokevirtual 349	java/io/BufferedReader:close	()V
    //   258: aload_3
    //   259: ifnull +7 -> 266
    //   262: aload_3
    //   263: invokevirtual 350	java/util/jar/JarFile:close	()V
    //   266: aload_2
    //   267: athrow
    //   268: astore_0
    //   269: goto -3 -> 266
