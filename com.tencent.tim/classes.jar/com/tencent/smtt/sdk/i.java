  ...
  extends X5ProxyWebChromeClient
{
  ...
  public boolean onCreateWindow(IX5WebViewBase paramIX5WebViewBase, boolean paramBoolean1, boolean paramBoolean2, Message paramMessage)
  {
    ...
    paramMessage = Message.obtain(paramMessage.getTarget(), new i.1(this, paramIX5WebViewBase, paramMessage));
  ...
  {
    paramValueCallback = new i.3(this, paramValueCallback);
    paramFileChooserParams = new i.4(this, paramFileChooserParams);
    this.a.a(paramIX5WebViewBase);
  ...
  {
    this.b.openFileChooser(new i.2(this, paramValueCallback), paramString1, paramString2);
  }
