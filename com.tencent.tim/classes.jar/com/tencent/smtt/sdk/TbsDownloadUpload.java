...
public class TbsDownloadUpload
{
  ...
  public void writeTbsDownloadInfo()
  {
    ...
    //   146: astore_1
    //   147: aload_0
    //   148: getfield 33	com/tencent/smtt/sdk/TbsDownloadUpload:a	Ljava/util/Map;
    //   151: aload_1
    //   152: invokeinterface 218 2 0
    //   157: astore 8
    //   159: aload 5
    //   161: aload_1
    //   162: new 220	java/lang/StringBuilder
    //   165: dup
    //   166: invokespecial 221	java/lang/StringBuilder:<init>	()V
    //   169: ldc 162
    //   171: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   174: aload 8
    //   176: invokevirtual 228	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   179: invokevirtual 232	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   182: invokevirtual 236	java/util/Properties:setProperty	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;
    //   185: pop
    //   186: ldc 188
    //   188: new 220	java/lang/StringBuilder
    //   191: dup
    //   192: invokespecial 221	java/lang/StringBuilder:<init>	()V
    //   195: ldc 238
    //   197: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   200: aload_1
    //   201: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   204: ldc 240
    //   206: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   209: aload 8
    //   211: invokevirtual 228	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   214: invokevirtual 232	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   217: invokestatic 195	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   220: goto -94 -> 126
    //   223: astore_3
    //   224: aload_2
    //   225: astore_1
    ...
    //   228: astore_2
    //   229: aload_3
    //   230: invokevirtual 186	java/lang/Throwable:printStackTrace	()V
    //   233: aload_1
    //   234: ifnull +7 -> 241
    //   237: aload_1
    //   238: invokevirtual 185	java/io/BufferedInputStream:close	()V
    //   241: aload_2
    //   242: ifnull -188 -> 54
    //   245: aload_2
    //   246: invokevirtual 243	java/io/BufferedOutputStream:close	()V
    //   249: goto -195 -> 54
    //   252: astore_1
    //   253: aload_1
    //   254: invokevirtual 144	java/lang/Exception:printStackTrace	()V
    //   257: goto -203 -> 54
    //   260: aload_0
    //   261: getfield 33	com/tencent/smtt/sdk/TbsDownloadUpload:a	Ljava/util/Map;
    //   264: invokeinterface 245 1 0
    //   269: new 242	java/io/BufferedOutputStream
    //   272: dup
    //   273: new 247	java/io/FileOutputStream
    //   276: dup
    //   277: aload 6
    //   279: invokespecial 248	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   282: invokespecial 251	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   285: astore_1
    //   286: aload 5
    //   288: aload_1
    //   289: aconst_null
    //   290: invokevirtual 255	java/util/Properties:store	(Ljava/io/OutputStream;Ljava/lang/String;)V
    //   293: aload_2
    //   294: ifnull +7 -> 301
    //   297: aload_2
    //   298: invokevirtual 185	java/io/BufferedInputStream:close	()V
    //   301: aload_1
    //   302: ifnull -248 -> 54
    //   305: aload_1
    //   306: invokevirtual 243	java/io/BufferedOutputStream:close	()V
    //   309: goto -255 -> 54
    //   312: astore_1
    //   313: aload_1
    //   314: invokevirtual 144	java/lang/Exception:printStackTrace	()V
    //   317: goto -263 -> 54
    //   320: astore_2
    //   321: aload_2
    //   322: invokevirtual 144	java/lang/Exception:printStackTrace	()V
    //   325: goto -24 -> 301
    //   328: astore_1
    //   329: aload_1
    //   330: invokevirtual 144	java/lang/Exception:printStackTrace	()V
    //   333: goto -92 -> 241
    //   336: astore_1
    //   337: aconst_null
    //   338: astore_2
    ...
    //   340: ifnull +7 -> 347
    //   343: aload_2
    //   344: invokevirtual 185	java/io/BufferedInputStream:close	()V
    //   347: aload_3
    //   348: ifnull +7 -> 355
    //   351: aload_3
    //   352: invokevirtual 243	java/io/BufferedOutputStream:close	()V
    //   355: aload_1
    //   356: athrow
    //   357: astore_2
    //   358: aload_2
    //   359: invokevirtual 144	java/lang/Exception:printStackTrace	()V
    //   362: goto -15 -> 347
    //   365: astore_2
    //   366: aload_2
    //   367: invokevirtual 144	java/lang/Exception:printStackTrace	()V
    //   370: goto -15 -> 355
    //   373: astore_1
    //   374: goto -35 -> 339
    //   377: astore 4
