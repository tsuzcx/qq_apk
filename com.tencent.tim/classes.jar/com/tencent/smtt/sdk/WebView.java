  ...
  implements View.OnLongClickListener
{
  ...
  private final String x = "javascript:document.getElementsByTagName('HEAD').item(0).removeChild(document.getElementById('QQBrowserSDKNightMode'));";
  private final String y = "javascript:var style = document.createElement('style');style.type='text/css';style.id='QQBrowserSDKNightMode';style.innerHTML='html,body{background:none !important;background-color: #1d1e2a !important;}html *{background-color: #1d1e2a !important; color:#888888 !important;border-color:#3e4f61 !important;text-shadow:none !important;box-shadow:none !important;}a,a *{border-color:#4c5b99 !important; color:#2d69b3 !important;text-decoration:none !important;}a:visited,a:visited *{color:#a600a6 !important;}a:active,a:active *{color:#5588AA !important;}input,select,textarea,option,button{background-image:none !important;color:#AAAAAA !important;border-color:#4c5b99 !important;}form,div,button,span{background-color:#1d1e2a !important; border-color:#4c5b99 !important;}img{opacity:0.5}';document.getElementsByTagName('HEAD').item(0).appendChild(style);";
  ...
  public WebView(Context paramContext, AttributeSet paramAttributeSet, int paramInt, Map<String, Object> paramMap, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if ((this.e) && (!QbSdk.a))
      {
        ...
        this.f = y.a().a(true).a(paramContext);
        ...
        if (TbsShareManager.isThirdPartyApp(paramContext)) {
          com.tencent.smtt.utils.q.a(paramContext, "x5_webview_ok", "" + QbSdk.getTbsVersion(paramContext));
        }
        com.tencent.smtt.utils.q.a("20");
        ...
        this.f.getX5WebViewExtension().setWebViewClientExtension(new WebView.1(this, y.a().a(true).k()));
      }
      try
      {
        if (Build.VERSION.SDK_INT >= 11)
        ...
        if ((("com.tencent.mobileqq".equals(this.i.getApplicationInfo().packageName)) || ("com.tencent.mm".equals(this.i.getApplicationInfo().packageName))) && (g.a(true).g()) && (Build.VERSION.SDK_INT >= 11)) {
          setLayerType(1, null);
        }
        if (this.f != null)
        {
        ...
        for (this.g = new b(paramContext, paramAttributeSet);; this.g = new b(paramContext))
        {
          ...
          if (TbsShareManager.isThirdPartyApp(paramContext)) {
            com.tencent.smtt.utils.q.a(paramContext, "x5_webview_fail", "");
          }
          CookieManager.getInstance().a(paramContext, true, false);
          CookieManager.getInstance().a();
          this.g.setFocusableInTouchMode(true);
  ...
  {
    com.tencent.smtt.utils.q.b("old03");
    Object localObject4;
    Object localObject1;
    Object localObject7;
    Object localObject6;
    ...
    if ((!this.k) && (this.a != 0))
    {
      com.tencent.smtt.utils.q.b("old04");
      this.k = true;
      localObject4 = "";
      ??? = "";
      localObject1 = "";
      ...
      if (this.e)
      {
        com.tencent.smtt.utils.q.b("old05");
        ...
        com.tencent.smtt.utils.q.b("old06");
        localObject5 = localObject4;
        localObject6 = ???;
        localObject7 = localObject1;
      }
    ...
    try
    {
      com.tencent.smtt.utils.q.b("old07");
      bool = this.f.getX5WebViewExtension().isX5CoreSandboxMode();
      com.tencent.smtt.utils.q.b("old08");
      com.tencent.smtt.sdk.stat.b.a(this.i, (String)localObject5, localObject6, localObject7, this.a, this.e, j(), bool);
      com.tencent.smtt.utils.q.b("old09");
      this.a = 0;
      this.k = false;
      com.tencent.smtt.utils.q.b("old10");
      if (!this.e) {}
      try
      {
        com.tencent.smtt.utils.q.b("old11");
      ...
      com.tencent.smtt.utils.q.b("old14");
      if (paramBoolean) {
        this.g.destroy();
      }
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        {
          boolean bool;
          com.tencent.smtt.utils.q.b("old15");
          TbsLog.i("sdkreport", "webview.tbsWebviewDestroy mQQMusicCrashFix is " + this.p);
          paramBoolean = this.p;
          if (paramBoolean)
          {
            return;
          ...
          {
            com.tencent.smtt.utils.q.b("old16");
            ((Field)???).set(null, null);
        ...
        synchronized ((List)???)
        {
          ...
          com.tencent.smtt.utils.q.b("old17");
          TbsLog.i("WebView", "X5 GUID = " + QbSdk.b());
          return;
        }
        com.tencent.smtt.utils.q.b("old18");
        if (paramBoolean) {
          this.f.destroy();
        }
        com.tencent.smtt.utils.q.b("old19");
      }
    }
  }
  ...
  private boolean a(View paramView)
  {
    ...
    paramView = com.tencent.smtt.utils.i.a(this.B, "onLongClick", new Class[] { View.class }, new Object[] { paramView });
    if (paramView != null) {
  ...
  private int e(Context paramContext)
  {
    ...
    //   1: iconst_1
    //   2: ldc_w 861
    //   5: invokestatic 866	com/tencent/smtt/utils/FileUtil:b	(Landroid/content/Context;ZLjava/lang/String;)Ljava/io/FileOutputStream;
    //   8: astore 7
    //   10: aload 7
    //   12: ifnull +16 -> 28
    //   15: aload_1
    //   16: aload 7
    //   18: invokestatic 869	com/tencent/smtt/utils/FileUtil:a	(Landroid/content/Context;Ljava/io/FileOutputStream;)Ljava/nio/channels/FileLock;
    //   21: astore 6
    //   23: aload 6
    //   25: ifnonnull +5 -> 30
    //   28: iconst_m1
    //   29: ireturn
    //   30: getstatic 96	com/tencent/smtt/sdk/WebView:c	Ljava/util/concurrent/locks/Lock;
    //   33: invokeinterface 874 1 0
    //   38: ifeq +472 -> 510
    //   41: aconst_null
    //   42: astore 5
    //   44: aload_1
    //   45: invokestatic 878	com/tencent/smtt/sdk/QbSdk:getTbsFolderDir	(Landroid/content/Context;)Ljava/io/File;
    //   48: astore_1
    //   49: new 880	java/io/File
    //   52: dup
    //   53: new 415	java/lang/StringBuilder
    //   56: dup
    //   57: invokespecial 416	java/lang/StringBuilder:<init>	()V
    //   60: aload_1
    //   61: invokevirtual 737	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   64: getstatic 883	java/io/File:separator	Ljava/lang/String;
    //   67: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   70: ldc_w 885
    //   73: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   76: invokevirtual 433	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   79: ldc_w 887
    //   82: invokespecial 889	java/io/File:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   85: astore_1
    //   86: aload_1
    //   87: ifnull +12 -> 99
    //   90: aload_1
    //   91: invokevirtual 892	java/io/File:exists	()Z
    //   94: istore_3
    //   95: iload_3
    //   96: ifne +65 -> 161
    //   99: iconst_0
    //   100: ifeq +11 -> 111
    //   103: new 894	java/lang/NullPointerException
    //   106: dup
    //   107: invokespecial 895	java/lang/NullPointerException:<init>	()V
    //   110: athrow
    //   111: getstatic 96	com/tencent/smtt/sdk/WebView:c	Ljava/util/concurrent/locks/Lock;
    //   114: invokeinterface 898 1 0
    //   119: aload 6
    //   121: aload 7
    //   123: invokestatic 901	com/tencent/smtt/utils/FileUtil:a	(Ljava/nio/channels/FileLock;Ljava/io/FileOutputStream;)V
    //   126: iconst_m1
    //   127: ireturn
    //   128: astore_1
    //   129: ldc_w 903
    //   132: new 415	java/lang/StringBuilder
    //   135: dup
    //   136: invokespecial 416	java/lang/StringBuilder:<init>	()V
    //   139: ldc_w 905
    //   142: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   145: aload_1
    //   146: invokevirtual 906	java/io/IOException:toString	()Ljava/lang/String;
    //   149: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   152: invokevirtual 433	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   155: invokestatic 834	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   158: goto -47 -> 111
    //   161: new 908	java/util/Properties
    //   164: dup
    //   165: invokespecial 909	java/util/Properties:<init>	()V
    //   168: astore 8
    //   170: new 911	java/io/FileInputStream
    //   173: dup
    //   174: aload_1
    //   175: invokespecial 914	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   178: astore 4
    //   180: aload 4
    //   182: astore_1
    //   183: aload 8
    //   185: aload 4
    //   187: invokevirtual 918	java/util/Properties:load	(Ljava/io/InputStream;)V
    //   190: aload 4
    //   192: astore_1
    //   193: aload 4
    //   195: invokevirtual 921	java/io/FileInputStream:close	()V
    //   198: aload 4
    //   200: astore_1
    //   201: aload 8
    //   203: ldc_w 923
    //   206: invokevirtual 926	java/util/Properties:getProperty	(Ljava/lang/String;)Ljava/lang/String;
    //   209: astore 5
    //   211: aload 5
    ...
    //   218: ifnull +8 -> 226
    //   221: aload 4
    //   223: invokevirtual 921	java/io/FileInputStream:close	()V
    //   226: getstatic 96	com/tencent/smtt/sdk/WebView:c	Ljava/util/concurrent/locks/Lock;
    //   229: invokeinterface 898 1 0
    //   234: aload 6
    //   236: aload 7
    //   238: invokestatic 901	com/tencent/smtt/utils/FileUtil:a	(Ljava/nio/channels/FileLock;Ljava/io/FileOutputStream;)V
    //   241: iconst_m1
    //   242: ireturn
    //   243: astore_1
    //   244: ldc_w 903
    //   247: new 415	java/lang/StringBuilder
    //   250: dup
    //   251: invokespecial 416	java/lang/StringBuilder:<init>	()V
    //   254: ldc_w 905
    //   257: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   260: aload_1
    //   261: invokevirtual 906	java/io/IOException:toString	()Ljava/lang/String;
    //   264: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   267: invokevirtual 433	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   270: invokestatic 834	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   273: goto -47 -> 226
    //   276: aload 4
    //   278: astore_1
    //   279: aload 5
    //   281: invokestatic 929	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   284: istore_2
    //   285: aload 4
    //   287: ifnull +8 -> 295
    //   290: aload 4
    //   292: invokevirtual 921	java/io/FileInputStream:close	()V
    //   295: getstatic 96	com/tencent/smtt/sdk/WebView:c	Ljava/util/concurrent/locks/Lock;
    //   298: invokeinterface 898 1 0
    //   303: aload 6
    //   305: aload 7
    //   307: invokestatic 901	com/tencent/smtt/utils/FileUtil:a	(Ljava/nio/channels/FileLock;Ljava/io/FileOutputStream;)V
    //   310: iload_2
    //   311: ireturn
    //   312: astore_1
    //   313: ldc_w 903
    //   316: new 415	java/lang/StringBuilder
    //   319: dup
    //   320: invokespecial 416	java/lang/StringBuilder:<init>	()V
    //   323: ldc_w 905
    //   326: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   329: aload_1
    //   330: invokevirtual 906	java/io/IOException:toString	()Ljava/lang/String;
    //   333: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   336: invokevirtual 433	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   339: invokestatic 834	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   342: goto -47 -> 295
    //   345: astore 5
    //   347: aconst_null
    //   348: astore 4
    ...
    //   352: astore_1
    //   353: ldc_w 903
    //   356: new 415	java/lang/StringBuilder
    //   359: dup
    //   360: invokespecial 416	java/lang/StringBuilder:<init>	()V
    //   363: ldc_w 931
    //   366: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   369: aload 5
    //   371: invokevirtual 932	java/lang/Exception:toString	()Ljava/lang/String;
    //   374: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   377: invokevirtual 433	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   380: invokestatic 834	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   383: aload 4
    //   385: ifnull +8 -> 393
    //   388: aload 4
    //   390: invokevirtual 921	java/io/FileInputStream:close	()V
    //   393: getstatic 96	com/tencent/smtt/sdk/WebView:c	Ljava/util/concurrent/locks/Lock;
    //   396: invokeinterface 898 1 0
    //   401: aload 6
    //   403: aload 7
    //   405: invokestatic 901	com/tencent/smtt/utils/FileUtil:a	(Ljava/nio/channels/FileLock;Ljava/io/FileOutputStream;)V
    //   408: iconst_m1
    //   409: ireturn
    //   410: astore_1
    //   411: ldc_w 903
    //   414: new 415	java/lang/StringBuilder
    //   417: dup
    //   418: invokespecial 416	java/lang/StringBuilder:<init>	()V
    //   421: ldc_w 905
    //   424: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   427: aload_1
    //   428: invokevirtual 906	java/io/IOException:toString	()Ljava/lang/String;
    //   431: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   434: invokevirtual 433	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   437: invokestatic 834	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   440: goto -47 -> 393
    //   443: astore_1
    //   444: aload 5
    //   446: astore 4
    ...
    //   450: ifnull +8 -> 458
    //   453: aload 4
    //   455: invokevirtual 921	java/io/FileInputStream:close	()V
    //   458: getstatic 96	com/tencent/smtt/sdk/WebView:c	Ljava/util/concurrent/locks/Lock;
    //   461: invokeinterface 898 1 0
    //   466: aload 6
    //   468: aload 7
    //   470: invokestatic 901	com/tencent/smtt/utils/FileUtil:a	(Ljava/nio/channels/FileLock;Ljava/io/FileOutputStream;)V
    //   473: aload_1
    //   474: athrow
    //   475: astore 4
    //   477: ldc_w 903
    //   480: new 415	java/lang/StringBuilder
    //   483: dup
    //   484: invokespecial 416	java/lang/StringBuilder:<init>	()V
    //   487: ldc_w 905
    //   490: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   493: aload 4
    //   495: invokevirtual 906	java/io/IOException:toString	()Ljava/lang/String;
    //   498: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   501: invokevirtual 433	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   504: invokestatic 834	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   507: goto -49 -> 458
    //   510: aload 6
    //   512: aload 7
    //   514: invokestatic 901	com/tencent/smtt/utils/FileUtil:a	(Ljava/nio/channels/FileLock;Ljava/io/FileOutputStream;)V
    //   517: iconst_m1
    //   518: ireturn
    //   519: astore 5
    //   521: aload_1
  ...
  public static String getCrashExtraMessage(Context paramContext)
  {
    ...
    String str = "tbs_core_version:" + QbSdk.getTbsVersionForCrash(paramContext) + ";" + "tbs_sdk_version:" + 44090 + ";";
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        localStringBuilder.append(g.a(true).d());
  ...
  public static Object getPluginList()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: invokestatic 362	com/tencent/smtt/sdk/y:a	()Lcom/tencent/smtt/sdk/y;
    //   6: invokevirtual 574	com/tencent/smtt/sdk/y:b	()Z
    //   9: ifne +18 -> 27
    //   12: ldc_w 853
    //   15: ldc_w 995
    //   18: invokestatic 857	com/tencent/smtt/utils/i:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;
    //   21: astore_0
    //   22: ldc 2
    //   24: monitorexit
    //   25: aload_0
  ...
  private void h()
  {
    ...
    //   2: monitorenter
    //   3: ldc_w 1003
    //   6: invokestatic 624	com/tencent/smtt/utils/q:b	(Ljava/lang/String;)V
    //   9: aload_0
    //   10: getfield 152	com/tencent/smtt/sdk/WebView:k	Z
    //   13: ifne +14 -> 27
    //   16: aload_0
    //   17: getfield 150	com/tencent/smtt/sdk/WebView:a	I
    //   20: ifeq +7 -> 27
    //   23: aload_0
    //   24: invokespecial 1005	com/tencent/smtt/sdk/WebView:k	()V
    //   27: ldc_w 1007
    //   30: invokestatic 624	com/tencent/smtt/utils/q:b	(Ljava/lang/String;)V
    //   33: ldc 2
    //   35: monitorexit
    //   36: aload_0
    //   37: getfield 144	com/tencent/smtt/sdk/WebView:e	Z
    //   40: ifne +175 -> 215
    //   43: ldc_w 1009
    //   46: invokestatic 624	com/tencent/smtt/utils/q:b	(Ljava/lang/String;)V
    //   49: aload_0
    //   50: getfield 219	com/tencent/smtt/sdk/WebView:g	Lcom/tencent/smtt/sdk/WebView$b;
    //   53: invokevirtual 721	android/webkit/WebView:destroy	()V
    //   56: ldc_w 1011
    //   59: invokestatic 624	com/tencent/smtt/utils/q:b	(Ljava/lang/String;)V
    //   62: ldc_w 725
    //   65: new 415	java/lang/StringBuilder
    //   68: dup
    //   69: invokespecial 416	java/lang/StringBuilder:<init>	()V
    //   72: ldc_w 1013
    //   75: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   78: aload_0
    //   79: getfield 158	com/tencent/smtt/sdk/WebView:p	Z
    //   82: invokevirtual 730	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   85: invokevirtual 433	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   88: invokestatic 307	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   91: aload_0
    //   92: getfield 158	com/tencent/smtt/sdk/WebView:p	Z
    //   95: istore_1
    //   96: iload_1
    //   97: ifeq +10 -> 107
    //   100: return
    ...
    //   106: athrow
    //   107: ldc_w 741
    //   110: invokestatic 245	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   113: ldc_w 743
    //   116: invokevirtual 686	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   119: astore_3
    //   120: aload_3
    //   121: iconst_1
    //   122: invokevirtual 689	java/lang/reflect/Field:setAccessible	(Z)V
    //   125: aload_3
    //   126: aconst_null
    //   127: invokevirtual 693	java/lang/reflect/Field:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   130: checkcast 745	android/content/ComponentCallbacks
    //   133: astore_2
    //   134: ldc_w 1015
    //   137: invokestatic 624	com/tencent/smtt/utils/q:b	(Ljava/lang/String;)V
    //   140: aload_2
    //   141: ifnull +54 -> 195
    //   144: aload_3
    //   145: aconst_null
    //   146: aconst_null
    //   147: invokevirtual 751	java/lang/reflect/Field:set	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   150: ldc_w 753
    //   153: invokestatic 245	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   156: ldc_w 755
    //   159: invokevirtual 686	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   162: astore_3
    //   163: aload_3
    //   164: iconst_1
    //   165: invokevirtual 689	java/lang/reflect/Field:setAccessible	(Z)V
    //   168: aload_3
    //   169: aconst_null
    //   170: invokevirtual 693	java/lang/reflect/Field:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   173: astore_3
    //   174: aload_3
    //   175: ifnull +20 -> 195
    //   178: aload_3
    //   179: checkcast 757	java/util/List
    //   182: astore_3
    //   183: aload_3
    //   184: monitorenter
    //   185: aload_3
    ...
    //   194: monitorexit
    //   195: ldc_w 1017
    //   198: invokestatic 624	com/tencent/smtt/utils/q:b	(Ljava/lang/String;)V
    //   201: return
    //   202: astore_2
    //   203: ldc_w 1019
    //   206: invokestatic 624	com/tencent/smtt/utils/q:b	(Ljava/lang/String;)V
    //   209: return
    //   210: astore_2
    //   211: aload_3
    //   212: monitorexit
    ...
    //   214: athrow
    //   215: ldc_w 1021
    //   218: invokestatic 624	com/tencent/smtt/utils/q:b	(Ljava/lang/String;)V
    //   221: aload_0
    //   222: getfield 209	com/tencent/smtt/sdk/WebView:f	Lcom/tencent/smtt/export/external/interfaces/IX5WebViewBase;
    //   225: invokeinterface 769 1 0
    //   230: ldc_w 1023
    //   233: invokestatic 624	com/tencent/smtt/utils/q:b	(Ljava/lang/String;)V
    //   236: return
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  private void i()
  {
    try
    {
      com.tencent.smtt.utils.q.b("old01");
    ...
    {
      com.tencent.smtt.utils.q.b("old30");
      a(true);
      return;
    }
    com.tencent.smtt.utils.q.b("old02");
    a(true);
  }
  ...
  private void k()
  {
    new Thread(new WebView.8(this)).start();
  }
  ...
  public static void setSysDayOrNight(boolean paramBoolean)
  {
    for (;;)
    {
      try
      {
        ...
        if (!paramBoolean)
        {
          if (z.getAlpha() == NIGHT_MODE_ALPHA) {
            continue;
          }
          z.setAlpha(NIGHT_MODE_ALPHA);
          continue;
        }
        if (z.getAlpha() == 255) {
          continue;
      ...
      if (Build.VERSION.SDK_INT >= 19) {
        try
        {
          ...
          if (q != null)
          {
            ...
            q.invoke(null, new Object[] { Boolean.valueOf(paramBoolean) });
            return;
          }
        }
        catch (Exception localException)
  ...
  void a(Context paramContext)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: invokespecial 558	com/tencent/smtt/sdk/WebView:e	(Landroid/content/Context;)I
    //   5: istore_2
    //   6: iload_2
    //   7: iconst_m1
    //   8: if_icmpeq +76 -> 84
    //   11: new 415	java/lang/StringBuilder
    //   14: dup
    //   15: invokespecial 416	java/lang/StringBuilder:<init>	()V
    //   18: ldc_w 1122
    //   21: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   24: iload_2
    //   25: iconst_1
    //   26: iadd
    //   27: invokestatic 1124	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   30: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   33: invokevirtual 433	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   36: astore_3
    //   37: aload_1
    //   38: invokestatic 878	com/tencent/smtt/sdk/QbSdk:getTbsFolderDir	(Landroid/content/Context;)Ljava/io/File;
    //   41: astore_1
    //   42: new 880	java/io/File
    //   45: dup
    //   46: new 415	java/lang/StringBuilder
    //   49: dup
    //   50: invokespecial 416	java/lang/StringBuilder:<init>	()V
    //   53: aload_1
    //   54: invokevirtual 737	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   57: getstatic 883	java/io/File:separator	Ljava/lang/String;
    //   60: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   63: ldc_w 885
    //   66: invokevirtual 422	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   69: invokevirtual 433	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   72: ldc_w 887
    //   75: invokespecial 889	java/io/File:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   78: astore_1
    //   79: aload_1
    //   80: ifnonnull +11 -> 91
    //   83: return
    ...
    //   88: goto -51 -> 37
    //   91: aload_1
    //   92: invokevirtual 1130	java/io/File:getParentFile	()Ljava/io/File;
    //   95: invokevirtual 1133	java/io/File:mkdirs	()Z
    //   98: pop
    //   99: aload_1
    //   100: invokevirtual 1136	java/io/File:isFile	()Z
    //   103: ifeq +10 -> 113
    //   106: aload_1
    //   107: invokevirtual 892	java/io/File:exists	()Z
    //   110: ifne +8 -> 118
    //   113: aload_1
    //   114: invokevirtual 1139	java/io/File:createNewFile	()Z
    //   117: pop
    //   118: new 1141	java/io/FileOutputStream
    //   121: dup
    //   122: aload_1
    //   123: iconst_0
    //   124: invokespecial 1144	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   127: putstatic 98	com/tencent/smtt/sdk/WebView:d	Ljava/io/OutputStream;
    //   130: getstatic 98	com/tencent/smtt/sdk/WebView:d	Ljava/io/OutputStream;
    //   133: aload_3
    //   134: invokevirtual 1148	java/lang/String:getBytes	()[B
    //   137: invokevirtual 1154	java/io/OutputStream:write	([B)V
    //   140: getstatic 98	com/tencent/smtt/sdk/WebView:d	Ljava/io/OutputStream;
    //   143: ifnull -60 -> 83
    //   146: getstatic 98	com/tencent/smtt/sdk/WebView:d	Ljava/io/OutputStream;
    //   149: invokevirtual 1157	java/io/OutputStream:flush	()V
    //   152: return
    //   153: astore_1
    //   154: getstatic 98	com/tencent/smtt/sdk/WebView:d	Ljava/io/OutputStream;
    //   157: ifnull +9 -> 166
    //   160: getstatic 98	com/tencent/smtt/sdk/WebView:d	Ljava/io/OutputStream;
    //   163: invokevirtual 1157	java/io/OutputStream:flush	()V
    //   166: aload_1
    //   167: athrow
    //   168: astore_1
    //   169: return
  ...
  public void destroy()
  {
    ...
    try
    {
      if (this.i.getApplicationInfo().packageName.contains("com.tencent.qqmusic")) {
        ...
        {
          this.p = true;
          boolean bool3 = com.tencent.smtt.utils.q.f(this.i);
          bool1 = bool2;
          if (!bool3) {
            bool1 = true;
          }
  ...
  public boolean onLongClick(View paramView)
  {
    if (this.C != null)
    {
      if (!this.C.onLongClick(paramView)) {
        return a(paramView);
      }
      return true;
    }
  ...
  protected void onVisibilityChanged(View paramView, int paramInt)
  {
    ...
    if (t == null) {
      t = this.i.getApplicationInfo().packageName;
    }
    if ((t != null) && ((t.equals("com.tencent.mm")) || (t.equals("com.tencent.mobileqq"))))
    {
      super.onVisibilityChanged(paramView, paramInt);
      return;
    }
  ...
  public void setOnLongClickListener(View.OnLongClickListener paramOnLongClickListener)
  {
    ...
    try
    {
      if (this.B == null)
      {
        ...
        this.B = ((Field)localObject2).get(localObject1);
      }
  ...
  public void setWebChromeClient(WebChromeClient paramWebChromeClient)
  {
    ...
    for (;;)
    {
      this.s = paramWebChromeClient;
      return;
      localObject = new i(y.a().a(true).i(), this, paramWebChromeClient);
      break;
      if (paramWebChromeClient != null)
      {
  ...
  public void setWebViewClient(WebViewClient paramWebViewClient)
  {
    ...
    if (this.e)
    {
      ...
      for (;;)
      {
        ...
        this.r = paramWebViewClient;
        return;
        localObject = new j(y.a().a(true).j(), this, paramWebViewClient);
      }
    }
    b localb = this.g;
    if (paramWebViewClient == null) {}
