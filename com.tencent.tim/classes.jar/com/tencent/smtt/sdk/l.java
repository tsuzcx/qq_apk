  ...
  extends ServiceWorkerController
{
  public ServiceWorkerWebSettings getServiceWorkerWebSettings()
  {
    ...
    return new l.1(this, android.webkit.ServiceWorkerController.getInstance().getServiceWorkerWebSettings());
  }
  
  public void setServiceWorkerClient(ServiceWorkerClient paramServiceWorkerClient)
  {
    if (Build.VERSION.SDK_INT >= 24) {
      android.webkit.ServiceWorkerController.getInstance().setServiceWorkerClient(new l.2(this, paramServiceWorkerClient));
    }
  }
}
