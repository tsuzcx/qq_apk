...
public class CookieManager
{
  ...
  void a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((localObject1 == null) || (!((y)localObject1).b())) {
          break;
        }
  ...
  protected void a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((q.a().j(paramContext) > 0) && (q.a().j(paramContext) < 36001)) {
          continue;
        }
        if (!bool) {
          break label344;
      ...
      if (i > 0)
      {
        String str = q.a().d(paramContext, "cookies_database_version");
  ...
  public boolean acceptThirdPartyCookies(WebView paramWebView)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 97	com/tencent/smtt/sdk/y:a	()Lcom/tencent/smtt/sdk/y;
    //   5: astore_3
    //   6: aload_3
    //   7: ifnull +72 -> 79
    //   10: aload_3
    //   11: invokevirtual 99	com/tencent/smtt/sdk/y:b	()Z
    //   14: ifeq +65 -> 79
    //   17: aload_3
    //   18: invokevirtual 293	com/tencent/smtt/sdk/y:c	()Lcom/tencent/smtt/sdk/z;
    //   21: invokevirtual 304	com/tencent/smtt/sdk/z:b	()Lcom/tencent/smtt/export/external/DexLoader;
    //   24: astore_3
    //   25: aload_1
  ...
  public void flush()
  {
    y localy = y.a();
    if ((localy != null) && (localy.b())) {
      localy.c().b().invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_flush", new Class[0], new Object[0]);
    }
  ...
  public void removeAllCookies(ValueCallback<Boolean> paramValueCallback)
  {
    ...
    y localy = y.a();
    if ((localy != null) && (localy.b())) {
      localy.c().b().invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeAllCookies", new Class[] { android.webkit.ValueCallback.class }, new Object[] { paramValueCallback });
    }
    while (Build.VERSION.SDK_INT < 21) {
      return;
    }
  ...
  public void removeExpiredCookie()
  {
    ...
    if ((localy != null) && (localy.b()))
    {
      localy.c().b().invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeExpiredCookie", new Class[0], new Object[0]);
      return;
    }
  ...
  public void removeSessionCookie()
  {
    ...
    if ((localy != null) && (localy.b()))
    {
      localy.c().b().invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeSessionCookie", new Class[0], new Object[0]);
      return;
    }
  ...
  public void removeSessionCookies(ValueCallback<Boolean> paramValueCallback)
  {
    y localy = y.a();
    if ((localy != null) && (localy.b())) {
      localy.c().b().invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeSessionCookies", new Class[] { android.webkit.ValueCallback.class }, new Object[] { paramValueCallback });
    }
    while (Build.VERSION.SDK_INT < 21) {
      return;
    }
  ...
  public void setCookie(String paramString1, String paramString2, ValueCallback<Boolean> paramValueCallback)
  {
    ...
    //   9: ifnull +67 -> 76
    //   12: aload 4
    //   14: invokevirtual 99	com/tencent/smtt/sdk/y:b	()Z
    //   17: ifeq +59 -> 76
    //   20: aload 4
    //   22: invokevirtual 293	com/tencent/smtt/sdk/y:c	()Lcom/tencent/smtt/sdk/z;
    //   25: invokevirtual 304	com/tencent/smtt/sdk/z:b	()Lcom/tencent/smtt/export/external/DexLoader;
    //   28: ldc_w 312
    //   31: ldc_w 401
    //   34: iconst_3
    ...
    //   74: monitorexit
    //   75: return
    //   76: invokestatic 97	com/tencent/smtt/sdk/y:a	()Lcom/tencent/smtt/sdk/y;
    //   79: invokevirtual 402	com/tencent/smtt/sdk/y:d	()Z
    //   82: ifne +65 -> 147
  ...
  public void setCookie(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    //   86: invokestatic 97	com/tencent/smtt/sdk/y:a	()Lcom/tencent/smtt/sdk/y;
    //   89: invokevirtual 402	com/tencent/smtt/sdk/y:d	()Z
    //   92: ifne -28 -> 64
  ...
  public boolean setCookieCompatialbeMode(Context paramContext, a parama, String paramString, boolean paramBoolean)
  {
    ...
    if ((this.c != a.a) && (paramBoolean) && (!y.a().d())) {
      y.a().a(paramContext, null);
    }
    return true;
  }
  ...
  public void setCookies(Map<String, String[]> paramMap)
  {
    ...
    for (boolean bool = ((y)localObject).c().a(paramMap);; bool = false)
    {
      if (!bool)
      {
