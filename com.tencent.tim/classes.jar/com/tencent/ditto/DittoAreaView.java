  ...
  implements DittoHost
{
  ...
  private List<KVCNode> needKVCAreas = Collections.synchronizedList(new ArrayList());
  ...
  public void updateViewModel(Object paramObject)
  {
    ...
    {
      KVCNode localKVCNode = (KVCNode)localIterator1.next();
  ...
  class KVCNode
  {
    ...
    KVCNode(Map<String, DittoValue> paramMap)
    {
      this.area = paramMap;
