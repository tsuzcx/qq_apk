  ...
  implements DittoElement, DittoType
{
  ...
  private void checkForLongClick(MotionEvent paramMotionEvent)
  {
    if (this.mPendingCheckForLongPress == null) {
      this.mPendingCheckForLongPress = new CheckForLongPressRunnable(null);
    }
  ...
  final class CheckForLongPressRunnable
    implements Runnable
  {
  ...
  {
    public abstract void onClick(DittoArea paramDittoArea, @Nullable MotionEvent paramMotionEvent, Object paramObject);
  }
  
  public static abstract interface LongClickListener
  {
    public abstract void onLongClick(DittoArea paramDittoArea, @Nullable MotionEvent paramMotionEvent, Object paramObject);
  }
}
