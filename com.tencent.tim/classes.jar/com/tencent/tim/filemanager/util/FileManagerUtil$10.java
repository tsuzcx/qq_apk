...
public final class FileManagerUtil$10
  implements Runnable
{
  public FileManagerUtil$10(String paramString, int paramInt1, boolean paramBoolean, audx.b paramb, int paramInt2, int paramInt3) {}
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          try
          {
            localBitmap3 = audx.c(localMatrix, localBitmap2, this.val$width, this.val$height);
            if (this.a == null) {
              break;
            }
 ...
 * Qualified Name:     com.tencent.tim.filemanager.util.FileManagerUtil.10
