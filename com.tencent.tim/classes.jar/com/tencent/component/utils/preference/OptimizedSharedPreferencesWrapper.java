  ...
  extends SharedPreferencesWrapper
{
  ...
  public SharedPreferences.Editor edit()
  {
    ...
    if (localEditor != null) {
      return new OptimizedEditorWrapper(localEditor);
    }
    return null;
  }
  ...
  class OptimizedEditorWrapper
    extends SharedPreferencesWrapper.EditorWrapper
  {
    public OptimizedEditorWrapper(SharedPreferences.Editor paramEditor)
    {
      super(OptimizedSharedPreferencesWrapper.this.getKeyGenerator());
    }
    ...
    public SharedPreferences.Editor clear()
    {
      ...
      {
        return this;
        Object localObject = OptimizedSharedPreferencesWrapper.this.getWrappedSharedPreferences().getAll();
    ...
    {
      if ((OptimizedSharedPreferencesWrapper.this.mOptimize) && (Build.VERSION.SDK_INT >= 9))
      {
        super.apply();
        return true;
      }
