  ...
  implements DownloadTask.DownloadTaskHandler
{
  ...
  private static final ThreadPoolCache sThreadPoolCache = new ThreadPoolCache("download", THREAD_POOL_SIZE);
  ...
  private LockManager mLockManager = new LockManager(null);
  private OkHttpClient mOkClient;
  private boolean mPaused = false;
  private final MultiHashMap<String, DownloadRequest> mPendingRequests = new MultiHashMap();
  private final ThreadPoolCache mThreadPoolCache = sThreadPoolCache;
  ...
  static final class ThreadPoolCache
  {
