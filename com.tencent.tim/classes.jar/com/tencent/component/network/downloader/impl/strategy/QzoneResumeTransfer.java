  ...
  implements ResumeTransfer
{
  ...
  private CacheFileAttribute parseAttrs(HttpResponse paramHttpResponse, Response paramResponse)
  {
    ...
    for (paramResponse = paramResponse.getValue();; paramResponse = null)
    {
      ...
      for (localObject1 = ((Header)localObject1).getValue();; localObject1 = null)
      {
        ...
        for (;;)
        {
          return new CacheFileAttribute(paramHttpResponse, (String)localObject3, (String)localObject2);
          if (paramResponse != null)
          {
  ...
  public void addCacheTmpFile(String paramString1, String arg2, HttpResponse paramHttpResponse, Response paramResponse)
  {
    ...
    for (??? = paramHttpResponse.toString();; ??? = "N/A")
    {
      ...
      {
        if (!paramHttpResponse.equals((CacheFileAttribute)this.mCacheAttributes.get(getTmpCacheFileName(paramString1))))
        {
    ...
    implements Parcelable
  {
    ...
    public CacheFileAttribute(String paramString1, String paramString2, String paramString3)
    {
