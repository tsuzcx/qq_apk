...
public class NetworkUtils
{
  ...
  public static String getAPN(Context paramContext)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: invokestatic 83	com/tencent/component/network/utils/NetworkUtils:getActiveNetworkInfo	(Landroid/content/Context;)Landroid/net/NetworkInfo;
    //   6: astore 4
    //   8: aload 4
    //   10: ifnonnull +5 -> 15
    //   13: aconst_null
    //   14: areturn
    //   15: aload 4
    //   17: invokevirtual 89	android/net/NetworkInfo:getType	()I
    //   20: iconst_1
    //   21: if_icmpne +19 -> 40
    //   24: ldc 14
    //   26: astore_0
    ...
    //   30: ifnull +8 -> 38
    //   33: aload_0
    //   34: invokevirtual 95	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   37: astore_1
    //   38: aload_1
    //   39: areturn
    //   40: aload 4
    //   42: invokevirtual 89	android/net/NetworkInfo:getType	()I
    //   45: ifne +165 -> 210
    //   48: invokestatic 100	com/tencent/component/network/utils/PlatformUtil:version	()I
    //   51: bipush 17
    //   53: if_icmpge +152 -> 205
    //   56: aload_0
    //   57: invokevirtual 106	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   60: getstatic 34	com/tencent/component/network/utils/NetworkUtils:PREFERRED_APN_URI	Landroid/net/Uri;
    //   63: aconst_null
    //   64: aconst_null
    //   65: aconst_null
    //   66: aconst_null
    //   67: invokestatic 112	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   70: astore_0
    //   71: aload_0
    //   72: astore_2
    //   73: aconst_null
    ...
    //   123: astore_0
    //   124: aload_1
    //   125: invokestatic 137	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   128: ifeq -101 -> 27
    //   131: aload 4
    //   133: invokevirtual 140	android/net/NetworkInfo:getExtraInfo	()Ljava/lang/String;
    //   136: astore_0
    //   137: goto -110 -> 27
    //   140: astore_1
    //   141: aconst_null
    ...
    //   146: astore_2
    //   147: aload_1
    //   148: invokevirtual 143	java/lang/Throwable:printStackTrace	()V
    //   151: aload_2
    //   152: astore_1
    //   153: aload_0
    //   154: ifnull -32 -> 122
