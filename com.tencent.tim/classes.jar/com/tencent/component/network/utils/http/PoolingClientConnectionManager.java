  ...
  implements ConnPoolControl<HttpRoute>, ClientConnectionManager
{
  ...
  public void releaseConnection(ManagedClientConnection paramManagedClientConnection, long paramLong, TimeUnit paramTimeUnit)
  {
    ...
    //   16: athrow
    //   17: aload_1
    //   18: checkcast 231	com/tencent/component/network/utils/http/ManagedClientConnectionImpl
    //   21: astore_1
    //   22: aload_1
    //   23: invokevirtual 246	com/tencent/component/network/utils/http/ManagedClientConnectionImpl:getManager	()Lorg/apache/http/conn/ClientConnectionManager;
    //   26: aload_0
    //   27: if_acmpeq +13 -> 40
    //   30: new 223	java/lang/IllegalStateException
    //   33: dup
    //   34: ldc 248
    //   36: invokespecial 226	java/lang/IllegalStateException:<init>	(Ljava/lang/String;)V
    //   39: athrow
    //   40: aload_1
    //   41: monitorenter
    //   42: aload_1
    //   43: invokevirtual 252	com/tencent/component/network/utils/http/ManagedClientConnectionImpl:detach	()Lcom/tencent/component/network/utils/http/HttpPoolEntry;
    //   46: astore 6
    //   48: aload 6
    //   50: ifnonnull +6 -> 56
    //   53: aload_1
    ...
    //   55: return
    //   56: aload_1
    //   57: invokevirtual 255	com/tencent/component/network/utils/http/ManagedClientConnectionImpl:isOpen	()Z
    //   60: ifeq +18 -> 78
    //   63: aload_1
    //   64: invokevirtual 258	com/tencent/component/network/utils/http/ManagedClientConnectionImpl:isMarkedReusable	()Z
    //   67: istore 5
    //   69: iload 5
    //   71: ifne +7 -> 78
    //   74: aload_1
    //   75: invokevirtual 259	com/tencent/component/network/utils/http/ManagedClientConnectionImpl:shutdown	()V
    //   78: aload_1
    //   79: invokevirtual 258	com/tencent/component/network/utils/http/ManagedClientConnectionImpl:isMarkedReusable	()Z
    //   82: ifeq +16 -> 98
    //   85: aload 4
    //   87: ifnull +34 -> 121
    //   90: aload 6
    //   92: lload_2
    //   93: aload 4
    //   95: invokevirtual 262	com/tencent/component/network/utils/http/HttpPoolEntry:updateExpiry	(JLjava/util/concurrent/TimeUnit;)V
    //   98: aload_0
    ...
    //   102: aload 6
    //   104: aload_1
    //   105: invokevirtual 258	com/tencent/component/network/utils/http/ManagedClientConnectionImpl:isMarkedReusable	()Z
    //   108: invokevirtual 266	com/tencent/component/network/utils/http/HttpConnPool:release	(Lcom/tencent/component/network/utils/http/pool/PoolEntry;Z)V
    //   111: aload_1
    //   112: monitorexit
    //   113: return
    //   114: astore 4
    ...
    //   135: aload 6
    //   137: aload_1
    //   138: invokevirtual 258	com/tencent/component/network/utils/http/ManagedClientConnectionImpl:isMarkedReusable	()Z
    //   141: invokevirtual 266	com/tencent/component/network/utils/http/HttpConnPool:release	(Lcom/tencent/component/network/utils/http/pool/PoolEntry;Z)V
    //   144: aload 4
    //   146: athrow
    //   147: astore 7
    //   149: goto -71 -> 78
