...
public class HttpUtil
{
  ...
  {
    ClientOptions localClientOptions = new ClientOptions();
  ...
  public static boolean containsProxy(HttpRequest paramHttpRequest, RequestOptions paramRequestOptions)
  {
  ...
  public static OkHttpClient createHttp2Client(ClientOptions paramClientOptions, CustomDnsResolve paramCustomDnsResolve)
  {
    ClientOptions localClientOptions = paramClientOptions;
  ...
  public static QZoneHttpClient createHttpClient(ClientOptions paramClientOptions)
  {
    ...
    HttpConnectionParams.setConnectionTimeout(localBasicHttpParams, ((ClientOptions)localObject1).connTimeout);
    HttpConnectionParams.setTcpNoDelay(localBasicHttpParams, true);
    HttpConnectionParams.setSoTimeout(localBasicHttpParams, ((ClientOptions)localObject1).soTimeout);
    ...
    try
    {
      ...
      if (((ClientOptions)localObject1).multiConnection)
      {
        localObject2 = new PoolingClientConnectionManager(paramClientOptions, ((ClientOptions)localObject1).timeToLive, ((ClientOptions)localObject1).timeToLiveUnit, new SystemDefaultDnsResolver(), ((ClientOptions)localObject1).dnsResolve);
        if (((ClientOptions)localObject1).maxConnectionPerRoute > 0) {
          ((PoolingClientConnectionManager)localObject2).setDefaultMaxPerRoute(((ClientOptions)localObject1).maxConnectionPerRoute);
        }
        paramClientOptions = (ClientOptions)localObject2;
        if (((ClientOptions)localObject1).maxConnection > 0)
        {
          ((PoolingClientConnectionManager)localObject2).setMaxTotal(((ClientOptions)localObject1).maxConnection);
          paramClientOptions = (ClientOptions)localObject2;
        }
        ConnManagerParams.setTimeout(localBasicHttpParams, ((ClientOptions)localObject1).connManagerTimeout);
  ...
  public static HttpGet createHttpGet(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, RequestOptions paramRequestOptions)
    throws MalformedURLException
  {
  ...
  public static Proxy prepareRequest(RequestOptions paramRequestOptions)
  {
  ...
  public static final class ClientOptions
  {
    ...
    public ClientOptions(boolean paramBoolean)
    {
