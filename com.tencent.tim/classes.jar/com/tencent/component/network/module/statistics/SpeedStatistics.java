...
public class SpeedStatistics
{
  ...
  private static final Comparator<StatisticsUnit> sUnitComparator = new SpeedStatistics.1();
  ...
  private void updateAverageSpeed(int paramInt)
  {
    ...
    do
    {
      ...
      paramInt = i;
      break;
      StatisticsUnit localStatisticsUnit = (StatisticsUnit)this.mStatisticList.get(paramInt - 1);
