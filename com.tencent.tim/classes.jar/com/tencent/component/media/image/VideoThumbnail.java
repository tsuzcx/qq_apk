...
public class VideoThumbnail
{
  ...
  private static Bitmap queryVideoThumbnail(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localCursor = alld.query(paramContext.getContentResolver(), MediaStore.Video.Media.EXTERNAL_CONTENT_URI, PROJECTION_VIDEO, paramString, null, null);
        if (localCursor == null) {}
      }
      finally
      {
  ...
  private static String queryVideoThumbnailFilePath(Context paramContext, long paramLong)
  {
    ...
    //   47: aconst_null
    //   48: aconst_null
    //   49: invokestatic 184	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   52: astore_0
    //   53: aload_0
    //   54: ifnull +139 -> 193
    //   57: aload_0
  ...
  public static String queryVideoThumbnailFilePath(Context paramContext, String paramString)
  {
    ...
    //   54: aconst_null
    //   55: aconst_null
    //   56: invokestatic 184	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   59: astore_1
    //   60: aload_1
    //   61: ifnull +131 -> 192
    //   64: aload_1
