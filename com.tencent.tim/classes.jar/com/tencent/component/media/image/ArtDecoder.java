  ...
  implements IDecoder
{
  ...
  public Bitmap decodeBitmap(java.io.File paramFile, int paramInt1, int paramInt2, Bitmap paramBitmap)
  {
    ...
    //   1: ifnull +24 -> 25
    //   4: aload_1
    //   5: invokevirtual 223	java/io/File:exists	()Z
    //   8: ifeq +17 -> 25
    //   11: aload_1
    //   12: invokevirtual 226	java/io/File:isFile	()Z
    //   15: ifeq +10 -> 25
    //   18: aload_1
    //   19: invokevirtual 229	java/io/File:canRead	()Z
    //   22: ifne +5 -> 27
    //   25: aconst_null
    //   26: areturn
    ...
    //   36: aload 8
    //   38: iconst_1
    //   39: putfield 232	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   42: aload 8
    //   44: aload_0
    ...
    //   63: dup
    //   64: new 203	java/io/FileInputStream
    //   67: dup
    //   68: aload_1
    //   69: invokespecial 235	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   72: sipush 8192
    //   75: invokespecial 238	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;I)V
    //   78: astore 6
    //   80: aload 6
    //   82: astore 5
    //   84: aload 6
    ...
    //   92: pop
    //   93: aload 6
    //   95: invokevirtual 241	java/io/BufferedInputStream:close	()V
    //   98: aload 8
    //   100: iconst_0
    //   101: putfield 232	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   104: new 243	com/tencent/component/media/image/ImageLoader$Options
    //   107: dup
    //   108: invokespecial 244	com/tencent/component/media/image/ImageLoader$Options:<init>	()V
    //   111: astore 5
    //   113: aload 5
    //   115: iload_3
    //   116: putfield 247	com/tencent/component/media/image/ImageLoader$Options:clipHeight	I
    //   119: aload 5
    //   121: iload_2
    //   122: putfield 250	com/tencent/component/media/image/ImageLoader$Options:clipWidth	I
    //   125: iload_3
    //   126: ifle +27 -> 153
    //   129: iload_2
    //   130: ifle +23 -> 153
    ...
    //   147: invokestatic 256	com/tencent/component/media/image/ImageOptionSampleSize:computeSampleSize	(Lcom/tencent/component/media/image/ImageLoader$Options;II)I
    ...
    //   168: aload 8
    //   170: aload 4
    //   172: invokestatic 260	com/tencent/component/media/utils/BitmapUtils:addInBitmapOptions	(Landroid/graphics/BitmapFactory$Options;Landroid/graphics/Bitmap;)V
    //   175: new 137	java/io/BufferedInputStream
    //   178: dup
    //   179: new 203	java/io/FileInputStream
    //   182: dup
    //   183: aload_1
    //   184: invokespecial 235	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   187: sipush 8192
    //   190: invokespecial 238	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;I)V
    //   193: astore 4
    //   195: aload 4
    //   197: astore_1
    //   198: aload 4
    ...
    //   206: astore 5
    //   208: aload 4
    //   210: invokevirtual 241	java/io/BufferedInputStream:close	()V
    //   213: aload 5
    //   215: areturn
    //   216: astore_1
    //   217: ldc 16
    ...
    //   263: aload 6
    //   265: invokevirtual 241	java/io/BufferedInputStream:close	()V
    //   268: goto -170 -> 98
    //   271: astore 5
    //   273: ldc 16
    //   275: aload 5
    ...
    //   305: aload 6
    //   307: invokevirtual 241	java/io/BufferedInputStream:close	()V
    //   310: goto -212 -> 98
    //   313: astore 5
    //   315: ldc 16
    //   317: aload 5
    ...
    //   330: astore 5
    //   332: aload 5
    //   334: invokevirtual 241	java/io/BufferedInputStream:close	()V
    //   337: aload_1
    //   338: athrow
    //   339: astore 4
    //   341: ldc 16
    ...
    //   372: aload 4
    //   374: invokevirtual 241	java/io/BufferedInputStream:close	()V
    //   377: aconst_null
    //   378: areturn
    //   379: astore_1
    //   380: ldc 16
    ...
    //   409: aload 4
    //   411: invokevirtual 241	java/io/BufferedInputStream:close	()V
    //   414: aconst_null
    //   415: areturn
    //   416: astore_1
    //   417: ldc 16
    ...
    //   446: aload 4
    //   448: invokevirtual 241	java/io/BufferedInputStream:close	()V
    //   451: aconst_null
    //   452: areturn
    //   453: astore_1
    //   454: ldc 16
    ...
    //   468: astore_1
    //   469: aload_1
    //   470: invokevirtual 241	java/io/BufferedInputStream:close	()V
    //   473: aload 4
    //   475: athrow
    //   476: astore_1
    //   477: ldc 16
    ...
    //   229	5	5	localIOException1	IOException
    //   251	1	5	localBufferedInputStream1	BufferedInputStream
    //   271	5	5	localIOException2	IOException
    //   293	1	5	localBufferedInputStream2	BufferedInputStream
    //   313	5	5	localIOException3	IOException
  ...
  public Bitmap decodeFile(java.io.File paramFile, BitmapFactory.Options paramOptions)
  {
    ...
    //   53: aload_2
    //   54: iload_3
    //   55: invokespecial 264	com/tencent/component/media/image/ArtDecoder:getDecodeOptions	(Landroid/graphics/BitmapFactory$Options;Z)Landroid/graphics/BitmapFactory$Options;
    //   58: astore 4
    //   60: aload_0
    //   61: aload_1
    //   62: aload 4
    //   64: invokespecial 266	com/tencent/component/media/image/ArtDecoder:decodeImageFromStream	(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   67: astore_2
    //   68: iload_3
    //   69: ifeq +277 -> 346
    //   72: aload_2
    ...
    //   76: aload_0
    //   77: aload_1
    //   78: invokespecial 268	com/tencent/component/media/image/ArtDecoder:reset	(Ljava/io/FileInputStream;)V
    //   81: aload_0
    //   82: aload_1
    //   83: aload_0
    //   84: aload 4
    //   86: iconst_0
    //   87: invokespecial 264	com/tencent/component/media/image/ArtDecoder:getDecodeOptions	(Landroid/graphics/BitmapFactory$Options;Z)Landroid/graphics/BitmapFactory$Options;
    //   90: invokespecial 266	com/tencent/component/media/image/ArtDecoder:decodeImageFromStream	(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   93: astore 4
    //   95: aload 4
    //   97: astore_2
    //   98: aload_1
    //   99: ifnull +10 -> 109
    //   102: aload_1
    //   103: invokevirtual 269	java/io/FileInputStream:close	()V
    //   106: aload 4
    //   108: astore_2
    //   109: aload_2
    //   110: areturn
    //   111: astore_1
    //   112: aload_1
    //   113: invokevirtual 272	java/io/IOException:printStackTrace	()V
    //   116: aload 4
    //   118: areturn
    //   119: astore_2
    //   120: aconst_null
    ...
    //   139: ifnull -30 -> 109
    //   142: aload 5
    //   144: invokevirtual 269	java/io/FileInputStream:close	()V
    //   147: aload_1
    //   148: areturn
    //   149: astore_2
    //   150: aload_2
    //   151: invokevirtual 272	java/io/IOException:printStackTrace	()V
    //   154: aload_1
    //   155: areturn
    //   156: astore_2
    //   157: aconst_null
    ...
    //   180: ifnull -71 -> 109
    //   183: aload 5
    //   185: invokevirtual 269	java/io/FileInputStream:close	()V
    //   188: aload_1
    //   189: areturn
    //   190: astore_2
    //   191: aload_2
    //   192: invokevirtual 272	java/io/IOException:printStackTrace	()V
    //   195: aload_1
    //   196: areturn
    //   197: astore_2
    //   198: aconst_null
    ...
    //   221: ifnull -112 -> 109
    //   224: aload 5
    //   226: invokevirtual 269	java/io/FileInputStream:close	()V
    //   229: aload_1
    //   230: areturn
    //   231: astore_2
    //   232: aload_2
    //   233: invokevirtual 272	java/io/IOException:printStackTrace	()V
    //   236: aload_1
    //   237: areturn
    //   238: astore_1
    //   239: aload 4
    //   241: ifnull +8 -> 249
    //   244: aload 4
    //   246: invokevirtual 269	java/io/FileInputStream:close	()V
    //   249: aload_1
    //   250: athrow
    //   251: astore_2
    //   252: aload_2
    //   253: invokevirtual 272	java/io/IOException:printStackTrace	()V
    //   256: goto -7 -> 249
    //   259: astore_2
    //   260: aload_1
    //   261: astore 4
    ...
    //   307	8	4	localIOException	IOException
  ...
  public BitmapReference decodeImage(java.io.File paramFile, BitmapFactory.Options paramOptions)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: new 203	java/io/FileInputStream
    //   6: dup
    //   7: aload_1
    //   8: invokespecial 235	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   11: astore_3
    //   12: aload_3
    //   13: astore_1
    //   14: aload_0
    //   15: aload_3
    //   16: aload_2
    //   17: invokevirtual 277	com/tencent/component/media/image/ArtDecoder:decodeImage	(Ljava/io/FileInputStream;Landroid/graphics/BitmapFactory$Options;)Lcom/tencent/component/media/image/BitmapReference;
    //   20: astore_2
    //   21: aload_2
    //   22: astore_1
    //   23: aload_3
    //   24: ifnull +9 -> 33
    //   27: aload_3
    //   28: invokevirtual 269	java/io/FileInputStream:close	()V
    //   31: aload_2
    //   32: astore_1
    //   33: aload_1
    //   34: areturn
    ...
    //   53: ifnull -20 -> 33
    //   56: aload_3
    //   57: invokevirtual 269	java/io/FileInputStream:close	()V
    //   60: aconst_null
    //   61: areturn
    //   62: astore_1
    //   63: aconst_null
    ...
    //   83: ifnull -50 -> 33
    //   86: aload_3
    //   87: invokevirtual 269	java/io/FileInputStream:close	()V
    //   90: aconst_null
    //   91: areturn
    //   92: astore_1
    //   93: aconst_null
  ...
  public BitmapReference decodeImage(FileInputStream paramFileInputStream, BitmapFactory.Options paramOptions)
  {
    ...
    //   104: aload_1
    //   105: aload 7
    //   107: invokespecial 266	com/tencent/component/media/image/ArtDecoder:decodeImageFromStream	(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   110: astore_3
    //   111: aload_3
    //   112: astore_2
    //   113: aload_3
    ...
    //   126: aload_0
    //   127: aload_1
    //   128: invokespecial 268	com/tencent/component/media/image/ArtDecoder:reset	(Ljava/io/FileInputStream;)V
    //   131: aload_3
    //   132: astore 4
    //   134: aload_3
    //   135: astore 5
    ...
    //   143: aload 7
    //   145: iconst_0
    //   146: invokespecial 264	com/tencent/component/media/image/ArtDecoder:getDecodeOptions	(Landroid/graphics/BitmapFactory$Options;Z)Landroid/graphics/BitmapFactory$Options;
    //   149: invokespecial 266	com/tencent/component/media/image/ArtDecoder:decodeImageFromStream	(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   152: astore_2
    //   153: aload_2
    //   154: invokestatic 283	com/tencent/component/media/image/BitmapReference:getBitmapReference	(Landroid/graphics/Bitmap;)Lcom/tencent/component/media/image/BitmapReference;
    //   157: areturn
    //   158: aload_3
    //   159: astore 4
    //   161: aload 8
    ...
    //   170: aload_2
    //   171: iconst_1
    //   172: invokespecial 264	com/tencent/component/media/image/ArtDecoder:getDecodeOptions	(Landroid/graphics/BitmapFactory$Options;Z)Landroid/graphics/BitmapFactory$Options;
    //   175: astore 7
    //   177: goto -85 -> 92
    //   180: astore_1
    //   181: ldc 16
