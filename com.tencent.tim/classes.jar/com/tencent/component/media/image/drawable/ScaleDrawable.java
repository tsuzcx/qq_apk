  ...
  extends DrawableContainer
{
  ...
  {
    this.mScaleState = new ScaleState(paramDrawable, this);
  ...
  public static void getMatrix(Matrix paramMatrix, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, float paramFloat1, float paramFloat2)
  {
    ...
    case 0: 
      ...
      if (paramInt2 * paramInt5 > paramInt4 * paramInt3)
      {
        ...
        f1 = (paramInt4 - paramInt2 * paramFloat1) * 0.5F;
      }
      for (;;)
      {
        localMatrix.setScale(paramFloat1, paramFloat1);
        localMatrix.postTranslate((int)(0.5F + f1), (int)(paramFloat2 + 0.5F));
        return;
        paramFloat1 = paramInt4 / paramInt2;
        paramFloat2 = (paramInt5 - paramInt3 * paramFloat1) * 0.5F;
      }
    case 1: 
      if (paramInt2 * paramInt5 > paramInt4 * paramInt3) {}
      ...
      {
        localMatrix.setScale(paramFloat1, paramFloat1);
        localMatrix.postTranslate((int)(0.5F + 0.0F), (int)(0.0F + 0.5F));
        return;
      }
    case 2: 
      f1 = 0.0F;
      ...
      {
        paramFloat1 = paramInt5 / paramInt3;
        f1 = (paramInt4 - paramInt2 * paramFloat1) * 1.0F;
      }
      for (;;)
      {
        localMatrix.setScale(paramFloat1, paramFloat1);
        ...
        return;
        paramFloat1 = paramInt4 / paramInt2;
        paramFloat2 = (paramInt5 - paramInt3 * paramFloat1) * 1.0F;
      }
    case 3: 
      f1 = 0.0F;
      paramFloat2 = 0.0F;
  ...
  {
    ScaleState(Drawable paramDrawable, ScaleDrawable paramScaleDrawable)
    {
      super(paramScaleDrawable);
    }
    
    ScaleState(ScaleState paramScaleState, ScaleDrawable paramScaleDrawable, Resources paramResources)
    {
      super(paramScaleDrawable, paramResources);
    }
