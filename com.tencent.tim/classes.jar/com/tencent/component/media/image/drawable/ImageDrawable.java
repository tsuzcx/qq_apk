  ...
  extends Drawable
{
  ...
  {
    this.mImageState = new ImageState(paramBitmapReference, paramInt1, paramInt2);
  ...
  private ImageDrawable(ImageState paramImageState, Resources paramResources)
  {
    this.mImageState = new ImageState(paramImageState);
    if (paramResources != null)
    {
      this.mTargetDensity = paramResources.getDisplayMetrics().densityDpi;
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    for (localObject = ((BitmapReference)localObject).getBitmap();; localObject = null)
    {
      if (localObject != null)
      {
        ImageState localImageState = this.mImageState;
    ...
    extends Drawable.ConstantState
  {
    ...
    ImageState(BitmapReference paramBitmapReference, int paramInt1, int paramInt2)
    {
      this.mBitmap = paramBitmapReference;
    ...
    ImageState(ImageState paramImageState)
    {
