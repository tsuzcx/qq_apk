  ...
  implements Animatable
{
  ...
  private Runnable mDecodeTask = new DecodeTask(null);
  ...
  private void rebuildCache()
  {
    ...
    while (i < this.mFrameCounts)
    {
      ...
      if (localObject != null)
      {
        localObject = (FrameRef)((WeakReference)localObject).get();
        if ((localObject != null) && (((FrameRef)localObject).mBmpRef.getBitmap().getGenerationId() == ((FrameRef)localObject).mBmpGenerationId))
        {
          this.mLruCache.put(str, ((FrameRef)localObject).mBmpRef);
    ...
    public void run()
    {
      ...
      do
      {
        ...
        if ((NewAnimationDrawable.this.mCurFrameIndex == -1) || (NewAnimationDrawable.this.mCurFrameIndex >= NewAnimationDrawable.this.mOptions.photoList.size())) {
          NewAnimationDrawable.access$602(NewAnimationDrawable.this, 0);
        }
        localObject2 = (String)NewAnimationDrawable.this.mOptions.photoList.get(NewAnimationDrawable.this.mCurFrameIndex);
        ??? = (BitmapReference)NewAnimationDrawable.this.mLruCache.get(localObject2);
        if (NewAnimationDrawable.this.mCurBitmapRef == null)
        {
          ...
          NewAnimationDrawable.access$202(NewAnimationDrawable.this, (BitmapReference)???);
          NewAnimationDrawable.this.mInvalidHandler.removeMessages(0);
          ??? = NewAnimationDrawable.this.mInvalidHandler;
          if (i == 0) {
            break label286;
          }
        }
        for (l = 0L;; l = NewAnimationDrawable.this.mDelayTime)
        {
          ((Handler)???).sendEmptyMessageDelayed(0, l);
          ImageManagerEnv.getLogger().d("NewAnimationDrawable", new Object[] { "get from cache: index=" + NewAnimationDrawable.this.mCurFrameIndex });
          return;
          i = 0;
          break;
        }
        localObject4 = NewAnimationDrawable.this.decodeFrame((String)localObject2);
      } while (localObject4 == null);
      for (;;)
      {
        synchronized (NewAnimationDrawable.this.mLruCache)
        {
          NewAnimationDrawable.access$202(NewAnimationDrawable.this, (BitmapReference)localObject4);
          NewAnimationDrawable.this.mLruCache.put(localObject2, localObject4);
          localObject4 = new NewAnimationDrawable.FrameRef((BitmapReference)localObject4);
          NewAnimationDrawable.this.mWeakRefCache.put(localObject2, new WeakReference(localObject4));
          NewAnimationDrawable.this.mInvalidHandler.removeMessages(0);
          localObject2 = NewAnimationDrawable.this.mInvalidHandler;
          if (i != 0)
          {
            ((Handler)localObject2).sendEmptyMessageDelayed(0, l);
            ImageManagerEnv.getLogger().d("NewAnimationDrawable", new Object[] { "get from decoder:index=" + NewAnimationDrawable.this.mCurFrameIndex });
            return;
          }
        }
        l = NewAnimationDrawable.this.mDelayTime;
      }
    }
  }
  
  static class FrameRef
  {
    int mBmpGenerationId;
    BitmapReference mBmpRef;
    
    public FrameRef(BitmapReference paramBitmapReference)
    {
