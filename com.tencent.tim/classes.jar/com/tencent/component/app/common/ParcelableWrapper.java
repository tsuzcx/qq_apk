  ...
  implements Parcelable
{
  ...
  private static ClassLoader getClassLoader()
  {
    ...
    try
    {
      sClassLoader = QzonePluginProxyActivity.c(localBaseApplication);
      if (sClassLoader == null) {
  ...
  /* Error */
  private static ParcableInfo getParcableInfo(String paramString, Class paramClass)
  {
    // Byte code:
    //   0: aload_0
    //   1: ifnonnull +13 -> 14
    //   4: new 187	java/lang/NullPointerException
    //   7: dup
    //   8: ldc 189
    //   10: invokespecial 192	java/lang/NullPointerException:<init>	(Ljava/lang/String;)V
    //   13: athrow
    //   14: getstatic 64	com/tencent/component/app/common/ParcelableWrapper:sParcableCache	Ljava/util/concurrent/ConcurrentHashMap;
    //   17: aload_0
    //   18: invokevirtual 196	java/util/concurrent/ConcurrentHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   21: checkcast 8	com/tencent/component/app/common/ParcelableWrapper$ParcableInfo
    //   24: astore_3
    //   25: aload_3
    //   26: astore_2
    //   27: aload_3
    ...
    //   33: aload_1
    //   34: ifnonnull +11 -> 45
    //   37: invokestatic 93	com/tencent/component/app/common/ParcelableWrapper:getClassLoader	()Ljava/lang/ClassLoader;
    //   40: aload_0
    //   41: invokestatic 202	com/tencent/ditto/utils/ClassLoadUtils:load	(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Class;
    //   44: astore_2
    //   45: aload_2
    //   46: monitorenter
    //   47: getstatic 64	com/tencent/component/app/common/ParcelableWrapper:sParcableCache	Ljava/util/concurrent/ConcurrentHashMap;
    //   50: aload_0
    //   51: invokevirtual 196	java/util/concurrent/ConcurrentHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   54: checkcast 8	com/tencent/component/app/common/ParcelableWrapper$ParcableInfo
    //   57: astore_3
    //   58: aload_3
    //   59: astore_1
    //   60: aload_3
    //   61: ifnonnull +17 -> 78
    //   64: aload_2
    //   65: invokestatic 206	com/tencent/component/app/common/ParcelableWrapper:parseParcableInfo	(Ljava/lang/Class;)Lcom/tencent/component/app/common/ParcelableWrapper$ParcableInfo;
    //   68: astore_1
    //   69: getstatic 64	com/tencent/component/app/common/ParcelableWrapper:sParcableCache	Ljava/util/concurrent/ConcurrentHashMap;
    //   72: aload_0
    //   73: aload_1
    //   74: invokevirtual 210	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   77: pop
    //   78: aload_2
    //   79: monitorexit
    //   80: aload_1
    ...
    //   84: astore_1
    //   85: ldc 169
    //   87: new 212	java/lang/StringBuilder
    //   90: dup
    //   91: invokespecial 213	java/lang/StringBuilder:<init>	()V
    //   94: ldc 215
    ...
    //   103: invokevirtual 223	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   106: aload_1
    //   107: invokestatic 226	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   110: new 228	java/lang/RuntimeException
    //   113: dup
    //   114: new 212	java/lang/StringBuilder
    //   117: dup
    //   118: invokespecial 213	java/lang/StringBuilder:<init>	()V
    //   121: ldc 230
    //   123: invokevirtual 219	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   126: aload_0
    //   127: invokevirtual 219	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   130: invokevirtual 223	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   133: invokespecial 231	java/lang/RuntimeException:<init>	(Ljava/lang/String;)V
    //   136: athrow
    //   137: astore_0
    //   138: aload_2
    //   139: monitorexit
    ...
    //   24	37	3	localParcableInfo	ParcableInfo
    // Exception table:
    //   from	to	target	type
  ...
  private static ParcableInfo parseParcableInfo(Class paramClass)
  {
    Field[] arrayOfField = paramClass.getDeclaredFields();
    ParcableInfo localParcableInfo = new ParcableInfo();
    ParcableInfo.access$002(localParcableInfo, paramClass);
    List localList1 = localParcableInfo.fields;
    List localList2 = localParcableInfo.fieldTypes;
    ...
    if (SmartParcelable.class.isAssignableFrom((Class)localObject))
    {
      ...
      localList1.addAll(((ParcableInfo)localObject).fields);
      localList2.addAll(((ParcableInfo)localObject).fieldTypes);
    }
  ...
  {
    // Byte code:
    //   0: getstatic 72	com/tencent/component/app/common/ParcelableWrapper:sOwnedPool	[Lcom/tencent/component/app/common/ParcelableWrapper;
    //   3: astore_2
    //   4: aload_2
    //   5: monitorenter
    //   6: iconst_0
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localObject3 = ((ParcableInfo)localObject1).fields;
      localObject1 = ((ParcableInfo)localObject1).fieldTypes;
      try
      {
