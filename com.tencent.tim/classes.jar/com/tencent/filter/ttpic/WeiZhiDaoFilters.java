...
public class WeiZhiDaoFilters
{
    ...
    extends BaseFilter
  {
    ...
    public void applyFilterChain(boolean paramBoolean, float paramFloat1, float paramFloat2)
    {
      ...
      ((BaseFilter)localObject).addParam(new TextureResParam("inputImageTexture2", "weizhidao/kafei_lf.png", 33986));
    ...
    extends BaseFilter
  {
    ...
    public void applyFilterChain(boolean paramBoolean, float paramFloat1, float paramFloat2)
    {
      ...
      setNextFilter(localBaibianFilter, null);
      localObject = new GPUImageLookupFilter();
      ((BaseFilter)localObject).addParam(new TextureResParam("inputImageTexture2", "weizhidao/meiwei_lf.png", 33986));
      localBaibianFilter.setNextFilter((BaseFilter)localObject, null);
      super.applyFilterChain(paramBoolean, paramFloat1, paramFloat2);
    }
  }
    ...
    extends BaseFilter
  {
    ...
    public void applyFilterChain(boolean paramBoolean, float paramFloat1, float paramFloat2)
    {
      ...
      setNextFilter(localBaibianFilter, null);
      localObject = new GPUImageLookupFilter();
      ((BaseFilter)localObject).addParam(new TextureResParam("inputImageTexture2", "weizhidao/tianpin_lf.png", 33986));
      localBaibianFilter.setNextFilter((BaseFilter)localObject, null);
      super.applyFilterChain(paramBoolean, paramFloat1, paramFloat2);
    }
  }
    ...
    extends BaseFilter
  {
    ...
    public void applyFilterChain(boolean paramBoolean, float paramFloat1, float paramFloat2)
    {
      ...
      setNextFilter(localBaibianFilter, null);
      localObject = new GPUImageLookupFilter();
      ((BaseFilter)localObject).addParam(new TextureResParam("inputImageTexture2", "weizhidao/xican_lf.png", 33986));
      localBaibianFilter.setNextFilter((BaseFilter)localObject, null);
      super.applyFilterChain(paramBoolean, paramFloat1, paramFloat2);
    }
  }
