...
public final class CmdModAccountReq
  extends BaseProtoBuf
{
  ...
  public final CmdModAccountReq parseFrom(byte[] paramArrayOfByte)
    throws IOException
  {
  ...
  public final boolean populateBuilderWithField(InputReader paramInputReader, CmdModAccountReq paramCmdModAccountReq, int paramInt)
    throws IOException
  {
    Object localObject2;
    Object localObject1;
    ...
    case 1: 
      ...
      while (paramInt < i)
      {
        ...
        paramCmdModAccountReq.account_info = ((EmailAccountInfo)localObject1);
        paramInt += 1;
      }
      return true;
    }
    ...
    while (paramInt < i)
    {
      ...
      paramCmdModAccountReq.verify_code = ((VerifyCodeAnswer)localObject1);
      paramInt += 1;
    }
    return true;
  }
 ...
 * Qualified Name:     com.tencent.qqmail.protocol.UMA.CmdModAccountReq
