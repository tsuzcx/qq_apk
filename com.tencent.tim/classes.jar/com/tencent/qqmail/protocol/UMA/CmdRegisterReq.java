...
public final class CmdRegisterReq
  extends BaseProtoBuf
{
  private static final int fieldNumberDevice_id = 1;
  private static final int fieldNumberDevice_info = 4;
  ...
  public final int computeSize()
  {
    ...
    if (this.device_info != null) {
      i = j + ComputeSizeUtil.computeStringSize(4, this.device_info);
    }
    return i;
  }
  
  public final CmdRegisterReq parseFrom(byte[] paramArrayOfByte)
    throws IOException
  {
  ...
  public final boolean populateBuilderWithField(InputReader paramInputReader, CmdRegisterReq paramCmdRegisterReq, int paramInt)
    throws IOException
  {
    switch (paramInt)
    {
    default: 
      return false;
    case 1: 
      paramCmdRegisterReq.device_id = paramInputReader.readString(paramInt);
      return true;
    case 2: 
      paramCmdRegisterReq.rsp_key = paramInputReader.readByteString(paramInt);
      return true;
    case 3: 
      ...
      while (paramInt < i)
      {
        ...
        paramCmdRegisterReq.verify_code = localVerifyCodeAnswer;
        paramInt += 1;
      }
      return true;
    }
    paramCmdRegisterReq.device_info = paramInputReader.readString(paramInt);
    return true;
  }
    ...
    throws IOException
  {
    ...
    if (this.device_info != null) {
      paramOutputWriter.writeString(4, this.device_info);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.qqmail.protocol.UMA.CmdRegisterReq
