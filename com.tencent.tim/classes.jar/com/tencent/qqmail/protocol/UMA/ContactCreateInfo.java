...
public final class ContactCreateInfo
  extends BaseProtoBuf
{
  ...
  public final ContactCreateInfo parseFrom(byte[] paramArrayOfByte)
    throws IOException
  {
  ...
  public final boolean populateBuilderWithField(InputReader paramInputReader, ContactCreateInfo paramContactCreateInfo, int paramInt)
    throws IOException
  {
    switch (paramInt)
    {
    ...
    case 1: 
      ...
      while (paramInt < i)
      {
        ...
        paramContactCreateInfo.contact_list.add(localContacts);
        paramInt += 1;
      }
      return true;
    }
    paramContactCreateInfo.account_address = paramInputReader.readString(paramInt);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.qqmail.protocol.UMA.ContactCreateInfo
