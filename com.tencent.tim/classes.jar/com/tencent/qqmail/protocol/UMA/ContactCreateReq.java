...
public final class ContactCreateReq
  extends BaseProtoBuf
{
  ...
  public final ContactCreateReq parseFrom(byte[] paramArrayOfByte)
    throws IOException
  {
  ...
  public final boolean populateBuilderWithField(InputReader paramInputReader, ContactCreateReq paramContactCreateReq, int paramInt)
    throws IOException
  {
    switch (paramInt)
    {
    ...
    while (paramInt < i)
    {
      ...
      paramContactCreateReq.create_info = localContactCreateInfo;
      paramInt += 1;
    }
    return true;
  }
 ...
 * Qualified Name:     com.tencent.qqmail.protocol.UMA.ContactCreateReq
