...
public final class DelEMailNicknameReqInfo
  extends BaseProtoBuf
{
  ...
  public final DelEMailNicknameReqInfo parseFrom(byte[] paramArrayOfByte)
    throws IOException
  {
  ...
  public final boolean populateBuilderWithField(InputReader paramInputReader, DelEMailNicknameReqInfo paramDelEMailNicknameReqInfo, int paramInt)
    throws IOException
  {
    switch (paramInt)
    {
    default: 
      return false;
    case 1: 
      paramDelEMailNicknameReqInfo.email = paramInputReader.readString(paramInt);
      return true;
    }
    ...
    while (paramInt < i)
    {
      ...
      paramDelEMailNicknameReqInfo.info = localEmailProtocolInfo;
      paramInt += 1;
    }
    return true;
  }
 ...
 * Qualified Name:     com.tencent.qqmail.protocol.UMA.DelEMailNicknameReqInfo
