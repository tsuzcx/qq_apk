  ...
  extends BaseAdapter
{
  ...
  private void setThumbTypeImage(String paramString, ImageView paramImageView, View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localDownloadInfo.setImageDownloadListener(new ComposeFtnListAdapter.1(this, paramInt, paramView, paramImageView));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((paramView == null) || (paramView.getTag() == null))
    {
      ...
      localObject = (QMListItemView)localView;
      ((QMListItemView)localObject).bindItemChevron(paramView.chevron);
      ((QMListItemView)localObject).setItemToEditMode();
      paramView.ftn_filename.setText(getFileName(localFileInfo));
    ...
    for (;;)
    {
      if ((this.checkedFids.contains(localFileInfo.fid)) && (!this.listView.isItemChecked(paramInt))) {
        this.listView.setItemChecked(paramInt, true);
      }
 ...
 * Qualified Name:     com.tencent.qqmail.ftn.activity.ComposeFtnListAdapter
