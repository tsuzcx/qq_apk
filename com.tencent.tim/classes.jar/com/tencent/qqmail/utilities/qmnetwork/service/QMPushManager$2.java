...
final class QMPushManager$2
  implements Runnable
{
  QMPushManager$2(CreditCardBill paramCreditCardBill) {}
  ...
  public void run()
  {
    ...
    {
      localObject = ((QMUIDialog.MessageDialogBuilder)((QMUIDialog.MessageDialogBuilder)((QMUIDialog.MessageDialogBuilder)new QMUIDialog.MessageDialogBuilder(localActivity).setTitle(2131718776)).setMessage((CharSequence)localObject).addAction(2131691552, new QMPushManager.2.2(this))).addAction(0, 2131694372, 0, new QMPushManager.2.1(this, localActivity))).create();
 ...
 * Qualified Name:     com.tencent.qqmail.utilities.qmnetwork.service.QMPushManager.2
