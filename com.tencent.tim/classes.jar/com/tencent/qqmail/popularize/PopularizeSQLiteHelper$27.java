...
class PopularizeSQLiteHelper$27
  implements IReducer<Popularize>
{
  PopularizeSQLiteHelper$27(PopularizeSQLiteHelper paramPopularizeSQLiteHelper, PopularizeSubItem paramPopularizeSubItem, boolean paramBoolean) {}
    ...
    if ((paramPopularize != null) && (paramPopularize.size() > 0))
    {
      ...
      while (paramPopularize.hasNext())
      {
        ...
        if (localPopularizeSubItem.getId() == this.val$subitem.getId()) {
          localPopularizeSubItem.setIsClickMyApp(this.val$isClickMyApp);
        }
      }
    }
  }
 ...
 * Qualified Name:     com.tencent.qqmail.popularize.PopularizeSQLiteHelper.27
