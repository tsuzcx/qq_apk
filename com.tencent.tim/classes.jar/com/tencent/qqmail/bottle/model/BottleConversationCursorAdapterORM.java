...
public class BottleConversationCursorAdapterORM
  implements CursorAdapterORM<BottleConversation>
{
  ...
  public BottleConversationCursorAdapterORM(Cursor paramCursor)
  {
    this.mCursor = paramCursor;
  }
  
  public BottleConversationCursorAdapterORM(SQLiteDatabase paramSQLiteDatabase, String paramString, String[] paramArrayOfString)
  {
    this.mCursor = BottleConversationORM.rawQuery(paramSQLiteDatabase, paramString, paramArrayOfString);
  ...
  public BottleConversation getItem(int paramInt)
  {
    ...
    if (this.mCursor != null)
    {
      ...
      localObject = BottleConversationORM.fill(this.mCursor, null);
    }
    return localObject;
  }
  ...
  public BottleConversation getItem(int paramInt, BottleConversation paramBottleConversation)
  {
    if (this.mCursor != null)
    {
      ...
      return BottleConversationORM.fill(this.mCursor, paramBottleConversation);
    }
    return null;
  }
 ...
 * Qualified Name:     com.tencent.qqmail.bottle.model.BottleConversationCursorAdapterORM
