...
{
  public static BottleListController.BottleListOverdueData fill(Cursor paramCursor, BottleListController.BottleListOverdueData paramBottleListOverdueData)
  {
    boolean bool = true;
    if (paramCursor == null) {
      throw new IllegalArgumentException("cursor null");
    }
    BottleListController.BottleListOverdueData localBottleListOverdueData = paramBottleListOverdueData;
    if (paramBottleListOverdueData == null) {
      localBottleListOverdueData = new BottleListController.BottleListOverdueData();
    }
  ...
  public static void replace(SQLiteDatabase paramSQLiteDatabase, BottleListController.BottleListOverdueData paramBottleListOverdueData)
  {
    int i = 0;
  ...
  public static void update(SQLiteDatabase paramSQLiteDatabase, BottleListController.BottleListOverdueData paramBottleListOverdueData)
  {
    if (paramBottleListOverdueData.convOverdue) {}
    for (int i = 1;; i = 0)
    {
 ...
 * Qualified Name:     com.tencent.qqmail.bottle.controller.BottleListController_BottleListOverdueDataORM
