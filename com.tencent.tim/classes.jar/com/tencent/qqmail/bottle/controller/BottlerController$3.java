...
class BottlerController$3
  extends QMCallback
{
  BottlerController$3(BottlerController paramBottlerController, boolean paramBoolean) {}
  ...
  {
    QMLog.log(6, "BottlerController", "submitMyGender: error:" + paramQMNetworkError);
  ...
  {
    QMLog.log(4, "BottlerController", "submitMyGender: success");
    paramQMNetworkRequest = new BottlerController.MyInformationData(BottlerController.access$200(this.this$0).getUin(), BottlerController.access$200(this.this$0).getName(), BottlerController.access$200(this.this$0).getAvatar(), BottlerController.access$200(this.this$0).getBigAvatar(), this.val$isMale);
 ...
 * Qualified Name:     com.tencent.qqmail.bottle.controller.BottlerController.3
