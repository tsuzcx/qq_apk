...
public class QMAllSentMailListCursor
  extends QMLocalHybirdMailListCursor
  implements MailListUtil.IDraftAlike
{
  private Cursor mContactCursor = null;
  
  public QMAllSentMailListCursor(QMMailSQLiteHelper paramQMMailSQLiteHelper)
  {
  ...
  public Cursor queryForRelativeContacts()
  {
    ...
    return this.sqliteHelper.mail.queryForRelativeContacts(localSQLiteDatabase, null, 3);
  }
  
  protected Cursor queryHybirdRawCursor()
  {
    return this.sqliteHelper.mail.getAllSentMailListCursor(this.sqliteHelper.getReadableDatabase());
  }
 ...
 * Qualified Name:     com.tencent.qqmail.model.mail.cursor.QMAllSentMailListCursor
