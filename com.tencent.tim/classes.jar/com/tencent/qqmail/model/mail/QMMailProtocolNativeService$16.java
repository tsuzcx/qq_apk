...
class QMMailProtocolNativeService$16
  extends SimpleOnProtocolListener
{
  QMMailProtocolNativeService$16(QMMailProtocolNativeService paramQMMailProtocolNativeService, MailManagerDelegate paramMailManagerDelegate, Profile paramProfile, int paramInt) {}
  
  public void onResult(ProtocolResult paramProtocolResult)
  {
    QMLog.log(6, "QMMailProtocolNativeService", "starMails result: " + paramProtocolResult.error_code_);
    ...
    {
      QMMailProtocolNativeService.access$100(this.this$0, this.val$profile, "starMails", true);
      return;
      ...
      {
        QMLog.log(6, "QMMailProtocolNativeService", "starMails error : " + paramProtocolResult.error_code_);
        localQMProtocolError = new QMProtocolError(paramProtocolResult.error_code_);
        if (this.val$callback != null) {
          this.val$callback.handleError(localQMProtocolError);
        }
    ...
    QMMailProtocolNativeService.access$100(this.this$0, this.val$profile, "starMails", false);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.tim\classes11.jar
 * Qualified Name:     com.tencent.qqmail.model.mail.QMMailProtocolNativeService.16
