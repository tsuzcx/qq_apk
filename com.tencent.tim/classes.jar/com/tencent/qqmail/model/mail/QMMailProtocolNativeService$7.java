...
class QMMailProtocolNativeService$7
  extends SimpleOnProtocolListener
{
  QMMailProtocolNativeService$7(QMMailProtocolNativeService paramQMMailProtocolNativeService, QMFolder paramQMFolder, IListStatusCallback paramIListStatusCallback, Profile paramProfile) {}
  ...
  public void onResult(ProtocolResult paramProtocolResult)
  {
    ...
    if (paramProtocolResult.error_code_ == 0) {
      if ((this.val$folder.isOverdue()) || (paramProtocolResult.exchange_content_.created_mail_list_.length > 0) || (paramProtocolResult.exchange_content_.deleted_mail_list_.length > 0) || (paramProtocolResult.exchange_content_.updated_mail_list_.length > 0) || (paramProtocolResult.exchange_content_.unread_mail_list_.length > 0) || (paramProtocolResult.exchange_content_.read_mail_list_.length > 0))
      {
        bool = true;
 ...
 * Qualified Name:     com.tencent.qqmail.model.mail.QMMailProtocolNativeService.7
