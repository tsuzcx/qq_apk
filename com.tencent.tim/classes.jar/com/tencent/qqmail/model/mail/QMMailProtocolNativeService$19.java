...
class QMMailProtocolNativeService$19
  extends SimpleOnProtocolListener
{
  QMMailProtocolNativeService$19(QMMailProtocolNativeService paramQMMailProtocolNativeService, MailManagerDelegate paramMailManagerDelegate, Profile paramProfile, int paramInt) {}
  
  public void onResult(ProtocolResult paramProtocolResult)
  {
    QMLog.log(6, "QMMailProtocolNativeService", "removeMail result: " + paramProtocolResult.error_code_);
    ...
    {
      QMMailProtocolNativeService.access$100(this.this$0, this.val$profile, "removeMails", true);
      return;
      ...
      {
        QMLog.log(6, "QMMailProtocolNativeService", "removeMail error : " + paramProtocolResult.error_code_);
        localQMProtocolError = new QMProtocolError(paramProtocolResult.error_code_);
        if (this.val$callback != null) {
          this.val$callback.handleError(localQMProtocolError);
        }
    ...
    QMMailProtocolNativeService.access$100(this.this$0, this.val$profile, "removeMails", false);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.tim\classes11.jar
 * Qualified Name:     com.tencent.qqmail.model.mail.QMMailProtocolNativeService.19
