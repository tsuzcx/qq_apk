...
class QMCalendarProtocolManager$3
  extends CalendarCallback
{
  QMCalendarProtocolManager$3(QMCalendarProtocolManager paramQMCalendarProtocolManager, CalendarInfo paramCalendarInfo, Account paramAccount, MailManagerDelegate paramMailManagerDelegate) {}
  
  public void onResult(CalendarResult paramCalendarResult)
  {
    QMLog.log(4, "QMCalendarProtocolManager", "removeCalendarFolder ok? " + paramCalendarResult.code);
    Object localObject;
 ...
 * Qualified Name:     com.tencent.qqmail.calendar.model.QMCalendarProtocolManager.3
