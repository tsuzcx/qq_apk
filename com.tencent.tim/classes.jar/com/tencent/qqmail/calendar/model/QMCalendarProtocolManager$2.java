...
class QMCalendarProtocolManager$2
  extends CalendarCallback
{
  QMCalendarProtocolManager$2(QMCalendarProtocolManager paramQMCalendarProtocolManager, CalendarInfo paramCalendarInfo, Account paramAccount, MailManagerDelegate paramMailManagerDelegate) {}
  
  public void onResult(CalendarResult paramCalendarResult)
  {
    QMLog.log(4, "QMCalendarProtocolManager", "addCalendarFolder ok? " + paramCalendarResult.code);
    Object localObject;
 ...
 * Qualified Name:     com.tencent.qqmail.calendar.model.QMCalendarProtocolManager.2
