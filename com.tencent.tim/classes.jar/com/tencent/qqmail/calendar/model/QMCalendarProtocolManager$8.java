...
class QMCalendarProtocolManager$8
  extends CalendarCallback
{
  QMCalendarProtocolManager$8(QMCalendarProtocolManager paramQMCalendarProtocolManager, CalendarInfo paramCalendarInfo, Account paramAccount, QMCalendarFolder paramQMCalendarFolder, MailManagerDelegate paramMailManagerDelegate) {}
  
  public void onResult(CalendarResult paramCalendarResult)
  {
    QMLog.log(4, "QMCalendarProtocolManager", "updateEvent ok? " + paramCalendarResult.code);
 ...
 * Qualified Name:     com.tencent.qqmail.calendar.model.QMCalendarProtocolManager.8
