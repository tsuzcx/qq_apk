...
class QMUmaManager$14
  implements Action1<QMUmaManager.QMUmaResult>
{
  QMUmaManager$14(QMUmaManager paramQMUmaManager) {}
  ...
  public void call(QMUmaManager.QMUmaResult paramQMUmaResult)
  {
    ...
    try
    {
      ...
      localCloudProtocolResult.query_sec_app_rsp_ = new CmdQuerySecAppRsp().parseFrom(paramQMUmaResult.decryptedPkg);
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        ...
        QMLog.log(5, "QMUmaManager", "general result.query_sec_app_rsp_ error: " + localIOException.getMessage());
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.qqmail.uma.QMUmaManager.14
