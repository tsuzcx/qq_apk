...
class QMUmaManager$33
  implements Action1<QMUmaManager.QMUmaResult>
{
  QMUmaManager$33(QMUmaManager paramQMUmaManager) {}
  ...
  public void call(QMUmaManager.QMUmaResult paramQMUmaResult)
  {
    ...
    try
    {
      localCloudProtocolResult.contact_create_resp_ = new ContactCreateResp().parseFrom(paramQMUmaResult.decryptedPkg);
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        ...
        QMLog.log(5, "QMUmaManager", "general result.contact_create_resp_ error: " + localIOException.getMessage());
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.qqmail.uma.QMUmaManager.33
