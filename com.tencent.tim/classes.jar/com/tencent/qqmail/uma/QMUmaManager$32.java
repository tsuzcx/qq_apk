...
class QMUmaManager$32
  implements Action1<QMUmaManager.QMUmaResult>
{
  QMUmaManager$32(QMUmaManager paramQMUmaManager) {}
  ...
  public void call(QMUmaManager.QMUmaResult paramQMUmaResult)
  {
    ...
    try
    {
      localCloudProtocolResult.contact_modify_resp_ = new ContactModifyResp().parseFrom(paramQMUmaResult.decryptedPkg);
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        ...
        QMLog.log(5, "QMUmaManager", "general result.contact_modify_resp_ error: " + localIOException.getMessage());
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.qqmail.uma.QMUmaManager.32
