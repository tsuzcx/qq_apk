...
class QMUmaManager$24
  implements Action1<QMUmaManager.QMUmaResult>
{
  QMUmaManager$24(QMUmaManager paramQMUmaManager) {}
  ...
  public void call(QMUmaManager.QMUmaResult paramQMUmaResult)
  {
    ...
    try
    {
      ...
      localCloudProtocolResult.open_mobile_acct_rsp_ = new CmdOpenMobileAcctRsp().parseFrom(paramQMUmaResult.decryptedPkg);
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        ...
        QMLog.log(5, "QMUmaManager", "general result.open_mobile_acct_rsp_ error: " + localIOException.getMessage());
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.qqmail.uma.QMUmaManager.24
