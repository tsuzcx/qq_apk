...
class QMUmaManager$42
  implements Action1<QMUmaManager.QMUmaResult>
{
  QMUmaManager$42(QMUmaManager paramQMUmaManager) {}
  ...
  public void call(QMUmaManager.QMUmaResult paramQMUmaResult)
  {
    ...
    try
    {
      localCloudProtocolResult.get_thank_list_rsp_ = new GetThanksListRsp().parseFrom(paramQMUmaResult.decryptedPkg);
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        ...
        QMLog.log(5, "QMUmaManager", "general result.get_thank_list_rsp_ error: " + localIOException.getMessage());
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.qqmail.uma.QMUmaManager.42
