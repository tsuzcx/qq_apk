...
public class SettingCalendarDefaultDurationFragment
  extends SettingCalendarBaseFragment
{
  ...
  protected SettingCalendarDefaultDurationFragment()
  {
    super(false);
  }
  ...
  private void onBack()
  {
    if (this.mRemindTime.hasChange()) {
      this.qmCalendarManager.modifyDefaultEventDuration(this.mRemindTime.getSelectedItem());
    }
    popBackStack();
  }
  ...
  {
    this.defaultEventDuration = this.qmCalendarManager.getDefaultEventDuration();
  }
  ...
  public void initDom(View paramView, QMBaseFragment.ViewHolder paramViewHolder, Bundle paramBundle)
  {
    ...
    this.mRemindTime.addItem(30, 2131691109);
    this.mRemindTime.addItem(60, 2131691108);
    this.mRemindTime.addItem(120, 2131691111);
    this.mRemindTime.addItem(180, 2131691110);
    this.mRemindTime.commit();
    this.mRemindTime.setSelectedItem(this.defaultEventDuration);
  }
  
  public void initTopbar(View paramView)
  {
    this.mTopBar = getTopBar();
    this.mTopBar.setTitle(2131719688);
    this.mTopBar.setButtonLeftBack();
    this.mTopBar.setButtonLeftOnclickListener(new SettingCalendarDefaultDurationFragment.1(this));
 ...
 * Qualified Name:     com.tencent.qqmail.activity.setting.SettingCalendarDefaultDurationFragment
