...
public class ReadIcsAttendeeFragment
  extends MailFragment
{
  ...
  private void initTopBar()
  {
    ...
    localQMTopBar.setTitle(2131694727);
    ...
    if (this.event != null)
    {
      ...
      if (localObject != null)
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          {
          default: 
            this.noResponseList.add(localAttendee.getName());
            break;
          case 3: 
            this.acceptList.add(localAttendee.getName());
            break;
          case 2: 
            this.tentativeList.add(localAttendee.getName());
            break;
          case 4: 
            this.declineList.add(localAttendee.getName());
            break;
          case 5: 
            this.noResponseList.add(localAttendee.getName());
          }
  ...
  public void initDom(View paramView, QMBaseFragment.ViewHolder paramViewHolder, Bundle paramBundle)
  {
    ...
    while (paramView.hasNext())
    {
      ...
      paramBundle.setTitle(paramViewHolder.getName());
 ...
 * Qualified Name:     com.tencent.qqmail.activity.readmail.ReadIcsAttendeeFragment
