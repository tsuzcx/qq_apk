  ...
  implements IDecoderTrack.SurfaceCreator
{
  ...
  private void eglSetup(EGLContext paramEGLContext)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokestatic 152	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   6: invokevirtual 156	java/lang/Thread:getId	()J
    ...
    //   26: aload_0
    //   27: iconst_0
    //   28: invokestatic 199	android/opengl/EGL14:eglGetDisplay	(I)Landroid/opengl/EGLDisplay;
    //   31: putfield 201	com/tencent/tav/decoder/RenderContext:eglDisplay	Landroid/opengl/EGLDisplay;
    //   34: aload_0
    //   35: getfield 201	com/tencent/tav/decoder/RenderContext:eglDisplay	Landroid/opengl/EGLDisplay;
    //   38: getstatic 204	android/opengl/EGL14:EGL_NO_DISPLAY	Landroid/opengl/EGLDisplay;
    //   41: if_acmpne +31 -> 72
    //   44: new 99	java/lang/RuntimeException
    //   47: dup
    //   48: ldc 206
    ...
    //   59: astore_1
    //   60: aload_1
    //   61: invokevirtual 209	java/lang/Throwable:printStackTrace	()V
    //   64: goto -41 -> 23
    //   67: astore_1
    //   68: aload_0
    //   69: monitorexit
    ...
    //   75: astore 5
    //   77: aload_0
    //   78: getfield 201	com/tencent/tav/decoder/RenderContext:eglDisplay	Landroid/opengl/EGLDisplay;
    //   81: aload 5
    //   83: iconst_0
    //   84: aload 5
    //   86: iconst_1
    //   87: invokestatic 213	android/opengl/EGL14:eglInitialize	(Landroid/opengl/EGLDisplay;[II[II)Z
    //   90: ifne +23 -> 113
    //   93: aload_0
    //   94: aconst_null
    //   95: putfield 201	com/tencent/tav/decoder/RenderContext:eglDisplay	Landroid/opengl/EGLDisplay;
    //   98: new 99	java/lang/RuntimeException
    //   101: dup
    //   102: ldc 215
    ...
    //   110: goto -87 -> 23
    //   113: iconst_1
    //   114: anewarray 217	android/opengl/EGLConfig
    //   117: astore 5
    //   119: iconst_1
    //   120: newarray int
    //   122: astore 6
    //   124: aload_0
    //   125: getfield 201	com/tencent/tav/decoder/RenderContext:eglDisplay	Landroid/opengl/EGLDisplay;
    //   128: astore 7
    //   130: aload 5
    //   132: arraylength
    //   133: istore_2
    ...
    //   209: aload 6
    //   211: iconst_0
    //   212: invokestatic 221	android/opengl/EGL14:eglChooseConfig	(Landroid/opengl/EGLDisplay;[II[Landroid/opengl/EGLConfig;II[II)Z
    //   215: ifne +18 -> 233
    //   218: new 99	java/lang/RuntimeException
    //   221: dup
    //   222: ldc 223
    ...
    //   266: aload_0
    //   267: aload_0
    //   268: getfield 201	com/tencent/tav/decoder/RenderContext:eglDisplay	Landroid/opengl/EGLDisplay;
    //   271: aload 5
    //   273: iconst_0
    //   274: aaload
    //   275: aload_1
    //   276: aload 6
    //   278: iconst_0
    //   279: invokestatic 227	android/opengl/EGL14:eglCreateContext	(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;Landroid/opengl/EGLContext;[II)Landroid/opengl/EGLContext;
    //   282: putfield 229	com/tencent/tav/decoder/RenderContext:_eglContext	Landroid/opengl/EGLContext;
    //   285: ldc 230
    //   287: invokestatic 179	com/tencent/tav/decoder/RenderContext:checkEglError	(Ljava/lang/String;)V
    //   290: aload_0
    //   291: getfield 229	com/tencent/tav/decoder/RenderContext:_eglContext	Landroid/opengl/EGLContext;
    //   294: ifnonnull +66 -> 360
    //   297: new 99	java/lang/RuntimeException
    //   300: dup
    //   301: ldc 232
    ...
    //   312: aload_0
    //   313: aload_0
    //   314: getfield 201	com/tencent/tav/decoder/RenderContext:eglDisplay	Landroid/opengl/EGLDisplay;
    //   317: aload 5
    //   319: iconst_0
    //   320: aaload
    //   321: getstatic 235	android/opengl/EGL14:EGL_NO_CONTEXT	Landroid/opengl/EGLContext;
    //   324: aload 6
    //   326: iconst_0
    //   327: invokestatic 227	android/opengl/EGL14:eglCreateContext	(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;Landroid/opengl/EGLContext;[II)Landroid/opengl/EGLContext;
    //   330: putfield 229	com/tencent/tav/decoder/RenderContext:_eglContext	Landroid/opengl/EGLContext;
    //   333: ldc 230
    //   335: invokestatic 179	com/tencent/tav/decoder/RenderContext:checkEglError	(Ljava/lang/String;)V
    //   338: aload_0
    //   339: getfield 229	com/tencent/tav/decoder/RenderContext:_eglContext	Landroid/opengl/EGLContext;
    //   342: ifnonnull +18 -> 360
    //   345: new 99	java/lang/RuntimeException
    //   348: dup
    //   349: ldc 232
    ...
    //   367: aload_0
    //   368: aload_0
    //   369: getfield 201	com/tencent/tav/decoder/RenderContext:eglDisplay	Landroid/opengl/EGLDisplay;
    //   372: aload 5
    //   374: iconst_0
    //   375: aaload
    //   376: aload_0
    ...
    //   388: iastore
    //   389: iconst_0
    //   390: invokestatic 239	android/opengl/EGL14:eglCreateWindowSurface	(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;Ljava/lang/Object;[II)Landroid/opengl/EGLSurface;
    //   393: putfield 241	com/tencent/tav/decoder/RenderContext:eglSurface	Landroid/opengl/EGLSurface;
    //   396: ldc 242
    //   398: invokestatic 145	com/tencent/tav/decoder/RenderContext:checkEglActionSuccess	(Ljava/lang/String;)Z
    //   401: ifeq +8 -> 409
    //   404: aload_0
    //   405: iconst_1
    //   406: putfield 68	com/tencent/tav/decoder/RenderContext:pBufferEnable	Z
    //   409: aload_0
    //   410: getfield 241	com/tencent/tav/decoder/RenderContext:eglSurface	Landroid/opengl/EGLSurface;
    //   413: ifnonnull -390 -> 23
    //   416: new 99	java/lang/RuntimeException
    //   419: dup
    //   420: ldc 244
    ...
    //   441: aload_0
    //   442: aload_0
    //   443: getfield 201	com/tencent/tav/decoder/RenderContext:eglDisplay	Landroid/opengl/EGLDisplay;
    //   446: aload 5
    //   448: iconst_0
    //   449: aaload
    //   450: iconst_5
    ...
    //   478: iastore
    //   479: iconst_0
    //   480: invokestatic 248	android/opengl/EGL14:eglCreatePbufferSurface	(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;[II)Landroid/opengl/EGLSurface;
    //   483: putfield 241	com/tencent/tav/decoder/RenderContext:eglSurface	Landroid/opengl/EGLSurface;
    //   486: goto -90 -> 396
    //   489: astore_1
    //   490: goto -430 -> 60
  ...
  private void release(Surface paramSurface)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokespecial 287	com/tencent/tav/decoder/RenderContext:checkThread	()V
    //   6: aload_1
    //   7: ifnonnull +6 -> 13
    //   10: aload_0
    //   11: monitorexit
    ...
    //   17: aload_1
    //   18: invokevirtual 291	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   21: ifeq +17 -> 38
    //   24: aload_0
    //   25: getfield 73	com/tencent/tav/decoder/RenderContext:videoTextureMap	Ljava/util/HashMap;
    //   28: aload_1
    //   29: invokevirtual 295	java/util/HashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   32: checkcast 297	com/tencent/tav/decoder/VideoTexture
    //   35: invokevirtual 299	com/tencent/tav/decoder/VideoTexture:release	()V
    //   38: aload_1
    //   39: invokevirtual 302	android/view/Surface:release	()V
    //   42: goto -32 -> 10
    //   45: astore_1
    //   46: aload_0
    //   47: monitorexit
  ...
  public void free(Surface paramSurface)
  {
    ...
    //   1: monitorenter
    //   2: ldc 15
    //   4: new 101	java/lang/StringBuilder
    //   7: dup
    ...
    //   17: invokestatic 152	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   20: invokevirtual 156	java/lang/Thread:getId	()J
    //   23: invokevirtual 348	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   26: invokevirtual 129	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   29: invokestatic 352	com/tencent/tav/decoder/logger/Logger:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   32: aload_1
    //   33: ifnonnull +6 -> 39
    //   36: aload_0
    //   37: monitorexit
    ...
    //   43: aload_1
    //   44: invokevirtual 295	java/util/HashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   47: checkcast 354	java/lang/String
    //   50: astore_2
    //   51: aload_2
    //   52: invokestatic 360	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   55: ifne +14 -> 69
    //   58: aload_0
    //   59: getfield 77	com/tencent/tav/decoder/RenderContext:freeSurfaceCache	Ljava/util/HashMap;
    //   62: aload_2
    //   63: invokevirtual 291	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   66: ifne +3 -> 69
    //   69: aload_0
    //   70: getfield 82	com/tencent/tav/decoder/RenderContext:releasingSurfaceCache	Ljava/util/List;
    //   73: aload_1
    //   74: invokeinterface 363 2 0
    //   79: pop
    //   80: goto -44 -> 36
    //   83: astore_1
    //   84: aload_0
  ...
  public void makeCurrent()
  {
    ...
    //   17: return
    //   18: aload_0
    //   19: getfield 201	com/tencent/tav/decoder/RenderContext:eglDisplay	Landroid/opengl/EGLDisplay;
    //   22: aload_0
    //   23: getfield 241	com/tencent/tav/decoder/RenderContext:eglSurface	Landroid/opengl/EGLSurface;
    //   26: aload_0
    //   27: getfield 241	com/tencent/tav/decoder/RenderContext:eglSurface	Landroid/opengl/EGLSurface;
    //   30: aload_0
    //   31: getfield 229	com/tencent/tav/decoder/RenderContext:_eglContext	Landroid/opengl/EGLContext;
    //   34: invokestatic 392	android/opengl/EGL14:eglMakeCurrent	(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;Landroid/opengl/EGLSurface;Landroid/opengl/EGLContext;)Z
    //   37: ifne -22 -> 15
    //   40: ldc_w 394
    //   43: invokestatic 179	com/tencent/tav/decoder/RenderContext:checkEglError	(Ljava/lang/String;)V
    //   46: goto -31 -> 15
    //   49: astore_2
    //   50: aload_0
    //   51: monitorexit
  ...
  public void setPresentationTime(long paramLong)
  {
    ...
    //   18: ifnull -7 -> 11
    //   21: aload_0
    //   22: getfield 201	com/tencent/tav/decoder/RenderContext:eglDisplay	Landroid/opengl/EGLDisplay;
    //   25: aload_0
    //   26: getfield 241	com/tencent/tav/decoder/RenderContext:eglSurface	Landroid/opengl/EGLSurface;
    //   29: ldc2_w 451
    //   32: lload_1
    //   33: lmul
    //   34: invokestatic 458	android/opengl/EGLExt:eglPresentationTimeANDROID	(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;J)Z
    //   37: pop
    //   38: goto -27 -> 11
    //   41: astore 4
    //   43: aload_0
  ...
  public boolean swapBuffers()
  {
    ...
    //   25: aload_0
    //   26: getfield 241	com/tencent/tav/decoder/RenderContext:eglSurface	Landroid/opengl/EGLSurface;
    //   29: invokestatic 463	android/opengl/EGL14:eglSwapBuffers	(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z
    //   32: istore_1
    //   33: goto -16 -> 17
    //   36: astore_2
    //   37: aload_0
