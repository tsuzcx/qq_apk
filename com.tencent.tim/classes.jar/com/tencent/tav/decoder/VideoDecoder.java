  ...
  implements IVideoDecoder
{
  ...
  private CMTime doReadSample(CMTime paramCMTime, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          releaseOutputBuffer();
          localObject = new SampleTime(null);
  ...
  private void readFromExtractor()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 183	com/tencent/tav/decoder/VideoDecoder:extractor	Lcom/tencent/tav/extractor/AssetExtractor;
    //   6: invokevirtual 499	com/tencent/tav/extractor/AssetExtractor:getSampleTime	()J
    //   9: lstore_2
    //   10: lload_2
    //   11: aload_0
    //   12: getfield 244	com/tencent/tav/decoder/VideoDecoder:timeRange	Lcom/tencent/tav/coremedia/CMTimeRange;
    //   15: invokevirtual 546	com/tencent/tav/coremedia/CMTimeRange:getEndUs	()J
    //   18: lcmp
    //   19: ifge +22 -> 41
    //   22: aload_0
    //   23: getfield 183	com/tencent/tav/decoder/VideoDecoder:extractor	Lcom/tencent/tav/extractor/AssetExtractor;
    //   26: invokevirtual 480	com/tencent/tav/extractor/AssetExtractor:getSampleTrackIndex	()I
    //   29: iconst_m1
    //   30: if_icmpeq +11 -> 41
    //   33: lload_2
    //   34: ldc2_w 547
    ...
    //   41: lload_2
    //   42: aload_0
    //   43: getfield 244	com/tencent/tav/decoder/VideoDecoder:timeRange	Lcom/tencent/tav/coremedia/CMTimeRange;
    //   46: invokevirtual 546	com/tencent/tav/coremedia/CMTimeRange:getEndUs	()J
    //   49: lcmp
    //   50: iflt +7 -> 57
    //   53: aload_0
    //   54: invokespecial 551	com/tencent/tav/decoder/VideoDecoder:readSampleData	()V
    //   57: aload_0
    //   58: getfield 119	com/tencent/tav/decoder/VideoDecoder:mediaCodecWrapper	Lcom/tencent/tav/decoder/MediaCodecWrapper;
    //   61: invokevirtual 554	com/tencent/tav/decoder/MediaCodecWrapper:dequeueInputBuffer	()I
    //   64: istore_1
    //   65: iload_1
    //   66: iflt +20 -> 86
    //   69: aload_0
    //   70: getfield 119	com/tencent/tav/decoder/VideoDecoder:mediaCodecWrapper	Lcom/tencent/tav/decoder/MediaCodecWrapper;
    //   73: iload_1
    //   74: iconst_0
    //   75: iconst_0
    //   76: lconst_0
    //   77: iconst_4
    //   78: invokevirtual 558	com/tencent/tav/decoder/MediaCodecWrapper:queueInputBuffer	(IIIJI)V
    //   81: aload_0
    //   82: iconst_1
    //   83: putfield 158	com/tencent/tav/decoder/VideoDecoder:extractorDone	Z
    //   86: aload_0
    //   87: monitorexit
    //   88: return
    //   89: aload_0
    //   90: invokespecial 551	com/tencent/tav/decoder/VideoDecoder:readSampleData	()V
    //   93: goto -7 -> 86
    //   96: astore 4
    //   98: aload_0
    //   99: monitorexit
  ...
  public boolean hasTrack()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 112	com/tencent/tav/decoder/VideoDecoder:trackIndex	I
    //   6: istore_1
    //   7: iload_1
    //   8: iconst_m1
    //   9: if_icmpeq +9 -> 18
  ...
  public void release(boolean paramBoolean)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 142	com/tencent/tav/decoder/VideoDecoder:isReleased	Z
    //   6: istore_2
    //   7: iload_2
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 92	com/tencent/tav/decoder/VideoDecoder:TAG	Ljava/lang/String;
    ...
    //   31: iload_1
    //   32: invokevirtual 296	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   35: invokevirtual 90	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   38: invokestatic 307	com/tencent/tav/decoder/logger/Logger:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   41: iload_1
    //   42: ifeq +15 -> 57
    //   45: aload_0
    //   46: getfield 183	com/tencent/tav/decoder/VideoDecoder:extractor	Lcom/tencent/tav/extractor/AssetExtractor;
    //   49: invokevirtual 665	com/tencent/tav/extractor/AssetExtractor:dispose	()V
    //   52: aload_0
    //   53: aconst_null
    //   54: putfield 183	com/tencent/tav/decoder/VideoDecoder:extractor	Lcom/tencent/tav/extractor/AssetExtractor;
    //   57: aload_0
    //   58: getfield 252	com/tencent/tav/decoder/VideoDecoder:mirrorExtractor	Lcom/tencent/tav/extractor/AssetExtractor;
    //   61: ifnull +15 -> 76
    //   64: aload_0
    //   65: getfield 252	com/tencent/tav/decoder/VideoDecoder:mirrorExtractor	Lcom/tencent/tav/extractor/AssetExtractor;
    //   68: invokevirtual 665	com/tencent/tav/extractor/AssetExtractor:dispose	()V
    //   71: aload_0
    //   72: aconst_null
    //   73: putfield 252	com/tencent/tav/decoder/VideoDecoder:mirrorExtractor	Lcom/tencent/tav/extractor/AssetExtractor;
    //   76: aload_0
    //   77: iconst_0
    //   78: putfield 144	com/tencent/tav/decoder/VideoDecoder:started	Z
    //   81: aload_0
    //   82: iconst_1
    //   83: putfield 142	com/tencent/tav/decoder/VideoDecoder:isReleased	Z
    //   86: aload_0
    //   87: getfield 119	com/tencent/tav/decoder/VideoDecoder:mediaCodecWrapper	Lcom/tencent/tav/decoder/MediaCodecWrapper;
    //   90: invokevirtual 667	com/tencent/tav/decoder/MediaCodecWrapper:release	()V
    //   93: aload_0
    //   94: getfield 92	com/tencent/tav/decoder/VideoDecoder:TAG	Ljava/lang/String;
    ...
    //   110: iload_1
    //   111: invokevirtual 296	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   114: invokevirtual 90	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   117: invokestatic 307	com/tencent/tav/decoder/logger/Logger:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   120: goto -109 -> 11
    //   123: astore_3
    //   124: aload_0
    //   125: monitorexit
  ...
  public void seekTo(CMTime paramCMTime, boolean paramBoolean)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 92	com/tencent/tav/decoder/VideoDecoder:TAG	Ljava/lang/String;
    ...
    //   19: aload_1
    //   20: invokevirtual 289	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   23: ldc_w 676
    //   26: invokevirtual 76	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   29: aload_0
    //   30: invokevirtual 289	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   33: ldc_w 468
    //   36: invokevirtual 76	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   39: aload_0
    //   40: getfield 156	com/tencent/tav/decoder/VideoDecoder:currentStartTime	Lcom/tencent/tav/coremedia/CMTime;
    //   43: invokevirtual 289	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   46: ldc_w 468
    //   49: invokevirtual 76	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   52: aload_0
    //   53: getfield 131	com/tencent/tav/decoder/VideoDecoder:currentDecoderTime	Lcom/tencent/tav/coremedia/CMTime;
    //   56: invokevirtual 289	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   59: invokevirtual 90	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   62: iconst_0
    //   63: anewarray 4	java/lang/Object
    //   66: invokestatic 166	com/tencent/tav/decoder/logger/Logger:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   69: aload_0
    //   70: getfield 144	com/tencent/tav/decoder/VideoDecoder:started	Z
    //   73: ifeq +11 -> 84
    //   76: aload_0
    //   77: getfield 112	com/tencent/tav/decoder/VideoDecoder:trackIndex	I
    //   80: iconst_m1
    //   81: if_icmpne +16 -> 97
    //   84: aload_0
    //   85: getfield 92	com/tencent/tav/decoder/VideoDecoder:TAG	Ljava/lang/String;
    //   88: ldc_w 678
    //   91: invokestatic 307	com/tencent/tav/decoder/logger/Logger:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   94: aload_0
    //   95: monitorexit
    //   96: return
    //   97: aload_1
    //   98: astore_3
    //   99: aload_1
    //   100: getstatic 101	com/tencent/tav/coremedia/CMTime:CMTimeZero	Lcom/tencent/tav/coremedia/CMTime;
    //   103: invokevirtual 537	com/tencent/tav/coremedia/CMTime:smallThan	(Lcom/tencent/tav/coremedia/CMTime;)Z
    //   106: ifeq +7 -> 113
    //   109: getstatic 101	com/tencent/tav/coremedia/CMTime:CMTimeZero	Lcom/tencent/tav/coremedia/CMTime;
    //   112: astore_3
    //   113: aload_0
    //   114: getfield 244	com/tencent/tav/decoder/VideoDecoder:timeRange	Lcom/tencent/tav/coremedia/CMTimeRange;
    //   117: invokevirtual 681	com/tencent/tav/coremedia/CMTimeRange:getStart	()Lcom/tencent/tav/coremedia/CMTime;
    //   120: aload_3
    //   121: invokevirtual 637	com/tencent/tav/coremedia/CMTime:add	(Lcom/tencent/tav/coremedia/CMTime;)Lcom/tencent/tav/coremedia/CMTime;
    //   124: astore_1
    //   125: iload_2
    //   126: ifeq +11 -> 137
    //   129: aload_0
    //   130: aload_3
    //   131: invokespecial 683	com/tencent/tav/decoder/VideoDecoder:moreCloseCurrentThenSeek	(Lcom/tencent/tav/coremedia/CMTime;)Z
    //   134: ifne -40 -> 94
    //   137: aload_3
    //   138: aload_0
    //   139: getfield 131	com/tencent/tav/decoder/VideoDecoder:currentDecoderTime	Lcom/tencent/tav/coremedia/CMTime;
    //   142: invokevirtual 686	com/tencent/tav/coremedia/CMTime:equalsTo	(Lcom/tencent/tav/coremedia/CMTime;)Z
    //   145: ifne -51 -> 94
    //   148: aload_0
    //   149: aload_3
    //   150: invokespecial 688	com/tencent/tav/decoder/VideoDecoder:hasPreReadAndFirstFrameSeek	(Lcom/tencent/tav/coremedia/CMTime;)Z
    //   153: ifne -59 -> 94
    //   156: aload_0
    //   157: aload_3
    //   158: putfield 156	com/tencent/tav/decoder/VideoDecoder:currentStartTime	Lcom/tencent/tav/coremedia/CMTime;
    //   161: aload_0
    //   162: aload_1
    //   163: invokevirtual 378	com/tencent/tav/coremedia/CMTime:getTimeUs	()J
    //   166: invokespecial 690	com/tencent/tav/decoder/VideoDecoder:seekExtractorTo	(J)V
    //   169: aload_0
    //   170: iconst_0
    //   171: putfield 158	com/tencent/tav/decoder/VideoDecoder:extractorDone	Z
    //   174: aload_0
    //   175: getfield 92	com/tencent/tav/decoder/VideoDecoder:TAG	Ljava/lang/String;
    ...
    //   191: aload_0
    //   192: getfield 156	com/tencent/tav/decoder/VideoDecoder:currentStartTime	Lcom/tencent/tav/coremedia/CMTime;
    //   195: invokevirtual 289	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   198: ldc_w 468
    //   201: invokevirtual 76	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   204: aload_0
    //   205: getfield 183	com/tencent/tav/decoder/VideoDecoder:extractor	Lcom/tencent/tav/extractor/AssetExtractor;
    //   208: invokevirtual 499	com/tencent/tav/extractor/AssetExtractor:getSampleTime	()J
    //   211: invokevirtual 232	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   214: invokevirtual 90	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   217: iconst_0
    //   218: anewarray 4	java/lang/Object
    //   221: invokestatic 166	com/tencent/tav/decoder/logger/Logger:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   224: goto -130 -> 94
    //   227: astore_1
    //   228: aload_0
    //   229: monitorexit
