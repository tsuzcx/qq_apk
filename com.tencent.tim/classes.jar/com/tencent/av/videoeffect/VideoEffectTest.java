  ...
  implements Runnable
{
  ...
  public VideoEffectTest(a parama)
  {
    this.a = parama;
  }
  ...
  public void execute()
  {
    ...
    {
      this.mThread = new Thread(this, "VideoEffectTest");
      this.mThread.start();
    }
  }
  ...
  void test()
  {
    ...
    for (;;)
    {
      try
      {
        localObject = new jlw((byte[])localObject, 480, 640);
        ((jlw)localObject).bV();
        l2 = (((jlw)localObject).bV() + 0L + ((jlw)localObject).bV()) / 2L;
        ((jlw)localObject).destroy();
        if (l2 > 0L) {
          continue;
        }
        i = (int)l2;
      ...
      if (this.a != null) {
        this.a.b(i, l1, GLES20.glGetString(7936), GLES20.glGetString(7937));
      }
      return;
      i = 1;
      l1 = l2;
  ...
  {
    public abstract void b(int paramInt, long paramLong, String paramString1, String paramString2);
  }
}
