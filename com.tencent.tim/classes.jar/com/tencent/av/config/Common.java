...
public class Common
{
  ...
  public static final ConcurrentHashMap<String, byte[]> aG = new ConcurrentHashMap();
  ...
  {
    // Byte code:
    //   0: getstatic 43	com/tencent/av/config/Common:aG	Ljava/util/concurrent/ConcurrentHashMap;
    //   3: aload_1
    ...
    //   20: aload_0
    //   21: aload_1
    //   22: invokevirtual 99	android/content/Context:openFileInput	(Ljava/lang/String;)Ljava/io/FileInputStream;
    //   25: astore 5
    //   27: aload 5
    //   29: astore_0
    //   30: aload 4
    //   32: astore_3
    //   33: aload 5
    //   35: invokevirtual 105	java/io/FileInputStream:available	()I
    //   38: istore_2
    //   39: iload_2
    //   40: ifgt +70 -> 110
    //   43: aload 5
    ...
    //   48: astore_3
    //   49: aload 5
    //   51: invokevirtual 108	java/io/FileInputStream:close	()V
    //   54: aload 5
    //   56: ifnull +8 -> 64
    //   59: aload 5
    //   61: invokevirtual 108	java/io/FileInputStream:close	()V
    //   64: aconst_null
    //   65: astore_3
    //   66: aload_3
    //   67: areturn
    ...
    //   72: ifeq -8 -> 64
    //   75: getstatic 16	com/tencent/av/config/Common:TAG	Ljava/lang/String;
    //   78: iconst_1
    //   79: new 18	java/lang/StringBuilder
    //   82: dup
    //   83: invokespecial 21	java/lang/StringBuilder:<init>	()V
    //   86: ldc 116
    //   88: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   91: aload_1
    ...
    //   100: invokevirtual 36	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   103: aload_0
    ...
    //   127: aload 5
    //   129: aload 4
    //   131: invokevirtual 126	java/io/FileInputStream:read	([B)I
    //   134: pop
    //   135: aload 5
    //   137: astore_0
    //   138: aload 4
    //   140: astore_3
    //   141: getstatic 43	com/tencent/av/config/Common:aG	Ljava/util/concurrent/ConcurrentHashMap;
    //   144: aload_1
    //   145: aload 4
    //   147: invokevirtual 130	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   150: pop
    //   151: aload 4
    //   153: astore_3
    //   154: aload 5
    //   156: ifnull -90 -> 66
    //   159: aload 5
    //   161: invokevirtual 108	java/io/FileInputStream:close	()V
    //   164: aload 4
    //   166: areturn
    //   167: astore_0
    //   168: aload 4
    //   170: astore_3
    //   171: invokestatic 114	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   174: ifeq -108 -> 66
    //   177: getstatic 16	com/tencent/av/config/Common:TAG	Ljava/lang/String;
    //   180: iconst_1
    //   181: new 18	java/lang/StringBuilder
    //   184: dup
    //   185: invokespecial 21	java/lang/StringBuilder:<init>	()V
    //   188: ldc 116
    //   190: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   193: aload_1
    //   194: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   197: ldc 118
    //   199: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   202: invokevirtual 36	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   205: aload_0
    ...
    //   216: aload 5
    //   218: astore_0
    //   219: invokestatic 133	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   222: ifeq +38 -> 260
    //   225: aload 5
    //   227: astore_0
    //   228: getstatic 16	com/tencent/av/config/Common:TAG	Ljava/lang/String;
    //   231: iconst_1
    //   232: new 18	java/lang/StringBuilder
    //   235: dup
    //   236: invokespecial 21	java/lang/StringBuilder:<init>	()V
    //   239: ldc 135
    //   241: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   244: aload_1
    //   245: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   248: ldc 118
    //   250: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   253: invokevirtual 36	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   256: aload_3
    ...
    //   265: ifnull -199 -> 66
    //   268: aload 5
    //   270: invokevirtual 108	java/io/FileInputStream:close	()V
    //   273: aload 4
    //   275: areturn
    //   276: astore_0
    //   277: aload 4
    //   279: astore_3
    //   280: invokestatic 114	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   283: ifeq -217 -> 66
    //   286: getstatic 16	com/tencent/av/config/Common:TAG	Ljava/lang/String;
    //   289: iconst_1
    //   290: new 18	java/lang/StringBuilder
    //   293: dup
    //   294: invokespecial 21	java/lang/StringBuilder:<init>	()V
    //   297: ldc 116
    //   299: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   302: aload_1
    //   303: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   306: ldc 118
    //   308: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   311: invokevirtual 36	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   314: aload_0
    ...
    //   325: ifnull +7 -> 332
    //   328: aload_0
    //   329: invokevirtual 108	java/io/FileInputStream:close	()V
    //   332: aload_3
    //   333: athrow
    //   334: astore_0
    //   335: invokestatic 114	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   338: ifeq -6 -> 332
    //   341: getstatic 16	com/tencent/av/config/Common:TAG	Ljava/lang/String;
    //   344: iconst_1
    //   345: new 18	java/lang/StringBuilder
    //   348: dup
    ...
    //   357: aload_1
    //   358: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   361: ldc 118
  ...
  public static void writeFile(Context paramContext, String paramString, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        aG.put(paramString, paramArrayOfByte);
        localObject2 = str;
