  ...
  implements Parcelable, Serializable
{
  ...
  public static final Parcelable.Creator<AVRedPacketConfig> CREATOR = new itt();
  ...
  public AVRedPacketConfig(Parcel paramParcel)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      this.expressionInfoList = paramParcel.createTypedArrayList(ExpressionInfo.CREATOR);
  ...
  static final String getConfigPrefix()
  {
    ...
    try
    {
      String str = aqgz.bd(BaseApplicationImpl.getContext());
      localObject = str;
    }
  ...
  public static AVRedPacketConfig parse(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        localAVRedPacketConfig.operatingEntranceBeginTime = aduc.aj(localXmlPullParser.nextText());
      }
      else if (paramString.equalsIgnoreCase("activityEndTime"))
      {
        localAVRedPacketConfig.operatingEntranceEndTime = aduc.aj(localXmlPullParser.nextText());
      }
    ...
    for (String str = arrayOfString[i];; str = null)
    {
      ...
      i = localXmlPullParser.next();
      paramString = new ExpressionInfo();
      label1127:
      if (i != 1)
      {
        if (i != 2) {
  ...
  public static AVRedPacketConfig readFromFile(String paramString)
  {
    ...
    //   8: iconst_2
    //   9: ldc_w 354
    //   12: invokestatic 187	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   15: aload_0
    //   16: invokestatic 213	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   19: ifeq +20 -> 39
    //   22: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   25: ifeq +12 -> 37
    //   28: ldc 21
    //   30: iconst_2
    //   31: ldc_w 356
    //   34: invokestatic 187	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   37: aconst_null
    //   38: areturn
    //   39: invokestatic 145	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   42: new 147	java/lang/StringBuilder
    //   45: dup
    //   46: invokespecial 148	java/lang/StringBuilder:<init>	()V
    //   49: invokestatic 151	com/tencent/av/service/AVRedPacketConfig:getConfigPrefix	()Ljava/lang/String;
    //   52: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   55: aload_0
    //   56: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   59: invokevirtual 158	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   62: invokevirtual 164	com/tencent/qphone/base/util/BaseApplication:getFileStreamPath	(Ljava/lang/String;)Ljava/io/File;
    //   65: astore_0
    //   66: aload_0
    //   67: invokevirtual 170	java/io/File:exists	()Z
    //   70: ifne +20 -> 90
    //   73: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   76: ifeq -39 -> 37
    //   79: ldc 21
    //   81: iconst_2
    //   82: ldc_w 358
    //   85: invokestatic 187	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   88: aconst_null
    //   89: areturn
    //   90: new 360	java/io/FileInputStream
    //   93: dup
    //   94: aload_0
    //   95: invokespecial 363	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   98: astore_1
    //   99: new 365	java/io/ObjectInputStream
    //   102: dup
    //   103: new 367	java/io/BufferedInputStream
    //   106: dup
    //   107: aload_1
    //   108: invokespecial 370	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   111: invokespecial 371	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   114: astore 5
    //   116: aload 5
    //   118: astore_3
    //   119: aload_1
    //   120: astore_2
    //   121: aload 5
    //   123: invokevirtual 375	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   126: checkcast 2	com/tencent/av/service/AVRedPacketConfig
    //   129: astore 4
    //   131: aload_1
    //   132: ifnull +7 -> 139
    //   135: aload_1
    //   136: invokevirtual 378	java/io/FileInputStream:close	()V
    //   139: aload 4
    //   141: astore_0
    //   142: aload 5
    //   144: ifnull +11 -> 155
    //   147: aload 5
    //   149: invokevirtual 379	java/io/ObjectInputStream:close	()V
    //   152: aload 4
    //   154: astore_0
    //   155: aload_0
    //   156: areturn
    //   157: astore_0
    //   158: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   161: ifeq -22 -> 139
    //   164: aload_0
    //   165: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   168: goto -29 -> 139
    //   171: astore_1
    //   172: aload 4
    //   174: astore_0
    //   175: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   178: ifeq -23 -> 155
    //   181: aload_1
    //   182: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   185: aload 4
    //   187: astore_0
    //   188: goto -33 -> 155
    //   191: astore 4
    ...
    //   199: aload_1
    //   200: astore_2
    //   201: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   204: ifeq +37 -> 241
    //   207: aload_0
    //   208: astore_3
    //   209: aload_1
    ...
    //   221: ldc_w 384
    //   224: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   227: aload 4
    //   229: invokevirtual 268	java/lang/Exception:toString	()Ljava/lang/String;
    //   232: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   235: invokevirtual 158	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   238: invokestatic 187	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   241: aload_1
    //   242: ifnull +7 -> 249
    //   245: aload_1
    ...
    //   250: ifnull +120 -> 370
    //   253: aload_0
    //   254: invokevirtual 379	java/io/ObjectInputStream:close	()V
    //   257: aconst_null
    //   258: astore_0
    //   259: goto -104 -> 155
    //   262: astore_1
    //   263: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   266: ifeq -17 -> 249
    //   269: aload_1
    //   270: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   273: goto -24 -> 249
    //   276: astore_0
    //   277: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   280: ifeq +7 -> 287
    //   283: aload_0
    //   284: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   287: aconst_null
    //   288: astore_0
    //   289: goto -134 -> 155
    //   292: astore_0
    ...
    //   298: ifnull +7 -> 305
    //   301: aload_1
    //   302: invokevirtual 378	java/io/FileInputStream:close	()V
    //   305: aload_3
    //   306: ifnull +7 -> 313
    //   309: aload_3
    //   310: invokevirtual 379	java/io/ObjectInputStream:close	()V
    //   313: aload_0
    //   314: athrow
    //   315: astore_1
    //   316: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   319: ifeq -14 -> 305
    //   322: aload_1
    //   323: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   326: goto -21 -> 305
    //   329: astore_1
    //   330: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   333: ifeq -20 -> 313
    //   336: aload_1
    //   337: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   340: goto -27 -> 313
    //   343: astore_0
    //   344: aconst_null
    //   345: astore_3
  ...
  public void saveToFile(String paramString)
  {
    ...
    //   1: astore_2
    //   2: aload_1
    //   3: invokestatic 213	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifeq +19 -> 25
    //   9: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   12: ifeq +12 -> 24
    //   15: ldc 21
    //   17: iconst_2
    //   18: ldc_w 390
    //   21: invokestatic 187	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   24: return
    //   25: invokestatic 145	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   28: new 147	java/lang/StringBuilder
    //   31: dup
    //   32: invokespecial 148	java/lang/StringBuilder:<init>	()V
    //   35: invokestatic 151	com/tencent/av/service/AVRedPacketConfig:getConfigPrefix	()Ljava/lang/String;
    //   38: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   41: aload_1
    //   42: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   45: invokevirtual 158	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   48: invokevirtual 164	com/tencent/qphone/base/util/BaseApplication:getFileStreamPath	(Ljava/lang/String;)Ljava/io/File;
    //   51: astore 8
    //   53: invokestatic 145	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   56: new 147	java/lang/StringBuilder
    //   59: dup
    //   60: invokespecial 148	java/lang/StringBuilder:<init>	()V
    //   63: invokestatic 151	com/tencent/av/service/AVRedPacketConfig:getConfigPrefix	()Ljava/lang/String;
    //   66: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   69: aload_1
    ...
    //   82: invokevirtual 164	com/tencent/qphone/base/util/BaseApplication:getFileStreamPath	(Ljava/lang/String;)Ljava/io/File;
    //   85: astore 9
    //   87: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   90: ifeq +33 -> 123
    //   93: ldc 21
    //   95: iconst_2
    //   96: new 147	java/lang/StringBuilder
    //   99: dup
    //   100: invokespecial 148	java/lang/StringBuilder:<init>	()V
    //   103: ldc_w 394
    //   106: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   109: aload 8
    //   111: invokevirtual 183	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   114: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   117: invokevirtual 158	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   120: invokestatic 187	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   123: aload 9
    //   125: invokevirtual 170	java/io/File:exists	()Z
    //   128: ifeq +9 -> 137
    //   131: aload 9
    //   133: invokevirtual 173	java/io/File:delete	()Z
    //   136: pop
    //   137: aload 9
    //   139: invokevirtual 397	java/io/File:createNewFile	()Z
    //   142: pop
    //   143: new 399	java/io/FileOutputStream
    //   146: dup
    //   147: aload 9
    //   149: invokespecial 400	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   152: astore_3
    //   153: new 402	java/io/BufferedOutputStream
    //   156: dup
    //   157: aload_3
    //   158: invokespecial 405	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   161: astore_1
    //   162: new 407	java/io/ObjectOutputStream
    //   165: dup
    //   166: aload_1
    //   167: invokespecial 408	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   170: astore 4
    //   172: aload_3
    //   173: astore 7
    //   175: aload_1
    ...
    //   182: aload 4
    //   184: aload_0
    //   185: invokevirtual 412	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   188: aload_3
    //   189: astore 7
    //   191: aload_1
    //   192: astore 6
    ...
    //   196: astore 5
    //   198: aload 4
    //   200: invokevirtual 415	java/io/ObjectOutputStream:flush	()V
    //   203: aload_3
    //   204: astore 7
    //   206: aload_1
    //   207: astore 6
    ...
    //   211: astore 5
    //   213: aload 8
    //   215: invokevirtual 170	java/io/File:exists	()Z
    //   218: ifeq +19 -> 237
    //   221: aload_3
    //   222: astore 7
    //   224: aload_1
    ...
    //   229: astore 5
    //   231: aload 8
    //   233: invokevirtual 173	java/io/File:delete	()Z
    //   236: pop
    //   237: aload_3
    //   238: astore 7
    //   240: aload_1
    ...
    //   247: aload 9
    //   249: aload 8
    //   251: invokevirtual 419	java/io/File:renameTo	(Ljava/io/File;)Z
    //   254: pop
    //   255: aload_3
    //   256: astore 7
    //   258: aload_1
    ...
    //   283: iconst_2
    //   284: ldc_w 421
    //   287: invokestatic 187	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   290: aload_3
    //   291: ifnull +7 -> 298
    //   294: aload_3
    //   295: invokevirtual 422	java/io/FileOutputStream:close	()V
    //   298: aload_1
    //   299: ifnull +7 -> 306
    //   302: aload_1
    //   303: invokevirtual 423	java/io/BufferedOutputStream:close	()V
    //   306: aload 4
    //   308: ifnull -284 -> 24
    //   311: aload 4
    //   313: invokevirtual 424	java/io/ObjectOutputStream:close	()V
    //   316: return
    //   317: astore_1
    //   318: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   321: ifeq -297 -> 24
    //   324: aload_1
    //   325: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   328: return
    //   329: astore_2
    //   330: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   333: ifeq -35 -> 298
    ...
    //   343: astore_1
    //   344: aload_1
    //   345: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   348: goto -42 -> 306
    //   351: astore 4
    //   353: aconst_null
    //   354: astore_3
    ...
    //   356: astore_1
    //   357: aload 4
    //   359: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   362: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   365: ifeq +33 -> 398
    //   368: ldc 21
    //   370: iconst_2
    //   371: new 147	java/lang/StringBuilder
    //   374: dup
    //   375: invokespecial 148	java/lang/StringBuilder:<init>	()V
    //   378: ldc_w 426
    //   381: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   384: aload 4
    //   386: invokevirtual 427	java/io/IOException:toString	()Ljava/lang/String;
    //   389: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   392: invokevirtual 158	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   395: invokestatic 187	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   398: aload_3
    //   399: ifnull +7 -> 406
    //   402: aload_3
    //   403: invokevirtual 422	java/io/FileOutputStream:close	()V
    //   406: aload_2
    //   407: ifnull +7 -> 414
    //   410: aload_2
    //   411: invokevirtual 423	java/io/BufferedOutputStream:close	()V
    //   414: aload_1
    //   415: ifnull -391 -> 24
    //   418: aload_1
    //   419: invokevirtual 424	java/io/ObjectOutputStream:close	()V
    //   422: return
    //   423: astore_1
    //   424: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   427: ifeq -403 -> 24
    //   430: aload_1
    //   431: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   434: return
    //   435: astore_3
    //   436: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   439: ifeq -33 -> 406
    //   442: aload_3
    //   443: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   446: goto -40 -> 406
    //   449: astore_2
    //   450: aload_2
    //   451: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   454: goto -40 -> 414
    //   457: astore_2
    //   458: aconst_null
    //   459: astore 8
    ...
    //   475: ldc 21
    //   477: iconst_2
    //   478: new 147	java/lang/StringBuilder
    //   481: dup
    //   482: invokespecial 148	java/lang/StringBuilder:<init>	()V
    //   485: ldc_w 429
    //   488: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   491: aload_2
    //   492: invokevirtual 432	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    //   495: invokevirtual 155	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   498: invokevirtual 158	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   501: invokestatic 187	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   504: aload 8
    //   506: ifnull +8 -> 514
    //   509: aload 8
    //   511: invokevirtual 422	java/io/FileOutputStream:close	()V
    //   514: aload_3
    //   515: ifnull +7 -> 522
    //   518: aload_3
    //   519: invokevirtual 423	java/io/BufferedOutputStream:close	()V
    //   522: aload_1
    //   523: ifnull -499 -> 24
    //   526: aload_1
    //   527: invokevirtual 424	java/io/ObjectOutputStream:close	()V
    //   530: return
    //   531: astore_1
    //   532: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   535: ifeq -511 -> 24
    //   538: aload_1
    //   539: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   542: return
    //   543: astore_2
    //   544: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   547: ifeq -33 -> 514
    //   550: aload_2
    //   551: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   554: goto -40 -> 514
    //   557: astore_2
    //   558: aload_2
    //   559: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   562: goto -40 -> 522
    //   565: astore_2
    //   566: aconst_null
    //   567: astore 4
    ...
    //   575: ifnull +8 -> 583
    //   578: aload 4
    //   580: invokevirtual 422	java/io/FileOutputStream:close	()V
    //   583: aload_1
    //   584: ifnull +7 -> 591
    //   587: aload_1
    //   588: invokevirtual 423	java/io/BufferedOutputStream:close	()V
    //   591: aload_3
    //   592: ifnull +7 -> 599
    //   595: aload_3
    //   596: invokevirtual 424	java/io/ObjectOutputStream:close	()V
    //   599: aload_2
    //   600: athrow
    //   601: astore 4
    //   603: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   606: ifeq -23 -> 583
    //   609: aload 4
    //   611: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   614: goto -31 -> 583
    //   617: astore_1
    //   618: aload_1
    //   619: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   622: goto -31 -> 591
    //   625: astore_1
    //   626: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   629: ifeq -30 -> 599
    //   632: aload_1
    //   633: invokevirtual 382	java/io/IOException:printStackTrace	()V
    //   636: goto -37 -> 599
    //   639: astore_2
    //   640: aconst_null
    //   641: astore_1
  ...
  public static class ExpressionInfo
    implements Parcelable, Serializable
  {
    public static final Parcelable.Creator<ExpressionInfo> CREATOR = new itu();
    ...
    public ExpressionInfo(Parcel paramParcel)
    {
