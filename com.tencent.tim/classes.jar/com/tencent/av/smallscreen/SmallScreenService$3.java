  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (localObject != null)
    {
      localObject = aqmj.j(((VideoAppInterface)localObject).getApp()).edit();
      if (this.this$0.a.isGameMode()) {
        ((SharedPreferences.Editor)localObject).putInt("small_window_position_land", this.this$0.a.b().anh);
      }
