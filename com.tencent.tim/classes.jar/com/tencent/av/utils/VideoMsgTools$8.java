  ...
  extends ResultReceiver
{
  ...
  {
    boolean bool3 = true;
    AudioHelper.I("addGroupMember_" + this.kQ, paramBundle);
    ...
    for (;;)
    {
      ...
      localObject = new VideoMsgTools.MygetGroupInfoRunnable(this.kQ, (QQAppInterface)localObject, this.val$groupUin);
