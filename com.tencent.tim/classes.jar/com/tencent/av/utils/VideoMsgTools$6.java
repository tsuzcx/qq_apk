  ...
  extends ResultReceiver
{
  ...
  {
    int i = -1;
    AudioHelper.I("addMemberFromC2C", paramBundle);
    boolean bool;
    if (paramInt == -1) {
      bool = true;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        QLog.w("double_2_multi", 1, paramInt + "], seq[" + this.kQ + "], uinType[" + j + "], roomId[" + l1 + "]");
      ...
      catch (Throwable paramBundle)
      {
        ...
        VideoMsgTools.b(this.kQ, BaseApplicationImpl.getApplication(), j, bool, l1, localArrayList);
      }
    }
  }
}
