...
public class PTSNativeModuleRegistry
{
  ...
  {
    PTSNativeModule localPTSNativeModule = (PTSNativeModule)sNativeModuleMap.get("AllInOneJumpModule");
  ...
  {
    PTSNativeModule localPTSNativeModule = (PTSNativeModule)sNativeModuleMap.get("HandleJSException");
  ...
  {
    PTSNativeModule localPTSNativeModule = (PTSNativeModule)sNativeModuleMap.get("LoadFeedsModule");
  ...
  {
    PTSNativeModule localPTSNativeModule = (PTSNativeModule)sNativeModuleMap.get("MakeHttpRequest");
  ...
  {
    PTSNativeModule localPTSNativeModule = (PTSNativeModule)sNativeModuleMap.get("MarkArticleRead");
    if ((localPTSNativeModule instanceof IPTSMarkArticleRead)) {
      ((IPTSMarkArticleRead)localPTSNativeModule).markArticleRead(paramLong1, paramLong2);
    }
  }
  
  public static void navigateTo(String paramString)
  {
    PTSNativeModule localPTSNativeModule = (PTSNativeModule)sNativeModuleMap.get("NavigateToModule");
  ...
  public static void registerNativeModule(String paramString, PTSNativeModule paramPTSNativeModule)
  {
  ...
  {
    PTSNativeModule localPTSNativeModule = (PTSNativeModule)sNativeModuleMap.get("ReportTo1160");
    if ((localPTSNativeModule instanceof IPTSReportTo1160)) {
      ((IPTSReportTo1160)localPTSNativeModule).reportTo1160(paramString1, paramString2, paramLong, paramInt, paramString3, paramString4);
    }
  }
  
  public static void requestFeeds(long paramLong1, long paramLong2, boolean paramBoolean, long paramLong3, long paramLong4)
  {
    PTSNativeModule localPTSNativeModule = (PTSNativeModule)sNativeModuleMap.get("RequestFeedsModule");
  ...
  public static abstract interface IPTSMarkArticleRead
    extends PTSNativeModuleRegistry.PTSNativeModule
  {
    public abstract void markArticleRead(long paramLong1, long paramLong2);
  }
  
  public static abstract interface IPTSReportTo1160
    extends PTSNativeModuleRegistry.PTSNativeModule
  {
  ...
  public static abstract interface PTSNativeModule {}
}
