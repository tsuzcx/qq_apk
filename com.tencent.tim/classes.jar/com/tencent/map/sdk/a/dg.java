...
public final class dg
{
  ...
  public static String a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        str1 = alla.a((TelephonyManager)ac.a().getSystemService("phone"));
        label29:
  ...
  public static String a(int paramInt)
  {
    ...
    //   6: dup
    //   7: ldc 103
    //   9: invokespecial 73	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   12: iload_0
    //   13: invokevirtual 106	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   16: ldc 108
    ...
    //   24: astore_1
    //   25: new 110	java/io/BufferedReader
    //   28: dup
    //   29: new 112	java/io/FileReader
    //   32: dup
    //   33: aload_1
    //   34: invokespecial 113	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   37: invokespecial 116	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   40: astore_2
    //   41: aload_2
    //   42: astore_1
    //   43: aload_2
    //   44: invokevirtual 119	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   47: astore_3
    //   48: aload_2
    //   49: astore_1
    //   50: aload_3
    ...
    //   58: astore_1
    //   59: aload_3
    //   60: invokevirtual 92	java/lang/String:trim	()Ljava/lang/String;
    //   63: astore_3
    //   64: aload_3
    //   65: astore_1
    //   66: aload_2
    ...
    //   76: astore_1
    //   77: aload_3
    //   78: invokevirtual 125	java/lang/Exception:printStackTrace	()V
    //   81: aload 4
    //   83: astore_1
    //   84: aload_2
    //   85: ifnull -15 -> 70
    //   88: aload_2
    //   89: invokevirtual 122	java/io/BufferedReader:close	()V
    //   92: aconst_null
    //   93: areturn
    //   94: astore_1
    //   95: aconst_null
    ...
    //   101: ifnull +7 -> 108
    //   104: aload_1
    //   105: invokevirtual 122	java/io/BufferedReader:close	()V
    //   108: aload_2
    //   109: athrow
    //   110: astore_2
    //   111: aload_1
  ...
  public static String b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        str1 = alla.e((TelephonyManager)ac.a().getSystemService("phone"));
        label29:
        if (!TextUtils.isEmpty(str1)) {
          if (!ac.g) {
            break label104;
  ...
  public static String c()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        str1 = alkz.c(alkz.a((WifiManager)ac.a().getApplicationContext().getSystemService("wifi")));
        label35:
        if (!TextUtils.isEmpty(str1)) {
          if (!ac.g) {
            break label110;
  ...
  public static String e()
  {
    ...
    try
    {
      ...
      {
        if (i != 0) {
          d = alla.getString(ac.a().getContentResolver(), "android_id");
        }
        return d;
