...
public final class oe<D extends nz>
  extends of<D>
{
  private static final a h = new oe.1();
  private oa.a<b> a;
  private c b;
  private File c;
  private File d;
  ...
  public final D a(String paramString, Class<D> paramClass)
  {
    ...
    if ((!this.g) || (this.b.d != -1L))
    {
      ...
      if ((paramString != null) && (!this.f.contains(paramString)))
      {
        ...
        if (this.a != null)
        {
          ...
          while (((Iterator)localObject4).hasNext())
          {
            ...
            this.a.a(localObject5, new b(new File(paramString, str), i));
          }
        }
      ...
      if (!this.g)
      {
        paramString = (b)this.a.b(localObject2);
        if (paramString == null) {}
      }
    }
  ...
  public final void a(String paramString, D paramD)
  {
    ...
    if (paramD != null)
    {
      ...
      if ((!this.g) || (this.b.d != -1L))
      {
        localObject2 = new b(localFile, paramD.length);
        if (!this.g) {
          this.a.a(paramString, localObject2);
        }
        if (((b)localObject2).a != null)
        {
          localFile = ((b)localObject2).a.getParentFile();
          localObject1 = om.b(localFile, ".disk_idx");
          localObject2 = paramString + "#" + ((b)localObject2).toString();
