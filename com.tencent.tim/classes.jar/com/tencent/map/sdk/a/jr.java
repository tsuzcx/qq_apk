  ...
  implements gh
{
  ...
  private boolean a(String paramString, Bitmap paramBitmap)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: getstatic 105	com/tencent/map/sdk/a/jr:f	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   46: getstatic 105	com/tencent/map/sdk/a/jr:f	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   81: getstatic 105	com/tencent/map/sdk/a/jr:f	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   99: getstatic 105	com/tencent/map/sdk/a/jr:f	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   118: getstatic 105	com/tencent/map/sdk/a/jr:f	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
  ...
  {
    // Byte code:
    //   0: getstatic 105	com/tencent/map/sdk/a/jr:f	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   35: getstatic 105	com/tencent/map/sdk/a/jr:f	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   64: getstatic 105	com/tencent/map/sdk/a/jr:f	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   82: getstatic 105	com/tencent/map/sdk/a/jr:f	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   104: getstatic 105	com/tencent/map/sdk/a/jr:f	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    extends View
  {
    ...
    public a(Context paramContext)
    {
      ...
      this.b.setStrokeWidth(1.0F * jr.d(jr.this));
    ...
    public final void draw(Canvas paramCanvas)
    {
      ...
      int j = getHeight();
      int i = (int)(6.0F * jr.d(jr.this));
      j /= 2;
      paramCanvas.drawPaint(this.c);
      paramCanvas.drawLine(i, j, jr.e(jr.this) + i, j, this.b);
      paramCanvas.drawLine(i, j - jr.d(jr.this) * 3.0F, i, j + 1, this.b);
      paramCanvas.drawLine(jr.e(jr.this) + i, j - jr.d(jr.this) * 3.0F, jr.e(jr.this) + i, j + 1, this.b);
    }
    
    protected final void onMeasure(int paramInt1, int paramInt2)
    {
      super.onMeasure(paramInt1, paramInt2);
      setMeasuredDimension(Math.min(Math.round(jr.e(jr.this) + 12.0F * jr.d(jr.this)), jr.f(jr.this) / 2), Math.round(jr.g(jr.this) * jr.d(jr.this)));
    }
  }
}
