  ...
  implements Cloneable
{
  ...
  public final float a(float paramFloat)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 94	com/tencent/map/sdk/a/kc:p	Lcom/tencent/map/sdk/a/pf;
    //   4: invokevirtual 101	com/tencent/map/sdk/a/pf:q	()F
    //   7: fload_1
    //   8: fcmpl
    //   9: ifne +5 -> 14
    //   12: fload_1
    ...
    //   20: fload_1
    //   21: f2d
    //   22: invokestatic 108	java/lang/Math:toRadians	(D)D
    //   25: dstore_2
    //   26: aload_0
    //   27: dload_2
    //   28: invokestatic 111	java/lang/Math:sin	(D)D
    //   31: putfield 48	com/tencent/map/sdk/a/kc:g	D
    //   34: aload_0
    //   35: dload_2
    //   36: invokestatic 114	java/lang/Math:cos	(D)D
    //   39: putfield 50	com/tencent/map/sdk/a/kc:h	D
    //   42: aload_0
    //   43: getfield 94	com/tencent/map/sdk/a/kc:p	Lcom/tencent/map/sdk/a/pf;
    //   46: ifnull +33 -> 79
    //   49: aload_0
    //   50: getfield 94	com/tencent/map/sdk/a/kc:p	Lcom/tencent/map/sdk/a/pf;
    //   53: astore 7
    //   55: aload 7
    //   57: invokevirtual 117	com/tencent/map/sdk/a/pf:y	()V
    //   60: aload 7
    //   62: getfield 120	com/tencent/map/sdk/a/pf:b	J
    //   65: lstore 5
    //   67: lconst_0
    //   68: lload 5
    //   70: lcmp
    //   71: ifne +11 -> 82
    //   74: aload 7
    //   76: invokevirtual 123	com/tencent/map/sdk/a/pf:z	()V
    //   79: fload 4
    //   81: freturn
    //   82: aload 7
    //   84: monitorenter
    //   85: aload 7
    //   87: getfield 126	com/tencent/map/sdk/a/pf:a	Lcom/tencent/map/sdk/engine/jni/JNI;
    //   90: aload 7
    //   92: getfield 120	com/tencent/map/sdk/a/pf:b	J
    //   95: fload 4
    //   97: iconst_0
    //   98: invokevirtual 132	com/tencent/map/sdk/engine/jni/JNI:nativeSetRotate	(JFZ)V
    //   101: aload 7
    //   103: monitorexit
    //   104: aload 7
    //   106: invokevirtual 123	com/tencent/map/sdk/a/pf:z	()V
    //   109: goto -30 -> 79
    //   112: astore 8
    //   114: aload 7
    //   116: monitorexit
    ...
    //   120: astore 8
    //   122: aload 7
    //   124: invokevirtual 123	com/tencent/map/sdk/a/pf:z	()V
    //   127: aload 8
    //   129: athrow
  ...
  public final float b(float paramFloat)
  {
    ...
    //   0: aload_0
    //   1: getfield 94	com/tencent/map/sdk/a/kc:p	Lcom/tencent/map/sdk/a/pf;
    //   4: invokevirtual 221	com/tencent/map/sdk/a/pf:p	()F
    //   7: fload_1
    //   8: fcmpl
    //   9: ifne +5 -> 14
    //   12: fload_1
    ...
    //   15: ldc 222
    //   17: fload_1
    //   18: invokestatic 226	java/lang/Math:min	(FF)F
    //   21: invokestatic 229	java/lang/Math:max	(FF)F
    //   24: fstore 4
    //   26: fload_1
    //   27: f2d
    //   28: invokestatic 108	java/lang/Math:toRadians	(D)D
    //   31: dstore_2
    //   32: aload_0
    //   33: dload_2
    //   34: invokestatic 111	java/lang/Math:sin	(D)D
    //   37: putfield 52	com/tencent/map/sdk/a/kc:i	D
    //   40: aload_0
    //   41: dload_2
    //   42: invokestatic 114	java/lang/Math:cos	(D)D
    //   45: putfield 54	com/tencent/map/sdk/a/kc:j	D
    //   48: ldc2_w 230
    //   51: dload_2
    //   52: dsub
    //   53: dstore_2
    //   54: aload_0
    //   55: dload_2
    //   56: invokestatic 114	java/lang/Math:cos	(D)D
    //   59: putfield 58	com/tencent/map/sdk/a/kc:l	D
    //   62: aload_0
    //   63: dload_2
    //   64: invokestatic 111	java/lang/Math:sin	(D)D
    //   67: putfield 56	com/tencent/map/sdk/a/kc:k	D
    //   70: aload_0
    //   71: getfield 94	com/tencent/map/sdk/a/kc:p	Lcom/tencent/map/sdk/a/pf;
    //   74: ifnull +33 -> 107
    //   77: aload_0
    //   78: getfield 94	com/tencent/map/sdk/a/kc:p	Lcom/tencent/map/sdk/a/pf;
    //   81: astore 7
    //   83: aload 7
    //   85: invokevirtual 117	com/tencent/map/sdk/a/pf:y	()V
    //   88: aload 7
    //   90: getfield 120	com/tencent/map/sdk/a/pf:b	J
    //   93: lstore 5
    //   95: lconst_0
    //   96: lload 5
    //   98: lcmp
    //   99: ifne +11 -> 110
    //   102: aload 7
    //   104: invokevirtual 123	com/tencent/map/sdk/a/pf:z	()V
    //   107: fload 4
    //   109: freturn
    //   110: aload 7
    //   112: monitorenter
    //   113: aload 7
    //   115: getfield 126	com/tencent/map/sdk/a/pf:a	Lcom/tencent/map/sdk/engine/jni/JNI;
    //   118: aload 7
    //   120: getfield 120	com/tencent/map/sdk/a/pf:b	J
    //   123: fload 4
    //   125: iconst_0
    //   126: invokevirtual 234	com/tencent/map/sdk/engine/jni/JNI:nativeSetSkew	(JFZ)V
    //   129: aload 7
    //   131: monitorexit
    //   132: aload 7
    //   134: invokevirtual 123	com/tencent/map/sdk/a/pf:z	()V
    //   137: goto -30 -> 107
    //   140: astore 8
    //   142: aload 7
    //   144: monitorexit
    ...
    //   148: astore 8
    //   150: aload 7
    //   152: invokevirtual 123	com/tencent/map/sdk/a/pf:z	()V
    //   155: aload 8
    //   157: athrow
    // Local variable table:
    //   start	length	slot	name	signature
