    ...
    if (b(paramInt))
    {
      ...
      case 13: 
        ...
        if (((a)localObject2).a != 0) {
          throw new h("type mismatch, tag: " + paramInt + ", type: " + ((a)localObject1).a + ", " + ((a)localObject2).a);
        }
        i = a(0, 0, true);
        if ((i < 0) || (i > this.b.capacity())) {
          throw new h("invalid size, tag: " + paramInt + ", type: " + ((a)localObject1).a + ", " + ((a)localObject2).a + ", size: " + i);
        }
