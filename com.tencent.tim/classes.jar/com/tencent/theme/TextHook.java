...
public class TextHook
{
  ...
  public boolean switchFont(Context paramContext, String paramString)
  {
    ...
    {
      c = paramString;
      new a(null).execute(new Context[] { paramContext });
      return true;
    }
    ...
    extends AsyncTask<Context, String, Context>
  {
    ...
    protected Context a(Context... paramVarArgs)
    {
      ...
      try
      {
        ...
        {
          TextHook.a(TextHook.this, (Typeface)TextHook.this.mTypefaceMap.get(str));
      ...
      if ((!TextUtils.isEmpty(str)) && (new File(str).exists()))
      {
        ...
        TextHook.this.mTypefaceMap.put(str, localTypeface);
        TextHook.a(TextHook.this, localTypeface);
    ...
    {
      if (paramContext != null) {
        TextHook.this.update(paramContext);
      }
    }
  }
}
