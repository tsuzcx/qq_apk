...
class SonicChunkDataHelper
{
  ...
  static void clear()
  {
    ...
    //   5: iconst_4
    //   6: ldc 51
    //   8: invokestatic 57	com/tencent/sonic/sdk/SonicUtils:log	(Ljava/lang/String;ILjava/lang/String;)V
    //   11: invokestatic 63	com/tencent/sonic/sdk/SonicDBHelper:getInstance	()Lcom/tencent/sonic/sdk/SonicDBHelper;
    //   14: invokevirtual 67	com/tencent/sonic/sdk/SonicDBHelper:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   17: ldc 38
    //   19: aconst_null
    //   20: aconst_null
    //   21: invokevirtual 73	android/database/sqlite/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   24: pop
    //   25: ldc 2
    //   27: monitorexit
    //   28: return
    ...
    //   46: aload_0
    //   47: invokevirtual 86	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   56: invokestatic 57	com/tencent/sonic/sdk/SonicUtils:log	(Ljava/lang/String;ILjava/lang/String;)V
    //   59: goto -34 -> 25
    //   62: astore_0
    //   63: ldc 2
    //   65: monitorexit
  ...
  @NonNull
  static List<ChunkData> getChunkDataList(String paramString1, String paramString2)
  {
  ...
  @NonNull
  private static ContentValues getContentValues(String paramString, ChunkData paramChunkData)
  {
  ...
  private static ChunkData querySessionData(Cursor paramCursor)
  {
    ChunkData localChunkData = new ChunkData();
  ...
  private static void saveChunkData(String paramString, List<ChunkData> paramList)
  {
    ...
    if ((paramList != null) && (paramList.size() > 0) && (!TextUtils.isEmpty(paramString))) {
      try
      {
        ...
        {
          ChunkData localChunkData = (ChunkData)paramList.next();
