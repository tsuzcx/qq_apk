...
class SonicDataHelper
{
  ...
  static boolean setSonicUnavailableTime(String paramString, long paramLong)
  {
    ...
    {
      ((SessionData)localObject1).unAvailableTime = paramLong;
      updateSessionData(localSQLiteDatabase, paramString, (SessionData)localObject1);
      return true;
    }
    localObject1 = new SessionData();
    ((SessionData)localObject1).sessionId = paramString;
    ((SessionData)localObject1).eTag = "Unknown";
    ((SessionData)localObject1).htmlSha1 = "Unknown";
    ((SessionData)localObject1).unAvailableTime = paramLong;
    insertSessionData(localSQLiteDatabase, paramString, (SessionData)localObject1);
    return true;
  }
