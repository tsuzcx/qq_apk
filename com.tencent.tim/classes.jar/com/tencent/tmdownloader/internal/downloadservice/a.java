    ...
    try
    {
      ...
      else
      {
        ...
        if (Build.VERSION.SDK_INT >= 24)
        {
          ...
          if (i >= 24)
          {
            localObject1 = (Uri)w.a("android.support.v4.content.FileProvider").a("getUriForFile", new Object[] { GlobalUtil.getInstance().getContext(), "com.tencent.tim.fileprovider", new File(paramString) }).a();
