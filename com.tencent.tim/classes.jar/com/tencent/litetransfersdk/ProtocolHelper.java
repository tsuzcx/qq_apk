...
public class ProtocolHelper
{
  ...
  private void FillIPv6InfoForDownloadResp(MsgSCBody paramMsgSCBody, cmd0x346.RspBody paramRspBody)
  {
    ...
    do
    {
      ...
      } while (!agke.a().l((QQAppInterface)localObject, 7));
    ...
    paramRspBody = new agke.a(paramRspBody, 0);
    Object localObject = agke.a().a((QQAppInterface)localObject, paramRspBody, 7);
    if ((localObject != null) && (!((agke.c)localObject).alz()))
    {
      ...
      if (((agke.c)localObject).cXn == 2)
      {
        paramMsgSCBody.msgBody0x346.pMsgBody0x346_1210.msg_download_info.v6_select_type = V6SelectType_IPv6;
        int j = ((agke.c)localObject).Bb.size();
        paramMsgSCBody.msgBody0x346.pMsgBody0x346_1210.msg_download_info.rpt_str_downloadipv6_list = new String[j];
        paramRspBody = "";
        while (i < j)
        {
          agke.b localb = (agke.b)((agke.c)localObject).Bb.get(i);
          paramMsgSCBody.msgBody0x346.pMsgBody0x346_1210.msg_download_info.rpt_str_downloadipv6_list[i] = localb.vb();
          paramRspBody = paramRspBody + " " + localb.vb() + ":" + localb.mPort;
          i += 1;
        }
  ...
  private void FillIPv6InfoForUploadRspV2(MsgSCBody paramMsgSCBody, cmd0x346.RspBody paramRspBody)
  {
    ...
    if ((localObject != null) && (!((agke.c)localObject).alz()))
    {
      ...
      if (((agke.c)localObject).cXn == 2)
      {
        ...
        {
          agke.b localb = (agke.b)((agke.c)localObject).Bb.get(i);
          paramMsgSCBody.msgBody0x346.pMsgBody0x346_uploadRsp.rpt_str_uploadipv6_list[i] = localb.vb();
          paramRspBody = paramRspBody + " " + localb.vb() + ":" + localb.mPort;
          i += 1;
        }
  ...
  public long GetSelfUin()
  {
    ...
    if (this.mUinType == 1) {
      return ((syw)((QQAppInterface)this.mApp).getBusinessHandler(51)).getSelfUin();
    }
    return 0L;
  }
  ...
  {
    Session localSession = genSession(paramDataLineMsgRecord.fileFrom, paramDataLineMsgRecord.path, paramDataLineMsgRecord.thumbPath, paramDataLineMsgRecord.filename, acde.gv(paramDataLineMsgRecord.msgtype), 0, paramDataLineMsgRecord.sessionid, paramDataLineMsgRecord.groupId, paramDataLineMsgRecord.groupSize, paramDataLineMsgRecord.groupIndex);
  ...
  public void showFileIsEmptyDialog(String paramString)
  {
    ...
    {
      ahao.JD("'" + paramString + "'" + BaseApplication.getContext().getResources().getString(2131695399));
      return;
    }
  ...
  public void showFileNotExistDialog(String paramString)
  {
    ...
    if (Thread.currentThread() == localLooper.getThread())
    {
      ahao.JD("'" + paramString + "'" + BaseApplication.getContext().getResources().getString(2131695402));
      return;
    }
  ...
  public void showFileTooLargeDialog(String paramString)
  {
    ...
    if (Thread.currentThread() == localLooper.getThread())
    {
      ahao.JD("'" + paramString + "'" + BaseApplication.getContext().getResources().getString(2131695400));
      return;
    }
