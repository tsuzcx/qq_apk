  ...
  implements GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener, ScaleGestureDetector.OnScaleGestureListener
{
  ...
  private void applyTransformation(View paramView1, View paramView2)
  {
    ...
    paramView2.setTag(2131296388, (TransformationInfo)paramView1.getTag(2131296388));
  }
  ...
  private ScaleViewHolder getChildGravityAndScale(int paramInt1, int paramInt2, int paramInt3, int paramInt4, View paramView)
  {
    boolean bool2 = false;
    ScaleViewHolder localScaleViewHolder = new ScaleViewHolder(null);
  ...
  private TransformationInfo getChildTransformationInfo(View paramView)
  {
    TransformationInfo localTransformationInfo2 = (TransformationInfo)paramView.getTag(2131296388);
    TransformationInfo localTransformationInfo1 = localTransformationInfo2;
    if (localTransformationInfo2 == null)
    {
      localTransformationInfo1 = new TransformationInfo();
  ...
  private Rect getImageSize(View paramView)
  {
    ...
    if (VersionUtils.isHoneycomb()) {}
    for (Matrix localMatrix = paramView.getMatrix();; localMatrix = getChildTransformationInfo(paramView).mMatrix)
    {
  ...
  private void layoutAndScaleChild(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, View paramView)
  {
    ...
    ScaleViewHolder localScaleViewHolder = getChildGravityAndScale(i, j, paramInt1, paramInt2, paramView);
    boolean bool1;
    boolean bool2;
  ...
  {
    if (paramView == null) {}
    TransformationInfo localTransformationInfo;
    do
    {
      return;
      if (VersionUtils.isHoneycomb())
  ...
  private void updateMatrix(TransformationInfo paramTransformationInfo)
  {
    if (paramTransformationInfo == null) {}
    while (!paramTransformationInfo.mMatrixDirty) {
      return;
    }
    paramTransformationInfo.mMatrix.reset();
    paramTransformationInfo.mMatrix.setTranslate(paramTransformationInfo.mTranslationX, paramTransformationInfo.mTranslationY);
    paramTransformationInfo.mMatrix.preRotate(paramTransformationInfo.mRotation, paramTransformationInfo.mPivotX, paramTransformationInfo.mPivotY);
    paramTransformationInfo.mMatrix.preScale(paramTransformationInfo.mScaleX, paramTransformationInfo.mScaleY, paramTransformationInfo.mPivotX, paramTransformationInfo.mPivotY);
    paramTransformationInfo.mMatrixDirty = false;
    TransformationInfo.access$302(paramTransformationInfo, paramTransformationInfo.mMatrix.isIdentity());
  }
  ...
  public Matrix getChildMatrix(View paramView)
  {
    ...
    return getChildTransformationInfo(paramView).mMatrix;
  }
  ...
  {
    paramView = (TransformationInfo)paramView.getTag(2131296388);
    if (paramView != null)
    {
      updateMatrix(paramView);
      paramTransformation.getMatrix().set(paramView.mMatrix);
      return true;
    }
    return false;
  }
  ...
  public void scrollIntoSlots(float paramFloat)
  {
    ...
    for (i = ((Integer)this.mSelectedChild.getTag(2131296389)).intValue();; i = 0)
    {
      ...
      if ((this.mSelectedChild.getTag(2131296392) instanceof Float))
      {
        ...
        ScaleViewHolder localScaleViewHolder = getChildGravityAndScale(k, m, n, i1, this.mSelectedChild);
  ...
  public void setOnItemRotateListener(OnItemRotateListener paramOnItemRotateListener)
  {
    this.mOnItemRotateListener = paramOnItemRotateListener;
  }
  
  public void setOnScollListener(OnScollListener paramOnScollListener)
  {
    ...
    implements Runnable
  {
    ...
    private OverScroller mScroller = new OverScroller(Gallery.this.getContext());
    ...
    public void run()
    {
      ...
      Gallery.access$902(Gallery.this, false);
      ...
      if (this.mStartTime >= 0L)
      {
        ...
        if (n >= Gallery.this.mAnimationDuration) {
          break label273;
        }
      ...
      {
        Gallery.this.setChildScale(Gallery.this.mSelectedChild, f2);
        Gallery.this.setChildRotation(Gallery.this.mSelectedChild, f1);
        if (!this.mScaling) {
          this.mScaling = true;
        }
      ...
      if (this.mScaling)
      {
        ...
        if (Gallery.this.canUpdateRegionRect())
        {
          ...
          bool = true;
          ((Gallery)localObject).updateShowArea(bool);
        }
      }
      for (;;)
      {
    ...
    public void startUsingDistance(int paramInt1, int paramInt2)
    {
      ...
      do
      {
        ...
        this.mLastFlingX = 0;
        this.mLastFlingY = 0;
        this.mScroller.startScroll(0, 0, paramInt1, paramInt2, Gallery.this.mAnimationDuration);
        Gallery.this.post(this);
      } while (Gallery.this.mOnScollListener == null);
    ...
    public void startUsingVelocity(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
    {
      ...
      if (AnimationUtils.currentAnimationTimeMillis() - Gallery.this.lastMoveTime > 15L) {
        this.mScroller.fling(Gallery.this.lastMoveTime + 15L, 0, 0, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, Gallery.this.mSpacing, Gallery.this.mSpacing);
      }
      for (;;)
      {
        Gallery.this.post(this);
        ...
        Gallery.this.mOnScollListener.onScrollStart(Gallery.this.mSelectedPosition);
        return;
        this.mScroller.fling(0, 0, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, Gallery.this.mSpacing, Gallery.this.mSpacing);
      }
    }
  ...
  public static abstract interface OnItemRotateListener
  {
    public abstract void onRotateFinished(View paramView, int paramInt1, int paramInt2);
  }
  
  public static abstract interface OnScollListener
  {
