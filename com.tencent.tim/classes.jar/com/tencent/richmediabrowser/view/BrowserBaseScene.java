  ...
  implements AnimationLister, IGalleryAnimationEvent, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, AdapterView.OnItemSelectedListener, Gallery.OnItemRotateListener, Gallery.OnScollListener
{
  ...
  {
    return (RelativeLayout)LayoutInflater.from(this.mContext).inflate(2131558794, null);
  }
  ...
  public void onCreate(ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      this.rootView = ((ViewGroup)this.mRoot.findViewById(2131377546));
      this.mGallery = ((Gallery)this.mContext.findViewById(2131367833));
      ...
      this.mGallery.setSpacing(this.mContext.getResources().getDimensionPixelSize(2131297406));
