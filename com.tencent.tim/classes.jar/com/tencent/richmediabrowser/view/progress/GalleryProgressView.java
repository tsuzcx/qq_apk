  ...
  implements AbstractProgressView
{
  ...
  private void initDrawable(Activity paramActivity)
  {
    ...
    try
    {
      localObject2 = BitmapFactory.decodeResource(paramActivity.getResources(), 2130842382);
  ...
  {
    this.progressBar = ((ImageView)((RelativeLayout)paramBrowserBaseScene.getRootView()).findViewById(2131373704));
    initDrawable(paramActivity);
  }
