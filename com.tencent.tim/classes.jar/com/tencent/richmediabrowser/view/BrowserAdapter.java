  ...
  implements IGalleryScaleListener, ProGallery.OnProGalleryListener
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject1 = new GalleryUrlImageView(this.mContext);
    if ((localObject2 == null) || (((RichMediaBrowserInfo)localObject2).baseData == null) || (this.mainBrowserPresenter == null)) {
    ...
    for (;;)
    {
      ...
      return localObject1;
      int i = ((RichMediaBrowserInfo)localObject2).baseData.getType();
      if (this.mainBrowserPresenter.getPresenter(i) == null) {
        this.mainBrowserPresenter.buildMVP(i);
      }
      localObject2 = this.mainBrowserPresenter.getPresenter(i);
      if (localObject2 == null) {
        break label215;
      }
      localObject2 = ((BrowserBasePresenter)localObject2).browserBaseView;
      if (localObject2 == null) {
        break;
      }
      localObject1 = ((BrowserBaseView)localObject2).getView(paramInt, paramView, paramViewGroup);
      if ((localObject1 != null) && ((((View)localObject1).getTag() instanceof IBrowserViewHolder))) {
        ((BrowserBaseView)localObject2).setViewHolder((IBrowserViewHolder)((View)localObject1).getTag());
      }
    }
