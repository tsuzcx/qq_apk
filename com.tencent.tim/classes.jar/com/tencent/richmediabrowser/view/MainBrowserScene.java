  ...
  implements DragView.OnGestureChangeListener
{
  ...
  {
    return (RelativeLayout)LayoutInflater.from(this.mContext).inflate(2131559521, null);
  }
  ...
  {
    this.contentView = ((RelativeLayout)this.rootView.findViewById(2131365360));
    ...
    this.mDragView = ((DragView)this.mRoot.findViewById(2131366139));
