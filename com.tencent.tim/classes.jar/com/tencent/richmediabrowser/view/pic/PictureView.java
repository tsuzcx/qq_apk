  ...
  extends BrowserBaseView
{
  ...
  {
    if (((paramView instanceof RelativeLayout)) && ((paramView.getTag() instanceof GalleryPictureViewHolder)))
    {
      this.galleryView = ((RelativeLayout)paramView);
      paramView = ((GalleryPictureViewHolder)paramView.getTag()).urlImageView;
    }
    for (;;)
    {
      ...
      paramViewGroup = this.mContext.getResources().getDrawable(2130851853);
      paramView.setTag(Integer.valueOf(1));
      paramView.setIgnoreLayout(false);
      paramView.setImageDrawable(paramViewGroup);
      paramViewGroup = new GalleryPictureViewHolder();
  ...
  {
    if ((paramView != null) && ((paramView.getTag() instanceof GalleryPictureViewHolder)))
    {
      paramView = ((GalleryPictureViewHolder)paramView.getTag()).urlImageView.getDrawable();
  ...
  public class GalleryPictureViewHolder
