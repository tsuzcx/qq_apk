  ...
  implements View.OnClickListener
{
  ...
  {
    if (((paramView instanceof RelativeLayout)) && ((paramView.getTag() instanceof GalleryVideoViewHolder)))
    {
      this.galleryView = ((RelativeLayout)paramView);
      paramView = ((GalleryVideoViewHolder)paramView.getTag()).videoView;
    }
    for (;;)
    {
      paramView = new GalleryVideoViewHolder();
