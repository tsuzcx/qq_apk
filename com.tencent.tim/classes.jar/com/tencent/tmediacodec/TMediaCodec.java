  ...
  implements IMediaCodec
{
  ...
  private TMediaCodec(String paramString, CreateBy paramCreateBy)
  {
  ...
  {
    return new TMediaCodec(paramString, CreateBy.CreateByName);
  }
  
  public static TMediaCodec createDecoderByType(@NonNull String paramString)
  {
    return new TMediaCodec(paramString, CreateBy.CreateByType);
  }
  ...
  public final void setCallback(@Nullable Callback paramCallback)
  {
    ...
    localMediaCodec.setCallback(new HookCallback(this, paramCallback));
  }
  
  @TargetApi(23)
  public final void setCallback(@NonNull Callback paramCallback, @Nullable Handler paramHandler)
  {
    ...
    localMediaCodec.setCallback(new HookCallback(this, paramCallback), paramHandler);
  }
  ...
  @TargetApi(21)
  public static final class HookCallback
    extends MediaCodec.Callback
  {
    ...
    public HookCallback(@NonNull TMediaCodec paramTMediaCodec, @Nullable TMediaCodec.Callback paramCallback)
    {
