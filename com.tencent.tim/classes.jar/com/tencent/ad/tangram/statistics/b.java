...
public final class b
{
  ...
  {
    paramWeakReference = getUrl(paramAd, paramInt);
    ...
    AdLog.i("AdReporterForEffect", String.format("reportAsync %s", new Object[] { paramWeakReference }));
    AdThreadManager.INSTANCE.post(new b.1(paramWeakReference), 4);
  }
}
