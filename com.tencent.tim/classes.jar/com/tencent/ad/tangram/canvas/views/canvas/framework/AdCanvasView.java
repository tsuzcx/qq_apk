  ...
  implements AdArkAdapter.ArkNotifyCallback, AdCanvasViewListener
{
  ...
  private void dealXiJingDefaultPageIfTriggleDownload()
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((!this.data.ad.isAppXiJingDefault()) || ((!this.mAppDownloadManager.hasStartedDownload()) && ((!this.data.getAutoDownLoad()) || (!com.tencent.ad.tangram.net.a.isWifiConnected(getContext())))) || (this.bottomFixedButtonView.getVisibility() != 0));
  ...
  private void initTopBar()
  {
    ...
    Object localObject1 = new RelativeLayout.LayoutParams(-1, AdUIUtils.dp2px(60.0F, getResources()));
    ...
    Object localObject2 = AdUIUtils.getBitmapFromString("");
    ...
    localObject2 = new RelativeLayout.LayoutParams(AdUIUtils.dp2px(60.0F, getResources()), AdUIUtils.dp2px(60.0F, getResources()));
    this.closeIcon.setLayoutParams((ViewGroup.LayoutParams)localObject2);
    ...
    this.topBar.addView(this.closeIcon, (ViewGroup.LayoutParams)localObject2);
  }
  ...
  private void showProgressBarIfTriggleDownload()
  {
    ...
    do
    {
      ...
      } while ((TextUtils.isEmpty(str)) || ((!this.mAppDownloadManager.hasStartedDownload()) && ((!this.data.getAutoDownLoad()) || (!com.tencent.ad.tangram.net.a.isWifiConnected(getContext())))));
