  ...
  implements AdImageViewAdapter.Callback
{
  ...
  private void init(Context paramContext, a parama)
  {
    ...
    ((RelativeLayout.LayoutParams)localObject1).leftMargin = AdUIUtils.dp2px(15.0F, paramContext.getResources());
    ...
    for (localObject1 = parama.downloadCount / 10000L + "万次下载 ";; localObject1 = parama.downloadCount + "次下载 ")
    {
      ...
      localTextView.setMaxWidth(AdUIUtils.dp2px(170.0F, paramContext.getResources()));
      localTextView.setEllipsize(TextUtils.TruncateAt.END);
      localTextView.setText(parama.starCount + "分 " + (String)localObject1 + AdUIUtils.getFileSizeDesc(parama.fileSize));
      ...
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = AdUIUtils.dp2px(15.0F, paramContext.getResources());
      ((RelativeLayout.LayoutParams)localObject1).topMargin = AdUIUtils.dp2px(5.0F, paramContext.getResources());
