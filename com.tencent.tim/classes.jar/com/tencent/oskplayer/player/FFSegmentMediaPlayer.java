  ...
  implements ISegmentMediaPlayer
{
  ...
  private String generatePlayListFile(SegmentVideoInfo.StreamInfo paramStreamInfo, List<String> paramList)
  {
    // Byte code:
    //   0: aload_1
    //   1: getfield 188	com/tencent/oskplayer/model/SegmentVideoInfo$StreamInfo:segmentInfos	Ljava/util/ArrayList;
    //   4: invokevirtual 194	java/util/ArrayList:size	()I
    //   7: iconst_1
    //   8: if_icmpne +14 -> 22
    //   11: aload_2
    //   12: iconst_0
    //   13: invokeinterface 200 2 0
    //   18: checkcast 202	java/lang/String
    //   21: areturn
    //   22: aload_0
    //   23: getfield 204	com/tencent/oskplayer/player/FFSegmentMediaPlayer:mPlayListFile	Ljava/io/File;
    //   26: ifnonnull +302 -> 328
    //   29: invokestatic 210	com/tencent/oskplayer/PlayerConfig:g	()Lcom/tencent/oskplayer/PlayerConfig;
    //   32: invokevirtual 214	com/tencent/oskplayer/PlayerConfig:getTempDir	()Ljava/lang/String;
    //   35: astore 4
    //   37: aload 4
    //   39: ifnonnull +14 -> 53
    //   42: bipush 6
    //   44: ldc 13
    //   46: ldc 216
    //   48: invokestatic 222	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   51: aconst_null
    //   52: areturn
    //   53: new 224	java/io/File
    //   56: dup
    //   57: aload 4
    //   59: invokespecial 225	java/io/File:<init>	(Ljava/lang/String;)V
    //   62: astore 5
    //   64: aload_0
    //   65: new 224	java/io/File
    //   68: dup
    //   69: new 227	java/lang/StringBuilder
    //   72: dup
    //   73: invokespecial 228	java/lang/StringBuilder:<init>	()V
    //   76: aload 4
    //   78: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   81: getstatic 235	java/io/File:separator	Ljava/lang/String;
    //   84: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   87: invokestatic 241	java/lang/System:currentTimeMillis	()J
    //   90: invokevirtual 244	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   93: ldc 246
    ...
    //   101: invokespecial 225	java/io/File:<init>	(Ljava/lang/String;)V
    //   104: putfield 204	com/tencent/oskplayer/player/FFSegmentMediaPlayer:mPlayListFile	Ljava/io/File;
    //   107: aload 5
    //   109: invokevirtual 252	java/io/File:exists	()Z
    //   112: ifne +9 -> 121
    //   115: aload 5
    //   117: invokevirtual 255	java/io/File:mkdirs	()Z
    //   120: pop
    //   121: iconst_4
    //   122: ldc 13
    //   124: new 227	java/lang/StringBuilder
    //   127: dup
    //   128: invokespecial 228	java/lang/StringBuilder:<init>	()V
    //   131: ldc_w 257
    //   134: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   137: aload_0
    //   138: getfield 204	com/tencent/oskplayer/player/FFSegmentMediaPlayer:mPlayListFile	Ljava/io/File;
    //   141: invokevirtual 260	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   144: invokevirtual 249	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   147: invokestatic 222	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   150: new 262	java/io/FileOutputStream
    //   153: dup
    //   154: aload_0
    //   155: getfield 204	com/tencent/oskplayer/player/FFSegmentMediaPlayer:mPlayListFile	Ljava/io/File;
    //   158: invokespecial 265	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   161: astore 5
    //   163: aload 5
    //   165: astore 4
    //   167: new 227	java/lang/StringBuilder
    //   170: dup
    //   171: invokespecial 228	java/lang/StringBuilder:<init>	()V
    //   174: astore 6
    //   176: aload 5
    //   178: astore 4
    //   180: aload 6
    ...
    //   191: astore 4
    //   193: aload_1
    //   194: getfield 188	com/tencent/oskplayer/model/SegmentVideoInfo$StreamInfo:segmentInfos	Ljava/util/ArrayList;
    //   197: invokevirtual 271	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   200: astore_1
    //   201: iconst_0
    //   202: istore_3
    //   203: aload 5
    //   205: astore 4
    //   207: aload_1
    //   208: invokeinterface 276 1 0
    //   213: ifeq +88 -> 301
    //   216: aload 5
    //   218: astore 4
    //   220: aload_1
    //   221: invokeinterface 280 1 0
    //   226: checkcast 282	com/tencent/oskplayer/model/SegmentVideoInfo$SegmentInfo
    //   229: astore 7
    //   231: aload 5
    //   233: astore 4
    //   235: aload 6
    ...
    //   243: aload_2
    //   244: iload_3
    //   245: invokeinterface 200 2 0
    //   250: checkcast 202	java/lang/String
    //   253: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   256: ldc_w 286
    //   259: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   262: pop
    //   263: aload 5
    //   265: astore 4
    //   267: aload 6
    ...
    //   275: aload 7
    //   277: getfield 291	com/tencent/oskplayer/model/SegmentVideoInfo$SegmentInfo:duration	I
    //   280: sipush 1000
    //   283: idiv
    //   284: invokevirtual 294	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   287: ldc_w 286
    ...
    //   305: aload 5
    //   307: aload 6
    //   309: invokevirtual 249	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   312: invokevirtual 298	java/lang/String:getBytes	()[B
    //   315: invokevirtual 304	java/io/OutputStream:write	([B)V
    //   318: aload 5
    //   320: ifnull +8 -> 328
    //   323: aload 5
    //   325: invokevirtual 307	java/io/OutputStream:close	()V
    //   328: aload_0
    //   329: getfield 204	com/tencent/oskplayer/player/FFSegmentMediaPlayer:mPlayListFile	Ljava/io/File;
    //   332: invokevirtual 310	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   335: areturn
    //   336: astore_1
    //   337: bipush 6
    //   339: ldc 13
    ...
    //   354: aload_1
    //   355: invokevirtual 315	java/io/IOException:getMessage	()Ljava/lang/String;
    //   358: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   361: invokevirtual 249	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   364: invokestatic 222	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   367: aconst_null
    //   368: areturn
    //   369: astore_2
    //   370: aconst_null
    ...
    //   372: bipush 6
    //   374: ldc 13
    //   376: new 227	java/lang/StringBuilder
    //   379: dup
    //   380: invokespecial 228	java/lang/StringBuilder:<init>	()V
    //   383: ldc_w 317
    //   386: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   389: aload_2
    //   390: invokevirtual 318	java/io/FileNotFoundException:getMessage	()Ljava/lang/String;
    //   393: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   396: invokevirtual 249	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   399: invokestatic 222	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   402: aload_1
    //   403: ifnull +7 -> 410
    //   406: aload_1
    //   407: invokevirtual 307	java/io/OutputStream:close	()V
    //   410: aconst_null
    //   411: areturn
    //   412: astore_1
    //   413: bipush 6
    ...
    //   424: ldc_w 312
    //   427: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   430: aload_1
    //   431: invokevirtual 315	java/io/IOException:getMessage	()Ljava/lang/String;
    //   434: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   437: invokevirtual 249	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   440: invokestatic 222	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   443: aconst_null
    //   444: areturn
    //   445: astore_1
    //   446: aconst_null
    ...
    //   453: bipush 6
    //   455: ldc 13
    //   457: new 227	java/lang/StringBuilder
    //   460: dup
    //   461: invokespecial 228	java/lang/StringBuilder:<init>	()V
    //   464: ldc_w 320
    //   467: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   470: aload_1
    //   471: invokevirtual 315	java/io/IOException:getMessage	()Ljava/lang/String;
    //   474: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   477: invokevirtual 249	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   480: invokestatic 222	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   483: aload 5
    //   485: ifnull +8 -> 493
    //   488: aload 5
    //   490: invokevirtual 307	java/io/OutputStream:close	()V
    //   493: aconst_null
    //   494: areturn
    //   495: astore_1
    //   496: bipush 6
    //   498: ldc 13
    //   500: new 227	java/lang/StringBuilder
    //   503: dup
    //   504: invokespecial 228	java/lang/StringBuilder:<init>	()V
    //   507: ldc_w 312
    //   510: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   513: aload_1
    //   514: invokevirtual 315	java/io/IOException:getMessage	()Ljava/lang/String;
    //   517: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   520: invokevirtual 249	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   523: invokestatic 222	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   526: aconst_null
    //   527: areturn
    //   528: astore_1
    //   529: aconst_null
    ...
    //   534: ifnull +8 -> 542
    //   537: aload 4
    //   539: invokevirtual 307	java/io/OutputStream:close	()V
    //   542: aload_1
    //   543: athrow
    //   544: astore_1
    //   545: bipush 6
    //   547: ldc 13
    //   549: new 227	java/lang/StringBuilder
    //   552: dup
    //   553: invokespecial 228	java/lang/StringBuilder:<init>	()V
    //   556: ldc_w 312
    //   559: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   562: aload_1
    //   563: invokevirtual 315	java/io/IOException:getMessage	()Ljava/lang/String;
    //   566: invokevirtual 232	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   569: invokevirtual 249	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   572: invokestatic 222	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   575: aconst_null
    //   576: areturn
    //   577: astore_1
    //   578: goto -46 -> 532
  ...
  class AbstractMediaPlayerListenerHolder
    implements IMediaPlayer.OnBufferingUpdateListener, IMediaPlayer.OnCompletionListener, IMediaPlayer.OnErrorListener, IMediaPlayer.OnInfoListener, IMediaPlayer.OnPreparedListener, IMediaPlayer.OnSeekCompleteListener, IMediaPlayer.OnVideoSizeChangedListener
  {
    ...
    public AbstractMediaPlayerListenerHolder(AbstractMediaPlayer paramAbstractMediaPlayer)
    {
    ...
    public void onBufferingUpdate(IMediaPlayer paramIMediaPlayer, int paramInt)
    {
      ...
      FFSegmentMediaPlayer.this.notifyOnBufferingUpdate(paramInt);
    }
    ...
    public void onCompletion(IMediaPlayer paramIMediaPlayer)
    {
      ...
      for (;;)
      {
        ...
        if (FFSegmentMediaPlayer.this.isLooping)
        {
          ...
          FFSegmentMediaPlayer.access$202(FFSegmentMediaPlayer.this, true);
          FFSegmentMediaPlayer.access$302(FFSegmentMediaPlayer.this, true);
    ...
    public boolean onError(IMediaPlayer paramIMediaPlayer, int paramInt1, int paramInt2)
    {
      ...
      FFSegmentMediaPlayer.access$702(FFSegmentMediaPlayer.this, -1);
      FFSegmentMediaPlayer.access$802(FFSegmentMediaPlayer.this, -1);
      return (paramIMediaPlayer != null) && (FFSegmentMediaPlayer.this.notifyOnError(paramInt1, paramInt2));
    }
    ...
    public boolean onInfo(IMediaPlayer paramIMediaPlayer, int paramInt1, int paramInt2)
    {
      ...
      if ((FFSegmentMediaPlayer.this.preventBufferingEvent) && (paramInt1 == 701)) {
        return false;
      }
      if ((FFSegmentMediaPlayer.this.preventBufferingEvent) && (paramInt1 == 702))
      {
        FFSegmentMediaPlayer.access$202(FFSegmentMediaPlayer.this, false);
        return false;
      }
      return FFSegmentMediaPlayer.this.notifyOnInfo(paramInt1, paramInt2);
    }
    ...
    public void onPrepared(IMediaPlayer paramIMediaPlayer)
    {
      ...
      FFSegmentMediaPlayer.access$702(FFSegmentMediaPlayer.this, 2);
    ...
    public void onSeekComplete(IMediaPlayer paramIMediaPlayer)
    {
      ...
      FFSegmentMediaPlayer.access$302(FFSegmentMediaPlayer.this, false);
    }
    ...
    public void onVideoSizeChanged(IMediaPlayer paramIMediaPlayer, int paramInt1, int paramInt2)
    {
      ...
      FFSegmentMediaPlayer.this.notifyOnVideoSizeChanged(paramInt1, paramInt2, 1, 1);
    }
  }
}
