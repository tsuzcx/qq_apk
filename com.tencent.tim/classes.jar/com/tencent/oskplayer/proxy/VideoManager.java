...
public class VideoManager
{
  ...
  public boolean isCached(SegmentVideoInfo.StreamInfo paramStreamInfo)
  {
    ...
    {
      paramStreamInfo = ThreadUtils.submitTaskCatchAll(new IsStreamInfoCachedCallable(paramStreamInfo), 800, true, "isCached", "VideoManager");
  ...
  class IsStreamInfoCachedCallable
    implements Callable<Boolean>
  {
    private SegmentVideoInfo.StreamInfo mStreamInfo;
    
    public IsStreamInfoCachedCallable(SegmentVideoInfo.StreamInfo paramStreamInfo)
    {
      ...
      throws Exception
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!VideoManager.this.proxy.isCached(localSegmentInfo.url)) {
