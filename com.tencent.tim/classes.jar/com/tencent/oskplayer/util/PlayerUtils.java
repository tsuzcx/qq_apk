...
public class PlayerUtils
{
    ...
    throws IllegalStateException
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: new 169	java/net/ServerSocket
    //   5: dup
    //   6: iconst_0
    //   7: invokespecial 170	java/net/ServerSocket:<init>	(I)V
    //   10: astore_1
    //   11: aload_1
    //   12: iconst_1
    //   13: invokevirtual 174	java/net/ServerSocket:setReuseAddress	(Z)V
    //   16: aload_1
    //   17: invokevirtual 177	java/net/ServerSocket:getLocalPort	()I
    //   20: istore_0
    //   21: aload_1
    //   22: invokevirtual 180	java/net/ServerSocket:close	()V
    //   25: aload_1
    //   26: ifnull +7 -> 33
    //   29: aload_1
    //   30: invokevirtual 180	java/net/ServerSocket:close	()V
    //   33: iload_0
    //   34: ireturn
    //   35: astore_1
    //   36: aconst_null
    ...
    //   39: ifnull +7 -> 46
    //   42: aload_1
    //   43: invokevirtual 180	java/net/ServerSocket:close	()V
    //   46: new 165	java/lang/IllegalStateException
    //   49: dup
    //   50: ldc 182
    ...
    //   58: ifnull +7 -> 65
    //   61: aload_2
    //   62: invokevirtual 180	java/net/ServerSocket:close	()V
    //   65: aload_1
    //   66: athrow
    //   67: astore_2
    //   68: goto -43 -> 25
  ...
  {
    // Byte code:
    //   0: new 264	java/net/URL
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 265	java/net/URL:<init>	(Ljava/lang/String;)V
    //   8: astore 6
    //   10: iconst_0
    //   11: istore 4
    //   13: iconst_4
    ...
    //   28: aload 6
    //   30: invokevirtual 752	java/net/URL:toExternalForm	()Ljava/lang/String;
    ...
    //   39: invokestatic 195	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   42: iload 4
    //   44: iconst_1
    //   45: iadd
    //   46: istore 5
    ...
    //   81: invokestatic 195	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   84: iload_2
    //   85: iconst_1
    //   86: if_icmpne +170 -> 256
    //   89: new 264	java/net/URL
    //   92: dup
    //   93: aload_1
    //   94: aload 6
    //   96: invokevirtual 752	java/net/URL:toExternalForm	()Ljava/lang/String;
    //   99: ldc2_w 755
    //   102: invokestatic 760	com/tencent/oskplayer/util/PlayerUtils:replaceDomainPrependIp	(Lcom/tencent/oskplayer/service/DNSService;Ljava/lang/String;J)Ljava/lang/String;
    //   105: invokespecial 265	java/net/URL:<init>	(Ljava/lang/String;)V
    //   108: astore 6
    //   110: aload 6
    //   112: invokestatic 764	com/tencent/oskplayer/util/PlayerUtils:shouldByPassProxySetting	(Ljava/net/URL;)Z
    //   115: ifeq +198 -> 313
    //   118: aload 6
    //   120: getstatic 770	java/net/Proxy:NO_PROXY	Ljava/net/Proxy;
    //   123: invokevirtual 774	java/net/URL:openConnection	(Ljava/net/Proxy;)Ljava/net/URLConnection;
    //   126: checkcast 776	java/net/HttpURLConnection
    //   129: astore 7
    //   131: aload 7
    //   133: sipush 30000
    //   136: invokevirtual 779	java/net/HttpURLConnection:setConnectTimeout	(I)V
    //   139: aload 7
    //   141: sipush 12000
    //   144: invokevirtual 782	java/net/HttpURLConnection:setReadTimeout	(I)V
    //   147: aload 7
    //   149: iconst_0
    //   150: invokevirtual 785	java/net/HttpURLConnection:setDoOutput	(Z)V
    //   153: aload 7
    //   155: iconst_0
    //   156: invokevirtual 788	java/net/HttpURLConnection:setInstanceFollowRedirects	(Z)V
    //   159: aload 7
    //   161: invokevirtual 791	java/net/HttpURLConnection:connect	()V
    //   164: new 793	com/tencent/oskplayer/datasource/DefaultHttpDataSource$GetResponseCodeCallable
    //   167: dup
    //   168: aload 7
    //   170: invokespecial 796	com/tencent/oskplayer/datasource/DefaultHttpDataSource$GetResponseCodeCallable:<init>	(Ljava/net/HttpURLConnection;)V
    //   173: sipush 12000
    //   176: iconst_1
    //   177: ldc_w 798
    ...
    //   200: invokestatic 806	com/tencent/oskplayer/util/ThreadUtils:submitTask	(Ljava/util/concurrent/Callable;IZLjava/lang/String;Ljava/lang/String;)Ljava/lang/Object;
    //   203: astore 8
    //   205: aload 8
    //   207: ifnonnull +119 -> 326
    //   210: aload 7
    //   212: invokevirtual 809	java/net/HttpURLConnection:disconnect	()V
    //   215: bipush 6
    //   217: ldc 24
    //   219: ldc_w 811
    //   222: invokestatic 195	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   225: aconst_null
    //   226: areturn
    //   227: astore_0
    //   228: bipush 6
    ...
    //   244: aload_0
    //   245: invokevirtual 718	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   248: invokevirtual 111	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   251: invokestatic 195	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   254: aconst_null
    //   255: areturn
    //   256: iload_2
    //   257: ifne +27 -> 284
    //   260: new 264	java/net/URL
    //   263: dup
    //   264: aload_1
    //   265: aload 6
    //   267: invokevirtual 752	java/net/URL:toExternalForm	()Ljava/lang/String;
    //   270: ldc2_w 755
    //   273: invokestatic 816	com/tencent/oskplayer/util/PlayerUtils:replaceDomain	(Lcom/tencent/oskplayer/service/DNSService;Ljava/lang/String;J)Ljava/lang/String;
    //   276: invokespecial 265	java/net/URL:<init>	(Ljava/lang/String;)V
    //   279: astore 6
    //   281: goto -171 -> 110
    //   284: iconst_5
    //   285: aload_3
    ...
    //   307: invokestatic 195	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   310: goto +248 -> 558
    //   313: aload 6
    //   315: invokevirtual 821	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   318: checkcast 776	java/net/HttpURLConnection
    //   321: astore 7
    //   323: goto -192 -> 131
    //   326: aload 8
    //   328: checkcast 115	java/lang/Integer
    //   331: invokevirtual 824	java/lang/Integer:intValue	()I
    //   334: istore 4
    //   336: iload 4
    //   338: sipush 300
    ...
    //   384: aload 7
    //   386: ldc_w 826
    //   389: invokevirtual 829	java/net/HttpURLConnection:getHeaderField	(Ljava/lang/String;)Ljava/lang/String;
    //   392: astore 8
    //   394: iconst_4
    //   395: aload_3
    ...
    //   417: invokestatic 195	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   420: aload 7
    //   422: invokevirtual 809	java/net/HttpURLConnection:disconnect	()V
    //   425: aload 6
    //   427: aload 8
    //   429: invokestatic 837	com/tencent/oskplayer/datasource/DefaultHttpDataSource:handleRedirect	(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;
    //   432: astore 6
    //   434: iload 5
    //   436: istore 4
    //   438: goto -396 -> 42
    ...
    //   466: aload 6
    //   468: invokevirtual 752	java/net/URL:toExternalForm	()Ljava/lang/String;
    ...
    //   488: invokestatic 195	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   491: aload 6
    //   493: invokevirtual 752	java/net/URL:toExternalForm	()Ljava/lang/String;
    //   496: astore_0
    //   497: aload_0
    //   498: areturn
    //   499: astore_0
    ...
    //   515: aload_0
    //   516: invokestatic 648	com/tencent/oskplayer/util/PlayerUtils:getPrintableStackTrace	(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    //   525: invokestatic 195	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   528: aconst_null
    //   529: areturn
    //   530: iconst_5
    //   531: aload_3
    ...
    //   553: invokestatic 195	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   556: aconst_null
    //   557: areturn
    //   558: goto -448 -> 110
    // Local variable table:
