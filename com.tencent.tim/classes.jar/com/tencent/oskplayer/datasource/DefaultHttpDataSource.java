  ...
  implements HttpDataSource
{
  ...
  private static long getContentLength(HttpURLConnection paramHttpURLConnection, String paramString)
  {
    ...
    //   5: aload_0
    //   6: ldc_w 291
    //   9: invokevirtual 294	java/net/HttpURLConnection:getHeaderField	(Ljava/lang/String;)Ljava/lang/String;
    //   12: astore 8
    //   14: lload 4
    //   16: lstore_2
    //   17: aload 8
    //   19: invokestatic 300	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   22: ifne +9 -> 31
    //   25: aload 8
    //   27: invokestatic 306	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   30: lstore_2
    //   31: aload_0
    //   32: ldc_w 308
    //   35: invokevirtual 294	java/net/HttpURLConnection:getHeaderField	(Ljava/lang/String;)Ljava/lang/String;
    //   38: astore_0
    //   39: lload_2
    //   40: lstore 4
    //   42: aload_0
    //   43: invokestatic 300	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   46: ifne +64 -> 110
    //   49: getstatic 67	com/tencent/oskplayer/datasource/DefaultHttpDataSource:CONTENT_RANGE_HEADER	Ljava/util/regex/Pattern;
    //   52: aload_0
    //   53: invokevirtual 312	java/util/regex/Pattern:matcher	(Ljava/lang/CharSequence;)Ljava/util/regex/Matcher;
    //   56: astore 9
    //   58: lload_2
    //   59: lstore 4
    //   61: aload 9
    //   63: invokevirtual 317	java/util/regex/Matcher:find	()Z
    //   66: ifeq +44 -> 110
    //   69: aload 9
    //   71: iconst_2
    //   72: invokevirtual 321	java/util/regex/Matcher:group	(I)Ljava/lang/String;
    //   75: invokestatic 306	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   78: lstore 4
    //   80: aload 9
    //   82: iconst_1
    //   83: invokevirtual 321	java/util/regex/Matcher:group	(I)Ljava/lang/String;
    //   86: invokestatic 306	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   89: lstore 6
    //   91: lload 4
    //   93: lload 6
    //   95: lsub
    ...
    //   115: bipush 6
    //   117: aload_1
    //   118: new 228	java/lang/StringBuilder
    //   121: dup
    //   122: invokespecial 229	java/lang/StringBuilder:<init>	()V
    //   125: ldc_w 323
    ...
    //   142: invokevirtual 243	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   145: invokestatic 284	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   148: lload 4
    //   150: lstore_2
    //   151: goto -120 -> 31
    //   154: lload_2
    ...
    //   169: dup
    //   170: invokespecial 229	java/lang/StringBuilder:<init>	()V
    //   173: ldc_w 327
    //   176: invokevirtual 235	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   179: aload 8
    //   181: invokevirtual 235	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   184: ldc_w 329
    //   187: invokevirtual 235	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   190: aload_0
    ...
    //   200: invokevirtual 243	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   203: invokestatic 284	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   206: lload_2
    //   207: lload 6
    //   209: invokestatic 335	java/lang/Math:max	(JJ)J
    //   212: lstore 4
    //   214: lload 4
    //   216: lreturn
    //   217: astore 8
    //   219: bipush 6
    //   221: aload_1
    //   222: new 228	java/lang/StringBuilder
    //   225: dup
    //   226: invokespecial 229	java/lang/StringBuilder:<init>	()V
    //   229: ldc_w 337
    //   232: invokevirtual 235	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   235: aload_0
    //   236: invokevirtual 235	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   239: ldc_w 325
    //   242: invokevirtual 235	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   245: invokevirtual 243	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   248: invokestatic 284	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   251: lload_2
    //   252: lreturn
  ...
  private static long getTotalLength(HttpURLConnection paramHttpURLConnection, String paramString)
  {
    ...
    //   12: astore 10
    //   14: aload 10
    //   16: invokestatic 300	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   19: ifne +104 -> 123
    //   22: aload 10
    //   24: invokestatic 306	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   27: lstore_2
    //   28: aload_0
    //   29: ldc_w 308
    //   32: invokevirtual 294	java/net/HttpURLConnection:getHeaderField	(Ljava/lang/String;)Ljava/lang/String;
    //   35: astore_0
    //   36: aload_0
    //   37: invokestatic 300	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   40: ifne +149 -> 189
    //   43: getstatic 67	com/tencent/oskplayer/datasource/DefaultHttpDataSource:CONTENT_RANGE_HEADER	Ljava/util/regex/Pattern;
    //   46: aload_0
    //   47: invokevirtual 312	java/util/regex/Pattern:matcher	(Ljava/lang/CharSequence;)Ljava/util/regex/Matcher;
    //   50: astore 10
    //   52: lload 6
    //   54: lstore 4
    //   56: aload 10
    //   58: invokevirtual 317	java/util/regex/Matcher:find	()Z
    //   61: ifeq +24 -> 85
    //   64: aload 10
    //   66: iconst_3
    //   67: invokevirtual 321	java/util/regex/Matcher:group	(I)Ljava/lang/String;
    //   70: invokestatic 306	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   73: lstore 8
    //   75: lload_2
    //   76: lconst_0
    //   77: lcmp
    ...
    //   90: bipush 6
    //   92: aload_1
    //   93: new 228	java/lang/StringBuilder
    //   96: dup
    //   97: invokespecial 229	java/lang/StringBuilder:<init>	()V
    //   100: ldc_w 323
    //   103: invokevirtual 235	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   106: aload 10
    //   108: invokevirtual 235	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   111: ldc_w 325
    ...
    //   120: invokestatic 284	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   123: ldc2_w 87
    //   126: lstore_2
    //   127: goto -99 -> 28
    //   130: lload 6
    ...
    //   142: lload_2
    //   143: lload 8
    //   145: invokestatic 335	java/lang/Math:max	(JJ)J
    //   148: lstore_2
    //   149: lload_2
    //   150: lreturn
    //   151: astore 10
    //   153: bipush 6
    //   155: aload_1
    //   156: new 228	java/lang/StringBuilder
    //   159: dup
    //   160: invokespecial 229	java/lang/StringBuilder:<init>	()V
    //   163: ldc_w 337
    //   166: invokevirtual 235	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   169: aload_0
    //   170: invokevirtual 235	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   173: ldc_w 325
    //   176: invokevirtual 235	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   179: invokevirtual 243	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   182: invokestatic 284	com/tencent/oskplayer/util/PlayerUtils:log	(ILjava/lang/String;Ljava/lang/String;)V
    //   185: ldc2_w 87
    //   188: lreturn
    //   189: lload_2
    //   190: lreturn
    ...
    throws IOException, NoSuchAlgorithmException, NoSuchProviderException, KeyManagementException
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject4 = ThreadUtils.submitTask(new GetResponseCodeCallable((HttpURLConnection)localObject2), this.readTimeoutMillis, true, "GetResponseCodeCallable", getLogTag());
    ...
    throws HttpDataSource.HttpDataSourceException
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 561	com/tencent/oskplayer/datasource/DefaultHttpDataSource:inputStream	Ljava/io/InputStream;
    //   4: ifnull +26 -> 30
    //   7: aload_0
    //   8: getfield 133	com/tencent/oskplayer/datasource/DefaultHttpDataSource:connection	Ljava/net/HttpURLConnection;
    //   11: aload_0
    //   12: invokevirtual 631	com/tencent/oskplayer/datasource/DefaultHttpDataSource:bytesRemaining	()J
    //   15: invokestatic 637	com/tencent/oskplayer/util/Util:maybeTerminateInputStream	(Ljava/net/HttpURLConnection;J)V
    //   18: aload_0
    //   19: getfield 561	com/tencent/oskplayer/datasource/DefaultHttpDataSource:inputStream	Ljava/io/InputStream;
    //   22: invokevirtual 639	java/io/InputStream:close	()V
    //   25: aload_0
    //   26: aconst_null
    //   27: putfield 561	com/tencent/oskplayer/datasource/DefaultHttpDataSource:inputStream	Ljava/io/InputStream;
    //   30: aload_0
    //   31: getfield 641	com/tencent/oskplayer/datasource/DefaultHttpDataSource:opened	Z
    //   34: ifeq +24 -> 58
    //   37: aload_0
    //   38: iconst_0
    //   39: putfield 641	com/tencent/oskplayer/datasource/DefaultHttpDataSource:opened	Z
    //   42: aload_0
    //   43: getfield 108	com/tencent/oskplayer/datasource/DefaultHttpDataSource:listener	Lcom/tencent/oskplayer/datasource/TransferListener;
    //   46: ifnull +12 -> 58
    //   49: aload_0
    //   50: getfield 108	com/tencent/oskplayer/datasource/DefaultHttpDataSource:listener	Lcom/tencent/oskplayer/datasource/TransferListener;
    //   53: invokeinterface 644 1 0
    //   58: aload_0
    //   59: invokespecial 427	com/tencent/oskplayer/datasource/DefaultHttpDataSource:closeConnection	()V
    //   62: return
    //   63: astore_1
    //   64: new 629	com/tencent/oskplayer/datasource/HttpDataSource$HttpDataSourceException
    //   67: dup
    //   68: aload_1
    //   69: aload_0
    //   70: getfield 646	com/tencent/oskplayer/datasource/DefaultHttpDataSource:dataSpec	Lcom/tencent/oskplayer/datasource/DataSpec;
    //   73: invokespecial 649	com/tencent/oskplayer/datasource/HttpDataSource$HttpDataSourceException:<init>	(Ljava/io/IOException;Lcom/tencent/oskplayer/datasource/DataSpec;)V
    //   76: athrow
    //   77: astore_1
    //   78: aload_0
    //   79: getfield 641	com/tencent/oskplayer/datasource/DefaultHttpDataSource:opened	Z
    //   82: ifeq +24 -> 106
    //   85: aload_0
    //   86: iconst_0
    //   87: putfield 641	com/tencent/oskplayer/datasource/DefaultHttpDataSource:opened	Z
    //   90: aload_0
    //   91: getfield 108	com/tencent/oskplayer/datasource/DefaultHttpDataSource:listener	Lcom/tencent/oskplayer/datasource/TransferListener;
    //   94: ifnull +12 -> 106
    //   97: aload_0
    //   98: getfield 108	com/tencent/oskplayer/datasource/DefaultHttpDataSource:listener	Lcom/tencent/oskplayer/datasource/TransferListener;
    //   101: invokeinterface 644 1 0
    //   106: aload_0
    //   107: invokespecial 427	com/tencent/oskplayer/datasource/DefaultHttpDataSource:closeConnection	()V
    //   110: aload_1
    //   111: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public static class GetResponseCodeCallable
    implements Callable<Integer>
  {
    private HttpURLConnection mConnection;
    
    public GetResponseCodeCallable(HttpURLConnection paramHttpURLConnection)
    {
