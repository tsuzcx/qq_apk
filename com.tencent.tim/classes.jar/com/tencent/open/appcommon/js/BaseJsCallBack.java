  ...
  extends BaseInterface
{
  ...
  private avgx mRemoteServiceProxy;
  ...
  public BaseJsCallBack(Activity paramActivity)
  {
    ...
    for (this.activity = ((PluginBaseActivity)paramActivity).getOutActivity();; this.activity = paramActivity)
    {
      ...
      this.mRemoteServiceProxy = avgx.a(String.valueOf(aroi.a().getUin()));
      return;
    }
  }
  ...
  public String appIsExistsBatch(String paramString1, String paramString2)
  {
    ...
    arwt.d("BaseJsCallBack", "appIsExistsBatch >>>" + ((StringBuilder)localObject).substring(0, ((StringBuilder)localObject).length() - 1));
  ...
  public void cgiReport(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      arxy.a().a(paramString1, SystemClock.elapsedRealtime() - l, 0L, 0L, i, aroi.a().getUin(), "1000002", null);
      return;
    }
  ...
  public int getAPNType()
  {
    ...
    for (;;)
    {
      ...
      {
        int j;
        arwt.e("BaseJsCallBack", "getAPNType EX >>> ", localException);
        continue;
        i = -1;
        continue;
      }
  ...
  public String getAppVersionCode(String paramString)
  {
    try
    {
      ...
      int i = 0;
      if (arxn.appIsExists(paramString)) {
        i = arxn.fA(paramString);
      }
      paramString = new JSONObject();
      paramString.put("installedVersionCode", i);
      paramString.put("downloadedVersionCode ", arxn.fB(aryy.a().qz((String)localObject)));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < paramString.length())
        {
          ...
          if (!arxn.appIsExists((String)localObject1)) {
            break label145;
          }
          j = arxn.fA((String)localObject1);
          localObject1 = new JSONObject();
          ((JSONObject)localObject1).put("installedVersionCode", j);
          ((JSONObject)localObject1).put("downloadedVersionCode", arxn.fB(aryy.a().qz((String)localObject2)));
          localJSONObject.put((String)localObject2, localObject1);
        }
      }
      catch (Exception paramString)
      {
        arwt.e("BaseJsCallBack", "getAppVersionCode ", paramString);
      }
  ...
  {
    return aroi.a().getAppVersionName();
  }
  ...
  {
    return arug.getFileUrl(paramString);
  }
  ...
  public String getUin()
  {
    ...
    return String.valueOf(aroi.a().getUin());
  }
  
  public void goOldDetail(String paramString)
  {
    arue.R(this.activity, paramString);
  }
  
  public void goToDetailPage(String paramString1, String paramString2)
  {
    arwt.d("TIME-STATISTIC", "JsCallBack--goToDetailPage");
    Object localObject;
    boolean bool1;
    boolean bool2;
    try
    {
      ...
      paramString2.putString(aryv.PARAM_SNG_APPID, paramString1.optString("appid"));
      paramString2.putString(aryv.PARAM_TASK_PACKNAME, paramString1.optString("packageName"));
      paramString2.putString(aryv.PARAM_VIA, paramString1.optString("via"));
      paramString2.putString(aryv.PARAM_TASK_APPID, paramString1.optString("myAppId"));
      paramString2.putString(aryv.PARAM_TASK_APK_ID, paramString1.optString("apkId"));
      paramString2.putInt(aryv.PARAM_TASK_VERSION, paramString1.optInt("versionCode"));
      ...
      if (this.lastActionRecord == null) {
        this.lastActionRecord = new arut(str, (String)localObject, i);
      }
      while (!this.lastActionRecord.j(str, (String)localObject, i))
      {
        ...
        localObject = aryy.a().c(paramString1.optString("appid"));
    ...
    {
      arwt.e("BaseJsCallBack", "goToDetailPage>>>", paramString1);
      return;
    }
    label282:
    if (((DownloadInfo)localObject).downloadType == 1)
    {
      arzk.a();
      if (arzk.aHx())
      {
  ...
  public void goToDownloadTaskList(String paramString)
  {
    ...
    try
    {
      ...
      localBundle.putString(aryv.PARAM_VIA, paramString.optString("via"));
      ThreadManager.getSubThreadHandler().post(new BaseJsCallBack.4(this, localBundle));
      return;
    }
    catch (JSONException paramString)
    {
      arwt.e("BaseJsCallBack", "goToDetailPage>>>", paramString);
    }
  }
  ...
  public void goUrl(String paramString)
  {
    ...
    arwt.d("BaseJsCallBack", paramString);
    Object localObject3;
    ...
    try
    {
      ...
      {
        arwt.e("BaseJsCallBack", "gourl strUrl == null");
        return;
      }
    }
    catch (JSONException paramString)
    ...
    for (localObject1 = (String)localObject1 + "?";; localObject1 = (String)localObject1 + "&")
    {
      ...
      if (((String)localObject1).indexOf("{UIN}") > 0) {
        paramString = ((String)localObject1).replaceAll("\\{UIN\\}", aroi.a().getUin() + "");
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      arwt.d("BaseJsCallBack", "array = " + paramString.toString() + " | " + paramString.size());
      label462:
      ...
      ((Bundle)localObject3).putString("uin", String.valueOf(aroi.a().getUin()));
      ((Bundle)localObject3).putString("sid", aroi.a().getSkey());
  ...
  protected void goUrl(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      localJSONArray.put(this.activity.getString(2131692453));
    ...
    {
      arwt.e("BaseJsCallBack", "gourl(onlyurl) error ", paramString);
    }
  }
  ...
  public void goWebApp(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 387	com/tencent/open/appcommon/js/BaseJsCallBack:hasRight	()Z
    //   4: ifne +4 -> 8
    //   7: return
    //   8: ldc 30
    //   10: astore 22
    ...
    //   325: aload 32
    //   327: ldc_w 633
    //   330: invokevirtual 443	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   333: istore_2
    //   334: aload 23
    //   336: astore 24
    //   338: aload_1
    ...
    //   393: aload 32
    //   395: ldc_w 635
    //   398: invokevirtual 443	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   401: istore_3
    //   402: aload 23
    //   404: astore 24
    //   406: aload_1
    ...
    //   460: aload 32
    //   462: ldc_w 637
    //   465: invokevirtual 443	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   468: istore 4
    //   470: aload 23
    //   472: astore 24
    //   474: aload_1
    ...
    //   528: aload 32
    //   530: ldc_w 639
    //   533: invokevirtual 443	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   536: istore 5
    //   538: aload 23
    //   540: astore 24
    //   542: aload_1
    ...
    //   596: aload 32
    //   598: ldc_w 641
    //   601: invokevirtual 443	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   604: istore 6
    //   606: aload 23
    //   608: astore 24
    //   610: aload_1
    ...
    //   754: astore 25
    //   756: ldc 8
    //   758: new 115	java/lang/StringBuilder
    //   761: dup
    //   762: invokespecial 116	java/lang/StringBuilder:<init>	()V
    //   765: ldc_w 649
    //   768: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   771: aload 22
    //   773: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   776: ldc_w 601
    //   779: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   782: iload_2
    //   783: invokevirtual 365	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   786: ldc_w 601
    //   789: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   792: iload 4
    //   794: invokevirtual 365	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   797: ldc_w 601
    //   800: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   803: iload_3
    //   804: invokevirtual 365	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   807: ldc_w 601
    //   810: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   813: iload 5
    //   815: invokevirtual 365	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   818: ldc_w 601
    ...
    //   829: ldc_w 601
    //   832: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   835: aload 24
    //   837: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   840: ldc_w 601
    //   843: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   846: iload 6
    //   848: invokevirtual 365	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   851: ldc_w 601
    //   854: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   857: aload_1
    //   858: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   861: ldc_w 601
    //   864: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   867: aload 25
    //   869: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   872: ldc_w 601
    //   875: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   878: iconst_0
    //   879: invokevirtual 365	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   882: invokevirtual 159	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   885: invokestatic 165	arwt:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   888: new 556	android/content/Intent
    //   891: dup
    //   892: aload_0
    //   893: getfield 44	com/tencent/open/appcommon/js/BaseJsCallBack:activity	Landroid/app/Activity;
    //   896: ldc_w 558
    //   899: invokespecial 561	android/content/Intent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   902: astore 25
    //   904: new 408	android/os/Bundle
    //   907: dup
    //   908: invokespecial 409	android/os/Bundle:<init>	()V
    //   911: astore 26
    //   913: aload 26
    //   915: ldc_w 498
    //   918: aload 22
    //   920: invokevirtual 417	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   923: aload 26
    //   925: ldc_w 633
    //   928: iload_2
    //   929: invokevirtual 447	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   932: aload 26
    //   934: ldc_w 637
    //   937: iload 4
    //   939: invokevirtual 447	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   942: aload 26
    //   944: ldc_w 635
    //   947: iload_3
    //   948: invokevirtual 447	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   951: aload 26
    //   953: ldc_w 639
    //   956: iload 5
    //   958: invokevirtual 447	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   961: aload 26
    //   963: ldc_w 643
    //   966: aload 23
    //   968: invokevirtual 417	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   971: aload 26
    //   973: ldc_w 645
    //   976: aload 24
    //   978: invokevirtual 417	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   981: aload 26
    //   983: ldc_w 641
    //   986: iload 6
    //   988: invokevirtual 447	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   991: aload 26
    //   993: ldc_w 651
    //   996: aload_1
    //   997: invokevirtual 417	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   1000: aload 26
    //   1002: ldc_w 607
    //   1005: iconst_5
    //   1006: invokevirtual 447	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   1009: aload 25
    //   1011: aload 26
    //   1013: invokevirtual 611	android/content/Intent:putExtras	(Landroid/os/Bundle;)Landroid/content/Intent;
    //   1016: pop
    //   1017: aload_0
    //   1018: getfield 44	com/tencent/open/appcommon/js/BaseJsCallBack:activity	Landroid/app/Activity;
    //   1021: aload 25
    //   1023: invokevirtual 655	android/app/Activity:startActivity	(Landroid/content/Intent;)V
    //   1026: return
    //   1027: astore 25
    //   1029: ldc 30
    //   1031: astore 27
    ...
    //   1064: astore 24
    //   1066: aload 25
    //   1068: invokevirtual 532	org/json/JSONException:printStackTrace	()V
    //   1071: ldc 8
    //   1073: ldc_w 657
    //   1076: aload 25
    //   1078: invokestatic 274	arwt:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   1081: aload 31
    //   1083: astore 25
    //   1085: goto -329 -> 756
    //   1088: astore 26
    ...
    //   1121: astore 23
    //   1123: aload 26
    //   1125: invokevirtual 203	java/lang/Exception:printStackTrace	()V
    //   1128: ldc 8
    //   1130: ldc_w 659
    //   1133: aload 26
    //   1135: invokestatic 274	arwt:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   1138: aload 31
    //   1140: astore 25
    //   1142: goto -386 -> 756
    //   1145: astore 26
  ...
  {
    new AlertDialog.Builder(this.activity).setTitle("javaScript dialog").setMessage(paramString).setPositiveButton(17039370, new arun(this)).setCancelable(false).create().show();
  }
  ...
  public void report(String paramString)
  {
    ...
    arwt.i("BaseJsCallBack", "[report] json=" + paramString);
    try
    {
      paramString = new JSONObject(paramString);
      arwk.report(paramString.optInt("type"), paramString.optString("data"));
      return;
    }
    catch (JSONException paramString)
    {
  ...
  public void reportBatch(String paramString)
  {
    ...
    arwt.i("BaseJsCallBack", "[reportBatch] json=" + paramString);
    for (;;)
    {
      int i;
      try
      {
        ...
        if (localJSONObject != null) {
          arwk.report(localJSONObject.optInt("type"), localJSONObject.optString("data"));
        }
      }
      catch (JSONException paramString)
      {
  ...
  public void reportForVia(String paramString)
  {
    ...
    try
    {
      ...
      arxt.a(paramString, str1, str2, (String)localObject, localBundle);
      arwt.d("BaseJsCallBack", "reportForvia " + paramString + " | " + str1 + " | " + str2);
      return;
    }
    catch (JSONException paramString)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject != null)
        {
          ...
          arxt.a(str1, str2, str3, (String)localObject, localBundle);
          arwt.d("BaseJsCallBack", "reportForvia " + str1 + " | " + str2 + " | " + str3);
        }
      }
      catch (JSONException paramString)
      {
  ...
  public void reportPV(String paramString1, String paramString2)
  {
    ...
    if (arxn.appIsExists(paramString1))
    {
      arxt.br("100", "ANDROIDQQ.INSTALLED.APPDETAIL", paramString2);
      return;
    }
    if (aryy.a().sB(paramString2))
    {
      arxt.br("100", "ANDROIDQQ.UNINSTALL.APPDETAIL", paramString2);
      return;
    }
    arxt.br("100", "ANDROIDQQ.UNDOWNLOAD.APPDETAIL", paramString2);
  }
  ...
  {
    arwt.d("BaseJsCallBack", "JsCallBack--setCommonReportData");
    if (!TextUtils.isEmpty(paramString)) {
      try
      {
        aroi.a().WJ(paramString);
        return true;
      }
      catch (Exception paramString)
      {
        arwt.e("BaseJsCallBack", "JsCallBack--setCommonReportData Exception", paramString);
      }
    }
    return false;
  }
  ...
  public void showToast(String paramString)
  {
    ...
    arxa.a().showToast(paramString, 1);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        if (appIsExists(paramString1))
        {
          ...
          arxn.an(this.activity, paramString1, paramString2);
          return;
        }
      }
      catch (Exception paramString2)
      {
        arwt.e("startApp", "apk not exist packName = " + paramString1);
      }
    }
  }
  ...
  public void startApp(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      {
        arxa.a().showToast(acfp.m(2131703107), 0);
        return;
      }
      return;
    }
  ...
  public void startOpenApp(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    //   5: dup
    //   6: invokespecial 116	java/lang/StringBuilder:<init>	()V
    //   9: ldc_w 835
    ...
    //   35: aload 4
    //   37: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   40: invokevirtual 159	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   43: invokestatic 704	arwt:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   46: aload_0
    //   47: aload_1
    //   48: invokevirtual 784	com/tencent/open/appcommon/js/BaseJsCallBack:appIsExists	(Ljava/lang/String;)Z
    //   51: istore 6
    //   53: iload 6
    //   55: ifeq +22 -> 77
    //   58: aload 5
    //   60: ldc_w 839
    //   63: invokestatic 844	java/net/URLDecoder:decode	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   66: astore_2
    //   67: aload_0
    ...
    //   72: aload_1
    //   73: aload_2
    //   74: invokestatic 848	arxn:v	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   77: return
    //   78: astore_1
    //   79: ldc 8
    ...
    //   94: aload_1
    //   95: invokevirtual 853	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   98: invokevirtual 148	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   101: invokevirtual 159	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   104: invokestatic 225	arwt:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   107: return
    //   108: astore_2
    //   109: aload 5
    //   111: astore_2
