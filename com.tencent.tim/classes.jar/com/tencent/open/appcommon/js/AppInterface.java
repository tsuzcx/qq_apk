  ...
  extends BaseInterface
{
  ...
  public String gSetPackageScanSetting(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      {
        arxt.br("100", "ANDROIDQQ.STORE.UPDATECHECKBOX", "");
        paramString1 = new aruk(this, paramString2);
        this.mHandler.post(new AppInterface.2(this, paramString1));
        return null;
      }
    } while (!paramString1.equals("1"));
    paramString1 = aroi.a().getContext().getSharedPreferences("package_scan", 0).edit();
  ...
  protected JSONArray getAppInfo(PackageInfo paramPackageInfo, String paramString1, String paramString2, String paramString3)
  {
    ...
    if ("true".equals(paramString1))
    {
      ...
      paramString1.put(arwr.a(paramPackageInfo.applicationInfo.loadIcon(this.activity.getPackageManager())));
      label128:
      if (k == 0) {
        break label252;
      }
  ...
  public String getAppInfoBatch(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    paramString1 = arwx.split(paramString1, paramString2);
    ...
    for (;;)
    {
      ...
      if (i < j)
      {
        ...
        if ((TextUtils.isEmpty(localCharSequence)) || (!aqiz.isAppInstalled(this.activity, localCharSequence))) {}
      }
      try
      {
  ...
  {
    arwt.i("AppUpdate", "getUpdateApp , param = " + paramString);
    try
    {
      aroi.a().a(paramString, this.activity, this.webView);
      return;
    }
  ...
  {
    if (!hasRight()) {}
    while (!arxn.aZ(this.activity, paramString)) {
      return -1;
    }
    return 0;
  }
