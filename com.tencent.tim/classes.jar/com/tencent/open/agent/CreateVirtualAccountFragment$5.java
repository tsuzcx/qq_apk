  ...
  public void run()
  {
    ...
    do
    {
      for (;;)
      {
        try
        {
          localObject2 = new File(this.cBM);
          localObject1 = new BitmapFactory.Options();
          localObject2 = new BufferedInputStream(new FileInputStream((File)localObject2));
          ((BitmapFactory.Options)localObject1).inSampleSize = ((int)aqhu.getOptRatio((InputStream)localObject2, CreateVirtualAccountFragment.a(this.this$0).getWidth(), CreateVirtualAccountFragment.a(this.this$0).getHeight()));
          ((BufferedInputStream)localObject2).close();
          localObject1 = aqcu.decodeFile(this.cBM, (BitmapFactory.Options)localObject1);
        ...
        catch (Exception localException1)
        {
          try
          {
            localObject2 = CreateVirtualAccountFragment.a(this.this$0).getCircleFaceBitmap((Bitmap)localObject1, CreateVirtualAccountFragment.a(this.this$0).getWidth(), CreateVirtualAccountFragment.a(this.this$0).getWidth());
