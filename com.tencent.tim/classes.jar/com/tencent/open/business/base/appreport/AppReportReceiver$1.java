  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      str2 = this.val$intent.getAction();
      if (str2 == null) {
        return;
      }
      bool = this.val$intent.getBooleanExtra("android.intent.extra.REPLACING", false);
      Object localObject = this.val$intent.getDataString();
    ...
    catch (Throwable localThrowable)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        try
        {
          arxt.dc(this.val$context.getApplicationContext(), localThrowable);
          label166:
