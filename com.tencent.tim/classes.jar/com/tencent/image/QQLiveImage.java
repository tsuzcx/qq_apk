    ...
    implements Runnable
  {
    ...
    public void run()
    {
      if (this.videoPlayer != null)
      {
        ...
        QLog.d(QQLiveImage.TAG + QQLiveImage.this.ID, 1, "ReleaseTask release TVK_IMediaPlayer =" + localTVK_IMediaPlayer + "，cost = " + (l2 - l1) + "ms");
      }
    }
  }
  
  static class SDKInstallListener
