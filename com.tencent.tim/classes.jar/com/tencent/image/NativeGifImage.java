  ...
  extends AbstractGifImage
{
  ...
  protected void applyNextFrame()
  {
    ...
    //   4: aload_0
    //   5: aload_0
    //   6: getfield 94	com/tencent/image/NativeGifImage:mMetaData	[I
    //   9: getstatic 74	com/tencent/image/NativeGifImage:CURRENT_FRAMEINDEX_INDEX	I
    //   12: iaload
    //   13: putfield 308	com/tencent/image/NativeGifImage:mCurrentFrameIndex	I
    //   16: aload_0
    //   17: aload_0
    //   18: getfield 94	com/tencent/image/NativeGifImage:mMetaData	[I
    //   21: getstatic 76	com/tencent/image/NativeGifImage:CURRENT_LOOP_INDEX	I
    //   24: iaload
    //   25: putfield 310	com/tencent/image/NativeGifImage:mCurrentLoop	I
    //   28: aload_0
    //   29: getfield 310	com/tencent/image/NativeGifImage:mCurrentLoop	I
    //   32: iconst_1
    //   33: if_icmpne +54 -> 87
    //   36: aload_0
    //   37: getfield 308	com/tencent/image/NativeGifImage:mCurrentFrameIndex	I
    //   40: ifne +47 -> 87
    //   43: aload_0
    //   44: getfield 314	com/tencent/image/NativeGifImage:mPlayOnceListener	Ljava/lang/ref/WeakReference;
    //   47: ifnull +24 -> 71
    //   50: aload_0
    //   51: getfield 314	com/tencent/image/NativeGifImage:mPlayOnceListener	Ljava/lang/ref/WeakReference;
    //   54: invokevirtual 320	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   57: checkcast 322	com/tencent/image/GifDrawable$OnGIFPlayOnceListener
    //   60: astore_3
    //   61: aload_3
    //   62: ifnull +9 -> 71
    //   65: aload_3
    //   66: invokeinterface 325 1 0
    //   71: aload_0
    //   72: getfield 329	com/tencent/image/NativeGifImage:mStrongPlayOnceListener	Lcom/tencent/image/GifDrawable$OnGIFPlayOnceListener;
    //   75: ifnull +12 -> 87
    //   78: aload_0
    //   79: getfield 329	com/tencent/image/NativeGifImage:mStrongPlayOnceListener	Lcom/tencent/image/GifDrawable$OnGIFPlayOnceListener;
    //   82: invokeinterface 325 1 0
    //   87: aload_0
    //   88: getfield 232	com/tencent/image/NativeGifImage:mCurrentFrameBitmapBuffer	Landroid/graphics/Bitmap;
    //   91: ifnull +112 -> 203
    //   94: new 331	android/graphics/Canvas
    //   97: dup
    //   98: aload_0
    //   99: getfield 165	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   102: invokespecial 334	android/graphics/Canvas:<init>	(Landroid/graphics/Bitmap;)V
    //   105: astore_3
    //   106: aload_0
    //   107: getfield 165	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   110: iconst_0
    //   111: invokevirtual 338	android/graphics/Bitmap:eraseColor	(I)V
    //   114: aload_0
    //   115: getfield 173	com/tencent/image/NativeGifImage:mDefaultRoundCorner	F
    //   118: fconst_0
    //   119: fcmpl
    //   120: ifle +69 -> 189
    //   123: new 340	android/graphics/Paint
    //   126: dup
    //   127: invokespecial 341	android/graphics/Paint:<init>	()V
    //   130: astore_2
    //   131: aload_2
    //   132: iconst_1
    //   133: invokevirtual 344	android/graphics/Paint:setAntiAlias	(Z)V
    //   136: aload_3
    //   137: new 346	android/graphics/RectF
    //   140: dup
    //   141: fconst_0
    //   142: fconst_0
    //   143: aload_0
    //   144: getfield 165	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   147: invokevirtual 349	android/graphics/Bitmap:getWidth	()I
    //   150: i2f
    //   151: aload_0
    //   152: getfield 165	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   155: invokevirtual 352	android/graphics/Bitmap:getHeight	()I
    //   158: i2f
    //   159: invokespecial 355	android/graphics/RectF:<init>	(FFFF)V
    //   162: aload_0
    //   163: getfield 173	com/tencent/image/NativeGifImage:mDefaultRoundCorner	F
    //   166: aload_0
    //   167: getfield 173	com/tencent/image/NativeGifImage:mDefaultRoundCorner	F
    //   170: aload_2
    //   171: invokevirtual 359	android/graphics/Canvas:drawRoundRect	(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    //   174: aload_2
    //   175: new 361	android/graphics/PorterDuffXfermode
    //   178: dup
    //   179: getstatic 367	android/graphics/PorterDuff$Mode:SRC_IN	Landroid/graphics/PorterDuff$Mode;
    //   182: invokespecial 370	android/graphics/PorterDuffXfermode:<init>	(Landroid/graphics/PorterDuff$Mode;)V
    //   185: invokevirtual 374	android/graphics/Paint:setXfermode	(Landroid/graphics/Xfermode;)Landroid/graphics/Xfermode;
    //   188: pop
    //   189: aload_3
    //   190: aload_0
    //   191: getfield 232	com/tencent/image/NativeGifImage:mCurrentFrameBitmapBuffer	Landroid/graphics/Bitmap;
    //   194: fconst_0
    //   195: fconst_0
    //   196: aload_2
    //   197: invokevirtual 378	android/graphics/Canvas:drawBitmap	(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    //   200: aload_0
    //   201: monitorexit
    //   202: return
    //   203: aload_0
    //   204: getfield 173	com/tencent/image/NativeGifImage:mDefaultRoundCorner	F
    //   207: fstore_1
    //   208: fload_1
    //   209: fconst_0
    //   210: fcmpl
    //   211: ifle -11 -> 200
    //   214: aload_0
    //   215: getfield 165	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   218: invokevirtual 349	android/graphics/Bitmap:getWidth	()I
    //   221: aload_0
    //   222: getfield 165	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   225: invokevirtual 352	android/graphics/Bitmap:getHeight	()I
    //   228: aload_0
    //   229: getfield 98	com/tencent/image/NativeGifImage:mCurrentConfig	Landroid/graphics/Bitmap$Config;
    //   232: invokestatic 230	android/graphics/Bitmap:createBitmap	(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    //   235: astore_2
    //   236: aload_2
    //   237: ifnull -37 -> 200
    //   240: new 331	android/graphics/Canvas
    //   243: dup
    //   244: aload_2
    //   245: invokespecial 334	android/graphics/Canvas:<init>	(Landroid/graphics/Bitmap;)V
    //   248: astore_3
    //   249: new 340	android/graphics/Paint
    //   252: dup
    //   253: invokespecial 341	android/graphics/Paint:<init>	()V
    //   256: astore 4
    //   258: aload 4
    //   260: iconst_1
    //   261: invokevirtual 344	android/graphics/Paint:setAntiAlias	(Z)V
    //   264: aload_3
    //   265: new 346	android/graphics/RectF
    //   268: dup
    //   269: fconst_0
    //   270: fconst_0
    //   271: aload_0
    //   272: getfield 165	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   275: invokevirtual 349	android/graphics/Bitmap:getWidth	()I
    //   278: i2f
    //   279: aload_0
    //   280: getfield 165	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   283: invokevirtual 352	android/graphics/Bitmap:getHeight	()I
    //   286: i2f
    //   287: invokespecial 355	android/graphics/RectF:<init>	(FFFF)V
    //   290: aload_0
    //   291: getfield 173	com/tencent/image/NativeGifImage:mDefaultRoundCorner	F
    //   294: aload_0
    //   295: getfield 173	com/tencent/image/NativeGifImage:mDefaultRoundCorner	F
    //   298: aload 4
    //   300: invokevirtual 359	android/graphics/Canvas:drawRoundRect	(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    //   303: aload 4
    //   305: new 361	android/graphics/PorterDuffXfermode
    //   308: dup
    //   309: getstatic 367	android/graphics/PorterDuff$Mode:SRC_IN	Landroid/graphics/PorterDuff$Mode;
    //   312: invokespecial 370	android/graphics/PorterDuffXfermode:<init>	(Landroid/graphics/PorterDuff$Mode;)V
    //   315: invokevirtual 374	android/graphics/Paint:setXfermode	(Landroid/graphics/Xfermode;)Landroid/graphics/Xfermode;
    //   318: pop
    //   319: aload_3
    //   320: aload_0
    //   321: getfield 165	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   324: fconst_0
    //   325: fconst_0
    //   326: aload 4
    //   328: invokevirtual 378	android/graphics/Canvas:drawBitmap	(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    //   331: aload_0
    //   332: aload_2
    //   333: putfield 165	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   336: goto -136 -> 200
    //   339: astore_2
    //   340: aload_0
    //   341: monitorexit
    ...
    //   344: astore_2
    //   345: aload_0
    //   346: getfield 98	com/tencent/image/NativeGifImage:mCurrentConfig	Landroid/graphics/Bitmap$Config;
    //   349: astore_2
    //   350: getstatic 56	android/graphics/Bitmap$Config:ARGB_8888	Landroid/graphics/Bitmap$Config;
    //   353: astore_3
    //   354: aload_2
    //   355: aload_3
    //   356: if_acmpne +43 -> 399
    //   359: aload_0
    //   360: getfield 165	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   363: invokevirtual 349	android/graphics/Bitmap:getWidth	()I
    //   366: aload_0
    //   367: getfield 165	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   370: invokevirtual 352	android/graphics/Bitmap:getHeight	()I
    //   373: getstatic 235	android/graphics/Bitmap$Config:ARGB_4444	Landroid/graphics/Bitmap$Config;
    //   376: invokestatic 230	android/graphics/Bitmap:createBitmap	(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    //   379: astore_2
    //   380: goto -144 -> 236
    //   383: astore_2
    //   384: invokestatic 124	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   387: ifeq +12 -> 399
    //   390: ldc 24
    //   392: iconst_2
    //   393: ldc_w 380
    //   396: invokestatic 383	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   399: aconst_null
    //   400: astore_2
    //   401: goto -165 -> 236
  ...
  protected void executeNewTask()
  {
    ...
    try
    {
      for (;;)
      {
        ThreadManagerV2.excute(new NativeDecodeFrameTask(l), 64, null, true);
        return;
        label61:
