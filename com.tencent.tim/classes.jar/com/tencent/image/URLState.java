  ...
  extends Drawable.ConstantState
{
  ...
  void downloadImediatly(Header[] paramArrayOfHeader, CookieStore paramCookieStore, Object paramObject1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, float paramFloat, boolean paramBoolean5, Object paramObject2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 171	com/tencent/image/URLState:mStatus	I
    //   4: iconst_1
    //   5: if_icmpeq +10 -> 15
    //   8: aload_0
    //   9: getfield 189	com/tencent/image/URLState:mIsLoadingStarted	I
    //   12: ifle +4 -> 16
    //   15: return
    //   16: aload_0
    //   17: aload_0
    //   18: getfield 189	com/tencent/image/URLState:mIsLoadingStarted	I
    //   21: iconst_1
    //   22: iadd
    //   23: putfield 189	com/tencent/image/URLState:mIsLoadingStarted	I
    //   26: aload_0
    //   27: iload 4
    //   29: putfield 746	com/tencent/image/URLState:mDecodeFile	Z
    //   32: aload_0
    //   33: getfield 178	com/tencent/image/URLState:mParams	Lcom/tencent/image/DownloadParams;
    //   36: aload_2
    //   37: putfield 750	com/tencent/image/DownloadParams:cookies	Lorg/apache/http/client/CookieStore;
    //   40: aload_0
    //   41: getfield 178	com/tencent/image/URLState:mParams	Lcom/tencent/image/DownloadParams;
    //   44: aload_1
    //   45: putfield 754	com/tencent/image/DownloadParams:headers	[Lorg/apache/http/Header;
    //   48: aload_0
    //   49: getfield 178	com/tencent/image/URLState:mParams	Lcom/tencent/image/DownloadParams;
    //   52: aload_3
    //   53: putfield 757	com/tencent/image/DownloadParams:tag	Ljava/lang/Object;
    //   56: aload_0
    //   57: getfield 178	com/tencent/image/URLState:mParams	Lcom/tencent/image/DownloadParams;
    //   60: iload 5
    //   62: putfield 476	com/tencent/image/DownloadParams:useGifAnimation	Z
    //   65: aload_0
    //   66: getfield 178	com/tencent/image/URLState:mParams	Lcom/tencent/image/DownloadParams;
    //   69: iload 6
    //   71: putfield 489	com/tencent/image/DownloadParams:useApngImage	Z
    //   74: aload_0
    //   75: getfield 178	com/tencent/image/URLState:mParams	Lcom/tencent/image/DownloadParams;
    //   78: iload 7
    //   80: putfield 502	com/tencent/image/DownloadParams:useSharpPImage	Z
    //   83: aload_0
    //   84: getfield 178	com/tencent/image/URLState:mParams	Lcom/tencent/image/DownloadParams;
    //   87: fload 8
    //   89: putfield 480	com/tencent/image/DownloadParams:mGifRoundCorner	F
    //   92: aload_0
    //   93: getfield 178	com/tencent/image/URLState:mParams	Lcom/tencent/image/DownloadParams;
    //   96: iconst_0
    //   97: putfield 760	com/tencent/image/DownloadParams:needCheckNetType	Z
    //   100: aload_0
    //   101: getfield 178	com/tencent/image/URLState:mParams	Lcom/tencent/image/DownloadParams;
    //   104: iload 9
    //   106: putfield 763	com/tencent/image/DownloadParams:useExifOrientation	Z
    //   109: aload_0
    //   110: getfield 178	com/tencent/image/URLState:mParams	Lcom/tencent/image/DownloadParams;
    //   113: aload 10
    //   115: putfield 465	com/tencent/image/DownloadParams:mExtraInfo	Ljava/lang/Object;
    //   118: aload_0
    //   119: aload_0
    //   120: getfield 211	com/tencent/image/URLState:mUrl	Ljava/net/URL;
    //   123: new 765	com/tencent/image/URLDrawableHandler$Adapter
    //   126: dup
    //   127: invokespecial 766	com/tencent/image/URLDrawableHandler$Adapter:<init>	()V
    //   130: invokevirtual 770	com/tencent/image/URLState:loadImage	(Ljava/net/URL;Lcom/tencent/image/URLDrawableHandler;)Ljava/lang/Object;
    //   133: astore_1
    //   134: aload_1
    //   135: getstatic 139	com/tencent/image/URLState:DOWNLOAD_ASYNC	Ljava/lang/Object;
    //   138: if_acmpeq -123 -> 15
    //   141: invokestatic 716	android/os/Looper:myLooper	()Landroid/os/Looper;
    //   144: invokestatic 147	android/os/Looper:getMainLooper	()Landroid/os/Looper;
    //   147: if_acmpne +9 -> 156
    //   150: aload_0
    //   151: aload_1
    //   152: invokevirtual 773	com/tencent/image/URLState:onResult	(Ljava/lang/Object;)V
    //   155: return
    //   156: getstatic 152	com/tencent/image/URLState:UI_HANDLER	Landroid/os/Handler;
    //   159: new 12	com/tencent/image/URLState$PostOnResult
    //   162: dup
    //   163: aload_0
    //   164: aload_1
    //   165: invokespecial 774	com/tencent/image/URLState$PostOnResult:<init>	(Lcom/tencent/image/URLState;Ljava/lang/Object;)V
    //   168: invokevirtual 735	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   171: pop
    //   172: return
    //   173: astore_1
    //   174: aload_1
    //   175: getstatic 139	com/tencent/image/URLState:DOWNLOAD_ASYNC	Ljava/lang/Object;
    //   178: if_acmpeq -163 -> 15
    //   181: invokestatic 716	android/os/Looper:myLooper	()Landroid/os/Looper;
    //   184: invokestatic 147	android/os/Looper:getMainLooper	()Landroid/os/Looper;
    //   187: if_acmpne +9 -> 196
    //   190: aload_0
    //   191: aload_1
    //   192: invokevirtual 773	com/tencent/image/URLState:onResult	(Ljava/lang/Object;)V
    //   195: return
    //   196: getstatic 152	com/tencent/image/URLState:UI_HANDLER	Landroid/os/Handler;
    //   199: new 12	com/tencent/image/URLState$PostOnResult
    //   202: dup
    //   203: aload_0
    //   204: aload_1
    //   205: invokespecial 774	com/tencent/image/URLState$PostOnResult:<init>	(Lcom/tencent/image/URLState;Ljava/lang/Object;)V
    //   208: invokevirtual 735	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   211: pop
    //   212: return
    //   213: astore_1
    //   214: getstatic 139	com/tencent/image/URLState:DOWNLOAD_ASYNC	Ljava/lang/Object;
    //   217: ifnull +17 -> 234
    //   220: invokestatic 716	android/os/Looper:myLooper	()Landroid/os/Looper;
    //   223: invokestatic 147	android/os/Looper:getMainLooper	()Landroid/os/Looper;
    //   226: if_acmpne +10 -> 236
    //   229: aload_0
    //   230: aconst_null
    //   231: invokevirtual 773	com/tencent/image/URLState:onResult	(Ljava/lang/Object;)V
    //   234: aload_1
    //   235: athrow
    //   236: getstatic 152	com/tencent/image/URLState:UI_HANDLER	Landroid/os/Handler;
    //   239: new 12	com/tencent/image/URLState$PostOnResult
    //   242: dup
    //   243: aload_0
    //   244: aconst_null
    //   245: invokespecial 774	com/tencent/image/URLState$PostOnResult:<init>	(Lcom/tencent/image/URLState;Ljava/lang/Object;)V
    //   248: invokevirtual 735	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   251: pop
    //   252: goto -18 -> 234
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (localObject1 != null)
          {
            ((Callback)localObject1).onLoadStarted(this);
          }
          else
          {
            localObject1 = this.callbacks;
    ...
    implements URLDrawableHandler, Runnable
  {
    ...
    {
      this.mUrl = paramURL;
      if (URLState.this.mProtocolDownloader == null) {}
      for (this$1 = null;; this$1 = URLState.this.mProtocolDownloader.getQueue(paramURL))
      {
        this.mQueue = URLState.this;
        return;
      }
    }
    ...
    {
      Vector localVector1 = URLState.this.callbacks;
      int i = 0;
      for (;;)
      {
        try
        {
          ...
          Object localObject1 = (WeakReference)URLState.this.callbacks.get(i);
          if (localObject1 != null)
          {
        ...
        Vector localVector2 = URLState.this.callbacks;
        int j = i - 1;
        localVector2.remove(i);
        i = j;
        break label137;
    ...
    protected void onProgressUpdate(int paramInt)
    {
      ...
      {
        localVector1 = URLState.this.callbacks;
        i = 0;
      }
      for (;;)
      {
    ...
    public void publishProgress(int paramInt)
    {
      ...
      URLState.UI_HANDLER.post(new URLState.DownloadRunnable.1(this, paramInt));
    }
    ...
    public void run()
    {
      ...
      try
      {
        ...
        if (localObject1 != URLState.DOWNLOAD_ASYNC) {
          URLState.this.result(localObject1);
        }
        return;
      }
      catch (Throwable localThrowable)
      {
        URLState.this.result(localThrowable);
        return;
      }
      finally
      {
    ...
    implements ThreadExcutor.IThreadListener, Runnable
  {
    ...
    public void run()
    {
      ...
      URLState.UI_HANDLER.post(new URLState.PreDownloadRunnable.1(this));
    }
  }
