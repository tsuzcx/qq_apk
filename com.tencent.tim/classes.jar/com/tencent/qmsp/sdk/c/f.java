...
public final class f
{
  ...
  private static ConcurrentHashMap<Long, f> k = new ConcurrentHashMap();
  ...
  {
    if ((!(paramObject1 instanceof String)) || (paramObject1 == null) || (!j)) {
      return null;
    }
    long l1 = paramInt1;
    long l2 = paramInt2;
  ...
  {
    f localf = (f)k.get(Long.valueOf(paramLong1));
    if (localf != null) {
