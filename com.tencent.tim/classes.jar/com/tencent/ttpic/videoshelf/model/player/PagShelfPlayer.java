  ...
  implements IVideoShelfPlayer
{
  ...
  public PagShelfPlayer()
    throws PagNotSupportSystemException
  {
    ...
    this.mPlayTask = new PagPlayTimerTask(null);
    this.mHandler = new Handler();
    this.mRenderRunable = new RenderRunable(null);
  }
  ...
  {
    PagPlayTimerTask localPagPlayTimerTask = this.mPlayTask;
    if (paramBoolean) {}
    for (int i = -1;; i = 1)
    {
    ...
    extends TimerTask
  {
    ...
    public void allEnd()
    {
      ...
      PagShelfPlayer.access$902(PagShelfPlayer.this, false);
      ...
      try
      {
        ...
        PagShelfPlayer.access$202(PagShelfPlayer.this, true);
    ...
    public void run()
    {
      ...
      do
      {
        ...
        if ((!this.mIsLooping) && (this.mReaptCount <= 0)) {
          PagShelfPlayer.this.mHandler.post(new PagShelfPlayer.PagPlayTimerTask.1(this));
        }
        this.mProgress = 0.0D;
      } while ((!PagShelfPlayer.this.mIsAudioPlaying) || (PagShelfPlayer.this.mAudioPlayer == null) || (PagShelfPlayer.this.isStoped));
