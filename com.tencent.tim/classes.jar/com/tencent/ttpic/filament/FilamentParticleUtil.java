...
public class FilamentParticleUtil
{
  ...
  public static List<Particle> getParticles(List<FrameParticleData> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      while (i < localFrameParticleData.particleCount)
      {
        ...
        localParticle.size = new SizeF(localFrameParticleData.particleSize[(i * 12)], localFrameParticleData.particleSize[(i * 12 + 1)]);
  ...
  public static class Particle
  {
    ...
    public FilamentParticleUtil.SizeF size;
  }
