  ...
  extends Vector4f
{
  ...
  private void generateQuaternionFromMatrix()
  {
    ...
    if (this.matrix.size() == 16) {
      if (this.matrix.isColumnMajor())
      {
        ...
        f1 = (float)Math.sqrt(f1 + 1.0D) * 2.0F;
        f4 = 0.25F * f1;
        f3 = (arrayOfFloat[i5] - arrayOfFloat[i3]) / f1;
        f2 = (arrayOfFloat[n] - arrayOfFloat[i4]) / f1;
        f1 = (arrayOfFloat[i1] - arrayOfFloat[m]) / f1;
      }
    }
    for (;;)
    {
      ...
      for (int j = 1;; j = 0)
      {
        ...
        f1 = (float)Math.sqrt(1.0D + arrayOfFloat[k] - arrayOfFloat[i2] - arrayOfFloat[i6]) * 2.0F;
        f4 = (arrayOfFloat[i5] - arrayOfFloat[i3]) / f1;
        f3 = 0.25F * f1;
        f2 = (arrayOfFloat[m] + arrayOfFloat[i1]) / f1;
        f5 = arrayOfFloat[n];
        f1 = (arrayOfFloat[i4] + f5) / f1;
        break;
        i = 0;
        break label249;
      }
      ...
      {
        f1 = (float)Math.sqrt(1.0D + arrayOfFloat[i2] - arrayOfFloat[k] - arrayOfFloat[i6]) * 2.0F;
        f4 = (arrayOfFloat[n] - arrayOfFloat[i4]) / f1;
        f3 = (arrayOfFloat[m] + arrayOfFloat[i1]) / f1;
        f2 = 0.25F * f1;
        f5 = arrayOfFloat[i3];
        f1 = (arrayOfFloat[i5] + f5) / f1;
      }
      else
      {
        f1 = (float)Math.sqrt(1.0D + arrayOfFloat[i6] - arrayOfFloat[k] - arrayOfFloat[i2]) * 2.0F;
        f4 = (arrayOfFloat[i1] - arrayOfFloat[m]) / f1;
        f3 = (arrayOfFloat[n] + arrayOfFloat[i4]) / f1;
        f2 = (arrayOfFloat[i3] + arrayOfFloat[i5]) / f1;
        f1 *= 0.25F;
      }
    }
  }
  ...
  public void slerp(Quaternion paramQuaternion1, Quaternion paramQuaternion2, float paramFloat)
  {
    ...
    d3 = this.points[2];
    paramQuaternion2[2] = ((float)(d2 * paramQuaternion1.points[2] + d1 * d3));
  }
