  ...
  extends FrameSourceItem
{
  ...
  public void clear()
  {
    ...
    {
      localScoreTag = localObject[i];
      if (localScoreTag.texId != null)
      {
        GLES20.glDeleteTextures(localScoreTag.texId.length, localScoreTag.texId, 0);
        ScoreTag.access$102(localScoreTag, null);
      }
      i += 1;
    }
  }
  ...
  {
    ScoreTag.access$302(this.scores[paramCanvasItem.index], true);
  ...
  public void init()
  {
    ...
    while (i < this.expressionList.size())
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        ScoreTag.access$102(this.scores[i], arrayOfInt);
      }
      i += 1;
    }
  }
  ...
  public void reset()
  {
    ...
    while (i < this.scores.length)
    {
      ScoreTag.access$202(this.scores[i], 0);
      ScoreTag.access$302(this.scores[i], false);
      i += 1;
    }
  }
  ...
  public void update(Frame paramFrame, long paramLong, List<List<PointF>> paramList, List<float[]> paramList1, int paramInt)
  {
    ...
    if (i >= 0)
    {
      ...
      if ((paramList.size() > 0) && (paramInt == 0))
      {
        ...
        ScoreTag.access$202(this.scores[i], (int)ActUtil.getExpressionSimilarity((List)this.starFacePoints.get(i), (List)paramList.get(0), (float[])this.starFaceAngles.get(i), (float[])paramList1.get(0), ((ExpressionItem)this.expressionList.get(i)).expressionWeight));
    ...
    ScoreTag.access$202(this.scores[i], this.random.nextInt(5) + 5);
  }
