  ...
  extends VideoFilterBase
{
  ...
  private ParticleEmitterParam updateEmitterParam(List<PointF> paramList, float[] paramArrayOfFloat)
  {
    ParticleEmitterParam localParticleEmitterParam = new ParticleEmitterParam();
  ...
  private void updateParticle(ParticleEmitterParam paramParticleEmitterParam)
  {
  ...
  public void setDynamicColorReference(Frame paramFrame)
  {
    if ((this.fromUnTrigger2Trigger) && (paramFrame != null) && ("*".equals(this.item.gpuParticleConfig.startColorReference)))
    {
      Bitmap localBitmap = RendererUtils.saveTexture(paramFrame);
      if (localBitmap != null)
      {
        this.pdSystem.setTextureImage(BitmapUtils.bitmap2RGBA(localBitmap), this.item.gpuParticleConfig.startColorReference, localBitmap.getWidth(), localBitmap.getHeight());
        BitmapUtils.recycle(localBitmap);
    ...
    if ((this.fromUnTrigger2Trigger) && (paramFrame != null) && (this.item.gpuParticleConfig.backgroundConfig != null) && ("*".equals(this.item.gpuParticleConfig.backgroundConfig.texture)))
    {
      paramFrame = RendererUtils.saveTexture(paramFrame);
      if (paramFrame != null)
      {
        this.pdBackground.setTexture(BitmapUtils.bitmap2RGBA(paramFrame), paramFrame.getWidth(), paramFrame.getHeight());
        BitmapUtils.recycle(paramFrame);
      }
    }
  }
  ...
  public void updateVideoSize(int paramInt1, int paramInt2, double paramDouble)
  {
    ...
    if (this.item.gpuParticleConfig.backgroundConfig != null) {
      this.pdBackground.updateFboSize(-1, paramInt1, paramInt2);
    }
    this.pdSystem.updateFboSize(0, 0, paramInt1, paramInt2);
  }
  
  public static class ParticleEmitterParam
  {
