  ...
  extends BasePaticleEmitter
{
  ...
  @Deprecated
  class SpriteDecodeTask
    extends AsyncTask<Void, Void, Void>
  {
    String folder;
    ParticleConfig.ParticleEmitterConfigBean.Sprite sprite;
    
    public SpriteDecodeTask(String paramString, ParticleConfig.ParticleEmitterConfigBean.Sprite paramSprite)
    {
        ...
        for (;;)
        {
          ...
          catch (Throwable localThrowable2)
          {
            for (;;)
            {
              ...
              continue;
              ParticleEmitter3D.this.mTextureBitmaps[j] = localObject;
            }
          }
        }
