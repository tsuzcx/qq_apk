  ...
  extends Feature
{
  ...
  private static final SharedLibraryInfo[] sharedLibraries4Video = { new SharedLibraryInfo("opencv_world"), new SharedLibraryInfo("YTFaceTrackPro"), new SharedLibraryInfo("CameraFaceJNI") };
