  ...
  extends Feature
{
  ...
  private static final ModelInfo[] rapidBigModels = { new ModelInfo(true, "humansegment", "portrait_Xception_EX_spconv_256x256_0317_400_big.onnx.opt.onnx.rapidmodel"), new ModelInfo(true, "humansegment", "portrait_Xception_EX_spconv_256x256_0317_400_big.onnx.opt.onnx.rapidproto") };
  private static final ModelInfo[] rapidMiddleModels = { new ModelInfo(true, "humansegment", "portrait_Xception_192x160_0302_8910_small.onnx.opt.onnx.middle.rapidmodel"), new ModelInfo(true, "humansegment", "portrait_Xception_192x160_0302_8910_small.onnx.opt.onnx.middle.rapidproto") };
  private static final ModelInfo[] rapidSmallModels = { new ModelInfo(true, "humansegment", "portrait_Xception_192x160_0302_8910_small.onnx.opt.onnx.rapidmodel"), new ModelInfo(true, "humansegment", "portrait_Xception_192x160_0302_8910_small.onnx.opt.onnx.rapidproto") };
  ...
  public boolean initModelSync()
  {
    ...
    {
      Log.i(TAG, "huawei device init human seg model: CPU + " + MODLE_LEVEL.SMALL_MODEL.toString());
      return initSmallCpu();
    }
  ...
  static enum MODLE_LEVEL
  {
    BIG_MODEL(0),  MIDDLE_MODEL(1),  SMALL_MODEL(2);
    
    private final int value;
    
    private MODLE_LEVEL(int paramInt)
    {
      this.value = paramInt;
    }
