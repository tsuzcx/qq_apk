  ...
  extends Feature
{
  ...
  private static final ModelInfo[] rapidBigModels = { new ModelInfo(true, "aecatdetect", "20200218_cat_cleaned_ly_blazenet208_multiscale_coconobody_plus_bush_real_plus_handseg_all_plus_rear_neg_yolact_no_yolact_aug_90.onnx.opt.onnx.rapidmodel"), new ModelInfo(true, "aecatdetect", "20200218_cat_cleaned_ly_blazenet208_multiscale_coconobody_plus_bush_real_plus_handseg_all_plus_rear_neg_yolact_no_yolact_aug_90.onnx.opt.onnx.rapidproto"), new ModelInfo(true, "aecatdetect", "cat_tracking_v1.6.onnx.opt.onnx.rapidmodel"), new ModelInfo(true, "aecatdetect", "cat_tracking_v1.6.onnx.opt.onnx.rapidproto"), new ModelInfo(true, "aecatdetect", "cat_keypoint_v1.7.onnx.opt.onnx.rapidmodel"), new ModelInfo(true, "aecatdetect", "cat_keypoint_v1.7.onnx.opt.onnx.rapidproto") };
