...
public class SimpleGLThread
{
  ...
  public SimpleGLThread(EGLContext paramEGLContext, String paramString, OnSurfaceCreatedListener paramOnSurfaceCreatedListener)
  {
  ...
  public static abstract interface OnSurfaceCreatedListener
  {
    public abstract void onSurfaceCreated(OffscreenSurface paramOffscreenSurface);
  }
}
