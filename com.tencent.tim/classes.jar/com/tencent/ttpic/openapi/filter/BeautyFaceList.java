...
public class BeautyFaceList
{
  ...
  void getAvgColor(Frame paramFrame, float paramFloat1, List<PointF> paramList, float paramFloat2, ColorParam paramColorParam)
  {
      ...
      while (j < paramList.size())
      {
        ...
        if (this.mEyeLightenFilter != null)
        {
          ...
          if (this.mEyeLightenFilter.needRender())
          {
            ...
            new Frame();
            Object localObject2 = (ColorParam)this.colorParams.get(j);
            if (this.mEyeLightenFilter.getSmoothOpacity() > 0.0F)
            {
              ...
              if ((isFirstFewFrames()) || (i != 0) || (this.mRenderIndex % 2 == 0)) {
                getAvgColor(localFrame, 0.5F, localList, (float)this.mFaceDetScale, (ColorParam)localObject2);
              }
              localFrame.unlock();
            }
            this.mEyeLightenFilter.setEyePouchSmoothImage(((Frame)localObject1).getLastRenderTextureId(), ((ColorParam)localObject2).mRGBLeft, ((ColorParam)localObject2).mRGBRight, ((ColorParam)localObject2).mCgCrLeft, ((ColorParam)localObject2).mCgCrRight);
