...
public final class LogicDataManager
{
  ...
  private OnGetQQNumberEventListener mGetQQNumberEventListener;
  ...
  private VTSentenceImpl mVTSentenceStrategyImpl;
  ...
  public void buildVoice2TextParams(VideoMaterial paramVideoMaterial)
  {
    ...
    this.mVTSentenceStrategyImpl = new VTSentenceImpl(null);
  ...
  public String getValue(String paramString, WMElement paramWMElement)
  {
    String str = paramString;
    if (this.mProviderMap.containsKey(paramString)) {
      str = ((LogicValueProvider)this.mProviderMap.get(paramString)).getValue(paramWMElement);
    }
    return str;
  }
      ...
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((PATTERN_SPEECHW.matcher(paramString).find()) && (PATTERN_SPEECHW.matcher(str).find()))
          {
            ...
            paramSet = ((LogicValueProvider)this.mProviderMap.get(str)).getValue(paramWMElement);
  ...
  public void test()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      LogUtils.e(TAG, (String)localEntry.getKey() + ": " + ((LogicValueProvider)localEntry.getValue()).getValue());
    }
  }
  
  abstract class LogicValueProvider
  {
    private LogicValueProvider() {}
  ...
  public static abstract interface OnGetQQNumberEventListener
  {
    public abstract int onGetQQNumber();
  }
    ...
    implements VoiceTextRecognizer.VTChangeListener
  {
    ...
    private VoiceTextHandler vtHandler = new VoiceTextHandler(null);
    private ArrayList<String> wordCache = new ArrayList();
    private int wordCursor;
    
    private VTSentenceImpl() {}
    ...
    private void onWordsComplete()
    {
      ...
      for (;;)
      {
        ...
        if ((LogicDataManager.this.mVTSegmentCount > 0) && (!this.segmentImmediately))
        {
          ...
          int k = str.length() / LogicDataManager.this.mVTSegmentCount;
          if (str.length() % LogicDataManager.this.mVTSegmentCount == 0) {}
          for (int i = 0;; i = 1)
          {
            int j = 0;
            while (j < k + i)
            {
              int m = LogicDataManager.this.mVTSegmentCount * j;
              localArrayList.add(str.substring(m, Math.min(LogicDataManager.this.mVTSegmentCount + m, str.length())));
              j += 1;
            }
          }
          if (LogicDataManager.this.mVTSegmentTime > 0) {
            ...
            LogicDataManager.this.mVoiceTextDup.addAll(localArrayList);
          }
        }
    ...
    {
      LogUtils.e(LogicDataManager.TAG, "VTSentenceImpl -> onError : " + paramInt);
    }
    ...
    public void onVTChanged(String paramString)
    {
      ...
      LogUtils.d(LogicDataManager.TAG, "Before verify => " + paramString);
      if (!this.lastWord.equals(paramString))
      {
        ...
        for (;;)
        {
          synchronized (LogicDataManager.this.mVoiceTextQueue)
          {
            ...
            if (LogicDataManager.this.mVTSegmentTime > 0)
            {
              ...
              i = this.wordCursor;
              this.wordCursor = (i + 1);
              ((VoiceTextHandler)localObject2).addPendingChar2Queue(String.valueOf(paramString.charAt(i)));
            }
          }
          Object localObject2 = LogicDataManager.this.mVoiceTextQueue;
        ...
        if (LogicDataManager.this.mVTSegmentCount > 0)
        {
          ...
          label272:
          if (this.segmentStart + LogicDataManager.this.mVTSegmentCount > paramString.length()) {
            break label374;
          }
          ??? = paramString.substring(this.segmentStart, this.segmentStart + LogicDataManager.this.mVTSegmentCount);
          if (LogicDataManager.this.mVTSegmentTime <= 0) {
            break label357;
          }
        ...
        for (;;)
        {
          ...
          break;
          label357:
          LogicDataManager.this.mVoiceTextDup.add(???);
        }
        label374:
        LogUtils.e(LogicDataManager.TAG, "mVoiceTextDup = " + LogicDataManager.this.mVoiceTextDup.toString());
      }
      ...
      extends Handler
    {
      ...
      private VoiceTextHandler() {}
      
      public void addPendingChar2Queue(String paramString)
      {
        long l1 = System.currentTimeMillis();
        if (l1 > this.lastCharAt + LogicDataManager.this.mVTSegmentTime)
        {
          this.lastCharAt = l1;
          sendMessage(obtainMessage(4, paramString));
          return;
        }
        long l2 = this.lastCharAt + LogicDataManager.this.mVTSegmentTime - l1;
      ...
      {
        long l1 = System.currentTimeMillis();
        if (l1 > this.lastWordAt + LogicDataManager.this.mVTSegmentTime)
        {
          this.lastWordAt = l1;
          sendMessage(obtainMessage(3, paramString));
          return;
        }
        long l2 = this.lastWordAt + LogicDataManager.this.mVTSegmentTime - l1;
      ...
      public void handleMessage(Message paramMessage)
      {
        ...
        case 2: 
          ...
          {
            return;
            LogicDataManager.VTSentenceImpl.this.onWordsComplete();
            return;
            LogicDataManager.this.clearVoiceTexts();
          } while (LogicDataManager.this.mSilenceEventListener == null);
          LogicDataManager.this.mSilenceEventListener.onSilenceTimeEvent();
          return;
        case 3: 
          LogicDataManager.this.mVoiceTextDup.add((String)paramMessage.obj);
          LogUtils.e(LogicDataManager.TAG, "mVoiceTextDup = " + LogicDataManager.this.mVoiceTextDup.toString());
          return;
        }
        synchronized (LogicDataManager.this.mVoiceTextQueue)
        {
          LogicDataManager.this.mVoiceTextQueue.offer((String)paramMessage.obj);
          LogUtils.e(LogicDataManager.TAG, "mVoiceTextQueue = " + LogicDataManager.this.mVoiceTextQueue.toString());
          return;
        }
      }
