...
public class VideoTemplateParser
{
  ...
  private static void parseBasicParams(String paramString, JsonObject paramJsonObject, VideoMaterial paramVideoMaterial)
  {
    ...
    if (GsonUtils.optInt(paramJsonObject, VideoMaterialUtil.FIELD.SUPPORT_LANDSCAPE.value, 1) == 1)
    {
      ...
      bool = true;
      label283:
      paramVideoMaterial.setIsInternalRecord(bool);
    ...
    if (localJsonArray != null)
    {
      ...
      if (i < localJsonArray.size())
      {
        ...
        for (;;)
        {
          ...
          break;
          label166:
          paramJsonObject = FilamentJavaUtil.getDefaultExpressionRange(localAnimojiExpressionJava.shapeName);
        }
      }
    }
    return localArrayList;
  ...
  private static FaceStyleItem parseFaceStyleItem(JsonObject paramJsonObject, VideoMaterial paramVideoMaterial)
  {
    ...
    while (i < paramVideoMaterial.size())
    {
      ...
      i += 1;
      continue;
      paramVideoMaterial = GsonUtils.optString(paramJsonObject, VideoMaterialUtil.FACE_STYLE_ITEM_FIELD.TRIGGER_STATE.value);
      if ((paramVideoMaterial != null) && (paramVideoMaterial != "")) {
        localFaceStyleItem.triggerState.add(paramVideoMaterial);
      }
    }
    ...
    paramVideoMaterial = GsonUtils.optJsonArray(paramJsonObject, VideoMaterialUtil.FACE_STYLE_ITEM_FIELD.IMAGE_SIZE.value);
    if (paramVideoMaterial != null)
    {
      i = 0;
      while (i < paramVideoMaterial.size())
      {
        localFaceStyleItem.imageSize[i] = GsonUtils.optInt(paramVideoMaterial, i);
        i += 1;
      }
    }
    paramVideoMaterial = GsonUtils.optJsonObject(paramJsonObject, VideoMaterialUtil.FACE_STYLE_ITEM_FIELD.MODEL_CONFIG.value);
    if (paramVideoMaterial != null)
    {
      localFaceStyleItem.modelConfig = ((FaceStyleItem.ModelConfig)GsonUtils.json2Obj(paramVideoMaterial.toString(), FaceStyleItem.ModelConfig.class));
      localFaceStyleItem.getClass();
      paramVideoMaterial = new FaceStyleItem.ModelConfigItem(localFaceStyleItem);
    }
    switch (OfflineConfig.getPhonePerfLevel())
    {
    default: 
      localFaceStyleItem.modelName = paramVideoMaterial.modelName;
      localFaceStyleItem.imageSize = paramVideoMaterial.imageSize;
      if (paramVideoMaterial.initprocess == null)
      {
        localFaceStyleItem.getClass();
        paramVideoMaterial.initprocess = new FaceStyleItem.Process(localFaceStyleItem);
      }
      localFaceStyleItem.initProcess = paramVideoMaterial.initprocess;
      if (paramVideoMaterial.preprocess == null)
      {
        localFaceStyleItem.getClass();
        paramVideoMaterial.preprocess = new FaceStyleItem.Process(localFaceStyleItem);
      }
      localFaceStyleItem.preProcess = paramVideoMaterial.preprocess;
      if (paramVideoMaterial.postprocess == null)
      {
        localFaceStyleItem.getClass();
        paramVideoMaterial.postprocess = new FaceStyleItem.Process(localFaceStyleItem);
      }
      localFaceStyleItem.postProcess = paramVideoMaterial.postprocess;
      if (paramVideoMaterial.postRender == null)
      {
        localFaceStyleItem.getClass();
        paramVideoMaterial.postRender = new FaceStyleItem.Render(localFaceStyleItem);
      }
      localFaceStyleItem.postRender = paramVideoMaterial.postRender;
      ...
      {
        paramVideoMaterial = FileUtils.genSeperateFileDir(localFaceStyleItem.dataPath) + localFaceStyleItem.libraryPath;
        if (!FileUtils.isFileExist(paramVideoMaterial)) {
          break label811;
        }
      }
      break;
    }
    for (localFaceStyleItem.libraryText = FileUtils.load(AEModule.getContext(), paramVideoMaterial);; localFaceStyleItem.libraryText = FileUtils.load(AEModule.getContext(), paramVideoMaterial))
    {
      ...
      paramVideoMaterial = localFaceStyleItem.modelConfig.vlow;
      break;
      paramVideoMaterial = localFaceStyleItem.modelConfig.low;
      break;
      paramVideoMaterial = localFaceStyleItem.modelConfig.middle;
      break;
      paramVideoMaterial = localFaceStyleItem.modelConfig.mhigh;
      break;
      paramVideoMaterial = localFaceStyleItem.modelConfig.high;
      break;
      label811:
      paramVideoMaterial = "assets://" + FileUtils.genSeperateFileDir("faceStyleKernel") + localFaceStyleItem.libraryPath;
    }
    label860:
  ...
  private static VideoMaterial parsePituVideoMaterial(JsonObject paramJsonObject, String paramString, VideoMaterial paramVideoMaterial, DecryptListener paramDecryptListener)
  {
    ...
    if (arrayOfBoolean[0] != 0)
    {
      ...
      paramVideoMaterial.setStyleFilterList(parseStyleFilterList(paramString, GsonUtils.optJsonArray(paramJsonObject, VideoMaterialUtil.FIELD.STYLE_FILTER_LIST.value)));
  ...
  private static Map<String, StyleFilterSettingJsonBean> parseStyleFilterList(String paramString, JsonArray paramJsonArray)
  {
    Object localObject2 = null;
  ...
  public static String readMaterialFile(String paramString1, String paramString2, boolean paramBoolean, DecryptListener paramDecryptListener)
  {
    ...
    //   4: astore 6
    //   6: aload_0
    //   7: invokestatic 191	com/tencent/ttpic/baseutils/io/FileUtils:getRealPath	(Ljava/lang/String;)Ljava/lang/String;
    //   10: astore_0
    ...
    //   22: ldc_w 1042
    //   25: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   28: aload_1
    //   29: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   32: invokevirtual 206	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   35: astore 5
    //   37: new 193	java/lang/StringBuilder
    //   40: dup
    //   41: invokespecial 194	java/lang/StringBuilder:<init>	()V
    //   44: aload_0
    //   45: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   48: ldc_w 1042
    //   51: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   54: aload_1
    ...
    //   70: aload 5
    //   72: ldc 34
    //   74: invokevirtual 2692	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   77: ifne +25 -> 102
    //   80: new 193	java/lang/StringBuilder
    //   83: dup
    //   84: invokespecial 194	java/lang/StringBuilder:<init>	()V
    //   87: aload 5
    //   89: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   92: ldc_w 5461
    ...
    //   104: aload 7
    //   106: ldc 31
    //   108: invokevirtual 2692	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   111: ifne +884 -> 995
    ...
    //   135: astore_1
    //   136: new 200	java/io/File
    //   139: dup
    //   140: aload_0
    //   141: invokespecial 5464	java/io/File:<init>	(Ljava/lang/String;)V
    //   144: astore 7
    //   146: new 200	java/io/File
    //   149: dup
    //   150: aload_1
    //   151: invokespecial 5464	java/io/File:<init>	(Ljava/lang/String;)V
    //   154: astore 5
    //   156: aload 7
    //   158: invokevirtual 5467	java/io/File:exists	()Z
    //   161: ifeq +11 -> 172
    //   164: aload 7
    //   166: invokevirtual 5470	java/io/File:isFile	()Z
    //   169: ifne +19 -> 188
    //   172: aload 5
    //   174: invokevirtual 5467	java/io/File:exists	()Z
    //   177: ifeq +357 -> 534
    //   180: aload 5
    //   182: invokevirtual 5470	java/io/File:isFile	()Z
    //   185: ifeq +349 -> 534
    //   188: aload 7
    //   190: invokevirtual 5467	java/io/File:exists	()Z
    //   193: ifeq +296 -> 489
    //   196: aload 7
    //   198: invokevirtual 5470	java/io/File:isFile	()Z
    //   201: ifeq +288 -> 489
    //   204: new 5472	java/io/FileInputStream
    //   207: dup
    //   208: aload 7
    //   210: invokespecial 5475	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   213: astore_1
    //   214: iload_2
    //   215: ifne +314 -> 529
    //   218: aload_1
    //   219: aload_3
    //   220: invokestatic 5362	com/tencent/ttpic/openapi/util/VideoTemplateParser:drinkACupOfCoffee	(Ljava/io/InputStream;Lcom/tencent/ttpic/util/DecryptListener;)Ljava/io/InputStream;
    //   223: astore_0
    //   224: aload_1
    //   225: astore 5
    //   227: aload_0
    ...
    //   233: astore 7
    //   235: aload_1
    //   236: invokestatic 5478	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   239: aload_0
    //   240: ifnull +454 -> 694
    //   243: aload_1
    //   244: astore 5
    ...
    //   251: aload_0
    //   252: astore 7
    //   254: new 5349	java/io/InputStreamReader
    //   257: dup
    //   258: aload_0
    //   259: invokespecial 5365	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   262: astore 6
    //   264: new 5347	java/io/BufferedReader
    //   267: dup
    //   268: aload 6
    //   270: sipush 1024
    //   273: invokespecial 5368	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   276: astore_3
    //   277: aload_1
    //   278: astore 10
    //   280: aload 6
    ...
    //   310: astore 7
    //   312: aload_3
    //   313: invokevirtual 5371	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   316: astore 5
    //   318: aload 5
    //   320: ifnull +310 -> 630
    //   323: aload_1
    ...
    //   365: aload 5
    //   367: invokevirtual 5459	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   370: aload 5
    //   372: iconst_0
    //   373: anewarray 4	java/lang/Object
    //   376: invokestatic 5481	com/tencent/ttpic/baseutils/log/LogUtils:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    //   379: aload_3
    //   380: ifnull +7 -> 387
    //   383: aload_3
    //   384: invokevirtual 5484	java/io/BufferedReader:close	()V
    //   387: aload 6
    //   389: ifnull +8 -> 397
    //   392: aload 6
    //   394: invokevirtual 5485	java/io/InputStreamReader:close	()V
    //   397: aload_0
    //   398: ifnull +7 -> 405
    //   401: aload_0
    //   402: invokevirtual 5488	java/io/InputStream:close	()V
    //   405: aload_1
    //   406: ifnull +7 -> 413
    //   409: aload_1
    //   410: invokevirtual 5489	java/io/FileInputStream:close	()V
    //   413: aconst_null
    //   414: astore_0
    //   415: aload_0
    //   416: areturn
    ...
    //   420: aload 5
    //   422: ldc 31
    //   424: invokevirtual 2692	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   427: ifne +25 -> 452
    //   430: new 193	java/lang/StringBuilder
    //   433: dup
    //   434: invokespecial 194	java/lang/StringBuilder:<init>	()V
    //   437: aload 5
    //   439: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   442: ldc_w 5463
    //   445: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   448: invokevirtual 206	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   451: astore_0
    //   452: aload_0
    //   453: astore_1
    //   454: aload 7
    //   456: ldc 34
    //   458: invokevirtual 2692	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   461: ifne +534 -> 995
    //   464: new 193	java/lang/StringBuilder
    //   467: dup
    //   468: invokespecial 194	java/lang/StringBuilder:<init>	()V
    //   471: aload 7
    //   473: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   476: ldc_w 5461
    //   479: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   482: invokevirtual 206	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   485: astore_1
    //   486: goto -350 -> 136
    //   489: aload 5
    //   491: invokevirtual 5467	java/io/File:exists	()Z
    //   494: ifeq +496 -> 990
    //   497: aload 5
    //   499: invokevirtual 5470	java/io/File:isFile	()Z
    //   502: ifeq +488 -> 990
    //   505: new 5472	java/io/FileInputStream
    //   508: dup
    //   509: aload 5
    //   511: invokespecial 5475	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   514: astore_1
    //   515: iload_2
    //   516: ifne +8 -> 524
    //   519: iconst_1
    ...
    //   530: astore_0
    //   531: goto -292 -> 239
    //   534: invokestatic 2188	com/tencent/aekit/api/standard/AEModule:getContext	()Landroid/content/Context;
    //   537: invokevirtual 5493	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   540: aload_0
    //   541: invokevirtual 5499	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   544: astore 5
    //   546: iload_2
    //   547: ifne +20 -> 567
    //   550: aload 5
    //   552: aload_3
    //   553: invokestatic 5362	com/tencent/ttpic/openapi/util/VideoTemplateParser:drinkACupOfCoffee	(Ljava/io/InputStream;Lcom/tencent/ttpic/util/DecryptListener;)Ljava/io/InputStream;
    //   556: astore_0
    //   557: aload 5
    //   559: invokestatic 5478	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   562: aconst_null
    //   563: astore_1
    //   564: goto -325 -> 239
    //   567: aload 5
    ...
    //   574: aconst_null
    //   575: astore_0
    //   576: invokestatic 2188	com/tencent/aekit/api/standard/AEModule:getContext	()Landroid/content/Context;
    //   579: invokevirtual 5493	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   582: aload_1
    //   583: invokevirtual 5499	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   586: astore_1
    //   587: iload_2
    //   588: ifne +25 -> 613
    //   591: iload 4
    ...
    //   596: aload_1
    //   597: aload_3
    //   598: invokestatic 5362	com/tencent/ttpic/openapi/util/VideoTemplateParser:drinkACupOfCoffee	(Ljava/io/InputStream;Lcom/tencent/ttpic/util/DecryptListener;)Ljava/io/InputStream;
    //   601: astore_3
    //   602: aload_3
    //   603: astore_0
    //   604: aload_1
    //   605: invokestatic 5478	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   608: aconst_null
    //   609: astore_1
    //   610: goto -371 -> 239
    //   613: iconst_0
    ...
    //   641: astore 7
    //   643: aload 11
    //   645: invokevirtual 206	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   648: astore 5
    //   650: aload_3
    //   651: ifnull +7 -> 658
    //   654: aload_3
    //   655: invokevirtual 5484	java/io/BufferedReader:close	()V
    //   658: aload 6
    //   660: ifnull +8 -> 668
    //   663: aload 6
    //   665: invokevirtual 5485	java/io/InputStreamReader:close	()V
    //   668: aload_0
    //   669: ifnull +7 -> 676
    //   672: aload_0
    //   673: invokevirtual 5488	java/io/InputStream:close	()V
    //   676: aload 5
    //   678: astore_0
    //   679: aload_1
    //   680: ifnull -265 -> 415
    //   683: aload_1
    //   684: invokevirtual 5489	java/io/FileInputStream:close	()V
    //   687: aload 5
    //   689: areturn
    //   690: astore_0
    //   691: aload 5
    ...
    //   694: iconst_0
    //   695: ifeq +11 -> 706
    //   698: new 5501	java/lang/NullPointerException
    //   701: dup
    //   702: invokespecial 5502	java/lang/NullPointerException:<init>	()V
    //   705: athrow
    //   706: iconst_0
    //   707: ifeq +11 -> 718
    //   710: new 5501	java/lang/NullPointerException
    //   713: dup
    //   714: invokespecial 5502	java/lang/NullPointerException:<init>	()V
    //   717: athrow
    //   718: aload_0
    //   719: ifnull +7 -> 726
    //   722: aload_0
    //   723: invokevirtual 5488	java/io/InputStream:close	()V
    //   726: aload_1
    //   727: ifnull -314 -> 413
    //   730: aload_1
    //   731: invokevirtual 5489	java/io/FileInputStream:close	()V
    //   734: goto -321 -> 413
    //   737: astore_0
    //   738: goto -325 -> 413
    //   741: astore_1
    ...
    //   751: ifnull +8 -> 759
    //   754: aload 5
    //   756: invokevirtual 5484	java/io/BufferedReader:close	()V
    //   759: aload_3
    //   760: ifnull +7 -> 767
    //   763: aload_3
    //   764: invokevirtual 5485	java/io/InputStreamReader:close	()V
    //   767: aload_0
    //   768: ifnull +7 -> 775
    //   771: aload_0
    //   772: invokevirtual 5488	java/io/InputStream:close	()V
    //   775: aload 6
    //   777: ifnull +8 -> 785
    //   780: aload 6
    //   782: invokevirtual 5489	java/io/FileInputStream:close	()V
    //   785: aload_1
    //   786: athrow
    //   787: astore_0
    //   788: goto -3 -> 785
    ...
    //   985	1	5	localIOException	IOException
  ...
  private static String readPexFile(String paramString1, String paramString2, DecryptListener paramDecryptListener)
  {
    ...
    //   9: aload_1
    //   10: ldc 31
    //   12: invokevirtual 2692	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   15: ifne +327 -> 342
    //   18: iconst_1
    //   19: istore_3
    //   20: aload_0
    //   21: invokestatic 191	com/tencent/ttpic/baseutils/io/FileUtils:getRealPath	(Ljava/lang/String;)Ljava/lang/String;
    //   24: astore 6
    //   26: new 193	java/lang/StringBuilder
    //   29: dup
    //   30: invokespecial 194	java/lang/StringBuilder:<init>	()V
    //   33: aload 6
    //   35: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   38: ldc_w 1042
    //   41: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   44: aload_1
    //   45: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    //   55: dup
    //   56: invokespecial 194	java/lang/StringBuilder:<init>	()V
    //   59: aload 6
    //   61: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   64: ldc_w 1042
    //   67: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   70: aload_1
    ...
    //   77: astore 6
    //   79: new 200	java/io/File
    //   82: dup
    //   83: aload_0
    //   84: invokespecial 5464	java/io/File:<init>	(Ljava/lang/String;)V
    //   87: astore_1
    //   88: new 200	java/io/File
    //   91: dup
    //   92: aload 6
    //   94: invokespecial 5464	java/io/File:<init>	(Ljava/lang/String;)V
    //   97: astore 8
    //   99: aload_1
    //   100: invokevirtual 5467	java/io/File:exists	()Z
    //   103: ifeq +10 -> 113
    //   106: aload_1
    //   107: invokevirtual 5470	java/io/File:isFile	()Z
    //   110: ifne +19 -> 129
    //   113: aload 8
    //   115: invokevirtual 5467	java/io/File:exists	()Z
    //   118: ifeq +280 -> 398
    //   121: aload 8
    //   123: invokevirtual 5470	java/io/File:isFile	()Z
    //   126: ifeq +272 -> 398
    //   129: aload_1
    //   130: invokevirtual 5467	java/io/File:exists	()Z
    //   133: ifeq +214 -> 347
    //   136: aload_1
    //   137: invokevirtual 5470	java/io/File:isFile	()Z
    //   140: ifeq +207 -> 347
    //   143: new 5472	java/io/FileInputStream
    //   146: dup
    //   147: aload_1
    //   148: invokespecial 5475	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   151: astore_0
    //   152: aload_0
    //   153: astore 7
    //   155: iload_3
    ...
    //   159: aload 7
    //   161: aload_2
    //   162: invokestatic 5362	com/tencent/ttpic/openapi/util/VideoTemplateParser:drinkACupOfCoffee	(Ljava/io/InputStream;Lcom/tencent/ttpic/util/DecryptListener;)Ljava/io/InputStream;
    //   165: astore_0
    //   166: aload 7
    //   168: invokestatic 5478	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   171: aload_0
    //   172: astore 6
    //   174: aload 6
    //   176: ifnull +405 -> 581
    //   179: new 5349	java/io/InputStreamReader
    //   182: dup
    //   183: aload 6
    //   185: invokespecial 5365	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   188: astore_2
    //   189: new 5347	java/io/BufferedReader
    //   192: dup
    //   193: aload_2
    //   194: sipush 1024
    //   197: invokespecial 5368	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   200: astore_0
    //   201: aload 7
    //   203: astore 11
    //   205: aload_2
    ...
    //   211: aload 6
    //   213: astore 8
    //   215: new 193	java/lang/StringBuilder
    //   218: dup
    //   219: invokespecial 194	java/lang/StringBuilder:<init>	()V
    //   222: astore_1
    //   223: aload 7
    //   225: astore 11
    //   227: aload_2
    ...
    //   235: astore 8
    //   237: aload_0
    //   238: invokevirtual 5371	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   241: astore 12
    //   243: aload 12
    //   245: ifnull +259 -> 504
    //   248: aload 7
    ...
    //   262: aload_1
    //   263: aload 12
    //   265: invokevirtual 198	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   268: pop
    //   269: goto -46 -> 223
    //   272: astore_1
    //   273: aload 7
    ...
    //   290: aload_1
    //   291: invokevirtual 5459	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   294: aload_1
    //   295: iconst_0
    //   296: anewarray 4	java/lang/Object
    //   299: invokestatic 5481	com/tencent/ttpic/baseutils/log/LogUtils:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    //   302: aload_0
    //   303: ifnull +7 -> 310
    //   306: aload_0
    //   307: invokevirtual 5484	java/io/BufferedReader:close	()V
    //   310: aload_2
    //   311: ifnull +7 -> 318
    //   314: aload_2
    //   315: invokevirtual 5485	java/io/InputStreamReader:close	()V
    //   318: aload 6
    //   320: ifnull +8 -> 328
    //   323: aload 6
    //   325: invokevirtual 5488	java/io/InputStream:close	()V
    //   328: aload 7
    //   330: ifnull +8 -> 338
    //   333: aload 7
    //   335: invokevirtual 5489	java/io/FileInputStream:close	()V
    //   338: aconst_null
    //   339: astore_0
    //   340: aload_0
    //   341: areturn
    ...
    //   344: goto -324 -> 20
    //   347: aload 8
    //   349: invokevirtual 5467	java/io/File:exists	()Z
    //   352: ifeq +598 -> 950
    //   355: aload 8
    //   357: invokevirtual 5470	java/io/File:isFile	()Z
    //   360: ifeq +590 -> 950
    //   363: new 5472	java/io/FileInputStream
    //   366: dup
    //   367: aload 8
    //   369: invokespecial 5475	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   372: astore_0
    //   373: iload_3
    //   374: ifne +12 -> 386
    //   377: iload 5
    ...
    //   393: astore 6
    //   395: goto -221 -> 174
    //   398: invokestatic 2188	com/tencent/aekit/api/standard/AEModule:getContext	()Landroid/content/Context;
    //   401: invokevirtual 5493	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   404: aload_0
    //   405: invokevirtual 5499	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   408: astore_1
    //   409: iload_3
    //   410: ifne +22 -> 432
    //   413: aload_1
    //   414: aload_2
    //   415: invokestatic 5362	com/tencent/ttpic/openapi/util/VideoTemplateParser:drinkACupOfCoffee	(Ljava/io/InputStream;Lcom/tencent/ttpic/util/DecryptListener;)Ljava/io/InputStream;
    //   418: astore_0
    //   419: aload_1
    //   420: invokestatic 5478	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   423: aconst_null
    //   424: astore 7
    //   426: aload_0
    //   427: astore 6
    ...
    //   438: aconst_null
    //   439: astore_0
    //   440: invokestatic 2188	com/tencent/aekit/api/standard/AEModule:getContext	()Landroid/content/Context;
    //   443: invokevirtual 5493	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   446: aload 6
    //   448: invokevirtual 5499	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   451: astore_1
    //   452: iload_3
    //   453: ifne +31 -> 484
    //   456: iload 4
    ...
    //   463: aload_1
    //   464: aload_2
    //   465: invokestatic 5362	com/tencent/ttpic/openapi/util/VideoTemplateParser:drinkACupOfCoffee	(Ljava/io/InputStream;Lcom/tencent/ttpic/util/DecryptListener;)Ljava/io/InputStream;
    //   468: astore_2
    //   469: aload_2
    //   470: astore_0
    //   471: aload_1
    //   472: invokestatic 5478	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   475: aconst_null
    //   476: astore 7
    //   478: aload_0
    //   479: astore 6
    ...
    //   516: astore 8
    //   518: aload_1
    //   519: invokevirtual 206	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   522: astore_1
    //   523: aload_0
    //   524: ifnull +7 -> 531
    //   527: aload_0
    //   528: invokevirtual 5484	java/io/BufferedReader:close	()V
    //   531: aload_2
    //   532: ifnull +7 -> 539
    //   535: aload_2
    //   536: invokevirtual 5485	java/io/InputStreamReader:close	()V
    //   539: aload 6
    //   541: ifnull +8 -> 549
    //   544: aload 6
    //   546: invokevirtual 5488	java/io/InputStream:close	()V
    //   549: aload_1
    //   550: astore_0
    //   551: aload 7
    //   553: ifnull -213 -> 340
    //   556: aload 7
    //   558: invokevirtual 5489	java/io/FileInputStream:close	()V
    //   561: aload_1
    //   562: areturn
    //   563: astore_0
    //   564: getstatic 56	com/tencent/ttpic/openapi/util/VideoTemplateParser:TAG	Ljava/lang/String;
    //   567: aload_0
    //   568: invokevirtual 5503	java/io/IOException:getMessage	()Ljava/lang/String;
    //   571: aload_0
    //   572: iconst_0
    //   573: anewarray 4	java/lang/Object
    //   576: invokestatic 5481	com/tencent/ttpic/baseutils/log/LogUtils:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    //   579: aload_1
    //   580: areturn
    //   581: iconst_0
    //   582: ifeq +11 -> 593
    //   585: new 5501	java/lang/NullPointerException
    //   588: dup
    //   589: invokespecial 5502	java/lang/NullPointerException:<init>	()V
    //   592: athrow
    //   593: iconst_0
    //   594: ifeq +11 -> 605
    //   597: new 5501	java/lang/NullPointerException
    //   600: dup
    //   601: invokespecial 5502	java/lang/NullPointerException:<init>	()V
    //   604: athrow
    //   605: aload 6
    //   607: ifnull +8 -> 615
    //   610: aload 6
    //   612: invokevirtual 5488	java/io/InputStream:close	()V
    //   615: aload 7
    //   617: ifnull -279 -> 338
    //   620: aload 7
    //   622: invokevirtual 5489	java/io/FileInputStream:close	()V
    //   625: goto -287 -> 338
    //   628: astore_0
    //   629: getstatic 56	com/tencent/ttpic/openapi/util/VideoTemplateParser:TAG	Ljava/lang/String;
    //   632: aload_0
    //   633: invokevirtual 5503	java/io/IOException:getMessage	()Ljava/lang/String;
    //   636: aload_0
    //   637: iconst_0
    //   638: anewarray 4	java/lang/Object
    //   641: invokestatic 5481	com/tencent/ttpic/baseutils/log/LogUtils:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    //   644: goto -306 -> 338
    //   647: astore_0
    //   648: getstatic 56	com/tencent/ttpic/openapi/util/VideoTemplateParser:TAG	Ljava/lang/String;
    //   651: aload_0
    //   652: invokevirtual 5503	java/io/IOException:getMessage	()Ljava/lang/String;
    //   655: aload_0
    //   656: iconst_0
    //   657: anewarray 4	java/lang/Object
    //   660: invokestatic 5481	com/tencent/ttpic/baseutils/log/LogUtils:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    //   663: goto -325 -> 338
    //   666: astore_0
    //   667: aconst_null
    //   668: astore_1
    ...
    //   675: ifnull +7 -> 682
    //   678: aload_2
    //   679: invokevirtual 5484	java/io/BufferedReader:close	()V
    //   682: aload_1
    //   683: ifnull +7 -> 690
    //   686: aload_1
    //   687: invokevirtual 5485	java/io/InputStreamReader:close	()V
    //   690: aload 6
    //   692: ifnull +8 -> 700
    //   695: aload 6
    //   697: invokevirtual 5488	java/io/InputStream:close	()V
    //   700: aload 7
    //   702: ifnull +8 -> 710
    //   705: aload 7
    //   707: invokevirtual 5489	java/io/FileInputStream:close	()V
    //   710: aload_0
    //   711: athrow
    //   712: astore_1
    //   713: getstatic 56	com/tencent/ttpic/openapi/util/VideoTemplateParser:TAG	Ljava/lang/String;
    //   716: aload_1
    //   717: invokevirtual 5503	java/io/IOException:getMessage	()Ljava/lang/String;
    //   720: aload_1
    //   721: iconst_0
    //   722: anewarray 4	java/lang/Object
    //   725: invokestatic 5481	com/tencent/ttpic/baseutils/log/LogUtils:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    //   728: goto -18 -> 710
    //   731: astore_0
    //   732: aconst_null
    //   733: astore_1
