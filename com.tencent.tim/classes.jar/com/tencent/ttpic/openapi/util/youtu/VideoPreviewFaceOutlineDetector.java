  ...
  implements FaceActionCounterListener
{
  ...
  public int init()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 108	com/tencent/ttpic/openapi/util/youtu/VideoPreviewFaceOutlineDetector:mInitSuccess	Z
    //   8: istore_2
    //   9: iload_2
    //   10: ifeq +7 -> 17
    //   13: aload_0
    ...
    //   16: ireturn
    //   17: aload_0
    //   18: invokespecial 733	com/tencent/ttpic/openapi/facedetect/FaceDetector:init	()I
    //   21: pop
    //   22: aload_0
    //   23: getfield 192	com/tencent/ttpic/openapi/util/youtu/VideoPreviewFaceOutlineDetector:mFaceDetect	Lcom/tencent/ttpic/util/youtu/VideoFaceDetector;
    //   26: ifnull +14 -> 40
    //   29: aload_0
    //   30: aload_0
    //   31: getfield 192	com/tencent/ttpic/openapi/util/youtu/VideoPreviewFaceOutlineDetector:mFaceDetect	Lcom/tencent/ttpic/util/youtu/VideoFaceDetector;
    //   34: invokevirtual 734	com/tencent/ttpic/util/youtu/VideoFaceDetector:init	()Z
    //   37: putfield 108	com/tencent/ttpic/openapi/util/youtu/VideoPreviewFaceOutlineDetector:mInitSuccess	Z
    //   40: getstatic 88	com/tencent/ttpic/openapi/util/youtu/VideoPreviewFaceOutlineDetector:TAG	Ljava/lang/String;
    //   43: new 280	java/lang/StringBuilder
    //   46: dup
    //   47: invokespecial 281	java/lang/StringBuilder:<init>	()V
    //   50: ldc_w 736
    //   53: invokevirtual 287	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   56: aload_0
    //   57: getfield 108	com/tencent/ttpic/openapi/util/youtu/VideoPreviewFaceOutlineDetector:mInitSuccess	Z
    //   60: invokevirtual 739	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   63: invokevirtual 305	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   66: invokestatic 744	com/tencent/ttpic/baseutils/log/LogUtils:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   69: aload_0
    //   70: getfield 108	com/tencent/ttpic/openapi/util/youtu/VideoPreviewFaceOutlineDetector:mInitSuccess	Z
    //   73: istore_2
    //   74: iload_2
    //   75: ifne -62 -> 13
    //   78: iconst_2
  ...
  public void updateFacesTrack(List<FaceInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (paramList != null)
      {
        ...
        Log.i(TAG, "匹配上一帧人脸，ID：" + paramList.idFace);
        break label209;
      }
      Log.i(TAG, "人脸丢失，ID");
      break label209;
  ...
  class TraceFaceItem
  {
    ...
    public double distanceTwoFaces(FaceInfo paramFaceInfo)
    {
      if ((paramFaceInfo != null) && (paramFaceInfo.points != null) && (paramFaceInfo.points.size() > 64)) {
        return VideoPreviewFaceOutlineDetector.this.distance2Points(this.centerPoint, (PointF)paramFaceInfo.points.get(64));
      }
      return VideoPreviewFaceOutlineDetector.this.DISTANCE_MAX_TWO_POINTS;
    }
    ...
    public void updatePoints(FaceInfo paramFaceInfo)
    {
      ...
      if (VideoPreviewFaceOutlineDetector.this.mFaceCodeIDMap == null) {
        VideoPreviewFaceOutlineDetector.access$302(VideoPreviewFaceOutlineDetector.this, new HashMap());
      }
