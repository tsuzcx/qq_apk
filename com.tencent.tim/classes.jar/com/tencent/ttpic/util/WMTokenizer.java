...
public class WMTokenizer
{
  ...
  private void tokenizerHorizontalMultiRow()
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = new Token();
        ((Token)localObject).text = this.mText.substring(j);
        ((Token)localObject).width = f;
        ((Token)localObject).height = this.mCharHeight;
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        {
          localObject = (Token)this.mTokens.get(i - 1);
          if (((Token)localObject).text.length() > 3) {
            ((Token)localObject).text = (((Token)localObject).text.substring(0, ((Token)localObject).text.length() - 3) + "...");
          }
        }
  ...
  private void tokenizerVerticalMultiColumn()
  {
    ...
    for (;;)
    {
      ...
      if (j < this.mText.length())
      {
        localObject = new Token();
        ((Token)localObject).text = this.mText.substring(j);
        ((Token)localObject).width = this.mCharWidth;
        ((Token)localObject).height = f;
        this.mTokens.add(localObject);
      }
  ...
  public void doLayout()
  {
    ...
    if (this.mVertical)
    {
      ...
      if (this.mAlignMode == 2)
      {
        ...
        localObject2 = (Token)((Iterator)localObject1).next();
      ...
      for (;;)
      {
        ((Token)localObject2).x = f1;
        f1 = ((Token)localObject2).width + f1;
        break label88;
        ...
        break;
        ((Token)localObject2).y = 0.0F;
        continue;
        ((Token)localObject2).y = ((this.mHeight - ((Token)localObject2).height) / 2.0F);
        continue;
        ((Token)localObject2).y = (this.mHeight - ((Token)localObject2).height);
      }
    }
    else
    {
      ...
      for (;;)
      {
        ((Token)localObject2).y = f1;
        f1 = ((Token)localObject2).height + f1;
        break label302;
        if (this.mAlignMode != 1) {
          break;
        }
        f1 = (this.mHeight - this.mCharHeight * this.mTokens.size()) / 2.0F;
        break;
        ((Token)localObject2).x = 0.0F;
        continue;
        ((Token)localObject2).x = ((this.mWidth - ((Token)localObject2).width) / 2.0F);
        continue;
        ((Token)localObject2).x = (this.mWidth - ((Token)localObject2).width);
      }
    }
    label455:
    Object localObject1 = (Token)this.mTokens.get(0);
    float f1 = ((Token)localObject1).x;
    float f2 = ((Token)localObject1).y;
    float f3 = ((Token)localObject1).x;
    float f4 = ((Token)localObject1).width;
    float f5 = ((Token)localObject1).y;
    this.mTextRect = new RectF(f1, f2, f3 + f4, ((Token)localObject1).height + f5);
    int i = 1;
    label528:
    if (i < this.mTokens.size())
    {
      localObject1 = (Token)this.mTokens.get(i);
      localObject2 = this.mTextRect;
      if (this.mTextRect.left > ((Token)localObject1).x) {
        break label719;
      }
      ...
      localObject2 = this.mTextRect;
      if (this.mTextRect.right < ((Token)localObject1).x + ((Token)localObject1).width) {
        break label728;
      }
      ...
      localObject2 = this.mTextRect;
      if (this.mTextRect.top > ((Token)localObject1).y) {
        break label743;
      }
      ...
      localObject2 = this.mTextRect;
      if (this.mTextRect.bottom < ((Token)localObject1).y + ((Token)localObject1).height) {
        break label752;
      }
    }
    for (f1 = this.mTextRect.bottom;; f1 = ((Token)localObject1).height + f1)
    {
      ...
      break;
      label719:
      f1 = ((Token)localObject1).x;
      break label584;
      label728:
      f1 = ((Token)localObject1).x + ((Token)localObject1).width;
      break label626;
      label743:
      f1 = ((Token)localObject1).y;
      break label662;
      label752:
      f1 = ((Token)localObject1).y;
    }
  ...
  public Token getToken(int paramInt)
  {
    ...
    return (Token)this.mTokens.get(paramInt);
  }
