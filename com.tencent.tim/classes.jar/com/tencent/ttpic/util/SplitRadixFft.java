...
public class SplitRadixFft
{
  ...
  private final void cftb1st(int paramInt1, double[] paramArrayOfDouble1, double[] paramArrayOfDouble2, int paramInt2)
  {
    ...
    paramArrayOfDouble1[(paramInt2 + 3)] = (d4 * d9 + d3 * d10);
    d3 = d7 - d8;
    d4 = d5 - d6;
    paramArrayOfDouble1[(i + 2)] = (d1 * d3 + d2 * d4);
    paramArrayOfDouble1[(i + 3)] = (d1 * d4 - d3 * d2);
  }
    ...
    if (paramInt > 2)
    {
      ...
      while (k >= 2)
      {
        ...
        for (;;)
        {
          ...
          {
            i1 += (m << 2);
            paramArrayOfDouble1[(i1 - m)] = (paramArrayOfDouble2[n] - paramArrayOfDouble2[(n + 1)]);
            paramArrayOfDouble1[(i1 + m)] = (paramArrayOfDouble2[n] + paramArrayOfDouble2[(n + 1)]);
            n += 2;
          }
          if (k == 4) {
        ...
        {
          int i2 = k - n;
          paramArrayOfDouble2[n] = (paramArrayOfDouble2[(k + i2)] - paramArrayOfDouble2[(k + n)]);
          paramArrayOfDouble2[i2] = (paramArrayOfDouble2[(k + i2)] + paramArrayOfDouble2[(k + n)]);
          n += 1;
        }
  ...
  public void dfst(int paramInt, double[] paramArrayOfDouble1, double[] paramArrayOfDouble2, int[] paramArrayOfInt, double[] paramArrayOfDouble3)
  {
    ...
    if (paramInt > 2)
    {
      ...
      while (k >= 2)
      {
        dstsub(k, paramArrayOfDouble2, j, paramArrayOfDouble3, i);
        if (k > 4)
        {
          cftfsub(k, paramArrayOfDouble2, paramArrayOfInt, 2, i, paramArrayOfDouble3);
          rftfsub(k, paramArrayOfDouble2, j, paramArrayOfDouble3, i);
        ...
        paramArrayOfDouble2[0] = paramArrayOfDouble2[(k + i1)];
        m <<= 1;
        k = i1;
      }
      paramArrayOfDouble1[m] = paramArrayOfDouble2[0];
