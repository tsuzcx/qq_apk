...
public class FrameRateUtil
{
  ...
  private FrameRateUtil(Operation paramOperation)
  {
  ...
  public static FrameRateUtil getInstance(Operation paramOperation)
  {
  ...
  public void setListener(DowngradeListener paramDowngradeListener)
  {
    this.listener = paramDowngradeListener;
  }
  
  public static abstract interface DowngradeListener
  {
