...
public class BeautyBodyThinBody
{
  ...
  public BeautyBodyThinBody()
  {
    ...
    int k = 0;
    int i = j;
    ThinBodyParameters localThinBodyParameters1;
    for (j = k; i < this.smoothedWithinFrames; j = k)
    {
      ...
      if (this.previousValidFrames[i] == 1)
      {
        ...
        ThinBodyParameters localThinBodyParameters2 = this.smoothedParams;
  ...
  public class ThinBodyParameters
  {
    ...
    public ThinBodyParameters(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6)
    {
    ...
    {
      return new ThinBodyParameters(BeautyBodyThinBody.this, this.waistWidth, this.middleLine, this.strength, this.y0, this.y1, this.y2);
    }
