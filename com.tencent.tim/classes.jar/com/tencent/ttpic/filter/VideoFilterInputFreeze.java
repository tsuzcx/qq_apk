...
public class VideoFilterInputFreeze
{
  ...
  public void setDelayTriggerTime(long paramLong)
  {
    ...
    this.mDelayRunnable = new DelayRunnable(null);
  }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      VideoFilterInputFreeze.access$202(VideoFilterInputFreeze.this, true);
      VideoFilterInputFreeze.access$308(VideoFilterInputFreeze.this);
      VideoFilterInputFreeze.access$402(VideoFilterInputFreeze.this, false);
    }
  }
}
