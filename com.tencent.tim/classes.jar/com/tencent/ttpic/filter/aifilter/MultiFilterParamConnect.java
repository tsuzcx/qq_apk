...
public class MultiFilterParamConnect
{
  ...
  public static BaseFilter createFilter(FilterMaterial paramFilterMaterial, float paramFloat1, float paramFloat2, OnSingleFilterCreatedCallback paramOnSingleFilterCreatedCallback)
  {
  ...
  public static abstract interface OnSingleFilterCreatedCallback
  {
    public abstract void onCreated(BaseFilterMaterial paramBaseFilterMaterial);
  }
}
