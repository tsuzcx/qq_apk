  ...
  implements NetworkRequest
{
  ...
  public static void writeBytesToFile(Context paramContext, byte[] paramArrayOfByte)
  {
    ...
    //   5: aconst_null
    //   6: astore_2
    //   7: new 89	java/lang/StringBuilder
    //   10: dup
    //   11: invokespecial 90	java/lang/StringBuilder:<init>	()V
    //   14: aload_0
    //   15: invokevirtual 131	android/content/Context:getFilesDir	()Ljava/io/File;
    //   18: invokevirtual 136	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   21: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   24: getstatic 139	java/io/File:separator	Ljava/lang/String;
    ...
    //   43: iconst_0
    //   44: ifeq -40 -> 4
    //   47: new 157	java/lang/NullPointerException
    //   50: dup
    //   51: invokespecial 158	java/lang/NullPointerException:<init>	()V
    //   54: athrow
    //   55: astore_0
    //   56: return
    //   57: new 160	java/io/FileOutputStream
    //   60: dup
    //   61: new 133	java/io/File
    //   64: dup
    //   65: aload_0
    //   66: invokespecial 163	java/io/File:<init>	(Ljava/lang/String;)V
    //   69: invokespecial 166	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   72: astore_0
    //   73: aload_0
    //   74: aload_1
    //   75: invokevirtual 170	java/io/FileOutputStream:write	([B)V
    //   78: aload_0
    //   79: ifnull -75 -> 4
    //   82: aload_0
    //   83: invokevirtual 173	java/io/FileOutputStream:close	()V
    //   86: return
    //   87: astore_0
    //   88: return
    //   89: astore_0
    ...
    //   93: ifnull -89 -> 4
    //   96: aload_0
    //   97: invokevirtual 173	java/io/FileOutputStream:close	()V
    //   100: return
    //   101: astore_0
    //   102: return
    //   103: astore_0
  ...
  public String post(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString2.getParams().setParameter("http.connection.timeout", Integer.valueOf(3000));
        paramString2.getParams().setParameter("http.socket.timeout", Integer.valueOf(12000));
        paramString1 = new JSONObject(EntityUtils.toString(paramString2.execute(paramString1).getEntity(), "UTF-8"));
      ...
      {
        Log.w(TAG, "upload error = ", paramString1);
        return "";
      }
 ...
 * Qualified Name:     com.tencent.ttpic.filter.aifilter.HttpRequestUtils
