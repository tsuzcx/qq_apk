...
public class BeautyBodyThinShoulder
{
  ...
  public BeautyBodyThinShoulder()
  {
    ...
    while (i < this.smoothedWithinFrames)
    {
      ...
      {
        k = j + 1;
        ThinShoulderParameters localThinShoulderParameters = this.previousParams[i];
  ...
  public class ThinShoulderParameters
  {
    ...
    public ThinShoulderParameters(RectF paramRectF)
    {
    ...
    {
      return new ThinShoulderParameters(BeautyBodyThinShoulder.this, new RectF(this.rect));
    }
