...
public class DeviceUtils
{
  ...
  private static String fetchExternalIpProviderHTML(String paramString)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: new 216	java/net/URL
    //   6: dup
    //   7: aload_0
    //   8: invokespecial 217	java/net/URL:<init>	(Ljava/lang/String;)V
    //   11: invokevirtual 221	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   14: checkcast 223	java/net/HttpURLConnection
    //   17: astore_0
    //   18: iconst_1
    //   19: invokestatic 227	java/net/HttpURLConnection:setFollowRedirects	(Z)V
    //   22: aload_0
    //   23: ldc 229
    //   25: invokevirtual 232	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   28: aload_0
    //   29: ldc 234
    //   31: ldc 236
    //   33: invokevirtual 240	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   36: aload_0
    //   37: invokevirtual 244	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   40: astore_3
    //   41: sipush 1024
    //   44: newarray byte
    //   46: astore 4
    ...
    //   64: iload_1
    //   65: isub
    //   66: invokevirtual 250	java/io/InputStream:read	([BII)I
    //   69: istore_2
    //   70: iload_2
    //   71: iflt +10 -> 81
    //   74: iload_1
    ...
    //   77: istore_1
    //   78: goto -28 -> 50
    //   81: new 151	java/lang/String
    //   84: dup
    //   85: aload 4
    //   87: ldc 252
    //   89: invokespecial 255	java/lang/String:<init>	([BLjava/lang/String;)V
    //   92: astore 4
    //   94: aload_3
    //   95: ifnull +7 -> 102
    //   98: aload_3
    //   99: invokevirtual 258	java/io/InputStream:close	()V
    //   102: aload_0
    //   103: ifnull +7 -> 110
    //   106: aload_0
    //   107: invokevirtual 261	java/net/HttpURLConnection:disconnect	()V
    //   110: aload 4
    //   112: areturn
    //   113: astore_0
    //   114: aload_0
    //   115: invokevirtual 198	java/lang/Exception:printStackTrace	()V
    //   118: goto -8 -> 110
    //   121: astore 4
    //   123: aconst_null
    //   124: astore_0
    ...
    //   131: astore 5
    //   133: aload 4
    //   135: invokevirtual 262	java/net/MalformedURLException:printStackTrace	()V
    //   138: aload_3
    //   139: ifnull +7 -> 146
    //   142: aload_3
    //   143: invokevirtual 258	java/io/InputStream:close	()V
    //   146: aload_0
    //   147: ifnull +7 -> 154
    //   150: aload_0
    //   151: invokevirtual 261	java/net/HttpURLConnection:disconnect	()V
    //   154: aconst_null
    //   155: areturn
    //   156: astore_0
    //   157: aload_0
    //   158: invokevirtual 198	java/lang/Exception:printStackTrace	()V
    //   161: goto -7 -> 154
    //   164: astore 4
    //   166: aconst_null
    //   167: astore_0
    ...
    //   174: astore 5
    //   176: aload 4
    //   178: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   181: aload_3
    //   182: ifnull +7 -> 189
    //   185: aload_3
    //   186: invokevirtual 258	java/io/InputStream:close	()V
    //   189: aload_0
    //   190: ifnull -36 -> 154
    //   193: aload_0
    //   194: invokevirtual 261	java/net/HttpURLConnection:disconnect	()V
    //   197: goto -43 -> 154
    //   200: astore_0
    //   201: aload_0
    //   202: invokevirtual 198	java/lang/Exception:printStackTrace	()V
    //   205: goto -51 -> 154
    //   208: astore_0
    //   209: aconst_null
    //   210: astore_3
    ...
    //   212: ifnull +7 -> 219
    //   215: aload_3
    //   216: invokevirtual 258	java/io/InputStream:close	()V
    //   219: aload 4
    //   221: ifnull +8 -> 229
    //   224: aload 4
    //   226: invokevirtual 261	java/net/HttpURLConnection:disconnect	()V
    //   229: aload_0
    //   230: athrow
    //   231: astore_3
    //   232: aload_3
    //   233: invokevirtual 198	java/lang/Exception:printStackTrace	()V
    //   236: goto -7 -> 229
    //   239: astore 5
    //   241: aconst_null
    //   242: astore_3
  ...
  public static String getCpuName()
  {
    ...
    //   3: dup
    //   4: new 336	java/io/FileReader
    //   7: dup
    //   8: ldc_w 338
    //   11: invokespecial 339	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   14: invokespecial 342	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   17: astore_1
    //   18: aload_1
    //   19: astore_0
    //   20: aload_1
    //   21: invokevirtual 345	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   24: astore_2
    //   25: aload_2
    //   26: ifnull +106 -> 132
    //   29: aload_1
    ...
    //   32: ldc_w 347
    //   35: iconst_2
    //   36: invokevirtual 351	java/lang/String:split	(Ljava/lang/String;I)[Ljava/lang/String;
    //   39: astore_3
    //   40: aload_1
    //   41: astore_0
    //   42: aload_3
    ...
    //   51: iconst_0
    //   52: aaload
    //   53: invokevirtual 354	java/lang/String:trim	()Ljava/lang/String;
    //   56: invokevirtual 357	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   59: ldc_w 359
    //   62: invokevirtual 362	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   65: ifeq +57 -> 122
    //   68: aload_1
    //   69: astore_0
    //   70: getstatic 90	com/tencent/ttpic/baseutils/device/DeviceUtils:TAG	Ljava/lang/String;
    //   73: new 165	java/lang/StringBuilder
    //   76: dup
    //   77: invokespecial 166	java/lang/StringBuilder:<init>	()V
    //   80: ldc_w 364
    //   83: invokevirtual 170	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   86: aload_2
    //   87: invokevirtual 170	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   90: invokevirtual 175	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   93: invokestatic 369	com/tencent/ttpic/baseutils/log/LogUtils:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   96: aload_1
    //   97: astore_0
    //   98: aload_3
    //   99: iconst_1
    //   100: aaload
    //   101: invokevirtual 354	java/lang/String:trim	()Ljava/lang/String;
    //   104: astore_2
    //   105: aload_1
    //   106: ifnull +7 -> 113
    //   109: aload_1
    //   110: invokevirtual 370	java/io/BufferedReader:close	()V
    //   113: aload_2
    //   114: areturn
    //   115: astore_0
    //   116: aload_0
    //   117: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   120: aload_2
    //   121: areturn
    //   122: aload_1
    //   123: astore_0
    //   124: aload_1
    //   125: invokevirtual 345	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   128: astore_2
    //   129: goto -104 -> 25
    //   132: aload_1
    //   133: ifnull +7 -> 140
    //   136: aload_1
    //   137: invokevirtual 370	java/io/BufferedReader:close	()V
    //   140: ldc_w 324
    //   143: areturn
    //   144: astore_0
    //   145: aload_0
    //   146: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   149: goto -9 -> 140
    //   152: astore_2
    //   153: aconst_null
    //   154: astore_1
    ...
    //   156: astore_0
    //   157: aload_2
    //   158: invokevirtual 371	java/io/FileNotFoundException:printStackTrace	()V
    //   161: aload_1
    //   162: ifnull -22 -> 140
    //   165: aload_1
    //   166: invokevirtual 370	java/io/BufferedReader:close	()V
    //   169: goto -29 -> 140
    //   172: astore_0
    //   173: aload_0
    //   174: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   177: goto -37 -> 140
    //   180: astore_2
    //   181: aconst_null
    //   182: astore_1
    ...
    //   184: astore_0
    //   185: aload_2
    //   186: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   189: aload_1
    //   190: ifnull -50 -> 140
    //   193: aload_1
    //   194: invokevirtual 370	java/io/BufferedReader:close	()V
    //   197: goto -57 -> 140
    //   200: astore_0
    //   201: aload_0
    //   202: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   205: goto -65 -> 140
    //   208: astore_1
    //   209: aconst_null
    //   210: astore_0
    ...
    //   212: ifnull +7 -> 219
    //   215: aload_0
    //   216: invokevirtual 370	java/io/BufferedReader:close	()V
    //   219: aload_1
    //   220: athrow
    //   221: astore_0
    //   222: aload_0
    //   223: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   226: goto -7 -> 219
    //   229: astore_1
    //   230: goto -19 -> 211
    //   233: astore_2
  ...
  public static String getLocalIpAddress()
  {
    try
    {
      if (alkz.getNetworkInterfaces() != null)
      {
        Enumeration localEnumeration = alkz.getNetworkInterfaces();
  ...
  public static String getLocalRealIpAddress()
  {
    ...
    //   4: aconst_null
    //   5: astore_1
    //   6: invokestatic 594	alkz:getNetworkInterfaces	()Ljava/util/Enumeration;
    //   9: astore 6
    //   11: iconst_0
    //   12: istore_0
    //   13: aconst_null
    ...
    //   43: astore_3
    //   44: aload 6
    //   46: invokeinterface 602 1 0
    //   51: checkcast 604	java/net/NetworkInterface
    //   54: invokevirtual 607	java/net/NetworkInterface:getInetAddresses	()Ljava/util/Enumeration;
    //   57: astore 5
    //   59: aload_2
    //   60: astore 4
    //   62: aload_2
    ...
    //   78: astore_3
    //   79: aload 5
    //   81: invokeinterface 602 1 0
    //   86: checkcast 609	java/net/InetAddress
    //   89: astore 7
    //   91: aload_2
    //   92: astore 4
    //   94: aload_2
    //   95: astore_3
    //   96: aload 7
    //   98: invokevirtual 632	java/net/InetAddress:isSiteLocalAddress	()Z
    //   101: ifne +56 -> 157
    //   104: aload_2
    //   105: astore 4
    //   107: aload_2
    //   108: astore_3
    //   109: aload 7
    //   111: invokevirtual 612	java/net/InetAddress:isLoopbackAddress	()Z
    //   114: ifne +43 -> 157
    //   117: aload_2
    //   118: astore 4
    //   120: aload_2
    //   121: astore_3
    //   122: aload 7
    //   124: invokevirtual 617	java/net/InetAddress:getHostAddress	()Ljava/lang/String;
    //   127: ldc_w 634
    //   130: invokevirtual 637	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   133: iconst_m1
    ...
    //   141: astore_3
    //   142: aload 7
    //   144: invokevirtual 617	java/net/InetAddress:getHostAddress	()Ljava/lang/String;
    //   147: astore 5
    //   149: iconst_1
    //   150: istore_0
    //   151: aload 5
    ...
    //   161: astore_3
    //   162: aload 7
    //   164: invokevirtual 632	java/net/InetAddress:isSiteLocalAddress	()Z
    //   167: ifeq -108 -> 59
    //   170: aload_2
    //   171: astore 4
    //   173: aload_2
    //   174: astore_3
    //   175: aload 7
    //   177: invokevirtual 612	java/net/InetAddress:isLoopbackAddress	()Z
    //   180: ifne -121 -> 59
    //   183: aload_2
    //   184: astore 4
    //   186: aload_2
    //   187: astore_3
    //   188: aload 7
    //   190: invokevirtual 617	java/net/InetAddress:getHostAddress	()Ljava/lang/String;
    //   193: ldc_w 634
    //   196: invokevirtual 637	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   199: iconst_m1
    ...
    //   207: astore_3
    //   208: aload 7
    //   210: invokevirtual 617	java/net/InetAddress:getHostAddress	()Ljava/lang/String;
    //   213: astore_2
    //   214: goto -155 -> 59
    //   217: aload_1
    //   218: invokestatic 144	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   221: ifne +5 -> 226
    //   224: aload_1
    //   225: areturn
    //   226: invokestatic 639	com/tencent/ttpic/baseutils/device/DeviceUtils:getExternalLocalIpAddress	()Ljava/lang/String;
    //   229: astore_3
    //   230: aload_3
    //   231: astore_1
    //   232: aload_3
    //   233: invokestatic 144	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   236: ifeq -12 -> 224
    //   239: aload_2
    //   240: areturn
    //   241: astore 4
    ...
    //   244: astore_3
    //   245: aload 4
    //   247: invokevirtual 640	java/net/SocketException:printStackTrace	()V
    //   250: aload_2
    //   251: astore_1
    //   252: aload_2
    //   253: invokestatic 144	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   256: ifeq -32 -> 224
    //   259: invokestatic 639	com/tencent/ttpic/baseutils/device/DeviceUtils:getExternalLocalIpAddress	()Ljava/lang/String;
    //   262: astore_2
    //   263: aload_2
    //   264: astore_1
    //   265: aload_2
    //   266: invokestatic 144	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   269: ifeq -45 -> 224
    //   272: aload_3
    //   273: areturn
    //   274: astore_1
    ...
    //   282: astore_1
    //   283: aload_2
    //   284: invokestatic 144	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   287: ifeq -63 -> 224
    //   290: invokestatic 639	com/tencent/ttpic/baseutils/device/DeviceUtils:getExternalLocalIpAddress	()Ljava/lang/String;
    //   293: astore_2
    //   294: aload_2
    //   295: astore_1
    //   296: aload_2
    //   297: invokestatic 144	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   300: ifeq -76 -> 224
    //   303: aload_3
    //   304: areturn
    //   305: astore_2
  ...
  {
    // Byte code:
    //   0: getstatic 98	com/tencent/ttpic/baseutils/device/DeviceUtils:sMaxCpuFreq	J
    //   3: lconst_0
    //   4: lcmp
    //   5: ifle +7 -> 12
    //   8: getstatic 98	com/tencent/ttpic/baseutils/device/DeviceUtils:sMaxCpuFreq	J
    //   11: lreturn
    //   12: iconst_0
    //   13: istore_0
    //   14: iload_0
    //   15: invokestatic 656	com/tencent/ttpic/baseutils/device/DeviceUtils:getNumCores	()I
    //   18: if_icmpge +194 -> 212
    //   21: new 146	java/io/File
    //   24: dup
    //   25: new 165	java/lang/StringBuilder
    //   28: dup
    //   29: invokespecial 166	java/lang/StringBuilder:<init>	()V
    //   32: ldc_w 658
    //   35: invokevirtual 170	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   38: iload_0
    //   39: invokevirtual 562	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   42: ldc_w 660
    //   45: invokevirtual 170	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   48: invokevirtual 175	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   51: invokespecial 178	java/io/File:<init>	(Ljava/lang/String;)V
    //   54: astore_2
    //   55: aload_2
    //   56: invokevirtual 186	java/io/File:exists	()Z
    //   59: ifeq +214 -> 273
    //   62: sipush 128
    //   65: newarray byte
    //   67: astore_3
    //   68: new 662	java/io/FileInputStream
    //   71: dup
    //   72: aload_2
    //   73: invokespecial 665	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   76: astore_2
    //   77: aload_2
    //   78: aload_3
    //   79: invokevirtual 668	java/io/FileInputStream:read	([B)I
    //   82: pop
    //   83: iconst_0
    //   84: istore_1
    //   85: aload_3
    ...
    //   110: istore_1
    //   111: goto -26 -> 85
    //   114: new 151	java/lang/String
    //   117: dup
    //   118: aload_3
    //   119: iconst_0
    //   120: iload_1
    //   121: invokespecial 671	java/lang/String:<init>	([BII)V
    //   124: invokestatic 208	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   127: invokestatic 674	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   130: astore_3
    //   131: aload_3
    //   132: invokevirtual 677	java/lang/Integer:intValue	()I
    //   135: i2l
    //   136: getstatic 98	com/tencent/ttpic/baseutils/device/DeviceUtils:sMaxCpuFreq	J
    //   139: lcmp
    //   140: ifle +11 -> 151
    //   143: aload_3
    //   144: invokevirtual 677	java/lang/Integer:intValue	()I
    //   147: i2l
    //   148: putstatic 98	com/tencent/ttpic/baseutils/device/DeviceUtils:sMaxCpuFreq	J
    //   151: aload_2
    //   152: invokevirtual 678	java/io/FileInputStream:close	()V
    //   155: goto +118 -> 273
    //   158: astore_3
    //   159: aload_2
    //   160: invokevirtual 678	java/io/FileInputStream:close	()V
    //   163: goto +110 -> 273
    //   166: astore_2
    //   167: ldc2_w 679
    //   170: putstatic 98	com/tencent/ttpic/baseutils/device/DeviceUtils:sMaxCpuFreq	J
    //   173: ldc_w 682
    //   176: new 165	java/lang/StringBuilder
    //   179: dup
    //   180: invokespecial 166	java/lang/StringBuilder:<init>	()V
    //   183: ldc_w 684
    //   186: invokevirtual 170	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   189: getstatic 98	com/tencent/ttpic/baseutils/device/DeviceUtils:sMaxCpuFreq	J
    //   192: invokevirtual 547	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   195: invokevirtual 175	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   198: invokestatic 551	com/tencent/ttpic/baseutils/log/LogUtils:v	(Ljava/lang/String;Ljava/lang/String;)V
    //   201: getstatic 98	com/tencent/ttpic/baseutils/device/DeviceUtils:sMaxCpuFreq	J
    //   204: lreturn
    //   205: astore_3
    //   206: aload_2
    //   207: invokevirtual 678	java/io/FileInputStream:close	()V
    //   210: aload_3
    //   211: athrow
    //   212: getstatic 98	com/tencent/ttpic/baseutils/device/DeviceUtils:sMaxCpuFreq	J
    //   215: ldc2_w 679
    //   218: lcmp
    //   219: ifne -46 -> 173
    //   222: new 662	java/io/FileInputStream
    //   225: dup
    //   226: ldc_w 338
    //   229: invokespecial 685	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   232: astore_2
    //   233: ldc_w 687
    //   236: aload_2
    //   237: invokestatic 691	com/tencent/ttpic/baseutils/device/DeviceUtils:parseFileForValue	(Ljava/lang/String;Ljava/io/FileInputStream;)I
    //   240: sipush 1000
    //   243: imul
    //   244: istore_0
    //   245: iload_0
    //   246: i2l
    //   247: getstatic 98	com/tencent/ttpic/baseutils/device/DeviceUtils:sMaxCpuFreq	J
    //   250: lcmp
    //   251: ifle +8 -> 259
    //   254: iload_0
    //   255: i2l
    //   256: putstatic 98	com/tencent/ttpic/baseutils/device/DeviceUtils:sMaxCpuFreq	J
    //   259: aload_2
    //   260: invokevirtual 678	java/io/FileInputStream:close	()V
    //   263: goto -90 -> 173
    //   266: astore_3
    //   267: aload_2
    //   268: invokevirtual 678	java/io/FileInputStream:close	()V
    //   271: aload_3
    //   272: athrow
    //   273: iload_0
    //   274: iconst_1
  ...
  {
    // Byte code:
    //   0: getstatic 882	android/os/Build$VERSION:SDK_INT	I
    //   3: bipush 16
    //   5: if_icmplt +42 -> 47
    //   8: new 884	android/app/ActivityManager$MemoryInfo
    //   11: dup
    //   12: invokespecial 885	android/app/ActivityManager$MemoryInfo:<init>	()V
    //   15: astore 4
    //   17: aload_0
    //   18: ldc_w 386
    //   21: invokevirtual 392	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   24: checkcast 394	android/app/ActivityManager
    //   27: aload 4
    //   29: invokevirtual 888	android/app/ActivityManager:getMemoryInfo	(Landroid/app/ActivityManager$MemoryInfo;)V
    //   32: aload 4
    //   34: ifnull +9 -> 43
    //   37: aload 4
    //   39: getfield 891	android/app/ActivityManager$MemoryInfo:totalMem	J
    //   42: lreturn
    //   43: ldc2_w 679
    //   46: lreturn
    //   47: new 662	java/io/FileInputStream
    //   50: dup
    //   51: ldc_w 893
    //   54: invokespecial 685	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   57: astore_0
    //   58: ldc_w 895
    //   61: aload_0
    //   62: invokestatic 691	com/tencent/ttpic/baseutils/device/DeviceUtils:parseFileForValue	(Ljava/lang/String;Ljava/io/FileInputStream;)I
    //   65: istore_1
    //   66: iload_1
    //   67: i2l
    //   68: ldc2_w 804
    ...
    //   72: lstore_2
    //   73: aload_0
    //   74: invokevirtual 678	java/io/FileInputStream:close	()V
    //   77: lload_2
    //   78: lreturn
    //   79: astore_0
    //   80: lload_2
    ...
    //   82: astore 4
    //   84: aload_0
    //   85: invokevirtual 678	java/io/FileInputStream:close	()V
    //   88: aload 4
    //   90: athrow
    //   91: astore_0
    //   92: ldc2_w 679
