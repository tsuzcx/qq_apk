...
public final class DeviceAttrs
{
  ...
  private JsonObject parseFastCaptureFile()
  {
    ...
    //   2: ldc_w 416
    //   5: astore 4
    //   7: getstatic 295	com/tencent/ttpic/baseutils/device/DeviceAttrs:PARSE_XML_DEBUG_MODE	Ljava/lang/Boolean;
    //   10: invokevirtual 422	java/lang/Boolean:booleanValue	()Z
    //   13: ifne +48 -> 61
    //   16: aload_0
    //   17: getfield 445	com/tencent/ttpic/baseutils/device/DeviceAttrs:mContext	Landroid/content/Context;
    //   20: ldc_w 915
    //   23: aload_0
    //   24: getfield 448	com/tencent/ttpic/baseutils/device/DeviceAttrs:mSignature	Ljava/lang/String;
    //   27: invokestatic 920	com/tencent/ttpic/baseutils/device/DeviceParser:parseFastCaptureFile	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   30: astore_1
    //   31: aload_1
    //   32: astore_2
    //   33: aconst_null
    ...
    //   38: ifnull +9 -> 47
    //   41: aload_1
    //   42: invokestatic 926	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   45: aload_2
    //   46: astore_3
    //   47: aload_3
    //   48: invokestatic 777	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   51: ifne +78 -> 129
    //   54: aload_3
    //   55: invokestatic 930	com/tencent/ttpic/util/GsonUtils:json2JsonObject	(Ljava/lang/String;)Lcom/google/gson/JsonObject;
    //   58: astore_1
    //   59: aload_1
    //   60: areturn
    //   61: aload_0
    //   62: getfield 445	com/tencent/ttpic/baseutils/device/DeviceAttrs:mContext	Landroid/content/Context;
    //   65: invokevirtual 934	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   68: ldc_w 936
    //   71: invokevirtual 942	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   74: astore_1
    //   75: aload_1
    //   76: astore_2
    //   77: aload_1
    //   78: invokestatic 945	com/tencent/ttpic/baseutils/io/IOUtils:toString	(Ljava/io/InputStream;)Ljava/lang/String;
    //   81: astore_3
    //   82: aload_3
    //   83: astore_2
    //   84: goto -49 -> 35
    ...
    //   91: astore_2
    //   92: aload_3
    //   93: invokestatic 883	com/tencent/ttpic/baseutils/log/LogUtils:e	(Ljava/lang/Throwable;)V
    //   96: aload 4
    //   98: astore_3
    //   99: aload_1
    //   100: ifnull -53 -> 47
    //   103: aload_1
    //   104: invokestatic 926	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   107: aload 4
    //   109: astore_3
    //   110: goto -63 -> 47
    //   113: astore_1
    ...
    //   115: ifnull +7 -> 122
    //   118: aload_2
    //   119: invokestatic 926	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   122: aload_1
    //   123: athrow
    //   124: astore_1
    //   125: aload_1
    //   126: invokevirtual 539	java/lang/Exception:printStackTrace	()V
    //   129: aconst_null
    //   130: areturn
    //   131: astore_1
    //   132: goto -18 -> 114
