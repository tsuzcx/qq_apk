...
public class TMSDKCustomConfig
{
  ...
  public IInstaller getCustomInstaller()
  {
    try
    {
      IInstaller localIInstaller = this.qe;
  ...
  public IThreadPoolManager getCustomThreadPool()
  {
    try
    {
      IThreadPoolManager localIThreadPoolManager = this.qg;
  ...
  public void onCustomReport(int paramInt1, int paramInt2)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 47	com/tencent/wifisdk/TMSDKCustomConfig:qh	Lcom/tencent/wifisdk/TMSDKCustomConfig$ICustomReporter;
    //   6: ifnull +12 -> 18
    //   9: aload_0
    //   10: getfield 49	com/tencent/wifisdk/TMSDKCustomConfig:qi	Landroid/util/SparseArray;
    //   13: astore_3
    //   14: aload_3
    //   15: ifnonnull +6 -> 21
    //   18: aload_0
    ...
    //   20: return
    //   21: aload_0
    //   22: getfield 49	com/tencent/wifisdk/TMSDKCustomConfig:qi	Landroid/util/SparseArray;
    //   25: iload_1
    //   26: invokevirtual 71	android/util/SparseArray:get	(I)Ljava/lang/Object;
    //   29: checkcast 73	java/lang/String
    //   32: astore_3
    //   33: aload_3
    //   34: invokestatic 79	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   37: ifne -19 -> 18
    //   40: aload_0
    //   41: getfield 47	com/tencent/wifisdk/TMSDKCustomConfig:qh	Lcom/tencent/wifisdk/TMSDKCustomConfig$ICustomReporter;
    //   44: aload_3
    //   45: iload_2
    //   46: invokeinterface 83 3 0
    //   51: goto -33 -> 18
    //   54: astore_3
    //   55: aload_0
    //   56: monitorexit
  ...
  public TMSDKCustomConfig setCustomInstaller(IInstaller paramIInstaller)
  {
    try
    {
  ...
  public TMSDKCustomConfig setCustomReporter(ICustomReporter paramICustomReporter)
  {
    try
    {
  ...
  public TMSDKCustomConfig setCustomThreadPool(IThreadPoolManager paramIThreadPoolManager)
  {
    try
    {
  ...
  public TMSDKCustomConfig setCustomToast(IToast paramIToast)
  {
    try
    {
      this.qf = paramIToast;
  ...
  public static abstract interface ICustomReporter
  {
    public abstract void reportAction(String paramString, int paramInt);
  }
  
  public static abstract interface IInstaller
  {
    public abstract boolean installApp(Context paramContext, String paramString);
  }
  
  public static abstract interface IThreadPoolManager
  {
  ...
  public static abstract interface IToast
  {
