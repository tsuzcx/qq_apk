  ...
  implements TAVVideoMixEffect
{
  ...
  public TAVVideoMixEffect.Filter createFilter()
  {
    ...
    {
      this.count += 1;
      return new StickerVideoCompositionMixerEffect(this.stickerContext, null);
    }
    return new StickerVideoCompositionMixerEffect(this.stickerContext.copy(), null);
  }
  ...
  class StickerVideoCompositionMixerEffect
    implements TAVVideoMixEffect.Filter, IReportable
  {
    ...
    private StickerVideoCompositionMixerEffect(TAVStickerRenderContext paramTAVStickerRenderContext)
    {
      this.stickerContext = paramTAVStickerRenderContext;
    }
      ...
      if (this.stickerContext != null) {
        synchronized (this.stickerContext.getStickers())
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            {
              localObject1 = TAVBigStickerOverlayEffect.this.reportKey;
              return localObject1;
            }
          }
        }
