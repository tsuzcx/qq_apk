  ...
  extends PublicBaseFragment
{
  ...
  public static void start(Activity paramActivity, Class<? extends GdtCanvasBaseFragment> paramClass, AdCanvasData paramAdCanvasData, Bundle paramBundle)
  {
    ...
    {
      tkw.i("GdtCanvasBaseFragment", "start error");
      return;
    }
    tkw.i("GdtCanvasBaseFragment", "start");
    ...
    if (TextUtils.isEmpty(paramAdCanvasData.getStringExtra("big_brother_ref_source_key"))) {
      tkw.e("GdtCanvasBaseFragment", "start gdt empty refId");
    }
    ...
    if (!TextUtils.isEmpty(paramBundle)) {
      paramAdCanvasData.putExtra("from_process_name", paramBundle);
    }
    PublicFragmentActivity.start(paramActivity, paramAdCanvasData, paramClass);
  }
