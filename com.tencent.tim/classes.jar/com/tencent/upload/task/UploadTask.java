  ...
  implements IUploadSession.RequestListener
{
  ...
  private boolean multiThreadSendFilePkg()
  {
    ...
    while (i < k)
    {
      ...
      if (localObject != null)
      {
        localObject = new UploadThread(this.mAtomFile, (IUploadSession)localObject);
        this.mMultiThreads.add(localObject);
        ((UploadThread)localObject).tFuture = UploadThreadManager.getInstance().getDataThreadPool().submit((Runnable)localObject);
      }
      i += 1;
    }
    return true;
  ...
  {
    boolean bool = paramIActionRequest.getTag() instanceof UploadThread;
    if (bool) {}
    for (String str = ((UploadThread)paramIActionRequest.getTag()).tTAG;; str = "")
    {
      ...
      do
      {
        do
        {
          ...
          for (String str = ((UploadThread)paramIActionRequest.getTag()).tTAG;; str = "")
          {
            ...
            ((UploadThread)paramIActionRequest.getTag()).notifySendend();
            return;
          }
  ...
  {
    String str;
    if ((paramIActionRequest.getTag() instanceof UploadThread))
    {
      str = ((UploadThread)paramIActionRequest.getTag()).tTAG;
  ...
  protected void quitMultiThreadUpload()
  {
    synchronized (this.mMultiThreads)
    {
      ...
      {
        UploadThread localUploadThread = (UploadThread)localIterator.next();
    ...
    implements Runnable
  {
    ...
    public UploadThread(AtomFile paramAtomFile, IUploadSession paramIUploadSession)
    {
    ...
    private void terminate()
    {
      ...
      //   1: monitorenter
      //   2: aload_0
      //   3: getfield 78	com/tencent/upload/task/UploadTask$UploadThread:tFinish	Z
      //   6: istore_1
      //   7: iload_1
      //   8: ifeq +6 -> 14
      //   11: aload_0
      ...
      //   14: aload_0
      //   15: iconst_1
      //   16: putfield 78	com/tencent/upload/task/UploadTask$UploadThread:tFinish	Z
      //   19: aload_0
    ...
    private void terminateWithRetry()
    {
      try
      {
        ...
        terminate();
        UploadTask localUploadTask = UploadTask.this;
    ...
    public void run()
    {
      ...
      for (;;)
      {
        ...
        {
          FileUploadRequest localFileUploadRequest = UploadTask.this.getFileUploadRequest(this.tFile);
          if (localFileUploadRequest != null)
          {
            UploadTask.this.mFileSendOffset = (localFileUploadRequest.mOffset + localFileUploadRequest.getRealDataSize());
            UploadTask.this.mLastSliceSize = localFileUploadRequest.getRealDataSize();
            UploadTask.this.mLastSendOffset = localFileUploadRequest.mOffset;
        ...
        this.tWaitFlag = true;
        boolean bool = this.tSession.send(localIActionRequest, UploadTask.this);
        ...
        for (;;)
        {
          ...
          {
            UploadLog.e("[transfer] UploadTask", this.tTAG + "run tFinish: " + this.tFinish + " mFinish: " + UploadTask.this.mFinish, localException);
            continue;
          }
          try
          {
