...
public class SessionDbHelper
{
  ...
  public void insert(long paramLong, String paramString1, String paramString2)
  {
    ...
    //   0: aconst_null
    //   1: astore 7
    //   3: new 123	android/content/ContentValues
    //   6: dup
    //   7: invokespecial 124	android/content/ContentValues:<init>	()V
    //   10: astore 10
    //   12: invokestatic 130	java/lang/System:currentTimeMillis	()J
    //   15: lstore 5
    //   17: aload 10
    //   19: ldc 33
    //   21: lload_1
    //   22: invokestatic 134	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   25: invokevirtual 138	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   28: aload 10
    //   30: ldc 20
    //   32: aload_3
    //   33: invokevirtual 140	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   36: aload 10
    //   38: ldc 26
    //   40: aload 4
    //   42: invokevirtual 140	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   45: aload 10
    //   47: ldc 23
    //   49: lload 5
    //   51: invokestatic 134	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   54: invokevirtual 138	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   57: aload_0
    //   58: getfield 63	com/tencent/upload/network/session/cache/SessionDbHelper:mOpenHelper	Lcom/tencent/upload/network/session/cache/SessionDbHelper$DatabaseHelper;
    //   61: invokevirtual 78	com/tencent/upload/network/session/cache/SessionDbHelper$DatabaseHelper:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   64: astore 9
    //   66: aload 9
    //   68: astore 7
    //   70: aload 9
    ...
    //   78: aconst_null
    //   79: aload 10
    //   81: invokevirtual 143	android/database/sqlite/SQLiteDatabase:insert	(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    //   84: pop2
    //   85: aload 9
    //   87: ifnull +16 -> 103
    //   90: aload 9
    //   92: invokevirtual 90	android/database/sqlite/SQLiteDatabase:isOpen	()Z
    //   95: ifeq +8 -> 103
    //   98: aload 9
    //   100: invokevirtual 93	android/database/sqlite/SQLiteDatabase:close	()V
    //   103: return
    //   104: astore 8
    //   106: aload 7
    //   108: astore 8
    ...
    //   141: invokestatic 112	com/tencent/upload/utils/UploadLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   144: aload 7
    //   146: ifnull -43 -> 103
    //   149: aload 7
    //   151: invokevirtual 90	android/database/sqlite/SQLiteDatabase:isOpen	()Z
    //   154: ifeq -51 -> 103
    //   157: aload 7
    //   159: invokevirtual 93	android/database/sqlite/SQLiteDatabase:close	()V
    //   162: return
    //   163: astore_3
    //   164: aconst_null
    //   165: astore 8
    ...
    //   169: ifnull +16 -> 185
    //   172: aload 8
    //   174: invokevirtual 90	android/database/sqlite/SQLiteDatabase:isOpen	()Z
    //   177: ifeq +8 -> 185
    //   180: aload 8
  ...
  public String query(long paramLong, String paramString)
  {
    // Byte code:
    //   0: lload_1
    //   1: invokestatic 74	java/lang/Long:toString	(J)Ljava/lang/String;
    //   4: astore 5
    //   6: aload_0
    //   7: getfield 63	com/tencent/upload/network/session/cache/SessionDbHelper:mOpenHelper	Lcom/tencent/upload/network/session/cache/SessionDbHelper$DatabaseHelper;
    //   10: invokevirtual 78	com/tencent/upload/network/session/cache/SessionDbHelper$DatabaseHelper:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   13: astore 4
    //   15: aload 4
    //   17: ldc 26
    //   19: getstatic 47	com/tencent/upload/network/session/cache/SessionDbHelper:columns	[Ljava/lang/String;
    //   22: ldc 116
    //   24: iconst_2
    ...
    //   38: aconst_null
    //   39: aconst_null
    //   40: invokevirtual 150	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   43: astore 5
    //   45: aload 5
    //   47: ifnull +227 -> 274
    //   50: aload 5
    //   52: invokeinterface 155 1 0
    //   57: ifeq +217 -> 274
    //   60: aload 5
    //   62: aload 5
    //   64: ldc 26
    //   66: invokeinterface 159 2 0
    //   71: invokeinterface 163 2 0
    //   76: astore_3
    //   77: aload 4
    //   79: ifnull +16 -> 95
    //   82: aload 4
    //   84: invokevirtual 90	android/database/sqlite/SQLiteDatabase:isOpen	()Z
    //   87: ifeq +8 -> 95
    //   90: aload 4
    //   92: invokevirtual 93	android/database/sqlite/SQLiteDatabase:close	()V
    //   95: aload 5
    //   97: ifnull +175 -> 272
    //   100: aload 5
    ...
    //   140: aload_3
    //   141: invokevirtual 105	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   150: invokestatic 112	com/tencent/upload/utils/UploadLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   153: aload 4
    //   155: ifnull +16 -> 171
    //   158: aload 4
    //   160: invokevirtual 90	android/database/sqlite/SQLiteDatabase:isOpen	()Z
    //   163: ifeq +8 -> 171
    //   166: aload 4
    //   168: invokevirtual 93	android/database/sqlite/SQLiteDatabase:close	()V
    //   171: aload 5
    //   173: ifnull +97 -> 270
    //   176: aload 5
    //   178: invokeinterface 166 1 0
    //   183: ifne +87 -> 270
    //   186: aload 5
    ...
    //   204: ifnull +16 -> 220
    //   207: aload 4
    //   209: invokevirtual 90	android/database/sqlite/SQLiteDatabase:isOpen	()Z
    //   212: ifeq +8 -> 220
    //   215: aload 4
    //   217: invokevirtual 93	android/database/sqlite/SQLiteDatabase:close	()V
    //   220: aload 5
    //   222: ifnull +20 -> 242
    //   225: aload 5
