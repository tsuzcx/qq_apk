  ...
  implements IConnectionCallback, IUploadSession
{
  ...
  private void doCleanup(int paramInt)
  {
    ...
    if (paramInt < this.mSendingMap.size())
    {
      ...
      localObject = (RequestWrapper)this.mTimeoutMap.get(j);
      if ((localObject != null) && (((RequestWrapper)localObject).request != null)) {}
      for (;;)
      {
        paramInt += 1;
        break;
    ...
    if (paramInt < this.mTimeoutMap.size())
    {
      ...
      localObject = (RequestWrapper)this.mTimeoutMap.get(i);
      if (localObject != null) {}
      for (localObject = ((RequestWrapper)localObject).request;; localObject = null)
      {
        if ((localObject != null) && (((IActionRequest)localObject).getListener() != null)) {
          ((IActionRequest)localObject).getListener().onRequestError((IActionRequest)localObject, localUploadRetCode, this);
        }
  ...
  private void doClearAllTimeout()
  {
    ...
    if (i < this.mTimeoutMap.size())
    {
      ...
      RequestWrapper localRequestWrapper = (RequestWrapper)this.mTimeoutMap.get(j);
  ...
  private void doDeleteTimeout(UploadResponse paramUploadResponse)
  {
    ...
    do
    {
      ...
      localRequestWrapper = (RequestWrapper)paramUploadResponse.get(i);
  ...
  private void doHandleResponse(RequestWrapper paramRequestWrapper, UploadResponse paramUploadResponse)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (Exception paramArrayOfByte)
        {
          ...
          paramArrayOfByte = (RequestWrapper)this.mTimeoutMap.get(((UploadResponse)localObject).getRequestSequence());
          if (paramArrayOfByte == null) {
            break label308;
          }
  ...
  private void doStartTimeout(IActionRequest paramIActionRequest)
  {
    ...
    if ((RequestWrapper)this.mTimeoutMap.get(i) != null)
    {
      UploadLog.w("UploadSession", "timeout runnable has been started. reqId=" + i + " sid=" + this.mId);
      return;
    }
    RequestWrapper localRequestWrapper = new RequestWrapper(paramIActionRequest);
  ...
  private void setSessionState(IUploadSession.SessionState paramSessionState)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 102	com/tencent/upload/network/session/UploadSession:mSessionState	Lcom/tencent/upload/network/session/IUploadSession$SessionState;
    //   6: astore_2
    //   7: aload_2
    //   8: aload_1
    //   9: if_acmpne +6 -> 15
    ...
    //   14: return
    //   15: ldc 18
    //   17: new 173	java/lang/StringBuilder
    //   20: dup
    //   21: invokespecial 174	java/lang/StringBuilder:<init>	()V
    //   24: ldc_w 533
    //   27: invokevirtual 180	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   30: aload_0
    //   31: getfield 68	com/tencent/upload/network/session/UploadSession:mId	Ljava/lang/String;
    //   34: invokevirtual 180	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   37: ldc_w 428
    //   40: invokevirtual 180	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   43: aload_0
    //   44: getfield 102	com/tencent/upload/network/session/UploadSession:mSessionState	Lcom/tencent/upload/network/session/IUploadSession$SessionState;
    //   47: invokevirtual 328	com/tencent/upload/network/session/IUploadSession$SessionState:toString	()Ljava/lang/String;
    ...
    //   59: aload_1
    //   60: invokevirtual 328	com/tencent/upload/network/session/IUploadSession$SessionState:toString	()Ljava/lang/String;
    //   63: invokevirtual 180	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   66: invokevirtual 184	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   69: invokestatic 190	com/tencent/upload/utils/UploadLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   72: aload_0
    //   73: aload_1
    //   74: putfield 102	com/tencent/upload/network/session/UploadSession:mSessionState	Lcom/tencent/upload/network/session/IUploadSession$SessionState;
    //   77: goto -65 -> 12
    //   80: astore_1
    //   81: aload_0
    //   82: monitorexit
  ...
  public void cancel(int paramInt)
  {
    ...
    if (i < k)
    {
      localObject2 = (RequestWrapper)this.mTimeoutMap.valueAt(i);
      if ((localObject2 == null) || (((RequestWrapper)localObject2).request.getTaskId() != paramInt)) {}
      for (;;)
      {
        i += 1;
        break;
        ...
        UploadLog.d("UploadSession", this.mId + " cancel: mTimeoutMap remove runnable reqSeq:" + j + " actSeq:" + ((RequestWrapper)localObject2).request.getTaskId());
        this.mHandler.removeCallbacks(((RequestWrapper)localObject2).runnable);
        ((RequestWrapper)localObject2).runnable = null;
      }
    }
    while (((LinkedList)localObject1).size() > 0) {
  ...
  static final class RequestWrapper
  {
    ...
    public RequestWrapper(IActionRequest paramIActionRequest)
    {
