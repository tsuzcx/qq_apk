  ...
  extends UploadTask
{
  ...
  public com.tencent.upload.request.impl.FileUploadRequest getFileUploadRequest(com.tencent.upload.task.AtomFile paramAtomFile)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 343	com/tencent/upload/uinterface/AbstractUploadTask:mSliceSize	I
    //   4: ifle +68 -> 72
    //   7: aload_0
    //   8: getfield 343	com/tencent/upload/uinterface/AbstractUploadTask:mSliceSize	I
    //   11: istore_2
    //   12: aload_0
    //   13: iload_2
    //   14: putfield 343	com/tencent/upload/uinterface/AbstractUploadTask:mSliceSize	I
    //   17: aconst_null
    //   18: astore 5
    //   20: aload_1
    //   21: monitorenter
    //   22: aload_1
    //   23: invokevirtual 348	com/tencent/upload/task/AtomFile:getRemainSize	()J
    //   26: lstore_3
    //   27: lload_3
    //   28: lconst_0
    //   29: lcmp
    //   30: ifgt +50 -> 80
    //   33: ldc 17
    //   35: new 225	java/lang/StringBuilder
    //   38: dup
    ...
    //   48: aload_0
    //   49: getfield 189	com/tencent/upload/uinterface/AbstractUploadTask:flowId	I
    //   52: invokevirtual 353	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   55: ldc_w 355
    //   58: invokevirtual 233	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   61: invokevirtual 241	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   64: invokestatic 358	com/tencent/upload/utils/UploadLog:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   67: aload_1
    //   68: monitorexit
    //   69: aload 5
    //   71: areturn
    //   72: aload_0
    //   73: invokevirtual 360	com/tencent/upload/uinterface/AbstractUploadTask:getBucketSize	()I
    //   76: istore_2
    //   77: goto -65 -> 12
    //   80: lload_3
    //   81: aload_0
    //   82: getfield 343	com/tencent/upload/uinterface/AbstractUploadTask:mSliceSize	I
    //   85: i2l
    //   86: invokestatic 366	java/lang/Math:min	(JJ)J
    //   89: lstore_3
    //   90: new 368	com/tencent/upload/request/impl/FileUploadRequest
    //   93: dup
    //   94: aload_0
    //   95: getfield 152	com/tencent/upload/uinterface/AbstractUploadTask:mDataSource	Lcom/tencent/upload/task/data/UploadDataSource;
    //   98: new 225	java/lang/StringBuilder
    //   101: dup
    //   102: invokespecial 227	java/lang/StringBuilder:<init>	()V
    //   105: aload_0
    //   106: getfield 87	com/tencent/upload/uinterface/AbstractUploadTask:iUin	J
    //   109: invokevirtual 295	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   112: ldc 83
    //   114: invokevirtual 233	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   117: invokevirtual 241	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   120: aload_0
    //   121: getfield 203	com/tencent/upload/uinterface/AbstractUploadTask:mAppid	Ljava/lang/String;
    //   124: aload_0
    //   125: getfield 298	com/tencent/upload/uinterface/AbstractUploadTask:mSessionId	Ljava/lang/String;
    //   128: aload_1
    //   129: lload_3
    //   130: invokevirtual 372	com/tencent/upload/task/AtomFile:reduce	(J)J
    //   133: lload_3
    //   134: aload_0
    //   135: getfield 216	com/tencent/upload/uinterface/AbstractUploadTask:mCheckType	LSLICE_UPLOAD/CheckType;
    //   138: iconst_0
    //   139: invokespecial 375	com/tencent/upload/request/impl/FileUploadRequest:<init>	(Lcom/tencent/upload/task/data/UploadDataSource;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JJLSLICE_UPLOAD/CheckType;Z)V
    //   142: astore 5
    //   144: aload 5
    //   146: aload_0
    //   147: getfield 189	com/tencent/upload/uinterface/AbstractUploadTask:flowId	I
    //   150: invokevirtual 376	com/tencent/upload/request/impl/FileUploadRequest:setTaskId	(I)V
    //   153: goto -86 -> 67
    //   156: astore 5
    //   158: aload_1
    //   159: monitorexit
