...
public class TAVCut
{
  ...
  public static void initTAVCut(Context paramContext, Callback paramCallback)
  {
    initTAVCut(paramContext, "", "", paramCallback);
  }
  
  public static void initTAVCut(Context paramContext, String paramString1, String paramString2, Callback paramCallback)
  {
    try
    {
  ...
  {
    public abstract void onDone(int paramInt);
  }
}
