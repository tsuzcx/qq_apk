...
class TAVCutSession$7
  implements Runnable
{
  TAVCutSession$7(TAVCutSession paramTAVCutSession, MediaModel paramMediaModel, float paramFloat, long paramLong1, long paramLong2, VideoRenderChainManager paramVideoRenderChainManager) {}
  ...
  public void run()
  {
    ...
    localAEKitModel1.setGlowAlpha(this.val$alpha);
