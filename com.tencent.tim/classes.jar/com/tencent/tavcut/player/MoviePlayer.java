  ...
  implements IPlayer.PlayerListener
{
  ...
  private void onPlayerDestroy()
  {
    ...
    while (localIterator.hasNext()) {
      ((OnPlayerLifeCycleListener)localIterator.next()).onPlayerDestroy();
    }
  }
  ...
  private void onPlayerItemChanged()
  {
    Iterator localIterator = this.playerLifeCycleListeners.iterator();
    while (localIterator.hasNext()) {
      ((OnPlayerLifeCycleListener)localIterator.next()).onPlayerItemChanged();
    }
  }
  ...
  private void onPlayerReady()
  {
    Iterator localIterator = this.playerLifeCycleListeners.iterator();
    while (localIterator.hasNext()) {
      ((OnPlayerLifeCycleListener)localIterator.next()).onPlayerReady();
    }
  }
  ...
  public void addOnPlayerLifeCycleListener(OnPlayerLifeCycleListener paramOnPlayerLifeCycleListener)
  {
  ...
  public IPlayer.PlayerStatus getCurrentStatus()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 183	com/tencent/tavcut/player/MoviePlayer:player	Lcom/tencent/tav/player/Player;
    //   6: ifnonnull +11 -> 17
    //   9: getstatic 451	com/tencent/tav/player/IPlayer$PlayerStatus:ERROR	Lcom/tencent/tav/player/IPlayer$PlayerStatus;
    //   12: astore_1
    //   13: aload_0
    //   14: monitorexit
    //   15: aload_1
    //   16: areturn
    //   17: aload_0
    //   18: getfield 183	com/tencent/tavcut/player/MoviePlayer:player	Lcom/tencent/tav/player/Player;
    //   21: invokevirtual 454	com/tencent/tav/player/Player:currentStatus	()Lcom/tencent/tav/player/IPlayer$PlayerStatus;
    //   24: astore_1
    //   25: goto -12 -> 13
    //   28: astore_1
    //   29: aload_0
  ...
  public CMTime getPosition()
  {
    ...
    //   6: ifnull +15 -> 21
    //   9: aload_0
    //   10: getfield 183	com/tencent/tavcut/player/MoviePlayer:player	Lcom/tencent/tav/player/Player;
    //   13: invokevirtual 468	com/tencent/tav/player/Player:position	()Lcom/tencent/tav/coremedia/CMTime;
    //   16: astore_1
    //   17: aload_0
    //   18: monitorexit
    //   19: aload_1
    //   20: areturn
    //   21: getstatic 462	com/tencent/tav/coremedia/CMTime:CMTimeInvalid	Lcom/tencent/tav/coremedia/CMTime;
    //   24: astore_1
    //   25: goto -8 -> 17
    //   28: astore_1
    //   29: aload_0
  ...
  public boolean isPlaying()
  {
    ...
    //   6: ifnull +48 -> 54
    //   9: aload_0
    //   10: getfield 87	com/tencent/tavcut/player/MoviePlayer:TAG	Ljava/lang/String;
    ...
    //   26: aload_0
    //   27: getfield 183	com/tencent/tavcut/player/MoviePlayer:player	Lcom/tencent/tav/player/Player;
    //   30: invokevirtual 481	com/tencent/tav/player/Player:isPlaying	()Z
    //   33: invokevirtual 247	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   36: invokevirtual 85	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   39: invokestatic 199	com/tencent/tavcut/util/Logger:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   42: aload_0
    //   43: getfield 183	com/tencent/tavcut/player/MoviePlayer:player	Lcom/tencent/tav/player/Player;
    //   46: invokevirtual 481	com/tencent/tav/player/Player:isPlaying	()Z
    //   49: istore_1
    //   50: aload_0
    //   51: monitorexit
    //   52: iload_1
  ...
  public boolean isReleased()
  {
    ...
    //   9: aload_0
    //   10: getfield 183	com/tencent/tavcut/player/MoviePlayer:player	Lcom/tencent/tav/player/Player;
    //   13: invokevirtual 484	com/tencent/tav/player/Player:isReleased	()Z
    //   16: istore_1
    //   17: iload_1
    //   18: ifeq +9 -> 27
    //   21: iconst_1
  ...
  public void pause()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 87	com/tencent/tavcut/player/MoviePlayer:TAG	Ljava/lang/String;
    //   6: new 64	java/lang/StringBuilder
    //   9: dup
    //   10: invokespecial 65	java/lang/StringBuilder:<init>	()V
    //   13: ldc_w 494
    //   16: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   19: aload_0
    //   20: getfield 183	com/tencent/tavcut/player/MoviePlayer:player	Lcom/tencent/tav/player/Player;
    //   23: invokevirtual 191	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   26: invokevirtual 85	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   29: invokestatic 199	com/tencent/tavcut/util/Logger:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   32: aload_0
    //   33: getfield 183	com/tencent/tavcut/player/MoviePlayer:player	Lcom/tencent/tav/player/Player;
    //   36: ifnull +17 -> 53
    //   39: aload_0
    //   40: invokespecial 496	com/tencent/tavcut/player/MoviePlayer:abandonAudioFocus	()V
    //   43: aload_0
    //   44: getfield 183	com/tencent/tavcut/player/MoviePlayer:player	Lcom/tencent/tav/player/Player;
    //   47: invokevirtual 498	com/tencent/tav/player/Player:pause	()V
    //   50: aload_0
    //   51: monitorexit
    //   52: return
    //   53: aload_0
    //   54: iconst_0
    //   55: putfield 91	com/tencent/tavcut/player/MoviePlayer:isAutoPlay	Z
    //   58: goto -8 -> 50
    //   61: astore_1
    //   62: aload_0
    //   63: monitorexit
  ...
  public void play()
  {
    ...
    //   36: ifnull +20 -> 56
    //   39: aload_0
    //   40: invokespecial 301	com/tencent/tavcut/player/MoviePlayer:requestAudioFocus	()Z
    //   43: ifeq +10 -> 53
    //   46: aload_0
    //   47: getfield 183	com/tencent/tavcut/player/MoviePlayer:player	Lcom/tencent/tav/player/Player;
    //   50: invokevirtual 304	com/tencent/tav/player/Player:play	()V
    //   53: aload_0
    //   54: monitorexit
    //   55: return
    //   56: aload_0
    //   57: iconst_1
    //   58: putfield 91	com/tencent/tavcut/player/MoviePlayer:isAutoPlay	Z
    //   61: goto -8 -> 53
    //   64: astore_1
    //   65: aload_0
    //   66: monitorexit
  ...
  public void removeOnPlayerLifeCyclerListener(OnPlayerLifeCycleListener paramOnPlayerLifeCycleListener)
  {
    if (paramOnPlayerLifeCycleListener == null) {
      return;
    }
  ...
  public static abstract interface OnPlayerLifeCycleListener
  {
