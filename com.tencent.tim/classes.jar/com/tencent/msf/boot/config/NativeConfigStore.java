...
public class NativeConfigStore
{
  ...
  public static String getConfigIMEI()
  {
    try
    {
      String str = Pandora.getDeviceID(BaseApplication.getContext());
      return str;
    }
  ...
  public String[] n_getConfigList(String paramString)
  {
    ...
    //   6: invokevirtual 192	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   9: ifne +21 -> 30
    //   12: getstatic 20	com/tencent/msf/boot/config/NativeConfigStore:tag	Ljava/lang/String;
    //   15: iconst_1
    //   16: ldc 194
    //   18: invokestatic 196	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   21: iconst_0
    ...
    //   30: aload_0
    //   31: aload_1
    //   32: invokevirtual 198	com/tencent/msf/boot/config/NativeConfigStore:getConfigList	(Ljava/lang/String;)[Ljava/lang/String;
    //   35: astore_1
    //   36: goto -10 -> 26
    //   39: astore_1
    //   40: aload_0
  ...
  public void n_removeConfig(String paramString)
  {
    ...
    //   24: aload_0
    //   25: aload_1
    //   26: invokevirtual 203	com/tencent/msf/boot/config/NativeConfigStore:removeConfig	(Ljava/lang/String;)I
    //   29: pop
    //   30: goto -9 -> 21
    //   33: astore_1
    //   34: aload_0
  ...
  public void n_setConfig(String paramString1, String paramString2)
  {
    ...
    //   25: aload_1
    //   26: aload_2
    //   27: invokevirtual 208	com/tencent/msf/boot/config/NativeConfigStore:setConfig	(Ljava/lang/String;Ljava/lang/String;)I
    //   30: pop
    //   31: goto -10 -> 21
    //   34: astore_1
    //   35: aload_0
