  ...
  extends AbstractCursor
{
  ...
  {
    if ((this.mCursor == null) || (!(this.mCursor instanceof AbstractCursor))) {
      return null;
    }
    return ((AbstractCursor)this.mCursor).getDatabase();
  }
 ...
 * Qualified Name:     com.tencent.moai.database.sqlite.MergeCursor
