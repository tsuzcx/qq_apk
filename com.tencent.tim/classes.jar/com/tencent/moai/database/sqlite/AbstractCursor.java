  ...
  implements CrossProcessCursor
{
  ...
  {
    ExtraUtils.cursorFillWindow(this, paramInt, paramCursorWindow);
  }
  ...
  public int getColumnIndex(String paramString)
  {
    ...
    if (i != -1)
    {
      ...
      SQLiteDebug.Log.e("Cursor", "requesting column name with table name -- " + paramString, (Throwable)localObject);
  ...
  {
    return new Date(getLong(paramInt));
  }
 ...
 * Qualified Name:     com.tencent.moai.database.sqlite.AbstractCursor
