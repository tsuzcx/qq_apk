...
{
  public ItemCreateResponse(String paramString, HttpResponse paramHttpResponse)
  {
  ...
  public boolean parseResponse()
  {
    ...
    do
    {
      do
      {
        ...
        Node localNode = XmlDocumentHelper.getChildNodeByLocalName((Node)localObject, "CreateItemResponse");
        if (localNode == null)
        {
      ...
      localObject = XmlDocumentHelper.getChildNodesByLocalName((Node)localObject, "CreateItemResponseMessage");
    } while (localObject == null);
 ...
 * Qualified Name:     com.tencent.moai.mailsdk.protocol.exchange.response.ItemCreateResponse
