  ...
  extends ExchangeResponse
{
  ...
  public FolderCreateResponse(String paramString, HttpResponse paramHttpResponse)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            Node localNode = XmlDocumentHelper.getChildNodeByLocalName((Node)localObject, "CreateFolderResponse");
            if (localNode == null)
            {
          ...
          localObject = XmlDocumentHelper.getChildNodeByLocalName((Node)localObject, "CreateFolderResponseMessage");
        } while (localObject == null);
 ...
 * Qualified Name:     com.tencent.moai.mailsdk.protocol.exchange.response.FolderCreateResponse
