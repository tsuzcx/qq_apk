  ...
  extends ExchangeResponse
{
  ...
  public GetFolderResponse(String paramString, HttpResponse paramHttpResponse)
  {
  ...
  public boolean parseResponse()
  {
    ...
    do
    {
      ...
      localObject = XmlDocumentHelper.getChildNodeByLocalName((Node)localObject, "Folder");
    } while (localObject == null);
    this.folder = ExchangeXmlParser.getFolder((Node)localObject);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.moai.mailsdk.protocol.exchange.response.GetFolderResponse
