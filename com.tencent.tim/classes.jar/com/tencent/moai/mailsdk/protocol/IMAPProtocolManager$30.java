...
class IMAPProtocolManager$30
  implements TaskCallBack
{
  IMAPProtocolManager$30(IMAPProtocolManager paramIMAPProtocolManager, Profile paramProfile, MailOperationCallback paramMailOperationCallback) {}
  ...
  public void onError(Throwable paramThrowable)
  {
    if ((paramThrowable instanceof MessageException))
    {
      ...
      Logger.log(6, "IMAPProtocolManager", "move mail error:" + paramThrowable.getResultCode() + ":" + paramThrowable.getDetailCode() + ":" + paramThrowable.getDetailMessage());
 ...
 * Qualified Name:     com.tencent.moai.mailsdk.protocol.IMAPProtocolManager.30
