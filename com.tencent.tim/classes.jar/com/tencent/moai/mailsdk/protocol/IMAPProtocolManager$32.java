...
class IMAPProtocolManager$32
  implements TaskCallBack
{
  IMAPProtocolManager$32(IMAPProtocolManager paramIMAPProtocolManager, Profile paramProfile, MailOperationCallback paramMailOperationCallback) {}
  ...
  public void onError(Throwable paramThrowable)
  {
    if ((paramThrowable instanceof MessageException))
    {
      ...
      Logger.log(6, "IMAPProtocolManager", "modify mail flag error:" + paramThrowable.getResultCode() + ":" + paramThrowable.getDetailCode() + ":" + paramThrowable.getDetailMessage());
 ...
 * Qualified Name:     com.tencent.moai.mailsdk.protocol.IMAPProtocolManager.32
