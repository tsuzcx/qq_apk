...
class IMAPProtocolManager$23
  implements TaskCallBack
{
  IMAPProtocolManager$23(IMAPProtocolManager paramIMAPProtocolManager, Profile paramProfile, MailAbstractCallBack paramMailAbstractCallBack) {}
  ...
  public void onError(Throwable paramThrowable)
  {
    if ((paramThrowable instanceof MessageException))
    {
      ...
      Logger.log(6, "IMAPProtocolManager", "download mail abstract error:" + paramThrowable.getResultCode() + ":" + paramThrowable.getDetailCode() + ":" + paramThrowable.getDetailMessage());
 ...
 * Qualified Name:     com.tencent.moai.mailsdk.protocol.IMAPProtocolManager.23
