...
class IMAPProtocolManager$12
  implements TaskCallBack
{
  IMAPProtocolManager$12(IMAPProtocolManager paramIMAPProtocolManager, Profile paramProfile, MailListCallBack paramMailListCallBack) {}
  ...
  public void onError(Throwable paramThrowable)
  {
    if ((paramThrowable instanceof MessageException))
    {
      ...
      Logger.log(6, "IMAPProtocolManager", "fetch mail list error:" + paramThrowable.getResultCode() + ":" + paramThrowable.getDetailCode() + ":" + paramThrowable.getDetailMessage());
 ...
 * Qualified Name:     com.tencent.moai.mailsdk.protocol.IMAPProtocolManager.12
