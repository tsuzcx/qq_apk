...
class IMAPProtocolManager$25
  implements TaskCallBack
{
  IMAPProtocolManager$25(IMAPProtocolManager paramIMAPProtocolManager, Profile paramProfile, AttachmentCallBack paramAttachmentCallBack) {}
  ...
  public void onError(Throwable paramThrowable)
  {
    if ((paramThrowable instanceof MessageException))
    {
      ...
      Logger.log(6, "IMAPProtocolManager", "download attachment error:" + paramThrowable.getResultCode() + ":" + paramThrowable.getDetailCode() + ":" + paramThrowable.getDetailMessage());
      ...
      if (this.val$attachmentCallBack != null) {
        this.val$attachmentCallBack.onError(paramThrowable.getResultCode(), paramThrowable.getDetailCode(), paramThrowable.getDetailMessage());
      }
    }
    do
    {
    ...
    this.val$attachmentCallBack.onError(1, 200001, paramThrowable.getMessage());
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.tim\classes7.jar
 * Qualified Name:     com.tencent.moai.mailsdk.protocol.IMAPProtocolManager.25
