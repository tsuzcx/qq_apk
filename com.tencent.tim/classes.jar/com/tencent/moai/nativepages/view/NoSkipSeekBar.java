  ...
  extends SeekBar
{
  ...
  private Rect boundCopy = new Rect();
  private int dragAreaOffset = 40;
  ...
  private boolean isWithinThumb(MotionEvent paramMotionEvent)
  {
    ...
    Rect localRect = getThumb().getBounds();
    this.boundCopy.left = (localRect.left - this.dragAreaOffset);
    this.boundCopy.right = (localRect.right + this.dragAreaOffset);
    this.boundCopy.top = (localRect.top - this.dragAreaOffset);
    this.boundCopy.bottom = (localRect.bottom + this.dragAreaOffset);
    return this.boundCopy.contains((int)paramMotionEvent.getX(), (int)paramMotionEvent.getY());
  }
 ...
 * Qualified Name:     com.tencent.moai.nativepages.view.NoSkipSeekBar
