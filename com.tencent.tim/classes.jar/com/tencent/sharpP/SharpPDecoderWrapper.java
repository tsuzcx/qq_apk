...
public class SharpPDecoderWrapper
{
  ...
  SharpPFeatureWrapper createSharpPFeatureWrapper()
  {
    SharpPDecoder localSharpPDecoder = this.mDecoder;
    localSharpPDecoder.getClass();
    return new SharpPFeatureWrapper(new SharpPDecoder.SharpPFeature(localSharpPDecoder));
  }
  ...
  public int decodeOneFrameInNative(long paramLong, int paramInt, Bitmap paramBitmap, WriteableInteger paramWriteableInteger)
  {
  ...
  public Bitmap decodeOneFrameWithAlphaInNative(long paramLong, int paramInt1, int paramInt2, int paramInt3, WriteableInteger paramWriteableInteger, Bitmap paramBitmap)
  {
  ...
  public static class SharpPFeatureWrapper
  {
    ...
    public SharpPFeatureWrapper(SharpPDecoder.SharpPFeature paramSharpPFeature)
    {
  ...
  public static class WriteableInteger
  {
    ...
    public WriteableInteger(int paramInt)
    {
