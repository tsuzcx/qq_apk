  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Map localMap = SuperPlayerSDKMgr.getGlobalReportMap();
    if (localMap != null) {
      this.val$copyMap.putAll(localMap);
    }
    LogUtil.d(".SPBeaconReporter", "report eventName=" + this.val$eventName + ", dataMap=" + this.val$copyMap);
