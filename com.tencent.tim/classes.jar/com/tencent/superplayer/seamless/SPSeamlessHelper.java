...
public class SPSeamlessHelper
{
  ...
  private void addSeamlessCallback(String paramString, SeamlessCallback paramSeamlessCallback)
  {
  ...
  private void onSeamlessExitEnd()
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((SeamlessCallback)((Iterator)localObject).next()).onSeamlessExitEnd("", "", null);
      }
    }
  ...
  public void attachThenDoAnimation(View paramView, ViewGroup paramViewGroup, SPSeamlessParam paramSPSeamlessParam, SceneTransformType paramSceneTransformType)
  {
    if ((this.mAnimActivity == null) || (this.mAnimActivity.get() == null)) {
      LogUtil.e("SPSeamlessHelper", "attachThenDoAnimation failed for mAnimActivity is null, mAnimActivityReference:" + this.mAnimActivity);
    }
    ViewGroup localViewGroup;
    do
    {
      return;
      localViewGroup = (ViewGroup)((Activity)this.mAnimActivity.get()).getWindow().getDecorView();
      if (paramSceneTransformType == SceneTransformType.Exit)
      {
    ...
    } while (paramSceneTransformType != SceneTransformType.EnterIn);
  ...
  @Deprecated
  public void enterScene(String paramString, ViewGroup paramViewGroup, ViewGroup.LayoutParams paramLayoutParams, SeamlessCallback paramSeamlessCallback)
  {
  ...
  public void enterSceneWithAnim(Activity paramActivity, String paramString, ViewGroup paramViewGroup, SPSeamlessParam paramSPSeamlessParam, SeamlessCallback paramSeamlessCallback)
  {
    if (paramSeamlessCallback != null) {
      addSeamlessCallback(paramString, paramSeamlessCallback);
    }
    ...
    this.mAnimActivity = new WeakReference(paramActivity);
    this.mJumpParentViewGroup = getParentView(paramString);
    attachThenDoAnimation(paramString, paramViewGroup, paramSPSeamlessParam, SceneTransformType.EnterIn);
  }
  
  public void exitScene(String paramString1, String paramString2, SPSeamlessParam paramSPSeamlessParam, SeamlessCallback paramSeamlessCallback)
  {
    if (paramSeamlessCallback != null) {
    ...
    for (;;)
    {
      ...
      return;
      if (bool) {
        attachThenDoAnimation(paramSeamlessCallback, this.mJumpParentViewGroup, paramSPSeamlessParam, SceneTransformType.Exit);
      } else {
  ...
  public void jumpScene(Activity paramActivity, String paramString, SeamlessCallback paramSeamlessCallback)
  {
  ...
  @Deprecated
  public void jumpScene(String paramString, SeamlessCallback paramSeamlessCallback)
  {
    if (paramSeamlessCallback != null) {
      addSeamlessCallback(paramString, paramSeamlessCallback);
    }
    ...
    if (paramSeamlessCallback != null)
    {
      ...
      while (paramSeamlessCallback.hasNext()) {
        ((SeamlessCallback)paramSeamlessCallback.next()).onSeamlessJump(paramString);
      }
    }
  }
  
  public static enum SceneTransformType
  {
    EnterIn,  Exit;
    
    private SceneTransformType() {}
  }
  
  public static abstract interface SeamlessCallback
  {
