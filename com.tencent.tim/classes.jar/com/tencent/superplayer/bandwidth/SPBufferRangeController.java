  ...
  implements ISPBufferRangeController, Comparator<Integer[]>
{
  ...
  private int judgeStrategy(List<Integer[]> paramList, long paramLong, int paramInt)
  {
    if ((paramLong > 0L) && (paramInt > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        int i = paramInt / 8;
        if (paramLong > arrayOfInteger[0].intValue() * i) {
  ...
  {
    ThreadUtil.runOnUiThread(new SPBufferRangeController.1(this, paramISuperPlayer, computeBufferange(paramInt, paramLong), CommonUtil.parseStr2Int((String)this.configMap.get("emergency_time_for_preplay"), 3)));
  }
}
