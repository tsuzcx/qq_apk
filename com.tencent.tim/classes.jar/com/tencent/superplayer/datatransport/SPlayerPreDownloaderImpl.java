  ...
  implements ISPlayerPreDownloader
{
  ...
  public SPlayerPreDownloaderImpl(Context paramContext, int paramInt)
  {
    ...
    this.mTPPreloadProxy = TPP2PProxyFactory.createPreloadManager(paramContext, CommonUtil.getDownloadProxyServiceType(paramInt));
  ...
  private void configDownloadParamData(TPDownloadParamData paramTPDownloadParamData, SuperPlayerVideoInfo paramSuperPlayerVideoInfo)
  {
    ...
    paramTPDownloadParamData.setDownloadFileID(CommonUtil.calculateFileIDForVideoInfo(paramSuperPlayerVideoInfo));
    int i = 0;
  ...
  private void configDownloadParamData(TPDownloadParamData paramTPDownloadParamData, SuperPlayerVideoInfo paramSuperPlayerVideoInfo, SuperPlayerDownOption paramSuperPlayerDownOption)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      paramSuperPlayerVideoInfo.put("dl_param_quic_enable_mode", Integer.valueOf(paramSuperPlayerDownOption.quicEnableMode));
  ...
  private void doPreDownload(SuperPlayerVideoInfo paramSuperPlayerVideoInfo, TPDownloadParamData paramTPDownloadParamData, int paramInt)
  {
    ...
    int i = this.mTPPreloadProxy.startPreload(CommonUtil.calculateFileIDForVideoInfo(paramSuperPlayerVideoInfo), paramTPDownloadParamData, CommonUtil.createHttpHeaderForFirstUrl(paramSuperPlayerVideoInfo), new SPlayerPreDownloaderImpl.4(this, paramSuperPlayerVideoInfo, paramInt));
