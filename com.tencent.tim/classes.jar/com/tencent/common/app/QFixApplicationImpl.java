...
{
  public static String aHE = "com.tencent.common.app.BaseApplicationImpl";
  ...
  {
    if (aNN) {
      paramContext.getSharedPreferences("hotpatch_preference", 4).edit().putInt("androidNTryCount" + sProcessName, 0).commit();
    }
  }
  ...
  private JSONObject m(String paramString)
  {
    for (;;)
    {
      int j;
  ...
  public boolean isAndroidNPatchEnable()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        Log.d("QFixAppImpl_PatchLogTag", "isAndroidNPatchEnable revision=" + (String)localObject2 + ", " + "1d5677cf");
        if (!"1d5677cf".equals(localObject2))
        {
        ...
        else
        {
          ...
          if ((TextUtils.isEmpty((CharSequence)localObject2)) || (!((String)localObject2).equals(getVersionName(this) + "." + getVersionCode(this))))
          {
  ...
  public void startActivity(Intent paramIntent)
  {
    try
    {
      ...
      ahwd.a(this, paramIntent, new QFixApplicationImpl.1(this, paramIntent));
      return;
    }
  ...
  public void startActivity(Intent paramIntent, Bundle paramBundle)
  {
    try
    {
      FileProvider7Helper.intentCompatForN(this, paramIntent);
      ThirdAppReportHelper.reportThirdAppOpen(this, paramIntent, 0);
      ahwd.a(this, paramIntent, new QFixApplicationImpl.2(this, paramIntent, paramBundle));
      return;
    }
    catch (Throwable paramIntent)
    {
