...
public class AnimatorInflater
{
    ...
    throws XmlPullParserException, IOException
  {
    ...
    //   54: ifnull +41 -> 95
    //   57: aload 9
    //   59: invokevirtual 83	java/util/ArrayList:size	()I
    //   62: anewarray 85	com/nineoldandroids/animation/Animator
    //   65: astore_0
    //   66: aload 9
    //   68: invokevirtual 89	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   71: astore_1
    //   72: iload 6
    //   74: istore 5
    //   76: aload_1
    ...
    //   90: aload_3
    //   91: aload_0
    //   92: invokevirtual 101	com/nineoldandroids/animation/AnimatorSet:playTogether	([Lcom/nineoldandroids/animation/Animator;)V
    //   95: aload 10
    //   97: areturn
    //   98: iload 5
    //   100: iconst_2
    ...
    //   112: aload 8
    //   114: ldc 107
    //   116: invokevirtual 113	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   119: ifeq +47 -> 166
    //   122: aload_0
    //   123: aload_2
    //   124: invokestatic 117	com/nineoldandroids/animation/AnimatorInflater:loadObjectAnimator	(Landroid/content/Context;Landroid/util/AttributeSet;)Lcom/nineoldandroids/animation/ObjectAnimator;
    //   127: astore 8
    //   129: aload 8
    //   131: astore 10
    //   133: aload_3
    ...
    //   142: new 80	java/util/ArrayList
    //   145: dup
    //   146: invokespecial 118	java/util/ArrayList:<init>	()V
    //   149: astore 9
    //   151: aload 9
    //   153: aload 8
    ...
    //   166: aload 8
    //   168: ldc 123
    //   170: invokevirtual 113	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   173: ifeq +14 -> 187
    //   176: aload_0
    //   177: aload_2
    //   178: aconst_null
    //   179: invokestatic 127	com/nineoldandroids/animation/AnimatorInflater:loadAnimator	(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/nineoldandroids/animation/ValueAnimator;)Lcom/nineoldandroids/animation/ValueAnimator;
    //   182: astore 8
    //   184: goto -55 -> 129
    //   187: aload 8
    //   189: ldc 129
    //   191: invokevirtual 113	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   194: ifeq +156 -> 350
    //   197: new 97	com/nineoldandroids/animation/AnimatorSet
    //   200: dup
    //   201: invokespecial 130	com/nineoldandroids/animation/AnimatorSet:<init>	()V
    //   204: astore 12
    //   206: aload_0
    //   207: aload_2
    //   208: getstatic 34	com/nineoldandroids/animation/AnimatorInflater:AnimatorSet	[I
    //   211: invokevirtual 136	android/content/Context:obtainStyledAttributes	(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    //   214: astore 10
    //   216: aload 10
    //   218: astore 8
    //   220: new 138	android/util/TypedValue
    //   223: dup
    //   224: invokespecial 139	android/util/TypedValue:<init>	()V
    //   227: astore 11
    //   229: aload 10
    //   231: astore 8
    //   233: aload 10
    //   235: iconst_0
    //   236: aload 11
    //   238: invokevirtual 145	android/content/res/TypedArray:getValue	(ILandroid/util/TypedValue;)Z
    //   241: pop
    //   242: aload 10
    //   244: astore 8
    //   246: aload 11
    //   248: getfield 148	android/util/TypedValue:type	I
    //   251: bipush 16
    //   253: if_icmpne +45 -> 298
    //   256: aload 10
    //   258: astore 8
    //   260: aload 11
    //   262: getfield 151	android/util/TypedValue:data	I
    //   265: istore 5
    //   267: aload 10
    //   269: ifnull +8 -> 277
    //   272: aload 10
    //   274: invokevirtual 154	android/content/res/TypedArray:recycle	()V
    //   277: aload_0
    //   278: aload_1
    //   279: aload_2
    //   280: aload 12
    //   282: checkcast 97	com/nineoldandroids/animation/AnimatorSet
    //   285: iload 5
    //   287: invokestatic 66	com/nineoldandroids/animation/AnimatorInflater:createAnimatorFromXml	(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Lcom/nineoldandroids/animation/AnimatorSet;I)Lcom/nineoldandroids/animation/Animator;
    //   290: pop
    //   291: aload 12
    //   293: astore 8
    //   295: goto -166 -> 129
    ...
    //   311: astore 8
    //   313: aload 11
    //   315: invokevirtual 157	java/lang/Exception:printStackTrace	()V
    //   318: aload 10
    //   320: ifnull +101 -> 421
    //   323: aload 10
    //   325: invokevirtual 154	android/content/res/TypedArray:recycle	()V
    //   328: iconst_0
    //   329: istore 5
    //   331: goto -54 -> 277
    //   334: astore_0
    ...
    //   340: ifnull +8 -> 348
    //   343: aload 8
    //   345: invokevirtual 154	android/content/res/TypedArray:recycle	()V
    //   348: aload_0
    //   349: athrow
    //   350: new 159	java/lang/RuntimeException
    //   353: dup
    //   354: new 161	java/lang/StringBuilder
    //   357: dup
    //   358: ldc 163
    //   360: invokespecial 166	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   363: aload_1
    //   364: invokeinterface 105 1 0
    //   369: invokevirtual 170	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   372: invokevirtual 173	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   375: invokespecial 174	java/lang/RuntimeException:<init>	(Ljava/lang/String;)V
    //   378: athrow
    //   379: aload_0
    //   380: iload 5
    //   382: aload_1
    //   383: invokeinterface 177 1 0
    //   388: checkcast 85	com/nineoldandroids/animation/Animator
    //   391: aastore
    //   392: iload 5
    //   394: iconst_1
    //   395: iadd
    ...
    //   401: aload_3
    //   402: aload_0
    //   403: invokevirtual 180	com/nineoldandroids/animation/AnimatorSet:playSequentially	([Lcom/nineoldandroids/animation/Animator;)V
    //   406: aload 10
    //   408: areturn
    //   409: astore_0
    //   410: goto -72 -> 338
