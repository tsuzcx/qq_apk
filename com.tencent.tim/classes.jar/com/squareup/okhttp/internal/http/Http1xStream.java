  ...
  implements HttpStream
{
    ...
    extends Http1xStream.AbstractSource
  {
      ...
      throws IOException
    {
      ...
      paramLong = Http1xStream.this.source.read(paramBuffer, Math.min(this.bytesRemaining, paramLong));
      if (paramLong == -1L)
      {
        unexpectedEndOfInput();
        throw new ProtocolException("unexpected end of stream");
    ...
    extends Http1xStream.AbstractSource
  {
      ...
      throws IOException
    {
      ...
      paramLong = Http1xStream.this.source.read(paramBuffer, paramLong);
      if (paramLong == -1L)
      {
