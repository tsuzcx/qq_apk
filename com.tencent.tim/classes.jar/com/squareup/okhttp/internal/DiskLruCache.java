  ...
  implements Closeable
{
      ...
      try
      {
        ...
        else
        {
          ...
          else if (localObject == null)
          {
            ...
            localObject = new Editor(paramString, null);
            Entry.access$902(paramString, (Editor)localObject);
            paramString = (String)localObject;
          }
          else
          {
    ...
    throws IOException
  {
    ...
    //   8: invokeinterface 435 2 0
    //   13: invokestatic 438	okio/Okio:buffer	(Lokio/Source;)Lokio/BufferedSource;
    //   16: astore_2
    //   17: aload_2
    //   18: invokeinterface 443 1 0
    //   23: astore_3
    //   24: aload_2
    //   25: invokeinterface 443 1 0
    //   30: astore 4
    //   32: aload_2
    //   33: invokeinterface 443 1 0
    //   38: astore 5
    //   40: aload_2
    //   41: invokeinterface 443 1 0
    //   46: astore 6
    //   48: aload_2
    //   49: invokeinterface 443 1 0
    //   54: astore 7
    //   56: ldc 40
    //   58: aload_3
    //   59: invokevirtual 449	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   62: ifeq +54 -> 116
    //   65: ldc 49
    //   67: aload 4
    //   69: invokevirtual 449	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   72: ifeq +44 -> 116
    //   75: aload_0
    //   76: getfield 130	com/squareup/okhttp/internal/DiskLruCache:appVersion	I
    //   79: invokestatic 454	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   82: aload 5
    //   84: invokevirtual 449	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   87: ifeq +29 -> 116
    //   90: aload_0
    //   91: getfield 143	com/squareup/okhttp/internal/DiskLruCache:valueCount	I
    //   94: invokestatic 454	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   97: aload 6
    //   99: invokevirtual 449	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   102: ifeq +14 -> 116
    //   105: ldc_w 456
    //   108: aload 7
    //   110: invokevirtual 449	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   113: ifne +77 -> 190
    //   116: new 157	java/io/IOException
    //   119: dup
    //   120: new 237	java/lang/StringBuilder
    //   123: dup
    //   124: invokespecial 238	java/lang/StringBuilder:<init>	()V
    //   127: ldc_w 458
    //   130: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   133: aload_3
    //   134: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   137: ldc_w 460
    //   140: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   143: aload 4
    //   145: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   148: ldc_w 460
    ...
    //   159: ldc_w 460
    //   162: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   165: aload 7
    ...
    //   176: invokevirtual 251	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   179: invokespecial 463	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   182: athrow
    //   183: astore_3
    //   184: aload_2
    //   185: invokestatic 467	com/squareup/okhttp/internal/Util:closeQuietly	(Ljava/io/Closeable;)V
    //   188: aload_3
    //   189: athrow
    //   190: iconst_0
    //   191: istore_1
    //   192: aload_0
    //   193: aload_2
    //   194: invokeinterface 443 1 0
    //   199: invokespecial 470	com/squareup/okhttp/internal/DiskLruCache:readJournalLine	(Ljava/lang/String;)V
    //   202: iload_1
    //   203: iconst_1
    //   204: iadd
    //   205: istore_1
    ...
    //   211: iload_1
    //   212: aload_0
    //   213: getfield 115	com/squareup/okhttp/internal/DiskLruCache:lruEntries	Ljava/util/LinkedHashMap;
    //   216: invokevirtual 387	java/util/LinkedHashMap:size	()I
    //   219: isub
    //   220: putfield 201	com/squareup/okhttp/internal/DiskLruCache:redundantOpCount	I
    //   223: aload_2
    //   224: invokeinterface 473 1 0
    //   229: ifne +12 -> 241
    //   232: aload_0
    //   233: invokespecial 197	com/squareup/okhttp/internal/DiskLruCache:rebuildJournal	()V
    //   236: aload_2
    //   237: invokestatic 467	com/squareup/okhttp/internal/Util:closeQuietly	(Ljava/io/Closeable;)V
    //   240: return
    //   241: aload_0
    //   242: aload_0
    //   243: invokespecial 475	com/squareup/okhttp/internal/DiskLruCache:newJournalWriter	()Lokio/BufferedSink;
    //   246: putfield 289	com/squareup/okhttp/internal/DiskLruCache:journalWriter	Lokio/BufferedSink;
    //   249: goto -13 -> 236
    ...
    throws IOException
  {
    ...
    for (;;)
    {
      ...
      if ((k != -1) && (i == "CLEAN".length()) && (paramString.startsWith("CLEAN")))
      {
        ...
        Entry.access$802(localEntry1, true);
        Entry.access$902(localEntry1, null);
        localEntry1.setLengths(paramString);
        return;
      }
      if ((k == -1) && (i == "DIRTY".length()) && (paramString.startsWith("DIRTY")))
      {
        Entry.access$902(localEntry1, new Editor(localEntry1, null));
        return;
      }
    ...
    throws IOException
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 151	com/squareup/okhttp/internal/DiskLruCache:initialized	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifne +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: invokespecial 364	com/squareup/okhttp/internal/DiskLruCache:checkNotClosed	()V
    //   18: aload_0
    //   19: invokespecial 160	com/squareup/okhttp/internal/DiskLruCache:trimToSize	()V
    //   22: aload_0
    //   23: getfield 289	com/squareup/okhttp/internal/DiskLruCache:journalWriter	Lokio/BufferedSink;
    //   26: invokeinterface 314 1 0
    //   31: goto -20 -> 11
    //   34: astore_2
    //   35: aload_0
    //   36: monitorexit
    ...
    throws IOException
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 362	com/squareup/okhttp/internal/DiskLruCache:initialize	()V
    //   6: aload_0
    //   7: invokespecial 364	com/squareup/okhttp/internal/DiskLruCache:checkNotClosed	()V
    //   10: aload_0
    //   11: aload_1
    //   12: invokespecial 367	com/squareup/okhttp/internal/DiskLruCache:validateKey	(Ljava/lang/String;)V
    //   15: aload_0
    //   16: getfield 115	com/squareup/okhttp/internal/DiskLruCache:lruEntries	Ljava/util/LinkedHashMap;
    //   19: aload_1
    //   20: invokevirtual 370	java/util/LinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   23: checkcast 11	com/squareup/okhttp/internal/DiskLruCache$Entry
    //   26: astore_3
    //   27: aload_3
    //   28: ifnull +12 -> 40
    //   31: aload_3
    //   32: invokestatic 228	com/squareup/okhttp/internal/DiskLruCache$Entry:access$800	(Lcom/squareup/okhttp/internal/DiskLruCache$Entry;)Z
    //   35: istore_2
    //   36: iload_2
    //   37: ifne +9 -> 46
    //   40: aconst_null
    ...
    //   45: areturn
    //   46: aload_3
    //   47: invokevirtual 551	com/squareup/okhttp/internal/DiskLruCache$Entry:snapshot	()Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;
    //   50: astore_3
    //   51: aload_3
    //   52: ifnonnull +8 -> 60
    //   55: aconst_null
    ...
    //   60: aload_0
    //   61: aload_0
    //   62: getfield 201	com/squareup/okhttp/internal/DiskLruCache:redundantOpCount	I
    //   65: iconst_1
    //   66: iadd
    //   67: putfield 201	com/squareup/okhttp/internal/DiskLruCache:redundantOpCount	I
    //   70: aload_0
    //   71: getfield 289	com/squareup/okhttp/internal/DiskLruCache:journalWriter	Lokio/BufferedSink;
    //   74: ldc 44
    //   76: invokeinterface 295 2 0
    //   81: bipush 32
    //   83: invokeinterface 299 2 0
    //   88: aload_1
    //   89: invokeinterface 295 2 0
    //   94: bipush 10
    ...
    //   103: astore_1
    //   104: aload_0
    //   105: invokespecial 193	com/squareup/okhttp/internal/DiskLruCache:journalRebuildRequired	()Z
    //   108: ifeq -66 -> 42
    //   111: aload_0
    //   112: getfield 147	com/squareup/okhttp/internal/DiskLruCache:executor	Ljava/util/concurrent/Executor;
    //   115: aload_0
    //   116: getfield 124	com/squareup/okhttp/internal/DiskLruCache:cleanupRunnable	Ljava/lang/Runnable;
    //   119: invokeinterface 320 2 0
    //   124: aload_3
    //   125: astore_1
    //   126: goto -84 -> 42
    //   129: astore_1
    ...
    throws IOException
  {
    ...
    //   37: aload_0
    //   38: aload_1
    //   39: invokespecial 187	com/squareup/okhttp/internal/DiskLruCache:removeEntry	(Lcom/squareup/okhttp/internal/DiskLruCache$Entry;)Z
    //   42: istore_2
    //   43: goto -10 -> 33
    //   46: astore_1
    //   47: aload_0
