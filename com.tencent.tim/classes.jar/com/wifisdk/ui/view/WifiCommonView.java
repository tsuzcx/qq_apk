  ...
  implements View.OnClickListener
{
  ...
  public void fR()
  {
    ...
    for (;;)
    {
      try
      {
        Object localObject1 = fq.ek().getString("kfpt", null);
        ...
        Object localObject5 = localObject1[1];
        localTextView = null;
      }
      catch (Throwable localThrowable1)
      {
        try
        {
          localObject3 = new SpannableString((CharSequence)localObject5);
        }
        ...
        try
        {
          ((SpannableString)localObject3).setSpan(new ForegroundColorSpan(this.vy.getResources().getColor(RProxy.color.tmsdk_wifi_floor_text_color)), 0, ((String)localObject5).length(), 33);
          ...
          {
            localObject4 = this.vy.getString(RProxy.string.tmsdk_wifi_floor_content_title);
            ...
            localObject5 = this.vy.getString(RProxy.string.tmsdk_wifi_floor_btn_text);
          }
          this.vs.setText((CharSequence)localObject4);
          this.vt.setText((CharSequence)localObject3);
          this.vu.setText((CharSequence)localObject5);
          localObject3 = fm.dL().dO();
          localObject1 = localObject6;
          if (localObject3 != null) {
            localObject1 = ((fm.a)localObject3).qu;
          }
          i = hl.i("com.tencent.wifimanager", (String)localObject1);
          if (i != 3) {
            break label332;
          }
