  ...
  extends ReportFragment
{
  ...
  public void onStart()
  {
    ...
    while (i < this.a.size())
    {
      ((a)this.a.valueAt(i)).a.connect(null);
      i += 1;
    }
  }
  ...
  public void onStop()
  {
    ...
    while (i < this.a.size())
    {
      ((a)this.a.valueAt(i)).a.disconnect();
      i += 1;
    }
  }
  ...
  public void startAutoMange(int paramInt, HuaweiApiClient paramHuaweiApiClient)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.a.put(paramInt, new a(paramInt, paramHuaweiApiClient));
      if (this.b) {
  ...
  class a
  {
    ...
    public a(int paramInt, HuaweiApiClient paramHuaweiApiClient)
    {
