  ...
  implements Closeable
{
  ...
  {
    this(Builder.a(paramBuilder), getCursorWindows(paramBuilder, -1), paramInt, null);
  }
  
  private DataHolder(Builder paramBuilder, int paramInt1, Bundle paramBundle, int paramInt2)
  {
    this(Builder.a(paramBuilder), getCursorWindows(paramBuilder, -1), paramInt1, paramBundle);
  }
  ...
  private final void checkAvailable(String paramString, int paramInt)
  {
    String str = "";
  ...
  private static CursorWindow[] getCursorWindows(Builder paramBuilder, int paramInt)
  {
    ...
    {
      i = paramInt;
      if (paramInt < Builder.b(paramBuilder).size()) {}
    }
    else
    {
      i = Builder.b(paramBuilder).size();
    }
    paramBuilder = iterCursorWindow(paramBuilder, i, Builder.b(paramBuilder).subList(0, i));
    return (CursorWindow[])paramBuilder.toArray(new CursorWindow[paramBuilder.size()]);
  }
  
  private static ArrayList<CursorWindow> iterCursorWindow(Builder paramBuilder, int paramInt, List paramList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        boolean bool = true;
        int j = 0;
        if (j >= Builder.a(paramBuilder).length) {
          break label290;
        }
        bool = putValue(localCursorWindow, localHashMap.get(Builder.a(paramBuilder)[j]), i, j);
        if (!bool)
        {
          if (!bool)
          {
            ...
            paramList.setNumColumns(Builder.a(paramBuilder).length);
  ...
  public static class Builder
  {
    ...
    Builder(String[] paramArrayOfString, String paramString, a parama)
    {
