  ...
  extends Exception
{
  ...
  public ConnectionResult getConnectionResult(HuaweiApi<? extends Api.ApiOptions> paramHuaweiApi)
  {
    ...
    return b(new AvailableAdapter(30000000).isHuaweiMobileServicesAvailable(paramHuaweiApi));
  }
  ...
  public ConnectionResult getConnectionResult(HuaweiApiCallable paramHuaweiApiCallable)
  {
    ...
    return b(new AvailableAdapter(30000000).isHuaweiMobileServicesAvailable(paramHuaweiApiCallable));
  }
