  ...
  implements ServiceConnection, IBridgeActivityDelegate
{
  ...
  {
    Intent localIntent = new Intent();
    localIntent.setClassName("com.huawei.hwid", "com.huawei.hms.core.activity.JumpActivity");
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      this.d.a(localActivity, new BindingFailedResolution.3(this));
      return;
      this.d.b();
    }
  }
    ...
    extends b
  {
    ...
    {
      return ResourceLoaderUtil.getString("hms_bindfaildlg_message", new Object[] { Util.getAppName(paramContext, null), Util.getAppName(paramContext, "com.huawei.hwid") });
    }
