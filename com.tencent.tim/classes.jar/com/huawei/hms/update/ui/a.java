  ...
  implements IBridgeActivityDelegate
{
  ...
  {
    if (HiAnalyticsUtil.getInstance().hasError(b())) {}
    ...
    localHashMap.put("sdk_ver", String.valueOf(40002300));
    localHashMap.put("app_id", Util.getAppId(localActivity));
    ...
    HiAnalyticsUtil.getInstance().onEvent(localActivity, "HMS_SDK_UPDATE", localHashMap);
  }
