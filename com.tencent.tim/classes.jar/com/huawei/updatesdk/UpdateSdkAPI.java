...
import com.huawei.updatesdk.service.d.a.c;
...
public final class UpdateSdkAPI
{
  ...
  private static void init(Context paramContext)
  {
    ...
    Log.i("updatesdk", "UpdateSDK version is: 2.0.6.300 ,flavor: envrelease ,pkgName: " + paramContext.getPackageName());
  }
  ...
  public static void releaseCallBack()
  {
    ...
    for (;;)
    {
      ...
      {
        AsyncTask localAsyncTask = (AsyncTask)((Iterator)localObject).next();
