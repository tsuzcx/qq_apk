...
public class a
{
  ...
  {
    // Byte code:
    //   0: new 6	com/huawei/updatesdk/a/a/c/b/a$a
    //   3: dup
  ...
  {
    return alld.query(paramContext.getContentResolver(), a, null, null, null, null);
  }
  ...
  {
    return alld.query(paramContext.getContentResolver(), c, null, null, null, null);
  }
  
  private static Cursor f(Context paramContext)
  {
    return alld.query(paramContext.getContentResolver(), b, null, null, null, null);
  }
