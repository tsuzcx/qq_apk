  ...
  implements com.huawei.updatesdk.service.b.b, b
{
  ...
  private void a(com.huawei.updatesdk.a.b.c.b paramb)
  {
    ...
    int i1 = paramb.a("download_apk_size", 0);
    i1 = i.a(paramb.a("download_apk_already", 0), i1);
  ...
  private void a(ApkUpgradeInfo paramApkUpgradeInfo, TextView paramTextView)
  {
    ...
    {
      paramApkUpgradeInfo = i.a(this, paramApkUpgradeInfo.getSize_());
  ...
  {
    long l1 = paramApkUpgradeInfo.getSize_();
  ...
  private void e(ApkUpgradeInfo paramApkUpgradeInfo)
  {
    ...
    this.l = new com.huawei.updatesdk.a.b.b.b(new com.huawei.updatesdk.a.b.b.a(paramApkUpgradeInfo.getDownurl_(), paramApkUpgradeInfo.getSize_(), paramApkUpgradeInfo.getSha256_()));
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if (paramInt1 == 1002)
    {
      if (paramIntent != null)
      {
        ...
        this.m = paramInt2;
        this.n = paramIntent.a("installResultCode", -99);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    if ((localSerializable != null) && ((localSerializable instanceof ApkUpgradeInfo)))
    {
      ...
      if ((this.i.getDevType_() != 1) || (com.huawei.updatesdk.service.e.c.a(this) != com.huawei.updatesdk.service.e.c.a.b)) {
        d(this.i);
      }
    }
    else
    ...
    implements c.a
  {
    ...
    public void a(Boolean paramBoolean)
    {
      ...
      try
      {
        ...
        AppUpdateActivity.this.startActivity(paramBoolean);
      ...
      catch (ActivityNotFoundException paramBoolean)
      {
        for (;;)
        {
          com.huawei.updatesdk.a.a.b.a.a.a.d("AppUpdateActivity", "goHiappUpgrade error: " + paramBoolean.toString());
        }
      }
    }
  }
    ...
    extends com.huawei.updatesdk.a.b.c.a
  {
    ...
    public void a(Context paramContext, com.huawei.updatesdk.a.b.c.b paramb)
    {
      if (!paramb.d()) {}
      do
      {
        do
        {
          ...
          {
            return;
            if (AppUpdateActivity.e(AppUpdateActivity.this) != null) {
              AppUpdateActivity.e(AppUpdateActivity.this).c();
            }
        ...
        } while ((!"android.intent.action.PACKAGE_ADDED".equals(paramContext)) || (!AppUpdateActivity.j(AppUpdateActivity.this).equals(paramb)));
        d.a().a(AppUpdateActivity.a(AppUpdateActivity.this, 6, 0, -1));
        g.a.a(paramb, 1);
        AppUpdateActivity.a(AppUpdateActivity.this, AppUpdateActivity.g(AppUpdateActivity.this).getPackage_(), AppUpdateActivity.g(AppUpdateActivity.this).getDetailId_());
      } while (!AppUpdateActivity.f(AppUpdateActivity.this));
      AppUpdateActivity.a(AppUpdateActivity.this, AppUpdateActivity.g(AppUpdateActivity.this));
    }
  }
}
