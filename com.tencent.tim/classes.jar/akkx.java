...
public class akkx
{
  ...
  public static final HashMap mb = new HashMap();
  ...
  static
  {
    ...
    mb.put(Integer.valueOf(10001), localNearbyMyTabConfigExtraVal);
    ...
    mb.put(Integer.valueOf(10002), localNearbyMyTabConfigExtraVal);
    localNearbyMyTabConfigExtraVal = new NearbyMyTabCard.NearbyMyTabConfigExtraVal();
    ...
    mb.put(Integer.valueOf(10003), localNearbyMyTabConfigExtraVal);
    localNearbyMyTabConfigExtraVal = new NearbyMyTabCard.NearbyMyTabConfigExtraVal();
    localNearbyMyTabConfigExtraVal.path = "100510.100521";
    localNearbyMyTabConfigExtraVal.pathId = 100521;
    mb.put(Integer.valueOf(10004), localNearbyMyTabConfigExtraVal);
    localNearbyMyTabConfigExtraVal = new NearbyMyTabCard.NearbyMyTabConfigExtraVal();
    localNearbyMyTabConfigExtraVal.path = "100510.100517";
    localNearbyMyTabConfigExtraVal.pathId = 100517;
    mb.put(Integer.valueOf(10005), localNearbyMyTabConfigExtraVal);
    localNearbyMyTabConfigExtraVal = new NearbyMyTabCard.NearbyMyTabConfigExtraVal();
    localNearbyMyTabConfigExtraVal.path = "100510.100513";
    localNearbyMyTabConfigExtraVal.pathId = 100513;
    mb.put(Integer.valueOf(10006), localNearbyMyTabConfigExtraVal);
    localNearbyMyTabConfigExtraVal = new NearbyMyTabCard.NearbyMyTabConfigExtraVal();
    localNearbyMyTabConfigExtraVal.path = "100510.100524";
    localNearbyMyTabConfigExtraVal.pathId = 100524;
    mb.put(Integer.valueOf(10010), localNearbyMyTabConfigExtraVal);
    fK = new String[] { "100510.100511", "100510.100513", "100510.100514", "100510.100519", "100510.100521", "100510.100520", "100510.100516", "100510.100517", "100510.100524", "100510.100523" };
  }
  ...
  public static NearbyMyTabCard a(AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      ...
      synchronized (ek)
      {
        paramAppInterface = aqhq.a(paramAppInterface.getCurrentAccountUin() + "NewNearbyMyTab.nbr", arrayOfClass);
        ...
        ajrk.f("Q.nearby", "readNearbyMyTabCardFromLocal", new Object[] { paramAppInterface });
  ...
  public static BusinessInfoCheckUpdate.AppInfo a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      paramAppInterface = (altq)paramAppInterface.getManager(36);
      if (paramAppInterface != null) {
        paramAppInterface.b(paramString1, true);
      }
    }
    return paramString1;
  }
  ...
  public static BusinessInfoCheckUpdate.AppInfo a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    if ((!localaltq.czp) || (!localaltq.kT(100510)))
    {
      if (QLog.isColorLevel()) {
    ...
    if (((Boolean)ajrb.a(paramQQAppInterface.getAccount(), "nearby_event_file", 4, "config_show_date", Boolean.valueOf(false))).booleanValue()) {}
    for (int i = d(paramQQAppInterface, 100511) + 0;; i = 0)
    {
      int j = i;
      if (((Boolean)ajrb.a(paramQQAppInterface.getAccount(), "nearby_event_file", 4, "config_show_rank", Boolean.valueOf(false))).booleanValue()) {
        j = i + d(paramQQAppInterface, 100517);
      }
      if (QLog.isColorLevel()) {
      ...
      if (j > 0)
      {
        paramQQAppInterface = localaltq.getAppInfoByPath(String.valueOf(100510));
        ...
        for (;;)
        {
          try
          {
            ...
            return localaltq.a(0, 100510, String.valueOf(100510), j);
          }
      ...
      BusinessInfoCheckUpdate.AppInfo localAppInfo = localaltq.getAppInfoByPath("100510");
      if ((localAppInfo != null) && (localAppInfo.iNewFlag.get() == 1) && (localAppInfo.type.get() == 5))
      {
        ...
        localaltq.OS(String.valueOf(100510));
        if (paramBoolean) {
          acks.cw(paramQQAppInterface);
        }
      }
      return localAppInfo;
    }
  ...
  public static BusinessInfoCheckUpdate.AppInfo a(QQAppInterface paramQQAppInterface, Object[] paramArrayOfObject)
  {
    ...
    do
    {
      ...
      if (k < fK.length)
      {
        int i2 = Integer.parseInt(fK[k].substring(fK[k].lastIndexOf(".") + 1));
        Object localObject1 = ((altq)localObject3).getAppInfoByPath(fK[k]);
        int n = 0;
        int j = n;
    ...
    for (paramQQAppInterface = ((BusinessInfoCheckUpdate.AppInfo)localObject2).type.get() + "";; paramQQAppInterface = "-1")
    {
      ...
      localObject3 = ((altq)localObject3).getAppInfoByPath(str);
  ...
  public static void a(AppInterface paramAppInterface, NearbyMyTabCard paramNearbyMyTabCard)
  {
    ...
    ajrk.f("Q.nearby", "storeNearbyMyTabCard", new Object[] { paramNearbyMyTabCard });
    synchronized (ek)
    {
      aqhq.x(paramAppInterface.getCurrentAccountUin() + "NewNearbyMyTab.nbr", new Object[] { paramNearbyMyTabCard });
      return;
    }
  }
  ...
  public static void a(NearbyAppInterface paramNearbyAppInterface, int paramInt, boolean paramBoolean)
  {
    ...
    ((acig)paramNearbyAppInterface.getBusinessHandler(3)).b(localNearbyMyTabCard);
  }
  
  public static int d(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    case 100519: 
      for (;;)
      {
        ...
        return i;
        j = ajrb.O(paramQQAppInterface.getAccount(), "unread_count_date");
        i = j;
        if (QLog.isColorLevel())
        {
          ajrk.log(2, "NearbyMineHelper", "getUnCountByPathIDMain", new Object[] { "dating", Integer.valueOf(j) });
          i = j;
          continue;
          j = ajrb.O(paramQQAppInterface.getAccount(), "unread_count_freshnews");
          i = j;
          if (QLog.isColorLevel())
          {
            ajrk.log(2, "NearbyMineHelper", "getUnCountByPathIDMain", new Object[] { "freshnews", Integer.valueOf(j) });
            i = j;
          }
        }
      }
    }
    if (ajrb.O(paramQQAppInterface.getAccount(), "unread_count_rank") > 0) {}
    for (int j = 1;; j = 0)
    {
      i = j;
      if (!QLog.isColorLevel()) {
      ...
      ajrk.log(2, "NearbyMineHelper", "getUnCountByPathIDMain", new Object[] { "ranking", Integer.valueOf(j) });
      i = j;
      break;
    }
  }
