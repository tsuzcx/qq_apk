...
public class ankj
{
  public static final List<String> Gy = Arrays.asList(new String[] { "VIVO X7", "VIVO XPLAY5A", "VIVO X6SPLUS", "VIVO X6S A", "REDMI NOTE 3", "REDMI NOTE 4X", "MI 5", "MI-4C", "CAM-AL00", "MLA-AL10", "CAZ-AL10", "VNS-AL00" });
  ...
  public static boolean axS()
  {
    ...
    if ((i == 22) || (i == 23) || (i == 24))
    {
      ...
      Iterator localIterator = Gy.iterator();
