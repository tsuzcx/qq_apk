...
{
  public akdb(NearbyProfileDisplayPanel.13.1 param1) {}
  
  public void onClick(View paramView)
  {
    if (TextUtils.isEmpty(akcx.a(this.a.a.this$0).strGodJumpUrl))
    {
      EventCollector.getInstance().onViewClicked(paramView);
      return;
    }
    Object localObject1 = new Intent(this.a.a.this$0.a, QQBrowserActivity.class);
    Object localObject2 = new StringBuilder().append(akcx.a(this.a.a.this$0).strGodJumpUrl).append("&gender=");
    int i;
    if (this.a.i == null)
    {
      i = 0;
