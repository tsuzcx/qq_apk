...
public class kjs
{
  private static HashMap<Integer, Pair<Integer, Integer>> di = new HashMap();
  
  static
  {
    di.put(Integer.valueOf(385), new Pair(Integer.valueOf(1000), Integer.valueOf(560)));
    di.put(Integer.valueOf(65), new Pair(Integer.valueOf(1000), Integer.valueOf(560)));
    di.put(Integer.valueOf(600), new Pair(Integer.valueOf(1000), Integer.valueOf(560)));
    di.put(Integer.valueOf(769), new Pair(Integer.valueOf(1280), Integer.valueOf(720)));
    di.put(Integer.valueOf(710), new Pair(Integer.valueOf(720), Integer.valueOf(1280)));
  }
