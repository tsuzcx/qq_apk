...
public class arwr
{
  public static Bitmap R(String paramString)
  {
    String str1 = aN(paramString, 100);
    String str2 = ImageCache.ci("app", str1);
    arwt.i("ImageUtil", "100_url:" + str1 + " icon_path=" + str2);
    if (new File(str2).exists()) {
      return arwp.c(str2, 72, 72, false);
    }
    paramString = aN(paramString, 75);
    str1 = ImageCache.ci("app", paramString);
    arwt.i("ImageUtil", "75_url:" + paramString + " icon_path=" + str1);
    if (new File(str1).exists()) {
      return arwp.c(str1, 72, 72, false);
    }
    return null;
  }
  ...
  public static String aN(String paramString, int paramInt)
  {
    ...
    arwt.i("opensdk", ">>iconUrl=" + paramString);
    return paramString;
  }
  ...
  public static Bitmap h(Drawable paramDrawable)
  {
    return drawableToBitmap(paramDrawable);
  }
}
