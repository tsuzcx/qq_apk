  ...
  extends sfx
{
    ...
    throws InvalidProtocolBufferMicroException
  {
    ...
    notifyObserver(paramIntent, this.bwI, true, paramBundle, null);
  }
      ...
      for (;;)
      {
        ...
        catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException1)
        {
          ...
          try
          {
            ...
            localObject2 = new sga((COMM.StCommonExt)localObject2, (CertifiedAccountMeta.StFeed)localObject1).encode(paramIntent, i, getTraceId());
