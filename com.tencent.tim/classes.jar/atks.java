  ...
  extends atkw
{
  ...
  public boolean a(CloudHistoryInfo paramCloudHistoryInfo, Object paramObject)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("DiscussRecentInfo", 1, "create. fileName[" + paramCloudHistoryInfo.fileName + "] filePath[" + paramCloudHistoryInfo.localPath + "]");
    }
  ...
  public void n(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (localFileManagerEntity != null)
    {
      paramQQAppInterface = audk.a(localFileManagerEntity);
