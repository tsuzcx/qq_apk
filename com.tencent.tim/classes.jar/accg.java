  ...
  extends accb
{
  ...
  protected accg(AppInterface paramAppInterface)
  {
  ...
  protected accg(QQAppInterface paramQQAppInterface)
  {
  ...
  protected void checkReportErrorToMM(FromServiceMsg paramFromServiceMsg)
  {
    if (reportErrorToMM(paramFromServiceMsg))
    {
      ...
      arts.a().a(paramFromServiceMsg.getServiceCmd(), 100, paramFromServiceMsg.getBusinessFailCode(), getCurrentAccountUin(), 1000277, acfp.m(2131703316) + paramFromServiceMsg.getServiceCmd(), true);
    }
  }
