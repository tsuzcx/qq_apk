...
public class andw
{
  ...
  private boolean bp(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
  ...
  private boolean bq(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    long l = u(paramToServiceMsg.getUin());
    if (l == 0L) {}
  ...
  private boolean br(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
  ...
  private boolean bs(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
  ...
  private boolean bt(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    try
    {
  ...
  private boolean bu(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    String str = aofy.iF(paramToServiceMsg);
    try
    {
      byte[] arrayOfByte = str.getBytes("utf-8");
      if (arrayOfByte.length > 120) {}
      for (localModifyGroupInfoReq.strFingerMemo = jqn.b(arrayOfByte, 120);; localModifyGroupInfoReq.strFingerMemo = str)
      {
        localModifyGroupInfoReq.strRichFingerMemo = jqc.escape(paramToServiceMsg);
  ...
  private boolean bv(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (bool3)
    {
      ...
      ((oidb_0x88d.ReqBody)localObject1).uint32_appid.set(this.app.getAppid());
    ...
    for (;;)
    {
      ...
      ((oidb_0x787.ReqBody)localObject1).rpt_uin_list.add(Long.valueOf(this.app.getLongAccountUin()));
