  ...
  implements BadcaseReportUtils.ReportItemData
{
  ...
  private static ArrayList<BadcaseReportUtils.BadDataFrame> zb = new ArrayList();
  
  public static void On(boolean paramBoolean)
  {
    if (paramBoolean) {}
    for (BadcaseReportUtils.ENABLE_REPORT = anki.axJ();; BadcaseReportUtils.ENABLE_REPORT = false)
    {
      BadcaseReportUtils.sTotalReportNumber = anki.JN();
  ...
  private static void a(BadcaseReportUtils.BadDataFrame paramBadDataFrame, String paramString1, int paramInt, String paramString2, String paramString3)
    throws Exception
  {}
  ...
  public static boolean a(Bitmap paramBitmap, String paramString, int paramInt)
  {
    ...
    //   26: iload_3
    //   27: ireturn
    //   28: new 92	java/io/File
    //   31: dup
    //   32: aload_1
    //   33: invokespecial 95	java/io/File:<init>	(Ljava/lang/String;)V
    //   36: astore_1
    //   37: aload_1
    //   38: invokevirtual 98	java/io/File:exists	()Z
    //   41: ifeq +8 -> 49
    //   44: aload_1
    //   45: invokevirtual 101	java/io/File:delete	()Z
    //   48: pop
    //   49: aload_1
    //   50: invokevirtual 104	java/io/File:createNewFile	()Z
    //   53: pop
    //   54: new 106	java/io/FileOutputStream
    //   57: dup
    //   58: aload_1
    //   59: invokespecial 109	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   62: astore_1
    //   63: aload_1
    //   64: astore 5
    //   66: aload 7
    //   68: astore 6
    //   70: new 111	java/io/BufferedOutputStream
    //   73: dup
    //   74: aload_1
    //   75: sipush 20480
    //   78: invokespecial 114	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   81: astore 7
    //   83: aload_0
    //   84: getstatic 120	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   87: iload_2
    //   88: aload 7
    //   90: invokevirtual 126	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   93: istore_3
    //   94: iload_3
    //   95: istore 4
    //   97: aload 7
    //   99: ifnull +13 -> 112
    //   102: aload 7
    //   104: invokevirtual 131	java/io/OutputStream:flush	()V
    //   107: aload 7
    //   109: invokevirtual 134	java/io/OutputStream:close	()V
    //   112: iload 4
    //   114: istore_3
    //   115: aload_1
    //   116: ifnull -90 -> 26
    ...
    //   142: astore 6
    //   144: aload_0
    //   145: invokevirtual 138	java/io/FileNotFoundException:printStackTrace	()V
    //   148: aload 7
    //   150: ifnull +13 -> 163
    //   153: aload 7
    //   155: invokevirtual 131	java/io/OutputStream:flush	()V
    //   158: aload 7
    //   160: invokevirtual 134	java/io/OutputStream:close	()V
    //   163: iload 4
    //   165: istore_3
    //   166: aload_1
    //   167: ifnull -141 -> 26
    ...
    //   184: ifnull +13 -> 197
    //   187: aload 6
    //   189: invokevirtual 131	java/io/OutputStream:flush	()V
    //   192: aload 6
    //   194: invokevirtual 134	java/io/OutputStream:close	()V
    //   197: aload_1
    //   198: ifnull +7 -> 205
    //   201: aload_1
    //   202: invokevirtual 135	java/io/FileOutputStream:close	()V
    //   205: aload_0
    //   206: athrow
    //   207: astore_0
    //   208: iconst_0
  ...
  {
    Object localObject1 = new File(yD());
  ...
  public static boolean f(Bitmap paramBitmap, String paramString)
  {
  ...
  {
    Object localObject = new StringBuilder(aasa.SDCARD_ROOT);
