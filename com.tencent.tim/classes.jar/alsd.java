...
public class alsd
  extends MSFServlet
{
  private void a(boolean paramBoolean, newest_feeds_rsp paramnewest_feeds_rsp)
  {
    ...
    {
      b(paramBoolean, paramnewest_feeds_rsp);
      localQQAppInterface.a().a(paramnewest_feeds_rsp);
      localQQAppInterface.a().dIQ();
      return;
    }
    localQQAppInterface.a().dIP();
  }
  
  protected void b(boolean paramBoolean, newest_feeds_rsp paramnewest_feeds_rsp)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject3 = localacff.a(String.valueOf(localObject3));
      ...
      if (i == 3) {
        try
        {
          ...
          if (((localNumberFormatException.feedTime <= ((META.StStoryFeed)localObject5).createTime.get()) || (localNumberFormatException.feedType == 2)) && (!TextUtils.isEmpty(((META.StStoryFeed)localObject5).coverImage.url.get())))
          {
            ...
            localNumberFormatException.feedContent = BaseApplicationImpl.getApplication().getString(2131690246);
    ...
    if ((paramnewest_feeds_rsp != null) && (!paramnewest_feeds_rsp.isEmpty()))
    {
      ...
      while (paramnewest_feeds_rsp.hasNext())
      {
        ...
        localObject2 = localacff.a(String.valueOf(((feed_info)localObject1).opuin));
        if (localObject2 != null)
        {
          l = ((feed_info)localObject1).time;
          str = alse.e(((feed_info)localObject1).strcontent, localQQAppInterface);
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      paramnewest_feeds_rsp = (FriendListHandler)localQQAppInterface.getBusinessHandler(1);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      paramIntent = alsc.a(paramFromServiceMsg.getWupBuffer());
      if (paramIntent != null)
      {
        a(true, paramIntent);
        return;
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    byte[] arrayOfByte = new alsc(alse.a(paramIntent)).encode();
