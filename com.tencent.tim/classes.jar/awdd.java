...
public class awdd
{
  private static awdd a;
  private String cPk;
  private String cPl;
  private final ConcurrentHashMap<String, Set<String>> kc = new ConcurrentHashMap();
  private final ConcurrentHashMap<String, Set<String>> kd = new ConcurrentHashMap();
  ...
  public boolean B(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      if (!paramString1.equals(this.cPl))
      {
        a(paramString1, this.kd);
        this.cPl = paramString1;
        if (QLog.isColorLevel()) {
          QLog.d("QzoneAuthorizeConfig", 1, this.cPl);
        }
      }
      if (this.kd.size() == 0) {
        return true;
      }
      Object localObject2 = this.kd.keySet();
      ...
      do
      {
        while (!((Iterator)localObject2).hasNext())
        {
          do
          {
            ...
            } while (!A((String)localObject2, paramString1));
            localObject2 = (Set)this.kd.get(localObject2);
          } while ((localObject2 == null) || (((Set)localObject2).size() == 0));
          localObject2 = ((Set)localObject2).iterator();
        }
        bool = A((String)((Iterator)localObject2).next(), paramString2);
      } while (!bool);
      return false;
    }
  ...
  public boolean ct(String paramString1, String paramString2)
  {
    for (;;)
    {
      try
      {
        ...
        if (!((String)localObject1).equals(this.cPk))
        {
          a((String)localObject1, this.kc);
          this.cPk = ((String)localObject1);
          if (QLog.isColorLevel()) {
            QLog.d("QzoneAuthorizeConfig", 1, this.cPk);
          }
        }
        if (this.kc.size() == 0) {
          return true;
        }
        localObject1 = this.kc.keySet();
        ...
        if (!TextUtils.isEmpty(paramString1))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if (A((String)localObject2, paramString1))
            {
              localObject2 = (Set)this.kc.get(localObject2);
              if ((localObject2 != null) && (((Set)localObject2).size() != 0))
              {
                localObject2 = ((Set)localObject2).iterator();
                if (((Iterator)localObject2).hasNext())
                {
                  boolean bool = A((String)((Iterator)localObject2).next(), paramString2);
                  if (bool) {
                    return false;
                  }
                }
