...
public class mah
  extends lwm
{
  public mah(Context paramContext, aqdf paramaqdf, ndi paramndi)
  {
  ...
  {
    this.alM = true;
    return d(this.d, this.c).q().g().l().j().n().h();
  }
    ...
    throws Exception
  {
    ...
    if (this.jdField_a_of_type_Lwl != null)
    {
      ...
      localLinearLayout2.addView((View)this.jdField_a_of_type_Lwl);
  ...
  public lwm g()
  {
    this.jdField_a_of_type_Lwl = new ComponentContentUgcImage(this.context);
    return this;
  }
  ...
  public lwm p()
  {
    super.p();
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentHeaderUgc != null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentHeaderUgc.a(this.jdField_a_of_type_Lwm$a);
    }
    return this;
  }
}
