...
public class anhi
{
  public static void a(boolean paramBoolean1, String paramString, int paramInt1, int paramInt2, boolean paramBoolean2, long paramLong, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      Object localObject2 = anpc.a(BaseApplication.getContext());
      ((anpc)localObject2).collectPerformance("", "Camera2Support", true, 0L, 0L, (HashMap)localObject1, "");
      if (!CameraCaptureView.b.cFW) {
        break label513;
      }
      ...
      ((anpc)localObject2).collectPerformance("", "Camera2RunState", true, 0L, 0L, localHashMap, "");
      paramInt1 = 1;
      break label515;
      g(paramInt1, paramInt3, paramLong);
      label370:
  ...
  public static void f(int paramInt1, int paramInt2, long paramLong)
  {
    ...
    anpc.a(BaseApplication.getContext()).collectPerformance("", str, true, paramLong, 0L, localHashMap, "");
  }
  
  public static void g(int paramInt1, int paramInt2, long paramLong)
  {
    if ((paramInt2 > 0) && (paramLong > 0L))
    {
      ...
      localHashMap.put("param_version", Build.VERSION.SDK_INT + "");
      localHashMap.put("param_deviceName", Build.MANUFACTURER + "_" + Build.MODEL);
      anpc.a(BaseApplication.getContext()).collectPerformance("", str, true, (int)f, 0L, localHashMap, "");
    }
  }
}
