...
public class arpv
  extends Handler
{
  public arpv(BindGroupConfirmActivity paramBindGroupConfirmActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      Bitmap localBitmap = artw.a(this.this$0, paramMessage, 50, 50);
      paramMessage.recycle();
      if (localBitmap == null) {
        break;
      }
      this.this$0.mAppIcon.setImageBitmap(localBitmap);
      return;
      i = j;
    }
  }
