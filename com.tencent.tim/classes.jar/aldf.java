...
public class aldf
{
  ...
  public CharSequence a(aetb paramaetb)
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    Object localObject = paramaetb.a().jQ;
    localSpannableStringBuilder.append(paramaetb.a().recommendTitle);
    int i = 0;
    while (i < ((ArrayList)localObject).size()) {
      if (TextUtils.isEmpty(((aetb.b)((ArrayList)localObject).get(i)).topicName))
      {
        i += 1;
      }
      else
      {
        ...
        paramaetb = ((aetb.b)((ArrayList)localObject).get(i)).topicName;
        localObject = new ForegroundColorSpan(Color.parseColor("#4D94FF"));
        localSpannableStringBuilder.append(paramaetb);
        localSpannableStringBuilder.setSpan(localObject, j, paramaetb.length() + j, 33);
      }
    }
    return localSpannableStringBuilder;
  }
  
  public boolean bm(QQAppInterface paramQQAppInterface)
  {
  ...
  public boolean bn(QQAppInterface paramQQAppInterface)
  {
  ...
  public List<oidb_0xd9f.UinItem> bo(List<oidb_0xd9f.TopicItem> paramList)
  {
  ...
  public boolean bo(QQAppInterface paramQQAppInterface)
  {
    boolean bool = false;
    if (aeif.a().q(529, paramQQAppInterface.getCurrentAccountUin()) > paramQQAppInterface.getApp().getSharedPreferences(paramQQAppInterface.getCurrentAccountUin(), 0).getLong("recommend_topic_version", -1L)) {
      bool = true;
    }
    return bool;
  }
  
  public void c(QQAppInterface paramQQAppInterface, RichStatus paramRichStatus)
  {
    ...
    while (!a().bn(str, paramRichStatus.feedsId)) {
      return;
    }
  ...
  public Pair<Integer, String> d(List<oidb_0xd9f.TopicItem> paramList)
  {
    int j = -1;
    String str1 = "";
    int i = j;
  ...
  public void dD(QQAppInterface paramQQAppInterface)
  {
  ...
  public void dE(QQAppInterface paramQQAppInterface)
  {
  ...
  public void dF(QQAppInterface paramQQAppInterface)
  {
    long l = aeif.a().q(529, paramQQAppInterface.getCurrentAccountUin());
  ...
  public long e(List<oidb_0xd9f.TopicItem> paramList)
  {
    long l2 = -1L;
    long l1 = l2;
    if (paramList != null)
  ...
  public boolean k(QQAppInterface paramQQAppInterface, long paramLong)
  {
    boolean bool = false;
    ...
    {
      n(paramQQAppInterface, paramLong);
      bool = true;
    }
    return bool;
  }
  
  public void n(QQAppInterface paramQQAppInterface, long paramLong)
  {
  ...
  public int w(List<oidb_0xd9f.TopicItem> paramList)
  {
    int k;
    if ((paramList == null) || (paramList.size() <= 0))
    {
  ...
  static class a
  {
    private static final aldf a = new aldf(null);
  }
}
