...
{
  private final roo.a a;
  
  public roo(Context paramContext, GestureDetector.OnGestureListener paramOnGestureListener)
  {
    this(paramContext, paramOnGestureListener, null);
  }
  
  public roo(Context paramContext, GestureDetector.OnGestureListener paramOnGestureListener, Handler paramHandler)
  {
    this.a = new roo.b(paramContext, paramOnGestureListener, paramHandler);
  }
    ...
    implements roo.a
  {
    ...
    public b(Context paramContext, GestureDetector.OnGestureListener paramOnGestureListener, Handler paramHandler)
    {
      ...
      for (this.mHandler = new roo.b.a(paramHandler);; this.mHandler = new roo.b.a())
      {
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent)
    {
      ...
      case 2: 
        ...
        } while ((this.mInLongPress) && (!this.aJe));
      ...
      extends Handler
    {
      ...
      public void handleMessage(Message paramMessage)
      {
        ...
        case 1: 
          roo.b.this.mListener.onShowPress(roo.b.this.mCurrentDownEvent);
        }
        do
        {
          return;
          roo.b.this.dispatchLongPress();
          return;
        } while (roo.b.this.mDoubleTapListener == null);
        if (!roo.b.this.mStillDown)
        {
          roo.b.this.mDoubleTapListener.onSingleTapConfirmed(roo.b.this.mCurrentDownEvent);
          return;
        }
        roo.b.this.mDeferConfirmSingleTap = true;
      }
    }
  }
}
