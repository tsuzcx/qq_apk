...
{
  adwy(RockDownloaderTask paramRockDownloaderTask) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (1 == paramInt)
    {
      ...
      if (localObject == null)
      {
        ...
        {
          this.a.getRockDownloadListener().onDownloadFail(this.a.getDownloadInfo(), acfp.m(2131713979), 10003);
