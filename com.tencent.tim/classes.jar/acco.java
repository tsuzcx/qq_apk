  ...
  extends accg
{
  ...
  public acco(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(chatbgInfo.Bg_CheckAuth_Rsp paramBg_CheckAuth_Rsp)
  {
    ...
    localObject1 = ((ChatBackgroundManager)this.app.getManager(63)).Q();
    Object localObject2 = this.app.getApplication().getApplicationContext();
  ...
  public void ae(Map<Integer, Integer> paramMap)
  {
    HashMap localHashMap = ((ChatBackgroundManager)this.app.getManager(63)).P();
    SharedPreferences.Editor localEditor = wkj.getSharedPreferences(this.app.getApplication().getApplicationContext(), this.app.getCurrentAccountUin(), 0).edit();
