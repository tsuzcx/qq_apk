  ...
  implements WtloginManager
{
  ...
  public WtloginManagerImpl(AppRuntime paramAppRuntime)
  {
    ...
    this.localWtloginHelper = new WtloginHelper(paramAppRuntime.getApplication(), true, WtloginPrivacyListenerImpl.getSingleton());
  }
  ...
  public int GetStViaSMSVerifyLogin(String paramString1, String paramString2, int paramInt, WtloginObserver paramWtloginObserver)
  {
    ...
    localNewIntent.putExtra("appid", paramInt);
    if ("com.tencent.tim:openSdk".equals(this.app.getApplication().getQQProcessName())) {
  ...
  {
    this.localWtloginHelper = new WtloginHelper(paramContext, true, WtloginPrivacyListenerImpl.getSingleton());
  }
