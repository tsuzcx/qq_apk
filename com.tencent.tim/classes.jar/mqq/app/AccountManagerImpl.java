  ...
  implements AccountManager
{
  ...
  public void sendRegisterBySetPass(String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean, String paramString5, String paramString6, AccountObserver paramAccountObserver)
  {
    NewIntent localNewIntent = new NewIntent(this.app.getApplication(), BuiltInServlet.class);
    ...
    localNewIntent.putExtra("appVersion", paramString5);
    localNewIntent.putExtra("wx_token", paramString6);
    localNewIntent.setObserver(paramAccountObserver);
    localNewIntent.withouLogin = true;
    this.app.startServlet(localNewIntent);
  }
  ...
  {
    sendRegisterBySetPass(paramString1, paramString2, paramString3, paramString4, paramBoolean, paramString5, null, paramAccountObserver);
  }
