  ...
  implements VerifyDevLockManager
{
  ...
  private void notifyUI(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, int paramInt, ErrMsg paramErrMsg, DevlockInfo paramDevlockInfo)
  {
    ...
    for (;;)
    {
      ...
      label515:
      for (paramToServiceMsg = "null";; paramToServiceMsg = localVerifyDevLockWrapper.mVerifyDevLockObserver)
      {
        ...
        if (!"com.tencent.tim:mail".equals(str4)) {
          break;
        }
        paramToServiceMsg = new Intent();
        paramToServiceMsg.setAction("com.tencent.androidqqmail.tim.devlock");
        ...
        this.mApp.getApplication().sendBroadcast(paramToServiceMsg);
        return;
      }
      paramToServiceMsg = new Intent();
      paramToServiceMsg.setFlags(268435456);
      if ("com.tencent.tim:openSdk".equals(str4))
      {
  ...
  public void gatewayVerify(VerifyDevLockManager.VerifyDevLockObserver paramVerifyDevLockObserver, byte[] paramArrayOfByte)
  {
    ...
    paramVerifyDevLockObserver = this.mApp.getService().msfSub.getCheckSMSAndGetStMsg(localVerifyDevLockWrapper.mUin, new byte[0]);
    ...
    {
      String str = (String)((ToServiceMsg)localObject).getAttribute("from_where");
      localObject = (String)((ToServiceMsg)localObject).getAttribute("mainaccount");
      paramVerifyDevLockObserver.addAttribute("from_where", str);
  ...
  public void submitSms(VerifyDevLockManager.VerifyDevLockObserver paramVerifyDevLockObserver, String paramString)
  {
    ...
    ToServiceMsg localToServiceMsg = localVerifyDevLockWrapper.mToServiceMsg;
    localVerifyDevLockWrapper.mVerifyDevLockObserver = paramVerifyDevLockObserver;
    ...
    paramString = localToServiceMsg.getAttribute("targetTicket");
    if ((paramString != null) && ((paramString instanceof Integer))) {
      paramVerifyDevLockObserver.addAttribute("targetTicket", (Integer)paramString);
    }
    VerifyCodeManagerImpl.addConnectData(localVerifyDevLockWrapper.mToServiceMsg, paramVerifyDevLockObserver);
    this.mApp.getService().msfSub.sendMsg(paramVerifyDevLockObserver);
  }
