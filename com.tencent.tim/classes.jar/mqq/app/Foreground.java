  ...
  implements Handler.Callback
{
  ...
  private static List<AppLifeCycleCallback> callbacks = new LinkedList();
  ...
  public static void onCreate(Activity paramActivity)
  {
    synchronized (callbacks)
    {
      ...
      if (localIterator.hasNext()) {
        ((AppLifeCycleCallback)localIterator.next()).onActivityCreated(paramActivity);
      }
    }
  }
  ...
  public static void onDestroy(Activity paramActivity)
  {
    synchronized (callbacks)
    {
      Iterator localIterator = callbacks.iterator();
      if (localIterator.hasNext()) {
        ((AppLifeCycleCallback)localIterator.next()).onActivityDestroyed(paramActivity);
      }
    }
  }
  ...
  public static void registerLifeCycleCallback(AppLifeCycleCallback paramAppLifeCycleCallback)
  {
    synchronized (callbacks)
    {
  ...
  public static void unregisterLifeCycleCallback(AppLifeCycleCallback paramAppLifeCycleCallback)
  {
    synchronized (callbacks)
    {
      ...
      if (sCountActivity > 0)
      {
        ...
        synchronized (callbacks)
        {
          ...
          if (localIterator2.hasNext()) {
            ((AppLifeCycleCallback)localIterator2.next()).onRunningForeground();
          }
        }
      ...
      if (sCountActivity == 0)
      {
        ...
        synchronized (callbacks)
        {
          ...
          if (localIterator1.hasNext()) {
            ((AppLifeCycleCallback)localIterator1.next()).onRunningBackground();
          }
        }
        try
        {
  ...
  public static abstract interface AppLifeCycleCallback
  {
