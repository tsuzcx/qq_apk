  ...
  implements TicketManager
{
  ...
  public TicketManagerImpl(AppRuntime paramAppRuntime)
  {
    ...
    this.mWtLoginHelper = new WtloginHelper(BaseApplication.getContext(), this, WtloginPrivacyListenerImpl.getSingleton());
  ...
  public void reloadCache(Context paramContext)
  {
    ...
    if (this.mWtLoginHelper == null) {
      this.mWtLoginHelper = new WtloginHelper(paramContext, true, WtloginPrivacyListenerImpl.getSingleton());
    }
