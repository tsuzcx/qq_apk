...
class SecurityUtile
{
  ...
  public static void setKey(Context paramContext)
  {
    ...
    try
    {
      str = alla.a((TelephonyManager)paramContext.getApplicationContext().getSystemService("phone"));
      if (str != null)
      {
        localObject = str;
      ...
      localObject = str;
      paramContext = alkz.c(alkz.a((WifiManager)paramContext.getSystemService("wifi")));
    }
