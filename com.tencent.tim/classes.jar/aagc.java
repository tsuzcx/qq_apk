...
public class aagc
{
  public static boolean H(Context paramContext)
  {
    ...
    if (aqcx.dip2px(paramContext, 650.0F) < localDisplayMetrics.heightPixels) {}
  ...
  public static Bundle a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    for (;;)
    {
      ...
      i = 0;
      paramSessionInfo = p(paramQQAppInterface);
      continue;
      i = 2;
      paramSessionInfo = p(paramQQAppInterface);
      continue;
      ...
      int j;
      if ((localObject != null) && (((HotChatManager)localObject).kj(paramSessionInfo.aTl)))
      {
        j = 5;
        localObject = aqgv.G(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin());
        paramSessionInfo = (SessionInfo)localObject;
        i = j;
  ...
  {
    paramString1 = a(paramString2, paramString1, paramInt1, paramString3, paramString4, paramString7, paramSessionInfo.troopUin, paramInt2, paramInt3, paramInt4, paramString8, paramInt5, paramBundle, paramSessionInfo.aTl);
  ...
  public static JSONObject a(QQAppInterface paramQQAppInterface, MessageForQQWalletMsg paramMessageForQQWalletMsg, QQWalletTransferMsgElem paramQQWalletTransferMsgElem, int paramInt1, SessionInfo paramSessionInfo, int paramInt2, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    for (;;)
    {
      paramQQWalletTransferMsgElem = a(paramString2, paramString1, paramInt2, paramString3, paramString4, paramString7, paramMessageForQQWalletMsg.senderuin, paramInt1, i, j, "", paramMessageForQQWalletMsg.fromHBList, null, paramSessionInfo.aTl);
      try
      {
      ...
      catch (Exception paramSessionInfo)
      {
        try
        {
          do
          {
            ...
            paramSessionInfo.put("senderuin", top.g(paramMessageForQQWalletMsg));
            return paramSessionInfo;
            paramSessionInfo = paramSessionInfo;
          } while (!QLog.isDevelopLevel());
          paramSessionInfo.printStackTrace();
  ...
  public static String p(QQAppInterface paramQQAppInterface)
  {
    String str = paramQQAppInterface.getCurrentAccountUin();
    paramQQAppInterface = ((acff)paramQQAppInterface.getManager(51)).e(str);
