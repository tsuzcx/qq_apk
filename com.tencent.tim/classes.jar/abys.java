...
final class abys
  implements abto.b
{
  abys(String paramString, String[] paramArrayOfString, abyp paramabyp, int paramInt) {}
    ...
    if (paramBoolean)
    {
      ...
      if (paramArrayOfInt.exists()) {
        try
        {
          ...
          {
            QLog.d("ApolloHttpUtil", 2, new Object[] { "fakeResource3DUrlRequest onDownLoadFinish retHeader:", paramString + " id:" + this.val$id });
            return;
