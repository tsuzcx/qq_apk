  ...
  extends MSFServlet
{
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4, String paramString5, long paramLong, BusinessObserver paramBusinessObserver)
  {
    ...
    {
      return;
      NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), aijc.class);
  ...
  private static void a(String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, long paramLong, BusinessObserver paramBusinessObserver)
  {
    ...
    aneg.a(paramString1, paramLong, Base64.encodeToString(localAppConfRequest.toByteArray(), 11), new aijd(paramInt, paramBusinessObserver));
  }
  ...
  private void l(Intent paramIntent, Packet paramPacket)
  {
  ...
  private void u(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      ((FaceDetectForThirdPartyManager.AppConf)localObject2).actionReq = j(str3);
