  ...
  implements AladdinConfigHandler
{
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramInt1 == 200)
      {
        if ((TextUtils.equals(str1, "ad_guide_area")) && (!TextUtils.isEmpty(str2))) {
          awit.jD("sp_key_ad_soft_total_area", str2.trim());
        }
        if ((TextUtils.equals(str1, "ad_max_num")) && (!TextUtils.isEmpty(str2))) {
          awit.jD("sp_key_ad_soft_ad_max", str2.trim());
        }
        if ((TextUtils.equals(str1, "kd_max_num")) && (!TextUtils.isEmpty(str2))) {
          awit.jD("sp_key_ad_soft_kd_max", str2.trim());
        }
      }
    }
    return true;
  ...
  public void onWipeConfig(int paramInt)
  {
    if (paramInt == 200)
    {
      awit.jD("sp_key_ad_soft_total_area", "0");
      awit.jD("sp_key_ad_soft_ad_max", "25");
      awit.jD("sp_key_ad_soft_kd_max", "25");
    }
  }
}
