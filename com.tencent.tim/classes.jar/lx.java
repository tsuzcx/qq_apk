...
public class lx
{
  ...
  public static void a(Camera.Parameters paramParameters)
  {
    ...
    try
    {
      ...
      if ((localList.contains("continuous-video")) && (adfw.a().bMH)) {
  ...
  public static void a(Camera paramCamera, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    try
    {
      Object localObject1 = h.invoke(localParameters, (Object[])null);
      List localList;
      Object localObject3;
    ...
    catch (IllegalArgumentException localIllegalArgumentException1)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          localObject2 = (List)g.invoke(localParameters, (Object[])null);
          if (localObject2 != null)
          {
            paramInt1 = b((List)localObject2);
            if (paramInt1 != -1) {
    ...
    catch (IllegalAccessException localIllegalAccessException1)
    {
      for (;;)
      {
        ...
        {
          localSize1 = getOptimalPreviewSize(localList, paramInt1, paramInt2);
          if (localSize1 != null) {
            break;
          }
          localSize1 = getOptimalPreviewSize(localList, 640, 480);
        }
        else
        {
          localSize1 = getOptimalPreviewSize(localSize1, 1280, 720);
        }
      }
    }
  ...
  private static void eY()
  {
    try
    {
      h = Camera.Parameters.class.getMethod("getSupportedPreviewSizes", (Class[])null);
      try
      {
        label14:
        g = Camera.Parameters.class.getMethod("getSupportedPreviewFormats", (Class[])null);
        return;
      }
  ...
  public static Camera.Size getOptimalPreviewSize(List<Camera.Size> paramList, int paramInt1, int paramInt2)
  {
    if (paramList == null) {
      return null;
    }
