...
public class kdl
{
  private static List<List<String>> fV;
  private static List<Map<String, Integer>> fW;
  ...
  public static void a(CustomWebView paramCustomWebView)
  {
    ...
    if ((paramCustomWebView != null) && (paramCustomWebView.getPluginEngine() != null))
    {
      ...
      localWebViewPlugin = paramCustomWebView.b("JD_REPORT");
    ...
    paramCustomWebView.aa(new String[] { "JD_REPORT" });
    return;
    label75:
    ((sst)localWebViewPlugin).tF(str);
  }
  
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2)
  {
    if ((!(paramAppInterface instanceof BrowserAppInterface)) || (TextUtils.isEmpty(paramString1)) || (fW == null)) {}
    String str;
    do
    {
      return;
    ...
    if (i < fV.size())
    {
      localObject2 = ((List)fV.get(i)).iterator();
      while (((Iterator)localObject2).hasNext()) {
        if (str.contains((String)((Iterator)localObject2).next())) {
          localObject1 = (Map)fW.get(i);
        }
      }
    }
    for (int j = 1;; j = 0)
    {
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          {
            localObject2 = (kec)paramAppInterface.getBusinessHandler(0);
            if (localObject2 == null) {
              break label339;
            }
            ((kec)localObject2).a(i, null, paramString2, null, null, 0L, false);
            return;
            i += 1;
            break;
          }
  ...
  public static void aBJ()
  {
    ...
    do
    {
      ...
      fW = new ArrayList();
      fV = new ArrayList();
      localObject1 = new File(kdm.Yq);
    } while ((!((File)localObject1).exists()) || (!((File)localObject1).isFile()));
    Object localObject1 = aqhq.readFileContent((File)localObject1);
    for (;;)
    {
      int i;
      try
  ...
  {
    if ((fV == null) || (fV.isEmpty()) || (TextUtils.isEmpty(paramString))) {
      return false;
    }
    ...
    do
    {
      Iterator localIterator1 = fV.iterator();
