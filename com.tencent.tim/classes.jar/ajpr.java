...
class ajpr
  extends jnm.a
{
  ajpr(ajpp paramajpp, ajpa paramajpa, long paramLong) {}
      ...
      if (paramArrayOfByte != null) {
        for (;;)
        {
          try
          {
            ...
            if (paramArrayOfByte.hasNext())
            {
              ...
              if (paramBundle.uint32_result.get() == 0) {
                this.jdField_a_of_type_Ajpa.O(paramBundle.uint64_uin.get(), paramBundle.uint64_tinyid.get());
              }
            }
            else
            {
          ...
          catch (InvalidProtocolBufferMicroException paramArrayOfByte)
          {
            ...
            this.jdField_a_of_type_Ajpa.O(this.val$uin, -1L);
          }
          this.jdField_a_of_type_Ajpa.O(this.val$uin, -1L);
