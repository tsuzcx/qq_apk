...
public class ahtj
  extends accg
{
  private static String TAG = bLH + "GameCenterUnissoHandler";
  public static String bLH = "GameCenterMsg.";
  private QQAppInterface mApp;
  
  public ahtj(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.mApp = paramQQAppInterface;
  }
  
  private ahsz a(GameUserInfo paramGameUserInfo)
  {
    if (paramGameUserInfo == null) {
      return null;
    }
    ahta localahta = (ahta)this.mApp.getManager(358);
    if (GameUserInfo.isUsrInfoUpdate(localahta.a(paramGameUserInfo.mRoleId), paramGameUserInfo))
    {
      QLog.i(TAG, 1, "[notifyGameUsrInfoChanged], roleId:" + paramGameUserInfo.mRoleId);
      return ahsz.a(localahta.a(paramGameUserInfo.mAppId), paramGameUserInfo);
    }
    return null;
  }
  ...
  private void l(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if (QLog.isColorLevel()) {
      QLog.d(TAG, 0, "[handleGetGameSwitch]");
    }
    if ((paramArrayOfByte != null) && (paramFromServiceMsg != null)) {
      try
      {
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (i != 0)
          {
            QLog.w(TAG, 1, "errMsg:" + paramFromServiceMsg);
            return;
          }
          if (QLog.isColorLevel()) {
            QLog.d(TAG, 0, "[handleGetGameSwitch] result: " + paramIntent.toString());
          }
          ...
          if (paramIntent != null)
          {
            ...
            ((ahta)this.mApp.getManager(358)).et(paramFromServiceMsg);
          }
        }
      }
      catch (Throwable paramIntent)
      {
        QLog.e(TAG, 1, paramIntent.getMessage());
        return;
      }
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(TAG, 0, "[handleGetUserInfoRsp]");
    }
    long l1;
    int i;
    ...
    try
    {
      ...
      paramIntent = (ahta)this.mApp.getManager(358);
      ...
      if (QLog.isColorLevel()) {
        QLog.d(TAG, 0, paramFromServiceMsg.toString());
      }
      ...
      if (i != 0)
      {
        QLog.w(TAG, 1, "errMsg:" + paramArrayOfByte);
        return;
      }
    ...
    if (paramIntent != null) {
      paramIntent.er(paramArrayOfByte);
    }
  }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.d(TAG, 0, "[onReceive], cmd:" + str);
      }
  ...
  public void dqb()
  {
    ...
    try
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(TAG, 0, ((JSONObject)localObject).toString());
      }
      localObject = new NewIntent(this.app.getApp(), ahtl.class);
  ...
  public void eu(ArrayList<String> paramArrayList)
  {
    if (QLog.isColorLevel()) {
      QLog.d(TAG, 0, "[getGameUserInfo] from svr");
    }
    ...
    {
      QLog.e(TAG, 1, paramArrayList.getMessage());
      return;
    }
    ...
    if (QLog.isColorLevel()) {
      QLog.d(TAG, 0, ((JSONObject)localObject1).toString());
    }
    paramArrayList = new NewIntent(this.app.getApp(), ahtl.class);
