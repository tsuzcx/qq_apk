...
public class ajms
{
  ...
  public static int[] c(Bitmap paramBitmap)
  {
    ...
    f(paramBitmap, arrayOfFloat);
    return new int[] { Color.HSVToColor(paramBitmap), Color.HSVToColor(arrayOfFloat) };
  }
  
  private static void e(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
  ...
  private static void f(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
