  ...
  extends rdb
{
  ...
  private int bpZ;
  private int bqa;
  protected ElasticImageView c;
  private RelativeLayout[] f;
  private RelativeLayout fS;
  protected RelativeLayout fT;
  private ImageView[] l;
  private List<rco.c> oB = new ArrayList();
  private ViewStub y;
  
  public rco(@NonNull rdc paramrdc)
  {
    super(paramrdc);
  }
  
  private void T(List<? extends rfa> paramList, boolean paramBoolean)
  {
    int j = 0;
    if (paramList == null)
    {
    ...
    if (paramBoolean)
    {
      ...
      if (((rfa)paramList.get(i)).bqJ != this.bqa) {}
    }
    for (;;)
    {
      if (i < 0)
      ...
      while (i < paramList.size())
      {
        ...
        if (j < this.oB.size())
        {
          ...
          while (((rfa)paramList.get(i)).bqJ != ((rco.c)this.oB.get(j)).bqJ)
          {
            j += 1;
            break;
          }
  ...
  private void eN(List<? extends rfa> paramList)
  {
    int i;
    int j;
    if (paramList == null)
    ...
    for (;;)
    {
      ...
      if (i == 1)
      {
        this.oB.add(new rco.c((rfa)paramList.get(0), null, null));
        return;
      }
      if (this.b.a.Ld()) {}
      int k;
      ...
      label368:
      localObject = rop.b(localrfa.cE, k, m, false);
      if (localObject != null) {}
      for (localObject = localqwh.z((Bitmap)localObject);; localObject = null)
      {
        this.oB.add(new rco.c(localrfa, (Bitmap)localObject, null));
        break;
      }
    }
  }
  
  private void eO(List<rco.c> paramList)
  {
    int j = 0;
    if (paramList == null) {}
    ...
    this.c = ((ElasticImageView)this.fS.findViewById(2131369885));
  ...
  private void eP(List<rco.c> paramList)
  {
    if (paramList == null) {}
    for (int i = 0; (i < 2) || (i > 6); i = paramList.size())
    {
    ...
    int n = (ankt.SCREEN_WIDTH - k * 2 - m * 5) / 6;
  ...
  private void eQ(List<rco.c> paramList)
  {
    int j = 0;
    if (!this.aY.get()) {
    ...
    for (;;)
    {
      ...
      while (i < paramList.size())
      {
        this.f[i].setOnTouchListener(new rco.a(i));
        i += 1;
      }
    }
  }
  
  private void eR(List<rco.c> paramList)
  {
    if (!this.aY.get())
    {
    ...
    if (i < this.f.length)
    {
      ...
      this.l[i].setBackgroundDrawable(new BitmapDrawable(((rco.c)paramList.get(i)).cB));
      this.l[i].setImageBitmap(((rco.c)paramList.get(i)).cA);
  ...
  private void wV(int paramInt)
  {
    ...
    for (;;)
    {
      if (i < this.oB.size())
      {
        if (paramInt == ((rco.c)this.oB.get(i)).bqJ)
        {
          ...
          ((rco.c)this.oB.get(i)).cA = this.a.g(paramInt);
        }
      }
      else {
        return;
  ...
  protected void ab(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      localrdc.d("clk_del", 0, 0, new String[] { "", localObject });
      return;
    }
  }
  ...
  public void g(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localValueAnimator.addListener(new rcp(this, paramView));
    localValueAnimator.addUpdateListener(new rcq(this, paramInt3, paramInt1, paramInt4, paramInt2, paramView));
  ...
  protected void wW(int paramInt)
  {
    ...
    if ((this.bpZ == ((rco.c)this.oB.get(paramInt)).bqJ) && (!this.aGS))
    {
    ...
    this.bqa = this.bpZ;
    this.bpZ = ((rco.c)this.oB.get(paramInt)).bqJ;
    if (!this.aGS)
    {
  ...
  {
    private final int PADDING = wja.dp2px(40.0F, rco.this.getResources());
    private Rect aE;
    private boolean aGT;
    private boolean aGU;
    private boolean aGV;
    ...
    public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
    {
      ...
      do
      {
        do
        {
          for (;;)
          {
            ...
            if (rco.this.BK > System.currentTimeMillis()) {
              return false;
            }
            this.mStartX = i;
            this.mStartY = j;
            this.bqh = paramView.getLeft();
            this.beW = (ankt.aC(rco.this.getContext()) - paramView.getBottom());
            this.bqj = 0;
            this.bqk = 0;
            this.mPointerId = paramMotionEvent.getPointerId(paramMotionEvent.getActionIndex());
            this.aGT = false;
            this.aGV = false;
            rco.this.dP(paramView);
            rco.this.wW(this.bqg);
            continue;
            ...
            this.bqk = (ankt.aC(rco.this.getContext()) - paramView.getBottom() - this.beW);
            this.mPointerId = k;
          }
        ...
        {
          this.aGV = true;
          rco.this.dQ(paramView);
        }
        rco.this.ar(this.bqg, false);
        this.mMarginLeft = (this.bqh + this.bqj + this.mOffsetX);
        this.bqi = (this.beW + this.bqk + this.mOffsetY);
        if (this.mMarginLeft < 0) {
          this.mMarginLeft = 0;
        }
        if (this.mMarginLeft + paramView.getWidth() > ankt.SCREEN_WIDTH) {
          this.mMarginLeft = (ankt.SCREEN_WIDTH - paramView.getWidth());
        }
        if (this.bqi < 0) {
          this.bqi = 0;
        }
        if (this.bqi + paramView.getHeight() > ankt.aC(rco.this.getContext())) {
          this.bqi = (ankt.aC(rco.this.getContext()) - paramView.getHeight());
        }
        ...
        rco.this.fT.setVisibility(0);
        rco.this.c.getGlobalVisibleRect(this.aE);
        paramView = this.aE;
        ...
        if (this.aE.contains(i, j))
        {
          this.aGU = true;
          rco.this.c.ag(1.5F);
          rco.this.c.getDrawable().setColorFilter(Color.parseColor("#F31919"), PorterDuff.Mode.MULTIPLY);
        }
        for (;;)
        {
          rco.this.b.changeState(23);
          break;
          if (this.aGU)
          {
            this.aGU = false;
            rco.this.c.ag(1.0F);
            rco.this.c.getDrawable().clearColorFilter();
          }
        }
      } while (!this.aGT);
      paramView.clearAnimation();
      if ((this.aE != null) && (this.aE.contains(i, j)))
      {
        ...
        rco.this.c.ag(1.0F);
        rco.this.c.getDrawable().clearColorFilter();
        rco.this.ab(this.bqg, this.bqh, this.beW);
        rco.this.wX(this.bqg);
      }
      for (;;)
      {
        rco.this.fT.setVisibility(4);
        rco.this.b.changeState(0);
        break;
        rco.this.g(paramView, paramView.getLeft(), ankt.aC(rco.this.getContext()) - paramView.getBottom(), this.bqh, this.beW);
        rco.this.ar(this.bqg, true);
      }
    }
  }
  ...
  class b
  {
    int AD = wja.dp2px(15.0F, rco.this.getResources());
    rba jdField_a_of_type_Rba = (rba)rco.this.a(rba.class);
    rbb jdField_a_of_type_Rbb = (rbb)rco.this.a(rbb.class);
    qwh b = new qwh(wja.dp2px(3.0F, rco.this.getResources()), 0, this.thumbHeight * 1.0F / this.thumbWidth, null, null);
    int bql = (ankt.SCREEN_WIDTH - this.AD * 2 - this.gap * 5) / 6;
    int gap = wja.dp2px(12.0F, rco.this.getResources());
    int padding = wja.dp2px(2.0F, rco.this.getResources());
    int thumbHeight = this.thumbWidth * 8 / 5;
    int thumbWidth = this.bql - this.padding * 2;
    
    public b() {}
    
    public void a(rfa paramrfa, rco.c paramc)
    {
      Bitmap localBitmap = rop.b(paramrfa.cE, this.thumbWidth, this.thumbHeight, false);
      paramrfa = null;
      if (localBitmap != null) {
        paramrfa = this.b.z(localBitmap);
      }
      paramc.cB = paramrfa;
    }
    ...
    public Bitmap g(int paramInt)
    {
      ...
      if (this.jdField_a_of_type_Rba != null) {
        if (this.jdField_a_of_type_Rba.y(paramInt))
        {
          localObject1 = localObject2;
          if (this.jdField_a_of_type_Rbb != null)
          {
            localObject1 = localObject2;
            if (!this.jdField_a_of_type_Rbb.eL(paramInt)) {}
          }
        }
        else
        {
          Bitmap localBitmap1 = this.jdField_a_of_type_Rba.e(paramInt);
          localObject1 = localObject2;
          if (localBitmap1 != null)
          {
            if (this.jdField_a_of_type_Rbb != null) {
              this.jdField_a_of_type_Rbb.a(paramInt, new Canvas(localBitmap1), localBitmap1.getWidth(), localBitmap1.getHeight());
            }
            Bitmap localBitmap2 = rop.b(localBitmap1, this.thumbWidth, this.thumbHeight, false);
            this.jdField_a_of_type_Rba.s(localBitmap1);
            localObject1 = localObject2;
    ...
    extends rfa
  {
    ...
    public c(rfa paramrfa, Bitmap paramBitmap1, Bitmap paramBitmap2)
    {
      this(paramrfa.bqJ, paramrfa.cE, paramBitmap1, paramBitmap2);
    }
  }
}
