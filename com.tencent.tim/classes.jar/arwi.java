  ...
  extends Handler
{
  ...
  public arwi(Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    Object localObject2 = ((Bundle)localObject1).getString(aryv.PARAM_TICKET);
    arwt.v("NoticeHintHandler", "+++++what:" + paramMessage.what + "+++++" + localObject1);
    localObject2 = arvv.a().d((String)localObject2);
    if (localObject2 != null)
    {
      if (((DownloadInfo)localObject2).ell == TMAssistantDownloadConst.SHOW_NOTIFICATION_TRUE) {
        arwt.d("NoticeHintHandler", "notification isShowNotification=" + ((DownloadInfo)localObject2).ell);
      }
    }
    else {
      return;
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          arwt.d("NoticeHintHandler", "notify key=" + this.a.nKey + " type=" + this.a.noticeType + "appid=" + this.a.appId);
          return;
      ...
      {
        arwt.e("NoticeHintHandler", "init Notification>>>", localException);
        continue;
        arwt.i("NoticeHintHandler", ">>downloading:" + this.a.appId);
        arwt.d("NoticeHintHandler", "size = " + ((DownloadInfo)localObject2).progress + " content = ");
        ...
        continue;
        arwt.i("NoticeHintHandler", ">>complete:" + this.a.appId);
        this.a.noticeType = 3;
        this.notification = asab.a().b(this.a);
      }
      if (this.notification == null) {
      ...
      for (;;)
      {
        ...
        asab.a().Xu(this.a.nKey);
        break;
        arwt.i("NoticeHintHandler", ">>download icon fail,so we use default notification icon");
        this.notification.contentView.setImageViewResource(2131372529, 2130845239);
      }
      arwt.i("NoticeHintHandler", ">>pause:" + this.a.appId);
      ...
      asab.a().Xu(this.a.nKey);
      continue;
      arwt.i("NoticeHintHandler", ">>error:" + this.a.appId);
      this.notification.contentView.setViewVisibility(2131372528, 0);
      this.notification.contentView.setViewVisibility(2131372523, 8);
      this.notification.contentView.setViewVisibility(2131372534, 8);
