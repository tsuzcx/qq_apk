...
public class akwn
  extends MSFServlet
{
  private PhoneContactManagerImp f;
  private int[] mm = new int[0];
  ...
  private void A(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      for (;;)
      {
        ...
        notifyObserver(paramIntent, 12, true, localBundle, akwl.class);
        return;
    ...
    notifyObserver(paramIntent, 12, false, null, akwl.class);
  }
  ...
  private void B(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      a().ao(((ResponeBindMobileV2)localObject).sessionSid);
      Bundle localBundle = new Bundle();
      ...
      for (;;)
      {
        notifyObserver(paramIntent, 35, true, localBundle, akwl.class);
        return;
    ...
    notifyObserver(paramIntent, 35, false, null, akwl.class);
  }
  ...
  private void C(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      a().ao(((ResponeReBindMobile)localObject).sessionSid);
      ...
      {
        notifyObserver(paramIntent, 19, true, (Bundle)localObject, akwl.class);
        return;
      }
      if (QLog.isColorLevel()) {
        QLog.d("PhoneContact.Servlet", 2, "BindNumberBusiness  rebind failed ,返回码不正确");
      }
      notifyObserver(paramIntent, 19, false, (Bundle)localObject, akwl.class);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("PhoneContact.Servlet", 2, "BindNumberBusiness  rebind failed ,response isSuccess = false");
    }
    notifyObserver(paramIntent, 19, false, null, akwl.class);
  }
  ...
  private void D(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      if ((paramFromServiceMsg.result == 0) || (paramFromServiceMsg.result == 105))
      {
        ...
        notifyObserver(paramIntent, 20, true, null, akwl.class);
        return;
      }
      notifyObserver(paramIntent, 20, false, null, akwl.class);
      return;
    }
    notifyObserver(paramIntent, 20, false, null, akwl.class);
  }
  ...
  private void E(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        a().clW();
        notifyObserver(paramIntent, 33, true, null, akwl.class);
        return;
      }
      notifyObserver(paramIntent, 33, false, null, akwl.class);
      return;
    }
    notifyObserver(paramIntent, 33, false, null, akwl.class);
  }
  ...
  private void F(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      Bundle localBundle = new Bundle();
      localBundle.putInt("k_result", paramFromServiceMsg.result);
      notifyObserver(paramIntent, 16, true, localBundle, akwl.class);
      return;
    }
    notifyObserver(paramIntent, 16, false, null, akwl.class);
  }
  ...
  private void G(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    NewIntent localNewIntent = new NewIntent(getAppRuntime().getApplication(), akwn.class);
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      if (((RespondHeader)localObject).result == 0)
      {
        ...
        notifyObserver(paramIntent, 14, true, null, akwl.class);
        return;
      }
      if ((((RespondHeader)localObject).result == 105) || (((RespondHeader)localObject).result == 107))
      {
        ...
        notifyObserver(paramIntent, 14, false, paramFromServiceMsg, akwl.class);
        return;
      }
  ...
  private void H(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    try
    {
      ...
      localNewIntent = new NewIntent(getAppRuntime().getApplication(), akwn.class);
      ...
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        if (((RespondHeader)localObject1).result == 0)
        {
          ...
          for (j = (j + 50) * 100 / ((ArrayList)localObject1).size();; j = 100)
          {
            ...
            notifyObserver(paramIntent, 100, true, (Bundle)localObject2, akwl.class);
            if (paramFromServiceMsg.nextFlag == 4294967295L) {
              break label539;
            }
            localNewIntent.putExtra("next_flag", paramFromServiceMsg.nextFlag);
          ...
          label539:
          notifyObserver(paramIntent, 31, true, null, akwl.class);
          return;
        }
        if ((((RespondHeader)localObject1).result == 105) || (((RespondHeader)localObject1).result == 107))
        {
          ...
          paramFromServiceMsg = new Bundle();
          paramFromServiceMsg.putInt("param_fail_reason", 1);
          notifyObserver(paramIntent, 31, false, paramFromServiceMsg, akwl.class);
          return;
        }
  ...
  private void I(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      {
        notifyObserver(paramIntent, 37, false, null, akwl.class);
        return;
      }
      continue;
      label518:
    ...
    notifyObserver(paramIntent, 37, true, null, akwl.class);
    return;
    label543:
    if ((((RespondHeader)localObject1).result == 109) || (((RespondHeader)localObject1).result == 108))
    {
      ...
      if (((RespondHeader)localObject1).result == 109)
      {
        i = 4;
        paramFromServiceMsg.putInt("param_fail_reason", i);
        notifyObserver(paramIntent, 37, false, paramFromServiceMsg, akwl.class);
      }
    }
    else
    {
  ...
  private void J(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        paramIntent = new NewIntent(getAppRuntime().getApplication(), akwn.class);
      ...
      notifyObserver(paramIntent, 32, true, null, akwl.class);
      return;
      label452:
      notifyObserver(paramIntent, 32, false, null, akwl.class);
      return;
    }
    notifyObserver(paramIntent, 32, false, null, akwl.class);
  }
  ...
  private void K(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      do
      {
        ...
        notifyObserver(paramIntent, 15, true, null, akwl.class);
    ...
    if (((RespondHeader)localObject).result == 105)
    {
      ...
      paramFromServiceMsg = new Bundle();
      paramFromServiceMsg.putInt("param_fail_reason", 1);
      notifyObserver(paramIntent, 15, false, paramFromServiceMsg, akwl.class);
      return;
    }
    if (localBundle.getBoolean("is_resend"))
    {
  ...
  private void L(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      do
      {
        ...
        notifyObserver(paramIntent, 38, true, null, akwl.class);
      } while (!localBundle.containsKey("add_contact_list"));
      paramIntent = (ArrayList)localBundle.getSerializable("rename_contact_list");
    } while (paramIntent.size() == 0);
    a().df(paramIntent);
    ...
    if ((paramFromServiceMsg.result == 109) || (paramFromServiceMsg.result == 108))
    {
      ...
      for (i = 4;; i = 5)
      {
        ...
        notifyObserver(paramIntent, 38, false, localBundle, akwl.class);
        return;
      }
    }
    if (localBundle.getBoolean("is_resend"))
    {
      ...
      {
        paramFromServiceMsg.putInt("param_fail_reason", i);
        notifyObserver(paramIntent, 38, false, paramFromServiceMsg, akwl.class);
        return;
      }
    }
    localNewIntent.putExtra("next_flag", ((ResponeUpdateAddressBookNotBind)localObject).nextFlag);
  ...
  private void M(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    if (paramFromServiceMsg.isSuccess())
    {
      if (((RespondHeader)decodePacket(paramFromServiceMsg.getWupBuffer(), "RespondHeader", new RespondHeader())).result == 0)
      {
        notifyObserver(paramIntent, 17, true, null, akwl.class);
        return;
      }
      notifyObserver(paramIntent, 17, false, null, akwl.class);
      return;
    }
    notifyObserver(paramIntent, 17, false, null, akwl.class);
  }
  ...
  private void N(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
        ...
        if ((localObject != null) && (paramFromServiceMsg != null))
        {
          ...
          if (((RespondHeader)localObject).result == 0)
          {
            ...
            if (paramFromServiceMsg.queryFlag == 1)
            {
              ...
              int k = a().xx();
              localObject = new NewIntent(getAppRuntime().getApplication(), akwn.class);
              ...
              a().gv(paramFromServiceMsg.UIBits);
            }
          }
        }
      }
      for (int i = 1;; i = 0)
      {
        ...
        notifyObserver(paramIntent, 30, false, null, akwl.class);
        return;
        bool = false;
        break label329;
        if (QLog.isColorLevel()) {
        ...
        notifyObserver(paramIntent, 12, true, (Bundle)localObject, akwl.class);
        localObject = new Bundle();
        ((Bundle)localObject).putInt("param_update_flag", j);
        notifyObserver(paramIntent, 30, true, (Bundle)localObject, akwl.class);
        break label555;
        if ((((RespondHeader)localObject).result == 105) || (((RespondHeader)localObject).result == 107))
        {
          a(paramFromServiceMsg);
  ...
  private void O(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        notifyObserver(paramIntent, 34, false, localBundle, akwl.class);
        return;
      }
      if (QLog.isColorLevel()) {
      ...
      if (paramFromServiceMsg.result == 0)
      {
        ...
        a().be(paramIntent.getStringExtra("unique_phone_no"), bool);
        notifyObserver(paramIntent, 34, true, localBundle, akwl.class);
        return;
      }
      notifyObserver(paramIntent, 34, false, localBundle, akwl.class);
      return;
  ...
  private void P(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      LoginWelcomeManager.a((QQAppInterface)getAppRuntime()).ln(paramIntent);
      return;
    }
  }
  ...
  private ResponeQueryQQMobileContactsV3 a(UniPacket paramUniPacket)
  {
    ...
    if (localCompressedPackage != null)
    {
      ...
      for (paramUniPacket = inflate(localCompressedPackage.buffer);; paramUniPacket = localCompressedPackage.buffer)
      {
  ...
  {
    if (this.f == null) {
      this.f = ((PhoneContactManagerImp)getAppRuntime().getManager(11));
    }
    return this.f;
  }
  ...
  private void a(ResponeQueryQQMobileContactsV3 paramResponeQueryQQMobileContactsV3)
  {
    ...
    a().n(paramResponeQueryQQMobileContactsV3.nextQueryTimeInterval * 1000L, paramResponeQueryQQMobileContactsV3.nextReLoginTimeInterval * 1000L, paramResponeQueryQQMobileContactsV3.nextReconnectionTimeInterval * 1000L);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, String paramString)
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), akwn.class);
  ...
  private void y(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    boolean bool2 = false;
    Bundle localBundle = new Bundle();
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        notifyObserver(paramIntent, 26, false, localBundle, akwl.class);
        return;
      }
      paramFromServiceMsg = null;
      if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        notifyObserver(paramIntent, 26, true, localBundle, akwl.class);
        return;
  ...
  private void z(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    boolean bool = false;
    Bundle localBundle = new Bundle();
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        localBundle.putBoolean("bind_state", false);
        notifyObserver(paramIntent, 27, false, localBundle, akwl.class);
        return;
      }
      if (localRespondHeader.result == 0)
      {
      ...
      notifyObserver(paramIntent, 27, true, localBundle, akwl.class);
      return;
    }
    localBundle.putBoolean("bind_state", false);
    notifyObserver(paramIntent, 27, false, localBundle, akwl.class);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      {
        y(paramIntent, paramFromServiceMsg);
        return;
      }
      if (str.equals("account.RequestReBindMblWTLogin_emp"))
      {
        z(paramIntent, paramFromServiceMsg);
        return;
      }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    case 12: 
      ...
      paramPacket.addRequestPacket("RequestQueryQQBindingStat", new RequestQueryQQBindingStat(a().pS()));
      return;
    case 26: 
