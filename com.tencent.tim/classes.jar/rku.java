...
public class rku
{
  ...
  public rku(int paramInt1, int paramInt2, String paramString1, float paramFloat, boolean paramBoolean1, int paramInt3, double paramDouble1, double paramDouble2, String paramString2, int paramInt4, boolean paramBoolean2)
  {
    this.bsU = paramInt1;
    this.bsV = paramInt2;
  ...
  public rku(@NonNull Bitmap paramBitmap, @NonNull String paramString, int paramInt1, int paramInt2, int paramInt3, float paramFloat, double paramDouble1, double paramDouble2, int paramInt4)
  {
    this.bN = paramString;
    this.mOrientationDegree = paramInt3;
    this.dw = paramFloat;
  ...
  private int tD()
  {
    ...
    for (;;)
    {
      return i;
      int j;
      if (this.cL.getWidth() > this.cL.getHeight()) {
        if (this.mThumbWidth < this.gP)
        {
          j = this.mThumbWidth;
      ...
      for (;;)
      {
        localBitmap = rop.b(this.cL, this.mThumbWidth, this.gP, true);
        if (localBitmap != null) {
          break;
        }
        ram.e("Q.qqstory.publish.edit.GenerateThumbTask", "saveThumb error. resize thumb bitmap error.");
        return 1;
        if (this.mThumbWidth > this.gP)
        {
          j = this.mThumbWidth;
