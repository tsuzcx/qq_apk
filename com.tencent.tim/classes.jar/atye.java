...
public class atye
{
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, atye.a parama)
  {
    if (paramLong < 0L) {
      return;
    }
    ...
    jnm.b(paramQQAppInterface, new atyf(parama), localReqBody.toByteArray(), "OidbSvc.oidb_0x6e7", 1767, 0, null);
  }
