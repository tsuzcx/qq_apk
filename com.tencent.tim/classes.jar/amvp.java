...
{
  public amvp(GroupSearchEngine paramGroupSearchEngine, amwd paramamwd, String paramString, int paramInt)
  {
  ...
  {
    return new ampp(paramList, paramString, GroupSearchEngine.a(this.this$0));
  }
}
