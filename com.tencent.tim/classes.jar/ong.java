...
public class ong
{
  ...
  {
    ooz.w("898", "optionId:" + paramInt3);
    String str1 = opn.getSceneTypeTestId(4);
  ...
  public static void Y(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    default: 
      return;
    case 6: 
      a("weishi_share_officialacc", "feeds_popup_exp", paramInt2, 0, 0L, 0L, str, lD());
      return;
    case 112: 
      a("weishi_share_officialacc", "feeds_popup_clk", paramInt2, 0, 0L, 0L, str, lD());
      return;
    case 115: 
      a("weishi_share_officialacc", "feeds_popup_dl_ws", paramInt2, 0, 0L, 0L, str, lD());
      return;
    case 114: 
      a("weishi_share_officialacc", "feeds_popup_clk_ws", paramInt2, 0, 0L, 0L, str, lD());
      return;
    }
    a("officialacc_weishi", "feeds_popup_close", paramInt2, 0, 0L, 0L, str, lD());
  }
  ...
  public static String a(WSRedDotPushMsg paramWSRedDotPushMsg)
  {
    ...
    if (paramWSRedDotPushMsg != null)
    {
      ...
      bool = opn.a(paramWSRedDotPushMsg);
  ...
  public static void a(WSDownloadParams paramWSDownloadParams, int paramInt)
  {
    ...
    a("weishi_share_officialacc", "start_dl_ws", paramInt, 0, ohy.a().rs(), 0L, "", paramWSDownloadParams.mTestId);
  }
  ...
  {
    anot.a(null, "dc00898", "", "", paramString1, paramString2, paramInt1, paramInt2, String.valueOf(paramLong1), String.valueOf(paramLong2), paramString3, paramString4);
  }
  ...
  public static void a(boolean paramBoolean, WSDownloadParams paramWSDownloadParams)
  {
    ...
    {
      return;
      str = bL(paramWSDownloadParams.mScene);
    ...
    a(str, "dl_clk_officialdownloader", ohy.a().rs(), 0, 0L, 0L, "", paramWSDownloadParams.mTestId);
  }
  
  public static void ak(int paramInt, boolean paramBoolean)
  {
    a("weishi_share_officialacc", g(paramInt, paramBoolean), 0, 0, 0L, 0L, "", "");
  }
  ...
  public static void b(WSRedDotPushMsg paramWSRedDotPushMsg)
  {
    ...
    if (paramWSRedDotPushMsg != null)
    {
      ...
      i = ((WSPushStrategyInfo)localObject).mWSPushModel.aSO;
    ...
    for (;;)
    {
      ...
      long l1;
      long l2;
      if (rpw.isWeishiInstalled(BaseApplicationImpl.getApplication().getApplicationContext()))
      {
        l1 = 1L;
        l2 = j;
  ...
  {
    a("officialacc_weishi", "feeds_clk", 0, 0, -1L, 0L, "", lD());
    a("weishi_share_officialacc", "feeds_clk_ws", 0, 0, -1L, 0L, "", lD());
  }
  ...
  private static void c(String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramBoolean1)
    {
  ...
  private static String g(int paramInt, boolean paramBoolean)
  {
    String str1 = "";
    String str2 = "";
    switch (paramInt)
  ...
  {
    if (paramInt == 1) {
      c("officialacc_weishi", "weishi_share_officialacc", paramBoolean1, paramBoolean2);
    }
    while (paramInt != 2) {
      return;
    }
    c("trandstab_weishi", "weishi_share_trendstab", paramBoolean1, paramBoolean2);
  }
  ...
  {
    return opn.getSceneTypeTestId(1);
  }
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              a("officialacc_weishi", "single_video_exp", 0, 0, 0L, 0L, (String)paramObject, lD());
              return;
          ...
          a("officialacc_weishi", "push_video_clk", 0, 0, 0L, 0L, (String)paramObject, lD());
          return;
          if ((paramObject instanceof String))
          {
            a("officialacc_weishi", "feeds_clk", 0, 0, 0L, 0L, (String)paramObject, lD());
            return;
          }
        ...
        default: 
          return;
        case 2: 
          a("officialacc_weishi", "feeds_clk_videoplay", 0, 0, 0L, 0L, "", lD());
          return;
        case 115: 
          a("weishi_share_officialacc", "feeds_dl_ws", 0, 0, 0L, 0L, "", lD());
          return;
        }
        a("weishi_share_officialacc", "feeds_clk_ws", 0, 0, 0L, 0L, "", lD());
        return;
      } while ((!(paramObject instanceof Integer)) || (((Integer)paramObject).intValue() != 4));
      a("weishi_share_officialacc", "dtest_dl_ws", 0, 0, 0L, 0L, "", lD());
      return;
      String str = "";
      if (paramObject.getClass().isArray())
      {
        ...
        {
        default: 
          a("officialacc_weishi", "feeds_video_exp", 0, 0, 0L, 0L, "", lD());
        }
      }
      for (;;)
      {
        a("officialacc_weishi", "feeds_exp_cpl", 0, 0, 0L, 0L, str, lD());
        return;
        a("weishi_share_officialacc", "feeds_dl_exp", 0, 0, 0L, 0L, "", lD());
      }
    } while (!paramObject.getClass().isArray());
    paramObject = (Object[])paramObject;
  ...
  public static void q(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    paramInt3 += 1;
    ooz.e("898", "optionId:" + paramInt4);
    ...
    default: 
      return;
    case 6: 
      a("weishi_share_officialacc", "feeds_op_card_exp", paramInt2, 0, paramInt3, 0L, str, lD());
      return;
    case 112: 
      a("weishi_share_officialacc", "feeds_op_card_clk", paramInt2, 0, paramInt3, 0L, str, lD());
      return;
    case 115: 
      a("weishi_share_officialacc", "feeds_opcard_dl_ws", paramInt2, 0, paramInt3, 0L, str, lD());
      return;
    case 114: 
      a("weishi_share_officialacc", "feeds_opcard_clk_ws", paramInt2, 0, paramInt3, 0L, str, lD());
      return;
    }
    a("weishi_share_officialacc", "feeds_opcard_clk_h5", paramInt2, 0, paramInt3, 0L, str, lD());
  }
  ...
  public static void qS(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      a("weishi_share_zhibo", "zhibo_feeds_clk", 0, 0, 0L, 0L, "", lD());
      return;
    }
    a("weishi_share_zhibo", "zhibo_feeds_exp", 0, 0, 0L, 0L, "", lD());
  }
  ...
  public static void reportVideoPlayUpdateExp(int paramInt)
  {
    if (paramInt == 2) {
  ...
  {
    a("weishi_share_officialacc", "start_dl_ws_fin", paramInt, 0, ohy.a().rs(), 0L, "", "");
  }
