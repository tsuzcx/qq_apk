...
public class anbf
{
  ...
  private static HashMap<String, Integer> nf = ;
  
  protected static ArrayList<String> D(List<im_msg_body.Elem> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (localElem.deliver_gift_msg.has())
      {
      ...
      else if (anbg.a(localElem).booleanValue())
      {
  ...
  protected static boolean L(ArrayList<String> paramArrayList)
  {
  ...
  protected static int s(ArrayList<String> paramArrayList)
  {
    if (nf == null) {}
    synchronized (eH)
    {
    ...
    while (((Iterator)???).hasNext())
    {
      ...
      if ((nf != null) && (nf.containsKey(str))) {
        return ((Integer)nf.get(str)).intValue();
      }
    }
