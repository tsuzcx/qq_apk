...
public class aqri
  extends accg
{
  public CopyOnWriteArrayList<String> as = new CopyOnWriteArrayList();
  public AtomicBoolean et = new AtomicBoolean(false);
  public AtomicBoolean eu = new AtomicBoolean(false);
  
  public aqri(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, ArrayList<String> paramArrayList, ArrayList<Float> paramArrayList1, String paramString2)
  {
    ...
    paramArrayList.qqversion.set("3.4.4.3058");
    ...
    ((aqri)paramQQAppInterface.getBusinessHandler(103)).sendPbReq(paramArrayList1);
    if (QLog.isColorLevel()) {
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, float paramFloat1, float paramFloat2)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (aqri)paramAppRuntime.getBusinessHandler(103);
      if (!((aqri)localObject).eu.get()) {
        ((aqri)localObject).c(paramAppRuntime, false);
      }
      if (((aqri)localObject).et.get())
      {
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      if (((aqri)localObject).as.contains(paramString1))
      {
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      ThreadManager.post(new VasMonitorHandler.1(paramAppRuntime, paramString1, a(new String[] { "109", "3.4.4", paramString2, localObject, paramString4, paramString5 }), a(new Float[] { Float.valueOf(1.0F), Float.valueOf(paramFloat1), Float.valueOf(paramFloat2) }), paramString3), 5, null, false);
  ...
  public void c(AppRuntime paramAppRuntime, boolean paramBoolean)
  {
    this.eu.set(true);
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    QLog.i("VasMonitorHandler", 2, "onReceive res.isSuccess=" + paramFromServiceMsg.isSuccess() + ",data=" + aqoj.C((byte[])paramObject));
  }
}
