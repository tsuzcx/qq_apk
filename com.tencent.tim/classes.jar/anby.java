  ...
  implements anbs
{
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, anax paramanax)
  {
    ...
    if (anvq.bD(paramMessageHandler.app))
    {
      ...
      i2 = localObject6[i1];
      i1 += 1;
      i5 = aqoj.b((byte[])localObject6, i1);
      i6 = i1 + 2;
      if (i2 != 3) {
        break label509;
      }
      localObject3 = new byte[i5];
      aqoj.copyData((byte[])localObject3, 0, (byte[])localObject6, i6, i5);
      l2 = aqoj.getLongData((byte[])localObject3, 0);
      if (l2 > 0L) {
        l1 = l2;
      }
      if (QLog.isColorLevel()) {
      ...
      localObject1 = paramanax;
      paramanax = (anax)localObject3;
    }
    label481:
    label509:
    Object localObject4;
    ...
    {
      i1 = i6 + i5;
      localObject3 = paramanax;
      paramanax = (anax)localObject1;
      ...
      if (i2 == 9)
      {
        localObject3 = new byte[i5];
        aqoj.copyData((byte[])localObject3, 0, (byte[])localObject6, i6, i5);
        n = aqlv.kh(aqft.ag(aqoj.getLongData((byte[])localObject3, 0)));
        localObject3 = paramanax;
        paramanax = (anax)localObject1;
        localObject1 = localObject3;
      }
      else if (i2 == 8)
      {
        localObject3 = new byte[i5];
        aqoj.copyData((byte[])localObject3, 0, (byte[])localObject6, i6, i5);
        m = (int)aqoj.getLongData((byte[])localObject3, 0);
        localObject3 = paramanax;
        paramanax = (anax)localObject1;
        localObject1 = localObject3;
      }
      else
      {
        ...
        aqoj.copyData((byte[])localObject4, 0, (byte[])localObject6, i6, i5);
        ...
        try
        {
          ...
          paramanax = (anax)localObject4;
        }
        catch (Exception localException1)
        {
          localObject2 = paramanax;
          paramanax = (anax)localObject3;
          k = i3;
          j = i2;
          i = i1;
    ...
    for (;;)
    {
      ...
      for (localObject3 = ((ByteStringMicro)localObject3).toStringUtf8();; localObject3 = "") {
        for (;;)
        {
          ...
          {
            i1 = 1;
            anot.a(paramMessageHandler.app, "CliOper", "", "", "0X80060E4", "0X80060E4", i1, 0, "", "", "", "3.4.4");
            ...
            localObject7 = aqhs.bytes2HexStr(((im_msg_body.Ptt)localObject5).bytes_file_md5.get().toByteArray());
          }
          try
          {
            ...
            for (;;)
            {
              try
              {
                ...
                if (((generalflags.ResvAttr)localObject5).bytes_pb_ptt_waveform.has())
                {
                  ...
                  ((MessageForPtt)localObject4).waveformArray = aqjh.a((ptt_waveform.PttWaveform)localObject6);
                  if (QLog.isColorLevel())
                  {
            ...
            if (localRichText.elems.has())
            {
              ...
              while (paramList.hasNext())
              {
                ...
                if ((((im_msg_body.Elem)localObject2).common_elem.has()) && (21 == ((im_msg_body.Elem)localObject2).common_elem.uint32_service_type.get()))
                {
                  ...
                  aegu.a(paramMsg, (im_msg_body.Elem)localObject2, localArrayList, paramMessageHandler.app);
                }
              }
            }
            aagm.d(paramanax, (MessageRecord)localObject3);
            return;
          }
        }
      }
