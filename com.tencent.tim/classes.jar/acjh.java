  ...
  extends accg
{
  ...
  public static boolean ax(String paramString1, String paramString2)
  {
  ...
  public static boolean iy(int paramInt)
  {
    if (paramInt == 0) {
      return true;
    }
  ...
  public void a(safecheckPB.ReqMQScanRequest paramReqMQScanRequest, safecheckPB.RspMQScanReport paramRspMQScanReport)
  {
    ...
    try
    {
      localObject1 = ((PackageManager)localObject1).getPackageInfo(this.mContext.getPackageName(), 1);
  ...
  public void ay(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      if (!iy(((safecheckPB.ReqMQScanRequest)localObject).uint32_check_condition.get()))
      {
        acli.cMn();
        bIP = false;
        return;
  ...
  {
    paramReqMQScanRequest = this.mContext.getPackageManager();
  ...
  public void c(safecheckPB.ReqMQScanRequest paramReqMQScanRequest, safecheckPB.RspMQScanReport paramRspMQScanReport)
  {
    ...
    for (;;)
    {
      ...
      String str;
      if ((str != null) && (ax(paramReqMQScanRequest.string_check_target.get(), str)))
      {
        paramReqMQScanRequest = new safecheckPB.ReportItem();
  ...
  public void d(safecheckPB.ReqMQScanRequest paramReqMQScanRequest, safecheckPB.RspMQScanReport paramRspMQScanReport)
  {
    ...
    //   22: astore 14
    //   24: aload_0
    //   25: getfield 53	acjh:mContext	Landroid/content/Context;
    //   28: invokevirtual 59	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   31: astore 6
    //   33: aload 6
    //   35: aload_0
    //   36: getfield 53	acjh:mContext	Landroid/content/Context;
    //   39: invokevirtual 63	android/content/Context:getPackageName	()Ljava/lang/String;
    //   42: iconst_1
    //   43: invokevirtual 69	android/content/pm/PackageManager:getPackageInfo	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    //   46: astore 15
    //   48: new 306	com/tencent/commonsdk/zip/QZipFile
    //   51: dup
    //   52: aload 15
    //   54: getfield 131	android/content/pm/PackageInfo:applicationInfo	Landroid/content/pm/ApplicationInfo;
    //   57: getfield 136	android/content/pm/ApplicationInfo:sourceDir	Ljava/lang/String;
    //   60: invokespecial 308	com/tencent/commonsdk/zip/QZipFile:<init>	(Ljava/lang/String;)V
    //   63: astore 8
    //   65: aload 14
    //   67: astore 10
    //   69: aload 13
    ...
    //   85: aload 8
    //   87: ldc_w 310
    //   90: invokevirtual 314	com/tencent/commonsdk/zip/QZipFile:getEntry	(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
    //   93: astore 16
    //   95: aload 16
    //   97: ifnonnull +83 -> 180
    //   100: iconst_0
    //   101: ifeq +11 -> 112
    //   104: new 316	java/lang/NullPointerException
    //   107: dup
    //   108: invokespecial 317	java/lang/NullPointerException:<init>	()V
    //   111: athrow
    //   112: aload 8
    //   114: ifnull +8 -> 122
    //   117: aload 8
    //   119: invokevirtual 320	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   122: return
    //   123: astore_1
    //   124: aload_1
    //   125: invokevirtual 107	java/lang/RuntimeException:printStackTrace	()V
    //   128: iconst_0
    //   129: ifeq +11 -> 140
    //   132: new 316	java/lang/NullPointerException
    //   135: dup
    //   136: invokespecial 317	java/lang/NullPointerException:<init>	()V
    //   139: athrow
    //   140: iconst_0
    //   141: ifeq -19 -> 122
    //   144: new 316	java/lang/NullPointerException
    //   147: dup
    //   148: invokespecial 317	java/lang/NullPointerException:<init>	()V
    //   151: athrow
    //   152: astore_1
    //   153: aload_1
    //   154: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   157: return
    //   158: astore_1
    //   159: aload_1
    //   160: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   163: goto -23 -> 140
    //   166: astore_1
    //   167: aload_1
    //   168: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   171: goto -59 -> 112
    //   174: astore_1
    //   175: aload_1
    //   176: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   179: return
    //   180: aload 14
    //   182: astore 10
    //   184: aload 13
    ...
    //   200: aload 8
    //   202: aload 16
    //   204: invokevirtual 325	com/tencent/commonsdk/zip/QZipFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   207: astore 7
    //   209: aload 7
    ...
    //   216: ifnull +8 -> 224
    //   219: aload 7
    //   221: invokevirtual 328	java/io/InputStream:close	()V
    //   224: aload 8
    //   226: ifnull -104 -> 122
    //   229: aload 8
    //   231: invokevirtual 320	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   234: return
    //   235: astore_1
    //   236: aload_1
    //   237: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   240: return
    //   241: astore_1
    //   242: aload_1
    //   243: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   246: goto -22 -> 224
    //   249: aload 7
    //   251: astore 10
    //   253: aload 7
    ...
    //   294: astore 11
    //   296: ldc_w 330
    //   299: invokestatic 336	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   302: astore 13
    //   304: aload 7
    //   306: astore 10
    //   308: aload 7
    ...
    //   324: aload 7
    //   326: aload 12
    //   328: invokevirtual 340	java/io/InputStream:read	([B)I
    //   331: istore_3
    //   332: iload_3
    //   333: ifle +75 -> 408
    //   336: aload 7
    ...
    //   360: iconst_0
    //   361: iload_3
    //   362: invokevirtual 344	java/security/MessageDigest:update	([BII)V
    //   365: goto -61 -> 304
    //   368: astore_1
    //   369: aload 10
    //   371: astore 5
    ...
    //   375: astore 6
    //   377: aload_1
    //   378: invokevirtual 108	android/content/pm/PackageManager$NameNotFoundException:printStackTrace	()V
    //   381: aload 10
    //   383: ifnull +8 -> 391
    //   386: aload 10
    //   388: invokevirtual 328	java/io/InputStream:close	()V
    //   391: aload 8
    //   393: ifnull -271 -> 122
    //   396: aload 8
    //   398: invokevirtual 320	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   401: return
    //   402: astore_1
    //   403: aload_1
    //   404: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   407: return
    //   408: aload 7
    //   410: astore 10
    //   412: aload 7
    ...
    //   426: astore 11
    //   428: aload 13
    //   430: invokevirtual 347	java/security/MessageDigest:digest	()[B
    //   433: invokestatic 350	com/tencent/mobileqq/utils/SecUtil:toHexString	([B)Ljava/lang/String;
    //   436: astore 12
    //   438: aload 7
    //   440: astore 10
    //   442: aload 7
    ...
    //   454: aload 7
    //   456: astore 11
    //   458: new 14	java/lang/String
    //   461: dup
    //   462: invokespecial 85	java/lang/String:<init>	()V
    //   465: pop
    //   466: aload 7
    //   468: astore 10
    //   470: aload 7
    ...
    //   484: astore 11
    //   486: aload_1
    //   487: getfield 95	com/tencent/ims/safecheckPB$ReqMQScanRequest:string_check_target	Lcom/tencent/mobileqq/pb/PBStringField;
    //   490: invokevirtual 100	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   493: aload 12
    //   495: invokevirtual 104	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   498: istore 4
    //   500: iload 4
    //   502: ifeq +132 -> 634
    //   505: aload 7
    ...
    //   524: astore 6
    //   526: aload 7
    //   528: invokevirtual 328	java/io/InputStream:close	()V
    //   531: aload 7
    //   533: ifnull +8 -> 541
    //   536: aload 7
    //   538: invokevirtual 328	java/io/InputStream:close	()V
    //   541: aload 8
    //   543: ifnull -421 -> 122
    //   546: aload 8
    //   548: invokevirtual 320	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   551: return
    //   552: astore_1
    //   553: aload_1
    //   554: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   557: return
    //   558: astore_1
    //   559: aload 7
    //   561: astore 10
    ...
    //   577: astore 11
    //   579: aload_1
    //   580: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   583: goto -52 -> 531
    //   586: astore_1
    //   587: aload 9
    //   589: astore 5
    ...
    //   593: astore 6
    //   595: aload_1
    //   596: invokevirtual 351	java/security/NoSuchAlgorithmException:printStackTrace	()V
    //   599: aload 9
    //   601: ifnull +8 -> 609
    //   604: aload 9
    //   606: invokevirtual 328	java/io/InputStream:close	()V
    //   609: aload 8
    //   611: ifnull -489 -> 122
    //   614: aload 8
    //   616: invokevirtual 320	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   619: return
    //   620: astore_1
    //   621: aload_1
    //   622: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   625: return
    //   626: astore_1
    //   627: aload_1
    //   628: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   631: goto -90 -> 541
    //   634: aload 7
    //   636: astore 10
    //   638: aload 7
    ...
    //   652: astore 11
    //   654: aload_2
    //   655: getfield 227	com/tencent/ims/safecheckPB$RspMQScanReport:uint32_check_uid	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   658: aload_1
    //   659: getfield 192	com/tencent/ims/safecheckPB$ReqMQScanRequest:uint32_check_uid	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   662: invokevirtual 194	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   665: invokevirtual 161	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   668: aload 7
    //   670: astore 10
    //   672: aload 7
    //   674: astore 9
    ...
    //   686: astore 11
    //   688: aload_2
    //   689: getfield 156	com/tencent/ims/safecheckPB$RspMQScanReport:uint32_check_count	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   692: iconst_1
    //   693: invokevirtual 161	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   696: aload 7
    //   698: astore 10
    //   700: aload 7
    //   702: astore 9
    ...
    //   712: aload 7
    //   714: astore 11
    //   716: new 110	com/tencent/ims/safecheckPB$ReportItem
    //   719: dup
    //   720: invokespecial 111	com/tencent/ims/safecheckPB$ReportItem:<init>	()V
    //   723: astore_1
    //   724: aload 7
    //   726: astore 10
    //   728: aload 7
    ...
    //   742: astore 11
    //   744: aload_1
    //   745: getfield 114	com/tencent/ims/safecheckPB$ReportItem:string_target_packname	Lcom/tencent/mobileqq/pb/PBStringField;
    //   748: aload 15
    //   750: getfield 120	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   753: invokevirtual 124	com/tencent/mobileqq/pb/PBStringField:set	(Ljava/lang/String;)V
    //   756: aload 7
    //   758: astore 10
    //   760: aload 7
    //   762: astore 9
    ...
    //   774: astore 11
    //   776: aload_1
    //   777: getfield 127	com/tencent/ims/safecheckPB$ReportItem:string_target_md5	Lcom/tencent/mobileqq/pb/PBStringField;
    //   780: aload 12
    //   782: invokevirtual 124	com/tencent/mobileqq/pb/PBStringField:set	(Ljava/lang/String;)V
    //   785: aload 7
    //   787: astore 10
    //   789: aload 7
    //   791: astore 9
    ...
    //   803: astore 11
    //   805: aload_2
    //   806: getfield 146	com/tencent/ims/safecheckPB$RspMQScanReport:rpt_check_item	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   809: aload_1
    //   810: invokevirtual 152	com/tencent/mobileqq/pb/PBRepeatMessageField:add	(Lcom/tencent/mobileqq/pb/MessageMicro;)V
    //   813: aload 7
    //   815: ifnull +8 -> 823
    //   818: aload 7
    //   820: invokevirtual 328	java/io/InputStream:close	()V
    //   823: aload 8
    //   825: ifnull -703 -> 122
    //   828: aload 8
    //   830: invokevirtual 320	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   833: return
    //   834: astore_1
    //   835: aload_1
    //   836: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   839: return
    //   840: astore_1
    //   841: aload_1
    //   842: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   845: goto -22 -> 823
    //   848: astore_1
    //   849: aload_1
    //   850: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   853: goto -462 -> 391
    //   856: astore_1
    //   857: aload_1
    //   858: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   861: goto -252 -> 609
    //   864: astore_1
    //   865: aconst_null
    //   866: astore 8
    ...
    //   874: astore 6
    //   876: aload_1
    //   877: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   880: aload 11
    //   882: ifnull +8 -> 890
    //   885: aload 11
    //   887: invokevirtual 328	java/io/InputStream:close	()V
    //   890: aload 8
    //   892: ifnull -770 -> 122
    //   895: aload 8
    //   897: invokevirtual 320	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   900: return
    //   901: astore_1
    //   902: aload_1
    //   903: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   906: return
    //   907: astore_1
    //   908: aload_1
    //   909: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   912: goto -22 -> 890
    //   915: astore_1
    //   916: aconst_null
    //   917: astore 6
    ...
    //   921: ifnull +8 -> 929
    //   924: aload 5
    //   926: invokevirtual 328	java/io/InputStream:close	()V
    //   929: aload 6
    //   931: ifnull +8 -> 939
    //   934: aload 6
    //   936: invokevirtual 320	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   939: aload_1
    //   940: athrow
    //   941: astore_2
    //   942: aload_2
    //   943: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   946: goto -17 -> 929
    //   949: astore_2
    //   950: aload_2
    //   951: invokevirtual 321	java/io/IOException:printStackTrace	()V
    //   954: goto -15 -> 939
    //   957: astore_1
    //   958: goto -39 -> 919
    //   961: astore_1
    ...
    //   19	800	7	localInputStream	java.io.InputStream
    //   63	912	8	localQZipFile	com.tencent.commonsdk.zip.QZipFile
    //   7	785	9	localObject3	Object
    //   1	787	10	localObject4	Object
    //   10	876	11	localObject5	Object
    //   16	765	12	localObject6	Object
    //   4	425	13	localMessageDigest	java.security.MessageDigest
    //   22	159	14	localObject7	Object
  ...
  public void e(safecheckPB.ReqMQScanRequest paramReqMQScanRequest, safecheckPB.RspMQScanReport paramRspMQScanReport)
  {
    ...
    Object localObject2 = (ActivityManager)this.mContext.getSystemService("activity");
    Object localObject1 = this.mContext.getPackageManager();
