...
public class rze
{
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2, int paramInt3, Bitmap.Config paramConfig)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString = new lo().b(paramString, paramInt1, paramInt1, (Map)localObject);
        if (paramString == null) {
          break;
        }
      ...
      if (i < j)
      {
        if (paramString.get(i, paramInt1)) {
  ...
  public static String aC(long paramLong)
  {
    ...
    if (((Time)localObject1).yearDay == i - 1) {
      return BaseApplicationImpl.getApplication().getString(2131721953);
    }
    return ((Time)localObject1).month + 1 + BaseApplicationImpl.getApplication().getString(2131695973) + ((Time)localObject1).monthDay + BaseApplicationImpl.getApplication().getString(2131692436);
  }
  ...
  public static boolean bg(long paramLong)
  {
    return h(paramLong, 1);
  }
  
  public static boolean bh(long paramLong)
  {
    return h(paramLong, 4);
  }
  
  public static boolean bi(long paramLong)
  {
    return (bg(paramLong)) && (bh(paramLong));
  }
  ...
  public static String bitmapToBase64(Bitmap paramBitmap)
  {
    ...
    //   4: aload_0
    //   5: ifnull +128 -> 133
    //   8: new 290	java/io/ByteArrayOutputStream
    //   11: dup
    //   12: sipush 1024
    //   15: invokespecial 293	java/io/ByteArrayOutputStream:<init>	(I)V
    //   18: astore_2
    //   19: aload_2
    //   20: astore_1
    //   21: aload_0
    //   22: getstatic 299	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   25: bipush 100
    //   27: aload_2
    //   28: invokevirtual 303	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   31: pop
    //   32: aload_2
    //   33: astore_1
    //   34: aload_2
    //   35: invokevirtual 304	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   38: iconst_2
    //   39: invokestatic 310	aqgo:encodeToString	([BI)Ljava/lang/String;
    //   42: astore_0
    //   43: aload_0
    //   44: astore_1
    //   45: aload_2
    //   46: ifnull +13 -> 59
    //   49: aload_2
    //   50: invokevirtual 313	java/io/ByteArrayOutputStream:flush	()V
    //   53: aload_2
    //   54: invokevirtual 316	java/io/ByteArrayOutputStream:close	()V
    //   57: aload_0
    //   58: astore_1
    //   59: aload_1
    //   60: areturn
    //   61: astore_1
    //   62: aload_1
    //   63: invokevirtual 317	java/io/IOException:printStackTrace	()V
    //   66: aload_0
    //   67: areturn
    //   68: astore_0
    //   69: aconst_null
    ...
    //   72: astore_1
    //   73: aload_0
    //   74: invokevirtual 167	java/lang/Exception:printStackTrace	()V
    //   77: aload_3
    //   78: astore_1
    //   79: aload_2
    //   80: ifnull -21 -> 59
    //   83: aload_2
    //   84: invokevirtual 313	java/io/ByteArrayOutputStream:flush	()V
    //   87: aload_2
    //   88: invokevirtual 316	java/io/ByteArrayOutputStream:close	()V
    //   91: aconst_null
    //   92: areturn
    //   93: astore_0
    //   94: aload_0
    //   95: invokevirtual 317	java/io/IOException:printStackTrace	()V
    //   98: aconst_null
    //   99: areturn
    //   100: astore_0
    //   101: aconst_null
    ...
    //   104: ifnull +11 -> 115
    //   107: aload_1
    //   108: invokevirtual 313	java/io/ByteArrayOutputStream:flush	()V
    //   111: aload_1
    //   112: invokevirtual 316	java/io/ByteArrayOutputStream:close	()V
    //   115: aload_0
    //   116: athrow
    //   117: astore_1
    //   118: aload_1
    //   119: invokevirtual 317	java/io/IOException:printStackTrace	()V
    //   122: goto -7 -> 115
    //   125: astore_0
    //   126: goto -23 -> 103
    //   129: astore_0
  ...
  {
    a(paramFile, paramString, ryy.aDB);
  }
  ...
  {
    return ryy.gw("certified_account_download_pics");
  }
}
