...
{
  public kqw(CommentInfo paramCommentInfo1, CommentInfo paramCommentInfo2, BaseActivity paramBaseActivity) {}
  
  public void onClick(View paramView)
  {
    ksz.f(this.b.toUin, this.val$activity);
    paramView = new ksz.c(this.c.articleInfo, this.b).b(ksm.aLx).c(this.c.area).d(0).a().a(this.b.toUin).build();
