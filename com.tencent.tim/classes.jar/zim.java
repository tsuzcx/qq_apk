...
public class zim
  extends acnd
{
  public zim(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
  ...
  protected void a(String paramString, boolean paramBoolean, List<TroopMemberInfo> paramList, int paramInt1, long paramLong, int paramInt2)
  {
    if (!this.this$0.mTroopUin.equals(paramString)) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.history.BaseFragment", 2, "onUpdateTroopGetMemberList,!mTroopUin.equals(troopUin)==>mTroopUin:" + this.this$0.mTroopUin + "|troopUin:" + paramString);
      }
    }
    do
    {
      ...
      {
        return;
        paramInt2 = ChatHistoryTroopMemberFragment.d(this.this$0);
    ...
    QLog.e("Q.history.BaseFragment", 2, "onUpdateTroopGetMemberList,mMemberListReqStartTime != reqTimestamp, mMemberListReqStartTime:" + this.this$0.Hm + "|reqTimestamp:" + paramLong);
    return;
    ...
    for (;;)
    {
      try
      {
        this.this$0.getActivity().getSharedPreferences("last_update_time" + this.this$0.app.getCurrentAccountUin(), 4).edit().putLong("key_last_update_time" + this.this$0.mTroopUin, System.currentTimeMillis()).commit();
  ...
  {
    this.this$0.getActivity().runOnUiThread(new ChatHistoryTroopMemberFragment.41.1(this, paramBoolean1, paramString1, paramBoolean2, paramString2, paramString3, paramBoolean3));
  }
    ...
    if (paramBoolean)
    {
      if ((paramArrayList != null) && (paramArrayList.size() > 0))
      {
        ...
        if (this.this$0.mFrom == 15) {
          ChatHistoryTroopMemberFragment.a(this.this$0, paramArrayList);
        }
  ...
  protected void b(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.history.BaseFragment", 2, "onOIDB0X899_1_Ret, isSuccess:" + paramBoolean + " returnUin:" + paramLong1 + " mTroopUin:" + this.this$0.mTroopUin + " time:" + (System.currentTimeMillis() - this.this$0.Hn) / 1000L + "s");
    }
    if ((!paramBoolean) || (!this.this$0.mTroopUin.equals(Long.toString(paramLong1)))) {}
    do
    {
      return;
      this.this$0.getActivity().getSharedPreferences("last_update_time" + this.this$0.app.getCurrentAccountUin(), 4).edit().putLong("key_troop_info_last_update" + this.this$0.mTroopUin, System.currentTimeMillis()).commit();
