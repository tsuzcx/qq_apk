  ...
  implements View.OnClickListener
{
  ...
  public aulw(Context paramContext, View.OnClickListener paramOnClickListener)
  {
  ...
  private void a(AsyncImageView paramAsyncImageView, GroupPadTemplateInfo paramGroupPadTemplateInfo)
  {
    if (paramGroupPadTemplateInfo != null)
    {
      ...
      if (paramGroupPadTemplateInfo.docOrSheetType == 1)
      {
        localDrawable = this.mContext.getResources().getDrawable(2130840630);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramGroupPadTemplateInfo != null)
          {
            ...
            paramGroupPadTemplateInfo.setDownloadListener(new aulx(this, str));
