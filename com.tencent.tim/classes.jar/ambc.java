public class ambc
{
  ...
  public static int a(java.lang.String paramString1, java.lang.String paramString2, float paramFloat1, float paramFloat2)
  {
    ...
    //   6: aconst_null
    //   7: astore 12
    //   9: invokestatic 16	java/lang/System:currentTimeMillis	()J
    //   12: lstore 7
    //   14: fload_2
    //   15: fconst_0
    //   16: fcmpg
    ...
    //   65: iconst_0
    //   66: fload_2
    //   67: invokestatic 26	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   70: aastore
    //   71: dup
    //   72: iconst_1
    //   73: fload_3
    //   74: invokestatic 26	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   77: aastore
    //   78: invokestatic 32	ram:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   81: ldc 33
    //   83: istore 5
    //   85: iload 5
    //   87: ireturn
    //   88: new 35	java/io/File
    //   91: dup
    //   92: aload_0
    //   93: invokespecial 39	java/io/File:<init>	(Ljava/lang/String;)V
    //   96: astore 11
    //   98: aload 11
    //   100: invokevirtual 42	java/io/File:length	()J
    //   103: l2i
    //   104: istore 6
    //   106: aload 11
    //   108: invokevirtual 46	java/io/File:exists	()Z
    //   111: ifeq +8 -> 119
    //   114: iload 6
    //   116: ifgt +39 -> 155
    //   119: ldc 18
    ...
    //   128: iconst_0
    //   129: fload_2
    //   130: invokestatic 26	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   133: aastore
    //   134: dup
    //   135: iconst_1
    //   136: fload_3
    //   137: invokestatic 26	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   140: aastore
    //   141: dup
    //   142: iconst_2
    //   143: iload 6
    ...
    //   148: aastore
    //   149: invokestatic 32	ram:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   152: ldc 54
    //   154: ireturn
    //   155: aload_0
    //   156: aconst_null
    //   157: iconst_0
    //   158: invokestatic 59	com/tencent/mobileqq/shortvideo/util/AudioEncoder:a	(Ljava/lang/String;Ljava/lang/String;I)Lcom/tencent/mobileqq/shortvideo/util/AudioEncoder$a;
    //   161: astore_0
    //   162: fload_3
    //   163: fstore 4
    //   165: fload_3
    ...
    //   179: f2i
    //   180: aload_0
    //   181: getfield 65	com/tencent/mobileqq/shortvideo/util/AudioEncoder$a:dIH	I
    //   184: invokestatic 69	ambc:aK	(II)I
    //   187: istore 5
    //   189: iload 6
    //   191: i2f
    //   192: fload 4
    ...
    //   195: f2i
    //   196: aload_0
    //   197: getfield 65	com/tencent/mobileqq/shortvideo/util/AudioEncoder$a:dIH	I
    //   200: invokestatic 69	ambc:aK	(II)I
    //   203: istore 6
    //   205: ldc 18
    ...
    //   237: invokestatic 93	ram:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   240: iload 6
    //   242: iload 5
    //   244: isub
    //   245: newarray byte
    //   247: astore 15
    //   249: new 35	java/io/File
    //   252: dup
    //   253: aload_1
    //   254: invokespecial 39	java/io/File:<init>	(Ljava/lang/String;)V
    //   257: astore_0
    //   258: aload_0
    //   259: invokevirtual 46	java/io/File:exists	()Z
    //   262: ifeq +8 -> 270
    //   265: aload_0
    //   266: invokevirtual 96	java/io/File:delete	()Z
    //   269: pop
    //   270: aload_0
    //   271: invokevirtual 100	java/io/File:getParentFile	()Ljava/io/File;
    //   274: invokevirtual 46	java/io/File:exists	()Z
    //   277: ifne +11 -> 288
    //   280: aload_0
    //   281: invokevirtual 100	java/io/File:getParentFile	()Ljava/io/File;
    //   284: invokevirtual 103	java/io/File:mkdirs	()Z
    //   287: pop
    //   288: aload_0
    //   289: invokevirtual 106	java/io/File:createNewFile	()Z
    //   292: pop
    //   293: new 108	java/io/FileOutputStream
    //   296: dup
    //   297: aload_0
    //   298: invokespecial 111	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   301: astore_0
    //   302: new 113	java/io/FileInputStream
    //   305: dup
    //   306: aload 11
    //   308: invokespecial 114	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   311: astore 11
    //   313: aload 11
    //   315: ifnull +29 -> 344
    //   318: iload 5
    ...
    //   328: aload 11
    //   330: lload 9
    //   332: invokevirtual 118	java/io/FileInputStream:skip	(J)J
    //   335: pop2
    //   336: aload 11
    //   338: aload 15
    //   340: invokevirtual 122	java/io/FileInputStream:read	([B)I
    //   343: pop
    //   344: aload_0
    //   345: aload 15
    //   347: invokevirtual 126	java/io/FileOutputStream:write	([B)V
    //   350: aload_0
    //   351: invokevirtual 129	java/io/FileOutputStream:flush	()V
    //   354: aload 11
    //   356: ifnull +8 -> 364
    //   359: aload 11
    //   361: invokevirtual 132	java/io/FileInputStream:close	()V
    //   364: aload_0
    //   365: ifnull +7 -> 372
    //   368: aload_0
    ...
    //   386: invokestatic 16	java/lang/System:currentTimeMillis	()J
    //   389: lload 7
    //   391: lsub
    //   392: invokevirtual 138	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   395: invokevirtual 89	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   398: invokestatic 93	ram:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   401: iconst_0
    //   402: ireturn
    //   403: astore_1
    //   404: aload_1
    //   405: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   408: goto -44 -> 364
    //   411: astore_0
    //   412: aload_0
    //   413: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   416: goto -44 -> 372
    //   419: astore_1
    //   420: aconst_null
    //   421: astore_0
    ...
    //   424: astore 11
    //   426: aload_1
    //   427: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   430: ldc 142
    //   432: istore 5
    //   434: aload 11
    //   436: ifnull +8 -> 444
    //   439: aload 11
    //   441: invokevirtual 132	java/io/FileInputStream:close	()V
    //   444: aload_0
    //   445: ifnull -360 -> 85
    //   448: aload_0
    //   449: invokevirtual 133	java/io/FileOutputStream:close	()V
    //   452: ldc 142
    //   454: ireturn
    //   455: astore_0
    //   456: aload_0
    //   457: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   460: ldc 142
    //   462: ireturn
    //   463: astore_1
    //   464: aload_1
    //   465: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   468: goto -24 -> 444
    //   471: astore_0
    //   472: aconst_null
    //   473: astore 11
    ...
    //   478: ldc 18
    //   480: ldc 144
    //   482: invokestatic 146	ram:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   485: aload_0
    //   486: invokevirtual 147	java/lang/Throwable:printStackTrace	()V
    //   489: ldc 142
    //   491: istore 5
    //   493: aload 11
    //   495: ifnull +8 -> 503
    //   498: aload 11
    //   500: invokevirtual 132	java/io/FileInputStream:close	()V
    //   503: aload_1
    //   504: ifnull -419 -> 85
    //   507: aload_1
    //   508: invokevirtual 133	java/io/FileOutputStream:close	()V
    //   511: ldc 142
    //   513: ireturn
    //   514: astore_0
    //   515: aload_0
    //   516: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   519: ldc 142
    //   521: ireturn
    //   522: astore_0
    //   523: aload_0
    //   524: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   527: goto -24 -> 503
    //   530: astore_0
    //   531: aconst_null
    //   532: astore 11
    ...
    //   539: ifnull +8 -> 547
    //   542: aload 11
    //   544: invokevirtual 132	java/io/FileInputStream:close	()V
    //   547: aload_1
    //   548: ifnull +7 -> 555
    //   551: aload_1
    //   552: invokevirtual 133	java/io/FileOutputStream:close	()V
    //   555: aload_0
    //   556: athrow
    //   557: astore 11
    //   559: aload 11
    //   561: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   564: goto -17 -> 547
    //   567: astore_1
    //   568: aload_1
    //   569: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   572: goto -17 -> 555
    //   575: astore 12
    //   577: aconst_null
    //   578: astore 11
