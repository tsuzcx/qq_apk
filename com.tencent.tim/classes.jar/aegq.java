...
public class aegq
  extends accg
{
  public aegq(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private void b(QQAppInterface paramQQAppInterface, aegp paramaegp)
  {
    int i = 0;
    long l1 = anaz.gQ();
    ...
    aegp.e(paramQQAppInterface, "redpoint_box_show", l1);
    aegu.d(paramQQAppInterface, false, true);
    paramQQAppInterface.b().a().bS(acbn.blK, 1032);
    acxw localacxw = paramQQAppInterface.a().a();
    RecentUser localRecentUser = localacxw.b(acbn.blK, 1032);
    if (localRecentUser == null)
    {
      paramQQAppInterface = new RecentUser(acbn.blK, 1032);
  ...
  private void c(QQAppInterface paramQQAppInterface, aegp paramaegp)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ConfessHandler", 2, "onNeedShowLebaRedPoint");
    }
    aegp.e(paramQQAppInterface, "redpoint_leba_show", anaz.gQ());
  }
      ...
      try
      {
        ...
        if (n == 0)
        {
          ...
          if (localRspBody.uint32_result.has())
          {
            ...
            aegu.a(this.app, str, aegp.bwQ, k, m, paramToServiceMsg);
            label169:
          ...
          while (QLog.isColorLevel())
          {
            ...
            break label141;
            label280:
            aegu.a(this.app, str, k, m, paramToServiceMsg);
            break label169;
            label297:
  ...
  public void a(aehb paramaehb)
  {
    if (this.app == null) {
      return;
    }
    if (this.app.a().a().b(acbn.blK, 1032) != null)
    {
    ...
    notifyUI(2, true, paramaehb);
  }
  
  public void a(QQAppInterface paramQQAppInterface, aegp paramaegp)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ConfessHandler", 2, String.format("onGetNewConfig boxEntry:%d contactEntry:%d", new Object[] { Integer.valueOf(paramaegp.cMI), Integer.valueOf(paramaegp.cMJ) }));
    }
    if (paramaegp.cMI == 2) {
      b(paramQQAppInterface, paramaegp);
    }
    if (paramaegp.cMJ == 2) {
      c(paramQQAppInterface, paramaegp);
    }
  }
  ...
  public void b(long paramLong1, long paramLong2, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
  ...
  public void b(aehb paramaehb)
  {
    ...
    if ((paramaehb != null) && (paramaehb.agG()))
    {
      localacxw = this.app.a().a();
      localRecentUser2 = localacxw.b(acbn.blK, 1032);
      i = 0;
      if (localRecentUser2 != null) {
        break label123;
      }
      localRecentUser1 = new RecentUser();
      localRecentUser1.uin = acbn.blK;
      localRecentUser1.setType(1032);
      localRecentUser1.lastmsgtime = paramaehb.Wd;
      i = 1;
    }
    for (;;)
    {
      if (i != 0)
      {
        ...
        paramaehb = this.mApp.getHandler(Conversation.class);
        if (paramaehb != null) {
          paramaehb.sendEmptyMessage(1009);
        }
      }
      ...
      if (localRecentUser2.lastmsgtime < paramaehb.Wd)
      {
        localRecentUser2.lastmsgtime = paramaehb.Wd;
        i = 1;
        localRecentUser1 = localRecentUser2;
      }
    }
