  ...
  extends EIPCModuleManager
{
    ...
    throws RemoteException
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 35	eipc/EIPCServer:clients	Ljava/util/ArrayList;
    //   4: astore 5
    //   6: aload 5
    //   8: monitorenter
    //   9: aload_3
    ...
    //   13: aload_0
    //   14: getfield 35	eipc/EIPCServer:clients	Ljava/util/ArrayList;
    //   17: invokevirtual 212	java/util/ArrayList:size	()I
    //   20: iconst_1
    //   21: isub
    //   22: istore_2
    //   23: iload_2
    //   24: iflt +258 -> 282
    //   27: aload_0
    //   28: getfield 35	eipc/EIPCServer:clients	Ljava/util/ArrayList;
    //   31: iload_2
    //   32: invokevirtual 213	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   35: checkcast 84	eipc/EIPCConnection
    //   38: astore_3
    //   39: aload_3
    //   40: getfield 214	eipc/EIPCConnection:channel	Leipc/EIPCChannel;
    //   43: invokeinterface 218 1 0
    //   48: astore 6
    //   50: aload 6
    //   52: invokeinterface 221 1 0
    //   57: ifne +13 -> 70
    //   60: aload 6
    ...
    //   70: aload_1
    //   71: aload_3
    //   72: getfield 177	eipc/EIPCConnection:procName	Ljava/lang/String;
    //   75: invokestatic 183	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   78: ifeq +197 -> 275
    //   81: iload 4
    //   83: aload_3
    //   84: getfield 187	eipc/EIPCConnection:clientId	I
    //   87: if_icmpne +188 -> 275
    //   90: aload_0
    //   91: getfield 35	eipc/EIPCServer:clients	Ljava/util/ArrayList;
    //   94: iload_2
    //   95: invokevirtual 227	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   98: pop
    //   99: aload_0
    //   100: aload_3
    //   101: invokevirtual 231	eipc/EIPCServer:notifyUnbind	(Leipc/EIPCConnection;)V
    //   104: goto +171 -> 275
    //   107: aload 5
    //   109: monitorexit
    //   110: iload_2
    //   111: ireturn
    //   112: new 84	eipc/EIPCConnection
    //   115: dup
    //   116: aload_3
    //   117: aload_1
    //   118: invokespecial 243	eipc/EIPCConnection:<init>	(Leipc/EIPCChannel;Ljava/lang/String;)V
    //   121: astore_1
    //   122: aload_1
    //   123: aload_0
    //   124: putfield 247	eipc/EIPCConnection:callbackManager	Leipc/EIPCModuleManager;
    //   127: aload_1
    //   128: iload 4
    //   130: putfield 187	eipc/EIPCConnection:clientId	I
    //   133: aload_1
    //   134: ldc 249
    //   136: putfield 252	eipc/EIPCConnection:logMark	Ljava/lang/String;
    //   139: invokestatic 121	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   142: ifeq +28 -> 170
    //   145: ldc 123
    //   147: iconst_2
    ...
    //   155: ldc 254
    //   157: invokevirtual 132	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   160: aload_1
    //   161: invokevirtual 257	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   164: invokevirtual 141	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   167: invokestatic 145	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   170: aload_0
    //   171: getfield 35	eipc/EIPCServer:clients	Ljava/util/ArrayList;
    //   174: aload_1
    //   175: invokevirtual 261	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   178: pop
    //   179: aload_0
    //   180: aload_1
    //   181: invokevirtual 264	eipc/EIPCServer:notifyBind	(Leipc/EIPCConnection;)V
    //   184: aload_0
    //   185: getfield 28	eipc/EIPCServer:instanceCount	Ljava/util/concurrent/atomic/AtomicInteger;
    //   188: iconst_1
    //   189: invokevirtual 268	java/util/concurrent/atomic/AtomicInteger:addAndGet	(I)I
    //   192: istore_2
    //   193: aload_0
    //   194: getfield 40	eipc/EIPCServer:channelSparseArr	Landroid/util/SparseArray;
    //   197: astore 6
    //   199: aload 6
    //   201: monitorenter
    //   202: aload_0
    //   203: getfield 40	eipc/EIPCServer:channelSparseArr	Landroid/util/SparseArray;
    //   206: iload_2
    //   207: aload_3
    //   208: invokevirtual 272	android/util/SparseArray:put	(ILjava/lang/Object;)V
    //   211: aload 6
    //   213: monitorexit
    //   214: new 6	eipc/EIPCServer$ServerRecipient
    //   217: dup
