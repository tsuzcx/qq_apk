...
class acbl
  extends aquy
{
  acbl(acbk paramacbk, String paramString1, String paramString2, String paramString3) {}
  ...
  public void onDone(aquz paramaquz)
  {
    ...
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d("SimpleFrameZipDecoder", 2, "downloadZip onDone task.getStatus()->" + paramaquz.getStatus());
      }
      return;
