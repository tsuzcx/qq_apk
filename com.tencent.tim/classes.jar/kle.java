  ...
  extends lce
{
  ...
  public void a(Object paramObject, int paramInt, boolean paramBoolean, String... paramVarArgs)
  {
    ...
    while (paramInt != 110) {
      ...
      {
        return;
        paramObject = (ReadInJoyXListView)this.this$0.a().b();
        localObject1 = this.this$0.a().getData();
        if ((paramObject != null) && (localObject1 != null))
        {
          ...
          try
          {
            ...
            if (paramInt <= k)
            {
              ...
              m = knd.f((AdvertisementInfo)localObject3);
              String str = knd.c((AdvertisementInfo)localObject3);
              ...
              if ((localObject2 == null) || (!(localObject2 instanceof koh))) {
                break label717;
              }
              ((koh)localObject2).a(true, (AdvertisementInfo)localObject3, paramVarArgs);
            }
          }
    ...
    for (;;)
    {
      ...
      {
        paramObject = (ReadInJoyXListView)this.this$0.a().b();
        paramVarArgs = this.this$0.a().getData();
