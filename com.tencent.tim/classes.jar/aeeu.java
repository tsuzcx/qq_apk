...
public class aeeu
{
  ...
  public static void a(boolean paramBoolean1, int paramInt1, int paramInt2, boolean paramBoolean2, String paramString)
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      anpc.a(BaseApplication.getContext()).collectPerformance(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "DanmakuRequestMonitor", paramBoolean1, 0L, 0L, localHashMap, null);
      return;
      str = "0";
      break;
    }
  ...
  public static int b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    {
      paramMessageRecord = xmb.a(paramQQAppInterface, paramMessageRecord);
      int i;
  ...
  public static final String e(Context paramContext, int paramInt)
  {
    if (paramInt < 0) {
      return "";
    }
    ...
    if (i < 60) {
      return paramContext.getString(2131701576, new Object[] { Integer.valueOf(i) });
    }
    if (i < 3600) {
      return paramContext.getString(2131701577, new Object[] { Integer.valueOf(i / 60), Integer.valueOf(i % 60) });
    }
    paramInt = i / 60;
    return paramContext.getString(2131701578, new Object[] { Integer.valueOf(paramInt / 60), Integer.valueOf(paramInt % 60) });
  }
}
