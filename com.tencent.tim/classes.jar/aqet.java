  ...
  extends acfd
{
  protected void onGetHeadInfo(boolean paramBoolean, Setting paramSetting)
  {
    ...
    for (String str = paramSetting.uin;; str = "")
    {
      ...
      if ((paramSetting != null) && (paramSetting.uin != null) && (paramSetting.uin.equals(aqes.a(this.this$0)))) {
  ...
  public void onGetHeadInfoEmpty(boolean paramBoolean, int paramInt, List<String> paramList)
  {
    ...
    for (String str = paramList.toString();; str = "")
    {
      ...
      if (paramList != null)
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if ((str != null) && (str.equals(aqes.a(this.this$0))))
          {
            if (!paramBoolean) {
              break label145;
            }
    ...
    label145:
    aqes.a(this.this$0).obtainMessage(1).sendToTarget();
  }
}
