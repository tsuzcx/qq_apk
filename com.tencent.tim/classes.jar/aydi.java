  ...
  implements View.OnClickListener
{
  ...
  public aydi(@NonNull aygz paramaygz)
  {
    super(paramaygz);
  }
  ...
  public void a(@NonNull ayqb paramayqb)
  {
    if (this.delayTime == -1) {
      if (this.b.a.aGo)
      {
        paramayqb.a.bsS = ((int)this.b.a.a.getDuration());
        paramayqb.a.aGy = this.aGy;
        if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      paramayqb.a.bsS = this.delayTime;
      paramayqb.a.aGy = this.aGy;
  ...
  public void onCreate()
  {
    ...
    this.mSeekBar.setOnSeekBarChangeListener(new aydj(this));
  }
