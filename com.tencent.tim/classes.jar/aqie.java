...
{
  aqie(aqhv paramaqhv, arhz paramarhz, String paramString1, String paramString2, String paramString3) {}
      ...
      for (;;)
      {
        if (paramInt != 0)
        {
          ...
          if (this.this$0.context != null) {
            ArkFullScreenAppActivity.a(this.this$0.context, this.val$appName, paramAppPathInfo, "0.0.0.1", paramObject, adqr.getDensity(), null, 1);
          }
        }
        do
        {
          ...
          return;
          QQToast.a(this.this$0.context, 2131690467, 0).show();
