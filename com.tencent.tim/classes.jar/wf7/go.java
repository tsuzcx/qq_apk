...
public class go
{
  private static String R(String paramString)
  {
    ...
    try
    {
      paramString = alkz.a(NetworkInterface.getByName(paramString));
      if (paramString == null) {
        return "";
      }
  ...
  private static List<String> b(File paramFile)
  {
    ...
    //   3: aconst_null
    //   4: astore_3
    //   5: new 91	java/util/ArrayList
    //   8: dup
    //   9: invokespecial 92	java/util/ArrayList:<init>	()V
    //   12: astore 5
    //   14: new 94	java/io/FileInputStream
    //   17: dup
    //   18: aload_0
    //   19: invokespecial 97	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   22: astore_0
    //   23: new 99	java/io/InputStreamReader
    //   26: dup
    //   27: aload_0
    //   28: invokespecial 102	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   31: astore_2
    //   32: new 104	java/io/BufferedReader
    //   35: dup
    //   36: aload_2
    //   37: invokespecial 107	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   40: astore_3
    //   41: aload_3
    //   42: invokevirtual 110	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   45: astore_1
    //   46: aload_1
    //   47: ifnull +47 -> 94
    //   50: aload 5
    //   52: aload_1
    //   53: invokeinterface 114 2 0
    //   58: pop
    //   59: goto -18 -> 41
    //   62: astore_1
    //   63: aload_0
    ...
    //   76: ifnull +7 -> 83
    //   79: aload_2
    //   80: invokevirtual 118	java/io/InputStreamReader:close	()V
    //   83: aload_0
    //   84: ifnull +7 -> 91
    //   87: aload_0
    //   88: invokevirtual 119	java/io/BufferedReader:close	()V
    //   91: aload 5
    //   93: areturn
    //   94: aload_0
    //   95: ifnull +7 -> 102
    ...
    //   103: ifnull +7 -> 110
    //   106: aload_2
    //   107: invokevirtual 118	java/io/InputStreamReader:close	()V
    //   110: aload_3
    //   111: ifnull -20 -> 91
    //   114: aload_3
    //   115: invokevirtual 119	java/io/BufferedReader:close	()V
    //   118: aload 5
    //   120: areturn
    //   121: astore_0
    //   122: aload_0
    //   123: invokevirtual 122	java/lang/Throwable:printStackTrace	()V
    //   126: aload 5
    //   128: areturn
    //   129: astore_0
    //   130: aload_0
    //   131: invokevirtual 122	java/lang/Throwable:printStackTrace	()V
    //   134: aload 5
    //   136: areturn
    //   137: astore_1
    //   138: aconst_null
    ...
    //   146: ifnull +7 -> 153
    //   149: aload_0
    //   150: invokevirtual 117	java/io/FileInputStream:close	()V
    //   153: aload_2
    //   154: ifnull +7 -> 161
    //   157: aload_2
    //   158: invokevirtual 118	java/io/InputStreamReader:close	()V
    //   161: aload_3
    //   162: ifnull +7 -> 169
    //   165: aload_3
    //   166: invokevirtual 119	java/io/BufferedReader:close	()V
    //   169: aload_1
    //   170: athrow
    //   171: astore_0
    //   172: aload_0
    //   173: invokevirtual 122	java/lang/Throwable:printStackTrace	()V
    //   176: goto -7 -> 169
    //   179: astore_1
    //   180: aconst_null
    //   181: astore_2
