...
public class ao
{
  ...
  public an i(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 27	wf7/ao:dp	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   10: aload_0
    //   11: getfield 32	wf7/ao:dq	Ljava/util/HashMap;
    //   14: iload_1
    ...
    //   24: astore_2
    //   25: aload_0
    //   26: getfield 27	wf7/ao:dp	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
  ...
  {
    public static final ao ds = new ao(null);
  }
}
