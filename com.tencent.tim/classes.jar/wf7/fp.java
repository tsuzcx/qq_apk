...
public class fp
{
  ...
  private d qT = new d(null);
  private e qU = new e(null);
  private f qV = new f(null);
  private b qW = new b(null);
  private c qX = new c(null);
  ...
  private void eb()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 113	wf7/fp:qL	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   6: invokevirtual 416	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   9: istore_1
    //   10: iload_1
    //   11: ifeq +6 -> 17
    //   14: aload_0
    ...
    //   17: aload_0
    //   18: iconst_1
    //   19: invokespecial 464	wf7/fp:D	(Z)V
    //   22: invokestatic 469	wf7/dk:bJ	()I
    //   25: bipush 23
    //   27: if_icmplt +43 -> 70
    //   30: aload_0
    //   31: new 6	wf7/fp$a
    ...
    //   40: putfield 106	wf7/fp:qK	Landroid/content/BroadcastReceiver;
    ...
    //   58: invokestatic 231	wf7/fq:cr	()Landroid/content/Context;
    //   61: aload_0
    //   62: getfield 106	wf7/fp:qK	Landroid/content/BroadcastReceiver;
    //   65: aload_2
    ...
    //   69: pop
    //   70: aload_0
    //   71: getfield 113	wf7/fp:qL	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   74: iconst_1
    //   75: invokevirtual 199	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   78: goto -64 -> 14
    //   81: astore_2
    //   82: aload_0
    //   83: monitorexit
  ...
  private void ec()
  {
    ...
    //   19: invokespecial 464	wf7/fp:D	(Z)V
    //   22: aload_0
    //   23: getfield 106	wf7/fp:qK	Landroid/content/BroadcastReceiver;
    //   26: ifnull +13 -> 39
    //   29: invokestatic 231	wf7/fq:cr	()Landroid/content/Context;
    //   32: aload_0
    //   33: getfield 106	wf7/fp:qK	Landroid/content/BroadcastReceiver;
    //   36: invokevirtual 489	android/content/Context:unregisterReceiver	(Landroid/content/BroadcastReceiver;)V
    //   39: aload_0
    //   40: getfield 113	wf7/fp:qL	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   43: iconst_0
    //   44: invokevirtual 199	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   47: goto -33 -> 14
    //   50: astore_2
    //   51: aload_0
    //   52: monitorexit
  ...
  private void f(CurrentSessionItem paramCurrentSessionItem)
  {
    ...
    //   8: return
    //   9: aload_0
    //   10: getfield 104	wf7/fp:qJ	Ljava/util/List;
    //   13: invokeinterface 373 1 0
    //   18: astore_2
    //   19: aload_2
    //   20: invokeinterface 378 1 0
    //   25: ifeq -19 -> 6
    //   28: aload_2
    //   29: invokeinterface 382 1 0
    //   34: checkcast 384	wf7/fo
    //   37: aload_1
  ...
  public void a(fo paramfo)
  {
    ...
    //   3: ifnull +18 -> 21
    //   6: aload_0
    //   7: getfield 104	wf7/fp:qJ	Ljava/util/List;
    //   10: aload_1
    ...
    //   23: return
    //   24: aload_0
    //   25: getfield 104	wf7/fp:qJ	Ljava/util/List;
    //   28: aload_1
  ...
  public void a(fr paramfr)
  {
    ...
    //   3: ifnull +18 -> 21
    //   6: aload_0
    //   7: getfield 102	wf7/fp:qI	Ljava/util/List;
    //   10: aload_1
    //   11: invokeinterface 567 2 0
    //   16: istore_2
    //   17: iload_2
    ...
    //   23: return
    //   24: aload_0
    //   25: getfield 102	wf7/fp:qI	Ljava/util/List;
    //   28: aload_1
    //   29: invokeinterface 570 2 0
    //   34: pop
    //   35: aload_0
    //   36: getfield 160	wf7/fp:qP	Lwf7/bq;
    //   39: iconst_1
    //   40: invokeinterface 227 2 0
    //   45: astore_3
    //   46: aload_3
    //   47: ifnull -26 -> 21
    //   50: aload_3
  ...
  public void destroy()
  {
    ...
    //   2: aload_0
    //   3: iconst_0
    //   4: putfield 97	wf7/fp:qH	Z
    //   7: invokestatic 590	wf7/ft:eJ	()Lwf7/ft;
    //   10: invokevirtual 593	wf7/ft:eP	()V
    //   13: aload_0
    //   14: getfield 152	wf7/fp:qY	Landroid/os/Handler;
    //   17: aconst_null
    //   18: invokevirtual 214	android/os/Handler:removeCallbacksAndMessages	(Ljava/lang/Object;)V
    //   21: aload_0
    //   22: aconst_null
    //   23: putfield 152	wf7/fp:qY	Landroid/os/Handler;
    //   26: aload_0
    //   27: getfield 104	wf7/fp:qJ	Ljava/util/List;
    //   30: invokeinterface 595 1 0
    //   35: aload_0
    //   36: getfield 102	wf7/fp:qI	Ljava/util/List;
    //   39: invokeinterface 595 1 0
    //   44: aload_0
    //   45: iconst_0
    //   46: invokespecial 181	wf7/fp:E	(Z)V
    //   49: aload_0
    //   50: iconst_0
    //   51: invokespecial 184	wf7/fp:F	(Z)V
    //   54: aload_0
    //   55: getfield 178	wf7/fp:qS	Lcom/tencent/qqpimsecure/wificore/api/connect/d;
    //   58: invokeinterface 598 1 0
    //   63: ifeq +27 -> 90
    //   66: aload_0
    //   67: getfield 178	wf7/fp:qS	Lcom/tencent/qqpimsecure/wificore/api/connect/d;
    //   70: new 600	wf7/fp$2
    //   73: dup
    //   74: aload_0
    //   75: invokespecial 601	wf7/fp$2:<init>	(Lwf7/fp;)V
    //   78: invokeinterface 305 2 0
    //   83: aconst_null
    //   84: putstatic 409	wf7/fp:qZ	Lwf7/fp;
    //   87: aload_0
    //   88: monitorexit
    //   89: return
    //   90: invokestatic 189	wf7/ao:c	()Lwf7/ao;
    ...
    implements bp
  {
    ...
    {
      fp.d(fp.this).sendEmptyMessage(4);
    }
  }
    ...
    implements a
  {
    ...
    public void a(CurrentSessionItem paramCurrentSessionItem)
    {
      ...
      default: 
        return;
      case 1: 
        fp.a(fp.this, paramCurrentSessionItem);
        return;
      case 0: 
        fp.b(fp.this, paramCurrentSessionItem);
        return;
      }
      fp.a(fp.this, -9);
    }
  ...
  class f
    implements com.tencent.qqpimsecure.wificore.api.event.d
  {
    private f() {}
