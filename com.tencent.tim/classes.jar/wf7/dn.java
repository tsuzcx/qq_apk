  ...
  implements eu
{
  ...
  {
    a locala = this.li.v(paramString);
    if (locala != null)
    {
      if (locala.isValid()) {
        return locala;
  ...
  private a j(boolean paramBoolean)
  {
    ...
    localObject = new a(0L, localArrayList, true);
    if (paramBoolean)
    {
      lo = (a)localObject;
      return localObject;
  ...
  public void a(long paramLong, int paramInt, JceStruct paramJceStruct)
  {
    ...
    do
    {
      ...
      paramJceStruct = new a(System.currentTimeMillis() + 1000L * ((m)localObject).aQ, a(((m)localObject).aP, false), false);
