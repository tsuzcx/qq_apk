...
public final class gr
{
  ...
  {
    // Byte code:
    //   0: new 92	java/io/FileInputStream
    //   3: dup
    //   4: ldc 94
    //   6: invokespecial 98	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   9: astore_2
    //   10: new 100	java/io/BufferedReader
    //   13: dup
    //   14: new 102	java/io/InputStreamReader
    //   17: dup
    //   18: aload_2
    //   19: invokespecial 105	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   22: sipush 8192
    //   25: invokespecial 108	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   28: astore_3
    //   29: new 110	java/lang/StringBuilder
    //   32: dup
    //   33: ldc 60
    //   35: invokespecial 111	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   38: astore_1
    //   39: aload_3
    //   40: invokevirtual 115	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   43: astore 4
    //   45: aload 4
    //   47: ifnull +46 -> 93
    //   50: aload_1
    ...
    //   63: ifnull +7 -> 70
    //   66: aload_3
    //   67: invokevirtual 122	java/io/BufferedReader:close	()V
    //   70: aload_2
    //   71: ifnull +7 -> 78
    //   74: aload_2
    //   75: invokevirtual 125	java/io/InputStream:close	()V
    //   78: aload_1
    //   79: invokevirtual 128	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   82: astore_1
    //   83: iload_0
    //   84: ifne +59 -> 143
    //   87: aload_1
    ...
    //   94: ifnull +7 -> 101
    //   97: aload_3
    //   98: invokevirtual 122	java/io/BufferedReader:close	()V
    //   101: aload_2
    //   102: ifnull +7 -> 109
    //   105: aload_2
    ...
    //   120: ifnull +7 -> 127
    //   123: aload_3
    //   124: invokevirtual 122	java/io/BufferedReader:close	()V
    //   127: aload_2
    //   128: ifnull +7 -> 135
    //   131: aload_2
    //   132: invokevirtual 125	java/io/InputStream:close	()V
    //   135: aload_1
    ...
    //   147: aload_1
    //   148: ldc 60
    //   150: invokevirtual 134	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   153: ifne +62 -> 215
    //   156: aload_1
    //   157: aload_1
    //   158: ldc 136
    //   160: invokevirtual 140	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   163: ldc 136
    //   165: invokevirtual 143	java/lang/String:length	()I
    //   168: iadd
    //   169: invokevirtual 147	java/lang/String:substring	(I)Ljava/lang/String;
    //   172: astore_1
    //   173: aload_1
    //   174: iconst_0
    //   175: aload_1
    //   176: ldc 149
    //   178: invokevirtual 140	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   181: invokevirtual 152	java/lang/String:substring	(II)Ljava/lang/String;
    //   184: astore_1
    //   185: aload_1
    //   186: areturn
    //   187: astore_1
  ...
  public static String L(boolean paramBoolean)
  {
    ...
    //   10: ldc 159
    //   12: astore_2
    //   13: new 100	java/io/BufferedReader
    //   16: dup
    //   17: new 161	java/io/FileReader
    //   20: dup
    //   21: new 110	java/lang/StringBuilder
    //   24: dup
    //   25: invokespecial 163	java/lang/StringBuilder:<init>	()V
    //   28: aload_3
    ...
    //   40: invokespecial 166	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   43: invokespecial 169	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   46: astore_1
    //   47: aload_1
    //   48: invokevirtual 115	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   51: astore 5
    //   53: aload 5
    //   55: ifnull +95 -> 150
    //   58: aload 5
    //   60: invokevirtual 172	java/lang/String:toUpperCase	()Ljava/lang/String;
    //   63: aload_2
    //   64: invokevirtual 134	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   67: ifeq +83 -> 150
    //   70: new 100	java/io/BufferedReader
    //   73: dup
    //   74: new 161	java/io/FileReader
    //   77: dup
    //   78: new 110	java/lang/StringBuilder
    //   81: dup
    //   82: invokespecial 163	java/lang/StringBuilder:<init>	()V
    //   85: aload_3
    ...
    //   97: invokespecial 166	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   100: invokespecial 169	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   103: astore_2
    //   104: aload_2
    //   105: invokevirtual 115	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   108: astore 4
    //   110: aload_2
    //   111: astore_3
    //   112: aload 4
    //   114: ifnull +38 -> 152
    //   117: aload 4
    //   119: invokevirtual 177	java/lang/String:trim	()Ljava/lang/String;
    //   122: astore_3
    //   123: aload_1
    //   124: ifnull +7 -> 131
    //   127: aload_1
    //   128: invokevirtual 122	java/io/BufferedReader:close	()V
    //   131: aload_2
    //   132: ifnull +7 -> 139
    //   135: aload_2
    //   136: invokevirtual 122	java/io/BufferedReader:close	()V
    //   139: aload_3
    //   140: areturn
    //   141: ldc 179
    //   143: astore_3
    ...
    //   153: ifnull +7 -> 160
    //   156: aload_1
    //   157: invokevirtual 122	java/io/BufferedReader:close	()V
    //   160: aload_3
    //   161: ifnull +7 -> 168
    //   164: aload_3
    //   165: invokevirtual 122	java/io/BufferedReader:close	()V
    //   168: aconst_null
    //   169: areturn
    //   170: astore_1
    //   171: aconst_null
    ...
    //   176: ifnull +7 -> 183
    //   179: aload_2
    //   180: invokevirtual 122	java/io/BufferedReader:close	()V
    //   183: aload_1
    //   184: ifnull -16 -> 168
    //   187: aload_1
    //   188: invokevirtual 122	java/io/BufferedReader:close	()V
    //   191: goto -23 -> 168
    //   194: astore_1
    //   195: goto -27 -> 168
    //   198: astore_2
    ...
    //   205: ifnull +7 -> 212
    //   208: aload_1
    //   209: invokevirtual 122	java/io/BufferedReader:close	()V
    //   212: aload_3
    //   213: ifnull +7 -> 220
    //   216: aload_3
    //   217: invokevirtual 122	java/io/BufferedReader:close	()V
    //   220: aload_2
    //   221: athrow
    //   222: astore_1
    //   223: goto -92 -> 131
  ...
  {
    // Byte code:
    //   0: getstatic 15	wf7/gr:sv	J
    //   3: ldc2_w 12
    //   6: lcmp
    //   7: ifne +76 -> 83
    //   10: new 214	java/io/File
    //   13: dup
    //   14: ldc_w 367
    ...
    //   31: dup
    //   32: new 92	java/io/FileInputStream
    //   35: dup
    //   36: aload_0
    ...
    //   55: aload_1
    //   56: astore_0
    //   57: new 155	java/io/IOException
    //   60: dup
    //   61: ldc_w 380
    ...
    //   83: getstatic 15	wf7/gr:sv	J
    //   86: lconst_0
    //   87: lcmp
    //   88: ifle +159 -> 247
    //   91: getstatic 15	wf7/gr:sv	J
    //   94: lreturn
    //   95: aload_1
    //   96: astore_0
    //   97: aload_2
    //   98: invokevirtual 177	java/lang/String:trim	()Ljava/lang/String;
    //   101: ldc_w 387
