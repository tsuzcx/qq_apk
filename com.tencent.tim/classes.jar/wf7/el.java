...
public class el
{
  ...
  private fk<Integer, a> mA = new fk(200);
  private dt mC = null;
  ...
  public void a(int paramInt, long paramLong, String paramString)
  {
    ...
    //   38: aload_0
    //   39: getfield 38	wf7/el:mD	Landroid/os/PowerManager;
    //   42: astore 4
    //   44: aload 4
    //   46: ifnull +15 -> 61
    //   49: aload 5
    //   51: aload_0
    //   52: getfield 38	wf7/el:mD	Landroid/os/PowerManager;
    //   55: invokevirtual 100	android/os/PowerManager:isScreenOn	()Z
    //   58: putfield 104	wf7/el$a:mJ	Z
    //   61: aload_0
    //   62: getfield 34	wf7/el:mA	Lwf7/fk;
    //   65: iload_1
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, ae paramae, int paramInt3, int paramInt4, String paramString2)
  {
    for (;;)
    {
      try
      {
        paramString1 = (a)this.mA.get(Integer.valueOf(paramInt2));
  ...
  public void b(dt paramdt)
  {
    ...
    //   2: aload_0
    //   3: aload_1
    //   4: putfield 36	wf7/el:mC	Lwf7/dt;
    //   7: aload_0
    ...
    //   19: putfield 38	wf7/el:mD	Landroid/os/PowerManager;
  ...
  public boolean c(int paramInt, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      try
      {
        locala = (a)this.mA.get(Integer.valueOf(paramInt));
        if (locala == null)
        {
          paramBoolean = false;
          return paramBoolean;
