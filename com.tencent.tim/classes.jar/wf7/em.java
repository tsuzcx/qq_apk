...
public class em
{
  ...
  private d mW = null;
  private d mX = null;
  private ArrayList<d> mY = new ArrayList();
  private LinkedHashMap<Integer, d> mZ = new LinkedHashMap();
  ...
  public em(Context paramContext, dt paramdt, b paramb, c paramc, boolean paramBoolean, String paramString)
  {
  ...
  private final ArrayList<ae> a(d paramd, boolean paramBoolean, af paramaf, ArrayList<ae> paramArrayList)
  {
  ...
  private void a(boolean paramBoolean, int paramInt, d arg3)
  {
    if (??? == null) {
      return;
    }
    ...
    for (;;)
    {
      ...
      while (???.hasNext()) {
        a(paramBoolean, (d)???.next(), paramInt, 0, null);
      }
      break;
  ...
  private void a(boolean paramBoolean, d paramd, int paramInt1, int paramInt2, ArrayList<ae> paramArrayList)
  {
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    synchronized (this.mY)
    {
      ...
      {
        a(paramBoolean1, (d)((Iterator)localObject1).next(), paramInt, 0, null);
        continue;
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, d paramd, int paramInt1, int paramInt2, ArrayList<ae> paramArrayList)
  {
      ...
      if ((localObject2 != null) && (((ArrayList)localObject2).size() > 0))
      {
        ...
        do
        {
          ...
          while (!((Iterator)localObject2).hasNext())
          {
            ...
            } while ((localObject2 == null) || (((d)localObject2).nE == null) || (((d)localObject2).nE.size() <= 0));
            localObject2 = ((d)localObject2).nE.iterator();
          }
  ...
  private d al(int paramInt)
  {
    synchronized (this.mZ)
    {
      d locald = (d)this.mZ.remove(Integer.valueOf(paramInt));
      return locald;
    }
  }
  ...
  private void cQ()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 119	wf7/em:li	Lwf7/dt;
    //   6: invokevirtual 156	wf7/dt:bX	()Z
    //   9: istore_1
    //   10: iload_1
    //   11: ifne +6 -> 17
    //   14: aload_0
    ...
    //   16: return
    //   17: aload_0
    //   18: getfield 110	wf7/em:nk	J
    //   21: lconst_0
    //   22: lcmp
    //   23: ifeq +18 -> 41
    //   26: invokestatic 479	java/lang/System:currentTimeMillis	()J
    //   29: aload_0
    //   30: getfield 110	wf7/em:nk	J
    //   33: lsub
    //   34: ldc2_w 480
    //   37: lcmp
    //   38: ifle -24 -> 14
    //   41: aload_0
    //   42: invokestatic 479	java/lang/System:currentTimeMillis	()J
    //   45: putfield 110	wf7/em:nk	J
    //   48: aload_0
    //   49: getfield 108	wf7/em:nj	Landroid/os/Handler;
    //   52: bipush 8
    //   54: invokevirtual 483	android/os/Handler:removeMessages	(I)V
    //   57: aload_0
    //   58: getfield 108	wf7/em:nj	Landroid/os/Handler;
    //   61: bipush 8
    //   63: ldc2_w 484
    //   66: invokevirtual 489	android/os/Handler:sendEmptyMessageDelayed	(IJ)Z
    //   69: pop
    //   70: goto -56 -> 14
    //   73: astore_2
    //   74: aload_0
  ...
  private void cR()
  {
    ...
    //   16: return
    //   17: aload_0
    //   18: getfield 108	wf7/em:nj	Landroid/os/Handler;
    //   21: bipush 10
    //   23: invokevirtual 483	android/os/Handler:removeMessages	(I)V
    //   26: aload_0
    //   27: getfield 108	wf7/em:nj	Landroid/os/Handler;
    //   30: bipush 10
    //   32: ldc2_w 490
    //   35: invokevirtual 489	android/os/Handler:sendEmptyMessageDelayed	(IJ)Z
    //   38: pop
    //   39: goto -25 -> 14
    //   42: astore_2
    //   43: aload_0
  ...
  protected dx a(boolean paramBoolean, d paramd)
  {
    if (paramd == null) {
      return null;
    }
  ...
  public void a(int paramInt, long paramLong, boolean paramBoolean, ArrayList<x> paramArrayList, a parama)
  {
    a(new d(paramInt, false, false, false, paramLong, paramArrayList, parama, 0L));
    if (paramBoolean) {
      this.mU.t(false);
    }
  }
  
  protected void a(ArrayList<x> paramArrayList, a parama)
  {
    this.mW = new d(0, true, false, false, 0L, paramArrayList, parama, 0L);
    this.mW.nu = true;
  ...
  protected void b(ArrayList<x> paramArrayList, a parama)
  {
    this.mX = new d(0, true, false, false, 0L, paramArrayList, parama, 0L);
    this.mX.nv = true;
  ...
  {
    public abstract void a(boolean paramBoolean, int paramInt1, int paramInt2, ArrayList<ae> paramArrayList);
  }
  
  public static abstract interface b
  {
    public abstract long a(boolean paramBoolean, int paramInt, ae paramae);
    
    public abstract long b(boolean paramBoolean, int paramInt, ae paramae);
  }
  ...
  public static class d
  {
    ...
    public d(int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, long paramLong1, ArrayList<x> paramArrayList, em.a parama, long paramLong2)
    {
      this.ns = paramInt;
