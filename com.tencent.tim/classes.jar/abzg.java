  ...
  extends acbg
{
  ...
  public abzg(Context paramContext, SessionInfo paramSessionInfo)
  {
      ...
      for (;;)
      {
        ...
        if (k < this.ctN)
        {
          ...
          if (m < this.xf.size())
          {
            ...
            if (locala.d.mType == 2)
            {
              locala.sk.setBackgroundResource(2130838650);
              ...
              ((ImageView)localObject2).postDelayed(new ApolloFavViewBinder.1(this, (ImageView)localObject2, localRelativeLayout, (RelativeLayout)localObject1, locala), 200L);
              this.cuv = -1;
              localView.setContentDescription(localApolloActionData.actionName + acfp.m(2131702479));
            }
          }
          for (;;)
          {
  ...
  public View bQ()
  {
    ...
    case 4: 
      return LayoutInflater.from(this.mContext).inflate(2131558722, null);
    }
    return new ApolloLinearLayout(this.mContext, null, this.mBinderType, this.ctN, this.ctO);
  }
