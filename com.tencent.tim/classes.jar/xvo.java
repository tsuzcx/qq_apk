  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (aagc.s(xvk.dr, l))
      {
        ...
        {
          ((zxj)localObject2).cO(this.b.sessionInfo.aTl, 8);
        ...
        else
        {
          if (this.b.sessionInfo.cZ == 1)
          {
            ...
            {
              ((zxj)localObject2).cP(this.b.sessionInfo.aTl, 8);
              if (!QLog.isColorLevel()) {
                continue;
              }
          ...
          if ((localObject3 != null) && ((((zxi)localObject3).isOpen) || (((zxi)localObject3).isFinish) || (((zxi)localObject3).bul) || (((zxi)localObject3).expireTime < l)))
          {
            ...
            ((Bundle)localObject4).putString("feedsid", aagm.m(localMessageForQQWalletMsg));
            ((zxj)localObject2).a(this.b.sessionInfo, (zxi)localObject3, l, 131072, (String)localObject1, localMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem.skinId, localMessageForQQWalletMsg.fromHBList, (Bundle)localObject4);
            if (QLog.isColorLevel()) {
          ...
          else
          {
            ...
            PublicFragmentActivity.b.start(paramView.getContext(), (Intent)localObject2, PublicTransFragmentActivity.class, RedPacketKSongFragment.class);
            if (QLog.isColorLevel()) {
