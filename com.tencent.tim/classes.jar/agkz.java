  ...
  implements aglh, aqoi
{
  ...
  private agkz(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, String paramString3)
  {
  ...
  public static agkz a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, String paramString3)
  {
    ...
    return new agkz(paramQQAppInterface, paramLong1, paramInt1, paramInt2, paramString1, paramString2, paramLong2, paramBoolean, paramString3);
  }
  ...
  {
    return this.mApp.getHttpCommunicatort();
  }
  ...
  public boolean a(String paramString, long paramLong, byte[] paramArrayOfByte)
  {
    ...
    this.b.setRequestProperty("Net-type", paramArrayOfByte);
    ...
    if ((this.mIsHttps) && (paramArrayOfByte.startsWith("https")))
    {
      this.b.mIsHttps = true;
      this.b.cML = aglb.mp(paramString);
      this.b.cux = this.bHV;
    }
    this.b.d = ahav.a();
    a().a(this.b);
