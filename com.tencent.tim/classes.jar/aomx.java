  ...
  extends aoiz
{
  ...
  /* Error */
  private void hN(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_3
    //   2: invokestatic 40	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   5: ifeq +37 -> 42
    //   8: ldc 42
    //   10: iconst_2
    ...
    //   39: invokestatic 61	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   42: new 44	java/lang/StringBuilder
    //   45: dup
    //   46: invokespecial 45	java/lang/StringBuilder:<init>	()V
    //   49: aload_1
    ...
    //   61: astore 5
    //   63: new 65	java/io/File
    //   66: dup
    //   67: aload 5
    //   69: invokespecial 68	java/io/File:<init>	(Ljava/lang/String;)V
    //   72: astore 4
    //   74: aload 4
    //   76: invokevirtual 71	java/io/File:exists	()Z
    //   79: ifeq +9 -> 88
    //   82: aload 4
    //   84: invokevirtual 74	java/io/File:delete	()Z
    //   87: pop
    //   88: aload 4
    //   90: invokevirtual 78	java/io/File:getParentFile	()Ljava/io/File;
    //   93: astore 6
    //   95: aload 6
    //   97: ifnull +17 -> 114
    //   100: aload 6
    //   102: invokevirtual 71	java/io/File:exists	()Z
    //   105: ifne +9 -> 114
    //   108: aload 6
    //   110: invokevirtual 81	java/io/File:mkdirs	()Z
    //   113: pop
    //   114: aconst_null
    //   115: ldc 83
    //   117: aload_2
    //   118: invokestatic 89	com/tencent/mobileqq/msf/sdk/MsfSdkUtils:insertMtype	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   121: aload 4
    //   123: invokestatic 95	com/tencent/mobileqq/utils/HttpDownloadUtil:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Ljava/io/File;)Z
    //   126: ifeq +102 -> 228
    //   129: aload 5
    //   131: invokestatic 101	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   134: astore_2
    //   135: aload_2
    //   136: invokestatic 103	aomx:P	(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   139: astore_2
    //   140: aload_2
    //   141: ifnull +81 -> 222
    //   144: new 65	java/io/File
    //   147: dup
    //   148: aload_1
    //   149: invokespecial 68	java/io/File:<init>	(Ljava/lang/String;)V
    //   152: astore_1
    //   153: aload_1
    //   154: invokevirtual 71	java/io/File:exists	()Z
    //   157: ifeq +8 -> 165
    //   160: aload_1
    //   161: invokevirtual 74	java/io/File:delete	()Z
    //   164: pop
    //   165: aload_1
    //   166: invokevirtual 78	java/io/File:getParentFile	()Ljava/io/File;
    //   169: astore 5
    //   171: aload 5
    //   173: ifnull +17 -> 190
    //   176: aload 5
    ...
    //   181: ifne +9 -> 190
    //   184: aload 5
    //   186: invokevirtual 81	java/io/File:mkdirs	()Z
    //   189: pop
    //   190: new 105	java/io/FileOutputStream
    //   193: dup
    //   194: aload_1
    //   195: invokespecial 108	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   198: astore_1
    //   199: aload_1
    //   200: ifnull +22 -> 222
    //   203: aload_2
    //   204: getstatic 114	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   207: bipush 70
    //   209: aload_1
    //   210: invokevirtual 118	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   213: pop
    //   214: aload_1
    //   215: invokevirtual 121	java/io/FileOutputStream:flush	()V
    //   218: aload_1
    //   219: invokevirtual 124	java/io/FileOutputStream:close	()V
    //   222: aload 4
    //   224: invokevirtual 74	java/io/File:delete	()Z
    //   227: pop
    //   228: return
    //   229: astore_2
    //   230: aload_2
    //   231: invokevirtual 127	java/lang/OutOfMemoryError:printStackTrace	()V
    //   234: aconst_null
    //   235: astore_2
    //   236: goto -101 -> 135
    //   239: astore_2
    ...
    //   249: astore_1
    //   250: aload_1
    //   251: invokevirtual 129	java/io/FileNotFoundException:printStackTrace	()V
    //   254: aload_3
    //   255: astore_1
    //   256: goto -57 -> 199
    //   259: astore_1
    //   260: aload_1
    //   261: invokevirtual 130	java/io/IOException:printStackTrace	()V
    //   264: goto -42 -> 222
  ...
  private String ov(String paramString)
  {
    int i = 0;
    ...
    throws Exception
  {
    ...
    {
      paramOutputStream = paramURLDrawableHandler;
      if (aqft.equalsWithNullCheck(((URL)localObject).getProtocol(), "troop_photo_qzone"))
      {
        ...
        else
        {
          ...
          if (localObject != null)
          {
            hN(paramURLDrawableHandler, ov((String)localObject));
            paramOutputStream = paramDownloadParams;
          }
        }
      }
