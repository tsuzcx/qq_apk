...
public class awgo
  ...
  implements avzi
{
  private BroadcastReceiver broadcastReceiver = new awgp(this);
  private String cPV;
  private String cPW;
  private String cPX;
  private boolean dqj;
        ...
        if (!TextUtils.isEmpty(str1))
        {
          ...
          if ((localObject != null) && (((JSONObject)localObject).optInt("videoType") == 0))
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject)) {
              this.f.mRuntime.a().getHandler(awgt.class).post(new QzoneUiJsPlugin.1(this, (String)localObject));
            }
          }
          ...
          if (avqy.a().getVipType() > 0)
          {
            bool1 = true;
            break label490;
            avqw.a(paramString, "ref_h5_record_video", bool1, bool2, bool3, bool4, bool5, bool6, str1, str2, (Intent)localObject);
          }
        }
        else
        {
  ...
  private void abt(String paramString)
  {
    ...
    avqw.b(this.f.mRuntime.getActivity(), i, paramString, l2, localBundle);
    return;
    label199:
    if (i == 1) {
      avpw.a(this.f.mRuntime.getActivity(), avpw.d.a(), i, paramString, l1, l1 + l2);
    }
  }
  ...
  private void abu(String paramString)
  {
    ...
    try
    {
      ...
      this.f.mRuntime.a().getHandler(awgt.class).post(new QzoneUiJsPlugin.2(this, paramString));
      return;
    }
    catch (JSONException paramString)
    {
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        if (!TextUtils.isEmpty(paramString)) {
          this.f.mRuntime.a().getHandler(awgt.class).post(new QzoneUiJsPlugin.3(this, paramString));
        }
      }
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if ("ptucamera".equals(paramString.optString("shoot")))
        {
          ...
          avqw.a(0L, paramString, true, true, "QZonePublishMoodTabActivity", bool2, true, str, bool1, null, null, null);
          return;
        }
      }
      catch (JSONException paramString)
  ...
  private JSONObject c(Intent paramIntent)
  {
  ...
  private void registerBroadcast()
  {
    ...
    this.f.mRuntime.getActivity().registerReceiver(this.broadcastReceiver, localIntentFilter);
    this.dqj = true;
  }
  
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    if ((!"qzui".equals(paramString2)) || (this.f == null)) {
      return false;
    }
  ...
  public void onDestroy()
  {
    if (this.dqj)
    {
      this.f.mRuntime.getActivity().unregisterReceiver(this.broadcastReceiver);
      this.dqj = false;
    }
    avzf.a().b(this);
    super.onDestroy();
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    } while ((!"cmd.videoGetFakeFeedCover".equals(paramString)) || (TextUtils.isEmpty(this.cPW)));
    ...
    if (TextUtils.isEmpty(paramString)) {}
    for (paramString = "";; paramString = awfn.k(paramString, i, j))
    {
      ...
      try
      {
        ...
        this.f.callJs(this.cPW, new String[] { localJSONObject1.toString() });
        return;
      }
      catch (JSONException paramString)
      {
