  ...
  implements anbs
{
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    if (paramMsg.appshare_info.has())
    {
      ...
      localObject1 = aqgb.a((msg_comm.PluginInfo)localObject1);
      if (QLog.isColorLevel()) {
        QLog.d("AppShareInfoDecoder", 2, "<--decodeC2CMsgPkg_AppShared appShareID:" + ((AppShareID)localObject1).toString());
      }
      localObject2 = (AppShareID)paramMessageHandler.b().find(AppShareID.class, "strPkgName=?", new String[] { ((AppShareID)localObject1).strPkgName });
      if (localObject2 == null)
      {
        paramMessageHandler.b().persist((Entity)localObject1);
        if (QLog.isColorLevel()) {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((paramMsg.msg_body.has()) && (((im_msg_body.MsgBody)paramMsg.msg_body.get()).rich_text.has()))
      {
        ...
        paramMsg = null;
        localObject1 = BaseApplication.getContext().getString(2131720033);
        ...
        for (;;)
        {
          ...
          for (localObject3 = str1;; localObject3 = null)
          {
            if (localObject3 != null)
            {
              ...
              localObject2 = aoon.a((String)localObject3, j, 1, false, (String)localObject3);
              if (QLog.isColorLevel()) {
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                {
                  paramMessageHandler.b().remove((Entity)localObject2);
                  paramMessageHandler.b().persist((Entity)localObject1);
                  if (!QLog.isColorLevel()) {
                    break;
                  }
                ...
                else if (((im_msg_body.Elem)localObject3).custom_face.has())
                {
                  ...
                  localObject6 = aqhs.bytes2HexStr((byte[])localObject6);
                  localObject4 = aqhs.bytes2HexStr((byte[])localObject4);
                  localObject5 = aqhs.bytes2HexStr((byte[])localObject5);
                  if (QLog.isColorLevel()) {
                  ...
                  localObject1 = aoon.a((String)localObject1, 0L, 1, false, (String)localObject1);
                  paramBoolean = true;
                  continue;
                  ...
                  {
                    if (i == 0) {
                      paramMessageHandler.j(Long.valueOf(l1));
                    }
                    do
                    {
                      return;
                      if ((!paramBoolean) && (bool1))
                      {
                        paramMessageHandler = (MessageForText)anbi.d(-1000);
                    ...
                    paramMessageHandler.Eo(String.valueOf(aqgb.X(l1)));
                    paramMsg = aqfw.a(localAppShareInfo.appshare_cookie.get().toByteArray());
                    if (QLog.isColorLevel()) {
                      QLog.d("AppShareInfoDecoder", 2, "<--decodeC2CMsgPkg_AppShared: content:" + (String)localObject1 + ",opType:" + paramMsg.opType);
                    }
                    localObject2 = aqfw.b((String)localObject1, (String)localObject2, l1, paramMsg.csF);
                    if (QLog.isColorLevel()) {
                      QLog.d("AppShareInfoDecoder", 2, "<--decodeC2CMsgPkg_AppShared : content:" + (String)localObject1 + ",encodeMsg:" + (String)localObject2);
                    }
                    localObject1 = anbi.d(paramMsg.opType);
                    ((MessageRecord)localObject1).msgtype = paramMsg.opType;
  ...
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, anax paramanax)
  {
    ...
    a(paramMessageHandler, paramList, paramMsg, 0L, 0L, paramanax.cEE);
  }
}
