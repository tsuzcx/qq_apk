...
public abstract interface avgv
  extends IInterface
{
    ...
    implements avgv
  {
    ...
    public static avgv a(IBinder paramIBinder)
    {
      if (paramIBinder == null) {
        return null;
      }
      IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.qappcenter.remote.IServiceHandler");
      if ((localIInterface != null) && ((localIInterface instanceof avgv))) {
        return (avgv)localIInterface;
      }
      return new avgv.a.a(paramIBinder);
    }
      ...
      implements avgv
    {
        ...
        throws RemoteException
      {
        ...
        //   24: aload_2
        //   25: iconst_0
        //   26: invokevirtual 44	cooperation/qappcenter/remote/SendMsg:writeToParcel	(Landroid/os/Parcel;I)V
        //   29: aload_0
        //   30: getfield 18	avgv$a$a:mRemote	Landroid/os/IBinder;
        //   33: iconst_1
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
