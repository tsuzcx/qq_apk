  ...
  implements lpi
{
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
    throws JSONException
  {
    return lkx.a(paramBaseArticleInfo);
  }
  ...
  public void a(int paramInt1, Container paramContainer, lie paramlie, int paramInt2)
  {
    ...
    if ((paramlie != null) && (paramlie.a() != null) && (AdvertisementInfo.isAdvertisementInfo(paramlie.a())))
    {
      ...
      {
        localObject = (koh)localObject;
        ((koh)localObject).pq(paramInt1);
        ((koh)localObject).setModel(paramlie, true);
      }
      paramContainer = paramContainer.findViewBaseByName("id_article_double_image");
      if ((paramContainer != null) && ((paramContainer instanceof kos))) {
        ((kos)paramContainer).setModel(paramlie);
      }
    }
  }
