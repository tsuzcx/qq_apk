...
{
  public awzf(AEBeautyProviderView paramAEBeautyProviderView) {}
  
  public void onProgressChanged(SeekBar paramSeekBar, int paramInt, boolean paramBoolean)
  {
    if (AEBeautyProviderView.a(this.a) != null)
    {
      AEBeautyProviderView.a(this.a).setSharpFaceLevel(paramInt);
      this.a.agX.setText("+" + String.format("%.1f", new Object[] { Float.valueOf(paramInt / 10.0F) }));
    }
  }
  ...
  public void onStopTrackingTouch(SeekBar paramSeekBar)
  {
    ...
    axip.a().adZ(paramSeekBar.getProgress());
