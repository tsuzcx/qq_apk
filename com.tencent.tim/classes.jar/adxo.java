...
public class adxo
  extends accg
{
  public adxo(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  public void b(List<String> paramList, acci paramacci)
  {
    ...
    do
    {
      ...
      localBubble_Req_Comm.mqqver.set("3.4.4");
    ...
    paramacci = super.createToServiceMsg("bubble.1", paramacci);
    paramacci.putWupBuffer(paramList.toByteArray());
      ...
      do
      {
        ...
        catch (Exception paramFromServiceMsg)
        {
          ...
          if ((paramFromServiceMsg.rspcmd_0x01.has()) && (paramFromServiceMsg.rspcmd_0x01.user_text_info.has()))
          {
            ...
            adxn.a().a(this.app, true, paramFromServiceMsg);
