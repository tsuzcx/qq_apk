  ...
  implements acci
{
    ...
    case 6: 
      do
      {
        do
        {
          ...
          return;
          r(paramBoolean, ((Integer)paramObject[0]).intValue(), (String)paramObject[1]);
          return;
        } while ((paramObject == null) || (!(paramObject instanceof Object[])));
        paramObject = (Object[])paramObject;
      } while (paramObject.length < 2);
      s(paramBoolean, ((Integer)paramObject[0]).intValue(), (String)paramObject[1]);
      return;
    case 3: 
      paramObject = (Object[])paramObject;
  ...
  public void r(boolean paramBoolean, int paramInt, String paramString) {}
  
  public void s(boolean paramBoolean, int paramInt, String paramString) {}
}
