  ...
  extends VasWebviewJsPlugin
{
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (paramString3.equalsIgnoreCase("getCountryCode"))
    {
      ...
      try
      {
        this.bYe = new JSONObject(paramJsBridgeListener).getString("callbackId");
        paramJsBridgeListener = (BaseActivity)this.mRuntime.getActivity();
      ...
      startActivityForResult(new Intent(paramJsBridgeListener, CountryActivity.class), this.bv);
    }
    for (;;)
    {
      return true;
      if (paramString3.equalsIgnoreCase("onAuthResult"))
      {
        ...
        try
        {
          int i = new JSONObject(paramJsBridgeListener).getInt("result");
          paramJsBridgeListener = new Bundle();
          paramJsBridgeListener.putInt("result", i);
          QIPCClientHelper.getInstance().getClient().callServer("REAL_NAME", "ON_WEB_AUTH_RESULT", paramJsBridgeListener);
        }
        catch (JSONException paramJsBridgeListener)
        {
          if (QLog.isColorLevel()) {
      ...
      else if (paramString3.equalsIgnoreCase("getDeviceInfo"))
      {
        ...
        try
        {
          ...
          try
          {
            paramString3.put("appid", String.valueOf(AppSetting.getAppId()));
            paramString3.put("imei", auri.getIMEI("ef0716"));
  ...
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    Object localObject = "";
    String str1 = "";
    if ((paramByte == this.bv) && (paramInt == -1)) {
      if (paramIntent != null)
      {
    ...
    try
    {
      for (;;)
      {
        ...
        callJs(this.bYe, new String[] { localJSONObject.toString() });
        return;
        if (QLog.isColorLevel()) {
