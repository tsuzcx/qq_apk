...
public class axja
{
  ...
  {
    axiy.i("PicChooseJumpUtil", "[jumpForAECircle] Start");
    axiy.d("PicChooseJumpUtil", "[AE Profiler] jumpForAECircle Start");
    ...
    localIntent.putExtra("VIDEO_STORY_FROM_TYPE", AETemplateInfoFragment.bI(paramActivity));
  ...
  public static void cQ(Activity paramActivity)
  {
    ...
    {
      axiy.e("PicChooseJumpUtil", "activity is null.");
      return;
    }
    ...
    localIntent.putExtra("VIDEO_STORY_JUMP_TO_TYPE", axcg.j(paramActivity.getIntent()));
    localIntent.putExtra("VIDEO_STORY_FROM_TYPE", axcg.i(paramActivity.getIntent()));
  ...
  public static void y(Activity paramActivity, int paramInt)
  {
  ...
  public static void z(Activity paramActivity, int paramInt)
  {
    String str = QIMCameraCaptureActivity.class.getName();
    Intent localIntent = new Intent(paramActivity, NewPhotoListActivity.class);
    localIntent.putExtra("PhotoConst.INIT_ACTIVITY_CLASS_NAME", str);
