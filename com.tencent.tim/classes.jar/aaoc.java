...
public class aaoc
  implements ausj.a
{
  public aaoc(TimLoginQQView paramTimLoginQQView) {}
  
  public void OnClick(View paramView, int paramInt)
  {
    TimLoginQQView.f(this.this$0, false);
    if (TimLoginQQView.d(this.this$0)) {
      return;
    }
    if (paramInt == 0)
    {
      ...
      anpc.report("Login_clickforgotpassword_clickretrieve_null_null");
      paramView = null;
    ...
    for (paramView = this.this$0.a.getText().toString();; paramView = "https://ti.qq.com/safe/forgetpw?source_id=2756") {
      for (;;)
      {
        try
        {
          ...
          QLog.d("LoginActivity.TimLoginQQView", 1, new Object[] { "forgetpwd url is ", paramView });
          ...
          TimLoginQQView.e(this.this$0, true);
        ...
        catch (Exception paramView)
        {
          ...
          QLog.i("LoginActivity.TimLoginQQView", 4, String.format(Locale.getDefault(), "forget pwd %s", new Object[] { this.this$0.a.getText().toString() }));
          paramView = (View)localObject;
          continue;
        }
        if (paramInt == 1)
        {
          ...
          anpc.report("Login_clickforgotpassword_clickSMS_null_null");
