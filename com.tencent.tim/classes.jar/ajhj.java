...
public class ajhj
{
  ...
  public static void a(Context paramContext, String paramString1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, MessageRecord paramMessageRecord, String paramString2)
  {
    ...
    if ((!TextUtils.isEmpty(paramString1)) && (ntp.ek(paramString1)))
    {
      ntp.b(paramContext, null, ntp.fd(paramString1), null);
      return;
    }
    AudioHelper.rw("gotoWebViewBrowser_" + paramString1);
    ...
    for (;;)
    {
      ...
      if ((paramString2 instanceof QQAppInterface)) {
        wis.a(localIntent, (QQAppInterface)paramString2, paramMessageRecord);
      }
      wgv.c(paramContext, localIntent, paramString1);
