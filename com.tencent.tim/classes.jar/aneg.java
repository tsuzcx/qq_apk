...
public class aneg
  extends MSFServlet
{
  public static AtomicInteger au = new AtomicInteger(0);
  ...
  public static void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/if_proxy", "application/json", localJSONObject.toString(), new aneh(paramBusinessObserver));
      return;
    }
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, int paramInt2, byte[] paramArrayOfByte, BusinessObserver paramBusinessObserver)
  {
    ...
    paramArrayOfByte = new NewIntent(paramQQAppInterface.getApp(), aneg.class);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, aklm paramaklm)
  {
    paramString = new FaceSecureCheck.SecureCheckRequest();
    Object localObject = lfn.getIpAddress(BaseApplicationImpl.getApplication());
    boolean bool;
    if (localObject != null)
    {
    ...
    for (;;)
    {
      paramString.uint32_seq.set(au.addAndGet(1));
      paramString.uint32_timestamp.set((int)(System.currentTimeMillis() / 1000L));
      paramString.uint32_version.set(AppSetting.getAppId());
      ...
      localObject = new NewIntent(paramQQAppInterface.getApp(), aneg.class);
      ((NewIntent)localObject).setObserver(paramaklm);
  ...
  public static void a(String paramString1, long paramLong, String paramString2, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/appconf", "application/json", localJSONObject.toString(), new anei(paramBusinessObserver));
      return;
    }
    catch (JSONException paramString1)
    {
  ...
  private static void a(String paramString1, String paramString2, String paramString3, aneg.a parama)
  {
    ThreadManager.getNetExcutor().execute(new LoginVerifyServlet.3(paramString1, paramString2, paramString3, parama));
  }
