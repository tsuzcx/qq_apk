...
public class igo
{
  public static String a(ConfigurationService.Config paramConfig, int paramInt1, int paramInt2)
  {
    ...
    while (paramInt1 < paramInt2)
    {
      ...
      else
      {
        ...
        {
          localObject1 = aden.u((byte[])localObject2);
  ...
  public static void a(int paramInt, String paramString, ConfigurationService.ConfigSeq paramConfigSeq)
  {
    ...
    for (;;)
    {
      ...
      return;
      paramInt = EffectConfigBase.j(paramInt, EffectConfigBase.Nk);
      paramConfigSeq.version.set(paramInt);
      paramConfigSeq.compress.set(1);
      continue;
      paramInt = aqmj.aN(BaseApplicationImpl.getContext());
      paramConfigSeq.version.set(paramInt);
      paramConfigSeq.compress.set(1);
    }
  }
  ...
  public static void b(int paramInt, String paramString, ConfigurationService.Config paramConfig)
  {
    ...
    for (;;)
    {
      ...
      return;
      int j = EffectConfigBase.j(paramInt, EffectConfigBase.Nk);
      paramConfig = a(paramConfig, j, paramInt);
      paramString = paramConfig;
      i = j;
      if (paramConfig != null)
      {
        EffectConfigBase.j(paramInt, EffectConfigBase.Nk, k, paramConfig);
        paramString = paramConfig;
        i = j;
        continue;
        i = EffectConfigBase.j(paramInt, EffectConfigBase.Nk);
        paramConfig = a(paramConfig, i, paramInt);
        paramString = paramConfig;
        paramInt = i;
        if (paramConfig != null)
        {
          iou.b(localQQAppInterface.getApplication(), paramConfig, k, true);
          paramString = paramConfig;
          continue;
          i = aqmj.aN(localQQAppInterface.getApplication());
          paramConfig = a(paramConfig, i, paramInt);
          paramString = paramConfig;
          paramInt = i;
          if (paramConfig != null)
          {
            aqmj.av(localQQAppInterface.getApplication(), k);
            paramString = aqmj.g(localQQAppInterface.getCurrentAccountUin());
            if (paramString != null) {
