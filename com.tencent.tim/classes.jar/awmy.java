...
public class awmy
{
  ...
  /* Error */
  public static android.graphics.Bitmap decodeFileWithBuffer(String paramString, android.graphics.BitmapFactory.Options paramOptions)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_3
    ...
    //   17: astore_2
    //   18: aload_1
    //   19: getfield 52	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   22: ifeq +50 -> 72
    //   25: aload 6
    //   27: astore_2
    //   28: new 54	java/io/FileInputStream
    //   31: dup
    //   32: aload_0
    //   33: invokespecial 58	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   36: astore_0
    //   37: new 60	java/io/BufferedInputStream
    //   40: dup
    //   41: aload_0
    //   42: sipush 8192
    //   45: invokespecial 63	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;I)V
    //   48: aconst_null
    //   49: aload_1
    //   50: invokestatic 69	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   53: astore_1
    //   54: aload_0
    //   55: astore_2
    //   56: aload_1
    ...
    //   104: aload_1
    //   105: aload_0
    //   106: invokevirtual 91	android/graphics/Bitmap:getHeight	()I
    //   109: putfield 95	android/graphics/BitmapFactory$Options:outHeight	I
    //   112: aload 6
    //   114: astore_2
    //   115: aload_1
    //   116: aload_0
    //   117: invokevirtual 98	android/graphics/Bitmap:getWidth	()I
    //   120: putfield 101	android/graphics/BitmapFactory$Options:outWidth	I
    //   123: aload 5
    //   125: astore_2
    //   126: goto -68 -> 58
    //   129: aload 6
    //   131: astore_2
    //   132: invokestatic 107	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   135: invokevirtual 111	com/tencent/common/app/BaseApplicationImpl:getRuntime	()Lmqq/app/AppRuntime;
    //   138: instanceof 113
    //   141: ifeq +33 -> 174
    //   144: aload 6
    //   146: astore_2
    //   147: invokestatic 119	com/tencent/component/media/image/ImageManager:getInstance	()Lcom/tencent/component/media/image/ImageManager;
    //   150: invokevirtual 123	com/tencent/component/media/image/ImageManager:getDecoder	()Lcom/tencent/component/media/image/IDecoder;
    //   153: new 16	java/io/File
    //   156: dup
    //   157: aload_0
    ...
    //   177: aload_0
    //   178: aload_1
    //   179: invokestatic 133	com/tencent/image/SafeBitmapFactory:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   182: astore_0
    //   183: aload 5
    //   185: astore_2
    //   186: goto -128 -> 58
    ...
    //   192: aload_3
    //   193: astore_2
    //   194: invokestatic 139	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   197: ifeq +14 -> 211
    //   200: aload_3
    //   201: astore_2
    //   202: ldc 141
    ...
    //   214: ifnull -144 -> 70
    //   217: aload_3
    //   218: invokevirtual 75	java/io/InputStream:close	()V
    //   221: aload_0
    //   222: areturn
    //   223: astore_1
    //   224: aload_0
    ...
    //   232: aload_3
    //   233: astore_2
    //   234: invokestatic 139	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   237: ifeq +14 -> 251
    //   240: aload_3
    //   241: astore_2
    //   242: ldc 141
    ...
    //   254: ifnull -184 -> 70
    //   257: aload_3
    //   258: invokevirtual 75	java/io/InputStream:close	()V
    //   261: aload_0
    //   262: areturn
    //   263: astore_1
    //   264: aload_0
    ...
    //   268: ifnull +7 -> 275
    //   271: aload_2
    //   272: invokevirtual 75	java/io/InputStream:close	()V
    //   275: aload_0
    //   276: athrow
    //   277: astore_1
    //   278: aload_0
  ...
  public static int getIdFromZipUrl(String paramString)
  {
