...
{
  public amvz(GroupSearchEngine paramGroupSearchEngine, amwd paramamwd, String paramString, int paramInt)
  {
  ...
  {
    return new ampq(paramList, paramString, GroupSearchEngine.a(this.this$0));
  }
}
