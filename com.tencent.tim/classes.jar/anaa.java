...
public class anaa
  extends swr
{
  private static final String[] gu = { "ClubInfoSvc", "VipCustom", "QCUniBusinessLogic" };
  
  private long ay(String paramString)
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if ((localAppRuntime != null) && ((localAppRuntime instanceof QQAppInterface)))
    {
      long l = aqvl.c((QQAppInterface)localAppRuntime, "name_plate_config_version", 0L);
      if (TextUtils.isEmpty(afab.j((QQAppInterface)localAppRuntime, paramString))) {
        return 0L;
      }
      return l;
    }
  ...
  private <T> T c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, T paramT)
  {
  ...
  private boolean i(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    String str3 = paramToServiceMsg.extraData.getString(acny.KEY_UIN);
    Object localObject = paramToServiceMsg.extraData.getString(acny.bpX);
    long l1 = paramToServiceMsg.extraData.getLong(acny.bqg);
    boolean bool3 = aqrc.aFx();
    boolean bool1 = false;
    boolean bool2 = false;
    ...
    String str4 = aqux.a(0, BaseApplicationImpl.getContext());
    localObject = aqux.a(1, BaseApplicationImpl.getContext());
    ...
    localPrivExtV2Req.iItemCfgVer = ay(str3);
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        localPrivExtV2Req.pullPayRuleCfgTime = aqvl.c((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "last_pull_pay_rule", 0L);
        ...
        paramToServiceMsg.extraData.putBoolean(acny.bqc, bool1);
        paramToServiceMsg.extraData.putBoolean(acny.bqd, bool2);
        ...
        try
        {
          localPrivExtV2Req.sImsi1 = auri.ru("a4bd32");
        }
    ...
    {
      if (bool1) {
        paramToServiceMsg.extraData.putString(acny.bqe, localPrivExtV2Req.sImsi1);
      }
      if (bool2) {
        paramToServiceMsg.extraData.putString(acny.bqf, localPrivExtV2Req.sImsi2);
      }
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    if ("ClubInfoSvc.queryPrivExt".equals(paramToServiceMsg.getServiceCmd())) {
      return c(paramToServiceMsg, paramFromServiceMsg, new PrivExtV2Rsp());
    }
    if ("ClubInfoSvc.guanjiaReport".equals(paramToServiceMsg.getServiceCmd())) {
      return c(paramToServiceMsg, paramFromServiceMsg, new GuanjiaReportRsp());
    }
    if ("VipCustom.GetCustomOnlineStatus".equals(paramToServiceMsg.getServiceCmd()))
    {
      ...
      return c(paramToServiceMsg, paramFromServiceMsg, new GetCustomOnlineStatusRsp());
    }
    if ("QCUniBusinessLogic.uniSet".equals(paramToServiceMsg.getServiceCmd())) {
      return c(paramToServiceMsg, paramFromServiceMsg, new UniSetRsp());
    }
    if ("QCUniBusinessLogic.uniGet".equals(paramToServiceMsg.getServiceCmd())) {
      return c(paramToServiceMsg, paramFromServiceMsg, new UniGetRsp());
    }
    return null;
  }
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    do
    {
      ...
      if ("ClubInfoSvc.guanjiaReport".equals(paramToServiceMsg.getServiceCmd()))
      {
        ...
        localObject = paramToServiceMsg.extraData.getString(acny.KEY_UIN);
        ...
        localGuanjiaReportReq.sPhoneNum = paramToServiceMsg.extraData.getString(acny.bpY);
        localGuanjiaReportReq.bKingCard = paramToServiceMsg.extraData.getBoolean(acny.bpZ);
        localGuanjiaReportReq.iCardType = paramToServiceMsg.extraData.getInt(acny.bqa);
        localGuanjiaReportReq.iCardStatus = paramToServiceMsg.extraData.getInt(acny.bqb);
      ...
      ((GetCustomOnlineStatusReq)localObject).lUin = paramToServiceMsg.extraData.getLong(acny.bqh);
