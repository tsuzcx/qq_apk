...
public class amdl
{
  ...
  public static void a(Context paramContext, String paramString, int paramInt, RichMediaBrowserInfo paramRichMediaBrowserInfo)
  {
    ...
    localIntent.putExtra("extra.EXTRA_CURRENT_IMAGE", amdj.a((AIOBrowserBaseData)paramRichMediaBrowserInfo.baseData));
    localIntent.putExtra("leftViewText", paramContext.getString(2131721059));
    paramContext.startActivity(localIntent);
  }
  
  public static void b(Context paramContext, String paramString1, int paramInt1, boolean paramBoolean, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt2, String paramString6, String paramString7, Intent paramIntent)
  {
