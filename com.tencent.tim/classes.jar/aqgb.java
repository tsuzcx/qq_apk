...
public class aqgb
{
  ...
  {
    return aZ(bN(paramLong));
  }
  
  public static long X(long paramLong)
  {
    return ba(bM(paramLong));
  }
  ...
  public static String bM(long paramLong)
  {
  ...
  public static String bN(long paramLong)
  {
    long l = jpq.x(paramLong);
    if (l != 0L) {
      paramLong = l;
    }
  ...
  public static long ba(String paramString)
  {
