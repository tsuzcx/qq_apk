...
public class acdp
{
  ...
  private static void dI(Context paramContext)
  {
    int m = 0;
    ...
    if ((localObject1 != null) && (((BluetoothAdapter)localObject1).isEnabled())) {
      if (((BluetoothAdapter)localObject1).getScanMode() == 23)
      {
        ...
        localObject2 = alkz.a((WifiManager)localObject1);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          localHashMap.put("orgMaxMemory", String.valueOf(HackVm.amw / 1024L / 1024L));
          localHashMap.put("vm", localObject1);
          localHashMap.put("autoMode", String.valueOf(i2));
          anpc.a(paramContext).collectPerformance("", "actDeviceAbility", true, 0L, 0L, localHashMap, "");
          return;
          i = 0;
          break;
          label735:
  ...
  private static void dJ(Context paramContext)
  {
    int i2 = (int)(aqhq.bA() / 1024.0F / 1024.0F);
    ...
    if (aqhq.aCJ())
    {
      k = (int)(aqhq.bA() / 1024.0F / 1024.0F);
      j = (int)(aqhq.getAvailableInnernalMemorySize() / 1024.0F / 1024.0F);
      if (Build.VERSION.SDK_INT < 9) {
        break label377;
      }
      localObject = aqhq.s(paramContext);
      n = ((List)localObject).size();
      localObject = ((List)localObject).iterator();
      i = -1;
      while (((Iterator)localObject).hasNext())
      {
        if (!((aqhq.a)((Iterator)localObject).next()).cTZ) {
          break label374;
        }
        i += 1;
      }
    ...
    for (k = n;; k = n)
    {
      n = acix.getNumberOfCores();
      i1 = (int)(aqgz.getCpuMaxFreq() / 1024L);
      int i3 = (int)(aqgz.getSystemTotalMemory() / 1024L / 1024L);
      ...
      anpc.a(paramContext).collectPerformance("", "actStorageStats", true, 0L, 0L, (HashMap)localObject, "");
      return;
      label374:
      break;
      label377:
