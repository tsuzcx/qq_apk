...
class ajwc
  extends jnm.c
{
  ajwc(ajwa paramajwa, ajvz.c paramc, Comments.Comment paramComment) {}
      ...
      for (;;)
      {
        try
        {
          ...
          if (!localRspBody.busi_buf.has())
          {
            ...
            this.jdField_a_of_type_Ajvz$c.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment, -1, "");
            return;
          }
        ...
        try
        {
          ...
          this.jdField_a_of_type_Ajvz$c.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment, (int)localAddCommentNoFilterResp.result.get(), paramArrayOfByte);
          return;
        }
        catch (InvalidProtocolBufferMicroException paramBundle) {}
      }
      QLog.i("CommentsDataSource", 1, "merge publish resp data error");
      this.jdField_a_of_type_Ajvz$c.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment, -1, paramArrayOfByte);
      return;
      if (localAddCommentNoFilterResp.comment_id.get() > 0L)
      {
        this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment.id = localAddCommentNoFilterResp.comment_id.get();
        this.jdField_a_of_type_Ajvz$c.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment);
        ajwa.a(this.jdField_a_of_type_Ajwa).add(Long.valueOf(localAddCommentNoFilterResp.comment_id.get()));
        paramBundle = (AppInterface)this.n.get();
        if (paramBundle != null) {
          ((akio)paramBundle.getManager(263)).Nt(ajwa.a(this.jdField_a_of_type_Ajwa).id);
        }
      }
    }
    else
