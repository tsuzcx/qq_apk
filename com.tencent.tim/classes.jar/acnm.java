...
public class acnm
  extends accg
{
  public static long[] aa = { 1001L, 1002L, 1003L, 1005L, 2073745984L, 1006L };
  public static long[] ab = { 1004L };
  public static long[] ac = { 2073745984L, 1073745984L, 1001L, 1002L, 1003L, 1005L, 1006L };
  public static String bpQ = "hot_word_for_sub_business";
  public static String bpR = "hot_word_for_sub_business_req_time";
  public static String bpS = "hot_word_for_sub_business_exprire_time";
  private HashMap<Long, acnm.a> jg = new HashMap();
  
  public acnm(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<BusinessGroupWord> aQ(List<DynamicBusinessHotWord.GroupWord> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      BusinessGroupWord.b localb = new BusinessGroupWord.b(((DynamicBusinessHotWord.GroupID)((DynamicBusinessHotWord.GroupWord)localObject1).group_id.get()).rpt_group_mask.get());
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((Iterator)localObject).hasNext())
        {
          ...
          localAssociateItem.subTitle = localAssociationItem.subWord.get().toStringUtf8();
  ...
  private void ig(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    int i = paramFromServiceMsg.getResultCode();
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if (localRspBody.search_ver.has()) {
        amxk.a("dynamic_unite_search.1", (long[])localObject2, localRspBody.search_ver.get().toStringUtf8());
      }
    ...
    {
      ((List)localObject2).add(new amps((UniteSearch.TabItemGroup)paramObject.get(i)));
      i += 1;
    }
    i = localRspBody.trigger_netword_num.get();
    if (i >= 0) {
      aqmj.aL(BaseApplicationImpl.getContext(), i);
    }
    paramObject = localRspBody.item_groups.get();
    paramToServiceMsg = new amrp().a(new Object[] { str1, paramObject, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
  ...
  private void ih(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    int i = paramFromServiceMsg.getResultCode();
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((DynamicTabSearch.RspBody)localObject1).search_ver.has()) {
          amxk.a("dynamic_tab_search.1", arrayOfLong, ((DynamicTabSearch.RspBody)localObject1).search_ver.get().toStringUtf8());
        }
  ...
  private void ii(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (this.jg != null)
    {
      ...
      if (this.jg.containsKey(Long.valueOf(paramToServiceMsg.extraData.getLong("time_stamp"))))
      {
        localObject1 = (acnm.a)this.jg.get(Long.valueOf(paramToServiceMsg.extraData.getLong("time_stamp")));
        this.jg.remove(Long.valueOf(paramToServiceMsg.extraData.getLong("time_stamp")));
      }
    }
    ...
    try
    {
      ...
      ((acnm.a)localObject1).a(paramToServiceMsg.msg_search_keywords.rcmds, paramToServiceMsg.msg_search_keywords.sessionid);
      return;
    }
  ...
  private String js(String paramString)
  {
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    String str2 = tbc.getLocalIpAddress();
    paramQQAppInterface = new DynamicKdReport.ReqBody();
    paramQQAppInterface.sopername.set("Grp_all_search");
    paramQQAppInterface.suin.set(js(str1));
    paramQQAppInterface.sreseverver2.set(js("Kdfeedsback"));
    paramQQAppInterface.splatform.set("android");
    paramQQAppInterface.sversion.set(js("3.4.4"));
    paramQQAppInterface.smodule.set("all_result");
    paramQQAppInterface.sreseverobj1.set("2049");
    paramQQAppInterface.sclientIp.set(js(str2));
    paramQQAppInterface.ssessionId.set(paramString2);
    paramQQAppInterface.sreseverver3.set(js(paramString3));
    paramQQAppInterface.sreseverver4.set(js(paramString4));
    paramQQAppInterface.sreseverver5.set(js(paramString5));
    paramQQAppInterface.sreseverver6.set(js(paramString6));
    paramQQAppInterface.stimeStamp.set(js(String.valueOf(l)));
    paramQQAppInterface.saction.set(js(paramString1));
    paramString1 = createToServiceMsg("KDSearch.1");
    paramString1.putWupBuffer(paramQQAppInterface.toByteArray());
    sendPbReq(paramString1);
  }
  
  public void a(ByteStringMicro paramByteStringMicro, acnm.a parama)
  {
    long l = System.currentTimeMillis();
    this.jg.put(Long.valueOf(l), parama);
    parama = new RequestSearchWord.ReqBody();
    parama.bytes_rowkey.set(paramByteStringMicro);
    parama.uint32_oper_type.set(1);
    paramByteStringMicro = lup.makeOIDBPkg("OidbSvc.0xd78_0", 3448, 0, parama.toByteArray());
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        ...
        if (!paramBoolean1)
        {
          ...
          ((DynamicSearch.RootSearcherRequest)localObject).rpt_busi_mask.set(amxk.c(aa));
        ...
        i = 2;
        arrayOfString = aqmj.x(this.app.getCurrentAccountUin());
  ...
  {
    b(paramString1, paramString2, paramInt, paramList1, paramList2, paramArrayOfByte, 0, paramDouble1, paramDouble2, paramBundle);
  }
  
  public void b(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, byte[] paramArrayOfByte, int paramInt2, double paramDouble1, double paramDouble2, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      sendPbReq(paramList2);
      return;
      localIterator1 = amjm.mQ.values().iterator();
      paramInt1 = 2;
      i = paramInt1;
    } while (!localIterator1.hasNext());
    Iterator localIterator2 = ((List)localIterator1.next()).iterator();
    while (localIterator2.hasNext()) {
      if (paramString1.equals((BusinessGroupWord.c)localIterator2.next())) {
        paramInt1 = 1;
      }
    }
    for (;;)
    ...
    for (;;)
    {
      try
      {
        ...
        if (localRspBody.error_msg.get() != null)
        {
          ...
          aqmj.aN(this.app.getCurrentAccountUin(), i, localRspBody.expire_time.get());
          paramToServiceMsg = localRspBody.result_items.get();
          paramObject = amrb.a(this.app, paramToServiceMsg, i);
          if (localRspBody.bucket_id.get() == null) {
            break label278;
          }
          paramToServiceMsg = localRspBody.bucket_id.get().toStringUtf8();
          amub.cce = paramToServiceMsg;
  ...
  public void d(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    if (paramQQAppInterface == null) {
      return;
    }
    ...
    String str3 = cz.f(cz.s());
    paramQQAppInterface = new DynamicKdReport.ReqBody();
    paramQQAppInterface.suin.set(js(str2));
    paramQQAppInterface.sclientIp.set(js(str3));
    paramQQAppInterface.splatform.set("android");
    paramQQAppInterface.sversion.set(js("3.4.4"));
    paramQQAppInterface.ssessionId.set(js(str2 + str1));
    paramQQAppInterface.stimeStamp.set(js(str1));
    paramQQAppInterface.sopername.set("Grp_all_search");
    paramQQAppInterface.smodule.set("hot_list");
    paramQQAppInterface.saction.set(js(paramString1));
    paramQQAppInterface.sreseverver2.set(js(paramString3));
    paramQQAppInterface.sreseverver4.set(js(paramString2));
    paramQQAppInterface.sreseverobj2.set(js(paramString4));
    paramString1 = createToServiceMsg("KDSearch.1");
    paramString1.putWupBuffer(paramQQAppInterface.toByteArray());
    sendPbReq(paramString1);
  }
  
  public void m(String paramString, int paramInt, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      {
        ig(paramToServiceMsg, paramFromServiceMsg, paramObject);
        return;
      }
    ...
    ii(paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
  
  public void q(QQAppInterface paramQQAppInterface, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.i("Q.uniteSearch.UniteSearchHandler818searchProto_old", 2, "getUniteSearchDiscovery. fromType ：" + paramInt);
    }
    if (!aqmj.ap(paramQQAppInterface.getCurrentAccountUin(), paramInt))
    {
      if (QLog.isColorLevel()) {
