...
public class qgg
{
  ...
  {
    paramSerializable = new OpenPlayerBuilder(paramSerializable, paramInt).b();
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, @Nullable View paramView)
  {
    ...
    qem.a(localShareFromMemoryPlayInfo, new qgi(localShareFromMemoryPlayInfo, paramInt2, paramActivity, paramView));
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, int paramInt3, @Nullable View paramView)
  {
    ...
    qem.a(localShareFromMemoryPlayInfo, new qgj(localShareFromMemoryPlayInfo, paramInt2, paramActivity, paramView));
  }
  ...
  {
    paramString1 = new OpenPlayerBuilder(new MemorySelectVideoPlayInfo(paramString1, (String)paramArrayList2.get(paramInt1), paramString2, paramString3, paramArrayList1, paramBoolean, 0), paramInt3).d().e().a().b().a(false).b();
  ...
  {
    paramString1 = new OpenPlayerBuilder(new VidListPlayInfo(paramString2, paramString1), paramInt).b();
  ...
  public static void c(Context paramContext, String paramString1, String paramString2, int paramInt)
  {
    ...
    qem.a(qem.getQQAppInterface(), paramString1, new qgh(paramString2, paramString1, paramInt, paramContext));
  }
  
  public static void j(Activity paramActivity, String paramString, int paramInt)
  {
    a(paramActivity, new OpenPlayerBuilder(new SingleFeedPlayInfo(paramString, paramString, "", 1), paramInt).b(), null);
  }
  
  public static void r(Context paramContext, String paramString1, String paramString2)
  {
    paramString1 = new OpenPlayerBuilder(new SingleFeedPlayInfo(paramString1, paramString1, paramString2, 1, true), 31).b();
