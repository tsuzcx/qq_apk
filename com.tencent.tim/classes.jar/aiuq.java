...
public class aiuq
{
  ...
  {
    paramQQAppInterface = ((acff)paramQQAppInterface.getManager(51)).a(paramString);
  ...
  public static void b(QQAppInterface paramQQAppInterface, int paramInt, String paramString, boolean paramBoolean)
  {
    if (paramInt == 0)
    {
  ...
  public static void dd(QQAppInterface paramQQAppInterface)
  {
  ...
  public static boolean g(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    if (paramInt == 0) {
      return H(paramQQAppInterface, paramString);
    }
    if (paramInt == 1) {
      return I(paramQQAppInterface, paramString);
    }
    return false;
  }
}
