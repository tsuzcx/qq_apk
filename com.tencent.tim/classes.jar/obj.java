...
public class obj
{
        ...
        else if (((String)localObject3).equals("url"))
        {
          ...
          catch (Exception localException)
          {
            for (;;)
            {
              ...
              {
                QLog.d(obj.class.getSimpleName(), 2, localException.getMessage(), localException);
                l1 = l2;
              }
            }
          }
  ...
  public static com.tencent.mobileqq.data.PAMessage a(String paramString)
  {
    ...
    //   120: astore 5
    //   122: aload 5
    //   124: invokestatic 37	obj:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   127: astore 7
    //   129: aload 5
    ...
    //   248: aload 7
    //   250: invokestatic 365	obj:a	(Lorg/w3c/dom/Node;)Lcom/tencent/mobileqq/data/PAMessage$Item;
    //   253: astore 7
    //   255: aload_0
    ...
    //   322: astore 8
    //   324: aload 8
    //   326: invokestatic 37	obj:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   329: astore 7
    //   331: aload 8
  ...
  public static byte[] a(com.tencent.mobileqq.data.PAMessage paramPAMessage)
  {
    ...
    //   4: aconst_null
    //   5: areturn
    //   6: new 420	java/io/ByteArrayOutputStream
    //   9: dup
    //   10: invokespecial 421	java/io/ByteArrayOutputStream:<init>	()V
    //   13: astore_3
    //   14: new 423	java/io/ObjectOutputStream
    //   17: dup
    //   18: aload_3
    //   19: invokespecial 426	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   22: astore_2
    //   23: aload_2
    //   24: astore_1
    //   25: aload_2
    //   26: aload_0
    //   27: invokevirtual 430	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   30: aload_2
    //   31: astore_1
    //   32: aload_3
    //   33: invokevirtual 433	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   36: astore_0
    //   37: aload_2
    //   38: ifnull +7 -> 45
    //   41: aload_2
    //   42: invokevirtual 434	java/io/ObjectOutputStream:close	()V
    //   45: aload_3
    //   46: invokevirtual 435	java/io/ByteArrayOutputStream:close	()V
    //   49: aload_0
    //   50: areturn
    //   51: astore_1
    //   52: aload_1
    ...
    //   68: ifnull +7 -> 75
    //   71: aload_2
    //   72: invokevirtual 434	java/io/ObjectOutputStream:close	()V
    //   75: aload_3
    //   76: invokevirtual 435	java/io/ByteArrayOutputStream:close	()V
    //   79: aconst_null
    //   80: areturn
    //   81: astore_0
    //   82: aload_0
    ...
    //   98: ifnull +7 -> 105
    //   101: aload_2
    //   102: invokevirtual 434	java/io/ObjectOutputStream:close	()V
    //   105: aload_3
    //   106: invokevirtual 435	java/io/ByteArrayOutputStream:close	()V
    //   109: aconst_null
    //   110: areturn
    //   111: astore_0
    //   112: aload_0
    ...
    //   122: ifnull +7 -> 129
    //   125: aload_1
    //   126: invokevirtual 434	java/io/ObjectOutputStream:close	()V
    //   129: aload_3
    //   130: invokevirtual 435	java/io/ByteArrayOutputStream:close	()V
    //   133: aload_0
    //   134: athrow
    //   135: astore_1
    //   136: aload_1
