  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      notifyObserver(paramIntent, j, bool1, localBundle, ayac.class);
      return;
      ...
      if (((MqqLbsPack.RspGetPOIList)localObject).msg_head.has())
      {
        ...
        if (k != 0) {
          ayae.o("actLbsSendPoiListFailure", k);
        }
        for (;;)
        {
          if (QLog.isColorLevel()) {
          ...
          break;
          ayae.W("actLbsSendPoiListFailure");
        }
        ...
        if (((MqqLbsPack.RspOpenLBSRPReport)localObject).msg_head.has())
        {
          ...
          if (paramFromServiceMsg != null)
          {
            ...
            if (((MqqLbsPack.RspGetLBSPID)localObject).msg_head.has())
            {
              ...
              ayae.W("actLbsSendGetPidFailure");
            }
            for (;;)
            {
              localBundle.putInt("key_receive_result", k);
              ...
              break;
              ayae.o("actLbsSendGetPidFailure", k);
            }
            ...
            default: 
              break;
            case 1: 
              ayae.o("actLbsSendPoiListFailure", -10006);
              break;
            case 2: 
              break;
            case 3: 
              ayae.o("actLbsSendGetPidFailure", -10006);
              break;
            case 4: 
              if (QLog.isColorLevel())
              {
