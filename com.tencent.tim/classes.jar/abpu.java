...
public class abpu
  extends accg
{
  public abpu(AppInterface paramAppInterface)
  {
  ...
  public void a(int paramInt, String paramString, ArrayList<abpe> paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      {
        abpe localabpe = (abpe)paramArrayList.next();
        STCommon.STLocalCVerInfo localSTLocalCVerInfo = new STCommon.STLocalCVerInfo();
        localSTLocalCVerInfo.busId.set(localabpe.busId);
        localSTLocalCVerInfo.itemId.set(localabpe.itemId);
        localSTLocalCVerInfo.localVer.set(localabpe.cqB);
    ...
    paramArrayList = new NewIntent(this.mApp.getApp(), abpv.class);
  ...
  public void a(ReportInfoManager.ReportChannlInfo paramReportChannlInfo)
  {
    ...
    try
    {
      ...
      paramReportChannlInfo = new NewIntent(this.mApp.getApp(), abpv.class);
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong1, String paramString2, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    try
    {
      ...
      paramString2 = new NewIntent(this.mApp.getApp(), abpv.class);
      ...
      if (("apollo_game_av.get_usraccinfo".equals(paramString)) && (paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        try
        {
          ...
          if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
          {
            ...
            paramIntent = abmt.a(paramIntent.getIntExtra("gameId", -1));
            if (paramIntent != null)
            {
  ...
  public void a(String paramString1, String paramString2, long paramLong, int paramInt, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        paramArrayOfByte = new NewIntent(this.mApp.getApp(), abpv.class);
  ...
  public void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        ((abpm)localObject1).bK(paramFromServiceMsg.getResultCode(), paramIntent);
        return;
      }
    }
    ...
    {
      ((abpm)localObject1).bK(paramArrayOfByte.subCode.get(), paramIntent);
      return;
    }
    Object localObject2 = new abpl();
    if (paramArrayOfByte.updateFlag.get() == 1)
    {
      bool = true;
      ((abpl)localObject2).isUpdate = bool;
    ...
    {
      ((abpl)localObject2).isPatch = bool;
      ((abpl)localObject2).cqD = paramArrayOfByte.svrVer.get();
      ((abpl)localObject2).gameId = i;
      ((abpl)localObject2).bhl = paramArrayOfByte.url.get();
      ((abpl)localObject2).md5 = paramArrayOfByte.md5.get();
      ((abpl)localObject2).cM = paramArrayOfByte.patchContent.get().toByteArray();
      ((abpl)localObject2).patchUrl = paramArrayOfByte.patchUrl.get();
      ((abpl)localObject2).Ol = paramArrayOfByte.packageSize.get();
      ((abpl)localObject2).Ok = paramArrayOfByte.tipsSize.get();
      ((abpl)localObject2).itemId = paramArrayOfByte.itemId.get();
      ((abpl)localObject2).packName = paramIntent;
      ((abpl)localObject2).cqE = 1;
      ((abpm)localObject1).a((abpl)localObject2);
      return;
      bool = false;
      break;
    }
  ...
  public void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((localaboz == null) || (localaboz.a() == null))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (i < paramFromServiceMsg.length())
          {
            ...
            localObject1 = new ably(((JSONObject)localObject1).optString("icon"), (String)localObject2, paramArrayOfByte);
            localaboz.a().updateUserInfo((ably)localObject1);
            if (j == aboc.cqp) {
              localaboz.a().getOpenApiHead(l, paramArrayOfByte);
            } else if (j == aboc.cqq) {
              localaboz.a().getOpenApiNick(l, paramArrayOfByte);
            }
          }
        }
      }
      ...
      for (;;)
      {
        try
        {
          ...
          localaboz.a().nativeOpenApiGetHeadCallBack(l, paramFromServiceMsg.getString(0), -1, 0, 0, null);
        ...
        localaboz.a().callbackFromRequest(l, 0, "cs.preload_userInfoList.local", paramFromServiceMsg.toString());
        return;
        if (j == aboc.cqp)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localaboz.a().nativeOpenApiGetHeadCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), 0, 0, null);
        ...
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localaboz.a().nativeOpenApiGetNickCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), null);
        ...
        localaboz.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), "cs.preload_userInfoList.local", paramIntent.toString());
        ...
        {
          paramFromServiceMsg = new JSONObject(str).optJSONArray("uidList");
          localaboz.a().nativeOpenApiGetNickCallBack(l, paramFromServiceMsg.getString(0), -1, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_NICK error openid=" + paramFromServiceMsg.getString(0));
        }
        else if (j == aboc.cqr)
        {
          localaboz.a().callbackFromRequest(l, -1, "cs.preload_userInfoList.local", "{}");
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_PRELOAD error ");
        }
      }
      label859:
  ...
  public void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              if (i == 4)
              {
                localaboz.a().callbackFromRequest(l, (int)localUniSsoServerRsp.ret.get(), str3, paramArrayOfByte);
                return;
              }
            }
            catch (Throwable paramArrayOfByte)
            {
              ...
              try
              {
                ...
                if (i == 4)
                {
                  localaboz.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), paramIntent, "{}");
                  return;
                }
              }
        ...
        paramArrayOfByte = abmt.a(localJSONObject1.optInt("gameId"));
    ...
    localaboz.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), str3, "{}");
  }
  
  public void e(String paramString1, String paramString2, long paramLong, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("cmgame_process.CmGameSSoHandler", 2, "[doCmGameRequest], cmd:" + paramString1 + ",luaR:" + paramLong + ", app: " + this.mApp);
    }
    try
    {
      ...
      localUniSsoServerReq.comm.set((MessageMicro)localObject);
      localUniSsoServerReq.reqdata.set(paramString2);
      localObject = new NewIntent(this.mApp.getApp(), abpv.class);
  ...
  public void z(String paramString, int paramInt, long paramLong)
  {
    if (QLog.isColorLevel()) {
