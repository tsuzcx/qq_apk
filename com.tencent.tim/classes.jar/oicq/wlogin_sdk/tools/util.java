...
public class util
{
  ...
  public static final long BUILD_TIME = 1630062176L;
  ...
  public static String LOG_TAG_EVENT_REPORT;
  public static String LOG_TAG_GATEWAY_LOGIN_NEW_DOV;
  public static String LOG_TAG_POW;
  public static String LOG_TAG_PRIVACY;
  public static String LOG_TAG_QIMEI;
  ...
  public static void LOGW(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      if (LOG_LEVEL >= 0)
      {
        ...
        for (;;)
        {
          b.a(u.u, paramString3, paramString1 + ":" + paramString2);
          return;
          if (LOGCAT_OUT) {
            Log.w("wlogin_sdk" + getLineInfo(2), paramString1 + ":" + paramString2);
          }
  ...
  public static Key RSAPrivKeyFromJNI(byte[] paramArrayOfByte)
  {
    ...
    tmp90_83[13] = 72;
    byte[] tmp97_90 = tmp90_83;
    tmp97_90[14] = -122;
    byte[] tmp104_97 = tmp97_90;
    tmp104_97[15] = -9;
    byte[] tmp111_104 = tmp104_97;
    tmp111_104[16] = 13;
    byte[] tmp117_111 = tmp111_104;
    tmp117_111[17] = 1;
    ...
    tmp153_147[23] = -126;
    byte[] tmp160_153 = tmp153_147;
    tmp160_153[24] = 2;
    byte[] tmp166_160 = tmp160_153;
    tmp166_160[25] = 95;
    tmp166_160;
  ...
  public static byte[] generateGuid(Context paramContext)
  {
    ...
    {
      str2 = privacyListener.getMac(paramContext);
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(str1)) {
        str2 = getRandomAndroidId(paramContext);
      }
      LOGI("android_id " + str2, "");
      LOGI("mac " + str3, "");
      return MD5.toMD5Byte((str2 + str3).getBytes());
      str2 = null;
    }
  }
  ...
  public static String getBootId()
  {
    ...
    //   0: aconst_null
    //   1: astore_1
    //   2: new 833	java/io/FileReader
    //   5: dup
    //   6: ldc_w 835
    //   9: invokespecial 836	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   12: astore_0
    //   13: aload_0
    //   14: astore_1
    //   15: new 838	java/io/BufferedReader
    //   18: dup
    //   19: aload_0
    //   20: invokespecial 841	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   23: invokevirtual 844	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   26: astore_2
    //   27: aload_2
    //   28: ifnull +20 -> 48
    //   31: aload_0
    //   32: ifnull +7 -> 39
    //   35: aload_0
    //   36: invokevirtual 845	java/io/FileReader:close	()V
    //   39: aload_2
    //   40: areturn
    //   41: astore_0
    //   42: aload_0
    //   43: invokevirtual 848	java/io/IOException:printStackTrace	()V
    //   46: aload_2
    //   47: areturn
    //   48: aload_0
    //   49: ifnull +7 -> 56
    //   52: aload_0
    //   53: invokevirtual 845	java/io/FileReader:close	()V
    //   56: ldc 253
    //   58: areturn
    //   59: astore_0
    //   60: aload_0
    //   61: invokevirtual 848	java/io/IOException:printStackTrace	()V
    //   64: goto -8 -> 56
    //   67: astore_0
    //   68: aload_1
    //   69: astore_0
    //   70: ldc_w 850
    //   73: ldc 253
    //   75: invokestatic 852	oicq/wlogin_sdk/tools/util:LOGD	(Ljava/lang/String;Ljava/lang/String;)V
    //   78: aload_0
    //   79: ifnull -23 -> 56
    //   82: aload_0
    //   83: invokevirtual 845	java/io/FileReader:close	()V
    //   86: goto -30 -> 56
    //   89: astore_0
    //   90: aload_0
    //   91: invokevirtual 848	java/io/IOException:printStackTrace	()V
    //   94: goto -38 -> 56
    //   97: astore_0
    //   98: aconst_null
    //   99: astore_0
    ...
    //   102: ldc_w 854
    //   105: ldc 253
    //   107: invokestatic 852	oicq/wlogin_sdk/tools/util:LOGD	(Ljava/lang/String;Ljava/lang/String;)V
    //   110: aload_0
    //   111: ifnull -55 -> 56
    //   114: aload_0
    //   115: invokevirtual 845	java/io/FileReader:close	()V
    //   118: goto -62 -> 56
    //   121: astore_0
    //   122: aload_0
    //   123: invokevirtual 848	java/io/IOException:printStackTrace	()V
    //   126: goto -70 -> 56
    //   129: astore_0
    //   130: aconst_null
    //   131: astore_1
    ...
    //   133: ifnull +7 -> 140
    //   136: aload_1
    //   137: invokevirtual 845	java/io/FileReader:close	()V
    //   140: aload_0
    //   141: athrow
    //   142: astore_1
    //   143: aload_1
    //   144: invokevirtual 848	java/io/IOException:printStackTrace	()V
    //   147: goto -7 -> 140
    //   150: astore_0
    //   151: goto -19 -> 132
    //   154: astore_2
  ...
  public static byte[] getGuidFromFile(Context paramContext)
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: getstatic 729	oicq/wlogin_sdk/request/u:al	[B
    //   5: ifnull +24 -> 29
    //   8: getstatic 729	oicq/wlogin_sdk/request/u:al	[B
    //   11: arraylength
    //   12: ifeq +17 -> 29
    //   15: ldc_w 962
    //   18: ldc 253
    //   20: invokestatic 447	oicq/wlogin_sdk/tools/util:LOGI	(Ljava/lang/String;Ljava/lang/String;)V
    //   23: getstatic 729	oicq/wlogin_sdk/request/u:al	[B
    //   26: astore_3
    //   27: aload_3
    //   28: areturn
    //   29: ldc_w 964
    //   32: ldc 253
    //   34: invokestatic 447	oicq/wlogin_sdk/tools/util:LOGI	(Ljava/lang/String;Ljava/lang/String;)V
    //   37: aload_0
    //   38: ifnull -11 -> 27
    //   41: iconst_0
    //   42: newarray byte
    //   44: astore_3
    //   45: new 668	java/io/File
    //   48: dup
    //   49: new 398	java/lang/StringBuilder
    //   52: dup
    //   53: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   56: aload_0
    //   57: invokevirtual 717	android/content/Context:getFilesDir	()Ljava/io/File;
    //   60: invokevirtual 709	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   63: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   66: ldc_w 966
    //   69: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   72: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   75: invokespecial 670	java/io/File:<init>	(Ljava/lang/String;)V
    //   78: astore_2
    //   79: aload_2
    //   80: ifnull +230 -> 310
    //   83: aload_2
    //   84: invokevirtual 952	java/io/File:exists	()Z
    //   87: ifeq +223 -> 310
    //   90: new 880	java/io/FileInputStream
    //   93: dup
    //   94: aload_2
    //   95: invokespecial 969	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   98: astore 5
    //   100: aload 5
    //   102: astore 4
    //   104: aload_3
    //   105: astore_2
    //   106: aload 5
    //   108: invokevirtual 884	java/io/FileInputStream:available	()I
    //   111: istore_1
    //   112: aload 5
    //   114: astore 4
    //   116: aload_3
    ...
    //   141: aload 5
    //   143: aload_3
    //   144: invokevirtual 891	java/io/FileInputStream:read	([B)I
    //   147: pop
    //   148: aload_3
    //   149: astore_2
    //   150: aload 5
    ...
    //   158: ifnull +147 -> 305
    //   161: aload 4
    //   163: invokevirtual 892	java/io/FileInputStream:close	()V
    //   166: aload_2
    //   167: ifnull +10 -> 177
    //   170: aload_2
    //   171: astore_3
    ...
    //   174: ifgt -147 -> 27
    //   177: aload_0
    //   178: invokestatic 972	oicq/wlogin_sdk/tools/util:get_saved_android_id	(Landroid/content/Context;)[B
    //   181: astore_2
    //   182: aload_2
    //   183: astore_3
    //   184: aload_2
    ...
    //   195: aload_0
    //   196: aload_2
    //   197: invokestatic 976	oicq/wlogin_sdk/tools/util:saveGuidToFile	(Landroid/content/Context;[B)V
    //   200: aload_2
    //   201: areturn
    //   202: astore_3
    //   203: aload_3
    //   204: ldc 253
    //   206: invokestatic 508	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;Ljava/lang/String;)V
    //   209: goto -43 -> 166
    //   212: astore 4
    //   214: aconst_null
    //   215: astore 5
    ...
    //   222: aload 5
    //   224: astore 4
    //   226: getstatic 979	oicq/wlogin_sdk/request/u:aa	I
    //   229: ldc_w 980
    //   232: ior
    //   233: putstatic 979	oicq/wlogin_sdk/request/u:aa	I
    //   236: aload 5
    //   238: astore 4
    //   240: aload_3
    //   241: ldc 253
    //   243: invokestatic 508	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;Ljava/lang/String;)V
    //   246: aload_2
    //   247: astore_3
    //   248: aload 5
    //   250: ifnull +55 -> 305
    //   253: aload 5
    //   255: invokevirtual 892	java/io/FileInputStream:close	()V
    //   258: goto -92 -> 166
    //   261: astore_3
    //   262: aload_3
    //   263: ldc 253
    //   265: invokestatic 508	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;Ljava/lang/String;)V
    //   268: goto -102 -> 166
    //   271: astore_0
    //   272: aconst_null
    //   273: astore 4
    ...
    //   277: ifnull +8 -> 285
    //   280: aload 4
    //   282: invokevirtual 892	java/io/FileInputStream:close	()V
    //   285: aload_0
    //   286: athrow
    //   287: astore_2
    //   288: aload_2
    //   289: ldc 253
    //   291: invokestatic 508	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;Ljava/lang/String;)V
    //   294: goto -9 -> 285
    //   297: astore_0
    //   298: goto -23 -> 275
    //   301: astore_3
  ...
  public static byte[] getIccid(Context paramContext)
  {
    try
    {
      ...
      if (paramContext != null)
      {
        paramContext = alla.d(paramContext);
        if (paramContext != null)
        {
          paramContext = paramContext.getBytes();
          return paramContext;
  ...
  {
    // Byte code:
    //   0: new 833	java/io/FileReader
    //   3: dup
    //   4: ldc_w 1108
    //   7: invokespecial 836	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   10: astore_1
    //   11: aload_1
    //   12: astore_0
    //   13: new 838	java/io/BufferedReader
    //   16: dup
    //   17: aload_1
    //   18: invokespecial 841	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   21: invokevirtual 844	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   24: astore_2
    //   25: aload_2
    //   26: ifnull +20 -> 46
    //   29: aload_1
    //   30: ifnull +7 -> 37
    //   33: aload_1
    //   34: invokevirtual 845	java/io/FileReader:close	()V
    //   37: aload_2
    //   38: areturn
    //   39: astore_0
    //   40: aload_0
    //   41: invokevirtual 848	java/io/IOException:printStackTrace	()V
    //   44: aload_2
    //   45: areturn
    //   46: aload_1
    //   47: ifnull +7 -> 54
    //   50: aload_1
    //   51: invokevirtual 845	java/io/FileReader:close	()V
    //   54: ldc 253
    //   56: areturn
    //   57: astore_0
    //   58: aload_0
    //   59: invokevirtual 848	java/io/IOException:printStackTrace	()V
    //   62: goto -8 -> 54
    //   65: astore_2
    //   66: aconst_null
    //   67: astore_1
    //   68: aload_1
    //   69: astore_0
    //   70: new 398	java/lang/StringBuilder
    //   73: dup
    //   74: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   77: ldc_w 1110
    //   80: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   83: aload_2
    //   84: invokevirtual 464	java/lang/Exception:toString	()Ljava/lang/String;
    //   87: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   90: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   93: ldc 253
    //   95: invokestatic 852	oicq/wlogin_sdk/tools/util:LOGD	(Ljava/lang/String;Ljava/lang/String;)V
    //   98: aload_1
    //   99: ifnull -45 -> 54
    //   102: aload_1
    //   103: invokevirtual 845	java/io/FileReader:close	()V
    //   106: goto -52 -> 54
    //   109: astore_0
    //   110: aload_0
    //   111: invokevirtual 848	java/io/IOException:printStackTrace	()V
    //   114: goto -60 -> 54
    //   117: astore_1
    //   118: aconst_null
    //   119: astore_0
    ...
    //   121: ifnull +7 -> 128
    //   124: aload_0
    //   125: invokevirtual 845	java/io/FileReader:close	()V
    //   128: aload_1
    //   129: athrow
    //   130: astore_0
    //   131: aload_0
    //   132: invokevirtual 848	java/io/IOException:printStackTrace	()V
    //   135: goto -7 -> 128
    //   138: astore_1
    //   139: goto -19 -> 120
    //   142: astore_2
  ...
  public static byte[] get_IMSI(Context paramContext)
  {
    if (privacyListener != null)
    {
      paramContext = privacyListener.getImsi(paramContext);
  ...
  public static byte[] get_android_id(Context paramContext)
  {
    if (privacyListener != null)
    {
      String str = privacyListener.getAndroidID(paramContext);
  ...
  public static byte[] get_bssid_addr(Context paramContext)
  {
    if (privacyListener != null)
    {
      paramContext = privacyListener.getBssid(paramContext);
      if (!TextUtils.isEmpty(paramContext)) {
  ...
  public static byte[] get_cp_pubkey(Context paramContext, long paramLong1, long paramLong2)
  {
    ...
    //   14: areturn
    //   15: aload_0
    //   16: invokevirtual 1299	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   19: astore_0
    //   20: new 398	java/lang/StringBuilder
    //   23: dup
    //   24: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   27: ldc_w 1301
    //   30: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   33: ldc_w 1303
    //   36: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   39: ldc_w 1305
    //   42: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   45: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   48: invokestatic 1311	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   51: astore 6
    //   53: new 398	java/lang/StringBuilder
    //   56: dup
    //   57: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   60: ldc 253
    //   62: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   65: lload_1
    //   66: invokevirtual 948	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   69: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   72: astore 7
    //   74: new 398	java/lang/StringBuilder
    //   77: dup
    //   78: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   81: ldc 253
    //   83: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   86: lload_3
    //   87: invokevirtual 948	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   90: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   93: astore 8
    //   95: aload_0
    //   96: aload 6
    //   98: iconst_5
    //   99: anewarray 383	java/lang/String
    //   102: dup
    //   103: iconst_0
    //   104: ldc_w 1313
    //   107: aastore
    ...
    //   132: ldc_w 1323
    //   135: iconst_2
    //   136: anewarray 383	java/lang/String
    //   139: dup
    //   140: iconst_0
    //   141: aload 7
    //   143: aastore
    ...
    //   148: aastore
    //   149: aconst_null
    //   150: invokestatic 1329	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   153: astore_0
    //   154: aload_0
    //   155: ifnull +98 -> 253
    //   158: aload_0
    ...
    //   174: aload_0
    //   175: ldc_w 1319
    //   178: invokeinterface 1337 2 0
    //   183: invokeinterface 1339 2 0
    //   188: astore 6
    //   190: aload_0
    //   191: astore 5
    //   193: aload_0
    //   194: aload_0
    //   195: ldc_w 1321
    //   198: invokeinterface 1337 2 0
    //   203: invokeinterface 1339 2 0
    //   208: astore 7
    //   210: aload_0
    //   211: astore 5
    //   213: aload 6
    //   215: invokestatic 1342	oicq/wlogin_sdk/tools/MD5:toMD5	(Ljava/lang/String;)Ljava/lang/String;
    //   218: aload 7
    //   220: invokevirtual 387	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   223: ifeq +30 -> 253
    //   226: aload_0
    //   227: astore 5
    //   229: aload 6
    //   231: invokestatic 1346	oicq/wlogin_sdk/tools/util:string_to_buf	(Ljava/lang/String;)[B
    //   234: astore 6
    //   236: aload 6
    //   238: astore 5
    //   240: aload_0
    //   241: ifnull -229 -> 12
    //   244: aload_0
    //   245: invokeinterface 1347 1 0
    //   250: aload 6
    //   252: areturn
    //   253: aload_0
    //   254: ifnull +9 -> 263
    //   257: aload_0
    //   258: invokeinterface 1347 1 0
    //   263: ldc_w 1349
    //   266: invokestatic 1346	oicq/wlogin_sdk/tools/util:string_to_buf	(Ljava/lang/String;)[B
    //   269: areturn
    //   270: astore 6
    //   272: aconst_null
    //   273: astore_0
    ...
    //   277: aload 6
    //   279: ldc 253
    //   281: invokestatic 508	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;Ljava/lang/String;)V
    //   284: aload_0
    //   285: ifnull -22 -> 263
    //   288: aload_0
    //   289: invokeinterface 1347 1 0
    //   294: goto -31 -> 263
    //   297: astore_0
    //   298: aload 5
    //   300: ifnull +10 -> 310
    //   303: aload 5
    //   305: invokeinterface 1347 1 0
    //   310: aload_0
    //   311: athrow
    //   312: astore_0
    //   313: goto -15 -> 298
  ...
  public static String get_device_model()
  {
    if (privacyListener != null)
    {
      String str = privacyListener.getDeviceModel();
      if (!TextUtils.isEmpty(str)) {
        return str;
      }
    }
  ...
  public static byte[] get_mac_addr(Context paramContext)
  {
    if (privacyListener != null)
    {
      paramContext = privacyListener.getMac(paramContext);
      if (!TextUtils.isEmpty(paramContext)) {
        return paramContext.getBytes();
      }
    }
  ...
  public static boolean get_pow_test(Context paramContext)
  {
    ...
    try
    {
      ...
      LOGI(LOG_TAG_POW + "get_pow_test " + bool1, "");
      return bool1;
    }
    catch (Throwable paramContext)
    {
      for (;;)
      {
        LOGI(LOG_TAG_POW + "get_pow_test " + Log.getStackTraceString(paramContext), "");
        bool1 = bool2;
      }
    }
  }
  ...
  public static byte[] get_qimei(Context paramContext)
  {
    ...
    {
      LOGI(LOG_TAG_QIMEI + "get listener = null", "");
      return new byte[0];
    }
    paramContext = qimeiListener.getQimei(paramContext);
    if (TextUtils.isEmpty(paramContext))
    {
      LOGI(LOG_TAG_QIMEI + "get isEmpty", "");
      return new byte[0];
    }
    LOGI(LOG_TAG_QIMEI + "get length = " + paramContext.length(), "");
    return paramContext.getBytes();
  }
  ...
  public static byte[] get_ssid_addr(Context paramContext)
  {
    if (privacyListener != null)
    {
      paramContext = privacyListener.getSsid(paramContext);
      if (!TextUtils.isEmpty(paramContext)) {
        return paramContext.getBytes();
      }
    }
  ...
  public static boolean isWtLoginUrlV1(String paramString)
  {
    ...
    } while (base64_decode_url(paramString.getBytes(), paramString.length()) == null);
    return true;
  }
  ...
  {
    // Byte code:
    //   0: getstatic 261	oicq/wlogin_sdk/tools/util:loadEncryptSo	Z
    //   3: ifne +5 -> 8
    //   6: iconst_0
    //   7: ireturn
    //   8: getstatic 266	android/os/Build$VERSION:SDK_INT	I
    //   11: bipush 23
    //   13: if_icmplt +5 -> 18
    //   16: iconst_0
    //   17: ireturn
    //   18: getstatic 259	oicq/wlogin_sdk/tools/util:libwtecdh_loaded	Z
    //   21: ifeq +5 -> 26
    //   24: iconst_1
    //   25: ireturn
    //   26: aload_1
    ...
    //   31: ifnull +10 -> 41
    //   34: aload_0
    //   35: invokevirtual 664	java/lang/String:length	()I
    //   38: ifne +5 -> 43
    //   41: iconst_0
    //   42: ireturn
    //   43: new 668	java/io/File
    //   46: dup
    //   47: new 398	java/lang/StringBuilder
    //   50: dup
    //   51: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   54: aload_1
    //   55: invokevirtual 717	android/content/Context:getFilesDir	()Ljava/io/File;
    //   58: invokevirtual 1595	java/io/File:getParent	()Ljava/lang/String;
    //   61: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   64: ldc_w 1597
    //   67: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   70: aload_0
    //   71: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   74: ldc_w 1599
    //   77: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   80: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   83: invokespecial 670	java/io/File:<init>	(Ljava/lang/String;)V
    //   86: astore 5
    //   88: aload 5
    //   90: astore 4
    //   92: aload 5
    //   94: invokevirtual 952	java/io/File:exists	()Z
    //   97: ifne +150 -> 247
    //   100: new 668	java/io/File
    //   103: dup
    //   104: new 398	java/lang/StringBuilder
    //   107: dup
    //   108: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   111: aload_1
    //   112: invokevirtual 717	android/content/Context:getFilesDir	()Ljava/io/File;
    //   115: invokevirtual 1595	java/io/File:getParent	()Ljava/lang/String;
    //   118: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   121: ldc_w 1601
    //   124: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   127: aload_0
    //   128: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   131: ldc_w 1599
    //   134: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   137: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   140: invokespecial 670	java/io/File:<init>	(Ljava/lang/String;)V
    //   143: astore 4
    //   145: aload 4
    //   147: ifnull +134 -> 281
    //   150: aload 4
    //   152: invokevirtual 952	java/io/File:exists	()Z
    //   155: ifeq +126 -> 281
    //   158: aload 4
    //   160: invokevirtual 709	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   163: invokestatic 1604	java/lang/System:load	(Ljava/lang/String;)V
    //   166: iconst_1
    //   167: istore_3
    //   168: iload_3
    //   169: istore_2
    ...
    //   171: ifne +9 -> 180
    //   174: aload_0
    //   175: invokestatic 1606	java/lang/System:loadLibrary	(Ljava/lang/String;)V
    //   178: iconst_1
    //   179: istore_2
    //   180: iload_2
    //   181: istore_3
    ...
    //   186: aload_1
    //   187: aload_0
    //   188: invokestatic 1611	com/tencent/commonsdk/soload/SoLoadUtilNew:loadSoByName	(Landroid/content/Context;Ljava/lang/String;)Z
    //   191: istore_3
    //   192: iload_3
    //   193: ifeq +129 -> 322
    //   196: ldc_w 1613
    //   199: ldc 253
    //   201: invokestatic 447	oicq/wlogin_sdk/tools/util:LOGI	(Ljava/lang/String;Ljava/lang/String;)V
    //   204: iload_3
    //   205: putstatic 259	oicq/wlogin_sdk/tools/util:libwtecdh_loaded	Z
    //   208: new 398	java/lang/StringBuilder
    //   211: dup
    //   212: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   215: ldc_w 1615
    //   218: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   221: getstatic 259	oicq/wlogin_sdk/tools/util:libwtecdh_loaded	Z
    //   224: invokevirtual 1429	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   227: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   230: ldc 253
    //   232: invokestatic 447	oicq/wlogin_sdk/tools/util:LOGI	(Ljava/lang/String;Ljava/lang/String;)V
    //   235: iload_3
    //   236: ireturn
    //   237: astore 6
    //   239: aconst_null
    //   240: astore 4
    //   242: aload 6
    //   244: invokestatic 1571	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;)V
    //   247: goto -102 -> 145
    //   250: astore 4
    //   252: new 398	java/lang/StringBuilder
    //   255: dup
    //   256: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   259: ldc_w 1617
    //   262: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   265: aload 4
    //   267: invokevirtual 1620	java/lang/UnsatisfiedLinkError:getMessage	()Ljava/lang/String;
    //   270: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   273: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   276: ldc 253
    //   278: invokestatic 447	oicq/wlogin_sdk/tools/util:LOGI	(Ljava/lang/String;Ljava/lang/String;)V
    //   281: iconst_0
    //   282: istore_3
    //   283: goto -115 -> 168
    //   286: astore 4
    //   288: new 398	java/lang/StringBuilder
    //   291: dup
    //   292: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   295: ldc_w 1617
    //   298: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   301: aload 4
    //   303: invokevirtual 1620	java/lang/UnsatisfiedLinkError:getMessage	()Ljava/lang/String;
    //   306: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   309: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   312: ldc 253
    //   314: invokestatic 447	oicq/wlogin_sdk/tools/util:LOGI	(Ljava/lang/String;Ljava/lang/String;)V
    //   317: iload_3
    //   318: istore_2
    //   319: goto -139 -> 180
    //   322: ldc_w 1622
    //   325: ldc 253
    //   327: invokestatic 447	oicq/wlogin_sdk/tools/util:LOGI	(Ljava/lang/String;Ljava/lang/String;)V
    //   330: goto -126 -> 204
    //   333: astore 6
    //   335: aload 5
    //   337: astore 4
  ...
  public static boolean needChangeGuid(Context paramContext)
  {
    ...
    long l1 = u.f();
    LOGI("needChangeGuid delay:" + l2 + " now:" + l1, "");
    if (l2 == 0L)
    {
      l2 = new Random().nextInt(GUID_DELAY_HOUR) * 60 * 60 * 1000;
      paramContext.edit().putLong("change_guid_time", l2 + l1).commit();
    }
    while (l2 < l1) {
      return false;
    }
  ...
  public static void saveGuidToFile(Context paramContext, byte[] paramArrayOfByte)
  {
    ...
    //   9: arraylength
    //   10: ifle +187 -> 197
    //   13: new 398	java/lang/StringBuilder
    //   16: dup
    //   17: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   20: ldc_w 1693
    //   23: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   26: aload_1
    //   27: invokestatic 1695	oicq/wlogin_sdk/tools/util:buf_to_string	([B)Ljava/lang/String;
    //   30: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   33: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   36: ldc 253
    //   38: invokestatic 447	oicq/wlogin_sdk/tools/util:LOGI	(Ljava/lang/String;Ljava/lang/String;)V
    //   41: aconst_null
    //   42: astore 6
    //   44: aconst_null
    //   45: astore 7
    ...
    //   54: aload 7
    //   56: astore_2
    //   57: new 668	java/io/File
    //   60: dup
    //   61: new 398	java/lang/StringBuilder
    //   64: dup
    //   65: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   68: aload_0
    //   69: invokevirtual 717	android/content/Context:getFilesDir	()Ljava/io/File;
    //   72: invokevirtual 709	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   75: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   78: ldc_w 966
    //   81: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   84: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   87: invokespecial 670	java/io/File:<init>	(Ljava/lang/String;)V
    //   90: astore 8
    //   92: aload 6
    //   94: astore 4
    //   96: aload 7
    //   98: astore_2
    //   99: aload 8
    //   101: invokevirtual 952	java/io/File:exists	()Z
    //   104: ifne +16 -> 120
    //   107: aload 6
    //   109: astore 4
    //   111: aload 7
    //   113: astore_2
    //   114: aload 8
    //   116: invokevirtual 1698	java/io/File:createNewFile	()Z
    //   119: pop
    //   120: aload 5
    //   122: astore_3
    //   123: aload 6
    ...
    //   129: astore_2
    //   130: aload 8
    //   132: invokevirtual 952	java/io/File:exists	()Z
    //   135: ifeq +44 -> 179
    //   138: aload 5
    //   140: astore_3
    //   141: aload 6
    ...
    //   147: astore_2
    //   148: aload 8
    //   150: invokevirtual 1701	java/io/File:canWrite	()Z
    //   153: ifeq +26 -> 179
    //   156: aload 6
    //   158: astore 4
    //   160: aload 7
    //   162: astore_2
    //   163: new 1703	java/io/FileOutputStream
    //   166: dup
    //   167: aload 8
    //   169: iconst_0
    //   170: invokespecial 1706	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   173: astore_3
    //   174: aload_3
    //   175: aload_1
    //   176: invokevirtual 1707	java/io/FileOutputStream:write	([B)V
    //   179: aload_3
    //   180: astore 4
    //   182: aload_3
    //   183: astore_2
    //   184: aload_0
    //   185: aload_1
    //   186: invokestatic 1710	oicq/wlogin_sdk/tools/util:save_android_id	(Landroid/content/Context;[B)V
    //   189: aload_3
    //   190: ifnull +7 -> 197
    //   193: aload_3
    //   194: invokevirtual 1711	java/io/FileOutputStream:close	()V
    //   197: return
    //   198: astore_0
    //   199: aload_0
    //   200: ldc 253
    //   202: invokestatic 508	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;Ljava/lang/String;)V
    //   205: return
    //   206: astore_0
    //   207: aload 4
    //   209: astore_2
    //   210: aload_0
    //   211: ldc 253
    //   213: invokestatic 508	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;Ljava/lang/String;)V
    //   216: aload 4
    //   218: ifnull -21 -> 197
    //   221: aload 4
    //   223: invokevirtual 1711	java/io/FileOutputStream:close	()V
    //   226: return
    //   227: astore_0
    //   228: aload_0
    //   229: ldc 253
    //   231: invokestatic 508	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;Ljava/lang/String;)V
    //   234: return
    //   235: astore_0
    //   236: aload_2
    //   237: ifnull +7 -> 244
    //   240: aload_2
    //   241: invokevirtual 1711	java/io/FileOutputStream:close	()V
    //   244: aload_0
    //   245: athrow
    //   246: astore_1
    //   247: aload_1
    //   248: ldc 253
    //   250: invokestatic 508	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;Ljava/lang/String;)V
    //   253: goto -9 -> 244
    //   256: astore_0
    //   257: aload_3
    //   258: astore_2
  ...
  public static void saveInitKeyTime(Context paramContext, int paramInt)
  {
    ...
    try
    {
      ...
      paramContext.commit();
      LOGI("saveInitKeyTime time:" + paramInt, "");
      return;
    }
    catch (Throwable paramContext)
    {
  ...
  public static boolean set_cp_pubkey(Context paramContext, long paramLong1, long paramLong2)
  {
    ...
    //   5: ireturn
    //   6: aload_0
    //   7: invokevirtual 1299	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   10: astore 7
    //   12: new 398	java/lang/StringBuilder
    //   15: dup
    //   16: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   19: ldc_w 1301
    //   22: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   25: ldc_w 1303
    //   28: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   31: ldc_w 1305
    //   34: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   37: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   40: invokestatic 1311	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   43: astore 8
    //   45: aload 8
    //   47: invokevirtual 1740	android/net/Uri:toString	()Ljava/lang/String;
    //   50: invokestatic 639	oicq/wlogin_sdk/tools/util:LOGI	(Ljava/lang/String;)V
    //   53: new 398	java/lang/StringBuilder
    //   56: dup
    //   57: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   60: ldc 253
    ...
    //   97: aload 8
    //   99: iconst_5
    //   100: anewarray 383	java/lang/String
    //   103: dup
    //   104: iconst_0
    //   105: ldc_w 1313
    //   108: aastore
    ...
    //   133: ldc_w 1323
    //   136: iconst_2
    //   137: anewarray 383	java/lang/String
    //   140: dup
    //   141: iconst_0
    //   142: aload 6
    //   144: aastore
    ...
    //   149: aastore
    //   150: aconst_null
    //   151: invokestatic 1329	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   154: astore 6
    //   156: aload 6
    ...
    //   163: ifnull +10 -> 173
    //   166: aload 6
    //   168: invokeinterface 1347 1 0
    //   173: iconst_0
    //   174: ireturn
    //   175: aload_0
    //   176: invokestatic 1742	oicq/wlogin_sdk/tools/util:get_rsa_pubkey	(Landroid/content/Context;)[B
    //   179: invokestatic 1695	oicq/wlogin_sdk/tools/util:buf_to_string	([B)Ljava/lang/String;
    //   182: astore_0
    //   183: aload_0
    //   184: invokevirtual 664	java/lang/String:length	()I
    //   187: istore 5
    //   189: iload 5
    //   191: ifne +17 -> 208
    //   194: aload 6
    //   196: ifnull +10 -> 206
    //   199: aload 6
    //   201: invokeinterface 1347 1 0
    //   206: iconst_0
    //   207: ireturn
    //   208: aload_0
    //   209: invokestatic 1342	oicq/wlogin_sdk/tools/MD5:toMD5	(Ljava/lang/String;)Ljava/lang/String;
    //   212: astore 9
    //   214: aload 6
    //   216: invokeinterface 1745 1 0
    //   221: ifle +53 -> 274
    //   224: new 1747	android/content/ContentValues
    //   227: dup
    //   228: invokespecial 1748	android/content/ContentValues:<init>	()V
    //   231: astore 7
    //   233: aload 7
    //   235: ldc_w 1319
    //   238: aload_0
    //   239: invokevirtual 1751	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   242: aload 7
    //   244: ldc_w 1321
    //   247: aload 9
    //   249: invokevirtual 1751	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   252: aload 6
    //   254: invokeinterface 1334 1 0
    //   259: pop
    //   260: aload 6
    //   262: ifnull +10 -> 272
    //   265: aload 6
    //   267: invokeinterface 1347 1 0
    //   272: iconst_1
    //   273: ireturn
    //   274: new 1747	android/content/ContentValues
    //   277: dup
    //   278: invokespecial 1748	android/content/ContentValues:<init>	()V
    //   281: astore 10
    //   283: aload 10
    //   285: ldc_w 1315
    //   288: lload_1
    //   289: invokestatic 1754	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   292: invokevirtual 1757	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   295: aload 10
    //   297: ldc_w 1317
    //   300: lload_3
    //   301: invokestatic 1754	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   304: invokevirtual 1757	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   307: aload 10
    //   309: ldc_w 1319
    //   312: aload_0
    //   313: invokevirtual 1751	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   316: aload 10
    //   318: ldc_w 1321
    //   321: aload 9
    //   323: invokevirtual 1751	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   326: aload 7
    //   328: aload 8
    //   330: aload 10
    //   332: invokevirtual 1763	android/content/ContentResolver:insert	(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    //   335: astore_0
    //   336: new 398	java/lang/StringBuilder
    //   339: dup
    //   340: invokespecial 399	java/lang/StringBuilder:<init>	()V
    //   343: ldc_w 1765
    //   346: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   349: aload_0
    //   350: invokevirtual 1768	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   353: ldc_w 1770
    //   356: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   359: lload_1
    //   360: invokevirtual 948	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   363: ldc_w 1772
    //   366: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   369: lload_3
    //   370: invokevirtual 948	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   373: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   376: invokestatic 1774	oicq/wlogin_sdk/tools/util:LOGD	(Ljava/lang/String;)V
    //   379: goto -119 -> 260
    //   382: astore 7
    //   384: aload 6
    //   386: astore_0
    ...
    //   391: aload 6
    //   393: ldc 253
    //   395: invokestatic 508	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;Ljava/lang/String;)V
    //   398: aload_0
    //   399: ifnull +9 -> 408
    //   402: aload_0
    //   403: invokeinterface 1347 1 0
    //   408: iconst_0
    //   409: ireturn
    //   410: astore_0
    //   411: aconst_null
  ...
  public static void writeFile(String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   4: ifnull +12 -> 16
    //   7: aload_0
    //   8: invokevirtual 664	java/lang/String:length	()I
    //   11: istore_2
    //   12: iload_2
    //   13: ifne +7 -> 20
    //   16: ldc 2
    //   18: monitorexit
    //   19: return
    //   20: new 668	java/io/File
    //   23: dup
    //   24: aload_0
    //   25: invokespecial 670	java/io/File:<init>	(Ljava/lang/String;)V
    //   28: astore_0
    //   29: aload_0
    //   30: invokevirtual 952	java/io/File:exists	()Z
    //   33: ifne +26 -> 59
    //   36: aload_0
    //   37: invokevirtual 1817	java/io/File:getParentFile	()Ljava/io/File;
    //   40: astore_3
    //   41: aload_3
    //   42: ifnull -26 -> 16
    //   45: aload_3
    //   46: invokevirtual 1820	java/io/File:mkdirs	()Z
    //   49: ifne +10 -> 59
    //   52: aload_3
    //   53: invokevirtual 673	java/io/File:isDirectory	()Z
    //   56: ifeq -40 -> 16
    //   59: new 1703	java/io/FileOutputStream
    //   62: dup
    //   63: aload_0
    //   64: iconst_1
    //   65: invokespecial 1706	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   68: astore_0
    //   69: aload_0
    //   70: aload_1
    //   71: invokevirtual 1707	java/io/FileOutputStream:write	([B)V
    //   74: aload_0
    //   75: invokevirtual 1711	java/io/FileOutputStream:close	()V
    //   78: goto -62 -> 16
    //   81: astore_0
    //   82: goto -66 -> 16
    //   85: astore_0
    ...
    //   11	2	2	i	int
    //   40	13	3	localFile	File
    // Exception table:
    //   from	to	target	type
    //   20	41	81	java/lang/Exception
    //   45	59	81	java/lang/Exception
    //   59	78	81	java/lang/Exception
    //   7	12	85	finally
    //   20	41	85	finally
    //   45	59	85	finally
    //   59	78	85	finally
