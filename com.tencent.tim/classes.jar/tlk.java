  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg != null)
    {
      ...
      localObject1 = (ExposeAndGetAdvInfoRsp)tlk.a.a(paramFromServiceMsg, "ExposeAndGetAdvInfo");
    ...
    for (;;)
    {
      ...
      {
        notifyObserver(paramIntent, 100, bool, localBundle, tlj.class);
        return;
        i = -1;
        break;
        label278:
        ...
        localObject1 = (GetAdvInfoRsp)tlk.a.a(paramFromServiceMsg, "GetAdvInfo");
        if (localObject1 == null) {
          break label339;
        }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      localObject3 = new tlk.a((String)localObject3, (JceStruct)localObject1, paramIntent, (String)localObject2);
      localObject2 = ((tlk.a)localObject3).encode();
      localObject1 = localObject2;
      if (localObject2 == null)
      {
        QLog.e("QBossC2SCheckerServlet", 1, "onSend request encode result is null.cmd = " + ((tlk.a)localObject3).uniKey());
    ...
    extends QzoneExternalRequest
  {
    ...
    public a(String paramString1, JceStruct paramJceStruct, String paramString2, String paramString3)
    {
      this.mCmd = paramString2;
      this.aJx = paramString3;
      long l = Long.parseLong(paramString1);
      super.setHostUin(l);
      super.setLoginUserId(l);
      this.needCompress = false;
      this.d = paramJceStruct;
    }
    ...
    {
      return "QzoneNewService." + this.mCmd;
    }
