...
{
  oca(obw paramobw, String paramString) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (i == 0)
        {
          ...
          this.this$0.pUin = ((JSONObject)localObject2).optString("puin");
          if (i == -1)
          {
            paramInt = ((JSONObject)localObject2).optInt("refuseSec");
            if (paramInt > 0)
            {
              this.this$0.awk = true;
              this.this$0.mHandler.sendEmptyMessageDelayed(1000, paramInt * 1000);
            }
          }
          ...
          {
            localObject4 = obw.f(((Integer)((Iterator)localObject3).next()).intValue());
          ...
          Object localObject4 = (ArrayList)obw.eX.get(this.val$url);
          paramInt = 0;
          if (paramInt < ((ArrayList)localObject2).size())
          {
            String str = (String)obw.map.get(Integer.valueOf(paramInt));
            if ((str != null) && (((Integer)((ArrayList)localObject2).get(paramInt)).intValue() == 1) && (obw.a((ArrayList)localObject4, str))) {
              ((ArrayList)localObject3).add(str);
            }
          }
          else
          {
            obw.eW.put(this.val$url, localObject3);
            obw.eX.remove(this.val$url);
            localObject2 = new ArrayList();
            if (localObject4 != null)
            {
              ...
              {
                if (obw.a((ArrayList)localObject3, (String)((ArrayList)localObject4).get(paramInt))) {
                  break label583;
                }
        ...
        else
        {
          ...
          if (this.this$0.apA != null) {
            this.this$0.callJs(this.this$0.apA, new String[] { paramBundle });
          }
          return;
        }
      }
