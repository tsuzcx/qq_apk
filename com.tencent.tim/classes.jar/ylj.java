  ...
  extends WebViewPlugin
{
  ...
  public BroadcastReceiver aP = new ylk(this);
  ...
  public void c(Intent paramIntent, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("BlessJsApiPlugin", 2, "startNewPTVActivity" + " result:" + ReadInJoyDeliverUGCActivity.eS(paramIntent));
      }
  ...
  public boolean handleEvent(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    if ((paramLong == 8589934600L) && (paramMap != null))
    {
      ...
      if (i == 11000)
      {
        ...
        c((Intent)paramMap.get("data"), i, j);
        return true;
      }
    }
    ...
    if ("bless".equals(paramString2))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          {
            paramString1 = ajri.encode(paramString1);
        ...
        else if ("sendBlessText".equals(paramString3))
        {
          ...
          if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
            try
            {
              ...
              yll.b(this.mRuntime.getActivity(), paramString1, paramJsBridgeListener);
            }
            catch (JSONException paramJsBridgeListener)
            {
              paramJsBridgeListener.printStackTrace();
        ...
        else if ("sendBlessPtv".equals(paramString3))
        {
          ...
          if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
            try
            {
              ...
              mCallBack = paramJsBridgeListener;
              yll.a(localAppInterface, localActivity, paramString1, paramString2, paramString3, paramVarArgs, str1, str2, str3, str4, str5, str6, (String)localObject, paramJsBridgeListener);
            }
            catch (JSONException paramJsBridgeListener)
            {
              paramJsBridgeListener.printStackTrace();
  ...
  public void onCreate()
  {
    ...
    this.mRuntime.getActivity().registerReceiver(this.aP, localIntentFilter);
  }
  
  public void onDestroy()
  {
    super.onDestroy();
    this.mRuntime.getActivity().unregisterReceiver(this.aP);
  }
}
