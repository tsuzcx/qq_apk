...
public class akjz
  extends accg
{
  public akjz(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
  }
  
  private void kA(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
  ...
  private void ky(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((i == 0) && (paramToServiceMsg.str_config_version.has()))
    {
      ...
      {
        paramObject = (akjp)this.app.getManager(160);
        if (paramObject != null)
        {
          paramObject.Nv(paramFromServiceMsg);
  ...
  private void kz(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (int i = paramToServiceMsg.extraData.getInt("task_id");; i = 0)
    {
      ...
      paramObject = (akjp)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(160);
      if (paramObject == null) {
        break;
      }
      if (j == 0)
      ...
      for (paramToServiceMsg = paramFromServiceMsg;; paramToServiceMsg = null)
      {
        ...
        if (paramFromServiceMsg != null)
        {
          ...
          {
            bool1 = true;
            ay(paramFromServiceMsg, bool4);
          }
        }
        for (;;)
        {
          paramObject.ax(paramToServiceMsg, bool1);
          return;
          bool1 = bool3;
  ...
  public void ay(List<cmd0x6cd.PullRedpointReq> paramList, boolean paramBoolean)
  {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      {
        kA(paramToServiceMsg, paramFromServiceMsg, paramObject);
        return;
      }
