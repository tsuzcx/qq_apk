...
{
  lmu(lmp paramlmp, lie paramlie, Container paramContainer, int paramInt) {}
  ...
  public void rr(int paramInt)
  {
    ...
    lmp.a(this.a, this.c.getContext(), this.b.a(), (int)((SocializeFeedsInfo.n)localObject).vP, this.b.a().innerUniqueID, this.val$position, paramInt, this.b.b());
  }
}
