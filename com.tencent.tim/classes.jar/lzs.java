...
public class lzs
  extends lwm
{
  public lzs(Context paramContext, aqdf paramaqdf, ndi paramndi)
  {
    ...
    throws Exception
  {
    ...
    if ((this.jdField_a_of_type_Lwl != null) && ((this.jdField_a_of_type_Lwl instanceof ComponentContentBig)) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null))
    {
      ...
      ((LinearLayout.LayoutParams)localObject).setMargins(0, wja.dp2px(5.0F, this.context.getResources()), 0, wja.dp2px(6.0F, this.context.getResources()));
      ...
      localLinearLayout2.setOnClickListener(new lzt(this));
