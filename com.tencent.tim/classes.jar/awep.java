...
{
  awep(aweo paramaweo, JSONObject paramJSONObject, String paramString, boolean paramBoolean) {}
  ...
  public void onPluginManagerLoaded(PluginManagerClient paramPluginManagerClient)
  {
    ...
    catch (JSONException paramPluginManagerClient)
    {
      ...
      QLog.i("QZoneLiveJsPlugin", 2, "插件未安装,state=" + ((PluginBaseInfo)localObject).mState + "needInstall：" + this.dqb + "返回：" + this.val$result);
      label371:
      if (!this.dqb) {
        break label449;
      }
