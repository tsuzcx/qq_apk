...
public class aoed
  implements Manager
{
  private ConcurrentHashMap<String, Entity> iy = new ConcurrentHashMap();
  private ConcurrentHashMap<String, Entity> iz = new ConcurrentHashMap();
  QQAppInterface mApp;
  private EntityManager mEntityManager;
  
  public aoed(QQAppInterface paramQQAppInterface)
  {
  ...
  private void mB(List<GPadInfo> paramList)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 42	aoed:mEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   4: invokevirtual 86	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   7: invokevirtual 91	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   10: aload_1
    ...
    //   32: checkcast 109	com/tencent/mobileqq/teamworkforgroup/GPadInfo
    //   35: astore_2
    //   36: aload_0
    //   37: getfield 42	aoed:mEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   40: aload_2
    //   41: invokevirtual 113	com/tencent/mobileqq/persistence/EntityManager:persist	(Lcom/tencent/mobileqq/persistence/Entity;)V
    //   44: goto -27 -> 17
    //   47: astore_1
    //   48: ldc 115
    //   50: iconst_1
    ...
    //   63: aload_1
    //   64: invokevirtual 118	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   73: invokestatic 124	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   76: aload_0
    //   77: getfield 42	aoed:mEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   80: invokevirtual 86	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   83: invokevirtual 127	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   86: return
    //   87: aload_0
    //   88: getfield 42	aoed:mEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   91: invokevirtual 86	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   94: invokevirtual 130	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   97: aload_0
    //   98: getfield 42	aoed:mEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   101: invokevirtual 86	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   104: invokevirtual 127	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   107: return
    //   108: astore_1
    //   109: aload_0
    //   110: getfield 42	aoed:mEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   113: invokevirtual 86	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   116: invokevirtual 127	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   119: aload_1
    //   120: athrow
  ...
  private void mC(List<GroupPadTemplateInfo> paramList)
  {
    ...
    //   26: aload_1
    //   27: invokeinterface 107 1 0
    //   32: checkcast 135	com/tencent/mobileqq/teamworkforgroup/GroupPadTemplateInfo
    //   35: astore_2
    //   36: aload_0
    //   37: getfield 42	aoed:mEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   40: aload_2
  ...
  public void X(int paramInt, List<GPadInfo> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        this.iy.put(aobw.nT(localGPadInfo.pad_url), localGPadInfo);
      }
      mB(paramList);
    }
  }
    ...
    try
    {
      ...
      if ((localObject1 != null) && (((List)localObject1).size() > 0))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          this.iy.put(aobw.nT(((GPadInfo)localObject4).pad_url), localObject4);
        }
      }
      this.iz.clear();
    }
  ...
  public void mA(List<GroupPadTemplateInfo> paramList)
  {
    ...
    if ((paramList != null) && (this.iz != null))
    {
      Iterator localIterator = paramList.iterator();
      while (localIterator.hasNext())
      {
  ...
  public void mD(List<GroupPadTemplateInfo> paramList)
  {
    ...
    //   1: ifnull +81 -> 82
    //   4: aload_0
    //   5: getfield 42	aoed:mEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   8: invokevirtual 86	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   11: astore_2
    //   12: aload_2
    //   13: invokevirtual 91	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   16: aload_1
    //   17: invokeinterface 97 1 0
    //   22: astore_1
    //   23: aload_1
    ...
    //   39: checkcast 135	com/tencent/mobileqq/teamworkforgroup/GroupPadTemplateInfo
    //   42: invokevirtual 255	aoed:a	(Lcom/tencent/mobileqq/teamworkforgroup/GroupPadTemplateInfo;)V
    //   45: goto -22 -> 23
    //   48: astore_1
    //   49: ldc 115
    //   51: iconst_1
    ...
    //   65: aload_1
    //   66: invokevirtual 118	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   75: invokestatic 124	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   78: aload_2
    //   79: invokevirtual 127	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   82: return
    //   83: aload_2
    //   84: invokevirtual 127	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   87: return
    //   88: astore_1
    //   89: aload_2
    //   90: invokevirtual 127	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   93: aload_1
    //   94: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	95	0	this	aoed
    //   0	95	1	paramList	List<GroupPadTemplateInfo>
    //   11	79	2	localEntityTransaction	com.tencent.mobileqq.persistence.EntityTransaction
    // Exception table:
    //   from	to	target	type
