  ...
  extends accg
{
  ...
  public void e(int paramInt1, int paramInt2, String paramString, int paramInt3)
  {
    if (QLog.isColorLevel()) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
      ...
      if ("QQAIOMediaSvc.get_latest_playing_state".equals(paramFromServiceMsg.getServiceCmd()))
      {
        ...
        else
        {
          ...
          else
          {
            ...
            paramObject = ((aohy)this.mApp.getManager(339)).a(i);
            if (paramObject == null)
            {
              if (QLog.isColorLevel()) {
      ...
      else if ("QQAIOMediaSvc.get_dynamic_info".equals(paramFromServiceMsg.getServiceCmd()))
      {
        ...
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          try
          {
            ...
            paramFromServiceMsg = new aoie();
            paramFromServiceMsg.id = 1001;
            paramFromServiceMsg.cLF = true;
            paramFromServiceMsg.dOC = ((aio_media.DynamicInfo)((aio_media.RspGetDynamicInfo)paramToServiceMsg.get()).msg_music_info.get()).uint32_user_num.get();
            ...
            paramFromServiceMsg.Bj = new ArrayList(paramObject.size());
            paramObject = paramObject.iterator();
            while (paramObject.hasNext())
            {
              localLong = (Long)paramObject.next();
              paramFromServiceMsg.Bj.add(localLong + "");
            }
            if (!QLog.isColorLevel()) {}
          }
          catch (InvalidProtocolBufferMicroException paramToServiceMsg)
    ...
    return;
    aohy.a(this.app).a(paramFromServiceMsg);
    label443:
    if (((aio_media.RspGetDynamicInfo)paramToServiceMsg.get()).msg_video_info.has())
    {
      paramFromServiceMsg = new aoie();
      paramFromServiceMsg.id = 1002;
      paramFromServiceMsg.cLF = true;
      paramFromServiceMsg.dOC = ((aio_media.DynamicInfo)((aio_media.RspGetDynamicInfo)paramToServiceMsg.get()).msg_video_info.get()).uint32_user_num.get();
    ...
    {
      paramFromServiceMsg = new aoie();
      paramFromServiceMsg.id = 1003;
      paramFromServiceMsg.cLF = true;
      paramFromServiceMsg.dOC = ((aio_media.DynamicInfo)((aio_media.RspGetDynamicInfo)paramToServiceMsg.get()).msg_ksing_info.get()).uint32_user_num.get();
    ...
    {
      paramFromServiceMsg = new aoie();
      paramFromServiceMsg.id = 1004;
      paramFromServiceMsg.cLF = true;
      paramFromServiceMsg.dOC = ((aio_media.DynamicInfo)((aio_media.RspGetDynamicInfo)paramToServiceMsg.get()).msg_play_info.get()).uint32_user_num.get();
      ...
      paramFromServiceMsg.Bj = new ArrayList(paramToServiceMsg.size());
      paramToServiceMsg = paramToServiceMsg.iterator();
      while (paramToServiceMsg.hasNext())
      {
        paramObject = (Long)paramToServiceMsg.next();
        paramFromServiceMsg.Bj.add(paramObject + "");
      }
      aohy.a(this.app).a(paramFromServiceMsg);
    }
