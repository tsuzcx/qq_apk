...
public class lyi
  extends lwm
{
  public lyi(Context paramContext, aqdf paramaqdf, ndi paramndi)
  {
  ...
  {
    this.alM = true;
    return c(this.d, this.c).q().l().n().h().g().j();
  }
    ...
    throws Exception
  {
    ...
    if ((this.jdField_a_of_type_Lwl != null) && ((this.jdField_a_of_type_Lwl instanceof ComponentContentBig)) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null))
    {
      ...
      localLinearLayout2.addView((ComponentContentBig)this.jdField_a_of_type_Lwl);
      RelativeLayout localRelativeLayout2 = new RelativeLayout(this.context);
      Object localObject = new LinearLayout.LayoutParams(-1, -2);
      ((LinearLayout.LayoutParams)localObject).setMargins(0, wja.dp2px(13.0F, this.context.getResources()), 0, wja.dp2px(13.0F, this.context.getResources()));
      ...
      ((RelativeLayout.LayoutParams)localObject).setMargins(wja.dp2px(12.0F, this.context.getResources()), 0, wja.dp2px(12.0F, this.context.getResources()), 0);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle.setLayoutParams((ViewGroup.LayoutParams)localObject);
      localRelativeLayout2.addView(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle);
      localLinearLayout2.setBackgroundResource(2130843717);
      localLinearLayout2.setOnClickListener(new lyj(this));
