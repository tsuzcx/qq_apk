...
public final class auqr
{
  ...
  public static String bJ(Context paramContext)
  {
    ...
    try
    {
      ...
      paramContext = I(((MessageDigest)localObject).digest());
      return paramContext;
    }
    catch (Exception paramContext)
    {
  ...
  public static String getFileMd5(InputStream paramInputStream)
  {
    try
    {
      ...
      paramInputStream = I(localMessageDigest.digest());
    }
  ...
  public static String getFileMd5(String paramString)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: invokestatic 124	twz:getFileMd5	(Ljava/lang/String;)Ljava/lang/String;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +7 -> 15
    //   11: aload_1
    ...
    //   13: aload_2
    //   14: areturn
    //   15: new 126	java/io/BufferedInputStream
    //   18: dup
    //   19: new 128	java/io/FileInputStream
    //   22: dup
    //   23: aload_0
    //   24: invokespecial 131	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   27: invokespecial 134	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   30: astore_1
    //   31: aload_1
    //   32: astore_0
    //   33: aload_1
    //   34: invokestatic 136	auqr:getFileMd5	(Ljava/io/InputStream;)Ljava/lang/String;
    //   37: astore_2
    //   38: aload_2
    //   39: astore_0
    //   40: aload_0
    ...
    //   43: ifnull -30 -> 13
    //   46: aload_1
    //   47: invokevirtual 139	java/io/BufferedInputStream:close	()V
    //   50: aload_0
    //   51: areturn
    //   52: astore_1
    //   53: aload_0
    ...
    //   59: astore_0
    //   60: aload_2
    //   61: invokevirtual 140	java/io/IOException:printStackTrace	()V
    //   64: aload_1
    //   65: ifnull +7 -> 72
    //   68: aload_1
    //   69: invokevirtual 139	java/io/BufferedInputStream:close	()V
    //   72: aconst_null
    //   73: areturn
    //   74: astore_0
    //   75: aload_2
    ...
    //   78: ifnull +7 -> 85
    //   81: aload_1
    //   82: invokevirtual 139	java/io/BufferedInputStream:close	()V
    //   85: aload_0
    //   86: athrow
    //   87: astore_0
    //   88: goto -16 -> 72
