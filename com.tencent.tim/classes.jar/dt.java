...
public class dt
{
  public static int dL = 19;
  public static int dM = 1;
  public static int dN = 21;
  ...
  public static void a(QQAppInterface paramQQAppInterface, ReportItem paramReportItem, int paramInt)
  {
    ...
    if (paramReportItem.bSend)
    {
      ...
      l1 = paramInt;
      if ((paramQQAppInterface != null) && (paramInt == dM)) {
        ((ackv)paramQQAppInterface.getBusinessHandler(10)).eW();
      }
      l1 = 1L;
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      anpc.a(BaseApplication.getContext()).collectPerformance(paramQQAppInterface.getCurrentAccountUin(), str, bool, l2, l3 - l4, localHashMap, null);
      return;
      str = "actFAFileDown";
      break;
      bool = false;
