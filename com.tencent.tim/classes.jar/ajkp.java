  ...
  extends accg
{
  ...
  public ajkp(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.a = ((ajkq)paramQQAppInterface.getManager(347));
  }
  ...
  private void ka(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      label474:
      this.a.b(bool, paramFromServiceMsg, String.valueOf(l2));
      label496:
      return;
      bool = false;
      break;
  ...
  public void g(String paramString, int paramInt, List<Long> paramList)
  {
    try
    {
