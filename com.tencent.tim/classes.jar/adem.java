...
public class adem
  implements adis.a
{
  public adem(ArConfigService paramArConfigService) {}
  ...
  public void a(boolean paramBoolean, adis.b paramb)
  {
    ...
    if (paramBoolean)
    {
      ArConfigService.f(this.this$0, true);
      if ((ArConfigService.f(this.this$0)) && (ArConfigService.g(this.this$0)) && (ArConfigService.h(this.this$0)) && (ArConfigService.i(this.this$0)) && (ArConfigService.j(this.this$0))) {
        ArConfigService.a(this.this$0).post(new ArConfigService.8.2(this));
      }
    }
    while (ArConfigService.e(this.this$0)) {
      return;
    }
    ArConfigService.a(this.this$0).post(new ArConfigService.8.3(this));
  ...
  public void aj(long paramLong1, long paramLong2)
  {
    ...
    ArConfigService.e(this.this$0, (int)(100L * paramLong1 / paramLong2));
    ...
    if (!ArConfigService.e(this.this$0)) {
      ArConfigService.a(this.this$0).post(new ArConfigService.8.1(this, i));
    }
  }
