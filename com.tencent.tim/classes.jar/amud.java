...
public class amud
  extends adnq.b
{
  private WeakReference<amud.a> hO;
  
  public amud(ark.Application paramApplication, long paramLong)
  {
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    do
    {
      return false;
      if (paramString.equals("Report")) {
        return i(paramArrayOfVariantWrapper, paramVariantWrapper);
      }
      if (paramString.equals("SetTalkBackText")) {
        return j(paramArrayOfVariantWrapper, paramVariantWrapper);
      }
    } while (!paramString.equals("Notify"));
    return k(paramArrayOfVariantWrapper, paramVariantWrapper);
  }
  
  public void a(amud.a parama)
  {
    this.hO = new WeakReference(parama);
  }
  
  protected boolean i(ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    for (;;)
    {
      ...
      else if (k == 7)
      {
        ...
        continue;
        anot.a(localQQAppInterface, "CliOper", "", str, paramVariantWrapper, (String)localObject1, i, j, String.valueOf(l1), String.valueOf(l2), (String)localObject3, (String)localObject2);
        return true;
      }
      else
      {
  ...
  protected boolean j(ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
  ...
  protected boolean k(ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
  ...
  {
    public abstract void aG(long paramLong, String paramString);
    
    public abstract void t(long paramLong, String paramString1, String paramString2);
  }
}
