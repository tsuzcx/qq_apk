  ...
  extends SSLSocketFactory
{
  ...
  public aqok(String paramString, HostnameVerifier paramHostnameVerifier)
  {
    this.cux = paramString;
    ...
    throws IOException
  {
    ...
    if (Build.VERSION.SDK_INT >= 17) {
      localSSLCertificateSocketFactory.setHostname(paramSocket, this.cux);
    }
    for (;;)
    {
      ...
      if (this.b.verify(this.cux, paramString)) {
        break;
      }
      throw new SSLPeerUnverifiedException("Cannot verify hostname: " + this.cux);
      try
      {
        paramSocket.getClass().getMethod("setHostname", new Class[] { String.class }).invoke(paramSocket, new Object[] { this.cux });
      }
