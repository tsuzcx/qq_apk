  ...
  implements azau, azav
{
  ...
  private SVHwEncoder.a jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$a = new SVHwEncoder.a();
  ...
  public azar(String paramString1, String paramString2, String paramString3)
  {
  ...
  public SVHwEncoder.a a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecVideoSourceHelper != null) && (!this.cGi))
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$a.data = this.fx;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$a.offset = 0;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$a.size = paramInt;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$a.isVideo = true;
      SVHwEncoder.a locala = this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$a;
      if (paramInt > 0) {
        bool = false;
      }
      locala.finish = bool;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$a.time = this.aw[0];
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$a.bitrate = -1;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$a.zI = -1.0F;
      if (QLog.isColorLevel()) {
        QLog.d("HwEncodeHelper", 4, "getVideoFrame() bufferSize=" + this.fx.length + ", readSize=" + paramInt + ", frametime=" + this.aw[0]);
      }
      this.cGi = this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$a.finish;
      return this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$a;
    }
    return null;
  }
