  ...
  implements AVRoomMulti.EventListener
{
  ...
  public void onEndpointsUpdateInfo(int paramInt, String[] paramArrayOfString)
  {
    ...
    if (this.b.jdField_a_of_type_Avev$c != null) {
      this.b.jdField_a_of_type_Avev$c.onEndpointsUpdateInfo(paramInt, paramArrayOfString);
    }
  }
  ...
  public void onEnterRoomComplete(int paramInt, String paramString)
  {
    ...
    if (this.b.jdField_a_of_type_Avev$b != null) {
      this.b.jdField_a_of_type_Avev$b.onEnterRoomComplete(paramInt, paramString);
    }
  }
  ...
  public void onExitRoomComplete()
  {
    ...
    this.b.jdField_a_of_type_ComTencentTMGSdkAVContext.getAudioCtrl().stopTRAEService();
    if (this.b.jdField_a_of_type_Avev$c != null) {
      this.b.jdField_a_of_type_Avev$c.onExitRoomComplete();
    }
  }
  ...
  {
    if (this.b.jdField_a_of_type_Avev$c != null) {
      this.b.jdField_a_of_type_Avev$c.onRoomDisconnect(paramInt, paramString);
    }
  }
  ...
  public void onSemiAutoRecvCameraVideo(String[] paramArrayOfString)
  {
    ...
    if (this.b.jdField_a_of_type_Avev$c != null) {
      this.b.jdField_a_of_type_Avev$c.onSemiAutoRecvCameraVideo(paramArrayOfString);
    }
  }
