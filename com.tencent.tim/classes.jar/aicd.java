...
final class aicd
{
  public static final aibw a(String paramString, Object paramObject)
  {
    return a(paramString, new Object[] { paramObject });
  }
  
  public static final aibw a(String paramString, Object paramObject1, Object paramObject2)
  {
    return a(paramString, new Object[] { paramObject1, paramObject2 });
  }
  
  public static final aibw a(String paramString, Object[] paramArrayOfObject)
  {
  ...
  public static final aibw a(String paramString, Object[] paramArrayOfObject, Throwable paramThrowable)
  {
    int j = 0;
    if (paramString == null) {
      return new aibw(null, paramArrayOfObject, paramThrowable);
    }
    if (paramArrayOfObject == null) {
      return new aibw(paramString);
    }
    ...
    if (j < paramArrayOfObject.length)
    {
      ...
      {
        if (i == 0) {
          return new aibw(paramString, paramArrayOfObject, paramThrowable);
        }
        localStringBuilder.append(paramString, i, paramString.length());
        return new aibw(localStringBuilder.toString(), paramArrayOfObject, paramThrowable);
      }
