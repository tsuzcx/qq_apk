  ...
  extends accg
{
  ...
  public aklq(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(int paramInt, Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      for (paramIntent = Integer.toString(j);; paramIntent = i + "_" + j)
      {
        ...
        anpc.a(this.mApp.getApplication()).collectPerformance(this.app.getCurrentAccountUin(), "ocrTextSearch", bool, l, 0L, paramArrayOfByte, "");
        if (QLog.isColorLevel()) {
  ...
  private void dC(Intent paramIntent)
  {
    ...
    for (;;)
    {
      return;
      Object localObject1 = "";
      Object localObject2 = ConfigManager.getInstance(this.app.getApp().getBaseContext(), this.app.getHwEngine()).getNextSrvAddr(this.app.getApp().getBaseContext(), this.app, this.app.getCurrentAccountUin(), false);
      if (localObject2 != null) {
        localObject1 = "https://" + ((EndPoint)localObject2).host + ":" + ((EndPoint)localObject2).port + "/";
      }
      Object localObject3 = localObject1;
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject3 = "https://htdata.qq.com/";
      }
      Object localObject4 = aokl.a().i(l1);
      Object localObject5 = aokl.a().h(l1);
      ...
      ((im_msg_head.HttpConnHead)localObject1).uint32_seq.set(getSeq());
      ...
      try
      {
        ...
        ((aoll)localObject1).X = ((byte[])localObject5);
        ((aoll)localObject1).f = new aklq.a(paramIntent, (byte[])localObject2, (String)localObject3);
        ((aoll)localObject1).bZ = ((String)localObject4);
        ((aoll)localObject1).mHttpMethod = 1;
        ((aoll)localObject1).mFileType = 57;
        ((aoll)localObject1).u.put("Accept-Encoding", "identity");
        ((aoll)localObject1).mContinuErrorLimit = 2;
        ((aoll)localObject1).mExcuteTimeLimit = 15000L;
        paramIntent = BaseApplicationImpl.sApplication.getRuntime();
        if ((paramIntent instanceof AppInterface))
        {
          ((AppInterface)paramIntent).getNetEngine(0).a((aomg)localObject1);
          if (QLog.isColorLevel()) {
        ...
        QLog.i("Q.ocr.OCRHandler", 2, "reqSouggouSearchBigData start, uin=" + l1 + ",subType=" + l2 + ",url=" + (String)localObject4 + ",testserver=" + csL);
        return;
      }
      catch (Exception localException)
      {
  ...
  private void kB(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      ((TranslateResult)localObject).L(paramToServiceMsg.extraData.getString("param_translate_src_lang"), paramToServiceMsg.extraData.getString("param_translate_dst_lang"), paramToServiceMsg.extraData.getString("param_translate_src_text"), paramFromServiceMsg);
  ...
  private void kC(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 2)
    {
      kC(paramToServiceMsg, paramFromServiceMsg, paramObject);
      return;
    }
  ...
  public void r(String paramString1, String paramString2, long paramLong)
  {
    ...
    ((subcmd0x533.ReqBody)localObject1).string_clt_version.set(String.valueOf(AppSetting.getAppId()));
    ...
    implements aolm.b
  {
    ...
    public a(Intent paramIntent, byte[] paramArrayOfByte, String paramString)
    {
      this.ag = paramIntent;
    ...
    public void onResp(aomh paramaomh)
    {
      ...
      ThreadManager.post(new OCRHandler.BaseOCRReqBigDataListener.1(this, paramaomh), 8, null, true);
    }
