...
public class avlo
{
  public static AppRuntime g(BaseApplicationImpl paramBaseApplicationImpl, String paramString)
  {
    if ((paramBaseApplicationImpl == null) || (paramString == null))
    {
      if (QLog.isColorLevel()) {
        QLog.d(avli.TAG, 2, "createQQPimRuntime() application == null || processName == null");
      }
      return null;
    }
    try
    ...
    catch (ClassNotFoundException localClassNotFoundException)
    {
      for (;;)
      {
        try
        {
          ...
          QLog.d(avli.TAG, 2, "createQQPimRuntime() cls == null");
        }
        ...
        do
        {
          return null;
          if (QLog.isColorLevel()) {
            QLog.d(avli.TAG, 2, "createQQPimRuntime() 1 ");
          }
        ...
        if (QLog.isColorLevel()) {
          QLog.d(avli.TAG, 2, "createQQPimRuntime() succ");
        }
