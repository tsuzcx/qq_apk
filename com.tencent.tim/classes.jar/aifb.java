...
public class aifb
{
  private static final String bNB = Environment.getExternalStorageDirectory() + "/Tencent/wns/logs/qqplugin.zip";
    ...
    throws IOException
  {
    ...
    //   10: ifnonnull +4 -> 14
    //   13: return
    //   14: new 46	java/io/File
    //   17: dup
    //   18: aload_0
    //   19: invokespecial 108	java/io/File:<init>	(Ljava/lang/String;)V
    //   22: astore 5
    //   24: new 46	java/io/File
    //   27: dup
    //   28: aload_1
    //   29: invokespecial 108	java/io/File:<init>	(Ljava/lang/String;)V
    //   32: astore_1
    //   33: aload 5
    //   35: invokevirtual 73	java/io/File:exists	()Z
    //   38: ifne +33 -> 71
    //   41: new 110	java/io/FileNotFoundException
    //   44: dup
    ...
    //   56: ldc 111
    //   58: invokestatic 117	acfp:m	(I)Ljava/lang/String;
    ...
    //   67: invokespecial 118	java/io/FileNotFoundException:<init>	(Ljava/lang/String;)V
    //   70: athrow
    //   71: new 120	java/io/FileOutputStream
    //   74: dup
    //   75: aload_1
    //   76: invokespecial 121	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   79: astore_2
    //   80: new 90	java/util/zip/ZipOutputStream
    //   83: dup
    //   84: new 123	java/util/zip/CheckedOutputStream
    //   87: dup
    //   88: aload_2
    //   89: new 125	java/util/zip/CRC32
    //   92: dup
    //   93: invokespecial 126	java/util/zip/CRC32:<init>	()V
    //   96: invokespecial 129	java/util/zip/CheckedOutputStream:<init>	(Ljava/io/OutputStream;Ljava/util/zip/Checksum;)V
    //   99: invokespecial 132	java/util/zip/ZipOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   102: astore_1
    //   103: aload 5
    //   105: aload_1
    //   106: ldc 134
    //   108: invokestatic 70	aifb:a	(Ljava/io/File;Ljava/util/zip/ZipOutputStream;Ljava/lang/String;)V
    //   111: aload_1
    //   112: ifnull +59 -> 171
    //   115: aload_1
    //   116: invokevirtual 135	java/util/zip/ZipOutputStream:close	()V
    //   119: aload 4
    //   121: astore_0
    //   122: aload_0
    //   123: ifnull -110 -> 13
    ...
    //   137: ifnull +29 -> 166
    //   140: aload_1
    //   141: invokevirtual 135	java/util/zip/ZipOutputStream:close	()V
    //   144: aload_3
    //   145: astore_1
    //   146: aload_1
    //   147: ifnull +7 -> 154
