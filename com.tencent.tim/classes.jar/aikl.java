...
public class aikl
  extends Client.b
{
  public aikl(UiApiPlugin paramUiApiPlugin) {}
  ...
  public void onResponse(Bundle paramBundle)
  {
    ...
    Object localObject3;
    Object localObject2;
    if ((paramBundle != null) && (paramBundle.getInt("respkey", 0) == this.this$0.mOnRemoteResp.key))
    {
      ...
      else
      {
        ...
        if (("checkRelation".equals(str3)) && (localActivity != null) && (localObject1 != null))
        {
          ...
          if ("openSocialCard".equals(str2))
          {
            ...
            localObject2 = this.this$0.mRuntime.a();
            if ((((Bundle)localObject3).getBoolean("result", false)) && (localObject2 != null) && (!((AppInterface)localObject2).getCurrentAccountUin().equals(localObject1)))
            {
              ...
              ((ProfileActivity.AllInOne)localObject1).bJa = i;
          ...
          for (;;)
          {
            ...
            this.this$0.callJs(str1, new String[] { paramBundle });
            return;
            localObject1 = new ProfileActivity.AllInOne((String)localObject1, localObject4[k]);
            if (!TextUtils.isEmpty(paramBundle)) {
              ((ProfileActivity.AllInOne)localObject1).cf = ChatActivityUtils.p(paramBundle);
            }
            ((ProfileActivity.AllInOne)localObject1).bJa = i;
              ...
              else
              {
                ...
                if ((bool) || (!TextUtils.isEmpty(paramBundle)) || (i == 6))
                {
                  if (bool)
                  {
                    ...
                    ((Intent)localObject4).putExtra("rich_accost_sig", ChatActivityUtils.p(paramBundle));
                  }
                  for (;;)
                  {
                    ...
                    case 8: 
                      ...
                      break;
                      if (i == 1010) {
                        ((Intent)localObject4).putExtra("rich_date_sig", ChatActivityUtils.p(paramBundle));
                      } else if (i == 10004) {
                        ((Intent)localObject4).putExtra("rich_movie_sig", ChatActivityUtils.p(paramBundle));
                      }
                      break;
                    }
                  }
