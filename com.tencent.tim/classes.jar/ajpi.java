...
public class ajpi
  extends MSFServlet
{
  static HashMap<String, Object> lR;
  ...
  public static String N(int paramInt1, int paramInt2)
  {
    ...
    return ar(localStringBuilder.toString(), paramInt2);
  }
  ...
  private void a(Intent paramIntent, int paramInt, byte[] paramArrayOfByte1, byte[] arg4)
  {
    ...
    for (;;)
    {
      ...
      {
        if (lR != null) {
          paramArrayOfByte1 = lR.remove(str2);
        }
        if (ajrk.isColorLevel()) {
          ajrk.m("NearbyAlumniServlet", new Object[] { "respGetNearbyAlumni", Integer.valueOf(i), paramArrayOfByte1 });
        }
        if ((paramArrayOfByte1 instanceof ssx)) {
          paramArrayOfByte1 = (ssx)paramArrayOfByte1;
        }
      }
      try
      {
  ...
  public static void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString1, Object paramObject, String paramString2)
  {
    ...
    synchronized (sLock)
    {
      ...
      lR.put(str, paramObject);
      paramObject = new NewIntent(paramAppInterface.getApplication(), ajpi.class);
      ...
      if ((localObject2 != null) && (((List)localObject2).size() != 0))
      {
        ...
        if ((localObject3 != null) && (((List)localObject3).size() != 0))
        {
          ...
          while (i < ((List)localObject3).size())
          {
            ...
            localObject2[i] = N(localIpAddr.uint32_ip.get(), localIpAddr.uint32_port.get());
            i += 1;
          }
          localObject3 = b();
          if (localObject3 != null) {
            ((ajro)localObject3).a(paramFromServiceMsg, (byte[])localObject1, (String[])localObject2);
          }
  ...
  protected void a(Intent paramIntent, Packet paramPacket, boolean paramBoolean)
  {
    ...
    if (ajrk.isColorLevel()) {
      ajrk.m("NearbyAlumniServlet", new Object[] { "reqBigData", Integer.valueOf(i), Long.valueOf(l) });
    }
    ...
    do
    {
      do
      {
        ...
        while (localObject1 == null) {
          if (paramBoolean)
          {
            a(null, -1, null, null);
            return;
            localObject1 = ((ajro)localObject3).ah();
          }
          else
          {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            if (localObject3 == null)
            {
              ...
              a(null, -1, null, null);
              return;
              localObject2 = ((ajro)localObject3).ai();
              continue;
              if (paramBoolean)
              {
                a(null, -1, null, null);
        ...
        paramPacket = new aoll();
        paramPacket.X = ((byte[])localObject3);
        paramPacket.f = new ajpi.a(paramIntent, (byte[])localObject1);
        paramPacket.bZ = str;
        paramPacket.mHttpMethod = 1;
        paramPacket.mFileType = 131080;
        paramPacket.u.put("Accept-Encoding", "identity");
      ...
      ((aolm)localObject1).a(paramPacket);
    } while (!ajrk.isColorLevel());
    ajrk.m("NearbyAlumniServlet", new Object[] { "getBigData", localObject1, paramIntent });
  }
  ...
  protected ajro b()
  {
    ...
    if ((localAppRuntime instanceof NearbyAppInterface)) {
      return (ajro)localAppRuntime.getManager(217);
    }
    ...
    implements aolm.b
  {
    ...
    public a(Intent paramIntent, byte[] paramArrayOfByte)
    {
      this.ag = paramIntent;
    ...
    public void onResp(aomh paramaomh)
    {
      ...
      if ((paramaomh == null) || (paramaomh.mResult != 0))
      {
        ...
        if (QLog.isColorLevel())
        {
          localStringBuilder = new StringBuilder().append("NearbyAlumniDownloadListener.onResp() | resp = ").append(paramaomh).append(" | mResult=");
          if (paramaomh == null) {
            break label110;
          }
        }
        label110:
        for (int i = paramaomh.mResult;; i = -1)
        {
          QLog.i("NearbyAlumniServlet", 2, i);
          ajpi.a(ajpi.this, this.ag, -10, null, new byte[1]);
          paramaomh = ajpi.this.b();
          if (paramaomh != null) {
            paramaomh.dyT();
          }
          return;
      ...
      ajpi.a(ajpi.this, this.ag, 0, paramaomh.mRespData, this.eQ);
    }
