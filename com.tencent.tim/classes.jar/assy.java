  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    if ("troop_upload".equals(paramIntent.getAction())) {
      if (assx.a(this.a).getAttachedActivity() == null) {
    ...
    {
      return;
      paramContext = assx.b(this.a).getAttachedActivity().getSharedPreferences("troop_album" + BaseApplicationImpl.sApplication.getRuntime().getAccount(), 0).edit();
      ...
      for (;;)
      {
        ...
        assx.a(this.a, "groupAlbum_onGroupAlbumUpload", ((JSONObject)localObject).toString());
        if (i != 0) {
          break;
        }
        paramContext.putBoolean("is_exit_fail_misson", false).apply();
        assx.c(this.a).getAttachedActivity().unregisterReceiver(assx.a(this.a));
        assx.a(this.a, null);
        return;
        paramContext.putBoolean("is_exit_fail_misson", false).apply();
      }
    ...
    try
    {
      ...
      assx.a(this.a).ok(paramContext);
      assx.d(this.a).getAttachedActivity().unregisterReceiver(assx.a(this.a));
      return;
    }
