...
import com.tencent.mobileqq.filemanager.fileviewer.model.TroopFileModel.15.1;
...
public class agvc
  implements agrn.a
{
  agvc(aguu paramaguu, aguk.b paramb, TroopInfo paramTroopInfo, TroopManager paramTroopManager) {}
  ...
  public void bD(int paramInt1, int paramInt2)
  {
    ...
    while (paramInt1 != 0)
    {
      ...
      ThreadManager.post(new TroopFileModel.15.1(this), 5, null, true);
