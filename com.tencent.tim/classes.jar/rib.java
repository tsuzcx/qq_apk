  ...
  extends rhz
{
  ...
  public rib(rhw paramrhw)
  {
    this.mLinePaint.setAntiAlias(true);
    this.mLinePaint.setStyle(Paint.Style.STROKE);
    this.mLinePaint.setStrokeJoin(Paint.Join.ROUND);
    this.mLinePaint.setStrokeCap(Paint.Cap.ROUND);
    this.jdField_a_of_type_Rhw = paramrhw;
  }
  ...
  public void a(Canvas paramCanvas, ria paramria, float paramFloat)
  {
    if (paramria.mode == 103) {}
    do
    {
      return;
      if (paramria.mode == 104)
      {
        if (this.c == null) {
          buB();
        }
        ...
        paramCanvas.drawPath(paramria.path, this.mLinePaint);
        return;
      }
    } while (paramria.mode != 105);
    if (this.h == null)
    {
    ...
    this.h.drawPath(paramria.path, this.mLinePaint);
    this.h.restore();
    this.aHR = true;
  }
  
  public void a(rfz.a parama, float paramFloat, Bitmap paramBitmap, Rect paramRect)
  {
    this.jdField_a_of_type_Rfz$a = parama;
  ...
  public void a(ria paramria)
  {
    if (paramria.mode == 103)
    {
      ...
      ras.so("0X80076C2");
      List localList = paramria.oP;
      paramria = paramria.oQ;
      int i = 0;
      while ((i < localList.size()) && (i < paramria.size()))
      {
        em(((Integer)localList.get(i)).intValue(), ((Integer)paramria.get(i)).intValue());
        i += 1;
      }
      buD();
    }
  ...
  public void b(DoodleLayout paramDoodleLayout)
  {
    this.b = paramDoodleLayout;
  }
  ...
  public void buB()
  {
    ...
    do
    {
      ...
      localBitmap = this.b.W();
      this.cI = localBitmap;
    } while (this.cI == null);
    int j;
    if ((this.b.getBusinessId() == 1) && (this.mMode == 104))
    {
    ...
    for (int i = 2;; i = 8) {
      for (;;)
      {
        ...
        break;
        label536:
        f2 = (localOutOfMemoryError.getWidth() - this.cI.getWidth() * f3) / 2.0F;
        float f1 = f3;
        float f3 = 0.0F;
        continue;
        label563:
        f1 = localOutOfMemoryError.getWidth() / this.cI.getWidth();
        f3 = 0.0F;
        f2 = 0.0F;
      }
    }
  ...
  public void buD()
  {
    if (this.jdField_a_of_type_Rfz$a != null)
    {
      if (this.mMode != 105) {
        break label50;
      }
      this.jdField_a_of_type_Rfz$a.f(this.cJ, this.aHR);
    }
    for (;;)
    {
      this.aHR = false;
      ...
      return;
      label50:
      this.jdField_a_of_type_Rfz$a.h(this.mMosaicMask, this.brE, this.brF);
    }
  }
  ...
  public void clear()
  {
    this.jdField_a_of_type_Ria = null;
    if (this.mMode == 104) {
      return;
    }
    if (this.mMode == 105)
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.mLastX = f1;
      this.mLastY = f2;
      this.jdField_a_of_type_Ria = new ria(new Path(), this.mMode);
      if (this.jdField_a_of_type_Rhw != null) {
        this.jdField_a_of_type_Rhw.a(this.jdField_a_of_type_Ria);
      }
      int i;
      int j;
      if (this.mMode == 103)
      {
        ...
        if ((i >= 0) && (j >= 0))
        {
          this.jdField_a_of_type_Ria.oP.add(Integer.valueOf(i));
          this.jdField_a_of_type_Ria.oQ.add(Integer.valueOf(j));
          el(i, j);
          buD();
        }
      }
      ...
      {
        this.jdField_a_of_type_Ria.path.reset();
        this.jdField_a_of_type_Ria.path.moveTo(f1, f2);
        this.jdField_a_of_type_Ria.path.lineTo(f1 + 1.0F, f2 + 1.0F);
      }
      else if (this.mMode == 105)
      {
        ...
        if (this.mMode == 103)
        {
          i = ((Integer)this.jdField_a_of_type_Ria.oP.get(this.jdField_a_of_type_Ria.oP.size() - 1)).intValue();
          j = ((Integer)this.jdField_a_of_type_Ria.oQ.get(this.jdField_a_of_type_Ria.oQ.size() - 1)).intValue();
          k = (int)(f1 * this.nn / this.mMosaicSize);
          m = (int)(f2 * this.nn / this.mMosaicSize);
          if (((k != i) || (m != j)) && (k >= 0) && (m >= 0))
          {
            this.jdField_a_of_type_Ria.oP.add(Integer.valueOf(k));
            this.jdField_a_of_type_Ria.oQ.add(Integer.valueOf(m));
            el(k, m);
            buD();
          }
        }
        ...
        {
          this.jdField_a_of_type_Ria.path.quadTo(this.mLastX, this.mLastY, (this.mLastX + f1) / 2.0F, (this.mLastY + f2) / 2.0F);
          this.mLastX = f1;
          this.mLastY = f2;
        }
        else if (this.mMode == 105)
