...
{
  aoip(aoim paramaoim, AnimatorSet paramAnimatorSet) {}
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    ...
    while (i < 3)
    {
      paramAnimation = (ImageView)this.a.AB.get(i);
      paramAnimation.clearAnimation();
      Object localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      if ((localObject1 != null) && (i < this.a.uinList.size()))
      {
        Object localObject2 = (String)this.a.uinList.get(i);
    ...
    this.a.zt.clearAnimation();
    this.ao.cancel();
    this.a.DX.setTranslationX(0.0F);
    this.a.DX.setAlpha(1.0F);
    paramAnimation = new AlphaAnimation(1.0F, 0.0F);
    paramAnimation.setFillAfter(true);
    paramAnimation.setDuration(200L);
    paramAnimation.setAnimationListener(new aoiq(this));
