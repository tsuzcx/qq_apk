  ...
  extends accg
{
  ...
  {
    acic.d(this, 7, paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
  ...
  private void kd(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    boolean bool3 = true;
    int i;
    label201:
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.getResultCode() == 1000))
    {
      ...
      if ((paramToServiceMsg != null) && (paramToServiceMsg.uint32_result.has()))
      {
        ...
        if ((i == 0) && (paramToServiceMsg.bytes_bodybuffer.has()) && (paramToServiceMsg.bytes_bodybuffer.get() != null))
        {
          ...
          if (4 <= n)
          {
            paramFromServiceMsg = String.valueOf(aqoj.getLongData(paramToServiceMsg, 0));
          ...
          if (j < i)
          {
            ...
            if (k + 4 <= n)
            {
              m = aqoj.b(paramToServiceMsg, k);
              i1 = k + 2;
              k = aqoj.b(paramToServiceMsg, i1);
              i1 += 2;
              if ((m & 0xFFFF) == 40493) {
                if (k == 0)
                {
    ...
    for (;;)
    {
      ...
      for (boolean bool2 = bool3;; bool2 = false)
      {
        ...
        return;
        i = (byte)aqoj.b(paramToServiceMsg, i1);
        bool1 = true;
        break label291;
        m = i1 + k;
        j += 1;
  ...
  private void ke(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (m == 0)
    {
      ...
      if (localRspBody.rpt_msg_event_list.has())
      {
        ...
        if (QLog.isColorLevel())
        {
          ajrk.m("handleGetNearbyUneadMsg", new Object[] { "dating", Long.valueOf(localRspBody.uint64_max_event_id.get()), Integer.valueOf(j), Long.valueOf(paramToServiceMsg.extraData.getLong("dating_lastEventId")), Long.valueOf(paramToServiceMsg.extraData.getLong("dating_readEventId")) });
          i = j;
        }
      }
      j = i;
      if (localRspBody.rpt_msg_nearby_event_list.has())
      {
        ...
        if (QLog.isColorLevel())
        {
          ajrk.m("handleGetNearbyUneadMsg", new Object[] { "rank", Integer.valueOf(k), Long.valueOf(paramToServiceMsg.extraData.getLong("rank_lastEventId")), Long.valueOf(paramToServiceMsg.extraData.getLong("rank_readEventId")) });
          j = k;
        }
      }
      i = j;
      if (localRspBody.rpt_msg_feed_event_list.has())
      {
        ...
        if (QLog.isColorLevel())
        {
          ajrk.m("handleGetNearbyUneadMsg", new Object[] { "feed", Long.valueOf(localRspBody.uint64_max_fresh_event_id.get()), Integer.valueOf(k), Long.valueOf(paramToServiceMsg.extraData.getLong("feed_lastEventId")), Long.valueOf(paramToServiceMsg.extraData.getLong("feed_readEventId")) });
          i = k;
        }
      }
    }
    if (QLog.isColorLevel()) {
      ajrk.m("handleGetNearbyUneadMsg", new Object[] { Integer.valueOf(m), Integer.valueOf(i) });
    }
    if (i != 0) {
      this.app.a().Rp(i);
    }
    ajqo.fm(this.app.getCurrentAccountUin(), i);
  }
  
  private void kf(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    boolean bool1;
    boolean bool2;
    boolean bool5;
    ...
    if ((paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      ...
      paramFromServiceMsg = (ajpg)this.app.getManager(161);
      bool2 = paramFromServiceMsg.aro();
      bool5 = bool1;
      if (!bool1) {
        break label663;
      }
      ...
      try
      {
        ...
        if (paramObject != null)
        {
          ...
          if (paramObject.uint32_result.get() == 0)
          {
            ...
            bool4 = bool1;
            bool3 = bool1;
            l = aqft.K(ByteBuffer.wrap(paramObject.bytes_bodybuffer.get().toByteArray()).getInt());
            bool4 = bool1;
            bool3 = bool1;
  ...
  private void kg(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    boolean bool3 = true;
    int i;
    label203:
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        paramToServiceMsg = (ajpg)this.app.getManager(161);
        if (i == 0)
        {
          bool2 = true;
          label321:
          paramToServiceMsg.Mh(bool2);
        }
      }
      else
      {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean == true)
        {
          ...
          aqoj.q((byte[])localObject, 7, 42049);
  ...
  public void dyQ()
  {
    long l1 = ((Long)ajrb.a(this.app.getAccount(), "nearby_event_file", 4, "dating_last_event_id", Long.valueOf(0L))).longValue();
    long l2 = ((Long)ajrb.a(this.app.getAccount(), "nearby_event_file", 4, "dating_read_event_id", Long.valueOf(0L))).longValue();
    long l3 = ((Long)ajrb.a(this.app.getAccount(), "nearby_event_file", 4, "rank_last_event_seq", Long.valueOf(0L))).longValue();
    long l4 = ((Long)ajrb.a(this.app.getAccount(), "nearby_event_file", 4, "rank_read_event_seq", Long.valueOf(0L))).longValue();
    long l5 = ((Long)ajrb.a(this.app.getAccount(), "nearby_event_file", 4, "freshfeed_last_event_seq", Long.valueOf(0L))).longValue();
    long l6 = ((Long)ajrb.a(this.app.getAccount(), "nearby_event_file", 4, "freshfeed_red_event_seq", Long.valueOf(0L))).longValue();
    ...
    if (ajrb.nC(this.app.getAccount()))
    {
    ...
    sendPbReq((ToServiceMsg)localObject);
    if (QLog.isColorLevel()) {
      ajrk.m("getNearbyUnreadMsg", new Object[] { Long.valueOf(l1), Long.valueOf(l2), Long.valueOf(l3), Long.valueOf(l4), Long.valueOf(l5), Long.valueOf(l6) });
    }
  }
  ...
  public void dyR()
  {
    try
    {
      ...
      sendPbReq((ToServiceMsg)localObject);
      afck.l("getNotifyOnLikeSwitch...", new Object[0]);
      return;
    }
    catch (Exception localException)
    {
  ...
  public void k(byte paramByte)
  {
    acic.a(this, paramByte);
  }
  
  public void lA(List<Long> paramList)
  {
  ...
  protected boolean msgCmdFilter(String paramString)
  {
    if (this.allowCmdSet == null)
    {
      ...
      this.allowCmdSet.add("OidbSvc.0x9e4_22");
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            ke(paramToServiceMsg, paramFromServiceMsg, paramObject);
            return;
          }
        ...
        {
          kg(paramToServiceMsg, paramFromServiceMsg, paramObject);
          return;
        }
        kd(paramToServiceMsg, paramFromServiceMsg, paramObject);
        return;
      ...
      {
        kf(paramToServiceMsg, paramFromServiceMsg, paramObject);
        return;
      }
