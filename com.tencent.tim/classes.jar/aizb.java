...
public class aizb
{
  ...
  {
    s_notificationReportController.report(3, paramInt1, paramString, paramInt2);
  }
  
  public static void T(int paramInt1, String paramString, int paramInt2)
  {
    s_notificationReportController.report(4, paramInt1, paramString, paramInt2);
  }
  ...
  public static void dz(Intent paramIntent)
  {
    if (paramIntent != null) {}
    try
    {
      ...
      if (QQNotificationManager.getInstance().isIdValid("MsgPushReportHelper", i)) {
        s_notificationReportController.report(2, i, str, j);
      }
      return;
    }
