...
public class aqan
{
  public static boolean bR(String paramString1, String paramString2)
  {
  ...
  public static String bS(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString1 = aqhq.fileToBytes(new File(new File(BaseApplicationImpl.getApplication().getFilesDir(), "upgrade_config"), paramString1 + paramString2));
  ...
  public static void bg(String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      aqhq.z(localFile.getAbsolutePath() + "/", paramString1 + paramString2, paramString3);
