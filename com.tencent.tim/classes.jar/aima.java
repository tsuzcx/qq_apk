  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    try
    {
      ...
      localObject1 = aqgo.encodeToString(((cmd0xccb.RspBody)localObject2).res_id.get().toByteArray(), 0);
    ...
    catch (Exception paramFromServiceMsg)
    {
      ...
      notifyObserver(paramIntent, 0, false, paramIntent.getExtras(), ailx.class);
      return;
    }
    int n;
    ...
    notifyObserver(paramIntent, 0, bool, paramIntent.getExtras(), ailx.class);
    return;
    label780:
    for (;;)
    {
