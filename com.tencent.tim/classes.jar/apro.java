...
public class apro
{
  ...
  public static void aV(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localacms.hV(Long.valueOf(paramString).longValue());
      aptr.K(paramQQAppInterface, paramString, 1102858908);
      ChatActivityUtils.a(paramQQAppInterface, paramString, Integer.valueOf(0));
      return;
    }
    ThreadManager.post(new TroopAioNotifyManager.1(paramQQAppInterface, paramString, localacms), 8, null, true);
  }
  
  public static List<TroopAIONotifyItem> e(QQAppInterface paramQQAppInterface, String paramString)
  {
    for (;;)
    {
      try
  ...
  public static void n(QQAppInterface paramQQAppInterface, List<TroopAIONotifyItem> paramList)
  {
    if (paramList != null) {}
    for (;;)
    {
  ...
  /* Error */
  public static void o(QQAppInterface paramQQAppInterface, List<TroopAIONotifyItem> paramList)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   21: return
    //   22: aload_0
    //   23: invokevirtual 199	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   26: invokevirtual 205	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   29: astore_0
    //   30: iconst_0
    //   31: istore_2
    //   32: iload_2
    ...
    //   45: checkcast 247	com/tencent/mobileqq/persistence/Entity
    //   48: invokevirtual 249	com/tencent/mobileqq/persistence/EntityManager:remove	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   51: pop
    //   52: iload_2
    //   53: iconst_1
    //   54: iadd
    ...
    //   56: goto -24 -> 32
    //   59: aload_0
    //   60: invokevirtual 218	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   63: invokestatic 32	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   66: ifeq -48 -> 18
    //   69: ldc 75
    //   71: iconst_2
    //   72: new 36	java/lang/StringBuilder
    //   75: dup
    //   76: invokespecial 37	java/lang/StringBuilder:<init>	()V
    //   79: ldc 251
    //   81: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   84: iload_3
    //   85: invokevirtual 223	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   88: invokevirtual 50	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   91: invokestatic 161	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   94: goto -76 -> 18
    //   97: astore_0
    //   98: invokestatic 32	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   101: ifeq -83 -> 18
    //   104: ldc 75
    //   106: iconst_2
    ...
    //   119: aload_0
    //   120: invokevirtual 226	java/lang/Exception:toString	()Ljava/lang/String;
    //   123: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   126: invokevirtual 50	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   129: invokestatic 228	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   132: goto -114 -> 18
    //   135: astore_0
    //   136: ldc 2
    //   138: monitorexit
