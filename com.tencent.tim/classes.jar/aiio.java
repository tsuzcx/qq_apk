  ...
  public static <T> JSONObject convert2JSONObject(T paramT)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        Object localObject2 = (aiin)((Field)localObject1).getAnnotation(aiin.class);
        if (localObject2 != null)
        {
          localObject2 = ((aiin)localObject2).value();
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          if ((!Modifier.isStatic(k)) || (!Modifier.isFinal(k)))
          {
            ...
            localObject4 = (aiin)localField.getAnnotation(aiin.class);
            if (localObject4 != null) {
              paramClass = ((aiin)localObject4).value();
            }
