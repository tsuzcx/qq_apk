...
{
  public ueu(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject = AddFriendVerifyActivity.a(this.this$0).getText().toString().trim();
    if (TextUtils.isEmpty((CharSequence)localObject)) {
      if (!this.this$0.isFinishing())
      {
        localObject = new jog(this.this$0);
        ((jog)localObject).np.setText(acfp.m(2131702083));
        ((jog)localObject).hk.setImageResource(2130851444);
        ((jog)localObject).ayG();
      }
    }
    for (;;)
    {
      ...
      {
        this.this$0.aN((String)localObject, true);
        if (aqiw.isNetSupport(this.this$0)) {
          AddFriendVerifyActivity.a(this.this$0, AddFriendVerifyActivity.a(this.this$0), (String)localObject, this.this$0.getIntent().getIntExtra("stat_option", 0), 2000);
        } else {
