...
public class aptk
{
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, List<String> paramList, long paramLong)
  {
    ...
    return;
    Object localObject = acfp.m(2131721387);
    String str2 = acfp.m(2131721385);
    String str1 = acfp.m(2131721386);
    str2 = (String)localObject + " " + str2 + " " + str1;
    paramString1 = new ahwa(paramString1, paramString2, str2, 1, -5040, 131086, System.currentTimeMillis() / 1000L);
    ...
    i = BaseApplicationImpl.getApplication().getResources().getColor(2131167622);
