  ...
  implements BusinessObserver
{
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.a.this$0.TAG, 2, "requestQidiKefu ... onReceive = " + paramBoolean);
    }
    if (paramBoolean) {
      try
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(this.a.this$0.TAG, 2, "requestQidiKefu ... onReceive: retCode = " + paramInt);
        }
        if (paramInt == 0)
        {
          this.a.this$0.blL = true;
          this.a.this$0.chg();
          this.a.this$0.aAt();
          return;
        }
