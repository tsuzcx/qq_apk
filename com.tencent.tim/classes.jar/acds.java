...
public class acds
{
  public static void dH(Context paramContext)
  {
    ...
    String str = aqhq.readFileContent(localFile);
    long l1;
    int i;
    if (!TextUtils.isEmpty(str))
    {
      ...
      if ((l4 > 0L) || (l3 > 0L) || (l1 > 0L))
      {
        ...
        anpc.a(paramContext).collectPerformance("", "actSpFileStable", true, i, 0L, localHashMap, "");
        if (i == 0)
        {
          ...
          anpc.a(paramContext).collectPerformance("", "actSpContentStable", true, i, 0L, localHashMap, "");
        }
      }
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      bool1 = aqhq.writeFile(localFile.getAbsolutePath(), String.valueOf(l1), false);
