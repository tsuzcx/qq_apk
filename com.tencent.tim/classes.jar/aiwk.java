...
public class aiwk
{
  ...
  {
    b(paramQQAppInterface, paramContext, paramInt, paramString, "2");
  }
  
  public static void b(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      K(paramString1, paramString2, "2", LpReportInfo_dc03950.getReportUserType(paramQQAppInterface));
      ...
      {
        paramContext = aqik.c(paramQQAppInterface, paramContext, str);
        if (paramContext != null) {
          paramContext.ace();
        }
      }
