public class awry
{
  ...
  public static android.graphics.Bitmap a(android.content.Context paramContext, boolean paramBoolean)
  {
    ...
    //   30: aconst_null
    //   31: aconst_null
    //   32: invokestatic 26	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   35: astore_0
    //   36: aload_0
    //   37: ifnull +964 -> 1001
    //   40: aload_0
    ...
    //   307: aconst_null
    //   308: aconst_null
    //   309: invokestatic 26	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   312: astore 13
    //   314: aload 13
    //   316: astore 12
    //   318: aload 12
    ...
    //   562: ifnull -555 -> 7
    //   565: aload 11
    //   567: invokestatic 120	aqhu:getExifOrientation	(Ljava/lang/String;)I
    //   570: istore_2
    //   571: aload_0
    //   572: astore 12
    //   574: iload_2
