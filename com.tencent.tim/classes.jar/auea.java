...
final class auea
  implements ahbm
{
  auea(QQAppInterface paramQQAppInterface) {}
  ...
  public String a(String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3, String paramString4, long paramLong1, long paramLong2)
  {
    ...
    if ((aueh.isFileExists(paramString1.LocalFile)) && ((paramInt1 == 0) || (paramInt1 == 2))) {
      if (paramInt1 == 0)
      {
        ...
        paramLong1 = apsv.a(this.val$app, paramString2, paramString1.FileName, paramString1.ProgressTotal, paramString1.Id.toString(), paramInt2, String.valueOf(paramString1.TroopUin), paramLong2, paramString3.outWidth, paramString3.outHeight);
      }
    }
    for (;;)
    {
      ...
      if (paramInt1 == 2)
      {
        ...
        paramLong1 = apsv.a(this.val$app, paramString2, paramString1.FileName, paramString1.ProgressTotal, paramString1.Id.toString(), paramInt2, String.valueOf(paramString1.TroopUin), paramLong2, paramString3[0], paramString3[1], paramString3[2]);
        continue;
        if (localFileManagerEntity != null) {
          paramLong1 = apsv.a(this.val$app, paramString2, paramString4, paramLong1, paramString1.Id.toString(), paramInt2, String.valueOf(8888L), paramLong2, localFileManagerEntity.imgWidth, localFileManagerEntity.imgHeight, 0);
        } else {
          paramLong1 = apsv.a(this.val$app, paramString2, paramString4, paramLong1, paramString1.Id.toString(), paramInt2, String.valueOf(8888L), paramLong2);
        }
      }
    }
  }
