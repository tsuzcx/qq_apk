public class ayzb
{
  ...
  {
    // Byte code:
    //   0: invokestatic 16	java/lang/System:currentTimeMillis	()J
    //   3: lstore 9
    //   5: fload_2
    //   6: fconst_0
    //   7: fcmpg
    ...
    //   56: iconst_0
    //   57: fload_2
    //   58: invokestatic 26	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   61: aastore
    //   62: dup
    //   63: iconst_1
    //   64: fload_3
    //   65: invokestatic 26	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   68: aastore
    //   69: invokestatic 32	ram:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   72: ldc 33
    //   74: istore 5
    //   76: iload 5
    //   78: ireturn
    //   79: new 35	java/io/File
    //   82: dup
    //   83: aload_0
    //   84: invokespecial 39	java/io/File:<init>	(Ljava/lang/String;)V
    //   87: astore 18
    //   89: aload 18
    //   91: invokevirtual 42	java/io/File:length	()J
    //   94: l2i
    //   95: istore 6
    //   97: aload 18
    //   99: invokevirtual 46	java/io/File:exists	()Z
    //   102: ifeq +8 -> 110
    //   105: iload 6
    //   107: ifgt +39 -> 146
    //   110: ldc 18
    ...
    //   119: iconst_0
    //   120: fload_2
    //   121: invokestatic 26	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   124: aastore
    //   125: dup
    //   126: iconst_1
    //   127: fload_3
    //   128: invokestatic 26	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   131: aastore
    //   132: dup
    //   133: iconst_2
    //   134: iload 6
    ...
    //   139: aastore
    //   140: invokestatic 32	ram:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   143: ldc 54
    //   145: ireturn
    //   146: aload_0
    //   147: aconst_null
    //   148: iconst_0
    //   149: invokestatic 59	com/tencent/mobileqq/shortvideo/util/AudioEncoder:a	(Ljava/lang/String;Ljava/lang/String;I)Lcom/tencent/mobileqq/shortvideo/util/AudioEncoder$a;
    //   152: astore_0
    //   153: fload_3
    //   154: fstore 4
    //   156: fload_3
    ...
    //   170: f2i
    //   171: aload_0
    //   172: getfield 65	com/tencent/mobileqq/shortvideo/util/AudioEncoder$a:dIH	I
    //   175: invokestatic 69	ayzb:aK	(II)I
    //   178: istore 5
    //   180: iload 6
    //   182: i2f
    //   183: fload 4
    ...
    //   186: f2i
    //   187: aload_0
    //   188: getfield 65	com/tencent/mobileqq/shortvideo/util/AudioEncoder$a:dIH	I
    //   191: invokestatic 69	ayzb:aK	(II)I
    //   194: istore 6
    //   196: ldc 18
    ...
    //   228: invokestatic 93	ram:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   231: iload 6
    //   233: iload 5
    //   235: isub
    //   236: istore 6
    ...
    //   266: aload_0
    //   267: astore 11
    //   269: new 35	java/io/File
    //   272: dup
    //   273: aload_1
    //   274: invokespecial 39	java/io/File:<init>	(Ljava/lang/String;)V
    //   277: astore_1
    //   278: aload 17
    //   280: astore 12
    //   282: aload_0
    //   283: astore 11
    //   285: aload_1
    //   286: invokevirtual 46	java/io/File:exists	()Z
    //   289: ifeq +15 -> 304
    //   292: aload 17
    //   294: astore 12
    //   296: aload_0
    ...
    //   481: invokestatic 16	java/lang/System:currentTimeMillis	()J
    //   484: lload 9
    //   486: lsub
    ...
    //   493: invokestatic 93	ram:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   496: iconst_0
    //   497: ireturn
    //   498: aload_0
    //   499: aload 19
    ...
    //   596: ldc 18
    //   598: ldc 144
    //   600: invokestatic 146	ram:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   603: aload_0
    //   604: astore 12
    //   606: aload 13
    //   608: astore 11
  ...
  public static int e(byte[] paramArrayOfByte1, int paramInt1, byte[] paramArrayOfByte2, int paramInt2)
  {
    int i = paramInt2 * 3 / 2;
    paramInt2 = i;
    if (i % 2 == 1) {
