  ...
  extends adkd
{
  ...
  public adjy(int paramInt, String paramString)
  {
    super(paramInt);
    if (TextUtils.isEmpty(paramString)) {
      throw new IllegalArgumentException("mFragmentShader can not be empty!");
    }
    this.mFragmentShader = paramString;
  }
  ...
  protected void a(adkf paramadkf)
  {
    ...
    GLES20.glUniform1f(this.cHL, paramadkf.vd);
  }
  
  protected void cSi()
  {
    this.cHL = GLES20.glGetUniformLocation(this.mProgramId, "u_currentTime");
  }
  
  protected String nw()
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(adkg.dI(this.mTextureType));
    localStringBuilder.append(this.mFragmentShader);
