...
public class kcp
  extends accg
{
  static final String TAG = "Q.pubaccount.video." + kcq.class.getSimpleName();
  
  public kcp(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
  }
  
  public kcp(QQAppInterface paramQQAppInterface)
  {
  ...
  private void l(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(TAG, 2, "handleGetPlayCount onReceive :" + bool);
      }
      if (!bool) {
        break label532;
      }
    ...
    for (;;)
    {
        ...
        try
        {
          ...
          if ((paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
          {
            ...
            if ((paramToServiceMsg.bytes_article_id.has()) && (paramToServiceMsg.bytes_article_id.get() != null))
            {
              ...
              if (QLog.isColorLevel()) {
                QLog.d(TAG, 2, "handleGetPlayCount vid :" + paramToServiceMsg + " playCount :" + i);
              }
              ...
              if (QLog.isColorLevel())
              {
                QLog.e(TAG, 2, "handleGetPlayCount 获取失败, read_count 为空");
                i = 0;
                continue;
                if (QLog.isColorLevel()) {
                  QLog.e(TAG, 2, "handleGetPlayCount 获取失败, ret_code 为空或 ret_code == 1");
                }
              }
              i = 0;
              continue;
            ...
            QLog.e(TAG, 2, "geVideoPlayCount, 请求vid空");
            continue;
          }
          paramToServiceMsg = paramFromServiceMsg;
          if (QLog.isColorLevel())
          {
            QLog.e(TAG, 2, "geVideoPlayCount, reqBody为空");
            paramToServiceMsg = paramFromServiceMsg;
            continue;
            i = j;
          }
      ...
      if (QLog.isColorLevel())
      {
        QLog.e(TAG, 2, "geVideoPlayCount, ERROR e=" + paramObject.getMessage());
        i = j;
        paramToServiceMsg = paramFromServiceMsg;
        continue;
        paramToServiceMsg = paramFromServiceMsg;
        if (QLog.isColorLevel())
        {
          QLog.e(TAG, 2, "geVideoPlayCount, reqPkg为空");
          paramToServiceMsg = paramFromServiceMsg;
          continue;
          label532:
          i = k;
          ...
          if (QLog.isColorLevel())
          {
            QLog.e(TAG, 2, "geVideoPlayCount, 返回直接出错了");
            i = k;
            paramToServiceMsg = paramFromServiceMsg;
          }
        }
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2)
  {
    if (QLog.isDevelopLevel()) {
      QLog.d(TAG, 4, "getVideoPlayCount()  vId" + paramString1);
    }
  ...
  public void br(String paramString1, String paramString2)
  {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(TAG, 2, "handleGetPlayCount onReceive");
    }
