...
{
  public aafo(Context paramContext)
  {
  ...
  private ReportHeader a(String paramString)
  {
    ...
    paramString = new String(aqgo.decode(paramString.getBytes(), 0));
    try
    {
  ...
  private String a(ReportHeader paramReportHeader)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        paramReportHeader = new String(aqgo.encode(localJSONObject.toString().getBytes(), 0));
  ...
  private String a(ReportItem paramReportItem)
  {
    ...
    try
    {
      ...
      paramReportItem = new String(aqgo.encode(localJSONObject.toString().getBytes(), 0));
  ...
  public Map<Long, ReportInfo> g(Map<Long, ReportInfo> paramMap)
  {
    for (;;)
    {
      Object localObject4;
  ...
  /* Error */
  public void hA(java.util.List<ReportItem> paramList)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   24: return
    //   25: aload_0
    //   26: invokevirtual 374	aafo:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore 5
    //   31: aload 5
    //   33: astore_3
    //   34: aload 5
    //   36: astore 4
    //   38: aload 5
    //   40: invokevirtual 377	android/database/sqlite/SQLiteDatabase:beginTransaction	()V
    //   43: aload 5
    //   45: astore_3
    //   46: aload 5
    //   48: astore 4
    //   50: new 379	android/content/ContentValues
    //   53: dup
    //   54: invokespecial 380	android/content/ContentValues:<init>	()V
    //   57: astore 6
    //   59: aload 5
    //   61: astore_3
    //   62: aload 5
    ...
    //   117: astore 4
    //   119: aload 6
    //   121: invokevirtual 396	android/content/ContentValues:clear	()V
    //   124: aload 5
    //   126: astore_3
    //   127: aload 5
    //   129: astore 4
    ...
    //   140: invokestatic 279	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   143: invokevirtual 399	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   146: aload 5
    //   148: astore_3
    //   149: aload 5
    //   151: astore 4
    ...
    //   157: aload_0
    //   158: aload 7
    //   160: invokespecial 401	aafo:a	(LVACDReport/ReportItem;)Ljava/lang/String;
    //   163: invokevirtual 404	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   166: aload 5
    //   168: astore_3
    //   169: aload 5
    //   171: astore 4
    ...
    //   182: invokestatic 279	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   185: invokevirtual 399	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   188: aload 5
    //   190: astore_3
    //   191: aload 5
    //   193: astore 4
    ...
    //   197: ldc 202
    //   199: iconst_0
    //   200: invokestatic 409	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   203: invokevirtual 412	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    //   206: aload 5
    //   208: astore_3
    //   209: aload 5
    //   211: astore 4
    ...
    //   217: aconst_null
    //   218: aload 6
    //   220: invokevirtual 416	android/database/sqlite/SQLiteDatabase:insertOrThrow	(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    //   223: pop2
    //   224: goto -151 -> 73
    //   227: astore_1
    //   228: aload_3
    ...
    //   270: ifnull -248 -> 22
    //   273: aload_3
    //   274: invokevirtual 421	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   277: aload_3
    //   278: invokevirtual 306	android/database/sqlite/SQLiteDatabase:close	()V
    //   281: goto -259 -> 22
    //   284: astore_1
    ...
    //   333: astore 4
    //   335: aload 5
    //   337: invokevirtual 426	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    //   340: aload 5
    //   342: ifnull -320 -> 22
    //   345: aload 5
    //   347: invokevirtual 421	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   350: aload 5
    //   352: invokevirtual 306	android/database/sqlite/SQLiteDatabase:close	()V
    //   355: goto -333 -> 22
    //   358: astore_1
    ...
    //   400: ifnull +13 -> 413
    //   403: aload 4
    //   405: invokevirtual 421	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   408: aload 4
    //   410: invokevirtual 306	android/database/sqlite/SQLiteDatabase:close	()V
    //   413: aload_1
    //   414: athrow
    //   415: astore_3
  ...
  /* Error */
  public void hB(java.util.List<ReportHeader> paramList)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   112: astore 4
    //   114: aload 6
    //   116: invokevirtual 396	android/content/ContentValues:clear	()V
    //   119: aload 5
    //   121: astore_3
    //   122: aload 5
    //   124: astore 4
    ...
    //   135: invokestatic 279	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   138: invokevirtual 399	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   141: aload 5
    //   143: astore_3
    //   144: aload 5
    //   146: astore 4
    ...
    //   152: aload_0
    //   153: aload 7
    //   155: invokespecial 430	aafo:a	(LVACDReport/ReportHeader;)Ljava/lang/String;
    //   158: invokevirtual 404	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   161: aload 5
    //   163: astore_3
    //   164: aload 5
    //   166: astore 4
    ...
    //   170: ldc 202
    //   172: iconst_1
    //   173: invokestatic 409	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   176: invokevirtual 412	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    //   179: aload 5
    //   181: astore_3
    //   182: aload 5
    //   184: astore 4
    ...
    //   188: ldc 96
    //   190: iconst_0
    //   191: invokestatic 409	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   194: invokevirtual 412	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    //   197: aload 5
    //   199: astore_3
    //   200: aload 5
    //   202: astore 4
    ...
    //   208: aconst_null
    //   209: aload 6
    //   211: invokevirtual 416	android/database/sqlite/SQLiteDatabase:insertOrThrow	(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    //   214: pop2
    //   215: goto -142 -> 73
    //   218: astore_1
    //   219: aload_3
    ...
    //   261: ifnull -239 -> 22
    //   264: aload_3
    //   265: invokevirtual 421	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   268: aload_3
    //   269: invokevirtual 306	android/database/sqlite/SQLiteDatabase:close	()V
    //   272: goto -250 -> 22
    //   275: astore_1
    ...
    //   298: aload_1
    //   299: invokevirtual 303	java/lang/Throwable:toString	()Ljava/lang/String;
    ...
    //   324: astore 4
    //   326: aload 5
    //   328: invokevirtual 426	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    //   331: aload 5
    //   333: ifnull -311 -> 22
    //   336: aload 5
    //   338: invokevirtual 421	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   341: aload 5
    //   343: invokevirtual 306	android/database/sqlite/SQLiteDatabase:close	()V
    //   346: goto -324 -> 22
    //   349: astore_1
    ...
    //   372: aload_1
    //   373: invokevirtual 303	java/lang/Throwable:toString	()Ljava/lang/String;
    ...
    //   391: ifnull +13 -> 404
    //   394: aload 4
    //   396: invokevirtual 421	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   399: aload 4
    //   401: invokevirtual 306	android/database/sqlite/SQLiteDatabase:close	()V
    //   404: aload_1
    //   405: athrow
    //   406: astore_3
    ...
    //   429: aload_3
    //   430: invokevirtual 303	java/lang/Throwable:toString	()Ljava/lang/String;
  ...
  /* Error */
  public void hz(java.util.List<Long> paramList)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   26: astore 5
    //   28: aload_0
    //   29: invokevirtual 374	aafo:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   32: astore 7
    //   34: aload 7
    //   36: astore 5
    //   38: aload 7
    //   40: astore 6
    //   42: aload 7
    //   44: invokevirtual 377	android/database/sqlite/SQLiteDatabase:beginTransaction	()V
    //   47: aload 7
    //   49: astore 5
    //   51: aload 7
    //   53: astore 6
    //   55: aload_1
    //   56: invokeinterface 435 1 0
    //   61: istore_3
    //   62: aload 7
    //   64: astore 5
    //   66: aload 7
    ...
    //   75: bipush 14
    //   77: imul
    //   78: invokespecial 436	java/lang/StringBuilder:<init>	(I)V
    //   81: astore 8
    //   83: iconst_0
    //   84: istore_2
    //   85: iload_2
    ...
    //   100: aload_1
    //   101: iload_2
    //   102: invokeinterface 439 2 0
    //   107: checkcast 275	java/lang/Long
    //   110: invokevirtual 442	java/lang/Long:longValue	()J
    ...
    //   167: aload 8
    //   169: invokevirtual 322	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   172: ldc_w 448
    ...
    //   181: invokevirtual 213	android/database/sqlite/SQLiteDatabase:execSQL	(Ljava/lang/String;)V
    //   184: aload 7
    //   186: astore 5
    //   188: aload 7
    //   190: astore 6
    ...
    //   233: invokestatic 325	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   236: aload 7
    //   238: astore 5
    //   240: aload 7
    //   242: astore 6
    //   244: aload 7
    //   246: invokevirtual 426	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    //   249: aload 7
    //   251: ifnull -232 -> 19
    //   254: aload 7
    //   256: invokevirtual 421	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   259: aload 7
    //   261: invokevirtual 306	android/database/sqlite/SQLiteDatabase:close	()V
    //   264: goto -245 -> 19
    //   267: astore_1
    ...
    //   357: ifnull -338 -> 19
    //   360: aload 5
    //   362: invokevirtual 421	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   365: aload 5
    //   367: invokevirtual 306	android/database/sqlite/SQLiteDatabase:close	()V
    //   370: goto -351 -> 19
    //   373: astore_1
    ...
    //   415: ifnull +13 -> 428
    //   418: aload 6
    //   420: invokevirtual 421	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   423: aload 6
    //   425: invokevirtual 306	android/database/sqlite/SQLiteDatabase:close	()V
    //   428: aload_1
    //   429: athrow
    //   430: astore 5
