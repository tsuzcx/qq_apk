  ...
  extends accg
{
  ...
  public iji(AppInterface paramAppInterface)
  {
  ...
  private AudioTransClientTransInfo.IntHead a(int paramInt1, int paramInt2)
  {
    ...
    localIntHead.str_session_id.set(String.valueOf(this.a.mSessionId));
  ...
  private AudioTransClientTransInfo.IntReqBody a(int paramInt1, boolean paramBoolean, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      paramArrayOfByte.uint32_client_ver.set(jll.mM());
  ...
  public void a(String paramString1, long paramLong, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      ijf localijf = this.b;
      localToServiceMsg.putWupBuffer(ijf.g(localIntHead.toByteArray(), paramArrayOfByte.toByteArray()));
      if (aqiw.isNetworkAvailable(this.mApp.getApplication().getApplicationContext())) {
        sendPbReq(localToServiceMsg);
      }
      QLog.w("AudioTransClientInterfaceHandler", 1, "sendCmdToServiceSSO, cmd[" + paramString2 + "], seq[" + paramLong + "], bodyType[" + i + "], trans_english[" + bool1 + "], bussiness_direction[" + j + "], mSendRawDataCount[" + m + "->" + this.anI + "], from[" + paramString1 + "]");
      return;
  ...
  public void d(int paramInt, byte[] paramArrayOfByte)
  {
    ...
    localObject1 = ijf.a(paramArrayOfByte);
    paramArrayOfByte = ((ijf.a)localObject1).head;
    localObject1 = ((ijf.a)localObject1).body;
    ...
    try
    {
      ...
      case 11: 
        ...
        h(paramArrayOfByte, (String)localObject2, str, paramInt);
        return;
      }
    }
  ...
  protected abstract void h(String paramString1, String paramString2, String paramString3, int paramInt);
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (bool)
    {
      ...
      paramFromServiceMsg = paramObject.head;
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (j == 2)
          {
            ...
            QLog.w("AudioTransClientInterfaceHandler", 1, "onReceive, cmd[" + paramToServiceMsg + "], seq[" + i + "], bodyType[" + j + "], sessionid[" + l1 + "], mReceiveRawDataCount[" + k + "->" + this.anJ + "]");
            return;
          }
        }
        ...
        else if (j == 6)
        {
          ...
          this.a.mChannelType = paramFromServiceMsg.enum_channel_type.get();
          if (AudioHelper.aCz())
          {
            m = paramFromServiceMsg.uint32_combine_num.get();
            QLog.d("AudioTransClientInterfaceHandler", 2, "enum_channel_type = " + this.a.mChannelType);
            ...
            while (paramFromServiceMsg.hasNext())
            {
              ...
              ijf localijf = this.b;
              QLog.d("AudioTransClientInterfaceHandler", 2, ijf.aH(paramObject.fixed32_IP.get()));
              ...
              localijf = this.b;
              QLog.d("AudioTransClientInterfaceHandler", 2, ijf.aH(paramObject.fixed32_inner_IP.get()));
            }
          }
        }
      }
