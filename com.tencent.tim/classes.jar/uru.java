...
public class uru
  extends acfd
{
  public uru(ContactSyncJumpActivity paramContactSyncJumpActivity) {}
  ...
  protected void onGetOnlineInfoByUinOrMobile(boolean paramBoolean, long paramLong, String paramString, GetOnlineInfoResp paramGetOnlineInfoResp)
  {
    ...
    do
    {
      ...
      for (paramLong = paramGetOnlineInfoResp.uAbiFlag;; paramLong = -10000L)
      {
        ...
        paramString = (TextView)this.a.H.findViewById(2131365900);
        paramString.setText(2131700864);
      ...
      if (paramGetOnlineInfoResp.result == 1)
      {
        ...
        {
          paramString = String.format(this.a.getResources().getString(2131700854), new Object[] { ContactSyncJumpActivity.d(this.a) });
          ContactSyncJumpActivity.a(this.a).HB(ContactSyncJumpActivity.e(this.a));
    ...
    label760:
    for (paramString = this.a.getResources().getString(2131700864);; paramString = (String)localObject)
    {
      localObject = (TextView)this.a.H.findViewById(2131365900);
