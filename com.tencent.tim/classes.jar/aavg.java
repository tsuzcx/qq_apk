...
public class aavg
{
  ...
  public boolean a(boolean paramBoolean, int paramInt1, int paramInt2, ByteBuffer paramByteBuffer1, ByteBuffer paramByteBuffer2, ByteBuffer paramByteBuffer3)
  {
    ...
    if (paramInt1 != 0) {
      GLLogMsg("glDrawFrame:err=" + paramInt1 + " errname=" + cX(paramInt1));
    }
    return bool;
  }
  ...
  public void gx(int paramInt1, int paramInt2)
  {
    ...
    if ((this.o == null) || (this.o.capacity() < paramInt1)) {
      this.o = aavg.a.a(i, paramInt1);
    }
    if ((this.p == null) || (this.p.capacity() < paramInt1)) {
      this.p = aavg.a.a(i + paramInt1, paramInt1);
    }
  }
  ...
  public static class b
  {
    ...
    private static int compileShader(int paramInt, String paramString)
    {
      ...
      if (i == 0)
      {
        aavg.GLLogMsg("glCreateShader:shader==0 type=" + cY(paramInt));
        return 0;
      }
      ...
      if (jK[0] == 0)
      {
        ...
        aavg.GLLogMsg("glGetShaderiv:GL_COMPILE_STATUS error  loginfo=" + paramString);
        return 0;
      }
      return i;
    }
    ...
    private static int linkProgram(int paramInt1, int paramInt2)
    {
      ...
      if (i == 0)
      {
        aavg.GLLogMsg("glCreateProgram:program == 0");
        return 0;
      }
      ...
      if (jK[0] == 0)
      {
        ...
        aavg.GLLogMsg("linkProgram:GL_COMPILE_STATUS errorinfo =" + str);
        return 0;
      }
      return i;
    }
    ...
    public static int x(String paramString1, String paramString2)
    {
      ...
      if ((i == 0) || (j == 0))
      {
        aavg.GLLogMsg("compileShader:vertext or fragment == 0");
        return 0;
      }
