...
public class jjb
{
  private static final Map<String, Long> dh = new HashMap(5);
  private static final Map<String, Long> di = new HashMap(5);
  ...
  public static void a(String paramString1, String paramString2, int paramInt, Object... paramVarArgs)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      Object localObject1 = (Long)di.get(paramString1);
      long l1;
      if ((paramInt == 1) || (localObject1 == null))
      {
        dh.put(paramString1, Long.valueOf(l2));
        di.put(paramString1, Long.valueOf(l2));
        l1 = 0L;
      }
      for (;;)
      {
      ...
      if (paramInt == 2)
      {
        paramVarArgs = (Long)dh.get(paramString1);
