...
import com.tencent.tim.teamworkforgroup.GroupTeamWordkMoreView;
import com.tencent.tim.teamworkforgroup.TroopTeamWorkFileSearchDialog.10;
import com.tencent.tim.teamworkforgroup.TroopTeamWorkFileSearchDialog.11;
...
public class aumz
  ...
  implements Handler.Callback, augx, aujw
{
  ...
  public aumz(Activity paramActivity, View paramView, QQAppInterface paramQQAppInterface, long paramLong)
  {
    super(paramActivity, 2131755579);
    this.jdField_b_of_type_Aumy = new auni(this);
    this.mActivity = paramActivity;
    this.mApp = paramQQAppInterface;
    this.jdField_b_of_type_Aumb = ((aumb)this.mApp.getBusinessHandler(143));
    this.acU = paramLong;
    cg(paramActivity);
    ...
    this.mApp.addObserver(this.jdField_b_of_type_Aumy);
    hM(paramView);
  }
  
  private void dUn()
  {
    this.aF.setOnClickListener(new aung(this));
    View localView = findViewById(2131363801);
    localView.setVisibility(0);
    localView.setOnClickListener(new aunh(this));
  }
  ...
  public void Jb(String paramString)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 156	aumz:uiHandler	Landroid/os/Handler;
    //   18: iconst_1
    //   19: invokevirtual 204	android/os/Handler:sendEmptyMessage	(I)Z
    //   22: pop
    //   23: aload_0
    //   24: aload_0
    //   25: getfield 110	aumz:acU	J
    //   28: aload_1
    //   29: iconst_0
    //   30: bipush 50
    //   32: iconst_0
    //   33: invokevirtual 207	aumz:b	(JLjava/lang/String;III)V
    //   36: goto -25 -> 11
    //   39: astore_1
    //   40: aload_0
    //   41: monitorexit
  ...
  public final void b(long paramLong, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Aumb != null) {
        this.jdField_b_of_type_Aumb.a(paramLong, paramString, paramInt1, paramInt2, paramInt3);
      }
    }
  }
  ...
  protected void cg(Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      findViewById(2131370833).setOnClickListener(new auna(this));
  ...
  public void dismiss()
  {
    ...
    if (this.jdField_b_of_type_Auma != null)
    {
      this.jdField_b_of_type_Auma.dUi();
      this.jdField_b_of_type_Auma = null;
    }
    this.mApp.removeObserver(this.jdField_b_of_type_Aumy);
    try
    {
      super.dismiss();
      return;
  ...
  protected String fu(int paramInt)
  {
    ...
    return this.mActivity.getString(2131699569, new Object[] { Integer.valueOf(paramInt) });
  }
  
  protected void g(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentTimTeamworkforgroupGroupTeamWordkMoreView = new GroupTeamWordkMoreView(paramActivity);
    this.jdField_a_of_type_ComTencentTimTeamworkforgroupGroupTeamWordkMoreView.setBackgroundResource(2130838900);
    this.jdField_a_of_type_ComTencentTimTeamworkforgroupGroupTeamWordkMoreView.setTextColor(paramActivity.getResources().getColor(2131167304));
    this.V.addFooterView(this.jdField_a_of_type_ComTencentTimTeamworkforgroupGroupTeamWordkMoreView);
    this.jdField_a_of_type_ComTencentTimTeamworkforgroupGroupTeamWordkMoreView.setVisibility(8);
    this.jdField_b_of_type_Auma = new auma(this.mApp, this.mActivity, this, this, this.uiHandler);
    this.V.setAdapter(this.jdField_b_of_type_Auma);
    this.V.setOnScrollListener(new aunb(this));
    this.V.setOnTouchListener(new aunc(this));
    this.jdField_b_of_type_Auma.setOnClickListener(new aund(this));
  }
  ...
  protected void gT()
  {
    ...
    this.aR.setOnEditorActionListener(new aune(this));
    this.aR.addTextChangedListener(new aunf(this));
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      tG(this.mIsEnd);
      this.jdField_b_of_type_Auma.mw(this.GY);
      this.jdField_b_of_type_Auma.notifyDataSetChanged();
      if (this.cLn) {
        this.cLn = false;
      }
  ...
  protected void tG(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentTimTeamworkforgroupGroupTeamWordkMoreView.setVisibility(0);
    if (paramBoolean)
    {
      this.jdField_a_of_type_ComTencentTimTeamworkforgroupGroupTeamWordkMoreView.setText(2131720487);
      this.jdField_a_of_type_ComTencentTimTeamworkforgroupGroupTeamWordkMoreView.dmA();
      return;
    }
    this.jdField_a_of_type_ComTencentTimTeamworkforgroupGroupTeamWordkMoreView.setText(2131696924);
    this.jdField_a_of_type_ComTencentTimTeamworkforgroupGroupTeamWordkMoreView.setTextLeftDrawable(2130839651);
  }
}
