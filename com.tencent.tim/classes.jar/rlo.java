  ...
  extends BaseAdapter
{
  ...
  protected ArrayList<rlo.b> nG;
  
  public rlo(Context paramContext, ArrayList<TroopInfo> paramArrayList, ArrayList<String> paramArrayList1)
  {
    this.mContext = paramContext;
    this.nG = rlo.b.g(paramArrayList, paramArrayList1);
  }
  
  public void a(rlo.a parama)
  {
    this.a = parama;
  }
  
  public void a(rlo.b paramb)
  {
  ...
  public ArrayList<String> bw()
  {
    ...
    if (this.nG != null)
    {
      ...
      {
        rlo.b localb = (rlo.b)this.nG.get(i);
  ...
  {
    rlo.b localb = (rlo.b)getItem(paramInt);
    ...
    if (paramView != null)
    {
      ...
      label69:
      ((TextView)localqyd.get(2131368211)).setText(localTroopInfo.getTroopName());
  ...
  {
    public abstract boolean a(ArrayList<String> paramArrayList, rlo.b paramb);
