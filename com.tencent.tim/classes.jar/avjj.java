...
{
  private static final Map<String, List<Field>> pX = new HashMap();
  
  public static boolean B(Activity paramActivity)
  {
    if (!aqfo.isExistSDCard())
    {
      z(paramActivity, 2131695442, 1);
      return false;
    }
    if (aqfo.getSDCardAvailableSize() < 500L)
    {
      z(paramActivity, 2131695441, 1);
      return false;
    }
    return true;
  }
  ...
  public static boolean X(ChatMessage paramChatMessage)
  {
  ...
  public static boolean Y(ChatMessage paramChatMessage)
  {
    if (paramChatMessage == null) {
      return false;
    }
  ...
  public static ContentValues a(byte[] paramArrayOfByte)
  {
    ...
    {
      return null;
      if (bytes2Long(paramArrayOfByte, 8) == 3L) {
        break;
      }
  ...
  public static ansu a(StructMsgForImageShare paramStructMsgForImageShare)
  {
    if (paramStructMsgForImageShare.getItemCount() > 0)
    {
      paramStructMsgForImageShare = paramStructMsgForImageShare.getItemByIndex(0);
      if ((paramStructMsgForImageShare instanceof anug))
      {
        paramStructMsgForImageShare = (anug)paramStructMsgForImageShare;
        if ((paramStructMsgForImageShare.rz.size() > 0) && ((paramStructMsgForImageShare.rz.get(0) instanceof ansu))) {
          return (ansu)paramStructMsgForImageShare.rz.get(0);
        }
      }
    }
    return null;
  ...
  public static avjf.a a(byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length <= 16)) {
      return null;
    }
    if (bytes2Long(paramArrayOfByte, 8) != 1L) {
      return null;
    }
    ...
    if ((localObject2 instanceof ChatMessage))
    {
      if ((localObject2 instanceof MessageForStructing))
      {
        ...
        {
          localObject1 = anre.a((byte[])localObject1);
          ((MessageForStructing)localObject2).structingMsg = ((AbsStructMsg)localObject1);
        }
        return new avjf.a((ChatMessage)localObject2, paramArrayOfByte);
      }
      return new avjf.a((ChatMessage)localObject2, paramArrayOfByte);
    }
    return null;
  ...
  public static AbsStructMsg a(List<byte[]> paramList)
  {
    ...
    {
      AbsStructMsg localAbsStructMsg = b((byte[])paramList.next());
  ...
  private static List<Field> a(Entity paramEntity)
  {
    ...
    Object localObject1 = (List)pX.get(localClass);
    ...
    if (localObject1 == null)
    {
      ...
      pX.put(localClass.getName(), paramEntity);
    }
    return paramEntity;
  }
  ...
  public static void a(long paramLong, List<avjf> paramList1, List<avjf> paramList2)
  {
    ...
    for (;;)
    {
      ...
      {
        avjf localavjf = (avjf)paramList1.next();
        if (localavjf.mSeq == paramLong) {
          paramList2.add(localavjf);
        }
      }
    }
  }
  ...
  {
    return b(paramLong1, 5L, d(paramLong2));
  }
  
  private static byte[] a(long paramLong1, long paramLong2, Parcelable paramParcelable)
  {
    if (paramParcelable == null) {
      return b(paramLong1, paramLong2, (byte[])null);
    }
    Parcel localParcel = Parcel.obtain();
    paramParcelable.writeToParcel(localParcel, 0);
    paramParcelable = localParcel.marshall();
    localParcel.recycle();
    return b(paramLong1, paramLong2, paramParcelable);
  }
  ...
  public static byte[] a(long paramLong, AbsStructMsg paramAbsStructMsg)
  {
    ...
    return b(paramLong, 2L, paramAbsStructMsg.getBytes());
  }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = wvy.a(paramQQAppInterface, paramChatMessage);
    }
  ...
  public static String[] a(byte[] paramArrayOfByte)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: invokestatic 691	javax/xml/parsers/DocumentBuilderFactory:newInstance	()Ljavax/xml/parsers/DocumentBuilderFactory;
    //   6: astore 5
    //   8: aload 5
    //   10: invokevirtual 695	javax/xml/parsers/DocumentBuilderFactory:newDocumentBuilder	()Ljavax/xml/parsers/DocumentBuilder;
    //   13: new 697	java/io/ByteArrayInputStream
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 700	java/io/ByteArrayInputStream:<init>	([B)V
    //   21: invokevirtual 706	javax/xml/parsers/DocumentBuilder:parse	(Ljava/io/InputStream;)Lorg/w3c/dom/Document;
    //   24: invokeinterface 712 1 0
    //   29: astore 5
    //   31: aload 4
    //   33: astore_0
    //   34: aconst_null
    //   35: invokestatic 657	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   38: ifeq +14 -> 52
    //   41: aload 5
    //   43: ldc_w 714
    //   46: invokeinterface 719 2 0
    //   51: astore_0
    //   52: aload 5
    //   54: invokeinterface 720 1 0
    //   59: astore 26
    //   61: aload 26
    //   63: invokeinterface 514 1 0
    //   68: istore_3
    //   69: iconst_0
    //   70: istore_1
    //   71: aconst_null
    ...
    //   254: aload 28
    //   256: ldc_w 724
    //   259: invokevirtual 727	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   262: ifeq +1246 -> 1508
    //   265: aload 4
    //   267: astore 16
    //   269: aload 5
    ...
    //   507: astore 21
    //   509: aload 9
    //   511: invokeinterface 723 1 0
    //   516: ldc_w 729
    //   519: invokevirtual 727	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   522: ifeq +160 -> 682
    //   525: aload 4
    //   527: astore 16
    //   529: aload 5
    ...
    //   587: astore 25
    //   589: aload 5
    //   591: invokestatic 657	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   594: ifeq +1463 -> 2057
    //   597: aload 4
    //   599: astore 16
    //   601: aload 5
    ...
    //   643: astore 21
    //   645: aload 9
    //   647: invokeinterface 733 1 0
    //   652: ldc_w 735
    //   655: invokeinterface 741 2 0
    //   660: invokeinterface 505 1 0
    //   665: astore 22
    //   667: aload 4
    //   669: astore 23
    //   671: aload 6
    ...
    //   728: astore 21
    //   730: aload 9
    //   732: invokeinterface 723 1 0
    //   737: ldc_w 743
    //   740: invokevirtual 727	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   743: ifeq +145 -> 888
    //   746: aload 4
    //   748: astore 16
    //   750: aload 5
    ...
    //   808: astore 25
    //   810: aload 7
    //   812: invokestatic 657	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   815: ifeq +1242 -> 2057
    //   818: aload 4
    //   820: astore 16
    //   822: aload 5
    ...
    //   864: astore 21
    //   866: aload 9
    //   868: invokestatic 745	avjj:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   871: astore 25
    //   873: aload 4
    //   875: astore 23
    //   877: aload 5
    ...
    //   934: astore 21
    //   936: aload 9
    //   938: invokeinterface 723 1 0
    //   943: ldc_w 747
    //   946: invokevirtual 727	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   949: ifeq +145 -> 1094
    //   952: aload 4
    //   954: astore 16
    //   956: aload 5
    ...
    //   1014: astore 25
    //   1016: aload 6
    //   1018: invokestatic 657	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1021: ifeq +1036 -> 2057
    //   1024: aload 4
    //   1026: astore 16
    //   1028: aload 5
    ...
    //   1070: astore 21
    //   1072: aload 9
    //   1074: invokestatic 745	avjj:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   1077: astore 24
    //   1079: aload 4
    //   1081: astore 23
    //   1083: aload 5
    ...
    //   1156: astore 25
    //   1158: aload 9
    //   1160: invokeinterface 723 1 0
    //   1165: ldc_w 749
    //   1168: invokevirtual 727	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1171: ifeq +886 -> 2057
    //   1174: aload 4
    //   1176: astore 16
    //   1178: aload 5
    ...
    //   1281: astore 21
    //   1283: aload 5
    //   1285: invokestatic 657	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1288: ifeq +68 -> 1356
    //   1291: aload 4
    //   1293: astore 16
    //   1295: aload 5
    ...
    //   1339: aload 28
    //   1341: ldc_w 735
    //   1344: invokeinterface 741 2 0
    //   1349: invokeinterface 505 1 0
    //   1354: astore 9
    //   1356: aload 4
    //   1358: astore 16
    //   1360: aload 9
    ...
    //   1418: astore 25
    //   1420: aload 4
    //   1422: invokestatic 657	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1425: ifeq +632 -> 2057
    //   1428: aload 4
    //   1430: astore 16
    //   1432: aload 9
    ...
    //   1476: aload 28
    //   1478: ldc_w 751
    //   1481: invokeinterface 741 2 0
    //   1486: invokeinterface 505 1 0
    //   1491: astore 23
    //   1493: aload 9
    //   1495: astore 22
    //   1497: aload 6
    ...
    //   1576: aload 28
    //   1578: ldc_w 753
    //   1581: invokevirtual 727	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1584: ifeq +165 -> 1749
    //   1587: aload 4
    //   1589: astore 22
    //   1591: aload 5
    ...
    //   1653: astore 21
    //   1655: aload 8
    //   1657: invokestatic 657	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1660: ifeq +89 -> 1749
    //   1663: aload 4
    //   1665: astore 16
    //   1667: aload 5
    ...
    //   1709: astore 21
    //   1711: aload 27
    //   1713: invokeinterface 733 1 0
    //   1718: ldc_w 755
    //   1721: invokeinterface 741 2 0
    //   1726: invokeinterface 505 1 0
    //   1731: astore 25
    //   1733: aload 7
    //   1735: astore 9
    //   1737: aload 6
    ...
    //   1781: astore_0
    //   1782: bipush 6
    //   1784: anewarray 238	java/lang/String
    //   1787: dup
    //   1788: iconst_0
    //   1789: aload 7
    //   1791: aastore
    ...
    //   1834: astore 7
    //   1836: aload 9
    //   1838: invokevirtual 756	javax/xml/parsers/ParserConfigurationException:printStackTrace	()V
    //   1841: aload 6
    //   1843: astore 9
    //   1845: goto -63 -> 1782
    //   1848: astore 9
    ...
    //   1865: astore 7
    //   1867: aload 9
    //   1869: invokevirtual 757	org/xml/sax/SAXException:printStackTrace	()V
    //   1872: aload 6
    //   1874: astore 9
    //   1876: goto -94 -> 1782
    //   1879: astore 9
    ...
    //   1896: astore 7
    //   1898: aload 9
    //   1900: invokevirtual 758	java/io/IOException:printStackTrace	()V
    //   1903: aload 6
    //   1905: astore 9
    //   1907: goto -125 -> 1782
    //   1910: astore 9
  ...
  public static void aS(Context paramContext, String paramString, int paramInt)
  {
    ...
    paramInt = paramContext.getResources().getDimensionPixelSize(2131299627) - (int)aqho.convertDpToPixel(paramContext, 5.0F);
  ...
  private static void ab(FileManagerEntity paramFileManagerEntity)
  {
    ...
    a(ahav.b(paramFileManagerEntity), paramFileManagerEntity.busId, paramFileManagerEntity.Uuid, paramFileManagerEntity.strTroopFilePath, paramFileManagerEntity.WeiYunDirKey, paramFileManagerEntity.WeiYunFileId, paramFileManagerEntity.fileName, paramFileManagerEntity.fileSize, paramFileManagerEntity.strFileMd5, paramFileManagerEntity.getFilePath());
  }
  
  public static AbsStructMsg b(byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length <= 16)) {}
    do
    {
      return null;
      if (bytes2Long(paramArrayOfByte, 8) == 2L) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("qqfav", 2, "unParcelStructMsg, is not structMsg");
    ...
    return anre.a(arrayOfByte);
  }
  
  public static Map<String, String> b(byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length <= 16)) {
      return null;
    }
    if (bytes2Long(paramArrayOfByte, 8) != 4L)
    {
      if (QLog.isColorLevel()) {
        QLog.d("qqfav", 2, "unParcelStructMsg, is not structMsg");
      }
  ...
  private static void b(MessageForFile paramMessageForFile)
  {
    ...
    e(paramMessageForFile.fileName, paramMessageForFile.filePath, paramMessageForFile.fileSize, paramMessageForFile.extStr);
  }
  
  private static byte[] b(long paramLong1, long paramLong2, byte[] paramArrayOfByte)
  {
    int i;
    if (paramArrayOfByte != null) {
    ...
    for (;;)
    {
      ...
      System.arraycopy(d(paramLong1), 0, arrayOfByte, 0, 8);
      System.arraycopy(d(paramLong2), 0, arrayOfByte, 8, 8);
  ...
  public static byte[] b(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    {
      localaviz = new aviz(3);
      if (!(paramChatMessage instanceof MessageForFile)) {
        break label237;
      }
      b((MessageForFile)paramChatMessage);
      ...
      localObject = wvy.a(paramQQAppInterface, paramChatMessage);
      ab((FileManagerEntity)localObject);
      if (localObject == null) {
        break label219;
      }
      localaviz.a(paramQQAppInterface, null, (FileManagerEntity)localObject, paramChatMessage, true);
    }
    for (;;)
    {
      paramQQAppInterface = new ContentValues();
      localObject = (ContentValues)localaviz.F().getExtras().getParcelable("fileContents");
      if (localObject != null) {
        paramQQAppInterface.put("fileContents", a((ContentValues)localObject));
      }
      localObject = top.g(paramChatMessage);
      ...
      localObject = ahav.a(paramQQAppInterface, (MessageForFile)paramChatMessage);
      break;
      label219:
      label483:
      if (QLog.isColorLevel())
      {
        ...
        if ((paramChatMessage instanceof MessageForTroopFile))
        {
          ...
          {
            ab((FileManagerEntity)localObject);
            wvy.a((FileManagerEntity)localObject, localMessageForTroopFile);
            if (localObject == null) {
              break label483;
            }
            localaviz.a(paramQQAppInterface, null, (FileManagerEntity)localObject, localMessageForTroopFile, true);
            break;
            if (QLog.isColorLevel()) {
              QLog.d("qqfav", 2, "parcelFileMsg, isMultiMsg T, find in db");
            }
            localObject = apsv.a(paramQQAppInterface, localMessageForTroopFile);
            if (localObject != null)
            {
              FileManagerEntity localFileManagerEntity = wvy.a((apcy)localObject);
              localObject = apsf.a(paramQQAppInterface, ((apcy)localObject).TroopUin);
              if ((localObject != null) && (localFileManagerEntity != null) && (!TextUtils.isEmpty(localFileManagerEntity.strTroopFilePath)))
              {
                apbr localapbr = ((apsf)localObject).a(localFileManagerEntity.strTroopFilePath);
                localObject = localFileManagerEntity;
                if (localapbr != null)
                {
                  localFileManagerEntity.lastTime = localapbr.dTh;
                  localFileManagerEntity.selfUin = String.valueOf(localapbr.aqT);
                  localObject = localFileManagerEntity;
                }
              }
              else
  ...
  public static List<avjf> by(List<byte[]> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return null;
    }
    ...
    while (paramList.hasNext())
    {
      ...
      long l1 = bytes2Long((byte[])localObject, 8);
      if (l1 != 2L)
      {
        long l2;
        if (l1 == 1L)
        {
          l2 = bytes2Long((byte[])localObject, 0);
          localObject = a((byte[])localObject);
          if (localObject != null) {
            localArrayList.add(new avjf(l2, l1, ((avjf.a)localObject).mMessage, ((avjf.a)localObject).mNickName));
        ...
        else if (l1 == 3L)
        {
          ...
          localObject = a((byte[])localObject);
          if (localObject != null) {
            localArrayList.add(new avjf(l2, l1, (ContentValues)localObject));
          }
        }
      }
    }
  ...
  private static long bytes2Long(byte[] paramArrayOfByte, int paramInt)
  {
    long l = 0L;
    int i = 0;
    while (i < 8)
  ...
  private static void d(MessageForTroopFile paramMessageForTroopFile)
  {
    ...
    e(paramMessageForTroopFile.fileName, paramMessageForTroopFile.uuid, paramMessageForTroopFile.fileSize, paramMessageForTroopFile.extStr);
  }
  
  private static byte[] d(long paramLong)
  {
  ...
  private static void e(String paramString1, String paramString2, long paramLong, String paramString3)
  {
    if (QLog.isColorLevel()) {
  ...
  public static long g(List<byte[]> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return -1L;
    }
  ...
  public static long g(byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length <= 16)) {}
    while (bytes2Long(paramArrayOfByte, 8) != 5L) {
      return -1L;
    }
    return bytes2Long(paramArrayOfByte, 16);
  }
  
  public static Map<String, String> g(List<byte[]> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return null;
    }
    ...
    while (paramList.hasNext())
    {
      Map localMap = b((byte[])paramList.next());
      if (localMap != null) {
        return localMap;
      }
    }
  ...
  public static int lk(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  public static void z(Context paramContext, int paramInt1, int paramInt2)
  {
    QQToast localQQToast = QQToast.a(paramContext, paramInt2, paramInt1, 2000);
    paramInt1 = paramContext.getResources().getDimensionPixelSize(2131299627) - (int)aqho.convertDpToPixel(paramContext, 5.0F);
    paramContext = Looper.getMainLooper();
    if (Thread.currentThread() != paramContext.getThread())
    {
