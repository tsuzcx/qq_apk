...
public class afdd
{
  ...
  {
    paramMessageForYanZhi = paramQQAppInterface.b().d(paramMessageForYanZhi.senderuin, paramMessageForYanZhi.istroop);
    if (paramMessageForYanZhi != null) {
      paramQQAppInterface.b().t(paramMessageForYanZhi.senderuin, paramMessageForYanZhi.istroop, paramMessageForYanZhi.uniseq);
    }
  }
  
  public static MessageRecord b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, MsgInfo paramMsgInfo)
  {
    if (paramArrayOfByte != null)
    {
      try
      {
        ...
        paramArrayOfByte = (MessageForYanZhi)anbi.d(-2070);
        ...
        paramArrayOfByte.msg = (localMsgBody.uint32_like_count.get() + BaseApplicationImpl.getContext().getString(2131696063));
        ...
        paramArrayOfByte.frienduin = acbn.bkE;
        paramArrayOfByte.senderuin = acbn.blm;
  ...
  public static MessageRecord b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, msg_comm.Msg paramMsg)
  {
    if (paramArrayOfByte != null)
    {
      try
  ...
  public static String e(AppInterface paramAppInterface)
  {
    paramAppInterface = (String)ajrb.c(paramAppInterface.getCurrentAccountUin(), "key_banner_enter_items", "");
    try
    {
