  ...
  extends RemoteCommand
{
  ...
  public avcj(String paramString, boolean paramBoolean)
  {
    super(paramString);
  ...
  public static Bitmap a(String paramString, Resources paramResources, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    catch (OutOfMemoryError paramString)
    {
      ...
      if (paramBoolean)
      {
        ...
        paramResources = aqcu.decodeResource(paramResources, 2130844383);
  ...
  private Bundle a(Bundle paramBundle1, Bundle paramBundle2, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    for (Bundle localBundle = new Bundle();; localBundle = paramBundle2)
    {
      ...
      if (!TextUtils.isEmpty(paramBundle2))
      {
        ...
        if (!TextUtils.isEmpty(paramBundle2))
        {
          localObject1 = apzg.a(paramBundle2, BaseApplicationImpl.getContext().getResources(), i, j, bool1);
          if (localObject1 != null) {
            localBundle.putString("path", rwt.a(BaseApplicationImpl.getContext(), paramBundle2.hashCode() + "", (Bitmap)localObject1));
          }
        }
      }
      if (QLog.isColorLevel())
      {
        ...
        paramBundle1 = paramBundle2.append(paramBundle1).append(";mIsSynchronized=").append(this.dmc).append("; linstener is null=");
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        {
          SosoInterface.a(new avck(this, 3, true, true, 300000L, false, false, "buscardLocation", localBundle, paramOnInvokeFinishLinstener));
          break;
        }
        Object localObject2;
        if (paramBundle2.equals("publicAccount"))
        {
          ...
          for (paramBundle2 = (Bundle)localObject1;; paramBundle2 = "null")
          {
            ...
            ocp.a(getAppInterface(), getAppInterface().getApp(), (String)localObject1, new avcl(this, localBundle, paramOnInvokeFinishLinstener));
            break;
          }
        }
        ...
        else
        {
          ...
          if (getAppInterface() != null)
          {
            ...
            if (!TextUtils.isEmpty(paramBundle2))
            {
              localObject2 = (acja)getAppInterface().getManager(56);
              if (localObject2 != null) {
                bool1 = ((acja)localObject2).f(Long.valueOf(paramBundle2));
              }
              bool2 = bool1;
              if (QLog.isColorLevel())
              {
  ...
  public static void register()
  {
    ...
    if ((localPluginCommunicationHandler != null) && (!localPluginCommunicationHandler.containsCmd("com.tencent.nfc.buscard.remotecommand"))) {
      localPluginCommunicationHandler.register(new avcj("com.tencent.nfc.buscard.remotecommand", true));
    }
    if ((localPluginCommunicationHandler != null) && (!localPluginCommunicationHandler.containsCmd("com.tencent.nfc.buscard.remotecommand.async"))) {
      localPluginCommunicationHandler.register(new avcj("com.tencent.nfc.buscard.remotecommand.async", false));
    }
  }
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    try
    {
      if ((!this.dmc) && (Thread.currentThread() != Looper.getMainLooper().getThread()))
      {
