...
public class afsb
{
  ...
  public static int cTI = 2;
  public static int cTJ = 3;
  public static int cTK = 4;
  ...
  private static Intent a(Activity paramActivity, AppInterface paramAppInterface, int paramInt)
  {
    ...
    paramAppInterface = b(ec(paramInt), paramAppInterface);
  ...
  private static String b(String paramString, AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      ...
      if (paramAppInterface != null)
      {
        paramAppInterface = (ajdo)paramAppInterface.getManager(11);
        if (paramAppInterface != null)
        {
  ...
  private static String ec(int paramInt)
  {
    String str = afsf.a().uA();
    Object localObject;
  ...
  public static void f(Activity paramActivity, String paramString1, String paramString2, int paramInt)
  {
    boolean bool = true;
    if (paramActivity == null)
    {
