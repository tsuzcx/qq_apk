...
public class qec
{
  ...
  protected static boolean ac(Context paramContext)
  {
    List localList = ((ActivityManager)paramContext.getSystemService("activity")).getRunningTasks(1);
    if (localList == null) {
      return false;
    }
    return j(paramContext).contains(((ActivityManager.RunningTaskInfo)localList.get(0)).topActivity.getPackageName());
  }
  
  protected static List<String> j(Context paramContext)
  {
