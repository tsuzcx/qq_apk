  ...
  implements IJSApiAdapter
{
  ...
  private static void jumpUrl(Context paramContext, String paramString, Bundle paramBundle)
  {
      ...
      for (;;)
      {
        ...
        if ("getCache".equals(paramString))
        {
          try
          {
            ...
            msg.a().a(paramJSONObject.getString("url"), paramJSONObject.toString(), new nuc.a(paramOnInovkeCallback));
            return;
          }
          catch (JSONException paramString)
          {
            paramOnInovkeCallback.callback(h(paramString.getMessage()));
          }
        ...
        else if ("writeCache".equals(paramString))
        {
          try
          {
            ...
            {
              paramJSONObject.put("callid", 0);
              msg.a().a(paramJSONObject.getString("url"), paramJSONObject.toString(), null, paramJSONObject);
              return;
            }
          }
          catch (JSONException paramString)
    ...
    implements msg.a
  {
    ...
    public a(IJSApiAdapter.OnInovkeCallback paramOnInovkeCallback)
    {
      this.a = paramOnInovkeCallback;
    }
    
    public void ac(JSONObject paramJSONObject)
    {
      if (this.a != null) {
