...
{
  public ailm(UiApiPlugin paramUiApiPlugin) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if (paramInt == 0)
      {
        ...
        paramBundle = TroopInfoActivity.c(String.valueOf(ByteBuffer.wrap(arrayOfByte).getInt() + ""), 32);
        apuh.a(this.this$0.getCurrentContext(), paramBundle, -1);
      }
      return;
    }
