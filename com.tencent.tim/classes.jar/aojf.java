  ...
  extends aoiz
{
    ...
    throws Exception
  {
    ...
    do
    {
      ...
      localObject2 = acbn.SDCARD_PATH + "avatarPendantDefaultHead" + str;
    ...
    for (;;)
    {
      for (;;)
      {
        if (localObject1 != null)
        {
          ...
          try
          {
            new aolf().a((OutputStream)localObject2, paramDownloadParams, paramURLDrawableHandler);
            ...
            paramOutputStream = new File(acbn.bmK + str);
            if (!paramOutputStream.exists()) {
              paramOutputStream.mkdir();
            }
            long l = Long.valueOf(str.split("/")[1]).longValue();
            localObject1 = aqgm.m(l, 5);
            localObject2 = new File((String)localObject1);
            paramOutputStream = (OutputStream)localObject2;
            if (((File)localObject2).exists()) {
              break;
            }
            localObject2 = aqgm.n(l, 5);
            paramOutputStream = (OutputStream)localObject1;
