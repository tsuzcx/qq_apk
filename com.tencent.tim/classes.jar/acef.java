...
public class acef
  extends acdd<CustomEmotionData>
{
  public acef(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (i < paramList2.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localObject2 = new afib((String)localObject1);
          if ((!((afib)localObject2).ajo()) || (TextUtils.isEmpty(((afib)localObject2).flag)) || (TextUtils.isEmpty(((afib)localObject2).md5)))
          {
      ...
      if (i < paramList1.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localafib1 = new afib((String)localObject2);
          if ((!localafib1.ajo()) || (TextUtils.isEmpty(localafib1.flag)) || (TextUtils.isEmpty(localafib1.md5)))
          {
            if (QLog.isColorLevel()) {
            ...
            ((List)localObject1).add(localafib1);
          }
        }
      }
      ...
      {
        localafib1 = (afib)localArrayList.get(i);
        int j = 0;
        while (j < ((List)localObject1).size())
        {
          afib localafib2 = (afib)((List)localObject1).get(j);
          if ((localafib1.flag.equals(localafib2.flag)) && (localafib2.flag.equals("0")) && (localafib2.md5.equals(localafib1.md5)))
          {
            paramList1.remove(localafib2.resid);
            ((StringBuilder)localObject2).append(localafib2.resid).append(", ");
          }
          j += 1;
        }
        i += 1;
  ...
  public void Q(List<CustomEmotionData> paramList, int paramInt)
  {
    int j = 0;
    ...
    for (;;)
    {
      try
      {
        ...
        localReqBody.string_version.set("3.4.4");
  ...
  public void a(CustomEmotionData paramCustomEmotionData, String paramString)
  {
    ...
    if ((this.app == null) || (this.app.getApp() == null))
    {
      ...
      notifyUI(3, false, this.mApp.getApplication().getString(2131693110));
      return;
    }
    if (!aqiw.isNetworkAvailable())
    {
      notifyUI(3, false, this.app.getApp().getString(2131695432));
      return;
    }
    try
    {
      ...
      ((FavEmotionOcr.ReqBody)localObject1).string_version.set("3.4.4");
  ...
  public void a(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        anpc.a(BaseApplication.getContext()).collectPerformance(null, "favEmoModifyOcrsSuc", false, 0L, 0L, (HashMap)localObject, null);
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          ...
          if (i < paramFromServiceMsg.size())
          {
            ...
            {
              paramObject = ((afhu)this.app.getManager(149)).ez();
              if (paramObject != null)
              {
            ...
            {
              notifyUI(3, false, this.mApp.getApplication().getString(2131693116));
              if (QLog.isColorLevel()) {
  ...
  public void a(FromServiceMsg paramFromServiceMsg, Object paramObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        anpc.a(BaseApplication.getContext()).collectPerformance(null, "favEmoGetOcrSuc", false, 0L, 0L, (HashMap)localObject1, null);
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          paramFromServiceMsg = new FavEmotionOcr.RspBody();
          paramFromServiceMsg.mergeFrom(paramObject.bytes_bodybuffer.get().toByteArray());
          ...
          paramObject = (afhu)this.app.getManager(149);
          localObject1 = paramObject.ez();
  ...
  public void ai(List<String> paramList, boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("FavEmoRoamingHandler", 2, "delUserEmoRoamingReq, delList size = " + paramList.size());
    }
    ...
    localPlatInfo.mqqver.set("8.3.6");
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("FavEmoRoamingHandler", 2, "queryUserEmoRoamingReq");
    }
  ...
  public void e(Object paramObject, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((afhu)this.app.getManager(149)).kg(localArrayList);
  ...
  public void iI(List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0)) {}
    try
    {
  ...
  public void iJ(List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        afib localafib = new afib((String)paramList.next());
        if (!TextUtils.isEmpty(localafib.md5)) {
          localArrayList.add(localafib.md5);
        }
      }
      if (localArrayList.size() > 0) {
        ((afim)this.app.getManager(141)).kn(localArrayList);
      }
    }
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      if (i == 1)
      {
        paramToServiceMsg = (afhv)this.mApp.getManager(72);
        if (paramToServiceMsg != null) {
          paramToServiceMsg.cYY();
        }
      }
    ...
    do
    {
      ...
      case 1: 
        ...
        return;
      case 2: 
        e(paramObject, paramToServiceMsg.extraData.getBoolean("needSync"));
        return;
      case 3: 
        if (QLog.isColorLevel()) {
