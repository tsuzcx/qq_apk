...
public class ajpm
{
  ...
  public static void D(QQAppInterface paramQQAppInterface, int paramInt)
  {
    for (;;)
    {
      try
      {
        ...
        paramQQAppInterface.nY(56);
        paramQQAppInterface.nY(61);
        return;
      }
      ...
      paramQQAppInterface.nY(paramInt);
      return;
      label102:
      if (paramInt != 60) {
        if (paramInt != 57) {}
  ...
  public static boolean j(AppInterface paramAppInterface)
  {
    boolean bool2 = false;
    paramAppInterface = (String)ajrb.c(paramAppInterface.getAccount(), "key_tabs_array", "");
    for (;;)
    {
      try
      {
  ...
  public static boolean k(AppInterface paramAppInterface)
  {
    int i = 0;
    paramAppInterface = (String)ajrb.c(paramAppInterface.getAccount(), "key_tabs_array", "");
    try
  ...
  public static boolean m(QQAppInterface paramQQAppInterface, int paramInt)
  {
  ...
  public DatingConfig a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 198	ajpm:a	Lcom/tencent/mobileqq/data/DatingConfig;
    //   6: ifnull +12 -> 18
    //   9: aload_0
    //   10: getfield 198	ajpm:a	Lcom/tencent/mobileqq/data/DatingConfig;
    //   13: astore_1
    //   14: aload_0
    //   15: monitorexit
    //   16: aload_1
    ...
    //   19: astore_2
    //   20: iconst_1
    //   21: anewarray 200	java/lang/Class
    //   24: astore_3
    //   25: aload_3
    //   26: iconst_0
    //   27: ldc 4
    ...
    //   30: ldc 202
    //   32: aload_3
    //   33: invokestatic 207	aqhq:a	(Ljava/lang/String;[Ljava/lang/Class;)[Ljava/lang/Object;
    //   36: astore 4
    //   38: aload_2
    //   39: astore_1
    //   40: aload 4
    ...
    //   57: iconst_0
    //   58: aaload
    //   59: checkcast 209	com/tencent/mobileqq/data/DatingConfig
    //   62: astore_1
    //   63: aload_0
    //   64: aload_1
    //   65: putfield 198	ajpm:a	Lcom/tencent/mobileqq/data/DatingConfig;
    //   68: goto -54 -> 14
    //   71: astore_1
    //   72: aload_0
    //   73: monitorexit
  ...
  public void dyF()
  {
    ...
    //   14: aload_0
    //   15: aconst_null
    //   16: putfield 198	ajpm:a	Lcom/tencent/mobileqq/data/DatingConfig;
    //   19: goto -8 -> 11
    //   22: astore_1
    //   23: aload_0
    //   24: monitorexit
