  ...
  implements avjv.a
{
  public boolean f(int paramInt, Bundle paramBundle)
  {
    ...
    case 1: 
      ...
      aglz.a().z(paramBundle, (Bundle)localObject2);
      return true;
    case 2: 
      ...
      ((QQAppInterface)localObject1).a().a(new aglu(paramBundle));
    ...
    case 4: 
      ...
      paramBundle.putString("configInfo", agmx.w(((QQAppInterface)localObject1).getApp().getBaseContext(), str));
      return true;
    }
    paramBundle.putBoolean("isVideoChatting", ((QQAppInterface)localObject1).bF());
    return true;
  }
}
