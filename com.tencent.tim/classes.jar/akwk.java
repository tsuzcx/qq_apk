...
public class akwk
  extends accg
{
  public akwk(QQAppInterface paramQQAppInterface)
  {
  ...
  private void kL(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      paramToServiceMsg.mResult = i;
      if (i != 0) {
        break label241;
      }
      paramToServiceMsg.mEnd = ((cmd0xbf2.RspBody)localObject).uint32_end.get();
      paramToServiceMsg.Dt = ((cmd0xbf2.RspBody)localObject).uint32_next_index.get();
      ...
      if ((paramFromServiceMsg != null) && (!paramFromServiceMsg.isEmpty()))
      {
        ...
        while (paramFromServiceMsg.hasNext())
        {
          ...
          ((NewerGuidePlugin.PhoneInfo)localObject).aGB = paramObject.str_phone.get();
          ((NewerGuidePlugin.PhoneInfo)localObject).aGC = paramObject.str_nick.get();
          ((NewerGuidePlugin.PhoneInfo)localObject).aGD = paramObject.str_long_nick.get();
          ((NewerGuidePlugin.PhoneInfo)localObject).aGE = paramObject.str_head_url.get();
          paramToServiceMsg.pA.add(localObject);
        }
      }
  ...
  public void cF(String paramString, boolean paramBoolean)
  {
    int i = 2;
    if (QLog.isColorLevel()) {
  ...
  public void fv(String paramString, int paramInt)
  {
    if (QLog.isColorLevel()) {
