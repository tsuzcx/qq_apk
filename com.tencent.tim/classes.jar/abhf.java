...
public class abhf
{
  ...
  public abhf(QQAppInterface paramQQAppInterface)
  {
  ...
  public void BC(String paramString)
  {
        ...
        if (!localJSONObject.optBoolean("isGameApp"))
        {
          ...
          if ((BaseActivity.sTopActivity instanceof FragmentActivity))
          {
            ...
            if (localChatFragment != null)
            {
              ...
              {
                i = ((BaseChatPie)localObject1).a().cZ;
                paramString = ((BaseChatPie)localObject1).a().aTl;
              }
          ...
          paramString = (QQAppInterface)this.mAppRef.get();
          if (paramString != null) {
            abmh.b(paramString, str1, i, m, l);
          }
          xxh.bkr = true;
        }
      }
    ...
    if (!aqiz.isAppInstalled(BaseActivity.sTopActivity, (String)localObject2))
    {
    ...
    new anan().a(paramString, BaseActivity.sTopActivity, (String)localObject1, str1, (String)localObject2, j);
  }
