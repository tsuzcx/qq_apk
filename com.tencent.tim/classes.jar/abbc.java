...
public class abbc
  extends Handler
{
  public abbc(QQSpecialFriendSettingActivity paramQQSpecialFriendSettingActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              QQSpecialFriendSettingActivity.a(this.a, new arhz(this.a, this.a.getTitleBarHeight()));
              if ((paramMessage.obj != null) && ((paramMessage.obj instanceof String))) {
                QQSpecialFriendSettingActivity.a(this.a).setMessage((String)paramMessage.obj);
              }
            }
    ...
    QQToast.a(this.a, paramMessage.arg1, paramMessage.arg2, 0).show(this.a.getTitleBarHeight());
  }
}
