  ...
  extends Entity
{
  ...
  public JSONObject toJsonObject()
  {
    try
    {
      ...
      localJSONObject.put("thumbPath", PhotoPlusManager.cKs + getUnzippedDir() + getThumbImageFileName());
      localJSONObject.put("path", PhotoPlusManager.cKs + getUnzippedDir() + getImageFileName());
      localJSONObject.put("version", this.version);
      localJSONObject.put("priority", this.priority);
      localJSONObject.put("type", this.type);
      localJSONObject.put("jsonPath", PhotoPlusManager.cKs + getUnzippedDir() + getJsonFileName());
