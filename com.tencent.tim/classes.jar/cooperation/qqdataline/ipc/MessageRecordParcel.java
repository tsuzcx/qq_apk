...
{
  public static final Parcelable.Creator<MessageRecordParcel> CREATOR = new aviy();
  private MessageRecord mRecord;
  
  public MessageRecordParcel(MessageRecord paramMessageRecord)
  {
    this.mRecord = paramMessageRecord;
  }
  
  private static MessageRecordParcel a(Parcel paramParcel)
  {
  ...
  {
    if ((this.mRecord instanceof DataLineMsgRecord))
    {
      paramParcel.writeString("DataLineMsgRecord");
      localBundle = new Bundle();
      a(localBundle, this.mRecord);
      a(localBundle, (DataLineMsgRecord)this.mRecord);
      paramParcel.writeBundle(localBundle);
    }
    while (!(this.mRecord instanceof MpfileTaskRecord)) {
      return;
    }
    paramParcel.writeString("MpfileTaskRecord");
    Bundle localBundle = new Bundle();
    a(localBundle, this.mRecord);
    a(localBundle, (MpfileTaskRecord)this.mRecord);
    paramParcel.writeBundle(localBundle);
  }
}
