  ...
  implements PluginManagerHelper.OnPluginManagerLoadedListener
{
  ...
  private View.OnClickListener cancelInstallListener = new avrw(this);
  private View.OnClickListener installListener = new avrv(this);
  ...
  private Handler mHandler = new avrt(this);
  ...
  private void cancelInstall()
  {
    ...
    awed.ad(this.account, "vertical_video_entry", "9", null);
  }
  ...
  private void doLaunchVerticalVideo()
  {
    ...
    QzoneVerticalVideoPluginProxyActivity.d(this, this.account, localIntent, -1);
    finish();
  }
  ...
  private int getQzonePluginStatus()
  {
    ...
    if (this.app != null)
    {
      Object localObject = (avfw)this.app.getManager(27);
      if (localObject != null)
      {
        localObject = ((avfw)localObject).b("qzone_plugin.apk");
  ...
  private void installQzonePlugin()
  {
    ...
    if (this.app == null)
    {
      arxa.a().showToast(acfp.m(2131713442));
    ...
    {
      return;
      localavfw = (avfw)this.app.getManager(27);
    } while (localavfw == null);
    localavfw.installPlugin("qzone_plugin.apk", new avrx(this, l));
  }
  ...
  private void launchVerticalVideoLayer()
  {
    if (!this.mDoNotCheckQZonePlugin)
    {
      ...
      if (i != 4)
      {
        ...
        case 4: 
        default: 
          arxa.a().showToast(acfp.m(2131713448));
          finish();
        }
        for (;;)
        {
          ...
          return;
          arxa.a().showToast(acfp.m(2131713446));
          finish();
          continue;
          installQzonePlugin();
        }
    ...
    {
      QQToast.a(this, acfp.m(2131713434), 0).show();
  ...
  private void updateTextProgress(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      this.mBtnAction.setText(acfp.m(2131713435));
      return;
    }
    if (paramBoolean2)
    {
      this.mBtnAction.setText(acfp.m(2131713438));
      return;
    }
    this.progress %= 3;
    ...
    for (;;)
    {
      this.progress += 1;
      return;
      this.mBtnAction.setText(acfp.m(2131713439));
      continue;
      this.mBtnAction.setText(acfp.m(2131713437));
      continue;
      this.mBtnAction.setText(acfp.m(2131713445));
    }
  }
  ...
  public void initUI(int paramInt)
  {
    ...
    ong.reportVideoPlayUpdateExp(this.mSceneType);
    ...
    ((TextView)findViewById(2131381300)).setText(QzoneConfig.getInstance().getConfig("VerticalVideoLayer", "VerticalVideoPluginUpdateTips", "升级插件，体验精彩小视频"));
    ...
    try
    {
      ...
      if (this.mURLDrawable != null)
      {
        ...
        this.mURLDrawable.setURLDrawableListener(new avru(this));
      }
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        continue;
        this.mBtnAction.setText(acfp.m(2131713436));
      }
    }
    this.mBtnClose.setOnClickListener(this.cancelInstallListener);
    if (paramInt == 0)
    {
      this.mBtnAction.setText(acfp.m(2131713447));
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.mDownloadRoot = ((FrameLayout)findViewById(2131366099));
  ...
  public void onHandleMessage(Handler paramHandler, Message paramMessage)
  {
    ...
    arxa.a().showToast(acfp.m(2131713444));
    finish();
  }
  ...
  public void onPluginManagerLoaded(PluginManagerClient paramPluginManagerClient)
  {
    ...
    if (paramPluginManagerClient != null)
    {
      ...
      if ((!TextUtils.isEmpty(this.mBackupUrl)) && (jqc.isValidUrl(this.mBackupUrl)))
      {
    ...
    arxa.a().showToast(acfp.m(2131713440));
    finish();
  }
