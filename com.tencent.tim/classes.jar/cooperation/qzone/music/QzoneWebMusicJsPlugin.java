  ...
  implements avzi
{
  ...
  {
    if (!this.isDestroy) {
      this.mRuntime.getWebView().loadUrl("javascript:try{QQMusicJSInterface.onRecieve({type:\"networktype\",data:{type:\"isUnicomNetwork\",value:" + paramString + "}})}catch(e){}");
    }
  }
  ...
  private void callWebPageInterface(String paramString)
  {
    if ((this.isWebPageListening) && (!this.isDestroy)) {
      this.mRuntime.getWebView().loadUrl("javascript:try{QQMusicJSInterface.onRecieve({type:\"WEBAPP_MUSIC\",data:{type:\"" + paramString + "\"}})}catch(e){}");
    }
  }
  ...
  private void callWebPageInterfaceImpl(String paramString, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      localJSONObject.put("name", localSongInfo.title);
      localJSONObject.put("singer", localSongInfo.singer);
      localJSONObject.put("songId", localSongInfo.id);
      localJSONObject.put("songMid", localSongInfo.album);
      localJSONObject.put("singerId", localSongInfo.singerId);
      localJSONObject.put("type", localSongInfo.type);
      localJSONObject.put("cover", localSongInfo.coverUrl);
      localJSONObject.put("ownerUin", localSongInfo.uin);
      localJSONObject.put("playUrl", localSongInfo.url);
      localJSONObject.put("detailUrl", localSongInfo.detailUrl);
      if (!TextUtils.isEmpty(localSongInfo.summary)) {
        localJSONObject.put("showId", localSongInfo.summary);
      }
      switch (localSongInfo.type)
      {
      }
    }
    ...
    for (;;)
    {
      ...
      if (!this.isDestroy) {
        this.mRuntime.getWebView().loadUrl("javascript:try{QQMusicJSInterface.onRecieve({type:\"WEBAPP_MUSIC\",data:{type:\"" + paramString + "\",value:" + localJSONObject.toString() + "}})}catch(e){}");
      }
      return;
  ...
  private void doPlayMusicOrAudioCommon(a parama)
  {
    Activity localActivity = this.mRuntime.getActivity();
    if ((localActivity != null) && (needPlayTips()))
    {
      showPlayTips(localActivity, new avvx(this, parama), new avvz(this));
  ...
  private long getCurrentHostUin()
  {
    ...
    try
    {
      String str1 = this.mRuntime.getWebView().getUrl();
      localObject = str1;
  ...
  {
    paramContext = aqha.a(paramContext, 230, null, acfp.m(2131713547), acfp.m(2131713542), acfp.m(2131713544), paramOnClickListener2, paramOnClickListener1);
  ...
  {
    aqha.a(paramContext, 230, acfp.m(2131713548), "你正处于非WiFi环境，继续播放将会消耗流量，运营商可能会收取费用，是否继续\n", acfp.m(2131713543), acfp.m(2131713549), paramOnClickListener2, paramOnClickListener1).show();
  }
  ...
  public void changeMusicList(String paramString)
  {
    try
    {
      aiow.a(new JSONObject(paramString), "changeMusicList", null);
      return;
    }
    catch (JSONException paramString)
    {
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      doPlayMusicOrAudioCommon(new avwb(this, paramVarArgs[0]));
      return true;
    }
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      pausePlay();
      showPlayTips(paramString, new avvv(this), new avvw(this));
      this.isShowing = true;
      return;
  ...
  public void playAudioList(String paramString)
  {
    ...
    //   10: astore 7
    //   12: new 206	org/json/JSONObject
    //   15: dup
    //   16: aload_1
    ...
    //   21: aload_1
    //   22: ldc_w 491
    //   25: invokevirtual 714	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   28: istore_3
    //   29: aload_1
    //   30: ldc_w 778
    //   33: invokevirtual 714	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   36: istore_2
    //   37: aload_1
    //   38: ldc_w 496
    ...
    //   68: invokestatic 781	cooperation/qzone/music/QzoneMusicHelper:convertAudioSongInfo	(Lorg/json/JSONObject;)Lcom/tencent/mobileqq/music/SongInfo;
    ...
    //   88: istore_2
    //   89: aload_1
    //   90: invokevirtual 599	org/json/JSONException:printStackTrace	()V
    //   93: iload_3
    //   94: istore 4
    //   96: iload_2
    //   97: istore 6
    ...
    //   120: istore_2
    //   121: aload_0
    //   122: getfield 146	cooperation/qzone/music/QzoneWebMusicJsPlugin:mRuntime	Lcom/tencent/mobileqq/webview/swift/WebViewPlugin$a;
    //   125: invokevirtual 401	com/tencent/mobileqq/webview/swift/WebViewPlugin$a:a	()Lcom/tencent/common/app/AppInterface;
    //   128: ldc 2
    //   130: invokevirtual 407	com/tencent/common/app/AppInterface:getHandler	(Ljava/lang/Class;)Lmqq/os/MqqHandler;
    //   133: new 783	cooperation/qzone/music/QzoneWebMusicJsPlugin$9
    //   136: dup
    //   137: aload_0
    //   138: iload_2
    //   139: iload 4
    //   141: aload 7
    //   143: invokespecial 784	cooperation/qzone/music/QzoneWebMusicJsPlugin$9:<init>	(Lcooperation/qzone/music/QzoneWebMusicJsPlugin;IILjava/util/ArrayList;)V
    //   146: invokevirtual 414	mqq/os/MqqHandler:post	(Ljava/lang/Runnable;)Z
    //   149: pop
    //   150: return
    //   151: bipush 6
    //   153: istore_2
    //   154: goto -33 -> 121
    //   157: invokestatic 346	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   160: ifeq -10 -> 150
    //   163: aload_0
    //   164: getfield 86	cooperation/qzone/music/QzoneWebMusicJsPlugin:TAG	Ljava/lang/String;
    //   167: iconst_2
    //   168: ldc_w 786
  ...
  public void playMusic(String paramString)
  {
    ...
    try
    {
      ...
      if (localArrayList.size() > 0) {
        if (((SongInfo)localArrayList.get(0)).type == 6)
        {
          i = 6;
        ...
        catch (JSONException paramString)
        {
          try
          {
            ...
            if ((paramString.length() > 0) && (i < paramString.length()) && (paramString.getJSONObject(0).optInt("isProfileMusicBox", 0) == 1))
            {
              ...
              paramString.put("uin", ((SongInfo)localArrayList.get(i)).uin);
              paramString.put("coverUrl", ((SongInfo)localArrayList.get(i)).coverUrl);
              aiow.a(paramString, "showFloatView", null);
            }
            if (localArrayList.size() <= 0) {
              break;
            }
  ...
  public void setPlayMode(String paramString)
  {
    ...
    {
      QQToast.a(BaseApplication.getContext(), 1, QzoneMusicHelper.NO_NETWORK_MSG, 1).show();
      getPlayMode();
      return;
    }
    for (;;)
    {
      ...
      showAutoPlayTips(this.mRuntime.getActivity(), new avvs(this), new avvt(this, i, k, j), new avvu(this));
      return;
      i = 0;
      continue;
      k = 0;
  ...
  public void setRightButton(String paramString)
  {
    try
    {
      ...
      {
        localObject = (TextView)this.mRuntime.getActivity().findViewById(2131369612);
        if (bool) {}
        try
        {
          ...
          ((TextView)localObject).setOnClickListener(new avvq(this));
          return;
        }
        catch (Exception paramString)
        {
