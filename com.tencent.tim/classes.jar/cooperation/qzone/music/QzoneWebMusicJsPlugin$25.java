    ...
    if (QzoneWebMusicJsPlugin.access$500(this.this$0)) {
      for (;;)
      {
        try
        {
          ...
          localJSONObject2.put("detailUrl", localSongInfo.b.detailUrl);
          localJSONObject2.put("broadcastID", localSongInfo.b.broadcastID);
          localJSONObject2.put("broadcastName", localSongInfo.b.broadcastName);
          if (i != 2) {
            continue;
          }
        ...
        catch (Exception localException)
        {
          ...
          continue;
          QzoneWebMusicJsPlugin.access$700().bV(localException);
        }
        ...
        if (!QzoneWebMusicJsPlugin.access$700().cXk) {
          continue;
        }
