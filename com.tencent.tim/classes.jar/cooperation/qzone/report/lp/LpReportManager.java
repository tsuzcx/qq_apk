...
public class LpReportManager
{
  ...
  private void addReportTask(ReportRunner paramReportRunner)
  {
  ...
  private void reportAsync(int paramInt, LpReportInfo paramLpReportInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((Looper.myLooper() != null) && (Looper.myLooper() == Looper.getMainLooper()))
    {
      ...
      {
        addReportTask(new ReportRunner(paramInt, paramLpReportInfo, paramBoolean1, paramBoolean2));
        return;
      }
  ...
  private void runNext()
  {
    ...
    {
      ReportRunner localReportRunner = (ReportRunner)this.mReportRunners.poll();
    ...
    implements Runnable
  {
    ...
    public ReportRunner(int paramInt, LpReportInfo paramLpReportInfo, boolean paramBoolean1, boolean paramBoolean2)
    {
      this.subtype = paramInt;
      this.b = paramLpReportInfo;
    ...
    public void run()
    {
      LpReportManager.this.report(this.subtype, this.b, this.isNeedSample, this.isReportNow);
      LpReportManager localLpReportManager = LpReportManager.this;
