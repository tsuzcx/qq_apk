  ...
  extends LinearLayout
{
  ...
  private void aj(List<ByteStringMicro> paramList, int paramInt)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      if (j < SJ)
      {
        ...
        localObject1 = new LinearLayout.LayoutParams(wja.dp2px(60.0F, getResources()), wja.dp2px(60.0F, getResources()));
        ((LinearLayout.LayoutParams)localObject1).setMargins(0, 0, wja.dp2px(2.0F, getResources()), 0);
    ...
    for (;;)
    {
      ...
      if (j == SJ)
      {
        ...
        addViewInLayout((View)localObject2, j - 1, new LinearLayout.LayoutParams(wja.dp2px(60.0F, getResources()), wja.dp2px(60.0F, getResources())));
  ...
  public void setImages(List<ByteStringMicro> paramList, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      addView((View)localObject1, new LinearLayout.LayoutParams(wja.dp2px(60.0F, getResources()), wja.dp2px(60.0F, getResources())));
    ...
    {
      localObject1 = ((ByteStringMicro)paramList.next()).toStringUtf8();
      k = wja.dp2px(60.0F, getResources());
      if (!URLUtil.isValidUrl((String)localObject1)) {
        break label423;
      }
      j = i + 1;
