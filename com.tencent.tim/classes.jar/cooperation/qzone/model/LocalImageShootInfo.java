...
{
  public static final Parcelable.Creator<LocalImageShootInfo> CREATOR = new avus();
  ...
  public LocalImageShootInfo(Parcel paramParcel)
  {
    ...
    if (paramParcel.readInt() != 0) {
      this.a = new GpsInfo4LocalImage(paramParcel);
    }
  }
  ...
  public static boolean a(LocalImageShootInfo paramLocalImageShootInfo)
  {
    ...
    try
    {
      if (!JpegExifReader.isCrashJpeg(paramLocalImageShootInfo.path))
      {
        ...
        {
          paramLocalImageShootInfo.a = new GpsInfo4LocalImage(arrayOfFloat[0], arrayOfFloat[1]);
          return true;
        }
      }
    }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((this.captureTime == paramObject.captureTime) && (this.a.equals(paramObject))) {}
    for (;;)
    {
      return bool;
      bool = false;
