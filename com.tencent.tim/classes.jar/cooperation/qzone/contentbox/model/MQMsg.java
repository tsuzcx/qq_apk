  ...
  implements Serializable
{
  ...
  private static Map<String, String> c(JSONObject paramJSONObject)
  {
  ...
  private static JSONObject d(Map<String, String> paramMap)
  {
  ...
  public static MQMsg parseFromJson(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      localMQMsg.expand = c(paramJSONObject.optJSONObject("expand"));
  ...
  public JSONObject convertToJson()
  {
    ...
    try
    {
      ...
      localJSONObject.put("expand", d(this.expand));
