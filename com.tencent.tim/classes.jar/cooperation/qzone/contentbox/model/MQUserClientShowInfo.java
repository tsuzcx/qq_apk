  ...
  implements Serializable
{
  ...
  public static MQUserClientShowInfo readFrom(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = (AllInfo)awkh.decodeWup(AllInfo.class, paramArrayOfByte);
    if (paramArrayOfByte != null)
    {
      Object localObject = (UserClientShowInfo)awkh.decodeWup(UserClientShowInfo.class, paramArrayOfByte.vecQQBigVipInfo);
      if (localObject == null) {
        return null;
      }
      ...
      localObject = awne.a(8, (UserClientShowInfo)localObject);
      if (localObject != null)
      {
