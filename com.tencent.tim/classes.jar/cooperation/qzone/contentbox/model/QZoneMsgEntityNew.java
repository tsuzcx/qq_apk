  ...
  implements Serializable
{
  ...
  @notColumn
  public ArrayList<avtr> bottomItems;
  ...
  public static QZoneMsgEntityNew readFrom(QzoneMessageBoxRsp paramQzoneMessageBoxRsp)
  {
    ...
    localQZoneMsgEntityNew.bottomItems = avtr.ar(paramQzoneMessageBoxRsp.bottomVec);
    ...
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          while (i < localJSONArray.length())
          {
            avtr localavtr = avtr.a(localJSONArray.getJSONObject(i));
            if (localavtr != null) {
              this.bottomItems.add(localavtr);
            }
            i += 1;
          }
  ...
  public void writeBottomItemToBuffer()
  {
    ...
    while (localIterator.hasNext())
    {
      avtr localavtr = (avtr)localIterator.next();
      if (localavtr != null) {
        localJSONArray.put(localavtr.convertToJSON());
      }
    }
