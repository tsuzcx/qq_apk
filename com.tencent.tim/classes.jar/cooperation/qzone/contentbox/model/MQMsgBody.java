  ...
  implements Serializable
{
  ...
  private static ArrayList<MQPhotoCell> as(ArrayList<PhotoCell> paramArrayList)
  {
  ...
  private static JSONArray b(ArrayList<String> paramArrayList)
  {
    if ((paramArrayList == null) || (paramArrayList.size() == 0)) {
      return null;
    }
  ...
  private static JSONArray c(ArrayList<MQPhotoCell> paramArrayList)
  {
    if ((paramArrayList == null) || (paramArrayList.size() == 0)) {
      return null;
    }
  ...
  private static ArrayList<String> f(JSONArray paramJSONArray)
  {
  ...
  private static ArrayList<MQPhotoCell> g(JSONArray paramJSONArray)
  {
    if ((paramJSONArray == null) || (paramJSONArray.length() == 0)) {
      return null;
    }
  ...
  public static MQMsgBody parseFromJson(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      localMQMsgBody.photolist = g(paramJSONObject.optJSONArray("photolist"));
      localMQMsgBody.vecUserAvatar = f(paramJSONObject.optJSONArray("vecUserAvatar"));
  ...
  public static MQMsgBody readFrom(MsgBody paramMsgBody)
  {
    ...
    localMQMsgBody.photolist = as(paramMsgBody.vecPhotos);
  ...
  public JSONObject convertToJson()
  {
    ...
    try
    {
      ...
      localJSONObject.put("photolist", c(this.photolist));
      localJSONObject.put("vecUserAvatar", b(this.vecUserAvatar));
