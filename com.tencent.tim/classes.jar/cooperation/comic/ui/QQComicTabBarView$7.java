  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject = (aved)((AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web")).getManager(213);
    ArrayList localArrayList = new ArrayList();
    if (((aved)localObject).nr(1113)) {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localObject = ((aved)localObject).b(localArrayList);
      if (QLog.isColorLevel()) {
