...
public class PatternLockUtils
{
  ...
  public static String patternToString(List<LockPatternView.a> paramList)
  {
    ...
    while (i < j)
    {
      ...
      int k = locala.getRow();
      localStringBuilder.append((char)(locala.getColumn() + k * 3 + 49));
      i += 1;
    }
  ...
  public static List<LockPatternView.a> stringToPattern(String paramString)
  {
    ...
    while (i < paramString.length())
    {
      ...
      localArrayList.add(LockPatternView.a.a(j / 3, j % 3));
      i += 1;
    }
    return localArrayList;
  }
