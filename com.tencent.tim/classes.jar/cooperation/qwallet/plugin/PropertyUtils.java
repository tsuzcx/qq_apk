...
public class PropertyUtils
{
  ...
  public static String getNetworkType(Context paramContext)
  {
    ...
    int i = aqiw.getSystemNetwork(paramContext.getApplicationContext());
    if (i == 1) {
      mNetworkType = "WIFI";
    }
    for (;;)
  ...
  public static int getTitleBarHeight(Activity paramActivity)
  {
    ...
    mTitleBarHeight = paramActivity.getResources().getDimensionPixelSize(2131299627);
    return mTitleBarHeight;
  }
  ...
  public static int getToastOffset(Context paramContext)
  {
    ...
    mToastOffset = paramContext.getResources().getDimensionPixelSize(2131299627) - (int)aqho.convertDpToPixel(paramContext, 5.0F);
    return mToastOffset;
  }
}
