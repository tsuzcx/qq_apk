  ...
  extends BaseReq
{
  ...
  private void onPubAcc()
  {
    ...
    if ((localQQAppInterface != null) && (!TextUtils.isEmpty(this.pubAccUin))) {
      ocp.a(localQQAppInterface, localQQAppInterface.getApp(), this.pubAccUin, null, false);
    }
  }
  ...
  private void onRedpoint()
  {
    ...
    if (localObject != null)
    {
      localObject = (altq)((QQAppInterface)localObject).getManager(36);
      ((altq)localObject).OS(this.redpointPath);
      if ((this.redpointPath != null) && (this.redpointPath.equals("100007.102000")) && (((altq)localObject).ai(100007) != null)) {}
    }
    else
    {
      return;
    }
    ((altq)localObject).dx(100007, this.redpointPath);
  }
    ...
    if (this.reportContents != null)
    {
      ...
      if (i < this.reportContents.size())
      {
        ...
        for (;;)
        {
          ...
          {
            anpc.a(BaseApplication.getContext()).i(QWalletHelper.getAppInterface(), (String)localObject);
          }
          else
          {
            try
            {
              ...
              anot.a(null, "P_CliOper", localObject[0], localObject[2], localObject[3], localObject[4], Integer.valueOf(localObject[5]).intValue(), Integer.valueOf(localObject[7]).intValue(), localObject[8], localObject[9], localObject[10], localObject[11]);
            }
  ...
  public void onReportDc()
  {
    ...
    {
      return;
      annx.b(null, this.dcId, this.dcDetail, this.dcIsMerge);
