...
public class FakeUrl
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (localMatcher.find())
        {
          ...
          localSpannableString.setSpan(new ForegroundColorSpan(this.context.getResources().getColor(2131165985)), 0, str1.length(), 33);
  ...
  public boolean onFakePros(String paramString1, String paramString2, FakeListener paramFakeListener)
  {
    try
    {
  ...
  public boolean onFakePros(String paramString, JSONObject paramJSONObject, FakeListener paramFakeListener)
  {
    ...
    {
      this.mDialog = new aqju(this.context, 2131756467);
  ...
  public static abstract class FakeAdapter
  ...
  public static abstract interface FakeListener
  {
