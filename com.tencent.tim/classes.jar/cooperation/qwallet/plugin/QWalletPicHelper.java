...
public class QWalletPicHelper
{
  ...
  public static void decodeDrawable(Drawable paramDrawable, OnDecodeListener paramOnDecodeListener)
  {
  ...
  private static URLDrawable getDrawableInner(String paramString1, String paramString2, Drawable paramDrawable1, Drawable paramDrawable2, int[] paramArrayOfInt, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if (TextUtils.isEmpty(paramString1)) {
        paramArrayOfInt = PreloadManager.getFilePath(paramString2);
      }
  ...
  {
    paramString = getDrawableInner(PreloadManager.getFilePath(paramString), paramString, paramDrawable1, paramDrawable2, new int[] { 26 }, paramBundle);
    ApngImage.playByTag(26);
    return paramString;
  }
  ...
  {
    String str = PreloadManager.getFilePath(paramString1);
  ...
  public static abstract interface OnDecodeListener
  {
