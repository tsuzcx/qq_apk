...
public class LiveRoomHelper
{
  ...
  {
    avfw localavfw = getPluginManagerInQQ();
    if (localavfw == null) {
      return null;
    }
    return localavfw.b("LiveRoomPlugin.apk");
  }
  ...
  @Nullable
  public static avfw getPluginManagerInQQ()
  {
    ...
    for (localObject = (QQAppInterface)localObject;; localObject = null)
    {
      ...
      return (avfw)((QQAppInterface)localObject).getManager(27);
    }
  }
  ...
  public static void report(String paramString1, String paramString2, String paramString3, long paramLong)
  {
    try
    {
      ...
      localJSONObject.put("platVersion", AppSetting.getVersion());
      String str = "";
      ...
      for (;;)
      {
        ...
        localJSONObject.put("imei", aqgz.getIMEI());
        localJSONObject.put("device", aqgz.getModel());
        localJSONObject.put("uin", BaseApplicationImpl.sApplication.getRuntime().getAccount());
        localJSONObject.put("network", aqiw.getNetworkType(BaseApplicationImpl.getContext()));
        localJSONObject.put("os", aqgz.getDeviceOSVersion());
