...
public final class aoij
{
  ...
  public static String a(@NonNull String paramString, @NonNull Bundle paramBundle)
  {
    ...
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_TROOP_UIN"))
    {
      ...
      localObject = aurr.addParameter(paramString, "troopuin", (String)localObject);
    }
    ...
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_OWNER_UIN"))
    {
      ...
      paramString = aurr.addParameter((String)localObject, "troopowneruin", paramString);
    }
    localObject = paramString;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_IS_OWNER")) {
      localObject = aurr.addParameter(paramString, "isowner", paramBundle.getBoolean("TOGETHER_BUNDLE_KEY_IS_OWNER", false) + "");
    }
    paramString = (String)localObject;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_IS_ADMIN")) {
      paramString = aurr.addParameter((String)localObject, "isadmin", paramBundle.getBoolean("TOGETHER_BUNDLE_KEY_IS_ADMIN", false) + "");
    }
    localObject = paramString;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_OPEN_STATUS")) {
      localObject = aurr.addParameter(paramString, "isopen", paramBundle.getBoolean("TOGETHER_BUNDLE_KEY_OPEN_STATUS", false) + "");
    }
    paramString = (String)localObject;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_FROM_TYPE")) {
      paramString = aurr.addParameter((String)localObject, "from", paramBundle.getInt("TOGETHER_BUNDLE_KEY_FROM_TYPE", 0) + "");
    }
    if (QLog.isColorLevel()) {
  ...
  public static void a(int paramInt, java.util.Map<String, Object> paramMap, java.util.Map<String, String> paramMap1)
  {
    ...
    //   64: ldc 156
    //   66: aastore
    //   67: invokestatic 146	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   70: aload_1
    //   71: instanceof 158
    //   74: ifeq +145 -> 219
    //   77: aload_1
    //   78: checkcast 158	java/lang/Long
    //   81: invokevirtual 162	java/lang/Long:longValue	()J
    //   84: lstore 4
    //   86: aload 7
    //   88: invokestatic 14	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   91: ifne +171 -> 262
    //   94: aload_2
    //   95: invokestatic 14	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   98: ifne +164 -> 262
    //   101: ldc 164
    //   103: aload 7
    //   105: invokevirtual 167	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   108: istore 6
    //   110: iload 6
    //   112: ifeq +113 -> 225
    //   115: iconst_2
    ...
    //   136: iconst_1
    //   137: ldc 169
    //   139: invokestatic 172	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   142: return
    //   143: aload_2
    //   144: ldc 174
    //   146: invokeinterface 180 2 0
    //   151: checkcast 28	java/lang/String
    //   154: astore 7
    //   156: goto -149 -> 7
    //   159: aload_2
    //   160: ldc 182
    //   162: invokeinterface 180 2 0
    //   167: checkcast 28	java/lang/String
    //   170: astore_2
    //   171: goto -158 -> 13
    //   174: aload_1
    //   175: ldc 184
    //   177: invokeinterface 180 2 0
    //   182: checkcast 186	java/util/HashMap
    //   185: astore_1
    //   186: goto -167 -> 19
    //   189: aload_1
    //   190: ldc 188
    //   192: invokeinterface 180 2 0
    //   197: astore_1
    //   198: goto -173 -> 25
    //   201: astore_1
    ...
    //   210: iconst_2
    //   211: aload_1
    //   212: invokevirtual 189	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   215: aload_1
    //   216: invokestatic 66	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   219: lconst_0
    //   220: lstore 4
    //   222: goto -136 -> 86
    //   225: ldc 191
    //   227: aload 7
    //   229: invokevirtual 167	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   232: istore 6
    //   234: iload 6
    //   236: ifeq +65 -> 301
    //   239: iconst_1
    ...
    //   241: goto -124 -> 117
    //   244: astore_1
    //   245: invokestatic 57	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   248: ifeq +14 -> 262
    //   251: ldc 59
    //   253: iconst_2
    //   254: aload_1
    //   255: invokevirtual 189	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   258: aload_1
    //   259: invokestatic 66	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   262: iconst_m1
    //   263: istore_3
    //   264: goto -147 -> 117
    //   267: getstatic 197	com/tencent/mobileqq/app/BaseActivity:sTopActivity	Lcom/tencent/mobileqq/app/BaseActivity;
    //   270: astore_1
    //   271: aload_1
    ...
    //   277: iconst_1
    //   278: ldc 199
    //   280: invokestatic 172	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   283: return
    //   284: aload_1
    //   285: getfield 203	com/tencent/mobileqq/app/BaseActivity:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   288: invokestatic 208	aohy:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Laohy;
    //   291: aload_1
    //   292: iload_0
    //   293: iload_3
    //   294: aload_2
    //   295: lload 4
    //   297: invokevirtual 211	aohy:a	(Lcom/tencent/mobileqq/app/BaseActivity;IILjava/lang/String;J)V
    //   300: return
    //   301: iconst_m1
    //   302: istore_3
    //   303: goto -186 -> 117
  ...
  public static void a(@NonNull Context paramContext, int paramInt1, @NonNull String paramString1, @Nullable String paramString2, @NonNull Bundle paramBundle, int paramInt2)
  {
    ...
    {
    default: 
      QQToast.a(paramContext, 0, 2131721823, 0).show();
      return;
    case 1: 
  ...
  public static void a(@NonNull QQAppInterface paramQQAppInterface, @NonNull aoii paramaoii, boolean paramBoolean)
  {
    a(paramQQAppInterface, paramaoii.serviceType + "_" + paramaoii.type + "_" + paramaoii.uin, paramBoolean, true);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      if (localObject != null)
      {
        ...
        if (paramString != null)
        {
          ...
          ((TroopManager)localObject).i(paramString);
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 2)
      {
        ...
        paramString = ((acff)localObject).a(paramString, false);
        if (paramString != null)
        {
          bool = paramString.isTogetherBusinessOpen(paramInt2);
          paramString.setTogetherBusiness(paramBoolean, paramInt2);
          ((acff)localObject).a(paramString);
          if (QLog.isColorLevel()) {
            QLog.i("TogetherUtils", 2, "setBusinessTogetherOpen troopinfo saved, last=" + bool);
          }
          i = j;
  ...
  public static boolean a(@NonNull QQAppInterface paramQQAppInterface, @NonNull aoii paramaoii)
  {
    return a(paramQQAppInterface, paramaoii.serviceType + "_" + paramaoii.type + "_" + paramaoii.uin, true, true);
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      paramQQAppInterface = localacff.a(paramString, false);
      paramString = localacff.b(paramString);
  ...
  public static <T extends aoii> T b(int paramInt1, int paramInt2, String paramString)
  {
    if (paramInt1 == 2) {
  ...
  public static String b(@NonNull String paramString, @NonNull Bundle paramBundle)
  {
    ...
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_C2C_FRIEND_OPENID")) {
      str = aurr.addParameter(paramString, "friend_user_openid", paramBundle.getString("TOGETHER_BUNDLE_KEY_C2C_FRIEND_OPENID"));
    }
    paramString = str;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_OPEN_STATUS")) {
      paramString = aurr.addParameter(str, "isopen", paramBundle.getBoolean("TOGETHER_BUNDLE_KEY_OPEN_STATUS") + "");
    }
    str = paramString;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_FROM_TYPE")) {
      str = aurr.addParameter(paramString, "from", paramBundle.getInt("TOGETHER_BUNDLE_KEY_FROM_TYPE") + "");
    }
    if (QLog.isColorLevel()) {
  ...
  public static void p(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      if (localTroopManager != null)
      {
        ...
        if (paramString != null)
        {
          ...
          localTroopManager.i(paramString);
          if (QLog.isColorLevel()) {
