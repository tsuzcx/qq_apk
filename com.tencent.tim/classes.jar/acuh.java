  ...
  extends acul
{
  ...
  {
    paramQQAppInterface = new acug(paramQQAppInterface, paramContext);
    paramQQAppInterface.source = paramString;
    paramQQAppInterface.cti = "huayang";
        ...
        catch (Exception paramacuo)
        {
          for (;;)
          {
            if (QLog.isColorLevel()) {
              QLog.d("HuaYangParser", 2, "failed to decode param value,tmps[1] is:" + paramString[0] + ",tmps[1] is:" + paramString[1], paramacuo);
            }
          }
        }
      }
