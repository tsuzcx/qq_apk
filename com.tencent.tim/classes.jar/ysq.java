...
public class ysq
{
  ...
  public static final void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, short paramShort, msg_comm.Msg paramMsg, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (localObject1 = "0xbc";; localObject1 = "0xbd")
      {
        ...
        localObject1 = String.format(acfp.m(2131709043), new Object[] { paramMsg });
        ...
        localPushPlatform.str_title.set(acfp.m(2131709045));
        ...
        ((aizd)paramQQAppInterface.getManager(284)).a((SubMsgType0x27.MsgBody)localObject2, (short)(mSeq.getAndIncrement() % 32767), paramInt);
        return;
        if (!bool2)
        {
  ...
  public static int g(MessageRecord paramMessageRecord)
  {
