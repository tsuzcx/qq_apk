...
public class jgj
{
  public static int a(AppRuntime paramAppRuntime, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    label67:
    for (i = aqwu.a(paramAppRuntime, paramString, 6, paramBoolean1, null); i != 0; i = aqwu.a(paramAppRuntime, paramAppRuntime.getAccount(), 6, paramBoolean1, paramString))
    {
      if (AudioHelper.aCz()) {
  ...
  public static void c(VideoAppInterface paramVideoAppInterface, int paramInt)
  {
