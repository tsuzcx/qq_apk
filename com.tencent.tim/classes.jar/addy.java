  ...
  extends addc
{
  ...
  public addy(String paramString1, int paramInt1, int paramInt2, int paramInt3, adkf paramadkf, ArCloudConfigInfo.a parama, String paramString2, long paramLong, boolean paramBoolean, int paramInt4, int paramInt5, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    super(paramString1, paramInt1, paramInt2, paramInt5, paramFloat1, paramFloat2, paramFloat3);
    this.cDO = paramInt3;
    this.mVideoUrl = paramString2;
  ...
  public String toString()
  {
    ...
    localStringBuilder.append(", mVideoUrl='").append(this.mVideoUrl).append('\'');
    localStringBuilder.append(", mVideoSize='").append(this.mVideoSize).append('\'');
    localStringBuilder.append(", mLayout='").append(this.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo$a).append('\'');
    localStringBuilder.append(", isSoftPlay='").append(this.bMi).append('\'');
