...
final class audy
  implements ahbm
{
  audy(QQAppInterface paramQQAppInterface, int paramInt) {}
  ...
  public long a(String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3, String paramString4, String paramString5, long paramLong, int paramInt3)
  {
    ...
    {
      localDataLineMsgRecord.thumbPath = aueh.ba(aueh.aC(this.val$app.getApplication()), ahav.getFileName(paramString5));
    ...
    for (localDataLineMsgRecord.nOpType = 29;; localDataLineMsgRecord.nOpType = 31)
    {
      ...
      paramString2 = (acle)this.val$app.getBusinessHandler(13);
      localDataLineMsgRecord.vipBubbleDiyTextId = paramString2.AV();
      localDataLineMsgRecord.vipBubbleID = acle.g(paramString2.AS(), localDataLineMsgRecord.vipBubbleDiyTextId);
