  ...
  extends atyg
{
  ...
  public atyi(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    super(paramQQAppInterface, paramFileManagerEntity);
    this.app = paramQQAppInterface;
    this.ceX = audx.b(paramQQAppInterface.getApplication().getBaseContext(), paramFileManagerEntity.fileName, paramFileManagerEntity.fileSize);
    if ((paramFileManagerEntity.isZipInnerFile) && (audx.a(paramQQAppInterface, this))) {
      this.ceX = false;
    }
    this.c = apsv.a(paramQQAppInterface, paramFileManagerEntity);
    if ((this.c.Status == 2) || (this.c.Status == 3))
    {
      boolean bool3 = audx.a(this);
      if (getCloudType() == 3)
      {
        boolean bool1 = bool2;
        if (this.ceX)
  ...
  {
    if (aueh.fileExistsAndNotEmpty(super.getFilePath())) {
      return 3;
    }
  ...
  public String vH()
  {
    String str2 = aueh.g(super.getFileSize());
    String str1 = str2;
