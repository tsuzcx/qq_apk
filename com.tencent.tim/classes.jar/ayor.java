  ...
  extends ayoq
{
  ...
  public ayor(int paramInt1, String paramString1, int paramInt2, @NonNull String paramString2, @NonNull String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, int paramInt3, int paramInt4, int paramInt5)
  {
  ...
  {
    return new ayor.a(paramContext, paramViewGroup);
  }
    ...
    extends ayoq.a<ayor>
  {
    ...
    public void a(ayor paramayor, int paramInt)
    {
      super.a(paramayor, paramInt);
      if (paramayor != null)
      {
        this.yD.setText(paramayor.mY());
        return;
      }
      this.yD.setText("");
    }
