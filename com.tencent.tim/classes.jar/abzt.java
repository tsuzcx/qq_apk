...
{
  abzt(abzq paramabzq, ApolloGameData paramApolloGameData) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    Intent localIntent = new Intent(this.jdField_a_of_type_Abzq.mContext, QQBrowserActivity.class);
    localIntent.putExtra("big_brother_source_key", "biz_src_zf_lmx");
    VasWebviewUtil.openQQBrowserActivity(this.jdField_a_of_type_Abzq.mContext, paramDialogInterface, -1L, localIntent, false, -1);
  }
}
