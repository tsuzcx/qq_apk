...
public class kqg
{
  ...
  public static android.graphics.drawable.BitmapDrawable a(Context paramContext)
  {
    ...
    //   13: aconst_null
    //   14: aconst_null
    //   15: invokestatic 29	alld:query	(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   18: astore 4
    //   20: aload 4
    //   22: ifnull +254 -> 276
    //   25: aload 4
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    boolean bool = ankq.f(paramQQAppInterface, BaseApplicationImpl.getContext());
    return (a(paramQQAppInterface)) && ((bool) || (ankq.aB(paramContext) == 0));
  }
}
