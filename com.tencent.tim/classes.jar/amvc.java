...
{
  public amvc(CloudFileGroupSearchEngine paramCloudFileGroupSearchEngine) {}
    ...
    synchronized (this.this$0)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        if (this.this$0.d == null)
        {
          ...
          localStringBuilder = localStringBuilder.append(str).append(" | mOnlineFileSearchEndListener onSearchEnd ");
          if (paramamwt != null) {
            break label145;
          }
          str = " request == null ";
      ...
      else
      {
        ...
        CloudFileGroupSearchEngine.a(this.this$0, paramList, paramamwt, "online_file_result_list");
      }
      label145:
      label171:
      label199:
