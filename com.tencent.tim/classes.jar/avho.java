...
public class avho
{
  public static Intent E()
  {
    ...
    QlinkPluginProxyActivity.x(localIntent, "com.tencent.qlink.activity.QlinkProxyActivity");
    return localIntent;
  }
  
  public static avho.a a(String paramString)
  {
    int i = 0;
    if (paramString == null) {}
    avho.a locala;
    ...
    for (;;)
    {
      locala.key = paramString.getString("k=");
      locala.peerUin = rF(paramString.getString("u="));
      localObject = rD(paramString.getString("n="));
      if (localObject != null)
      {
        locala.peerNick = URLDecoder.decode((String)localObject, "UTF-8");
        if (locala.peerNick != null) {}
      }
      for (locala.peerNick = locala.peerUin;; locala.peerNick = locala.peerUin)
      {
        locala.cKQ = paramString.getString("o=");
        locala.cKR = paramString.getString("p=");
        locala.preSharedKey = paramString.getString("d=");
        if ((locala.key == null) || (locala.peerUin == null) || (locala.cKQ == null)) {
          break;
        }
        return locala;
      }
  ...
  public static AppInterface b(BaseApplicationImpl paramBaseApplicationImpl, String paramString)
  {
    ...
    catch (ClassNotFoundException localClassNotFoundException)
    {
      ...
      try
      {
        ClassLoader localClassLoader = QlinkPluginProxyActivity.b(paramBaseApplicationImpl);
