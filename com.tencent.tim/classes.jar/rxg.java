  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    try
    {
      ...
      if (paramFromServiceMsg != null)
      {
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          notifyObserver(paramIntent, 1010, true, localBundle, akln.class);
          return;
        }
        ...
        notifyObserver(paramIntent, 1010, false, localBundle, akln.class);
        return;
      }
    }
    catch (Throwable paramIntent)
    {
      ...
      notifyObserver(null, 1010, false, null, akln.class);
    }
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    try
    {
      ...
      arrayOfByte = new rxe((COMM.StCommonExt)localObject, l1, l2).encode(paramIntent, -1, getTraceId());
