...
public class aqfr
{
  public static void Ux(String paramString)
  {
    try
    {
      ...
      if ((localObject != null) && (localObject.length >= 4)) {
        b(paramString, str1, str2, i, j, new String[] { localObject[0], localObject[1], localObject[2], localObject[3] });
      }
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    ...
    b("Grp_edu", paramString2, paramString3, paramInt1, paramInt2, new String[] { paramVarArgs[0], j(paramQQAppInterface, paramString1, paramQQAppInterface.getCurrentAccountUin()), paramVarArgs[2], paramVarArgs[3] });
  }
  ...
  public static void b(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    ...
    {
      if (ram.isColorLevel()) {
        ram.i("TroopReportor", "[op_type]%s;[op_name]%s;[op_in]%d;[op_result]%d;[d1]%s;[d2]%s;[d3]%s;[d4]%s", new Object[] { paramString2, paramString3, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), a(0, paramVarArgs), a(1, paramVarArgs), a(2, paramVarArgs), a(3, paramVarArgs) });
      }
  ...
  public static String c(TroopMemberInfo paramTroopMemberInfo)
  {
  ...
  public static void e(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    b("Grp_edu", paramString2, paramString3, 0, 0, new String[] { paramString1, c(localTroopMemberInfo), a((TroopInfo)localObject, paramQQAppInterface), String.valueOf(((TroopInfo)localObject).dwGroupClassExt) });
  }
  ...
  public static String j(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    return c(((TroopManager)paramQQAppInterface.getManager(52)).b(paramString1, paramString2));
  }
  
  public static void o(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    String str;
    if (paramInt3 == 10001) {
      str = "1";
      ...
      do
      {
        do
        {
          do
          {
            ...
            if (paramInt2 == 1)
            {
              b("Grp_set_new", "recommend", "exp_new", 3, 0, new String[] { paramString, str });
              return;
            }
          } while (paramInt2 != 0);
          b("Grp_set_new", "recommend", "clkjoin_new", 3, 0, new String[] { paramString, str });
          return;
        } while (paramInt1 != 1);
        if (paramInt2 == 1)
        {
          b("Grp_join_new", "person_data", "exp_new", 3, 0, new String[] { paramString, str });
          return;
        }
      } while (paramInt2 != 0);
      b("Grp_join_new", "recommend", "clkjoin_new", 3, 0, new String[] { paramString, str });
      return;
      label266:
      str = null;
    }
  ...
  public static String r(QQAppInterface paramQQAppInterface, String paramString)
  {
