...
public class Log
{
  ...
  private static ILogger sLogger = new MoaiChannelLogger(new LogcatLogger(null));
  ...
  public static void setLogger(ILogger paramILogger)
  {
    ...
    sLogger = new MoaiChannelLogger(paramILogger);
  }
  ...
  static class MoaiChannelLogger
    implements Log.ILogger
  {
    Log.ILogger logger;
    
    MoaiChannelLogger(Log.ILogger paramILogger)
    {
    ...
    public void log(int paramInt, String paramString1, String paramString2, Throwable paramThrowable)
    {
      this.logger.log(paramInt, "moai-channel-" + paramString1, paramString2, paramThrowable);
    }
  }
}
 ...
 * Qualified Name:     moai.channel.utils.Log
