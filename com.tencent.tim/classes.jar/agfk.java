...
public class agfk
{
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity, agsa paramagsa)
  {
    ...
    if ((str1 != null) && (str1.lastIndexOf(".rename") > 0))
    {
      ...
      ahal.a(paramActivity, paramActivity.getString(2131694155), 2131694142, new agfl(str2, str1, paramFileManagerEntity, paramQQAppInterface, paramActivity, paramagsa));
      return;
    }
    if ((paramFileManagerEntity.nFileType == 5) && ((paramFileManagerEntity.isZipInnerFile) || (paramFileManagerEntity.nOpType == 190)))
    {
      ahal.a(paramActivity, paramActivity.getString(2131694155), 2131694122, new agfm(paramActivity, paramFileManagerEntity));
      return;
    }
    ahav.installApkFile(paramActivity, paramFileManagerEntity.getFilePath());
  }
}
