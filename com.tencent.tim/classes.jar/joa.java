...
public class joa
{
  public static String TAG = joa.class.getSimpleName();
  
  public static View a(Context paramContext, ViewGroup paramViewGroup, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    paramContext = aozz.a(paramContext, paramViewGroup, paramInt2);
    paramViewGroup = (aozz.a)paramContext.getTag();
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((oidb_0x935.RgroupInfo)localObject).rpt_group_label.has()) {
          paramRecommendTroopItem.labelList = ackn.aM(((oidb_0x935.RgroupInfo)localObject).rpt_group_label.get());
        }
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.e(TAG, 2, "fillCustomView NumberFormatException");
        }
      }
      localGroupInfo.labels = localNumberFormatException;
      aozz.a(paramView, localGroupInfo, paramContext, false);
    }
  }
  ...
  {
    paramContext = aozz.a(paramContext, paramViewGroup, paramInt2, 2131561660);
    paramViewGroup = (aozz.a)paramContext.getTag();
    paramViewGroup.a.setMaxLabelCount(paramInt1);
    paramViewGroup.a.setmIsNeedPriority(paramBoolean);
    paramViewGroup.dSo = 1;
    return paramContext;
  }
}
