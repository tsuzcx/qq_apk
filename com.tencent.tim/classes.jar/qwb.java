...
public class qwb
  extends qwc<TagFeedItem>
{
  public qwb(@NonNull TagFeedItem paramTagFeedItem)
  {
  ...
  public boolean a(qqstory_struct.StoryFeed paramStoryFeed)
  {
    ...
    ((TagFeedItem)this.c).covertFrom(paramStoryFeed.feed_id.get().toStringUtf8(), (qqstory_struct.TagFeed)localObject);
    ((TagFeedItem)this.c).feedSourceTagType = paramStoryFeed.feed_source_tag_type.get();
