  ...
  extends Drawable
{
  ...
  public arin(Bitmap paramBitmap)
  {
  ...
  {
    if ((paramDrawable == null) || ((paramDrawable instanceof arin))) {}
    Object localObject;
    do
    {
      ...
      if ((paramDrawable instanceof LayerDrawable))
      {
        ...
        for (;;)
        {
          ...
          while (i < j)
          {
            ...
            paramDrawable.setDrawableByLayerId(paramDrawable.getId(i), E((Drawable)localObject));
            i += 1;
          }
        }
        return paramDrawable;
    ...
    return new arin((Bitmap)localObject);
  }
  
  public static arin a(Bitmap paramBitmap)
  {
    if (paramBitmap != null) {
      return new arin(paramBitmap);
    }
    return null;
  }
  ...
  {
    float f2 = 0.0F;
    switch (ario.$SwitchMap$android$widget$ImageView$ScaleType[this.mScaleType.ordinal()])
    {
    case 4: 
    default: 
  ...
  public arin a(float paramFloat)
  {
  ...
  public arin a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    int j = 1;
  ...
  public arin a(ColorStateList paramColorStateList)
  {
  ...
  public arin a(Shader.TileMode paramTileMode)
  {
  ...
  public arin a(ImageView.ScaleType paramScaleType)
  {
  ...
  public arin a(boolean paramBoolean)
  {
    this.mOval = paramBoolean;
    return this;
  }
  
  public arin b(Shader.TileMode paramTileMode)
  {
