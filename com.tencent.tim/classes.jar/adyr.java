...
public class adyr
  extends MSFServlet
{
  private void a(adyp paramadyp, ArrayList<BusinessCard> paramArrayList, Oidb_0x43c.ResponseCardList paramResponseCardList)
  {
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), adyr.class);
    ...
    for (;;)
    {
      ...
      if ((paramCardInfo.uin_info.has()) && (paramCardInfo.uin_info.get() != null))
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          ((CardUinInfo)localObject4).uin = String.valueOf(((Oidb_0x43c.UinInfo)localObject3).uin.get());
          if ((((Oidb_0x43c.UinInfo)localObject3).isFriend.has()) && (((Oidb_0x43c.UinInfo)localObject3).isFriend.get()))
          {
            bool = true;
            label352:
            ((CardUinInfo)localObject4).isFriend = bool;
          ...
          {
            ((CardUinInfo)localObject4).bSx = bool;
      ...
      if ((paramCardInfo.mobile_info.has()) && (paramCardInfo.mobile_info.get() != null))
      {
        ...
        if (((Iterator)localObject3).hasNext())
        {
          ...
          if (localMobileInfo.mobile.has())
          {
            ...
            label646:
            ((CardMobileInfo)localObject4).mobile = ((String)localObject1);
            if ((!localMobileInfo.isFriend.has()) || (!localMobileInfo.isFriend.get())) {
              break label788;
            }
            bool = true;
            label678:
            ((CardMobileInfo)localObject4).isFriend = bool;
            if (!((CardMobileInfo)localObject4).isFriend) {
              break label794;
            }
            ((CardMobileInfo)localObject4).bwu = String.valueOf(localMobileInfo.bind_uin.get());
            label709:
            ...
            label730:
            ((CardMobileInfo)localObject4).nickName = ((String)localObject1);
          ...
          {
            ((CardMobileInfo)localObject4).bwv = ((String)localObject1);
            ...
            bool = false;
            break label678;
            ((CardMobileInfo)localObject4).bwu = "";
            break label709;
            localObject1 = "";
            break label730;
          }
      ...
      if (paramCardInfo.ocr_info.has())
      {
        ...
        {
          ((CardOCRInfo)localObject4).name = ((String)localObject1);
          ...
          while (paramCardInfo.hasNext())
          {
            ...
            ((CardOCRInfo)localObject4).qqNum.add(String.valueOf(l));
          }
        }
        ...
        while (paramCardInfo.hasNext())
        {
          ...
          ((CardOCRInfo)localObject4).mobilesNum.add(localObject1);
        }
        ((CardOCRInfo)localObject4).vD = ((Oidb_0x43c.OCRInfo)localObject3).name_dependLevel.get();
        ((CardOCRInfo)localObject4).vE = ((Oidb_0x43c.OCRInfo)localObject3).uins_dependLevel.get();
        ((CardOCRInfo)localObject4).vF = ((Oidb_0x43c.OCRInfo)localObject3).mobiles_dependLevel.get();
      }
  ...
  private void d(Intent paramIntent, Packet paramPacket)
  {
    ...
    try
    {
      ...
      if (localBusinessCard.OCRInfo != null)
      {
        ...
        ((Oidb_0x43c.OCRInfo)localObject1).name.set(localBusinessCard.OCRInfo.name);
        localObject2 = localBusinessCard.OCRInfo.qqNum.iterator();
        String str;
        ...
        localObject2 = localBusinessCard.OCRInfo.mobilesNum.iterator();
        while (((Iterator)localObject2).hasNext())
        {
          str = (String)((Iterator)localObject2).next();
          if (str.length() > 0) {
        ...
        ((Oidb_0x43c.OCRInfo)localObject1).name_dependLevel.set(localBusinessCard.OCRInfo.vD);
        ((Oidb_0x43c.OCRInfo)localObject1).uins_dependLevel.set(localBusinessCard.OCRInfo.vE);
        ((Oidb_0x43c.OCRInfo)localObject1).mobiles_dependLevel.set(localBusinessCard.OCRInfo.vF);
  ...
  private void f(Intent paramIntent, Packet paramPacket)
  {
    ...
    try
    {
      ...
      {
        localObject1 = new Oidb_0x43c.OCRInfo();
        ((Oidb_0x43c.OCRInfo)localObject1).name.set(paramIntent.OCRInfo.name);
        localObject2 = paramIntent.OCRInfo.qqNum.iterator();
        String str;
        while (((Iterator)localObject2).hasNext())
        {
          str = (String)((Iterator)localObject2).next();
        ...
        localObject2 = paramIntent.OCRInfo.mobilesNum.iterator();
        while (((Iterator)localObject2).hasNext())
        {
          str = (String)((Iterator)localObject2).next();
          if (str.length() > 0) {
        ...
        ((Oidb_0x43c.OCRInfo)localObject1).name_dependLevel.set(paramIntent.OCRInfo.vD);
        ((Oidb_0x43c.OCRInfo)localObject1).uins_dependLevel.set(paramIntent.OCRInfo.vE);
        ((Oidb_0x43c.OCRInfo)localObject1).mobiles_dependLevel.set(paramIntent.OCRInfo.vF);
        localCardInfo.ocr_info.set((MessageMicro)localObject1);
      }
  ...
  private void g(Intent paramIntent, Packet paramPacket)
  {
  ...
  private void h(Intent paramIntent, Packet paramPacket)
  {
  ...
  private void m(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, 1, bool1, localBundle, adyq.class);
      return;
      boolean bool1 = false;
      continue;
      bool1 = bool2;
  ...
  private void n(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramFromServiceMsg = (adyp)((QQAppInterface)getAppRuntime()).getManager(112);
        localObject = paramFromServiceMsg.a(str);
        if ((localObject != null) && (!TextUtils.isEmpty(((BusinessCard)localObject).bindUin))) {
          paramFromServiceMsg.Hf(((BusinessCard)localObject).bindUin);
        }
        paramFromServiceMsg.He(str);
      }
      catch (Exception paramFromServiceMsg)
      {
        paramFromServiceMsg.printStackTrace();
      ...
      notifyObserver(paramIntent, 2, bool1, localBundle, adyq.class);
      return;
      bool1 = false;
    }
  }
  ...
  private void o(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, 3, bool1, localBundle, adyq.class);
      return;
      bool1 = false;
    }
  }
  ...
  private void p(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (bool2)
    {
      try
      {
        ...
        paramFromServiceMsg = (QQAppInterface)getAppRuntime();
        localObject1 = (adyp)paramFromServiceMsg.getManager(112);
        ...
        if (((Oidb_0x43c.CardInfo)localObject2).ocr_info.has()) {
          ((adyp)localObject1).c((BusinessCard)localObject3);
        }
        if (TextUtils.isEmpty(((BusinessCard)localObject3).bindUin)) {
          break label364;
        }
        if (!((acff)paramFromServiceMsg.getManager(51)).isFriend(((BusinessCard)localObject3).bindUin)) {
          break label447;
        }
        ((adyp)localObject1).a(((BusinessCard)localObject3).bindUin, (BusinessCard)localObject3);
      }
      catch (Exception paramFromServiceMsg)
      {
        for (;;)
        {
          ...
          bool1 = false;
          continue;
          ((adyp)localObject1).Hf(((BusinessCard)localObject3).bindUin);
          continue;
          bool1 = false;
        }
      }
    ...
    for (;;)
    {
      notifyObserver(paramIntent, 5, bool1, localBundle, adyq.class);
      return;
      label416:
      ...
      try
      {
        ...
        if ((j == 0) && (((oidb_sso.OIDBSSOPkg)localObject2).bytes_bodybuffer.has()) && (((oidb_sso.OIDBSSOPkg)localObject2).bytes_bodybuffer.get() != null))
        {
          ...
          if (j == i)
          {
            ...
            notifyObserver(paramIntent, 4, false, null, adyq.class);
            return;
          }
          ...
          if (bool)
          {
            ...
            if (((Oidb_0x43c.ResponseCardList)localObject2).mine.has())
            {
              ...
              localBusinessCard.cardType = 1;
              ((adyp)localObject1).b(localBusinessCard);
              ((ArrayList)localObject3).add(localBusinessCard);
            }
          }
          a((adyp)localObject1, (ArrayList)localObject3, (Oidb_0x43c.ResponseCardList)localObject2);
          ((adyp)localObject1).an((List)localObject3, false);
          ...
          ((adyp)localObject1).LK(j);
          notifyObserver(paramIntent, 4, true, null, adyq.class);
          return;
        }
      }
      catch (Exception paramFromServiceMsg)
