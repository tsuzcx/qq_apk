  ...
  public void onFinished(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt)
  {
    ...
    for (int i = paramArrayOfByte1.head.requestId;; i = 0)
    {
      if ((paramArrayOfByte2 == null) && (this.a != null))
      {
        ...
        this.a.onStatReportFinish(i, null, null, paramInt);
        return;
      }
      if (this.a != null)
      {
        ...
        if ((paramArrayOfByte1 instanceof StatReportResponse))
        {
          ...
          this.a.onStatReportFinish(i, null, paramArrayOfByte1, 0);
        }
      }
      for (;;)
      {
        ...
        return;
        label171:
        this.a.onStatReportFinish(i, null, paramArrayOfByte1, paramArrayOfByte1.ret);
        continue;
        label191:
        this.a.onStatReportFinish(i, null, null, paramInt);
        continue;
