  ...
  extends agrw
{
  ...
  public agrs(QQAppInterface paramQQAppInterface, WeiYunFileInfo paramWeiYunFileInfo)
  {
  ...
  {
    if ((this.d.cet) && (this.d.strFileName.toLowerCase().endsWith("heic"))) {
      return 0;
    }
    return ahav.getFileType(this.d.strFileName);
  }
  ...
  public String vG()
  {
    ...
    {
      E(localFileManagerEntity1);
      if (ahbj.fileExistsAndNotEmpty(localFileManagerEntity1.getFilePath())) {
