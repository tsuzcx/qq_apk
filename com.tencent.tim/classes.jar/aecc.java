  ...
  public void b(Context paramContext, ColorNote paramColorNote)
  {
    ...
    do
    {
      try
      {
        ...
        avpw.a(paramContext, avpw.d.a(), Long.valueOf(l).toString(), i + "", paramColorNote, (String)localObject1, 0, localBundle, true, true);
        return;
      }
      ...
      if (((String)localObject1).startsWith("qzone_userhome")) {
        try
        {
          ...
          avpw.a(paramContext, avpw.d.a(), paramColorNote, 0, 0, 0, null, null, true);
          return;
        }
        catch (JSONException paramContext)
        {
    ...
    try
    {
      ...
      avpw.a(paramContext, avpw.d.a(), paramColorNote, 0, 0, null, (String)localObject1, true);
      return;
    }
    catch (JSONException paramContext)
    {
