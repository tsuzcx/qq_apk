...
public class afeb
  extends MSFServlet
{
  public List<DoutuData> aX(List<DoutuRecommend.ImgInfo> paramList)
  {
  ...
  public List<DoutuData> i(List<Doutu.ImgInfo> paramList, int paramInt)
  {
    if ((paramList == null) || (paramList.size() <= 0)) {
      return null;
    }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      bool = false;
      paramIntent = (afdw)getAppRuntime().getManager(214);
      if (!bool) {
        break label505;
      }
    }
    ...
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        {
          paramIntent.P(true, i((List)localObject, paramFromServiceMsg.uint32_rsp_type.get()));
        }
      }
      else
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (i == 0)
          {
            paramIntent.a(true, aX(paramFromServiceMsg.rpt_msg_img_info.get()), l);
            return;
          }
          if (paramIntent != null) {
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      while (!QLog.isColorLevel())
      {
        ...
        localObject1 = aqnv.I(paramIntent.toByteArray());
        break;
        ...
        localObject1 = aqnv.I(paramIntent.getStringExtra("key_report_content").getBytes());
        if (!QLog.isColorLevel()) {
          break label676;
        }
