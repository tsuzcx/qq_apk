...
class ajpq
  extends jnm.a
{
  ajpq(ajpp paramajpp, ajpa paramajpa) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        paramArrayOfByte = new ajpb(bool1, bool2, l, paramArrayOfByte.bytes_list_jump_url.get().toStringUtf8(), paramArrayOfByte.bytes_card_url_h.get().toStringUtf8(), paramArrayOfByte.bytes_card_url_g.get().toStringUtf8());
        this.jdField_a_of_type_Ajpa.a(paramArrayOfByte);
        return;
        bool1 = false;
        break;
        label208:
