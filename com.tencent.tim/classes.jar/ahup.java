...
public class ahup
{
  public static ahuh a(MessageRecord paramMessageRecord, Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      {
        if (!(paramMessageRecord.get(n) instanceof anqv)) {
          break label269;
        }
        ArrayList localArrayList = ((anqv)paramMessageRecord.get(n)).rz;
        k = i;
        i = j;
        i1 = 0;
        j = k;
        ...
        {
          k = i;
          if (!(localArrayList.get(i1) instanceof ansr)) {
            continue;
          }
          j = 1;
          k = i;
  ...
  public static ahuh a(QQGameMsgInfo paramQQGameMsgInfo, Activity paramActivity)
  {
