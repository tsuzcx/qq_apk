...
public final class hd_video_voip2
{
    ...
    extends MessageMicro<CmdPhoneMultiChatInviteReqBody>
  {
    ...
    public final PBBytesField bytes_conf_id = PBField.initBytes(ByteStringMicro.EMPTY);
    public hd_video_voip2.TelInfo msg_from_tel = new hd_video_voip2.TelInfo();
    public final PBRepeatMessageField<hd_video_voip2.TelInfo> msg_invite_tel = PBField.initRepeatMessage(hd_video_voip2.TelInfo.class);
    ...
    extends MessageMicro<CmdPhoneMultiChatInviteRspBody>
  {
    static final MessageMicro.FieldMap __fieldMap__;
    public final PBBytesField bytes_conf_id = PBField.initBytes(ByteStringMicro.EMPTY);
    public final PBRepeatMessageField<hd_video_voip2.TelInfo> msg_invite_fail_tel = PBField.initRepeatMessage(hd_video_voip2.TelInfo.class);
    public final PBRepeatMessageField<hd_video_voip2.TelInfo> msg_invite_succ_tel = PBField.initRepeatMessage(hd_video_voip2.TelInfo.class);
    ...
    extends MessageMicro<CmdPhoneMultiChatQueryRspBody>
  {
    static final MessageMicro.FieldMap __fieldMap__;
    public final PBBytesField bytes_conf_id = PBField.initBytes(ByteStringMicro.EMPTY);
    public final PBRepeatMessageField<hd_video_voip2.TelInfo> msg_chating_tel = PBField.initRepeatMessage(hd_video_voip2.TelInfo.class);
 ...
 * Qualified Name:     tencent.im.cs.video.voip.hd_video_voip2
