...
public final class cmd0xe62
{
  ...
  {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "set_type", "rpt_uint64_uin" }, new Object[] { Integer.valueOf(0), Long.valueOf(0L) }, ReqBody.class);
