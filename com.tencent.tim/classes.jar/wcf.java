...
{
  public wcf(TroopMemberListActivity paramTroopMemberListActivity, String paramString) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      QQToast.a(this.this$0, acfp.m(2131715982), 0).show(this.this$0.mTitleBar.getHeight());
      continue;
      if (!TextUtils.isEmpty(this.this$0.aQL)) {
        QQToast.a(this.this$0, this.this$0.aQL, 0).show(this.this$0.mTitleBar.getHeight());
      } else {
        QQToast.a(this.this$0, acfp.m(2131715978), 0).show(this.this$0.mTitleBar.getHeight());
      }
    }
  }
}
