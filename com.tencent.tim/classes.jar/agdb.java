...
public class agdb
  implements aprb.a
{
  public agdb(TroopFileZipPreviewActivity paramTroopFileZipPreviewActivity, List paramList, String paramString1, FileManagerEntity paramFileManagerEntity, boolean paramBoolean1, String paramString2, boolean paramBoolean2, String paramString3, String paramString4, short paramShort, String paramString5, int paramInt, String paramString6, smq.j paramj) {}
        ...
        if (paramInt < paramBundle.length())
        {
          ...
          if (this.val$filePath.equals("/"))
          {
            ...
            if (localFileManagerEntity.mContext == null) {
              QLog.i("IphoneTitleBarActivity", 1, "zip list file content is empty. zipSessionId[" + this.b.nSessionId + "] zipIsWeiyunFile[" + this.ccV + "] zipCouldType[" + this.b.cloudType + "] fileSessionId[" + localFileManagerEntity.nSessionId + "]");
            }
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityTroopFileZipPreviewActivity.app.a().v(localFileManagerEntity);
            this.pv.add(locala);
            paramInt += 1;
            break;
