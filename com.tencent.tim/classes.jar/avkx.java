...
public abstract interface avkx
  extends IInterface
{
    ...
    implements avkx
  {
    ...
    public static avkx a(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof avkx))) {
        return (avkx)localIInterface;
      }
      return new avkx.a.a(paramIBinder);
    }
      ...
      implements avkx
    {
        ...
        throws RemoteException
      {
        ...
        //   35: aload_0
        //   36: getfield 18	avkx$a$a:mRemote	Landroid/os/IBinder;
        //   39: iconst_1
        //   40: aload_3
        //   41: aload 4
        //   43: iconst_0
