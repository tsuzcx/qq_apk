...
public class ahao
{
  ...
  private static int mToastOffset = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299627) - (int)aqho.convertDpToPixel(BaseApplicationImpl.getContext(), 5.0F);
