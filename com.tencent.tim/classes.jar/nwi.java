...
{
  nwi(nwg paramnwg, Intent paramIntent, Activity paramActivity) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    nwg.a(this.this$0).dismiss();
    if (paramBoolean) {}
    for (;;)
    {
      try
      ...
      catch (Exception paramBundle)
      {
        ...
        QLog.d(nwg.TAG, 2, paramBundle.getMessage());
        continue;
        this.val$intent.putExtra("stuctmsg_bytes", paramBundle.getBytes());
        this.val$activity.startActivityForResult(this.val$intent, 21);
      }
      ...
      if (QLog.isColorLevel()) {
        QLog.d(nwg.TAG, 2, "build struct msg fail");
      }
      return;
