  ...
  extends MSFServlet
{
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramAppRuntime.getApplication(), anek.class);
  ...
  {
    paramIntent = new avui((UserCommReport)paramIntent.getSerializableExtra("userCommReport"), (ArrayList)paramIntent.getSerializableExtra("reportInfos"));
