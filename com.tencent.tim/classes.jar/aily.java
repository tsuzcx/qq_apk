...
public class aily
{
  public static List<ChatMessage> bi(List<ChatMessage> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((!top.fC(localChatMessage.msgtype)) && (!wkh.i(localChatMessage))) {
  ...
  public static void f(QQAppInterface paramQQAppInterface, Intent paramIntent)
  {
    ajlc.a().djF = 7;
    ...
    do
    {
      ...
      if ((j == 3000) || (j == 1))
      {
        ...
        paramQQAppInterface = paramQQAppInterface.b().a((String)localObject2, j, l);
      ...
      if (paramIntent.size() > 0)
      {
        ...
        while (paramQQAppInterface.hasNext())
        {
          ...
          ajlc.a().lC.put(localObject1, Boolean.valueOf(true));
        }
      }
