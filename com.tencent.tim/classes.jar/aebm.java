...
public class aebm
  extends accg
{
  private short Y = -23193;
  
  public aebm(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private void jg(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    boolean bool2;
  ...
  public void Hf(boolean paramBoolean)
  {
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      try
      {
        ...
        ((ByteBuffer)localObject2).putInt(aqft.ag(l)).put((byte)0).putShort((short)1).putShort(this.Y).putShort((short)2).putShort(s);
