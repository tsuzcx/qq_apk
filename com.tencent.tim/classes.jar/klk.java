  ...
  implements nln, nlp
{
  ...
  public int a(BaseData paramBaseData)
  {
    ...
    if ((paramBaseData instanceof ProteusBannerBigPicItemData)) {
      i = kmx.a((ProteusBannerBigPicItemData)paramBaseData);
    }
    return i;
  }
  ...
  public nlm a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    return new klk.a(paramViewGroup, localProteusItemData);
  }
    ...
    extends nlm
  {
    ...
    private void a(BaseData paramBaseData, Context paramContext, JSONObject paramJSONObject)
    {
      ...
      ViewFactory.findClickableViewListener(paramJSONObject, new kll(this, paramBaseData, paramContext, paramJSONObject));
    }
    ...
    public void a(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
    {
      ...
      try
      {
        ...
        a(paramBaseData2, klk.a(klk.this), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataProteusItemData.aD);
