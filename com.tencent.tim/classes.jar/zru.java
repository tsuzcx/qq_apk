...
public class zru
  implements aoow
{
  private Bitmap i(Bitmap paramBitmap, int paramInt1, int paramInt2)
  {
  ...
  public Bitmap getBitmap(java.net.URL paramURL)
  {
    ...
    //   29: aload_1
    //   30: invokestatic 88	aqhu:d	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   33: astore_1
    //   34: aload 8
    //   36: getfield 92	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbHeight	I
    //   39: istore_2
    //   40: aload 8
    //   42: getfield 95	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbWidth	I
    //   45: istore_3
    //   46: aload_1
    ...
    //   152: ifnull +417 -> 569
    //   155: aload_1
    //   156: invokevirtual 99	android/graphics/Bitmap:recycle	()V
    //   159: aload 6
    //   161: astore_1
    //   162: aload 8
    //   164: getfield 82	com/tencent/mobileqq/activity/photo/LocalMediaInfo:path	Ljava/lang/String;
    //   167: invokestatic 105	aoop:eI	(Ljava/lang/String;)I
    //   170: istore_2
    //   171: aload_1
    //   172: astore 6
    //   174: iload_2
    //   175: ifeq +68 -> 243
    //   178: new 107	android/graphics/Matrix
    //   181: dup
    //   182: invokespecial 108	android/graphics/Matrix:<init>	()V
    //   185: astore 6
    //   187: aload 6
    //   189: iload_2
    //   190: i2f
    ...
    //   203: idiv
    //   204: i2f
    //   205: invokevirtual 112	android/graphics/Matrix:setRotate	(FFF)V
    //   208: aload_1
    //   209: iconst_0
    //   210: iconst_0
    //   211: aload_1
    ...
    //   219: aload 6
    //   221: iconst_1
    //   222: invokestatic 115	android/graphics/Bitmap:createBitmap	(Landroid/graphics/Bitmap;IIIILandroid/graphics/Matrix;Z)Landroid/graphics/Bitmap;
    //   225: astore 7
    //   227: aload_1
    //   228: astore 6
    //   230: aload 7
    //   232: ifnull +11 -> 243
    //   235: aload_1
    //   236: invokevirtual 99	android/graphics/Bitmap:recycle	()V
    //   239: aload 7
    //   241: astore 6
    //   243: aload 6
    //   245: areturn
    ...
    //   260: idiv
    //   261: iload_2
    //   262: invokespecial 117	zru:i	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   265: astore 7
    //   267: aload_1
    //   268: astore 6
    //   270: aload 7
    //   272: ifnull +300 -> 572
    //   275: aload_1
    //   276: invokevirtual 99	android/graphics/Bitmap:recycle	()V
    //   279: aload 7
    //   281: astore 6
    //   283: goto +289 -> 572
    //   286: aload_0
    ...
    //   293: iload 4
    //   295: idiv
    //   296: invokespecial 117	zru:i	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   299: astore 7
    //   301: aload_1
    //   302: astore 6
    //   304: aload 7
    //   306: ifnull +299 -> 605
    //   309: aload_1
    //   310: invokevirtual 99	android/graphics/Bitmap:recycle	()V
    //   313: aload 7
    //   315: astore 6
    //   317: goto +288 -> 605
    //   320: iload 4
    ...
    //   410: ifnull +201 -> 611
    //   413: aload_1
    //   414: invokevirtual 99	android/graphics/Bitmap:recycle	()V
    //   417: aload 7
    //   419: astore 6
    //   421: goto +190 -> 611
    //   424: iload 4
    ...
    //   437: iload 4
    //   439: idiv
    //   440: invokespecial 117	zru:i	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   443: astore 7
    //   445: aload_1
    //   446: astore 6
    //   448: aload 7
    //   450: ifnull +167 -> 617
    //   453: aload_1
    //   454: invokevirtual 99	android/graphics/Bitmap:recycle	()V
    //   457: aload 7
    //   459: astore 6
    //   461: goto +156 -> 617
    //   464: aload_0
    ...
    //   472: idiv
    //   473: iload_3
    //   474: invokespecial 117	zru:i	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   477: astore 6
    //   479: aload 6
    //   481: ifnull +88 -> 569
    //   484: aload_1
    //   485: invokevirtual 99	android/graphics/Bitmap:recycle	()V
    //   488: aload 6
    //   490: astore_1
    //   491: goto -329 -> 162
    //   494: astore 6
    //   496: invokestatic 123	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   499: ifeq +13 -> 512
    //   502: ldc 125
    //   504: iconst_2
    //   505: ldc 127
    //   507: aload 6
    //   509: invokestatic 131	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   512: aload_1
    //   513: astore 6
    //   515: aload_1
    ...
    //   523: aconst_null
    //   524: astore_1
    //   525: invokestatic 123	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   528: ifeq +13 -> 541
    //   531: ldc 125
    //   533: iconst_2
    //   534: ldc 133
    //   536: aload 6
    //   538: invokestatic 131	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   541: aload_1
    //   542: ifnull -23 -> 519
    //   545: aload_1
    //   546: areturn
