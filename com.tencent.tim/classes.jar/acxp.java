  ...
  extends acul
{
  ...
  {
    paramQQAppInterface = new acxo(paramQQAppInterface, paramContext);
    paramQQAppInterface.source = paramString;
    paramQQAppInterface.cti = "wsgzh";
    paramQQAppInterface.ctj = "miniapp_player";
        ...
        catch (Exception paramacuo)
        {
          for (;;)
          {
            if (QLog.isColorLevel()) {
              QLog.d("WeishiPublicAccountVideoParser", 2, "failed to decode param value,tmps[1] is:" + paramString[0] + ",tmps[1] is:" + paramString[1], paramacuo);
            }
          }
        }
      }
