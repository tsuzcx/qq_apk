...
{
  public inr(GaInviteLockActivity paramGaInviteLockActivity) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    boolean bool;
    if ((this.this$0.mGroupId == l1) && (GaInviteLockActivity.a(this.this$0) == l2)) {
      bool = true;
    }
    Object localObject;
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d(this.this$0.TAG, 2, "handleMsgType0x210SuMsgType0x116 mMemberChangeEventReceiver fit=" + bool + ";current roomId=" + GaInviteLockActivity.a(this.this$0) + ";groupId=" + this.this$0.mGroupId);
      }
      ...
      if ((paramContext.equalsIgnoreCase("tencent.video.q2v.GvideoMemInviteUpdate")) && (bool))
      {
        ...
        try
        {
          ...
          localObject = GaInviteLockActivity.a(this.this$0).iterator();
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(this.this$0.TAG, 2, "mMemberChangeEventReceiver before totalCount:" + paramContext.uint32_invite_list_total_count.get() + ";currentInviteMembers=" + GaInviteLockActivity.a(this.this$0).size());
      }
      int i = 0;
      j = 0;
      if (j < paramContext.rpt_msg_member_join.size())
      {
        ...
        for (int m = 1;; m = 0)
        {
          ...
          if (!paramIntent.contains(Long.valueOf(l1)))
          {
            ...
            if (m != 0)
            {
              GaInviteLockActivity.a(this.this$0).add(new inx(((submsgtype0x116.MemberInfo)localObject).uint64_member_uin.get(), ((submsgtype0x116.MemberInfo)localObject).uint32_invite_timestamp.get()));
              i = 1;
              k = i;
              if (QLog.isColorLevel())
              {
      ...
      while (i < paramContext.rpt_msg_member_quit.size())
      {
        ...
        paramIntent = GaInviteLockActivity.a(this.this$0).iterator();
        do
        {
          k = j;
        ...
        GaInviteLockActivity.a(this.this$0).remove(localObject);
        if (QLog.isColorLevel()) {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(this.this$0.TAG, 2, "mMemberChangeEventReceiver after totalCount:" + paramContext.uint32_invite_list_total_count.get() + ";currentInviteMembers=" + GaInviteLockActivity.a(this.this$0).size() + ";eventType=" + paramContext.enum_event_type.get());
      }
    } while (j == 0);
    GaInviteLockActivity.a(this.this$0, "mMemberChangeEventReceiver");
  }
}
