  ...
  implements ubd
{
  ...
  private void b(String paramString1, int paramInt, String paramString2, String paramString3, long paramLong1, long paramLong2)
  {
    ...
    for (;;)
    {
      localObject = this.a;
      if (localObject != null) {
        ThreadManager.getUIHandler().post(new DoraemonAPIReporterMain.4(this, (ubd.a)localObject, paramString1, paramInt, paramString2, paramString3, paramLong1, paramLong2));
      }
      return;
  ...
  private void c(String paramString1, int paramInt1, String paramString2, String paramString3, int paramInt2)
  {
    ...
    try
    {
      ...
      jnm.a(localAppRuntime, new ubf(this, paramString1, paramString3, paramInt2), localReqBody.toByteArray(), "OidbSvc.0xb6f_1", 2927, 1, null, 0L);
      return;
    }
  ...
  private void p(String paramString, List<APIQuotaEntity> paramList)
  {
    if (QLog.isColorLevel()) {
    ...
    if (locala != null)
    {
      ...
      ThreadManager.getUIHandler().post(new DoraemonAPIReporterMain.5(this, locala, paramString, localHashMap));
    }
  }
  ...
  {
    c(paramString1, paramInt, paramString2, paramString3, 1);
  }
}
