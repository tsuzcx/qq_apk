  ...
  extends qdh
{
  ...
  public qca(boolean paramBoolean1, boolean paramBoolean2)
  {
    a(false, true);
    this.isRound = paramBoolean1;
    this.aCN = paramBoolean2;
  }
  ...
  public static Bitmap c(Drawable paramDrawable)
  {
    ...
    try
    {
      ...
      {
        ram.e("WeChatImageJob", "drawableToBitmapWhiteBg " + paramDrawable.getMessage());
        return null;
      }
      return null;
    }
  ...
  public static Bitmap t(Bitmap paramBitmap)
  {
    ...
    //   11: areturn
    //   12: aload_0
    //   13: invokevirtual 98	android/graphics/Bitmap:getWidth	()I
    //   16: istore 6
    //   18: aload_0
    //   19: invokevirtual 101	android/graphics/Bitmap:getHeight	()I
    //   22: istore 7
    //   24: iload 6
    //   26: iload 7
    ...
    //   73: aconst_null
    //   74: iconst_0
    //   75: invokestatic 104	android/graphics/Bitmap:createBitmap	(Landroid/graphics/Bitmap;IIIILandroid/graphics/Matrix;Z)Landroid/graphics/Bitmap;
    //   78: astore 8
    //   80: aload 8
    //   82: astore_0
    //   83: iload 6
    ...
    //   102: dstore_1
    //   103: dload_1
    //   104: invokestatic 112	java/lang/Math:sqrt	(D)D
    //   107: dstore_1
    //   108: iload_3
    //   109: i2d
    //   110: dload_1
    ...
    //   116: iload_3
    //   117: iconst_1
    //   118: invokestatic 116	android/graphics/Bitmap:createScaledBitmap	(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    //   121: astore 8
    //   123: aload_0
    //   124: invokevirtual 119	android/graphics/Bitmap:recycle	()V
    //   127: aconst_null
    //   128: astore_0
    //   129: aload 8
    ...
    //   157: goto -28 -> 129
    //   160: astore 8
    //   162: invokestatic 124	java/lang/System:gc	()V
    //   165: invokestatic 130	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   168: ifeq +15 -> 183
    //   171: ldc 71
    //   173: iconst_2
    //   174: aload 8
    //   176: iconst_0
    //   177: anewarray 132	java/lang/Object
    //   180: invokestatic 136	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   183: aload 9
    //   185: astore 8
    //   187: goto -58 -> 129
    //   190: astore 8
    //   192: aload 10
    //   194: astore 9
    //   196: invokestatic 130	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   199: ifeq +15 -> 214
    //   202: ldc 71
    //   204: iconst_2
    //   205: aload 8
    //   207: iconst_0
    //   208: anewarray 132	java/lang/Object
    //   211: invokestatic 136	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   214: aload 9
    //   216: astore 8
    //   218: goto -89 -> 129
    //   221: astore 8
  ...
  public static Bitmap x(Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      Bitmap localBitmap2 = aqhu.g(BaseApplicationImpl.sApplication.getResources(), 2130847677);
  ...
  public boolean Jp()
  {
    return (this.cp != null) || (this.db != null);
  }
  ...
  public void M(Map<String, Object> paramMap)
  {
    if ((paramMap != null) && (!paramMap.isEmpty()))
    {
      if (paramMap.containsKey("WeChatImageJob_in_bitmap")) {
        this.cp = ((Bitmap)k("WeChatImageJob_in_bitmap"));
      }
      if (paramMap.containsKey("WeChatImageJob_in_drawable")) {
        this.db = ((Drawable)k("WeChatImageJob_in_drawable"));
      }
    }
  }
  ...
  public void bnE()
  {
    Object localObject3;
    if (this.cp != null) {
      localObject3 = y(this.cp);
    }
    for (;;)
    {
      Object localObject1 = localObject3;
      if (this.isRound) {
        localObject1 = apzg.R(aqhu.r((Bitmap)localObject3, 70, 70));
      }
      localObject3 = localObject1;
      if (localObject1 == null) {
        localObject3 = apzg.R(aqhu.r(0));
      }
      localObject3 = t((Bitmap)localObject3);
      localObject1 = localObject3;
      if (this.aCN) {}
      try
      {
        localObject1 = x((Bitmap)localObject3);
        p("WeChatImageJob_out_bitmap", localObject1);
        sA(true);
        return;
        if (this.db != null)
        {
          localObject3 = c(this.db);
          continue;
        }
        sA(false);
        return;
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        for (;;)
        {
          ram.i("WeChatImageJob", "addPlayIconInBitmapForWeChat oom error" + localOutOfMemoryError.getMessage());
