  ...
  extends IInterface
{
    ...
    implements avix
  {
    ...
    public static avix a(IBinder paramIBinder)
    {
      if (paramIBinder == null) {
        return null;
      }
      IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.qqdataline.ipc.IDatalineService");
      if ((localIInterface != null) && ((localIInterface instanceof avix))) {
        return (avix)localIInterface;
      }
      return new avix.a.a(paramIBinder);
    }
      ...
      implements avix
    {
        ...
        throws RemoteException
      {
        ...
        //   35: aload_0
        //   36: getfield 18	avix$a$a:mRemote	Landroid/os/IBinder;
        //   39: iconst_2
        //   40: aload_3
        //   41: aload 4
        //   43: iconst_0
