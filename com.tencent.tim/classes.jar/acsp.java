...
public class acsp
{
  ...
  private static String a(String paramString, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    paramInt = ((achs)paramQQAppInterface.getManager(92)).a(paramString, paramInt, localStringBuilder);
  ...
  {
    List localList = paramQQAppInterface.b().k(paramString1, paramInt);
    ...
    for (long l1 = ((MessageRecord)localList.get(localList.size() - 1)).time + 2L;; l1 = 0L) {
      for (;;)
      {
        paramQQAppInterface.b().N(paramString1, paramInt);
        paramQQAppInterface.b().cc(paramString1, paramInt);
        ...
        try
        {
          ...
          l1 = Math.max(l2, l1);
          if (l1 > 0L) {
            paramQQAppInterface.a().F(paramString1, paramInt, l1);
          }
          return;
  ...
  public static void c(String paramString, int paramInt, QQAppInterface paramQQAppInterface)
  {
