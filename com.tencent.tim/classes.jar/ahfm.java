  ...
  extends afeu
{
  ...
  public ahfm(QQAppInterface paramQQAppInterface)
  {
  ...
  public void HO(String paramString)
  {
    ...
    if (ahfn.a(paramString, (QFlutterEngineData)b())) {
      ahfn.bA(0, true);
    }
    for (;;)
    {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("QFlutter.QFlutterEngineDownloader", 2, String.format("isNetValid2Download mHadRequestedByUser: %s", new Object[] { Boolean.valueOf(this.cgD) }));
    }
    if (this.cgD) {
      return true;
    }
  ...
  public boolean aiY()
  {
    QLog.d("QFlutter.QFlutterEngineDownloader", 1, String.format("downloadResource, mHadRequestedByUser = %s", new Object[] { Boolean.valueOf(this.cgD) }));
    if (!this.cgD) {
      return false;
    }
    return super.aiY();
  ...
  public void aq(long paramLong1, long paramLong2)
  {
    ...
    ahfn.i(0, paramLong1, paramLong2);
  }
