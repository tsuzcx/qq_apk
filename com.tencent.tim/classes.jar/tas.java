...
public class tas
{
  public static String a(DeviceInfo paramDeviceInfo)
  {
    ...
    {
      localObject = ((syw)((QQAppInterface)localObject).getBusinessHandler(51)).a(paramDeviceInfo.productId);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, DeviceInfo paramDeviceInfo, String paramString, Bundle paramBundle)
  {
      ...
      for (;;)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            awjb.a().a((Activity)paramContext, paramQQAppInterface, paramQQAppInterface.getAccount(), paramDeviceInfo, "com.tencent.device.activities.DeviceSquareActivity", 0, null, SmartDevicePluginProxyActivity.class);
            tar.a(null, "Usr_NewDevice_Aio", 2, 0, 0);
            return;
          }
        }
        catch (Exception paramQQAppInterface)
        {
          arwt.e("SmartDeviceUtil", "jumpLightApp, Exception >>>", paramQQAppInterface);
          return;
        }
    ...
    paramBundle = (syw)paramQQAppInterface.getBusinessHandler(51);
  ...
  public static void a(QQAppInterface paramQQAppInterface, JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      paramJSONObject = (StructMsgForGeneralShare)anre.a((Bundle)localObject);
      localObject = (MessageForStructing)anbi.d(-2011);
      ...
      paramQQAppInterface.b().b((MessageRecord)localObject, paramQQAppInterface.getCurrentAccountUin());
      return;
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void a(String paramString1, Bundle paramBundle, int paramInt, String paramString2, AppRuntime paramAppRuntime, BusinessObserver paramBusinessObserver)
  {
    ...
    paramBundle.putString("version", "3.4.4");
    ...
    paramString1 = new NewIntent(paramAppRuntime.getApplication(), syk.class);
