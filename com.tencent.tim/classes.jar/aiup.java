...
public class aiup
{
  ...
  {
    return paramQQAppInterface.b().a(paramString, paramInt, new int[] { -2076 }, 5);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    if ((paramMessageRecord instanceof MessageForLocationShare))
    {
      ...
      paramQQAppInterface.b().c(paramMessageRecord.frienduin, paramMessageRecord.istroop, paramMessageRecord.uniseq, localMessageForLocationShare.convertToMsgData());
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, aozx paramaozx)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (paramaozx != null) {}
      for (paramQQAppInterface = paramaozx.frienduin;; paramQQAppInterface = paramMsg.msg_head.to_uin.get() + "") {
        break;
      }
      if (QLog.isColorLevel()) {
        paramStringBuilder.append("elemType:LbsShareMsg;\n");
      }
      paramList = (MessageForLocationShare)anbi.d(-2076);
      paramList.msgtype = -2076;
      paramList.msg = BaseApplicationImpl.context.getString(2131720431);
  ...
  {
    return paramQQAppInterface.b().a(paramString, paramInt, 9223372036854775807L, 3, 9223372036854775807L, new int[] { -2076 }, 2147483647);
  }
}
