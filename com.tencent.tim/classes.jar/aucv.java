...
import com.tencent.tim.filemanager.fileviewer.viewer.VideoFileViewer.1;
  ...
  implements View.OnTouchListener
{
  ...
  private DragView.b jdField_a_of_type_ComTencentWidgetDragView$b = new aucz(this);
  ...
  public aucv(Activity paramActivity)
  {
    super(paramActivity);
  }
  ...
  public void dkB()
  {
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      this.d.addUpdateListener(new aucy(this));
    }
  }
  ...
  public void fR(String paramString1, String paramString2)
  {
    ...
    if (ahbj.fileExistsAndNotEmpty(paramString1))
    {
      ...
      paramString2.setOnClickListener(new aucw(this, paramString1));
    ...
    this.CS.setOnClickListener(new aucx(this));
  }
