...
{
  static String YE;
  static final String Yp = BaseApplication.getContext().getFilesDir() + File.separator + "qqshp_client_log_wl_conf.json";
  public achq c = new ked(this);
  
  public kec(AppInterface paramAppInterface)
  {
  ...
  public void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, long paramLong1, long paramLong2, long paramLong3, long paramLong4, boolean paramBoolean)
  {
    ...
    if (this.app == null)
    {
      ...
      if (paramBoolean)
      {
        if ((YE == null) && (this.app != null) && (this.app.getApp() != null))
        {
          paramString2 = (WifiManager)this.app.getApp().getSystemService("wifi");
          if ((paramString2 != null) && (alkz.a(paramString2) != null)) {
            YE = alkz.c(alkz.a(paramString2));
          }
        }
        if (!TextUtils.isEmpty(YE)) {
          localSQQSHPCliLogInfo.wifimac.set(YE);
        }
      }
  ...
  public void a(boolean paramBoolean, MessageRecord paramMessageRecord, int paramInt, String paramString)
  {
    try
    {
      ...
      {
        paramString = new kds.a();
        paramString.aId = 3;
        paramString = kds.a(paramString, paramMessageRecord);
        paramString.aIh = paramInt;
        ((kds)this.app.getBusinessHandler(139)).a(paramString, null);
        if ((paramMessageRecord instanceof MessageForStructing))
        {
          ...
          if ((paramMessageRecord instanceof StructMsgForGeneralShare))
          {
            ...
            if ((paramMessageRecord.mStructMsgItemLists != null) && (paramMessageRecord.mStructMsgItemLists.size() > 0)) {
              tlb.a(1, 2, kdm.a((anqu)paramMessageRecord.mStructMsgItemLists.get(0)));
            }
          }
        }
      }
  ...
  {
    boolean bool = true;
    Object localObject = new File(Yp);
    ...
    for (;;)
    {
      try
      {
        ...
        kdm.fX = localArrayList;
        if ((localJSONArray2 != null) && (localJSONArray2.length() > 0))
        {
          i = 0;
          if (i < localJSONArray2.length())
          {
            kdm.fY.add(String.valueOf(localJSONArray2.getLong(i)));
            i += 1;
            continue;
          }
        }
  ...
  public void d(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localObject = localkdm.a(paramMessageRecord.senderuin);
      ((EcShopData)localObject).mLastMsgTime = paramMessageRecord.time;
      paramMessageRecord = this.app.b().a(((EcShopData)localObject).mUin, 1008);
      ...
      localkdm.a((EcShopData)localObject);
  ...
  public void e(MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      {
        localObject1 = new kds.a();
        ((kds.a)localObject1).aId = 1;
        localObject1 = kds.a((kds.a)localObject1, paramMessageRecord);
        ((kds)this.app.getBusinessHandler(139)).a((kds.a)localObject1, null);
        if ((paramMessageRecord instanceof MessageForStructing))
        {
          paramMessageRecord = ((MessageForStructing)paramMessageRecord).structingMsg;
          if (!(paramMessageRecord instanceof StructMsgForGeneralShare)) {
          ...
          tlb.a(0, 2, kdm.a(paramMessageRecord));
          if ((paramMessageRecord == null) || (paramMessageRecord.dLY != 100) || (!(paramMessageRecord.e instanceof StructMsgForGeneralShare))) {
            return;
          }
          kee.S(paramMessageRecord.cdl, false);
          kee.a(this.app, "qgg.push.arrive", ((StructMsgForGeneralShare)paramMessageRecord.e).mContentTitle, NetConnInfoCenter.getServerTimeMillis() + "", "");
          return;
        }
        ...
        localObject1 = paramMessageRecord.optJSONObject("thirdparty_monitor_urls");
        ...
        localObject3 = ((JSONObject)localObject1).optJSONArray("api_click_monitor_url");
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.ThirdPartyMonitorUrls)localObject2).api_click_monitor_url.set(jsonArrayToList((JSONArray)localObject3));
        localObject3 = ((JSONObject)localObject1).optJSONArray("api_exposure_monitor_url");
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.ThirdPartyMonitorUrls)localObject2).api_exposure_monitor_url.set(jsonArrayToList((JSONArray)localObject3));
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.ThirdPartyMonitorUrls)localObject2).sdk_click_monitor_url.set(jsonArrayToList(((JSONObject)localObject1).optJSONArray("sdk_click_monitor_url")));
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.ThirdPartyMonitorUrls)localObject2).sdk_exposure_monitor_url.set(jsonArrayToList(((JSONObject)localObject1).optJSONArray("sdk_exposure_monitor_url")));
        paramMessageRecord.thirdparty_monitor_urls.set((MessageMicro)localObject2);
        localObject1 = new qq_ad_get.QQAdGetRsp.AdInfo();
        ((qq_ad_get.QQAdGetRsp.AdInfo)localObject1).report_info.set(paramMessageRecord);
        tlb.a(0, 2, (qq_ad_get.QQAdGetRsp.AdInfo)localObject1);
        return;
      }
    }
    catch (Throwable paramMessageRecord)
    ...
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      ...
      if (localObject3 != null)
      {
        ...
        {
          kee.S(((JSONObject)localObject3).optInt("tab_id"), false);
          kee.a(this.app, "qgg.push.arrive", ((MessageForArkApp)localObject2).msg, NetConnInfoCenter.getServerTimeMillis() + "", "");
        }
      }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          paramToServiceMsg = (kdm)this.app.getManager(88);
          localObject1 = paramToServiceMsg.am();
          try
          {
    ...
    kdm.Yr = String.valueOf(l);
    localObject1 = ((SharedPreferences)localObject1).edit();
    if (l != 0L) {
      paramToServiceMsg.lU(String.valueOf(l));
    }
