  ...
  extends MSFServlet
{
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    obd.d(arrayOfByte, (String)localObject);
    ...
    for (;;)
    {
      try
      {
        ...
        if ((paramIntent.getBooleanExtra("useNewProtocol", false)) || (((super.getAppRuntime() instanceof QQAppInterface)) && (ocp.d((QQAppInterface)super.getAppRuntime(), l + "") != -4)))
        {
