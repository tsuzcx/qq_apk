  ...
  extends atsn
{
  ...
  {
    QLog.i("FMObserver<FileAssistant>", 1, "[downloadThumb]  ID[" + paramLong + "] OnGetDiscVideoThumbInfo, bSuccess[" + paramBoolean + " retCode:" + paramInt1 + " downloadIp:" + paramString4 + " downloadDomain:" + paramString5 + " port:" + paramInt2 + " url:" + paramString6);
    attd.a locala = attd.a(this.b, paramLong, false);
    if (locala == null)
    {
      QLog.e("FMObserver<FileAssistant>", 2, "[downloadThumb]  ID[" + paramLong + "] OnGetDiscVideoThumbInfo no this session");
    ...
    {
      QLog.w("FMObserver<FileAssistant>", 2, "[downloadThumb]  ID[" + paramLong + "] OnGetDiscVideoThumbInfo url=null");
      this.b.app.a().b(false, 50, new Object[] { locala.h });
      this.b.jn(paramLong);
      this.b.a(paramLong, false, null, 0, null, null, paramString2);
      return;
