...
public class ainz
{
  private static String TAG = "ListenTogether.PushHelper";
  private static final String bPl = acfp.m(2131695320);
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, TroopTips0x857.MediaChangePushInfo paramMediaChangePushInfo)
  {
    if (paramMediaChangePushInfo != null)
    {
      ...
      if (paramMediaChangePushInfo.uint32_msg_type.has())
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i(TAG, 2, "decodeGroupPush, msg_type = " + i + " groupUin = " + str1 + " oper_uin = " + str2 + " gray_tips = " + str3 + " timeStamp = " + l1 + " joinedNum = " + j);
        }
        ...
        QLog.d(TAG, 1, String.format("decodeGroupPush, filter oldTimeStamp: %s, timeStamp: %s, msyType: %s, groupUin: %s", new Object[] { Long.valueOf(l1), Long.valueOf(l2), Integer.valueOf(i), str1 }));
      }
      label328:
      label331:
      label338:
      ...
      do
      {
        ...
        if ((i == 31) || (i == 32))
        {
          localListenTogetherManager.a(1, str1, paramLong1, l1, aiob.k(1, j, 0));
          return;
        }
    ...
    QLog.d(TAG, 1, "decodeGroupPush, pushInfo == null");
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i(TAG, 2, "insertGrayTips begin uin:" + paramString1 + " uinType:" + paramInt1 + " grayTips:" + paramString2 + " sub_type:" + paramInt2 + " msgSeq:" + paramLong1 + " msgTime:" + paramLong2);
    }
    ...
    ahwa localahwa = new ahwa(paramString1, paramString1, paramString2, paramInt1, i, 131083, anaz.gQ());
    if ((paramInt2 == 1) || (paramInt2 == 3))
    {
      i = paramString2.indexOf(bPl);
      if (i == -1) {
        break label340;
      }
      paramString2 = new Bundle();
      paramString2.putInt("key_action", 46);
      localahwa.addHightlightItem(i, i + 4, paramString2);
    }
    for (;;)
    {
      ...
      paramString2.tipParam.bLT = (paramString1 + "_" + paramInt1 + "_listen_together_" + paramLong1 + "_" + paramLong2);
      boolean bool = ahwb.a(paramQQAppInterface, paramString2);
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.i(TAG, 2, "insertGrayTips end  res:" + bool + " grayTipKey:" + paramString2.tipParam.bLT);
      return;
      label340:
      QLog.d(TAG, 1, String.format("grayTips: %s don't contain keyword", new Object[] { paramString2 }));
    }
  }
  
  public static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    String str1;
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.i(TAG, 2, "decodePush0x210_0x11f, msgSeq = " + paramLong1 + " msgTime = " + paramLong2 + " selfUin:" + str1 + " isOffline = " + paramBoolean);
      }
      ...
      try
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i(TAG, 2, "decodePush0x210_0x11f, msg_type = " + i + " friend_uin = " + paramArrayOfByte + " oper_uin = " + str2 + " gray_tips = " + str1 + " timeStamp = " + l1 + " statusTips = " + (String)localObject1);
        }
        if ((TextUtils.isEmpty(paramArrayOfByte)) || (TextUtils.isEmpty(str2)))
        {
          QLog.d(TAG, 1, "filter friendUin: " + paramArrayOfByte + ", operatorUin: " + str2);
          return;
        }
        if (!paramBoolean) {
          break label624;
        ...
        if ((i != 1) && (i != 2) && (i != 3) && (i != 4))
        {
          QLog.d(TAG, 1, "filter offline msg, msgType:" + i);
          return;
        }
      }
      catch (Throwable paramQQAppInterface)
      {
        QLog.i(TAG, 1, "decodePush0x210_0x11f decode error, e=" + paramQQAppInterface.toString());
        return;
      }
    }
    ...
    if (l1 / 1000L < l2)
    {
      QLog.d(TAG, 1, String.format("filter offline msg, timestamp: %s < incUpdateTimeStamp: %s", new Object[] { Long.valueOf(l1 / 1000L), Long.valueOf(l2) }));
      return;
    }
    label624:
    ...
    if (l1 <= l2)
    {
      QLog.d(TAG, 1, String.format("decodePush0x210_0x11f, filter oldTimeStamp: %s, timeStamp: %s, msyType: %s, friendUin: %s", new Object[] { Long.valueOf(l1), Long.valueOf(l2), Integer.valueOf(i), paramArrayOfByte }));
      return;
    }
    for (;;)
    {
      ...
      do
      {
        ...
        if (!TextUtils.isEmpty(str1))
        {
          ...
          return;
          QLog.i(TAG, 1, "decodePush0x210_0x11f pbData = null");
        }
        return;
        if (i == 31) {
          break;
