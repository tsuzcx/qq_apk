...
public class awct
{
  ...
  private static void a(UniAttribute paramUniAttribute, String[] paramArrayOfString)
  {
    ...
    //   18: ldc 10
    //   20: ldc 12
    //   22: invokevirtual 18	com/qq/jce/wup/UniAttribute:get	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    //   25: checkcast 20	java/lang/String
    //   28: checkcast 20	java/lang/String
    //   31: aastore
    //   32: aload_1
    //   33: iconst_0
    //   34: aaload
  ...
  public static JceStruct decode(byte[] paramArrayOfByte, String paramString, int[] paramArrayOfInt, String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      try
      {
        paramArrayOfByte = ((WNSStream)localObject1).unpack(aqnv.J(paramArrayOfByte));
