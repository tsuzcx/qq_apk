...
public class zti
{
  ...
  public static final Point a(Activity paramActivity, int paramInt)
  {
    ...
    for (int i = localDisplayMetrics.widthPixels;; i = localDisplayMetrics.heightPixels) {
      ...
      {
      default: 
        paramInt = i - wja.dp2px(65.0F, paramActivity.getResources());
        localPoint.set(paramInt, paramInt);
        return localPoint;
      }
    }
    localPoint.set(i, fD(i));
    return localPoint;
  }
  ...
  public static String a(List<zri> paramList, TroopInfo paramTroopInfo)
  {
    String str = zri.baD;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localTroopClipPic.type == 1) {
        ...
        paramList.add(zri.a(localTroopClipPic, paramTroopInfo.mTroopVerifyingPics));
      }
    }
    if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static void a(Activity paramActivity, Intent paramIntent, String paramString, int paramInt)
  {
    ...
    paramIntent.putExtra("PhotoConst.ORIGIN_WITH_CLIPINFO", hr(paramInt));
    paramIntent.putExtra("PhotoConst.IS_WITH_PENDANT", false);
    PhotoUtils.a(paramIntent, paramActivity, paramActivity.getClass().getName(), localPoint.x, localPoint.y, 640, 640, paramString, pX());
  }
  ...
  public static final void a(Rect paramRect, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if ((paramString.length == 4) && (alab.isNumeric(paramString[0])) && (alab.isNumeric(paramString[1])) && (alab.isNumeric(paramString[2])) && (alab.isNumeric(paramString[3])))
      {
  ...
  public static int calculateInSampleSize(BitmapFactory.Options paramOptions, int paramInt1, int paramInt2)
  {
    ...
    {
      return paramInt1;
      paramInt2 = getInSampleSize(paramInt1, paramInt2, paramOptions.outHeight, paramOptions.outWidth);
      paramInt1 = paramInt2;
    } while (!com.tencent.TMG.utils.QLog.isColorLevel());
  ...
  public static int copySdcardFile(String paramString1, String paramString2)
  {
    ...
    //   6: iconst_0
    //   7: istore_2
    //   8: new 369	java/io/FileInputStream
    //   11: dup
    //   12: aload_0
    //   13: invokespecial 372	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   16: astore_0
    //   17: new 374	java/io/FileOutputStream
    //   20: dup
    //   21: aload_1
    //   22: invokespecial 375	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   25: astore 4
    //   27: sipush 8192
    //   30: newarray byte
    //   32: astore_1
    //   33: aload_0
    //   34: aload_1
    //   35: invokevirtual 381	java/io/InputStream:read	([B)I
    //   38: istore_3
    //   39: iload_3
    //   40: ifle +44 -> 84
    //   43: aload 4
    ...
    //   46: iconst_0
    //   47: iload_3
    //   48: invokevirtual 387	java/io/OutputStream:write	([BII)V
    //   51: goto -18 -> 33
    //   54: astore_1
    //   55: aload_0
    //   56: astore_1
    ...
    //   63: ifnull +7 -> 70
    //   66: aload_1
    //   67: invokevirtual 390	java/io/InputStream:close	()V
    //   70: iload_3
    //   71: istore_2
    //   72: aload_0
    //   73: ifnull +9 -> 82
    //   76: aload_0
    //   77: invokevirtual 391	java/io/OutputStream:close	()V
    //   80: iload_3
    //   81: istore_2
    //   82: iload_2
    //   83: ireturn
    ...
    //   85: ifnull +7 -> 92
    //   88: aload_0
    //   89: invokevirtual 390	java/io/InputStream:close	()V
    //   92: aload 4
    //   94: ifnull -12 -> 82
    //   97: aload 4
    //   99: invokevirtual 391	java/io/OutputStream:close	()V
    //   102: iconst_0
    //   103: ireturn
    //   104: astore_0
    //   105: aload_0
    //   106: invokevirtual 394	java/io/IOException:printStackTrace	()V
    //   109: iconst_0
    //   110: ireturn
    //   111: astore_0
    //   112: aload_0
    //   113: invokevirtual 394	java/io/IOException:printStackTrace	()V
    //   116: goto -24 -> 92
    //   119: astore_1
    //   120: aload_1
    //   121: invokevirtual 394	java/io/IOException:printStackTrace	()V
    //   124: goto -54 -> 70
    //   127: astore_0
    //   128: aload_0
    //   129: invokevirtual 394	java/io/IOException:printStackTrace	()V
    //   132: iconst_m1
    //   133: ireturn
    //   134: astore_1
    //   135: aconst_null
    ...
    //   142: ifnull +7 -> 149
    //   145: aload_0
    //   146: invokevirtual 390	java/io/InputStream:close	()V
    //   149: aload 4
    //   151: ifnull +8 -> 159
    //   154: aload 4
    //   156: invokevirtual 391	java/io/OutputStream:close	()V
    //   159: aload_1
    //   160: athrow
    //   161: astore_0
    //   162: aload_0
    //   163: invokevirtual 394	java/io/IOException:printStackTrace	()V
    //   166: goto -17 -> 149
    //   169: astore_0
    //   170: aload_0
    //   171: invokevirtual 394	java/io/IOException:printStackTrace	()V
    //   174: goto -15 -> 159
    //   177: astore_1
    //   178: aload 5
    //   180: astore 4
  ...
  {
    if (paramInt == 0) {
      return paramContext.getString(2131719574);
    }
    if (paramInt == 1) {
      return paramContext.getString(2131698318);
    }
    if (paramInt == 2) {
      return paramContext.getString(2131698317);
    }
    if (paramInt == 3) {
      return paramContext.getString(2131698319);
    }
    if (paramInt == 5) {
      return paramContext.getString(2131698316);
    }
    if (paramInt == 100) {
      return paramContext.getString(2131698300);
    }
    if (paramInt == 101) {
      return paramContext.getString(2131698301);
    }
    if (paramInt == 102) {
      return paramContext.getString(2131698298);
    }
    if (paramInt == 103) {
      return paramContext.getString(2131698302);
    }
    if (paramInt == 1793) {
      return paramContext.getString(2131694905);
    }
    return paramContext.getString(2131698315);
  }
  ...
  public static URL f(String paramString)
  {
    ...
    do
    {
      ...
      try
      {
        paramString = aomc.l(paramString);
        return paramString;
      }
  ...
  public static final int fE(int paramInt)
  {
    int i = 1;
    if (paramInt == 0) {
      i = 0;
  ...
  public static final int fF(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  public static final int fG(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  public static final boolean hr(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  public static void l(Activity paramActivity, String paramString, int paramInt)
  {
  ...
  public static void p(Activity paramActivity, int paramInt)
  {
    ...
    localIntent.putExtra("PhotoConst.ORIGIN_WITH_CLIPINFO", hr(paramInt));
    PhotoUtils.a(localIntent, paramActivity, paramActivity.getClass().getName(), localPoint.x, localPoint.y, 640, 640, pX());
  }
  ...
  public static String pX()
  {
    ...
    {
      localStringBuilder.append(acbn.bnK).append("tmp/").append(System.currentTimeMillis()).append("_photo.tmp");
  ...
  public static void s(int paramInt, String paramString1, String paramString2)
  {
    ...
    URL localURL = f(apqw.oL(apqw.p(str, paramString2, 1)));
    if (localURL != null)
    {
      paramInt = copySdcardFile(paramString1, aoiz.getFilePath(localURL.toString()));
      if (com.tencent.TMG.utils.QLog.isColorLevel()) {
        com.tencent.TMG.utils.QLog.d("TroopPhotoUtil", 0, "cacheFileFromLocal origin photo,result:" + paramInt);
      }
    }
    paramString2 = f(apqw.oK(apqw.p(str, paramString2, 1)));
    if (paramString2 != null)
    {
      paramInt = u(paramString1, aoiz.getFilePath(paramString2.toString()));
      if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static int u(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      BitmapFactory.Options localOptions = aqhu.a(((File)localObject).getPath(), 100);
      try
      {
        localObject = aqhu.d(((File)localObject).getPath(), localOptions);
      ...
      try
      {
        int i = apuh.U(paramString1);
        paramString1 = (String)localObject;
        if (i != 0) {
          paramString1 = aqhu.d((Bitmap)localObject, i);
        }
        if (paramString1 != null)
        {
          aqhu.saveBitmapToFile(paramString1, paramString2);
          return 0;
        }
      }
