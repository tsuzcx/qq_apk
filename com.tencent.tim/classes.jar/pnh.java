...
public class pnh
{
  protected static plv<String, pnh.a> b = new plv(200);
  ...
  public static File a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (Object localObject = a(paramString, localStoryVideoItem.mCreateTime, paramInt, false, paramBoolean2);; localObject = b(paramString, paramInt, false, paramBoolean2))
    {
    ...
    while ((rnw.fy(paramString)) && (b(paramString, paramInt) != null))
    {
    ...
    {
      if ((localStoryVideoItem != null) && (localStoryVideoItem.isMine())) {}
      for (paramString = a(paramString, localStoryVideoItem.mCreateTime, paramInt, true, paramBoolean2);; paramString = b(paramString, paramInt, true, paramBoolean2)) {
  ...
  public static String a(String paramString, long paramLong, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (rnw.fy(paramString)) {}
    for (String str = plr.atf;; str = plr.atg) {
  ...
  public static String a(String paramString, boolean paramBoolean, long paramLong)
  {
    ...
    Object localObject = getMd5(paramString);
    cl(paramString, (String)localObject);
    return localObject;
  }
  ...
  public static void a(StoryVideoItem paramStoryVideoItem, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        localpsu.a(paramStoryVideoItem.mVid, paramStoryVideoItem);
        return;
  ...
  public static File b(String paramString, int paramInt)
  {
    ...
    for (paramString = (MessageForShortVideo)paramString;; paramString = null)
    {
      ...
      for (;;)
      {
        ...
        label74:
        if (paramInt == 2) {
          paramString = ShortVideoUtils.bw(paramString.thumbMD5, "jpg");
        } else {
          paramString = null;
        }
      }
  ...
  protected static String bS(int paramInt)
  {
    switch (paramInt)
    {
    case 4: 
  ...
  public static void cl(String paramString1, String paramString2)
  {
    pnh.a locala = new pnh.a();
    locala.value = paramString2;
    b.a(paramString1, locala);
  }
  
  public static String fM(String paramString)
  {
    paramString = (pnh.a)b.a(paramString);
    if (paramString != null) {
    ...
    implements plu
  {
    ...
    public void copy(Object paramObject)
    {
      if ((paramObject instanceof a)) {
        this.value = ((a)paramObject).value;
      }
    }
  }
}
