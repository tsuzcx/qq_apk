...
import com.tencent.biz.pubaccount.readinjoy.comment.ReadInJoyCommentListFragment.a;
...
public class ksj
{
  ...
  {
    long l = ((Long)awit.f("family_comment_card_hide_timestamp", Long.valueOf(-1L))).longValue();
    if (l == -1L)
    {
  ...
  public ReadInJoyCommentListFragment a(String paramString, ReadInJoyCommentListFragment.a parama, ksk.a parama1)
  {
    ...
    try
    {
      ...
      localReadInJoyCommentListFragment.a(parama);
      localReadInJoyCommentListFragment.a(parama1);
