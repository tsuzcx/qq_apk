...
public class ahpx
{
  ...
  public static int a(FTSDatabase paramFTSDatabase, ArrayList<FTSEntity> paramArrayList, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = paramFTSDatabase.execSQL("UPDATE " + paramString + " SET cursor=" + (k + i) + " WHERE id=1;");
        boolean bool2 = bool1;
        if (bool1)
        {
          l1 = System.currentTimeMillis();
          bool1 = paramFTSDatabase.anT();
  ...
  public static boolean a(FTSDatabase paramFTSDatabase, TroopIndex paramTroopIndex)
  {
    ...
    return paramFTSDatabase.execSQL(localStringBuilder.toString());
  }
  ...
  public static boolean b(FTSDatabase paramFTSDatabase, String paramString)
  {
    ...
    {
      return false;
      paramFTSDatabase.execSQL("CREATE TABLE IF NOT EXISTS " + paramString + "(id INTEGER PRIMARY KEY AUTOINCREMENT, cursor INTEGER);");
      paramFTSDatabase.execSQL("INSERT INTO " + paramString + "(cursor) VALUES(0);");
    } while (!paramFTSDatabase.anT());
    return true;
  }
