  ...
  extends afeu
{
  ...
  public affa(QQAppInterface paramQQAppInterface)
  {
  ...
  public void aq(long paramLong1, long paramLong2)
  {
    ...
    adjr.hj(2, this.bwG);
    if (QLog.isColorLevel()) {
      QLog.d("MiniRecog.MiniScanDetectModelsDownloadHandler", 2, "download progress: " + this.bwG);
    }
  }
  
  public void cYL()
  {
    boolean bool = ahbj.deleteFile(new File(adjt.sD()));
    if (QLog.isColorLevel()) {
