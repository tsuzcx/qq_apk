  ...
  implements QfilePinnedHeaderExpandableListView.a
{
  ...
  public aggc(QfileLocalFilePicTabView paramQfileLocalFilePicTabView) {}
  ...
  public void Q(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      while (paramInt2 <= i)
      {
        QfileLocalFilePicTabView.a(this.this$0, (FileInfo)this.this$0.b.getChild(paramInt1, paramInt2), this.mIsSelected);
        paramInt2 += 1;
      }
    ...
    if (paramInt2 < paramInt3)
    {
      ...
      localFileInfo = (FileInfo)this.this$0.b.getChild(paramInt1, paramInt2);
      if (!this.mIsSelected) {}
  ...
  public void ag(int paramInt1, int paramInt2)
  {
    ...
    FileInfo localFileInfo = (FileInfo)this.this$0.b.getChild(paramInt1, paramInt2);
    if (localFileInfo == null) {}
    do
    {
      return;
      if (!agmz.d(localFileInfo)) {
        bool = true;
      }
