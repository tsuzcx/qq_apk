...
import com.tencent.mobileqq.listentogether.ListenTogetherHandler.1;
  ...
  extends accg
{
  ...
  public aink(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.a = ((ListenTogetherManager)paramQQAppInterface.getManager(331));
  }
  ...
  private List<MusicInfo> a(aio_media.TypeMusic paramTypeMusic, long paramLong1, long paramLong2)
  {
    ...
    if (paramTypeMusic != null)
    {
      ...
      localList = bj(paramTypeMusic.rpt_msg_song_list.get());
    ...
    label181:
    for (paramTypeMusic.abP = (l + paramLong2);; paramTypeMusic.abP = l)
    {
      QLog.i("ListenTogether.Seek", 1, "handler seek: " + paramTypeMusic.abP + " currentTime: " + System.currentTimeMillis());
      paramTypeMusic.timeStamp = SystemClock.elapsedRealtime();
      paramTypeMusic.abQ = SystemClock.elapsedRealtime();
  ...
  public static List<MusicInfo> bj(List<aio_media.Song> paramList)
  {
  ...
  private void d(int paramInt1, String paramString, int paramInt2, int paramInt3)
  {
    for (;;)
    {
      try
      {
        ...
        ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.app.getCurrentAccountUin(), "QQAIOMediaSvc.media_operation");
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        this.a.p(false, paramInt1, paramString);
        continue;
        if ((paramInt2 != 2) || (this.a == null)) {
          continue;
        }
        this.a.o(false, paramInt1, paramString);
        continue;
      }
      if (QLog.isColorLevel()) {
  ...
  private void e(int paramInt1, String paramString, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.app.getCurrentAccountUin(), "QQAIOMediaSvc.room_operation");
      localToServiceMsg.extraData.putInt("KEY_SESSION_TYPE", paramInt1);
      localToServiceMsg.extraData.putString("KEY_SESSION_UIN", paramString);
      localToServiceMsg.extraData.putInt("KEY_OPERATOR", paramInt2);
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      for (;;)
      {
        ...
        if (this.a != null) {
          if (paramInt2 == 1) {
            this.a.b(false, new ListenTogetherSession(paramInt1, paramString), paramInt3);
          } else if ((paramInt2 == 2) || (paramInt2 == 3)) {
            this.a.c(false, new ListenTogetherSession(paramInt1, paramString), paramInt2);
          }
        }
      }
    }
  ...
  private void jI(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    int i;
    String str;
    ...
    for (int j = paramToServiceMsg.extraData.getInt("KEY_REFRESH_SESSION_BY");; j = -1)
    {
      ...
      if (this.a != null)
      {
        ...
        this.a.a(false, paramToServiceMsg, -1);
      }
    ...
    {
      bool1 = bool2;
      if (!localListenTogetherSession.isValid()) {}
    }
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localListenTogetherSession.status = paramToServiceMsg.enum_aio_state.get();
          localListenTogetherSession.CA = a((aio_media.TypeMusic)paramToServiceMsg.msg_music.get(), l2, l1);
          localListenTogetherSession.ckM = ((aio_media.TypeMusic)paramToServiceMsg.msg_music.get()).bool_allow_member_start.get();
          localListenTogetherSession.jdField_ckN_of_type_Boolean = ((aio_media.TypeMusic)paramToServiceMsg.msg_music.get()).bool_allow_member_add.get();
          localListenTogetherSession.playMode = ((aio_media.TypeMusic)paramToServiceMsg.msg_music.get()).enum_play_mode.get();
          localListenTogetherSession.timeStamp = l2;
          localListenTogetherSession.jdField_ckN_of_type_JavaLangString = String.valueOf(paramToServiceMsg.uint64_create_uin.get());
          if (!TextUtils.isEmpty(localListenTogetherSession.jdField_ckN_of_type_JavaLangString)) {
            localListenTogetherSession.creatorNick = aiob.b(this.app, str, i, localListenTogetherSession.jdField_ckN_of_type_JavaLangString);
          }
          localListenTogetherSession.deR = paramToServiceMsg.enum_user_state.get();
          localListenTogetherSession.themeId = paramToServiceMsg.msg_personal_setting.uint32_theme_id.get();
          k = 0;
          m = 0;
          if (i == 1)
          {
            ...
            i = m;
            localListenTogetherSession.bPm = localListenTogetherSession.I(k, i);
            localListenTogetherSession.deh = paramToServiceMsg.enum_joined_aio_type.get();
            localListenTogetherSession.bPn = String.valueOf(paramToServiceMsg.uint64_joined_id.get());
            localListenTogetherSession.ckL = paramToServiceMsg.bool_joined_is_creater.get();
            localListenTogetherSession.apd = paramToServiceMsg.uint64_aio_identification.get();
            bool1 = true;
            if (this.a != null) {
              this.a.a(bool1, localListenTogetherSession, j);
            }
            if (!QLog.isColorLevel()) {
              break;
            }
  ...
  /* Error */
  private void jJ(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +55 -> 56
    //   4: aload_1
    //   5: getfield 207	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   8: ldc_w 538
    //   11: invokevirtual 542	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   14: istore 8
    //   16: aload_1
    //   17: ifnull +11 -> 28
    //   20: aload_2
    ...
    //   25: ifnonnull +37 -> 62
    //   28: aload_0
    //   29: getfield 20	aink:a	Lcom/tencent/mobileqq/listentogether/ListenTogetherManager;
    //   32: ifnull +14 -> 46
    //   35: aload_0
    //   36: getfield 20	aink:a	Lcom/tencent/mobileqq/listentogether/ListenTogetherManager;
    //   39: iconst_0
    //   40: aconst_null
    //   41: iload 8
    //   43: invokevirtual 545	com/tencent/mobileqq/listentogether/ListenTogetherManager:d	(ZLjava/util/List;Z)V
    //   46: ldc 116
    //   48: iconst_1
    //   49: ldc_w 547
    //   52: invokestatic 135	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   55: return
    //   56: iconst_0
    //   57: istore 8
    //   59: goto -43 -> 16
    ...
    //   63: istore 7
    //   65: aload_1
    //   66: getfield 207	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   69: ldc 209
    //   71: invokevirtual 331	android/os/Bundle:getInt	(Ljava/lang/String;)I
    //   74: istore 6
    //   76: aload_1
    //   77: getfield 207	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   80: ldc 217
    //   82: invokevirtual 335	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   85: astore 12
    //   87: aconst_null
    //   88: astore 11
    //   90: aconst_null
    ...
    //   102: istore 5
    //   104: aload_2
    //   105: invokevirtual 358	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   108: ifeq +383 -> 491
    //   111: aload 10
    //   113: astore 9
    //   115: iload 4
    //   117: istore 5
    //   119: new 549	tencent/aio/media/aio_media$RspSongExtendedInfo
    //   122: dup
    //   123: invokespecial 550	tencent/aio/media/aio_media$RspSongExtendedInfo:<init>	()V
    //   126: astore_2
    //   127: aload 10
    //   129: astore 9
    //   131: iload 4
    ...
    //   137: checkcast 366	[B
    //   140: checkcast 366	[B
    //   143: invokevirtual 551	tencent/aio/media/aio_media$RspSongExtendedInfo:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   146: pop
    //   147: aload 10
    //   149: astore 9
    //   151: iload 4
    //   153: istore 5
    //   155: aload_2
    //   156: getfield 552	tencent/aio/media/aio_media$RspSongExtendedInfo:msg_result	Ltencent/aio/media/aio_media$ResultInfo;
    //   159: invokevirtual 379	tencent/aio/media/aio_media$ResultInfo:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   162: checkcast 376	tencent/aio/media/aio_media$ResultInfo
    //   165: astore_3
    //   166: aload_3
    //   167: ifnull +309 -> 476
    //   170: aload 10
    ...
    //   176: istore 5
    //   178: aload_3
    //   179: getfield 383	tencent/aio/media/aio_media$ResultInfo:uint32_result	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   182: invokevirtual 386	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   185: istore 4
    //   187: iload 4
    //   189: ifne +343 -> 532
    //   192: aload 10
    ...
    //   198: istore 5
    //   200: aload_2
    //   201: getfield 553	tencent/aio/media/aio_media$RspSongExtendedInfo:rpt_msg_song_list	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   204: invokevirtual 43	com/tencent/mobileqq/pb/PBRepeatMessageField:get	()Ljava/util/List;
    //   207: invokestatic 47	aink:bj	(Ljava/util/List;)Ljava/util/List;
    //   210: astore_2
    //   211: aload_2
    //   212: ifnull +14 -> 226
    //   215: aload_2
    //   216: astore_3
    //   217: aload_2
    //   218: invokeinterface 52 1 0
    //   223: ifne +259 -> 482
    //   226: new 139	java/util/ArrayList
    //   229: dup
    //   230: invokespecial 140	java/util/ArrayList:<init>	()V
    //   233: astore_3
    //   234: aload_3
    //   235: astore 9
    //   237: iload 4
    //   239: istore 5
    //   241: aload_1
    //   242: getfield 207	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   245: ldc_w 555
    //   248: invokevirtual 559	android/os/Bundle:getStringArrayList	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   251: astore_1
    //   252: aload_1
    //   253: ifnull +229 -> 482
    //   256: aload_3
    ...
    //   291: istore 5
    //   293: aload_1
    //   294: invokeinterface 572 1 0
    //   299: checkcast 128	java/lang/String
    //   302: astore_2
    //   303: aload_3
    //   304: astore 9
    //   306: iload 4
    //   308: istore 5
    //   310: new 57	com/tencent/mobileqq/listentogether/data/MusicInfo
    //   313: dup
    //   314: invokespecial 573	com/tencent/mobileqq/listentogether/data/MusicInfo:<init>	()V
    //   317: astore 10
    //   319: aload_3
    //   320: astore 9
    //   322: iload 4
    ...
    //   326: aload 10
    //   328: aload_2
    //   329: putfield 576	com/tencent/mobileqq/listentogether/data/MusicInfo:id	Ljava/lang/String;
    //   332: aload_3
    //   333: astore 9
    //   335: iload 4
    //   337: istore 5
    ...
    //   361: dup
    //   362: invokespecial 72	java/lang/StringBuilder:<init>	()V
    //   365: ldc_w 578
    ...
    //   378: invokestatic 135	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   381: goto -111 -> 270
    //   384: astore_1
    //   385: iload 5
    //   387: istore 4
    ...
    //   392: ldc_w 580
    //   395: aload_1
    //   396: invokestatic 257	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   399: invokestatic 114	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   402: ifeq +53 -> 455
    //   405: ldc 116
    //   407: iconst_2
    //   408: ldc_w 582
    //   411: iconst_5
    //   412: anewarray 120	java/lang/Object
    //   415: dup
    //   416: iconst_0
    //   417: iload 6
    //   419: invokestatic 249	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   422: aastore
    //   423: dup
    //   424: iconst_1
    //   425: aload 12
    ...
    //   429: iconst_2
    //   430: iload 7
    //   432: invokestatic 511	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   435: aastore
    //   436: dup
    //   437: iconst_3
    //   438: iload 4
    //   440: invokestatic 249	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   443: aastore
    //   444: dup
    //   445: iconst_4
    //   446: aload 9
    //   448: aastore
    //   449: invokestatic 132	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   452: invokestatic 135	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   455: aload_0
    //   456: getfield 20	aink:a	Lcom/tencent/mobileqq/listentogether/ListenTogetherManager;
    //   459: ifnull -404 -> 55
    //   462: aload_0
    //   463: getfield 20	aink:a	Lcom/tencent/mobileqq/listentogether/ListenTogetherManager;
    //   466: iload 7
    //   468: aload 9
    //   470: iload 8
    //   472: invokevirtual 545	com/tencent/mobileqq/listentogether/ListenTogetherManager:d	(ZLjava/util/List;Z)V
    //   475: return
    //   476: iconst_m1
    //   477: istore 4
    //   479: goto -292 -> 187
    ...
    //   502: ldc_w 584
    //   505: iconst_0
    //   506: anewarray 120	java/lang/Object
    //   509: invokestatic 132	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   512: invokestatic 135	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   515: iconst_m1
    //   516: istore 4
    //   518: aload 11
    //   520: astore 9
  ...
  private void jK(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg == null) || (paramObject == null))
    {
      ...
      for (;;)
      {
        ...
        label87:
        if (k == 2) {
          this.a.o(false, j, str);
        } else if (k == 3) {
          this.a.q(false, j, str);
        } else if (k == 4) {
          this.a.b(false, j, str, m);
        }
      }
    }
    bool = false;
  ...
  private void jL(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    int j;
    label30:
    label45:
    ...
    if (paramToServiceMsg != null)
    {
      ...
      if (this.a != null)
      {
        ...
        this.a.b(false, paramToServiceMsg, k);
      }
    }
    label136:
    label144:
    ...
    this.a.c(false, paramToServiceMsg, i);
    return;
    label180:
    bool2 = false;
    ...
    {
      bool1 = bool2;
      if (!((ListenTogetherSession)localObject).isValid()) {}
    }
    for (;;)
    {
      try
      ...
      catch (Exception paramToServiceMsg)
      {
        ...
        this.a.c(bool1, (ListenTogetherSession)localObject, i);
        continue;
        paramToServiceMsg = "";
        continue;
      }
      if (this.a != null)
      {
        ...
        this.a.b(bool1, (ListenTogetherSession)localObject, k);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  private void jM(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    String str;
    if (paramToServiceMsg != null)
    {
  ...
  private void jP(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      this.a.s(false, new Object[] { Integer.valueOf(-1), "" });
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramToServiceMsg != null)
        {
          ...
          bool = true;
          paramFromServiceMsg.s(bool, new Object[] { Integer.valueOf(i), paramToServiceMsg });
          return;
        }
      }
  ...
  {
    d(paramInt1, paramString, 4, paramInt2);
  }
  
  public void H(int paramInt1, String paramString, int paramInt2)
  {
    d(paramInt1, paramString, 3, paramInt2);
  }
  
  public void I(int paramInt1, String paramString, int paramInt2)
  {
    e(paramInt1, paramString, 1, paramInt2);
  }
  ...
  public void LM(String paramString)
  {
    ...
    try
    {
      ...
      ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.app.getCurrentAccountUin(), "QQAIOMediaSvc.get_play_show_info");
      localToServiceMsg.extraData.putString("KEY_SESSION_UIN", paramString);
  ...
  public void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, List<String> paramList)
  {
    do
    {
      ...
      paramString2 = new ToServiceMsg("mobileqq.service", this.app.getCurrentAccountUin(), "QQAIOMediaSvc.report_download_fail");
  ...
  public void a(int paramInt, String paramString, List<aioc> paramList, boolean paramBoolean)
  {
    if ((paramList == null) || (paramList.size() == 0))
    {
      if (this.a != null) {
        this.a.d(false, null, paramBoolean);
      }
    ...
    try
    {
      ...
      {
        aioc localaioc = (aioc)paramList.next();
        aio_media.SongExtendedReqParam localSongExtendedReqParam = new aio_media.SongExtendedReqParam();
        localSongExtendedReqParam.str_song_id.set(localaioc.id);
        localSongExtendedReqParam.bool_need_lyric.set(localaioc.ckP);
        localSongExtendedReqParam.bool_need_url.set(localaioc.ckO);
        localArrayList2.add(localSongExtendedReqParam);
        localArrayList1.add(localaioc.id);
      }
    ...
    paramList = new ToServiceMsg("mobileqq.service", this.app.getCurrentAccountUin(), "QQAIOMediaSvc.get_song_extended_info");
  ...
  public void bm(JSONObject paramJSONObject)
  {
    try
    {
      ...
      localObject = new ToServiceMsg("mobileqq.service", this.app.getCurrentAccountUin(), "QQAIOMediaSvc.share_trans_check");
  ...
  public void bn(JSONObject paramJSONObject)
  {
    try
    {
      ...
      localObject1 = new ToServiceMsg("mobileqq.service", this.app.getCurrentAccountUin(), "QQAIOMediaSvc.share_trans");
    ...
    {
      this.a.br(false, new Object[] { Integer.valueOf(-1), "" });
    }
  }
  
  public void cJ(int paramInt, String paramString)
  {
    d(paramInt, paramString, 1, 0);
  }
  
  public void cK(int paramInt, String paramString)
  {
    d(paramInt, paramString, 2, 0);
  }
  
  public void cL(int paramInt, String paramString)
  {
    e(paramInt, paramString, 2, 0);
  }
  
  public void cM(int paramInt, String paramString)
  {
    e(paramInt, paramString, 3, 0);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramFromServiceMsg != null)
        {
          ...
          if (!TextUtils.isEmpty(QQMusicPlayService.wZ())) {
            break label271;
          }
          paramToServiceMsg = "";
          paramFromServiceMsg.put("current_song_id", paramToServiceMsg);
          this.a.bq(true, paramFromServiceMsg);
          return;
        }
      }
      catch (Exception paramToServiceMsg)
      ...
      continue;
      label271:
      paramToServiceMsg = QQMusicPlayService.wZ();
    }
    if (QLog.isColorLevel()) {
      QLog.d("AioShareMusicListenTogether.handler", 2, "handleCheckAndShowAioShareMusic() result = " + i + " errMsg = " + paramFromServiceMsg.bytes_errmsg.get().toStringUtf8());
    }
    this.a.bq(false, null);
  }
  
  public void jO(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if (paramFromServiceMsg != null) {}
    int i;
    for (;;)
    {
      try
      {
        ...
        if (paramToServiceMsg != null)
        {
          ...
          this.a.br(true, new Object[] { Integer.valueOf(j), paramFromServiceMsg, paramObject });
          return;
        }
      }
      catch (Exception paramToServiceMsg)
    ...
    this.a.br(false, new Object[] { Integer.valueOf(i), paramToServiceMsg });
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      jI(paramToServiceMsg, paramFromServiceMsg, paramObject);
      return;
      if ("QQAIOMediaSvc.get_song_extended_info".equals(paramFromServiceMsg.getServiceCmd()))
      {
        jJ(paramToServiceMsg, paramFromServiceMsg, paramObject);
        return;
      }
    ...
    } while (!"QQAIOMediaSvc.report_download_fail".equals(paramFromServiceMsg.getServiceCmd()));
