...
public class jqo
{
  ...
  public static final void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, long paramLong1, long paramLong2, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        anot.a(paramQQAppInterface, "P_CliOper", "qqconnect", paramString1, paramString2, paramString3, 0, 0, str2, str1, paramString4, "");
        return;
      }
    }
  }
  ...
  public static final String aW(int paramInt)
  {
    String str = "";
    if (paramInt == 0) {
      str = "contact";
  ...
  {
    return getSpecifiedLevelDomain(paramString, 1);
  }
    ...
    if (i < arrayOfFile.length)
    {
      ...
      for (;;)
      {
        ...
        if (arrayOfFile[i].isFile()) {
          ...
          dn(arrayOfFile[i].getAbsolutePath());
        }
      }
    }
    paramString.delete();
