  ...
  extends MSFServlet
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), acoe.class);
  ...
  public static void c(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2)
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), acoe.class);
    localNewIntent.putExtra("param_req_type", 114);
  ...
  public static void e(QQAppInterface paramQQAppInterface, ArrayList<String> paramArrayList)
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), acoe.class);
  ...
  private void j(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    acof localacof = (acof)getAppRuntime().getManager(85);
    ...
    for (;;)
    {
      ...
      localacof.b(paramFromServiceMsg, 2);
      label658:
      localBundle.putInt("key_rt_type", i);
      notifyObserver(paramIntent, 113, true, localBundle, acog.class);
      return;
            ...
            if (localObject != null)
            {
              ...
              if ((i == 0) && (((oidb_sso.OIDBSSOPkg)localObject).bytes_bodybuffer.has()) && (((oidb_sso.OIDBSSOPkg)localObject).bytes_bodybuffer.get() != null))
              {
                ...
                try
                {
                  ...
                  paramIntent = (acof)getAppRuntime().getManager(85);
  ...
  public void b(Intent paramIntent, Packet paramPacket)
  {
    ...
    if (bool2)
    {
      ...
      localReqHelloType.string_qua.set(avpq.getQUA3());
    ...
    for (int i = j;; i = 0)
    {
      ...
      ((cmd0x7c9.ReqBody)localObject).string_qua.set(avpq.getQUA3());
      paramIntent = new oidb_sso.OIDBSSOPkg();
  ...
  public void c(Intent paramIntent, Packet paramPacket)
  {
    ...
    paramIntent.uint32_inst_id.set(AppSetting.getAppId());
