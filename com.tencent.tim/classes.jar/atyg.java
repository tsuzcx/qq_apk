  ...
  extends atyn
{
  ...
  public atyg(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    this.mApp = paramQQAppInterface;
    this.c = paramFileManagerEntity;
    if ((1 == getCloudType()) || (2 == getCloudType())) {
      this.ceX = audx.b(this.mApp.getApplication().getBaseContext(), paramFileManagerEntity.fileName, paramFileManagerEntity.fileSize);
    }
    this.aaa = 3145728L;
    if (3 == getCloudType())
    {
  ...
  public int bF()
  {
    if ((this.c.isZipInnerFile) && (aueh.fileExistsAndNotEmpty(this.c.getFilePath()))) {
      this.c.status = 1;
    }
