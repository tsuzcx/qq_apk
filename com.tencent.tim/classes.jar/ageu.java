  ...
  implements QfilePinnedHeaderExpandableListView.a
{
  ...
  public ageu(QfileCloudFileTabView paramQfileCloudFileTabView) {}
  ...
  public void Q(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      while (paramInt2 <= i)
      {
        QfileCloudFileTabView.a(this.this$0, (WeiYunFileInfo)this.this$0.b.getChild(paramInt1, paramInt2), this.mIsSelected);
        paramInt2 += 1;
      }
    ...
    if (paramInt2 < paramInt3)
    {
      ...
      localWeiYunFileInfo = (WeiYunFileInfo)this.this$0.b.getChild(paramInt1, paramInt2);
      if (!this.mIsSelected) {}
  ...
  public void ag(int paramInt1, int paramInt2)
  {
    ...
    WeiYunFileInfo localWeiYunFileInfo = (WeiYunFileInfo)this.this$0.b.getChild(paramInt1, paramInt2);
    if (localWeiYunFileInfo == null) {}
    do
    {
      return;
      if (!agmz.c(localWeiYunFileInfo)) {
        bool = true;
      }
