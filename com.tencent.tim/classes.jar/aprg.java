...
public class aprg
{
  ...
  {
    paramString1 = bO(paramString1, paramString2);
    paramString2 = new Intent(paramContext, QQBrowserActivity.class);
    paramString2.putExtra("url", paramString1);
    paramString2.putExtra("selfSet_leftViewText", acfp.m(2131713972));
    if (arap.sPluginNameSpaceHashMap.containsKey("robotsummary")) {
  ...
  public static boolean V(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (paramQQAppInterface != null) {
      return paramQQAppInterface.gM(paramString);
    }
    return false;
  }
    ...
    do
    {
      do
      {
        do
        {
          return bool1;
          bool1 = bool2;
        } while (!X(paramQQAppInterface, paramString));
  ...
  public static boolean X(QQAppInterface paramQQAppInterface, String paramString)
  {
    boolean bool1;
    if ((TextUtils.isEmpty(paramString)) || (paramString == "0"))
    {
    ...
    {
      return bool1;
      if (bP(paramQQAppInterface)) {
        return true;
      }
      bool2 = U(paramQQAppInterface, paramString);
      bool1 = bool2;
    } while (!QLog.isColorLevel());
  ...
  public static void Z(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
  ...
  public static String a(AbsShareMsg paramAbsShareMsg, String paramString)
  {
    ...
    do
    {
      ...
      return null;
      paramString = bM(paramAbsShareMsg.mMsgUrl, paramString);
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, int paramInt)
  {
    ...
    paramString5 = wja.a(new Intent(paramContext, SplashActivity.class), null);
    if (paramInt == 1)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((paramQQAppInterface != null) && (!V(paramQQAppInterface, paramString2)));
      ...
      paramQQAppInterface = bO(paramString1, paramString2);
      paramString1 = acfp.m(2131713973) + paramString2;
      localObject2 = new AbsShareMsg.a(StructMsgForGeneralShare.class).c(14).a(acfp.m(2131713976) + paramString3).a(2).a(1).a("web", paramQQAppInterface, (String)localObject2, (String)localObject1, (String)localObject1).d(paramActivity.getResources().getString(2131718647)).a();
      anug localanug = new anug();
      localanug.Vs(1);
      localanug.Rn(acfp.m(2131713975));
      antd localantd = new antd();
      localantd.Vs(1);
      localantd.a(new ansr((String)localObject1));
      localantd.a(new StructMsgItemTitle(paramString3));
      localantd.a(new anux(paramString1));
      ((AbsShareMsg)localObject2).addItem(localanug);
      ...
      ahgq.f(paramActivity, (Intent)localObject2, paramInt);
    } while (!QLog.isColorLevel());
  ...
  public static void aP(boolean paramBoolean, String paramString)
  {
    ...
    for (localObject = (QQAppInterface)localObject;; localObject = null)
    {
      ...
      ((aptw)localObject).aR(paramBoolean, paramString);
      return;
    }
  }
  
  public static void aa(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
  ...
  public static void ab(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
  ...
  public static ArrayList<String> ac(String paramString)
  {
  ...
  public static boolean b(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    if (!V(localQQAppInterface, paramString2))
    {
      QLog.i("RobotUtils", 2, "notifyMemChange err" + paramString2);
      return false;
    }
    ((acms)localQQAppInterface.getBusinessHandler(20)).a(paramString1, paramString2, paramString3, Boolean.valueOf(paramBoolean));
    return true;
  }
  ...
  public static String bM(String paramString1, String paramString2)
  {
    ...
    return G(paramString1, "gc", paramString2);
  }
  
  public static final String bN(String paramString1, String paramString2)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      return null;
    }
  ...
  public static boolean bN(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return false;
    }
    paramQQAppInterface = (aptw)paramQQAppInterface.getManager(203);
    if (paramQQAppInterface != null) {
      return paramQQAppInterface.aBz();
    }
    return false;
  }
  ...
  public static boolean bO(QQAppInterface paramQQAppInterface)
  {
    boolean bool1 = false;
    paramQQAppInterface = f(paramQQAppInterface);
    if (paramQQAppInterface == null) {}
  ...
  public static boolean c(QQAppInterface paramQQAppInterface, ArrayList<String> paramArrayList)
  {
    boolean bool2 = false;
    boolean bool1 = false;
    if (paramArrayList != null)
  ...
  public static void d(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    try
    {
      Long.parseLong(paramString2);
      anot.a(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, paramString2, "", paramString3, "");
      return;
    }
    catch (Exception paramString2)
    {
      anot.a(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, "0", "", paramString3, "");
    }
  }
  
  public static SharedPreferences f(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null)
    {
  ...
  public static void j(BaseActivity paramBaseActivity, String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
    ...
    paramString = oM(paramString);
    Intent localIntent = new Intent(paramBaseActivity, QQBrowserActivity.class);
    localIntent.putExtra("url", paramString);
    localIntent.putExtra("selfSet_leftViewText", acfp.m(2131713974));
    if (arap.sPluginNameSpaceHashMap.containsKey("robotsummary")) {
  ...
  public static ArrayList<String> k(QQAppInterface paramQQAppInterface)
  {
    paramQQAppInterface = f(paramQQAppInterface);
    Object localObject;
    if (paramQQAppInterface == null) {
    ...
    {
      return localObject;
      localObject = ac(paramQQAppInterface.getString("sp_new_robot_red_list", ""));
  ...
  public static String kO(String paramString)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      return aqgv.a((QQAppInterface)localAppRuntime, paramString, false);
    }
    return null;
  }
  
  public static ArrayList<String> l(QQAppInterface paramQQAppInterface)
  {
    paramQQAppInterface = f(paramQQAppInterface);
    Object localObject;
    if (paramQQAppInterface == null) {
    ...
    {
      return localObject;
      localObject = ac(paramQQAppInterface.getString("sp_history_robot_red_list", ""));
      paramQQAppInterface = (QQAppInterface)localObject;
      if (localObject == null) {
        paramQQAppInterface = new ArrayList();
      }
  ...
  public static boolean qI(String paramString)
  {
    ...
    } while ((TextUtils.isEmpty(str)) || (!str.equalsIgnoreCase(paramString.substring(0, str.length()))) || (TextUtils.isEmpty(bN(paramString, "robot_uin"))));
    return true;
  }
  ...
  public static void z(QQAppInterface paramQQAppInterface, long paramLong)
  {
    paramQQAppInterface = f(paramQQAppInterface);
    if (paramQQAppInterface == null) {}
    long l;
