...
public class aszr
{
    ...
    throws java.io.IOException
  {
    ...
    //   16: astore 7
    //   18: aload_0
    //   19: invokevirtual 76	java/io/File:exists	()Z
    //   22: ifeq +142 -> 164
    //   25: aload 9
    //   27: astore 7
    //   29: aload_0
    //   30: invokevirtual 80	java/io/File:length	()J
    //   33: lconst_0
    //   34: lcmp
    //   35: ifle +129 -> 164
    //   38: new 82	java/io/FileInputStream
    //   41: dup
    //   42: aload_0
    //   43: invokespecial 85	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   46: astore 8
    //   48: aload 8
    //   50: astore 7
    //   52: aload_0
    //   53: invokevirtual 80	java/io/File:length	()J
    //   56: lstore_1
    //   57: aload 8
    //   59: astore 7
    //   61: sipush 4096
    ...
    //   77: aload 8
    //   79: aload_0
    //   80: invokevirtual 89	java/io/FileInputStream:read	([B)I
    //   83: i2l
    //   84: lstore 5
    //   86: lload 5
    //   88: ldc2_w 90
    ...
    //   111: aload 8
    //   113: astore 7
    //   115: getstatic 40	aszr:messagedigest	Ljava/security/MessageDigest;
    //   118: aload_0
    //   119: iconst_0
    //   120: lload_3
    //   121: l2i
    //   122: invokestatic 97	java/nio/ByteBuffer:wrap	([BII)Ljava/nio/ByteBuffer;
    //   125: invokevirtual 101	java/security/MessageDigest:update	(Ljava/nio/ByteBuffer;)V
    //   128: goto -61 -> 67
    //   131: astore 7
    //   133: aload 8
    //   135: astore_0
    ...
    //   141: astore 7
    //   143: aload 8
    //   145: invokevirtual 104	java/lang/Throwable:printStackTrace	()V
    //   148: aload 9
    //   150: astore 7
    //   152: aload_0
    //   153: ifnull +11 -> 164
    //   156: aload_0
    //   157: invokevirtual 107	java/io/FileInputStream:close	()V
    //   160: aload 9
    //   162: astore 7
    //   164: aload 7
    //   166: areturn
    ...
    //   169: astore 7
    //   171: aload 8
    //   173: invokevirtual 107	java/io/FileInputStream:close	()V
    //   176: aload 8
    //   178: astore 7
    //   180: getstatic 40	aszr:messagedigest	Ljava/security/MessageDigest;
    //   183: invokevirtual 111	java/security/MessageDigest:digest	()[B
    //   186: astore 11
    //   188: aload 10
    //   190: astore_0
    //   191: aload 11
    ...
    //   198: astore 7
    //   200: aload 11
    //   202: invokestatic 113	aszr:bufferToHex	([B)Ljava/lang/String;
    //   205: astore_0
    //   206: aload_0
    //   207: astore 7
    //   209: aload 8
    //   211: ifnull -47 -> 164
    //   214: aload 8
    //   216: invokevirtual 107	java/io/FileInputStream:close	()V
    //   219: aload_0
    //   220: areturn
    //   221: astore 7
    //   223: aload 7
    //   225: invokevirtual 114	java/io/IOException:printStackTrace	()V
    //   228: aload_0
    //   229: areturn
    //   230: astore_0
    //   231: aload_0
    //   232: invokevirtual 114	java/io/IOException:printStackTrace	()V
    //   235: aconst_null
    //   236: areturn
    //   237: astore_0
    //   238: aconst_null
    ...
    //   243: ifnull +8 -> 251
    //   246: aload 7
    //   248: invokevirtual 107	java/io/FileInputStream:close	()V
    //   251: aload_0
    //   252: athrow
    //   253: astore 7
    //   255: aload 7
  ...
  public static String getFileMd5BigFile(String paramString)
  {
    ...
    //   5: astore 9
    //   7: ldc 32
    //   9: invokestatic 38	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   12: astore 10
    //   14: new 82	java/io/FileInputStream
    //   17: dup
    //   18: aload_0
    //   19: invokespecial 126	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   22: astore 8
    //   24: aload 8
    //   26: astore 7
    //   28: new 72	java/io/File
    //   31: dup
    //   32: aload_0
    //   33: invokespecial 127	java/io/File:<init>	(Ljava/lang/String;)V
    //   36: invokevirtual 80	java/io/File:length	()J
    //   39: lstore 5
    //   41: lload 5
    //   43: ldc2_w 122
    //   46: lcmp
    ...
    //   70: aload 8
    //   72: aload_0
    //   73: invokevirtual 130	java/io/InputStream:read	([B)I
    //   76: istore_2
    //   77: iload_2
    //   78: iconst_m1
    //   79: if_icmpeq +62 -> 141
    ...
    //   106: iconst_0
    //   107: iload_1
    //   108: invokevirtual 133	java/security/MessageDigest:update	([BII)V
    //   111: goto -51 -> 60
    //   114: astore_0
    //   115: aload 8
    //   117: astore 7
    //   119: aload_0
    //   120: invokevirtual 134	java/security/NoSuchAlgorithmException:printStackTrace	()V
    //   123: aload 9
    //   125: astore_0
    //   126: aload 8
    //   128: ifnull +11 -> 139
    //   131: aload 8
    //   133: invokevirtual 135	java/io/InputStream:close	()V
    //   136: aload 9
    //   138: astore_0
    //   139: aload_0
    //   140: areturn
    ...
    //   152: astore 7
    //   154: aload 10
    //   156: invokevirtual 111	java/security/MessageDigest:digest	()[B
    //   159: invokestatic 113	aszr:bufferToHex	([B)Ljava/lang/String;
    //   162: astore_0
    //   163: aload_0
    //   164: astore 7
    //   166: aload 7
    ...
    //   171: ifnull -32 -> 139
    //   174: aload 8
    //   176: invokevirtual 135	java/io/InputStream:close	()V
    //   179: aload 7
    //   181: areturn
    //   182: astore_0
    //   183: aload 7
    ...
    //   192: astore 7
    //   194: aload_0
    //   195: invokevirtual 136	java/io/FileNotFoundException:printStackTrace	()V
    //   198: aload 9
    //   200: astore_0
    //   201: aload 8
    //   203: ifnull -64 -> 139
    //   206: aload 8
    //   208: invokevirtual 135	java/io/InputStream:close	()V
    //   211: aconst_null
    //   212: areturn
    //   213: astore_0
    //   214: aconst_null
    ...
    //   233: ifnull -94 -> 139
    //   236: aload 8
    //   238: invokevirtual 135	java/io/InputStream:close	()V
    //   241: aconst_null
    //   242: areturn
    //   243: astore_0
    //   244: aconst_null
    ...
    //   252: astore 7
    //   254: aload_0
    //   255: invokevirtual 104	java/lang/Throwable:printStackTrace	()V
    //   258: aload 9
    //   260: astore_0
    //   261: aload 8
    //   263: ifnull -124 -> 139
    //   266: aload 8
    //   268: invokevirtual 135	java/io/InputStream:close	()V
    //   271: aconst_null
    //   272: areturn
    //   273: astore_0
    //   274: aconst_null
    ...
    //   282: ifnull +8 -> 290
    //   285: aload 7
    //   287: invokevirtual 135	java/io/InputStream:close	()V
    //   290: aload_0
    //   291: athrow
    //   292: astore_0
    //   293: aconst_null
