  ...
  implements aolm.a
{
  ...
  public aomk(aooi paramaooi, aool paramaool)
  {
  ...
  {
    return aqul.getSDKPrivatePath(acbn.SDCARD_PATH + Utils.Crc64String(paramQQAppInterface.getAccount()) + "/" + "ptt" + "/pa_audio_" + paramString + ".amr");
  }
  ...
  public int KH()
  {
    ...
    this.h.clR = aqul.getSDKPrivatePath(acbn.SDCARD_PATH + Utils.Crc64String(this.app.getAccount()) + "/" + "ptt" + "/pa_audio_" + str + ".amr");
    return 0;
  }
  ...
  protected void f(com.tencent.qphone.base.remote.ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    //   1: ldc 127
    //   3: ldc_w 596
    //   6: invokevirtual 133	aomk:hM	(Ljava/lang/String;Ljava/lang/String;)V
    //   9: aload_2
    //   10: invokevirtual 599	com/tencent/qphone/base/remote/FromServiceMsg:getResultCode	()I
    //   13: sipush 1000
    //   16: if_icmpeq +38 -> 54
    //   19: aload_2
    //   20: invokevirtual 599	com/tencent/qphone/base/remote/FromServiceMsg:getResultCode	()I
    //   23: istore 4
    //   25: aload_0
    //   26: ldc_w 601
    //   29: new 195	java/lang/StringBuilder
    //   32: dup
    //   33: invokespecial 196	java/lang/StringBuilder:<init>	()V
    //   36: ldc_w 603
    //   39: invokevirtual 205	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   42: iload 4
    //   44: invokevirtual 606	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   47: invokevirtual 226	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   50: invokevirtual 133	aomk:hM	(Ljava/lang/String;Ljava/lang/String;)V
    //   53: return
    //   54: new 608	tencent/im/cs/cmd0x346/cmd0x346$RspBody
    //   57: dup
    //   58: invokespecial 609	tencent/im/cs/cmd0x346/cmd0x346$RspBody:<init>	()V
    //   61: astore_1
    //   62: aload_1
    //   63: aload_3
    //   64: invokevirtual 613	tencent/im/cs/cmd0x346/cmd0x346$RspBody:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   67: pop
    //   68: aload_1
    //   69: getfield 614	tencent/im/cs/cmd0x346/cmd0x346$RspBody:uint32_cmd	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   72: invokevirtual 617	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   75: ifeq +91 -> 166
    //   78: aload_1
    //   79: getfield 614	tencent/im/cs/cmd0x346/cmd0x346$RspBody:uint32_cmd	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   82: invokevirtual 619	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   85: i2l
    //   86: lstore 5
    //   88: lload 5
    //   90: ldc2_w 620
    ...
    //   94: ifne -41 -> 53
    //   97: aload_1
    //   98: getfield 625	tencent/im/cs/cmd0x346/cmd0x346$RspBody:msg_download_succ_rsp	Ltencent/im/cs/cmd0x346/cmd0x346$DownloadSuccRsp;
    //   101: invokevirtual 628	tencent/im/cs/cmd0x346/cmd0x346$DownloadSuccRsp:has	()Z
    //   104: ifeq -51 -> 53
    //   107: aload_1
    //   108: getfield 625	tencent/im/cs/cmd0x346/cmd0x346$RspBody:msg_download_succ_rsp	Ltencent/im/cs/cmd0x346/cmd0x346$DownloadSuccRsp;
    //   111: invokevirtual 631	tencent/im/cs/cmd0x346/cmd0x346$DownloadSuccRsp:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   114: checkcast 627	tencent/im/cs/cmd0x346/cmd0x346$DownloadSuccRsp
    //   117: getfield 635	tencent/im/cs/cmd0x346/cmd0x346$DownloadSuccRsp:int32_ret_code	Lcom/tencent/mobileqq/pb/PBInt32Field;
    //   120: invokevirtual 638	com/tencent/mobileqq/pb/PBInt32Field:get	()I
    //   123: istore 4
    //   125: invokestatic 330	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   128: ifeq -75 -> 53
    //   131: aload_0
    //   132: ldc_w 601
    //   135: new 195	java/lang/StringBuilder
    //   138: dup
    //   139: invokespecial 196	java/lang/StringBuilder:<init>	()V
    //   142: ldc_w 640
    //   145: invokevirtual 205	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   148: iload 4
    //   150: invokevirtual 606	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   153: invokevirtual 226	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   156: invokevirtual 133	aomk:hM	(Ljava/lang/String;Ljava/lang/String;)V
    //   159: return
    //   160: astore_1
    //   161: aload_1
    //   162: invokevirtual 643	java/lang/Exception:printStackTrace	()V
    //   165: return
    //   166: ldc2_w 644
    //   169: lstore 5
    //   171: goto -83 -> 88
