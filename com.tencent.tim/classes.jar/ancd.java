  ...
  implements anbs
{
  private long a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (long l1 = aqoj.getLongData(arrayOfByte, 0);; l1 = 0L)
    {
      ...
      if (localObject != null)
      {
        ...
        paramMessageHandler.eQ("" + l1, (String)localObject);
      }
      l2 = l1;
      if (paramBoolean1) {
        break;
  ...
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, anax paramanax)
  {
    ...
    for (i = 1;; i = 0)
    {
      if ((!paramanax.cED) && (i == 0)) {
        paramMessageHandler.a().y(3, 1, false);
      }
      paramanax.friendUin = 9998L;
      a(paramMessageHandler, paramMsg, paramanax.isRead, paramanax.cEG, paramanax.cEE);
      if (i == 0) {
        anze.a().a(l1, l2, paramMessageHandler.app);
      }
      return;
    }
  }
