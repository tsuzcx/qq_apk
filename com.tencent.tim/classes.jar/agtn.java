  ...
  extends acdl
{
  ...
  protected void a(long paramLong, float paramFloat)
  {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("DatalineFileModel<FileAssistant>", 2, "DataLine onProgress : opType[" + this.a.c.getOpType() + "], uniseq[" + ((FileManagerEntity)localObject).uniseq + "], nSessionId[" + ((FileManagerEntity)localObject).nSessionId + "], peerType[" + this.a.c.DW() + "]");
      }
  ...
  protected void c(boolean paramBoolean, long paramLong, String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("DatalineFileModel<FileAssistant>", 2, "DataLine onRecvFile : isSuccess[" + paramBoolean + "], uniseq[" + localFileManagerEntity.uniseq + "], nSessionId[" + localFileManagerEntity.nSessionId + "], peerType[" + this.a.c.DW() + "]");
    }
  ...
  protected void d(boolean paramBoolean, long paramLong, String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("DatalineFileModel<FileAssistant>", 2, "DataLine onSendFile : isSuccess[" + paramBoolean + "], uniseq[" + paramString.uniseq + "], nSessionId[" + paramString.nSessionId + "], peerType[" + this.a.c.DW() + "]");
    }
