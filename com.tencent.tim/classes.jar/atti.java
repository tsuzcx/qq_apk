...
import com.tencent.tim.filemanager.core.FileManagerNotifyCenter.2;
  ...
  extends Observable
{
  ...
  MqqHandler g = new attj(this, Looper.getMainLooper());
  
  public atti(QQAppInterface paramQQAppInterface)
  {
