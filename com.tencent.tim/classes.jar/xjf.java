...
{
  xjf(xje paramxje, boolean paramBoolean) {}
  ...
  public void fk(View paramView)
  {
    ...
    if ((paramView instanceof AnimationTextView))
    {
      ...
      f1 = ((AnimationTextView)localObject).touchL - xje.access$000();
      f2 = ((AnimationTextView)localObject).touchT;
      f3 = xje.access$100();
      if (this.awo) {
        f1 = ((AnimationTextView)localObject).touchL - xje.access$200();
      }
    ...
    for (int i = k;; i = -1)
    {
      ...
      {
        afnu.a((aofk.a[])localObject, f1, f2 - f3, bool2, i, j, this.a.app, this.a.sessionInfo, (Activity)this.a.mContext, bool1);
        return;
        label314:
        bool2 = false;
        break;
