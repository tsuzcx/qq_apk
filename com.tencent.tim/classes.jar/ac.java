...
{
  public ac(LiteActivity paramLiteActivity, ArrayList paramArrayList) {}
  
  DataLineMsgRecord a(acde paramacde, String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      localDataLineMsgRecord.sessionid = paramacde.a(0, this.this$0.cM).longValue();
  ...
  void b(List<String> paramList, int paramInt)
  {
    if (paramList == null) {}
    acde localacde;
    int j;
    ...
    {
      return;
      localacde = (acde)this.this$0.app.getBusinessHandler(8);
      j = paramList.size();
      if (j > 3) {
        break;
      }
      ...
      while (i < j)
      {
        localObject = a(localacde, (String)paramList.get(i), paramInt, 0, 0, 0);
        if (localObject != null) {
    ...
    if ((j > 3) && (j < 50))
    {
      ...
      if (i < j)
      {
        localDataLineMsgRecord = a(localacde, (String)paramList.get(i), paramInt, k, j, i);
    ...
    for (;;)
    {
      ...
      if (i < 50)
      {
        localDataLineMsgRecord = a(localacde, (String)paramList.get(i), paramInt, j, 50, i);
        if (localDataLineMsgRecord != null) {
          ((ArrayList)localObject).add(localDataLineMsgRecord);
        }
