...
public class afgc
{
  public static String bDl = "ipsite.png";
  ...
  protected static int CS()
  {
    if (aqft.cC())
    {
      if (aqft.hE() < 1048576L)
      {
        printLog(" RESULT_CODE_SDCARD less 1mb .");
        return 11001;
      }
      printLog(" RESULT_CODE_DOWNLOAD_OTHER_ERROR .");
      return 11011;
    }
    printLog(" RESULT_CODE_SDCARD_UNUSABLE .");
    return 11000;
  }
  ...
  protected static int CT()
  {
    if (aqft.cC())
    {
      ...
      printLog(" RESULT_CODE_LOCAL_FILESYSTEM_FAIL .");
      return 11013;
    }
    printLog(" RESULT_CODE_SDCARD_UNUSABLE .");
    return 11000;
  ...
  public static int a(byte[] paramArrayOfByte, String paramString)
  {
    ...
    do
    {
      ...
      bool = aqhq.a(paramString, paramArrayOfByte, false);
      if (QLog.isColorLevel()) {
  ...
  public static int a(byte[] paramArrayOfByte, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramArrayOfByte = j(paramArrayOfByte, paramString1.getBytes());
      if (paramArrayOfByte == null) {
        return 11017;
      }
      if (QLog.isColorLevel()) {
      ...
      bool = aqhq.a(paramString2, paramArrayOfByte, false);
      if (QLog.isColorLevel()) {
  ...
  public static String a(Context paramContext, QQMessageFacade.Message paramMessage)
  {
    ...
    return paramContext.getString(2131693094);
  }
  ...
  {
    return new int[] { f(new byte[] { (byte)paramArrayOfChar[0], (byte)paramArrayOfChar[1] }, 2), paramArrayOfChar[2] };
  }
  ...
  {
    boolean bool = aqiw.isNetSupport(BaseApplicationImpl.getContext());
    if (!bool) {
      QQToast.a(BaseApplicationImpl.getContext(), 2131693404, 0).show();
    }
    return bool;
  }
  
  public static Drawable c(int paramInt, String paramString)
  {
    Object localObject = null;
    File localFile = new File(z(paramInt, paramString));
  ...
  public static String c(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    return aqoj.C(paramArrayOfByte).toLowerCase();
  }
  ...
  {
    bDl = "ipsite_" + paramString2 + ".png";
    return z(paramInt, paramString1);
  }
  ...
  public static int hg(int paramInt)
  {
    ...
    case 7: 
    default: 
      printLog("default RESULT_CODE_OTHER_ERROR .");
      return 11011;
    case 10: 
      printLog(" RESULT_CODE_NET_UNKNOWN_HOST ");
      return 11002;
    case 9: 
      printLog(" RESULT_CODE_NET_UNUSABLE .");
      return 11003;
    case 8: 
      printLog(" RESULT_CODE_CONTENT_LOSSY .");
      return 11006;
    case 6: 
      printLog(" RESULT_CODE_USER_CANCEL .");
      return 11007;
    case 2: 
      printLog(" RESULT_CODE_NET_CONNECT_TIMEOUT .");
      return 11004;
    case 3: 
      printLog(" RESULT_CODE_NET_SO_TIMEOUT .");
      return 11005;
    case 11: 
      printLog(" RESULT_CODE_SOCKET_EXCEPTION_ERROR .");
      return 11012;
    case 4: 
      return CS();
    case 12: 
      return CT();
    case 14: 
      printLog(" RESULT_CODE_HTTP_RESPONSE_NO_OK .");
      return 11016;
    case 13: 
      printLog(" RESULT_CODE_URL_STRING_ILLEGAL .");
      return 11014;
    }
    printLog(" RESULT_CODE_IS_HTML .");
    return 11021;
  }
  ...
  public static String ky(String paramString)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(afnu.bEq.replace("[epId]", paramString));
    ...
    throws java.io.IOException
  {
    ...
    //   8: aload_0
    //   9: ldc_w 386
    //   12: invokespecial 389	afga:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   15: astore 4
    //   17: aload 4
    //   19: astore_0
    //   20: bipush 10
    ...
    //   29: aload 4
    //   31: aload 5
    //   33: invokevirtual 393	afga:read	([B)I
    //   36: pop
    //   37: iload_3
    //   38: istore_2
    //   39: aload 5
    ...
    //   78: ifnull +10 -> 88
    //   81: aload 4
    //   83: invokevirtual 396	afga:close	()V
    //   86: iload_2
    //   87: istore_3
    //   88: iload_3
    //   89: ireturn
    //   90: astore_0
    //   91: aload_0
    //   92: invokevirtual 397	java/io/IOException:printStackTrace	()V
    //   95: iload_2
    //   96: istore_3
    //   97: invokestatic 97	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   100: ifeq -12 -> 88
    //   103: ldc_w 399
    //   106: iconst_2
    //   107: ldc_w 401
    ...
    //   123: astore_0
    //   124: aload 5
    //   126: invokevirtual 397	java/io/IOException:printStackTrace	()V
    //   129: aload 4
    //   131: astore_0
    ...
    //   157: ifnull -69 -> 88
    //   160: aload 4
    //   162: invokevirtual 396	afga:close	()V
    //   165: iconst_0
    //   166: ireturn
    //   167: astore_0
    //   168: aload_0
    //   169: invokevirtual 397	java/io/IOException:printStackTrace	()V
    //   172: iload_2
    //   173: istore_3
    //   174: invokestatic 97	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   177: ifeq -89 -> 88
    //   180: ldc_w 399
    //   183: iconst_2
    //   184: ldc_w 401
    ...
    //   198: ifnull +7 -> 205
    //   201: aload_0
    //   202: invokevirtual 396	afga:close	()V
    //   205: aload 4
    //   207: athrow
    //   208: astore_0
    //   209: aload_0
    //   210: invokevirtual 397	java/io/IOException:printStackTrace	()V
  ...
  protected static void printLog(String paramString)
  {
    if (QLog.isColorLevel()) {
  ...
  public static byte[] u(String paramString)
  {
    ...
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 279	java/io/File:<init>	(Ljava/lang/String;)V
    //   8: invokevirtual 282	java/io/File:exists	()Z
    //   11: ifeq +63 -> 74
    //   14: new 414	java/io/FileInputStream
    //   17: dup
    //   18: new 274	java/io/File
    //   21: dup
    //   22: aload_0
    //   23: invokespecial 279	java/io/File:<init>	(Ljava/lang/String;)V
    //   26: invokespecial 417	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   29: astore_1
    //   30: aload_1
    //   31: astore_0
    //   32: aload_1
    //   33: invokevirtual 420	java/io/FileInputStream:available	()I
    //   36: newarray byte
    //   38: astore_2
    //   39: aload_1
    //   40: astore_0
    //   41: aload_1
    //   42: aload_2
    //   43: invokevirtual 421	java/io/FileInputStream:read	([B)I
    //   46: pop
    //   47: aload_1
    //   48: ifnull +7 -> 55
    //   51: aload_1
    //   52: invokevirtual 422	java/io/FileInputStream:close	()V
    //   55: aload_2
    //   56: areturn
    //   57: astore_2
    //   58: aconst_null
    ...
    //   61: astore_0
    //   62: aload_2
    //   63: invokevirtual 423	java/io/FileNotFoundException:printStackTrace	()V
    //   66: aload_1
    //   67: ifnull +7 -> 74
    //   70: aload_1
    //   71: invokevirtual 422	java/io/FileInputStream:close	()V
    //   74: aconst_null
    //   75: areturn
    //   76: astore_2
    //   77: aconst_null
    ...
    //   80: astore_0
    //   81: aload_2
    //   82: invokevirtual 397	java/io/IOException:printStackTrace	()V
    //   85: aload_1
    //   86: ifnull -12 -> 74
    //   89: aload_1
    //   90: invokevirtual 422	java/io/FileInputStream:close	()V
    //   93: goto -19 -> 74
    //   96: astore_0
    //   97: goto -23 -> 74
    //   100: astore_1
    ...
    //   104: ifnull +7 -> 111
    //   107: aload_0
    //   108: invokevirtual 422	java/io/FileInputStream:close	()V
    //   111: aload_1
    //   112: athrow
    //   113: astore_0
    //   114: aload_2
  ...
  public static String z(int paramInt, String paramString)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(afnu.bEq.replace("[epId]", paramString));
    switch (paramInt)
