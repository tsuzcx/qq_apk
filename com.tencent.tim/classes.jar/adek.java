...
public class adek
  implements adis.a
{
  public adek(ArConfigService paramArConfigService) {}
  ...
  public void a(boolean paramBoolean, adis.b paramb)
  {
    ...
    if (paramBoolean)
    {
      ArConfigService.d(this.this$0, true);
      if ((ArConfigService.f(this.this$0)) && (ArConfigService.g(this.this$0)) && (ArConfigService.h(this.this$0)) && (ArConfigService.i(this.this$0)) && (ArConfigService.j(this.this$0))) {
        ArConfigService.a(this.this$0).post(new ArConfigService.6.2(this));
      }
    }
    while (ArConfigService.e(this.this$0)) {
      return;
    }
    ArConfigService.a(this.this$0).post(new ArConfigService.6.3(this));
  ...
  public void aj(long paramLong1, long paramLong2)
  {
    ...
    ArConfigService.c(this.this$0, (int)(100L * paramLong1 / paramLong2));
    ...
    if (!ArConfigService.e(this.this$0)) {
      ArConfigService.a(this.this$0).post(new ArConfigService.6.1(this, i));
    }
  }
