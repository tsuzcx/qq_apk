...
public class tez
  implements AdArkAdapter, ArkAppNotifyCenter.b
{
  private AdArkAdapter.ArkNotifyCallback a;
  private View qO;
  
  private wyw a(ArkAppView paramArkAppView, aqjn.a parama)
  {
    wyw localwyw = new wyw();
    parama.e = localwyw;
    int i = paramArkAppView.getWidth();
    int j = paramArkAppView.getHeight();
    localwyw.a(parama.appName, parama.appView, parama.appMinVersion, parama.metaData, parama.scale, parama.d);
  ...
  private void a(ArkAppView paramArkAppView, AdArkAdapter.Params paramParams)
  {
    ...
    paramArkAppView.initArkView(a(paramArkAppView, new aqjn.a(aqjn.a.a(str1, str2, "0.0.0.1", paramParams.metaData, f, null, null))), false);
  ...
  private void a(ArkAppView paramArkAppView, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    paramArkAppView.initArkView(a(paramArkAppView, new aqjn.a(aqjn.a.a(paramString1, paramString2, "0.0.0.1", paramString4, f1, null, null))), false);
    paramArkAppView.setVisibility(0);
  }
  ...
  public View buildArkView(AdArkAdapter.Params paramParams)
  {
    if ((paramParams != null) && (paramParams.isValid()))
    {
      ...
      localArkAppView.setCallback(new tfa(this, localCallback));
      ...
      if ((paramParams.context.get() instanceof Activity))
      {
        ...
        if (localFrameLayout != null)
        {
          ...
          if (this.qO != null) {
            this.qO.getViewTreeObserver().addOnGlobalLayoutListener(new tfb(this, localCallback));
          }
        }
      }
      localArkAppView.setInputCallback(new tfc(this, localCallback));
  ...
  public String getArkFormData(AdArkAdapter.DataParams paramDataParams)
  {
    ...
    try
    {
      ...
      localObject1 = localObject3;
      JSONObject localJSONObject = c(paramDataParams.canvas_json, paramDataParams.form_module_id);
      ...
      localObject1 = localObject3;
      localObject4 = tkv.pbToJson((PBField)localObject4);
  ...
  {
    if (this.a != null) {
      return this.a.notify(paramString1, paramString2, paramString3);
    }
    return false;
  }
  ...
  public void setNotify(WeakReference<AdArkAdapter.ArkNotifyCallback> paramWeakReference)
  {
    ...
    {
      this.a = ((AdArkAdapter.ArkNotifyCallback)paramWeakReference.get());
