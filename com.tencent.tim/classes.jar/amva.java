...
{
  public amva(CloudFileGroupSearchEngine paramCloudFileGroupSearchEngine) {}
  ...
  public void a(List<ampx> paramList, amwt paramamwt)
  {
    synchronized (this.this$0)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        localStringBuilder = localStringBuilder.append(str).append(" | mAddFilesSearchEndListener onSearchEnd ");
        if (paramamwt != null) {
          break label145;
        }
      }
      ...
      for (String str = " request == null ";; str = " request.keyword: " + paramamwt.keyword)
      {
        ...
        if (CloudFileGroupSearchEngine.a(this.this$0, paramamwt)) {
          CloudFileGroupSearchEngine.a(this.this$0, paramList, paramamwt, "add_files_result_list");
        }
        return;
        label113:
