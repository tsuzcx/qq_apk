...
{
  public jsk(Handler paramHandler) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
      ...
      if (paramBundle != null)
      {
        ...
        for (;;)
        {
          ...
          catch (InvalidProtocolBufferMicroException paramBundle)
          {
            ...
            return;
            paramBundle = this.val$handler.obtainMessage();
            paramBundle.arg1 = 0;
            paramBundle.obj = localArrayList;
            this.val$handler.sendMessage(paramBundle);
          }
          try
          {
        ...
        if (paramBundle == null)
        {
          ...
          if ((paramInt == 2) && (localResultItem.jmp_url.has()) && (!TextUtils.isEmpty(localResultItem.jmp_url.get().toStringUtf8())))
          {
            ...
            paramInt = SearchProtocol.aF(paramBundle.optString("color"));
            if (paramInt == 0) {
              break label473;
            }
          }
    ...
    for (;;)
    {
      ...
      localWordItem.frameColor = SearchProtocol.aF(paramBundle.optString("framecolor"));
