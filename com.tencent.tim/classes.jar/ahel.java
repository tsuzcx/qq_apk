...
public class ahel
  extends MSFServlet
{
  public static ArrayList<FlashChatItem> c(byte[] paramArrayOfByte)
  {
    try
    {
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      notifyObserver(paramIntent, 967, false, localBundle, ahei.class);
      return;
      bool = paramFromServiceMsg.isSuccess();
      break;
      localObject = c(paramFromServiceMsg);
    } while (localObject == null);
    ((FlashChatManager)getAppRuntime().getManager(217)).a((ArrayList)localObject, true, paramFromServiceMsg);
    notifyObserver(paramIntent, 967, bool, localBundle, ahei.class);
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    do
    {
      ...
      paramIntent.str_qq_ver.set("3.4.4");
