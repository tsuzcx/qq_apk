...
public class afck
{
  ...
  public static boolean F(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    return paramQQAppInterface.b().a(paramString, 1010).hasReply;
  }
  ...
  public static boolean G(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      if ((paramString.isGameRoom) || (paramString.troopUin.equals(paramQQAppInterface.cAg))) {
        return true;
      }
    }
    return false;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          bool2 = bool3;
          if (paramQQAppInterface.eA(paramMessage.istroop) > 0)
          {
            bool2 = bool3;
            if (bool1) {
              bool2 = true;
  ...
  public static void ae(MessageRecord paramMessageRecord)
  {
  ...
  public static boolean aiI()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        try
        {
          bool = TextUtils.isEmpty(aqgz.getIMSI());
          if (bool) {
            continue;
          }
          i = 1;
  ...
  public static im_msg_body.Elem c(MessageRecord paramMessageRecord)
  {
    Object localObject2 = null;
    Object localObject1;
  ...
  public static String h(long paramLong, boolean paramBoolean)
  {
    ...
    if (i == j + 1)
    {
      ...
      for (localObject = "H点m分";; localObject = "HH:mm")
      {
        ...
        return String.format(acfp.m(2131704688), new Object[] { localObject });
      }
    }
    if (i == j + 2)
    {
      ...
      {
        localObject = new SimpleDateFormat((String)localObject).format(localCalendar.getTime());
        return String.format(acfp.m(2131704689), new Object[] { localObject });
      }
    }
  ...
  public static boolean l(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
  ...
  public static boolean m(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    if (TextUtils.isEmpty(paramString)) {}
    do
    {
  ...
  public static void n(String paramString, Object... paramVarArgs) {}
}
