...
public class arwv
{
  ...
  protected static Comparator strComparator = new arwv.b();
  ...
  protected static byte[] encodeFile(String paramString)
  {
    // Byte code:
    //   0: ldc 114
    //   2: invokestatic 120	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   5: astore_3
    //   6: new 137	java/io/File
    //   9: dup
    //   10: aload_0
    //   11: invokespecial 140	java/io/File:<init>	(Ljava/lang/String;)V
    //   14: astore_0
    //   15: aload_0
    //   16: invokevirtual 144	java/io/File:exists	()Z
    //   19: ifne +5 -> 24
    //   22: aconst_null
    //   23: areturn
    //   24: new 146	java/io/BufferedInputStream
    //   27: dup
    //   28: new 148	java/io/FileInputStream
    //   31: dup
    //   32: aload_0
    //   33: invokespecial 151	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   36: invokespecial 154	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   39: astore_2
    //   40: sipush 4096
    //   43: newarray byte
    //   45: astore_0
    //   46: aload_2
    //   47: aload_0
    //   48: invokevirtual 158	java/io/BufferedInputStream:read	([B)I
    //   51: istore_1
    //   52: iload_1
    //   53: iconst_m1
    //   54: if_icmpeq +26 -> 80
    ...
    //   59: iconst_0
    //   60: iload_1
    //   61: invokevirtual 161	java/security/MessageDigest:update	([BII)V
    //   64: goto -18 -> 46
    //   67: astore_0
    //   68: aload_0
    //   69: invokevirtual 164	java/io/IOException:printStackTrace	()V
    //   72: aload_2
    //   73: invokevirtual 167	java/io/BufferedInputStream:close	()V
    //   76: aconst_null
    //   77: astore_0
    //   78: aload_0
    //   79: areturn
    //   80: aload_3
    //   81: invokevirtual 127	java/security/MessageDigest:digest	()[B
    //   84: astore_0
    //   85: aload_2
    //   86: invokevirtual 167	java/io/BufferedInputStream:close	()V
    //   89: goto -11 -> 78
    //   92: astore_2
    //   93: aload_2
    //   94: invokevirtual 164	java/io/IOException:printStackTrace	()V
    //   97: goto -19 -> 78
    //   100: astore_0
    //   101: aload_0
    //   102: invokevirtual 168	java/io/FileNotFoundException:printStackTrace	()V
    //   105: aconst_null
    //   106: areturn
    //   107: astore_0
    //   108: aload_0
    ...
    //   117: astore_0
    //   118: aload_2
    //   119: invokevirtual 167	java/io/BufferedInputStream:close	()V
    //   122: aload_0
    //   123: athrow
    //   124: astore_0
    //   125: aload_0
    //   126: invokevirtual 169	java/security/NoSuchAlgorithmException:printStackTrace	()V
    //   129: aconst_null
    //   130: areturn
    //   131: astore_2
    //   132: aload_2
    //   133: invokevirtual 164	java/io/IOException:printStackTrace	()V
    //   136: goto -14 -> 122
  ...
  {
    return aqhs.bytes2HexStr(encodeFile(paramString));
  }
  ...
  public static String encodeHexStr(String paramString)
  {
    try
    {
      paramString = aqhs.bytes2HexStr(encode(paramString.getBytes("UTF-8")));
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  {
    return aqhs.bytes2HexStr(encode(paramArrayOfByte));
  }
  ...
  public static String toMD5(String paramString)
  {
    ...
    paramString = new arwv().getMD5(paramString);
