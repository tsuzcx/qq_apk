...
public class apen
{
  ...
  public apen(QQAppInterface paramQQAppInterface, cmd0x383.ApplyFileSearchRspBody.Item paramItem)
  {
    if (paramItem == null) {
      return;
    }
    ...
    if (this.aqV > 0L)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("TroopFileSearchItemData<QFile>", 2, "TroopFileSearchItemData matchUin:" + this.aqV + ", name:" + this.col + ", remark = " + this.com);
      }
    }
