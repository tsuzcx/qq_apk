...
public class QzoneConfig
{
  ...
  public static final String SECONDARY_FLUTTER_ENABLE_UIN_POSTFIX = "flutter_enable_uin_postfix";
  ...
  private ArrayList<WeakReference<a>> mCallback = new ArrayList();
  private avca mStringHelper;
  ...
  {
    registObserver();
    this.mStringHelper = new avca();
  }
  
  private void initConfigUpdateObserver()
  {
    if (this.configUpdateObserver == null) {
      this.configUpdateObserver = new avcd(this, null);
    }
  }
  ...
  private void registObserver()
  {
    ...
    try
    {
      ...
      BaseApplication.getContext().getContentResolver().registerContentObserver(QZoneConfigProvider.o, true, this.configUpdateObserver);
      return;
    }
    catch (Exception localException)
    {
  ...
  public void addListener(a parama)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        } while (!parama.equals(localObject));
      }
      finally {}
      continue;
      label77:
      this.mCallback.add(new WeakReference(parama));
    }
  }
  ...
  public String getConfig(String paramString1, String paramString2)
  {
    ...
    {
      Object localObject;
      if ((this.mStringHelper != null) && (this.mStringHelper.aKl()))
      {
  ...
  public String getConfigSync(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if (localObject != null)
      {
        ...
        {
          paramString2 = sxc.ar(paramString2, paramString1);
          str1 = paramString2;
  ...
  public void notifyConfigChange()
  {
    ...
    a locala = (a)locala.get();
    if (locala != null) {
      locala.onConfigChange();
    }
    label74:
    label95:
    for (;;)
  ...
  public void removeListener(a parama)
  {
    ...
    //   8: return
    //   9: aload_0
    //   10: getfield 6998	common/config/service/QzoneConfig:mCallback	Ljava/util/ArrayList;
    //   13: invokevirtual 7174	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   16: astore_2
    //   17: aload_2
    //   18: invokeinterface 7179 1 0
    //   23: ifeq -17 -> 6
    //   26: aload_2
    //   27: invokeinterface 7183 1 0
    //   32: checkcast 7185	java/lang/ref/WeakReference
    //   35: astore_3
    //   36: aload_3
    //   37: ifnull -20 -> 17
    //   40: aload_3
    //   41: invokevirtual 7188	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   44: checkcast 6	common/config/service/QzoneConfig$a
    //   47: astore_3
    //   48: aload_3
    //   49: ifnull +11 -> 60
    //   52: aload_1
    //   53: aload_3
    //   54: invokevirtual 7195	java/lang/Object:equals	(Ljava/lang/Object;)Z
    //   57: ifeq -40 -> 17
    //   60: aload_2
    //   61: invokeinterface 7191 1 0
    //   66: goto -49 -> 17
    //   69: astore_1
    //   70: aload_0
    //   71: monitorexit
