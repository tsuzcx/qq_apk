  ...
  implements QGBitmapLoader.QGBitmapLoaderImpl
{
  ...
  public android.graphics.Bitmap load(java.lang.String paramString)
  {
    ...
    //   48: monitorenter
    //   49: aload_1
    //   50: invokestatic 61	aqgs:getBitmapFromCache	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   53: astore_2
    //   54: aload_2
    //   55: ifnull +15 -> 70
    //   58: aload_2
    ...
    //   72: monitorexit
    //   73: aload_1
    //   74: invokestatic 72	jqc:isValidUrl	(Ljava/lang/String;)Z
    //   77: ifeq +365 -> 442
    ...
    //   89: new 79	obs
    //   92: dup
    //   93: invokestatic 85	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   96: invokespecial 88	obs:<init>	(Lcom/tencent/common/app/BaseApplicationImpl;)V
    //   99: astore 4
    //   101: new 90	com/tencent/image/DownloadParams
    //   104: dup
    //   105: invokespecial 91	com/tencent/image/DownloadParams:<init>	()V
    //   108: astore 5
    //   110: aload 5
    //   112: aload_3
    //   113: putfield 95	com/tencent/image/DownloadParams:url	Ljava/net/URL;
    //   116: aload 5
    //   118: aload_1
    //   119: putfield 99	com/tencent/image/DownloadParams:urlStr	Ljava/lang/String;
    //   122: aload 4
    //   124: aload 5
    //   126: new 101	asga
    //   129: dup
    //   130: aload_0
    //   131: invokespecial 104	asga:<init>	(Lasfz;)V
    //   134: invokevirtual 108	obs:loadImageFile	(Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   137: astore_3
    //   138: aload_3
    //   139: astore 8
    //   141: aload_3
    ...
    //   148: dup
    //   149: ldc 110
    //   151: invokespecial 111	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   154: athrow
    //   155: astore 4
    //   157: ldc 37
    //   159: ldc 113
    //   161: aload 4
    //   163: invokestatic 119	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   166: pop
    //   167: aload_3
    //   168: astore 8
    //   170: aload 8
    ...
    //   185: astore 7
    //   187: aload 8
    //   189: invokevirtual 124	java/io/File:exists	()Z
    //   192: ifeq +263 -> 455
    //   195: aload_2
    //   196: astore_3
    //   197: aload_2
    ...
    //   205: astore 7
    //   207: aload 8
    //   209: invokevirtual 127	java/io/File:getPath	()Ljava/lang/String;
    //   212: invokestatic 132	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   215: astore 6
    //   217: aload 6
    //   219: astore_2
    //   220: aload 6
    ...
    //   233: astore 7
    //   235: aload_1
    //   236: invokestatic 72	jqc:isValidUrl	(Ljava/lang/String;)Z
    //   239: ifeq +78 -> 317
    //   242: aload 6
    //   244: astore_2
    //   245: aload 6
    ...
    //   258: astore 7
    //   260: aload 8
    //   262: invokestatic 138	com/tencent/image/GifDrawable:isGifFile	(Ljava/io/File;)Z
    //   265: ifeq +52 -> 317
    //   268: aload 6
    //   270: astore_3
    //   271: aload 6
    ...
    //   285: bipush 100
    //   287: aload 8
    //   289: invokestatic 144	aqhu:a	(Landroid/graphics/Bitmap;ILjava/io/File;)Z
    //   292: pop
    //   293: aload 6
    //   295: astore_3
    //   296: aload 6
    ...
    //   306: astore 7
    //   308: aload 8
    //   310: invokevirtual 127	java/io/File:getPath	()Ljava/lang/String;
    //   313: invokestatic 132	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   316: astore_2
    //   317: aload_2
    //   318: astore_3
    //   319: aload_2
    ...
    //   344: aload 8
    //   346: invokevirtual 127	java/io/File:getPath	()Ljava/lang/String;
    ...
    //   368: ifnull +10 -> 378
    //   371: aload_3
    //   372: invokevirtual 151	java/io/InputStream:close	()V
    //   375: aload 4
    //   377: astore_2
    //   378: ldc 56
    //   380: monitorenter
    ...
    //   392: aload_1
    //   393: aload_2
    //   394: invokestatic 154	aqgs:e	(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    //   397: ldc 56
    //   399: monitorexit
    //   400: aload_2
    //   401: areturn
    ...
    //   437: invokestatic 158	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   440: aconst_null
    //   441: areturn
    //   442: new 121	java/io/File
    //   445: dup
    //   446: aload_1
    //   447: invokespecial 159	java/io/File:<init>	(Ljava/lang/String;)V
    //   450: astore 8
    //   452: goto -282 -> 170
    //   455: aload_2
    //   456: astore_3
    ...
    //   463: aload 10
    //   465: astore 7
    //   467: getstatic 165	com/tencent/qg/sdk/QGRenderer:assetManager	Landroid/content/res/AssetManager;
    //   470: aload_1
    //   471: invokevirtual 171	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   474: astore 6
    //   476: aload 6
    //   478: astore_3
    //   479: aload_3
    //   480: astore 7
    //   482: aload_3
    //   483: invokestatic 175	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    //   486: astore 4
    //   488: goto -124 -> 364
    //   491: astore_2
    //   492: aload_2
    //   493: invokevirtual 178	java/io/IOException:printStackTrace	()V
    //   496: aload 4
    //   498: astore_2
    //   499: goto -121 -> 378
    //   502: astore 5
    ...
    //   512: ldc 180
    //   514: aload 5
    //   516: invokestatic 119	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   519: pop
    //   520: aload_3
    //   521: astore_2
    //   522: aload 4
    //   524: ifnull -146 -> 378
    //   527: aload 4
    //   529: invokevirtual 151	java/io/InputStream:close	()V
    //   532: aload_3
    //   533: astore_2
    //   534: goto -156 -> 378
    //   537: astore_2
    //   538: aload_2
    //   539: invokevirtual 178	java/io/IOException:printStackTrace	()V
    //   542: aload_3
    //   543: astore_2
    //   544: goto -166 -> 378
    //   547: astore 5
    ...
    //   560: ldc 182
    //   562: aload 5
    //   564: invokestatic 119	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   567: pop
    //   568: aload_3
    //   569: astore_2
    //   570: aload 4
    //   572: ifnull -194 -> 378
    //   575: aload 4
    //   577: invokevirtual 151	java/io/InputStream:close	()V
    //   580: aload_3
    //   581: astore_2
    //   582: goto -204 -> 378
    //   585: astore_2
    //   586: aload_2
    //   587: invokevirtual 178	java/io/IOException:printStackTrace	()V
    //   590: aload_3
    //   591: astore_2
    //   592: goto -214 -> 378
    //   595: astore_2
    ...
    //   610: ldc 184
    //   612: aload 5
    //   614: invokestatic 119	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   617: pop
    //   618: aload 4
    //   620: astore_2
    //   621: aload 5
    //   623: invokevirtual 178	java/io/IOException:printStackTrace	()V
    //   626: aload_3
    //   627: astore_2
    //   628: aload 4
    //   630: ifnull -252 -> 378
    //   633: aload 4
    //   635: invokevirtual 151	java/io/InputStream:close	()V
    //   638: aload_3
    //   639: astore_2
    //   640: goto -262 -> 378
    //   643: astore_2
    //   644: aload_2
    //   645: invokevirtual 178	java/io/IOException:printStackTrace	()V
    //   648: aload_3
    //   649: astore_2
    //   650: goto -272 -> 378
    //   653: astore_1
    ...
    //   656: ifnull +8 -> 664
    //   659: aload 7
    //   661: invokevirtual 151	java/io/InputStream:close	()V
    //   664: aload_1
    //   665: athrow
    //   666: astore_2
    //   667: aload_2
    //   668: invokevirtual 178	java/io/IOException:printStackTrace	()V
    //   671: goto -7 -> 664
    //   674: astore_1
    //   675: aload_2
    //   676: astore 7
