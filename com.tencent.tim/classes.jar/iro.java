  ...
  extends accg
{
  ...
  ije.a jdField_a_of_type_Ije$a = new irp(this);
  ije.c jdField_a_of_type_Ije$c = new irq(this);
  
  public iro(VideoAppInterface paramVideoAppInterface)
  {
  ...
  private AVRedPacketManager.LocalFrameSyncInfo a(AVRedPacketGameSyncInfo.FrameSyncInfo paramFrameSyncInfo)
  {
    ...
    if (paramFrameSyncInfo.emojis.has())
    {
      ...
      while (i < paramFrameSyncInfo.emojis.size())
      {
        ...
        localLocalEmojiInfo.emojiType = AVRedPacketManager.cs(localEmoji.emojiTypeId.get());
  ...
  private void apV()
  {
    if (QLog.isColorLevel()) {
      QLog.d("AVRedPacketHandler", 2, "registerC2CHandler, hasRegisterC2CHandler: " + this.Uy);
    }
    if (this.Uy) {
      return;
    }
    ije.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a(9, this.jdField_a_of_type_Ije$a);
  }
  
  public void apW()
  {
    if (QLog.isColorLevel()) {
      QLog.d("AVRedPacketHandler", 2, "registerC2CHandler, hasRegisterFrameHandler: " + this.Uz);
    }
    if (this.Uz) {
      return;
    }
    this.Uz = ije.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a(5, this.jdField_a_of_type_Ije$c);
  }
  
  public void apX()
  {
    if (QLog.isColorLevel()) {
      QLog.d("AVRedPacketHandler", 2, "unRegisterFrameHandler, hasRegisterFrameHandler: " + this.Uz);
    }
    ije localije = ije.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    if (localije != null) {
      localije.b(5, this.jdField_a_of_type_Ije$c);
    }
    this.Uz = false;
  }
  ...
  public void g(int paramInt, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ije.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a(9, paramInt, (byte[])localObject1);
      return;
