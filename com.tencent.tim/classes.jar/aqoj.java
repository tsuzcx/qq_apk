...
public class aqoj
{
  ...
  public static void a(long paramLong, byte[] paramArrayOfByte, int paramInt1, int paramInt2, String paramString)
  {
    ...
    try
    {
      ...
      b(arrayOfByte1, paramInt2 - arrayOfByte2.length, arrayOfByte2, arrayOfByte2.length);
      b(paramArrayOfByte, paramInt1, arrayOfByte1, arrayOfByte1.length);
      return;
    }
    catch (Exception paramArrayOfByte) {}
  }
  
  public static byte[] ag(String paramString)
  {
    if (paramString == null) {
      return null;
    }
  ...
  public static String b(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    localStringBuffer.append(paramString1.substring(paramInt, i)).append(paramString3).append(b(paramString1, i + j, paramString2, paramString3));
    return localStringBuffer.toString();
  }
  ...
  public static String b(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    //   38: iconst_2
    //   39: iload_2
    //   40: invokestatic 154	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   43: new 156	java/io/ByteArrayInputStream
    //   46: dup
    //   47: aload 7
    //   49: invokespecial 159	java/io/ByteArrayInputStream:<init>	([B)V
    //   52: astore_0
    //   53: new 161	java/io/DataInputStream
    //   56: dup
    //   57: aload_0
    //   58: invokespecial 164	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   61: astore_3
    //   62: aload_3
    //   63: invokevirtual 167	java/io/DataInputStream:readUTF	()Ljava/lang/String;
    //   66: astore 5
    //   68: aload 5
    //   70: astore 4
    //   72: aload_3
    //   73: ifnull +7 -> 80
    //   76: aload_3
    //   77: invokevirtual 170	java/io/DataInputStream:close	()V
    //   80: aload 4
    //   82: astore_3
    //   83: aload_0
    //   84: ifnull +10 -> 94
    //   87: aload_0
    //   88: invokevirtual 171	java/io/ByteArrayInputStream:close	()V
    //   91: aload 4
    //   93: astore_3
    //   94: aload_3
    //   95: areturn
    ...
    //   106: ifnull +7 -> 113
    //   109: aload_3
    //   110: invokevirtual 170	java/io/DataInputStream:close	()V
    //   113: aload 4
    //   115: astore_3
    //   116: aload_0
    //   117: ifnull -23 -> 94
    //   120: aload_0
    //   121: invokevirtual 171	java/io/ByteArrayInputStream:close	()V
    //   124: ldc 100
    //   126: areturn
    //   127: astore_0
    //   128: ldc 100
    ...
    //   138: ifnull +7 -> 145
    //   141: aload_3
    //   142: invokevirtual 170	java/io/DataInputStream:close	()V
    //   145: aload 4
    //   147: astore_3
    //   148: aload_0
    //   149: ifnull -55 -> 94
    //   152: aload_0
    //   153: invokevirtual 171	java/io/ByteArrayInputStream:close	()V
    //   156: ldc 100
    //   158: areturn
    //   159: astore_0
    //   160: ldc 100
    ...
    //   172: ifnull +8 -> 180
    //   175: aload 4
    //   177: invokevirtual 170	java/io/DataInputStream:close	()V
    //   180: aload_0
    //   181: ifnull +7 -> 188
    //   184: aload_0
    //   185: invokevirtual 171	java/io/ByteArrayInputStream:close	()V
    //   188: aload_3
    //   189: athrow
    //   190: astore_3
    //   191: goto -111 -> 80
  ...
  public static void c(byte[] paramArrayOfByte1, int paramInt1, byte[] paramArrayOfByte2, int paramInt2)
  {
