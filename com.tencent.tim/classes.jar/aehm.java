  ...
  extends ServerConfigObserver
{
  ...
  public void onGetPluginConfig(boolean paramBoolean, int paramInt, GetResourceRespV2 paramGetResourceRespV2)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        localObject1 = aehl.a(this.this$0).a().createEntityManager();
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if (localGetResourceRespInfoV2.iPluginType == 32)
          {
            ...
            if (aehr.a((EntityManager)localObject1, aehl.a(this.this$0), localGetResourceRespInfoV2).cDefaultState != 0) {
              break label515;
            }
            paramInt = 1;
            i = 1;
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        while (paramGetResourceRespV2.hasNext())
        {
          ...
          {
            aehr.a((EntityManager)localObject1, aehl.a(this.this$0), (GetResourceRespInfoV2)localObject2);
            i = 1;
          }
        }
        ((EntityManager)localObject1).close();
        this.this$0.bR(true, false);
        k = m;
        if (i != 0)
        {
          paramGetResourceRespV2 = new ArrayList(aehl.a(this.this$0)).iterator();
          while (paramGetResourceRespV2.hasNext())
          {
        ...
        label415:
        if (k >= aehl.a(this.this$0).size()) {
          break;
        }
        try
        {
          ResourcePluginListener.a((ResourcePluginListener)aehl.a(this.this$0).get(k), (byte)1, 2);
          label454:
          k += 1;
          break label415;
          while (paramInt < aehl.a(this.this$0).size()) {
            try
            {
              ResourcePluginListener.a((ResourcePluginListener)aehl.a(this.this$0).get(paramInt), (byte)-1, 2);
              label500:
              paramInt += 1;
            }
