  ...
  implements Connection
{
    ...
    throws IOException
  {
    ...
    //   4: invokevirtual 74	okhttp3/Route:proxy	()Ljava/net/Proxy;
    //   7: astore 6
    //   9: aload_0
    //   10: getfield 59	okhttp3/internal/connection/RealConnection:route	Lokhttp3/Route;
    //   13: invokevirtual 78	okhttp3/Route:address	()Lokhttp3/Address;
    //   16: astore 5
    //   18: aload 6
    //   20: invokevirtual 84	java/net/Proxy:type	()Ljava/net/Proxy$Type;
    //   23: getstatic 90	java/net/Proxy$Type:DIRECT	Ljava/net/Proxy$Type;
    //   26: if_acmpeq +14 -> 40
    //   29: aload 6
    //   31: invokevirtual 84	java/net/Proxy:type	()Ljava/net/Proxy$Type;
    //   34: getstatic 93	java/net/Proxy$Type:HTTP	Ljava/net/Proxy$Type;
    //   37: if_acmpne +89 -> 126
    //   40: aload 5
    //   42: invokevirtual 99	okhttp3/Address:socketFactory	()Ljavax/net/SocketFactory;
    //   45: invokevirtual 105	javax/net/SocketFactory:createSocket	()Ljava/net/Socket;
    //   48: astore 5
    //   50: aload_0
    //   51: aload 5
    //   53: putfield 107	okhttp3/internal/connection/RealConnection:rawSocket	Ljava/net/Socket;
    //   56: aload 4
    //   58: aload_3
    //   59: aload_0
    //   60: getfield 59	okhttp3/internal/connection/RealConnection:route	Lokhttp3/Route;
    //   63: invokevirtual 111	okhttp3/Route:socketAddress	()Ljava/net/InetSocketAddress;
    //   66: aload 6
    //   68: invokevirtual 117	okhttp3/EventListener:connectStart	(Lokhttp3/Call;Ljava/net/InetSocketAddress;Ljava/net/Proxy;)V
    //   71: aload_0
    //   72: getfield 107	okhttp3/internal/connection/RealConnection:rawSocket	Ljava/net/Socket;
    //   75: iload_2
    //   76: invokevirtual 123	java/net/Socket:setSoTimeout	(I)V
    //   79: invokestatic 129	okhttp3/internal/platform/Platform:get	()Lokhttp3/internal/platform/Platform;
    //   82: aload_0
    //   83: getfield 107	okhttp3/internal/connection/RealConnection:rawSocket	Ljava/net/Socket;
    //   86: aload_0
    //   87: getfield 59	okhttp3/internal/connection/RealConnection:route	Lokhttp3/Route;
    //   90: invokevirtual 111	okhttp3/Route:socketAddress	()Ljava/net/InetSocketAddress;
    //   93: iload_1
    //   94: invokevirtual 132	okhttp3/internal/platform/Platform:connectSocket	(Ljava/net/Socket;Ljava/net/InetSocketAddress;I)V
    //   97: aload_0
    //   98: aload_0
    //   99: getfield 107	okhttp3/internal/connection/RealConnection:rawSocket	Ljava/net/Socket;
    //   102: invokestatic 137	okio/Okio:source	(Ljava/net/Socket;)Lokio/Source;
    //   105: invokestatic 141	okio/Okio:buffer	(Lokio/Source;)Lokio/BufferedSource;
    //   108: putfield 143	okhttp3/internal/connection/RealConnection:source	Lokio/BufferedSource;
    //   111: aload_0
    //   112: aload_0
    //   113: getfield 107	okhttp3/internal/connection/RealConnection:rawSocket	Ljava/net/Socket;
    //   116: invokestatic 146	okio/Okio:sink	(Ljava/net/Socket;)Lokio/Sink;
    //   119: invokestatic 149	okio/Okio:buffer	(Lokio/Sink;)Lokio/BufferedSink;
    //   122: putfield 151	okhttp3/internal/connection/RealConnection:sink	Lokio/BufferedSink;
    //   125: return
    //   126: new 119	java/net/Socket
    //   129: dup
    //   130: aload 6
    ...
    //   137: goto -87 -> 50
    //   140: astore_3
    //   141: new 66	java/net/ConnectException
    //   144: dup
    ...
    //   161: invokevirtual 111	okhttp3/Route:socketAddress	()Ljava/net/InetSocketAddress;
    //   164: invokevirtual 166	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   167: invokevirtual 170	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   170: invokespecial 173	java/net/ConnectException:<init>	(Ljava/lang/String;)V
    //   173: astore 4
    //   175: aload 4
    //   177: aload_3
    //   178: invokevirtual 177	java/net/ConnectException:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   181: pop
    //   182: aload 4
    //   184: athrow
    //   185: astore_3
    //   186: ldc 13
    //   188: aload_3
    //   189: invokevirtual 180	java/lang/NullPointerException:getMessage	()Ljava/lang/String;
    //   192: invokevirtual 186	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   195: ifeq -70 -> 125
    //   198: new 64	java/io/IOException
    //   201: dup
    //   202: aload_3
    ...
    throws IOException
  {
    ...
    //   12: invokevirtual 78	okhttp3/Route:address	()Lokhttp3/Address;
    //   15: astore 6
    //   17: aload 6
    ...
    //   23: aload_3
    //   24: aload_0
    //   25: getfield 107	okhttp3/internal/connection/RealConnection:rawSocket	Ljava/net/Socket;
    //   28: aload 6
    ...
    //   64: ifeq +23 -> 87
    //   67: invokestatic 129	okhttp3/internal/platform/Platform:get	()Lokhttp3/internal/platform/Platform;
    //   70: aload_3
    //   71: aload 6
    ...
    //   95: astore_1
    //   96: aload_1
    //   97: invokestatic 250	okhttp3/Handshake:get	(Ljavax/net/ssl/SSLSession;)Lokhttp3/Handshake;
    //   100: astore_2
    //   101: aload 6
    //   103: invokevirtual 254	okhttp3/Address:hostnameVerifier	()Ljavax/net/ssl/HostnameVerifier;
    //   106: aload 6
    //   108: invokevirtual 202	okhttp3/Address:url	()Lokhttp3/HttpUrl;
    //   111: invokevirtual 207	okhttp3/HttpUrl:host	()Ljava/lang/String;
    //   114: aload_1
    //   115: invokeinterface 260 3 0
    //   120: ifne +191 -> 311
    //   123: aload_2
    //   124: invokevirtual 263	okhttp3/Handshake:peerCertificates	()Ljava/util/List;
    //   127: astore_1
    //   128: aload_1
    //   129: invokeinterface 268 1 0
    //   134: ifne +136 -> 270
    //   137: aload_1
    //   138: iconst_0
    //   139: invokeinterface 271 2 0
    //   144: checkcast 273	java/security/cert/X509Certificate
    //   147: astore_1
    //   148: new 275	javax/net/ssl/SSLPeerUnverifiedException
    //   151: dup
    ...
    //   165: aload 6
    //   167: invokevirtual 202	okhttp3/Address:url	()Lokhttp3/HttpUrl;
    //   170: invokevirtual 207	okhttp3/HttpUrl:host	()Ljava/lang/String;
    //   173: invokevirtual 163	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   176: ldc_w 279
    //   179: invokevirtual 163	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   182: aload_1
    //   183: invokestatic 285	okhttp3/CertificatePinner:pin	(Ljava/security/cert/Certificate;)Ljava/lang/String;
    ...
    //   195: aload_1
    //   196: invokevirtual 291	java/security/cert/X509Certificate:getSubjectDN	()Ljava/security/Principal;
    //   199: invokeinterface 296 1 0
    //   204: invokevirtual 163	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   207: ldc_w 298
    //   210: invokevirtual 163	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   213: aload_1
    //   214: invokestatic 304	okhttp3/internal/tls/OkHostnameVerifier:allSubjectAltNames	(Ljava/security/cert/X509Certificate;)Ljava/util/List;
    //   217: invokevirtual 166	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   220: invokevirtual 170	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   223: invokespecial 305	javax/net/ssl/SSLPeerUnverifiedException:<init>	(Ljava/lang/String;)V
    //   226: athrow
    //   227: astore_2
    //   228: aload_3
    //   229: astore_1
    ...
    //   233: astore_2
    //   234: aload_3
    //   235: invokestatic 311	okhttp3/internal/Util:isAndroidGetsocknameError	(Ljava/lang/AssertionError;)Z
    //   238: ifeq +183 -> 421
    //   241: aload_1
    //   242: astore_2
    //   243: new 64	java/io/IOException
    //   246: dup
    //   247: aload_3
    ...
    //   253: aload_2
    //   254: ifnull +10 -> 264
    //   257: invokestatic 129	okhttp3/internal/platform/Platform:get	()Lokhttp3/internal/platform/Platform;
    //   260: aload_2
    //   261: invokevirtual 315	okhttp3/internal/platform/Platform:afterHandshake	(Ljavax/net/ssl/SSLSocket;)V
    //   264: aload_2
    //   265: invokestatic 319	okhttp3/internal/Util:closeQuietly	(Ljava/net/Socket;)V
    //   268: aload_1
    //   269: athrow
    //   270: new 275	javax/net/ssl/SSLPeerUnverifiedException
    //   273: dup
    //   274: new 156	java/lang/StringBuilder
    //   277: dup
    //   278: invokespecial 157	java/lang/StringBuilder:<init>	()V
    //   281: ldc_w 277
    //   284: invokevirtual 163	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   287: aload 6
    //   289: invokevirtual 202	okhttp3/Address:url	()Lokhttp3/HttpUrl;
    //   292: invokevirtual 207	okhttp3/HttpUrl:host	()Ljava/lang/String;
    //   295: invokevirtual 163	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   298: ldc_w 321
    //   301: invokevirtual 163	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   304: invokevirtual 170	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   307: invokespecial 305	javax/net/ssl/SSLPeerUnverifiedException:<init>	(Ljava/lang/String;)V
    //   310: athrow
    //   311: aload 6
    //   313: invokevirtual 325	okhttp3/Address:certificatePinner	()Lokhttp3/CertificatePinner;
    //   316: aload 6
    //   318: invokevirtual 202	okhttp3/Address:url	()Lokhttp3/HttpUrl;
    //   321: invokevirtual 207	okhttp3/HttpUrl:host	()Ljava/lang/String;
    //   324: aload_2
    //   325: invokevirtual 263	okhttp3/Handshake:peerCertificates	()Ljava/util/List;
    //   328: invokevirtual 329	okhttp3/CertificatePinner:check	(Ljava/lang/String;Ljava/util/List;)V
    //   331: aload 4
    //   333: astore_1
    //   334: aload 5
    //   336: invokevirtual 230	okhttp3/ConnectionSpec:supportsTlsExtensions	()Z
    //   339: ifeq +11 -> 350
    //   342: invokestatic 129	okhttp3/internal/platform/Platform:get	()Lokhttp3/internal/platform/Platform;
    //   345: aload_3
    //   346: invokevirtual 333	okhttp3/internal/platform/Platform:getSelectedProtocol	(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
    //   349: astore_1
    //   350: aload_0
    //   351: aload_3
    //   352: putfield 335	okhttp3/internal/connection/RealConnection:socket	Ljava/net/Socket;
    //   355: aload_0
    //   356: aload_0
    //   357: getfield 335	okhttp3/internal/connection/RealConnection:socket	Ljava/net/Socket;
    //   360: invokestatic 137	okio/Okio:source	(Ljava/net/Socket;)Lokio/Source;
    //   363: invokestatic 141	okio/Okio:buffer	(Lokio/Source;)Lokio/BufferedSource;
    //   366: putfield 143	okhttp3/internal/connection/RealConnection:source	Lokio/BufferedSource;
    //   369: aload_0
    //   370: aload_0
    //   371: getfield 335	okhttp3/internal/connection/RealConnection:socket	Ljava/net/Socket;
    //   374: invokestatic 146	okio/Okio:sink	(Ljava/net/Socket;)Lokio/Sink;
    //   377: invokestatic 149	okio/Okio:buffer	(Lokio/Sink;)Lokio/BufferedSink;
    //   380: putfield 151	okhttp3/internal/connection/RealConnection:sink	Lokio/BufferedSink;
    //   383: aload_0
    //   384: aload_2
    //   385: putfield 337	okhttp3/internal/connection/RealConnection:handshake	Lokhttp3/Handshake;
    //   388: aload_1
    //   389: ifnull +25 -> 414
    //   392: aload_1
    //   393: invokestatic 342	okhttp3/Protocol:get	(Ljava/lang/String;)Lokhttp3/Protocol;
    //   396: astore_1
    //   397: aload_0
    //   398: aload_1
    //   399: putfield 344	okhttp3/internal/connection/RealConnection:protocol	Lokhttp3/Protocol;
    //   402: aload_3
    //   403: ifnull +10 -> 413
    //   406: invokestatic 129	okhttp3/internal/platform/Platform:get	()Lokhttp3/internal/platform/Platform;
    //   409: aload_3
    //   410: invokevirtual 315	okhttp3/internal/platform/Platform:afterHandshake	(Ljavax/net/ssl/SSLSocket;)V
    //   413: return
    //   414: getstatic 347	okhttp3/Protocol:HTTP_1_1	Lokhttp3/Protocol;
    //   417: astore_1
    //   418: goto -21 -> 397
    //   421: aload_1
    //   422: astore_2
