  ...
  implements WebSocket, WebSocketReader.FrameCallback
{
  ...
  public void failWebSocket(Exception paramException, @javax.annotation.Nullable Response paramResponse)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 196	okhttp3/internal/ws/RealWebSocket:failed	Z
    //   6: ifeq +6 -> 12
    //   9: aload_0
    //   10: monitorexit
    //   11: return
    //   12: aload_0
    //   13: iconst_1
    //   14: putfield 196	okhttp3/internal/ws/RealWebSocket:failed	Z
    //   17: aload_0
    //   18: getfield 381	okhttp3/internal/ws/RealWebSocket:streams	Lokhttp3/internal/ws/RealWebSocket$Streams;
    //   21: astore_3
    //   22: aload_0
    //   23: aconst_null
    //   24: putfield 381	okhttp3/internal/ws/RealWebSocket:streams	Lokhttp3/internal/ws/RealWebSocket$Streams;
    //   27: aload_0
    //   28: getfield 383	okhttp3/internal/ws/RealWebSocket:cancelFuture	Ljava/util/concurrent/ScheduledFuture;
    //   31: ifnull +14 -> 45
    //   34: aload_0
    //   35: getfield 383	okhttp3/internal/ws/RealWebSocket:cancelFuture	Ljava/util/concurrent/ScheduledFuture;
    //   38: iconst_0
    //   39: invokeinterface 388 2 0
    //   44: pop
    //   45: aload_0
    //   46: getfield 186	okhttp3/internal/ws/RealWebSocket:executor	Ljava/util/concurrent/ScheduledExecutorService;
    //   49: ifnull +12 -> 61
    //   52: aload_0
    //   53: getfield 186	okhttp3/internal/ws/RealWebSocket:executor	Ljava/util/concurrent/ScheduledExecutorService;
    //   56: invokeinterface 391 1 0
    //   61: aload_0
    //   62: monitorexit
    //   63: aload_0
    //   64: getfield 147	okhttp3/internal/ws/RealWebSocket:listener	Lokhttp3/WebSocketListener;
    //   67: aload_0
    //   68: aload_1
    //   69: aload_2
    //   70: invokevirtual 397	okhttp3/WebSocketListener:onFailure	(Lokhttp3/WebSocket;Ljava/lang/Throwable;Lokhttp3/Response;)V
    //   73: aload_3
    //   74: invokestatic 403	okhttp3/internal/Util:closeQuietly	(Ljava/io/Closeable;)V
    //   77: return
    //   78: astore_1
    //   79: aload_0
    //   80: monitorexit
    ...
    //   83: astore_1
    //   84: aload_3
    //   85: invokestatic 403	okhttp3/internal/Util:closeQuietly	(Ljava/io/Closeable;)V
    //   88: aload_1
    //   89: athrow
  ...
  public void onReadPing(ByteString paramByteString)
  {
    ...
    //   6: ifne +22 -> 28
    //   9: aload_0
    //   10: getfield 198	okhttp3/internal/ws/RealWebSocket:enqueuedClose	Z
    //   13: ifeq +18 -> 31
    //   16: aload_0
    //   17: getfield 110	okhttp3/internal/ws/RealWebSocket:messageAndCloseQueue	Ljava/util/ArrayDeque;
    //   20: invokevirtual 445	java/util/ArrayDeque:isEmpty	()Z
    //   23: istore_2
    //   24: iload_2
    //   25: ifeq +6 -> 31
    //   28: aload_0
    ...
    //   30: return
    //   31: aload_0
    //   32: getfield 108	okhttp3/internal/ws/RealWebSocket:pongQueue	Ljava/util/ArrayDeque;
    //   35: aload_1
    //   36: invokevirtual 214	java/util/ArrayDeque:add	(Ljava/lang/Object;)Z
    //   39: pop
    //   40: aload_0
    //   41: invokespecial 216	okhttp3/internal/ws/RealWebSocket:runWriter	()V
    //   44: aload_0
    //   45: aload_0
    //   46: getfield 489	okhttp3/internal/ws/RealWebSocket:receivedPingCount	I
    //   49: iconst_1
    //   50: iadd
    //   51: putfield 489	okhttp3/internal/ws/RealWebSocket:receivedPingCount	I
    //   54: goto -26 -> 28
    //   57: astore_1
    //   58: aload_0
    //   59: monitorexit
  ...
  boolean pong(ByteString paramByteString)
  {
    ...
    //   33: ireturn
    //   34: aload_0
    //   35: getfield 108	okhttp3/internal/ws/RealWebSocket:pongQueue	Ljava/util/ArrayDeque;
    //   38: aload_1
    //   39: invokevirtual 214	java/util/ArrayDeque:add	(Ljava/lang/Object;)Z
    //   42: pop
    //   43: aload_0
    //   44: invokespecial 216	okhttp3/internal/ws/RealWebSocket:runWriter	()V
    //   47: iconst_1
    //   48: istore_2
    //   49: goto -19 -> 30
    //   52: astore_1
    ...
    for (;;)
    {
      ...
      if (localObject1 == null)
      {
        ...
        if ((localObject3 instanceof Message))
        {
          ...
          localObject3 = Okio.buffer(localWebSocketWriter.newMessageSink(((Message)localObject3).formatOpcode, ((ByteString)localObject7).size()));
