...
public abstract class aafa
{
  protected Interpreter a = new Interpreter(a(paramString1));
  public List<String> vh = new ArrayList();
  
  public aafa(String paramString1, String paramString2)
    throws Throwable
  {
    ...
    throws Throwable
  {
    ...
    //   14: astore 7
    //   16: new 79	java/io/FileInputStream
    //   19: dup
    //   20: aload 7
    //   22: invokespecial 82	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   25: astore 4
    //   27: aload 4
    //   29: invokevirtual 86	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   32: astore_1
    //   33: aload 7
    //   35: invokevirtual 90	java/io/File:length	()J
    //   38: lstore_2
    //   39: aload_1
    //   40: getstatic 96	java/nio/channels/FileChannel$MapMode:READ_ONLY	Ljava/nio/channels/FileChannel$MapMode;
    //   43: lconst_0
    //   44: lload_2
    //   45: invokevirtual 102	java/nio/channels/FileChannel:map	(Ljava/nio/channels/FileChannel$MapMode;JJ)Ljava/nio/MappedByteBuffer;
    //   48: astore 5
    //   50: aload_1
    //   51: ifnull +7 -> 58
    //   54: aload_1
    //   55: invokevirtual 103	java/nio/channels/FileChannel:close	()V
    //   58: aload 4
    //   60: ifnull +8 -> 68
    //   63: aload 4
    //   65: invokevirtual 104	java/io/FileInputStream:close	()V
    //   68: aload 5
    //   70: areturn
    //   71: astore 5
    //   73: aconst_null
    ...
    //   96: ifnull +8 -> 104
    //   99: aload 5
    //   101: invokevirtual 103	java/nio/channels/FileChannel:close	()V
    //   104: aload 6
    //   106: ifnull +8 -> 114
    //   109: aload 6
    //   111: invokevirtual 104	java/io/FileInputStream:close	()V
    //   114: aload_1
    //   115: athrow
    //   116: astore_1
    //   117: aconst_null
  ...
  public abstract boolean a(wrb paramwrb, String paramString, float paramFloat, int paramInt);
  ...
  public float[] a(float[][][][] paramArrayOfFloat)
  {
    ...
    this.a.run(paramArrayOfFloat, arrayOfFloat);
