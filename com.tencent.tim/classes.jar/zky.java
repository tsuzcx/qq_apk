  ...
  extends zkw
{
  ...
  int cdG = 0;
  private View.OnClickListener clickListener = new zlc(this);
  View footerView;
  boolean gV = false;
  MessageForStructing h;
  LinearLayout hI;
  ...
  public zky(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
  ...
  private void cpP()
  {
    ((ImageButton)findViewById(2131368696)).setOnClickListener(new zla(this));
    Button localButton = (Button)findViewById(2131363801);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new zlb(this));
  }
  ...
  private void cpQ()
  {
    ...
    this.a = new zkx(this.mContext, this.b, this.sessionInfo, this.app);
    this.F.setAdapter(this.a);
    this.F.setOnScrollListener(new zld(this));
    this.F.setOnTouchListener(new zle(this));
    this.F.setOnItemClickListener(new zlf(this));
  }
  ...
  private void gT()
  {
    ...
    this.v.addTextChangedListener(new zkz(this));
  ...
  protected void cpN()
  {
    ...
    this.a.zx(this.ban);
    if (QLog.isColorLevel()) {
      QLog.i("LinkMessageSearchDialog", 2, "searchMessage, keyword: " + this.ban + ", netState: " + AppNetConnInfo.isNetSupport());
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.MS.setText(acfp.m(2131703325));
      ...
      } while ((this.Lj != l) || (TextUtils.isEmpty((CharSequence)localObject)) || (!((String)localObject).equals(this.ban)) || (l != this.Lj) || (!this.ban.equals(localObject)));
      this.gV = false;
      this.footerView.setVisibility(8);
      ...
      {
        this.MS.setText(acfp.m(2131703328));
        this.hI.findViewById(2131373660).setVisibility(8);
        this.hI.setVisibility(0);
        this.footerView.setVisibility(0);
      }
    ...
    } while ((TextUtils.isEmpty(paramMessage)) || (this.Lj != l) || (!this.ban.equals(paramMessage)) || (l != this.Lj) || (!this.ban.equals(paramMessage)));
    this.gV = false;
    this.footerView.setVisibility(8);
    this.hI.setVisibility(8);
