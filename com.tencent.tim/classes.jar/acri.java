...
public class acri
  extends tnv
{
  public acri(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(MsgInfo paramMsgInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((l == 20002L) || (l == 20009L) || (l == 20031L) || (l == 20019L))
      {
        ...
        if (this.app != null)
        {
          paramMsgInfo = (FriendListHandler)this.app.getBusinessHandler(1);
          if (j != 0) {
            paramMsgInfo.DH(this.app.getAccount());
          }
          if (i != 0) {
