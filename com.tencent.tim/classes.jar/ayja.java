...
public class ayja
{
  public static Intent a(String paramString1, String paramString2, ayrk paramayrk, String paramString3, String paramString4)
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("uin", paramayrk.uin);
    localIntent.putExtra("troop_uin", paramayrk.troopUin);
    localIntent.putExtra("uintype", paramayrk.messageType);
    localIntent.putExtra("from_uin_type", paramayrk.messageType);
    ...
    paramString3 = aqhs.bytes2HexStr(ahav.t(paramString2));
    if (paramString3 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "thumb file md5 compute fail");
      return null;
    }
    paramayrk.fileMd5 = str;
    paramayrk = new azbt.a();
    int i = azbt.a(paramString1, paramayrk);
    if (i != 0)
    {
      QLog.e("ShortVideoForwardManager", 1, new Object[] { "video file getRotationDegree fail, code:", Integer.valueOf(i) });
      return null;
    }
    i = paramayrk.mMetaData[0];
    int j = paramayrk.mMetaData[1];
    int k = paramayrk.mMetaData[3];
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, boolean paramBoolean, int paramInt, String paramString3)
  {
    ...
    String str2 = aqhs.bytes2HexStr(ahav.t(paramString1));
    if (str2 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "video file md5 compute fail");
      return;
    }
    String str1 = aqhs.bytes2HexStr(ahav.t(paramString2));
    if (str1 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "thumb file md5 compute fail");
      return;
    ...
    int i = azbt.a(paramString1, locala);
    if (i != 0)
    {
      QLog.e("ShortVideoForwardManager", 1, new Object[] { "video file getRotationDegree fail, code:", Integer.valueOf(i) });
      return;
    }
    i = locala.mMetaData[0];
    int j = locala.mMetaData[1];
    int k = locala.mMetaData[3];
    ...
    if (TextUtils.isEmpty(paramString3))
    {
      ...
      {
        localIntent.putExtra("qq_camera_scheme", aywz.sT(paramString1));
        localIntent.putExtra("widgetinfo", paramString1);
        paramString1 = paramActivity.getIntent().getStringExtra("key_camera_material_name");
        axiy.i("ShortVideoForwardManager", "gotoForwardShortVideoUI---activity=" + paramActivity + ", takeSameName=" + paramString1);
        if (TextUtils.isEmpty(paramString1)) {
          break label628;
        }
    ...
    for (;;)
    {
      ((QQStoryBaseActivity)paramActivity).f(localIntent, paramInt);
      return;
    ...
    if (((paramActivity instanceof PublicFragmentActivityForPeak)) || ((paramActivity instanceof QQBrowserActivity)))
    {
      ...
      for (;;)
      {
        if (paramActivity.getIntent() == null)
        {
          ...
          paramString3 = "";
          label691:
          axiy.i("ShortVideoForwardManager", "gotoForwardShortVideoUI---activity=" + paramActivity + ", takeSameName=" + paramString3);
        }
        try
        {
          if (paramString2.startsWith("http"))
          {
            ...
            localIntent.putExtra("qq_camera_scheme", aywz.sT(paramString2));
            if (!TextUtils.isEmpty(paramString3))
            {
        ...
        catch (UnsupportedEncodingException paramString1)
        {
          for (;;)
          {
            ...
            continue;
            if ((!aqmr.isEmpty(paramString2)) && (!aqmr.isEmpty(paramString1)))
            {
  ...
  public static void a(Activity paramActivity, String paramString1, boolean paramBoolean1, boolean paramBoolean2, String paramString2, String paramString3)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      ...
      if ((paramActivity != null) && (paramActivity.getIntent() != null))
      {
        ...
        if (paramString2 != null)
        {
          ...
          axiy.i("ShortVideoForwardManager", "gotoForwardPicUI---activity=" + paramActivity + ", takeSameName=" + paramString2);
          if (TextUtils.isEmpty(paramString2)) {
            break label485;
          }
    ...
    for (;;)
    {
      ...
      ahgq.a(paramActivity, "caller_aecamera", localIntent, 21, 100200);
      return;
      if (!paramBoolean2) {
        break;
      }
      localIntent.putExtra("forward_summary_extra", acfp.m(2131714476));
      break;
      label485:
      localIntent.putExtra("qq_camera_top_title", "魔法视频");
    }
    label500:
    ahgq.a(paramActivity, localIntent, 21, 100200);
  }
  ...
  public static void k(Activity paramActivity, String paramString, boolean paramBoolean)
  {
