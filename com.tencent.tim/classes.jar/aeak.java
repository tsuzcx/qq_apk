  ...
  extends WebViewPlugin
{
  ...
  public boolean a(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      paramString3 = paramString2.mRootView.getContext().getResources();
      ...
      catch (Exception paramVarArgs)
      {
        for (;;)
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            {
              paramJsBridgeListener = paramString3.getDrawable(2130845845);
            }
      ...
      {
        paramJsBridgeListener = paramString3.getDrawable(2130845846);
        if (j <= 3) {
          break label278;
        }
        k = 3;
  ...
  public boolean handleEvent(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    ...
    {
      if (this.mRuntime.getActivity().getIntent().getIntExtra("uintype", -1) == 1030) {
        bool3 = false;
      }
      try
      {
        paramString = Uri.parse(this.mRuntime.getActivity().getIntent().getStringExtra("url"));
        bool1 = bool3;
        if (paramString != null)
        {
          bool1 = bool3;
      ...
      paramString = new Intent(this.mRuntime.getActivity(), SplashActivity.class);
