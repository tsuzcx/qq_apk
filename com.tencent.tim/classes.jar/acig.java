  ...
  extends accg
{
  ...
  public acig(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
    if ((paramAppInterface instanceof NearbyAppInterface)) {
      this.b = ((NearbyAppInterface)paramAppInterface);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      {
        byte[] arrayOfByte = paramQQAppInterface.a().R(paramString1);
        if (arrayOfByte != null) {
          localJSONObject.put("chat_sig", new String(aqgo.encode(arrayOfByte, 0)));
        }
      }
      ...
      for (;;)
      {
        ...
        paramString1 = new NewIntent(paramQQAppInterface.getApplication().getApplicationContext(), jnl.class);
  ...
  public static void a(NearbyAppInterface paramNearbyAppInterface, long[] paramArrayOfLong, BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      paramArrayOfLong = new NewIntent(paramNearbyAppInterface.getApplication().getApplicationContext(), jnl.class);
  ...
  private void a(NearbyMyTabCard paramNearbyMyTabCard)
  {
  ...
  private void a(Oidb_0x66b.RspBody paramRspBody, NearbyMyTabCard paramNearbyMyTabCard)
  {
    ...
    for (;;)
    {
      akkx.a(this.b, paramNearbyMyTabCard);
      this.b.c(paramNearbyMyTabCard);
    ...
    try
    {
      ...
      if ((paramRspBody1.rpt_msg_uin_data.has()) && (paramRspBody1.rpt_msg_uin_data.size() > 0))
      {
        ...
        if ((paramNearbyMyTabCard.gender == 1) || (paramNearbyMyTabCard.gender == 2)) {
          ajrb.c(paramNearbyMyTabCard.uin + "", "self_gender", Integer.valueOf(paramNearbyMyTabCard.gender));
        }
  ...
  private boolean a(oidb_0xada.ReqBody paramReqBody)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      paramReqBody.version_code.set(aewh.getVersionCode(BaseApplicationImpl.sApplication));
    ...
    if (paramRspBody.stConfigList.has())
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        else
        {
          ...
          localNearbyMyTabConfig.extraVal = ((NearbyMyTabCard.NearbyMyTabConfigExtraVal)akkx.mb.get(Integer.valueOf(localNearbyMyTabConfig.configId)));
      ...
      {
        bool |= this.b.a().m(i, paramRspBody[i]);
        i += 1;
      }
      if (bool) {
  ...
  public static void e(AppInterface paramAppInterface, int paramInt)
  {
  ...
  private void fn(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      for (long l2 = ((cmd0x4f0.RspBody)localObject).uint32_unread_visitor.get();; l2 = 0L)
      {
        ...
        paramObject = this.b.getEntityManagerFactory().createEntityManager();
      ...
      paramObject = ajrb.a("nearby_visitor_file", this.b.getAccount(), 0).edit();
      if (l1 > 0L)
      {
  ...
  private void fq(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null)) {
      if (QLog.isColorLevel()) {
  ...
  public void Et(String paramString)
  {
    ...
    localQueryRecommendReq.uint32_client_version.set(aewh.getVersionCode(BaseApplicationImpl.sApplication));
    SosoInterface.SosoLbsInfo localSosoLbsInfo = aczc.a("LBSService.Point");
    if ((localSosoLbsInfo != null) && (localSosoLbsInfo.a != null))
    {
      localObject = new nearbyPeopleRecommend.Location();
      double d1 = Double.valueOf(localSosoLbsInfo.a.cd * 1000000.0D).intValue();
      double d2 = Double.valueOf(localSosoLbsInfo.a.ce * 1000000.0D).intValue();
  ...
  cmd0x77f.VisitProfRec a(ajra.a parama)
  {
    cmd0x77f.VisitProfRec localVisitProfRec = new cmd0x77f.VisitProfRec();
    localVisitProfRec.uint64_tinyid.set(parama.DM);
    localVisitProfRec.uint32_seq.set(parama.mPosition);
    if (parama.dkK > 0) {
      localVisitProfRec.uint32_enter_count.set(parama.dkK);
    }
    if (parama.dkL > 0) {
      localVisitProfRec.uint32_visit_duration.set(parama.dkL);
    }
    if (parama.dkM > 0) {
      localVisitProfRec.uint32_visit_pic_count.set(parama.dkM);
    }
    if (parama.dkN > 0) {
      localVisitProfRec.uint32_opflag.set(parama.dkN);
    }
    if (QLog.isColorLevel()) {
      QLog.d("NearbyHandler", 2, "convert2VisitRec ,record =" + parama);
    }
  ...
  public void ak(List<ajra.a> paramList, boolean paramBoolean)
  {
    int j = 0;
    ...
    if (k <= 200)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        ((cmd0x77f.ReqBody)localObject1).uint32_list_ruleid.set(((ajra.a)paramList.get(0)).dkJ);
        i = j;
        while (i < k)
        {
          localObject2 = a((ajra.a)paramList.get(i));
    ...
    ak((List)localObject1, paramBoolean);
    ak(paramList, paramBoolean);
  }
  
  public void b(NearbyMyTabCard paramNearbyMyTabCard)
  {
  ...
  public void bRK()
  {
    ...
    long l = this.b.getLongAccountUin();
  ...
  public void c(int paramInt, SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    if (paramInt == 1)
    {
      ...
      if (paramSosoLbsInfo == null)
      {
        ...
        if ((((SosoInterface.SosoLocation)localObject).cd == 0.0D) || (((SosoInterface.SosoLocation)localObject).ce == 0.0D)) {
          break label234;
        }
        localLocation.int32_lat.set((int)(((SosoInterface.SosoLocation)localObject).cd * 1000000.0D));
        localLocation.int32_lon.set((int)(((SosoInterface.SosoLocation)localObject).ce * 1000000.0D));
    ...
    for (;;)
    {
      ...
      do
      {
        do
        {
          ...
          break;
          if ((((SosoInterface.SosoLocation)localObject).cf == 0.0D) || (((SosoInterface.SosoLocation)localObject).cg == 0.0D)) {
            break label119;
          }
          localLocation.int32_lat.set((int)(((SosoInterface.SosoLocation)localObject).cf * 1000000.0D));
          localLocation.int32_lon.set((int)(((SosoInterface.SosoLocation)localObject).cg * 1000000.0D));
  ...
  public void d(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramToServiceMsg.msg_self_info.has())
      {
        ...
        ((aehy)this.b.getManager(210)).a(this.b, paramObject);
        if (QLog.isColorLevel()) {
  ...
  public void e(float paramFloat1, float paramFloat2, int paramInt)
  {
    Object localObject = new oidb_0xada.ReqBody();
    if (!a((oidb_0xada.ReqBody)localObject))
    {
  ...
  public void fl(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if (QLog.isColorLevel()) {
  ...
  public void fm(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    boolean bool = false;
    if (QLog.isColorLevel()) {
    ...
    for (paramFromServiceMsg = "0";; paramFromServiceMsg = "-1")
    {
      ...
      paramObject.put("param_NetType", String.valueOf(aqiw.getSystemNetwork(BaseApplication.getContext())));
      paramObject.put("param_DeviceType", String.valueOf(zsz.getDeviceType()));
      long l = paramToServiceMsg.extraData.getLong("request_start_time");
      l = SystemClock.uptimeMillis() - l;
      anpc.a(BaseApplicationImpl.getContext()).collectPerformance(getCurrentAccountUin(), "actGetNearbyMyTab", bool, l, 0L, paramObject, "");
      if (QLog.isColorLevel()) {
  ...
  public void fo(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null))
    {
  ...
  public void fp(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null))
    {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      do
      {
        ...
        if ("NeighborSvc.ReqGetPoint".equals(str))
        {
          ...
          for (int i = 5;; i = 6)
          {
            acic.a(this, i, paramToServiceMsg, paramFromServiceMsg, paramObject);
            return;
          }
        }
        if ("OidbSvc.0x9c7_0".equals(str))
        {
          acic.c(this, 10, paramToServiceMsg, paramFromServiceMsg, paramObject);
          return;
        }
        if ("OidbSvc.0x686".equals(str))
        {
          acic.b(this, 8, paramToServiceMsg, paramFromServiceMsg, paramObject);
          return;
        }
        ...
        {
          d(paramFromServiceMsg, paramToServiceMsg, paramObject);
          return;
        }
    ...
    fq(paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
}
