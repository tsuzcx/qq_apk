...
public class IOUtils
{
  ...
  static
  {
    ...
    //   110	16	0	localObject2	Object
    //   146	16	0	localThrowable3	Throwable
    //   176	1	0	localObject3	Object
    //   78	14	1	localObject4	Object
    //   101	1	1	localObject5	Object
    //   107	23	1	localThrowable4	Throwable
    //   178	1	1	localObject6	Object
  ...
  {
    // Byte code:
    //   0: new 438	org/apache/commons/io/output/ByteArrayOutputStream
    //   3: dup
    //   4: invokespecial 445	org/apache/commons/io/output/ByteArrayOutputStream:<init>	()V
    //   7: astore_3
    //   8: aconst_null
    //   9: astore_2
    //   10: aload_0
    //   11: aload_3
    //   12: invokestatic 447	org/apache/commons/io/IOUtils:copy	(Ljava/io/InputStream;Ljava/io/OutputStream;)I
    //   15: pop
    //   16: aload_3
    //   17: invokevirtual 450	org/apache/commons/io/output/ByteArrayOutputStream:toByteArray	()[B
    //   20: astore_0
    //   21: aload_3
    //   22: ifnull +11 -> 33
    //   25: iconst_0
    //   26: ifeq +18 -> 44
    //   29: aload_3
    //   30: invokevirtual 451	org/apache/commons/io/output/ByteArrayOutputStream:close	()V
    //   33: aload_0
    //   34: areturn
    //   35: astore_0
    ...
    //   43: athrow
    //   44: aload_3
    //   45: invokevirtual 451	org/apache/commons/io/output/ByteArrayOutputStream:close	()V
    //   48: aload_0
    //   49: areturn
    //   50: astore_0
    //   51: aload_0
    ...
    //   59: ifnull +18 -> 77
    //   62: aload_3
    //   63: invokevirtual 451	org/apache/commons/io/output/ByteArrayOutputStream:close	()V
    //   66: aload_1
    //   67: athrow
    //   68: astore_2
    //   69: aload_0
    ...
    //   74: goto -8 -> 66
    //   77: aload_3
    //   78: invokevirtual 451	org/apache/commons/io/output/ByteArrayOutputStream:close	()V
    //   81: goto -15 -> 66
    //   84: astore_1
    //   85: aload_2
    //   86: astore_0
    ...
    throws IOException
  {
    ...
    //   11: aload_3
    //   12: aload_1
    //   13: invokestatic 216	org/apache/commons/io/IOUtils:copy	(Ljava/io/Reader;Ljava/io/OutputStream;Ljava/nio/charset/Charset;)V
    //   16: aload_3
    //   17: invokevirtual 450	org/apache/commons/io/output/ByteArrayOutputStream:toByteArray	()[B
    //   20: astore_0
    //   21: aload_3
    ...
    throws IOException
  {
    ...
    //   3: dup
    //   4: invokespecial 536	org/apache/commons/io/output/StringBuilderWriter:<init>	()V
    //   7: astore_3
    //   8: aconst_null
    //   9: astore_2
    //   10: aload_0
    //   11: aload_3
    //   12: aload_1
    //   13: invokestatic 195	org/apache/commons/io/IOUtils:copy	(Ljava/io/InputStream;Ljava/io/Writer;Ljava/nio/charset/Charset;)V
    //   16: aload_3
    ...
    throws IOException
  {
    ...
    //   10: aload_0
    //   11: aload_3
    //   12: invokestatic 212	org/apache/commons/io/IOUtils:copy	(Ljava/io/Reader;Ljava/io/Writer;)I
    //   15: pop
    //   16: aload_3
    //   17: invokevirtual 58	org/apache/commons/io/output/StringBuilderWriter:toString	()Ljava/lang/String;
    //   20: astore_0
