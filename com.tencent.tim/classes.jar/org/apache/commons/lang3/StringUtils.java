...
public class StringUtils
{
  ...
  public static int countMatches(CharSequence paramCharSequence, char paramChar)
  {
    ...
    {
      k = j;
      if (paramChar == paramCharSequence.charAt(i)) {
        k = j + 1;
      }
      i += 1;
    }
  ...
  public static int getFuzzyDistance(CharSequence paramCharSequence1, CharSequence paramCharSequence2, Locale paramLocale)
  {
    ...
    if (n < paramCharSequence2.length())
    {
      ...
      k = 0;
      if ((i < paramCharSequence1.length()) && (k == 0))
      {
  ...
  public static int getLevenshteinDistance(CharSequence paramCharSequence1, CharSequence paramCharSequence2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (i1 > 1)
        {
          paramCharSequence1[(i1 - 1)] = 2147483647;
          n = i1;
        }
        if (n <= m)
        {
  ...
  private static int ordinalIndexOf(CharSequence paramCharSequence1, CharSequence paramCharSequence2, int paramInt, boolean paramBoolean)
  {
    ...
    label59:
    if (paramBoolean) {}
    for (i = CharSequenceUtils.lastIndexOf(paramCharSequence1, paramCharSequence2, i - paramCharSequence2.length());; i = CharSequenceUtils.indexOf(paramCharSequence1, paramCharSequence2, paramCharSequence2.length() + i))
    {
      j = i;
      if (i < 0) {
        break;
        ...
        if (i < i3)
        {
          ...
          if (arrayOfBoolean[i] == 0)
          {
            ...
            if (paramArrayOfString1[i] != null)
            {
              m = k;
              n = j;
              if (!paramArrayOfString1[i].isEmpty())
              {
  ...
  private static double score(CharSequence paramCharSequence1, CharSequence paramCharSequence2)
  {
    ...
    String str2;
    for (paramCharSequence1 = str1;; paramCharSequence1 = paramCharSequence1.toString().toLowerCase())
    {
      i = paramCharSequence1.length() / 2 + 1;
      str1 = getSetOfMatchingCharacterWithin(paramCharSequence1, paramCharSequence2, i);
      str2 = getSetOfMatchingCharacterWithin(paramCharSequence2, paramCharSequence1, i);
    ...
    double d = str1.length() / paramCharSequence1.length();
    return (str2.length() / paramCharSequence2.length() + d + (str1.length() - i) / str1.length()) / 3.0D;
  }
