  ...
  implements Runnable
{
  ...
  private void doServerShutdown()
  {
    ...
    if (this.decoders != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((WebSocketWorker)localIterator.next()).interrupt();
      }
    }
  ...
  private boolean doSetupSelectorAndServerThread()
  {
    ...
    try
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((WebSocketWorker)((Iterator)localObject).next()).start();
      }
      onStart();
    }
    catch (IOException localIOException)
  ...
  private void handleFatal(WebSocket paramWebSocket, Exception paramException)
  {
    ...
    if (this.decoders != null)
    {
      ...
      while (paramWebSocket.hasNext()) {
        ((WebSocketWorker)paramWebSocket.next()).interrupt();
      }
    }
    if (this.selectorthread != null) {
    ...
    throws InterruptedException
  {
    ...
    {
      paramWebSocketImpl.setWorkerThread((WebSocketWorker)this.decoders.get(this.queueinvokes % this.decoders.size()));
      this.queueinvokes += 1;
    }
  ...
  public void run()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 702	org/java_websocket/server/WebSocketServer:doEnsureSingleThread	()Z
    //   4: ifne +4 -> 8
    //   7: return
    //   8: aload_0
    //   9: invokespecial 704	org/java_websocket/server/WebSocketServer:doSetupSelectorAndServerThread	()Z
    //   12: ifeq -5 -> 7
    //   15: iconst_0
    //   16: istore_1
    //   17: iconst_5
    //   18: istore_3
    //   19: aload_0
    //   20: getfield 345	org/java_websocket/server/WebSocketServer:selectorthread	Ljava/lang/Thread;
    //   23: invokevirtual 707	java/lang/Thread:isInterrupted	()Z
    //   26: istore 10
    //   28: iload 10
    //   30: ifne +462 -> 492
    //   33: iload_3
    ...
    //   55: istore 8
    //   57: aload_0
    //   58: getfield 92	org/java_websocket/server/WebSocketServer:isclosed	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   61: invokevirtual 380	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   64: ifeq +5 -> 69
    //   67: iconst_5
    //   68: istore_2
    //   69: iload_3
    ...
    //   87: istore 8
    //   89: aload_0
    //   90: getfield 222	org/java_websocket/server/WebSocketServer:selector	Ljava/nio/channels/Selector;
    //   93: iload_2
    //   94: i2l
    //   95: invokevirtual 711	java/nio/channels/Selector:select	(J)I
    //   98: ifne +37 -> 135
    //   101: iload_3
    //   102: istore_1
    //   103: iload_2
    ...
    //   119: istore 8
    //   121: aload_0
    //   122: getfield 92	org/java_websocket/server/WebSocketServer:isclosed	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   125: invokevirtual 380	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   128: ifeq +7 -> 135
    //   131: iload_3
    //   132: iconst_1
    //   133: isub
    ...
    //   151: istore 8
    //   153: aload_0
    //   154: getfield 222	org/java_websocket/server/WebSocketServer:selector	Ljava/nio/channels/Selector;
    //   157: invokevirtual 715	java/nio/channels/Selector:selectedKeys	()Ljava/util/Set;
    //   160: invokeinterface 718 1 0
    //   165: astore 13
    //   167: aconst_null
    //   168: astore 11
    //   170: iload_2
    ...
    //   202: istore 8
    //   204: aload 13
    //   206: invokeinterface 321 1 0
    //   211: checkcast 183	java/nio/channels/SelectionKey
    //   214: astore 12
    //   216: iload_2
    //   217: istore 7
    //   219: iload_1
    ...
    //   226: istore 8
    //   228: aload 12
    //   230: invokevirtual 483	java/nio/channels/SelectionKey:isValid	()Z
    //   233: ifne +10 -> 243
    //   236: aload 12
    //   238: astore 11
    //   240: goto -70 -> 170
    ...
    //   253: istore 8
    //   255: aload 12
    //   257: invokevirtual 721	java/nio/channels/SelectionKey:isAcceptable	()Z
    //   260: ifeq +30 -> 290
    //   263: iload_2
    //   264: istore 7
    //   266: iload_1
    ...
    //   276: aload 12
    //   278: aload 13
    //   280: invokespecial 723	org/java_websocket/server/WebSocketServer:doAccept	(Ljava/nio/channels/SelectionKey;Ljava/util/Iterator;)V
    //   283: aload 12
    //   285: astore 11
    //   287: goto -117 -> 170
    //   290: iload_2
    ...
    //   300: istore 8
    //   302: aload 12
    //   304: invokevirtual 726	java/nio/channels/SelectionKey:isReadable	()Z
    //   307: ifeq +33 -> 340
    //   310: iload_2
    //   311: istore 7
    //   313: iload_1
    ...
    //   323: aload 12
    //   325: aload 13
    //   327: invokespecial 728	org/java_websocket/server/WebSocketServer:doRead	(Ljava/nio/channels/SelectionKey;Ljava/util/Iterator;)Z
    //   330: ifne +10 -> 340
    //   333: aload 12
    //   335: astore 11
    //   337: goto -167 -> 170
    ...
    //   350: istore 8
    //   352: aload 12
    //   354: invokevirtual 731	java/nio/channels/SelectionKey:isWritable	()Z
    //   357: ifeq +181 -> 538
    //   360: iload_2
    //   361: istore 7
    //   363: iload_1
    ...
    //   372: aload_0
    //   373: aload 12
    //   375: invokespecial 733	org/java_websocket/server/WebSocketServer:doWrite	(Ljava/nio/channels/SelectionKey;)V
    //   378: aload 12
    //   380: astore 11
    //   382: goto -212 -> 170
    //   385: iload_2
    ...
    //   395: istore 8
    //   397: aload_0
    //   398: invokespecial 735	org/java_websocket/server/WebSocketServer:doAdditionalRead	()V
    //   401: iload_2
    //   402: istore_3
    //   403: iload_1
    //   404: istore_2
    ...
    //   412: astore 11
    //   414: aload_0
    //   415: invokespecial 737	org/java_websocket/server/WebSocketServer:doServerShutdown	()V
    //   418: return
    //   419: astore 11
    //   421: aconst_null
    //   422: astore 12
    ...
    //   432: ifnull +8 -> 440
    //   435: aload 12
    //   437: invokevirtual 186	java/nio/channels/SelectionKey:cancel	()V
    //   440: aload_0
    //   441: aload 12
    //   443: aconst_null
    //   444: aload 11
    //   446: invokespecial 257	org/java_websocket/server/WebSocketServer:handleIOException	(Ljava/nio/channels/SelectionKey;Lorg/java_websocket/WebSocket;Ljava/io/IOException;)V
    //   449: goto -42 -> 407
    //   452: astore 11
    //   454: aload_0
    //   455: aconst_null
    //   456: aload 11
    //   458: invokespecial 164	org/java_websocket/server/WebSocketServer:handleFatal	(Lorg/java_websocket/WebSocket;Ljava/lang/Exception;)V
    //   461: aload_0
    //   462: invokespecial 737	org/java_websocket/server/WebSocketServer:doServerShutdown	()V
    //   465: return
    //   466: astore 11
    //   468: iload 7
    //   470: istore_1
    //   471: iload 5
    //   473: istore_2
    //   474: invokestatic 378	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   477: invokevirtual 512	java/lang/Thread:interrupt	()V
    //   480: goto -73 -> 407
    //   483: astore 11
    //   485: aload_0
    //   486: invokespecial 737	org/java_websocket/server/WebSocketServer:doServerShutdown	()V
    //   489: aload 11
    //   491: athrow
    //   492: aload_0
    //   493: invokespecial 737	org/java_websocket/server/WebSocketServer:doServerShutdown	()V
    //   496: return
    //   497: astore 13
    //   499: aload 11
    //   501: astore 12
    ...
    //   452	5	11	localRuntimeException	RuntimeException
    ...
    extends Thread
  {
    ...
    public WebSocketWorker()
    {
      ...
      setUncaughtExceptionHandler(new WebSocketServer.WebSocketWorker.1(this, WebSocketServer.this));
    }
      ...
      throws InterruptedException
    {
      ...
      {
        WebSocketServer.log.error("Error while reading from remote connection", paramWebSocketImpl);
        return;
      }
      finally
      {
        WebSocketServer.this.pushBuffer(paramByteBuffer);
      }
    }
    ...
    public void run()
    {
      ...
      catch (InterruptedException localInterruptedException)
      {
        ...
        WebSocketServer.this.handleFatal(localInterruptedException, localRuntimeException1);
        return;
      }
