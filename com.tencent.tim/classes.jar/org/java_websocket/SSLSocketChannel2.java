  ...
  implements ByteChannel, WrappedByteChannel
{
    ...
    throws SSLException
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 102	org/java_websocket/SSLSocketChannel2:readEngineResult	Ljavax/net/ssl/SSLEngineResult;
    //   6: invokevirtual 215	javax/net/ssl/SSLEngineResult:getStatus	()Ljavax/net/ssl/SSLEngineResult$Status;
    //   9: getstatic 262	javax/net/ssl/SSLEngineResult$Status:CLOSED	Ljavax/net/ssl/SSLEngineResult$Status;
    //   12: if_acmpne +24 -> 36
    //   15: aload_0
    //   16: getfield 79	org/java_websocket/SSLSocketChannel2:sslEngine	Ljavax/net/ssl/SSLEngine;
    //   19: invokevirtual 95	javax/net/ssl/SSLEngine:getHandshakeStatus	()Ljavax/net/ssl/SSLEngineResult$HandshakeStatus;
    //   22: astore_2
    //   23: getstatic 180	javax/net/ssl/SSLEngineResult$HandshakeStatus:NOT_HANDSHAKING	Ljavax/net/ssl/SSLEngineResult$HandshakeStatus;
    //   26: astore_3
    //   27: aload_2
    //   28: aload_3
    //   29: if_acmpne +7 -> 36
    //   32: aload_0
    //   33: invokevirtual 283	org/java_websocket/SSLSocketChannel2:close	()V
    //   36: aload_0
    //   37: getfield 233	org/java_websocket/SSLSocketChannel2:inData	Ljava/nio/ByteBuffer;
    //   40: invokevirtual 265	java/nio/ByteBuffer:remaining	()I
    //   43: istore_1
    //   44: aload_0
    //   45: aload_0
    //   46: getfield 79	org/java_websocket/SSLSocketChannel2:sslEngine	Ljavax/net/ssl/SSLEngine;
    //   49: aload_0
    //   50: getfield 217	org/java_websocket/SSLSocketChannel2:inCrypt	Ljava/nio/ByteBuffer;
    //   53: aload_0
    //   54: getfield 233	org/java_websocket/SSLSocketChannel2:inData	Ljava/nio/ByteBuffer;
    //   57: invokevirtual 286	javax/net/ssl/SSLEngine:unwrap	(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)Ljavax/net/ssl/SSLEngineResult;
    //   60: putfield 102	org/java_websocket/SSLSocketChannel2:readEngineResult	Ljavax/net/ssl/SSLEngineResult;
    //   63: aload_0
    //   64: getfield 102	org/java_websocket/SSLSocketChannel2:readEngineResult	Ljavax/net/ssl/SSLEngineResult;
    //   67: invokevirtual 215	javax/net/ssl/SSLEngineResult:getStatus	()Ljavax/net/ssl/SSLEngineResult$Status;
    //   70: getstatic 289	javax/net/ssl/SSLEngineResult$Status:OK	Ljavax/net/ssl/SSLEngineResult$Status;
    //   73: if_acmpne +27 -> 100
    //   76: iload_1
    //   77: aload_0
    //   78: getfield 233	org/java_websocket/SSLSocketChannel2:inData	Ljava/nio/ByteBuffer;
    //   81: invokevirtual 265	java/nio/ByteBuffer:remaining	()I
    //   84: if_icmpne -48 -> 36
    //   87: aload_0
    //   88: getfield 79	org/java_websocket/SSLSocketChannel2:sslEngine	Ljavax/net/ssl/SSLEngine;
    //   91: invokevirtual 95	javax/net/ssl/SSLEngine:getHandshakeStatus	()Ljavax/net/ssl/SSLEngineResult$HandshakeStatus;
    //   94: getstatic 211	javax/net/ssl/SSLEngineResult$HandshakeStatus:NEED_UNWRAP	Ljavax/net/ssl/SSLEngineResult$HandshakeStatus;
    //   97: if_acmpeq -61 -> 36
    //   100: aload_0
    //   101: getfield 233	org/java_websocket/SSLSocketChannel2:inData	Ljava/nio/ByteBuffer;
    //   104: invokevirtual 231	java/nio/ByteBuffer:flip	()Ljava/nio/Buffer;
    //   107: pop
    //   108: aload_0
    //   109: getfield 233	org/java_websocket/SSLSocketChannel2:inData	Ljava/nio/ByteBuffer;
    //   112: astore_2
    //   113: aload_0
    //   114: monitorexit
    //   115: aload_2
