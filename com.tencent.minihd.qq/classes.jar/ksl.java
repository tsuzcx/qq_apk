...
public class ksl
  extends BaseAdapter
{
  public ksl(QQCustomDialogThreeBtns paramQQCustomDialogThreeBtns) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView.a != null)
    {
      ...
      paramView.a.setOnClickListener(new kss(this.a, paramInt));
