...
public class hps
  extends Handler
{
  public hps(StartAppCheckHandler paramStartAppCheckHandler, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 1: 
      ...
      if ((this.a.jdField_a_of_type_AndroidAppActivity != null) && (this.a.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface != null))
      {
        ...
        ((NewIntent)localObject).putExtra("data", ((hpx)paramMessage.obj).a.toByteArray());
      ...
      for (;;)
      {
        ...
        this.a.jdField_a_of_type_Hpx = null;
        return;
        localObject = this.a.a("SecCheckSigSvc.UploadReq");
        ((ToServiceMsg)localObject).putWupBuffer(((hpx)paramMessage.obj).a.toByteArray());
