  ...
  implements Runnable
{
  ...
  private final Runnable jdField_a_of_type_JavaLangRunnable = new lqo(this);
  
  public lqn(AbsListView paramAbsListView)
  {
    ...
    case 4: 
      ...
      try
      {
        ...
        if (i > 0)
        {
          ...
          this.jdField_a_of_type_ComTencentWidgetAbsListView.b_ = ((View)localObject1).getTop();
        }
