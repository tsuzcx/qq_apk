  ...
  implements Runnable
{
  ...
  public hra(CleanCache paramCleanCache) {}
    ...
    if (paramFile.exists())
    {
      ...
      if (paramFile.isDirectory())
      {
        ...
        if (paramFile != null)
        {
          ...
          if (j > 2000)
          {
            Arrays.sort(paramFile, new hrc(this));
            n = paramFile.length;
            k = m;
            i = j;
          }
  ...
  private File[] a(File[] paramArrayOfFile)
  {
    ...
    //   10: istore 5
    //   12: aload_0
    //   13: getfield 13	hra:jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache	Lcom/tencent/mobileqq/app/automator/step/CleanCache;
    ...
    //   129: istore_2
    //   130: aload_0
    //   131: getfield 13	hra:jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache	Lcom/tencent/mobileqq/app/automator/step/CleanCache;
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        arrayOfString[0] = AppConstants.aZ;
        ...
        if (i < j)
        {
          ...
          Arrays.sort((Object[])localObject, new hrb(this));
      ...
      for (;;)
      {
        ...
        arrayOfFile[1] = new File(AppConstants.aG + "photo");
        arrayOfFile[2] = new File(AppConstants.aG + this.jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache.a() + "/ptt/");
