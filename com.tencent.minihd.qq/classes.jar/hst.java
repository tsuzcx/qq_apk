...
public class hst
  implements Runnable
{
  public hst(DatalineMessageManager paramDatalineMessageManager, DataLineMsgSet paramDataLineMsgSet) {}
  ...
  public void run()
  {
    ...
    {
      localObject1 = MsgProxyUtils.a(String.valueOf(AppConstants.Y), 6000);
    ...
    for (;;)
    {
      ...
      localObject2 = ((RecentUserProxy)localObject2).a(String.valueOf(AppConstants.Y), 6000);
