...
public class gwg
  extends Handler
{
  public gwg(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity) {}
  
  public void handleMessage(Message paramMessage)
  {
    if (paramMessage.what == 0)
    {
      this.a.app.a(new gwh(this));
    ...
    this.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840318);
    this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130840318);
    this.a.c.setImageResource(2130840318);
    this.a.d.setImageResource(2130840318);
