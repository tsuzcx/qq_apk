...
public class dzl
  implements Runnable
{
  public dzl(ForwardOperations paramForwardOperations) {}
  ...
  public void run()
  {
    ...
    if (this.a.w == 5)
    {
      ...
      localBundle.putString("title", this.a.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131368840, new Object[] { this.a.jdField_a_of_type_AndroidOsBundle.getString("app_name") }));
    }
    for (;;)
    {
      str1 = TroopBarUtils.a(this.a.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.getEditText());
      if (str1 != null) {
