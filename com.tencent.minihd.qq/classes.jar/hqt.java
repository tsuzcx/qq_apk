...
public class hqt
  implements Runnable
{
  public hqt(RecentUserCache paramRecentUserCache, SharedPreferences paramSharedPreferences) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        i = ((SQLiteDatabase)???).a(MessageRecord.getTableName(AppConstants.ab, 4000), "frienduin=?", new String[] { AppConstants.ab });
        if (QLog.isColorLevel()) {
