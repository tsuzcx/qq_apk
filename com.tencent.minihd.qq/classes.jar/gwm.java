  ...
  extends BaseAdapter
{
  ...
  gwn jdField_a_of_type_Gwn;
  
  public gwm(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903925, null);
      this.jdField_a_of_type_Gwn = new gwn(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberCreateFaceToFaceDiscussionActivity);
      this.jdField_a_of_type_Gwn.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131296551));
      this.jdField_a_of_type_Gwn.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131296582));
      paramView.setTag(this.jdField_a_of_type_Gwn);
    ...
    for (;;)
    {
      ...
      return paramView;
      this.jdField_a_of_type_Gwn = ((gwn)paramView.getTag());
      if (!this.jdField_a_of_type_Gwn.jdField_a_of_type_Boolean) {
        break;
      }
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903925, null);
      this.jdField_a_of_type_Gwn = new gwn(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberCreateFaceToFaceDiscussionActivity);
      ...
      this.jdField_a_of_type_Gwn.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131296582));
      paramView.setTag(this.jdField_a_of_type_Gwn);
      this.jdField_a_of_type_Gwn.jdField_a_of_type_Boolean = false;
      break;
      label237:
