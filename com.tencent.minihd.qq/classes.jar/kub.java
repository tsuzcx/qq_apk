...
public final class kub
  implements Runnable
{
  public kub(Context paramContext, String paramString) {}
  
  public void run()
  {
    BadgeUtils.a(this.jdField_a_of_type_AndroidContentContext, 0);
    boolean bool = ShortcutUtils.a(this.jdField_a_of_type_AndroidContentContext, new String[] { this.jdField_a_of_type_AndroidContentContext.getString(2131365725) });
    ...
    localIntent2.putExtra("android.intent.extra.shortcut.NAME", this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131365725));
    localIntent2.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", Intent.ShortcutIconResource.fromContext(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2130838429));
