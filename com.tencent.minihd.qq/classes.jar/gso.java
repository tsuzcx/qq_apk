  ...
  implements GestureSelectGridView.OnSelectListener
{
  ...
  public gso(PhotoListActivity paramPhotoListActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      this.b = 2147483647;
      localLocalMediaInfo = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_a_of_type_Gsv.a(paramInt);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      while (paramInt1 <= j)
      {
        PhotoListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_a_of_type_Gsv.a(paramInt1), this.jdField_a_of_type_Boolean);
        paramInt1 += 1;
      }
    ...
    if (paramInt1 < i)
    {
      ...
      localLocalMediaInfo = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_a_of_type_Gsv.a(paramInt1);
