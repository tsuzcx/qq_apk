  ...
  extends BaseAdapter
{
  ...
  private gil(RecommendListView paramRecommendListView)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130904379, paramViewGroup, false);
      paramViewGroup = new gim();
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131298654));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131301987));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131301988));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131300556));
      paramViewGroup.c = ((TextView)paramView.findViewById(2131296659));
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131296570));
      ...
      if (RecommendListView.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendRecommendListView) == 0)
      {
        if (RecommendListView.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendRecommendListView) == null) {
          RecommendListView.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendRecommendListView, new gik(this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendRecommendListView));
        }
      ...
      paramViewGroup.c.setText(2131365752);
    }
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (gim)paramView.getTag();
      break;
      label508:
      ...
      for (;;)
      {
        ...
        paramViewGroup.b.setText("通讯录联系人");
      ...
      if (localRecommendContactMsg.friendStatus == 1)
      {
        paramViewGroup.d.setVisibility(4);
        paramViewGroup.c.setVisibility(0);
        paramViewGroup.c.setText(2131365759);
      }
      else
      {
