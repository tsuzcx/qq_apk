...
{
  public gwj(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity) {}
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (i == this.a.jdField_b_of_type_Int)
      {
        ...
        this.a.finish();
        str = ContactUtils.a(this.a.app, this.a.getActivity().getApplicationContext(), paramObject);
        localIntent = new Intent(this.a.getActivity(), ChatActivity.class);
    ...
    while (i != this.a.jdField_b_of_type_Int)
    {
      ...
      Intent localIntent;
      return;
      CreateFaceToFaceDiscussionActivity.a(this.a, 1, this.a.getString(2131369372));
      return;
    }
    CreateFaceToFaceDiscussionActivity.b(this.a, 1, this.a.getString(2131369372));
  }
  ...
  protected void a(boolean paramBoolean, List paramList, int paramInt1, int paramInt2, nearfield_discuss.BusiRespHead paramBusiRespHead)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilList == null)
      {
        ...
        if (this.a.jdField_a_of_type_Gwm != null)
        {
          this.a.jdField_a_of_type_Gwm.notifyDataSetChanged();
