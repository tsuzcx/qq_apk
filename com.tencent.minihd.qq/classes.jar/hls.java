  ...
  extends Thread
{
  ...
  public hls(MessageHandler paramMessageHandler, ArrayList paramArrayList)
  {
  ...
  public void run()
  {
    ...
    //   21: aload_0
    //   22: invokevirtual 52	hls:getName	()Ljava/lang/String;
    ...
    //   35: istore_1
    //   36: aload_0
    //   37: getfield 18	hls:jdField_a_of_type_Boolean	Z
    //   40: ifeq +836 -> 876
    //   43: iload_1
    //   44: iconst_2
    //   45: if_icmplt +13 -> 58
    //   48: aload_0
    //   49: getfield 22	hls:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   66: istore_2
    //   67: aload_0
    //   68: getfield 22	hls:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   71: astore 11
    //   73: iload_1
    //   74: istore_2
    //   75: aload 11
    ...
    //   79: istore_2
    //   80: aload_0
    //   81: getfield 22	hls:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   84: invokevirtual 65	java/util/ArrayList:size	()I
    //   87: ifle +505 -> 592
    //   90: iload_1
    //   91: istore_2
    //   92: aload_0
    //   93: getfield 22	hls:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   96: iconst_0
    //   97: invokevirtual 76	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   100: checkcast 78	hlt
    //   103: astore 10
    //   105: iconst_0
    //   106: istore_1
    //   107: iload_1
    ...
    //   146: istore_2
    //   147: aload 10
    //   149: getfield 87	hlt:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   152: ifnull +766 -> 918
    //   155: iload_1
    //   156: istore_2
    //   157: aload 10
    //   159: getfield 87	hlt:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   229: istore_2
    //   230: aload 10
    //   232: getfield 96	hlt:f	I
    //   235: tableswitch	default:+680 -> 915, 1:+387->622, 2:+435->670, 3:+462->697, 4:+489->724, 5:+556->791
    //   269: istore_2
    //   270: aload_0
    //   271: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   353: aload_0
    //   354: iconst_0
    //   355: putfield 20	hls:b	Z
    //   358: iload_1
    //   359: istore_2
    //   360: aload_0
    //   361: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   371: istore_2
    //   372: aload_0
    //   373: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   376: invokestatic 130	com/tencent/mobileqq/app/MessageHandler:a	(Lcom/tencent/mobileqq/app/MessageHandler;)Z
    //   379: ifeq +198 -> 577
    //   382: iload_1
    //   383: istore_2
    //   384: aload_0
    //   385: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   388: invokestatic 132	com/tencent/mobileqq/app/MessageHandler:b	(Lcom/tencent/mobileqq/app/MessageHandler;)Z
    //   391: ifeq +186 -> 577
    //   394: iload_1
    //   395: istore_2
    //   396: aload_0
    //   397: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   409: monitorenter
    //   410: aload_0
    //   411: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   442: iconst_0
    //   443: aload_0
    //   444: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   465: iconst_1
    //   466: aload_0
    //   467: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   479: aastore
    //   480: aload_0
    //   481: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   504: istore 9
    //   506: aload_0
    //   507: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   510: aconst_null
    ...
    //   524: ifeq +29 -> 553
    //   527: aload_0
    //   528: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   537: ifeq +16 -> 553
    //   540: aload_0
    //   541: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   550: ifne +24 -> 574
    //   553: aload_0
    //   554: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   557: invokevirtual 177	com/tencent/mobileqq/app/MessageHandler:f	()V
    //   560: aload_0
    //   561: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   564: sipush 4013
    //   567: iload 9
    //   569: aload 11
    ...
    //   577: iload_1
    //   578: istore_2
    //   579: invokestatic 183	hls:yield	()V
    //   582: goto -546 -> 36
    //   585: astore 10
    //   587: iload_2
    //   588: istore_1
    ...
    //   593: istore_2
    //   594: aload_0
    //   595: getfield 22	hls:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   598: ldc2_w 184
    ...
    //   623: istore_2
    //   624: aload_0
    //   625: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   628: ldc 191
    ...
    //   641: iconst_0
    //   642: aload 10
    //   644: getfield 197	hlt:jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg	Lcom/tencent/qphone/base/remote/ToServiceMsg;
    //   647: aastore
    //   648: dup
    //   649: iconst_1
    //   650: aload 10
    //   652: getfield 200	hlt:jdField_a_of_type_ComTencentQphoneBaseRemoteFromServiceMsg	Lcom/tencent/qphone/base/remote/FromServiceMsg;
    //   655: aastore
    //   656: dup
    //   657: iconst_2
    //   658: aload 10
    //   660: getfield 87	hlt:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   663: aastore
    ...
    //   671: istore_2
    //   672: aload_0
    //   673: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   676: aload 10
    //   678: getfield 197	hlt:jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg	Lcom/tencent/qphone/base/remote/ToServiceMsg;
    //   681: aload 10
    //   683: getfield 200	hlt:jdField_a_of_type_ComTencentQphoneBaseRemoteFromServiceMsg	Lcom/tencent/qphone/base/remote/FromServiceMsg;
    //   686: aload 10
    //   688: getfield 87	hlt:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   698: istore_2
    //   699: aload_0
    //   700: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   703: aload 10
    //   705: getfield 197	hlt:jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg	Lcom/tencent/qphone/base/remote/ToServiceMsg;
    //   708: aload 10
    //   710: getfield 200	hlt:jdField_a_of_type_ComTencentQphoneBaseRemoteFromServiceMsg	Lcom/tencent/qphone/base/remote/FromServiceMsg;
    //   713: aload 10
    //   715: getfield 87	hlt:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   725: istore_2
    //   726: aload 10
    //   728: getfield 87	hlt:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   731: ifnull -463 -> 268
    //   734: iload_1
    //   735: istore_2
    //   736: aload 10
    //   738: getfield 87	hlt:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   741: instanceof 212
    //   744: ifeq -476 -> 268
    //   747: iload_1
    //   748: istore_2
    //   749: aload 10
    //   751: getfield 87	hlt:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   754: checkcast 212	MessageSvcPack/GroupInfo
    //   757: astore 11
    //   759: iload_1
    //   760: istore_2
    //   761: aload_0
    //   762: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   792: istore_2
    //   793: aload 10
    //   795: getfield 87	hlt:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   798: ifnull -530 -> 268
    //   801: iload_1
    //   802: istore_2
    //   803: aload 10
    //   805: getfield 87	hlt:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   808: instanceof 233
    //   811: ifeq -543 -> 268
    //   814: iload_1
    //   815: istore_2
    //   816: aload 10
    //   818: getfield 87	hlt:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   821: checkcast 233	MessageSvcPack/stConfNumInfo
    //   824: astore 11
    //   826: iload_1
    //   827: istore_2
    //   828: aload_0
    //   829: getfield 13	hls:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   901: aload_0
    //   902: invokevirtual 52	hls:getName	()Ljava/lang/String;
