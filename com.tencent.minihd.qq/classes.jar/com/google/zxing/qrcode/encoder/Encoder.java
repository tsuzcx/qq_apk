...
public final class Encoder
{
  ...
  private static int a(BitArray paramBitArray, ErrorCorrectionLevel paramErrorCorrectionLevel, Version paramVersion, ByteMatrix paramByteMatrix)
  {
    ...
    if (i < 8)
    {
      et.a(paramBitArray, paramErrorCorrectionLevel, paramVersion, i, paramByteMatrix);
  ...
  {
    return es.a(paramByteMatrix) + es.b(paramByteMatrix) + es.c(paramByteMatrix) + es.d(paramByteMatrix);
  }
  ...
  static BitArray a(BitArray paramBitArray, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (int j = 0; k < paramInt3; j = n + j)
    {
      ...
      localArrayList.add(new eq(arrayOfByte, (byte[])localObject2));
      m = Math.max(m, n);
    ...
    while (paramInt2 < m)
    {
      ...
      {
        arrayOfByte = ((eq)((Iterator)localObject1).next()).a();
    ...
    while (paramInt2 < i)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        arrayOfByte = ((eq)((Iterator)localObject1).next()).b();
        if (paramInt2 < arrayOfByte.length) {
          paramBitArray.b(arrayOfByte[paramInt2], 8);
        }
      }
  ...
  public static QRCode a(String paramString, ErrorCorrectionLevel paramErrorCorrectionLevel, Map paramMap)
  {
    ...
    for (int i = ((BitArray)localObject3).b();; i = paramString.length())
    {
      ...
      et.a(paramString, paramErrorCorrectionLevel, paramMap, i, (ByteMatrix)localObject1);
