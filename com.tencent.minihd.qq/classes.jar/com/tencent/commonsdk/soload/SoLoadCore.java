...
public class SoLoadCore
{
  ...
  private static void copyZipEntry2File(java.util.zip.ZipEntry paramZipEntry, ZipFile paramZipFile, File paramFile)
  {
    ...
    //   20: iconst_0
    //   21: ifeq +11 -> 32
    //   24: new 74	java/lang/NullPointerException
    //   27: dup
    //   28: invokespecial 75	java/lang/NullPointerException:<init>	()V
    //   31: athrow
    //   32: iconst_0
    //   33: ifeq +11 -> 44
    //   36: new 74	java/lang/NullPointerException
    //   39: dup
    //   40: invokespecial 75	java/lang/NullPointerException:<init>	()V
    //   43: athrow
    //   44: return
    //   45: aload 8
    //   47: astore 5
    //   49: aload_1
    //   50: aload_0
    //   51: invokevirtual 81	java/util/zip/ZipFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   54: astore_0
    //   55: aload 8
    //   57: astore 5
    //   59: aload_0
    ...
    //   79: aload_0
    //   80: astore 6
    //   82: new 83	java/io/FileOutputStream
    //   85: dup
    //   86: aload_2
    //   87: invokespecial 86	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   90: astore_1
    //   91: aload_0
    //   92: aload 9
    //   94: invokevirtual 92	java/io/InputStream:read	([B)I
    //   97: istore_3
    //   98: iload_3
    //   99: iconst_m1
    ...
    //   106: iconst_0
    //   107: iload_3
    //   108: invokevirtual 96	java/io/FileOutputStream:write	([BII)V
    //   111: goto -20 -> 91
    //   114: astore_2
    //   115: aload_1
    //   116: astore 5
    ...
    //   119: astore 4
    //   121: aload_2
    //   122: invokevirtual 99	java/io/IOException:printStackTrace	()V
    //   125: aload_0
    //   126: ifnull +7 -> 133
    //   129: aload_0
    //   130: invokevirtual 102	java/io/InputStream:close	()V
    //   133: aload_1
    //   134: ifnull -90 -> 44
    //   137: aload_1
    //   138: invokevirtual 103	java/io/FileOutputStream:close	()V
    //   141: return
    //   142: astore_0
    //   143: return
    //   144: aload_1
    //   145: ifnull +7 -> 152
    //   148: aload_1
    //   149: invokevirtual 103	java/io/FileOutputStream:close	()V
    //   152: aload_0
    //   153: ifnull +7 -> 160
    //   156: aload_0
    //   157: invokevirtual 102	java/io/InputStream:close	()V
    //   160: aload_1
    //   161: ifnull +7 -> 168
    //   164: aload_1
    //   165: invokevirtual 103	java/io/FileOutputStream:close	()V
    //   168: return
    //   169: astore_0
    //   170: return
    //   171: astore_0
    ...
    //   174: ifnull +8 -> 182
    //   177: aload 4
    //   179: invokevirtual 102	java/io/InputStream:close	()V
    //   182: aload 5
    //   184: ifnull +8 -> 192
    //   187: aload 5
    //   189: invokevirtual 103	java/io/FileOutputStream:close	()V
    //   192: aload_0
    //   193: athrow
    //   194: astore_1
    //   195: goto -3 -> 192
  ...
  public static long getCRC32Value(File paramFile)
  {
    ...
    //   7: ifnull +12 -> 19
    //   10: aload_0
    //   11: invokevirtual 200	java/io/File:exists	()Z
    //   14: ifne +7 -> 21
    //   17: lload_3
    //   18: lstore_1
    //   19: lload_1
    ...
    //   24: aconst_null
    //   25: astore 6
    //   27: new 202	java/io/FileInputStream
    //   30: dup
    //   31: aload_0
    //   32: invokespecial 203	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   35: astore_0
    //   36: aload_0
    //   37: invokestatic 206	com/tencent/commonsdk/soload/SoLoadCore:getCRC32Value	(Ljava/io/InputStream;)J
    //   40: lstore_1
    //   41: lload_1
    //   42: lstore_3
    //   43: lload_3
    ...
    //   46: ifnull -27 -> 19
    //   49: aload_0
    //   50: invokevirtual 207	java/io/FileInputStream:close	()V
    //   53: lload_3
    //   54: lreturn
    //   55: astore_0
    //   56: aload_0
    ...
    //   72: astore 5
    //   74: aload 6
    //   76: invokevirtual 208	java/lang/Exception:printStackTrace	()V
    //   79: lload_3
    //   80: lstore_1
    //   81: aload_0
    //   82: ifnull -63 -> 19
    //   85: aload_0
    //   86: invokevirtual 207	java/io/FileInputStream:close	()V
    //   89: ldc2_w 195
    //   92: lreturn
    //   93: astore_0
    //   94: aload_0
    ...
    //   105: ifnull +8 -> 113
    //   108: aload 5
    //   110: invokevirtual 207	java/io/FileInputStream:close	()V
    //   113: aload_0
    //   114: athrow
    //   115: astore 5
    //   117: aload 5
  ...
  private static String getPlatformString()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 261	android/os/Build:CPU_ABI	Ljava/lang/String;
    //   6: astore_0
    //   7: aload_0
    //   8: ifnull +22 -> 30
    //   11: aload_0
    //   12: ldc_w 263
    //   15: invokevirtual 269	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   18: ifeq +12 -> 30
    //   21: ldc_w 263
    //   24: astore_0
    //   25: ldc 2
    ...
    //   34: aload_0
    //   35: ldc_w 271
    //   38: invokevirtual 269	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   41: ifeq +10 -> 51
    //   44: ldc_w 273
    //   47: astore_0
    //   48: goto -23 -> 25
  ...
  private static void initAssestCrcConfigs(Context paramContext)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 64	com/tencent/commonsdk/soload/SoLoadCore:assestCrcConfigs	Ljava/util/HashMap;
    //   6: astore 4
    //   8: aload 4
    //   10: ifnull +7 -> 17
    //   13: ldc 2
    ...
    //   27: aload 7
    //   29: astore 4
    //   31: new 283	java/util/HashMap
    //   34: dup
    //   35: invokespecial 379	java/util/HashMap:<init>	()V
    //   38: putstatic 64	com/tencent/commonsdk/soload/SoLoadCore:assestCrcConfigs	Ljava/util/HashMap;
    //   41: aload 6
    //   43: astore 5
    //   45: aload 7
    //   47: astore 4
    //   49: aload_0
    //   50: invokevirtual 383	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   53: invokevirtual 389	android/content/res/Resources:getAssets	()Landroid/content/res/AssetManager;
    //   56: ldc 13
    //   58: invokevirtual 395	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   61: astore_0
    //   62: aload_0
    //   63: astore 5
    //   65: aload_0
    //   66: astore 4
    //   68: new 397	java/io/BufferedReader
    //   71: dup
    //   72: new 399	java/io/InputStreamReader
    //   75: dup
    //   76: aload_0
    //   77: invokespecial 402	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   80: invokespecial 405	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   83: astore 6
    //   85: aload_0
    //   86: astore 5
    //   88: aload_0
    //   89: astore 4
    //   91: aload 6
    //   93: invokevirtual 408	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   96: astore 7
    //   98: aload 7
    //   100: ifnull +115 -> 215
    //   103: aload_0
    ...
    //   109: aload 7
    //   111: ldc_w 410
    //   114: invokevirtual 414	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   117: istore_1
    //   118: aload_0
    //   119: astore 5
    //   121: aload_0
    ...
    //   126: iconst_0
    //   127: iload_1
    //   128: invokevirtual 418	java/lang/String:substring	(II)Ljava/lang/String;
    //   131: astore 8
    //   133: aload_0
    //   134: astore 5
    //   136: aload_0
    ...
    //   142: iconst_1
    //   143: iadd
    //   144: invokevirtual 421	java/lang/String:substring	(I)Ljava/lang/String;
    //   147: invokestatic 425	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   150: lstore_2
    //   151: lload_2
    //   152: lconst_1
    //   153: lcmp
    ...
    //   160: aload_0
    //   161: astore 4
    //   163: getstatic 64	com/tencent/commonsdk/soload/SoLoadCore:assestCrcConfigs	Ljava/util/HashMap;
    //   166: aload 8
    //   168: lload_2
    //   169: invokestatic 429	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   172: invokevirtual 433	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   175: pop
    //   176: goto -91 -> 85
    //   179: astore_0
    //   180: aload 5
    //   182: astore 4
    //   184: aload_0
    //   185: invokevirtual 208	java/lang/Exception:printStackTrace	()V
    //   188: aload 5
    //   190: ifnull -177 -> 13
    //   193: aload 5
    //   195: invokevirtual 102	java/io/InputStream:close	()V
    //   198: goto -185 -> 13
    //   201: astore_0
    //   202: aload_0
    //   203: invokevirtual 99	java/io/IOException:printStackTrace	()V
    //   206: goto -193 -> 13
    //   209: astore_0
    //   210: ldc 2
    //   212: monitorexit
    ...
    //   237: ifnull +8 -> 245
    //   240: aload 4
    //   242: invokevirtual 102	java/io/InputStream:close	()V
    //   245: aload_0
    //   246: athrow
    //   247: astore 4
    //   249: aload 4
    //   251: invokevirtual 99	java/io/IOException:printStackTrace	()V
    //   254: goto -9 -> 245
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  private static ConfigStruct readConfig(File paramFile)
  {
    ...
    //   12: ldc_w 482
    //   15: astore 7
    //   17: new 202	java/io/FileInputStream
    //   20: dup
    //   21: aload_0
    //   22: invokespecial 203	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   25: astore_0
    //   26: new 397	java/io/BufferedReader
    //   29: dup
    //   30: new 399	java/io/InputStreamReader
    //   33: dup
    //   34: aload_0
    //   35: invokespecial 402	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   38: invokespecial 405	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   41: astore_3
    //   42: aload_3
    //   43: invokevirtual 408	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   46: astore_0
    //   47: aload_0
    //   48: ifnull +115 -> 163
    //   51: aload_0
    //   52: ldc_w 484
    //   55: invokevirtual 269	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   58: ifeq +105 -> 163
    //   61: aload_0
    //   62: aload_0
    //   63: ldc_w 486
    //   66: invokevirtual 414	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   69: iconst_1
    //   70: iadd
    //   71: invokevirtual 421	java/lang/String:substring	(I)Ljava/lang/String;
    //   74: invokestatic 425	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   77: lstore_1
    //   78: aload_3
    //   79: invokevirtual 408	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   82: astore_0
    //   83: aload 7
    //   85: astore 4
    //   87: aload_0
    ...
    //   95: aload_0
    //   96: ldc_w 488
    //   99: invokevirtual 269	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   102: ifeq +18 -> 120
    //   105: aload_0
    //   106: aload_0
    //   107: ldc_w 486
    //   110: invokevirtual 414	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   113: iconst_1
    //   114: iadd
    //   115: invokevirtual 421	java/lang/String:substring	(I)Ljava/lang/String;
    //   118: astore 4
    //   120: aload 6
    //   122: astore_0
    //   123: lload_1
    ...
    //   142: new 315	com/tencent/commonsdk/soload/ConfigStruct
    //   145: dup
    //   146: lload_1
    //   147: aload 4
    //   149: invokespecial 445	com/tencent/commonsdk/soload/ConfigStruct:<init>	(JLjava/lang/String;)V
    //   152: astore_0
    //   153: aload_3
    //   154: ifnull +111 -> 265
    //   157: aload_3
    //   158: invokevirtual 489	java/io/BufferedReader:close	()V
    //   161: aload_0
    //   162: areturn
    //   163: aload_3
    //   164: ifnull +7 -> 171
    //   167: aload_3
    //   168: invokevirtual 489	java/io/BufferedReader:close	()V
    //   171: aconst_null
    //   172: areturn
    //   173: astore_0
    //   174: aload_0
    //   175: invokevirtual 99	java/io/IOException:printStackTrace	()V
    //   178: goto -7 -> 171
    //   181: astore_3
    //   182: aload_3
    //   183: invokevirtual 99	java/io/IOException:printStackTrace	()V
    //   186: goto -25 -> 161
    //   189: astore_0
    //   190: aload 8
    //   192: astore_3
    ...
    //   197: ifnull -36 -> 161
    //   200: aload_3
    //   201: invokevirtual 489	java/io/BufferedReader:close	()V
    //   204: aload 5
    //   206: astore_0
    //   207: goto -46 -> 161
    //   210: astore_0
    //   211: aload_0
    //   212: invokevirtual 99	java/io/IOException:printStackTrace	()V
    //   215: aload 5
    //   217: astore_0
    //   218: goto -57 -> 161
    //   221: astore_0
    ...
    //   226: ifnull +7 -> 233
    //   229: aload_3
    //   230: invokevirtual 489	java/io/BufferedReader:close	()V
    //   233: aload_0
    //   234: athrow
    //   235: astore_3
    //   236: aload_3
    //   237: invokevirtual 99	java/io/IOException:printStackTrace	()V
    //   240: goto -7 -> 233
    //   243: astore_0
    //   244: aload 4
    //   246: astore_3
  ...
  public static String releaseSo(Context paramContext, String paramString)
  {
    ...
    if (((String)localObject1).equals("equalAndAbove14")) {
      paramString = getSoByBaseDexClassLoader(paramContext, str1, str2);
    }
    for (;;)
    {
      ...
      if (((String)localObject1).equals("below14")) {
        paramString = getSoByPathClassLoader(paramContext, str1, str2);
      }
    }
  }
  ...
  private static boolean writeConfig(ConfigStruct paramConfigStruct, File paramFile)
  {
    ...
    //   6: istore_2
    //   7: aload_1
    //   8: invokevirtual 200	java/io/File:exists	()Z
    //   11: ifeq +8 -> 19
    //   14: aload_1
    //   15: invokevirtual 334	java/io/File:delete	()Z
    //   18: pop
    //   19: aload_1
    //   20: invokevirtual 350	java/io/File:createNewFile	()Z
    //   23: pop
    //   24: new 519	java/io/BufferedWriter
    //   27: dup
    //   28: new 521	java/io/OutputStreamWriter
    //   31: dup
    //   32: new 83	java/io/FileOutputStream
    //   35: dup
    //   36: aload_1
    //   37: invokespecial 86	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   40: invokespecial 524	java/io/OutputStreamWriter:<init>	(Ljava/io/OutputStream;)V
    //   43: invokespecial 527	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   46: astore_1
    //   47: aload_1
    //   48: new 226	java/lang/StringBuilder
    //   51: dup
    //   52: invokespecial 227	java/lang/StringBuilder:<init>	()V
    //   55: ldc_w 529
    //   58: invokevirtual 233	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   61: aload_0
    //   62: getfield 319	com/tencent/commonsdk/soload/ConfigStruct:mCrcvalue	J
    //   65: invokevirtual 532	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   68: invokevirtual 238	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   71: invokevirtual 534	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   74: aload_1
    //   75: invokevirtual 537	java/io/BufferedWriter:newLine	()V
    //   78: aload_1
    //   79: new 226	java/lang/StringBuilder
    //   82: dup
    //   83: invokespecial 227	java/lang/StringBuilder:<init>	()V
    //   86: ldc_w 539
    //   89: invokevirtual 233	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   92: aload_0
    //   93: getfield 322	com/tencent/commonsdk/soload/ConfigStruct:mSopath	Ljava/lang/String;
    //   96: invokevirtual 233	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   99: invokevirtual 238	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   102: invokevirtual 534	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   105: iconst_1
    //   106: istore_2
    //   107: aload_1
    //   108: ifnull +68 -> 176
    //   111: aload_1
    //   112: invokevirtual 540	java/io/BufferedWriter:close	()V
    //   115: iload_2
    //   116: ireturn
    //   117: astore_0
    //   118: aload_0
    ...
    //   129: ifnull -14 -> 115
    //   132: aload_0
    //   133: invokevirtual 540	java/io/BufferedWriter:close	()V
    //   136: iconst_0
    //   137: ireturn
    //   138: astore_0
    //   139: aload_0
    //   140: invokevirtual 99	java/io/IOException:printStackTrace	()V
    //   143: iconst_0
    //   144: ireturn
    //   145: astore_0
    //   146: aload_3
    ...
    //   149: ifnull +7 -> 156
    //   152: aload_1
    //   153: invokevirtual 540	java/io/BufferedWriter:close	()V
    //   156: aload_0
    //   157: athrow
    //   158: astore_1
    //   159: aload_1
