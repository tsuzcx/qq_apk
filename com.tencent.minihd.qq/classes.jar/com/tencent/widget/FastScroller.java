...
public class FastScroller
{
  ...
  private final Runnable jdField_a_of_type_JavaLangRunnable = new lrw(this);
  ...
  private void a(Context paramContext)
  {
    ...
    b();
    this.r = paramContext.getResources().getDimensionPixelSize(2131492893);
  ...
  private void a(Context paramContext, Drawable paramDrawable)
  {
    ...
    if ((paramDrawable instanceof NinePatchDrawable)) {
      this.jdField_b_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131492894);
    }
    for (this.jdField_a_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131492895);; this.jdField_a_of_type_Int = paramDrawable.getIntrinsicHeight())
    {
  ...
  boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      {
        if (!this.jdField_a_of_type_ComTencentWidgetAbsListView.o())
        {
          f();
          return true;
        }
    ...
    do
    {
      ...
      if (i2 == 1)
      {
        ...
        for (;;)
        {
          ...
          if (this.jdField_a_of_type_ComTencentWidgetAbsListView != null)
          {
            ...
            this.jdField_a_of_type_ComTencentWidgetAbsListView.c(0);
          }
          b(2);
      ...
      if ((this.jdField_b_of_type_Boolean) && (Math.abs(paramMotionEvent.getY() - this.jdField_a_of_type_Float) > this.y))
      {
        ...
        if (this.jdField_a_of_type_ComTencentWidgetAbsListView != null)
        {
          ...
          this.jdField_a_of_type_ComTencentWidgetAbsListView.c(1);
        }
        i();
        d();
      }
