  ...
  implements Parcelable
{
  ...
  {
    return "ToServiceMsg msName:" + this.msfCommand + " ssoSeq:" + getRequestSsoSeq() + " appId:" + this.appId + " appSeq:" + this.appSeq + " sName:" + this.serviceName + " uin:" + MsfSdkUtils.getShortUin(this.uin) + " sCmd:" + this.serviceCmd + " t:" + this.timeout + " needResp:" + this.needResp;
  }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    //   69: invokevirtual 329	android/os/Parcel:writeStrongInterface	(Landroid/os/IInterface;)V
    //   72: aload_0
    ...
    //   84: invokevirtual 333	android/os/Parcel:writeSerializable	(Ljava/io/Serializable;)V
    //   87: aload_1
    //   88: aload_0
    //   89: getfield 55	com/tencent/qphone/base/remote/ToServiceMsg:sendTimeout	J
    //   92: invokevirtual 322	android/os/Parcel:writeLong	(J)V
    //   95: aload_0
