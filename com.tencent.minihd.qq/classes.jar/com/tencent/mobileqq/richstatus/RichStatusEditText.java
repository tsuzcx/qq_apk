  ...
  extends EditText
{
  ...
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new jsk(this);
  ...
  {
    if (((paramInt > 0) && (!getText().subSequence(paramInt - 1, paramInt).toString().equals(" "))) || (paramInt == 0))
    {
      this.jdField_a_of_type_Boolean = false;
      getText().insert(paramInt, " ");
      this.jdField_a_of_type_Boolean = true;
    }
  }
  ...
  {
    if (((paramInt < length()) && (!getText().subSequence(paramInt, paramInt + 1).toString().equals(" "))) || (paramInt == length()))
    {
      this.jdField_a_of_type_Boolean = false;
      getText().insert(paramInt, " ");
      this.jdField_a_of_type_Boolean = true;
  ...
  protected void onSelectionChanged(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 != paramInt2) && (((ClickableImageSpan[])a().getSpans(Math.min(paramInt1, paramInt2), Math.max(paramInt1, paramInt2), ClickableImageSpan.class)).length != 0))
    {
      ...
      this.jdField_a_of_type_Int = ((jsl)localObject).jdField_a_of_type_Int;
      this.b = ((jsl)localObject).b;
      i = 1;
    }
    for (;;)
    {
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if ((!isFocused()) || (getSelectionEnd() != getSelectionStart()) || ((k != 0) && (k != 2) && (k != 3) && (k != 1)))
    {
      if (k == 1)
      {
        localObject = ((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app.a(EditActivity.class);
        if (localObject != null) {
          Message.obtain((Handler)localObject, 4).sendToTarget();
        }
      }
