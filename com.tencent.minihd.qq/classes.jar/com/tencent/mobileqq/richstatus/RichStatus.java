  ...
  implements Cloneable
{
  ...
  public static RichStatus a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      case 4: 
        ...
        for (localRichStatus.g = localRichStatus.jdField_a_of_type_JavaUtilArrayList.size();; localRichStatus.g = 0)
        {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localRichStatus.h = localByteBuffer.getInt();
          localRichStatus.i = localByteBuffer.getInt();
          continue;
          localRichStatus.jdField_f_of_type_JavaLangString = new String(paramArrayOfByte, i1, i3);
          if (QLog.isColorLevel())
          {
            QLog.d("Q.richstatus.status", 2, HexUtil.a(paramArrayOfByte) + ",sign feeds id=" + localRichStatus.jdField_f_of_type_JavaLangString);
            continue;
            localRichStatus.jdField_d_of_type_Int = localByteBuffer.getInt();
            continue;
            localRichStatus.jdField_e_of_type_Int = localByteBuffer.getInt();
            continue;
            localRichStatus.jdField_f_of_type_Int = localByteBuffer.getInt();
          }
        }
      }
    }
  ...
  public CharSequence a(TextView paramTextView, CharSequence paramCharSequence)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        jdField_a_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource((Resources)localObject2, 2130841580);
        label107:
        ...
        if (paramCharSequence != null) {}
        for (i1 = paramCharSequence.length() + 1;; i1 = 0)
        {
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      break;
      i2 = 1;
      return (this.b == 0) && (this.jdField_c_of_type_Int == 0) && (i2 != 0) && (TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString));
    }
  }
  ...
  public byte[] a()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)) {
      localByteBuffer.put((byte)-126).put((byte)8).putInt(this.h).putInt(this.i);
    }
    localByteBuffer.put((byte)-111).put((byte)4).putInt(this.jdField_d_of_type_Int);
    localByteBuffer.put((byte)-110).put((byte)4).putInt(this.jdField_e_of_type_Int);
