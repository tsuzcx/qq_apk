  ...
  extends Service
{
    ...
    throws Exception
  {
    ...
    Object localObject = (PackageInfo)PluginStatic.d.get(this.e);
    if (localObject == null)
    {
      try
      {
        PackageInfo localPackageInfo = ApkFileParser.getPackageInfo(this, this.e, 1);
      ...
      catch (Throwable localThrowable2)
      {
        label37:
        break label37;
        PluginStatic.d.put(this.e, localObject);
      }
      if (localObject == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.a.IInit(this.d, this.e, this, localClassLoader, (PackageInfo)localObject, this.b);
        return null;
      }
  ...
  public int onStartCommand(Intent paramIntent, int paramInt1, int paramInt2)
  {
    ...
    if ((startPluginIfNeccessary(paramIntent)) && (this.a != null)) {
      this.a.IOnStartCommand(paramIntent, paramInt1, paramInt2);
    }
    return 3;
  }
  ...
  protected boolean startPluginIfNeccessary(Intent paramIntent)
  {
    ...
    try
    {
      ...
      this.c = str3;
      this.f = str5;
      localObject = PluginStatic.b(this.d);
      if (localObject != null) {
