...
public class d
{
  ...
  public static int a(ToServiceMsg paramToServiceMsg)
  {
    ...
    if (!a.containsKey(paramToServiceMsg.getServiceName())) {
      a.putIfAbsent(paramToServiceMsg.getServiceName(), new u(paramToServiceMsg.getServiceName()));
    }
    return ((u)a.get(paramToServiceMsg.getServiceName())).b(paramToServiceMsg);
  }
  ...
  public static void a(String paramString)
  {
    ...
    if (!a.containsKey(paramString)) {
      a.putIfAbsent(paramString, new u(paramString));
    }
    ((u)a.get(paramString)).i();
  }
