...
public class SettingCloneUtil
{
  ...
  private static String readFromFile(Context paramContext, String paramString)
  {
    ...
    //   407: ifnull +7 -> 414
    //   410: aload_0
    //   411: invokevirtual 140	java/io/FileInputStream:close	()V
    //   414: aload_1
    //   415: athrow
    //   416: astore_0
    //   417: invokestatic 56	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   420: ifeq +31 -> 451
    //   423: ldc 8
    //   425: iconst_2
    ...
    //   438: aload_0
    //   439: invokestatic 146	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   442: invokevirtual 65	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   445: invokevirtual 73	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   448: invokestatic 77	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   451: aload_0
    //   452: invokevirtual 149	java/lang/Throwable:printStackTrace	()V
    //   455: goto -41 -> 414
    //   458: astore_0
    //   459: invokestatic 56	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   462: ifeq +31 -> 493
    //   465: ldc 8
    //   467: iconst_2
    //   468: new 58	java/lang/StringBuilder
    //   471: dup
    //   472: invokespecial 59	java/lang/StringBuilder:<init>	()V
    //   475: ldc 228
    //   477: invokevirtual 65	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   480: aload_0
    //   481: invokestatic 146	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   484: invokevirtual 65	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   487: invokevirtual 73	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   490: invokestatic 77	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   493: aload_0
    //   494: invokevirtual 149	java/lang/Throwable:printStackTrace	()V
    //   497: goto -182 -> 315
    //   500: astore_1
    //   501: goto -95 -> 406
    //   504: astore_1
    ...
    //   40	467	2	localFileInputStream	FileInputStream
    ...
    //   20	34	403	finally
    //   34	41	403	finally
    //   410	414	416	java/lang/Throwable
    //   311	315	458	java/lang/Throwable
    //   43	51	500	finally
    //   53	58	500	finally
    //   60	66	500	finally
    //   68	76	500	finally
    ...
    //   382	390	500	finally
    //   392	398	500	finally
    //   20	34	504	java/lang/Throwable
    //   34	41	504	java/lang/Throwable
  }
  
  public static String readValue(Context paramContext, String arg1, String paramString2, String paramString3, String paramString4)
  {
    if (paramContext == null) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      for (;;)
      {
        ...
        if ((paramString2 != null) && (!paramString2.equals("qqsetting_screenshot_key"))) {
          synchronized (locker)
          {
            readFromFile(paramContext, null);
            paramContext = get(paramString2);
            if (paramContext != null) {
              return paramContext;
            }
          }
      ...
      paramContext = readFromFile(paramContext, paramString2);
  ...
  public static void writeValue(Context paramContext, String arg1, String paramString2, String paramString3, String paramString4)
  {
    if (paramContext == null)
    {
      if (QLog.isColorLevel()) {
    ...
    synchronized (locker)
    {
      put(paramString2, paramString4);
      paramString3 = new Properties();
      try
      {
        if (isKeyFileExists(paramContext))
        {
          FileInputStream localFileInputStream = paramContext.openFileInput("set_sp");
          paramString3.load(localFileInputStream);
          localFileInputStream.close();
        }
        paramString3.setProperty(paramString2, paramString4);
        paramString3.store(paramContext.openFileOutput("set_sp", 0), null);
        if (QLog.isColorLevel()) {
          QLog.d("set_sp", 2, "write string. write file ok.k=" + paramString2 + " v=" + paramString4);
        }
      }
      catch (Throwable paramContext)
      {
  ...
  public static void writeValue(Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    //   77: aload 9
    //   79: iload 4
    //   81: invokestatic 248	java/lang/Boolean:toString	(Z)Ljava/lang/String;
    //   84: invokestatic 280	com/tencent/mobileqq/msf/sdk/SettingCloneUtil:put	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   170: aload 9
    //   172: iload 4
    //   174: invokestatic 248	java/lang/Boolean:toString	(Z)Ljava/lang/String;
    //   177: invokevirtual 284	java/util/Properties:setProperty	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;
    //   180: pop
    //   181: aload 10
    //   183: astore 5
    //   185: aload 6
    ...
    //   197: ldc 8
    //   199: iconst_0
    //   200: invokevirtual 288	android/content/Context:openFileOutput	(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    //   203: astore 10
    //   205: aload 10
    //   207: astore 5
    //   209: aload 6
    ...
    //   222: aload 10
    //   224: aconst_null
    //   225: invokevirtual 292	java/util/Properties:store	(Ljava/io/OutputStream;Ljava/lang/String;)V
    //   228: aload 10
    //   230: astore 5
    //   232: aload 6
    //   234: astore_3
    ...
    //   354: ifeq +57 -> 411
    //   357: aload_0
    //   358: invokeinterface 307 1 0
    //   363: astore_0
    //   364: aload_0
    //   365: aload_3
    //   366: invokeinterface 313 2 0
    //   371: pop
    //   372: aload_0
    //   373: invokeinterface 316 1 0
    //   378: pop
    ...
    //   423: ifnull +8 -> 431
    //   426: aload 10
    //   428: invokevirtual 321	java/io/FileOutputStream:close	()V
    //   431: aload 12
    //   433: monitorexit
    //   434: return
    //   435: astore_0
    ...
    //   561: ifeq +57 -> 618
    //   564: aload_0
    //   565: invokeinterface 307 1 0
    //   570: astore_0
    //   571: aload_0
    //   572: aload_3
    //   573: invokeinterface 313 2 0
    //   578: pop
    //   579: aload_0
    //   580: invokeinterface 316 1 0
    //   585: pop
    ...
    //   630: ifnull -199 -> 431
    //   633: aload 8
    //   635: invokevirtual 321	java/io/FileOutputStream:close	()V
    //   638: goto -207 -> 431
    //   641: astore_0
    ...
    //   677: aload_0
    //   678: invokevirtual 326	java/lang/Exception:printStackTrace	()V
    //   681: goto -250 -> 431
    //   684: astore 6
    //   686: aconst_null
    //   687: astore_3
    ...
    //   745: ifeq +59 -> 804
    //   748: aload_0
    //   749: invokeinterface 307 1 0
    //   754: astore_0
    //   755: aload_0
    //   756: aload 7
    //   758: invokeinterface 313 2 0
    //   763: pop
    //   764: aload_0
    //   765: invokeinterface 316 1 0
    //   770: pop
    ...
    //   814: ifnull +8 -> 822
    //   817: aload 5
    //   819: invokevirtual 321	java/io/FileOutputStream:close	()V
    //   822: aload 6
    //   824: athrow
    //   825: astore_0
    ...
    //   861: aload_0
    //   862: invokevirtual 326	java/lang/Exception:printStackTrace	()V
    //   865: goto -43 -> 822
    //   868: astore_0
    ...
    //   904: aload_0
    //   905: invokevirtual 326	java/lang/Exception:printStackTrace	()V
    //   908: goto -477 -> 431
    //   911: astore 6
    //   913: goto -225 -> 688
    //   916: astore 6
  ...
  public static void writeValueForInt(Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    //   77: aload 9
    //   79: iload 4
    //   81: invokestatic 272	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   84: invokestatic 280	com/tencent/mobileqq/msf/sdk/SettingCloneUtil:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   87: new 127	java/util/Properties
    //   90: dup
    //   91: invokespecial 128	java/util/Properties:<init>	()V
    ...
    //   170: aload 9
    //   172: iload 4
    //   174: invokestatic 272	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   177: invokevirtual 284	java/util/Properties:setProperty	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;
    //   180: pop
    //   181: aload 10
    //   183: astore 5
    ...
    //   287: invokevirtual 65	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   290: iload 4
    //   292: invokevirtual 261	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   295: invokevirtual 73	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   298: invokestatic 77	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   301: aload_2
    //   302: invokestatic 157	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
