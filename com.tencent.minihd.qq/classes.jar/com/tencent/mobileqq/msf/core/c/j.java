  ...
  public void run()
  {
      ...
      if ((localObject1 != null) && (((String)localObject1).length() > 0)) {
        try
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            i.c.a("actNetworkFlowCollection", true, 0L, ((l)localObject5).b, ((l)localObject5).c, false, false);
      ...
      if ((localObject2 != null) && (((String)localObject2).length() > 0)) {
        try
        {
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            i.c.a("monitorNetFlowResultReportRDM", true, 0L, ((l)localObject5).b, ((l)localObject5).c, false, false);
            localObject6 = ((l)localObject5).c.entrySet().iterator();
            while (((Iterator)localObject6).hasNext())
            {
              localObject7 = (Map.Entry)((Iterator)localObject6).next();
      ...
      if ((localObject3 != null) && (((String)localObject3).length() > 0)) {
        try
        {
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            i.c.a("monitorNetFlowCautionReportRDM", true, 0L, ((l)localObject5).b, ((l)localObject5).c, false, false);
            localObject6 = ((l)localObject5).c.entrySet().iterator();
            while (((Iterator)localObject6).hasNext())
            {
              localObject7 = (Map.Entry)((Iterator)localObject6).next();
    ...
    try
    {
      ...
      while (((Iterator)localObject4).hasNext())
      {
        ...
        i.c.a("monitorNetFlowResultReportRDMWithStatus", true, 0L, ((l)localObject5).b, ((l)localObject5).c, false, false);
        localObject6 = ((l)localObject5).c.entrySet().iterator();
        while (((Iterator)localObject6).hasNext())
        {
          localObject7 = (Map.Entry)((Iterator)localObject6).next();
