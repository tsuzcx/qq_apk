...
public class h
{
  ...
  public static final String[] c = { "game.qq.com", "qun.qq.com", "connect.qq.com", "mail.qq.com", "qzone.qq.com", "qzone.com", "openmobile.qq.com", "tenpay.com" };
  ...
  {
    FromServiceMsg localFromServiceMsg = l.a(paramToServiceMsg);
  ...
  static void a(String paramString)
  {
    ...
    MsfStore.getNativeConfigStore().setConfig("_wtlastchecklocaltokentime_" + paramString, String.valueOf(l1));
  }
  ...
  public void D(ToServiceMsg paramToServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      a(paramToServiceMsg, localk, e.GetStViaSMSVerifyLogin((String)localObject, 16L, l1, 1970272, localWUserSigInfo), "wt_GetStViaSMSVerifyLogin");
      return;
  ...
  int a(ToServiceMsg paramToServiceMsg, WtloginHelper paramWtloginHelper)
  {
    ...
    paramWtloginHelper = l.a(paramToServiceMsg);
  ...
  public int a(ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if ((str2 != null) && (str2.equalsIgnoreCase("ssoAccountAction")))
      {
        ...
        l1 = 2L;
        str2 = (String)paramToServiceMsg.getAttribute("process", null);
        if ((!TextUtils.isEmpty(str2)) && (str2.equals("com.tencent.minihd.qq:openSdk"))) {}
        int m = e.GetStWithPasswdMd5(paramToServiceMsg.getUin(), 16L, l1, 1970272, (String)localObject1, (WUserSigInfo)localObject3);
        a(paramToServiceMsg, (k)localObject2, m, "login");
        return m;
      }
    }
  ...
  public HashMap c(String paramString)
  {
    ...
    //   3: aconst_null
    //   4: astore 8
    //   6: getstatic 106	com/tencent/mobileqq/msf/core/auth/h:e	Loicq/wlogin_sdk/request/WtloginHelper;
    //   9: aload_1
    //   10: ldc2_w 11
    //   13: bipush 64
    //   15: invokevirtual 505	oicq/wlogin_sdk/request/WtloginHelper:GetLocalTicket	(Ljava/lang/String;JI)Loicq/wlogin_sdk/request/Ticket;
    //   18: astore_2
    //   19: aload_2
    //   20: ifnull +657 -> 677
    //   23: aload_2
    //   24: getfield 585	oicq/wlogin_sdk/request/Ticket:_sig	[B
    //   27: astore_2
    //   28: aload_2
    //   29: ifnull +648 -> 677
    //   32: aload_2
    //   33: invokestatic 591	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   36: astore_2
    //   37: getstatic 106	com/tencent/mobileqq/msf/core/auth/h:e	Loicq/wlogin_sdk/request/WtloginHelper;
    //   40: aload_1
    //   41: ldc2_w 11
    //   44: ldc_w 592
    //   47: invokevirtual 505	oicq/wlogin_sdk/request/WtloginHelper:GetLocalTicket	(Ljava/lang/String;JI)Loicq/wlogin_sdk/request/Ticket;
    //   50: astore_3
    //   51: aload_3
    //   52: ifnull +620 -> 672
    //   55: aload_3
    //   56: getfield 585	oicq/wlogin_sdk/request/Ticket:_sig	[B
    //   59: astore_3
    //   60: aload_3
    //   61: ifnull +611 -> 672
    //   64: new 39	java/lang/String
    //   67: dup
    //   68: aload_3
    //   69: invokespecial 595	java/lang/String:<init>	([B)V
    //   72: astore_3
    //   73: getstatic 106	com/tencent/mobileqq/msf/core/auth/h:e	Loicq/wlogin_sdk/request/WtloginHelper;
    //   76: aload_1
    //   77: ldc2_w 11
    //   80: ldc_w 596
    //   83: invokevirtual 505	oicq/wlogin_sdk/request/WtloginHelper:GetLocalTicket	(Ljava/lang/String;JI)Loicq/wlogin_sdk/request/Ticket;
    //   86: astore 4
    //   88: aload 4
    //   90: ifnull +576 -> 666
    //   93: aload 4
    //   95: getfield 585	oicq/wlogin_sdk/request/Ticket:_sig	[B
    //   98: astore 4
    //   100: aload 4
    //   102: ifnull +564 -> 666
    //   105: new 39	java/lang/String
    //   108: dup
    //   109: aload 4
    //   111: invokespecial 595	java/lang/String:<init>	([B)V
    //   114: astore 4
    //   116: getstatic 106	com/tencent/mobileqq/msf/core/auth/h:e	Loicq/wlogin_sdk/request/WtloginHelper;
    //   119: aload_1
    //   120: ldc2_w 11
    //   123: sipush 4096
    //   126: invokevirtual 505	oicq/wlogin_sdk/request/WtloginHelper:GetLocalTicket	(Ljava/lang/String;JI)Loicq/wlogin_sdk/request/Ticket;
    //   129: astore 5
    //   131: aload 5
    //   133: ifnull +527 -> 660
    //   136: aload 5
    //   138: getfield 585	oicq/wlogin_sdk/request/Ticket:_sig	[B
    //   141: astore 5
    //   143: aload 5
    //   145: ifnull +515 -> 660
    //   148: new 39	java/lang/String
    //   151: dup
    //   152: aload 5
    //   154: invokespecial 595	java/lang/String:<init>	([B)V
    //   157: astore 5
    //   159: getstatic 106	com/tencent/mobileqq/msf/core/auth/h:e	Loicq/wlogin_sdk/request/WtloginHelper;
    //   162: aload_1
    //   163: ldc2_w 11
    //   166: bipush 32
    //   168: invokevirtual 505	oicq/wlogin_sdk/request/WtloginHelper:GetLocalTicket	(Ljava/lang/String;JI)Loicq/wlogin_sdk/request/Ticket;
    //   171: astore 6
    //   173: aload 6
    //   175: ifnull +479 -> 654
    //   178: aload 6
    //   180: getfield 585	oicq/wlogin_sdk/request/Ticket:_sig	[B
    //   183: astore 6
    //   185: aload 6
    //   187: ifnull +467 -> 654
    //   190: aload 6
    //   192: invokestatic 591	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   195: astore 6
    //   197: getstatic 106	com/tencent/mobileqq/msf/core/auth/h:e	Loicq/wlogin_sdk/request/WtloginHelper;
    //   200: aload_1
    //   201: ldc2_w 11
    //   204: ldc 120
    //   206: invokevirtual 505	oicq/wlogin_sdk/request/WtloginHelper:GetLocalTicket	(Ljava/lang/String;JI)Loicq/wlogin_sdk/request/Ticket;
    //   209: astore 9
    //   211: aload 9
    //   213: ifnull +435 -> 648
    //   216: aload 9
    //   218: getfield 585	oicq/wlogin_sdk/request/Ticket:_sig	[B
    //   221: astore 7
    //   223: aload 7
    //   225: ifnull +417 -> 642
    //   228: new 39	java/lang/String
    //   231: dup
    //   232: aload 7
    //   234: invokespecial 595	java/lang/String:<init>	([B)V
    //   237: astore 7
    //   239: aload 9
    //   241: getfield 600	oicq/wlogin_sdk/request/Ticket:_pskey_map	Ljava/util/Map;
    //   244: ifnull +395 -> 639
    //   247: aload 9
    //   249: getfield 600	oicq/wlogin_sdk/request/Ticket:_pskey_map	Ljava/util/Map;
    //   252: ldc 41
    //   254: invokeinterface 605 2 0
    //   259: ifeq +380 -> 639
    //   262: new 39	java/lang/String
    //   265: dup
    //   266: aload 9
    //   268: getfield 600	oicq/wlogin_sdk/request/Ticket:_pskey_map	Ljava/util/Map;
    //   271: ldc 41
    //   273: invokeinterface 606 2 0
    //   278: checkcast 128	[B
    //   281: invokespecial 595	java/lang/String:<init>	([B)V
    //   284: astore 8
    //   286: aload 5
    //   288: astore 11
    //   290: aload_2
    ...
    //   307: aload 7
    //   309: astore_2
    //   310: new 153	java/util/HashMap
    //   313: dup
    //   314: invokespecial 607	java/util/HashMap:<init>	()V
    //   317: astore 6
    //   319: aload 6
    //   321: ldc_w 609
    //   324: aload_1
    //   325: invokevirtual 613	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   328: pop
    //   329: aload 6
    //   331: ldc_w 615
    //   334: aload 10
    //   336: invokevirtual 613	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   339: pop
    //   340: aload 6
    //   342: ldc_w 617
    //   345: aload 9
    //   347: invokevirtual 613	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   350: pop
    //   351: aload 6
    //   353: ldc_w 619
    //   356: aload 5
    //   358: invokevirtual 613	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   361: pop
    //   362: aload 6
    //   364: ldc_w 621
    //   367: aload 4
    //   369: invokevirtual 613	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   372: pop
    //   373: aload 6
    //   375: ldc_w 623
    //   378: aload 8
    //   380: invokevirtual 613	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   383: pop
    //   384: aload 6
    //   386: ldc_w 625
    //   389: aload_3
    //   390: invokevirtual 613	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   393: pop
    //   394: aload 6
    //   396: ldc_w 627
    //   399: aload_2
    //   400: invokevirtual 613	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   403: pop
    //   404: aload 6
    //   406: areturn
    //   407: astore 8
    ...
    //   424: astore_2
    //   425: aload 8
    //   427: invokevirtual 628	java/lang/Exception:printStackTrace	()V
    //   430: aload 11
    //   432: astore 8
    //   434: aload 6
    //   436: astore 9
  ...
  public int e(ToServiceMsg paramToServiceMsg)
  {
    ...
    WUserSigInfo localWUserSigInfo = i.b(paramToServiceMsg.getRequestSsoSeq());
    localWUserSigInfo._seqence = localk.f;
    int m = e.RegSubmitMobile(str2.getBytes(), str1.getBytes(), this.k.getBytes(), localByte1.byteValue(), localByte2.byteValue(), localByte3.byteValue(), 16L, l1, localWUserSigInfo);
  ...
  public int i(ToServiceMsg paramToServiceMsg)
  {
    ...
    WUserSigInfo localWUserSigInfo = i.b(paramToServiceMsg.getRequestSsoSeq());
    localWUserSigInfo._seqence = localk.f;
    m = e.RegGetAccount(str1.getBytes(), "qqpassport".getBytes(), str2.getBytes(), str3.getBytes(), this.k.getBytes(), m, localWUserSigInfo);
  ...
  public void w(ToServiceMsg paramToServiceMsg)
  {
    ...
    WUserSigInfo localWUserSigInfo = i.b(paramToServiceMsg.getRequestSsoSeq());
    localWUserSigInfo._seqence = localk.f;
    int m = e.RefreshSMSData(paramToServiceMsg.getUin(), 9L, localWUserSigInfo, null);
    Log.d("WTLoginCenter", "---------WTLoginCenter wt_RefreshSMSData :" + m);
    a(paramToServiceMsg, localk, m, "wt_RefreshSMSData");
  }
  ...
  public void y(ToServiceMsg paramToServiceMsg)
  {
    ...
    WUserSigInfo localWUserSigInfo = i.b(paramToServiceMsg.getRequestSsoSeq());
    localWUserSigInfo._seqence = localk.f;
    int m = e.CheckSMSAndGetSt(paramToServiceMsg.getUin(), (byte[])paramToServiceMsg.getAttribute("userInput"), localWUserSigInfo);
    Log.d("WTLoginCenter", "---------WTLoginCenter wt_CheckSMSAndGetStExt :" + m);
    a(paramToServiceMsg, localk, m, "wt_CheckSMSAndGetSt");
  }
  ...
  public void z(ToServiceMsg paramToServiceMsg)
  {
    ...
    WUserSigInfo localWUserSigInfo = i.b(paramToServiceMsg.getRequestSsoSeq());
    localWUserSigInfo._seqence = localk.f;
    a(paramToServiceMsg, localk, e.RegGetSMSVerifyLoginAccount((byte[])paramToServiceMsg.getAttribute("msgchk"), "qqpassport".getBytes(), (byte[])paramToServiceMsg.getAttribute("nick"), this.k.getBytes(), localWUserSigInfo), "wt_RegGetSMSVerifyLoginAccount");
  }
}
