...
public class StatisticCollector
{
  ...
  public static StatisticCollector a(Context arg0)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      if ((PrivacyPolicyHelper.a().equals("1")) && (((Context)localObject1).checkSelfPermission("android.permission.READ_PHONE_STATE") == 0))
      {
  ...
  public static StatisticCollector a(Context arg0, long paramLong)
  {
    Object localObject1 = BaseApplication.getContext();
    if (jdField_a_of_type_ComTencentMobileqqStatisticsStatisticCollector == null) {
      jdField_a_of_type_ComTencentMobileqqStatisticsStatisticCollector = new StatisticCollector((Context)localObject1);
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      {
        UserAction.setUserID("10000");
        UserAction.initUserAction(BaseApplication.getContext(), false, paramLong);
      }
      jdField_a_of_type_Boolean = true;
      return jdField_a_of_type_ComTencentMobileqqStatisticsStatisticCollector;
    }
  ...
  private String a(String paramString)
  {
    ...
    int i1 = 0;
    if (i1 < this.jdField_a_of_type_ArrayOfJwr.length)
    {
      String str = this.jdField_a_of_type_ArrayOfJwr[i1].a;
      if (!paramString.toLowerCase().contains(str)) {}
    }
    for (paramString = this.jdField_a_of_type_ArrayOfJwr[i1].b;; paramString = null)
    {
      return paramString;
      i1 += 1;
      break;
  ...
  private static String b()
  {
    ...
    try
    {
      ...
      float f1 = ((android.app.ActivityManager)BaseApplicationImpl.getContext().getSystemService("activity")).getProcessMemoryInfo(new int[] { Process.myPid() })[0].getTotalPss() / 1024.0F;
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      return;
      paramString1 = new jwq(System.currentTimeMillis(), paramString1, paramString2);
      ...
      for (this.c = (paramString1.a + i1); (this.c > 15360L) && (this.jdField_a_of_type_JavaUtilLinkedList.size() > 1); this.c -= paramString1.a) {
        paramString1 = (jwq)this.jdField_a_of_type_JavaUtilLinkedList.removeLast();
      }
    }
  }
  ...
  public void b(String paramString)
  {
    ...
    if (PrivacyPolicyHelper.a().equals("1")) {
      CrashReport.initCrashReport(BaseApplication.getContext(), new jwp(this), null, true, (CrashStrategyBean)localObject, 30000L);
    }
    ...
    try
    {
      ...
      CrashReport.initNativeCrashReport(BaseApplication.getContext(), (String)localObject, false, null, null, 0L);
