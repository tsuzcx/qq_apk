...
public class MainAcitivityReportHelper
{
  ...
  public long a;
  public Handler a;
  private Runnable jdField_a_of_type_JavaLangRunnable = new jwi(this);
  ...
  public MainAcitivityReportHelper(SplashActivity paramSplashActivity)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new jwh(this, Looper.getMainLooper());
  ...
  private Activity a()
  {
    ...
    if (localSplashActivity != null) {
      return localSplashActivity.getActivity();
    }
    return null;
  }
  ...
  {
    new jwl(paramContext, paramLong, paramString).execute(new Void[0]);
  }
  ...
  {
    return paramContext.getSharedPreferences("mobileQQ", 0).getInt("menu_quit_" + paramString, 0);
  }
  ...
  {
    new jwm(paramString).execute(new Void[0]);
  }
  ...
  public void a()
  {
    ...
    localSplashActivity.getSharedPreferences("mobileQQ", 0).edit().putInt("online_friend_enter_count_" + localQQAppInterface.a(), 0).commit();
    ...
    ((ChatBackgroundManager)localQQAppInterface.getManager(61)).b(a(), localQQAppInterface.a());
  }
  ...
  public void a(String paramString)
  {
    ...
    localObject = ((SplashActivity)localObject).getSharedPreferences("mobileQQ", 0).edit();
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    for (String str = paramQQAppInterface.a();; str = null)
    {
      ...
      ThreadManager.a().schedule(new jwk(this, paramQQAppInterface), 60000L);
  ...
  public void b(String paramString)
  {
    ...
    do
    {
      ...
      localObject = ((SplashActivity)localObject).getSharedPreferences("mobileQQ", 0);
      if (QLog.isColorLevel()) {
