...
public class OnlineFileSessionCenter
{
  ...
  private FMObserver jdField_a_of_type_ComTencentMobileqqFilemanagerAppFMObserver = new isk(this);
  private iso jdField_a_of_type_Iso = null;
  ...
  public OnlineFileSessionCenter(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new isj(this);
    try
    {
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    do
    {
      ...
      a(paramString, paramLong, new isn(this, 10));
      return;
  ...
  public void a(String paramString, long paramLong, int paramInt)
  {
    ...
    do
    {
      ...
      a(paramString, paramLong, new isn(this, paramInt));
      return;
  ...
  public void a(String paramString1, long paramLong, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      localObject = new isn(this, 12);
      ((isn)localObject).jdField_b_of_type_Int = paramInt;
      ((isn)localObject).jdField_a_of_type_JavaLangString = paramString2;
      a(paramString1, paramLong, (isn)localObject);
      return;
  ...
  public void a(String paramString1, long paramLong1, int paramInt, String paramString2, long paramLong2)
  {
    ...
    do
    {
      ...
      localObject = new isn(this, 11);
      ((isn)localObject).jdField_b_of_type_Int = paramInt;
      ((isn)localObject).jdField_a_of_type_JavaLangString = paramString2;
      ((isn)localObject).jdField_b_of_type_Long = paramLong2;
      a(paramString1, paramLong1, (isn)localObject);
      return;
  ...
  void a(String paramString, long paramLong, isn paramisn)
  {
    if ((paramString == null) || (paramLong <= 0L) || (paramisn == null)) {
      return;
    }
    QLog.i("OnlineFileSessionCenter<FileAssistant>", 1, "OLfilesession[" + paramLong + "]  cacheHandleBeforeRequest handleType:" + paramisn.jdField_a_of_type_Int + " info_1:" + paramisn.jdField_b_of_type_Int + " info_2:" + paramisn.jdField_a_of_type_JavaLangString + " info_3:" + paramisn.jdField_b_of_type_Long);
    LinkedHashMap localLinkedHashMap = (LinkedHashMap)this.b.get(paramString);
    if (localLinkedHashMap == null)
    {
      localLinkedHashMap = new LinkedHashMap();
      localLinkedHashMap.put(Long.valueOf(paramLong), paramisn);
  ...
  boolean a(String paramString, long paramLong)
  {
    ...
    if (localLinkedHashMap != null)
    {
      localObject = (isn)localLinkedHashMap.get(Long.valueOf(paramLong));
      if (localObject != null)
      {
        QLog.i("OnlineFileSessionCenter<FileAssistant>", 1, "OLfilesession[" + paramLong + "]  isBeHandledBeforeRequest handleType:" + ((isn)localObject).jdField_a_of_type_Int + " info_1:" + ((isn)localObject).jdField_b_of_type_Int + " info_2:" + ((isn)localObject).jdField_a_of_type_JavaLangString + " info_3:" + ((isn)localObject).jdField_b_of_type_Long);
        switch (((isn)localObject).jdField_a_of_type_Int)
        {
        case 6: 
        case 7: 
        case 8: 
      ...
      for (;;)
      {
        ...
        if ((localLinkedHashMap != null) && (localLinkedHashMap.size() > 0))
        {
          ...
          for (;;)
          {
            ...
            isn localisn = (isn)localEntry.getValue();
            long l = ((Long)localEntry.getKey()).longValue();
            if (localisn != null)
            {
              if (paramLong - localisn.jdField_a_of_type_Long < 7200L) {
                continue;
              }
              QLog.i("OnlineFileSessionCenter<FileAssistant>", 1, "OLfilesession[" + l + "]  isBeHandledBeforeRequest and clear it.handleType:" + localisn.jdField_a_of_type_Int + " info_1:" + localisn.jdField_b_of_type_Int + " info_2:" + localisn.jdField_a_of_type_JavaLangString + " info_3:" + localisn.jdField_b_of_type_Long);
              ((Iterator)localObject).remove();
              continue;
              a(paramString, paramLong, ((isn)localObject).jdField_a_of_type_Int);
              bool1 = true;
              break;
              a(paramString, paramLong);
              bool1 = true;
              break;
              a(paramString, paramLong, ((isn)localObject).jdField_b_of_type_Int, ((isn)localObject).jdField_a_of_type_JavaLangString, ((isn)localObject).jdField_b_of_type_Long);
              bool1 = true;
              break;
              a(paramString, paramLong, ((isn)localObject).jdField_b_of_type_Int, ((isn)localObject).jdField_a_of_type_JavaLangString);
              bool1 = true;
              break;
            }
            ((Iterator)localObject).remove();
  ...
  void b()
  {
    if (this.jdField_a_of_type_AndroidOsHandler == null) {
      this.jdField_a_of_type_AndroidOsHandler = new ism(this, Looper.getMainLooper());
    }
    if (this.jdField_a_of_type_Iso == null)
    {
      this.jdField_a_of_type_Iso = new iso(this, null);
      this.jdField_a_of_type_Iso.a();
  ...
  public void b(int paramInt)
  {
    ...
    {
      new Handler(localLooper).post(new isl(this, paramInt));
      return;
    }
    a(paramInt);
  }
