...
public class QQShortCutUtils
{
  ...
  {
    if (PrivacyPolicyHelper.a().equals("0"))
    {
      jdField_c_of_type_JavaLangString = "empty";
  ...
  private static ArrayList a(Context paramContext, String paramString, String[] paramArrayOfString)
  {
    ...
    //   3: dup
    //   4: invokespecial 194	java/util/ArrayList:<init>	()V
    //   7: astore_3
    //   8: aload_0
    //   9: invokestatic 196	com/tencent/mobileqq/utils/QQShortCutUtils:a	(Landroid/content/Context;)Ljava/lang/String;
    //   12: astore 4
    //   14: ldc 10
    //   16: aload 4
    //   18: invokevirtual 119	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   21: ifeq +5 -> 26
    //   24: aload_3
    //   25: areturn
    //   26: aload_0
    //   27: invokevirtual 200	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   30: aload 4
    //   32: invokestatic 206	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   35: bipush 9
    ...
    //   89: aload_2
    //   90: aconst_null
    //   91: invokevirtual 230	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   94: astore_1
    //   95: aload_1
    //   96: ifnull +262 -> 358
    //   99: aload_1
    //   100: astore_0
    //   101: aload_1
    //   102: invokeinterface 235 1 0
    //   107: ifeq +251 -> 358
    //   110: aload_1
    //   111: astore_0
    //   112: new 237	ktt
    //   115: dup
    //   116: invokespecial 238	ktt:<init>	()V
    //   119: astore_2
    //   120: aload_1
    //   121: astore_0
    //   122: aload_2
    //   123: aload_1
    //   124: iconst_0
    //   125: invokeinterface 242 2 0
    //   130: putfield 244	ktt:jdField_a_of_type_Int	I
    //   133: aload_1
    //   134: astore_0
    //   135: aload_2
    //   136: aload_1
    ...
    //   143: putfield 250	ktt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   146: aload_1
    //   147: astore_0
    //   148: aload_2
    //   149: aload_1
    //   150: iconst_2
    //   151: invokeinterface 242 2 0
    //   156: putfield 252	ktt:b	I
    //   159: aload_1
    //   160: astore_0
    //   161: aload_2
    //   162: aload_1
    //   163: iconst_3
    //   164: invokeinterface 242 2 0
    //   169: putfield 254	ktt:d	I
    //   172: aload_1
    //   173: astore_0
    //   174: aload_2
    //   175: aload_1
    //   176: iconst_4
    //   177: invokeinterface 242 2 0
    //   182: putfield 256	ktt:e	I
    //   185: aload_1
    //   186: astore_0
    //   187: aload_2
    //   188: aload_1
    //   189: iconst_5
    //   190: invokeinterface 242 2 0
    //   195: putfield 258	ktt:f	I
    //   198: aload_1
    //   199: astore_0
    //   200: aload_2
    //   201: aload_1
    //   202: bipush 6
    //   204: invokeinterface 242 2 0
    //   209: putfield 260	ktt:g	I
    //   212: aload_1
    //   213: astore_0
    //   214: aload_2
    //   215: aload_1
    //   216: bipush 7
    //   218: invokeinterface 242 2 0
    //   223: putfield 262	ktt:c	I
    //   226: aload_1
    //   227: astore_0
    //   228: aload_1
    //   229: bipush 8
    //   231: invokeinterface 248 2 0
    //   236: astore 4
    //   238: aload_1
    //   239: astore_0
    //   240: aload 4
    //   242: invokestatic 268	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   245: ifne +86 -> 331
    //   248: aload_1
    //   249: astore_0
    //   250: aload 4
    //   252: ldc_w 270
    //   255: invokevirtual 273	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   258: ifeq +73 -> 331
    //   261: aload_1
    //   262: astore_0
    //   263: aload_2
    //   264: iconst_0
    //   265: putfield 274	ktt:h	I
    //   268: aload_1
    //   269: astore_0
    //   270: aload_3
    //   271: aload_2
    //   272: invokevirtual 277	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   275: pop
    //   276: goto -177 -> 99
    //   279: astore_2
    //   280: aload_1
    ...
    //   306: aload_2
    //   307: invokevirtual 280	java/lang/Exception:toString	()Ljava/lang/String;
    //   310: invokevirtual 131	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   313: invokevirtual 136	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   316: invokestatic 147	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   319: aload_1
    //   320: ifnull +9 -> 329
    //   323: aload_1
    //   324: invokeinterface 283 1 0
    //   329: aload_3
    //   330: areturn
    //   331: aload_1
    //   332: astore_0
    ...
    //   347: ifnull +9 -> 356
    //   350: aload_1
    //   351: invokeinterface 283 1 0
    //   356: aload_0
    //   357: athrow
    //   358: aload_1
    //   359: ifnull -30 -> 329
    //   362: aload_1
    //   363: invokeinterface 283 1 0
    //   368: goto -39 -> 329
    //   371: astore_0
    //   372: aconst_null
    //   373: astore_1
  ...
  public static ArrayList a(Context paramContext, List paramList, String paramString)
  {
    ...
    {
      localObject2 = (ktt)paramList.get(i3);
      if ((localObject2 == null) || (TextUtils.isEmpty(((ktt)localObject2).jdField_a_of_type_JavaLangString))) {
        break label2171;
      }
      if ((((ktt)localObject2).c >= 0) && (((ktt)localObject2).c <= n))
      {
        i4 = ((ktt)localObject2).c;
        arrayOfInt[i4] += 1;
      }
      if ((paramContext != null) || (!((ktt)localObject2).jdField_a_of_type_JavaLangString.equals(paramString)) || (((ktt)localObject2).h != 0)) {
        break label2168;
      }
    ...
    for (;;)
    {
      ...
      int i5;
      if (i4 < b.length) {
        if ((((ktt)localObject2).jdField_a_of_type_JavaLangString.equals(b[i4])) && ((((ktt)localObject2).d != k) || (((ktt)localObject2).e != m)))
        {
          i2 = 4;
          i5 = i3;
        }
      ...
      for (Object localObject3 = localObject2;; localObject3 = localObject1)
      {
        ...
        for (;;)
        {
          ...
          {
            if ((((ktt)localObject2).jdField_a_of_type_JavaLangString.equals(jdField_c_of_type_ArrayOfJavaLangString[i6])) && ((((ktt)localObject2).d != k) || (((ktt)localObject2).e != m)))
            {
              i1 = 3;
              i4 = i3;
        ...
        for (;;)
        {
          ...
          if (i6 < d.length)
          {
            if ((((ktt)localObject2).jdField_a_of_type_JavaLangString.equals(d[i6])) && ((((ktt)localObject2).d != k) || (((ktt)localObject2).e != m)))
            {
              i2 = 2;
              i5 = i3;
        ...
        for (;;)
        {
          ...
          if ((((ktt)localObject2).jdField_a_of_type_JavaLangString.equals(e[i1])) && ((((ktt)localObject2).d != k) || (((ktt)localObject2).e != m)))
          {
            i2 = 1;
            localObject1 = localObject2;
            i1 = i3;
        ...
        if (localObject1 != null)
        {
          ...
          a((ktt)localObject1, paramContext);
          if (QLog.isColorLevel()) {
          ...
          {
            localObject1 = (ktt)paramList.get(i2);
            if ((paramContext.jdField_a_of_type_Int == ((ktt)localObject1).jdField_a_of_type_Int) && (((ktt)localObject1).jdField_a_of_type_JavaLangString != null) && (paramContext.jdField_a_of_type_JavaLangString.equals(((ktt)localObject1).jdField_a_of_type_JavaLangString)))
            {
              if (QLog.isColorLevel()) {
            ...
            if ((localObject1 == null) || (((ktt)localObject1).c != paramContext.c) || (((ktt)localObject1).d != paramContext.d) || (((ktt)localObject1).e != paramContext.e)) {
              break label2149;
            }
            paramString = (String)localObject1;
            if (QLog.isColorLevel()) {
              QLog.d("Q.shortcut", 2, "getMoveShortCut.toReplaceShortcuts.screen=" + ((ktt)localObject1).c + ",y=" + ((ktt)localObject1).e + ",x=" + ((ktt)localObject1).d);
            }
          }
        }
        label960:
        ...
        for (paramString = (String)localObject1;; paramString = null)
        {
          ...
          if ((i4 < paramList.size()) && (paramString != null))
          {
            ...
            i2 = paramList.size();
            localObject1 = (ktt)paramList.get(i2 - 1);
            if ((localObject1 == null) || (paramContext == null) || (((ktt)localObject1).jdField_a_of_type_Int != paramContext.jdField_a_of_type_Int)) {
              break label2143;
            }
            i2 -= 1;
            localObject2 = paramList.subList(i4, i2);
            paramList = (ktt)((List)localObject2).get(0);
            localObject1 = (ktt)((List)localObject2).get(((List)localObject2).size() - 1);
            i2 = ((ktt)localObject1).c;
            i3 = paramList.c;
            i4 = h;
            i5 = ((ktt)localObject1).e;
            i6 = paramList.e;
            int i7 = i;
            int i8 = ((ktt)localObject1).d;
            int i9 = paramList.d;
            int i10 = ((ktt)localObject1).f;
            i4 = (i2 - i3) * i4 + (i5 - i6) * i7 + (i8 - i9) + ((ktt)localObject1).g * i10;
            localObject1 = new ktt[i4];
            localObject2 = ((List)localObject2).iterator();
            if (((Iterator)localObject2).hasNext())
            {
              localObject3 = (ktt)((Iterator)localObject2).next();
              i5 = ((ktt)localObject3).c;
              i6 = paramList.c;
              i7 = h;
              i8 = ((ktt)localObject3).e;
              i9 = paramList.e;
              i10 = i;
              int i11 = ((ktt)localObject3).d;
              int i12 = paramList.d;
              i2 = 1;
              if (i2 <= ((ktt)localObject3).f)
              {
                i3 = 1;
                for (;;)
                {
                  if (i3 <= ((ktt)localObject3).g)
                  {
                    ...
                    paramString = (ktt)paramList.get(i2);
          ...
          for (;;)
          {
            ...
            paramContext.c = i3;
            paramContext.d = j;
            paramContext.e = ((ktt)localObject1).e;
            i4 = i2;
            paramString = localObject4;
            if (((ktt)localObject1).d != j) {
              break label880;
            }
            if (QLog.isColorLevel()) {
              QLog.d("Q.shortcut", 2, "getMoveShortCut.toReplaceShortcuts.screen=" + ((ktt)localObject1).c + ",y=" + ((ktt)localObject1).e + ",x=" + ((ktt)localObject1).d);
  ...
  public static void a(Context paramContext)
  {
    ...
    do
    {
      do
      {
        ...
        return;
        str = paramContext.getString(2131365725);
      ...
      while (localIterator.hasNext()) {
        if (((ktt)localIterator.next()).b != -100) {
      ...
      while (localIterator.hasNext())
      {
        ktt localktt = (ktt)localIterator.next();
        if (localktt.b == -100)
        {
          j = Math.min(j, localktt.d);
          k = Math.max(k, localktt.d);
          l = Math.min(l, localktt.e);
          m = Math.max(m, localktt.e);
          n = Math.max(n, localktt.c);
        }
      }
      i = k - j + 1;
      h = i * (m - l + 1);
      ...
      Collections.sort(localArrayList, new kts());
    } while (!a(paramContext, a(paramContext, localArrayList, str)));
    a(paramContext);
  }
  
  private static void a(ktt paramktt1, ktt paramktt2)
  {
    if ((paramktt1 != null) && (paramktt2 != null))
    {
      if ((paramktt1.d == k) && (paramktt1.e == m))
      {
        paramktt2.d = j;
        paramktt2.e = l;
        paramktt1.c += 1;
    ...
    if (paramktt1.d == k)
    {
      paramktt2.d = j;
      paramktt1.e += 1;
      paramktt2.c = paramktt1.c;
      return;
    }
    paramktt1.d += 1;
    paramktt2.e = paramktt1.e;
    paramktt2.c = paramktt1.c;
  }
  ...
  private static boolean a(Context paramContext, List paramList)
  {
    ...
    {
      ktt localktt = (ktt)paramList.next();
      ContentValues localContentValues = new ContentValues();
      localContentValues.put("cellX", Integer.valueOf(localktt.d));
      localContentValues.put("cellY", Integer.valueOf(localktt.e));
      localContentValues.put("spanX", Integer.valueOf(localktt.f));
      localContentValues.put("spanY", Integer.valueOf(localktt.g));
      localContentValues.put("screen", Integer.valueOf(localktt.c));
      localArrayList.add(ContentProviderOperation.newUpdate(Uri.parse(a(paramContext))).withSelection("_id=?", new String[] { localktt.jdField_a_of_type_Int + "" }).withValues(localContentValues).build());
    }
    try
    {
