  ...
  implements View.OnClickListener
{
  ...
  {
    ksv localksv = new ksv(this);
    if (this.jdField_a_of_type_Int == 7)
    {
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel = new SystemAndEmojiEmoticonPanel(paramContext, localksv);
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel = new SystemEmoticonPanel(paramContext, localksv);
  }
    ...
    if (paramView.getId() == 2131297032)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel != null)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel.getVisibility() == 0)
        {
          ...
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ksw(this), 200L);
        }
      }
      else {
        return;
      ...
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ksx(this), 200L);
      return;
    }
  ...
  public void setContentView(int paramInt)
  {
    ...
    Object localObject1 = (RelativeLayout)findViewById(2131297366);
    paramInt = 0;
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131297032));
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new ksu(this));
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel.setBackgroundResource(2130837553);
      localObject1 = new RelativeLayout.LayoutParams(-1, (int)(((Context)localObject1).getResources().getDisplayMetrics().density * 150.0F));
      ((FrameLayout)findViewById(2131297385)).addView(this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel, (ViewGroup.LayoutParams)localObject1);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel.setVisibility(8);
      return;
    }
