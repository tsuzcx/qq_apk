  ...
  extends Dialog
{
  ...
  {
    paramContext = new QQCustomDialogDevLock(paramContext, 2131558902);
    paramContext.setContentView(2130904078);
  ...
  public QQCustomDialogDevLock a(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.d.setOnClickListener(new ksj(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomDialogDevLock b(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.e.setOnClickListener(new ksk(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131298055));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131300769));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131297264));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131300771));
    this.c = ((TextView)findViewById(2131297269));
    this.d = ((TextView)findViewById(2131297370));
    this.e = ((TextView)findViewById(2131297371));
  }
}
