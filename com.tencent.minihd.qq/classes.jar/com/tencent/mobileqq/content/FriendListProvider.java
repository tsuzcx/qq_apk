  ...
  implements FriendList
{
  ...
  {
    super.onCreate();
    this.a.addURI("qq.friendlist.2", "group/#", 1000);
    this.a.addURI("qq.friendlist.2", "friendlist/#", 1001);
    this.a.addURI("qq.friendlist.2", "trooplist/#", 1002);
    this.a.addURI("qq.friendlist.2", "troopmemberinfo/#/#/#", 1003);
    this.a.addURI("qq.friendlist.2", "troopname/#", 1004);
    this.a.addURI("qq.friendlist.2", "discussinfo/#/#", 1005);
    this.a.addURI("qq.friendlist.2", "discussmenberinfo/#/#/#", 1006);
    return true;
  }
