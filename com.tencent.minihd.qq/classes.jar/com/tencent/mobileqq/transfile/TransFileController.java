  ...
  implements INetEngine.INetEngineListener
{
  ...
  public TransFileController(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Kbd = new kbd(ThreadManager.b());
  }
  ...
  private boolean a(String paramString1, int paramInt1, String paramString2, String paramString3, long paramLong, int paramInt2, boolean paramBoolean)
  {
    ...
    if (((paramString1 instanceof LbsTransfileProcessor)) && (paramString1 != null)) {
      ((LbsTransfileProcessor)paramString1).g();
    }
    return false;
  }
  ...
  BaseTransProcessor a(TransferRequest paramTransferRequest)
  {
    ...
    else
    {
      if (paramTransferRequest.jdField_a_of_type_Boolean)
      {
        ...
        if ((paramTransferRequest.jdField_b_of_type_Int == 8) || (paramTransferRequest.jdField_b_of_type_Int == 21)) {
  ...
  public BaseTransProcessor a(String paramString, long paramLong)
  {
    ...
    if ((paramString != null) && ((paramString instanceof BaseTransProcessor)))
    {
      ...
      if ((paramString.f) && (paramString.e)) {
        return paramString;
      }
    }
    return null;
  ...
  public void a(StreamInfo paramStreamInfo, StreamData paramStreamData, long paramLong1, long paramLong2)
  {
    ...
    if (str2 == null)
    {
      ...
      StreamDataManager.a(str1, paramStreamInfo.msgSeq);
      StreamDataManager.b(str1, paramStreamInfo.random);
    }
        ...
        if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
        {
          if (!this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(str))
          {
            ...
            if ((paramTransferRequest != null) && (paramTransferRequest.e() == 0))
            {
              ...
              if (this.jdField_a_of_type_Kbd != null) {
                this.jdField_a_of_type_Kbd.a(paramTransferRequest);
              }
            }
            return;
          }
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (a((IHttpCommunicatorListener)localObject))
        {
          ...
          if ((paramString.equals(((BaseTransProcessor)localObject).a.jdField_b_of_type_JavaLangString)) && (!((BaseTransProcessor)localObject).e))
          {
  ...
  public boolean a()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      localObject = (BaseTransProcessor)localObject;
      if ((!((BaseTransProcessor)localObject).g) || (((BaseTransProcessor)localObject).e)) {
        break label171;
      }
      ((BaseTransProcessor)localObject).i();
  ...
  public boolean a(long paramLong)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if ((((BaseUploadProcessor)localObject).a == null) || (!((BaseUploadProcessor)localObject).a.jdField_h_of_type_Boolean)) {
        break label175;
      }
      ((BaseUploadProcessor)localObject).j = paramLong;
      if (QLog.isColorLevel()) {
  ...
  public boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, byte paramByte, int paramInt)
  {
    paramString1 = new CompressInfo(paramString2, 0);
    paramString1.f = 0;
    CompressOperator.a(paramString1);
    if (QLog.isColorLevel()) {
      QLog.d("Q.nearby_people_card.upload_local_photo", 2, ".uploadPhoto(), img_path = " + paramString1.e);
    }
    if (!StringUtil.b(paramString1.e))
    {
      paramString2 = new TransferRequest();
      paramString2.jdField_a_of_type_Boolean = true;
      paramString2.jdField_h_of_type_JavaLangString = paramString1.e;
      paramString2.jdField_b_of_type_Int = 21;
      paramString2.jdField_a_of_type_ComTencentMobileqqPicUpCallBack = new kbc(this, paramQQAppInterface);
  ...
  public boolean b()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      localObject = (BaseTransProcessor)localObject;
      if ((!((BaseTransProcessor)localObject).jdField_h_of_type_Boolean) || (((BaseTransProcessor)localObject).e)) {
        break label171;
      }
      ((BaseTransProcessor)localObject).i();
      if (((BaseTransProcessor)localObject).a() != null) {
  ...
  public boolean b(String paramString, long paramLong)
  {
    ...
    //   45: ifnull +7 -> 52
    //   48: aload_1
    //   49: invokevirtual 752	com/tencent/mobileqq/transfile/ShortVideoDownloadProcessor:i	()V
    //   52: iconst_1
    //   53: istore 4
    //   55: aload_0
    //   56: monitorexit
  ...
  public boolean b(String paramString1, String paramString2)
  {
    ...
    {
      localObject = (BaseTransProcessor)localObject;
      if (((BaseTransProcessor)localObject).f)
      {
        ((BaseTransProcessor)localObject).i();
        if (QLog.isColorLevel()) {
  ...
  public boolean c()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      localObject = (BaseTransProcessor)localObject;
      if ((!((BaseTransProcessor)localObject).f) || (((BaseTransProcessor)localObject).e)) {
        break label178;
      }
      ((BaseTransProcessor)localObject).i();
      if (((BaseTransProcessor)localObject).a() != null) {
  ...
  public boolean c(String paramString, long paramLong)
  {
    ...
    //   45: ifnull +7 -> 52
    //   48: aload_1
    //   49: invokevirtual 770	com/tencent/mobileqq/transfile/ShortVideoUploadProcessor:i	()V
    //   52: iconst_1
    //   53: istore 4
    //   55: aload_0
    //   56: monitorexit
