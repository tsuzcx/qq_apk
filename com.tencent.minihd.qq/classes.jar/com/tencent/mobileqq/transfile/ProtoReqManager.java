...
public class ProtoReqManager
{
  ...
  private void a(Intent paramIntent, ProtoReqManager.ProtoResp paramProtoResp)
  {
    ...
    paramProtoResp.jdField_a_of_type_ArrayOfKat[i].jdField_b_of_type_Boolean = true;
    paramProtoResp.jdField_a_of_type_ArrayOfKat[i].jdField_c_of_type_Long = System.currentTimeMillis();
  }
  ...
  private void a(ProtoReqManager.ProtoResp paramProtoResp)
  {
    ...
    int i = 0;
    while (i < paramProtoResp.jdField_a_of_type_ArrayOfKat.length)
    {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramProtoResp.jdField_a_of_type_ArrayOfKat[i].jdField_a_of_type_MqqAppNewIntent);
      this.jdField_a_of_type_AndroidOsHandler.removeCallbacks(paramProtoResp.jdField_a_of_type_ArrayOfKat[i]);
      i += 1;
    }
  }
  ...
  private boolean a(ProtoReqManager.ProtoResp paramProtoResp)
  {
    ...
    while (i < paramProtoResp.jdField_a_of_type_ArrayOfKat.length)
    {
      if ((!paramProtoResp.jdField_a_of_type_ArrayOfKat[i].jdField_b_of_type_Boolean) && ((paramProtoResp.jdField_a_of_type_ArrayOfKat[i].jdField_a_of_type_Boolean == true) || (paramProtoResp.jdField_a_of_type_ArrayOfKat[i].jdField_c_of_type_Boolean == true))) {
        return false;
      }
      i += 1;
    }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    for (;;)
    {
      ...
      if ((l1 < localProtoReq.e) && (localProtoResp.jdField_a_of_type_Int < localProtoReq.jdField_b_of_type_Int))
      {
        ...
        paramIntent = localProtoResp.jdField_a_of_type_ArrayOfKat[localProtoResp.jdField_a_of_type_Int];
  ...
  public void a(ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    try
    {
      ...
      if (paramProtoReq != null)
      {
        ...
        localProtoResp.jdField_a_of_type_ArrayOfKat = new kat[paramProtoReq.jdField_b_of_type_Int];
        ...
        for (;;)
        {
          ...
          localObject = new kat(this);
          localProtoResp.jdField_a_of_type_ArrayOfKat[i] = localObject;
          ((kat)localObject).jdField_a_of_type_ComTencentMobileqqTransfileProtoReqManager$ProtoResp = localProtoResp;
          ((kat)localObject).jdField_a_of_type_MqqAppNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), ProtoServlet.class);
          localObject = ((kat)localObject).jdField_a_of_type_MqqAppNewIntent;
        ...
        while (j < paramProtoReq.c)
        {
          ...
          localProtoResp.jdField_a_of_type_ArrayOfKat[j].jdField_a_of_type_Long = (l2 - l1 - l3);
          a(localProtoResp.jdField_a_of_type_ArrayOfKat[j], l1);
          j += 1;
        }
  ...
  void a(kat paramkat, long paramLong)
  {
    paramkat.jdField_c_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(paramkat, paramLong);
  }
