...
public class UnaffectedFrameLayout
  extends FrameLayout
{
  int a;
  int b;
  ...
  public UnaffectedFrameLayout(Context paramContext)
  {
    super(paramContext);
    b();
  }
  
  public UnaffectedFrameLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
 ...
 * Qualified Name:     com.tencent.mobileqq.widget.UnaffectedFrameLayout
