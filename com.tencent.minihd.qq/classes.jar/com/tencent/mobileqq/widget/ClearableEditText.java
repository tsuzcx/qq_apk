  ...
  extends EditText
{
  ...
  private void a(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) {
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130838211);
    }
    if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
    {
    ...
    setOnTouchListener(new kxd(this));
    addTextChangedListener(new kxe(this));
