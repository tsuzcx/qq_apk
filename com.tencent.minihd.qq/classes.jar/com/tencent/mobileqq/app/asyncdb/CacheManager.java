  ...
  implements Manager
{
  ...
  private BaseCache[] jdField_a_of_type_ArrayOfComTencentMobileqqAppAsyncdbBaseCache = new BaseCache[3];
  ...
  public BaseCache a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      RoamDateCache localRoamDateCache = new RoamDateCache(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppAsyncdbDBDelayManager);
      continue;
      return localRoamDateCache;
    }
  }
