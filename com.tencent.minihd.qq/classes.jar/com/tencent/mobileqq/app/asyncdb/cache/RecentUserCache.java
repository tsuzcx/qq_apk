  ...
  extends FullCache
{
  ...
  Comparator jdField_b_of_type_JavaUtilComparator = new hqs(this);
  ...
  private void a(List paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localRecentUser != null) {
        if ((localObject1 == null) && (AppConstants.ae.equals(localRecentUser.uin)))
        {
          localObject1 = localRecentUser;
        }
        else if ((localObject2 == null) && ((AppConstants.ab.equals(localRecentUser.uin)) || (4000 == localRecentUser.type)))
        {
    ...
    if (localObject2 != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new hqr(this, l));
    }
  }
  ...
  private void e()
  {
    ...
    return;
    label71:
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new hqt(this, localSharedPreferences));
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localIterator.hasNext())
        {
          RecentUser localRecentUser = (RecentUser)localIterator.next();
          localRecentUser.parse();
          if (localRecentUser.uin.equals(AppConstants.aw)) {
            j = i;
          }
        }
        else
  ...
  {
    paramString = (ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    return (paramString != null) && (!paramString.isEmpty()) && ((!paramString.containsKey(String.valueOf(7000))) || (paramString.keySet().size() > 1));
  }
