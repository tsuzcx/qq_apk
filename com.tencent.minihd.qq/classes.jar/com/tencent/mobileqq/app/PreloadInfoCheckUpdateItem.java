  ...
  implements CheckUpdateItemInterface
{
  ...
  public ReqItem a()
  {
    ...
    ((PreloadInfoCheckUpdate.ControlReqHead)localObject2).client_ver.set("5.9.3");
    ...
    localObject2 = BaseApplicationImpl.a().getSharedPreferences("web_process_preload_file", 4);
          ...
          if (paramRespItem.length > 4)
          {
            ...
            if (paramRespItem != null)
            {
              ...
              if (localObject1 != null)
              {
                ...
                localObject1 = BaseApplicationImpl.a().getSharedPreferences("web_process_preload_file", 4).edit();
