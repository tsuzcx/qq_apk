  ...
  extends AsyncStep
{
  ...
  private void c()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new hsd(this, null);
  ...
  protected int a()
  {
    if (this.h == 4)
    {
      ...
      localObject = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppAutomatorAutomator.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(50);
