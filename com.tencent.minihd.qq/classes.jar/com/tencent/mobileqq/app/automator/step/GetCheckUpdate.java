  ...
  extends AsyncStep
{
  ...
  public void a()
  {
    ...
    for (Object localObject = new ReqDpcInfoNewItem(localQQAppInterface, false);; localObject = new ReqDpcInfoNewItem(localQQAppInterface, true))
    {
      ...
      if (((ProfileCardCheckUpdate)localObject).a()) {
        this.jdField_a_of_type_ComTencentMobileqqAppAutomatorAutomator.a(122, (CheckUpdateItemInterface)localObject);
      }
      ...
      localObject = new WebViewCheckUpdataItem(localQQAppInterface);
      ((WebViewCheckUpdataItem)localObject).a(localQQAppInterface.a());
      if (((WebViewCheckUpdataItem)localObject).a()) {
        this.jdField_a_of_type_ComTencentMobileqqAppAutomatorAutomator.a(126, (CheckUpdateItemInterface)localObject);
      }
      if (this.jdField_a_of_type_Hre == null)
      {
        this.jdField_a_of_type_Hre = new hre(this, null);
        localQQAppInterface.a(this.jdField_a_of_type_Hre);
      }
      return;
    }
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Hre != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppAutomatorAutomator.a.c(this.jdField_a_of_type_Hre);
      this.jdField_a_of_type_Hre = null;
    }
  }
}
