  ...
  implements Runnable
{
  ...
  private boolean b()
  {
    return (this.jdField_a_of_type_ComTencentMobileqqAppAutomatorAutomator.a.f) || (NetConnInfoCenter.socketConnState == 4) || (NetConnInfoCenter.socketConnState == 2) || (NetworkUtil.e(BaseApplicationImpl.a));
  }
