...
public class ScreenShot
{
  ...
  public ScreenShot(Context paramContext, Window paramWindow)
  {
    ...
    for (this.jdField_a_of_type_AndroidViewWindow = paramWindow.getWindow();; this.jdField_a_of_type_AndroidViewWindow = paramWindow)
    {
      ...
      this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2130904389, null));
      this.jdField_a_of_type_Hph = new hph(this, this.jdField_a_of_type_AndroidContentContext);
      this.jdField_a_of_type_AndroidViewViewGroup.addView(this.jdField_a_of_type_Hph, 0);
      ...
      this.jdField_c_of_type_AndroidWidgetButton.setOnClickListener(new hpd(this));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new hpe(this));
      this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(new hpf(this));
      return;
    }
  }
  ...
  private void b()
  {
    ...
    if (!a())
    {
      ...
      this.d.setOnClickListener(new hpg(this));
    }
    try
    {
  ...
  private boolean c()
  {
    return (!Build.MODEL.contains("Galaxy Nexus")) && (!Build.MODEL.contains("HTC S720")) && (!Build.MODEL.contains("SM-N9006")) && ((!Build.MODEL.contains("ZTE U930")) || (Build.VERSION.SDK_INT != 16)) && ((!Build.MODEL.contains("HTC One X")) || (Build.VERSION.SDK_INT != 16)) && ((!Build.MODEL.contains("GT-I9260")) || (Build.VERSION.SDK_INT != 16)) && (!Build.MODEL.contains("vivo Y18L")) && (!d());
  }
  ...
  public boolean b()
  {
    this.jdField_a_of_type_Hph.k = 0;
    this.jdField_a_of_type_Hph.a.setEmpty();
    this.jdField_b_of_type_AndroidGraphicsBitmap = null;
    a(false);
    if (c()) {}
    try
