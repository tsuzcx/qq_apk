  ...
  implements ProcessorDispatcherInterface, ProcessorObserver
{
  ...
  private static String t = MessageHandler.class.getSimpleName();
  ...
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new hln(this);
  private EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = null;
  public MessageCache a;
  hlv jdField_a_of_type_Hlv;
  ...
  private hls[] jdField_a_of_type_ArrayOfHls = null;
  ...
  MessageHandler(QQAppInterface paramQQAppInterface)
  {
    ...
    AppSetting.k = paramQQAppInterface.getBoolean(AppSetting.p, true);
  ...
  private hlv a()
  {
    if (this.jdField_a_of_type_Hlv == null) {
      this.jdField_a_of_type_Hlv = new hlv(this, ThreadManager.b());
    }
    return this.jdField_a_of_type_Hlv;
  }
  ...
  {
    g();
    paramToServiceMsg = new hlt(paramInt, paramToServiceMsg, ???, paramObject);
    if (paramInt == 1) {
  ...
  private void a(MessageRecord paramMessageRecord, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    if (!MsgProxyUtils.f(paramMessageRecord.msgtype)) {
      i1 = 0;
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq, long paramLong, int paramInt, BusinessObserver paramBusinessObserver, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramPbSendMsgReq)
      {
        break label437;
      }
    }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, AdMsgInfo paramAdMsgInfo)
  {
    ...
    if ((paramAdMsgInfo != null) && (String.valueOf(paramAdMsgInfo.uDstUin).equalsIgnoreCase(paramToServiceMsg.getUin())))
    {
      ...
      paramFromServiceMsg.frienduin = String.valueOf(AppConstants.ag);
      paramFromServiceMsg.senderuin = String.valueOf(AppConstants.ag);
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, SvcRequestPushReadedNotify paramSvcRequestPushReadedNotify)
  {
    ...
    if ((paramSvcRequestPushReadedNotify.vC2CReadedNotify != null) && (paramSvcRequestPushReadedNotify.vC2CReadedNotify.size() > 0))
    {
      if (bool1)
      {
        paramFromServiceMsg = (SubAccountManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(59);
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (i1 != 0)
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(str2, 7000, i1);
            if (QLog.isColorLevel()) {
              QLog.d("Q.msg.MessageHandler", 2, "handlePushReadedNotify subUin=" + str2 + "increaseUnread=" + i1);
            }
          }
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(new String[] { AppConstants.W, str2 });
        }
      }
    ...
    if ((paramSvcRequestPushReadedNotify.vGroupReadedNotify != null) && (paramSvcRequestPushReadedNotify.vGroupReadedNotify.size() > 0))
    {
      ...
      while (paramFromServiceMsg.hasNext())
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a((String)localObject2) == 1)
        {
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a((String)localObject2, (GroupMsgReadedNotify)localObject1);
          if (QLog.isColorLevel()) {
    ...
    if ((paramSvcRequestPushReadedNotify.vDisReadedNotify != null) && (paramSvcRequestPushReadedNotify.vDisReadedNotify.size() > 0))
    {
      ...
      while (paramFromServiceMsg.hasNext())
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b((String)localObject1) == 1)
        {
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a((String)localObject1, paramSvcRequestPushReadedNotify);
          if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          break label103;
        } while (((paramInt1 != 6000) && (paramInt1 != 8002) && (paramInt1 != 7000) && (paramInt1 != 8005) && (paramInt1 != 8006) && (paramInt1 != 6010) && (paramInt1 != 6012) && (paramInt1 != 6013) && (paramInt1 != 8008) && (paramInt1 != 8010) && (paramInt1 != 8012) && (paramInt1 != 8014)) || (!(paramObject instanceof Object[])));
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localObject = (EmojiManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(42);
  ...
  private Object[] a()
  {
    Object localObject = ((ContactFacade)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).a("-1004");
    ...
    for (HashMap localHashMap = new HashMap(this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.a());; localHashMap = null)
    {
      ...
      if (i1 < paramSvcResponsePullGroupMsgSeq.vGroupInfo.size())
      {
        ...
        if ((localObject2 != null) && (localObject2.length > 0))
        {
          ...
          if (((((GroupInfo)localObject1).lMask != 2L) && (((GroupInfo)localObject1).lMask != 3L)) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a.c())) {
            break label511;
          }
          f(str);
          label397:
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    str1 = paramToServiceMsg.extraData.getString("uin");
    ...
    i2 = paramToServiceMsg.extraData.getInt("msgtype");
    i5 = paramToServiceMsg.extraData.getInt("ROUNTING_TYPE");
    i4 = MessageProtoCodec.a(i5);
    bool = paramToServiceMsg.extraData.getBoolean("RichNotify", false);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (paramObject.result.get() != 0)
        {
          ...
          if ((i4 == 1010) && (paramObject.errmsg.has()) && ((i1 == 54) || (i1 == 61) || (i1 == 62))) {
            AddMessageHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2[0], paramObject.errmsg.get(), i4, false, false);
          }
  ...
  private boolean d()
  {
    for (;;)
    {
      ...
      {
        if ((this.jdField_a_of_type_ArrayOfHls != null) && (this.jdField_a_of_type_ArrayOfHls.length > 1)) {
          break label77;
        }
        return true;
        if (i1 >= this.jdField_a_of_type_ArrayOfHls.length) {
          break label73;
        }
        if ((this.jdField_a_of_type_ArrayOfHls[i1] != null) && (this.jdField_a_of_type_ArrayOfHls[i1].b())) {
          return false;
        }
      }
      i1 += 1;
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
      ...
      for (;;)
      {
        ...
        if (paramObject.result.get() != 0)
        {
          ...
          if (i1 == 255)
          {
            ...
            localObject3 = ((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(58)).a((String)localObject2);
            if ((!paramObject.f((String)localObject2)) && (localObject3 == null)) {
              break label776;
            }
            if ((i1 != 108) && (i1 != 102)) {
              break label765;
            ...
            HotChatHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (HotChatInfo)localObject3);
            bool = false;
          }
          for (;;)
          {
            ...
            for (;;)
            {
              ...
              i2 = 0;
              break;
              ((FriendsManagerImp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(8)).i((String)localObject2);
    ...
    if ((paramObject == null) || (!paramObject.result.has()))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><R><---handleSendTroopMessageRespPB: ---cmd:" + (String)localObject3 + "----replyCode:" + i1 + " ssoseq:" + paramFromServiceMsg.getRequestSsoSeq() + " appseq:" + paramFromServiceMsg.getAppSeq() + ",SendTroopMessageResp : peerUin:" + (String)localObject2 + ",uniseq:" + l2 + ",msgSeq:" + l1);
      }
      localObject1 = a(l1);
      if (localObject1 != null) {
        break label343;
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if ((i1 == 1) || (i1 == 3) || (i1 == 14) || (i1 == 5) || (i1 == 6) || (i1 == 10) || (i1 == 11) || (i1 == 12) || (i1 == 8) || (i1 == 16) || (i1 == 17) || (i1 == 18) || (i1 == 15) || (i1 == 19) || (i1 == 20))
        {
  ...
  private void m(ToServiceMsg arg1, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      long l1;
      if (paramFromServiceMsg.uEndSeq == this.bL)
      {
        l1 = 0L;
      ...
      for (;;)
      {
        if (((!d()) || (!e())) && (jdField_a_of_type_Boolean)) {
          break label268;
        }
        ...
        if (paramFromServiceMsg.uEndSeq != this.bM) {
          break;
        }
  ...
  private void n(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      r(paramToServiceMsg, paramFromServiceMsg, arrayOfByte);
      return;
    }
    catch (Exception paramToServiceMsg)
    {
  ...
  private void o()
  {
    ...
    Object localObject2 = ((Context)localObject1).getString(2131368980);
    String str = ((Context)localObject1).getString(2131368980);
    Bitmap localBitmap = BitmapManager.a(((Context)localObject1).getResources(), 2130839616);
    ...
    for (;;)
    {
      ...
      localNotificationManager.cancel(bJ);
      localNotificationManager.notify(bJ, (Notification)localObject1);
      this.jdField_a_of_type_JavaLangThread = new Thread(new hlj(this, localNotificationManager));
      this.jdField_a_of_type_JavaLangThread.start();
      return;
      ((NotificationCompat.Builder)localObject2).setLargeIcon(BitmapManager.a(((Context)localObject1).getResources(), 2130839616));
    }
  }
  ...
  private void o(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    if (this.bT < 3)
    {
      ...
      while (paramFromServiceMsg.hasNext()) {
        a(String.valueOf(((msg_svc.PbPullGroupMsgSeqReq.GroupInfoReq)paramFromServiceMsg.next()).group_code.get()), paramToServiceMsg.extraData.getInt("doSome"));
      }
    }
    n(paramToServiceMsg, paramFromServiceMsg);
  }
  ...
  private void q(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (QLog.isColorLevel())
    {
      paramFromServiceMsg.append("<<---handleGetPullTroopMsgNumResp_PB groupMsgSeqResp.result: ").append(paramObject.result.get()).append(" ,doSome: ").append(i2);
    ...
    {
      localObject2 = (msg_svc.PbPullGroupMsgSeqResp.GroupInfoResp)paramObject.group_info_resp.get().get(i1);
      str = String.valueOf(((msg_svc.PbPullGroupMsgSeqResp.GroupInfoResp)localObject2).group_code.get());
      localObject3 = this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.b(str);
      ...
      if (QLog.isColorLevel())
      {
        ...
        paramFromServiceMsg.append("handleGetPullTroopMsgNumResp_PB getGroupMsgMemberSeq groupUin=").append(((msg_svc.PbPullGroupMsgSeqResp.GroupInfoResp)localObject2).group_code.get()).append(" ,memberseq=").append(((msg_svc.PbPullGroupMsgSeqResp.GroupInfoResp)localObject2).member_seq.get()).append(" ,groupSeq=").append(((msg_svc.PbPullGroupMsgSeqResp.GroupInfoResp)localObject2).group_seq.get()).append(" ,localMemberMsgSeq=").append(l1).append(" ,localLastSeq=").append(l2);
        QLog.d("Q.msg.MessageHandler", 2, paramFromServiceMsg.toString());
      }
      this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.c(str, new Object[] { Long.valueOf(((msg_svc.PbPullGroupMsgSeqResp.GroupInfoResp)localObject2).member_seq.get()), Long.valueOf(((msg_svc.PbPullGroupMsgSeqResp.GroupInfoResp)localObject2).group_seq.get()) });
      if (l1 < ((msg_svc.PbPullGroupMsgSeqResp.GroupInfoResp)localObject2).member_seq.get()) {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(String.valueOf(((msg_svc.PbPullGroupMsgSeqResp.GroupInfoResp)localObject2).group_code.get()), 1, ((msg_svc.PbPullGroupMsgSeqResp.GroupInfoResp)localObject2).member_seq.get());
      }
      l1 = this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.a(str, 1);
      localObject2 = a(str, 1, this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.a(str), this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.b(str), l1, ((msg_svc.PbPullGroupMsgSeqResp.GroupInfoResp)localObject2).group_seq.get());
      int i3 = (int)(((Long)((Pair)localObject2).second).longValue() - ((Long)((Pair)localObject2).first).longValue());
      ...
      {
        paramFromServiceMsg.setLength(0);
        paramFromServiceMsg.append("---------handleGetPullTroopMsgNumResp_PB troopUin: ").append(str).append(" ,msg count: ").append(i3);
        QLog.d("Q.msg.MessageHandler", 2, paramFromServiceMsg.toString());
      }
      if (i3 > 0) {
        break label750;
  ...
  private void r(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object arg3)
  {
  ...
  public SvcRequestPullDisMsgSeq a()
  {
    ...
    Object localObject = (ContactFacade)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
    if (localObject != null) {}
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      break;
      if ((!MsgProxyUtils.n(paramMessageRecord.msgtype)) && (MsgProxyUtils.e(paramMessageRecord.msgtype)))
      {
        localObject = new ArrayList();
        int i3;
        int i1;
        ...
        for (;;)
        {
          ...
          while (i2 < 12)
          {
            localSendMessageHandler.a(new hll(this, localMessageRecord, l1));
            i2 += 1;
          }
          i2 = 0;
          if (i2 < 6)
  ...
  public void a(MessageRecord paramMessageRecord, BusinessObserver paramBusinessObserver, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localSendMessageHandler.a(new hli(this, paramMessageRecord, localPbSendMsgReq, paramBusinessObserver, paramBoolean));
      i1 += 1;
    }
    label148:
    if (i2 < 3) {
  ...
  public void a(MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    else if ((paramMessageRecord.msgtype == -2009) && ((paramMessageRecord.istroop == 0) || (paramMessageRecord.istroop == 1000) || (paramMessageRecord.istroop == 1004) || (paramMessageRecord.istroop == 1006) || (paramMessageRecord.istroop == 1021) || (paramMessageRecord.istroop == 1010) || (paramMessageRecord.istroop == 1001)))
    {
      if (!paramBoolean) {}
      for (paramBoolean = true;; paramBoolean = false)
      {
        a("addMessageAndNotify", 1000, true, null, 1, a(paramBoolean, MessageHandlerUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList)), false, paramMessageRecord);
        return;
      }
    }
    if (!paramBoolean) {}
    for (paramBoolean = true;; paramBoolean = false)
    {
      a("addMessageAndNotify", 1000, true, null, 1, a(paramBoolean, MessageHandlerUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList)), false, null);
      return;
    }
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    } while (!"MessageSvc.DelRoamMsg".equalsIgnoreCase(str));
        ...
        else
        {
          ...
          if ("MessageSvc.PushNotify".equalsIgnoreCase(str))
          {
            ...
            if ((paramObject instanceof RequestPushNotify))
            {
              ...
              {
                bool = true;
                localObject1 = Long.toString(localRequestPushNotify.lBindedUin);
              }
            ...
            {
              QLog.d((String)localObject2, 2, "MessageSvc.PushNotify,notify.wUserActive:" + localRequestPushNotify.wUserActive + " isSubAccount=" + bool + " cmd" + localRequestPushNotify.strCmd);
              i2 = bool;
              localObject2 = localObject1;
              if (i2 == 0) {
                break label933;
              ...
              SubAccountControll.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2, true);
              break;
            }
            label933:
          ...
          else if ("OnlinePush.PbPushTransMsg".equalsIgnoreCase(str))
          {
            ...
            PkgTools.a((byte[])localObject1, 0, paramObject, 4, paramObject.length - 4);
            paramObject = new OnlinePushTrans.PbMsgInfo();
            try
            {
              paramObject.mergeFrom((byte[])localObject1);
              if (paramObject != null)
              {
              ...
              else
              {
                ...
                if (paramObject != null)
                {
                  ...
                  paramToServiceMsg.extraData.putInt("seq", paramObject.msg_seq.get());
                }
                paramToServiceMsg.extraData.putLong("lUin", Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a()));
          ...
          else
          {
            ...
            else if ("MessageSvc.RequestPushStatus".equalsIgnoreCase(str))
            {
              if (paramObject != null)
              {
                ...
                for (;;)
                {
                  ...
                  paramFromServiceMsg.c(paramToServiceMsg.cPrintable);
                  paramFromServiceMsg.d(paramToServiceMsg.cViewPcFile);
                  paramFromServiceMsg.a(paramToServiceMsg.iPCVersion);
                  ((DataLineHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).a().a(b1, paramToServiceMsg.cDataLine, paramToServiceMsg.cPrintable, paramToServiceMsg.cViewPcFile, paramToServiceMsg.iPCVersion);
            ...
            else if (("MultiVideo.c2sack".equalsIgnoreCase(str)) && (QLog.isColorLevel()))
            {
  ...
  public void a(String paramString1, int paramInt1, long paramLong, int paramInt2, boolean paramBoolean1, String paramString2, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 1)
      {
        localMessageForGrayTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramString1, paramString1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131365754), paramLong, -1013, paramInt1, paramLong);
      ...
      for (;;)
      {
        ...
        localMessageForGrayTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramString1, paramString1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131365753), paramLong, -1013, paramInt1, paramLong);
  ...
  public void a(String paramString, long paramLong1, long paramLong2, long paramLong3, short paramShort, long paramLong4, int paramInt, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    if (QLog.isColorLevel())
    {
      QLog.d("Q.msg.MessageHandler", 2, "--->>getRoamMsgByTime friendUin: " + paramString + " beginTime: " + paramLong1 + " endTime: " + paramLong3 + " middleTime: " + paramLong2 + " maxCnt: " + paramShort + " random: " + paramLong4 + " subcmd：" + paramInt);
      QLog.d("Q.msg.MessageHandler", 2, "--->>getRoamMsgByTime passwordMD5: " + Arrays.toString(paramArrayOfByte1));
      QLog.d("Q.msg.MessageHandler", 2, "--->>getRoamMsgByTime signature: " + Arrays.toString(paramArrayOfByte2));
    }
    ...
    for (;;)
    {
      ...
      localPbGetRoamMsgReq.subcmd.set(paramInt);
      localPbGetRoamMsgReq.begin_msgtime.set(paramLong1);
      localPbGetRoamMsgReq.check_pwd.set(1);
      if (paramArrayOfByte1 != null) {
        localPbGetRoamMsgReq.pwd.set(ByteStringMicro.copyFrom(paramArrayOfByte1));
      }
      if (paramArrayOfByte2 != null) {
        localPbGetRoamMsgReq.sig.set(ByteStringMicro.copyFrom(paramArrayOfByte2));
      }
  ...
  public void a(String paramString1, String paramString2, byte paramByte, String paramString3, long paramLong1, long paramLong2)
  {
    ...
    for (long l1 = 0L; l1 < 3L; l1 += 1L) {
      localSendMessageHandler.postDelayed(new hlk(this, l1, paramString1, paramString2, paramByte, paramString3, paramLong1, paramLong2), 30000L * l1);
    }
  ...
  public void a(ArrayList paramArrayList1, ArrayList paramArrayList2)
  {
    ...
    if ((paramArrayList1 != null) && (paramArrayList1.size() > 0))
    {
      ...
      {
        arrayOfLong[i1] = ((hlq)paramArrayList1.get(i1)).jdField_a_of_type_Long;
        localObject[i1] = ((hlq)paramArrayList1.get(i1)).jdField_a_of_type_Int;
        arrayOfShort[i1] = ((hlq)paramArrayList1.get(i1)).jdField_a_of_type_Short;
        if (QLog.isColorLevel()) {
  ...
  public void a(ArrayList paramArrayList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayList.hasNext())
      {
        Object localObject1 = (MessageRecord)paramArrayList.next();
        if (((localObject1 instanceof MessageForPic)) || ((localObject1 instanceof MessageForMixedMsg))) {
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a((MessageRecord)localObject1, 3);
        }
        if (((localObject1 instanceof MessageForStructing)) && (!((MessageRecord)localObject1).isread))
        {
          Object localObject2 = (MessageForStructing)localObject1;
          if ((((MessageForStructing)localObject2).structingMsg.mMsgServiceID == 38) && (!TextUtils.isEmpty(((MessageForStructing)localObject2).structingMsg.mResid)))
          {
            localObject1 = (VipGiftManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(72);
            paramBoolean = ((VipGiftManager)localObject1).a((MessageForStructing)localObject2);
            localObject2 = ((VipGiftManager)localObject1).a();
            if ((paramBoolean) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a.b()) && (localObject2 != null) && (((VipGiftDownloadInfo)localObject2).d == 0L) && (((VipGiftDownloadInfo)localObject2).jdField_a_of_type_Long != 0L)) {
  ...
  public void a(SubMsgType0x6f.FanpaiziNotify paramFanpaiziNotify)
  {
    if ((paramFanpaiziNotify == null) && (QLog.isColorLevel())) {
      QLog.d("TurnBrand", 2, "decodeTurnBrandTipsPush param fanpaiziNotify is null.");
    }
    if (paramFanpaiziNotify.uint64_from_uin.has())
    {
      String str2 = Long.toString(paramFanpaiziNotify.uint64_from_uin.get());
      paramFanpaiziNotify.str_from_nick.get();
      String str1 = "";
      if (paramFanpaiziNotify.bytes_tips_content.has()) {
        str1 = paramFanpaiziNotify.bytes_tips_content.get().toStringUtf8();
      }
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
      if (paramFanpaiziNotify.bytes_sig.has())
      {
        paramFanpaiziNotify = paramFanpaiziNotify.bytes_sig.get().toByteArray();
        if (paramFanpaiziNotify != null) {
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().h(str2, paramFanpaiziNotify);
        }
      }
      AddMessageHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str2, str1, 1001, null, true, true, false);
      if (QLog.isColorLevel()) {
        QLog.d("TurnBrand", 2, "handle turnbrand push friendUin=" + str2 + ",senderUin=" + str2);
      }
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(t, 2, "Msg Pull Finish picPreDownloadOn");
    }
  ...
  protected boolean a(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilSet == null)
    {
      ...
      this.jdField_a_of_type_JavaUtilSet.add("PbMessageSvc.PbUnReadMsgSeq");
  ...
  public boolean a(String paramString, long paramLong1, long paramLong2, boolean paramBoolean, Bundle paramBundle, int paramInt)
  {
    ...
    PBBoolField localPBBoolField = paramBundle.public_group;
    if ((localFriendManager.f(paramString)) || (localHotChatManager.c(paramString))) {}
    for (paramBoolean = true;; paramBoolean = false)
    {
      localPBBoolField.set(paramBoolean);
      localToServiceMsg.putWupBuffer(paramBundle.toByteArray());
      c(localToServiceMsg);
      return true;
    }
  ...
  public boolean a(boolean paramBoolean1, boolean paramBoolean2, List paramList)
  {
    ...
    if ((paramBoolean1) && (paramList != null) && (paramList.size() > 0) && ((MsgProxyUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)paramList.get(0))) || (MsgProxyUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)paramList.get(0)))))
    {
      if (QLog.isColorLevel()) {
  ...
  public void b(MessageRecord paramMessageRecord)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      a("addMessageAndNotify", 1000, true, null, 1, a(bool, MessageHandlerUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList)), false, null);
      return;
    }
  }
  ...
  public void b(String paramString, int paramInt)
  {
    ...
    while (paramInt < 9)
    {
      localSendMessageHandler.a(new hlp(this, paramString, l2, l1));
      paramInt += 1;
    }
    paramInt = 0;
    label95:
  ...
  public boolean c()
  {
    return ((d()) && (e())) || (!jdField_a_of_type_Boolean);
  }
  ...
  public void d(String paramString)
  {
    ...
    localAccountManager.changeToken(localHashMap, new hlm(this, paramString));
  }
  ...
  public void g()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_c_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_ArrayOfHls != null) {
          break label193;
        }
        this.jdField_c_of_type_JavaUtilArrayList = new ArrayList(20);
        this.jdField_d_of_type_JavaUtilArrayList = new ArrayList(10);
        this.jdField_a_of_type_ArrayOfHls = new hls[6];
        break label193;
        if (i1 < this.jdField_a_of_type_ArrayOfHls.length)
        {
          if ((this.jdField_a_of_type_ArrayOfHls[i1] != null) && (!this.jdField_a_of_type_ArrayOfHls[i1].a())) {
            break label198;
          }
          if (i1 == 0)
          {
            this.jdField_a_of_type_ArrayOfHls[i1] = new hls(this, this.jdField_d_of_type_JavaUtilArrayList);
            this.jdField_a_of_type_ArrayOfHls[i1].setName("MessageHandleThread" + (i1 + 1));
            this.jdField_a_of_type_ArrayOfHls[i1].setPriority(5);
            this.jdField_a_of_type_ArrayOfHls[i1].start();
            break label198;
          }
          this.jdField_a_of_type_ArrayOfHls[i1] = new hls(this, this.jdField_c_of_type_JavaUtilArrayList);
        }
      }
      return;
      label193:
  ...
  public void h()
  {
    synchronized (this.jdField_c_of_type_JavaLangObject)
    {
      ...
      {
        int i1 = 0;
        while (i1 < this.jdField_a_of_type_ArrayOfHls.length)
        {
          this.jdField_a_of_type_ArrayOfHls[i1].a();
          i1 += 1;
        }
      }
      synchronized (this.jdField_c_of_type_JavaUtilArrayList)
      {
        ...
        this.jdField_a_of_type_ArrayOfHls = null;
        return;
      }
    }
  }
  ...
  public void l()
  {
    ...
    while (i1 < 9)
    {
      localSendMessageHandler.a(new hlo(this, localPbMsgReadedReportReq, l2, l1));
      i1 += 1;
    }
    i1 = 0;
    label88:
