  ...
  extends BaseProxy
{
  ...
  public long a(MpfileTaskRecord paramMpfileTaskRecord)
  {
    ...
    new Handler(localLooper).post(new huk(this, paramMpfileTaskRecord, localWaitEvent));
    localWaitEvent.a(-1L);
    return 0L;
  }
  ...
  public void a(Entity paramEntity, ProxyListener paramProxyListener)
  {
    ...
    new Handler(localLooper).post(new huh(this, paramEntity, paramProxyListener, localWaitEvent));
    localWaitEvent.a(-1L);
  }
  ...
  public void a(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString, ProxyListener paramProxyListener)
  {
    ...
    new Handler(localLooper).post(new hui(this, paramString1, paramContentValues, paramString2, paramArrayOfString, paramProxyListener));
  }
  ...
  public void a(String paramString1, String paramString2, String[] paramArrayOfString, ProxyListener paramProxyListener)
  {
    ...
    new Handler(localLooper).post(new huj(this, paramString1, paramString2, paramArrayOfString, paramProxyListener));
  }
