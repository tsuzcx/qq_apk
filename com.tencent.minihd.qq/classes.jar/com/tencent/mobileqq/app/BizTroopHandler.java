  ...
  extends BusinessHandler
{
  ...
  protected static final int L = 1282;
  ...
  private void k(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (RecommendTroopManagerImp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(21);
    if (paramFromServiceMsg.getResultCode() != 1000)
    {
  ...
  private void t(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramFromServiceMsg = (TroopInfoManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36);
        if (bool)
        {
  ...
  private void v(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramFromServiceMsg.mergeFrom((byte[])paramObject);
        paramObject = (TroopInfoManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36);
        ...
        do
        {
          do
          {
            do
            {
                  ...
                  do
                  {
                    do
                    {
                      do
                      {
                        ...
                        if (i1 == 2)
                        {
                          ((TroopGagMgr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47)).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
                          return;
                        }
                      } while (i1 != 3);
              ...
              ((TroopHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(19)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "" + l1, paramToServiceMsg);
              return;
  ...
  public void d(String paramString, boolean paramBoolean)
  {
    ...
    for (int i1 = (byte)(i2 & 0x1);; i1 = (byte)(i2 & 0x2))
    {
      ...
      paramString = localFriendManager.g(paramString);
      ((ToServiceMsg)localObject2).extraData.putString("troopUin", paramString);
  ...
  public void f(String paramString)
  {
    ...
    try
    {
      ...
      if (i1 == 2)
      {
        ...
        localReqBody.bytes_mobileQ_ver.set(ByteStringMicro.copyFrom("5.9.3".getBytes()));
        localToServiceMsg.putWupBuffer(localReqBody.toByteArray());
