  ...
  implements BusinessObserver
{
  ...
  public static void a(String paramString, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    if (a != null)
    {
      paramString = new hha(paramString, System.currentTimeMillis());
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    {
      hha localhha = (hha)localIterator.next();
      if (!localhha.jdField_a_of_type_JavaLangString.equals(localObject1)) {
        break label355;
      }
      localOnInvokeFinishLinstener = (RemoteCommand.OnInvokeFinishLinstener)a.get(localhha);
      localObject2 = localhha;
    }
    label355:
    for (;;)
    {
      ...
      if (localOnInvokeFinishLinstener != null)
      {
        ...
        for (i = 1;; i = 0)
        {
          ReportController.a(null, "P_CliOper", "cardpay", "", "sso-req", "finish", paramInt, i, "" + (System.currentTimeMillis() - ((hha)localObject2).jdField_a_of_type_Long), ((hha)localObject2).jdField_a_of_type_JavaLangString, "", "");
          return;
        }
      }
      if (paramBoolean) {}
