          ...
          for (;;)
          {
            ...
            catch (InvalidProtocolBufferMicroException paramObject)
            {
              ...
              try
              {
                ...
                paramFromServiceMsg = (SubAccountManager)this.a.getManager(59);
                ...
                SubAccountControll.a(this.a, (byte)1, str1);
                SubAccountControll.a(this.a, str1, false);
                if (AccountManageActivity.class.getSimpleName().equals(str2)) {
                  ReportController.a(this.a, "CliOper", "", "", "0X8004003", "0X8004003", 0, 0, "", "", "", "");
                }
                bool1 = true;
              }
              catch (Exception paramToServiceMsg)
      ...
      for (;;)
      {
        for (;;)
        {
          for (;;)
          {
            ...
            {
              localSubAccountBackProtocData.p = 0;
              SubAccountControll.a(this.a, str1);
            }
            catch (Exception paramToServiceMsg)
            {
              bool1 = true;
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          paramToServiceMsg = (SubAccountControll)this.a.getManager(60);
        ...
        if (localSubAccountBackProtocData.c())
        {
          ...
          if ((paramToServiceMsg != null) && (paramToServiceMsg.size() > 0))
          {
            ...
            if (paramObject.hasNext())
            {
              ...
              i = 1 - this.a.a().a(str, 7000);
              if (i == 0) {
                continue;
              }
              this.a.a().b(str, 7000, i);
              continue;
            }
          }
        ...
        try
        {
          if (paramObject.hasNext())
          {
            ...
            bool1 = false;
            localObject = SubAccountControll.a(this.a, str);
            if (localObject != null) {
        ...
        try
        {
          ...
          this.a.getSubAccountKey(this.a.getAccount(), ((SubAccountBackProtocData)localObject).c, new hpz(this, (SubAccountBackProtocData)localObject, paramFromServiceMsg, bool2));
          i = 0;
        }
        catch (Exception paramToServiceMsg)
        {
        ...
        {
          j = 1 - this.a.a().a(str, 7000);
          if (j != 0)
          {
            this.a.a().b(str, 7000, j);
            this.a.a().a(new String[] { AppConstants.W, str });
          }
          if (QLog.isColorLevel()) {
