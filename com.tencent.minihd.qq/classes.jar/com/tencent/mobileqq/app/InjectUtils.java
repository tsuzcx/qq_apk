...
public class InjectUtils
{
  ...
  private static final String[] a = { "exlibs.1.jar", "exlibs.2.jar", "exlibs.3.jar" };
  private static final String[] b = { "Foo", "Foo2", "Foo3" };
  ...
  private static File a(String paramString)
  {
    ...
    if (!localFile.exists())
    {
      ...
      if (!localFile.exists())
      {
        paramString = new File("/data/data/com.tencent.minihd.qq/files", paramString);
  ...
  private static String a(Application paramApplication, String paramString1, String paramString2)
  {
    ...
    //   13: dup
    //   14: aload_0
    //   15: invokevirtual 83	android/app/Application:getFilesDir	()Ljava/io/File;
    //   18: aload_1
    //   19: invokespecial 65	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   22: astore_3
    //   23: new 53	java/io/File
    //   26: dup
    //   27: aload_0
    //   28: invokevirtual 83	android/app/Application:getFilesDir	()Ljava/io/File;
    //   31: aload_2
    //   32: invokespecial 65	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   35: astore 9
    //   37: aload_0
    //   38: invokevirtual 87	android/app/Application:getAssets	()Landroid/content/res/AssetManager;
    //   41: aload_1
    //   42: invokevirtual 93	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   45: astore_1
    //   46: new 95	java/io/FileOutputStream
    //   49: dup
    //   50: aload_3
    //   51: iconst_0
    //   52: invokespecial 98	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   55: astore_3
    //   56: aload_3
    //   57: astore 5
    //   59: aload_1
    ...
    //   62: aload_1
    //   63: aload_3
    //   64: invokestatic 100	com/tencent/mobileqq/app/InjectUtils:a	(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    //   67: pop2
    //   68: aload_1
    //   69: ifnull +7 -> 76
    //   72: aload_1
    //   73: invokevirtual 103	java/io/InputStream:close	()V
    //   76: aload 6
    //   78: astore 4
    //   80: aload_3
    //   81: ifnull +11 -> 92
    //   84: aload_3
    //   85: invokevirtual 104	java/io/OutputStream:close	()V
    //   88: aload 6
    //   90: astore 4
    //   92: ldc 8
    //   94: aload 4
    //   96: invokevirtual 108	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   99: ifeq +383 -> 482
    //   102: aload_0
    //   103: invokevirtual 87	android/app/Application:getAssets	()Landroid/content/res/AssetManager;
    //   106: aload_2
    //   107: invokevirtual 93	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   110: astore_0
    //   111: new 95	java/io/FileOutputStream
    //   114: dup
    //   115: aload 9
    //   117: iconst_0
    //   118: invokespecial 98	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   121: astore_1
    //   122: aload_0
    //   123: aload_1
    //   124: invokestatic 100	com/tencent/mobileqq/app/InjectUtils:a	(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    //   127: pop2
    //   128: aload_0
    //   129: ifnull +7 -> 136
    //   132: aload_0
    //   133: invokevirtual 103	java/io/InputStream:close	()V
    //   136: aload_1
    //   137: ifnull +7 -> 144
    //   140: aload_1
    //   141: invokevirtual 104	java/io/OutputStream:close	()V
    //   144: aload 4
    //   146: areturn
    //   147: astore 6
    //   149: aconst_null
    ...
    //   157: astore 4
    //   159: aload 6
    //   161: invokevirtual 111	java/lang/Throwable:printStackTrace	()V
    //   164: aload_3
    //   165: astore 5
    //   167: aload_1
    //   168: astore 4
    //   170: aload 9
    //   172: invokevirtual 114	java/io/File:delete	()Z
    //   175: pop
    //   176: aload_3
    //   177: astore 5
    //   179: aload_1
    ...
    //   194: aload 6
    //   196: invokestatic 129	android/util/Log:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    //   212: ifnull +7 -> 219
    //   215: aload_1
    //   216: invokevirtual 103	java/io/InputStream:close	()V
    //   219: aload 5
    //   221: astore 4
    //   223: aload_3
    //   224: ifnull -132 -> 92
    //   227: aload_3
    //   228: invokevirtual 104	java/io/OutputStream:close	()V
    //   231: aload 5
    //   233: astore 4
    //   235: goto -143 -> 92
    //   238: astore_1
    ...
    //   253: ifnull +7 -> 260
    //   256: aload_1
    //   257: invokevirtual 103	java/io/InputStream:close	()V
    //   260: aload 5
    //   262: ifnull +8 -> 270
    //   265: aload 5
    //   267: invokevirtual 104	java/io/OutputStream:close	()V
    //   270: aload_0
    //   271: athrow
    //   272: astore_0
    //   273: aconst_null
    ...
    //   275: aload 7
    //   277: astore_2
    //   278: invokestatic 138	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   281: ifeq +30 -> 311
    //   284: ldc 140
    //   286: iconst_2
    //   287: new 116	java/lang/StringBuilder
    //   290: dup
    //   291: invokespecial 117	java/lang/StringBuilder:<init>	()V
    //   294: aload 9
    //   296: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   299: ldc 145
    ...
    //   307: aload_0
    //   308: invokestatic 149	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   311: aload_0
    //   312: invokevirtual 111	java/lang/Throwable:printStackTrace	()V
    //   315: aload_1
    //   316: ifnull +7 -> 323
    //   319: aload_1
    //   320: invokevirtual 103	java/io/InputStream:close	()V
    //   323: aload_2
    //   324: ifnull -180 -> 144
    //   327: aload_2
    //   328: invokevirtual 104	java/io/OutputStream:close	()V
    //   331: aload 4
    //   333: areturn
    //   334: astore_0
    //   335: aload 4
    ...
    //   345: ifnull +7 -> 352
    //   348: aload_1
    //   349: invokevirtual 103	java/io/InputStream:close	()V
    //   352: aload_2
    //   353: ifnull +7 -> 360
    //   356: aload_2
    //   357: invokevirtual 104	java/io/OutputStream:close	()V
    //   360: aload_0
    //   361: athrow
    //   362: astore_1
    //   363: goto -287 -> 76
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      ...
      if ((TelephonyManager)paramContext.getSystemService("phone") != null) {
        localStringBuilder.append(QQDeviceInfo.a("master")).append("|");
      }
      localStringBuilder.append(paramString2).append("|");
      new hkq(arrayOfByte, localStringBuilder.toString()).start();
      return;
    }
  ...
  private static boolean a(Application paramApplication, String paramString1, String paramString2)
  {
    ...
    //   1: astore 4
    //   3: aload_1
    //   4: invokestatic 234	com/tencent/mobileqq/app/InjectUtils:a	(Ljava/lang/String;)Ljava/io/File;
    //   7: ifnonnull +36 -> 43
    //   10: invokestatic 138	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   13: ifeq +28 -> 41
    //   16: ldc 140
    //   18: iconst_2
    //   19: new 116	java/lang/StringBuilder
    //   22: dup
    //   23: invokespecial 117	java/lang/StringBuilder:<init>	()V
    //   26: aload_1
    ...
    //   35: invokevirtual 133	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   38: invokestatic 168	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   41: iconst_0
    //   42: ireturn
    //   43: aload_2
    //   44: invokestatic 234	com/tencent/mobileqq/app/InjectUtils:a	(Ljava/lang/String;)Ljava/io/File;
    //   47: astore 5
    //   49: aload 5
    //   51: ifnonnull +36 -> 87
    //   54: invokestatic 138	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   57: ifeq -16 -> 41
    //   60: ldc 140
    //   62: iconst_2
    //   63: new 116	java/lang/StringBuilder
    //   66: dup
    //   67: invokespecial 117	java/lang/StringBuilder:<init>	()V
    //   70: aload_2
    //   71: invokevirtual 123	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   74: ldc 236
    //   76: invokevirtual 123	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   79: invokevirtual 133	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   82: invokestatic 168	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   85: iconst_0
    //   86: ireturn
    //   87: aload_0
    //   88: invokevirtual 87	android/app/Application:getAssets	()Landroid/content/res/AssetManager;
    //   91: aload_2
    //   92: invokevirtual 93	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   95: astore_0
    //   96: new 238	java/io/FileInputStream
    //   99: dup
    //   100: aload 5
    //   102: invokespecial 241	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   105: astore 4
    //   107: aload_0
    //   108: aload 4
    //   110: invokestatic 244	com/tencent/mobileqq/app/InjectUtils:a	(Ljava/io/InputStream;Ljava/io/InputStream;)Z
    //   113: istore_3
    //   114: invokestatic 138	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   117: ifeq +33 -> 150
    //   120: ldc 140
    //   122: iconst_2
    //   123: new 116	java/lang/StringBuilder
    //   126: dup
    //   127: invokespecial 117	java/lang/StringBuilder:<init>	()V
    //   130: aload 5
    ...
    //   140: iload_3
    //   141: invokevirtual 249	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   144: invokevirtual 133	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   147: invokestatic 168	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   150: aload_0
    //   151: ifnull +7 -> 158
    //   154: aload_0
    //   155: invokevirtual 103	java/io/InputStream:close	()V
    //   158: aload 4
    //   160: ifnull +8 -> 168
    //   163: aload 4
    //   165: invokevirtual 103	java/io/InputStream:close	()V
    //   168: iload_3
    //   169: ireturn
    //   170: astore_2
    //   171: aconst_null
    ...
    //   173: aload 4
    //   175: astore_1
    //   176: invokestatic 138	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   179: ifeq +30 -> 209
    //   182: ldc 140
    //   184: iconst_2
    ...
    //   192: aload 5
    //   194: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   197: ldc 251
    //   199: invokevirtual 123	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   202: invokevirtual 133	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   205: aload_2
    //   206: invokestatic 149	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   209: aload_2
    //   210: invokevirtual 252	java/io/IOException:printStackTrace	()V
    //   213: aload_1
    //   214: ifnull +7 -> 221
    //   217: aload_1
    ...
    //   240: ifnull +7 -> 247
    //   243: aload_0
    //   244: invokevirtual 103	java/io/InputStream:close	()V
    //   247: aload_2
    //   248: ifnull +7 -> 255
    //   251: aload_2
