...
public class NewFriendManager
  ...
  implements Manager
{
  public static final int a = 2130838434;
  ...
  private boolean a(NewFriendMessage paramNewFriendMessage)
  {
    ...
    } while ((paramNewFriendMessage == null) || (localRecentUserProxy == null) || (paramNewFriendMessage.jdField_a_of_type_Boolean) || ((paramNewFriendMessage.o == 0) && (!localRecentUserProxy.a(AppConstants.ab, 4000))));
    return true;
  }
  ...
  private void b(NewFriendMessage paramNewFriendMessage)
  {
    ...
    do
    {
      do
      {
        ...
        if ((paramNewFriendMessage.n == 0) && (localPhoneContactManagerImp.a() > 0) && (!localRecentUserProxy.a(AppConstants.ab, 4000)))
        {
  ...
  private void c(NewFriendMessage paramNewFriendMessage)
  {
    ...
    do
    {
      ...
      localRecentUserProxy = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
      localRecentUser = localRecentUserProxy.a(AppConstants.ab, 4000);
  ...
  private void j()
  {
    ...
    if (localRecommendContact != null)
    {
      ...
      localRecentUser.msgType = 5;
      localRecentUser.displayName = "新朋友";
      localRecentUser.lastmsgtime = localRecommendContact.timeStamp;
      String str = null;
      ...
      label150:
      for (localRecentUser.msg = ("你可能认识 " + str + b + 0);; localRecentUser.msg = ("" + b + 0))
      {
        localRecentUserProxy.a(localRecentUser);
        return;
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new hma(this));
  }
  ...
  public void c()
  {
    ...
    do
    {
      return;
      localRecentUserProxy = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
      localRecentUser = localRecentUserProxy.b(AppConstants.ab, 4000);
  ...
  public void d()
  {
    ...
    if (localObject2 != null)
    {
      ...
      localRecentUser = ((RecentUserProxy)localObject1).b(AppConstants.ab, 4000);
    ...
    do
    {
      ...
      localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(AppConstants.aj, 0);
      ...
      localRecentUser = ((RecentUserProxy)localObject2).b(AppConstants.ab, 4000);
    } while (localRecentUser == null);
    localRecentUser.msgType = 5;
    localRecentUser.displayName = "新朋友";
  ...
  public void h()
  {
    ...
    ((PhoneContactManagerImp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(10)).m();
  ...
  public void i()
  {
    ...
    ((PhoneContactManagerImp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(10)).h();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b();
