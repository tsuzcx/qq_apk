  ...
  extends BusinessHandler
{
  ...
  public void a(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
          ...
          for (;;)
          {
            ...
            if (paramObject.msg_quota.has())
            {
              ...
              if (paramObject.uint32_comm_quota.has()) {
                QvipSpecialCareManager.a(paramObject.uint32_comm_quota.get(), this.a);
              }
              if (paramObject.uint32_svip_quota.has()) {
                QvipSpecialCareManager.b(paramObject.uint32_svip_quota.get(), this.a);
              }
                ...
                if ((localObject1 != null) && (((List)localObject1).size() > 0))
                {
                  ...
                  while (((Iterator)localObject1).hasNext())
                  {
                    ...
                    if ((((RemindPB.RemindItem)localObject2).uint64_uin.has()) && (((RemindPB.RemindItem)localObject2).uint32_id.has()))
                    {
                      ...
                      paramObject.add(str);
                      QvipSpecialCareManager.a(str, ((RemindPB.RemindItem)localObject2).uint32_id.get(), this.a);
                    }
                  }
                  QvipSpecialCareManager.a(paramObject, this.a);
                  continue;
                  if (paramObject.rep_clear_uin.has())
                  {
                    ...
                    if ((localObject1 != null) && (((List)localObject1).size() > 0))
                    {
                      ...
                      while (((Iterator)localObject1).hasNext())
                      {
                        ...
                        QvipSpecialCareManager.c((String)localObject2, this.a);
                      }
                      QvipSpecialCareManager.b(paramObject, this.a);
                    }
                  }
                }
              }
    ...
    do
    {
      ...
      String str;
      if (QLog.isColorLevel()) {
        QLog.e("QVipSpeicalCareHandler", 2, "-->report MM:cmd=" + paramFromServiceMsg.getServiceCmd() + ",error code=" + paramFromServiceMsg.getBusinessFailCode() + ",uin=" + this.a.a());
      }
    } while (paramFromServiceMsg.isSuccess());
    ReportCenter.a().a(paramFromServiceMsg.getServiceCmd(), 100, paramFromServiceMsg.getBusinessFailCode(), this.a.a(), 1000277, "[特别关心]请求后台失败.", true);
  }
