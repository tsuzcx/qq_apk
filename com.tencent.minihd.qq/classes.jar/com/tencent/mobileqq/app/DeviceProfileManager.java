...
public class DeviceProfileManager
{
  ...
  {
    jdField_a_of_type_ComTencentMobileqqAppDeviceProfileManager$AccountDpcManager = (DeviceProfileManager.AccountDpcManager)BaseApplicationImpl.a.a().getManager(64);
  ...
  public static ConfigurationService.ReqGetConfig a(AppInterface paramAppInterface, boolean paramBoolean)
  {
    ...
    int m = 0;
    if (paramBoolean) {
      m = ReflectedMethods.a(BaseApplicationImpl.getContext(), "dpcConfig_account").getInt(DeviceProfileManager.AccountDpcManager.a((QQAppInterface)paramAppInterface, "server_version"), 0);
    }
    ((ConfigurationService.ConfigSeq)localObject3).version.set(m);
  ...
  private void b()
  {
    ...
    localObject1 = new DeviceProfileManager.DPCConfigInfo();
    ((DeviceProfileManager.DPCConfigInfo)localObject1).featureValue = "1|3|约会打招呼|有人在约会上给你打招呼，快去看看！";
    this.b.put(DeviceProfileManager.DpcNames.OneyWayDateMsgNotifyCfg.name(), localObject1);
    localObject1 = new DeviceProfileManager.DPCConfigInfo();
    ((DeviceProfileManager.DPCConfigInfo)localObject1).featureValue = "1|5|附近打招呼|有附近的人给你打招呼，快去看看！";
    this.b.put(DeviceProfileManager.DpcNames.OneyWayLBSFriendMsgNotifyCfg.name(), localObject1);
  }
  ...
  private static boolean b(DeviceProfileManager.DPCConfigInfo paramDPCConfigInfo, String paramString)
  {
    ...
    if (jdField_a_of_type_ArrayOfJavaLangReflectField == null)
    {
      ...
      for (;;)
      {
        if (m < jdField_a_of_type_ArrayOfJavaLangReflectField.length) {
          try
          {
            jdField_a_of_type_ArrayOfJavaLangReflectField[m] = paramDPCConfigInfo.getClass().getField(jdField_a_of_type_ArrayOfJavaLangString[m]);
            jdField_a_of_type_ArrayOfJavaLangReflectField[m].setAccessible(true);
            m += 1;
          }
          catch (NoSuchFieldException paramString)
          {
            for (;;)
            {
              ...
              jdField_a_of_type_ArrayOfJavaLangReflectField[m] = null;
            }
          }
        }
      }
    }
    int n = Math.min(jdField_a_of_type_ArrayOfJavaLangReflectField.length, arrayOfString.length);
    int m = 0;
    boolean bool1 = false;
    boolean bool2;
    while (m < n)
    ...
    for (;;)
    {
      try
      {
        if ((jdField_a_of_type_ArrayOfJavaLangReflectField[m] == null) || (paramString.equals((String)jdField_a_of_type_ArrayOfJavaLangReflectField[m].get(paramDPCConfigInfo)))) {
          break label282;
        }
        jdField_a_of_type_ArrayOfJavaLangReflectField[m].set(paramDPCConfigInfo, paramString);
        bool1 = true;
        bool2 = bool1;
      }
  ...
  private void c()
  {
    ...
    else
    {
      ...
      int n = arrayOfDpcNames.length;
      m = 0;
      if (m >= n) {
        return;
      }
      localDpcNames = arrayOfDpcNames[m];
  ...
  public String a(String paramString)
  {
    ...
    //   2: aload_0
    //   3: aload_1
    //   4: invokespecial 671	com/tencent/mobileqq/app/DeviceProfileManager:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/app/DeviceProfileManager$DPCConfigInfo;
    //   7: astore_2
    //   8: invokestatic 112	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   11: ifeq +47 -> 58
    //   14: aload_2
    //   15: ifnull +43 -> 58
    //   18: getstatic 60	com/tencent/mobileqq/app/DeviceProfileManager:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   21: iconst_2
    ...
    //   45: aload_2
    //   46: invokevirtual 663	com/tencent/mobileqq/app/DeviceProfileManager$DPCConfigInfo:toString	()Ljava/lang/String;
    //   49: invokevirtual 126	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   52: invokevirtual 129	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   55: invokestatic 131	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   58: aload_2
    //   59: ifnull +20 -> 79
    //   62: aload_2
    //   63: getfield 538	com/tencent/mobileqq/app/DeviceProfileManager$DPCConfigInfo:featureValue	Ljava/lang/String;
    //   66: ifnull +13 -> 79
    //   69: aload_2
    //   70: getfield 538	com/tencent/mobileqq/app/DeviceProfileManager$DPCConfigInfo:featureValue	Ljava/lang/String;
    //   73: invokevirtual 564	java/lang/String:length	()I
    //   76: ifne +11 -> 87
    //   79: ldc_w 287
    //   82: astore_1
    //   83: aload_0
    ...
    //   86: areturn
    //   87: aload_2
    //   88: getfield 538	com/tencent/mobileqq/app/DeviceProfileManager$DPCConfigInfo:featureValue	Ljava/lang/String;
    //   91: astore_1
    //   92: goto -9 -> 83
    //   95: astore_1
    //   96: aload_0
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    //   2: aload_0
    //   3: aload_1
    //   4: invokevirtual 678	com/tencent/mobileqq/app/DeviceProfileManager:a	(Ljava/lang/String;)Ljava/lang/String;
    //   7: astore 4
    //   9: aload_2
    //   10: astore_1
    //   11: aload 4
    ...
    //   16: ldc_w 287
    //   19: aload 4
    //   21: invokevirtual 609	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   24: istore_3
    //   25: iload_3
    //   26: ifeq +9 -> 35
    //   29: aload_2
  ...
  public boolean a(ConfigurationService.RespGetConfig paramRespGetConfig, String paramString)
  {
    try
    {
      ThreadManager.b().post(new hit(this, paramRespGetConfig, paramString));
      return true;
    }
    finally
    {
  ...
  public boolean a(String paramString, HashMap paramHashMap)
  {
    ...
    paramHashMap = new hiu(paramHashMap);
    try
    {
