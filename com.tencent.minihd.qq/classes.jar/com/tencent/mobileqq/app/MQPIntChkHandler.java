  ...
  extends BusinessHandler
{
  ...
  private intchk.AppInfo a()
  {
    ...
    localAppInfo.bytes_app_version.set(ByteStringMicro.copyFromUtf8("5.9.3.2cb8ec"));
    localAppInfo.uint32_intchk_module_version.set(MQPSecUtil.jdField_a_of_type_Int);
    int m = n;
  ...
  private void a(Element paramElement)
  {
    ...
    for (localObject = new hla(this, Integer.parseInt(((Element)localObject).getAttribute("action")));; localObject = null)
    {
      String str2 = "";
      ...
      for (paramElement = new hlb(this, Integer.parseInt(paramElement.getAttribute("action")));; paramElement = null)
      {
        hlc localhlc = new hlc(this);
        if (QLog.isDevelopLevel()) {
          QLog.d("IntChk", 4, "start create toast.");
        }
        new Handler(Looper.getMainLooper()).post(new hld(this, str3, str4, (DialogInterface.OnClickListener)localObject, paramElement, str2, str1, localhlc));
        return;
      }
    }
  }
    ...
    for (int m = paramCheckItem.uint32_start_offset.get();; m = 0)
    {
      ...
      for (int n = paramCheckItem.uint32_end_offset.get();; n = 0)
      {
        ...
        do
        {
          ...
          try
          {
            boolean bool = MQPSecUtil.memchk(str1, m, n, HexUtil.a(str2));
            return bool;
          }
  ...
  private byte[] a(intchk.CheckItem paramCheckItem)
  {
    ...
    for (int m = paramCheckItem.uint32_start_offset.get();; m = 0)
    {
      ...
      for (int n = paramCheckItem.uint32_end_offset.get();; n = 0)
      {
        ...
        try
        {
          paramCheckItem = MQPSecUtil.memreport(str, m, n);
  ...
  private void g()
  {
    ...
    do
    {
      ...
      ((Context)localObject).registerReceiver(new hle(this, localDownloadManager), localIntentFilter);
      try
      {
