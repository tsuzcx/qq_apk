  ...
  implements IMessageManager
{
  ...
  private void a(DataLineMsgRecord paramDataLineMsgRecord, EntityManager paramEntityManager)
  {
    ...
    {
      localMessage = this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a(String.valueOf(AppConstants.Y), 6000);
      localMessage.selfuin = String.valueOf(AppConstants.Y);
      localMessage.senderuin = String.valueOf(AppConstants.Y);
      ...
      localMessage.frienduin = String.valueOf(AppConstants.Y);
  ...
  public int a()
  {
    ...
    localObject = this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a(String.valueOf(AppConstants.Y), 6000);
  ...
  public int a(long paramLong)
  {
    ...
    new Handler(localLooper).post(new hss(this, localDataLineMsgSet));
    return 0;
  }
  ...
  public int a(DataLineMsgSet paramDataLineMsgSet)
  {
    ...
    if (Thread.currentThread() == ((Looper)localObject).getThread())
    {
      ...
      if (i > 0)
      {
        paramDataLineMsgSet = MsgProxyUtils.a(String.valueOf(AppConstants.Y), 6000);
        ...
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(String.valueOf(AppConstants.Y), 6000);
    ...
    new Handler((Looper)localObject).post(new hst(this, paramDataLineMsgSet));
    return 0;
  }
  ...
  public long a(DataLineMsgRecord paramDataLineMsgRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (Thread.currentThread() == ((Looper)localObject2).getThread())
      {
        ...
        try
        {
          ...
          RecentUser localRecentUser = ((RecentUserProxy)localObject2).a(String.valueOf(AppConstants.Y), 6000);
    ...
    new Handler((Looper)localObject2).post(new hsr(this, paramDataLineMsgRecord, (WaitEvent)localObject1));
  ...
  public void a()
  {
    ...
    try
    {
      ...
      ((EntityManager)localObject1).a();
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a(String.valueOf(AppConstants.Y), 6000);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.DatalineMessageManager", 2, "setDataLineMsgReaded,unread=" + this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a().a(AppConstants.Y, 6000));
    }
    if (this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a().a(AppConstants.Y, 6000) > 0)
    {
      a().e();
      this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a().a(AppConstants.Y, 6000);
      this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a(AppConstants.Y, 6000));
    }
  }
}
