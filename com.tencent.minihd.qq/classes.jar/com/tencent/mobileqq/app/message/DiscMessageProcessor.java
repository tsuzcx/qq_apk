  ...
  extends BaseMessageProcessorForTroopAndDisc
{
  ...
  public DiscMessageProcessor(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
    ...
    this.jdField_a_of_type_Hsx = new hsx(this, null);
  }
  ...
  private MessageRecord a(MsgInfo paramMsgInfo, long paramLong)
  {
    ...
    Object localObject7 = (DiscussionManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
      ...
      for (;;)
      {
        ...
        if (!((DiscussionManager)localObject7).a(String.valueOf(l1), String.valueOf(l2)))
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131366635, new Object[] { localObject2 });
            ...
            localObject3 = new Pair(Long.valueOf(l2), ((ArrayList)localObject1).get(0));
            localObject5 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
            if (((RecentUserProxy)localObject5).b(Long.toString(l1), 3000) != null)
            {
              if (QLog.isColorLevel()) {
                QLog.d("Q.msg.DiscMessageProcessor.discuss", 2, "handleDiscussionMemchangeMsg ru alreadyintab");
              }
              a((Pair)localObject3, paramMsgInfo, (ArrayList)localObject2, paramLong, String.valueOf(l1), b1, false);
            }
            else
            {
              localObject4 = ((RecentUserProxy)localObject5).a(Long.toString(l1), 3000);
              ...
              ((RecentUserProxy)localObject5).a((RecentUser)localObject4);
              if (QLog.isColorLevel()) {
              ...
              else if (TextUtils.equals((CharSequence)localObject5, String.valueOf(l2)))
              {
                a((ArrayList)localObject1, ((RecentUser)localObject4).uin, (String)localObject5, (String)localObject5);
                ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Multi_call", "Show_discuss_tips", 0, 0, "", "", "", "");
              }
              else
              {
                a((Pair)localObject3, paramMsgInfo, (ArrayList)localObject2, paramLong, String.valueOf(l1), b1, true);
                continue;
                l2 = PkgTools.a((byte[])localObject5, 5);
                ...
                if (l2 == paramLong) {}
                for (localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131368368, new Object[] { localObject4 });; localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131368369, new Object[] { localObject2, localObject4 }))
                {
                ...
                if (PkgTools.a((byte[])localObject5, 5) != 0)
                {
                  ...
                  this.jdField_a_of_type_JavaUtilTimer.schedule(new hsu(this, (ArrayList)localObject3, paramLong, l1, (String)localObject1, paramMsgInfo, l2), 2000L);
                }
              }
            }
          }
    ...
    for (int k = 1;; k = 0)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_JavaUtilTimer.schedule(new hsv(this, l3, paramLong, (Pair)localObject6, paramMsgInfo, l1, l2, b1, l4, (Pair)localObject7, localArrayList), 2000L);
      }
      ...
      for (;;)
      {
        ...
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131366636, new Object[] { localObject2 });
  ...
  private void a(Pair paramPair1, MsgInfo paramMsgInfo, long paramLong1, long paramLong2, long paramLong3, byte paramByte, long paramLong4, Pair paramPair2)
  {
    ...
    for (;;)
    {
      ...
      if (paramLong4 == 0L) {
        paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131366649, new Object[] { paramPair1 });
      }
      for (;;)
      {
        ...
        return;
        if (paramLong4 == 1L) {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131366651, new Object[] { paramPair1, paramPair2 });
        } else if (paramLong4 == 2L) {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131369368, new Object[] { paramPair1 });
        } else {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131366634, new Object[] { paramPair1 });
        }
      }
    }
  }
  ...
  private void a(Pair paramPair, MsgInfo paramMsgInfo, ArrayList paramArrayList, long paramLong1, String paramString, byte paramByte, long paramLong2, boolean paramBoolean)
  {
    ...
    if (k < n)
    {
      ...
      if (Long.valueOf(str2).longValue() == paramLong1)
      {
        ...
        paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131366642);
    ...
    paramPair = "";
    if (paramByte == 11) {
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131366648, new Object[] { localStringBuffer.toString() });
    }
    if (paramByte == 22) {
      if (paramLong2 == 0L) {
        paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131366648, new Object[] { localStringBuffer.toString() });
    ...
    for (;;)
    {
      ...
      if (paramLong2 == 1L)
      {
        paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131366650);
      }
      else if (paramLong2 == 2L)
      {
        paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131369369, new Object[] { localStringBuffer.toString() });
        continue;
        if (l == paramLong1)
        {
          m = 1;
          ...
          paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131366641);
        }
        for (;;)
        {
          paramPair = paramPair + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131366634, new Object[] { localStringBuffer.toString() });
          break;
          m = 0;
          break label626;
          label703:
          ...
          paramPair = paramPair + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131366640);
          continue;
          label796:
          paramPair = "";
        }
  ...
  private void a(ArrayList paramArrayList, String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((paramArrayList != null) && (paramArrayList.size() > 1))
    {
      ...
      paramArrayList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131365757, new Object[] { localObject });
      localMessageRecord.init(paramString2, paramString1, paramString3, paramArrayList + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131365758), l, -1016, 3000, l);
  ...
  private boolean a(long paramLong1, long paramLong2, short paramShort)
  {
    ...
    //   43: invokevirtual 665	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/service/message/MessageCache;
    //   46: invokevirtual 1223	com/tencent/mobileqq/service/message/MessageCache:a	()Ljava/util/ArrayList;
    //   49: aload 7
    //   51: invokevirtual 1224	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
    //   54: ifeq +44 -> 98
    ...
    //   87: invokestatic 1228	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   90: iconst_1
    //   91: istore 6
    //   93: aload_0
    //   94: monitorexit
    ...
    //   102: invokevirtual 665	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/service/message/MessageCache;
    //   105: aload 7
    //   107: invokevirtual 1229	com/tencent/mobileqq/service/message/MessageCache:a	(Ljava/lang/String;)V
    //   110: iconst_0
    //   111: istore 6
    //   113: goto -20 -> 93
    //   116: astore 7
  ...
  public hth a(int paramInt, MsgInfo paramMsgInfo, SvcReqPushMsg paramSvcReqPushMsg)
  {
    ...
    for (;;)
    {
      ...
      if ((paramMsgInfo != null) && (paramSvcReqPushMsg != null)) {
        return new hth(a(paramMsgInfo, paramSvcReqPushMsg), false);
      }
  ...
  {
    a(true, false, false, 0L, new hsw(this, paramLong1, paramLong2));
  }
