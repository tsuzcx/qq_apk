  ...
  extends BaseProxy
{
    ...
    synchronized (MsgPool.a().a(paramString, paramInt))
    {
      ...
      if (paramString != null)
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if ((localMessageRecord.time >= paramLong1) && (localMessageRecord.time <= paramLong2) && (MsgProxyUtils.e(localMessageRecord.msgtype))) {
  ...
  private void b(String paramString, int paramInt, List paramList)
  {
    ...
    //   5: invokevirtual 241	com/tencent/mobileqq/app/message/MsgPool:a	()Ljava/util/concurrent/ConcurrentHashMap;
    //   8: invokevirtual 270	java/util/concurrent/ConcurrentHashMap:size	()I
    //   11: istore 4
    //   13: getstatic 273	com/tencent/mobileqq/app/message/MsgProxyUtils:a	[Ljava/lang/String;
    //   16: arraylength
    //   17: istore 5
    //   19: iload 4
    //   21: iload 5
    ...
    //   30: istore 7
    //   32: aload_0
    //   33: invokespecial 275	com/tencent/mobileqq/app/message/MsgProxy:a	()Z
    //   36: istore 6
    //   38: invokestatic 224	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   41: ifeq +30 -> 71
    //   44: ldc 10
    //   46: iconst_2
    ...
    //   60: iload 6
    //   62: invokevirtual 280	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   65: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   68: invokestatic 232	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   71: invokestatic 36	com/tencent/mobileqq/app/message/MsgPool:a	()Lcom/tencent/mobileqq/app/message/MsgPool;
    //   74: invokevirtual 241	com/tencent/mobileqq/app/message/MsgPool:a	()Ljava/util/concurrent/ConcurrentHashMap;
    //   77: aload_0
    //   78: aload_1
    //   79: iload_2
    //   80: invokevirtual 58	com/tencent/mobileqq/app/message/MsgProxy:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   83: aload_3
    //   84: invokevirtual 284	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   87: pop
    //   88: aload_0
    //   89: monitorexit
    //   90: return
    ...
    //   93: iload 7
    //   95: istore 6
    //   97: invokestatic 224	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   100: ifeq -62 -> 38
    //   103: ldc 10
    //   105: iconst_2
    //   106: ldc_w 286
  ...
  protected int a(int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (MsgPool.a().a(AppConstants.ar, paramInt))
      {
        Object localObject2 = d(AppConstants.ar, 4001);
        if (localObject2 != null)
        {
          ...
          if (j >= 0)
          {
            ...
            a(String.valueOf(AppConstants.ar), 4001, MessageRecord.getTableName(String.valueOf(AppConstants.ar), 4001), "msgtype=?", new String[] { String.valueOf(paramInt) }, null);
          }
        }
        else
        {
          if ((localObject2 != null) && (((List)localObject2).size() == 0) && (GroupSystemMsgController.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) <= 0))
          {
            ...
            RecentUser localRecentUser = ((RecentUserProxy)localObject2).a(AppConstants.ap, 9000);
  ...
  protected int a(String paramString, int paramInt, long paramLong)
  {
    ...
    if (localList != null)
    {
      ...
      for (;;)
      {
        ...
        j = i;
        if (((MessageRecord)localList.get(i)).uniseq == paramLong) {
          break;
        }
        i += 1;
      }
    ...
    if ((paramString != null) && (!paramString.isEmpty()))
    {
      ...
      {
        if (((MessageRecord)paramString.get(paramInt)).uniseq == paramLong) {
          return paramInt;
        }
        paramInt += 1;
      }
  ...
  public Cursor a(String paramString, int paramInt)
  {
    ...
    if (paramString.equals(String.valueOf(AppConstants.ae)))
    {
      ArrayList localArrayList = new ArrayList();
      int i = 0;
      ...
      return new hsz(this, localArrayList);
    }
    return new hsz(this, (List)((ArrayList)localList).clone());
  }
  
  @Deprecated
  protected Cursor a(List paramList)
  {
    return new hsz(this, paramList);
  }
  ...
  protected ChatHistorySearchData a(SessionInfo paramSessionInfo, String paramString)
  {
    ...
    //   12: astore_3
    //   13: aload_1
    //   14: getfield 547	com/tencent/mobileqq/activity/aio/SessionInfo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   17: invokestatic 543	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   20: ifne +13 -> 33
    //   23: aload_2
    //   24: invokestatic 543	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   27: ifeq +8 -> 35
    //   30: aload 4
    //   32: astore_3
    //   33: aload_3
    //   34: areturn
    //   35: aload_1
    //   36: getfield 547	com/tencent/mobileqq/activity/aio/SessionInfo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   39: aload_1
    //   40: getfield 549	com/tencent/mobileqq/activity/aio/SessionInfo:jdField_a_of_type_Int	I
    ...
    //   54: ldc_w 627
    //   57: iconst_1
    //   58: anewarray 132	java/lang/String
    //   61: dup
    //   62: iconst_0
    //   63: sipush -1000
    ...
    //   72: ldc_w 629
    //   75: aconst_null
    //   76: invokevirtual 480	com/tencent/mobileqq/persistence/MessageRecordEntityManager:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   79: astore 5
    //   81: aload_0
    //   82: aload 5
    //   84: aload_1
    //   85: aload_2
    //   86: invokevirtual 631	com/tencent/mobileqq/app/message/MsgProxy:a	(Landroid/database/Cursor;Lcom/tencent/mobileqq/activity/aio/SessionInfo;Ljava/lang/String;)Lcom/tencent/mobileqq/data/ChatHistorySearchData;
    //   89: astore_1
    //   90: aload_1
    //   91: astore_3
    //   92: aload 5
  ...
  protected List a(String paramString, int paramInt, List paramList)
  {
    ...
    //   30: astore_1
    //   31: iconst_1
    //   32: anewarray 132	java/lang/String
    //   35: astore_3
    ...
    //   73: checkcast 166	java/lang/Integer
    //   76: invokevirtual 1020	java/lang/Integer:intValue	()I
    ...
    //   96: aconst_null
    //   97: aconst_null
    //   98: invokevirtual 480	com/tencent/mobileqq/persistence/MessageRecordEntityManager:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   101: astore 4
    //   103: aload 5
    //   105: aload_0
    ...
    //   111: aconst_null
    //   112: aload 4
    //   114: invokevirtual 604	com/tencent/mobileqq/persistence/MessageRecordEntityManager:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;)Lcom/tencent/mobileqq/persistence/Entity;
    //   117: checkcast 92	com/tencent/mobileqq/data/MessageRecord
    //   120: invokevirtual 605	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   123: pop
    //   124: aload 4
    //   126: ifnull -72 -> 54
    //   129: aload 4
    //   131: invokeinterface 488 1 0
    //   136: goto -82 -> 54
    //   139: astore 7
    //   141: aload 4
    //   143: ifnull -89 -> 54
    //   146: aload 4
    //   148: invokeinterface 488 1 0
    //   153: goto -99 -> 54
    //   156: astore_1
    //   157: aload 4
    //   159: ifnull +10 -> 169
    //   162: aload 4
    //   164: invokeinterface 488 1 0
    //   169: aload_1
    //   170: athrow
    //   171: aload 5
    //   173: areturn
  ...
  protected void a(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c("recv_msg_back_public", 1);
        return;
      }
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c("recv_msg_notify", 1);
      return;
  ...
  protected void a(String paramString, int paramInt, QQMessageFacade.Message paramMessage)
  {
    ...
    if ((paramInt == 1001) && (paramMessage.msgtype != -1003) && (paramMessage.msgtype != -1031) && (paramMessage.msgtype != -1032) && (paramMessage.msgtype != 201)) {
      ...
      {
        str = MessageRecord.getTableName(String.valueOf(AppConstants.af), 1001);
    ...
    for (;;)
    {
      ...
      return;
      str = MessageRecord.getOldTableName(String.valueOf(AppConstants.af), 1001);
      break;
      if (paramInt == 1009) {
        a(paramString, paramInt, MessageRecord.getTableName(AppConstants.V, 1009), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
      } else if (paramInt == 1010) {
        a(paramString, paramInt, MessageRecord.getTableName(AppConstants.au, 1010), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
      }
    }
  }
  ...
  {
    if ((MsgProxyUtils.i(paramMessageRecord.msgtype)) && (!MsgProxyUtils.a(paramMessageRecord.frienduin, paramMessageRecord.istroop))) {}
    while (!paramBoolean2) {
      return;
    }
    if (paramBoolean1)
  ...
  {
    new Thread(new hsy(this, paramBoolean), "report_troop_aio_break").start();
  }
  ...
  protected void b(String paramString, int paramInt, long paramLong)
  {
    ...
    synchronized (MsgPool.a().a(paramString, paramInt))
    {
      ...
      {
        MessageRecord localMessageRecord = (MessageRecord)((Iterator)localObject2).next();
        if ((!localMessageRecord.isread) && (a(paramInt, paramLong, localMessageRecord)) && ((!MsgProxyUtils.a(paramInt)) || (!MsgProxyUtils.h(localMessageRecord.msgtype)))) {
          localMessageRecord.isread = true;
        }
      }
    }
    ...
    while (paramString.hasNext())
    {
      ...
      if ((!((MessageRecord)localObject2).isread) && (a(paramInt, paramLong, (MessageRecord)localObject2)) && ((!MsgProxyUtils.a(paramInt)) || (!MsgProxyUtils.h(((MessageRecord)localObject2).msgtype)))) {
  ...
  public void e()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 117	com/tencent/mobileqq/app/message/MsgProxy:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   4: invokevirtual 307	com/tencent/mobileqq/app/proxy/ProxyManager:c	()V
    //   7: aload_0
    //   8: getfield 117	com/tencent/mobileqq/app/message/MsgProxy:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   11: invokevirtual 1275	com/tencent/mobileqq/app/proxy/ProxyManager:d	()V
    //   14: aload_0
    //   15: getfield 113	com/tencent/mobileqq/app/message/MsgProxy:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   18: invokevirtual 1277	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   21: astore 11
    //   23: aload 11
    //   25: invokevirtual 1282	com/tencent/mobileqq/app/SQLiteDatabase:b	()[Ljava/lang/String;
    //   28: astore 12
    //   30: aload 12
    //   32: ifnonnull +4 -> 36
    //   35: return
    ...
    //   51: aload 13
    //   53: ldc_w 1284
    //   56: invokevirtual 136	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   59: ifeq +357 -> 416
    ...
    //   102: aload 8
    //   104: ifnull +246 -> 350
    //   107: invokestatic 224	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   110: ifeq +31 -> 141
    //   113: ldc_w 322
    //   116: iconst_2
    //   117: new 145	java/lang/StringBuilder
    //   120: dup
    //   121: invokespecial 146	java/lang/StringBuilder:<init>	()V
    //   124: ldc_w 1292
    ...
    //   135: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   138: invokestatic 232	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   141: aload 11
    //   143: aload 8
    //   145: aconst_null
    //   146: invokevirtual 1295	com/tencent/mobileqq/app/SQLiteDatabase:a	(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   149: astore 9
    //   151: aload 9
    //   153: ifnull +175 -> 328
    //   156: aload 9
    //   158: astore 8
    //   160: aload 9
    //   162: invokeinterface 485 1 0
    //   167: ifle +161 -> 328
    //   170: aload 9
    //   172: astore 8
    //   174: aload 9
    //   176: invokeinterface 579 1 0
    //   181: pop
    //   182: aload 9
    //   184: astore 8
    //   186: aload 9
    //   188: aload 9
    //   190: ldc_w 1297
    //   193: invokeinterface 1300 2 0
    //   198: invokeinterface 1304 2 0
    //   203: lstore 6
    //   205: aload 9
    //   207: astore 8
    //   209: aload 9
    //   211: aload 9
    //   213: ldc_w 1305
    //   216: invokeinterface 1300 2 0
    //   221: invokeinterface 841 2 0
    //   226: astore 10
    //   228: aload 9
    //   230: astore 8
    //   232: aload 9
    //   234: aload 9
    //   236: ldc_w 1306
    //   239: invokeinterface 1300 2 0
    //   244: invokeinterface 614 2 0
    //   249: istore_2
    //   250: aload 9
    //   252: astore 8
    //   254: aload 9
    //   256: aload 9
    //   258: ldc_w 842
    //   261: invokeinterface 1300 2 0
    //   266: invokeinterface 614 2 0
    //   271: istore_3
    //   272: lload 6
    //   274: lstore 4
    //   276: iload_2
    ...
    //   311: astore 8
    //   313: aload_0
    //   314: getfield 113	com/tencent/mobileqq/app/message/MsgProxy:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   317: invokevirtual 1037	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/service/message/MessageCache;
    //   320: aload 10
    //   322: iload_2
    //   323: lload 4
    //   325: invokevirtual 1310	com/tencent/mobileqq/service/message/MessageCache:a	(Ljava/lang/String;IJ)V
    //   328: aload 9
    //   330: ifnull +10 -> 340
    //   333: aload 9
    //   335: invokeinterface 488 1 0
    //   340: aload 11
    //   342: aload 13
    //   344: aconst_null
    //   345: aconst_null
    //   346: invokevirtual 1313	com/tencent/mobileqq/app/SQLiteDatabase:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   349: pop
    //   350: iload_1
    //   351: iconst_1
    //   352: iadd
    ...
    //   364: astore 8
    //   366: aload 10
    //   368: invokevirtual 611	java/lang/Exception:printStackTrace	()V
    //   371: aload 9
    //   373: ifnull -33 -> 340
    //   376: aload 9
    //   378: invokeinterface 488 1 0
    //   383: goto -43 -> 340
    //   386: astore 9
    //   388: aconst_null
    //   389: astore 8
