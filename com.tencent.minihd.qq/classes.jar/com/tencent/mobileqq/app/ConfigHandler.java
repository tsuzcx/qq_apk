  ...
  implements UpgradeController.OnHandleUpgradeFinishListener
{
  ...
  private void a(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new hhv(this, paramGetResourceRespInfo, l2));
    return;
    ThreadManager.a().post(new hhx(this));
  }
  ...
  private boolean a(String paramString, long paramLong)
  {
    ...
    do
    {
      ...
      if ("eggs_android_CI_4.7.1".equals(paramString))
      {
        ...
        {
          FileUtils.d(new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getFilesDir(), "eggs_config.zip").getAbsolutePath());
          ...
          if (paramFromServiceMsg.bytes_bodybuffer.has())
          {
            ...
            if (paramFromServiceMsg.bytes_bodybuffer.get() != null)
            {
              ...
              if (j == 16)
              {
                ...
                bool5 = bool1;
                bool6 = bool2;
                this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().sendBroadcast(paramFromServiceMsg);
                bool7 = bool2;
                bool2 = bool1;
              }
            }
  ...
  private void b(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    while (paramGetResourceRespInfo.iResult == 0)
    {
      ...
      if ((str != null) && (str.length() > 0)) {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new hhy(this, str, paramGetResourceRespInfo));
      }
      return;
    }
  }
  ...
  private void c(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new hhz(this, str, paramGetResourceRespInfo));
  }
  
  private void d()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getSharedPreferences("mobileQQ", 0).edit().putInt("upgrade_tip_count", 0).putLong("upgrade_tip_time", 0L).commit();
  ...
  private void d(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new hia(this, str, paramGetResourceRespInfo));
  }
  ...
  private void e(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new hib(this, str, localStatusManager, paramGetResourceRespInfo));
  }
  ...
  private void f(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new hic(this, paramGetResourceRespInfo, str, l2));
    return;
    ThreadManager.a().post(new hid(this, paramGetResourceRespInfo));
  }
    ...
    if ("ConfigService.GetResourceReq".equals(paramFromServiceMsg.getServiceCmd()))
    {
      if (paramObject == null) {
        if (paramToServiceMsg.extraData.getBoolean("reqRegionConfig")) {
          ((ConditionSearchManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(57)).a(null);
        }
      }
      do
      {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (paramFromServiceMsg.sResType == 2)
          {
            ...
            {
              paramObject = (ConditionSearchManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(57);
              if (paramObject != null) {
          ...
          {
            paramObject = (EarlyDownloadManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(73);
            if (paramObject != null) {
              paramObject.a(paramFromServiceMsg);
            }
          }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new hie(this, paramString, paramFile));
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    a(paramString1);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new hhw(this, paramString2, paramString1));
  }
  ...
  {
    ConditionSearchManager localConditionSearchManager = (ConditionSearchManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(57);
  ...
  {
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("OfflineFileConfigV2", 0);
