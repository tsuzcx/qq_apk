  ...
  extends BusinessHandler
{
  ...
  public void a(int paramInt, ArrayList paramArrayList, String paramString)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      try
      {
        localObject3 = ByteStringMicro.copyFrom(a(((Emoticon)localObject3).eId));
            ...
            for (;;)
            {
              try
              {
                ...
                if (i != 0)
                {
                  ...
                  bool1 = true;
                  this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("mobileQQ", 0).edit().putBoolean("emosm_has_download_emosmpackage_tag_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), bool1).commit();
                }
                if (!bool1) {
                  break;
                }
  ...
  public void a(String paramString)
  {
    ...
    paramString.str_app_version.set("5.9.3");
