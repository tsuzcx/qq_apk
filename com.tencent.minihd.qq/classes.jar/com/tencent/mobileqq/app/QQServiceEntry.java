  ...
  implements View.OnClickListener, AdapterView.OnItemClickListener
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfHof = new hof[6];
  }
  ...
  public void onClick(View paramView)
  {
    ...
    } while (this.jdField_a_of_type_ComTencentMobileqqAppQQServiceEntry$Tag.jdField_a_of_type_JavaLangString.equals(String.valueOf(AppConstants.ae)));
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQServiceEntry$Tag.jdField_a_of_type_AndroidWidgetGridView.setAdapter(new hog(this, this.jdField_a_of_type_ComTencentMobileqqAppQQServiceEntry$Tag.b));
