  ...
  implements CommandListener, IHttpCommunicatorListener
{
  ...
  public static final String c = "https://activeqq.3g.qq.com/activeQQ/upgrade.jsp";
  public static final String d = "https://kiss.3g.qq.com/activeQQ/mq/5?g_t=2&";
  public static final String e = "https://kiss.3g.qq.com/activeQQ/mq/4?";
  public static final String f = "qq_config.dat";
  private static final String h = "https://conf.3g.qq.com/newConf/n";
  ...
  {
    this.jdField_a_of_type_Hxi = new hxi(this);
  ...
  public void a(HttpMsg arg1, HttpMsg paramHttpMsg2)
  {
    ...
    try
    {
      synchronized (this.jdField_a_of_type_ArrayOfInt)
      {
        ...
        ConfigParser.a(paramHttpMsg2, new hxj(), this.j);
        b();
        d();
        return;
      }
  ...
  public void a(BaseConf[] paramArrayOfBaseConf)
  {
    ...
    paramArrayOfBaseConf = new HttpMsg("https://conf.3g.qq.com/newConf/n", ConfigParser.a(paramArrayOfBaseConf), this, true);
    ...
    this.jdField_a_of_type_JavaUtilTimer.schedule(new hxh(this), 1000L);
  }
  ...
  {
    boolean bool = true;
    switch (this.jdField_a_of_type_Hxi.a)
    {
    default: 
      bool = false;
    }
