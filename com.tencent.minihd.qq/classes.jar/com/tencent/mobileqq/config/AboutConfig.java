...
public class AboutConfig
{
  ...
  public static final String b = "https://fwd.3g.qq.com:8080/forward.jsp?bid=942";
  public static final String c = "com.tx.aboutimage";
  public static final String d = "https://fwd.3g.qq.com:8080/forward.jsp?bid=943";
  public static final String e = "com.tx.abouthelp";
  public static final String f = "https://fwd.3g.qq.com:8080/forward.jsp?bid=941";
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private Hashtable jdField_a_of_type_JavaUtilHashtable;
  private List jdField_a_of_type_JavaUtilList;
  private ServerConfigObserver jdField_a_of_type_MqqObserverServerConfigObserver = new hxf(this);
  ...
  private Hashtable a()
  {
    ...
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131367885);
    ...
    localResourcePluginInfo.strGotoUrl = "https://fwd.3g.qq.com:8080/forward.jsp?bid=942";
    ...
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131367886);
    localResourcePluginInfo.strResURL = "";
    localResourcePluginInfo.sResSubType = 2;
    localResourcePluginInfo.cCanChangeState = 0;
    localResourcePluginInfo.cDefaultState = 0;
    ...
    localResourcePluginInfo.sLanType = 1;
    localResourcePluginInfo.uiResId = 0L;
    localResourcePluginInfo.strGotoUrl = "https://fwd.3g.qq.com:8080/forward.jsp?bid=943";
    localResourcePluginInfo.iPluginType = 32;
    localHashtable.put(localResourcePluginInfo.strPkgName, localResourcePluginInfo);
    localResourcePluginInfo = new ResourcePluginInfo();
    localResourcePluginInfo.strPkgName = "com.tx.abouthelp";
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131367887);
    ...
    localResourcePluginInfo.uiResId = 0L;
    localResourcePluginInfo.strGotoUrl = "https://fwd.3g.qq.com:8080/forward.jsp?bid=941";
    localResourcePluginInfo.iPluginType = 32;
    localHashtable.put(localResourcePluginInfo.strPkgName, localResourcePluginInfo);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, ResourcePluginInfo paramResourcePluginInfo)
  {
    ...
    Object localObject2 = "&version=5.9.3.3468&appid=" + AppSetting.a + "&QUA=" + QZoneHelper.a() + "&sid=" + paramQQAppInterface.getSid();
    Object localObject1 = localObject2;
    if (paramResourcePluginInfo.strPkgName.equals("com.tx.abouthelp")) {
      localObject1 = (String)localObject2 + "&adtag=3468";
    }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramResourcePluginInfo.isNew == 0)
          {
            ...
            ThreadManager.b(new hxg(localAboutConfig, paramResourcePluginInfo));
          }
          return;
          localObject1 = "";
          break;
  ...
  public void a(ResourcePluginInfo paramResourcePluginInfo)
  {
    ...
    //   19: invokevirtual 397	java/util/Hashtable:containsKey	(Ljava/lang/Object;)Z
    //   22: ifeq +58 -> 80
    //   25: aload_0
    ...
    //   33: invokevirtual 321	java/util/Hashtable:get	(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   60: invokevirtual 400	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/persistence/EntityManagerFactory;
    //   63: invokevirtual 406	com/tencent/mobileqq/persistence/EntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   66: astore_1
    //   67: aload_1
    //   68: aload_2
    //   69: invokestatic 410	com/tencent/mobileqq/data/ResourcePluginInfo:persistOrReplace	(Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/data/ResourcePluginInfo;)V
    //   72: aload_1
    //   73: ifnull +7 -> 80
    //   76: aload_1
    //   77: invokevirtual 414	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   80: return
    //   81: astore_2
    //   82: aload_1
    //   83: ifnull -3 -> 80
    //   86: aload_1
    //   87: invokevirtual 414	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   90: return
    //   91: astore_2
    //   92: aload_1
    //   93: ifnull +7 -> 100
    //   96: aload_1
    //   97: invokevirtual 414	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   100: aload_2
    //   101: athrow
