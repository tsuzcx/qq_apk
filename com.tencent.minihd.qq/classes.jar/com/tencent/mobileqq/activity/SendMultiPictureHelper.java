...
public class SendMultiPictureHelper
{
  ...
  DialogInterface.OnClickListener jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new ezq(this);
  public Bundle a;
  protected SendMultiPictureHelper.SendingFileInfo a;
  public BaseActivity a;
  public QQAppInterface a;
  public FMObserver a;
  private TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new ezo(this);
  ...
  DialogInterface.OnClickListener jdField_b_of_type_AndroidContentDialogInterface$OnClickListener = new ezr(this);
  protected String b;
  public boolean b;
  public int c;
  ...
  public SendMultiPictureHelper(BaseActivity paramBaseActivity)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppFMObserver = new ezp(this);
    this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener = new ezs(this);
    ...
    this.f = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131368520);
  }
  ...
  public void a()
  {
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilArrayList)
      {
        ...
        if (((File)localObject2).length() == 0L)
        {
          if (this.jdField_c_of_type_Int == 0) {
            Toast.makeText(BaseApplicationImpl.a(), this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131368629), 0).show();
          }
        }
        else
        {
      ...
      Toast.makeText(BaseApplicationImpl.a(), this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131368631), 0).show();
      continue;
      label261:
  ...
  public void a(String paramString1, String paramString2, int paramInt1, String paramString3, int paramInt2, Bundle paramBundle, ArrayList paramArrayList)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230, this.e, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131368523), null, this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentBroadcastReceiver == null) {
        this.jdField_a_of_type_AndroidContentBroadcastReceiver = new ezt(this);
      }
  ...
  public void b()
  {
    Object localObject = "";
    if (this.jdField_d_of_type_Int == 1) {
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131368521);
    }
    for (;;)
    {
      localObject = DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131367300), (String)localObject, 2131368634, 2131365733, this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener, this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener);
      ((QQCustomDialog)localObject).setCancelable(false);
      ((QQCustomDialog)localObject).show();
      return;
      if (this.jdField_d_of_type_Int == 0) {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131368522);
      }
    }
  }
