...
import mqq.app.Window4FragmentTitle;
  ...
  implements IDragView.OnChangeModeListener
{
  ...
  private static final int[] jdField_a_of_type_ArrayOfInt = { 2130839036, 2130839037, 2130839038, 2130839039, 2130839040 };
  ...
  private gvs jdField_a_of_type_Gvs;
  private gvt jdField_a_of_type_Gvt;
  private gvu jdField_a_of_type_Gvu;
  ...
  public static DragFrameLayout a(Activity paramActivity)
  {
    ...
    if (((paramActivity.getWindow() instanceof Window4FragmentTitle)) && (localViewGroup.getChildCount() >= 2))
    {
      i1 = 1;
      if (i1 == 0) {
        break label70;
    ...
    label75:
    paramActivity = new DragFrameLayout(paramActivity.getApplicationContext());
    localViewGroup.addView(paramActivity, localView.getLayoutParams());
    localViewGroup.removeView(localView);
    paramActivity.addView(localView, paramActivity.generateDefaultLayoutParams());
  ...
  private void a(Canvas paramCanvas)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Gvu == null);
        localObject = this.jdField_a_of_type_Gvu.a();
        ...
        this.jdField_a_of_type_AndroidGraphicsPaint.setColor(-16711936);
        paramCanvas.drawBitmap(this.b, this.jdField_a_of_type_AndroidGraphicsPointF.x - this.jdField_a_of_type_AndroidGraphicsRect.width() / 2.0F, this.jdField_a_of_type_AndroidGraphicsPointF.y - this.jdField_a_of_type_AndroidGraphicsRect.height() / 2.0F, this.jdField_a_of_type_AndroidGraphicsPaint);
        postDelayed(this.jdField_a_of_type_Gvu, 60L);
        return;
        if (this.k == 2)
        {
          paramCanvas.drawBitmap(this.b, this.jdField_a_of_type_AndroidGraphicsPointF.x - this.jdField_a_of_type_AndroidGraphicsRect.width() / 2.0F, this.jdField_a_of_type_AndroidGraphicsPointF.y - this.jdField_a_of_type_AndroidGraphicsRect.height() / 2.0F, this.jdField_a_of_type_AndroidGraphicsPaint);
      ...
      } while (this.jdField_a_of_type_Gvt == null);
      localObject = this.jdField_a_of_type_Gvt.a();
      if (localObject != null) {
      ...
      postDelayed(this.jdField_a_of_type_Gvt, 50L);
      return;
    } while ((this.k != 5) || (this.jdField_a_of_type_Gvs == null));
    Object localObject = this.jdField_a_of_type_Gvs.a();
    Bitmap localBitmap = this.jdField_a_of_type_Gvs.a();
    ...
    postDelayed(this.jdField_a_of_type_Gvs, 40L);
  }
  ...
  public void a()
  {
    if (this.k != -1)
    {
      if (this.jdField_a_of_type_Gvu != null)
      {
        getHandler().removeCallbacks(this.jdField_a_of_type_Gvu);
        this.jdField_a_of_type_Gvu = null;
      }
      if (this.jdField_a_of_type_Gvt != null)
      {
        getHandler().removeCallbacks(this.jdField_a_of_type_Gvt);
        this.jdField_a_of_type_Gvt = null;
      }
      if (this.jdField_a_of_type_Gvs != null)
      {
        getHandler().removeCallbacks(this.jdField_a_of_type_Gvs);
        this.jdField_a_of_type_Gvs = null;
      }
      this.k = -1;
      a(false);
      this.b = null;
          ...
          do
          {
            do
            {
              ...
              if (this.k == 1)
              {
                ...
                this.jdField_a_of_type_Gvu = new gvu(this, new PointF(this.jdField_a_of_type_AndroidGraphicsRect.centerX(), this.jdField_a_of_type_AndroidGraphicsRect.centerY()), paramMotionEvent);
                invalidate();
                return true;
              }
              bool1 = bool2;
            ...
            if (this.k == 2)
            {
              ...
              for (;;)
              {
                ...
                this.k = 4;
                this.jdField_a_of_type_AndroidGraphicsPointF.set(f1, f2);
                this.jdField_a_of_type_Gvt = new gvt(this, this.jdField_a_of_type_AndroidGraphicsPointF);
              }
            }
            bool1 = bool2;
          } while (this.k != 4);
