  ...
  extends RecentUserBaseData
{
  ...
  {
    paramQQAppInterface = paramQQAppInterface.a().a().a(AppConstants.ab, 4000);
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaLangString = paramContext.getString(this.J);
    if (localNewFriendMessage == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("RecentItemNewFriendMsgData", 2, "isFirstShow = " + this.jdField_b_of_type_Boolean);
      }
      if ((this.jdField_b_of_type_Boolean) && (a().msg == null))
      {
    ...
    for (paramQQAppInterface = localNewFriendMessage.jdField_a_of_type_JavaLangString;; paramQQAppInterface = this.jdField_b_of_type_JavaLangCharSequence)
    {
      ...
      this.B = localNewFriendManager.a();
