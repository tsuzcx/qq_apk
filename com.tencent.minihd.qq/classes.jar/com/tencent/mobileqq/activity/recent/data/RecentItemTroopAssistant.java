  ...
  extends RecentUserBaseData
{
  ...
  public void a(Context paramContext)
  {
    if (this.B > 0)
    {
      this.jdField_c_of_type_JavaLangCharSequence = String.format(paramContext.getString(2131368989), new Object[] { Integer.valueOf(this.B) });
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_JavaLangString = paramContext.getString(2131367701);
    }
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        this.B = localTroopAssistantManager.a(localQQMessageFacade);
        ...
        if ((TextUtils.isEmpty(localMsgSummary.jdField_b_of_type_JavaLangCharSequence)) && (TextUtils.isEmpty(localMsgSummary.jdField_c_of_type_JavaLangCharSequence)))
        {
          ...
          localMsgSummary.jdField_b_of_type_JavaLangCharSequence = paramContext.getString(2131367702);
        }
        i = this.G & 0xFFFFFF0F;
      ...
      label340:
      label348:
      for (this.jdField_c_of_type_JavaLangString = String.format("进入群助手界面，有%d个群有新消息。", new Object[] { Integer.valueOf(this.B) });; this.jdField_c_of_type_JavaLangString = "进入群助手界面，无新消息。")
      {
