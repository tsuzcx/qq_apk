  ...
  implements BaseSystemMsgInterface, FaceDecoder.DecodeTaskCompletionListener, SlideDetectListView.OnScrollToTopListener, SlideDetectListView.OnSlideListener, Observer
{
  ...
  public Handler a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new git(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new gio(this);
  private SystemMsgListAdapter jdField_a_of_type_ComTencentMobileqqAdapterSystemMsgListAdapter;
  FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new giw(this);
  MessageObserver jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new giy(this);
  TroopObserver jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new gix(this);
  private FaceDecoder jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder;
  public QQProgressDialog a;
  private SlideDetectListView.OnScrollToTopListener jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView$OnScrollToTopListener = new gip(this);
  private SlideDetectListView jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView;
  private List jdField_a_of_type_JavaUtilList = new ArrayList();
  public final long b;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new giu(this);
  private boolean jdField_b_of_type_Boolean = true;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new giv(this);
  ...
  public SystemMsgListView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new gin(this);
  ...
  private static void c(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null) {
      paramQQAppInterface.a(new giq(paramQQAppInterface));
    }
    if (QLog.isColorLevel()) {
  ...
  {
    a(2130904038);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView = ((SlideDetectListView)findViewById(2131300609));
    this.jdField_d_of_type_AndroidViewView = findViewById(2131300610);
    this.jdField_e_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130904039, null);
  ...
  private void p()
  {
    ...
    this.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(AppConstants.aj, 0);
    if (this.jdField_a_of_type_ComTencentMobileqqAdapterSystemMsgListAdapter != null)
    {
      ...
      localView.setLayoutParams(new AbsListView.LayoutParams(-1, AIOUtils.a(32.0F, getResources())));
      this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.a(localView, null, false);
  ...
  private void q()
  {
    if (this.jdField_f_of_type_AndroidViewView == null) {
      this.jdField_f_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130904036, null);
    }
    if (this.jdField_f_of_type_AndroidViewView.getParent() == null) {
      this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.b(this.jdField_f_of_type_AndroidViewView);
    }
  ...
  public void a(SystemMsgListAdapter.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    if ((paramViewHolder.jdField_b_of_type_JavaLangString != null) && (!paramViewHolder.jdField_b_of_type_JavaLangString.equals("")))
    {
      ...
      paramViewHolder.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131365888) + " " + paramViewHolder.jdField_d_of_type_JavaLangString);
  ...
  protected void e()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqAdapterSystemMsgListAdapter != null) && (this.jdField_a_of_type_ComTencentMobileqqAdapterSystemMsgListAdapter.getCount() > 0))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new gir(this));
  ...
  protected void h()
  {
    super.h();
    n();
    if ((!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getSharedPreferences(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), 0).getBoolean("newfriend_sysmsg_game_add_friends_tips", true)) && (this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.m() > 0)) {
  ...
  public void l()
  {
    ...
    localIntent.putExtra("title", this.jdField_a_of_type_AndroidContentContext.getString(2131369106));
    a(localIntent.putExtra("url", "https://ti.qq.com/friendship_auth/index.html?_wv=3&_bid=173#p1"));
  }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new gis(this));
  }
}
