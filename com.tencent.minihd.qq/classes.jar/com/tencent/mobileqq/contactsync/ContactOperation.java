...
public class ContactOperation
{
  ...
  public ContactOperation c(String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidContentContentValues.put("data1", paramString);
    this.jdField_a_of_type_AndroidContentContentValues.put("data2", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131369281));
    this.jdField_a_of_type_AndroidContentContentValues.put("data3", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131369282));
    a();
    return this;
  }
