...
public class NativeConfigStore
{
  ...
  public String[] n_getConfigList(String paramString)
  {
    ...
    //   6: invokevirtual 88	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   9: ifne +21 -> 30
    //   12: getstatic 20	com/tencent/msf/boot/config/NativeConfigStore:tag	Ljava/lang/String;
    //   15: iconst_1
    //   16: ldc 130
    //   18: invokestatic 133	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   21: iconst_0
    //   22: anewarray 106	java/lang/String
    //   25: astore_1
    //   26: aload_0
    //   27: monitorexit
    //   28: aload_1
    ...
    //   30: aload_0
    //   31: aload_1
    //   32: invokevirtual 135	com/tencent/msf/boot/config/NativeConfigStore:getConfigList	(Ljava/lang/String;)[Ljava/lang/String;
    //   35: astore_1
    //   36: goto -10 -> 26
    //   39: astore_1
    //   40: aload_0
  ...
  public void n_removeConfig(String paramString)
  {
    ...
    //   24: aload_0
    //   25: aload_1
    //   26: invokevirtual 140	com/tencent/msf/boot/config/NativeConfigStore:removeConfig	(Ljava/lang/String;)V
    //   29: goto -8 -> 21
    //   32: astore_1
    //   33: aload_0
    //   34: monitorexit
  ...
  public void n_setConfig(String paramString1, String paramString2)
  {
    ...
    //   25: aload_1
    //   26: aload_2
    //   27: invokevirtual 145	com/tencent/msf/boot/config/NativeConfigStore:setConfig	(Ljava/lang/String;Ljava/lang/String;)V
    //   30: goto -9 -> 21
    //   33: astore_1
    //   34: aload_0
    //   35: monitorexit
