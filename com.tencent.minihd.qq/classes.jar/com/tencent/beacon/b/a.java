...
public class a
{
  ...
  public static com.tencent.beacon.c.a.b a(int paramInt1, com.tencent.beacon.a.e parame, byte[] paramArrayOfByte, int paramInt2, int paramInt3)
  {
    ...
    //   198: aload 7
    //   200: invokevirtual 453	com/tencent/beacon/event/d:c	()Ljava/lang/String;
    ...
    //   227: aload 7
    //   229: invokevirtual 456	com/tencent/beacon/event/d:b	()Ljava/lang/String;
    ...
    //   256: aload 7
    //   258: invokevirtual 459	com/tencent/beacon/event/d:d	()Ljava/lang/String;
    ...
    //   343: aload 7
    //   345: invokevirtual 465	com/tencent/beacon/event/d:e	()Ljava/lang/String;
  ...
  public static String a(Context paramContext, int paramInt)
  {
    try
    {
      ...
      paramContext = d(paramContext + "_" + (String)localObject + "_" + new Date().getTime() + "_" + paramInt);
      return paramContext;
    }
    catch (Exception paramContext) {}
    return null;
  ...
  public static ArrayList<String> a(String[] paramArrayOfString)
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: new 536	java/util/ArrayList
    //   5: dup
    //   6: invokespecial 537	java/util/ArrayList:<init>	()V
    //   9: astore 4
    //   11: invokestatic 543	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   14: aload_0
    //   15: invokevirtual 547	java/lang/Runtime:exec	([Ljava/lang/String;)Ljava/lang/Process;
    //   18: astore_0
    //   19: new 549	java/io/BufferedReader
    //   22: dup
    //   23: new 551	java/io/InputStreamReader
    //   26: dup
    //   27: aload_0
    //   28: invokevirtual 554	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   31: invokespecial 555	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   34: invokespecial 558	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   37: astore_1
    //   38: aload_1
    //   39: invokevirtual 561	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   42: astore_2
    //   43: aload_2
    //   44: ifnull +44 -> 88
    //   47: aload 4
    //   49: aload_2
    //   50: invokevirtual 564	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   53: pop
    //   54: goto -16 -> 38
    //   57: astore 4
    //   59: aconst_null
    ...
    //   71: ifnull +7 -> 78
    //   74: aload_1
    //   75: invokevirtual 565	java/io/BufferedReader:close	()V
    //   78: aload_0
    //   79: ifnull +7 -> 86
    //   82: aload_0
    //   83: invokevirtual 565	java/io/BufferedReader:close	()V
    //   86: aconst_null
    //   87: areturn
    //   88: new 549	java/io/BufferedReader
    //   91: dup
    //   92: new 551	java/io/InputStreamReader
    //   95: dup
    //   96: aload_0
    //   97: invokevirtual 568	java/lang/Process:getErrorStream	()Ljava/io/InputStream;
    //   100: invokespecial 555	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   103: invokespecial 558	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   106: astore_0
    //   107: aload_0
    //   108: astore_3
    //   109: aload_1
    //   110: astore_2
    //   111: aload_0
    //   112: invokevirtual 561	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   115: astore 5
    //   117: aload 5
    //   119: ifnull +23 -> 142
    //   122: aload_0
    ...
    //   126: aload 4
    //   128: aload 5
    //   130: invokevirtual 564	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   133: pop
    //   134: goto -27 -> 107
    //   137: astore 4
    //   139: goto -78 -> 61
    //   142: aload_1
    //   143: invokevirtual 565	java/io/BufferedReader:close	()V
    //   146: aload_0
    //   147: invokevirtual 565	java/io/BufferedReader:close	()V
    //   150: aload 4
    //   152: areturn
    //   153: astore_0
    //   154: aload_0
    ...
    //   189: ifnull +7 -> 196
    //   192: aload_1
    //   193: invokevirtual 565	java/io/BufferedReader:close	()V
    //   196: aload_3
    //   197: ifnull +7 -> 204
    //   200: aload_3
    //   201: invokevirtual 565	java/io/BufferedReader:close	()V
    //   204: aload_0
    //   205: athrow
    //   206: astore_1
    //   207: aload_1
  ...
  public static byte[] a(Object paramObject)
  {
    ...
    //   14: ldc_w 598
    //   17: aload_0
    //   18: invokevirtual 603	java/lang/Class:isInstance	(Ljava/lang/Object;)Z
    //   21: ifne +15 -> 36
    //   24: ldc_w 605
    //   27: iconst_0
    //   28: anewarray 4	java/lang/Object
    //   31: invokestatic 607	com/tencent/beacon/d/a:c	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   34: aconst_null
    //   35: areturn
    //   36: new 609	java/io/ByteArrayOutputStream
    //   39: dup
    //   40: invokespecial 610	java/io/ByteArrayOutputStream:<init>	()V
    //   43: astore 4
    //   45: new 612	java/io/ObjectOutputStream
    //   48: dup
    //   49: aload 4
    //   51: invokespecial 615	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   54: astore_2
    //   55: aload_2
    //   56: astore_1
    //   57: aload_2
    //   58: aload_0
    //   59: invokevirtual 619	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   62: aload_2
    //   63: astore_1
    //   64: aload_2
    //   65: invokevirtual 620	java/io/ObjectOutputStream:flush	()V
    //   68: aload_2
    //   69: astore_1
    //   70: aload 4
    //   72: invokevirtual 623	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   75: astore_0
    //   76: aload_2
    //   77: invokevirtual 624	java/io/ObjectOutputStream:close	()V
    //   80: aload 4
    //   82: invokevirtual 625	java/io/ByteArrayOutputStream:close	()V
    //   85: aload_0
    //   86: areturn
    //   87: astore_1
    //   88: aload_1
    ...
    //   125: ifnull +7 -> 132
    //   128: aload_0
    //   129: invokevirtual 624	java/io/ObjectOutputStream:close	()V
    //   132: aload 4
    //   134: invokevirtual 625	java/io/ByteArrayOutputStream:close	()V
    //   137: aconst_null
    //   138: areturn
    //   139: astore_0
    //   140: aload_0
    ...
    //   158: ifnull +7 -> 165
    //   161: aload_1
    //   162: invokevirtual 624	java/io/ObjectOutputStream:close	()V
    //   165: aload 4
    //   167: invokevirtual 625	java/io/ByteArrayOutputStream:close	()V
    //   170: aload_0
    //   171: athrow
    //   172: astore_1
    //   173: aload_1
