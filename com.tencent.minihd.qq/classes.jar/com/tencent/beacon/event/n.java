  ...
  implements com.tencent.beacon.a.b.b, com.tencent.beacon.a.b.f, com.tencent.beacon.a.b.g
{
  ...
  protected static boolean a(String paramString, boolean paramBoolean1, long paramLong1, long paramLong2, boolean paramBoolean2, c... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean2) {}
      for (localObject = ((n)localObject).m(); localObject != null; localObject = ((n)localObject).l()) {
  ...
  private static boolean k()
  {
    ...
    boolean bool2 = ((n)localObject).g();
    boolean bool1 = bool2;
    if (bool2)
    {
      bool1 = bool2;
      if (((n)localObject).n()) {
        bool1 = ((n)localObject).o();
      }
    }
    if (bool1)
    {
  ...
  public final void b()
  {
    ...
    for (;;)
    {
      ...
      if ((j() < 2) && (com.tencent.beacon.upload.h.a(this.b).b()) && (i.a(this.b).a("sig_1")))
      {
        ...
        if ((this.d.i()) || (this.d.p()))
        {
          ...
          if ((m > 0) && (n > 0))
          {
            localObject = new com.tencent.beacon.a.c(this.b, m, n, new m(this.b), this.d.i(), this.d.p(), this.d.o());
