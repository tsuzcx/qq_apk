...
public final class a
{
  ...
  public static String b(Context paramContext)
  {
    ...
    //   18: astore 4
    //   20: aload_0
    //   21: invokevirtual 134	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   24: astore 6
    //   26: aload_0
    //   27: ldc 105
    //   29: iconst_0
    //   30: invokevirtual 109	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   33: ldc 117
    //   35: ldc 23
    ...
    //   47: aload 5
    //   49: ldc 23
    //   51: invokevirtual 142	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   54: ifeq +33 -> 87
    //   57: ldc 144
    //   59: astore_2
    //   60: aload_0
    //   61: ldc 105
    //   63: iconst_0
    //   64: invokevirtual 109	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   67: invokeinterface 115 1 0
    //   72: ldc 117
    //   74: ldc 144
    //   76: invokeinterface 123 3 0
    //   81: invokeinterface 127 1 0
    //   86: pop
    //   87: new 31	java/lang/StringBuilder
    //   90: dup
    //   91: ldc 146
    //   93: invokespecial 149	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   96: aload_2
    ...
    //   107: invokestatic 151	com/tencent/beacon/d/a:a	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   110: aload_2
    //   111: ldc 23
    //   113: invokevirtual 142	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   116: ifne +301 -> 417
    //   119: aload 6
    //   121: aload_2
    //   122: invokevirtual 157	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   125: astore_2
    //   126: new 159	java/util/Properties
    //   129: dup
    //   130: invokespecial 160	java/util/Properties:<init>	()V
    //   133: astore_3
    //   134: aload_3
    //   135: aload_2
    //   136: invokevirtual 164	java/util/Properties:load	(Ljava/io/InputStream;)V
    //   139: aload_3
    //   140: ldc 166
    //   142: ldc 23
    //   144: invokevirtual 169	java/util/Properties:getProperty	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   147: astore_3
    //   148: new 31	java/lang/StringBuilder
    //   151: dup
    //   152: ldc 171
    //   154: invokespecial 149	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   157: aload_3
    ...
    //   168: invokestatic 151	com/tencent/beacon/d/a:a	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   171: ldc 23
    //   173: aload_3
    //   174: invokevirtual 142	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   177: istore_1
    //   178: iload_1
    //   179: ifne +34 -> 213
    //   182: aload_3
    ...
    //   185: ifnull -175 -> 10
    //   188: aload_2
    //   189: invokevirtual 176	java/io/InputStream:close	()V
    //   192: aload_3
    //   193: astore_0
    //   194: goto -184 -> 10
    //   197: astore_0
    //   198: aload_0
    //   199: invokevirtual 179	java/io/IOException:printStackTrace	()V
    //   202: aload_3
    //   203: astore_0
    //   204: goto -194 -> 10
    //   207: astore_0
    ...
    //   225: ifnull +186 -> 411
    //   228: aload_3
    //   229: invokevirtual 176	java/io/InputStream:close	()V
    //   232: aload_0
    //   233: invokevirtual 65	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   236: aload_0
    //   237: invokevirtual 68	android/content/Context:getPackageName	()Ljava/lang/String;
    //   240: sipush 128
    //   243: invokevirtual 74	android/content/pm/PackageManager:getApplicationInfo	(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    //   246: getfield 80	android/content/pm/ApplicationInfo:metaData	Landroid/os/Bundle;
    //   249: ldc 181
    //   251: invokevirtual 88	android/os/Bundle:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   254: astore_3
    //   255: aload_2
    //   256: astore_0
    //   257: aload_3
    //   258: ifnull -248 -> 10
    //   261: aload_3
    //   262: invokevirtual 89	java/lang/Object:toString	()Ljava/lang/String;
    //   265: astore_0
    //   266: goto -256 -> 10
    //   269: astore_3
    //   270: aload_3
    //   271: invokevirtual 179	java/io/IOException:printStackTrace	()V
    //   274: goto -42 -> 232
    //   277: astore_2
    //   278: ldc 23
    //   280: astore_2
    ...
    //   282: ldc 105
    //   284: iconst_0
    //   285: invokevirtual 109	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   288: invokeinterface 115 1 0
    //   293: ldc 117
    //   295: ldc 23
    //   297: invokeinterface 123 3 0
    //   302: invokeinterface 127 1 0
    //   307: pop
    //   308: ldc 183
    //   310: iconst_0
    //   311: anewarray 4	java/lang/Object
    //   314: invokestatic 185	com/tencent/beacon/d/a:c	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   317: aload_2
    //   318: astore 4
    //   320: aload_3
    //   321: ifnull +90 -> 411
    //   324: aload_3
    //   325: invokevirtual 176	java/io/InputStream:close	()V
    //   328: goto -96 -> 232
    //   331: astore_3
    //   332: aload_3
    //   333: invokevirtual 179	java/io/IOException:printStackTrace	()V
    //   336: goto -104 -> 232
    //   339: astore_0
    //   340: aconst_null
    //   341: astore_2
    ...
    //   343: ifnull +7 -> 350
    //   346: aload_2
    //   347: invokevirtual 176	java/io/InputStream:close	()V
    //   350: aload_0
    //   351: athrow
    //   352: astore_2
    //   353: aload_2
    //   354: invokevirtual 179	java/io/IOException:printStackTrace	()V
    //   357: goto -7 -> 350
    //   360: astore_0
    //   361: ldc 187
    //   363: iconst_0
    //   364: anewarray 4	java/lang/Object
    //   367: invokestatic 151	com/tencent/beacon/d/a:a	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   370: aload_2
    //   371: astore_0
    //   372: goto -362 -> 10
    //   375: astore_0
