  ...
  implements Drawable.Callback, Runnable, URLState.Callback
{
  ...
  static final String TAG_AUTOTEST = "URLDrawable_AutoTest";
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          {
            return;
          } while (!RegionDrawable.class.isInstance(this.mCurrDrawable));
      ...
      if (QLog.isColorLevel()) {
        QLog.d("URLDrawable_AutoTest", 2, "url=" + getURL().toString() + " size exceed " + str2 + " " + str3);
      }
    } while (sDebugCallback == null);
    String str1 = "";
  ...
  public static URLDrawable getDrawable(java.io.File paramFile, URLDrawableOptions paramURLDrawableOptions)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 346	java/io/File:toURL	()Ljava/net/URL;
    //   4: astore_0
    //   5: aload_0
    //   6: ifnull +33 -> 39
    //   9: aload_0
    //   10: aload_1
    //   11: invokestatic 349	com/tencent/image/URLDrawable:getDrawable	(Ljava/net/URL;Lcom/tencent/image/URLDrawable$URLDrawableOptions;)Lcom/tencent/image/URLDrawable;
    //   14: areturn
    //   15: astore_0
    //   16: iconst_0
    //   17: ifeq +22 -> 39
    //   20: aconst_null
    //   21: aload_1
    //   22: invokestatic 349	com/tencent/image/URLDrawable:getDrawable	(Ljava/net/URL;Lcom/tencent/image/URLDrawable$URLDrawableOptions;)Lcom/tencent/image/URLDrawable;
    //   25: areturn
    //   26: astore_0
    //   27: iconst_0
    //   28: ifeq +9 -> 37
    //   31: aconst_null
    //   32: aload_1
    //   33: invokestatic 349	com/tencent/image/URLDrawable:getDrawable	(Ljava/net/URL;Lcom/tencent/image/URLDrawable$URLDrawableOptions;)Lcom/tencent/image/URLDrawable;
    //   36: areturn
    //   37: aload_0
    //   38: athrow
    //   39: aconst_null
  ...
  public static URLDrawable getDrawable(URL paramURL, URLDrawableOptions paramURLDrawableOptions)
  {
    ...
    try
    {
      ...
      localURLState = URLState.getConstants(paramURL.toString());
      if (localURLState == null) {
        break label360;
      }
      paramURLDrawableOptions = (URLDrawable)localURLState.newDrawable(null);
      ...
      for (;;)
      {
        if ((DEBUG) && (QLog.isColorLevel()))
        {
          localObject = new IllegalStateException("UrlDrawable getStack");
          paramURLDrawableOptions.mCallStack = getMinimumStackInfo((IllegalStateException)localObject);
          QLog.d("URLDrawable_AutoTest", 2, "url=" + paramURL.toString(), (Throwable)localObject);
        }
        ...
        if ((paramURLDrawableOptions.mCurrDrawable instanceof ApngDrawable)) {
          ((ApngDrawable)paramURLDrawableOptions.mCurrDrawable).mUseAnimation = localURLDrawableOptions.mPlayGifImage;
        }
      }
    ...
    if (i == 2)
    {
      localObject = sDefaultDrawableParms.getDefualtFailedDrawable();
      if ((localURLDrawableOptions.mFailedDrawable == null) && (localObject != null)) {}
      for (;;)
      {
        paramURLDrawableOptions.mFailedDrawable = ((Drawable)localObject);
        paramURLDrawableOptions.mCurrDrawable = paramURLDrawableOptions.mFailedDrawable;
        break;
        localObject = localURLDrawableOptions.mFailedDrawable;
      }
    }
    paramURLDrawableOptions.mFailedDrawable = localURLDrawableOptions.mFailedDrawable;
    Object localObject = sDefaultDrawableParms.getDefaultLoadingDrawable();
    if ((localURLDrawableOptions.mLoadingDrawable == null) && (localObject != null)) {}
    for (;;)
    {
      paramURLDrawableOptions.mProgressDrawable = ((Drawable)localObject);
      paramURLDrawableOptions.mCurrDrawable = paramURLDrawableOptions.mProgressDrawable;
      if (i != 4) {
        break;
      }
      localObject = localURLState.mParams;
      if (localURLDrawableOptions.mRequestWidth == 0) {
        break;
      }
      i = localURLDrawableOptions.mRequestHeight;
      break;
      localObject = localURLDrawableOptions.mLoadingDrawable;
    }
    label360:
  ...
  private static String getMinimumStackInfo(IllegalStateException paramIllegalStateException)
  {
    if (paramIllegalStateException == null) {
      return "";
    }
    StringBuffer localStringBuffer = new StringBuffer();
    paramIllegalStateException = paramIllegalStateException.getStackTrace();
    int j = 0;
    int m = paramIllegalStateException.length;
    int i = 0;
    if (i >= m) {
      label36:
      return localStringBuffer.toString();
    }
    Object localObject = paramIllegalStateException[i];
    ...
    for (;;)
    {
      ...
      localStringBuffer.append(localObject.getFileName());
      localStringBuffer.append(":");
      localStringBuffer.append(localObject.getLineNumber());
      localStringBuffer.append("\n");
    }
  }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    {
      if ((DEBUG) && (Build.VERSION.SDK_INT >= 11)) {
        checkBitmapSize();
      }
      i = paramCanvas.save();
