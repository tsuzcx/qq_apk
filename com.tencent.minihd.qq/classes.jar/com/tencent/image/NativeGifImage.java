  ...
  extends AbstractGifImage
{
  ...
  protected void applyNextFrame()
  {
    ...
    //   10: iaload
    //   11: putfield 291	com/tencent/image/NativeGifImage:mCurrentFrameIndex	I
    //   14: aload_0
    //   15: aload_0
    ...
    //   22: iaload
    //   23: putfield 293	com/tencent/image/NativeGifImage:mCurrentLoop	I
    //   26: aload_0
    //   27: getfield 234	com/tencent/image/NativeGifImage:mCurrentFrameBitmapBuffer	Landroid/graphics/Bitmap;
    //   30: ifnull +114 -> 144
    //   33: new 295	android/graphics/Canvas
    //   36: dup
    //   37: aload_0
    //   38: getfield 169	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   41: invokespecial 298	android/graphics/Canvas:<init>	(Landroid/graphics/Bitmap;)V
    //   44: astore_3
    //   45: aload_0
    //   46: getfield 169	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   49: iconst_0
    //   50: invokevirtual 301	android/graphics/Bitmap:eraseColor	(I)V
    //   53: aconst_null
    //   54: astore_2
    //   55: aload_0
    //   56: getfield 177	com/tencent/image/NativeGifImage:mDefaultRoundCorner	F
    //   59: fconst_0
    //   60: fcmpl
    //   61: ifle +69 -> 130
    //   64: new 303	android/graphics/Paint
    //   67: dup
    //   68: invokespecial 304	android/graphics/Paint:<init>	()V
    //   71: astore_2
    //   72: aload_2
    //   73: iconst_1
    //   74: invokevirtual 307	android/graphics/Paint:setAntiAlias	(Z)V
    //   77: aload_3
    //   78: new 309	android/graphics/RectF
    //   81: dup
    //   82: fconst_0
    //   83: fconst_0
    //   84: aload_0
    //   85: getfield 169	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   88: invokevirtual 312	android/graphics/Bitmap:getWidth	()I
    //   91: i2f
    //   92: aload_0
    //   93: getfield 169	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   96: invokevirtual 315	android/graphics/Bitmap:getHeight	()I
    //   99: i2f
    //   100: invokespecial 318	android/graphics/RectF:<init>	(FFFF)V
    //   103: aload_0
    //   104: getfield 177	com/tencent/image/NativeGifImage:mDefaultRoundCorner	F
    //   107: aload_0
    //   108: getfield 177	com/tencent/image/NativeGifImage:mDefaultRoundCorner	F
    //   111: aload_2
    //   112: invokevirtual 322	android/graphics/Canvas:drawRoundRect	(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    //   115: aload_2
    //   116: new 324	android/graphics/PorterDuffXfermode
    //   119: dup
    //   120: getstatic 330	android/graphics/PorterDuff$Mode:SRC_IN	Landroid/graphics/PorterDuff$Mode;
    //   123: invokespecial 333	android/graphics/PorterDuffXfermode:<init>	(Landroid/graphics/PorterDuff$Mode;)V
    //   126: invokevirtual 337	android/graphics/Paint:setXfermode	(Landroid/graphics/Xfermode;)Landroid/graphics/Xfermode;
    //   129: pop
    //   130: aload_3
    //   131: aload_0
    //   132: getfield 234	com/tencent/image/NativeGifImage:mCurrentFrameBitmapBuffer	Landroid/graphics/Bitmap;
    //   135: fconst_0
    //   136: fconst_0
    //   137: aload_2
    //   138: invokevirtual 341	android/graphics/Canvas:drawBitmap	(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    //   141: aload_0
    //   142: monitorexit
    //   143: return
    //   144: aload_0
    //   145: getfield 177	com/tencent/image/NativeGifImage:mDefaultRoundCorner	F
    //   148: fstore_1
    //   149: fload_1
    //   150: fconst_0
    //   151: fcmpl
    ...
    //   156: astore_3
    //   157: aload_0
    //   158: getfield 169	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   161: invokevirtual 312	android/graphics/Bitmap:getWidth	()I
    //   164: aload_0
    //   165: getfield 169	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   168: invokevirtual 315	android/graphics/Bitmap:getHeight	()I
    //   171: aload_0
    //   172: getfield 93	com/tencent/image/NativeGifImage:mCurrentConfig	Landroid/graphics/Bitmap$Config;
    //   175: invokestatic 232	android/graphics/Bitmap:createBitmap	(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    //   178: astore_2
    //   179: aload_2
    //   180: ifnull -39 -> 141
    //   183: new 295	android/graphics/Canvas
    //   186: dup
    //   187: aload_2
    //   188: invokespecial 298	android/graphics/Canvas:<init>	(Landroid/graphics/Bitmap;)V
    //   191: astore_3
    //   192: new 303	android/graphics/Paint
    //   195: dup
    //   196: invokespecial 304	android/graphics/Paint:<init>	()V
    //   199: astore 4
    //   201: aload 4
    //   203: iconst_1
    //   204: invokevirtual 307	android/graphics/Paint:setAntiAlias	(Z)V
    //   207: aload_3
    //   208: new 309	android/graphics/RectF
    //   211: dup
    //   212: fconst_0
    //   213: fconst_0
    //   214: aload_0
    //   215: getfield 169	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   218: invokevirtual 312	android/graphics/Bitmap:getWidth	()I
    //   221: i2f
    //   222: aload_0
    //   223: getfield 169	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   226: invokevirtual 315	android/graphics/Bitmap:getHeight	()I
    //   229: i2f
    //   230: invokespecial 318	android/graphics/RectF:<init>	(FFFF)V
    //   233: aload_0
    //   234: getfield 177	com/tencent/image/NativeGifImage:mDefaultRoundCorner	F
    //   237: aload_0
    //   238: getfield 177	com/tencent/image/NativeGifImage:mDefaultRoundCorner	F
    //   241: aload 4
    //   243: invokevirtual 322	android/graphics/Canvas:drawRoundRect	(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    //   246: aload 4
    //   248: new 324	android/graphics/PorterDuffXfermode
    //   251: dup
    //   252: getstatic 330	android/graphics/PorterDuff$Mode:SRC_IN	Landroid/graphics/PorterDuff$Mode;
    //   255: invokespecial 333	android/graphics/PorterDuffXfermode:<init>	(Landroid/graphics/PorterDuff$Mode;)V
    //   258: invokevirtual 337	android/graphics/Paint:setXfermode	(Landroid/graphics/Xfermode;)Landroid/graphics/Xfermode;
    //   261: pop
    //   262: aload_3
    //   263: aload_0
    //   264: getfield 169	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   267: fconst_0
    //   268: fconst_0
    //   269: aload 4
    //   271: invokevirtual 341	android/graphics/Canvas:drawBitmap	(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    //   274: aload_0
    //   275: aload_2
    //   276: putfield 169	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   279: goto -138 -> 141
    //   282: astore_2
    //   283: aload_0
    //   284: monitorexit
    ...
    //   308: aload_0
    //   309: getfield 169	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   312: invokevirtual 312	android/graphics/Bitmap:getWidth	()I
    //   315: aload_0
    //   316: getfield 169	com/tencent/image/NativeGifImage:mCurrentFrameBitmap	Landroid/graphics/Bitmap;
    //   319: invokevirtual 315	android/graphics/Bitmap:getHeight	()I
    //   322: getstatic 237	android/graphics/Bitmap$Config:ARGB_4444	Landroid/graphics/Bitmap$Config;
    //   325: invokestatic 232	android/graphics/Bitmap:createBitmap	(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    //   328: astore_2
    //   329: goto -150 -> 179
    //   332: astore_2
    //   333: aload_3
    //   334: astore_2
    //   335: invokestatic 122	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   338: ifeq -159 -> 179
    //   341: ldc 24
    //   343: iconst_2
    //   344: ldc_w 343
    //   347: invokestatic 346	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   350: aload_3
    //   351: astore_2
    //   352: goto -173 -> 179
