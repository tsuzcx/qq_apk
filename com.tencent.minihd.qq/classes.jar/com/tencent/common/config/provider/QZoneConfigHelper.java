...
{
  private static final String s = "QZoneConfigHelper";
  private static final String t = " CREATE TABLE IF NOT EXISTS qz_configs (main_key text  NOT NULL,second_key text  NOT NULL,value String,PRIMARY KEY (main_key,second_key))";
  private static final String u = " CREATE TABLE IF NOT EXISTS qz_cookie (name text PRIMARY KEY NOT NULL,cookie text NOT NULL)";
  private static final String v = " CREATE TABLE IF NOT EXISTS qz_check_time (name text PRIMARY KEY NOT NULL,check_time INTEGER NOT NULL)";
  private static final String w = " CREATE TABLE IF NOT EXISTS qz_update (name text PRIMARY KEY NOT NULL,updatelog text NOT NULL)";
  private static final String x = " CREATE TABLE IF NOT EXISTS qz_isp_config (key text PRIMARY KEY NOT NULL,value text)";
  private static final String y = " CREATE TABLE IF NOT EXISTS qz_predownload_config (name text PRIMARY KEY NOT NULL,updatelog text)";
  ...
  public void onCreate(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    paramSQLiteDatabase.execSQL(" CREATE TABLE IF NOT EXISTS qz_predownload_config (name text PRIMARY KEY NOT NULL,updatelog text)");
  }
  ...
  public void onDowngrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    ...
    paramSQLiteDatabase.execSQL("drop table if exists qz_predownload_config");
