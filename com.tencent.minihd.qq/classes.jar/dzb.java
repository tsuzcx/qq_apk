...
public class dzb
  extends Thread
{
  public dzb(ForwardOperations paramForwardOperations, String paramString1, int paramInt, String paramString2) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      if ((i >= 3) || ((this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.c) && (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse != null))) {
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.v != 11) || (ForwardOperations.b(this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations))) {
          break label63;
        }
      }
      label63:
    ...
    if ((!this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.c) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.G)))
    {
      ForwardOperations.b(this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations);
      this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new dzc(this));
      return;
    }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.K != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidOsBundle.putString("share_comment_message", this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.K);
    }
    if (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.w == 5)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = HttpUtil.a(BaseApplication.getContext(), str2, this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.G, 1, localHashMap);
        this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new dzd(this, (HashMap)localObject1));
        return;
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      localObject1 = HttpUtil.a("https://cgi.connect.qq.com/qqconnectopen/upload_share_image", str2, this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.G, null, (Map)localObject3, (Map)localObject2);
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = HttpUtil.a(BaseApplication.getContext(), str2, this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.G, 1, localHashMap);
        this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new dze(this, (HashMap)localObject1));
        return;
      }
