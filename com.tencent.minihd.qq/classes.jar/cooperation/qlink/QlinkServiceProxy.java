...
public class QlinkServiceProxy
{
  ...
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new lyh(this);
  ...
  private void b()
  {
    lyi locallyi = new lyi(this);
    locallyi.setName("handleWaitSendProxyMsgThread");
    locallyi.start();
  }
