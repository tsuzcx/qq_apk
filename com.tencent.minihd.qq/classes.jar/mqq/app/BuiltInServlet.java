  ...
  implements Constants.Action
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    case 1001: 
      ...
      localObject5 = paramFromServiceMsg.getAttribute("resp_login_url");
      localObject3 = "";
      ...
      localObject6 = paramFromServiceMsg.getAttribute("resp_login_lhsig");
      localObject5 = null;
      ...
      if (localObject6 != null)
      {
        ...
        if ((localObject6 instanceof byte[])) {
          localObject3 = (byte[])localObject6;
        }
      }
      ...
      localBundle.putByteArray("lhsig", (byte[])localObject3);
    ...
    case 1037: 
      localObject6 = (String)paramFromServiceMsg.getAttribute("MSF.getKey");
    ...
    for (;;)
    {
      try
      {
        if (localObject6.length > 0)
        {
          ...
          if (i < localObject6.length)
          {
            ...
            if ((localObject1 == null) || (((String)localObject1).length() == 0) || (!((String)localObject1).startsWith("UIN=" + (String)localObject5 + ","))) {
              break label3784;
            }
      ...
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        for (;;)
        {
          ...
          if ((paramFromServiceMsg.getWupBuffer() != null) && (paramFromServiceMsg.getWupBuffer().length > 0))
          {
            ...
            QLog.i("mqq", 1, paramFromServiceMsg.getUin() + ", " + localObject4 + ", " + ((SvcRespRegister)localObject2).timeStamp + ", " + false + ", " + false);
            label2539:
            bool3 = bool1;
            bool4 = bool2;
            l1 = l2;
          ...
          for (bool2 = true;; bool2 = false)
          {
            ...
            l1 = l2;
            break;
            QLog.d("mqq", 1, paramFromServiceMsg.getUin() + ", " + localObject4);
            break label2539;
            bool1 = false;
            break label2588;
          }
      ...
      try
      {
        ...
        localObject4 = (String)paramFromServiceMsg.getAttribute("resp_register_uin", "");
        localBundle.putInt("code", j);
  ...
  public void service(Intent paramIntent)
  {
    ...
    Object localObject1 = paramIntent.getStringExtra("src");
    paramIntent.getBooleanExtra("opened", false);
    localObject2 = new ToServiceMsg(MsfServiceSdk.get().getMsfServiceName(), (String)localObject2, "");
