...
{
  public gtd(PhotoPreviewActivity paramPhotoPreviewActivity) {}
  ...
  public void b(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    {
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(paramInt + 1 + " / " + this.a.jdField_a_of_type_JavaUtilArrayList.size());
      return;
      this.a.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
    }
    this.a.jdField_b_of_type_AndroidWidgetTextView.setText(this.a.getResources().getString(2131367086));
  }
}
