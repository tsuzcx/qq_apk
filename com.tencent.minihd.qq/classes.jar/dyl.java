...
public class dyl
  implements Runnable
{
  public dyl(ForwardOperations paramForwardOperations, String paramString, QQCustomDialog paramQQCustomDialog) {}
  ...
  public void run()
  {
    ...
    if (!this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_Boolean) {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.v == 1)
      {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130838295);
        this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new dym(this, (Drawable)localObject1));
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new dyn(this, (URLDrawable)localObject1));
          return;
          i = 4;
      ...
      localObject5 = null;
      label332:
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.D != null) && (AbsDownloader.a(this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.D)))
      {
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.D;
        label363:
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_Boolean)
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_Boolean)
          {
            ...
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.v != 12) || (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.E == null)) {
              break label671;
            }
        ...
        for (;;)
        {
          this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new dyp(this, (Drawable)localObject2));
          return;
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.C;
          break label363;
          label630:
