...
{
  public gxn(SelectMemberActivity paramSelectMemberActivity) {}
  ...
  public void a(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    IContactSearchable localIContactSearchable = (IContactSearchable)SelectMemberActivity.a(this.a).getItem(i);
    if (localIContactSearchable != null)
    {
      ...
      if ((localIContactSearchable instanceof ContactSearchableFriend))
      {
        ...
        if (((this.a.jdField_a_of_type_JavaUtilArrayList == null) || (!this.a.jdField_a_of_type_JavaUtilArrayList.contains(paramView))) && (!this.a.a(paramView)) && (!this.a.b())) {
          break label428;
        }
      }
    }
    ...
    for (paramAdapterView = ContactUtils.a(paramAdapterView, this.a.app);; paramAdapterView = "")
    {
      ...
      if ((localIContactSearchable instanceof ContactsSearchableCircleBuddy))
      {
        ...
        for (;;)
        {
          ReportController.b(this.a.app, "CliOper", "", "", "Network_circle", "Search_circle_clk", 82, 0, "", "", "", "");
          break;
      ...
      if ((localIContactSearchable instanceof ContactsSearchablePhoneContact))
      {
        ...
        for (;;)
        {
          ...
          this.a.jdField_a_of_type_ComTencentCommonAppInnerFrameManager.setVisibility(0);
          return;
          if ((localIContactSearchable instanceof ContactSearchableFriend)) {
