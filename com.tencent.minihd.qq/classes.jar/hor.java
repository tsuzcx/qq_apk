...
public class hor
  implements Runnable
{
  public hor(RouterHandler paramRouterHandler, long paramLong, MsgHeader paramMsgHeader) {}
  
  public void run()
  {
    Object localObject2 = (Session)this.jdField_a_of_type_ComTencentMobileqqAppRouterHandler.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(this.jdField_a_of_type_Long));
    Object localObject1 = localObject2;
    if (localObject2 == null)
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppRouterHandler.b.a().createEntityManager();
      ...
      localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppRouterHandler.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper.genSession(0, ((RouterMsgRecord)localObject1).filename, null, 0, 0, this.jdField_a_of_type_Long, 0, 0, 0, true);
      ...
      if (localObject2 != null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppRouterHandler.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(((Session)localObject2).uSessionID), localObject2);
        localObject1 = localObject2;
      }
    }
