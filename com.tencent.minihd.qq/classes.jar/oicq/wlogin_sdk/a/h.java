  ...
  public byte[] a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt1, int paramInt2, int paramInt3, long paramLong1, long paramLong2, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, byte[] paramArrayOfByte6, byte[] paramArrayOfByte7, long paramLong3, byte[] paramArrayOfByte8, byte[] paramArrayOfByte9, byte[] paramArrayOfByte10, Map<Integer, RegTLV> paramMap, Map<String, Object> paramMap1)
  {
    ...
    else
    {
      for (;;)
      {
        ...
        paramArrayOfByte10 = util.get_device_model();
        localSecTransInfo.str_model_type.set(paramArrayOfByte10);
        localStringBuilder2.append(" model:").append(paramArrayOfByte10);
        ...
        if (u.aB == null)
        {
          ...
          localStringBuilder2.append(" regMacAddress:").append(u.aB);
          ...
          label850:
          localPBStringField.set(paramArrayOfByte10);
          localStringBuilder2.append(" regLocation:").append(u.aE);
        ...
        label1029:
        for (paramArrayOfByte10 = "";; paramArrayOfByte10 = u.aC)
        {
          localPBStringField.set(paramArrayOfByte10);
          localStringBuilder2.append(" regOSLanguage:").append(u.aC);
          localSecTransInfo.uint32_qq_language.set(u.aD);
          localStringBuilder2.append(" regQQLanguage:").append(u.aD);
          ...
          break;
          paramArrayOfByte10 = u.aB;
          break label812;
          label1021:
          paramArrayOfByte10 = u.aE;
          break label850;
        }
        label1037:
        ...
        util.int32_to_buf(paramArrayOfByte10, 0, 18);
        paramArrayOfByte7.setData(paramArrayOfByte10, paramArrayOfByte10.length);
        paramArrayOfByte7 = paramArrayOfByte7.getBuf();
        ...
        util.int16_to_buf(paramArrayOfByte7, m, paramArrayOfByte3.length);
        m += 2;
        System.arraycopy(paramArrayOfByte3, 0, paramArrayOfByte7, m, paramArrayOfByte3.length);
        m += paramArrayOfByte3.length;
        util.int16_to_buf(paramArrayOfByte7, m, arrayOfByte2.length);
        System.arraycopy(arrayOfByte2, 0, paramArrayOfByte7, m + 2, arrayOfByte2.length);
