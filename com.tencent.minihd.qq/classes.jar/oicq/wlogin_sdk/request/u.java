...
public class u
{
  ...
  public static void d()
  {
    ...
    if ((localObject2 == null) || (localObject2.length <= 0))
    {
      ...
      for (;;)
      {
        ...
        util.LOGI("init ok os ver:" + new String(K) + " cur_guid:" + util.buf_to_string(B) + " svn " + 2484L + " at " + m(), "");
        return;
        W = 1;
        Y = 17;
      }
    ...
    for (X = 0;; X = 1)
    {
      ...
      for (i1 = 1;; i1 = 0)
      {
        ...
        d.a(u, (byte[])localObject2, (byte[])localObject1);
        util.saveGuidToFile(u, (byte[])localObject1);
        localObject2 = localObject1;
        localObject3 = localObject1;
        localObject1 = localObject2;
  ...
  public u a(long paramLong)
  {
    ...
    localu.l = this.l;
    if (this.c != null) {
      localu.c = ((byte[])this.c.clone());
    }
    if ((this.n != null) && (this.p != null))
    {
      localu.n = ((byte[])this.n.clone());
      localu.p = ((byte[])this.p.clone());
      localu.r = this.r;
    }
    if (paramLong <= 0L) {}
    for (localu.h = a();; localu.h = paramLong)
    {
      localu.c(u);
      return localu;
    }
