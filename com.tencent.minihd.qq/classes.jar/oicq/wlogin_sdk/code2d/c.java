...
public class c
{
  ...
  {
    byte[] arrayOfByte = new byte[28 + (u.F.length + 2 + 2 + u.H.length + 2 + u.I.length)];
    ...
    System.arraycopy(u.B, 0, arrayOfByte, 12, u.B.length);
    int i = u.B.length;
    i = fill_staff(arrayOfByte, u.F, i + 12);
    i = fill_staff(arrayOfByte, u.H, i);
    fill_staff(arrayOfByte, u.I, i);
    return arrayOfByte;
  }
