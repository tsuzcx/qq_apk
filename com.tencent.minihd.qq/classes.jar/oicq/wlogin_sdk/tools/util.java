...
public class util
{
  ...
  public static final long BUILD_TIME = 1630653275L;
  ...
  public static byte[] get_cp_pubkey(Context paramContext, long paramLong1, long paramLong2)
  {
    ...
    //   14: areturn
    //   15: aload_0
    //   16: invokevirtual 1297	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   19: astore_0
    ...
    //   48: invokestatic 1309	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   51: astore 6
    ...
    //   148: aastore
    //   149: aconst_null
    //   150: invokevirtual 1327	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   153: astore_0
    //   154: aload_0
    //   155: ifnull +98 -> 253
    //   158: aload_0
    ...
    //   174: aload_0
    //   175: ldc_w 1317
    //   178: invokeinterface 1335 2 0
    //   183: invokeinterface 1337 2 0
    //   188: astore 6
    //   190: aload_0
    //   191: astore 5
    //   193: aload_0
    //   194: aload_0
    //   195: ldc_w 1319
    //   198: invokeinterface 1335 2 0
    //   203: invokeinterface 1337 2 0
    //   208: astore 7
    //   210: aload_0
    //   211: astore 5
    //   213: aload 6
    //   215: invokestatic 1340	oicq/wlogin_sdk/tools/MD5:toMD5	(Ljava/lang/String;)Ljava/lang/String;
    //   218: aload 7
    ...
    //   227: astore 5
    //   229: aload 6
    //   231: invokestatic 1344	oicq/wlogin_sdk/tools/util:string_to_buf	(Ljava/lang/String;)[B
    //   234: astore 6
    //   236: aload 6
    //   238: astore 5
    //   240: aload_0
    //   241: ifnull -229 -> 12
    //   244: aload_0
    //   245: invokeinterface 1345 1 0
    //   250: aload 6
    //   252: areturn
    //   253: aload_0
    //   254: ifnull +9 -> 263
    //   257: aload_0
    //   258: invokeinterface 1345 1 0
    //   263: ldc_w 1347
    //   266: invokestatic 1344	oicq/wlogin_sdk/tools/util:string_to_buf	(Ljava/lang/String;)[B
    //   269: areturn
    //   270: astore 6
    //   272: aconst_null
    //   273: astore_0
    ...
    //   285: ifnull -22 -> 263
    //   288: aload_0
    //   289: invokeinterface 1345 1 0
    //   294: goto -31 -> 263
    //   297: astore_0
    //   298: aload 5
    //   300: ifnull +10 -> 310
    //   303: aload 5
    //   305: invokeinterface 1345 1 0
    //   310: aload_0
    //   311: athrow
    //   312: astore_0
    //   313: goto -15 -> 298
  ...
  public static boolean loadLibrary(String paramString, Context paramContext)
  {
    ...
    //   58: invokevirtual 1593	java/io/File:getParent	()Ljava/lang/String;
    ...
    //   115: invokevirtual 1593	java/io/File:getParent	()Ljava/lang/String;
    ...
    //   163: invokestatic 1602	java/lang/System:load	(Ljava/lang/String;)V
    //   166: iconst_1
    //   167: istore_3
    //   168: iload_3
    //   169: istore_2
    ...
    //   171: ifne +9 -> 180
    //   174: aload_0
    //   175: invokestatic 1604	java/lang/System:loadLibrary	(Ljava/lang/String;)V
    //   178: iconst_1
    //   179: istore_2
    //   180: iload_2
    //   181: istore_3
    ...
    //   186: aload_1
    //   187: aload_0
    //   188: invokestatic 1609	com/tencent/commonsdk/soload/SoLoadUtilNew:loadSoByName	(Landroid/content/Context;Ljava/lang/String;)Z
    //   191: istore_3
    //   192: iload_3
    //   193: ifeq +129 -> 322
    //   196: ldc_w 1611
    ...
    //   224: invokevirtual 1427	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    ...
    //   240: astore 4
    //   242: aload 6
    //   244: invokestatic 1569	oicq/wlogin_sdk/tools/util:printException	(Ljava/lang/Exception;)V
    //   247: goto -102 -> 145
    //   250: astore 4
    ...
    //   265: aload 4
    //   267: invokevirtual 1618	java/lang/UnsatisfiedLinkError:getMessage	()Ljava/lang/String;
    ...
    //   301: aload 4
    //   303: invokevirtual 1618	java/lang/UnsatisfiedLinkError:getMessage	()Ljava/lang/String;
  ...
  public static void saveGuidToFile(Context paramContext, byte[] paramArrayOfByte)
  {
    ...
    //   26: aload_1
    //   27: invokestatic 1693	oicq/wlogin_sdk/tools/util:buf_to_string	([B)Ljava/lang/String;
    //   30: invokevirtual 403	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    //   113: astore_2
    //   114: aload 8
    //   116: invokevirtual 1696	java/io/File:createNewFile	()Z
    //   119: pop
    //   120: aload 5
    //   122: astore_3
    //   123: aload 6
    ...
    //   147: astore_2
    //   148: aload 8
    //   150: invokevirtual 1699	java/io/File:canWrite	()Z
    //   153: ifeq +26 -> 179
    //   156: aload 6
    //   158: astore 4
    //   160: aload 7
    //   162: astore_2
    //   163: new 1701	java/io/FileOutputStream
    //   166: dup
    //   167: aload 8
    //   169: iconst_0
    //   170: invokespecial 1704	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   173: astore_3
    //   174: aload_3
    //   175: aload_1
    //   176: invokevirtual 1705	java/io/FileOutputStream:write	([B)V
    //   179: aload_3
    //   180: astore 4
    //   182: aload_3
    //   183: astore_2
    //   184: aload_0
    //   185: aload_1
    //   186: invokestatic 1708	oicq/wlogin_sdk/tools/util:save_android_id	(Landroid/content/Context;[B)V
    //   189: aload_3
    //   190: ifnull +7 -> 197
    //   193: aload_3
    //   194: invokevirtual 1709	java/io/FileOutputStream:close	()V
    //   197: return
    //   198: astore_0
    //   199: aload_0
    //   200: ldc 253
    ...
    //   218: ifnull -21 -> 197
    //   221: aload 4
    //   223: invokevirtual 1709	java/io/FileOutputStream:close	()V
    //   226: return
    //   227: astore_0
    //   228: aload_0
    //   229: ldc 253
    ...
    //   237: ifnull +7 -> 244
    //   240: aload_2
    //   241: invokevirtual 1709	java/io/FileOutputStream:close	()V
    //   244: aload_0
    //   245: athrow
    //   246: astore_1
    //   247: aload_1
  ...
  public static boolean set_cp_pubkey(Context paramContext, long paramLong1, long paramLong2)
  {
    ...
    //   5: ireturn
    //   6: aload_0
    //   7: invokevirtual 1297	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   10: astore 7
    ...
    //   40: invokestatic 1309	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   43: astore 8
    //   45: aload 8
    //   47: invokevirtual 1738	android/net/Uri:toString	()Ljava/lang/String;
    ...
    //   149: aastore
    //   150: aconst_null
    //   151: invokevirtual 1327	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   154: astore 6
    //   156: aload 6
    ...
    //   163: ifnull +10 -> 173
    //   166: aload 6
    //   168: invokeinterface 1345 1 0
    //   173: iconst_0
    //   174: ireturn
    //   175: aload_0
    //   176: invokestatic 1740	oicq/wlogin_sdk/tools/util:get_rsa_pubkey	(Landroid/content/Context;)[B
    //   179: invokestatic 1693	oicq/wlogin_sdk/tools/util:buf_to_string	([B)Ljava/lang/String;
    //   182: astore_0
    //   183: aload_0
    ...
    //   196: ifnull +10 -> 206
    //   199: aload 6
    //   201: invokeinterface 1345 1 0
    //   206: iconst_0
    //   207: ireturn
    //   208: aload_0
    //   209: invokestatic 1340	oicq/wlogin_sdk/tools/MD5:toMD5	(Ljava/lang/String;)Ljava/lang/String;
    //   212: astore 9
    //   214: aload 6
    //   216: invokeinterface 1743 1 0
    //   221: ifle +53 -> 274
    //   224: new 1745	android/content/ContentValues
    //   227: dup
    //   228: invokespecial 1746	android/content/ContentValues:<init>	()V
    //   231: astore 7
    //   233: aload 7
    //   235: ldc_w 1317
    //   238: aload_0
    //   239: invokevirtual 1749	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   242: aload 7
    //   244: ldc_w 1319
    //   247: aload 9
    //   249: invokevirtual 1749	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   252: aload 6
    //   254: invokeinterface 1332 1 0
    //   259: pop
    //   260: aload 6
    //   262: ifnull +10 -> 272
    //   265: aload 6
    //   267: invokeinterface 1345 1 0
    //   272: iconst_1
    //   273: ireturn
    //   274: new 1745	android/content/ContentValues
    //   277: dup
    //   278: invokespecial 1746	android/content/ContentValues:<init>	()V
    //   281: astore 10
    //   283: aload 10
    //   285: ldc_w 1313
    //   288: lload_1
    //   289: invokestatic 1752	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   292: invokevirtual 1755	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   295: aload 10
    //   297: ldc_w 1315
    //   300: lload_3
    //   301: invokestatic 1752	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   304: invokevirtual 1755	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   307: aload 10
    //   309: ldc_w 1317
    //   312: aload_0
    //   313: invokevirtual 1749	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   316: aload 10
    //   318: ldc_w 1319
    //   321: aload 9
    //   323: invokevirtual 1749	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   326: aload 7
    //   328: aload 8
    //   330: aload 10
    //   332: invokevirtual 1759	android/content/ContentResolver:insert	(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    //   335: astore_0
    ...
    //   349: aload_0
    //   350: invokevirtual 1764	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   353: ldc_w 1766
    ...
    //   376: invokestatic 1770	oicq/wlogin_sdk/tools/util:LOGD	(Ljava/lang/String;)V
    //   379: goto -119 -> 260
    //   382: astore 7
    //   384: aload 6
    //   386: astore_0
  ...
  public static void writeFile(String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   33: ifne +26 -> 59
    //   36: aload_0
    //   37: invokevirtual 1813	java/io/File:getParentFile	()Ljava/io/File;
    //   40: astore_3
    //   41: aload_3
    //   42: ifnull -26 -> 16
    //   45: aload_3
    //   46: invokevirtual 1816	java/io/File:mkdirs	()Z
    //   49: ifne +10 -> 59
    //   52: aload_3
    //   53: invokevirtual 673	java/io/File:isDirectory	()Z
    //   56: ifeq -40 -> 16
    //   59: new 1701	java/io/FileOutputStream
    //   62: dup
    //   63: aload_0
    //   64: iconst_1
    //   65: invokespecial 1704	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   68: astore_0
    //   69: aload_0
    //   70: aload_1
    //   71: invokevirtual 1705	java/io/FileOutputStream:write	([B)V
    //   74: aload_0
    //   75: invokevirtual 1709	java/io/FileOutputStream:close	()V
    //   78: goto -62 -> 16
    //   81: astore_0
    //   82: goto -66 -> 16
    //   85: astore_0
