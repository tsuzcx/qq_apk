...
{
  private gqi(ContactListView paramContactListView) {}
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    do
    {
      ...
      if (i == 4)
      {
        ...
        {
          this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new gqj(this));
          return;
        }
        this.a.i();
        this.a.jdField_a_of_type_Gql.sendEmptyMessageDelayed(1, 0L);
        return;
      }
    } while (!this.a.jdField_a_of_type_ComTencentMobileqqAppPhoneContactManagerImp.h());
    this.a.a(2131366988, 0L, false);
  }
