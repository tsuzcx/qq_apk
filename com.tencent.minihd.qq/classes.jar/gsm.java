...
public class gsm
  extends AsyncTask
{
  private gsm(PhotoCropActivity paramPhotoCropActivity) {}
  ...
  private String a(android.graphics.Bitmap paramBitmap)
  {
    ...
    //   15: dup
    //   16: aload_0
    //   17: getfield 10	gsm:a	Lcom/tencent/mobileqq/activity/photo/PhotoCropActivity;
    ...
    //   31: ifne +14 -> 45
    //   34: aload_0
    //   35: getfield 10	gsm:a	Lcom/tencent/mobileqq/activity/photo/PhotoCropActivity;
    ...
    //   60: aload_0
    //   61: getfield 10	gsm:a	Lcom/tencent/mobileqq/activity/photo/PhotoCropActivity;
    ...
    //   73: astore_2
    //   74: aload_0
    //   75: getfield 10	gsm:a	Lcom/tencent/mobileqq/activity/photo/PhotoCropActivity;
  ...
  protected void a(String paramString)
  {
    ...
    {
      QQToast.a(this.a, 2131368356, 0).a();
      return;
    }
    if ("sdcardfull".equals(paramString))
    {
      QQToast.a(this.a, 2131368357, 0).a();
      return;
    }
    if (this.a.getIntent().getBooleanExtra("PhotoConst.IS_SET_BACKGROUND", false))
    {
      localObject = new Intent();
      ((Intent)localObject).setAction("chatbgBroadcast");
      ((Intent)localObject).setPackage(this.a.getPackageName());
      ((Intent)localObject).putExtra("friendUin", this.a.getIntent().getStringExtra("friendUin"));
      ((Intent)localObject).putExtra("uintype", this.a.getIntent().getIntExtra("uintype", -1));
      ((Intent)localObject).putExtra("PhotoConst.SINGLE_PHOTO_PATH", paramString);
