...
{
  public gnr(MainAssistObserver paramMainAssistObserver) {}
  ...
  public void a()
  {
    ...
    do
    {
      ...
      localQCallFacade = (QCallFacade)this.a.a.app.getManager(37);
    ...
    i = 0;
    if (localObject != null) {
      i = ((QQMessageFacade)localObject).e();
    }
    BadgeUtils.a(localQQAppInterface.a(), localQCallFacade.a() + i);
  }
}
