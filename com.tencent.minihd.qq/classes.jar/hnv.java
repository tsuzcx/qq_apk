...
public class hnv
  implements Runnable
{
  public hnv(QQAppInterface paramQQAppInterface, int paramInt) {}
  ...
  public void run()
  {
    ...
    if ((!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.h()) && (bool2) && (!bool1) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.k()) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.l()) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.m()) && (QQAppInterface.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)))
    {
