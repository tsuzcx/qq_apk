...
public class hlj
  implements Runnable
{
  public hlj(MessageHandler paramMessageHandler, NotificationManager paramNotificationManager) {}
  ...
  public void run()
  {
    try
    {
      ...
      this.jdField_a_of_type_AndroidAppNotificationManager.cancel(MessageHandler.bJ);
