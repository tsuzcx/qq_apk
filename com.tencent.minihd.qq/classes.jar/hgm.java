  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      if (i > 10)
      {
        ...
        bool1 = SettingCloneUtil.readValue(BaseActivity.sTopActivity, null, BaseActivity.sTopActivity.getString(2131366269), "qqsetting_screenshot_key", false);
        ...
        if (BaseActivity.sTopActivity.screenShot == null)
        {
          ...
          label119:
          BaseActivity.sTopActivity.screenShot = new ScreenShot((Context)localObject, BaseActivity.sTopActivity.getWindow());
        }
        bool1 = BaseActivity.sTopActivity.screenShot.a();
        if (bool1) {
          continue;
        }
        if (BaseActivity.sTopActivity.screenShot.b()) {
          break label217;
        }
        BaseActivity.access$000(BaseActivity.sTopActivity);
      }
      for (;;)
      {
