...
public class gwp
  extends BaseAdapter
{
  private gwp(DiscussionListInnerFrame paramDiscussionListInnerFrame) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = (gwq)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramViewGroup = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130904409, paramViewGroup, false);
      paramView = new gwq(this.a, null);
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131296567));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131302123));
      paramView.b = ((TextView)paramViewGroup.findViewById(2131297479));
