...
public class kyr
  extends Handler
{
  public kyr(QQToastNotifier paramQQToastNotifier, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  {
    paramMessage = (kys)paramMessage.obj;
    ...
    TextView localTextView = (TextView)localView.findViewById(2131298079);
    if ((paramMessage.jdField_a_of_type_JavaLangString != null) && (paramMessage.jdField_a_of_type_JavaLangString.length() > 0)) {
      localTextView.setText(paramMessage.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      ((ImageView)localView.findViewById(2131298078)).setImageResource(QQToast.a(paramMessage.jdField_a_of_type_Int));
