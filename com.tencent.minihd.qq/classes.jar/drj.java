...
{
  public drj(ContactSyncJumpActivity paramContactSyncJumpActivity) {}
  ...
  protected void a(boolean paramBoolean, long paramLong, String paramString, GetOnlineInfoResp paramGetOnlineInfoResp)
  {
    ...
    do
    {
      ...
      for (paramLong = paramGetOnlineInfoResp.uAbiFlag;; paramLong = -10000L)
      {
        ...
        paramString = (TextView)this.a.jdField_a_of_type_AndroidAppDialog.findViewById(2131299857);
        paramString.setText(2131369297);
      ...
      if (paramGetOnlineInfoResp.result == 1)
      {
        ...
        {
          paramString = String.format(this.a.getResources().getString(2131369292), new Object[] { ContactSyncJumpActivity.d(this.a) });
    ...
    label760:
    for (paramString = this.a.getResources().getString(2131369297);; paramString = (String)localObject)
    {
      localObject = (TextView)this.a.jdField_a_of_type_AndroidAppDialog.findViewById(2131299857);
