...
public class gya
  extends BaseAdapter
{
  private gya(SelectMemberActivity paramSelectMemberActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramViewGroup = this.a.getLayoutInflater().inflate(2130903349, null);
    }
    paramViewGroup.setTag(localResultRecord);
    paramView = this.a.app.b(localResultRecord.jdField_a_of_type_JavaLangString);
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131296567);
