...
public class lsk
  ...
  implements lte
{
  public lsk(ListView paramListView)
  {
    super(paramListView);
  }
    ...
    for (;;)
    {
      if (paramInt3 >= 0)
      {
        ...
        for (;;)
        {
          ...
          {
            this.a.jdField_a_of_type_Lqt.a(this.a.getChildAt(paramInt1), this.a.ao + paramInt1);
            paramInt1 += 1;
            continue;
    ...
    for (paramInt2 = paramInt3;; paramInt2 = -1)
    {
      if (paramInt2 >= 0)
      {
        ...
        for (;;)
        {
          ...
          {
            this.a.jdField_a_of_type_Lqt.a(this.a.getChildAt(paramInt3), this.a.ao + paramInt3);
            paramInt3 += 1;
            continue;
    ...
    do
    {
      ...
      do
      {
        ...
        if (paramInt2 >= 0)
        {
          ...
          {
            this.a.jdField_a_of_type_Lqt.a((View)localObject, this.a.ao + paramInt2);
            j = i;
            if (i >= 0) {}
          }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (paramInt4 > 0)
    {
      ...
      if (paramInt3 < paramInt1)
      {
        ...
        {
          this.a.jdField_a_of_type_Lqt.a(localView, this.a.ao + paramInt3);
          j = i;
          if (i >= 0) {}
        }
        for (j = paramInt3;; j = i)
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 == 0) && (this.a.aA > 0))
    {
      ...
      if ((paramInt1 < 0) || (paramInt1 > this.a.aA - this.a.m() - this.a.n())) {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            while (paramInt2 < j)
            {
              this.a.jdField_a_of_type_Lqt.a(this.a.getChildAt(paramInt2), this.a.ao + paramInt2);
              paramInt2 += 1;
            }
          }
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 < 0) || (paramInt2 >= this.a.aA - this.a.m() - this.a.n())) {
      throw new IllegalArgumentException("row index out of bound");
    }
    if ((this.a.o) || (this.a.q)) {
      onChanged();
    ...
    do
    {
      ...
      if (n < i1)
      {
        ...
        this.a.jdField_a_of_type_Lqt.a((View)localObject, i);
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 < this.a.m()) || (paramInt2 >= this.a.aA - this.a.m() - this.a.n())) {
      throw new IllegalArgumentException("row index out of bound. insert range: " + paramInt1 + "~" + paramInt2 + ". valid range: " + this.a.m() + "~" + (this.a.aA - this.a.m() - this.a.n()));
    }
    if ((this.a.o) || (this.a.q)) {
      onChanged();
    }
