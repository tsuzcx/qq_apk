  ...
  implements Runnable
{
  ...
  public hlf(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
  ...
  private boolean a(String paramString)
  {
    boolean bool2 = false;
    boolean bool1;
    if (paramString.startsWith("com.tencent.minihd.qq"))
    {
      bool1 = true;
      return bool1;
    }
  ...
  public void run()
  {
    for (;;)
    {
      ...
      try
      {
        boolean bool = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.j;
        if (bool) {
          return;
        }
