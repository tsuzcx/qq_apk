...
{
  public hpz(SubAccountBindHandler paramSubAccountBindHandler, SubAccountBackProtocData paramSubAccountBackProtocData, SubAccountManager paramSubAccountManager, boolean paramBoolean) {}
  ...
  protected void onGetKeyBack(String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqAppSubAccountBindHandler.a != null) && (paramString2.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqSubaccountLogicSubAccountBackProtocData.c)) && (paramString1.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppSubAccountBindHandler.a.getAccount())))
    {
      ...
      SubAccountControll.a(this.jdField_a_of_type_ComTencentMobileqqAppSubAccountBindHandler.a, (byte)1, paramString2);
    ...
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("SUB_ACCOUNT", 2, bool1 + " subUin:" + paramString2.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqSubaccountLogicSubAccountBackProtocData.c) + " mainAccount:" + paramString1.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppSubAccountBindHandler.a.getAccount()));
    }
    this.jdField_a_of_type_ComTencentMobileqqAppSubAccountBindHandler.a(2, true, this.jdField_a_of_type_ComTencentMobileqqSubaccountLogicSubAccountBackProtocData);
  }
}
