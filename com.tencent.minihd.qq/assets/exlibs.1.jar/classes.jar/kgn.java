...
{
  public kgn(TroopBarPublishLocationSelectActivity paramTroopBarPublishLocationSelectActivity) {}
  ...
  public boolean a(int paramInt, View paramView, ListView paramListView)
  {
    ...
    if (this.a.jdField_a_of_type_Long == 0L)
    {
      ...
      this.a.a(0, true);
      this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new kgo(this), 300L);
    }
    for (;;)
    {
      ...
      break;
      label97:
      this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new kgp(this), 300L);
    }
  }
