...
public class knu
  extends Thread
{
  public knu(NearbyTroopsMapView paramNearbyTroopsMapView, String paramString)
  {
    super(paramString);
  }
  ...
  public void run()
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentTencentmapMapsdkMapGeoPoint != null) && (localGeoPoint != null))
    {
      ...
      if ((this.a.d) && (!this.a.c))
      {
        ...
        if (this.a.jdField_b_of_type_AndroidOsHandler != null) {
          this.a.jdField_b_of_type_AndroidOsHandler.sendMessage(this.a.a(0, localGeoPoint));
        }
      }
    }
    for (;;)
    {
      ...
      if ((this.a.j != i) && (this.a.jdField_b_of_type_AndroidOsHandler != null)) {
        this.a.jdField_b_of_type_AndroidOsHandler.sendMessage(this.a.a(2, new Point(this.a.j, i)));
      }
      this.a.j = i;
      ...
      if ((!this.a.d) && (this.a.c))
      {
        this.a.d = true;
        if (this.a.jdField_b_of_type_AndroidOsHandler != null) {
          this.a.jdField_b_of_type_AndroidOsHandler.sendMessage(this.a.a(1, localGeoPoint));
        }
      }
    }
  }
