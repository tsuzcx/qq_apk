  ...
  implements QzoneMusicConst
{
  ...
  IActionListener mActionListener = new mcu(this);
  private Handler mMainHandler = new Handler(Looper.getMainLooper());
  private ArrayList mMusicEventListeners = new ArrayList();
  private AtomicInteger mReqestId = new AtomicInteger(1);
  private RemoteServiceProxy serviceProxy = new RemoteServiceProxy("com.qzone.music.service.QzoneMusicService", QzoneMusicPluginProxyService.class, ((AppInterface)BaseApplicationImpl.a().a()).a());
  ...
  public void playMusicList(long paramLong, int paramInt1, int paramInt2, ArrayList paramArrayList)
  {
  ...
  public void setPlayMode(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    sendData("cmd.savePlayMode", localBundle, false);
  }
