...
public class QZoneVipInfoManager
{
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (localObject != null)
      {
        ...
        ((SharedPreferences.Editor)localObject).putString(a(paramString), a(paramInt1, paramInt2, paramInt3));
  ...
  public int[] a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      paramString = LocalMultiProcConfig.a("QZONE_VIP_INFO", a(paramString), null);
      if (!TextUtils.isEmpty(paramString))
      {
    ...
    try
    {
      ...
      arrayOfInt[2] = Integer.parseInt(paramString[2]);
      if (QLog.isDevelopLevel()) {
