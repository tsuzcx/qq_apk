  ...
  implements Handler.Callback, INetEngine.IBreakDownFix, INetEngine.INetEngineListener
{
  ...
  private void a(NetReq paramNetReq, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 > 0)
    {
      paramNetReq = (lxm)this.b.get(str);
      if (paramNetReq == null) {
        break label95;
      }
    }
    label95:
    for (paramNetReq = lxm.a(paramNetReq);; paramNetReq = null)
    {
      if (paramNetReq != null) {
  ...
  private void b(NetResp paramNetResp)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      Object localObject = (lxm)this.b.remove(str);
      if (localObject != null)
      {
        localObject = lxm.a((lxm)localObject);
        a(str, paramNetResp);
  ...
  private void b(String paramString)
  {
    ...
    Object localObject = (lxm)this.b.remove(paramString);
    if (localObject != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(0).b(lxm.a((lxm)localObject));
      localObject = lxm.a((lxm)localObject);
      if (localObject != null) {
  ...
  public void a(PluginInfo paramPluginInfo, PluginDownloader.OnPluginDownLoadListener paramOnPluginDownLoadListener)
  {
    ...
    do
    {
      ...
      lxm locallxm = new lxm(null);
      lxm.a(locallxm, localHttpNetReq);
      lxm.a(locallxm, paramOnPluginDownLoadListener);
      this.b.put(paramPluginInfo.mID, locallxm);
  ...
  {
    paramString = a(this.jdField_a_of_type_AndroidContentContext).listFiles(new lxl(this, paramString));
