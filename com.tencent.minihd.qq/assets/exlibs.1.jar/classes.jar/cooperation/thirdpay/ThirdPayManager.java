...
public class ThirdPayManager
{
  ...
  public static AppRuntime a(BaseApplicationImpl paramBaseApplicationImpl, String paramString)
  {
    ...
    try
    {
      ...
      SharedPreferences localSharedPreferences = ((Context)localObject).getSharedPreferences("mobileQQ", i);
      localObject = "";
  ...
  {
    SosoInterface.a(new meq(3, true, 0L, false, false, "ThirdPayManager", paramQQAppInterface));
  }
