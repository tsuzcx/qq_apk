  ...
  extends PluginProxyActivity
{
  ...
  private void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidNfcNfcAdapter != null) {
      if (!this.jdField_a_of_type_AndroidNfcNfcAdapter.isEnabled()) {
        DialogUtil.a(this, 0, "", "请到设置界面打开NFC功能", new meg(this), new meh(this)).show();
      }
    }
  ...
  private void b()
  {
    ...
    try
    {
      this.jdField_a_of_type_Array2dOfJavaLangString = new String[][] { { IsoDep.class.getName() }, { NfcV.class.getName() }, { NfcF.class.getName() }, { MifareClassic.class.getName() }, { NfcA.class.getName() } };
