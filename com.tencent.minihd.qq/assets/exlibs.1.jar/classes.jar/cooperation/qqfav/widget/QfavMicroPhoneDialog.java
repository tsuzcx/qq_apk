  ...
  implements View.OnClickListener, VoicePlayer.VoicePlayerListener
{
  ...
  public QfavMicroPhoneDialog(Context paramContext, AppRuntime paramAppRuntime, QfavMicroPhoneDialog.Listener paramListener)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new lzr(this);
    this.jdField_a_of_type_CooperationQqfavWidgetQfavMicroPhoneDialog$Listener = paramListener;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    super.setContentView(2130903711);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131299374));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131299382).setOnClickListener(this);
    this.jdField_a_of_type_ComTencentMobileqqWidgetOvalProgress = ((OvalProgress)super.findViewById(2131299375));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131299376));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131299377));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131299381));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)super.findViewById(2131299379));
  ...
  private void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqUtilsVoicePlayer == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqUtilsVoicePlayer.a();
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840522);
      return;
    }
