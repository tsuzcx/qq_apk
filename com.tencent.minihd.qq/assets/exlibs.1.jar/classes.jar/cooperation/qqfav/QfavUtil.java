...
{
  private static final int jdField_a_of_type_Int = 10485760;
    ...
    try
    {
      ...
      if (localEntity != null)
      {
        ...
        while (paramString1.hasNext())
        {
          ...
          {
            localField.set(localEntity, Byte.valueOf((byte)paramContentValues.getAsShort((String)localObject1).shortValue()));
          }
  ...
  {
    QQToast.a(paramContext, paramInt2, paramInt1, 2000).b(paramContext.getResources().getDimensionPixelSize(2131492923) - (int)DisplayUtils.a(paramContext, 5.0F));
  }
  
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    QQToast.a(paramContext, paramInt, paramString, 2000).b(paramContext.getResources().getDimensionPixelSize(2131492923) - (int)DisplayUtils.a(paramContext, 5.0F));
  }
  ...
  public static boolean a(Activity paramActivity)
  {
    if (!SystemUtil.a())
    {
      a(paramActivity, 2131362082, 1);
      return false;
    }
    if (SystemUtil.a() < 500L)
    {
      a(paramActivity, 2131362081, 1);
      return false;
    }
    return true;
  }
  
  private static boolean a(Context paramContext1, String paramString, Context paramContext2, boolean paramBoolean1, boolean paramBoolean2)
  {
    boolean bool1 = false;
    Object localObject = BaseApplicationImpl.a();
    if (Build.VERSION.SDK_INT > 10) {}
    for (int i = 4;; i = 0)
    {
      ...
      paramString = "favorites_new_flag_" + paramString;
      boolean bool2 = ((SharedPreferences)localObject).getBoolean(paramString, false);
      if (!bool2)
      {
        ((SharedPreferences)localObject).edit().putBoolean(paramString, true).commit();
        if (paramBoolean1) {
          a(paramContext2, paramBoolean2, paramContext1, null);
        }
      }
      paramBoolean1 = bool1;
      if (!bool2) {
  ...
  public static boolean a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    return a(paramContext.getApplicationContext(), paramString, paramContext, paramBoolean, false);
  }
  
  public static boolean a(Context paramContext1, boolean paramBoolean, Context paramContext2, DialogInterface.OnDismissListener paramOnDismissListener)
  {
    if (paramContext1 == null) {
      paramContext1 = BaseActivity.sTopActivity;
    }
    while (paramContext1 == null) {
      return false;
    }
    try
    {
      String str = paramContext1.getString(2131364651);
      if (paramBoolean) {}
      for (paramContext2 = paramContext1.getString(2131364653);; paramContext2 = paramContext1.getString(2131364652))
      {
        paramContext1 = DialogUtil.a(paramContext1, 230, str, paramContext2, 2131365736, 2131364654, new lzg(), null);
  ...
  public static boolean a(AppRuntime paramAppRuntime, boolean paramBoolean1, boolean paramBoolean2, Context paramContext)
  {
    if (paramAppRuntime == null) {
      return false;
    }
    return a(paramAppRuntime.getApplication().getApplicationContext(), paramAppRuntime.getAccount(), paramContext, paramBoolean1, paramBoolean2);
  }
  ...
  public static String[] a(byte[] paramArrayOfByte)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: invokestatic 530	javax/xml/parsers/DocumentBuilderFactory:newInstance	()Ljavax/xml/parsers/DocumentBuilderFactory;
    //   6: astore 5
    //   8: aload 5
    //   10: invokevirtual 534	javax/xml/parsers/DocumentBuilderFactory:newDocumentBuilder	()Ljavax/xml/parsers/DocumentBuilder;
    //   13: new 536	java/io/ByteArrayInputStream
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 539	java/io/ByteArrayInputStream:<init>	([B)V
    //   21: invokevirtual 545	javax/xml/parsers/DocumentBuilder:parse	(Ljava/io/InputStream;)Lorg/w3c/dom/Document;
    //   24: invokeinterface 551 1 0
    //   29: astore 5
    //   31: aload 4
    //   33: astore_0
    //   34: aconst_null
    //   35: invokestatic 285	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   38: ifeq +14 -> 52
    //   41: aload 5
    //   43: ldc_w 553
    //   46: invokeinterface 558 2 0
    //   51: astore_0
    //   52: aload 5
    //   54: invokeinterface 559 1 0
    //   59: astore 26
    //   61: aload 26
    //   63: invokeinterface 303 1 0
    //   68: istore_3
    //   69: iconst_0
    //   70: istore_1
    //   71: aconst_null
    ...
    //   254: aload 28
    //   256: ldc_w 563
    //   259: invokevirtual 566	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   262: ifeq +1246 -> 1508
    //   265: aload 4
    //   267: astore 16
    //   269: aload 5
    ...
    //   507: astore 21
    //   509: aload 9
    //   511: invokeinterface 562 1 0
    //   516: ldc_w 568
    //   519: invokevirtual 566	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   522: ifeq +160 -> 682
    //   525: aload 4
    //   527: astore 16
    //   529: aload 5
    ...
    //   587: astore 25
    //   589: aload 5
    //   591: invokestatic 285	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   594: ifeq +1463 -> 2057
    //   597: aload 4
    //   599: astore 16
    //   601: aload 5
    ...
    //   643: astore 21
    //   645: aload 9
    //   647: invokeinterface 572 1 0
    //   652: ldc_w 574
    //   655: invokeinterface 580 2 0
    //   660: invokeinterface 294 1 0
    //   665: astore 22
    //   667: aload 4
    //   669: astore 23
    //   671: aload 6
    ...
    //   737: ldc_w 582
    //   740: invokevirtual 566	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   743: ifeq +145 -> 888
    //   746: aload 4
    //   748: astore 16
    //   750: aload 5
    ...
    //   808: astore 25
    //   810: aload 7
    //   812: invokestatic 285	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   815: ifeq +1242 -> 2057
    //   818: aload 4
    //   820: astore 16
    //   822: aload 5
    ...
    //   864: astore 21
    //   866: aload 9
    //   868: invokestatic 584	cooperation/qqfav/QfavUtil:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   871: astore 25
    //   873: aload 4
    //   875: astore 23
    //   877: aload 5
    ...
    //   934: astore 21
    //   936: aload 9
    //   938: invokeinterface 562 1 0
    //   943: ldc_w 586
    //   946: invokevirtual 566	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   949: ifeq +145 -> 1094
    //   952: aload 4
    //   954: astore 16
    //   956: aload 5
    ...
    //   1014: astore 25
    //   1016: aload 6
    //   1018: invokestatic 285	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1021: ifeq +1036 -> 2057
    //   1024: aload 4
    //   1026: astore 16
    //   1028: aload 5
    ...
    //   1070: astore 21
    //   1072: aload 9
    //   1074: invokestatic 584	cooperation/qqfav/QfavUtil:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   1077: astore 24
    //   1079: aload 4
    //   1081: astore 23
    //   1083: aload 5
    ...
    //   1156: astore 25
    //   1158: aload 9
    //   1160: invokeinterface 562 1 0
    //   1165: ldc_w 588
    //   1168: invokevirtual 566	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1171: ifeq +886 -> 2057
    //   1174: aload 4
    //   1176: astore 16
    //   1178: aload 5
    ...
    //   1281: astore 21
    //   1283: aload 5
    //   1285: invokestatic 285	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1288: ifeq +68 -> 1356
    //   1291: aload 4
    //   1293: astore 16
    //   1295: aload 5
    ...
    //   1339: aload 28
    //   1341: ldc_w 574
    //   1344: invokeinterface 580 2 0
    //   1349: invokeinterface 294 1 0
    //   1354: astore 9
    //   1356: aload 4
    //   1358: astore 16
    //   1360: aload 9
    ...
    //   1418: astore 25
    //   1420: aload 4
    //   1422: invokestatic 285	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1425: ifeq +632 -> 2057
    //   1428: aload 4
    //   1430: astore 16
    //   1432: aload 9
    ...
    //   1476: aload 28
    //   1478: ldc_w 590
    //   1481: invokeinterface 580 2 0
    //   1486: invokeinterface 294 1 0
    //   1491: astore 23
    //   1493: aload 9
    //   1495: astore 22
    //   1497: aload 6
    ...
    //   1576: aload 28
    //   1578: ldc_w 592
    //   1581: invokevirtual 566	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1584: ifeq +165 -> 1749
    //   1587: aload 4
    //   1589: astore 22
    //   1591: aload 5
    ...
    //   1653: astore 21
    //   1655: aload 8
    //   1657: invokestatic 285	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1660: ifeq +89 -> 1749
    //   1663: aload 4
    //   1665: astore 16
    //   1667: aload 5
    ...
    //   1709: astore 21
    //   1711: aload 27
    //   1713: invokeinterface 572 1 0
    //   1718: ldc_w 594
    //   1721: invokeinterface 580 2 0
    //   1726: invokeinterface 294 1 0
    //   1731: astore 25
    //   1733: aload 7
    //   1735: astore 9
    //   1737: aload 6
    ...
    //   1781: astore_0
    //   1782: bipush 6
    //   1784: anewarray 101	java/lang/String
    //   1787: dup
    //   1788: iconst_0
    //   1789: aload 7
    //   1791: aastore
    ...
    //   1834: astore 7
    //   1836: aload 9
    //   1838: invokevirtual 595	javax/xml/parsers/ParserConfigurationException:printStackTrace	()V
    //   1841: aload 6
    //   1843: astore 9
    //   1845: goto -63 -> 1782
    //   1848: astore 9
    ...
    //   1865: astore 7
    //   1867: aload 9
    //   1869: invokevirtual 596	org/xml/sax/SAXException:printStackTrace	()V
    //   1872: aload 6
    //   1874: astore 9
    //   1876: goto -94 -> 1782
    //   1879: astore 9
    ...
    //   1896: astore 7
    //   1898: aload 9
    //   1900: invokevirtual 597	java/io/IOException:printStackTrace	()V
    //   1903: aload 6
    //   1905: astore 9
    //   1907: goto -125 -> 1782
    //   1910: astore 9
