...
public class QlAndQQInterface$ReportNbFileContactScanInfo
  implements Serializable
{
  ...
  public QlAndQQInterface$ReportNbFileContactScanInfo(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString1, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, String paramString2)
  {
 ...
 * Qualified Name:     cooperation.qlink.QlAndQQInterface.ReportNbFileContactScanInfo
