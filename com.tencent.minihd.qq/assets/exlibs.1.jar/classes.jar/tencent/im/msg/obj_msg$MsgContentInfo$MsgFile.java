  ...
  extends MessageMicro
{
  ...
  public static final int INT64_DEAD_TIME_FIELD_NUMBER = 5;
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 40 }, new String[] { "uint32_bus_id", "bytes_file_path", "uint64_file_size", "str_file_name", "int64_dead_time" }, new Object[] { Integer.valueOf(0), localByteStringMicro, Long.valueOf(0L), "", Long.valueOf(0L) }, MsgFile.class);
  }
}
