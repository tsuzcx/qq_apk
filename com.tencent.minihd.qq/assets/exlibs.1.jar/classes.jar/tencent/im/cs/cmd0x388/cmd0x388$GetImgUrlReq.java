...
{
  public static final int BYTES_BUILD_VER_FIELD_NUMBER = 11;
  public static final int BYTES_FILE_MD5_FIELD_NUMBER = 4;
  public static final int UINT32_BU_TYPE_FIELD_NUMBER = 10;
  public static final int UINT32_INNER_IP_FIELD_NUMBER = 9;
  public static final int UINT32_ORIGINAL_PIC_FIELD_NUMBER = 14;
  public static final int UINT32_REQ_PLATFORM_TYPE_FIELD_NUMBER = 8;
  public static final int UINT32_REQ_TERM_FIELD_NUMBER = 7;
  public static final int UINT32_RETRY_REQ_FIELD_NUMBER = 15;
  public static final int UINT32_URL_FLAG_FIELD_NUMBER = 5;
  ...
  public static final int UINT64_FILE_ID_FIELD_NUMBER = 12;
  public static final int UINT64_FILE_SIZE_FIELD_NUMBER = 13;
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 48, 56, 64, 72, 80, 90, 96, 104, 112, 120 }, new String[] { "uint64_group_code", "uint64_dst_uin", "uint64_fileid", "bytes_file_md5", "uint32_url_flag", "uint32_url_type", "uint32_req_term", "uint32_req_platform_type", "uint32_inner_ip", "uint32_bu_type", "bytes_build_ver", "uint64_file_id", "uint64_file_size", "uint32_original_pic", "uint32_retry_req" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), localByteStringMicro1, Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), localByteStringMicro2, Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0) }, GetImgUrlReq.class);
  }
}
