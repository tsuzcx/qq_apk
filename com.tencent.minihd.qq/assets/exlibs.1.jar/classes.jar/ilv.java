...
{
  public ilv(QfileBaseCloudFileTabView paramQfileBaseCloudFileTabView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (paramView != null) {
      if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 1)
      {
        ...
        if ((FileManagerUtil.a()) && (paramView.fileSize > 5242880L)) {
          FMDialogUtil.a(this.a.getContext(), 2131362469, 2131362465, new ilw(this, paramView));
        }
      }
    }
    for (;;)
    {
      ...
      if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 3)
      {
        ...
        if ((FileManagerUtil.a()) && (paramView.fileSize > 5242880L)) {
          FMDialogUtil.a(this.a.getContext(), 2131362469, 2131362465, new ilx(this, paramView));
        } else {
      ...
      else if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 0)
      {
        ...
        ((ForwardFileInfo)localObject).d(paramView.cloudType);
      ...
      else if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 2)
      {
        ...
        {
          FMDialogUtil.a(this.a.getContext(), 2131362469, 2131362465, new ily(this, localWeiYunFileInfo));
        }
        else
        {
          paramView = FileManagerUtil.a(localWeiYunFileInfo);
          QfileBaseCloudFileTabView.m(this.a).a().b(paramView);
