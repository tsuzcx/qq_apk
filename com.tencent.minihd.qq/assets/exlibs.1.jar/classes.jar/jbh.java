...
{
  public jbh(UniformDownloaderAppBabySdk paramUniformDownloaderAppBabySdk) {}
  
  public void OnDownloadSDKTaskProgressChanged(TMAssistantDownloadClient paramTMAssistantDownloadClient, String paramString, long paramLong1, long paramLong2)
  {
    UniformDownloaderAppBabySdk.b(this.a);
    if (!UniformDownloaderAppBabySdk.a(this.a).post(new jbi(this, paramString, paramLong1, paramLong2))) {
  ...
  public void OnDownloadSDKTaskStateChanged(TMAssistantDownloadClient paramTMAssistantDownloadClient, String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    if ((paramTMAssistantDownloadClient != null) && (4 == paramInt1))
    {
      ...
      catch (Exception paramTMAssistantDownloadClient)
      {
        ...
        } while (UniformDownloaderAppBabySdk.a(this.a).post(new jbk(this, paramString1, paramInt1, paramInt2, paramString2, (String)localObject1)));
        QLog.e(UniformDownloaderAppBabySdk.a, 1, "[UniformDL] OnDownloadSDKTaskProgressChanged. thread error!!");
        return;
      }
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        if (!UniformDownloaderAppBabySdk.a(this.a).post(new jbj(this, paramString1, j, paramTMAssistantDownloadClient))) {
  ...
  public void OnDwonloadSDKServiceInvalid(TMAssistantDownloadClient paramTMAssistantDownloadClient)
  {
    ...
    UniformDownloaderAppBabySdk.b(this.a);
    if (!UniformDownloaderAppBabySdk.a(this.a).post(new jbl(this))) {
