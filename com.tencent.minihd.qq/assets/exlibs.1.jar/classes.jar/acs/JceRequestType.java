...
public final class JceRequestType
{
  ...
  public static final JceRequestType a;
  private static JceRequestType[] jdField_a_of_type_ArrayOfAcsJceRequestType;
  ...
  static
  {
    if (!JceRequestType.class.desiredAssertionStatus()) {}
    for (boolean bool = true;; bool = false)
    {
      jdField_a_of_type_Boolean = bool;
      jdField_a_of_type_ArrayOfAcsJceRequestType = new JceRequestType[49];
      ...
      A = new JceRequestType(26, 26, "labelSearch");
      B = new JceRequestType(27, 27, "getCategory");
      C = new JceRequestType(28, 28, "getTopic");
      D = new JceRequestType(29, 29, "getHotwords");
      E = new JceRequestType(30, 30, "getShare");
      F = new JceRequestType(31, 31, "wordSearch");
      G = new JceRequestType(32, 32, "sortSoftwares");
      H = new JceRequestType(33, 33, "widgetDayRecommend");
      I = new JceRequestType(34, 34, "getAdvert");
      J = new JceRequestType(35, 35, "listFavoriten");
      K = new JceRequestType(36, 36, "addFavoriten");
      L = new JceRequestType(37, 37, "delFavoriten");
      M = new JceRequestType(38, 38, "editFavoriten");
      N = new JceRequestType(39, 39, "scoreFavoriten");
      O = new JceRequestType(40, 40, "listFavoritenSoft");
      P = new JceRequestType(41, 41, "addFavoritenSoft");
      Q = new JceRequestType(42, 42, "delFavoritenSoft");
      R = new JceRequestType(43, 43, "addLabel");
      S = new JceRequestType(44, 44, "getFeed");
      T = new JceRequestType(45, 45, "friendFeed");
      U = new JceRequestType(46, 46, "reportDownSoft");
      V = new JceRequestType(47, 47, "reportAdData");
      W = new JceRequestType(48, 48, "getConfig");
      return;
    }
  }
  ...
  public static JceRequestType a(int paramInt)
  {
    int i1 = 0;
    while (i1 < jdField_a_of_type_ArrayOfAcsJceRequestType.length)
    {
      if (jdField_a_of_type_ArrayOfAcsJceRequestType[i1].a() == paramInt) {
        return jdField_a_of_type_ArrayOfAcsJceRequestType[i1];
      }
      i1 += 1;
    }
  ...
  public static JceRequestType a(String paramString)
  {
    int i1 = 0;
    while (i1 < jdField_a_of_type_ArrayOfAcsJceRequestType.length)
    {
      if (jdField_a_of_type_ArrayOfAcsJceRequestType[i1].toString().equals(paramString)) {
        return jdField_a_of_type_ArrayOfAcsJceRequestType[i1];
      }
      i1 += 1;
    }
