...
public class jcl
  implements Runnable
{
  public jcl(MediaApiPlugin paramMediaApiPlugin, String paramString1, String paramString2, AtomicBoolean paramAtomicBoolean) {}
  ...
  public void run()
  {
    ...
    //   17: aload_0
    //   18: getfield 17	jcl:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   21: aconst_null
    //   22: ldc 45
    //   24: aconst_null
    //   25: aconst_null
    ...
    //   76: pop
    //   77: aload_0
    //   78: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   81: aload 6
    ...
    //   121: pop
    //   122: aload_0
    //   123: getfield 19	jcl:b	Ljava/lang/String;
    //   126: invokestatic 104	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   129: ifne +38 -> 167
    //   132: aload_0
    //   133: getfield 21	jcl:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   136: iconst_0
    //   137: iconst_1
    //   138: invokevirtual 110	java/util/concurrent/atomic/AtomicBoolean:compareAndSet	(ZZ)Z
    //   141: ifeq +26 -> 167
    //   144: aload_0
    //   145: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   148: aload_0
    //   149: getfield 19	jcl:b	Ljava/lang/String;
    //   152: iconst_1
    ...
    //   167: aload_0
    //   168: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   171: getfield 123	com/tencent/mobileqq/jsp/MediaApiPlugin:a	Lcom/tencent/mobileqq/widget/QQProgressDialog;
    //   174: ifnull +26 -> 200
    //   177: aload_0
    //   178: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    ...
    //   187: ifeq +13 -> 200
    //   190: aload_0
    //   191: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    ...
    //   272: istore_3
    //   273: aload_0
    //   274: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   277: getfield 123	com/tencent/mobileqq/jsp/MediaApiPlugin:a	Lcom/tencent/mobileqq/widget/QQProgressDialog;
    //   280: ifnull +30 -> 310
    //   283: iload_2
    //   284: istore_3
    //   285: aload_0
    //   286: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    ...
    //   295: ifeq +15 -> 310
    //   298: aload_0
    //   299: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    ...
    //   342: pop
    //   343: aload_0
    //   344: getfield 19	jcl:b	Ljava/lang/String;
    //   347: invokestatic 104	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   350: ifne -150 -> 200
    //   353: aload_0
    //   354: getfield 21	jcl:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   357: iconst_0
    //   358: iconst_1
    //   359: invokevirtual 110	java/util/concurrent/atomic/AtomicBoolean:compareAndSet	(ZZ)Z
    //   362: ifeq -162 -> 200
    //   365: aload_0
    //   366: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   369: aload_0
    //   370: getfield 19	jcl:b	Ljava/lang/String;
    //   373: iconst_1
    ...
    //   425: pop
    //   426: aload_0
    //   427: getfield 19	jcl:b	Ljava/lang/String;
    //   430: invokestatic 104	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   433: ifne +38 -> 471
    //   436: aload_0
    //   437: getfield 21	jcl:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   440: iconst_0
    //   441: iconst_1
    //   442: invokevirtual 110	java/util/concurrent/atomic/AtomicBoolean:compareAndSet	(ZZ)Z
    //   445: ifeq +26 -> 471
    //   448: aload_0
    //   449: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   452: aload_0
    //   453: getfield 19	jcl:b	Ljava/lang/String;
    //   456: iconst_1
    ...
    //   471: aload_0
    //   472: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   475: getfield 123	com/tencent/mobileqq/jsp/MediaApiPlugin:a	Lcom/tencent/mobileqq/widget/QQProgressDialog;
    //   478: ifnull -278 -> 200
    //   481: aload_0
    //   482: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    ...
    //   491: ifeq -291 -> 200
    //   494: aload_0
    //   495: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    ...
    //   510: istore_3
    //   511: aload_0
    //   512: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   515: getfield 123	com/tencent/mobileqq/jsp/MediaApiPlugin:a	Lcom/tencent/mobileqq/widget/QQProgressDialog;
    //   518: ifnull -208 -> 310
    //   521: iload_1
    //   522: istore_3
    //   523: aload_0
    //   524: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    ...
    //   533: ifeq -223 -> 310
    //   536: aload_0
    //   537: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    ...
    //   551: astore 4
    //   553: aload_0
    //   554: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   557: getfield 123	com/tencent/mobileqq/jsp/MediaApiPlugin:a	Lcom/tencent/mobileqq/widget/QQProgressDialog;
    //   560: ifnull +26 -> 586
    //   563: aload_0
    //   564: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    ...
    //   573: ifeq +13 -> 586
    //   576: aload_0
    //   577: getfield 15	jcl:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
