...
public class iko
  extends AsyncTask
{
  public iko(LocalFileBrowserActivity paramLocalFileBrowserActivity, boolean paramBoolean) {}
  ...
  protected void a(List paramList)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        if (!this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityLocalFileBrowserActivity.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.i()) {
