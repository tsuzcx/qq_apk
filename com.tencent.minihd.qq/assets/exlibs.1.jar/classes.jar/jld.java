...
{
  public jld(TroopSystemMessage paramTroopSystemMessage) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      ((FriendListHandler)TroopSystemMessage.a(this.a).a(1)).b(String.valueOf(TroopSystemMessage.a(this.a).structMsg.req_uin.get()));
