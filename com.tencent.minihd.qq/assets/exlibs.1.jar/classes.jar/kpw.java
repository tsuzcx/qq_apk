  ...
  extends AsyncTask
{
  ...
  public kpw(ImageWorker paramImageWorker, View paramView)
  {
  ...
  {
    View localView = a();
    kpy localkpy = (kpy)ImageWorker.a(this.jdField_a_of_type_ComTencentMobileqqUtilImageWorker).remove(localView);
    ...
    if (localView != null)
    {
      ...
      if ((localkpy != null) && (localkpy.a != null)) {
        localkpy.a.a(localView, null);
      }
    }
    return;
    label72:
    ImageWorker.a(this.jdField_a_of_type_ComTencentMobileqqUtilImageWorker, this.jdField_a_of_type_Boolean, localView, paramDrawable, localkpy);
  }
}
