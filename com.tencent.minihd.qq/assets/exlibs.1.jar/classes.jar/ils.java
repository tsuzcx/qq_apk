...
{
  ils(ilr paramilr, View paramView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView instanceof QfileWeiYunImageExpandableListAdapter.ImageHolder))
    {
      ...
      QfileBaseCloudFileTabView.c(this.jdField_a_of_type_Ilr.a).a().a(paramView);
      QfileBaseCloudFileTabView.a(this.jdField_a_of_type_Ilr.a);
    }
    do
    {
      return;
