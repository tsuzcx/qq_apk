...
public class ioy
  implements Runnable
{
  public ioy(QfileLocalFilePicTabView paramQfileLocalFilePicTabView, Context paramContext) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      FileCategoryUtil.a(AppConstants.aP, ".jpg|.bmp|.jpeg|.gif|.png|.ico|", "", localHashMap, null);
