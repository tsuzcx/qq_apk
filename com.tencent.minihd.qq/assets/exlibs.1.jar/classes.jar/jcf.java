...
{
  public jcf(DataApiPlugin paramDataApiPlugin) {}
  ...
  public void onResponse(Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && (paramBundle.getInt("respkey", 0) == this.a.a.key))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.i(DataApiPlugin.b, 2, "response:" + (String)localObject);
      }
      ...
      if ("getFaceFilePath".equals(localObject))
      {
        ...
        if (paramBundle == null)
        {
          ...
          if (!TextUtils.isEmpty(str1))
          {
            ...
            if (QLog.isColorLevel())
            {
              QLog.i(DataApiPlugin.b, 2, "response IPC_FUNC_CMD_GET_FACE_FILE_PATH error: " + paramBundle.getMessage());
              return;
        ...
        else
        {
          ...
          String str2 = Base64Util.encodeToString(((ByteArrayOutputStream)localObject).toByteArray(), 2);
