  ...
  extends BitmapDrawable
{
  ...
  public jow(Resources paramResources, Bitmap paramBitmap)
  {
    super(paramResources, paramBitmap);
  }
  
  public static jow[] a(int paramInt, Resources paramResources, Bitmap paramBitmap)
  {
    if ((paramBitmap != null) && (paramResources != null))
    {
      jow[] arrayOfjow2 = new jow[paramInt];
      i = paramBitmap.getWidth() / 2;
      h = paramBitmap.getHeight() / 2;
      int j = 0;
      for (;;)
      {
        arrayOfjow1 = arrayOfjow2;
        if (j >= paramInt) {
          break;
        }
        arrayOfjow2[j] = new jow(paramResources, paramBitmap);
        j += 1;
      }
    }
    jow[] arrayOfjow1 = null;
    return arrayOfjow1;
  }
