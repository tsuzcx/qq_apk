  ...
  extends View.DragShadowBuilder
{
  ...
  public jke(NearbyProfileEditPanel paramNearbyProfileEditPanel, View paramView)
  {
    super(paramView);
    this.jdField_a_of_type_Int = ((int)(NearbyProfileEditPanel.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyProfileEditPanel).p * 1.4D));
  }
