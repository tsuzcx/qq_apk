...
public class iuq
  implements Runnable
{
  public iuq(UniformDownloadMgr paramUniformDownloadMgr, String paramString, Bundle paramBundle) {}
  ...
  public void run()
  {
    ...
    ius localius = UniformDownloadMgr.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreUniformDownloadMgr, this.jdField_a_of_type_JavaLangString);
    if ((localius != null) && (this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreUniformDownloadMgr.a != null))
    {
      if (localius.a != 1) {
        break label175;
      }
