  ...
  extends MessageMicro
{
  ...
  public static final int DIRECTION_FLAG_FIELD_NUMBER = 10;
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48, 58, 66, 72, 80 }, new String[] { "c2c_type", "service_type", "group_uin", "group_code", "sig", "sig_type", "from_phone", "to_phone", "lock_display", "direction_flag" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), Long.valueOf(0L), Long.valueOf(0L), localByteStringMicro, Integer.valueOf(0), "", "", Integer.valueOf(0), Integer.valueOf(0) }, C2CTmpMsgHead.class);
  }
}
