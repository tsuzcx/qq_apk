...
public class jcm
  implements Runnable
{
  public jcm(MediaApiPlugin paramMediaApiPlugin, String paramString1, String paramString2, AtomicBoolean paramAtomicBoolean) {}
  ...
  public void run()
  {
    ...
    //   17: astore_2
    //   18: aload_0
    //   19: getfield 17	jcm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   22: ldc 45
    //   24: invokevirtual 51	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   27: ifeq +32 -> 59
    //   30: aload_0
    //   31: getfield 17	jcm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   34: bipush 44
    ...
    //   43: ifle +16 -> 59
    //   46: aload_0
    //   47: getfield 17	jcm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   50: iload_1
    ...
    //   95: pop
    //   96: aload_0
    //   97: getfield 19	jcm:b	Ljava/lang/String;
    //   100: invokestatic 89	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   103: ifne +38 -> 141
    //   106: aload_0
    //   107: getfield 21	jcm:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   110: iconst_0
    //   111: iconst_1
    //   112: invokevirtual 95	java/util/concurrent/atomic/AtomicBoolean:compareAndSet	(ZZ)Z
    //   115: ifeq +26 -> 141
    //   118: aload_0
    //   119: getfield 15	jcm:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   122: aload_0
    //   123: getfield 19	jcm:b	Ljava/lang/String;
    //   126: iconst_1
    ...
    //   141: return
    //   142: aload_0
    //   143: getfield 15	jcm:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   146: aload_2
    //   147: invokestatic 108	com/tencent/mobileqq/jsp/MediaApiPlugin:a	(Lcom/tencent/mobileqq/jsp/MediaApiPlugin;[B)Ljava/lang/String;
    //   150: astore_2
    //   151: aload 4
    //   153: ldc 68
    //   155: iconst_0
