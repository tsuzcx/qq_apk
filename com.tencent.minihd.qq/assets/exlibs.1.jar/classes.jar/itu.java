...
public class itu
  extends isw
{
  public itu(OnlineFileSessionWorker paramOnlineFileSessionWorker)
  {
  ...
  protected void a()
  {
    ...
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "] state change :(" + this.jdField_a_of_type_Isw.a() + "->StateSenderCancelSend)");
    this.jdField_a_of_type_Isw = new itt(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker);
  }
}
