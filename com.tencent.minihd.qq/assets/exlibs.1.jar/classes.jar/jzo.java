...
{
  public jzo(C2CPicUploadProcessor paramC2CPicUploadProcessor, long paramLong) {}
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    ThreadManager.b(new jzq(this, l2, l3, l4, l5));
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.h = this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.jdField_a_of_type_Long;
    this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.t();
    ThreadManager.b(new jzp(this, l2, l3, l4, l5));
  ...
  public void onSwitch2BackupChannel()
  {
    ...
    switch (this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.aO)
    {
    default: 
      return;
    case 0: 
    ...
    this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.aO = 2;
  ...
  public void onUpdateProgress(int paramInt)
  {
    ...
    if ((paramInt < this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.jdField_a_of_type_Long) && (!this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.i) && (!this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.e)) {
