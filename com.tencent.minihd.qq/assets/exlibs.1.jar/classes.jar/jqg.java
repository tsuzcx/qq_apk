  ...
  implements RedTouchManager.BannerInfoHandler
{
  ...
  public boolean a(VipBannerInfo paramVipBannerInfo)
  {
    ...
    {
      this.a.jdField_a_of_type_AndroidContentSharedPreferences.edit().putLong("blue_banner_time_out" + this.a.jdField_a_of_type_ComTencentMobileqqActivityConversation.app.getAccount(), System.currentTimeMillis() + paramVipBannerInfo.jdField_a_of_type_Long).commit();
      ...
      if ((1 != m) || (VipUtils.b(this.a.jdField_a_of_type_ComTencentMobileqqActivityConversation.app))) {
        break label378;
      }
      i = 1;
      if ((2 != m) || (VipUtils.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityConversation.app))) {
        break label383;
      }
      j = 1;
      if ((3 != m) || (!VipUtils.b(this.a.jdField_a_of_type_ComTencentMobileqqActivityConversation.app))) {
        break label388;
      }
      k = 1;
      label210:
      if ((4 != m) || (!VipUtils.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityConversation.app))) {
        break label394;
      }
    }
    label388:
    ...
    for (int m = 1;; m = 0)
    {
      ...
      return true;
      long l = this.a.jdField_a_of_type_AndroidContentSharedPreferences.getLong("blue_banner_time_out" + this.a.jdField_a_of_type_ComTencentMobileqqActivityConversation.app.getAccount(), -1L);
