  ...
  extends JceStruct
{
  ...
  public template_gift_item(long paramLong, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, text_region paramtext_region, boolean paramBoolean, int paramInt1, int paramInt2, String paramString6)
  {
    this.id = paramLong;
