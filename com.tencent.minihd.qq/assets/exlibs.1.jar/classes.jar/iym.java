...
public class iym
  implements Runnable
{
  public iym(LocalVideoFileView paramLocalVideoFileView) {}
  ...
  public void run()
  {
    ...
    for (int i = LocalVideoFileView.a(this.a).b();; i = LocalVideoFileView.a(this.a))
    {
      if (LocalVideoFileView.a(this.a).getBackground() == null)
      {
        ...
        FileManagerUtil.a(LocalVideoFileView.a(this.a), bool1, k, m, LocalVideoFileView.a(this.a) * 1000, new iyn(this));
      }
