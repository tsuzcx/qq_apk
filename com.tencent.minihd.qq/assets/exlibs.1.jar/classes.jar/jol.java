...
{
  public jol(ProfileTagView paramProfileTagView, View paramView, PointF paramPointF) {}
  ...
  public void a(ValueAnimation paramValueAnimation, float paramFloat, Float paramFloat1, Transformation paramTransformation)
  {
    ...
    float f1 = ProfileTagView.a(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileTagView).x;
    ...
    float f4 = ProfileTagView.a(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileTagView).y;
