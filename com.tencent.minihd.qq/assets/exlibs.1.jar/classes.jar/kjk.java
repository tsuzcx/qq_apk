...
public class kjk
  implements Runnable
{
  public kjk(TroopBarPostLayoutBanner paramTroopBarPostLayoutBanner, View paramView) {}
  ...
  public void run()
  {
    ...
    TroopBarUtils.a((BaseActivity)localObject2, localBundle, "https://xiaoqu.qq.com/cgi-bin/bar/user/fbar", 2, null, this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPostLayoutBanner.a);
