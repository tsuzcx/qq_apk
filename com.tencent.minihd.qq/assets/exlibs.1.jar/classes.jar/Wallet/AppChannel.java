...
{
  static ArrayList cache_vecSubAppChannel;
  ...
  public ArrayList vecSubAppChannel = null;
  ...
  public void readFrom(JceInputStream paramJceInputStream)
  {
    ...
    this.reversalURL = paramJceInputStream.readString(22, false);
    if (cache_vecSubAppChannel == null)
    {
      cache_vecSubAppChannel = new ArrayList();
      AppChannel localAppChannel = new AppChannel();
      cache_vecSubAppChannel.add(localAppChannel);
    }
    this.vecSubAppChannel = ((ArrayList)paramJceInputStream.read(cache_vecSubAppChannel, 23, false));
    this.cellWidth = paramJceInputStream.read(this.cellWidth, 24, false);
  }
  ...
  public void writeTo(JceOutputStream paramJceOutputStream)
  {
    ...
    if (this.reversalURL != null) {
      paramJceOutputStream.write(this.reversalURL, 22);
    }
    if (this.vecSubAppChannel != null) {
      paramJceOutputStream.write(this.vecSubAppChannel, 23);
    }
    paramJceOutputStream.write(this.cellWidth, 24);
  }
}
