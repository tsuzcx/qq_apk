  ...
  extends FragmentManager
{
  ...
  public void addFragment(Fragment paramFragment, boolean paramBoolean)
  {
    ...
    if ((DEBUG) && (QLog.isDevelopLevel())) {
      QLog.d("FragmentManager", 4, "add: " + paramFragment);
    }
  ...
  public int allocBackStackIndex(BackStackRecord paramBackStackRecord)
  {
    try
    {
      if ((this.mAvailBackStackIndices == null) || (this.mAvailBackStackIndices.size() <= 0))
      {
        ...
        if ((DEBUG) && (QLog.isDevelopLevel())) {
          QLog.d("FragmentManager", 4, "Setting back stack index " + i + " to " + paramBackStackRecord);
        }
      ...
      if ((DEBUG) && (QLog.isDevelopLevel())) {
        QLog.d("FragmentManager", 4, "Adding back stack index " + i + " with " + paramBackStackRecord);
      }
  ...
  {
    if ((DEBUG) && (QLog.isDevelopLevel())) {
      QLog.d("FragmentManager", 4, "attach: " + paramFragment);
    }
    if (paramFragment.mDetached)
    {
      ...
      if (!paramFragment.mAdded)
      {
        ...
        if ((DEBUG) && (QLog.isDevelopLevel())) {
          QLog.d("FragmentManager", 4, "add from attach: " + paramFragment);
        }
        this.mAdded.add(paramFragment);
        paramFragment.mAdded = true;
        if ((paramFragment.mHasMenu) && (paramFragment.mMenuVisible)) {
  ...
  {
    if ((DEBUG) && (QLog.isDevelopLevel())) {
      QLog.d("FragmentManager", 4, "detach: " + paramFragment);
    }
    if (!paramFragment.mDetached)
    {
      ...
      if (paramFragment.mAdded)
      {
        ...
        {
          if ((DEBUG) && (QLog.isDevelopLevel())) {
            QLog.d("FragmentManager", 4, "remove from detach: " + paramFragment);
          }
  ...
  public void enqueueAction(Runnable paramRunnable, boolean paramBoolean)
  {
    ...
    //   1: ifne +7 -> 8
    //   4: aload_0
    //   5: invokespecial 507	android/support/v4/app/FragmentManagerImpl:checkStateLoss	()V
    //   8: aload_0
    //   9: monitorenter
    //   10: aload_0
    //   11: getfield 387	android/support/v4/app/FragmentManagerImpl:mDestroyed	Z
    //   14: ifne +10 -> 24
    //   17: aload_0
    //   18: getfield 215	android/support/v4/app/FragmentManagerImpl:mActivity	Landroid/support/v4/app/FragmentActivity;
    //   21: ifnonnull +19 -> 40
    //   24: new 126	java/lang/IllegalStateException
    //   27: dup
    //   28: ldc_w 509
    //   31: invokespecial 131	java/lang/IllegalStateException:<init>	(Ljava/lang/String;)V
    //   34: athrow
    //   35: astore_1
    //   36: aload_0
    //   37: monitorexit
    ...
    //   39: athrow
    //   40: aload_0
    //   41: getfield 473	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    //   44: ifnonnull +14 -> 58
    //   47: aload_0
    //   48: new 239	java/util/ArrayList
    //   51: dup
    //   52: invokespecial 240	java/util/ArrayList:<init>	()V
    //   55: putfield 473	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    //   58: aload_0
    //   59: getfield 473	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    //   62: aload_1
    //   63: invokevirtual 244	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   66: pop
    //   67: aload_0
    //   68: getfield 473	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    //   71: invokevirtual 301	java/util/ArrayList:size	()I
    //   74: iconst_1
    //   75: if_icmpne +32 -> 107
    //   78: aload_0
    //   79: getfield 215	android/support/v4/app/FragmentManagerImpl:mActivity	Landroid/support/v4/app/FragmentActivity;
    //   82: getfield 513	android/support/v4/app/FragmentActivity:mHandler	Landroid/os/Handler;
    //   85: aload_0
    //   86: getfield 121	android/support/v4/app/FragmentManagerImpl:mExecCommit	Ljava/lang/Runnable;
    //   89: invokevirtual 519	android/os/Handler:removeCallbacks	(Ljava/lang/Runnable;)V
    //   92: aload_0
    //   93: getfield 215	android/support/v4/app/FragmentManagerImpl:mActivity	Landroid/support/v4/app/FragmentActivity;
    //   96: getfield 513	android/support/v4/app/FragmentActivity:mHandler	Landroid/os/Handler;
    //   99: aload_0
    //   100: getfield 121	android/support/v4/app/FragmentManagerImpl:mExecCommit	Ljava/lang/Runnable;
    //   103: invokevirtual 523	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   106: pop
    //   107: aload_0
    //   108: monitorexit
    //   109: return
  ...
  public void freeBackStackIndex(int paramInt)
  {
    try
    {
      ...
      if ((DEBUG) && (QLog.isDevelopLevel())) {
        QLog.d("FragmentManager", 4, "Freeing back stack index " + paramInt);
      }
  ...
  {
    if ((DEBUG) && (QLog.isDevelopLevel())) {
      QLog.d("FragmentManager", 4, "hide: " + paramFragment);
    }
  ...
  void makeActive(Fragment paramFragment)
  {
    ...
    for (;;)
    {
      ...
      while ((DEBUG) && (QLog.isDevelopLevel()))
      {
        QLog.d("FragmentManager", 4, "Allocated fragment index " + paramFragment);
        return;
  ...
  void makeInactive(Fragment paramFragment)
  {
    ...
    if ((DEBUG) && (QLog.isDevelopLevel())) {
      QLog.d("FragmentManager", 4, "Freeing fragment index " + paramFragment);
    }
  ...
  void moveToState(Fragment paramFragment, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    if (paramFragment.mState < paramInt1)
    {
      ...
      case 0: 
        if ((DEBUG) && (QLog.isDevelopLevel())) {
          QLog.d("FragmentManager", 4, "moveto CREATED: " + paramFragment);
        }
        j = paramInt1;
      ...
      case 1: 
        ...
        {
          if ((DEBUG) && (QLog.isDevelopLevel())) {
            QLog.d("FragmentManager", 4, "moveto ACTIVITY_CREATED: " + paramFragment);
          }
          if (!paramFragment.mFromLayout)
          {
    ...
    for (Object localObject1 = localObject2;; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        {
          if ((DEBUG) && (QLog.isDevelopLevel())) {
            QLog.d("FragmentManager", 4, "moveto STARTED: " + paramFragment);
          }
        ...
        if ((DEBUG) && (QLog.isDevelopLevel())) {
          QLog.d("FragmentManager", 4, "moveto RESUMED: " + paramFragment);
        }
      ...
      case 2: 
        do
        {
          ...
          {
            if ((DEBUG) && (QLog.isDevelopLevel())) {
              QLog.d("FragmentManager", 4, "movefrom RESUMED: " + paramFragment);
            }
          ...
          {
            if ((DEBUG) && (QLog.isDevelopLevel())) {
              QLog.d("FragmentManager", 4, "movefrom STARTED: " + paramFragment);
            }
          ...
          {
            if ((DEBUG) && (QLog.isDevelopLevel())) {
              QLog.d("FragmentManager", 4, "movefrom STOPPED: " + paramFragment);
            }
            paramFragment.performReallyStop();
          }
        } while (paramInt1 >= 2);
        if ((DEBUG) && (QLog.isDevelopLevel())) {
          QLog.d("FragmentManager", 4, "movefrom ACTIVITY_CREATED: " + paramFragment);
        }
        ...
        for (localObject1 = loadAnimation(paramFragment, paramInt2, false, paramInt3);; localObject1 = null)
        {
          ...
          break label1090;
          if ((DEBUG) && (QLog.isDevelopLevel())) {
            QLog.d("FragmentManager", 4, "movefrom CREATED: " + paramFragment);
          }
          if (!paramFragment.mRetaining) {
  ...
  boolean popBackStackState(Handler paramHandler, String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        if ((DEBUG) && (QLog.isDevelopLevel())) {
          QLog.d("FragmentManager", 4, "Popping back stack state: " + paramHandler.get(paramInt1));
        }
  ...
  {
    if ((DEBUG) && (QLog.isDevelopLevel())) {
      QLog.d("FragmentManager", 4, "remove: " + paramFragment + " nesting=" + paramFragment.mBackStackNesting);
    }
      ...
      if (paramParcelable.mActive != null)
      {
        ...
        if (paramArrayList != null)
        {
          ...
          while (i < paramArrayList.size())
          {
            ...
            if ((DEBUG) && (QLog.isDevelopLevel())) {
              QLog.d("FragmentManager", 4, "restoreAllState: re-attaching retained " + localObject1);
            }
        ...
        if (i < paramParcelable.mActive.length)
        {
          ...
          if (localObject1 != null)
          {
            ...
            if ((DEBUG) && (QLog.isDevelopLevel())) {
              QLog.d("FragmentManager", 4, "restoreAllState: active #" + i + ": " + localObject2);
            }
          ...
          for (;;)
          {
            ...
            if ((DEBUG) && (QLog.isDevelopLevel())) {
              QLog.d("FragmentManager", 4, "restoreAllState: avail #" + i);
            }
        ...
        if (paramParcelable.mAdded != null)
        {
          ...
          while (i < paramParcelable.mAdded.length)
          {
            ...
            if ((DEBUG) && (QLog.isDevelopLevel())) {
              QLog.d("FragmentManager", 4, "restoreAllState: added #" + i + ": " + paramArrayList);
            }
        ...
        while (i < paramParcelable.mBackStack.length)
        {
          ...
          {
            if (QLog.isDevelopLevel()) {
              QLog.d("FragmentManager", 4, "restoreAllState: back stack #" + i + " (index " + paramArrayList.mIndex + "): " + paramArrayList);
            }
      ...
      if (i < this.mActive.size())
      {
        ...
        for (int j = localFragment.mTarget.mIndex;; j = -1)
        {
          ...
          if (DEBUG)
          {
            ...
            if (QLog.isDevelopLevel())
            {
              QLog.d("FragmentManager", 4, "retainNonConfig: keeping retained " + localFragment);
              localObject3 = localObject2;
            }
          }
          i += 1;
  ...
  Parcelable saveAllState()
  {
    ...
    if (j < k)
    {
      ...
      if ((((Fragment)localObject1).mState > 0) && (((FragmentState)localObject2).mSavedFragmentState == null))
      {
        ...
        label301:
        if ((DEBUG) && (QLog.isDevelopLevel())) {
          QLog.d("FragmentManager", 4, "Saved state of " + localObject1 + ": " + ((FragmentState)localObject2).mSavedFragmentState);
        }
        i = 1;
      }
    }
    ...
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        QLog.d("FragmentManager", 4, "saveAllState: no fragments!");
        return null;
      }
      if (this.mAdded != null)
      {
        ...
        if (j > 0)
        {
          ...
          for (;;)
          {
            ...
            if ((DEBUG) && (QLog.isDevelopLevel())) {
              QLog.d("FragmentManager", 4, "saveAllState: adding fragment #" + i + ": " + this.mAdded.get(i));
            }
            i += 1;
          }
        }
      ...
      if (this.mBackStack != null)
      {
        ...
        if (j > 0)
        {
          ...
          for (;;)
          {
            ...
            if ((DEBUG) && (QLog.isDevelopLevel())) {
              QLog.d("FragmentManager", 4, "saveAllState: adding back stack #" + i + ": " + this.mBackStack.get(i));
            }
            i += 1;
          }
        }
  ...
  public void setBackStackIndex(int paramInt, BackStackRecord paramBackStackRecord)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 303	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   6: ifnonnull +14 -> 20
    //   9: aload_0
    //   10: new 239	java/util/ArrayList
    //   13: dup
    //   14: invokespecial 240	java/util/ArrayList:<init>	()V
    //   17: putfield 303	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   20: aload_0
    //   21: getfield 303	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   24: invokevirtual 301	java/util/ArrayList:size	()I
    //   27: istore 4
    //   29: iload 4
    //   31: istore_3
    //   32: iload_1
    ...
    //   41: ifeq +45 -> 86
    //   44: invokestatic 194	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   47: ifeq +39 -> 86
    //   50: ldc 32
    //   52: iconst_4
    //   53: new 135	java/lang/StringBuilder
    //   56: dup
    //   57: invokespecial 136	java/lang/StringBuilder:<init>	()V
    //   60: ldc_w 305
    //   63: invokevirtual 142	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   66: iload_1
    //   67: invokevirtual 308	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   70: ldc_w 310
    //   73: invokevirtual 142	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   76: aload_2
    //   77: invokevirtual 256	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   80: invokevirtual 146	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   83: invokestatic 259	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   86: aload_0
    //   87: getfield 303	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   90: iload_1
    //   91: aload_2
    //   92: invokevirtual 327	java/util/ArrayList:set	(ILjava/lang/Object;)Ljava/lang/Object;
    //   95: pop
    //   96: aload_0
    //   97: monitorexit
    //   98: return
    //   99: iload_3
    //   100: iload_1
    //   101: if_icmpge +87 -> 188
    //   104: aload_0
    //   105: getfield 303	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   108: aconst_null
    //   109: invokevirtual 244	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   112: pop
    //   113: aload_0
    //   114: getfield 297	android/support/v4/app/FragmentManagerImpl:mAvailBackStackIndices	Ljava/util/ArrayList;
    //   117: ifnonnull +14 -> 131
    //   120: aload_0
    //   121: new 239	java/util/ArrayList
    //   124: dup
    //   125: invokespecial 240	java/util/ArrayList:<init>	()V
    //   128: putfield 297	android/support/v4/app/FragmentManagerImpl:mAvailBackStackIndices	Ljava/util/ArrayList;
    //   131: getstatic 79	android/support/v4/app/FragmentManagerImpl:DEBUG	Z
    //   134: ifeq +35 -> 169
    //   137: invokestatic 194	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   140: ifeq +29 -> 169
    //   143: ldc 32
    //   145: iconst_4
    //   146: new 135	java/lang/StringBuilder
    //   149: dup
    //   150: invokespecial 136	java/lang/StringBuilder:<init>	()V
    //   153: ldc_w 1123
    //   156: invokevirtual 142	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   159: iload_3
    //   160: invokevirtual 308	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   163: invokevirtual 146	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   166: invokestatic 259	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   169: aload_0
    //   170: getfield 297	android/support/v4/app/FragmentManagerImpl:mAvailBackStackIndices	Ljava/util/ArrayList;
    //   173: iload_3
    //   174: invokestatic 587	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   177: invokevirtual 244	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   180: pop
    //   181: iload_3
    //   182: iconst_1
    //   183: iadd
    //   184: istore_3
    //   185: goto -86 -> 99
    //   188: getstatic 79	android/support/v4/app/FragmentManagerImpl:DEBUG	Z
    //   191: ifeq +45 -> 236
    //   194: invokestatic 194	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   197: ifeq +39 -> 236
    //   200: ldc 32
    //   202: iconst_4
    //   203: new 135	java/lang/StringBuilder
    //   206: dup
    //   207: invokespecial 136	java/lang/StringBuilder:<init>	()V
    //   210: ldc_w 321
    //   213: invokevirtual 142	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   216: iload_1
    //   217: invokevirtual 308	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   220: ldc_w 323
    //   223: invokevirtual 142	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   226: aload_2
    //   227: invokevirtual 256	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   230: invokevirtual 146	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   233: invokestatic 259	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   236: aload_0
    //   237: getfield 303	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   240: aload_2
    //   241: invokevirtual 244	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   244: pop
    //   245: goto -149 -> 96
    //   248: astore_2
    //   249: aload_0
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	253	0	this	FragmentManagerImpl
    //   0	253	1	paramInt	int
    //   0	253	2	paramBackStackRecord	BackStackRecord
    //   31	154	3	i	int
    //   27	9	4	j	int
    // Exception table:
    //   from	to	target	type
  ...
  {
    if ((DEBUG) && (QLog.isDevelopLevel())) {
      QLog.d("FragmentManager", 4, "show: " + paramFragment);
    }
    if (paramFragment.mHidden)
    {
