  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  void bumpBackStackNesting(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ((FragmentManagerImpl.DEBUG) && (QLog.isDevelopLevel())) {
        QLog.d("FragmentManager", 4, "Bump nesting in " + this + " by " + paramInt);
      }
      for (BackStackRecord.Op localOp = this.mHead; localOp != null; localOp = localOp.next)
      {
        ...
        if (localOp.fragment != null)
        {
          ...
          if ((FragmentManagerImpl.DEBUG) && (QLog.isDevelopLevel())) {
            QLog.d("FragmentManager", 4, "Bump nesting of " + localOp.fragment + " to " + localOp.fragment.mBackStackNesting);
          }
        }
        if (localOp.removed != null)
        {
          ...
          while (i >= 0)
          {
            ...
            localFragment.mBackStackNesting += paramInt;
            if ((FragmentManagerImpl.DEBUG) && (QLog.isDevelopLevel())) {
              QLog.d("FragmentManager", 4, "Bump nesting of " + localFragment + " to " + localFragment.mBackStackNesting);
            }
            i -= 1;
          }
        }
  ...
  int commitInternal(boolean paramBoolean)
  {
    ...
    if (FragmentManagerImpl.DEBUG)
    {
      if (QLog.isDevelopLevel()) {
        QLog.d("FragmentManager", 4, "Commit: " + this);
      }
  ...
  public void popFromBackStack(boolean paramBoolean)
  {
    ...
    {
      if (QLog.isDevelopLevel()) {
        QLog.d("FragmentManager", 4, "popFromBackStack: " + this);
      }
      dump("  ", null, new PrintWriter(new LogWriter("FragmentManager")), null);
    }
  ...
  {
    if ((FragmentManagerImpl.DEBUG) && (QLog.isDevelopLevel())) {
      QLog.d("FragmentManager", 4, "Run: " + this);
    }
      ...
      for (;;)
      {
        ...
        if (this.mManager.mAdded != null)
        {
          ...
          if (i < this.mManager.mAdded.size())
          {
            ...
            if ((FragmentManagerImpl.DEBUG) && (QLog.isDevelopLevel())) {
              QLog.d("FragmentManager", 4, "OP_REPLACE: adding=" + localObject1 + " old=" + localFragment);
            }
