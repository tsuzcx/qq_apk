...
public class kkw
  implements Runnable
{
  public kkw(TroopMessageManager paramTroopMessageManager, QQMessageFacade.RefreshMessageContext paramRefreshMessageContext, String paramString, int paramInt, long paramLong, boolean paramBoolean) {}
  
  public void run()
  {
    TroopMessageManager.a(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopMessageManager, this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade$RefreshMessageContext);
    int j = 0;
    ...
    if (localObject != null)
    {
      ...
      } while (MsgProxyUtils.n(localChatMessage.msgtype));
    }
    for (int i = (int)localChatMessage.shmsgseq;; i = 0)
    {
      ...
      for (boolean bool = true; (j == i) || (i <= this.jdField_a_of_type_Long); bool = false)
      {
        ...
        TroopMessageManager.d(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopMessageManager).a.post(new kkx(this));
        return;
      }
