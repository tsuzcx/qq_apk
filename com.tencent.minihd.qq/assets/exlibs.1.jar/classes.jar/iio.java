  ...
  extends FriendListObserver
{
  ...
  DialogInterface.OnClickListener jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new iip(this);
  DialogInterface.OnDismissListener jdField_a_of_type_AndroidContentDialogInterface$OnDismissListener = new iir(this);
  private QQCustomDialog jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog;
  DialogInterface.OnClickListener b = new iiq(this);
  
  public iio(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
          ...
          for (localObject4 = ((Bundle)localObject4).getString("AlertRightBtnText");; localObject4 = null)
          {
            ...
            else
            {
              ...
              if (localObject3 == null)
              {
                ...
                localObject1 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131365716);
              }
              if (localObject2 != null) {
                break label407;
              }
              ...
              localObject2 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131365720);
            }
            for (;;)
            {
              ...
              if ((this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener == null) || (this.b == null)) {
                this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.findViewById(2131297379).setVisibility(8);
              }
              return;
              i = 2131365715;
              break;
              ...
              {
                localObject1 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131365717);
                break label203;
              }
              if (this.jdField_a_of_type_Int == 3)
              {
                localObject1 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131365718);
                break label203;
              }
              localObject1 = localObject3;
              ...
              localObject1 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131365719);
              break label203;
              localObject3 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131365721);
              break label223;
              localObject3 = localObject2;
              ...
              localObject3 = localObject2;
              break label223;
              localObject2 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131365722);
              continue;
  ...
  protected void a(String paramString)
  {
    ...
    do
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.e.add(paramString);
        if (this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))
        {
  ...
  protected void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    byte b1 = (byte)this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.J;
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.f.contains(String.valueOf(paramObject))) {
      this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.f.remove(String.valueOf(paramObject));
    }
  }
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt)
  {
      ...
      for (;;)
      {
        ...
        if (paramBoolean)
        {
          ...
          try
          {
            ...
            {
              this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.J = paramInt;
              this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.a(this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.J));
              this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.jdField_b_of_type_JavaUtilHashMap.put(paramString1, Integer.valueOf(this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.J));
              return;
            }
          }
    ...
    this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.J = 0;
    this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.a(this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.J));
    this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.jdField_b_of_type_JavaUtilHashMap.put(paramString1, Integer.valueOf(this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.J));
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString, Bundle paramBundle)
  {
    ...
    paramString = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getResources().getString(2131369974);
