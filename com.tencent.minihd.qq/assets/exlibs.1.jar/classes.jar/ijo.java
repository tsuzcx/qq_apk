  ...
  extends TroopObserver
{
  ...
  public ijo(FMActivity paramFMActivity) {}
  ...
  protected void a(boolean paramBoolean, long paramLong1, int paramInt1, List paramList, long paramLong2, int paramInt2, String paramString)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            } while (this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFMActivity.e == null);
          ...
          localObject1 = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFMActivity.app.getManager(50);
        } while (((TroopManager)localObject1).a(String.valueOf(paramLong1)));
        paramString = ((TroopManager)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFMActivity.e);
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFMActivity.e;
