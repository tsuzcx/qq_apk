...
public class lxc
  implements Runnable
{
  public lxc(PhotoPlusBridgeActivity paramPhotoPlusBridgeActivity) {}
  ...
  public void run()
  {
    ...
    //   17: dup
    //   18: invokestatic 46	cooperation/photoplus/PhotoPlusBridgeActivity:a	()Ljava/lang/String;
    //   21: invokespecial 49	org/apache/http/client/methods/HttpGet:<init>	(Ljava/lang/String;)V
    //   24: astore_1
    //   25: new 51	org/apache/http/impl/client/DefaultHttpClient
    //   28: dup
    //   29: invokespecial 52	org/apache/http/impl/client/DefaultHttpClient:<init>	()V
    //   32: astore_2
    //   33: aload_2
    //   34: aload_1
    ...
    //   83: astore_2
    //   84: aload_2
    //   85: invokestatic 88	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    //   88: astore_1
    //   89: aload_2
    //   90: invokevirtual 93	java/io/InputStream:close	()V
    //   93: new 95	java/io/File
    //   96: dup
    //   97: invokestatic 98	cooperation/photoplus/PhotoPlusBridgeActivity:b	()Ljava/lang/String;
    ...
    //   115: pop
    //   116: new 95	java/io/File
    //   119: dup
    //   120: invokestatic 98	cooperation/photoplus/PhotoPlusBridgeActivity:b	()Ljava/lang/String;
    //   123: ldc 107
    ...
    //   183: aload_0
    //   184: getfield 12	lxc:a	Lcooperation/photoplus/PhotoPlusBridgeActivity;
    //   187: invokestatic 142	cooperation/photoplus/PhotoPlusBridgeActivity:a	(Lcooperation/photoplus/PhotoPlusBridgeActivity;)Lcom/tencent/util/WeakReferenceHandler;
    //   190: sipush 1004
