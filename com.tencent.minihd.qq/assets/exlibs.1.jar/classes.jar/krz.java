...
public final class krz
  extends AsyncTask
{
  public krz(String paramString1, int paramInt, String paramString2) {}
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_Int > 0))
        {
          ...
          Object localObject = QQUtils.a(ServerConfigManager.ConfigType.common, PerformanceReportUtils.q());
          if (localObject != null) {}
          try
          {
            if (QLog.isDevelopLevel()) {
          ...
          if ((l2 == 0L) || (SystemClock.uptimeMillis() < l2) || (SystemClock.uptimeMillis() - l2 >= l1))
          {
            ...
            StatisticCollector.a(BaseApplication.getContext()).a(QQUtils.a(), this.jdField_a_of_type_JavaLangString, PerformanceReportUtils.a(this.jdField_a_of_type_JavaLangString), 0L, 0L, (HashMap)localObject, PerformanceReportUtils.o());
