...
{
  public ihp(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  public void a(Face2FaceGroupProfile paramFace2FaceGroupProfile)
  {
    ...
    for (;;)
    {
      ...
      paramFace2FaceGroupProfile.E += 1;
      return;
      bool = false;
      break;
      label162:
  ...
  public void a(Face2FaceUserProfile paramFace2FaceUserProfile)
  {
    ...
    {
      localObject = Face2FaceAddFriendActivity.jdField_b_of_type_JavaLangString;
      StringBuilder localStringBuilder = new StringBuilder().append("onRecvMemberPush, from_type=").append(this.a.jdField_b_of_type_Int).append(",fromTroopUin=").append(this.a.e).append(",userProfile isNull=");
    ...
    do
    {
      ...
      do
      {
        ...
        l2 = l1 - this.a.h;
        if ((this.a.h == 0L) || (l2 >= 1000L) || (paramFace2FaceUserProfile.a != 0L)) {
          break label269;
        }
      ...
      QLog.d(Face2FaceAddFriendActivity.jdField_b_of_type_JavaLangString, 2, "onRecvMemberPush, delay=" + l2 + ", delayed=" + l3 + ",mLastToopMemberPushStamp=" + this.a.h);
      return;
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead)
  {
    ...
    QLog.d(Face2FaceAddFriendActivity.jdField_a_of_type_JavaLangString, 2, "onCloseFace2faceTroop, ret=" + i + ",seqNo=" + j + ",ver=" + k + ",errInfo=" + paramBusiRespHead + ",from_type=" + this.a.jdField_b_of_type_Int + ",fromTroopUin=" + this.a.e);
  }
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, String paramString)
  {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.jdField_b_of_type_JavaLangString, 2, "onJoinTroop, ret=" + i + ", seqNo=" + j + ",ver=" + k + ",errInfo=" + str + ",troopCode=" + paramString + ",from_type=" + this.a.jdField_b_of_type_Int + ",fromTroopUin=" + this.a.e);
      }
    ...
    for (paramBusiRespHead = paramBusiRespHead.e + "_" + ((Face2FaceGroupProfile)paramBusiRespHead).jdField_b_of_type_JavaLangString;; paramBusiRespHead = paramString)
    {
      ...
      break;
      ReportController.b(null, "P_CliOper", "Grp_set", "", "Radar_grp_guest", "suc_join", 0, 0, paramString, "5.9.3", "", this.a.app.a());
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, List paramList)
  {
    ...
    if (paramList == null)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 1) {
        DialogUtil.a(this.a, 230, this.a.getString(2131367300), "分享失败，请稍后重试", 2131365736, 2131366212, new ihq(this), null).show();
      }
    }
    label176:
    label182:
    do
    {
      do
      {
        ...
        paramBusiRespHead = paramBusiRespHead.str_result.get();
        if (QLog.isColorLevel()) {
          QLog.d(Face2FaceAddFriendActivity.jdField_b_of_type_JavaLangString, 2, "onOpenFace2faceTroop, ret=" + i + ",seqNo=" + j + ",ver=" + k + ",errInfo=" + paramBusiRespHead + ",from_type=" + this.a.jdField_b_of_type_Int + ",fromTroopUin=" + this.a.e);
        }
        if (i != 0) {
          break label418;
        }
    ...
    label418:
    DialogUtil.a(this.a, 230, this.a.getString(2131367300), "分享失败，请稍后重试", 2131365736, 2131366212, new ihr(this), null).show();
  }
}
