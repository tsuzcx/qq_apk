...
public class ife
  implements Runnable
{
  public ife(SogouEmoji paramSogouEmoji, String paramString1, String paramString2, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonSogouEmoji.a(this.jdField_a_of_type_JavaLangString, localArrayList, new iff(this));
    } while (!QLog.isColorLevel());
