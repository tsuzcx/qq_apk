...
{
  public klr(VideoPlayLogic paramVideoPlayLogic) {}
  ...
  protected void a(String paramString, List paramList, int paramInt)
  {
    ...
    if (VideoPlayLogic.a(this.a) == null)
    {
      ...
      paramString.leftMargin = VideoPlayLogic.a(this.a).getResources().getDimensionPixelSize(2131493264);
      paramString.rightMargin = VideoPlayLogic.a(this.a).getResources().getDimensionPixelSize(2131493265);
      paramString.topMargin = VideoPlayLogic.a(this.a).getResources().getDimensionPixelSize(2131493267);
