...
public class ivs
  implements Runnable
{
  public ivs(DiscFileOperator paramDiscFileOperator) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      {
        str1 = FileHttpUtils.a(FileManagerUtil.c(this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFilePath));
