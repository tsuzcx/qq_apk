  ...
  extends PagerAdapter
{
  ...
  private jqz(ActionListActivity paramActionListActivity) {}
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localGridView.setAdapter(new jqy(this.jdField_a_of_type_ComTencentMobileqqRichstatusActionListActivity, localStateTag.jdField_a_of_type_JavaUtilArrayList));
