...
public class MoloHandler
{
  ...
  private PCPushProxy.OnDownloadListener jdField_a_of_type_ComTencentOpenPcpushPCPushProxy$OnDownloadListener = new ct(this);
    ...
    for (;;)
    {
      try
      {
        ...
        if (localPkgEntry != null)
        {
          ...
          paramArrayOfByte.msg = this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.a().a().getString(2131362069);
          ...
          paramArrayOfByte.vipBubbleID = this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.f();
  ...
  public boolean a(String paramString)
  {
    ...
    if (bool)
    {
      ...
      while (paramString.hasNext())
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.b(6, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf(0), Boolean.valueOf(false), Boolean.valueOf(true), Long.valueOf(localDataLineMsgRecord.filesize) });
      }
    }
    return bool;
  }
