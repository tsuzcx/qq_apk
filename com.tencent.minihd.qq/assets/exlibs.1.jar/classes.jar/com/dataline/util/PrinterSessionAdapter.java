  ...
  extends TimeAdapter
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new dr(this);
  ...
  public PrinterSessionAdapter(PrinterActivity paramPrinterActivity, DataLineHandler paramDataLineHandler)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnLongClickListener = new dt(this);
  ...
  public boolean a(View paramView)
  {
    ...
    localObject1 = new du(this, (PrinterItemMsgRecord)localObject1, (Context)localObject2);
    ...
    this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow.a(new ds(this));
    return true;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (paramViewGroup = (PrinterItemMsgRecord)this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.a.a.get(paramInt);; paramViewGroup = null)
    {
      ...
      if (paramView == null)
      {
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903240, null);
        localItemHolder = new ItemHolder();
        localItemHolder.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131297440));
        ...
        localItemHolder.b((TextView)paramView.findViewById(2131297441));
        localObject = (RelativeLayout)paramView.findViewById(2131296361);
        localItemHolder.a().jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localObject);
        localItemHolder.a().jdField_a_of_type_ComDatalineUtilWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131297402));
        localItemHolder.a().jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297403));
        localItemHolder.a().jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131297407));
        localItemHolder.a().jdField_a_of_type_ComDatalineUtilWidgetAsyncImageView.setDefaultImage(2130842125);
        localItemHolder.a().jdField_a_of_type_ComDatalineUtilWidgetAsyncImageView.setIsDrawRound(false);
        localItemHolder.a((TextView)paramView.findViewById(2131297050));
        ...
        localItemHolder.a().jdField_a_of_type_ComDatalineUtilWidgetAsyncImageView.setImageResource(2130839694);
      ...
      for (;;)
      {
        ...
        {
          localObject = (ChatBackgroundDrawable)this.jdField_a_of_type_ComDatalineActivitiesPrinterActivity.a.getTag(2131296425);
          if (localObject != null)
          {
