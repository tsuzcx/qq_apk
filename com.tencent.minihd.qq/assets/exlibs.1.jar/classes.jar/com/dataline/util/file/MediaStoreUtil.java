...
public class MediaStoreUtil
{
  ...
  public static String a(String paramString)
  {
    ...
    //   5: invokevirtual 124	java/lang/Class:newInstance	()Ljava/lang/Object;
    //   8: astore_2
    //   9: ldc 114
    //   11: invokestatic 120	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   14: ldc 126
    //   16: iconst_0
    //   17: anewarray 116	java/lang/Class
    //   20: invokevirtual 130	java/lang/Class:getMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   23: astore 5
    //   25: aload 5
    //   27: astore 4
    //   29: aload_2
    //   30: astore_3
    //   31: ldc 114
    //   33: invokestatic 120	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   36: ldc 132
    //   38: iconst_1
    //   39: anewarray 116	java/lang/Class
    //   42: dup
    //   43: iconst_0
    //   44: ldc 42
    //   46: aastore
    //   47: invokevirtual 130	java/lang/Class:getMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   50: aload_2
    //   51: iconst_1
    ...
    //   57: aload_0
    //   58: aastore
    //   59: invokevirtual 138	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   62: pop
    //   63: aload 5
    //   65: astore 4
    //   67: aload_2
    //   68: astore_3
    //   69: ldc 114
    //   71: invokestatic 120	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   74: ldc 140
    //   76: iconst_1
    //   77: anewarray 116	java/lang/Class
    //   80: dup
    //   81: iconst_0
    //   82: getstatic 146	java/lang/Integer:TYPE	Ljava/lang/Class;
    //   85: aastore
    //   86: invokevirtual 130	java/lang/Class:getMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   89: aload_2
    //   90: iconst_1
    ...
    //   95: iconst_0
    //   96: bipush 9
    //   98: invokestatic 150	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   101: aastore
    //   102: invokevirtual 138	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   105: checkcast 42	java/lang/String
    //   108: invokestatic 153	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   111: sipush 1000
    //   114: idiv
    //   115: istore_1
    //   116: aload 5
    ...
    //   131: sipush 3600
    //   134: idiv
    //   135: invokestatic 150	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   138: aastore
    //   139: dup
    //   140: iconst_1
    //   141: iload_1
    ...
    //   146: bipush 60
    //   148: idiv
    //   149: invokestatic 150	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   152: aastore
    //   153: dup
    //   154: iconst_2
    //   155: iload_1
    //   156: bipush 60
    //   158: irem
    //   159: invokestatic 150	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   162: aastore
    //   163: invokestatic 161	java/text/MessageFormat:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   166: astore_0
    //   167: aload 5
    //   169: ifnull +14 -> 183
    //   172: aload 5
    ...
    //   179: invokevirtual 138	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   182: pop
    //   183: aload_0
    //   184: areturn
    //   185: astore_2
    //   186: aload_2
    //   187: invokevirtual 162	java/lang/Exception:printStackTrace	()V
    //   190: aload_0
    //   191: areturn
    //   192: astore 6
    //   194: aconst_null
    ...
    //   218: invokevirtual 138	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   221: pop
    //   222: aconst_null
    //   223: areturn
    //   224: astore_0
    //   225: aload_0
    //   226: invokevirtual 162	java/lang/Exception:printStackTrace	()V
    //   229: aconst_null
    //   230: areturn
    //   231: astore_0
    //   232: aconst_null
    ...
    //   249: invokevirtual 138	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   252: pop
    //   253: aload_0
    //   254: athrow
    //   255: astore_2
    //   256: aload_2
    //   257: invokevirtual 162	java/lang/Exception:printStackTrace	()V
    //   260: goto -7 -> 253
    //   263: astore_0
    //   264: aconst_null
    //   265: astore 4
    ...
    //   185	2	2	localException1	Exception
    //   197	48	2	localObject2	Object
    //   255	2	2	localException2	Exception
    ...
    //   192	12	6	localException3	Exception
    //   276	1	6	localException4	Exception
    //   283	1	6	localException5	Exception
    // Exception table:
    //   from	to	target	type
  ...
  public static java.util.List a(Context paramContext, String paramString, int paramInt)
  {
    ...
    //   5: aconst_null
    //   6: iload_2
    //   7: invokestatic 165	com/dataline/util/file/MediaStoreUtil:a	(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;I)Landroid/database/Cursor;
    //   10: astore_0
    //   11: aload_0
    //   12: invokeinterface 171 1 0
    //   17: istore_2
    //   18: iload_2
    //   19: ifle +153 -> 172
    //   22: new 173	java/util/ArrayList
    //   25: dup
    //   26: iload_2
    //   27: invokespecial 176	java/util/ArrayList:<init>	(I)V
    //   30: astore_1
    //   31: aload_0
    //   32: ldc 48
    //   34: invokeinterface 179 2 0
    //   39: istore_2
    //   40: aload_0
    //   41: invokeinterface 183 1 0
    //   46: ifeq +64 -> 110
    //   49: aload_0
    //   50: iload_2
    ...
    //   58: ifnull -18 -> 40
    //   61: aload_3
    //   62: invokestatic 192	com/dataline/util/file/ImageInfo:a	(Ljava/lang/String;)Lcom/dataline/util/file/ImageInfo;
    //   65: astore_3
    //   66: aload_3
    //   67: ifnull -27 -> 40
    //   70: aload_1
    //   71: aload_3
    //   72: invokeinterface 198 2 0
    //   77: pop
    //   78: goto -38 -> 40
    //   81: astore_3
    //   82: aload_1
    ...
    //   89: astore_0
    //   90: aload_3
    //   91: invokevirtual 162	java/lang/Exception:printStackTrace	()V
    //   94: aload_0
    //   95: astore_3
    //   96: aload_1
    //   97: ifnull +11 -> 108
  ...
  public static java.util.List b(Context paramContext, String paramString, int paramInt)
  {
    ...
    //   5: aconst_null
    //   6: iload_2
    //   7: invokestatic 227	com/dataline/util/file/MediaStoreUtil:b	(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;I)Landroid/database/Cursor;
    //   10: astore_0
    //   11: aload_0
    //   12: invokeinterface 171 1 0
    //   17: istore_2
