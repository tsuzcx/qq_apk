...
{
  private static final long jdField_a_of_type_Long = 9223372036854775807L;
  ...
  private static final String c = "pref_google_nice";
  private static final String d = "pref_ms_nice";
  private static final String e = "pref_policy_update_time";
  private static final String f = "pref_trans_service_status";
  ...
  private long a(long paramLong, AITranslator.TranslatorType paramTranslatorType)
  {
    ...
    do
    {
      ...
      switch (byf.a[paramTranslatorType.ordinal()])
      {
      }
  ...
  private void a(long paramLong, Context paramContext, TextTranslationItemBuilder.Holder paramHolder, String paramString, List paramList1, List paramList2, Language paramLanguage, Long arg9, TranslateCallback paramTranslateCallback, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        switch (byf.a[localTranslatorType.ordinal()])
        {
        case 1: 
          return;
        }
      ...
      if (!this.jdField_a_of_type_JavaUtilList.contains(str))
      {
        ...
        GoogleTranslator.a().a(paramContext, paramList2, paramLanguage, this.jdField_a_of_type_ComRookeryTranslateGoogleGoogleInfo.a(), localLong, new byc(this, str, paramLong, paramContext, paramHolder, paramString, paramLanguage, paramTranslateCallback, paramList1, paramList2, paramInt, localTranslatorType));
        continue;
        str = paramString + paramLanguage.toString() + "M";
        if (!this.jdField_a_of_type_JavaUtilList.contains(str))
        {
          this.jdField_a_of_type_JavaUtilList.add(str);
          MicrosoftTranslator.a().a(paramContext, paramList2, paramLanguage, localLong, this.jdField_a_of_type_ComRookeryTranslateMicrosoftMicrosoftInfo.a(), this.jdField_a_of_type_ComRookeryTranslateMicrosoftMicrosoftInfo.b(), new byd(this, str, paramLong, paramContext, paramHolder, paramString, paramLanguage, paramTranslateCallback, paramList1, paramList2, paramInt, localTranslatorType));
        }
      }
    }
  }
  ...
  private void a(Context paramContext)
  {
    ...
    if ((localLong.longValue() == 0L) || (System.currentTimeMillis() - localLong.longValue() > 86400000L)) {
      if (Build.VERSION.SDK_INT >= 9)
      {
        ...
        byg.a(paramContext, new bye(this, paramContext));
      }
    }
    while (!QLog.isColorLevel()) {
      for (;;)
