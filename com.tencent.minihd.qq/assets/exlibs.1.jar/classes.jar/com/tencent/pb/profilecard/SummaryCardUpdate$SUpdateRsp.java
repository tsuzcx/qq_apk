  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40, 50 }, new String[] { "cmd", "code", "version", "url", "interv", "buff" }, new Object[] { Integer.valueOf(3), Integer.valueOf(0), "", "", Integer.valueOf(0), "" }, SUpdateRsp.class);
