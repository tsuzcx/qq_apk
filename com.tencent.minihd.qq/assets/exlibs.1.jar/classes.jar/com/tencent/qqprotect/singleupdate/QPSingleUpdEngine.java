...
public class QPSingleUpdEngine
{
  ...
  final String jdField_c_of_type_JavaLangString = "qd-up.m.qq.com";
  final int jdField_d_of_type_Int = 2;
  final String jdField_d_of_type_JavaLangString = "TxSingleUpd.zip";
  ...
  public void a(QPSingleUpdateProto.Head paramHead, QPSingleUpdateProto.ReqBody paramReqBody)
  {
    ...
    int i = 0;
    while (i < "5.9.3".length())
    {
      localObject2 = localObject1;
      if ("5.9.3".charAt(i) != '.') {
        localObject2 = ((String)localObject1).concat(Character.toString("5.9.3".charAt(i)));
      }
      i += 1;
    ...
    Object localObject2 = ByteStringMicro.copyFrom(QQDeviceInfo.a("master").getBytes());
  ...
  public boolean a()
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        this.jdField_a_of_type_ComTencentQqprotectSingleupdateQPSinlgeUpdInfo.jdField_a_of_type_ArrayOfLqc[i].jdField_a_of_type_JavaLangString = new String(localObject4[i].bytes_name.get().toByteArray());
        this.jdField_a_of_type_ComTencentQqprotectSingleupdateQPSinlgeUpdInfo.jdField_a_of_type_ArrayOfLqc[i].jdField_b_of_type_JavaLangString = new String(localObject4[i].bytes_hash.get().toByteArray());
        i += 1;
      }
      i = ((InputStream)localObject3).read();
  ...
  public boolean c()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 65	com/tencent/qqprotect/singleupdate/QPSingleUpdEngine:jdField_a_of_type_ComTencentQqprotectSingleupdateQPSinlgeUpdInfo	Lcom/tencent/qqprotect/singleupdate/QPSinlgeUpdInfo;
    ...
    //   15: aload_0
    //   16: getfield 53	com/tencent/qqprotect/singleupdate/QPSingleUpdEngine:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   33: invokevirtual 95	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   36: astore_2
    //   37: new 82	java/io/File
    //   40: dup
    //   41: aload_2
    //   42: invokespecial 591	java/io/File:<init>	(Ljava/lang/String;)V
    //   45: astore 4
    //   47: aload 4
    //   49: invokevirtual 154	java/io/File:exists	()Z
    //   52: ifeq +9 -> 61
    //   55: aload 4
    //   57: invokevirtual 871	java/io/File:delete	()Z
    //   60: pop
    //   61: ldc 10
    //   63: iconst_0
    //   64: ldc_w 875
    //   67: invokestatic 824	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   70: new 877	java/net/URL
    //   73: dup
    //   74: ldc_w 879
    //   77: aload_3
    //   78: invokestatic 885	com/tencent/mobileqq/msf/sdk/MsfSdkUtils:insertMtype	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   81: invokespecial 886	java/net/URL:<init>	(Ljava/lang/String;)V
    //   84: invokevirtual 890	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   87: astore_3
    //   88: ldc 10
    //   90: iconst_0
    //   91: ldc_w 892
    //   94: invokestatic 824	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   97: new 894	java/io/BufferedInputStream
    //   100: dup
    //   101: aload_3
    //   102: invokevirtual 897	java/net/URLConnection:getInputStream	()Ljava/io/InputStream;
    //   105: invokespecial 900	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   108: astore_3
    //   109: ldc 10
    //   111: iconst_0
    //   112: ldc_w 902
    //   115: invokestatic 824	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   118: new 904	java/io/FileOutputStream
    //   121: dup
    //   122: aload_2
    //   123: invokespecial 905	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   126: astore_2
    //   127: ldc 10
    //   129: iconst_0
    //   130: ldc_w 907
    //   133: invokestatic 824	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   136: sipush 512
    //   139: newarray byte
    //   141: astore 4
    //   143: aload_3
    ...
    //   146: iconst_0
    //   147: sipush 512
    //   150: invokevirtual 908	java/io/BufferedInputStream:read	([BII)I
    //   153: istore_1
    //   154: iload_1
    //   155: iconst_m1
    ...
    //   162: iconst_0
    //   163: iload_1
    //   164: invokevirtual 911	java/io/FileOutputStream:write	([BII)V
    //   167: goto -24 -> 143
    //   170: astore_2
    //   171: aload_0
    //   172: getfield 61	com/tencent/qqprotect/singleupdate/QPSingleUpdEngine:jdField_a_of_type_ComTencentQqprotectSingleupdateQPSingleUpdReportSig	Lcom/tencent/qqprotect/singleupdate/QPSingleUpdReportSig;
    //   175: iconst_1
    //   176: putfield 914	com/tencent/qqprotect/singleupdate/QPSingleUpdReportSig:m	Z
    //   179: ldc 10
    //   181: iconst_0
    //   182: ldc_w 916
    //   185: invokestatic 824	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   188: iconst_0
    //   189: ireturn
    //   190: aload_2
    //   191: invokevirtual 917	java/io/FileOutputStream:close	()V
    //   194: aload_3
    //   195: invokevirtual 918	java/io/BufferedInputStream:close	()V
    //   198: aload_0
    //   199: getfield 61	com/tencent/qqprotect/singleupdate/QPSingleUpdEngine:jdField_a_of_type_ComTencentQqprotectSingleupdateQPSingleUpdReportSig	Lcom/tencent/qqprotect/singleupdate/QPSingleUpdReportSig;
    //   202: iconst_1
    //   203: putfield 921	com/tencent/qqprotect/singleupdate/QPSingleUpdReportSig:l	Z
    //   206: ldc 10
    //   208: iconst_0
    //   209: ldc_w 923
    //   212: invokestatic 824	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   215: aload_0
    //   216: getfield 61	com/tencent/qqprotect/singleupdate/QPSingleUpdEngine:jdField_a_of_type_ComTencentQqprotectSingleupdateQPSingleUpdReportSig	Lcom/tencent/qqprotect/singleupdate/QPSingleUpdReportSig;
    //   219: iconst_1
    //   220: putfield 921	com/tencent/qqprotect/singleupdate/QPSingleUpdReportSig:l	Z
    //   223: iconst_1
    //   224: ireturn
    //   225: astore_2
    //   226: aload_0
    //   227: getfield 61	com/tencent/qqprotect/singleupdate/QPSingleUpdEngine:jdField_a_of_type_ComTencentQqprotectSingleupdateQPSingleUpdReportSig	Lcom/tencent/qqprotect/singleupdate/QPSingleUpdReportSig;
    //   230: iconst_1
    //   231: putfield 926	com/tencent/qqprotect/singleupdate/QPSingleUpdReportSig:q	Z
    //   234: ldc 10
    //   236: iconst_0
    //   237: ldc_w 928
    //   240: invokestatic 824	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   243: goto -55 -> 188
