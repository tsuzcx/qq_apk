  ...
  extends WebViewPlugin
{
  ...
  private void a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    paramString1.putStringArrayList("image_url", paramString2);
    paramString1.putLong("req_share_id", 0L);
    int i1;
    if ((paramJSONObject instanceof QQBrowserActivity))
    {
      i1 = ((QQBrowserActivity)paramJSONObject).a(this, (byte)1);
      if (!QZoneShareManager.a(this.mRuntime.a(), paramJSONObject, paramString1, null, i1)) {
        break label164;
      }
    }
    label164:
  ...
  private void b(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    paramString1 = new jct(this, localHashMap, paramString6, paramString2, paramString3, paramString4, paramString1, paramString7);
    ...
    label222:
    for (this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog = ((QQBrowserActivity)paramJSONObject).a().a();; this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog = new QQProgressDialog(paramJSONObject, paramJSONObject.getResources().getDimensionPixelSize(2131492923)))
    {
      if (!this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.isShowing())
      {
        this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.b(2131367967);
        this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.show();
      }
      ThreadManager.a(new jcv(this, paramString5, localHashMap, paramString1));
      return;
    }
  }
  
  private void c(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    label431:
    label474:
    for (this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog = ((QQBrowserActivity)paramString1).a().a();; this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog = new QQProgressDialog(paramString1, paramString1.getResources().getDimensionPixelSize(2131492923)))
    {
      if (!this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.isShowing())
      {
        this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.b(2131367967);
      ...
      Share.a(paramJSONObject, this.jdField_a_of_type_AndroidContentContext, paramJSONObject.getAccount(), l1, 3000L, new jcw(this, localIntent));
      return;
    ...
    for (;;)
    {
      ...
      for (paramString3 = paramString3.name;; paramString3 = null)
      {
        ...
        for (;;)
        {
          ...
          callJs(this.q, new String[] { "false" });
          return;
          localIntent.putExtra("app_name", this.jdField_a_of_type_AndroidContentContext.getString(2131363661));
        }
  ...
  {
    return ((this.jdField_a_of_type_AndroidContentContext instanceof QQBrowserActivity)) && (((QQBrowserActivity)this.jdField_a_of_type_AndroidContentContext).a(paramString));
  }
  ...
  public void c(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ThreadManager.a(new jcr(this, localHashMap, str4, str5, str7, str1, paramString, str2, str3, str6));
        return;
      }
      catch (JSONException paramString) {}
      if (!QLog.isColorLevel()) {
      ...
      return;
      label346:
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog = new QQProgressDialog(localActivity, localActivity.getResources().getDimensionPixelSize(2131492923));
    }
    label370:
    if ("1".equals(str1))
    {
    ...
    c(paramString, str1, str2, str3, str4, str5, str6, str7);
  }
  ...
  public void e(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString.setAction("com.tencent.intent.QQ_FORWARD");
