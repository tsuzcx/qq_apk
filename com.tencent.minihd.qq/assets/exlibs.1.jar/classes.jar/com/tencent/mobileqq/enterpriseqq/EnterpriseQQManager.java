...
public class EnterpriseQQManager
{
  ...
  {
    this.jdField_a_of_type_JavaLangRunnable = new ihh(this);
    this.jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new ihi(this, 4, true, 0L, false, false, "EnterpriseQQManager");
  ...
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean, double paramDouble1, double paramDouble2)
  {
    ...
    {
      paramContext = (EnterpriseQQHandler)paramQQAppInterface.a(20);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    if ((paramQQAppInterface != null) && (!TextUtils.isEmpty(paramString1)))
    {
      paramQQAppInterface = (EnterpriseQQHandler)paramQQAppInterface.a(20);
      if (paramQQAppInterface != null) {
