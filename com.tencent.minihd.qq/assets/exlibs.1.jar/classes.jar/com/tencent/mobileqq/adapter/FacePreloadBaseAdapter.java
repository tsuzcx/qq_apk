  ...
  implements FaceDecoder.DecodeTaskCompletionListener, AbsListView.OnScrollListener
{
  ...
  protected Bitmap a(int paramInt, String paramString)
  {
    ...
    try
    {
      paramString = BitmapFactory.decodeResource(BaseApplicationImpl.a().getResources(), 2130840890);
      return paramString;
    }
    ...
    while (i < j)
    {
      ...
      if ((localObject != null) && ((localObject instanceof FacePreloadBaseAdapter.ViewHolder)))
      {
        ...
        if ((localObject != null) && (((FacePreloadBaseAdapter.ViewHolder)localObject).b != null) && (((FacePreloadBaseAdapter.ViewHolder)localObject).b.length() > 0)) {
          ((FacePreloadBaseAdapter.ViewHolder)localObject).d.setImageBitmap(a(this.jdField_b_of_type_Int, ((FacePreloadBaseAdapter.ViewHolder)localObject).b));
        }
      }
      i += 1;
      continue;
