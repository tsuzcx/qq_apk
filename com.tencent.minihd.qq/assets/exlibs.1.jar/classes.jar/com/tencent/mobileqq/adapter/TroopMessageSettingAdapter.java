  ...
  extends BaseExpandableListAdapter
{
  ...
  public TroopMessageSettingAdapter(Context paramContext, QQAppInterface paramQQAppInterface, List paramList, Map paramMap)
  {
    ...
    this.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131492945);
    this.b = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131492946);
    this.c = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131492947);
    this.d = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131492948);
  ...
  private void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    paramView.setBackgroundResource(2130837949);
  }
      ...
      else
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if (this.jdField_a_of_type_AndroidUtilSparseArray.get(i) == null)
          {
            ...
            localTroopInfo.troopname = this.jdField_a_of_type_AndroidContentContext.getString(2131368290);
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 1) {
      if (paramView != null) {
        ...
        {
          paramViewGroup = (TextView)paramView.findViewById(2131302145);
    ...
    for (localObject = ((TroopInfo)localObject).troopuin;; localObject = ((TroopInfo)localObject).troopname)
    {
      ...
      return paramView;
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130904431, null);
      break;
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130904431, null);
      break;
      if (paramView != null) {
      ...
      {
        paramViewGroup = (TextView)paramView.findViewById(2131302145);
        ImageView localImageView = (ImageView)paramView.findViewById(2131302144);
        ...
        paramView.findViewById(2131302147).setVisibility(8);
        paramView.findViewById(2131302148).setVisibility(0);
        paramView.setBackgroundResource(2130837947);
        break;
        paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130904430, null);
        continue;
        paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130904430, null);
      }
      paramView.findViewById(2131302147).setVisibility(0);
      paramView.findViewById(2131302148).setVisibility(8);
      paramView.setBackgroundResource(2130837949);
      break label67;
    }
  }
