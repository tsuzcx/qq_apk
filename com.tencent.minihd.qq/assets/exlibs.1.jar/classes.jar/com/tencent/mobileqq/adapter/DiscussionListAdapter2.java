  ...
  implements FaceDecoder.DecodeTaskCompletionListener, AbsListView.OnScrollListener
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new hfj(this);
  ...
  public DiscussionListAdapter2(Context paramContext, DiscussionView paramDiscussionView, ListView paramListView, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    if ((paramContext instanceof BaseActivity)) {
      this.jdField_a_of_type_Boolean = ((BaseActivity)paramContext).isModeleWindow();
    }
  ...
  private void a(String paramString, Bitmap paramBitmap)
  {
    ...
    if (i < j)
    {
      ...
      if ((localObject == null) || (!(localObject instanceof hfk))) {
        break label169;
      }
      localObject = (hfk)localObject;
      if ((paramString == null) && (!TextUtils.isEmpty(((hfk)localObject).jdField_a_of_type_JavaLangString)))
      {
        paramBitmap = this.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder.a(101, ((hfk)localObject).jdField_a_of_type_JavaLangString);
        if (paramBitmap != null) {
          ((hfk)localObject).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramBitmap));
        }
      }
    }
    label169:
    for (;;)
    {
      i += 1;
      break;
      this.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder.a(((hfk)localObject).jdField_a_of_type_JavaLangString, 101, true);
      continue;
      if (TextUtils.equals(paramString, ((hfk)localObject).jdField_a_of_type_JavaLangString))
      {
        ((hfk)localObject).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramBitmap));
        return;
      }
  ...
  private void b()
  {
    ...
    localObject1 = (ContactFacade)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
    ...
    Object localObject2 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131366029);
    String str1 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131366032);
    ...
    Collections.sort(this.jdField_a_of_type_JavaUtilList, new hfi(this, (HashMap)localObject1));
    this.b.clear();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (getItemViewType(paramInt) == 1) {
      if (paramView == null)
      {
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903279, paramViewGroup, false);
        paramViewGroup = new hfk(null);
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131296551));
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297264));
        paramViewGroup.b = ((TextView)paramView.findViewById(2131297269));
        ...
        String str = ((DiscussionInfo)localObject1).uin;
        ...
        {
          i = (int)(32.0F * this.jdField_a_of_type_Float);
          localObject1 = paramView.findViewById(2131297530);
          if (localObject1 == null) {
            break label447;
          }
          ((View)localObject1).setBackgroundResource(2130837949);
        }
      }
    }
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (hfk)paramView.getTag();
      break;
      label320:
      ...
      if (paramView == null)
      {
        paramView = new hfk(null);
        localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903278, paramViewGroup, false);
        paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131297529));
      ...
      for (;;)
      {
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText("常用讨论组");
        break;
        paramViewGroup = (hfk)paramView.getTag();
      }
      label434:
      ...
      break label257;
      label447:
      paramViewGroup = paramViewGroup.jdField_a_of_type_AndroidWidgetTextView;
      paramViewGroup.setBackgroundResource(2130837952);
      if (paramInt == 0) {
        paramViewGroup.setPadding(i, i, i, i / 2);
      } else {
        paramViewGroup.setPadding(i, i / 2, i, i / 2);
      }
    }
  }
