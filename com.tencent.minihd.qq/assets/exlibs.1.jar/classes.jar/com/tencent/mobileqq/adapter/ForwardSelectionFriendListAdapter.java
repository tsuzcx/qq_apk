  ...
  implements View.OnClickListener
{
  ...
  public void a(List paramList, boolean paramBoolean)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      for (;;)
      {
        ...
        break;
        ArrayList localArrayList = ((ContactFacade)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).a(String.valueOf(localGroups.group_id));
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130904377, paramViewGroup, false);
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130904414, paramViewGroup, false);
      paramViewGroup = new ForwardSelectionFriendListAdapter.GroupViewTag();
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297234));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131297235));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131297233));
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841853);
    }
    for (;;)
    {
      ...
      break;
      label178:
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841854);
    }
  }
