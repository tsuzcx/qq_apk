  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 50, 58, 64, 74, 82, 90, 98, 106, 112 }, new String[] { "id", "source", "uin", "name", "account", "desc", "nameAccount", "kfuin", "si", "cs", "category", "ic", "isverified", "filter" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), Long.valueOf(0L), "", "", "", "", Long.valueOf(0L), "", "", "", "", "", Integer.valueOf(0) }, BusinessRecommend.class);
