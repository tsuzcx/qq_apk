  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 41, 49, 56, 64 }, new String[] { "uin", "key", "type", "is_need_lbs", "latitude", "longitude", "luin", "msg_id" }, new Object[] { Integer.valueOf(0), "", Integer.valueOf(1), Boolean.valueOf(false), Double.valueOf(0.0D), Double.valueOf(0.0D), Long.valueOf(0L), Long.valueOf(0L) }, SendMenuEventRequest.class);
