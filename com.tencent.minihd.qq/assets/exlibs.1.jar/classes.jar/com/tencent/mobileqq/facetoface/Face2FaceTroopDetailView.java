  ...
  implements View.OnClickListener
{
  ...
  protected void a()
  {
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131297244);
    this.jdField_b_of_type_AndroidViewView = super.findViewById(2131297660);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297661));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297662));
    this.c = ((TextView)super.findViewById(2131297663));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131297664));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView);
    this.e = super.findViewById(2131297658);
  ...
  public void a(int paramInt, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    else if ((this.jdField_a_of_type_Boolean) && ((this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceUserData instanceof Face2FaceGroupProfile)) && (paramString2 != null) && (paramString2.equals(this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceUserData.e)))
    {
      ...
      setBtnEnabled(false);
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131369976);
      if (!paramBoolean) {
  ...
  public void setBindData(Face2FaceUserData paramFace2FaceUserData, View.OnClickListener paramOnClickListener)
  {
    ...
    if ((paramFace2FaceUserData instanceof Face2FaceGroupProfile))
    {
      ...
      paramFace2FaceUserData = localQQAppInterface.getApplication().getString(2131369980, new Object[] { paramFace2FaceUserData });
    ...
    while (!(paramFace2FaceUserData instanceof Face2FaceUserProfile)) {
      for (;;)
      {
        ...
        return;
        setBtnEnabled(true);
        this.jdField_a_of_type_AndroidWidgetButton.setText(2131369978);
      }
    }
    ...
    paramFace2FaceUserData = ((FriendsManager)localQQAppInterface.getManager(49)).c(paramFace2FaceUserData.e);
    ...
    for (;;)
    {
      ...
      setBtnEnabled(false);
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131369977);
      break;
  ...
  public void setBtnEnabled(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130841767);
