  ...
  extends ProtocolDownloader.Adapter
{
  ...
  private static final String jdField_a_of_type_JavaLangString = "LastModifySupportDownloader";
  private static final String b = "http_lastmodify";
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    // Byte code:
    //   0: aload_1
    //   1: getfield 156	com/tencent/image/DownloadParams:urlStr	Ljava/lang/String;
    //   4: invokestatic 94	com/tencent/image/Utils:Crc64String	(Ljava/lang/String;)Ljava/lang/String;
    //   7: astore_3
    //   8: getstatic 99	com/tencent/mobileqq/startup/step/InitUrlDrawable:a	Lcom/tencent/mobileqq/transfile/DiskCache;
    //   11: aload_3
    //   12: invokevirtual 359	com/tencent/mobileqq/transfile/DiskCache:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/transfile/DiskCache$Editor;
    //   15: astore 5
    //   17: new 361	java/io/FileOutputStream
    //   20: dup
    //   21: aload 5
    //   23: getfield 366	com/tencent/mobileqq/transfile/DiskCache$Editor:a	Ljava/io/File;
    //   26: iconst_0
    //   27: invokespecial 369	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   30: astore 4
    //   32: aload 4
    //   34: astore_3
    //   35: aload_0
    ...
    //   38: aload_1
    //   39: aload_2
    //   40: invokevirtual 371	com/tencent/mobileqq/transfile/LastModifySupportDownloader:a	(Ljava/io/OutputStream;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   43: pop
    //   44: aload 4
    //   46: astore_3
    //   47: aload 5
    //   49: invokevirtual 374	com/tencent/mobileqq/transfile/DiskCache$Editor:a	()Ljava/io/File;
    //   52: astore_1
    //   53: aload 4
    //   55: ifnull +8 -> 63
    //   58: aload 4
    //   60: invokevirtual 375	java/io/OutputStream:close	()V
    //   63: aload_1
    //   64: areturn
    //   65: astore_2
    //   66: aconst_null
    ...
    //   75: aload 5
    //   77: iconst_0
    //   78: invokevirtual 378	com/tencent/mobileqq/transfile/DiskCache$Editor:a	(Z)V
    //   81: aload_1
    //   82: astore_3
    //   83: invokestatic 249	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   86: ifeq +15 -> 101
    //   89: aload_1
    //   90: astore_3
    //   91: ldc 10
    ...
    //   94: ldc_w 380
    //   97: aload_2
    //   98: invokestatic 383	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   101: aload_1
    //   102: astore_3
    //   103: aload_2
    //   104: athrow
    ...
    //   107: ifnull +7 -> 114
    //   110: aload_3
    //   111: invokevirtual 375	java/io/OutputStream:close	()V
    //   114: aload_1
    //   115: athrow
    //   116: astore_2
    //   117: aload_1
