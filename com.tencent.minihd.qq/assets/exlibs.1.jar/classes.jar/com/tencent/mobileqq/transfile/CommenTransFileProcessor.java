  ...
  implements IHttpCommunicatorListener, HttpVerifyHandler
{
  ...
  protected static final int aN = 4;
  protected static final int aO = 5;
  ...
  public static final String ae = "9u23fh$jkf^%43hj";
  public static final String af = "https://120.196.213.173:8080/";
  public static final String ag = "https://113.105.95.81:8080/";
  public static final String ah = "https://163.177.66.82:8080/";
  static final String ai = "https://mqq.tc.qq.com/";
  public static int ar = 122880;
  public static final int as = 16715521;
  public static final int at = 16715522;
  protected static final int au = 1;
  protected static final int av = 2;
  private static final int bc = 1048576;
  private static final int bd = 122880;
  private static final int be = -1;
  private static final int bf = -6102;
  ...
  static
  {
    jdField_e_of_type_JavaLangString = "https://112.90.138.173:8080/mmu/0";
    f = "https://112.90.138.173:8080/mmd/0";
    ac = "https://112.90.138.173:8080/1/0";
    ad = "https://112.90.138.173:8080/2/0";
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { "https://120.196.213.173:8080/", "https://113.105.95.81:8080/", "https://163.177.66.82:8080/" };
  }
  ...
  private void a(JceInputStream paramJceInputStream)
  {
    for (;;)
    {
      ...
      b(null, null);
      return;
      this.ba = (localHttpUploadResp.uSeq + 1);
      this.bb = localHttpUploadResp.uFromPos;
      this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_e_of_type_Long = this.bb;
  ...
  public static void a(AppInterface paramAppInterface, String paramString)
  {
    if ((paramAppInterface != null) && (paramString != null) && (!"".equals(paramString)))
    {
      ...
      if (paramAppInterface.startsWith("http://"))
      {
        ...
        ac = paramAppInterface + "1/0";
        ad = paramAppInterface + "2/0";
      }
    }
    else
    {
    ...
    ac = "http://" + paramAppInterface + "/1/0";
    ad = "http://" + paramAppInterface + "/2/0";
  }
  ...
  private byte[] a(HttpDownloadResp paramHttpDownloadResp)
  {
    ...
    int j = paramHttpDownloadResp.encryTo;
    if ((1 == paramHttpDownloadResp.encryType) && (arrayOfByte2 != null) && (arrayOfByte2.length >= 1) && (i >= 0) && (i < m) && (j >= 0) && (j <= m))
    {
      m = arrayOfByte2[0];
      while (i < j)
      {
        arrayOfByte1[i] = ((byte)(arrayOfByte1[i] ^ m));
        i += 1;
      }
    }
    return arrayOfByte1;
  ...
  private void b(JceInputStream paramJceInputStream)
  {
    for (;;)
    {
      ...
      this.ba += 1;
      this.bb += localHttpDownloadResp.vFileData.length;
  ...
  private void b(HttpMsg paramHttpMsg)
  {
    ...
    paramHttpMsg.jdField_e_of_type_Int = this.aq;
  }
  ...
  public void a()
  {
    ...
    //   64: aload_0
    //   65: iconst_0
    //   66: putfield 475	com/tencent/mobileqq/transfile/CommenTransFileProcessor:jdField_b_of_type_Boolean	Z
    //   69: aload_0
    ...
    //   102: getfield 259	com/tencent/mobileqq/transfile/FileMsg:jdField_a_of_type_Long	J
    ...
    //   119: aload_0
    //   120: sipush 1001
    //   123: invokevirtual 310	com/tencent/mobileqq/transfile/CommenTransFileProcessor:d	(I)V
    //   126: aload_2
    //   127: ifnull -71 -> 56
    //   130: aload_2
    ...
    //   226: aload_0
    //   227: sipush 2001
    //   230: invokevirtual 310	com/tencent/mobileqq/transfile/CommenTransFileProcessor:d	(I)V
    //   233: return
    //   234: astore_3
    //   235: aload_1
    //   236: astore_2
  ...
  public byte[] a()
  {
    return new Cryptor().encrypt(new UsrInfo(Long.valueOf(this.jdField_c_of_type_JavaLangString).longValue(), Long.valueOf(this.d).longValue(), this.aZ, this.ba, AppSetting.jdField_a_of_type_Int, (short)a(), (short)c(), (short)1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getSid().getBytes(), (byte)1, b(), d(), b()).toByteArray(), "9u23fh$jkf^%43hj".getBytes());
  }
  ...
  protected String e()
  {
    if (NetworkUtil.b(BaseApplication.getContext())) {
      return "https://113.105.95.81:8080/";
    }
    return "https://163.177.66.82:8080/";
  }
  ...
  protected void j()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.D == 2003) || (this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.D == 1003)) {
      return;
    }
    b(null, null);
  }
  ...
  protected void q()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        b1 = (byte)i;
        if (ar + this.bb <= this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_a_of_type_Long) {
          break label342;
        }
        l1 = this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_a_of_type_Long - this.bb;
        m = (int)l1;
        if (QLog.isColorLevel()) {
          QLog.d("Q.profilecard.PhotoWall.Trans", 2, "dataSliceSize: " + ar + "  fromPos : " + this.bb + " file.fileSize: " + this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_a_of_type_Long);
        }
        arrayOfByte = this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.a(this.bb, m);
        if (this.bb + m >= this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_a_of_type_Long) {
          this.l = true;
        }
        if (QLog.isColorLevel()) {
      ...
      label342:
      label351:
      for (i = j;; i = arrayOfByte.length)
      {
        QLog.d("Q.profilecard.PhotoWall.Trans", 2, i);
        localObject2 = new HttpUploadReq((byte[])localObject2, (int)this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_a_of_type_Long, this.jdField_a_of_type_ArrayOfByte, this.bb, m, arrayOfByte, b1, (DefineAvatarInfo)localObject1, null);
        ...
        {
          System.gc();
          localObject1 = new jzu(this, (JceOutputStream)localObject1);
  ...
  protected void s()
  {
    ...
    Object localObject1 = new HttpDownloadReq(a(), a(this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_c_of_type_JavaLangString), this.bb, ar, this.jdField_a_of_type_Short);
    try
    {
  ...
  protected void t()
  {
    ...
    for (;;)
    {
      ...
      return;
      localStringBuilder.append("https://mqq.tc.qq.com/");
    }
  }
