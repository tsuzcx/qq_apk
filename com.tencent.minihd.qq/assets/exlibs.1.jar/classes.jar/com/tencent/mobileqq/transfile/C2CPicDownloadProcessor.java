  ...
  extends BasePicDownloadProcessor
{
  ...
  void s()
  {
    ...
    for (;;)
    {
      ...
      localHttpNetReq.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_g_of_type_JavaLangString;
      ...
      if (i == 4)
      {
        localHttpNetReq.jdField_a_of_type_Long = this.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_g_of_type_Int;
        localHttpNetReq.jdField_b_of_type_Long = 0L;
        localHttpNetReq.jdField_a_of_type_Boolean = false;
        localHttpNetReq.jdField_a_of_type_JavaUtilHashMap.put("Range", "bytes=" + this.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_g_of_type_Int + "-");
      }
      for (;;)
      {
        ...
        {
          localHttpNetReq.jdField_a_of_type_Long = this.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_g_of_type_Int;
          localHttpNetReq.jdField_b_of_type_Long = (this.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_g_of_type_Int + this.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.h - 1);
          localHttpNetReq.jdField_a_of_type_Boolean = false;
          localHttpNetReq.jdField_a_of_type_JavaUtilHashMap.put("Range", "bytes=" + this.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_g_of_type_Int + "-" + localHttpNetReq.jdField_b_of_type_Long);
        }
        else
        {
          localHttpNetReq.jdField_b_of_type_Long = 0L;
