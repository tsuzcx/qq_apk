  ...
  implements IHttpCommunicatorListener
{
  ...
  private static final String jdField_d_of_type_JavaLangString = "https://i.gtimg.cn";
  ...
  {
    return (paramString != null) && (paramString.trim().startsWith("https://i.gtimg.cn"));
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_a_of_type_JavaIoFile = new File(this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_e_of_type_JavaLangString + ".tmp");
    ...
    this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_e_of_type_Long = l;
    localException.a("Range", "bytes=" + l + "-");
    localException.a("Accept", "application/octet-stream");
    if (QLog.isColorLevel()) {
      QLog.d("ThemeDownloadTrace", 2, "start download success,url is:" + this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.k + ",filePath is:" + this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_e_of_type_JavaLangString + ",fileLength is:" + l);
    }
    if (QLog.isColorLevel()) {
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          QLog.d("ThemeDownloadTrace", 2, bool + ",transferedSize is:" + this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_e_of_type_Long + ",fileSize is:" + this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_a_of_type_Long + ",requestPause is:" + localObject2 + ",requestStop is:" + localObject3 + ",hasError is:" + localBoolean);
        }
