...
public class TranDbRecord$PicDbRecord
{
  ...
  static
  {
    jdField_f_of_type_Int = jdField_e_of_type_Int + 1;
  ...
  {
    return TransfileUtile.a(paramString1, paramLong, paramInt1, paramBoolean, paramString2, paramString3, paramString4, paramString5, paramString6, paramString7, paramInt2, paramInt3);
  }
  ...
  {
    return TransfileUtile.a(paramString1, paramLong, paramInt1, paramBoolean, paramString2, paramString3, paramString4, paramString5, paramString6, paramString7, paramInt2, paramInt3, paramString8);
  }
  ...
  public void a(String paramString)
  {
    ...
    if ((paramString != null) && (paramString.length() > 0) && (paramString.charAt(0) == '\026'))
    {
      ...
      if (localObject != null)
      {
        ...
        if (localObject.length >= 1) {
          this.jdField_b_of_type_JavaLangString = localObject[0].trim();
        }
    ...
    try
    {
      this.jdField_b_of_type_Long = Long.parseLong(localObject[1]);
    ...
    catch (NumberFormatException localException3)
    {
      try
      {
        this.jdField_b_of_type_Int = Integer.parseInt(localObject[2]);
      ...
      catch (NumberFormatException localException3)
      {
        try
        {
          ...
          if (localObject.length >= 5) {
            this.jdField_c_of_type_JavaLangString = localObject[4];
          }
          if (localObject.length >= 6) {
            this.jdField_d_of_type_JavaLangString = localObject[5];
          }
          if (localObject.length >= 7) {
            this.jdField_e_of_type_JavaLangString = localObject[6];
          }
          if (localObject.length >= 8) {
            this.jdField_f_of_type_JavaLangString = localObject[7];
          }
          if (localObject.length >= 9) {
            this.jdField_g_of_type_JavaLangString = localObject[8];
          }
          if (localObject.length >= 10) {
            this.h = localObject[9];
          }
        ...
        catch (Exception localException3)
        {
          try
          {
            this.jdField_c_of_type_Int = Integer.parseInt(localObject[10]);
          ...
          catch (Exception localException3)
          {
            try
            {
              for (;;)
              {
                this.jdField_d_of_type_Int = Integer.parseInt(localObject[11]);
                if (this.jdField_d_of_type_Int == jdField_g_of_type_Int)
                {
                  localObject = new PicFowardDbRecordData();
                  ((PicFowardDbRecordData)localObject).a(paramString);
