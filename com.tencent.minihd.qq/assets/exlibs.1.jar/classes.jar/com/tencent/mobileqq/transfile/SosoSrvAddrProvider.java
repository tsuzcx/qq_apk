...
public class SosoSrvAddrProvider
{
  ...
  kbb jdField_a_of_type_Kbb = new kbb(this);
  ...
  public String a(SosoSrvAddrProvider.SosoSrvAddrType paramSosoSrvAddrType)
  {
    ...
    try
    {
      FileStorageServerListInfo localFileStorageServerListInfo = this.jdField_a_of_type_Kbb.a(paramSosoSrvAddrType);
  ...
  public void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    try
    {
      ...
      this.jdField_a_of_type_Kbb.a(paramFileStoragePushFSSvcList);
      return;
    }
    finally
    {
  ...
  public void a(SosoSrvAddrProvider.SosoSrvAddrType paramSosoSrvAddrType, String paramString)
  {
    try
    {
      this.jdField_a_of_type_Kbb.a(paramSosoSrvAddrType, paramString);
      return;
    }
    finally
    {
