...
{
  public static final String aj = "LbsTransfileProcessor";
  MessageObserver a;
  ...
  public LbsTransfileProcessor(String paramString1, int paramInt, String paramString2, boolean paramBoolean, TransFileController paramTransFileController)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new kan(this);
    b(false);
    this.ak = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c();
  }
  ...
  private void w()
  {
    ...
    try
    {
      ...
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.d, this.aq);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_e_of_type_Int == 2) {
        try
        {
          ...
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.d, this.aq);
  ...
  protected void r()
  {
    ...
    a(true);
    a(this.jdField_c_of_type_JavaLangString, this.d, this.ak, null, this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_e_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_c_of_type_JavaLangString);
  }
