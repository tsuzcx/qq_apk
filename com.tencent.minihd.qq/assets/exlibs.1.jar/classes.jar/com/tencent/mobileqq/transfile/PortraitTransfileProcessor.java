  ...
  extends CommenTransFileProcessor
{
  ...
  public void b(HttpMsg paramHttpMsg1, HttpMsg paramHttpMsg2)
  {
    ...
    if (QLog.isColorLevel())
    {
      if (paramHttpMsg2 != null)
      {
        ...
        QLog.d("Q.profilecard.PhotoWall.Trans", 2, "resp.errDesc = " + paramHttpMsg2.af);
      }
    }
    else if ((this.aY == 0) && (this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.a == 0))
    {
    ...
    for (;;)
    {
      ...
      return;
      QLog.d("Q.profilecard.PhotoWall.Trans", 2, "resp.errCode = " + this.aC);
      QLog.d("Q.profilecard.PhotoWall.Trans", 2, "resp.errDesc = " + this.T);
      break;
      label225:
  ...
  {
    super.h();
    if ((this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.a == 1) && (this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.D != 2003))
    {
      if (QLog.isColorLevel()) {
  ...
  {
    int i = 0;
    this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.D = 1003;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.e);
