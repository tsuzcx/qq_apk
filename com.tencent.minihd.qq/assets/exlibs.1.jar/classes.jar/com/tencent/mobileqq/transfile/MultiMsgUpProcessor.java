  ...
  extends BaseUploadProcessor
{
  ...
  private static final String ae = "MultiMsgUpProcessor";
  private int aP = this.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_a_of_type_Int;
  ...
  public MultiMsgUpProcessor(TransFileController paramTransFileController, TransferRequest paramTransferRequest)
  {
    ...
    for (this.jdField_a_of_type_Long = paramTransferRequest.jdField_a_of_type_ArrayOfByte.length;; this.jdField_a_of_type_Long = 0L) {
      try
      {
        this.k = Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_a_of_type_JavaLangString);
        return;
      }
  ...
  private boolean g()
  {
    ...
    ((im_msg_head.HttpConnHead)localObject2).uint64_uin.set(this.k);
  ...
  protected void c(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if ((this.j) && (i != 0))
      {
        ...
        this.jdField_a_of_type_JavaLangStringBuilder.append("s").append(this.aL).append("_").append("tr").append(this.jdField_f_of_type_Long).append("_").append("ht").append(this.jdField_e_of_type_Long).append("_").append("pic").append(this.jdField_g_of_type_Long).append(";");
  ...
  public int e()
  {
    ...
    if ((this.jdField_b_of_type_ArrayOfByte == null) || (0L >= this.jdField_a_of_type_Long) || (0L == this.k)) {
      return -1;
    }
  ...
  public int f()
  {
    if (this.jdField_e_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTransfileTransFileController.a.post(new kao(this));
    }
    return 0;
  }
