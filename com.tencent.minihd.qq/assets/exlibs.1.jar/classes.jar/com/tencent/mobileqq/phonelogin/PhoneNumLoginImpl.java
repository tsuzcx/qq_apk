...
public class PhoneNumLoginImpl
{
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localQQCustomDialog.setTitle(2131366921);
    localQQCustomDialog.setMessage(2131366922);
    paramQQAppInterface = new jlh(this, str, paramActivity, paramQQAppInterface);
    paramActivity = new jli(this);
    localQQCustomDialog.setPositiveButton(2131366923, paramQQAppInterface);
    localQQCustomDialog.setNegativeButton(2131365736, paramActivity);
