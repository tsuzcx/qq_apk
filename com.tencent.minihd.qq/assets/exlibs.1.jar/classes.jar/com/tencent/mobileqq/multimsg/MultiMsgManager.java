...
public class MultiMsgManager
{
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, HashMap paramHashMap, MessageRecord paramMessageRecord, MessageObserver paramMessageObserver, ArrayList paramArrayList1, ArrayList paramArrayList2)
  {
    ...
    paramMessageObserver.a(new jgn(this, paramArrayList1, paramQQAppInterface, paramString, paramInt, paramHashMap, paramMessageRecord));
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, HashMap paramHashMap, MessageRecord paramMessageRecord, MessageObserver paramMessageObserver, ArrayList paramArrayList, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        if (!a(paramQQAppInterface, paramHashMap, paramQQAppInterface.a(), paramString, paramString, paramInt, paramMessageRecord.uniseq, 1035, new jgo(this, paramMessageRecord, paramQQAppInterface, paramString, paramInt))) {
          break;
        }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, MessageObserver paramMessageObserver, Intent paramIntent, ArrayList paramArrayList)
  {
    ...
    paramQQAppInterface.a(new jgl(this, paramArrayList, paramIntent, paramSessionInfo, paramQQAppInterface, paramContext));
  }
  
  public void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong, boolean paramBoolean)
  {
    paramQQAppInterface.a(new jgp(this, paramQQAppInterface, paramString, paramInt, paramLong, paramBoolean));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, ArrayList paramArrayList, HashMap paramHashMap, MessageRecord paramMessageRecord, MessageObserver paramMessageObserver)
  {
    ...
    paramQQAppInterface.a(new jgm(this, paramArrayList, paramHashMap, paramMessageRecord, paramQQAppInterface, paramInt, paramString));
  }
  ...
  public void a(HashMap paramHashMap, long paramLong, QQAppInterface paramQQAppInterface)
  {
    ...
    //   18: astore 5
    //   20: aload_1
    //   21: invokevirtual 457	java/util/HashMap:entrySet	()Ljava/util/Set;
    //   24: invokeinterface 433 1 0
    //   29: astore_1
    //   30: aload_1
    ...
    //   45: checkcast 459	java/util/Map$Entry
    //   48: astore 7
    //   50: aload 7
    //   52: invokeinterface 462 1 0
    //   57: checkcast 284	java/lang/String
    //   60: astore 6
    //   62: aload 7
    //   64: invokeinterface 465 1 0
    ...
    //   103: aload 5
    //   105: aload 8
    //   107: invokevirtual 466	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   110: pop
    //   111: goto -81 -> 30
    //   114: aload 4
    ...
    //   122: astore 4
    //   124: aload 4
    //   126: invokevirtual 469	com/tencent/mobileqq/persistence/EntityManager:a	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   129: astore_1
    //   130: aload_1
    //   131: invokevirtual 473	com/tencent/mobileqq/persistence/EntityTransaction:a	()V
    //   134: aload 5
    //   136: invokevirtual 474	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   139: astore 5
    //   141: aload 5
    ...
    //   163: invokevirtual 477	com/tencent/mobileqq/persistence/EntityManager:b	(Lcom/tencent/mobileqq/persistence/Entity;)V
    //   166: goto -25 -> 141
    //   169: astore 5
    //   171: aload 5
    //   173: invokevirtual 480	java/lang/Exception:printStackTrace	()V
    //   176: aload_1
    //   177: invokevirtual 482	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   180: aload 4
    //   182: invokevirtual 483	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   185: return
    //   186: aload_1
    //   187: invokevirtual 485	com/tencent/mobileqq/persistence/EntityTransaction:c	()V
    //   190: aload_1
    //   191: invokevirtual 482	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   194: goto -14 -> 180
    //   197: astore 4
    //   199: aload_1
    //   200: invokevirtual 482	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   203: aload 4
    //   205: athrow
