  ...
  implements FaceDecodeTask.DecodeCompletionListener
{
  ...
  private kpo jdField_a_of_type_Kpo;
  private kpp jdField_a_of_type_Kpp;
  ...
  private FaceDrawable(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, String paramString1, byte paramByte, int paramInt3, String paramString2, boolean paramBoolean, Drawable paramDrawable1, Drawable paramDrawable2)
  {
    ...
    else
    {
      ...
      if (paramInt1 == 101)
      {
        this.jdField_a_of_type_Kpo = new kpo(this, null);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Kpo);
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, FaceInfo paramFaceInfo)
  {
    ...
    {
      if (this.jdField_a_of_type_Kpp == null)
      {
        this.jdField_a_of_type_Kpp = new kpp(this, null);
        paramQQAppInterface.a(this.jdField_a_of_type_Kpp);
      }
