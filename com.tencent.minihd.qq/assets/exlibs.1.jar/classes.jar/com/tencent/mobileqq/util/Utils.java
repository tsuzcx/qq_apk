...
public class Utils
{
  ...
  public static View a(Context paramContext)
  {
    ...
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, a(paramContext, 1.0F));
    int i = a(paramContext, 32.0F);
    localLayoutParams.leftMargin = i;
    localLayoutParams.rightMargin = i;
    localView.setLayoutParams(localLayoutParams);
    localView.setBackgroundColor(Color.parseColor("#f2f2f2"));
    return localView;
  }
  
  public static View a(Context paramContext, ListView paramListView)
  {
    float f = paramContext.getResources().getDisplayMetrics().density;
    FrameLayout localFrameLayout = new FrameLayout(paramContext);
    localFrameLayout.setPadding((int)(32.0F * f), 0, (int)(32.0F * f), 0);
    paramContext = new View(paramContext);
    paramContext.setBackgroundResource(2130837955);
    localFrameLayout.addView(paramContext, new FrameLayout.LayoutParams(-1, (int)(f * 6.0F)));
    paramListView.b(localFrameLayout);
  ...
  public static LinearLayout a(Context paramContext)
  {
    ...
    int i = a(paramContext, 16.0F);
    int j = a(paramContext, 6.0F);
  ...
  public static ArrayList a(ArrayList paramArrayList)
  {
    ...
    Arrays.sort(arrayOfObject, new kqq());
  ...
  public static void a(Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        localObject1 = localIntent.resolveTypeIfNeeded(paramContext.getContentResolver());
        localObject3 = ReflectionUtil.a(ReflectionUtil.a("android.app.AppGlobals", "getPackageManager", null, null), null, "getLastChosenActivity", new Class[] { Intent.class, String.class, Integer.TYPE }, new Object[] { localIntent, localObject1, Integer.valueOf(65536) });
        Log.i("app2", "chosen=" + localObject3 + " type=" + (String)localObject1);
        if (!(localObject3 instanceof ResolveInfo)) {
          break label416;
        }
        localObject1 = (ResolveInfo)localObject3;
      ...
      catch (Exception localException)
      {
        ...
        localObject3 = ((ResolveInfo)localList.get(i)).activityInfo.applicationInfo.packageName;
        ...
        Log.i("app2", "openPackageName=" + (String)localObject3);
        localIntent.setPackage((String)localObject3);
        paramContext.startActivity(localIntent);
        return;
      }
      localList = ((PackageManager)localObject4).queryIntentActivities(localIntent, 0);
      Collections.sort(localList, new ResolveInfo.DisplayNameComparator((PackageManager)localObject4));
      j = localList.size();
      i = 0;
      localObject1 = null;
      if (i < j)
      {
        ...
        localObject4 = localResolveInfo.activityInfo.applicationInfo.packageName;
        Log.i("app2", "info=" + localResolveInfo);
        if ((localObject3 != null) && (localObject4 != null) && (((String)localObject4).equals(((ResolveInfo)localObject3).activityInfo.applicationInfo.packageName)))
        {
  ...
  public static void a(Context paramContext, View paramView)
  {
    ...
    View localView = paramView.findViewById(2131302026);
    localView.getLayoutParams().height = a(paramContext, 52.0F);
    paramView.findViewById(2131299473).setBackgroundResource(2130837951);
    paramView = (RelativeLayout.LayoutParams)localView.findViewById(2131300437).getLayoutParams();
    paramView.getRules()[15] = 0;
    paramView.rightMargin = i;
    paramView.topMargin = a(paramContext, 12.0F);
  }
  ...
  public static void a(Context paramContext, View paramView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramView.setPadding(paramView.getPaddingLeft(), a(paramContext, 2.0F), paramView.getPaddingRight(), a(paramContext, 7.0F));
      return;
    }
    paramView.setPadding(paramView.getPaddingLeft(), i, paramView.getPaddingRight(), i);
  }
  ...
  public static void a(Window paramWindow, boolean paramBoolean)
  {
    ...
    try
    {
      paramWindow.clearFlags(WindowManager.LayoutParams.class.getField("FLAG_NEEDS_MENU_KEY").getInt(null));
      return;
    }
    catch (NoSuchFieldException paramWindow)
    {
  ...
  {
    return (paramString == null) || (paramString.equals(AppConstants.ac)) || (paramString.equals(String.valueOf(AppConstants.ad))) || (paramString.equals(String.valueOf(AppConstants.ae))) || (paramString.equals(String.valueOf(AppConstants.af))) || (paramString.equals(String.valueOf(AppConstants.ag))) || (paramString.equals(String.valueOf(AppConstants.ab))) || (paramString.equals(String.valueOf(AppConstants.aa))) || (paramString.equals(String.valueOf(AppConstants.ao))) || (paramString.equals(String.valueOf(AppConstants.av))) || (paramString.equals(String.valueOf(AppConstants.Y))) || (paramString.equals(String.valueOf(AppConstants.Z))) || (paramString.equals(String.valueOf(AppConstants.at))) || (paramString.equals(String.valueOf(AppConstants.W))) || (paramString.equals(String.valueOf(AppConstants.V))) || (paramString.equals(String.valueOf(AppConstants.au))) || (paramString.equals(String.valueOf(AppConstants.ap))) || (paramString.equals(String.valueOf(AppConstants.as))) || (paramString.equals(String.valueOf(AppConstants.aq))) || (paramString.equals(String.valueOf(AppConstants.aw))) || (paramString.equals(String.valueOf(AppConstants.ax)));
  }
  ...
  public static byte[] a(byte[] paramArrayOfByte)
  {
    ...
    //   23: newarray byte
    //   25: astore_2
    //   26: new 873	java/io/ByteArrayInputStream
    //   29: dup
    //   30: aload_0
    //   31: invokespecial 876	java/io/ByteArrayInputStream:<init>	([B)V
    //   34: astore 4
    //   36: new 878	java/util/zip/GZIPInputStream
    //   39: dup
    //   40: aload 4
    //   42: invokespecial 881	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   45: astore_3
    //   46: new 883	java/io/ByteArrayOutputStream
    //   49: dup
    //   50: invokespecial 884	java/io/ByteArrayOutputStream:<init>	()V
    //   53: astore_0
    //   54: aload_0
    //   55: astore 7
    //   57: aload_3
    ...
    //   67: aload_2
    //   68: arraylength
    //   69: invokevirtual 888	java/util/zip/GZIPInputStream:read	([BII)I
    //   72: istore_1
    //   73: iload_1
    //   74: ifle +76 -> 150
    //   77: aload_0
    ...
    //   89: iconst_0
    //   90: iload_1
    //   91: invokevirtual 892	java/io/ByteArrayOutputStream:write	([BII)V
    //   94: goto -40 -> 54
    //   97: astore_2
    //   98: aload_0
    //   99: astore 7
    ...
    //   106: astore 5
    //   108: aload_2
    //   109: invokevirtual 893	java/io/IOException:printStackTrace	()V
    //   112: aload_0
    //   113: ifnull +7 -> 120
    //   116: aload_0
    //   117: invokevirtual 896	java/io/ByteArrayOutputStream:close	()V
    //   120: aload_3
    //   121: ifnull +7 -> 128
    //   124: aload_3
    //   125: invokevirtual 897	java/util/zip/GZIPInputStream:close	()V
    //   128: aload 8
    //   130: astore_2
    //   131: aload 4
    //   133: ifnull -115 -> 18
    //   136: aload 4
    //   138: invokevirtual 898	java/io/ByteArrayInputStream:close	()V
    //   141: aconst_null
    //   142: areturn
    //   143: astore_0
    //   144: aload_0
    //   145: invokevirtual 893	java/io/IOException:printStackTrace	()V
    //   148: aconst_null
    //   149: areturn
    //   150: aload_0
    //   151: astore 7
    ...
    //   158: astore 5
    //   160: aload_0
    //   161: invokevirtual 902	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   164: astore_2
    //   165: aload_2
    //   166: astore 5
    //   168: aload_0
    //   169: ifnull +7 -> 176
    //   172: aload_0
    //   173: invokevirtual 896	java/io/ByteArrayOutputStream:close	()V
    //   176: aload_3
    //   177: ifnull +7 -> 184
    //   180: aload_3
    //   181: invokevirtual 897	java/util/zip/GZIPInputStream:close	()V
    //   184: aload 5
    //   186: astore_2
    //   187: aload 4
    //   189: ifnull -171 -> 18
    //   192: aload 4
    //   194: invokevirtual 898	java/io/ByteArrayInputStream:close	()V
    //   197: aload 5
    //   199: areturn
    //   200: astore_0
    //   201: aload_0
    //   202: invokevirtual 893	java/io/IOException:printStackTrace	()V
    //   205: aload 5
    //   207: areturn
    //   208: astore_0
    //   209: aconst_null
    ...
    //   217: ifnull +7 -> 224
    //   220: aload_2
    //   221: invokevirtual 896	java/io/ByteArrayOutputStream:close	()V
    //   224: aload_3
    //   225: ifnull +7 -> 232
    //   228: aload_3
    //   229: invokevirtual 897	java/util/zip/GZIPInputStream:close	()V
    //   232: aload 4
    //   234: ifnull +8 -> 242
    //   237: aload 4
    //   239: invokevirtual 898	java/io/ByteArrayInputStream:close	()V
    //   242: aload_0
    //   243: athrow
    //   244: astore_2
    //   245: aload_2
    //   246: invokevirtual 893	java/io/IOException:printStackTrace	()V
    //   249: goto -7 -> 242
    //   252: astore_0
    //   253: aconst_null
    //   254: astore_2
  ...
  public static int b(Context paramContext)
  {
    ...
    {
      paramContext = ((Activity)paramContext).getParent();
      if ((paramContext instanceof QQTabActivity)) {
        return ((QQTabActivity)paramContext).a();
      }
    }
    return -1;
  }
  ...
  public static View b(Context paramContext, ListView paramListView)
  {
    float f = paramContext.getResources().getDisplayMetrics().density;
    FrameLayout localFrameLayout = new FrameLayout(paramContext);
    localFrameLayout.setPadding((int)(32.0F * f), 0, (int)(32.0F * f), 0);
    paramContext = new View(paramContext);
    paramContext.setBackgroundResource(2130837958);
    localFrameLayout.addView(paramContext, new FrameLayout.LayoutParams(-1, (int)(f * 6.0F)));
    paramListView.a(localFrameLayout);
    return localFrameLayout;
  }
  ...
  {
    Object localObject = new IntentFilter("android.intent.action.MAIN");
    ((IntentFilter)localObject).addCategory("android.intent.category.HOME");
    ((IntentFilter)localObject).addCategory("android.intent.category.DEFAULT");
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(localObject);
    localObject = new ArrayList();
    paramContext.getPackageManager().getPreferredActivities(localArrayList, (List)localObject, paramString);
    paramContext = ((List)localObject).iterator();
    while (paramContext.hasNext()) {
      if (paramString.equals(((ComponentName)paramContext.next()).getPackageName())) {
        return true;
      }
    }
    return false;
  ...
  public static boolean e()
  {
    ...
    if (localSplashActivity.checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE") != 0)
    {
      localSplashActivity.permissionManager.permissions(new PermissionItem[] { PermissionItem.init("android.permission.WRITE_EXTERNAL_STORAGE", 300) }).request(new kqo(localSplashActivity));
      return false;
    }
