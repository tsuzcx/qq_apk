  ...
  implements IActionListener, IIconListener, AdapterView.OnItemClickListener
{
  ...
  private jqu jdField_a_of_type_Jqu;
  private int c = 0;
  private int d = 0;
  private int e = 3;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 100)
    {
      ...
      this.jdField_a_of_type_Jqu.notifyDataSetChanged();
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (jqv)((View)localObject).getTag();
      if (((jqv)localObject).jdField_a_of_type_Int == paramInt1)
      {
        ((jqv)localObject).jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(new StatableBitmapDrawable(getResources(), paramBitmap, false, false));
        return;
      }
      paramInt2 += 1;
    }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    setContentViewNoBackground(2130904455);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetGridListView = ((GridListView)findViewById(2131302247));
    ...
    this.jdField_a_of_type_Jqu = new jqu(this, null);
    this.jdField_a_of_type_ComTencentMobileqqWidgetGridListView.setAdapter(this.jdField_a_of_type_Jqu);
    a();
