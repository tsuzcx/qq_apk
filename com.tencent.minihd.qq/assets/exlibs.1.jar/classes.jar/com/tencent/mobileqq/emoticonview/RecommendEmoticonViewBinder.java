...
{
  private static int jdField_a_of_type_Int = 11;
  ...
  {
    Drawable localDrawable = paramContext.getResources().getDrawable(2130840769);
    paramContext = paramContext.getResources().getDrawable(2130840770);
  ...
  protected void a(View paramView, int paramInt)
  {
    ...
    Object localObject1 = (URLImageView)paramView.findViewById(2131300785);
    Object localObject2 = (Button)paramView.findViewById(2131300787);
    ((TextView)paramView.findViewById(2131300786)).setText(StringUtil.a(localPromotionEmoticonPkg.c, jdField_a_of_type_Int));
    try
    {
      Drawable localDrawable1 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838136);
      Drawable localDrawable2 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840746);
      ((URLImageView)localObject1).setImageDrawable(URLDrawable.getDrawable(ClubContentJsonTask.a.c + localPromotionEmoticonPkg.jdField_b_of_type_JavaLangString, localDrawable1, localDrawable2));
      label130:
      ((URLImageView)localObject1).setURLDrawableDownListener(this);
      ((Button)localObject2).setText(localPromotionEmoticonPkg.d);
      ((Button)localObject2).setOnClickListener(new ihg(this, localPromotionEmoticonPkg));
