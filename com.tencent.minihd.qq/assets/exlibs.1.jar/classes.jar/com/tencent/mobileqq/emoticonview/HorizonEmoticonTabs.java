  ...
  implements View.OnClickListener
{
  ...
  public HorizonEmoticonTabs(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_b_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131493149);
    this.c = paramContext.getResources().getDimensionPixelSize(2131493151);
  ...
  public View a(int paramInt)
  {
    ...
    while ((paramInt >= this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildCount()) || (paramInt < 0)) {
      return null;
    }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int < j)
      {
        ...
        j = (int)getResources().getDimension(2131493146);
  ...
  public void a(int paramInt)
  {
    ...
    ((ImageView)localView.findViewById(2131297588)).setVisibility(0);
  }
  
  public void a(Drawable paramDrawable, int paramInt)
  {
    post(new ihb(this, paramInt, paramDrawable));
  }
  ...
  public void a(EmoticonViewBinder paramEmoticonViewBinder, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        View localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130904083, null);
        ImageView localImageView = (ImageView)localView.findViewById(2131297589);
        Object localObject = localView.findViewById(2131297586);
        if (paramBoolean)
        {
          i = 0;
          ...
          if (localDrawable == null)
          {
            ...
            if ((paramEmoticonViewBinder instanceof BigEmoticonViewBinder))
            {
              ...
              ThreadManager.b(new igz(this, localQQAppInterface, paramEmoticonViewBinder));
            }
          }
          if (localObject != null)
          {
  ...
  public void a(EmoticonViewBinder paramEmoticonViewBinder, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        View localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903292, null);
        ImageView localImageView2 = (ImageView)localView.findViewById(2131297589);
        ImageView localImageView1 = (ImageView)localView.findViewById(2131297588);
        Object localObject1 = localView.findViewById(2131297586);
        if (paramBoolean)
        {
          i = 0;
          ...
          if (localObject2 == null)
          {
            ...
            if ((paramEmoticonViewBinder instanceof BigEmoticonViewBinder))
            {
              ...
              ThreadManager.b(new iha(this, localQQAppInterface, (BigEmoticonViewBinder)localObject2));
            }
          }
  ...
  public boolean a(int paramInt)
  {
    ...
    if ((paramInt < 0) || (paramInt > this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildCount() - 1)) {
      return false;
    }
    return ((ImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(paramInt).findViewById(2131297588)).getVisibility() == 0;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          if (this.jdField_a_of_type_Int < j) {
            setTabSelected(false, this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(this.jdField_a_of_type_Int), this.jdField_a_of_type_Int);
          }
          if (paramView != null)
          {
            localObject = (ImageView)paramView.findViewById(2131297588);
            if (localObject != null) {
              ((ImageView)localObject).setVisibility(8);
            }
            setTabSelected(true, paramView, i);
          }
  ...
  public void setSelectedIndex(int paramInt)
  {
    ...
    super.postDelayed(new ihc(this), 200L);
  }
  ...
  public void setTabSelected(boolean paramBoolean, View paramView, int paramInt)
  {
    ImageView localImageView = (ImageView)paramView.findViewById(2131297589);
    View localView = paramView.findViewById(2131297586);
    paramView.findViewById(2131297587).setSelected(paramBoolean);
    localImageView.setSelected(paramBoolean);
    if (!paramBoolean)
    {
      localView.setBackgroundResource(2130840722);
      if (paramInt > 0) {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(paramInt - 1).findViewById(2131297586).setBackgroundResource(2130840722);
      }
    }
    do
    {
      return;
      localView.setBackgroundResource(2130837567);
    } while (paramInt <= 0);
    this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(paramInt - 1).findViewById(2131297586).setBackgroundResource(2130837567);
  }
}
