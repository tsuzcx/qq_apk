  ...
  extends LinearLayout
{
  ...
  public void a()
  {
    ...
    removeAllViews();
    Object localObject = inflate(this.jdField_a_of_type_AndroidContentContext, 2130903075, null);
    ((ImageView)((View)localObject).findViewById(2131296701)).setImageDrawable(this.jdField_a_of_type_ComTencentImageURLDrawable);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      localAlphaAnimation.setAnimationListener(new igv(this));
      return;
    }
    removeAllViews();
  }
  ...
  public void b()
  {
    ThreadManager.b().post(new igw(this));
  }
