  ...
  extends EmoticonPanelViewBinder
{
  ...
  public Drawable a(Context paramContext)
  {
    ...
    try
    {
      Drawable localDrawable = paramContext.getResources().getDrawable(2130840761);
      paramContext = paramContext.getResources().getDrawable(2130840762);
    ...
    catch (OutOfMemoryError paramContext)
    {
      ...
      QLog.e("RecentAndFavPanelViewBinder", 2, "getTabDrawable OOM occured");
    }
    return localStateListDrawable;
  }
  ...
  protected void a(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonLinearLayout$EmoticonAdapter = new EmoticonPanelViewBinder.DefaultEmoticonAdapter(this, 2009);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilList == null) || (paramBoolean)) {
      this.jdField_a_of_type_JavaUtilList = EmoticonUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Int);
    }
