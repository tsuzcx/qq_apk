...
public class TroopAssistantManager
{
  ...
  private void a(EntityManager arg1)
  {
    try
    {
      ...
      if ((localObject1 != null) && (((List)localObject1).size() > 0)) {
        Collections.sort((List)localObject1, new jfc(this));
      }
    }
    catch (Exception ???)
    {
  ...
  private boolean a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong)
  {
    ...
    case 2: 
      if (bool)
      {
        localObject = localRecentUserProxy.a(AppConstants.aa, 5000);
        ((RecentUser)localObject).uin = AppConstants.aa;
    ...
    for (;;)
    {
      ...
      if (paramInt != 3)
      {
        paramQQAppInterface = localRecentUserProxy.b(AppConstants.aa, 5000);
        if (paramQQAppInterface != null) {
  ...
  private void k(QQAppInterface paramQQAppInterface)
  {
    ...
    ThreadManager.b(new jfb(this, paramQQAppInterface));
  }
