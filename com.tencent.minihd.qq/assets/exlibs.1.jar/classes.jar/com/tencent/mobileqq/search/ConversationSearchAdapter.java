...
public class ConversationSearchAdapter
  extends BaseAdapter
  implements SearchAdapterInterface, SearchTask.SearchTaskCallBack, FaceDecoder.DecodeTaskCompletionListener, AbsListView.OnScrollListener
{
  ...
  private View b(int paramInt, View paramView, ViewGroup paramViewGroup, IContactSearchable paramIContactSearchable)
  {
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903197, paramViewGroup, false);
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(paramIContactSearchable.a());
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setText(paramIContactSearchable.c());
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView.setText("来自:" + paramIContactSearchable.b());
  ...
  protected View a(int paramInt, View paramView, ViewGroup paramViewGroup, IContactSearchable paramIContactSearchable)
  {
    ...
    if (localRecentUser != null)
    {
      ...
      if (((paramIContactSearchable instanceof RecentItemChatMsgData)) && (!TextUtils.isEmpty(paramIContactSearchable.c)) && (paramIContactSearchable.c.toString().equals("[新签名]"))) {
        paramIContactSearchable.E = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131427972);
      }
