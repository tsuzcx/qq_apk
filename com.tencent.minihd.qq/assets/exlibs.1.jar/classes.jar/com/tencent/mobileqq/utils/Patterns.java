...
public class Patterns
{
  ...
  public static final Pattern d = Pattern.compile("(((([a-zA-Z0-9][a-zA-Z0-9\\-]*)*[a-zA-Z0-9]\\.)+" + a + ")|" + c + ")");
  ...
  public static final String a(Matcher paramMatcher)
  {
    ...
    int j = paramMatcher.groupCount();
    int i = 1;
    while (i <= j)
    {
      String str = paramMatcher.group(i);
      System.err.println("Group(" + i + ") : " + str);
      if (str != null) {
  ...
  public static final String b(Matcher paramMatcher)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    paramMatcher = paramMatcher.group();
    int i = 0;
    int j = paramMatcher.length();
    while (i < j)
    {
      char c1 = paramMatcher.charAt(i);
