  ...
  implements Manager
{
  ...
  {
    paramQQAppInterface = (RoamSettingController)paramQQAppInterface.getManager(30);
  ...
  {
    return (RoamSettingManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(39);
  }
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          ThreadManager.b().postDelayed(new kty(this), i);
        } while (!QLog.isColorLevel());
