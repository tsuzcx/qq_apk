  ...
  extends Dialog
{
  ...
  private BaseAdapter jdField_a_of_type_AndroidWidgetBaseAdapter = new ksz(this);
  ...
  public QQCustomSingleButtonDialog a(int paramInt1, int paramInt2, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new ktb(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomSingleButtonDialog a(Drawable paramDrawable, boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (paramInt == 2)
      {
        this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130838391);
        return this;
      }
  ...
  public QQCustomSingleButtonDialog a(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.d.setOnClickListener(new kta(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomSingleButtonDialog b(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.d.setVisibility(0);
    this.d.setOnClickListener(new ktc(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomSingleButtonDialog b(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      this.b.setContentDescription(paramString);
      this.b.setLinkTextColor(getContext().getResources().getColor(2131427477));
      this.b.setVisibility(0);
      return this;
    }
    this.b.setVisibility(8);
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.b = ((TextView)findViewById(2131296606));
    this.c = ((TextView)findViewById(2131297378));
    this.f = ((TextView)findViewById(2131297374));
    this.e = ((TextView)findViewById(2131297375));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131297377));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131297376);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131297370));
