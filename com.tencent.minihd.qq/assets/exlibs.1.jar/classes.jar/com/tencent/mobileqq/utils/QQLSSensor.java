...
public class QQLSSensor
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new ktq(this, Looper.getMainLooper());
  ...
  public QQLSSensor(Context paramContext, QQLSSensor.ProximitySensorChangeListener paramProximitySensorChangeListener)
  {
    ...
    this.jdField_a_of_type_AndroidHardwareSensorEventListener = new ktp(this);
