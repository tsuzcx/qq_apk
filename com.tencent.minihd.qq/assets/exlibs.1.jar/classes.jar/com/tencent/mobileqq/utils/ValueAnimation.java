...
public class ValueAnimation
  extends Animation
{
  static final kuj jdField_a_of_type_Kuj = new kue();
  static final kuj b;
  static final kuj c;
  static final kuj d = new kuh();
  static final kuj e = new kui();
  ...
  static
  {
    jdField_b_of_type_Kuj = new kuf();
    jdField_c_of_type_Kuj = new kug();
  }
  ...
  public ValueAnimation(Object paramObject1, Object paramObject2, ValueAnimation.AnimationUpdateListener paramAnimationUpdateListener, boolean paramBoolean1, boolean paramBoolean2, kuj paramkuj)
  {
    ...
    for (;;)
    {
      ...
      {
        this.f = jdField_a_of_type_Kuj;
      }
      else if (Float.class == localClass)
      {
        this.f = jdField_b_of_type_Kuj;
      }
      else if (Rect.class == localClass)
      {
        this.f = jdField_c_of_type_Kuj;
      }
