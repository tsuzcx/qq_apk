...
public class QQRecorder
{
  ...
  public static final String b = "https://kf.qq.com/touch/apifaq/1211147RVfAV140904mA3QjU.html?platform=14";
  ...
  public static int a(String paramString)
  {
    ...
    //   0: aconst_null
    //   1: astore 11
    //   3: new 215	java/io/FileInputStream
    //   6: dup
    //   7: aload_0
    //   8: invokespecial 216	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   11: astore 10
    //   13: new 218	java/io/DataInputStream
    //   16: dup
    //   17: aload 10
    //   19: invokespecial 221	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   22: astore 9
    //   24: aload 10
    //   26: invokevirtual 225	java/io/FileInputStream:available	()I
    //   29: istore 7
    //   31: iconst_0
    //   32: istore 5
    //   34: aload 9
    //   36: invokevirtual 229	java/io/DataInputStream:readByte	()B
    //   39: istore 8
    //   41: iload 8
    //   43: ifle +237 -> 280
    //   46: iload 5
    ...
    //   77: ldc2_w 230
    //   80: dsub
    //   81: getstatic 66	com/tencent/mobileqq/utils/QQRecorder:jdField_a_of_type_ArrayOfInt	[I
    //   84: iload 5
    //   86: iaload
    //   87: i2d
    //   88: ddiv
    ...
    //   93: dstore_3
    //   94: aload 9
    //   96: invokevirtual 236	java/io/DataInputStream:close	()V
    //   99: aload 10
    //   101: invokevirtual 237	java/io/FileInputStream:close	()V
    //   104: aload 10
    //   106: ifnull +8 -> 114
    //   109: aload 10
    //   111: invokevirtual 237	java/io/FileInputStream:close	()V
    //   114: aload 9
    //   116: ifnull +8 -> 124
    //   119: aload 9
    //   121: invokevirtual 236	java/io/DataInputStream:close	()V
    //   124: dload_3
    //   125: dstore_1
    //   126: dload_3
    //   127: ldc2_w 238
    ...
    //   161: astore 9
    //   163: aload 10
    //   165: invokevirtual 242	java/lang/Exception:printStackTrace	()V
    //   168: aload_0
    //   169: ifnull +7 -> 176
    //   172: aload_0
    //   173: invokevirtual 237	java/io/FileInputStream:close	()V
    //   176: aload 9
    //   178: ifnull +8 -> 186
    //   181: aload 9
    //   183: invokevirtual 236	java/io/DataInputStream:close	()V
    //   186: iconst_0
    //   187: ireturn
    //   188: astore_0
    //   189: aconst_null
    ...
    //   197: ifnull +8 -> 205
    //   200: aload 10
    //   202: invokevirtual 237	java/io/FileInputStream:close	()V
    //   205: aload 9
    //   207: ifnull +8 -> 215
    //   210: aload 9
    //   212: invokevirtual 236	java/io/DataInputStream:close	()V
    //   215: aload_0
    //   216: athrow
    //   217: astore 9
    //   219: goto -4 -> 215
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ChatActivity", 2, "thread is:" + this.jdField_a_of_type_Ktr + ",time is:" + System.currentTimeMillis());
    }
    if (this.jdField_a_of_type_Ktr != null) {
      this.jdField_a_of_type_Ktr.a = false;
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Ktr == null)
    {
      this.jdField_a_of_type_Ktr = new ktr(this, paramString);
      this.jdField_a_of_type_Ktr.start();
      d = paramString;
    }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Ktr != null;
  }
  
  public boolean b()
  {
    return (this.jdField_a_of_type_Ktr == null) || (!this.jdField_a_of_type_Ktr.a);
  }
}
