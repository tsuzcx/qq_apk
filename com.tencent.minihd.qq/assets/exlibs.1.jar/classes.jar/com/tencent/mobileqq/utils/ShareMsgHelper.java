  ...
  implements AppConstants
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, AbsStructMsg paramAbsStructMsg, BusinessObserver paramBusinessObserver)
  {
    ...
    do
    {
      do
      {
        ...
        MobileQQService.c = i + 1;
        long l = i;
        MessageForStructing localMessageForStructing = MessageRecordFactory.a(paramQQAppInterface, paramBusinessObserver, paramString, paramBusinessObserver, paramInt, l, paramAbsStructMsg);
        if (paramAbsStructMsg.mMsgServiceID == 41)
        {
          paramQQAppInterface.a().b(localMessageForStructing, null);
          return;
        }
        if (paramAbsStructMsg.mMsgServiceID == 100)
        {
          paramAbsStructMsg.mMsgServiceID = 1;
          paramAbsStructMsg = MessageRecordFactory.a(paramQQAppInterface, paramBusinessObserver, paramString, paramBusinessObserver, paramInt, l, paramAbsStructMsg);
          paramQQAppInterface.a().a(paramAbsStructMsg, new kua(paramQQAppInterface, paramInt, paramString));
          return;
        }
        paramQQAppInterface.a().a(localMessageForStructing, null);
        return;
  ...
  public static boolean a(Context paramContext, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12, String paramString13, String paramString14, String paramString15, String paramString16, String paramString17, String paramString18, Intent paramIntent, int paramInt3, String paramString19)
  {
    ...
    if (paramIntent == null) {
      localIntent = new Intent("com.tencent.intent.QQ_FORWARD");
    }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, int paramInt)
  {
    ...
    localIntent.putExtra("category", paramContext.getString(2131363606));
    ...
    for (;;)
    {
      ...
      localIntent.putExtra("app_name", paramContext.getString(2131363607));
      localIntent.putExtra("brief_key", String.format(paramContext.getString(2131363610), new Object[] { paramString6, paramString2 }));
      ...
      paramContext.startActivity(localIntent);
      return true;
      paramString3 = "mqqapi://app/action?pkg=com.tencent.minihd.qq&cmp=com.tencent.biz.pubaccount.AccountDetailActivity&uin=" + paramString1;
      ...
      continue;
      paramString3 = "mqqapi://app/action?pkg=com.tencent.minihd.qq&cmp=com.tencent.biz.eqq.EnterpriseDetailActivity&uin=" + paramString1;
