...
public class ContactConfig
{
  ...
  {
    int i = 0;
    paramContext = paramContext.getSharedPreferences(String.valueOf(AppConstants.ae), 0).edit();
  ...
  {
    paramContext.getSharedPreferences(String.valueOf(AppConstants.ae), 0).edit().putInt(paramString, paramInt).commit();
  }
