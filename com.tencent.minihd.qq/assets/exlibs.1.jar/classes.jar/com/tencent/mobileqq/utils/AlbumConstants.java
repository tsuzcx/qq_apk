...
public class AlbumConstants
{
  ...
  private static final String D = AlbumConstants.class.getName() + ".";
  public static final int a = 1;
  public static final String a = AlbumConstants.class.getSimpleName();
  public static final int b = 2;
  public static final String b = D + "SelectedPhotoList";
  public static final int c = 3;
  public static final String c = D + "ForwardWhere";
  public static final int d = 4;
  public static final String d = D + "FromWhere";
  public static final int e = 5;
  public static final String e = D + "AlbumName";
  public static final int f = 200;
  public static final String f = D + "AlbumId";
  public static final int g = 200;
  public static final String g = D + "InitActivityClass";
  public static final int h = 6;
  public static final String h = D + "DestActivityClass";
  public static final String i = D + "RequestCode";
  public static final String j = "result_code";
  public static final String k = D + "TempSelectPhotoMap";
  public static final String l = D + "PassToDestActivity";
  public static final String m = D + "PassFromDestActivity";
