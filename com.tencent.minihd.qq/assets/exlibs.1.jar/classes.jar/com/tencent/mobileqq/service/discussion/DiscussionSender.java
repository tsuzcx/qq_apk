...
{
  private static final String jdField_a_of_type_JavaLangString = DiscussionSender.class.getSimpleName();
  ...
  private boolean e(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    Object localObject = (Map)paramToServiceMsg.getAttribute("inteRemarkUinMap");
    ...
    if (localObject != null) {
      localReqGetDiscussInfo.UinList = ((Map)localObject);
    }
    ...
    if (QLog.isColorLevel())
    {
      ...
      localObject = new StringBuilder().append("createGetDiscussInfoBuffer reqUIn =").append(localReqGetDiscussInfo.DiscussUin).append(",inteRemarktime =").append(localReqGetDiscussInfo.InteRemarkTimeStamp).append(",uinList size ");
    ...
    {
      QLog.d(paramToServiceMsg, 2, i + ", signature=" + localReqGetDiscussInfo.Signature);
  ...
  private boolean f(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "createGetDiscussInteRemarkBuffer reqUIn =" + localReqGetDiscussInteRemark.DiscussUin + " uinList size " + localReqGetDiscussInteRemark.UinList.size());
    }
  ...
  {
    paramUniPacket.setServantName("QQServiceDiscussSvc");
    paramUniPacket.setFuncName("ReqGetDiscuss");
    ReqGetDiscuss localReqGetDiscuss = new ReqGetDiscuss();
    localReqGetDiscuss.Uin = paramToServiceMsg.extraData.getLong("uin");
    paramUniPacket.put("ReqGetDiscuss", localReqGetDiscuss);
    paramUniPacket.put("DiscussReqHeader", this.jdField_a_of_type_QQServiceDiscussReqHeader);
    return true;
  }
  ...
  private boolean k(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localReqJoinDiscuss.From = paramToServiceMsg.extraData.getInt(ScannerActivity.o);
