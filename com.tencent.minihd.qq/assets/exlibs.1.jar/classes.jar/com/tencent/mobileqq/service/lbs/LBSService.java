...
import NeighborSvc.ReqGetEntrance;
  ...
  extends BaseProtocolCoder
{
  ...
  protected static final String a = "https://112.90.138.176:8080/mmu/0";
  ...
  protected static final String b = "https://112.90.138.176:8080/mmd/0";
  ...
  private boolean A(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    try
    {
      ...
      localSSummaryCardLikeIt.version = "5.9.3";
  ...
  private boolean E(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localObject = new ReqFavorite(new QQService.ReqHead(l1, (short)1, paramUniPacket.getRequestId(), (byte)1, (byte)0, (byte[])localObject), l2, 0, i);
    paramUniPacket.setServantName("VisitorSvc");
      ...
      if (i1 == 3)
      {
        ...
        try
        {
          ...
          while (j < i2)
          {
            ...
            ((SummaryCardBusiEntry.comm)localObject3).qqver.set("5.9.3.3468");
  ...
  private boolean j(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      if (localObject1 != null)
      {
        ...
        EncounterSvc.ReqUserInfo localReqUserInfo = new EncounterSvc.ReqUserInfo();
        ...
        localReqUserInfo.stGps = new EncounterSvc.GPS((int)(((SosoInterface.SosoLbsInfo)localObject1).jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$SosoLocation.a * 1000000.0D), (int)(((SosoInterface.SosoLbsInfo)localObject1).jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$SosoLocation.b * 1000000.0D), -1, 0);
        ...
        localObject1 = new EncounterSvc.ReqUserInfo();
        int i = paramToServiceMsg.extraData.getInt("localLat");
        int j = paramToServiceMsg.extraData.getInt("localLon");
        if ((i != 0) && (j != 0))
        {
          ((EncounterSvc.ReqUserInfo)localObject1).vCells = new ArrayList(1);
          ((EncounterSvc.ReqUserInfo)localObject1).vMacs = new ArrayList(1);
          ((EncounterSvc.ReqUserInfo)localObject1).eLocalInfo = LocalInfoType.LocalInfoType_Decode.value();
          ((EncounterSvc.ReqUserInfo)localObject1).stGps = new EncounterSvc.GPS(i, j, 0, 1);
        }
    ...
    while (paramToServiceMsg != null) {
      if ((paramToServiceMsg.eReplyCode == 0) || (paramToServiceMsg.eReplyCode == 300))
      {
        ...
        if (paramFromServiceMsg != null)
        {
          ...
          DatingManager.a(this.jdField_a_of_type_EncounterSvcUserData.iLon, this.jdField_a_of_type_EncounterSvcUserData.iLat, this.jdField_a_of_type_EncounterSvcUserData.lTime);
  ...
  private boolean k(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      localObject4 = paramToServiceMsg.extraData.getLongArray("tags");
      localObject2 = null;
    ...
    Object localObject4 = new cmd0x5fb.ReqInfo();
    if (paramToServiceMsg != null)
    {
      ((cmd0x5fb.ReqInfo)localObject4).uint32_time.set(paramToServiceMsg.e);
      ((cmd0x5fb.ReqInfo)localObject4).uint32_subject.set(paramToServiceMsg.g);
      ((cmd0x5fb.ReqInfo)localObject4).uint32_gender.set(paramToServiceMsg.d);
      ((cmd0x5fb.ReqInfo)localObject4).uint32_age_low.set(DatingFilters.b[paramToServiceMsg.h]);
      ((cmd0x5fb.ReqInfo)localObject4).uint32_age_up.set(DatingFilters.jdField_a_of_type_ArrayOfInt[paramToServiceMsg.h]);
      PBUInt32Field localPBUInt32Field = ((cmd0x5fb.ReqInfo)localObject4).uint32_profession;
      if (paramToServiceMsg.i >= 0) {
        break label1233;
      }
      i = 0;
      localPBUInt32Field.set(i);
      ((cmd0x5fb.ReqInfo)localObject4).bytes_cookie.set(ByteStringMicro.copyFrom(new byte[0]));
      if ((paramToServiceMsg.jdField_a_of_type_AppointDefineAppoint_define$LocaleInfo != null) && (paramToServiceMsg.g == 5)) {
        ((cmd0x5fb.ReqInfo)localObject4).msg_destination.set(paramToServiceMsg.jdField_a_of_type_AppointDefineAppoint_define$LocaleInfo);
      }
    }
    if (bool1) {}
    for (paramToServiceMsg = new ReqGetEncounterV2(localReqUserInfo, this.jdField_a_of_type_EncounterSvcUserData, k, -1, (ArrayList)localObject1, new byte[1], (byte)j, 2000, -1, 0, null, (byte[])localObject2, 0, (byte)1, b1, b2, b3, m, n, i2, i3, (byte)1, i1, (EncounterSvc.ReqUserInfo)localObject3, 15, ((cmd0x5fb.ReqInfo)localObject4).toByteArray());; paramToServiceMsg = new ReqGetEncounterV2(localReqUserInfo, this.jdField_a_of_type_EncounterSvcUserData, k, -1, (ArrayList)localObject1, new byte[1], (byte)0, 2000, -1, 0, null, (byte[])localObject2, 0, (byte)1, b1, b2, b3, m, n, i2, i3, (byte)1, i1, null, 15, ((cmd0x5fb.ReqInfo)localObject4).toByteArray()))
    {
      paramUniPacket.setEncodeName("utf-8");
      paramUniPacket.setServantName("EncounterObj");
  ...
  private boolean o(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      return true;
      SosoInterface.a(60000L, getClass().getSimpleName() + ".Neighbour");
      localObject1 = SosoInterface.a();
      i = 0;
      break;
      label327:
      localReqUserInfo.eLocalInfo = LocalInfoType.LocalInfoType_SOSO.value();
      localReqUserInfo.stGps = new NeighborSvc.GPS((int)(((SosoInterface.SosoLbsInfo)localObject1).jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$SosoLocation.a * 1000000.0D), (int)(((SosoInterface.SosoLbsInfo)localObject1).jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$SosoLocation.b * 1000000.0D), -1, 0);
      localReqUserInfo.vSOSOCells = new ArrayList();
      Object localObject2;
      if (((SosoInterface.SosoLbsInfo)localObject1).jdField_a_of_type_JavaUtilArrayList != null)
      {
  ...
  private boolean p(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (((bool1) && (i != 0) && (j != 0)) || (bool2))
    {
      ...
      for (i = 1;; i = 0)
      {
        ...
        SosoInterface.a(60000L, getClass().getSimpleName() + ".Point");
  ...
  private Object v(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.vUserList != null) && (!paramFromServiceMsg.vUserList.isEmpty()))
    {
      ...
      while (i < paramFromServiceMsg.vUserList.size())
      {
        ...
        paramToServiceMsg.locDesc = ((ConditionSearchManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(57)).b(new String[] { str1, str2, str3, "0" });
        i += 1;
      }
    }
    return paramFromServiceMsg;
  ...
  private boolean v(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    byte[] arrayOfByte = ((UniPacket)localObject4).encode();
    localObject3 = null;
    if (!bool)
    {
      localObject3 = new SSummaryCardQueryReq(1, Long.parseLong(paramToServiceMsg.getUin()), l2, "5.9.3", k, 109L);
    ...
    for (;;)
    {
      try
      {
        ...
        if ((l2 > 0L) || (bool))
        {
          ...
          int[] tmp391_389 = arrayOfInt;
          tmp391_389[0] = 1;
          int[] tmp395_391 = tmp391_389;
          tmp395_391[1] = 2;
          int[] tmp399_395 = tmp395_391;
          tmp399_395[2] = 3;
          int[] tmp403_399 = tmp399_395;
          tmp403_399[3] = 4;
          int[] tmp407_403 = tmp403_399;
          tmp407_403[4] = 6;
          tmp407_403;
          int j = 0;
          if (j < tmp403_399.length)
          {
            ...
            ((SummaryCardBusiEntry.comm)localObject6).service.set(tmp403_399[j]);
            if ((tmp403_399[j] == 1) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
            {
              localObject4 = (TicketManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(2);
              if (localObject4 == null) {
                break label817;
              }
              localObject4 = ((TicketManager)localObject4).getSid(String.valueOf(l1));
              if (TextUtils.isEmpty((CharSequence)localObject4)) {
                break label811;
              }
              localObject4 = ((String)localObject4).getBytes();
              if (localObject4 != null) {
                ((SummaryCardBusiEntry.comm)localObject6).session_key.set(ByteStringMicro.copyFrom((byte[])localObject4));
              }
            }
            ((SummaryCardBusiEntry.comm)localObject6).platform.set(2);
            ((SummaryCardBusiEntry.comm)localObject6).qqver.set("5.9.3.3468");
            ((SummaryCardBusiEntry.comm)localObject6).build.set(i);
            localObject4 = ((SummaryCardBusiEntry.comm)localObject6).toByteArray();
            int n = localObject4.length;
            localObject6 = new byte[n + 9 + 0 + 1];
            localObject6[0] = 40;
            PkgTools.a((byte[])localObject6, 1, n);
            PkgTools.a((byte[])localObject6, 5, 0);
            PkgTools.a((byte[])localObject6, 9, (byte[])localObject4, n);
            n = localObject4.length + 9;
            localObject6[n] = 41;
            tmp399_395.add(localObject6);
            j += 1;
            continue;
          }
        }
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        int i = 0;
        continue;
        localObject1 = new ReqSummaryCard(l2, k, l3, b1, l4, l5, (byte[])localObject1, tmp391_389, l6, m, (byte[])localObject2, tmp395_391, (byte[])localObject3, null, tmp399_395, l7);
        localObject2 = new SummaryCard.ReqHead();
        paramUniPacket.setServantName("SummaryCardServantObj");
  ...
  private boolean z(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        localSSummaryCardSetLabel.version = "5.9.3";
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (("EncounterSvc.ReqGetEntrance".equals(paramFromServiceMsg.getServiceCmd())) || ("NeighborSvc.ReqGetNeighbors".equals(paramFromServiceMsg.getServiceCmd())) || ("NeighborSvc.ReqSetUserState".equals(paramFromServiceMsg.getServiceCmd())));
