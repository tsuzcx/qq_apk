...
public class QZonePreLoader
  extends Step
{
  private static final String a = "com.qzone.util.ResourceLoader";
  private static final String c = "preloadResource";
  
  private void a()
  {
    Object localObject1 = PluginUtils.getInstalledPluginPath(BaseApplicationImpl.getContext(), "qzone_plugin.apk");
