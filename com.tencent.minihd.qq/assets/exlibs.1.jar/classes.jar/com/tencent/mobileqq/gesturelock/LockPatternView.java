  ...
  extends View
{
  ...
  public LockPatternView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.C).getString(0);
    ...
    {
      setClickable(true);
      this.s = getResources().getColor(2131427460);
      this.t = getResources().getColor(2131427461);
      this.u = getResources().getDimensionPixelSize(2131493093);
      ...
      this.jdField_g_of_type_Int = getResources().getColor(2131427465);
      this.jdField_h_of_type_Int = getResources().getColor(2131427466);
      this.i = getResources().getColor(2131427467);
      this.j = getResources().getColor(2131427468);
      this.k = getResources().getColor(2131427469);
      this.l = getResources().getColor(2131427470);
      this.m = getResources().getColor(2131427471);
      this.n = getResources().getColor(2131427472);
      this.o = getResources().getColor(2131427473);
      this.jdField_g_of_type_Float = getResources().getDimensionPixelSize(2131493094);
      this.p = (getWidth() / 4);
      this.q = (getHeight() / 4);
      return;
