...
public class SogouEmoji
{
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqEmoticonSogouEmoji$OnEmojiJsonBackSogou = new ifd(this);
  ...
  {
    paramString1 = new ife(this, paramString1, paramString2, paramBoolean);
  ...
  public void a(String paramString, ArrayList paramArrayList, SogouEmoji.OnEmojiKeyBackSogou paramOnEmojiKeyBackSogou)
  {
    ...
    {
      return;
      paramOnEmojiKeyBackSogou = new ifh(this, paramArrayList, paramOnEmojiKeyBackSogou);
  ...
  {
    paramList = new ifg(this, paramList);
