...
public class EmosmUtils
{
  ...
  public static String getEmoticonAIOPreviewUrl(String paramString1, String paramString2)
  {
    ...
    paramString1.append("https://i.gtimg.cn/club/item/parcel/item/" + paramString2.substring(0, 2) + "/" + paramString2 + "/200x200.png");
  ...
  public static String getEmoticonEncrytUrl(String paramString1, String paramString2, int paramInt)
  {
    paramString1 = new StringBuilder();
    if (1 == paramInt) {
      paramString1.append("https://i.gtimg.cn/club/item/parcel/item/" + paramString2.substring(0, 2) + "/" + paramString2 + "/pngframe.zip");
    }
    for (;;)
    {
      return insertMtype("VIP_emosm", paramString1.toString());
      paramString1.append("https://i.gtimg.cn/club/item/parcel/item/" + paramString2.substring(0, 2) + "/" + paramString2 + "/200_200");
    }
  }
  ...
  {
    paramString1 = new StringBuilder();
    paramString1.append("https://i.gtimg.cn/club/item/parcel/item/" + paramString2.substring(0, 2) + "/" + paramString2 + "/126x126.png");
    return insertMtype("VIP_emosm", paramString1.toString());
  }
  ...
  {
    paramString1 = new StringBuilder();
    paramString1.append("https://i.gtimg.cn/club/item/parcel/item/" + paramString2.substring(0, 2) + "/" + paramString2 + "/ring.amr");
    return insertMtype("VIP_emosm", paramString1.toString());
  }
  ...
  public static byte[] getFileData(String paramString)
  {
    ...
    //   11: ifeq +63 -> 74
    //   14: new 262	java/io/FileInputStream
    //   17: dup
    ...
    //   31: astore_0
    //   32: aload_1
    //   33: invokevirtual 268	java/io/FileInputStream:available	()I
    //   36: newarray byte
    //   38: astore_2
    //   39: aload_1
    //   40: astore_0
    //   41: aload_1
    //   42: aload_2
    //   43: invokevirtual 272	java/io/FileInputStream:read	([B)I
    //   46: pop
    //   47: aload_1
    //   48: ifnull +7 -> 55
    //   51: aload_1
    //   52: invokevirtual 275	java/io/FileInputStream:close	()V
    //   55: aload_2
    //   56: areturn
    //   57: astore_2
    //   58: aconst_null
    ...
    //   61: astore_0
    //   62: aload_2
    //   63: invokevirtual 276	java/io/FileNotFoundException:printStackTrace	()V
    //   66: aload_1
    //   67: ifnull +7 -> 74
    //   70: aload_1
    //   71: invokevirtual 275	java/io/FileInputStream:close	()V
    //   74: aconst_null
    //   75: areturn
    //   76: astore_2
    //   77: aconst_null
    ...
    //   80: astore_0
    //   81: aload_2
    //   82: invokevirtual 277	java/io/IOException:printStackTrace	()V
    //   85: aload_1
    //   86: ifnull -12 -> 74
    //   89: aload_1
    //   90: invokevirtual 275	java/io/FileInputStream:close	()V
    //   93: goto -19 -> 74
    //   96: astore_0
    //   97: goto -23 -> 74
    //   100: astore_1
    ...
    //   104: ifnull +7 -> 111
    //   107: aload_0
    //   108: invokevirtual 275	java/io/FileInputStream:close	()V
    //   111: aload_1
    //   112: athrow
    //   113: astore_0
    //   114: aload_2
  ...
  public static String getMagicfaceFolderPath(String paramString1, String paramString2)
  {
    ...
    paramString2.append(AppConstants.bk);
    paramString2.append(paramString1 + File.separator);
    return paramString2.toString();
  }
  
  public static String getPngFramePath(String paramString)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(getEmoticonPackageFolder(paramString));
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("https://ugc.qpic.cn/q_face/0/");
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(AppConstants.bl);
    localStringBuilder.append(paramString + File.separator);
    if (paramBoolean) {
  ...
  public static String getQFaceMaterialUrl(String paramString)
  {
    ...
    catch (Exception localException)
    {
      ...
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append("https://i.gtimg.cn/club/item/parcel/" + i % 10 + "/" + paramString + "/material.zip");
      return insertMtype("VIP_emosm", localStringBuilder.toString());
    }
  }
  ...
  public static boolean showNetEnable(Context paramContext)
  {
    boolean bool = NetworkUtil.e(BaseApplicationImpl.getContext());
    if (!bool) {
      QQToast.a(BaseApplicationImpl.getContext(), 2131365730, 0).a();
    }
    return bool;
  }
}
