  ...
  extends ListView
{
  ...
  public DragSortListView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    {
      paramContext = getContext().obtainStyledAttributes(paramAttributeSet, R.styleable.l, 0, 0);
  ...
  private ImageView getLeftIndicator(int paramInt)
  {
    ...
    if ((paramInt >= 0) && (paramInt <= getChildCount()))
    {
      ...
      if (localView != null) {
        return (ImageView)localView.findViewById(2131300116);
      }
    }
    return null;
  }
  ...
  public ShaderAnimLayout getDelButton(int paramInt)
  {
    ...
    if ((paramInt >= 0) && (paramInt <= super.getChildCount()))
    {
      View localView = super.getChildAt(paramInt);
      if (localView != null) {
        return (ShaderAnimLayout)localView.findViewById(2131296569);
      }
    }
    return null;
  }
  ...
  public void hideDelButton()
  {
    ...
    if (localObject != null)
    {
      ...
      {
        localObject = (RelativeLayout)getItemChild(this.mProgressPos, 2131297625);
        if ((localObject != null) && (((ProgressCircle)((RelativeLayout)localObject).findViewById(2131297627)).getVisibility() == 0)) {
  ...
  public void hideDelButtonWithoutAnimation()
  {
    ...
    if (localObject != null)
    {
      ...
      {
        localObject = (RelativeLayout)getItemChild(this.mProgressPos, 2131297625);
        if (((ProgressCircle)((RelativeLayout)localObject).findViewById(2131297627)).getVisibility() == 0) {
          ((RelativeLayout)localObject).setVisibility(0);
        }
      }
    }
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramMotionEvent = (Button)getItemChild(this.mTapPos, 2131297583);
        if (paramMotionEvent == null) {
          return false;
        }
    ...
    do
    {
      ...
      if (!this.mDragEnabled)
      {
        if (paramMotionEvent.getAction() == 0)
        {
          ...
          Button localButton = (Button)getItemChild(this.mTapPos, 2131297583);
  ...
  public void showDelButton()
  {
    ...
    do
    {
      ...
      this.mIsDelShow = true;
      localObject = (RelativeLayout)getItemChild(this.mSrcPos, 2131297625);
      localProgressCircle = (ProgressCircle)((RelativeLayout)localObject).findViewById(2131297627);
