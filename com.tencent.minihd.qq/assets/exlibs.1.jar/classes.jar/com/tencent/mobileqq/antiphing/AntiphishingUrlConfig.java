...
public class AntiphishingUrlConfig
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new hgd(this);
  ...
  public void a(int paramInt, String paramString1, String paramString2, Context paramContext)
  {
    ...
    new hge(this, paramContext, paramString1, paramString2).start();
  }
  ...
  public boolean a()
  {
    ...
    hgf localhgf = new hgf();
    try
    {
      SAXParserFactory.newInstance().newSAXParser().parse(new InputSource(new InputStreamReader(new FileInputStream((File)localObject), "UTF-8")), localhgf);
      this.jdField_a_of_type_Int = localhgf.a();
      this.jdField_a_of_type_JavaUtilArrayList = localhgf.a();
      return true;
    }
