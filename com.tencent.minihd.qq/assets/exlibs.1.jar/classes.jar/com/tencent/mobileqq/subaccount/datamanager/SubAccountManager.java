  ...
  implements Manager
{
  ...
  public void a(SubAccountBackProtocData paramSubAccountBackProtocData)
  {
    ...
    label143:
    for (paramSubAccountBackProtocData = "data == null";; paramSubAccountBackProtocData = "data.mMainAccount=" + paramSubAccountBackProtocData.b + " data.mSubUin=" + paramSubAccountBackProtocData.c)
    {
      QLog.d("SUB_ACCOUNT", 2, paramSubAccountBackProtocData);
      return;
      localObject1 = "data.mMainAccount=" + paramSubAccountBackProtocData.b + " data.mSubUin=" + paramSubAccountBackProtocData.c;
      break;
    }
    label183:
  ...
  public long b(String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("SUB_ACCOUNT", 2, "getLastCleanQZoneMessageTime() subUin is null.");
      }
      return 0L;
    }
    if (this.jdField_a_of_type_JavaUtilArrayList == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("SUB_ACCOUNT", 2, "getLastCleanQZoneMessageTime() listSubInfo is null.");
      }
      return 0L;
    }
    this.jdField_a_of_type_JavaUtilConcurrentLocksLock.lock();
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_JavaUtilConcurrentLocksLock.unlock();
        if (paramString != null) {
          return paramString.lastCleanQZoneMessageTime;
        }
      }
      finally
      {
  ...
  public void g(String paramString)
  {
    if (paramString == null) {
      if (QLog.isColorLevel()) {
        QLog.d("SUB_ACCOUNT", 2, "updateLastCleanQZoneMessageTime() subUin is null.");
      }
    }
    do
    {
    ...
    QLog.d("SUB_ACCOUNT", 2, "updateLastCleanQZoneMessageTime() listSubInfo is null.");
    return;
    this.jdField_a_of_type_JavaUtilConcurrentLocksLock.lock();
    for (;;)
    {
      try
      {
        ...
        if (((Iterator)localObject).hasNext())
        {
          ...
          localSubAccountInfo.lastCleanQZoneMessageTime = (System.currentTimeMillis() / 1000L);
          localObject = localSubAccountInfo;
          if (QLog.isColorLevel())
          {
            QLog.d("SUB_ACCOUNT", 2, "updateLastCleanQZoneMessageTime() subUin=" + paramString + ", CurrentTime=" + System.currentTimeMillis());
            localObject = localSubAccountInfo;
          }
          this.jdField_a_of_type_JavaUtilConcurrentLocksLock.unlock();
          if (localObject == null) {
