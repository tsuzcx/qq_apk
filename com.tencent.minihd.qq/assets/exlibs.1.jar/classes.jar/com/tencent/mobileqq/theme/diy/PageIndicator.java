  ...
  extends LinearLayout
{
  ...
  public void bindScrollViewGroup(ScrollLayout paramScrollLayout)
  {
    ...
    while (i < j)
    {
      ...
      localImageView.setBackgroundResource(2130840913);
      if ((paramScrollLayout != null) && (i == j - 1)) {
  ...
  public void generatePageControl(int paramInt)
  {
    ...
    while (i < j)
    {
      ...
      if (localView != null) {
        localView.setBackgroundResource(2130840913);
      }
      i += 1;
    }
    if (paramInt == -1) {
    ...
    for (;;)
    {
      if ((i > -1) && (i < j))
      {
        localView = super.getChildAt(i);
        if (localView != null) {
          localView.setBackgroundResource(2130840914);
        }
      }
      return;
      i = paramInt;
