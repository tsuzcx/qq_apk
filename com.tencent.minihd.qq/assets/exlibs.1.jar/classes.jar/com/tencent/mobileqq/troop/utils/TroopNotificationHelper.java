...
public class TroopNotificationHelper
{
  ...
  public static TroopNotificationCache a(kms paramkms, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    if (paramkms != null)
    {
      if (paramkms.jdField_c_of_type_Int == 1)
      {
        String str2 = a(paramkms.jdField_c_of_type_JavaLangString);
        ...
        str2 = a(paramkms.jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty(paramkms.jdField_a_of_type_JavaLangString))
        {
          str2 = new SimpleDateFormat("yyyy年M月d日").format(new Date(paramkms.jdField_e_of_type_Int * 1000L));
          str2 = str2 + " 群公告";
        }
        ...
        localTroopNotificationCache.title = paramkms.jdField_a_of_type_JavaLangString;
        localTroopNotificationCache.feedType = paramInt1;
        localTroopNotificationCache.appId = paramInt2;
        localTroopNotificationCache.userUin = paramkms.jdField_d_of_type_Int;
        localTroopNotificationCache.troopUin = paramLong;
        localTroopNotificationCache.time = paramkms.jdField_e_of_type_Int;
        localTroopNotificationCache.feedsId = paramkms.jdField_b_of_type_JavaLangString;
        ...
        if (TextUtils.isEmpty(paramkms.jdField_d_of_type_JavaLangString)) {}
        for (localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"1\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, str3, str1 }).getBytes();; localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"6\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /></item><item layout=\"2\"><picture cover=\"%s\"/><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, paramkms.jdField_d_of_type_JavaLangString, str3, str1 }).getBytes()) {
          return localTroopNotificationCache;
        }
      }
      if (paramkms.jdField_c_of_type_Int == 2)
      {
        paramString = new TroopNotificationCache();
        paramString.feedType = paramInt1;
        paramString.appId = paramInt2;
        paramString.userUin = paramkms.jdField_d_of_type_Int;
        paramString.troopUin = paramLong;
        paramString.time = paramkms.jdField_e_of_type_Int;
        paramString.feedsId = paramkms.jdField_b_of_type_JavaLangString;
        paramString.ctrlStr = paramkms.jdField_e_of_type_JavaLangString;
        paramString.xmlBytes = paramkms.jdField_a_of_type_ArrayOfByte;
        paramString.src = paramkms.f;
        paramString.filterID = paramkms.jdField_a_of_type_Long;
  ...
  public static kms a(DataInputStream paramDataInputStream, boolean paramBoolean)
  {
  ...
  public static kms a(String paramString, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    int j = 0;
    for (;;)
    {
      ...
      try
      {
        ...
        if ((i == 5) || (i == 19))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (i == 3)
            {
              localObject2 = String.format("https://gdynamic.qpic.cn/gdynamic/%s/72", new Object[] { ((group_feeds.GroupFeedsMessage.MessageContent)localObject2).pic_id.get().toStringUtf8() });
          ...
          localObject5 = new kms(null);
          ((kms)localObject5).jdField_a_of_type_JavaLangString = paramArrayOfByte;
          ((kms)localObject5).jdField_b_of_type_JavaLangString = paramString;
          ((kms)localObject5).jdField_c_of_type_JavaLangString = ((String)localObject3);
          ((kms)localObject5).jdField_d_of_type_JavaLangString = ((String)localObject1);
          ((kms)localObject5).jdField_c_of_type_Int = 1;
          return localObject5;
        }
        if (i == 22)
        {
      ...
      long l2 = l1;
      localObject3 = new kms(null);
      ((kms)localObject3).jdField_b_of_type_JavaLangString = paramString;
      ((kms)localObject3).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
      ((kms)localObject3).jdField_e_of_type_JavaLangString = ((String)localObject1);
      ((kms)localObject3).jdField_c_of_type_Int = 2;
      ((kms)localObject3).jdField_a_of_type_Long = l2;
      ((kms)localObject3).f = i;
      return localObject3;
      return null;
      label679:
      label687:
  ...
  {
    // Byte code:
    //   0: new 958	java/util/ArrayList
    //   3: dup
    //   4: invokespecial 959	java/util/ArrayList:<init>	()V
    //   7: astore 15
    //   9: new 958	java/util/ArrayList
    //   12: dup
    //   13: invokespecial 959	java/util/ArrayList:<init>	()V
    //   16: astore 16
    //   18: new 958	java/util/ArrayList
    //   21: dup
    //   22: invokespecial 959	java/util/ArrayList:<init>	()V
    //   25: astore 17
    //   27: aload_2
    //   28: invokeinterface 717 1 0
    //   33: astore_2
    //   34: aload_2
    //   35: invokeinterface 722 1 0
    //   40: ifeq +666 -> 706
    //   43: aload_2
    //   44: invokeinterface 726 1 0
    //   49: checkcast 416	com/tencent/mobileqq/activity/TroopNotificationCache
    //   52: astore 18
    //   54: invokestatic 1067	com/tencent/mobileqq/service/message/MessageUtils:a	()I
    //   57: istore 7
    //   59: getstatic 1070	com/tencent/mobileqq/service/MobileQQService:jdField_c_of_type_Int	I
    //   62: istore_3
    //   63: iload_3
    //   64: iconst_1
    //   65: iadd
    //   66: putstatic 1070	com/tencent/mobileqq/service/MobileQQService:jdField_c_of_type_Int	I
    //   69: iload_3
    //   70: i2l
    //   71: lstore 11
    //   73: invokestatic 967	com/tencent/mobileqq/service/message/MessageCache:a	()J
    //   76: l2i
    //   77: istore 8
    //   79: sipush -2021
    //   82: invokestatic 1075	com/tencent/mobileqq/service/message/MessageRecordFactory:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    //   85: checkcast 1077	com/tencent/mobileqq/data/MessageForTroopNotification
    //   88: astore 19
    //   90: aload 19
    //   92: lconst_0
    //   93: putfield 1080	com/tencent/mobileqq/data/MessageForTroopNotification:shmsgseq	J
    //   96: aload 19
    //   98: sipush -2021
    //   101: putfield 1083	com/tencent/mobileqq/data/MessageForTroopNotification:msgtype	I
    //   104: aload 18
    ...
    //   137: iload_3
    //   138: invokestatic 1088	com/tencent/mobileqq/structmsg/StructMsgFactory:a	([BI)Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   141: putfield 1092	com/tencent/mobileqq/data/MessageForTroopNotification:structingMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   144: aload 19
    //   146: getfield 1092	com/tencent/mobileqq/data/MessageForTroopNotification:structingMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    ...
    //   183: invokespecial 666	java/lang/String:<init>	([B)V
    ...
    //   219: ifnull -89 -> 130
    //   222: new 755	org/json/JSONObject
    //   225: dup
    //   226: aload 18
    //   228: getfield 536	com/tencent/mobileqq/activity/TroopNotificationCache:ctrlStr	Ljava/lang/String;
    //   231: invokespecial 756	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   234: astore 20
    //   236: iload 5
    //   238: istore_3
    //   239: aload 20
    ...
    //   244: invokevirtual 759	org/json/JSONObject:has	(Ljava/lang/String;)Z
    //   247: ifeq -117 -> 130
    //   250: iload 5
    //   252: istore_3
    //   253: aload 20
    ...
    //   258: invokevirtual 762	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    ...
    //   272: invokevirtual 766	org/json/JSONObject:getJSONObject	(Ljava/lang/String;)Lorg/json/JSONObject;
    //   275: astore 20
    //   277: aload 20
    ...
    //   282: invokevirtual 762	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   285: istore_3
    ...
    //   304: invokevirtual 1097	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   307: astore 21
    //   309: aload 21
    //   311: invokestatic 1100	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   314: lstore 13
    //   316: invokestatic 967	com/tencent/mobileqq/service/message/MessageCache:a	()J
    //   319: lload 13
    //   321: lcmp
    //   322: ifle +84 -> 406
    //   325: aload 18
    //   327: aload_0
    //   328: invokestatic 1102	com/tencent/mobileqq/troop/utils/TroopNotificationHelper:a	(Lcom/tencent/mobileqq/activity/TroopNotificationCache;Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   331: goto -297 -> 34
    //   334: astore 20
    //   336: iload_3
    //   337: istore 4
    //   339: iload 4
    //   341: istore_3
    //   342: invokestatic 773	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   345: ifeq -215 -> 130
    //   348: ldc 10
    //   350: iconst_4
    ...
    //   373: invokespecial 666	java/lang/String:<init>	([B)V
    ...
    //   396: astore 20
    //   398: aload 20
    //   400: invokevirtual 1103	java/lang/NumberFormatException:printStackTrace	()V
    //   403: goto -369 -> 34
    //   406: aload 20
    //   408: getstatic 305	com/tencent/mobileqq/troop/utils/TroopNotificationHelper:f	Ljava/lang/String;
    //   411: invokevirtual 762	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   414: istore 6
    //   416: aload 20
    //   418: getstatic 311	com/tencent/mobileqq/troop/utils/TroopNotificationHelper:g	Ljava/lang/String;
    //   421: invokevirtual 1097	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   424: astore 21
    //   426: aload 20
    //   428: getstatic 315	com/tencent/mobileqq/troop/utils/TroopNotificationHelper:h	Ljava/lang/String;
    //   431: invokevirtual 762	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   434: istore 9
    //   436: iconst_0
    //   437: istore 5
    //   439: iconst_0
    ...
    //   461: invokevirtual 1106	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
    //   464: ifeq +88 -> 552
    //   467: iload 5
    //   469: istore 6
    //   471: aload 17
    //   473: aload 21
    //   475: invokevirtual 1106	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
    //   478: ifeq +74 -> 552
    //   481: aload 16
    //   483: invokevirtual 1107	java/util/ArrayList:size	()I
    //   486: aload 17
    //   488: invokevirtual 1107	java/util/ArrayList:size	()I
    //   491: invokestatic 1113	java/lang/Math:min	(II)I
    //   494: istore 10
    //   496: iconst_0
    //   497: istore 5
    //   499: iload 4
    ...
    //   510: aload 16
    //   512: iload 5
    //   514: invokevirtual 1116	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   517: checkcast 485	java/lang/Integer
    //   520: invokevirtual 1119	java/lang/Integer:intValue	()I
    //   523: iload 9
    //   525: if_icmpne +200 -> 725
    //   528: aload 17
    //   530: iload 5
    //   532: invokevirtual 1116	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   535: checkcast 41	java/lang/String
    //   538: aload 21
    //   540: invokevirtual 932	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   543: ifeq +182 -> 725
    //   546: iconst_1
    //   547: istore 4
    //   549: goto +176 -> 725
    ...
    //   557: aload 18
    //   559: aload_0
    //   560: invokestatic 1102	com/tencent/mobileqq/troop/utils/TroopNotificationHelper:a	(Lcom/tencent/mobileqq/activity/TroopNotificationCache;Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   563: goto -529 -> 34
    //   566: aload 16
    //   568: iload 9
    //   570: invokestatic 488	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   573: invokevirtual 962	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   576: pop
    //   577: aload 17
    //   579: aload 21
    //   581: invokevirtual 962	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   584: pop
    //   585: goto -455 -> 130
    //   588: aload 19
    //   590: aload 19
    //   592: getfield 1092	com/tencent/mobileqq/data/MessageForTroopNotification:structingMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   595: invokevirtual 1122	com/tencent/mobileqq/structmsg/AbsStructMsg:getBytes	()[B
    //   598: putfield 1125	com/tencent/mobileqq/data/MessageForTroopNotification:msgData	[B
    //   601: aload 19
    //   603: ldc_w 1127
    //   606: putfield 1129	com/tencent/mobileqq/data/MessageForTroopNotification:msg	Ljava/lang/String;
    //   609: aload 19
    //   611: aload_1
    //   612: putfield 1132	com/tencent/mobileqq/data/MessageForTroopNotification:frienduin	Ljava/lang/String;
    //   615: aload 19
    //   617: iconst_1
    //   618: putfield 1135	com/tencent/mobileqq/data/MessageForTroopNotification:istroop	I
    //   621: aload 19
    //   623: iconst_1
    //   624: putfield 1139	com/tencent/mobileqq/data/MessageForTroopNotification:isread	Z
    //   627: aload 19
    //   629: iload 8
    //   631: i2l
    //   632: putfield 1141	com/tencent/mobileqq/data/MessageForTroopNotification:time	J
    //   635: aload 19
    //   637: lload 11
    //   639: putfield 1144	com/tencent/mobileqq/data/MessageForTroopNotification:msgseq	J
    //   642: aload 19
    //   644: iload 7
    //   646: invokestatic 1146	com/tencent/mobileqq/service/message/MessageUtils:a	(I)J
    //   649: putfield 1149	com/tencent/mobileqq/data/MessageForTroopNotification:msgUid	J
    //   652: aload 15
    //   654: aload 19
    //   656: invokevirtual 962	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   659: pop
    //   660: aconst_null
    //   661: ldc_w 1151
    //   664: ldc_w 1153
    ...
    //   677: iconst_0
    //   678: aload 19
    //   680: getfield 1158	com/tencent/mobileqq/data/MessageForTroopNotification:troopUin	J
    ...
    //   694: ldc_w 523
    //   697: ldc_w 523
    //   700: invokestatic 1163	com/tencent/mobileqq/statistics/ReportController:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   703: goto -669 -> 34
    //   706: aload_0
    //   707: invokevirtual 956	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/message/QQMessageFacade;
    //   710: aload 15
    //   712: aload_0
    //   713: invokevirtual 845	com/tencent/mobileqq/app/QQAppInterface:a	()Ljava/lang/String;
    //   716: invokevirtual 1166	com/tencent/mobileqq/app/message/QQMessageFacade:a	(Ljava/util/List;Ljava/lang/String;)V
    //   719: return
    //   720: astore 20
    //   722: goto -383 -> 339
    //   725: iload 5
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, List paramList, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      } while (((paramString.msg instanceof TroopSpecialAttentionMsg)) || ((paramString.msg instanceof TroopAtMeMsg)) || ((paramString.msg instanceof TroopAtAllMsg)) || (paramQQAppInterface.b(paramString.uin) == 3));
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    localTroopNotificationCache.xmlBytes = "<msg templateID=\"\"     url=\"https://www.baidu.com\"     serviceID=\"27\"     action=\"web\"     actionData=\"\"     a_actionData=\"\"     i_actionData=\"\"     brief=\"群公告\"     flag=\"5\">  <item layout=\"2\">    <picture cover=\"https://www.baidu.com\"/>    <title>[群公告更新]群公告标题</title>    <summary>群公告内容…………</summary>  </item></msg>".getBytes();
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    if ((jdField_a_of_type_JavaUtilHashMap != null) && (jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
    {
      ...
      ((TroopHandler)paramQQAppInterface.a(19)).a(paramQQAppInterface, paramString, arrayOfByte);
      return;
    }
    try
    {
