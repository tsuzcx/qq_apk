  ...
  extends Observable
{
  ...
  public static final String b = "https://web.qun.qq.com/cgi-bin/notice/get_data_new";
  public static final int c = 1001;
  public static final String c = "https://web.qun.qq.com/cgi-bin/announce/del_feed";
  ...
  public TroopFeedsDataManager(QQAppInterface paramQQAppInterface, Long paramLong)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new kka(this, Looper.getMainLooper());
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsHttpWebCgiAsyncTask$Callback = new kkc(this);
  ...
  {
    List localList = ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(50)).a("" + this.jdField_a_of_type_JavaLangLong);
    if (localList == null) {
  ...
  public void a()
  {
    ...
    ThreadManager.a().post(new kkb(this));
  }
  ...
  public void a(TroopFeedItem paramTroopFeedItem)
  {
    ...
    new HttpWebCgiAsyncTask("https://web.qun.qq.com/cgi-bin/announce/del_feed", "POST", this.jdField_a_of_type_ComTencentMobileqqTroopUtilsHttpWebCgiAsyncTask$Callback, 1001, null, true).execute(new HashMap[] { localObject1 });
  ...
  public void b()
  {
    ...
    ((Bundle)localObject2).putString("ver", "5.9.3");
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
    ((HashMap)localObject1).put("CONTEXT", MobileQQ.getContext());
    new HttpWebCgiAsyncTask("https://web.qun.qq.com/cgi-bin/notice/get_data_new", "GET", this.jdField_a_of_type_ComTencentMobileqqTroopUtilsHttpWebCgiAsyncTask$Callback, 1000, null, true).execute(new HashMap[] { localObject1 });
    if (QLog.isColorLevel()) {
