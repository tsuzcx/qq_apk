    ...
    try
    {
      ...
      if (((group_feeds.GroupFeedsMessage)localObject1).type.get() == 13)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if (i == 3)
          {
            localObject2 = String.format("https://gdynamic.qpic.cn/gdynamic/%s/42", new Object[] { ((group_feeds.GroupFeedsMessage.MessageContent)localObject2).pic_id.get().toStringUtf8() });
