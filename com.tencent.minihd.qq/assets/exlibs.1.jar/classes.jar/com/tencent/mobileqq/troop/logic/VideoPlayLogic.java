  ...
  implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, Handler.Callback, View.OnClickListener, Animation.AnimationListener, MediaControllerX.MediaControllerListener, VideoViewX.OnPlayListener, VideoViewX.OnSeekListener
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new klq(this);
  ...
  BizTroopObserver jdField_a_of_type_ComTencentMobileqqAppBizTroopObserver = new klr(this);
  ...
  private final Runnable jdField_a_of_type_JavaLangRunnable = new klp(this);
  ...
  private void a(int paramInt)
  {
    ...
    if (this.jdField_c_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      localObject2 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839013);
      ...
      if ((!this.jdField_i_of_type_Boolean) && (((this.jdField_a_of_type_ComTencentMobileqqTroopWidgetMediaControllerX != null) && (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetVideoViewX.b() == 0)) || (this.jdField_j_of_type_Boolean) || (this.jdField_g_of_type_Int != 0)))
      {
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqTroopWidgetVideoViewX.f()) || (this.jdField_b_of_type_Boolean))
      {
        ...
        ((ImageView)localObject1).setId(2131296415);
        ((ImageView)localObject1).setImageResource(2130839004);
        ((ImageView)localObject1).setContentDescription(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131363498));
      ...
      if (paramInt == 2)
      {
        this.jdField_c_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130839003);
        ...
        ((TextView)localObject3).setId(2131296412);
        ((TextView)localObject3).setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131363843));
        ((TextView)localObject3).setContentDescription(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131363845));
        localObject2 = new TextView(this.jdField_a_of_type_AndroidContentContext);
        ((TextView)localObject2).setId(2131296413);
        ((TextView)localObject2).setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131363844));
        ((TextView)localObject2).setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131427917));
        ((TextView)localObject2).setContentDescription(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131363845));
        ...
        ((RelativeLayout.LayoutParams)localObject3).addRule(1, 2131296412);
        ((RelativeLayout)localObject1).addView((View)localObject2, (ViewGroup.LayoutParams)localObject3);
      }
      else if (paramInt == 3)
      {
        this.jdField_c_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130839003);
        if ((!this.jdField_i_of_type_Boolean) && (((this.jdField_a_of_type_ComTencentMobileqqTroopWidgetMediaControllerX != null) && (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetVideoViewX.b() == 0)) || (this.jdField_j_of_type_Boolean)))
        {
          localObject1 = new TextView(this.jdField_a_of_type_AndroidContentContext);
          localObject2 = new RelativeLayout.LayoutParams(-1, -1);
          ((TextView)localObject1).setBackgroundColor(-16777216);
        ...
        ((ImageView)localObject2).setId(2131296414);
        ((ImageView)localObject2).setImageResource(2130839007);
        ((ImageView)localObject2).setOnClickListener(this);
        ((ImageView)localObject2).setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131363846));
        new TextView(this.jdField_a_of_type_AndroidContentContext).setId(2131296413);
        localObject3 = new RelativeLayout.LayoutParams(-2, -2);
        ((RelativeLayout.LayoutParams)localObject3).addRule(14);
        ((RelativeLayout)localObject1).addView((View)localObject2, (ViewGroup.LayoutParams)localObject3);
        new RelativeLayout.LayoutParams(-2, -2).addRule(3, 2131296414);
      }
    }
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetMediaControllerX.setOnSwitchSubTitleBtnClickListener(new kls(this));
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetMediaControllerX.setonOutLinkBtnClickListener(new klk(this));
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_ComTencentBizTroopTroopMemberApiClient.a(this.jdField_a_of_type_JavaLangString, new klo(this));
  }
  ...
  private void n()
  {
    ...
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.findViewById(2131297347);
  ...
  public void a(CharSequence paramCharSequence1, CharSequence paramCharSequence2)
  {
    if (paramCharSequence2 != null) {
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new kln(this, paramCharSequence1, paramCharSequence2));
    }
  }
  ...
  public void a(String paramString, StructMsgForGeneralShare paramStructMsgForGeneralShare, View paramView)
  {
    ...
    if (this.jdField_i_of_type_Boolean)
    {
      ...
      if ((paramString != null) && (paramString.a()))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.a("正在加载中");
        this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.show();
        new klh(this, paramString).execute(new Void[0]);
        return;
      }
    }
    ...
    {
      DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230, this.jdField_a_of_type_AndroidContentContext.getString(2131363346), this.jdField_a_of_type_AndroidContentContext.getString(2131363479), 2131365736, 2131363480, new kll(this), new klm(this)).show();
      return;
    }
    k();
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        if (m == 2131296413)
        {
          if ((this.jdField_i_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare != null))
          {
