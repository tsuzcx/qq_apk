  ...
  extends ItemizedOverlay
{
  ...
  public NearbyTroopsMapViewItemOverlay(Context paramContext, Drawable paramDrawable, String paramString)
  {
    super(paramDrawable);
          ...
          if (localObject2 != null)
          {
            ...
            if ((this.jdField_a_of_type_AndroidContentContext != null) && (paramBoolean1))
            {
              if (this.jdField_a_of_type_AndroidGraphicsBitmap == null) {
                this.jdField_a_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130839149);
              }
              if (this.b == null) {
                this.b = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130839151);
              }
            ...
            for (paramArrayList = "99";; paramArrayList = "" + ((NearbyTroopsMapViewOverlayItem)localObject1).jdField_a_of_type_Long)
            {
              ...
              if ((this.jdField_a_of_type_AndroidContentContext != null) && (!paramBoolean1))
              {
                if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) {
                  this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839150);
                }
  ...
  protected boolean onTap(int paramInt)
  {
    ...
    setFocus(localNearbyTroopsMapViewOverlayItem);
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetNearbyTroopsMapViewItemOverlay$Callback.a(localNearbyTroopsMapViewOverlayItem);
    return true;
  }
