...
{
  public static final String a = "https://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s&qqname=qqhd";
  public static final String b = "&initgrouptype=%s";
  public static final String c = "1";
  
  public static void a(Context paramContext)
  {
    String str = String.format("https://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s&qqname=qqhd", new Object[] { "1", "5.9.3", Integer.valueOf(0) });
    Intent localIntent = new Intent(paramContext, TroopCreateActivity.class);
    localIntent.putExtra("url", str);
    localIntent.putExtra("isShowAd", false);
    paramContext.startActivity(localIntent);
    ((Activity)paramContext).overridePendingTransition(2130968593, 2130968594);
  }
  
  public static void a(Context paramContext, int paramInt)
  {
    if ((paramInt == 1) || (paramInt == 2)) {}
    for (String str = String.format("https://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s&qqname=qqhd", new Object[] { "1", "5.9.3", Integer.valueOf(1) });; str = String.format("https://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s&qqname=qqhd", new Object[] { "1", "5.9.3", Integer.valueOf(0) }))
    {
      Intent localIntent = new Intent(paramContext, TroopCreateActivity.class);
      localIntent.putExtra("url", str);
      localIntent.putExtra("isShowAd", false);
  ...
  public static void a(Context paramContext, Intent paramIntent, String paramString)
  {
    ...
    if ("".equals(localObject2))
    {
      ...
      paramIntent = "https://xiaoqu.qq.com/mobile/index.html?groupuin=" + (String)localObject1;
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    Intent localIntent = new Intent(paramContext, QQBrowserActivity.class);
    localIntent.putExtra("url", "https://qun.qq.com/search/mobileqq/index.html?_bid=118");
  ...
  {
    Object localObject = String.format("https://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s&qqname=qqhd", new Object[] { "1", "5.9.3", Integer.valueOf(0) });
  ...
  public static void b(Context paramContext, String paramString1, String paramString2)
  {
    ...
    if (TextUtils.isEmpty(paramString1)) {
      str = "https://xiaoqu.qq.com/mobile/index.html";
    }
  ...
  public static void c(Context paramContext, String paramString)
  {
    ...
    Intent localIntent = new Intent(paramContext, QQBrowserActivity.class);
    localIntent.putExtra("url", "https://qqweb.qq.com/m/qunactivity/form.html?_wv=7&_bid=244&type=relgroup");
    localIntent.putExtra("uin", paramString);
    localIntent.putExtra("portraitOnly", true);
    localIntent.putExtra("hide_more_button", true);
    localIntent.putExtra("hide_operation_bar", true);
