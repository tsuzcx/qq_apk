  ...
  extends GroupAreaWrapper.BaseInfo
{
  ...
  {
    ((NearbyTroops.ActivityAndTopicViewHolder)paramView.getTag()).a.setTextColor(paramView.getContext().getResources().getColor(2131427705));
    paramView.findViewById(2131298669).setBackgroundResource(2130839154);
  }
  ...
  protected void setNumberText(TextView paramTextView)
  {
    ...
    paramTextView.setCompoundDrawablesWithIntrinsicBounds(2130839244, 0, 0, 0);
  }
}
