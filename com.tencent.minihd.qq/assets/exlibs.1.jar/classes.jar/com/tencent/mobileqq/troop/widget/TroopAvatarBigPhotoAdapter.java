  ...
  extends BaseAdapter
{
  ...
  public void a(int paramInt, TroopAvatarBigPhotoAdapter.ViewHolder paramViewHolder)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          localURLImageView.setImageResource(2130839157);
          return;
        }
    ...
    localURLImageView.setURLDrawableDownListener(new koh(this, paramViewHolder));
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2130903347, null);
    }
    if (localView.getTag() == null)
    {
      paramView = new TroopAvatarBigPhotoAdapter.ViewHolder(this);
      paramView.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131296300));
      paramView.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle = ((ImageProgressCircle)localView.findViewById(2131296299));
