...
public final class TroopFileInfo
{
  ...
  private String a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    int n = 1;
    int m = 0;
    if ((paramBoolean) || (this.jdField_i_of_type_JavaLangString == null)) {}
    label75:
    int k;
    for (int j = 1;; j = 1)
    {
      if (j != 0)
      {
        this.jdField_i_of_type_JavaLangString = ContactUtils.a(paramQQAppInterface, c(), paramLong + "", 1, 0);
        if (this.jdField_i_of_type_JavaLangString.length() > 10) {
          break label264;
        }
        j = n;
        if (j == 0) {
        ...
        k = 0;
        label83:
        if (k >= this.jdField_i_of_type_JavaLangString.length()) {
          break label279;
        }
        if (Character.isDigit(this.jdField_i_of_type_JavaLangString.charAt(k))) {
          break label270;
        }
        j = m;
        label114:
        if ((TextUtils.isEmpty(this.jdField_i_of_type_JavaLangString)) || (j != 0)) {
          this.jdField_i_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
        }
  ...
  {
    return "TroopFileInfo{TAG='TroopFileInfo', Id=" + this.jdField_a_of_type_JavaUtilUUID + ", str_file_path='" + this.jdField_b_of_type_JavaLangString + '\'' + ", str_file_name='" + this.jdField_c_of_type_JavaLangString + '\'' + ", uint64_file_size=" + this.jdField_a_of_type_Long + ", uint32_bus_id=" + this.jdField_a_of_type_Int + ", uint32_upload_uin=" + this.jdField_b_of_type_Int + ", uint64_uploaded_size=" + this.jdField_b_of_type_Long + ", uint32_upload_time=" + this.jdField_c_of_type_Int + ", uint32_dead_time=" + this.jdField_d_of_type_Int + ", uint32_modify_time=" + this.jdField_e_of_type_Int + ", uint32_download_times=" + this.jdField_f_of_type_Int + ", str_uploader_name='" + this.jdField_d_of_type_JavaLangString + '\'' + ", Status=" + this.jdField_g_of_type_Int + ", _sStatus='" + this.jdField_e_of_type_JavaLangString + '\'' + ", ProgressValue=" + this.jdField_c_of_type_Long + ", ErrorCode=" + this.jdField_h_of_type_Int + ", LocalFile='" + this.jdField_f_of_type_JavaLangString + '\'' + ", UploadCreateTime=" + this.jdField_i_of_type_Int + ", Unread=" + this.jdField_a_of_type_Boolean + ", ThumbnailFile_Small='" + this.jdField_g_of_type_JavaLangString + '\'' + ", ThumbnailFile_Large='" + this.jdField_h_of_type_JavaLangString + '\'' + ", IsGhost=" + this.jdField_b_of_type_Boolean + ", IsNewStatus=" + this.jdField_c_of_type_Boolean + ", NickName='" + this.jdField_i_of_type_JavaLangString + '\'' + ", lastNickNameUpdateMS=" + this.jdField_d_of_type_Long + '}';
  }
}
