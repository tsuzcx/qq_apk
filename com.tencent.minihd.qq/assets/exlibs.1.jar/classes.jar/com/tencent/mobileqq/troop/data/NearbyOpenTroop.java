...
public class NearbyOpenTroop
{
  ...
  public NearbyOpenTroop(String paramString1, String paramString2, Activity paramActivity, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppBizTroopObserver = new kiq(this);
    this.jdField_b_of_type_ComTencentMobileqqAppBizTroopObserver = new kir(this);
    this.jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new kis(this);
    ...
    this.jdField_a_of_type_AndroidOsHandler = new kit(this);
  }
  ...
  public void a(GroupInfo paramGroupInfo, int paramInt)
  {
    ...
    this.jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new kiu(this), 1000L);
