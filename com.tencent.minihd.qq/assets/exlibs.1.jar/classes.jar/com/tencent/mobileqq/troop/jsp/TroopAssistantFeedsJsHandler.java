  ...
  extends WebViewPlugin
{
  ...
  public static final String b = "https://qqweb.qq.com/m/qunfeeds/index.html?_wv=1031&_bid=200";
  ...
  protected void b(String paramString)
  {
    try
    {
      ...
      if ((!TextUtils.isEmpty(paramString)) && (!TextUtils.isEmpty(str)))
      {
        ...
        this.jdField_a_of_type_ComTencentBizTroopTroopMemberApiClient.a((String)localObject, new kla(this, (String)localObject, str));
        return;
      }
    }
    catch (Exception paramString)
  ...
  protected void onDestroy()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 362	com/tencent/mobileqq/webviewplugin/WebViewPlugin:onDestroy	()V
    //   4: aload_0
    ...
    //   15: invokevirtual 364	com/tencent/biz/troop/TroopMemberApiClient:b	()V
    //   18: aload_0
    ...
    //   22: iconst_0
    //   23: invokevirtual 367	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   26: return
    //   27: astore_1
    //   28: aload_0
    ...
    //   32: iconst_0
    //   33: invokevirtual 367	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   36: return
    //   37: astore_1
    //   38: aload_0
    ...
    //   42: iconst_0
    //   43: invokevirtual 367	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   46: aload_1
    //   47: athrow
