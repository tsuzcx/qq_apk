  ...
  extends TroopCreateBaseActivity
{
  ...
  private void a()
  {
    ...
    getLayoutInflater().inflate(2130903512, (ViewGroup)localObject, true);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131298583));
    this.g = ((int)getResources().getDimension(2131493221));
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetAutoLocationMapView = new AutoLocationMapView(this);
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetAutoLocationMapView.setId(2131296400);
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetAutoLocationMapView.setBuiltInZoomControls(false);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_ComTencentMobileqqTroopWidgetAutoLocationMapView, new RelativeLayout.LayoutParams(-1, this.g));
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetAutoLocationMapView.setVisibility(8);
    localObject = new RelativeLayout.LayoutParams(-1, -1);
    ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131296400);
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {}
    for (TroopCreateMapViewSupportActivity.TroopCreateMapViewAnimation localTroopCreateMapViewAnimation = new TroopCreateMapViewSupportActivity.TroopCreateMapViewAnimation(this, 0, this.g);; localTroopCreateMapViewAnimation = new TroopCreateMapViewSupportActivity.TroopCreateMapViewAnimation(this, this.g, 0))
    {
  ...
  public void e(String paramString)
  {
    ...
    try
    {
      localJSONObject.put("mapViewHeight", this.g);
