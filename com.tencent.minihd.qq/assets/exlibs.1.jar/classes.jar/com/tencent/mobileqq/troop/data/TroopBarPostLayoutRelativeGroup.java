...
{
  protected static final int a = 2130903687;
  ...
  public View a(Activity paramActivity, LayoutInflater paramLayoutInflater, View paramView, TroopBarAbsDataEntity paramTroopBarAbsDataEntity)
  {
    if (paramView == null)
    {
      paramView = paramLayoutInflater.inflate(2130903687, null);
      paramLayoutInflater = (kjm)a(paramView);
    ...
    for (;;)
    {
      ...
      Drawable localDrawable = ((Resources)localObject).getDrawable(2130839199);
      localObject = ((Resources)localObject).getDrawable(2130839200);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      paramView = paramView.getTag(2131296416);
