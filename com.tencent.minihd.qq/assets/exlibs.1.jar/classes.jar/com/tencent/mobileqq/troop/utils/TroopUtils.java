...
public class TroopUtils
{
  ...
  protected static String d = "https://app.qun.qq.com/mobileapp/index.html?_bid=136";
  protected static String e = "https://qqweb.qq.com/m/qunactivity/index.html?_wv=3&_bid=244&from=aio&groupuin=";
  ...
  public static Bundle a(int paramInt1, NearbyRecommendTroop paramNearbyRecommendTroop, int paramInt2)
  {
    Bundle localBundle = new Bundle();
    localBundle.putInt("troop_info_from", paramInt1);
    localBundle.putString("troop_uin", String.valueOf(paramNearbyRecommendTroop.uin));
    localBundle.putString("troop_info_name", paramNearbyRecommendTroop.name);
    localBundle.putInt("TROOP_INFO_MEMBER_NUM", paramNearbyRecommendTroop.memberNum);
    localBundle.putString("troop_info_fingermemo", paramNearbyRecommendTroop.intro);
    localBundle.putInt("troop_info_from_ex", paramInt2);
    return localBundle;
  }
