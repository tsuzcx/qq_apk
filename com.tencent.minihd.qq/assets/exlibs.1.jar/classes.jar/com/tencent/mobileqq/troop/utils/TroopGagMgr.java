  ...
  implements Manager
{
  ...
  TroopObserver jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new kmq(this);
  ...
  {
    Object localObject = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(50);
    if (localObject == null) {
    ...
    if ((((TroopInfo)localObject).dwGagTimeStamp != 0L) && (!bool) && (l < ((TroopInfo)localObject).dwGagTimeStamp))
    {
      ...
      return new TroopGagMgr.SelfGagInfo(this, paramString, true, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getString(2131363800), 60L);
    }
    if ((((TroopInfo)localObject).dwGagTimeStamp_me != 0L) && (l < ((TroopInfo)localObject).dwGagTimeStamp_me + 3L))
    {
      ...
      String str = localContext.getString(2131363801);
  ...
  {
    return String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getString(2131363802), new Object[] { b(paramContext, paramLong) });
  }
  ...
  public String a(Context paramContext, long paramLong1, long paramLong2)
  {
    ...
    paramContext = ((Context)localObject).getString(2131363803);
    String str = ((Context)localObject).getString(2131363804);
    localObject = ((Context)localObject).getString(2131363805);
    if (paramLong1 < 60L) {
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      if (paramLong3 == 0L) {
        paramString = ((Context)localObject2).getResources().getString(2131364058);
      }
    }
    for (;;)
    {
      ...
      return;
      paramString = ((Context)localObject2).getResources().getString(2131364059);
      continue;
      if (paramLong3 == 0L) {
        paramString = ((Context)localObject2).getResources().getString(2131364057, new Object[] { paramString });
      } else {
        paramString = ((Context)localObject2).getResources().getString(2131364056, new Object[] { paramString, d((Context)localObject2, paramLong3) });
      }
    }
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong1, long paramLong2, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1)
    {
      localObject1 = ((Context)localObject3).getString(2131363820);
      if ((paramBoolean2) && (bool))
      {
        localObject2 = (String)localObject1 + ((Context)localObject3).getString(2131363818);
        if (!paramBoolean1) {
          break label425;
        }
        if (paramLong2 == 0L) {
        ...
        localObject1 = ((Context)localObject3).getString(2131363825);
      }
    }
    label412:
    label425:
    ...
    for (;;)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        for (;;)
        {
          ...
          return;
          localObject2 = (String)localObject1 + ((Context)localObject3).getString(2131363819);
          break;
          if ((paramBoolean2) && (bool))
          {
            localObject2 = ((Context)localObject3).getString(2131363824);
            break;
          }
          localObject2 = ((Context)localObject3).getString(2131363823);
          break;
          localObject1 = ((Context)localObject3).getString(2131363826);
          break label126;
          if (paramLong2 != 0L) {}
          for (i = 2131363821;; i = 2131363822)
          {
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    Context localContext = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext();
    int i = localContext.getResources().getDimensionPixelSize(2131492923);
    if (Looper.getMainLooper() != Looper.myLooper())
    {
      new Handler(Looper.getMainLooper()).post(new kmp(this, paramBoolean, localContext, paramString, i));
      return;
    }
    if (paramBoolean)
    {
    ...
    QQToast.a(localContext, 2130838254, paramString, 0).b(i);
  }
  ...
  public final boolean b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (int i = 2131363812;; i = 2131363808)
    {
      a(i, true);
      return true;
    }
  ...
  public String d(Context paramContext, long paramLong)
  {
    ...
    String str1 = paramContext.getString(2131363803);
    String str2 = paramContext.getString(2131363804);
    Object localObject = paramContext.getString(2131363805);
    if (paramLong < 60L) {
      paramContext = 1 + str1;
    }
    long l2;
