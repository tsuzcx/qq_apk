  ...
  implements Animation.AnimationListener
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new kiz(this);
  ...
  private void a(TextView paramTextView, int paramInt)
  {
    ...
    if (paramInt == e)
    {
      paramTextView.setText(2131363740);
      paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130839010, 0);
  ...
  private void d()
  {
    if (this.jdField_b_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setId(2131296332);
      Object localObject = new RelativeLayout.LayoutParams(-1, this.m);
      ((RelativeLayout.LayoutParams)localObject).addRule(2, 2131297027);
      ...
      this.jdField_b_of_type_AndroidWidgetLinearLayout.setId(2131296381);
      this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130837980);
      ...
      setChanged();
      notifyObservers(TroopAioAgent.Message.a(2131296332));
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setId(2131296382);
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColorStateList(2131427970));
      this.jdField_b_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
      this.jdField_b_of_type_AndroidWidgetTextView.setId(2131296383);
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColorStateList(2131427970));
      ...
      localObject = new RelativeLayout.LayoutParams(-1, this.m);
      ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131296382);
      ((RelativeLayout.LayoutParams)localObject).addRule(14);
      ...
      this.jdField_b_of_type_AndroidWidgetLinearLayout.setOnClickListener(new kja(this));
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.o > 0) {
        e();
      } else if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.t() < this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.b() - 11)
      {
  ...
  protected void b()
  {
    ...
    this.m = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131492881));
