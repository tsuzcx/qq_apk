...
{
  protected static final int a = 2130903558;
  ...
  public TroopBarPostLayoutBanner()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsHttpWebCgiAsyncTask$Callback = new kjl(this);
  }
  ...
  public View a(Activity paramActivity, LayoutInflater paramLayoutInflater, View paramView, TroopBarAbsDataEntity paramTroopBarAbsDataEntity)
  {
    ...
    if (paramView == null)
    {
      paramView = paramLayoutInflater.inflate(2130903558, null);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_MqqUtilWeakReference.get() != null) {
        this.b = ((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getDrawable(2130839171);
      }
      ...
      try
      {
        ...
        localObject = paramActivity.getDrawable(2130839170);
        ...
        try
        {
          ...
          label165:
          localBannerItemViewHolder.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(paramActivity.getString(2131363873));
          localBannerItemViewHolder.jdField_a_of_type_AndroidWidgetProgressBar.setContentDescription(paramActivity.getString(2131363876));
          ...
          if (paramTroopBarAbsDataEntity.exsit)
          {
            ...
            if (paramLayoutInflater != null)
            {
              ...
              localBannerItemViewHolder.e.setText(paramActivity.getString(2131363862, new Object[] { Integer.valueOf(paramLayoutInflater.point), Integer.valueOf(paramLayoutInflater.next) }));
          ...
          try
          {
            ...
            if (paramTroopBarAbsDataEntity.sign) {
              ...
              {
                localBannerItemViewHolder.d.setText(paramActivity.getString(2131363863, new Object[] { TroopBarUtils.a(paramTroopBarAbsDataEntity.continueSignDays) }));
                label472:
            ...
            for (;;)
            {
              ...
              paramView.setTag(2131296416, paramTroopBarAbsDataEntity);
              return paramView;
              ...
              break label165;
              localBannerItemViewHolder.d.setText(paramActivity.getString(2131363861));
              break label472;
              localBannerItemViewHolder.d.setText(2131363864);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      ThreadManager.a(new kjj(this, paramView));
      return;
      localObject = new Intent("refresh_page");
      ((Intent)localObject).putExtra("sub_action", "show_loading");
      paramView.getContext().sendBroadcast((Intent)localObject);
      ThreadManager.a(new kjk(this, paramView));
      return;
