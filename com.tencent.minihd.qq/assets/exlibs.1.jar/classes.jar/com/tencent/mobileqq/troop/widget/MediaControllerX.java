  ...
  extends FrameLayout
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new knm(this);
  public View.OnClickListener a;
  private View.OnLayoutChangeListener jdField_a_of_type_AndroidViewView$OnLayoutChangeListener = new knf(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new kni(this);
  ...
  private SeekBar.OnSeekBarChangeListener jdField_a_of_type_AndroidWidgetSeekBar$OnSeekBarChangeListener = new kno(this);
  ...
  public boolean a;
  View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new knk(this);
  ...
  public boolean c;
  public int d;
  View.OnClickListener jdField_d_of_type_AndroidViewView$OnClickListener = new knl(this);
  ...
  private View.OnClickListener jdField_g_of_type_AndroidViewView$OnClickListener = new knn(this);
  private ImageButton jdField_g_of_type_AndroidWidgetImageButton;
  private boolean jdField_g_of_type_Boolean;
  private View.OnClickListener jdField_h_of_type_AndroidViewView$OnClickListener = new knp(this);
  private ImageButton jdField_h_of_type_AndroidWidgetImageButton;
  private boolean jdField_h_of_type_Boolean;
  private View.OnClickListener jdField_i_of_type_AndroidViewView$OnClickListener = new kng(this);
  ...
  public MediaControllerX(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidHardwareSensorEventListener = new knh(this);
  ...
  {
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)paramView.findViewById(2131299351));
    if (this.jdField_a_of_type_AndroidWidgetImageButton != null)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetMediaControllerX$MediaPlayerControlX.a())
      {
        this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131363495));
    ...
    {
      this.jdField_f_of_type_AndroidWidgetImageButton = ((ImageButton)paramView.findViewById(2131299360));
      if ((this.jdField_f_of_type_AndroidWidgetImageButton != null) && (!this.jdField_g_of_type_Boolean) && (!this.jdField_h_of_type_Boolean))
      {
        ...
        this.jdField_f_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131363497));
      }
      label138:
      this.jdField_g_of_type_AndroidWidgetImageButton = ((ImageButton)paramView.findViewById(2131299358));
      this.jdField_g_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131363501));
    ...
    for (;;)
    {
      this.jdField_g_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131363502));
      if (this.j) {
        this.jdField_g_of_type_AndroidWidgetImageButton.setVisibility(8);
      }
      this.jdField_h_of_type_AndroidWidgetImageButton = ((ImageButton)paramView.findViewById(2131299359));
      if (this.jdField_h_of_type_AndroidWidgetImageButton != null)
      {
        this.jdField_h_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131363503));
        this.jdField_h_of_type_AndroidWidgetImageButton.setOnClickListener(new knj(this));
      }
      this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131299352));
      if (this.jdField_a_of_type_AndroidWidgetProgressBar != null)
      {
        this.jdField_a_of_type_AndroidWidgetProgressBar.setContentDescription(getResources().getString(2131363499));
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131299354));
      if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null) {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      }
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131299357));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131299355));
      ...
      l();
      return;
      this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131363494));
      break;
      label472:
      this.jdField_f_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131363496));
      break label138;
      label492:
      this.jdField_g_of_type_AndroidWidgetImageButton.setVisibility(8);
    }
      ...
      try
      {
        ...
        else
        {
          if (localObject1 != null) {
            this.jdField_a_of_type_AndroidViewWindow = ((Window)localObject1.invoke(null, new Object[] { this.jdField_a_of_type_AndroidContentContext }));
          }
  ...
  private void k()
  {
    ...
    for (;;)
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131363842), 1).a();
      }
      else
      {
  ...
  protected View a()
  {
    this.jdField_b_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2130903700, null);
  ...
  public void a(Configuration paramConfiguration)
  {
    if (paramConfiguration.orientation == 2)
    {
      ...
      if (this.jdField_f_of_type_AndroidWidgetImageButton != null) {
        this.jdField_f_of_type_AndroidWidgetImageButton.setBackgroundResource(2130839547);
      }
    }
    for (;;)
    {
      ...
      if (paramConfiguration.orientation == 1)
      {
        ...
        if (this.jdField_f_of_type_AndroidWidgetImageButton != null) {
          this.jdField_f_of_type_AndroidWidgetImageButton.setBackgroundResource(2130839548);
        }
      }
    }
  }
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetMediaControllerX$MediaPlayerControlX.a())
    {
      this.jdField_a_of_type_AndroidWidgetImageButton.setBackgroundResource(2130839550);
      this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131363495));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageButton.setBackgroundResource(2130839551);
    this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(getResources().getString(2131363494));
  }
