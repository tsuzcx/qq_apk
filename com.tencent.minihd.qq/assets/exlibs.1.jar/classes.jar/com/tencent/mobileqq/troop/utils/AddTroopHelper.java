...
public class AddTroopHelper
{
  ...
  public AddTroopHelper(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new klu(this);
  }
  ...
  private final void a(TroopInfo paramTroopInfo)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), 2131366967, 0).b(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).getTitleBarHeight());
      return;
    }
