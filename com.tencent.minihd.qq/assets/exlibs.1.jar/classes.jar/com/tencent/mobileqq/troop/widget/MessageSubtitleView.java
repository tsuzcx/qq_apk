  ...
  extends LinearLayout
{
  ...
  Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new kns(this);
  ...
  private final Runnable jdField_a_of_type_JavaLangRunnable = new knq(this);
  ...
  private final Runnable jdField_b_of_type_JavaLangRunnable = new knr(this);
  ...
  void a(Context paramContext)
  {
    ...
    ((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2130903528, this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131296744));
    ...
    while (i1 < 4)
    {
      ...
      LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(paramContext.getResources().getDimensionPixelSize(2131493266), paramContext.getResources().getDimensionPixelSize(2131493268));
    ...
    this.h = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131493268);
  ...
  public void a(CharSequence paramCharSequence1, CharSequence paramCharSequence2)
  {
    ...
    int i3 = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131427525);
