  ...
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    if ((localObject instanceof FavOpenTroopActivity.CustomViewHolder))
    {
      ...
      ((QQCustomMenu)localObject).a(i, this.a.getString(2131366672));
      this.a.jdField_a_of_type_ComTencentWidgetBubblePopupWindow = BubbleContextMenu.a(paramView, (QQCustomMenu)localObject, this.a.jdField_a_of_type_AndroidViewView$OnClickListener, new kcv(this, paramView));
      return true;
    }
    return false;
  }
