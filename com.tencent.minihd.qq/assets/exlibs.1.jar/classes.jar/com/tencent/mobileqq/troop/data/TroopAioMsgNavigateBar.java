  ...
  implements View.OnClickListener, Animation.AnimationListener
{
  ...
  private void h()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setId(2131296380);
    Object localObject = new RelativeLayout.LayoutParams(-1, this.g);
    ((RelativeLayout.LayoutParams)localObject).addRule(10);
    int i = (int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131493127);
    ...
    this.jdField_c_of_type_AndroidWidgetRelativeLayout.setId(2131296379);
    boolean bool = ThemeUtil.isInNightMode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131427593));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131296386);
    ...
    localObject = String.format(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131363738), new Object[] { Integer.valueOf(this.jdField_d_of_type_Int) });
    ...
    if (bool)
    {
      ...
      j = 2131427702;
      label316:
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColorStateList(2131428004));
      this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131492870));
      this.jdField_a_of_type_AndroidWidgetImageView = new ImageView(this.jdField_a_of_type_AndroidContentContext);
      this.jdField_a_of_type_AndroidWidgetImageView.setId(2131296387);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(i);
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject).addRule(1, 2131296386);
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setId(2131296389);
      if (!bool) {
        break label801;
      }
      this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130839001);
    }
    for (;;)
    {
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setId(2131296388);
      localObject = new RelativeLayout.LayoutParams(-1, -1);
      ((RelativeLayout.LayoutParams)localObject).addRule(9);
      ((RelativeLayout.LayoutParams)localObject).addRule(0, 2131296389);
      ((RelativeLayout.LayoutParams)localObject).leftMargin = ((int)(this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().density * 8.0F + 0.5F));
      ((RelativeLayout.LayoutParams)localObject).rightMargin = ((int)(this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().density * 8.0F + 0.5F));
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setTextSize(0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131492883));
      ...
      break label316;
      label801:
      this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130839000);
    }
  }
  ...
  private void j()
  {
    ...
    {
      new Handler(Looper.getMainLooper()).post(new kix(this));
      return;
    }
    i();
  }
  ...
  protected void b()
  {
    ...
    this.g = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131493222));
  ...
  public boolean b()
  {
    ...
    this.e = ((TroopInfoManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    if (this.e == 1)
    {
    ...
    else if ((this.e == 5) || (this.e == 2) || (this.e == 3) || (this.e == 4)) {
      return true;
    }
    return false;
  }
  ...
  public void d()
  {
    if ((this.jdField_c_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_b_of_type_AndroidWidgetRelativeLayout.getVisibility() == 0))
    {
      ...
      if (localObject != null)
      {
        ...
        if (l1 > 0L)
        {
          int i = this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.s();
  ...
  public void f()
  {
    ...
    else
    {
      ...
      localObject = (MessageRecord)this.jdField_a_of_type_ComTencentMobileqqActivityAioChatAdapter1.getItem(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.s());
      if (localObject == null) {
        break label918;
      }
    ...
    for (;;)
    {
      ...
      else if (this.e == 4)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131369155) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_AndroidContentContext, (MessageRecord)localObject, false));
      ...
      for (int i = 1;; i = 0)
      {
        ...
        if (this.e == 5)
        {
          ...
          this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131363736) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_AndroidContentContext, (MessageRecord)localObject, false));
          this.jdField_c_of_type_AndroidWidgetRelativeLayout.setTag(TroopAioAgent.Message.a(this.e, 0L, this.jdField_c_of_type_Long));
          j();
        }
        for (;;)
        {
          ...
          if (this.e == 2)
          {
            ...
            this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131363737) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_AndroidContentContext, (MessageRecord)localObject, false));
            this.jdField_c_of_type_AndroidWidgetRelativeLayout.setTag(TroopAioAgent.Message.a(this.e, 0L, this.jdField_c_of_type_Long));
            j();
            continue;
          }
          ...
          this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131365866) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_AndroidContentContext, (MessageRecord)localObject, false));
          this.jdField_c_of_type_AndroidWidgetRelativeLayout.setTag(TroopAioAgent.Message.a(this.e, 0L, this.jdField_c_of_type_Long));
          j();
        }
      }
  ...
  public void g()
  {
    if (Looper.getMainLooper() != Looper.myLooper())
    {
      new Handler(Looper.getMainLooper()).post(new kiy(this));
      return;
    }
    k();
  }
