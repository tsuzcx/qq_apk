  ...
  implements XmlSerializer
{
  ...
  {
    int i = this.jdField_a_of_type_ArrayOfInt[(this.c + 1)] * 2 - 2;
    Object localObject;
    int j;
    if (i >= 0) {
      if ((this.jdField_b_of_type_ArrayOfJavaLangString[(i + 1)].equals(paramString)) && ((paramBoolean1) || (this.jdField_b_of_type_ArrayOfJavaLangString[i].length() != 0)))
      {
        ...
        j = i + 2;
        label70:
        if (j >= this.jdField_a_of_type_ArrayOfInt[(this.c + 1)] * 2) {
          break label275;
        }
    ...
    for (;;)
    {
      ...
      String str = i;
      i = this.jdField_a_of_type_ArrayOfInt[(this.c + 1)] * 2 - 2;
      for (;;)
      {
        localObject = str;
        if (i >= 0)
  ...
  private final void a(boolean paramBoolean)
  {
    ...
    this.c += 1;
    this.jdField_a_of_type_Boolean = false;
    if (this.jdField_a_of_type_ArrayOfBoolean.length <= this.c)
    {
      localObject = new boolean[this.c + 4];
      System.arraycopy(this.jdField_a_of_type_ArrayOfBoolean, 0, localObject, 0, this.c);
      this.jdField_a_of_type_ArrayOfBoolean = ((boolean[])localObject);
    }
    this.jdField_a_of_type_ArrayOfBoolean[this.c] = this.jdField_a_of_type_ArrayOfBoolean[(this.c - 1)];
    int i = this.jdField_a_of_type_ArrayOfInt[(this.c - 1)];
    if (i < this.jdField_a_of_type_ArrayOfInt[this.c])
    {
      ...
      while ((getNamespace().length() != 0) || (this.jdField_b_of_type_ArrayOfJavaLangString[(i * 2 + 1)].length() == 0))
      {
        this.jdField_a_of_type_JavaIoBufferedWriter.write("=\"");
    ...
    if (this.jdField_a_of_type_ArrayOfInt.length <= this.c + 1)
    {
      localObject = new int[this.c + 8];
      System.arraycopy(this.jdField_a_of_type_ArrayOfInt, 0, localObject, 0, this.c + 1);
      this.jdField_a_of_type_ArrayOfInt = ((int[])localObject);
    }
    this.jdField_a_of_type_ArrayOfInt[(this.c + 1)] = this.jdField_a_of_type_ArrayOfInt[this.c];
    BufferedWriter localBufferedWriter = this.jdField_a_of_type_JavaIoBufferedWriter;
    if (paramBoolean) {}
  ...
  {
    while (this.c > 0) {
      endTag(this.jdField_a_of_type_ArrayOfJavaLangString[(this.c * 3 - 3)], this.jdField_a_of_type_ArrayOfJavaLangString[(this.c * 3 - 1)]);
    }
    flush();
  }
  ...
  public XmlSerializer endTag(String paramString1, String paramString2)
  {
    ...
    if (((paramString1 == null) && (this.jdField_a_of_type_ArrayOfJavaLangString[(this.c * 3)] != null)) || ((paramString1 != null) && (!paramString1.equals(this.jdField_a_of_type_ArrayOfJavaLangString[(this.c * 3)]))) || (!this.jdField_a_of_type_ArrayOfJavaLangString[(this.c * 3 + 2)].equals(paramString2))) {
    ...
    for (;;)
    {
      this.jdField_a_of_type_ArrayOfInt[(this.c + 1)] = this.jdField_a_of_type_ArrayOfInt[this.c];
      return this;
      if (this.jdField_a_of_type_ArrayOfBoolean[(this.c + 1)] != 0)
      {
        this.jdField_a_of_type_JavaIoBufferedWriter.write("\r\n");
        int i = 0;
        while (i < this.c)
      ...
      this.jdField_a_of_type_JavaIoBufferedWriter.write("</");
      paramString1 = this.jdField_a_of_type_ArrayOfJavaLangString[(this.c * 3 + 1)];
      if (paramString1.length() != 0)
      {
        this.jdField_a_of_type_JavaIoBufferedWriter.write(paramString1);
        this.jdField_a_of_type_JavaIoBufferedWriter.write(58);
  ...
  {
    if ("https://xmlpull.org/v1/doc/features.html#indent-output".equals(paramString)) {
      return this.jdField_a_of_type_ArrayOfBoolean[this.c];
    }
    return false;
  }
  ...
  public void setFeature(String paramString, boolean paramBoolean)
  {
    if ("https://xmlpull.org/v1/doc/features.html#indent-output".equals(paramString))
    {
      this.jdField_a_of_type_ArrayOfBoolean[this.c] = paramBoolean;
      return;
    }
  ...
  {
    a(false);
    if (this.jdField_a_of_type_ArrayOfBoolean[this.c] != 0)
    {
      this.jdField_a_of_type_JavaIoBufferedWriter.write("\r\n");
      i = 0;
      while (i < this.c)
    ...
    if (paramString1 == null)
    {
      ...
      if ((paramString1 != null) && (paramString1.length() == 0)) {
        i = this.jdField_a_of_type_ArrayOfInt[this.c];
      }
    }
    else
    {
      for (;;)
      {
        if (i >= this.jdField_a_of_type_ArrayOfInt[(this.c + 1)]) {
          break label207;
        }
  ...
  {
    a(false);
    this.jdField_a_of_type_ArrayOfBoolean[this.c] = false;
    a(paramString, -1);
    return this;
  }
