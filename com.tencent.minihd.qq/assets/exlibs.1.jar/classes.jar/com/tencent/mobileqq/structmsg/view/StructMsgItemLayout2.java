  ...
  private TextViewWrapLayout a(Context paramContext)
  {
    ...
    for (int j = a(paramContext) + i;; j = i)
    {
      ...
      if (!TextUtils.isEmpty(this.c)) {
        localTextViewWrapLayout.setBackgroundResource(2130838151);
      }
  ...
  public View b(Context paramContext, View paramView)
  {
    ...
    if ((paramView != null) && ((paramView instanceof TextViewWrapLayout)))
    {
      ...
      if (((Iterator)localObject6).hasNext())
      {
        ...
        {
          localObject3 = ((AbsStructMsgElement)localObject4).a(paramContext, ((TextViewWrapLayout)localObject5).findViewById(2131296340));
    ...
    for (;;)
    {
      ...
      if (("title".equals(localObject7)) && (localObject1 == null))
      {
        ...
        localObject4 = (TextView)((AbsStructMsgElement)localObject4).a(paramContext, ((TextViewWrapLayout)localObject5).findViewById(2131296341));
        localObject1 = localObject2;
        localObject2 = localObject4;
      }
      else
      {
        if (localObject2 == null)
        {
          ...
          {
            localObject4 = (TextView)((AbsStructMsgElement)localObject4).a(paramContext, ((TextViewWrapLayout)localObject5).findViewById(2131296342));
            localObject2 = localObject1;
            localObject1 = localObject4;
            continue;
          }
          ...
          {
            paramView = (LinearLayout)((AbsStructMsgElement)localObject4).a(paramContext, ((TextViewWrapLayout)localObject5).findViewById(2131296344));
            localObject4 = localObject1;
            localObject1 = localObject2;
            localObject2 = localObject4;
            continue;
