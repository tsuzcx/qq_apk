  ...
  implements ActionSheet.OnButtonClickListener
{
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      paramView = new File(AppConstants.aG + "photo/");
      if (!paramView.exists()) {
        paramView.mkdirs();
      }
      paramView = new Intent();
      Uri localUri = FileProvider7Helper.setSystemCapture(this.this$0.mRuntime.a(), new File(AppConstants.aG + "photo/" + System.currentTimeMillis() + ".jpg"), paramView);
