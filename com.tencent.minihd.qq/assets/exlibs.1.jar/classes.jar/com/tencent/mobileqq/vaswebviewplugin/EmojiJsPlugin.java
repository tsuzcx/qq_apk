  ...
  extends VasWebviewJsPlugin
{
  ...
  public static final String SEND_EMOJI_TO_FRIEND = "send_emoji_to_friend";
  ...
  private void sendEmojiToFriend(int paramInt)
  {
    try
    {
      ...
      if (((this.mSrcFromType == 1) || (this.mSrcFromType == 8)) && (localObject != null))
      {
        ...
        localBundle.putBoolean("send_emoji_to_friend", true);
        ...
        this.mRuntime.a().sendBroadcast((Intent)localObject);
        return;
      }
      Bundle localBundle = new Bundle();
  ...
  private void startDownloadEmoji(String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    catch (JSONException localJSONException1)
    {
      ...
      for (;;)
      {
        ...
        localObject = DialogUtil.a(this.mRuntime.a(), 230).a(this.mRuntime.a().getString(2131368601)).b(this.mRuntime.a().getString(2131368602)).a(this.mRuntime.a().getString(2131368603), new EmojiJsPlugin.6(this, paramString)).c(this.mRuntime.a().getString(2131368604), new EmojiJsPlugin.5(this, paramInt1, paramInt2, paramString));
