  ...
  extends VasBasePlugin
{
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i(TAG, 2, "getDomainIpList: " + paramJSONObject);
    }
    try
    {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e(TAG, 2, "getDomainIpList failed: " + paramJSONObject.getMessage());
      }
    ...
    sendRemoteReq(DataFactory.makeIPCRequestPacket("getDomainIpList", paramString, this.mOnRemoteResp.key, localBundle), false, false);
  }
  ...
  protected boolean handleEmojiSchemaRequest(String paramString1, String paramString2)
  {
    ...
    do
    {
      return bool;
      if (QLog.isDevelopLevel()) {
        QLog.d(TAG, 4, "handleSchemaRequest:" + Util.b(paramString1, new String[0]));
      }
