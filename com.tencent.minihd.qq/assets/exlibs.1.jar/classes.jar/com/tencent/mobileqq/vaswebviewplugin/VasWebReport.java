    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        for (;;)
        {
          ...
          ReportController.a(null, "P_CliOper", "vasweb", "", "load", "finish", 0, 1, "errocode:" + this.erroMap.get(paramString), paramMap, Util.b(paramString, new String[0]), "5.9.3--android--" + Build.VERSION.SDK_INT);
        ...
        {
          ReportController.a(null, "P_CliOper", "vasweb", "", "load", "finish", 0, 0, "" + l, paramMap, Util.b(paramString, new String[0]), "5.9.3--android--" + Build.VERSION.SDK_INT);
          break;
          if (QLog.isColorLevel()) {
