...
import com.tencent.mobileqq.widget.NotAllowInterceptRelativeLayout;
import com.tencent.widget.CirclePageIndicator;
import java.util.List;

public class ProfileLabelPanel
  extends NotAllowInterceptRelativeLayout
  implements ViewPager.OnPageChangeListener
{
  ...
  {
    this(paramContext);
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2130904121, this);
  ...
  {
    this.b = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131297562));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131297561));
    ...
    this.jdField_a_of_type_ComTencentWidgetCirclePageIndicator = ((CirclePageIndicator)this.jdField_a_of_type_AndroidViewView.findViewById(2131300942));
