  ...
  implements DragAndDropDetector.DropTarget
{
  ...
  private void e()
  {
    e = getResources().getDimensionPixelSize(2131493352);
    setBackgroundResource(2130840874);
    ...
    if ((localDrawable instanceof LayerDrawable))
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[2] = this.jdField_a_of_type_AndroidGraphicsDrawableLayerDrawable.findDrawableByLayerId(2131302475);
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[1] = this.jdField_a_of_type_AndroidGraphicsDrawableLayerDrawable.findDrawableByLayerId(2131302476);
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[0] = this.jdField_a_of_type_AndroidGraphicsDrawableLayerDrawable.findDrawableByLayerId(2131302477);
      return;
    }
    ...
    if (a())
    {
      if (this.jdField_a_of_type_AndroidViewAnimationAnimationSet == null)
      {
        ...
        while (i < 3)
        {
          ...
          localObject2 = new ValueAnimation(this.jdField_a_of_type_ArrayOfAndroidGraphicsRect[i], localObject2, new jnk(this, (Drawable)localObject1));
          ...
          localObject1 = new ValueAnimation(Integer.valueOf(0), Integer.valueOf(255), new jnl(this, (Drawable)localObject1));
          ...
          if (2 == i) {
            ((ValueAnimation)localObject2).setAnimationListener(new jnm(this));
          }
  ...
  public void a(BreatheEffectView.BreatheListener paramBreatheListener)
  {
    ...
    if (a())
    {
      ...
      while (i < 3)
      {
        ...
        ((ValueAnimation)localObject).a(new jnn(this, localDrawable));
      ...
      if (paramBreatheListener != null) {
        localAnimationSet.setAnimationListener(new jno(this, paramBreatheListener));
      }
  ...
  public void b(BreatheEffectView.BreatheListener paramBreatheListener)
  {
    if (a())
    {
      ...
      while (i < 3)
      {
        ...
        int j = localRect.centerX();
        int k = localRect.centerY();
        localObject = new ValueAnimation(localRect, new Rect(j, k, j, k), new jnp(this, (Drawable)localObject));
        ((ValueAnimation)localObject).setDuration(400L);
  ...
  public void c()
  {
    if (a())
    {
      ...
      while (i < 3)
      {
        ...
        localObject2 = new ValueAnimation(localObject2, localObject3, new jnq(this, (Drawable)localObject1));
        ((ValueAnimation)localObject2).setDuration(800L);
        ((ValueAnimation)localObject2).setInterpolator(new AccelerateInterpolator(0.24F));
        localObject1 = new ValueAnimation(Integer.valueOf(204), Integer.valueOf(0), new jnr(this, (Drawable)localObject1));
        ...
        ((Animation)localObject3).setAnimationListener(new jns(this));
