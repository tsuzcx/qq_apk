  ...
  implements DragAndDropDetector.Draggable
{
  ...
  private static final int[] jdField_a_of_type_ArrayOfInt = { 2131493341, 2131493342, 2131493343, 2131493344, 2131493345 };
  ...
  {
    setBackgroundResource(2130840875);
  ...
  private void b()
  {
    setClickable(true);
    Resources localResources = getResources();
    setTextSize(0, localResources.getDimensionPixelSize(2131493346));
    int i = localResources.getDimensionPixelSize(2131493348);
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsValueAnimation = new ValueAnimation(Float.valueOf(0.0F), Float.valueOf(1.0F), new jot(this));
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsValueAnimation.setAnimationListener(new jou(this));
  }
