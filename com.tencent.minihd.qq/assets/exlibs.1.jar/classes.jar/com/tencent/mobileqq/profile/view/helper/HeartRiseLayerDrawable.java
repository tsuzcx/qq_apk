  ...
  extends LayerDrawable
{
  ...
  {
    super(jow.a(paramInt, paramResources, a(paramResources)));
  }
  
  public static Bitmap a(Resources paramResources)
  {
    Paint localPaint = new Paint();
    localPaint.setColor(paramResources.getColor(2131427540));
  ...
  public void a(Handler paramHandler, int paramInt1, int paramInt2)
  {
    ...
    {
      jov localjov = new jov(this, i, paramInt1, paramInt2);
      if (i % 2 == 0) {}
      for (long l = i * 200;; l = i * 130)
      {
        paramHandler.postDelayed(localjov, l);
        i += 1;
        break;
      }
    }
