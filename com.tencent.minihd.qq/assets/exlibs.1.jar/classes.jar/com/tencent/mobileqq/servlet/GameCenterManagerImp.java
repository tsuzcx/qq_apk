  ...
  public void c()
  {
    ...
    if ((m - i1 > n) || (m < i1))
    {
      ...
      if (((ProfileCardCheckUpdate)localObject).a()) {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a.a(122, (CheckUpdateItemInterface)localObject);
      }
      localObject = BaseApplicationImpl.a().getSharedPreferences("web_process_preload_file", 4);
