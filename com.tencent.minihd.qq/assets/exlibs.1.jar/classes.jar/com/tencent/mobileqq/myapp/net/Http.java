...
public class Http
{
      ...
      if ((str != null) && (str.trim().length() > 0))
      {
        ...
        if (localNetworkInfo != null)
        {
          if (NetworkUtil.a(localNetworkInfo))
          {
            ...
            localObject = a();
            str = ((jhk)localObject).jdField_a_of_type_JavaLangString;
            i = ((jhk)localObject).jdField_a_of_type_Int;
            continue;
          }
          return null;
        }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (NetworkUtil.a(((ConnectivityManager)((Context)localObject2).getSystemService("connectivity")).getActiveNetworkInfo()))
        {
          ...
          localObject2 = a();
          localObject1 = ((jhk)localObject2).jdField_a_of_type_JavaLangString;
          i = ((jhk)localObject2).jdField_a_of_type_Int;
          break;
          localObject1 = null;
        }
      }
  ...
  private static jhk a()
  {
    Object localObject1 = BaseApplication.getContext();
    jhk localjhk = new jhk();
    try
    {
      String str1;
      String str2;
      ...
      try
      {
        ...
        if ((str3 != null) && (str3.startsWith("ctwap"))) {
          ...
          {
            localjhk.jdField_a_of_type_JavaLangString = str1;
            localjhk.jdField_a_of_type_Int = Integer.valueOf(str2).intValue();
          }
          else
          {
            localjhk.jdField_a_of_type_JavaLangString = "10.0.0.200";
            localjhk.jdField_a_of_type_Int = 80;
          }
        }
      }
      ...
      if ((str3 != null) && (str3.startsWith("cmwap")))
      {
        ...
        {
          localjhk.jdField_a_of_type_JavaLangString = "10.0.0.172";
          localjhk.jdField_a_of_type_Int = 80;
        }
      }
