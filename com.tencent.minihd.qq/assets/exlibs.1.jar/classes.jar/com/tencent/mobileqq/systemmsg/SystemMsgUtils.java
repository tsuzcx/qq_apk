...
public class SystemMsgUtils
{
  ...
  public static void a(long paramLong, int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("SystemMsgUtils", 2, "changeNickNameInStructMsgActions remark=" + paramString + ";remarkResult=" + paramInt2);
      }
      localStructMsg = SystemMsgController.a().a(Long.valueOf(paramLong));
    } while (localStructMsg == null);
    switch (localStructMsg.msg_type.get())
    {
    default: 
      return;
    }
    localStructMsg.msg.req_uin_nick.set(paramString);
  }
  ...
  {
    return (paramInt == 0) || (paramInt == 1) || (paramInt == 2) || (paramInt == 3) || (paramInt == 4) || (paramInt == 5) || (paramInt == 6) || (paramInt == 7) || (paramInt == 8) || (paramInt == 9) || (paramInt == 10);
  }
