  ...
  implements SystemMsgUiActionInterface
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new jyj(this, Looper.getMainLooper());
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if (this.jdField_a_of_type_Int > 0) {
      ((NewFriendManager)paramQQAppInterface.getManager(33)).a();
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    paramQQAppInterface.a(new jyh(this, paramQQAppInterface, paramInt));
  }
  ...
  {
    paramQQAppInterface.a(new jyi(this, paramQQAppInterface, paramString));
  }
  ...
  public void a(boolean paramBoolean, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.a(new jyk(this, paramQQAppInterface, paramBoolean));
  }
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    if (this.jdField_a_of_type_Int > 0)
    {
      Object localObject = paramQQAppInterface.a().a(AppConstants.an, 0);
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        ...
        ((NewFriendManager)paramQQAppInterface.getManager(33)).a((NewFriendMessage)localObject);
      }
      return;
    }
    ((NewFriendManager)paramQQAppInterface.getManager(33)).a(new TroopSystemMessage(0));
  }
