...
{
  static final int DB_VERSION = 104;
  ...
  public static void checkColumnChange(String paramString, android.database.sqlite.SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    for (;;)
    {
      ...
      else if (str1.equals(MpfileTaskRecord.tableName()))
      {
        localObject2 = MpfileTaskRecord.class;
      }
      else if (str1.equals(PrinterItemMsgRecord.tableName()))
      {
        localObject2 = PrinterItemMsgRecord.class;
      }
      else if (str1.startsWith(RouterMsgRecord.tableBasicName()))
      {
        localObject2 = RouterMsgRecord.class;
      }
      ...
      else if (str1.startsWith(SecMsg.getTabPrefix()))
      {
        localObject2 = SecMsg.class;
      }
      else if (str1.equals("recent_call"))
      {
        localObject2 = QCallRecent.class;
      }
      else
      {
  ...
  public SQLiteOpenHelper build(String paramString)
  {
    ...
    try
    {
      ...
      if (VersionUtils.e())
      {
        ...
        for (;;)
        {
          this.mInnerDbHelper = new QQEntityManagerFactory.SQLiteOpenHelperImpl(this, paramString, null, i, new hzd(this));
  ...
  public void createDatabase(android.database.sqlite.SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    localMessageRecord.frienduin = String.valueOf(AppConstants.af);
  ...
  {
    if (paramInt1 < 20) {
      QQEntityManagerFactory.SQLiteOpenHelperImpl.access$000(this.mInnerDbHelper, paramSQLiteDatabase);
    }
    do
    {
      return;
