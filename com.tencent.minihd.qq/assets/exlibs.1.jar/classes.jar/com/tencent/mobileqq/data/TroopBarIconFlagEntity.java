  ...
  extends TroopBarAbsDataEntity
{
  ...
  public TroopBarIconFlagEntity(JSONObject paramJSONObject)
  {
    ...
    this.icon_text = paramJSONObject.optString("icon_text", "");
    this.icon_bg = paramJSONObject.optString("icon_bg", "");
    this.icon_color = paramJSONObject.optString("icon_color", "");
  ...
  public static final void setViewBackgroundColor(Resources paramResources, View paramView, String paramString)
  {
    ...
    try
    {
      paramResources = (GradientDrawable)paramResources.getDrawable(2130839181);
