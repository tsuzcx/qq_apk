  ...
  extends TroopBarAbsDataEntity
{
  ...
  public TroopBarUserEntity(JSONObject paramJSONObject)
  {
    ...
    this.nickName = paramJSONObject.optString("nick_name", "");
    this.admin_ext = paramJSONObject.optString("admin_ext", "");
    this.gender = paramJSONObject.optInt("gender", -1);
  ...
  public ArrayList getIconListEntitys()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 94	com/tencent/mobileqq/data/TroopBarUserEntity:iconListBytes	[B
    //   4: ifnull +116 -> 120
    //   7: new 104	java/io/ByteArrayInputStream
    //   10: dup
    //   11: aload_0
    //   12: getfield 94	com/tencent/mobileqq/data/TroopBarUserEntity:iconListBytes	[B
    //   15: invokespecial 107	java/io/ByteArrayInputStream:<init>	([B)V
    //   18: astore 4
    //   20: new 109	java/io/ObjectInputStream
    //   23: dup
    //   24: aload 4
    //   26: invokespecial 112	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   29: astore 5
    //   31: aload 5
    //   33: invokevirtual 116	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   36: astore_1
    //   37: aload_1
    //   38: instanceof 70
    //   41: ifeq +74 -> 115
    //   44: aload_1
    //   45: checkcast 70	java/util/ArrayList
    //   48: astore_1
    //   49: aload_1
    //   50: astore_2
    //   51: aload_1
    //   52: astore_3
    //   53: aload 4
    //   55: invokevirtual 119	java/io/ByteArrayInputStream:close	()V
    //   58: aload_1
    //   59: astore_2
    //   60: aload_1
    //   61: astore_3
    //   62: aload 5
    //   64: invokevirtual 120	java/io/ObjectInputStream:close	()V
    //   67: aload_1
    //   68: areturn
    //   69: astore 4
    //   71: aconst_null
    ...
    //   76: astore_3
    //   77: aload 4
    //   79: invokevirtual 123	java/lang/ClassNotFoundException:printStackTrace	()V
    //   82: aload_1
    //   83: areturn
    //   84: astore_1
    //   85: aload_1
    //   86: invokevirtual 124	java/io/StreamCorruptedException:printStackTrace	()V
    //   89: aload_2
    //   90: areturn
    //   91: astore_1
    //   92: aconst_null
