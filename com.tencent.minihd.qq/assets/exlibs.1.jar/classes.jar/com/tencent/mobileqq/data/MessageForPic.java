...
{
  public static final Parcelable.Creator CREATOR = new hyy();
  ...
  public void doParse()
  {
    ...
    if (i != 0)
    {
      ...
      this.mShowLength = ((RichMsg.PicRec)localObject).uint32_show_len.get();
      this.mDownloadLength = ((RichMsg.PicRec)localObject).uint32_download_len.get();
      this.mCurrlength = ((RichMsg.PicRec)localObject).uint32_current_len.get();
      this.mNotPredownloadReason = ((RichMsg.PicRec)localObject).notPredownloadReason.get();
