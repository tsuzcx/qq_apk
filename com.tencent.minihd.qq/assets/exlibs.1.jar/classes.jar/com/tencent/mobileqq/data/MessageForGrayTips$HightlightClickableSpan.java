  ...
  implements MessageForGrayTips.HightlightClickInterface
{
  ...
  public MessageForGrayTips$HightlightClickableSpan(MessageForGrayTips paramMessageForGrayTips, QQAppInterface paramQQAppInterface, int paramInt, Context paramContext, hyx paramhyx)
  {
  ...
  public MessageForGrayTips$HightlightClickableSpan(MessageForGrayTips paramMessageForGrayTips, QQAppInterface paramQQAppInterface, Context paramContext, hyx paramhyx)
  {
    this(paramMessageForGrayTips, paramQQAppInterface, -1, paramContext, paramhyx);
  }
  ...
  public boolean clickAppMsg(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      try
      {
        ((StartAppCheckHandler)this.mApp.a(22)).b(paramString2[0].trim(), this.context, (Intent)localObject);
        bool = true;
        return bool;
      }
  ...
  public boolean clickWebMsg(String paramString)
  {
    ...
    if ((this.context instanceof BasePadActivity))
    {
      paramString = ((BasePadActivity)this.context).getTopFragment();
      if ((paramString != null) && ((paramString instanceof MyFragment)))
      {
        paramString = ((MyFragment)paramString).getBasePadAct();
        if ((paramString != null) && ((paramString instanceof ChatActivity)))
        {
  ...
  public void onClick(View paramView)
  {
    ...
    case 2: 
      ...
      return;
    case 4: 
      if (((TroopManager)this.mApp.getManager(50)).a(this.this$0.frienduin) != null) {
        break;
      }
    }
    for (int i = 2;; i = 1)
    {
      ...
      if ((this.context instanceof BasePadActivity))
      {
        Object localObject = ((BasePadActivity)this.context).getTopFragment();
        if ((localObject != null) && ((localObject instanceof MyFragment)))
        {
          localObject = ((MyFragment)localObject).getBasePadAct();
          if ((localObject != null) && ((localObject instanceof ChatActivity)))
          {
