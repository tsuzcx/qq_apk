...
public abstract class BaseShortVideoOprerator
  implements DownCallBack, UpCallBack, InfoBuilder, jvq
{
  ...
  public BaseShortVideoOprerator(QQAppInterface paramQQAppInterface)
  {
    ...
    if (this.jdField_a_of_type_AndroidOsHandler == null) {
      this.jdField_a_of_type_AndroidOsHandler = new jvo(this, Looper.getMainLooper());
    }
  }
  
  private void a(Message paramMessage)
  {
    Logger.a(this.jdField_g_of_type_JavaLangString, this.f, "dispatchMessage", "what:" + paramMessage.what + ",result:" + paramMessage.arg1 + ",obj:" + paramMessage.obj);
  ...
  private void a(MessageRecord paramMessageRecord)
  {
    ...
    Logger.a(this.jdField_g_of_type_JavaLangString, this.f, "addMsg", "cost:" + (System.currentTimeMillis() - l));
    Logger.a(this.jdField_g_of_type_JavaLangString, this.f, "addMsg", "MessageRecord: " + ((LoggerInterface)paramMessageRecord).toLogString() + "\n" + paramMessageRecord.toString());
  }
  ...
  private boolean a(ShortVideoDownloadInfo paramShortVideoDownloadInfo)
  {
    ...
    {
      Logger.a(this.jdField_g_of_type_JavaLangString, this.f, "checkShortVideoDownloadInfo", "info:" + paramShortVideoDownloadInfo);
      return paramShortVideoDownloadInfo.a();
    }
    Logger.b(this.jdField_g_of_type_JavaLangString, this.f, "checkShortVideoDownloadInfo", "info == null");
    return false;
  }
  ...
  private boolean a(ShortVideoUploadInfo paramShortVideoUploadInfo)
  {
    ...
    {
      Logger.a(this.jdField_g_of_type_JavaLangString, this.f, "checkShortVideoUploadInfo", "info:" + paramShortVideoUploadInfo);
      return paramShortVideoUploadInfo.a();
    }
    Logger.b(this.jdField_g_of_type_JavaLangString, this.f, "checkShortVideoUploadInfo", "info == null");
    return false;
  }
  ...
  private void b(ShortVideoDownloadInfo paramShortVideoDownloadInfo)
  {
    ...
    for (;;)
    {
      ...
      Logger.a(this.jdField_g_of_type_JavaLangString, this.f, "doDownloadShortVideo", "cost:" + (System.currentTimeMillis() - l));
      Logger.a(this.jdField_g_of_type_JavaLangString, this.f, "doDownloadShortVideo.start", "TransferRequest: " + localTransferRequest.toString());
      return;
  ...
  {
    ThreadManager.b().post(new jvp(this, paramShortVideoUploadInfo));
  }
  ...
  protected void a(int paramInt, PicInfoInterface.ErrInfo paramErrInfo)
  {
    ...
    {
      Logger.b(this.jdField_g_of_type_JavaLangString, this.f, paramErrInfo.jdField_a_of_type_JavaLangString, paramErrInfo.jdField_b_of_type_JavaLangString);
      return;
    }
    Logger.b(this.jdField_g_of_type_JavaLangString, this.f, "handleError", "unkown err,err == null");
  }
  ...
  protected void a(int paramInt, ShortVideoResult paramShortVideoResult)
  {
    ...
    Logger.a(this.jdField_g_of_type_JavaLangString, this.f, "handleSuccess", "what:" + paramInt);
  }
  ...
  public void a(DownCallBack.DownResult paramDownResult)
  {
    ...
    Logger.a(this.jdField_g_of_type_JavaLangString, this.f, "onDownload", "result:" + paramDownResult.jdField_a_of_type_Int);
  ...
  {
    Logger.a(this.jdField_g_of_type_JavaLangString, this.f, "downloadShortVideo", "start " + Thread.currentThread().getId());
