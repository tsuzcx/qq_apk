...
public class AddressData
{
  ...
  {
    paramAppInterface.runOnUiThread(new hwy(this, paramString));
  }
  ...
  public boolean a(AppInterface paramAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      paramString = (BaseAddress)paramAppInterface.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject1);
      if (paramString == null)
      {
        j = a(k - 1);
        paramString = new BaseAddress(str1, (String)localObject1, j);
        paramAppInterface.jdField_a_of_type_JavaUtilLinkedHashMap.put("0", new BaseAddress("不限", "0", j));
        paramAppInterface.jdField_a_of_type_JavaUtilLinkedHashMap.put(localObject1, paramString);
        paramAppInterface.jdField_a_of_type_Boolean = true;
      }
      for (;;)
      {
