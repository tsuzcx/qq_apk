  ...
  extends QQBrowserActivity
{
  ...
  private BroadcastReceiver b = new jhc(this);
  private BroadcastReceiver c = new jhd(this);
  
  static
  {
    jdField_a_of_type_JavaLangString = MusicGeneQQBrowserActivity.class.getSimpleName();
  }
  ...
  protected void doOnStart()
  {
    try
    {
      ...
      registerReceiver(this.c, localIntentFilter, "com.tencent.music.data.permission22", null);
      registerReceiver(this.b, new IntentFilter("com.tencent.mobileqq.activity.ForwardRecentActivity.ACTION_LIST_ITEM_ON_CLICK"));
      return;
    }
