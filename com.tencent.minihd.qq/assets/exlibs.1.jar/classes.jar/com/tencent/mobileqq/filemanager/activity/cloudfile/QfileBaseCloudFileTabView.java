  ...
  extends QfileBaseTabView
{
  ...
  private FMObserver jdField_a_of_type_ComTencentMobileqqFilemanagerAppFMObserver = new ilz(this);
  ...
  public TextView c;
  public boolean c;
  public View.OnClickListener d = new ilv(this);
  int e = 0;
  ...
  public QfileBaseCloudFileTabView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new imi(this);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new imm(this);
    this.jdField_a_of_type_AndroidViewView$OnLongClickListener = new ilr(this);
    this.jdField_c_of_type_AndroidViewView$OnClickListener = new ilu(this);
  ...
  private void t()
  {
    try
    {
      ...
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetViewerMoreRelativeLayout.findViewById(2131299471));
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.setOnGroupExpandListener(new ilq(this));
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.setOnGroupCollapseListener(new imf(this));
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.setSelector(2131427375);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.setGroupIndicator(null);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.setAdapter(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityAdapterQfileBaseExpandableListAdapter);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.setTranscriptMode(0);
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.d(0);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.setStackFromBottom(false);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.setTranscriptMode(0);
    if ((this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityAdapterQfileBaseExpandableListAdapter instanceof QfileWeiYunImageExpandableListAdapter))
    {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.getViewTreeObserver().addOnGlobalLayoutListener(new img(this));
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.getViewTreeObserver().addOnGlobalLayoutListener(new imh(this));
  }
  ...
  public void e()
  {
    ...
    localActionSheet.a(new imj(this, localActionSheet));
    localActionSheet.setOnDismissListener(new imk(this));
    localActionSheet.setOnCancelListener(new iml(this));
