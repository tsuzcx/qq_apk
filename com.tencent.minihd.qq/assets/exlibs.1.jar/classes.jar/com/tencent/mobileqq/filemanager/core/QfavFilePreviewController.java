  ...
  extends FilePreViewControllerBase
{
  ...
  private FavoritesRemoteCommand.IRemoteCommandHandler jdField_a_of_type_CooperationQqfavIpcFavoritesRemoteCommand$IRemoteCommandHandler = new iue(this);
  ...
  public QfavFilePreviewController(Bundle paramBundle)
  {
    ...
    this.e = 2;
    new Handler(Looper.getMainLooper()).postDelayed(new iug(this), 300000L);
  }
  ...
  public boolean a()
  {
    ...
    new Handler(Looper.getMainLooper()).postDelayed(new iuh(this), 2000L);
    return true;
  }
