...
public class UniformDownloader
{
  ...
  public UniformDownloader(long paramLong, String paramString, Bundle paramBundle)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader$IUniformDownloader.a(new jbc(this));
      return;
      this.ac = 2;
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloader$IUniformDownloader != null)
    {
      ...
      do
      {
        ...
        String str1 = UniformDownloadUtil.c(AppConstants.aR + paramBundle);
        String str2 = AppConstants.aP + paramBundle;
