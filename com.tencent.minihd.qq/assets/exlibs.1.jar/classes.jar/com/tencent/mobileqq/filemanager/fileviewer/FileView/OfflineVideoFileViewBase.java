  ...
  extends FileViewBase
{
  ...
  private void g()
  {
    ...
    do
    {
      ...
      localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131299574);
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)BaseApplicationImpl.getContext().getSystemService("layout_inflater")).inflate(2130903783, paramViewGroup, false);
    g();
  ...
  public void e()
  {
    AsyncImageView localAsyncImageView = (AsyncImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131299573);
