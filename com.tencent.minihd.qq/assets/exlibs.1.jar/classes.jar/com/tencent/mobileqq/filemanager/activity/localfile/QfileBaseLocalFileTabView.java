  ...
  extends QfileBaseTabView
{
  ...
  private FMObserver jdField_a_of_type_ComTencentMobileqqFilemanagerAppFMObserver = new inl(this);
  ...
  public View.OnClickListener c = new inj(this);
  View c;
  public View.OnClickListener d = new ink(this);
  int e = 0;
  private int f;
  ...
  public QfileBaseLocalFileTabView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new int(this);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new inx(this);
    this.jdField_a_of_type_AndroidViewView$OnLongClickListener = new iny(this);
  ...
  private void k()
  {
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetNoFileRelativeLayout.setText(2131362401);
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityAdapterQfileBaseExpandableListAdapter instanceof QfileLocalImageExpandableListAdapter))
    {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.getViewTreeObserver().addOnGlobalLayoutListener(new ini(this));
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.getViewTreeObserver().addOnGlobalLayoutListener(new inr(this));
  }
  ...
  public void e()
  {
    ...
    localActionSheet.a(new inu(this, localActionSheet));
    localActionSheet.setOnDismissListener(new inv(this));
    localActionSheet.setOnCancelListener(new inw(this));
