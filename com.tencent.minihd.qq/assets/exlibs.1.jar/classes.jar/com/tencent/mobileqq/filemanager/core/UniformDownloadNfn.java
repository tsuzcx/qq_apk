...
public class UniformDownloadNfn
{
  ...
  private iuw jdField_a_of_type_Iuw = null;
  ...
  private UniformDownloadNfn()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Iuw = new iuw(this, BaseApplicationImpl.a());
  ...
  public int a(UniformDownloader paramUniformDownloader, Bundle paramBundle, long paramLong, int paramInt)
  {
    ...
    {
      paramUniformDownloader.a(new iuv(this, this.jdField_a_of_type_AndroidOsHandler.getLooper(), paramInt, paramBundle, paramLong), false);
      return paramInt;
  ...
  public Notification a(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      localNotification.icon = 2130839693;
      paramBundle = new RemoteViews(BaseApplication.getContext().getPackageName(), 2130903775);
      paramBundle.setImageViewResource(2131298180, 2130839689);
      paramBundle.setTextViewText(2131298182, (CharSequence)localObject);
      paramBundle.setProgressBar(2131298186, 100, 0, false);
      paramBundle.setViewVisibility(2131298184, 8);
      paramBundle.setViewVisibility(2131298185, 8);
      if (this.jdField_a_of_type_Iuw.b() != null) {
        paramBundle.setTextColor(2131298182, this.jdField_a_of_type_Iuw.b().intValue());
      }
      for (;;)
      {
        if (this.jdField_a_of_type_Iuw.a() != null)
        {
          paramBundle.setTextColor(2131298184, this.jdField_a_of_type_Iuw.a().intValue());
          paramBundle.setTextColor(2131299571, this.jdField_a_of_type_Iuw.a().intValue());
          label161:
          float f1 = this.jdField_a_of_type_Iuw.a();
          if (this.jdField_a_of_type_Iuw.a() <= 0.0F)
          {
            QLog.w(jdField_a_of_type_JavaLangString, 1, "[UniformDL]. initNotification param error. getTextSize failed. set defualt value:14");
            f1 = 14.0F;
          }
          paramBundle.setFloat(2131298184, "setTextSize", f1);
          paramBundle.setFloat(2131299571, "setTextSize", f1);
          float f2 = this.jdField_a_of_type_Iuw.b();
          f1 = f2;
          if (f2 <= 0.0F)
          {
          ...
          paramBundle.setFloat(2131298182, "setTextSize", f1);
        ...
        try
        {
          int i1 = this.jdField_a_of_type_Iuw.b().intValue();
          paramBundle.setInt(2131299569, "setBackgroundColor", (i1 & 0xFF000000) + (-1 - i1));
          ...
          this.jdField_a_of_type_Iuw.a(BaseApplication.getContext(), true);
          if (this.jdField_a_of_type_Iuw.b() != null)
          {
            paramBundle.setTextColor(2131298182, this.jdField_a_of_type_Iuw.b().intValue());
          }
          else
          {
            ...
            paramBundle.setTextColor(2131298182, -7829368);
            continue;
            ...
            QLog.w(jdField_a_of_type_JavaLangString, 1, "[UniformDL]. initNotification param error. getTitleColor failed. set defualt value");
            paramBundle.setTextColor(2131298184, -7829368);
            paramBundle.setTextColor(2131299571, -7829368);
          }
        }
        catch (Exception localException)
        {
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 100	com/tencent/mobileqq/filemanager/core/UniformDownloadNfn:jdField_a_of_type_AndroidOsHandlerThread	Landroid/os/HandlerThread;
    //   6: ifnull +12 -> 18
    //   9: aload_0
    //   10: getfield 102	com/tencent/mobileqq/filemanager/core/UniformDownloadNfn:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   13: astore_1
    //   14: aload_1
    //   15: ifnonnull +6 -> 21
    //   18: aload_0
    ...
    //   20: return
    //   21: aload_0
    //   22: getfield 102	com/tencent/mobileqq/filemanager/core/UniformDownloadNfn:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   25: new 344	iuu
    //   28: dup
    //   29: aload_0
    //   30: invokespecial 347	iuu:<init>	(Lcom/tencent/mobileqq/filemanager/core/UniformDownloadNfn;)V
    //   33: invokevirtual 351	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   36: pop
    //   37: goto -19 -> 18
    //   40: astore_1
    //   41: aload_0
  ...
  public void a(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    {
      return;
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131362503) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setImageViewResource(2131298180, 2130839689);
      int i1 = paramBundle2.getInt("_START_WAITING_");
      if (1 == i1)
      {
        paramNotification.contentView.setTextViewText(2131299571, BaseApplication.getContext().getString(2131362504));
        paramNotification.contentView.setViewVisibility(2131298185, 0);
        paramNotification.contentView.setViewVisibility(2131298184, 8);
        paramNotification.contentView.setProgressBar(2131298186, 100, 0, false);
      ...
      for (;;)
      {
        ...
        return;
        paramNotification.contentView.setTextViewText(2131299571, "0%");
        break;
        paramNotification.when = a(3);
        break label223;
        paramNotification.contentView.setOnClickPendingIntent(2131299569, paramBundle1);
      }
    }
  }
  ...
  public void a(int paramInt, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    localNotification.tickerText = (BaseApplication.getContext().getString(2131362506) + " " + paramBundle1.getString("_notify_param_Filename"));
    Bitmap localBitmap = null;
    paramBundle2 = BaseApplication.getContext().getString(2131362508);
    if (UniformDownloadUtil.b(str1) != null)
    {
      localBitmap = UniformDownloadUtil.a(str1);
      paramBundle2 = BaseApplication.getContext().getString(2131362507);
    }
    if (localBitmap == null)
    {
      ...
      if (i1 != 0)
      {
        localNotification.contentView.setImageViewResource(2131298180, i1);
        label195:
        localNotification.contentView.setImageViewResource(2131298180, 2130839691);
      }
    }
    for (;;)
    {
      localNotification.contentView.setViewVisibility(2131298184, 0);
      localNotification.contentView.setViewVisibility(2131298185, 8);
      localNotification.contentView.setTextViewText(2131298184, paramBundle2);
      ...
      localNotification.contentView.setImageViewResource(2131298180, 2130839691);
      break label195;
      localNotification.contentView.setImageViewBitmap(2131298180, localBitmap);
    }
  }
  ...
  public void b(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setProgressBar(2131298186, 100, i1, false);
      paramNotification.contentView.setTextViewText(2131299571, "" + i1 + "%");
      paramNotification.flags = 34;
      paramBundle2 = new Intent("com.tencent.mobileqq.UniformDownloadNfn.PAUSE");
      paramBundle2.putExtra("_PARAM_EXTRA", paramBundle1);
      paramBundle1 = PendingIntent.getBroadcast(BaseApplication.getContext(), b(), paramBundle2, 134217728);
  ...
  public void c(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    paramNotification.tickerText = null;
    int i1 = paramBundle2.getInt("_FILE_PROGRESS_");
    paramNotification.contentView.setImageViewResource(2131298180, 2130839692);
    paramNotification.contentView.setViewVisibility(2131298184, 0);
    paramNotification.contentView.setViewVisibility(2131298185, 8);
    paramNotification.contentView.setTextViewText(2131298184, BaseApplication.getContext().getString(2131362505));
    paramNotification.contentView.setProgressBar(2131298186, 100, i1, false);
    paramNotification.contentView.setTextViewText(2131299571, "" + i1 + "%");
    ...
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidAppNotificationManager.notify(paramInt, paramNotification);
      return;
      paramNotification.contentView.setOnClickPendingIntent(2131299569, paramBundle2);
    }
  }
  ...
  public void d(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (2 == i1)
    {
      paramNotification.tickerText = BaseApplication.getContext().getString(2131362509);
      paramNotification.contentView.setTextViewText(2131298184, BaseApplication.getContext().getString(2131362509));
      label113:
      paramNotification.contentView.setImageViewResource(2131298180, 2130839690);
      paramNotification.contentView.setViewVisibility(2131298184, 0);
      paramNotification.contentView.setTextViewText(2131299571, " ");
      paramNotification.flags = 16;
    ...
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidAppNotificationManager.notify(paramInt, paramNotification);
      return;
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131362510) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setTextViewText(2131298184, UniformDownloader.a(i1) + "，点击重试");
      break label113;
      label351:
      paramNotification.contentView.setOnClickPendingIntent(2131299569, paramBundle2);
    }
