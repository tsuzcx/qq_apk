  ...
  implements View.OnClickListener
{
  ...
  private TabBarView.OnTabChangeListener jdField_a_of_type_ComTencentMobileqqWidgetTabBarView$OnTabChangeListener = new jbv(this);
  public TabBarView a;
  ...
  public QfileTabBarView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    ((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2130903769, this);
    this.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView = ((TabBarView)findViewById(2131297618));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131299546));
  ...
  public QfileBaseTabView a(int paramInt)
  {
    ...
    int j = ((Integer)this.c.get(Integer.valueOf(paramInt))).intValue();
    int i;
