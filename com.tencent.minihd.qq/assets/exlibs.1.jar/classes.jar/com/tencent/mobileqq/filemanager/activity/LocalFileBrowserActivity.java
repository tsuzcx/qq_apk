  ...
  implements View.OnClickListener
{
  ...
  public LocalFileBrowserActivity()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new ikr(this);
    this.jdField_a_of_type_AndroidViewView$OnLongClickListener = new ikv(this);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new iky(this);
    this.jdField_a_of_type_ComTencentWidgetAdapterView$OnItemClickListener = new ikn(this);
  }
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      new iko(this, paramBoolean).execute(new String[] { paramString });
      return;
      ...
      if (this.jdField_d_of_type_JavaLangString.equalsIgnoreCase(this.e)) {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(2131362351);
      } else {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(2131362476);
      }
    }
  }
  ...
  private void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setSelected(true);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.post(new ikp(this, paramInt));
  }
  ...
  private void n()
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView = ((SlideDetectListView)findViewById(2131299527));
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetNoFileRelativeLayout = ((NoFileRelativeLayout)findViewById(2131299528));
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetNoFileRelativeLayout.setText(2131368119);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setOnSlideListener(new ikq(this));
  }
  ...
  private void o()
  {
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_d_of_type_JavaLangString = AppConstants.aP;
      continue;
      this.jdField_d_of_type_JavaLangString = AppConstants.aE;
      continue;
  ...
  private void q()
  {
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = this.leftView;
    if (this.jdField_c_of_type_AndroidWidgetTextView != null) {
      this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(new ikz(this));
    }
    this.jdField_c_of_type_AndroidWidgetTextView = this.leftView;
  }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    p();
    q();
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131299526));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131299525));
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setOnItemClickListener(this.jdField_a_of_type_ComTencentWidgetAdapterView$OnItemClickListener);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setOnScrollToTopListener(new ikm(this));
  ...
  public void l()
  {
    ...
    localActionSheet.a(getResources().getStringArray(2131230794)[1], 3);
    localActionSheet.a(new iks(this, localActionSheet));
    localActionSheet.setOnDismissListener(new ikt(this));
    localActionSheet.setOnCancelListener(new iku(this));
