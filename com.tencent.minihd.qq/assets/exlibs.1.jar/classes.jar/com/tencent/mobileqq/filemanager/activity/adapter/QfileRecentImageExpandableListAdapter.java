  ...
  extends QfileBaseExpandableListAdapter
{
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    ill localill = (ill)paramView.getTag();
    int i = 0;
    View localView;
    if (i < 3)
    {
      localView = b(paramInt1, paramInt2 * 3 + i, paramBoolean, localill.a[i], paramViewGroup);
      if (localView != null) {}
    }
    else
    {
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new ill(null));
    ...
    for (FileManagerEntity localFileManagerEntity = (FileManagerEntity)paramViewGroup;; localView = null)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramViewGroup = paramView;
          ((QfileRecentImageExpandableListAdapter.ImageHolder)localObject).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131296300));
          paramViewGroup = paramView;
          ((QfileRecentImageExpandableListAdapter.ImageHolder)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131299535));
          paramViewGroup = paramView;
          ((QfileRecentImageExpandableListAdapter.ImageHolder)localObject).b = ((ImageView)paramView.findViewById(2131297175));
          paramViewGroup = paramView;
          ...
          try
          {
            ...
            if ((!this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.h()) || (!FMDataCache.a(localFileManagerEntity))) {
              continue;
            }
