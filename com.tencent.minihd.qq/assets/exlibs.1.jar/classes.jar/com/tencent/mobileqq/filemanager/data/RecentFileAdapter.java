  ...
  extends BaseFileAdapter
{
  ...
  private String a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    default: 
      ...
      default: 
        ...
        if (paramFileManagerEntity.cloudType == 0) {
          str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362395);
        }
        str3 = str4;
        if (str1 != null)
        {
          str3 = str4;
          if (!str1.equals(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362385)))
          {
            str3 = str4;
            if (!str1.equals(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362396))) {
    ...
    label760:
    for (String str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362397);; str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362395))
    {
      str3 = paramFileManagerEntity.peerNick;
      str4 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362402);
      ...
      return str2;
      str2 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362362);
      str1 = FileManagerUtil.a(paramFileManagerEntity.srvTime, paramFileManagerEntity.peerType, false);
      localObject = str1 + this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362398);
      break;
      str2 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362363);
      localObject = null;
      break;
      localObject = null;
      str2 = null;
      ...
      str2 = null;
      break;
      str2 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131364775);
      localObject = null;
      break;
      str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362395);
      break label234;
      str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362385);
      break label234;
      str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362397);
      break label234;
      str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362396);
      break label234;
      if (paramFileManagerEntity.bSend)
      {
        str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362397);
      ...
      str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362395);
      break label234;
      str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362496);
      break label234;
      str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362497);
      break label234;
      str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362498);
      break label234;
      str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362499);
      break label234;
      str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362500);
      break label234;
      str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362501);
      break label234;
      str1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362502);
      break label234;
    }
    label773:
    if (paramFileManagerEntity.cloudType == 5) {
    ...
    if (paramFileManagerEntity.TroopUin != 0L)
    {
      ...
      if (paramFileManagerEntity.bSend) {
        return str1 + this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362513) + ((TroopInfo)localObject).troopname;
      }
      return str1 + this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131362512) + ((TroopInfo)localObject).troopname;
    }
    return str1;
  }
    ...
    for (;;)
    {
      for (;;)
      {
        try
        {
          ...
          paramViewGroup = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903765, paramViewGroup, false);
        ...
        try
        {
          localItemHolder.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131299496));
          paramViewGroup = paramView;
          ...
          paramViewGroup = paramView;
          localItemHolder.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131299537));
          paramViewGroup = paramView;
          localItemHolder.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131299501));
          paramViewGroup = paramView;
          localItemHolder.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131299538));
          paramViewGroup = paramView;
          localItemHolder.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131299498));
          paramViewGroup = paramView;
          localItemHolder.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131299499));
          paramViewGroup = paramView;
          localItemHolder.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131299503));
          paramViewGroup = paramView;
          localItemHolder.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131297407));
          paramViewGroup = paramView;
          localItemHolder.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131299504));
          paramViewGroup = paramView;
          localItemHolder.d = ((TextView)paramView.findViewById(2131297921));
          paramViewGroup = paramView;
          localItemHolder.jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout = ((ShaderAnimLayout)paramView.findViewById(2131296569));
          paramViewGroup = paramView;
          localItemHolder.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131297628));
          paramViewGroup = paramView;
          ...
          case 17: 
            ...
            localItemHolder.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
            paramViewGroup = paramView;
            localItemHolder.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130838123);
            paramViewGroup = paramView;
