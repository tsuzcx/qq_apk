  ...
  extends OfflineVideoFileViewBase
{
  ...
  {
    super(paramActivity);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerFileViewOfflineVideoFileViewBase$IControllProxyInterface = new iyu(this, paramQQAppInterface);
    a().a();
  }
