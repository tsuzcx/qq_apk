  ...
  extends RelativeLayout
{
  ...
  public ViewerMoreRelativeLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    ((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2130903767, this);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131299469));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131299471));
