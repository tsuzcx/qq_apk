  ...
  extends PinnedHeaderExpandableListView.ExpandableListAdapter
{
  ...
  {
    Object localObject = (ilg)paramView.getTag();
    if (localObject == null)
    {
      localObject = new ilg();
      paramView.findViewById(2131297233).setVisibility(0);
      ((ilg)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297234));
      ((ilg)localObject).b = ((TextView)paramView.findViewById(2131297235));
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      localObject = (ilg)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramView.b = ((TextView)paramViewGroup.findViewById(2131297235));
