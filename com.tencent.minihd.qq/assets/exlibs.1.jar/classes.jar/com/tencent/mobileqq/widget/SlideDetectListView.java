  ...
  implements MotionViewSetter
{
  ...
  public SlideDetectListView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidViewGestureDetector$SimpleOnGestureListener = new kzc(this);
    this.jdField_a_of_type_AndroidViewGestureDetector = null;
    this.jdField_c_of_type_Boolean = false;
    this.jdField_b_of_type_Float = 0.0F;
    super.setOnScrollListener(new kzd(this));
  ...
  public void d()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      View localView = this.jdField_a_of_type_AndroidViewView.findViewById(2131296569);
      if (localView != null) {
