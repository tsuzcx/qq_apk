  ...
  extends PhotoBoard
{
  ...
  public ProfilePhotoBoard(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    try
    {
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840532);
      paramInt = getResources().getDimensionPixelSize(2131493117);
      if (paramInt <= 0)
      {
        this.x = ((int)(this.x * this.jdField_b_of_type_Float));
        paramInt = getResources().getDimensionPixelSize(2131493118);
        if (paramInt > 0) {
          break label251;
        }
        this.y = ((int)(this.y * this.jdField_b_of_type_Float));
        paramInt = getResources().getDimensionPixelSize(2131493119);
        if (paramInt > 0) {
          break label259;
        }
        this.z = ((int)(this.z * this.jdField_b_of_type_Float));
        paramInt = getResources().getDimensionPixelSize(2131493120);
        if (paramInt > 0) {
          break label267;
        }
  ...
  public void setDrawCoverBgIconFlag(boolean paramBoolean)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_JavaLangString = getResources().getString(2131369051);
      return;
    }
    this.jdField_a_of_type_AndroidGraphicsPaint = null;
  }
