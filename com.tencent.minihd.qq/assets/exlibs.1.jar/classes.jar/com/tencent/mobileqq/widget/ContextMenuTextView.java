  ...
  extends TextView
{
  ...
  kxn jdField_a_of_type_Kxn = new kxn(this, null);
  ...
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new kxl(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    setOnLongClickListener(this.jdField_a_of_type_Kxn);
  ...
  public ContextMenuTextView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    setOnLongClickListener(this.jdField_a_of_type_Kxn);
    setSelectAllOnFocus(true);
    setOnTouchListener(this.jdField_a_of_type_Kxn);
  }
