  ...
  extends LinearLayout
{
  ...
  public String a(boolean paramBoolean)
  {
    try
    {
      int j = this.jdField_a_of_type_ComTencentMobileqqWidgetWorkSpaceView.a();
      int i = j;
      if (paramBoolean) {
        i = (j + 1) % this.jdField_a_of_type_ComTencentMobileqqWidgetWorkSpaceView.getChildCount();
      }
      String str = ((PushBanner)this.jdField_a_of_type_ComTencentMobileqqWidgetWorkSpaceView.getChildAt(i).getTag()).m;
      return str;
    }
    catch (Exception localException) {}
    return "";
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildCount() == 0)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetWorkSpaceView.setOnScreenChangeListener(new kws(this, (LinearLayout)localObject));
  ...
  protected void a(LinearLayout paramLinearLayout)
  {
    ...
    paramLinearLayout.setBackgroundResource(2130838515);
  ...
  public void b()
  {
    this.jdField_a_of_type_Kwt.removeMessages(0);
    try
    {
      i = ((PushBanner)this.jdField_a_of_type_ComTencentMobileqqWidgetWorkSpaceView.getChildAt(this.jdField_a_of_type_ComTencentMobileqqWidgetWorkSpaceView.a()).getTag()).a;
      i *= 1000;
    }
    catch (Exception localException)
    {
    ...
    this.jdField_a_of_type_Kwt.sendEmptyMessageDelayed(0, i);
  }
  
  public void c()
  {
    this.jdField_a_of_type_Kwt.sendEmptyMessage(1);
  }
