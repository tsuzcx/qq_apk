  ...
  extends AlertDialog
{
  ...
  public CustomAlertDialog(Context paramContext, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, List paramList)
  {
    ...
    paramContext = new kxo(this, paramList);
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2130903163, null));
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    getWindow().getAttributes().windowAnimations = 2131558890;
