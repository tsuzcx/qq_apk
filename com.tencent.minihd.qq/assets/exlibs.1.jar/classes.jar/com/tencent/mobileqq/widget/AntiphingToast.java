...
public class AntiphingToast
{
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new kwy(this);
  }
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    if (paramBoolean == true) {
      localTranslateAnimation.setAnimationListener(new kwz(this));
    }
  ...
  public boolean a(Context paramContext, String paramString, int paramInt)
  {
    ...
    View localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130904077, null);
    if (localView != null)
    {
      TextView localTextView = (TextView)localView.findViewById(2131300767);
  ...
  public boolean a(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130904077, null);
      if (this.jdField_a_of_type_AndroidViewView != null)
      {
        TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131300767);
    ...
    a(-80.0F, 0.0F, false);
    new Timer().schedule(new kxa(this), this.g + 700);
    return true;
  }
