...
{
  public static final String a = "IphoneTreeView";
  private static final boolean jdField_a_of_type_Boolean = false;
  public int a;
  private final Rect jdField_a_of_type_AndroidGraphicsRect = new Rect();
  private Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable;
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new kyg(this);
  public View a;
  ...
  protected void dispatchDraw(Canvas paramCanvas)
  {
    ...
    default: 
      ...
      else
      {
        ...
        if ((this.jdField_a_of_type_AndroidViewView == null) || (this.jdField_c_of_type_Boolean) || (this.jdField_a_of_type_Int != i))
        {
          this.jdField_a_of_type_Int = i;
          this.jdField_a_of_type_AndroidViewView = getExpandableListAdapter().getGroupView(i, true, this.jdField_c_of_type_AndroidViewView, this);
        ...
        if (this.jdField_a_of_type_AndroidViewView != this.jdField_c_of_type_AndroidViewView) {
