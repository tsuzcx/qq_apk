  ...
  implements PopupWindow.OnDismissListener
{
  ...
  private DropdownView.DropdownViewDropIconClickListner jdField_a_of_type_ComTencentMobileqqWidgetDropdownView$DropdownViewDropIconClickListner;
  public kxw a;
  ...
  public DropdownView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Kxw = new kxw(this, paramContext);
    a(paramContext);
  }
  ...
  public DropdownView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Kxw = new kxw(this, paramContext, paramAttributeSet);
    a(paramContext);
  }
  ...
  public DropdownView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_Kxw = new kxw(this, paramContext, paramAttributeSet, paramInt);
    a(paramContext);
  }
  ...
  private void a(Context paramContext)
  {
    ...
    addView(this.jdField_a_of_type_Kxw, (ViewGroup.LayoutParams)localObject1);
    this.jdField_a_of_type_Kxw.setDropDownVerticalOffset(0);
    ...
    ((RelativeLayout.LayoutParams)localObject2).addRule(7, this.jdField_a_of_type_Kxw.getId());
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130838120);
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130838539);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130838540);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new kxu(this));
    try
    {
      paramContext = this.jdField_a_of_type_Kxw.getClass().getSuperclass().getDeclaredField("mPopup");
      paramContext.setAccessible(true);
      paramContext = paramContext.get(this.jdField_a_of_type_Kxw);
  ...
  {
    return this.jdField_a_of_type_Kxw;
  }
  ...
  {
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    new Handler().postDelayed(new kxv(this), 500L);
  }
  
  public void setDropIconViewDown()
  {
  ...
  public void setDropIconViewUp()
  {
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
  }
  
  public void setOnDropdownViewDropIconClickListner(DropdownView.DropdownViewDropIconClickListner paramDropdownViewDropIconClickListner)
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetDropdownView$DropdownViewDropIconClickListner = paramDropdownViewDropIconClickListner;
  }
}
