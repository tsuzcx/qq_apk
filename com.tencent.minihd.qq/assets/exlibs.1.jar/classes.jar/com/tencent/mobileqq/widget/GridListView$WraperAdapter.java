  ...
  extends BaseAdapter
{
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new kya(null));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      kya localkya = (kya)paramView.getTag();
      ...
      paramViewGroup = localkya.a[paramInt];
      int k = this.a.jdField_a_of_type_ComTencentMobileqqWidgetGridListView$GridListAdapter.b(j + paramInt);
      if ((paramViewGroup != null) && (((Integer)paramViewGroup.getTag(2131296583)).intValue() != k)) {
        paramViewGroup = null;
      }
      for (;;)
      {
        ...
        localView.setTag(2131296583, Integer.valueOf(k));
        localkya.a[paramInt] = localView;
        ...
        {
          localView.setTag(2131300513, Integer.valueOf(j + paramInt));
        ...
        {
          localObject = paramView;
          if (((Integer)paramView.getTag(2131296583)).intValue() != i) {
            localObject = null;
          }
        }
        ...
        paramView.setTag(2131296583, Integer.valueOf(i));
        ...
        {
          paramView.setTag(2131300513, Integer.valueOf(paramInt));
