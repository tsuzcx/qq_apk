  ...
  extends LinearLayout
{
  ...
  public CustomedTabWidget(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)inflate(paramContext, 2130904434, null));
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidWidgetImageView.getBackground();
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130841930);
    this.c = paramContext.getResources().getDrawable(2130841929);
    this.jdField_b_of_type_Float = paramContext.getResources().getDisplayMetrics().density;
    this.jdField_a_of_type_Kxt = new kxt(this);
  }
  ...
  private void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Kxt.sendEmptyMessage(0);
  }
  
  private void a(View paramView)
  {
    paramView.setOnClickListener(new kxr(this));
    paramView.setOnTouchListener(new kxs(this));
    if (getChildCount() == 1) {
  ...
  {
    this.jdField_a_of_type_Kxt.removeMessages(0);
