  ...
  extends LinearLayout
{
  ...
  private kyh jdField_a_of_type_Kyh = new kyh(this);
  private kyi jdField_a_of_type_Kyi = new kyi(this);
  ...
  private ChatThumbView a(MessageForPic paramMessageForPic)
  {
    ...
    localChatThumbView.setMaxHeight(URLDrawableHelper.a());
    localChatThumbView.setMaxWidth(URLDrawableHelper.a());
  ...
  private AnimationTextView a()
  {
    ...
    localAnimationTextView.setTextColor(getContext().getResources().getColorStateList(2131427942));
    localAnimationTextView.setLinkTextColor(getContext().getResources().getColorStateList(2131427941));
  ...
  public void a(List paramList)
  {
    ...
    while (i < ((ArrayList)localObject3).size())
    {
      ...
      this.jdField_a_of_type_Kyi.a((AnimationTextView)localObject1);
      i += 1;
    }
    j = paramList.size();
    i = 0;
    if (i < j)
    {
      ...
      {
        localObject2 = this.jdField_a_of_type_Kyi.a();
      ...
      localObject1 = this.jdField_a_of_type_Kyh.a();
    ...
    for (;;)
    {
      ...
      while (i < ((ArrayList)localObject3).size())
      {
        ...
        if ((paramList instanceof ChatThumbView))
        {
          ...
          this.jdField_a_of_type_Kyh.a((ChatThumbView)paramList);
        }
        i += 1;
      }
      return;
