  ...
  implements GetChars, Spannable, CharSequence, Cloneable
{
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidTextSpannable$Factory = new jzf();
    try
    {
  ...
  public static void a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    localActionSheet.a(2131367602, 1);
    localActionSheet.a(2131367603, 1);
    if (paramBoolean)
    {
      localActionSheet.a(2131365750, 1);
      localActionSheet.a(2131365760, 1);
    }
    if (paramBoolean) {
      localActionSheet.a(String.format(paramContext.getString(2131367618), new Object[] { paramString }));
    }
    for (;;)
    {
      localActionSheet.a(new jzg(paramString, paramContext, localActionSheet));
  ...
  public void a(View paramView, String paramString)
  {
    ...
    MttBrowerWrapper.a(paramView.getContext(), paramString, true, true, true, false, this.n, "");
  }
  
  protected void a(Object paramObject, int paramInt1, int paramInt2, int paramInt3)
  {
    if (this.o + 1 >= this.jdField_b_of_type_ArrayOfJavaLangObject.length)
    {
      int i1 = a(this.o + 1);
      Object[] arrayOfObject = new Object[i1];
      int[] arrayOfInt = new int[i1 * 3];
      System.arraycopy(this.jdField_b_of_type_ArrayOfJavaLangObject, 0, arrayOfObject, 0, this.o);
      System.arraycopy(this.jdField_a_of_type_ArrayOfInt, 0, arrayOfInt, 0, this.o * 3);
      this.jdField_b_of_type_ArrayOfJavaLangObject = arrayOfObject;
      this.jdField_a_of_type_ArrayOfInt = arrayOfInt;
    }
    this.jdField_b_of_type_ArrayOfJavaLangObject[this.o] = paramObject;
    this.jdField_a_of_type_ArrayOfInt[(this.o * 3 + 0)] = paramInt1;
    this.jdField_a_of_type_ArrayOfInt[(this.o * 3 + 1)] = paramInt2;
    this.jdField_a_of_type_ArrayOfInt[(this.o * 3 + 2)] = paramInt3;
    this.o += 1;
  }
