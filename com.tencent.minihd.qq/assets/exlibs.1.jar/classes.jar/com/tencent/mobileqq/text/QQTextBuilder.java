  ...
  extends SpannableStringBuilder
{
  ...
  static
  {
    jdField_a_of_type_AndroidTextEditable$Factory = new jzh();
    jdField_b_of_type_AndroidTextEditable$Factory = new jzi();
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          localObject = new QQText(paramCharSequence, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int).a();
