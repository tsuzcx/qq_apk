  ...
  implements View.OnClickListener
{
  ...
  protected void a()
  {
    ...
    LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130904094, this, true);
    ...
    this.c = findViewById(2131297352);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131300821));
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.setOnDismissListener(new jfs(this));
    this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.show();
    startAnimation(AnimationUtils.loadAnimation(this.jdField_a_of_type_AndroidContentContext, 2130968628));
  }
