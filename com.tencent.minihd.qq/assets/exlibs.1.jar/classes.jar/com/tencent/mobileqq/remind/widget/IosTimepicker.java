  ...
  extends LinearLayout
{
  ...
  private AdapterView.OnItemSelectedListener jdField_a_of_type_ComTencentWidgetAdapterView$OnItemSelectedListener = new jqk(this);
  private VerticalGallery.OnEndFlingListener jdField_a_of_type_ComTencentWidgetVerticalGallery$OnEndFlingListener = new jqm(this);
  private VerticalGallery.OnSelectViewDataUpdateListener jdField_a_of_type_ComTencentWidgetVerticalGallery$OnSelectViewDataUpdateListener = new jql(this);
  ...
  private void a()
  {
    ...
    if (this.n == 1)
    {
      this.jdField_b_of_type_Long = TimeHelper.a(this.jdField_a_of_type_ComTencentMobileqqRemindWidgetWheelView.r(), 23, 59);
    ...
    int i1 = this.jdField_a_of_type_ComTencentMobileqqRemindWidgetWheelView.r();
    int i2 = this.jdField_b_of_type_ComTencentMobileqqRemindWidgetWheelView.r();
    int i3 = this.c.r();
    String str2 = TimeHelper.a(i1);
    if ((i2 >= 0) && (i2 < TimeHelper.jdField_a_of_type_ArrayOfJavaLangString.length)) {}
    for (String str1 = TimeHelper.jdField_a_of_type_ArrayOfJavaLangString[i2];; str1 = null)
    {
      Object localObject1 = localObject2;
      if (i3 >= 0)
      {
        localObject1 = localObject2;
        if (i3 < TimeHelper.jdField_b_of_type_ArrayOfJavaLangString.length) {
          localObject1 = TimeHelper.jdField_b_of_type_ArrayOfJavaLangString[i3];
        }
      }
      ...
      this.jdField_b_of_type_Long = TimeHelper.a(i1, i2, i3);
      break;
    }
  }
  ...
  public void a(Context paramContext, ActionSheet paramActionSheet, long paramLong, IosTimepicker.OnTimePickerSelectListener paramOnTimePickerSelectListener, View.OnClickListener paramOnClickListener, int paramInt)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    ...
    this.l = paramContext.getColor(2131427979);
    this.m = paramContext.getColor(2131427960);
    ...
    this.jdField_a_of_type_AndroidViewView = findViewById(2131302427);
    this.jdField_a_of_type_ComTencentMobileqqRemindWidgetWheelView = ((WheelView)findViewById(2131299752));
    this.jdField_b_of_type_ComTencentMobileqqRemindWidgetWheelView = ((WheelView)findViewById(2131299753));
    this.c = ((WheelView)findViewById(2131299754));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131302428));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131300123));
    paramInt = paramContext.getColor(2131427988);
    findViewById(2131302429).setBackgroundColor(paramInt);
    findViewById(2131302430).setBackgroundColor(paramInt);
    this.jdField_a_of_type_AndroidViewView.setBackgroundColor(paramContext.getColor(2131427962));
    paramInt = paramContext.getColor(2131427987);
    findViewById(2131298566).setBackgroundColor(paramInt);
    findViewById(2131298567).setBackgroundColor(paramInt);
    if (paramOnClickListener != null)
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqRemindWidgetWheelView.setVisibility(8);
      this.c.setVisibility(8);
      paramContext = new LinearLayout.LayoutParams(-1, -1);
      this.jdField_a_of_type_ComTencentMobileqqRemindWidgetWheelView.setLayoutParams(paramContext);
    ...
    for (;;)
    {
      a();
      return;
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new jqj(this));
      break;
      label426:
