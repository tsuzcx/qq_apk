...
public class PicReporter
{
  ...
  {
    boolean bool = SettingCloneUtil.readValue(BaseApplication.getContext(), null, BaseApplication.getContext().getString(2131366260), "qqsetting_auto_receive_pic_key", true);
