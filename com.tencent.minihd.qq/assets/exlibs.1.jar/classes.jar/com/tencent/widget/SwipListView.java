  ...
  implements Handler.Callback
{
  ...
  private void c(View paramView)
  {
    ...
    for (int m = paramView.getScrollX();; m = 0)
    {
      if (this.jdField_a_of_type_ComTencentWidgetSwipListView$SwipListListener != null) {
        this.jdField_a_of_type_ComTencentWidgetSwipListView$SwipListListener.b(-1);
      }
      if (m != 0) {
    ...
    if (paramView != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentWidgetSwipListView$SwipListListener != null)
      {
        ...
        if ((localObject instanceof Integer)) {
          this.jdField_a_of_type_ComTencentWidgetSwipListView$SwipListListener.b(((Integer)localObject).intValue());
        }
      }
    }
    for (int m = n;; m = 0)
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetSwipListView$SwipListListener.a();
    return true;
  }
  ...
  public void setAdapter(ListAdapter paramListAdapter)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetSwipListView$SwipListListener = null;
  }
