...
public class BubblePopupWindow
{
  ...
  private static final String jdField_a_of_type_JavaLangString = "com.tencent.minihd.qq.action.drag";
  public static final int b = 1;
  public static final int c = 2;
  private static final int[] jdField_c_of_type_ArrayOfInt = { 16842922 };
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new lrk(this);
  ...
  private ViewTreeObserver.OnScrollChangedListener jdField_a_of_type_AndroidViewViewTreeObserver$OnScrollChangedListener = new lrl(this);
  ...
  private lrm jdField_c_of_type_Lrm;
  ...
  public BubblePopupWindow(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_AndroidContentContext.registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, new IntentFilter("com.tencent.minihd.qq.action.drag"));
  }
  ...
  private void a(WindowManager.LayoutParams paramLayoutParams)
  {
    ...
    lrn locallrn = new lrn(this, this.jdField_a_of_type_AndroidContentContext);
    ...
    locallrn.addView((View)localObject, -1, -1);
    ...
    localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837925);
    this.jdField_a_of_type_Lrm = new lrm(this, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837926));
    localObject = new LayerDrawable(new Drawable[] { localObject, this.jdField_a_of_type_Lrm });
    ...
    this.jdField_b_of_type_Lrm = new lrm(this, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837924));
    LayerDrawable localLayerDrawable = new LayerDrawable(new Drawable[] { this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837923), this.jdField_b_of_type_Lrm });
    this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundDrawable(localLayerDrawable);
    locallrn.addView(this.jdField_b_of_type_AndroidWidgetImageView, (ViewGroup.LayoutParams)localObject);
    this.jdField_a_of_type_AndroidWidgetImageView = new ImageView(this.jdField_a_of_type_AndroidContentContext);
    localObject = new FrameLayout.LayoutParams(-2, -2, 83);
    this.jdField_c_of_type_Lrm = new lrm(this, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837922));
    localLayerDrawable = new LayerDrawable(new Drawable[] { this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837921), this.jdField_c_of_type_Lrm });
    this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(localLayerDrawable);
    locallrn.addView(this.jdField_a_of_type_AndroidWidgetImageView, (ViewGroup.LayoutParams)localObject);
    this.jdField_b_of_type_AndroidViewView = locallrn;
  ...
  private boolean a(View paramView, WindowManager.LayoutParams paramLayoutParams, int paramInt1, int paramInt2)
  {
    ...
    paramView.getLocationInWindow(this.jdField_b_of_type_ArrayOfInt);
    Rect localRect1 = new Rect();
    localView.getDrawingRect(localRect1);
  ...
  private boolean a(WindowManager.LayoutParams paramLayoutParams, int paramInt1, int paramInt2, View paramView)
  {
    ...
    for (int i2 = this.jdField_b_of_type_AndroidViewView.getMeasuredHeight();; i2 = i3)
    {
      ...
      if (((paramInt2 - i2 < localRect.top) || (paramInt1 + i1 - paramView.getWidth() > 0)) && (paramInt2 - i2 < localRect.top)) {
        paramLayoutParams.gravity = 51;
      }
      for (boolean bool = false;; bool = true)
      {
        ...
        for (paramLayoutParams.y = (paramInt2 + paramLayoutParams.y);; paramLayoutParams.y = Math.max(paramLayoutParams.y, localRect.top))
        {
          paramLayoutParams.gravity |= 0x10000000;
          if (bool) {
            paramLayoutParams.y = (paramView.getHeight() - paramLayoutParams.y);
          }
