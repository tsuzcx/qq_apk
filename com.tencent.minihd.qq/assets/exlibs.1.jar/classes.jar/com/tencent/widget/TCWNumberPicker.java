  ...
  implements View.OnClickListener, View.OnFocusChangeListener, View.OnLongClickListener
{
  ...
  private final Runnable jdField_a_of_type_JavaLangRunnable = new lsv(this);
  ...
  static
  {
    jdField_a_of_type_ComTencentWidgetTCWNumberPicker$Formatter = new lsu();
  }
  ...
  public TCWNumberPicker(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    setOrientation(1);
    ((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2130903389, this, true);
    this.jdField_a_of_type_AndroidOsHandler = new Handler();
    paramContext = new lsw(this, null);
    this.jdField_a_of_type_AndroidTextInputFilter = new lsx(this, null);
    this.jdField_a_of_type_ComTencentWidgetTCWNumberPickerButton = ((TCWNumberPickerButton)findViewById(2131298073));
    ...
    this.jdField_b_of_type_ComTencentWidgetTCWNumberPickerButton = ((TCWNumberPickerButton)findViewById(2131298075));
    ...
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131298074));
  ...
  public void onClick(View paramView)
  {
    ...
    if (2131298073 == paramView.getId()) {
      a(this.c + 1);
    }
    while (2131298075 != paramView.getId()) {
      return;
    }
    a(this.c - 1);
  }
