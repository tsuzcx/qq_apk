  ...
  implements Filterable, lrr
{
  ...
  public Cursor a(Cursor paramCursor)
  {
    ...
    if (localCursor != null)
    {
      if (this.jdField_a_of_type_Lth != null) {
        localCursor.unregisterContentObserver(this.jdField_a_of_type_Lth);
      }
    ...
    {
      if (this.jdField_a_of_type_Lth != null) {
        paramCursor.registerContentObserver(this.jdField_a_of_type_Lth);
      }
      if (this.jdField_a_of_type_AndroidDatabaseDataSetObserver != null) {
  ...
  void a(Context paramContext, Cursor paramCursor, int paramInt)
  {
    ...
    if ((paramInt & 0x1) == 1)
    {
      ...
      this.jdField_a_of_type_Lth = new lth(this);
    }
    for (this.jdField_a_of_type_AndroidDatabaseDataSetObserver = new lti(this, null);; this.jdField_a_of_type_AndroidDatabaseDataSetObserver = null)
    {
      if (bool)
      {
        if (this.jdField_a_of_type_Lth != null) {
      ...
      break label54;
      label152:
      this.jdField_a_of_type_Lth = null;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Lrq == null) {
      this.jdField_a_of_type_Lrq = new lrq(this);
    }
