  ...
  implements Runnable
{
  ...
  private int jdField_c_of_type_Int = getContext().getResources().getDimensionPixelSize(2131492887);
          ...
          if (localObject != null)
          {
            ...
            if (this.jdField_d_of_type_Int == 0)
            {
              ...
              if ((jdField_a_of_type_Boolean) && (paramBoolean))
              {
                ...
                ((ValueAnimator)localObject).addUpdateListener(new ltj(this, paramInt));
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      ...
      if (jdField_a_of_type_Boolean)
      {
        ...
        localValueAnimator.addUpdateListener(new ltk(this, m));
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      {
        QLog.e(jdField_a_of_type_JavaLangString, 1, "main.getContext: " + ((View)localObject).getContext() + " \n " + localArrayIndexOutOfBoundsException.toString());
        continue;
        c();
        if ((jdField_a_of_type_Boolean) && (this.jdField_d_of_type_Boolean))
        {
      ...
      else if ((this.jdField_d_of_type_Int > 1) && (m == 0))
      {
        this.jdField_b_of_type_AndroidViewView.measure(View.MeasureSpec.makeMeasureSpec(paramInt3 - i1, 1073741824), View.MeasureSpec.makeMeasureSpec(this.jdField_c_of_type_Int, 1073741824));
