  ...
  extends CompoundButton
{
  ...
  {
    this(paramContext, paramAttributeSet, 2130772097);
  }
  ...
  public Switch(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.U, paramInt, 2131558802);
    ...
    setOnClickListener(new lsr(this));
  }
