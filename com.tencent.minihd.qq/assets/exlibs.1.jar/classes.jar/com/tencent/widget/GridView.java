  ...
  extends AbsListView
{
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean1, int paramInt3, boolean paramBoolean2, int paramInt4)
  {
    if (!this.q)
    {
      localView = this.jdField_a_of_type_Lqt.a(paramInt1);
      if (localView != null)
      {
    ...
    for (;;)
    {
      try
      {
        ...
        case 6: 
          ...
          g(this.ay);
          int i3 = this.ao;
          locallqt = this.jdField_a_of_type_Lqt;
          if (bool2)
          {
            m = 0;
            if (m < i2)
            {
              locallqt.a(getChildAt(m), i3 + m);
              m += 1;
              continue;
            }
          }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetListAdapter == null)
      {
        ...
        if (i3 > 0)
        {
          ...
          m = j;
          if (this.jdField_a_of_type_Lqt.a(localLayoutParams1.jdField_a_of_type_Int))
          {
            this.jdField_a_of_type_Lqt.a(localView, -1);
            m = j;
          }
        }
        if (n != 0) {
  ...
  public void setAdapter(ListAdapter paramListAdapter)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetListAdapter != null)
    {
      ...
      this.q = true;
      w();
      this.jdField_a_of_type_Lqj = new lqj(this);
      this.jdField_a_of_type_AndroidWidgetListAdapter.registerDataSetObserver(this.jdField_a_of_type_Lqj);
      this.jdField_a_of_type_Lqt.a(this.jdField_a_of_type_AndroidWidgetListAdapter.getViewTypeCount());
      if (this.jdField_i_of_type_Boolean)
      {
        j = a(this.aA - 1, false);
        g(j);
