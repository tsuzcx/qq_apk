  ...
  implements PageIndicator
{
  ...
  public CirclePageIndicator(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    int i = ((Resources)localObject).getColor(2131427523);
    int j = ((Resources)localObject).getColor(2131427522);
    int k = ((Resources)localObject).getColor(2131427524);
    float f1 = ((Resources)localObject).getDimension(2131493219);
    float f2 = ((Resources)localObject).getDimension(2131493218);
    paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.e, paramInt, 0);
