...
public class jrd
{
  ...
  private jrf jdField_a_of_type_Jrf;
  private volatile long jdField_b_of_type_Long;
  private String jdField_b_of_type_JavaLangString;
  
  public jrd(String paramString, jrf paramjrf)
  {
    paramString = this.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_Jrf = paramjrf;
  }
  
  public static File a()
  {
    if (SystemUtil.a()) {
      return new File(AppConstants.aG + "status_ic");
    }
    return null;
  }
  ...
  public Bitmap a(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (localBitmap == null)
    {
      ...
      if (!this.jdField_a_of_type_JavaUtilHashSet.contains(paramString1))
      {
        ...
        new jre(this, paramString1, paramString2, paramString3).execute((Void[])null);
      }
    }
    return localBitmap;
  }
