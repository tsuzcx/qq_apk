  ...
  extends BaseAdapter
{
  ...
  private jsp(SameStatusActivity paramSameStatusActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramView == null)
      {
        paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqRichstatusSameStatusActivity).inflate(2130904448, null);
        paramView = new SameStatusActivity.ItemViewHolder();
        paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131302232));
        paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131302234));
        paramView.jdField_a_of_type_AndroidViewView = paramViewGroup.findViewById(2131302233);
        paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131302235));
        paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131298102));
        paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131302237));
        paramView.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131302208));
        paramView.d = ((TextView)paramViewGroup.findViewById(2131302214));
      ...
      if ((localItemViewHolder.jdField_a_of_type_PersonalStateUserProfile != paramView) || (SameStatusActivity.a(this.jdField_a_of_type_ComTencentMobileqqRichstatusSameStatusActivity).contains(Long.valueOf(paramView.lEctID))))
      {
        ...
        localItemViewHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841585);
      ...
      for (;;)
      {
        ...
        if (paramView.bSex == 1)
        {
          localItemViewHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841576);
          break;
        }
    ...
    if (paramView == null)
    {
      paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqRichstatusSameStatusActivity.getLayoutInflater().inflate(2130903377, null);
