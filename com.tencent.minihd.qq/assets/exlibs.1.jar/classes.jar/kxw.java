  ...
  extends AutoCompleteTextView
{
  ...
  public kxw(DropdownView paramDropdownView, Context paramContext)
  {
    super(paramContext);
    setId(526);
  ...
  public kxw(DropdownView paramDropdownView, Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public kxw(DropdownView paramDropdownView, Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  public void showDropDown()
  {
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        ((PopupWindow)localObject2).setAnimationStyle(2130968747);
        return;
      }
