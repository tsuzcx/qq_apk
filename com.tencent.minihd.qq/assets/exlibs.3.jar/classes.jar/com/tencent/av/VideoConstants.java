...
public class VideoConstants
{
  ...
  public static String QUA_REPORT_CURRENT;
  public static String QUA_REPORT_EXCEPTION;
  ...
  public static int REQUEST_BY_MOBILE_QQ = 0;
  public static int REQUEST_FROM_QQ_TO_UNQQ = 0;
  public static int REQUEST_FROM_TEMP_CHAT = 0;
  public static int REQUEST_SWITCH_TERMINAL = 0;
  public static int REQUEST_UNQQ = 0;
  ...
  public static String SCORE_BEGINTIME;
  public static String SCORE_BUSINESS_FLAG;
  public static String SCORE_BUSINESS_TYPE;
  public static String SCORE_COMMITED = "qav_commited";
  public static String SCORE_COUNT;
  public static String SCORE_ENDTIME;
  public static String SCORE_IP;
  public static String SCORE_PEER_SDK_VERSION;
  public static String SCORE_SDK_VERSION;
  public static String SCORE_TOUIN;
  ...
  {
    IsQQPaused = false;
    QUA_REPORT_CURRENT = "qua_report_current";
    QUA_REPORT_EXCEPTION = "qua_report_exception";
    NORMAL_REQUEST = 1;
    REQUEST_FROM_QQ_TO_UNQQ = 2;
    REQUEST_SWITCH_TERMINAL = 3;
    REQUEST_UNQQ = 4;
    REQUEST_BY_MOBILE_QQ = 5;
    REQUEST_FROM_TEMP_CHAT = 6;
    SCORE_COUNT = "qav_score_count";
    SCORE_BEGINTIME = "qav_score_begintime";
    SCORE_ENDTIME = "qav_score_endtime";
    SCORE_SDK_VERSION = "qav_sdk_version";
    SCORE_PEER_SDK_VERSION = "qav_peer_sdk_version";
    SCORE_IP = "qav_ip";
    SCORE_BUSINESS_TYPE = "qav_business_type";
    SCORE_BUSINESS_FLAG = "qav_business_flag";
    SCORE_TOUIN = "qav_touin";
  }
  
  public static abstract interface ANYCHAT_VIDEO_STATUS
  {
  ...
  public static abstract interface AVAccostType
  {
  ...
  public static abstract interface AVFunType
  {
  ...
  public static abstract interface AVTerminalType
  {
  ...
  public static abstract interface BIND_TYPE
  {
  ...
  @Deprecated
  public static abstract interface C2C_CALL_TYPE
  {
  ...
  public static abstract interface ColseReason
  {
  ...
  public static abstract interface DESTORY_INVITE_UI_REASEON
  {
  ...
  public static abstract interface EffectsType
  {
  ...
  public static abstract interface GaChatOperationResult
  {
  ...
  public static abstract interface MULTI_VIDEO_CHAT_MEMBERS_INFO_CHANGE_TYPE
  {
  ...
  public static abstract interface Mic_Status
  {
  ...
  public static abstract interface NativeResult
  {
    public static final int FAIL = -1;
  }
  
  public static abstract interface PPT_UPLOAD_STATE
  {
  ...
  @Deprecated
  public static abstract interface PSTN_ENTRY
  {
  ...
  public static abstract interface ProcessExitReason
  {
  ...
  public static class ProcessInfo
    implements VideoConstants.ProcessInfoConstants
  {
    public static String curReason = "0";
  }
  
  public static abstract interface ProcessInfoConstants
  {
  ...
  public static abstract interface RemoteTerminal
  {
  ...
  public static abstract interface emAVFunChatType
  {
  ...
  public static abstract interface emMagicfaceMsg
  {
  ...
  public static abstract interface emRedBagSubType
  {
