...
public abstract class TbsBaseConfig
{
  ...
  public void refreshSyncMap(Context paramContext)
  {
    ...
    //   84: aload 5
    //   86: aload_2
    //   87: invokevirtual 104	java/util/Properties:load	(Ljava/io/InputStream;)V
    //   90: aload_2
    //   91: astore_1
    //   92: aload 5
    //   94: invokevirtual 108	java/util/Properties:stringPropertyNames	()Ljava/util/Set;
    ...
    //   125: checkcast 125	java/lang/String
    //   128: astore_3
    //   129: aload_2
    //   130: astore_1
    //   131: aload_0
    //   132: getfield 48	com/tencent/smtt/sdk/TbsBaseConfig:a	Ljava/util/Map;
    //   135: aload_3
    //   136: aload 5
    //   138: aload_3
    //   139: invokevirtual 129	java/util/Properties:getProperty	(Ljava/lang/String;)Ljava/lang/String;
    //   142: invokeinterface 133 3 0
    //   147: pop
    //   148: goto -44 -> 104
    //   151: astore_3
    //   152: aload_2
    //   153: astore_1
    //   154: aload_3
    //   155: invokevirtual 134	java/lang/Throwable:printStackTrace	()V
    //   158: aload_2
    //   159: ifnull -129 -> 30
    //   162: aload_2
    //   163: invokevirtual 137	java/io/BufferedInputStream:close	()V
    //   166: goto -136 -> 30
    //   169: astore_1
    //   170: aload_1
    //   171: invokevirtual 88	java/lang/Exception:printStackTrace	()V
    //   174: goto -144 -> 30
    //   177: aload_2
    //   178: ifnull -148 -> 30
    //   181: aload_2
    //   182: invokevirtual 137	java/io/BufferedInputStream:close	()V
    //   185: goto -155 -> 30
    //   188: astore_1
    //   189: aload_1
    //   190: invokevirtual 88	java/lang/Exception:printStackTrace	()V
    //   193: goto -163 -> 30
    //   196: astore_2
    //   197: aconst_null
    //   198: astore_1
    ...
    //   200: ifnull +7 -> 207
    //   203: aload_1
    //   204: invokevirtual 137	java/io/BufferedInputStream:close	()V
    //   207: aload_2
    //   208: athrow
    //   209: astore_1
    //   210: aload_1
    //   211: invokevirtual 88	java/lang/Exception:printStackTrace	()V
    //   214: goto -7 -> 207
    //   217: astore_2
    //   218: goto -19 -> 199
    //   221: astore_3
  ...
  public void writeTbsDownloadInfo()
  {
    ...
    //   150	58	7	str	String
    //   128	13	8	localIterator	java.util.Iterator
    // Exception table:
    //   from	to	target	type
