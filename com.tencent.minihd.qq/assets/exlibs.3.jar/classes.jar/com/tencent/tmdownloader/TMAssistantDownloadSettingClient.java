  ...
  extends b
{
  ...
  public boolean isAllDownloadFinished()
  {
    ...
    //   2: ldc 11
    //   4: ldc 55
    //   6: invokestatic 61	com/tencent/tmassistantbase/a/k:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   9: aload_0
    ...
    //   28: ldc 11
    //   30: ldc 65
    //   32: invokestatic 61	com/tencent/tmassistantbase/a/k:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   35: ldc 11
    ...
    //   56: invokestatic 61	com/tencent/tmassistantbase/a/k:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   59: ldc 11
    //   61: ldc 85
    //   63: invokestatic 61	com/tencent/tmassistantbase/a/k:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   66: aload_0
    //   67: monitorexit
    //   68: iload_1
    //   69: ireturn
    ...
    //   75: ldc 11
    //   77: ldc 86
    //   79: invokestatic 61	com/tencent/tmassistantbase/a/k:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   82: iconst_0
    //   83: istore_1
    //   84: goto -49 -> 35
    //   87: astore_2
  ...
  public void setDownloadSDKMaxTaskNum(int paramInt)
  {
    for (;;)
    {
      try
      {
        k.c("TMAssistantDownloadSettingClient", "enter");
        k.c("TMAssistantDownloadSettingClient", "maxTaskNum: " + paramInt);
        if ((paramInt < 1) || (paramInt > 10))
        {
          k.c("TMAssistantDownloadSettingClient", "maxTaskNum < 1 || maxTaskNum > 10");
          k.c("TMAssistantDownloadSettingClient", "exit");
          return;
        }
        ...
        {
          locald.a(paramInt);
          k.c("TMAssistantDownloadSettingClient", "setServiceSetingMaxTaskNum");
          k.c("TMAssistantDownloadSettingClient", "exit");
          continue;
        }
      ...
      k.c("TMAssistantDownloadSettingClient", "initTMAssistantDownloadSDK");
    }
  }
  ...
  public void setDownloadSDKWifiOnly(boolean paramBoolean)
  {
    ...
    //   30: invokestatic 61	com/tencent/tmassistantbase/a/k:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   33: aload_0
    ...
    //   74: ldc 11
    //   76: ldc 86
    //   78: invokestatic 61	com/tencent/tmassistantbase/a/k:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   81: goto -22 -> 59
    //   84: astore_2
    //   85: aload_0
    //   86: monitorexit
