  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (CommonDataAdapter.a().a() != null)
    {
      ...
      ((TextView)localObject2).setBackgroundColor(CommonDataAdapter.a().a().getResources().getColor(2131427375));
      ((TextView)localObject2).setText(2131362597);
      ((TextView)localObject2).setTextColor(CommonDataAdapter.a().a().getResources().getColor(2131427405));
