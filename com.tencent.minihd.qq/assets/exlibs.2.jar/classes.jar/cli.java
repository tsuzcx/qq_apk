...
public class cli
  extends Thread
{
  public cli(CodeMaskManager paramCodeMaskManager, SharedPreferences paramSharedPreferences, int paramInt1, int paramInt2, int paramInt3) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      if (((JSONObject)localObject).getInt("r") == 0)
      {
        ...
        {
          this.jdField_a_of_type_ComTencentBizQrcodeCodeMaskManager.jdField_a_of_type_AndroidOsHandler.post(new clj(this, (JSONArray)localObject));
