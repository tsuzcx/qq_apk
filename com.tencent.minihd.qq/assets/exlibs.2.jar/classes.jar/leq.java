...
public class leq
  implements Runnable
{
  public leq(WebAppActivity paramWebAppActivity, String paramString1, String paramString2, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    try
    {
      localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentOpenApplistWebAppActivity.getResources(), 2130838653);
