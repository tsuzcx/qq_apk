...
{
  public lav(BindGroupConfirmActivity paramBindGroupConfirmActivity) {}
    ...
    try
    {
      if (paramJSONObject.getInt("ret") == 0)
      {
        if (this.a.jdField_a_of_type_ComTencentBizWidgetsShareAioResultDialog == null)
        {
          ...
          this.a.jdField_a_of_type_ComTencentBizWidgetsShareAioResultDialog.a(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131362708));
          this.a.jdField_a_of_type_ComTencentBizWidgetsShareAioResultDialog.a(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131362709, new Object[] { this.a.i }), this.a);
      ...
      if ((paramJSONObject.getInt("ret") == 10071) || (paramJSONObject.getInt("ret") == 10000))
      {
        if (this.a.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog == null) {
          this.a.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this.a, 230, this.a.jdField_a_of_type_AndroidContentResResources.getString(2131362705), this.a.jdField_a_of_type_AndroidContentResResources.getString(2131362706), 2131367454, 2131365737, this.a, null);
        }
