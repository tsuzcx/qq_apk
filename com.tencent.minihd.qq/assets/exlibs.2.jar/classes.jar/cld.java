...
{
  public cld(AppInterface paramAppInterface, Context paramContext, String paramString) {}
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBundle != null)
        {
          ...
          if (paramInt == 58)
          {
            PublicAccountUtil.a(this.jdField_a_of_type_AndroidContentContext, 2131363621);
            return;
          }
