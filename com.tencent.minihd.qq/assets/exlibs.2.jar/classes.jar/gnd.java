...
class gnd
  implements Runnable
{
  gnd(gnc paramgnc, long paramLong, List paramList) {}
  
  public void run()
  {
    TroopManager localTroopManager = (TroopManager)this.jdField_a_of_type_Gnc.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(50);
    if (localTroopManager.a(String.valueOf(this.jdField_a_of_type_Long))) {}
    TroopInfo localTroopInfo;
    do
    {
      return;
      localTroopInfo = localTroopManager.b(this.jdField_a_of_type_Gnc.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
    ...
    TroopFloatChatPie.a(this.jdField_a_of_type_Gnc.a).removeMessages(1);
    TroopFloatChatPie.a(this.jdField_a_of_type_Gnc.a).sendEmptyMessage(1);
  }
}
