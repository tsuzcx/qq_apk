...
{
  public fkc(TroopRequestActivity paramTroopRequestActivity, TextView paramTextView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (!NetworkUtil.e(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity)) {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity, this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity.getString(2131365941), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity.getTitleBarHeight());
    }
    String str2;
    label386:
    label593:
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  TroopRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity).b(2131366988);
      ...
      for (;;)
      {
        if (((TroopRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity).msg.group_msg_type.get() == 11) && (TroopRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity).msg.sub_type.get() == 3)) || (TroopRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity).msg.group_msg_type.get() == 7))
        {
          ...
          try
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity.d();
    ...
    if ((paramView.size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity.p.length() > 0)) {
      ((TroopHandler)this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity.app.a(19)).a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity.p, paramView, "");
    }
