...
public final class lfb
  implements Runnable
{
  public lfb(String paramString1, int paramInt, Context paramContext, String paramString2, WebView paramWebView, String paramString3) {}
      ...
      try
      {
        ...
        else
        {
          ...
          catch (PackageManager.NameNotFoundException localNameNotFoundException2)
          {
            ...
            new HttpCgiAsyncTask("https://fusionbase.qq.com/cgi-bin/appstage/sdk_update", "POST", new AppReport.IncrementalReportCallback(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, j, this.b, this.jdField_a_of_type_ComTencentSmttSdkWebView)).execute(new Bundle[] { localObject2 });
            return;
            AppReport.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, j);
            return;
            new HttpCgiAsyncTask("https://fusionbase.qq.com/cgi-bin/appstage/sdk_update", "POST", new AppReport.IncrementalReportCallback(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, j, this.b, this.jdField_a_of_type_ComTencentSmttSdkWebView)).execute(new Bundle[] { localObject2 });
