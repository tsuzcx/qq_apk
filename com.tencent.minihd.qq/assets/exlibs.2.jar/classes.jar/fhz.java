...
{
  public fhz(TroopMemberCardActivity paramTroopMemberCardActivity, CheckBox paramCheckBox, Dialog paramDialog) {}
  ...
  public void onClick(View paramView)
  {
    ...
    paramView = "";
    if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.t == 3)
    {
      paramView = "0";
    ...
    for (String str = "0";; str = "1")
    {
      ...
      return;
      if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.t != 2) {
        break;
      }
      paramView = "1";
      break;
