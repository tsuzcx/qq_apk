...
import com.tencent.mobileqq.activity.flaotaio.FloatPttItemBuilder;
...
public class gmq
  implements Runnable
{
  public gmq(FloatPttItemBuilder paramFloatPttItemBuilder, MessageForPtt paramMessageForPtt) {}
  ...
  public void run()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityFlaotaioFloatPttItemBuilder.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(this.jdField_a_of_type_ComTencentMobileqqActivityFlaotaioFloatPttItemBuilder.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataMessageForPtt.istroop, this.jdField_a_of_type_ComTencentMobileqqDataMessageForPtt.url, this.jdField_a_of_type_ComTencentMobileqqDataMessageForPtt.uniseq);
      return;
    }
    TransferRequest localTransferRequest = new TransferRequest();
    localTransferRequest.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqActivityFlaotaioFloatPttItemBuilder.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount();
    localTransferRequest.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqActivityFlaotaioFloatPttItemBuilder.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityFlaotaioFloatPttItemBuilder.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localTransferRequest);
  }
}
