...
public class fgl
  extends BaseAdapter
{
  public fgl(TroopClassChoiceActivity paramTroopClassChoiceActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramViewGroup = this.a.getLayoutInflater().inflate(2130904487, null);
    }
    TextView localTextView1 = (TextView)paramViewGroup.findViewById(2131302324);
    TextView localTextView2 = (TextView)paramViewGroup.findViewById(2131302326);
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131302325);
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      if (paramInt != 0)
      {
        ...
        localTextView2.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130842098, 0);
      }
      for (;;)
      {
