...
{
  public lcn(SwitchAccountActivity paramSwitchAccountActivity) {}
  ...
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if (paramInt2 == -1000) {
        this.a.a.a(this.a, this.a.getResources().getString(2131368093));
      }
      for (;;)
      {
        paramInt1 = paramBundle.getInt("code");
        ...
        else
        {
          ...
          {
            localObject3 = this.a.getString(2131367285);
          }
