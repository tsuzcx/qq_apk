...
{
  private efh(JoinDiscussionActivity paramJoinDiscussionActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, RespGetDiscussInfo paramRespGetDiscussInfo)
  {
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((FriendsManager)this.a.app.getManager(49)).a(((DiscussionMemberInfo)localObject1).memberUin);
      ...
      if (this.a.jdField_a_of_type_JavaUtilArrayList.size() == this.a.jdField_c_of_type_Int)
      {
        ...
        this.a.runOnUiThread(new efi(this, paramRespGetDiscussInfo));
      }
      this.a.runOnUiThread(new efj(this));
      return;
    }
    this.a.a(0, paramInt);
  }
