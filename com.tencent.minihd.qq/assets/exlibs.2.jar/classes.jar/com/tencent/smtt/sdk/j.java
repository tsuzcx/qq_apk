  ...
  extends X5ProxyWebViewClient
{
  ...
  public j(IX5WebViewClient paramIX5WebViewClient, WebView paramWebView, WebViewClient paramWebViewClient)
  {
    ...
    try
    {
      ...
      if ((!TbsShareManager.mHasQueryed) && (this.b.getContext() != null) && (TbsShareManager.isThirdPartyApp(this.b.getContext())))
      {
        ...
        new Thread(new Runnable()
        {
          public void run()
          {
            if ((!TbsShareManager.forceLoadX5FromTBSDemo(j.a(j.this).getContext())) && (TbsDownloader.needDownload(j.a(j.this).getContext(), false))) {
