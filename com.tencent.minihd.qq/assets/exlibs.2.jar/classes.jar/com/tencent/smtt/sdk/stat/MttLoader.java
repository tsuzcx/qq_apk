...
public class MttLoader
{
  ...
  public static int loadUrl(Context paramContext, String paramString1, HashMap<String, String> paramHashMap, String paramString2, WebView paramWebView)
  {
    ...
    if (i != 0)
    {
      ...
      localStringBuilder.append("mttbrowser://url=").append(paramString1).append(",product=").append("TBS").append(",packagename=").append(paramContext.getPackageName()).append(",from=").append(paramString2).append(",version=").append("4.3.0.185").append((String)localObject);
  ...
  public static boolean verifySignature(File paramFile)
  {
    ...
    //   5: aconst_null
    //   6: astore 5
    //   8: new 549	java/util/jar/JarFile
    //   11: dup
    //   12: aload_0
    //   13: invokespecial 552	java/util/jar/JarFile:<init>	(Ljava/io/File;)V
    //   16: astore_0
    //   17: aload 4
    //   19: astore_3
    //   20: aload_0
    //   21: ldc_w 554
    //   24: invokevirtual 558	java/util/jar/JarFile:getJarEntry	(Ljava/lang/String;)Ljava/util/jar/JarEntry;
    //   27: astore 5
    //   29: aload 5
    //   31: ifnonnull +25 -> 56
    //   34: iconst_0
    //   35: ifeq +11 -> 46
    //   38: new 560	java/lang/NullPointerException
    //   41: dup
    //   42: invokespecial 561	java/lang/NullPointerException:<init>	()V
    //   45: athrow
    //   46: aload_0
    //   47: ifnull +7 -> 54
    //   50: aload_0
    //   51: invokevirtual 564	java/util/jar/JarFile:close	()V
    //   54: iconst_0
    //   55: ireturn
    //   56: aload 4
    //   58: astore_3
    ...
    //   69: aload_0
    //   70: aload 5
    //   72: invokevirtual 568	java/util/jar/JarFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   75: astore 4
    //   77: aload 4
    //   79: astore_3
    //   80: aload 4
    ...
    //   85: aload 6
    //   87: arraylength
    //   88: invokevirtual 574	java/io/InputStream:read	([BII)I
    //   91: iconst_m1
    //   92: if_icmpne -15 -> 77
    //   95: aload 4
    //   97: astore_3
    //   98: aload 4
    //   100: invokevirtual 575	java/io/InputStream:close	()V
    //   103: aload 4
    //   105: astore_3
    //   106: aload 5
    //   108: invokevirtual 581	java/util/jar/JarEntry:getCertificates	()[Ljava/security/cert/Certificate;
    //   111: astore 5
    //   113: aload 4
    //   115: astore_3
    //   116: aload 5
    ...
    //   127: ifnull +8 -> 135
    //   130: aload 4
    //   132: invokevirtual 575	java/io/InputStream:close	()V
    //   135: aload_0
    //   136: ifnull -82 -> 54
    //   139: aload_0
    //   140: invokevirtual 564	java/util/jar/JarFile:close	()V
    //   143: iconst_0
    //   144: ireturn
    //   145: astore_0
    //   146: iconst_0
    ...
    //   153: iconst_0
    //   154: aaload
    //   155: invokestatic 583	com/tencent/smtt/sdk/stat/MttLoader:a	(Ljava/security/cert/Certificate;)Ljava/lang/String;
    //   158: astore 5
    //   160: aload 5
    //   162: ifnull +39 -> 201
    //   165: aload 4
    ...
    //   183: ifnull +8 -> 191
    //   186: aload 4
    //   188: invokevirtual 575	java/io/InputStream:close	()V
    //   191: aload_0
    //   192: ifnull +7 -> 199
    //   195: aload_0
    //   196: invokevirtual 564	java/util/jar/JarFile:close	()V
    //   199: iconst_1
    //   200: ireturn
    //   201: aload 4
    //   203: ifnull +8 -> 211
    //   206: aload 4
    //   208: invokevirtual 575	java/io/InputStream:close	()V
    //   211: aload_0
    //   212: ifnull -158 -> 54
    //   215: aload_0
    //   216: invokevirtual 564	java/util/jar/JarFile:close	()V
    //   219: iconst_0
    //   220: ireturn
    //   221: astore_0
    //   222: iconst_0
    ...
    //   231: ifnull +7 -> 238
    //   234: aload_0
    //   235: invokevirtual 575	java/io/InputStream:close	()V
    //   238: aload_3
    //   239: ifnull -185 -> 54
    //   242: aload_3
    //   243: invokevirtual 564	java/util/jar/JarFile:close	()V
    //   246: iconst_0
    //   247: ireturn
    //   248: astore_0
    //   249: iconst_0
    ...
    //   256: ifnull +7 -> 263
    //   259: aload_3
    //   260: invokevirtual 575	java/io/InputStream:close	()V
    //   263: aload_0
    //   264: ifnull +7 -> 271
    //   267: aload_0
    //   268: invokevirtual 564	java/util/jar/JarFile:close	()V
    //   271: aload 4
    //   273: athrow
    //   274: astore_3
    //   275: goto -229 -> 46
