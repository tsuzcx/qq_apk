  ...
  extends Dialog
{
  ...
  public void b()
  {
    ...
    this.h.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        Object localObject = d.a(d.this).a();
        paramAnonymousView = d.a(d.this).a((b)localObject);
        d.a(d.this, "userClickAlwaysEvent:");
        if (localObject == null) {
          return;
        }
        ...
        if (!((b)localObject).e())
        {
          ...
          {
            d.a(d.this, (b)localObject);
            d.this.dismiss();
            return;
          }
          localObject = d.b(d.this);
          localContext = d.this.getContext();
          paramAnonymousView = paramAnonymousView.activityInfo.packageName;
          ((Intent)localObject).setPackage(paramAnonymousView);
          if ("com.tencent.mtt".equals(paramAnonymousView))
          {
            ((Intent)localObject).putExtra("ChannelID", localContext.getApplicationContext().getPackageName());
            ((Intent)localObject).putExtra("PosID", "4");
          }
          ...
          if (!TextUtils.isEmpty(d.c(d.this))) {
            ((Intent)localObject).putExtra("big_brother_source_key", d.c(d.this));
          }
        }
        for (;;)
        {
          ...
          paramAnonymousView = localException.g();
          if (d.a.get() != null) {
            ((ValueCallback)d.a.get()).onReceiveValue("extraMenuEvent:" + paramAnonymousView);
          }
          d.this.a("extraMenuEvent:" + paramAnonymousView);
        }
      }
    });
    this.i.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        ...
        for (;;)
        {
          ...
          if ((d.d(d.this)) && (d.a.get() != null)) {
            ((ValueCallback)d.a.get()).onReceiveValue("extraMenuEvent:" + ((b)localObject).g());
          }
        }
      }
    });
