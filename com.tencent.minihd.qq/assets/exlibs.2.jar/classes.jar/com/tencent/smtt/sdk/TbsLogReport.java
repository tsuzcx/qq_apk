...
public class TbsLogReport
{
  ...
  private void a(int paramInt, TbsLogInfo paramTbsLogInfo)
  {
    ...
    do
    {
      ...
      localStringBuilder.append(a("4.3.0.185_44085"));
  ...
  private void b()
  {
    ...
    try
    {
      localObject = f.a(n.a(this.c).c(), ((JSONArray)localObject).toString().getBytes("utf-8"), new f.a()
      {
  ...
  public void reportTbsLog()
  {
    ...
    //   0: aconst_null
    //   1: astore 8
    //   3: getstatic 156	com/tencent/smtt/sdk/QbSdk:o	Ljava/util/Map;
    //   6: ifnull +43 -> 49
    //   9: getstatic 156	com/tencent/smtt/sdk/QbSdk:o	Ljava/util/Map;
    //   12: ldc 158
    //   14: invokeinterface 164 2 0
    //   19: ifeq +30 -> 49
    //   22: getstatic 156	com/tencent/smtt/sdk/QbSdk:o	Ljava/util/Map;
    //   25: ldc 158
    //   27: invokeinterface 167 2 0
    //   32: ldc 169
    //   34: invokevirtual 172	java/lang/Object:equals	(Ljava/lang/Object;)Z
    //   37: ifeq +12 -> 49
    //   40: ldc 174
    //   42: ldc_w 462
    //   45: invokestatic 182	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   48: return
    //   49: aload_0
    //   50: getfield 43	com/tencent/smtt/sdk/TbsLogReport:c	Landroid/content/Context;
    //   53: invokestatic 467	com/tencent/smtt/utils/Apn:getApnType	(Landroid/content/Context;)I
    //   56: iconst_3
    //   57: if_icmpne -9 -> 48
    //   60: invokestatic 470	com/tencent/smtt/utils/TbsLog:getTbsLogFilePath	()Ljava/lang/String;
    //   63: astore 6
    //   65: aload 6
    //   67: ifnull -19 -> 48
    //   70: invokestatic 475	com/tencent/smtt/utils/g:a	()Lcom/tencent/smtt/utils/g;
    //   73: invokevirtual 477	com/tencent/smtt/utils/g:b	()Ljava/lang/String;
    //   76: astore 9
    //   78: ldc 106
    //   80: astore_2
    //   81: aload_0
    //   82: getfield 43	com/tencent/smtt/sdk/TbsLogReport:c	Landroid/content/Context;
    //   85: invokestatic 480	com/tencent/smtt/utils/b:g	(Landroid/content/Context;)Z
    //   88: ifeq +11 -> 99
    //   91: aload_0
    //   92: getfield 43	com/tencent/smtt/sdk/TbsLogReport:c	Landroid/content/Context;
    //   95: invokestatic 482	com/tencent/smtt/utils/b:h	(Landroid/content/Context;)Ljava/lang/String;
    //   98: astore_2
    //   99: aload_0
    //   100: getfield 43	com/tencent/smtt/sdk/TbsLogReport:c	Landroid/content/Context;
    //   103: invokestatic 297	com/tencent/smtt/utils/b:k	(Landroid/content/Context;)Ljava/lang/String;
    //   106: astore 4
    //   108: aload_2
    //   109: invokevirtual 312	java/lang/String:getBytes	()[B
    //   112: astore_3
    //   113: aload 4
    //   115: invokevirtual 312	java/lang/String:getBytes	()[B
    //   118: astore 4
    //   120: aload_3
    //   121: astore_2
    //   122: invokestatic 475	com/tencent/smtt/utils/g:a	()Lcom/tencent/smtt/utils/g;
    //   125: aload_3
    //   126: invokevirtual 485	com/tencent/smtt/utils/g:a	([B)[B
    //   129: astore_3
    //   130: aload_3
    //   131: astore_2
    //   132: invokestatic 475	com/tencent/smtt/utils/g:a	()Lcom/tencent/smtt/utils/g;
    //   135: aload 4
    //   137: invokevirtual 485	com/tencent/smtt/utils/g:a	([B)[B
    //   140: astore 5
    //   142: aload 5
    //   144: astore_2
    //   145: aload_3
    ...
    //   149: astore_3
    //   150: aload 4
    //   152: invokestatic 488	com/tencent/smtt/utils/g:b	([B)Ljava/lang/String;
    //   155: astore_2
    //   156: aload_3
    //   157: invokestatic 488	com/tencent/smtt/utils/g:b	([B)Ljava/lang/String;
    //   160: astore_3
    //   161: new 64	java/lang/StringBuilder
    //   164: dup
    //   165: invokespecial 65	java/lang/StringBuilder:<init>	()V
    //   168: aload_0
    //   169: getfield 43	com/tencent/smtt/sdk/TbsLogReport:c	Landroid/content/Context;
    //   172: invokestatic 384	com/tencent/smtt/utils/n:a	(Landroid/content/Context;)Lcom/tencent/smtt/utils/n;
    //   175: invokevirtual 490	com/tencent/smtt/utils/n:h	()Ljava/lang/String;
    ...
    //   198: astore 10
    //   200: new 494	java/util/HashMap
    //   203: dup
    //   204: invokespecial 495	java/util/HashMap:<init>	()V
    //   207: astore 11
    //   209: aload 11
    //   211: ldc_w 497
    //   214: ldc_w 499
    //   217: invokeinterface 502 3 0
    //   222: pop
    //   223: aload 11
    //   225: ldc_w 504
    //   228: ldc 206
    //   230: invokeinterface 502 3 0
    //   235: pop
    //   236: aload 11
    //   238: ldc_w 506
    //   241: aload_0
    //   242: getfield 43	com/tencent/smtt/sdk/TbsLogReport:c	Landroid/content/Context;
    //   245: invokestatic 191	com/tencent/smtt/utils/k:a	(Landroid/content/Context;)Ljava/lang/String;
    //   248: invokeinterface 502 3 0
    //   253: pop
    //   254: new 508	java/io/File
    //   257: dup
    //   258: getstatic 513	com/tencent/smtt/utils/FileUtil:a	Ljava/lang/String;
    //   261: invokespecial 514	java/io/File:<init>	(Ljava/lang/String;)V
    //   264: pop
    //   265: new 18	com/tencent/smtt/sdk/TbsLogReport$a
    //   268: dup
    //   269: aload 6
    //   271: new 64	java/lang/StringBuilder
    //   274: dup
    //   275: invokespecial 65	java/lang/StringBuilder:<init>	()V
    //   278: getstatic 513	com/tencent/smtt/utils/FileUtil:a	Ljava/lang/String;
    ...
    //   293: invokespecial 518	com/tencent/smtt/sdk/TbsLogReport$a:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   296: invokevirtual 520	com/tencent/smtt/sdk/TbsLogReport$a:a	()V
    //   299: new 508	java/io/File
    //   302: dup
    //   303: getstatic 513	com/tencent/smtt/utils/FileUtil:a	Ljava/lang/String;
    //   306: ldc_w 522
    //   309: invokespecial 523	java/io/File:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   312: astore 5
    //   314: new 525	java/io/FileInputStream
    //   317: dup
    //   318: aload 5
    //   320: invokespecial 528	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   323: astore 4
    //   325: sipush 8192
    //   328: newarray byte
    //   330: astore_3
    //   331: new 530	java/io/ByteArrayOutputStream
    //   334: dup
    //   335: invokespecial 531	java/io/ByteArrayOutputStream:<init>	()V
    //   338: astore_2
    //   339: aload_2
    //   340: astore 8
    //   342: aload 5
    ...
    //   350: aload 4
    //   352: aload_3
    //   353: invokevirtual 535	java/io/FileInputStream:read	([B)I
    //   356: istore_1
    //   357: iload_1
    //   358: iconst_m1
    ...
    //   375: iconst_0
    //   376: iload_1
    //   377: invokevirtual 539	java/io/ByteArrayOutputStream:write	([BII)V
    //   380: goto -41 -> 339
    //   383: astore_3
    //   384: aload_2
    //   385: astore 8
    ...
    //   393: astore 6
    //   395: aload_3
    //   396: invokevirtual 540	java/lang/Exception:printStackTrace	()V
    //   399: aload 4
    //   401: ifnull +8 -> 409
    //   404: aload 4
    //   406: invokevirtual 543	java/io/FileInputStream:close	()V
    //   409: aload_2
    //   410: ifnull +7 -> 417
    //   413: aload_2
    //   414: invokevirtual 544	java/io/ByteArrayOutputStream:close	()V
    //   417: aload 5
    //   419: ifnull +250 -> 669
    //   422: aload 5
    //   424: invokevirtual 547	java/io/File:delete	()Z
    //   427: pop
    //   428: aconst_null
    //   429: astore_2
    //   430: new 64	java/lang/StringBuilder
    //   433: dup
    //   434: invokespecial 65	java/lang/StringBuilder:<init>	()V
    //   437: aload 10
    //   439: invokevirtual 74	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   442: ldc_w 549
    //   445: invokevirtual 74	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   448: aload 9
    ...
    //   456: aload 11
    //   458: aload_2
    //   459: new 8	com/tencent/smtt/sdk/TbsLogReport$2
    //   462: dup
    //   463: aload_0
    ...
    //   495: aload 4
    //   497: astore 6
    //   499: invokestatic 475	com/tencent/smtt/utils/g:a	()Lcom/tencent/smtt/utils/g;
    //   502: aload_2
    //   503: invokevirtual 559	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   506: invokevirtual 485	com/tencent/smtt/utils/g:a	([B)[B
    //   509: astore_3
    //   510: aload 4
    //   512: ifnull +8 -> 520
    //   515: aload 4
    //   517: invokevirtual 543	java/io/FileInputStream:close	()V
    //   520: aload_2
    //   521: ifnull +7 -> 528
    //   524: aload_2
    //   525: invokevirtual 544	java/io/ByteArrayOutputStream:close	()V
    //   528: aload_3
    //   529: astore_2
    //   530: aload 5
    //   532: ifnull -102 -> 430
    //   535: aload 5
    //   537: invokevirtual 547	java/io/File:delete	()Z
    //   540: pop
    //   541: aload_3
    //   542: astore_2
    //   543: goto -113 -> 430
    ...
    //   553: ifnull +7 -> 560
    //   556: aload_3
    //   557: invokevirtual 543	java/io/FileInputStream:close	()V
    //   560: aload 8
    //   562: ifnull +8 -> 570
    //   565: aload 8
    //   567: invokevirtual 544	java/io/ByteArrayOutputStream:close	()V
    //   570: aload 5
    //   572: ifnull +9 -> 581
    //   575: aload 5
    //   577: invokevirtual 547	java/io/File:delete	()Z
    //   580: pop
    //   581: aload_2
    //   582: athrow
    //   583: astore 4
