...
public class e
{
  ...
  static
  {
    ...
    String[] arrayOfString2 = { ".conf", "text/plain" };
    String[] arrayOfString3 = { ".doc", "application/msword" };
    String[] arrayOfString4 = { ".docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document" };
    String[] arrayOfString5 = { ".xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" };
    String[] arrayOfString6 = { ".exe", "application/octet-stream" };
    String[] arrayOfString7 = { ".m3u", "audio/x-mpegurl" };
    String[] arrayOfString8 = { ".m4a", "audio/mp4a-latm" };
    String[] arrayOfString9 = { ".m4v", "video/x-m4v" };
    String[] arrayOfString10 = { ".rc", "text/plain" };
    String[] arrayOfString11 = { ".xml", "text/plain" };
    String[] arrayOfString12 = { ".z", "application/x-compress" };
    a = new String[][] { { ".3gp", "video/3gpp" }, arrayOfString1, { ".asf", "video/x-ms-asf" }, { ".avi", "video/x-msvideo" }, { ".bin", "application/octet-stream" }, { ".bmp", "image/bmp" }, { ".c", "text/plain" }, { ".class", "application/octet-stream" }, arrayOfString2, { ".cpp", "text/plain" }, arrayOfString3, arrayOfString4, { ".xls", "application/vnd.ms-excel" }, arrayOfString5, arrayOfString6, { ".gif", "image/gif" }, { ".gtar", "application/x-gtar" }, { ".gz", "application/x-gzip" }, { ".h", "text/plain" }, { ".htm", "text/html" }, { ".html", "text/html" }, { ".jar", "application/java-archive" }, { ".java", "text/plain" }, { ".jpeg", "image/jpeg" }, { ".jpg", "image/jpeg" }, { ".js", "application/x-javascript" }, { ".log", "text/plain" }, arrayOfString7, arrayOfString8, { ".m4b", "audio/mp4a-latm" }, { ".m4p", "audio/mp4a-latm" }, { ".m4u", "video/vnd.mpegurl" }, arrayOfString9, { ".mov", "video/quicktime" }, { ".mp2", "audio/x-mpeg" }, { ".mp3", "audio/x-mpeg" }, { ".mp4", "video/mp4" }, { ".mpc", "application/vnd.mpohun.certificate" }, { ".mpe", "video/mpeg" }, { ".mpeg", "video/mpeg" }, { ".mpg", "video/mpeg" }, { ".mpg4", "video/mp4" }, { ".mpga", "audio/mpeg" }, { ".msg", "application/vnd.ms-outlook" }, { ".ogg", "audio/ogg" }, { ".pdf", "application/pdf" }, { ".png", "image/png" }, { ".pps", "application/vnd.ms-powerpoint" }, { ".ppt", "application/vnd.ms-powerpoint" }, { ".pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation" }, { ".prop", "text/plain" }, arrayOfString10, { ".rmvb", "audio/x-pn-realaudio" }, { ".rtf", "application/rtf" }, { ".sh", "text/plain" }, { ".tar", "application/x-tar" }, { ".tgz", "application/x-compressed" }, { ".txt", "text/plain" }, { ".wav", "audio/x-wav" }, { ".wma", "audio/x-ms-wma" }, { ".wmv", "audio/x-ms-wmv" }, { ".wps", "application/vnd.ms-works" }, arrayOfString11, arrayOfString12, { ".zip", "application/zip" }, { ".7z", "application/7z" }, { "", "*/*" } };
  }
  
  public static Drawable a(String paramString)
  {
    if ("application_icon".equals(paramString)) {
      return new BitmapDrawable(c(b));
    }
    if ("x5_tbs_activity_picker_check".equals(paramString)) {
      return new BitmapDrawable(c(c));
    }
    return null;
  }
  ...
  public static String d(String paramString)
  {
    ...
    for (String str1 = a[i][1];; str1 = "*/*")
    {
      ...
      if (paramString == null)
      {
        ...
        paramString.put("3gp", "video/3gpp");
        paramString.put("chm", "text/plain");
        paramString.put("ape", "audio/x-ape");
        str1 = (String)paramString.get(str2.toLowerCase());
      }
      return str1;
      i += 1;
      break;
 ...
 * Qualified Name:     com.tencent.smtt.sdk.ui.dialog.e
