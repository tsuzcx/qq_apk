...
public class ReportManager
{
  ...
  protected static final String c = "https://analy.qq.com/cgi-bin/mapp_apptrace";
  ...
  protected String a()
  {
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      this.jdField_b_of_type_JavaLangString = "https://analy.qq.com/cgi-bin/mapp_apptrace";
    }
  ...
  protected void a()
  {
    ...
    if (a(str)) {
      ThreadManager.a(new lfg(this, str));
    }
  }
  ...
  {
    ThreadManager.a(new lff(this, paramBoolean, paramBatchReportInfo, paramBundle, paramString));
  }
