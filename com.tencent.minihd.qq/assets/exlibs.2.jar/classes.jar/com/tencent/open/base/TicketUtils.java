...
public class TicketUtils
{
  ...
  public TicketUtils()
  {
    this.jdField_a_of_type_MqqObserverSSOAccountObserver = new let(this);
  }
  ...
  public byte[] a(android.content.Context paramContext, long paramLong1, long paramLong2)
  {
    ...
    //   350: ifnull +9 -> 359
    //   353: aload_1
    //   354: invokeinterface 194 1 0
    //   359: ldc 196
    //   361: invokestatic 191	oicq/wlogin_sdk/tools/util:string_to_buf	(Ljava/lang/String;)[B
    //   364: areturn
    //   365: astore 7
    //   367: aconst_null
    //   368: astore_1
    ...
    //   372: ldc 8
    //   374: aload 7
    //   376: invokevirtual 199	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   379: aload 7
    //   381: invokestatic 205	com/tencent/open/base/LogUtility:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   384: aload_1
    //   385: ifnull -26 -> 359
    //   388: aload_1
    //   389: invokeinterface 194 1 0
    //   394: goto -35 -> 359
    //   397: astore_1
    //   398: aload 6
    //   400: ifnull +10 -> 410
    //   403: aload 6
    //   405: invokeinterface 194 1 0
    //   410: aload_1
    //   411: athrow
    //   412: astore_1
    //   413: goto -15 -> 398
