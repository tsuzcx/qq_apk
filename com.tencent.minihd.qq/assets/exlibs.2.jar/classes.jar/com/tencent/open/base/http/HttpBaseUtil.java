...
public class HttpBaseUtil
{
  ...
  public static HttpBaseUtil.HttpResponseBean a(String paramString1, String paramString2, Bundle paramBundle, HttpContext paramHttpContext)
  {
    ...
    if (CommonDataAdapter.a().a() != null)
    {
      localObject1 = (ConnectivityManager)CommonDataAdapter.a().a().getSystemService("connectivity");
  ...
  protected static HttpBaseUtil.Statistic a(String paramString1, String paramString2, Bundle paramBundle, int paramInt)
  {
    ...
    String str3 = paramBundle.getString("LastModifyUseString");
    ...
    else
    {
      ...
      {
        str3 = a(str7, paramBundle);
        LogUtility.c(jdField_a_of_type_JavaLangString, "url2=" + str3);
      }
      if (j != 200) {
        break label377;
      }
      ...
      HttpCacheService.a().a(str3, str1, l1, paramString1, (String)localObject);
      paramInt = 1;
    }
    label547:
    for (;;)
    {
      ...
      if ((j == 304) && (str1 != null))
      {
        paramString1 = HttpCacheService.a().c(str3);
  ...
  public static String a(HttpResponse paramHttpResponse)
  {
    ...
    //   9: astore 8
    //   11: aload_0
    //   12: invokeinterface 496 1 0
    //   17: astore 5
    //   19: aload_0
    //   20: ldc_w 586
    //   23: invokeinterface 473 2 0
    //   28: ifeq +47 -> 75
    //   31: aload_0
    //   32: ldc_w 586
    //   35: invokeinterface 477 2 0
    //   40: invokeinterface 482 1 0
    //   45: invokestatic 510	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   48: lstore_3
    //   49: getstatic 37	com/tencent/open/base/http/HttpBaseUtil:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   52: new 179	java/lang/StringBuilder
    //   55: dup
    //   56: invokespecial 180	java/lang/StringBuilder:<init>	()V
    //   59: ldc_w 588
    //   62: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   65: lload_3
    //   66: invokevirtual 244	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   69: invokevirtual 187	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   72: invokestatic 252	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   75: aload 5
    //   77: invokeinterface 502 1 0
    //   82: astore 5
    //   84: aload_0
    //   85: ldc_w 590
    //   88: invokeinterface 477 2 0
    //   93: astore 6
    //   95: aload 6
    //   97: ifnull +72 -> 169
    //   100: aload 6
    //   102: invokeinterface 482 1 0
    //   107: invokevirtual 593	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   110: ldc 194
    //   112: invokevirtual 177	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   115: iconst_m1
    //   116: if_icmple +53 -> 169
    //   119: new 595	java/util/zip/GZIPInputStream
    //   122: dup
    //   123: aload 5
    //   125: invokespecial 596	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   128: astore 6
    //   130: aload 6
    //   132: invokestatic 598	com/tencent/open/base/http/HttpBaseUtil:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   135: astore 7
    //   137: aload 7
    //   139: astore_0
    //   140: aload 5
    //   142: ifnull +8 -> 150
    //   145: aload 5
    //   147: invokevirtual 601	java/io/InputStream:close	()V
    //   150: aload_0
    //   151: astore 5
    //   153: aload 6
    //   155: ifnull +11 -> 166
    //   158: aload 6
    //   160: invokevirtual 601	java/io/InputStream:close	()V
    //   163: aload_0
    //   164: astore 5
    //   166: aload 5
    //   168: areturn
    //   169: aload 5
    //   171: invokestatic 598	com/tencent/open/base/http/HttpBaseUtil:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   174: astore 6
    //   176: aload 6
    //   178: astore_0
    //   179: aconst_null
    ...
    //   182: goto -42 -> 140
    //   185: astore 5
    //   187: getstatic 37	com/tencent/open/base/http/HttpBaseUtil:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   190: ldc_w 603
    //   193: aload 5
    //   195: invokestatic 606	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   198: aload_0
    //   199: areturn
    //   200: astore 7
    //   202: aconst_null
    ...
    //   205: aload 9
    //   207: astore 6
    //   209: getstatic 37	com/tencent/open/base/http/HttpBaseUtil:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   212: new 179	java/lang/StringBuilder
    //   215: dup
    //   216: invokespecial 180	java/lang/StringBuilder:<init>	()V
    //   219: ldc_w 608
    //   222: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   225: aload 7
    //   227: invokevirtual 609	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   230: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   233: invokevirtual 187	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   236: aload 7
    //   238: invokestatic 606	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   241: aload_0
    //   242: invokeinterface 613 1 0
    //   247: astore_0
    //   248: aload_0
    //   249: arraylength
    //   250: istore_2
    ...
    //   260: aaload
    //   261: astore 7
    //   263: getstatic 37	com/tencent/open/base/http/HttpBaseUtil:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   279: aload 7
    //   281: invokeinterface 616 1 0
    //   286: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   289: ldc_w 618
    //   292: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   295: aload 7
    //   297: invokeinterface 482 1 0
    //   302: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   305: invokevirtual 187	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   308: invokestatic 376	com/tencent/open/base/LogUtility:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   311: iload_1
    //   312: iconst_1
    //   313: iadd
    //   314: istore_1
    ...
    //   320: ifnull +8 -> 328
    //   323: aload 5
    //   325: invokevirtual 601	java/io/InputStream:close	()V
    //   328: aload 8
    //   330: astore 5
    //   332: aload 6
    //   334: ifnull -168 -> 166
    //   337: aload 6
    //   339: invokevirtual 601	java/io/InputStream:close	()V
    //   342: ldc_w 461
    //   345: areturn
    //   346: astore_0
    //   347: getstatic 37	com/tencent/open/base/http/HttpBaseUtil:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   350: ldc_w 603
    //   353: aload_0
    //   354: invokestatic 606	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   357: ldc_w 461
    //   360: areturn
    //   361: astore_0
    //   362: aconst_null
    ...
    //   371: ifnull +8 -> 379
    //   374: aload 5
    //   376: invokevirtual 601	java/io/InputStream:close	()V
    //   379: aload 6
    //   381: ifnull +8 -> 389
    //   384: aload 6
    //   386: invokevirtual 601	java/io/InputStream:close	()V
    //   389: aload_0
    //   390: athrow
    //   391: astore 5
    //   393: getstatic 37	com/tencent/open/base/http/HttpBaseUtil:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   396: ldc_w 603
    //   399: aload 5
    //   401: invokestatic 606	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   404: goto -15 -> 389
    //   407: astore_0
    //   408: aload 7
    //   410: astore 6
  ...
  protected static HttpClient a()
  {
    try
    {
      ...
      localObject = new lex((KeyStore)localObject);
