  ...
  implements DownloadListener
{
  ...
  protected static final String a = "PCPushProxy";
  ...
  protected PCPushProxy()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new lic(this, ThreadManager.b());
  ...
  public int a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = OpenFileUtil.a(paramString, new File(((DownloadInfo)localObject1).jdField_k_of_type_JavaLangString));
      if (localObject1 != null)
      {
  ...
  public void a(String paramString)
  {
    ...
    paramString.putString(DownloadConstants.jdField_k_of_type_JavaLangString, localPkgEntry.jdField_e_of_type_JavaLangString);
  ...
  public void a(List paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        int i1 = localPkgEntry.jdField_e_of_type_Int;
        switch (((DownloadInfo)localObject).a())
        {
        }
        for (;;)
        {
          localPkgEntry.jdField_f_of_type_Int = ((DownloadInfo)localObject).jdField_k_of_type_Int;
          if ((i1 == 101) || (localPkgEntry.jdField_e_of_type_Int != 101)) {
            break;
          }
          localObject = jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject).hasNext()) {
  ...
  public void c(String paramString)
  {
    ...
    localBundle.putString(DownloadConstants.jdField_k_of_type_JavaLangString, ((PCPushProxy.PkgEntry)localObject).jdField_e_of_type_JavaLangString);
    String str = DownloadConstants.x;
