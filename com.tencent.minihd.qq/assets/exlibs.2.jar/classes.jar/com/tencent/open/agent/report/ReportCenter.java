...
public class ReportCenter
{
  ...
  public static final String a = "https://wspeed.qq.com/w.cgi";
  protected static final int b = 1001;
  public static final String b = "https://appsupport.qq.com/cgi-bin/appstage/mstats_batch_report";
  protected static final int c = 10000;
  public static final String c = "https://c.isdspeed.qq.com/code.cgi";
  ...
  protected Executor c = ThreadManager.a();
  
  private ReportCenter()
  {
    this.jdField_a_of_type_AndroidOsHandler = new lcu(this, Looper.getMainLooper());
  ...
  private void a(Bundle paramBundle, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_b_of_type_JavaUtilConcurrentExecutor.execute(new lcv(this, paramString2, paramBundle, paramBoolean));
        return;
      }
  ...
  public Bundle a()
  {
    ...
    try
    {
      ...
      localBundle.putString("releaseversion", CommonDataAdapter.a().e());
  ...
  public void a()
  {
    this.jdField_b_of_type_JavaUtilConcurrentExecutor.execute(new lcy(this));
  }
  
  public void a(String paramString)
  {
    this.c.execute(new lcx(this, paramString));
  }
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, String paramString3, boolean paramBoolean)
  {
    ...
    this.c.execute(new lda(this, paramInt3, paramString1, paramString3, paramInt1, paramInt2, paramString2, paramBoolean));
  }
  ...
  public void a(String paramString1, long paramLong1, long paramLong2, long paramLong3, int paramInt, long paramLong4, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    this.c.execute(new lcw(this, paramLong1, paramString2, paramString1, paramString3, paramInt, paramLong2, paramLong3, paramLong4, paramBoolean));
  }
  
  public void a(String paramString1, String paramString2, Bundle paramBundle, boolean paramBoolean)
  {
    this.jdField_a_of_type_JavaUtilConcurrentExecutor.execute(new lcz(this, paramBundle, paramString1, paramBoolean));
  }
