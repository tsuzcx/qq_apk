  ...
  implements View.OnClickListener, ViewStub.OnInflateListener, ImageLoader.ImageLoadListener
{
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new lcd(this, paramString, paramBitmap));
  }
  ...
  public void b()
  {
    ...
    if (j < i)
    {
      ...
      for (;;)
      {
        j += 1;
        break;
        localObject = (CheckBox)((View)localObject).findViewById(2131297505);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        paramView = (CheckBox)paramView.findViewById(2131297505);
  ...
  public void onInflate(ViewStub paramViewStub, View paramView)
  {
    ...
    default: 
      ...
      localObject = (CheckBox)paramView.findViewById(2131297505);
      localImageView = (ImageView)paramView.findViewById(2131296551);
      paramView = (TextView)paramView.findViewById(2131296582);
      if (this.jdField_a_of_type_ComTencentOpenAgentDatamodelFriendDataManager.a(paramViewStub.a))
      {
        ...
        localImageView.setImageResource(2130838406);
