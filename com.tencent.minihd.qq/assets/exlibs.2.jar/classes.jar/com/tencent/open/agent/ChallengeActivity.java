  ...
  implements View.OnClickListener, ImageLoader.ImageLoadListener, IKeyboardChanged
{
  ...
  protected void a()
  {
    this.jdField_a_of_type_ComTencentOpenWidgetKeyboardDetectorRelativeLayout = ((KeyboardDetectorRelativeLayout)super.findViewById(2131298242));
    this.jdField_b_of_type_AndroidWidgetScrollView = ((ScrollView)super.findViewById(2131298244));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131298245));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)super.findViewById(2131298241));
    this.jdField_a_of_type_AndroidWidgetScrollView = ((ScrollView)super.findViewById(2131298246));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131298254));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131298253));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131298248));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131298250));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130838406);
