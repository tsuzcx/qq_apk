  ...
  implements DialogInterface.OnClickListener, View.OnClickListener, ImageLoader.ImageLoadListener, HttpCgiAsyncTask.Callback, AdapterView.OnItemClickListener
{
  ...
  protected static final String b = "https://fusionbase.qq.com/cgi-bin/appstage/mb_get_created_qqgroup_list";
  ...
  public BindGroupActivity()
  {
    ...
    this.jdField_a_of_type_ComTencentBizCommonUtilOpenIdObserver = new lat(this);
  }
  ...
  private void c()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString))
    {
      if ((localOpenID == null) || (TextUtils.isEmpty(localOpenID.openID)))
      {
        this.jdField_b_of_type_ComTencentMobileqqWidgetQQProgressDialog.b(2131366968);
        this.jdField_b_of_type_ComTencentMobileqqWidgetQQProgressDialog.show();
        this.jdField_a_of_type_AndroidOsHandler = new Handler();
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(new lau(this), 3000L);
  ...
  public void a()
  {
    ...
    new HttpCgiAsyncTask("https://fusionbase.qq.com/cgi-bin/appstage/mb_get_created_qqgroup_list", "POST", this).a(this.jdField_a_of_type_AndroidOsBundle);
    this.jdField_a_of_type_Boolean = true;
  }
  ...
  public void a(String paramString, Bitmap paramBitmap)
  {
    ...
    runOnUiThread(new las(this, paramString, paramBitmap));
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131365736, this);
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(2131363612, this);
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130903592);
    ...
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131298894);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView = ((SlideDetectListView)super.findViewById(2131298897));
    ...
    this.jdField_b_of_type_AndroidViewView = super.findViewById(2131298898);
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131298901));
  ...
  protected void onStart()
  {
    ...
    this.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentResResources.getString(2131362711));
