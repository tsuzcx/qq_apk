  ...
  implements View.OnClickListener
{
  ...
  protected void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      paramString = a(str, b() + "&uin=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getUin() + "&sid=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getSid() + "&mobileInfo=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getMobileInfo());
  ...
  public void b(Bundle paramBundle)
  {
    ...
    if (paramBundle.getString("iconType").equals("2")) {
      this.rightViewText.setOnClickListener(new ldf(this));
    }
  }
  ...
  protected void h()
  {
    ...
    this.jdField_a_of_type_ComTencentSmttSdkWebView.getView().setOnLongClickListener(new lde(this));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((WebSettings)localObject).setDatabasePath(getApplicationContext().getDir("storage", 0).getPath());
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          LogUtility.e(this.jdField_c_of_type_JavaLangString, "error happend:" + localException.getMessage());
        }
      }
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      String str = a(a(), b() + "&uin=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getUin() + "&sid=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getSid() + "&mobileInfo=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getMobileInfo());
      this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.setParams(this.e + "&platform=" + CommonDataAdapter.a().g());
      LogUtility.c(this.jdField_c_of_type_JavaLangString, "enter loadurl = " + str + " | " + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getParams());
      if (Build.VERSION.SDK_INT > 7) {
  ...
  protected void j()
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      getWindow().setContentView(2130903425);
      return;
    }
    ...
    this.jdField_c_of_type_AndroidViewView = findViewById(2131298177);
    k();
  ...
  public void onClick(View paramView)
  {
    ...
    this.jdField_a_of_type_ComTencentSmttSdkWebView.loadUrl("javascript:JsBridge.callback(\"" + this.s + "\");void(0);");
  }
  ...
  public void onNewIntent(Intent paramIntent)
  {
    ...
    if (a(paramIntent))
    {
      if ((this.jdField_a_of_type_Boolean == true) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() == 1) && (((String)this.jdField_a_of_type_JavaUtilArrayList.get(0)).equals(getString(2131362607))))
      {
