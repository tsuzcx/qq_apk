  ...
  extends Dialog
{
  ...
  public MyAppDialog a(int paramInt, DialogInterface.OnClickListener paramOnClickListener, boolean paramBoolean)
  {
    ...
    this.c.setOnClickListener(new lhs(this, paramOnClickListener, paramInt, paramBoolean));
    return this;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      return;
      localObject = ((Resources)localObject).getString(2131362601, new Object[] { Integer.valueOf(paramInt1) });
      break;
      localObject = ((Resources)localObject).getString(2131362602);
      break;
      localObject = ((Resources)localObject).getString(2131362603, new Object[] { Integer.valueOf(paramInt1) });
      break;
      localObject = ((Resources)localObject).getString(2131362604);
      paramInt1 = 100;
      break;
      localObject = ((Resources)localObject).getString(2131362603);
      break;
      if (paramInt1 > 100) {
        break label113;
      }
  ...
  public MyAppDialog b(int paramInt, DialogInterface.OnClickListener paramOnClickListener, boolean paramBoolean)
  {
    ...
    this.d.setOnClickListener(new lht(this, paramOnClickListener, paramInt, paramBoolean));
    return this;
  }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131298193));
    this.e = ((TextView)findViewById(2131298194));
  }
