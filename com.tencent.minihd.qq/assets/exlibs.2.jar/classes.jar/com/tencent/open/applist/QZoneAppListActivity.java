  ...
  extends AppViewBaseActivity
{
  ...
  {
    super.b(paramBundle);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new leh(this));
  }
  ...
  protected void h()
  {
    ...
    this.jdField_a_of_type_ComTencentSmttSdkWebView.getView().setOnLongClickListener(new lei(this));
    ...
    for (;;)
    {
      ...
      if (this.jdField_c_of_type_AndroidViewView != null)
      {
        ...
        if (this.jdField_c_of_type_AndroidViewView != null)
        {
          ...
          {
            if (this.jdField_h_of_type_Boolean) {
              this.jdField_a_of_type_ComTencentSmttSdkWebView.loadUrl(a(d, b() + "&uin=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getUin() + "&sid=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getSid() + "&mobileInfo=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getMobileInfo() + "&pageTime=" + c() + "&isFirstEnter=1"));
            }
            for (;;)
            {
              n();
              break;
              this.jdField_a_of_type_ComTencentSmttSdkWebView.loadUrl(a(d, b() + "&uin=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getUin() + "&sid=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getSid() + "&mobileInfo=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getMobileInfo() + "&pageTime=" + c() + "&isFirstEnter=0"));
            }
            if (this.jdField_a_of_type_ComTencentSmttSdkWebView != null) {
              if (this.jdField_h_of_type_Boolean)
              {
              ...
              else
              {
                ...
                if ((Common.a()) && (localFile.exists()))
                {
                  ...
                  this.jdField_a_of_type_ComTencentSmttSdkWebView.loadUrl(a("file:///" + Common.h(), b() + "&uin=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getUin() + "&sid=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getSid() + "&mobileInfo=" + this.jdField_a_of_type_ComTencentOpenAppcommonJsBaseJsCallBack.getMobileInfo() + "&pageTime=" + c() + "&isFirstEnter=0"));
                }
                else
                {
