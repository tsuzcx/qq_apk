  ...
  extends JsBridge.JsHandler
{
  ...
  public void addResult(WebView paramWebView, long paramLong1, String paramString, long paramLong2, int paramInt)
  {
    ...
    if (this.firstIn)
    {
      ...
      ldt localldt = new ldt(this, paramWebView, paramLong1);
      this.mTask = localldt;
      localTimer.schedule(localldt, paramLong2, paramLong2);
      this.firstIn = false;
    }
    try
    {
  ...
  public void batchCallback(WebView paramWebView, long paramLong)
  {
    ...
    {
      new Handler(Looper.getMainLooper()).post(new ldu(this, paramLong, localArrayList, paramWebView));
      return;
    }
  ...
  protected void batchCallbackError(WebView paramWebView, long paramLong, String paramString)
  {
    ...
    new Handler(Looper.getMainLooper()).post(new ldv(this, paramLong, paramString, paramWebView));
  }
