  ...
  implements ViewStub.OnInflateListener
{
  ...
  public InnerFrameManager.SwitchListener a;
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentCommonAppInnerFrameManager$SwitchListener != null) {
      this.jdField_a_of_type_ComTencentCommonAppInnerFrameManager$SwitchListener.a(paramInt, getDisplayedChild());
    }
    if (paramBoolean) {
      if (getDisplayedChild() != 0)
      {
        ...
        setInAnimation(this.jdField_a_of_type_AndroidAppActivity, 2130968634);
        setOutAnimation(this.jdField_a_of_type_AndroidAppActivity, 2130968635);
      }
    }
    for (;;)
    {
      ...
      return;
      label156:
      setInAnimation(this.jdField_a_of_type_AndroidAppActivity, 2130968632);
      setOutAnimation(this.jdField_a_of_type_AndroidAppActivity, 2130968633);
      continue;
      setInAnimation(this.jdField_a_of_type_AndroidAppActivity, 2130968649);
      setOutAnimation(this.jdField_a_of_type_AndroidAppActivity, 2130968649);
    }
  }
  ...
  public void setSwitchListener(InnerFrameManager.SwitchListener paramSwitchListener)
  {
    this.jdField_a_of_type_ComTencentCommonAppInnerFrameManager$SwitchListener = paramSwitchListener;
  }
}
