...
public class ThreadTracker
{
  ...
  {
    return new crv(paramIterable, paramBoolean);
  }
  ...
  private static crx b(long paramLong, List paramList)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      crx localcrx = (crx)paramList.next();
      if (crx.a(localcrx) == paramLong) {
        return localcrx;
      }
    }
    return null;
  ...
  public static void b(String paramString)
  {
    ...
    try
    {
      ...
      if (i < j)
      {
        ...
        if (localObject2 != null) {
          crx.a((crx)localObject2, ((Thread)localObject1).getName());
        } else {
          localArrayList.add(new crx(((Thread)localObject1).getId(), ((Thread)localObject1).getName(), 0L, null));
        }
      }
    }
    ...
    if (((Iterator)localObject1).hasNext())
    {
      ...
      if (!crx.a((crx)localObject2).startsWith("SharedPreferencesImpl"))
      {
        localPrintStream.println(i + "," + ((crx)localObject2).toString());
        i += 1;
        break label575;
      }
    }
    else
    {
      ...
      {
        localObject2 = (crx)((Iterator)localObject1).next();
        if ((crx.a((crx)localObject2) != null) && (!crx.a((crx)localObject2).startsWith("SharedPreferencesImpl")))
        {
          localPrintStream.println("id:" + crx.a((crx)localObject2));
          localPrintStream.println("name:" + crx.a((crx)localObject2));
          crx.a((crx)localObject2).printStackTrace(localPrintStream);
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        {
          localPrintStream.println("id:" + crx.a((crx)localObject1));
          localPrintStream.println("name:" + crx.a((crx)localObject1));
          if (crx.a((crx)localObject1) != null) {
            crx.a((crx)localObject1).printStackTrace(localPrintStream);
          }
          for (;;)
          {
            localPrintStream.println();
