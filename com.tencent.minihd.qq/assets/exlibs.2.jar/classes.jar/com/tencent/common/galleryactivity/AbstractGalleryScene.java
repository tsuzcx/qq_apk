  ...
  implements AnimationLister, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, AdapterView.OnItemSelectedListener, Gallery.OnItemRotateListener, Gallery.OnScollListener
{
  ...
  AnimationLister jdField_a_of_type_ComTencentCommonGalleryactivityAnimationLister = new cry(this);
  public Gallery a;
  protected int b;
  View b;
  boolean f = false;
  ...
  {
    return (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2130903983, null);
  }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      b((ViewGroup)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131296742));
      this.jdField_a_of_type_ComTencentWidgetGallery = ((Gallery)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131297712));
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131296573);
      ...
      this.jdField_a_of_type_ComTencentWidgetGallery.setSpacing(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131492982));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAlphaAnimation.setAnimationListener(new crz(this));
  ...
  public void b(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAnimationSet.setAnimationListener(new csa(this));
    this.jdField_b_of_type_AndroidViewView.startAnimation(localAlphaAnimation);
