  ...
  implements AbstractProgressView
{
  ...
  {
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((RelativeLayout)paramAbstractGalleryScene.a()).findViewById(2131297713));
    paramAbstractGalleryScene = null;
    try
    {
      localObject = BitmapFactory.decodeResource(paramActivity.getResources(), 2130841318);
      paramAbstractGalleryScene = (AbstractGalleryScene)localObject;
    }
    ...
    localObject = paramAbstractGalleryScene;
    if (paramAbstractGalleryScene == null) {
      localObject = Bitmap.createBitmap(4, 4, Bitmap.Config.ARGB_8888);
    }
    this.jdField_a_of_type_ComTencentMobileqqWidgetPhotoProgressDrawable = new PhotoProgressDrawable((Bitmap)localObject, (int)(paramActivity.getResources().getDisplayMetrics().density * 12.0F));
