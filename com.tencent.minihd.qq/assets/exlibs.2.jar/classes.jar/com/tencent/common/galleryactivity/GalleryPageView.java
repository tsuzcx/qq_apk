  ...
  extends AbstractGalleryPageView
{
  ...
  Runnable jdField_a_of_type_JavaLangRunnable = new csj(this);
  ...
  public void a(Activity paramActivity, AbstractGalleryScene paramAbstractGalleryScene, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131296390);
    ...
    this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setAnimationListener(new csh(this));
    this.b.setAnimationListener(new csi(this));
  }
