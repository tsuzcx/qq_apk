...
public class QQMusicService
{
  ...
  QQPlayerService.QQPlayerCallback jdField_a_of_type_ComTencentMobileqqMusicQQPlayerService$QQPlayerCallback = new ccs(this);
  ...
  public void a(String paramString)
  {
    ...
    QQPlayerService.a(new Intent(BaseApplication.getContext(), MusicSharePlayActivity.class));
  ...
  public void a(AppRuntime paramAppRuntime, Bundle paramBundle)
  {
    ...
    {
      MLog.d("QQMusicService", "this is not troopbar music!!!");
      return;
    }
    switch (i)
    {
