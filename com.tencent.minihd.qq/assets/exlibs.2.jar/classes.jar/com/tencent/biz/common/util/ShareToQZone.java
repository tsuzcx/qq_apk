...
public class ShareToQZone
{
  ...
  static
  {
    ...
    b = null;
    jdField_a_of_type_AndroidOsHandler = new ced();
    jdField_a_of_type_JavaLangRunnable = new cee();
  }
  ...
  public static int a()
  {
    ...
    if (bool) {
      return a(str3, "https://openmobile.qq.com/api/share/add_share_pic?t=" + System.currentTimeMillis() + "&" + "mType" + "=" + "qb_share", str1, localBundle);
    }
    str1 = "https://openmobile.qq.com/api/share/add_share?t=" + System.currentTimeMillis();
  ...
  private static int a(String paramString1, String paramString2, String paramString3, Bundle paramBundle)
  {
    ...
    paramString2.setHeader("Referer", "https://openmobile.qq.com/");
  ...
  public static byte[] a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      catch (OutOfMemoryError paramString)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.i(jdField_a_of_type_JavaLangString, 2, "======compressPic has OutOfMemoryError =========");
          }
          paramString = null;
        }
