  ...
  extends BusinessHandler
{
  ...
  static final String jdField_a_of_type_JavaLangString = "TroopRedTouchHandler";
  static final String b = "OidbSvc.0x791";
  private BusinessObserver jdField_a_of_type_ComTencentMobileqqAppBusinessObserver = new cbv(this);
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    ThreadManager.b(new cbu(paramQQAppInterface, paramLong));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, oidb_0x791.RedDotInfo paramRedDotInfo)
  {
    ...
    {
      return;
      localTroopRedTouchManager = (TroopRedTouchManager)paramQQAppInterface.getManager(66);
    ...
    ((TroopRedTouchHandler)paramQQAppInterface.a(45)).a(paramRedDotInfo);
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ((TroopRedTouchManager)paramQQAppInterface.getManager(66)).a(paramArrayOfByte);
        bool = true;
        return bool;
      }
  ...
  private void d()
  {
    ...
    ((NewIntent)localObject2).setObserver(new cbs(this));
  ...
  public void a(oidb_0x791.RedDotInfo paramRedDotInfo)
  {
    ...
    ((NewIntent)localObject2).putExtra("data", ((oidb_sso.OIDBSSOPkg)localObject1).toByteArray());
    ((NewIntent)localObject2).setObserver(new cbt(this));
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject2);
  }
