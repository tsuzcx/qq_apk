  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.setBackgroundResource(2130838987);
    ...
    for (;;)
    {
      ...
      break;
      label150:
      Object localObject = this.jdField_a_of_type_ComTencentBizLebasearchSearchActivity.getString(2131364147, new Object[] { str });
