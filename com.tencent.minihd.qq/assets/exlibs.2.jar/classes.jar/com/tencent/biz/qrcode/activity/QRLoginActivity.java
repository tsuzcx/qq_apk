  ...
  implements View.OnClickListener
{
  ...
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new cmz(this);
  protected boolean a;
  protected byte[] a;
  public int b;
  public Button b;
  ...
  public QRLoginActivity()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new cnc(this);
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!HttpUtil.a(this))
    {
      ...
      ((QQCustomDialog)localObject).setMessage(2131363529);
      ((QQCustomDialog)localObject).setPositiveButton(2131365737, new cnb(this));
    ...
    {
      localObject = getString(2131363554);
    }
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setText(2131363532);
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.b(2131363600);
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.setOnCancelListener(new cna(this));
  ...
  public void b()
  {
    ...
    Toast.makeText(getApplicationContext(), 2131363555, 0).show();
    if (this.jdField_d_of_type_JavaLangString.equals("QQ"))
    {
      localIntent = new Intent("com.tencent.mobileqq.action.PC_STATUS_MANAGE");
      localIntent.putExtra("loginInfo", this.jdField_e_of_type_JavaLangString);
  ...
  {
    if ((paramView.getId() == 2131298989) && (this.jdField_a_of_type_Boolean))
    {
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    super.setTitle(2131363531);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131298984));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131298989));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131298990));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131298986));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131298987));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131298988));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131298985));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131298982));
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)super.findViewById(2131298991));
