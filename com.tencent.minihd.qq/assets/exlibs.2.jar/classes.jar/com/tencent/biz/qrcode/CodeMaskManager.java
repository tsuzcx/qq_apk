...
{
  private static final String jdField_a_of_type_JavaLangString = "https://qm.qq.com/cgi-bin/tpl";
  private static final String b;
  private static final int jdField_c_of_type_Int = 1;
  private static final String jdField_c_of_type_JavaLangString = "https://pub.idqqimg.com/qqmobile/qrcode/images/";
  ...
  static
  {
    if (SystemUtil.a())
    {
      jdField_b_of_type_JavaLangString = AppConstants.aG + "qbiz/qrcode/";
      return;
    }
  ...
  private Bitmap a(String paramString)
  {
    ...
    do
    {
      ...
      if (!paramString.startsWith("http://")) {
        localObject1 = "https://pub.idqqimg.com/qqmobile/qrcode/images/" + paramString;
      }
  ...
  private void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_JavaLangThread = new cli(this, localSharedPreferences, localDisplay.getWidth(), i, paramInt);
  ...
  public void a(CodeMaskManager.Callback paramCallback, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    localObject = new cll(this, paramCallback, (Bundle)localObject);
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new clk(this, (cll)localObject, paramCallback), 10000L);
    ((cll)localObject).start();
  }
}
