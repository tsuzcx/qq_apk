  ...
  implements View.OnClickListener, ScannerView.ScannerListener
{
  ...
  {
    this.jdField_a_of_type_JavaLangRunnable = new cln(this);
    this.jdField_b_of_type_JavaLangRunnable = new clq(this);
    this.jdField_c_of_type_JavaLangRunnable = new clr(this);
  }
  
  private void j()
  {
    findViewById(2131297357).setOnClickListener(this);
    ((TextView)findViewById(2131297348)).setText(2131366157);
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_Int = getResources().getDimensionPixelOffset(2131492923);
  ...
  protected Rect a()
  {
    ...
    for (;;)
    {
      ...
      float f1 = super.getResources().getDimension(2131492935);
  ...
  public void a()
  {
    ...
    QRUtils.a(this.app, this, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, new clo(this));
  }
  ...
  public void c()
  {
    if (super.isResume())
    {
      ...
      localQQCustomDialog.setPositiveButton(2131365737, new clp(this));
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      super.setContentView(2130903616);
    }
    for (;;)
    {
      e();
      j();
      return true;
      super.setContentView(2130903615);
    }
  }
  ...
  protected void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131298974));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131298972));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131298973));
  ...
  public void i()
  {
    ...
    if (super.isResume())
    {
      ...
      ((QQCustomDialog)localObject).setMessage(2131363530);
      ((QQCustomDialog)localObject).setPositiveButton(2131365737, new cls(this));
