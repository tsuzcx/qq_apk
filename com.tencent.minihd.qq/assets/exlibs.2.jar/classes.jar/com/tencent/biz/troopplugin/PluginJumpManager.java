...
public class PluginJumpManager
{
  ...
  {
    ReportController.a(null, "P_CliOper", paramString1, "", paramString2, paramString3, 0, paramInt, paramString4, paramString5, paramString6, paramString7);
  }
  ...
  public void launchPlugin(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, long paramLong, String paramString6, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("skey", paramString5);
    localIntent.putExtra("open_time", paramLong);
    paramString4 = new IPluginManager.PluginParams(1);
    paramString4.jdField_b_of_type_JavaLangString = paramString1;
    paramString4.d = paramString2;
    paramString4.jdField_a_of_type_JavaLangString = paramString3;
    paramString4.e = paramString6;
    paramString4.jdField_a_of_type_JavaLangClass = TroopBarProxyActivity.class;
    paramString4.jdField_a_of_type_AndroidContentIntent = localIntent;
    paramString4.jdField_a_of_type_AndroidAppDialog = null;
    localIntent.putExtra("useSkinEngine", true);
    localIntent.putExtra("param_plugin_gesturelock", true);
    paramString4.jdField_b_of_type_Int = 0;
    paramString4.c = 10000;
    paramString4.f = null;
    IPluginManager.a(paramActivity, paramString4);
  }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          while (i < k)
          {
            ...
            ((PluginJumpManager.BidInfo)localObject3).jdField_b_of_type_JavaLangString = localJSONObject.optString("pluginid");
          ...
          while (i < k)
          {
            ...
            ((PluginJumpManager.UrlMappingInfo)localObject2).jdField_b_of_type_JavaLangString = ((JSONObject)localObject3).optString("activity");
  ...
  public void loadConfigFromFile()
  {
    ...
    Object localObject2 = new File(HtmlOffline.a("1007") + "1007" + "/urlplugin.cfg");
    ...
    return;
    label105:
    localObject1 = Util.a((InputStream)localObject1);
    try
    {
      localObject1 = new JSONObject((String)localObject1);
      SharedPreferences.Editor localEditor = this.mPref.edit();
      localEditor.putString("config_file_version", HtmlOffline.c("1007"));
      localEditor.putString("version", ((JSONObject)localObject1).optString("version"));
      localEditor.putString("bidinfo", ((JSONObject)localObject1).optString("bidinfo"));
      localEditor.putString("urlmaping", ((JSONObject)localObject1).optString("urlmaping")).commit();
  ...
  public boolean openView(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    AppRuntime localAppRuntime = ((BaseActivity)paramActivity).getAppRuntime();
  ...
  public boolean openView(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean)
  {
    ...
    PluginManagerHelper.getPluginInterface(paramActivity.getApplicationContext(), new cox(this, (PluginJumpManager.BidInfo)localObject2, paramActivity, paramString3, paramString1, paramString4, l, (PluginJumpManager.UrlMappingInfo)localObject1, paramString2));
    return true;
  }
  
  public boolean openViewForPlugin(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    if (!openView(paramActivity, paramString1, paramString2, paramString3, paramString4, true)) {
      openLinkInNewWebView(paramActivity, paramString1, paramString2);
    }
    return true;
  }
  ...
  {
    HtmlOffline.b(this.mContext, "1007", paramString, true, new cov(this));
  }
}
