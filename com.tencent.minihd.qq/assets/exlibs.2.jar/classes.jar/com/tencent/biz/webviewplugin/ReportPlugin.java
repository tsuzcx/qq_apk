  ...
  extends WebViewPlugin
{
  ...
  public static void a(BaseActivity paramBaseActivity, int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    for (String str1 = "groupuin=" + paramString1;; str1 = "groupuin=0")
    {
      ...
      for (;;)
      {
        ...
        ((StringBuffer)localObject3).append("&" + str1 + "&" + paramString2 + "&" + str2);
        if (!TextUtils.isEmpty((CharSequence)localObject1)) {
          ((StringBuffer)localObject3).append("&" + (String)localObject1);
        }
        ((StringBuffer)localObject3).append("&" + paramString3);
        if ((paramInt == 403) || (paramInt == 402) || (paramInt == 406) || (paramInt == 405))
        {
          ...
          if ((paramInt == 403) || (paramInt == 406) || (paramInt == 405))
          {
            ...
            if ((paramInt == 405) || ((paramInt == 406) && (!TextUtils.isEmpty(paramString5)))) {
              ((StringBuffer)localObject3).append("&commentid=").append(paramString5);
            }
          }
        }
        try
        {
          ...
          paramBaseActivity.startActivity(paramString1.putExtra("url", "https://jubao.qq.com/cn/jubao"));
          return;
        }
        catch (Exception paramBaseActivity) {}
        if (!QLog.isColorLevel()) {
  ...
  protected boolean handleEvent(String paramString, int paramInt, Map paramMap)
  {
    if ((paramInt == 21) && (this.jdField_a_of_type_Boolean))
    {
      ...
      ((QQBrowserActivity)this.mRuntime.a()).l();
      return true;
    }
    return false;
  }
