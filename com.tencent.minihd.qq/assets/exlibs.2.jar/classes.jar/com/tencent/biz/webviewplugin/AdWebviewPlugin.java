  ...
  extends WebViewPlugin
{
    ...
    do
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_MqqAppNewIntent == null)
        {
          ...
          this.jdField_a_of_type_MqqObserverBusinessObserver = new cpp(this, (String)localObject);
  ...
  protected boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    do
    {
      ...
      paramJsBridgeListener = ((QQBrowserActivity)this.jdField_a_of_type_AndroidAppActivity).e();
      try
      {
      ...
      {
        ((QQBrowserActivity)this.jdField_a_of_type_AndroidAppActivity).n();
        return true;
      }
