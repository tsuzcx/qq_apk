  ...
  extends WebViewPlugin
{
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomContextMenuDialog == null)
    {
      ...
      localQQCustomMenu.a(1, localActivity.getString(2131369621));
      localQQCustomMenu.a(2, localActivity.getString(2131369622));
      localQQCustomMenu.a(String.format(localActivity.getString(2131369620), new Object[] { this.c }));
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomContextMenuDialog = DialogUtil.a(localActivity, localQQCustomMenu, new cqa(this));
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomContextMenuDialog.show();
      return;
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomContextMenuDialog.setTitle(String.format(localActivity.getString(2131369620), new Object[] { this.c }));
    }
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_ComTencentWidgetActionSheet == null)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetActionSheet.c(String.format("%s%s", new Object[] { this.mRuntime.a().getString(2131367602), this.c }));
      this.jdField_a_of_type_ComTencentWidgetActionSheet.c(2131369619);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.c(2131369620);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.c(2131367603);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.e(2131365736);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(new cpz(this));
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentWidgetActionSheet.show();
      return;
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(0, String.format("%s%s", new Object[] { this.mRuntime.a().getString(2131367602), this.c }));
    }
  }
