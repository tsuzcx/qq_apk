  ...
  extends WebViewPlugin
{
  ...
  private Client.onRemoteRespObserver jdField_a_of_type_ComTencentMobileqqEmosmClient$onRemoteRespObserver = new cqd(this);
        ...
        if (localJSONObject.has("timeout"))
        {
          ...
          if (this.d.containsKey(paramString2))
          {
            ...
            if (((Long)((Pair)localObject1).first).longValue() != l2)
            {
              ...
              ((WebSSOAgent.UniSsoServerReqComm)localObject2).mqqver.set("5.9.3");
              ...
              ((NewIntent)localObject2).setObserver(new cqe(this, System.currentTimeMillis(), paramString2));
              if (QLog.isColorLevel()) {
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramString2.setObserver(new cqf(this, str1));
