  ...
  implements View.OnClickListener
{
  ...
  protected static final String e = "https://openmobile.qq.com/api/get_app_info_by_id?appid=%d";
  public static final int f = 2;
  public static final String f = "https://cgi.connect.qq.com/qqconnectopen/get_urlinfoForQQV2?url=%2$s&uin=%1$s";
  public static final int g = 3;
  public static final String g = "mqqapi://app/action?pkg=com.tencent.minihd.qq&cmp=com.tencent.biz.pubaccount.AccountDetailActivity&uin=%s";
  public static final int h = 4;
  public static final String h = "mqqapi://card/show_pslcard?src_type=internal&card_type=public_account&uin=%s&version=1";
  public static final String i = "https://url.cn/JS8oE7";
  ...
  public Share(AppInterface paramAppInterface, QQBrowserActivity paramQQBrowserActivity)
  {
    ...
    this.jdField_a_of_type_MqqObserverBusinessObserver = new cqn(this);
    this.jdField_a_of_type_AndroidOsHandler = new cqp(this);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = paramQQBrowserActivity.a();
    c();
  }
  ...
  public static final void a(AppInterface paramAppInterface, Context paramContext, String paramString, long paramLong1, long paramLong2, BusinessObserver paramBusinessObserver)
  {
    ...
    localGetAppinfoRequest.qqv.set("5.9.3");
  ...
  private void c()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.findViewById(2131298926));
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.findViewById(2131298925);
  ...
  public QQProgressDialog a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.b(2131367965);
    }
  ...
  public String a()
  {
    ...
    for (String str = this.jdField_a_of_type_JavaLangString; TextUtils.isEmpty(str); str = this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.f()) {
      return "";
    }
    return Util.a(str, new String[0]);
  }
  ...
  public void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, Bitmap paramBitmap)
  {
    ...
    do
    {
      ...
      if (paramInt == 1)
      {
        ...
        {
          String str4 = ((PublicAccountBrowser)this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity).b();
          ...
          if ((TextUtils.isEmpty(str4)) || (TextUtils.isEmpty(str3)))
          {
            ...
            str1 = null;
            str2 = null;
            str3 = localResources.getString(2131363661);
          ...
          for (;;)
          {
            ShareMsgHelper.a(localQQBrowserActivity, 1001, 1, "web_share", str4, paramString4, paramString1, paramString2, String.format(localResources.getString(2131363662), new Object[] { paramString1 }), paramString3, "web", null, null, null, paramBitmap, null, (String)localObject, str1, str2, str3, null);
            return;
            paramBitmap = "plugin";
            localObject = String.format("mqqapi://app/action?pkg=com.tencent.minihd.qq&cmp=com.tencent.biz.pubaccount.AccountDetailActivity&uin=%s", new Object[] { str4 });
            str1 = String.format("mqqapi://card/show_pslcard?src_type=internal&card_type=public_account&uin=%s&version=1", new Object[] { str4 });
            str2 = "https://url.cn/JS8oE7";
            break;
            break label235;
          }
        }
        ...
        for (;;)
        {
          ShareMsgHelper.a(paramBitmap, 1001, 1, "web_share", "", paramString4, paramString1, paramString2, this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.getString(2131363662, new Object[] { paramString1 }), paramString3, "web", null, null, null, " ", null, null, null, null, this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.getString(2131363661), null);
          return;
          break;
        }
      }
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWxapiWXShareHelper$WXShareListener = new cqk(this);
    ...
    catch (Exception paramContext)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        if (PackageUtil.a(paramContext, localAndroidInfo.packName.get()))
        {
          ...
          QLog.e(n, 2, "QQBrowserActivity getAppInfo image decode failed: oom ===== ");
        }
        else
        {
          paramContext = HttpUtil.a(paramContext, String.format("https://openmobile.qq.com/api/get_app_info_by_id?appid=%d", new Object[] { Long.valueOf(AppShareIDUtil.b(this.jdField_a_of_type_Long)) }), "GET", null, null);
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    {
      a().show();
      this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView.a(this.m, new String[] { paramString });
      return;
      if (paramInt == 2) {
        paramString = "1";
      } else if (paramInt == 3) {
  ...
  public boolean a(String paramString1, int paramInt, boolean paramBoolean, String paramString2)
  {
    if (!NetworkUtil.e(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity))
    {
      QRUtils.a(1, 2131367328);
      return false;
    }
    if (TextUtils.isEmpty(paramString1))
    {
      QRUtils.a(1, 2131367966);
      return false;
    }
    a().b(2131367965);
    Bitmap localBitmap;
    ...
    for (boolean bool3 = true;; bool3 = false)
    {
      ...
      new cqg(this, bool1, paramString1, bool2, bool3, localBitmap, paramInt).start();
      return true;
    ...
    for (;;)
    {
      a(paramInt, paramString2, str1, paramString1, str2, localBitmap);
      break;
      localBitmap = null;
    }
    label255:
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.show();
    new cqi(this, paramString1, paramString2, paramBoolean, localBitmap, paramInt).start();
    return true;
  }
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    if (paramString5.length() > 180)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.show();
      new cql(this, bool, paramString5, paramString1, paramString2, paramString3, paramString4, paramString6).start();
    }
    for (;;)
    {
      return true;
      ...
      break label107;
      label160:
      paramString7 = String.format("mqqapi://app/action?pkg=com.tencent.minihd.qq&cmp=com.tencent.biz.pubaccount.AccountDetailActivity&uin=%s", new Object[] { paramString1 });
      ...
      String str = String.format(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.getResources().getString(2131363662), new Object[] { paramString2 });
      ShareMsgHelper.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, 1001, 1, "struct_msg_from_h5", paramString1, paramString5, paramString2, paramString3, str, paramString4, "web", null, null, null, "plugin", null, paramString7, paramString8, "https://url.cn/JS8oE7", paramString6, null);
    }
  }
