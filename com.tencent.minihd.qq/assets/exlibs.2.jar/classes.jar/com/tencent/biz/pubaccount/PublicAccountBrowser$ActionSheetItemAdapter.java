  ...
  extends ArrayAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903299, null);
      paramViewGroup = new PublicAccountBrowser.ActionSheetItemViewHolder();
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131297602));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297603));
    ...
    for (;;)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(localActionSheetItem.l);
      return paramView;
