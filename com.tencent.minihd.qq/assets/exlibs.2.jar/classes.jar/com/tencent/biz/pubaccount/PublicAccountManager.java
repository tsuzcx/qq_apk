...
public class PublicAccountManager
{
  ...
  public static final String p = "set_refuse_follow";
  public static final String q = "send_msg_receipt";
  public static final String r = "get_business_recommend";
  public static final String s = "secmsg.configs";
  public static final String t = "send_pre_message_status";
  public Context a;
  ...
  private PublicAccountManager()
  {
    ...
    this.jdField_a_of_type_JavaLangRunnable = new cjv(this);
    this.jdField_a_of_type_ComTencentMobileqqAppLBSObserver = new cjx(this);
  }
  
  public static int a(String paramString, AppInterface paramAppInterface)
  {
    if (((PublicAccountDataManager)paramAppInterface.getManager(54)).a(paramString + "").extendType == 2) {
      return 1;
    }
    return 2;
  }
  ...
  private static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, mobileqq_mp.ButtonInfo paramButtonInfo)
  {
    ...
    for (;;)
    {
      ...
      localIntent.putExtra("assignBackText", paramContext.getResources().getString(2131366374));
  ...
  public NewIntent a(Context paramContext, AppInterface paramAppInterface, long paramLong1, long paramLong2, long paramLong3, long paramLong4, int paramInt, List paramList)
  {
    ...
    for (;;)
    {
      ...
      paramContext.setObserver(new cjz(this, paramContext));
  ...
  public NewIntent a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, BusinessObserver paramBusinessObserver, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localNewIntent.setObserver(new cjs(this, localNewIntent, paramQQAppInterface, paramString, paramBusinessObserver));
      paramContext = localNewIntent;
  ...
  public NewIntent a(String paramString, int paramInt, boolean paramBoolean, Context paramContext, AppInterface paramAppInterface, PublicAccountManager.refuseAcceptDone paramrefuseAcceptDone)
  {
    ...
    paramContext.setObserver(new cjy(this, paramContext, paramrefuseAcceptDone));
    if (paramAppInterface != null) {
      paramAppInterface.startServlet(paramContext);
    }
    return paramContext;
  ...
  {
    if ((paramString1 != null) && (!paramString1.equals(this.w))) {
      a();
    }
    this.w = paramString1;
    ThreadManager.b(new cjq(this, paramString2, paramQQAppInterface, paramInitDoneObserver, paramContext));
  }
  ...
  {
    a(paramContext, paramQQAppInterface, paramString1, paramString2, paramBoolean, paramDouble1, paramDouble2, paramBusinessObserver, 1, 0L);
  }
  
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean, double paramDouble1, double paramDouble2, BusinessObserver paramBusinessObserver, int paramInt, long paramLong)
  {
    try
    {
      ...
      localNewIntent.setObserver(new cju(this, localNewIntent, paramContext, paramString1, paramBusinessObserver, paramQQAppInterface));
