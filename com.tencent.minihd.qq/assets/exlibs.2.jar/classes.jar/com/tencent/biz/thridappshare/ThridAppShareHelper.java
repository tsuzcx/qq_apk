...
public class ThridAppShareHelper
{
  ...
  public void a(Context paramContext, String paramString1, String paramString2, SessionInfo paramSessionInfo)
  {
    ...
    if (!DataProviderApi.b(paramContext, localThirdAppInfo.c, paramString1, "android.intent.action.VIEW", "com.tencent.minihd.qq", "com.tencent.mobileqq.activity.JumpActivity"))
    {
      if (!DataProviderApi.b(paramContext, localThirdAppInfo.d, paramString1, "android.intent.action.VIEW", "com.tencent.minihd.qq", "com.tencent.mobileqq.activity.JumpActivity"))
      {
  ...
  {
    if (11 != paramIntent.getIntExtra("forward_type", 2147483647))
    {
  ...
  public boolean a(Intent paramIntent, Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      paramIntent = new ForwardOperations(paramActivity, paramQQAppInterface, paramIntent, paramIntent.getExtras());
      paramIntent.L = String.valueOf(localLong);
