...
class WXApiImplComm
{
  ...
  public static boolean isIntentFromWx(Intent paramIntent, String paramString)
  {
    ...
    } while ((paramIntent == null) || (!paramIntent.equals(paramString)));
    return true;
  }
  ...
  public static boolean validateAppSignature(Context paramContext, Signature[] paramArrayOfSignature, boolean paramBoolean)
  {
    if (!paramBoolean)
    {
      a.c("MicroMsg.SDK.WXMsgImplComm", "ignore wechat app signature validation");
      return true;
    }
    ...
    while (i < j)
    {
      paramContext = paramArrayOfSignature[i].toCharsString().toLowerCase();
      a.c("MicroMsg.SDK.WXMsgImplComm", "check signature:" + paramContext);
      ...
      {
        a.c("MicroMsg.SDK.WXMsgImplComm", "pass");
        return true;
      }
      i += 1;
    }
 ...
 * Qualified Name:     com.tencent.mm.sdk.openapi.WXApiImplComm
