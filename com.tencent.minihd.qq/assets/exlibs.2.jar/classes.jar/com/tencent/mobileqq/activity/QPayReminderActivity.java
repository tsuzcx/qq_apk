...
{
  public static final String a = "URGENCY";
  ...
  private boolean a()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840817);
          continue;
        }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    setContentView(2130904108);
    setLeftButton(2131367454, this);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131300879));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131300878));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131300877));
    if (!a()) {
      finish();
    }
    return true;
