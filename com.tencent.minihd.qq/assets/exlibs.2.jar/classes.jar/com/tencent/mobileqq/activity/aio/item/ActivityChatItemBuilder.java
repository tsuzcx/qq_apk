  ...
  implements View.OnClickListener
{
  ...
  {
    paramLinearLayout = (ftg)paramViewHolder;
    paramViewHolder = paramView;
    if (paramView == null)
    {
      paramViewHolder = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130903510, null);
      paramLinearLayout.b = ((TextView)paramViewHolder.findViewById(2131298572));
      paramLinearLayout.c = ((TextView)paramViewHolder.findViewById(2131298577));
      paramLinearLayout.d = ((TextView)paramViewHolder.findViewById(2131298578));
      paramLinearLayout.a = ((ImageView)paramViewHolder.findViewById(2131298575));
    ...
    try
    {
      paramMessageRecord = URLDrawable.getDrawable(paramView.bigPic, paramViewHolder.getResources().getDrawable(2130839159), paramViewHolder.getResources().getDrawable(2130839158));
    ...
    catch (Exception paramMessageRecord)
    {
      for (;;)
      {
        paramLinearLayout.a.setBackgroundResource(2130839158);
        continue;
  ...
  {
    paramTextView.getViewTreeObserver().addOnPreDrawListener(new ftf(this, paramTextView, paramString));
  }
