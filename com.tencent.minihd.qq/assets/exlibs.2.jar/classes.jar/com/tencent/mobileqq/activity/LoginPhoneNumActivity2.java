  ...
  implements TextWatcher, View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  Handler jdField_a_of_type_AndroidOsHandler = new ejm(this);
  ...
  WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new ejn(this);
  private int c;
  ...
  private void d()
  {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("LoginPhoneNumActivity", 2, "0X80060DD: mobile = " + this.d);
      }
      ReportController.b(null, "CliOper", "", "", "0X80060DD", "0X80060DD", 0, 0, "", "", this.d, "");
      a(2131366848);
