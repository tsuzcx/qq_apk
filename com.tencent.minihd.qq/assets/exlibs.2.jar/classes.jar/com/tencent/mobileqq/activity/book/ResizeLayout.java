  ...
  extends ScrollView
{
  ...
  protected void onSizeChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      Log.i("onSizeChanged", "w:" + paramInt1 + " h:" + paramInt2 + " oldw:" + paramInt3 + " oldh:" + paramInt4);
      ...
      {
        new Handler(Looper.getMainLooper()).postDelayed(new gea(this, paramInt1, paramInt2, paramInt3, paramInt4), 50L);
        return;
      }
    }
  }
