  ...
  extends AIOAnimationConatiner.AIOAnimator
{
  ...
  protected boolean a(Object... paramVarArgs)
  {
    try
    {
      ...
      label305:
      if (this.jdField_a_of_type_Fri == null)
      {
        this.jdField_a_of_type_Fri = new fri(this, null);
        this.jdField_a_of_type_ComTencentWidgetListView.postDelayed(this.jdField_a_of_type_Fri, 16L);
      }
      return true;
    }
  ...
  protected void c()
  {
    if (this.jdField_a_of_type_Fri != null)
    {
      this.jdField_a_of_type_ComTencentWidgetListView.removeCallbacks(this.jdField_a_of_type_Fri);
      this.jdField_a_of_type_Fri = null;
    }
  }
}
