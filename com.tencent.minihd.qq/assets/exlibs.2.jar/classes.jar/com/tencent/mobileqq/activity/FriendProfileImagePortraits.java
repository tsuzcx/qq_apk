  ...
  extends FriendProfileImageModel
{
  ...
  private CardObserver jdField_a_of_type_ComTencentMobileqqAppCardObserver = new ecp(this);
  ...
  public FriendProfileImagePortraits(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new eco(this);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilStack == null) || (this.jdField_a_of_type_AndroidOsHandler == null))
        {
          ...
          this.jdField_a_of_type_AndroidOsHandler = new ecq(this);
        }
