...
public class NearPeopleFilterActivity$NearPeopleFilters
{
  ...
  static
  {
    ...
    b = new String[] { "不限", "水瓶座", "双鱼座", "白羊座", "金牛座", "双子座", "巨蟹座", "狮子座", "处女座", "天秤座", "天蝎座", "射手座", "摩羯座" };
    jdField_a_of_type_ArrayOfInt = new int[] { 1, 2, 3, 0 };
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((this.i == paramObject.i) && ((this.j == paramObject.j) || (((this.j == 4) || (this.j == 0)) && ((paramObject.j == 4) || (paramObject.j == 0)))) && (this.k == paramObject.k) && (this.l == paramObject.l) && (this.m == paramObject.m)) {}
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      for (;;)
      {
        ...
        bool2 &= this.c[n].equalsIgnoreCase(paramObject.c[n]);
        bool1 = bool2;
        if (!bool2) {
          break;
        }
