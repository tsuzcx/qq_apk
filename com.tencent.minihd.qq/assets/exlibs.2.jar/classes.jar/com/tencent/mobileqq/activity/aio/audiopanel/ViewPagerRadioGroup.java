  ...
  implements ViewPager.OnPageChangeListener
{
  ...
  {
    fte localfte = new fte(this, getContext());
    localfte.setButtonDrawable(2130838297);
    localfte.setGravity(17);
    ...
    localfte.setLayoutParams(localLayoutParams);
    localfte.setClickable(true);
    return localfte;
  }
