  ...
  implements FileTransferManager.Callback
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new fvh(this);
  ...
  private AnimationTextView.OnDoubleClick jdField_a_of_type_ComTencentMobileqqWidgetAnimationTextView$OnDoubleClick = new fvi(this);
  ...
  public MixedMsgItemBuilder(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioMixedImageOnclickListener.jdField_a_of_type_AndroidContentContext = this.jdField_a_of_type_AndroidContentContext;
  }
  ...
  protected View a(ChatMessage paramChatMessage, BaseBubbleBuilder.ViewHolder paramViewHolder, View paramView, BaseChatItemLayout paramBaseChatItemLayout, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    for (int j = 1;; j = 0)
    {
      if (((i & j) == 0) || (!TextUtils.isEmpty(paramChatMessage.getExtInfoFromExtStr("sens_msg_ctrl_info")))) {
        break label134;
      }
      j = MixedMsgItemBuilder.MixedHolder.a(paramBaseChatItemLayout).getChildCount();
      i = 0;
      for (;;)
      {
        ...
        paramChatMessage = MixedMsgItemBuilder.MixedHolder.a(paramBaseChatItemLayout).getChildAt(i);
        if ((paramChatMessage instanceof ChatThumbView))
        {
          ((ChatThumbView)paramChatMessage).setMaxHeight(URLDrawableHelper.a());
          ((ChatThumbView)paramChatMessage).setMaxWidth(URLDrawableHelper.a());
        }
        i += 1;
      }
      i = 0;
    ...
    for (;;)
    {
      ...
      {
        paramViewHolder.a(paramBaseChatItemLayout, this);
        paramChatMessage = paramBaseChatItemLayout;
      }
  ...
  public MixedMsgLinearLayout a(BaseBubbleBuilder.ViewHolder paramViewHolder, MixedMsgLinearLayout paramMixedMsgLinearLayout, List paramList, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    if (paramMixedMsgLinearLayout == null)
    {
      ...
      paramList.setPadding(2131493057, 2131493055, 2131493058, 2131493056);
      paramMixedMsgLinearLayout = new RelativeLayout.LayoutParams(-2, -2);
      paramMixedMsgLinearLayout.addRule(1, 2131296551);
      paramMixedMsgLinearLayout.addRule(3, 2131297136);
      ...
      else
      {
        ...
        for (paramMixedMsgLinearLayout.bottomMargin = BaseChatItemLayout.n;; paramMixedMsgLinearLayout.bottomMargin = 0)
        {
          ...
          if ((paramMixedMsgLinearLayout instanceof MessageForPic))
          {
            ...
            ((ChatThumbView)localObject).setTag(2131296335, paramMixedMsgLinearLayout);
      ...
      else
      {
        for (;;)
        {
          ...
          if (paramInt1 < paramInt2)
          {
            ...
            {
              localObject1 = ((ChatThumbView)paramFileMsg).getTag(2131296335);
  ...
  protected void a(BaseBubbleBuilder.ViewHolder paramViewHolder, View paramView, ChatMessage paramChatMessage, BubbleInfo paramBubbleInfo)
  {
    ...
    if ((paramBubbleInfo.c == 0) || (!paramBubbleInfo.a()))
    {
      ...
      label79:
      for (paramView = paramView.getColorStateList(2131427944);; paramView = paramView.getColorStateList(2131427943))
      {
    ...
    paramView = paramView.getResources().getColorStateList(2131427943);
    if (paramBubbleInfo.e != 0) {
      paramViewHolder = ColorStateList.valueOf(paramBubbleInfo.e);
    }
    if (paramBubbleInfo.f != 0) {
      paramView = ColorStateList.valueOf(paramBubbleInfo.f);
    }
    MixedMsgItemBuilder.MixedHolder.a(localMixedHolder).a(paramViewHolder, paramView);
  }
  ...
  public QQCustomMenuItem[] a(View paramView)
  {
    ...
    paramView.a(this.jdField_a_of_type_AndroidContentContext.getString(2131365746));
    paramView.a(2131302484, this.jdField_a_of_type_AndroidContentContext.getString(2131366394));
