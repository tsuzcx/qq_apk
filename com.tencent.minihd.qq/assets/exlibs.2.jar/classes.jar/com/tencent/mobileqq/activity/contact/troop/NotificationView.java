  ...
  implements View.OnClickListener, BaseSystemMsgInterface, FaceDecoder.DecodeTaskCompletionListener, SlideDetectListView.OnScrollToTopListener, SlideDetectListView.OnSlideListener
{
  ...
  public Handler a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new gjg(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new gji(this);
  private NotificationAdapter jdField_a_of_type_ComTencentMobileqqActivityContactTroopNotificationAdapter;
  MessageObserver jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new gjh(this);
  private FaceDecoder jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder;
  public QQProgressDialog a;
  private SlideDetectListView.OnScrollToTopListener jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView$OnScrollToTopListener = new gjj(this);
  private SlideDetectListView jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView;
  private List jdField_a_of_type_JavaUtilList = new ArrayList();
  public final long b;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new gjl(this);
  ...
  public NotificationView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new gjf(this);
  ...
  private void b(NotificationAdapter.ViewHolder paramViewHolder)
  {
    ...
    default: 
      ...
      i1 = 4;
      str = paramViewHolder.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_name.get() + this.jdField_a_of_type_AndroidContentContext.getString(2131363674);
    }
    for (;;)
    {
      ...
      str = paramViewHolder.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.req_uin_nick.get() + this.jdField_a_of_type_AndroidContentContext.getString(2131363675);
      continue;
      ...
      str = paramViewHolder.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.action_uin_nick.get() + this.jdField_a_of_type_AndroidContentContext.getString(2131363676);
    }
  }
  ...
  {
    a(2130903555);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView = ((SlideDetectListView)findViewById(2131298767));
    this.jdField_e_of_type_AndroidViewView = findViewById(2131298768);
    q();
  ...
  private void p()
  {
    ...
    this.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(AppConstants.ak, 0);
  ...
  {
    if (this.f == null) {
      this.f = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130904036, null);
    }
  ...
  private void r()
  {
    ...
    do
    {
      do
      {
        ...
        {
          QQToast.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131365730), 0).b(a());
          return;
        }
  ...
  private void t()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new gjk(this));
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(NotificationAdapter.ViewHolder paramViewHolder, int paramInt)
  {
      ...
      default: 
        ...
        if ((paramInt != 0) && ((localStructMsg.msg.group_ext_flag.get() & 0x800) != 0)) {
          if (localStructMsg.msg.group_info.group_auth_type.get() == 2)
          {
            ...
            paramViewHolder.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130838652);
            str = localStructMsg.msg.group_info.msg_alert.get();
            paramViewHolder.jdField_c_of_type_AndroidWidgetTextView.setTextAppearance(this.jdField_a_of_type_AndroidContentContext, 2131558573);
            if ((TextUtils.isEmpty(str)) || ((paramViewHolder.jdField_a_of_type_Int != 1) && (paramViewHolder.jdField_a_of_type_Int != 22))) {
              break label753;
            }
            paramViewHolder.jdField_c_of_type_AndroidWidgetTextView.setTextAppearance(this.jdField_a_of_type_AndroidContentContext, 2131558574);
            localObject = str;
            label345:
            ...
            paramViewHolder.jdField_a_of_type_AndroidWidgetButton.setTextAppearance(this.jdField_a_of_type_AndroidContentContext, 2131558814);
            paramViewHolder.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838090);
    ...
    for (;;)
    {
      ...
      {
        paramViewHolder.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        paramViewHolder.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130839096);
        break label272;
      }
      ...
      {
        paramViewHolder.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131363413));
        break label410;
      }
      paramViewHolder.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
      break label410;
      ...
      if (i1 == 1)
      {
        ...
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          ...
          for (;;)
          {
            ...
            break;
            paramViewHolder.jdField_a_of_type_AndroidWidgetButton.setText(((structmsg.SystemMsgAction)((List)localObject).get(0)).name.get());
            paramViewHolder.jdField_a_of_type_AndroidWidgetButton.setTextAppearance(this.jdField_a_of_type_AndroidContentContext, 2131558826);
            paramViewHolder.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838088);
          }
        }
      ...
      paramViewHolder.jdField_a_of_type_AndroidWidgetButton.setTextAppearance(this.jdField_a_of_type_AndroidContentContext, 2131558575);
  ...
  public void a(SlideDetectListView paramSlideDetectListView, View paramView, int paramInt)
  {
    ...
    {
      paramView = (ShaderAnimLayout)paramView.findViewById(2131298765);
      if (paramView != null) {
        break label38;
      }
    }
    ...
    {
      return;
      localButton = (Button)paramView.findViewById(2131298766);
  ...
  {
    paramSlideDetectListView = (ShaderAnimLayout)paramView.findViewById(2131298765);
    if (paramSlideDetectListView != null)
    {
      paramSlideDetectListView.d();
      paramSlideDetectListView = (Button)paramSlideDetectListView.findViewById(2131298766);
      if (paramSlideDetectListView != null) {
  ...
  protected void e()
  {
    ...
    ((NewFriendManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(33)).a(new TroopSystemMessage(0));
  }
