  ...
  implements Manager
{
  ...
  private final TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new fox(this, Looper.getMainLooper());
  ...
  public void a(Message paramMessage)
  {
    ...
    {
      Object localObject = (foy)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((foy)localObject).a();
      localObject = ((foy)localObject).a();
  ...
  public void a(View paramView, FileTransferManager.Callback paramCallback)
  {
    ...
    {
      foy localfoy = (foy)localIterator.next();
      if (localfoy.a() == paramView)
      {
        localfoy.b = new WeakReference(paramCallback);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new foy(this, paramView, paramCallback));
  }
