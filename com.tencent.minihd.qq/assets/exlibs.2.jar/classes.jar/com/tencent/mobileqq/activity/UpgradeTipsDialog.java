  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  {
    super(paramActivity, 2131558902);
  ...
  {
    this.jdField_a_of_type_ComTencentSmttSdkWebView = ((WebView)paramView.findViewById(2131300646));
    ...
    this.jdField_a_of_type_ComTencentSmttSdkWebView.setWebViewClient(new fmq(this));
    ...
    this.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131300642));
    ...
    this.b = ((Button)paramView.findViewById(2131300645));
    this.b.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131300644));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    if (UpgradeController.a().a() == 4) {
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131366452);
    }
  }
  ...
  private void b(UpgradeTipsDialog.OnPreparedListener paramOnPreparedListener)
  {
    ...
    paramOnPreparedListener = getLayoutInflater().inflate(2130904057, null);
