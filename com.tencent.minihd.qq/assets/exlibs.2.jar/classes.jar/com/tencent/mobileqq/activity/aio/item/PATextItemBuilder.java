  ...
  extends AbstractChatItemBuilder
{
  ...
  public PATextItemBuilder(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new fvr(this);
  }
  ...
  protected View a(MessageRecord paramMessageRecord, AbstractChatItemBuilder.ViewHolder paramViewHolder, View paramView, LinearLayout paramLinearLayout, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    if (paramView == null) {
      paramLinearLayout = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130903149, null);
    }
    ...
    paramMessageRecord = (fvs)paramViewHolder;
    Object localObject3 = localPAMessage.items;
    paramViewHolder = (ViewGroup)paramLinearLayout.findViewById(2131297087);
    Object localObject1 = (ImageView)paramLinearLayout.findViewById(2131297089);
    TextView localTextView1 = (TextView)paramLinearLayout.findViewById(2131297088);
    TextView localTextView2 = (TextView)paramLinearLayout.findViewById(2131297090);
    TextView localTextView3 = (TextView)paramLinearLayout.findViewById(2131297092);
    TextView localTextView4 = (TextView)paramLinearLayout.findViewById(2131297093);
    TextView localTextView5 = (TextView)paramLinearLayout.findViewById(2131297094);
    TextView localTextView6 = (TextView)paramLinearLayout.findViewById(2131297095);
    ...
    if ((!TextUtils.isEmpty(paramMessageRecord.d)) && (paramMessageRecord.d.contains("1")))
    {
      ...
      if ((localObject2 instanceof ViewGroup.MarginLayoutParams))
      {
        ...
        ((ViewGroup.MarginLayoutParams)localObject2).rightMargin = AIOUtils.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
