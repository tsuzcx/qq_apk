...
public class DiscussChatPie
  extends BaseChatPie
{
  private final String K = "DiscussChatPie";
  ...
  public DiscussChatPie(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppDiscussionObserver = new gaa(this);
    this.jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new gab(this);
  }
  ...
  {
    if (((TroopGagMgr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true).a) {}
    do
    {
      do
      {
  ...
  protected void l()
  {
    this.c.setOnClickListener(new fzz(this));
    this.c.setVisibility(8);
    this.c.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131366082));
  }
