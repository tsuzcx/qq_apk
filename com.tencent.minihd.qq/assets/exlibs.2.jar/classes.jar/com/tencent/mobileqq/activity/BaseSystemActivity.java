  ...
  implements Observer
{
  ...
  private void c()
  {
    setContentView(2130904038);
    setContentBackgroundResource(2130837687);
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131300609));
  ...
  protected View onCreateRightView()
  {
    ...
    this.rightViewText.setCompoundDrawablesWithIntrinsicBounds(2130842078, 0, 0, 0);
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    if ((paramObject != null) && ((paramObject instanceof MessageRecord)))
    {
      ...
      if ((this.jdField_a_of_type_JavaLangString.equals(paramObservable.frienduin)) && (paramObservable.istroop == 0))
      {
        ...
        runOnUiThread(new dke(this));
      }
      if (!paramObservable.isSendFromLocal()) {
        runOnUiThread(new dkf(this));
      }
    }
  }
}
