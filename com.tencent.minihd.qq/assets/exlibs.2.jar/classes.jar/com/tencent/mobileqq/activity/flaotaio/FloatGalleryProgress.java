...
public class FloatGalleryProgress
{
  ...
  public void a(Context paramContext, ImageView paramImageView)
  {
    this.jdField_a_of_type_AndroidWidgetImageView = paramImageView;
    paramImageView = null;
    try
    {
      localObject = BitmapFactory.decodeResource(paramContext.getResources(), 2130841318);
    ...
    localObject = paramImageView;
    if (paramImageView == null) {
      localObject = Bitmap.createBitmap(4, 4, Bitmap.Config.ARGB_8888);
    }
    this.jdField_a_of_type_ComTencentMobileqqWidgetPhotoProgressDrawable = new PhotoProgressDrawable((Bitmap)localObject, (int)(paramContext.getResources().getDisplayMetrics().density * 12.0F));
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.flaotaio.FloatGalleryProgress
