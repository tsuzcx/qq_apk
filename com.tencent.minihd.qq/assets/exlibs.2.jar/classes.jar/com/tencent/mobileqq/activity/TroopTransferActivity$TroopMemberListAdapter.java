  ...
  extends FacePreloadBaseAdapter
{
  ...
  public TroopTransferActivity$TroopMemberListAdapter(TroopTransferActivity paramTroopTransferActivity, Context paramContext, ArrayList paramArrayList)
  {
    ...
    new fli(this, paramTroopTransferActivity).start();
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 0) {
      if (paramView == null)
      {
        paramViewGroup = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903362, paramViewGroup, false);
        paramView = new flk(null);
        paramView.d = null;
        ...
        paramView.jdField_a_of_type_AndroidWidgetTextView.setText(2131365819);
      }
    }
    label256:
    for (;;)
    {
      ...
      Object localObject = (flk)paramView.getTag();
      ...
      {
        paramView.jdField_a_of_type_AndroidWidgetTextView.setText(2131367727);
      }
      else
      {
        ...
        if (i == 1)
        {
          if (paramView == null)
          {
            paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130904501, paramViewGroup, false);
            paramView.findViewById(2131302361).setVisibility(8);
            paramView.findViewById(2131302314).setVisibility(8);
