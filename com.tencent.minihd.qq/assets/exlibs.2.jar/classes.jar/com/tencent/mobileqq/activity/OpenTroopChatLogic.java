...
public class OpenTroopChatLogic
{
  ...
  public OpenTroopChatLogic(SessionInfo paramSessionInfo, BaseActivity paramBaseActivity)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppBizTroopObserver = new eop(this);
    this.jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new eoq(this);
  ...
  public void a()
  {
    ...
    this.jdField_c_of_type_Boolean = false;
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new eor(this), 1000L);
  ...
  public void b(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      paramChatMessage = PicBusiManager.a(4, localMessageForPic.busiType);
