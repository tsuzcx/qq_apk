  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2130903374, null);
      paramView = new goz(null);
      paramView.a = ((TextView)localView.findViewById(2131296554));
    ...
    for (;;)
    {
      ...
      return localView;
      paramViewGroup = (goz)paramView.getTag();
      localView = paramView;
    }
  }
}
