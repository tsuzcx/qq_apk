  ...
  implements TipsBarTask
{
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2130903088, null);
    paramVarArgs.setOnClickListener(new gdr(this));
    ((TextView)paramVarArgs.findViewById(2131296769)).setText(this.jdField_a_of_type_JavaLangString);
    return paramVarArgs;
  }
