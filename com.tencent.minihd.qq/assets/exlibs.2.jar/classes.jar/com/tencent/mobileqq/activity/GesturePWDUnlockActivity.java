  ...
  extends BaseActivity
{
  ...
  public long a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new edc(this);
  private Handler jdField_a_of_type_AndroidOsHandler = new edb(this);
  private View jdField_a_of_type_AndroidViewView;
  private Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new edk(this);
  public ImageView a;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new edj(this);
  ...
  {
    setTitle(2131368429);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131297771));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131297772));
    this.jdField_a_of_type_ComTencentMobileqqGesturelockLockPatternView = ((LockPatternView)findViewById(2131297773));
    ...
    this.jdField_a_of_type_ComTencentMobileqqGesturelockLockPatternView.setOnPatternListener(new edd(this));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131297770));
    Object localObject1;
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131297775));
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(new ede(this));
    ...
    if ((this.jdField_e_of_type_Int > 0) && (this.jdField_e_of_type_Int < 5))
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(getResources().getColor(2131427719));
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new edf(this), 500L);
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new edg(this), 500L);
    if ((this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog != null) && (this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.isShowing())) {
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this, 231, getString(2131368445), getString(2131368446), new edh(this), null);
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnDismissListener(new edi(this));
  ...
  public void finish()
  {
    ...
    super.finish();
    overridePendingTransition(2130968592, 2130968628);
  }
