  ...
  implements AdapterView.OnItemClickListener
{
  ...
  private TroopObserver jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new ezy(this);
  private TroopInfo jdField_a_of_type_ComTencentMobileqqDataTroopInfo;
  private QQProgressDialog jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog;
  private XListView jdField_a_of_type_ComTencentWidgetXListView;
  private fac jdField_a_of_type_Fac;
  private ArrayList jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private HashMap jdField_a_of_type_JavaUtilHashMap = new HashMap();
  public HashSet a;
  public boolean a;
  private TroopObserver jdField_b_of_type_ComTencentMobileqqAppTroopObserver = new ezz(this);
  ...
  public SetTroopAdminsActivity()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new faa(this);
    this.jdField_a_of_type_AndroidOsHandler = new fab(this);
  }
  ...
  private void a()
  {
    ...
    {
      localObject = getString(2131365819);
      localTextView.setText((CharSequence)localObject);
      return;
    }
    localObject = new StringBuilder(getString(2131365819)).append("(");
  ...
  public fae a(String paramString)
  {
    ...
    while (i < j)
    {
      ...
      if ((((View)localObject).getTag() != null) && ((((View)localObject).getTag() instanceof fae)))
      {
        localObject = (fae)((View)localObject).getTag();
        if ((((fae)localObject).b != null) && (((fae)localObject).b.equals(paramString)))
        {
  ...
  public void a(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_Fac.getCount()))
    {
      localTroopAdmin = (SetTroopAdminsActivity.TroopAdmin)this.jdField_a_of_type_Fac.getItem(paramInt);
      paramView = null;
  ...
  protected void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    a(2131365839);
    ((TroopHandler)this.app.a(19)).a((byte)1, str1, str2);
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131297503));
      this.jdField_a_of_type_AndroidViewView = getLayoutInflater().inflate(2130904476, this.jdField_a_of_type_ComTencentWidgetXListView, false);
      this.jdField_a_of_type_ComTencentWidgetXListView.b(this.jdField_a_of_type_AndroidViewView);
      this.jdField_a_of_type_ComTencentWidgetXListView.setDividerHeight(0);
      this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(this);
      this.jdField_a_of_type_Fac = new fac(this, this, this.app, this.jdField_a_of_type_ComTencentWidgetXListView);
      this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Fac);
      this.rightViewText.setOnClickListener(new ezv(this));
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new ezw(this));
      ...
      if (this.jdField_g_of_type_Int > 0)
      {
        ...
        StringBuilder localStringBuilder = new StringBuilder(getString(2131365819)).append("(");
        i = j;
        if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0) {
  ...
  protected void doOnDestroy()
  {
    ...
    if (this.jdField_a_of_type_Fac != null) {
      this.jdField_a_of_type_Fac.b();
    }
    super.doOnDestroy();
  }
