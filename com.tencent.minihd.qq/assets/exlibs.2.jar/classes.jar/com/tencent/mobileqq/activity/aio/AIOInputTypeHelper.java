...
public class AIOInputTypeHelper
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    //   6: ifne +7 -> 13
    //   9: aload_0
    //   10: invokestatic 74	com/tencent/mobileqq/activity/aio/AIOInputTypeHelper:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   13: aload_0
    //   14: ifnull +74 -> 88
    //   17: iload_1
    //   18: ifeq +70 -> 88
    ...
    //   62: astore_0
    //   63: invokestatic 79	com/tencent/util/VersionUtils:c	()Z
    //   66: ifeq +26 -> 92
    //   69: aload_0
    //   70: invokeinterface 83 1 0
    //   75: ldc 18
    //   77: iconst_1
    //   78: invokeinterface 89 3 0
    //   83: invokeinterface 92 1 0
    //   88: ldc 2
    //   90: monitorexit
    //   91: return
    //   92: invokestatic 97	com/tencent/mobileqq/app/ThreadManager:a	()Landroid/os/Handler;
    //   95: new 99	fop
    //   98: dup
    //   99: aload_0
    //   100: invokespecial 102	fop:<init>	(Landroid/content/SharedPreferences;)V
    //   103: invokevirtual 108	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   106: pop
    //   107: goto -19 -> 88
    //   110: astore_0
    //   111: ldc 2
    ...
    for (;;)
    {
      try
      {
        ...
        if (VersionUtils.c()) {
          ...
          ThreadManager.a().post(new fon(paramQQAppInterface));
        }
      }
      finally {}
    }
