  ...
  extends AIOAnimationConatiner.AIOAnimator
{
    ...
    if (paramLong == 0L)
    {
      ...
      while (i1 < this.jdField_a_of_type_ComTencentWidgetListView.getChildCount())
      {
        ...
        if ((localObject1 instanceof BaseChatItemLayout))
        {
          ...
          if ((((BaseBubbleBuilder.ViewHolder)localObject2).jdField_a_of_type_Int != 0) && (((BaseBubbleBuilder.ViewHolder)localObject2).c.getTop() + ((View)localObject1).getTop() + BaseChatItemLayout.i > 0)) {
  ...
  int a(int paramInt, BaseBubbleBuilder.ViewHolder paramViewHolder)
  {
    ...
    {
      i1 = paramViewHolder.c.getLeft() + BaseChatItemLayout.l + BaseChatItemLayout.q;
      i2 = paramViewHolder.c.getRight() - BaseChatItemLayout.k - BaseChatItemLayout.p;
      if (paramInt > i1) {
        break label129;
      }
    ...
    {
      return i3;
      i1 = paramViewHolder.c.getLeft() + BaseChatItemLayout.k + BaseChatItemLayout.p;
      i2 = paramViewHolder.c.getRight() - BaseChatItemLayout.l - BaseChatItemLayout.l;
      break;
    ...
    case 3: 
      ...
      if (this.jdField_b_of_type_Int == 1)
      {
        ...
        if (localBaseChatItemLayout != null)
        {
          ...
          if (localViewHolder != null)
          {
            ...
            this.j = 0;
            i1 = localViewHolder.c.getTop();
            this.k = (localBaseChatItemLayout.getTop() + i1 + BaseChatItemLayout.i - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY());
            this.l = a((localViewHolder.c.getLeft() + localViewHolder.c.getRight()) / 2, localViewHolder);
            this.m = 0;
            this.e = 0.0F;
      ...
      if (localBaseChatItemLayout != null)
      {
        ...
        if (localViewHolder != null)
        {
          ...
          this.k = (localViewHolder.c.getTop() + localBaseChatItemLayout.getTop() + BaseChatItemLayout.i - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - this.m);
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner == null) || (this.jdField_a_of_type_AndroidViewView == null))
      {
        ...
        else
        {
          ...
          {
            i1 = localViewHolder.c.getTop();
            i1 = localViewHolder.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + i1 + BaseChatItemLayout.i - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.m + this.k);
            if (i1 != 0)
            {
              this.m += i1;
              this.o += i1;
