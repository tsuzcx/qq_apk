  ...
  public Drawable c()
  {
    for (;;)
    {
      try
      {
        ...
        localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageData.a(4);
        localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
        localURLDrawableOptions.mLoadingDrawable = URLDrawableHelper.d;
        localURLDrawableOptions.mFailedDrawable = URLDrawableHelper.d;
        ...
        localObject1 = URLDrawable.getDrawable(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageData.a(2), localURLDrawableOptions);
      }
      ...
      this.h = a((Rect)localObject3, (Drawable)localObject1);
      return localObject1;
      if ((localObject3 != null) && (BaseApplicationImpl.a.get(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageData.a(4)) != null))
      {
        if (ImageUtil.c(((File)localObject3).getAbsolutePath()) != 0) {
          break label226;
        }
        localObject1 = URLDrawable.getDrawable(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageData.a(4), localURLDrawableOptions);
      }
      else
      {
        ...
        localObject1 = URLDrawable.getDrawable(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageData.a(1), localURLDrawableOptions);
