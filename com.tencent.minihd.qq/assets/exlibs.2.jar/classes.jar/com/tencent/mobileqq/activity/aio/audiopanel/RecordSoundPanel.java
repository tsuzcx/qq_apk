  ...
  implements View.OnClickListener, AudioPanelCallback, QQRecorder.OnQQRecorderListener
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new fsu(this, Looper.getMainLooper());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new fsx(this));
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new fta(this, paramInt));
  }
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new fsw(this, paramString));
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
    this.jdField_a_of_type_AndroidOsHandler.post(new ftb(this));
  }
  ...
  public void a(String paramString, byte[] paramArrayOfByte, int paramInt, double paramDouble)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new fsz(this, paramInt, paramDouble));
  }
  ...
  public void b(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Double < 1000.0D)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new ftc(this));
    }
    int i;
    do
    {
      ...
      if (i == 2)
      {
        this.jdField_a_of_type_AndroidOsHandler.post(new ftd(this, paramString));
        return;
      }
    } while (i != 1);
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(paramString, 3);
    this.jdField_a_of_type_AndroidOsHandler.post(new fsv(this, paramString));
  }
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new fsy(this));
  }
