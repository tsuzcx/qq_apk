  ...
  extends IphoneTitleBarActivity
{
  ...
  {
    setTitle(2131368429);
    setLeftButton(2131365736, new ecr(this));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131297752));
    this.jdField_a_of_type_ComTencentMobileqqGesturelockLockPatternView = ((LockPatternView)findViewById(2131297754));
    ...
    this.jdField_a_of_type_ComTencentMobileqqGesturelockLockPatternView.setOnPatternListener(new ecs(this));
    ...
    this.jdField_a_of_type_AndroidViewView = findViewById(2131297742);
    this.jdField_b_of_type_AndroidViewView = findViewById(2131297743);
    this.c = findViewById(2131297744);
    this.d = findViewById(2131297745);
    this.e = findViewById(2131297746);
    this.f = findViewById(2131297747);
    this.g = findViewById(2131297748);
    this.h = findViewById(2131297749);
    this.i = findViewById(2131297750);
  }
  ...
  private void d()
  {
    if ((this.jdField_a_of_type_ArrayOfInt != null) && (this.jdField_a_of_type_ArrayOfInt.length == 9))
    {
      ...
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130840326);
      if (this.jdField_a_of_type_ArrayOfInt[1] != 1) {
        break label204;
      }
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130840326);
      label55:
      if (this.jdField_a_of_type_ArrayOfInt[2] != 1) {
        break label216;
      }
      this.c.setBackgroundResource(2130840326);
      label74:
      if (this.jdField_a_of_type_ArrayOfInt[3] != 1) {
        break label228;
      }
      this.d.setBackgroundResource(2130840326);
      label93:
      if (this.jdField_a_of_type_ArrayOfInt[4] != 1) {
        break label240;
      }
      this.e.setBackgroundResource(2130840326);
      label112:
      if (this.jdField_a_of_type_ArrayOfInt[5] != 1) {
        break label252;
      }
      this.f.setBackgroundResource(2130840326);
      label131:
      if (this.jdField_a_of_type_ArrayOfInt[6] != 1) {
        break label264;
      }
      this.g.setBackgroundResource(2130840326);
      label151:
      if (this.jdField_a_of_type_ArrayOfInt[7] != 1) {
        break label276;
      }
      this.h.setBackgroundResource(2130840326);
    }
    for (;;)
    {
      ...
      this.i.setBackgroundResource(2130840326);
      return;
      label192:
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130840325);
      break;
      label204:
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130840325);
      break label55;
      label216:
      this.c.setBackgroundResource(2130840325);
      break label74;
      label228:
      this.d.setBackgroundResource(2130840325);
      break label93;
      label240:
      this.e.setBackgroundResource(2130840325);
      break label112;
      label252:
      this.f.setBackgroundResource(2130840325);
      break label131;
      label264:
      this.g.setBackgroundResource(2130840325);
      break label151;
      label276:
      this.h.setBackgroundResource(2130840325);
    }
    label288:
    this.i.setBackgroundResource(2130840325);
  }
  ...
  {
    super.finish();
    overridePendingTransition(2130968592, 2130968596);
  }
}
