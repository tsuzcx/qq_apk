  ...
  implements ViewPager.OnPageChangeListener, View.OnClickListener
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (m < n)
        {
          ...
          if (((View)localObject1).getId() == 2131297028) {}
          for (;;)
          {
            m += 1;
            break label107;
  ...
  public void a(QQAppInterface paramQQAppInterface, BaseChatPie paramBaseChatPie, SessionInfo paramSessionInfo, InputLinearLayout paramInputLinearLayout)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelAudioPanelViewPager = ((AudioPanelViewPager)findViewById(2131299756));
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)findViewById(2131299757));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131299760));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131299761));
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)findViewById(2131299759));
    ...
    paramQQAppInterface = getResources().getDrawable(2130841714);
  ...
  public void onClick(View paramView)
  {
    ...
    while ((m != 2131299761) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelAudioPanelViewPager.getCurrentItem() == 1)) {
      return;
    }
