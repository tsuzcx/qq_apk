  ...
  extends AIOAnimationConatiner.AIOAnimator
{
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    if (i > 0)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[3] = this.jdField_a_of_type_ComTencentWidgetListView.getResources().getDrawable(2130837552);
      ...
      this.jdField_a_of_type_AndroidViewView = new fre(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      this.jdField_b_of_type_AndroidViewView = new fre(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      ...
      if (a(this.jdField_a_of_type_Long))
      {
        ...
        ((AnimatorSet)localObject3).addListener(new fqz(this));
    ...
    for (;;)
    {
      ...
      paramVarArgs.setAnimationListener(new frb(this));
      paramVarArgs = new frd(this);
      paramVarArgs.setDuration(1000L);
      paramVarArgs.setFillAfter(true);
