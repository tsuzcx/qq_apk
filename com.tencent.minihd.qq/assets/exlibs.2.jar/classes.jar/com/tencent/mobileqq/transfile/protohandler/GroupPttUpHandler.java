  ...
  extends BaseHandler
{
  ...
  public void a(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramProtoResp = ((cmd0x388.RspBody)new cmd0x388.RspBody().mergeFrom((byte[])localObject2)).rpt_msg_tryup_ptt_rsp.get();
        ...
        for (;;)
        {
          ...
          if ((localList != null) && (localList.size() > 0))
          {
            ...
            if (i < localList.size())
            {
              ...
              l2 = ((Integer)((List)localObject3).get(i)).intValue();
          ...
          if ((localObject3 == null) || (((String)localObject3).equals("")) || (localList == null) || (localList.size() == 0)) {
            throw new Exception("check ukey,iplist");
          }
          ((RichProto.RichProtoResp.GroupPttUpResp)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject3);
