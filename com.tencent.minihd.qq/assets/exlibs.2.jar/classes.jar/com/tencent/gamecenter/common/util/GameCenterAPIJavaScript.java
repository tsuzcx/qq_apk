  ...
  extends WebViewPlugin
{
  ...
  public String getOpenidBatch(String paramString)
  {
    ...
    if ((this.mContext instanceof GameCenterActivity)) {
      str = GameCenterActivity.a(this.mContext, "https://cgi.connect.qq.com/api/get_openids_by_appids", paramString, ((GameCenterActivity)this.mContext).c(), this.uin);
    }
    return str;
  }
  ...
  {
    if ((this.mContext instanceof GameCenterActivity)) {
      return ((GameCenterActivity)this.mContext).b();
    }
    return "";
  }
