...
public abstract interface IVideoEventListener
{
  ...
  public abstract void dataTransfered(int paramInt, long paramLong);
  
  public abstract int getAPAndGateWayIP();
  
  public abstract long getMsfInviteTimeStamp(long paramLong);
  ...
  public abstract void onApptypeNotSuit(String paramString);
  ...
  public abstract void onChannelReady(String paramString);
  ...
  public abstract void onNetworkMonitorInfo(String paramString, byte[] paramArrayOfByte1, long paramLong, byte[] paramArrayOfByte2);
  ...
  public abstract void onPeerSwitchTerninal(String paramString);
  
  public abstract void onPstnCallConnected(String paramString, int paramInt, long paramLong, byte[] paramArrayOfByte);
  
  public abstract void onReceiveC2CMsg(String paramString, int paramInt, byte[] paramArrayOfByte);
  
  public abstract void onReceiveDoodle(byte[] paramArrayOfByte);
  
  public abstract void onReceiveFirstVideoFrame(String paramString);
  
  public abstract void onReceiveFucMultiFaceExp(String paramString);
  
  public abstract void onReceiveFucMultiMode(String paramString);
  
  public abstract void onReceiveFucMultiVolumeExp(String paramString);
  
  public abstract void onReceiveMagicface(int paramInt, String paramString);
  
  public abstract void onReceiveRecordMsg(String paramString1, String paramString2);
  
  public abstract void onReceiveSubtitleChanged(int paramInt, String paramString);
  ...
  public abstract void onSwitchTerminalSuccess(String paramString, int paramInt);
