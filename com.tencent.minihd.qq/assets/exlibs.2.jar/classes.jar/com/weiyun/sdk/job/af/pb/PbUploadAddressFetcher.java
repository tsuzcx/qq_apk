  ...
  extends UploadAddressFetcher
{
  ...
  protected int sendRequest()
  {
    ...
    if (SdkContext.getInstance().getSender().sendRequest("OfflineFilleHandleSvr.pb_weiyun_CMD_REQ_UPLOAD2QCLOUD-5", localReqBody.toByteArray(), new UploadFileRequestCallback()) == true) {
      return 0;
    }
    return -10011;
  }
