...
{
  public ccy(BmqqProfileCardActivity paramBmqqProfileCardActivity) {}
  ...
  public boolean onPreDraw()
  {
    if (BmqqSegmentUtil.b(this.a.getApplicationContext(), this.a.a.mBmqqUin))
    {
      ...
      localImageView.setBackgroundResource(2130837688);
      ...
      if (this.a.a.isCertified())
      {
        ...
        ((RelativeLayout.LayoutParams)localObject2).addRule(1, 2131296820);
        localObject1 = new ImageView(this.a);
        ((ImageView)localObject1).setBackgroundResource(2130839260);
        this.a.jdField_b_of_type_AndroidWidgetRelativeLayout.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
        localObject2 = (ImageView)this.a.findViewById(2131296816);
      ...
      this.a.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new ccz(this));
    }
