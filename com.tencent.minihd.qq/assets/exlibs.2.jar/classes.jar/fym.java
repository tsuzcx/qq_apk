...
public final class fym
  extends AsyncTask
{
  public fym(Context paramContext, int paramInt, QQAppInterface paramQQAppInterface, URLDrawable paramURLDrawable, String paramString) {}
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    paramVarArgs = AppConstants.aM + (String)localObject1 + paramVarArgs + ".jpg";
  ...
  protected void a(Integer paramInteger)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), this.jdField_a_of_type_AndroidContentContext.getString(2131367028), 0).b(this.jdField_a_of_type_Int);
    ...
    do
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), this.jdField_a_of_type_AndroidContentContext.getString(2131367114), 0).b(this.jdField_a_of_type_Int);
        return;
      }
    } while (paramInteger.intValue() != 2);
    QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), this.jdField_a_of_type_AndroidContentContext.getString(2131367032), 0).b(this.jdField_a_of_type_Int);
  }
}
