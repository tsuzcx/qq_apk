...
{
  public dvr(DiscussionInfoCardActivity paramDiscussionInfoCardActivity) {}
  ...
  protected void a(boolean paramBoolean, long paramLong, ArrayList paramArrayList)
  {
    if ((paramBoolean) && (paramArrayList != null) && (paramArrayList.size() > 0) && (paramLong == Long.valueOf(DiscussionInfoCardActivity.a(this.a)).longValue()))
    {
      ...
      this.a.a(2, this.a.getString(2131367794));
  ...
  protected void a(boolean paramBoolean, Long paramLong1, Long paramLong2)
  {
    ...
    QQToast.a(this.a, 1, this.a.getString(2131366625), 0).b(this.a.getTitleBarHeight());
  }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    if (DiscussionInfoCardActivity.a(this.a).equals(paramString))
    {
      ...
      {
        DiscussionInfoCardActivity.a(this.a).a(this.a.getString(2131367798));
        DiscussionInfoCardActivity.a(this.a).c(2130838252);
    ...
    DiscussionInfoCardActivity.a(this.a).a(this.a.getString(2131367799));
    DiscussionInfoCardActivity.a(this.a).c(2130838242);
    DiscussionInfoCardActivity.a(this.a).b(false);
  ...
  protected void a(Object[] paramArrayOfObject)
  {
    ...
    if ((paramArrayOfObject == null) || (paramArrayOfObject.trim().equals(""))) {
      paramArrayOfObject = this.a.getString(2131367800);
    }
    for (;;)
    {
      ...
      {
        if ((10001 == i) || (10002 == i)) {
          DialogUtil.a(this.a, 230, null, paramArrayOfObject, new dvs(this, str), null).show();
        }
      }
      else {
        return;
  ...
  protected void b(boolean paramBoolean, String paramString)
  {
    if (DiscussionInfoCardActivity.a(this.a).equals(paramString))
    {
      ...
      if ((DiscussionInfoCardActivity.a(this.a) != null) && (DiscussionInfoCardActivity.a(this.a).isShowing()) && (!this.a.isFinishing()))
      {
        DiscussionInfoCardActivity.a(this.a).a(this.a.getString(2131367791));
        DiscussionInfoCardActivity.a(this.a).c(2130838252);
        DiscussionInfoCardActivity.a(this.a).b(false);
        this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(17, 1500L);
      }
    ...
    DiscussionInfoCardActivity.a(this.a).a(this.a.getString(2131367792));
    DiscussionInfoCardActivity.a(this.a).c(2130838252);
    DiscussionInfoCardActivity.a(this.a).b(false);
    this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(17, 1500L);
  }
