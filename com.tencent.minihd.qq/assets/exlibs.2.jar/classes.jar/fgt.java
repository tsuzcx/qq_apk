...
{
  public fgt(TroopGagActivity paramTroopGagActivity) {}
  ...
  protected void a(TroopGagMgr.GagStatus paramGagStatus)
  {
    ...
    if (paramGagStatus.jdField_a_of_type_Int == 3)
    {
      ...
      this.a.jdField_a_of_type_Fgv.notifyDataSetChanged();
    }
    while (this.a.jdField_a_of_type_JavaUtilList.size() == 0)
    {
      ...
      if (paramGagStatus.jdField_a_of_type_Int == 5)
      {
        ...
        {
          paramGagStatus = ((TroopGagMgr)this.a.app.getManager(47)).a(this.a.jdField_a_of_type_JavaLangString, false);
