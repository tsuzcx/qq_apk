...
{
  public lca(QuickLoginAuthorityActivity paramQuickLoginAuthorityActivity) {}
  ...
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    if (paramInt2 == -1000)
    {
      this.a.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.a(this.a, this.a.getResources().getString(2131368093));
      return;
    }
    paramBundle = (ErrMsg)paramBundle.getParcelable("lastError");
    Context localContext = BaseApplicationImpl.getContext();
    if (paramBundle == null) {}
    for (paramBundle = this.a.getString(2131368100);; paramBundle = paramBundle.getMessage())
    {
      QQToast.a(localContext, paramBundle, 0).a();
