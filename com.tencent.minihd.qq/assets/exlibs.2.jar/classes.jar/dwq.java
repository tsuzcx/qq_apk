  ...
  implements TextWatcher
{
  ...
  public dwq(EditActivity paramEditActivity) {}
  ...
  public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityEditActivity.u == 100) && (this.jdField_c_of_type_JavaLangString.contains("\n")))
      {
