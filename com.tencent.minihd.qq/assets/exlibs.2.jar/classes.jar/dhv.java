...
{
  private dhv(AutoRemarkActivity paramAutoRemarkActivity) {}
  
  protected void a(String paramString, byte paramByte1, byte paramByte2)
  {
    if (((this.a.e == 2) && (paramString == null) && (this.a.f.equals(this.a.app.a()))) || ((paramString != null) && (paramString.equals(this.a.f))))
    {
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.dismiss();
      QQToast.a(this.a, 2, 2131366996, 0).b(this.a.getTitleBarHeight());
  ...
  protected void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    {
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.dismiss();
      QQToast.a(this.a, 1, 2131366997, 0).b(this.a.getTitleBarHeight());
      return;
    }
  ...
  {
    if ((this.a.e == 2) && (TextUtils.equals(paramString1, this.a.f)))
    {
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        AutoRemarkActivity.a(this.a).setContentDescription(this.a.getResources().getString(2131366181) + this.a.jdField_a_of_type_AndroidWidgetEditText.getText().toString());
        this.a.g = paramInt;
      ...
      do
      {
        do
        {
          ...
          if (paramBundle.getInt("resultCode") == 0)
          {
            ...
            case 100: 
              this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.dismiss();
              QQToast.a(this.a.getActivity(), 2, 2131367794, 0).b(this.a.getTitleBarHeight());
              this.a.a();
              return;
            }
            this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.dismiss();
        ...
        return;
        QQToast.a(this.a, 1, 2131366995, 0).b(this.a.getTitleBarHeight());
      } while (!QLog.isColorLevel());
