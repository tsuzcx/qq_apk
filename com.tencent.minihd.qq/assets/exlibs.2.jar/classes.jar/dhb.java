...
{
  public dhb(AuthDevActivity paramAuthDevActivity) {}
  ...
  protected void a(boolean paramBoolean, SvcRspGetDevLoginInfo paramSvcRspGetDevLoginInfo)
  {
    ...
    for (;;)
    {
      ...
      QQToast.a(this.a, 1, this.a.getString(2131368887), 0).b(this.a.getTitleBarHeight());
      return;
      label312:
  ...
  protected void b(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    {
      QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131368888), 0).b(this.a.getTitleBarHeight());
      return;
    }
