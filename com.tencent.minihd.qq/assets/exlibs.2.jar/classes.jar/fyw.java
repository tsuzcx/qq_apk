  ...
  extends AsyncTask
{
  ...
  public fyw(AIOImageListScene paramAIOImageListScene, ArrayList paramArrayList)
  {
  ...
  protected Integer a(Integer... paramVarArgs)
  {
    ...
    //   46: istore 4
    //   48: aload_0
    //   49: getfield 44	fyw:jdField_a_of_type_Boolean	Z
    //   52: ifne +8 -> 60
    //   55: iconst_1
    ...
    //   86: aastore
    //   87: invokevirtual 104	fyw:publishProgress	([Ljava/lang/Object;)V
    //   90: iload 4
    //   92: tableswitch	default:+684 -> 776, 0:+691->783, 1:+349->441, 2:+691->783
    //   121: aload_0
    //   122: getfield 55	fyw:jdField_a_of_type_ArrayOfComTencentMobileqqActivityAioPhotoAIOImageInfo	[Lcom/tencent/mobileqq/activity/aio/photo/AIOImageInfo;
    //   125: arraylength
    //   126: if_icmpge +203 -> 329
    //   129: aload_0
    //   130: getfield 44	fyw:jdField_a_of_type_Boolean	Z
    //   133: ifne +8 -> 141
    //   136: iconst_1
    ...
    //   161: idiv
    //   162: aload_0
    //   163: getfield 55	fyw:jdField_a_of_type_ArrayOfComTencentMobileqqActivityAioPhotoAIOImageInfo	[Lcom/tencent/mobileqq/activity/aio/photo/AIOImageInfo;
    //   166: arraylength
    //   167: idiv
    //   168: iadd
    //   169: ldc 100
    ...
    //   181: aastore
    //   182: invokevirtual 104	fyw:publishProgress	([Ljava/lang/Object;)V
    //   185: aload_0
    //   186: getfield 55	fyw:jdField_a_of_type_ArrayOfComTencentMobileqqActivityAioPhotoAIOImageInfo	[Lcom/tencent/mobileqq/activity/aio/photo/AIOImageInfo;
    //   189: iload_2
    //   190: aaload
    //   191: astore 8
    //   193: aload 8
    ...
    //   198: getfield 112	com/tencent/mobileqq/activity/aio/photo/AIOImageData:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   201: astore 9
    //   203: ldc 114
    //   205: aload 9
    ...
    //   216: aload_0
    //   217: aload 8
    //   219: putfield 122	fyw:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageInfo	Lcom/tencent/mobileqq/activity/aio/photo/AIOImageInfo;
    //   222: aload_0
    //   223: getfield 44	fyw:jdField_a_of_type_Boolean	Z
    //   226: ifeq +127 -> 353
    //   229: aload 9
    //   231: ifnull +28 -> 259
    //   234: aload 9
    ...
    //   256: ifne +97 -> 353
    //   259: aload_0
    //   260: getfield 39	fyw:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageListScene	Lcom/tencent/mobileqq/activity/aio/photo/AIOImageListScene;
    ...
    //   279: getfield 142	com/tencent/mobileqq/activity/aio/photo/AIOImageData:jdField_e_of_type_Int	I
    //   282: iconst_2
    //   283: invokeinterface 147 5 0
    //   288: aload_0
    //   289: getfield 122	fyw:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageInfo	Lcom/tencent/mobileqq/activity/aio/photo/AIOImageInfo;
    //   292: astore 9
    //   294: aload 9
    //   296: monitorenter
    //   297: aload_0
    //   298: getfield 122	fyw:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageInfo	Lcom/tencent/mobileqq/activity/aio/photo/AIOImageInfo;
    //   301: invokevirtual 152	java/lang/Object:wait	()V
    //   304: aload 9
    //   306: monitorexit
    //   307: ldc 154
    //   309: aload_0
    //   310: getfield 122	fyw:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageInfo	Lcom/tencent/mobileqq/activity/aio/photo/AIOImageInfo;
    ...
    //   316: getfield 112	com/tencent/mobileqq/activity/aio/photo/AIOImageData:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   352: areturn
    //   353: aload_0
    //   354: getfield 44	fyw:jdField_a_of_type_Boolean	Z
    //   357: ifne +8 -> 365
    //   360: iconst_1
    ...
    //   412: getfield 112	com/tencent/mobileqq/activity/aio/photo/AIOImageData:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   424: aload_0
    //   425: aload_0
    //   426: getfield 55	fyw:jdField_a_of_type_ArrayOfComTencentMobileqqActivityAioPhotoAIOImageInfo	[Lcom/tencent/mobileqq/activity/aio/photo/AIOImageInfo;
    //   429: arraylength
    //   430: iload_2
    //   431: isub
    //   432: putfield 166	fyw:o	I
    //   435: bipush 11
    ...
    //   475: dup
    //   476: getstatic 184	com/tencent/mobileqq/app/AppConstants:aK	Ljava/lang/String;
    ...
    //   501: iload_2
    //   502: aload_0
    //   503: getfield 55	fyw:jdField_a_of_type_ArrayOfComTencentMobileqqActivityAioPhotoAIOImageInfo	[Lcom/tencent/mobileqq/activity/aio/photo/AIOImageInfo;
    //   506: arraylength
    //   507: if_icmpge +235 -> 742
    //   510: aload_0
    //   511: getfield 55	fyw:jdField_a_of_type_ArrayOfComTencentMobileqqActivityAioPhotoAIOImageInfo	[Lcom/tencent/mobileqq/activity/aio/photo/AIOImageInfo;
    //   514: iload_2
    //   515: aaload
    //   516: astore 9
    //   518: aload_0
    //   519: getfield 44	fyw:jdField_a_of_type_Boolean	Z
    //   522: ifne +8 -> 530
    //   525: iconst_1
    ...
    //   550: idiv
    //   551: aload_0
    //   552: getfield 55	fyw:jdField_a_of_type_ArrayOfComTencentMobileqqActivityAioPhotoAIOImageInfo	[Lcom/tencent/mobileqq/activity/aio/photo/AIOImageInfo;
    //   555: arraylength
    //   556: idiv
    //   557: iadd
    //   558: ldc 100
    ...
    //   570: aastore
    //   571: invokevirtual 104	fyw:publishProgress	([Ljava/lang/Object;)V
    //   574: aload 9
    ...
    //   723: areturn
    //   724: aload_0
    //   725: getfield 39	fyw:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOImageListScene	Lcom/tencent/mobileqq/activity/aio/photo/AIOImageListScene;
