...
public class den
  extends BaseAdapter
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new deo(this);
  
  public den(AddFriendActivity paramAddFriendActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendActivity.getLayoutInflater().inflate(2130904380, null);
      paramView = new dep(null);
    ...
    paramView = (dep)paramViewGroup.getTag();
