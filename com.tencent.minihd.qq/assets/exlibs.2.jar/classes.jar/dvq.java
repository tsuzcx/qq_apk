...
{
  public dvq(DiscussionInfoCardActivity paramDiscussionInfoCardActivity) {}
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        ImageView localImageView = (ImageView)DiscussionInfoCardActivity.a(this.a).getChildAt(i).findViewById(2131296551);
