...
{
  public dhc(AuthDevActivity paramAuthDevActivity) {}
  ...
  public void OnCheckDevLockSms(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    do
    {
      ...
      paramWUserSigInfo = (SecSvcHandler)this.a.app.a(36);
      ...
      QQToast.a(this.a.getApplicationContext(), 2, this.a.getString(2131368862), 0).b(this.a.getTitleBarHeight());
    ...
    QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131368892), 0).b(this.a.getTitleBarHeight());
  }
  ...
  public void OnCloseDevLock(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt == 0)
    {
      ...
      QQToast.a(this.a.getApplicationContext(), 2, this.a.getString(2131368890), 0).b(this.a.getTitleBarHeight());
      paramWUserSigInfo = this.a.app.a(LoginInfoActivity.class);
      if (paramWUserSigInfo != null) {
    ...
    QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131368891), 0).b(this.a.getTitleBarHeight());
  }
}
