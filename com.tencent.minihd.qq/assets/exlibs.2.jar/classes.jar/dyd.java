...
public class dyd
  extends AsyncTask
{
  public dyd(ForwardHandlerActivity paramForwardHandlerActivity, ArrayList paramArrayList) {}
  ...
  private void a(List paramList, int paramInt)
  {
    ...
    {
      return;
      localDataLineHandler = (DataLineHandler)this.jdField_a_of_type_ComTencentMobileqqActivityForwardHandlerActivity.app.a(8);
      j = paramList.size();
      if (j > 3) {
        break;
      }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityForwardHandlerActivity.app.a().a().d();
  }
}
