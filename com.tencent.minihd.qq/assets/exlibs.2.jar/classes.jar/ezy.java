...
{
  public ezy(SetTroopAdminsActivity paramSetTroopAdminsActivity) {}
  ...
  protected void a(int paramInt)
  {
    ...
    case 6: 
    default: 
      str = this.a.getString(2131365842);
    }
    for (;;)
    {
      ...
      {
        str = String.format(this.a.getString(2131365846), new Object[] { Integer.valueOf(SetTroopAdminsActivity.a(this.a)) });
      }
      else
      {
        str = this.a.getString(2131365847);
        continue;
        str = this.a.getString(2131365848);
      }
    }
  }
  ...
  protected void a(String paramString1, String paramString2, byte paramByte)
  {
    ...
    if (paramByte == 0) {
      QQToast.a(this.a, 2, 2131365844, 0).b(this.a.getTitleBarHeight());
    }
    for (;;)
    {
      this.a.setResult(-1);
      return;
      if (paramByte == 1) {
        QQToast.a(this.a, 2, 2131365840, 0).b(this.a.getTitleBarHeight());
      }
    }
  }
}
