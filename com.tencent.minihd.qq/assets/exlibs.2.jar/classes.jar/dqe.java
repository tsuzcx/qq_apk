...
{
  public dqe(ChatSettingForTroop paramChatSettingForTroop) {}
    ...
    do
    {
      for (;;)
      {
        ...
        if (paramInt == 2)
        {
          ...
          if (paramByte == 0)
          {
            this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(5, 2131367798, 1500);
            return;
          }
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131367799, 1500);
          return;
  ...
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData == null) || (this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.jdField_c_of_type_JavaLangString == null) || (!this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.jdField_c_of_type_JavaLangString.equals(paramString))) {}
    while (paramBoolean) {
      return;
    }
  ...
  protected void b(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      ...
      localView = this.a.jdField_a_of_type_ArrayOfAndroidViewView[15].findViewById(2131299346);
    ...
    ((TextView)localView.findViewById(2131297001)).setText(paramString);
  }
  ...
  protected void b(boolean paramBoolean, ArrayList paramArrayList)
  {
    ...
    do
    {
      ...
      for (bool = false;; bool = a(paramArrayList))
      {
        ...
        if ((paramBoolean) || ((this.a.au & 0x1) != 1)) {
          break;
        }
        paramArrayList = this.a;
        paramArrayList.au &= 0xFFFFFFFE;
        this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131366337, 1000);
        return;
      }
    } while ((!bool) || ((this.a.au & 0x1) != 1));
    paramArrayList = this.a;
    paramArrayList.au &= 0xFFFFFFFE;
    this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(1, 2131366336, 1000);
  }
