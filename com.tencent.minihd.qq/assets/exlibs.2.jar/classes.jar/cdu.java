...
public class cdu
{
  ...
  cdu(Context paramContext, String paramString, AsyncCallBack paramAsyncCallBack)
  {
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      {
        a(this.jdField_a_of_type_JavaLangString, 0);
        HtmlOffline.a(this.b, 5, 0L, NetworkUtil.b(this.jdField_a_of_type_AndroidContentContext), "lixian_cover", "0");
        return;
      }
      if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        {
          a(this.jdField_a_of_type_JavaLangString, 0);
          HtmlOffline.a(this.b, i, j, NetworkUtil.b(this.jdField_a_of_type_AndroidContentContext), "lixian_cover", "0");
          return;
          i = 10;
          localObject2 = localObject1;
          continue;
        ...
        else
        {
          ...
          for (;;)
          {
            ...
            for (;;)
            {
              ...
              HtmlOffline.a(this.b, 7, j, NetworkUtil.b(this.jdField_a_of_type_AndroidContentContext), "lixian_cover", "0");
              return;
              continue;
              bool = false;
              break label752;
