...
public class fha
  extends Handler
{
  public fha(TroopInfoActivity paramTroopInfoActivity) {}
      ...
      do
      {
        ...
        do
        {
          ...
          if (paramMessage.what == 4)
          {
            ...
            for (paramMessage = this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.m;; paramMessage = this.a.getResources().getString(2131365797))
            {
