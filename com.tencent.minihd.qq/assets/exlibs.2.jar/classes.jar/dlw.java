...
{
  public dlw(ChatHistory paramChatHistory, String paramString) {}
  
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    paramDialogInterface = this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.d, this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.a);
    ...
    for (long l1 = ((MessageRecord)paramDialogInterface.get(paramDialogInterface.size() - 1)).shmsgseq;; l1 = 0L) {
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app.a().e(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.d, this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.a);
