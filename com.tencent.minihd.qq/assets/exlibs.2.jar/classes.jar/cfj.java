...
{
  public cfj(EnterpriseDetailActivity paramEnterpriseDetailActivity, mobileqq_mp.ConfigInfo paramConfigInfo, Switch paramSwitch, int paramInt, boolean paramBoolean) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      ...
      this.jdField_a_of_type_ComTencentBizEqqEnterpriseDetailActivity.a(2131363617);
        ...
        if (paramBundle != null)
        {
          ...
          if (((mobileqq_mp.RetInfo)localSetFunctionFlagResponse.ret_info.get()).ret_code.get() == 0)
          {
            ...
            if (this.jdField_a_of_type_ComTencentMobileqqMpMobileqq_mp$ConfigInfo.state_id.get() == 5)
            {
              ...
              {
                PubAccountAssistantManager.a().d(this.jdField_a_of_type_ComTencentBizEqqEnterpriseDetailActivity.jdField_a_of_type_ComTencentMobileqqDataEqqDetail.uin, this.jdField_a_of_type_ComTencentBizEqqEnterpriseDetailActivity.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
