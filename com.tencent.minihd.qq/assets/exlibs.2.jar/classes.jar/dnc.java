  ...
  implements View.OnClickListener, OnLongClickAndTouchListener, BubblePopupWindow.OnDismissListener
{
  ...
  private dnc(ChatHistory paramChatHistory) {}
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    localQQCustomMenu.a(2131302479, this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131366320));
    if (localQQCustomMenu.a() > 0)
    {
      this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = ((dnd)ChatHistory.a(paramView)).jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
