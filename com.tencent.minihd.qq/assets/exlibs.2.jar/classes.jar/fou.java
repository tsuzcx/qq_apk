  ...
  implements CompoundButton.OnCheckedChangeListener
{
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    {
      localObject = paramCompoundButton.getContext().getString(2131366112, new Object[] { Integer.valueOf(MultiMsgManager.a().a()) });
    ...
    {
      localObject = paramCompoundButton.getContext().getString(2131366113, new Object[] { Integer.valueOf(MultiMsgManager.a().b()) });
      QQToast.a(paramCompoundButton.getContext(), (CharSequence)localObject, 0).b(((ChatActivity)paramCompoundButton.getContext()).getTitleBarHeight());
      paramCompoundButton.setChecked(false);
      return;
    }
