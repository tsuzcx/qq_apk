  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public dwh(DiscussionMemberActivity paramDiscussionMemberActivity)
  {
  ...
  private void a()
  {
    ...
    {
      dwg localdwg = (dwg)((Iterator)localObject2).next();
      if ((localdwg.c == null) || (localdwg.c.length() == 0))
      {
        localObject1 = "#";
      ...
      for (localObject1 = ((String)localObject1).toUpperCase();; localObject1 = "#")
      {
        ...
        ((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject1)).add(localdwg);
        break;
        localObject1 = localdwg.c.substring(0, 1);
        break label66;
      }
    }
  ...
  public Object getItem(int paramInt)
  {
    ...
    i = -(i + 1) - 1;
    return (dwg)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionMemberActivity.getLayoutInflater().inflate(2130903280, paramViewGroup, false);
      ...
      paramView.d = ((ImageView)localView.findViewById(2131297531));
      paramView.c = ((TextView)localView.findViewById(2131297297));
    }
    paramView = (TroopMemberListActivity.ViewHolder)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      paramViewGroup = (dwg)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
