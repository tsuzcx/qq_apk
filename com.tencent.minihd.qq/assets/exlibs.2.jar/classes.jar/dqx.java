...
{
  public dqx(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        localObject1 = (TroopInfoManager)this.a.app.getManager(36);
    ...
    for (;;)
    {
      ...
      if (((TextView)paramView.findViewById(2131299347)).getVisibility() != 0) {
        break;
      }
