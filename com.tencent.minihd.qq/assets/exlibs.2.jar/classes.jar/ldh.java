...
public final class ldh
  implements Runnable
{
  public ldh(Bundle paramBundle1, Bundle paramBundle2, String paramString1, String paramString2, String paramString3) {}
  ...
  public void run()
  {
    ...
    if (Common.a(this.jdField_a_of_type_AndroidOsBundle.getString("schemaUrl")).get("auto_download") != null)
    {
      ...
      {
        str1 = Common.i() + File.separator + "qapp_center_detail.htm";
    ...
    for (;;)
    {
      ...
      for (str2 = str1;; str2 = str1 + "&" + this.c)
      {
        ...
        break;
        label380:
        localObject = Common.p() + File.separator + "qapp_center_detail.htm";
        break label170;
      }
    }
  }
