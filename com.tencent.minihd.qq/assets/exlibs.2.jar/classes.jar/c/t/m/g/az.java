...
public final class az
{
  ...
  public az(byte[] paramArrayOfByte, byte paramByte)
  {
    this.a = ByteBuffer.wrap(paramArrayOfByte);
    this.a.position(4);
  }
  ...
  public final bb a(bb parambb, int paramInt, boolean paramBoolean)
  {
    a locala = null;
    if (a(paramInt))
    {
      try
      {
        parambb = (bb)parambb.getClass().newInstance();
        locala = new a();
        a(locala, this.a);
        if (locala.a != 10) {
          throw new RuntimeException("type mismatch.");
      ...
      {
        throw new RuntimeException(parambb.getMessage());
      }
      parambb.a(this);
      a();
    }
  ...
  public final Object a(Object paramObject, int paramInt, boolean paramBoolean)
  {
    ...
    if ((paramObject instanceof bb)) {
      return a((bb)paramObject, paramInt, paramBoolean);
    }
