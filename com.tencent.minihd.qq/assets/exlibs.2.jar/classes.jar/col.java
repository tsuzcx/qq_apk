...
{
  public col(TroopBarDetailActivity paramTroopBarDetailActivity) {}
      ...
      try
      {
        ...
        try
        {
          ...
          if (((mobileqq_mp.RetInfo)((mobileqq_mp.UnFollowResponse)localObject).ret_info.get()).ret_code.get() == 0)
          {
            ...
            TroopBarDetailActivity.a(this.a, this.a.jdField_a_of_type_ComTencentMobileqqDataAccountDetail);
