...
{
  public dez(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString, Bundle paramBundle)
  {
    ...
    if (paramBoolean1)
    {
      ...
      for (paramString = paramBundle.getString("ErrorString");; paramString = this.a.getString(2131367006))
      {
        QQToast.a(this.a, 1, paramString, 1).b(this.a.getTitleBarHeight());
        return;
      }
    }
    QQToast.a(this.a, 1, this.a.getString(2131366995), 1).b(this.a.getTitleBarHeight());
  }
}
