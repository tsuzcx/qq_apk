  ...
  extends Thread
{
  ...
  public hbs(VipSpecialSoundWebViewPlugin paramVipSpecialSoundWebViewPlugin)
  {
  ...
  void a()
  {
    for (;;)
    {
      ...
      try
      {
        VipSpecialSoundWebViewPlugin.a(this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareVipSpecialSoundWebViewPlugin, "-->wait " + QvipSpecialSoundConfig.a + " seconds");
        this.jdField_a_of_type_JavaLangObject.wait(QvipSpecialSoundConfig.a * 1000);
