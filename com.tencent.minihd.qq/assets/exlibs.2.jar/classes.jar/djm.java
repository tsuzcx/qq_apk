...
public class djm
  implements Runnable
{
  public djm(BaseChatPie paramBaseChatPie, Activity paramActivity) {}
  ...
  public void run()
  {
    ...
    BaseChatPie.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).setOnTouchListener(new djn(this));
    ...
    localAnimationSet.setAnimationListener(new djo(this));
