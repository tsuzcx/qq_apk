...
public class cad
  implements Runnable
{
  public cad(AuthorizeConfig paramAuthorizeConfig) {}
  ...
  public void run()
  {
    try
    {
      ...
      if (localAppRuntime != null)
      {
        ...
        if ((str2 != null) && (str2.length() > 0) && ("2013 5.9.3".equals(localObject3))) {
        ...
        ((NewIntent)localObject3).setObserver(new cae(this));
    ...
    if (str2 != null)
    {
      ...
      {
        localObject1 = localObject2;
        if ("2013 5.9.3".equals(localObject3))
        {
    ...
    localObject2 = Uri.parse("https://pub.idqqimg.com/qqmobile/config/webview_whitelist2.json").getHost();
    Object localObject3 = MsfSdkUtils.insertMtype("qb_offline", "https://pub.idqqimg.com/qqmobile/config/webview_whitelist2.json");
    int i;
    label421:
    do
    {
