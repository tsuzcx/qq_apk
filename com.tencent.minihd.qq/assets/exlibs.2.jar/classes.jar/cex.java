...
public class cex
  extends BaseAdapter
{
  public cex(EnterpriseDetailActivity paramEnterpriseDetailActivity, int paramInt1, JSONArray paramJSONArray, int paramInt2) {}
  ...
  {
    AsyncImageView localAsyncImageView = new AsyncImageView(this.jdField_a_of_type_ComTencentBizEqqEnterpriseDetailActivity, this.b, this.b);
