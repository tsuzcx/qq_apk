...
{
  public fkx(TroopTransferActivity paramTroopTransferActivity) {}
  ...
  protected void a(boolean paramBoolean, long paramLong, String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramString1 = (TroopManager)this.a.app.getManager(50);
      ...
      paramString1.putExtra("fin_tip_msg", this.a.getString(2131367729));
    ...
    if ((paramInt == 1) || (paramInt == 2) || (paramInt == 6) || (paramInt == 8) || (paramInt == 9) || (paramInt == 10) || (paramInt == 11)) {
      paramString1 = this.a.getString(2131367730);
    }
    for (;;)
    {
      if (this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier == null) {
      ...
      {
        paramString1 = this.a.getString(2131367732);
      }
      else if ((paramInt == 5) || (paramInt == 17) || (paramInt == 18))
      {
        paramString1 = this.a.getString(2131367731);
      }
      else
      {
        if (paramInt == 12)
        {
          ...
          paramString1.setTitle(this.a.getString(2131363964));
          paramString1.setMessage(this.a.getString(2131363967));
          paramString1.setNegativeButton(this.a.getString(2131363963), new fky(this, paramString1));
          paramString1.setPositiveButton(this.a.getString(2131367782), new fkz(this, paramString1));
          paramString1.show();
          return;
        }
        paramString1 = this.a.getString(2131367731);
