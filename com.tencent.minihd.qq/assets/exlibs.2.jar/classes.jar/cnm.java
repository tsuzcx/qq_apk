...
{
  public cnm(AppActivity paramAppActivity, String paramString, QQAppInterface paramQQAppInterface, boolean paramBoolean1, View paramView, boolean paramBoolean2, ScannerView paramScannerView) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if ((paramBoolean) && (paramBundle != null))
    {
      ...
      for (;;)
      {
        ...
        ((QQCustomDialog)localObject1).setTitle(2131363598);
        ((QQCustomDialog)localObject1).setMessage(paramBundle);
        localObject2 = new cnn(this);
        ((QQCustomDialog)localObject1).setPositiveButton(2131365737, new cno(this, paramBundle));
        ((QQCustomDialog)localObject1).setNegativeButton(2131365736, (DialogInterface.OnClickListener)localObject2);
