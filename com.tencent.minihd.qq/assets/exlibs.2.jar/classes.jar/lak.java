...
{
  public lak(AuthorityActivity paramAuthorityActivity) {}
    ...
    for (str = "s_a_a_emp";; str = "s_a_a")
    {
      ...
      for (;;)
      {
        ...
        catch (Exception paramBundle)
        {
          ...
          ((Message)localObject1).obj = this.a.getResources().getString(2131368093);
        ...
        paramBundle.obj = this.a.getResources().getString(2131368093);
        this.a.jdField_a_of_type_AndroidOsHandler.sendMessage(paramBundle);
        paramBundle = this.a.getResources().getString(2131368093);
        try
        {
