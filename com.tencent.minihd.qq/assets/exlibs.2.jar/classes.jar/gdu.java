...
public class gdu
  implements Runnable
{
  public gdu(TroopAssistTipsBar paramTroopAssistTipsBar) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      if (TroopAssistTipsBar.a(this.a).getIntent() != null)
      {
        ...
        boolean bool = ((HotChatManager)TroopAssistTipsBar.a(this.a).getManager(58)).d(TroopAssistTipsBar.a(this.a).jdField_a_of_type_JavaLangString);
        ...
        if ((i > 99) && (!TroopAssistantManager.a().b(TroopAssistTipsBar.a(this.a), TroopAssistTipsBar.a(this.a).jdField_a_of_type_JavaLangString)) && (TroopAssistTipsBar.a(this.a).b(TroopAssistTipsBar.a(this.a).jdField_a_of_type_JavaLangString) == 1) && (!localFriendManager.f(TroopAssistTipsBar.a(this.a).jdField_a_of_type_JavaLangString)) && (!bool)) {
          if (i <= 200) {}
        }
