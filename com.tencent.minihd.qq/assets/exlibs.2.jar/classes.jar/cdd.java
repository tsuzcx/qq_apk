...
public class cdd
  implements Runnable
{
  public cdd(BmqqProfileCardActivity paramBmqqProfileCardActivity, int paramInt, ProfileActivity.AllInOne paramAllInOne, String paramString) {}
  
  public void run()
  {
    Object localObject1 = null;
    int i = this.jdField_a_of_type_ComTencentBizBmqqProfileBmqqProfileCardActivity.getResources().getDimensionPixelSize(2131493018);
    ...
    for (;;)
    {
      ...
      if (localObject1 != null)
      {
        ...
        this.jdField_a_of_type_ComTencentBizBmqqProfileBmqqProfileCardActivity.app.runOnUiThread(new cde(this, (Drawable)localObject1));
      }
      return;
      label224:
      ...
      else
      {
        ...
        {
          localObject1 = BitmapManager.a(this.jdField_a_of_type_ComTencentBizBmqqProfileBmqqProfileCardActivity.getResources(), 2130838430);
          continue;
        }
