  ...
  extends BaseAdapter
{
  ...
  eug jdField_a_of_type_Eug;
  
  public euf(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903576, null);
      this.jdField_a_of_type_Eug = new eug(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberCreateFaceToFaceDiscussionActivity);
      this.jdField_a_of_type_Eug.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131230940));
      this.jdField_a_of_type_Eug.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231000));
      paramView.setTag(this.jdField_a_of_type_Eug);
    ...
    for (;;)
    {
      ...
      return paramView;
      this.jdField_a_of_type_Eug = ((eug)paramView.getTag());
      if (!this.jdField_a_of_type_Eug.jdField_a_of_type_Boolean) {
        break;
      }
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903576, null);
      this.jdField_a_of_type_Eug = new eug(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberCreateFaceToFaceDiscussionActivity);
      ...
      this.jdField_a_of_type_Eug.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231000));
      paramView.setTag(this.jdField_a_of_type_Eug);
      this.jdField_a_of_type_Eug.jdField_a_of_type_Boolean = false;
      break;
      label237:
