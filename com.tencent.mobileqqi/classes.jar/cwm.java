...
{
  public cwm(MyPublishedHornActivity paramMyPublishedHornActivity) {}
  ...
  protected void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        ...
        this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(new cwn(this));
      }
      return;
    }
  }
  ...
  protected void a(boolean paramBoolean, int paramInt, String paramString)
  {
    if (paramBoolean)
    {
      ...
      {
        this.a.jdField_a_of_type_Cwr.a(this.a.jdField_b_of_type_ComTencentMobileqqDataHornDetail);
      ...
      this.a.jdField_a_of_type_Cwr.a();
      this.a.jdField_a_of_type_Cwr.notifyDataSetChanged();
      return;
    }
    ...
    paramString = this.a.jdField_a_of_type_Bwo.obtainMessage(3);
    this.a.jdField_a_of_type_Bwo.sendMessage(paramString);
  }
