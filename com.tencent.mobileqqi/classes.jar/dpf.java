  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramInt > 0)
    {
      if ((paramView == null) || (paramView.getTag() == null))
      {
        ...
        paramViewGroup = new dpg(this, null);
        paramViewGroup.c = ((ImageView)paramView.findViewById(2131231772));
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231090));
        paramViewGroup.b = ((TextView)paramView.findViewById(2131232385));
        paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131232386));
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (dpg)paramView.getTag();
      }
