...
public class ecx
  implements Runnable
{
  public ecx(PressToSpeakPanel paramPressToSpeakPanel, MotionEvent paramMotionEvent) {}
    ...
    for (;;)
    {
      if (i != 0)
      {
        if (new StatFs(Environment.getExternalStorageDirectory().getAbsolutePath()).getAvailableBlocks() > 1)
        {
          ...
          PressToSpeakPanel.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelPressToSpeakPanel).setBackgroundResource(2130839750);
