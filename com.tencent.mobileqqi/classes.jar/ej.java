  ...
  extends BaseAdapter
{
  ...
  private ej(DatalineSessionAdapter paramDatalineSessionAdapter, DatalineSessionAdapter.ItemHolder paramItemHolder, DataLineMsgSet paramDataLineMsgSet, int paramInt)
  {
  ...
  private void b()
  {
    ...
    while (i < 3)
    {
      ...
      this.jdField_a_of_type_ArrayOfComDatalineUtilWidgetAsyncImageView[i].setDefaultImage(2130840361);
  ...
  public void a()
  {
    ...
    if (i < 3)
    {
      ...
      if (localDataLineMsgRecord == null) {
        localAsyncImageView.setImageResource(2130840361);
      }
      for (;;)
      {
        i += 1;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (localDataLineMsgRecord == null)
      {
        paramViewGroup.setImageResource(2130840361);
