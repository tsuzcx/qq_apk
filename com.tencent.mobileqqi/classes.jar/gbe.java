...
public class gbe
  implements Runnable
{
  public gbe(UniformDownloadMgr paramUniformDownloadMgr, String paramString, Bundle paramBundle) {}
  ...
  public void run()
  {
    ...
    gbh localgbh = UniformDownloadMgr.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreUniformDownloadMgr, this.jdField_a_of_type_JavaLangString);
    if ((localgbh != null) && (this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreUniformDownloadMgr.a != null))
    {
      if (localgbh.a != 1) {
        break label175;
      }
