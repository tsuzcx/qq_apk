...
{
  public dle(SubAccountBindActivity paramSubAccountBindActivity) {}
  ...
  protected void a(boolean paramBoolean, SubAccountBackProtocData paramSubAccountBackProtocData)
  {
    ...
    for (String str = "..success";; str = "...failed..")
    {
      ...
      this.a.a(this.a.getString(2131562520), this.a.getString(2131563288), this.a.getString(2131562540), new dlh(this));
      break;
    }
  }
  ...
  protected void b(boolean paramBoolean, SubAccountBackProtocData paramSubAccountBackProtocData)
  {
    ...
    for (Object localObject1 = "..success";; localObject1 = "...failed..")
    {
      ...
      case 1002: 
        ...
        this.a.a((String)localObject1, (String)localObject2, new dlf(this));
        break;
      case 1003: 
      ...
      case 1004: 
        ...
        case 1215: 
          ...
          this.a.a((String)localObject1, (String)localObject2, new dlg(this, paramSubAccountBackProtocData));
          break;
        case 1218: 
          if (!TextUtils.isEmpty(paramSubAccountBackProtocData.a)) {
            break;
