  ...
  extends XCursorAdapter
{
  ...
  public djj(SpaceGateActivity paramSpaceGateActivity, Cursor paramCursor)
  {
  ...
  public void a(View paramView, Context paramContext, Cursor paramCursor)
  {
    ...
    Object localObject2 = (djl)paramView.getTag();
    Object localObject1 = localObject2;
    if (localObject2 == null)
    {
      localObject1 = new djl(null);
      ((djl)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131231415));
      ((djl)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131230940));
      ((djl)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(16908308));
      ((djl)localObject1).b = ((TextView)paramView.findViewById(16908309));
      ((djl)localObject1).c = ((TextView)paramView.findViewById(2131231882));
      ((djl)localObject1).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)paramView.findViewById(2131234179));
      ((djl)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout = ((ShaderAnimLayout)paramView.findViewById(2131230987));
      ((djl)localObject1).jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131231700));
      paramView.setTag(localObject1);
      ((djl)localObject1).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setOnModeChangeListener(SpaceGateActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivitySpaceGateActivity));
      ((djl)localObject1).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setDragViewType(0);
    }
    ...
    ((djl)localObject1).c.setText(a(str, l));
    ...
    ((djl)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(paramView);
    a(((djl)localObject1).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView, this.jdField_a_of_type_ComTencentMobileqqActivitySpaceGateActivity.b.a().a(localMessage.frienduin, localMessage.istroop));
    a(((djl)localObject1).b, paramContext, localMessage);
    paramContext = str + "_" + 1009;
    if (((djl)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout != null)
    {
      if ((this.jdField_b_of_type_JavaLangString != null) && (this.jdField_b_of_type_JavaLangString.equals(paramContext))) {
        ((djl)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout.b();
      }
    }
    else
    {
      ...
      ((djl)localObject1).jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramContext);
    }
    for (;;)
    {
      paramContext = new ProfileActivity.AllInOne(str, -1);
      paramContext.g = paramView;
      ((djl)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(2130838010, paramContext);
      ((djl)localObject1).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setTag(paramContext);
      ((djl)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.jdField_a_of_type_ComTencentMobileqqActivitySpaceGateActivity);
      return;
      ((djl)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout.c();
      break;
      label559:
      ((djl)localObject1).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(this.jdField_a_of_type_ComTencentMobileqqActivitySpaceGateActivity.getResources().getDrawable(2130838010));
    }
  }
