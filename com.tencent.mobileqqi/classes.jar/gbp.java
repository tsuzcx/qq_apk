  ...
  implements Runnable
{
  ...
  public gbp(RoamingActivity paramRoamingActivity, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (1 == this.jdField_a_of_type_Int)
    {
      ...
      View localView2 = this.jdField_a_of_type_ComTencentMobileqqMaproamActivityRoamingActivity.findViewById(2131231447);
