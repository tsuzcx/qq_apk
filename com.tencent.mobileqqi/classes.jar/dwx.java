...
public class dwx
  extends Handler
{
  public dwx(TroopMemberListActivity paramTroopMemberListActivity) {}
    ...
    case 2: 
      for (;;)
      {
        synchronized (this.a.jdField_a_of_type_JavaUtilList)
        {
          ...
          dxo.a(this.a.jdField_a_of_type_Dxo, (LinkedHashMap)paramMessage[1]);
          this.a.jdField_a_of_type_Dxo.a = ((int[])paramMessage[2]);
          dxo.a(this.a.jdField_a_of_type_Dxo, (String[])paramMessage[3]);
          if (this.a.jdField_a_of_type_JavaUtilList.size() != 0)
          {
            if (this.a.jdField_a_of_type_Dxo == null) {
              break label378;
            }
            this.a.jdField_a_of_type_Dxo.notifyDataSetChanged();
            ...
            this.a.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setOnLayoutListener(new dwy(this));
          }
          if (!this.a.c) {
            this.a.g();
          }
        ...
        if ((paramMessage != null) && (paramMessage.length == 1))
        {
          ...
          this.a.jdField_a_of_type_Dxo = new dxo(this.a);
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.a.jdField_a_of_type_Dxo);
        }
      }
    case 3: 
