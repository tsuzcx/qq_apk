...
public class ghg
  extends BaseAdapter
{
  private ghg(EditActivity paramEditActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramInt == 3)
    {
      ...
      localImageView = (ImageView)paramView.findViewById(2131232969);
      ...
      localTextView = (TextView)paramView.findViewById(2131232970);
