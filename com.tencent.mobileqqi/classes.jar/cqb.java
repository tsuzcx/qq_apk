  ...
  extends XCursorAdapter
{
  ...
  public cqb(HelloListActivity paramHelloListActivity, Cursor paramCursor)
  {
  ...
  public void a(View paramView, Context paramContext, Cursor paramCursor)
  {
    ...
    paramContext = (cqc)paramView.getTag();
    if (paramContext == null)
    {
      paramContext = new cqc(null);
      paramContext.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131231772));
      paramContext.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131231773));
      paramContext.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231090));
      paramContext.b = ((TextView)paramView.findViewById(2131231774));
      paramContext.c = ((TextView)paramView.findViewById(2131231771));
      paramContext.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)paramView.findViewById(2131231775));
