...
{
  public dhy(SetTroopAdminsActivity paramSetTroopAdminsActivity) {}
  
  protected void a(int paramInt)
  {
    ReportController.b(this.a.b, "CliOper", "", "", "Grp", "Grant_cancel_admin", 0, 1, SetTroopAdminsActivity.a(this.a), "", "", "");
    ...
    case 6: 
    default: 
      str = this.a.getString(2131562566);
    }
    for (;;)
    {
      QQToast.a(this.a, str, 0).b(this.a.d());
      return;
      if (SetTroopAdminsActivity.a(this.a) > 0)
      {
        str = String.format(this.a.getString(2131562353), new Object[] { Integer.valueOf(SetTroopAdminsActivity.a(this.a)) });
      }
      else
      {
        str = this.a.getString(2131562355);
        continue;
        str = this.a.getString(2131563264);
      }
    }
  }
  ...
  protected void a(String paramString1, String paramString2, byte paramByte)
  {
    ...
    {
      return;
      paramString1 = (FriendsManagerImp)this.a.b.getManager(8);
    ...
    {
      ReportController.b(this.a.b, "CliOper", "", "", "Grp", "Grant_cancel_admin", 0, 0, SetTroopAdminsActivity.a(this.a), "1", "", "");
    ...
    if (paramByte == 1)
    {
      ReportController.b(this.a.b, "CliOper", "", "", "Grp", "Grant_cancel_admin", 0, 0, SetTroopAdminsActivity.a(this.a), "0", "", "");
    ...
    if (paramByte == 0) {
      QQToast.a(this.a, 2, 2131561760, 0).b(this.a.d());
    }
    for (;;)
    {
      this.a.setResult(-1);
      return;
      if (paramByte == 1) {
        QQToast.a(this.a, 2, 2131561613, 0).b(this.a.d());
      }
    }
  }
}
