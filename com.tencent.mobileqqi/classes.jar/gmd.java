...
public class gmd
  extends BaseAdapter
{
  private gmd(StatusHistoryActivity paramStatusHistoryActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramView == null)
      {
        paramView = LayoutInflater.from(this.a).inflate(2130903987, null);
        paramView.setFocusable(true);
        paramViewGroup = new StatusHistoryActivity.ItemViewHolder();
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131234526));
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetClickableColorSpanTextView = ((ClickableColorSpanTextView)paramView.findViewById(2131234527));
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131234525));
        paramViewGroup.b = paramView.findViewById(2131234524);
        ...
        paramViewGroup.jdField_a_of_type_AndroidViewView = paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout.findViewById(2131231699);
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840234);
        label240:
      ...
      for (;;)
      {
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetClickableColorSpanTextView.setText(localRichStatus.a(null, this.a.getResources().getColor(2131362073)));
        ...
        if (paramInt == 0) {
          ...
          paramViewGroup.b.setBackgroundResource(2130840235);
        } else {
          paramViewGroup.b.setBackgroundResource(2130840236);
        }
      }
    }
