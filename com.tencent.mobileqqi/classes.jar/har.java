  ...
  extends AsyncTask
{
  ...
  public har(ImageWorker paramImageWorker, View paramView)
  {
  ...
  {
    View localView = a();
    hat localhat = (hat)ImageWorker.a(this.jdField_a_of_type_ComTencentMobileqqUtilImageWorker).remove(localView);
    ...
    if (localView != null)
    {
      ...
      if ((localhat != null) && (localhat.a != null)) {
        localhat.a.a(localView, null);
      }
    }
    return;
    label72:
    ImageWorker.a(this.jdField_a_of_type_ComTencentMobileqqUtilImageWorker, this.jdField_a_of_type_Boolean, localView, paramDrawable, localhat);
  }
}
