...
{
  private deg jdField_a_of_type_Deg = null;
  
  public cef(ChatActivity paramChatActivity) {}
  ...
  protected void a(String paramString1, int paramInt1, int paramInt2, SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    if (paramInt1 == 1) {
      if (((FriendManager)this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.b.getManager(8)).f(paramString1)) {
        if (paramInt2 == 108)
        {
          if (this.jdField_a_of_type_Deg == null) {
            this.jdField_a_of_type_Deg = new deg(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.a, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity);
          }
          ...
          this.jdField_a_of_type_Deg.a(paramString1);
          if (this.jdField_a_of_type_Deg.a()) {
            this.jdField_a_of_type_Deg.a();
          }
        }
      }
    }
        ...
        case 103: 
          ...
          if (paramInt1 == 3000) {
            ...
            case 102: 
              ...
              break;
            case 103: 
              DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity, 230, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131559040), this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131561440), new ceg(this, paramString1), null).show();
              break;
            case 104: 
              DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity, 230, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131559040), this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131562512), new ceh(this, paramString1), null).show();
              break;
            }
