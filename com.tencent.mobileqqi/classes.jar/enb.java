...
public class enb
  extends AsyncTask
{
  private enb(PhotoListActivity paramPhotoListActivity) {}
  ...
  protected void a(List paramList)
  {
    ...
    this.a.jdField_a_of_type_Emz.a(paramList);
    if (PhotoListActivity.d(this.a)) {
    ...
    for (;;)
    {
      ...
      {
        label216:
        j = this.a.jdField_a_of_type_Emz.getCount();
        if (j == 0) {
          j = k;
        }
        for (;;)
        {
          ...
          this.a.jdField_a_of_type_Emz.notifyDataSetChanged();
