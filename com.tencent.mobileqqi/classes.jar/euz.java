...
{
  public euz(RenMaiQuanMemberListInnerFrame paramRenMaiQuanMemberListInnerFrame, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, int paramInt, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      return localView;
      paramViewGroup = (eva)paramView.getTag();
      localView = paramView;
      break;
      label290:
