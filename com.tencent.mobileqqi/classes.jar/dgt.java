  ...
  extends AccountObserver
{
  ...
  public void onRegisterQuerySmsStatResp(boolean paramBoolean, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3)
  {
    ...
    this.a.jdField_b_of_type_AndroidOsHandler.post(new dgu(this, paramInt3));
    try
    {
      this.a.jdField_b_of_type_AndroidOsHandler.postDelayed(new dgv(this), paramInt1 * 1000);
      return;
    }
    catch (Exception paramArrayOfByte)
    {
