...
public class hcn
  extends BaseAdapter
{
  public hcn(QQCustomDialogThreeBtns paramQQCustomDialogThreeBtns) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView.a != null)
    {
      ...
      paramView.a.setOnClickListener(new hcu(this.a, paramInt));
