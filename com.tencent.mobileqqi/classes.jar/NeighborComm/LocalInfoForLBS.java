...
public final class LocalInfoForLBS
  extends JceStruct
{
  ...
  public LocalInfoForLBS(String paramString1, String paramString2, int paramInt, GPS paramGPS, ArrayList paramArrayList1, ArrayList paramArrayList2, byte[] paramArrayOfByte)
  {
    this.strAuthName = paramString1;
    this.strAuthPassword = paramString2;
    this.eLocalInfo = paramInt;
    this.stGps = paramGPS;
  ...
  public void readFrom(JceInputStream paramJceInputStream)
  {
    ...
    this.eLocalInfo = paramJceInputStream.read(this.eLocalInfo, 2, true);
    if (cache_stGps == null) {
      cache_stGps = new GPS();
    }
  ...
  public void writeTo(JceOutputStream paramJceOutputStream)
  {
    ...
    paramJceOutputStream.write(this.eLocalInfo, 2);
    if (this.stGps != null) {
 ...
 * Qualified Name:     NeighborComm.LocalInfoForLBS
