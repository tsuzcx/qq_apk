...
public class fbl
  implements Runnable
{
  public fbl(DeviceProfileManager paramDeviceProfileManager, PBRepeatField paramPBRepeatField) {}
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          {
            Iterator localIterator = fbm.a.entrySet().iterator();
            ...
            if (localIterator.hasNext())
            {
              ...
              fbn localfbn = (fbn)((Map.Entry)localObject1).getValue();
              if (QLog.isColorLevel()) {
                QLog.d(DeviceProfileManager.a, 2, "onDPCResponse DPCXmlHandler.tempMap: key=" + str + ", value=" + localfbn.toString());
              }
              ...
              DeviceProfileManager.a(this.jdField_a_of_type_ComTencentMobileqqAppDeviceProfileManager, (DeviceProfileManager.DPCConfigInfo)localObject1, localfbn.b.toString().trim());
              if (bool) {
              ...
              localEditor2.putString(str, localfbn.b);
              localEditor2.putString(str + "_attachInfo", localfbn.c);
            }
          }
