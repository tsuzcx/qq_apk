...
public class hht
  extends BaseAdapter
{
  public hht(QQCustomSplitDialog paramQQCustomSplitDialog) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903172, null);
      paramView = new hhz(this.a, null);
      paramView.a = ((TextView)paramViewGroup.findViewById(2131231492));
      paramView.b = ((TextView)paramViewGroup.findViewById(2131231474));
      paramViewGroup.setTag(paramView);
    }
    paramView = (hhz)paramViewGroup.getTag();
    int i;
    int j;
    int k;
    int m;
    if (paramView.b != null)
    {
      ...
      paramView.b.setOnClickListener(new hhy(this.a, paramInt));
      ...
      paramView.b.setBackgroundResource(2130837923);
    }
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_ArrayOfJavaLangString.length == 3) {
        ...
        case 0: 
          ...
          break;
        case 1: 
          paramView.b.setBackgroundResource(2130837922);
          break;
        case 2: 
          paramView.b.setBackgroundResource(2130837923);
        }
