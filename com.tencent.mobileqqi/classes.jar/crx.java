...
public class crx
  extends Thread
{
  public crx(ForwardOperations paramForwardOperations) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      if ((i >= 3) || ((this.a.c) && (!TextUtils.isEmpty((CharSequence)localObject))))
      {
        ...
        this.a.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new cry(this));
      }
      label108:
    ...
    {
      this.a.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new crz(this));
      return;
    }
