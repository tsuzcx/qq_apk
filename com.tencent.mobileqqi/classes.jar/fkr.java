...
public class fkr
  extends Handler
{
  public fkr(SaveTrafficHandler paramSaveTrafficHandler, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject = (fkt)((Map.Entry)localObject).getValue();
        if (localObject == null) {
          continue;
        }
        if (((fkt)localObject).a == bool) {
          break label152;
        }
    ...
    {
      int i = this.a.a();
      paramMessage = new fkt(this.a, i, bool);
