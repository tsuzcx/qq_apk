...
public class gat
  extends fzn
{
  public gat(OnlineFileSessionWorker paramOnlineFileSessionWorker)
  {
  ...
  protected void c()
  {
    ...
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "] state change :(" + this.jdField_a_of_type_Fzn.a() + "->StateWaitResultWhenPause)");
    this.jdField_a_of_type_Fzn = new gas(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker);
  }
