...
{
  public ejw(RecommendListView paramRecommendListView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (paramView.getId() == 2131230988)
    {
      ...
      if (this.a.jdField_a_of_type_Eke != null) {
        this.a.jdField_a_of_type_Eke.a = -1;
      }
      paramView = (Button)paramView;
      if (paramView.getTag() != null)
      {
        int i = ((Integer)paramView.getTag()).intValue();
        paramView = (RecommendContactMsg)this.a.jdField_a_of_type_Eke.getItem(i);
