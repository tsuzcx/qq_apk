...
public class gem
  implements Runnable
{
  public gem(ProfileCardBrowserActivity paramProfileCardBrowserActivity, long paramLong, int paramInt) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        ...
        localObject1 = new SSummaryCardSetReq(2, Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqProfileProfileCardBrowserActivity.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a()), this.jdField_a_of_type_Long, "6.0.2", 109L);
