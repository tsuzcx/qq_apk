  ...
  extends MessageMicro
{
  ...
  public static final int BYTES_SHA_FIELD_NUMBER = 51;
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 80, 160, 240, 322, 402, 410, 482, 560, 640 }, new String[] { "uint64_sender_uin", "uint64_recver_uin", "uint64_file_size", "str_file_name", "bytes_10m_md5", "bytes_sha", "str_local_filepath", "uint32_danger_level", "uint64_total_space" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), "", localByteStringMicro1, localByteStringMicro2, "", Integer.valueOf(0), Long.valueOf(0L) }, ApplyUploadHitReq.class);
  }
}
