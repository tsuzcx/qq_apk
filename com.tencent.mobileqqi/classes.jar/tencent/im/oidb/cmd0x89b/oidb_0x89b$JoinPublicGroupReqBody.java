  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8 }, new String[] { "uint64_visitor_uin" }, new Object[] { Long.valueOf(0L) }, JoinPublicGroupReqBody.class);
  public static final JoinPublicGroupReqBody __repeatHelper__ = new JoinPublicGroupReqBody();
