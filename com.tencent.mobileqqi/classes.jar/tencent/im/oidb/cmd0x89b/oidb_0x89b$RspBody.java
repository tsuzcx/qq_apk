  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 50 }, new String[] { "uint64_group_uin", "uint64_group_code", "uint32_req_type", "str_err_msg", "msg_join_group", "msg_exit_group" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(0), "", null, null }, RspBody.class);
