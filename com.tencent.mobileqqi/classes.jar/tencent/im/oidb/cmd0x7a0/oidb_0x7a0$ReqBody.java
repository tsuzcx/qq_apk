  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32 }, new String[] { "uint64_bind_uin", "msg_bind_uin_sig", "str_imei", "uint32_clt_appid" }, new Object[] { Long.valueOf(0L), null, "", Integer.valueOf(0) }, ReqBody.class);
