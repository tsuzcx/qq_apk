  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "uint64_bind_uin", "str_imei", "uint32_clt_appid" }, new Object[] { Long.valueOf(0L), "", Integer.valueOf(0) }, ReqBody.class);
