...
public final class QQService$SetSecretFileInfoReq
  extends MessageMicro
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 48, 56, 64, 72, 82, 90 }, new String[] { "uint64_uin", "bytes_vUuid", "uint64_fromUin", "uint64_toUin", "uint32_State", "uint32_startTime", "uint32_validTimes", "uint32_watchTimes", "uint32_fileType", "str_fromphonenum", "str_tophonenum" }, new Object[] { Long.valueOf(0L), localByteStringMicro, Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), "", "" }, SetSecretFileInfoReq.class);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqqi\classes2.jar
 * Qualified Name:     tencent.im.secretfile.QQService.SetSecretFileInfoReq
