  ...
  extends AutoCompleteTextView
{
  ...
  public hgp(DropdownView paramDropdownView, Context paramContext)
  {
    super(paramContext);
    setId(526);
  ...
  public hgp(DropdownView paramDropdownView, Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public hgp(DropdownView paramDropdownView, Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
