  ...
  extends FacePreloadBaseAdapter
{
  ...
  public dsd(TroopMemberListActivity paramTroopMemberListActivity, List paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = TroopMemberListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity).inflate(2130904038, paramViewGroup, false);
      paramViewGroup = new TroopMemberListActivity.SearchViewHolder();
      paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131232621));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231566));
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131231568));
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231411));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131234627));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131234628));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131234625));
      TroopMemberListActivity.SearchViewHolder.a(paramViewGroup, (Button)paramView.findViewById(2131234629));
      TroopMemberListActivity.SearchViewHolder.a(paramViewGroup, (RelativeLayout)paramView.findViewById(2131234624));
      ...
      TroopMemberListActivity.SearchViewHolder.a(paramViewGroup).setOnClickListener(new dse(this, localATroopMember));
    ...
    for (;;)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839715);
    ...
    paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839714);
    return paramView;
    label546:
    ...
    for (;;)
    {
      ...
      paramViewGroup.d.setOnClickListener(new dsf(this, localATroopMember));
      return paramView;
