  ...
  extends Thread
{
  ...
  public gin(String paramString, HttpNotify paramHttpNotify)
  {
  ...
  public void run()
  {
    for (;;)
    {
      ...
      localHttpRequestHandlerRegistry.register("*", new gim(this.jdField_a_of_type_JavaLangString, (Socket)localObject2));
      ...
      localObject1 = new gio((HttpService)localObject2, (HttpServerConnection)localObject1, this.jdField_a_of_type_ComTencentMobileqqServiceHttpNotify, this);
      ((gio)localObject1).setDaemon(true);
      ((gio)localObject1).start();
