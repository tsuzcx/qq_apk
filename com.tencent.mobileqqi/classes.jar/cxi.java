...
{
  private cxi(JoinDiscussionActivity paramJoinDiscussionActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, RespGetDiscussInfo paramRespGetDiscussInfo)
  {
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilArrayList.size() == this.a.jdField_c_of_type_Int)
      {
        ...
        this.a.runOnUiThread(new cxj(this, paramRespGetDiscussInfo));
      }
      this.a.runOnUiThread(new cxk(this));
      return;
    }
    this.a.a(0, paramInt);
  }
