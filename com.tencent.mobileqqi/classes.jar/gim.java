  ...
  extends Thread
{
  ...
  public gim(String paramString, HttpNotify paramHttpNotify)
  {
  ...
  public void run()
  {
    for (;;)
    {
      ...
      localHttpRequestHandlerRegistry.register("/wifiphoto*", new HttpRequestWifiphotoHandler());
      localHttpRequestHandlerRegistry.register("*", new gil(this.jdField_a_of_type_JavaLangString, (Socket)localObject2));
      ...
      localObject1 = new gin((HttpService)localObject2, (HttpServerConnection)localObject1, this.jdField_a_of_type_ComTencentMobileqqServiceHttpNotify, this);
      ((gin)localObject1).setDaemon(true);
      ((gin)localObject1).start();
