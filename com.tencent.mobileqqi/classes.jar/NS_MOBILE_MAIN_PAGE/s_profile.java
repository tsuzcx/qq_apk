  ...
  extends JceStruct
{
  ...
  public s_profile(long paramLong1, String paramString1, String paramString2, byte paramByte1, byte paramByte2, byte paramByte3, int paramInt1, String paramString3, String paramString4, String paramString5, String paramString6, int paramInt2, int paramInt3, boolean paramBoolean1, long paramLong2, String paramString7, int paramInt4, String paramString8, boolean paramBoolean2, String paramString9, int paramInt5, int paramInt6, int paramInt7)
  {
    this.uin = paramLong1;
