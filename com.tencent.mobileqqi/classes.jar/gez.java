...
public class gez
  implements Runnable
{
  public gez(ProfileHeaderView paramProfileHeaderView, int paramInt, ProfileActivity.AllInOne paramAllInOne, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      if (localObject1 != null) {
        this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileHeaderView.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new gfa(this, (Bitmap)localObject1));
      }
      return;
      label217:
