  ...
  extends JceStruct
{
  ...
  public ProfUsrQryReq(int paramInt1, String paramString, ArrayList paramArrayList, int paramInt2, int paramInt3, byte paramByte, int paramInt4, int paramInt5)
  {
