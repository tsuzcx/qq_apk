  ...
  extends FacePreloadBaseAdapter
{
  ...
  public dsc(TroopMemberListActivity paramTroopMemberListActivity, List paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      TroopMemberListActivity.SearchViewHolder.a(paramViewGroup, (Button)paramView.findViewById(2131234628));
      TroopMemberListActivity.SearchViewHolder.a(paramViewGroup, (RelativeLayout)paramView.findViewById(2131234623));
      ...
      TroopMemberListActivity.SearchViewHolder.a(paramViewGroup).setOnClickListener(new dsd(this, localATroopMember));
    ...
    for (;;)
    {
      ...
      paramViewGroup.d.setOnClickListener(new dse(this, localATroopMember));
      return paramView;
