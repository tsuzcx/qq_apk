  ...
  extends ContactBindObserver
{
  ...
  public feh(PhoneContactManagerImp paramPhoneContactManagerImp) {}
  ...
  void d(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      fei localfei = new fei(this);
      PhoneContactManagerImp.a(this.jdField_a_of_type_ComTencentMobileqqAppPhoneContactManagerImp).a(localfei);
    }
    if (QLog.isColorLevel()) {
