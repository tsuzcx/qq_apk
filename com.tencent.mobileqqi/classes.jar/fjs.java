...
{
  public fjs(QQAppInterface paramQQAppInterface) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                QLog.d(QQAppInterface.a, 2, "sharealbum exitAlbum:" + paramContext);
                return;
              } while (paramIntent == null);
              paramContext = paramIntent.getString("albumid");
            } while (TextUtils.isEmpty(paramContext));
          ...
          QLog.d(QQAppInterface.a, 2, "sharealbum clearShareAlbum:" + paramContext);
          return;
        } while (paramIntent == null);
        paramContext = paramIntent.getString("albumid");
    ...
    QLog.d(QQAppInterface.a, 2, "sharealbum changeName:" + paramContext + " name:" + paramIntent);
  }
}
