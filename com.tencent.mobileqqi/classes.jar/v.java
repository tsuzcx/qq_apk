  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    } while ((((DLFileInfo)localObject1).a != DLBaseFileViewActivity.DLFileState.SENDING) && (((DLFileInfo)localObject1).a != DLBaseFileViewActivity.DLFileState.RECVING));
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if (NetworkUtil.e(this.a))
        {
          if ((FileManagerUtil.a()) && (DLFilesViewerActivity.a(this.a).getFileTotalSize() > 5242880L))
          {
            ...
            localObject1 = new w(this, paramView, localDataLineHandler);
            localObject2 = new x(this);
            if (paramView.isSendFromLocal()) {
              DialogUtil.a(this.a, 230, this.a.getString(2131558502), this.a.getString(2131558756), 2131561746, 2131558509, (DialogInterface.OnClickListener)localObject1, (DialogInterface.OnClickListener)localObject2).show();
            } else {
              DialogUtil.a(this.a, 230, this.a.getString(2131558505), this.a.getString(2131558757), 2131561746, 2131558509, (DialogInterface.OnClickListener)localObject1, (DialogInterface.OnClickListener)localObject2).show();
            }
          }
          else
          {
            ...
            if (localIterator.hasNext())
            {
              ...
              for (;;)
              {
                ...
                else
                {
                  ...
                  this.a.b.a().c(localDataLineMsgRecord.msgId);
                }
