...
{
  public gwj(TroopBarPageActivity paramTroopBarPageActivity) {}
  ...
  public boolean a(int paramInt, View paramView, ListView paramListView)
  {
    ...
    if (this.a.jdField_a_of_type_Long == 0L)
    {
      ...
      this.a.a(false);
      this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new gwk(this), 300L);
    }
    for (;;)
    {
      ...
      break;
      label110:
      this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new gwl(this), 300L);
    }
  }
