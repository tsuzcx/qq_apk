...
class cyo
{
  ...
  Handler jdField_a_of_type_AndroidOsHandler = new cyp(this);
  public Toast a;
  ...
  public cyo(SessionInfo paramSessionInfo, BaseActivity paramBaseActivity)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppBizTroopObserver = new cyq(this);
    this.jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new cyr(this);
  ...
  public void a()
  {
    ...
    this.jdField_c_of_type_Boolean = false;
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new cys(this), 1000L);
