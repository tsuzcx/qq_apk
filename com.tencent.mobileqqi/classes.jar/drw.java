  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public drw(TroopMemberListActivity paramTroopMemberListActivity)
  {
      ...
      if ((localATroopMember.c != null) && (localATroopMember.c.length() != 0))
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if (!((String)localObject2).equals(this.jdField_a_of_type_JavaLangString)) {
            Collections.sort((List)((LinkedHashMap)localObject4).get(localObject2), new dsb(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity, null));
          }
        }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131232620));
      ...
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231410));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131234626));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131234627));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131234624));
      TroopMemberListActivity.ViewHolder.a(paramViewGroup, (Button)paramView.findViewById(2131234628));
      TroopMemberListActivity.ViewHolder.a(paramViewGroup, (RelativeLayout)paramView.findViewById(2131234623));
      ...
      TroopMemberListActivity.ViewHolder.a(paramViewGroup).setOnClickListener(new drx(this, localATroopMember));
    ...
    for (;;)
    {
      ...
      paramViewGroup.d.setOnClickListener(new dry(this, localATroopMember));
      return paramView;
