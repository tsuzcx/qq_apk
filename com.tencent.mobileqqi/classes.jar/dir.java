...
{
  public dir(QQMapActivity paramQQMapActivity, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
  ...
  public void onLocationUpdate(SOSOMapLBSApiResult paramSOSOMapLBSApiResult)
  {
    ...
    if (paramSOSOMapLBSApiResult.Address == null)
    {
      ...
      this.a.runOnUiThread(new dis(this, paramSOSOMapLBSApiResult, str));
    }
    for (;;)
    {
      label113:
