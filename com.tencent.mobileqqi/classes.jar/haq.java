  ...
  extends AsyncTask
{
  ...
  public haq(ImageWorker paramImageWorker, View paramView)
  {
  ...
  {
    View localView = a();
    has localhas = (has)ImageWorker.a(this.jdField_a_of_type_ComTencentMobileqqUtilImageWorker).remove(localView);
    ...
    if (localView != null)
    {
      ...
      if ((localhas != null) && (localhas.a != null)) {
        localhas.a.a(localView, null);
      }
    }
    return;
    label72:
    ImageWorker.a(this.jdField_a_of_type_ComTencentMobileqqUtilImageWorker, this.jdField_a_of_type_Boolean, localView, paramDrawable, localhas);
  }
}
