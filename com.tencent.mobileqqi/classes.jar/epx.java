  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public epx(DiscussionMemberListInnerFrame paramDiscussionMemberListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = new epy(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame, null);
    ...
    paramView = (epy)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
