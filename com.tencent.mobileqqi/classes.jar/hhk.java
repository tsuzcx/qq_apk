...
public class hhk
  extends BaseAdapter
{
  public hhk(QQCustomSingleButtonDialog paramQQCustomSingleButtonDialog) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView.a != null)
    {
      ...
      paramView.a.setOnClickListener(new hho(this.a, paramInt));
