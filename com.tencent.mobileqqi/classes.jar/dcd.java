...
{
  public dcd(MyPublishedHornActivity paramMyPublishedHornActivity) {}
  ...
  protected void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        ...
        this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(new dce(this));
      }
      return;
    }
  }
  ...
  protected void a(boolean paramBoolean, int paramInt, String paramString)
  {
    if (paramBoolean)
    {
      ...
      {
        this.a.jdField_a_of_type_Dci.a(this.a.jdField_b_of_type_ComTencentMobileqqDataHornDetail);
      ...
      this.a.jdField_a_of_type_Dci.a();
      this.a.jdField_a_of_type_Dci.notifyDataSetChanged();
      return;
    }
    ...
    paramString = this.a.jdField_a_of_type_Ccj.obtainMessage(3);
    this.a.jdField_a_of_type_Ccj.sendMessage(paramString);
  }
  ...
  protected void a(boolean paramBoolean, List paramList, Boolean paramBoolean1, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (!paramBoolean1.booleanValue())
      {
        paramList = this.a.jdField_a_of_type_Ccj.obtainMessage(0);
        this.a.jdField_a_of_type_Ccj.sendMessageDelayed(paramList, 1000L);
      }
      else
      {
        paramList = this.a.jdField_a_of_type_Ccj.obtainMessage(3);
        this.a.jdField_a_of_type_Ccj.sendMessage(paramList);
      }
    }
  }
}
