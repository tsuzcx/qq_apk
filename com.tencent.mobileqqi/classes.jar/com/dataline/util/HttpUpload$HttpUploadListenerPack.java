  ...
  implements HttpUpload.HttpUploadListener
{
  ...
  {
    new Handler(Looper.getMainLooper()).post(new ey(this, paramLong1, paramLong2, paramLong3));
  }
  
  public void a(long paramLong1, String paramString, long paramLong2)
  {
    new Handler(Looper.getMainLooper()).post(new ew(this, paramLong1, paramString, paramLong2));
  }
  ...
  {
    new Handler(Looper.getMainLooper()).post(new ex(this, paramLong1, paramBoolean, paramLong2, paramInt1, paramInt2, paramInt3, paramString1, paramString2));
  }
