  ...
  extends BaseAdapter
{
  ...
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new el(this);
  ...
  {
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new em(this);
  ...
  private void a(DatalineFilesAdapter.ItemHolder paramItemHolder, DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    {
      paramItemHolder.jdField_a_of_type_ComDatalineUtilFileDLFileInfo.jdField_a_of_type_ComDatalineActivitiesDLBaseFileViewActivity$DLFileState = DLBaseFileViewActivity.DLFileState.RECVING;
      paramDataLineMsgRecord.fileMsgStatus = 0L;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(paramDataLineMsgRecord.msgId);
  ...
  private void b(DatalineFilesAdapter.ItemHolder paramItemHolder, DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    for (;;)
    {
      paramItemHolder.jdField_a_of_type_ComDatalineUtilFileDLFileInfo.jdField_a_of_type_ComDatalineActivitiesDLBaseFileViewActivity$DLFileState = DLBaseFileViewActivity.DLFileState.SENDING;
      return;
  ...
  public void a(long paramLong, ListView paramListView, float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        localObject = (ProgressBar)paramListView.findViewById(2131231506);
        if (localObject != null) {
          ((ProgressBar)localObject).setProgress((int)(f * 100.0F));
        }
        paramListView = (TextView)paramListView.findViewById(2131231505);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (paramViewGroup = (DataLineMsgRecord)getItem(paramInt);; paramViewGroup = null)
    {
      ...
      if (paramView == null)
      {
        ...
        if (i != 0)
        {
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903181, null);
          localItemHolder.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131231517));
          localItemHolder.jdField_a_of_type_ComDatalineUtilWidgetWaitTextView = ((WaitTextView)paramView.findViewById(2131231518));
      ...
      do
      {
        ...
        i = 0;
        break;
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903180, null);
        localItemHolder.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131231500));
        ...
        localItemHolder.jdField_a_of_type_ComDatalineUtilWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131231501));
        localItemHolder.jdField_a_of_type_ComDatalineUtilWidgetAsyncImageView.setDefaultImage(2130838586);
        localItemHolder.jdField_a_of_type_ComDatalineUtilWidgetAsyncImageView.setIsDrawRound(false);
        localItemHolder.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231502));
        localItemHolder.b = ((TextView)paramView.findViewById(2131231504));
        localItemHolder.c = ((TextView)paramView.findViewById(2131231505));
        localItemHolder.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131231506));
        localItemHolder.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131231516));
        ...
        if (!this.jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSet.isTimeOut())
        {
          ...
          paramViewGroup = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131558568), new Object[] { Integer.valueOf(i - paramInt) });
        ...
        paramInt = this.jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSet.getComeCount();
        i = this.jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSet.getTotalCount();
        paramViewGroup = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131558567), new Object[] { Integer.valueOf(paramInt), Integer.valueOf(i - paramInt) });
        localItemHolder.jdField_a_of_type_ComDatalineUtilWidgetWaitTextView.setWaitText(paramViewGroup);
        return paramView;
        ...
        for (;;)
        {
          ...
          localItemHolder.jdField_a_of_type_AndroidWidgetButton.setText(2131558499);
          return paramView;
      ...
      {
        localItemHolder.jdField_a_of_type_AndroidWidgetButton.setText(2131558498);
        return paramView;
      }
      localItemHolder.jdField_a_of_type_AndroidWidgetButton.setText(2131558561);
      return paramView;
      localItemHolder.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      ...
      localItemHolder.jdField_a_of_type_AndroidWidgetButton.setText(2131558500);
      return paramView;
    }
  }
