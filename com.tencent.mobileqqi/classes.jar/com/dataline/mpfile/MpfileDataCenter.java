  ...
  implements HttpDownload.HttpDownloadListener
{
  ...
  public static String a()
  {
    ...
    if (!FileUtils.a(AppConstants.as)) {
      localFile.mkdirs();
    }
  ...
  public static String b()
  {
    ...
    if (!FileUtils.a(AppConstants.au)) {
      localFile.mkdirs();
    }
    return AppConstants.au;
  }
  ...
  public String a(String paramString)
  {
    ...
    //   31: astore_1
    //   32: new 377	java/net/URL
    //   35: dup
    //   36: aload_1
    //   37: invokespecial 378	java/net/URL:<init>	(Ljava/lang/String;)V
    //   40: invokevirtual 382	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   43: checkcast 384	java/net/HttpURLConnection
    //   46: astore_1
    //   47: new 386	java/io/InputStreamReader
    //   50: dup
    //   51: aload_1
    //   52: invokevirtual 390	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   55: invokespecial 393	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   58: astore_3
    //   59: new 395	java/io/BufferedReader
    //   62: dup
    //   63: aload_3
    //   64: invokespecial 398	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   67: astore_2
    //   68: new 400	java/lang/StringBuffer
    //   71: dup
    //   72: invokespecial 401	java/lang/StringBuffer:<init>	()V
    //   75: astore 4
    //   77: aload_2
    //   78: invokevirtual 404	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   81: astore 5
    //   83: aload 5
    //   85: ifnull +45 -> 130
    //   88: aload 4
    //   90: aload 5
    //   92: invokevirtual 408	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   95: pop
    //   96: goto -19 -> 77
    //   99: astore 4
    //   101: aload_1
    ...
    //   107: astore_3
    //   108: aload_3
    //   109: invokevirtual 411	java/lang/Exception:printStackTrace	()V
    //   112: aload_2
    //   113: ifnull +7 -> 120
    //   116: aload_2
    //   117: invokevirtual 414	java/net/HttpURLConnection:disconnect	()V
    //   120: aload_1
    //   121: ifnull +124 -> 245
    //   124: aload_1
    //   125: invokevirtual 417	java/io/InputStreamReader:close	()V
    //   128: aconst_null
    //   129: areturn
    //   130: aload 4
    //   132: invokevirtual 420	java/lang/StringBuffer:toString	()Ljava/lang/String;
    //   135: astore_2
    //   136: aload_1
    //   137: ifnull +7 -> 144
    //   140: aload_1
    //   141: invokevirtual 414	java/net/HttpURLConnection:disconnect	()V
    //   144: aload_3
    //   145: ifnull +102 -> 247
    //   148: aload_3
    //   149: invokevirtual 417	java/io/InputStreamReader:close	()V
    //   152: aload_2
    //   153: areturn
    //   154: astore_1
    //   155: aload_1
    //   156: invokevirtual 421	java/io/IOException:printStackTrace	()V
    //   159: aload_2
    //   160: areturn
    //   161: astore_1
    //   162: aload_1
    //   163: invokevirtual 421	java/io/IOException:printStackTrace	()V
    //   166: aconst_null
    //   167: areturn
    //   168: astore_1
    //   169: aconst_null
    ...
    //   172: ifnull +7 -> 179
    //   175: aload_2
    //   176: invokevirtual 414	java/net/HttpURLConnection:disconnect	()V
    //   179: aload_3
    //   180: ifnull +7 -> 187
    //   183: aload_3
    //   184: invokevirtual 417	java/io/InputStreamReader:close	()V
    //   187: aload_1
    //   188: athrow
    //   189: astore_2
    //   190: aload_2
    //   191: invokevirtual 421	java/io/IOException:printStackTrace	()V
    //   194: goto -7 -> 187
    //   197: astore 4
    //   199: aconst_null
    //   200: astore_3
