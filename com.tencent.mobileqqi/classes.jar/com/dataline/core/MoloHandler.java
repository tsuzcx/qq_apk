...
public class MoloHandler
{
  ...
  public int a(String paramString)
  {
    ...
    QLog.d("MoloHandler", 1, "PCPushProxy open(" + paramString + "):" + i);
    return i;
  }
  ...
  public DataLineMsgRecord a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          QLog.d("MoloHandler", 1, "dealWith new pkgEntry:" + localPkgEntry.e);
          long l = this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.a(0).longValue();
          paramArrayOfByte = new DataLineMsgRecord();
          paramArrayOfByte.msg = this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.a().a().getString(2131558513);
      ...
      {
        QLog.d("MoloHandler", 1, "PCPushProxy.parse Exception:" + paramArrayOfByte.toString());
        return null;
      }
      boolean bool1 = false;
      continue;
  ...
  public boolean a(String paramString)
  {
    ...
    QLog.d("MoloHandler", 1, "PCPushProxy start(" + paramString + "):" + bool);
    if (bool)
    {
      ...
      while (paramString.hasNext())
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.a.a().c(localDataLineMsgRecord.msgId);
  ...
  public boolean b(String paramString)
  {
    ...
    QLog.d("MoloHandler", 1, "PCPushProxy install : " + paramString);
    return true;
  }
  ...
  public boolean c(String paramString)
  {
    ...
    QLog.d("MoloHandler", 1, "PCPushProxy pause(" + paramString + ")");
    return true;
  }
  ...
  public boolean d(String paramString)
  {
    ...
    QLog.d("MoloHandler", 1, "PCPushProxy delete(" + paramString + ")");
    return true;
  }
  ...
  public boolean e(String paramString)
  {
    ...
    QLog.d("MoloHandler", 1, "PCPushProxy isInstalled(" + paramString + "):" + bool);
    return bool;
  }
}
