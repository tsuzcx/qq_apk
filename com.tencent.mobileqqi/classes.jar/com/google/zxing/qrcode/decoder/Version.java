...
{
  private static final int[] jdField_a_of_type_ArrayOfInt = { 31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017 };
  ...
  public static Version a(int paramInt)
  {
    ...
    try
    {
      Version localVersion = b(paramInt - 17 >> 2);
      return localVersion;
    }
  ...
  public static Version c(int paramInt)
  {
    int i = 0;
    int j = 2147483647;
    int m = 0;
  ...
  public BitMatrix a()
  {
    ...
    localBitMatrix.a(k - 8, 0, 8, 9);
    localBitMatrix.a(0, k - 8, 9, 8);
    int m = this.jdField_b_of_type_ArrayOfInt.length;
    int i = 0;
    while (i < m)
    {
      int n = this.jdField_b_of_type_ArrayOfInt[i];
      int j = 0;
      if (j < m)
      {
        ...
        for (;;)
        {
          j += 1;
          break;
          localBitMatrix.a(this.jdField_b_of_type_ArrayOfInt[j] - 2, n - 2, 5, 5);
        }
      }
      i += 1;
    }
    localBitMatrix.a(6, 9, 1, k - 17);
    localBitMatrix.a(9, 6, k - 17, 1);
    if (this.jdField_a_of_type_Int > 6)
    {
      localBitMatrix.a(k - 11, 0, 3, 6);
      localBitMatrix.a(0, k - 11, 6, 3);
    }
