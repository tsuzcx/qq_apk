...
public final class Encoder
{
  ...
  private static int a(BitArray paramBitArray, ErrorCorrectionLevel paramErrorCorrectionLevel, Version paramVersion, ByteMatrix paramByteMatrix)
  {
    ...
    if (i < 8)
    {
      gj.a(paramBitArray, paramErrorCorrectionLevel, paramVersion, i, paramByteMatrix);
  ...
  {
    return gi.a(paramByteMatrix) + gi.b(paramByteMatrix) + gi.c(paramByteMatrix) + gi.d(paramByteMatrix);
  }
  ...
  static BitArray a(BitArray paramBitArray, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (int j = 0; k < paramInt3; j = n + j)
    {
      ...
      localArrayList.add(new gg(arrayOfByte, (byte[])localObject2));
      m = Math.max(m, n);
    ...
    while (paramInt2 < m)
    {
      ...
      {
        arrayOfByte = ((gg)((Iterator)localObject1).next()).a();
    ...
    while (paramInt2 < i)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        arrayOfByte = ((gg)((Iterator)localObject1).next()).b();
        if (paramInt2 < arrayOfByte.length) {
          paramBitArray.c(arrayOfByte[paramInt2], 8);
        }
      }
  ...
  public static QRCode a(String paramString, ErrorCorrectionLevel paramErrorCorrectionLevel, Map paramMap)
  {
    ...
    for (int i = ((BitArray)localObject3).b();; i = paramString.length())
    {
      ...
      gj.a(paramString, paramErrorCorrectionLevel, paramMap, i, (ByteMatrix)localObject1);
