...
{
  static final String jdField_a_of_type_JavaLangString = "ISO-8859-1";
  ...
  private static int a(BitArray paramBitArray, ErrorCorrectionLevel paramErrorCorrectionLevel, Version paramVersion, ByteMatrix paramByteMatrix)
  {
    ...
    if (i < 8)
    {
      gb.a(paramBitArray, paramErrorCorrectionLevel, paramVersion, i, paramByteMatrix);
  ...
  {
    return ga.a(paramByteMatrix) + ga.b(paramByteMatrix) + ga.c(paramByteMatrix) + ga.d(paramByteMatrix);
  }
  
  public static int a(String paramString, ErrorCorrectionLevel paramErrorCorrectionLevel, Map paramMap)
  {
    if (paramMap == null) {}
    for (paramMap = null;; paramMap = (String)paramMap.get(EncodeHintType.CHARACTER_SET))
    {
      Object localObject1 = paramMap;
      if (paramMap == null) {
        localObject1 = "ISO-8859-1";
      }
      paramMap = a(paramString, (String)localObject1);
      BitArray localBitArray = new BitArray();
      if ((paramMap == Mode.BYTE) && (!"ISO-8859-1".equals(localObject1)))
      {
        localObject2 = CharacterSetECI.getCharacterSetECIByName((String)localObject1);
        if (localObject2 != null) {
          a((CharacterSetECI)localObject2, localBitArray);
        }
      }
      a(paramMap, localBitArray);
      Object localObject2 = new BitArray();
      a(paramString, paramMap, (BitArray)localObject2, (String)localObject1);
      return a(localBitArray.a() + paramMap.getCharacterCountBits(Version.b(40)) + ((BitArray)localObject2).a(), paramErrorCorrectionLevel).a();
    }
  }
  ...
  static BitArray a(BitArray paramBitArray, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (int j = 0; k < paramInt3; j = n + j)
    {
      ...
      localArrayList.add(new fy(arrayOfByte, (byte[])localObject2));
      m = Math.max(m, n);
    ...
    while (paramInt2 < m)
    {
      ...
      {
        arrayOfByte = ((fy)((Iterator)localObject1).next()).a();
        if (paramInt2 < arrayOfByte.length) {
          paramBitArray.c(arrayOfByte[paramInt2], 8);
        }
      }
      paramInt2 += 1;
    }
    ...
    while (paramInt2 < i)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        arrayOfByte = ((fy)((Iterator)localObject1).next()).b();
        if (paramInt2 < arrayOfByte.length) {
          paramBitArray.c(arrayOfByte[paramInt2], 8);
        }
      }
  ...
  public static Mode a(String paramString)
  {
  ...
  public static QRCode a(String paramString, ErrorCorrectionLevel paramErrorCorrectionLevel)
  {
    return a(paramString, paramErrorCorrectionLevel, null);
  }
  
  public static QRCode a(String paramString, ErrorCorrectionLevel paramErrorCorrectionLevel, Map paramMap)
  {
    Object localObject1;
    Object localObject2;
    Object localObject3;
    ...
    if (paramMap == null)
    {
      ...
      j = 40;
      label156:
      paramMap = a(((Mode)localObject1).getCharacterCountBits(Version.b(j)) + k + ((BitArray)localObject3).a(), paramErrorCorrectionLevel);
      if (i != 0) {
        break label368;
      }
      label184:
    ...
    for (int i = ((BitArray)localObject3).b();; i = paramString.length())
    {
      ...
      gb.a(paramString, paramErrorCorrectionLevel, paramMap, i, (ByteMatrix)localObject1);
  ...
  static void a(int paramInt, Version paramVersion, Mode paramMode, BitArray paramBitArray)
  {
    ...
    paramBitArray.c(paramInt, i);
  }
  
  private static void a(CharacterSetECI paramCharacterSetECI, BitArray paramBitArray)
  {
    paramBitArray.c(Mode.ECI.getBits(), 4);
    paramBitArray.c(paramCharacterSetECI.getValue(), 8);
  }
  
  static void a(Mode paramMode, BitArray paramBitArray)
  {
    paramBitArray.c(paramMode.getBits(), 4);
  }
  ...
  static void a(CharSequence paramCharSequence, BitArray paramBitArray)
  {
    ...
    while (i < j)
    {
      ...
      if (i + 2 < j)
      {
        paramBitArray.c(k * 100 + (paramCharSequence.charAt(i + 1) - '0') * 10 + (paramCharSequence.charAt(i + 2) - '0'), 10);
        i += 3;
      }
      else if (i + 1 < j)
      {
        paramBitArray.c(k * 10 + (paramCharSequence.charAt(i + 1) - '0'), 7);
        i += 2;
      }
      else
      {
  ...
  static void a(String paramString, BitArray paramBitArray)
  {
    for (;;)
    {
      ...
      if ((i >= 57408) && (i <= 60351))
      {
        ...
        continue;
        label109:
        paramBitArray.c((i & 0xFF) + (i >> 8) * 192, 13);
        j += 2;
      }
      else
      {
  ...
  static void a(String paramString1, BitArray paramBitArray, String paramString2)
  {
    try
    {
      ...
      while (i < j)
      {
        paramBitArray.c(paramString1[i], 8);
        i += 1;
      }
      return;
    }
