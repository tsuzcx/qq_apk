...
public abstract interface IVideoEventListener
{
  ...
  public abstract void a(int paramInt, String paramString1, String paramString2, byte[] paramArrayOfByte, boolean paramBoolean);
  
  public abstract void a(String paramString, int paramInt, long paramLong);
  
  public abstract void a(String paramString, boolean paramBoolean);
  
  public abstract void a(String paramString, byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4);
  ...
  public abstract void d(byte[] paramArrayOfByte, long paramLong);
