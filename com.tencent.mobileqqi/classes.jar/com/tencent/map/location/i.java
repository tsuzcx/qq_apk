...
public final class i
{
  ...
  public static String a(d.b paramb, List<NeighboringCellInfo> paramList)
  {
    ...
    int j = paramb.b;
    int k = paramb.c;
    if (a(paramb.a, j, k, paramb.d, paramb.e))
    {
      localStringBuilder.append(a(j, k, paramb.d, paramb.e, paramb.f, paramb.g, paramb.h));
      i = 1;
    }
    if (paramList != null) {}
    label258:
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if (!a(paramb.a, j, k, m, localNeighboringCellInfo.getCid())) {
            break label258;
          }
          if (i > 0) {
            localStringBuilder.append(",");
          }
          localStringBuilder.append(a(j, k, m, localNeighboringCellInfo.getCid(), (localNeighboringCellInfo.getRssi() << 1) - 113, 2147483647, 2147483647));
          i += 1;
          continue;
        }
        localStringBuilder.append("]");
 ...
 * Qualified Name:     com.tencent.map.location.i
