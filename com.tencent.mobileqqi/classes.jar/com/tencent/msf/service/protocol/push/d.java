  ...
  extends JceStruct
{
  ...
  public d(long paramLong1, long paramLong2, String paramString1, int paramInt1, byte paramByte1, byte paramByte2, byte paramByte3, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, byte[] paramArrayOfByte, String paramString2, String paramString3, String paramString4)
  {
    this.a = paramLong1;
    this.b = paramLong2;
    this.c = paramString1;
