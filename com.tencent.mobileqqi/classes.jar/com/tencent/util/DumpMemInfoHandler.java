...
public class DumpMemInfoHandler
{
  ...
  private hzl[] jdField_a_of_type_ArrayOfHzl = new hzl[DumpMemInfoHandler.Heap.values().length];
  ...
  public DumpMemInfoHandler()
  {
    ...
    while (i < this.jdField_a_of_type_ArrayOfHzl.length)
    {
      this.jdField_a_of_type_ArrayOfHzl[i] = new hzl(this, null);
  ...
  private String a(String paramString1, String paramString2)
  {
    ...
    while (i < this.jdField_a_of_type_ArrayOfHzl.length)
    {
      ((StringBuffer)localObject).append(String.format("\n\n%-11s    %dK\n", new Object[] { arrayOfHeap[i].name(), Long.valueOf(this.jdField_a_of_type_ArrayOfHzl[i].a) }));
  ...
  private Map.Entry[] a(Hashtable paramHashtable)
  {
    ...
    Arrays.sort(paramHashtable, new hzk(this));
      ...
      try
      {
        ...
        if ((((String)localObject4).length() > 30) && (((String)localObject4).charAt(8) == '-') && (((String)localObject4).charAt(17) == ' '))
        {
          ...
          if (m < paramString.length)
          {
            ...
            localObject2 = this.jdField_a_of_type_ArrayOfHzl[n];
            ((hzl)localObject2).a += i;
            localObject2 = this.jdField_a_of_type_ArrayOfHzl[n];
            ((hzl)localObject2).b += j;
            localObject2 = this.jdField_a_of_type_ArrayOfHzl[n];
            ((hzl)localObject2).c += k;
