...
public class H5ConfirmDialog
{
  ...
  public H5ConfirmDialog(Context paramContext)
  {
    ...
    this.confirm_btn = ((Button)this.dialog.findViewById(2131232102));
    this.cancel_btn = ((Button)this.dialog.findViewById(2131232101));
    this.createIcon_cb = ((CheckBox)this.dialog.findViewById(2131232100));
