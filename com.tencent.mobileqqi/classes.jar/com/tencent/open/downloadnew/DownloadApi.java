...
public class DownloadApi
{
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentTmassistantsdkDownloadclientITMAssistantExchangeURLListenner = new hmh();
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    ThreadManager.b(new hmi(paramActivity, paramBundle));
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, int paramInt1, ApkUpdateDetail paramApkUpdateDetail, int paramInt2)
  {
    ...
    ThreadManager.b().post(new hmf(paramBundle, paramInt1, paramInt2, paramActivity, paramApkUpdateDetail));
  }
  ...
  public static void a(Bundle paramBundle)
  {
    ...
    ThreadManager.b(new hmj(paramBundle));
  }
  
  public static void a(DownloadListener paramDownloadListener)
  {
    ThreadManager.b().post(new hmn(paramDownloadListener));
  }
  
  public static void a(String paramString)
  {
    ThreadManager.b().post(new hmm(paramString));
  }
  
  public static void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ThreadManager.b().post(new hml(paramString1, paramString2, paramBoolean));
  }
  ...
  public static void a(List paramList, DownloadQueryListener paramDownloadQueryListener)
  {
    ...
    ThreadManager.b().post(new hmk(paramList, paramDownloadQueryListener));
  }
  ...
  public static void b(Activity paramActivity, Bundle paramBundle, int paramInt1, ApkUpdateDetail paramApkUpdateDetail, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramInt2 == 1)
      {
        ...
        MyAppApi.a().a(paramActivity, paramBundle, new hmp(paramBundle, paramInt1, paramApkUpdateDetail));
        return;
      }
    } while ((paramInt2 != 2) && (paramInt2 != 0));
    MyAppApi.a().b(paramActivity, paramBundle, new hmg(paramBundle, paramInt1, paramApkUpdateDetail));
  }
