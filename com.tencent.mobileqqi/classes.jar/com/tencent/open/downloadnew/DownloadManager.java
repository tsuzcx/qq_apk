...
public class DownloadManager
{
  ...
  protected DownloadManager()
  {
    ...
    this.jdField_a_of_type_ComTencentTmassistantsdkDownloadclientITMAssistantDownloadSDKClientListener = new hrl(this);
    ...
    ThreadManager.b().post(new hri(this));
  }
  ...
  public int a(String paramString)
  {
    ...
    {
      ThreadManager.b().post(new hqz(this, (String)localObject));
  ...
  public void a()
  {
    ThreadManager.b().post(new hqw(this));
  }
  ...
  {
    new Handler(Looper.getMainLooper()).post(new hre(this, paramBundle, paramActivity, paramInt1, paramApkUpdateDetail, paramInt2));
  }
    ...
    for (;;)
    {
      try
      {
        if (paramDownloadInfo.jdField_c_of_type_Boolean) {
          ImageCache.a("app", ImageUtil.a(paramDownloadInfo.jdField_b_of_type_JavaLangString, 100), new hqx(this, paramDownloadInfo));
        }
        ...
        if (localObject != null)
        {
          if (a((DownloadInfo)localObject, paramDownloadInfo))
          {
            ...
            if (paramDownloadInfo.jdField_f_of_type_Int == 1)
            {
              ...
              ThreadManager.b().post(new hqy(this, (String)localObject, i, paramDownloadInfo));
            }
          }
          else
          {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (((Iterator)localObject).hasNext())
        {
          ...
          if (paramDownloadInfo.jdField_f_of_type_Int == 1)
          {
            ThreadManager.b().post(new hro(this, paramDownloadInfo));
            return;
          }
          ThreadManager.b().post(new hrp(this, paramDownloadInfo));
          return;
          ...
          {
            ThreadManager.b().post(new hrq(this, (String)localObject));
            break;
          }
        }
      }
  ...
  protected void b()
  {
    ThreadManager.b().postDelayed(new hrj(this), 5000L);
    ThreadManager.b().postDelayed(new hrk(this), 10000L);
  }
  ...
  public void b(DownloadInfo paramDownloadInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        if (paramDownloadInfo.jdField_f_of_type_Int == 1) {
          ThreadManager.b().post(new hra(this, paramDownloadInfo));
        } else {
          ThreadManager.b().post(new hrb(this, paramDownloadInfo));
        }
      }
      else {
        ThreadManager.b().post(new hrc(this, paramDownloadInfo));
      }
    }
  }
  ...
  public void b(String paramString)
  {
    ...
    for (localObject = ((DownloadInfo)localObject).jdField_h_of_type_JavaLangString;; localObject = ((DownloadInfo)localObject).jdField_c_of_type_JavaLangString)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        ThreadManager.b().post(new hrr(this, (String)localObject));
      }
  ...
  public void e()
  {
    ...
    //   61: dup
    //   62: aload_0
    //   63: invokespecial 934	hrd:<init>	(Lcom/tencent/open/downloadnew/DownloadManager;)V
  ...
  protected void f()
  {
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 200) {
      ThreadManager.b().postDelayed(new hrh(this), 3000L);
    }
  }
}
