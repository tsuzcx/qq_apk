...
public class HttpBaseUtil
{
  ...
  {
    String str2 = paramBundle.getString("needhttpcache");
    Object localObject = a(paramString1, paramString2, paramBundle);
    paramBundle.remove("needhttpcache");
    HttpResponse localHttpResponse = ((HttpBaseUtil.HttpResponseBean)localObject).jdField_a_of_type_OrgApacheHttpHttpResponse;
    int i = ((HttpBaseUtil.HttpResponseBean)localObject).jdField_a_of_type_Int;
    int j = localHttpResponse.getStatusLine().getStatusCode();
    long l = 0L;
    if (localHttpResponse.containsHeader("Etag")) {}
    for (localObject = localHttpResponse.getFirstHeader("Etag").getValue();; localObject = null)
    {
      if (localHttpResponse.containsHeader("Last-Modified")) {
        l = Long.parseLong(localHttpResponse.getFirstHeader("Last-Modified").getValue());
      }
      String str1;
      if ("GET".equals(paramString2))
      {
        str1 = a(paramString1, paramBundle);
        LogUtility.c(jdField_a_of_type_JavaLangString, "url2=" + str1);
      }
      for (;;)
      {
        if (j == 200)
        {
          ...
          if ((str2 == null) || (!"GET".equals(paramString2))) {
            break label388;
          }
          HttpCacheService.a().a(str1, (String)localObject, l, paramString1);
          paramInt = 1;
        }
        for (;;)
        {
          return new HttpBaseUtil.Statistic(paramString1, i, paramInt);
          if ((j == 304) && (localObject != null))
          {
            localObject = HttpCacheService.a().b(str1);
            if ((localObject == null) || ("".equals(localObject)))
            {
              ...
              if (str1 != null) {
                HttpCacheService.a().a(str1);
              }
              paramBundle.putString("needhttpcache", "nothing");
              if (paramInt < 1) {
                a(paramString1, paramString2, paramBundle, paramInt);
              }
            }
            paramInt = 0;
            paramString1 = (String)localObject;
          ...
          {
            LogUtility.e(jdField_a_of_type_JavaLangString, "request" + paramString1 + "http server return error, statuscode:" + j);
            throw new HttpBaseUtil.HttpStatusException("http status code error:" + j);
            label388:
            paramInt = 1;
          }
  ...
  public static String a(HttpResponse paramHttpResponse)
  {
    ...
    //   9: astore 8
    //   11: aload_0
    //   12: invokeinterface 554 1 0
    //   17: astore 5
    //   19: aload_0
    //   20: ldc_w 556
    //   23: invokeinterface 449 2 0
    //   28: ifeq +47 -> 75
    //   31: aload_0
    //   32: ldc_w 556
    //   35: invokeinterface 453 2 0
    //   40: invokeinterface 458 1 0
    //   45: invokestatic 465	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   48: lstore_3
    ...
    //   107: invokevirtual 569	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   110: ldc 186
    //   112: invokevirtual 169	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   115: iconst_m1
    //   116: if_icmple +53 -> 169
    //   119: new 571	java/util/zip/GZIPInputStream
    //   122: dup
    //   123: aload 5
    //   125: invokespecial 572	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   128: astore 6
    //   130: aload 6
    //   132: invokestatic 574	com/tencent/open/base/http/HttpBaseUtil:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   135: astore 7
    //   137: aload 7
    //   139: astore_0
    //   140: aload 5
    //   142: ifnull +8 -> 150
    //   145: aload 5
    //   147: invokevirtual 577	java/io/InputStream:close	()V
    //   150: aload_0
    //   151: astore 5
    //   153: aload 6
    //   155: ifnull +11 -> 166
    //   158: aload 6
    //   160: invokevirtual 577	java/io/InputStream:close	()V
    //   163: aload_0
    //   164: astore 5
    //   166: aload 5
    //   168: areturn
    //   169: aload 5
    //   171: invokestatic 574	com/tencent/open/base/http/HttpBaseUtil:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   174: astore 6
    //   176: aload 6
    //   178: astore_0
    //   179: aconst_null
    ...
    //   190: ldc_w 579
    //   193: aload 5
    //   195: invokestatic 582	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   198: aload_0
    //   199: areturn
    //   200: astore 7
    //   202: aconst_null
    ...
    //   225: aload 7
    //   227: invokevirtual 585	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   236: aload 7
    //   238: invokestatic 582	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   241: aload_0
    //   242: invokeinterface 589 1 0
    //   247: astore_0
    //   248: aload_0
    //   249: arraylength
    //   250: istore_2
    ...
    //   308: invokestatic 482	com/tencent/open/base/LogUtility:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   311: iload_1
    //   312: iconst_1
    //   313: iadd
    //   314: istore_1
    ...
    //   320: ifnull +8 -> 328
    //   323: aload 5
    //   325: invokevirtual 577	java/io/InputStream:close	()V
    //   328: aload 8
    //   330: astore 5
    //   332: aload 6
    //   334: ifnull -168 -> 166
    //   337: aload 6
    //   339: invokevirtual 577	java/io/InputStream:close	()V
    //   342: ldc_w 477
    //   345: areturn
    //   346: astore_0
    ...
    //   350: ldc_w 579
    //   353: aload_0
    //   354: invokestatic 582	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   357: ldc_w 477
    //   360: areturn
    //   361: astore_0
    //   362: aconst_null
    ...
    //   371: ifnull +8 -> 379
    //   374: aload 5
    //   376: invokevirtual 577	java/io/InputStream:close	()V
    //   379: aload 6
    //   381: ifnull +8 -> 389
    //   384: aload 6
    //   386: invokevirtual 577	java/io/InputStream:close	()V
    //   389: aload_0
    //   390: athrow
    //   391: astore 5
    ...
    //   396: ldc_w 579
    //   399: aload 5
    //   401: invokestatic 582	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   404: goto -15 -> 389
    //   407: astore_0
    //   408: aload 7
    //   410: astore 6
  ...
  protected static HttpClient a()
  {
    try
    {
      ...
      localObject = new hlt((KeyStore)localObject);
