  ...
  implements JavaScriptInterface, IJsCallBack
{
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new hor(this, paramString));
  }
  ...
  public void getQueryDownloadAction(String paramString)
  {
    ...
    try
    {
      ...
      DownloadApi.a(localArrayList, new hop(this, (String)localObject));
      return;
    }
    catch (JSONException paramString)
    {
  ...
  public void getQueryDownloadAction(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      DownloadApi.a(paramString2, new hoq(this));
      return;
    }
    catch (JSONException paramString1)
    {
