...
public class OpenSdkFriendService
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = OpenSdkFriendService.class.getName();
  ...
  public void a(Bundle paramBundle, OpenSdkFriendService.GetFriendInfoListener paramGetFriendInfoListener, String paramString)
  {
    ...
    {
      LogUtility.e(jdField_a_of_type_JavaLangString, "getFriendListAsync params error. params=" + paramBundle + "; listener=" + paramGetFriendInfoListener);
      return;
    }
  ...
  {
    new Handler(Looper.getMainLooper()).post(new hjh(this, paramHandler));
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        LogUtility.e(jdField_a_of_type_JavaLangString, "initData error. appid=" + paramString1 + "; openid=" + paramString2);
        return;
      }
      finally {}
