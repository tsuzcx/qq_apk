  ...
  extends PinnedDividerListView.DividerAdapter
{
  ...
  protected void a()
  {
    ...
    LogUtility.c(FriendListOpenFrame.jdField_a_of_type_JavaLangString, "-->start constructHashStruct()");
    ...
    LogUtility.c(FriendListOpenFrame.jdField_a_of_type_JavaLangString, "-->end constructHashStruct()");
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903964, paramViewGroup, false);
      paramViewGroup = new FriendListOpenFrame.ViewHolder();
      paramViewGroup.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131231566));
      paramViewGroup.e = ((TextView)paramView.findViewById(2131231565));
      paramViewGroup.a = ((CheckBox)paramView.findViewById(2131230943));
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131230940));
      paramViewGroup.f = ((TextView)paramView.findViewById(2131231000));
      ...
      if ((localFriend.d == null) || ("".equals(localFriend.d))) {
        localFriend.d = QZonePortraitData.a(this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_ComTencentOpenAgentSocialFriendChooser.c(), localFriend.jdField_a_of_type_JavaLangString);
      }
      ...
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130838010);
    ...
    for (;;)
    {
      ...
      paramViewGroup.f.setText(localFriend.jdField_b_of_type_JavaLangString);
      return paramView;
      ...
      break label185;
      label354:
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView.setImageBitmap(localBitmap);
    }
    label366:
