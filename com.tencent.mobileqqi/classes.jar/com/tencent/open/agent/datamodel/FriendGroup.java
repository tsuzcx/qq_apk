  ...
  extends DbCacheData
{
  ...
  public static final String c = "INTEGER UNIQUE";
  ...
  static
  {
    jdField_a_of_type_ComTencentOpenComponentCacheDatabaseDbCacheData$DbCreator = new hob();
  }
    ...
    while (i < n)
    {
      ...
      if (j < i1)
      {
        ...
        for (localObject = ((JSONObject)localObject).getString("label");; localObject = null)
        {
          ...
          localFriend.c = StringAddition.a((String)localObject);
          localFriend.jdField_a_of_type_Int = m;
          localFriend.jdField_b_of_type_Int = k;
      ...
      while (k < i2)
      {
        ...
        else
        {
          ...
          for (String str1 = localJSONObject2.getString("remark");; str1 = null)
          {
            ...
            localFriend.c = StringAddition.a(str1);
            if (localJSONObject2.getInt("specified") == 1)
            {
              localFriend.jdField_a_of_type_Int = i1;
              localFriend.jdField_b_of_type_Int = n;
              localArrayList2.add(localFriend);
            }
