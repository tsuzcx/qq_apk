  ...
  implements HttpCgiAsyncTask.Callback
{
  ...
  {
    LogUtility.c(OpenSdkFriendService.jdField_a_of_type_JavaLangString, "GetFriendListCallback exception." + paramException.getMessage(), paramException);
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        LogUtility.c(OpenSdkFriendService.jdField_a_of_type_JavaLangString, "-->result = " + paramJSONObject);
        ...
        if ("action_invite".equals(this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService.i))
        {
          ...
          if (!OpensdkPreference.a(CommonDataAdapter.a().a(), "invite_friend_list_md5").getString(this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService.g, "").equals(str))
          {
            ...
            ThreadManager.b(new hjj(this, paramJSONObject, str));
            if (this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService$GetFriendInfoListener == null) {
              break label536;
            }
          ...
          this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService.jdField_a_of_type_AndroidOsBundle.putString("md5str", "0");
          this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService.a("0");
          new HttpCgiAsyncTask(this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService.h, "GET", new GetFriendListCallback(this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService, this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService$GetFriendInfoListener)).a(this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService.jdField_a_of_type_AndroidOsBundle);
          return;
        }
      }
