  ...
  implements View.OnClickListener
{
  ...
  public void g()
  {
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList != null)
    {
      ...
      {
        localObject4 = localLayoutInflater.inflate(2130903065, this.jdField_a_of_type_AndroidWidgetLinearLayout, false);
        localObject6 = (TextView)((View)localObject4).findViewById(2131230989);
        TextView localTextView = (TextView)((View)localObject4).findViewById(2131230990);
        localObject5 = (ImageView)((View)localObject4).findViewById(2131230985);
        ...
        if (localObject1 != null)
        {
          localObject3 = ImageUtil.a((Bitmap)localObject1, ((Bitmap)localObject1).getWidth(), ((Bitmap)localObject1).getHeight());
    ...
    for (;;)
    {
      ...
      {
        localObject1 = localLayoutInflater.inflate(2130903065, this.jdField_a_of_type_AndroidWidgetLinearLayout, false);
        localObject4 = (TextView)((View)localObject1).findViewById(2131230989);
        localObject5 = (TextView)((View)localObject1).findViewById(2131230990);
        localObject2 = (ImageView)((View)localObject1).findViewById(2131230985);
        ...
        {
          localObject5 = ImageUtil.a((Bitmap)localObject4, 24.0F, ((Bitmap)localObject4).getWidth(), ((Bitmap)localObject4).getHeight());
      ...
      {
        localObject1 = localLayoutInflater.inflate(2130903070, this.jdField_a_of_type_AndroidWidgetLinearLayout, false);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.addView((View)localObject1);
  ...
  public void i()
  {
    ...
    {
      if (this.jdField_a_of_type_MqqManagerWtloginManager.IsUserHaveA1(this.jdField_b_of_type_JavaLangString, jdField_a_of_type_Long))
      {
        if (QLog.isColorLevel()) {
    ...
    {
      if (!this.jdField_a_of_type_MqqManagerWtloginManager.IsNeedLoginWithPasswd(this.jdField_b_of_type_JavaLangString, (int)jdField_a_of_type_Long))
      {
        if (QLog.isColorLevel()) {
