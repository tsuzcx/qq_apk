  ...
  implements View.OnClickListener, Animation.AnimationListener, ImageLoader.ImageLoadListener
{
  ...
  public FriendChooser()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new hne(this);
  }
  ...
  protected void d()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131232154));
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)super.findViewById(2131232160));
    this.jdField_a_of_type_ComTencentCommonAppInnerFrameManager = ((InnerFrameManager)super.findViewById(2131232156));
    this.jdField_a_of_type_AndroidWidgetHorizontalScrollView = ((HorizontalScrollView)super.findViewById(2131232162));
    this.jdField_a_of_type_AndroidWidgetGridView = ((GridView)super.findViewById(2131232164));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131232167));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131232166));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131232163));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131232165));
  }
  ...
  protected void f()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetGridView.setOnItemClickListener(new hnb(this));
  ...
  protected void h()
  {
    ...
    this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131233084));
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new hnc(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new hnd(this));
  }
