  ...
  implements TextWatcher, View.OnClickListener, HttpCgiAsyncTask.Callback, HttpImageDownloadAsyncTask.TaskCompleteCallback
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = SendStoryActivity.class.getName();
  }
  ...
  protected void a(Intent paramIntent)
  {
    ...
    if (j != 0)
    {
      ...
      LogUtility.e(jdField_a_of_type_JavaLangString, "onSendStoryComplete error:{KEY_ERROR_CODE:" + j + "; KEY_ERROR_MSG:" + paramIntent.getStringExtra("key_error_msg") + "}");
    }
  ...
  {
    f();
    LogUtility.c(jdField_a_of_type_JavaLangString, "SendStory exception. " + paramException.getMessage(), paramException);
  ...
  public void a(JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (j == 0) {
        Toast.makeText(this, 2131560057, 0).show();
      }
      Intent localIntent = new Intent();
    ...
    {
      LogUtility.c(jdField_a_of_type_JavaLangString, "SendStory exception. " + paramJSONObject.getMessage(), paramJSONObject);
  ...
  protected void d()
  {
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131232182));
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131232157);
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131231375));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131231455));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131231456));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131231379));
    this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_e_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_f_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentOpenWidgetCursorEditText = ((CursorEditText)super.findViewById(2131232187));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131232185));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131232188));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131232183));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131232189));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131232190));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131232191));
    ...
    new HttpImageDownloadAsyncTask(null, this.g, null, "GET", this).execute(new Void[0]);
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      {
        LogUtility.c(jdField_a_of_type_JavaLangString, "onActivityResult error:" + paramIntent.getMessage(), paramIntent);
        super.setResult(0);
        super.finish();
        return;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        {
          localObject3[j] = localObject2[j].jdField_a_of_type_JavaLangString;
          j += 1;
        }
    ...
    Arrays.sort((Object[])localObject3, new hjm(this, (Editable)localObject2));
    ...
    {
      Toast.makeText(this, super.getString(2131560058, new Object[] { Integer.valueOf(10) }), 0).show();
      return;
    }
    ...
    this.jdField_a_of_type_AndroidAppProgressDialog = ProgressDialog.show(this, "", super.getString(2131560056), true);
  ...
  protected void onStart()
  {
    ...
    this.jdField_e_of_type_AndroidWidgetTextView.setText(2131561746);
    this.jdField_f_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_f_of_type_AndroidWidgetTextView.setText(2131560054);
    this.jdField_c_of_type_AndroidWidgetTextView.setText(2131560053);
    this.jdField_e_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_f_of_type_AndroidWidgetTextView.setOnClickListener(this);
  }
