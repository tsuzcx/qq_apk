  ...
  extends OpenFrame
{
  ...
  public void a(Bundle paramBundle)
  {
    ...
    super.setContentView(2130903973);
  ...
  protected void f()
  {
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)super.findViewById(2131232609));
    LinearLayout localLinearLayout = (LinearLayout)super.a().getLayoutInflater().inflate(2130903342, null);
    localLinearLayout.findViewById(2131233084).setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localLinearLayout.findViewById(2131232168));
    this.b = ((TextView)localLinearLayout.findViewById(2131232175));
    this.jdField_a_of_type_ComTencentOpenAgentRecommendListManager = ((RecommendListManager)localLinearLayout.findViewById(2131232169));
    ...
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)localLinearLayout.findViewById(2131233085));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new hnk(this));
  }
