  ...
  extends BaseInterface
{
  ...
  public String getAppVersionCode(String paramString)
  {
    try
    {
      ...
      String str = localJSONObject.getString("packageName");
      paramString = localJSONObject.getString("appid");
      localJSONObject.getString("downloadUrl");
      int i = 0;
      if (AppUtil.a(str)) {
        i = AppUtil.a(str);
      }
      localJSONObject = new JSONObject();
      localJSONObject.put("installedVersionCode", i);
      localJSONObject.put("downloadedVersionCode ", AppUtil.b(DownloadManager.a().a(paramString)));
  ...
  public void goToDetailPage(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      while (!this.lastActionRecord.a(str, (String)localObject, i))
      {
        ...
        ThreadManager.b().post(new how(this, paramString2, bool1, bool2));
        return;
      }
      return;
    ...
    {
      ThreadManager.b().post(new hox(this, paramString2, bool1, bool2));
      return;
    }
    goUrl(paramString1.optString("url"), true);
  }
  ...
  public void goUrl(String paramString)
  {
    ...
    label347:
    label372:
    for (localObject1 = paramString.replaceAll("\\{SID\\}", CommonDataAdapter.a().a());; localObject1 = paramString + "sid=" + CommonDataAdapter.a().a())
    {
      paramString = (String)localObject1;
  ...
  protected void goUrl(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      localJSONArray.put(this.activity.getString(2131560015));
  ...
  public void goWebApp(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 376	com/tencent/open/appcommon/js/BaseJsCallBack:hasRight	()Z
    //   4: ifne +4 -> 8
    //   7: return
    //   8: ldc 29
    //   10: astore 22
    ...
    //   186: aload 32
    //   188: ldc_w 281
    //   191: invokevirtual 405	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   194: astore_1
    //   195: aload 23
    //   197: astore 24
    //   199: aload_1
    ...
    //   255: aload 32
    //   257: ldc_w 599
    //   260: invokevirtual 405	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   263: astore 22
    //   265: aload 23
    //   267: astore 24
    //   269: aload_1
    ...
    //   325: aload 32
    //   327: ldc_w 601
    //   330: invokevirtual 430	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   333: istore_2
    //   334: aload 23
    //   336: astore 24
    //   338: aload_1
    ...
    //   393: aload 32
    //   395: ldc_w 603
    //   398: invokevirtual 430	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   401: istore_3
    //   402: aload 23
    //   404: astore 24
    //   406: aload_1
    ...
    //   460: aload 32
    //   462: ldc_w 605
    //   465: invokevirtual 430	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   468: istore 4
    //   470: aload 23
    //   472: astore 24
    //   474: aload_1
    ...
    //   528: aload 32
    //   530: ldc_w 607
    //   533: invokevirtual 430	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   536: istore 5
    //   538: aload 23
    //   540: astore 24
    //   542: aload_1
    ...
    //   596: aload 32
    //   598: ldc_w 609
    //   601: invokevirtual 430	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   604: istore 6
    //   606: aload 23
    //   608: astore 24
    //   610: aload_1
    ...
    //   664: aload 32
    //   666: ldc_w 611
    //   669: invokevirtual 405	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   672: astore 23
    //   674: aload 23
    //   676: astore 24
    //   678: aload_1
    ...
    //   732: aload 32
    //   734: ldc_w 613
    //   737: invokevirtual 405	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   740: astore 30
    //   742: aload 30
    //   744: astore 24
    //   746: aload 32
    //   748: ldc_w 615
    //   751: invokevirtual 405	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   754: astore 25
    //   756: ldc 8
    ...
    //   782: iload_2
    //   783: invokevirtual 351	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   786: ldc_w 572
    //   789: invokevirtual 119	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   792: iload 4
    //   794: invokevirtual 351	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   797: ldc_w 572
    //   800: invokevirtual 119	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   803: iload_3
    //   804: invokevirtual 351	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   807: ldc_w 572
    //   810: invokevirtual 119	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   813: iload 5
    //   815: invokevirtual 351	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   818: ldc_w 572
    ...
    //   846: iload 6
    //   848: invokevirtual 351	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   851: ldc_w 572
    ...
    //   878: iconst_0
    //   879: invokevirtual 351	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    ...
    //   888: new 525	android/content/Intent
    //   891: dup
    //   892: aload_0
    //   893: getfield 37	com/tencent/open/appcommon/js/BaseJsCallBack:activity	Landroid/app/Activity;
    //   896: ldc_w 619
    //   899: invokespecial 530	android/content/Intent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   902: astore 25
    //   904: new 397	android/os/Bundle
    //   907: dup
    //   908: invokespecial 398	android/os/Bundle:<init>	()V
    //   911: astore 26
    //   913: aload 26
    //   915: ldc_w 476
    //   918: aload 22
    //   920: invokevirtual 408	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   923: aload 26
    //   925: ldc_w 601
    //   928: iload_2
    //   929: invokevirtual 434	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   932: aload 26
    //   934: ldc_w 605
    //   937: iload 4
    //   939: invokevirtual 434	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   942: aload 26
    //   944: ldc_w 603
    //   947: iload_3
    //   948: invokevirtual 434	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   951: aload 26
    //   953: ldc_w 607
    //   956: iload 5
    //   958: invokevirtual 434	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   961: aload 26
    //   963: ldc_w 611
    //   966: aload 23
    //   968: invokevirtual 408	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   971: aload 26
    //   973: ldc_w 613
    //   976: aload 24
    //   978: invokevirtual 408	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   981: aload 26
    //   983: ldc_w 609
    //   986: iload 6
    //   988: invokevirtual 434	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   991: aload 26
    //   993: ldc_w 621
    //   996: aload_1
    //   997: invokevirtual 408	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   1000: aload 25
    //   1002: aload 26
    //   1004: invokevirtual 580	android/content/Intent:putExtras	(Landroid/os/Bundle;)Landroid/content/Intent;
    //   1007: pop
    //   1008: aload_0
    //   1009: getfield 37	com/tencent/open/appcommon/js/BaseJsCallBack:activity	Landroid/app/Activity;
    //   1012: aload 25
    //   1014: invokevirtual 625	android/app/Activity:startActivity	(Landroid/content/Intent;)V
    //   1017: return
    //   1018: astore 25
    //   1020: ldc 29
    //   1022: astore 27
    ...
    //   1055: astore 24
    //   1057: aload 25
    //   1059: invokevirtual 502	org/json/JSONException:printStackTrace	()V
    //   1062: ldc 8
    //   1064: ldc_w 627
    //   1067: aload 25
  ...
  {
    new AlertDialog.Builder(this.activity).setTitle("javaScript dialog").setMessage(paramString).setPositiveButton(17039370, new hov(this)).setCancelable(false).create().show();
  }
  ...
  public void setActionButton(String paramString)
  {
    ...
    this.mHandler.post(new hoy(this, paramString));
  }
  ...
  public void showToast(String paramString)
  {
    ...
    Toast.makeText(this.activity, paramString, 1).show();
  }
  ...
  public void startOpenApp(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    //   43: invokestatic 773	com/tencent/open/base/LogUtility:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   46: aload_0
    //   47: aload_1
    //   48: invokevirtual 729	com/tencent/open/appcommon/js/BaseJsCallBack:appIsExists	(Ljava/lang/String;)Z
    //   51: istore 6
    //   53: iload 6
    //   55: ifeq +22 -> 77
    //   58: aload 5
    //   60: ldc_w 775
    //   63: invokestatic 780	java/net/URLDecoder:decode	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   66: astore_2
    //   67: aload_0
    ...
    //   72: aload_1
    //   73: aload_2
    //   74: invokestatic 783	com/tencent/open/business/base/AppUtil:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   77: return
    //   78: astore_1
    //   79: ldc 8
    ...
    //   94: aload_1
    //   95: invokevirtual 788	java/lang/Exception:getMessage	()Ljava/lang/String;
