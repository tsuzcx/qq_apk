  ...
  implements IJsCallBack
{
  ...
  public void getQueryDownloadAction(String paramString)
  {
    try
    {
      ...
      getQueryDownloadAction(paramString.getJSONArray("infolist"), paramString.getString("guid"));
      return;
    }
    catch (Exception paramString)
    {
  ...
  public void getQueryDownloadAction(String paramString1, String paramString2)
  {
    try
    {
      getQueryDownloadAction(new JSONArray(paramString1), paramString2);
      return;
    }
    catch (JSONException paramString1)
    {
  ...
  public void getQueryDownloadAction(JSONArray paramJSONArray, String paramString)
  {
    try
    {
      ...
      DownloadApi.a(localArrayList, new hpa(this, paramString));
      return;
    }
    catch (JSONException paramJSONArray)
    {
      LogUtility.c(this.TAG, "getQueryDownloadAction>>>", paramJSONArray);
    }
  }
  ...
  {
    this.mHandler.post(new hpb(this, paramString));
  }
