...
public class AppClient
{
  ...
  public static void a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    for (paramActivity = (Activity)localObject5;; paramActivity = "2410")
    {
      ...
      ThreadManager.b().post(new hkc(paramBundle, (Bundle)localObject2, localMalformedURLException, paramActivity, (String)localObject1));
      return;
      localObject2 = null;
      localObject3 = null;
      localObject4 = "0";
  ...
  protected static void a(Activity paramActivity, String paramString1, String paramString2, Bundle paramBundle, String paramString3, String paramString4)
  {
    ...
    label1181:
    ThreadManager.b().post(new hkb(paramString1, localBundle, str1, paramActivity, localIntent, paramBundle));
    return;
    label1205:
    paramActivity.startActivityForResult(localIntent, 200);
  }
  ...
  public static void b(Activity paramActivity, Bundle paramBundle)
  {
    ...
    if (MyAppApi.a().b())
    {
      ...
      ThreadManager.b().post(new hkd(paramActivity, localBundle));
      return;
    }
