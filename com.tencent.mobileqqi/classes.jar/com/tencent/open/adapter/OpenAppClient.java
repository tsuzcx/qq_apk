...
public class OpenAppClient
{
  ...
  public static Intent a(Context paramContext, String paramString1, String paramString2, int paramInt)
  {
    ...
    if (APNUtil.c(paramContext))
    {
      ...
      {
        new Handler(Looper.getMainLooper()).post(new hif(paramContext, (String)localObject, str1, str3, str2, paramString1, paramString2, paramInt));
        return null;
      }
  ...
  protected static boolean a(Context paramContext, HashMap paramHashMap)
  {
    ...
    //   73: aload_0
    //   74: aload_1
    //   75: invokespecial 395	hig:<init>	(Landroid/content/Context;Ljava/util/HashMap;)V
