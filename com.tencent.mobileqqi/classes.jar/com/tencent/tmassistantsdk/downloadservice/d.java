...
public final class d
{
  ...
  {
    j.b(paramString, "--------dump DownloadInfo-----------");
    j.b(paramString, "mContentType: " + this.a);
    j.b(paramString, "mURL: " + this.b);
    j.b(paramString, "mRetryCnt: " + this.d);
    j.b(paramString, "mRedirectCnt: " + this.e);
    j.b(paramString, "mTotalBytes: " + this.q);
    j.b(paramString, "mUUID: " + this.f);
    j.b(paramString, "mStatus: " + this.i);
    j.b(paramString, "mReceivedBytes: " + this.j);
    j.b(paramString, "mFileName: " + this.k);
    j.b(paramString, "mDownloadFailedErrCode: " + this.n);
    j.b(paramString, "mNetType:" + this.o);
    j.b(paramString, "mDownloadFailedTime:" + this.p);
    j.b(paramString, "mHeaderParamString:" + this.s);
  }
  ...
  public final int d()
  {
    j.b("_DownloadInfo", "DownloadInfo::startDownloadIfReady url: " + this.b);
    ...
    if (!TextUtils.isEmpty(this.k))
    {
      ...
      j.b("_DownloadInfo", "FileLen: " + l1 + " filename: " + this.k);
      if (l1 > this.q)
      {
        ((b)localObject).a();
        this.j = 0L;
    ...
    j.b("_DownloadInfo", "startDownloadIfReady...");
    a("_DownloadInfo");
