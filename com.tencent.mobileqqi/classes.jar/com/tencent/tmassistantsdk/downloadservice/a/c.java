  ...
  implements k
{
  ...
  public final int a(String paramString1, String paramString2, int paramInt, String paramString3, String paramString4, Map paramMap)
  {
    ...
    j.b("ServiceDownloadTaskManager", "startDownload,clientKey:" + paramString1);
    if (c(paramString1, paramString2) != null)
    {
      j.b("ServiceDownloadTaskManager", "startDownload,clientKey:" + paramString1 + ",taskItem is null");
    ...
    localb1.c = 1;
    this.a.add(localb1);
    j.b("ServiceDownloadTaskManager", "startDownload,clientKey:" + paramString1 + ",add newTask");
    ...
    for (;;)
    {
      ...
      if ((j == 1) || (i == 1))
      {
        ...
        for (;;)
        {
          ...
          j.b("ServiceDownloadTaskManager", "startDownload,clientKey:" + paramString1 + ",newTask is downloading");
          return 0;
          if (i == 1) {
            localb1.c = 1;
          }
      ...
      j.b("ServiceDownloadTaskManager", "startDownload,clientKey:" + paramString1 + ",start newTask download");
      return com.tencent.tmassistantsdk.downloadservice.a.a().a(paramString2, paramInt, paramString3, paramString4, paramMap);
    }
  }
    ...
    for (;;)
    {
      ...
      if ((localObject != null) && (((ArrayList)localObject).size() > 0))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          j.b("ServiceDownloadTaskManager", "OnDownloadStateChanged,clientKey:" + localb.a + ",state:" + paramInt1 + ",errorcode:" + paramInt2 + ",url:" + paramString1.hashCode());
          localb.c = paramInt1;
  ...
  public final void a(String paramString, long paramLong1, long paramLong2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        j.b("ServiceDownloadTaskManager", "OnDownloadProgressChanged,clientKey:" + localb.a + ",receivedLen:" + paramLong1 + ",url:" + paramString.hashCode());
  ...
  public final void a(String paramString1, String paramString2)
  {
    ...
    j.b("ServiceDownloadTaskManager", "pauseDownload,clientKey:" + paramString1);
    b localb = c(paramString1, paramString2);
    if (localb != null)
    {
      localb.c = 3;
      this.a.remove(localb);
      j.b("ServiceDownloadTaskManager", "pauseDownload,clientKey:" + paramString1 + ",remove taskItem");
      ArrayList localArrayList = b(paramString2);
      if ((localArrayList == null) || (localArrayList.size() == 0))
      {
        j.b("ServiceDownloadTaskManager", "pauseDownload,clientKey:" + paramString1 + ",taskItem is the only on pauseAll");
        com.tencent.tmassistantsdk.downloadservice.a.a().a(paramString2);
        j.b("ServiceDownloadTaskManager", "pauseDownload end,clientKey:" + paramString1 + ",taskItem is the only on pauseAll");
      }
      if (this.b != null) {
    ...
    for (;;)
    {
      j.b("ServiceDownloadTaskManager", "pauseDownload end,clientKey:" + paramString1);
      return;
      j.d("ServiceDownloadTaskManager", "pauseDownload,clientKey:" + paramString1 + ",taskItem is null");
    }
  }
  ...
  public final void b(String paramString1, String paramString2)
  {
    ...
    j.b("ServiceDownloadTaskManager", "cancelDownload,clientKey:" + paramString1);
    Object localObject = c(paramString1, paramString2);
    if (localObject != null)
    {
      this.a.remove(localObject);
      j.b("ServiceDownloadTaskManager", "cancelDownload,clientKey:" + paramString1 + ",remove taskItem");
    }
    for (;;)
    {
      ...
      j.b("ServiceDownloadTaskManager", "cancelDownload,clientKey:" + paramString1 + ",taskItem is the only on cancelAll");
      com.tencent.tmassistantsdk.downloadservice.a.a().b(paramString2);
      return;
      j.d("ServiceDownloadTaskManager", "cancelDownload,clientKey:" + paramString1 + ",taskItem is null");
    }
  }
}
