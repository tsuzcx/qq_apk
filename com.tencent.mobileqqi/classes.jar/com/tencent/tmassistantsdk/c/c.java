...
public abstract class c
{
  ...
  public void a(com.qq.taf.jce.JceStruct paramJceStruct)
  {
    ...
    //   2: ldc 27
    //   4: ldc 29
    //   6: invokestatic 34	com/tencent/tmassistantsdk/f/j:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   9: aload_1
    //   10: ifnull +18 -> 28
    //   13: aload_1
    //   14: ifnonnull +17 -> 31
    ...
    //   18: astore_1
    //   19: aload_0
    //   20: invokevirtual 37	com/tencent/tmassistantsdk/c/c:b	()Lcom/tencent/tmassistantsdk/e/c/a;
    //   23: aload_1
  ...
  {
    j.b("BaseReportManager", "onLogReprotHttpRequestFinish,result:" + paramBoolean);
    ...
    {
      j.b("BaseReportManager", "onLogReprotHttpRequestFinish wifi is true reportlog go on,result:" + paramBoolean + " count:" + this.b);
      e();
      this.b += 1;
    }
  }
  ...
  public void e()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        j.b("BaseReportManager", "reportLogData,request:" + this.a);
        if (this.a != null) {
          continue;
        }
        this.a = new d();
        this.a.a(this);
        b localb1 = b().a(1000);
        j.b("BaseReportManager", "readLogDataAndSendToServer,wrappterCount:" + localb1.b.size());
        bool1 = bool2;
        if (localb1 != null)
        {
          if (localb1.b.size() <= 0) {
      ...
      boolean bool1 = this.a.a((byte)0, localb2);
    }
  }
