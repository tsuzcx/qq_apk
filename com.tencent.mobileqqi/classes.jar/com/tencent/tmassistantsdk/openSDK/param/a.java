...
public class a
{
  ...
  public static IPCRequest a(JceStruct paramJceStruct)
  {
    ...
    if (paramJceStruct == null)
    {
      ...
      ((IPCHead)localObject).hostPackageName = e.b(e.a().b());
      ((IPCHead)localObject).hostVersionCode = String.valueOf(e.c(e.a().b()));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty(localIPCResponse.head.hostPackageName))
        {
          ...
          localIPCResponse.body = new d().a(paramArrayOfByte, arrayOfByte);
  ...
  public static byte[] a(IPCRequest paramIPCRequest)
  {
    ...
    do
    {
      ...
      byte[] arrayOfByte = "ji*9^&43U0X-~./(".getBytes();
      paramIPCRequest.body = new d().b((byte[])localObject, arrayOfByte);
