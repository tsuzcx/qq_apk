  ...
  implements GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener, ScaleGestureDetector.OnScaleGestureListener
{
  ...
  private iax jdField_a_of_type_Iax = new iax(this);
  private Runnable jdField_a_of_type_JavaLangRunnable = new iav(this);
  ...
  private Rect a(View paramView, Rect paramRect)
  {
    ...
    if (VersionUtils.e()) {}
    for (Matrix localMatrix = paramView.getMatrix();; localMatrix = iaz.a(a(paramView)))
    {
  ...
  private View a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, View paramView)
  {
    ...
    {
      localObject = this.jdField_a_of_type_Iad.a(paramInt1);
      if (localObject != null)
      {
  ...
  private iay a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, View paramView)
  {
    iay localiay = new iay(null);
    int i3 = 0;
    if (paramView.getTag(2131296389) != null) {
      i3 = ((Integer)paramView.getTag(2131296389)).intValue();
    }
    localiay.jdField_a_of_type_Int = i3;
    if (paramView.getTag(2131296386) != null)
    {
      localiay.jdField_a_of_type_Float = ((Float)paramView.getTag(2131296386)).floatValue();
      localiay.b = 17;
      return localiay;
    }
    int i2;
    ...
    if (i2 >= paramInt3) {
      ...
      {
        localiay.jdField_a_of_type_Float = (paramInt3 / i2);
        localiay.b = 17;
      }
    }
    for (;;)
    {
      ...
      {
        localiay.jdField_a_of_type_Float = (paramInt4 / i1);
        localiay.b = 17;
      }
      else
      {
        ...
        if (i1 < paramInt4)
        {
          if (paramInt4 >= paramInt1)
          {
            ...
            {
              localiay.jdField_a_of_type_Float = 1.0F;
              localiay.b = 17;
            }
          }
  ...
  private iaz a(View paramView)
  {
    iaz localiaz2 = (iaz)paramView.getTag(2131296388);
    iaz localiaz1 = localiaz2;
    if (localiaz2 == null)
    {
      localiaz1 = new iaz();
      paramView.setTag(2131296388, localiaz1);
    }
    if (localiaz1.jdField_a_of_type_Boolean) {
      a(localiaz1);
    }
    return localiaz1;
  }
    ...
    for (i1 = ((Integer)this.jdField_a_of_type_AndroidViewView.getTag(2131296389)).intValue();; i1 = 0)
    {
      ...
      if (paramFloat == 0.0F) {
        if (i2 != i1)
        {
          ...
          f2 = ((iay)localObject).jdField_a_of_type_Float;
          this.jdField_a_of_type_AndroidViewView.setTag(2131296385, Float.valueOf(((iay)localObject).jdField_a_of_type_Float));
          paramFloat = f2;
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_Iax.a(i2, i1, f1, paramFloat, f3, f4);
          return;
        ...
        label628:
        this.jdField_a_of_type_Iax.a(i2, i1);
        return;
        if (jdField_b_of_type_AndroidGraphicsRect.right + this.jdField_t_of_type_Int / 2 > this.jdField_a_of_type_AndroidGraphicsRect.left + this.E / 2)
        {
          ...
          this.jdField_a_of_type_Iax.a(i1 + i2 - i3, 0);
          return;
        }
        a(localView, jdField_b_of_type_AndroidGraphicsRect);
        i1 = this.jdField_a_of_type_AndroidGraphicsRect.left;
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, View paramView)
  {
    ...
    {
      return;
      localiay = a(i1, i2, paramInt1, paramInt2, paramView);
    } while (localiay == null);
    a(paramView, localiay.b, paramInt3, paramBoolean);
    if (localiay.jdField_a_of_type_Float != 0.0F)
    {
      a(paramView, 0.0F, 0.0F);
      a(paramView, localiay.jdField_a_of_type_Float);
      b(paramView, localiay.jdField_a_of_type_Int * 90);
      a(paramView, jdField_b_of_type_AndroidGraphicsRect);
      Rect localRect = a(jdField_b_of_type_AndroidGraphicsRect.width(), jdField_b_of_type_AndroidGraphicsRect.height(), localiay.b, paramInt3, paramBoolean);
    ...
    paramView.setTag(2131296385, Float.valueOf(localiay.jdField_a_of_type_Float));
    paramView.setTag(2131296389, Integer.valueOf(localiay.jdField_a_of_type_Int));
  }
  ...
  private void a(View paramView, float paramFloat1, float paramFloat2)
  {
    ...
    do
    {
      ...
      localiaz = a(paramView);
    } while ((localiaz.jdField_f_of_type_Float == paramFloat1) && (localiaz.jdField_g_of_type_Float == paramFloat2));
    localiaz.jdField_f_of_type_Float = paramFloat1;
    localiaz.jdField_g_of_type_Float = paramFloat2;
    localiaz.jdField_a_of_type_Boolean = true;
  ...
  private void a(View paramView, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    do
    {
      return;
      localiaz = a(paramView);
    } while (localiaz.jdField_d_of_type_Float == paramFloat3);
    localiaz.jdField_f_of_type_Float = paramFloat1;
    localiaz.jdField_g_of_type_Float = paramFloat2;
    localiaz.jdField_d_of_type_Float = paramFloat3;
    localiaz.jdField_e_of_type_Float = paramFloat3;
    localiaz.jdField_a_of_type_Boolean = true;
    paramView.invalidate();
  }
  ...
  private void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    iaz localiaz = a(paramView);
    localiaz.jdField_b_of_type_Float += paramInt1;
    localiaz.jdField_c_of_type_Float += paramInt2;
    localiaz.jdField_a_of_type_Boolean = true;
    paramView.invalidate();
  }
  ...
  private void a(View paramView1, View paramView2)
  {
    ...
    paramView2.setTag(2131296388, (iaz)paramView1.getTag(2131296388));
  }
  
  private void a(iaz paramiaz)
  {
    if (paramiaz == null) {}
    while (!paramiaz.jdField_a_of_type_Boolean) {
      return;
    }
    iaz.a(paramiaz).reset();
    iaz.a(paramiaz).setTranslate(paramiaz.jdField_b_of_type_Float, paramiaz.jdField_c_of_type_Float);
    iaz.a(paramiaz).preRotate(paramiaz.jdField_a_of_type_Float, paramiaz.jdField_f_of_type_Float, paramiaz.jdField_g_of_type_Float);
    iaz.a(paramiaz).preScale(paramiaz.jdField_d_of_type_Float, paramiaz.jdField_e_of_type_Float, paramiaz.jdField_f_of_type_Float, paramiaz.jdField_g_of_type_Float);
    paramiaz.jdField_a_of_type_Boolean = false;
    iaz.a(paramiaz, iaz.a(paramiaz).isIdentity());
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        i2 += 1;
        this.jdField_a_of_type_Iad.a(i6 + i1, localView);
  ...
  private boolean a(int paramInt)
  {
    ...
    if (localView != null)
    {
      paramInt = b();
      int i1 = d(localView);
      this.jdField_a_of_type_Iax.a(paramInt - i1, 0);
      bool = true;
    }
    return bool;
  }
  ...
  public Rect a(Rect paramRect)
  {
    ...
    if (VersionUtils.e()) {}
    for (paramRect = this.jdField_a_of_type_AndroidViewView.getMatrix();; paramRect = iaz.a(a(this.jdField_a_of_type_AndroidViewView)))
    {
  ...
  void d()
  {
    ...
    for (;;)
    {
      ...
      break;
      if (iax.a(this.jdField_a_of_type_Iax).a())
      {
        g();
        if (this.D == 0) {
          this.D = 2;
  ...
  {
    paramView = (iaz)paramView.getTag(2131296388);
    if (paramView != null)
    {
      a(paramView);
      paramTransformation.getMatrix().set(iaz.a(paramView));
      return true;
    }
    return false;
  }
  ...
  public boolean onDown(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Iax.a(false);
  ...
  public boolean onFling(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Iax.a((int)paramFloat1, (int)paramFloat2, i1, i2, i3 + i4 - i5, i6 - i7 - i8);
      break;
      i3 = this.F;
      ...
      for (;;)
      {
        this.jdField_a_of_type_Iax.a((int)paramFloat1, (int)paramFloat2, i1, i2, i3 + i4 - i5, i6 - i7);
        break;
        if (paramFloat1 < 0.0F)
        {
          ...
          if (this.jdField_a_of_type_Iax.a(i1, (int)paramFloat1) <= this.jdField_a_of_type_AndroidGraphicsRect.left)
          {
            this.jdField_a_of_type_Iax.a((int)paramFloat1, 0, this.jdField_a_of_type_AndroidGraphicsRect.left - i1, 2147483647, 0, 0);
            break;
          }
          if (paramFloat1 < -this.y)
          {
            this.jdField_a_of_type_Iax.a(this.jdField_a_of_type_AndroidGraphicsRect.left - i1, 0);
            break;
          }
          g();
          break;
        ...
        if (this.jdField_a_of_type_Iax.a(i2, (int)paramFloat1) >= i1)
        {
          this.jdField_a_of_type_Iax.a((int)paramFloat1, 0, -2147483648, i1 - i2, 0, 0);
          break;
        }
        if (paramFloat1 > this.y)
        {
          this.jdField_a_of_type_Iax.a(i1 - i2, 0);
          break;
        }
        g();
        break;
  ...
  public boolean onKeyUp(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    if ((this.jdField_i_of_type_Boolean) && (this.aB > 0))
    {
      ...
      postDelayed(new iaw(this), ViewConfiguration.getPressedStateDuration());
