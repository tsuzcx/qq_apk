...
public class BubblePopupWindow
{
  ...
  private ViewTreeObserver.OnScrollChangedListener jdField_a_of_type_AndroidViewViewTreeObserver$OnScrollChangedListener = new hvp(this);
  ...
  private void a(WindowManager.LayoutParams paramLayoutParams)
  {
    ...
    hvr localhvr = new hvr(this, this.jdField_a_of_type_AndroidContentContext);
    ...
    localhvr.addView((View)localObject, -1, -1);
    ...
    this.jdField_a_of_type_Hvq = new hvq(this, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837741));
    localObject = new LayerDrawable(new Drawable[] { localObject, this.jdField_a_of_type_Hvq });
    ...
    this.jdField_b_of_type_Hvq = new hvq(this, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837739));
    LayerDrawable localLayerDrawable = new LayerDrawable(new Drawable[] { this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837738), this.jdField_b_of_type_Hvq });
    this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundDrawable(localLayerDrawable);
    localhvr.addView(this.jdField_b_of_type_AndroidWidgetImageView, (ViewGroup.LayoutParams)localObject);
    this.jdField_a_of_type_AndroidWidgetImageView = new ImageView(this.jdField_a_of_type_AndroidContentContext);
    localObject = new FrameLayout.LayoutParams(-2, -2, 83);
    this.jdField_c_of_type_Hvq = new hvq(this, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837737));
    localLayerDrawable = new LayerDrawable(new Drawable[] { this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837736), this.jdField_c_of_type_Hvq });
    this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(localLayerDrawable);
    localhvr.addView(this.jdField_a_of_type_AndroidWidgetImageView, (ViewGroup.LayoutParams)localObject);
    this.jdField_b_of_type_AndroidViewView = localhvr;
