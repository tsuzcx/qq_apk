...
{
  private static final String jdField_a_of_type_JavaLangString = "CameraView";
  ...
  public void a(Camera paramCamera)
  {
    ...
    try
    {
      paramCamera.setPreviewDisplay(this.jdField_a_of_type_AndroidViewSurfaceHolder);
      Camera.Parameters localParameters = paramCamera.getParameters();
      localParameters.setPreviewSize(this.jdField_a_of_type_AndroidHardwareCamera$Size.width, this.jdField_a_of_type_AndroidHardwareCamera$Size.height);
      requestLayout();
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        Log.e("CameraView", "IOException caused by setPreviewDisplay()", localIOException);
      }
    }
  }
  ...
  public void surfaceCreated(SurfaceHolder paramSurfaceHolder)
  {
    ...
    {
      Log.e("CameraView", "IOException caused by setPreviewDisplay()", paramSurfaceHolder);
    }
  }
