  ...
  extends FrameLayout
{
  ...
  public void a(int paramInt)
  {
    if (getChildCount() > 0)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetOverScroller.a(this.mScrollX, this.mScrollY, 0, paramInt, 0, 0, 0, Math.max(0, i3 - (n - i1 - i2)), 0, 0);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      int n = paramMotionEvent.findPointerIndex(this.k);
      if (n != -1)
      {
        float f1 = paramMotionEvent.getY(n);
        int i1 = (int)(this.jdField_b_of_type_Float - f1);
        n = i1;
        if (!this.jdField_d_of_type_Boolean)
        {
          n = i1;
        ...
        if (this.jdField_d_of_type_Boolean)
        {
          ...
          if (this.jdField_d_of_type_Boolean)
          {
            ...
            if ((this.jdField_d_of_type_Boolean) && (getChildCount() > 0))
            {
              ...
              continue;
              a(paramMotionEvent);
              this.jdField_b_of_type_Float = paramMotionEvent.getY(paramMotionEvent.findPointerIndex(this.k));
            }
          }
        }
      }
  ...
  public void setEdgeEffectEnabled(boolean paramBoolean)
  {
    ...
    if (this.jdField_b_of_type_Boolean != paramBoolean)
    {
      ...
      if ((this.g != 2) && (this.jdField_a_of_type_ComTencentWidgetEdgeEffect == null))
      {
  ...
  public void setOverScrollMode(int paramInt)
  {
    ...
    if (paramInt != 2)
    {
      if ((this.jdField_a_of_type_ComTencentWidgetEdgeEffect == null) && (this.jdField_b_of_type_Boolean))
      {
