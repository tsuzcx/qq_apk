  ...
  implements QZoneConfigConst
{
  ...
  private static UriMatcher a()
  {
    ...
    localUriMatcher.addURI("com.tencent.i.common.config.provider.QZoneConfigProvider", "qz_configs", 1);
    localUriMatcher.addURI("com.tencent.i.common.config.provider.QZoneConfigProvider", "qz_cookie", 2);
    localUriMatcher.addURI("com.tencent.i.common.config.provider.QZoneConfigProvider", "qz_update", 3);
    localUriMatcher.addURI("com.tencent.i.common.config.provider.QZoneConfigProvider", "qz_isp_config", 4);
    localUriMatcher.addURI("com.tencent.i.common.config.provider.QZoneConfigProvider", "qz_delete", 6);
    localUriMatcher.addURI("com.tencent.i.common.config.provider.QZoneConfigProvider", "qz_check_time", 5);
  ...
  private Cursor a(String paramString1, String[] paramArrayOfString, String paramString2)
  {
    return this.jdField_a_of_type_ComTencentCommonConfigProviderQZConfigSqliteManager.a(paramString1, paramArrayOfString, paramString2);
  }
  ...
  private Cursor b(String paramString1, String[] paramArrayOfString, String paramString2)
  {
    return this.jdField_a_of_type_ComTencentCommonConfigProviderQZConfigSqliteManager.b(paramString1, paramArrayOfString, paramString2);
  }
  ...
  public Cursor query(Uri paramUri, String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2)
  {
    ...
    default: 
      return null;
    case 1: 
      return a(paramString1, paramArrayOfString2, paramString2);
    case 2: 
      return b();
    case 3: 
      return a();
    case 4: 
      return b(paramString1, paramArrayOfString2, paramString2);
    }
    return c();
  }
