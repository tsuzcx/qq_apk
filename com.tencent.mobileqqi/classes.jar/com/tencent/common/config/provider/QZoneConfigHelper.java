  ...
  implements QZoneConfigConst
{
  ...
  {
    paramSQLiteDatabase.execSQL(" CREATE TABLE IF NOT EXISTS qz_configs (key text PRIMARY KEY NOT NULL,value blob)");
  ...
  {
    QLog.i("provider", 2, "updating database from version " + paramInt1 + " to " + paramInt2);
