...
public class MttLoader
{
  ...
  public static final String a = "http://mdc.html5.qq.com/mh?channel_id=50079&u=";
  public static final int b = 1;
  public static final String b = "http://mdc.html5.qq.com/d/directdown.jsp?channel_id=50079";
  public static final int c = 2;
  public static final String c = "com.tencent.QQBrowser.action.VIEW";
  public static final int d = 3;
  public static final String d = "com.tencent.QQBrowser.action.VIEWSP";
  public static final int e = 4;
  public static final String e = "50079";
  public static final int f = 5;
  public static final String f = "50190";
  private static final int g = 13;
  @Deprecated
  public static final String g = "KEY_APPNAME";
  private static final int h = -1;
  @Deprecated
  public static final String h = "KEY_PKG";
  private static final int i = 0;
  @Deprecated
  public static final String i = "KEY_ACT";
  private static final int j = 1;
  public static final String j = "KEY_PID";
  private static final int k = 2;
  public static final String k = "KEY_EUSESTAT";
  private static final int jdField_l_of_type_Int = 33;
  private static final String jdField_l_of_type_JavaLangString = "loginType";
  private static final int jdField_m_of_type_Int = 42;
  private static final String jdField_m_of_type_JavaLangString = "com.tencent.mtt";
  private static final int jdField_n_of_type_Int = 420000;
  private static final String jdField_n_of_type_JavaLangString = "com.tencent.mtt.x86";
  ...
  public static int a(Activity paramActivity, String paramString, HashMap paramHashMap)
  {
    ...
    try
    {
      ...
      if (paramString.getScheme().toLowerCase().equals("qb"))
      {
        localObject1 = paramString;
        if (!a(paramActivity)) {
          localObject1 = Uri.parse("http://mdc.html5.qq.com/mh?channel_id=50079&u=" + URLEncoder.encode((String)localObject2, "UTF-8"));
        }
      }
          ...
          for (;;)
          {
            if (((Iterator)localObject1).hasNext())
            {
              ...
              if (!TextUtils.isEmpty(str))
              {
                ...
                if ((localObject2 != null) && (!TextUtils.isEmpty(((hif)localObject2).jdField_a_of_type_JavaLangString))) {
                  paramString.setClassName(((hif)localObject2).b, ((hif)localObject2).jdField_a_of_type_JavaLangString);
                }
                break;
                if (((MttLoader.BrowserInfo)localObject2).jdField_a_of_type_Int == 1)
                {
          ...
          catch (PackageManager.NameNotFoundException localNameNotFoundException4)
          {
            ...
            catch (Exception localException)
            {
              ...
              try
              {
                ...
                if (TextUtils.isEmpty(((hif)localObject6).b)) {
                  continue;
                }
                localObject5 = localObject2;
                paramContext = localPackageManager.getPackageInfo(((hif)localObject6).b, 0);
  ...
  private static hif a(Context paramContext, Uri paramUri)
  {
