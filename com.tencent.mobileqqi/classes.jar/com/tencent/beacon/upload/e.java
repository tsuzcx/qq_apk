...
public abstract class e
{
  ...
  public abstract byte[] a(String paramString, byte[] paramArrayOfByte, d paramd);
    ...
    extends e
  {
    ...
    private HttpResponse a(String paramString1, byte[] paramArrayOfByte, String paramString2)
    {
      ...
      //   16: invokestatic 35	com/tencent/beacon/d/a:d	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   19: aload 4
      //   21: astore_1
      //   22: aload_1
      //   23: areturn
      ...
      //   37: aload_0
      //   38: aload_3
      //   39: invokespecial 43	com/tencent/beacon/upload/e$a:a	(Ljava/lang/String;)Lorg/apache/http/client/HttpClient;
      //   42: astore 4
      //   44: aload 4
      //   46: ifnonnull +90 -> 136
      //   49: ldc 45
      ...
      //   55: invokestatic 35	com/tencent/beacon/d/a:d	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   58: aconst_null
      //   59: areturn
      //   60: astore 4
      //   62: aconst_null
      ...
      //   89: aastore
      //   90: invokestatic 35	com/tencent/beacon/d/a:d	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   93: aload_2
      //   94: astore_1
      //   95: aload_3
      //   96: ifnull -74 -> 22
      ...
      //   216: aastore
      //   217: invokestatic 111	com/tencent/beacon/d/a:h	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   220: aload_3
    ...
    private HttpClient a(String paramString)
    {
      try
      {
        ...
        {
          a.a("use proxy: %s", new Object[] { paramString });
    ...
    private static byte[] a(HttpResponse paramHttpResponse)
    {
      ...
      //   46: aastore
      //   47: invokestatic 219	com/tencent/beacon/d/a:c	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   50: aconst_null
      //   51: areturn
      //   52: aload_0
      ...
      //   69: invokestatic 35	com/tencent/beacon/d/a:d	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   72: aconst_null
      //   73: areturn
      ...
      //   148: aastore
      //   149: invokestatic 35	com/tencent/beacon/d/a:d	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   152: aload_2
      //   153: ifnull -149 -> 4
      //   156: aload_2
    ...
    public final byte[] a(String paramString, byte[] paramArrayOfByte, d paramd)
    {
      if (paramString == null)
      {
      ...
      {
        l2 = 0L;
        a.h("start req: %s sz:%d", new Object[] { paramString, Long.valueOf(l2) });
        k = 0;
        m = j + 1;
        if ((j >= 3) || (i >= 2)) {
          break label479;
      ...
      while (k != 0)
      {
        ...
        if (paramString == null)
        {
          a.d("redirect code:" + n + " Location is null! return", new Object[0]);
          return null;
          k = 0;
        }
        else
