  ...
  public final void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localObject1 = b.a().b().getPackageManager();
          ...
          if (!TextUtils.isEmpty(str)) {
            for (;;)
            {
              ...
              try
              {
                ...
                localAppInfoForUpdate.grayVersionCode = 0;
                localAppInfoForUpdate.targetVersionCode = j;
                localAppInfoForUpdate.targetGrayVersionCode = 0;
        ...
        b.a().a(new com.tencent.apkupdate.logic.protocol.a.a(paramMessage));
        return;
