  ...
  implements View.OnClickListener
{
  ...
  public HorizonEmoticonTabs(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_b_of_type_Int = ((int)paramContext.getResources().getDimension(2131427515));
    this.c = ((int)paramContext.getResources().getDimension(2131427516));
  ...
  private void a(boolean paramBoolean, View paramView, int paramInt)
  {
    ...
    if (!paramBoolean)
    {
      localView.setBackgroundResource(2130839114);
      if (paramInt > 0) {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(paramInt - 1).findViewById(2131231651).setBackgroundResource(2130839114);
      }
    }
    do
    {
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int < j)
      {
        ...
        j = (int)getResources().getDimension(2131427512);
  ...
  {
    post(new ftl(this, paramInt, paramDrawable));
  }
  ...
  public void a(EmoticonViewBinder paramEmoticonViewBinder, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        View localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903662, null);
        ...
        if (paramBoolean)
        {
          ...
          if (localDrawable == null)
          {
            ...
            if ((paramEmoticonViewBinder instanceof BigEmoticonViewBinder))
            {
              ...
              ThreadManager.b(new ftj(this, localQQAppInterface, paramEmoticonViewBinder));
            }
          }
          if (localObject != null)
          {
  ...
  public void a(EmoticonViewBinder paramEmoticonViewBinder, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        View localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903214, null);
        ...
        if (paramBoolean)
        {
          ...
          if (localObject2 == null)
          {
            ...
            if ((paramEmoticonViewBinder instanceof BigEmoticonViewBinder))
            {
              ...
              ThreadManager.b(new ftk(this, localQQAppInterface, (BigEmoticonViewBinder)localObject2));
            }
          }
  ...
  public void setSelectedIndex(int paramInt)
  {
    ...
    super.postDelayed(new ftm(this), 200L);
  }
