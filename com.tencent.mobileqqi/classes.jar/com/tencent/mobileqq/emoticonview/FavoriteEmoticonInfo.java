  ...
  extends EmoticonInfo
{
  ...
  {
    this.jdField_b_of_type_JavaLangString = "show_fav_menu";
  }
  
  public static List a(BaseActivity paramBaseActivity)
  {
    if ((paramBaseActivity == null) || (paramBaseActivity.b == null))
    {
    ...
    EmoticonManager localEmoticonManager = (EmoticonManager)paramBaseActivity.b.getManager(12);
    Object localObject1 = paramBaseActivity.b.a().createEntityManager();
    ...
    if (localList != null)
    {
      ...
      if (i >= 0)
      {
        ...
        {
          localObject2 = new PicEmoticonInfo(paramBaseActivity.b.a());
          ((PicEmoticonInfo)localObject2).jdField_b_of_type_Int = 6;
        ...
        for (;;)
        {
          ...
          ((FavoriteEmoticonInfo)localObject2).jdField_b_of_type_Int = 5;
  ...
  {
    String[] arrayOfString = paramContext.getResources().getStringArray(2131689479);
    ...
    paramContext.d(2131561746);
    paramContext.a(new fow(this, paramQQAppInterface, paramEmoticonCallback, paramContext));
    paramContext.show();
  }
