...
{
  private static ColorDrawable jdField_a_of_type_AndroidGraphicsDrawableColorDrawable = new ColorDrawable();
  private static Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable = null;
  ...
  private Drawable a(Context paramContext)
  {
    ...
    label99:
    return jdField_a_of_type_AndroidGraphicsDrawableColorDrawable;
  }
  ...
  public URLDrawable a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        URLDrawable localURLDrawable = URLDrawable.getDrawable((URL)localObject1, jdField_a_of_type_AndroidGraphicsDrawableDrawable, jdField_b_of_type_AndroidGraphicsDrawableDrawable, false);
        ...
        QLog.e("PicEmoticonInfo", 2, "getBigDrawable oom,drawableID=" + this.c);
        return localURLDrawable;
      }
      ...
      for (;;)
      {
        ...
        catch (MalformedURLException localMalformedURLException)
        {
          for (;;)
          {
            ...
            Object localObject3 = null;
            continue;
            localObject5 = jdField_a_of_type_AndroidGraphicsDrawableDrawable;
            localObject4 = jdField_b_of_type_AndroidGraphicsDrawableDrawable;
          }
        }
      }
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      do
      {
        ...
        paramEditText = ((EmoticonManager)paramQQAppInterface.getManager(12)).a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId);
      ...
      } while (((paramEditText != null) && ((2 != paramEditText.status) || (!paramEditText.valid))) || (this.jdField_a_of_type_Boolean));
      if (!EmoticonController.a(paramQQAppInterface).a()) {
        break label282;
      }
      if (EmoticonController.a(paramQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, Boolean.valueOf(false))) {
        break;
      }
      ChatActivityUtils.a(paramContext, 2131562352, 0);
    ...
    if ((paramEditText != null) && (paramEditText.jdField_a_of_type_Boolean))
    {
      ...
      {
        ((ChatActivity)paramContext).a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, 0, null, false);
        ((ChatActivity)paramContext).a().a(this);
        return;
      }
      this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.magicValue = "value=0";
    }
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.magicValue = "null";
      ((ChatActivity)paramContext).a().a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
    }
    label282:
    ChatActivityUtils.a(paramContext, 2131562210);
  }
  ...
  public URLDrawable b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        URLDrawable localURLDrawable = URLDrawable.getDrawable((URL)localObject1, jdField_a_of_type_AndroidGraphicsDrawableDrawable, jdField_b_of_type_AndroidGraphicsDrawableDrawable, true);
        localObject1 = localURLDrawable;
        if (localURLDrawable.getStatus() == 1) {
          continue;
        }
