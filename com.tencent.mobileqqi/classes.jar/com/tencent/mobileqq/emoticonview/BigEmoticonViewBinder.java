  ...
  implements View.OnClickListener
{
  ...
  private void a(View paramView)
  {
    ...
    GridView localGridView = (GridView)paramView.findViewById(2131233301);
  ...
  public void a(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null) {
        ((ProgressBar)localObject).post(new fnw(this, (ProgressBar)localObject, paramInt));
      }
    }
  }
  ...
  {
    View localView = c(0);
    localView.post(new fnx(this, localView));
  }
  ...
  public void c()
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((ImageView)localObject).getVisibility() == 0)) {
        ((ImageView)localObject).post(new fny(this, (ImageView)localObject));
      }
    }
  }
