  ...
  implements IFileHttpBase, IHttpCommunicatorListener
{
  ...
  private FileTransferObserver jdField_a_of_type_ComTencentMobileqqFilemanagerAppFileTransferObserver = new fuh(this);
  ...
  public void a(HttpMsg paramHttpMsg1, HttpMsg paramHttpMsg2)
  {
    ...
    //   581: aload_0
    //   582: lload 5
    //   584: invokespecial 684	fui:<init>	(Lcom/tencent/mobileqq/filemanager/core/FileManagerRSWorker;J)V
    //   587: ldc2_w 685
  ...
  public void b(HttpMsg paramHttpMsg1, HttpMsg paramHttpMsg2)
  {
    ...
    for (n = 0;; n = 6000)
    {
      new Handler().postDelayed(new fuj(this), n);
  ...
  public void f()
  {
    ...
    this.jdField_a_of_type_JavaLangThread = new Thread(new fuk(this));
  ...
  public void g()
  {
    ...
    this.jdField_a_of_type_ComWeiyunSdkIWyTaskManager$Task.addListener(new ful(this));
