...
public class UniformDownloadNfn
{
  ...
  private gbl jdField_a_of_type_Gbl = null;
  ...
  private UniformDownloadNfn()
  {
    ...
    this.jdField_a_of_type_Gbl = new gbl(this, BaseApplication.getContext());
  ...
  public int a(UniformDownloader paramUniformDownloader, Bundle paramBundle, long paramLong, int paramInt)
  {
    ...
    {
      paramUniformDownloader.a(new gbk(this, this.jdField_a_of_type_AndroidOsHandler.getLooper(), paramInt, paramBundle, paramLong), false);
      return paramInt;
  ...
  public Notification a(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      localNotification.icon = 2130838625;
      paramBundle = new RemoteViews(BaseApplication.getContext().getPackageName(), 2130903511);
      paramBundle.setImageViewResource(2131232116, 2130838621);
      paramBundle.setTextViewText(2131232118, (CharSequence)localObject);
      paramBundle.setProgressBar(2131232122, 100, 0, false);
      paramBundle.setViewVisibility(2131232120, 8);
      paramBundle.setViewVisibility(2131232121, 8);
      if (this.jdField_a_of_type_Gbl.b() != null) {
        paramBundle.setTextColor(2131232118, this.jdField_a_of_type_Gbl.b().intValue());
      }
      for (;;)
      {
        if (this.jdField_a_of_type_Gbl.a() != null)
        {
          paramBundle.setTextColor(2131232120, this.jdField_a_of_type_Gbl.a().intValue());
          paramBundle.setTextColor(2131232779, this.jdField_a_of_type_Gbl.a().intValue());
          label158:
          float f1 = this.jdField_a_of_type_Gbl.a();
          if (this.jdField_a_of_type_Gbl.a() <= 0.0F)
          {
          ...
          paramBundle.setFloat(2131232779, "setTextSize", f1);
          float f2 = this.jdField_a_of_type_Gbl.b();
          f1 = f2;
          if (f2 <= 0.0F)
          {
          ...
          paramBundle.setFloat(2131232118, "setTextSize", f1);
        ...
        try
        {
          int i1 = this.jdField_a_of_type_Gbl.b().intValue();
          paramBundle.setInt(2131232777, "setBackgroundColor", (i1 & 0xFF000000) + (-1 - i1));
          ...
          this.jdField_a_of_type_Gbl.a(BaseApplication.getContext(), true);
          if (this.jdField_a_of_type_Gbl.b() != null)
          {
            paramBundle.setTextColor(2131232118, this.jdField_a_of_type_Gbl.b().intValue());
          }
          else
          {
            ...
            paramBundle.setTextColor(2131232118, -7829368);
            continue;
            ...
            paramBundle.setTextColor(2131232779, -7829368);
          }
        }
  ...
  public void a()
  {
    ...
    //   28: dup
    //   29: aload_0
    //   30: invokespecial 341	gbj:<init>	(Lcom/tencent/mobileqq/filemanager/core/UniformDownloadNfn;)V
  ...
  public void a(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setImageViewResource(2131232116, 2130838621);
      int i1 = paramBundle2.getInt("_START_WAITING_");
      if (1 == i1)
      {
        paramNotification.contentView.setTextViewText(2131232779, BaseApplication.getContext().getString(2131558789));
        paramNotification.contentView.setViewVisibility(2131232121, 0);
        paramNotification.contentView.setViewVisibility(2131232120, 8);
        paramNotification.contentView.setProgressBar(2131232122, 100, 0, false);
      ...
      for (;;)
      {
        ...
        return;
        paramNotification.contentView.setTextViewText(2131232779, "0%");
        break;
        paramNotification.when = a(3);
        break label222;
        paramNotification.contentView.setOnClickPendingIntent(2131232777, paramBundle1);
      }
    }
  }
  ...
  public void a(int paramInt, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (localBitmap == null)
    {
      ...
      if (i1 != 0)
      {
        localNotification.contentView.setImageViewResource(2131232116, i1);
        label195:
        localNotification.contentView.setImageViewResource(2131232116, 2130838623);
      }
    }
    for (;;)
    {
      localNotification.contentView.setViewVisibility(2131232120, 0);
      localNotification.contentView.setViewVisibility(2131232121, 8);
      localNotification.contentView.setTextViewText(2131232120, paramBundle2);
      ...
      localNotification.contentView.setImageViewResource(2131232116, 2130838623);
      break label195;
      localNotification.contentView.setImageViewBitmap(2131232116, localBitmap);
    }
  }
  ...
  public void b(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setProgressBar(2131232122, 100, i1, false);
      paramNotification.contentView.setTextViewText(2131232779, "" + i1 + "%");
      paramNotification.flags = 34;
      paramBundle2 = new Intent("com.tencent.mobileqq.UniformDownloadNfn.PAUSE");
      paramBundle2.putExtra("_PARAM_EXTRA", paramBundle1);
      paramBundle1 = PendingIntent.getBroadcast(BaseApplication.getContext(), b(), paramBundle2, 134217728);
  ...
  public void c(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    paramNotification.tickerText = null;
    int i1 = paramBundle2.getInt("_FILE_PROGRESS_");
    paramNotification.contentView.setImageViewResource(2131232116, 2130838624);
    paramNotification.contentView.setViewVisibility(2131232120, 0);
    paramNotification.contentView.setViewVisibility(2131232121, 8);
    paramNotification.contentView.setTextViewText(2131232120, BaseApplication.getContext().getString(2131558790));
    paramNotification.contentView.setProgressBar(2131232122, 100, i1, false);
    paramNotification.contentView.setTextViewText(2131232779, "" + i1 + "%");
    ...
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidAppNotificationManager.notify(paramInt, paramNotification);
      return;
      paramNotification.contentView.setOnClickPendingIntent(2131232777, paramBundle2);
    }
  }
  ...
  public void d(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (2 == i1)
    {
      ...
      paramNotification.contentView.setTextViewText(2131232120, BaseApplication.getContext().getString(2131558794));
      label113:
      paramNotification.contentView.setImageViewResource(2131232116, 2130838622);
      paramNotification.contentView.setViewVisibility(2131232120, 0);
      paramNotification.contentView.setTextViewText(2131232779, " ");
      paramNotification.flags = 16;
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setTextViewText(2131232120, UniformDownloader.a(i1) + "，点击重试");
      break label113;
      label351:
      paramNotification.contentView.setOnClickPendingIntent(2131232777, paramBundle2);
    }
