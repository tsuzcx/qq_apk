  ...
  extends Observable
{
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new fue(this, Looper.getMainLooper());
  ...
  private void b(FileManagerEntity paramFileManagerEntity, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      FileManagerUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.nSessionId, (String)localObject, 1L, paramString, paramFileManagerEntity.peerUin, paramFileManagerEntity.Uuid, 0L, 0L, paramFileManagerEntity.fileSize, 0, null);
      return;
  ...
  public void a(FileManagerEntity paramFileManagerEntity, int paramInt, String paramString)
  {
    ...
    new Thread(new fuf(this, paramFileManagerEntity, paramInt)).run();
  }
