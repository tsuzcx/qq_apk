  ...
  extends URLImageView
{
  ...
  public void setAsyncImage(String paramString, boolean paramBoolean)
  {
    ...
    if (localFile.exists()) {
      ...
      {
        setAdjustViewBounds(false);
        setImageDrawable(URLDrawable.getDrawable(a(paramString, this.jdField_a_of_type_Int, this.b, localFile, paramBoolean, false), this.jdField_a_of_type_AndroidGraphicsDrawableDrawable, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable, true));
        return;
      }
      catch (Exception paramString)
      {
