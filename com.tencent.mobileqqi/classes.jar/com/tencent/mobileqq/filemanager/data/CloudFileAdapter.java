  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          localCloudFileItemHolder1.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramViewGroup.findViewById(2131232739));
          paramView = paramViewGroup;
          ...
          paramView = paramViewGroup;
          localCloudFileItemHolder1.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramViewGroup.findViewById(2131232740));
          paramView = paramViewGroup;
          localCloudFileItemHolder1.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramViewGroup.findViewById(2131232741));
          paramView = paramViewGroup;
          localCloudFileItemHolder1.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131232743));
          paramView = paramViewGroup;
          localCloudFileItemHolder1.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131232742));
          paramView = paramViewGroup;
          localCloudFileItemHolder1.b = ((TextView)paramViewGroup.findViewById(2131232744));
          paramView = paramViewGroup;
          localCloudFileItemHolder1.c = ((TextView)paramViewGroup.findViewById(2131232745));
          paramView = paramViewGroup;
          localCloudFileItemHolder1.d = ((TextView)paramViewGroup.findViewById(2131231882));
          paramView = paramViewGroup;
          ...
          paramView = paramViewGroup;
          localCloudFileItemHolder1.jdField_a_of_type_AndroidWidgetButton = ((Button)paramViewGroup.findViewById(2131231700));
          paramView = paramViewGroup;
