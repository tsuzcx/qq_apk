  ...
  extends BaseAdapter
{
  ...
  private View a(int paramInt, View paramView, fxr paramfxr)
  {
    BaseImageInfo localBaseImageInfo = (BaseImageInfo)getItem(paramInt);
    if (localBaseImageInfo == null)
    {
      paramfxr.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      b(paramfxr.jdField_a_of_type_AndroidWidgetProgressBar);
    }
    do
    {
      return paramView;
      this.jdField_b_of_type_Boolean = localBaseImageInfo.e;
      a(paramfxr.jdField_a_of_type_AndroidWidgetProgressBar);
    ...
    paramfxr.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable((Drawable)localObject);
    a(paramfxr.jdField_a_of_type_AndroidWidgetProgressBar, localBaseImageInfo.e);
    return paramView;
    ...
    for (;;)
    {
      ...
      if (localFile.exists()) {
        try
        {
          ...
          paramfxr.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(localURLDrawable);
        }
  ...
  private View b(int paramInt, View paramView, fxr paramfxr)
  {
    ...
    paramfxr.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    a(paramfxr.jdField_a_of_type_AndroidWidgetProgressBar, localFileViewerImageInfo.f);
    return paramView;
    ...
    for (;;)
    {
      try
      {
        ...
        paramfxr.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable((Drawable)localObject1);
        a(paramfxr.jdField_a_of_type_AndroidWidgetProgressBar, localFileViewerImageInfo.f);
        return paramView;
      }
      catch (Exception localException)
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      return localView;
      paramViewGroup = (fxr)paramView.getTag();
      break;
      localView = paramView;
