  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ((OfflineFileAdapter.CloudFileItemHolder)localObject).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131232739));
        ...
        ((OfflineFileAdapter.CloudFileItemHolder)localObject).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131232740));
        ((OfflineFileAdapter.CloudFileItemHolder)localObject).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131232741));
        ((OfflineFileAdapter.CloudFileItemHolder)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131232743));
        ((OfflineFileAdapter.CloudFileItemHolder)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131232742));
        ((OfflineFileAdapter.CloudFileItemHolder)localObject).b = ((TextView)paramView.findViewById(2131232744));
        ((OfflineFileAdapter.CloudFileItemHolder)localObject).c = ((TextView)paramView.findViewById(2131232745));
        ((OfflineFileAdapter.CloudFileItemHolder)localObject).d = ((TextView)paramView.findViewById(2131231882));
        ((OfflineFileAdapter.CloudFileItemHolder)localObject).jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131232133));
        ...
        ((OfflineFileAdapter.CloudFileItemHolder)localObject).jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131231700));
