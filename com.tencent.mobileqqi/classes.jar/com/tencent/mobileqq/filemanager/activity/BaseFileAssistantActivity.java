  ...
  implements View.OnClickListener
{
  ...
  FMObserver jdField_a_of_type_ComTencentMobileqqFilemanagerAppFMObserver = new fpl(this);
  ...
  private void g()
  {
    if (g())
    {
      ...
      this.m.setOnClickListener(new fpk(this));
      return;
    }
  ...
  private void h()
  {
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetSendBottomBar = ((SendBottomBar)findViewById(2131232754));
  ...
  private void i()
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)findViewById(2131232759);
    if (g())
    {
  ...
  public void d()
  {
    ...
    new Handler().postDelayed(new fpj(this), 1500L);
  }
