  ...
  implements View.OnClickListener
{
  ...
  private FMObserver jdField_b_of_type_ComTencentMobileqqFilemanagerAppFMObserver = new fuo(this);
  ...
  public FMActivity()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new fuv(this);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new fuz(this);
    this.jdField_a_of_type_AndroidViewView$OnLongClickListener = new fva(this);
    this.jdField_c_of_type_AndroidViewView$OnClickListener = new fvc(this);
    this.jdField_d_of_type_AndroidViewView$OnClickListener = new fum(this);
  }
  ...
  private void j()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setOnSlideListener(new fuu(this));
  }
  ...
  private void l()
  {
    try
    {
      if (getIntent().getBooleanExtra("from_aio", false))
      {
        ...
        {
          View localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903532, this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView, false);
          localView.setOnClickListener(this);
          this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.a(localView);
        }
        this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903486, this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView, false);
        this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
        this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.a(this.jdField_a_of_type_AndroidViewView);
        this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903497, this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView, false);
        this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
        this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.a(this.jdField_b_of_type_AndroidViewView);
        this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903501, this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView, false);
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    {
      i();
      this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.getViewTreeObserver().addOnGlobalLayoutListener(new ful(this));
      return true;
      c(false);
    }
  }
  ...
  public void h()
  {
    ...
    localActionSheet.a(new fuw(this, localActionSheet));
    localActionSheet.setOnDismissListener(new fux(this));
    localActionSheet.setOnCancelListener(new fuy(this));
