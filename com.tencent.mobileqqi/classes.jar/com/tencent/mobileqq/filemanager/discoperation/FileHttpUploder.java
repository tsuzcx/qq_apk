  ...
  implements INetEngine.INetEngineListener
{
  ...
  public FileHttpUploder(QQAppInterface paramQQAppInterface, FileReportData paramFileReportData, String paramString1, String paramString2, long paramLong, IFileHttpUploderSink paramIFileHttpUploderSink)
  {
  ...
  public void a(long paramLong)
  {
    ...
    localHttpNetReq.jdField_c_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    try
    {
  ...
  public void a(NetReq paramNetReq, int paramInt1, int paramInt2)
  {
    if (QLog.isDevelopLevel()) {
      QLog.d("FileHttpUploder<FileAssistant>", 1, "nID[" + this.jdField_d_of_type_JavaLangString + "]onUpdateProgeress[" + paramInt1 + "]/[" + paramInt2 + "]");
    }
  }
  ...
  public void a(NetResp paramNetResp)
  {
    ...
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.d("FileHttpUploder<FileAssistant>", 4, "logID[" + this.jdField_d_of_type_JavaLangString + "]onResp result:" + paramNetResp.jdField_d_of_type_Int + " errCode:" + paramNetResp.jdField_a_of_type_Long + " errDesc:" + paramNetResp.jdField_a_of_type_JavaLangString);
      }
      ...
      i = paramNetResp.e;
      if ((paramNetResp.jdField_a_of_type_Long == 9364L) && (this.jdField_b_of_type_Int < 3))
      {
      ...
      if ((i == 200) && (paramNetResp.jdField_d_of_type_Int == 0)) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDiscoperationFileReportData.jdField_a_of_type_Long = paramNetResp.jdField_d_of_type_Int;
      ...
      if ((paramNetResp.jdField_d_of_type_Int == 9056) && (this.f < 5))
      {
    ...
    QLog.e("FileHttpUploder<FileAssistant>", 1, "logID[" + this.jdField_d_of_type_JavaLangString + "]httpRetCode:" + i + "]onResp result:" + paramNetResp.jdField_d_of_type_Int + " errCode:" + paramNetResp.jdField_a_of_type_Long + " errDesc:" + paramNetResp.jdField_a_of_type_JavaLangString);
    return;
    this.f = 0;
  ...
  byte[] a(long paramLong)
  {
    ...
    //   6: aload_0
    //   7: lconst_0
    //   8: putfield 50	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_b_of_type_Long	J
    //   11: aload_0
    //   12: getfield 48	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   15: ifnonnull +23 -> 38
    //   18: aload_0
    //   19: new 321	java/io/FileInputStream
    //   22: dup
    //   23: aload_0
    //   24: getfield 40	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   27: invokespecial 322	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   30: putfield 48	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   33: aload_0
    //   34: lconst_0
    //   35: putfield 72	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_Long	J
    //   38: lload_1
    //   39: lconst_0
    //   40: lcmp
    //   41: ifne +113 -> 154
    //   44: aload_0
    //   45: getfield 72	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_Long	J
    //   48: lconst_0
    //   49: lcmp
    //   50: ifeq +23 -> 73
    //   53: aload_0
    //   54: new 321	java/io/FileInputStream
    //   57: dup
    //   58: aload_0
    //   59: getfield 40	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   62: invokespecial 322	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   65: putfield 48	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   68: aload_0
    //   69: lconst_0
    //   70: putfield 72	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_Long	J
    //   73: aload_0
    //   74: lload_1
    //   75: putfield 72	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_Long	J
    //   78: aload_0
    //   79: getfield 42	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_a_of_type_ComTencentWsttSSCMSSCM	Lcom/tencent/wstt/SSCM/SSCM;
    //   82: aload_0
    //   83: getfield 46	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_a_of_type_Long	J
    //   86: aload_0
    //   87: getfield 50	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_b_of_type_Long	J
    //   90: lload_1
    //   91: invokestatic 327	com/tencent/mobileqq/filemanager/discoperation/FileHttpUtils:a	(Lcom/tencent/wstt/SSCM/SSCM;JJJ)I
    //   94: istore_3
    //   95: iload_3
    //   96: newarray byte
    //   98: astore 4
    //   100: aload_0
    //   101: getfield 48	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   104: aload 4
    //   106: iconst_0
    //   107: iload_3
    //   108: invokevirtual 333	java/io/InputStream:read	([BII)I
    //   111: pop
    //   112: aload_0
    //   113: aload_0
    //   114: getfield 72	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_Long	J
    //   117: iload_3
    //   118: i2l
    //   119: ladd
    //   120: putfield 72	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_Long	J
    //   123: aload 4
    //   125: areturn
    //   126: astore 4
    //   128: aload_0
    //   129: aconst_null
    //   130: putfield 48	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   133: aload 4
    //   135: invokevirtual 336	java/io/FileNotFoundException:printStackTrace	()V
    //   138: aconst_null
    //   139: areturn
    //   140: astore 4
    //   142: aload_0
    //   143: aconst_null
    //   144: putfield 48	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   147: aload 4
    //   149: invokevirtual 336	java/io/FileNotFoundException:printStackTrace	()V
    //   152: aconst_null
    //   153: areturn
    //   154: lload_1
    //   155: aload_0
    //   156: getfield 72	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_Long	J
    //   159: lcmp
    //   160: ifle +29 -> 189
    //   163: aload_0
    //   164: getfield 48	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   167: lload_1
    //   168: aload_0
    //   169: getfield 72	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_Long	J
    //   172: lsub
    //   173: invokevirtual 340	java/io/InputStream:skip	(J)J
    //   176: pop2
    //   177: goto -104 -> 73
    //   180: astore 4
    //   182: aload 4
    //   184: invokevirtual 341	java/io/IOException:printStackTrace	()V
    //   187: aconst_null
    //   188: areturn
    //   189: lload_1
    //   190: aload_0
    //   191: getfield 72	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_Long	J
    //   194: lcmp
    //   195: ifge -122 -> 73
    //   198: aload_0
    //   199: new 321	java/io/FileInputStream
    //   202: dup
    //   203: aload_0
    //   204: getfield 40	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   207: invokespecial 322	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   210: putfield 48	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   213: aload_0
    //   214: lconst_0
    //   215: putfield 72	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_c_of_type_Long	J
    //   218: aload_0
    //   219: getfield 48	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   222: lload_1
    //   223: invokevirtual 340	java/io/InputStream:skip	(J)J
    //   226: pop2
    //   227: goto -154 -> 73
    //   230: astore 4
    //   232: aload_0
    //   233: aconst_null
    //   234: putfield 48	com/tencent/mobileqq/filemanager/discoperation/FileHttpUploder:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   237: aload 4
    //   239: invokevirtual 341	java/io/IOException:printStackTrace	()V
    //   242: aconst_null
    //   243: areturn
    //   244: astore 4
    //   246: aconst_null
