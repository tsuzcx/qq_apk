  ...
  implements UniformDownloader.IUniformDownloader
{
  ...
  private int i()
  {
    int i = UniformDownloaderAppBabySdk.a().a(this.jdField_c_of_type_Long, this.jdField_c_of_type_JavaLangString, this.b, new fyn(this));
    if (i == 0) {
      a(true);
    }
    return i;
  ...
  public int a()
  {
    ...
    QQAppInterface localQQAppInterface = UniformDownloadMgr.a().a();
    if (localQQAppInterface != null) {
      StatisticAssist.a(localQQAppInterface.getApplication().getApplicationContext(), localQQAppInterface.a(), "Start_download_2-3_3-0");
    }
    if (!a())
    {
