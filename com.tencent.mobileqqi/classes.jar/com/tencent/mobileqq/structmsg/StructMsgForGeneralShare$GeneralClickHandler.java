  ...
  extends StructMsgClickHandler
{
  ...
  public boolean a(String paramString)
  {
    ...
    Object localObject2 = ((QQAppInterface)localObject1).e();
    if ((55901189L == l) || (274201605L == l) || (440495416L == l))
    {
      ...
      QZoneHelper.b((Activity)localContext, (QZoneHelper.UserInfo)localObject1, paramString, "mqqChat", -1);
    }
    for (;;)
    {
      return true;
      ...
      else
      {
        ...
        for (paramString = "&sid=" + (String)localObject3;; paramString = "")
        {
          ...
          paramString.append("&uin=").append(localStructMsgForGeneralShare.currentAccountUin).append("&originuin=").append(localStructMsgForGeneralShare.uin);
          ...
          ((Intent)localObject2).putExtra("url", paramString.toString().trim());
  ...
  public boolean b(String paramString1, String paramString2, String paramString3)
  {
    ...
    int i = paramString3.a();
    paramString2 = paramString3.d();
    paramString3 = paramString3.c();
