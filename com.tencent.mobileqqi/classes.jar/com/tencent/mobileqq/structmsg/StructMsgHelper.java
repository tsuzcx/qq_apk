...
public class StructMsgHelper
{
  public static AbsStructMsg a(ArrayList paramArrayList)
  {
    ...
    localStructMsgForGeneralShare.mMsgBrief = BaseApplicationImpl.getContext().getString(2131559293);
    ...
    if (i == 1)
    {
      ...
      localAbsStructMsgItem1.a(new StructMsgItemSummary(BaseApplicationImpl.getContext().getString(2131559294)));
    ...
    for (;;)
    {
      ...
      localAbsStructMsgItem2.a(new StructMsgItemSummary(BaseApplicationImpl.getContext().getString(2131559294)));
      localStructMsgForGeneralShare.addItem(localAbsStructMsgItem1);
      localStructMsgForGeneralShare.addItem(paramArrayList);
