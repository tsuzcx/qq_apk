  ...
  implements View.OnClickListener
{
  ...
  public View a(Context paramContext, View paramView)
  {
    ...
    for (;;)
    {
      ...
      AbsStructMsgTextElement.RichText localRichText = a(paramContext.getResources());
      if (localRichText != null)
      {
        paramContext = LocaleString.s(paramContext, LocaleString.n(paramContext, localRichText.jdField_a_of_type_JavaLangString));
        paramView.setTextColor(localRichText.jdField_a_of_type_Int);
        paramView.requestLayout();
        paramView.setTypeface(Typeface.DEFAULT, localRichText.b);
        paramView.setTextSize(localRichText.c);
