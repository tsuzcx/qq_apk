  ...
  extends AbsStructMsgItem
{
  ...
  private RelativeLayout a(Context paramContext)
  {
    ...
    int m = localResources.getDimensionPixelSize(2131427489);
    int i;
    if (a(1))
    {
      i = localResources.getDimensionPixelSize(2131427490);
      if (!a(2)) {
        break label116;
      }
    }
    label116:
    for (int j = localResources.getDimensionPixelSize(2131427491);; j = localResources.getDimensionPixelSize(2131427491))
    {
  ...
  public View b(Context paramContext, View paramView)
  {
    ...
    if ((paramView != null) && ((paramView instanceof RelativeLayout)))
    {
      ...
      paramView.setId(2131230796);
      paramView.setTag(localObject2);
      paramView.setMaxLines(2);
      paramView.setEllipsize(TextUtils.TruncateAt.END);
      paramView.setTextColor(-1);
      paramView.setTextSize(2, 16.0F);
      paramView.setBackgroundColor(paramContext.getResources().getColor(2131361865));
    ...
    for (;;)
    {
      ...
      if ("picture".equals(localObject3))
      {
        ...
        localObject3 = ((View)localObject2).findViewById(2131230795);
