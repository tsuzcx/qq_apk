  ...
  extends AbsStructMsgElement
{
  ...
  {
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new gpj(this);
  ...
  public View a(Context paramContext, View paramView)
  {
    ...
    try
    {
      Drawable localDrawable = ((Resources)localObject1).getDrawable(2130840239);
    ...
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      for (;;)
      {
        ...
        paramView.setId(2131230795);
        paramView.setContentDescription(((Resources)localObject1).getString(2131558460));
