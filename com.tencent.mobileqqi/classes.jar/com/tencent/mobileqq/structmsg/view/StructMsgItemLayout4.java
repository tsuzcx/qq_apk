  ...
  extends AbsStructMsgItem
{
  ...
  private LinearLayout a(Context paramContext)
  {
    ...
    label121:
    for (int j = localResources.getDimensionPixelSize(2131427488);; j = AIOUtils.a(6.0F, localResources))
    {
  ...
  public View b(Context paramContext, View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ("title".equals(paramView))
      {
        ...
        TextView localTextView = (TextView)paramView.findViewById(2131230796);
