  ...
  implements StructMsgOnClickListener
{
  ...
  public StructMsgClickHandler(QQAppInterface paramQQAppInterface, View paramView)
  {
    ...
    if ((paramQQAppInterface == null) && (ChatActivity.class.isInstance(this.jdField_a_of_type_AndroidContentContext))) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = ((ChatActivity)this.jdField_a_of_type_AndroidContentContext).a();
    }
  }
  ...
  private static void a(Context paramContext, String paramString)
  {
    if ((jdField_a_of_type_ComTencentWidgetActionSheet == null) || (!jdField_a_of_type_ComTencentWidgetActionSheet.getContext().equals(paramContext)))
    {
      ...
      jdField_a_of_type_ComTencentWidgetActionSheet.a(2131561727, 1);
      ...
      jdField_a_of_type_ComTencentWidgetActionSheet.a(new gpa(paramString, paramContext));
    }
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      int i = ((ChatActivity)localObject).a();
      paramString2 = ((ChatActivity)localObject).d();
  ...
  public boolean b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      paramString2 = ((ChatActivity)this.jdField_a_of_type_AndroidContentContext).c();
  ...
  public boolean c(String paramString1, String paramString2)
  {
    ...
    try
    {
      for (;;)
      {
        JumpParser.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString1).b();
        return true;
        paramString1 = paramString2;
      }
    }
