  ...
  implements SystemMsgUiActionInterface
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new gls(this, Looper.getMainLooper());
  ...
  {
    ((NewFriendManager)paramQQAppInterface.getManager(32)).a(new NewFriendMessage(1, 0));
    Object localObject = (NewFriendManager)paramQQAppInterface.getManager(32);
    if (localObject != null) {}
    for (int i = ((NewFriendManager)localObject).a(1);; i = 0)
    {
      localObject = paramQQAppInterface.a();
      if (localObject != null)
      {
        int j = ((QQMessageFacade)localObject).f();
        BadgeUtils.d(paramQQAppInterface.a(), i + j);
      }
      return;
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    paramQQAppInterface.a(new glr(this, paramQQAppInterface, paramInt));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString, long paramLong)
  {
    if (this.jdField_a_of_type_Int > 0)
    {
      ...
      ((NewFriendManager)paramQQAppInterface.getManager(32)).a(paramString);
      paramString = (NewFriendManager)paramQQAppInterface.getManager(32);
      if (paramString == null) {
        break label130;
      }
    }
    label130:
    for (int i = paramString.a(1);; i = 0)
    {
      ...
      return;
      ((NewFriendManager)paramQQAppInterface.getManager(32)).a(new NewFriendMessage(1, 0, paramBoolean));
      break;
    }
  }
  ...
  public void a(boolean paramBoolean, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.a(new glt(this, paramQQAppInterface, paramBoolean));
  }
