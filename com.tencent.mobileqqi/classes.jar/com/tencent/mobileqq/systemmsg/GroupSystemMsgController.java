  ...
  implements SystemMsgUiActionInterface
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new gqe(this, Looper.getMainLooper());
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if (this.jdField_a_of_type_Int > 0) {
      ((NewFriendManager)paramQQAppInterface.getManager(32)).a();
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    paramQQAppInterface.a(new gqc(this, paramQQAppInterface, paramInt));
  }
  ...
  {
    paramQQAppInterface.a(new gqd(this, paramQQAppInterface, paramString));
  }
  ...
  public void a(boolean paramBoolean, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.a(new gqf(this, paramQQAppInterface, paramBoolean));
  }
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    if (this.jdField_a_of_type_Int > 0)
    {
      Object localObject = paramQQAppInterface.a().a(AppConstants.ad, 0);
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        ...
        ((NewFriendManager)paramQQAppInterface.getManager(32)).a((NewFriendMessage)localObject);
      }
      return;
    }
    ((NewFriendManager)paramQQAppInterface.getManager(32)).a(new TroopSystemMessage(0));
  }
