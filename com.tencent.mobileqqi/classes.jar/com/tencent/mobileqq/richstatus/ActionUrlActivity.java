  ...
  extends IphoneTitleBarActivity
{
  ...
  private void e()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131234644));
    ...
    this.jdField_a_of_type_ComTencentWidgetProtectedWebView.setWebViewClient(new ggl(this, null));
    this.jdField_a_of_type_ComTencentWidgetProtectedWebView.setWebChromeClient(new ggk(this, null));
    ...
    this.jdField_a_of_type_AndroidViewView = ((LinearLayout)findViewById(2131234645));
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131234646));
    this.jdField_b_of_type_JavaLangString = this.k.getText().toString();
    this.jdField_b_of_type_AndroidViewView = findViewById(2131231186);
