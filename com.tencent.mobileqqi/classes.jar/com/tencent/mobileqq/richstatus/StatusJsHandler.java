  ...
  extends JsBridge.JsHandler
{
  ...
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new ghy(this);
  public boolean a;
  public String b;
  WeakReference jdField_b_of_type_JavaLangRefWeakReference;
  private BusinessObserver jdField_b_of_type_MqqObserverBusinessObserver = new ghz(this);
  public boolean b;
  public String c;
  ...
  private void a(BaseActivity paramBaseActivity, String paramString)
  {
    ...
    try
    {
      ...
      paramBaseActivity.b.startServlet(localNewIntent);
      if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt)
  {
    ...
    QQToast.a(localBaseActivity, paramInt, 0).b(localBaseActivity.d());
  }
  
  public void a(BaseActivity paramBaseActivity, AccountDetail paramAccountDetail)
  {
    paramBaseActivity = paramBaseActivity.b.a().createEntityManager();
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new ghx(this, paramString1, paramString2, localWebView));
  }
  ...
  public void followAccount(String paramString1, String paramString2)
  {
    ...
    this.c = paramString2;
    paramString2 = localBaseActivity.b.a().createEntityManager();
  ...
  public void getLocation(String paramString)
  {
    ...
    new Thread(new ghw(this, (LocationManager)localBaseActivity.getSystemService("location"))).start();
  }
  ...
  public boolean hasFollowAccount(String paramString)
  {
    ...
    localObject = (PublicAccountDataManager)((BaseActivity)localObject).b.getManager(51);
