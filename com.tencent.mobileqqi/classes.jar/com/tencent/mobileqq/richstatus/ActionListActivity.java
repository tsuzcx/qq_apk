  ...
  implements ViewPager.OnPageChangeListener, View.OnClickListener, TabHost.OnTabChangeListener, IActionListener, IIconListener
{
  ...
  private void d()
  {
    ...
    if (i != 100)
    {
      ...
      if ((this.jdField_b_of_type_Int == -1) && ((i == 102) || (NetworkUtil.e(this)))) {
        d();
      }
    }
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      ...
      while (i < j)
      {
        ...
        TextView localTextView = (TextView)localLayoutInflater.inflate(2130903580, this.jdField_a_of_type_AndroidWidgetTabWidget, false);
        localTextView.setText(localStateTag.a);
        localTextView.setWidth(k);
        localTextView.setGravity(17);
        this.jdField_a_of_type_AndroidWidgetTabHost.addTab(this.jdField_a_of_type_AndroidWidgetTabHost.newTabSpec(localStateTag.a).setIndicator(localTextView).setContent(2131231056));
        i += 1;
      }
    }
    ((gks)this.jdField_a_of_type_AndroidSupportV4ViewViewPager.getAdapter()).a();
    int j = this.jdField_a_of_type_AndroidSupportV4ViewViewPager.getChildCount();
    i = 0;
    while (i < j)
    {
      ((gkr)((GridView)this.jdField_a_of_type_AndroidSupportV4ViewViewPager.getChildAt(i)).getAdapter()).notifyDataSetChanged();
      i += 1;
    }
  }
  ...
  void a(int paramInt, Bitmap paramBitmap)
  {
    ...
    while (i < k)
    {
      ...
      while (j < m)
      {
        gkq localgkq = (gkq)localGridView.getChildAt(j).getTag();
        if ((localgkq != null) && (localgkq.jdField_a_of_type_Int == paramInt)) {
          localgkq.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(new StatableBitmapDrawable(getResources(), paramBitmap, false, false));
        }
        j += 1;
      }
      i += 1;
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    e(2130903075);
    this.jdField_a_of_type_AndroidWidgetTabHost = ((TabHost)findViewById(2131231055));
    ...
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setAdapter(new gks(this, null));
    ...
    for (;;)
    {
      ...
      this.m.setContentDescription(getResources().getString(2131561842) + "按钮");
      d();
      ...
      return true;
      setTitle(this.jdField_a_of_type_ComTencentMobileqqRichstatusStatusManager.a(this.jdField_b_of_type_Int).c);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      } while ((paramView == null) || (!(paramView instanceof gkq)));
      paramView = (gkq)paramView;
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          ...
          continue;
          String str = localActionInfo.e.replace("$A", this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a());
