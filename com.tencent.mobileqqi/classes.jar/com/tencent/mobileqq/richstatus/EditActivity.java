  ...
  implements View.OnClickListener, AdapterView.OnItemClickListener
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new glb(this);
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new glj(this);
  private View jdField_a_of_type_AndroidViewView;
  private GridView jdField_a_of_type_AndroidWidgetGridView;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private IActionListener jdField_a_of_type_ComTencentMobileqqRichstatusIActionListener = new gla(this);
  private IIconListener jdField_a_of_type_ComTencentMobileqqRichstatusIIconListener = new glh(this);
  private IStatusListener jdField_a_of_type_ComTencentMobileqqRichstatusIStatusListener = new gli(this);
  private RichStatus jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus;
  private RichStatusEditText.RichStatusEditListener jdField_a_of_type_ComTencentMobileqqRichstatusRichStatusEditText$RichStatusEditListener = new glk(this);
  private RichStatusEditText jdField_a_of_type_ComTencentMobileqqRichstatusRichStatusEditText;
  private StatusManager jdField_a_of_type_ComTencentMobileqqRichstatusStatusManager;
  private StatusObserver jdField_a_of_type_ComTencentMobileqqRichstatusStatusObserver = new glc(this);
  private ClickableImageSpan.ClickableImageSpanListener jdField_a_of_type_ComTencentMobileqqWidgetClickableImageSpan$ClickableImageSpanListener = new gll(this);
  ...
  private glp jdField_a_of_type_Glp;
  ...
  {
    View localView = ((LayoutInflater)getSystemService("layout_inflater")).inflate(2130903259, null);
    ImageView localImageView = (ImageView)localView.findViewById(2131231860);
    TextView localTextView = (TextView)localView.findViewById(2131231861);
    ...
    if (paramBoolean) {
      localView.setBackgroundResource(2130839650);
    }
    for (;;)
    {
      return a(localView);
      localView.setBackgroundResource(2130839649);
    }
  }
  ...
  private void c(boolean paramBoolean)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.jdField_e_of_type_JavaLangString))
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840359);
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(getResources().getColorStateList(2131362098));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130838102);
    this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(getResources().getColorStateList(2131362075));
  ...
  private void i()
  {
    ...
    b(2131562656, this);
    d(true);
    ((MaxHeightRelativelayout)findViewById(2131234518)).setMaxHeight((int)(getResources().getDisplayMetrics().heightPixels * 0.31D));
    this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatusEditText = ((RichStatusEditText)findViewById(2131233371));
    ...
    this.jdField_a_of_type_AndroidViewView = findViewById(2131234520);
    ...
    this.jdField_b_of_type_AndroidViewView = findViewById(2131234519);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130839658);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131231860));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131231861));
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131234521));
      this.jdField_a_of_type_AndroidWidgetGridView = ((GridView)findViewById(2131234523));
      this.jdField_a_of_type_AndroidWidgetGridView.setOnItemClickListener(this);
      this.jdField_a_of_type_Glp = new glp(this, null);
      this.jdField_a_of_type_AndroidWidgetGridView.setAdapter(this.jdField_a_of_type_Glp);
  ...
  {
    this.d = false;
    this.jdField_a_of_type_Glp.notifyDataSetChanged();
    this.jdField_a_of_type_AndroidWidgetGridView.postDelayed(new gld(this), 200L);
  }
  ...
  void f()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetActionSheet.a(new glm(this));
    this.jdField_a_of_type_ComTencentWidgetActionSheet.setOnDismissListener(new gln(this));
  }
