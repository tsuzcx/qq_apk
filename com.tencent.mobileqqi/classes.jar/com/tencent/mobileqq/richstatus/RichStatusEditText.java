  ...
  extends EditText
{
  ...
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new glt(this);
  ...
  protected void onSelectionChanged(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 != paramInt2) && (((ClickableImageSpan[])a().getSpans(Math.min(paramInt1, paramInt2), Math.max(paramInt1, paramInt2), ClickableImageSpan.class)).length != 0))
    {
      ...
      this.jdField_a_of_type_Int = ((glu)localObject).jdField_a_of_type_Int;
      this.b = ((glu)localObject).b;
      i = 1;
    }
    for (;;)
    {
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    ClickableImageSpan localClickableImageSpan = a(i, false, false);
    boolean bool2;
    if (k == 0)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetClickableImageSpan != null) {
      ...
      if ((localClickableImageSpan == null) && (this.jdField_a_of_type_ComTencentMobileqqWidgetClickableImageSpan != null)) {
        paramMotionEvent.setAction(3);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetClickableImageSpan == null) {
        break label228;
      }
      bool2 = this.jdField_a_of_type_ComTencentMobileqqWidgetClickableImageSpan.a(this, paramMotionEvent);
      if (k != 1)
      {
        bool1 = bool2;
        if (k != 3) {}
