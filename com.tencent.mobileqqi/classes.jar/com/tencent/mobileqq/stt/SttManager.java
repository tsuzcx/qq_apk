  ...
  implements Handler.Callback, Manager, BusinessObserver
{
  ...
  private static final String b = "rich_status";
  public static final int c = 2;
  private static final String c = "k_ability_";
  ...
  public static int a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      SharedPreferences localSharedPreferences1 = paramQQAppInterface.getApplication().getSharedPreferences("rich_status", 0);
      localSharedPreferences2 = paramQQAppInterface.getPreferences();
      l = localSharedPreferences1.getLong("k_stt_guide_version", 0L);
      i = j;
      if (localSharedPreferences2.getLong("k_stt_guide_show", -1L) < l)
      {
        if (l <= 0L) {
          break label122;
        }
        i = j;
        if (new File(paramQQAppInterface.a().getFilesDir(), "VoiceToTextMask").exists())
        {
          if (paramBoolean) {
            localSharedPreferences2.edit().putLong("k_stt_guide_show", l).commit();
          }
          i = 2;
        }
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = new gpp(((DisplayMetrics)localObject).widthPixels, ((DisplayMetrics)localObject).heightPixels);
      }
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(((gpp)localObject).a)) {
          bool = HttpDownloadUtil.a(paramQQAppInterface, new URL(paramString), localFile);
        }
        if (!bool) {
          continue;
      ...
      return;
      if (QLog.isColorLevel()) {
        QLog.d("Q.stt", 2, "updateGuide download image failed: " + ((gpp)localObject).a);
      }
    }
  }
  ...
  {
    if (h < 0) {
      h = paramQQAppInterface.getApplication().getSharedPreferences("rich_status", 0).getInt("k_ability_" + paramQQAppInterface.getAccount(), 0);
    }
    return h == 1;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    if (a(paramQQAppInterface) != paramBoolean)
    {
      ...
      {
        h = i;
        paramQQAppInterface.getApplication().getSharedPreferences("rich_status", 0).edit().putInt("k_ability_" + paramQQAppInterface.getAccount(), h).commit();
        return true;
      }
    }
    return false;
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayOfByte != null)
      {
        ...
        localObject = (gpo)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localLong);
        paramArrayOfByte = (byte[])localObject;
        if (localObject == null)
        {
          paramArrayOfByte = new gpo(null);
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    Long localLong1 = Long.valueOf(paramBundle.getLong("k_session", 0L));
