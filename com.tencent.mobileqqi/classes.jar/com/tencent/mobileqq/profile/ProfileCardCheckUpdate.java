  ...
  implements CheckUpdateItemInterface
{
  ...
  public ReqItem a()
  {
    ...
    ((SummaryCardUpdate.SUpdateReq)localObject2).client_version.set("6.0.3");
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ProfileCard.ProfileCardCheckUpdate", 2, "getCheckUpdateItemData uin=" + this.a.getLongAccountUin() + ",version=" + (String)localObject1 + ",client_version=" + "6.0.3" + ",dataLen=" + j);
    }
    return localReqItem;
  }
  ...
  {
    ThreadManager.a(new ges(this, paramString1, paramString2));
  }
