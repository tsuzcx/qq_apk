  ...
  extends ProfileHeaderView
{
  ...
  public void b()
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidViewView.findViewById(2131233386).getLayoutParams();
        ...
        localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131233380);
  ...
  public void b(ProfileCardInfo paramProfileCardInfo)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQZoneCoverView = ((QZoneCoverView)this.jdField_a_of_type_AndroidViewView.findViewById(2131233379));
    ...
    if (paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0)
    {
      ...
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131233385));
    ...
    for (localObject = localContext.getString(2131558436);; localObject = localContext.getString(2131558435))
    {
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131231783));
      this.jdField_a_of_type_ComTencentImageURLImageView.setVisibility(8);
