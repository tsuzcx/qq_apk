  ...
  extends ProfileHeaderView
{
  ...
  public void b()
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidViewView.findViewById(2131233384).getLayoutParams();
        ...
        i = getResources().getDimensionPixelSize(2131427445);
        ...
        localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131233378);
      } while (localObject == null);
      ((View)localObject).setBackgroundResource(0);
      return;
      int i = getResources().getDimensionPixelSize(2131427444);
      if ((localObject != null) && (((RelativeLayout.LayoutParams)localObject).topMargin != i)) {
        ((RelativeLayout.LayoutParams)localObject).setMargins(((RelativeLayout.LayoutParams)localObject).leftMargin, i, ((RelativeLayout.LayoutParams)localObject).rightMargin, ((RelativeLayout.LayoutParams)localObject).bottomMargin);
      }
      localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131233378);
    } while (localObject == null);
    ((View)localObject).setBackgroundResource(2130839011);
  }
  
  public void b(ProfileCardInfo paramProfileCardInfo)
  {
    Context localContext = getContext();
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(localContext).inflate(2130903678, this, true);
    this.jdField_a_of_type_ComTencentMobileqqWidgetQZoneCoverView = ((QZoneCoverView)this.jdField_a_of_type_AndroidViewView.findViewById(2131233377));
    ...
    if (paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0)
    {
      ...
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131233383));
    ...
    for (localObject = localContext.getString(2131558436);; localObject = localContext.getString(2131558435))
    {
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131231781));
      this.jdField_a_of_type_ComTencentImageURLImageView.setVisibility(8);
