  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131233396));
      paramViewGroup.b = ((ImageView)paramView.findViewById(2131233393));
      paramViewGroup.c = ((ImageView)paramView.findViewById(2131233394));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfileViewCircularProgressBar = ((CircularProgressBar)paramView.findViewById(2131233397));
      paramViewGroup.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131233398));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131233395));
    ...
    for (;;)
    {
      ...
      localObject2 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839200);
      ...
      return paramView;
      paramViewGroup = (gjb)paramView.getTag();
      break;
      this.jdField_a_of_type_ComTencentMobileqqProfileProfileCardBrowserActivity.a(paramViewGroup, 4);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839206);
      break label204;
      ...
      break label204;
      this.jdField_a_of_type_ComTencentMobileqqProfileProfileCardBrowserActivity.a(paramViewGroup, 4);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839209);
      break label204;
      this.jdField_a_of_type_ComTencentMobileqqProfileProfileCardBrowserActivity.a(paramViewGroup, 4);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839210);
      break label204;
      paramViewGroup.c.setImageResource(2130839195);
      continue;
      paramViewGroup.c.setImageResource(2130839195);
      continue;
