    ...
    if (DalvikInternals.a) {
      ...
      catch (Exception paramContext)
      {
        ...
        do
        {
          ...
          {
            i = 6L;
            Log.e(a, "Failed to find LinearAlloc buffer (at size " + paramInt + "). Continuing with standard buffer.", paramContext);
            l = 0L;
          }
          try
          {
          ...
          {
            i = 7L;
            Log.e(a, "Failed to replace LinearAlloc buffer (at size " + paramInt + "). Continuing with standard buffer.", paramContext);
            return;
          }
          if (l == 0L)
          {
