...
public class TroopInfoData
{
  ...
  public TroopInfoData()
  {
    ...
    this.jdField_v_of_type_Int |= 0x4;
    this.jdField_v_of_type_Int |= 0x2;
  }
  ...
  public int a()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_Int = 3022;
      continue;
      this.jdField_b_of_type_Int = 3006;
      continue;
      this.jdField_b_of_type_Int = 3001;
      continue;
      this.jdField_b_of_type_Int = 3002;
      continue;
      this.jdField_b_of_type_Int = 3005;
      continue;
      this.jdField_b_of_type_Int = 3023;
    }
  }
  ...
  public void a(TroopInfo paramTroopInfo, Resources paramResources, String paramString)
  {
    ...
    if (paramTroopInfo != null)
    {
      ...
      this.jdField_h_of_type_JavaLangString = String.format(paramResources.getString(2131561513), new Object[] { Integer.valueOf(paramTroopInfo.wMemberNum) });
      this.u = String.format(paramResources.getString(2131561513), new Object[] { Integer.valueOf(paramTroopInfo.wMemberMax) });
      this.r = paramTroopInfo.joinTroopQuestion;
      ...
      default: 
        ...
        if (!Utils.a(this.jdField_o_of_type_JavaLangString, paramTroopInfo.Administrator))
        {
          this.jdField_o_of_type_JavaLangString = paramTroopInfo.Administrator;
          b(paramString);
        }
    ...
    for (this.jdField_v_of_type_Int &= 0xFFFFFFFB;; this.jdField_v_of_type_Int |= 0x4)
    {
      ...
      this.jdField_m_of_type_Int = paramTroopInfo.nTroopGrade;
      ...
      this.jdField_p_of_type_Int = paramTroopInfo.isShowInNearbyTroops;
      if (QLog.isColorLevel()) {
        QLog.i("TroopInfoData", 2, "updateTroopInfoData: time = " + (System.currentTimeMillis() - l1));
      }
      return;
      this.n = paramResources.getString(2131561648);
      break;
      this.n = paramResources.getString(2131562788);
      break;
      this.n = paramResources.getString(2131561965);
      break;
    }
  }
  ...
  public void a(TroopInfo paramTroopInfo, String paramString)
  {
    ...
    if (paramTroopInfo != null)
    {
      ...
      this.jdField_p_of_type_Int = paramTroopInfo.isShowInNearbyTroops;
      this.jdField_q_of_type_Int = paramTroopInfo.troopTypeExt;
    }
    if (QLog.isColorLevel()) {
      QLog.i("TroopInfoData", 2, "updateTroopInfoData: time = " + (System.currentTimeMillis() - l1));
    }
  ...
  {
    this.jdField_o_of_type_JavaLangString = paramString1;
    b(paramString2);
    this.jdField_c_of_type_Int = paramInt;
    this.jdField_h_of_type_JavaLangString = String.format(paramResources.getString(2131561513), new Object[] { Integer.valueOf(paramInt) });
  }
  ...
  {
    if (paramBoolean) {}
    for (this.jdField_v_of_type_Int |= 0x1;; this.jdField_v_of_type_Int &= 0xFFFFFFFE)
    {
      this.jdField_v_of_type_Int &= 0xFFFFFFFE;
      return;
    }
  }
  ...
  public boolean a()
  {
    return (this.jdField_v_of_type_Int & 0x1) == 1;
  }
  ...
  public void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        String[] arrayOfString = this.jdField_o_of_type_JavaLangString.split("\\|");
  ...
  public void b(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_v_of_type_Int |= 0x8;
      return;
    }
    this.jdField_v_of_type_Int &= 0xFFFFFFF7;
  }
  
  public boolean b()
  {
    return (this.jdField_v_of_type_Int & 0x8) == 8;
  }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    this.jdField_v_of_type_Int &= 0xFFFFFFFD;
  }
  
  public boolean c()
  {
    return (this.jdField_v_of_type_Int & 0x2) == 2;
  }
  
  public boolean d()
  {
    return (this.jdField_v_of_type_Int & 0x4) == 4;
  }
  ...
  public boolean h()
  {
    return ((this.jdField_o_of_type_Int & 0x80000) != 0) || ((this.jdField_o_of_type_Int & 0x4000) != 0);
  }
  ...
  public boolean k()
  {
    ...
    while (this.jdField_p_of_type_Int == 0)
    {
      return true;
      return false;
    }
