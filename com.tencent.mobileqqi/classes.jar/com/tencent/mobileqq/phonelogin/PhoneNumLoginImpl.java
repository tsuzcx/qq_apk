...
public class PhoneNumLoginImpl
{
  ...
  private static final String jdField_a_of_type_JavaLangString = "pwd_sharedpref";
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localQQCustomDialog.setTitle(2131562748);
    localQQCustomDialog.setMessage(2131563275);
    paramQQAppInterface = new gdr(this, str, paramActivity, paramQQAppInterface);
    paramActivity = new gds(this);
    localQQCustomDialog.setPositiveButton(2131562888, paramQQAppInterface);
    localQQCustomDialog.setNegativeButton(2131561746, paramActivity);
