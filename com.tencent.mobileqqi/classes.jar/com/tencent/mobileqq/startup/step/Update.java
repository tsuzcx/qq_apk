  ...
  implements Handler.Callback
{
  ...
  protected boolean a()
  {
    ...
    {
      Thread.sleep(500L);
      boolean bool = Step.a(0, this.jdField_a_of_type_ComTencentMobileqqStartupDirectorStartupDirector, jdField_a_of_type_ArrayOfInt).b();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      if (this.jdField_a_of_type_AndroidWidgetTextView != null) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(this.jdField_a_of_type_ComTencentMobileqqStartupDirectorStartupDirector.a.getString(2131563138), new Object[] { Integer.valueOf(i) }));
      }
      if (i < 99)
      {
