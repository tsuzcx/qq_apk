...
public class AboutConfig
{
  ...
  private ServerConfigObserver jdField_a_of_type_MqqObserverServerConfigObserver = new fqx(this);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramResourcePluginInfo.isNew == 0)
          {
            ...
            ThreadManager.b(new fqy(localAboutConfig, paramResourcePluginInfo));
          }
          return;
          localObject1 = "";
          break;
