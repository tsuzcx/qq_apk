  ...
  implements CommandListener, IHttpCommunicatorListener
{
  ...
  {
    this.jdField_a_of_type_Fra = new fra(this);
  ...
  public void a(HttpMsg arg1, HttpMsg paramHttpMsg2)
  {
    ...
    try
    {
      synchronized (this.jdField_a_of_type_ArrayOfInt)
      {
        ...
        ConfigParser.a(paramHttpMsg2, new frb(), this.j);
        b();
        d();
        return;
      }
  ...
  public void a(BaseConf[] paramArrayOfBaseConf)
  {
    ...
    this.jdField_a_of_type_JavaUtilTimer.schedule(new fqz(this), 1000L);
  }
  ...
  {
    boolean bool = true;
    switch (this.jdField_a_of_type_Fra.a)
    {
    default: 
      bool = false;
    }
