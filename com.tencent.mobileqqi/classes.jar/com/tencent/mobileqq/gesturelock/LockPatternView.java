  ...
  extends View
{
  ...
  public LockPatternView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.I).getString(0);
    ...
    for (;;)
    {
      ...
      this.jdField_g_of_type_Int = getResources().getColor(2131361853);
      this.jdField_h_of_type_Int = getResources().getColor(2131361854);
      this.i = getResources().getColor(2131361855);
      this.j = getResources().getColor(2131361856);
      this.k = getResources().getColor(2131361857);
      this.l = getResources().getColor(2131361858);
