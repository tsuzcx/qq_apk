  ...
  extends URLSpan
{
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        i = 1;
        localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity.b;
    ...
    if (((FriendManager)this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity.b.getManager(8)).b(this.jdField_a_of_type_JavaLangString))
    {
    ...
    for (;;)
    {
      ReportController.b(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity.b, "P_CliOper", "Grp_contacts", "", "notice", "see_fromdata", 0, 0, TroopRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity).msg.group_code.get() + "", paramView, "", "");
      ProfileActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity, (ProfileActivity.AllInOne)localObject);
      return;
      if ((TroopRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity).msg.group_msg_type.get() == 2) && (TroopRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRequestActivity).msg.sub_type.get() == 3))
      {
        ...
        ((ProfileActivity.AllInOne)localObject).c = 1;
        break;
      }
