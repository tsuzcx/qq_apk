  ...
  implements View.OnClickListener, FaceDecoder.DecodeTaskCompletionListener, IndexView.OnIndexChangedListener, AbsListView.OnScrollListener
{
  ...
  public eth a;
  private eti jdField_a_of_type_Eti;
  public etl a;
  public ArrayList a;
  ...
  private void a(ListView paramListView, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (m < n)
      {
        etk localetk = (etk)paramListView.getChildAt(m).getTag();
        if ((localetk != null) && (paramString.equals(localetk.jdField_a_of_type_JavaLangString))) {
          localetk.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(paramBitmap);
        }
      }
      else
      {
  ...
  private void a(etk parametk, String paramString, int paramInt1, PhoneContact paramPhoneContact, int paramInt2)
  {
    if ((paramPhoneContact != null) && (paramPhoneContact.photoUri != null)) {
      parametk.jdField_a_of_type_AndroidWidgetImageView.setImageURI(paramPhoneContact.photoUri);
    }
    do
    {
      try
      {
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getContentResolver() != null)
        {
          ...
          parametk.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(paramString);
        }
        return;
      }
      catch (Exception paramString)
      {
        ...
        parametk.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramString);
        return;
      }
      paramString = getResources().getDrawable(2130840369);
    } while (paramString == null);
  ...
  {
    Object localObject1 = (etk)paramView.getTag();
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (etk.a((etk)localObject1) == jdField_b_of_type_JavaLangInteger.intValue())
    {
      paramView = "0";
      ReportController.b((QQAppInterface)localObject2, "CliOper", "", "", "Mobile_contacts", "Clk_addlist_call", 0, 0, paramView, "", "", "");
      paramView = ((etk)localObject1).jdField_a_of_type_ComTencentMobileqqDataPhoneContact;
    ...
    ((AlertDialog.Builder)localObject2).setItems((CharSequence[])localObject1, new etg(this, paramView));
  ...
  public View a()
  {
    ...
    etk localetk = new etk(null);
    localetk.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131232030));
    localetk.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131232031));
    localetk.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131232034));
    localetk.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    localView.setTag(localetk);
    return localView;
  }
  
  protected void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(VoipAddressBookView.class, this.jdField_a_of_type_Etl);
    boolean bool;
    if (this.d)
    {
      this.jdField_b_of_type_AndroidWidgetTextView.setText(getContext().getString(2131558966));
      if (this.jdField_a_of_type_Eti == null)
      {
        this.jdField_a_of_type_Eti = new eti(this, null);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.registObserver(this.jdField_a_of_type_Eti);
      }
      j();
  ...
  protected void a(Intent paramIntent, PhoneInnerFrame paramPhoneInnerFrame)
  {
    ...
    a(2130904051);
    this.jdField_a_of_type_Etl = new etl(this);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView = ((PinnedDividerListView)findViewById(2131234659));
    ...
    this.jdField_a_of_type_Eth = new eth(this, null);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_Eth);
  ...
  public void a(View paramView, PhoneContact paramPhoneContact, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      etk.a(paramView, jdField_b_of_type_JavaLangInteger.intValue());
    ...
    etk.a(paramView, jdField_c_of_type_JavaLangInteger.intValue());
  ...
  public void a(AbsListView paramAbsListView, int paramInt)
  {
    ...
    paramAbsListView = (etk)this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.getChildAt(paramInt).getTag();
  ...
  {
    super.b();
    this.jdField_a_of_type_Eth.notifyDataSetChanged();
  ...
  protected void d()
  {
    ...
    if (this.jdField_a_of_type_Eti != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver(this.jdField_a_of_type_Eti);
      this.jdField_a_of_type_Eti = null;
    }
    super.d();
  }
  ...
  public void j()
  {
    ...
    {
      this.jdField_a_of_type_Etl.sendEmptyMessageDelayed(2, 1000L);
      return;
    }
  ...
  public void k()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(getContext(), 231, getContext().getString(2131559983), getContext().getString(2131559982), 2131559984, 2131559985, new eta(this), new etc(this));
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnKeyListener(new etd(this));
  ...
  public void l()
  {
    ...
    for (int m = 15;; m = 16)
    {
      this.jdField_a_of_type_AndroidAppDialog = new ete(this, getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, m, this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations);
      this.jdField_a_of_type_AndroidAppDialog.setCanceledOnTouchOutside(true);
      this.jdField_a_of_type_AndroidAppDialog.show();
      this.jdField_a_of_type_AndroidAppDialog.setOnDismissListener(new etf(this));
      return;
    }
  }
  ...
  public void n()
  {
    this.jdField_a_of_type_Etl.removeMessages(1);
