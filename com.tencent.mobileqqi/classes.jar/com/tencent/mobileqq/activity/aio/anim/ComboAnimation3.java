...
{
  static final int jdField_b_of_type_Int = (int)(60.0F * BaseApplicationImpl.a().getResources().getDisplayMetrics().density + 0.5F);
  public float a;
  ...
  public ComboAnimation3(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ChatXListView paramChatXListView)
  {
    super(paramInt, paramAIOAnimationConatiner, paramChatXListView);
    this.jdField_a_of_type_Float = 0.04166667F;
  }
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    if (i > 0)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[3] = this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources().getDrawable(2130837626);
      i = this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[3].getIntrinsicWidth();
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[2] = this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources().getDrawable(2130838281);
      j = this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[2].getIntrinsicWidth();
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[1] = this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources().getDrawable(2130838281);
      k = this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[1].getIntrinsicWidth() + (i + 0 + j);
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[0] = this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources().getDrawable(2130838282);
      i = this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[0].getIntrinsicWidth() + k;
      this.jdField_a_of_type_AndroidViewView = new eco(this, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getContext());
      this.jdField_b_of_type_AndroidViewView = new eco(this, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getContext());
      ...
      if (a(this.jdField_a_of_type_Long))
      {
        ...
        ((AnimatorSet)localObject3).addListener(new ecj(this));
    ...
    for (;;)
    {
      ...
      do
      {
        this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[(i1 - m)] = this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources().getDrawable(i % 10 + 2130838272);
      ...
      paramVarArgs.setAnimationListener(new ecl(this));
      paramVarArgs = new ecn(this);
      paramVarArgs.setDuration(1000L);
      paramVarArgs.setFillAfter(true);
