  ...
  extends ViewGroup
{
  ...
  {
    if (paramInt == 2) {
      return new FloorJumperSet(paramInt, this, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
    }
    if (paramInt == 1) {
      return new ComboAnimation3(paramInt, this, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
    }
    if (paramInt == 0) {
      return new BubbleAnimation(paramInt, this, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
    }
    if (paramInt == 4) {
      return new PathAnimation(paramInt, this, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
    }
    if (paramInt == 3) {}
    return null;
  }
  ...
  protected boolean getChildStaticTransformation(View paramView, Transformation paramTransformation)
  {
    ...
    if ((VersionUtils.e()) && ((localObject instanceof AnimationPath.Values)) && (((AnimationPath.Values)localObject).jdField_a_of_type_Boolean))
    {
      ...
      localMatrix.preRotate(((AnimationPath.Values)localObject).jdField_a_of_type_Float, j, k);
