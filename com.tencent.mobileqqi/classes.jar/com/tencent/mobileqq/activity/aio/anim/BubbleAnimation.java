  ...
  extends AIOAnimationConatiner.AIOAnimator
{
  ...
  public BubbleAnimation(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ChatXListView paramChatXListView)
  {
    ...
    this.jdField_a_of_type_Ect = new ect(paramChatXListView.getResources());
    this.jdField_b_of_type_Ect = new ect(paramChatXListView.getResources());
  ...
  private boolean a(long paramLong)
  {
    ...
    if ((localObject != null) && (this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_a_of_type_ComTencentMobileqqBubbleBubbleInfo$CommonAttrs != null))
    {
      ...
      {
        bool1 = true;
        this.jdField_a_of_type_Ect.a(bool1);
        if (this.jdField_b_of_type_ComTencentMobileqqBubbleBubbleInfo$CommonAttrs != null)
        {
          ...
          localObject = this.jdField_b_of_type_Ect;
          if (bool1) {
            break label1051;
          }
          bool2 = true;
          ((ect)localObject).a(bool2);
        }
      ...
      for (bool1 = true;; bool1 = false)
      {
        if ((this.jdField_b_of_type_ComTencentMobileqqBubbleBubbleInfo$CommonAttrs != null) && (this.jdField_b_of_type_AndroidViewView != null) && (bool1))
        {
          ...
          for (;;)
          {
            ...
            bool2 = false;
            break label309;
            this.jdField_b_of_type_Ect.a(bool1);
            break label316;
          ...
          this.jdField_a_of_type_AndroidOsHandler.post(new ecd(this));
          return false;
        }
        return bool1;
      }
  ...
  protected void a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      if ((!this.jdField_a_of_type_Ect.a()) && (this.jdField_a_of_type_AndroidViewView.getBottom() > 0) && (this.jdField_a_of_type_AndroidViewView.getTop() < this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getHeight())) {}
    }
    for (int i = 1;; i = 0)
    {
      if (this.jdField_b_of_type_AndroidViewView != null)
      {
        ...
        if ((!this.jdField_b_of_type_Ect.a()) && (this.jdField_b_of_type_AndroidViewView.getBottom() > 0))
        {
          paramInt = j;
      ...
      for (paramInt = 1;; paramInt = i)
      {
        label112:
        if (paramInt != 0) {
          this.jdField_a_of_type_AndroidOsHandler.post(new ece(this));
        }
        return;
      }
    }
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    if ((l != this.jdField_a_of_type_Long) || (this.jdField_b_of_type_Int != k))
    {
      ...
      this.jdField_a_of_type_Ect.a(this.jdField_a_of_type_ComTencentMobileqqBubbleBubbleInfo$CommonAttrs.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_ComTencentMobileqqBubbleBubbleInfo$CommonAttrs.e);
      if (k != 0)
      {
        paramVarArgs = this.jdField_a_of_type_Ect;
      ...
      {
        this.jdField_a_of_type_AndroidViewView = new ecf(this, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getContext());
        this.jdField_a_of_type_AndroidViewView.setBackgroundDrawable(this.jdField_a_of_type_Ect);
        ...
        this.jdField_a_of_type_AndroidViewView.layout(0, 0, this.jdField_a_of_type_Ect.getIntrinsicWidth(), this.jdField_a_of_type_Ect.getIntrinsicHeight());
        ...
        {
          this.jdField_b_of_type_Ect.a(this.jdField_b_of_type_ComTencentMobileqqBubbleBubbleInfo$CommonAttrs.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_b_of_type_ComTencentMobileqqBubbleBubbleInfo$CommonAttrs.e);
          if (k != 0)
          {
            paramVarArgs = this.jdField_b_of_type_Ect;
          ...
          this.jdField_b_of_type_AndroidViewView = new ech(this, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getContext());
          this.jdField_b_of_type_AndroidViewView.setBackgroundDrawable(this.jdField_b_of_type_Ect);
          ...
          this.jdField_b_of_type_AndroidViewView.layout(0, 0, this.jdField_b_of_type_Ect.getIntrinsicWidth(), this.jdField_b_of_type_Ect.getIntrinsicHeight());
        }
      }
    }
  ...
  protected void c()
  {
    if (this.jdField_a_of_type_Ect != null) {
      this.jdField_a_of_type_Ect.a();
    }
    if (this.jdField_b_of_type_Ect != null) {
      this.jdField_b_of_type_Ect.a();
    }
  }
}
