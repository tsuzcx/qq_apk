          ...
          if ((j == 0) && (m == 0))
          {
            ...
            if (((AioAnimationRule)localObject1).jdField_a_of_type_Boolean)
            {
              ...
              while (i < j)
              {
                ...
                k = i * 800;
                this.jdField_a_of_type_AndroidOsHandler.postDelayed(new dwp(this, paramAIOAnimationConatiner, (Drawable)localObject2, k), paramInt + k);
                i += 1;
              }
            }
            else
            {
              ...
              this.jdField_a_of_type_AndroidOsHandler.postDelayed(new dws(this, paramAIOAnimationConatiner, (Drawable)localObject1), paramInt);
            }
          }
        }
        else if ((j == 0) && (m == 0))
        {
          ...
          if (((AioAnimationRule)localObject1).jdField_a_of_type_Boolean)
          {
            ...
            while (i < j)
            {
              ...
              localObject2 = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject2);
              k = i * 800;
              this.jdField_a_of_type_AndroidOsHandler.postDelayed(new dwt(this, paramAIOAnimationConatiner, (Drawable)localObject2, k), paramInt + k);
              i += 1;
            }
          }
          else
          {
            localObject1 = (AioAnimationRule.JumpImage)((AioAnimationRule)localObject1).jdField_b_of_type_JavaUtilArrayList.get(0);
            localObject1 = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject1);
            this.jdField_a_of_type_AndroidOsHandler.postDelayed(new dwu(this, paramAIOAnimationConatiner, (Drawable)localObject1), paramInt);
          }
        }
        else if ((j < m) && (i >= j))
        {
          if (i == m)
          {
            ...
            if (paramBoolean2)
            {
              ...
              this.jdField_a_of_type_AndroidOsHandler.postDelayed(new dwv(this, paramAIOAnimationConatiner, i, paramChatMessage), paramInt + 0);
            }
            if (QLog.isColorLevel()) {
    ...
    for (int j = 1000;; j = 0)
    {
      if (((AioAnimationRule)localObject1).jdField_a_of_type_Boolean)
      {
        ...
        while (k < n)
        {
          ...
          localObject2 = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject2);
          int i1 = (k + i) * 800;
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new dww(this, paramAIOAnimationConatiner, (Drawable)localObject2, i1), paramInt + j + i1);
          k += 1;
        }
      }
      ...
      localObject2 = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject2);
      k = i * 800;
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new dwx(this, paramAIOAnimationConatiner, (Drawable)localObject2, k), paramInt + j + k);
      i += 1;
      break label801;
      break label63;
      if (i > m)
      {
        ...
        if (paramBoolean2)
        {
          a(paramQQAppInterface, paramChatMessage, 1, 2, (AioAnimationRule)localObject1);
          a(paramQQAppInterface, paramChatMessage, (AioAnimationRule)localObject1);
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new dwy(this, paramAIOAnimationConatiner, i, paramChatMessage), paramInt + 0);
        }
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "detect (M > Y) =======>  egg_jumper animation ,Y=" + m + ",crazyModeEnable=" + ((AioAnimationRule)localObject1).jdField_a_of_type_Boolean);
        }
      ...
      for (i = 1000;; i = 0)
      {
        if (((AioAnimationRule)localObject1).jdField_a_of_type_Boolean)
        {
          ...
          while (j < k)
          {
            ...
            localObject2 = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject2);
            m = j * 800;
            this.jdField_a_of_type_AndroidOsHandler.postDelayed(new dwz(this, paramAIOAnimationConatiner, (Drawable)localObject2, m), paramInt + i + m);
            j += 1;
          }
          break label63;
        }
        localObject1 = (AioAnimationRule.JumpImage)((AioAnimationRule)localObject1).jdField_b_of_type_JavaUtilArrayList.get(0);
        localObject1 = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject1);
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(new dwq(this, paramAIOAnimationConatiner, (Drawable)localObject1), paramInt + i);
        break label63;
        if (QLog.isColorLevel()) {
        ...
        a(paramQQAppInterface, paramChatMessage, 1, 2, (AioAnimationRule)localObject1);
        a(paramQQAppInterface, paramChatMessage, (AioAnimationRule)localObject1);
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(new dwr(this, paramAIOAnimationConatiner, i, paramChatMessage), 0 + paramInt);
        break label63;
        break;
      }
    }
