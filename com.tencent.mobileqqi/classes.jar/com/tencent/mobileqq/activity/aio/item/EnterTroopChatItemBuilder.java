  ...
  extends AbstractChatItemBuilder
{
  ...
  {
    int j = 0;
    paramOnLongClickAndTouchListener = (dyi)paramViewHolder;
    ...
    if ((paramMessageRecord instanceof MessageForEnterTroop))
    {
      ...
      paramMessageRecord = this.jdField_a_of_type_AndroidContentContext.getString(2131560285);
      ...
      for (i = 1; ((Iterator)localObject2).hasNext(); i = 0)
      {
        ...
        paramMessageRecord = paramView + localUser.nick;
      }
    ...
    for (;;)
    {
      ...
      while ((paramMessageRecord.hasNext()) && (paramView.hasNext()))
      {
        ...
        paramLinearLayout.setImageDrawable(FaceDrawable.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, paramOnLongClickAndTouchListener.uin));
      }
