  ...
  extends AbstractChatItemBuilder
{
  ...
  protected View a(MessageRecord paramMessageRecord, AbstractChatItemBuilder.ViewHolder paramViewHolder, View paramView, LinearLayout paramLinearLayout, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    if ((paramViewHolder != null) && (paramViewHolder.equals("1.0")))
    {
      ...
      paramLinearLayout.b.setText(str2 + this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131558912));
    ...
    for (;;)
    {
      ...
      if (l > 0L) {
        paramLinearLayout.jdField_a_of_type_JavaLangStringBuilder.append(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131558913, new Object[] { paramViewHolder }));
      }
      paramLinearLayout.jdField_a_of_type_JavaLangStringBuilder.append(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131558914)).append((CharSequence)localObject1);
