  ...
  implements View.OnClickListener, AudioPanelCallback, VoicePlayer.VoicePlayerListener
{
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqUtilsVoicePlayer != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCircleProgressView.setImageResource(2130838666);
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, ChatActivity paramChatActivity, ViewGroup paramViewGroup1, AudioPanel paramAudioPanel, ViewGroup paramViewGroup2, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131232853));
    this.jdField_a_of_type_AndroidWidgetTextView.setText(AudioPanel.a(0.0D));
    this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCircleProgressView = ((CircleProgressView)findViewById(2131232855));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131232857));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131232858));
    ...
    paramQQAppInterface = SkinUtils.a(paramChatActivity.getDrawable(2130839756));
    paramChatActivity = SkinUtils.a(paramChatActivity.getDrawable(2130839757));
  ...
  public boolean a()
  {
    ...
    {
      setVisibility(8);
      localObject = (PressToSpeakPanel)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131232859);
  ...
  public void onClick(View paramView)
  {
    ...
    if (i == 2131232855)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqUtilsVoicePlayer == null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsVoicePlayer.a();
        this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCircleProgressView.setImageResource(2130838667);
      }
    }
    label192:
    do
    {
      ...
      if (i == 2131232857)
      {
        ...
        for (i = 3;; i = 2)
        {
          ...
          setVisibility(8);
          paramView = (PressToSpeakPanel)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131232859);
          paramView.c();
