  ...
  extends IAIOImageProvider.Stub
{
  ...
  {
    ThreadManager.a().post(new eht(this, paramLong, paramInt));
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localPicReq.a(new ehr(this, paramLong, paramInt1, paramInt2, localMessageForPic.size, str));
  ...
  public void b()
  {
    ...
    ThreadManager.a().post(new ehs(this));
  }
