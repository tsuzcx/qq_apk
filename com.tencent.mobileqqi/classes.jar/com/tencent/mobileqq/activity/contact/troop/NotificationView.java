  ...
  implements View.OnClickListener, BaseSystemMsgInterface, FaceDecoder.DecodeTaskCompletionListener, SlideDetectListView.OnScrollToTopListener, SlideDetectListView.OnSlideListener
{
  ...
  private void b(NotificationAdapter.ViewHolder paramViewHolder)
  {
    ...
    default: 
      ...
      i1 = 4;
      str = paramViewHolder.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_name.get() + this.jdField_a_of_type_AndroidContentContext.getString(2131560582);
    }
    for (;;)
    {
      ...
      str = paramViewHolder.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.req_uin_nick.get() + this.jdField_a_of_type_AndroidContentContext.getString(2131560583);
      continue;
      ...
      str = paramViewHolder.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.action_uin_nick.get() + this.jdField_a_of_type_AndroidContentContext.getString(2131560584);
    }
  }
  ...
  private void p()
  {
    ...
    this.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(AppConstants.aa, 0);
  ...
  public void a(NotificationAdapter.ViewHolder paramViewHolder, int paramInt)
  {
      ...
      default: 
        ...
        if ((paramInt != 0) && ((localStructMsg.msg.group_ext_flag.get() & 0x800) != 0)) {
          if (localStructMsg.msg.group_info.group_auth_type.get() == 2)
          {
            ...
            paramViewHolder.jdField_c_of_type_AndroidWidgetTextView.setTextAppearance(this.jdField_a_of_type_AndroidContentContext, 2131624127);
            localObject = str;
            label345:
    ...
    for (;;)
    {
      ...
      {
        paramViewHolder.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131560388));
        break label410;
      }
      paramViewHolder.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
      break label410;
      ...
      else
      {
        ...
        paramViewHolder.jdField_a_of_type_AndroidWidgetButton.setTextAppearance(this.jdField_a_of_type_AndroidContentContext, 2131624128);
        ...
        if (localObject != null)
        {
          ...
          ((RelativeLayout.LayoutParams)localObject).setMargins(0, 0, (int)(2.0F * this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getResources().getDisplayMetrics().density), 0);
        }
      }
    }
  }
  ...
  protected void e()
  {
    ...
    ((NewFriendManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(32)).a(new TroopSystemMessage(0));
  }
