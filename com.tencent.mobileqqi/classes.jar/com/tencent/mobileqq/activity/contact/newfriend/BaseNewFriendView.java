  ...
  implements Observer
{
  ...
  protected View a(int paramInt)
  {
    if (this.jdField_d_of_type_AndroidViewView != null) {
      return this.jdField_d_of_type_AndroidViewView.findViewById(paramInt);
    }
  ...
  protected void a(Intent paramIntent, BaseNewFriendView.INewFriendContext paramINewFriendContext)
  {
    ...
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendBaseNewFriendView$INewFriendContext.c();
  ...
  protected final void b(int paramInt)
  {
    ...
    this.jdField_d_of_type_AndroidViewView = localLayoutInflater.inflate(paramInt, null);
    localBounceScrollView.addView(this.jdField_d_of_type_AndroidViewView);
  ...
  {
    NewFriendManager localNewFriendManager = (NewFriendManager)this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendBaseNewFriendView$INewFriendContext.a().getManager(32);
    if (paramBoolean)
    {
