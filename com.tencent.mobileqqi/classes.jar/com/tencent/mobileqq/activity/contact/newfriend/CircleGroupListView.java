  ...
  implements View.OnClickListener
{
  ...
  IGroupObserver jdField_a_of_type_ComTencentMobileqqServiceCircleIGroupObserver = new edu(this);
  ...
  private void a()
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Edz = new edz(this, null);
      this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Edz);
      return;
      bool = false;
      break;
      label116:
  ...
  private void c(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactSearchResultDialog = new edv(this, getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations);
    ...
    localTranslateAnimation1.setAnimationListener(new edw(this));
    localTranslateAnimation2.setAnimationListener(new edx(this, paramInt));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactSearchResultDialog.setOnDismissListener(new edy(this, paramInt, localTranslateAnimation2));
  ...
  private void j()
  {
    ...
    this.d = findViewById(2131232906);
    ...
    ((TextView)localView.findViewById(2131234397)).setText(2131562831);
  ...
  public View a()
  {
    ...
    eea localeea = new eea(null);
    localeea.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131230940));
    localeea.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131231394));
    localeea.b = ((TextView)localView.findViewById(2131231395));
    Button localButton = (Button)localView.findViewById(2131232034);
    localButton.setBackgroundResource(2130837804);
    localButton.setVisibility(0);
    localButton.setClickable(false);
    localView.setTag(localeea);
  ...
  {
    eea localeea = (eea)paramView.getTag();
    localeea.jdField_a_of_type_AndroidWidgetImageView.setImageResource(this.jdField_a_of_type_ComTencentMobileqqAppCircleManager.a(paramCircleGroup.groupId));
    localeea.jdField_a_of_type_AndroidWidgetTextView.setText(paramCircleGroup.groupName);
    localeea.b.setText(getResources().getString(2131558935, new Object[] { Integer.valueOf(paramCircleGroup.buddyCount) }));
    localeea.jdField_a_of_type_Int = paramCircleGroup.groupId;
    localeea.jdField_a_of_type_JavaLangString = paramCircleGroup.groupName;
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(getResources().getString(2131558936, new Object[] { localeea.jdField_a_of_type_JavaLangString }));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      paramView.putExtra("k_group_id", localeea.jdField_a_of_type_Int);
      paramView.putExtra("k_group_name", localeea.jdField_a_of_type_JavaLangString);
      if (this.jdField_a_of_type_Boolean)
      {
        ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Network_circle", "Forward_circle_grp", 0, 0, localeea.jdField_a_of_type_Int - 1 + "", "", "", "");
        b(paramView, 20000);
        return;
        if (this.jdField_a_of_type_Boolean)
        {
      ...
      ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Network_circle", "Circle_list_exp", 0, 0, localeea.jdField_a_of_type_Int - 1 + "", "", "", "");
      a(paramView);
      return;
    }
  }
