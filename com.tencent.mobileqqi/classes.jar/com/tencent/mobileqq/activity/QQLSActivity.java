  ...
  implements View.OnClickListener, Observer
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new dbz(this, Looper.getMainLooper());
  private PowerManager.WakeLock jdField_a_of_type_AndroidOsPowerManager$WakeLock;
  private MotionEvent jdField_a_of_type_AndroidViewMotionEvent;
  View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new dby(this);
  ...
  private dca jdField_a_of_type_Dca;
  ...
  private void e()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131232998));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131233000));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131233009));
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131233015));
    this.jdField_b_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131233007));
    ...
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)findViewById(2131233011));
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx = ((XEditTextEx)findViewById(2131233012));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131233013));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131231661));
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new dbu(this));
    this.jdField_a_of_type_Dca = new dca(this, new ArrayList());
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Dca);
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setCursorVisible(false);
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnTouchListener(new dbv(this));
    this.jdField_a_of_type_Dcb = new dcb(this, new ArrayList());
    this.jdField_b_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Dcb);
  ...
  private void f()
  {
    ...
    for (;;)
    {
      ...
      dca.a(this.jdField_a_of_type_Dca).clear();
      dca.a(this.jdField_a_of_type_Dca).addAll(localArrayList1);
      this.jdField_a_of_type_Dca.notifyDataSetChanged();
    }
  }
  ...
  private void g()
  {
    ...
    {
      localObject = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131233001);
      TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131233004);
      TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131233005);
      localTextView3 = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131233008);
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131233009).setVisibility(8);
      ...
      dcb.a(this.jdField_a_of_type_Dcb).addAll(a(this.jdField_a_of_type_ComTencentMobileqqActivityRecentRecentBaseData.a(), this.jdField_a_of_type_ComTencentMobileqqActivityRecentRecentBaseData.a()));
      this.jdField_a_of_type_Dcb.notifyDataSetChanged();
      if (dcb.a(this.jdField_a_of_type_Dcb).size() == 0)
      {
        if (QLog.isColorLevel()) {
      ...
      this.jdField_b_of_type_ComTencentWidgetXListView.b(this.jdField_a_of_type_Dcb.getCount() - 1);
    }
    for (;;)
    {
      ...
      return;
      label323:
      this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131233009).setVisibility(0);
      break;
      label340:
      ...
      break label173;
      label361:
      this.jdField_b_of_type_ComTencentWidgetXListView.setSelection(this.jdField_a_of_type_Dcb.getCount() - 1);
    }
  }
