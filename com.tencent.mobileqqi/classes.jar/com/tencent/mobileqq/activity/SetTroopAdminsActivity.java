  ...
  implements AdapterView.OnItemClickListener
{
  ...
  private TroopObserver jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new dhx(this);
  private TroopInfo jdField_a_of_type_ComTencentMobileqqDataTroopInfo;
  private QQProgressDialog jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog;
  private XListView jdField_a_of_type_ComTencentWidgetXListView;
  private dia jdField_a_of_type_Dia;
  ...
  {
    this.jdField_b_of_type_ComTencentMobileqqAppTroopObserver = new dhy(this);
    this.jdField_a_of_type_AndroidOsHandler = new dhz(this);
  }
  ...
  public void a(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (paramInt >= 0)
    {
      localTroopAdmin = (SetTroopAdminsActivity.TroopAdmin)this.jdField_a_of_type_Dia.getItem(paramInt);
      paramView = null;
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      d();
      ((TextView)findViewById(2131231455)).setVisibility(4);
      setTitle(2131562342);
      c(2131561977, new dhu(this));
      this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131234481));
      ...
      this.jdField_a_of_type_Dia = new dia(this, this, this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentWidgetXListView);
      this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Dia);
      ((Button)findViewById(2131234378)).setOnClickListener(new dhv(this));
  ...
  protected void doOnDestroy()
  {
    ...
    if (this.jdField_a_of_type_Dia != null) {
      this.jdField_a_of_type_Dia.b();
    }
    super.doOnDestroy();
  }
