  ...
  implements View.OnClickListener
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new cbg(this);
  ...
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new cbm(this);
  ...
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new cbn(this);
  ...
  private void a(String paramString1, ArrayList paramArrayList, String paramString2, int paramInt, boolean paramBoolean1, boolean paramBoolean2, long paramLong)
  {
    ...
    {
      DialogUtil.a(this, 230, str, paramString1, new cbk(this, paramString2, paramArrayList, paramInt, paramBoolean2, paramLong), new cbl(this)).show();
      return;
    }
  }
  ...
  private void a(List paramList)
  {
    ...
    label76:
    View localView = getLayoutInflater().inflate(2130903565, this.jdField_a_of_type_AndroidWidgetLinearLayout, false);
    ...
    if (j == 1)
    {
      ...
      localTextView2 = (TextView)localView.findViewById(2131232939);
    ...
    for (;;)
    {
      ...
      localRelativeLayout.setOnClickListener(new cbj(this, localRelativeLayout, i));
  ...
  private void e()
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new cbh(this));
  }
  
  private void f()
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new cbi(this));
  }
  ...
  void a()
  {
    ...
    localDialog.setOnDismissListener(new cbo(this));
    if (localTextView1 != null) {
      localTextView1.setOnClickListener(new cbp(this));
    }
    if (localTextView2 != null) {
      localTextView2.setOnClickListener(new cbq(this));
    }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem = ((FormSimpleItem)super.findViewById(2131232936));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131232938));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)super.findViewById(2131231617));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131232934));
