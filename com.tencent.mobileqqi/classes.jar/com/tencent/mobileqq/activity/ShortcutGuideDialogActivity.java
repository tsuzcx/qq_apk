  ...
  extends BaseActivity
{
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(getString(2131561592), new dig(this)).setNegativeButton(getString(2131561746), new dif(this));
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnDismissListener(new dih(this));
    View localView = getLayoutInflater().inflate(2130903630, null);
    ImageView localImageView = (ImageView)localView.findViewById(2131233163);
    TextView localTextView = (TextView)localView.findViewById(2131233164);
