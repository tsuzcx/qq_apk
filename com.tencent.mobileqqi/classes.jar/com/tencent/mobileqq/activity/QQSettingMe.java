  ...
  implements View.OnClickListener
{
  ...
  protected long a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new diu(this);
  protected View a;
  ...
  CardObserver jdField_a_of_type_ComTencentMobileqqAppCardObserver = new djk(this);
  private ConfigObserver jdField_a_of_type_ComTencentMobileqqAppConfigObserver = new dji(this);
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new div(this);
  public QQAppInterface a;
  private VipInfoObserver jdField_a_of_type_ComTencentMobileqqAppVipInfoObserver = new djg(this);
  private UpgradeDetailWrapper jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper;
  private GameCenterObserver jdField_a_of_type_ComTencentMobileqqObserverGameCenterObserver = new djf(this);
  ...
  NightModeLogic.NightModeCallback jdField_a_of_type_ComTencentMobileqqThemeNightModeLogic$NightModeCallback = new diz(this);
  ...
  public QQSettingMe(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2130903618, null));
  }
  ...
  private void b(String paramString)
  {
    ...
    for (paramString = "http://mc.vip.qq.com?platform=1&sid=" + paramString + "&_bid=138";; paramString = "http://mc.vip.qq.com?platform=1&_bid=138")
    {
      ...
      CustomWidgetUtil.a((TextView)this.jdField_a_of_type_ArrayOfAndroidViewView[0].findViewById(2131233117), 0, 0, 0);
      return;
    }
  }
  ...
  public void a(Resources paramResources, ImageView paramImageView, String paramString)
  {
    try
    {
      Object localObject = paramResources.getDrawable(2130839213);
    ...
    catch (Exception localException)
    {
      ...
      paramImageView.setImageDrawable(paramResources.getDrawable(2130839213));
      paramImageView.setVisibility(0);
  ...
  {
    ThreadManager.a().post(new dja(this, paramString));
  }
  ...
  public void f()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131233093);
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView.setContentDescription("进入我的资料卡");
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131232298));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131231090));
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131233095);
      ...
      tmp244_238[6] = 2131563366;
      int[] tmp251_244 = tmp244_238;
      tmp251_244[7] = 2131563367;
      ...
      while (m < 9)
      {
        this.jdField_a_of_type_ArrayOfAndroidViewView[m] = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(new int[] { 2131233106, 2131233107, 2131233110, 2131233112, 2131233111, 2131233109, 2131233113, 2131233114, 2131233108 }[m]);
        ...
        ImageView localImageView = (ImageView)this.jdField_a_of_type_ArrayOfAndroidViewView[m].findViewById(2131233115);
        if (localImageView != null) {
          localImageView.setImageResource(new int[] { 2130839053, 2130839067, 2130839069, 2130839070, 2130839071, 2130839072, 2130839052, 2130839052, 2130839052 }[m]);
        }
        ((TextView)this.jdField_a_of_type_ArrayOfAndroidViewView[m].findViewById(2131233116)).setText(arrayOfInt[m]);
        ((TextView)this.jdField_a_of_type_ArrayOfAndroidViewView[m].findViewById(2131233117)).setVisibility(8);
      ...
      localObject = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131233099);
      ((View)localObject).setOnClickListener(this);
      this.jdField_a_of_type_ComTencentMobileqqWidgetRedDotTextView = ((RedDotTextView)((View)localObject).findViewById(2131233100));
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131233101);
      this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131233103));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131233102));
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ArrayOfAndroidViewView[5].findViewById(2131233118));
      e();
      h();
      o();
      g();
  ...
  public void j()
  {
    ...
    if (m == 1)
    {
      localDrawable = localResources.getDrawable(2130839064);
    ...
    for (;;)
    {
      ...
      if (m == 2)
      {
        localDrawable = localResources.getDrawable(2130839063);
        str = localResources.getString(2131562469);
      }
      else
      {
  ...
  protected void l()
  {
    try
    {
      ...
      QQSettingUtil.a((TextView)this.jdField_a_of_type_ArrayOfAndroidViewView[1].findViewById(2131233117), localAppInfo);
      return;
    }
    catch (Exception localException)
    {
  ...
  protected void m()
  {
    try
    {
      ...
      {
        QQSettingUtil.a((TextView)this.jdField_a_of_type_ArrayOfAndroidViewView[5].findViewById(2131233117), (BusinessInfoCheckUpdate.AppInfo)localObject);
  ...
  protected void n()
  {
    try
    {
      ...
      QQSettingUtil.a((TextView)this.jdField_a_of_type_ArrayOfAndroidViewView[0].findViewById(2131233117), localAppInfo);
      return;
    }
    catch (Exception localException)
    {
  ...
  public void o()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqRichstatusIStatusListener = new djc(this);
      this.jdField_a_of_type_ComTencentMobileqqRichstatusIIconListener = new djd(this);
      this.jdField_a_of_type_ComTencentMobileqqRichstatusIActionListener = new dje(this);
    ...
    Object localObject = (ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131233096);
    TextView localTextView = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131233097);
    ...
    {
      ((ImageView)localObject).setBackgroundResource(2130839065);
    ...
    for (;;)
    {
      ...
      ((ImageView)localObject).setImageResource(2130839066);
      break;
      label400:
      localObject = null;
      break label271;
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      case 2131233109: 
        ...
        CustomWidgetUtil.a((TextView)this.jdField_a_of_type_ArrayOfAndroidViewView[5].findViewById(2131233117), 0, 0, 0);
        this.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
      ...
      case 2131233108: 
        ...
        CustomWidgetUtil.a((TextView)this.jdField_a_of_type_ArrayOfAndroidViewView[8].findViewById(2131233117), 0, 0, 0);
  ...
  public void p()
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      localObject1 = (TextView)localView.findViewById(2131233119);
      if (!TextUtils.isEmpty(((Carrier)localObject2).carrierLogo))
      {
        ...
        m = (int)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDimension(2131427597);
      ...
      for (;;)
      {
        QQSettingUtil.a((TextView)localView.findViewById(2131233117), localAppInfo);
        return;
