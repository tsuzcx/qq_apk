  ...
  implements View.OnClickListener, ListAdapter
{
  ...
  public TroopMemberGagActivity$TroopGagListAdapter(TroopMemberGagActivity paramTroopMemberGagActivity, ArrayList paramArrayList, TroopMemberGagActivity.GagItemListener paramGagItemListener)
  {
    ...
    if (paramTroopMemberGagActivity.hasNext())
    {
      ...
      {
        paramGagItemListener.add(new dqq(this, paramArrayList, bool));
        i += 1;
        break;
      }
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)localView.findViewById(2131232687));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131234605));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131234606));
    ...
    paramViewGroup = (dqq)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    ...
    for (int i = 0;; i = 8)
    {
      ...
      paramView.jdField_a_of_type_Dqq = ((dqq)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt));
  ...
  public void onClick(View paramView)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramView.jdField_a_of_type_Dqq == localdqq) {
        localdqq.jdField_a_of_type_Boolean = true;
      } else {
        localdqq.jdField_a_of_type_Boolean = false;
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberGagActivity$GagItemListener.a(paramView.jdField_a_of_type_Dqq.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopGagMgr$GagItem);
