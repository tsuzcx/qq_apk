...
public class SendMultiPictureHelper
{
  ...
  DialogInterface.OnClickListener jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new dhp(this);
  public Bundle a;
  protected SendMultiPictureHelper.SendingFileInfo a;
  public BaseActivity a;
  public QQAppInterface a;
  public FMObserver a;
  private TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new dhn(this);
  ...
  DialogInterface.OnClickListener jdField_b_of_type_AndroidContentDialogInterface$OnClickListener = new dhq(this);
  protected String b;
  public boolean b;
  public int c;
  ...
  public SendMultiPictureHelper(BaseActivity paramBaseActivity)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppFMObserver = new dho(this);
    this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener = new dhr(this);
  ...
  private long a(String paramString1, String paramString2, int paramInt)
  {
    if (paramString1 != null)
    {
      ...
      localMessageForPic.path = paramString1;
      localMessageForPic.size = 0L;
      localMessageForPic.type = 1;
      localMessageForPic.isRead = true;
      localMessageForPic.localUUID = PicReq.a();
      localMessageForPic.serial();
      localMessageForPic.msgUid = (0x0 | Math.abs(new Random().nextInt()));
      int i = MobileQQService.jdField_c_of_type_Int;
      MobileQQService.jdField_c_of_type_Int = i + 1;
      localMessageForPic.shmsgseq = ((short)i);
      localMessageForPic.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
      localMessageForPic.frienduin = paramString2;
      localMessageForPic.senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
      localMessageForPic.msgtype = -2000;
      localMessageForPic.isread = true;
      localMessageForPic.issend = 1;
      localMessageForPic.istroop = paramInt;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localMessageForPic, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a());
      return localMessageForPic.uniseq;
    }
    return 0L;
  }
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilArrayList)
      {
        ...
        if (!((File)localObject2).exists())
        {
          ...
          Toast.makeText(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, ((File)localObject2).getName() + this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131559118), 0).show();
        ...
        if (((File)localObject2).length() == 0L)
        {
          if (this.jdField_c_of_type_Int == 0) {
            Toast.makeText(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131563070), 0).show();
          }
        }
        else
        {
      ...
      Toast.makeText(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131563086), 0).show();
      continue;
      label271:
  ...
  public void a(String paramString1, String paramString2, int paramInt1, String paramString3, int paramInt2, Bundle paramBundle, ArrayList paramArrayList)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230, this.e, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131562870), null, this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentBroadcastReceiver == null) {
        this.jdField_a_of_type_AndroidContentBroadcastReceiver = new dhs(this);
      }
  ...
  public void b()
  {
    Object localObject = "";
    if (this.jdField_d_of_type_Int == 1) {
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131562977);
    }
    for (;;)
    {
      localObject = DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131562517), (String)localObject, 2131561572, 2131562473, this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener, this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener);
      ((QQCustomDialog)localObject).setCancelable(false);
      ((QQCustomDialog)localObject).show();
      return;
      if (this.jdField_d_of_type_Int == 0) {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131562976);
      }
    }
  }
