  ...
  extends IphoneTitleBarActivity
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new dup(this);
  ...
  public VerifyCodeActivity()
  {
    ...
    this.jdField_a_of_type_MqqObserverServerNotifyObserver = new dul(this);
  }
  ...
  private void a(Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131234650));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new duo(this));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131234648);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131234649));
  ...
  {
    setTitle(2131563158);
    a(2131561746, new dum(this));
    b(2131561977, new dun(this));
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      j(2130837729);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131234647));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131234651));
      a(getIntent());
