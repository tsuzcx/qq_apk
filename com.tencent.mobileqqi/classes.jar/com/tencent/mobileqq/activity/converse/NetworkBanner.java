  ...
  extends BaseBanner
{
  ...
  public View a(Context paramContext)
  {
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131231163));
  ...
  protected void a(int paramInt)
  {
    ...
    {
      if (paramInt == 1) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131561867);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131562476);
  }
}
