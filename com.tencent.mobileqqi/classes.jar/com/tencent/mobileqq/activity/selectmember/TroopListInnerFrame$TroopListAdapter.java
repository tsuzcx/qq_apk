  ...
  extends FacePreloadBaseAdapter
{
  ...
  private void a()
  {
    ...
    {
      Collections.sort((List)localObject3, new err(this, null));
    ...
    localObject5 = new ers(this, null);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject1 = (ert)paramView.getTag();
      paramViewGroup = paramView;
      paramView = (View)localObject1;
    }
    for (;;)
    {
      localObject1 = paramViewGroup.findViewById(2131232382);
      localObject2 = (TextView)paramViewGroup.findViewById(2131232381);
      ...
      paramView = new ert(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopListInnerFrame, null);
      paramView.c = ((ImageView)paramViewGroup.findViewById(2131230985));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131232317));
