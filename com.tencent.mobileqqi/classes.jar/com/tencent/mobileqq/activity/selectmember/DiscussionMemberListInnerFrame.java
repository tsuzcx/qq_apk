  ...
  implements View.OnClickListener, View.OnTouchListener, IndexView.OnIndexChangedListener, PinnedDividerListView.OnLayoutListener
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new euk(this);
  private EditText jdField_a_of_type_AndroidWidgetEditText;
  public LinearLayout a;
  TextView jdField_a_of_type_AndroidWidgetTextView;
  private IndexView jdField_a_of_type_ComTencentMobileqqWidgetIndexView;
  public PinnedDividerListView a;
  private eul jdField_a_of_type_Eul;
  ...
  public void a(Bundle paramBundle)
  {
    ...
    g();
    this.jdField_a_of_type_Eul = new eul(this);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_Eul);
  }
  
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (((this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.q() > 0) || ((this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.q() == 0) && (this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.getChildCount() < this.jdField_a_of_type_Eul.getCount() + this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.k()))) && (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.c()))
    {
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Eul.a(paramString);
    } while (i == -1);
  ...
  public void b(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Eul.notifyDataSetChanged();
  }
  
  public void d()
  {
    if (this.jdField_a_of_type_Eul != null) {
      this.jdField_a_of_type_Eul.b();
    }
    super.d();
  }
  ...
  {
    eum localeum = (eum)paramView.getTag();
    if ((localeum != null) && (localeum.jdField_a_of_type_AndroidWidgetCheckBox != null) && (localeum.c != null) && (localeum.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
    {
      boolean bool = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(localeum.jdField_a_of_type_JavaLangString, localeum.c.getText().toString(), 2, this.jdField_b_of_type_JavaLangString);
      localeum.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(bool);
      if (localeum.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
        paramView.setContentDescription(localeum.c.getText().toString() + "已选中,双击取消");
      }
    }
    else
    {
    ...
    paramView.setContentDescription(localeum.c.getText().toString() + "未选中,双击选中");
  }
