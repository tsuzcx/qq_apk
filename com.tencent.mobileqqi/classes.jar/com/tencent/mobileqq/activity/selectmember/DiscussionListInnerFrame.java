  ...
  implements View.OnClickListener
{
  ...
  private void g()
  {
    ...
    String str1 = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getResources().getString(2131562457);
    String str2 = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getResources().getString(2131561536);
    ...
    Collections.sort(this.jdField_a_of_type_JavaUtilArrayList, new eps(this, (HashMap)localObject1));
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    g();
    this.jdField_a_of_type_Ept = new ept(this, null);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ept);
  }
  
  public void b(Bundle paramBundle)
  {
    super.b(paramBundle);
    this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(true, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131561693), this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131561954));
  }
  ...
  {
    paramView = (epu)paramView.getTag();
