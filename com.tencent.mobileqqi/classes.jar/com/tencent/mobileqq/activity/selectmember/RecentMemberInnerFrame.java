  ...
  implements View.OnClickListener, View.OnTouchListener
{
  ...
  private eqh jdField_a_of_type_Eqh;
  ...
  public void a(Bundle paramBundle)
  {
    ...
    g();
    this.jdField_a_of_type_Eqh = new eqh(this);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Eqh);
  }
  ...
  public void b(Bundle paramBundle)
  {
    ...
    if (this.jdField_a_of_type_Eqh != null) {
      this.jdField_a_of_type_Eqh.notifyDataSetChanged();
    }
  }
  ...
  {
    eqi localeqi = (eqi)paramView.getTag();
    if ((localeqi != null) && (localeqi.jdField_a_of_type_JavaLangString != null) && (localeqi.jdField_a_of_type_AndroidWidgetCheckBox != null) && (localeqi.jdField_a_of_type_AndroidWidgetTextView != null) && (localeqi.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
    {
      boolean bool = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(localeqi.jdField_a_of_type_JavaLangString, localeqi.jdField_a_of_type_AndroidWidgetTextView.getText().toString(), 0, "-1");
      localeqi.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(bool);
      if (localeqi.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
        paramView.setContentDescription(localeqi.jdField_a_of_type_AndroidWidgetTextView.getText().toString() + "已选中,双击取消");
      }
    }
    else
    {
    ...
    paramView.setContentDescription(localeqi.jdField_a_of_type_AndroidWidgetTextView.getText().toString() + "未选中,双击选中");
  }
