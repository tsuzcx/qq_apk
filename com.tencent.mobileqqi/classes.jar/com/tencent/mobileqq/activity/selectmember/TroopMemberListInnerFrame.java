  ...
  implements View.OnClickListener, View.OnTouchListener, IndexView.OnIndexChangedListener, PinnedDividerListView.OnLayoutListener
{
  ...
  private TroopObserver jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new erw(this);
  ...
  public TroopMemberListInnerFrame(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new eru(this);
  }
  ...
  private Object[] a(String arg1)
  {
    ...
    else
    {
      ...
      while (???.hasNext()) {
        Collections.sort((List)((LinkedHashMap)localObject4).get((String)???.next()), new ery(this, null));
      }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(localerv);
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    g();
    this.jdField_a_of_type_Erz = new erz(this);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_Erz);
  }
  
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (((this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.q() > 0) || ((this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.q() == 0) && (this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.getChildCount() < this.jdField_a_of_type_Erz.getCount() + this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.k()))) && (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.c()))
    {
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Erz.a(paramString);
    } while (i == -1);
  ...
  public void b(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Erz.notifyDataSetChanged();
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Erz != null) {
      this.jdField_a_of_type_Erz.b();
    }
    super.d();
  }
  ...
  {
    esa localesa = (esa)paramView.getTag();
    if ((localesa != null) && (localesa.jdField_a_of_type_AndroidWidgetCheckBox != null) && (localesa.c != null) && (localesa.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
    {
      boolean bool = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(localesa.jdField_a_of_type_JavaLangString, localesa.c.getText().toString(), 1, this.jdField_b_of_type_JavaLangString);
      localesa.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(bool);
      if (localesa.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
        paramView.setContentDescription(localesa.c.getText().toString() + "已选中,双击取消");
      }
    }
    else
    {
    ...
    paramView.setContentDescription(localesa.c.getText().toString() + "未选中,双击选中");
  }
