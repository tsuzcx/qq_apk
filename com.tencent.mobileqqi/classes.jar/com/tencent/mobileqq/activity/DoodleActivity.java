  ...
  extends BaseActivity
{
  ...
  public Uri a;
  public Handler a;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new cpc(this);
  public ImageView a;
  ...
  public int[] a;
  public ImageView[] a;
  View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new cpd(this);
  ...
  public int[] b;
  public ImageView[] b;
  View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new cpe(this);
  ...
  public DoodleActivity()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new cpf(this);
  }
  ...
  private void d()
  {
    ...
    localActionSheet.a(new cpg(this, localActionSheet));
  ...
  public void a()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new cpj(this));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new cpk(this));
    this.jdField_f_of_type_AndroidWidgetImageView.setVisibility(8);
    this.g.setVisibility(8);
    this.h.setOnClickListener(new cpl(this));
    this.i.setOnClickListener(new cpo(this));
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new cpp(this));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new cpq(this));
    this.jdField_f_of_type_AndroidWidgetImageView.setVisibility(0);
    this.g.setVisibility(0);
    this.jdField_f_of_type_AndroidWidgetImageView.setOnClickListener(new cox(this));
    this.h.setOnClickListener(new coy(this));
    this.i.setOnClickListener(new cpb(this));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_b_of_type_ArrayOfAndroidWidgetImageView[0].setBackgroundResource(2130839730);
    this.jdField_a_of_type_ComTencentMobileqqWidgetDoodlePicView.setPaintThickness(this.jdField_c_of_type_ArrayOfInt[2]);
    this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[2].setBackgroundResource(2130839732);
    this.jdField_d_of_type_AndroidWidgetImageView.setOnClickListener(new cow(this));
    this.jdField_e_of_type_AndroidWidgetImageView.setOnClickListener(new cph(this));
    this.j.setOnClickListener(new cpi(this));
