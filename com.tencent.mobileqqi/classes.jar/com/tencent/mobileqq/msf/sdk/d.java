...
public class d
{
  ...
  public static int a(ToServiceMsg paramToServiceMsg)
  {
    ...
    if (!a.containsKey(paramToServiceMsg.getServiceName())) {
      a.putIfAbsent(paramToServiceMsg.getServiceName(), new s(paramToServiceMsg.getServiceName()));
    }
    return ((s)a.get(paramToServiceMsg.getServiceName())).b(paramToServiceMsg);
  }
  ...
  public static void a(String paramString)
  {
    ...
    if (!a.containsKey(paramString)) {
      a.putIfAbsent(paramString, new s(paramString));
    }
    ((s)a.get(paramString)).i();
  }
