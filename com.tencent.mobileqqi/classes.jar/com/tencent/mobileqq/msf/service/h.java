...
public class h
{
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    localIntent.putExtra("gatewayip", l.l());
    try
    {
    ...
    catch (Exception paramContext)
    {
      for (;;)
      {
        QLog.d("MSF.S.Util", 2, "sendBootAction " + paramContext);
      }
    }
    if ((QLog.isColorLevel()) || (paramString2.equals("0"))) {
  ...
  {
    b localb = d.a(BaseApplication.getContext().getPackageName());
    String str = "com.tencent.mobileqqi.broadcast.qq";
    if (localb != null) {
      str = localb.b();
    }
    return str;
