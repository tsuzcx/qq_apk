  ...
  extends MSFServlet
{
  ...
  private ResponeQueryQQMobileContacts a(UniPacket paramUniPacket)
  {
    ...
    {
      ResponeQueryQQMobileContacts localResponeQueryQQMobileContacts = new ResponeQueryQQMobileContacts();
      ...
      for (paramUniPacket = a(localCompressedPackage.buffer);; paramUniPacket = localCompressedPackage.buffer)
      {
        ...
        localResponeQueryQQMobileContacts.readFrom(paramUniPacket);
        return localResponeQueryQQMobileContacts;
      }
    }
    return (ResponeQueryQQMobileContacts)paramUniPacket.getByClass("ResponeQueryQQMobileContacts", new ResponeQueryQQMobileContacts());
  }
  ...
  private void e(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        notifyObserver(paramIntent, 19, true, null, ContactBindObserver.class);
        return;
      }
      if (QLog.isColorLevel()) {
  ...
  private void j(Intent arg1, FromServiceMsg paramFromServiceMsg)
  {
    if (paramFromServiceMsg.isSuccess())
    {
      paramFromServiceMsg = a(paramFromServiceMsg);
      Object localObject = (RespondHeader)paramFromServiceMsg.getByClass("RespondHeader", new RespondHeader());
      paramFromServiceMsg = (ResponseGetRecommendedList)paramFromServiceMsg.getByClass("ResponseGetRecommendedList", new ResponseGetRecommendedList());
      if (((RespondHeader)localObject).result == 0)
      {
        localObject = paramFromServiceMsg.alreadyBindContacts;
        ArrayList localArrayList = paramFromServiceMsg.circleInfo;
        if ((localArrayList != null) && (localArrayList.size() > 0)) {
          a().b(localArrayList, paramFromServiceMsg.timeStamp);
        }
        if ((localObject != null) && (((List)localObject).size() != 0)) {
          a().a((List)localObject, paramFromServiceMsg.timeStamp);
        }
        if (paramFromServiceMsg.nextFlag != 4294967295L)
        {
          ...
          ((NewIntent)localObject).putExtra("time_stamp", ???.getExtras().getLong("time_stamp"));
          ((NewIntent)localObject).putExtra("session_id", paramFromServiceMsg.sessionSid);
          ((NewIntent)localObject).putExtra("recommend_type", ???.getIntExtra("recommend_type", 1));
          ((NewIntent)localObject).setObserver(((NewIntent)???).getObserver());
          getAppRuntime().startServlet((NewIntent)localObject);
          return;
        }
        localObject = getAppRuntime().getPreferences().edit();
        ((SharedPreferences.Editor)localObject).putLong("getRecommendedTimeStamp", paramFromServiceMsg.timeStamp);
        ...
        if ((paramFromServiceMsg.alreadyBindContacts != null) && (paramFromServiceMsg.alreadyBindContacts.size() > 0))
        {
          ...
          notifyObserver(???, 22, true, (Bundle)localObject, ContactBindObserver.class);
        }
        for (;;)
        {
          synchronized (this.jdField_a_of_type_ArrayOfInt)
          {
            ...
            if (this.c)
            {
              ...
              localObject = new NewIntent(getAppRuntime().getApplication(), ContactBindServlet.class);
              ((NewIntent)localObject).putExtra("req_type", 22);
              ((NewIntent)localObject).putExtra("next_flag", 0L);
              ((NewIntent)localObject).putExtra("getRecommendedTimeStamp", paramFromServiceMsg.timeStamp);
              ((NewIntent)localObject).putExtra("session_id", new byte[] { 0 });
              if (!a().h()) {
                break label455;
              }
          ...
          break;
          label455:
          ((NewIntent)localObject).putExtra("recommend_type", 1);
        }
      }
      notifyObserver(???, 22, false, null, ContactBindObserver.class);
      return;
    }
    notifyObserver(???, 22, false, null, ContactBindObserver.class);
  }
  ...
  private void l(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      if (((RespondHeader)localObject).result == 0)
      {
        a().a(paramFromServiceMsg.nextFlag, paramFromServiceMsg.timeStamp, paramFromServiceMsg.alreadyBindContacts, paramFromServiceMsg.noBindContacts);
        if (paramFromServiceMsg.nextFlag != 4294967295L)
        {
          localObject = new NewIntent(getAppRuntime().getApplication(), ContactBindServlet.class);
          ((NewIntent)localObject).putExtra("req_type", 18);
          ((NewIntent)localObject).putExtra("next_flag", paramFromServiceMsg.nextFlag);
        ...
        localObject = new Bundle();
        if (((paramFromServiceMsg.alreadyBindContacts != null) && (paramFromServiceMsg.alreadyBindContacts.size() > 0)) || ((paramFromServiceMsg.noBindContacts != null) && (paramFromServiceMsg.noBindContacts.size() > 0))) {
          ((Bundle)localObject).putBoolean("hasUpdate", true);
        }
        for (;;)
        {
          notifyObserver(paramIntent, 18, true, (Bundle)localObject, ContactBindObserver.class);
          return;
          ((Bundle)localObject).putBoolean("hasUpdate", false);
        }
      }
      notifyObserver(paramIntent, 18, false, null, ContactBindObserver.class);
      return;
    }
    notifyObserver(paramIntent, 18, false, null, ContactBindObserver.class);
  }
  
  private void m(Intent arg1, FromServiceMsg paramFromServiceMsg)
  {
    if (QLog.isColorLevel()) {
    ...
    if (((RespondHeader)decodePacket(paramFromServiceMsg.getWupBuffer(), "RespondHeader", new RespondHeader())).requestID == 0) {
      for (;;)
      {
        synchronized (this.jdField_a_of_type_ArrayOfInt)
        {
          ...
          paramFromServiceMsg.putExtra("req_type", 22);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      if (str.equals("account.RequestQueryQqMobileContacts"))
      {
      ...
      if (str.equals("account.RequestGetRecommendedList"))
      {
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    case 17: 
      ...
      return;
    case 18: 
      paramPacket.setSSOCommand("account.RequestQueryQqMobileContacts");
      ((RequestHeader)localObject1).cmd = 18;
      paramPacket.addRequestPacket("RequestHeader", (JceStruct)localObject1);
      localObject1 = new RequestQueryQQMobileContacts();
      ((RequestQueryQQMobileContacts)localObject1).Compressd = true;
      ((RequestQueryQQMobileContacts)localObject1).nextFlag = paramIntent.getLong("next_flag");
      ((RequestQueryQQMobileContacts)localObject1).timeStamp = paramIntent.getLong("time_stamp");
      ((RequestQueryQQMobileContacts)localObject1).sessionSid = paramIntent.getByteArray("session_id");
      ((RequestQueryQQMobileContacts)localObject1).version = 1;
      paramPacket.addRequestPacket("RequestQueryQQMobileContacts", (JceStruct)localObject1);
      return;
    case 14: 
    ...
    paramPacket.setSSOCommand("account.RequestGetRecommendedList");
    ((RequestHeader)localObject1).cmd = 22;
    paramPacket.addRequestPacket("RequestHeader", (JceStruct)localObject1);
    localObject1 = new RequestGetRecommendedList();
    ((RequestGetRecommendedList)localObject1).nextFlag = paramIntent.getLong("next_flag");
    ((RequestGetRecommendedList)localObject1).timeStamp = getAppRuntime().getPreferences().getLong("getRecommendedTimeStamp", 0L);
    ((RequestGetRecommendedList)localObject1).sessionSid = paramIntent.getByteArray("session_id");
    ((RequestGetRecommendedList)localObject1).version = 1;
    ((RequestGetRecommendedList)localObject1).type = paramIntent.getInt("recommend_type", 1);
    paramPacket.addRequestPacket("RequestGetRecommendedList", (JceStruct)localObject1);
  }
}
