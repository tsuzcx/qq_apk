...
public class TroopAssistantManager
{
  ...
  private static final String j = "should_update_troop_assistant";
  ...
  private void a(EntityManager arg1)
  {
    try
    {
      ...
      if ((localObject1 != null) && (((List)localObject1).size() > 0)) {
        Collections.sort((List)localObject1, new gfs(this));
      }
    }
    catch (Exception ???)
    {
  ...
  private boolean a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong)
  {
    ...
    case 2: 
      if (bool)
      {
        localObject = localRecentUserProxy.a(AppConstants.Q, 5000);
        ((RecentUser)localObject).uin = AppConstants.Q;
    ...
    for (;;)
    {
      ...
      if (paramInt != 3)
      {
        paramQQAppInterface = localRecentUserProxy.b(AppConstants.Q, 5000);
        if (paramQQAppInterface != null) {
  ...
  private void k(QQAppInterface paramQQAppInterface)
  {
    ...
    ThreadManager.b(new gfr(this, paramQQAppInterface));
  }
  ...
  public void a(EntityManager paramEntityManager, QQAppInterface paramQQAppInterface)
  {
    try
    {
      a(paramQQAppInterface);
      RecentUserProxy localRecentUserProxy = paramQQAppInterface.a().a();
      Object localObject2 = localRecentUserProxy.a();
  ...
  public boolean e(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null)
    {
      if (this.m < 0)
      {
        paramQQAppInterface = paramQQAppInterface.a().getSharedPreferences(paramQQAppInterface.getAccount(), 0);
        if (paramQQAppInterface != null) {
          this.m = paramQQAppInterface.getInt("tag_troop_assist_tip_time", 0);
        }
      }
      if (this.m >= 2) {}
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("troopassist_guide", 2, "getTroopAssistTipInRange time=" + this.m + ",ret=" + bool);
        }
        return bool;
        bool = true;
      }
  ...
  public void h(QQAppInterface paramQQAppInterface)
  {
    ...
    ??? = ((RecentUserProxy)localObject1).a();
    Object localObject5;
    if ((??? != null) && (((List)???).size() > 0))
    {
      ??? = ((List)???).iterator();
  ...
  public void i(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      if (paramQQAppInterface != null)
      {
        ...
        this.m += 1;
        paramQQAppInterface.edit().putInt("tag_troop_assist_tip_time", this.m).commit();
        if (QLog.isColorLevel()) {
          QLog.d("troopassist_guide", 2, "addTroopAssistTipTime time=" + this.m);
        }
      }
    }
  }
