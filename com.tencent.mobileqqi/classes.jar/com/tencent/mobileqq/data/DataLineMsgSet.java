  ...
  implements Cloneable
{
  ...
  {
    return (paramDataLineMsgRecord.msgtype == -2000) || (paramDataLineMsgRecord.msgtype == -2005) || (paramDataLineMsgRecord.msgtype == -2333) || (paramDataLineMsgRecord.msgtype == -2335);
  }
  ...
  {
    return (paramDataLineMsgRecord.groupId == 0) || (paramDataLineMsgRecord.msgtype == -2005) || (paramDataLineMsgRecord.msgtype == -2333);
  }
  ...
  {
    return (this.groupType == -2000) || (this.groupType == -2005) || (this.groupType == -2333) || (this.groupType == -2335);
  }
  ...
  {
    return (this.groupId == 0) || (this.groupType == -2005) || (this.groupType == -2333);
  }
  ...
  public DataLineMsgRecord put(Integer paramInteger, DataLineMsgRecord paramDataLineMsgRecord)
  {
    for (;;)
    {
      try
      {
        ...
        {
          if ((this.groupType != -2000) || ((paramDataLineMsgRecord.msgtype != -2005) && (paramDataLineMsgRecord.msgtype != -2333))) {
            continue;
          }
          this.groupType = -2005;
          continue;
