  ...
  extends TroopBarAbsDataEntity
{
  ...
  public TroopBarPostContentEntity(JSONObject paramJSONObject)
  {
    ...
    this.content = TroopBarUtils.a(paramJSONObject, "content");
    try
    {
    ...
    catch (JSONException localJSONException)
    {
      ...
      this.price = TroopBarUtils.a(paramJSONObject, "price");
      this.tag = TroopBarUtils.a(paramJSONObject, "tag");
      this.addr = TroopBarUtils.a(paramJSONObject, "addr");
      this.sponsor = TroopBarUtils.a(paramJSONObject, "sponsor");
      this.image2 = TroopBarUtils.a(paramJSONObject, "image2");
      this.image1 = TroopBarUtils.a(paramJSONObject, "image1");
      this.channel = TroopBarUtils.a(paramJSONObject, "channel");
    }
  }
