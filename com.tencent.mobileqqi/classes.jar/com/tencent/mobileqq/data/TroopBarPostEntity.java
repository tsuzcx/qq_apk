  ...
  extends TroopBarAbsDataEntity
{
  ...
  public TroopBarPostEntity(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      this.id = TroopBarUtils.a(paramJSONObject, "pid");
      ...
      this.zan = TroopBarUtils.a(paramJSONObject, "zan");
      this.likes = TroopBarUtils.a(paramJSONObject, "likes");
      this.best = TroopBarUtils.a(paramJSONObject, "best");
      this.subscribers = TroopBarUtils.a(paramJSONObject, "subscribers");
      this.bid = TroopBarUtils.a(paramJSONObject, "bid");
      this.layout = TroopBarUtils.a(paramJSONObject, "layout");
      this.gid = TroopBarUtils.a(paramJSONObject, "gid");
      try
      {
  ...
  public TroopBarPostContentEntity getContentEntity()
  {
    ...
    //   4: ifnull +116 -> 120
    //   7: new 183	java/io/ByteArrayInputStream
    //   10: dup
    //   11: aload_0
    //   12: getfield 96	com/tencent/mobileqq/data/TroopBarPostEntity:contentBytes	[B
    //   15: invokespecial 186	java/io/ByteArrayInputStream:<init>	([B)V
    //   18: astore 4
    //   20: new 188	java/io/ObjectInputStream
    //   23: dup
    //   24: aload 4
    //   26: invokespecial 191	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   29: astore 5
    //   31: aload 5
    //   33: invokevirtual 195	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   36: astore_1
    //   37: aload_1
    //   38: instanceof 81
    //   41: ifeq +74 -> 115
    ...
    //   52: astore_3
    //   53: aload 4
    //   55: invokevirtual 198	java/io/ByteArrayInputStream:close	()V
    //   58: aload_1
    //   59: astore_2
    //   60: aload_1
    //   61: astore_3
    //   62: aload 5
    //   64: invokevirtual 199	java/io/ObjectInputStream:close	()V
    //   67: aload_1
    //   68: areturn
    //   69: astore 4
    //   71: aconst_null
    ...
    //   76: astore_3
    //   77: aload 4
    //   79: invokevirtual 202	java/lang/ClassNotFoundException:printStackTrace	()V
    //   82: aload_1
    //   83: areturn
    //   84: astore_1
    //   85: aload_1
    //   86: invokevirtual 203	java/io/StreamCorruptedException:printStackTrace	()V
    //   89: aload_2
    //   90: areturn
    //   91: astore_1
    //   92: aconst_null
  ...
  public ArrayList getIconListEntitys()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 164	com/tencent/mobileqq/data/TroopBarPostEntity:iconListBytes	[B
    //   4: ifnull +116 -> 120
    //   7: new 183	java/io/ByteArrayInputStream
    //   10: dup
    //   11: aload_0
    //   12: getfield 164	com/tencent/mobileqq/data/TroopBarPostEntity:iconListBytes	[B
    //   15: invokespecial 186	java/io/ByteArrayInputStream:<init>	([B)V
    //   18: astore 4
    //   20: new 188	java/io/ObjectInputStream
    //   23: dup
    ...
    //   41: ifeq +74 -> 115
    //   44: aload_1
    //   45: checkcast 145	java/util/ArrayList
    //   48: astore_1
    //   49: aload_1
    //   50: astore_2
    //   51: aload_1
  ...
  public TroopBarPostEntity.TroopBarPostAddress getPostAddress()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 171	com/tencent/mobileqq/data/TroopBarPostEntity:addrBytes	[B
    //   4: ifnull +116 -> 120
    //   7: new 183	java/io/ByteArrayInputStream
    //   10: dup
    //   11: aload_0
    //   12: getfield 171	com/tencent/mobileqq/data/TroopBarPostEntity:addrBytes	[B
    //   15: invokespecial 186	java/io/ByteArrayInputStream:<init>	([B)V
    //   18: astore 4
    //   20: new 188	java/io/ObjectInputStream
    //   23: dup
    ...
    //   41: ifeq +74 -> 115
    //   44: aload_1
    //   45: checkcast 166	com/tencent/mobileqq/data/TroopBarPostEntity$TroopBarPostAddress
    //   48: astore_1
    //   49: aload_1
    //   50: astore_2
    //   51: aload_1
  ...
  public TroopBarUserEntity getUsers()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 137	com/tencent/mobileqq/data/TroopBarPostEntity:userBytes	[B
    //   4: ifnull +116 -> 120
    //   7: new 183	java/io/ByteArrayInputStream
    //   10: dup
    //   11: aload_0
    //   12: getfield 137	com/tencent/mobileqq/data/TroopBarPostEntity:userBytes	[B
    //   15: invokespecial 186	java/io/ByteArrayInputStream:<init>	([B)V
    //   18: astore 4
    //   20: new 188	java/io/ObjectInputStream
    //   23: dup
    ...
    //   41: ifeq +74 -> 115
    //   44: aload_1
    //   45: checkcast 134	com/tencent/mobileqq/data/TroopBarUserEntity
    //   48: astore_1
    //   49: aload_1
    //   50: astore_2
    //   51: aload_1
