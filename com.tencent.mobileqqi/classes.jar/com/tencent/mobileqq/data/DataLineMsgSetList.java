  ...
  implements Iterable
{
  ...
  public boolean remove(DataLineMsgSet paramDataLineMsgSet)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 24	com/tencent/mobileqq/data/DataLineMsgSetList:mList	Ljava/util/ArrayList;
    ...
    //   30: aload 4
    //   32: aload_1
    //   33: invokevirtual 134	com/tencent/mobileqq/data/DataLineMsgSet:equals	(Ljava/lang/Object;)Z
    //   36: ifeq -26 -> 10
    //   39: aload_0
    //   40: getfield 24	com/tencent/mobileqq/data/DataLineMsgSetList:mList	Ljava/util/ArrayList;
    //   43: aload 4
    //   45: invokevirtual 136	java/util/ArrayList:remove	(Ljava/lang/Object;)Z
    //   48: istore_2
    //   49: aload_0
    //   50: invokespecial 130	com/tencent/mobileqq/data/DataLineMsgSetList:checkFirstLastIdByRemove	()V
    //   53: aload_0
    //   54: monitorexit
    //   55: iload_2
    //   56: ireturn
