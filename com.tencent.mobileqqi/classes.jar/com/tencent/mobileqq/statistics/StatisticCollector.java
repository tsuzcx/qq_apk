...
public class StatisticCollector
{
  ...
  public static final String C = "actC2CStreamPttUpload";
  public static final String D = "actC2CStreamPttDownload";
  public static final String E = "actC2CPttDownload";
  public static final String F = "actC2CPttUpload";
  public static final String G = "actGroupPicUploadV1";
  public static final String H = "actGroupPicDownloadV1";
  public static final String I = "actGroupPicSmallDownV1";
  public static final String J = "actGrpPttUp";
  public static final String K = "actGrpPttDown";
  public static final String L = "actDiscussPicUpload";
  public static final String M = "actDiscussPicDown";
  public static final String N = "actDiscussPicSmallDown";
  public static final String O = "actDisscusPttUp";
  public static final String P = "actDisscusPttDown";
  public static final String Q = "actSendDiscussProcess";
  public static final String R = "actSendDiscussPictureProcess";
  public static final String S = "dim.actSendDiscussionPttMsg";
  public static final String T = "actIntroPttUpload";
  public static final String U = "actIntroPttDownload";
  public static final String V = "dim.actSendWpaMsg";
  public static final String W = "actQzoneUnread";
  public static final String X = "actPluginUnread";
  public static final String Y = "actNearbyPeoplePicUpload";
  public static final String Z = "actFriendAvatarUpload";
  ...
  public static final String aa = "actSendCltMsg";
  public static final String ab = "dim.pttRecordInit";
  public static final String ac = "dim.pttRecordTime";
  public static final String ad = "actForegroundT";
  public static final String ae = "actMessageEvent";
  private static final String af = "Statistics_time";
  private static final String ag = "fg_duration";
  private static final String ah = "bg_duration";
  private static final String ai = "next_reportTime";
  private static final String aj = "End_Info";
  private static final String ak = "AndroidQQUseApp";
  private static final String al = "AndroidQQRunTime";
  private static final String am = "mqq_dailyUse";
  ...
  private gou[] jdField_a_of_type_ArrayOfGou = { new gou(this, "com.tencent.mtt", "qqBrowser"), new gou(this, "com.tencent.android.qqdownloader", "qqMarket"), new gou(this, "com.tencent.qqgame", "qqGame"), new gou(this, "com.tencent.qqmusic", "qqMusic"), new gou(this, "com.tencent.news", "qqNews"), new gou(this, "com.qq.reader", "qqReader"), new gou(this, "com.tencent.qqlive", "qqVideo"), new gou(this, "com.tencent.wblog", "qqMicroblog"), new gou(this, "com.tencent.qqphonebook", "qqPhonebook") };
  ...
  private String a(String paramString)
  {
    ...
    int i1 = 0;
    if (i1 < this.jdField_a_of_type_ArrayOfGou.length)
    {
      String str = this.jdField_a_of_type_ArrayOfGou[i1].a;
      if (!paramString.toLowerCase().contains(str)) {}
    }
    for (paramString = this.jdField_a_of_type_ArrayOfGou[i1].b;; paramString = null)
    {
      return paramString;
      i1 += 1;
      break;
  ...
  static void b(Context paramContext)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("BaseApplication", 2, "loadRQDClasses: " + Log.getStackTraceString(paramContext));
      }
      return;
    }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      return;
      paramString1 = new got(System.currentTimeMillis(), paramString1, paramString2);
      ...
      for (this.jdField_c_of_type_Int = (paramString1.a + i1); (this.jdField_c_of_type_Int > 15360L) && (this.jdField_a_of_type_JavaUtilLinkedList.size() > 1); this.jdField_c_of_type_Int -= paramString1.a) {
        paramString1 = (got)this.jdField_a_of_type_JavaUtilLinkedList.removeLast();
      }
    }
  }
    ...
    for (;;)
    {
      ...
      if (paramHashMap == null)
      {
        ...
        if ((paramHashMap.isRealTime == true) && (paramHashMap.isMerge == true) && (!paramHashMap.isSucceed)) {
          UserAction.onMergeUserAction(paramString2, paramBoolean1, paramLong1, paramLong2, true, new CountItem[0]);
        }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      return;
      localSharedPreferences = jdField_a_of_type_AndroidContentContext.getSharedPreferences("mobileQQi", 0);
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    ...
    do
    {
      ...
      localObject = jdField_a_of_type_AndroidContentContext.getSharedPreferences("mobileQQi", 0);
  ...
  public void b(String paramString)
  {
    ...
    CrashReport.initCrashReport(BaseApplication.getContext(), new gos(this), null, true, paramString, 30000L);
    ...
    for (;;)
    {
      ...
      {
        while (!QLog.isColorLevel()) {}
        QLog.e("StatisticCollector", 2, Log.getStackTraceString(paramString), paramString);
      }
    }
  }
  ...
  public void b(AppRuntime paramAppRuntime, String paramString)
  {
    ...
    {
      return;
      SharedPreferences localSharedPreferences = jdField_a_of_type_AndroidContentContext.getSharedPreferences("mobileQQi", 0);
  ...
  public void e(String paramString)
  {
    ...
    jdField_a_of_type_AndroidContentContext.getSharedPreferences("mobileQQi", 0).edit().putLong("Statistics_time_" + paramString, System.currentTimeMillis()).commit();
  }
