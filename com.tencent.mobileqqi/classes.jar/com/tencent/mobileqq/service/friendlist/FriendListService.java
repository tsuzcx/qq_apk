  ...
  extends BaseProtocolCoder
{
  ...
  private void a(int paramInt, byte paramByte1, long paramLong, short paramShort1, short paramShort2, byte paramByte2, byte paramByte3, byte paramByte4, byte paramByte5, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        paramUniPacket.put("FL", new GetFriendListReq(paramInt, paramByte1, paramLong, paramShort1, paramShort2, paramByte2, paramByte3, paramByte4, paramByte5, (byte)0, (byte)1, 3L, null));
        return;
      }
    }
  }
  ...
  private boolean c(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg = new GetSimpleOnlineFriendInfoReq(l, (byte)0, (byte)0, null, paramToServiceMsg.extraData.getByte("ifShowTermType"), 4L, paramToServiceMsg.extraData.getByte("srcType"));
    paramUniPacket.setServantName("mqq.IMService.FriendListServiceServantObj");
  ...
  private boolean d(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (l == 0L) {}
    for (paramToServiceMsg = new GetOnlineInfoReq(l, paramToServiceMsg.extraData.getLong("dwUin"), null, 4L);; paramToServiceMsg = new GetOnlineInfoReq(l, 0L, paramToServiceMsg.extraData.getString("strMobile"), 4L))
    {
      paramUniPacket.setServantName("mqq.IMService.FriendListServiceServantObj");
  ...
  {
    paramFromServiceMsg = (AddFriendResp)a(paramFromServiceMsg.getWupBuffer(), "AFRESP", new AddFriendResp());
    paramToServiceMsg = paramFromServiceMsg;
    if (paramFromServiceMsg == null) {
      paramToServiceMsg = null;
    }
  ...
  private boolean g(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    long l2 = a(localBundle.getString("uin"));
    int i = localBundle.getInt("source_id", 10004);
    if ((i != 3006) && (i != 3009) && (i != 3014) && (l2 == 0L)) {
      return false;
    }
    ...
    int k = localBundle.getInt("friend_setting");
    boolean bool = localBundle.getBoolean("allow_added");
    byte b3 = localBundle.getByte("group_id");
    Object localObject = localBundle.getString("msg");
    byte b4 = localBundle.getByte("auto_send");
    byte[] arrayOfByte = localBundle.getByteArray("sig");
    String str = localBundle.getString("troop_uin");
    byte b1;
    AddFriendReq localAddFriendReq;
    if ((localObject == null) || (((String)localObject).length() <= 0))
    {
      paramToServiceMsg = (ToServiceMsg)localObject;
      b1 = 0;
      localAddFriendReq = new AddFriendReq();
    ...
    for (byte b2 = 1;; b2 = 0)
    {
      localAddFriendReq.myAllowFlag = b2;
      localAddFriendReq.msgLen = b1;
      localAddFriendReq.sourceSubID = j;
      if (paramToServiceMsg != null) {
        localAddFriendReq.msg = paramToServiceMsg;
      }
      localAddFriendReq.myfriendgroupid = b3;
      localAddFriendReq.sourceID = i;
      paramToServiceMsg = localBundle.getString("friend_mobile_number");
      if (!TextUtils.isEmpty(paramToServiceMsg)) {
        localAddFriendReq.name = paramToServiceMsg.getBytes();
      }
      if ((3004 == i) && (str != null) && (str.length() > 0))
      {
        paramToServiceMsg = new FrdSysMsg.GroupInfo();
        paramToServiceMsg.uint64_group_uin.set(a(str));
        localAddFriendReq.friend_src_desc = paramToServiceMsg.toByteArray();
      }
  ...
  {
    paramFromServiceMsg = (GetUserAddFriendSettingResp)a(paramFromServiceMsg.getWupBuffer(), "FSRESP", new GetUserAddFriendSettingResp());
    paramToServiceMsg = paramFromServiceMsg;
    if (paramFromServiceMsg == null) {
      paramToServiceMsg = null;
    }
  ...
  private boolean k(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    do
    {
      return false;
      paramToServiceMsg = paramToServiceMsg.extraData;
      i = paramToServiceMsg.getInt("source_id");
      l2 = a(paramToServiceMsg.getString("uin"));
    } while ((i != 3006) && (i != 3009) && (i != 3014) && (l2 == 0L));
    paramToServiceMsg = paramToServiceMsg.getString("friend_mobile_number");
    GetUserAddFriendSettingReq localGetUserAddFriendSettingReq = new GetUserAddFriendSettingReq();
    localGetUserAddFriendSettingReq.version = 0L;
    localGetUserAddFriendSettingReq.uin = l1;
    localGetUserAddFriendSettingReq.queryuin = l2;
  ...
  private boolean m(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localGetFriendListReq.version = 4L;
  ...
  private boolean n(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (int i = 0;; i = 1)
    {
      paramToServiceMsg = new GetFriendListReq(3, (byte)i, Long.valueOf(paramToServiceMsg.getUin()).longValue(), s1, s2, (byte)0, (byte)i, b1, b2, (byte)0, b3, 4L, null);
      paramUniPacket.setServantName("mqq.IMService.FriendListServiceServantObj");
      paramUniPacket.setFuncName("GetFriendListReq");
  ...
  private boolean p(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localGetAutoInfoReq.dwFriendUin = a(paramToServiceMsg.extraData.getString("friendUin"));
  ...
  private boolean q(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    //   13: new 648	friendlist/SetGroupReq
    //   16: dup
    //   17: invokespecial 649	friendlist/SetGroupReq:<init>	()V
    //   20: astore 4
    //   22: aload 4
    //   24: aload_1
    ...
    //   31: putfield 650	friendlist/SetGroupReq:uin	J
    //   34: aload 4
    //   36: aload_1
    ...
    //   46: putfield 653	friendlist/SetGroupReq:reqtype	I
    //   49: new 488	java/io/ByteArrayOutputStream
    //   52: dup
    //   53: bipush 10
    //   55: invokespecial 491	java/io/ByteArrayOutputStream:<init>	(I)V
    //   58: astore 5
    //   60: new 493	java/io/DataOutputStream
    //   63: dup
    //   64: aload 5
    //   66: invokespecial 496	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   69: astore 6
    //   71: aload 4
    //   73: getfield 653	friendlist/SetGroupReq:reqtype	I
    //   76: tableswitch	default:+371 -> 447, 0:+32->108, 1:+140->216, 2:+225->301, 3:+262->338
    //   109: iconst_m1
    //   110: d2l
    //   111: dup
    //   112: invokespecial 656	friendlist/AddGroup:<init>	()V
    //   115: astore 7
    //   117: aload 7
    //   119: aload_1
    ...
    //   129: putfield 661	friendlist/AddGroup:cSortId	B
    //   132: aload 7
    //   134: aload_1
    ...
    //   144: putfield 666	friendlist/AddGroup:sGroupName	Ljava/lang/String;
    //   147: aload 7
    //   149: getfield 666	friendlist/AddGroup:sGroupName	Ljava/lang/String;
    //   152: invokevirtual 378	java/lang/String:getBytes	()[B
    //   155: astore_1
    //   156: aload 7
    //   158: aload_1
    //   159: arraylength
    //   160: i2b
    //   161: putfield 669	friendlist/AddGroup:cLen	B
    //   164: aload 6
    //   166: aload 7
    //   168: getfield 661	friendlist/AddGroup:cSortId	B
    //   171: invokevirtual 499	java/io/DataOutputStream:writeByte	(I)V
    //   174: aload 6
    //   176: aload 7
    //   178: getfield 669	friendlist/AddGroup:cLen	B
    //   181: invokevirtual 499	java/io/DataOutputStream:writeByte	(I)V
    //   184: aload 6
    //   186: aload_1
    //   187: invokevirtual 672	java/io/DataOutputStream:write	([B)V
    //   190: aload 6
    //   192: invokevirtual 508	java/io/DataOutputStream:close	()V
    //   195: aload 4
    //   197: aload 5
    //   199: invokevirtual 509	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   202: putfield 673	friendlist/SetGroupReq:vecBody	[B
    //   205: aload_2
    //   206: ldc_w 646
    //   209: aload 4
    ...
    //   214: iconst_1
    //   215: ireturn
    //   216: new 675	friendlist/RenameGroup
    //   219: dup
    //   220: invokespecial 676	friendlist/RenameGroup:<init>	()V
    //   223: astore 7
    //   225: aload 7
    //   227: aload_1
    ...
    //   237: putfield 679	friendlist/RenameGroup:cGroupId	B
    //   240: aload 7
    //   242: aload_1
    ...
    //   252: putfield 680	friendlist/RenameGroup:sGroupName	Ljava/lang/String;
    //   255: aload 7
    //   257: getfield 680	friendlist/RenameGroup:sGroupName	Ljava/lang/String;
    //   260: invokevirtual 378	java/lang/String:getBytes	()[B
    //   263: astore_1
    //   264: aload 7
    //   266: aload_1
    //   267: arraylength
    //   268: i2b
    //   269: putfield 681	friendlist/RenameGroup:cLen	B
    //   272: aload 6
    //   274: aload 7
    //   276: getfield 679	friendlist/RenameGroup:cGroupId	B
    //   279: invokevirtual 683	java/io/DataOutputStream:write	(I)V
    //   282: aload 6
    //   284: aload 7
    //   286: getfield 681	friendlist/RenameGroup:cLen	B
    //   289: invokevirtual 499	java/io/DataOutputStream:writeByte	(I)V
    //   292: aload 6
    //   294: aload_1
    //   295: invokevirtual 672	java/io/DataOutputStream:write	([B)V
    //   298: goto -108 -> 190
    //   301: new 685	friendlist/DelGroup
    //   304: dup
    //   305: invokespecial 686	friendlist/DelGroup:<init>	()V
    //   308: astore 7
    //   310: aload 7
    //   312: aload_1
    ...
    //   322: putfield 687	friendlist/DelGroup:cGroupId	B
    //   325: aload 6
    //   327: aload 7
    //   329: getfield 687	friendlist/DelGroup:cGroupId	B
    //   332: invokevirtual 499	java/io/DataOutputStream:writeByte	(I)V
    //   335: goto -145 -> 190
    //   338: new 689	friendlist/ReSortGroup
    //   341: dup
    //   342: invokespecial 690	friendlist/ReSortGroup:<init>	()V
    //   345: astore 7
    //   347: aload 7
    //   349: aload_1
    ...
    //   359: putfield 694	friendlist/ReSortGroup:cGroupId	[B
    //   362: aload 7
    //   364: aload_1
    ...
    //   374: putfield 698	friendlist/ReSortGroup:cSortId	[B
    //   377: aload 7
    //   379: aload 7
    //   381: getfield 694	friendlist/ReSortGroup:cGroupId	[B
    //   384: arraylength
    //   385: i2b
    //   386: putfield 701	friendlist/ReSortGroup:cNum	B
    //   389: aload 6
    //   391: aload 7
    //   393: getfield 701	friendlist/ReSortGroup:cNum	B
    //   396: invokevirtual 499	java/io/DataOutputStream:writeByte	(I)V
    //   399: aload 7
    //   401: getfield 694	friendlist/ReSortGroup:cGroupId	[B
    //   404: astore_1
    //   405: aload 7
    //   407: getfield 698	friendlist/ReSortGroup:cSortId	[B
    //   410: astore 7
    //   412: iconst_0
    //   413: istore_3
    //   414: iload_3
    ...
    //   423: iload_3
    //   424: baload
    //   425: invokevirtual 499	java/io/DataOutputStream:writeByte	(I)V
    //   428: aload 6
    //   430: aload 7
    //   432: iload_3
    //   433: baload
    //   434: invokevirtual 499	java/io/DataOutputStream:writeByte	(I)V
    //   437: iload_3
    //   438: iconst_1
    //   439: iadd
    //   440: istore_3
