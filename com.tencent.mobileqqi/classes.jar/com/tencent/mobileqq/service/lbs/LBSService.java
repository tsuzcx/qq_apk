  ...
  extends BaseProtocolCoder
{
  ...
  private boolean u(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localObject3 = new SSummaryCardQueryReq(1, Long.parseLong(paramToServiceMsg.getUin()), l2, "6.0.3", n, 109L);
      ...
      try
      {
        ...
        if ((l2 > 0L) || (n == 37))
        {
          ...
          if (j < tmp370_366.length)
          {
            ...
            ((SummaryCardBusiEntry.comm)localObject7).qqver.set("6.0.3.6604");
