...
public class MessageFactoryReceiver
{
  ...
  {
    return (FileUploadResp)a(paramFromServiceMsg.getWupBuffer(), "FileUploadResp", new FileUploadResp());
  }
  
  private Object B(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    return (FileDownloadResp)a(paramFromServiceMsg.getWupBuffer(), "FileDownloadResp", new FileDownloadResp());
  }
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if ("TransService.FileUploadReq".equals(str)) {
      return A(paramToServiceMsg, paramFromServiceMsg);
    }
    if ("TransService.FileDownloadReq".equals(str)) {
      return B(paramToServiceMsg, paramFromServiceMsg);
    }
