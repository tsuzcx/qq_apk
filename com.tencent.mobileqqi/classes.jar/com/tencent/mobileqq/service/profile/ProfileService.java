  ...
  extends BaseProtocolCoder
{
  ...
  public ProfileService(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_JavaUtilHashMap.put("StatSvc.register", Integer.valueOf(16));
  ...
  private boolean B(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localGroupMngReq.wSourceSubID = 0;
    if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
      if (!TroopFileUtils.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, l2)) {
        break label207;
      }
    }
    ByteBuffer localByteBuffer;
    label207:
    for (localGroupMngReq.wSourceID = 3003;; localGroupMngReq.wSourceID = 3008)
    {
      ...
      localByteBuffer = ByteBuffer.allocate(((ArrayList)localObject).size() * 4 + 10 + 1 + paramToServiceMsg.getBytes().length);
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, ArrayList paramArrayList, UniPacket paramUniPacket)
  {
    ...
    for (int i2 = 1;; i2 = 0)
    {
      paramUniPacket.put("req", new ProfUsrQryReq(0, "", paramArrayList, 1, 1, (byte)0, i1, i2));
      return true;
      i1 = 0;
      break;
    }
  ...
  private boolean j(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    int i1 = paramToServiceMsg.extraData.getInt("status");
    long l1 = a(str);
    if (l1 == 0L)
    {
      b(paramToServiceMsg);
    ...
    if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) && (!"0".equals(this.jdField_a_of_type_ComTencentCommonAppAppInterface.a())))
    {
      paramToServiceMsg = new SvcReqRegister();
      paramToServiceMsg.lUin = l1;
      paramToServiceMsg.lBid = 1L;
      if (i1 == 0) {
        paramToServiceMsg.lBid = 0L;
      }
      paramToServiceMsg.cConnType = 0;
      paramToServiceMsg.iStatus = i1;
      paramToServiceMsg.timeStamp = this.jdField_a_of_type_ComTencentCommonAppAppInterface.getPreferences().getLong(Constants.Key.SvcRegister_timeStamp.toString(), 0L);
      paramToServiceMsg.vecGuid = NetConnInfoCenter.GUID;
      if (QLog.isColorLevel()) {
        QLog.d("Q.contacts.", 2, " handlerSvcReqRegister " + i1 + ", " + paramToServiceMsg.timeStamp);
      }
      paramUniPacket.setServantName("StatSvc");
      paramUniPacket.setFuncName("SvcReqRegister");
      paramUniPacket.put("SvcReqRegister", paramToServiceMsg);
    }
    return true;
  }
  ...
  private boolean t(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    CircleManager localCircleManager = (CircleManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(33);
    ...
    if (i1 < i3)
    {
      ...
      if (localObject != null) {}
      for (long l1 = ((Friends)localObject).richTime;; l1 = 0L)
      {
        paramToServiceMsg.add(new ReqRichInfo(l2, l1));
        break;
      }
    ...
    {
      paramToServiceMsg = new GetRichSigReq(paramToServiceMsg, bool);
      paramUniPacket.setServantName("KQQ.ProfileService.ProfileServantObj");
