  ...
  implements IHttpCommunicatorListener
{
  ...
  private gnq jdField_a_of_type_Gnq;
  ...
  private void a()
  {
    ...
    if (this.jdField_a_of_type_Gnq != null)
    {
      this.jdField_a_of_type_Gnq.cancel();
      this.jdField_a_of_type_Gnq = null;
    }
    this.jdField_a_of_type_Gnq = new gnq(this, null);
    this.jdField_a_of_type_JavaUtilTimer.schedule(this.jdField_a_of_type_Gnq, jdField_a_of_type_Long);
