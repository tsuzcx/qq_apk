      ...
      else
      {
        for (paramFromServiceMsg = paramIntent.getStringExtra("k_uin");; paramFromServiceMsg = null)
        {
          if (paramFromServiceMsg != null)
          {
            ...
            localEditor.putString(ChatActivityFacade.b(paramFromServiceMsg), String.valueOf(l));
            ...
            localEditor.putString(ChatActivityFacade.c(paramFromServiceMsg), (String)localObject1);
            localEditor.commit();
            if (!QLog.isColorLevel()) {
              break label702;
            }
