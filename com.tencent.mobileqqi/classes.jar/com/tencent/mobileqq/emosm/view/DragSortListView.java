  ...
  extends ListView
{
  ...
  private DragSortListView.DragScrollProfile mScrollProfile = new DragSortListView.1(this);
  int mSecondExpPos;
  ...
  public DragSortListView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    {
      paramContext = getContext().obtainStyledAttributes(paramAttributeSet, R.styleable.t, 0, 0);
  ...
  public ShaderAnimLayout getDelButton(int paramInt)
  {
    ...
    if ((paramInt >= 0) && (paramInt <= getChildCount()))
    {
      View localView = getChildAt(paramInt);
      if (localView != null) {
        return (ShaderAnimLayout)localView.findViewById(2131230987);
      }
    }
    return null;
  }
