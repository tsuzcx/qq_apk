  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.scrollDir == 0)
    {
      ...
      this.mScrollSpeed = DragSortListView.access$600(this.this$0).getSpeed((this.this$0.mUpScrollStartYF - i2) / this.this$0.mDragUpScrollHeight, this.mPrevTime);
    ...
    for (;;)
    {
      ...
      DragSortListView.access$702(this.this$0, true);
      this.this$0.setSelectionFromTop(i, j - k);
      this.this$0.layoutChildren();
      this.this$0.invalidate();
      DragSortListView.access$702(this.this$0, false);
      DragSortListView.access$800(this.this$0, i, localView, false);
      ...
      this.mScrollSpeed = (-DragSortListView.access$600(this.this$0).getSpeed((i1 - this.this$0.mDownScrollStartYF) / this.this$0.mDragDownScrollHeight, this.mPrevTime));
      break;
      label470:
