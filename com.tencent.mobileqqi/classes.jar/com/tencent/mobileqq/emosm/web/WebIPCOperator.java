...
public class WebIPCOperator
{
  ...
  private void dispatchResp(Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
  ...
  private void setRespFailCode(Bundle paramBundle, int paramInt)
  {
    if (paramBundle != null) {
  ...
  public void onRespFromClient(Bundle paramBundle)
  {
    ...
    } while ((localObject == null) || ((!((String)localObject).equals("startDownloadEmoji")) && (!((String)localObject).equals("addThemeSpecific")) && (!((String)localObject).equals("startDownloadTheme")) && (!((String)localObject).equals("pausedownload")) && (!((String)localObject).equals("stopdownload")) && (!((String)localObject).equals("qwalletOpenInit")) && (!((String)localObject).equals("qwalletOpenLogin")) && (!((String)localObject).equals("openEquipmentLock")) && (!((String)localObject).equals("closeWeb")) && (!((String)localObject).equals("setMobileResult")) && (!((String)localObject).equals("setWaitingResponse")) && (!((String)localObject).equals("getA2"))));
    setRespFailCode(paramBundle, 1000);
