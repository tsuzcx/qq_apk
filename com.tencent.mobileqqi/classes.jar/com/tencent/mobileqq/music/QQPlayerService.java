  ...
  implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, Constants.PlayMode, Constants.PlayState
{
  ...
  private IQQPlayerService.Stub jdField_a_of_type_ComTencentMobileqqMusicIQQPlayerService$Stub = new gct(this);
  public gcu a;
  private gcv jdField_a_of_type_Gcv;
  private volatile gcw jdField_a_of_type_Gcw;
  ...
  public QQPlayerService()
  {
    ...
    this.jdField_a_of_type_Gcu = null;
  ...
  private void a(SongInfo paramSongInfo)
  {
    ...
    if ((jdField_b_of_type_JavaLangRefWeakReference != null) && (jdField_b_of_type_JavaLangRefWeakReference.get() != null))
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new gcq(this, localQQPlayerCallback, paramSongInfo));
    }
    for (;;)
    {
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_Gcw = new gcw(this, this.jdField_a_of_type_AndroidOsLooper);
  }
  ...
  private void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ((jdField_b_of_type_JavaLangRefWeakReference != null) && (jdField_b_of_type_JavaLangRefWeakReference.get() != null))
      {
        ...
        if (Thread.currentThread() != Looper.getMainLooper().getThread())
        {
          ...
          this.jdField_a_of_type_AndroidOsHandler.post(new gcr(this, localQQPlayerCallback, paramInt));
          if (this.jdField_a_of_type_AndroidOsRemoteCallbackList == null) {
            break label399;
          }
          int i2 = this.jdField_a_of_type_AndroidOsRemoteCallbackList.beginBroadcast();
    ...
    if (t == 5)
    {
      ...
      this.jdField_a_of_type_Gcw.postDelayed(new gcs(this), 4000L);
    }
  }
  ...
  private void b(Intent paramIntent)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_c_of_type_Boolean = false;
      if ((this.jdField_a_of_type_Gcu != null) && (this.jdField_a_of_type_Gcu.isAlive()) && (!this.jdField_a_of_type_Gcu.jdField_a_of_type_Boolean)) {
        this.jdField_a_of_type_Gcu.jdField_a_of_type_Boolean = true;
      }
      b(4);
      ...
      try
      {
        paramIntent = this.jdField_a_of_type_Gcu;
  ...
  private void b(String paramString)
  {
        ...
        try
        {
          ...
          if (b())
          {
            ...
            if ((this.jdField_a_of_type_Gcu != null) && (this.jdField_a_of_type_Gcu.isAlive()) && (!this.jdField_a_of_type_Gcu.jdField_a_of_type_Boolean))
            {
              ...
              if (paramString.equals(this.jdField_a_of_type_Gcu.jdField_a_of_type_JavaLangString))
              {
                if (QLog.isColorLevel()) {
                  QLog.d("QQPlayerService", 2, "mediaPlayStart: download url equals nextUrl,so no need play and return.");
                }
                this.jdField_a_of_type_Gcu.d = false;
                return;
              }
            }
          }
        ...
        catch (Exception paramString)
        {
          ...
          if ((((File)localObject2).exists()) && (((File)localObject2).length() > 0L))
          {
            ...
            else
            {
              ...
              this.jdField_a_of_type_Gcu = new gcu(this, paramString, (String)localObject1, arrayOfInt[0], arrayOfInt[1]);
              this.jdField_a_of_type_Gcu.d = false;
              this.jdField_a_of_type_Gcu.start();
            }
          }
          else
          {
            ...
            this.jdField_a_of_type_Gcu = new gcu(this, paramString, (String)localObject1, 0, 0);
            this.jdField_a_of_type_Gcu.d = false;
            this.jdField_a_of_type_Gcu.start();
            return;
          }
    ...
    } while ((this.jdField_a_of_type_Gcu == null) || (!this.jdField_a_of_type_Gcu.isAlive()) || (this.jdField_a_of_type_Gcu.jdField_a_of_type_Boolean));
    if (QLog.isColorLevel()) {
    ...
    if ((this.jdField_a_of_type_Gcu != null) && (this.jdField_a_of_type_Gcu.isAlive()) && (!this.jdField_a_of_type_Gcu.jdField_a_of_type_Boolean))
    {
      if ((paramString != null) && (paramString.equals(this.jdField_a_of_type_Gcu.jdField_a_of_type_JavaLangString)))
      {
        if (QLog.isColorLevel()) {
          QLog.d("QQPlayerService", 2, "mediaPlayStart:cache not complete,the download url is equals current url,need play!");
        }
        this.jdField_a_of_type_Gcu.d = true;
        return;
      }
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Gcu = new gcu(this, paramString, (String)localObject2, arrayOfInt[0], arrayOfInt[1]);
    this.jdField_a_of_type_Gcu.start();
    return;
    label1167:
    if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Gcu = new gcu(this, paramString, (String)localObject2, 0, 0);
    this.jdField_a_of_type_Gcu.start();
  }
  ...
  public void a()
  {
    ...
    Message localMessage = this.jdField_a_of_type_Gcw.obtainMessage();
    Intent localIntent = new Intent();
    localIntent.putExtra("musicplayer.action", 4);
    localMessage.obj = localIntent;
    this.jdField_a_of_type_Gcw.sendMessageDelayed(localMessage, this.jdField_c_of_type_Long);
  }
  ...
  public void onCreate()
  {
    ...
    if (VersionUtils.b()) {
      this.jdField_a_of_type_JavaLangObject = new gcp(this);
    }
    b();
    c();
    this.jdField_a_of_type_Gcv = new gcv(this);
    IntentFilter localIntentFilter = new IntentFilter();
    localIntentFilter.addAction("com.tencent.mobileqq.intent.logout");
    localIntentFilter.addAction("qqplayer_exit_action");
    registerReceiver(this.jdField_a_of_type_Gcv, localIntentFilter);
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Gcw = null;
    f = null;
    x = 0;
    v = 0;
    jdField_a_of_type_ComTencentMobileqqMusicSongInfo = null;
    ...
    for (;;)
    {
      unregisterReceiver(this.jdField_a_of_type_Gcv);
      g();
      return;
      if (QLog.isColorLevel()) {
  ...
  public void onPrepared(MediaPlayer paramMediaPlayer)
  {
    ...
    if ((this.jdField_a_of_type_Gcu != null) && (this.jdField_a_of_type_Gcu.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Gcu.jdField_a_of_type_JavaLangString.equals(jdField_a_of_type_ComTencentMobileqqMusicSongInfo.jdField_a_of_type_JavaLangString)))
    {
      if (x != 0) {
  ...
  public int onStartCommand(Intent paramIntent, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      label61:
      b();
      this.jdField_a_of_type_Gcw.sendMessage(localMessage);
      return 2;
    }
    catch (Throwable paramIntent)
    {
