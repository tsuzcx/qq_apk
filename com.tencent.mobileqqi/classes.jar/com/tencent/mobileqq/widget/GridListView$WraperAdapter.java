  ...
  extends BaseAdapter
{
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new hgr(null));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      hgr localhgr = (hgr)paramView.getTag();
      ...
      paramViewGroup = localhgr.a[paramInt];
      int k = this.a.jdField_a_of_type_ComTencentMobileqqWidgetGridListView$GridListAdapter.b(j + paramInt);
      if ((paramViewGroup != null) && (((Integer)paramViewGroup.getTag(2131231001)).intValue() != k)) {
        paramViewGroup = null;
      }
      for (;;)
      {
        ...
        localView.setTag(2131231001, Integer.valueOf(k));
        localhgr.a[paramInt] = localView;
        ...
        {
          localView.setTag(2131233144, Integer.valueOf(j + paramInt));
        ...
        {
          localObject = paramView;
          if (((Integer)paramView.getTag(2131231001)).intValue() != i) {
            localObject = null;
          }
        }
        ...
        paramView.setTag(2131231001, Integer.valueOf(i));
        ...
        {
          paramView.setTag(2131233144, Integer.valueOf(paramInt));
