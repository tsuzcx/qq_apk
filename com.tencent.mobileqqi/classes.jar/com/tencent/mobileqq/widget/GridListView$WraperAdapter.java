  ...
  extends BaseAdapter
{
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new hgs(null));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      hgs localhgs = (hgs)paramView.getTag();
      ...
      paramViewGroup = localhgs.a[paramInt];
      ...
      for (;;)
      {
        ...
        {
          localView.setTag(2131233145, Integer.valueOf(j + paramInt));
        ...
        {
          paramView.setTag(2131233145, Integer.valueOf(paramInt));
