  ...
  extends BaseAdapter
{
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new hkw(null));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      hkw localhkw = (hkw)paramView.getTag();
      ...
      paramViewGroup = localhkw.a[paramInt];
      ...
      for (;;)
      {
        ...
        {
          localView.setTag(2131233143, Integer.valueOf(j + paramInt));
        ...
        {
          paramView.setTag(2131233143, Integer.valueOf(paramInt));
