  ...
  implements MotionViewSetter
{
  ...
  private GestureDetector.SimpleOnGestureListener jdField_a_of_type_AndroidViewGestureDetector$SimpleOnGestureListener = new hly(this);
  ...
  public SlideDetectListView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    super.setOnScrollListener(new hlz(this));
  ...
  public void d()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      View localView = this.jdField_a_of_type_AndroidViewView.findViewById(2131230987);
      if (localView != null) {
