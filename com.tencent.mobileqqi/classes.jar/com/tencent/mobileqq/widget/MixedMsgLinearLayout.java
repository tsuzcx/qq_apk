  ...
  extends LinearLayout
{
  ...
  private hld jdField_a_of_type_Hld = new hld(this);
  private hle jdField_a_of_type_Hle = new hle(this);
  ...
  private AnimationTextView a()
  {
    ...
    localAnimationTextView.setTextColor(getContext().getResources().getColorStateList(2131362077));
    localAnimationTextView.setLinkTextColor(getContext().getResources().getColorStateList(2131362076));
  ...
  public void a(List paramList)
  {
    ...
    while (i < localArrayList.size())
    {
      ...
      this.jdField_a_of_type_Hle.a((AnimationTextView)localObject1);
      i += 1;
    }
    j = paramList.size();
    i = 0;
    if (i < j)
    {
      ...
      {
        localObject2 = this.jdField_a_of_type_Hle.a();
      ...
      localObject1 = this.jdField_a_of_type_Hld.a();
    ...
    for (;;)
    {
      ...
      while (i < localArrayList.size())
      {
        ...
        if ((paramList instanceof ChatThumbView))
        {
          ...
          this.jdField_a_of_type_Hld.a((ChatThumbView)paramList);
        }
        i += 1;
      }
      return;
