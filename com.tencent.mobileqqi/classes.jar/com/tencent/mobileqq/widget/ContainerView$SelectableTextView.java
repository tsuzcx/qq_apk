  ...
  extends TextView
{
  ...
  public ContainerView$SelectableTextView(ContainerView paramContainerView, Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    setTextSelectHandle(2130840296);
    setTextSelectHandleLeft(2130840295);
    setTextSelectHandleRight(2130840297);
    setTextSize(28.0F);
    setTextColor(-16777216);
    setVisibility(4);
    if (Build.VERSION.SDK_INT >= 11) {
      setCustomSelectionActionModeCallback(new hkf(this, paramContainerView));
    }
  }
  ...
  public void setTextIsSelectable(boolean paramBoolean)
  {
    ...
    setOnLongClickListener(new hkg(this));
  }
