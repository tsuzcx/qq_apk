  ...
  extends Drawable
{
  ...
  public ImageProgressDrawable(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.g = paramContext.getColor(0, 2131361815);
    this.f = paramContext.getColor(1, 2131361825);
    this.jdField_e_of_type_Int = paramContext.getColor(2, 2131361824);
    this.h = paramContext.getColor(3, 2131361824);
