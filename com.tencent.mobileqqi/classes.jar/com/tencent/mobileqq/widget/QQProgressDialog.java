  ...
  extends Dialog
{
  ...
  public QQProgressDialog(Context paramContext, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903612, null);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131233078));
  ...
  {
    setOnKeyListener(new hlk(this, paramBoolean));
  }
  ...
  {
    this.b.postDelayed(new hlj(this), 50L);
    super.onStart();
  }
