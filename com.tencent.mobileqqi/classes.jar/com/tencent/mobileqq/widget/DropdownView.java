  ...
  implements PopupWindow.OnDismissListener
{
  ...
  public DropdownView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Hkt = new hkt(this, paramContext);
    a(paramContext);
  }
  ...
  public DropdownView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Hkt = new hkt(this, paramContext, paramAttributeSet);
    a(paramContext);
  }
  ...
  public DropdownView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Hkt = new hkt(this, paramContext, paramAttributeSet, paramInt);
    a(paramContext);
  }
  ...
  private void a(Context paramContext)
  {
    ...
    addView(this.jdField_a_of_type_Hkt, (ViewGroup.LayoutParams)localObject1);
    this.jdField_a_of_type_Hkt.setDropDownVerticalOffset(0);
    ...
    ((RelativeLayout.LayoutParams)localObject2).addRule(7, this.jdField_a_of_type_Hkt.getId());
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130837845);
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130838114);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130838115);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new hkq(this));
    try
    {
      paramContext = this.jdField_a_of_type_Hkt.getClass().getSuperclass().getDeclaredField("mPopup");
      paramContext.setAccessible(true);
      paramContext = paramContext.get(this.jdField_a_of_type_Hkt);
  ...
  {
    return this.jdField_a_of_type_Hkt;
  }
  ...
  {
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    new Handler().postDelayed(new hks(this), 500L);
  }
}
