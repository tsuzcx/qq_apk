  ...
  extends View
{
  ...
  private hls jdField_a_of_type_Hls;
  ...
  public RoundWaveView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.U, paramInt, 0);
  ...
  public void a()
  {
    ...
    b();
    this.jdField_a_of_type_Hls = new hls(this, 0.4F, 0.0F, this.jdField_b_of_type_Float, this.e, 1000L);
    ViewCompat.postOnAnimation(this, this.jdField_a_of_type_Hls);
  }
  
  public void b()
  {
    if (this.jdField_a_of_type_Hls != null)
    {
      this.jdField_a_of_type_Hls.a();
      this.jdField_a_of_type_Hls = null;
    }
  }
