  ...
  implements IHwManager, IConnectionListener
{
  ...
  {
    EndPoint localEndPoint1 = ConfigManager.getInstance(this.engine.getAppContext(), this.engine.app, this.engine.appId, this.engine.currentUin).getNextSrvAddr(this.engine.getAppContext(), this.engine.app, this.engine.currentUin);
    ...
    for (;;)
    {
      synchronized (this.connections)
      {
        ...
        if ((paramBoolean) || (localEndPoint1.protoType != 1)) {
          break label265;
        }
        ...
        {
          paramInt = 10000;
          ??? = new TcpConnection(this, i, localEndPoint1, paramInt, 30000);
          if (??? != null)
          {
      ...
      continue;
      label265:
      HttpConnection localHttpConnection = new HttpConnection(this, connSeq.incrementAndGet(), localEndPoint2);
      ??? = localHttpConnection;
      if (paramBoolean)
      {
  ...
  public void onConnect(boolean paramBoolean, int paramInt1, IConnection paramIConnection, EndPoint paramEndPoint, int paramInt2, ConnReportInfo paramConnReportInfo)
  {
    ...
    if (localContext != null) {
      localConfigManager = ConfigManager.getInstance(localContext, this.engine.app, this.engine.appId, this.engine.currentUin);
    }
    if (paramBoolean)
    {
    ...
    for (;;)
    {
      ...
      if (localConfigManager != null) {
        localConfigManager.onSrvAddrUnavailable(this.engine.getAppContext(), this.engine.app, this.engine.currentUin, paramEndPoint.host, paramInt2);
      }
      if (paramInt2 == 3) {
        this.engine.mRequestWorker.sendConnectRequest(5000L, false);
      } else {
