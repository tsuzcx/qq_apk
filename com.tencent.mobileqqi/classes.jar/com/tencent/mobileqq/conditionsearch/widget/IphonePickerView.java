  ...
  extends LinearLayout
{
  ...
  private AdapterView.OnItemSelectedListener jdField_a_of_type_ComTencentWidgetAdapterView$OnItemSelectedListener = new fqs(this);
  private VerticalGallery.OnSelectViewDataUpdateListener jdField_a_of_type_ComTencentWidgetVerticalGallery$OnSelectViewDataUpdateListener = new fqt(this);
  private WheelView[] jdField_a_of_type_ArrayOfComTencentMobileqqRemindWidgetWheelView;
  private fqv[] jdField_a_of_type_ArrayOfFqv;
  private int i = 0;
  ...
  private void a(WheelView paramWheelView, int paramInt)
  {
    ...
    paramWheelView.setAdapter(localfqv);
    ...
    paramWheelView.setOnEndMovementListener(new fqu(this, paramInt));
  }
  ...
  {
    if ((paramInt < 0) || (paramInt >= this.jdField_a_of_type_ArrayOfFqv.length)) {
      throw new IllegalArgumentException("Error column index " + paramInt);
    }
    this.jdField_a_of_type_ArrayOfFqv[paramInt].notifyDataSetChanged();
  }
  ...
  public void a(IphonePickerView.PickerViewAdapter paramPickerViewAdapter)
  {
    ...
    this.jdField_a_of_type_ArrayOfFqv = new fqv[this.i];
    paramPickerViewAdapter = (WheelView)findViewById(2131232970);
    WheelView localWheelView1 = (WheelView)findViewById(2131232971);
    WheelView localWheelView2 = (WheelView)findViewById(2131232972);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131232969));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131232968));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new fqr(this));
