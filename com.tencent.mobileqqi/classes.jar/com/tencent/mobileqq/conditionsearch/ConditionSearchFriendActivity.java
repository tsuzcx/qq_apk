  ...
  implements View.OnClickListener
{
  ...
  public int a;
  DialogInterface.OnDismissListener jdField_a_of_type_AndroidContentDialogInterface$OnDismissListener = new fpx(this);
  public Handler a;
  Button jdField_a_of_type_AndroidWidgetButton;
  EditText jdField_a_of_type_AndroidWidgetEditText;
  ConditionSearchManager.IConfigListener jdField_a_of_type_ComTencentMobileqqAppConditionSearchManager$IConfigListener = new fqa(this);
  ConditionSearchManager.ISearchListener jdField_a_of_type_ComTencentMobileqqAppConditionSearchManager$ISearchListener = new fpz(this);
  public ConditionSearchManager a;
  LBSObserver jdField_a_of_type_ComTencentMobileqqAppLBSObserver = new fps(this);
  IphonePickerView.IphonePickListener jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView$IphonePickListener = new fpw(this);
  IphonePickerView.PickerViewAdapter jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView$PickerViewAdapter = new fpv(this);
  ...
  public ConditionSearchFriendActivity()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new fpy(this);
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new fpr(this));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem = ((FormSimpleItem)findViewById(2131232911));
    this.jdField_b_of_type_ComTencentMobileqqWidgetFormSimpleItem = ((FormSimpleItem)findViewById(2131232912));
    this.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem = ((FormSimpleItem)findViewById(2131232913));
    this.jdField_d_of_type_ComTencentMobileqqWidgetFormSimpleItem = ((FormSimpleItem)findViewById(2131232914));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131232915));
  ...
  public void d()
  {
    ...
    {
      this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(new fpt(this));
      return;
    }
    this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(new fpu(this));
  }
