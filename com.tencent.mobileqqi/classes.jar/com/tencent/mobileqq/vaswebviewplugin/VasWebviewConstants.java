...
public class VasWebviewConstants
{
  ...
  static
  {
    ...
    localStringBuilder.append("http://imgcache.qq.com/club/themes/mobile/head_pendant/html/index.html").append("?client=androidQQ").append("&version=").append("6.0.3.6604").append("&system=").append(Build.VERSION.RELEASE).append("&device=").append(Build.DEVICE).append("&updateFlag=[updateFlag]").append("&_bid=160").append("&_wv=3");
    ...
    localStringBuilder.append("?client=androidQQ").append("&version=").append("6.0.3.6604").append("&system=").append(Build.VERSION.RELEASE).append("&device=").append(Build.DEVICE).append("&updateFlag=[updateFlag]").append("&_bid=182").append("&_wv=3");
