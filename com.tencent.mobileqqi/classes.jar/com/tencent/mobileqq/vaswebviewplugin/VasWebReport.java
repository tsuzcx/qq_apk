  ...
  extends WebViewPlugin
{
  ...
  protected boolean handleEvent(String paramString, int paramInt, Map paramMap)
  {
    ...
    do
    {
      ...
      {
        ReportController.a(null, "P_CliOper", "vasweb", "", "load", "finish", 0, 1, "errocode:" + this.erroMap.get(paramString), paramMap, paramString, "6.0.1--android--" + Build.VERSION.SDK_INT);
      ...
      {
        ReportController.a(null, "P_CliOper", "vasweb", "", "load", "finish", 0, 0, "" + l, paramMap, paramString, "6.0.1--android--" + Build.VERSION.SDK_INT);
        break;
        if (QLog.isColorLevel()) {
