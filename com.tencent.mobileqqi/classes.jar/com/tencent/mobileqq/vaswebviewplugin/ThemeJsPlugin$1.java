...
class ThemeJsPlugin$1
  implements Runnable
{
  ThemeJsPlugin$1(ThemeJsPlugin paramThemeJsPlugin, String paramString) {}
  
  public void run()
  {
    String str1 = ThemeJsPlugin.access$100(this.this$0).getSharedPreferences("userThemeSharedPreferences", 0).getString("userDownloadTheme", "");
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        int i = localJSONObject5.getInt("downsize");
        ...
        if (j > 0)
        {
          ...
          localObject = ThemeUtil.getThemeInfo(ThemeJsPlugin.access$100(this.this$0), str4);
          if (localObject == null) {
            break label550;
          }
          ...
          ThemeUtil.setThemeInfo(ThemeJsPlugin.access$100(this.this$0), (ThemeUtil.ThemeInfo)localObject);
          localObject = str1;
          if (str1.equals("5")) {
            localObject = "3";
          }
