...
{
  ThemeJsPlugin$4(ThemeJsPlugin paramThemeJsPlugin, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    try
    {
      ...
      String str = ThemeUtil.getThemeDownloadFilePath(ThemeJsPlugin.access$100(this.this$0), this.val$id, this.val$version);
      ...
      if (localObject == null)
      {
        localObject = ThemeUtil.getThemeInfo(ThemeJsPlugin.access$100(this.this$0), this.val$id);
        paramDialogInterface = (DialogInterface)localObject;
        if (localObject != null)
        {
