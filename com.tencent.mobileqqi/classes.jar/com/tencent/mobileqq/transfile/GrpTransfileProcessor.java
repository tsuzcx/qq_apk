  ...
  extends CommenTransFileProcessor
{
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (paramBoolean = bool;; paramBoolean = false)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.d, this.aj, this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.c, str);
        return;
  ...
  protected void r()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.d, this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.c);
    if (this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_e_of_type_Int == 1) {}
    for (;;)
    {
      a(true);
