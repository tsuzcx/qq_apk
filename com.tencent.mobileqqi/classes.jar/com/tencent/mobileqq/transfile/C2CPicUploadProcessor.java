  ...
  extends BaseUploadProcessor
{
  ...
  MessageObserver jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new gmy(this);
  ...
  private void u()
  {
    this.jdField_a_of_type_ComTencentMobileqqTransfileTransFileController.a.post(new gmv(this));
  }
  ...
  public void c()
  {
    ...
    do
    {
      ...
      gmw localgmw = new gmw(this, SystemClock.uptimeMillis());
      this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), 1, this.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.g, (int)this.jdField_g_of_type_Long, arrayOfByte, this.jdField_a_of_type_ArrayOfByte, localgmw);
  ...
  public int f()
  {
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_ComTencentWsttSSCMSSCM.a();
      v();
      this.jdField_a_of_type_ComTencentMobileqqTransfileTransFileController.a.post(new gmx(this));
    }
    return 0;
  }
