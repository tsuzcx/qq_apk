  ...
  extends BaseUploadProcessor
{
  ...
  public GroupPicUploadProcessor(TransFileController paramTransFileController, TransferRequest paramTransferRequest)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new grt(this);
  }
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      new grr(this, localPicReq).execute(new Void[0]);
      return;
      m = 0;
      break;
    }
  ...
  public int f()
  {
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTransfileTransFileController.a.post(new grs(this));
    }
    return 0;
  }
