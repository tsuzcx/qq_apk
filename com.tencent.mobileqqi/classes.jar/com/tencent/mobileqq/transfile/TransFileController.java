  ...
  implements INetEngine.INetEngineListener
{
  ...
  {
    this.jdField_a_of_type_Gsg = null;
    ...
    this.jdField_a_of_type_Gsg = new gsg(ThreadManager.b());
  }
    ...
    do
    {
      do
      {
          ...
          synchronized ((BaseDownloadProcessor)???)
          {
            ...
            if ((l == -1L) || (l == 2002L) || (l == 2001L))
            {
              ...
              if (paramTransferRequest.jdField_a_of_type_ComTencentMobileqqPicDownCallBack != null) {
                ((BaseDownloadProcessor)???).b.add(paramTransferRequest.jdField_a_of_type_ComTencentMobileqqPicDownCallBack);
              }
              if (paramBoolean) {
        ...
        if (paramTransferRequest.jdField_a_of_type_ComTencentMobileqqPicDownCallBack != null)
        {
          ...
          paramBaseTransProcessor.jdField_b_of_type_JavaLangString = paramTransferRequest.f;
  ...
  {
    return (paramIHttpCommunicatorListener != null) && (((paramIHttpCommunicatorListener instanceof C2CPicUploadProcessor)) || ((paramIHttpCommunicatorListener instanceof GroupPicUploadProcessor)));
  }
    ...
    do
    {
      ...
      else
      {
        if (paramTransferRequest.jdField_a_of_type_Boolean)
        {
          ...
          if (paramTransferRequest.jdField_b_of_type_Int == 22) {
  ...
  public BaseTransProcessor a(String paramString, long paramLong)
  {
    ...
    if ((paramString != null) && ((paramString instanceof BaseTransProcessor)))
    {
      ...
      if ((paramString.d) && (paramString.c)) {
        return paramString;
      }
    }
    return null;
  ...
  {
    ThreadManager.b(new gse(this, paramString, paramQQAppInterface));
  }
        ...
        if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
        {
          if (!this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.contains(str))
          {
            ...
            if ((paramTransferRequest != null) && (paramTransferRequest.e() == 0))
            {
              ...
              if (this.jdField_a_of_type_Gsg != null) {
                this.jdField_a_of_type_Gsg.a(paramTransferRequest);
              }
            }
            return;
          }
  ...
  public boolean a()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      localObject = (BaseTransProcessor)localObject;
      if ((!((BaseTransProcessor)localObject).d) || (((BaseTransProcessor)localObject).c)) {
        break label178;
      }
      ((BaseTransProcessor)localObject).i();
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("raw_photo", 2, "resumeLastRawSend keys size:" + this.jdField_a_of_type_JavaUtilArrayList.size());
    }
