...
public class SosoSrvAddrProvider
{
  ...
  gsd jdField_a_of_type_Gsd = new gsd(this);
  ...
  public String a(SosoSrvAddrProvider.SosoSrvAddrType paramSosoSrvAddrType)
  {
    ...
    try
    {
      FileStorageServerListInfo localFileStorageServerListInfo = this.jdField_a_of_type_Gsd.a(paramSosoSrvAddrType);
  ...
  public void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    try
    {
      ...
      this.jdField_a_of_type_Gsd.a(paramFileStoragePushFSSvcList);
      return;
    }
    finally
    {
  ...
  public void a(SosoSrvAddrProvider.SosoSrvAddrType paramSosoSrvAddrType, String paramString)
  {
    try
    {
      this.jdField_a_of_type_Gsd.a(paramSosoSrvAddrType, paramString);
      return;
    }
    finally
    {
