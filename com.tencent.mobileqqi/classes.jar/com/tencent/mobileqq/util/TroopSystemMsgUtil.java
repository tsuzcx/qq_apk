...
public class TroopSystemMsgUtil
{
  ...
  {
    long l = 0L;
    paramContext = paramContext.getSharedPreferences(String.valueOf(AppConstants.U), 0);
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    SharedPreferences localSharedPreferences = paramContext.getSharedPreferences(String.valueOf(AppConstants.U), 0);
