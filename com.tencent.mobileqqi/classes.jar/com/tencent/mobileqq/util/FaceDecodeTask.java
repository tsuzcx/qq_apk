...
public class FaceDecodeTask
{
  ...
  private static had[] jdField_a_of_type_ArrayOfHad;
  ...
  public static void a()
  {
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (jdField_a_of_type_ArrayOfHad != null)
        {
          i = 0;
          if (i < jdField_a_of_type_ArrayOfHad.length)
          {
            if (jdField_a_of_type_ArrayOfHad[i] == null) {
              break label107;
            }
            jdField_a_of_type_ArrayOfHad[i].a();
            break label107;
          }
        }
        synchronized (jdField_a_of_type_JavaUtilArrayList)
        {
          ...
          jdField_a_of_type_ArrayOfHad = null;
    ...
    if (jdField_a_of_type_ArrayOfHad == null) {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        if (jdField_a_of_type_ArrayOfHad == null)
        {
          ...
          jdField_a_of_type_AndroidOsHandler = new hac(jdField_a_of_type_AndroidOsLooper);
          jdField_a_of_type_JavaUtilArrayList = new ArrayList();
          jdField_a_of_type_ArrayOfHad = new had[f];
          int i = 0;
          while (i < jdField_a_of_type_ArrayOfHad.length)
          {
            jdField_a_of_type_ArrayOfHad[i] = new had(null);
            jdField_a_of_type_ArrayOfHad[i].start();
            i += 1;
          }
        }
        return;
  ...
  private static void c(FaceDecodeTask paramFaceDecodeTask)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!paramFaceDecodeTask.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(localFaceInfo.jdField_a_of_type_Int, localFaceInfo.jdField_a_of_type_JavaLangString)) {}
        ...
        label206:
        if ((localFaceInfo.jdField_a_of_type_Int != 101) && (localFaceInfo.jdField_a_of_type_Byte != 1))
        {
          Pair localPair = paramFaceDecodeTask.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(localFaceInfo.jdField_a_of_type_Int, localFaceInfo.jdField_a_of_type_JavaLangString);
        ...
        case 2: 
          for (;;)
          {
            paramFaceDecodeTask.jdField_a_of_type_AndroidGraphicsBitmap = paramFaceDecodeTask.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(localFaceInfo.jdField_a_of_type_Int, localFaceInfo.jdField_a_of_type_JavaLangString, (byte)localFaceInfo.jdField_b_of_type_Int, false, b1);
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e("Q.qqhead.FaceDecodeTask", 2, "doDecodeBitmap exception. uin=" + localFaceInfo.jdField_a_of_type_JavaLangString, localException);
        }
        try
        {
          jdField_a_of_type_AndroidOsHandler.sendMessage(jdField_a_of_type_AndroidOsHandler.obtainMessage(e, paramFaceDecodeTask));
