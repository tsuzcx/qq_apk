  ...
  implements FaceDecodeTask.DecodeCompletionListener
{
  ...
  private haf jdField_a_of_type_Haf;
  ...
  private void e()
  {
    ...
    do
    {
      ...
      catch (Throwable localThrowable1)
      {
        try
        {
          if ((localFaceInfo.jdField_a_of_type_Int == 101) && (this.jdField_a_of_type_Haf == null))
          {
            this.jdField_a_of_type_Haf = new haf(this, null);
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Haf);
          }
          this.b += 1;
  ...
  public void d()
  {
    ...
    c();
    if (this.jdField_a_of_type_Haf != null) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(this.jdField_a_of_type_Haf);
    }
    if (this.jdField_a_of_type_Hag != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(this.jdField_a_of_type_Hag);
      this.jdField_a_of_type_Hag = null;
    }
