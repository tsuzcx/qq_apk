  ...
  implements Manager
{
  ...
  private void b()
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localArrayList1.add(localPublicAccountInfo);
      }
      if (i <= 1) {
        break label128;
      }
  ...
  public List a(List paramList, long paramLong)
  {
    ...
    //   27: dup
    //   28: invokespecial 160	java/util/concurrent/ConcurrentHashMap:<init>	()V
    ...
    //   41: invokevirtual 163	com/tencent/mobileqq/persistence/EntityManager:a	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   44: astore 5
    //   46: aload 5
    //   48: astore 4
    //   50: aload 4
    //   52: invokevirtual 166	com/tencent/mobileqq/persistence/EntityTransaction:a	()V
    //   55: aload_1
    //   56: ifnull +77 -> 133
    //   59: aload_1
    //   60: invokeinterface 169 1 0
    //   65: ifle +68 -> 133
    //   68: aload_1
    ...
    //   95: aload_0
    //   96: aload 5
    //   98: invokevirtual 173	com/tencent/mobileqq/app/PublicAccountDataManager:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   101: pop
    //   102: aload_0
    ...
    //   106: aload 5
    //   108: invokevirtual 138	com/tencent/mobileqq/data/PublicAccountInfo:getUin	()Ljava/lang/String;
    //   111: aload 5
    //   113: invokevirtual 142	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   116: pop
    //   117: goto -42 -> 75
    //   120: astore_1
    //   121: aload 4
    //   123: invokevirtual 174	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   126: aload_0
    ...
    //   137: invokevirtual 148	java/util/concurrent/ConcurrentHashMap:entrySet	()Ljava/util/Set;
    ...
    //   161: checkcast 153	java/util/Map$Entry
    //   164: invokeinterface 156 1 0
    //   169: checkcast 88	com/tencent/mobileqq/data/PublicAccountInfo
    //   172: astore 5
    //   174: aload 5
    //   176: getfield 178	com/tencent/mobileqq/data/PublicAccountInfo:extendType	I
    //   179: iconst_2
    //   180: if_icmpne -34 -> 146
    //   183: aload 5
    //   185: getfield 182	com/tencent/mobileqq/data/PublicAccountInfo:dateTime	J
    //   188: lload_2
    //   189: lcmp
    //   190: ifge -44 -> 146
    //   193: aload_1
    //   194: invokeinterface 185 1 0
    //   199: aload_0
    ...
    //   203: aload 5
    //   205: invokevirtual 187	com/tencent/mobileqq/persistence/EntityManager:b	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   208: pop
    //   209: aload 6
    //   211: aload 5
    //   213: invokeinterface 188 2 0
    //   218: pop
    //   219: goto -73 -> 146
    //   222: astore_1
    //   223: aload 4
    //   225: invokevirtual 174	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   228: aload_1
    //   229: athrow
    //   230: aload 4
    //   232: invokevirtual 191	com/tencent/mobileqq/persistence/EntityTransaction:c	()V
    //   235: aload 4
    //   237: invokevirtual 174	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   240: goto -114 -> 126
    //   243: astore_1
    //   244: aconst_null
    //   245: astore 4
  ...
  public List a(List paramList, long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   23: dup
    //   24: iload 6
    //   26: invokespecial 193	java/util/concurrent/ConcurrentHashMap:<init>	(I)V
    ...
    //   48: invokevirtual 163	com/tencent/mobileqq/persistence/EntityManager:a	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   51: astore 8
    //   53: aload 8
    //   55: astore 7
    //   57: aload 7
    //   59: invokevirtual 166	com/tencent/mobileqq/persistence/EntityTransaction:a	()V
    //   62: aload_1
    //   63: ifnull +133 -> 196
    //   66: aload_1
    ...
    //   102: aload_0
    //   103: aload 8
    //   105: invokevirtual 173	com/tencent/mobileqq/app/PublicAccountDataManager:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   108: pop
    //   109: aload 8
    //   111: invokevirtual 196	com/tencent/mobileqq/data/PublicAccountInfo:isNeedShow	()Z
    //   114: ifeq +40 -> 154
    //   117: aload_0
    ...
    //   121: aload 8
    //   123: invokevirtual 138	com/tencent/mobileqq/data/PublicAccountInfo:getUin	()Ljava/lang/String;
    //   126: aload 8
    //   128: invokevirtual 142	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   131: pop
    //   132: goto -50 -> 82
    //   135: astore_1
    //   136: aload 7
    //   138: invokevirtual 174	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   141: aload_0
    ...
    //   158: aload 8
    //   160: invokevirtual 138	com/tencent/mobileqq/data/PublicAccountInfo:getUin	()Ljava/lang/String;
    //   163: invokevirtual 198	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   166: pop
    //   167: aload 8
    ...
    //   175: aload 9
    //   177: aload 8
    //   179: invokeinterface 188 2 0
    //   184: pop
    //   185: goto -103 -> 82
    //   188: astore_1
    //   189: aload 7
    //   191: invokevirtual 174	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   194: aload_1
    //   195: athrow
    //   196: iload 4
    //   198: ifne +96 -> 294
    ...
    //   210: invokevirtual 148	java/util/concurrent/ConcurrentHashMap:entrySet	()Ljava/util/Set;
    //   213: invokeinterface 151 1 0
    //   218: astore_1
    //   219: aload_1
    ...
    //   234: checkcast 153	java/util/Map$Entry
    //   237: invokeinterface 156 1 0
    //   242: checkcast 88	com/tencent/mobileqq/data/PublicAccountInfo
    //   245: astore 8
    //   247: aload 8
    //   249: getfield 178	com/tencent/mobileqq/data/PublicAccountInfo:extendType	I
    //   252: ifne -33 -> 219
    //   255: aload 8
    //   257: getfield 182	com/tencent/mobileqq/data/PublicAccountInfo:dateTime	J
    //   260: lload_2
    //   261: lcmp
    //   262: ifge -43 -> 219
    //   265: aload_1
    ...
    //   275: aload 8
    //   277: invokevirtual 187	com/tencent/mobileqq/persistence/EntityManager:b	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   280: pop
    //   281: aload 9
    //   283: aload 8
    //   285: invokeinterface 188 2 0
    //   290: pop
    //   291: goto -72 -> 219
    //   294: aload 7
    //   296: invokevirtual 191	com/tencent/mobileqq/persistence/EntityTransaction:c	()V
    //   299: aload 7
    //   301: invokevirtual 174	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   304: goto -163 -> 141
    //   307: astore_1
    //   308: aconst_null
    //   309: astore 7
