  ...
  extends BusinessHandler
{
  ...
  private void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((paramIntent != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()) && (paramArrayOfByte != null))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          localfex.jdField_a_of_type_Int = m;
          if (m == 0) {
            continue;
          }
        ...
        else
        {
          ...
          localfex.jdField_a_of_type_JavaUtilList = paramFromServiceMsg;
    ...
    for (;;)
    {
      localfex.jdField_a_of_type_Boolean = bool1;
      localfex.jdField_a_of_type_Long = l3;
      paramIntent = (PublicAccountDataManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
      a(paramFromServiceMsg, l1, bool2, localfex.jdField_a_of_type_Boolean);
      ...
      QLog.d(jdField_b_of_type_JavaLangString, 2, "<<---handleGetUserFollowList " + localfex.jdField_a_of_type_Int);
      bool1 = bool2;
      m = n;
      break;
      label646:
  ...
  public void a(Object paramObject)
  {
    ...
    localfew.jdField_a_of_type_Int = 0;
    long l = SystemClock.uptimeMillis();
    if ((paramObject instanceof AccountDetail)) {
      localfew.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo = PublicAccountInfo.createPublicAccount((AccountDetail)paramObject, l);
    }
    for (;;)
    {
      paramObject = (PublicAccountDataManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
      paramObject.a(localfew.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo);
      ...
      if ((paramObject instanceof EqqDetail)) {
        localfew.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo = PublicAccountInfo.createPublicAccount((EqqDetail)paramObject, l);
      }
    }
  }
  ...
  public void b(Object paramObject)
  {
    ...
    {
      paramObject = (PublicAccountDataManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
      paramObject.b(localfew.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo);
      PubAccountAssistantManager.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject.a());
      a(102, true, localfew);
      return;
      if ((paramObject instanceof EqqDetail)) {
