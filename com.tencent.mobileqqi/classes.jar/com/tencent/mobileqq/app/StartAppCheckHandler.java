  ...
  implements BusinessObserver
{
  ...
  private Handler jdField_b_of_type_AndroidOsHandler = new fgt(this, Looper.getMainLooper());
  final int c = 2;
  final int d = 3;
  ...
  public StartAppCheckHandler(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new fgs(this, Looper.getMainLooper());
    this.jdField_a_of_type_JavaLangRunnable = new fgu(this);
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramArrayOfByte)
      {
        ...
        this.jdField_a_of_type_Fgv.jdField_b_of_type_Long = Long.valueOf(l).longValue();
        if (((signature.SignatureResult)localObject1).u32_timeout.has()) {
          this.jdField_a_of_type_Fgv.jdField_a_of_type_Long = ((signature.SignatureResult)localObject1).u32_timeout.get();
        }
        if (((signature.SignatureResult)localObject1).u32_check_result.has()) {
          this.jdField_a_of_type_Fgv.jdField_a_of_type_Int = ((signature.SignatureResult)localObject1).u32_check_result.get();
        }
        if (((signature.SignatureResult)localObject1).str_title.has()) {
          this.jdField_a_of_type_Fgv.jdField_c_of_type_JavaLangString = ((signature.SignatureResult)localObject1).str_title.get();
        }
        if (((signature.SignatureResult)localObject1).str_content.has()) {
          this.jdField_a_of_type_Fgv.d = ((signature.SignatureResult)localObject1).str_content.get();
        }
        if (((signature.SignatureResult)localObject1).str_left_button.has()) {
          this.jdField_a_of_type_Fgv.e = ((signature.SignatureResult)localObject1).str_left_button.get();
        }
        if (((signature.SignatureResult)localObject1).str_right_button.has()) {
          this.jdField_a_of_type_Fgv.f = ((signature.SignatureResult)localObject1).str_right_button.get();
        }
        if (((signature.SignatureResult)localObject1).str_url.has()) {
          this.jdField_a_of_type_Fgv.g = ((signature.SignatureResult)localObject1).str_url.get();
        }
        this.jdField_a_of_type_Fgv.b();
        this.jdField_a_of_type_Fgv = null;
      ...
      {
        localObject2 = (fgw)((Iterator)localObject1).next();
        if (((fgw)localObject2).jdField_a_of_type_JavaLangString.equals(paramArrayOfByte))
        {
      ...
      {
        localObject3 = (fgw)((Iterator)localObject2).next();
        if (((fgw)localObject3).jdField_a_of_type_JavaLangString.equals(paramArrayOfByte))
        {
  ...
  public void b(String paramString, Context paramContext, Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Fgx = new fgx(this, paramString);
    this.jdField_a_of_type_Fgv = new fgv(this, paramString);
    long l;
    if (Long.valueOf(System.currentTimeMillis()).longValue() < this.jdField_a_of_type_Fgv.jdField_b_of_type_Long + 86400000L)
    {
      PackageInfo localPackageInfo = a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), this.jdField_a_of_type_Fgx.jdField_a_of_type_JavaLangString);
      if (localPackageInfo != null)
      {
        ...
        if ((this.jdField_a_of_type_Fgv.jdField_c_of_type_Long == l) && (this.jdField_a_of_type_Fgv.jdField_a_of_type_JavaLangString.equalsIgnoreCase(str)))
        {
          if (this.jdField_a_of_type_Fgv.jdField_a_of_type_Int != 2)
          {
            paramContext.startActivity(paramIntent);
            return;
          }
          ...
          paramContext.putString("dlg_title", this.jdField_a_of_type_Fgv.jdField_c_of_type_JavaLangString);
          paramContext.putString("dlg_content", this.jdField_a_of_type_Fgv.d);
          paramContext.putString("dlg_lbutton", this.jdField_a_of_type_Fgv.e);
          paramContext.putString("dlg_rbutton", this.jdField_a_of_type_Fgv.f);
          paramContext.putString("dlg_url", this.jdField_a_of_type_Fgv.g);
          ...
          try
          {
            ReportController.b(null, "P_CliOper", "Safe_StartAppCheck", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), "startAppByCheckValid", this.jdField_a_of_type_Fgv.jdField_b_of_type_JavaLangString, 0, 0, "", "", "", "");
            return;
          }
    ...
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_Fgx.jdField_a_of_type_Long = Long.valueOf(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount()).longValue();
        this.jdField_a_of_type_Fgx.jdField_a_of_type_Int = 1;
        this.jdField_a_of_type_Fgx.jdField_a_of_type_JavaLangString = paramString;
        paramString = new fgw(this, paramString, paramContext, paramIntent);
        ...
        if (this.jdField_a_of_type_Fgv.jdField_a_of_type_Long <= 0L) {
          break label527;
        }
        l = this.jdField_a_of_type_Fgv.jdField_a_of_type_Long;
