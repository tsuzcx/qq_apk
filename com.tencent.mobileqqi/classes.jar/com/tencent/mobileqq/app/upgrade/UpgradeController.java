  ...
  implements DownloadListener, DownloadQueryListener, UpdateManager.OnCheckUpdateListener
{
  ...
  private int a(int paramInt1, int paramInt2)
  {
    ...
    for (int i1 = 0;; i1 = paramInt2)
    {
      ...
      DownloadApi.a(BaseActivity.a, localBundle, 1, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail, i1);
      return 0;
      str = BaseApplicationImpl.getContext().getString(2131559216);
      break;
      label353:
    ...
    for (;;)
    {
      try
      {
        ...
        if ((localBaseActivity != null) && (str != null) && (!str.startsWith("com.tencent.av.")) && (!str.equals("com.tencent.mobileqq.activity.UserguideActivity")) && (!str.equals("com.tencent.mobileqq.activity.UpgradeDetailActivity"))) {
          new UpgradeTipsDialog(localBaseActivity, (QQAppInterface)localObject, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper, null);
        }
  ...
  public void c()
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 200	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   5: ifeq +12 -> 17
    //   8: ldc 17
    //   10: iconst_2
    //   11: ldc_w 521
    //   14: invokestatic 218	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   17: aload_0
    //   18: getfield 265	com/tencent/mobileqq/app/upgrade/UpgradeController:jdField_a_of_type_Boolean	Z
    //   21: ifeq +21 -> 42
    //   24: aload_0
    //   25: iconst_0
    //   26: putfield 265	com/tencent/mobileqq/app/upgrade/UpgradeController:jdField_a_of_type_Boolean	Z
    //   29: aload_0
