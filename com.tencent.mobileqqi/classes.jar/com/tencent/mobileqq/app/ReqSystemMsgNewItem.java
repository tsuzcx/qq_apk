  ...
  implements CheckUpdateItemInterface
{
  ...
  public ReqItem a()
  {
    ...
    int i = LocaleUtil.a(this.a.getApplication().getApplicationContext());
    if (i == 2) {
      ((structmsg.ReqSystemMsgNew)localObject1).language.set(1000);
    }
    for (;;)
    {
      ...
      return localReqItem;
      if (i == 1) {
        ((structmsg.ReqSystemMsgNew)localObject1).language.set(1001);
      } else if (i == 6) {
        ((structmsg.ReqSystemMsgNew)localObject1).language.set(1002);
      } else if (i == 8) {
        ((structmsg.ReqSystemMsgNew)localObject1).language.set(1003);
      } else if (i == 7) {
        ((structmsg.ReqSystemMsgNew)localObject1).language.set(1004);
      } else if (i == 4) {
        ((structmsg.ReqSystemMsgNew)localObject1).language.set(1005);
      } else if (i == 5) {
        ((structmsg.ReqSystemMsgNew)localObject1).language.set(1006);
      } else if (i == 3) {
        ((structmsg.ReqSystemMsgNew)localObject1).language.set(1007);
      } else {
        ((structmsg.ReqSystemMsgNew)localObject1).language.set(1001);
      }
    }
