  ...
  extends BusinessHandler
{
      ...
      catch (Exception paramFromServiceMsg)
      {
        for (;;)
        {
          ...
          try
          {
            ...
            paramToServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131563263, new Object[] { paramToServiceMsg });
  ...
  public void c(String paramString, int paramInt, nearfield_discuss.LBSInfo paramLBSInfo)
  {
    if (QLog.isColorLevel()) {
