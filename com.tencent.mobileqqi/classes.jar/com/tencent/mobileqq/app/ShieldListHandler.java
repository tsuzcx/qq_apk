  ...
  extends BusinessHandler
{
  ...
  ShieldListHandler(QQAppInterface paramQQAppInterface)
  {
    ...
    this.f = null;
    this.e = paramQQAppInterface.getApplication().getString(2131563248);
    this.f = paramQQAppInterface.getApplication().getString(2131563249);
    this.jdField_g_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131563232);
    this.h = paramQQAppInterface.getApplication().getString(2131563233);
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    ((ShieldMsgManger)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(paramFromServiceMsg);
  ...
  private void a(boolean paramBoolean, int paramInt, long[] paramArrayOfLong)
  {
    ...
    if (i < j)
    {
      ...
      int k = ShieldListInfo.SOURCE_ID_2_AIO_TYPE(paramInt);
      ...
      for (;;)
      {
        ...
        localMessageRecord.init(str3, str2, str3, str1, l2, 0, k, 0L);
        ...
        do
        {
          ...
          str2 = ContactUtils.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1));
        } while (str2 == null);
        if (paramBoolean) {
          str1 = this.f;
        } else {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localArrayList, String.valueOf(str3), false);
  }
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    paramToServiceMsg = (ShieldMsgManger)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14);
    int i = 0;
  ...
  private void e()
  {
    ...
    ((ShieldMsgManger)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(localArrayList);
