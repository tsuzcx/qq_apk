...
import com.tencent.mobileqq.statistics.ReportController.ReportProxyAdapter;
  ...
  implements Manager
{
  ...
  private MpfileTaskProxy jdField_a_of_type_ComDatalineMpfileMpfileTaskProxy;
  ...
  private ReportController.ReportProxyAdapter jdField_a_of_type_ComTencentMobileqqStatisticsReportController$ReportProxyAdapter;
  ...
  public ProxyManager(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComDatalineMpfileMpfileTaskProxy = new MpfileTaskProxy(paramQQAppInterface, this);
    ...
    this.jdField_a_of_type_ComTencentMobileqqStatisticsReportController$ReportProxyAdapter = new ReportController.ReportProxyAdapter(paramQQAppInterface, this);
    this.jdField_a_of_type_ComTencentMobileqqAppMessageConversationProxy = new ConversationProxy(paramQQAppInterface, this);
    this.jdField_a_of_type_ComTencentMobileqqAppProxyRecentUserProxy = new RecentUserProxy(paramQQAppInterface, this);
    this.jdField_a_of_type_ComTencentMobileqqQcallQCallProxy = new QCallProxy(paramQQAppInterface, this);
    this.jdField_a_of_type_ArrayOfComTencentMobileqqAppProxyBaseProxy = new BaseProxy[] { this.jdField_a_of_type_ComTencentMobileqqAppProxyRecentUserProxy, this.jdField_a_of_type_ComTencentMobileqqAppMessageMsgProxyContainer, this.jdField_a_of_type_ComTencentMobileqqAppProxyDataLineMsgProxy, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerProxy, this.jdField_a_of_type_ComTencentMobileqqStatisticsReportController$ReportProxyAdapter, this.jdField_a_of_type_ComTencentMobileqqFilemanagerUtilUniformDownloadBPTransProxy, this.jdField_a_of_type_ComTencentMobileqqAppMessageConversationProxy, this.jdField_a_of_type_ComTencentMobileqqQcallQCallProxy };
    this.jdField_a_of_type_JavaLangThread = new Thread(new fkn(this));
  ...
  {
    return this.jdField_a_of_type_ComDatalineMpfileMpfileTaskProxy;
  }
  ...
  public ReportController.ReportProxyAdapter a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqStatisticsReportController$ReportProxyAdapter;
  }
  ...
  public void a(String arg1, int paramInt1, String paramString2, ContentValues paramContentValues, String paramString3, String[] paramArrayOfString, int paramInt2, ProxyListener paramProxyListener)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Pause) || (!ReflectionUtil.a(BaseApplicationImpl.a)))
      {
        if (QLog.isColorLevel()) {
