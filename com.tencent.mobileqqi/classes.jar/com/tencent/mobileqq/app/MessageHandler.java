...
import tencent.im.oidb.cmd0xb72.oidb_0xb72.ReqBody;
import tencent.im.oidb.cmd0xb72.oidb_0xb72.RspBody;
  ...
  implements ProcessorDispatcherInterface, ProcessorObserver
{
  ...
  private static String B = MessageHandler.class.getSimpleName();
  ...
  public static final int aA = 6010;
  public static final int aB = 6012;
  ...
  public static final int aG = 8001;
  public static final int aH = 8002;
  public static final int aI = 8003;
  public static final int aJ = 8004;
  public static final int aK = 8005;
  public static final int aL = 8006;
  public static final int aM = 8007;
  public static final int aN = 8008;
  public static final int aO = 8010;
  public static final int aP = 8011;
  public static final int aQ = 8012;
  public static final int aR = 8013;
  ...
  public static final int ad = 4013;
  public static final int ae = 5001;
  public static final int af = 5002;
  public static final int ag = 5003;
  public static final int ah = 5004;
  public static final int ai = 5005;
  public static final int aj = 5006;
  public static final int ak = 5007;
  public static final int al = 5008;
  ...
  private final String E = "Q.msg.MessageHandler";
  private final String F = "Q.msg.MessageHandler";
  ...
  MessageHandler(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = paramQQAppInterface.a().getSharedPreferences("mobileQQi", 0);
    AppSetting.k = paramQQAppInterface.getBoolean(AppSetting.o, true);
    AppSetting.m = paramQQAppInterface.getBoolean("c2c_del_msg_oper_enable", true);
  }
  ...
  private static oidb_sso.OIDBSSOPkg a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramToServiceMsg)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.MessageHandler", 2, "parseSSOPkg: oidb_sso parseFrom byte InvalidProtocolBufferMicroException ");
          }
        }
      }
    }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    int i2 = EUCountryUtils.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a());
    if ((paramInt1 == 0) && (paramInt2 == 0)) {
      if (i1 == 2)
      {
        EUCountryUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), 0);
  ...
  private void a(MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq, long paramLong, int paramInt, BusinessObserver paramBusinessObserver)
  {
    ...
    for (;;)
    {
      paramInt = MessageProtoCodec.b(paramMessageRecord.istroop);
      l1 = paramMessageRecord.msgUid;
      int i1 = (short)(int)paramMessageRecord.msgseq;
      int i2 = MessageUtils.a(l1);
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><S> --->createSendRichTextMsgReq : mr_friendUin:" + paramMessageRecord.frienduin + " mr_senderUin:" + paramMessageRecord.senderuin + "mr_uniseq:" + paramMessageRecord.uniseq + ",msgSeq:" + paramMessageRecord.msgseq + " mr_shMsgseq:" + paramMessageRecord.shmsgseq + " uint32Seq:" + (0xFFFF & i1) + " mr_msgUid:" + paramMessageRecord.msgUid + " random:" + i2 + " routingType:" + paramInt + " mr_longMsgCtn:" + paramMessageRecord.longMsgCount + " mr_longMsgSeq" + paramMessageRecord.longMsgId + " mr_longMsgIndex:" + paramMessageRecord.longMsgIndex);
      }
      paramBusinessObserver.extraData.putInt("ROUNTING_TYPE", paramInt);
  ...
  private void a(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      a(4004, true, null);
      ((SaveTrafficHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(18)).b();
      return;
    }
    a(4004, false, null);
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, SvcResponseGroupMsgReadConfirm paramSvcResponseGroupMsgReadConfirm)
  {
    ...
    int i1 = paramSvcResponseGroupMsgReadConfirm.cReplyCode;
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "<ReadReport><R>_Group_reqSeq:" + l1 + " replyCode:" + i1);
    }
    a(l1);
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, SvcResponseMsgReadedReport paramSvcResponseMsgReadedReport)
  {
    ...
    int i1 = paramSvcResponseMsgReadedReport.cReplyCode;
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "<ReadReport><R>_C2C_reqSeq:" + l1 + " replyCode:" + i1);
    }
    a(l1);
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, SvcResponseSetConfMsgRead paramSvcResponseSetConfMsgRead)
  {
    ...
    int i1 = paramSvcResponseSetConfMsgRead.cReplyCode;
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "<ReadReport><R>_Discussion_reqSeq:" + l1 + " replyCode:" + i1);
    }
    a(l1);
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, AdMsgInfo paramAdMsgInfo)
  {
    ...
    if ((paramAdMsgInfo != null) && (String.valueOf(paramAdMsgInfo.uDstUin).equalsIgnoreCase(paramToServiceMsg.getUin())))
    {
      ...
      paramFromServiceMsg.frienduin = String.valueOf(AppConstants.W);
      paramFromServiceMsg.senderuin = String.valueOf(AppConstants.W);
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, SvcRequestPushReadedNotify paramSvcRequestPushReadedNotify)
  {
    ...
    if ((paramSvcRequestPushReadedNotify.cNotifyType & 0x8) == 8)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("Q.msg.MessageHandler", 2, "handlePushReadedNotify isSubAccount readed notify.");
        bool1 = bool2;
      }
    }
    Object localObject1;
    ...
    if ((paramSvcRequestPushReadedNotify.vC2CReadedNotify != null) && (paramSvcRequestPushReadedNotify.vC2CReadedNotify.size() > 0))
    {
      ...
      paramFromServiceMsg = SubAccountAssistantImpl.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        l1 = ((C2CMsgReadedNotify)localObject2).lPeerUin;
        int i3 = SubAccountDataControll.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFromServiceMsg, String.valueOf(l1));
        int i2 = i1 + i3;
        i1 = i2;
        if (QLog.isColorLevel())
        {
          QLog.d("Q.msg.MessageHandler", 2, "handlePushReadedNotify C2CMsgReadedNotify curFriendUin is " + ((C2CMsgReadedNotify)localObject2).lPeerUin + ", lLastReadTime  is " + ((C2CMsgReadedNotify)localObject2).lLastReadTime + " isSubAccount=" + bool1 + " changed=" + i3);
          i1 = i2;
        }
      }
      if (i1 != 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(AppConstants.O, 7000, i1);
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "handlePushReadedNotify increaseUnread=" + i1);
        }
      }
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(AppConstants.O);
    }
    while ((paramSvcRequestPushReadedNotify.vGroupReadedNotify != null) && (paramSvcRequestPushReadedNotify.vGroupReadedNotify.size() > 0))
    {
      ...
      while (paramFromServiceMsg.hasNext())
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "GroupMsgReadedNotify lGroupCode is " + ((GroupMsgReadedNotify)localObject1).lGroupCode + ", lMemberSeq  is " + ((GroupMsgReadedNotify)localObject1).lMemberSeq);
        }
        localObject2 = String.valueOf(((GroupMsgReadedNotify)localObject1).lGroupCode);
        Object[] arrayOfObject = this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.b((String)localObject2);
        if ((arrayOfObject != null) && (arrayOfObject.length >= 2))
        {
          l1 = ((Long)arrayOfObject[0]).longValue();
          ((Long)arrayOfObject[1]).longValue();
          if (l1 < ((GroupMsgReadedNotify)localObject1).lMemberSeq) {
            this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.c((String)localObject2, new Object[] { Long.valueOf(((GroupMsgReadedNotify)localObject1).lMemberSeq), Long.valueOf(((GroupMsgReadedNotify)localObject1).lGroupMsgSeq) });
          }
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a((String)localObject2, 1, ((GroupMsgReadedNotify)localObject1).lMemberSeq);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a((String)localObject2, ((GroupMsgReadedNotify)localObject1).lMemberSeq);
      }
      label646:
      ...
      while (paramFromServiceMsg.hasNext())
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a((String)localObject2, 0, ((C2CMsgReadedNotify)localObject1).lLastReadTime);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c((String)localObject2, ((C2CMsgReadedNotify)localObject1).lLastReadTime);
      }
    }
    if ((paramSvcRequestPushReadedNotify.vDisReadedNotify != null) && (paramSvcRequestPushReadedNotify.vDisReadedNotify.size() > 0))
    {
      ...
      while (paramFromServiceMsg.hasNext())
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "DisMsgReadedNotify lDisUin is " + paramSvcRequestPushReadedNotify.lDisUin + ", lMemberSeq  is " + paramSvcRequestPushReadedNotify.lMemberSeq);
        }
        localObject1 = String.valueOf(paramSvcRequestPushReadedNotify.lDisUin);
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.a((String)localObject1);
        if ((localObject2 != null) && (localObject2.length >= 2))
        {
          l1 = ((Long)localObject2[0]).longValue();
          ((Long)localObject2[1]).longValue();
          if (l1 < paramSvcRequestPushReadedNotify.lMemberSeq) {
            this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.b((String)localObject1, new Object[] { Long.valueOf(paramSvcRequestPushReadedNotify.lMemberSeq), Long.valueOf(paramSvcRequestPushReadedNotify.lDisMsgSeq) });
          }
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a((String)localObject1, 3000, paramSvcRequestPushReadedNotify.lMemberSeq);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b((String)localObject1, paramSvcRequestPushReadedNotify.lMemberSeq);
      }
    }
    ...
    if (paramSvcResponsePullDisGroupSeq != null)
    {
      ...
      if (paramSvcResponsePullDisGroupSeq.vDisInfo != null)
      {
        ...
        if (i1 < paramSvcResponsePullDisGroupSeq.vDisInfo.size())
        {
          ...
          if (QLog.isColorLevel()) {
            localStringBuilder.append("\nlDisCode=").append(localstDisGroupInfo.lDisCode).append(", eInfoFlag=").append(localstDisGroupInfo.eInfoFlag);
          }
  ...
  private void a(String paramString, int paramInt1, boolean paramBoolean1, Object paramObject, int paramInt2, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          break label98;
        } while (((paramInt1 != 6000) && (paramInt1 != 8002) && (paramInt1 != 7000) && (paramInt1 != 8005) && (paramInt1 != 8006) && (paramInt1 != 6010) && (paramInt1 != 6012) && (paramInt1 != 6013) && (paramInt1 != 8008) && (paramInt1 != 8010)) || (!(paramObject instanceof Object[])));
    ...
    ((ShieldListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(17)).a(paramObject, paramInt1);
  }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      paramArrayOfByte = (EmoticonManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(12);
    } while (paramArrayOfByte.b(Long.toString(l2)) != null);
    EmoticonPackage localEmoticonPackage = new EmoticonPackage();
    localEmoticonPackage.epId = Long.toString(l2);
    localEmoticonPackage.wordingId = l5;
    if (l4 == 1L) {}
    for (boolean bool = true;; bool = false)
    {
      localEmoticonPackage.valid = bool;
      localEmoticonPackage.expiretime = l3;
      paramArrayOfByte.a(localEmoticonPackage);
      paramArrayOfByte.a(localEmoticonPackage.epId);
      EmoticonController.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(localEmoticonPackage.epId);
      new EPCoverTask(localEmoticonPackage, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a();
      return;
    }
  }
      ...
      if (!bool3)
      {
        ...
        if (l1 <= l2)
        {
          ...
          if (paramPbGetGroupMsgResp.return_begin_seq.get() <= paramPbGetGroupMsgResp.return_end_seq.get()) {
            bool1 = a((String)localObject1, l1, l2, paramToServiceMsg.extraData.getBoolean("isRefreshHead"), paramToServiceMsg.extraData.getBundle("context"));
          }
        }
      }
      return bool1;
  ...
  private Object[] a()
  {
    Object localObject = ((ContactFacade)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(49)).a("-1004");
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, SvcResponsePullGroupMsgSeq paramSvcResponsePullGroupMsgSeq)
  {
    ...
    if (QLog.isColorLevel())
    {
      localStringBuilder.append("<<---handleGetPullTroopMsgNumResp msgStruct.cReplyCode: ").append(paramSvcResponsePullGroupMsgSeq.cReplyCode).append(",isUsedRegisterProxy: ").append(bool);
      QLog.d("Q.msg.MessageHandler", 2, localStringBuilder.toString());
    }
    ...
    for (HashMap localHashMap = new HashMap(this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.a());; localHashMap = null)
    {
      ...
      if (i1 < paramSvcResponsePullGroupMsgSeq.vGroupInfo.size())
      {
        ...
        for (;;)
        {
          ...
          int i2 = (int)(((Long)((Pair)localObject1).second).longValue() - ((Long)((Pair)localObject1).first).longValue());
          ...
          for (l1 = l2 - 10 + 1L;; l1 = l2 - l1)
          {
            ...
            {
              localStringBuilder.setLength(0);
              localStringBuilder.append("---------handleGetPullTroopMsgNumResp troopUin: ").append(str).append(" msg count: ").append(i2);
              QLog.d("Q.msg.MessageHandler", 2, localStringBuilder.toString());
            }
            if (i2 <= 0) {
              break;
      ...
      if ((localHashMap != null) && (!localHashMap.isEmpty()))
      {
        ...
        while (paramToServiceMsg.hasNext()) {
          f((String)paramToServiceMsg.next());
        }
      }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject == null) || (!paramObject.result.has()))
    {
      ...
      i1 = 4;
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><R><---handleSendC2CMessageResp_PB : ---cmd:" + str2 + "----replyCode:" + i1 + " peerUin:" + str1 + " uniseq:" + l1 + " msgSeq:" + l2 + " msgType:" + i2 + " uinType:" + i4 + " routingType:" + i5);
      }
  ...
  private void d(String paramString1, String paramString2)
  {
    ...
    ArrayList localArrayList = this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.a(paramString1);
    if (QLog.isColorLevel()) {
    ...
    if ((localArrayList != null) && (localArrayList.size() > 0))
    {
      ...
      {
        paramString2 = (Object[])paramString1.next();
        if ((paramString2 != null) && (paramString2.length >= 2)) {
          a("troop_processor").a(1001, paramString2);
        }
      }
    }
  }
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><E><---handleSendC2CMessageError: ---cmd:" + (String)localObject2 + ",sendC2CMessage error : peerUin:" + (String)localObject1 + " uniseq:" + l1 + " msgSeq:" + l2 + " msgType:" + i3 + " uinType:" + i2 + " routingType:" + i4 + " retryIndex:" + i1);
    }
    b(paramToServiceMsg, paramFromServiceMsg);
    localObject2 = a(l2);
    if (localObject2 != null)
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
      ...
      for (;;)
      {
        ...
        if (paramObject.result.get() != 0)
        {
          ...
          if (i1 == 255)
          {
            ...
            if (!((FriendManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(8)).f((String)localObject2)) {
              break label709;
            }
            if ((i1 != 108) && (i1 != 102)) {
              break label698;
            ...
            ((FriendsManagerImp)localObject3).i((String)localObject2);
    ...
    if ((paramObject == null) || (!paramObject.result.has()))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><R><---handleSendTroopMessageRespPB: ---cmd:" + (String)localObject3 + "----replyCode:" + i1 + ",SendTroopMessageResp : peerUin:" + (String)localObject2 + ",uniseq:" + l2 + ",msgSeq:" + l1);
      }
      localObject1 = a(l1);
      if (localObject1 != null) {
        break label318;
    ...
    if ((paramString2 != null) && (!paramString2.isEmpty()))
    {
      ...
      while (paramString1.hasNext())
      {
        ...
        if ((paramString2 != null) && (paramString2.length >= 3)) {
          a("disc_processor").a(1001, new Object[] { paramString2[0], paramString2[1], paramString2[2], Boolean.valueOf(false) });
        }
      }
    }
  }
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><E><---handleSendGrpMessageError: ---cmd:" + (String)localObject + ",sendC2CMessage error : peerUin:" + str + " uniseq:" + l3 + " msgSeq:" + l1 + " msgType:" + i1 + " uinType:" + i4 + " routingType:" + i2 + " retryIndex:" + i3);
    }
    b(paramToServiceMsg, paramFromServiceMsg);
    localObject = a(l1);
    if (localObject != null)
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    int i4 = MessageProtoCodec.a(i2);
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><E><---handleSendDisMessageError: ---cmd:" + (String)localObject + ",sendC2CMessage error : peerUin:" + str + " uniseq:" + l3 + " msgSeq:" + l1 + " msgType:" + i1 + " uinType:" + i4 + " routingType:" + i2 + " retryIndex:" + i3);
    }
    b(paramToServiceMsg, paramFromServiceMsg);
    localObject = a(l1);
    if (localObject != null)
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      do
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><R><---handleSendDiscussionMsgRespPB: ---cmd:" + (String)localObject2 + "----replyCode:" + i1 + "SendDiscussionMsgResp : peerUin:" + (String)localObject1 + ",uniseq:" + l1 + ",msgSeq:" + l2);
        }
        localObject1 = a(l2);
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      {
        QLog.e("Barry", 4, "CMD_IQQ_USER_TYPE_INFO_HANDLE_TIME_OUT");
        z(paramToServiceMsg, paramFromServiceMsg);
        return;
      }
    } while (!"OidbSvc.0x587_34".equalsIgnoreCase(str));
    QLog.e("Barry", 4, "CMD_IQQ_USER_TYPE_ISEU_HANDLE_TIME_OUT");
  ...
  private void m(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "<ReadReport><E>_Group_reqSeq:" + l1);
    }
    a(l1);
  }
  ...
  private void n(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "<ReadReport><E>_Discussion_reqSeq:" + l1);
    }
    a(l1);
  }
  ...
  private void o()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.c())
    {
      ...
      while ((localObject1 != null) && (!((HashMap)localObject1).isEmpty()))
      {
        ...
        while (((Iterator)localObject1).hasNext()) {
          e((String)((Iterator)localObject1).next());
        }
  ...
  private void o(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "<ReadReport><E>_C2C_reqSeq:" + l1);
    }
    a(l1);
  }
  ...
  private void q(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    if (this.bY < 3)
    {
      ...
      {
        int i3 = paramToServiceMsg.length;
        int i1 = 0;
        while (i1 < i3)
        {
          a(paramToServiceMsg[i1], i2);
          i1 += 1;
        }
      }
      this.bY += 1;
    ...
    catch (Exception localException)
    {
      ...
      if (paramToServiceMsg.getUin() == null)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          localObject = "null";
          label208:
          localStringBuilder2.append(localObject).append(" troopUin: ").append(l1).append(",isRefreshHead:").append(bool2).append(", dataHash=").append(???.hashCode()).append(" rtnBeginSeq:").append(localPbGetGroupMsgResp2.return_begin_seq.get()).append(" rtnEndSeq:").append(localPbGetGroupMsgResp2.return_end_seq.get());
  ...
  private void v(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    String str = paramToServiceMsg.extraData.getString("uin");
    long l2 = paramToServiceMsg.extraData.getLong("timeOut");
    int i1 = paramToServiceMsg.extraData.getInt("transC2CCmd");
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><E><---handleSendTransMessageError: ---cmd:" + (String)localObject + ",sendC2CMessage error : peerUin:" + str + ",msgSeq:" + l1 + ",transc2ccmd:" + i1);
    }
    b(paramToServiceMsg, paramFromServiceMsg);
    localObject = a(l1);
    if (localObject != null)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><R><---handleSendTransMessageError, msf said:RESNDMSG");
      }
      localObject.getClass();
      if (!a((SendMessageHandler)localObject, "msf")) {
        break label181;
  ...
  private void w(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    long l4 = paramToServiceMsg.extraData.getLong("timeOut");
    int i1 = paramToServiceMsg.extraData.getInt("transC2CCmd");
    int i2 = paramToServiceMsg.extraData.getInt("busiType");
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><E><---handleSendTransMessageExError: ---cmd:" + (String)localObject + ",sendC2CMessage error : peerUin:" + str + ",uniseq:" + l1 + ",msgSeq:" + l3 + ",transc2ccmd:" + i1);
    }
    b(paramToServiceMsg, paramFromServiceMsg);
    localObject = a(l2);
    if (localObject != null)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><R><---handleSendTransMessageExError, msf said:RESNDMSG");
      }
      localObject.getClass();
      if (!a((SendMessageHandler)localObject, "msf")) {
        break label228;
    ...
    do
    {
      do
      {
        do
        {
          ...
          QLog.d("Q.msg.MessageHandler", 2, "<FileAssistant><---handleSendTransMessageExResp : should not come here for the moment, busiType" + i2);
          return;
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(str, paramToServiceMsg.extraData.getLong("sessionid"), false);
          return;
        ...
        QLog.d("Q.msg.MessageHandler", 2, "<FileAssistant><---handleSendTransMessageExResp : send offline file  fail");
        return;
      } while (!QLog.isColorLevel());
      QLog.d("Q.msg.MessageHandler", 2, "<FileAssistant><---handleSendTransMessageExResp : send file receipt fail");
      return;
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandler", 2, "<FileAssistant><---handleSendTransMessageExError : qlink send file fail");
      }
      l1 = paramToServiceMsg.extraData.getLong("sessionid");
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(l1);
      return;
    } while (!QLog.isColorLevel());
    QLog.d("Q.msg.MessageHandler", 2, "<FileAssistant><---handleSendTransMessageExError : qlink send file state fail");
  }
  ...
  public SvcRequestPullDisMsgSeq a()
  {
    ...
    Object localObject = (ContactFacade)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(49);
    if (localObject != null) {}
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    {
      if (i1 == 0) {}
      for (paramLong1 = 480000L;; paramLong1 = (3 - i1) * 480000 / 3 - i1 * 2000)
      {
        paramLong2 = 480000 * i1 / 3;
        localSendMessageHandler.getClass();
        localSendMessageHandler.a(paramLong2, paramLong1, "period");
        i1 += 1;
        break;
      }
    }
  ...
  public void a(MessageForText paramMessageForText)
  {
    ...
    a(paramMessageForText.frienduin, paramMessageForText.msg, (byte)1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.e(), paramMessageForText.msgseq, paramMessageForText.uniseq);
  }
  ...
  public void a(MessageRecord paramMessageRecord, BusinessObserver paramBusinessObserver)
  {
    ...
    label187:
    for (long l1 = 480000L;; l1 = (3 - i1) * 480000 / 3 - i1 * 2000)
    {
      long l2 = i1 * 480000 / 3;
      localSendMessageHandler.getClass();
      localSendMessageHandler.a(l2, l1, "period");
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      if ("OidbSvc.0xb72_0".equalsIgnoreCase(str))
      {
        QLog.e("Barry", 4, "CMD_IQQ_USER_TYPE_INFO_HANDLE_ERROR");
        z(paramToServiceMsg, paramFromServiceMsg);
        return;
      }
    } while (!"OidbSvc.0x587_34".equalsIgnoreCase(str));
    QLog.e("Barry", 4, "CMD_IQQ_USER_TYPE_ISEU_HANDLE_ERROR");
    y(paramToServiceMsg, paramFromServiceMsg);
  }
            ...
            else
            {
              if ("OidbSvc.0xb72_0".equalsIgnoreCase(str))
              {
                ...
                if (paramObject == null)
                {
                  ...
                  QLog.d("Q.msg.MessageHandler", 2, "CMD_IQQ_USER_TYPE_INFO: ssoPkg parse failed");
                  return;
                }
                try
                {
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "getPullTroopMsgNumber troopUinArray.length: " + arrayOfString.length + " troopUinArray:" + arrayOfString + ", lastSeqAry:" + arrayOfLong);
    }
    ...
    paramString.extraData.putInt("mask_type", paramInt);
    a(paramString);
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "----------addFriendTipsMr friendUin: " + paramString + " istroop: " + paramInt);
    }
    if (paramLong < 0L) {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        localMessageForGrayTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramString, paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131563245), paramLong, -1013, paramInt, paramLong);
      ...
      {
        break label148;
        localMessageForGrayTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramString, paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131563246), paramLong, -1013, paramInt, paramLong);
        ...
        try
        {
          for (;;)
          {
            ...
            TroopNotificationHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, l1, paramLong, l2, "", (int)System.currentTimeMillis(), "OidbSvc.0x852_48", (short)34, false);
            return;
            b(localMessageForGrayTips);
          }
        }
  ...
  public void a(ArrayList paramArrayList, boolean paramBoolean)
  {
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if ((localMessageRecord != null) && (((localMessageRecord instanceof MessageForPic)) || ((localMessageRecord instanceof MessageForMixedMsg))) && ((bool) || (i1 != 0))) {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(B, 2, "Msg Pull Finish picPreDownloadOn");
    }
  ...
  public boolean a(String paramString, long paramLong1, long paramLong2, boolean paramBoolean, Bundle paramBundle)
  {
    long l1 = this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.a(paramString, 1);
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MessageHandler", 2, "--->>getPullTroopMsg troopUin2: " + paramString + " beginSeq: " + paramLong1 + " endSeq: " + paramLong2 + " delSeq: " + l1 + " pull num : " + (paramLong2 - paramLong1 + 1L));
    }
  ...
  public void b(int paramInt)
  {
    ...
    localOIDBSSOPkg.uint32_service_type.set(34);
    localOIDBSSOPkg.bytes_bodybuffer.set(ByteStringMicro.copyFrom(((oidb_0x587.ReqBody)localObject).toByteArray()));
    localObject = a("OidbSvc.0x587_34");
  ...
  public void b(MessageRecord paramMessageRecord, BusinessObserver paramBusinessObserver)
  {
    ...
    QLog.d("Q.msg.MessageHandler", 2, "msgSending:send message once success");
  }
  ...
  public void c()
  {
    ...
    ((BaseApplicationImpl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a()).a();
  ...
  protected boolean c(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilSet == null)
    {
      ...
      this.jdField_a_of_type_JavaUtilSet.add("MultiVideo.c2sack");
      this.jdField_a_of_type_JavaUtilSet.add("MultiVideo.s2c");
      ...
      this.jdField_a_of_type_JavaUtilSet.add("OidbSvc.0xb72_0");
      this.jdField_a_of_type_JavaUtilSet.add("OidbSvc.0x587_34");
    }
    ...
    while (!a())
    {
      ...
      for (;;)
      {
        ...
        if (i2 > 0)
        {
          try
          {
            a(localRecentUser.uin, ((Long)localPair.first).longValue() + 1L, ((Long)localPair.second).longValue(), false, null);
          }
  ...
  public void h()
  {
    ...
    {
      ConcurrentHashMap localConcurrentHashMap = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c();
      Object localObject1 = new ArrayList();
      Object localObject2 = localConcurrentHashMap.entrySet().iterator();
      while (((Iterator)localObject2).hasNext())
      {
        Iterator localIterator = ((ConcurrentHashMap)((Map.Entry)((Iterator)localObject2).next()).getValue()).entrySet().iterator();
        while (localIterator.hasNext())
        {
          Object localObject3 = (MessageCache.MsgSendingInfo)((Map.Entry)localIterator.next()).getValue();
          String str = ((MessageCache.MsgSendingInfo)localObject3).jdField_a_of_type_JavaLangString;
          int i1 = ((MessageCache.MsgSendingInfo)localObject3).jdField_a_of_type_Int;
          long l1 = ((MessageCache.MsgSendingInfo)localObject3).jdField_a_of_type_Long;
          localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(str, i1, l1);
          if (localObject3 == null)
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().d(str, i1, l1);
          }
          else
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.d("Q.msg.MessageHandler", 2, "msgSending:setMsgSendingInfo, uin:" + str + " istroop:" + i1 + " uniseq:" + l1 + " time:" + l2 + " currentServerTime:" + l3);
            }
            if (((l3 - l2) * 1000L + 30000L >= 480000L) || (l3 - l2 < 0L))
            {
              if (QLog.isColorLevel()) {
                QLog.d("Q.msg.MessageHandler", 2, "msgSending:msg sending flag set to failed");
              }
              localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(str, i1);
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().d(str, i1, l1);
              if ((localObject3 != null) && (((QQMessageFacade.Message)localObject3).uniseq == l1)) {
                ((QQMessageFacade.Message)localObject3).extraflag = 32768;
              }
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(str, i1, l1, 32768, 1002);
      ...
      if ((localObject1 != null) && (!((ArrayList)localObject1).isEmpty()))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          b((MessageRecord)localObject2, null);
        }
      }
      if (QLog.isColorLevel()) {
  ...
  public void k()
  {
    Object localObject = new oidb_0xb72.ReqBody();
    oidb_sso.OIDBSSOPkg localOIDBSSOPkg = new oidb_sso.OIDBSSOPkg();
    localOIDBSSOPkg.uint32_command.set(2930);
    localOIDBSSOPkg.uint32_result.set(0);
    localOIDBSSOPkg.uint32_service_type.set(0);
    localOIDBSSOPkg.bytes_bodybuffer.set(ByteStringMicro.copyFrom(((oidb_0xb72.ReqBody)localObject).toByteArray()));
    localObject = a("OidbSvc.0xb72_0");
    ((ToServiceMsg)localObject).putWupBuffer(localOIDBSSOPkg.toByteArray());
    ((ToServiceMsg)localObject).setTimeout(30000L);
    b((ToServiceMsg)localObject);
    QLog.e("Barry", 4, "CMD_IQQ_USER_TYPE_INFO");
