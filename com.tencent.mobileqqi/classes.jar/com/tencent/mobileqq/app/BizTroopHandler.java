  ...
  extends BusinessHandler
{
  ...
  public void e(String paramString)
  {
    ...
    try
    {
      ...
      ByteStringMicro localByteStringMicro = ByteStringMicro.copyFrom("6.0.1".getBytes());
  ...
  public void f(String paramString)
  {
    ...
    try
    {
      ...
      if (i1 == 2)
      {
        ...
        localReqBody.bytes_mobileQ_ver.set(ByteStringMicro.copyFrom("6.0.1".getBytes()));
        localToServiceMsg.putWupBuffer(localReqBody.toByteArray());
