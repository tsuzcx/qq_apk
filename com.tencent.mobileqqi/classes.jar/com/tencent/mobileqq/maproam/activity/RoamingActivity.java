  ...
  implements Animation.AnimationListener, QQMapView.QQMapViewObserver, XListView.MotionEventInterceptor
{
  ...
  LBSObserver jdField_a_of_type_ComTencentMobileqqAppLBSObserver = new ggd(this);
  public RoamLocalSearchBar a;
  RoamSearchDialog.OnRoamResultObserver jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog$OnRoamResultObserver = new ggh(this);
  RoamSearchDialog.OnSearchResultItemClick jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog$OnSearchResultItemClick = new ggg(this);
  public RoamingMapView a;
  public GeoPoint a;
  public MapController a;
  ggk jdField_a_of_type_Ggk = new ggk(this, 1, 1, 1, 8);
  public Boolean a;
  Runnable jdField_a_of_type_JavaLangRunnable = new gfw(this);
  public View b;
  ...
  private void a(double paramDouble1, double paramDouble2, String paramString)
  {
    ...
    a(localGeoPoint, this.jdField_b_of_type_AndroidWidgetTextView, new gfy(this));
  }
  ...
  private void a(GeoPoint paramGeoPoint, TextView paramTextView, RoamingActivity.GetAddressTaskListener paramGetAddressTaskListener)
  {
    if (paramGeoPoint != null) {
      new ggj(paramGeoPoint, paramTextView, paramGetAddressTaskListener).execute(new Context[] { getApplicationContext() });
    }
  }
  ...
  private void k()
  {
    if ((getSharedPreferences(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(), 0).getBoolean("roaming_usage_tips", true)) && (VipUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface)))
    {
      ...
      this.jdField_d_of_type_AndroidViewViewGroup.findViewById(2131233346).setOnClickListener(this);
    }
  }
  ...
  private void l()
  {
    ...
    {
      localObject = new ChangeViewSizeAnimation(this.jdField_c_of_type_AndroidViewViewGroup, this.jdField_c_of_type_AndroidViewViewGroup.getWidth(), this.jdField_c_of_type_AndroidViewViewGroup.getWidth(), this.jdField_c_of_type_AndroidViewViewGroup.getHeight(), getResources().getDimensionPixelSize(2131427574));
  ...
  private void m()
  {
    DialogUtil.a(this, 230).setTitle(getString(2131562948)).setMessage(2131562452).setPositiveButton(getString(2131562540), new ggi(this)).show();
  }
  ...
  protected View b()
  {
    ...
    this.e = ((ViewGroup)getLayoutInflater().inflate(2130903669, null));
    if ((!jdField_b_of_type_Boolean) && (this.e == null)) {
      throw new AssertionError();
    }
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.e.findViewById(2131233348));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131233349));
    this.jdField_d_of_type_AndroidWidgetTextView.setText(2131562017);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131233350));
    ...
    if (VipUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      ...
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.e.findViewById(2131233351));
      this.jdField_c_of_type_AndroidViewViewGroup = ((ViewGroup)this.e.findViewById(2131233343));
      this.jdField_d_of_type_AndroidViewViewGroup = ((ViewGroup)this.e.findViewById(2131233345));
      this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamingMapView = ((RoamingMapView)this.e.findViewById(2131233241));
      ...
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.e.findViewById(2131233246));
      this.jdField_b_of_type_AndroidWidgetTextView.setClickable(true);
      this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130839173, 0);
      ...
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.e.findViewById(2131233244));
      localObject = BitmapManager.a(getResources(), 2130839671);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap((Bitmap)localObject);
      this.jdField_a_of_type_AndroidWidgetImageView.setPadding(0, 0, 0, ((Bitmap)localObject).getHeight());
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.e.findViewById(2131233245));
      this.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130839673);
      this.jdField_c_of_type_AndroidWidgetImageView.setPadding(0, 0, 0, ((Bitmap)localObject).getHeight());
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      this.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
      this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamLocalSearchBar = ((RoamLocalSearchBar)this.e.findViewById(2131233344));
      ...
      a((GeoPoint)localObject, this.jdField_c_of_type_AndroidWidgetTextView, new ggb(this));
    }
    for (;;)
    {
      this.jdField_b_of_type_AndroidViewView = this.e.findViewById(2131233347);
      this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamingMapView.post(new ggc(this, i));
      return this.e;
      i = 2131562277;
      break;
      label632:
  ...
  protected void doOnDestroy()
  {
    ...
    this.jdField_a_of_type_Ggk = null;
  ...
  void e()
  {
    ...
    showDialog(0);
    SOSOMapLBSApi.getInstance().requestLocationUpdate(getApplicationContext(), this.jdField_a_of_type_Ggk);
  }
  ...
  void j()
  {
    this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(new gfz(this));
  }
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    ...
    this.jdField_a_of_type_ComTencentTencentmapMapsdkMapMapController.animateTo(paramAnimation, new ggf(this));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131233246: 
      ...
      a(true, false);
      return;
      Utils.a(this, 2131562519, getResources().getString(2131563244), new gge(this), null);
      return;
    case 2131233346: 
      this.jdField_d_of_type_AndroidViewViewGroup.setVisibility(8);
