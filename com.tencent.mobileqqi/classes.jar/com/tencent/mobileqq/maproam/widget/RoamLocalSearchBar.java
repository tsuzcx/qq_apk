  ...
  implements View.OnClickListener
{
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.c.findViewById(2131233085));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.c.findViewById(2131234397));
  ...
  public void b()
  {
    ...
    View localView1 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.findViewById(2131231447);
    View localView2 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.findViewById(2131231838);
    ...
    localTranslateAnimation1.setAnimationListener(new gbz(this, localView2, localView1));
    localTranslateAnimation2.setAnimationListener(new gca(this, localView2, i));
    this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.setOnDismissListener(new gcb(this, localView2, i, localView1, localTranslateAnimation2));
