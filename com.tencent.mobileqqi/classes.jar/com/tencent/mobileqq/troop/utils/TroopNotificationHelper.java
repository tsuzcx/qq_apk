...
public class TroopNotificationHelper
{
  ...
  public static TroopNotificationCache a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramQQAppInterface != null)
        {
          if (paramInt == 23)
          {
            paramArrayOfByte = a(paramQQAppInterface, paramQQAppInterface.jdField_b_of_type_JavaLangString, i, 0, paramLong2);
          ...
          paramQQAppInterface = a(paramQQAppInterface, paramQQAppInterface.jdField_b_of_type_JavaLangString, 34, 0, paramLong2);
  ...
  public static TroopNotificationCache a(TroopNotificationHelper.FeedItem paramFeedItem, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    {
      if (paramFeedItem.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopNotificationHelper$FeedItem$ItemType == TroopNotificationHelper.FeedItem.ItemType.TROOP_NOTIFICATION)
      {
        ...
        {
          str2 = new SimpleDateFormat("yyyy年M月d日").format(new Date(paramFeedItem.jdField_b_of_type_Int * 1000L));
          str2 = str2 + " 群公告";
        }
        paramString = String.format("http://en.qq.com/qqiGroupAnnounceRedirect.php?_wv=1027&amp;_bid=148&amp;qqqi=qqqi&amp;gc=%d&amp;feedType=%d&amp;gotoFid=%s", new Object[] { Long.valueOf(paramLong), Integer.valueOf(paramInt1), paramString });
        ...
        localTroopNotificationCache.userUin = paramFeedItem.jdField_a_of_type_Int;
        localTroopNotificationCache.troopUin = paramLong;
        localTroopNotificationCache.time = paramFeedItem.jdField_b_of_type_Int;
      ...
      if (paramFeedItem.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopNotificationHelper$FeedItem$ItemType == TroopNotificationHelper.FeedItem.ItemType.NEW_OBJ_STREAM)
      {
        paramString = new TroopNotificationCache();
        paramString.feedType = paramInt1;
        paramString.appId = paramInt2;
        paramString.userUin = paramFeedItem.jdField_a_of_type_Int;
        paramString.troopUin = paramLong;
        paramString.time = paramFeedItem.jdField_b_of_type_Int;
        ...
        paramString.src = paramFeedItem.jdField_c_of_type_Int;
        paramString.filterID = paramFeedItem.jdField_a_of_type_Long;
  ...
  public static TroopNotificationHelper.FeedItem a(DataInputStream paramDataInputStream, boolean paramBoolean)
  {
    ...
    paramDataInputStream.jdField_a_of_type_Int = k;
    paramDataInputStream.jdField_b_of_type_Int = m;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((i == 5) || (i == 19))
        {
          ...
          localObject5 = new TroopNotificationHelper.FeedItem(null);
          ...
          ((TroopNotificationHelper.FeedItem)localObject5).jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopNotificationHelper$FeedItem$ItemType = TroopNotificationHelper.FeedItem.ItemType.TROOP_NOTIFICATION;
          return localObject5;
        }
        if (i == 22)
        {
      ...
      long l2 = l1;
      localObject3 = new TroopNotificationHelper.FeedItem(null);
      ...
      ((TroopNotificationHelper.FeedItem)localObject3).jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopNotificationHelper$FeedItem$ItemType = TroopNotificationHelper.FeedItem.ItemType.NEW_OBJ_STREAM;
      ((TroopNotificationHelper.FeedItem)localObject3).jdField_a_of_type_Long = l2;
      ((TroopNotificationHelper.FeedItem)localObject3).jdField_c_of_type_Int = i;
      return localObject3;
      return null;
      label683:
      label691:
  ...
  {
    if ((jdField_a_of_type_JavaUtilHashMap != null) && (jdField_a_of_type_JavaUtilHashMap.containsKey(Long.valueOf(paramLong2))))
    {
      localObject1 = (byte[])jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong2));
      short s = (short)localObject1.length;
      if ("OidbSvc.0x852_35".equals(paramString2))
      {
        jdField_e_of_type_JavaUtilHashMap.put(paramString1, Boolean.valueOf(true));
        a(paramQQAppInterface, paramInt1, paramLong1, paramLong2, s, (byte[])localObject1, paramLong3, paramString1, paramInt2);
      }
      while (!"OidbSvc.0x852_48".equals(paramString2)) {
        return;
      }
      a(paramQQAppInterface, paramInt1, paramLong1, paramLong2, s, (byte[])localObject1, paramShort, paramBoolean);
      return;
    }
    if ("OidbSvc.0x852_35".equals(paramString2)) {
      jdField_e_of_type_JavaUtilHashMap.put(paramString1, Boolean.valueOf(true));
    ...
    try
    {
      ...
      ((ToServiceMsg)localObject1).extraData.putLong("userUin", paramLong3);
      ((ToServiceMsg)localObject1).extraData.putString("feedsId", paramString1);
      ((ToServiceMsg)localObject1).extraData.putInt("time", paramInt2);
      ((ToServiceMsg)localObject1).extraData.putString("cmd", paramString2);
      ((ToServiceMsg)localObject1).extraData.putInt("feedType", paramShort);
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      if ((paramArrayOfByte.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopNotificationHelper$FeedItem$ItemType != TroopNotificationHelper.FeedItem.ItemType.TROOP_NOTIFICATION) && (paramArrayOfByte.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopNotificationHelper$FeedItem$ItemType != TroopNotificationHelper.FeedItem.ItemType.NEW_OBJ_STREAM)) {
        break label303;
      }
    ...
    catch (Exception localException)
    {
      try
      {
        do
        {
          ...
          ((DataOutputStream)localObject2).writeInt(n);
          ((DataOutputStream)localObject2).write(1);
          ((DataOutputStream)localObject2).writeShort(i1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if ((localList != null) && (localList.size() > 0)) {
      a(paramQQAppInterface, paramString, localList);
    }
  ...
  {
    // Byte code:
    //   0: new 957	java/util/ArrayList
    //   3: dup
    //   4: invokespecial 958	java/util/ArrayList:<init>	()V
    //   7: astore 15
    //   9: new 957	java/util/ArrayList
    //   12: dup
    //   13: invokespecial 958	java/util/ArrayList:<init>	()V
    //   16: astore 16
    //   18: new 957	java/util/ArrayList
    //   21: dup
    //   22: invokespecial 958	java/util/ArrayList:<init>	()V
    //   25: astore 17
    //   27: aload_2
    //   28: invokeinterface 610 1 0
    //   33: astore_2
    //   34: aload_2
    //   35: invokeinterface 615 1 0
    //   40: ifeq +666 -> 706
    //   43: aload_2
    //   44: invokeinterface 619 1 0
    //   49: checkcast 416	com/tencent/mobileqq/activity/TroopNotificationCache
    //   52: astore 18
    //   54: invokestatic 1058	com/tencent/mobileqq/service/message/MessageUtils:a	()I
    //   57: istore 7
    //   59: getstatic 1061	com/tencent/mobileqq/service/MobileQQService:jdField_c_of_type_Int	I
    //   62: istore_3
    //   63: iload_3
    //   64: iconst_1
    //   65: iadd
    //   66: putstatic 1061	com/tencent/mobileqq/service/MobileQQService:jdField_c_of_type_Int	I
    //   69: iload_3
    //   70: i2l
    //   71: lstore 11
    //   73: invokestatic 966	com/tencent/mobileqq/service/message/MessageCache:a	()J
    //   76: l2i
    //   77: istore 8
    //   79: sipush -2021
    //   82: invokestatic 1066	com/tencent/mobileqq/service/message/MessageRecordFactory:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    //   85: checkcast 1068	com/tencent/mobileqq/data/MessageForTroopNotification
    //   88: astore 19
    //   90: aload 19
    //   92: lconst_0
    //   93: putfield 1071	com/tencent/mobileqq/data/MessageForTroopNotification:shmsgseq	J
    //   96: aload 19
    //   98: sipush -2021
    //   101: putfield 1074	com/tencent/mobileqq/data/MessageForTroopNotification:msgtype	I
    //   104: aload 18
    //   106: getfield 535	com/tencent/mobileqq/activity/TroopNotificationCache:xmlBytes	[B
    //   109: ifnull -75 -> 34
    //   112: iconst_0
    //   113: istore 4
    //   115: iconst_0
    //   116: istore 5
    //   118: aload 18
    //   120: getfield 521	com/tencent/mobileqq/activity/TroopNotificationCache:serviceID	I
    //   123: bipush 27
    ...
    //   130: aload 19
    //   132: aload 18
    //   134: getfield 535	com/tencent/mobileqq/activity/TroopNotificationCache:xmlBytes	[B
    //   137: iload_3
    //   138: invokestatic 1079	com/tencent/mobileqq/structmsg/StructMsgFactory:a	([BI)Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   141: putfield 1083	com/tencent/mobileqq/data/MessageForTroopNotification:structingMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   144: aload 19
    //   146: getfield 1083	com/tencent/mobileqq/data/MessageForTroopNotification:structingMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    ...
    //   177: dup
    //   178: aload 18
    //   180: getfield 535	com/tencent/mobileqq/activity/TroopNotificationCache:xmlBytes	[B
    //   183: invokespecial 572	java/lang/String:<init>	([B)V
    ...
    //   200: istore_3
    //   201: aload 18
    //   203: getfield 521	com/tencent/mobileqq/activity/TroopNotificationCache:serviceID	I
    //   206: bipush 20
    //   208: if_icmpne -78 -> 130
    //   211: iload 5
    //   213: istore_3
    //   214: aload 18
    //   216: getfield 544	com/tencent/mobileqq/activity/TroopNotificationCache:ctrlStr	Ljava/lang/String;
    //   219: ifnull -89 -> 130
    //   222: new 648	org/json/JSONObject
    //   225: dup
    //   226: aload 18
    //   228: getfield 544	com/tencent/mobileqq/activity/TroopNotificationCache:ctrlStr	Ljava/lang/String;
    //   231: invokespecial 649	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   234: astore 20
    //   236: iload 5
    //   238: istore_3
    //   239: aload 20
    ...
    //   244: invokevirtual 652	org/json/JSONObject:has	(Ljava/lang/String;)Z
    //   247: ifeq -117 -> 130
    //   250: iload 5
    //   252: istore_3
    //   253: aload 20
    ...
    //   258: invokevirtual 656	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    ...
    //   272: invokevirtual 660	org/json/JSONObject:getJSONObject	(Ljava/lang/String;)Lorg/json/JSONObject;
    //   275: astore 20
    //   277: aload 20
    ...
    //   282: invokevirtual 656	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   285: istore_3
    ...
    //   304: invokevirtual 1088	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   307: astore 21
    //   309: aload 21
    //   311: invokestatic 1091	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   314: lstore 13
    //   316: invokestatic 966	com/tencent/mobileqq/service/message/MessageCache:a	()J
    //   319: lload 13
    //   321: lcmp
    //   322: ifle +84 -> 406
    //   325: aload 18
    //   327: aload_0
    //   328: invokestatic 1093	com/tencent/mobileqq/troop/utils/TroopNotificationHelper:a	(Lcom/tencent/mobileqq/activity/TroopNotificationCache;Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   331: goto -297 -> 34
    //   334: astore 20
    //   336: iload_3
    //   337: istore 4
    //   339: iload 4
    //   341: istore_3
    //   342: invokestatic 667	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   345: ifeq -215 -> 130
    //   348: ldc 10
    //   350: iconst_4
    ...
    //   367: dup
    //   368: aload 18
    //   370: getfield 535	com/tencent/mobileqq/activity/TroopNotificationCache:xmlBytes	[B
    //   373: invokespecial 572	java/lang/String:<init>	([B)V
    ...
    //   396: astore 20
    //   398: aload 20
    //   400: invokevirtual 1094	java/lang/NumberFormatException:printStackTrace	()V
    //   403: goto -369 -> 34
    //   406: aload 20
    //   408: getstatic 305	com/tencent/mobileqq/troop/utils/TroopNotificationHelper:f	Ljava/lang/String;
    //   411: invokevirtual 656	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   414: istore 6
    //   416: aload 20
    //   418: getstatic 311	com/tencent/mobileqq/troop/utils/TroopNotificationHelper:g	Ljava/lang/String;
    //   421: invokevirtual 1088	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   424: astore 21
    //   426: aload 20
    //   428: getstatic 315	com/tencent/mobileqq/troop/utils/TroopNotificationHelper:h	Ljava/lang/String;
    //   431: invokevirtual 656	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   434: istore 9
    //   436: iconst_0
    //   437: istore 5
    //   439: iconst_0
    ...
    //   454: aload 16
    //   456: iload 9
    //   458: invokestatic 494	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   461: invokevirtual 1097	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
    //   464: ifeq +88 -> 552
    //   467: iload 5
    //   469: istore 6
    //   471: aload 17
    //   473: aload 21
    //   475: invokevirtual 1097	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
    //   478: ifeq +74 -> 552
    //   481: aload 16
    //   483: invokevirtual 1098	java/util/ArrayList:size	()I
    //   486: aload 17
    //   488: invokevirtual 1098	java/util/ArrayList:size	()I
    //   491: invokestatic 1104	java/lang/Math:min	(II)I
    //   494: istore 10
    //   496: iconst_0
    //   497: istore 5
    //   499: iload 4
    ...
    //   510: aload 16
    //   512: iload 5
    //   514: invokevirtual 1107	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   517: checkcast 491	java/lang/Integer
    //   520: invokevirtual 1110	java/lang/Integer:intValue	()I
    //   523: iload 9
    //   525: if_icmpne +200 -> 725
    //   528: aload 17
    //   530: iload 5
    //   532: invokevirtual 1107	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   535: checkcast 41	java/lang/String
    //   538: aload 21
    //   540: invokevirtual 854	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   543: ifeq +182 -> 725
    //   546: iconst_1
    //   547: istore 4
    //   549: goto +176 -> 725
    ...
    //   557: aload 18
    //   559: aload_0
    //   560: invokestatic 1093	com/tencent/mobileqq/troop/utils/TroopNotificationHelper:a	(Lcom/tencent/mobileqq/activity/TroopNotificationCache;Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   563: goto -529 -> 34
    //   566: aload 16
    //   568: iload 9
    //   570: invokestatic 494	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   573: invokevirtual 961	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   576: pop
    //   577: aload 17
    //   579: aload 21
    //   581: invokevirtual 961	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   584: pop
    //   585: goto -455 -> 130
    //   588: aload 19
    //   590: aload 19
    //   592: getfield 1083	com/tencent/mobileqq/data/MessageForTroopNotification:structingMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   595: invokevirtual 1113	com/tencent/mobileqq/structmsg/AbsStructMsg:getBytes	()[B
    //   598: putfield 1116	com/tencent/mobileqq/data/MessageForTroopNotification:msgData	[B
    //   601: aload 19
    //   603: ldc_w 1118
    //   606: putfield 1120	com/tencent/mobileqq/data/MessageForTroopNotification:msg	Ljava/lang/String;
    //   609: aload 19
    //   611: aload_1
    //   612: putfield 1123	com/tencent/mobileqq/data/MessageForTroopNotification:frienduin	Ljava/lang/String;
    //   615: aload 19
    //   617: iconst_1
    //   618: putfield 1126	com/tencent/mobileqq/data/MessageForTroopNotification:istroop	I
    //   621: aload 19
    //   623: iconst_1
    //   624: putfield 1130	com/tencent/mobileqq/data/MessageForTroopNotification:isread	Z
    //   627: aload 19
    //   629: iload 8
    //   631: i2l
    //   632: putfield 1132	com/tencent/mobileqq/data/MessageForTroopNotification:time	J
    //   635: aload 19
    //   637: lload 11
    //   639: putfield 1135	com/tencent/mobileqq/data/MessageForTroopNotification:msgseq	J
    //   642: aload 19
    //   644: iload 7
    //   646: invokestatic 1137	com/tencent/mobileqq/service/message/MessageUtils:a	(I)J
    //   649: putfield 1140	com/tencent/mobileqq/data/MessageForTroopNotification:msgUid	J
    //   652: aload 15
    //   654: aload 19
    //   656: invokevirtual 961	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   659: pop
    //   660: aconst_null
    //   661: ldc_w 1142
    //   664: ldc_w 1144
    ...
    //   677: iconst_0
    //   678: aload 19
    //   680: getfield 1149	com/tencent/mobileqq/data/MessageForTroopNotification:troopUin	J
    //   683: invokestatic 830	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   686: aload 18
    //   688: getfield 501	com/tencent/mobileqq/activity/TroopNotificationCache:feedType	I
    //   691: invokestatic 369	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   694: ldc_w 528
    //   697: ldc_w 528
    //   700: invokestatic 1154	com/tencent/mobileqq/statistics/ReportController:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   703: goto -669 -> 34
    //   706: aload_0
    //   707: invokevirtual 955	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/message/QQMessageFacade;
    //   710: aload 15
    //   712: aload_0
    //   713: invokevirtual 868	com/tencent/mobileqq/app/QQAppInterface:a	()Ljava/lang/String;
    //   716: invokevirtual 1157	com/tencent/mobileqq/app/message/QQMessageFacade:a	(Ljava/util/List;Ljava/lang/String;)V
    //   719: return
    //   720: astore 20
    //   722: goto -383 -> 339
    //   725: iload 5
    ...
    //   396	31	20	localNumberFormatException	java.lang.NumberFormatException
