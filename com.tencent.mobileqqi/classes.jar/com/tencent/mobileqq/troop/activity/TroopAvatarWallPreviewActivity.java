  ...
  extends BaseActivity
{
  ...
  public TroopAvatarWallPreviewActivity()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new gvu(this);
  }
  ...
  {
    new gwb(this, paramURLDrawable, paramString).execute(new Void[0]);
  }
  ...
  private boolean c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetImageAnimationView.setAnimationListener(new gwc(this));
    this.jdField_a_of_type_ComTencentMobileqqWidgetImageAnimationView.a();
    this.jdField_a_of_type_AndroidWidgetFrameLayout.postDelayed(new gwd(this), this.jdField_a_of_type_Long);
  ...
  private void f()
  {
    ...
    localActionSheet.a(new gvy(this, bool, (URLDrawable)localObject, localActionSheet));
  ...
  public void a(URLDrawable paramURLDrawable)
  {
    ...
    DialogUtil.a(this, 230).setTitle(getString(2131562802)).setMessage(getString(2131561976)).setPositiveButton(getString(2131562765), new gwa(this, paramURLDrawable, str)).setNegativeButton(getString(2131562473), new gvz(this)).show();
  }
  ...
  public void a(URLDrawable paramURLDrawable, String paramString)
  {
    ...
    Object localObject = new File(AppConstants.aI);
    if (!((File)localObject).exists()) {
      ((File)localObject).mkdirs();
    }
    String str = AppConstants.aI + this.j + Utils.Crc64String(paramURLDrawable.getURL().toString());
    localObject = str;
  ...
  public void e()
  {
    ...
    localAnimationSet.setAnimationListener(new gvs(this));
    this.jdField_a_of_type_ComTencentWidgetGallery.postDelayed(new gvt(this), 500L);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetImageAnimationView = ((ImageAnimationView)findViewById(2131231776));
    ((ImageView)findViewById(2131231777)).setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(0);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetGallery.setOnItemClickListener(new gvr(this));
      this.jdField_a_of_type_ComTencentWidgetGallery.setOnItemSelectedListener(new gvw(this));
      this.jdField_a_of_type_ComTencentWidgetGallery.setOnItemLongClickListener(new gvx(this));
      return;
      this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(4);
    }
  }
