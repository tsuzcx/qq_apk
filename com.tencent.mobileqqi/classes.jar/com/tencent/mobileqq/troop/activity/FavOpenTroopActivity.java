  ...
  implements View.OnClickListener, SlideDetectListView.OnSlideListener
{
  ...
  public FavOpenTroopActivity()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new gpn(this);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new gpo(this);
  }
  ...
  public void a(SlideDetectListView paramSlideDetectListView, View paramView, int paramInt)
  {
    ...
    {
      ((Button)paramSlideDetectListView.findViewById(2131232314)).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
  ...
  public void b(SlideDetectListView paramSlideDetectListView, View paramView, int paramInt)
  {
    ...
    if (paramSlideDetectListView != null)
    {
      ...
      ((Button)paramSlideDetectListView.findViewById(2131232314)).setOnClickListener(null);
    }
  }
  ...
  View c()
  {
    ...
    localCustomViewHolder.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131232315));
    localCustomViewHolder.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131232317));
    localCustomViewHolder.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131232319));
    localCustomViewHolder.c = ((TextView)localView.findViewById(2131232320));
    localCustomViewHolder.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131232318));
    localCustomViewHolder.jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout = ((ShaderAnimLayout)localView.findViewById(2131232313));
    localCustomViewHolder.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131232314));
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView = ((SlideDetectListView)findViewById(2131232312));
