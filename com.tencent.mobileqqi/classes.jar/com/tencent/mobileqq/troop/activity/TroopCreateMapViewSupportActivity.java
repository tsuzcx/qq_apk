  ...
  extends TroopCreateBaseActivity
{
  ...
  private void e()
  {
    ...
    getLayoutInflater().inflate(2130903366, (ViewGroup)localObject, true);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131232303));
    this.f = ((int)getResources().getDimension(2131427564));
