...
public class TroopQQBrowserHelper
{
  ...
  {
    String str = String.format("http://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s", new Object[] { "1", "6.0.1", Integer.valueOf(0) });
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    for (String str = String.format("http://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s", new Object[] { "1", "6.0.1", Integer.valueOf(1) });; str = String.format("http://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s", new Object[] { "1", "6.0.1", Integer.valueOf(0) }))
    {
      Intent localIntent = new Intent(paramContext, TroopCreateActivity.class);
      localIntent.putExtra("url", str);
      localIntent.putExtra("isShowAd", false);
