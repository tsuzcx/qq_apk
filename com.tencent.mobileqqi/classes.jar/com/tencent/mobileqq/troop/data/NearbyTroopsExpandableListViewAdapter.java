  ...
  implements View.OnClickListener
{
  ...
  public void c()
  {
    ...
    while ((localObject != null) && (((ArrayList)localObject).size() > 0))
    {
      ...
      this.jdField_a_of_type_JavaUtilArrayList.add(new gux(1, this.jdField_a_of_type_AndroidContentContext.getString(2131560291), 2130838360, j + this.jdField_a_of_type_AndroidContentContext.getString(2131560292), localStringBuilder.toString()));
    }
  }
  ...
  {
    switch (((gux)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).a())
    {
    default: 
      return;
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (i == 1)
        {
          ...
          NearbyTroops.a(paramViewGroup, (gux)this.jdField_a_of_type_JavaUtilArrayList.get(b(i, paramInt2)));
