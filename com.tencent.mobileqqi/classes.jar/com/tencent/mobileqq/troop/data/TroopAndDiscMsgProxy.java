  ...
  extends MsgProxy
{
  ...
  protected void a(SessionInfo paramSessionInfo, String paramString, int paramInt, Set paramSet)
  {
    ...
    paramSessionInfo = ((DiscussionManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(paramString);
    paramString = paramSessionInfo.iterator();
    while (paramString.hasNext()) {
  ...
  {
    new Thread(new gzl(this, paramBoolean), "report_troop_aio_break").start();
  }
  ...
  protected void e()
  {
    ...
    label278:
    for (Object localObject = "select frienduin, istroop, shmsgseq as tmpseq, issend from " + str1 + " where shmsgseq=(select max(shmsgseq) from " + str1 + ")";; localObject = null)
    {
      if (localObject != null)
      {
        if (QLog.isColorLevel()) {
        ...
        if ((localObject != null) && (((Cursor)localObject).getCount() > 0))
        {
          ...
          long l = ((Cursor)localObject).getLong(((Cursor)localObject).getColumnIndexOrThrow("tmpseq"));
