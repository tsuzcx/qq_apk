...
public class NearbyOpenTroop
{
  ...
  public NearbyOpenTroop(String paramString1, String paramString2, Activity paramActivity, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppBizTroopObserver = new gur(this);
    this.jdField_b_of_type_ComTencentMobileqqAppBizTroopObserver = new gus(this);
    this.jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new gut(this);
    this.jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new guw(this);
    ...
    this.jdField_a_of_type_AndroidOsHandler = new guu(this);
  }
  ...
  public void a(GroupInfo paramGroupInfo, int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.a(BaseApplicationImpl.getContext().getString(2131559305));
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.show();
    this.jdField_a_of_type_Boolean = false;
    this.jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new guv(this), 1000L);
