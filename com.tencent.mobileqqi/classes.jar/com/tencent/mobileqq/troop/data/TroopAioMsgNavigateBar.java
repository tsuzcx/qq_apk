  ...
  implements View.OnClickListener, Animation.AnimationListener
{
  ...
  private void h()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setId(2131230824);
    Object localObject = new RelativeLayout.LayoutParams(-1, this.f);
    ...
    this.jdField_c_of_type_AndroidWidgetRelativeLayout.setId(2131230823);
    ...
    if (bool)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setId(2131230830);
      ...
      localObject = String.format(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131560612), new Object[] { Integer.valueOf(this.jdField_c_of_type_Int) });
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setId(2131230831);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(i);
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject).addRule(1, 2131230830);
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setId(2131230833);
      if (!bool) {
        break label787;
      }
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setId(2131230832);
      localObject = new RelativeLayout.LayoutParams(-1, -1);
      ((RelativeLayout.LayoutParams)localObject).addRule(9);
      ((RelativeLayout.LayoutParams)localObject).addRule(0, 2131230833);
      ((RelativeLayout.LayoutParams)localObject).leftMargin = ((int)(this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().density * 8.0F + 0.5F));
      ((RelativeLayout.LayoutParams)localObject).rightMargin = ((int)(this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().density * 8.0F + 0.5F));
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setTextSize(0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131427359));
  ...
  private void k()
  {
    ...
    {
      TroopInfoManager localTroopInfoManager = (TroopInfoManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(35);
  ...
  public void a(float paramFloat)
  {
    ...
    if ((this.jdField_a_of_type_Float < 0 - this.e / 2) && (this.jdField_d_of_type_Int == 1)) {
      g();
    }
  }
  ...
  protected void b()
  {
    ...
    this.jdField_c_of_type_Boolean = true;
    this.jdField_c_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
    ((TroopInfoManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(35)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 1, this.jdField_b_of_type_Long, "");
  ...
  public boolean b()
  {
    ...
    this.jdField_d_of_type_Int = ((TroopInfoManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(35)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    if (this.jdField_d_of_type_Int == 1)
    {
      if ((this.jdField_c_of_type_Int >= 20) && (this.jdField_c_of_type_Int <= 200)) {
        return true;
      }
    }
    else if ((this.jdField_d_of_type_Int == 4) || (this.jdField_d_of_type_Int == 2) || (this.jdField_d_of_type_Int == 3)) {
      return true;
    }
    return false;
  }
  ...
  protected void c()
  {
    ((TroopInfoManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(35)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 0);
    this.jdField_b_of_type_Boolean = false;
  ...
  public void e()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_d_of_type_Int == 1)) {
      g();
    }
  }
  ...
  public void f()
  {
    ...
    else
    {
      ...
      this.jdField_d_of_type_Int = ((TroopInfoManager)localObject).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      if (this.jdField_d_of_type_Int == 1)
      {
        ...
        localObject = String.format(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131560612), new Object[] { Integer.valueOf(this.jdField_c_of_type_Int) });
        this.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
        this.jdField_c_of_type_AndroidWidgetRelativeLayout.setTag(TroopAioAgent.Message.a(this.jdField_d_of_type_Int, this.jdField_c_of_type_Long, 0L));
      ...
      else if (this.jdField_d_of_type_Int == 4)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131560610) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_AndroidContentContext, (MessageRecord)localObject, false));
        this.jdField_c_of_type_AndroidWidgetRelativeLayout.setTag(TroopAioAgent.Message.a(this.jdField_d_of_type_Int, 0L, this.jdField_c_of_type_Long));
        j();
      }
      for (int i = 1;; i = 0)
      {
        ...
        if (this.jdField_d_of_type_Int == 2)
        {
          ...
          this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131560611) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_AndroidContentContext, (MessageRecord)localObject, false));
          this.jdField_c_of_type_AndroidWidgetRelativeLayout.setTag(TroopAioAgent.Message.a(this.jdField_d_of_type_Int, 0L, this.jdField_c_of_type_Long));
          j();
        }
        for (;;)
        {
          ...
          this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131561541) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_AndroidContentContext, (MessageRecord)localObject, false));
          this.jdField_c_of_type_AndroidWidgetRelativeLayout.setTag(TroopAioAgent.Message.a(this.jdField_d_of_type_Int, 0L, this.jdField_c_of_type_Long));
          j();
        }
      }
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    ...
    {
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      if ((this.jdField_d_of_type_Boolean) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int)))
      {
        setChanged();
