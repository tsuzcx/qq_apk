  ...
  extends FrameLayout
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new gyu(this);
  public View.OnClickListener a;
  private View.OnLayoutChangeListener jdField_a_of_type_AndroidViewView$OnLayoutChangeListener = new gyn(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new gyq(this);
  ...
  private SeekBar.OnSeekBarChangeListener jdField_a_of_type_AndroidWidgetSeekBar$OnSeekBarChangeListener = new gyw(this);
  ...
  public boolean a;
  View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new gys(this);
  ...
  public boolean c;
  public int d;
  View.OnClickListener jdField_d_of_type_AndroidViewView$OnClickListener = new gyt(this);
  ...
  private View.OnClickListener jdField_g_of_type_AndroidViewView$OnClickListener = new gyv(this);
  private ImageButton jdField_g_of_type_AndroidWidgetImageButton;
  private boolean jdField_g_of_type_Boolean;
  private View.OnClickListener jdField_h_of_type_AndroidViewView$OnClickListener = new gyx(this);
  private ImageButton jdField_h_of_type_AndroidWidgetImageButton;
  private boolean jdField_h_of_type_Boolean;
  private View.OnClickListener jdField_i_of_type_AndroidViewView$OnClickListener = new gyo(this);
  ...
  public MediaControllerX(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidHardwareSensorEventListener = new gyp(this);
  ...
  {
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)paramView.findViewById(2131232651));
    ...
    {
      this.jdField_f_of_type_AndroidWidgetImageButton = ((ImageButton)paramView.findViewById(2131232660));
      ...
      label138:
      this.jdField_g_of_type_AndroidWidgetImageButton = ((ImageButton)paramView.findViewById(2131232658));
    ...
    for (;;)
    {
      ...
      this.jdField_h_of_type_AndroidWidgetImageButton = ((ImageButton)paramView.findViewById(2131232659));
      if (this.jdField_h_of_type_AndroidWidgetImageButton != null)
      {
        ...
        this.jdField_h_of_type_AndroidWidgetImageButton.setOnClickListener(new gyr(this));
      }
      this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131232652));
      if (this.jdField_a_of_type_AndroidWidgetProgressBar != null)
      {
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131232654));
      if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null) {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      }
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131232657));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131232655));
