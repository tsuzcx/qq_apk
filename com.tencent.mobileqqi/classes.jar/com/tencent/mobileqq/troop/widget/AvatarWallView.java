  ...
  implements AdapterView.OnItemLongClickListener
{
  ...
  {
    if (((AvatarWallAdapter)getAdapter()).jdField_b_of_type_Int > 4)
    {
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetAvatarWallAdapter == null) {
      this.jdField_a_of_type_ComTencentMobileqqTroopWidgetAvatarWallAdapter = ((AvatarWallAdapter)getAdapter());
    }
