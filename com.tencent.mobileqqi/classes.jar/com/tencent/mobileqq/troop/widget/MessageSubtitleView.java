  ...
  extends LinearLayout
{
  ...
  Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new gza(this);
  ...
  private final Runnable jdField_a_of_type_JavaLangRunnable = new gyy(this);
  ...
  private final Runnable jdField_b_of_type_JavaLangRunnable = new gyz(this);
  ...
  void a(Context paramContext)
  {
    ...
    while (i1 < 4)
    {
      ...
      localTextView.setShadowLayer(3.0F, 3.0F, 3.0F, 2131361802);
  ...
  public void a(CharSequence paramCharSequence1, CharSequence paramCharSequence2)
  {
    ...
    int i3 = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131361888);
