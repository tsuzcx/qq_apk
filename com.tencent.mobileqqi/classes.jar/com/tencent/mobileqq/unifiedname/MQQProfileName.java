...
public class MQQProfileName
{
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("[head]").append("type = ").append(this.jdField_a_of_type_ComTencentMobileqqUnifiednameMQQName.jdField_a_of_type_Int).append(", value = ").append(this.jdField_a_of_type_ComTencentMobileqqUnifiednameMQQName.jdField_a_of_type_JavaLangString).append("\r\n");
    if (this.jdField_a_of_type_JavaUtilList == null) {}
    for (Object localObject = null;; localObject = Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()))
    {
      ...
      while (i < j)
      {
        ...
        if (localObject != null) {
          localStringBuilder.append("[more item]").append("type = ").append(((MQQName)localObject).jdField_a_of_type_Int).append(", value = ").append(((MQQName)localObject).jdField_a_of_type_JavaLangString).append("\r\n");
        }
        i += 1;
      }
    }
