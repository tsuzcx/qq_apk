  ...
  extends CrashHandler
{
  ...
  private static Handler jdField_a_of_type_AndroidOsHandler = new gaa(Looper.getMainLooper());
  private static IHttpCommunicatorListener jdField_a_of_type_ComTencentMobileqqUtilsHttputilsIHttpCommunicatorListener = new gab();
  ...
  {
    jdField_a_of_type_AndroidOsHandler.post(new gac(paramActivity, paramString));
  }
