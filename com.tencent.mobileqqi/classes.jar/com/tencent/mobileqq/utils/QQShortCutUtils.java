...
public class QQShortCutUtils
{
  ...
  private static ArrayList a(Context paramContext, String paramString, String[] paramArrayOfString)
  {
    ...
    //   7: astore_3
    //   8: aload_0
    //   9: invokestatic 190	com/tencent/mobileqq/utils/QQShortCutUtils:a	(Landroid/content/Context;)Ljava/lang/String;
    //   12: astore 4
    //   14: ldc 10
    //   16: aload 4
    //   18: invokevirtual 179	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   21: ifeq +5 -> 26
    //   24: aload_3
    //   25: areturn
    //   26: aload_0
    //   27: invokevirtual 194	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   30: aload 4
    //   32: invokestatic 200	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   35: bipush 9
    ...
    //   89: aload_2
    //   90: aconst_null
    //   91: invokevirtual 224	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   94: astore_1
    //   95: aload_1
    //   96: ifnull +262 -> 358
    //   99: aload_1
    //   100: astore_0
    //   101: aload_1
    //   102: invokeinterface 229 1 0
    //   107: ifeq +251 -> 358
    //   110: aload_1
    //   111: astore_0
    //   112: new 231	hdv
    //   115: dup
    //   116: invokespecial 232	hdv:<init>	()V
    //   119: astore_2
    //   120: aload_1
    //   121: astore_0
    //   122: aload_2
    ...
    //   130: putfield 238	hdv:jdField_a_of_type_Int	I
    //   133: aload_1
    //   134: astore_0
    //   135: aload_2
    //   136: aload_1
    //   137: iconst_1
    //   138: invokeinterface 242 2 0
    //   143: putfield 244	hdv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   146: aload_1
    //   147: astore_0
    //   148: aload_2
    //   149: aload_1
    ...
    //   156: putfield 246	hdv:b	I
    //   159: aload_1
    //   160: astore_0
    //   161: aload_2
    //   162: aload_1
    //   163: iconst_3
    //   164: invokeinterface 236 2 0
    //   169: putfield 248	hdv:d	I
    //   172: aload_1
    //   173: astore_0
    //   174: aload_2
    //   175: aload_1
    //   176: iconst_4
    //   177: invokeinterface 236 2 0
    //   182: putfield 250	hdv:e	I
    //   185: aload_1
    //   186: astore_0
    //   187: aload_2
    //   188: aload_1
    //   189: iconst_5
    //   190: invokeinterface 236 2 0
    //   195: putfield 252	hdv:f	I
    //   198: aload_1
    //   199: astore_0
    //   200: aload_2
    //   201: aload_1
    //   202: bipush 6
    //   204: invokeinterface 236 2 0
    //   209: putfield 254	hdv:g	I
    //   212: aload_1
    //   213: astore_0
    //   214: aload_2
    //   215: aload_1
    //   216: bipush 7
    //   218: invokeinterface 236 2 0
    //   223: putfield 256	hdv:c	I
    //   226: aload_1
    //   227: astore_0
    //   228: aload_1
    //   229: bipush 8
    //   231: invokeinterface 242 2 0
    //   236: astore 4
    //   238: aload_1
    //   239: astore_0
    //   240: aload 4
    //   242: invokestatic 262	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   245: ifne +86 -> 331
    //   248: aload_1
    //   249: astore_0
    //   250: aload 4
    //   252: ldc_w 264
    //   255: invokevirtual 267	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   258: ifeq +73 -> 331
    //   261: aload_1
    //   262: astore_0
    //   263: aload_2
    //   264: iconst_0
    //   265: putfield 268	hdv:h	I
    //   268: aload_1
    //   269: astore_0
    //   270: aload_3
    //   271: aload_2
    //   272: invokevirtual 271	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   275: pop
    //   276: goto -177 -> 99
    //   279: astore_2
    //   280: aload_1
    //   281: astore_0
    //   282: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   285: ifeq +34 -> 319
    //   288: aload_1
    //   289: astore_0
    //   290: ldc 15
    //   292: iconst_2
    //   293: new 113	java/lang/StringBuilder
    //   296: dup
    //   297: invokespecial 114	java/lang/StringBuilder:<init>	()V
    //   300: ldc_w 273
    //   303: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   306: aload_2
    //   307: invokevirtual 274	java/lang/Exception:toString	()Ljava/lang/String;
    //   310: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   313: invokevirtual 126	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   316: invokestatic 137	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   319: aload_1
    //   320: ifnull +9 -> 329
    //   323: aload_1
    ...
    //   347: ifnull +9 -> 356
    //   350: aload_1
    //   351: invokeinterface 277 1 0
    //   356: aload_0
    //   357: athrow
    //   358: aload_1
    //   359: ifnull -30 -> 329
    //   362: aload_1
    //   363: invokeinterface 277 1 0
    //   368: goto -39 -> 329
    //   371: astore_0
    //   372: aconst_null
    //   373: astore_1
  ...
  public static ArrayList a(Context paramContext, List paramList, String paramString)
  {
    ...
    {
      localObject2 = (hdv)paramList.get(i3);
      if ((localObject2 == null) || (TextUtils.isEmpty(((hdv)localObject2).jdField_a_of_type_JavaLangString))) {
        break label2171;
      }
      if ((((hdv)localObject2).c >= 0) && (((hdv)localObject2).c <= n))
      {
        i4 = ((hdv)localObject2).c;
        arrayOfInt[i4] += 1;
      }
      if ((paramContext != null) || (!((hdv)localObject2).jdField_a_of_type_JavaLangString.equals(paramString)) || (((hdv)localObject2).h != 0)) {
        break label2168;
      }
    ...
    for (;;)
    {
      ...
      int i5;
      if (i4 < b.length) {
        if ((((hdv)localObject2).jdField_a_of_type_JavaLangString.equals(b[i4])) && ((((hdv)localObject2).d != k) || (((hdv)localObject2).e != m)))
        {
          i2 = 4;
          i5 = i3;
        }
      ...
      for (Object localObject3 = localObject2;; localObject3 = localObject1)
      {
        ...
        for (;;)
        {
          ...
          {
            if ((((hdv)localObject2).jdField_a_of_type_JavaLangString.equals(jdField_c_of_type_ArrayOfJavaLangString[i6])) && ((((hdv)localObject2).d != k) || (((hdv)localObject2).e != m)))
            {
              i1 = 3;
              i4 = i3;
        ...
        for (;;)
        {
          ...
          if (i6 < d.length)
          {
            if ((((hdv)localObject2).jdField_a_of_type_JavaLangString.equals(d[i6])) && ((((hdv)localObject2).d != k) || (((hdv)localObject2).e != m)))
            {
              i2 = 2;
              i5 = i3;
        ...
        for (;;)
        {
          ...
          if ((((hdv)localObject2).jdField_a_of_type_JavaLangString.equals(e[i1])) && ((((hdv)localObject2).d != k) || (((hdv)localObject2).e != m)))
          {
            i2 = 1;
            localObject1 = localObject2;
            i1 = i3;
        ...
        if (localObject1 != null)
        {
          ...
          a((hdv)localObject1, paramContext);
          if (QLog.isColorLevel()) {
          ...
          {
            localObject1 = (hdv)paramList.get(i2);
            if ((paramContext.jdField_a_of_type_Int == ((hdv)localObject1).jdField_a_of_type_Int) && (((hdv)localObject1).jdField_a_of_type_JavaLangString != null) && (paramContext.jdField_a_of_type_JavaLangString.equals(((hdv)localObject1).jdField_a_of_type_JavaLangString)))
            {
              if (QLog.isColorLevel()) {
            ...
            if ((localObject1 == null) || (((hdv)localObject1).c != paramContext.c) || (((hdv)localObject1).d != paramContext.d) || (((hdv)localObject1).e != paramContext.e)) {
              break label2149;
            }
            paramString = (String)localObject1;
            if (QLog.isColorLevel()) {
              QLog.d("Q.shortcut", 2, "getMoveShortCut.toReplaceShortcuts.screen=" + ((hdv)localObject1).c + ",y=" + ((hdv)localObject1).e + ",x=" + ((hdv)localObject1).d);
            }
          }
        }
        label960:
        ...
        for (paramString = (String)localObject1;; paramString = null)
        {
          ...
          if ((i4 < paramList.size()) && (paramString != null))
          {
            ...
            i2 = paramList.size();
            localObject1 = (hdv)paramList.get(i2 - 1);
            if ((localObject1 == null) || (paramContext == null) || (((hdv)localObject1).jdField_a_of_type_Int != paramContext.jdField_a_of_type_Int)) {
              break label2143;
            }
            i2 -= 1;
            localObject2 = paramList.subList(i4, i2);
            paramList = (hdv)((List)localObject2).get(0);
            localObject1 = (hdv)((List)localObject2).get(((List)localObject2).size() - 1);
            i2 = ((hdv)localObject1).c;
            i3 = paramList.c;
            i4 = h;
            i5 = ((hdv)localObject1).e;
            i6 = paramList.e;
            int i7 = i;
            int i8 = ((hdv)localObject1).d;
            int i9 = paramList.d;
            int i10 = ((hdv)localObject1).f;
            i4 = (i2 - i3) * i4 + (i5 - i6) * i7 + (i8 - i9) + ((hdv)localObject1).g * i10;
            localObject1 = new hdv[i4];
            localObject2 = ((List)localObject2).iterator();
            if (((Iterator)localObject2).hasNext())
            {
              localObject3 = (hdv)((Iterator)localObject2).next();
              i5 = ((hdv)localObject3).c;
              i6 = paramList.c;
              i7 = h;
              i8 = ((hdv)localObject3).e;
              i9 = paramList.e;
              i10 = i;
              int i11 = ((hdv)localObject3).d;
              int i12 = paramList.d;
              i2 = 1;
              if (i2 <= ((hdv)localObject3).f)
              {
                i3 = 1;
                for (;;)
                {
                  if (i3 <= ((hdv)localObject3).g)
                  {
                    ...
                    paramString = (hdv)paramList.get(i2);
          ...
          for (;;)
          {
            ...
            paramContext.c = i3;
            paramContext.d = j;
            paramContext.e = ((hdv)localObject1).e;
            i4 = i2;
            paramString = localObject4;
            if (((hdv)localObject1).d != j) {
              break label880;
            }
            if (QLog.isColorLevel()) {
              QLog.d("Q.shortcut", 2, "getMoveShortCut.toReplaceShortcuts.screen=" + ((hdv)localObject1).c + ",y=" + ((hdv)localObject1).e + ",x=" + ((hdv)localObject1).d);
  ...
  public static void a(Context paramContext)
  {
    ...
    do
    {
      do
      {
        ...
        return;
        str = paramContext.getString(2131561399);
      ...
      while (localIterator.hasNext()) {
        if (((hdv)localIterator.next()).b != -100) {
      ...
      while (localIterator.hasNext())
      {
        hdv localhdv = (hdv)localIterator.next();
        if (localhdv.b == -100)
        {
          j = Math.min(j, localhdv.d);
          k = Math.max(k, localhdv.d);
          l = Math.min(l, localhdv.e);
          m = Math.max(m, localhdv.e);
          n = Math.max(n, localhdv.c);
        }
      }
      i = k - j + 1;
      h = i * (m - l + 1);
      ...
      Collections.sort(localArrayList, new hdu());
    } while (!a(paramContext, a(paramContext, localArrayList, str)));
    a(paramContext);
  }
  
  private static void a(hdv paramhdv1, hdv paramhdv2)
  {
    if ((paramhdv1 != null) && (paramhdv2 != null))
    {
      if ((paramhdv1.d == k) && (paramhdv1.e == m))
      {
        paramhdv2.d = j;
        paramhdv2.e = l;
        paramhdv1.c += 1;
    ...
    if (paramhdv1.d == k)
    {
      paramhdv2.d = j;
      paramhdv1.e += 1;
      paramhdv2.c = paramhdv1.c;
      return;
    }
    paramhdv1.d += 1;
    paramhdv2.e = paramhdv1.e;
    paramhdv2.c = paramhdv1.c;
  }
  ...
  private static boolean a(Context paramContext, List paramList)
  {
    ...
    {
      hdv localhdv = (hdv)paramList.next();
      ContentValues localContentValues = new ContentValues();
      localContentValues.put("cellX", Integer.valueOf(localhdv.d));
      localContentValues.put("cellY", Integer.valueOf(localhdv.e));
      localContentValues.put("spanX", Integer.valueOf(localhdv.f));
      localContentValues.put("spanY", Integer.valueOf(localhdv.g));
      localContentValues.put("screen", Integer.valueOf(localhdv.c));
      localArrayList.add(ContentProviderOperation.newUpdate(Uri.parse(a(paramContext))).withSelection("_id=?", new String[] { localhdv.jdField_a_of_type_Int + "" }).withValues(localContentValues).build());
    }
    try
    {
