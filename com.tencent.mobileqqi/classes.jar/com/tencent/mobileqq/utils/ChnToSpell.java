...
public class ChnToSpell
{
  ...
  private static void a()
  {
    ...
    //   28: astore 4
    //   30: aload 4
    //   32: invokestatic 976	java/nio/ByteBuffer:wrap	([B)Ljava/nio/ByteBuffer;
    //   35: astore 5
    //   37: new 978	java/io/BufferedInputStream
    //   40: dup
    //   41: getstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   44: invokespecial 983	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   47: astore_3
    //   48: aload_3
    //   49: astore_2
    //   50: aload_3
    ...
    //   53: iconst_0
    //   54: sipush 2048
    //   57: invokevirtual 987	java/io/BufferedInputStream:read	([BII)I
    //   60: iconst_2
    //   61: idiv
    //   62: istore_1
    //   63: iload_1
    ...
    //   78: aload 5
    //   80: iconst_0
    //   81: invokevirtual 991	java/nio/ByteBuffer:position	(I)Ljava/nio/Buffer;
    //   84: pop
    //   85: aload_3
    //   86: astore_2
    //   87: aload 5
    //   89: invokevirtual 995	java/nio/ByteBuffer:asShortBuffer	()Ljava/nio/ShortBuffer;
    ...
    //   100: iload_0
    //   101: isub
    //   102: invokestatic 1000	java/lang/Math:min	(II)I
    //   105: invokevirtual 1005	java/nio/ShortBuffer:get	([SII)Ljava/nio/ShortBuffer;
    //   108: pop
    //   109: iload_0
    //   110: iload_1
    //   111: iadd
    ...
    //   118: iconst_0
    //   119: sipush 2048
    //   122: invokevirtual 987	java/io/BufferedInputStream:read	([BII)I
    //   125: iconst_2
    //   126: idiv
    //   127: istore_1
    //   128: goto -65 -> 63
    ...
    //   132: ifnull +7 -> 139
    //   135: aload_3
    //   136: invokevirtual 1008	java/io/BufferedInputStream:close	()V
    //   139: getstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   142: astore_2
    //   143: aload_2
    //   144: ifnull +13 -> 157
    //   147: getstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   150: invokevirtual 1011	java/io/InputStream:close	()V
    //   153: aconst_null
    //   154: putstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   157: ldc 2
    //   159: monitorexit
    //   160: return
    //   161: astore_2
    ...
    //   167: astore_2
    //   168: aload_2
    //   169: invokevirtual 1014	java/io/IOException:printStackTrace	()V
    //   172: goto -33 -> 139
    //   175: astore_2
    //   176: aload_2
    //   177: invokevirtual 1014	java/io/IOException:printStackTrace	()V
    //   180: goto -27 -> 153
    //   183: astore 4
    //   185: aconst_null
    //   186: astore_3
    ...
    //   188: astore_2
    //   189: aload 4
    //   191: invokevirtual 1015	java/io/FileNotFoundException:printStackTrace	()V
    //   194: aload_3
    //   195: ifnull +7 -> 202
    //   198: aload_3
    //   199: invokevirtual 1008	java/io/BufferedInputStream:close	()V
    //   202: getstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   205: astore_2
    //   206: aload_2
    //   207: ifnull -50 -> 157
    //   210: getstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   213: invokevirtual 1011	java/io/InputStream:close	()V
    //   216: aconst_null
    //   217: putstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   220: goto -63 -> 157
    //   223: astore_2
    //   224: aload_2
    //   225: invokevirtual 1014	java/io/IOException:printStackTrace	()V
    //   228: goto -26 -> 202
    //   231: astore_2
    //   232: aload_2
    //   233: invokevirtual 1014	java/io/IOException:printStackTrace	()V
    //   236: goto -20 -> 216
    //   239: astore 4
    //   241: aconst_null
    //   242: astore_3
    ...
    //   244: astore_2
    //   245: aload 4
    //   247: invokevirtual 1014	java/io/IOException:printStackTrace	()V
    //   250: aload_3
    //   251: ifnull +7 -> 258
    //   254: aload_3
    //   255: invokevirtual 1008	java/io/BufferedInputStream:close	()V
    //   258: getstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   261: astore_2
    //   262: aload_2
    //   263: ifnull -106 -> 157
    //   266: getstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   269: invokevirtual 1011	java/io/InputStream:close	()V
    //   272: aconst_null
    //   273: putstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   276: goto -119 -> 157
    //   279: astore_2
    //   280: aload_2
    //   281: invokevirtual 1014	java/io/IOException:printStackTrace	()V
    //   284: goto -26 -> 258
    //   287: astore_2
    //   288: aload_2
    //   289: invokevirtual 1014	java/io/IOException:printStackTrace	()V
    //   292: goto -20 -> 272
    //   295: astore_3
    //   296: aconst_null
    //   297: astore_2
    ...
    //   299: ifnull +7 -> 306
    //   302: aload_2
    //   303: invokevirtual 1008	java/io/BufferedInputStream:close	()V
    //   306: getstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   309: astore_2
    //   310: aload_2
    //   311: ifnull +13 -> 324
    //   314: getstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   317: invokevirtual 1011	java/io/InputStream:close	()V
    //   320: aconst_null
    //   321: putstatic 980	com/tencent/mobileqq/utils/ChnToSpell:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   324: aload_3
    //   325: athrow
    //   326: astore_2
    //   327: aload_2
    //   328: invokevirtual 1014	java/io/IOException:printStackTrace	()V
    //   331: goto -25 -> 306
    //   334: astore_2
    //   335: aload_2
    //   336: invokevirtual 1014	java/io/IOException:printStackTrace	()V
    //   339: goto -19 -> 320
    //   342: astore_3
    //   343: goto -45 -> 298
    //   346: astore 4
