...
public class AntiFraudConfigFileUtil
{
  ...
  private AntiFraudGetConfigObserver jdField_a_of_type_ComTencentMobileqqAppAntiFraudGetConfigObserver = new hbf(this);
  ...
  {
    new hbh(this, paramString1, paramString3, paramString2).run();
  }
