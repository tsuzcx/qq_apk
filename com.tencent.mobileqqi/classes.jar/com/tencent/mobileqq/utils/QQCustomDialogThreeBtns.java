  ...
  extends Dialog
{
  ...
  private BaseAdapter jdField_a_of_type_AndroidWidgetBaseAdapter = new hgu(this);
  ...
  public QQCustomDialogThreeBtns a(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.c.setOnClickListener(new hgv(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomDialogThreeBtns b(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.c.setVisibility(0);
    this.c.setOnClickListener(new hgy(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomDialogThreeBtns b(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.e.setOnClickListener(new hgw(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomDialogThreeBtns c(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.e.setVisibility(0);
    this.e.setOnClickListener(new hgz(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomDialogThreeBtns c(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.d.setOnClickListener(new hgx(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomDialogThreeBtns d(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.d.setVisibility(0);
    this.d.setOnClickListener(new hha(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.f = ((TextView)findViewById(2131231480));
    this.c = ((TextView)findViewById(2131231472));
    this.e = ((TextView)findViewById(2131231485));
