...
public class HttpMsg
{
  ...
  public static final String R = "User-ReturnCode";
  public static final String S = "X-User-ReturnCode";
  public static final String T = "User-Range";
  ...
  public static final String aa = "X-RtFlag";
  public static final String ab = "X-httime";
  public static final String ac = "X-piccachetime";
  public static String ah = "param_reason";
  ...
  public HttpMsg(String paramString, byte[] paramArrayOfByte, IHttpCommunicatorListener paramIHttpCommunicatorListener, boolean paramBoolean)
  {
    ...
    if (paramString != null)
    {
      this.aj = paramString.substring(0, paramString.length());
  ...
  {
    this.ai = paramString;
    this.aj = this.ai.substring(0, this.ai.length());
  }
  ...
  public boolean d()
  {
    ...
    {
      String str = (String)this.jdField_b_of_type_JavaUtilHashMap.get(ah);
