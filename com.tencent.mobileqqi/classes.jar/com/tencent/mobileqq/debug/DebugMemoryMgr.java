...
public class DebugMemoryMgr
{
  ...
  public static ArrayList a()
  {
    ...
    if (jdField_a_of_type_JavaUtilMap != null)
    {
      ...
      {
        fse localfse = (fse)((Map.Entry)localIterator.next()).getValue();
        if ((localfse != null) && (fse.a(localfse) >= 5242880L)) {
          localArrayList.add(Pair.create(fse.a(localfse), Long.valueOf(fse.a(localfse))));
        }
      }
    }
