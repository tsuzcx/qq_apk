...
public class EmoticonController
{
  ...
  private MessengerService.EmoDataInfo jdField_a_of_type_ComTencentMobileqqEmosmWebMessengerService$EmoDataInfo = new fnr(this);
  public Integer a;
  public ArrayList a;
  ArrayList b;
  public ArrayList c;
  ...
  private void a(String paramString, ArrayList paramArrayList, EmoticonController.ProgressHandler paramProgressHandler, boolean paramBoolean)
  {
    ...
    Object localObject = new fnt(this, paramProgressHandler, localEmosmHandler, paramBoolean, paramArrayList, paramString);
  ...
  private void h(EmoticonPackage paramEmoticonPackage)
  {
    ...
    new fnu(this, EmosmUtils.getQFaceMaterialFolderPath(paramEmoticonPackage.epId, false)).start();
  }
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    synchronized (this.jdField_e_of_type_JavaUtilArrayList)
    {
      ...
      paramString = new fns(this, paramInt);
      if (paramBoolean)
      {
