  ...
  implements TaskInterface
{
  ...
  {
    IPluginManager localIPluginManager = (IPluginManager)paramQQAppInterface.getManager(24);
  ...
  {
    long l = System.currentTimeMillis();
    IPluginManager localIPluginManager = (IPluginManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(24);
    if (localIPluginManager == null) {
      this.c = 11027;
    }
    label398:
  ...
  public void b()
  {
    IPluginManager localIPluginManager = (IPluginManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(24);
    if (localIPluginManager != null) {
      localIPluginManager.cancelInstall("DEmoji.apk");
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.emoji.EmoDown", 2, "stop loading plugin, ep:");
    }
  }
}
