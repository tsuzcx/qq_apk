...
public class SoundPoolUtil
{
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      if (Build.VERSION.SDK_INT >= 8) {
        this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new gao(this, paramInt, paramString));
      }
      do
      {
        for (;;)
        {
          ...
          ThreadManager.a().schedule(new gap(this, paramInt, paramString), 200L);
        }
        paramInt = ((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).intValue();
