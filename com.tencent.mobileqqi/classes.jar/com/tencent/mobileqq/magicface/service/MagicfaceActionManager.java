  ...
  implements ActionGlobalData.ActionCountdownOver, MagicfaceContainerView.MagicfaceGestureListener
{
  ...
  private ShakeListener jdField_a_of_type_ComTencentMobileqqAppShakeListener = new gam(this);
  ...
  private RecordVolume jdField_a_of_type_ComTencentMobileqqMagicfaceModelRecordVolume = new RecordVolume(new gan(this));
  ...
  private MagicfaceActionManager.MagicfaceSensorOperation jdField_a_of_type_ComTencentMobileqqMagicfaceServiceMagicfaceActionManager$MagicfaceSensorOperation = new gak(this);
  ...
  public void a(Emoticon paramEmoticon, int paramInt, String paramString)
  {
    ...
    this.f = paramString;
    new Thread(new gal(this, paramInt)).start();
  }
