  ...
  extends WebViewPlugin
{
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqEmosmClient$onRemoteRespObserver = new geb(this);
  }
      ...
      else
      {
        ...
        if (("sendRequest".equals(paramString3)) && (paramVarArgs.length == 1))
        {
          ...
          for (paramString1 = "POST";; paramString1 = "GET")
          {
            ...
            ThreadManager.a(new gec(this, paramString2, paramString1, paramJsBridgeListener, paramVarArgs, paramString3));
            break;
          }
        }
