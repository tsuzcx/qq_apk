  ...
  implements FaceDecoder.DecodeTaskCompletionListener, AbsListView.OnScrollListener
{
  ...
  private void a(String paramString, Bitmap paramBitmap)
  {
    ...
    if (i < j)
    {
      ...
      ((FacePreloadBaseAdapter.ViewHolder)localObject).c.setBackgroundDrawable(new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramBitmap));
    }
  }
  ...
  public void a(FacePreloadBaseAdapter.ViewHolder paramViewHolder, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      if (paramBitmap == null)
      {
        paramBitmap = jdField_a_of_type_AndroidGraphicsBitmap;
      ...
      paramViewHolder.c.setBackgroundDrawable(new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), localBitmap));
      return;
    }
  }
