...
{
  private static final exu jdField_a_of_type_Exu = new exu(null);
  ...
  public BuddyListAdapter(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, View.OnClickListener paramOnClickListener)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130838693);
    paramExpandableListView.post(new exo(this));
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject3;
    Object localObject2;
    if ((paramView == null) || ((paramView.getTag() instanceof exv)))
    {
      ...
      ((exr)localObject1).jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131230940));
      ((exr)localObject1).d = ((TextView)paramViewGroup.findViewById(2131231394));
      ((exr)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131231397));
      ((exr)localObject1).e = ((TextView)paramViewGroup.findViewById(2131231395));
      ((exr)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131231396));
      ...
      ((exr)localObject1).jdField_a_of_type_JavaLangObject = paramView;
      ((exr)localObject1).jdField_a_of_type_JavaLangString = localFriends.uin;
      ...
      ((exr)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText("[" + (String)localObject3 + "]");
      localObject2 = ((exr)localObject1).jdField_c_of_type_AndroidWidgetImageView;
      if (paramInt1 == 0) {
        break label518;
      }
    }
    ...
    for (paramView = this.jdField_a_of_type_AndroidGraphicsDrawableDrawable;; paramView = null)
    {
      ...
      ((exr)localObject1).e.setText((CharSequence)localObject2);
      ((exr)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      ((exr)localObject1).d.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColorStateList(2131362080));
      paramView = (View)localObject3;
      localObject3 = ContactUtils.a(localFriends);
      ((exr)localObject1).d.setText((CharSequence)localObject3);
      ((exr)localObject1).e.setVisibility(0);
      ((exr)localObject1).jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(new exp(this, localFriends));
      ...
      localObject1 = (exr)paramView.getTag();
      ((exr)localObject1).d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    ...
    default: 
      ...
      if ((paramInt2 == 0) || (paramInt2 == 6))
      {
        paramInt1 = 1;
        label635:
        localObject3 = ((exr)localObject1).jdField_c_of_type_AndroidWidgetImageView;
        if (paramInt1 == 0) {
          break label851;
        }
        ...
        ((exr)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText("[" + paramView + "]");
        localObject2 = a(localFriends, (exr)localObject1);
        ((exr)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        if (paramInt1 == 0)
        {
  ...
  {
    Collections.sort(paramList, jdField_a_of_type_Exu);
  }
  ...
  {
    if ((paramView == null) || ((paramView.getTag() instanceof exr)))
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130903323, paramViewGroup, false);
      paramViewGroup = new exv();
      ...
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131232076));
    ...
    for (;;)
    {
      ...
      if (PublicAccountInfo.isLooker(localPublicAccountInfo))
      {
        ...
        return paramView;
        paramViewGroup = (exv)paramView.getTag();
  ...
  private void c()
  {
    ...
    while (i < j)
    {
      ...
      if ((localObject != null) && ((localObject instanceof exr)))
      {
        localObject = (exr)localObject;
        if ((TextUtils.isEmpty(((exr)localObject).e.getText().toString())) && ((((exr)localObject).jdField_a_of_type_JavaLangObject instanceof Friends))) {
          a((Friends)((exr)localObject).jdField_a_of_type_JavaLangObject, (exr)localObject);
        }
      }
      i += 1;
    }
      ...
      for (;;)
      {
        if (localGroups.group_id != -1006)
        {
          ...
          for (;;)
          {
            ...
            {
              ((ArrayList)localObject1).add(new exs((Friends)((Iterator)localObject4).next(), -1));
              continue;
              if (QLog.isColorLevel()) {
          ...
          while (((Iterator)localObject1).hasNext()) {
            ((List)localObject2).add(((exs)((Iterator)localObject1).next()).a);
          }
  ...
  SpannableString a(Friends paramFriends, exr paramexr)
  {
    ...
    if (this.jdField_a_of_type_Int != 0)
    {
      ...
      paramexr.e.setCompoundDrawables((Drawable)localObject, null, null, null);
    }
    for (;;)
    {
      paramFriends = paramFriends.a(null);
      paramexr.e.setText(paramFriends);
      return paramFriends;
      bool = false;
      break;
      label138:
      paramexr.e.setCompoundDrawables(null, null, null, null);
    }
  }
  
  public void a(View paramView, int paramInt)
  {
    Object localObject = (ext)paramView.getTag();
    if (localObject == null)
    {
      localObject = new ext();
      paramView.findViewById(2131231387).setVisibility(0);
      ((ext)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231388));
      ((ext)localObject).b = ((TextView)paramView.findViewById(2131231389));
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      paramViewGroup = (ext)paramView.getTag();
  ...
  {
    paramView = (ext)paramView.getTag();
