  ...
  implements View.OnClickListener
{
  ...
  private ArrayList a()
  {
    return a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a());
  }
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      if (!localGroups.group_name.equals("我的好友")) {
        break label158;
      }
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131559856));
    }
    for (;;)
    {
