  ...
  implements FaceDecoder.DecodeTaskCompletionListener, AbsListView.OnScrollListener
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new fcn(this);
  ...
  private void a(String paramString, Bitmap paramBitmap)
  {
    ...
    if (i < j)
    {
      ...
      if ((localObject == null) || (!(localObject instanceof fco))) {
        break label169;
      }
      localObject = (fco)localObject;
      if ((paramString == null) && (!TextUtils.isEmpty(((fco)localObject).jdField_a_of_type_JavaLangString)))
      {
        paramBitmap = this.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder.a(101, ((fco)localObject).jdField_a_of_type_JavaLangString);
        if (paramBitmap != null) {
          ((fco)localObject).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramBitmap));
        }
      }
    }
    label169:
    for (;;)
    {
      i += 1;
      break;
      this.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder.a(((fco)localObject).jdField_a_of_type_JavaLangString, 101, true);
      continue;
      if (TextUtils.equals(paramString, ((fco)localObject).jdField_a_of_type_JavaLangString))
      {
        ((fco)localObject).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramBitmap));
        return;
      }
  ...
  private void b()
  {
    ...
    Collections.sort(this.jdField_a_of_type_JavaUtilList, new fcm(this, (HashMap)localObject1));
    this.b.clear();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (getItemViewType(paramInt) == 1)
    {
      ...
      if (paramView == null)
      {
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903203, paramViewGroup, false);
        paramViewGroup = new fco(null);
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (fco)paramView.getTag();
        break;
        label270:
    ...
    if (paramView == null)
    {
      paramView = new fco(null);
      localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903202, paramViewGroup, false);
