  ...
  implements FaceDecoder.DecodeTaskCompletionListener, AbsListView.OnScrollListener
{
  ...
  public void a(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    if (this.jdField_a_of_type_Int == 0)
    {
      ...
      while (paramInt1 < paramInt2)
      {
        ...
        if ((paramString != null) && ((paramString instanceof TroopMemberListActivity.ViewHolder)))
        {
          paramString = (TroopMemberListActivity.ViewHolder)paramString;
  ...
  public void a(AbsListView paramAbsListView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      while (paramInt < i)
      {
        paramAbsListView = (TroopMemberListActivity.ViewHolder)this.jdField_a_of_type_ComTencentWidgetXListView.getChildAt(paramInt).getTag();
        if ((paramAbsListView != null) && (paramAbsListView.a != null) && (paramAbsListView.a.length() > 0)) {
          paramAbsListView.c.setImageBitmap(a(paramAbsListView.a, paramAbsListView.b, (byte)0));
        }
        paramInt += 1;
      }
    }
