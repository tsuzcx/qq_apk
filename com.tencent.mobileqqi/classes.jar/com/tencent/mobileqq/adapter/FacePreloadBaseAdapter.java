  ...
  implements FaceDecoder.DecodeTaskCompletionListener, AbsListView.OnScrollListener
{
  ...
  public FacePreloadBaseAdapter(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, int paramInt, boolean paramBoolean)
  {
    ...
    while (i < j)
    {
      ...
      if ((localObject != null) && ((localObject instanceof FacePreloadBaseAdapter.ViewHolder)))
      {
        ...
        if ((localObject != null) && (((FacePreloadBaseAdapter.ViewHolder)localObject).a != null) && (((FacePreloadBaseAdapter.ViewHolder)localObject).a.length() > 0)) {
          ((FacePreloadBaseAdapter.ViewHolder)localObject).c.setImageBitmap(a(this.jdField_b_of_type_Int, ((FacePreloadBaseAdapter.ViewHolder)localObject).a));
        }
      }
      i += 1;
      continue;
