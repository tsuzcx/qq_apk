  ...
  extends VasWebviewJsPlugin
{
  ...
  public void getRedPointShowInfo(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (((RedTouchInfo)localObject).h > 0)
      {
        i = 1;
        str1.put("hintType", j);
        str1.put("number", ((RedTouchInfo)localObject).h);
        str1.put("isShow", i);
      ...
      else if (((RedTouchInfo)localObject).f > 0)
      {
        i = 1;
        j = 0;
      }
  ...
  public void reportRedTouch(String paramString)
  {
    ...
    try
    {
      ...
      localObject1 = paramString;
      ((BusinessInfoCheckUpdate.ReportReqBody)localObject4).clientver.set("6.0.2.6602");
      localObject1 = paramString;
