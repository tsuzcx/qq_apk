  ...
  implements IPluginActivity, SkinnableActivityProcesser.Callback, PluginInterfaceHelper.OnPluginInterfaceLoadedListener
{
  ...
  {
    // Byte code:
    //   0: getstatic 235	com/tencent/mobileqq/pluginsdk/DebugHelper:sDebug	Z
    //   3: ifeq +47 -> 50
    //   6: ldc 237
    //   8: new 239	java/lang/StringBuilder
    //   11: dup
    //   12: invokespecial 240	java/lang/StringBuilder:<init>	()V
    //   15: ldc 242
    ...
    //   24: ldc 248
    //   26: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   29: iload 6
    //   31: invokevirtual 251	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   34: ldc 248
    //   36: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   39: iload 7
    //   41: invokevirtual 251	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   44: invokevirtual 255	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   47: invokestatic 259	com/tencent/mobileqq/pluginsdk/DebugHelper:log	(Ljava/lang/String;Ljava/lang/String;)V
    //   50: aload_0
    //   51: iconst_1
    //   52: putfield 51	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mIsRunInPlugin	Z
    //   55: aload_0
    //   56: aload 4
    //   58: putfield 69	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mDexClassLoader	Ljava/lang/ClassLoader;
    //   61: aload_0
    //   62: aload_3
    //   63: putfield 53	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mOutActivity	Landroid/app/Activity;
    //   66: aload_0
    //   67: aload_1
    //   68: putfield 261	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mPluginID	Ljava/lang/String;
    //   71: aload_0
    //   72: aload_2
    //   73: putfield 65	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mApkFilePath	Ljava/lang/String;
    //   76: aload_0
    //   77: aload 5
    //   79: putfield 263	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mPackageInfo	Landroid/content/pm/PackageInfo;
    //   82: aload_0
    //   83: iload 7
    //   85: putfield 265	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mUseQqResources	Z
    //   88: aload_0
    //   89: getfield 55	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mContext	Landroid/content/Context;
    //   92: ifnonnull +33 -> 125
    //   95: iload 7
    //   97: ifeq +335 -> 432
    //   100: aload_0
    //   101: new 267	com/tencent/mobileqq/pluginsdk/PluginContext
    //   104: dup
    //   105: aload_3
    //   106: iconst_0
    //   107: aload_0
    //   108: getfield 65	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mApkFilePath	Ljava/lang/String;
    //   111: aload_0
    //   112: getfield 69	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mDexClassLoader	Ljava/lang/ClassLoader;
    //   115: aload_3
    //   116: invokevirtual 222	android/app/Activity:getResources	()Landroid/content/res/Resources;
    //   119: invokespecial 270	com/tencent/mobileqq/pluginsdk/PluginContext:<init>	(Landroid/content/Context;ILjava/lang/String;Ljava/lang/ClassLoader;Landroid/content/res/Resources;)V
    //   122: putfield 55	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mContext	Landroid/content/Context;
    //   125: aload_0
    //   126: aload_0
    //   127: getfield 55	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mContext	Landroid/content/Context;
    //   130: invokevirtual 273	com/tencent/mobileqq/pluginsdk/BasePluginActivity:attachBaseContext	(Landroid/content/Context;)V
    //   133: aload_0
    //   134: iload 6
    //   136: putfield 67	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mUseSkinEngine	Z
    //   139: getstatic 43	com/tencent/mobileqq/pluginsdk/BasePluginActivity:sSkilEngineInit	Z
    //   142: ifne +289 -> 431
    //   145: iload 6
    //   147: ifeq +284 -> 431
    //   150: iconst_1
    //   151: ifeq +280 -> 431
    //   154: aload_0
    //   155: getfield 265	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mUseQqResources	Z
    //   158: ifne +328 -> 486
    //   161: new 239	java/lang/StringBuilder
    //   164: dup
    //   165: invokespecial 240	java/lang/StringBuilder:<init>	()V
    //   168: aload 5
    //   170: getfield 278	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   173: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   176: ldc_w 280
    //   179: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   182: invokevirtual 255	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   185: astore_3
    //   186: aconst_null
    //   187: astore_1
    //   188: aload 4
    //   190: new 239	java/lang/StringBuilder
    //   193: dup
    //   194: invokespecial 240	java/lang/StringBuilder:<init>	()V
    //   197: aload_3
    //   198: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   201: ldc_w 282
    ...
    //   210: invokevirtual 288	java/lang/ClassLoader:loadClass	(Ljava/lang/String;)Ljava/lang/Class;
    //   213: astore_2
    //   214: aload_2
    //   215: astore_1
    //   216: aconst_null
    ...
    //   227: aload_3
    //   228: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   231: ldc_w 290
    //   234: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   237: invokevirtual 255	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   240: invokevirtual 288	java/lang/ClassLoader:loadClass	(Ljava/lang/String;)Ljava/lang/Class;
    //   243: astore_3
    //   244: aload_3
    //   245: astore_2
    //   246: iconst_0
    ...
    //   254: ifnull +77 -> 331
    //   257: aload_1
    //   258: invokevirtual 294	java/lang/Class:getFields	()[Ljava/lang/reflect/Field;
    //   261: astore_3
    //   262: aload_3
    //   263: arraylength
    //   264: istore 11
    ...
    //   284: astore 4
    //   286: aload 4
    //   288: invokevirtual 297	java/lang/reflect/Field:getModifiers	()I
    //   291: bipush 25
    //   293: iand
    //   294: bipush 25
    //   296: if_icmpne +162 -> 458
    //   299: aload 4
    //   301: invokevirtual 300	java/lang/reflect/Field:getType	()Ljava/lang/Class;
    //   304: getstatic 306	java/lang/Integer:TYPE	Ljava/lang/Class;
    //   307: invokevirtual 310	java/lang/Object:equals	(Ljava/lang/Object;)Z
    //   310: ifeq +148 -> 458
    //   313: aload 4
    //   315: aconst_null
    //   316: invokevirtual 314	java/lang/reflect/Field:getInt	(Ljava/lang/Object;)I
    //   319: istore 8
    //   321: iload 8
    //   323: bipush 16
    //   325: ishr
    ...
    //   339: ifnull +77 -> 416
    //   342: aload_2
    //   343: invokevirtual 294	java/lang/Class:getFields	()[Ljava/lang/reflect/Field;
    //   346: astore_3
    //   347: aload_3
    //   348: arraylength
    //   349: istore 12
    ...
    //   369: astore 4
    //   371: aload 4
    //   373: invokevirtual 297	java/lang/reflect/Field:getModifiers	()I
    //   376: bipush 25
    //   378: iand
    //   379: bipush 25
    //   381: if_icmpne +88 -> 469
    //   384: aload 4
    //   386: invokevirtual 300	java/lang/reflect/Field:getType	()Ljava/lang/Class;
    //   389: getstatic 306	java/lang/Integer:TYPE	Ljava/lang/Class;
    //   392: invokevirtual 310	java/lang/Object:equals	(Ljava/lang/Object;)Z
    //   395: ifeq +74 -> 469
    //   398: aload 4
    //   400: aconst_null
    //   401: invokevirtual 314	java/lang/reflect/Field:getInt	(Ljava/lang/Object;)I
    //   404: istore 10
    //   406: iload 10
    //   408: bipush 16
    //   410: ishr
    ...
    //   421: iload 10
    //   423: aconst_null
    //   424: invokestatic 320	com/tencent/theme/SkinEngine:init	(Landroid/content/Context;Ljava/lang/Class;ILjava/lang/Class;ILjava/io/File;)V
    //   427: iconst_1
    //   428: putstatic 43	com/tencent/mobileqq/pluginsdk/BasePluginActivity:sSkilEngineInit	Z
    //   431: return
    //   432: aload_0
    //   433: new 267	com/tencent/mobileqq/pluginsdk/PluginContext
    //   436: dup
    //   437: aload_3
    //   438: iconst_0
    //   439: aload_0
    //   440: getfield 65	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mApkFilePath	Ljava/lang/String;
    //   443: aload_0
    //   444: getfield 69	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mDexClassLoader	Ljava/lang/ClassLoader;
    //   447: invokespecial 323	com/tencent/mobileqq/pluginsdk/PluginContext:<init>	(Landroid/content/Context;ILjava/lang/String;Ljava/lang/ClassLoader;)V
    //   450: putfield 55	com/tencent/mobileqq/pluginsdk/BasePluginActivity:mContext	Landroid/content/Context;
    //   453: goto -328 -> 125
    //   456: astore 4
    //   458: iload 9
    //   460: iconst_1
    ...
    //   475: goto -121 -> 354
    //   478: astore_1
    //   479: invokestatic 327	com/tencent/theme/SkinEngine:getInstances	()Lcom/tencent/theme/SkinEngine;
    //   482: invokevirtual 330	com/tencent/theme/SkinEngine:unInit	()V
    //   485: return
    //   486: ldc_w 332
    //   489: invokestatic 335	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   492: ldc_w 337
    //   495: iconst_1
    //   496: anewarray 95	java/lang/Class
    //   499: dup
    //   500: iconst_0
    //   501: ldc 218
    //   503: aastore
    //   504: invokevirtual 341	java/lang/Class:getMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   507: invokestatic 347	mqq/app/MobileQQ:getMobileQQ	()Lmqq/app/MobileQQ;
    //   510: iconst_1
    //   511: anewarray 89	java/lang/Object
    //   514: dup
    //   515: iconst_0
    //   516: aload_0
    //   517: aastore
    //   518: invokevirtual 353	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   521: pop
    //   522: iconst_1
    //   523: putstatic 43	com/tencent/mobileqq/pluginsdk/BasePluginActivity:sSkilEngineInit	Z
    //   526: return
    //   527: astore_1
    //   528: aload_1
    //   529: invokevirtual 356	java/lang/Exception:printStackTrace	()V
    //   532: return
    //   533: astore 4
    //   535: goto -77 -> 458
    //   538: astore 4
  ...
  {
    int i = LocaleUtil.getApplicationLanguageSettings(getApplicationContext());
    LocaleUtil.updateApplicationResourceLocale(getBaseContext(), i);
    if (this.mIsRunInPlugin)
    {
  ...
  public void startActivityForResult(Intent paramIntent, int paramInt)
  {
    if (this.mIsRunInPlugin)
    {
      ...
      {
        bool = paramIntent.getBooleanExtra("PARAM_PLUGIN_INTERNAL_ACTIVITIES_ONLY", false);
        if (!bool) {
