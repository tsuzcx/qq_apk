  ...
  implements BusinessObserver
{
  ...
  private boolean a(Context paramContext, String paramString, int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetAntiphingToast.a(2131562453, 3000, this.jdField_a_of_type_AndroidWidgetFrameLayout);
  ...
  private boolean a(String paramString)
  {
    ...
    try
    {
      ...
      if (QLog.isColorLevel()) {
        a(this.jdField_d_of_type_JavaLangString, 2, " Is QQ Domain, input url  : " + paramString + " Domain = " + str1);
      }
  ...
  public void a(String paramString, String... paramVarArgs)
  {
    ...
    a(paramString, localWebView.getUrl(), str1, str2, str3, paramVarArgs);
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      str = localContext.getString(2131562455);
      localObject1 = localContext.getString(2131562842);
      localObject3 = localContext.getString(2131562454);
      localObject2 = localContext.getString(2131563016);
