...
public class DownloadFileHelper
{
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      catch (IOException paramString1)
      {
        ...
        return;
        Object localObject1 = ((File)localObject2).getParentFile();
  ...
  public boolean a(URL paramURL, String paramString1, String paramString2, boolean paramBoolean, NetworkInfo paramNetworkInfo)
  {
    ...
    //   67: ireturn
    //   68: aload_2
    //   69: invokevirtual 168	java/lang/String:trim	()Ljava/lang/String;
    //   72: astore 11
    //   74: aload 11
    //   76: astore_2
    //   77: aload 11
    ...
    //   169: goto -116 -> 53
    //   172: aload 11
    //   174: invokevirtual 113	java/io/File:exists	()Z
    //   177: ifeq +13 -> 190
    //   180: aload 11
    //   182: invokevirtual 175	java/io/File:delete	()Z
    //   185: ifne +5 -> 190
    //   188: iconst_0
    //   189: ireturn
    //   190: aload 11
    //   192: invokevirtual 110	java/io/File:getParentFile	()Ljava/io/File;
    //   195: astore 14
    //   197: aload 14
    //   199: ifnull +17 -> 216
    //   202: aload 14
    //   204: invokevirtual 113	java/io/File:exists	()Z
    //   207: ifne +9 -> 216
    //   210: aload 14
    //   212: invokevirtual 100	java/io/File:mkdirs	()Z
    //   215: pop
    //   216: aload_1
    //   217: invokevirtual 176	java/net/URL:toString	()Ljava/lang/String;
    //   220: astore 15
    //   222: new 178	org/apache/http/client/methods/HttpGet
    //   225: dup
    //   226: aload 15
    //   228: invokespecial 179	org/apache/http/client/methods/HttpGet:<init>	(Ljava/lang/String;)V
    //   231: astore 14
    //   233: new 181	org/apache/http/params/BasicHttpParams
    //   236: dup
    //   237: invokespecial 182	org/apache/http/params/BasicHttpParams:<init>	()V
    //   240: astore 15
    //   242: sipush 20000
    //   245: istore 7
    //   247: sipush 10000
    ...
    //   252: aload 5
    //   254: ifnull +104 -> 358
    //   257: invokestatic 187	android/net/Proxy:getDefaultHost	()Ljava/lang/String;
    //   260: astore 16
    //   262: invokestatic 190	android/net/Proxy:getDefaultPort	()I
    //   265: istore 6
    //   267: aload 5
    //   269: invokevirtual 193	android/net/NetworkInfo:getExtraInfo	()Ljava/lang/String;
    //   272: astore 17
    //   274: aload 5
    //   276: invokestatic 195	com/tencent/mobileqq/antiphing/DownloadFileHelper:a	(Landroid/net/NetworkInfo;)Z
    //   279: ifeq +49 -> 328
    //   282: aload 17
    //   284: ifnull +13 -> 297
    //   287: aload 17
    ...
    //   307: aload 15
    //   309: ldc 199
    //   311: new 201	org/apache/http/HttpHost
    //   314: dup
    //   315: aload 16
    //   317: iload 6
    //   319: invokespecial 204	org/apache/http/HttpHost:<init>	(Ljava/lang/String;I)V
    //   322: invokeinterface 210 3 0
    //   327: pop
    //   328: aload 5
    //   330: invokestatic 195	com/tencent/mobileqq/antiphing/DownloadFileHelper:a	(Landroid/net/NetworkInfo;)Z
    //   333: ifeq +414 -> 747
    //   336: sipush 20000
    //   339: istore 7
    //   341: ldc 211
    ...
    //   347: ldc 213
    //   349: sipush 2048
    //   352: invokeinterface 217 3 0
    //   357: pop
    //   358: aload 15
    //   360: ldc 219
    //   362: iload 7
    //   364: invokestatic 225	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   367: invokeinterface 210 3 0
    //   372: pop
    //   373: aload 15
    //   375: ldc 227
    //   377: iload 6
    //   379: invokestatic 225	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   382: invokeinterface 210 3 0
    //   387: pop
    //   388: aload 14
    //   390: aload 15
    //   392: invokevirtual 231	org/apache/http/client/methods/HttpGet:setParams	(Lorg/apache/http/params/HttpParams;)V
    //   395: iconst_0
    //   396: istore 6
    //   398: iconst_0
    //   399: istore 9
    ...
    //   407: aload 15
    //   409: ldc 199
    //   411: invokeinterface 234 2 0
    //   416: pop
    //   417: aload 14
    //   419: aload 15
    //   421: invokevirtual 231	org/apache/http/client/methods/HttpGet:setParams	(Lorg/apache/http/params/HttpParams;)V
    //   424: iload 6
    //   426: iconst_1
    //   427: iadd
    //   428: istore 7
    //   430: new 181	org/apache/http/params/BasicHttpParams
    //   433: dup
    //   434: invokespecial 182	org/apache/http/params/BasicHttpParams:<init>	()V
    //   437: astore 5
    //   439: aload 5
    //   441: getstatic 240	org/apache/http/HttpVersion:HTTP_1_1	Lorg/apache/http/HttpVersion;
    //   444: invokestatic 246	org/apache/http/params/HttpProtocolParams:setVersion	(Lorg/apache/http/params/HttpParams;Lorg/apache/http/ProtocolVersion;)V
    //   447: aload 5
    //   449: ldc 248
    //   451: invokestatic 252	org/apache/http/params/HttpProtocolParams:setContentCharset	(Lorg/apache/http/params/HttpParams;Ljava/lang/String;)V
    //   454: aload 5
    //   456: iconst_1
    //   457: invokestatic 256	org/apache/http/params/HttpProtocolParams:setUseExpectContinue	(Lorg/apache/http/params/HttpParams;Z)V
    //   460: new 258	org/apache/http/conn/scheme/SchemeRegistry
    //   463: dup
    //   464: invokespecial 259	org/apache/http/conn/scheme/SchemeRegistry:<init>	()V
    //   467: astore 16
    //   469: aload 16
    //   471: new 261	org/apache/http/conn/scheme/Scheme
    //   474: dup
    //   475: ldc_w 263
    //   478: invokestatic 269	org/apache/http/conn/scheme/PlainSocketFactory:getSocketFactory	()Lorg/apache/http/conn/scheme/PlainSocketFactory;
    //   481: bipush 80
    //   483: invokespecial 272	org/apache/http/conn/scheme/Scheme:<init>	(Ljava/lang/String;Lorg/apache/http/conn/scheme/SocketFactory;I)V
    //   486: invokevirtual 276	org/apache/http/conn/scheme/SchemeRegistry:register	(Lorg/apache/http/conn/scheme/Scheme;)Lorg/apache/http/conn/scheme/Scheme;
    //   489: pop
    //   490: new 278	org/apache/http/impl/client/DefaultHttpClient
    //   493: dup
    //   494: new 280	org/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager
    //   497: dup
    //   498: aload 5
    //   500: aload 16
    //   502: invokespecial 283	org/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager:<init>	(Lorg/apache/http/params/HttpParams;Lorg/apache/http/conn/scheme/SchemeRegistry;)V
    //   505: aload 5
    //   507: invokespecial 286	org/apache/http/impl/client/DefaultHttpClient:<init>	(Lorg/apache/http/conn/ClientConnectionManager;Lorg/apache/http/params/HttpParams;)V
    ...
    //   516: new 288	org/apache/http/impl/client/DefaultHttpRequestRetryHandler
    //   519: dup
    //   520: invokespecial 289	org/apache/http/impl/client/DefaultHttpRequestRetryHandler:<init>	()V
    //   523: invokevirtual 293	org/apache/http/impl/client/DefaultHttpClient:setHttpRequestRetryHandler	(Lorg/apache/http/client/HttpRequestRetryHandler;)V
    ...
    //   529: new 201	org/apache/http/HttpHost
    //   532: dup
    //   533: aload_1
    //   534: invokevirtual 296	java/net/URL:getHost	()Ljava/lang/String;
    //   537: invokespecial 297	org/apache/http/HttpHost:<init>	(Ljava/lang/String;)V
    //   540: aload 14
    //   542: invokevirtual 301	org/apache/http/impl/client/DefaultHttpClient:execute	(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;)Lorg/apache/http/HttpResponse;
    //   545: astore 5
    //   547: iload 9
    //   549: istore 8
    //   551: sipush 200
    //   554: aload 5
    //   556: invokeinterface 307 1 0
    //   561: invokeinterface 312 1 0
    //   566: if_icmpne +109 -> 675
    //   569: aload 5
    //   571: invokeinterface 316 1 0
    //   576: astore 5
    //   578: aload 5
    //   580: invokeinterface 322 1 0
    //   585: pop2
    //   586: new 115	java/io/FileOutputStream
    //   589: dup
    //   590: aload 11
    //   592: invokespecial 118	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   595: astore 16
    //   597: aload 5
    //   599: aload 16
    //   601: invokeinterface 326 2 0
    //   606: aload 11
    //   608: invokevirtual 329	java/io/File:length	()J
    //   611: pop2
    //   612: aload 11
    //   614: invokestatic 334	java/lang/System:currentTimeMillis	()J
    //   617: invokevirtual 338	java/io/File:setLastModified	(J)Z
    //   620: pop
    //   621: aload 16
    //   623: invokevirtual 341	java/io/OutputStream:close	()V
    //   626: aload 12
    //   628: invokestatic 345	com/tencent/open/base/MD5Utils:a	(Ljava/lang/String;)Ljava/lang/String;
    //   631: aload_3
    //   632: invokevirtual 348	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   635: ifeq +171 -> 806
    //   638: ldc_w 350
    //   641: iconst_1
    //   642: ldc_w 352
    //   645: invokestatic 358	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   648: iload 4
    //   650: iconst_1
    ...
    //   657: iconst_2
    //   658: ldc_w 360
    //   661: invokestatic 358	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   664: aload_0
    //   665: aload 12
    //   667: aload 13
    //   669: invokespecial 362	com/tencent/mobileqq/antiphing/DownloadFileHelper:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   672: iconst_1
    //   673: istore 8
    ...
    //   684: invokevirtual 366	org/apache/http/impl/client/DefaultHttpClient:getConnectionManager	()Lorg/apache/http/conn/ClientConnectionManager;
    //   687: invokeinterface 371 1 0
    //   692: aconst_null
    ...
    //   724: ireturn
    //   725: astore 14
    //   727: new 178	org/apache/http/client/methods/HttpGet
    //   730: dup
    //   731: aload 15
    //   733: invokestatic 372	com/tencent/mobileqq/antiphing/DownloadFileHelper:a	(Ljava/lang/String;)Ljava/lang/String;
    //   736: invokespecial 179	org/apache/http/client/methods/HttpGet:<init>	(Ljava/lang/String;)V
    //   739: astore 14
    //   741: goto -508 -> 233
    //   744: astore_1
    //   745: iconst_0
    ...
    //   759: ldc 213
    //   761: sipush 4096
    //   764: invokeinterface 217 3 0
    //   769: pop
    //   770: goto -412 -> 358
    //   773: ldc_w 350
    //   776: iconst_2
    //   777: ldc_w 374
    //   780: invokestatic 358	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   783: aload_2
    //   784: invokevirtual 113	java/io/File:exists	()Z
    //   787: ifeq +8 -> 795
    //   790: aload_2
    //   791: invokevirtual 175	java/io/File:delete	()Z
    //   794: pop
    //   795: aload 11
    //   797: aload_2
    //   798: invokevirtual 378	java/io/File:renameTo	(Ljava/io/File;)Z
    //   801: istore 8
    //   803: goto -128 -> 675
    //   806: ldc_w 350
    //   809: iconst_1
    //   810: ldc_w 380
    //   813: invokestatic 358	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   816: iload 9
    //   818: istore 10
    ...
    //   829: invokevirtual 366	org/apache/http/impl/client/DefaultHttpClient:getConnectionManager	()Lorg/apache/http/conn/ClientConnectionManager;
    //   832: invokeinterface 371 1 0
    //   837: aconst_null
    ...
    //   844: astore_1
    //   845: aload_1
    //   846: invokevirtual 154	java/lang/Exception:printStackTrace	()V
    //   849: iload 9
    //   851: istore 10
    ...
    //   862: invokevirtual 366	org/apache/http/impl/client/DefaultHttpClient:getConnectionManager	()Lorg/apache/http/conn/ClientConnectionManager;
    //   865: invokeinterface 371 1 0
    //   870: aconst_null
    ...
    //   877: astore_1
    //   878: aload_1
    //   879: invokevirtual 154	java/lang/Exception:printStackTrace	()V
    //   882: iload 9
    //   884: istore 10
    ...
    //   895: invokevirtual 366	org/apache/http/impl/client/DefaultHttpClient:getConnectionManager	()Lorg/apache/http/conn/ClientConnectionManager;
    //   898: invokeinterface 371 1 0
    //   903: aconst_null
    ...
    //   920: invokevirtual 366	org/apache/http/impl/client/DefaultHttpClient:getConnectionManager	()Lorg/apache/http/conn/ClientConnectionManager;
    //   923: invokeinterface 371 1 0
    //   928: aconst_null
