...
public class PicReporter
{
  ...
  private static final String jdField_a_of_type_JavaLangString = "preload_status";
  ...
  {
    boolean bool = SettingCloneUtil.readValue(BaseApplication.getContext(), null, BaseApplication.getContext().getString(2131563451), "qqsetting_auto_receive_pic_key", true);
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("param_state", String.valueOf(paramBoolean));
    localHashMap.put("param_type", paramString);
    StatisticCollector.a(BaseApplication.getContext()).a(null, "act_Pic_Message_has_Width_Height", false, 0L, 0L, localHashMap, "");
  }
