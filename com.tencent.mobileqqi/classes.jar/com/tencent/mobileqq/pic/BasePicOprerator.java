...
public abstract class BasePicOprerator
  implements DownCallBack, InfoBuilder, UpCallBack, gdw
{
  ...
  public BasePicOprerator(QQAppInterface paramQQAppInterface)
  {
    ...
    if (this.jdField_a_of_type_AndroidOsHandler == null) {
      this.jdField_a_of_type_AndroidOsHandler = new gds(this, Looper.getMainLooper());
    }
  }
  ...
  {
    new gdt(this, paramPicFowardInfo).execute(new Void[0]);
  }
  
  private void b(PicUploadInfo paramPicUploadInfo)
  {
    new gdu(this, paramPicUploadInfo).execute(new Void[0]);
  }
