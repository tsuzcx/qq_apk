...
public class Utils
{
  ...
  private static gio a(int paramInt1, int paramInt2)
  {
    int i = 0;
    int j = 1;
    ...
    for (;;)
    {
      gio localgio = new gio(null);
      localgio.a = paramInt2;
      localgio.b = paramInt1;
      Logger.a("compress.Utils", "getType()", " type=" + localgio);
      return localgio;
      paramInt1 = 2;
      paramInt2 = 2;
      continue;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        default: 
          ...
          bool2 = true;
          Logger.a("compress.Utils", "compressAIOThumbnail()", paramString3 + " sample after W:" + n + " H:" + i1 + " isLongImg:" + a(0, 0) + " type:" + localgio + " needRotate:" + bool2);
          if (j <= i) {
            break label913;
          }
          i3 = j;
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError localOutOfMemoryError2)
        {
          ...
          Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " cut 3:1 createBitmap OutOfMemoryError, type:" + localgio);
          continue;
        }
        ...
        for (;;)
        {
          ...
          catch (OutOfMemoryError paramString1)
          {
            ...
            catch (OutOfMemoryError paramString1)
            {
              ...
              localBitmap.recycle();
              paramString1.printStackTrace();
              Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " case 1: cut createBitmap OutOfMemoryError, type:" + localgio);
              return false;
            }
            ...
            paramString1.printStackTrace();
            Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " case 1: scale or rotate createBitmap OutOfMemoryError, type:" + localgio);
            return false;
          }
          j = k;
          i = i2;
          ...
          for (j = k;; j = m)
          {
            for (;;)
            {
              ...
              catch (OutOfMemoryError paramString1)
              {
                ...
                ((Bitmap)localObject2).recycle();
                paramString1.printStackTrace();
                Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " case 2: scale or rotate createBitmap OutOfMemoryError, type:" + localgio);
                return false;
              }
            }
            i = k;
          ...
          catch (OutOfMemoryError paramString1)
          {
            ...
            paramString1.printStackTrace();
            Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " case 3: rotate createBitmap OutOfMemoryError, type:" + localgio);
            return false;
          }
        }
        if (bool2) {
        ...
        for (;;)
        {
          ...
          catch (OutOfMemoryError paramString1)
          {
            ...
            catch (OutOfMemoryError paramString2)
            {
              ...
              Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " case 4: cut createBitmap OutOfMemoryError, type:" + localgio);
              return false;
            }
            paramString1 = paramString1;
            if (localObject2 != null) {
            ...
            paramString1.printStackTrace();
            Logger.b("compress.Utils", "compressAIOThumbnail()", paramString3 + " case 4: rotate createBitmap OutOfMemoryError, type:" + localgio);
            return false;
          }
          i = m;
          j = k;
