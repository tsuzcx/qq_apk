  ...
  extends BaseStrategy
{
  ...
  public static long i = 1364283891L;
  ...
  {
    super.a();
    i = PicPreDownloadUtils.a(this.a, "PreDownPolicy", 1364283891L);
    Logger.a("PIC_TAG_PRELOAD", "", "getServerConfigValue", "maxPreDownPolicy:" + i);
  }
  ...
  {
    int j = PicPreDownloadUtils.a(paramInt2, paramInt1, 0);
    int k = PicPreDownloadUtils.a(paramInt2, paramInt1, 1);
    boolean bool1;
    if ((i >> j & 1L) == 1L)
    {
      bool1 = true;
