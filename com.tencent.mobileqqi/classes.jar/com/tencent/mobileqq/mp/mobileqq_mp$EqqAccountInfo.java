  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40, 50, 56, 66 }, new String[] { "uin", "name", "display_number", "summary", "certified_grade", "logo", "luin", "config_group_info" }, new Object[] { Integer.valueOf(0), "", "", "", Integer.valueOf(0), "", Long.valueOf(0L), null }, EqqAccountInfo.class);
