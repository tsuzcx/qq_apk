...
public class ThridAppShareHelper
{
  ...
  public void a(Context paramContext, String paramString1, String paramString2, SessionInfo paramSessionInfo)
  {
    ...
    if (!DataProviderApi.b(paramContext, localThirdAppInfo.c, paramString1, "android.intent.action.VIEW", "com.tencent.mobileqqi", "com.tencent.mobileqq.activity.ChatActivity"))
    {
      if (!DataProviderApi.b(paramContext, localThirdAppInfo.d, paramString1, "android.intent.action.VIEW", "com.tencent.mobileqqi", "com.tencent.mobileqq.activity.ChatActivity"))
      {
  ...
  public boolean a(Intent paramIntent, Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          return false;
        } while (!"thridapp".equals(paramIntent.getStringExtra("share_from")));
      ...
      paramIntent.A = String.valueOf(localLong);
