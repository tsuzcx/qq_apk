...
public class PAMessageUtil
{
  ...
  private static final String B = "rflag";
  ...
  public static final String k = "actionData";
  public static final String l = "a_actionData";
  public static final String m = "i_actionData";
  ...
  public static final String v = "iosurl";
  public static final String w = "androidurl";
  public static final String x = "needlogin";
  private static final String y = "nativejump";
  ...
  public static com.tencent.mobileqq.data.PAMessage a(String paramString)
  {
    ...
    //   11: aload 5
    //   13: areturn
    //   14: invokestatic 275	javax/xml/parsers/DocumentBuilderFactory:newInstance	()Ljavax/xml/parsers/DocumentBuilderFactory;
    //   17: invokevirtual 279	javax/xml/parsers/DocumentBuilderFactory:newDocumentBuilder	()Ljavax/xml/parsers/DocumentBuilder;
    //   20: astore 7
    //   22: aload 6
    //   24: astore 5
    //   26: aload 7
    //   28: ifnull -17 -> 11
    //   31: new 281	java/io/ByteArrayInputStream
    //   34: dup
    //   35: aload_0
    //   36: invokevirtual 285	java/lang/String:getBytes	()[B
    //   39: invokespecial 288	java/io/ByteArrayInputStream:<init>	([B)V
    //   42: astore_0
    //   43: aload 7
    //   45: aload_0
    //   46: invokevirtual 294	javax/xml/parsers/DocumentBuilder:parse	(Ljava/io/InputStream;)Lorg/w3c/dom/Document;
    //   49: astore_0
    //   50: aload 6
    //   52: astore 5
    //   54: aload_0
    //   55: ifnull -44 -> 11
    //   58: aload_0
    //   59: invokeinterface 300 1 0
    //   64: astore 5
    //   66: new 302	com/tencent/mobileqq/data/PAMessage
    //   69: dup
    //   70: invokespecial 303	com/tencent/mobileqq/data/PAMessage:<init>	()V
    //   73: astore_0
    //   74: aload_0
    //   75: new 142	java/util/ArrayList
    //   78: dup
    //   79: invokespecial 143	java/util/ArrayList:<init>	()V
    //   82: putfield 307	com/tencent/mobileqq/data/PAMessage:items	Ljava/util/ArrayList;
    //   85: aload 5
    ...
    //   112: aload 6
    //   114: iload_1
    //   115: invokeinterface 121 2 0
    //   120: astore 5
    //   122: aload 5
    //   124: invokestatic 124	com/tencent/biz/pubaccount/util/PAMessageUtil:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   127: astore 7
    //   129: aload 5
    //   131: invokeinterface 128 1 0
    //   136: ldc 24
    //   138: invokevirtual 134	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   141: ifeq +43 -> 184
    //   144: aload_0
    //   145: aload 7
    //   147: invokestatic 249	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   150: invokevirtual 252	java/lang/Integer:intValue	()I
    //   153: putfield 309	com/tencent/mobileqq/data/PAMessage:type	I
    //   156: iload_1
    //   157: iconst_1
    //   158: iadd
    //   159: istore_1
    ...
    //   163: astore_0
    //   164: aload_0
    //   165: invokevirtual 312	javax/xml/parsers/ParserConfigurationException:printStackTrace	()V
    //   168: aconst_null
    //   169: areturn
    //   170: astore_0
    //   171: aload_0
    //   172: invokevirtual 313	org/xml/sax/SAXException:printStackTrace	()V
    //   175: aconst_null
    //   176: areturn
    //   177: astore_0
    //   178: aload_0
    //   179: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   182: aconst_null
    //   183: areturn
    //   184: aload 5
    //   186: invokeinterface 128 1 0
    //   191: ldc 31
    //   193: invokevirtual 134	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   196: ifeq +74 -> 270
    //   199: aload 5
    ...
    //   225: aload 5
    //   227: iload_2
    //   228: invokeinterface 121 2 0
    //   233: astore 7
    //   235: aload 7
    //   237: invokeinterface 318 1 0
    //   242: iconst_1
    //   243: if_icmpne +20 -> 263
    //   246: aload 7
    //   248: invokestatic 320	com/tencent/biz/pubaccount/util/PAMessageUtil:a	(Lorg/w3c/dom/Node;)Lcom/tencent/mobileqq/data/PAMessage$Item;
    //   251: astore 7
    //   253: aload_0
    //   254: getfield 307	com/tencent/mobileqq/data/PAMessage:items	Ljava/util/ArrayList;
    //   257: aload 7
    //   259: invokevirtual 321	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   262: pop
    //   263: iload_2
    //   264: iconst_1
    //   265: iadd
    ...
    //   277: ldc 27
    //   279: invokevirtual 134	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   282: ifeq -126 -> 156
    //   285: aload 5
    //   287: invokeinterface 111 1 0
    //   292: astore 5
    //   294: aload 5
    //   296: invokeinterface 117 1 0
    //   301: istore 4
    //   303: iconst_0
    //   304: istore_2
    //   305: iload_2
    ...
    //   311: aload 5
    //   313: iload_2
    //   314: invokeinterface 121 2 0
    //   319: astore 8
    //   321: aload 8
    //   323: invokestatic 124	com/tencent/biz/pubaccount/util/PAMessageUtil:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   326: astore 7
    //   328: aload 8
    //   330: invokeinterface 128 1 0
    //   335: astore 8
    //   337: aload 8
    //   339: ldc 61
    //   341: invokevirtual 325	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   344: ifeq +18 -> 362
    //   347: aload_0
    //   348: aload 7
    //   350: invokestatic 228	java/lang/Long:valueOf	(Ljava/lang/String;)Ljava/lang/Long;
    //   353: invokevirtual 232	java/lang/Long:longValue	()J
    //   356: putfield 328	com/tencent/mobileqq/data/PAMessage:sendTime	J
    //   359: goto -203 -> 156
    //   362: aload 8
    //   364: ldc 92
    //   366: invokevirtual 325	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   369: ifeq +9 -> 378
    //   372: aload_0
    //   373: aload 7
    //   375: putfield 331	com/tencent/mobileqq/data/PAMessage:moreText	Ljava/lang/String;
    //   378: iload_2
    //   379: iconst_1
    //   380: iadd
    //   381: istore_2
  ...
  public static com.tencent.mobileqq.data.PAMessage a(byte[] paramArrayOfByte)
  {
    ...
    //   4: aconst_null
    //   5: areturn
    //   6: new 281	java/io/ByteArrayInputStream
    //   9: dup
    //   10: aload_0
    //   11: invokespecial 288	java/io/ByteArrayInputStream:<init>	([B)V
    //   14: astore_3
    //   15: new 338	java/io/ObjectInputStream
    //   18: dup
    //   19: aload_3
    //   20: invokespecial 341	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   23: astore_1
    //   24: aload_1
    //   25: astore_0
    //   26: aload_1
    //   27: invokevirtual 345	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   30: checkcast 302	com/tencent/mobileqq/data/PAMessage
    //   33: astore_2
    //   34: aload_1
    //   35: ifnull +7 -> 42
    //   38: aload_1
    //   39: invokevirtual 348	java/io/ObjectInputStream:close	()V
    //   42: aload_3
    //   43: invokevirtual 349	java/io/ByteArrayInputStream:close	()V
    //   46: aload_2
    //   47: astore_0
    //   48: aload_0
    //   49: areturn
    //   50: astore_0
    //   51: aload_0
    //   52: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   55: aload_2
    //   56: astore_0
    //   57: goto -9 -> 48
    //   60: astore_2
    ...
    //   64: astore_0
    //   65: aload_2
    //   66: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   69: aload_1
    //   70: ifnull +7 -> 77
    //   73: aload_1
    //   74: invokevirtual 348	java/io/ObjectInputStream:close	()V
    //   77: aload_3
    //   78: invokevirtual 349	java/io/ByteArrayInputStream:close	()V
    //   81: aconst_null
    //   82: astore_0
    //   83: goto -35 -> 48
    //   86: astore_0
    //   87: aload_0
    //   88: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   91: aconst_null
    //   92: astore_0
    //   93: goto -45 -> 48
    //   96: astore_2
    ...
    //   100: astore_0
    //   101: aload_2
    //   102: invokevirtual 350	java/lang/ClassNotFoundException:printStackTrace	()V
    //   105: aload_1
    //   106: ifnull +7 -> 113
    //   109: aload_1
    //   110: invokevirtual 348	java/io/ObjectInputStream:close	()V
    //   113: aload_3
    //   114: invokevirtual 349	java/io/ByteArrayInputStream:close	()V
    //   117: aconst_null
    //   118: astore_0
    //   119: goto -71 -> 48
    //   122: astore_0
    //   123: aload_0
    //   124: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   127: aconst_null
    //   128: astore_0
    //   129: goto -81 -> 48
    //   132: astore_2
    ...
    //   136: astore_0
    //   137: aload_2
    //   138: invokevirtual 351	java/lang/OutOfMemoryError:printStackTrace	()V
    //   141: aload_1
    //   142: ifnull +7 -> 149
    //   145: aload_1
    //   146: invokevirtual 348	java/io/ObjectInputStream:close	()V
    //   149: aload_3
    //   150: invokevirtual 349	java/io/ByteArrayInputStream:close	()V
    //   153: aconst_null
    //   154: astore_0
    //   155: goto -107 -> 48
    //   158: astore_0
    //   159: aload_0
    //   160: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   163: aconst_null
    //   164: astore_0
    //   165: goto -117 -> 48
    //   168: astore_2
    ...
    //   172: astore_0
    //   173: aload_2
    //   174: invokevirtual 352	java/lang/Exception:printStackTrace	()V
    //   177: aload_1
    //   178: ifnull +7 -> 185
    //   181: aload_1
    //   182: invokevirtual 348	java/io/ObjectInputStream:close	()V
    //   185: aload_3
    //   186: invokevirtual 349	java/io/ByteArrayInputStream:close	()V
    //   189: aconst_null
    //   190: astore_0
    //   191: goto -143 -> 48
    //   194: astore_0
    //   195: aload_0
    //   196: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   199: aconst_null
    //   200: astore_0
    //   201: goto -153 -> 48
    //   204: astore_1
    ...
    //   208: ifnull +7 -> 215
    //   211: aload_0
    //   212: invokevirtual 348	java/io/ObjectInputStream:close	()V
    //   215: aload_3
    //   216: invokevirtual 349	java/io/ByteArrayInputStream:close	()V
    //   219: aload_1
    //   220: athrow
    //   221: astore_0
    //   222: aload_0
    //   223: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   226: goto -7 -> 219
    //   229: astore_1
    //   230: goto -23 -> 207
    //   233: astore_2
  ...
  public static byte[] a(com.tencent.mobileqq.data.PAMessage paramPAMessage)
  {
    ...
    //   4: aconst_null
    //   5: areturn
    //   6: new 379	java/io/ByteArrayOutputStream
    //   9: dup
    //   10: invokespecial 380	java/io/ByteArrayOutputStream:<init>	()V
    //   13: astore_3
    //   14: new 382	java/io/ObjectOutputStream
    //   17: dup
    //   18: aload_3
    //   19: invokespecial 385	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   22: astore_2
    //   23: aload_2
    //   24: astore_1
    //   25: aload_2
    //   26: aload_0
    //   27: invokevirtual 389	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   30: aload_2
    //   31: astore_1
    //   32: aload_3
    //   33: invokevirtual 392	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   36: astore_0
    //   37: aload_2
    //   38: ifnull +7 -> 45
    //   41: aload_2
    //   42: invokevirtual 393	java/io/ObjectOutputStream:close	()V
    //   45: aload_3
    //   46: invokevirtual 394	java/io/ByteArrayOutputStream:close	()V
    //   49: aload_0
    //   50: areturn
    //   51: astore_1
    //   52: aload_1
    //   53: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   56: aload_0
    //   57: areturn
    //   58: astore_0
    //   59: aconst_null
    ...
    //   62: astore_1
    //   63: aload_0
    //   64: invokevirtual 351	java/lang/OutOfMemoryError:printStackTrace	()V
    //   67: aload_2
    //   68: ifnull +7 -> 75
    //   71: aload_2
    //   72: invokevirtual 393	java/io/ObjectOutputStream:close	()V
    //   75: aload_3
    //   76: invokevirtual 394	java/io/ByteArrayOutputStream:close	()V
    //   79: aconst_null
    //   80: areturn
    //   81: astore_0
    //   82: aload_0
    //   83: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   86: aconst_null
    //   87: areturn
    //   88: astore_0
    //   89: aconst_null
    ...
    //   92: astore_1
    //   93: aload_0
    //   94: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   97: aload_2
    //   98: ifnull +7 -> 105
    //   101: aload_2
    //   102: invokevirtual 393	java/io/ObjectOutputStream:close	()V
    //   105: aload_3
    //   106: invokevirtual 394	java/io/ByteArrayOutputStream:close	()V
    //   109: aconst_null
    //   110: areturn
    //   111: astore_0
    //   112: aload_0
    //   113: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   116: aconst_null
    //   117: areturn
    //   118: astore_0
    //   119: aconst_null
    ...
    //   122: ifnull +7 -> 129
    //   125: aload_1
    //   126: invokevirtual 393	java/io/ObjectOutputStream:close	()V
    //   129: aload_3
    //   130: invokevirtual 394	java/io/ByteArrayOutputStream:close	()V
    //   133: aload_0
    //   134: athrow
    //   135: astore_1
    //   136: aload_1
    //   137: invokevirtual 314	java/io/IOException:printStackTrace	()V
    //   140: goto -7 -> 133
    //   143: astore_0
    //   144: goto -23 -> 121
    //   147: astore_0
