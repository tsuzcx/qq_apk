...
public class PubAccountAssistantManager
{
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        ...
        if (Math.max(paramPubAccountAssistantData.mLastMsgTime, paramPubAccountAssistantData.mLastDraftTime) > Math.max(localPubAccountAssistantData.mLastMsgTime, localPubAccountAssistantData.mLastDraftTime))
        {
          ...
          ??? = (ProxyManager)paramQQAppInterface.getManager(16);
  ...
  private boolean a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong)
  {
    ...
    case 2: 
      ...
      if (k != 0)
      {
        localObject = localRecentUserProxy.a(AppConstants.af, 7200);
        ((RecentUser)localObject).uin = AppConstants.af;
        ...
        PubAccountAssistantData localPubAccountAssistantData = a(paramQQAppInterface);
        if (localPubAccountAssistantData != null)
        {
          ((RecentUser)localObject).lastmsgtime = localPubAccountAssistantData.mLastMsgTime;
          ((RecentUser)localObject).lastmsgdrafttime = localPubAccountAssistantData.mLastDraftTime;
        }
    ...
    for (;;)
    {
      try
      {
        ((RecentManagerFor3rdPart)paramQQAppInterface.getManager(31)).a(AppConstants.af, 7200, System.currentTimeMillis() / 1000L);
      ...
      paramInt = 0;
      break;
      localObject = localRecentUserProxy.b(AppConstants.af, 7200);
      if (localObject != null) {
    ...
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList == null)
      {
        ...
        if (k != 0)
        {
          ...
          a((EntityManager)???);
          ((EntityManager)???).a();
          paramQQAppInterface = ((PublicAccountDataManager)paramQQAppInterface.getManager(51)).a();
      ...
      if (((List)localObject1).size() > 0)
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          for (((PubAccountAssistantData)localObject3).mLastMsgTime = localMessage.time;; ((PubAccountAssistantData)localObject3).mLastMsgTime = ((RecentUser)localObject2).lastmsgtime)
          {
            ...
            e(((PubAccountAssistantData)localObject3).mUin, paramQQAppInterface);
            break;
          }
        }
      }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    if (!this.d) {
      try
      {
        Object localObject = (PublicAccountDataManager)paramQQAppInterface.getManager(51);
        if (localObject != null)
        {
          this.d = true;
          if (paramQQAppInterface != null) {
  ...
  public void g(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((??? != null) && (((List)???).size() > 0))
    {
      ...
      while (((Iterator)???).hasNext())
      {
        ...
        if (((((RecentUser)localObject4).type == 1008) || (((RecentUser)localObject4).type == 1024)) && (a(paramQQAppInterface, ((RecentUser)localObject4).uin)) && (!((RecentUser)localObject4).shouldShowInRecentList())) {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (a(localEntityManager, ((PubAccountAssistantData)???).mUin))
        {
          ...
          for (localObject1 = null;; localObject1 = (PublicAccountInfo)this.jdField_b_of_type_JavaUtilMap.get(((PubAccountAssistantData)???).mUin))
          {
            ...
            d(((PubAccountAssistantData)???).mUin, paramQQAppInterface);
            break;
          }
        }
      }
