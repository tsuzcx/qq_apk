...
public class CodeMaskManager
{
  ...
  static
  {
    if (SystemUtil.a())
    {
      jdField_b_of_type_JavaLangString = AppConstants.an + "qbiz/qrcode/";
      return;
    }
  ...
  private Bitmap a(String paramString)
  {
    ...
    Object localObject1 = HttpUtil.a(this.jdField_a_of_type_AndroidAppActivity, (String)localObject1, "GET", null, null);
  ...
  private boolean a(String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   19: invokevirtual 395	java/io/File:mkdirs	()Z
    //   22: pop
    ...
    //   47: invokespecial 392	java/io/File:<init>	(Ljava/lang/String;)V
    //   50: astore_1
    //   51: aload_1
    //   52: invokevirtual 398	java/io/File:exists	()Z
    //   55: ifne +8 -> 63
    //   58: aload_1
    //   59: invokevirtual 401	java/io/File:createNewFile	()Z
    //   62: pop
    //   63: new 403	java/io/FileOutputStream
    //   66: dup
    //   67: aload_1
    //   68: invokespecial 406	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   71: astore_1
    //   72: aload_1
    //   73: aload_2
    //   74: invokevirtual 410	java/io/FileOutputStream:write	([B)V
    //   77: aload_1
    //   78: ifnull +7 -> 85
    //   81: aload_1
    //   82: invokevirtual 413	java/io/FileOutputStream:close	()V
    //   85: iconst_0
    //   86: ireturn
    //   87: iconst_0
    //   88: ifeq -3 -> 85
    ...
    //   123: ifnull -38 -> 85
    //   126: aload_1
    //   127: invokevirtual 413	java/io/FileOutputStream:close	()V
    //   130: iconst_0
    //   131: ireturn
    //   132: astore_1
    //   133: iconst_0
