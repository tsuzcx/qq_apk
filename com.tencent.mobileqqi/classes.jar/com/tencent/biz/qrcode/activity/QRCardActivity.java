  ...
  implements View.OnClickListener
{
  ...
  public Handler a;
  private View.OnLongClickListener jdField_a_of_type_AndroidViewView$OnLongClickListener = new blw(this);
  protected Button a;
  public ImageView a;
  ...
  public QRCardActivity()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new blo(this);
  }
  ...
  private void a(Context paramContext, int paramInt, String paramString1, String paramString2)
  {
    ...
    if (paramInt == 2)
    {
      ...
      String str = this.jdField_a_of_type_AndroidContentResResources.getString(2131560470);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(str, 0);
      str = this.jdField_a_of_type_AndroidContentResResources.getString(2131560471);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(str, 0);
    }
    if (paramInt == 0)
    {
      arrayOfBoolean[1] = true;
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(this.jdField_a_of_type_AndroidContentResResources.getString(2131561727), 1);
    }
    if (paramInt == 4)
    {
      arrayOfBoolean[2] = true;
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(this.jdField_a_of_type_AndroidContentResResources.getString(2131560472), 1);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(this.jdField_a_of_type_AndroidContentResResources.getString(2131560473), 1);
    }
    if (paramInt == 3)
    {
      arrayOfBoolean[3] = true;
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(2131561727, 1);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(2131561879, 1);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(2131561597, 1);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(2131562263, 1);
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(String.format(paramContext.getString(2131561504), new Object[] { paramString1 }));
    }
    this.jdField_a_of_type_ComTencentWidgetActionSheet.a(new blq(this, arrayOfBoolean, paramString2, paramContext, paramString1));
    this.jdField_a_of_type_ComTencentWidgetActionSheet.d(2131561746);
    this.jdField_a_of_type_ComTencentWidgetActionSheet.setOnDismissListener(new bls(this));
        ...
        if ((localObject4 != null) && (localObject4.length > 0))
        {
          ...
          if (localObject4.length > 1)
          {
            ...
            for (;;)
            {
              ...
              localObject6 = ((LayoutInflater)localObject1).inflate(2130903437, null);
              ((View)localObject6).setTag(Integer.valueOf(0));
              localTextView = (TextView)((View)localObject6).findViewById(2131231118);
              ((TextView)((View)localObject6).findViewById(2131230941)).setText((CharSequence)localObject3);
          ...
          localObject4 = ((LayoutInflater)localObject1).inflate(2130903437, null);
          ((View)localObject4).setTag(Integer.valueOf(0));
          localObject6 = (TextView)((View)localObject4).findViewById(2131231118);
          ((TextView)((View)localObject4).findViewById(2131230941)).setText((CharSequence)localObject3);
    ...
    if (!this.jdField_a_of_type_ComTencentBizQrcodeUtilQRCard.b.isEmpty())
    {
        ...
        if ((localObject4 != null) && (localObject4.length > 0))
        {
          ...
          if (localObject4.length > 1)
          {
            ...
            for (;;)
            {
              ...
              localObject6 = ((LayoutInflater)localObject1).inflate(2130903435, null);
              localTextView = (TextView)((View)localObject6).findViewById(2131231118);
              ((TextView)((View)localObject6).findViewById(2131230941)).setText((CharSequence)localObject3);
              localTextView.setText((CharSequence)localObject5);
          ...
          localObject4 = ((LayoutInflater)localObject1).inflate(2130903435, null);
          localObject6 = (TextView)((View)localObject4).findViewById(2131231118);
          ((TextView)((View)localObject4).findViewById(2131230941)).setText((CharSequence)localObject3);
          ((TextView)localObject6).setText((CharSequence)localObject5);
      ...
      if (paramInt == 1)
      {
        ...
        if (!this.jdField_a_of_type_ComTencentBizQrcodeUtilQRCard.f.isEmpty())
        {
          ...
          localObject5 = (TextView)((View)localObject4).findViewById(2131231118);
          ((TextView)((View)localObject4).findViewById(2131230941)).setText((CharSequence)localObject2);
        ...
        {
          localObject1 = ((LayoutInflater)localObject1).inflate(2130903435, null);
          localObject2 = (TextView)((View)localObject1).findViewById(2131231118);
          localObject3 = (TextView)((View)localObject1).findViewById(2131230941);
  ...
  private void d()
  {
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131231090));
    ...
    if (TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString))
    {
      if (!TextUtils.isEmpty(this.p)) {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentResResources.getString(2131560486) + ": " + this.p);
      }
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      {
        this.jdField_a_of_type_JavaLangThread = new Thread(new blp(this));
        this.jdField_a_of_type_JavaLangThread.start();
      }
      e();
      return;
      this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentResResources.getString(2131560485) + ": " + this.jdField_c_of_type_JavaLangString);
      if (TextUtils.isEmpty(this.p)) {
        break;
      }
      this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentResResources.getString(2131560486) + ": " + this.p);
      break;
    }
  }
  ...
  public void a()
  {
    ...
    this.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_AndroidContentResResources.getString(2131560475);
    this.e = this.jdField_a_of_type_AndroidContentResResources.getString(2131560474);
    this.f = this.jdField_a_of_type_AndroidContentResResources.getString(2131560476);
    this.g = this.jdField_a_of_type_AndroidContentResResources.getString(2131560479);
    this.h = this.jdField_a_of_type_AndroidContentResResources.getString(2131560478);
    this.i = this.jdField_a_of_type_AndroidContentResResources.getString(2131560477);
    this.j = this.jdField_a_of_type_AndroidContentResResources.getString(2131560481);
    this.k = this.jdField_a_of_type_AndroidContentResResources.getString(2131560480);
    this.l = this.jdField_a_of_type_AndroidContentResResources.getString(2131560484);
    this.m = this.jdField_a_of_type_AndroidContentResResources.getString(2131560482);
    this.jdField_d_of_type_Int = super.getResources().getColor(2131361846);
  ...
  public void a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        paramView.setOnClickListener(new blv(this));
  ...
  public void a(String paramString)
  {
    ...
    localQQCustomDialog.setTitle(2131560527);
    localQQCustomDialog.setMessage(paramString);
    blt localblt = new blt(this);
    localQQCustomDialog.setPositiveButton(2131562539, new blu(this, paramString));
    localQQCustomDialog.setNegativeButton(2131561746, localblt);
