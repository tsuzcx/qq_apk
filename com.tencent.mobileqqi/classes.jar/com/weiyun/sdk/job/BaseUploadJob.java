  ...
  extends BaseJob
{
  ...
  {
    String str1 = this.mJobContext.getSrcPath();
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        Log.e("BaseUploadJob", "file is modified always. file=" + str1);
        ...
        this.mJobContext.setTotalSize(Utils.getFileSize(str1));
        this.mJobContext.setCurSize(0L);
        String str2 = HashSumCalc.getMD5Hash(str1, this);
        String str3 = HashSumCalc.getSHA1Hash(str1, this);
        if ((str2 != null) && (!str2.equals("")))
        {
          this.mJobContext.setMd5(str2);
          label141:
          if ((str3 == null) || (str3.equals(""))) {
            break label210;
          }
          this.mJobContext.setSha(str3);
        }
        label210:
        while (!isAlive())
        {
