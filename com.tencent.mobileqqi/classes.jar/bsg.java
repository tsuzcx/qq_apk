...
{
  public bsg(QRDisplayActivity paramQRDisplayActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong, String paramString1, String paramString2)
  {
    ...
    if (localObject != null)
    {
      ((TextView)this.a.findViewById(2131232580)).setText(paramString2);
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    if (paramBoolean1)
    {
      paramString = ((DiscussionHandler)this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).a(paramString, true);
