...
public class brj
  extends Thread
{
  public brj(CodeMaskManager paramCodeMaskManager, SharedPreferences paramSharedPreferences, int paramInt1, int paramInt2, int paramInt3) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      if (((JSONObject)localObject).getInt("r") == 0)
      {
        ...
        {
          this.jdField_a_of_type_ComTencentBizQrcodeCodeMaskManager.jdField_a_of_type_AndroidOsHandler.post(new brk(this, (JSONArray)localObject));
