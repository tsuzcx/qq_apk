...
public class gfc
  implements Runnable
{
  public gfc(ProfilePhotoView paramProfilePhotoView, int paramInt, ProfileActivity.AllInOne paramAllInOne, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject3 != null) {
          this.jdField_a_of_type_ComTencentMobileqqProfileViewProfilePhotoView.a.runOnUiThread(new gfd(this, (Bitmap)localObject3));
        }
        return;
      }
