...
{
  public gwz(TroopBarPublishBarSelectActivity paramTroopBarPublishBarSelectActivity) {}
  ...
  public boolean a(int paramInt, View paramView, ListView paramListView)
  {
    ...
    if (this.a.jdField_a_of_type_Long == 0L)
    {
      ...
      this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new gxa(this), 300L);
    }
    for (;;)
    {
      ...
      break;
      label113:
      this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new gxb(this), 300L);
    }
  }
