...
public class hsl
  implements Runnable
{
  public hsl(MyAppApi.QQDownloadListener paramQQDownloadListener, TMQQDownloaderOpenSDKParam paramTMQQDownloaderOpenSDKParam, int paramInt1, int paramInt2, String paramString) {}
