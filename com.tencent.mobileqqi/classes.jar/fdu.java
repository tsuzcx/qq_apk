  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      if (i > 10)
      {
        ...
        bool1 = SettingCloneUtil.readValue(BaseActivity.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, null, BaseActivity.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131563409), "qqsetting_screenshot_key", false);
