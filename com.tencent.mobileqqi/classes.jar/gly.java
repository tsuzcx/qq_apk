  ...
  extends BaseAdapter
{
  ...
  private gly(SameStatusActivity paramSameStatusActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramView == null)
      {
        paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqRichstatusSameStatusActivity).inflate(2130903989, null);
        paramView = new SameStatusActivity.ItemViewHolder();
        paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131234529));
        paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131234531));
        paramView.jdField_a_of_type_AndroidViewView = paramViewGroup.findViewById(2131234530);
        paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131234532));
        paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131232029));
        paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131234534));
        paramView.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131234526));
        paramView.d = ((TextView)paramViewGroup.findViewById(2131234527));
      ...
      if ((localItemViewHolder.jdField_a_of_type_PersonalStateUserProfile != paramView) || (SameStatusActivity.a(this.jdField_a_of_type_ComTencentMobileqqRichstatusSameStatusActivity).contains(Long.valueOf(paramView.lEctID))))
      {
        ...
        localItemViewHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839661);
      ...
      for (;;)
      {
        ...
        if (paramView.bSex == 1)
        {
          localItemViewHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839654);
          break;
        }
    ...
    if (paramView == null)
    {
      paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqRichstatusSameStatusActivity.getLayoutInflater().inflate(2130903281, null);
