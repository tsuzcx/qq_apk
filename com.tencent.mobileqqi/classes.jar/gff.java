...
public class gff
  implements Runnable
{
  public gff(ProfileSocialView paramProfileSocialView, int paramInt, ProfileActivity.AllInOne paramAllInOne, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject3 != null) {
          this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileSocialView.a.runOnUiThread(new gfg(this, (Bitmap)localObject3));
        }
        return;
      }
      ...
      else
      {
        ...
        {
          localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileSocialView.getResources(), 2130838019);
          continue;
        }
