  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public euo(FriendListInnerFrame paramFriendListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903962, paramViewGroup, false);
      paramView = new eup(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame, null);
    ...
    paramView = (eup)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
