...
{
  public epn(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity) {}
  ...
  protected void a(boolean paramBoolean, List paramList, int paramInt1, int paramInt2, nearfield_discuss.BusiRespHead paramBusiRespHead)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilList == null)
      {
        ...
        if (this.a.jdField_a_of_type_Epr != null)
        {
          this.a.jdField_a_of_type_Epr.notifyDataSetChanged();
