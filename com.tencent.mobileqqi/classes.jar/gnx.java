...
public class gnx
  implements Runnable
{
  public gnx(TransFileController paramTransFileController, String paramString, QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    if (!StringUtil.b(localCompressInfo.e))
    {
      ...
      localTransferRequest.jdField_a_of_type_ComTencentMobileqqPicUpCallBack = new gny(this);
