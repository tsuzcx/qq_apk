  ...
  implements TextWatcher, View.OnClickListener, View.OnTouchListener
{
  ...
  private elf jdField_a_of_type_Elf;
  
  public elg(CountryActivity paramCountryActivity, Context paramContext)
  {
    ...
    paramContext = (Button)findViewById(2131233086);
    ...
    this.jdField_a_of_type_Elf = new elf(paramCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Elf);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Elf.a(paramString);
    if (this.jdField_a_of_type_Elf.getCount() == 0) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      this.jdField_a_of_type_Elf.notifyDataSetChanged();
      return;
