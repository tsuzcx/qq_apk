  ...
  implements INetInfoHandler, DownloaderInterface
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = hjd.class.getSimpleName();
  }
  
  public hjd(AppInterface paramAppInterface, DownloaderFactory.DownloadConfig paramDownloadConfig)
  {
  ...
  public void a(int paramInt, String paramString, java.io.File arg3, DownloadListener paramDownloadListener, android.os.Bundle paramBundle)
  {
    ...
    //   20: aload_0
    //   21: aload_2
    //   22: invokevirtual 181	hjd:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/vip/DownloadTask;
    //   25: ifnonnull -8 -> 17
    ...
    //   51: aload_0
    //   52: getfield 33	hjd:jdField_a_of_type_JavaUtilLinkedList	Ljava/util/LinkedList;
    //   55: astore_3
    //   56: aload_3
    //   57: monitorenter
    //   58: aload_0
    //   59: getfield 33	hjd:jdField_a_of_type_JavaUtilLinkedList	Ljava/util/LinkedList;
    //   62: aload_2
    //   63: invokevirtual 194	java/util/LinkedList:addLast	(Ljava/lang/Object;)V
    //   66: aload_3
    //   67: monitorexit
    //   68: aload_0
    //   69: getfield 144	hjd:jdField_a_of_type_Boolean	Z
    //   72: ifne -55 -> 17
    //   75: aload_0
    //   76: iconst_1
    //   77: putfield 144	hjd:jdField_a_of_type_Boolean	Z
    //   80: aload_0
    //   81: invokespecial 116	hjd:b	()V
    //   84: goto -67 -> 17
    //   87: astore_2
    //   88: aload_0
    //   89: monitorexit
