  ...
  implements BusinessObserver, Constants.Action
{
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    case 1001: 
      ...
      {
        localStringBuilder = new StringBuilder().append("onRV  action login code = ").append(paramInt).append("; alias = ");
        if (str2 != null) {
          break label195;
        }
      }
      ...
      onLoginFailed(str2, paramBundle.getString("error"), str1, paramInt);
      return;
    case 1040: 
      onRegisterCmdCallback(paramBoolean);
      return;
    case 1002: 
      onlineStatusChanged(paramBoolean, (AppRuntime.Status)paramBundle.getSerializable("onlineStatus"), paramBundle.getBoolean("isChanged"));
      return;
    case 1041: 
