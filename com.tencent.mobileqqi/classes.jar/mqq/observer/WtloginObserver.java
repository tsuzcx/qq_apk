  ...
  implements BusinessObserver, Constants.Action
{
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    case 2120: 
      ...
      return;
    case 2121: 
      OnGetStViaSMSVerifyLogin(paramBundle.getString("userAccount"), paramBundle.getLong("dwAppid"), paramBundle.getInt("dwMainSigMap"), paramBundle.getLong("dwSubDstAppid"), paramBundle.getInt("ret"), (ErrMsg)paramBundle.getParcelable("errMsg"));
      return;
    case 2122: 
      OnGetSubaccountStViaSMSVerifyLogin(paramBundle.getString("submainaccount"), paramBundle.getString("userAccount"), paramBundle.getLong("dwAppid"), paramBundle.getInt("dwMainSigMap"), paramBundle.getLong("dwSubDstAppid"), paramBundle.getInt("ret"), (ErrMsg)paramBundle.getParcelable("errMsg"));
      return;
    }
