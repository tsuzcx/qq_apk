  ...
  extends Servlet
{
  ...
  {
    super.onCreate();
    String[] arrayOfString = getPreferSSOCommands();
    if (arrayOfString != null)
    {
      ...
      while (i < j)
      {
        ...
        getAppRuntime().getService().registCommands(str, getClass());
        i += 1;
      }
    }
  }
  ...
  protected final void sendToMSF(Intent paramIntent, ToServiceMsg paramToServiceMsg)
  {
