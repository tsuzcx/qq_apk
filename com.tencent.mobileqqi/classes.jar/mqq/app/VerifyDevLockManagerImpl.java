  ...
  implements VerifyDevLockManager
{
  ...
  private void notifyUI(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, int paramInt, ErrMsg paramErrMsg, DevlockInfo paramDevlockInfo)
  {
    ...
    {
      paramErrMsg = TAG;
      localStringBuilder = new StringBuilder().append("notifyUI wrapper=").append(localVerifyDevLockWrapper).append(" mVerifyDevLockObserver=");
    ...
    for (paramToServiceMsg = "null";; paramToServiceMsg = localVerifyDevLockWrapper.mVerifyDevLockObserver)
    {
      ...
      paramToServiceMsg = "mqq.i.intent.action.ACTION_VERYFY_LOCK_CODE";
      if ("com.tencent.mobileqq:openSdk".equals(str3)) {
        paramToServiceMsg = "mqq.opensdk.intent.action.ACTION_VERYFY_LOCK_CODE";
      }
      paramToServiceMsg = new Intent(paramToServiceMsg);
