...
{
  public ggk(RoamingActivity paramRoamingActivity, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
  ...
  public void onLocationUpdate(SOSOMapLBSApiResult paramSOSOMapLBSApiResult)
  {
    ...
    for (String str = "";; str = paramSOSOMapLBSApiResult.Address)
    {
      if (paramSOSOMapLBSApiResult.Info == 1) {
        this.a.runOnUiThread(new ggl(this, paramSOSOMapLBSApiResult, str));
      }
      try
      {
