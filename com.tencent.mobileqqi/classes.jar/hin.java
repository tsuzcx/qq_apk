  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 3: 
      ...
      do
      {
        ...
        else
        {
          for (;;)
          {
            try
            {
              ...
              this.a.a(paramMessage, new hio(this));
        ...
        {
          this.a.a(paramMessage, new hip(this, (SdkAuthorize.GetAuthApiListResponse)localObject1, (JSONObject)localObject2));
          break;
        }
        ...
        if (i != 0)
        {
          ...
          try
          {
            ...
            paramMessage = String.format(this.a.getResources().getString(2131562322), new Object[] { Integer.valueOf(i) });
            this.a.a(paramMessage, new hiq(this));
            this.a.b(i, paramMessage);
            return;
          }
          catch (JSONException paramMessage) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (k >= 100)
        {
          ...
          ThreadManager.a(new hir(this, paramMessage));
          return;
        }
      }
