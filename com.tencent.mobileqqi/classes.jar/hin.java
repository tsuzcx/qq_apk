...
{
  public hin(AuthorityActivity paramAuthorityActivity) {}
    ...
    for (str = "s_a_a_emp";; str = "s_a_a")
    {
      ...
      for (;;)
      {
          ...
          if (paramBundle != null)
          {
            ...
            if (localObject1 != null)
            {
              ...
              if (((SdkAuthorize.AuthorizeResponse)localObject1).ret.get() == 0) {
                this.a.a(this.a.B, this.a.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity$AccountInfo.a, ((SdkAuthorize.AuthorizeResponse)localObject1).expires_in.get(), paramBundle);
              }
        ...
        catch (Exception paramBundle)
        {
          ...
          ((Message)localObject1).obj = this.a.getResources().getString(2131562443);
        ...
        paramBundle.obj = this.a.getResources().getString(2131562443);
        this.a.jdField_a_of_type_AndroidOsHandler.sendMessage(paramBundle);
        paramBundle = this.a.getResources().getString(2131562443);
        try
        {
