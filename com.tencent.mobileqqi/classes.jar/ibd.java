...
public class ibd
  ...
  implements ibw
{
  public ibd(ListView paramListView)
  {
    super(paramListView);
  }
    ...
    for (;;)
    {
      if (paramInt3 >= 0)
      {
        ...
        for (;;)
        {
          ...
          {
            this.a.jdField_a_of_type_Hzz.a(this.a.getChildAt(paramInt1), this.a.ap + paramInt1);
            paramInt1 += 1;
            continue;
            ...
            int m = ListView.a(this.a, (View)localObject, this.a.ap + paramInt3, k, false, this.a.c.left, paramInt3);
            j += m;
            i = k - (m + i + this.a.aG);
            paramInt3 -= 1;
            break;
        ...
        ((ListView)localObject).ap += paramInt3 + 1;
        return 0;
      }
      return j;
      paramInt3 = -1;
    ...
    for (paramInt2 = paramInt3;; paramInt2 = -1)
    {
      if (paramInt2 >= 0)
      {
        ...
        for (;;)
        {
          ...
          {
            this.a.jdField_a_of_type_Hzz.a(this.a.getChildAt(paramInt3), this.a.ap + paramInt3);
            paramInt3 += 1;
            continue;
            ...
            int m = ListView.a(this.a, localView, this.a.ap + paramInt3, k, true, this.a.c.left, paramInt3);
            j += m;
            i = k + (m + i + this.a.aG);
            paramInt3 += 1;
            break;
    ...
    do
    {
      ...
      do
      {
        ...
        if (paramInt2 >= 0)
        {
          ...
          {
            this.a.jdField_a_of_type_Hzz.a((View)localObject, this.a.ap + paramInt2);
            j = i;
            if (i >= 0) {}
          }
      ...
      Object localObject = this.a;
      ((ListView)localObject).ap = (i + 1 + ((ListView)localObject).ap);
      return;
    } while (paramInt3 >= 0);
    this.a.b(false);
  }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (paramInt4 > 0)
    {
      ...
      if (paramInt3 < paramInt1)
      {
        ...
        {
          this.a.jdField_a_of_type_Hzz.a(localView, this.a.ap + paramInt3);
          j = i;
          if (i >= 0) {}
        }
        for (j = paramInt3;; j = i)
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    label477:
    Object localObject;
    if ((paramInt1 == 0) && (this.a.aB > 0))
    {
      System.nanoTime();
      if (paramInt2 < paramInt1) {
        throw new IllegalArgumentException("lastRow must more than firstRow!");
      }
      if ((paramInt1 < 0) || (paramInt1 > this.a.aB - this.a.k() - this.a.l())) {
      ...
      do
      {
        ...
        if (k == this.a.aB)
        {
          ...
          if (this.a.jdField_a_of_type_ComTencentWidgetFastScroller != null) {
            this.a.jdField_a_of_type_ComTencentWidgetFastScroller.a(this.a.aB, this.a.aB - n);
          }
          this.a.aB += n;
          if (this.a.aA < 0) {
            break label425;
          }
          i = a(this.a.aA, k, paramInt2, i1, i2);
          this.a.e(i);
          this.a.f(i);
          if (this.a.W >= 0) {
        ...
        for (i = 0;; i = this.a.jdField_a_of_type_AndroidUtilSparseBooleanArray.size())
        {
          ...
          this.a.aA = a(this.a.Q, k, paramInt2, i1, i2);
          break label283;
        }
    ...
    for (;;)
    {
      if (paramInt2 >= 0)
      {
        ...
        for (;;)
        {
          if (paramInt1 <= j - 1)
          {
            ...
            m = ((View)localObject).getHeight() + this.a.aG;
            i -= m;
            paramInt2 -= 1;
      ...
      for (;;)
      {
        ...
        continue;
        label932:
        if (((paramInt1 < 0) || (paramInt1 >= k)) && ((paramInt1 >= 0) || (this.a.h))) {
          break label1216;
        }
        i = 0;
        n = -1;
        ...
        paramInt1 = this.a.getChildAt(j - 1).getBottom() + this.a.aG;
        j = k;
        k = paramInt1;
        for (;;)
        {
          ...
          else
          {
            ...
            while (paramInt2 < j)
            {
              this.a.jdField_a_of_type_Hzz.a(this.a.getChildAt(paramInt2), this.a.ap + paramInt2);
              paramInt2 += 1;
            }
          }
          localObject = this.a.a(j, this.a.jdField_a_of_type_ArrayOfBoolean);
          ListView.a(this.a, (View)localObject, j, k, true, this.a.c.left, false, this.a.jdField_a_of_type_ArrayOfBoolean[0], j - this.a.ap);
          paramInt1 = ((View)localObject).getHeight() + this.a.aG;
          k += paramInt1;
          i += paramInt1;
          j += 1;
        }
        ...
        continue;
        label1188:
        a(this.a.getChildCount(), m, paramInt2 - this.a.ap + 1, i);
      }
      label1216:
      if (m > i3) {
        this.a.offsetChildrenTopAndBottom(m - i3);
      }
      i = this.a.getChildAt(j).getTop() - this.a.aG;
      paramInt1 = 0;
      if (paramInt2 >= k) {
        if (i < n) {
          paramInt2 += 1;
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 < 0) || (paramInt2 >= this.a.aB - this.a.k() - this.a.l())) {
      throw new IllegalArgumentException("row index out of bound");
    }
    if ((this.a.n) || (this.a.p)) {
      onChanged();
    ...
    do
    {
      ...
      do
      {
        ...
        i3 = this.a.ap + i4 - 1;
        if (this.a.jdField_a_of_type_ComTencentWidgetFastScroller != null) {
          this.a.jdField_a_of_type_ComTencentWidgetFastScroller.a(this.a.aB, this.a.aB - paramInt1);
        }
        this.a.aB -= paramInt1;
        if (this.a.aA >= 0)
        {
          paramInt1 = b(this.a.aA, n, i2, i1, i3);
          this.a.e(paramInt1);
          this.a.f(paramInt1);
          if (this.a.W >= 0) {
        ...
        for (paramInt2 = 0;; paramInt2 = this.a.jdField_a_of_type_AndroidUtilSparseBooleanArray.size())
        {
          ...
          this.a.aA = b(this.a.Q, n, i2, i1, i3);
          break;
        }
        if (ListView.a(this.a) != null)
        {
      ...
      if (n < i1)
      {
        ...
        this.a.jdField_a_of_type_Hzz.a((View)localObject, i);
    ...
    if (this.a.aA >= 0)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("XListView", 2, "first is:" + n + ",last is:" + i2 + ",firstPosition is:" + i1 + ",lastPosition is:" + i3 + ",newSelectionPosition is:" + j + ",mStackFromBottom is:" + this.a.h);
      }
      if ((n > i1) || (i2 < i3)) {
        break label1165;
      }
    ...
    for (;;)
    {
      ...
      if ((j >= 0) && (j < k) && (bool2)) {
        this.a.a(j, this.a.getChildAt(j - this.a.ap));
      }
      if (QLog.isColorLevel()) {
      ...
      if (n <= i1)
      {
        if ((this.a.h) || (j >= 0))
        {
          ...
          if (paramInt1 - this.a.aG > 0) {}
          for (paramInt1 = -paramInt1 + this.a.aG;; paramInt1 = 0)
          {
        ...
        this.a.b(true);
        ListView.a(this.a);
        if (((View)localObject).getTop() - this.a.aG > 0) {}
        for (paramInt1 = -((View)localObject).getTop() + this.a.aG;; paramInt1 = 0)
        {
      ...
      if (i2 >= i3)
      {
        if ((!this.a.h) || (j >= 0))
        {
          ...
          paramInt2 -= paramInt1;
          if (k - paramInt1 - this.a.aG > 0) {}
          for (paramInt1 = k - paramInt1 - this.a.aG;; paramInt1 = 0)
          {
            k = this.a.indexOfChild((View)localObject);
            i = paramInt1;
            bool1 = false;
        ...
        this.a.b(false);
        ListView.a(this.a);
        if (k - ((View)localObject).getBottom() - this.a.aG > 0) {}
        for (paramInt1 = k - ((View)localObject).getBottom() - this.a.aG;; paramInt1 = 0)
        {
          paramInt2 -= ((View)localObject).getTop();
          k = this.a.indexOfChild((View)localObject);
          i = paramInt1;
      ...
      if (((j >= 0) && (j < n)) || ((j < 0) && (!this.a.h)))
      {
        ...
        while (paramInt1 < paramInt2)
        {
          this.a.getChildAt(paramInt1).offsetTopAndBottom(-(m - i2) + this.a.aG);
          paramInt1 += 1;
        }
        this.a.b(true);
        ListView.a(this.a);
      ...
      else if ((j >= n) || ((j < 0) && (this.a.h)))
      {
        ...
        {
          this.a.getChildAt(paramInt1).offsetTopAndBottom(k - m - this.a.aG);
          paramInt1 += 1;
        }
        this.a.b(false);
        ListView.a(this.a);
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 < this.a.k()) || (paramInt2 >= this.a.aB - this.a.k() - this.a.l())) {
      throw new IllegalArgumentException("row index out of bound. insert range: " + paramInt1 + "~" + paramInt2 + ". valid range: " + this.a.k() + "~" + (this.a.aB - this.a.k() - this.a.l()));
    }
    if ((this.a.n) || (this.a.p)) {
      onChanged();
    }
    ...
    if (n < paramInt1)
    {
      ...
      paramInt1 = this.a.aA;
      label315:
      if (((paramInt1 < 0) || (paramInt1 > n)) && ((paramInt1 >= 0) || (this.a.h))) {
        break label426;
      }
    ...
    for (;;)
    {
      ...
      break label315;
      label426:
      if ((paramInt1 >= i1) || ((paramInt1 < 0) && (this.a.h)))
      {
