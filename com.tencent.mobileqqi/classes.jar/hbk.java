...
{
  public hbk(VideoPlayLogic paramVideoPlayLogic) {}
  ...
  protected void a(String paramString, List paramList, int paramInt)
  {
    ...
    if (VideoPlayLogic.a(this.a) == null)
    {
      ...
      paramString.leftMargin = VideoPlayLogic.a(this.a).getResources().getDimensionPixelSize(2131427575);
      paramString.rightMargin = VideoPlayLogic.a(this.a).getResources().getDimensionPixelSize(2131427576);
      paramString.topMargin = VideoPlayLogic.a(this.a).getResources().getDimensionPixelSize(2131427578);
