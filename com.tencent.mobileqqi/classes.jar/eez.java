...
{
  public eez(PAMultiItemBuilder paramPAMultiItemBuilder) {}
  
  public void onClick(View paramView)
  {
    efa localefa = (efa)paramView.getTag();
    paramView = AIOUtils.a(paramView);
    if ((localefa == null) || (!(paramView instanceof MessageForPubAccount))) {
      if (QLog.isColorLevel()) {
        QLog.d(ChatItemBuilder.a, 2, "PAMultiItemBuilder onClickListener holder = " + localefa + ", msg = " + paramView);
      }
    }
    ...
    return;
    PAMessage.Item localItem = (PAMessage.Item)localMessageForPubAccount.mPAMessage.items.get(localefa.jdField_c_of_type_Int);
    label162:
    ...
    if (TextUtils.isEmpty(localItem.a_actionData))
    {
      ...
      PASingleItemBuilder.a(PAMultiItemBuilder.c(this.a), PAMultiItemBuilder.c(this.a), localefa.a, localefa.b, localefa.jdField_c_of_type_JavaLangString, PAMultiItemBuilder.a(this.a).a, PAMultiItemBuilder.b(this.a).d);
      label293:
    ...
    for (;;)
    {
      ...
      break label293;
      label414:
      PASingleItemBuilder.a(PAMultiItemBuilder.e(this.a), PAMultiItemBuilder.d(this.a), localefa.a, localefa.b, localefa.jdField_c_of_type_JavaLangString, PAMultiItemBuilder.d(this.a).a, PAMultiItemBuilder.e(this.a).d);
      break label293;
      label469:
      if (TextUtils.isEmpty(localJumpAction.a()))
      {
        ...
        {
          PASingleItemBuilder.a(PAMultiItemBuilder.g(this.a), PAMultiItemBuilder.f(this.a), localefa.a, localefa.b, localefa.jdField_c_of_type_JavaLangString, PAMultiItemBuilder.f(this.a).a, PAMultiItemBuilder.g(this.a).d);
          break label293;
        }
      ...
      {
        PASingleItemBuilder.a(PAMultiItemBuilder.i(this.a), PAMultiItemBuilder.g(this.a), localefa.a, localefa.b, localefa.jdField_c_of_type_JavaLangString, PAMultiItemBuilder.i(this.a).a, PAMultiItemBuilder.j(this.a).d);
        break label293;
      }
      ...
      break label293;
      label689:
      PASingleItemBuilder.a(PAMultiItemBuilder.l(this.a), PAMultiItemBuilder.h(this.a), localefa.a, localefa.b, localefa.jdField_c_of_type_JavaLangString, PAMultiItemBuilder.m(this.a).a, PAMultiItemBuilder.n(this.a).d);
    }
  }
}
