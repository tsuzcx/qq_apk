...
public class duo
  extends BaseAdapter
{
  public duo(TroopClassChoiceActivity paramTroopClassChoiceActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramViewGroup = this.a.getLayoutInflater().inflate(2130904023, null);
    }
    TextView localTextView1 = (TextView)paramViewGroup.findViewById(2131234599);
    TextView localTextView2 = (TextView)paramViewGroup.findViewById(2131234601);
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131234600);
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      if (paramInt != 0)
      {
        ...
        localTextView2.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130840345, 0);
      }
      for (;;)
      {
