...
{
  public cos(GesturePWDCreateActivity paramGesturePWDCreateActivity) {}
  ...
  public void a(List paramList)
  {
    ...
    do
    {
      ...
      this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new cou(this), 500L);
      return;
      ...
      this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new cov(this), 300L);
    } while (!QLog.isColorLevel());
    QLog.d("Q.gesturelock.creat", 2, "gesture lock create success...");
    return;
    this.a.jdField_a_of_type_ComTencentMobileqqGesturelockLockPatternView.setDisplayMode(LockPatternView.DisplayMode.Wrong);
    this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new cow(this), 500L);
