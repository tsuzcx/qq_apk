  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public drx(TroopMemberListActivity paramTroopMemberListActivity)
  {
      ...
      if ((localATroopMember.c != null) && (localATroopMember.c.length() != 0))
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if (!((String)localObject2).equals(this.jdField_a_of_type_JavaLangString)) {
            Collections.sort((List)((LinkedHashMap)localObject4).get(localObject2), new dsc(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity, null));
          }
        }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      TroopMemberListActivity.ViewHolder.a(paramViewGroup, (Button)paramView.findViewById(2131234629));
      TroopMemberListActivity.ViewHolder.a(paramViewGroup, (RelativeLayout)paramView.findViewById(2131234624));
      ...
      TroopMemberListActivity.ViewHolder.a(paramViewGroup).setOnClickListener(new dry(this, localATroopMember));
    ...
    for (;;)
    {
      ...
      paramViewGroup.d.setOnClickListener(new drz(this, localATroopMember));
      return paramView;
