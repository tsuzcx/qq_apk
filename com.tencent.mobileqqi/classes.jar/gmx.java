  ...
  extends Thread
{
  ...
  private gmw jdField_a_of_type_Gmw = null;
  ...
  public gmx(HttpService paramHttpService, HttpServerConnection paramHttpServerConnection, HttpNotify paramHttpNotify, gmw paramgmw)
  {
    ...
    this.jdField_a_of_type_Gmw = paramgmw;
  }
  ...
  public void run()
  {
    ...
    //   10: ldc 35
    //   12: aload_0
    //   13: getfield 16	gmx:jdField_a_of_type_ComTencentMobileqqServiceHttpNotify	Lcom/tencent/mobileqq/service/HttpNotify;
    //   16: invokeinterface 41 3 0
    //   21: aload_0
    //   22: getfield 18	gmx:jdField_a_of_type_Gmw	Lgmw;
    //   25: invokevirtual 47	gmw:c	()Z
    //   28: ifeq +55 -> 83
    //   31: invokestatic 50	java/lang/Thread:interrupted	()Z
    //   34: ifne +49 -> 83
    //   37: aload_0
    //   38: getfield 22	gmx:jdField_a_of_type_OrgApacheHttpHttpServerConnection	Lorg/apache/http/HttpServerConnection;
    //   41: invokeinterface 55 1 0
    //   46: ifeq +37 -> 83
    //   49: aload_0
    //   50: getfield 20	gmx:jdField_a_of_type_OrgApacheHttpProtocolHttpService	Lorg/apache/http/protocol/HttpService;
    //   53: aload_0
    //   54: getfield 22	gmx:jdField_a_of_type_OrgApacheHttpHttpServerConnection	Lorg/apache/http/HttpServerConnection;
    //   57: aload_1
    ...
    //   64: astore_1
    //   65: aload_0
    //   66: getfield 18	gmx:jdField_a_of_type_Gmw	Lgmw;
    //   69: aload_0
    //   70: invokevirtual 64	gmw:a	(Ljava/lang/Thread;)V
    //   73: aload_0
    //   74: getfield 22	gmx:jdField_a_of_type_OrgApacheHttpHttpServerConnection	Lorg/apache/http/HttpServerConnection;
    //   77: invokeinterface 67 1 0
    //   82: return
    //   83: aload_0
    //   84: getfield 18	gmx:jdField_a_of_type_Gmw	Lgmw;
    //   87: aload_0
    //   88: invokevirtual 64	gmw:a	(Ljava/lang/Thread;)V
    //   91: aload_0
    //   92: getfield 22	gmx:jdField_a_of_type_OrgApacheHttpHttpServerConnection	Lorg/apache/http/HttpServerConnection;
    ...
    //   103: astore_1
    //   104: aload_0
    //   105: getfield 18	gmx:jdField_a_of_type_Gmw	Lgmw;
    //   108: aload_0
    //   109: invokevirtual 64	gmw:a	(Ljava/lang/Thread;)V
    //   112: aload_0
    //   113: getfield 22	gmx:jdField_a_of_type_OrgApacheHttpHttpServerConnection	Lorg/apache/http/HttpServerConnection;
