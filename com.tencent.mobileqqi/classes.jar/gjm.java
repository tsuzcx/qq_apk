...
public class gjm
  implements Runnable
{
  public gjm(ProfilePhotoView paramProfilePhotoView, int paramInt, ProfileActivity.AllInOne paramAllInOne, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject3 != null) {
          this.jdField_a_of_type_ComTencentMobileqqProfileViewProfilePhotoView.a.runOnUiThread(new gjn(this, (Bitmap)localObject3));
        }
        return;
      }
      ...
      else
      {
        ...
        {
          localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfilePhotoView.getResources(), 2130838017);
          continue;
        }
