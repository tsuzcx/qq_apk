  ...
  implements Cursor
{
  ...
  public fnq(MsgProxy paramMsgProxy, List paramList)
  {
  ...
  private Object a(int paramInt)
  {
    ...
    case 15: 
      if (localMessageRecord.istroop == 3000) {
        return ContactUtils.c(MsgProxy.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageMsgProxy), localMessageRecord.senderuin);
      }
      if (localMessageRecord.istroop == 1) {
        return ((FriendsManagerImp)MsgProxy.c(this.jdField_a_of_type_ComTencentMobileqqAppMessageMsgProxy).getManager(8)).e(localMessageRecord.senderuin);
      }
    ...
    case 16: 
      return Integer.valueOf(((FriendManager)MsgProxy.e(this.jdField_a_of_type_ComTencentMobileqqAppMessageMsgProxy).getManager(8)).a(localMessageRecord.frienduin));
    case 17: 
