...
public class cse
  implements Runnable
{
  public cse(ForwardOperations paramForwardOperations, String paramString, QQCustomDialog paramQQCustomDialog) {}
  ...
  public void run()
  {
    ...
    if (!this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_Boolean) {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.u == 1)
      {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130837965);
        this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new csf(this, (Drawable)localObject1));
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new csg(this, (URLDrawable)localObject1));
          return;
          i = 4;
      ...
      try
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new csi(this, (Drawable)localObject2));
          return;
