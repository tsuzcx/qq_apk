...
{
  public blq(QRCardActivity paramQRCardActivity, boolean[] paramArrayOfBoolean, String paramString1, Context paramContext, String paramString2) {}
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ArrayOfBoolean[0] == 1)
      {
        ...
        for (;;)
        {
          ...
          return;
          paramView = this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.b.getAccount();
          ...
          String str = this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.b.getSid();
          if (TextUtils.isEmpty(str))
          {
            ((AccountManager)this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.b.getManager(0)).updateSid(new blr(this, paramView, (String)localObject));
          }
          else if (!TextUtils.isEmpty(paramView))
          {
            localObject = "http://w.mail.qq.com/cgi-bin/login?target=mobileqqwrite&fwd=mq&fun=from3g&uin=" + paramView + "&3g_sid=" + str + "&to=" + (String)localObject;
