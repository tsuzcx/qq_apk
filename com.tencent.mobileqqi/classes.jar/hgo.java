  ...
  extends AutoCompleteTextView
{
  ...
  public hgo(DropdownView paramDropdownView, Context paramContext)
  {
    super(paramContext);
    setId(526);
  ...
  public hgo(DropdownView paramDropdownView, Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public hgo(DropdownView paramDropdownView, Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
