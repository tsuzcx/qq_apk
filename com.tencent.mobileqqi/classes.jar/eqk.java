...
{
  public eqk(RenMaiQuanMemberListInnerFrame paramRenMaiQuanMemberListInnerFrame, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, int paramInt, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903964, paramViewGroup, false);
      paramView = new eql(null);
      paramView.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)localView.findViewById(2131230943));
      paramView.c = ((ImageView)localView.findViewById(2131230940));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131231000));
      localView.setTag(paramView);
      paramViewGroup = paramView;
      paramViewGroup.jdField_a_of_type_JavaLangString = localCircleBuddy.uin;
      paramViewGroup.c.setImageBitmap(a(localCircleBuddy.uin, 1, (byte)1));
    ...
    for (;;)
    {
      ...
      return localView;
      paramViewGroup = (eql)paramView.getTag();
      localView = paramView;
      break;
      label290:
