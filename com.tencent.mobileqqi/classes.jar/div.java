...
{
  public div(QQSettingMe paramQQSettingMe) {}
  ...
  protected void a(String paramString, boolean paramBoolean)
  {
    if ((paramBoolean) && (this.a.b) && (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (Utils.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a()))) {
      this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new diw(this));
    }
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean2) && (paramBoolean1) && (this.a.b)) {
      this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new dix(this));
    }
  }
  ...
  protected void b(boolean paramBoolean, String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      ...
      if (j != 0) {
        this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new diy(this));
      }
      return;
      label97:
      i += 1;
