...
{
  public cio(ChatHistory paramChatHistory) {}
  ...
  public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    try
    {
      ...
      if (paramInt1 < this.a.jdField_b_of_type_Int)
      {
        ...
        this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130839663);
        if (this.a.c > 1) {
          break label221;
        }
        this.a.jdField_a_of_type_AndroidWidgetImageView.setEnabled(false);
        this.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130838076);
    ...
    catch (Exception paramCharSequence)
    {
      for (;;)
      {
        ...
        this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130837761);
        continue;
        label221:
        this.a.jdField_a_of_type_AndroidWidgetImageView.setEnabled(true);
        this.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130837760);
      }
    }
  }
}
