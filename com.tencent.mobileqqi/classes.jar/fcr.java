  ...
  implements Cursor
{
  ...
  private static fcr b(QQAppInterface paramQQAppInterface, int paramInt)
  {
    if (jdField_a_of_type_JavaUtilHashMap == null) {
      jdField_a_of_type_JavaUtilHashMap = ForwardFriendListAdapter.a();
    }
    return new fcr(a(((ContactFacade)paramQQAppInterface.getManager(49)).a(String.valueOf(paramInt))));
  }
