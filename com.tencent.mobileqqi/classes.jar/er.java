  ...
  extends BaseAdapter
{
  ...
  public DatalineSessionAdapter.ItemHolder a;
  ...
  private er(DatalineSessionAdapter paramDatalineSessionAdapter, DatalineSessionAdapter.ItemHolder paramItemHolder, DataLineMsgSet paramDataLineMsgSet, int paramInt)
  {
    this.jdField_a_of_type_ComDatalineUtilDatalineSessionAdapter$ItemHolder = paramItemHolder;
  ...
  private void b()
  {
    ...
    while (i < 3)
    {
      ...
      this.jdField_a_of_type_ArrayOfComDatalineUtilWidgetAsyncImageView[i].setDefaultImage(2130840363);
      ...
      this.jdField_a_of_type_ArrayOfComDatalineUtilWidgetAsyncImageView[i].setTag(this.jdField_a_of_type_ComDatalineUtilDatalineSessionAdapter$ItemHolder);
  ...
  public void a()
  {
    ...
    if (i < 3)
    {
      ...
      localAsyncImageView.setTag(this.jdField_a_of_type_ComDatalineUtilDatalineSessionAdapter$ItemHolder);
      DataLineMsgRecord localDataLineMsgRecord = this.jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSet.getAt(i);
      if (localDataLineMsgRecord == null) {
        localAsyncImageView.setImageResource(2130840363);
      }
      for (;;)
      {
        i += 1;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      paramViewGroup.setTag(this.jdField_a_of_type_ComDatalineUtilDatalineSessionAdapter$ItemHolder);
      localDataLineMsgRecord = this.jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSet.getAt(paramInt);
      if (localDataLineMsgRecord == null)
      {
        paramViewGroup.setImageResource(2130840363);
