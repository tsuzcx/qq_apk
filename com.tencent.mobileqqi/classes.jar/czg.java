...
{
  public czg(LoginActivity paramLoginActivity) {}
  ...
  protected void onLoginFailed(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    try
    {
      ...
      this.a.runOnUiThread(new czh(this));
    ...
    catch (Exception localException)
    {
      ...
      } while (!str.equals(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.b(localSimpleAccount.getUin())));
      SharedPreUtils.a(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.a.jdField_b_of_type_JavaLangString, true);
      label258:
