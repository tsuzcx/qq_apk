...
{
  private cqi(HornListActivity paramHornListActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    case 0: 
      if (paramView == null)
      {
        ...
        paramViewGroup.b = ((TextView)paramView.findViewById(2131233362));
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131233360));
      ...
      for (;;)
      {
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new cqj(this, (HornDetail)localObject));
        return paramView;
