...
class deg
{
  ...
  Handler jdField_a_of_type_AndroidOsHandler = new deh(this);
  public Toast a;
  ...
  public deg(SessionInfo paramSessionInfo, BaseActivity paramBaseActivity)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppBizTroopObserver = new dei(this);
    this.jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new dej(this);
  ...
  public void a()
  {
    ...
    this.jdField_c_of_type_Boolean = false;
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new dek(this), 1000L);
