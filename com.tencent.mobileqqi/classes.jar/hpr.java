...
public class hpr
  implements Runnable
{
  public hpr(WebAppActivity paramWebAppActivity, String paramString1, String paramString2, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    if (localObject1 == null)
    {
      ...
      if (localObject1 == null)
      {
        ...
        localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentOpenApplistWebAppActivity.getResources(), 2130838182);
      }
    }
