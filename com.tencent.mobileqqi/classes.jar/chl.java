...
public class chl
  extends Handler
{
  public chl(DiscussionInfoCardActivity paramDiscussionInfoCardActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (i + 1 > DiscussionInfoCardActivity.b(this.a) * 3)
    {
      ...
      DiscussionInfoCardActivity.b(this.a).setOnClickListener(new chm(this));
      ...
      DiscussionInfoCardActivity.a(this.a, new chr(this.a));
