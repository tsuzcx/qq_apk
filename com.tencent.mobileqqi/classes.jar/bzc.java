...
public class bzc
  implements Runnable
{
  public bzc(ChatActivity paramChatActivity, Activity paramActivity) {}
  ...
  public void run()
  {
    ...
    ChatActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity).setOnTouchListener(new bzd(this));
    ...
    localAnimationSet.setAnimationListener(new bze(this));
