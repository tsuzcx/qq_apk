...
public final class RespUploadJava
  extends JceStruct
{
  ...
  public RespUploadJava(byte paramByte1, int paramInt, String paramString1, long paramLong1, short paramShort, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte paramByte2, long paramLong2, long paramLong3, String paramString2)
  {
    ...
    this.strFliePath = paramArrayOfByte1;
    this.strFlieKey = paramArrayOfByte2;
  ...
  public void readFrom(JceInputStream paramJceInputStream)
  {
    ...
    {
      cache_strFliePath = (byte[])new byte[1];
      ((byte[])cache_strFliePath)[0] = 0;
    }
    this.strFliePath = ((byte[])paramJceInputStream.read(cache_strFliePath, 5, true));
    if (cache_strFlieKey == null)
    {
      cache_strFlieKey = (byte[])new byte[1];
      ((byte[])cache_strFlieKey)[0] = 0;
    }
    this.strFlieKey = ((byte[])paramJceInputStream.read(cache_strFlieKey, 6, true));
