  ...
  extends AsyncTask
{
  ...
  public iep(String paramString1, String paramString2, String paramString3)
  {
  ...
  {
    paramActivity = new ieq(this, paramActivity, paramPluginParams);
  ...
  {
    paramContext = new ies(this, paramContext, paramPluginParams);
  ...
  {
    paramContext = new iet(this, paramContext, paramPluginParams);
    this.jdField_a_of_type_JavaUtilArrayList.add(paramContext);
  }
}
