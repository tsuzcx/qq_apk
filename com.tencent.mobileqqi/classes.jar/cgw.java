...
{
  public cgw(ChatBackgroundSettingActivity paramChatBackgroundSettingActivity) {}
  ...
  public void onItemClick(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (paramAdapterView = "null";; paramAdapterView = str1)
    {
      ...
      {
        return;
        String str2 = AppConstants.aS + ((ChatBackgroundSettingActivity.PicInfo)localObject).jdField_b_of_type_JavaLangString + ".png";
