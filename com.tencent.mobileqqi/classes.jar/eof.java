...
{
  public eof(BannerManager paramBannerManager, View paramView, int paramInt, FrameLayout paramFrameLayout, String paramString) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = (ADView)this.jdField_a_of_type_AndroidViewView.findViewById(2131232088);
      if (localObject != null)
      {
    ...
    for (;;)
    {
      ...
      {
        paramView = (ADView)paramView.jdField_a_of_type_AndroidViewView.findViewById(2131232088);
        if (paramView != null) {
          paramView.a();
        }
      }
