...
public class epj
  extends Handler
{
  public epj(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity) {}
  
  public void handleMessage(Message paramMessage)
  {
    if (paramMessage.what == 0)
    {
      this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(new epk(this));
