  ...
  extends BaseAdapter
{
  ...
  public ero(PhotoListActivity paramPhotoListActivity)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130839360);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            if (paramView == null)
            {
              paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903596, null);
              ...
              paramViewGroup = new erp(this, null);
              paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131233027));
              paramViewGroup.b = ((ImageView)paramView.findViewById(2131233028));
              paramViewGroup.c = ((ImageView)paramView.findViewById(2131233029));
            ...
            for (;;)
            {
              ...
              default: 
                ...
                return paramView;
                paramViewGroup = (erp)paramView.getTag();
              }
            }
    ...
    paramViewGroup.setImageResource(2130838163);
