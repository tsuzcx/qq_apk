...
public class btx
  extends Handler
{
  public btx(TroopMemberApiService paramTroopMemberApiService) {}
      ...
      if ((localObject1 != null) && (localObject1.length != 0))
      {
        ...
        if ((localObject1 != null) && (localObject1.length != 0))
        {
          ...
          if ((localObject1 instanceof QQAppInterface))
          {
            ...
            {
              new bty(this, (TroopInfoManager)localObject1, (Bundle)localObject3, (String)localObject2).execute(new Void[0]);
            }
            else
            {
