...
public class fzn
{
  ...
  public fzn(OnlineFileSessionWorker paramOnlineFileSessionWorker)
  {
    this.jdField_a_of_type_Fzn = this;
  ...
  public fzn a()
  {
    return this.jdField_a_of_type_Fzn;
  }
  ...
  {
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_b_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "] state change :(" + this.jdField_a_of_type_Fzn.a() + "->" + paramString + ")");
  }
  ...
  protected final boolean a(String paramString)
  {
    if (this.jdField_b_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity == null)
    {
      QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_b_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "]. state:" + this.jdField_a_of_type_Fzn.a() + paramString + " entity is null ");
      return true;
    }
    return false;
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    {
      QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_b_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "] state change :(" + this.jdField_a_of_type_Fzn.a() + " recv  success response of ask progress");
      return;
    }
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_b_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "] state change :(" + this.jdField_a_of_type_Fzn.a() + " recv  failed response of ask progress");
  ...
  public void k()
  {
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_b_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.h + "] state change :(" + this.jdField_a_of_type_Fzn.a() + "->StateEnd)");
    this.jdField_a_of_type_Fzn = new fzv(this.jdField_b_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker);
  }
}
