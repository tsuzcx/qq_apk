...
{
  public ela(NotificationView paramNotificationView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    {
      QQToast.a(NotificationView.a(this.a), this.a.a().getString(2131562451), 0).b(this.a.a());
      return;
    }
    ((FriendListHandler)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1)).a(String.valueOf(localViewHolder.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.req_uin.get()));
    ...
    for (;;)
    {
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.b(2131562875);
