  ...
  extends AsyncTask
{
  ...
  protected String a(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        if ((this.f.contains("Resources$NotFoundException")) || (this.f.contains("ResourcesNotFoundException")) || (this.f.contains("ClassNotFoundException")))
        {
