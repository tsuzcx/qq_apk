  ...
  implements Runnable
{
  ...
  public fhq(CleanCache paramCleanCache) {}
    ...
    if (paramFile.exists())
    {
      ...
      if (paramFile.isDirectory())
      {
        ...
        if (paramFile != null)
        {
          ...
          if (j > 2000)
          {
            Arrays.sort(paramFile, new fhs(this));
            n = paramFile.length;
            k = m;
            i = j;
          }
  ...
  private File[] a(File[] paramArrayOfFile)
  {
    ...
    //   10: istore 5
    //   12: aload_0
    //   13: getfield 13	fhq:jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache	Lcom/tencent/mobileqq/app/automator/step/CleanCache;
    ...
    //   129: istore_2
    //   130: aload_0
    //   131: getfield 13	fhq:jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache	Lcom/tencent/mobileqq/app/automator/step/CleanCache;
  ...
  private int b(File paramFile)
  {
    ...
    i = paramFile.length;
    if (QLog.isColorLevel()) {
      QLog.e("QQInitHandler", 2, "sharefile.size:" + i);
    }
    k = i;
    int n;
    if (paramFile.length > 10)
    {
      Arrays.sort(paramFile, new fht(this));
      n = paramFile.length;
      k = m;
      j = i;
    }
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          if (localObject.exists())
          {
            ...
            {
              i = j;
              if (l - localObject.lastModified() <= 864000000L) {
                break;
              }
              localObject.delete();
              i = j + 1;
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        arrayOfString[0] = AppConstants.aC;
        ...
        if (i < j)
        {
          ...
          Arrays.sort((Object[])localObject, new fhr(this));
      ...
      for (;;)
      {
        ...
        arrayOfFile[1] = new File(AppConstants.an + "photo");
        arrayOfFile[2] = new File(AppConstants.an + this.jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache.a() + "/ptt/");
        ...
        i = b(new File(AppConstants.br));
        if (QLog.isColorLevel()) {
          QLog.e("QQInitHandler", 2, "onCleanCache.cleanSharedFile:" + i + " sharedfile(s)");
        }
      }
      label639:
      i += 1;
