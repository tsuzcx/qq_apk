...
{
  public dus(TroopDisbandActivity paramTroopDisbandActivity) {}
  ...
  protected void a(int paramInt, byte paramByte)
  {
    if (paramInt == 9)
    {
      ...
      if (paramByte == 8)
      {
        ...
        ((QQCustomDialog)localObject).setNegativeButton(this.a.getString(2131562549), new dut(this, (QQCustomDialog)localObject));
