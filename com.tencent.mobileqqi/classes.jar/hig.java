...
public final class hig
  implements Runnable
{
  public hig(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface, Handler paramHandler) {}
  ...
  public void run()
  {
    ...
    for (Object localObject1 = localFriendManager.b(localMessageForVideo.frienduin);; localObject1 = null)
    {
      ...
      {
        if (i != 0) {
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new hih(this, localMessageForVideo, (String)localObject1), 1000L);
        }
        return;
