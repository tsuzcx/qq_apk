...
public class gnf
{
  ...
  public gnf(FMTSrvAddrProvider paramFMTSrvAddrProvider) {}
  ...
  public FileStorageServerListInfo a(int paramInt)
  {
    ...
    ArrayList localArrayList = FMTSrvAddrProvider.b(this.jdField_a_of_type_ComTencentMobileqqTransfileFMTSrvAddrProvider, paramInt);
  ...
  public ArrayList a(int paramInt)
  {
    int i3 = 2147483647;
    int i2 = 0;
    ArrayList localArrayList1 = FMTSrvAddrProvider.b(this.jdField_a_of_type_ComTencentMobileqqTransfileFMTSrvAddrProvider, paramInt);
    int i;
    int k;
  ...
  public void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    ...
    {
      this.jdField_a_of_type_Array2dOfInt = new int[12][];
      ...
      if (i <= 10)
      {
        ...
        if (paramFileStoragePushFSSvcList != null) {}
        for (int j = paramFileStoragePushFSSvcList.size();; j = 0)
        {
