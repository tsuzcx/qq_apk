  ...
  implements Runnable
{
  ...
  public ggc(RoamingActivity paramRoamingActivity, int paramInt) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentMobileqqMaproamActivityRoamingActivity.c.getLayoutParams().height = this.jdField_a_of_type_ComTencentMobileqqMaproamActivityRoamingActivity.getResources().getDimensionPixelSize(2131427574);
    }
  }
}
