...
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new cnn(this);
  private DataTag jdField_a_of_type_ComTencentMobileqqProfileDataTag;
  
  public cnm(FriendProfileCardActivity paramFriendProfileCardActivity) {}
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (ProfileActivity.AllInOne.a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.a.a))
      {
        ...
        ((QQCustomMenu)localObject).a(2131234878, this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getString(2131561879));
