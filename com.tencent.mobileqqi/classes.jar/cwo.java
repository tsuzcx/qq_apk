...
{
  private cwo(HornListActivity paramHornListActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    case 0: 
      if (paramView == null)
      {
        paramView = this.jdField_a_of_type_ComTencentMobileqqActivityHornListActivity.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903673, paramViewGroup, false);
        paramViewGroup = new cck();
        paramView.setTag(paramViewGroup);
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetAnimationTextView = ((AnimationTextView)paramView.findViewById(2131233361));
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetAnimationTextView.setSpannableFactory(QQText.a);
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131233362));
        paramViewGroup.b = ((TextView)paramView.findViewById(2131233360));
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131233358));
        paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131233363));
      }
      for (;;)
      {
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new cwp(this, (HornDetail)localObject));
        return paramView;
        paramViewGroup = (cck)paramView.getTag();
      }
    }
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityHornListActivity.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903281, null);
      paramViewGroup = new cck();
      paramView.setTag(paramViewGroup);
      paramViewGroup.d = ((TextView)paramView.findViewById(2131231867));
      paramViewGroup.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131231066));
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131231866));
