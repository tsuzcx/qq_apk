  ...
  extends BaseAdapter
{
  ...
  public chc(ChatBackgroundSettingActivity paramChatBackgroundSettingActivity, ArrayList paramArrayList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      ...
      localObject3 = (ImageView)paramView.findViewById(2131231326);
      paramViewGroup = (ImageView)paramView.findViewById(2131231328);
      localView1 = paramView.findViewById(2131231327);
      localView2 = paramView.findViewById(2131231329);
      ...
      localObject1 = (ProgressBar)paramView.findViewById(2131231330);
      ...
      paramInt = 1;
      label200:
      ((ImageView)localObject3).setImageResource(2130839802);
    ...
    for (;;)
    {
      paramViewGroup.setOnClickListener(new chd(this));
      return paramView;
      ...
      Object localObject4 = BitmapManager.a(AppConstants.aR + ((ChatBackgroundSettingActivity.PicInfo)localObject2).a + ".png");
      if (localObject4 != null)
      {
        ...
        localObject3 = AppConstants.aS + ((ChatBackgroundSettingActivity.PicInfo)localObject2).jdField_b_of_type_JavaLangString + ".png";
