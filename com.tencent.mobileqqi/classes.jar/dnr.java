  ...
  protected void c(boolean paramBoolean, SubAccountBackProtocData paramSubAccountBackProtocData)
  {
    ...
    do
    {
      do
      {
        ...
        this.a.a(paramSubAccountBackProtocData, str, new dns(this));
        return;
      } while (!paramBoolean);
      this.a.b.a().c(AppConstants.O, 7000);
    } while (!this.a.c);
    this.a.a(this.a.getString(2131562520), this.a.getString(2131563026), this.a.getString(2131562540), new dnt(this));
  }
}
