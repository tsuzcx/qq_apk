  ...
  extends AsyncTask
{
  ...
  public hey(ImageWorker paramImageWorker, View paramView)
  {
  ...
  {
    View localView = a();
    hfa localhfa = (hfa)ImageWorker.a(this.jdField_a_of_type_ComTencentMobileqqUtilImageWorker).remove(localView);
    ...
    if (localView != null)
    {
      ...
      if ((localhfa != null) && (localhfa.a != null)) {
        localhfa.a.a(localView, null);
      }
    }
    return;
    label72:
    ImageWorker.a(this.jdField_a_of_type_ComTencentMobileqqUtilImageWorker, this.jdField_a_of_type_Boolean, localView, paramDrawable, localhfa);
  }
}
