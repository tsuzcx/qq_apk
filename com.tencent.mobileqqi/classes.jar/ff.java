...
public class ff
  implements Runnable
{
  public ff(FontManager paramFontManager) {}
    ...
    try
    {
      ...
      if (this.a.jdField_a_of_type_ComEtrumpMixlayoutETEngine != null)
      {
        ...
        if ((localObject != null) && (0L != ((ExtensionInfo)localObject).uVipFont))
        {
          ...
          if (localObject != null) {
            this.a.jdField_a_of_type_ComEtrumpMixlayoutETEngine.a((int)((ey)localObject).jdField_a_of_type_Long, ((ey)localObject).jdField_a_of_type_JavaLangString, true);
          }
        }
