...
{
  fti(fth paramfth, ActionSheet paramActionSheet) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Fth.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFileviewerBaseBaseFileViewerActivity.f();
      return;
      ...
      continue;
      FileManagerUtil.b(this.jdField_a_of_type_Fth.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFileviewerBaseBaseFileViewerActivity, this.jdField_a_of_type_Fth.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFilePath);
      continue;
      this.jdField_a_of_type_Fth.b();
    }
  }
}
