  ...
  implements View.OnClickListener
{
  ...
  public cmu(FriendProfileCardActivity paramFriendProfileCardActivity)
  {
          ...
          try
          {
            ...
            if ((((DataTag)localObject2).a instanceof String))
            {
              ...
              if (ProfileActivity.AllInOne.f(this.a.jdField_a_of_type_ComTencentMobileqqProfileProfileCardInfo.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne))
              {
                ...
                label3322:
                ChatActivityUtils.a(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.a, i, (String)localObject2, paramView, str1, true, (String)localObject1, true, true, null, "");
