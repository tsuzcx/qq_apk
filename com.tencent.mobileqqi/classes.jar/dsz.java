...
{
  public dsz(SubLoginActivity paramSubLoginActivity) {}
  ...
  protected void a(boolean paramBoolean, SubAccountBackProtocData paramSubAccountBackProtocData)
  {
    ...
    this.a.a(this.a.getString(2131562520), this.a.getString(2131563026), this.a.getString(2131562540), new dtc(this));
  }
    ...
    for (;;)
    {
      ...
      while ((paramSubAccountBackProtocData != null) && (QLog.isColorLevel()))
      {
        ...
        case 1002: 
          ...
          this.a.a((String)localObject, str, new dta(this));
          break;
        case 1003: 
        ...
        case 1004: 
          ...
          this.a.runOnUiThread(new dtb(this));
