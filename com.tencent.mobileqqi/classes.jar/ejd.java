...
{
  public ejd(MainAssistObserver paramMainAssistObserver, RadioButton paramRadioButton1, QQCustomDialog paramQQCustomDialog, RadioButton paramRadioButton2) {}
  ...
  public void onClick(View paramView)
  {
    if (this.jdField_a_of_type_AndroidWidgetRadioButton.isChecked())
    {
      ...
      MainAssistObserver.a(this.jdField_a_of_type_ComTencentMobileqqActivityMainMainAssistObserver, new eje(this));
    }
    do
    {
      return;
