  ...
  extends a
{
  ...
  public byte[] a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt1, int paramInt2, int paramInt3, long paramLong1, long paramLong2, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, byte[] paramArrayOfByte6, byte[] paramArrayOfByte7, long paramLong3, byte[] paramArrayOfByte8, byte[] paramArrayOfByte9, byte[] paramArrayOfByte10)
  {
    ...
    this.d = (paramArrayOfByte1.length + 1 + 1 + 1 + str.length() + 1 + paramArrayOfByte2.length + 1 + paramArrayOfByte3.length + 1 + 1 + 1 + 4 + 4 + 1 + paramArrayOfByte5.length + 1 + paramArrayOfByte6.length + 1 + (arrayOfByte.length + 2) + 6 + 10 + (paramArrayOfByte8.length + 2) + (paramArrayOfByte9.length + 2) + (paramArrayOfByte7.length + 5 + 4));
    ...
    for (paramInt1 = 1;; paramInt1 = 2)
    {
      ...
      util.int8_to_buf(paramArrayOfByte10, paramInt1, 37);
      paramInt1 += 1;
      util.int8_to_buf(paramArrayOfByte10, paramInt1, 2);
      paramInt1 += 1;
      util.int16_to_buf(paramArrayOfByte10, paramInt1, t.ak);
