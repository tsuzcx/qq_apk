  ...
  extends a
{
  ...
  public byte[] a(long paramLong1, long paramLong2, int paramInt1, long paramLong3, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt2, byte[] paramArrayOfByte3, long paramLong4, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, int paramInt3, byte[] paramArrayOfByte6, int paramInt4)
  {
    ...
    this.j += paramArrayOfByte6.length + 2;
    paramArrayOfByte4 = new byte[this.j];
    util.int16_to_buf(paramArrayOfByte4, 0, this.h);
    util.int32_to_buf(paramArrayOfByte4, 2, util.get_rand_32());
    util.int32_to_buf(paramArrayOfByte4, 6, this.i);
