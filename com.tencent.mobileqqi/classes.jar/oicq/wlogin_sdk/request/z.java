  ...
  extends j
{
  ...
  public int a(long paramLong1, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, long paramLong2, WUserSigInfo paramWUserSigInfo)
  {
    for (;;)
    {
      try
      {
        ...
        long l1 = System.currentTimeMillis() / 1000L;
        long l2 = t.aa;
        t.ah.commit(Build.VERSION.RELEASE, new String(t.E), "", util.buf_to_string(util.get_ksid(t.r)), new String(t.C), new String(t.O), new String(t.G), new String(t.F), util.get_release_time(), "6.3.1.2293");
        try
        {
          paramArrayOfByte1 = t.ah.toJasonObj().toString().getBytes();
          if (paramArrayOfByte1 != null)
          {
        ...
        if (i != 0)
        {
          ...
          report_t.write_tofile(t.ah, t.r);
          continue;
        }
        i = b();
      }
  ...
  public byte[] a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.w.p != null)
      {
        ...
        {
          arrayOfByte2 = new bg().a(this.w.p);
  ...
  {
    if (this.w.ae != null) {
      util.LOGD("_transport_sk", "_transport_sk" + this.w.ae.toString());
    }
    for (;;)
    {
      return this.w.ae;
