  ...
  extends WtloginListener
{
  ...
  private int CheckPictureAndGetSt(String paramString, byte[] paramArrayOfByte, WUserSigInfo paramWUserSigInfo, byte[][] paramArrayOfByte1, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      label330:
      t.ah.commit_t2(localt.f, localt.g, util.format_ret_code(paramInt), paramInt);
      if (paramInt != 0) {
        break label1304;
      }
  ...
  private int GetA1WithA1(String paramString, long paramLong1, long paramLong2, int paramInt1, byte[] paramArrayOfByte1, long paramLong3, long paramLong4, long paramLong5, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, WUserSigInfo paramWUserSigInfo, WFastLoginInfo paramWFastLoginInfo, int paramInt2)
  {
    ...
    t.ah.add_t2(new report_t2("login", new String(t.A), System.currentTimeMillis(), paramLong4, paramLong5, null));
    long l1;
    if (!util.check_uin_account(paramString).booleanValue())
    {
      long l2 = localt.b(paramString);
    ...
    for (;;)
    {
      t.ah.commit_t2(localt.f, localt.g, util.format_ret_code(paramInt1), paramInt1);
      if (paramInt1 == 0) {
  ...
  private int GetStWithPasswd(String paramString1, long paramLong1, int paramInt1, long paramLong2, long[] paramArrayOfLong, boolean paramBoolean1, String paramString2, WUserSigInfo paramWUserSigInfo, byte[][] paramArrayOfByte, boolean paramBoolean2, int paramInt2)
  {
    ...
    if ((paramBoolean2) && (!oicq.wlogin_sdk.a.h.v))
    {
      ...
      t.ah.add_t2(new report_t2("login", new String(t.A), System.currentTimeMillis(), paramLong1, paramLong2, paramArrayOfLong));
  ...
  private int GetStWithoutPasswd(String paramString, long paramLong1, long paramLong2, long paramLong3, int paramInt1, long paramLong4, long[] paramArrayOfLong, WUserSigInfo paramWUserSigInfo, byte[][] paramArrayOfByte1, byte[][] paramArrayOfByte2, int paramInt2, WtTicketPromise paramWtTicketPromise)
  {
    ...
    if ((paramWUserSigInfo._reserveData != null) && (paramWUserSigInfo._reserveData.length > 3))
    {
      ...
      t.ah.add_t2(new report_t2("exchg", new String(t.A), System.currentTimeMillis(), paramLong2, paramLong4, paramArrayOfLong));
      if (util.check_uin_account(paramString).booleanValue()) {
        break label780;
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        t.ah.commit_t2(paramWtTicketPromise.f, paramWtTicketPromise.g, util.format_ret_code(paramInt1), paramInt1);
        if (paramInt1 == 0) {
          if ((paramArrayOfLong._sig != null) && (paramArrayOfLong._sig.length != 0)) {
  ...
  private int RequestInit()
  {
    try
    {
      ...
      int j = ShareKeyInit();
      AsyncGenRSAKey();
      util.LOGI("WtloginHelper init ok, ret:" + j + " android version:" + new String(t.H) + " saved_network_type:" + i + " network_type:" + t.B + " release time:" + util.get_release_time() + " svn verion:" + 2293L + " at " + t.l(), "");
      return j;
    }
    finally {}
  }
  ...
  private int ShareKeyInitBC()
  {
    try
    {
      ...
      this.mG.n = ((byte[])localObject2);
      this.mG.o = ((byte[])localObject1);
      util.LOGI("client public key = " + util.buf_to_string(this.mG.n), "");
      util.LOGI("share key = " + util.buf_to_string(this.mG.o), "");
      util.LOGI("create key pair and shared key with bouncycastle OK", "");
      return 0;
    }
    catch (Exception localException)
    {
      util.LOGW("create key pair and shared key failed, " + localException.getStackTrace(), "");
      t.ah.attr_api(2369828);
    }
    return -6;
  }
  ...
  private int ShareKeyInitDefault()
  {
    ...
    t localt = this.mG;
    util.LOGW(t.ac + " using DEFAULT key", "");
    return 0;
  }
  ...
  public int CheckDevLockSms(String paramString1, long paramLong1, long paramLong2, String paramString2, byte[] paramArrayOfByte, WUserSigInfo paramWUserSigInfo)
  {
    ...
    byte[] arrayOfByte2 = "6.3.1.2293".getBytes();
  ...
  public int CheckDevLockStatus(String paramString, long paramLong1, long paramLong2, WUserSigInfo paramWUserSigInfo)
  {
    ...
    localTransReqContext._body = locala.a(l, paramLong1, paramLong2, ((WloginSigInfo)localObject)._TGT, t.y, t.C, "6.3.1.2293".getBytes(), t.I, t.H);
    if ((localTransReqContext._body == null) || (localTransReqContext._body.length == 0)) {
      return -1017;
    }
  ...
  public Boolean ClearUserLoginData(String paramString, long paramLong)
  {
    ...
    //   22: lload_2
    //   23: invokevirtual 150	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   26: ldc_w 1830
    ...
    //   35: aload_1
    //   36: invokestatic 162	oicq/wlogin_sdk/tools/util:LOGI	(Ljava/lang/String;Ljava/lang/String;)V
    //   39: aload_1
    //   40: ifnull +10 -> 50
    //   43: aload_1
    ...
    //   47: ifgt +8 -> 55
    //   50: iconst_1
    //   51: invokestatic 1833	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   54: areturn
    //   55: aload_0
    //   56: monitorenter
    //   57: aload_1
    //   58: invokestatic 179	oicq/wlogin_sdk/tools/util:check_uin_account	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   61: invokevirtual 185	java/lang/Boolean:booleanValue	()Z
    //   64: ifne +72 -> 136
    //   67: aload_0
    //   68: getfield 52	oicq/wlogin_sdk/request/WtloginHelper:mG	Loicq/wlogin_sdk/request/t;
    //   71: aload_1
    //   72: invokevirtual 188	oicq/wlogin_sdk/request/t:b	(Ljava/lang/String;)J
    //   75: lstore 5
    //   77: lload 5
    //   79: lconst_0
    //   80: lcmp
    ...
    //   97: lload 5
    //   99: lload_2
    //   100: invokevirtual 1836	oicq/wlogin_sdk/request/t:c	(JJ)V
    //   103: aload_0
    //   104: monitorexit
    //   105: iconst_0
    //   106: newarray byte
    //   108: putstatic 810	oicq/wlogin_sdk/sharemem/WloginSigInfo:_QRPUSHSig	[B
    //   111: iconst_0
    //   112: newarray byte
    //   114: putstatic 801	oicq/wlogin_sdk/sharemem/WloginSigInfo:_LHSig	[B
    //   117: iconst_1
    //   118: invokestatic 1833	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   121: areturn
    //   122: aload_0
    //   123: getfield 52	oicq/wlogin_sdk/request/WtloginHelper:mG	Loicq/wlogin_sdk/request/t;
    //   126: aload_1
    //   127: invokevirtual 1267	oicq/wlogin_sdk/request/t:d	(Ljava/lang/String;)V
    //   130: iconst_1
    //   131: istore 4
    //   133: goto -46 -> 87
    //   136: aload_1
    //   137: invokestatic 275	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   140: lstore 5
    //   142: iconst_1
    //   143: istore 4
    //   145: goto -58 -> 87
  ...
  public int CloseDevLock(String paramString, long paramLong1, long paramLong2, WUserSigInfo paramWUserSigInfo)
  {
    ...
    localTransReqContext._body = localb.a(l, paramLong1, paramLong2, localWloginSigInfo._TGT, t.y, t.C, "6.3.1.2293".getBytes(), "android".getBytes(), ((String)localObject).getBytes());
    if ((localTransReqContext._body == null) || (localTransReqContext._body.length == 0)) {
      return -1017;
    }
        ...
        if (localWloginSigInfo._dpwd != null)
        {
          ...
          if (localWloginSigInfo._dpwd.length > 0)
          {
            ...
            if (localWloginSigInfo._randseed != null)
            {
              ...
              {
                ((ck)localObject3).a(localWloginSigInfo._G, l, t.y, localWloginSigInfo._dpwd, paramLong, 1L, localWloginSigInfo._randseed);
