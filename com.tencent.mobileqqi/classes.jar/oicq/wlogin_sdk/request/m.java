  ...
  extends j
{
  ...
  public byte[] a(long paramLong1, long paramLong2, long paramLong3, int paramInt1, int paramInt2, byte[] paramArrayOfByte1, int paramInt3, int paramInt4, long[] paramArrayOfLong, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, List<String> paramList)
  {
    ...
    Object localObject21 = new cp();
    be localbe = new be();
    Object localObject20 = new bg();
    Object localObject18 = new bj();
    Object localObject19 = new bx();
    ...
    localObject18 = ((bj)localObject18).a(1524812170L, "6.3.1.2293");
    ...
    for (paramInt1 = 11;; paramInt1 = 10)
    {
      ...
      {
        paramArrayOfLong = ((cp)localObject21).a(paramList);
        paramInt1 += 1;
      }
      for (;;)
      {
        ...
        {
          paramArrayOfByte2 = ((bg)localObject20).a(this.w.p);
          paramInt1 += 1;
        }
        for (;;)
        {
          ...
          {
            paramList = ((bx)localObject19).a(t.L);
            paramInt1 += 1;
          }
          for (;;)
          {
              ...
              for (;;)
              {
                ...
                for (;;)
                {
                  ...
                  for (;;)
                  {
                    ...
                    localObject21 = t.A;
                    localObject22 = t.D;
                    localObject9 = localan.a((byte[])localObject16, ((ab)localObject9).a((byte[])localObject19, (byte[])localObject20, paramInt2, (byte[])localObject21, new byte[0], (byte[])localObject22), localaf.a(t.R, t.S, t.T, t.W, t.G, t.y, t.N), localbe.a(t.G), this.w.b);
