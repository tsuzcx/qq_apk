  ...
  implements Parcelable, Serializable
{
  ...
  public String toString()
  {
    try
    {
      String str = String.format(Locale.getDefault(), "{A1:%d,%d A2:%d pskey:%d,%d pt4token:%d}", new Object[] { Integer.valueOf(this._en_A1.length), Long.valueOf(this._create_time), Integer.valueOf(this._TGT.length), Integer.valueOf(this._psKey.length), Long.valueOf(this._psKey_create_time), Integer.valueOf(this._pt4Token.length) });
      return str;
    }
