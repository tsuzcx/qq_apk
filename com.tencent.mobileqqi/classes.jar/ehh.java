...
public final class ehh
  extends AsyncTask
{
  public ehh(Context paramContext, int paramInt, QQAppInterface paramQQAppInterface, URLDrawable paramURLDrawable, String paramString) {}
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    paramVarArgs = AppConstants.aq + (String)localObject1 + paramVarArgs + ".jpg";
  ...
  protected void a(Integer paramInteger)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), this.jdField_a_of_type_AndroidContentContext.getString(2131561900), 0).b(this.jdField_a_of_type_Int);
    ...
    do
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), this.jdField_a_of_type_AndroidContentContext.getString(2131563114), 0).b(this.jdField_a_of_type_Int);
        return;
      }
    } while (paramInteger.intValue() != 2);
    QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), this.jdField_a_of_type_AndroidContentContext.getString(2131561494), 0).b(this.jdField_a_of_type_Int);
  }
}
