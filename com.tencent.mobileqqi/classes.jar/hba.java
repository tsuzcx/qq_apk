...
public class hba
  extends AsyncTask
{
  public hba(VideoPlayLogic paramVideoPlayLogic, TroopInfoManager paramTroopInfoManager) {}
  ...
  protected void a(Void paramVoid)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqModelTroopInfoManager.a(VideoPlayLogic.a(this.jdField_a_of_type_ComTencentMobileqqTroopLogicVideoPlayLogic)))
    {
      ...
      if (TroopFileUtils.a(VideoPlayLogic.a(this.jdField_a_of_type_ComTencentMobileqqTroopLogicVideoPlayLogic)) != 2)
      {
        ...
        DialogUtil.a(VideoPlayLogic.a(this.jdField_a_of_type_ComTencentMobileqqTroopLogicVideoPlayLogic), 230, VideoPlayLogic.a(this.jdField_a_of_type_ComTencentMobileqqTroopLogicVideoPlayLogic).getString(2131560332), VideoPlayLogic.a(this.jdField_a_of_type_ComTencentMobileqqTroopLogicVideoPlayLogic).getString(2131560430), 2131561746, 2131560431, new hbb(this), new hbc(this)).show();
        return;
      }
