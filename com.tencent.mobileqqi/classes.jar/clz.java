...
public class clz
  extends Thread
{
  public clz(ForwardOperations paramForwardOperations, String paramString1, int paramInt, String paramString2) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      if ((i >= 3) || ((this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.c) && (this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse != null)))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new cma(this));
      }
      label89:
      Object localObject1;
      Object localObject2;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = HttpUtil.a(BaseApplication.getContext(), str2, this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_v_of_type_JavaLangString, 1, localHashMap);
        this.jdField_a_of_type_ComTencentMobileqqActivityForwardOperations.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new cmc(this, (HashMap)localObject1));
        return;
      }
