  ...
  extends FacePreloadBaseAdapter
{
  ...
  public egf(RecommendTroopView paramRecommendTroopView, Context paramContext, QQAppInterface paramQQAppInterface, SlideDetectListView paramSlideDetectListView)
  {
  ...
  private void a(int paramInt, RecTroopBusinessItem paramRecTroopBusinessItem, egh paramegh)
  {
    ...
    if (localObject != null) {
      paramegh.jdField_c_of_type_AndroidWidgetImageView.setBackgroundDrawable(localObject);
    }
    for (;;)
    {
      paramegh.jdField_a_of_type_AndroidWidgetTextView.setText(paramRecTroopBusinessItem.title);
      paramegh.b.setText(paramRecTroopBusinessItem.des);
      paramegh.d.setText(paramRecTroopBusinessItem.btnText);
      paramegh.d.setVisibility(0);
      paramegh.d.setOnClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityContactTroopRecommendTroopView);
      paramegh.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      paramegh.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      return;
      paramegh.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130838413);
    }
  }
  
  private void a(int paramInt, RecommendTroopInfo paramRecommendTroopInfo, egh paramegh)
  {
    if (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramRecommendTroopInfo.uin))
    {
      paramegh.b.setTag(Integer.valueOf(paramRecommendTroopInfo.curMemberNum));
      this.jdField_a_of_type_JavaUtilHashMap.put(paramRecommendTroopInfo.uin, paramegh.b);
    }
    paramegh.jdField_a_of_type_JavaLangString = paramRecommendTroopInfo.uin;
    Bitmap localBitmap = a(4, paramRecommendTroopInfo.uin);
    paramegh.jdField_c_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(localBitmap));
    paramegh.jdField_a_of_type_AndroidWidgetTextView.setText(paramRecommendTroopInfo.name);
    if ((paramRecommendTroopInfo.flagExt & 0x800) != 0) {
      if (paramRecommendTroopInfo.authType == 2)
      {
        paramegh.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        paramegh.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130838181);
      }
    }
    for (;;)
    {
      b(paramInt, paramRecommendTroopInfo, paramegh);
      ...
      paramegh.d.setVisibility(8);
      paramegh.jdField_c_of_type_AndroidWidgetTextView.setText(2131561611);
      paramegh.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
      return;
      if (paramRecommendTroopInfo.authType == 1)
      {
        paramegh.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        paramegh.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130838357);
      }
      else
      {
        paramegh.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    ...
    paramegh.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
    paramegh.d.setText(2131560762);
    paramegh.d.setOnClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityContactTroopRecommendTroopView);
    paramegh.d.setVisibility(0);
  }
  
  private void b(int paramInt, RecommendTroopInfo paramRecommendTroopInfo, egh paramegh)
  {
    String str = "";
    if (this.b.containsKey(paramRecommendTroopInfo.uin)) {
      str = (String)this.b.get(paramRecommendTroopInfo.uin);
    }
    paramegh.b.setText(a(paramRecommendTroopInfo.curMemberNum, paramRecommendTroopInfo.isSameCity, paramRecommendTroopInfo.location, str));
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup = new egh(null);
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131232316));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131231399));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131232318));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131232320));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131232456));
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131232457));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout = ((ShaderAnimLayout)paramView.findViewById(2131232314));
      paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131232458));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (egh)paramView.getTag();
    }
    paramView.setOnClickListener(new egg(this, localRecommendTroopMsg));
