...
public class cfx
  extends Thread
{
  public cfx(DetailProfileActivity paramDetailProfileActivity, String paramString) {}
  ...
  public void run()
  {
    ...
    if (localCard != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityDetailProfileActivity.runOnUiThread(new cfy(this));
