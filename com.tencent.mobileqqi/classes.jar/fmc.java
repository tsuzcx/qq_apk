  ...
  implements Runnable
{
  ...
  public fmc(CleanCache paramCleanCache) {}
    ...
    if (paramFile.exists())
    {
      ...
      if (paramFile.isDirectory())
      {
        ...
        if (paramFile != null)
        {
          ...
          if (j > 2000)
          {
            Arrays.sort(paramFile, new fme(this));
            n = paramFile.length;
            k = m;
            i = j;
          }
  ...
  private File[] a(File[] paramArrayOfFile)
  {
    ...
    //   10: istore 5
    //   12: aload_0
    //   13: getfield 13	fmc:jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache	Lcom/tencent/mobileqq/app/automator/step/CleanCache;
    ...
    //   129: istore_2
    //   130: aload_0
    //   131: getfield 13	fmc:jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache	Lcom/tencent/mobileqq/app/automator/step/CleanCache;
  ...
  private int b(File paramFile)
  {
    ...
    {
      Arrays.sort(paramFile, new fmf(this));
      n = paramFile.length;
      k = m;
      j = i;
    }
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        arrayOfString[0] = AppConstants.ay;
        ...
        if (i < j)
        {
          ...
          Arrays.sort((Object[])localObject, new fmd(this));
