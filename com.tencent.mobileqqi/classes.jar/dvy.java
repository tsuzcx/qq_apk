...
{
  public dvy(TroopMemberCardActivity paramTroopMemberCardActivity) {}
      ...
      while (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.jdField_a_of_type_ComTencentWidgetActionSheet != null)
      {
          ...
          if (paramInt == 0) {
            ...
            else
            {
              ...
              for (paramView = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.c;; paramView = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.jdField_b_of_type_JavaLangString + "(" + this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.c + ")")
              {
                ...
                paramView.setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131562701), new dvz(this, paramView));
                ...
                paramView.setNegativeButton(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131561746), new dwa(this, paramView));
        ...
        else if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.B == 3)
        {
          ...
          case 2: 
            ...
            paramView.setContentView(2130903219);
            ...
            ((TextView)paramView.findViewById(2131231665)).setText(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131563216));
            localObject = (CheckBox)paramView.findViewById(2131231665);
            ...
            localTextView1.setOnClickListener(new dwb(this, paramView));
            localTextView2.setOnClickListener(new dwc(this, (CheckBox)localObject, paramView));
            paramView.show();
