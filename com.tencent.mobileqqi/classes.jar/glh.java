...
{
  public glh(EditActivity paramEditActivity) {}
      ...
      if ((paramBitmap != null) && (paramInt2 == 201) && (EditActivity.a(this.a)))
      {
        ...
        while (paramInt2 < i)
        {
          ...
          if (paramInt1 == ((Integer)localView.getTag()).intValue()) {
            ((ImageView)localView.findViewById(2131232966)).setImageDrawable(new StatableBitmapDrawable(this.a.getResources(), paramBitmap, false, false));
          }
          paramInt2 += 1;
        }
      }
