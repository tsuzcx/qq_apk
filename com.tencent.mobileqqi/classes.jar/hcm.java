...
public class hcm
  extends BaseAdapter
{
  public hcm(QQCustomDialogThreeBtns paramQQCustomDialogThreeBtns) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView.a != null)
    {
      ...
      paramView.a.setOnClickListener(new hct(this.a, paramInt));
