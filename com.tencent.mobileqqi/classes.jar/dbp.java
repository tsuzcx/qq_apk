...
{
  public dbp(MayKnowManActivity paramMayKnowManActivity, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramViewGroup = this.a.getLayoutInflater().inflate(2130903276, null);
    }
    paramView = (dbo)paramViewGroup.getTag();
    if (paramView == null)
    {
      paramView = new dbo(this.a, null);
      paramView.c = ((ImageView)paramViewGroup.findViewById(2131231921));
      paramView.jdField_a_of_type_AndroidWidgetButton = ((Button)paramViewGroup.findViewById(2131231923));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131231922));
      paramView.b = ((TextView)paramViewGroup.findViewById(2131231924));
    ...
    for (;;)
    {
      ...
      paramView.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new dbq(this, localVisitor));
