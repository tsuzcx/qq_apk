...
{
  public duf(TroopAssistantActivity paramTroopAssistantActivity) {}
  ...
  protected void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      new Thread(new duh(this, paramString)).start();
      return;
    }
    this.a.h();
  }
  ...
  protected void a(boolean paramBoolean, Map paramMap)
  {
    ...
    if (paramBoolean)
    {
      QQToast.a(this.a.b.a(), 2130837958, this.a.getString(2131562193), 0).b(this.a.d());
      return;
    }
    QQToast.a(this.a.b.a(), 2130837947, this.a.getString(2131562192), 0).b(this.a.d());
  }
  
  protected void a(boolean paramBoolean, String[] paramArrayOfString)
  {
    if (paramBoolean) {
      new Thread(new dui(this)).start();
    }
  }
  ...
  void b(String paramString)
  {
    ...
    this.a.runOnUiThread(new dug(this));
  }
