...
public class erq
  extends AsyncTask
{
  private erq(PhotoListActivity paramPhotoListActivity) {}
  ...
  protected void a(List paramList)
  {
    ...
    this.a.jdField_a_of_type_Ero.a(paramList);
    if (PhotoListActivity.d(this.a)) {
    ...
    for (;;)
    {
      ...
      {
        label216:
        j = this.a.jdField_a_of_type_Ero.getCount();
        if (j == 0) {
          j = k;
        }
        for (;;)
        {
          ...
          this.a.jdField_a_of_type_Ero.notifyDataSetChanged();
