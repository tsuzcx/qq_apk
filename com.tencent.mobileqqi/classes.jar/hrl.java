...
{
  public hrl(DownloadManager paramDownloadManager) {}
  ...
  {
    ThreadManager.b().post(new hrn(this, paramLong1, paramLong2, paramString));
  }
  ...
  {
    ThreadManager.b().post(new hrm(this, paramTMAssistantDownloadSDKClient, paramInt1, paramString1, paramInt2, paramString2));
  }
