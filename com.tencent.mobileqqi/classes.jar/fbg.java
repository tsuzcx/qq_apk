  ...
  extends BaseAdapter
{
  ...
  public fbg(VoipHistoryActivity paramVoipHistoryActivity, Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130904058, paramViewGroup, false);
    ImageView localImageView2 = (ImageView)paramViewGroup.findViewById(2131234698);
    ImageView localImageView1 = (ImageView)paramViewGroup.findViewById(2131234700);
    TextView localTextView2 = (TextView)paramViewGroup.findViewById(2131234699);
    TextView localTextView3 = (TextView)paramViewGroup.findViewById(2131234701);
    TextView localTextView1 = (TextView)paramViewGroup.findViewById(2131234702);
    VoipHistoryActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityVoipVoipHistoryActivity, (RelativeLayout)paramViewGroup.findViewById(2131234697));
    ...
    paramView = (fbf)paramViewGroup.getTag();
    if (paramView == null)
    {
      paramView = new fbf(this.jdField_a_of_type_ComTencentMobileqqActivityVoipVoipHistoryActivity, null);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          VoipHistoryActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityVoipVoipHistoryActivity, (RelativeLayout)paramViewGroup.findViewById(2131234696));
          ...
          if (VoipHistoryActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityVoipVoipHistoryActivity) != null) {
            VoipHistoryActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityVoipVoipHistoryActivity).setOnLongClickListener(new fbh(this));
          }
          ...
          continue;
          localImageView1.setImageResource(2130840372);
          continue;
          localImageView1.setImageResource(2130840373);
        }
        ...
        if (paramView.isVideo())
        {
          ...
          ((ImageView)paramViewGroup.findViewById(2131234703)).setImageResource(2130840481);
          if (paramView.isSend())
          {
            localImageView1.setImageResource(2130840374);
            label666:
