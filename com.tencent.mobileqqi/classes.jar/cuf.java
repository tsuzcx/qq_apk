  ...
  implements View.OnClickListener
{
  ...
  public cuf(LoginActivity paramLoginActivity, Context paramContext)
  {
  ...
  public Filter getFilter()
  {
    if (this.jdField_a_of_type_AndroidWidgetFilter == null) {
      this.jdField_a_of_type_AndroidWidgetFilter = new cug(this);
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      paramViewGroup.setOnClickListener(new cuh(this, paramInt));
      return paramView;
