      ...
      while (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.jdField_a_of_type_ComTencentWidgetActionSheet != null)
      {
          ...
          if (paramInt == 0) {
            ...
            else
            {
              ...
              for (paramView = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.c;; paramView = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.jdField_b_of_type_JavaLangString + "(" + this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.c + ")")
              {
                ...
                paramView.setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131562701), new dqh(this, paramView));
                ...
                paramView.setNegativeButton(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131561746), new dqi(this, paramView));
        ...
        else if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.B == 3)
        {
          ...
          case 2: 
            ...
            ((TextView)paramView.findViewById(2131231468)).setText(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131562758));
            ...
            ((TextView)paramView.findViewById(2131231666)).setText(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberCardActivity.getString(2131563216));
            localObject = (CheckBox)paramView.findViewById(2131231666);
            TextView localTextView1 = (TextView)paramView.findViewById(2131231471);
            TextView localTextView2 = (TextView)paramView.findViewById(2131231472);
            localTextView1.setText(17039360);
            localTextView2.setText(17039370);
            localTextView1.setOnClickListener(new dqj(this, paramView));
            localTextView2.setOnClickListener(new dqk(this, (CheckBox)localObject, paramView));
            paramView.show();
