...
{
  private crb(JoinDiscussionActivity paramJoinDiscussionActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, RespGetDiscussInfo paramRespGetDiscussInfo)
  {
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((FriendsManager)this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(46)).a(((DiscussionMemberInfo)localObject1).memberUin);
        ...
        while (paramInt < this.a.jdField_c_of_type_Int)
        {
          ...
          if (this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a((String)localObject1, true) != null)
          {
      ...
      this.a.jdField_c_of_type_JavaLangString = ContactUtils.a(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.a.d, String.valueOf(this.a.jdField_a_of_type_Long), l | 0x20000000, paramRespGetDiscussInfo.Name, localHashMap);
      if (this.a.jdField_a_of_type_JavaUtilArrayList.size() == this.a.jdField_c_of_type_Int)
      {
        ...
        this.a.runOnUiThread(new crc(this, paramRespGetDiscussInfo));
      }
      this.a.runOnUiThread(new crd(this));
      return;
    }
    this.a.a(0, paramInt);
  }
  ...
  protected void a(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ReportController.b(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(), "discuss", "discuss_QR_join", 0, 0, "", "", "", "");
      ...
      if ((str != null) && (str.length() > 0))
      {
        ...
        paramLong = Long.parseLong(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a());
        paramInt = 0;
    ...
    {
      if (paramInt != 0) {
        QQToast.a(this.a, this.a.getString(2131559086), 0).b(this.a.d());
      }
