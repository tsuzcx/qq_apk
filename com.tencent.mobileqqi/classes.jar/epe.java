  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public epe(ContactsInnerFrame paramContactsInnerFrame, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = new epf(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame, null);
    ...
    paramView = (epf)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
