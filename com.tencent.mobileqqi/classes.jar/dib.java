...
{
  public dib(SetTroopAdminsActivity paramSetTroopAdminsActivity, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = new dif(null);
      paramView.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131234589));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131231411));
      paramView.b = ((TextView)paramViewGroup.findViewById(2131234590));
      paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131234591));
      paramViewGroup.setTag(paramView);
    }
    paramView = (dif)paramViewGroup.getTag();
    ...
    paramView.b.setOnClickListener(new dic(this, localTroopAdmin));
    return paramViewGroup;
  }
}
