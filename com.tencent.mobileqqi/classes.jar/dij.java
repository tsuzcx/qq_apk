...
{
  public dij(QQMapActivity paramQQMapActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject2 = this.a.getResources().getString(2131561419);
    String str2 = "mqqapi://app/action?pkg=com.tencent.mobileqq&cmp=com.tencent.biz.PoiMapActivity&type=sharedmap&lat=" + this.a.a + "&lon=" + this.a.b + "&title=" + paramView + "&loc=" + str1;
    localObject1 = new AbsShareMsg.Builder(StructMsgForGeneralShare.class).c(32).a((String)localObject2).b((String)localObject1).a("plugin", str2, str2, str2, str2).a();
