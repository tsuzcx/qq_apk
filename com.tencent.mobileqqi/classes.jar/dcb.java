  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = new dcd();
      localObject = (TextView)paramViewGroup.findViewById(2131233016);
    ...
    Object localObject = (dcd)paramViewGroup.getTag();
    ...
    {
      ((dcd)localObject).a.setText(new QQText(paramView, 5, 16, QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a()));
      return paramViewGroup;
