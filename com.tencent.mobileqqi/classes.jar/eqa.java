  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public eqa(FriendListInnerFrame paramFriendListInnerFrame)
  {
  ...
  protected Object a(int paramInt)
  {
    ...
    if (localFriends != null) {
      localFaceInfo.jdField_a_of_type_JavaLangString = localFriends.uin;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903964, paramViewGroup, false);
      paramView = new eqb(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame, null);
    ...
    paramView = (eqb)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(paramViewGroup.uin))
      {
        ...
        paramView.jdField_c_of_type_AndroidWidgetImageView.setImageBitmap(a(paramViewGroup.uin));
        paramView.jdField_c_of_type_AndroidWidgetTextView.setText(ContactSorter.a(paramViewGroup));
        paramView.jdField_a_of_type_JavaLangString = paramViewGroup.uin;
        if ((this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a == null) || (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a.contains(paramViewGroup.uin))) {
          break label370;
        }
        ...
        if (paramView.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled())
        {
          ...
          localView.setContentDescription(ContactSorter.a(paramViewGroup) + "已选中,双击取消");
        }
      }
      for (;;)
      {
        ...
        break label299;
        label381:
        localView.setContentDescription(ContactSorter.a(paramViewGroup) + "未选中,双击选中");
      }
    }
