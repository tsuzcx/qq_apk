...
public final class add_faces_rsp
  extends JceStruct
{
  ...
  public add_faces_rsp() {}
  
  public add_faces_rsp(int paramInt, String paramString, ArrayList paramArrayList)
  {
    this.ret = paramInt;
 ...
 * Qualified Name:     NS_MOBILE_PHOTO.add_faces_rsp
