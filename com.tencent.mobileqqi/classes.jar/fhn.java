...
public class fhn
  implements Runnable
{
  public fhn(I18nTranslatorHandler paramI18nTranslatorHandler, String paramString, Long paramLong, List paramList) {}
  
  public void run()
  {
    localObject1 = new fhp(this.jdField_a_of_type_ComTencentMobileqqAppI18nTranslatorHandler, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangLong, this.jdField_a_of_type_JavaUtilList);
