...
public class cny
  extends Handler
{
  public cny(DiscussionInfoCardActivity paramDiscussionInfoCardActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (i + 1 > DiscussionInfoCardActivity.b(this.a) * 3)
    {
      ...
      DiscussionInfoCardActivity.b(this.a).setOnClickListener(new cnz(this));
      ...
      DiscussionInfoCardActivity.a(this.a, new coe(this.a));
