...
{
  public cvx(MayKnowManActivity paramMayKnowManActivity, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramView = (cvw)paramViewGroup.getTag();
    if (paramView == null)
    {
      paramView = new cvw(this.a, null);
      paramView.c = ((ImageView)paramViewGroup.findViewById(2131231923));
      paramView.jdField_a_of_type_AndroidWidgetButton = ((Button)paramViewGroup.findViewById(2131231925));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131231924));
      paramView.b = ((TextView)paramViewGroup.findViewById(2131231926));
    ...
    for (;;)
    {
      ...
      paramView.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new cvy(this, localVisitor));
