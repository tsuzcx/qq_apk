...
{
  public gmj(ShareAppLogActivity paramShareAppLogActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    localQQCustomDialog.setPositiveButton("继续", new gmk(this));
    localQQCustomDialog.setNegativeButton("取消", new gml(this));
