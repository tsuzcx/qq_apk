...
public class bxq
  implements Runnable
{
  public bxq(ChatActivity paramChatActivity, QQMessageFacade.Message paramMessage, Intent paramIntent) {}
  ...
  public void run()
  {
    ...
    if ((!this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade$Message.frienduin)) && ((this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade$Message.senderuin == null) || (!this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade$Message.senderuin.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a()))) && (!this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.d))
    {
      if (ChatActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity) == null)
      {
        ...
        ChatActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity).setBackgroundDrawable(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getResources().getDrawable(2130837768));
        ...
        ChatActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity).setBackgroundResource(2130837768);
        ChatActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity).setTextColor(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getResources().getColorStateList(2131362105));
        ...
        localObject = new RelativeLayout.LayoutParams(-1, (int)this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getResources().getDimension(2131427501));
      ...
      ((RelativeLayout.LayoutParams)localObject).topMargin = ((int)this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getResources().getDimension(2131427501));
