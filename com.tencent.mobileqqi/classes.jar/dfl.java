...
public class dfl
  implements Runnable
{
  public dfl(RegisterPhoneNumActivity paramRegisterPhoneNumActivity, Bundle paramBundle) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      } while ((!bool1) || (TextUtils.isEmpty(str2)) || (TextUtils.isEmpty(str3)) || (RegisterPhoneNumActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterPhoneNumActivity, "6.0.3", str1) < 0));
