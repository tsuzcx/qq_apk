  ...
  extends XCursorAdapter
{
  ...
  public cqa(HelloListActivity paramHelloListActivity, Cursor paramCursor)
  {
    ...
    this.b = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839634);
  ...
  {
    return this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903249, paramViewGroup, false);
  }
  ...
  public void a(View paramView, Context paramContext, Cursor paramCursor)
  {
    ...
    paramContext = (cqb)paramView.getTag();
    if (paramContext == null)
    {
      paramContext = new cqb(null);
      paramContext.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131231771));
      paramContext.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131231772));
      paramContext.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231090));
      paramContext.b = ((TextView)paramView.findViewById(2131231773));
      paramContext.c = ((TextView)paramView.findViewById(2131231770));
      paramContext.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)paramView.findViewById(2131231774));
    ...
    for (paramView = paramContext;; paramView = paramContext)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          paramView.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(2130838010, paramCursor);
