...
{
  public ckk(ContactSyncJumpActivity paramContactSyncJumpActivity) {}
  ...
  protected void a(boolean paramBoolean, long paramLong, String paramString, GetOnlineInfoResp paramGetOnlineInfoResp)
  {
    ...
    do
    {
      ...
      for (paramLong = paramGetOnlineInfoResp.uAbiFlag;; paramLong = -10000L)
      {
        ...
        paramString = (TextView)this.a.jdField_a_of_type_AndroidAppDialog.findViewById(2131232927);
    ...
    {
      localObject = (TextView)this.a.jdField_a_of_type_AndroidAppDialog.findViewById(2131232927);
