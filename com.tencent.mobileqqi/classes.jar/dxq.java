  ...
  implements Runnable
{
  ...
  public dxq(Resources paramResources)
  {
    this.c = false;
    this.d = false;
  ...
  private void b()
  {
    ...
    long l2 = this.i;
    this.jdField_a_of_type_Dxr = new dxr(this, this.jdField_a_of_type_JavaLangObject);
    this.jdField_a_of_type_Dxr.execute(new Long[] { Long.valueOf(l1 + l2), Long.valueOf(this.g), Long.valueOf(this.f) });
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Dxr.cancel(false);
      this.jdField_a_of_type_Dxr = null;
    }
    this.f = -1;
  ...
  {
    if ((this.f == 1) && (((dxs)this.jdField_a_of_type_JavaLangObject).jdField_a_of_type_JavaLangString.equals(paramString))) {
      return;
    }
    a();
    this.f = 1;
    this.jdField_a_of_type_JavaLangObject = new dxs(this, paramString, paramInt1, paramInt2);
    BitmapFactory.Options localOptions = new BitmapFactory.Options();
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (this.g != -1)
    {
      ...
      localObject = (dxs)this.jdField_a_of_type_JavaLangObject;
      int i3 = this.g;
      int i4 = ((dxs)localObject).jdField_a_of_type_Int;
      int i2 = this.g / ((dxs)localObject).jdField_a_of_type_Int;
      int n = this.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() / ((dxs)localObject).jdField_a_of_type_Int;
      int i1 = this.jdField_a_of_type_AndroidGraphicsBitmap.getHeight() / ((dxs)localObject).b;
      i3 = i3 % i4 * this.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() / ((dxs)localObject).jdField_a_of_type_Int;
      i2 = i2 * this.jdField_a_of_type_AndroidGraphicsBitmap.getHeight() / ((dxs)localObject).b;
