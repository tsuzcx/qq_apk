...
{
  public bsu(AccountManageActivity paramAccountManageActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (!this.a.c)
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.a.getResources().getColor(2131362109));
    ...
    for (;;)
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.a.getResources().getColorStateList(2131362083));
      break label102;
      label216:
    ...
    this.a.a(this.a.c);
    this.a.d = false;
    this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new bsv(this), 400L);
  }
}
