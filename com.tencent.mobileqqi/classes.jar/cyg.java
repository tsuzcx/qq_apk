...
public final class cyg
  implements Runnable
{
  public cyg(QQAppInterface paramQQAppInterface, String paramString) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.e() == 1)
    {
      ...
      if (!SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131563461), "qqsetting_notify_myfeedpush_key", true)) {
        break label470;
      }
    }
    label415:
