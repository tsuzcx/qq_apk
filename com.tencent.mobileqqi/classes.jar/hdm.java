...
public class hdm
  extends BaseAdapter
{
  public hdm(QQCustomSplitDialog paramQQCustomSplitDialog) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = new hds(this.a, null);
      paramView.a = ((TextView)paramViewGroup.findViewById(2131231493));
      paramView.b = ((TextView)paramViewGroup.findViewById(2131231474));
      paramViewGroup.setTag(paramView);
    }
    paramView = (hds)paramViewGroup.getTag();
    int i;
    int j;
    int k;
    int m;
    if (paramView.b != null)
    {
      ...
      paramView.b.setOnClickListener(new hdr(this.a, paramInt));
