  ...
  extends BaseAdapter
{
  ...
  public ggi(ActionListActivity paramActionListActivity, ArrayList paramArrayList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = new ggh(null);
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131232969));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131232970));
      localView.setTag(paramView);
    }
    paramView = (ggh)localView.getTag();
