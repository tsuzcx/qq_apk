...
public class hqe
  implements Runnable
{
  public hqe(ReportManager paramReportManager, String paramString, Bundle paramBundle) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        HttpPost localHttpPost = new HttpPost(this.jdField_a_of_type_JavaLangString);
