  ...
  extends Thread
{
  ...
  public gmw(String paramString, HttpNotify paramHttpNotify)
  {
  ...
  public void run()
  {
    for (;;)
    {
      ...
      localHttpRequestHandlerRegistry.register("*", new gmv(this.jdField_a_of_type_JavaLangString, (Socket)localObject2));
      ...
      localObject1 = new gmx((HttpService)localObject2, (HttpServerConnection)localObject1, this.jdField_a_of_type_ComTencentMobileqqServiceHttpNotify, this);
      ((gmx)localObject1).setDaemon(true);
      ((gmx)localObject1).start();
