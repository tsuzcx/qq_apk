  ...
  extends BaseAdapter
{
  ...
  private eke(RecommendListView paramRecommendListView)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903930, paramViewGroup, false);
      paramViewGroup = new ekf();
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131231771));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131233360));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131232837));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131234360));
      paramViewGroup.c = ((TextView)paramView.findViewById(2131234361));
      ...
      if (RecommendListView.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendRecommendListView) == 0)
      {
        if (RecommendListView.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendRecommendListView) == null) {
          RecommendListView.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendRecommendListView, new ekd(this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendRecommendListView));
        }
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (ekf)paramView.getTag();
      break;
      label508:
