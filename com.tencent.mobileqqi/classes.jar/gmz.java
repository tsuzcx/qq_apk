...
public class gmz
  implements Runnable
{
  public gmz(MobileQQService paramMobileQQService, ToServiceMsg paramToServiceMsg) {}
  ...
  private void a(ToServiceMsg paramToServiceMsg)
  {
    ...
    if (MobileQQService.a(this.jdField_a_of_type_ComTencentMobileqqServiceMobileQQService) != null) {
      MobileQQService.a(this.jdField_a_of_type_ComTencentMobileqqServiceMobileQQService).cancel(2130838143);
    }
    this.jdField_a_of_type_ComTencentMobileqqServiceMobileQQService.a(2130838142, paramToServiceMsg);
  }
  ...
  private void b(ToServiceMsg paramToServiceMsg)
  {
    ...
    if (!MobileIssueSettings.e)
    {
      ...
      if (MobileQQService.a(this.jdField_a_of_type_ComTencentMobileqqServiceMobileQQService) != null) {
        MobileQQService.a(this.jdField_a_of_type_ComTencentMobileqqServiceMobileQQService).cancel(122);
      }
    ...
    for (;;)
    {
      ...
      {
        MobileQQService.a(this.jdField_a_of_type_ComTencentMobileqqServiceMobileQQService).cancel(2130838143);
        MobileQQService.a(this.jdField_a_of_type_ComTencentMobileqqServiceMobileQQService).cancel(2130838142);
      }
      this.jdField_a_of_type_ComTencentMobileqqServiceMobileQQService.a(2130838143, paramToServiceMsg);
    }
  }
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg != null)
    {
      ...
      {
        MobileQQService.a(this.jdField_a_of_type_ComTencentMobileqqServiceMobileQQService).E();
        this.jdField_a_of_type_ComTencentMobileqqServiceMobileQQService.a(2130838142);
        return;
      }
      if ("CMD_CANCLE_NOTIFIYCATION".equals(this.jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg.getServiceCmd()))
      {
        this.jdField_a_of_type_ComTencentMobileqqServiceMobileQQService.b(2130838142);
        return;
      }
