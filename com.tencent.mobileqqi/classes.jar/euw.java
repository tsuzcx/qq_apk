...
{
  public euw(RecentMemberInnerFrame paramRecentMemberInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = (eux)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramView = new eux(this.a, null);
      paramViewGroup = this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getLayoutInflater().inflate(2130903962, paramViewGroup, false);
