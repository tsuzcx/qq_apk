...
public class dpn
  extends Thread
{
  public dpn(TroopInfoActivity paramTroopInfoActivity) {}
  
  public void run()
  {
    Object localObject1 = ((FriendManager)this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(8)).c(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.p);
    ...
    for (;;)
    {
      ...
      label305:
      if ((!this.a.jdField_b_of_type_Boolean) && (this.a.jdField_a_of_type_ComTencentMobileqqAppFriendListHandler != null))
      {
