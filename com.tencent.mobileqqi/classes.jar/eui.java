...
public class eui
  extends BaseAdapter
{
  private eui(DiscussionListInnerFrame paramDiscussionListInnerFrame) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = (euj)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramViewGroup = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903957, paramViewGroup, false);
      paramView = new euj(this.a, null);
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131230985));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131234454));
      paramView.b = ((TextView)paramViewGroup.findViewById(2131234455));
      paramViewGroup.setTag(paramView);
      if (paramInt == 0) {
        paramViewGroup.setBackgroundResource(2130837875);
      }
    }
  }
}
