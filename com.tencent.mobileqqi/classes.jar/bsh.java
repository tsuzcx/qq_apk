...
public class bsh
  implements Runnable
{
  public bsh(QRDisplayActivity paramQRDisplayActivity) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      QRUtils.a(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.a, str, i, (String)localObject1, (String)localObject2, new bsi(this, str, i));
    }
    label739:
    ...
    for (i = 1;; i = 0)
    {
      this.a.findViewById(2131232581).setOnClickListener(this.a);
      if ((this.a.i == null) || (this.a.j == null) || (i == 0)) {
        break label1059;
      }
      ((TextView)this.a.findViewById(2131232580)).setText(this.a.i);
