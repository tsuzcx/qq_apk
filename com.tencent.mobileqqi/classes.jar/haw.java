...
public final class haw
  implements Runnable
{
  public haw(BaseActivity paramBaseActivity, String paramString1, boolean paramBoolean, String paramString2, String paramString3, QQProgressDialog paramQQProgressDialog) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new hay(this, localException));
        return;
      }
    }
    ...
    for (Object localObject1 = "subapp=tips&";; localObject1 = "subapp=BusinessCard&")
    {
      ...
      for (str = "&uin_source=friend";; str = "&uin_source=0")
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new hax(this, str));
        return;
      }
      str = "0";
      break label428;
