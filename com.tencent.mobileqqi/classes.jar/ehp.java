  ...
  extends BaseAdapter
{
  ...
  public ehp(SelectTransLangActivity paramSelectTransLangActivity, Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup = new ehq(this);
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231859));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131231860));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (ehq)paramView.getTag();
      break;
      label172:
