  ...
  implements EmoticonLinearLayout.DataObserver
{
  ...
  public fsr(EmoticonLinearLayout paramEmoticonLinearLayout) {}
      ...
      while (paramInt2 < this.jdField_a_of_type_Int)
      {
        ...
        if (i < this.b)
        {
          ...
          for (;;)
          {
            ...
            ((ProgressBar)localObject3).setIndeterminateDrawable(EmoticonLinearLayout.a(this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonLinearLayout).getResources().getDrawable(2130837854));
