...
{
  public bmo(QRJumpActivity paramQRJumpActivity, Activity paramActivity, String paramString) {}
      ...
      catch (Exception paramBundle)
      {
        try
        {
          if (((JSONObject)localObject3).has("wpa"))
          {
            ...
            QRResultHandler.a(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRJumpActivity.b, this.jdField_a_of_type_AndroidAppActivity, localBundle1, this.jdField_a_of_type_JavaLangString, paramBundle);
