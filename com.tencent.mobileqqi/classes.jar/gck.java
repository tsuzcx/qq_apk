  ...
  extends BaseAdapter
{
  ...
  public gck(RoamSearchDialog paramRoamSearchDialog) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    case 0: 
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (gcj)paramView.getTag();
      }
    }
    if (paramView == null)
    {
      ...
      paramViewGroup = new gcj(null);
      paramView.setTag(paramViewGroup);
      paramViewGroup.c = ((TextView)paramView.findViewById(2131231868));
      paramViewGroup.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131231066));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131231867));
