...
public class QlinkReport
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, QLAndQQStructDef.ReportNbFileChannelDetect paramReportNbFileChannelDetect)
  {
    long l2 = 0L;
    if ((paramQQAppInterface == null) || (paramReportNbFileChannelDetect == null))
    {
      QLog.e("QlinkReport", 1, "[QLINK]-QQ reportNbFileFileRecv -> param=null");
      return;
    }
    if (0L == paramReportNbFileChannelDetect.startTime) {
      paramReportNbFileChannelDetect.startTime = System.currentTimeMillis();
    }
    long l1;
    if (paramReportNbFileChannelDetect.startTime < 1L)
    {
      l1 = 0L;
      if (l1 >= 0L) {
        break label178;
    ...
    for (;;)
    {
      ...
      localHashMap.put("param_source", String.valueOf(paramReportNbFileChannelDetect.param_source));
      localHashMap.put("param_peer", String.valueOf(paramReportNbFileChannelDetect.param_peer));
      StatisticCollector.a(BaseApplication.getContext()).a(paramQQAppInterface.a(), "actNbFileChannelDetect", paramReportNbFileChannelDetect.eResult, l1, paramReportNbFileChannelDetect.rpSize, localHashMap, paramReportNbFileChannelDetect.reserved);
      QLog.i("QlinkReport", 1, "[QLINK]-QQ [QL_REPORT][" + paramReportNbFileChannelDetect._id + "] reportNbFileChannelDetect -> " + paramReportNbFileChannelDetect.toString());
      return;
      l1 = System.currentTimeMillis() - paramReportNbFileChannelDetect.startTime;
      break;
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, QLAndQQStructDef.ReportNbFileContactArbitrateInfo paramReportNbFileContactArbitrateInfo)
  {
    long l2 = 0L;
  ...
  public static void a(QQAppInterface paramQQAppInterface, QLAndQQStructDef.ReportNbFileContactScanInfo paramReportNbFileContactScanInfo)
  {
    long l2 = 0L;
  ...
  public static void a(QQAppInterface paramQQAppInterface, QLAndQQStructDef.ReportNbFileFileRecvInfo paramReportNbFileFileRecvInfo)
  {
    long l2 = 0L;
  ...
  public static void a(QQAppInterface paramQQAppInterface, QLAndQQStructDef.ReportNbFileFileSendInfo paramReportNbFileFileSendInfo)
  {
    long l2 = 0L;
