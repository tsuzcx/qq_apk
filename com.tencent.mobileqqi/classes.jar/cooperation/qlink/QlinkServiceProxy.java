...
public class QlinkServiceProxy
{
  ...
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new iat(this);
  ...
  private void b()
  {
    iau localiau = new iau(this);
    localiau.setName("handleWaitSendProxyMsgThread");
    localiau.start();
  }
