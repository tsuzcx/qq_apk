  ...
  extends BaseActivity
{
  ...
  final DialogInterface.OnDismissListener jdField_a_of_type_AndroidContentDialogInterface$OnDismissListener = new iav(this);
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      paramString = DialogUtil.a(this, 230, getString(2131560867), paramString, 2131560874, i, (DialogInterface.OnClickListener)localObject, localibd);
      paramString.setOnDismissListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnDismissListener);
      paramString.show();
      return;
      localObject = localibd;
      localibd = null;
    }
  }
  ...
  private void d()
  {
    Object localObject = new iaw(this);
  ...
  private void f()
  {
    ...
    iaz localiaz = new iaz(this);
    localObject = DialogUtil.a(this, 230, getString(2131560867), getString(2131560859), 2131560860, 2131560861, (DialogInterface.OnClickListener)localObject, localiaz);
    ((QQCustomDialog)localObject).setOnDismissListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnDismissListener);
    ((QQCustomDialog)localObject).show();
  }
  ...
  private void g()
  {
    Object localObject = new iba(this);
