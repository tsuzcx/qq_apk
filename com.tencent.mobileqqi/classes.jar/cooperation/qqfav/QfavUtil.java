...
public final class QfavUtil
{
  ...
  {
    QQToast.a(paramContext, paramInt2, paramInt1, 2000).b(paramContext.getResources().getDimensionPixelSize(2131427376) - (int)DisplayUtils.a(paramContext, 5.0F));
  }
  
  public static void a(Context paramContext1, boolean paramBoolean, Context paramContext2)
  {
    if (paramContext1 == null) {
      paramContext1 = BaseActivity.a;
    }
    ...
    for (;;)
    {
      try
      {
        String str = paramContext1.getString(2131560793);
        if (paramBoolean)
        {
          paramContext2 = paramContext1.getString(2131560795);
          paramContext1 = DialogUtil.a(paramContext1, 230, str, paramContext2, 2131561746, 2131560796, new igc(), null);
      ...
      paramContext2 = paramContext1.getString(2131560794);
    }
  }
  ...
  {
    paramContext1 = paramContext1.getSharedPreferences("mobileQQi", 0);
    paramString = "favorites_new_flag_" + paramString;
    paramBoolean2 = paramContext1.getBoolean(paramString, false);
    if (!paramBoolean2)
    {
      paramContext1.edit().putBoolean(paramString, true).commit();
      if (!paramBoolean1) {}
    }
  ...
  public static String[] a(byte[] paramArrayOfByte)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: invokestatic 470	javax/xml/parsers/DocumentBuilderFactory:newInstance	()Ljavax/xml/parsers/DocumentBuilderFactory;
    //   6: astore 5
    //   8: aload 5
    //   10: invokevirtual 474	javax/xml/parsers/DocumentBuilderFactory:newDocumentBuilder	()Ljavax/xml/parsers/DocumentBuilder;
    //   13: new 476	java/io/ByteArrayInputStream
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 479	java/io/ByteArrayInputStream:<init>	([B)V
    //   21: invokevirtual 485	javax/xml/parsers/DocumentBuilder:parse	(Ljava/io/InputStream;)Lorg/w3c/dom/Document;
    //   24: invokeinterface 491 1 0
    //   29: astore 5
    //   31: aload 4
    //   33: astore_0
    //   34: aconst_null
    ...
    //   254: aload 28
    //   256: ldc_w 503
    //   259: invokevirtual 506	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   262: ifeq +1246 -> 1508
    //   265: aload 4
    //   267: astore 16
    //   269: aload 5
    ...
    //   507: astore 21
    //   509: aload 9
    //   511: invokeinterface 502 1 0
    //   516: ldc_w 508
    //   519: invokevirtual 506	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   522: ifeq +160 -> 682
    //   525: aload 4
    //   527: astore 16
    //   529: aload 5
    ...
    //   728: astore 21
    //   730: aload 9
    //   732: invokeinterface 502 1 0
    //   737: ldc_w 522
    //   740: invokevirtual 506	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   743: ifeq +145 -> 888
    //   746: aload 4
    //   748: astore 16
    //   750: aload 5
    ...
    //   864: astore 21
    //   866: aload 9
    //   868: invokestatic 524	cooperation/qqfav/QfavUtil:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   871: astore 25
    //   873: aload 4
    //   875: astore 23
    //   877: aload 5
    ...
    //   934: astore 21
    //   936: aload 9
    //   938: invokeinterface 502 1 0
    //   943: ldc_w 526
    //   946: invokevirtual 506	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   949: ifeq +145 -> 1094
    //   952: aload 4
    //   954: astore 16
    //   956: aload 5
    ...
    //   1070: astore 21
    //   1072: aload 9
    //   1074: invokestatic 524	cooperation/qqfav/QfavUtil:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   1077: astore 24
    //   1079: aload 4
    //   1081: astore 23
    //   1083: aload 5
    ...
    //   1156: astore 25
    //   1158: aload 9
    //   1160: invokeinterface 502 1 0
    //   1165: ldc_w 528
    //   1168: invokevirtual 506	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1171: ifeq +886 -> 2057
    //   1174: aload 4
    //   1176: astore 16
    //   1178: aload 5
    ...
    //   1576: aload 28
    //   1578: ldc_w 532
    //   1581: invokevirtual 506	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1584: ifeq +165 -> 1749
    //   1587: aload 4
    //   1589: astore 22
    //   1591: aload 5
    ...
    //   1709: astore 21
    //   1711: aload 27
    //   1713: invokeinterface 512 1 0
    //   1718: ldc_w 534
    //   1721: invokeinterface 520 2 0
    ...
    //   1834: astore 7
    //   1836: aload 9
    //   1838: invokevirtual 535	javax/xml/parsers/ParserConfigurationException:printStackTrace	()V
    //   1841: aload 6
    //   1843: astore 9
    //   1845: goto -63 -> 1782
    //   1848: astore 9
    ...
    //   1865: astore 7
    //   1867: aload 9
    //   1869: invokevirtual 536	org/xml/sax/SAXException:printStackTrace	()V
    //   1872: aload 6
    //   1874: astore 9
    //   1876: goto -94 -> 1782
    //   1879: astore 9
    ...
    //   1896: astore 7
    //   1898: aload 9
    //   1900: invokevirtual 537	java/io/IOException:printStackTrace	()V
    //   1903: aload 6
    //   1905: astore 9
    //   1907: goto -125 -> 1782
    //   1910: astore 9
