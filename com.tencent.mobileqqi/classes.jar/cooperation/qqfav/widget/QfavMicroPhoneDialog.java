  ...
  implements View.OnClickListener, VoicePlayer.VoicePlayerListener
{
  ...
  public QfavMicroPhoneDialog(Context paramContext, AppRuntime paramAppRuntime, QfavMicroPhoneDialog.Listener paramListener)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new igj(this);
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131232669).setOnClickListener(this);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131232664));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131232668));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131232666));
