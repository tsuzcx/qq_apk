...
public class BuiltinPluginManager
{
  ...
  private static String[] jdField_a_of_type_ArrayOfJavaLangString = { "qzone_plugin.apk" };
  ...
  private void d()
  {
    ...
    localPluginInfo.mMD5 = "B6004AD4B164B2C12DF5F76B6690206C";
    ...
    localPluginInfo.mInstallType = 1;
  ...
  void c()
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: new 131	java/io/BufferedReader
    //   5: dup
    //   6: new 133	java/io/InputStreamReader
    //   9: dup
    //   10: aload_0
    //   11: getfield 32	cooperation/plugin/BuiltinPluginManager:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   14: invokevirtual 139	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   17: ldc 141
    //   19: invokevirtual 147	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   22: invokespecial 150	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   25: invokespecial 153	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   28: astore_1
    //   29: aload_1
    //   30: invokevirtual 156	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   33: astore_2
    //   34: aload_2
    //   35: ifnull +91 -> 126
    //   38: aload_2
    //   39: invokevirtual 159	java/lang/String:trim	()Ljava/lang/String;
    //   42: ldc 161
    //   44: invokevirtual 165	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   47: astore 4
    //   49: aload 4
    //   51: iconst_0
    //   52: aaload
    ...
    //   67: aaload
    //   68: astore_2
    //   69: new 54	cooperation/plugin/PluginInfo
    //   72: dup
    //   73: invokespecial 55	cooperation/plugin/PluginInfo:<init>	()V
    //   76: astore 4
    //   78: aload 4
    //   80: aload_3
    //   81: putfield 60	cooperation/plugin/PluginInfo:mID	Ljava/lang/String;
    //   84: aload 4
    //   86: aload_2
    //   87: putfield 65	cooperation/plugin/PluginInfo:mMD5	Ljava/lang/String;
    //   90: aload 4
    //   92: iconst_1
    //   93: putfield 74	cooperation/plugin/PluginInfo:mUpdateType	I
    //   96: aload 4
    //   98: iconst_0
    //   99: putfield 77	cooperation/plugin/PluginInfo:mInstallType	I
    //   102: aload_0
    //   103: getfield 30	cooperation/plugin/BuiltinPluginManager:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   106: aload_3
    //   107: aload 4
    //   109: invokevirtual 81	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   112: pop
    //   113: goto -84 -> 29
    //   116: astore_2
    //   117: aload_1
    //   118: ifnull +7 -> 125
    //   121: aload_1
    //   122: invokevirtual 170	java/io/BufferedReader:close	()V
    //   125: return
    //   126: aload_1
    //   127: ifnull -2 -> 125
    //   130: aload_1
    //   131: invokevirtual 170	java/io/BufferedReader:close	()V
    //   134: return
    //   135: astore_1
    //   136: return
    //   137: astore_1
