...
public class ImageFilePathUtil
{
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      paramString = SecurityUtil.a(paramString);
      if (a())
      {
      ...
      label64:
      for (paramContext = null;; paramContext = paramContext + File.separator + paramString)
      {
        return paramContext;
  ...
  {
    if (!paramBoolean) {}
    for (paramContext = idf.a(paramContext); paramContext == null; paramContext = idf.a(paramContext, "cache")) {
      return null;
    }
    return paramContext.getAbsolutePath();
  }
