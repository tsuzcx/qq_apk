...
public class ServerListProvider
{
  ...
  private static final String a = ServerListProvider.class.getSimpleName();
  ...
  public static int a()
  {
    return QZoneHelper.LocalConfig.a("ServerEnvironment", 0);
  }
  ...
  private static void a()
  {
    ...
    for (;;)
    {
      ...
      localObject = new File(b + "/testserver");
      if (!((File)localObject).exists()) {
        try
        {
  ...
  {
    c();
    int i1 = QZoneHelper.LocalConfig.a("ServerUploadEnvironment", 0);
  ...
  {
    Utility.CUSTOM_IP = QZoneHelper.LocalConfig.a("ServerUploadCustomIp", "113.108.67.16");
    Utility.CUSTOM_PORT = QZoneHelper.LocalConfig.a("ServerUploadCustomPort", 19994);
    if (QLog.isColorLevel()) {
