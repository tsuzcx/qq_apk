...
public final class hfe
  implements Runnable
{
  public hfe(BaseActivity paramBaseActivity, String paramString1, boolean paramBoolean, String paramString2, String paramString3, QQProgressDialog paramQQProgressDialog) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        List localList = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.b.a().a(this.jdField_a_of_type_JavaLangString, 0, 10);
        localObject1 = (FriendManager)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.b.getManager(8);
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new hfg(this, localException));
        return;
      }
    }
    ...
    for (Object localObject1 = "subapp=tips&";; localObject1 = "subapp=BusinessCard&")
    {
      ...
      for (str = "&uin_source=friend";; str = "&uin_source=0")
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new hff(this, str));
        return;
      }
      str = "0";
      break label428;
