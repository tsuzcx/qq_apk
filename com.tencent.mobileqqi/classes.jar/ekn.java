...
{
  public ekn(SystemMsgListView paramSystemMsgListView) {}
  ...
  protected void a(String paramString)
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog != null) && (this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.isShowing()))
    {
      ...
      paramString = SystemMsgListView.a(this.a).getResources().getString(2131562784);
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = SystemMsgListView.a(this.a).getResources().getString(2131561435);
      ...
      paramString1 = SystemMsgListView.a(this.a).getResources().getString(2131561910);
      if (paramInt1 == 0) {
        paramString1 = SystemMsgListView.a(this.a).getResources().getString(2131561580);
      }
      ...
      try
      {
        if (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
          this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(AppConstants.Z, 0, l2, paramString1.toByteArray());
        }
        this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1012);
        return;
      }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        SystemMsgListView.a(this.a, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(AppConstants.Z, 0));
        ...
        {
          ((NewFriendManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(32)).a(new NewFriendMessage(1, 0, false));
      ...
      {
        String str = SystemMsgListView.a(this.a).getResources().getString(2131561766);
