  ...
  extends BaseHornListActivity.BaseHornAdapter
{
  ...
  private dci(MyPublishedHornActivity paramMyPublishedHornActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    case 0: 
      if (paramView == null)
      {
        paramView = this.jdField_a_of_type_ComTencentMobileqqActivityMyPublishedHornActivity.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903677, paramViewGroup, false);
        paramViewGroup = new cck();
        paramView.setTag(paramViewGroup);
        paramViewGroup.b = ((ImageView)paramView.findViewById(2131233376));
      ...
      for (;;)
      {
        ...
        if (a(paramInt)) {
          paramViewGroup.b.setImageResource(2130839123);
        } else {
          paramViewGroup.b.setImageResource(2130839122);
        }
      }
    }
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityMyPublishedHornActivity.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903281, null);
      paramViewGroup = new cck();
      paramView.setTag(paramViewGroup);
