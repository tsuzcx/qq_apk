...
{
  private cyo jdField_a_of_type_Cyo = null;
  ...
  protected void a(String paramString1, int paramInt1, int paramInt2, SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    if (paramInt1 == 1) {
      if (((FriendManager)this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.b.getManager(8)).f(paramString1)) {
        if (paramInt2 == 108)
        {
          if (this.jdField_a_of_type_Cyo == null) {
            this.jdField_a_of_type_Cyo = new cyo(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.a, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity);
          }
          ...
          this.jdField_a_of_type_Cyo.a(paramString1);
          if (this.jdField_a_of_type_Cyo.a()) {
            this.jdField_a_of_type_Cyo.a();
          }
        }
      }
    }
        ...
        case 103: 
          ...
          if (paramInt1 == 3000) {
            ...
            case 102: 
              ...
              break;
            case 103: 
              DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity, 230, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131559040), this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131561440), new byk(this, paramString1), null).show();
              break;
            case 104: 
              DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity, 230, this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131559040), this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity.getString(2131562512), new byl(this, paramString1), null).show();
              break;
            }
