...
public class gfe
  implements Runnable
{
  public gfe(ProfileSocialView paramProfileSocialView, int paramInt, ProfileActivity.AllInOne paramAllInOne, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject3 != null) {
          this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileSocialView.a.runOnUiThread(new gff(this, (Bitmap)localObject3));
        }
        return;
      }
