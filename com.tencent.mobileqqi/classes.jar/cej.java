...
{
  public cej(ChatActivity paramChatActivity) {}
  ...
  protected void a(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    this.a.runOnUiThread(new cek(this, l));
  }
  ...
  protected void a(boolean paramBoolean, Map paramMap)
  {
    if ((!paramBoolean) && (this.a.isResume())) {
      QQToast.a(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(), 2130837947, this.a.getString(2131562192), 0).b(this.a.d());
    }
  }
