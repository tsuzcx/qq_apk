  ...
  implements INetInfoHandler, DownloaderInterface
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = heu.class.getSimpleName();
  }
  
  public heu(AppInterface paramAppInterface, DownloaderFactory.DownloadConfig paramDownloadConfig)
  {
  ...
  {
    ThreadManager.a(new hev(this, paramString));
  }
