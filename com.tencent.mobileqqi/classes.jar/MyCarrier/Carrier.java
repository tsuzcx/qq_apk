  ...
  extends JceStruct
{
  ...
  {
    return "Carrier [carrierName=" + this.carrierName + ", carrierId=" + this.carrierId + ", carrierProvince=" + this.carrierProvince + ", carrierCity=" + this.carrierCity + ", carrierLogo=" + this.carrierLogo + ", carrierURL=" + this.carrierURL + ", carrierExtraInfo=" + this.carrierExtraInfo + ", redhotfilter=" + this.redhotfilter + "]";
  }
