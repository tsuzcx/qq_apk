  ...
  implements Runnable
{
  ...
  public dxr(Resources paramResources)
  {
    this.c = false;
    this.d = false;
  ...
  private void b()
  {
    ...
    long l2 = this.i;
    this.jdField_a_of_type_Dxs = new dxs(this, this.jdField_a_of_type_JavaLangObject);
    this.jdField_a_of_type_Dxs.execute(new Long[] { Long.valueOf(l1 + l2), Long.valueOf(this.g), Long.valueOf(this.f) });
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Dxs != null)
    {
      this.jdField_a_of_type_Dxs.cancel(false);
      this.jdField_a_of_type_Dxs = null;
    }
    this.f = -1;
  ...
  {
    if ((this.f == 1) && (((dxt)this.jdField_a_of_type_JavaLangObject).jdField_a_of_type_JavaLangString.equals(paramString))) {
      return;
    }
    a();
    this.f = 1;
    this.jdField_a_of_type_JavaLangObject = new dxt(this, paramString, paramInt1, paramInt2);
    BitmapFactory.Options localOptions = new BitmapFactory.Options();
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (this.g != -1)
    {
      ...
      localObject = (dxt)this.jdField_a_of_type_JavaLangObject;
      int i3 = this.g;
      int i4 = ((dxt)localObject).jdField_a_of_type_Int;
      int i2 = this.g / ((dxt)localObject).jdField_a_of_type_Int;
      int n = this.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() / ((dxt)localObject).jdField_a_of_type_Int;
      int i1 = this.jdField_a_of_type_AndroidGraphicsBitmap.getHeight() / ((dxt)localObject).b;
      i3 = i3 % i4 * this.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() / ((dxt)localObject).jdField_a_of_type_Int;
      i2 = i2 * this.jdField_a_of_type_AndroidGraphicsBitmap.getHeight() / ((dxt)localObject).b;
