...
{
  public bte(ScannerActivity paramScannerActivity, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if ((paramBoolean) && (paramBundle != null))
    {
      ...
      for (;;)
      {
        ...
        localObject2 = new btf(this);
        ((QQCustomDialog)localObject1).setPositiveButton(2131562539, new btg(this, paramBundle));
