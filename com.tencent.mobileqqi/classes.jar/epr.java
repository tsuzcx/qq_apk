  ...
  extends BaseAdapter
{
  ...
  eps jdField_a_of_type_Eps;
  
  public epr(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      this.jdField_a_of_type_Eps = new eps(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberCreateFaceToFaceDiscussionActivity);
      this.jdField_a_of_type_Eps.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131230940));
      this.jdField_a_of_type_Eps.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231000));
      paramView.setTag(this.jdField_a_of_type_Eps);
    ...
    for (;;)
    {
      ...
      return paramView;
      this.jdField_a_of_type_Eps = ((eps)paramView.getTag());
      if (!this.jdField_a_of_type_Eps.jdField_a_of_type_Boolean) {
        break;
      }
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903578, null);
      this.jdField_a_of_type_Eps = new eps(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberCreateFaceToFaceDiscussionActivity);
      ...
      this.jdField_a_of_type_Eps.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231000));
      paramView.setTag(this.jdField_a_of_type_Eps);
      this.jdField_a_of_type_Eps.jdField_a_of_type_Boolean = false;
      break;
      label237:
