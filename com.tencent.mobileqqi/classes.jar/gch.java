...
public class gch
  implements Runnable
{
  public gch(RoamSearchDialog paramRoamSearchDialog, List paramList, int paramInt) {}
  ...
  public void run()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.jdField_a_of_type_Gck.b = true;
      ...
      this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.jdField_a_of_type_Gck.a = false;
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.jdField_a_of_type_Gck.b = false;
      break;
      label239:
