...
{
  public dux(TroopGagActivity paramTroopGagActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramInt > 0)
    {
      ...
      {
        paramView = ((LayoutInflater)this.a.getSystemService("layout_inflater")).inflate(2130903380, paramViewGroup, false);
        paramViewGroup = new duy(this, null);
        paramViewGroup.c = ((ImageView)paramView.findViewById(2131231771));
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131231090));
        paramViewGroup.b = ((TextView)paramView.findViewById(2131232383));
        paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131232384));
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (duy)paramView.getTag();
      }
