...
public class ceu
  implements Runnable
{
  public ceu(ChatActivity paramChatActivity, Activity paramActivity) {}
  ...
  public void run()
  {
    ...
    ChatActivity.c(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity).setOnTouchListener(new cev(this));
    this.jdField_a_of_type_AndroidAppActivity.addContentView(ChatActivity.c(this.jdField_a_of_type_ComTencentMobileqqActivityChatActivity), new ViewGroup.LayoutParams(-1, -1));
    ...
    localAnimationSet.setAnimationListener(new cew(this));
