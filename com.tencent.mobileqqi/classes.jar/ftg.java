  ...
  extends EmoticonLinearLayout.EmoticonAdapter
{
  ...
  public ftg(EmoticonPanelViewBinder paramEmoticonPanelViewBinder, int paramInt)
  {
  ...
  public void a(int paramInt, RelativeLayout paramRelativeLayout, ViewGroup paramViewGroup)
  {
    ...
    if (paramViewGroup != null) {
      if ((paramViewGroup.b == 1) || (paramViewGroup.b == 2) || (paramViewGroup.b == 7))
      {
        ...
        if ((this.k == 2006) || (this.k == 2009))
        {
          ...
          ((ImageView)localObject1).setVisibility(0);
          ((ImageView)localObject1).setImageResource(2130840217);
        }
        label361:
        if ((this.k == 2008) && (paramViewGroup != null) && ((paramViewGroup instanceof PicEmoticonInfo)))
        {
          ...
          if (paramViewGroup.b == 9)
          {
            ...
            paramViewGroup.setBackgroundResource(2130839127);
    ...
    for (;;)
    {
      ...
      {
        ((ImageView)localObject1).setImageResource(2130837939);
        break label138;
      }
      if ("setting".equals(paramViewGroup.a))
      {
        ((ImageView)localObject1).setImageDrawable(this.a.a.getResources().getDrawable(2130839129));
        break label138;
      }
      if ("add".equals(paramViewGroup.a))
      {
        ((ImageView)localObject1).setImageDrawable(this.a.a.getResources().getDrawable(2130839128));
        break label138;
      }
