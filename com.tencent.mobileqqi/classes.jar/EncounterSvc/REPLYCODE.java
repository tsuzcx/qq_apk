  ...
  implements Serializable
{
  ...
  static
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      REPLYCODE_ERR_Session_TimeOut = new REPLYCODE(6, 7, "REPLYCODE_ERR_Session_TimeOut");
      REPLYCODE_ERR_LBS_EXCEPTION = new REPLYCODE(7, 101, "REPLYCODE_ERR_LBS_EXCEPTION");
      REPLYCODE_ERR_LBS_POSITION_FAIL = new REPLYCODE(8, 102, "REPLYCODE_ERR_LBS_POSITION_FAIL");
      REPLYCODE_ERR_LBS_AUTH_FAIL = new REPLYCODE(9, 201, "REPLYCODE_ERR_LBS_AUTH_FAIL");
      REPLYCODE_ERR_LBS_INPUT_ERROR = new REPLYCODE(10, 202, "REPLYCODE_ERR_LBS_INPUT_ERROR");
      REPLYCODE_SUCC_NOPENGYOU_INFO = new REPLYCODE(11, 300, "REPLYCODE_SUCC_NOPENGYOU_INFO");
      return;
    }
  }
 ...
 * Qualified Name:     EncounterSvc.REPLYCODE
