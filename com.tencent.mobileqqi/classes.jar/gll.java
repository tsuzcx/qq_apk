...
public class gll
  extends Thread
{
  public gll(SubAccountProtocManager paramSubAccountProtocManager, String paramString)
  {
    super(paramString);
  }
  ...
  public void run()
  {
    int i = 1;
    super.run();
    SharedPreferences localSharedPreferences = SubAccountProtocManager.a(this.a).a().getSharedPreferences("mobileQQi", 0);
    ...
    if ((l3 > 0L) && (((Calendar)localObject).after(localCalendar1)) && (SubAccountAssistantImpl.a().a(SubAccountProtocManager.a(this.a))))
    {
      boolean bool = SubAccountAssistantImpl.a().b(SubAccountProtocManager.a(this.a));
    ...
    for (;;)
    {
      ...
      localSharedPreferences.edit().putLong("LastTimeLogin_" + SubAccountProtocManager.a(this.a).a(), l4).commit();
      if (l3 == 0L) {
