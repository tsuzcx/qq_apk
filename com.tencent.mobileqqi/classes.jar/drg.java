  ...
  implements PinnedDividerListView.OnLayoutListener
{
  ...
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (this.a.a.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.q() <= 0)
    {
      ...
      if (this.a.a.jdField_a_of_type_Drw != null) {
        break label110;
      }
    }
    label110:
    for (paramInt1 = 0; paramInt2 < paramInt1 + this.a.a.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.k(); paramInt1 = this.a.a.jdField_a_of_type_Drw.getCount())
    {
