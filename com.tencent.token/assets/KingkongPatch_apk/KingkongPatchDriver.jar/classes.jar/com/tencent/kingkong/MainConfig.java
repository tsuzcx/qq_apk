...
public class MainConfig
{
  ...
  private void updatePatchFlagList()
  {
    String str = "";
  ...
  public PatchInfo findPatch(String paramString)
  {
    ...
    } while (!localPatchInfo.mFlag.equals(paramString));
  ...
  public void removePatch(String paramString)
  {
    ...
    for (;;)
    {
      ...
      return;
      PatchInfo localPatchInfo = (PatchInfo)localIterator.next();
      if (!localPatchInfo.mFlag.equals(paramString)) {
        break;
      }
  ...
  public void updatePatch(PatchInfo paramPatchInfo)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (((PatchInfo)this.mPatches.get(i)).mFlag.equals(paramPatchInfo.mFlag)) {
        break label17;
      }
      i += 1;
      break;
