...
public class ca
{
  ...
  {
    paramContext = n.a(paramContext).a(10001);
    if ((paramContext != null) && (paramContext.soluInfo != null))
    {
      paramContext = (AuthSolutionConfig)ch.a(paramContext.soluInfo, new AuthSolutionConfig(), false);
  ...
  {
    paramContext = n.a(paramContext).a(20002);
    if ((paramContext != null) && (paramContext.soluInfo != null))
    {
      paramContext = (AuthSolutionConfig)ch.a(paramContext.soluInfo, new AuthSolutionConfig(), false);
      if ((paramContext != null) && (paramContext.authSolutionConfigList != null) && (!paramContext.authSolutionConfigList.isEmpty()))
  ...
  {
    paramContext = n.a(paramContext).a(30201);
    if ((paramContext != null) && (paramContext.soluInfo != null))
    {
      paramContext = (AuthSolutionConfig)ch.a(paramContext.soluInfo, new AuthSolutionConfig(), false);
