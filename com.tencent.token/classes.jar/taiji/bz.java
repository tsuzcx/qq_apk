  ...
  extends bu
{
  ...
  private int a()
  {
    ...
    //   3: aload_0
    //   4: iconst_5
    //   5: invokespecial 128	taiji/bu:checkPermission	(I)I
    //   8: istore_1
    //   9: iload_1
    //   10: ifne +217 -> 227
    //   13: iconst_2
    ...
    //   46: aload_0
    //   47: getfield 30	taiji/bz:f	Landroid/content/Context;
    ...
    //   65: iconst_0
    //   66: aload_0
    //   67: getfield 30	taiji/bz:f	Landroid/content/Context;
    ...
    //   204: istore_3
    //   205: goto -166 -> 39
    //   208: getstatic 179	taiji/bt:a	Ltmsdk/common/module/pgsdk/IPermissionChecker;
    //   211: astore 4
    //   213: aload 4
    //   215: ifnull +12 -> 227
    //   218: aload 4
  ...
  private int a(int paramInt, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 30	taiji/bz:f	Landroid/content/Context;
    //   4: ifnull +31 -> 35
    //   7: aload_0
    //   8: getfield 74	taiji/bz:g	Ljava/lang/reflect/Method;
    //   11: ifnull +24 -> 35
    //   14: aload_0
    //   15: getfield 78	taiji/bz:h	Ljava/lang/reflect/Method;
    //   18: ifnull +17 -> 35
    //   21: aload_0
    //   22: getfield 82	taiji/bz:i	Ljava/lang/reflect/Method;
    //   25: ifnull +10 -> 35
    //   28: aload_0
    //   29: getfield 92	taiji/bz:j	Ljava/lang/Object;
    //   32: ifnonnull +5 -> 37
    //   35: iconst_0
    //   36: ireturn
    //   37: aload_0
    //   38: getfield 74	taiji/bz:g	Ljava/lang/reflect/Method;
    //   41: aload_0
    //   42: getfield 92	taiji/bz:j	Ljava/lang/Object;
    //   45: iconst_1
    //   46: anewarray 84	java/lang/Object
    //   49: dup
    //   50: iconst_0
    //   51: aload_0
    //   52: getfield 30	taiji/bz:f	Landroid/content/Context;
    ...
    //   95: astore 5
    //   97: aload_0
    //   98: getfield 78	taiji/bz:h	Ljava/lang/reflect/Method;
    //   101: aconst_null
    //   102: iconst_1
    ...
    //   113: astore_2
    //   114: aload_0
    //   115: getfield 82	taiji/bz:i	Ljava/lang/reflect/Method;
    //   118: aload_2
    //   119: iconst_0
    ...
    //   174: iload_3
    //   175: aload_0
    //   176: getfield 98	taiji/bz:k	I
    //   179: if_icmpne +5 -> 184
    //   182: iconst_m1
    //   183: ireturn
    //   184: aload_0
    //   185: getfield 100	taiji/bz:l	I
    //   188: istore 4
    //   190: iload_3
    //   191: iload 4
    ...
    //   204: aload_0
    //   205: iload_1
    //   206: invokespecial 128	taiji/bu:checkPermission	(I)I
    //   209: istore_1
    //   210: iload_1
    //   211: iconst_m1
  ...
  private int b()
  {
    ...
    //   1: astore 6
    //   3: aload_0
    //   4: getfield 30	taiji/bz:f	Landroid/content/Context;
    ...
    //   24: iconst_0
    //   25: aload_0
    //   26: getfield 30	taiji/bz:f	Landroid/content/Context;
    ...
    //   224: athrow
    //   225: aload_0
    //   226: getfield 30	taiji/bz:f	Landroid/content/Context;
    ...
    //   240: astore 7
    //   242: aload_0
    //   243: getfield 30	taiji/bz:f	Landroid/content/Context;
  ...
  private int c()
  {
    ...
    //   11: aload_0
    //   12: aload_0
    //   13: getfield 30	taiji/bz:f	Landroid/content/Context;
    //   16: invokevirtual 148	android/content/Context:getPackageName	()Ljava/lang/String;
    //   19: invokespecial 314	taiji/bz:a	(Ljava/lang/String;)Ljava/lang/String;
    //   22: astore 6
    //   24: aload 5
    //   26: astore 4
    //   28: aload_0
    //   29: getfield 30	taiji/bz:f	Landroid/content/Context;
    ...
    //   176: aload_0
    //   177: aload_0
    //   178: getfield 30	taiji/bz:f	Landroid/content/Context;
    //   181: invokevirtual 148	android/content/Context:getPackageName	()Ljava/lang/String;
    //   184: invokespecial 322	taiji/bz:b	(Ljava/lang/String;)Ljava/lang/String;
    //   187: astore 7
    //   189: aload 6
    //   191: astore 4
    //   193: aload 6
    //   195: astore 5
    //   197: aload_0
    //   198: getfield 30	taiji/bz:f	Landroid/content/Context;
    ...
    //   345: astore 5
    //   347: aload_0
    //   348: getfield 30	taiji/bz:f	Landroid/content/Context;
    ...
    //   454: aload 5
    //   456: aload_0
    //   457: getfield 30	taiji/bz:f	Landroid/content/Context;
  ...
  private int e()
  {
    ...
    //   7: if_icmplt +163 -> 170
    //   10: aload_0
    //   11: getfield 30	taiji/bz:f	Landroid/content/Context;
    ...
    //   24: astore 4
    //   26: aload_0
    //   27: getfield 30	taiji/bz:f	Landroid/content/Context;
