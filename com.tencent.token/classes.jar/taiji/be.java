  ...
  extends bb
{
  ...
  private int a(int paramInt, String paramString)
  {
    ...
    //   4: ifnull +20 -> 24
    //   7: aload_0
    //   8: getfield 33	taiji/be:f	Ljava/util/ArrayList;
    //   11: ifnull +13 -> 24
    //   14: aload_0
    //   15: getfield 33	taiji/be:f	Ljava/util/ArrayList;
    //   18: invokevirtual 124	java/util/ArrayList:isEmpty	()Z
    //   21: ifeq +7 -> 28
    //   24: iconst_0
    //   25: istore_1
    //   26: iload_1
    //   27: ireturn
    //   28: aload_0
    //   29: getfield 120	taiji/be:a	Landroid/content/Context;
    //   32: invokevirtual 130	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   35: ldc 132
    //   37: invokestatic 138	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   40: ldc 140
    //   42: invokestatic 144	android/net/Uri:withAppendedPath	(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    //   45: aconst_null
    //   46: ldc 146
    //   48: iconst_1
    //   49: anewarray 91	java/lang/String
    //   52: dup
    //   53: iconst_0
    //   54: aload_0
    //   55: getfield 120	taiji/be:a	Landroid/content/Context;
    //   58: invokevirtual 150	android/content/Context:getPackageName	()Ljava/lang/String;
    //   61: aastore
    //   62: aconst_null
    //   63: invokevirtual 156	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   66: astore 7
    //   68: aload 7
    //   70: ifnull +371 -> 441
    //   73: iconst_0
    ...
    //   144: iconst_1
    //   145: aload_0
    //   146: getfield 33	taiji/be:f	Ljava/util/ArrayList;
    //   149: iload_1
    //   150: invokestatic 180	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   153: invokevirtual 184	java/util/ArrayList:indexOf	(Ljava/lang/Object;)I
    //   156: ishl
    //   157: istore 4
    //   159: aload 7
    //   161: astore 6
    ...
    //   196: aload 7
    //   198: ldc 188
    //   200: invokeinterface 167 2 0
    //   205: invokeinterface 171 2 0
    //   210: istore 5
    //   212: iload 4
    //   214: iload 5
    //   216: iand
    ...
    //   364: aload_0
    //   365: iload_1
    //   366: invokespecial 191	taiji/bb:checkPermission	(I)I
    //   369: istore_3
    //   370: goto -31 -> 339
    //   373: aload 7
    //   375: astore 6
    //   377: aload_0
    //   378: aload_2
    //   379: invokespecial 193	taiji/be:a	(Ljava/lang/String;)I
    //   382: istore_3
    //   383: iload_3
    //   384: istore_1
    //   385: aload 7
  ...
  private int a(final Parcel paramParcel1, final Parcel paramParcel2)
  {
    ...
    //   0: aload_0
    //   1: iconst_m1
    //   2: putfield 200	taiji/be:i	I
    //   5: aload_0
    //   6: getfield 114	taiji/be:h	Ljava/util/concurrent/locks/ReentrantLock;
    //   9: invokevirtual 203	java/util/concurrent/locks/ReentrantLock:tryLock	()Z
    //   12: ifne +5 -> 17
    //   15: iconst_m1
    //   16: ireturn
    //   17: new 6	taiji/be$1
    ...
    //   22: aload_1
    //   23: aload_2
    //   24: invokespecial 206	taiji/be$1:<init>	(Ltaiji/be;Landroid/os/Parcel;Landroid/os/Parcel;)V
    //   27: astore_1
    //   28: new 208	java/lang/Thread
    //   31: dup
    //   32: aload_1
    //   33: invokespecial 211	java/lang/Thread:<init>	(Ljava/lang/Runnable;)V
    //   36: invokevirtual 214	java/lang/Thread:start	()V
    //   39: aload_0
    //   40: getfield 114	taiji/be:h	Ljava/util/concurrent/locks/ReentrantLock;
    //   43: invokevirtual 217	java/util/concurrent/locks/ReentrantLock:unlock	()V
    //   46: aload_1
    //   47: monitorenter
    //   48: aload_1
    //   49: ldc2_w 218
    //   52: invokevirtual 223	java/lang/Object:wait	(J)V
    //   55: aload_1
    //   56: monitorexit
    //   57: aload_0
    //   58: getfield 200	taiji/be:i	I
    //   61: ireturn
    //   62: astore_2
    //   63: aload_1
    //   64: monitorexit
    ...
    //   start	length	slot	name	signature
    //   0	71	0	this	be
    //   0	71	1	paramParcel1	Parcel
    //   0	71	2	paramParcel2	Parcel
    // Exception table:
    //   from	to	target	type
    //   48	55	62	finally
    //   55	57	62	finally
  ...
  private int a(String paramString)
  {
    ...
    //   1: istore_2
    //   2: aload_0
    //   3: getfield 109	taiji/be:g	Landroid/os/IBinder;
    //   6: ifnonnull +5 -> 11
    //   9: iconst_0
    //   10: ireturn
    //   11: invokestatic 229	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   14: astore 4
    //   16: invokestatic 229	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   19: astore 5
    //   21: aload 4
    //   23: ldc 231
    //   25: invokevirtual 235	android/os/Parcel:writeInterfaceToken	(Ljava/lang/String;)V
    //   28: aload 4
    //   30: aload_1
    //   31: invokevirtual 238	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   34: aload 4
    //   36: invokestatic 244	android/os/Process:myPid	()I
    //   39: invokevirtual 248	android/os/Parcel:writeInt	(I)V
    //   42: aload 4
    //   44: invokestatic 251	android/os/Process:myUid	()I
    //   47: invokevirtual 248	android/os/Parcel:writeInt	(I)V
    //   50: aload_1
    //   51: ldc 253
    ...
    //   60: aload 4
    //   62: aload 5
    //   64: invokespecial 258	taiji/be:a	(Landroid/os/Parcel;Landroid/os/Parcel;)I
    //   67: istore_2
    //   68: aload 4
    //   70: invokevirtual 261	android/os/Parcel:recycle	()V
    //   73: aload 5
    //   75: invokevirtual 261	android/os/Parcel:recycle	()V
    //   78: iload_2
    //   79: ireturn
    //   80: aload_0
    //   81: getfield 109	taiji/be:g	Landroid/os/IBinder;
    //   84: iconst_1
    //   85: aload 4
    //   87: aload 5
    //   89: iconst_0
    //   90: invokeinterface 265 5 0
    //   95: pop
    //   96: aload 5
    //   98: invokevirtual 268	android/os/Parcel:readException	()V
    //   101: aload 5
    //   103: invokevirtual 271	android/os/Parcel:readInt	()I
    //   106: istore_3
    //   107: iload_3
    //   108: ifne -40 -> 68
    //   111: iconst_m1
    ...
    //   116: astore_1
    //   117: aload 4
    //   119: invokevirtual 261	android/os/Parcel:recycle	()V
    //   122: aload 5
    //   124: invokevirtual 261	android/os/Parcel:recycle	()V
    //   127: iconst_0
    //   128: ireturn
    //   129: astore_1
    //   130: aload 4
    //   132: invokevirtual 261	android/os/Parcel:recycle	()V
    //   135: aload 5
    //   137: invokevirtual 261	android/os/Parcel:recycle	()V
    //   140: aload_1
    //   141: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    //   1	112	2	j	int
    //   106	2	3	k	int
    //   14	117	4	localParcel1	Parcel
    //   19	117	5	localParcel2	Parcel
    // Exception table:
    //   from	to	target	type
