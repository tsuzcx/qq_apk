  ...
  implements Runnable
{
  ...
  public static void a()
  {
    ...
    {
      StringBuilder localStringBuilder = new StringBuilder("asyncGetPerformance error ");
  ...
  public static void a(byte[] paramArrayOfByte)
  {
    ...
    {
      StringBuilder localStringBuilder = new StringBuilder("aysncCalcPow error ");
  ...
  public static void b(byte[] paramArrayOfByte)
  {
    ...
    {
      StringBuilder localStringBuilder = new StringBuilder("syncCalcPow error ");
      localStringBuilder.append(Log.getStackTraceString(paramArrayOfByte));
      util.LOGI(localStringBuilder.toString(), "");
    }
  }
    ...
    if (i == 1) {
      try
      {
        ...
        if ((arrayOfByte != null) && (arrayOfByte.length != 0))
        {
          ...
          localStringBuilder2 = new StringBuilder("get performance");
      ...
      {
        StringBuilder localStringBuilder2 = new StringBuilder("getPerformance ");
        localStringBuilder2.append(Log.getStackTraceString(localThrowable));
        util.LOGI(localStringBuilder2.toString(), "");
        return;
      }
    }
    StringBuilder localStringBuilder1 = new StringBuilder("error type:");
