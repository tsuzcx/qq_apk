      ...
      if ((arrayOfByte2 != null) && (arrayOfByte2.length != 0))
      {
        ...
        if (d.t) {
          if ((arrayOfByte1 != null) && (paramArrayOfByte != null))
          {
            ...
            paramContext = e.a(paramContext, "tk_file", 0L);
            ...
            if ((localObject2[0] != null) && (localObject2[0].length > 0))
            {
              paramArrayOfByte = new StringBuilder("A1_INFO: update A1 Close code: ");
            ...
            paramMap.put_siginfo(paramLong, (byte[][])localObject2, u.f());
            paramContext.put(Long.valueOf(_status.a), paramMap.get_clone());
            u.ar.a(paramContext, "tk_file");
          }
          else
          {
            return -1009;
