  ...
  extends b
{
  ...
  public byte[] a(long paramLong1, long paramLong2, boolean paramBoolean, byte[] paramArrayOfByte1, int[] paramArrayOfInt, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, int paramInt, byte[] paramArrayOfByte5)
  {
    ...
    if ((paramArrayOfByte5 != null) && (paramArrayOfByte5.length > 0)) {
      arrayOfByte = new byte[paramArrayOfByte1.length + 16 + 2 + paramArrayOfByte2.length + 16 + 1 + 2 + 1 + 2 + paramArrayOfInt.length * 2 + 2 + 4 + paramArrayOfByte4.length + 4 + paramArrayOfByte5.length];
    } else {
      arrayOfByte = new byte[paramArrayOfByte1.length + 16 + 2 + paramArrayOfByte2.length + 16 + 1 + 2 + 1 + 2 + paramArrayOfInt.length * 2 + 2 + 4 + paramArrayOfByte4.length];
    }
    ...
    paramInt = i + 2;
    util.int8_to_buf(arrayOfByte, paramInt, 3);
    paramInt += 1;
    ...
    if ((paramArrayOfByte5 != null) && (paramArrayOfByte5.length > 0))
    {
      util.int16_to_buf(arrayOfByte, paramInt, 12);
      paramInt += 2;
