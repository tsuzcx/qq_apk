  ...
  extends Thread
{
  ...
  WtloginHelper$HelperThread(WtloginHelper paramWtloginHelper1, WtloginHelper paramWtloginHelper2, Handler paramHandler, long paramLong1, long paramLong2, String paramString1, WUserSigInfo paramWUserSigInfo, String paramString2)
  {
    this.mHelper = paramWtloginHelper2;
    this.mHandler = paramHandler;
    this.mUserAccount = paramString1;
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        for (;;)
        {
          ...
          j = WtloginHelper.access$600(this.mHelper, this.mUserAccount, this.mUserSigInfo, 1);
      ...
      finally
      {
        for (;;)
        {
          ...
          synchronized (WtloginHelper.__sync_top)
          {
            ...
            if (this.mReqType == 2)
            {
              j = WtloginHelper.access$700(this.mHelper, this.mUserAccount, this.mUserInput, this.mUserSigInfo, this.mST, 1);
              this.mHandler.post(new WtloginHelper.HelperThread.4(this, i, j));
              continue;
            }
            if (this.mReqType == 3)
            {
              j = WtloginHelper.access$800(this.mHelper, this.mUserAccount, this.mSmsAppid, this.mUserSigInfo, 1);
              this.mHandler.post(new WtloginHelper.HelperThread.5(this, i, j));
              continue;
            }
            if (this.mReqType == 4)
            {
              j = WtloginHelper.access$900(this.mHelper, this.mUserAccount, this.mUserInput, this.mUserSigInfo, this.mST, 1);
              this.mHandler.post(new WtloginHelper.HelperThread.6(this, i, j));
              continue;
            }
            if (this.mReqType == 5)
            {
              j = WtloginHelper.access$1000(this.mHelper, this.mUserAccount, this.mDwAppid, this.mDwDstAppid, this.mDwDstAppPri, this.mDwMainSigMap, this.mDwSubDstAppid, this.mDwDstSubAppidList, this.mUserSigInfo, this.mST, this.mReserve, 1, this.mPromise);
              this.mHandler.post(new WtloginHelper.HelperThread.7(this, i, j));
              continue;
            }
            if (this.mReqType == 6)
            {
              j = WtloginHelper.access$1200(this.mHelper, this.mUserAccount, this.mAppid1, this.mSubAppid1, this.mDwMainSigMap, this.mAppName2, this.mSsoVer2, this.mAppid2, this.mSubAppid2, this.mAppVer2, this.mAppSign2, this.mUserSigInfo, this.mFastLoginInfo, 1);
            ...
            if (this.mReqType == 12)
            {
              j = WtloginHelper.access$1700(this.mHelper, this.mAppid1, this.mSubAppid1, this.mUserAccount, this.mUserSigInfo, 1);
              this.mHandler.post(new WtloginHelper.HelperThread.11(this, i, j));
              continue;
            }
            if (this.mReqType == 13)
            {
              j = WtloginHelper.access$1800(this.mHelper, this.mUserAccount, this.mMsgCode, this.mUserSigInfo, 1);
              this.mHandler.post(new WtloginHelper.HelperThread.12(this, i, j));
              continue;
            }
            if (this.mReqType == 14)
            {
              j = WtloginHelper.access$1900(this.mHelper, this.mUserAccount, this.mUserSigInfo, 1);
            ...
            if (this.mReqType == 15)
            {
              j = WtloginHelper.access$2100(this.mHelper, this.mUserAccount, this.quickLoginParam, 1);
              this.mHandler.post(new WtloginHelper.HelperThread.14(this, i, j));
              continue;
            }
            if (this.mReqType == 16)
            {
              j = WtloginHelper.access$2200(this.mHelper, this.mUserAccount, this.ptSig, this.quickLoginParam, 1);
            ...
            j = WtloginHelper.access$2300(this.mHelper, this.mUserAccount, this.mDwAppid, this.mDwSubDstAppid, this.mDwMainSigMap, this.mUserSigInfo, 1);
