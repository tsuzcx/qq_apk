  ...
  extends oicq_request
{
  ...
  private byte[] a(long paramLong1, int paramInt1, long paramLong2, int paramInt2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt3, int paramInt4, long[] paramArrayOfLong, int paramInt5, long paramLong3, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, byte[] paramArrayOfByte4, long paramLong4, byte[] paramArrayOfByte5, List<String> paramList, int paramInt11)
  {
    ...
    Object localObject9 = new tlv_t145();
    ...
    Object localObject11 = new tlv_t172();
    ...
    tlv_t localtlv_t2 = new tlv_t(1302);
    tlv_t localtlv_t1 = new tlv_t(1313);
    new tlv_t(1317);
    ...
    localObject9 = ((tlv_t145)localObject9).get_tlv_145(t.A);
    localObject19 = ((tlv_t154)localObject19).get_tlv_154(this.x.i);
    byte[] arrayOfByte1 = ((tlv_t141)localObject12).get_tlv_141(t.C, t.D, t.F);
    byte[] arrayOfByte2 = ((tlv_t8)localObject8).get_tlv_8(0, t.u, 0);
    localObject8 = ((tlv_t147)localObject6).get_tlv_147(paramLong4, t.G, t.H);
    ...
    if ((paramInt3 & 0x80) != 0)
    {
      paramArrayOfByte1 = localtlv_t166.get_tlv_166(t.x);
      paramInt1 += 1;
    }
    else
    {
    ...
    {
      paramArrayOfByte2 = ((tlv_t172)localObject11).get_tlv_172(this.x.r);
      paramInt1 += 1;
    }
    else
    {
    ...
    {
      paramArrayOfLong = ((tlv_t187)localObject4).get_tlv_187(t.N);
      paramInt1 += 1;
    }
    else
    {
    ...
    {
      paramArrayOfByte4 = ((tlv_t188)localObject5).get_tlv_188(t.O);
      paramInt1 += 1;
    }
    else
    {
    ...
    {
      paramArrayOfByte2 = ((tlv_t194)localObject7).get_tlv_194(t.L);
      paramInt1 += 1;
    }
    else
    {
    ...
    localObject7 = paramArrayOfByte4;
    if ((l.J != null) && (l.J.length > 0))
    {
      paramArrayOfLong = ((tlv_t201)localObject10).get_tlv_201(l.J, l.K, "qq".getBytes(), l.L);
      paramInt1 += 1;
    }
    else
    {
    ...
    localObject11 = paramArrayOfByte2;
    if ((t.R != null) && (t.R.length > 0))
    {
      paramArrayOfByte2 = ((tlv_t202)localObject22).get_tlv_202(t.R, t.S);
      paramInt1 += 1;
    }
    else
    {
      paramArrayOfByte2 = (byte[])localObject12;
    }
    ...
    localObject21 = t.C;
    localObject22 = t.F;
    localObject12 = localtlv_t144.get_tlv_144(paramArrayOfByte1, localtlv_t124.get_tlv_124(paramArrayOfByte4, (byte[])localObject12, paramInt2, (byte[])localObject21, new byte[0], (byte[])localObject22), localtlv_t128.get_tlv_128(t.T, t.U, t.V, t.Y, t.I, t.A, t.P), localtlv_t16e.get_tlv_16e(t.I), t.b(this.x.h)._tgtgt_key);
    ...
    {
      paramArrayOfByte4 = localtlv_t112.get_tlv_112(this.x.g.getBytes());
      paramInt1 += 1;
    }
    else
    {
      paramArrayOfByte4 = (byte[])localObject6;
    }
    ...
    {
      paramArrayOfByte5 = localtlv_t400.get_tlv_400(((WloginSigInfo)localObject2)._G, paramLong2, t.A, ((WloginSigInfo)localObject2)._dpwd, paramLong4, 1L, ((WloginSigInfo)localObject2)._randseed);
      paramInt1 += 1;
    }
    else
    {
      paramArrayOfByte5 = new StringBuilder();
      paramArrayOfByte5.append("");
      paramArrayOfByte5.append(paramLong2);
      util.LOGI("request_tgtgt_nopicsig req without DA1", paramArrayOfByte5.toString());
      paramArrayOfByte5 = new byte[0];
    }
    paramList = new byte[4];
    util.int32_to_buf(paramList, 0, paramInt11);
    localtlv_t2.set_data(paramList, 4);
    paramList = localtlv_t2.get_buf();
    localObject2 = new byte[6];
    util.int32_to_buf((byte[])localObject2, 0, t.au);
    util.int16_to_buf((byte[])localObject2, 4, 0);
    localtlv_t1.set_data((byte[])localObject2, 6);
    localObject2 = localtlv_t1.get_buf();
    localObject6 = new byte[localObject13.length + localObject14.length + localObject15.length + localObject18.length + localObject16.length + localObject17.length + localObject1.length + localObject12.length + localObject20.length + paramArrayOfByte4.length + localObject9.length + localObject10.length + paramArrayOfByte3.length + localObject19.length + arrayOfByte1.length + arrayOfByte2.length + paramArrayOfByte1.length + localObject8.length + localObject4.length + localObject3.length + paramArrayOfByte5.length + localObject5.length + localObject7.length + localObject11.length + paramArrayOfLong.length + paramArrayOfByte2.length + paramList.length + localObject2.length];
    System.arraycopy(localObject13, 0, localObject6, 0, localObject13.length);
    ...
    System.arraycopy(localObject20, 0, localObject6, paramInt2, localObject20.length);
    ...
    System.arraycopy(localObject19, 0, localObject6, paramInt2, localObject19.length);
    paramInt2 += localObject19.length;
    System.arraycopy(arrayOfByte1, 0, localObject6, paramInt2, arrayOfByte1.length);
    paramInt2 += arrayOfByte1.length;
    System.arraycopy(arrayOfByte2, 0, localObject6, paramInt2, arrayOfByte2.length);
    ...
    System.arraycopy(localObject4, 0, localObject6, paramInt2, localObject4.length);
    ...
    System.arraycopy(localObject2, 0, localObject6, paramInt2 + paramList.length, localObject2.length);
    paramInt2 = localObject2.length;
    return a(a((byte[])localObject6, this.u, paramInt1 + 1 + 1), this.y, this.A, this.B);
  }
  ...
  public int a(long paramLong1, int paramInt1, long paramLong2, int paramInt2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt3, int paramInt4, long[] paramArrayOfLong, int paramInt5, long paramLong3, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, byte[] paramArrayOfByte4, long paramLong4, WUserSigInfo paramWUserSigInfo)
  {
    ...
    util.LOGI("start request_tgtgt_nopicsig", ((StringBuilder)localObject).toString());
    int j = t.w;
    ...
    {
      paramArrayOfByte2 = paramWUserSigInfo;
      localObject = this;
      if ((((y)localObject).y == oicq_request.EncryptionMethod.EM_ST) && ((((y)localObject).B == null) || (((y)localObject).B.length == 0) || (((y)localObject).A == null) || (((y)localObject).A.length == 0)))
      {
        ((y)localObject).y = oicq_request.EncryptionMethod.EM_ECDH;
        t.an.attr_api(2413503);
        localObject = new StringBuilder();
        ((StringBuilder)localObject).append("");
        ((StringBuilder)localObject).append(paramLong2);
        util.LOGI("using wt st encrypt body but no st key", ((StringBuilder)localObject).toString());
      }
      a(paramLong2, a(paramLong1, j, paramLong2, paramInt2, paramArrayOfByte1, arrayOfByte, paramArrayOfByte3, paramInt3, paramInt4, paramArrayOfLong, paramInt5, paramLong3, j, paramInt7, paramInt8, paramInt9, paramInt10, paramArrayOfByte4, paramLong4, t.E, paramArrayOfByte2._domains, paramArrayOfByte2._source_type), this.y);
      ...
      else
      {
        ...
        paramArrayOfByte2.append("retry num:");
        ...
        ((StringBuilder)localObject).append("");
        ((StringBuilder)localObject).append(paramLong2);
        util.LOGI(paramArrayOfByte2, ((StringBuilder)localObject).toString());
        if (paramInt6 != 180)
        {
          paramInt1 = paramInt6;
        }
