...
public class bq
{
    ...
    if (this.gt == null)
    {
      ...
      this.gu = new Handler(this.gt.getLooper())
      {
        public final void handleMessage(Message paramAnonymousMessage)
        {
          ...
          {
            paramAnonymousMessage = (aul)paramAnonymousMessage.obj;
            if (paramAnonymousMessage == null) {
              return;
            }
          }
          try
          {
            ...
            while (((Iterator)localObject1).hasNext())
            {
              ...
              if ((aul)bq.this.gs.get(localObject2) == paramAnonymousMessage) {
  ...
  private void a(br parambr, int paramInt)
  {
    ...
    //   364: checkcast 280	com/tencent/token/aul
    //   367: astore 6
    //   369: iload_2
    //   370: iconst_1
    ...
    //   611: aload 5
    //   613: astore 6
    //   615: invokestatic 319	com/tencent/token/auo:b	()Z
    //   618: ifeq +8 -> 626
    //   621: ldc_w 321
    //   624: astore 6
    ...
    //   1525: checkcast 280	com/tencent/token/aul
    //   1528: astore 7
    //   1530: iload_2
    //   1531: iconst_1
  ...
  private boolean a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    //   113: aload 11
    //   115: aconst_null
    //   116: invokestatic 488	com/tencent/token/auo:a	([B[B)[B
    //   119: astore 9
    //   121: aload_2
    //   122: aload 9
    ...
    //   130: aload 11
    //   132: aconst_null
    //   133: invokestatic 492	com/tencent/token/auo:b	([B[B)[B
    //   136: astore 9
    //   138: goto -17 -> 121
    //   141: aload_2
  ...
  public void a(aul paramaul)
  {
    ...
    {
      U();
      Message.obtain(this.gu, 261, paramaul).sendToTarget();
      this.gu.sendEmptyMessage(262);
      return;
    }
    finally
