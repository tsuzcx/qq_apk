  ...
  implements alb
{
    ...
    if (paramakz != null)
    {
      if (paramLong >= 0L)
      {
        if (!this.c)
        {
          ...
          return this.a.a(paramakz, paramLong);
        }
        throw new IllegalStateException("closed");
      }
      throw new IllegalArgumentException("byteCount < 0: ".concat(String.valueOf(paramLong)));
  ...
  public final void a(byte[] paramArrayOfByte)
  {
    ...
    catch (EOFException localEOFException)
    {
      ...
      {
        akz localakz = this.a;
        int j = localakz.a(paramArrayOfByte, i, (int)localakz.b);
        if (j != -1) {
          i += j;
        } else {
  ...
  public final InputStream d()
  {
    new InputStream()
    {
      ...
      {
        if (!alk.this.c) {
          return (int)Math.min(alk.this.a.b, 2147483647L);
        }
      ...
      public final int read()
      {
        if (!alk.this.c)
        {
          if ((alk.this.a.b == 0L) && (alk.this.b.a(alk.this.a, 8192L) == -1L)) {
            return -1;
          }
          return alk.this.a.f() & 0xFF;
        }
        throw new IOException("closed");
      }
      ...
      public final int read(byte[] paramAnonymousArrayOfByte, int paramAnonymousInt1, int paramAnonymousInt2)
      {
        if (!alk.this.c)
        {
          alr.a(paramAnonymousArrayOfByte.length, paramAnonymousInt1, paramAnonymousInt2);
          if ((alk.this.a.b == 0L) && (alk.this.b.a(alk.this.a, 8192L) == -1L)) {
            return -1;
          }
          return alk.this.a.a(paramAnonymousArrayOfByte, paramAnonymousInt1, paramAnonymousInt2);
        }
        throw new IOException("closed");
      }
      ...
      public final String toString()
      {
        ...
        localStringBuilder.append(alk.this);
  ...
  public final String d(long paramLong)
  {
    if (paramLong >= 0L)
    {
      ...
      ((akz)localObject).a(localakz, 0L, Math.min(32L, ((akz)localObject).b));
      localObject = new StringBuilder("\\n not found: limit=");
      ((StringBuilder)localObject).append(Math.min(this.a.b, paramLong));
      ((StringBuilder)localObject).append(" content=");
      ((StringBuilder)localObject).append(localakz.l().e());
