...
public final class sl
{
        ...
        try
        {
          ...
          if (paramJSONObject != null)
          {
            ...
            if (j < paramJSONObject.length())
            {
              ...
              xb.a(bool);
              localObject1 = new sl();
              if (!((sl)localObject1).a((JSONObject)localObject2))
              {
                xb.c("child json parse error: ".concat(String.valueOf(j)));
                return false;
              }
              a((sl)localObject1);
              ...
              ((StringBuilder)localObject2).append(((sl)localObject1).b);
              xb.b(((StringBuilder)localObject2).toString());
              j += 1;
              continue;
            }
          }
        ...
        try
        {
          ...
          if (paramJSONObject != null)
          {
            ...
            if (j < paramJSONObject.length())
            {
              ...
              xb.a(bool);
              localObject1 = new sl();
              if (!((sl)localObject1).b((JSONObject)localObject2))
              {
                xb.c("child json parse error: ".concat(String.valueOf(j)));
                return false;
              }
  ...
  public final boolean c(JSONObject paramJSONObject)
  {
    ...
    //   7: putfield 57	com/tencent/token/sl:a	I
    //   10: aload_0
    //   11: aload_1
    //   12: ldc 59
    //   14: invokevirtual 63	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   17: putfield 65	com/tencent/token/sl:b	Ljava/lang/String;
    //   20: aload_1
    //   21: ldc 67
    ...
    //   34: aload_0
    //   35: iload_3
    //   36: putfield 69	com/tencent/token/sl:c	Z
    //   39: aload_1
    //   40: ldc 75
    ...
    //   53: aload_0
    //   54: iload_3
    //   55: putfield 29	com/tencent/token/sl:g	Z
    //   58: aload_1
    //   59: ldc 80
    ...
    //   93: goto +3 -> 96
    //   96: iload_3
    //   97: invokestatic 99	com/tencent/token/xb:a	(Z)V
    //   100: new 2	com/tencent/token/sl
    //   103: dup
    //   104: invokespecial 100	com/tencent/token/sl:<init>	()V
    //   107: astore 4
    //   109: aload 4
    //   111: aload 5
    //   113: invokevirtual 148	com/tencent/token/sl:c	(Lorg/json/JSONObject;)Z
    //   116: ifne +17 -> 133
    //   119: ldc 104
    //   121: iload_2
    ...
    //   128: invokestatic 116	com/tencent/token/xb:c	(Ljava/lang/String;)V
    //   131: iconst_0
    //   132: ireturn
    //   133: aload_0
    //   134: aload 4
    //   136: invokespecial 118	com/tencent/token/sl:a	(Lcom/tencent/token/sl;)V
    ...
    //   165: aload 5
    //   167: aload 4
    //   169: getfield 65	com/tencent/token/sl:b	Ljava/lang/String;
    ...
    //   181: invokestatic 139	com/tencent/token/xb:b	(Ljava/lang/String;)V
    //   184: iload_2
    //   185: iconst_1
    //   186: iadd
    //   187: istore_2
    ...
    //   220: invokestatic 116	com/tencent/token/xb:c	(Ljava/lang/String;)V
    //   223: iconst_0
    //   224: ireturn
    //   225: astore_1
    //   226: iconst_1
