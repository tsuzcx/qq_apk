  ...
  public static final class a
  {
    ...
    public a(String paramString1, long paramLong, String paramString2, String paramString3, String paramString4)
    {
      ...
      if (!TextUtils.isEmpty(paramString4))
      {
        ...
        if ((paramString1 != null) && (paramString1.length > 0)) {
          new od(paramString1[0], Integer.parseInt(paramString1[1]));
        }
      }
    }
        ...
        if ((paramString != null) && (paramString.length > 0))
        {
          ...
          while (i < j)
          {
            ...
            if ((arrayOfString != null) && (arrayOfString.length > 0)) {
              localArrayList.add(new od(arrayOfString[0], Integer.parseInt(arrayOfString[1])));
            }
            i += 1;
          }
        }
    ...
    public final String a()
    {
      ...
      if ((localObject != null) && (((List)localObject).size() != 0))
      {
        ...
        {
          localStringBuilder.append(((od)((Iterator)localObject).next()).a());
