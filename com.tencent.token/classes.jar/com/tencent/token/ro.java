...
public final class ro
{
  ...
  final b a(long paramLong, final byte[] paramArrayOfByte)
  {
    ...
    localObject2 = new Handler(Looper.getMainLooper())
    {
      public final void handleMessage(Message paramAnonymousMessage)
      {
        ...
        if (paramAnonymousMessage.what == 3005)
        {
          ...
          if (((xh)paramAnonymousMessage.obj != null) && (this.b.get() < 2))
          {
            paramAnonymousMessage = this.b;
            paramAnonymousMessage.set(paramAnonymousMessage.get() + 1);
            paramAnonymousMessage = tj.a();
            byte b1 = tk.c;
            aao.a(paramArrayOfByte);
    ...
    byte b1 = tk.c;
    aao.a(paramArrayOfByte);
    localtj.a(b1, (Handler)localObject2);
    try
    {
    ...
    paramArrayOfByte = rp.a.a().a(paramLong);
    localObject2 = tj.a().f;
    localObject1 = new ArrayList();
    localObject2 = ((aay)localObject2).b();
  ...
  {
    private static final ro a = new ro((byte)0);
  }
