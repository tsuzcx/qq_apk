  ...
  extends ThreadPoolExecutor
{
  ...
  public nk(int paramInt, TimeUnit paramTimeUnit, BlockingQueue paramBlockingQueue, ThreadFactory paramThreadFactory)
  {
  ...
  public final void a()
  {
    if (b())
    {
      ...
      if (this.d + l < System.currentTimeMillis())
      {
        ...
        Thread.currentThread().setUncaughtExceptionHandler(new nl());
