    ...
    if (bc.o().isJavaTCC())
    {
      ...
      if (paramArrayOfByte1 != null)
      {
        ...
        if (arrayOfByte != null)
        {
          ...
          avl.a(paramArrayOfByte1, arrayOfInt);
          ...
          avl.a(arrayOfByte, paramArrayOfByte1);
          ...
          avl.a(arrayOfInt, arrayOfInt.length, paramArrayOfByte2);
        }
      }
    ...
    if (bc.o().isJavaTCC())
    {
      ...
      if ((paramArrayOfByte1 != null) && (arrayOfByte != null))
      {
        ...
        if (paramArrayOfByte1.length % 4 == 0)
        {
          ...
          avl.a(paramArrayOfByte1, paramArrayOfByte2);
          if (arrayOfByte.length % 4 == 0) {
            i = arrayOfByte.length >>> 2;
          } else {
            i = (arrayOfByte.length >>> 2) + 1;
          ...
          if (i >= 0)
          {
            ...
            avl.a(paramArrayOfByte2, paramArrayOfByte2.length - 1, paramArrayOfByte1);
            return paramArrayOfByte1;
          }
        }
        return null;
 ...
 * Qualified Name:     com.tencent.token.avm
