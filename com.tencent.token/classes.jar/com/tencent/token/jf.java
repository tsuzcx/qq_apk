  ...
  implements ip
{
  ...
  public jf(Toolbar paramToolbar, boolean paramBoolean)
  {
    this(paramToolbar, paramBoolean, go.h.abc_action_bar_up_description);
  }
  
  private jf(Toolbar paramToolbar, boolean paramBoolean, int paramInt)
  {
    this.a = paramToolbar;
    ...
    paramToolbar = je.a(paramToolbar.getContext(), null, go.j.ActionBar, go.a.actionBarStyle, 0);
    this.q = paramToolbar.a(go.j.ActionBar_homeAsUpIndicator);
    int i1;
    if (paramBoolean)
    {
      Object localObject1 = paramToolbar.c(go.j.ActionBar_title);
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
        this.k = true;
        b((CharSequence)localObject1);
      }
      localObject1 = paramToolbar.c(go.j.ActionBar_subtitle);
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
      ...
      localObject1 = paramToolbar.a(go.j.ActionBar_logo);
      if (localObject1 != null) {
        b((Drawable)localObject1);
      }
      localObject1 = paramToolbar.a(go.j.ActionBar_icon);
      if (localObject1 != null) {
      ...
      c(paramToolbar.a(go.j.ActionBar_displayOptions, 0));
      i1 = paramToolbar.g(go.j.ActionBar_customNavigationLayout, 0);
      Object localObject2;
      if (i1 != 0)
      {
      ...
      i1 = paramToolbar.f(go.j.ActionBar_height, 0);
      if (i1 > 0)
      {
      ...
      int i2 = paramToolbar.d(go.j.ActionBar_contentInsetStart, -1);
      i1 = paramToolbar.d(go.j.ActionBar_contentInsetEnd, -1);
      if ((i2 >= 0) || (i1 >= 0))
      {
        localObject1 = this.a;
        i2 = Math.max(i2, 0);
      ...
      i1 = paramToolbar.g(go.j.ActionBar_titleTextStyle, 0);
      if (i1 != 0)
      {
        localObject1 = this.a;
      ...
      i1 = paramToolbar.g(go.j.ActionBar_subtitleTextStyle, 0);
      if (i1 != 0)
      {
        localObject1 = this.a;
        localObject2 = ((Toolbar)localObject1).getContext();
      ...
      i1 = paramToolbar.g(go.j.ActionBar_popupTheme, 0);
      if (i1 != 0) {
    ...
    {
      final he a = new he(jf.this.a.getContext(), jf.this.b);
      
      public final void onClick(View paramAnonymousView)
      {
        if ((jf.this.c != null) && (jf.this.d)) {
          jf.this.c.onMenuItemSelected(0, this.a);
        }
      }
    });
  }
  ...
  public final ez a(final int paramInt, long paramLong)
  {
    ez localez = ew.f(this.a);
    float f1;
    if (paramInt == 0) {
      f1 = 1.0F;
    } else {
    ...
    localez.a(f1).a(paramLong).a(new fb()
    {
      private boolean c = false;
      
      public final void a(View paramAnonymousView)
      {
        jf.this.a.setVisibility(0);
      }
      
      public final void b(View paramAnonymousView)
      {
        if (!this.c) {
          jf.this.a.setVisibility(paramInt);
        }
      }
 ...
 * Qualified Name:     com.tencent.token.jf
