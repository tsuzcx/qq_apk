...
public final class jf
{
  ...
  private jf(Context paramContext, TypedArray paramTypedArray)
  {
    this.b = paramContext;
    this.a = paramTypedArray;
  }
  
  public static jf a(Context paramContext, int paramInt, int[] paramArrayOfInt)
  {
    return new jf(paramContext, paramContext.obtainStyledAttributes(paramInt, paramArrayOfInt));
  }
  
  public static jf a(Context paramContext, AttributeSet paramAttributeSet, int[] paramArrayOfInt)
  {
    return new jf(paramContext, paramContext.obtainStyledAttributes(paramAttributeSet, paramArrayOfInt));
  }
  
  public static jf a(Context paramContext, AttributeSet paramAttributeSet, int[] paramArrayOfInt, int paramInt1, int paramInt2)
  {
    return new jf(paramContext, paramContext.obtainStyledAttributes(paramAttributeSet, paramArrayOfInt, paramInt1, paramInt2));
  }
  ...
  public final Typeface a(int paramInt1, int paramInt2, cx.a parama)
  {
    ...
    return cx.a(this.b, paramInt1, this.c, paramInt2, parama);
  }
  ...
  public final Drawable b(int paramInt)
  {
    if (this.a.hasValue(paramInt))
    {
      ...
      if (paramInt != 0) {
        return ih.a().a(this.b, paramInt, true);
      }
    }
    return null;
  }
  ...
  public final ColorStateList e(int paramInt)
  {
    if (this.a.hasValue(paramInt))
    {
      ...
      if (i != 0)
      {
        ColorStateList localColorStateList = gr.a(this.b, i);
