...
public final class rh
{
  ...
  final b a(long paramLong, final byte[] paramArrayOfByte)
  {
    ...
    localObject2 = new Handler(Looper.getMainLooper())
    {
      public final void handleMessage(Message paramAnonymousMessage)
      {
        ...
        if (paramAnonymousMessage.what == 3005)
        {
          ...
          if (((wz)paramAnonymousMessage.obj != null) && (this.b.get() < 2))
          {
            paramAnonymousMessage = this.b;
            paramAnonymousMessage.set(paramAnonymousMessage.get() + 1);
            paramAnonymousMessage = tc.a();
            byte b1 = td.c;
            aad.a(paramArrayOfByte);
    ...
    byte b1 = td.c;
    aad.a(paramArrayOfByte);
    localtc.a(b1, (Handler)localObject2);
    try
    {
    ...
    paramArrayOfByte = ri.a.a().a(paramLong);
    localObject2 = tc.a().f;
    localObject1 = new ArrayList();
    localObject2 = ((aan)localObject2).b();
  ...
  {
    private static final rh a = new rh((byte)0);
  }
 ...
 * Qualified Name:     com.tencent.token.rh
