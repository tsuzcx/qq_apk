...
public final class rz
{
  ...
  public WtloginListener i = new WtloginListener()
  {
    private void a(int paramAnonymousInt, ErrMsg arg2, String paramAnonymousString, long paramAnonymousLong)
    {
      ...
      {
        rz.this.f.a(paramAnonymousInt, ???.getMessage(), ???.getMessage());
        rz.this.f.d = ???;
      }
      else
      {
        ??? = rz.b(rz.this).GetLocalTicket(paramAnonymousString, paramAnonymousLong, 64);
        if ((rz.this.f != null) && (??? != null))
        {
          rz.this.f.d = ???._sig;
          rz.this.f.a = 0;
        }
    ...
    public final void OnCheckPictureAndGetSt(String paramAnonymousString, byte[] arg2, WUserSigInfo paramAnonymousWUserSigInfo, int paramAnonymousInt, ErrMsg paramAnonymousErrMsg)
    {
      int i = rz.e(rz.this);
      rz.f(rz.this);
      synchronized (rz.g(rz.this))
      {
        rz.h(rz.this).cancel();
        if (rz.a(rz.this) == null)
        {
          xb.c("onCheckPictureAndGetSt, handler is null");
          return;
        }
        paramAnonymousWUserSigInfo = rz.a(rz.this).obtainMessage(4099);
        ...
        {
          if (i != 0) {
            paramAnonymousString = rz.b(rz.this).GetLocalTicket(paramAnonymousString, rz.j(rz.this), i);
          } else {
            paramAnonymousString = rz.b(rz.this).GetLocalTicket(paramAnonymousString, rz.j(rz.this), 64);
          }
          if (paramAnonymousString != null)
          {
            paramAnonymousWUserSigInfo.obj = paramAnonymousString._sig;
            paramAnonymousString = new Bundle();
            paramAnonymousString.putLong("appid", rz.j(rz.this));
            paramAnonymousWUserSigInfo.setData(paramAnonymousString);
          }
        }
        rz.a(rz.this).sendMessage(paramAnonymousWUserSigInfo);
        rz.c(rz.this);
        return;
      }
    }
    ...
    public final void OnCloseCode(String arg1, byte[] paramAnonymousArrayOfByte1, long paramAnonymousLong, WUserSigInfo paramAnonymousWUserSigInfo, byte[] paramAnonymousArrayOfByte2, int paramAnonymousInt)
    {
      synchronized (rz.g(rz.this))
      {
        ...
        if (rz.a(rz.this) == null)
        {
          xb.c("onCloseCode, handler is null");
          return;
        }
        paramAnonymousWUserSigInfo = rz.a(rz.this).obtainMessage(4102);
        paramAnonymousWUserSigInfo.arg1 = paramAnonymousInt;
    ...
    public final void OnException(ErrMsg paramAnonymousErrMsg, int paramAnonymousInt, WUserSigInfo arg3)
    {
      ...
      synchronized (rz.g(rz.this))
      {
        ...
        if (rz.a(rz.this) == null)
        {
          xb.c("onVerifyCode, handler is null");
          return;
        }
        Message localMessage = rz.a(rz.this).obtainMessage(4104);
        localMessage.arg1 = paramAnonymousInt;
        Bundle localBundle = new Bundle();
        localBundle.putString("exception", paramAnonymousErrMsg.getMessage());
        localMessage.setData(localBundle);
        rz.a(rz.this).sendMessage(localMessage);
        rz.c(rz.this);
        return;
      }
    }
    ...
    {
      paramAnonymousInt1 = rz.e(rz.this);
      rz.f(rz.this);
      synchronized (rz.g(rz.this))
      {
        rz.h(rz.this).cancel();
        ...
        if (rz.a(rz.this) == null)
        {
          xb.c("onGetStWithPasswd, handler is null");
          return;
        }
        ...
        xb.c(paramAnonymousWUserSigInfo.toString());
        paramAnonymousWUserSigInfo = new StringBuilder();
        paramAnonymousWUserSigInfo.append(this);
        ...
        paramAnonymousWUserSigInfo.append(paramAnonymousLong1);
        xb.c(paramAnonymousWUserSigInfo.toString());
        paramAnonymousWUserSigInfo = rz.a(rz.this).obtainMessage(4098);
        ...
        else
        {
          if (paramAnonymousInt1 != 0) {
            paramAnonymousString1 = rz.b(rz.this).GetLocalTicket(paramAnonymousString1, rz.j(rz.this), paramAnonymousInt1);
          } else {
            paramAnonymousString1 = rz.b(rz.this).GetLocalTicket(paramAnonymousString1, rz.j(rz.this), 64);
          }
    ...
    public final void OnGetStWithoutPasswd(String paramAnonymousString, long paramAnonymousLong1, long paramAnonymousLong2, int paramAnonymousInt1, long paramAnonymousLong3, WUserSigInfo arg9, int paramAnonymousInt2, ErrMsg paramAnonymousErrMsg)
    {
      ...
      synchronized (rz.g(rz.this))
      {
        ...
        if (rz.a(rz.this) == null)
        {
          xb.c("onGetStWithoutPasswd, handler is null");
          return;
        }
        ...
        ((StringBuilder)localObject).append(paramAnonymousLong1);
        xb.c(((StringBuilder)localObject).toString());
        localObject = rz.a(rz.this).obtainMessage(4097);
        ...
        {
          if (paramAnonymousInt1 != 0) {
            paramAnonymousString = rz.b(rz.this).GetLocalTicket(paramAnonymousString, paramAnonymousLong1, paramAnonymousInt1);
          } else {
            paramAnonymousString = rz.b(rz.this).GetLocalTicket(paramAnonymousString, paramAnonymousLong1, 64);
          }
          if (paramAnonymousString != null) {
            ((Message)localObject).obj = paramAnonymousString._sig;
          }
        }
        rz.a(rz.this).sendMessage((Message)localObject);
        rz.c(rz.this);
        return;
      }
    }
    ...
    {
      xb.b("Wtlogin init result ".concat(String.valueOf(paramAnonymousInt)));
    }
    ...
    public final void OnRefreshPictureData(String arg1, WUserSigInfo paramAnonymousWUserSigInfo, byte[] paramAnonymousArrayOfByte, int paramAnonymousInt, ErrMsg paramAnonymousErrMsg)
    {
      synchronized (rz.g(rz.this))
      {
        ...
        if (rz.a(rz.this) == null)
        {
          xb.c("onRefreshPictureData, handler is null");
          return;
        }
        paramAnonymousWUserSigInfo = rz.a(rz.this).obtainMessage(4100);
        paramAnonymousWUserSigInfo.arg1 = paramAnonymousInt;
        if (paramAnonymousInt != 0)
        {
    ...
    public final void OnVerifyCode(String arg1, byte[] paramAnonymousArrayOfByte1, long paramAnonymousLong, List<byte[]> paramAnonymousList, WUserSigInfo paramAnonymousWUserSigInfo, byte[] paramAnonymousArrayOfByte2, int paramAnonymousInt)
    {
      synchronized (rz.g(rz.this))
      {
        ...
        paramAnonymousList = rz.a(rz.this).obtainMessage(4101);
        ...
        rz.a(rz.this).sendMessage(paramAnonymousList);
        rz.c(rz.this);
        return;
      }
    }
      ...
      for (;;)
      {
        try
        {
          ...
          if (rz.a(rz.this) != null)
          {
            ...
            xb.a(paramAnonymousErrMsg.toString());
            if (paramAnonymousInt != 0)
            {
              if (true == util.shouldKick(paramAnonymousInt)) {
                rz.b(rz.this).ClearUserLoginData(paramAnonymousString, 523005419L);
              }
            }
            else
            {
              paramAnonymousQuickLoginParam = rz.a(paramAnonymousQuickLoginParam.userSigInfo);
              if (rz.a(rz.this) != null)
              {
                paramAnonymousErrMsg = rz.a(rz.this).obtainMessage(4109);
                ...
                rz.a(rz.this).sendMessage(paramAnonymousErrMsg);
                rz.c(rz.this);
              }
            }
            return;
  ...
  private rz(Context paramContext)
  {
  ...
  public static rz a(Context paramContext)
  {
    if (k == null) {
      k = new rz(paramContext);
    }
    return k;
  }
  ...
  public final int a(Activity paramActivity, Handler paramHandler)
  {
    try
    {
      this.a.quickLogin(paramActivity, 523005419L, this.n, aab.b, b());
      this.b = paramHandler;
    }
  ...
  public final int a(Activity paramActivity, Handler paramHandler, String paramString)
  {
    try
    {
      ...
      this.a.quickLogin(paramActivity, 523005419L, this.n, aab.b, localQuickLoginParam);
      this.b = paramHandler;
    }
    catch (Exception paramActivity)
    {
    ...
    try
    {
      ...
      if (localHandler == null)
      {
        ...
        this.c.schedule(new TimerTask()
        {
          ...
          {
            rz.this.i.OnGetStWithoutPasswd(null, 0L, 0L, 0, 0L, null, 8192, new ErrMsg());
          }
        }, 30000L);
        return 0;
      }
    ...
    if (this.b == null)
    {
      ...
      try
      {
        this.c.schedule(new TimerTask()
        {
          public final void run()
          {
            rz.this.i.OnVerifyCode(null, null, 0L, null, new WUserSigInfo(), null, 8192);
          }
        }, 30000L);
        return 0;
      }
    ...
    if (this.b == null)
    {
      ...
      try
      {
        this.c.schedule(new TimerTask()
        {
          public final void run()
          {
            rz.this.i.OnCloseCode(null, null, 0L, new WUserSigInfo(), null, 8192);
          }
        }, 30000L);
      }
 ...
 * Qualified Name:     com.tencent.token.rz
