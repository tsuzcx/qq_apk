...
public class bu
{
  ...
  private e a(String paramString)
  {
    ...
    //   7: astore_3
    //   8: invokestatic 78	com/tencent/token/cr:a	()Lcom/tencent/token/cr;
    //   11: invokevirtual 81	com/tencent/token/cr:o	()Z
    //   14: ifne +24 -> 38
    //   17: aload_0
    //   18: getfield 83	com/tencent/token/bu:j	Z
    //   21: ifeq +8 -> 29
    //   24: aload_0
    //   25: invokevirtual 85	com/tencent/token/bu:b	()Z
    //   28: pop
    //   29: aload_3
    //   30: sipush 30001
    ...
    //   89: aload 5
    //   91: ldc 120
    //   93: getstatic 122	com/tencent/token/cr:c	Ljava/lang/String;
    ...
    //   123: pop
    //   124: aload 6
    //   126: getstatic 122	com/tencent/token/cr:c	Ljava/lang/String;
    ...
    //   173: new 139	com/tencent/token/ez
    //   176: dup
    //   177: invokespecial 140	com/tencent/token/ez:<init>	()V
    //   180: astore_1
    //   181: aload_1
    //   182: aload 4
    //   184: aload 5
    //   186: invokevirtual 143	com/tencent/token/ez:a	(Ljava/lang/String;Landroid/content/ContentValues;)[B
    //   189: astore 4
    //   191: aload 4
    //   193: ifnonnull +25 -> 218
    //   196: aload_0
    //   197: getfield 83	com/tencent/token/bu:j	Z
    //   200: ifeq +8 -> 208
    //   203: aload_0
    //   204: invokevirtual 85	com/tencent/token/bu:b	()Z
    //   207: pop
    //   208: aload_3
    //   209: aload_1
    //   210: invokevirtual 146	com/tencent/token/ez:a	()Lcom/tencent/token/global/e;
    ...
    //   267: aload_0
    //   268: getfield 51	com/tencent/token/bu:b	Lorg/json/JSONArray;
    //   271: invokevirtual 177	org/json/JSONArray:length	()I
    //   274: getstatic 179	com/tencent/token/bu:e	I
    //   277: if_icmple +10 -> 287
    //   280: getstatic 179	com/tencent/token/bu:e	I
    //   283: istore_2
    //   284: goto +11 -> 295
    //   287: aload_0
    //   288: getfield 51	com/tencent/token/bu:b	Lorg/json/JSONArray;
    //   291: invokevirtual 177	org/json/JSONArray:length	()I
    //   294: istore_2
    //   295: iload_2
    //   296: getstatic 179	com/tencent/token/bu:e	I
    //   299: if_icmpgt +17 -> 316
    //   302: aload_0
    //   303: new 48	org/json/JSONArray
    //   306: dup
    //   307: invokespecial 49	org/json/JSONArray:<init>	()V
    //   310: putfield 51	com/tencent/token/bu:b	Lorg/json/JSONArray;
    //   313: goto +47 -> 360
    ...
    //   324: iload_2
    //   325: aload_0
    //   326: getfield 51	com/tencent/token/bu:b	Lorg/json/JSONArray;
    //   329: invokevirtual 177	org/json/JSONArray:length	()I
    //   332: if_icmpge +23 -> 355
    //   335: aload_1
    //   336: aload_0
    //   337: getfield 51	com/tencent/token/bu:b	Lorg/json/JSONArray;
    //   340: iload_2
    ...
    //   355: aload_0
    //   356: aload_1
    //   357: putfield 51	com/tencent/token/bu:b	Lorg/json/JSONArray;
    //   360: aload_0
    //   361: getfield 83	com/tencent/token/bu:j	Z
    //   364: ifeq +184 -> 548
    //   367: aload_0
    //   368: invokevirtual 85	com/tencent/token/bu:b	()Z
    //   371: pop
    //   372: aload_3
    //   373: areturn
    //   374: astore_1
    ...
    //   453: aload_0
    //   454: getfield 83	com/tencent/token/bu:j	Z
    //   457: ifeq +91 -> 548
    //   460: goto -93 -> 367
    //   463: astore_1
    ...
    //   538: aload_0
    //   539: getfield 83	com/tencent/token/bu:j	Z
    //   542: ifeq +6 -> 548
    //   545: goto -178 -> 367
    //   548: aload_3
    //   549: areturn
    //   550: aload_0
    //   551: getfield 83	com/tencent/token/bu:j	Z
    //   554: ifeq +8 -> 562
    //   557: aload_0
    //   558: invokevirtual 85	com/tencent/token/bu:b	()Z
    //   561: pop
    //   562: aload_1
    //   563: athrow
  ...
  public void a(boolean paramBoolean)
  {
    ...
    //   19: return
    //   20: aload_0
    //   21: getfield 42	com/tencent/token/bu:a	Z
    //   24: ifeq +268 -> 292
    //   27: aload_0
    //   28: getfield 51	com/tencent/token/bu:b	Lorg/json/JSONArray;
    //   31: invokevirtual 177	org/json/JSONArray:length	()I
    //   34: ifne +4 -> 38
    //   37: return
    //   38: aload_0
    //   39: iconst_1
    //   40: putfield 44	com/tencent/token/bu:h	Z
    //   43: new 48	org/json/JSONArray
    //   46: dup
    //   47: invokespecial 49	org/json/JSONArray:<init>	()V
    //   50: astore 6
    //   52: aload_0
    //   53: getfield 51	com/tencent/token/bu:b	Lorg/json/JSONArray;
    //   56: invokevirtual 177	org/json/JSONArray:length	()I
    //   59: istore_3
    //   60: getstatic 179	com/tencent/token/bu:e	I
    //   63: istore_2
    //   64: iload_3
    //   65: iload_2
    //   66: if_icmple +6 -> 72
    //   69: goto +11 -> 80
    //   72: aload_0
    //   73: getfield 51	com/tencent/token/bu:b	Lorg/json/JSONArray;
    ...
    //   87: aload 6
    //   89: aload_0
    //   90: getfield 51	com/tencent/token/bu:b	Lorg/json/JSONArray;
    //   93: iload_3
    ...
    //   125: astore 8
    //   127: aload 8
    //   129: invokevirtual 237	com/tencent/token/cr:k	()Lcom/tencent/token/core/bean/QQUser;
    //   132: astore 9
    //   134: aload 9
    //   136: ifnull +13 -> 149
    //   139: aload 9
    ...
    //   146: goto +22 -> 168
    //   149: aload 8
    //   151: invokevirtual 216	com/tencent/token/cr:e	()Lcom/tencent/token/core/bean/QQUser;
    //   154: astore 8
    //   156: aload 8
    //   158: ifnull +10 -> 168
    //   161: aload 8
    ...
    //   168: aload 7
    //   170: ldc 239
    //   172: invokestatic 244	com/tencent/token/cc:c	()Lcom/tencent/token/cc;
    //   175: invokevirtual 248	com/tencent/token/cc:s	()J
    //   178: ldc2_w 205
    //   181: ldiv
    //   182: l2i
    //   183: invokevirtual 213	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   186: pop
    //   187: getstatic 252	com/tencent/token/cb:a	I
    //   190: iconst_1
    //   191: iadd
    //   192: istore_2
    //   193: iload_2
    //   194: putstatic 252	com/tencent/token/cb:a	I
    //   197: aload 7
    //   199: ldc 254
    //   201: iload_2
    ...
    //   217: aload 7
    //   219: ldc_w 258
    //   222: invokestatic 244	com/tencent/token/cc:c	()Lcom/tencent/token/cc;
    //   225: invokevirtual 260	com/tencent/token/cc:k	()J
    ...
    //   252: putfield 271	com/tencent/token/bu:c	Ljava/lang/String;
    //   255: aload_0
    //   256: monitorexit
    //   257: aload_0
    //   258: new 6	com/tencent/token/bu$1
    //   261: dup
    //   262: aload_0
    //   263: invokespecial 274	com/tencent/token/bu$1:<init>	(Lcom/tencent/token/bu;)V
    //   266: putfield 46	com/tencent/token/bu:k	Lcom/tencent/token/utils/UserTask;
    //   269: aload_0
    //   270: getfield 46	com/tencent/token/bu:k	Lcom/tencent/token/utils/UserTask;
    //   273: iconst_0
  ...
  public boolean a(android.content.Context paramContext)
  {
    ...
    //   16: ireturn
    //   17: iconst_0
    //   18: putstatic 36	com/tencent/token/bu:i	Z
    //   21: aload_0
    //   22: getfield 42	com/tencent/token/bu:a	Z
    //   25: ifne +5 -> 30
    //   28: iconst_1
    //   29: ireturn
    //   30: aload_1
    ...
    //   45: aload_1
    //   46: aload_0
    //   47: getfield 51	com/tencent/token/bu:b	Lorg/json/JSONArray;
  ...
  public boolean c()
  {
    ...
    //   15: iconst_1
    //   16: ireturn
    //   17: invokestatic 306	com/tencent/token/global/RqdApplication:l	()Landroid/content/Context;
    //   20: ldc_w 286
    //   23: invokevirtual 312	android/content/Context:openFileInput	(Ljava/lang/String;)Ljava/io/FileInputStream;
    //   26: astore_1
    //   27: aload_1
    //   28: ifnonnull +5 -> 33
    //   31: iconst_0
    ...
    //   39: aload_1
    //   40: aload_2
    //   41: invokevirtual 318	java/io/FileInputStream:read	([B)I
    //   44: pop
    //   45: aload_0
    ...
    //   58: invokespecial 319	org/json/JSONArray:<init>	(Ljava/lang/String;)V
    //   61: putfield 51	com/tencent/token/bu:b	Lorg/json/JSONArray;
    //   64: aload_1
    //   65: invokevirtual 320	java/io/FileInputStream:close	()V
    //   68: iconst_1
    //   69: ireturn
    //   70: aload_1
    //   71: invokevirtual 320	java/io/FileInputStream:close	()V
    //   74: iconst_0
    //   75: ireturn
    //   76: astore_1
    //   77: iconst_0
