  ...
  implements cb.g
{
  ...
  {
    parama = parama.b;
    return (parama != null) && (parama.l) && (parama.J != null) && (!parama.C) && (!parama.B) && (parama.A());
  }
  ...
  public final cd a(int paramInt, Fragment paramFragment, String paramString)
  {
  ...
  public final cd a(Fragment paramFragment)
  {
  ...
  final void a(boolean paramBoolean)
  {
    ...
    while (i1 >= 0)
    {
      ...
      if (localObject2 != null) {
        ((Fragment)localObject2).a(cb.b(this.g), this.h);
      }
      ...
      if (i2 != 1)
      {
        ...
        case 5: 
          ((Fragment)localObject2).a(((a)localObject1).f);
          cb.d((Fragment)localObject2);
          break;
        case 4: 
          ((Fragment)localObject2).a(((a)localObject1).e);
          cb.e((Fragment)localObject2);
          break;
        case 3: 
          ((Fragment)localObject2).a(((a)localObject1).e);
    ...
    {
      localObject1 = this.a;
      ((cb)localObject1).a(((cb)localObject1).l, true);
    }
  }
  
  final boolean a(ArrayList<bu> paramArrayList, int paramInt1, int paramInt2)
  {
      ...
      if (i1 != 0)
      {
        ...
        if (i1 != i3)
        {
          ...
          while (i3 < paramInt2)
          {
            ...
            int i7 = ((bu)localObject).b.size();
            i4 = 0;
            while (i4 < i7)
            {
              a locala = (a)((bu)localObject).b.get(i4);
              int i5;
              if (locala.b != null) {
                i5 = locala.b.z;
              } else {
  ...
  public final boolean a(ArrayList<bu> paramArrayList, ArrayList<Boolean> paramArrayList1)
  {
    if (cb.a) {
  ...
  public final int b()
  {
    if (!this.l)
    {
      if (cb.a)
      {
        ...
        localObject1 = new PrintWriter(new dy("FragmentManager"));
      ...
      try
      {
        if ((!((cb)localObject1).u) && (((cb)localObject1).m != null))
        {
          if (((cb)localObject1).b == null) {
            ((cb)localObject1).b = new ArrayList();
          }
          ((cb)localObject1).b.add(this);
          ((cb)localObject1).g();
          return this.m;
        }
  ...
  public final cd b(Fragment paramFragment)
  {
