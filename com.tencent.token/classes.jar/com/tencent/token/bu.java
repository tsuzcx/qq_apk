  ...
  implements Interpolator
{
  ...
  public bu(Context paramContext, AttributeSet paramAttributeSet, XmlPullParser paramXmlPullParser)
  {
    this(paramContext.getResources(), paramContext.getTheme(), paramAttributeSet, paramXmlPullParser);
  }
  
  private bu(Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, XmlPullParser paramXmlPullParser)
  {
    paramResources = db.a(paramResources, paramTheme, paramAttributeSet, bo.l);
    if (db.a(paramXmlPullParser, "pathData"))
    {
      paramTheme = db.b(paramResources, paramXmlPullParser, "pathData", 4);
      paramAttributeSet = dd.a(paramTheme);
    ...
    {
      if (!db.a(paramXmlPullParser, "controlX1")) {
        break label252;
      }
      if (!db.a(paramXmlPullParser, "controlY1")) {
        break label242;
      }
      float f1 = db.a(paramResources, paramXmlPullParser, "controlX1", 0, 0.0F);
      float f2 = db.a(paramResources, paramXmlPullParser, "controlY1", 1, 0.0F);
      boolean bool = db.a(paramXmlPullParser, "controlX2");
      if (bool != db.a(paramXmlPullParser, "controlY2")) {
        break label232;
      }
      if (!bool)
      {
      ...
      {
        float f3 = db.a(paramResources, paramXmlPullParser, "controlX2", 2, 0.0F);
        float f4 = db.a(paramResources, paramXmlPullParser, "controlY2", 3, 0.0F);
        paramTheme = new Path();
        paramTheme.moveTo(0.0F, 0.0F);
