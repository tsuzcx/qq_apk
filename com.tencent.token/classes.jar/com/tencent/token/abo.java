...
public final class abo
{
  ...
  static
  {
    StringBuilder localStringBuilder = aev.a("turingfd_shark_");
    localStringBuilder.append(afi.a);
    localStringBuilder.append("_baseFull");
    a = localStringBuilder.toString();
  }
  
  public static acc a(Context paramContext)
  {
    j = -1;
    try
    {
    ...
    catch (Throwable localThrowable2)
    {
      try
      {
        ...
        m = j;
        localif = new if();
        localObject2 = aez.e(paramContext);
        ...
        localObject2 = aez.f(paramContext);
        localObject1 = localObject2;
        if (localObject2 != null) {
          break label154;
        }
        ...
        localif.B = 49;
        localObject1 = aev.a("");
        ((StringBuilder)localObject1).append(afi.a);
      ...
      catch (Throwable localThrowable2)
      {
        try
        {
          for (;;)
          {
            ...
            localif.ga = 2052;
            localif.ha = 1;
            localif.Ka = ach.a("ro.product.cpu.abi2");
            localObject1 = ach.a();
            ...
            localif.Ja = ach.a("ro.build.product");
            localif.La = ach.a("ro.build.fingerprint");
            localif.Ma = ach.a("ro.product.locale.language");
            localif.Na = ach.a("ro.product.locale.region");
            localObject1 = ach.c();
            paramContext = (Context)localObject1;
            if (localObject1 == null) {
              paramContext = "";
            ...
            localif.va = ach.a("ro.board.platform");
            localif.Qa = ach.a("ro.mediatek.platform");
            localif.wa = ach.a("ro.sf.lcd_density");
            localif.sa = ach.a("ro.product.name");
            localif.ta = ach.a("ro.build.version.release");
            localObject1 = ach.d();
            paramContext = (Context)localObject1;
            if (localObject1 == null) {
              paramContext = "";
            ...
            paramContext = new acc.a(1, 10001, 0);
