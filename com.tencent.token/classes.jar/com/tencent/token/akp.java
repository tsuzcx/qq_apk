...
public final class akp
{
  ...
  private akp(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, int paramInt3, int paramInt4, boolean paramBoolean6, boolean paramBoolean7, boolean paramBoolean8, @Nullable String paramString)
  {
  ...
  public static akp a(alc paramalc)
  {
    int i8 = paramalc.a.length / 2;
    int i7 = 0;
    int i2 = 1;
    ...
    for (;;)
    {
      Object localObject2 = paramalc;
      if (i7 >= i8) {
        break;
      }
      String str2 = ((alc)localObject2).a(i7);
      String str1 = ((alc)localObject2).b(i7);
      ...
      while (i1 < str1.length())
      {
        ...
        if ("no-cache".equalsIgnoreCase(str2)) {
          ...
          i6 = ami.b((String)localObject2, -1);
        } else if ("s-maxage".equalsIgnoreCase(str2)) {
          i5 = ami.b((String)localObject2, -1);
          ...
          i4 = ami.b((String)localObject2, 2147483647);
        } else if ("min-fresh".equalsIgnoreCase(str2)) {
          i3 = ami.b((String)localObject2, -1);
    ...
    return new akp(bool5, bool7, i6, i5, bool8, bool6, bool4, i4, i3, bool3, bool2, bool1, localObject1);
  }
