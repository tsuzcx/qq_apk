...
public final class alc
{
  ...
  {
    return ((paramObject instanceof alc)) && (Arrays.equals(((alc)paramObject).a, this.a));
  }
        ...
        if (!paramString1.isEmpty())
        {
          ...
          while (i < j)
          {
            ...
            if ((k > 32) && (k < 127)) {
              ...
              throw new IllegalArgumentException(alr.a("Unexpected char %#04x at %d in header name: %s", new Object[] { Integer.valueOf(k), Integer.valueOf(i), paramString1 }));
            }
          }
          if (paramString2 != null)
          {
            ...
            while (i < j)
            {
              ...
              if (((k > 31) || (k == 9)) && (k < 127)) {
                ...
                throw new IllegalArgumentException(alr.a("Unexpected char %#04x at %d in %s value: %s", new Object[] { Integer.valueOf(k), Integer.valueOf(i), paramString1, paramString2 }));
              }
            }
            return;
          }
