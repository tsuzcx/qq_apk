  ...
  implements ahk
{
  ...
  public final ahk a(afx paramafx)
  {
    ...
    localahl.b = paramafx.getLong(paramafx.getColumnIndex("plusTime"));
    localahl.c = paramafx.getInt(paramafx.getColumnIndex("tokenIntVTime"));
    localahl.d = paramafx.getBlob(paramafx.getColumnIndex("data"));
    return localahl;
  }
  ...
  public final void a(long paramLong, int paramInt, byte[] paramArrayOfByte)
  {
    ...
    ahi.a(this, "token_conf", localContentValues, "key=?", new String[] { String.valueOf(this.e) });
  }
