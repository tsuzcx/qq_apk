  ...
  extends BaseAdapter
{
  ...
  public xv(BaseActivity paramBaseActivity, List<QQUser> paramList)
  {
  ...
  public final View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null)
      {
        ...
        localStringBuilder.append(aac.e(((QQUser)localObject).mRealUin));
        localStringBuilder.append(")");
        paramViewGroup.setText(localStringBuilder.toString());
        paramViewGroup = aad.f();
 ...
 * Qualified Name:     com.tencent.token.xv
