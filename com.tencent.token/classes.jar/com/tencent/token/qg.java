...
public final class qg
{
  ...
  {
    Object localObject = qu.a(paramContext).a(paramInt1);
    if (localObject != null)
    {
    ...
    if (l1 - qq.a.a().a("pgd_sp").a((String)localObject, 0L) > 86400000L)
    {
      l2 = paramContext.b;
      localObject = new StringBuilder("s");
      ((StringBuilder)localObject).append(l2);
      ((StringBuilder)localObject).append("ct");
      localObject = ((StringBuilder)localObject).toString();
      qq.a.a().a("pgd_sp").b((String)localObject, l1);
