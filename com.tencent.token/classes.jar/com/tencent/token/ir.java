...
public final class ir
{
      ...
      for (;;)
      {
        try
        {
          if ((paramDrawable instanceof dj)) {
            localObject = ((dj)paramDrawable).a();
          }
  ...
  static void b(Drawable paramDrawable)
  {
    if ((Build.VERSION.SDK_INT == 21) && ("android.graphics.drawable.VectorDrawable".equals(paramDrawable.getClass().getName())))
    {
      ...
      if ((arrayOfInt != null) && (arrayOfInt.length != 0)) {
        paramDrawable.setState(jb.h);
      } else {
        paramDrawable.setState(jb.e);
      }
  ...
  public static boolean c(Drawable paramDrawable)
  {
    for (;;)
    {
      ...
      if ((paramDrawable instanceof dj))
      {
        paramDrawable = ((dj)paramDrawable).a();
      }
      else if ((paramDrawable instanceof gt))
      {
        paramDrawable = ((gt)paramDrawable).a;
      }
      else
      {
