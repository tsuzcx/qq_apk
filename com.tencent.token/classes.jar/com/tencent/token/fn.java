  ...
  implements Animatable
{
  ...
  private static final Interpolator c = new fh();
  ...
  public fn(final Context paramContext)
  {
    this.f = ((Context)ee.a(paramContext)).getResources();
    this.a = new a();
    this.a.a(d);
    this.a.a(2.5F);
    invalidateSelf();
    ...
    localValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
    {
      public final void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        ...
        fn.a(f, paramContext);
        fn.a(fn.this, f, paramContext, false);
        fn.this.invalidateSelf();
      }
    });
    ...
    localValueAnimator.addListener(new Animator.AnimatorListener()
    {
      ...
      {
        fn.a(fn.this, 1.0F, paramContext, true);
        paramContext.c();
        fn.a locala = paramContext;
        locala.a(locala.a());
        if (fn.a(fn.this))
        {
          fn.b(fn.this);
        ...
        paramAnonymousAnimator = fn.this;
        fn.a(paramAnonymousAnimator, fn.c(paramAnonymousAnimator) + 1.0F);
      }
