  ...
  extends MenuInflater
{
  ...
  public final void inflate(int paramInt, Menu paramMenu)
  {
    ...
    //   21: astore_3
    //   22: aload_0
    //   23: getfield 36	com/tencent/token/hf:e	Landroid/content/Context;
    ...
    //   54: aload_2
    //   55: invokespecial 120	com/tencent/token/hf:a	(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    //   58: aload 6
    //   60: ifnull +11 -> 71
    //   63: aload 6
  ...
  final class b
  {
    ...
    private <T> T a(String paramString, Class<?>[] paramArrayOfClass, Object[] paramArrayOfObject)
    {
      try
      {
        paramString = hf.this.e.getClassLoader().loadClass(paramString).getConstructor(paramArrayOfClass);
    ...
    private void a(MenuItem paramMenuItem)
    {
      ...
      if (this.B != null) {
        if (!hf.this.e.isRestricted())
        {
          localObject = hf.this;
          if (((hf)localObject).f == null) {
            ((hf)localObject).f = hf.a(((hf)localObject).e);
          }
          paramMenuItem.setOnMenuItemClickListener(new hf.a(((hf)localObject).f, this.B));
        }
        else
        {
      ...
      if (this.t >= 2) {
        if ((paramMenuItem instanceof hr)) {
          ((hr)paramMenuItem).a(true);
        } else if ((paramMenuItem instanceof hs)) {
          localObject = (hs)paramMenuItem;
        }
      }
      try
      {
        if (((hs)localObject).e == null) {
          ((hs)localObject).e = ((dr)((hs)localObject).d).getClass().getDeclaredMethod("setExclusiveCheckable", new Class[] { Boolean.TYPE });
        }
        ((hs)localObject).e.invoke(((hs)localObject).d, new Object[] { Boolean.TRUE });
      }
      ...
      if (localObject != null)
      {
        paramMenuItem.setActionView((View)a((String)localObject, hf.a, hf.this.c));
        i1 = 1;
      }
      i2 = this.y;
      if ((i2 > 0) && (i1 == 0)) {
      ...
      localObject = this.b;
      if (localObject != null) {
        eq.a(paramMenuItem, (em)localObject);
      }
      eq.a(paramMenuItem, this.C);
      eq.b(paramMenuItem, this.D);
      eq.b(paramMenuItem, this.p, this.q);
      eq.a(paramMenuItem, this.r, this.s);
      localObject = this.F;
      if (localObject != null) {
        eq.a(paramMenuItem, (PorterDuff.Mode)localObject);
      }
      localObject = this.E;
      if (localObject != null) {
        eq.a(paramMenuItem, (ColorStateList)localObject);
      }
    }
    ...
    {
      paramAttributeSet = hf.this.e.obtainStyledAttributes(paramAttributeSet, gs.j.MenuGroup);
      this.e = paramAttributeSet.getResourceId(gs.j.MenuGroup_android_id, 0);
      this.f = paramAttributeSet.getInt(gs.j.MenuGroup_android_menuCategory, 0);
      this.g = paramAttributeSet.getInt(gs.j.MenuGroup_android_orderInCategory, 0);
      this.h = paramAttributeSet.getInt(gs.j.MenuGroup_android_checkableBehavior, 0);
      this.i = paramAttributeSet.getBoolean(gs.j.MenuGroup_android_visible, true);
      this.j = paramAttributeSet.getBoolean(gs.j.MenuGroup_android_enabled, true);
