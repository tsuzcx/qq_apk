  ...
  extends bv
{
  ...
  public static bw a(Resources paramResources, int paramInt, Resources.Theme paramTheme)
  {
    Object localObject;
    if (Build.VERSION.SDK_INT >= 24)
    {
      ...
      ((bw)localObject).b = paramResources;
      ((bw)localObject).h = new g(((bw)localObject).b.getConstantState());
      return localObject;
    }
    try
    {
  ...
  public static bw a(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    bw localbw = new bw();
    localbw.inflate(paramResources, paramXmlPullParser, paramAttributeSet, paramTheme);
    return localbw;
  }
  ...
  private void b(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    ...
    for (int m = 1; (i1 != 1) && ((paramXmlPullParser.getDepth() >= i2 + 1) || (i1 != 3)); m = n)
    {
      if (i1 == 2)
      {
        ...
        {
          localObject = new b();
          localTypedArray = db.a(paramResources, paramTheme, paramAttributeSet, bo.c);
        ...
        {
          localObject = new a();
          if (db.a(paramXmlPullParser, "pathData"))
          {
            localTypedArray = db.a(paramResources, paramTheme, paramAttributeSet, bo.d);
        ...
        else
        {
          ...
          {
            localObject = new c();
            localTypedArray = db.a(paramResources, paramTheme, paramAttributeSet, bo.b);
            ((c)localObject).l = null;
            ((c)localObject).c = db.a(localTypedArray, paramXmlPullParser, "rotation", 5, ((c)localObject).c);
            ((c)localObject).d = localTypedArray.getFloat(1, ((c)localObject).d);
            ((c)localObject).e = localTypedArray.getFloat(2, ((c)localObject).e);
            ((c)localObject).f = db.a(localTypedArray, paramXmlPullParser, "scaleX", 3, ((c)localObject).f);
            ((c)localObject).g = db.a(localTypedArray, paramXmlPullParser, "scaleY", 4, ((c)localObject).g);
            ((c)localObject).h = db.a(localTypedArray, paramXmlPullParser, "translateX", 6, ((c)localObject).h);
            ((c)localObject).i = db.a(localTypedArray, paramXmlPullParser, "translateY", 7, ((c)localObject).i);
  ...
  public final void inflate(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    ...
    f localf1 = this.c;
    localf1.b = new e();
    TypedArray localTypedArray = db.a(paramResources, paramTheme, paramAttributeSet, bo.a);
    f localf2 = this.c;
    e locale = localf2.b;
    int m = db.a(localTypedArray, paramXmlPullParser, "tintMode", 6, -1);
    ...
    if (db.a(paramXmlPullParser, "autoMirrored")) {
      bool = localTypedArray.getBoolean(5, bool);
    }
    localf2.e = bool;
    locale.d = db.a(localTypedArray, paramXmlPullParser, "viewportWidth", 7, locale.d);
    locale.e = db.a(localTypedArray, paramXmlPullParser, "viewportHeight", 8, locale.e);
    if (locale.d > 0.0F)
    {
      if (locale.e > 0.0F)
      {
        ...
        if (locale.b > 0.0F)
        {
          if (locale.c > 0.0F)
          {
            locale.setAlpha(db.a(localTypedArray, paramXmlPullParser, "alpha", 4, locale.getAlpha()));
    ...
    extends bw.d
  {
    ...
    final void a(TypedArray paramTypedArray, XmlPullParser paramXmlPullParser)
    {
      ...
      if (localObject != null) {
        this.m = dd.b((String)localObject);
      }
      this.c = db.b(paramTypedArray, paramXmlPullParser, "fillColor", 1, this.c);
      this.f = db.a(paramTypedArray, paramXmlPullParser, "fillAlpha", 12, this.f);
      int m = db.a(paramTypedArray, paramXmlPullParser, "strokeLineCap", 8, -1);
      localObject = this.j;
      switch (m)
      {
      default: 
      ...
      m = db.a(paramTypedArray, paramXmlPullParser, "strokeLineJoin", 9, -1);
      localObject = this.k;
      switch (m)
      {
      default: 
      ...
      this.l = db.a(paramTypedArray, paramXmlPullParser, "strokeMiterLimit", 10, this.l);
      this.a = db.b(paramTypedArray, paramXmlPullParser, "strokeColor", 3, this.a);
      this.d = db.a(paramTypedArray, paramXmlPullParser, "strokeAlpha", 11, this.d);
      this.b = db.a(paramTypedArray, paramXmlPullParser, "strokeWidth", 4, this.b);
      this.h = db.a(paramTypedArray, paramXmlPullParser, "trimPathEnd", 6, this.h);
      this.i = db.a(paramTypedArray, paramXmlPullParser, "trimPathOffset", 7, this.i);
      this.g = db.a(paramTypedArray, paramXmlPullParser, "trimPathStart", 5, this.g);
      this.e = db.a(paramTypedArray, paramXmlPullParser, "fillType", 13, this.e);
    }
  ...
  static final class c
  {
    ...
    public c(c paramc, dy<String, Object> paramdy)
    {
      this.c = paramc.c;
      this.d = paramc.d;
      this.e = paramc.e;
      ...
      while (n < ((ArrayList)localObject).size())
      {
        ...
        {
          paramc = (c)paramc;
          this.b.add(new c(paramc, paramdy));
        }
        else
        {
          if ((paramc instanceof bw.b))
          {
            paramc = new bw.b((bw.b)paramc);
          }
          else
          {
            if (!(paramc instanceof bw.a)) {
              break label317;
            }
            paramc = new bw.a((bw.a)paramc);
          }
          this.b.add(paramc);
          if (paramc.n != null) {
            paramdy.put(paramc.n, paramc);
          }
        }
        n += 1;
        continue;
  ...
  static class d
  {
    ...
    public d(d paramd)
    {
      this.n = paramd.n;
      this.o = paramd.o;
      this.m = dd.a(paramd.m);
    }
    
    public final void a(Path paramPath)
    {
      paramPath.reset();
      dd.b[] arrayOfb = this.m;
      if (arrayOfb != null) {
        dd.b.a(arrayOfb, paramPath);
      }
    }
    ...
    public void setPathData(dd.b[] paramArrayOfb)
    {
      if (!dd.a(this.m, paramArrayOfb))
      {
        this.m = dd.a(paramArrayOfb);
        return;
      }
      dd.b[] arrayOfb = this.m;
      int i = 0;
  ...
  static final class e
  {
    ...
    int f = 255;
    String g = null;
    final dy<String, Object> h = new dy();
    ...
    public e(e parame)
    {
      this.a = new bw.c(parame.a, this.h);
    ...
    private void a(bw.c paramc, Matrix paramMatrix, Canvas paramCanvas, int paramInt1, int paramInt2, ColorFilter paramColorFilter)
    {
      ...
      while (i1 < paramc.b.size())
      {
        ...
        if ((localObject1 instanceof bw.c))
        {
          a((bw.c)localObject1, paramc.a, paramCanvas, paramInt1, paramInt2, paramColorFilter);
        }
        else if ((localObject1 instanceof bw.d))
        {
          Object localObject2 = (bw.d)localObject1;
          ...
          {
            localObject1 = this;
            ((bw.d)localObject2).a(((e)localObject1).i);
            paramMatrix = ((e)localObject1).i;
            ((e)localObject1).j.reset();
            if (((bw.d)localObject2).a())
            {
            ...
            {
              localObject2 = (bw.b)localObject2;
              if ((((bw.b)localObject2).g != 0.0F) || (((bw.b)localObject2).h != 1.0F))
              {
                f6 = ((bw.b)localObject2).g;
                f7 = ((bw.b)localObject2).i;
                f4 = ((bw.b)localObject2).h;
                f5 = ((bw.b)localObject2).i;
              ...
              if (((bw.b)localObject2).c != 0)
              {
                ...
                localPaint.setColor(bw.a(((bw.b)localObject2).c, ((bw.b)localObject2).f));
                localPaint.setColorFilter(paramColorFilter);
                Path localPath = ((e)localObject1).j;
                if (((bw.b)localObject2).e == 0) {
              ...
              if (((bw.b)localObject2).a != 0)
              {
                ...
                if (((bw.b)localObject2).k != null) {
                  paramMatrix.setStrokeJoin(((bw.b)localObject2).k);
                }
                if (((bw.b)localObject2).j != null) {
                  paramMatrix.setStrokeCap(((bw.b)localObject2).j);
                }
                paramMatrix.setStrokeMiter(((bw.b)localObject2).l);
                paramMatrix.setColor(bw.a(((bw.b)localObject2).a, ((bw.b)localObject2).d));
                paramMatrix.setColorFilter(paramColorFilter);
                paramMatrix.setStrokeWidth(((bw.b)localObject2).b * (f1 * f2));
    ...
    extends Drawable.ConstantState
  {
    ...
    public f(f paramf)
    {
      ...
      {
        this.a = paramf.a;
        this.b = new bw.e(paramf.b);
        if (bw.e.a(paramf.b) != null) {
          bw.e.a(this.b, new Paint(bw.e.a(paramf.b)));
        }
        if (bw.e.b(paramf.b) != null) {
          bw.e.b(this.b, new Paint(bw.e.b(paramf.b)));
        }
        this.c = paramf.c;
        this.d = paramf.d;
        this.e = paramf.e;
    ...
    extends Drawable.ConstantState
  {
    ...
    {
      bw localbw = new bw();
      localbw.b = ((VectorDrawable)this.a.newDrawable());
      return localbw;
    }
    ...
    {
      bw localbw = new bw();
      localbw.b = ((VectorDrawable)this.a.newDrawable(paramResources));
      return localbw;
    }
    ...
    {
      bw localbw = new bw();
      localbw.b = ((VectorDrawable)this.a.newDrawable(paramResources, paramTheme));
      return localbw;
    }
  }
}
