...
public final class adj
{
  ...
  static
  {
    StringBuilder localStringBuilder = aev.a("turingfd_conf_");
    localStringBuilder.append(afi.a);
    localStringBuilder.append("_baseFull");
    a = localStringBuilder.toString();
  }
  
  public adj(Handler paramHandler)
  {
    this.b = paramHandler;
  }
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      paramContext = aez.b(paramContext, aez.b());
  ...
  public static adb b(Context paramContext)
  {
  ...
  private static void b(Context paramContext, Map<String, String> paramMap)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      try
      {
        paramContext.putString(str1, aez.e(aez.a(str2.getBytes(), aez.b())));
      }
      catch (Throwable localThrowable)
      {
        break label99;
  ...
  public static aci<Long> f(Context paramContext)
  {
    System.currentTimeMillis();
    aci localaci = new aci(6);
  ...
  public final void a(Context paramContext, aci<Long> paramaci)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    int i = 0;
    while (i < paramaci.b.size())
    {
      localStringBuilder.append(paramaci.a(i));
      if (i != paramaci.b.size() - 1) {
