...
public final class iu
{
      ...
      for (;;)
      {
        try
        {
          if ((paramDrawable instanceof dm)) {
            localObject = ((dm)paramDrawable).a();
          }
  ...
  static void b(Drawable paramDrawable)
  {
    if ((Build.VERSION.SDK_INT == 21) && ("android.graphics.drawable.VectorDrawable".equals(paramDrawable.getClass().getName())))
    {
      ...
      if ((arrayOfInt != null) && (arrayOfInt.length != 0)) {
        paramDrawable.setState(je.h);
      } else {
        paramDrawable.setState(je.e);
      }
  ...
  public static boolean c(Drawable paramDrawable)
  {
    for (;;)
    {
      ...
      if ((paramDrawable instanceof dm))
      {
        paramDrawable = ((dm)paramDrawable).a();
      }
      else if ((paramDrawable instanceof gw))
      {
        paramDrawable = ((gw)paramDrawable).a;
      }
      else
      {
