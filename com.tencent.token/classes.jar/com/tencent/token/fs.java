  ...
  implements t
{
  ...
  private x a(z paramz, ab paramab)
  {
    ...
    do
    {
      ...
      } while ((!this.a.s()) || ((paramz.a().d() instanceof fu)) || ((paramz.g() != null) && (paramz.g().b() == 408)) || (a(paramz, 0) > 0));
      return paramz.a();
  ...
  private boolean a(IOException paramIOException, f paramf, boolean paramBoolean, x paramx)
  {
    ...
    if (!this.a.s()) {}
    while (((paramBoolean) && ((paramx.d() instanceof fu))) || (!a(paramIOException, paramBoolean)) || (!paramf.f())) {
      return false;
    }
    return true;
  }
  ...
  public z a(okhttp3.t.a parama)
  {
    ...
    //   60: aload_0
    //   61: aload_1
    //   62: putfield 278	com/tencent/token/fs:c	Lokhttp3/internal/connection/f;
    //   65: iconst_0
    //   66: istore_2
    //   67: aconst_null
    //   68: astore 5
    //   70: aload_0
    //   71: getfield 280	com/tencent/token/fs:e	Z
    //   74: ifeq +18 -> 92
    //   77: aload_1
    ...
    //   97: aconst_null
    //   98: aconst_null
    //   99: invokevirtual 288	com/tencent/token/fp:a	(Lokhttp3/x;Lokhttp3/internal/connection/f;Lcom/tencent/token/fl;Lokhttp3/internal/connection/c;)Lokhttp3/z;
    //   102: astore 6
    //   104: aload 6
    //   106: astore 4
    //   108: aload 5
    ...
    //   145: invokespecial 306	com/tencent/token/fs:a	(Lokhttp3/z;Lokhttp3/ab;)Lokhttp3/x;
    //   148: astore 6
    //   150: aload 6
    //   152: ifnonnull +97 -> 249
    //   155: aload_0
    //   156: getfield 24	com/tencent/token/fs:b	Z
    //   159: ifne +7 -> 166
    //   162: aload_1
    ...
    //   178: iconst_0
    //   179: aload 4
    //   181: invokespecial 311	com/tencent/token/fs:a	(Ljava/io/IOException;Lokhttp3/internal/connection/f;ZLokhttp3/x;)Z
    //   184: ifne -114 -> 70
    //   187: aload 6
    ...
    //   223: iload_3
    //   224: aload 4
    //   226: invokespecial 311	com/tencent/token/fs:a	(Ljava/io/IOException;Lokhttp3/internal/connection/f;ZLokhttp3/x;)Z
    //   229: ifne -159 -> 70
    //   232: aload 6
    //   234: athrow
    //   235: iconst_0
    ...
    //   254: invokestatic 323	com/tencent/token/fc:a	(Ljava/io/Closeable;)V
    //   257: iload_2
    //   258: iconst_1
    //   259: iadd
    //   260: istore_2
    ...
    //   338: invokespecial 204	com/tencent/token/fs:a	(Lokhttp3/z;Lokhttp3/s;)Z
    //   341: ifne +55 -> 396
    //   344: aload_1
    ...
    //   351: dup
    //   352: aload_0
    //   353: getfield 22	com/tencent/token/fs:a	Lokhttp3/v;
    //   356: invokevirtual 269	okhttp3/v:p	()Lokhttp3/j;
    //   359: aload_0
    //   360: aload 6
    //   362: invokevirtual 169	okhttp3/x:a	()Lokhttp3/s;
    //   365: invokespecial 271	com/tencent/token/fs:a	(Lokhttp3/s;)Lokhttp3/a;
    //   368: aload 8
    //   370: aload 9
    //   372: aload_0
    //   373: getfield 273	com/tencent/token/fs:d	Ljava/lang/Object;
    //   376: invokespecial 276	okhttp3/internal/connection/f:<init>	(Lokhttp3/j;Lokhttp3/a;Lokhttp3/e;Lokhttp3/p;Ljava/lang/Object;)V
    //   379: astore_1
    //   380: aload_0
    //   381: aload_1
    //   382: putfield 278	com/tencent/token/fs:c	Lokhttp3/internal/connection/f;
    //   385: aload 4
    //   387: astore 5
    //   389: aload 6
    //   391: astore 4
    //   393: goto -323 -> 70
    //   396: aload_1
    //   397: invokevirtual 348	okhttp3/internal/connection/f:a	()Lcom/tencent/token/fl;
    //   400: ifnull +38 -> 438
