  ...
  implements bx
{
  ...
  private static ArrayList a(ArrayList paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    {
      bg localbg = (bg)paramArrayList.get(paramInt1);
      localArrayList.add(new bg(localbg.a(), localbg.b()));
      paramInt1 += 1;
    }
  ...
  public final void a()
  {
    ...
    if ((this.e == null) || (this.e.size() <= 0))
    {
      ...
      label33:
      this.j = bool;
      c.a("SocketConnectorImpl", "doConnect...");
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          this.q = new bg(this.l.getInetAddress().getHostAddress(), this.l.getPort());
          this.m = 0;
          return;
          bool = false;
          break;
          ...
          if (!this.g)
          {
            ...
            this.l = bt.a((ArrayList)localObject, this.c);
            this.o = 0;
            this.p = ((int)(System.currentTimeMillis() - l1));
            c.a("SocketConnectorImpl", "use IpList, dnsTime: 0 ,connectTime：" + this.p);
          }
          else
          {
            ...
            {
              label437:
              localObject = bt.a((ArrayList)localObject, this.k, this.c);
              if (localObject != null) {
                this.l = ((bs)localObject).c();
              }
              this.o = bt.a;
              this.p = bt.b;
              c.a("SocketConnectorImpl", "use IpList DNS parallel , dnsTime:" + this.o + ",connectTime：" + this.p);
              break;
              label519:
              this.j = true;
              localObject = localArrayList;
