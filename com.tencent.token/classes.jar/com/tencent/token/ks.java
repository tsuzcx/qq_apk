...
public final class ks
{
  ...
  public static ks a(String paramString1, String paramString2)
  {
    if (TextUtils.isEmpty(paramString2)) {
      return null;
    }
    ks localks = new ks();
    localks.c = paramString1;
    try
    {
      paramString2 = new JSONObject(paramString2);
      if (paramString2.has("pkglist")) {
        localks.e = b(paramString2.getString("pkglist"));
      }
      if (paramString2.has("mode")) {
        localks.d = paramString2.getInt("mode");
      }
      if (paramString2.has("img1")) {
        localks.f = paramString2.getString("img1");
      }
      if (paramString2.has("img2")) {
        localks.g = paramString2.getString("img2");
      }
      if (paramString2.has("img3")) {
        localks.h = paramString2.getString("img3");
      }
      if (paramString2.has("text1")) {
        localks.i = paramString2.getString("text1");
      }
      if (paramString2.has("text2")) {
        localks.j = paramString2.getString("text2");
      }
      if (paramString2.has("text3")) {
        localks.k = paramString2.getString("text3");
      }
      if (paramString2.has("text4")) {
        localks.l = paramString2.getString("text4");
      }
      if (paramString2.has("text5")) {
        localks.m = paramString2.getString("text5");
      }
      if (paramString2.has("text6")) {
        localks.n = paramString2.getString("text6");
      }
      if (paramString2.has("text7")) {
        localks.o = paramString2.getString("text7");
      }
      if (paramString2.has("text8")) {
        localks.p = paramString2.getString("text8");
      }
      if (paramString2.has("lastpkg")) {
        localks.q = paramString2.getString("lastpkg");
      }
      if (paramString2.has("interval")) {
        localks.s = paramString2.getInt("interval");
      }
      if (paramString2.has("begin")) {
        localks.t = paramString2.getLong("begin");
      }
      if (paramString2.has("end")) {
        localks.u = paramString2.getLong("end");
      }
      paramString1 = localks;
      if (paramString2.has("timestamp"))
      {
        localks.r = paramString2.getLong("timestamp");
        return localks;
      }
    }
  ...
  public final ku a(Context paramContext, HashSet<String> paramHashSet)
  {
    int i1 = a;
    int i2 = this.d;
    ...
    if (i1 == i2)
    {
      ...
      } while (((paramHashSet != null) && (paramHashSet.contains(localObject))) || (yz.b(paramContext, (String)localObject)));
    ...
    else
    {
      if (b == i2)
      {
        ...
        {
          String str = (String)localIterator.next();
          if (((paramHashSet == null) || (!paramHashSet.contains(str))) && (!yz.b(paramContext, str))) {
  ...
  public final void a(String paramString)
  {
    ...
    if ((paramString != null) && (!TextUtils.isEmpty(this.c))) {
      afr.b(this.c, paramString.toString());
    }
  }
