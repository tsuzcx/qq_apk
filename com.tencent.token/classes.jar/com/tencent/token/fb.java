...
public final class fb
{
  ...
  public static String a(s params, boolean paramBoolean)
  {
    ...
    for (String str1 = "[" + params.f() + "]";; str1 = params.f())
    {
      String str2;
      if (!paramBoolean)
      {
  ...
  public static ThreadFactory a(String paramString, final boolean paramBoolean)
  {
    new ThreadFactory()
    {
      ...
      {
        paramAnonymousRunnable = new Thread(paramAnonymousRunnable, fb.this);
  ...
  public static boolean b(q paramq, int paramInt, TimeUnit paramTimeUnit)
  {
    ...
    for (;;)
    {
      paramq.a().a(Math.min(l1, paramTimeUnit.toNanos(paramInt)) + l2);
      try
      {
        paramTimeUnit = new c();
        while (paramq.a(paramTimeUnit, 8192L) != -1L) {
          paramTimeUnit.r();
        }
      }
