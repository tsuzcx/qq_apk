...
public class cr
{
  public static final dq b = new dq("", 16);
  public static String c = null;
  public static String d = null;
  public static String e = null;
  public static String f = null;
  public static String g = null;
  private static cr p = null;
  public byte[] a = null;
  public long h = 0L;
  public long i = 0L;
  ...
  private String b(String paramString, long paramLong)
  {
    cc localcc = cc.c();
    localcc.m();
    String str = localcc.o();
    try
    {
      long l1 = Long.parseLong(paramString);
      paramString = new JSONObject();
      paramString.put("uin", l1);
      paramString.put("tkn_seq", String.valueOf(localcc.k()));
  ...
  private e c(e parame)
  {
    ...
    if (!((cr)localObject3).o()) {
      if (!((cr)localObject3).p())
      {
        localObject2 = ((cr)localObject3).q();
      ...
      else
      {
        ...
        {
          return localObject2;
          localObject1 = ((cr)localObject3).u();
          localObject2 = localObject1;
        } while (!((e)localObject1).b());
      }
    }
    Object localObject2 = ((cr)localObject3).e();
    ...
    {
      localObject3 = cc.c();
      localObject5 = ((cc)localObject3).o();
      localObject4 = ca.a().b();
    ...
    cb.a = i1;
    this.o = i1;
    Object localObject5 = l.a(new Object[] { "tkn_code", localObject5, "ksid", ((cc)localObject3).h(), "channel_id", l.m(), "seq_id", Integer.valueOf(this.o), "op_time", Long.valueOf(cc.c().s() / 1000L) });
    ...
    localObject4 = new ez();
    localObject5 = ((ez)localObject4).a((String)localObject5);
    if (localObject5 == null)
    {
      ((e)localObject1).a(((ez)localObject4).a());
      return localObject1;
    }
    for (;;)
    {
      ...
      if (((cc)localObject3).h().length() == 0) {
        ((cc)localObject3).c(parame.optString("ksid"));
      }
      ((e)localObject1).c();
    }
  }
  ...
  private byte[] c(String paramString)
  {
    try
    {
      paramString = new a().a(cj.a(paramString), this.a);
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  public e a(String paramString, long paramLong)
  {
    ...
    byte[] arrayOfByte = ((ez)localObject).a(str);
    if (arrayOfByte == null)
    {
  ...
  public e a(org.json.JSONArray paramJSONArray)
  {
    ...
    //   237: pop
    //   238: aload_0
    //   239: getfield 85	com/tencent/token/cr:l	Lcom/tencent/token/eq;
    //   242: aload 5
    //   244: invokevirtual 554	com/tencent/token/eq:a	(Ljava/util/List;)V
    //   247: aload 4
  ...
  {
    // Byte code:
    //   0: getstatic 270	com/tencent/token/cb:a	I
    //   3: iconst_1
    //   4: iadd
    //   5: istore 4
    //   7: iload 4
    //   9: putstatic 270	com/tencent/token/cb:a	I
    ...
    //   29: pop
    //   30: getstatic 270	com/tencent/token/cb:a	I
    //   33: iconst_1
    //   34: iadd
    //   35: istore_3
    //   36: iload_3
    //   37: putstatic 270	com/tencent/token/cb:a	I
    //   40: aload 5
    //   42: ldc_w 282
    //   45: iload_3
    ...
    //   50: aload 5
    //   52: ldc_w 289
    //   55: invokestatic 113	com/tencent/token/cc:c	()Lcom/tencent/token/cc;
    //   58: invokevirtual 291	com/tencent/token/cc:s	()J
    //   61: ldc2_w 292
    //   64: ldiv
    ...
    //   129: getstatic 53	com/tencent/token/cr:c	Ljava/lang/String;
    ...
    //   175: astore_1
    //   176: new 318	com/tencent/token/ez
    //   179: dup
    //   180: invokespecial 319	com/tencent/token/ez:<init>	()V
    //   183: aload_1
    //   184: invokevirtual 322	com/tencent/token/ez:a	(Ljava/lang/String;)[B
    //   187: astore_1
    //   188: aload_1
    ...
    //   350: invokestatic 635	com/tencent/token/cb:a	()Lcom/tencent/token/cb;
    //   353: invokevirtual 637	com/tencent/token/cb:b	()I
  ...
  public e q()
  {
    ...
    //   8: aload_0
    //   9: invokespecial 715	com/tencent/token/cr:w	()V
    //   12: aload_0
    //   13: invokevirtual 243	com/tencent/token/cr:p	()Z
    //   16: ifne +21 -> 37
    //   19: aload_0
    //   20: invokevirtual 442	com/tencent/token/cr:s	()Lcom/tencent/token/global/e;
    //   23: astore_2
    //   24: aload_2
    ...
    //   36: areturn
    //   37: aload_0
    //   38: invokevirtual 251	com/tencent/token/cr:u	()Lcom/tencent/token/global/e;
    //   41: astore_3
    //   42: aload_3
    //   43: astore_2
    //   44: aload_3
    ...
    //   48: ifeq -15 -> 33
    //   51: aload_0
    //   52: invokevirtual 241	com/tencent/token/cr:o	()Z
  ...
  public e u()
  {
    ...
    //   8: ldc_w 742
    //   11: ldc_w 744
    //   14: invokestatic 551	android/util/Log:i	(Ljava/lang/String;Ljava/lang/String;)I
    //   17: pop
    //   18: new 233	com/tencent/token/global/e
    //   21: dup
    //   22: invokespecial 234	com/tencent/token/global/e:<init>	()V
    //   25: astore_1
    //   26: invokestatic 113	com/tencent/token/cc:c	()Lcom/tencent/token/cc;
    //   29: astore_2
    //   30: aload_2
    //   31: invokevirtual 115	com/tencent/token/cc:m	()V
    //   34: aload_2
    //   35: invokevirtual 118	com/tencent/token/cc:o	()Ljava/lang/String;
    //   38: astore_2
    //   39: aload_2
    //   40: ifnull +20 -> 60
    //   43: aload_2
    //   44: invokevirtual 381	java/lang/String:length	()I
    //   47: ifeq +13 -> 60
    //   50: aload_2
    //   51: ldc_w 746
    //   54: invokevirtual 749	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   57: ifeq +16 -> 73
    //   60: aload_1
    //   61: bipush 106
    //   63: ldc_w 751
    //   66: invokevirtual 358	com/tencent/token/global/e:a	(ILjava/lang/String;)V
    //   69: aload_0
    //   70: monitorexit
    //   71: aload_1
    //   72: areturn
    //   73: invokestatic 734	com/tencent/token/bv:a	()Lcom/tencent/token/bv;
    //   76: invokevirtual 753	com/tencent/token/bv:c	()Lcom/tencent/token/global/e;
    //   79: astore_1
    //   80: goto -11 -> 69
    //   83: astore_1
    //   84: aload_0
