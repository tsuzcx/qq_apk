...
public class cr
{
  ...
  private String b(String paramString, long paramLong)
  {
    ...
    ((cc)localObject).m();
    String str = ((cc)localObject).o();
    try
    {
      long l1 = Long.parseLong(paramString);
      paramString = new JSONObject();
      paramString.put("uin", l1);
      paramString.put("tkn_seq", String.valueOf(((cc)localObject).k()));
  ...
  private e c(e parame)
  {
    ...
    if (!((cr)localObject3).o()) {
      ...
      {
        localObject2 = ((cr)localObject3).u();
        localObject1 = localObject2;
        if (!((e)localObject2).b()) {
          return localObject2;
        }
    ...
    {
      localObject3 = cc.c();
      Object localObject5 = ((cc)localObject3).o();
      ...
      cb.a = i1;
      this.o = i1;
      localObject5 = l.a(new Object[] { "tkn_code", localObject5, "ksid", ((cc)localObject3).h(), "channel_id", l.m(), "seq_id", Integer.valueOf(this.o), "op_time", Long.valueOf(cc.c().s() / 1000L) });
      StringBuilder localStringBuilder = new StringBuilder();
      ...
      try
      {
        ...
        else
        {
          ...
          else
          {
            ...
            ((e)localObject1).a(10022, RqdApplication.l().getString(2131493067), RqdApplication.l().getString(2131493067));
          }
        }
      }
  ...
  public e a(String paramString, long paramLong)
  {
    ...
    ((cr)localObject1).n();
    localObject1 = ((cr)localObject1).s();
    if (!((e)localObject1).b()) {
      return localObject1;
    }
    localObject1 = new ez();
    ...
    ((StringBuilder)localObject2).append(str);
    str = ((StringBuilder)localObject2).toString();
    localObject2 = ((ez)localObject1).a(str);
    if (localObject2 == null)
    {
  ...
  public e a(org.json.JSONArray paramJSONArray)
  {
    ...
    //   274: pop
    //   275: aload_0
    //   276: getfield 85	com/tencent/token/cr:l	Lcom/tencent/token/eq;
    //   279: aload 7
    //   281: invokevirtual 554	com/tencent/token/eq:a	(Ljava/util/List;)V
    //   284: aload 6
  ...
  public String a(long paramLong, String paramString)
  {
    try
    {
      ...
      ((JSONObject)localObject).put("turingd_ticket_id", k.c());
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    paramString2.append(paramString1);
    paramString1 = paramString2.toString();
    paramString1 = new ez().a(paramString1);
