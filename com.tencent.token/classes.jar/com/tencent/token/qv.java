...
public final class qv
{
  ...
  private void b(Context paramContext)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: invokestatic 33	com/tencent/token/rc:a	(Landroid/content/Context;)Lcom/tencent/token/rc;
    //   6: pop
    //   7: aload_0
    //   8: getfield 19	com/tencent/token/qv:a	[B
    //   11: ifnonnull +323 -> 334
    //   14: invokestatic 38	com/tencent/token/qw$a:a	()Lcom/tencent/token/qw;
    //   17: ldc 40
    //   19: invokevirtual 45	com/tencent/token/qw:a	(Ljava/lang/String;)Lcom/tencent/token/aud;
    //   22: ldc 47
    //   24: ldc 49
    //   26: invokeinterface 54 3 0
    //   31: astore_3
    //   32: invokestatic 38	com/tencent/token/qw$a:a	()Lcom/tencent/token/qw;
    //   35: ldc 40
    //   37: invokevirtual 45	com/tencent/token/qw:a	(Ljava/lang/String;)Lcom/tencent/token/aud;
    //   40: ldc 56
    //   42: ldc 49
    ...
    //   67: ifeq +171 -> 238
    //   70: aload_1
    //   71: invokestatic 67	com/tencent/token/apx:a	(Landroid/content/Context;)Ljava/lang/String;
    //   74: astore_3
    //   75: aload_3
    ...
    //   117: pop
    //   118: invokestatic 103	com/tencent/token/apz:b	()V
    //   121: aload 4
    //   123: astore_3
    //   124: aload 4
    ...
    //   199: pop
    //   200: invokestatic 103	com/tencent/token/apz:b	()V
    //   203: invokestatic 38	com/tencent/token/qw$a:a	()Lcom/tencent/token/qw;
    //   206: ldc 40
    //   208: invokevirtual 45	com/tencent/token/qw:a	(Ljava/lang/String;)Lcom/tencent/token/aud;
    //   211: ldc 47
    //   213: aload_3
    //   214: invokeinterface 121 3 0
    //   219: pop
    //   220: invokestatic 38	com/tencent/token/qw$a:a	()Lcom/tencent/token/qw;
    //   223: ldc 40
    //   225: invokevirtual 45	com/tencent/token/qw:a	(Ljava/lang/String;)Lcom/tencent/token/aud;
    //   228: ldc 56
    //   230: aload 4
    ...
    //   252: putfield 19	com/tencent/token/qv:a	[B
    //   255: new 107	java/lang/StringBuilder
    //   258: dup
    //   259: ldc 133
    //   261: invokespecial 112	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   264: aload_0
    //   265: getfield 19	com/tencent/token/qv:a	[B
    //   268: invokevirtual 136	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   271: pop
    //   272: invokestatic 103	com/tencent/token/apz:b	()V
    //   275: aload_0
    //   276: getfield 19	com/tencent/token/qv:a	[B
    //   279: ifnull +11 -> 290
    //   282: aload_0
    //   283: getfield 19	com/tencent/token/qv:a	[B
    //   286: arraylength
    //   287: ifne +47 -> 334
    //   290: invokestatic 103	com/tencent/token/apz:b	()V
    //   293: aload_0
    //   294: invokestatic 38	com/tencent/token/qw$a:a	()Lcom/tencent/token/qw;
    //   297: invokevirtual 139	com/tencent/token/qw:c	()Lcom/tencent/token/aug;
    //   300: ldc 141
    //   302: invokevirtual 125	java/lang/String:getBytes	()[B
    //   305: aconst_null
    //   306: invokeinterface 146 3 0
    //   311: putfield 19	com/tencent/token/qv:a	[B
    //   314: new 107	java/lang/StringBuilder
    //   317: dup
    //   318: ldc 148
    //   320: invokespecial 112	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   323: aload_0
    //   324: getfield 19	com/tencent/token/qv:a	[B
    //   327: invokevirtual 136	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   330: pop
    //   331: invokestatic 103	com/tencent/token/apz:b	()V
    //   334: aload_0
    //   335: monitorexit
    //   336: return
    //   337: astore_1
  ...
  private void c(Context paramContext)
  {
    ...
    {
      apz.b();
      this.b = qw.a.a().c().a("*M<>DFG##%$R(&$G%^HR<".getBytes(), null);
  ...
  public final byte[] a(Context paramContext, byte[] paramArrayOfByte)
  {
    ...
    {
      paramContext = this.a;
      paramContext = qw.a.a().c().a(paramArrayOfByte, paramContext);
      return paramContext;
    }
    catch (Throwable paramContext)
    {
  ...
  public final byte[] a(Context paramContext, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      paramContext = qw.a.a().c().b(paramArrayOfByte, paramContext);
      return paramContext;
    }
    catch (Throwable paramContext)
    {
  ...
  {
    private static final qv a = new qv((byte)0);
  }
}
