...
{
  en(FacePwdIndexActivity paramFacePwdIndexActivity) {}
  ...
  public final void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    if (FacePwdIndexActivity.access$500(this.a).size() > 0)
    {
      if (FacePwdIndexActivity.access$500(this.a).size() == 1)
      {
        ...
        t.b(((QQUser)FacePwdIndexActivity.access$500(this.a).get(0)).mRealUin);
        this.a.refreshList();
        return;
      }
      FacePwdIndexActivity.access$002(this.a, true);
      FacePwdIndexActivity.access$100(this.a).a(false, false);
      paramCompoundButton = new FacePwdVerifySelDialog(this.a, FacePwdIndexActivity.access$500(this.a));
