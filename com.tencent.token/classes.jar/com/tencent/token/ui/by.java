...
{
  by(CheckMobileAvailableActivity paramCheckMobileAvailableActivity) {}
  ...
  public final void onClick(View paramView)
  {
    if (CheckMobileAvailableActivity.access$200(this.a) == 0)
    {
      ...
      af.a().a("", CheckMobileAvailableActivity.access$300(this.a).mRealUin, 1, 1, "", CheckMobileAvailableActivity.access$900(this.a));
    }
    do
    {
      return;
      ...
      if (CheckMobileAvailableActivity.access$200(this.a) == 6)
      {
        this.a.startTimeTask();
        this.a.showProgressDialog();
        af.a().a("", CheckMobileAvailableActivity.access$800(this.a), 1, 3, "", CheckMobileAvailableActivity.access$900(this.a));
        return;
      }
    } while (CheckMobileAvailableActivity.access$200(this.a) != 7);
    this.a.startTimeTask();
    this.a.showProgressDialog();
    af.a().a("", CheckMobileAvailableActivity.access$800(this.a), 1, 5, "", CheckMobileAvailableActivity.access$900(this.a));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.token\classes.jar
 * Qualified Name:     com.tencent.token.ui.by
