...
{
  bn(bh parambh, UpgradeDeterminResult paramUpgradeDeterminResult, QQUser paramQQUser) {}
  ...
  public final void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (i = j;; i = 0)
      {
        ...
        paramView = new Intent(bh.a(this.c), NetActiveVryOtherListActivity.class);
        paramView.putExtra("intent.qquser", this.b);
        paramView.putExtra("page_id", 7);
        paramView.putExtra("intent.upgradedetermin", this.a);
        bh.a(this.c).startActivity(paramView);
