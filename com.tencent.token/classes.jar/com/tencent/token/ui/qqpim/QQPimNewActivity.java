  ...
  implements View.OnClickListener
{
  ...
  private BroadcastReceiver mNetworkMsgReceiver = new BroadcastReceiver()
  {
    public final void onReceive(Context paramAnonymousContext, Intent paramAnonymousIntent)
    {
      ...
      if (paramAnonymousContext != null)
      {
        ...
        {
          paramAnonymousContext = zo.m(QQPimNewActivity.this);
          if ((zo.a()) && ("WIFI".equals(paramAnonymousContext)))
          {
      ...
      public final void a()
      {
        ...
        QQPimNewActivity.this.runOnUiThread(new Runnable()
        {
          public final void run()
          {
            ...
            yz.a(QQPimNewActivity.this, QQPimNewActivity.this.filePath);
  ...
  {
    this.qqpimBackNew = ((FrameLayout)findViewById(2131165858));
    this.tvQqpimDownload = ((TextView)findViewById(2131166184));
    this.qqpimFlProgressNew = ((FrameLayout)findViewById(2131165860));
    this.qqpimPbDownloadProgressNew = ((ProgressBar)findViewById(2131165862));
    this.qqpimTvProgressChangeNew = ((ProgressTextView)findViewById(2131165864));
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    aae.a(this, this.mTitleBar, 2130968665);
    initView();
    registReceiver();
