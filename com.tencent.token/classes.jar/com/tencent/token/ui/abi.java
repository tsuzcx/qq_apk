...
public class abi
{
  ...
  private void a(Activity paramActivity, DeterminVerifyFactorsResult paramDeterminVerifyFactorsResult, QQUser paramQQUser, DeterminVerifyFactorsResult.VerifyTypeItem paramVerifyTypeItem, int paramInt, boolean paramBoolean, Handler paramHandler)
  {
    ...
    case 1: 
      ...
      {
        cw.a().b(paramQQUser.mRealUin, paramVerifyTypeItem.a(), "", "", paramHandler);
        this.b = null;
        return;
      }
  ...
  private void a(DeterminVerifyFactorsResult paramDeterminVerifyFactorsResult, QQUser paramQQUser, DeterminVerifyFactorsResult.VerifyTypeItem paramVerifyTypeItem, int paramInt, boolean paramBoolean, Activity paramActivity, Class paramClass)
  {
    ...
    this.c.postDelayed(new abj(this, paramActivity, paramClass, paramQQUser, paramDeterminVerifyFactorsResult, paramVerifyTypeItem, paramInt, paramBoolean), 10L);
  }
 ...
 * Qualified Name:     com.tencent.token.ui.abi
