  ...
  extends de
{
  ...
  /* Error */
  public android.graphics.Typeface a(android.content.Context paramContext, ds.b[] paramArrayOfb, int paramInt)
  {
    // Byte code:
    //   0: aload_2
    //   1: arraylength
    ...
    //   8: aload_2
    //   9: iload_3
    //   10: invokevirtual 67	com/tencent/token/db:a	([Lcom/tencent/token/ds$b;I)Lcom/tencent/token/ds$b;
    //   13: astore_2
    //   14: aload_1
    ...
    //   20: aload 4
    //   22: aload_2
    //   23: getfield 78	com/tencent/token/ds$b:a	Landroid/net/Uri;
    //   26: ldc 80
    //   28: aconst_null
    ...
    //   32: astore 4
    //   34: aload 4
    //   36: invokestatic 88	com/tencent/token/db:a	(Landroid/os/ParcelFileDescriptor;)Ljava/io/File;
    //   39: astore_2
    //   40: aload_2
    //   41: ifnull +30 -> 71
    //   44: aload_2
    ...
    //   85: aload_1
    //   86: aload 5
    //   88: invokestatic 113	com/tencent/token/de:a	(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    //   91: astore_1
    //   92: aload 5
