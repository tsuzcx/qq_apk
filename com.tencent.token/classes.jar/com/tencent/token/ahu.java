...
public final class ahu
{
  ...
  private ahu(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, int paramInt3, int paramInt4, boolean paramBoolean6, boolean paramBoolean7, boolean paramBoolean8, @Nullable String paramString)
  {
  ...
  public static ahu a(aih paramaih)
  {
    int i8 = paramaih.a.length / 2;
    int i7 = 0;
    int i2 = 1;
    ...
    for (;;)
    {
      Object localObject2 = paramaih;
      if (i7 >= i8) {
        break;
      }
      String str2 = ((aih)localObject2).a(i7);
      String str1 = ((aih)localObject2).b(i7);
      ...
      while (i1 < str1.length())
      {
        ...
        if ("no-cache".equalsIgnoreCase(str2)) {
          ...
          i6 = ajn.b((String)localObject2, -1);
        } else if ("s-maxage".equalsIgnoreCase(str2)) {
          i5 = ajn.b((String)localObject2, -1);
          ...
          i4 = ajn.b((String)localObject2, 2147483647);
        } else if ("min-fresh".equalsIgnoreCase(str2)) {
          i3 = ajn.b((String)localObject2, -1);
    ...
    return new ahu(bool5, bool7, i6, i5, bool8, bool6, bool4, i4, i3, bool3, bool2, bool1, localObject1);
  }
