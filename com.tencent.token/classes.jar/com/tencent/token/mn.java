  ...
  extends ThreadPoolExecutor
{
  ...
  public mn(int paramInt1, int paramInt2, TimeUnit paramTimeUnit, BlockingQueue paramBlockingQueue, ThreadFactory paramThreadFactory)
  {
  ...
  public final void a()
  {
    if (b())
    {
      ...
      if (this.d + l < System.currentTimeMillis())
      {
        ...
        Thread.currentThread().setUncaughtExceptionHandler(new mo());
  ...
  {
    return (this.d >= 0L) && ((Thread.currentThread() instanceof mp)) && (((mp)Thread.currentThread()).a < this.b.longValue());
  }
