  ...
  private static ColorStateList a(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    ...
    for (;;)
    {
      ...
      if ((j == 2) && (k <= i1)) {
        ...
        {
          Object localObject2 = hg.j.ColorStateListItem;
          if (paramTheme == null) {
          ...
          int i2 = ((TypedArray)localObject2).getColor(hg.j.ColorStateListItem_android_color, -65281);
          boolean bool = ((TypedArray)localObject2).hasValue(hg.j.ColorStateListItem_android_alpha);
          float f = 1.0F;
          if (bool) {
            f = ((TypedArray)localObject2).getFloat(hg.j.ColorStateListItem_android_alpha, 1.0F);
          } else if (((TypedArray)localObject2).hasValue(hg.j.ColorStateListItem_alpha)) {
            f = ((TypedArray)localObject2).getFloat(hg.j.ColorStateListItem_alpha, 1.0F);
          }
          ...
          arrayOfInt = hj.a(arrayOfInt, i, dq.b(i2, Math.round(Color.alpha(i2) * f)));
          localObject1 = (int[][])hj.a((Object[])localObject1, i, localObject2);
          i += 1;
        }
        else {}
      }
