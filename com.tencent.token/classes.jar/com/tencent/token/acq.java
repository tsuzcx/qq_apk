...
{
  public static final afk<acq> a = new a();
  ...
  private static String b(Context paramContext)
  {
    ...
    paramContext = new File(aev.a(localStringBuilder, File.separator, "8"));
    if ((!paramContext.exists()) && (!paramContext.mkdirs())) {
      return "";
    }
    localStringBuilder = new StringBuilder();
    localStringBuilder.append(paramContext.getAbsolutePath());
    return aev.a(localStringBuilder, File.separator, "2");
  }
    ...
    try
    {
      synchronized (this.b)
      {
        ...
        if (!TextUtils.isEmpty(str)) {
          i = Integer.parseInt(new String(aez.b(str)));
        }
      }
    }
