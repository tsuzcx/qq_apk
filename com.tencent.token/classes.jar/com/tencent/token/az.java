...
public final class az
{
  ...
  private static Map<Class, List<Constructor<? extends at>>> b = new HashMap();
  ...
  static GenericLifecycleObserver a(Object paramObject)
  {
    ...
    if (b((Class)localObject) == 2)
    {
      ...
      at[] arrayOfat = new at[((List)localObject).size()];
      while (i < ((List)localObject).size())
      {
        arrayOfat[i] = a((Constructor)((List)localObject).get(i), paramObject);
        i += 1;
      }
      return new CompositeGeneratedAdaptersObserver(arrayOfat);
    }
    return new ReflectiveGenericLifecycleObserver(paramObject);
  }
  
  private static at a(Constructor<? extends at> paramConstructor, Object paramObject)
  {
    try
    {
      paramConstructor = (at)paramConstructor.newInstance(new Object[] { paramObject });
  ...
  private static Constructor<? extends at> a(Class<?> paramClass)
  {
    try
    {
  ...
  {
    return (paramClass != null) && (av.class.isAssignableFrom(paramClass));
  }
}
