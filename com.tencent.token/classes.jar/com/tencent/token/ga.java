...
public class ga
{
  ...
  public static int a(gd paramgd, String paramString)
  {
    try
    {
      a(paramgd);
      paramgd = a().query(paramString, new String[] { "count(*)" }, null, null, null, null, null, null);
      if (paramgd.getCount() > 0)
      {
        paramgd.moveToFirst();
        i = paramgd.getInt(0);
        paramgd.close();
        h.c("test database, tablecount=" + i);
        return i;
      }
    }
    catch (Exception paramgd)
    {
      h.c("status_kk" + paramgd.toString() + paramgd.getMessage());
      return 0;
    }
    catch (Throwable paramgd)
    {
      for (;;)
      {
        h.c("status_kk" + paramgd.toString() + paramgd.getMessage());
  ...
  public static int a(gd paramgd, String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString)
  {
    try
    {
      a(paramgd);
  ...
  public static int a(gd paramgd, String paramString1, String paramString2, String[] paramArrayOfString)
  {
    try
    {
      a(paramgd);
      int i = a().delete(paramString1, paramString2, paramArrayOfString);
      h.c("test database, del=" + i);
      return i;
    }
    catch (Exception paramgd)
    {
  ...
  /* Error */
  public static long a(gd paramgd, String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3, String paramString4, String paramString5, String paramString6, boolean paramBoolean)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic 25	com/tencent/token/ga:a	(Lcom/tencent/token/gd;)V
    //   4: invokestatic 28	com/tencent/token/ga:a	()Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   7: aload_1
    //   8: aload_2
    //   9: aload_3
    //   10: aload 4
    ...
    //   83: invokestatic 78	com/tencent/token/global/h:c	(Ljava/lang/String;)V
    //   86: lload 10
    //   88: lreturn
    //   89: aload_0
    ...
    //   138: invokestatic 78	com/tencent/token/global/h:c	(Ljava/lang/String;)V
    //   141: lconst_0
    //   142: lreturn
    //   143: astore_0
    ...
    //   173: invokestatic 78	com/tencent/token/global/h:c	(Ljava/lang/String;)V
    //   176: goto -35 -> 141
  ...
  public static gd a(gd paramgd, String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2)
  {
    return b(paramgd, paramString1, paramArrayOfString1, paramString2, paramArrayOfString2, null, null, null, null);
  }
  ...
  {
    // Byte code:
    //   0: getstatic 117	com/tencent/token/ga:a	Lcom/tencent/token/fw;
    //   3: ifnonnull +181 -> 184
    //   6: getstatic 119	com/tencent/token/ga:b	Landroid/content/Context;
    //   9: ifnonnull +9 -> 18
    //   12: invokestatic 125	com/tencent/token/global/RqdApplication:l	()Landroid/content/Context;
    //   15: putstatic 119	com/tencent/token/ga:b	Landroid/content/Context;
    //   18: getstatic 119	com/tencent/token/ga:b	Landroid/content/Context;
    //   21: ldc 127
    ...
    //   65: astore 5
    //   67: getstatic 119	com/tencent/token/ga:b	Landroid/content/Context;
    //   70: ldc 158
    ...
    //   80: ifne +199 -> 279
    //   83: getstatic 119	com/tencent/token/ga:b	Landroid/content/Context;
    //   86: ldc 160
    ...
    //   103: aconst_null
    //   104: iconst_1
    //   105: new 165	com/tencent/token/fu
    //   108: dup
    //   109: invokespecial 166	com/tencent/token/fu:<init>	()V
    ...
    //   115: astore_0
    //   116: aload_1
    //   117: getstatic 16	com/tencent/token/ga:c	Ljava/lang/String;
    //   120: invokevirtual 174	java/lang/String:getBytes	()[B
    //   123: aload 5
    //   125: aconst_null
    //   126: new 165	com/tencent/token/fu
    //   129: dup
    //   130: invokespecial 166	com/tencent/token/fu:<init>	()V
    ...
    //   141: aload_0
    //   142: aload_1
    //   143: invokestatic 181	com/tencent/token/ga:a	(Lcom/tencent/wcdb/database/SQLiteDatabase;Lcom/tencent/wcdb/database/SQLiteDatabase;)Z
    //   146: pop
    //   147: aload_0
    //   148: ifnull +7 -> 155
    //   151: aload_0
    ...
    //   163: new 184	com/tencent/token/fw
    //   166: dup
    //   167: getstatic 119	com/tencent/token/ga:b	Landroid/content/Context;
    //   170: getstatic 16	com/tencent/token/ga:c	Ljava/lang/String;
    //   173: invokestatic 188	com/tencent/token/global/c:a	()I
    //   176: aload 5
    //   178: invokespecial 191	com/tencent/token/fw:<init>	(Landroid/content/Context;Ljava/lang/String;ILcom/tencent/wcdb/database/SQLiteCipherSpec;)V
    //   181: putstatic 117	com/tencent/token/ga:a	Lcom/tencent/token/fw;
    //   184: getstatic 117	com/tencent/token/ga:a	Lcom/tencent/token/fw;
    //   187: invokevirtual 194	com/tencent/token/fw:getWritableDatabase	()Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   190: astore_0
    //   191: aload_0
    //   192: areturn
    //   193: astore 4
    ...
    //   234: invokestatic 78	com/tencent/token/global/h:c	(Ljava/lang/String;)V
    //   237: aload_0
    //   238: ifnull +7 -> 245
    //   241: aload_0
    ...
    //   277: aload_1
    //   278: athrow
    //   279: getstatic 119	com/tencent/token/ga:b	Landroid/content/Context;
    //   282: ldc 160
    ...
    //   296: invokestatic 78	com/tencent/token/global/h:c	(Ljava/lang/String;)V
    ...
    //   328: invokestatic 78	com/tencent/token/global/h:c	(Ljava/lang/String;)V
    //   331: goto -147 -> 184
    //   334: astore_0
    //   335: aload_0
    //   336: invokevirtual 84	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   339: invokestatic 78	com/tencent/token/global/h:c	(Ljava/lang/String;)V
    ...
    //   371: invokestatic 78	com/tencent/token/global/h:c	(Ljava/lang/String;)V
    //   374: aconst_null
    //   375: areturn
    //   376: astore_0
    ...
    //   406: invokestatic 78	com/tencent/token/global/h:c	(Ljava/lang/String;)V
    //   409: aconst_null
    //   410: areturn
    //   411: astore_1
    //   412: aconst_null
  ...
  public static List a(gd paramgd, String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    try
    {
      ...
      if (paramString1.getCount() > 0)
      {
        ...
        do
        {
          localArrayList.add(paramgd.a(paramString1));
  ...
  public static void a(gd paramgd)
  {
    try
    {
      paramgd.a(a());
  ...
  public static void a(String paramString)
  {
    ...
    {
      h.c("status_kk" + paramString.toString() + paramString.getMessage());
      return;
    }
  ...
  public static long b(gd paramgd)
  {
    try
    {
      a(paramgd);
  ...
  public static gd b(gd paramgd, String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    paramgd = a(paramgd, paramString1, paramArrayOfString1, paramString2, paramArrayOfString2, paramString3, paramString4, paramString5, paramString6);
    if ((paramgd != null) && (paramgd.size() > 0)) {
      return (gd)paramgd.get(0);
    }
    return null;
  }
  ...
  public static void b()
  {
    ...
    {
      h.c("status_kk" + localException.toString() + localException.getMessage());
      return;
    }
    catch (Throwable localThrowable)
    {
      h.c("status_kk" + localThrowable.toString() + localThrowable.getMessage());
    }
  }
  
  public static long c(gd paramgd)
  {
    try
    {
      a(paramgd);
      long l = a().replace(paramgd.b(), null, paramgd.c());
      return l;
    }
    catch (Exception paramgd)
    {
