          ...
          if (k != 524672)
          {
            ...
            if (k != 1835009)
            {
              ...
              case 1048836: 
                ...
                localObject1 = this.b;
                ((Node)((agw)localObject1).a.peek()).appendChild(((agw)localObject1).b.createCDATASection(paramInputStream));
                this.j += 28;
                break;
              case 1048835: 
                this.b.a.pop();
              ...
              case 1048834: 
                ...
                while (k < n)
                {
                  ...
                  i3 = b(this.j + 12);
                  i4 = b(this.j + 16);
                  localObject4 = new agl();
                  ((agl)localObject4).a = a(i1);
                  if (m == -1)
                  {
                    ((agl)localObject4).c = null;
                    ((agl)localObject4).b = null;
                  }
                  else
                  {
                    ...
                    {
                      ((agl)localObject4).c = paramInputStream;
                      ((agl)localObject4).b = ((String)this.c.get(paramInputStream));
                    }
                  }
                  if (i2 == -1)
                  {
                    ...
                    ((agl)localObject4).d = paramInputStream;
                  }
                  else
                  {
                    ((agl)localObject4).d = a(i2);
                  }
                  arrayOfagl[k] = localObject4;
                  this.j += 20;
                  k += 1;
                }
                ...
                if (k != 0) {
                  paramInputStream = ((agw)localObject4).b.createElement((String)localObject3);
                } else {
                  paramInputStream = ((agw)localObject4).b.createElementNS((String)localObject1, (String)localObject2);
                }
                k = 0;
                while (k < n)
                {
                  localObject1 = arrayOfagl[k];
                  localObject2 = ((agl)localObject1).c;
                  ...
                  if (m != 0)
                  {
                    paramInputStream.setAttribute(((agl)localObject1).a, ((agl)localObject1).d);
                  }
                  else
                  {
                    localObject2 = ((agl)localObject1).c;
                    localObject3 = new StringBuilder();
                    ((StringBuilder)localObject3).append(((agl)localObject1).b);
                    ((StringBuilder)localObject3).append(':');
                    ((StringBuilder)localObject3).append(((agl)localObject1).a);
                    paramInputStream.setAttributeNS((String)localObject2, ((StringBuilder)localObject3).toString(), ((agl)localObject1).d);
                  }
                  k += 1;
                }
                ((Node)((agw)localObject4).a.peek()).appendChild(paramInputStream);
                ((agw)localObject4).a.push(paramInputStream);
                break;
              case 1048833: 
                a(false);
                break;
 ...
 * Qualified Name:     com.tencent.token.aby
