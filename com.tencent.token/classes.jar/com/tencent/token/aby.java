  ...
  extends Handler
{
  ...
  public aby(Handler paramHandler, Window paramWindow, Looper paramLooper, abt paramabt, String paramString)
  {
    super(paramLooper);
    this.a = paramHandler;
    this.c = paramabt;
  ...
  public final void handleMessage(android.os.Message paramMessage)
  {
    ...
    //   9: istore_3
    //   10: aload_0
    //   11: getfield 20	com/tencent/token/aby:a	Landroid/os/Handler;
    //   14: aload_1
    //   15: invokevirtual 51	android/os/Handler:handleMessage	(Landroid/os/Message;)V
    //   18: aload_0
    //   19: getfield 22	com/tencent/token/aby:c	Lcom/tencent/token/abt;
    //   22: ifnonnull +4 -> 26
    //   25: return
    //   26: iload_3
    //   27: iconst_1
    ...
    //   31: return
    //   32: aload_0
    //   33: getfield 29	com/tencent/token/aby:b	Ljava/lang/ref/WeakReference;
    ...
    //   149: return
    //   150: aload_0
    //   151: getfield 22	com/tencent/token/aby:c	Lcom/tencent/token/abt;
    //   154: aload_0
    //   155: getfield 31	com/tencent/token/aby:d	Ljava/lang/String;
    //   158: aload_1
