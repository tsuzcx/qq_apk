  ...
  implements AdapterView.OnItemSelectedListener
{
  ...
  protected final void onConfigurationChanged(Configuration paramConfiguration)
  {
    ...
    paramConfiguration = hn.a(getContext());
    TypedArray localTypedArray = paramConfiguration.a.obtainStyledAttributes(null, hg.j.ActionBar, hg.a.actionBarStyle, 0);
    int k = localTypedArray.getLayoutDimension(hg.j.ActionBar_height, 0);
    Resources localResources = paramConfiguration.a.getResources();
    int j = k;
    if (!paramConfiguration.b()) {
      j = Math.min(k, localResources.getDimensionPixelSize(hg.d.abc_action_bar_stacked_max_height));
    }
    localTypedArray.recycle();
    setContentHeight(j);
    this.d = paramConfiguration.a.getResources().getDimensionPixelSize(hg.d.abc_action_bar_stacked_tab_max_width);
  }
    ...
    if (paramInt2 != 0)
    {
      ...
      if (this.b.getMeasuredWidth() > View.MeasureSpec.getSize(paramInt1))
      {
        if (!a())
        {
          if (this.f == null)
          {
            localObject = new AppCompatSpinner(getContext(), null, hg.a.actionDropDownStyle);
      ...
      if (bool)
      {
        ...
        this.a = new Runnable()
        {
          public final void run()
          {
            ...
            int j = (jq.this.getWidth() - this.a.getWidth()) / 2;
            jq.this.smoothScrollTo(i - j, 0);
            jq.this.a = null;
          }
        };
        post(this.a);
    ...
    extends BaseAdapter
  {
    ...
    {
      return jq.this.b.getChildCount();
    }
    
    public final Object getItem(int paramInt)
    {
      return ((jq.b)jq.this.b.getChildAt(paramInt)).a;
    }
    ...
    extends LinearLayout
  {
    ...
    {
      super(null, hg.a.actionBarTabStyle);
      this.a = parama;
      this$1 = jw.a(paramContext, null, this.c, hg.a.actionBarTabStyle, 0);
      if (jq.this.f(0)) {
        setBackgroundDrawable(jq.this.a(0));
      }
      jq.this.a.recycle();
      setGravity(8388627);
      a();
    ...
    public final void a()
    {
      ...
      if (bool)
      {
        if (this.d == null)
        {
          localObject3 = new AppCompatTextView(getContext(), null, hg.a.actionBarTabTextStyle);
    ...
    public final void onMeasure(int paramInt1, int paramInt2)
    {
      ...
      if ((jq.this.c > 0) && (getMeasuredWidth() > jq.this.c)) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(jq.this.c, 1073741824), paramInt2);
      }
    }
