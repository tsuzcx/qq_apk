  ...
  implements Camera.AutoFocusCallback, Camera.PreviewCallback
{
  ...
  public xu(Context paramContext, SurfaceHolder paramSurfaceHolder, Handler paramHandler, FaceDetector.IdCardDirection paramIdCardDirection)
  {
    this.j = paramContext;
    this.b = paramHandler;
  ...
  public final void a()
  {
    ...
    try
    {
      ...
      xb.c(((StringBuilder)localObject3).toString());
    ...
    if (this.s == FaceDetector.IdCardDirection.DT_FRONT)
    {
      f = 0;
      e = 0;
      ru.a().a(System.currentTimeMillis(), 130);
      return;
    }
    h = 0;
    g = 0;
    ru.a().a(System.currentTimeMillis(), 132);
  }
  ...
  public final void onPreviewFrame(byte[] paramArrayOfByte, Camera paramCamera)
  {
        ...
        public final void run()
        {
          try
          {
            synchronized (xu.this.i)
            {
              xu.a(xu.this, true);
              xu.a(xu.this);
              xu.b(xu.this, FaceDetector.IdCardDetectInitial(xu.b(xu.this)));
              StringBuilder localStringBuilder = new StringBuilder("IdCardDetectInitial: ");
              localStringBuilder.append(xu.c(xu.this));
              localStringBuilder.append(",mIdCardModelPath=");
              localStringBuilder.append(xu.b(xu.this));
              xb.c(localStringBuilder.toString());
              xu.d(xu.this);
              xu.a(xu.this, false);
            }
    ...
    try
    {
      ...
      l2 = l1;
      l3 = l1;
      xb.c("IdCardDetect detect ret: ".concat(String.valueOf(l1)));
    }
    catch (Error localError)
    {
      localError.printStackTrace();
    ...
    if (l1 == 0L)
    {
      ...
      if (this.s == FaceDetector.IdCardDirection.DT_FRONT)
      {
        ...
        localObject3 = zx.a(((IdCardInfo)localObject1).data(), "frontdata");
        localObject2 = this.b.obtainMessage(0);
        ...
        ((Message)localObject2).sendToTarget();
        ru.a().a(System.currentTimeMillis(), 131);
      }
      else if (this.s == FaceDetector.IdCardDirection.DT_BACK)
      {
        h = (int)(System.currentTimeMillis() - this.c);
        localObject3 = zx.a(((IdCardInfo)localObject1).data(), "backdata");
        localObject2 = this.b.obtainMessage(0);
        ((Message)localObject2).what = 1;
        ((Message)localObject2).obj = localObject3;
        localObject3 = new Bundle();
        ...
        ((Message)localObject2).sendToTarget();
        ru.a().a(System.currentTimeMillis(), 133);
      }
    ...
    xb.a("ret=".concat(String.valueOf(l1)));
    if ((l1 != 3L) && (l1 != 5L))
    {
      if ((l1 == 2L) || (l1 == 4L)) {
