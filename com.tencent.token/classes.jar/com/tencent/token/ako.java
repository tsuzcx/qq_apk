  ...
  extends akq
{
  ...
  private ako(Method paramMethod1, Method paramMethod2, Method paramMethod3, Class<?> paramClass1, Class<?> paramClass2)
  {
    this.a = paramMethod1;
    this.b = paramMethod2;
    this.d = paramMethod3;
  ...
  public static akq a()
  {
    try
    {
      ...
      localObject1 = new ako(((Class)localObject1).getMethod("put", new Class[] { SSLSocket.class, localObject2 }), ((Class)localObject1).getMethod("get", new Class[] { SSLSocket.class }), ((Class)localObject1).getMethod("remove", new Class[] { SSLSocket.class }), (Class)localObject3, (Class)localObject4);
      return localObject1;
    }
  ...
  public final String a(SSLSocket paramSSLSocket)
  {
    try
    {
      ...
      {
        akq.c.a(4, "ALPN callback dropped: HTTP/2 is disabled. Is alpn-boot on the boot class path?", null);
        return null;
      }
      if (paramSSLSocket.a) {
        return null;
    ...
    throw aiw.a("unable to get selected protocol", paramSSLSocket);
  }
  ...
  public final void a(SSLSocket paramSSLSocket, String paramString, List<aim> paramList)
  {
    ...
    try
    {
      paramString = akq.class.getClassLoader();
      paramList = this.e;
    ...
    throw aiw.a("unable to set alpn", paramSSLSocket);
  }
  ...
  public final void b(SSLSocket paramSSLSocket)
  {
    ...
    throw aiw.a("unable to remove alpn", paramSSLSocket);
  }
