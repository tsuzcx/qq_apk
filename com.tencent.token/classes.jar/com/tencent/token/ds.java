...
public final class ds
{
  ...
  private static final dt b = new dt("fonts");
  private static final Object c = new Object();
  private static final ef<String, ArrayList<dt.a<c>>> d = new ef();
  private static final Comparator<byte[]> e = new Comparator() {};
  
  public static Typeface a(Context paramContext, final dr paramdr, cw.a arg2, boolean paramBoolean, int paramInt1, final int paramInt2)
  {
    Object localObject1 = new StringBuilder();
    ((StringBuilder)localObject1).append(paramdr.f);
    ...
    {
      paramContext = b(paramContext, paramdr, paramInt2);
      if (??? != null) {
        if (paramContext.b == 0) {
    ...
    paramdr = new Callable() {};
    if (paramBoolean) {}
    try
    {
      paramContext = ((c)b.a(paramdr, paramInt1)).a;
      return paramContext;
    }
    ...
    synchronized (c)
    {
      ...
      paramContext = b;
      ??? = new dt.a() {};
      paramContext.a(new dt.2(paramContext, paramdr, new Handler(), ???));
      return null;
    }
    return null;
  }
    ...
    while (i < j)
    {
      ...
      if (((b)localObject).e == 0)
      {
        ...
        if (!localHashMap.containsKey(localObject)) {
          localHashMap.put(localObject, df.a(paramContext, (Uri)localObject));
        }
      }
      i += 1;
    }
  ...
  private static b[] a(Context paramContext, dr paramdr, String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    ...
    for (;;)
    {
      try
      {
        if (Build.VERSION.SDK_INT > 16)
        {
          ...
          paramdr = paramdr.c;
          paramString = localObject;
          paramContext = paramContext.query(localUri1, new String[] { "_id", "file_id", "font_ttc_index", "font_variation_settings", "font_weight", "font_italic", "result_code" }, "query = ?", new String[] { paramdr }, null, null);
        }
        else
        {
          paramString = localObject;
          ...
          paramdr = paramdr.c;
          paramString = localObject;
          paramContext = paramContext.query(localUri1, new String[] { "_id", "file_id", "font_ttc_index", "font_variation_settings", "font_weight", "font_italic", "result_code" }, "query = ?", new String[] { paramdr }, null);
        }
        paramdr = localArrayList;
        if (paramContext != null)
        {
          paramdr = localArrayList;
          ...
          if (paramContext.getCount() > 0)
          {
            ...
            if (paramContext.moveToNext())
            {
              ...
              {
                paramString = paramContext;
                paramdr = ContentUris.withAppendedId(localUri1, paramContext.getLong(n));
              }
              else
              {
                paramString = paramContext;
                paramdr = ContentUris.withAppendedId(localUri2, paramContext.getLong(i1));
              }
              if (i3 == -1) {
                break label554;
              }
              ...
              bool = true;
              paramString = paramContext;
              localArrayList.add(new b(paramdr, j, k, bool, i));
              continue;
            }
          }
        }
        ...
        return (b[])paramdr.toArray(new b[0]);
      }
      finally
      {
        if (paramString != null) {
  ...
  private static c b(Context paramContext, dr paramdr, int paramInt)
  {
    try
    {
      ...
      if (paramdr.d != null) {
        localObject1 = paramdr.d;
      } else {
        localObject1 = cv.a((Resources)localObject1, paramdr.e);
      }
    }
    ...
    if (i < ((List)localObject1).size())
    {
      ...
      if (a((List)localObject2, (List)localObject3))
      {
        ...
        if (localObject1 == null) {
          paramdr = new a(1, null);
        } else {
          paramdr = new a(0, a(paramContext, paramdr, ((ProviderInfo)localObject1).authority));
        }
        j = paramdr.a;
        i = -3;
        if (j == 0)
        {
          paramContext = da.a(paramContext, paramdr.b, paramInt);
          if (paramContext != null) {
            i = 0;
          }
  ...
  public static final class a
  {
    ...
    public a(int paramInt, ds.b[] paramArrayOfb)
    {
      this.a = paramInt;
