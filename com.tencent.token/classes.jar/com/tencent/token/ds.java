...
public final class ds
{
  ...
  public ds(String paramString1, String paramString2, String paramString3, List<List<byte[]>> paramList)
  {
    this.a = ((String)ef.a(paramString1));
    this.b = ((String)ef.a(paramString2));
    this.c = ((String)ef.a(paramString3));
    this.d = ((List)ef.a(paramList));
    this.e = 0;
