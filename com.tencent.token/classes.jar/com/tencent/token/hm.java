...
public final class hm
{
  ...
  public hm(Protocol paramProtocol, int paramInt, String paramString)
  {
  ...
  public static hm a(String paramString)
  {
    int i = 9;
    int j;
    ...
    for (paramString = paramString.substring(i + 4);; paramString = "") {
      return new hm(localNumberFormatException, j, paramString);
    }
  }
