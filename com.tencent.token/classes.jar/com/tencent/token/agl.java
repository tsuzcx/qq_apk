  ...
  extends agf
{
  ...
  protected agl(SQLiteDatabase paramSQLiteDatabase, String paramString, Object[] paramArrayOfObject, agt paramagt)
  {
    ...
    if (str != null)
    {
      ...
      paramSQLiteDatabase.a(str, j, paramagt);
      try
      {
    ...
    try
    {
      ...
      if ((this.i != null) && (this.f != null))
      {
        if (this.i == this.a.b())
        {
          ...
          if (((ago)localObject1).a != null)
          {
            ((ago)localObject1).a.a(localc);
            ((ago)localObject1).b();
          }
          this.f = null;
          this.i = null;
