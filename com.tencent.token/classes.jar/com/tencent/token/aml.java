  ...
  extends amn
{
  ...
  private aml(Method paramMethod1, Method paramMethod2, Method paramMethod3, Class<?> paramClass1, Class<?> paramClass2)
  {
    this.a = paramMethod1;
    this.b = paramMethod2;
    this.d = paramMethod3;
  ...
  public static amn a()
  {
    try
    {
      ...
      localObject1 = new aml(((Class)localObject1).getMethod("put", new Class[] { SSLSocket.class, localObject2 }), ((Class)localObject1).getMethod("get", new Class[] { SSLSocket.class }), ((Class)localObject1).getMethod("remove", new Class[] { SSLSocket.class }), (Class)localObject3, (Class)localObject4);
      return localObject1;
    }
  ...
  public final String a(SSLSocket paramSSLSocket)
  {
    try
    {
      ...
      {
        amn.c.a(4, "ALPN callback dropped: HTTP/2 is disabled. Is alpn-boot on the boot class path?", null);
        return null;
      }
      if (paramSSLSocket.a) {
        return null;
    ...
    throw akt.a("unable to get selected protocol", paramSSLSocket);
  }
  ...
  public final void a(SSLSocket paramSSLSocket, String paramString, List<akj> paramList)
  {
    ...
    try
    {
      paramString = amn.class.getClassLoader();
      paramList = this.e;
    ...
    throw akt.a("unable to set alpn", paramSSLSocket);
  }
  ...
  public final void b(SSLSocket paramSSLSocket)
  {
    ...
    throw akt.a("unable to remove alpn", paramSSLSocket);
  }
