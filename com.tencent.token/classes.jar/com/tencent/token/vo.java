  ...
  extends tr
{
  ...
  public final void a(abc paramabc)
  {
    ...
    this.g = ((Integer)paramabc.c.get("param.msg.source")).intValue();
    this.h = ((Integer)paramabc.c.get("param.msg.num")).intValue();
    this.i = ((Integer)paramabc.c.get("param.msg.type")).intValue();
    this.j = ((Integer)paramabc.c.get("param.msg.filter")).intValue();
    if ((this.j == 0) && (this.i == 1))
    {
      this.l = ((String)paramabc.c.get("param.device.lock.guid"));
      this.m = ((Integer)paramabc.c.get("param.device.lock.appid")).intValue();
      this.n = ((Integer)paramabc.c.get("param.device.lock.subappid")).intValue();
      this.o = ((String)paramabc.c.get("param.device.lock.appname"));
      this.p = ((String)paramabc.c.get("param.skey"));
    }
  }
  ...
  public final void a(JSONObject paramJSONObject)
  {
    ...
    if (paramJSONObject != null)
    {
      ...
      if (this.i == 1)
      {
        ...
        rp.a.a().a(this.f, (List)localObject);
 ...
 * Qualified Name:     com.tencent.token.vo
