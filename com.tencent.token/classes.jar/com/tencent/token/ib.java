  ...
  extends ViewGroup
{
  ...
  ib(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0);
  }
  
  protected ib(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    super(paramContext, paramAttributeSet, paramInt);
    paramAttributeSet = new TypedValue();
    if ((paramContext.getTheme().resolveAttribute(gp.a.actionBarPopupTheme, paramAttributeSet, true)) && (paramAttributeSet.resourceId != 0))
    {
  ...
  public fa a(int paramInt, long paramLong)
  {
    fa localfa = this.f;
    if (localfa != null) {
      localfa.b();
    ...
    if (paramInt == 0)
    {
      ...
      localfa = ex.f(this).a(1.0F);
      localfa.a(paramLong);
      localfa.a(this.a.a(localfa, paramInt));
      return localfa;
    }
    localfa = ex.f(this).a(0.0F);
    localfa.a(paramLong);
    localfa.a(this.a.a(localfa, paramInt));
    return localfa;
  }
  ...
  protected void onConfigurationChanged(Configuration paramConfiguration)
  {
    ...
    paramConfiguration = getContext().obtainStyledAttributes(null, gp.j.ActionBar, gp.a.actionBarStyle, 0);
    setContentHeight(paramConfiguration.getLayoutDimension(gp.j.ActionBar_height, 0));
    ...
    implements fb
  {
    ...
    public final a a(fa paramfa, int paramInt)
    {
      ib.this.f = paramfa;
      this.a = paramInt;
      return this;
