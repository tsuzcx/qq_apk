  ...
  extends ContextWrapper
{
  ...
  public final void a(int paramInt, String paramString1, String paramString2, PendingIntent paramPendingIntent)
  {
    if (Build.VERSION.SDK_INT >= 26)
    {
      ...
      if (Build.VERSION.SDK_INT >= 26) {
        paramString1 = new Notification.Builder(RqdApplication.n(), "channel_qqsafe").setDefaults(1).setContentTitle(paramString1).setContentText(paramString2).setContentIntent(paramPendingIntent).setSmallIcon(2131099917).setAutoCancel(true);
      } else {
        paramString1 = null;
      }
    ...
    paramString1 = new db.b(RqdApplication.n(), (byte)0).c().a(paramString1).b(paramString2);
