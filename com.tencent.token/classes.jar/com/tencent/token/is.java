  ...
  extends ListView
{
  ...
  public is(Context paramContext, boolean paramBoolean)
  {
    super(paramContext, null, gp.a.dropDownListViewStyle);
    this.j = paramBoolean;
    setCacheColorHint(0);
    try
    {
  ...
  public boolean a(MotionEvent paramMotionEvent, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt != 0)
      {
        ...
        dh.a((Drawable)localObject2, f3, f4);
      }
      localObject2 = getSelector();
      if ((localObject2 != null) && (i3 != -1)) {
        dh.a((Drawable)localObject2, f1, f2);
      }
