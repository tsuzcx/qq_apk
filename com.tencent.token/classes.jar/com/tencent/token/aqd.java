...
public final class aqd
{
  ...
  private static byte[] c(String paramString)
  {
    ...
    try
    {
      Object localObject = arm.a("MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDb49jFnNqMDLdl87UtY5jOMqqdMuvQg65Zuva3Qm1tORQGBuM04u7fqygA64XbOx9e/KPNkDNDmqS8SlsAPL1fV2lqM/phgV0NY62TJqSR+PLngwJd2rhYR8wQ1N0JE+R59a5c08EGsd6axStjHsVu2+evCf/SWU9Y/oQpEtOjGwIDAQAB");
  ...
  public final boolean a(AtomicReference paramAtomicReference)
  {
    ...
    if (??? != null)
    {
      ...
      new StringBuilder("updataRsaKey() reqRSA.enc: ").append(apb.a(paramAtomicReference.a));
      ??? = new ai();
      ((ai)???).b = this.c.b.a();
      ((ai)???).a = 152;
      ((ai)???).d = apu.a(paramAtomicReference);
    ...
    try
    {
      ...
      if (??? == null) {
        ...
        paramAtomicReference = aqa.a((byte[])???, paramAtomicReference);
      }
      if (paramAtomicReference == null) {
        return false;
      }
