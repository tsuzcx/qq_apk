  ...
  extends AppCompatDelegateImplV9
{
  ...
  gz(Context paramContext, Window paramWindow, gv paramgv)
  {
  ...
  public final boolean k()
  {
        ...
        else
        {
          ...
          if (Build.VERSION.SDK_INT < 26) {
            if (Build.VERSION.SDK_INT >= 24) {
              hb.c((Resources)localObject);
            } else if (Build.VERSION.SDK_INT >= 23) {
              hb.b((Resources)localObject);
            } else if (Build.VERSION.SDK_INT >= 21) {
              hb.a((Resources)localObject);
            }
          }
        }
        bool1 = true;
    ...
    if (i == 0)
    {
      ...
      if (((b)localObject).c == null) {
        ((b)localObject).c = new gz.b.1((b)localObject);
      }
    ...
    extends gx.b
  {
    ...
    {
      paramCallback = new hs.a(gz.this.b, paramCallback);
      ho localho = gz.this.a(paramCallback);
      if (localho != null) {
        return paramCallback.b(localho);
      }
      return null;
    }
  ...
  final class b
  {
    ...
    final void a()
    {
      if (this.c != null)
      {
        gz.this.b.unregisterReceiver(this.c);
        this.c = null;
      }
    }
  }
