  ...
  extends ahq
{
  ...
  protected ahw(SQLiteDatabase paramSQLiteDatabase, String paramString, Object[] paramArrayOfObject, aie paramaie)
  {
    ...
    if (str != null)
    {
      ...
      paramSQLiteDatabase.a(str, j, paramaie);
      try
      {
    ...
    try
    {
      ...
      if ((this.i != null) && (this.f != null))
      {
        if (this.i == this.a.b())
        {
          ...
          if (((ahz)localObject1).a != null)
          {
            ((ahz)localObject1).a.a(localc);
            ((ahz)localObject1).b();
          }
          this.f = null;
          this.i = null;
 ...
 * Qualified Name:     com.tencent.token.ahw
