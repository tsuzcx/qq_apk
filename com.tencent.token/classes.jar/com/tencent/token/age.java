...
public class age
{
  public static final String a = afz.a(afz.aU);
  ...
  public static void a(X509Certificate paramX509Certificate, agk paramagk)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((j > 0) && (j < k))
        {
          ...
          paramagk.h = paramX509Certificate.getString(c);
          paramagk.g = paramX509Certificate.getInt(d);
          paramagk.f = paramX509Certificate.getLong(b);
        }
        return;
      }
      catch (Exception paramX509Certificate)
      {
        paramagk = new StringBuilder("C");
        paramagk.append(paramX509Certificate.getStackTrace());
        throw new Exception(paramagk.toString());
      }
 ...
 * Qualified Name:     com.tencent.token.age
