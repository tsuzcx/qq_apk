...
import com.tencent.turingfd.sdk.qps.catch;
...
public final class age
{
  ...
  private void a(Object paramObject, int paramInt)
  {
    ...
    if ((paramObject instanceof final))
    {
      a((final)paramObject, paramInt);
      return;
    }
    if ((paramObject instanceof byte[]))
    {
    ...
    throw new catch(localStringBuilder.toString());
  }
  ...
  private void b(byte paramByte, int paramInt)
  {
    ...
    throw new catch("tag is too large: ".concat(String.valueOf(paramInt)));
  }
  ...
  public final void a(final paramfinal, int paramInt)
  {
    a(2);
    b((byte)10, paramInt);
    paramfinal.a(this);
