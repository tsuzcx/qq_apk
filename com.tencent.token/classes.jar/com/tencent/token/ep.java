...
public class ep
{
  ...
  private boolean a(QQUser paramQQUser, boolean paramBoolean)
  {
    ...
    if (eq.a(locala, "table_user", localContentValues, "uin=?", new String[] { String.valueOf(d(paramQQUser)) }) <= 0)
    {
  ...
  private boolean f(QQUser paramQQUser)
  {
    ...
    try
    {
      eq.a(locala, "table_user", "uin=?", new String[] { String.valueOf(d(paramQQUser)) });
      return true;
    }
  ...
  public boolean a()
  {
    for (;;)
    {
      ...
      finally
      {
        try
        {
          localObject1 = eq.a((es)localObject1, "table_user", new String[] { "uin", "email", "nick_name", "uin_mask", "flag", "head_image", "head_image_update_time" }, null, null, null, null, null, null);
  ...
  public void f()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 36	com/tencent/token/ep:c	Ljava/util/List;
    //   6: astore_2
    //   7: aload_2
    //   8: ifnonnull +6 -> 14
    //   11: aload_0
    ...
    //   16: iload_1
    //   17: aload_0
    //   18: getfield 36	com/tencent/token/ep:c	Ljava/util/List;
    //   21: invokeinterface 248 1 0
    //   26: if_icmpge -15 -> 11
    //   29: aload_0
    //   30: getfield 36	com/tencent/token/ep:c	Ljava/util/List;
    //   33: iload_1
    ...
    //   54: aload_0
    //   55: aload_2
    //   56: invokespecial 200	com/tencent/token/ep:f	(Lcom/tencent/token/core/bean/QQUser;)Z
    //   59: pop
    //   60: aload_2
    //   61: iconst_0
    ...
    //   65: aload_0
    //   66: aload_2
    //   67: invokespecial 206	com/tencent/token/ep:g	(Lcom/tencent/token/core/bean/QQUser;)Z
    //   70: pop
    //   71: iload_1
    //   72: iconst_1
    //   73: iadd
