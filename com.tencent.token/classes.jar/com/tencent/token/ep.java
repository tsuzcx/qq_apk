...
public final class ep
{
  ...
  public final boolean a(float paramFloat1, float paramFloat2)
  {
    if (this.a)
    {
      ...
      if (localViewParent != null) {
        return ey.a(localViewParent, this.d, paramFloat1, paramFloat2);
      }
    }
    return false;
  }
  ...
  public final boolean a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    if (this.a)
    {
      ViewParent localViewParent = c(0);
      if (localViewParent != null) {
        return ey.a(localViewParent, this.d, paramFloat1, paramFloat2, paramBoolean);
      }
    }
    return false;
  }
  ...
  public final boolean a(int paramInt1, int paramInt2)
  {
    ...
    if (this.a)
    {
      ...
      {
        if (ey.a(localViewParent, localView, this.d, paramInt1, paramInt2))
        {
          a(paramInt2, localViewParent);
          ey.b(localViewParent, localView, this.d, paramInt1, paramInt2);
          return true;
        }
  ...
  public final boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt, int paramInt5)
  {
    if (this.a)
    {
      ...
      else
      {
        ...
        ey.a(localViewParent, this.d, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5);
        if (paramArrayOfInt != null)
        {
          this.d.getLocationInWindow(paramArrayOfInt);
          paramArrayOfInt[0] -= i;
  ...
  public final boolean a(int paramInt1, int paramInt2, int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt3)
  {
    if (this.a)
    {
      ...
      else
      {
        ...
        arrayOfInt[0] = 0;
        arrayOfInt[1] = 0;
        ey.a(localViewParent, this.d, paramInt1, paramInt2, arrayOfInt, paramInt3);
        if (paramArrayOfInt2 != null)
        {
          this.d.getLocationInWindow(paramArrayOfInt2);
  ...
  public final void b(int paramInt)
  {
    ...
    if (localViewParent != null)
    {
      ey.a(localViewParent, this.d, paramInt);
      a(paramInt, null);
    }
  }
}
