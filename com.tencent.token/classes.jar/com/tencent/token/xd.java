...
{
  public List<xe> a = null;
  View.OnClickListener b;
  private Context c;
  
  public xd(Context paramContext, List<xe> paramList, View.OnClickListener paramOnClickListener)
  {
    this.c = paramContext;
    this.a = paramList;
  ...
  public final int getPositionForSection(int paramInt)
  {
    ...
    while (i < getCount())
    {
      if (((xe)this.a.get(i)).b.toUpperCase().charAt(0) == paramInt) {
        return i;
      }
      i += 1;
    }
  ...
  {
    return ((xe)this.a.get(paramInt)).b.charAt(0);
  }
  ...
  {
    Object localObject = (xe)this.a.get(paramInt);
    if (paramView == null)
    {
    ...
    if ((paramInt > 9) && (paramInt == getPositionForSection(i)))
    {
      ...
      paramViewGroup.b.setText(((xe)localObject).b);
    ...
    paramViewGroup.a.setText(((xe)this.a.get(paramInt)).a);
    return paramView;
  }
