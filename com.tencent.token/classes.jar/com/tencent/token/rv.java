...
public final class rv
{
  ...
  /* Error */
  final wz a(final long paramLong, int paramInt)
  {
    // Byte code:
    ...
    //   33: aload_0
    //   34: getfield 45	com/tencent/token/rv:c	Ljava/util/concurrent/ConcurrentHashMap;
    //   37: ldc 116
    ...
    //   48: aload_0
    //   49: getfield 45	com/tencent/token/rv:c	Ljava/util/concurrent/ConcurrentHashMap;
    //   52: ldc 116
    ...
    //   70: lcmp
    //   71: ifge +25 -> 96
    //   74: new 80	com/tencent/token/wz
    //   77: dup
    //   78: invokespecial 81	com/tencent/token/wz:<init>	()V
    //   81: astore 4
    //   83: aload 4
    //   85: sipush 10000
    //   88: aconst_null
    //   89: aconst_null
    //   90: invokevirtual 145	com/tencent/token/wz:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   93: aload 4
    //   95: areturn
    //   96: aload_0
    //   97: getfield 40	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
    ...
    //   120: astore 4
    //   122: invokestatic 161	com/tencent/token/qz:a	()Lcom/tencent/token/qz;
    //   125: lload_1
    //   126: iload_3
    //   127: new 10	com/tencent/token/rv$3
    //   130: dup
    //   131: aload_0
    //   132: lload_1
    //   133: iload_3
    //   134: aload 4
    //   136: aload 5
    //   138: invokespecial 164	com/tencent/token/rv$3:<init>	(Lcom/tencent/token/rv;JILjava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/CountDownLatch;)V
    //   141: invokevirtual 168	com/tencent/token/qz:e	(JILcom/tencent/token/qz$a;)V
    //   144: aload 5
    ...
    //   164: checkcast 80	com/tencent/token/wz
    //   167: astore 4
    ...
    //   180: aload 5
    //   182: aload 4
    //   184: getfield 84	com/tencent/token/wz:a	I
    ...
    //   201: aload_0
    //   202: getfield 45	com/tencent/token/rv:c	Ljava/util/concurrent/ConcurrentHashMap;
    //   205: ldc 116
    ...
    //   219: astore 5
    //   221: aload_0
    //   222: getfield 40	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
    ...
    //   273: astore 5
    //   275: aload_0
    //   276: getfield 40	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
    //   279: invokevirtual 193	java/util/concurrent/locks/ReentrantLock:unlock	()V
    //   282: aload 4
    //   284: areturn
    //   285: aload_0
    //   286: getfield 40	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
  ...
  public final void a(final long paramLong, int paramInt, final Handler paramHandler)
  {
    ...
    this.b.post(new Runnable()
    {
      ...
      public final void run()
      {
        // Byte code:
        //   0: aload_0
        //   1: getfield 22	com/tencent/token/rv$2:d	Lcom/tencent/token/rv;
        //   4: getfield 38	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        //   7: invokevirtual 43	java/util/concurrent/locks/ReentrantLock:lock	()V
        //   10: aload_0
        //   11: getfield 22	com/tencent/token/rv$2:d	Lcom/tencent/token/rv;
        //   14: aload_0
        //   15: getfield 24	com/tencent/token/rv$2:a	J
        //   18: aload_0
        //   19: getfield 26	com/tencent/token/rv$2:b	I
        //   22: invokevirtual 46	com/tencent/token/rv:a	(JI)Lcom/tencent/token/wz;
        //   25: astore_1
        //   26: aload_0
        //   27: getfield 28	com/tencent/token/rv$2:c	Landroid/os/Handler;
        //   30: sipush 3071
        //   33: invokevirtual 52	android/os/Handler:obtainMessage	(I)Landroid/os/Message;
        //   36: astore_2
        //   37: aload_2
        //   38: aload_1
        //   39: getfield 56	com/tencent/token/wz:a	I
        //   42: putfield 61	android/os/Message:arg1	I
        //   45: aload_1
        //   46: getfield 56	com/tencent/token/wz:a	I
        //   49: ifne +14 -> 63
        //   52: aload_2
        //   53: aload_1
        //   54: getfield 64	com/tencent/token/wz:d	Ljava/lang/Object;
        ...
        //   82: aload_2
        //   83: aload_1
        //   84: getfield 56	com/tencent/token/wz:a	I
        ...
        //   100: aload_0
        //   101: getfield 22	com/tencent/token/rv$2:d	Lcom/tencent/token/rv;
        //   104: getfield 38	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        ...
        //   136: aload_0
        //   137: getfield 22	com/tencent/token/rv$2:d	Lcom/tencent/token/rv;
        //   140: getfield 38	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        //   143: invokevirtual 96	java/util/concurrent/locks/ReentrantLock:unlock	()V
        //   146: return
        //   147: aload_0
        //   148: getfield 22	com/tencent/token/rv$2:d	Lcom/tencent/token/rv;
        //   151: getfield 38	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
  ...
  public final void a(final Handler paramHandler)
  {
    ...
    this.b.post(new Runnable()
    {
      ...
      public final void run()
      {
        // Byte code:
        //   0: aload_0
        //   1: getfield 18	com/tencent/token/rv$4:b	Lcom/tencent/token/rv;
        //   4: getfield 30	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        ...
        //   40: new 70	com/tencent/token/wz
        //   43: dup
        //   44: invokespecial 71	com/tencent/token/wz:<init>	()V
        //   47: astore_1
        //   48: aload_1
        //   49: iconst_0
        //   50: putfield 74	com/tencent/token/wz:a	I
        //   53: aload_0
        //   54: getfield 20	com/tencent/token/rv$4:a	Landroid/os/Handler;
        //   57: sipush 3025
        //   60: invokevirtual 80	android/os/Handler:obtainMessage	(I)Landroid/os/Message;
        //   63: astore_2
        //   64: aload_2
        //   65: aload_1
        //   66: getfield 74	com/tencent/token/wz:a	I
        ...
        //   91: aload_2
        //   92: aload_1
        //   93: getfield 74	com/tencent/token/wz:a	I
        ...
        //   109: aload_0
        //   110: getfield 18	com/tencent/token/rv$4:b	Lcom/tencent/token/rv;
        //   113: getfield 30	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        ...
        //   145: aload_0
        //   146: getfield 18	com/tencent/token/rv$4:b	Lcom/tencent/token/rv;
        //   149: getfield 30	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        //   152: invokevirtual 102	java/util/concurrent/locks/ReentrantLock:unlock	()V
        //   155: return
        //   156: aload_0
        //   157: getfield 18	com/tencent/token/rv$4:b	Lcom/tencent/token/rv;
        //   160: getfield 30	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
  ...
  public final void b(final Handler paramHandler)
  {
    ...
    this.b.post(new Runnable()
    {
      ...
      public final void run()
      {
        // Byte code:
        //   0: aload_0
        //   1: getfield 18	com/tencent/token/rv$5:b	Lcom/tencent/token/rv;
        //   4: getfield 30	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        //   7: invokevirtual 35	java/util/concurrent/locks/ReentrantLock:lock	()V
        //   10: new 37	java/lang/StringBuilder
        //   13: dup
        ...
        //   50: putfield 74	com/tencent/token/wz:a	I
        //   53: aload_0
        //   54: getfield 20	com/tencent/token/rv$5:a	Landroid/os/Handler;
        //   57: sipush 4016
        //   60: invokevirtual 80	android/os/Handler:obtainMessage	(I)Landroid/os/Message;
        //   63: astore_2
        //   64: aload_2
        ...
        //   106: invokestatic 68	com/tmsdk/common/util/TmsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
        //   109: aload_0
        //   110: getfield 18	com/tencent/token/rv$5:b	Lcom/tencent/token/rv;
        //   113: getfield 30	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        //   116: invokevirtual 102	java/util/concurrent/locks/ReentrantLock:unlock	()V
        //   119: return
        //   120: astore_1
        ...
        //   142: invokestatic 106	com/tmsdk/common/util/TmsLog:w	(Ljava/lang/String;Ljava/lang/String;)V
        //   145: aload_0
        //   146: getfield 18	com/tencent/token/rv$5:b	Lcom/tencent/token/rv;
        //   149: getfield 30	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        //   152: invokevirtual 102	java/util/concurrent/locks/ReentrantLock:unlock	()V
        //   155: return
        //   156: aload_0
        //   157: getfield 18	com/tencent/token/rv$5:b	Lcom/tencent/token/rv;
        //   160: getfield 30	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        //   163: invokevirtual 102	java/util/concurrent/locks/ReentrantLock:unlock	()V
        //   166: goto +13 -> 179
        //   169: astore_2
  ...
  public final wz c()
  {
    ...
    this.b.post(new Runnable()
    {
      ...
      public final void run()
      {
        // Byte code:
        //   0: aload_0
        //   1: getfield 21	com/tencent/token/rv$6:a	Ljava/util/concurrent/atomic/AtomicReference;
        //   4: aload_0
        //   5: getfield 19	com/tencent/token/rv$6:b	Lcom/tencent/token/rv;
        //   8: invokevirtual 31	com/tencent/token/rv:d	()Lcom/tencent/token/wz;
        //   11: invokevirtual 37	java/util/concurrent/atomic/AtomicReference:set	(Ljava/lang/Object;)V
        //   14: aload_0
        //   15: getfield 21	com/tencent/token/rv$6:a	Ljava/util/concurrent/atomic/AtomicReference;
        //   18: astore_1
        //   19: aload_1
        //   20: monitorenter
        //   21: aload_0
        //   22: getfield 21	com/tencent/token/rv$6:a	Ljava/util/concurrent/atomic/AtomicReference;
        ...
        //   50: aload_0
        //   51: getfield 21	com/tencent/token/rv$6:a	Ljava/util/concurrent/atomic/AtomicReference;
        //   54: astore_1
        //   55: aload_1
        //   56: monitorenter
        //   57: aload_0
        //   58: getfield 21	com/tencent/token/rv$6:a	Ljava/util/concurrent/atomic/AtomicReference;
        ...
        //   71: athrow
        //   72: aload_0
        //   73: getfield 21	com/tencent/token/rv$6:a	Ljava/util/concurrent/atomic/AtomicReference;
        //   76: astore_1
        //   77: aload_1
        //   78: monitorenter
        //   79: aload_0
        //   80: getfield 21	com/tencent/token/rv$6:a	Ljava/util/concurrent/atomic/AtomicReference;
    ...
    if (localAtomicReference.get() == null)
    {
      ...
      localAtomicReference.set(localwz);
    }
    return (wz)localAtomicReference.get();
    throw localwz;
  }
  ...
  public final void c(final Handler paramHandler)
  {
    ...
    this.b.post(new Runnable()
    {
      ...
      public final void run()
      {
        // Byte code:
        //   0: aload_0
        //   1: getfield 19	com/tencent/token/rv$7:b	Lcom/tencent/token/rv;
        //   4: getfield 31	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        //   7: invokevirtual 36	java/util/concurrent/locks/ReentrantLock:lock	()V
        //   10: aload_0
        //   11: getfield 19	com/tencent/token/rv$7:b	Lcom/tencent/token/rv;
        //   14: invokevirtual 40	com/tencent/token/rv:d	()Lcom/tencent/token/wz;
        //   17: astore_1
        //   18: aload_0
        //   19: getfield 21	com/tencent/token/rv$7:a	Landroid/os/Handler;
        //   22: sipush 3003
        //   25: invokevirtual 46	android/os/Handler:obtainMessage	(I)Landroid/os/Message;
        //   28: astore_2
        //   29: aload_2
        //   30: aload_1
        //   31: getfield 51	com/tencent/token/wz:a	I
        ...
        //   56: aload_2
        //   57: aload_1
        //   58: getfield 51	com/tencent/token/wz:a	I
        ...
        //   74: aload_0
        //   75: getfield 19	com/tencent/token/rv$7:b	Lcom/tencent/token/rv;
        //   78: getfield 31	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        ...
        //   110: aload_0
        //   111: getfield 19	com/tencent/token/rv$7:b	Lcom/tencent/token/rv;
        //   114: getfield 31	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
        //   117: invokevirtual 89	java/util/concurrent/locks/ReentrantLock:unlock	()V
        //   120: return
        //   121: aload_0
        //   122: getfield 19	com/tencent/token/rv$7:b	Lcom/tencent/token/rv;
        //   125: getfield 31	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
  ...
  final wz d()
  {
    ...
    //   31: aload_0
    //   32: getfield 45	com/tencent/token/rv:c	Ljava/util/concurrent/ConcurrentHashMap;
    //   35: ldc 248
    ...
    //   50: aload_0
    //   51: getfield 45	com/tencent/token/rv:c	Ljava/util/concurrent/ConcurrentHashMap;
    //   54: ldc 248
    ...
    //   69: lcmp
    //   70: ifge +22 -> 92
    //   73: new 80	com/tencent/token/wz
    //   76: dup
    //   77: invokespecial 81	com/tencent/token/wz:<init>	()V
    //   80: astore_2
    //   81: aload_2
    //   82: sipush 10006
    //   85: aconst_null
    //   86: aconst_null
    //   87: invokevirtual 145	com/tencent/token/wz:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   90: aload_2
    //   91: areturn
    //   92: aload_0
    //   93: getfield 40	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
    ...
    //   116: astore_3
    //   117: invokestatic 161	com/tencent/token/qz:a	()Lcom/tencent/token/qz;
    //   120: new 22	com/tencent/token/rv$9
    //   123: dup
    //   124: aload_0
    //   125: aload_3
    //   126: aload 4
    //   128: invokespecial 259	com/tencent/token/rv$9:<init>	(Lcom/tencent/token/rv;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/CountDownLatch;)V
    //   131: invokevirtual 262	com/tencent/token/qz:a	(Lcom/tencent/token/qz$a;)V
    //   134: aload 4
    ...
    //   153: checkcast 80	com/tencent/token/wz
    //   156: astore_3
    ...
    //   168: aload_2
    //   169: aload_3
    //   170: getfield 84	com/tencent/token/wz:a	I
    ...
    //   186: aload_0
    //   187: getfield 45	com/tencent/token/rv:c	Ljava/util/concurrent/ConcurrentHashMap;
    //   190: ldc 248
    ...
    //   201: pop
    //   202: aload_0
    //   203: getfield 40	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
    ...
    //   247: aload_0
    //   248: getfield 40	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
    ...
    //   268: areturn
    //   269: aload_0
    //   270: getfield 40	com/tencent/token/rv:a	Ljava/util/concurrent/locks/ReentrantLock;
  ...
  {
    private static rv a = new rv((byte)0);
  }
}
