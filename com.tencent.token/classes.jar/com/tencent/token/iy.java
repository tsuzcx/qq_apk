  ...
  implements AdapterView.OnItemSelectedListener
{
  ...
  protected final void onConfigurationChanged(Configuration paramConfiguration)
  {
    ...
    paramConfiguration = gv.a(getContext());
    TypedArray localTypedArray = paramConfiguration.a.obtainStyledAttributes(null, go.j.ActionBar, go.a.actionBarStyle, 0);
    int k = localTypedArray.getLayoutDimension(go.j.ActionBar_height, 0);
    Resources localResources = paramConfiguration.a.getResources();
    int j = k;
    if (!paramConfiguration.b()) {
      j = Math.min(k, localResources.getDimensionPixelSize(go.d.abc_action_bar_stacked_max_height));
    }
    localTypedArray.recycle();
    setContentHeight(j);
    this.d = paramConfiguration.a.getResources().getDimensionPixelSize(go.d.abc_action_bar_stacked_tab_max_width);
  }
    ...
    if (paramInt2 != 0)
    {
      ...
      if (this.b.getMeasuredWidth() > View.MeasureSpec.getSize(paramInt1))
      {
        if (!a())
        {
          if (this.f == null)
          {
            localObject = new AppCompatSpinner(getContext(), null, go.a.actionDropDownStyle);
      ...
      if (bool)
      {
        ...
        this.a = new Runnable()
        {
          public final void run()
          {
            ...
            int j = (iy.this.getWidth() - this.a.getWidth()) / 2;
            iy.this.smoothScrollTo(i - j, 0);
            iy.this.a = null;
          }
        };
        post(this.a);
    ...
    extends BaseAdapter
  {
    ...
    {
      return iy.this.b.getChildCount();
    }
    
    public final Object getItem(int paramInt)
    {
      return ((iy.b)iy.this.b.getChildAt(paramInt)).a;
    }
    ...
    extends LinearLayout
  {
    ...
    {
      super(null, go.a.actionBarTabStyle);
      this.a = parama;
      this$1 = je.a(paramContext, null, this.c, go.a.actionBarTabStyle, 0);
      if (iy.this.f(0)) {
        setBackgroundDrawable(iy.this.a(0));
      }
      iy.this.a.recycle();
      setGravity(8388627);
      a();
    ...
    public final void a()
    {
      ...
      if (bool)
      {
        if (this.d == null)
        {
          localObject3 = new AppCompatTextView(getContext(), null, go.a.actionBarTabTextStyle);
    ...
    public final void onMeasure(int paramInt1, int paramInt2)
    {
      ...
      if ((iy.this.c > 0) && (getMeasuredWidth() > iy.this.c)) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(iy.this.c, 1073741824), paramInt2);
      }
    }
