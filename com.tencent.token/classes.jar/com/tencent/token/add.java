...
public final class add
  extends Thread
{
  public add(adf paramadf) {}
  
  public final void run()
  {
    Context localContext = aez.a();
    adw.a(localContext, adf.a(this.a));
    try
    {
      Thread.sleep(5000L);
      label23:
      adf.a(this.a, localContext);
      if (adq.a.a(Gooseberry.mk.value))
      {
        ...
        for (;;)
        {
          try
          {
            localObject = new String(aez.c("/proc/self/maps"));
            ...
            if (bool)
            {
              ...
              if (bool)
              {
                ...
                if ((!bool) && (!TextUtils.equals("/system/framework/framework-res.apk", str)) && (!localHashSet.contains(str)))
                {
                  ...
                  localObject = aez.a(localContext, str);
                  if (localObject != null)
                  {
        ...
        adf.a(this.a).a(localContext, "405", (String)localObject, true);
      }
      localObject = this.a;
      adf.a((adf)localObject, adf.b((adf)localObject).a, false);
      return;
    }
