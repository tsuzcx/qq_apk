  ...
  implements adw
{
  ...
  private static int a(Context paramContext, AtomicReference<IBinder> paramAtomicReference, final AtomicReference<ServiceConnection> paramAtomicReference1)
  {
    ...
    Intent localIntent = new Intent(aff.a(aff.k));
    localIntent.setComponent(new ComponentName(aff.a(aff.g), aff.a(aff.h)));
  ...
  private aea c(Context paramContext)
  {
    ...
    i = -1;
    return new aea((String)localAtomicReference1.get(), i);
  }
  
  public final aea a(Context paramContext)
  {
    aea localaea = this.a;
    if ((localaea == null) || (localaea.b != 0)) {
    ...
    extends Thread
  {
    ...
    public final void run()
    {
      ...
      try
      {
        String str = aec.this.a((IBinder)paramAtomicReference.get());
        ??? = str;
      }
