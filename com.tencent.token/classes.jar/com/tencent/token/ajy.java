...
public final class ajy
{
  ...
  private ajy(String paramString1, String paramString2, long paramLong, String paramString3, String paramString4, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    this.a = paramString1;
    this.b = paramString2;
    this.g = paramLong;
  ...
  @Nullable
  private static ajy a(long paramLong, akf paramakf, String paramString)
  {
    int i7 = paramString.length();
    int n = akt.a(paramString, 0, i7, ';');
    int i1 = akt.a(paramString, 0, n, '=');
    localObject4 = null;
    if (i1 == n) {
      return null;
    }
    String str1 = akt.c(paramString, 0, i1);
    if ((!str1.isEmpty()) && (akt.b(str1) == -1))
    {
      String str2 = akt.c(paramString, i1 + 1, n);
      if (akt.b(str2) != -1) {
        return null;
      }
      n += 1;
      ...
      {
        int i8 = akt.a(paramString, n, i7, ';');
        i1 = akt.a(paramString, n, i8, '=');
        String str3 = akt.c(paramString, n, i1);
        if (i1 < i8) {
          localObject1 = akt.c(paramString, i1 + 1, i8);
        } else {
          localObject1 = "";
        }
        ...
        try
        {
          localObject1 = new GregorianCalendar(akt.g);
        ...
        else if (str3.equalsIgnoreCase("domain"))
        {
          if (!((String)localObject1).endsWith("."))
          {
            ...
            localObject1 = akt.a((String)localObject5);
      ...
      Object localObject1 = paramakf.b;
      ...
      else
      {
        if (((String)localObject1).equals(localObject4)) {
          n = 1;
        } else if ((((String)localObject1).endsWith(localObject4)) && (((String)localObject1).charAt(((String)localObject1).length() - localObject4.length() - 1) == '.') && (!akt.c((String)localObject1))) {
          n = 1;
        } else {
          n = 0;
        }
      ...
      {
        paramakf = localObject3;
      }
      else
      {
        paramakf = paramakf.e();
        n = paramakf.lastIndexOf('/');
        if (n != 0) {
          paramakf = paramakf.substring(0, n);
        } else {
          paramakf = "/";
        }
      }
      return new ajy(str1, str2, paramLong, paramString, paramakf, bool4, bool5, bool2, bool3);
    }
    else
    {
      return null;
  ...
  public static List<ajy> a(akf paramakf, ake paramake)
  {
    int i2 = paramake.a.length / 2;
    int i1 = 0;
    ajy localajy = null;
    ...
    while (n < i2)
    {
      ...
      if ("Set-Cookie".equalsIgnoreCase(paramake.a(n)))
      {
        localObject2 = localObject1;
        if (localObject1 == null) {
          localObject2 = new ArrayList(2);
        }
        ((List)localObject2).add(paramake.b(n));
      }
      n += 1;
    ...
    while (n < i2)
    {
      ...
      localajy = a(System.currentTimeMillis(), paramakf, (String)localObject1);
      ...
      if (localajy != null)
      {
        ...
        ((List)localObject1).add(localajy);
      }
      n += 1;
      paramake = (ake)localObject1;
    }
    if (paramake != null) {
      return Collections.unmodifiableList(paramake);
    }
  ...
  public final String toString()
  {
    ...
    if (this.l) {
      ...
      else
      {
        ...
        localStringBuilder.append(alj.a(new Date(this.g)));
      }
    }
    if (!this.m)
    {
