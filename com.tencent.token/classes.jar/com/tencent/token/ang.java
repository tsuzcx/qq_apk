  ...
  extends anl
{
  ...
  private final ank<Socket> b;
  private final ank<Socket> d;
  private final ank<Socket> e;
  private final ank<Socket> f;
  private final c g = c.a();
  
  private ang(Class<?> paramClass, ank<Socket> paramank1, ank<Socket> paramank2, ank<Socket> paramank3, ank<Socket> paramank4)
  {
    this.a = paramClass;
    this.b = paramank1;
    this.d = paramank2;
    ...
    for (;;)
    {
      ...
      catch (ClassNotFoundException localClassNotFoundException1)
      {
        try
        {
          ...
          ank localank3 = new ank(null, "setUseSessionTickets", new Class[] { Boolean.TYPE });
          ank localank4 = new ank(null, "setHostname", new Class[] { String.class });
          if (!d()) {
            break label125;
          }
          localank1 = new ank([B.class, "getAlpnSelectedProtocol", new Class[0]);
          localank2 = new ank(null, "setAlpnProtocols", new Class[] { [B.class });
          localObject = new ang((Class)localObject, localank3, localank4, localank1, localank2);
          return localObject;
        }
  ...
  public final ano a(X509TrustManager paramX509TrustManager)
  {
    try
    {
  ...
  public final String a(SSLSocket paramSSLSocket)
  {
    ...
    if (!localank.a(paramSSLSocket)) {
      return null;
    }
    paramSSLSocket = (byte[])this.e.b(paramSSLSocket, new Object[0]);
    if (paramSSLSocket != null) {
      return new String(paramSSLSocket, alr.e);
    }
    return null;
  }
  ...
  public final void a(SSLSocket paramSSLSocket, String paramString, List<alh> paramList)
  {
    ...
    if ((paramString != null) && (paramString.a(paramSSLSocket)))
    {
      ...
      while (i < j)
      {
        ...
        if (localalh != alh.a)
        {
          paramString.b(localalh.toString().length());
          paramString.a(localalh.toString());
        }
        i += 1;
      }
  ...
  public final anq b(X509TrustManager paramX509TrustManager)
  {
    try
    {
  ...
  public final boolean b(String paramString)
  {
    try
    {
      ...
      throw alr.a("unable to determine cleartext support", paramString);
    }
    ...
    implements anq
  {
    ...
    public final X509Certificate a(X509Certificate paramX509Certificate)
    {
      ...
      {
        throw alr.a("unable to get issues and signature", paramX509Certificate);
      }
