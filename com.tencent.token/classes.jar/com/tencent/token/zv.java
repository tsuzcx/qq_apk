  ...
  implements Handler.Callback
{
  ...
  private volatile abj h;
  private volatile abj i;
  private volatile abj j;
  private volatile boolean k = false;
  private HandlerThread l;
  private Handler m;
  
  private zv(int paramInt, abl paramabl, zw paramzw)
  {
    super(paramInt, paramabl);
    this.a = paramzw;
    this.g = new abj();
    this.h = new abj();
    this.i = this.g;
    this.j = this.h;
    this.f = new char[paramzw.c];
    b();
    this.l = new HandlerThread(paramzw.b, paramzw.f);
    paramabl = this.l;
    if (paramabl != null) {
      paramabl.start();
    }
    ...
    this.m.postDelayed(new Runnable()
    {
      ...
      {
        zw localzw = zv.this.a;
        if (localzw.e != null)
        {
          File[] arrayOfFile = localzw.e.listFiles(zw.a);
          if (arrayOfFile != null)
          {
            ...
            while (i < j)
            {
              ...
              long l = zw.a(localFile);
              if (System.currentTimeMillis() - l > localzw.h) {
                zx.a(localFile);
              }
              i += 1;
            }
  ...
  public zv(zw paramzw)
  {
    this(wx.a.h, abl.a, paramzw);
  }
  ...
  public final void a(int paramInt, Thread paramThread, long paramLong, String paramString1, String paramString2)
  {
    ...
    localStringBuilder.append(abl.a(paramInt));
  ...
  public final boolean handleMessage(android.os.Message paramMessage)
  {
    ...
    //   15: aload_0
    //   16: getfield 73	com/tencent/token/zv:l	Landroid/os/HandlerThread;
    //   19: if_acmpne +192 -> 211
    //   22: aload_0
    //   23: getfield 34	com/tencent/token/zv:k	Z
    //   26: ifne +185 -> 211
    //   29: aload_0
    //   30: iconst_1
    //   31: putfield 34	com/tencent/token/zv:k	Z
    //   34: aconst_null
    //   35: astore 4
    //   37: aconst_null
    //   38: astore 5
    ...
    //   43: monitorenter
    //   44: aload_0
    //   45: getfield 47	com/tencent/token/zv:i	Lcom/tencent/token/abj;
    //   48: aload_0
    //   49: getfield 43	com/tencent/token/zv:g	Lcom/tencent/token/abj;
    //   52: if_acmpne +22 -> 74
    //   55: aload_0
    //   56: aload_0
    //   57: getfield 45	com/tencent/token/zv:h	Lcom/tencent/token/abj;
    //   60: putfield 47	com/tencent/token/zv:i	Lcom/tencent/token/abj;
    //   63: aload_0
    //   64: aload_0
    //   65: getfield 43	com/tencent/token/zv:g	Lcom/tencent/token/abj;
    //   68: putfield 49	com/tencent/token/zv:j	Lcom/tencent/token/abj;
    //   71: goto +19 -> 90
    //   74: aload_0
    //   75: aload_0
    //   76: getfield 43	com/tencent/token/zv:g	Lcom/tencent/token/abj;
    //   79: putfield 47	com/tencent/token/zv:i	Lcom/tencent/token/abj;
    //   82: aload_0
    //   83: aload_0
    //   84: getfield 45	com/tencent/token/zv:h	Lcom/tencent/token/abj;
    //   87: putfield 49	com/tencent/token/zv:j	Lcom/tencent/token/abj;
    //   90: aload_0
    //   91: monitorexit
    //   92: aload 4
    //   94: astore_3
    ...
    //   97: astore_1
    //   98: aload_0
    //   99: invokespecial 61	com/tencent/token/zv:b	()Ljava/io/FileOutputStream;
    //   102: astore 6
    //   104: aload 6
    //   106: ifnull +50 -> 156
    //   109: aload 4
    ...
    //   142: astore_1
    //   143: aload_0
    //   144: getfield 49	com/tencent/token/zv:j	Lcom/tencent/token/abj;
    //   147: aload 4
    //   149: aload_0
    //   150: getfield 57	com/tencent/token/zv:f	[C
    //   153: invokevirtual 280	com/tencent/token/abj:a	(Ljava/io/Writer;[C)V
    //   156: aload_2
    //   157: ifnull +34 -> 191
    //   160: aload_2
    //   161: astore_1
    ...
    //   174: aload_0
    //   175: getfield 49	com/tencent/token/zv:j	Lcom/tencent/token/abj;
    //   178: invokevirtual 286	com/tencent/token/abj:a	()V
    //   181: aload_1
    //   182: athrow
    //   183: aload_1
    //   184: ifnull +7 -> 191
    ...
    //   191: aload_0
    //   192: getfield 49	com/tencent/token/zv:j	Lcom/tencent/token/abj;
    //   195: invokevirtual 286	com/tencent/token/abj:a	()V
    //   198: aload_0
    //   199: iconst_0
    //   200: putfield 34	com/tencent/token/zv:k	Z
    //   203: goto +8 -> 211
    //   206: astore_1
    //   207: aload_0
    //   208: monitorexit
    ...
    //   210: athrow
    //   211: aload_0
    //   212: invokespecial 93	com/tencent/token/zv:a	()V
    //   215: iconst_1
    //   216: ireturn
    //   217: astore_2
    //   218: goto -35 -> 183
