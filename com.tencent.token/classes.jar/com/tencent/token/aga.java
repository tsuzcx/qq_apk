  ...
  implements aft
{
  ...
  private static int a(Context arg0, AtomicReference<IBinder> paramAtomicReference, final AtomicReference<ServiceConnection> paramAtomicReference1)
  {
    ...
    //   11: dup
    //   12: getstatic 26	com/tencent/token/afz:k	[I
    //   15: invokestatic 29	com/tencent/token/afz:a	([I)Ljava/lang/String;
    //   18: invokespecial 32	android/content/Intent:<init>	(Ljava/lang/String;)V
    //   21: astore 4
    //   23: aload 4
    //   25: new 34	android/content/ComponentName
    //   28: dup
    //   29: getstatic 37	com/tencent/token/afz:g	[I
    //   32: invokestatic 29	com/tencent/token/afz:a	([I)Ljava/lang/String;
    //   35: getstatic 40	com/tencent/token/afz:h	[I
    //   38: invokestatic 29	com/tencent/token/afz:a	([I)Ljava/lang/String;
    ...
    //   48: aload_0
    //   49: aload 4
    //   51: new 8	com/tencent/token/aga$a
    //   54: dup
    //   55: aload_1
    //   56: aload_2
    //   57: aload_3
    //   58: invokespecial 50	com/tencent/token/aga$a:<init>	(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;)V
    //   61: iconst_1
  ...
  private int a(Context arg1, final AtomicReference<IBinder> paramAtomicReference, final AtomicReference<ServiceConnection> paramAtomicReference1, final AtomicReference<String> paramAtomicReference2)
  {
    ...
    //   20: astore 6
    //   22: new 10	com/tencent/token/aga$b
    //   25: dup
    //   26: aload_0
    //   27: aload_2
    //   28: aload 6
    ...
    //   33: aload_3
    //   34: aload 5
    //   36: invokespecial 83	com/tencent/token/aga$b:<init>	(Lcom/tencent/token/aga;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;Landroid/content/Context;Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;)V
  ...
  /* Error */
  private afy c(Context paramContext)
  {
    // Byte code:
    ...
    //   35: aload 5
    //   37: aload 6
    //   39: invokestatic 103	com/tencent/token/aga:a	(Landroid/content/Context;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;)I
    //   42: istore_3
    //   43: iload_3
    //   44: istore_2
    //   45: iload_3
    ...
    //   53: aload 6
    //   55: aload 4
    //   57: invokespecial 105	com/tencent/token/aga:a	(Landroid/content/Context;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;)I
    //   60: istore_2
    //   61: goto +5 -> 66
    //   64: iconst_m1
    //   65: istore_2
    //   66: new 107	com/tencent/token/afy
    //   69: dup
    //   70: aload 4
    //   72: invokevirtual 62	java/util/concurrent/atomic/AtomicReference:get	()Ljava/lang/Object;
    //   75: checkcast 109	java/lang/String
    //   78: iload_2
    //   79: invokespecial 112	com/tencent/token/afy:<init>	(Ljava/lang/String;I)V
    //   82: areturn
    //   83: astore_1
    //   84: goto -20 -> 64
    //   87: astore_1
    ...
    implements ServiceConnection
  {
    ...
    public final void onServiceConnected(ComponentName paramComponentName, IBinder arg2)
    {
      // Byte code:
      //   0: aload_0
      //   1: getfield 19	com/tencent/token/aga$a:a	Ljava/util/concurrent/atomic/AtomicReference;
      //   4: aload_2
      //   5: invokevirtual 35	java/util/concurrent/atomic/AtomicReference:set	(Ljava/lang/Object;)V
      //   8: aload_0
      //   9: getfield 21	com/tencent/token/aga$a:b	Ljava/util/concurrent/atomic/AtomicReference;
      //   12: aload_0
      //   13: invokevirtual 35	java/util/concurrent/atomic/AtomicReference:set	(Ljava/lang/Object;)V
      //   16: aload_0
      //   17: getfield 23	com/tencent/token/aga$a:c	Ljava/lang/Object;
      //   20: astore_1
      //   21: aload_1
      //   22: monitorenter
      //   23: aload_0
      //   24: getfield 23	com/tencent/token/aga$a:c	Ljava/lang/Object;
    ...
    extends Thread
  {
    ...
    public final void run()
    {
      ...
      //   2: astore_1
      //   3: aload_0
      //   4: getfield 23	com/tencent/token/aga$b:g	Lcom/tencent/token/aga;
      //   7: aload_0
      //   8: getfield 25	com/tencent/token/aga$b:a	Ljava/util/concurrent/atomic/AtomicReference;
      //   11: invokevirtual 48	java/util/concurrent/atomic/AtomicReference:get	()Ljava/lang/Object;
      //   14: checkcast 50	android/os/IBinder
      //   17: invokevirtual 53	com/tencent/token/aga:a	(Landroid/os/IBinder;)Ljava/lang/String;
      //   20: astore_2
      //   21: aload_2
      //   22: astore_1
      //   23: goto +15 -> 38
      //   26: aload_0
      //   27: getfield 27	com/tencent/token/aga$b:b	Ljava/util/concurrent/atomic/AtomicReference;
      //   30: bipush 154
      ...
      //   38: aload_0
      //   39: getfield 29	com/tencent/token/aga$b:c	Ljava/util/concurrent/atomic/AtomicReference;
      //   42: aload_1
      //   43: invokevirtual 63	java/util/concurrent/atomic/AtomicReference:set	(Ljava/lang/Object;)V
      //   46: aload_0
      //   47: getfield 31	com/tencent/token/aga$b:d	Landroid/content/Context;
      //   50: aload_0
      //   51: getfield 33	com/tencent/token/aga$b:e	Ljava/util/concurrent/atomic/AtomicReference;
      ...
      //   63: goto +15 -> 78
      //   66: aload_0
      //   67: getfield 27	com/tencent/token/aga$b:b	Ljava/util/concurrent/atomic/AtomicReference;
      //   70: bipush 153
      ...
      //   78: aload_0
      //   79: getfield 35	com/tencent/token/aga$b:f	Ljava/lang/Object;
      //   82: astore_1
      //   83: aload_1
      //   84: monitorenter
      //   85: aload_0
      //   86: getfield 35	com/tencent/token/aga$b:f	Ljava/lang/Object;
