  ...
  extends cj
{
  ...
  public static ck a(Resources paramResources, int paramInt, Resources.Theme paramTheme)
  {
    Object localObject;
    if (Build.VERSION.SDK_INT >= 24)
    {
      ...
      ((ck)localObject).b = paramResources;
      ((ck)localObject).h = new g(((ck)localObject).b.getConstantState());
      return localObject;
    }
    try
    {
  ...
  public static ck a(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    ck localck = new ck();
    localck.inflate(paramResources, paramXmlPullParser, paramAttributeSet, paramTheme);
    return localck;
  }
  ...
  private void b(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    ...
    for (int m = 1; (i1 != 1) && ((paramXmlPullParser.getDepth() >= i2 + 1) || (i1 != 3)); m = n)
    {
      if (i1 == 2)
      {
        ...
        {
          localObject = new b();
          localTypedArray = dp.a(paramResources, paramTheme, paramAttributeSet, cc.c);
        ...
        else if ("clip-path".equals(localObject))
        {
          ...
          {
            localTypedArray = dp.a(paramResources, paramTheme, paramAttributeSet, cc.d);
        ...
        else
        {
          ...
          {
            localObject = new c();
            localTypedArray = dp.a(paramResources, paramTheme, paramAttributeSet, cc.b);
            ((c)localObject).l = null;
            ((c)localObject).c = dp.a(localTypedArray, paramXmlPullParser, "rotation", 5, ((c)localObject).c);
            ((c)localObject).d = localTypedArray.getFloat(1, ((c)localObject).d);
            ((c)localObject).e = localTypedArray.getFloat(2, ((c)localObject).e);
            ((c)localObject).f = dp.a(localTypedArray, paramXmlPullParser, "scaleX", 3, ((c)localObject).f);
            ((c)localObject).g = dp.a(localTypedArray, paramXmlPullParser, "scaleY", 4, ((c)localObject).g);
            ((c)localObject).h = dp.a(localTypedArray, paramXmlPullParser, "translateX", 6, ((c)localObject).h);
            ((c)localObject).i = dp.a(localTypedArray, paramXmlPullParser, "translateY", 7, ((c)localObject).i);
  ...
  public final void inflate(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    ...
    f localf1 = this.c;
    localf1.b = new e();
    TypedArray localTypedArray = dp.a(paramResources, paramTheme, paramAttributeSet, cc.a);
    f localf2 = this.c;
    e locale = localf2.b;
    int m = dp.a(localTypedArray, paramXmlPullParser, "tintMode", 6, -1);
    ...
    if (dp.a(paramXmlPullParser, "autoMirrored")) {
      bool = localTypedArray.getBoolean(5, bool);
    }
    localf2.e = bool;
    locale.d = dp.a(localTypedArray, paramXmlPullParser, "viewportWidth", 7, locale.d);
    locale.e = dp.a(localTypedArray, paramXmlPullParser, "viewportHeight", 8, locale.e);
    if (locale.d > 0.0F)
    {
      if (locale.e > 0.0F)
      {
        ...
        if (locale.b > 0.0F)
        {
          if (locale.c > 0.0F)
          {
            locale.setAlpha(dp.a(localTypedArray, paramXmlPullParser, "alpha", 4, locale.getAlpha()));
    ...
    extends ck.d
  {
    ...
    final void a(TypedArray paramTypedArray, XmlPullParser paramXmlPullParser)
    {
      ...
      if (localObject != null) {
        this.m = dr.b((String)localObject);
      }
      this.c = dp.b(paramTypedArray, paramXmlPullParser, "fillColor", 1, this.c);
      this.f = dp.a(paramTypedArray, paramXmlPullParser, "fillAlpha", 12, this.f);
      int m = dp.a(paramTypedArray, paramXmlPullParser, "strokeLineCap", 8, -1);
      localObject = this.j;
      switch (m)
      {
      default: 
      ...
      m = dp.a(paramTypedArray, paramXmlPullParser, "strokeLineJoin", 9, -1);
      localObject = this.k;
      switch (m)
      {
      default: 
      ...
      this.l = dp.a(paramTypedArray, paramXmlPullParser, "strokeMiterLimit", 10, this.l);
      this.a = dp.b(paramTypedArray, paramXmlPullParser, "strokeColor", 3, this.a);
      this.d = dp.a(paramTypedArray, paramXmlPullParser, "strokeAlpha", 11, this.d);
      this.b = dp.a(paramTypedArray, paramXmlPullParser, "strokeWidth", 4, this.b);
      this.h = dp.a(paramTypedArray, paramXmlPullParser, "trimPathEnd", 6, this.h);
      this.i = dp.a(paramTypedArray, paramXmlPullParser, "trimPathOffset", 7, this.i);
      this.g = dp.a(paramTypedArray, paramXmlPullParser, "trimPathStart", 5, this.g);
      this.e = dp.a(paramTypedArray, paramXmlPullParser, "fillType", 13, this.e);
    }
  ...
  static final class c
  {
    ...
    public c(c paramc, em<String, Object> paramem)
    {
      this.c = paramc.c;
      this.d = paramc.d;
      this.e = paramc.e;
      ...
      while (n < ((ArrayList)localObject).size())
      {
        ...
        {
          paramc = (c)paramc;
          this.b.add(new c(paramc, paramem));
        }
        else
        {
          if ((paramc instanceof ck.b))
          {
            paramc = new ck.b((ck.b)paramc);
          }
          else
          {
            if (!(paramc instanceof ck.a)) {
              break label317;
            }
            paramc = new ck.a((ck.a)paramc);
          }
          this.b.add(paramc);
          if (paramc.n != null) {
            paramem.put(paramc.n, paramc);
          }
        }
        n += 1;
        continue;
  ...
  static class d
  {
    ...
    public d(d paramd)
    {
      this.n = paramd.n;
      this.o = paramd.o;
      this.m = dr.a(paramd.m);
    }
    
    public final void a(Path paramPath)
    {
      paramPath.reset();
      dr.b[] arrayOfb = this.m;
      if (arrayOfb != null) {
        dr.b.a(arrayOfb, paramPath);
      }
    }
    ...
    public void setPathData(dr.b[] paramArrayOfb)
    {
      if (!dr.a(this.m, paramArrayOfb))
      {
        this.m = dr.a(paramArrayOfb);
        return;
      }
      dr.b[] arrayOfb = this.m;
      int i = 0;
  ...
  static final class e
  {
    ...
    int f = 255;
    String g = null;
    final em<String, Object> h = new em();
    ...
    public e(e parame)
    {
      this.a = new ck.c(parame.a, this.h);
    ...
    private void a(ck.c paramc, Matrix paramMatrix, Canvas paramCanvas, int paramInt1, int paramInt2, ColorFilter paramColorFilter)
    {
      ...
      while (i1 < paramc.b.size())
      {
        ...
        if ((localObject1 instanceof ck.c))
        {
          a((ck.c)localObject1, paramc.a, paramCanvas, paramInt1, paramInt2, paramColorFilter);
        }
        else if ((localObject1 instanceof ck.d))
        {
          Object localObject2 = (ck.d)localObject1;
          ...
          {
            localObject1 = this;
            ((ck.d)localObject2).a(((e)localObject1).i);
            paramMatrix = ((e)localObject1).i;
            ((e)localObject1).j.reset();
            if (((ck.d)localObject2).a())
            {
            ...
            {
              localObject2 = (ck.b)localObject2;
              if ((((ck.b)localObject2).g != 0.0F) || (((ck.b)localObject2).h != 1.0F))
              {
                f6 = ((ck.b)localObject2).g;
                f7 = ((ck.b)localObject2).i;
                f4 = ((ck.b)localObject2).h;
                f5 = ((ck.b)localObject2).i;
              ...
              if (((ck.b)localObject2).c != 0)
              {
                ...
                localPaint.setColor(ck.a(((ck.b)localObject2).c, ((ck.b)localObject2).f));
                localPaint.setColorFilter(paramColorFilter);
                Path localPath = ((e)localObject1).j;
                if (((ck.b)localObject2).e == 0) {
              ...
              if (((ck.b)localObject2).a != 0)
              {
                ...
                if (((ck.b)localObject2).k != null) {
                  paramMatrix.setStrokeJoin(((ck.b)localObject2).k);
                }
                if (((ck.b)localObject2).j != null) {
                  paramMatrix.setStrokeCap(((ck.b)localObject2).j);
                }
                paramMatrix.setStrokeMiter(((ck.b)localObject2).l);
                paramMatrix.setColor(ck.a(((ck.b)localObject2).a, ((ck.b)localObject2).d));
                paramMatrix.setColorFilter(paramColorFilter);
                paramMatrix.setStrokeWidth(((ck.b)localObject2).b * (f1 * f2));
    ...
    extends Drawable.ConstantState
  {
    ...
    public f(f paramf)
    {
      ...
      {
        this.a = paramf.a;
        this.b = new ck.e(paramf.b);
        if (ck.e.a(paramf.b) != null) {
          ck.e.a(this.b, new Paint(ck.e.a(paramf.b)));
        }
        if (ck.e.b(paramf.b) != null) {
          ck.e.b(this.b, new Paint(ck.e.b(paramf.b)));
        }
        this.c = paramf.c;
        this.d = paramf.d;
        this.e = paramf.e;
    ...
    extends Drawable.ConstantState
  {
    ...
    {
      ck localck = new ck();
      localck.b = ((VectorDrawable)this.a.newDrawable());
      return localck;
    }
    ...
    {
      ck localck = new ck();
      localck.b = ((VectorDrawable)this.a.newDrawable(paramResources));
      return localck;
    }
    ...
    {
      ck localck = new ck();
      localck.b = ((VectorDrawable)this.a.newDrawable(paramResources, paramTheme));
      return localck;
    }
  }
}
