  ...
  extends BitmapDrawable
{
  ...
  public static Map<String, zz> d;
  public static Map<String, String> e;
  public static boolean f = false;
  private static boolean h;
  private BitmapDrawable g;
  
  private zz(final String paramString1, final String paramString2)
  {
    this.g = new BitmapDrawable(a);
    new UserTask() {}.a(new String[] { "" });
  }
  
  private zz(final String paramString1, final String paramString2, final String paramString3, Bitmap paramBitmap)
  {
  ...
  public static BitmapDrawable a(String paramString1, String paramString2)
  {
    ...
    if (paramString2 != null)
    {
      xb.a("face:from cache");
      localObject = a(paramString1, (String)localObject, paramString2);
      if (localObject != null) {
        return localObject;
      }
      xb.b("from memcache".concat(String.valueOf(paramString1)));
    ...
    if (paramString2 != null)
    {
      ...
      xb.b("from cache,don't update".concat(String.valueOf(paramString1)));
      return new BitmapDrawable(paramString2);
    }
    if ((paramString1 != null) && (paramString1.length() > 4))
    {
      paramString2 = (zz)d.get(paramString1);
      if (paramString2 != null)
      {
        xb.b("from loading task".concat(String.valueOf(paramString1)));
        return paramString2;
      }
      xb.b("from new task".concat(String.valueOf(paramString1)));
      paramString2 = new zz(paramString1, (String)localObject);
  ...
  private static BitmapDrawable a(String paramString1, String paramString2, Bitmap paramBitmap)
  {
    ...
    {
      zz localzz = (zz)d.get(paramString1);
      if (localzz != null) {
        return localzz;
      }
      paramString2 = new zz(paramString1, paramString2, str, paramBitmap);
      d.put(paramString1, paramString2);
      return paramString2;
    }
    return null;
  ...
  private static void a()
  {
    if (!h)
    {
      ...
      a = aae.a(localResources, 2131099813);
      b = aae.a(localResources, 2131099767);
  ...
  private static boolean a(Map<String, String> paramMap)
  {
    ...
    Object localObject = new ahg();
    try
    {
      localObject = ahi.a((ahk)localObject, "qqface", new String[] { "uinhash", "filename" }, null, null, null, null).iterator();
      while (((Iterator)localObject).hasNext())
      {
        ahg localahg = (ahg)((Iterator)localObject).next();
        if (localahg == null) {
          break;
        }
        paramMap.put(localahg.a, localahg.b);
      }
      return true;
    }
  ...
  public static BitmapDrawable b(String paramString1, String paramString2)
  {
    ...
    xb.b("from new task".concat(String.valueOf(paramString1)));
    paramString2 = new zz(paramString1, str);
    d.put(paramString1, paramString2);
    return paramString2;
    label120:
    return new BitmapDrawable(a);
