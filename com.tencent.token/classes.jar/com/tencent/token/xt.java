  ...
  implements Camera.AutoFocusCallback, Camera.PreviewCallback
{
  ...
  public xt(Context paramContext, SurfaceHolder paramSurfaceHolder, Handler paramHandler, FaceDetector.IdCardDirection paramIdCardDirection)
  {
    this.j = paramContext;
    this.b = paramHandler;
  ...
  public final void a()
  {
    ...
    try
    {
      ...
      xa.c(((StringBuilder)localObject3).toString());
    ...
    if (this.s == FaceDetector.IdCardDirection.DT_FRONT)
    {
      f = 0;
      e = 0;
      rt.a().a(System.currentTimeMillis(), 130);
      return;
    }
    h = 0;
    g = 0;
    rt.a().a(System.currentTimeMillis(), 132);
  }
  ...
  public final void onPreviewFrame(byte[] paramArrayOfByte, Camera paramCamera)
  {
    ...
    if ((!this.q) && (!this.p)) {
      new Thread(new Runnable()
      {
        public final void run()
        {
          try
          {
            synchronized (xt.this.i)
            {
              xt.a(xt.this, true);
              xt.a(xt.this);
              xt.b(xt.this, FaceDetector.IdCardDetectInitial(xt.b(xt.this)));
              StringBuilder localStringBuilder = new StringBuilder("IdCardDetectInitial: ");
              localStringBuilder.append(xt.c(xt.this));
              localStringBuilder.append(",mIdCardModelPath=");
              localStringBuilder.append(xt.b(xt.this));
              xa.c(localStringBuilder.toString());
              xt.d(xt.this);
              xt.a(xt.this, false);
            }
    ...
    try
    {
      ...
      l2 = l1;
      l3 = l1;
      xa.c("IdCardDetect detect ret: ".concat(String.valueOf(l1)));
    }
    catch (Error localError)
    {
      localError.printStackTrace();
    ...
    if (l1 == 0L)
    {
      ...
      if (this.s == FaceDetector.IdCardDirection.DT_FRONT)
      {
        ...
        localObject3 = zw.a(((IdCardInfo)localObject1).data(), "frontdata");
        localObject2 = this.b.obtainMessage(0);
        ...
        ((Message)localObject2).sendToTarget();
        rt.a().a(System.currentTimeMillis(), 131);
      }
      else if (this.s == FaceDetector.IdCardDirection.DT_BACK)
      {
        h = (int)(System.currentTimeMillis() - this.c);
        localObject3 = zw.a(((IdCardInfo)localObject1).data(), "backdata");
        localObject2 = this.b.obtainMessage(0);
        ((Message)localObject2).what = 1;
        ((Message)localObject2).obj = localObject3;
        localObject3 = new Bundle();
        ...
        ((Message)localObject2).sendToTarget();
        rt.a().a(System.currentTimeMillis(), 133);
      }
    ...
    xa.a("ret=".concat(String.valueOf(l1)));
    if ((l1 != 3L) && (l1 != 5L))
    {
      if ((l1 == 2L) || (l1 == 4L)) {
