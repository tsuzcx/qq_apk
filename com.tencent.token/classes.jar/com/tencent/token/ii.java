...
public final class ii
{
  ...
  private static final ii d = new ii();
  ...
  private static String a(byte[] paramArrayOfByte, byte[][] paramArrayOfByte1, int paramInt)
  {
    ...
    if (j < i)
    {
      ...
      label333:
      return new String(paramArrayOfByte, i5, i6, gn.e);
    }
    return null;
  }
  ...
  private String[] a(String[] paramArrayOfString)
  {
    ...
    {
      arrayOfByte[i] = paramArrayOfString[i].getBytes(gn.e);
      i += 1;
    }
    i = 0;
  ...
  private void b()
  {
    ...
    {
      ih.c().a(5, "Failed to read public suffix list", localIOException);
      return;
    }
    finally
    {
  ...
  private void c()
  {
    ...
    //   16: dup
    //   17: aload_1
    //   18: invokestatic 159	okio/o:a	(Ljava/io/InputStream;)Lokio/y;
    //   21: invokespecial 162	okio/m:<init>	(Lokio/y;)V
    //   24: invokestatic 165	okio/o:a	(Lokio/y;)Lokio/i;
    //   27: astore_1
    //   28: aload_1
    ...
    //   60: aload_1
    //   61: invokestatic 177	com/tencent/token/gn:a	(Ljava/io/Closeable;)V
    //   64: aload_0
    //   65: monitorenter
    //   66: aload_0
    //   67: aload_2
    //   68: putfield 75	com/tencent/token/ii:g	[B
    //   71: aload_0
    //   72: aload_3
    //   73: putfield 109	com/tencent/token/ii:h	[B
    //   76: aload_0
    //   77: monitorexit
    //   78: aload_0
    //   79: getfield 50	com/tencent/token/ii:f	Ljava/util/concurrent/CountDownLatch;
    //   82: invokevirtual 180	java/util/concurrent/CountDownLatch:countDown	()V
    //   85: return
    //   86: astore_2
    //   87: aload_1
    //   88: invokestatic 177	com/tencent/token/gn:a	(Ljava/io/Closeable;)V
    //   91: aload_2
    //   92: athrow
    //   93: astore_1
    //   94: aload_0
