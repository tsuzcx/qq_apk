  ...
  implements Animatable
{
  ...
  private static final Interpolator c = new fz();
  ...
  public gf(final Context paramContext)
  {
    this.f = ((Context)ew.a(paramContext)).getResources();
    this.a = new a();
    this.a.a(d);
    this.a.a(2.5F);
    invalidateSelf();
    ...
    localValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
    {
      public final void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        ...
        gf.a(f, paramContext);
        gf.a(gf.this, f, paramContext, false);
    ...
    localValueAnimator.addListener(new Animator.AnimatorListener()
    {
      ...
      {
        gf.a(gf.this, 1.0F, paramContext, true);
        paramContext.c();
        gf.a locala = paramContext;
        locala.a(locala.a());
        if (gf.a(gf.this))
        {
          gf.b(gf.this);
        ...
        paramAnonymousAnimator = gf.this;
        gf.a(paramAnonymousAnimator, gf.c(paramAnonymousAnimator) + 1.0F);
      }
