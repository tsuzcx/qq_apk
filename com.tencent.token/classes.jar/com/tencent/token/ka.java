...
final class ka
{
  ...
  ka(Context paramContext)
  {
    this.a = paramContext;
    this.b = LayoutInflater.from(this.a).inflate(hg.g.abc_tooltip, null);
    this.c = ((TextView)this.b.findViewById(hg.f.message));
    ...
    paramContext.windowAnimations = hg.i.Animation_AppCompat_Tooltip;
    this.d.flags = 24;
  }
  ...
  private void a(View paramView, int paramInt1, int paramInt2, boolean paramBoolean, WindowManager.LayoutParams paramLayoutParams)
  {
    ...
    int i = this.a.getResources().getDimensionPixelOffset(hg.d.tooltip_precise_anchor_threshold);
    if (paramView.getWidth() < i) {
      paramInt1 = paramView.getWidth() / 2;
    }
    if (paramView.getHeight() >= i)
    {
      j = this.a.getResources().getDimensionPixelOffset(hg.d.tooltip_precise_anchor_extra_offset);
      i = paramInt2 + j;
      j = paramInt2 - j;
      paramInt2 = i;
      i = j;
    ...
    if (paramBoolean) {
      j = hg.d.tooltip_y_offset_touch;
    } else {
      j = hg.d.tooltip_y_offset_non_touch;
    }
