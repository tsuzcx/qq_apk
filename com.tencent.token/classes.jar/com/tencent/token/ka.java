  ...
  implements apy
{
  ...
  public ka(Context paramContext)
  {
    this.e = new jz(paramContext);
  }
  ...
  private static String[] a(Context paramContext)
  {
    ...
    localStringBuilder.append(Integer.toString(arq.d(paramContext)));
    localStringBuilder.append("*");
    localStringBuilder.append(Integer.toString(arq.e(paramContext)));
  ...
  private long n()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 29	com/tencent/token/ka:f	J
    //   4: ldc2_w 26
    //   7: lcmp
    //   8: ifne +240 -> 248
    ...
    //   84: putfield 29	com/tencent/token/ka:f	J
    //   87: aload 4
    ...
    //   247: athrow
    //   248: aload_0
    //   249: getfield 29	com/tencent/token/ka:f	J
    //   252: lstore_1
    //   253: lload_1
    //   254: lconst_0
    //   255: lcmp
  ...
  public final void a(int paramInt1, int paramInt2)
  {
    ...
    if (str != null) {
      localjz.a("key_ha", str);
    }
    localjz = this.e;
    str = Integer.toString(paramInt2);
    if (str != null) {
      localjz.a("key_ha_sq", str);
    }
  }
  ...
  {
    jz localjz = this.e;
    localjz.a("key_gd_1", paramag.a);
    localjz.a("key_gd_2", paramag.b);
    localjz.a("key_gd_3", paramag.c);
    localjz.a("key_gd_4", paramag.d);
    localjz.a("key_gd_5", paramag.e);
    localjz.a("key_gd_6", Integer.toString(paramag.f));
    localjz.a("key_gd_7", paramag.g);
    localjz.a("key_gd_8", Integer.toString(paramag.h));
    localjz.a("key_gd_9", paramag.i);
    localjz.a("key_gd_10", Integer.toString(paramag.j));
    localjz.a("key_gd_11", Integer.toString(paramag.k));
    localjz.a("key_gd_12", Boolean.toString(paramag.l));
    localjz.a("key_gd_13", paramag.m);
    localjz.a("key_gd_14", paramag.n);
    localjz.a("key_gd_15", Integer.toString(paramag.o));
    localjz.a("key_gd_16", paramag.p);
    localjz.a("key_gd_17", Integer.toString(paramag.q));
    localjz.a("key_gd_18", Integer.toString(paramag.r));
    localjz.a("key_gd_19", paramag.s);
    localjz.a("key_gd_20", paramag.t);
    localjz.a("key_gd_21", Integer.toString(paramag.u));
    localjz.a("key_gd_22", paramag.v);
    localjz.a("key_gd_23", Long.toString(paramag.w));
    localjz.a("key_gd_24", Long.toString(paramag.x));
    localjz.a("key_gd_25", Long.toString(paramag.y));
    localjz.a("key_gd_26", paramag.z);
    localjz.a("key_gd_27", paramag.A);
    localjz.a("key_gd_28", paramag.B);
    localjz.a("key_gd_29", paramag.P);
    localjz.a("key_gd_30", Integer.toString(paramag.Q));
  }
  ...
  public final ag g()
  {
    jz localjz = this.e;
    ag localag = new ag();
    localag.a = localjz.b("key_gd_1", "");
    localag.b = localjz.b("key_gd_2", "");
    localag.c = localjz.b("key_gd_3", "");
    localag.d = localjz.b("key_gd_4", "");
    localag.e = localjz.b("key_gd_5", "");
    localag.f = jz.b(localjz.b("key_gd_6", ""));
    localag.g = localjz.b("key_gd_7", "");
    localag.h = jz.b(localjz.b("key_gd_8", ""));
    localag.i = localjz.b("key_gd_9", "");
    localag.j = jz.b(localjz.b("key_gd_10", ""));
    localag.k = jz.b(localjz.b("key_gd_11", ""));
    localag.l = jz.c(localjz.b("key_gd_12", ""));
    localag.m = localjz.b("key_gd_13", "");
    localag.n = localjz.b("key_gd_14", "");
    localag.o = jz.b(localjz.b("key_gd_15", ""));
    localag.p = localjz.b("key_gd_16", "");
    localag.q = ((short)jz.b(localjz.b("key_gd_17", "")));
    localag.r = jz.b(localjz.b("key_gd_18", ""));
    localag.s = localjz.b("key_gd_19", "");
    localag.t = localjz.b("key_gd_20", "");
    localag.u = jz.b(localjz.b("key_gd_21", ""));
    localag.v = localjz.b("key_gd_22", "");
    localag.w = jz.a(localjz.b("key_gd_23", ""));
    localag.x = jz.a(localjz.b("key_gd_24", ""));
    localag.y = jz.a(localjz.b("key_gd_25", ""));
    localag.z = localjz.b("key_gd_26", "");
    localag.A = localjz.b("key_gd_27", "");
    localag.B = localjz.b("key_gd_28", "");
    localag.P = localjz.b("key_gd_29", "");
    localag.Q = jz.b(localjz.b("key_gd_30", ""));
    return localag;
  }
  
  public final ag h()
  {
    String[] arrayOfString = a(aos.a());
    long l1 = n();
    Object localObject1 = new arr();
    if (Environment.getExternalStorageState().equals("mounted"))
    {
      localObject2 = new StatFs(Environment.getExternalStorageDirectory().getPath());
      l2 = ((StatFs)localObject2).getBlockSize();
      ((arr)localObject1).a = (((StatFs)localObject2).getAvailableBlocks() * l2);
      ((arr)localObject1).b = (((StatFs)localObject2).getBlockCount() * l2);
    }
    else
    {
      ((arr)localObject1).a = 0L;
      ((arr)localObject1).b = 0L;
    }
    long l2 = ((arr)localObject1).b;
    localObject1 = arq.c(aos.a());
    Object localObject2 = new ag();
    ((ag)localObject2).a = arq.a(aos.a());
    ((ag)localObject2).b = arq.b(aos.a());
    ...
    ((ag)localObject2).m = aos.a().getPackageName();
    ((ag)localObject2).n = d(arq.b());
    ((ag)localObject2).o = Build.VERSION.SDK_INT;
    ((ag)localObject2).p = d(arq.a());
 ...
 * Qualified Name:     com.tencent.token.ka
