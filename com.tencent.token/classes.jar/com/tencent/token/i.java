...
public class i
{
  ...
  public static i a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      if (paramString2.has("pkglist")) {
        locali.e = b(paramString2.getString("pkglist"));
      }
      if (paramString2.has("mode")) {
        locali.d = paramString2.getInt("mode");
      }
      if (paramString2.has("img1")) {
        locali.f = paramString2.getString("img1");
      }
      if (paramString2.has("img2")) {
        locali.g = paramString2.getString("img2");
      }
      if (paramString2.has("img3")) {
        locali.h = paramString2.getString("img3");
      }
      if (paramString2.has("text1")) {
        locali.i = paramString2.getString("text1");
      }
      if (paramString2.has("text2")) {
        locali.j = paramString2.getString("text2");
      }
      if (paramString2.has("text3")) {
        locali.k = paramString2.getString("text3");
      }
      if (paramString2.has("text4")) {
        locali.l = paramString2.getString("text4");
      }
      if (paramString2.has("text5")) {
        locali.m = paramString2.getString("text5");
      }
      if (paramString2.has("text6")) {
        locali.n = paramString2.getString("text6");
      }
      if (paramString2.has("text7")) {
        locali.o = paramString2.getString("text7");
      }
      if (paramString2.has("text8")) {
        locali.p = paramString2.getString("text8");
      }
      if (paramString2.has("lastpkg")) {
        locali.q = paramString2.getString("lastpkg");
      }
      if (paramString2.has("interval")) {
        locali.s = paramString2.getInt("interval");
      }
      if (paramString2.has("begin")) {
        locali.t = paramString2.getLong("begin");
      }
      if (paramString2.has("end")) {
        locali.u = paramString2.getLong("end");
      }
      paramString1 = locali;
      if (paramString2.has("timestamp"))
      {
        locali.r = paramString2.getLong("timestamp");
        return locali;
      }
    }
  ...
  public k a(Context paramContext, HashSet<String> paramHashSet)
  {
  ...
  public void a(String paramString)
  {
    ...
    if ((paramString != null) && (!TextUtils.isEmpty(this.c))) {
      ef.b(this.c, paramString.toString());
    }
  }
