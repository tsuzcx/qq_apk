...
public final class rf
{
  ...
  private static rf f = new rf();
  protected Context a;
  protected b b;
  private rd g;
  private HashMap<Long, rh> h = new HashMap();
  private c i = new c();
  ...
  private static ri c(String paramString)
  {
    ri localri = new ri();
    localri.b = -756;
    localri.a = 1L;
    localri.d = paramString;
    StringBuilder localStringBuilder = new StringBuilder("{\"info\":\"");
    localStringBuilder.append(paramString);
    localStringBuilder.append("\"}");
    localri.c = localStringBuilder.toString();
    return localri;
  }
  ...
  public final void a(int paramInt1, int paramInt2, int paramInt3, long paramLong1, String paramString, long paramLong2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "C94334F95F64C37ACC078B48C571FD9D";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
      parama.put("uin", paramLong1);
      parama.put("seq_id", localrh.b);
    ...
    this.i.c(localrh.b, localrh.c, parama.toString());
  }
  ...
  public final void a(int paramInt1, int paramInt2, int paramInt3, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "9F3F9056CEBD71D7CD0641324295FBDC";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(int paramInt, long paramLong, String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "3B1B93134164CA0F0B8B906DD2B86C36";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(int paramInt, String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "19E23E326C4D01DAD0F19ED6C4D9E9B7";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, byte paramByte, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "AC01BFB92BE5169CF571381B8FFF207F";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, long paramLong2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "50A401953EDCEE1B1C690DE0720828F2";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "44A002F2915AE7AE4EC64CC88158923F";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
      ...
      parama.put("mobile_model", URLEncoder.encode(l()));
  ...
  public final void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "DFA91EB80E402F06FD4CD719C2A1D83D";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, int paramInt1, int paramInt2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "333CDBD2430E70272952CAB6D6702E32";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, int paramInt1, int paramInt2, String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "0FB8C96B560F379CBB37C2C1C083450D";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong1, int paramInt1, long paramLong2, int paramInt2, int paramInt3, long paramLong3, int paramInt4, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "FADB69A40722109769E92646ED10F542";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, int paramInt, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "74DD203E3F2B081F7234CB597FEBD35B";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, int paramInt, String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "98F7841164F6AC41F06BF8D3DAF6CA3F";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, int paramInt, String paramString1, String paramString2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "B0548EA57A99E2F48E1EB7EFBEF5B8BA";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, int paramInt, boolean paramBoolean, String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "C45762F55EE1A15EABB8B2E2D8F10217";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    if (paramInt != 0) {}
    for (;;)
  ...
  public final void a(long paramLong1, long paramLong2, int paramInt1, String paramString1, int paramInt2, int paramInt3, int paramInt4, String paramString2, int paramInt5, int paramInt6, int paramInt7, boolean paramBoolean, int paramInt8, int paramInt9, int paramInt10, int paramInt11, int paramInt12, int paramInt13, int paramInt14, int paramInt15, int paramInt16, int paramInt17, int paramInt18, int paramInt19, a parama)
  {
    ...
    if ((paramInt3 != 2) && (paramInt3 != 10) && (paramInt3 != 1)) {
      localrh.c = "AF9B8A96E551B7650EF5BEE33B690043";
    } else {
      localrh.c = "AF9B8A96E551B7650EF5BEE33B690042";
    }
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    int k = 0;
    for (;;)
    {
      ...
      this.i.c(localrh.b, localrh.c, parama.toString(), new String[0], new String[0]);
      return;
      label529:
      paramInt1 = paramInt3;
    }
  ...
  public final void a(long paramLong1, long paramLong2, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, int paramInt11, int paramInt12, int paramInt13, int paramInt14, int paramInt15, int paramInt16, int paramInt17, int paramInt18, String paramString9, String paramString10, a parama)
  {
    ...
    localrh.a = parama;
    if (paramInt1 == 1) {
      localrh.c = "3D705DA929E34A7C5A9F7E1CFCD16BEB";
    } else if (paramInt1 == 3) {
      localrh.c = "3D705DA929E34A7C5A9F7E1CFCD16BEB";
    } else {
      localrh.c = "3D705DA929E34A7C5A9F7E1CFCD16BEA";
    }
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
  ...
  public final void a(long paramLong1, long paramLong2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "F175FC5637F6D8B8DF233674868A9AC0";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "5BD55AA7E5809627669C61369F0DD361";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, String paramString, int paramInt, a parama)
  {
    ...
    localrh.a = parama;
    if (1 == paramInt) {
      localrh.c = "479A4FB69763836611D26943B834C329";
    } else {
      localrh.c = "479A4FB69763836611D26943B834C32A";
    }
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
  ...
  public final void a(long paramLong, String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "C16E10370E478F79269FFEB9425FE21A";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, int paramInt3, String paramString4, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "A5612850B2C7DE432FC04B6EF0450BB9";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, String paramString1, String paramString2, int paramInt, String paramString3, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "08CF9F6B8DF42EEE097B808193CE344B";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4, String paramString5, String paramString6, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "04D6E7893DDFE646767FC205385D104F";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, String paramString, boolean paramBoolean, a parama)
  {
    ...
    localrh.a = parama;
    if (paramBoolean) {
      localrh.c = "53E34C4843494C4162B629849D78105A";
    } else {
      localrh.c = "53E34C4843494C4162B629849D781059";
    }
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
  ...
  public final void a(long paramLong, String paramString, int[] paramArrayOfInt1, int[] paramArrayOfInt2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "99F26100CF92C33991A8775439A7F2C4";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(long paramLong, JSONArray paramJSONArray, String paramString1, String paramString2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "771DD55790CDC5AC5B813EDB31F850E7";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
  ...
  public final void a(long paramLong, JSONObject paramJSONObject, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "28D1740924201BB5211FC63EE5A14BAA";
    this.h.put(Long.valueOf(localrh.b), localrh);
    try
    {
      paramJSONObject.put("seq_id", localrh.b);
    ...
    this.i.c(localrh.b, localrh.c, paramJSONObject.toString(), new String[0], new String[0]);
  }
  ...
  public final void a(long paramLong, int[] paramArrayOfInt, String[] paramArrayOfString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "A9E50633700022EF114BD0EDB19E3A00";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(Context paramContext, String paramString1, String paramString2, String paramString3, b paramb)
  {
    ...
    this.g = new rd(paramString1, paramString2, paramString3);
    this.i.r = new c();
    this.b = paramb;
    if (d != null)
    {
    ...
    try
    {
      ...
      if (c) {
        this.i.n(paramContext, paramString3, 523005419L, 1);
      }
    }
  ...
  public final void a(a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "34B175E318A75EB93A82CCAF64A31A9E";
    this.h.put(Long.valueOf(localrh.b), localrh);
    this.i.c(localrh.b, localrh.c, "");
  }
  ...
  public final void a(File paramFile, String paramString, long paramLong1, long paramLong2, int paramInt, a parama)
  {
    ...
    Object localObject1 = new rh();
    ((rh)localObject1).a = parama;
    ((rh)localObject1).c = "72DB5B82D88142908BC8FC1AFADFF186";
    this.h.put(Long.valueOf(((rh)localObject1).b), localObject1);
    parama = new JSONObject();
    ...
    localObject2 = this.i;
    paramLong1 = ((rh)localObject1).b;
    localObject1 = ((rh)localObject1).c;
  ...
  public final void a(String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "FA806047F65F95CB10B75D210411C17C";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(String paramString1, String paramString2, int paramInt1, long paramLong, int paramInt2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "F8A3779851B6648E065023F54D5A8EE7";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void a(byte[] paramArrayOfByte, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "E0B905EEA37A12C6CF5378B6A70C02DD";
    this.h.put(Long.valueOf(localrh.b), localrh);
    this.i.c(localrh.b, localrh.c, paramArrayOfByte);
  }
  ...
  public final boolean a(String paramString, long paramLong1, long paramLong2)
  {
    ...
    return this.i.w(paramString, paramLong1, paramLong2);
  }
  ...
  public final void b(long paramLong, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "E596F0205A5BDB6C7397249FDC22CAEA";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void b(long paramLong, int paramInt1, int paramInt2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "273B4F4457207103E27981A41529C0DB";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void b(long paramLong, int paramInt, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "CD4C69A4177412144231058A42BDB905";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void b(long paramLong, int paramInt, String paramString1, String paramString2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "FA46402A1B15548C7CDE81C6E7F1F732";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void b(long paramLong1, long paramLong2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "E71A126EA00EB610340E9F8D0B2BECC6";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void b(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "41A162EE938691A32828F0DEA38E9DD3";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void b(long paramLong, String paramString, int paramInt, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "1D707B1CCFEC2F2CC4B940E5130F5E74";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void b(long paramLong, String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "99814609F13A6C96EEAF766292B21C0B";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void b(a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "EB743F61BAC709EF2E9EA84DF8E4F095";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void b(String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "AC237F5468E06656F7ADAE11108F4D54";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void c(long paramLong, int paramInt1, int paramInt2, a parama)
  {
    ...
    localrh.a = parama;
    if (paramInt2 == 0) {
      localrh.c = "0D623F92C0B0C3F9BF08F2A167C34176";
    } else {
      localrh.c = "448C7C440DE2C2997A91EA1AD6BAC7B6";
    }
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
  ...
  public final void c(long paramLong, int paramInt, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "2B3FAD8767D1610B7F710A24334EB23C";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void c(long paramLong, int paramInt, String paramString1, String paramString2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "59684C276159686ED63345F6B6AA034A";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void c(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "918ABE6DD0DEE0CA3B98282AE9639EE2";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void c(long paramLong, String paramString, int paramInt, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "AB09BD83BABC6EBF82C9CA1BF6DDA37F";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    if (paramInt != 0) {}
    try
  ...
  public final void c(long paramLong, String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "41F7D5CECF0997AD21ED395396B9AB38";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void c(a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "7CC75354408C4834323634866588017C";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    this.i.c(localrh.b, localrh.c, parama.toString());
  }
  ...
  public final void c(String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "86DA4530C533BC0C758C1292AF8C3173";
    this.h.put(Long.valueOf(localrh.b), localrh);
    this.i.c(localrh.b, localrh.c, paramString, new String[0], new String[0]);
  }
  ...
  public final void d(long paramLong, int paramInt, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "668101455655578A4F39B91F23918B7A";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void d(long paramLong, int paramInt, String paramString1, String paramString2, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "0324CAC2D43F0443CFCFA583026BEFF2";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void d(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "5F1BFABD896BAFA440C4AA17E7DFBCE7";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void d(long paramLong, String paramString, int paramInt, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "83C85119A617707571F9AF47FD856827";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void d(long paramLong, String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "2840C98F0786E3E70302A9226EC5A712";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void d(String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "D941BCD7924B6B6311F5CF92765B2D93";
    this.h.put(Long.valueOf(localrh.b), localrh);
    this.i.c(localrh.b, localrh.c, paramString, new String[0], new String[0]);
  }
  ...
  public final void e(long paramLong, int paramInt, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "E7DECE972D03B599CE2408A62F157A83";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void e(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "26FF6825B86C68E1FABA9D9278AE1DB8";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void e(long paramLong, String paramString, int paramInt, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "D842F36E7AF0618988642B19803C0087";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void e(long paramLong, String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "9E84194DFFBCBB23DA2E6300B2603753";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void e(String paramString, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "EF59AE164087EC5F15461FFCF40D7EF7";
    this.h.put(Long.valueOf(localrh.b), localrh);
    this.i.c(localrh.b, localrh.c, paramString, new String[0], new String[0]);
  }
  ...
  public final void f(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "6E9B98C6054981CA934F7D2B6788D40D";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void f(long paramLong, String paramString, int paramInt, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "7657CC5E58154D915FCA63ABAE0B6733";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void g(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "F003698209A3250BE06FAD011DD79BB8";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void h(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "370D289E3FE3E8ED668DA209815CDEFF";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void i(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "9CE121E6F54413367610232409BB47BD";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void j(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "E77CB26DE18145EDAA56393DB1A5E471";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void k(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "BE915045169753B18F19EF34EBEFFA1A";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void l(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "9E808C16098A0A14D88D169B2F9D1F21";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void m(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "7ADA7075D675A2D03A82FA01528E2620";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  public final void n(long paramLong, a parama)
  {
    ...
    rh localrh = new rh();
    localrh.a = parama;
    localrh.c = "DB3278FC63B5F2CAC5FADDCC62E4B87F";
    this.h.put(Long.valueOf(localrh.b), localrh);
    parama = new JSONObject();
    try
    {
  ...
  {
    public abstract void a(ri paramri);
  }
    ...
    implements c.a
  {
    ...
    {
      rf.a(rf.this, paramLong, paramInt, paramString1, paramString2);
    }
    
    public final void a(long paramLong, String paramString1, String paramString2)
    {
      if (rf.this.b != null) {
        rf.this.b.a(paramLong, paramString1, paramString2);
      }
    }
    ...
    {
      if (rf.this.b != null) {
        rf.this.b.a(paramString);
      }
    }
    
    public final boolean a(long paramLong)
    {
      return (rf.this.b != null) && (rf.this.b.a(paramLong));
    }
    
    public final long b()
    {
      if (rf.this.b != null) {
        return rf.this.b.b().a;
      }
      return 0L;
    }
    ...
    public final String d()
    {
      if (rf.this.b != null)
      {
        re localre = rf.this.b.b();
        if (!TextUtils.isEmpty(localre.c)) {
          return localre.c;
        }
        return "";
      }
 ...
 * Qualified Name:     com.tencent.token.rf
