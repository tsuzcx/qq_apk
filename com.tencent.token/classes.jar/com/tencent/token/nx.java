  ...
  implements nw
{
  ...
  private static ArrayList a(ArrayList paramArrayList, int paramInt1, int paramInt2)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      {
        nj localnj = (nj)paramArrayList.get(paramInt1);
        localArrayList.add(new nj(localnj.a, localnj.b));
        paramInt1 += 1;
      }
  ...
  public final void a()
  {
    ...
    this.j = bool;
    li.a("SocketConnectorImpl", "doConnect...");
    while ((!this.g) || (!this.j))
    {
      int i1 = this.n;
      if (i1 > this.d) {
      ...
      else
      {
        ...
        label398:
        localObject = nv.a((ArrayList)localObject, this.k, this.c);
        if (localObject != null) {
          this.l = ((nu)localObject).c;
        }
        this.o = nv.a;
        this.p = nv.b;
      ...
      {
        this.q = new nj(this.l.getInetAddress().getHostAddress(), this.l.getPort());
        this.m = 0;
        return;
      }
      if (oa.f()) {
