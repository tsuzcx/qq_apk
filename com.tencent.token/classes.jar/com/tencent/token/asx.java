...
public final class asx
{
  ...
  private static byte[] c(String paramString)
  {
    ...
    try
    {
      Object localObject = aug.a("MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDb49jFnNqMDLdl87UtY5jOMqqdMuvQg65Zuva3Qm1tORQGBuM04u7fqygA64XbOx9e/KPNkDNDmqS8SlsAPL1fV2lqM/phgV0NY62TJqSR+PLngwJd2rhYR8wQ1N0JE+R59a5c08EGsd6axStjHsVu2+evCf/SWU9Y/oQpEtOjGwIDAQAB");
  ...
  public final boolean a(AtomicReference paramAtomicReference)
  {
    ...
    paramAtomicReference = new as();
    ??? = c(c());
    if (??? != null)
    {
      paramAtomicReference.a = ((byte[])???);
      new StringBuilder("updataRsaKey() reqRSA.enc: ").append(arv.a(paramAtomicReference.a));
      ??? = new aw();
      ((aw)???).b = this.c.b.a();
      ((aw)???).a = 152;
      ((aw)???).d = aso.a(paramAtomicReference);
      ...
      paramAtomicReference = (az)paramAtomicReference.get(0);
      if (paramAtomicReference == null) {
        return false;
      }
    ...
    try
    {
      ...
      if (??? == null) {
        ...
        paramAtomicReference = asu.a((byte[])???, paramAtomicReference);
      }
      if (paramAtomicReference == null) {
        return false;
      }
      paramAtomicReference = (at)paramAtomicReference;
 ...
 * Qualified Name:     com.tencent.token.asx
