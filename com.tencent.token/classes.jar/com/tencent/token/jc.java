  ...
  implements AdapterView.OnItemSelectedListener
{
  ...
  protected final void onConfigurationChanged(Configuration paramConfiguration)
  {
    ...
    paramConfiguration = gz.a(getContext());
    TypedArray localTypedArray = paramConfiguration.a.obtainStyledAttributes(null, gs.j.ActionBar, gs.a.actionBarStyle, 0);
    int k = localTypedArray.getLayoutDimension(gs.j.ActionBar_height, 0);
    Resources localResources = paramConfiguration.a.getResources();
    int j = k;
    if (!paramConfiguration.b()) {
      j = Math.min(k, localResources.getDimensionPixelSize(gs.d.abc_action_bar_stacked_max_height));
    }
    localTypedArray.recycle();
    setContentHeight(j);
    this.d = paramConfiguration.a.getResources().getDimensionPixelSize(gs.d.abc_action_bar_stacked_tab_max_width);
  }
    ...
    if (paramInt2 != 0)
    {
      ...
      if (this.b.getMeasuredWidth() > View.MeasureSpec.getSize(paramInt1))
      {
        if (!a())
        {
          if (this.f == null)
          {
            localObject = new AppCompatSpinner(getContext(), null, gs.a.actionDropDownStyle);
      ...
      if (bool)
      {
        ...
        this.a = new Runnable()
        {
          public final void run()
          {
            ...
            int j = (jc.this.getWidth() - this.a.getWidth()) / 2;
            jc.this.smoothScrollTo(i - j, 0);
            jc.this.a = null;
          }
        };
        post(this.a);
    ...
    extends BaseAdapter
  {
    ...
    {
      return jc.this.b.getChildCount();
    }
    
    public final Object getItem(int paramInt)
    {
      return ((jc.b)jc.this.b.getChildAt(paramInt)).a;
    }
    ...
    extends LinearLayout
  {
    ...
    {
      super(null, gs.a.actionBarTabStyle);
      this.a = parama;
      this$1 = ji.a(paramContext, null, this.c, gs.a.actionBarTabStyle, 0);
      if (jc.this.f(0)) {
        setBackgroundDrawable(jc.this.a(0));
      }
      jc.this.a.recycle();
      setGravity(8388627);
      a();
    ...
    public final void a()
    {
      ...
      if (bool)
      {
        if (this.d == null)
        {
          localObject3 = new AppCompatTextView(getContext(), null, gs.a.actionBarTabTextStyle);
    ...
    public final void onMeasure(int paramInt1, int paramInt2)
    {
      ...
      if ((jc.this.c > 0) && (getMeasuredWidth() > jc.this.c)) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(jc.this.c, 1073741824), paramInt2);
      }
    }
