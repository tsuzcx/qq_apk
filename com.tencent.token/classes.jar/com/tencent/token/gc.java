...
public final class gc
{
  ...
  private static final gc d = new gc();
  ...
  private static String a(byte[] paramArrayOfByte, byte[][] paramArrayOfByte1, int paramInt)
  {
    ...
    if (j < i)
    {
      ...
      label333:
      return new String(paramArrayOfByte, i5, i6, fb.e);
    }
    return null;
  }
  ...
  private String[] a(String[] paramArrayOfString)
  {
    ...
    {
      arrayOfByte[i] = paramArrayOfString[i].getBytes(fb.e);
      i += 1;
    }
    i = 0;
  ...
  private void b()
  {
    ...
    {
      gb.c().a(5, "Failed to read public suffix list", localIOException);
      return;
    }
    finally
    {
  ...
  private void c()
  {
    ...
    //   60: aload_1
    //   61: invokestatic 177	com/tencent/token/fb:a	(Ljava/io/Closeable;)V
    //   64: aload_0
    //   65: monitorenter
    //   66: aload_0
    //   67: aload_2
    //   68: putfield 75	com/tencent/token/gc:g	[B
    //   71: aload_0
    //   72: aload_3
    //   73: putfield 109	com/tencent/token/gc:h	[B
    //   76: aload_0
    //   77: monitorexit
    //   78: aload_0
    //   79: getfield 50	com/tencent/token/gc:f	Ljava/util/concurrent/CountDownLatch;
    //   82: invokevirtual 180	java/util/concurrent/CountDownLatch:countDown	()V
    //   85: return
    //   86: astore_2
    //   87: aload_1
    //   88: invokestatic 177	com/tencent/token/fb:a	(Ljava/io/Closeable;)V
    //   91: aload_2
    //   92: athrow
    //   93: astore_1
    //   94: aload_0
