...
final class qz
{
  ...
  static HashMap<Integer, String> a(Context paramContext)
  {
    ...
    Object localObject = apx.a();
    localHashMap.put(Integer.valueOf(9800), localObject);
    localHashMap.put(Integer.valueOf(9801), a(xr.a));
    localHashMap.put(Integer.valueOf(9803), a(apx.b()));
    localHashMap.put(Integer.valueOf(9804), apx.a("ro.build.fingerprint"));
    try
    {
  ...
  static HashMap<Integer, Integer> b(Context paramContext)
  {
    ...
    if (!TextUtils.isEmpty(a(paramContext, apx.a()))) {
      try
      {
