  ...
  implements aih
{
    ...
    extends ContentObserver
  {
    ...
    public a(aid paramaid)
    {
      super();
      this.a = new WeakReference(paramaid);
    }
    ...
    {
      aid localaid = (aid)this.a.get();
      if (localaid != null) {
        synchronized (localaid.g)
        {
          localaid.h.dispatchChange(false);
          return;
        }
      }
    }
 ...
 * Qualified Name:     com.tencent.token.aid
