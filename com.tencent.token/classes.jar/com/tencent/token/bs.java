  ...
  extends br
{
  ...
  public static bs a(Resources paramResources, int paramInt, Resources.Theme paramTheme)
  {
    Object localObject;
    if (Build.VERSION.SDK_INT >= 24)
    {
      ...
      ((bs)localObject).b = paramResources;
      ((bs)localObject).h = new g(((bs)localObject).b.getConstantState());
      return localObject;
    }
    try
    {
  ...
  public static bs a(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    bs localbs = new bs();
    localbs.inflate(paramResources, paramXmlPullParser, paramAttributeSet, paramTheme);
    return localbs;
  }
  ...
  private void b(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    ...
    for (int m = 1; (i1 != 1) && ((paramXmlPullParser.getDepth() >= i2 + 1) || (i1 != 3)); m = n)
    {
      if (i1 == 2)
      {
        ...
        {
          localObject = new b();
          localTypedArray = cx.a(paramResources, paramTheme, paramAttributeSet, bk.c);
        ...
        else if ("clip-path".equals(localObject))
        {
          ...
          {
            localTypedArray = cx.a(paramResources, paramTheme, paramAttributeSet, bk.d);
        ...
        else
        {
          ...
          {
            localObject = new c();
            localTypedArray = cx.a(paramResources, paramTheme, paramAttributeSet, bk.b);
            ((c)localObject).l = null;
            ((c)localObject).c = cx.a(localTypedArray, paramXmlPullParser, "rotation", 5, ((c)localObject).c);
            ((c)localObject).d = localTypedArray.getFloat(1, ((c)localObject).d);
            ((c)localObject).e = localTypedArray.getFloat(2, ((c)localObject).e);
            ((c)localObject).f = cx.a(localTypedArray, paramXmlPullParser, "scaleX", 3, ((c)localObject).f);
            ((c)localObject).g = cx.a(localTypedArray, paramXmlPullParser, "scaleY", 4, ((c)localObject).g);
            ((c)localObject).h = cx.a(localTypedArray, paramXmlPullParser, "translateX", 6, ((c)localObject).h);
            ((c)localObject).i = cx.a(localTypedArray, paramXmlPullParser, "translateY", 7, ((c)localObject).i);
  ...
  public final void inflate(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    if (this.b != null)
    {
      dg.a(this.b, paramResources, paramXmlPullParser, paramAttributeSet, paramTheme);
      return;
    }
    f localf1 = this.c;
    localf1.b = new e();
    TypedArray localTypedArray = cx.a(paramResources, paramTheme, paramAttributeSet, bk.a);
    f localf2 = this.c;
    e locale = localf2.b;
    int m = cx.a(localTypedArray, paramXmlPullParser, "tintMode", 6, -1);
    ...
    if (cx.a(paramXmlPullParser, "autoMirrored")) {
      bool = localTypedArray.getBoolean(5, bool);
    }
    localf2.e = bool;
    locale.d = cx.a(localTypedArray, paramXmlPullParser, "viewportWidth", 7, locale.d);
    locale.e = cx.a(localTypedArray, paramXmlPullParser, "viewportHeight", 8, locale.e);
    if (locale.d > 0.0F)
    {
      if (locale.e > 0.0F)
      {
        ...
        if (locale.b > 0.0F)
        {
          if (locale.c > 0.0F)
          {
            locale.setAlpha(cx.a(localTypedArray, paramXmlPullParser, "alpha", 4, locale.getAlpha()));
  ...
  public final void setTintList(ColorStateList paramColorStateList)
  {
    if (this.b != null)
    {
      dg.a(this.b, paramColorStateList);
      return;
    }
    f localf = this.c;
    ...
    extends bs.d
  {
    ...
    final void a(TypedArray paramTypedArray, XmlPullParser paramXmlPullParser)
    {
      ...
      if (localObject != null) {
        this.m = cz.b((String)localObject);
      }
      this.c = cx.b(paramTypedArray, paramXmlPullParser, "fillColor", 1, this.c);
      this.f = cx.a(paramTypedArray, paramXmlPullParser, "fillAlpha", 12, this.f);
      int m = cx.a(paramTypedArray, paramXmlPullParser, "strokeLineCap", 8, -1);
      localObject = this.j;
      switch (m)
      {
      default: 
      ...
      m = cx.a(paramTypedArray, paramXmlPullParser, "strokeLineJoin", 9, -1);
      localObject = this.k;
      switch (m)
      {
      default: 
      ...
      this.l = cx.a(paramTypedArray, paramXmlPullParser, "strokeMiterLimit", 10, this.l);
      this.a = cx.b(paramTypedArray, paramXmlPullParser, "strokeColor", 3, this.a);
      this.d = cx.a(paramTypedArray, paramXmlPullParser, "strokeAlpha", 11, this.d);
      this.b = cx.a(paramTypedArray, paramXmlPullParser, "strokeWidth", 4, this.b);
      this.h = cx.a(paramTypedArray, paramXmlPullParser, "trimPathEnd", 6, this.h);
      this.i = cx.a(paramTypedArray, paramXmlPullParser, "trimPathOffset", 7, this.i);
      this.g = cx.a(paramTypedArray, paramXmlPullParser, "trimPathStart", 5, this.g);
      this.e = cx.a(paramTypedArray, paramXmlPullParser, "fillType", 13, this.e);
    }
  ...
  static final class c
  {
    ...
    public c(c paramc, du<String, Object> paramdu)
    {
      this.c = paramc.c;
      this.d = paramc.d;
      this.e = paramc.e;
      ...
      while (n < ((ArrayList)localObject).size())
      {
        ...
        {
          paramc = (c)paramc;
          this.b.add(new c(paramc, paramdu));
        }
        else
        {
          if ((paramc instanceof bs.b))
          {
            paramc = new bs.b((bs.b)paramc);
          }
          else
          {
            if (!(paramc instanceof bs.a)) {
              break label317;
            }
            paramc = new bs.a((bs.a)paramc);
          }
          this.b.add(paramc);
          if (paramc.n != null) {
            paramdu.put(paramc.n, paramc);
          }
        }
        n += 1;
        continue;
  ...
  static class d
  {
    ...
    public d(d paramd)
    {
      this.n = paramd.n;
      this.o = paramd.o;
      this.m = cz.a(paramd.m);
    }
    
    public final void a(Path paramPath)
    {
      paramPath.reset();
      cz.b[] arrayOfb = this.m;
      if (arrayOfb != null) {
        cz.b.a(arrayOfb, paramPath);
      }
    }
    ...
    public void setPathData(cz.b[] paramArrayOfb)
    {
      if (!cz.a(this.m, paramArrayOfb))
      {
        this.m = cz.a(paramArrayOfb);
        return;
      }
      cz.b[] arrayOfb = this.m;
      int i = 0;
  ...
  static final class e
  {
    ...
    int f = 255;
    String g = null;
    final du<String, Object> h = new du();
    ...
    public e(e parame)
    {
      this.a = new bs.c(parame.a, this.h);
    ...
    private void a(bs.c paramc, Matrix paramMatrix, Canvas paramCanvas, int paramInt1, int paramInt2, ColorFilter paramColorFilter)
    {
      ...
      while (i1 < paramc.b.size())
      {
        ...
        if ((localObject1 instanceof bs.c))
        {
          a((bs.c)localObject1, paramc.a, paramCanvas, paramInt1, paramInt2, paramColorFilter);
        }
        else if ((localObject1 instanceof bs.d))
        {
          Object localObject2 = (bs.d)localObject1;
          ...
          {
            localObject1 = this;
            ((bs.d)localObject2).a(((e)localObject1).i);
            paramMatrix = ((e)localObject1).i;
            ((e)localObject1).j.reset();
            if (((bs.d)localObject2).a())
            {
            ...
            {
              localObject2 = (bs.b)localObject2;
              if ((((bs.b)localObject2).g != 0.0F) || (((bs.b)localObject2).h != 1.0F))
              {
                f6 = ((bs.b)localObject2).g;
                f7 = ((bs.b)localObject2).i;
                f4 = ((bs.b)localObject2).h;
                f5 = ((bs.b)localObject2).i;
              ...
              if (((bs.b)localObject2).c != 0)
              {
                ...
                localPaint.setColor(bs.a(((bs.b)localObject2).c, ((bs.b)localObject2).f));
                localPaint.setColorFilter(paramColorFilter);
                Path localPath = ((e)localObject1).j;
                if (((bs.b)localObject2).e == 0) {
              ...
              if (((bs.b)localObject2).a != 0)
              {
                ...
                if (((bs.b)localObject2).k != null) {
                  paramMatrix.setStrokeJoin(((bs.b)localObject2).k);
                }
                if (((bs.b)localObject2).j != null) {
                  paramMatrix.setStrokeCap(((bs.b)localObject2).j);
                }
                paramMatrix.setStrokeMiter(((bs.b)localObject2).l);
                paramMatrix.setColor(bs.a(((bs.b)localObject2).a, ((bs.b)localObject2).d));
                paramMatrix.setColorFilter(paramColorFilter);
                paramMatrix.setStrokeWidth(((bs.b)localObject2).b * (f1 * f2));
    ...
    extends Drawable.ConstantState
  {
    ...
    public f(f paramf)
    {
      ...
      {
        this.a = paramf.a;
        this.b = new bs.e(paramf.b);
        if (bs.e.a(paramf.b) != null) {
          bs.e.a(this.b, new Paint(bs.e.a(paramf.b)));
        }
        if (bs.e.b(paramf.b) != null) {
          bs.e.b(this.b, new Paint(bs.e.b(paramf.b)));
        }
        this.c = paramf.c;
        this.d = paramf.d;
        this.e = paramf.e;
    ...
    extends Drawable.ConstantState
  {
    ...
    {
      bs localbs = new bs();
      localbs.b = ((VectorDrawable)this.a.newDrawable());
      return localbs;
    }
    ...
    {
      bs localbs = new bs();
      localbs.b = ((VectorDrawable)this.a.newDrawable(paramResources));
      return localbs;
    }
    ...
    {
      bs localbs = new bs();
      localbs.b = ((VectorDrawable)this.a.newDrawable(paramResources, paramTheme));
      return localbs;
    }
  }
}
