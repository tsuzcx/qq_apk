...
public class eq
{
  ...
  private boolean a(QQUser paramQQUser, boolean paramBoolean)
  {
    ...
    if (er.a((et)localObject, "table_user", localContentValues, "uin=?", new String[] { String.valueOf(d(paramQQUser)) }) <= 0)
    {
  ...
  private boolean f(QQUser paramQQUser)
  {
    ...
    try
    {
      er.a((et)localObject, "table_user", "uin=?", new String[] { String.valueOf(d(paramQQUser)) });
      return true;
    }
  ...
  public boolean a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 38	com/tencent/token/eq:b	Z
    //   6: ifeq +12 -> 18
    //   9: aload_0
    //   10: getfield 38	com/tencent/token/eq:b	Z
    //   13: istore_1
    //   14: aload_0
    //   15: monitorexit
    //   16: iload_1
    //   17: ireturn
    //   18: aload_0
    //   19: getfield 36	com/tencent/token/eq:c	Ljava/util/List;
    //   22: invokeinterface 212 1 0
    //   27: aload_0
    //   28: aconst_null
    //   29: putfield 40	com/tencent/token/eq:d	Lcom/tencent/token/core/bean/QQUser;
    //   32: new 6	com/tencent/token/eq$a
    //   35: dup
    //   36: aload_0
    //   37: invokespecial 71	com/tencent/token/eq$a:<init>	(Lcom/tencent/token/eq;)V
    //   40: astore_2
    //   41: aload_2
    //   42: ldc 119
    //   44: bipush 7
    ...
    //   89: aconst_null
    //   90: aconst_null
    //   91: invokestatic 228	com/tencent/token/er:a	(Lcom/tencent/token/et;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   94: astore_2
    //   95: getstatic 25	com/tencent/token/eq:a	Z
    //   98: ifne +18 -> 116
    //   101: aload_2
    //   102: ifnull +6 -> 108
    //   105: goto +11 -> 116
    ...
    //   138: checkcast 6	com/tencent/token/eq$a
    //   141: astore 4
    //   143: getstatic 25	com/tencent/token/eq:a	Z
    //   146: ifne +19 -> 165
    //   149: aload 4
    //   151: ifnull +6 -> 157
    //   154: goto +11 -> 165
    ...
    //   164: athrow
    //   165: aload 4
    //   167: invokevirtual 230	com/tencent/token/eq$a:d	()Lcom/tencent/token/core/bean/QQUser;
    //   170: astore 4
    //   172: getstatic 25	com/tencent/token/eq:a	Z
    //   175: ifne +19 -> 194
    //   178: aload 4
    //   180: ifnull +6 -> 186
    //   183: goto +11 -> 194
    ...
    //   199: ifeq -76 -> 123
    //   202: aload_0
    //   203: getfield 36	com/tencent/token/eq:c	Ljava/util/List;
    //   206: aload 4
    ...
    //   288: aload 5
    //   290: aload_0
    //   291: getfield 36	com/tencent/token/eq:c	Ljava/util/List;
    ...
    //   336: checkcast 6	com/tencent/token/eq$a
    //   339: astore_3
    //   340: getstatic 25	com/tencent/token/eq:a	Z
    //   343: ifne +18 -> 361
    //   346: aload_3
    //   347: ifnull +6 -> 353
    //   350: goto +11 -> 361
    ...
    //   360: athrow
    //   361: aload_3
    //   362: invokevirtual 230	com/tencent/token/eq$a:d	()Lcom/tencent/token/core/bean/QQUser;
    //   365: astore_3
    //   366: getstatic 25	com/tencent/token/eq:a	Z
    //   369: ifne +18 -> 387
    //   372: aload_3
    //   373: ifnull +6 -> 379
    //   376: goto +11 -> 387
    ...
    //   391: ifne -70 -> 321
    //   394: aload_0
    //   395: getfield 36	com/tencent/token/eq:c	Ljava/util/List;
    //   398: aload_3
    ...
    //   476: aload 4
    //   478: aload_0
    //   479: getfield 36	com/tencent/token/eq:c	Ljava/util/List;
    ...
    //   502: aload_0
    //   503: iconst_1
    //   504: putfield 38	com/tencent/token/eq:b	Z
    //   507: aload_0
    //   508: monitorexit
    //   509: iconst_1
    //   510: ireturn
