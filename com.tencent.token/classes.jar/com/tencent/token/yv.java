  ...
  implements Camera.PreviewCallback, FaceServiceDelegate
{
  ...
  public yv(Context paramContext, SurfaceHolder paramSurfaceHolder, Handler paramHandler, int paramInt1, int paramInt2, FaceView paramFaceView, TextView paramTextView, View paramView)
  {
    k = aaz.s();
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    //   7: astore 6
    //   9: aload_0
    //   10: getfield 118	com/tencent/token/yv:B	Landroid/content/Context;
    ...
    //   107: invokestatic 387	com/tencent/token/xv:a	(Ljava/lang/String;)V
    //   110: aload 9
    //   112: arraylength
    //   113: istore 4
    //   115: iconst_0
    ...
    //   169: aload_1
    //   170: aload_2
    //   171: invokespecial 389	com/tencent/token/yv:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   174: aload_2
    //   175: iconst_0
    //   176: aload_2
    ...
    //   191: goto -74 -> 117
    //   194: aload_0
    //   195: getfield 118	com/tencent/token/yv:B	Landroid/content/Context;
    ...
    //   364: invokestatic 387	com/tencent/token/xv:a	(Ljava/lang/String;)V
    //   367: sipush 1024
    //   370: newarray byte
    //   372: astore_2
    //   373: aload 6
    ...
    if (paramBoolean1)
    {
      if (this.E == DetectType.DT_REGISTER)
      {
        if ((this.H == 0) && (paramBoolean2)) {
          so.a().a(System.currentTimeMillis(), 145);
        }
        switch (this.G)
        {
        default: 
          return;
        case 4: 
          so.a().a(System.currentTimeMillis(), 147);
          this.l = FaceDetector.LiveAction.ACT_HEAD_SHAKE;
          this.O = this.B.getResources().getString(2131493294);
          return;
        case 3: 
          so.a().a(System.currentTimeMillis(), 146);
          this.l = FaceDetector.LiveAction.ACT_HEAD_NOD;
          this.O = this.B.getResources().getString(2131493293);
          return;
        case 2: 
          so.a().a(System.currentTimeMillis(), 148);
          this.l = FaceDetector.LiveAction.ACT_BLINK;
          this.O = this.B.getResources().getString(2131493292);
          return;
        }
        so.a().a(System.currentTimeMillis(), 149);
        this.l = FaceDetector.LiveAction.ACT_MOUTH_OPEN;
        this.O = this.B.getResources().getString(2131493291);
        return;
      }
      so.a().a(System.currentTimeMillis(), 150);
      switch (this.G)
      {
      default: 
        return;
      case 6: 
        so.a().a(System.currentTimeMillis(), 157);
        this.l = FaceDetector.LiveAction.ACT_BLINK;
        this.O = this.B.getResources().getString(2131493292);
        return;
      case 5: 
        so.a().a(System.currentTimeMillis(), 158);
        this.l = FaceDetector.LiveAction.ACT_MOUTH_OPEN;
        this.O = this.B.getResources().getString(2131493291);
        return;
      case 4: 
        so.a().a(System.currentTimeMillis(), 154);
        this.m = FaceDetector.LiveDirection.LD_RIGHT;
        this.O = this.B.getResources().getString(2131493300);
        this.j.setDirection(this.m.ordinal());
        return;
      case 3: 
        so.a().a(System.currentTimeMillis(), 153);
        this.m = FaceDetector.LiveDirection.LD_LEFT;
        this.O = this.B.getResources().getString(2131493299);
        this.j.setDirection(this.m.ordinal());
        return;
      case 2: 
        so.a().a(System.currentTimeMillis(), 152);
        this.m = FaceDetector.LiveDirection.LD_DOWN;
        this.O = this.B.getResources().getString(2131493298);
        this.j.setDirection(this.m.ordinal());
        return;
      }
      so.a().a(System.currentTimeMillis(), 151);
  ...
  public final void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt)
  {
    ...
    vg.f = (int)(System.currentTimeMillis() - this.s);
    vg.h = paramInt;
    if (this.w == null) {
      return;
    }
    ...
    if (this.H == 0) {
      localFaceData.mOriginDataPath = aas.a(paramArrayOfByte1.toByteArray(), "origindata0");
    } else {
      localFaceData.mOriginDataPath = aas.a(paramArrayOfByte1.toByteArray(), "origindata1");
    }
  ...
  public final void c()
  {
    ...
    try
    {
      ...
      if (this.B.getResources().getConfiguration().orientation != 2)
      {
        ...
        if ((yd.a.equals("Nexus 6")) || (yd.a.toLowerCase().startsWith("nexus 6")) || (yd.a.equals("Moto X Pro")) || ((yd.a.toLowerCase().indexOf("nexus6") != -1) && (Build.BRAND.toLowerCase().indexOf("motorola") != -1))) {
      ...
      vg.d = ((StringBuilder)localObject3).toString();
      localObject3 = this.x;
      localObject3[0] = 0;
      ...
      localObject4 = yd.a;
      if ((!((String)localObject4).startsWith("8150")) && (this.z != 0) && (!((String)localObject4).equals("Nexus 6")) && (!((String)localObject4).equals("Nexus 6P")) && ((yd.a.toLowerCase().indexOf("nexus6") == -1) || (Build.BRAND.toLowerCase().indexOf("motorola") == -1)))
      {
  ...
  public final void onPreviewFrame(byte[] paramArrayOfByte, Camera paramCamera)
  {
    ...
    if ((this.A == null) && (!bool)) {
      new Thread(new Runnable()
      {
        public final void run()
        {
          ...
          {
            if (yv.a(yv.this) == null)
            {
              yv.a(yv.this, true);
              long l = System.currentTimeMillis();
              yv.b(yv.this);
              vg.g = (int)(System.currentTimeMillis() - l);
              yv.a(yv.this, new sa(yv.c(yv.this), yv.this, yv.d(yv.this)));
              FaceThreshold localFaceThreshold = new FaceThreshold();
              yv.a(localFaceThreshold);
              ...
              xv.a(localStringBuilder.toString());
              yv.a(yv.this).a = localFaceThreshold;
              yv.a(yv.this, false);
            }
            return;
          }
    ...
    try
    {
      ...
      localObject = new sd(paramArrayOfByte, ((Camera.Parameters)localObject).getPreviewSize().width, ((Camera.Parameters)localObject).getPreviewSize().height, this.F, this.x, this.y);
      this.A.a((sd)localObject, this.E);
    }
    ...
    xv.c("OutOfMemoryError:doFaceDetect");
    label235:
    vg.h += 1;
    if (this.v)
    {
          ...
          public final void run()
          {
            synchronized (yv.this.h)
            {
              if (!yv.this.r)
              {
                ...
                yv.a(yv.this, (LiveThreshold)localObject2);
                ...
                xv.a(localStringBuilder.toString());
                yv.this.p = FaceDetector.LiveDetectInitial(yv.e(yv.this), (LiveThreshold)localObject2);
                vg.i = (int)(System.currentTimeMillis() - l);
                if (yv.this.p)
                {
                  yv.a(yv.this, System.currentTimeMillis());
                  yv.f(yv.this);
                  yv.this.r = true;
                }
                localObject2 = new StringBuilder("LiveDetectInitial,ret=");
                ((StringBuilder)localObject2).append(yv.this.p);
                ((StringBuilder)localObject2).append(",livemodelfile=");
                ((StringBuilder)localObject2).append(yv.e(yv.this));
                xv.c(((StringBuilder)localObject2).toString());
                localObject2 = new StringBuilder("LiveDetectInitial,ret=");
                ((StringBuilder)localObject2).append(yv.this.p);
                ((StringBuilder)localObject2).append(",livemodelfile=");
    ...
    for (;;)
    {
      try
      {
        ...
        case 0: 
          ...
          {
            so.a().a(System.currentTimeMillis(), 135);
            vg.k = (int)(l1 - this.t);
          }
          switch (this.G)
          {
          ...
          case 1: 
            ...
            xv.a("ret:".concat(String.valueOf(i1)));
            switch (i1)
            {
            case 6: 
              if ((this.J != null) && (!this.J.getText().toString().equals(this.O))) {
      ...
      xv.c("OutOfMemoryError:doLiveDetect");
      return;
      continue;
      return;
    }
 ...
 * Qualified Name:     com.tencent.token.yv
