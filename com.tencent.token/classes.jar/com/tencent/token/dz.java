  ...
  implements Cloneable
{
  ...
  private dz<E> a()
  {
    for (;;)
    {
      ...
      try
      {
        localdz.c = ((long[])this.c.clone());
        localdz.d = ((Object[])this.d.clone());
        return localdz;
      }
  ...
  {
    int i = dw.a(this.c, this.e, paramLong);
    if (i >= 0)
    {
      this.d[i] = paramE;
      return;
    ...
    if (this.b)
    {
      ...
      {
        b();
        i = dw.a(this.c, this.e, paramLong) ^ 0xFFFFFFFF;
      }
    }
    j = this.e;
    if (j >= this.c.length)
