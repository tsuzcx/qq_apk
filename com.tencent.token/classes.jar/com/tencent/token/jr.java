  ...
  implements View.OnClickListener
{
  ...
  public jr(Context paramContext, SearchView paramSearchView, SearchableInfo paramSearchableInfo, WeakHashMap<String, Drawable.ConstantState> paramWeakHashMap)
  {
  ...
  public final View a(Context paramContext, Cursor paramCursor, ViewGroup paramViewGroup)
  {
    ...
    ((ImageView)paramContext.findViewById(hg.f.edit_query)).setImageResource(this.p);
    return paramContext;
  }
    ...
    if (locala.b != null)
    {
      ...
      if (str1 != null)
      {
        if (this.r == null)
        {
          ...
          this.d.getTheme().resolveAttribute(hg.a.textColorSearchUrl, paramView, true);
  ...
  static final class a
  {
    ...
    public a(View paramView)
    {
      ...
      this.e = ((ImageView)paramView.findViewById(hg.f.edit_query));
    }
  }
}
