...
final class dd
{
  ...
  public static Bundle a(Notification.Builder paramBuilder, db.a parama)
  {
  ...
  private static Bundle[] a(df[] paramArrayOfdf)
  {
    if (paramArrayOfdf == null) {
      return null;
    }
    Bundle[] arrayOfBundle = new Bundle[paramArrayOfdf.length];
    int i = 0;
    while (i < paramArrayOfdf.length)
    {
      Object localObject1 = paramArrayOfdf[i];
      Bundle localBundle = new Bundle();
      localBundle.putString("resultKey", ((df)localObject1).a);
      localBundle.putCharSequence("label", ((df)localObject1).b);
      localBundle.putCharSequenceArray("choices", ((df)localObject1).c);
      localBundle.putBoolean("allowFreeFormInput", ((df)localObject1).d);
      localBundle.putBundle("extras", ((df)localObject1).e);
      Object localObject2 = ((df)localObject1).f;
