...
public final class ajh
{
  ...
  private final List<ais> h = new ArrayList();
  
  public ajh(ahr paramahr, ajf paramajf, ahv paramahv, aif paramaif)
  {
    this.a = paramahr;
    this.b = paramajf;
    this.c = paramahv;
    ...
    if (paramahr != null)
    {
      paramahr = Collections.singletonList(paramahr);
    }
    else
    {
      paramahr = this.a.g.select(paramajf.a());
      if ((paramahr != null) && (!paramahr.isEmpty())) {
        paramahr = aiw.a(paramahr);
      } else {
        paramahr = aiw.a(new Proxy[] { Proxy.NO_PROXY });
      }
    }
    this.e = paramahr;
    this.f = 0;
    ...
    if (a())
    {
      ...
      while (c()) {
        if (c())
        {
          ...
          while (i < j)
          {
            ais localais = new ais(this.a, (Proxy)localObject2, (InetSocketAddress)this.g.get(i));
            if (this.b.c(localais)) {
              this.h.add(localais);
            } else {
              ((List)localObject1).add(localais);
            }
            i += 1;
          }
