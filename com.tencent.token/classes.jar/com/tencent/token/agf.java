  ...
  extends afs
{
  ...
  {
    public final afw a(agg paramAnonymousagg, String paramAnonymousString, agk paramAnonymousagk)
    {
      return new agf(paramAnonymousagg, paramAnonymousString, (agl)paramAnonymousagk);
    }
    
    public final agk a(SQLiteDatabase paramAnonymousSQLiteDatabase, String paramAnonymousString, Object[] paramAnonymousArrayOfObject, ags paramAnonymousags)
    {
      return new agl(paramAnonymousSQLiteDatabase, paramAnonymousString, paramAnonymousArrayOfObject, paramAnonymousags);
    }
  };
  ...
  public agf(agg paramagg, String paramString, agl paramagl)
  {
    if (paramagl != null)
    {
      this.r = null;
  ...
  public final boolean requery()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 187	com/tencent/token/agf:isClosed	()Z
    //   4: ifeq +5 -> 9
    //   7: iconst_0
    //   8: ireturn
    //   9: aload_0
    //   10: monitorenter
    //   11: aload_0
    //   12: getfield 46	com/tencent/token/agf:m	Lcom/tencent/token/agl;
    //   15: getfield 76	com/tencent/token/agk:a	Lcom/tencent/wcdb/database/SQLiteDatabase;
    ...
    //   27: ireturn
    //   28: aload_0
    //   29: getfield 90	com/tencent/token/agf:i	Lcom/tencent/wcdb/CursorWindow;
    //   32: ifnull +10 -> 42
    //   35: aload_0
    //   36: getfield 90	com/tencent/token/agf:i	Lcom/tencent/wcdb/CursorWindow;
    //   39: invokevirtual 191	com/tencent/wcdb/CursorWindow:a	()V
    //   42: aload_0
    //   43: iconst_m1
    //   44: putfield 192	com/tencent/token/agf:b	I
    //   47: aload_0
    //   48: iconst_m1
    //   49: putfield 36	com/tencent/token/agf:o	I
    //   52: aload_0
    //   53: monitorexit
    //   54: aload_0
    //   55: invokespecial 194	com/tencent/token/afs:requery	()Z
    //   58: istore_1
    //   59: iload_1
    //   60: ireturn
    //   61: astore_2
