...
public final class aph
{
  ...
  public aph(Context arg1, apw paramapw)
  {
    this.k = ???;
    this.a = false;
    this.b = paramapw;
    b();
    paramapw = new AtomicLong();
    ...
    this.b.a(paramapw, localAtomicReference1, localAtomicReference2, localAtomicReference3);
    synchronized (this.f)
    {
      if (paramapw.get() > 0L) {
        this.e = paramapw.get();
 ...
 * Qualified Name:     com.tencent.token.aph
