...
{
  private static final String p = "asw";
  public ast a;
  ...
  public asw(View paramView)
  {
    ...
    this.b.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
    {
      public final void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        if (asw.a(asw.this))
        {
          asw.b(asw.this).cancel();
          asw.this.d(1.0F);
          return;
        }
        asw.this.d(((Float)paramAnonymousValueAnimator.getAnimatedValue()).floatValue());
      }
    });
  }
  ...
  private void a(boolean paramBoolean)
  {
    if (this.v == null)
    {
      this.e.add(new b()
      {
        public final void a(ast paramAnonymousast)
        {
          asw.this.c();
        }
      });
  ...
  private void f()
  {
    ast localast = this.a;
    if (localast != null) {
      this.v = new ang(this, ani.a.a(localast), this.a.e, this.a);
    }
  }
  ...
  private aml g()
  {
    ...
    aml localaml = this.f;
    if ((localaml != null) && (!localaml.a(h()))) {
      this.f = null;
    }
    if (this.f == null) {
      this.f = new aml(getCallback(), this.g, this.h, this.a.b);
    }
    return this.f;
  }
  ...
  public final boolean a(ast paramast)
  {
    if (this.a == paramast) {
      return false;
    }
    ...
    while (localIterator.hasNext())
    {
      ((b)localIterator.next()).a(paramast);
  ...
  public final void c(float paramFloat)
  {
    ...
    ((atb)localObject).a(bool);
    localObject = this.a;
    if (localObject != null) {
      this.b.setDuration(((float)((ast)localObject).a() / Math.abs(paramFloat)));
    }
  }
  ...
  public final void e()
  {
    ...
    float f1 = this.d;
    setBounds(0, 0, (int)(localast.g.width() * f1), (int)(this.a.g.height() * f1));
  }
  ...
  public int getIntrinsicHeight()
  {
    ...
    return (int)(localast.g.height() * this.d);
  }
  ...
  public int getIntrinsicWidth()
  {
    ...
    return (int)(localast.g.width() * this.d);
  }
  ...
  {
    public abstract void a(ast paramast);
  }
}
