...
public final class aas
{
  ...
  private static final aas n = a(152125131763605L);
  private static aas[] o = new aas[17];
  private static aas[] p = new aas[17];
  private static final aas q;
  ...
  static
  {
    ...
    while (i1 <= 16)
    {
      ...
      localObject[0] = i1;
      o[i1] = new aas((int[])localObject, 1);
      p[i1] = new aas((int[])localObject, -1);
      i1 += 1;
    }
    c = new aas(new int[0], 0);
    d = a(1L);
    q = a(2L);
    e = a(10L);
  ...
  aas(aat paramaat, int paramInt)
  {
    ...
    this.k = -2;
    this.l = -2;
    if ((paramaat.c <= 0) && (paramaat.a.length == paramaat.b))
    {
      this.b = paramaat.a;
    }
    else
    {
      this.b = new int[paramaat.b];
      int i1 = 0;
      while (i1 < paramaat.b)
      {
        this.b[i1] = paramaat.a[(paramaat.c + i1)];
        i1 += 1;
      }
    }
    if (paramaat.b == 0) {
  ...
  public aas(byte[] paramArrayOfByte)
  {
    int i1 = -1;
    this.h = -1;
    this.i = -1;
  ...
  private aas(int[] paramArrayOfInt)
  {
    this.h = -1;
    this.i = -1;
    this.j = -2;
  ...
  private aas(int[] paramArrayOfInt, int paramInt)
  {
    this.h = -1;
    this.i = -1;
    this.j = -2;
  ...
  private static aas a(long paramLong)
  {
    if (paramLong == 0L) {
      return c;
    }
    ...
    return new aas(paramLong);
  }
  
  private aas a(aas paramaas)
  {
    int i1 = paramaas.a;
    if (i1 == 0) {
      return this;
    ...
    if (i1 == i2) {
      return new aas(a(this.b, paramaas.b), this.a);
    }
    i1 = c(this.b, paramaas.b);
    if (i1 == 0) {
      return c;
    }
    if (i1 > 0) {
      paramaas = b(this.b, paramaas.b);
    } else {
      paramaas = b(paramaas.b, this.b);
    }
    return new aas(c(paramaas), i1 * this.a);
  }
  
  private aas a(aas paramaas, int paramInt)
  {
    Object localObject1 = a(1L);
    aas localaas2 = c(paramInt);
    int i4 = paramaas.e();
    int i3 = 0;
    ...
    while (i1 < i2)
    {
      ...
      if (paramaas.f(i1)) {
        localObject1 = ((aas)localObject2).b(localaas1).c(paramInt);
      }
      i3 = i1 + 1;
      localObject2 = localObject1;
      i1 = i3;
      if (i3 < i2)
      {
        ...
        {
          localObject2 = localaas1.b;
          localObject2 = new aas(c(a((int[])localObject2, localObject2.length, null)), 1);
        }
        localaas1 = ((aas)localObject2).c(paramInt);
        localObject2 = localObject1;
        i1 = i3;
      }
    }
  ...
  private aas b(aas paramaas)
  {
    if ((this.a != 0) && (paramaas.a != 0))
    {
      int[] arrayOfInt1 = this.b;
      int i1 = arrayOfInt1.length;
      int[] arrayOfInt2 = paramaas.b;
      return new aas(c(a(arrayOfInt1, i1, arrayOfInt2, arrayOfInt2.length, null)), this.a * paramaas.a);
    }
    return c;
  }
  
  private aas b(aas paramaas1, aas paramaas2)
  {
    if (paramaas1.equals(d)) {
      return this;
    }
    if (this.a == 0) {
      return c;
    ...
    int[] arrayOfInt2 = paramaas1.b;
    int[] arrayOfInt3 = paramaas2.b;
    ...
    int i15 = -aat.d(arrayOfInt3[(i13 - 1)]);
    ...
    {
      paramaas1 = new int[i5 + i4];
      i1 = 0;
      while (i1 < i4)
      {
        paramaas1[i1] = localObject[i1];
        i1 += 1;
      }
      a(paramaas1, paramaas1.length, i3);
      localObject = paramaas1;
    }
    else
    {
      paramaas1 = new int[i5 + i4 + 1];
      i1 = 0;
      while (i1 < i4)
      {
        paramaas1[i1] = localObject[i1];
      ...
      i5 = 32 - i3;
      i1 -= 1;
      for (i3 = paramaas1[i1]; i1 > 0; i3 = i4)
      {
        i4 = paramaas1[(i1 - 1)];
        paramaas1[i1] = (i4 << 32 - i5 | i3 >>> i5);
        i1 -= 1;
      }
      paramaas1[0] >>>= i5;
      localObject = paramaas1;
    ...
    paramaas2 = new aat();
    paramaas1 = new aat();
    new aat((int[])localObject).a(new aat(arrayOfInt3), paramaas2, paramaas1);
    paramaas2 = new int[paramaas1.b];
    i1 = 0;
    while (i1 < paramaas1.b)
    {
      paramaas2[i1] = paramaas1.a[(paramaas1.c + i1)];
      i1 += 1;
    }
    arrayOfInt[0] = paramaas2;
    if (arrayOfInt[0].length < i13)
    {
      i3 = arrayOfInt[0].length;
      paramaas1 = new int[i13];
      i1 = 0;
      while (i1 < arrayOfInt[0].length)
      {
        paramaas1[(i1 + (i13 - i3))] = arrayOfInt[0][i1];
        i1 += 1;
      }
      arrayOfInt[0] = paramaas1;
    }
    paramaas1 = a(a(arrayOfInt[0], i13, null), arrayOfInt3, i13, i15);
    paramaas2 = new int[i13];
    i1 = 0;
    while (i1 < i13)
    {
      paramaas2[i1] = paramaas1[i1];
      i1 += 1;
    }
    i1 = 1;
    while (i1 < i14)
    {
      arrayOfInt[i1] = a(a(paramaas2, i13, arrayOfInt[(i1 - 1)], i13, null), arrayOfInt3, i13, i15);
      i1 += 1;
    }
    ...
    for (;;)
    {
      ...
      if (i11 == i4) {
        if (i2 != 0)
        {
          paramaas1 = new int[paramaas2.length];
          System.arraycopy(paramaas2, 0, paramaas1, 0, paramaas2.length);
          i2 = 0;
        }
        else
        {
          arrayOfInt1 = a(a(paramaas1, i13, paramaas2, i13, (int[])localObject), arrayOfInt3, i13, i15);
          localObject = paramaas1;
          paramaas1 = arrayOfInt1;
        }
      }
      i6 = 0;
      if (i11 == 0) {
      ...
      if (i2 == 0)
      {
        arrayOfInt1 = a(a(paramaas1, i13, (int[])localObject), arrayOfInt3, i13, i15);
        localObject = paramaas1;
        paramaas1 = arrayOfInt1;
        i6 = i4;
        i4 = i8;
    ...
    paramaas2 = new int[i13 * 2];
    i1 = 0;
    while (i1 < i13)
    {
      paramaas2[(i1 + i13)] = paramaas1[i1];
      i1 += 1;
    }
    paramaas1 = a(paramaas2, arrayOfInt3, i13, i15);
    paramaas2 = new int[i13];
    i1 = i6;
    while (i1 < i13)
    {
  ...
  private aas c()
  {
    return new aas(this.b, -this.a);
  }
  
  private aas c(int paramInt)
  {
    if (e() <= paramInt) {
      return this;
    }
    ...
    if (arrayOfInt1[0] == 0) {
      return new aas(arrayOfInt1);
    }
    return new aas(arrayOfInt1, 1);
  }
  
  private aas c(aas paramaas)
  {
    if (paramaas.a > 0)
    {
      Object localObject = new aat();
      aat localaat = new aat();
      new aat(this.b).a(new aat(paramaas.b), (aat)localObject, localaat);
      localObject = new aas(localaat, this.a);
      if (((aas)localObject).a >= 0) {
        return localObject;
      }
      return ((aas)localObject).a(paramaas);
    }
  ...
  private aas d(int paramInt)
  {
    ...
    return new aas((int[])localObject, this.a);
  }
  
  private aas d(aas paramaas)
  {
    if (paramaas.a == 1)
    {
      if (paramaas.equals(d)) {
        return c;
      }
      if ((this.a >= 0) && (c(this.b, paramaas.b) < 0)) {
        localObject = this;
      } else {
        localObject = c(paramaas);
      }
      if (((aas)localObject).equals(d)) {
        return d;
      }
      aat localaat3 = new aat((aas)localObject);
      Object localObject = new aat(paramaas);
      int i1;
      ...
      if (i1 != 0)
      {
        paramaas = localaat3.c((aat)localObject);
      }
      else
      {
        if (localaat3.c()) {
        ...
        i1 = ((aat)localObject).a();
        aat localaat1 = new aat((aat)localObject);
        localaat1.a(i1);
        if (localaat1.b())
        {
          paramaas = localaat3.c(i1);
        }
        else
        {
          aat localaat2 = localaat3.c(localaat1);
          localaat3 = localaat3.c(i1);
          aat localaat4 = aat.a(new aat(1), new aat(localaat1), i1);
          aat localaat5 = localaat1.c(i1);
          aat localaat6 = new aat();
          paramaas = new aat();
          aat localaat7 = new aat();
          localaat2.b(i1);
          localaat2.a(localaat4, localaat7);
          localaat3.a(localaat1, localaat6);
          localaat6.a(localaat5, paramaas);
          localaat7.a(paramaas);
          localaat7.a((aat)localObject, localaat6, paramaas);
        }
      }
      return new aas(paramaas, 1);
      label311:
  ...
  private int e(aas paramaas)
  {
    int i1 = this.a;
    int i2 = paramaas.a;
    if (i1 == i2) {
      return i1 * c(this.b, paramaas.b);
    }
    if (i1 > i2) {
      return 1;
    }
  ...
  private aas e(int paramInt)
  {
    ...
    return new aas((int[])localObject2, this.a);
  }
  ...
  private String h(int paramInt)
  {
    ...
    paramInt = 0;
    while (((aas)localObject1).a != 0)
    {
      aas localaas = t[i1];
      Object localObject2 = new aat();
      aat localaat = new aat();
      new aat(((aas)localObject1).b).a(new aat(localaas.b), (aat)localObject2, localaat);
      localObject2 = new aas((aat)localObject2, ((aas)localObject1).a * localaas.a);
      arrayOfString[paramInt] = Long.toString(new aas(localaat, ((aas)localObject1).a * localaas.a).f(), i1);
      paramInt += 1;
      localObject1 = localObject2;
    }
  ...
  public final aas a(aas paramaas1, aas paramaas2)
  {
    if (paramaas2.a > 0)
    {
      if (paramaas1.a == 0)
      {
        if (paramaas2.equals(d)) {
          return c;
        }
        return d;
      }
      ...
      if ((equals(c)) && (paramaas1.a >= 0)) {
        return c;
      }
      Object localObject = p;
      int i1 = 1;
      if ((equals(localObject[1])) && (!paramaas1.f(0)))
      {
        if (paramaas2.equals(d)) {
          return c;
        }
      ...
      localObject = paramaas1;
      if (i1 != 0) {
        localObject = paramaas1.c();
      }
      if ((this.a >= 0) && (e(paramaas2) < 0)) {
        paramaas1 = this;
      } else {
        paramaas1 = c(paramaas2);
      }
      if (paramaas2.f(0))
      {
        paramaas1 = paramaas1.b((aas)localObject, paramaas2);
      }
      else
      {
        int i2 = paramaas2.d();
        aas localaas2 = paramaas2.e(i2);
        aas localaas3 = d.d(i2);
        aas localaas1;
        if ((this.a >= 0) && (e(localaas2) < 0)) {
          localaas1 = this;
        } else {
          localaas1 = c(localaas2);
        }
        if (localaas2.equals(d)) {
          localaas1 = c;
        } else {
          localaas1 = localaas1.b((aas)localObject, localaas2);
        }
        paramaas1 = paramaas1.a((aas)localObject, i2);
        localObject = localaas3.d(localaas2);
        aas localaas4 = localaas2.d(localaas3);
        paramaas1 = localaas1.b(localaas3).b((aas)localObject).a(paramaas1.b(localaas2).b(localaas4)).c(paramaas2);
      }
      localObject = paramaas1;
      if (i1 != 0) {
        localObject = paramaas1.d(paramaas2);
      }
      return localObject;
    }
    throw new ArithmeticException("BigInteger: modulus not positive");
