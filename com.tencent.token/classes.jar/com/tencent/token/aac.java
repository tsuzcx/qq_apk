...
public final class aac
{
  ...
  public static String a(Context paramContext)
  {
    ...
    paramContext = null;
    xa.b("androidID =".concat(String.valueOf(paramContext)));
  ...
  public static String a(Object... paramVarArgs)
  {
    try
    {
      ...
      xa.a("plain data: ".concat(String.valueOf(paramVarArgs)));
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString)
  {
    ...
    catch (Exception paramBaseActivity)
    {
      ...
      xa.b(paramBaseActivity.toString());
    }
  }
  ...
  public static void a(IndexActivity paramIndexActivity, String paramString)
  {
    ...
    catch (Exception paramIndexActivity)
    {
      ...
      xa.b(paramIndexActivity.toString());
    }
  }
  ...
  public static String b(long paramLong)
  {
    ...
    int n = b.get(7);
    if ((i == k) && (j == m)) {
      return ww.g().getResources().getString(2131493329);
    }
    if ((i == k) && (j == m + 1)) {
      return ww.g().getResources().getString(2131493337);
    }
    if ((i == k) && (j <= m + 6))
    {
      switch (n)
      ...
      default: 
        return a(b);
      case 7: 
        return ww.g().getResources().getString(2131493335);
      case 6: 
        return ww.g().getResources().getString(2131493334);
      case 5: 
        return ww.g().getResources().getString(2131493333);
      case 4: 
        return ww.g().getResources().getString(2131493332);
      case 3: 
        return ww.g().getResources().getString(2131493331);
      case 2: 
        return ww.g().getResources().getString(2131493330);
      }
      return ww.g().getResources().getString(2131493336);
    }
    return a(b);
  }
  ...
  public static String b(Context paramContext)
  {
    ...
    paramContext = null;
    xa.b("deviceId =".concat(String.valueOf(paramContext)));
    if (paramContext == null) {
      return null;
    }
    return MD5.toMD5(paramContext);
  ...
  {
    byte[] arrayOfByte = sz.a().a;
    if ((arrayOfByte != null) && (arrayOfByte.length == 16))
    {
      paramArrayOfByte = new aav().b(paramArrayOfByte, arrayOfByte);
      if (paramArrayOfByte == null)
      {
        xa.c("encrypt pwd failed");
        return null;
      }
      return sr.a(paramArrayOfByte);
    }
    boolean bool;
    if (arrayOfByte == null) {
      bool = true;
  ...
  public static String c(Context paramContext)
  {
    ...
    paramContext = null;
    xa.b("mac =".concat(String.valueOf(paramContext)));
    if (paramContext == null) {
      return null;
    }
    return MD5.toMD5(paramContext);
  ...
  public static String c(String paramString)
  {
    ...
    while (i < k)
    {
      ...
      if (j == 0)
      {
        ...
        localStringBuilder.append(zt.a(paramString.getBytes()));
        return localStringBuilder.toString();
      }
      i += 1;
    }
  ...
  public static String d(Context paramContext)
  {
    ...
    paramContext = null;
    xa.b("bssid =".concat(String.valueOf(paramContext)));
    if (paramContext == null) {
      return null;
    }
    return MD5.toMD5(paramContext);
  ...
  public static byte[] d(String paramString)
  {
    ...
    if ((arrayOfByte != null) && (arrayOfByte.length == 16)) {
      try
      {
        paramString = new aav().a(sr.a(paramString), arrayOfByte);
        return paramString;
      }
      catch (Exception paramString)
      {
  ...
  public static boolean e()
  {
    ...
    try
    {
      ...
      String str = String.valueOf(sz.a().k.b().mUin);
  ...
  public static byte[] e(String paramString)
  {
    ...
    try
    {
      paramString = new aav().a(sr.a(paramString), sb.b().a.a);
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  public static long f(long paramLong)
  {
    ...
    String str = sr.a(MD5.toMD5Byte(Long.toString(paramLong)));
