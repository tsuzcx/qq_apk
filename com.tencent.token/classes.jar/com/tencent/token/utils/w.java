...
public class w
{
  ...
  public static String a(int paramInt, long paramLong, List paramList, String[] paramArrayOfString)
  {
    try
    {
  ...
  public static String a(long paramLong, char paramChar)
  {
    ...
    h.a("testabc src=" + paramLong + ",dst=" + localStringBuffer.toString());
    return localStringBuffer.toString();
  }
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString)
  {
    ...
    catch (Exception paramBaseActivity)
    {
      ...
      h.b(paramBaseActivity.toString());
    }
  }
  ...
  public static void a(IndexActivity paramIndexActivity, String paramString)
  {
    ...
    catch (Exception paramIndexActivity)
    {
      ...
      h.b(paramIndexActivity.toString());
    }
  }
  ...
  public static byte[] c(String paramString)
  {
    ...
    try
    {
      paramString = new a().a(dg.a(paramString), arrayOfByte);
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  {
    h.a("data hex: " + paramString);
    try
    {
      paramString = new a().a(dg.a(paramString), cx.c().f());
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  public static boolean e()
  {
    ...
    try
    {
      ...
      bool1 = bool3;
      String str = String.valueOf(do.a().e().mUin);
      bool1 = bool3;
  ...
  public static long f(long paramLong)
  {
    ...
    {
      return l;
      str = dg.a(MD5.toMD5Byte(Long.toString(paramLong)));
  ...
  public static boolean h()
  {
    ...
    for (;;)
    {
      ...
      if (i < localList.size())
      {
        ...
        {
          h.c("game login: " + ((ActivityManager.RunningServiceInfo)localList.get(i)).service.getClassName());
          bool1 = true;
        }
      }
      else {
  ...
  public static void i()
  {
    ...
    try
    {
      ...
      h.a("widget_big num=" + arrayOfInt.length);
      int i = j;
      if (arrayOfInt != null)
      {
        i = j;
  ...
  {
    // Byte code:
    //   0: new 811	java/util/ArrayList
    //   3: dup
    //   4: invokespecial 812	java/util/ArrayList:<init>	()V
    //   7: astore_0
    //   8: new 814	java/io/DataInputStream
    //   11: dup
    //   12: invokestatic 413	com/tencent/token/global/RqdApplication:l	()Landroid/content/Context;
    //   15: invokevirtual 102	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   18: invokevirtual 818	android/content/res/Resources:getAssets	()Landroid/content/res/AssetManager;
    //   21: ldc_w 820
    //   24: invokevirtual 826	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   27: invokespecial 829	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   30: astore_2
    //   31: aload_2
    //   32: ifnull +64 -> 96
    //   35: aload_2
    //   36: invokevirtual 832	java/io/DataInputStream:readLine	()Ljava/lang/String;
    //   39: astore_1
    //   40: aload_1
    //   41: ifnull +61 -> 102
    //   44: aload_1
    //   45: invokevirtual 284	java/lang/String:length	()I
    //   48: iconst_1
    //   49: if_icmple -14 -> 35
    //   52: aload_1
    //   53: invokevirtual 834	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   56: ldc_w 836
    //   59: invokevirtual 726	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   62: iflt -27 -> 35
    //   65: aload_0
    //   66: aload_1
    //   67: ldc_w 836
    //   70: invokevirtual 284	java/lang/String:length	()I
    //   73: invokevirtual 700	java/lang/String:substring	(I)Ljava/lang/String;
    //   76: invokevirtual 839	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   79: pop
    //   80: goto -45 -> 35
    //   83: astore_0
    //   84: aload_0
    //   85: invokevirtual 367	java/lang/Exception:printStackTrace	()V
    //   88: aload_2
    //   89: ifnull +7 -> 96
    //   92: aload_2
    //   93: invokevirtual 842	java/io/DataInputStream:close	()V
    //   96: ldc_w 844
    //   99: astore_1
    //   100: aload_1
    //   101: areturn
    //   102: aload_0
    //   103: invokevirtual 845	java/util/ArrayList:size	()I
    //   106: ifle +33 -> 139
    //   109: aload_0
    //   110: aload_0
    //   111: invokevirtual 845	java/util/ArrayList:size	()I
    //   114: iconst_1
    //   115: isub
    //   116: invokevirtual 846	java/util/ArrayList:get	(I)Ljava/lang/Object;
    ...
    //   126: ifnull -26 -> 100
    //   129: aload_2
    //   130: invokevirtual 842	java/io/DataInputStream:close	()V
    //   133: aload_0
    //   134: areturn
    //   135: astore_0
    //   136: goto -40 -> 96
    ...
    //   148: ifnull +7 -> 155
    //   151: aload_2
    //   152: invokevirtual 842	java/io/DataInputStream:close	()V
    //   155: aload_0
    //   156: athrow
