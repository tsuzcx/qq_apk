...
public final class ky
{
  ...
  public static ky a(String paramString1, String paramString2)
  {
    if (TextUtils.isEmpty(paramString2)) {
      return null;
    }
    ky localky = new ky();
    localky.c = paramString1;
    try
    {
      paramString2 = new JSONObject(paramString2);
      if (paramString2.has("pkglist")) {
        localky.e = b(paramString2.getString("pkglist"));
      }
      if (paramString2.has("mode")) {
        localky.d = paramString2.getInt("mode");
      }
      if (paramString2.has("img1")) {
        localky.f = paramString2.getString("img1");
      }
      if (paramString2.has("img2")) {
        localky.g = paramString2.getString("img2");
      }
      if (paramString2.has("img3")) {
        localky.h = paramString2.getString("img3");
      }
      if (paramString2.has("text1")) {
        localky.i = paramString2.getString("text1");
      }
      if (paramString2.has("text2")) {
        localky.j = paramString2.getString("text2");
      }
      if (paramString2.has("text3")) {
        localky.k = paramString2.getString("text3");
      }
      if (paramString2.has("text4")) {
        localky.l = paramString2.getString("text4");
      }
      if (paramString2.has("text5")) {
        localky.m = paramString2.getString("text5");
      }
      if (paramString2.has("text6")) {
        localky.n = paramString2.getString("text6");
      }
      if (paramString2.has("text7")) {
        localky.o = paramString2.getString("text7");
      }
      if (paramString2.has("text8")) {
        localky.p = paramString2.getString("text8");
      }
      if (paramString2.has("lastpkg")) {
        localky.q = paramString2.getString("lastpkg");
      }
      if (paramString2.has("interval")) {
        localky.s = paramString2.getInt("interval");
      }
      if (paramString2.has("begin")) {
        localky.t = paramString2.getLong("begin");
      }
      if (paramString2.has("end")) {
        localky.u = paramString2.getLong("end");
      }
      paramString1 = localky;
      if (paramString2.has("timestamp"))
      {
        localky.r = paramString2.getLong("timestamp");
        return localky;
      }
    }
  ...
  public final la a(Context paramContext, HashSet<String> paramHashSet)
  {
    int i1 = a;
    int i2 = this.d;
    ...
    if (i1 == i2)
    {
      ...
      } while (((paramHashSet != null) && (paramHashSet.contains(localObject))) || (zl.b(paramContext, (String)localObject)));
    ...
    else
    {
      if (b == i2)
      {
        ...
        {
          String str = (String)localIterator.next();
          if (((paramHashSet == null) || (!paramHashSet.contains(str))) && (!zl.b(paramContext, str))) {
  ...
  public final void a(String paramString)
  {
    ...
    if ((paramString != null) && (!TextUtils.isEmpty(this.c))) {
      ahc.b(this.c, paramString.toString());
    }
  }
