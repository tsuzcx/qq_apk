...
public final class aah
{
  static FileFilter a = new FileFilter()
  {
    public final boolean accept(File paramAnonymousFile)
    {
      ...
      return aah.a(paramAnonymousFile) > 0L;
    }
  };
  ...
  private FileFilter k = new FileFilter()
  {
    public final boolean accept(File paramAnonymousFile)
    {
      if (!paramAnonymousFile.getName().endsWith(aah.this.g)) {
        return false;
      }
      return aah.c(paramAnonymousFile) != -1;
    }
  };
  private Comparator<? super File> l = new Comparator() {};
  
  public aah(File paramFile, int paramInt, String paramString1, String paramString2, long paramLong)
  {
    this.e = paramFile;
    this.j = paramInt;
    this.i = 262144;
