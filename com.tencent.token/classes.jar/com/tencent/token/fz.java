  ...
  extends gb
{
  ...
  fz(Method paramMethod1, Method paramMethod2, Method paramMethod3, Class<?> paramClass1, Class<?> paramClass2)
  {
    this.a = paramMethod1;
    this.b = paramMethod2;
    this.c = paramMethod3;
  ...
  public static gb a()
  {
    try
    {
      ...
      localObject = new fz(((Class)localObject).getMethod("put", new Class[] { SSLSocket.class, localClass1 }), ((Class)localObject).getMethod("get", new Class[] { SSLSocket.class }), ((Class)localObject).getMethod("remove", new Class[] { SSLSocket.class }), localClass2, localClass3);
      return localObject;
    }
  ...
  public String a(SSLSocket paramSSLSocket)
  {
    try
    {
      ...
      {
        gb.c().a(4, "ALPN callback dropped: HTTP/2 is disabled. Is alpn-boot on the boot class path?", null);
        return null;
      }
      if (paramSSLSocket.a) {
        paramSSLSocket = null;
    ...
    {
      throw fb.a("unable to get selected protocol", paramSSLSocket);
    }
  ...
  public void a(SSLSocket paramSSLSocket, String paramString, List<Protocol> paramList)
  {
    ...
    try
    {
      paramString = gb.class.getClassLoader();
      paramList = this.d;
    ...
    {
      throw fb.a("unable to set alpn", paramSSLSocket);
    }
    catch (InvocationTargetException paramSSLSocket)
    {
      label77:
  ...
  public void b(SSLSocket paramSSLSocket)
  {
    ...
    {
      throw fb.a("unable to remove alpn", paramSSLSocket);
    }
    catch (InvocationTargetException paramSSLSocket)
    {
      label19:
