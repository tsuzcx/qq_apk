...
public final class lm
{
  ...
  public static String a(String paramString)
  {
    ...
    localObject = new lm();
    ((lm)localObject).a();
    ((lm)localObject).a(new ByteArrayInputStream(paramString), paramString.length);
    paramString = new byte[8];
    a(paramString, ((lm)localObject).c, 8);
    ...
    ((lm)localObject).a(a, i);
    ((lm)localObject).a(paramString, 8);
    a(((lm)localObject).e, ((lm)localObject).b, 16);
    localObject = ((lm)localObject).e;
    paramString = "";
    i = 0;
    while (i < 16)
    {
