  ...
  implements ef
{
  ...
  if(id paramid, int paramInt1, int paramInt2, int paramInt3, int paramInt4, CharSequence paramCharSequence, int paramInt5)
  {
    this.b = paramid;
    this.i = paramInt2;
    this.j = paramInt1;
  ...
  private Drawable a(Drawable paramDrawable)
  {
    ...
    if (paramDrawable != null)
    {
      ...
      if (this.D) {
        ...
        {
          localDrawable = dy.d(paramDrawable).mutate();
          if (this.B) {
            dy.a(localDrawable, this.z);
          }
          if (this.C) {
  ...
  public final CharSequence a(il.a parama)
  {
    if (parama.a()) {
  ...
  public final void a(iq paramiq)
  {
    this.u = paramiq;
    paramiq.setHeaderTitle(getTitle());
  }
  ...
  public final boolean b()
  {
    ...
    localObject = this.b;
    if (((id)localObject).a((id)localObject, this)) {
      return true;
    }
    localObject = this.v;
    if (localObject != null)
    ...
    localObject = this.c;
    return (localObject != null) && (((fa)localObject).d());
  }
  ...
  public final Drawable getIcon()
  {
    ...
    if (this.t != 0)
    {
      localDrawable = hi.b(this.b.a, this.t);
      this.t = 0;
  ...
  public final MenuItem setChecked(boolean paramBoolean)
  {
    if ((this.E & 0x4) != 0)
    {
      id localid = this.b;
      int i2 = getGroupId();
      int i3 = localid.c.size();
      localid.d();
      int i1 = 0;
      while (i1 < i3)
      {
        if localif = (if)localid.c.get(i1);
        if ((localif.getGroupId() == i2) && (localif.e()) && (localif.isCheckable()))
        {
          if (localif == this) {
            paramBoolean = true;
          } else {
  ...
  public final MenuItem setTitle(CharSequence paramCharSequence)
  {
    ...
    iq localiq = this.u;
    if (localiq != null) {
      localiq.setHeaderTitle(paramCharSequence);
    }
    return this;
  }
