...
class dj
  extends Drawable
  implements Drawable.Callback, dh, di
{
  ...
  dj(Drawable paramDrawable)
  {
    this.b = b();
    a(paramDrawable);
  }
  
  dj(a parama, Resources paramResources)
  {
    this.b = parama;
    parama = this.b;
    ...
    extends dj.a
  {
    ...
    {
      return new dj(this, paramResources);
    }
  }
}
