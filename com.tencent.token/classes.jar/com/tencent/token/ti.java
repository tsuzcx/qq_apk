  ...
  extends tj
{
  ...
  protected final void a(aaq paramaaq)
  {
    this.d = ((Long)paramaaq.c.get("param.uinhash")).longValue();
    this.e = ((int[])paramaaq.c.get("param.mbinfo.id"));
    this.f = ((int[])paramaaq.c.get("param.mbinfo.val"));
    this.g = ((String)paramaaq.c.get("param.wtlogin.a2"));
  ...
  protected final void a(JSONObject paramJSONObject)
  {
    ...
    if (paramJSONObject != null)
    {
      ...
      xa.b("ProtoSetServiceStatusV2:".concat(String.valueOf(paramJSONObject)));
