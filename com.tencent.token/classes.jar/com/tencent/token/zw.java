...
public final class zw
{
  ...
  {
    // Byte code:
    //   0: getstatic 28	com/tencent/token/zx:a	Ljava/lang/String;
    //   3: astore 5
  ...
  public static int i()
  {
    ...
    try
    {
      if ((!Build.FINGERPRINT.startsWith("generic")) && (!Build.FINGERPRINT.startsWith("unknown")) && (!xr.a.contains("google_sdk")) && (!xr.a.contains("Emulator")) && (!xr.a.contains("Android SDK built for x86")) && (!Build.MANUFACTURER.contains("Genymotion")) && ((!Build.BRAND.startsWith("generic")) || (!Build.DEVICE.startsWith("generic"))))
      {
