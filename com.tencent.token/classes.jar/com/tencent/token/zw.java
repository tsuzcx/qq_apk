...
public final class zw
{
  static FileFilter a = new FileFilter()
  {
    public final boolean accept(File paramAnonymousFile)
    {
      ...
      return zw.a(paramAnonymousFile) > 0L;
    }
  };
  ...
  private FileFilter k = new FileFilter()
  {
    public final boolean accept(File paramAnonymousFile)
    {
      if (!paramAnonymousFile.getName().endsWith(zw.this.g)) {
        return false;
      }
      return zw.c(paramAnonymousFile) != -1;
    }
  };
  private Comparator<? super File> l = new Comparator() {};
  
  public zw(File paramFile, int paramInt, String paramString1, String paramString2, long paramLong)
  {
    this.e = paramFile;
    this.j = paramInt;
    this.i = 262144;
