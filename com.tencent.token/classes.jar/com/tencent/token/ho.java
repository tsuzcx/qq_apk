  ...
  implements do
{
  ...
  ho(hm paramhm, int paramInt1, int paramInt2, int paramInt3, int paramInt4, CharSequence paramCharSequence, int paramInt5)
  {
    this.b = paramhm;
    this.i = paramInt2;
    this.j = paramInt1;
  ...
  private Drawable a(Drawable paramDrawable)
  {
    ...
    if (paramDrawable != null)
    {
      ...
      if (this.D) {
        ...
        {
          localDrawable = dh.d(paramDrawable).mutate();
          if (this.B) {
            dh.a(localDrawable, this.z);
          }
          if (this.C) {
  ...
  public final CharSequence a(hu.a parama)
  {
    if (parama.a()) {
  ...
  {
    this.u = paramhz;
    paramhz.setHeaderTitle(getTitle());
  }
  ...
  public final boolean b()
  {
    ...
    localObject = this.b;
    if (((hm)localObject).a((hm)localObject, this)) {
      return true;
    }
    localObject = this.v;
    if (localObject != null)
    ...
    localObject = this.c;
    return (localObject != null) && (((ej)localObject).d());
  }
  ...
  public final Drawable getIcon()
  {
    ...
    if (this.t != 0)
    {
      localDrawable = gr.b(this.b.a, this.t);
      this.t = 0;
  ...
  public final MenuItem setChecked(boolean paramBoolean)
  {
    if ((this.E & 0x4) != 0)
    {
      hm localhm = this.b;
      int i2 = getGroupId();
      int i3 = localhm.c.size();
      localhm.d();
      int i1 = 0;
      while (i1 < i3)
      {
        ho localho = (ho)localhm.c.get(i1);
        if ((localho.getGroupId() == i2) && (localho.e()) && (localho.isCheckable()))
        {
          if (localho == this) {
            paramBoolean = true;
          } else {
  ...
  public final MenuItem setTitle(CharSequence paramCharSequence)
  {
    ...
    hz localhz = this.u;
    if (localhz != null) {
      localhz.setHeaderTitle(paramCharSequence);
    }
    return this;
  }
