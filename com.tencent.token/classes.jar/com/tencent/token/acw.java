...
public final class acw
{
  ...
  public acw(Context paramContext, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    this.d = paramContext;
    this.c = new ach(paramInt1);
  ...
  public acw(Context paramContext, Virgo paramVirgo)
  {
    this.d = paramContext;
    this.j = paramVirgo.rb;
    this.c = new ach(paramVirgo.ub);
  ...
  public final boolean a()
  {
    ...
    if (k != 0)
    {
      ...
      {
        localObject = this.c;
        localObject = (Long)((ach)localObject).a(((ach)localObject).b.size() - this.f);
