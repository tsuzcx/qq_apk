  ...
  implements Camera.PreviewCallback, FaceServiceDelegate
{
  ...
  public xw(Context paramContext, SurfaceHolder paramSurfaceHolder, Handler paramHandler, int paramInt1, int paramInt2, FaceView paramFaceView, TextView paramTextView, View paramView)
  {
    k = aad.s();
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    //   7: astore 6
    //   9: aload_0
    //   10: getfield 118	com/tencent/token/xw:B	Landroid/content/Context;
    ...
    //   107: invokestatic 387	com/tencent/token/xa:a	(Ljava/lang/String;)V
    //   110: aload 9
    //   112: arraylength
    //   113: istore 4
    //   115: iconst_0
    ...
    //   169: aload_1
    //   170: aload_2
    //   171: invokespecial 389	com/tencent/token/xw:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   174: aload_2
    //   175: iconst_0
    //   176: aload_2
    ...
    //   191: goto -74 -> 117
    //   194: aload_0
    //   195: getfield 118	com/tencent/token/xw:B	Landroid/content/Context;
    ...
    //   364: invokestatic 387	com/tencent/token/xa:a	(Ljava/lang/String;)V
    //   367: sipush 1024
    //   370: newarray byte
    //   372: astore_2
    //   373: aload 6
    ...
    if (paramBoolean1)
    {
      if (this.E == DetectType.DT_REGISTER)
      {
        if ((this.H == 0) && (paramBoolean2)) {
          rt.a().a(System.currentTimeMillis(), 145);
        }
        switch (this.G)
        {
        default: 
  ...
  public final void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt)
  {
    ...
    um.f = (int)(System.currentTimeMillis() - this.s);
    um.h = paramInt;
    if (this.w == null) {
      return;
    }
    ...
    if (this.H == 0) {
      localFaceData.mOriginDataPath = zw.a(paramArrayOfByte1.toByteArray(), "origindata0");
    } else {
      localFaceData.mOriginDataPath = zw.a(paramArrayOfByte1.toByteArray(), "origindata1");
    }
  ...
  public final void c()
  {
    ...
    try
    {
      ...
      um.d = ((StringBuilder)localObject3).toString();
      localObject3 = this.x;
      localObject3[0] = 0;
  ...
  public final void onPreviewFrame(byte[] paramArrayOfByte, Camera paramCamera)
  {
    ...
    if ((this.A == null) && (!bool)) {
      new Thread(new Runnable()
      {
        ...
        {
          synchronized (xw.this.g)
          {
            if (xw.a(xw.this) == null)
            {
              xw.a(xw.this, true);
              long l = System.currentTimeMillis();
              xw.b(xw.this);
              um.g = (int)(System.currentTimeMillis() - l);
              xw.a(xw.this, new rf(xw.c(xw.this), xw.this, xw.d(xw.this)));
              FaceThreshold localFaceThreshold = new FaceThreshold();
              xw.a(localFaceThreshold);
              ...
              xa.a(localStringBuilder.toString());
              xw.a(xw.this).a = localFaceThreshold;
              xw.a(xw.this, false);
            }
            return;
          }
    ...
    try
    {
      ...
      localObject = new ri(paramArrayOfByte, ((Camera.Parameters)localObject).getPreviewSize().width, ((Camera.Parameters)localObject).getPreviewSize().height, this.F, this.x, this.y);
      this.A.a((ri)localObject, this.E);
    }
    ...
    xa.c("OutOfMemoryError:doFaceDetect");
    label235:
    um.h += 1;
    if (this.v)
    {
      ...
      if ((!this.r) && (!bool))
      {
        ...
        new Thread(new Runnable()
        {
          public final void run()
          {
            synchronized (xw.this.h)
            {
              if (!xw.this.r)
              {
                long l = System.currentTimeMillis();
                Object localObject2 = new LiveThreshold();
                xw.a(xw.this, (LiveThreshold)localObject2);
                ...
                xa.a(localStringBuilder.toString());
                xw.this.p = FaceDetector.LiveDetectInitial(xw.e(xw.this), (LiveThreshold)localObject2);
                um.i = (int)(System.currentTimeMillis() - l);
                if (xw.this.p)
                {
                  xw.a(xw.this, System.currentTimeMillis());
                  xw.f(xw.this);
                  xw.this.r = true;
                }
                localObject2 = new StringBuilder("LiveDetectInitial,ret=");
                ((StringBuilder)localObject2).append(xw.this.p);
                ((StringBuilder)localObject2).append(",livemodelfile=");
                ((StringBuilder)localObject2).append(xw.e(xw.this));
                xa.c(((StringBuilder)localObject2).toString());
                localObject2 = new StringBuilder("LiveDetectInitial,ret=");
                ((StringBuilder)localObject2).append(xw.this.p);
                ((StringBuilder)localObject2).append(",livemodelfile=");
    ...
    for (;;)
    {
      try
      {
        ...
        case 0: 
          ...
          {
            rt.a().a(System.currentTimeMillis(), 135);
            um.k = (int)(l1 - this.t);
          }
          switch (this.G)
          {
          ...
          case 1: 
            ...
            xa.a("ret:".concat(String.valueOf(i1)));
            switch (i1)
            {
            case 6: 
              if ((this.J != null) && (!this.J.getText().toString().equals(this.O))) {
      ...
      xa.c("OutOfMemoryError:doLiveDetect");
      return;
      continue;
      return;
    }
