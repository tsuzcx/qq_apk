  ...
  extends BaseAdapter
{
  ...
  public xw(BaseActivity paramBaseActivity, List<QQUser> paramList)
  {
  ...
  public final View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = (TextView)localView.findViewById(2131166073);
    paramView = (ImageView)localView.findViewById(2131165972);
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null)
      {
        ...
        localStringBuilder.append(aad.e(((QQUser)localObject).mRealUin));
        localStringBuilder.append(")");
        paramViewGroup.setText(localStringBuilder.toString());
        paramViewGroup = aae.f();
