  ...
  private sn()
  {
    ...
    if (localObject != null)
    {
      ...
      try
      {
        ...
        if (localObject != null) {
          this.l = ss.a(aay.a(localObject.getPackageManager().getPackageInfo(localObject.getPackageName(), 64).signatures[0].toByteArray()));
        }
      }
 ...
 * Qualified Name:     com.tencent.token.sn
