...
public final class ly
  implements ld.a, lu, mc
{
  private static ly c;
  public Vector a = new Vector();
  public mb b = new mb(this);
  ...
  private List i()
  {
    ...
    synchronized (this.a)
    {
      ...
      {
        ml localml = (ml)localIterator.next();
        if (localml.t()) {
          localLinkedList.add(localml);
        }
      }
  ...
  public final void a(int paramInt, String paramString)
  {
    ...
    if (((List)localObject).size() > 0)
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((ml)((Iterator)localObject).next()).a(paramInt, paramString);
      }
    }
  }
  ...
  {
    String str = "TaskManager".concat(String.valueOf(paramlt));
    StringBuilder localStringBuilder = new StringBuilder("onTaskDetectedMainloop task:");
    localStringBuilder.append(paramlt);
    localStringBuilder.append(",detectLen:");
    localStringBuilder.append(paramlt.e());
    li.a(str, localStringBuilder.toString());
  }
  
  /* Error */
  public final void a(ml paramml, int paramInt)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnonnull +4 -> 5
    ...
    //   16: aload 10
    //   18: aload_1
    //   19: invokevirtual 145	com/tencent/token/ml:c	()Ljava/lang/String;
    ...
    //   49: aload 10
    //   51: aload_1
    //   52: getfield 156	com/tencent/token/ml:m	J
    ...
    //   67: aload 10
    //   69: aload_1
    //   70: getfield 160	com/tencent/token/ml:i	J
    ...
    //   85: aload 10
    //   87: aload_1
    //   88: invokevirtual 163	com/tencent/token/ml:e	()J
    ...
    //   103: aload 10
    //   105: aload_1
    //   106: getfield 169	com/tencent/token/ml:r	Ljava/util/concurrent/atomic/AtomicLong;
    ...
    //   120: invokestatic 171	com/tencent/token/li:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   123: getstatic 176	com/tencent/token/ky:e	Z
    //   126: ifne +31 -> 157
    ...
    //   138: astore_1
    //   139: aload_1
    //   140: getstatic 176	com/tencent/token/ky:e	Z
    ...
    //   153: invokestatic 183	com/tencent/token/li:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   156: return
    ...
    //   175: aload 11
    //   177: aload_1
    //   178: getfield 191	com/tencent/token/ml:q	Ljava/lang/String;
    ...
    //   205: astore 11
    //   207: aload 11
    //   209: invokestatic 201	com/tencent/token/lr:e	()Ljava/lang/String;
    ...
    //   236: astore 11
    //   238: aload 11
    //   240: invokestatic 206	com/tencent/token/lr:f	()Ljava/lang/String;
    ...
    //   267: astore 11
    //   269: aload 11
    //   271: invokestatic 211	com/tencent/token/lr:g	()I
    ...
    //   290: pop
    //   291: getstatic 215	com/tencent/token/ky:a	Ljava/lang/String;
    ...
    //   307: astore 11
    //   309: aload 11
    //   311: getstatic 215	com/tencent/token/ky:a	Ljava/lang/String;
    ...
    //   331: aload 10
    //   333: ldc 225
    //   335: invokestatic 228	com/tencent/token/lp:f	()Ljava/lang/String;
    //   338: invokevirtual 197	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   341: pop
    //   342: aload_1
    //   343: getfield 230	com/tencent/token/ml:c	Ljava/lang/String;
    ...
    //   361: aload 11
    //   363: aload_1
    //   364: getfield 230	com/tencent/token/ml:c	Ljava/lang/String;
    ...
    //   383: pop
    //   384: aload_1
    //   385: getfield 235	com/tencent/token/ml:d	Ljava/lang/String;
    ...
    //   403: aload 11
    //   405: aload_1
    //   406: getfield 235	com/tencent/token/ml:d	Ljava/lang/String;
    ...
    //   425: pop
    //   426: getstatic 239	com/tencent/token/ky:b	Ljava/lang/String;
    ...
    //   442: astore 11
    //   444: aload 11
    //   446: getstatic 239	com/tencent/token/ky:b	Ljava/lang/String;
    ...
    //   465: pop
    //   466: getstatic 242	com/tencent/token/ky:c	Ljava/lang/String;
    ...
    //   482: astore 11
    //   484: aload 11
    //   486: getstatic 242	com/tencent/token/ky:c	Ljava/lang/String;
    ...
    //   513: astore 11
    //   515: aload 11
    //   517: invokestatic 248	com/tencent/token/lo:b	()J
    ...
    //   544: astore 11
    //   546: aload 11
    //   548: invokestatic 252	com/tencent/token/lo:a	()J
    ...
    //   570: ldc_w 256
    //   573: aload_1
    //   574: invokevirtual 259	com/tencent/token/ml:s	()Ljava/lang/String;
    ...
    //   590: aload 11
    //   592: aload_1
    //   593: getfield 261	com/tencent/token/ml:h	J
    ...
    //   623: aload 11
    //   625: aload_1
    //   626: getfield 156	com/tencent/token/ml:m	J
    ...
    //   661: aload 11
    //   663: aload_1
    //   664: getfield 273	com/tencent/token/ml:w	J
    ...
    //   708: aload 11
    //   710: aload_1
    //   711: getfield 283	com/tencent/token/ml:a	I
    ...
    //   741: aload 11
    //   743: aload_1
    //   744: getfield 286	com/tencent/token/ml:b	Ljava/lang/String;
    ...
    //   767: ldc_w 290
    //   770: aload_1
    //   771: invokevirtual 293	com/tencent/token/ml:n	()Ljava/lang/String;
    //   774: invokestatic 295	com/tencent/token/lr:b	(Ljava/lang/String;)Ljava/lang/String;
    //   777: invokevirtual 197	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   780: pop
    //   781: aload 10
    //   783: ldc_w 297
    //   786: aload_1
    //   787: getfield 301	com/tencent/token/ml:P	Ljava/util/HashMap;
    ...
    //   796: pop
    //   797: aload_1
    //   798: getfield 305	com/tencent/token/ml:u	I
    //   801: istore_3
    //   802: iconst_0
    //   803: istore 4
    //   805: iload_2
    ...
    //   839: ldc_w 314
    //   842: aload_1
    //   843: invokevirtual 317	com/tencent/token/ml:D	()Ljava/lang/String;
    //   846: invokevirtual 197	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   849: pop
    //   850: aload_1
    //   851: getfield 319	com/tencent/token/ml:I	Ljava/lang/String;
    ...
    //   869: aload 11
    //   871: aload_1
    //   872: getfield 319	com/tencent/token/ml:I	Ljava/lang/String;
    ...
    //   900: astore 11
    //   902: aload 11
    //   904: invokestatic 323	com/tencent/token/ld:e	()I
    ...
    //   934: aload 11
    //   936: aload_1
    //   937: invokevirtual 328	com/tencent/token/ml:A	()Ljava/lang/String;
    ...
    //   967: aload 11
    //   969: aload_1
    //   970: getfield 332	com/tencent/token/ml:J	I
    ...
    //   998: astore 11
    //   1000: aload_1
    //   1001: getfield 336	com/tencent/token/ml:n	Z
    //   1004: ifeq +777 -> 1781
    //   1007: iconst_1
    //   1008: istore_3
    //   1009: goto +3 -> 1012
    ...
    //   1032: pop
    //   1033: aload_1
    //   1034: getfield 340	com/tencent/token/ml:A	Z
    //   1037: istore 9
    ...
    //   1095: aload 11
    //   1097: aload_1
    //   1098: invokevirtual 346	com/tencent/token/ml:y	()J
    ...
    //   1128: aload 11
    //   1130: aload_1
    //   1131: getfield 350	com/tencent/token/ml:g	J
    ...
    //   1154: ldc_w 354
    //   1157: aload_1
    //   1158: invokevirtual 357	com/tencent/token/ml:B	()Ljava/lang/String;
    ...
    //   1173: putfield 364	com/tencent/token/ml:y	J
    //   1176: ldc2_w 365
    //   1179: lstore 7
    //   1181: lload 7
    //   1183: lstore 5
    //   1185: aload_1
    //   1186: getfield 369	com/tencent/token/ml:x	J
    //   1189: lconst_0
    //   1190: lcmp
    //   1191: ifle +30 -> 1221
    //   1194: lload 7
    //   1196: lstore 5
    //   1198: aload_1
    //   1199: getfield 364	com/tencent/token/ml:y	J
    //   1202: aload_1
    //   1203: getfield 369	com/tencent/token/ml:x	J
    //   1206: lcmp
    //   1207: ifle +14 -> 1221
    //   1210: aload_1
    //   1211: getfield 364	com/tencent/token/ml:y	J
    //   1214: aload_1
    //   1215: getfield 369	com/tencent/token/ml:x	J
    //   1218: lsub
    //   1219: lstore 5
    //   1221: aload 10
    //   1223: ldc_w 371
    ...
    //   1244: aload 11
    //   1246: aload_1
    //   1247: getfield 160	com/tencent/token/ml:i	J
    ...
    //   1277: aload 11
    //   1279: aload_1
    //   1280: getfield 169	com/tencent/token/ml:r	Ljava/util/concurrent/atomic/AtomicLong;
    ...
    //   1310: aload 11
    //   1312: aload_1
    //   1313: getfield 377	com/tencent/token/ml:s	Ljava/util/concurrent/atomic/AtomicLong;
    //   1316: lconst_0
    ...
    //   1337: pop
    //   1338: aload_1
    //   1339: getfield 388	com/tencent/token/ml:G	Z
    //   1342: ifeq +15 -> 1357
    //   1345: aload 10
    //   1347: ldc_w 390
    //   1350: ldc_w 392
    ...
    //   1370: aload 11
    //   1372: aload_1
    //   1373: getfield 396	com/tencent/token/ml:C	Lcom/tencent/halley/downloader/c/b;
    ...
    //   1406: aload 11
    //   1408: aload_0
    //   1409: invokespecial 404	com/tencent/token/ly:h	()I
    ...
    //   1439: aload 11
    //   1441: aload_1
    //   1442: getfield 409	com/tencent/token/ml:E	I
    ...
    //   1472: aload 11
    //   1474: aload_1
    //   1475: invokevirtual 413	com/tencent/token/ml:x	()I
    ...
    //   1505: aload 11
    //   1507: aload_1
    //   1508: invokevirtual 417	com/tencent/token/ml:w	()J
    ...
    //   1528: pop
    //   1529: aload_1
    //   1530: getfield 422	com/tencent/token/ml:F	Z
    //   1533: ifeq +15 -> 1548
    //   1536: aload 10
    //   1538: ldc_w 424
    //   1541: ldc_w 392
    ...
    //   1549: ifne +45 -> 1594
    //   1552: aload_1
    //   1553: getfield 427	com/tencent/token/ml:K	J
    //   1556: lconst_0
    //   1557: lcmp
    //   1558: ifle +36 -> 1594
    ...
    //   1570: aload 11
    //   1572: aload_1
    //   1573: getfield 427	com/tencent/token/ml:K	J
    ...
    //   1603: aload 11
    //   1605: aload_1
    //   1606: invokevirtual 431	com/tencent/token/ml:C	()Ljava/lang/String;
    ...
    //   1636: aload 11
    //   1638: aload_1
    //   1639: invokevirtual 436	com/tencent/token/ml:z	()Ljava/lang/String;
    ...
    //   1659: pop
    //   1660: aload_1
    //   1661: getfield 441	com/tencent/token/ml:H	Ljava/lang/String;
    ...
    //   1679: aload 11
    //   1681: aload_1
    //   1682: getfield 441	com/tencent/token/ml:H	Ljava/lang/String;
    ...
    //   1702: pop
    //   1703: aload_1
    //   1704: getfield 446	com/tencent/token/ml:N	Ljava/lang/String;
    //   1707: invokestatic 221	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1710: ifne +49 -> 1759
    //   1713: aload 10
    //   1715: ldc_w 448
    //   1718: aload_1
    //   1719: getfield 446	com/tencent/token/ml:N	Ljava/lang/String;
    ...
    //   1735: aload 11
    //   1737: aload_1
    //   1738: getfield 451	com/tencent/token/ml:O	I
    ...
    //   1759: ldc_w 455
    //   1762: aload 10
    //   1764: invokestatic 460	com/tencent/token/lq:a	(Ljava/lang/String;Ljava/util/Map;)Z
    //   1767: pop
    //   1768: return
    //   1769: astore_1
    //   1770: goto +9 -> 1779
  ...
  public final void b(lt paramlt)
  {
    ...
    localStringBuilder.append(paramlt.a_());
    localStringBuilder.append(",percentage:");
    localStringBuilder.append(paramlt.g());
    li.a(str, localStringBuilder.toString());
  }
  ...
  public final void c(lt paramlt)
  {
    if (e()) {
      this.b.a();
    } else {
    ...
    li.a("TaskManager".concat(String.valueOf(paramlt)), "onTaskPausedMainloop task:".concat(String.valueOf(paramlt)));
  }
  ...
  public final void d(lt paramlt)
  {
    if (e()) {
      this.b.a();
    } else {
    ...
    localStringBuilder.append(paramlt.m());
    localStringBuilder.append(",failInfo:");
    localStringBuilder.append(paramlt.n());
    li.a(str, localStringBuilder.toString());
  }
  
  public final void e(lt paramlt)
  {
    if (e()) {
      this.b.a();
    } else {
    ...
    li.a("TaskManager".concat(String.valueOf(paramlt)), "onTaskCompletedMainloop task:".concat(String.valueOf(paramlt)));
  }
    ...
    for (;;)
    {
      ...
      synchronized (this.a)
      {
        ...
        if (bool)
        {
          ...
          if (!localml.t())
          {
            if (localml.C.b == DownloaderTaskStatus.PENDING) {
              i = 1;
            }
          }
          else {
  ...
  public final void f(lt paramlt) {}
  ...
  public final boolean f()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ml localml = (ml)((Iterator)localObject).next();
      if (localml.E < i) {
        localml.E = i;
      }
      if (localml.f()) {
  ...
  public final void g(lt paramlt)
  {
    a((ml)paramlt, 2);
  }
  
  public final void h(lt paramlt)
  {
    a((ml)paramlt, 1);
  }
  
  public final void i(lt paramlt)
  {
    a((ml)paramlt, 0);
  }
}
