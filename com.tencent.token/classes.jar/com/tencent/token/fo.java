  ...
  implements Animatable
{
  ...
  private static final Interpolator c = new fi();
  ...
  public fo(final Context paramContext)
  {
    this.f = ((Context)ef.a(paramContext)).getResources();
    this.a = new a();
    this.a.a(d);
    this.a.a(2.5F);
    invalidateSelf();
    ...
    localValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
    {
      public final void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        ...
        fo.a(f, paramContext);
        fo.a(fo.this, f, paramContext, false);
        fo.this.invalidateSelf();
      }
    });
    ...
    localValueAnimator.addListener(new Animator.AnimatorListener()
    {
      ...
      {
        fo.a(fo.this, 1.0F, paramContext, true);
        paramContext.c();
        fo.a locala = paramContext;
        locala.a(locala.a());
        if (fo.a(fo.this))
        {
          fo.b(fo.this);
        ...
        paramAnonymousAnimator = fo.this;
        fo.a(paramAnonymousAnimator, fo.c(paramAnonymousAnimator) + 1.0F);
      }
