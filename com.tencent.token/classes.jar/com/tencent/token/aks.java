...
{
  public static final aks a = new aks(new LinkedHashSet(new a().a), null);
  final Set<b> b;
  @Nullable
  final ano c;
  
  aks(Set<b> paramSet, @Nullable ano paramano)
  {
    this.b = paramSet;
    this.c = paramano;
  }
  
  private static anw a(X509Certificate paramX509Certificate)
  {
    return anw.a(paramX509Certificate.getPublicKey().getEncoded()).d();
  }
  ...
  public final void a(String paramString, List<Certificate> paramList)
  {
    ...
    if (localObject1 != null) {
      localObject4 = ((ano)localObject1).a(paramList, paramString);
    } else {
    ...
    while (i < m)
    {
      ...
      while (j < n)
      {
        ...
        else
        {
          ...
          if (paramList == null) {
            localObject2 = anw.a(localX509Certificate.getPublicKey().getEncoded()).c();
          }
  ...
  public final boolean equals(@Nullable Object paramObject)
  {
    ...
    if ((paramObject instanceof aks))
    {
      ano localano = this.c;
      paramObject = (aks)paramObject;
      if ((alr.a(localano, paramObject.c)) && (this.b.equals(paramObject.b))) {
        return true;
      }
    }
    return false;
  ...
  {
    final List<aks.b> a = new ArrayList();
  }
