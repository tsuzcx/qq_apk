  ...
  extends Service
{
  ...
  public TokenService()
  {
    ...
    arrayOfInt[0] = 2131100195;
    arrayOfInt[1] = 2131100196;
    arrayOfInt[2] = 2131100197;
    arrayOfInt[3] = 2131100198;
    arrayOfInt[4] = 2131100199;
    arrayOfInt[5] = 2131100200;
    arrayOfInt[6] = 2131100201;
    arrayOfInt[7] = 2131100202;
    arrayOfInt[8] = 2131100203;
    arrayOfInt[9] = 2131100204;
  }
  
  private void a()
  {
    Object localObject2 = rt.a();
    if (!((rt)localObject2).d())
    {
      ...
      this.c.setImageViewResource(2131166328, 2131100213);
      boolean bool = this.f;
      int i1 = 0;
      if (!bool)
      {
        this.b = ((rt)localObject2).f();
        if (this.g) {
          this.c.setImageViewResource(2131166328, 2131100210);
        }
        this.c.setViewVisibility(2131166327, 4);
        this.c.setViewVisibility(2131166171, 4);
        this.c.setViewVisibility(2131166180, 0);
        this.c.setViewVisibility(2131166178, 0);
        this.c.setOnClickPendingIntent(2131166180, this.j);
        int m = 0;
        for (;;)
        {
          localObject2 = this.b;
          ...
          this.c.setImageViewResource(2131166172 + m, this.h[localObject2[m]]);
          m += 1;
        }
      }
      this.c.setViewVisibility(2131166180, 4);
      this.c.setViewVisibility(2131166178, 4);
      this.c.setViewVisibility(2131166327, 0);
      this.c.setViewVisibility(2131166171, 0);
      this.c.setOnClickPendingIntent(2131166327, this.i);
      int n = i1;
      try
      {
  ...
  public void onStart(Intent paramIntent, int paramInt)
  {
    ...
    //   130: aload_0
    //   131: invokestatic 169	com/tencent/token/sx:a	(Landroid/content/Context;)Lcom/tencent/token/sx;
    //   134: pop
    ...
    //   147: ldc2_w 219
    //   150: lstore_3
    //   151: invokestatic 73	com/tencent/token/rt:a	()Lcom/tencent/token/rt;
    //   154: invokevirtual 76	com/tencent/token/rt:d	()Z
    //   157: ifne +75 -> 232
    //   160: invokestatic 225	com/tencent/token/sw:a	()Lcom/tencent/token/sw;
    //   163: invokevirtual 227	com/tencent/token/sw:c	()Z
    //   166: ifne +53 -> 219
    //   169: invokestatic 231	com/tencent/token/aaz:e	()J
    //   172: lconst_0
    //   173: lcmp
    //   174: ifeq +6 -> 180
    //   177: goto +42 -> 219
    ...
    //   185: invokestatic 235	com/tencent/token/sv:d	()J
    //   188: lstore_3
    //   189: lload_3
    //   190: ldc2_w 236
    //   193: lcmp
