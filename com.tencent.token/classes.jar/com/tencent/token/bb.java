...
public final class bb
{
  ...
  private static Map<Class, List<Constructor<? extends au>>> b = new HashMap();
  ...
  static GenericLifecycleObserver a(Object paramObject)
  {
    ...
    if (b((Class)localObject) == 2)
    {
      ...
      au[] arrayOfau = new au[((List)localObject).size()];
      while (i < ((List)localObject).size())
      {
        arrayOfau[i] = a((Constructor)((List)localObject).get(i), paramObject);
        i += 1;
      }
      return new CompositeGeneratedAdaptersObserver(arrayOfau);
    }
    return new ReflectiveGenericLifecycleObserver(paramObject);
  }
  
  private static au a(Constructor<? extends au> paramConstructor, Object paramObject)
  {
    try
    {
      paramConstructor = (au)paramConstructor.newInstance(new Object[] { paramObject });
  ...
  private static Constructor<? extends au> a(Class<?> paramClass)
  {
    try
    {
  ...
  {
    return (paramClass != null) && (ax.class.isAssignableFrom(paramClass));
  }
}
