  ...
  implements SharedPreferences
{
  ...
  private Object a(String paramString)
  {
    for (;;)
    {
      try
      {
        Cursor localCursor = this.a.query(pg.b.a, this.b, "key = ?", new String[] { paramString }, null);
        if (localCursor == null) {
          return null;
        }
        ...
        {
          paramString = pg.a.a(localCursor.getInt(i), localCursor.getString(j));
          localCursor.close();
          return paramString;
        }
      }
  ...
  public final Map<String, ?> getAll()
  {
    try
    {
      Object localObject1 = this.a.query(pg.b.a, this.b, null, null, null);
      ...
      {
        Object localObject2 = pg.a.a(((Cursor)localObject1).getInt(j), ((Cursor)localObject1).getString(k));
    ...
    implements SharedPreferences.Editor
  {
    ...
    public final boolean commit()
    {
      ...
      if (this.c)
      {
        this.d.delete(pg.b.a, null, null);
        this.c = false;
      }
      ...
      while (localIterator.hasNext())
      {
        ...
        this.d.delete(pg.b.a, "key = ?", new String[] { localObject1 });
      }
      ...
      while (localIterator.hasNext())
      {
        ...
        if (i != 0) {
          this.d.update(pg.b.a, localContentValues, "key = ?", new String[] { (String)((Map.Entry)localObject1).getKey() });
        }
      }
      return true;
    }
