...
public final class cz
{
  ...
  {
    Object localObject = paramResources.obtainAttributes(Xml.asAttributeSet(paramXmlPullParser), bm.b.FontFamily);
    String str1 = ((TypedArray)localObject).getString(bm.b.FontFamily_fontProviderAuthority);
    String str2 = ((TypedArray)localObject).getString(bm.b.FontFamily_fontProviderPackage);
    String str3 = ((TypedArray)localObject).getString(bm.b.FontFamily_fontProviderQuery);
    int i = ((TypedArray)localObject).getResourceId(bm.b.FontFamily_fontProviderCerts, 0);
    int j = ((TypedArray)localObject).getInteger(bm.b.FontFamily_fontProviderFetchStrategy, 1);
    int k = ((TypedArray)localObject).getInteger(bm.b.FontFamily_fontProviderFetchTimeout, 500);
    ...
    if ((str1 != null) && (str2 != null) && (str3 != null))
    {
      ...
      return new d(new dv(str1, str2, str3, a(paramResources, i)), j, k);
    }
  ...
  {
    paramResources = paramResources.obtainAttributes(Xml.asAttributeSet(paramXmlPullParser), bm.b.FontFamilyFont);
    if (paramResources.hasValue(bm.b.FontFamilyFont_fontWeight)) {
      i = bm.b.FontFamilyFont_fontWeight;
    } else {
      i = bm.b.FontFamilyFont_android_fontWeight;
    }
    int j = paramResources.getInt(i, 400);
    if (paramResources.hasValue(bm.b.FontFamilyFont_fontStyle)) {
      i = bm.b.FontFamilyFont_fontStyle;
    } else {
      i = bm.b.FontFamilyFont_android_fontStyle;
    }
    ...
    if (paramResources.hasValue(bm.b.FontFamilyFont_font)) {
      i = bm.b.FontFamilyFont_font;
    } else {
      i = bm.b.FontFamilyFont_android_font;
    }
    ...
    implements cz.a
  {
    ...
    public d(dv paramdv, int paramInt1, int paramInt2)
    {
      this.a = paramdv;
      this.c = paramInt1;
      this.b = paramInt2;
