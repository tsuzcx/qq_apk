...
public final class rq
{
  ...
  public rp c = rp.a();
  private boolean e;
  private rm f = new rm("com.tencent.token");
  ...
  public final void a(final ro paramro)
  {
  ...
  final boolean a(boolean paramBoolean)
  {
    ...
    if ((this.c.a.a("meri_silent_update_switch_user", true)) && (localObject1 == aos.d))
    {
  ...
  public final void c()
  {
    synchronized (this.h)
    {
      ...
      localrp.h(0);
      localrp.d("");
      localrp.a.b("meri_update_start_time", 0L);
      localrp.a(0L);
      localrp.b(0);
      localrp.c(0);
      localrp.d(0);
      ...
      localrp.a(0);
      localrp.a("");
      localrp.a.b("meri_patch_url", "");
      localrp.g(0);
      localrp.b(0L);
      localrp.c(0L);
      localrp.a.b("meri_update_show_dialog_count", 0);
      localrp.b(false);
      localrp.e("");
      localrp.f("");
      localrp.g("");
      localrp.i(0);
      localrp.j(0);
      localrp.a.b("has_click_update_tip_in_main_page", false);
      localrp.a.b();
      this.c.k(0);
  ...
  public final void f()
  {
    ...
    new Handler(Looper.getMainLooper()).post(new Runnable()
    {
      ...
      {
        if (rq.a(rq.this) != null)
        {
          new UpdateDownloadDialog(rq.a(rq.this), locala).show();
          rq.d();
          rq.b(rq.this).c(System.currentTimeMillis() + rq.b(rq.this).n());
        }
      }
    });
  }
  ...
  public final void h()
  {
    a(new ro()
    {
      public final void a()
      {
        if (rq.b(rq.this).a.a("meri_update_msg_type") != 6) {
          return;
        }
        rq localrq = rq.this;
        rc.a locala = rq.a().g();
        if ((locala != null) && (localrq.b != null)) {
          new Handler(Looper.getMainLooper()).post(new rq.3(localrq, locala));
        }
      }
