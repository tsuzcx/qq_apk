  ...
  extends JceStruct
{
  ...
  static anp B;
  static ArrayList<anp> C;
  static ArrayList<ana> x = new ArrayList();
  ...
  public int u = 0;
  public anp v = null;
  public ArrayList<anp> w = null;
  
  static
  {
    Object localObject = new ana();
    x.add(localObject);
    y = new ArrayList();
    y.add("");
    z = new ArrayList();
  ...
  public final void readFrom(JceInputStream paramJceInputStream)
  {
    ...
    this.v = ((anp)paramJceInputStream.read(B, 21, false));
