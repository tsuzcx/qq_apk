...
public class ais
{
  ...
  private boolean a(QQUser paramQQUser, boolean paramBoolean)
  {
    ...
    if (ait.a((aiv)localObject, "table_user", localContentValues, "uin=?", new String[] { String.valueOf(c(paramQQUser)) }) <= 0)
    {
  ...
  private boolean e()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 38	com/tencent/token/ais:d	Z
    //   6: ifeq +12 -> 18
    //   9: aload_0
    //   10: getfield 38	com/tencent/token/ais:d	Z
    //   13: istore_1
    //   14: aload_0
    //   15: monitorexit
    //   16: iload_1
    //   17: ireturn
    //   18: aload_0
    //   19: getfield 36	com/tencent/token/ais:a	Ljava/util/List;
    //   22: invokeinterface 165 1 0
    //   27: aload_0
    //   28: aconst_null
    //   29: putfield 40	com/tencent/token/ais:e	Lcom/tencent/token/core/bean/QQUser;
    //   32: new 6	com/tencent/token/ais$a
    //   35: dup
    //   36: aload_0
    //   37: invokespecial 71	com/tencent/token/ais$a:<init>	(Lcom/tencent/token/ais;)V
    //   40: astore_2
    //   41: aload_2
    //   42: ldc 122
    //   44: bipush 7
    ...
    //   87: aconst_null
    //   88: aconst_null
    //   89: invokestatic 180	com/tencent/token/ait:a	(Lcom/tencent/token/aiv;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   92: astore_2
    //   93: aload_2
    ...
    //   115: checkcast 6	com/tencent/token/ais$a
    //   118: astore 4
    //   120: getstatic 25	com/tencent/token/ais:c	Z
    //   123: ifne +19 -> 142
    //   126: aload 4
    //   128: ifnull +6 -> 134
    //   131: goto +11 -> 142
    ...
    //   141: athrow
    //   142: aload 4
    //   144: invokevirtual 182	com/tencent/token/ais$a:d	()Lcom/tencent/token/core/bean/QQUser;
    //   147: astore 4
    //   149: aload 4
    //   151: getfield 152	com/tencent/token/core/bean/QQUser:mIsBinded	Z
    //   154: ifeq -54 -> 100
    //   157: aload_0
    //   158: getfield 36	com/tencent/token/ais:a	Ljava/util/List;
    //   161: aload 4
    ...
    //   237: aload 5
    //   239: aload_0
    //   240: getfield 36	com/tencent/token/ais:a	Ljava/util/List;
    ...
    //   257: invokestatic 120	com/tencent/token/xj:b	(Ljava/lang/String;)V
    //   260: goto -160 -> 100
    //   263: aload_2
    ...
    //   285: checkcast 6	com/tencent/token/ais$a
    //   288: astore_3
    //   289: getstatic 25	com/tencent/token/ais:c	Z
    //   292: ifne +18 -> 310
    //   295: aload_3
    //   296: ifnull +6 -> 302
    //   299: goto +11 -> 310
    ...
    //   309: athrow
    //   310: aload_3
    //   311: invokevirtual 182	com/tencent/token/ais$a:d	()Lcom/tencent/token/core/bean/QQUser;
    //   314: astore_3
    //   315: aload_3
    //   316: getfield 152	com/tencent/token/core/bean/QQUser:mIsBinded	Z
    //   319: ifne -49 -> 270
    //   322: aload_0
    //   323: getfield 36	com/tencent/token/ais:a	Ljava/util/List;
    //   326: aload_3
    ...
    //   398: aload 4
    //   400: aload_0
    //   401: getfield 36	com/tencent/token/ais:a	Ljava/util/List;
    ...
    //   418: invokestatic 120	com/tencent/token/xj:b	(Ljava/lang/String;)V
    //   421: goto -151 -> 270
    //   424: aload_0
    //   425: iconst_1
    //   426: putfield 38	com/tencent/token/ais:d	Z
    //   429: aload_0
    //   430: monitorexit
    //   431: iconst_1
    //   432: ireturn
    ...
    //   438: invokestatic 143	com/tencent/token/xj:c	(Ljava/lang/String;)V
    //   441: aload_0
    //   442: monitorexit
    //   443: iconst_0
    //   444: ireturn
  ...
  private boolean e(QQUser paramQQUser)
  {
    ...
    try
    {
      ait.a((aiv)localObject, "table_user", "uin=?", new String[] { String.valueOf(c(paramQQUser)) });
      return true;
    }
  ...
  public final boolean a(long paramLong)
  {
    ...
    if (localQQUser == null)
    {
      xj.c("find user not exist with uin:".concat(String.valueOf(paramLong)));
      return false;
    }
    ...
    implements aiv
  {
    ...
    {
      a locala = new a(ais.this);
      locala.a = paramahi.getLong(paramahi.getColumnIndex("uin"));
      locala.c = paramahi.getString(paramahi.getColumnIndex("email"));
      locala.d = paramahi.getString(paramahi.getColumnIndex("nick_name"));
      locala.e = paramahi.getString(paramahi.getColumnIndex("uin_mask"));
      locala.g = paramahi.getBlob(paramahi.getColumnIndex("head_image"));
      locala.h = paramahi.getLong(paramahi.getColumnIndex("head_image_update_time"));
      long l1 = paramahi.getLong(paramahi.getColumnIndex("flag"));
      int n = 0;
      boolean bool;
      if ((1L & l1) != 0L) {
        bool = true;
      ...
      paramahi = locala.g;
      if ((paramahi != null) && (paramahi.length >= 64) && (paramahi[0] == xd.a[0]) && (paramahi[1] == xd.a[1]) && (paramahi[2] == xd.a[2]) && (paramahi[3] == xd.a[3]))
      {
        byte[] arrayOfByte = new byte[60];
        System.arraycopy(paramahi, 4, arrayOfByte, 0, 60);
        while ((n < 60) && (arrayOfByte[n] == 0))
        {
          arrayOfByte[n] = 48;
          n += 1;
        }
        paramahi = new String(arrayOfByte);
      }
      try
      {
        locala.b = Long.parseLong(paramahi);
        return locala;
      }
      catch (Exception paramahi)
      {
        label416:
        break label416;
      }
    ...
    public final long b(SQLiteDatabase paramSQLiteDatabase)
    {
      if (!this.j)
      {
        ...
        System.arraycopy(xd.a, 0, this.g, 0, xd.a.length);
