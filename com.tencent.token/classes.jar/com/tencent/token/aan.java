...
public final class aan
{
  ...
  public aan(String paramString)
  {
    this.a = new ahj(paramString);
  }
      ...
      if ((localObject != null) && (i > 0))
      {
        ...
        if (!((QQUser)localObject).mIsBinded)
        {
          ...
          if (((QQUser)localObject).mUin == ((QQUser)localObject).mRealUin) {
            l1 = aad.f(((QQUser)localObject).mRealUin);
          }
        }
  ...
  public final wz a(JSONObject paramJSONObject, long paramLong, int paramInt)
  {
    wz localwz = new wz();
    long l1 = aae.a(paramInt, paramLong);
    for (;;)
    {
      int i;
      long l2;
      try
      {
        ...
        if ((m > 0) && (localObject1 != null))
        {
          ...
          if (i < ((JSONArray)localObject1).length())
          {
            ...
            xb.c("msg store to db is wrong".concat(String.valueOf(localObject2)));
            l2 = l1;
            break label532;
          }
          if (j != m)
          {
            this.d = j;
            xb.c("msg cnt is wrong");
            xb.c("msg cnt is wrong".concat(String.valueOf(paramJSONObject)));
          }
          aae.a(paramInt, paramLong, l1);
          localwz.a = 0;
          return localwz;
        }
      }
      catch (Exception paramJSONObject)
      {
        ...
        localwz.a(10021, ((StringBuilder)localObject1).toString(), null);
      }
