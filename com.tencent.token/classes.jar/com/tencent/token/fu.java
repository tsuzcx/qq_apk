  ...
  implements fk
{
  ...
  public fu(v paramv, f paramf, e parame, d paramd)
  {
    this.a = paramv;
    this.b = paramf;
    this.c = parame;
  ...
  public aa a(z paramz)
  {
    ...
    if (!fm.b(paramz)) {
      return new fp(str, 0L, k.a(b(0L)));
    }
    if ("chunked".equalsIgnoreCase(paramz.a("Transfer-Encoding"))) {
      return new fp(str, -1L, k.a(a(paramz.a().a())));
    }
    long l = fm.a(paramz);
    if (l != -1L) {
      return new fp(str, l, k.a(b(l)));
    }
    return new fp(str, -1L, k.a(e()));
  }
  ...
  public z.a a(boolean paramBoolean)
  {
    ...
    {
      fs localfs = fs.a(f());
      localObject = new z.a().a(localfs.a).a(localfs.b).a(localfs.c).a(c());
      if ((paramBoolean) && (localfs.b == 100)) {
        return null;
      }
      if (localfs.b == 100)
      {
  ...
  {
    String str = fq.a(paramx, this.b.c().a().b().type());
    a(paramx.c(), str);
  }
  ...
  private abstract class a
    implements q
  {
    protected final h a = new h(fu.this.c.a());
    protected boolean b;
    protected long c = 0L;
    ...
    public long a(okio.c paramc, long paramLong)
    {
      try
      {
        paramLong = fu.this.c.a(paramc, paramLong);
        if (paramLong > 0L) {
          this.c += paramLong;
        }
        return paramLong;
    ...
    protected final void a(boolean paramBoolean, IOException paramIOException)
    {
      ...
      do
      {
        return;
        if (fu.this.e != 5) {
          throw new IllegalStateException("state: " + fu.this.e);
        }
        fu.this.a(this.a);
        fu.this.e = 6;
      } while (fu.this.b == null);
      f localf = fu.this.b;
      if (!paramBoolean) {}
      for (paramBoolean = true;; paramBoolean = false)
      {
        localf.a(paramBoolean, fu.this, this.c, paramIOException);
        return;
      }
    }
  }
  ...
  private final class b
    implements okio.p
  {
    private final h b = new h(fu.this.d.a());
    private boolean c;
    ...
    public void a_(okio.c paramc, long paramLong)
    {
      ...
      fu.this.d.k(paramLong);
      fu.this.d.b("\r\n");
      fu.this.d.a_(paramc, paramLong);
      fu.this.d.b("\r\n");
    }
    ...
    public void close()
    {
      ...
      //   1: monitorenter
      //   2: aload_0
      //   3: getfield 42	com/tencent/token/fu$b:c	Z
      //   6: istore_1
      //   7: iload_1
      //   8: ifeq +6 -> 14
      //   11: aload_0
      ...
      //   14: aload_0
      //   15: iconst_1
      //   16: putfield 42	com/tencent/token/fu$b:c	Z
      //   19: aload_0
      //   20: getfield 18	com/tencent/token/fu$b:a	Lcom/tencent/token/fu;
      //   23: getfield 27	com/tencent/token/fu:d	Lokio/d;
      //   26: ldc 63
      //   28: invokeinterface 58 2 0
      //   33: pop
      //   34: aload_0
      //   35: getfield 18	com/tencent/token/fu$b:a	Lcom/tencent/token/fu;
      //   38: aload_0
      //   39: getfield 37	com/tencent/token/fu$b:b	Lokio/h;
      //   42: invokevirtual 66	com/tencent/token/fu:a	(Lokio/h;)V
      //   45: aload_0
      //   46: getfield 18	com/tencent/token/fu$b:a	Lcom/tencent/token/fu;
      //   49: iconst_3
      //   50: putfield 70	com/tencent/token/fu:e	I
      //   53: goto -42 -> 11
      //   56: astore_2
      //   57: aload_0
      //   58: monitorexit
    ...
    public void flush()
    {
      ...
      //   13: return
      //   14: aload_0
      //   15: getfield 18	com/tencent/token/fu$b:a	Lcom/tencent/token/fu;
      //   18: getfield 27	com/tencent/token/fu:d	Lokio/d;
    ...
    extends fu.a
  {
    ...
    private void b()
    {
      ...
      {
        this.h = false;
        fm.a(fu.this.a.g(), this.f, fu.this.c());
        a(true, null);
      }
    }
    ...
    public void close()
    {
      ...
      if ((this.h) && (!fb.a(this, 100, TimeUnit.MILLISECONDS))) {
        a(false, null);
      }
      this.b = true;
    }
    ...
    extends fu.a
  {
    ...
    public void close()
    {
      ...
      if ((this.f != 0L) && (!fb.a(this, 100, TimeUnit.MILLISECONDS))) {
        a(false, null);
      }
      this.b = true;
    }
