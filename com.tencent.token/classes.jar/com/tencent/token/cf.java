  ...
  implements LayoutInflater.Factory2
{
  ...
  private final CopyOnWriteArrayList<eg<ce.a, Boolean>> J = new CopyOnWriteArrayList();
  ArrayList<g> b;
  boolean c;
  int d = 0;
  ...
  private int a(ArrayList<by> paramArrayList, ArrayList<Boolean> paramArrayList1, int paramInt1, int paramInt2, dz<Fragment> paramdz)
  {
    int i1 = paramInt2 - 1;
    int i3;
    for (int i2 = paramInt2; i1 >= paramInt1; i2 = i3)
    {
      by localby = (by)paramArrayList.get(i1);
      boolean bool = ((Boolean)paramArrayList1.get(i1)).booleanValue();
      i3 = 0;
      int i4;
      for (;;)
      {
        int i5 = localby.b.size();
        i4 = 1;
        if (i3 >= i5) {
          break;
        }
        if (by.b((by.a)localby.b.get(i3)))
        {
          i3 = 1;
          break label101;
        }
      ...
      i3 = 0;
      label101:
      if ((i3 == 0) || (localby.a(paramArrayList, i1 + 1, paramInt2))) {
        i4 = 0;
      }
      i3 = i2;
      if (i4 != 0)
    ...
    try
    {
      ...
      if (paramInt < i2)
      {
        if (a)
        {
          ...
          localStringBuilder.append(paramby);
        }
        this.i.set(paramInt, paramby);
      }
      else
      {
        while (i1 < paramInt)
  ...
  private void a(Fragment paramFragment, Context paramContext, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject instanceof cf)) {
        ((cf)localObject).a(paramFragment, paramContext, true);
      }
    }
    paramFragment = this.J.iterator();
    while (paramFragment.hasNext())
    {
      paramContext = (eg)paramFragment.next();
      if (paramBoolean) {
  ...
  private void a(Fragment paramFragment, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).a(paramFragment, paramBundle, true);
      }
    }
    paramFragment = this.J.iterator();
    while (paramFragment.hasNext())
    {
      paramBundle = (eg)paramFragment.next();
      if (paramBoolean) {
  ...
  private void a(Fragment paramFragment, View paramView, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).a(paramFragment, paramView, paramBundle, true);
      }
    }
    paramFragment = this.J.iterator();
    while (paramFragment.hasNext())
    {
      paramView = (eg)paramFragment.next();
      if (paramBoolean) {
  ...
  public static void a(cg paramcg)
  {
    ...
    if (paramcg != null)
    {
      paramcg = paramcg.iterator();
      while (paramcg.hasNext()) {
        a((cg)paramcg.next());
      }
    }
  }
  
  private static void a(dz<Fragment> paramdz)
  {
    int i2 = paramdz.size();
    int i1 = 0;
    while (i1 < i2)
    {
      Fragment localFragment = (Fragment)paramdz.a[i1];
      if (!localFragment.l)
      {
  ...
  private void a(RuntimeException paramRuntimeException)
  {
    ...
    PrintWriter localPrintWriter = new PrintWriter(new ec("FragmentManager"));
    cd localcd = this.m;
    if (localcd != null) {}
    try
    {
      localcd.a("  ", localPrintWriter, new String[0]);
    }
  ...
  private void a(ArrayList<by> paramArrayList, ArrayList<Boolean> paramArrayList1)
  {
  ...
  private void a(ArrayList<by> paramArrayList, ArrayList<Boolean> paramArrayList1, int paramInt1, int paramInt2)
  {
    int i1 = paramInt1;
    boolean bool = ((by)paramArrayList.get(i1)).t;
    ...
    while (i3 < paramInt2)
    {
      by localby = (by)paramArrayList.get(i3);
      if (!((Boolean)paramArrayList1.get(i3)).booleanValue()) {
        localObject = localby.a(this.z, (Fragment)localObject);
      } else {
        localObject = localby.b(this.z, (Fragment)localObject);
      }
      if ((i2 == 0) && (!localby.i)) {
        i2 = 0;
      } else {
    ...
    this.z.clear();
    if (!bool) {
      ci.a(this, paramArrayList, paramArrayList1, paramInt1, paramInt2, false);
    }
    ...
    if (bool)
    {
      localObject = new dz();
      b((dz)localObject);
      i4 = a(paramArrayList, paramArrayList1, paramInt1, paramInt2, (dz)localObject);
      a((dz)localObject);
    }
    else
    {
    ...
    if (i4 != i1)
    {
      ...
      if (bool)
      {
        ci.a(this, paramArrayList, paramArrayList1, paramInt1, i4, true);
        a(this.l, true);
        i3 = i1;
      }
    }
    while (i3 < paramInt2)
    {
      localObject = (by)paramArrayList.get(i3);
      if ((((Boolean)paramArrayList1.get(i3)).booleanValue()) && (((by)localObject).m >= 0))
      {
        paramInt1 = ((by)localObject).m;
        try
        {
  ...
  private void b(Fragment paramFragment, Context paramContext, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).b(paramFragment, paramContext, true);
      }
    }
    paramFragment = this.J.iterator();
    while (paramFragment.hasNext())
  ...
  private void b(Fragment paramFragment, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).b(paramFragment, paramBundle, true);
      }
    }
    paramBundle = this.J.iterator();
    while (paramBundle.hasNext())
    {
      localObject = (eg)paramBundle.next();
      if ((!paramBoolean) || (((Boolean)((eg)localObject).b).booleanValue())) {
        ((ce.a)((eg)localObject).a).a(paramFragment);
      }
    }
  }
  ...
  private void b(Fragment paramFragment, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).b(paramFragment, true);
      }
    }
    localObject = this.J.iterator();
    while (((Iterator)localObject).hasNext())
    {
      eg localeg = (eg)((Iterator)localObject).next();
      if ((!paramBoolean) || (((Boolean)localeg.b).booleanValue())) {
        ((ce.a)localeg.a).b(paramFragment);
      }
    }
  }
  
  private void b(dz<Fragment> paramdz)
  {
    int i1 = this.l;
    if (i1 <= 0) {
      return;
    ...
    while (i1 < i3)
    {
      ...
      {
        a(localFragment, i2, localFragment.w(), localFragment.x(), false);
        if ((localFragment.J != null) && (!localFragment.B) && (localFragment.P)) {
          paramdz.add(localFragment);
        }
      }
      i1 += 1;
    }
  ...
  private void b(ArrayList<by> paramArrayList, ArrayList<Boolean> paramArrayList1)
  {
    if (paramArrayList != null)
    {
  ...
  private static void b(ArrayList<by> paramArrayList, ArrayList<Boolean> paramArrayList1, int paramInt1, int paramInt2)
  {
    while (paramInt1 < paramInt2)
    {
      by localby = (by)paramArrayList.get(paramInt1);
  ...
  private void c(Fragment paramFragment, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).c(paramFragment, paramBundle, true);
      }
    }
    paramFragment = this.J.iterator();
    while (paramFragment.hasNext())
  ...
  private void c(Fragment paramFragment, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).c(paramFragment, true);
      }
    }
    localObject = this.J.iterator();
    while (((Iterator)localObject).hasNext())
    {
      eg localeg = (eg)((Iterator)localObject).next();
      if ((!paramBoolean) || (((Boolean)localeg.b).booleanValue())) {
        ((ce.a)localeg.a).c(paramFragment);
      }
    }
  }
  
  private boolean c(ArrayList<by> paramArrayList, ArrayList<Boolean> paramArrayList1)
  {
    try
    {
  ...
  private void d(Fragment paramFragment, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).d(paramFragment, paramBundle, true);
      }
    }
    paramFragment = this.J.iterator();
    while (paramFragment.hasNext())
  ...
  private void d(Fragment paramFragment, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).d(paramFragment, true);
      }
    }
    paramFragment = this.J.iterator();
    while (paramFragment.hasNext())
    {
      localObject = (eg)paramFragment.next();
      if (paramBoolean) {
        ((Boolean)((eg)localObject).b).booleanValue();
      }
    }
  }
  ...
  private void e(Fragment paramFragment, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).e(paramFragment, true);
      }
    }
    paramFragment = this.J.iterator();
    while (paramFragment.hasNext())
  ...
  private void f(Fragment paramFragment, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).f(paramFragment, true);
      }
    }
    paramFragment = this.J.iterator();
    while (paramFragment.hasNext())
  ...
  private void g(Fragment paramFragment, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).g(paramFragment, true);
      }
    }
    paramFragment = this.J.iterator();
    while (paramFragment.hasNext())
  ...
  private void h(Fragment paramFragment, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((Fragment)localObject).s;
      if ((localObject instanceof cf)) {
        ((cf)localObject).h(paramFragment, true);
      }
    }
    paramFragment = this.J.iterator();
    while (paramFragment.hasNext())
  ...
  private void j(final Fragment paramFragment)
  {
    ...
    {
      c localc = a(paramFragment, paramFragment.x(), paramFragment.B ^ true, paramFragment.y());
      ...
      else
      {
        ...
        int i1;
        if ((paramFragment.B) && (!paramFragment.F())) {
          i1 = 8;
        } else {
          i1 = 0;
        }
  ...
  private boolean r()
  {
    ...
    if (localObject1 != null)
    {
      ...
      if ((localObject1 != null) && (((ce)localObject1).c())) {
        return true;
      }
    }
    localObject1 = this.x;
  ...
  private void w()
  {
    ...
    while (i2 < i1)
    {
      ...
      if (localObject != null) {
        if (((Fragment)localObject).B() != null)
        {
          int i3 = ((Fragment)localObject).D();
        ...
        else if (((Fragment)localObject).C() != null)
        {
          ((Fragment)localObject).C().end();
        }
      }
      i2 += 1;
    }
  ...
  private void z()
  {
    ...
    this.D = new cg(localObject6, (List)localObject5, localObject4);
  }
  
  public final int a(by paramby)
  {
    try
    {
      StringBuilder localStringBuilder;
  ...
  public final void a(Parcelable paramParcelable, cg arg2)
  {
    ...
    while (i1 < localFragmentManagerState.a.length)
    {
      ...
      if (localObject4 != null)
      {
        if ((localObject1 != null) && (i1 < ((List)localObject1).size())) {
          localObject2 = (cg)((List)localObject1).get(i1);
        } else {
          localObject2 = null;
        }
        if ((paramParcelable != null) && (i1 < paramParcelable.size())) {
          localObject3 = (bl)paramParcelable.get(i1);
        } else {
          localObject3 = null;
        }
        localObject2 = ((FragmentState)localObject4).a(this.m, this.n, this.o, (cg)localObject2, (bl)localObject3);
        if (a)
        {
    ...
    if (localFragmentManagerState.c != null)
    {
      ...
      while (i1 < localFragmentManagerState.c.length)
      {
        ...
        if (a)
        {
          ...
          ???.append("): ");
          ???.append(paramParcelable);
          ??? = new PrintWriter(new ec("FragmentManager"));
  ...
  final void a(Fragment paramFragment)
  {
    ...
    a(paramFragment, i1, paramFragment.x(), paramFragment.y(), false);
    if (paramFragment.J != null)
    {
      ...
      if ((paramFragment.P) && (paramFragment.I != null))
      {
        ...
        localObject = a(paramFragment, paramFragment.x(), true, paramFragment.y());
        if (localObject != null)
        {
  ...
  final void a(final Fragment paramFragment, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    if (paramFragment.m)
    {
      ...
      if (paramInt1 > paramFragment.b) {
        if ((paramFragment.b == 0) && (paramFragment.d())) {
          i1 = 1;
        } else {
          i1 = paramFragment.b;
        }
    ...
    if (paramFragment.b <= paramInt1)
    {
      ...
      if ((paramFragment.B() != null) || (paramFragment.C() != null))
      {
      ...
      case 0: 
        ...
        if (paramInt1 > 0)
        {
          ...
          localObject1 = this.m;
          paramFragment.t = ((cd)localObject1);
          localObject2 = this.o;
          paramFragment.x = ((Fragment)localObject2);
          if (localObject2 != null) {
            localObject1 = ((Fragment)localObject2).u;
          } else {
            localObject1 = ((cd)localObject1).f;
          }
          paramFragment.s = ((cf)localObject1);
          if (paramFragment.i != null) {
          ...
          else
          {
            ...
            throw new ct(((StringBuilder)localObject1).toString());
          }
        }
      case 1: 
        ...
        {
          paramFragment.f();
          paramFragment.J = paramFragment.q();
          if (paramFragment.J != null)
          {
    ...
    if (paramFragment.b > paramInt1)
    {
      ...
      case 5: 
        if (paramInt1 < 5)
        {
          ...
          paramFragment.U.a(av.a.ON_PAUSE);
      ...
      case 4: 
        if (paramInt1 < 4)
        {
          ...
          paramFragment.U.a(av.a.ON_STOP);
          if (paramFragment.u != null) {
            paramFragment.u.o();
          }
          paramFragment.b = 3;
                  ...
                  ((Animation)localObject4).setAnimationListener(new b(a((Animation)localObject4), (ViewGroup)localObject3)
                  {
                    public final void onAnimationEnd(Animation paramAnonymousAnimation)
                    {
                      ...
                      this.a.post(new Runnable()
                      {
                        public final void run()
                        {
                          if (cf.2.this.b.B() != null)
                          {
                            cf.2.this.b.a(null);
                            cf.this.a(cf.2.this.b, cf.2.this.b.D(), 0, 0, false);
                          }
                        }
                      });
                    }
                ...
                else
                {
                  ...
                  ((Animator)localObject4).addListener(new AnimatorListenerAdapter()
                  {
                    public final void onAnimationEnd(Animator paramAnonymousAnimator)
                    {
                      ...
                      paramAnonymousAnimator = paramFragment.C();
                      paramFragment.a(null);
                      if ((paramAnonymousAnimator != null) && (this.a.indexOfChild(this.b) < 0))
                      {
                        paramAnonymousAnimator = cf.this;
                        Fragment localFragment = paramFragment;
                        paramAnonymousAnimator.a(localFragment, localFragment.D(), 0, 0, false);
                      }
                    }
                  });
      ...
      if (paramInt1 <= 0)
      {
        ...
        if ((paramFragment.B() == null) && (paramFragment.C() == null))
        {
          ...
          if (!paramFragment.E)
          {
            paramFragment.U.a(av.a.ON_DESTROY);
            if (paramFragment.u != null) {
              paramFragment.u.p();
            }
            paramFragment.b = 0;
  ...
  public final void a(cd paramcd, cb paramcb, Fragment paramFragment)
  {
    if (this.m == null)
    {
      this.m = paramcd;
  ...
  public final void a(ce.a parama)
  {
    this.J.add(new eg(parama, Boolean.TRUE));
  }
  ...
  public final void a(String paramString, FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString)
  {
      ...
      if (i3 > 0)
      {
        ...
        while (i1 < i3)
        {
          ...
          if (localObject2 != null)
          {
            ...
            if (((Fragment)localObject2).w() != 0)
            {
              paramPrintWriter.print((String)localObject1);
              paramPrintWriter.print("mNextAnim=");
              paramPrintWriter.println(((Fragment)localObject2).w());
            }
            if (((Fragment)localObject2).I != null)
            {
              paramPrintWriter.print((String)localObject1);
            ...
            if (((Fragment)localObject2).B() != null)
            {
              paramPrintWriter.print((String)localObject1);
              paramPrintWriter.print("mAnimatingAway=");
              paramPrintWriter.println(((Fragment)localObject2).B());
              paramPrintWriter.print((String)localObject1);
            ...
            if (((Fragment)localObject2).u != null)
            {
              ...
              ((StringBuilder)localObject3).append((String)localObject1);
              ((StringBuilder)localObject3).append("  ");
              ((cf)localObject2).a(((StringBuilder)localObject3).toString(), paramFileDescriptor, paramPrintWriter, paramArrayOfString);
            }
          }
          i1 += 1;
        }
    ...
    if (paramFileDescriptor != null)
    {
      ...
      if (i3 > 0)
      {
        ...
        while (i1 < i3)
        {
          paramFileDescriptor = (by)this.g.get(i1);
          paramPrintWriter.print(paramString);
          paramPrintWriter.print("  #");
          paramPrintWriter.print(i1);
          paramPrintWriter.print(": ");
    ...
    try
    {
      if (this.i != null)
      {
        ...
        if (i3 > 0)
        {
          ...
          while (i1 < i3)
          {
            paramFileDescriptor = (by)this.i.get(i1);
            paramPrintWriter.print(paramString);
            paramPrintWriter.print("  #");
            paramPrintWriter.print(i1);
            paramPrintWriter.print(": ");
      ...
      if (localObject4 != null)
      {
        ...
        if (i2 > 0)
        {
          ...
          for (;;)
          {
            ...
            localObject3[i1] = new BackStackState((by)this.g.get(i1));
            if (a)
            {
  ...
  public final String toString()
  {
    ...
    if (localFragment != null) {
      eb.a(localFragment, localStringBuilder);
    } else {
      eb.a(this.m, localStringBuilder);
    }
    localStringBuilder.append("}}");
    ...
    extends cf.b
  {
    ...
    {
      if ((!fa.s(this.a)) && (Build.VERSION.SDK_INT < 24)) {
        ...
        this.a.post(new Runnable()
        {
          public final void run()
          {
            cf.a.this.a.setLayerType(0, null);
          }
        });
      }
  ...
  {
    public abstract boolean a(ArrayList<by> paramArrayList, ArrayList<Boolean> paramArrayList1);
  }
    ...
    implements Fragment.c
  {
    ...
    h(by paramby, boolean paramBoolean)
    {
      this.a = paramBoolean;
      this.b = paramby;
    }
    ...
    public final void c()
    {
      ...
      cf localcf = this.b.a;
      int k = localcf.e.size();
      while (j < k)
      {
        Fragment localFragment = (Fragment)localcf.e.get(j);
        localFragment.a(null);
        if ((i != 0) && (localFragment.E())) {
          localFragment.p();
        }
        j += 1;
      }
      cf.a(this.b.a, this.b, this.a, i ^ 0x1, true);
    }
    
    public final void d()
    {
      cf.a(this.b.a, this.b, this.a, false, false);
    }
  }
}
