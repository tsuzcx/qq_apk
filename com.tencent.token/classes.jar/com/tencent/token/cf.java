    ...
    if (!this.e)
    {
      ...
      new AsyncTask()
      {
        public String a(String... paramAnonymousVarArgs)
        {
          try
          {
            paramAnonymousVarArgs = (Integer)cf.a(cf.this).get(Integer.valueOf(11));
            if (paramAnonymousVarArgs == null) {
              return null;
            }
            int i = cf.this.a(paramAnonymousVarArgs.intValue());
            Thread.sleep(600L);
            cf.b(cf.this).stop(i);
            cf.a(cf.this, false);
            return null;
      ...
      new AsyncTask()
      {
        ...
        public String a(String... paramAnonymousVarArgs)
        {
          try
          {
            ...
            {
              paramAnonymousVarArgs = (Integer)cf.a(cf.this).get(Integer.valueOf(paramArrayOfInt[i] + 1));
              if (paramAnonymousVarArgs == null)
              {
              ...
              int j = cf.this.a(paramAnonymousVarArgs.intValue());
              Thread.sleep(600L);
              cf.b(cf.this).stop(j);
              i += 1;
            }
        ...
        {
          if ((cf.c(cf.this) != null) && (1 == this.c))
          {
            paramAnonymousString = new Message();
            paramAnonymousString.what = 200;
            cf.c(cf.this).sendMessage(paramAnonymousString);
          }
        }
