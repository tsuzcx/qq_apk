...
public class j
{
  ...
  private boolean a(int paramInt)
  {
    ...
    h.a("save reminder: " + this.g + "-" + this.i + "-" + this.h);
    return true;
  }
  ...
  private void h()
  {
    ...
    i();
    h.a("remind his info:[remind_version]" + this.g + "[remind_lasttime]" + this.i + "[remind_times]" + this.h + "[signature]" + this.l);
  }
  ...
  private void i()
  {
    try
    {
      ...
      if (localContext != null) {
        this.l = dg.a(com.tencent.token.utils.encrypt.c.b(localContext.getPackageManager().getPackageInfo(localContext.getPackageName(), 64).signatures[0].toByteArray()));
      }
      return;
    }
    catch (PackageManager.NameNotFoundException localNameNotFoundException)
    {
      h.c("NameNotFoundException:" + localNameNotFoundException.toString());
      return;
    }
    catch (Exception localException)
    {
  ...
  public boolean a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      h.a("update:[type]" + this.a + "[version]" + this.b + "[name]" + this.c + "[url]" + this.d + "[market_url]" + this.e + "[feature]" + this.f);
      return true;
    }
    catch (JSONException paramJSONObject)
    {
      g();
      h.c("parseUpdate info json error: " + paramJSONObject.getMessage());
    }
    return false;
  }
 ...
 * Qualified Name:     com.tencent.token.core.bean.j
