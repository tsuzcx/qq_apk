  ...
  extends e
{
  ...
  public static void a(ev paramev, long paramLong, String paramString, int paramInt)
  {
    ...
    paramev.c.put("param.smscode", paramString);
  ...
  protected String a()
  {
    ...
    cw.a = i;
    this.f = i;
    String str2 = w.a(new Object[] { "seq_id", Integer.valueOf(this.f), "op_time", Long.valueOf(cx.c().s() / 1000L), "uin", Long.valueOf(this.e), "mobile_code", this.d, "verify_type_id", Integer.valueOf(this.g) });
    if (str2 == null)
    {
  ...
  protected void a(ev paramev)
  {
    ...
    this.d = ((String)paramev.c.get("param.smscode"));
