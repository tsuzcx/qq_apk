  ...
  extends d
{
  ...
  public static void a(do paramdo, long paramLong, String paramString, int paramInt)
  {
    ...
    paramdo.c.put("param.qqtoken", paramString);
  ...
  protected String a()
  {
    ...
    cb.a = i;
    this.f = i;
    Object localObject = l.a(new Object[] { "seq_id", Integer.valueOf(this.f), "op_time", Long.valueOf(cc.c().s() / 1000L), "uin", Long.valueOf(this.e), "qqtoken_code", this.d, "verify_type_id", Integer.valueOf(this.g) });
    if (localObject == null)
    {
  ...
  protected void a(do paramdo)
  {
    ...
    this.d = ((String)paramdo.c.get("param.qqtoken"));
