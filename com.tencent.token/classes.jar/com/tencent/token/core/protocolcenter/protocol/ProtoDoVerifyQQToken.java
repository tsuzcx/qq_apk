  ...
  extends d
{
  ...
  public static void a(dp paramdp, long paramLong, String paramString, int paramInt)
  {
    ...
    paramdp.c.put("param.qqtoken", paramString);
  ...
  protected String a()
  {
    ...
    cc.a = i;
    this.f = i;
    Object localObject = l.a(new Object[] { "seq_id", Integer.valueOf(this.f), "op_time", Long.valueOf(cd.c().s() / 1000L), "uin", Long.valueOf(this.e), "qqtoken_code", this.d, "verify_type_id", Integer.valueOf(this.g) });
    if (localObject == null)
    {
    ...
    ((StringBuilder)localObject).append("/cn/mbtoken3/mbtoken3_verify_qqtoken_v2");
  ...
  protected void a(dp paramdp)
  {
    ...
    this.d = ((String)paramdp.c.get("param.qqtoken"));
 ...
 * Qualified Name:     com.tencent.token.core.protocolcenter.protocol.ProtoDoVerifyQQToken
