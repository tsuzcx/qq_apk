  ...
  extends d
{
  ...
  protected String a()
  {
    ...
    cb.a = i;
    this.f = i;
    String str2 = l.a(new Object[] { "seq_id", Integer.valueOf(this.f), "op_time", Long.valueOf(cc.c().s() / 1000L), "uin", Long.valueOf(this.e), "qqtoken_code", this.d, "verify_type_id", Integer.valueOf(this.g) });
    if (str2 == null)
    {
