  ...
  extends d
{
  ...
  protected String a()
  {
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      ((StringBuilder)localObject3).append("/cn/mbtoken3/mbtoken3_qry_super_code_info");
      ((StringBuilder)localObject3).append((String)localObject1);
      localObject1 = ((StringBuilder)localObject3).toString();
      localObject3 = new StringBuilder();
      ((StringBuilder)localObject3).append(this);
      ((StringBuilder)localObject3).append("ProtoQuerySuperCodeInfo url ");
      ((StringBuilder)localObject3).append((String)localObject1);
    ...
    localObject1 = new StringBuilder();
    ((StringBuilder)localObject1).append(this);
    ((StringBuilder)localObject1).append("ProtoQuerySuperCodeInfo url data is null ");
    g.c(((StringBuilder)localObject1).toString());
    return null;
  }
