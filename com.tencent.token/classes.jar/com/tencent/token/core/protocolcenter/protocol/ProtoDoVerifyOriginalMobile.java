  ...
  extends d
{
  ...
  public static void a(dn paramdn, long paramLong, String paramString, int paramInt)
  {
    ...
    paramdn.c.put("param.mbmobile.mobile", paramString);
  ...
  protected String a()
  {
    ...
    ca.a = i;
    this.f = i;
    String str2 = l.a(new Object[] { "seq_id", Integer.valueOf(this.f), "op_time", Long.valueOf(cb.c().s() / 1000L), "uin", Long.valueOf(this.e), "mobile", this.d, "verify_type_id", Integer.valueOf(this.g) });
    if (str2 == null)
    {
  ...
  protected void a(dn paramdn)
  {
    ...
    this.d = ((String)paramdn.c.get("param.mbmobile.mobile"));
