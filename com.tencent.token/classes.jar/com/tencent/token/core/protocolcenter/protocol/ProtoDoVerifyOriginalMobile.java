  ...
  extends d
{
  ...
  public static void a(dp paramdp, long paramLong, String paramString, int paramInt)
  {
    ...
    paramdp.c.put("param.mbmobile.mobile", paramString);
  ...
  protected String a()
  {
    ...
    cc.a = i;
    this.f = i;
    Object localObject = l.a(new Object[] { "seq_id", Integer.valueOf(this.f), "op_time", Long.valueOf(cd.c().s() / 1000L), "uin", Long.valueOf(this.e), "mobile", this.d, "verify_type_id", Integer.valueOf(this.g) });
    if (localObject == null)
    {
  ...
  protected void a(dp paramdp)
  {
    ...
    this.d = ((String)paramdp.c.get("param.mbmobile.mobile"));
