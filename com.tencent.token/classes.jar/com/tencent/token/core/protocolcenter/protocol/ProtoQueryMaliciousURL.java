  ...
  extends e
{
  ...
  {
    paramev.c.put("param.barcode.url", paramString);
  }
  ...
  protected String a()
  {
    ...
    cw.a = i;
    this.c = i;
    String str2 = w.a(new Object[] { "url", URLEncoder.encode(this.d), "seq_id", Integer.valueOf(this.c), "op_time", Long.valueOf(cx.c().s() / 1000L) });
  ...
  {
    this.d = ((String)paramev.c.get("param.barcode.url"));
  }
