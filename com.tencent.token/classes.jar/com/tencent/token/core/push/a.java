  ...
  extends ContextWrapper
{
  ...
  public Notification.Builder a(String paramString1, String paramString2, PendingIntent paramPendingIntent)
  {
    if (Build.VERSION.SDK_INT >= 26) {
      return new Notification.Builder(RqdApplication.n(), "channel_qqsafe").setDefaults(1).setContentTitle(paramString1).setContentText(paramString2).setContentIntent(paramPendingIntent).setSmallIcon(2131099913).setAutoCancel(true);
    }
    return null;
  }
  ...
  {
    return new NotificationCompat.Builder(RqdApplication.n()).setDefaults(1).setContentTitle(paramString1).setContentText(paramString2).setContentIntent(paramPendingIntent).setSmallIcon(2131099913).setAutoCancel(true);
  }
}
