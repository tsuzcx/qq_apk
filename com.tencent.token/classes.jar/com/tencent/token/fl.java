  ...
  implements View.OnTouchListener
{
  ...
  public final fl a(boolean paramBoolean)
  {
  ...
  static final class a
  {
    ...
    final float a(long paramLong)
    {
      ...
      {
        float f1 = this.j;
        return 1.0F - f1 + f1 * fl.a((float)(paramLong - l) / this.k, 0.0F, 1.0F);
      }
      return fl.a((float)(paramLong - this.e) / this.a, 0.0F, 1.0F) * 0.5F;
    }
    
    public final void a()
    {
      long l = AnimationUtils.currentAnimationTimeMillis();
      this.k = fl.a((int)(l - this.e), this.b);
      this.j = a(l);
      this.i = l;
    }
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      {
        localObject = fl.this;
        ((fl)localObject).c = false;
        localObject = ((fl)localObject).a;
        ((fl.a)localObject).e = AnimationUtils.currentAnimationTimeMillis();
        ((fl.a)localObject).i = -1L;
        ((fl.a)localObject).f = ((fl.a)localObject).e;
        ((fl.a)localObject).j = 0.5F;
        ((fl.a)localObject).g = 0;
        ((fl.a)localObject).h = 0;
      }
      Object localObject = fl.this.a;
      int i;
      if ((((fl.a)localObject).i > 0L) && (AnimationUtils.currentAnimationTimeMillis() > ((fl.a)localObject).i + ((fl.a)localObject).k)) {
        i = 1;
      } else {
        i = 0;
      }
      if ((i == 0) && (fl.this.a()))
      {
        ...
        if (fl.this.d)
        {
          ...
          localfl.b.onTouchEvent(localMotionEvent);
          localMotionEvent.recycle();
        }
        if (((fl.a)localObject).f != 0L)
        {
          l1 = AnimationUtils.currentAnimationTimeMillis();
          float f = ((fl.a)localObject).a(l1);
          long l2 = ((fl.a)localObject).f;
          ((fl.a)localObject).f = l1;
          f = (float)(l1 - l2) * (-4.0F * f * f + f * 4.0F);
          ((fl.a)localObject).g = ((int)(((fl.a)localObject).c * f));
          ((fl.a)localObject).h = ((int)(f * ((fl.a)localObject).d));
          i = ((fl.a)localObject).h;
          fl.this.a(i);
          ex.a(fl.this.b, this);
          return;
        }
