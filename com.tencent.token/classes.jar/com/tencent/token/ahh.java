...
public final class ahh
{
  ...
  public static int a(ahj paramahj, String paramString)
  {
    for (;;)
    {
      try
      {
        c(paramahj);
        paramahj = a().a(paramString, new String[] { "count(*)" }, null, null, null, null);
        if (paramahj.getCount() > 0)
        {
          paramahj.moveToFirst();
          i = paramahj.getInt(0);
          paramahj.close();
          xa.c("test database, tablecount=".concat(String.valueOf(i)));
          return i;
        }
      }
      catch (Throwable paramahj)
      {
        paramString = new StringBuilder("status_kk");
        paramString.append(paramahj.toString());
        paramString.append(paramahj.getMessage());
        xa.c(paramString.toString());
        return 0;
      }
      catch (Exception paramahj)
      {
        paramString = new StringBuilder("status_kk");
        paramString.append(paramahj.toString());
        paramString.append(paramahj.getMessage());
  ...
  public static int a(ahj paramahj, String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString)
  {
    try
    {
      c(paramahj);
    ...
    catch (Throwable paramahj)
    {
      ...
      paramString1.append(paramahj.toString());
      paramString1.append(paramahj.getMessage());
      xa.c(paramString1.toString());
    }
    catch (Exception paramahj)
    {
      paramString1 = new StringBuilder("status_kk");
  ...
  public static int a(ahj paramahj, String paramString1, String paramString2, String[] paramArrayOfString)
  {
    try
    {
      c(paramahj);
      int i = a().a(paramString1, paramString2, paramArrayOfString);
      xa.c("test database, del=".concat(String.valueOf(i)));
      return i;
    }
    catch (Throwable paramahj)
    {
  ...
  public static long a(ahj paramahj)
  {
    try
    {
      c(paramahj);
    ...
    catch (Throwable paramahj)
    {
      ...
      localStringBuilder.append(paramahj.toString());
      localStringBuilder.append(paramahj.getMessage());
  ...
  public static ahj a(ahj paramahj, String paramString, String[] paramArrayOfString)
  {
    paramahj = a(paramahj, paramString, paramArrayOfString, null, null, null, null);
    if (paramahj.size() > 0) {
      return (ahj)paramahj.get(0);
    }
    return null;
  }
  ...
  {
    // Byte code:
    //   0: getstatic 119	com/tencent/token/ahh:a	Lcom/tencent/token/ahe;
    //   3: ifnonnull +1549 -> 1552
    //   6: getstatic 121	com/tencent/token/ahh:b	Landroid/content/Context;
    //   9: ifnonnull +9 -> 18
    //   12: invokestatic 127	com/tencent/token/global/RqdApplication:n	()Landroid/content/Context;
    //   15: putstatic 121	com/tencent/token/ahh:b	Landroid/content/Context;
    //   18: getstatic 121	com/tencent/token/ahh:b	Landroid/content/Context;
    //   21: ldc 129
    ...
    //   81: getstatic 121	com/tencent/token/ahh:b	Landroid/content/Context;
    //   84: ldc 165
    ...
    //   94: ifne +1378 -> 1472
    //   97: getstatic 121	com/tencent/token/ahh:b	Landroid/content/Context;
    //   100: ldc 167
    ...
    //   120: iconst_1
    //   121: new 172	com/tencent/token/ahc
    //   124: dup
    //   125: invokespecial 173	com/tencent/token/ahc:<init>	()V
    //   128: invokestatic 176	com/tencent/wcdb/database/SQLiteDatabase:a	(Ljava/lang/String;ILcom/tencent/token/afx;)Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   131: astore 4
    //   133: aload_3
    //   134: getstatic 178	com/tencent/token/ahh:c	Ljava/lang/String;
    //   137: invokevirtual 182	java/lang/String:getBytes	()[B
    //   140: aload 8
    //   142: new 172	com/tencent/token/ahc
    //   145: dup
    //   146: invokespecial 173	com/tencent/token/ahc:<init>	()V
    //   149: invokestatic 185	com/tencent/wcdb/database/SQLiteDatabase:a	(Ljava/io/File;[BLcom/tencent/wcdb/database/SQLiteCipherSpec;Lcom/tencent/token/afx;)Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   152: astore_3
    //   153: aload_3
    //   154: astore 5
    //   156: aload 4
    ...
    //   216: aconst_null
    //   217: aconst_null
    //   218: invokevirtual 199	com/tencent/wcdb/database/SQLiteDatabase:a	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Lcom/tencent/token/afw;
    //   221: astore 10
    //   223: aload 10
    ...
    //   349: aconst_null
    //   350: aconst_null
    //   351: invokevirtual 199	com/tencent/wcdb/database/SQLiteDatabase:a	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Lcom/tencent/token/afw;
    //   354: astore 11
    //   356: aload 11
    ...
    //   451: aconst_null
    //   452: aconst_null
    //   453: invokevirtual 199	com/tencent/wcdb/database/SQLiteDatabase:a	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Lcom/tencent/token/afw;
    //   456: astore 12
    //   458: aload 12
    //   460: ifnull +810 -> 1270
    //   463: aload_3
    ...
    //   759: invokevirtual 261	com/tencent/wcdb/database/SQLiteDatabase:a	(Ljava/lang/String;)Lcom/tencent/token/ago;
    //   762: astore 13
    //   764: aload_3
    //   765: astore 5
    //   767: aload 4
    ...
    //   890: iload_2
    //   891: aload 15
    //   893: invokevirtual 276	com/tencent/token/agk:a	(ILjava/lang/Object;)V
    //   896: goto +800 -> 1696
    //   899: aload_3
    //   900: astore 5
    //   902: aload 4
    ...
    //   979: iadd
    //   980: aconst_null
    //   981: invokevirtual 276	com/tencent/token/agk:a	(ILjava/lang/Object;)V
    //   984: goto +712 -> 1696
    //   987: aload_3
    //   988: astore 5
    //   990: aload 4
    ...
    //   1027: iload_2
    //   1028: aload 15
    //   1030: invokevirtual 276	com/tencent/token/agk:a	(ILjava/lang/Object;)V
    //   1033: goto +663 -> 1696
    //   1036: aload_3
    //   1037: astore 5
    //   1039: aload 4
    ...
    //   1116: iadd
    //   1117: aconst_null
    //   1118: invokevirtual 276	com/tencent/token/agk:a	(ILjava/lang/Object;)V
    //   1121: goto +575 -> 1696
    //   1124: aload_3
    //   1125: astore 5
    //   1127: aload 4
    ...
    //   1147: invokevirtual 276	com/tencent/token/agk:a	(ILjava/lang/Object;)V
    //   1150: goto +546 -> 1696
    //   1153: aload_3
    //   1154: astore 5
    //   1156: aload 4
    ...
    //   1176: invokevirtual 276	com/tencent/token/agk:a	(ILjava/lang/Object;)V
    //   1179: goto +517 -> 1696
    //   1182: aload_3
    //   1183: astore 5
    //   1185: aload 4
    ...
    //   1193: iadd
    //   1194: aconst_null
    //   1195: invokevirtual 276	com/tencent/token/agk:a	(ILjava/lang/Object;)V
    //   1198: goto +498 -> 1696
    //   1201: aload_3
    //   1202: astore 5
    //   1204: aload 4
    //   1206: astore 6
    //   1208: aload 13
    //   1210: invokevirtual 309	com/tencent/token/ago:f	()J
    //   1213: pop2
    //   1214: aload_3
    //   1215: astore 5
    //   1217: aload 4
    ...
    //   1421: invokestatic 67	com/tencent/token/xa:c	(Ljava/lang/String;)V
    //   1424: aload 4
    //   1426: ifnull +8 -> 1434
    //   1429: aload 4
    ...
    //   1470: aload_3
    //   1471: athrow
    //   1472: getstatic 121	com/tencent/token/ahh:b	Landroid/content/Context;
    //   1475: ldc 167
    //   1477: invokevirtual 135	android/content/Context:getDatabasePath	(Ljava/lang/String;)Ljava/io/File;
    //   1480: pop
    //   1481: new 318	com/tencent/token/ahe
    //   1484: dup
    //   1485: getstatic 121	com/tencent/token/ahh:b	Landroid/content/Context;
    //   1488: getstatic 178	com/tencent/token/ahh:c	Ljava/lang/String;
    //   1491: invokestatic 322	com/tencent/token/ww:a	()I
    //   1494: aload 8
    //   1496: invokespecial 325	com/tencent/token/ahe:<init>	(Landroid/content/Context;Ljava/lang/String;ILcom/tencent/wcdb/database/SQLiteCipherSpec;)V
    //   1499: putstatic 119	com/tencent/token/ahh:a	Lcom/tencent/token/ahe;
    //   1502: goto +50 -> 1552
    //   1505: astore_3
    //   1506: aload_3
    //   1507: invokevirtual 88	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   1510: invokestatic 67	com/tencent/token/xa:c	(Ljava/lang/String;)V
    ...
    //   1549: invokestatic 67	com/tencent/token/xa:c	(Ljava/lang/String;)V
    //   1552: getstatic 119	com/tencent/token/ahh:a	Lcom/tencent/token/ahe;
    //   1555: invokevirtual 326	com/tencent/token/ahe:a	()Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   1558: astore_3
    //   1559: aload_3
    //   1560: areturn
    //   1561: astore_3
    ...
    //   1598: invokestatic 67	com/tencent/token/xa:c	(Ljava/lang/String;)V
    //   1601: aconst_null
    //   1602: areturn
    //   1603: astore_3
    //   1604: aload_3
    //   1605: invokevirtual 88	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   1608: invokestatic 67	com/tencent/token/xa:c	(Ljava/lang/String;)V
    ...
    //   1647: invokestatic 67	com/tencent/token/xa:c	(Ljava/lang/String;)V
    //   1650: aconst_null
    //   1651: areturn
    //   1652: iconst_0
    //   1653: istore_0
    ...
    //   221	1074	10	localafw1	afw
    //   354	924	11	localafw2	afw
    //   456	805	12	localafw3	afw
  ...
  public static List<ahj> a(ahj paramahj, String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3, String paramString4)
  {
    ...
    try
    {
      ...
      if (paramString1.getCount() > 0)
      {
        ...
        do
        {
          localArrayList.add(paramahj.a(paramString1));
  ...
  public static long b(ahj paramahj)
  {
    try
    {
      c(paramahj);
      long l = a().b(paramahj.a(), paramahj.b());
      return l;
    }
    catch (Throwable paramahj)
    {
  ...
  public static long b(ahj paramahj, String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3, String paramString4)
  {
    for (;;)
    {
      try
      {
        c(paramahj);
        paramahj = a().a(paramString1, paramArrayOfString1, paramString2, paramArrayOfString2, paramString3, paramString4);
        if (paramahj.getCount() > 0)
        {
          paramahj.moveToLast();
          l = paramahj.getLong(0);
          paramahj.close();
          xa.c("test database, time=".concat(String.valueOf(l)));
          return l;
        }
      }
      catch (Throwable paramahj)
  ...
  private static void c(ahj paramahj)
  {
    try
    {
      paramahj.a(a());
