...
public final class lq
{
  ...
  public static void a(byte[] paramArrayOfByte)
  {
    ...
    {
      b localb = new b();
      localb.a(new lj(paramArrayOfByte));
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          mx localmx = new mx();
          localmw.a.add(localmx);
        }
        paramArrayOfByte.add(localmw);
      }
      paramArrayOfByte = localb.b;
      no.a();
      if ((paramArrayOfByte == null) || (!"".equals(paramArrayOfByte))) {
        np.a("detectTaskCode", paramArrayOfByte);
      }
      return;
    }
      ...
      for (;;)
      {
        try
        {
          ...
          if (a != null)
          {
            ...
            bool2 = bool3;
            li.c("UserActionWrapper", paramMap.toString());
          }
          return bool3;
        }
