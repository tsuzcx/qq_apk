...
public final class ex
{
  ...
  public static fe a(View paramView, fe paramfe)
  {
    return a.a(paramView, paramfe);
  }
  ...
  public static void a(View paramView, ei paramei)
  {
    j.a(paramView, paramei);
  }
  
  public static void a(View paramView, eu parameu)
  {
    a.a(paramView, parameu);
  }
  ...
  public static fe b(View paramView, fe paramfe)
  {
    return a.b(paramView, paramfe);
  }
  ...
  public static fa f(View paramView)
  {
    j localj = a;
    if (localj.a == null) {
      localj.a = new WeakHashMap();
    }
    fa localfa2 = (fa)localj.a.get(paramView);
    fa localfa1 = localfa2;
    if (localfa2 == null)
    {
      localfa1 = new fa(paramView);
      localj.a.put(paramView, localfa1);
    }
    return localfa1;
  }
    ...
    extends ex.e
  {
    ...
    public final fe a(View paramView, fe paramfe)
    {
      paramfe = (WindowInsets)fe.a(paramfe);
      WindowInsets localWindowInsets = paramView.onApplyWindowInsets(paramfe);
      paramView = paramfe;
      if (localWindowInsets != paramfe) {
        paramView = new WindowInsets(localWindowInsets);
      }
      return fe.a(paramView);
    }
    ...
    public final void a(View paramView, final eu parameu)
    {
      if (parameu == null)
      {
      ...
      paramView.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener()
      {
        ...
        {
          paramAnonymousWindowInsets = fe.a(paramAnonymousWindowInsets);
          return (WindowInsets)fe.a(parameu.a(paramAnonymousView, paramAnonymousWindowInsets));
        }
      });
    }
    ...
    public final fe b(View paramView, fe paramfe)
    {
      paramfe = (WindowInsets)fe.a(paramfe);
      WindowInsets localWindowInsets = paramView.dispatchApplyWindowInsets(paramfe);
      paramView = paramfe;
      if (localWindowInsets != paramfe) {
        paramView = new WindowInsets(localWindowInsets);
      }
  ...
  static class j
  {
    ...
    public static void a(View paramView, ei paramei)
    {
      ...
      paramView.setAccessibilityDelegate(paramei);
    }
    ...
    public fe a(View paramView, fe paramfe)
    {
      return paramfe;
    }
    ...
    {
      if ((paramView instanceof ew)) {
        ((ew)paramView).setSupportBackgroundTintList(paramColorStateList);
      }
    }
    ...
    {
      if ((paramView instanceof ew)) {
        ((ew)paramView).setSupportBackgroundTintMode(paramMode);
      }
    }
    ...
    public fe b(View paramView, fe paramfe)
    {
      return paramfe;
    }
    ...
    {
      if ((paramView instanceof ew)) {
        return ((ew)paramView).getSupportBackgroundTintList();
      }
      return null;
    }
    ...
    {
      if ((paramView instanceof ew)) {
        return ((ew)paramView).getSupportBackgroundTintMode();
      }
      return null;
    }
