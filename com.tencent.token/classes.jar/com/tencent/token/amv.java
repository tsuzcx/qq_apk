...
{
  static final anw a = anw.a("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
  ...
  static
  {
    ...
    for (;;)
    {
      ...
      localObject[i] = alr.a("%8s", new Object[] { Integer.toBinaryString(i) }).replace(' ', '0');
      i += 1;
    }
  ...
  {
    throw new IllegalArgumentException(alr.a(paramString, paramVarArgs));
  }
  ...
  static String a(boolean paramBoolean, int paramInt1, int paramInt2, byte paramByte1, byte paramByte2)
  {
    ...
    if (paramByte1 < localObject.length) {
      ...
      str1 = alr.a("0x%02x", new Object[] { Byte.valueOf(paramByte1) });
    }
    if (paramByte2 == 0)
    {
      localObject = "";
    ...
    return alr.a("%s 0x%08x %5d %-13s %s", new Object[] { str2, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), str1, localObject });
  }
  
  static IOException b(String paramString, Object... paramVarArgs)
  {
    throw new IOException(alr.a(paramString, paramVarArgs));
  }
}
