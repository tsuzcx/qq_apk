  ...
  implements jh
{
  ...
  public jx(Toolbar paramToolbar, boolean paramBoolean)
  {
    this(paramToolbar, paramBoolean, hg.h.abc_action_bar_up_description);
  }
  
  private jx(Toolbar paramToolbar, boolean paramBoolean, int paramInt)
  {
    this.a = paramToolbar;
    ...
    paramToolbar = jw.a(paramToolbar.getContext(), null, hg.j.ActionBar, hg.a.actionBarStyle, 0);
    this.q = paramToolbar.a(hg.j.ActionBar_homeAsUpIndicator);
    int i1;
    if (paramBoolean)
    {
      Object localObject1 = paramToolbar.c(hg.j.ActionBar_title);
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
        this.k = true;
        b((CharSequence)localObject1);
      }
      localObject1 = paramToolbar.c(hg.j.ActionBar_subtitle);
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
      ...
      localObject1 = paramToolbar.a(hg.j.ActionBar_logo);
      if (localObject1 != null) {
        b((Drawable)localObject1);
      }
      localObject1 = paramToolbar.a(hg.j.ActionBar_icon);
      if (localObject1 != null) {
      ...
      c(paramToolbar.a(hg.j.ActionBar_displayOptions, 0));
      i1 = paramToolbar.g(hg.j.ActionBar_customNavigationLayout, 0);
      Object localObject2;
      if (i1 != 0)
      {
      ...
      i1 = paramToolbar.f(hg.j.ActionBar_height, 0);
      if (i1 > 0)
      {
      ...
      int i2 = paramToolbar.d(hg.j.ActionBar_contentInsetStart, -1);
      i1 = paramToolbar.d(hg.j.ActionBar_contentInsetEnd, -1);
      if ((i2 >= 0) || (i1 >= 0))
      {
        localObject1 = this.a;
        i2 = Math.max(i2, 0);
      ...
      i1 = paramToolbar.g(hg.j.ActionBar_titleTextStyle, 0);
      if (i1 != 0)
      {
        localObject1 = this.a;
      ...
      i1 = paramToolbar.g(hg.j.ActionBar_subtitleTextStyle, 0);
      if (i1 != 0)
      {
        localObject1 = this.a;
        localObject2 = ((Toolbar)localObject1).getContext();
      ...
      i1 = paramToolbar.g(hg.j.ActionBar_popupTheme, 0);
      if (i1 != 0) {
    ...
    {
      final hw a = new hw(jx.this.a.getContext(), jx.this.b);
      
      public final void onClick(View paramAnonymousView)
      {
        if ((jx.this.c != null) && (jx.this.d)) {
          jx.this.c.onMenuItemSelected(0, this.a);
        }
      }
    });
  }
  ...
  public final fr a(final int paramInt, long paramLong)
  {
    fr localfr = fo.f(this.a);
    float f1;
    if (paramInt == 0) {
      f1 = 1.0F;
    } else {
    ...
    localfr.a(f1).a(paramLong).a(new ft()
    {
      private boolean c = false;
      
      public final void a(View paramAnonymousView)
      {
        jx.this.a.setVisibility(0);
      }
      
      public final void b(View paramAnonymousView)
      {
        if (!this.c) {
          jx.this.a.setVisibility(paramInt);
        }
      }
 ...
 * Qualified Name:     com.tencent.token.jx
