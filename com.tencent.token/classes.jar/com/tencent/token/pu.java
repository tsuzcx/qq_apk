...
final class pu
{
  ...
  private PhoneStateListener d = new pv(this);
  ...
  public static List<pt.a> a(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      localLinkedList.add(new pt.a(paramContext, localObject2, String.valueOf(j), String.valueOf(i), (String)localObject3, "gsm", "", "", ""));
      label218:
      ...
      if ((localObject4 != null) && (((List)localObject4).size() > 0))
      {
        ...
        while (((Iterator)localObject4).hasNext())
        {
          ...
          if (((NeighboringCellInfo)localObject5).getCid() != -1)
          {
            ...
            localLinkedList.add(new pt.a(paramContext, localObject2, "", ((StringBuilder)localObject6).toString(), "", "gsm", "", "", ""));
          }
        }
      }
      return localLinkedList;
