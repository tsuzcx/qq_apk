...
{
  private static final String p = "auv";
  public aus a;
  ...
  public auv(View paramView)
  {
    ...
    this.b.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
    {
      public final void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        if (auv.a(auv.this))
        {
          auv.b(auv.this).cancel();
          auv.this.d(1.0F);
          return;
        }
        auv.this.d(((Float)paramAnonymousValueAnimator.getAnimatedValue()).floatValue());
      }
    });
  }
  ...
  private void a(boolean paramBoolean)
  {
    if (this.v == null)
    {
      this.e.add(new b()
      {
        public final void a(aus paramAnonymousaus)
        {
          auv.this.c();
        }
      });
  ...
  private void f()
  {
    aus localaus = this.a;
    if (localaus != null) {
      this.v = new apc(this, ape.a.a(localaus), this.a.e, this.a);
    }
  }
  ...
  private aoh g()
  {
    ...
    aoh localaoh = this.f;
    if ((localaoh != null) && (!localaoh.a(h()))) {
      this.f = null;
    }
    if (this.f == null) {
      this.f = new aoh(getCallback(), this.g, this.h, this.a.b);
    }
    return this.f;
  }
  ...
  public final boolean a(aus paramaus)
  {
    if (this.a == paramaus) {
      return false;
    }
    ...
    while (localIterator.hasNext())
    {
      ((b)localIterator.next()).a(paramaus);
  ...
  public final void c(float paramFloat)
  {
    ...
    ((ava)localObject).a(bool);
    localObject = this.a;
    if (localObject != null) {
      this.b.setDuration(((float)((aus)localObject).a() / Math.abs(paramFloat)));
    }
  }
  ...
  public final void e()
  {
    ...
    float f1 = this.d;
    setBounds(0, 0, (int)(localaus.g.width() * f1), (int)(this.a.g.height() * f1));
  }
  ...
  public int getIntrinsicHeight()
  {
    ...
    return (int)(localaus.g.height() * this.d);
  }
  ...
  public int getIntrinsicWidth()
  {
    ...
    return (int)(localaus.g.width() * this.d);
  }
  ...
  {
    public abstract void a(aus paramaus);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.token\classes.jar
 * Qualified Name:     com.tencent.token.auv
