  ...
  extends BaseAdapter
{
  ...
  public yf(LoginMsgActivity paramLoginMsgActivity)
  {
  ...
  public final void a()
  {
    ...
    xb.a("query login msg=".concat(String.valueOf(i1)));
    notifyDataSetChanged();
    this.k.checkTimeZoneFlag();
  }
  
  public final void a(aan paramaan, OnlineDeviceResult paramOnlineDeviceResult)
  {
    this.m = paramaan;
  ...
  public final View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject1 != null) && (((OnlineDeviceResult)localObject1).mDevicesList != null) && (i1 > paramInt))
    {
      ...
      ((Button)localObject4).setOnClickListener(new View.OnClickListener()
      {
        ...
        {
          paramAnonymousView = sb.a();
          Object localObject = this.a.a;
          String str1 = this.a.d;
          int i = this.a.e;
          int j = this.a.f;
          String str2 = this.a.g;
          String str3 = aad.a(rz.a(RqdApplication.n()).a.GetGuid());
          yf.a(yf.this);
          String str4 = LoginMsgActivity.mSkey;
          Handler localHandler = yf.a(yf.this).mHandler;
          ...
          if (localQQUser == null)
          {
            ...
            paramAnonymousView.arg1 = ((wz)localObject).a;
          ...
          else
          {
            ...
            qz.a().a(l, (String)localObject, str1, i, str2, str3, "com.tencent.token", str4, new sb.31(paramAnonymousView, l, i, j, str2, (String)localObject, localHandler));
          }
    ...
    if (localObject2 != null)
    {
      ...
      else
      {
        ...
        if ((localSafeMsgItem != null) && (!aad.a(localSafeMsgItem.mTime * 1000L, ((SafeMsgItem)localObject2).mTime * 1000L)))
        {
          localRelativeLayout.setVisibility(0);
      ...
      localTextView5.setText(aad.d(((SafeMsgItem)localObject2).mTime * 1000L));
      paramViewGroup = aad.b(((SafeMsgItem)localObject2).mTime * 1000L);
    ...
    implements View.OnClickListener
  {
    ...
    {
      paramView = new Intent(yf.a(yf.this), OpMsgDisplayActivity.class);
      ...
      yf.a(yf.this).startActivity(paramView);
    ...
    implements View.OnTouchListener
  {
    ...
    public final boolean onTouch(View paramView, MotionEvent paramMotionEvent)
    {
      ...
      int i = yf.a(yf.this).getResources().getColor(2130968665);
      ...
      case 3: 
        if ((this.b) && (!this.c))
        {
          ...
          localTextView1.setTextAppearance(yf.a(yf.this), 2131558768);
          localTextView2.setTextAppearance(yf.a(yf.this), 2131558767);
        }
        else
        {
          localRelativeLayout.setBackgroundResource(2131099949);
          localTextView1.setTextAppearance(yf.a(yf.this), 2131558772);
          localTextView2.setTextAppearance(yf.a(yf.this), 2131558771);
        }
        localTextView3.setTextAppearance(yf.a(yf.this), 2131558783);
        break;
      }
      localTextView1.setTextColor(i);
      localTextView2.setTextColor(i);
 ...
 * Qualified Name:     com.tencent.token.yf
