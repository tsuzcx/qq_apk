  ...
  implements Handler.Callback
{
  ...
  private File e;
  private char[] f;
  private volatile aca g;
  private volatile aca h;
  private volatile aca i;
  private volatile aca j;
  private volatile boolean k = false;
  private HandlerThread l;
  private Handler m;
  
  private aaq(int paramInt, acc paramacc, aar paramaar)
  {
    super(paramInt, paramacc);
    this.a = paramaar;
    this.g = new aca();
    this.h = new aca();
    this.i = this.g;
    this.j = this.h;
    this.f = new char[paramaar.c];
    b();
    this.l = new HandlerThread(paramaar.b, paramaar.f);
    paramacc = this.l;
    if (paramacc != null) {
      paramacc.start();
    }
    ...
    this.m.postDelayed(new Runnable()
    {
      ...
      {
        aar localaar = aaq.this.a;
        if (localaar.e != null)
        {
          File[] arrayOfFile = localaar.e.listFiles(aar.a);
          if (arrayOfFile != null)
          {
            ...
            while (i < j)
            {
              ...
              long l = aar.a(localFile);
              if (System.currentTimeMillis() - l > localaar.h) {
                aas.a(localFile);
              }
              i += 1;
            }
  ...
  public aaq(aar paramaar)
  {
    this(xr.a.h, acc.a, paramaar);
  }
  ...
  public final void a(int paramInt, Thread paramThread, long paramLong, String paramString1, String paramString2)
  {
    ...
    localStringBuilder.append(acc.a(paramInt));
  ...
  public final boolean handleMessage(android.os.Message paramMessage)
  {
    ...
    //   15: aload_0
    //   16: getfield 73	com/tencent/token/aaq:l	Landroid/os/HandlerThread;
    //   19: if_acmpne +192 -> 211
    //   22: aload_0
    //   23: getfield 34	com/tencent/token/aaq:k	Z
    //   26: ifne +185 -> 211
    //   29: aload_0
    //   30: iconst_1
    //   31: putfield 34	com/tencent/token/aaq:k	Z
    //   34: aconst_null
    //   35: astore 4
    //   37: aconst_null
    //   38: astore 5
    ...
    //   43: monitorenter
    //   44: aload_0
    //   45: getfield 47	com/tencent/token/aaq:i	Lcom/tencent/token/aca;
    //   48: aload_0
    //   49: getfield 43	com/tencent/token/aaq:g	Lcom/tencent/token/aca;
    //   52: if_acmpne +22 -> 74
    //   55: aload_0
    //   56: aload_0
    //   57: getfield 45	com/tencent/token/aaq:h	Lcom/tencent/token/aca;
    //   60: putfield 47	com/tencent/token/aaq:i	Lcom/tencent/token/aca;
    //   63: aload_0
    //   64: aload_0
    //   65: getfield 43	com/tencent/token/aaq:g	Lcom/tencent/token/aca;
    //   68: putfield 49	com/tencent/token/aaq:j	Lcom/tencent/token/aca;
    //   71: goto +19 -> 90
    //   74: aload_0
    //   75: aload_0
    //   76: getfield 43	com/tencent/token/aaq:g	Lcom/tencent/token/aca;
    //   79: putfield 47	com/tencent/token/aaq:i	Lcom/tencent/token/aca;
    //   82: aload_0
    //   83: aload_0
    //   84: getfield 45	com/tencent/token/aaq:h	Lcom/tencent/token/aca;
    //   87: putfield 49	com/tencent/token/aaq:j	Lcom/tencent/token/aca;
    //   90: aload_0
    //   91: monitorexit
    //   92: aload 4
    //   94: astore_3
    ...
    //   97: astore_1
    //   98: aload_0
    //   99: invokespecial 61	com/tencent/token/aaq:b	()Ljava/io/FileOutputStream;
    //   102: astore 6
    //   104: aload 6
    //   106: ifnull +50 -> 156
    //   109: aload 4
    ...
    //   142: astore_1
    //   143: aload_0
    //   144: getfield 49	com/tencent/token/aaq:j	Lcom/tencent/token/aca;
    //   147: aload 4
    //   149: aload_0
    //   150: getfield 57	com/tencent/token/aaq:f	[C
    //   153: invokevirtual 280	com/tencent/token/aca:a	(Ljava/io/Writer;[C)V
    //   156: aload_2
    //   157: ifnull +34 -> 191
    //   160: aload_2
    //   161: astore_1
    ...
    //   174: aload_0
    //   175: getfield 49	com/tencent/token/aaq:j	Lcom/tencent/token/aca;
    //   178: invokevirtual 286	com/tencent/token/aca:a	()V
    //   181: aload_1
    //   182: athrow
    //   183: aload_1
    //   184: ifnull +7 -> 191
    ...
    //   191: aload_0
    //   192: getfield 49	com/tencent/token/aaq:j	Lcom/tencent/token/aca;
    //   195: invokevirtual 286	com/tencent/token/aca:a	()V
    //   198: aload_0
    //   199: iconst_0
    //   200: putfield 34	com/tencent/token/aaq:k	Z
    //   203: goto +8 -> 211
    //   206: astore_1
    //   207: aload_0
    //   208: monitorexit
    ...
    //   210: athrow
    //   211: aload_0
    //   212: invokespecial 93	com/tencent/token/aaq:a	()V
    //   215: iconst_1
    //   216: ireturn
    //   217: astore_2
    //   218: goto -35 -> 183
