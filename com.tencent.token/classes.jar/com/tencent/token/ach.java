...
public final class ach
{
  ...
  public static String a(String paramString)
  {
    try
    {
      localObject = aeg.a.getClassLoader();
  ...
  public static String d()
  {
    ...
    //   64: astore_2
    //   65: aload_2
    //   66: invokestatic 184	com/tencent/token/aei:a	(Ljava/lang/Object;)V
    //   69: aload_0
    ...
    //   84: astore_3
    //   85: aload_3
    //   86: invokestatic 184	com/tencent/token/aei:a	(Ljava/lang/Object;)V
    //   89: aload_2
    //   90: invokevirtual 181	java/io/BufferedReader:close	()V
    //   93: goto +8 -> 101
    //   96: astore_2
    //   97: aload_2
    //   98: invokestatic 184	com/tencent/token/aei:a	(Ljava/lang/Object;)V
    //   101: aload_0
    //   102: invokevirtual 185	java/io/FileInputStream:close	()V
    //   105: goto +8 -> 113
    //   108: astore_0
    //   109: aload_0
    //   110: invokestatic 184	com/tencent/token/aei:a	(Ljava/lang/Object;)V
    //   113: aload_1
    ...
    //   125: astore_2
    //   126: aload_2
    //   127: invokestatic 184	com/tencent/token/aei:a	(Ljava/lang/Object;)V
    //   130: aload_0
    //   131: invokevirtual 185	java/io/FileInputStream:close	()V
    //   134: goto +8 -> 142
    //   137: astore_0
    //   138: aload_0
    //   139: invokestatic 184	com/tencent/token/aei:a	(Ljava/lang/Object;)V
    //   142: aload_1
    //   143: athrow
    //   144: astore_0
    //   145: aload_0
    //   146: invokestatic 184	com/tencent/token/aei:a	(Ljava/lang/Object;)V
    //   149: ldc 102
    //   151: areturn
  ...
  public static String e()
  {
    for (;;)
    {
      try
      {
        ...
        if (bool)
        {
          localObject1 = ael.a("ro.build.version.emui");
          return localObject1;
        }
        bool = ((String)localObject1).contains("xiaomi");
        if (bool)
        {
          localObject1 = ael.a("ro.miui.ui.version.name");
          return localObject1;
        }
        bool = ((String)localObject1).contains("gionee");
        if (bool)
        {
          localObject1 = ael.a("ro.gn.extvernumber");
          bool = TextUtils.isEmpty((CharSequence)localObject1);
          if (bool) {
            localObject1 = ael.a("ro.build.display.id");
          }
          return localObject1;
        }
        ...
        if (bool)
        {
          localObject1 = ael.a("ro.vivo.os.name");
          localObject3 = ael.a("ro.vivo.os.version");
          ...
          localObject1 = ael.a("ro.vivo.os.build.display.id");
          return localObject1;
        }
        ...
        if (bool)
        {
          localObject1 = ael.a("ro.lenovo.lvp.version");
          bool = TextUtils.isEmpty((CharSequence)localObject1);
          if (bool) {
            break label288;
          }
          ...
          bool = TextUtils.isEmpty((CharSequence)localObject1);
          if (bool) {
            localObject1 = ael.a("ro.build.version.incremental");
          }
          return localObject1;
        }
        ...
        if (bool)
        {
          localObject1 = ael.a("ro.letv.eui");
          return localObject1;
        }
      }
      catch (Exception localException)
      {
        Object localObject3 = aei.a;
        aei.b(localException);
      }
      return null;
      label288:
