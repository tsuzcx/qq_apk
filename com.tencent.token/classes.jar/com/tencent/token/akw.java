...
public final class akw
{
  ...
  private akw(String paramString1, String paramString2, long paramLong, String paramString3, String paramString4, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    this.a = paramString1;
    this.b = paramString2;
    this.g = paramLong;
  ...
  @Nullable
  private static akw a(long paramLong, ald paramald, String paramString)
  {
    int i7 = paramString.length();
    int n = alr.a(paramString, 0, i7, ';');
    int i1 = alr.a(paramString, 0, n, '=');
    localObject4 = null;
    if (i1 == n) {
      return null;
    }
    String str1 = alr.c(paramString, 0, i1);
    if ((!str1.isEmpty()) && (alr.b(str1) == -1))
    {
      String str2 = alr.c(paramString, i1 + 1, n);
      if (alr.b(str2) != -1) {
        return null;
      }
      n += 1;
      ...
      {
        int i8 = alr.a(paramString, n, i7, ';');
        i1 = alr.a(paramString, n, i8, '=');
        String str3 = alr.c(paramString, n, i1);
        if (i1 < i8) {
          localObject1 = alr.c(paramString, i1 + 1, i8);
        } else {
          localObject1 = "";
        }
        ...
        try
        {
          localObject1 = new GregorianCalendar(alr.g);
        ...
        else if (str3.equalsIgnoreCase("domain"))
        {
          if (!((String)localObject1).endsWith("."))
          {
            ...
            localObject1 = alr.a((String)localObject5);
      ...
      Object localObject1 = paramald.b;
      ...
      else
      {
        if (((String)localObject1).equals(localObject4)) {
          n = 1;
        } else if ((((String)localObject1).endsWith(localObject4)) && (((String)localObject1).charAt(((String)localObject1).length() - localObject4.length() - 1) == '.') && (!alr.c((String)localObject1))) {
          n = 1;
        } else {
          n = 0;
        }
      ...
      {
        paramald = localObject3;
      }
      else
      {
        paramald = paramald.e();
        n = paramald.lastIndexOf('/');
        if (n != 0) {
          paramald = paramald.substring(0, n);
        } else {
          paramald = "/";
        }
      }
      return new akw(str1, str2, paramLong, paramString, paramald, bool4, bool5, bool2, bool3);
    }
    else
    {
      return null;
  ...
  public static List<akw> a(ald paramald, alc paramalc)
  {
    int i2 = paramalc.a.length / 2;
    int i1 = 0;
    akw localakw = null;
    ...
    while (n < i2)
    {
      ...
      if ("Set-Cookie".equalsIgnoreCase(paramalc.a(n)))
      {
        localObject2 = localObject1;
        if (localObject1 == null) {
          localObject2 = new ArrayList(2);
        }
        ((List)localObject2).add(paramalc.b(n));
      }
      n += 1;
    ...
    while (n < i2)
    {
      ...
      localakw = a(System.currentTimeMillis(), paramald, (String)localObject1);
      ...
      if (localakw != null)
      {
        ...
        ((List)localObject1).add(localakw);
      }
      n += 1;
      paramalc = (alc)localObject1;
    }
    if (paramalc != null) {
      return Collections.unmodifiableList(paramalc);
    }
  ...
  public final String toString()
  {
    ...
    if (this.l) {
      ...
      else
      {
        ...
        localStringBuilder.append(amh.a(new Date(this.g)));
      }
    }
    if (!this.m)
    {
