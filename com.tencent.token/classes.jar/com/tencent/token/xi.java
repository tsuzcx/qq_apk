  ...
  implements xh.a, xk
{
  ...
  private ArrayList<xk.a> l = new ArrayList();
  private int m;
  ...
  public xi()
  {
    ...
    this.m = i1;
    this.f = new xh(this.m + 2, TimeUnit.SECONDS, this.b, new ThreadPoolExecutor.CallerRunsPolicy());
    this.f.a = this;
    ...
    try
    {
      ...
      if (i1 != 0)
      {
        ...
        this.p.post(new Runnable()
        {
          ...
          {
            xi.a(xi.this).writeLock().lock();
            try
            {
              Iterator localIterator = xi.b(xi.this).iterator();
              while (localIterator.hasNext()) {
                localIterator.next();
              }
              xi.a(xi.this).writeLock().unlock();
              if (xi.this.f.getActiveCount() + 4 <= xi.c(xi.this)) {
                xi.a(xi.this, true);
              }
              return;
            }
  ...
  public final void a(Thread paramThread, final Runnable paramRunnable)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 73	com/tencent/token/xi:a	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   10: aload_0
    //   11: getfield 85	com/tencent/token/xi:d	Ljava/util/ArrayList;
    ...
    //   24: ifnull +64 -> 88
    //   27: aload_2
    //   28: checkcast 16	com/tencent/token/xi$a
    //   31: astore 6
    //   33: iload 4
    //   35: istore_3
    //   36: aload 6
    ...
    //   56: checkcast 16	com/tencent/token/xi$a
    //   59: astore_2
    //   60: aload_2
    //   61: ifnull -28 -> 33
    //   64: aload_2
    ...
    //   92: istore_3
    //   93: aload_0
    //   94: getfield 73	com/tencent/token/xi:a	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   107: return
    //   108: aload_2
    //   109: getfield 254	com/tencent/token/xi$a:a	Lcom/tencent/token/xk$b;
    //   112: invokestatic 163	java/lang/System:currentTimeMillis	()J
    //   115: putfield 258	com/tencent/token/xk$b:f	J
    //   118: aload_2
    //   119: getfield 254	com/tencent/token/xi$a:a	Lcom/tencent/token/xk$b;
    //   122: invokestatic 263	android/os/Debug:threadCpuTimeNanos	()J
    //   125: putfield 264	com/tencent/token/xk$b:g	J
    //   128: aload_0
    //   129: getfield 73	com/tencent/token/xi:a	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   138: aload_0
    //   139: getfield 90	com/tencent/token/xi:e	Ljava/util/HashMap;
    //   142: aload_2
    //   143: aload_1
    //   144: invokevirtual 284	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   147: pop
    //   148: aload_0
    //   149: getfield 73	com/tencent/token/xi:a	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   158: aload_2
    //   159: getfield 254	com/tencent/token/xi$a:a	Lcom/tencent/token/xk$b;
    //   162: getfield 286	com/tencent/token/xk$b:d	I
    //   165: istore 4
    //   167: iload 4
    //   169: ifgt +8 -> 177
    //   172: iconst_1
    ...
    //   195: aload_1
    //   196: aload_2
    //   197: getfield 254	com/tencent/token/xi$a:a	Lcom/tencent/token/xk$b;
    //   200: getfield 294	com/tencent/token/xk$b:c	Ljava/lang/String;
    //   203: invokevirtual 297	java/lang/Thread:setName	(Ljava/lang/String;)V
    //   206: aload_2
    //   207: getfield 254	com/tencent/token/xi$a:a	Lcom/tencent/token/xk$b;
    //   210: aload_1
    //   211: invokevirtual 300	java/lang/Thread:getId	()J
    //   214: putfield 302	com/tencent/token/xk$b:k	J
    //   217: aload_0
    //   218: getfield 94	com/tencent/token/xi:n	Z
    //   221: istore 5
    //   223: aload_0
    //   224: getfield 148	com/tencent/token/xi:p	Lcom/tencent/token/xi$b;
    //   227: new 10	com/tencent/token/xi$1
    //   230: dup
    //   231: aload_0
    //   232: iload 5
    //   234: aload_2
    //   235: invokespecial 305	com/tencent/token/xi$1:<init>	(Lcom/tencent/token/xi;ZLcom/tencent/token/xi$a;)V
    //   238: invokevirtual 271	com/tencent/token/xi$b:post	(Ljava/lang/Runnable;)Z
    //   241: pop
    //   242: aload_0
    //   243: iconst_1
    //   244: putfield 94	com/tencent/token/xi:n	Z
    //   247: return
    //   248: astore_1
    //   249: aload_0
    //   250: getfield 73	com/tencent/token/xi:a	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   261: astore_1
    //   262: aload_0
    //   263: getfield 73	com/tencent/token/xi:a	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
  ...
  public final void b(final Runnable paramRunnable, String paramString)
  {
    ...
    try
    {
      ...
      this.p.post(new Runnable()
      {
        public final void run()
        {
          xi.this.f.execute(paramRunnable);
          if ((xi.this.f.getActiveCount() >= xi.c(xi.this)) && (xi.this.f.getCorePoolSize() < 18))
          {
            xi.this.f.setCorePoolSize(xi.this.f.getCorePoolSize() + 1);
            xi.this.f.setMaximumPoolSize(xi.this.f.getCorePoolSize() + 1);
          }
          else
          {
            xi.a(xi.this, false);
          }
          Iterator localIterator = xi.this.b().iterator();
          while (localIterator.hasNext())
          {
            localIterator.next();
            xi.this.f.getActiveCount();
          }
        }
      });
      return;
    ...
    extends Handler
  {
    ...
    public final void handleMessage(Message paramMessage)
    {
      ...
      if (xi.d(xi.this))
      {
        ...
        if ((xi.c() > 0L) && (Math.abs(xi.d() - l) > xi.c()))
        {
          paramMessage = xi.this;
