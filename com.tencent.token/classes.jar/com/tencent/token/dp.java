...
public class dp
{
  ...
  private static final dp n = a(152125131763605L);
  private static dp[] o = new dp[17];
  private static dp[] p = new dp[17];
  ...
  static
  {
    ...
    while (i1 <= 16)
    {
      ...
      arrayOfInt[0] = i1;
      o[i1] = new dp(arrayOfInt, 1);
      p[i1] = new dp(arrayOfInt, -1);
      i1 += 1;
    }
    c = new dp(new int[0], 0);
    d = a(1L);
    q = a(2L);
    e = a(10L);
  ...
  private dp(int paramInt, int[] paramArrayOfInt)
  {
  ...
  dp(dq paramdq, int paramInt)
  {
    int i1;
    if ((paramdq.c > 0) || (paramdq.a.length != paramdq.b))
    {
      this.b = new int[paramdq.b];
      i1 = 0;
    }
    while (i1 < paramdq.b)
    {
      this.b[i1] = paramdq.a[(paramdq.c + i1)];
      i1 += 1;
      continue;
      this.b = paramdq.a;
    }
  ...
  private dp(int[] paramArrayOfInt, int paramInt)
  {
  ...
  public static dp a(long paramLong)
  {
    if (paramLong == 0L) {
      return c;
    }
    ...
    return new dp(paramLong);
  }
  
  private dp a(dp paramdp, int paramInt)
  {
    ...
    for (;;)
    {
      if (i1 < i2)
      {
        ...
        if (paramdp.c(i1)) {
          localObject3 = ((dp)localObject1).b((dp)localObject2).h(paramInt);
        }
        i3 = i1 + 1;
        localObject1 = localObject3;
        i1 = i3;
        if (i3 < i2)
        {
          localObject2 = ((dp)localObject2).g().h(paramInt);
          localObject1 = localObject3;
          i1 = i3;
        }
      }
  ...
  private dp b(dp paramdp1, dp paramdp2)
  {
    if (paramdp1.equals(d)) {
      return this;
    }
    if (this.a == 0) {
      return c;
    ...
    int[] arrayOfInt1 = paramdp1.b;
    int[] arrayOfInt2 = paramdp2.b;
    ...
    int i14 = -dq.d(arrayOfInt2[(i12 - 1)]);
    paramdp1 = d((int[])localObject1, localObject1.length, i12 << 5);
    paramdp2 = new dq();
    localObject1 = new dq();
    new dq(paramdp1).a(new dq(arrayOfInt2), paramdp2, (dq)localObject1);
    arrayOfInt[0] = ((dq)localObject1).d();
    if (arrayOfInt[0].length < i12)
    {
      i2 = arrayOfInt[0].length;
      paramdp2 = new int[i12];
      i1 = 0;
      while (i1 < arrayOfInt[0].length)
      {
        paramdp2[(i1 + (i12 - i2))] = arrayOfInt[0][i1];
        i1 += 1;
      }
      arrayOfInt[0] = paramdp2;
    }
    paramdp2 = a(a(arrayOfInt[0], i12, null), arrayOfInt2, i12, i14);
    localObject1 = new int[i12];
    i1 = 0;
    while (i1 < i12)
    {
      localObject1[i1] = paramdp2[i1];
      i1 += 1;
    }
    i1 = 1;
    while (i1 < i13)
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          if (i9 == i2) {
            if (i1 != 0)
            {
              paramdp1 = new int[localObject1.length];
              System.arraycopy(localObject1, 0, paramdp1, 0, localObject1.length);
              i1 = 0;
            }
          }
          for (;;)
          {
            if (i9 == 0)
            {
              paramdp2 = new int[i12 * 2];
              i1 = 0;
              while (i1 < i12)
              {
                paramdp2[(i1 + i12)] = paramdp1[i1];
                i1 += 1;
              }
              localObject2 = a(a(paramdp1, i12, (int[])localObject1, i12, paramdp2), arrayOfInt2, i12, i14);
              paramdp2 = paramdp1;
              paramdp1 = (dp)localObject2;
            }
            else
            {
              if (i1 == 0)
              {
                localObject2 = a(a(paramdp1, i12, paramdp2), arrayOfInt2, i12, i14);
                paramdp2 = paramdp1;
                paramdp1 = (dp)localObject2;
                i10 = i5;
                i7 = i3;
                ...
                i6 = i9;
                break;
                paramdp1 = a(paramdp2, arrayOfInt2, i12, i14);
                paramdp2 = new int[i12];
                i1 = 0;
                while (i1 < i12)
                {
                  paramdp2[i1] = paramdp1[i1];
                  i1 += 1;
                }
                return new dp(1, paramdp2);
              }
              i7 = i5;
              i5 = i4;
              i4 = i3;
  ...
  private dp g()
  {
    ...
    return new dp(c(a(this.b, this.b.length, null)), 1);
  }
  ...
  private dp h(int paramInt)
  {
    ...
    if (localObject[0] == 0) {}
    for (localObject = new dp(1, (int[])localObject);; localObject = new dp((int[])localObject, 1)) {
      return localObject;
    }
  }
  ...
  public dp a(int paramInt)
  {
    ...
    return new dp((int[])localObject, this.a);
  }
  
  public dp a(dp paramdp)
  {
    if (paramdp.a == 0) {
      return this;
    }
    ...
    if (paramdp.a == this.a) {
      return new dp(a(this.b, paramdp.b), this.a);
    }
    int i1 = c(this.b, paramdp.b);
    if (i1 == 0) {
      return c;
    }
    if (i1 > 0) {}
    for (paramdp = b(this.b, paramdp.b);; paramdp = b(paramdp.b, this.b)) {
      return new dp(c(paramdp), i1 * this.a);
    }
  }
  
  public dp a(dp paramdp1, dp paramdp2)
  {
    if (paramdp2.a <= 0) {
    ...
    if ((equals(c)) && (paramdp1.a >= 0)) {
      return c;
    }
    if ((equals(p[1])) && (!paramdp1.c(0)))
    {
      if (paramdp2.equals(d)) {
        return c;
      }
    ...
    if (paramdp1.a < 0)
    {
      ...
      if ((this.a >= 0) && (f(paramdp2) < 0)) {
        break label211;
      }
    }
    label211:
    for (paramdp1 = c(paramdp2);; paramdp1 = this)
    {
      if (!paramdp2.c(0)) {
        break label216;
      }
      paramdp1 = paramdp1.b(localdp1, paramdp2);
      localdp1 = paramdp1;
      if (i1 == 0) {
        break;
      }
      return paramdp1.e(paramdp2);
      i1 = 0;
      break label143;
    }
    label216:
    int i2 = paramdp2.c();
    dp localdp3 = paramdp2.b(i2);
    dp localdp4 = d.a(i2);
    if (this.a >= 0)
    {
      localdp2 = this;
    ...
    if (localdp3.equals(d)) {}
    for (dp localdp2 = c;; localdp2 = localdp2.b(localdp1, localdp3))
    {
      paramdp1 = paramdp1.a(localdp1, i2);
      localdp1 = localdp4.e(localdp3);
      dp localdp5 = localdp3.e(localdp4);
      paramdp1 = localdp2.b(localdp4).b(localdp1).a(paramdp1.b(localdp3).b(localdp5)).c(paramdp2);
      break;
    }
  }
  ...
  public dp b()
  {
    return new dp(this.b, -this.a);
  }
  
  public dp b(int paramInt)
  {
    int i2 = 1;
    if (paramInt == 0) {
      return this;
    ...
    for (;;)
    {
      ...
      return new dp((int[])localObject2, this.a);
      paramInt = 0;
    }
  }
  ...
  {
    if ((this.a == 0) || (paramdp.a == 0)) {
      return c;
    }
    return new dp(c(a(this.b, this.b.length, paramdp.b, paramdp.b.length, null)), this.a * paramdp.a);
  }
  ...
  public dp c(dp paramdp)
  {
    if (paramdp.a <= 0) {
      throw new ArithmeticException("BigInteger: modulus not positive");
    }
    dp localdp = d(paramdp);
    if (localdp.a >= 0) {
      return localdp;
    }
    return localdp.a(paramdp);
  }
  ...
  public dp d(dp paramdp)
  {
    dq localdq1 = new dq();
    dq localdq2 = new dq();
    new dq(this.b).a(new dq(paramdp.b), localdq1, localdq2);
    return new dp(localdq2, this.a);
  }
  
  public dp e(dp paramdp)
  {
    if (paramdp.a != 1) {
      throw new ArithmeticException("BigInteger: modulus not positive");
    }
    ...
    return new dp(new dq(localdp).e(new dq(paramdp)), 1);
  }
    ...
    do
    {
      do
      {
        do
        {
          return bool1;
          bool1 = bool2;
        } while (!(paramObject instanceof dp));
  ...
  public int f(dp paramdp)
  {
    if (this.a == paramdp.a) {
      return this.a * c(this.b, paramdp.b);
    }
    if (this.a > paramdp.a) {
      return 1;
    }
  ...
  public String g(int paramInt)
  {
    ...
    paramInt = 0;
    while (((dp)localObject1).a != 0)
    {
      dp localdp = t[i1];
      Object localObject2 = new dq();
      dq localdq = new dq();
      new dq(((dp)localObject1).b).a(new dq(localdp.b), (dq)localObject2, localdq);
      localObject2 = new dp((dq)localObject2, ((dp)localObject1).a * localdp.a);
      arrayOfString[paramInt] = Long.toString(new dp(localdq, ((dp)localObject1).a * localdp.a).f(), i1);
      paramInt += 1;
      localObject1 = localObject2;
    }
