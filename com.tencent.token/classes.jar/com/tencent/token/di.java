  ...
  implements de.a
{
  ...
  protected static Typeface a(Context paramContext, java.io.InputStream paramInputStream)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic 26	com/tencent/token/dj:a	(Landroid/content/Context;)Ljava/io/File;
    //   4: astore_0
    //   5: aload_0
    //   6: ifnonnull +5 -> 11
    //   9: aconst_null
    ...
    //   11: aload_0
    //   12: aload_1
    //   13: invokestatic 29	com/tencent/token/dj:a	(Ljava/io/File;Ljava/io/InputStream;)Z
    //   16: istore_2
    //   17: iload_2
    //   18: ifne +10 -> 28
    //   21: aload_0
  ...
  public Typeface a(Context paramContext, Resources paramResources, int paramInt1, java.lang.String paramString, int paramInt2)
  {
    ...
    //   12: aload_2
    //   13: iload_3
    //   14: invokestatic 66	com/tencent/token/dj:a	(Ljava/io/File;Landroid/content/res/Resources;I)Z
    //   17: istore 6
    //   19: iload 6
    //   21: ifne +10 -> 31
    //   24: aload_1
  ...
  public Typeface a(Context paramContext, cz.b paramb, Resources paramResources, int paramInt)
  {
    paramb = (cz.c)a(paramb.a, paramInt, new a() {});
    if (paramb == null) {
      return null;
    }
    return de.a(paramContext, paramResources, paramb.d, paramb.a, paramInt);
  }
  
  /* Error */
  public Typeface a(Context paramContext, dw.b[] paramArrayOfb, int paramInt)
  {
    // Byte code:
    //   0: aload_2
    //   1: arraylength
    ...
    //   15: aload_2
    //   16: iload_3
    //   17: invokevirtual 96	com/tencent/token/di:a	([Lcom/tencent/token/dw$b;I)Lcom/tencent/token/dw$b;
    //   20: astore_2
    //   21: aload_1
    //   22: invokevirtual 102	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   25: aload_2
    //   26: getfield 107	com/tencent/token/dw$b:a	Landroid/net/Uri;
    //   29: invokevirtual 113	android/content/ContentResolver:openInputStream	(Landroid/net/Uri;)Ljava/io/InputStream;
    //   32: astore_2
    //   33: aload_1
    //   34: aload_2
    //   35: invokestatic 115	com/tencent/token/di:a	(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    //   38: astore_1
    //   39: aload_2
    //   40: invokestatic 118	com/tencent/token/dj:a	(Ljava/io/Closeable;)V
    //   43: aload_1
    //   44: areturn
    //   45: astore 5
    //   47: aload_2
    ...
    //   58: astore_1
    //   59: aload_1
    //   60: invokestatic 118	com/tencent/token/dj:a	(Ljava/io/Closeable;)V
    //   63: aload_2
    //   64: athrow
    //   65: aconst_null
    //   66: astore_2
    //   67: aload_2
    //   68: invokestatic 118	com/tencent/token/dj:a	(Ljava/io/Closeable;)V
    //   71: aconst_null
    //   72: areturn
    //   73: astore_1
    //   74: goto -9 -> 65
  ...
  protected final dw.b a(dw.b[] paramArrayOfb, int paramInt)
  {
    (dw.b)a(paramArrayOfb, paramInt, new a() {});
  }
