...
public final class acf
{
  ...
  public final SparseArray<acl> d = new SparseArray();
  public a e = new a();
  
  public acf(Context paramContext)
  {
  ...
  private static boolean a(SparseArray<acl> paramSparseArray)
  {
    if (paramSparseArray.size() != 0)
    {
      ...
      {
        Object localObject = (acl)paramSparseArray.valueAt(i);
        if (localObject != null)
        {
          Object[] arrayOfObject1 = (Object[])((acl)localObject).b.clone();
          if ((arrayOfObject1 != null) && (arrayOfObject1.length != 0))
          {
            ...
            for (int k = 0;; k = m)
            {
              Object[] arrayOfObject2 = ((acl)localObject).b;
            ...
            while (j < arrayOfObject1.length)
            {
              ...
              if ((localObject != null) && (((List)localObject).size() < adk.c / 4)) {
                return false;
              }
              j += 1;
            }
  ...
  public final void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 54	com/tencent/token/acf:b	Landroid/hardware/SensorManager;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnonnull +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 32	com/tencent/token/acf:c	Ljava/util/HashSet;
    //   18: astore_1
    //   19: aload_1
    //   20: monitorenter
    //   21: aload_0
    //   22: getfield 32	com/tencent/token/acf:c	Ljava/util/HashSet;
    ...
    //   47: astore_3
    //   48: aload_0
    //   49: getfield 54	com/tencent/token/acf:b	Landroid/hardware/SensorManager;
    //   52: aload_0
    //   53: getfield 42	com/tencent/token/acf:e	Lcom/tencent/token/acf$a;
    //   56: aload_3
    ...
    //   60: goto -31 -> 29
    //   63: aload_0
    //   64: getfield 32	com/tencent/token/acf:c	Ljava/util/HashSet;
    //   67: invokevirtual 106	java/util/HashSet:clear	()V
    //   70: aload_1
    //   71: monitorexit
    //   72: aload_0
    //   73: getfield 42	com/tencent/token/acf:e	Lcom/tencent/token/acf$a;
    //   76: astore_2
    //   77: aload_2
    //   78: getfield 109	com/tencent/token/acf$a:a	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   81: astore_1
    //   82: aload_1
    //   83: monitorenter
    //   84: aload_2
    //   85: getfield 109	com/tencent/token/acf$a:a	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   98: return
    //   99: aload_2
    //   100: getfield 109	com/tencent/token/acf$a:a	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   103: iconst_0
    ...
    //   111: aload_2
    //   112: getfield 127	com/tencent/token/acf$a:b	J
    //   115: lsub
    //   116: putfield 129	com/tencent/token/acf$a:d	J
    //   119: aload_2
    //   120: getfield 129	com/tencent/token/acf$a:d	J
    //   123: lconst_0
    //   124: lcmp
    //   125: ifge +8 -> 133
    //   128: aload_2
    //   129: lconst_0
    //   130: putfield 129	com/tencent/token/acf$a:d	J
    //   133: aload_2
    //   134: lconst_0
    //   135: putfield 127	com/tencent/token/acf$a:b	J
    //   138: aload_1
    //   139: monitorexit
    //   140: aload_0
    //   141: monitorexit
  ...
  public final SparseArray<acl> b()
  {
    synchronized (this.d)
    {
      ...
      while (i < this.d.size())
      {
        localSparseArray2.append(this.d.keyAt(i), (acl)this.d.valueAt(i));
        i += 1;
      }
    ...
    implements SensorEventListener
  {
    ...
    public final void onSensorChanged(SensorEvent paramSensorEvent)
    {
      synchronized (this.a)
      {
        ...
        {
          acn localacn = new acn(paramSensorEvent, System.currentTimeMillis());
          long l = localacn.b - this.b;
          if (l < 0L) {
            return;
          }
          int j = localacn.a;
          int i = (int)(l / adk.b);
          synchronized (acf.a(acf.this))
          {
            ??? = (acl)acf.a(acf.this).get(j);
            paramSensorEvent = (SensorEvent)???;
            if (??? == null)
            {
              paramSensorEvent = new acl(j, adk.c, this.c);
              acf.a(acf.this).put(j, paramSensorEvent);
            }
