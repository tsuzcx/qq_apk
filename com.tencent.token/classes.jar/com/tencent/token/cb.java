  ...
  implements a
{
  ...
  public int a(long paramLong1, long paramLong2, int paramInt, String paramString1, String paramString2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, Handler paramHandler)
  {
    ...
    if ((paramInt == 1) || (paramInt == 3))
    {
      ...
      else
      {
        ...
        paramHandler = new do("mbtoken3_realname_reg_v2", 3, paramHandler, 3067);
      }
    }
    for (;;)
    {
      ...
      label995:
      if (paramInt == 3) {
        paramHandler = new do("mbtoken3_realname_reg_v2", 3, paramHandler, 3078);
      } else {
        paramHandler = new do("mbtoken3_realname_reg_v2", 2, paramHandler, 3067);
      }
    }
  }
  ...
  public int a(long paramLong1, long paramLong2, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, int paramInt4, Handler paramHandler)
  {
    ...
    if (paramLong2 != 0L) {
      localObject1 = cr.a().d(paramLong2);
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          {
            paramHandler = new do("mbtoken3_face_reg_v2", 2, paramHandler, 3058);
            paramHandler.m = 1;
            paramHandler.n = new ContentValues(3);
            paramHandler.n.put("aq_base_sid", ca.a().b());
          ...
          for (;;)
          {
            ...
            if (paramInt1 == 5) {
              ((JSONObject)localObject2).put("token_seq", cc.c().k());
            }
            ...
            paramLong1 = l;
            break;
            paramHandler = new do("mbtoken3_face_reg_v2", 3, paramHandler, 3058);
            break label165;
  ...
  public int a(long paramLong1, long paramLong2, String paramString, Handler paramHandler, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      a += 1;
      if (paramBoolean) {}
      for (paramHandler = new do("mbtoken3_card_check", 3, paramHandler, 3080);; paramHandler = new do("mbtoken3_card_check", 2, paramHandler, 3080))
      {
