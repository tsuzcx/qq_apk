  ...
  implements a
{
  ...
  {
    paramHandler = new do("mbtoken3_get_config_v2", 2, paramHandler, 3041);
  ...
  {
    paramHandler = new do("mbtoken3_get_dual_msg_list_v2", 2, paramHandler, 3069);
  ...
  public int a(long paramLong, int paramInt1, int paramInt2, int paramInt3, SafeMsgItem paramSafeMsgItem, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_report_location", 3, paramHandler, 3032);
  ...
  public int a(long paramLong, int paramInt1, int paramInt2, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_get_message_v2", 3, paramHandler, 3005);
  ...
  public int a(long paramLong, int paramInt, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_get_message_v2", 3, paramHandler, 3006);
    if ((localObject != null) && (!((QQUser)localObject).mIsBinded)) {
      paramHandler.c.put("param.uin.wtlogin", Long.valueOf(((QQUser)localObject).mRealUin));
    }
  ...
  public int a(long paramLong, int paramInt1, String paramString1, int paramInt2, int paramInt3, String paramString2, String paramString3, Handler paramHandler)
  {
    ...
    a += 1;
    int i = a;
    paramHandler = new do("mbtoken3_get_device_lock_status_v2", 3, paramHandler, 3054);
  ...
  public int a(long paramLong, int paramInt, String paramString1, String paramString2, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_mbop_get_mobile_code", 3, paramHandler, 3013);
  ...
  public int a(long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_set_mod_mobile", 3, paramHandler, 3012);
  ...
  public int a(long paramLong, int paramInt, boolean paramBoolean, String paramString, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_face_verify_on_off", 3, paramHandler, 4002);
    int i = a + 1;
    a = i;
  ...
  public int a(long paramLong1, long paramLong2, int paramInt1, int paramInt2, Handler paramHandler)
  {
    if (paramLong2 == 0L)
    {
      ...
      paramHandler = new do("mbtoken3_check_up_sms", 2, paramHandler, 3068);
      a += 1;
  ...
  {
    a += 1;
    paramHandler = new do("mbtoken3_unbind_token", 3, paramHandler, 4001);
  ...
  public int a(long paramLong1, long paramLong2, int paramInt1, String paramString, int paramInt2, Handler paramHandler)
  {
    if (paramLong2 == 0L)
    {
      ...
      paramHandler = new do("mbtoken3_general_verify_mobile_code", 2, paramHandler, 3066);
      a += 1;
  ...
  public int a(long paramLong1, long paramLong2, int paramInt, String paramString1, String paramString2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, Handler paramHandler)
  {
    ...
    //   19: lstore_1
    //   20: goto +105 -> 125
    //   23: invokestatic 66	com/tencent/token/cr:a	()Lcom/tencent/token/cr;
    //   26: invokevirtual 70	com/tencent/token/cr:e	()Lcom/tencent/token/core/bean/QQUser;
    //   29: astore 15
    //   31: lload_1
    //   32: lconst_0
    //   33: lcmp
    ...
    //   121: lstore_3
    //   122: goto +3 -> 125
    //   125: getstatic 25	com/tencent/token/cb:a	I
    //   128: iconst_1
    //   129: iadd
    //   130: putstatic 25	com/tencent/token/cb:a	I
    //   133: getstatic 25	com/tencent/token/cb:a	I
    //   136: istore 14
    //   138: iload 5
    //   140: iconst_1
    //   141: if_icmpne +23 -> 164
    //   144: new 39	com/tencent/token/do
    //   147: dup
    //   148: ldc 212
    //   150: iconst_3
    //   151: aload 13
    //   153: sipush 3067
    //   156: invokespecial 44	com/tencent/token/do:<init>	(Ljava/lang/String;ILandroid/os/Handler;I)V
    //   159: astore 13
    //   161: goto +46 -> 207
    //   164: iload 5
    //   166: iconst_3
    //   167: if_icmpne +23 -> 190
    //   170: new 39	com/tencent/token/do
    //   173: dup
    //   174: ldc 212
    //   176: iconst_3
    //   177: aload 13
    //   179: sipush 3078
    //   182: invokespecial 44	com/tencent/token/do:<init>	(Ljava/lang/String;ILandroid/os/Handler;I)V
    //   185: astore 13
    //   187: goto +20 -> 207
    //   190: new 39	com/tencent/token/do
    //   193: dup
    //   194: ldc 212
    //   196: iconst_2
    //   197: aload 13
    //   199: sipush 3067
    //   202: invokespecial 44	com/tencent/token/do:<init>	(Ljava/lang/String;ILandroid/os/Handler;I)V
    //   205: astore 13
    //   207: aload 13
    //   209: iconst_1
    //   210: putfield 215	com/tencent/token/do:m	I
    //   213: aload 13
    //   215: new 217	android/content/ContentValues
    //   218: dup
    //   219: iconst_3
    //   220: invokespecial 219	android/content/ContentValues:<init>	(I)V
    //   223: putfield 223	com/tencent/token/do:n	Landroid/content/ContentValues;
    //   226: aload 13
    //   228: getfield 223	com/tencent/token/do:n	Landroid/content/ContentValues;
    //   231: ldc 225
    //   233: invokestatic 230	com/tencent/token/ca:a	()Lcom/tencent/token/ca;
    //   236: invokevirtual 233	com/tencent/token/ca:b	()Ljava/lang/String;
    ...
    //   554: aload 16
    //   556: ldc_w 307
    //   559: invokestatic 312	com/tencent/token/cc:c	()Lcom/tencent/token/cc;
    //   562: invokevirtual 316	com/tencent/token/cc:k	()J
    //   565: invokevirtual 244	org/json/JSONObject:put	(Ljava/lang/String;J)Lorg/json/JSONObject;
    //   568: pop
    //   569: aload 16
    //   571: ldc_w 318
    //   574: invokestatic 324	com/tencent/token/global/RqdApplication:l	()Landroid/content/Context;
    //   577: invokestatic 329	com/tencent/token/bz:a	(Landroid/content/Context;)Lcom/tencent/token/bz;
    //   580: invokevirtual 332	com/tencent/token/bz:b	()[B
    //   583: invokestatic 333	com/tencent/token/utils/l:a	([B)Ljava/lang/String;
    ...
    //   601: aload 16
    //   603: ldc_w 337
    //   606: invokestatic 312	com/tencent/token/cc:c	()Lcom/tencent/token/cc;
    //   609: invokevirtual 340	com/tencent/token/cc:s	()J
    //   612: ldc2_w 341
    //   615: ldiv
    //   616: l2i
    ...
    //   621: aload 16
    //   623: ldc_w 344
    //   626: getstatic 350	android/os/Build:MANUFACTURER	Ljava/lang/String;
    //   629: invokevirtual 251	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   632: pop
    //   633: aload 16
    //   635: ldc_w 352
    //   638: invokestatic 324	com/tencent/token/global/RqdApplication:l	()Landroid/content/Context;
    //   641: invokestatic 355	com/tencent/token/utils/l:a	(Landroid/content/Context;)Ljava/lang/String;
    //   644: invokevirtual 251	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   647: pop
    //   648: aload 16
    //   650: ldc_w 357
    //   653: invokestatic 324	com/tencent/token/global/RqdApplication:l	()Landroid/content/Context;
    //   656: invokestatic 359	com/tencent/token/utils/l:b	(Landroid/content/Context;)Ljava/lang/String;
    //   659: invokevirtual 251	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   662: pop
    //   663: aload 16
    //   665: ldc_w 361
    //   668: invokestatic 324	com/tencent/token/global/RqdApplication:l	()Landroid/content/Context;
    //   671: invokestatic 363	com/tencent/token/utils/l:c	(Landroid/content/Context;)Ljava/lang/String;
    //   674: invokevirtual 251	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   677: pop
    //   678: aload 16
    //   680: ldc_w 365
    //   683: getstatic 368	android/os/Build:MODEL	Ljava/lang/String;
    //   686: invokevirtual 251	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   689: pop
    //   690: aload 16
    //   692: ldc_w 370
    //   695: getstatic 375	android/os/Build$VERSION:RELEASE	Ljava/lang/String;
    //   698: invokevirtual 251	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   701: pop
    //   702: aload 16
    //   704: ldc_w 377
    //   707: getstatic 381	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:f	I
    //   710: invokevirtual 258	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   713: pop
    //   714: aload 16
    //   716: ldc_w 383
    //   719: getstatic 386	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:h	I
    //   722: invokevirtual 258	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   725: pop
    //   726: aload 16
    //   728: ldc_w 388
    //   731: getstatic 391	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:g	I
    //   734: invokevirtual 258	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   737: pop
    //   738: aload 16
    //   740: ldc_w 393
    //   743: getstatic 396	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:i	I
    //   746: invokevirtual 258	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   749: pop
    //   750: aload 16
    //   752: ldc_w 398
    //   755: getstatic 401	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:j	I
    //   758: invokevirtual 258	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   761: pop
    //   762: aload 16
    //   764: ldc_w 403
    //   767: getstatic 405	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:k	I
    ...
    //   905: pop
    //   906: invokestatic 324	com/tencent/token/global/RqdApplication:l	()Landroid/content/Context;
    ...
    //   932: pop
    //   933: invokestatic 324	com/tencent/token/global/RqdApplication:l	()Landroid/content/Context;
    ...
    //   1047: aload 13
    //   1049: getfield 223	com/tencent/token/do:n	Landroid/content/ContentValues;
    //   1052: ldc_w 482
    //   1055: aload 15
    ...
    //   1078: aload 11
    //   1080: aload 12
    //   1082: invokestatic 487	com/tencent/token/core/protocolcenter/protocol/ProtoRealNameReg:a	(Lcom/tencent/token/do;JIJLjava/lang/String;Ljava/lang/String;I[B[B[B[B[B)V
    //   1085: aload_0
    //   1086: getfield 32	com/tencent/token/cb:c	Lcom/tencent/token/core/protocolcenter/e;
    //   1089: aload 13
    //   1091: invokevirtual 52	com/tencent/token/core/protocolcenter/e:a	(Lcom/tencent/token/do;)I
    //   1094: pop
    //   1095: iconst_0
    //   1096: ireturn
  ...
  public int a(long paramLong1, long paramLong2, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, int paramInt4, Handler paramHandler)
  {
    ...
    //   2: lcmp
    //   3: ifeq +15 -> 18
    //   6: invokestatic 66	com/tencent/token/cr:a	()Lcom/tencent/token/cr;
    //   9: lload_3
    //   10: invokevirtual 491	com/tencent/token/cr:d	(J)Lcom/tencent/token/core/bean/QQUser;
    //   13: astore 15
    //   15: goto +6 -> 21
    //   18: aconst_null
    //   19: astore 15
    ...
    //   25: aload 15
    //   27: ifnonnull +11 -> 38
    //   30: invokestatic 66	com/tencent/token/cr:a	()Lcom/tencent/token/cr;
    //   33: invokevirtual 70	com/tencent/token/cr:e	()Lcom/tencent/token/core/bean/QQUser;
    //   36: astore 16
    //   38: lload_1
    //   39: lconst_0
    //   40: lcmp
    ...
    //   132: lstore_3
    //   133: goto +3 -> 136
    //   136: getstatic 25	com/tencent/token/cb:a	I
    //   139: iconst_1
    //   140: iadd
    //   141: putstatic 25	com/tencent/token/cb:a	I
    //   144: getstatic 25	com/tencent/token/cb:a	I
    //   147: istore 12
    //   149: iload 8
    //   151: iconst_2
    ...
    //   165: if_icmpne +6 -> 171
    //   168: goto +24 -> 192
    //   171: new 39	com/tencent/token/do
    //   174: dup
    //   175: ldc_w 493
    //   178: iconst_3
    //   179: aload 10
    //   181: sipush 3058
    //   184: invokespecial 44	com/tencent/token/do:<init>	(Ljava/lang/String;ILandroid/os/Handler;I)V
    //   187: astore 15
    //   189: goto +21 -> 210
    //   192: new 39	com/tencent/token/do
    //   195: dup
    //   196: ldc_w 493
    //   199: iconst_2
    //   200: aload 10
    //   202: sipush 3058
    //   205: invokespecial 44	com/tencent/token/do:<init>	(Ljava/lang/String;ILandroid/os/Handler;I)V
    //   208: astore 15
    //   210: aload 15
    //   212: iconst_1
    //   213: putfield 215	com/tencent/token/do:m	I
    //   216: aload 15
    //   218: new 217	android/content/ContentValues
    //   221: dup
    //   222: iconst_3
    //   223: invokespecial 219	android/content/ContentValues:<init>	(I)V
    //   226: putfield 223	com/tencent/token/do:n	Landroid/content/ContentValues;
    //   229: aload 15
    //   231: getfield 223	com/tencent/token/do:n	Landroid/content/ContentValues;
    //   234: ldc 225
    //   236: invokestatic 230	com/tencent/token/ca:a	()Lcom/tencent/token/ca;
    //   239: invokevirtual 233	com/tencent/token/ca:b	()Ljava/lang/String;
    ...
    //   506: aload 10
    //   508: ldc_w 377
    //   511: getstatic 381	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:f	I
    //   514: invokevirtual 258	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   517: pop
    //   518: aload 10
    //   520: ldc_w 383
    //   523: getstatic 386	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:h	I
    ...
    //   553: aload 10
    //   555: ldc_w 388
    //   558: getstatic 391	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:g	I
    //   561: invokevirtual 258	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   564: pop
    //   565: aload 10
    //   567: ldc_w 393
    //   570: getstatic 396	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:i	I
    //   573: invokevirtual 258	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   576: pop
    //   577: aload 10
    //   579: ldc_w 398
    //   582: getstatic 401	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:j	I
    //   585: invokevirtual 258	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   588: pop
    //   589: aload 10
    //   591: ldc_w 403
    //   594: getstatic 405	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:k	I
    //   597: invokevirtual 258	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   600: pop
    //   601: aload 10
    //   603: ldc_w 407
    ...
    //   702: pop
    //   703: aload 16
    //   705: getstatic 375	android/os/Build$VERSION:RELEASE	Ljava/lang/String;
    ...
    //   744: aload 10
    //   746: ldc_w 337
    //   749: invokestatic 312	com/tencent/token/cc:c	()Lcom/tencent/token/cc;
    //   752: invokevirtual 340	com/tencent/token/cc:s	()J
    //   755: ldc2_w 341
    //   758: ldiv
    //   759: l2i
    ...
    //   904: aload 10
    //   906: ldc_w 307
    //   909: invokestatic 312	com/tencent/token/cc:c	()Lcom/tencent/token/cc;
    //   912: invokevirtual 316	com/tencent/token/cc:k	()J
    ...
    //   951: astore 10
    //   953: aload 15
    //   955: getfield 223	com/tencent/token/do:n	Landroid/content/ContentValues;
    //   958: ldc_w 482
    //   961: aload 10
    ...
    //   1019: pop
    //   1020: aload 17
    //   1022: getstatic 381	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:f	I
    ...
    //   1037: pop
    //   1038: aload 17
    //   1040: getstatic 386	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:h	I
    ...
    //   1176: aload 15
    //   1178: iconst_1
    //   1179: putfield 576	com/tencent/token/do:k	Z
    //   1182: aload 10
    ...
    //   1199: iload 8
    //   1201: iload 9
    //   1203: invokestatic 579	com/tencent/token/core/protocolcenter/protocol/ProtoFaceCommon:a	(Lcom/tencent/token/do;JIJI[BIII)V
    //   1206: aload_0
    //   1207: getfield 32	com/tencent/token/cb:c	Lcom/tencent/token/core/protocolcenter/e;
    //   1210: aload 15
    //   1212: invokevirtual 52	com/tencent/token/core/protocolcenter/e:a	(Lcom/tencent/token/do;)I
    //   1215: pop
    //   1216: iconst_0
    //   1217: ireturn
    //   1218: iconst_0
  ...
  public int a(long paramLong1, long paramLong2, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_feedback_abnormal_login", 3, paramHandler, 3038);
  ...
  public int a(long paramLong1, long paramLong2, String paramString, Handler paramHandler, boolean paramBoolean)
  {
    ...
    a += 1;
    if (paramBoolean) {
      paramHandler = new do("mbtoken3_card_check", 3, paramHandler, 3080);
    } else {
      paramHandler = new do("mbtoken3_card_check", 2, paramHandler, 3080);
    }
  ...
  public int a(long paramLong, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_get_ac_lock_status_v2", 3, paramHandler, 3000);
  ...
  public int a(long paramLong, Long paramLong1, int paramInt, Handler paramHandler)
  {
    if (paramLong1.longValue() == 0L)
    {
      ...
      paramHandler = new do("mbtoken3_general_get_mobile_code", 2, paramHandler, 3065);
      a += 1;
  ...
  {
    paramHandler = new do("mbtoken3_verify_qqtoken_v2", 2, paramHandler, 3027);
  ...
  public int a(long paramLong, String paramString, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_mbop_verify_mobile_code", 3, paramHandler, 3014);
  ...
  public int a(long paramLong, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, int paramInt3, String paramString4, int paramInt4, int paramInt5, String paramString5, String paramString6, Handler paramHandler)
  {
    ...
    a += 1;
    int i = a;
    paramHandler = new do("mbtoken3_device_lock_del_device_v2", 3, paramHandler, 3055);
  ...
  public int a(long paramLong, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, int paramInt3, int paramInt4, String paramString5, String paramString6, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_kickoff_v2", 3, paramHandler, 3056);
  ...
  {
    paramHandler = new do("mbtoken3_vry_ques_v2", 2, paramHandler, 3028);
  ...
  {
    paramHandler = new do("mbtoken3_vfy_wtlogin", 2, paramHandler, 3024);
  ...
  public int a(long paramLong, byte[] paramArrayOfByte, Handler paramHandler, int paramInt1, int paramInt2)
  {
    ...
    if (1 == paramInt2)
    {
      paramHandler = new do("mbtoken3_determine_verify_factors", 3, paramHandler, 4003);
      paramHandler.c.put("param.uin.wtlogin", Long.valueOf(paramLong));
      paramHandler.c.put("param.uinhash", Long.valueOf(paramLong));
    }
    else
    {
      paramHandler = new do("mbtoken3_determine_verify_factors", 2, paramHandler, 4003);
    }
  ...
  public int a(long paramLong, int[] paramArrayOfInt1, int[] paramArrayOfInt2, String paramString, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_set_service_status_v2", 3, paramHandler, 3061);
    a += 1;
  ...
  {
    do localdo = new do("mbtoken3_get_key_value_conf", 2, paramHandler, 3023);
    Object localObject2 = this.c.b(localdo);
    if ((localObject2 != null) && (((dp)localObject2).a != null)) {
      try
      {
        Object localObject1 = cs.a().h.a("key_value");
        localObject2 = new JSONObject((String)((dp)localObject2).a);
  ...
  {
    QQUser localQQUser = cr.a().e();
    paramHandler = new do("mbtoken3_log_upload", 2, paramHandler, 3063);
    paramHandler.m = 2;
    ...
    paramHandler.n.put("aq_base_sid", ca.a().b());
    paramHandler.n.put("log_date", Integer.valueOf(dx.a().j()));
  ...
  {
    paramHandler = new do("token.getstartupimg", 1, paramHandler, 3042);
  ...
  public int a(String paramString1, long paramLong, int paramInt1, int paramInt2, String paramString2, Handler paramHandler)
  {
    ...
    a += 1;
    int i = a;
    paramHandler = new do("mbtoken3_get_sms_port_v2", 2, paramHandler, 3019);
  ...
  {
    paramHandler = new do("mbtoken3_query_malicious_url", 2, paramHandler, 3053);
  ...
  {
    paramHandler = new do("mbtoken3_report_dns_v2", 2, paramHandler, 4013);
  ...
  public int b(long paramLong, int paramInt, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_del_mbitem", 3, paramHandler, 3011);
  ...
  public int b(long paramLong, int paramInt, String paramString1, String paramString2, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_general_bind", 2, paramHandler, 4004);
  ...
  public int b(long paramLong1, long paramLong2, int paramInt, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_qry_spec_verify", 3, paramHandler, 3075);
    a += 1;
  ...
  public int b(long paramLong, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_get_game_lock_status_v2", 3, paramHandler, 3002);
  ...
  {
    paramHandler = new do("mbtoken3_verify_original_mobile", 2, paramHandler, 3085);
  ...
  {
    paramHandler = new do("mbtoken3_feedback_v2", 2, paramHandler, 3022);
  ...
  {
    paramHandler = new do("mbtoken3_qry_bind_notify_msg", 2, paramHandler, 3043);
    this.c.a(paramHandler);
    return 0;
  }
  ...
  {
    a += 1;
    paramHandler = new do("mbtoken3_login_v2", 2, paramHandler, 10002);
  ...
  public int c(long paramLong, int paramInt, String paramString1, String paramString2, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_bind_token_by_app_v3", 2, paramHandler, 3026);
  ...
  public int c(long paramLong, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_get_safe_protection_v2", 3, paramHandler, 3001);
  ...
  {
    paramHandler = new do("mbtoken3_verify_mobile_code_v2", 2, paramHandler, 3029);
  ...
  public int c(long paramLong, String paramString, Handler paramHandler)
  {
    ...
    a += 1;
    paramHandler = new do("mbtoken3_get_login_prot", 3, paramHandler, 3060);
  ...
  {
    paramHandler = new do("mbtoken3_get_domain", 2, paramHandler, 3062);
    QQUser localQQUser = cr.a().e();
    long l;
    if (localQQUser != null) {
  ...
  {
    a += 1;
    paramHandler = new do("mbtoken3_bind_token_by_realname", 2, paramHandler, 3074);
  ...
  {
    paramHandler = new do("mbtoken3_verify_captcha_v3", 2, paramHandler, 3072);
  ...
  public int d(long paramLong, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_eval_account_v3", 3, paramHandler, 3004);
    if ((localObject != null) && (!((QQUser)localObject).mIsBinded)) {
      paramHandler.c.put("param.uin.wtlogin", Long.valueOf(((QQUser)localObject).mRealUin));
    }
  ...
  public int d(long paramLong, String paramString, int paramInt, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_modify_pwd", 3, paramHandler, 3052);
  ...
  {
    a += 1;
    paramHandler = new do("mbtoken3_bind_token_by_univerify", 2, paramHandler, 4015);
  ...
  public int e(long paramLong, int paramInt, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_live_video_detect", 2, paramHandler, 3082);
  ...
  public int e(long paramLong, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_get_mbinfo", 3, paramHandler, 3010);
    if ((localObject != null) && (!((QQUser)localObject).mIsBinded)) {
      paramHandler.c.put("param.uin.wtlogin", Long.valueOf(((QQUser)localObject).mRealUin));
    }
  ...
  public int e(long paramLong, String paramString, int paramInt, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_freeze_action", 3, paramHandler, 4008);
    if ((localQQUser != null) && (!localQQUser.mIsBinded)) {
      paramHandler.c.put("param.uin.wtlogin", Long.valueOf(localQQUser.mRealUin));
    }
  ...
  {
    paramHandler = new do("mbtoken3_get_mobile_code_v2", 2, paramHandler, 3031);
  ...
  {
    paramHandler = new do("mbtoken3_query_real_uin_v2", 2, paramHandler, 1006);
  ...
  {
    paramHandler = new do("mbtoken3_del_unvfy_uin", 2, paramHandler, 3036);
  ...
  public int i(long paramLong, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_feedback_mobile_using", 2, paramHandler, 3037);
  ...
  public int j(long paramLong, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_realname_status_v2", 3, paramHandler, 3064);
    a += 1;
  ...
  {
    paramHandler = new do("mbtoken3_realname_qry", 2, paramHandler, 3073);
    a += 1;
  ...
  public int l(long paramLong, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_auto_idcard_detect", 2, paramHandler, 3083);
  ...
  public int m(long paramLong, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_copy_face", 3, paramHandler, 3084);
  ...
  public int n(long paramLong, Handler paramHandler)
  {
    ...
    paramHandler = new do("mbtoken3_query_freeze_status", 3, paramHandler, 4007);
    if ((localObject != null) && (!((QQUser)localObject).mIsBinded)) {
      paramHandler.c.put("param.uin.wtlogin", Long.valueOf(((QQUser)localObject).mRealUin));
    }
