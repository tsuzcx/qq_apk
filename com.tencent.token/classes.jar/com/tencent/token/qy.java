...
public final class qy
{
  private static k a(Context paramContext, JSONObject paramJSONObject, String paramString, int paramInt)
  {
    ...
    if (localObject1 != null)
    {
      ...
      apz.b();
      Object localObject2 = (JSONObject)apu.a(paramJSONObject, str);
      if ((localObject2 != null) && (!TextUtils.isEmpty(paramString)))
      {
        ...
        if (paramJSONObject != null) {
          while (paramJSONObject.hasNext())
          {
            ...
            {
              paramJSONObject = apu.a((JSONObject)localObject2, (String)localObject1);
              break label133;
            }
          }
        }
      ...
      if (paramJSONObject == null)
      {
        ...
        apz.b();
        localObject1 = (JSONArray)apu.a((JSONObject)localObject2, "all_brand");
      }
      if (localObject1 == null)
      {
      ...
      while (k < i1)
      {
        ...
        apz.b();
        paramJSONObject = (JSONObject)apu.a((JSONArray)localObject1, k);
        if (paramJSONObject != null)
        {
          localObject2 = apu.b(paramJSONObject, "scheme");
          paramString = apu.b(paramJSONObject, "sdk");
          ...
          else
          {
            ...
            paramString = apu.b(paramJSONObject, "model");
            int j = i;
            if (!TextUtils.isEmpty(paramString))
            {
              j = i;
              if (!a(paramString, String.valueOf(xr.a), ","))
              {
                paramString = new StringBuilder("adapter id ");
                paramString.append(str);
            ...
            paramString = apu.b(paramJSONObject, "rom_version");
            int i = j;
            Object localObject3;
            if (j != 0)
            {
            ...
            paramJSONObject = (JSONObject)apu.a(paramJSONObject, "pkg");
            int m = i;
            if (i != 0)
            {
              m = i;
                  ...
                  do
                  {
                    do
                    {
                      do
                      {
                        ...
                        paramString = apu.b(paramJSONObject, "pkg_exist");
                        if ((!TextUtils.isEmpty(paramString)) && (!apy.a(paramContext, paramString)))
                        {
                        ...
                        for (;;)
                        {
                          ...
                          apz.b();
                          break;
                          paramString = apu.b(paramJSONObject, "pkg_not_exist");
                          if ((!TextUtils.isEmpty(paramString)) && (apy.a(paramContext, paramString)))
                          {
                            paramJSONObject = new StringBuilder("package:");
                            paramJSONObject.append(paramString);
                          ...
                          {
                            paramString = apu.b(paramJSONObject, "package");
                            ...
                            if (!apy.a(paramContext, paramString))
                            {
                              paramJSONObject = new StringBuilder("package:");
                              break label759;
                            }
                            localObject3 = apy.b(paramContext, paramString);
                        ...
                        paramString = apu.b(paramJSONObject, "versionName_LT");
                      ...
                      paramString = apu.b(paramJSONObject, "versionName_LE");
                      "versionNameLe:".concat(String.valueOf(paramString));
                      apz.b();
                    } while ((!TextUtils.isEmpty(paramString)) && (((String)localObject3).compareTo(paramString) > 0));
                    paramString = apu.b(paramJSONObject, "versionName_MT");
                    "versionNameMt:".concat(String.valueOf(paramString));
                    apz.b();
                  } while ((!TextUtils.isEmpty(paramString)) && (((String)localObject3).compareTo(paramString) <= 0));
                  paramJSONObject = apu.b(paramJSONObject, "versionName_ME");
      ...
      {
        paramContext = (k)apv.a(Base64.decode(paramContext, 2), new k());
        if (paramContext != null)
        {
  ...
  {
    byte[] arrayOfByte = apt.a(paramContext, "zz.dat");
    if ((arrayOfByte != null) && (arrayOfByte.length != 0))
    {
      apz.b();
      paramContext = qv.a.a().a(paramContext, arrayOfByte, true);
      if (paramContext == null)
      {
        apz.b();
        return null;
  ...
  static List<k> a(Context paramContext, String paramString)
  {
    ...
    if (!"HONOR".equalsIgnoreCase((String)localObject2))
    {
      ...
      if (!"honor".equalsIgnoreCase((String)localObject2))
      {
        ...
        while (i < k)
        {
          k localk = a(paramContext, (JSONObject)apu.a(paramString, i), (String)localObject1, j);
          if (localk != null) {
  ...
  static void a(Context paramContext, List<k> paramList)
  {
    ...
    try
    {
      ...
      while (paramList.hasNext())
      {
        ...
        Object localObject = Base64.encodeToString(qv.a.a().a(paramContext, apv.a(localk)), 2);
        apz.b();
      ...
      qu.a(paramContext).a(localHashMap, false);
      return;
    }
    catch (Throwable paramContext)
    {
  ...
  {
    private static final qy a = new qy((byte)0);
  }
}
