...
final class js
{
  ...
  public static int a(Context paramContext, int paramInt)
  {
    ...
    paramContext = jw.a(paramContext, null, arrayOfInt);
    try
    {
  ...
  public static ColorStateList b(Context paramContext, int paramInt)
  {
    ...
    paramContext = jw.a(paramContext, null, (int[])localObject1);
    try
    {
  ...
  public static int c(Context paramContext, int paramInt)
  {
    ...
    return dq.b(paramInt, Math.round(Color.alpha(paramInt) * f1));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.token\classes.jar
 * Qualified Name:     com.tencent.token.js
