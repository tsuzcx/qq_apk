...
public final class ll
{
  ...
  public static String a(String paramString)
  {
    ...
    localObject = new ll();
    ((ll)localObject).a();
    ((ll)localObject).a(new ByteArrayInputStream(paramString), paramString.length);
    paramString = new byte[8];
    a(paramString, ((ll)localObject).c, 8);
    ...
    ((ll)localObject).a(a, i);
    ((ll)localObject).a(paramString, 8);
    a(((ll)localObject).e, ((ll)localObject).b, 16);
    localObject = ((ll)localObject).e;
    paramString = "";
    i = 0;
    while (i < 16)
    {
