...
public abstract class ec<K, V>
{
    ...
    implements Iterator<T>
  {
    ...
    public final T next()
    {
      if (hasNext())
      {
        Object localObject = ec.this.a(this.c, this.a);
        this.c += 1;
        this.d = true;
        return localObject;
      }
    ...
    implements Set<Map.Entry<K, V>>
  {
    ...
    public final boolean addAll(Collection<? extends Map.Entry<K, V>> paramCollection)
    {
      ...
      while (paramCollection.hasNext())
      {
        ...
        ec.this.a(localEntry.getKey(), localEntry.getValue());
      }
      return i != ec.this.a();
    }
    ...
    public final boolean contains(Object paramObject)
    {
      ...
      int i = ec.this.a(paramObject.getKey());
      if (i < 0) {
        return false;
      }
      return dx.a(ec.this.a(i, 1), paramObject.getValue());
    }
    ...
    public final int hashCode()
    {
      ...
      while (i >= 0)
      {
        Object localObject1 = ec.this.a(i, 0);
        Object localObject2 = ec.this.a(i, 1);
        int k;
    ...
    implements Set<K>
  {
    ...
    public final boolean contains(Object paramObject)
    {
      return ec.this.a(paramObject) >= 0;
    }
    
    public final boolean containsAll(Collection<?> paramCollection)
    {
      Map localMap = ec.this.b();
      paramCollection = paramCollection.iterator();
      while (paramCollection.hasNext()) {
    ...
    public final int hashCode()
    {
      ...
      while (i >= 0)
      {
        Object localObject = ec.this.a(i, 0);
        int k;
        if (localObject == null) {
          k = 0;
        } else {
    ...
    {
      return new ec.a(ec.this, 0);
    }
    
    public final boolean remove(Object paramObject)
    {
      int i = ec.this.a(paramObject);
      if (i >= 0)
      {
        ec.this.a(i);
        return true;
    ...
    public final boolean retainAll(Collection<?> paramCollection)
    {
      return ec.a(ec.this.b(), paramCollection);
    }
    ...
    public final <T> T[] toArray(T[] paramArrayOfT)
    {
      return ec.this.a(paramArrayOfT, 0);
    }
  }
    ...
    implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V>
  {
    ...
    public final boolean equals(Object paramObject)
    {
      if (this.c)
      {
        ...
        paramObject = (Map.Entry)paramObject;
        return (dx.a(paramObject.getKey(), ec.this.a(this.b, 0))) && (dx.a(paramObject.getValue(), ec.this.a(this.b, 1)));
      }
    ...
    public final int hashCode()
    {
      if (this.c)
      {
        Object localObject1 = ec.this;
        int i = this.b;
        int j = 0;
        localObject1 = ((ec)localObject1).a(i, 0);
        Object localObject2 = ec.this.a(this.b, 1);
        if (localObject1 == null) {
          i = 0;
        } else {
    ...
    {
      if (this.c) {
        return ec.this.a(this.b, paramV);
      }
      throw new IllegalStateException("This container does not support retaining Map.Entry objects");
    }
    ...
    implements Collection<V>
  {
    ...
    public final boolean contains(Object paramObject)
    {
      return ec.this.b(paramObject) >= 0;
    }
    ...
    {
      return new ec.a(ec.this, 1);
    }
    
    public final boolean remove(Object paramObject)
    {
      int i = ec.this.b(paramObject);
      if (i >= 0)
      {
        ec.this.a(i);
        return true;
    ...
    public final boolean removeAll(Collection<?> paramCollection)
    {
      ...
      while (i < j)
      {
        int k = j;
        int m = i;
        if (paramCollection.contains(ec.this.a(i, 1)))
        {
          ec.this.a(i);
          m = i - 1;
          k = j - 1;
    ...
    public final <T> T[] toArray(T[] paramArrayOfT)
    {
      return ec.this.a(paramArrayOfT, 1);
    }
  }
}
