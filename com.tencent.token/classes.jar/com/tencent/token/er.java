...
public class er
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramet.getCount() > 0)
        {
          ...
          paramet.append("test database, tablecount=");
          paramet.append(i);
          g.c(paramet.toString());
          return i;
        }
      }
      catch (Throwable paramet)
      {
        ...
        paramString.append(paramet.toString());
        paramString.append(paramet.getMessage());
  ...
  public static int a(et paramet, String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString)
  {
    ...
    catch (Throwable paramet)
    {
      ...
      paramString1.append(paramet.toString());
      paramString1.append(paramet.getMessage());
  ...
  public static int a(et paramet, String paramString1, String paramString2, String[] paramArrayOfString)
  {
    try
    {
      ...
      paramet = new StringBuilder();
      paramet.append("test database, del=");
      paramet.append(i);
      g.c(paramet.toString());
      return i;
    }
  ...
  public static long a(et paramet, String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3, String paramString4, String paramString5, String paramString6, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      {
        a(paramet);
        paramet = a().query(paramString1, paramArrayOfString1, paramString2, paramArrayOfString2, paramString3, paramString4, paramString5, paramString6);
        if (paramet.getCount() > 0)
        {
          if (paramBoolean)
          {
          ...
          paramet.close();
          paramet = new StringBuilder();
          paramet.append("test database, time=");
          paramet.append(l);
          g.c(paramet.toString());
          return l;
        }
  ...
  {
    // Byte code:
    //   0: getstatic 115	com/tencent/token/er:a	Lcom/tencent/token/eo;
    //   3: ifnonnull +379 -> 382
    //   6: getstatic 117	com/tencent/token/er:b	Landroid/content/Context;
    //   9: ifnonnull +9 -> 18
    //   12: invokestatic 123	com/tencent/token/global/RqdApplication:l	()Landroid/content/Context;
    //   15: putstatic 117	com/tencent/token/er:b	Landroid/content/Context;
    //   18: getstatic 117	com/tencent/token/er:b	Landroid/content/Context;
    //   21: ldc 125
    ...
    //   65: astore 5
    //   67: getstatic 117	com/tencent/token/er:b	Landroid/content/Context;
    //   70: ldc 156
    ...
    //   80: ifne +221 -> 301
    //   83: getstatic 117	com/tencent/token/er:b	Landroid/content/Context;
    //   86: ldc 158
    ...
    //   103: aconst_null
    //   104: iconst_1
    //   105: new 163	com/tencent/token/em
    //   108: dup
    //   109: invokespecial 164	com/tencent/token/em:<init>	()V
    ...
    //   115: astore_1
    //   116: aload_0
    //   117: getstatic 170	com/tencent/token/er:c	Ljava/lang/String;
    //   120: invokevirtual 174	java/lang/String:getBytes	()[B
    //   123: aload 5
    //   125: aconst_null
    //   126: new 163	com/tencent/token/em
    //   129: dup
    //   130: invokespecial 164	com/tencent/token/em:<init>	()V
    ...
    //   299: aload_0
    //   300: athrow
    //   301: getstatic 117	com/tencent/token/er:b	Landroid/content/Context;
    //   304: ldc 158
    //   306: invokevirtual 131	android/content/Context:getDatabasePath	(Ljava/lang/String;)Ljava/io/File;
    //   309: pop
    //   310: new 184	com/tencent/token/eo
    //   313: dup
    //   314: getstatic 117	com/tencent/token/er:b	Landroid/content/Context;
    //   317: getstatic 170	com/tencent/token/er:c	Ljava/lang/String;
    //   320: invokestatic 188	com/tencent/token/global/c:a	()I
    //   323: aload 5
    //   325: invokespecial 191	com/tencent/token/eo:<init>	(Landroid/content/Context;Ljava/lang/String;ILcom/tencent/wcdb/database/SQLiteCipherSpec;)V
    //   328: putstatic 115	com/tencent/token/er:a	Lcom/tencent/token/eo;
    //   331: goto +51 -> 382
    //   334: astore_0
    //   335: aload_0
    ...
    //   382: getstatic 115	com/tencent/token/er:a	Lcom/tencent/token/eo;
    //   385: invokevirtual 194	com/tencent/token/eo:getWritableDatabase	()Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   388: astore_0
    //   389: aload_0
    //   390: areturn
    //   391: astore_0
  ...
  public static void a(et paramet)
  {
    ...
    catch (Throwable paramet)
    {
      ...
      localStringBuilder.append(paramet.toString());
      localStringBuilder.append(paramet.getMessage());
