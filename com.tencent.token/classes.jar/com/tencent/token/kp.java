...
public final class kp
{
  ...
  public static int a(Context paramContext, Window paramWindow, RelativeLayout paramRelativeLayout1, RelativeLayout paramRelativeLayout2, ko paramko)
  {
    float f = paramContext.getResources().getDisplayMetrics().density;
    int i = a(paramContext, f);
    paramWindow.setBackgroundDrawable(new ColorDrawable(0));
    paramko.setVisibility(4);
    paramContext = new RelativeLayout.LayoutParams(-1, -1);
    paramContext.addRule(13);
    paramRelativeLayout1.addView(paramko, paramContext);
