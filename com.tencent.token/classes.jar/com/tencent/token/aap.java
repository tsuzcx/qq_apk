...
public final class aap
{
  ...
  private static ImageCache f = new ImageCache(2, RqdApplication.p());
  ...
  public static long a(int paramInt, long paramLong)
  {
    try
    {
      localObject2 = RqdApplication.p().getSharedPreferences("features_file", 0);
      Object localObject1;
      if (paramInt == 1)
      {
  ...
  public static void a()
  {
    try
    {
      Object localObject1 = RqdApplication.p().getSharedPreferences("features_file", 0);
  ...
  public static void a(int paramInt, long paramLong1, long paramLong2)
  {
    ...
    try
    {
      ...
      localObject1 = ((StringBuilder)localObject1).toString();
      label70:
      localObject2 = RqdApplication.p().getSharedPreferences("features_file", 0).edit();
  ...
  public static void a(long paramLong)
  {
    try
    {
      SharedPreferences.Editor localEditor = RqdApplication.p().getSharedPreferences("features_file", 0).edit();
  ...
  public static void a(ConfigResult paramConfigResult)
  {
    if ((paramConfigResult != null) && (paramConfigResult.mStartUpImgUrl != null))
    {
      ...
      try
      {
        localObject = RqdApplication.p().getSharedPreferences("features_file", 0).edit();
  ...
  public static Bitmap b(String paramString, int paramInt)
  {
    ...
    xj.c("BitmapFactory.decodeFile failed...");
    return null;
  }
  ...
  public static void b(long paramLong)
  {
    try
    {
      sk.a();
      RqdApplication.p();
      SharedPreferences.Editor localEditor = sk.g().edit();
      String str1 = se.b();
      abh localabh = new abh();
      String str2 = Long.toString(paramLong);
      localObject2 = localabh.b(str2.getBytes("UTF8"), abj.a(str1));
      Object localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = localabh.b(str2.getBytes("UTF8"), abj.a(str1));
      }
  ...
  public static void b(ConfigResult paramConfigResult)
  {
    if ((paramConfigResult != null) && (paramConfigResult.mToolsTitleList != null) && (paramConfigResult.mToolsList != null))
    {
      ...
      xj.a(paramConfigResult.toString());
      paramConfigResult = RqdApplication.p().getSharedPreferences("features_file", 0).edit();
  ...
  public static boolean b()
  {
    try
    {
      int i = RqdApplication.p().getSharedPreferences("features_file", 0).getInt("token_version", 0);
      int j = xf.d();
      return i != j;
    }
    catch (Exception localException)
  ...
  public static boolean b(String paramString)
  {
    try
    {
      boolean bool = RqdApplication.p().getSharedPreferences("features_file", 0).getBoolean(paramString, false);
      return bool;
    }
    catch (Exception paramString) {}
    return false;
  ...
  public static boolean c()
  {
    try
    {
      boolean bool = RqdApplication.p().getSharedPreferences("features_file", 0).getBoolean("start_camera", false);
      return bool;
    }
    catch (Exception localException)
    {
  ...
  public static boolean c(Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bool5 = bool2;
        bool1 = bool2;
        xj.c("notch screen".concat(String.valueOf(bool2)));
        bool1 = bool2;
      }
      ...
      return bool1;
      bool1 = bool5;
      xj.c("hasNotchInScreen Exception");
      bool1 = bool5;
      continue;
      bool1 = bool4;
      xj.c("hasNotchInScreen NoSuchMethodException");
      bool1 = bool4;
      continue;
      bool1 = bool3;
      xj.c("hasNotchInScreen ClassNotFoundException");
      bool1 = bool3;
    }
  }
  ...
  public static byte[] c(String paramString)
  {
    ...
    //   74: areturn
    //   75: aload_0
    //   76: invokestatic 523	com/tencent/token/aap:f	(Ljava/lang/String;)I
    //   79: istore_1
    //   80: iload_1
    //   81: ifeq +62 -> 143
  ...
  public static long d()
  {
    try
    {
      long l = RqdApplication.p().getSharedPreferences("features_file", 0).getLong("dns_time", 0L);
      return l;
    }
    catch (Exception localException)
    {
  ...
  public static long e()
  {
    try
    {
      ...
      if ((str != null) && (str.length() != 0) && (localObject1 != null))
      {
        ...
        byte[] arrayOfByte = sz.a((String)localObject1);
        localObject2 = localabh.a(arrayOfByte, abj.a(str));
        localObject1 = localObject2;
        if (localObject2 == null) {
          localObject1 = localabh.a(arrayOfByte, abj.a(str));
        }
        localObject1 = new String((byte[])localObject1, "UTF8");
        if (((String)localObject1).length() == 0) {
          return 0L;
        }
        xj.a("facepwd verify uin=".concat(String.valueOf(localObject1)));
  ...
  public static QQUser g()
  {
    try
    {
      ...
      QQUser localQQUser = th.a().c(aao.f(l));
      return localQQUser;
    }
    catch (Exception localException)
    {
  ...
  public static FaceRecognitionParamResult h()
  {
    ...
    try
    {
      Object localObject = RqdApplication.p().getSharedPreferences("features_file", 0);
  ...
  public static int i()
  {
    try
    {
      int i = RqdApplication.p().getSharedPreferences("features_file", 0).getInt("face_algorithm", 1);
      return i;
    }
    catch (Exception localException)
    {
  ...
  public static JSONArray j()
  {
    ...
    try
    {
      JSONArray localJSONArray = new JSONArray(RqdApplication.p().getSharedPreferences("features_file", 0).getString("tools_title", null));
  ...
  public static ArrayList<ArrayList<st>> k()
  {
    try
    {
      JSONArray localJSONArray1 = new JSONArray(RqdApplication.p().getSharedPreferences("features_file", 0).getString("tools_items", null));
      ...
      if (localJSONArray1.length() >= 0)
      {
        ...
        while (i < localJSONArray1.length())
        {
          ...
          {
            localArrayList2.add(new st(localJSONArray2.getJSONObject(j)));
            j += 1;
          }
  ...
  public static boolean m()
  {
    try
    {
      int i = RqdApplication.p().getSharedPreferences("features_file", 0).getInt("collect_device_info", 0);
      return i == 1;
    }
    catch (Exception localException)
    {
  ...
  public static boolean n()
  {
    try
    {
      int i = RqdApplication.p().getSharedPreferences("features_file", 0).getInt("use_face_start", 0);
      return i == 1;
    }
    catch (Exception localException)
    {
  ...
  public static boolean o()
  {
    try
    {
      int i = RqdApplication.p().getSharedPreferences("features_file", 0).getInt("use_face_chpwd", 0);
      return i == 1;
    }
    catch (Exception localException)
    {
  ...
  public static boolean p()
  {
    try
    {
      int i = RqdApplication.p().getSharedPreferences("features_file", 0).getInt("use_face_chmobile", 0);
      return i == 1;
    }
    catch (Exception localException)
    {
  ...
  public static String q()
  {
    try
    {
      String str = RqdApplication.p().getSharedPreferences("features_file", 0).getString("so_param_ids", "");
      return str;
    }
    catch (Exception localException)
    {
  ...
  public static String r()
  {
    try
    {
      String str = RqdApplication.p().getSharedPreferences("features_file", 0).getString("so_param_values", "");
      return str;
    }
    catch (Exception localException)
    {
  ...
  public static int s()
  {
    try
    {
      int i = RqdApplication.p().getSharedPreferences("features_file", 0).getInt("live_angle", 21);
      return i;
    }
    catch (Exception localException)
    {
  ...
  public static int t()
  {
    try
    {
      int i = RqdApplication.p().getSharedPreferences("features_file", 0).getInt("displayAngle_face", -1);
      return i;
    }
    catch (Exception localException)
    {
  ...
  public static int u()
  {
    try
    {
      int i = RqdApplication.p().getSharedPreferences("features_file", 0).getInt("imageAngle_face", -1);
      return i;
    }
    catch (Exception localException)
    {
  ...
  public static boolean v()
  {
    try
    {
      boolean bool = RqdApplication.p().getSharedPreferences("features_file", 0).getBoolean("show_bright_tip", false);
      return bool;
    }
    catch (Exception localException)
    {
  ...
  public static String x()
  {
    ...
    if (e(xr.a))
    {
      ...
      ((StringBuilder)localObject2).append((String)localObject1);
      ((StringBuilder)localObject2).append(xr.a);
  ...
  public static int z()
  {
    ...
    //   3: istore_0
    //   4: iload_2
    //   5: invokestatic 929	com/tencent/token/aap:y	()I
    //   8: if_icmpge +138 -> 146
    ...
    //   49: istore_1
    //   50: aload_3
    //   51: invokevirtual 936	java/io/File:exists	()Z
    //   54: ifeq +83 -> 137
    //   57: sipush 128
    //   60: newarray byte
    //   62: astore 4
    ...
    //   91: iconst_0
    //   92: iload_1
    //   93: invokespecial 938	java/lang/String:<init>	([BII)V
    //   96: invokestatic 496	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   99: invokestatic 941	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   102: astore 4
    //   104: iload_0
    //   105: istore_1
    //   106: aload 4
    //   108: invokevirtual 944	java/lang/Integer:intValue	()I
    //   111: iload_0
    //   112: if_icmple +9 -> 121
    //   115: aload 4
    //   117: invokevirtual 944	java/lang/Integer:intValue	()I
    //   120: istore_1
    //   121: aload_3
