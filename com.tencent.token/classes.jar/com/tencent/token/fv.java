  ...
  implements t
{
  ...
  public fv(v paramv, boolean paramBoolean)
  {
    this.a = paramv;
    this.b = paramBoolean;
  }
  ...
  private boolean a(IOException paramIOException, f paramf, boolean paramBoolean, x paramx)
  {
    ...
    if ((paramBoolean) && ((paramx.d() instanceof fx))) {
      return false;
    }
  ...
  public z a(okhttp3.t.a parama)
  {
    ...
    //   6: astore 6
    //   8: aload_1
    //   9: checkcast 258	com/tencent/token/fs
    //   12: astore 7
    //   14: aload 7
    //   16: invokevirtual 262	com/tencent/token/fs:h	()Lokhttp3/e;
    //   19: astore 8
    //   21: aload 7
    //   23: invokevirtual 265	com/tencent/token/fs:i	()Lokhttp3/p;
    //   26: astore 9
    //   28: new 226	okhttp3/internal/connection/f
    //   31: dup
    //   32: aload_0
    //   33: getfield 22	com/tencent/token/fv:a	Lokhttp3/v;
    //   36: invokevirtual 269	okhttp3/v:p	()Lokhttp3/j;
    //   39: aload_0
    //   40: aload 6
    //   42: invokevirtual 179	okhttp3/x:a	()Lokhttp3/s;
    //   45: invokespecial 271	com/tencent/token/fv:a	(Lokhttp3/s;)Lokhttp3/a;
    //   48: aload 8
    //   50: aload 9
    //   52: aload_0
    //   53: getfield 273	com/tencent/token/fv:d	Ljava/lang/Object;
    //   56: invokespecial 276	okhttp3/internal/connection/f:<init>	(Lokhttp3/j;Lokhttp3/a;Lokhttp3/e;Lokhttp3/p;Ljava/lang/Object;)V
    //   59: astore 4
    //   61: aload_0
    //   62: aload 4
    //   64: putfield 278	com/tencent/token/fv:c	Lokhttp3/internal/connection/f;
    //   67: aconst_null
    //   68: astore 5
    //   70: iconst_0
    //   71: istore_2
    ...
    //   74: astore_1
    //   75: aload_0
    //   76: getfield 280	com/tencent/token/fv:e	Z
    //   79: ifne +375 -> 454
    //   82: aload 7
    //   84: aload_1
    //   85: aload 4
    //   87: aconst_null
    //   88: aconst_null
    //   89: invokevirtual 283	com/tencent/token/fs:a	(Lokhttp3/x;Lokhttp3/internal/connection/f;Lcom/tencent/token/fo;Lokhttp3/internal/connection/c;)Lokhttp3/z;
    //   92: astore 6
    //   94: aload 6
    //   96: astore_1
    //   97: aload 5
    ...
    //   133: invokespecial 301	com/tencent/token/fv:a	(Lokhttp3/z;Lokhttp3/ab;)Lokhttp3/x;
    //   136: astore 6
    //   138: aload 6
    //   140: ifnonnull +17 -> 157
    //   143: aload_0
    //   144: getfield 24	com/tencent/token/fv:b	Z
    //   147: ifne +8 -> 155
    //   150: aload 4
    ...
    //   161: invokestatic 311	com/tencent/token/ff:a	(Ljava/io/Closeable;)V
    //   164: iload_2
    //   165: iconst_1
    //   166: iadd
    //   167: istore_2
    ...
    //   192: invokespecial 214	com/tencent/token/fv:a	(Lokhttp3/z;Lokhttp3/s;)Z
    //   195: ifne +50 -> 245
    //   198: aload 4
    ...
    //   206: dup
    //   207: aload_0
    //   208: getfield 22	com/tencent/token/fv:a	Lokhttp3/v;
    //   211: invokevirtual 269	okhttp3/v:p	()Lokhttp3/j;
    //   214: aload_0
    //   215: aload 6
    //   217: invokevirtual 179	okhttp3/x:a	()Lokhttp3/s;
    //   220: invokespecial 271	com/tencent/token/fv:a	(Lokhttp3/s;)Lokhttp3/a;
    //   223: aload 8
    //   225: aload 9
    //   227: aload_0
    //   228: getfield 273	com/tencent/token/fv:d	Ljava/lang/Object;
    //   231: invokespecial 276	okhttp3/internal/connection/f:<init>	(Lokhttp3/j;Lokhttp3/a;Lokhttp3/e;Lokhttp3/p;Ljava/lang/Object;)V
    //   234: astore 4
    //   236: aload_0
    //   237: aload 4
    //   239: putfield 278	com/tencent/token/fv:c	Lokhttp3/internal/connection/f;
    //   242: goto +11 -> 253
    //   245: aload 4
    //   247: invokevirtual 314	okhttp3/internal/connection/f:a	()Lcom/tencent/token/fo;
    ...
    //   400: iload_3
    //   401: aload_1
    //   402: invokespecial 348	com/tencent/token/fv:a	(Ljava/io/IOException;Lokhttp3/internal/connection/f;ZLokhttp3/x;)Z
    //   405: ifeq +6 -> 411
    //   408: goto -333 -> 75
    //   411: aload 6
    //   413: athrow
    ...
    //   424: iconst_0
    //   425: aload_1
    //   426: invokespecial 348	com/tencent/token/fv:a	(Ljava/io/IOException;Lokhttp3/internal/connection/f;ZLokhttp3/x;)Z
    //   429: ifeq +6 -> 435
    //   432: goto -357 -> 75
    //   435: aload 6
