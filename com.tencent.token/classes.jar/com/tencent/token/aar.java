...
public final class aar
{
  static FileFilter a = new FileFilter()
  {
    public final boolean accept(File paramAnonymousFile)
    {
      ...
      return aar.a(paramAnonymousFile) > 0L;
    }
  };
  ...
  private FileFilter k = new FileFilter()
  {
    public final boolean accept(File paramAnonymousFile)
    {
      if (!paramAnonymousFile.getName().endsWith(aar.this.g)) {
        return false;
      }
      return aar.c(paramAnonymousFile) != -1;
    }
  };
  private Comparator<? super File> l = new Comparator() {};
  
  public aar(File paramFile, int paramInt, String paramString1, String paramString2, long paramLong)
  {
    this.e = paramFile;
    this.j = paramInt;
    this.i = 262144;
 ...
 * Qualified Name:     com.tencent.token.aar
