  ...
  extends MenuInflater
{
  ...
  public final void inflate(int paramInt, Menu paramMenu)
  {
    ...
    //   21: astore_3
    //   22: aload_0
    //   23: getfield 36	com/tencent/token/hc:e	Landroid/content/Context;
    ...
    //   54: aload_2
    //   55: invokespecial 120	com/tencent/token/hc:a	(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    //   58: aload 6
    //   60: ifnull +11 -> 71
    //   63: aload 6
  ...
  final class b
  {
    ...
    private <T> T a(String paramString, Class<?>[] paramArrayOfClass, Object[] paramArrayOfObject)
    {
      try
      {
        paramString = hc.this.e.getClassLoader().loadClass(paramString).getConstructor(paramArrayOfClass);
    ...
    private void a(MenuItem paramMenuItem)
    {
      ...
      if (this.B != null) {
        if (!hc.this.e.isRestricted())
        {
          localObject = hc.this;
          if (((hc)localObject).f == null) {
            ((hc)localObject).f = hc.a(((hc)localObject).e);
          }
          paramMenuItem.setOnMenuItemClickListener(new hc.a(((hc)localObject).f, this.B));
        }
        else
        {
      ...
      if (this.t >= 2) {
        if ((paramMenuItem instanceof ho)) {
          ((ho)paramMenuItem).a(true);
        } else if ((paramMenuItem instanceof hp)) {
          localObject = (hp)paramMenuItem;
        }
      }
      try
      {
        if (((hp)localObject).e == null) {
          ((hp)localObject).e = ((do)((hp)localObject).d).getClass().getDeclaredMethod("setExclusiveCheckable", new Class[] { Boolean.TYPE });
        }
        ((hp)localObject).e.invoke(((hp)localObject).d, new Object[] { Boolean.TRUE });
      }
      ...
      if (localObject != null)
      {
        paramMenuItem.setActionView((View)a((String)localObject, hc.a, hc.this.c));
        i1 = 1;
      }
      i2 = this.y;
      if ((i2 > 0) && (i1 == 0)) {
      ...
      localObject = this.b;
      if (localObject != null) {
        en.a(paramMenuItem, (ej)localObject);
      }
      en.a(paramMenuItem, this.C);
      en.b(paramMenuItem, this.D);
      en.b(paramMenuItem, this.p, this.q);
      en.a(paramMenuItem, this.r, this.s);
      localObject = this.F;
      if (localObject != null) {
        en.a(paramMenuItem, (PorterDuff.Mode)localObject);
      }
      localObject = this.E;
      if (localObject != null) {
        en.a(paramMenuItem, (ColorStateList)localObject);
      }
    }
    ...
    {
      paramAttributeSet = hc.this.e.obtainStyledAttributes(paramAttributeSet, gp.j.MenuGroup);
      this.e = paramAttributeSet.getResourceId(gp.j.MenuGroup_android_id, 0);
      this.f = paramAttributeSet.getInt(gp.j.MenuGroup_android_menuCategory, 0);
      this.g = paramAttributeSet.getInt(gp.j.MenuGroup_android_orderInCategory, 0);
      this.h = paramAttributeSet.getInt(gp.j.MenuGroup_android_checkableBehavior, 0);
      this.i = paramAttributeSet.getBoolean(gp.j.MenuGroup_android_visible, true);
      this.j = paramAttributeSet.getBoolean(gp.j.MenuGroup_android_enabled, true);
