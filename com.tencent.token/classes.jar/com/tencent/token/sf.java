...
public final class sf
{
  ...
  {
    // Byte code:
    //   0: new 77	com/tencent/token/xh
    //   3: dup
    //   4: invokespecial 78	com/tencent/token/xh:<init>	()V
    //   7: astore_3
    //   8: invokestatic 83	com/tencent/token/th:a	()Lcom/tencent/token/th;
    //   11: astore 4
    //   13: aload 4
    //   15: invokevirtual 85	com/tencent/token/th:i	()Z
    //   18: ifne +26 -> 44
    //   21: aload_3
    //   22: sipush 30001
    //   25: aconst_null
    //   26: aconst_null
    //   27: invokevirtual 88	com/tencent/token/xh:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   30: aload_0
    //   31: getfield 90	com/tencent/token/sf:j	Z
    //   34: ifeq +8 -> 42
    //   37: aload_0
    //   38: invokespecial 92	com/tencent/token/sf:e	()Z
    //   41: pop
    //   42: aload_3
    //   43: areturn
    //   44: aload 4
    //   46: invokevirtual 95	com/tencent/token/th:f	()Lcom/tencent/token/core/bean/QQUser;
    //   49: ifnonnull +12 -> 61
    //   52: aload 4
    //   54: getfield 98	com/tencent/token/th:k	Lcom/tencent/token/ais;
    //   57: invokevirtual 102	com/tencent/token/ais:b	()Lcom/tencent/token/core/bean/QQUser;
    //   60: pop
    //   61: ldc 104
    //   63: aload_1
    ...
    //   70: invokestatic 119	com/tencent/token/xj:a	(Ljava/lang/String;)V
    ...
    //   91: astore 4
    //   93: invokestatic 134	com/tencent/token/rf:a	()Lcom/tencent/token/rf;
    //   96: aload_1
    //   97: new 6	com/tencent/token/sf$1
    //   100: dup
    //   101: aload_0
    //   102: aload 4
    //   104: aload 5
    //   106: invokespecial 137	com/tencent/token/sf$1:<init>	(Lcom/tencent/token/sf;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/CountDownLatch;)V
    //   109: invokevirtual 140	com/tencent/token/rf:d	(Ljava/lang/String;Lcom/tencent/token/rf$a;)V
    //   112: aload 5
    ...
    //   130: checkcast 152	com/tencent/token/ri
    //   133: astore_1
    //   134: aload_1
    //   135: ifnonnull +26 -> 161
    //   138: aload_0
    //   139: getfield 90	com/tencent/token/sf:j	Z
    //   142: ifeq +8 -> 150
    //   145: aload_0
    //   146: invokespecial 92	com/tencent/token/sf:e	()Z
    //   149: pop
    //   150: aload_3
    //   151: sipush -799
    //   154: aconst_null
    //   155: aconst_null
    //   156: invokevirtual 88	com/tencent/token/xh:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   159: aload_3
    //   160: areturn
    //   161: aload_1
    //   162: getfield 154	com/tencent/token/ri:b	I
    //   165: istore_2
    //   166: iload_2
    //   167: ifeq +18 -> 185
    //   170: aload_1
    //   171: getfield 156	com/tencent/token/ri:d	Ljava/lang/String;
    //   174: astore_1
    //   175: aload_3
    //   176: iload_2
    //   177: aload_1
    //   178: aload_1
    //   179: invokevirtual 88	com/tencent/token/xh:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   182: goto +101 -> 283
    //   185: aload_3
    //   186: iconst_0
    //   187: putfield 158	com/tencent/token/xh:a	I
    //   190: aload_0
    //   191: getfield 53	com/tencent/token/sf:b	Lorg/json/JSONArray;
    //   194: invokevirtual 162	org/json/JSONArray:length	()I
    //   197: getstatic 164	com/tencent/token/sf:e	I
    //   200: if_icmple +10 -> 210
    //   203: getstatic 164	com/tencent/token/sf:e	I
    //   206: istore_2
    //   207: goto +11 -> 218
    //   210: aload_0
    //   211: getfield 53	com/tencent/token/sf:b	Lorg/json/JSONArray;
    //   214: invokevirtual 162	org/json/JSONArray:length	()I
    //   217: istore_2
    //   218: iload_2
    //   219: getstatic 164	com/tencent/token/sf:e	I
    //   222: if_icmpgt +17 -> 239
    //   225: aload_0
    //   226: new 50	org/json/JSONArray
    //   229: dup
    //   230: invokespecial 51	org/json/JSONArray:<init>	()V
    //   233: putfield 53	com/tencent/token/sf:b	Lorg/json/JSONArray;
    //   236: goto +47 -> 283
    ...
    //   247: iload_2
    //   248: aload_0
    //   249: getfield 53	com/tencent/token/sf:b	Lorg/json/JSONArray;
    //   252: invokevirtual 162	org/json/JSONArray:length	()I
    //   255: if_icmpge +23 -> 278
    //   258: aload_1
    //   259: aload_0
    //   260: getfield 53	com/tencent/token/sf:b	Lorg/json/JSONArray;
    //   263: iload_2
    ...
    //   278: aload_0
    //   279: aload_1
    //   280: putfield 53	com/tencent/token/sf:b	Lorg/json/JSONArray;
    //   283: aload_0
    //   284: getfield 90	com/tencent/token/sf:j	Z
    //   287: ifeq +162 -> 449
    //   290: aload_0
    //   291: invokespecial 92	com/tencent/token/sf:e	()Z
    //   294: pop
    //   295: aload_3
    //   296: areturn
    //   297: astore_1
    ...
    //   328: invokestatic 188	com/tencent/token/xj:c	(Ljava/lang/String;)V
    ...
    //   361: aconst_null
    //   362: invokevirtual 88	com/tencent/token/xh:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   365: aload_0
    //   366: getfield 90	com/tencent/token/sf:j	Z
    //   369: ifeq +80 -> 449
    //   372: goto -82 -> 290
    //   375: astore_1
    ...
    //   402: invokestatic 188	com/tencent/token/xj:c	(Ljava/lang/String;)V
    ...
    //   435: aconst_null
    //   436: invokevirtual 88	com/tencent/token/xh:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   439: aload_0
    //   440: getfield 90	com/tencent/token/sf:j	Z
    //   443: ifeq +6 -> 449
    //   446: goto -156 -> 290
    //   449: aload_3
    //   450: areturn
    //   451: aload_0
    //   452: getfield 90	com/tencent/token/sf:j	Z
    //   455: ifeq +8 -> 463
    //   458: aload_0
    //   459: invokespecial 92	com/tencent/token/sf:e	()Z
    //   462: pop
    //   463: aload_1
    //   464: athrow
  ...
  {
    // Byte code:
    //   0: invokestatic 63	com/tencent/token/xf:j	()Z
    //   3: ifeq +5 -> 8
    //   6: iconst_0
    //   7: ireturn
    //   8: aload_0
    //   9: getfield 53	com/tencent/token/sf:b	Lorg/json/JSONArray;
    //   12: ifnonnull +5 -> 17
    //   15: iconst_0
    //   16: ireturn
    //   17: iconst_0
    //   18: putstatic 38	com/tencent/token/sf:i	Z
    //   21: aload_0
    //   22: getfield 44	com/tencent/token/sf:a	Z
    //   25: ifne +5 -> 30
    //   28: iconst_1
    //   29: ireturn
    //   30: aload_1
    ...
    //   44: aload_1
    //   45: aload_0
    //   46: getfield 53	com/tencent/token/sf:b	Lorg/json/JSONArray;
  ...
  private boolean f()
  {
    ...
    //   7: ireturn
    //   8: aload_0
    //   9: getfield 44	com/tencent/token/sf:a	Z
    //   12: ifne +5 -> 17
    //   15: iconst_1
    //   16: ireturn
    //   17: invokestatic 227	com/tencent/token/global/RqdApplication:p	()Landroid/content/Context;
    //   20: ldc 200
    ...
    //   60: putfield 53	com/tencent/token/sf:b	Lorg/json/JSONArray;
    //   63: aload_1
  ...
  public final void a(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      {
        if (th.a().k.b() != null) {
          localJSONObject.put("uin", th.a().k.b().mRealUin);
        }
        localObject2 = aao.c(RqdApplication.p());
        if (!TextUtils.isEmpty((CharSequence)localObject2)) {
          localJSONObject.put("mac", localObject2);
        }
        localObject2 = aao.b(RqdApplication.p());
        if (!TextUtils.isEmpty((CharSequence)localObject2)) {
          localJSONObject.put("device_id", localObject2);
        }
        localJSONObject.put("model", URLEncoder.encode(xr.a));
        localJSONObject.put("release", URLEncoder.encode(Build.VERSION.RELEASE));
        localJSONObject.put("platfrom", "android");
        localJSONObject.put("guid", aao.a(sg.a(RqdApplication.p()).a.GetGuid()));
        localObject2 = aao.d(RqdApplication.p());
        if (!TextUtils.isEmpty((CharSequence)localObject2)) {
