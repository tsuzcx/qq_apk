  ...
  extends aql
{
  ...
  private int a(int paramInt, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 120	com/tencent/token/aqo:a	Landroid/content/Context;
    //   4: astore 8
    //   6: iconst_0
    //   7: istore 4
    //   9: iconst_0
    ...
    //   23: ifnull +473 -> 496
    //   26: aload_0
    //   27: getfield 33	com/tencent/token/aqo:i	Ljava/util/ArrayList;
    //   30: astore 8
    //   32: iload 6
    //   34: istore 5
    //   36: aload 8
    ...
    //   59: istore 5
    //   61: aload_0
    //   62: getfield 120	com/tencent/token/aqo:a	Landroid/content/Context;
    ...
    //   86: iconst_0
    //   87: aload_0
    //   88: getfield 120	com/tencent/token/aqo:a	Landroid/content/Context;
    ...
    //   174: iconst_1
    //   175: aload_0
    //   176: getfield 33	com/tencent/token/aqo:i	Ljava/util/ArrayList;
    //   179: iload_1
    ...
    //   406: aload_0
    //   407: iload_1
    //   408: invokespecial 190	com/tencent/token/aql:a	(I)I
    //   411: istore_3
    //   412: iload_3
    //   413: iconst_m1
    ...
    //   462: aload_0
    //   463: aload_2
    //   464: invokespecial 194	com/tencent/token/aqo:a	(Ljava/lang/String;)I
    //   467: istore_3
    //   468: goto +17 -> 485
    //   471: aload 9
    //   473: ifnull +10 -> 483
    ...
    paramParcel1 = new Runnable()
    {
      public final void run()
      {
        try
        {
          ...
          aqo.this.g.lock();
          aqo.this.f.transact(1, paramParcel1, paramParcel2, 0);
          aqo.this.g.unlock();
