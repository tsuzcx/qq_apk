...
public final class aic
{
  ...
  private aic(String paramString1, String paramString2, long paramLong, String paramString3, String paramString4, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    this.a = paramString1;
    this.b = paramString2;
    this.g = paramLong;
  ...
  @Nullable
  private static aic a(long paramLong, aij paramaij, String paramString)
  {
    int i7 = paramString.length();
    int n = aix.a(paramString, 0, i7, ';');
    int i1 = aix.a(paramString, 0, n, '=');
    localObject4 = null;
    if (i1 == n) {
      return null;
    }
    String str1 = aix.c(paramString, 0, i1);
    if ((!str1.isEmpty()) && (aix.b(str1) == -1))
    {
      String str2 = aix.c(paramString, i1 + 1, n);
      if (aix.b(str2) != -1) {
        return null;
      }
      n += 1;
      ...
      {
        int i8 = aix.a(paramString, n, i7, ';');
        i1 = aix.a(paramString, n, i8, '=');
        String str3 = aix.c(paramString, n, i1);
        if (i1 < i8) {
          localObject1 = aix.c(paramString, i1 + 1, i8);
        } else {
          localObject1 = "";
        }
        ...
        try
        {
          localObject1 = new GregorianCalendar(aix.g);
        ...
        else if (str3.equalsIgnoreCase("domain"))
        {
          if (!((String)localObject1).endsWith("."))
          {
            ...
            localObject1 = aix.a((String)localObject5);
      ...
      Object localObject1 = paramaij.b;
      ...
      else
      {
        if (((String)localObject1).equals(localObject4)) {
          n = 1;
        } else if ((((String)localObject1).endsWith(localObject4)) && (((String)localObject1).charAt(((String)localObject1).length() - localObject4.length() - 1) == '.') && (!aix.c((String)localObject1))) {
          n = 1;
        } else {
          n = 0;
        }
      ...
      {
        paramaij = localObject3;
      }
      else
      {
        paramaij = paramaij.e();
        n = paramaij.lastIndexOf('/');
        if (n != 0) {
          paramaij = paramaij.substring(0, n);
        } else {
          paramaij = "/";
        }
      }
      return new aic(str1, str2, paramLong, paramString, paramaij, bool4, bool5, bool2, bool3);
    }
    else
    {
      return null;
  ...
  public static List<aic> a(aij paramaij, aii paramaii)
  {
    int i2 = paramaii.a.length / 2;
    int i1 = 0;
    aic localaic = null;
    ...
    while (n < i2)
    {
      ...
      if ("Set-Cookie".equalsIgnoreCase(paramaii.a(n)))
      {
        localObject2 = localObject1;
        if (localObject1 == null) {
          localObject2 = new ArrayList(2);
        }
        ((List)localObject2).add(paramaii.b(n));
      }
      n += 1;
    ...
    while (n < i2)
    {
      ...
      localaic = a(System.currentTimeMillis(), paramaij, (String)localObject1);
      localObject1 = paramaii;
      if (localaic != null)
      {
        localObject1 = paramaii;
        if (paramaii == null) {
        ...
        ((List)localObject1).add(localaic);
      }
      n += 1;
      paramaii = (aii)localObject1;
    }
    if (paramaii != null) {
      return Collections.unmodifiableList(paramaii);
    }
  ...
  {
    if (!(paramObject instanceof aic)) {
      return false;
    }
    paramObject = (aic)paramObject;
  ...
  public final String toString()
  {
    ...
    if (this.l) {
      ...
      else
      {
        ...
        localStringBuilder.append(ajn.a(new Date(this.g)));
      }
    }
    if (!this.m)
    {
