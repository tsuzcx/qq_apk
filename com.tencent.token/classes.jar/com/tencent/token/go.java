  ...
  implements ActionBarOverlayLayout.a
{
  ...
  final fb p = new fc()
  {
    ...
    {
      if ((go.this.k) && (go.this.f != null))
      {
        go.this.f.setTranslationY(0.0F);
        go.this.c.setTranslationY(0.0F);
      }
      go.this.c.setVisibility(8);
      go.this.c.setTransitioning(false);
      paramAnonymousView = go.this;
  ...
  final fd r = new fd()
  {
    public final void a()
    {
      ((View)go.this.c.getParent()).invalidate();
    }
  };
  private Context v;
  private Activity w;
  ...
  public go(Activity paramActivity, boolean paramBoolean)
  {
  ...
  {
    this.b = ((ActionBarOverlayLayout)paramView.findViewById(gp.f.decor_content_parent));
    ...
    this.d = b(paramView.findViewById(gp.f.action_bar));
    this.e = ((ActionBarContextView)paramView.findViewById(gp.f.action_context_bar));
    this.c = ((ActionBarContainer)paramView.findViewById(gp.f.action_bar_container));
    paramView = this.d;
    if ((paramView != null) && (this.e != null) && (this.c != null))
    {
      ...
      paramView = gw.a(this.a);
      paramView.c();
      f(paramView.b());
      paramView = this.a.obtainStyledAttributes(null, gp.j.ActionBar, gp.a.actionBarStyle, 0);
      if (paramView.getBoolean(gp.j.ActionBar_hideOnContentScroll, false)) {
        c();
      }
      int i1 = paramView.getDimensionPixelSize(gp.j.ActionBar_elevation, 0);
      if (i1 != 0) {
        a(i1);
      }
      paramView.recycle();
  ...
  private static iq b(View paramView)
  {
    if ((paramView instanceof iq)) {
      return (iq)paramView;
    }
  ...
  private void f(boolean paramBoolean)
  {
    ...
    if (localObject != null) {
      if (i1 != 0)
      {
        ((iz)localObject).setVisibility(0);
        localObject = this.b;
        if (localObject != null) {
          ex.j((View)localObject);
        }
      }
      else
      {
        ((iz)localObject).setVisibility(8);
      }
    }
    localObject = this.d;
    if ((!this.D) && (i1 != 0)) {
  ...
  private void h(boolean paramBoolean)
  {
    ...
    if ((this.E == 0) && ((this.H) || (paramBoolean)))
    {
      ...
      localObject1 = new hd();
      Object localObject2 = ex.f(this.c).b(0.0F);
      ((fa)localObject2).a(this.r);
      ((hd)localObject1).a((fa)localObject2);
      if (this.k)
      {
        localObject2 = this.f;
        if (localObject2 != null)
        {
          ...
          ((hd)localObject1).a(ex.f(this.f).b(0.0F));
        }
      }
      ((hd)localObject1).a(u);
      ((hd)localObject1).c();
      ((hd)localObject1).a(this.q);
      this.n = ((hd)localObject1);
      ((hd)localObject1).a();
    }
    else
    {
  ...
  private void i(boolean paramBoolean)
  {
    ...
    if ((this.E == 0) && ((this.H) || (paramBoolean)))
    {
      ...
      Object localObject = ex.f(this.c).b(f1);
      ((fa)localObject).a(this.r);
      localhd.a((fa)localObject);
      if (this.k)
      {
        localObject = this.f;
        if (localObject != null) {
          localhd.a(ex.f((View)localObject).b(f1));
        }
      }
      localhd.a(t);
      localhd.c();
  ...
  public final Context b()
  {
    if (this.v == null)
    {
      ...
      this.a.getTheme().resolveAttribute(gp.a.actionBarWidgetTheme, localTypedValue, true);
  ...
  public final void e(boolean paramBoolean)
  {
    ...
    if (ex.q(this.c))
    {
      ...
      if (paramBoolean)
      {
        localfa2 = this.d.a(4, 100L);
        localfa1 = this.e.a(0, 200L);
      }
      else
      {
        localfa1 = this.d.a(0, 200L);
        localfa2 = this.e.a(8, 100L);
      }
      hd localhd = new hd();
      localhd.a(localfa2, localfa1);
      localhd.a();
      return;
    }
    if (paramBoolean)
    ...
    implements hm.a
  {
    ...
    public a(Context paramContext, gx.a parama)
    {
      this.e = paramContext;
      this.f = parama;
      this$1 = new hm(paramContext);
      go.this.e = 1;
      this.a = go.this;
      this.a.a(this);
    }
    ...
    public final void a(int paramInt)
    {
      b(go.this.a.getResources().getString(paramInt));
    }
    
    public final void a(View paramView)
    {
      go.this.e.setCustomView(paramView);
    ...
    public final void a(CharSequence paramCharSequence)
    {
      go.this.e.setSubtitle(paramCharSequence);
    }
    
    public final void a(boolean paramBoolean)
    {
      super.a(paramBoolean);
      go.this.e.setTitleOptional(paramBoolean);
    }
    ...
    public final boolean a(hm paramhm, MenuItem paramMenuItem)
    {
      paramhm = this.f;
      if (paramhm != null) {
        return paramhm.a(this, paramMenuItem);
      }
      return false;
    }
    ...
    public final void b(int paramInt)
    {
      a(go.this.a.getResources().getString(paramInt));
    }
    
    public final void b(CharSequence paramCharSequence)
    {
      go.this.e.setTitle(paramCharSequence);
    }
    ...
    public final void c()
    {
      ...
      if (!go.a(go.this.l, go.this.m, false))
      {
        go localgo = go.this;
        localgo.i = this;
        localgo.j = this.f;
      ...
      go.this.e(false);
      go.this.e.b();
      go.this.d.a().sendAccessibilityEvent(32);
      go.this.b.setHideOnContentScrollEnabled(go.this.o);
      go.this.h = null;
    }
    ...
    {
      return go.this.e.getTitle();
    }
    
    public final CharSequence g()
    {
      return go.this.e.getSubtitle();
    }
