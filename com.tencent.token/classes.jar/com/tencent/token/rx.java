...
public final class rx
{
  ...
  public rw c = rw.a();
  private boolean e;
  private rt f = new rt("com.tencent.token");
  ...
  public final void a(final rv paramrv)
  {
  ...
  final boolean a(boolean paramBoolean)
  {
    ...
    if (j())
    {
      if (this.e)
      {
        RqdApplication.p().unregisterReceiver(this.i);
        this.e = false;
      }
      return false;
    }
    ...
    if ((this.c.a.a("meri_silent_update_switch_user", true)) && (localObject1 == aqo.d))
    {
    ...
    if ((!this.e) && (!this.c.l()))
    {
      ...
      RqdApplication.p().registerReceiver(this.i, (IntentFilter)localObject1);
      this.e = true;
    }
    return false;
  }
  ...
  public final void c()
  {
    synchronized (this.h)
    {
      ...
      localrw.h(0);
      localrw.d("");
      localrw.a.b("meri_update_start_time", 0L);
      localrw.a(0L);
      localrw.b(0);
      localrw.c(0);
      localrw.d(0);
      ...
      localrw.a(0);
      localrw.a("");
      localrw.a.b("meri_patch_url", "");
      localrw.g(0);
      localrw.b(0L);
      localrw.c(0L);
      localrw.a.b("meri_update_show_dialog_count", 0);
      localrw.b(false);
      localrw.e("");
      localrw.f("");
      localrw.g("");
      localrw.i(0);
      localrw.j(0);
      localrw.a.b("has_click_update_tip_in_main_page", false);
      localrw.a.b();
      this.c.k(0);
  ...
  public final void f()
  {
    ...
    new Handler(Looper.getMainLooper()).post(new Runnable()
    {
      ...
      {
        if (rx.a(rx.this) != null)
        {
          new UpdateDownloadDialog(rx.a(rx.this), locala).show();
          rx.d();
          rx.b(rx.this).c(System.currentTimeMillis() + rx.b(rx.this).n());
        }
      }
    });
  }
  ...
  public final void h()
  {
    a(new rv()
    {
      public final void a()
      {
        if (rx.b(rx.this).a.a("meri_update_msg_type") != 6) {
          return;
        }
        rx localrx = rx.this;
        rj.a locala = rx.a().g();
        if ((locala != null) && (localrx.b != null)) {
          new Handler(Looper.getMainLooper()).post(new rx.3(localrx, locala));
        }
      }
 ...
 * Qualified Name:     com.tencent.token.rx
