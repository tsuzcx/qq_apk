  ...
  extends MenuInflater
{
  ...
  public ht(Context paramContext)
  {
    super(paramContext);
    this.e = paramContext;
  ...
  public final void inflate(int paramInt, Menu paramMenu)
  {
    ...
    //   21: astore_3
    //   22: aload_0
    //   23: getfield 36	com/tencent/token/ht:e	Landroid/content/Context;
    ...
    //   54: aload_2
    //   55: invokespecial 120	com/tencent/token/ht:a	(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    //   58: aload 6
    //   60: ifnull +11 -> 71
    //   63: aload 6
  ...
  final class b
  {
    ...
    private <T> T a(String paramString, Class<?>[] paramArrayOfClass, Object[] paramArrayOfObject)
    {
      try
      {
        paramString = ht.this.e.getClassLoader().loadClass(paramString).getConstructor(paramArrayOfClass);
    ...
    private void a(MenuItem paramMenuItem)
    {
      ...
      if (this.B != null) {
        if (!ht.this.e.isRestricted())
        {
          localObject = ht.this;
          if (((ht)localObject).f == null) {
            ((ht)localObject).f = ht.a(((ht)localObject).e);
          }
          paramMenuItem.setOnMenuItemClickListener(new ht.a(((ht)localObject).f, this.B));
        }
        else
        {
      ...
      if (this.t >= 2) {
        if ((paramMenuItem instanceof if)) {
          ((if)paramMenuItem).a(true);
        } else if ((paramMenuItem instanceof ig)) {
          localObject = (ig)paramMenuItem;
        }
      }
      try
      {
        if (((ig)localObject).e == null) {
          ((ig)localObject).e = ((ef)((ig)localObject).d).getClass().getDeclaredMethod("setExclusiveCheckable", new Class[] { Boolean.TYPE });
        }
        ((ig)localObject).e.invoke(((ig)localObject).d, new Object[] { Boolean.TRUE });
      }
      ...
      if (localObject != null)
      {
        paramMenuItem.setActionView((View)a((String)localObject, ht.a, ht.this.c));
        i1 = 1;
      }
      i2 = this.y;
      if ((i2 > 0) && (i1 == 0)) {
      ...
      localObject = this.b;
      if (localObject != null) {
        fe.a(paramMenuItem, (fa)localObject);
      }
      fe.a(paramMenuItem, this.C);
      fe.b(paramMenuItem, this.D);
      fe.b(paramMenuItem, this.p, this.q);
      fe.a(paramMenuItem, this.r, this.s);
      localObject = this.F;
      if (localObject != null) {
        fe.a(paramMenuItem, (PorterDuff.Mode)localObject);
      }
      localObject = this.E;
      if (localObject != null) {
        fe.a(paramMenuItem, (ColorStateList)localObject);
      }
    }
    ...
    {
      paramAttributeSet = ht.this.e.obtainStyledAttributes(paramAttributeSet, hg.j.MenuGroup);
      this.e = paramAttributeSet.getResourceId(hg.j.MenuGroup_android_id, 0);
      this.f = paramAttributeSet.getInt(hg.j.MenuGroup_android_menuCategory, 0);
      this.g = paramAttributeSet.getInt(hg.j.MenuGroup_android_orderInCategory, 0);
      this.h = paramAttributeSet.getInt(hg.j.MenuGroup_android_checkableBehavior, 0);
      this.i = paramAttributeSet.getBoolean(hg.j.MenuGroup_android_visible, true);
      this.j = paramAttributeSet.getBoolean(hg.j.MenuGroup_android_enabled, true);
