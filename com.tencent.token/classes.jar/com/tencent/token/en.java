  ...
  public final Iterator<E> iterator()
  {
    if (this.j == null) {
      this.j = new et()
      {
        ...
        {
          return en.this.a(paramAnonymousObject);
        }
        
        protected final Object a(int paramAnonymousInt1, int paramAnonymousInt2)
        {
          return en.b(en.this)[paramAnonymousInt1];
        }
