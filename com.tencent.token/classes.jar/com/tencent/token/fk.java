  ...
  implements View.OnTouchListener
{
  ...
  public final fk a(boolean paramBoolean)
  {
  ...
  static final class a
  {
    ...
    final float a(long paramLong)
    {
      ...
      {
        float f1 = this.j;
        return 1.0F - f1 + f1 * fk.a((float)(paramLong - l) / this.k, 0.0F, 1.0F);
      }
      return fk.a((float)(paramLong - this.e) / this.a, 0.0F, 1.0F) * 0.5F;
    }
    
    public final void a()
    {
      long l = AnimationUtils.currentAnimationTimeMillis();
      this.k = fk.a((int)(l - this.e), this.b);
      this.j = a(l);
      this.i = l;
    }
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      {
        localObject = fk.this;
        ((fk)localObject).c = false;
        localObject = ((fk)localObject).a;
        ((fk.a)localObject).e = AnimationUtils.currentAnimationTimeMillis();
        ((fk.a)localObject).i = -1L;
        ((fk.a)localObject).f = ((fk.a)localObject).e;
        ((fk.a)localObject).j = 0.5F;
        ((fk.a)localObject).g = 0;
        ((fk.a)localObject).h = 0;
      }
      Object localObject = fk.this.a;
      int i;
      if ((((fk.a)localObject).i > 0L) && (AnimationUtils.currentAnimationTimeMillis() > ((fk.a)localObject).i + ((fk.a)localObject).k)) {
        i = 1;
      } else {
        i = 0;
      }
      if ((i == 0) && (fk.this.a()))
      {
        ...
        if (fk.this.d)
        {
          ...
          localfk.b.onTouchEvent(localMotionEvent);
          localMotionEvent.recycle();
        }
        if (((fk.a)localObject).f != 0L)
        {
          l1 = AnimationUtils.currentAnimationTimeMillis();
          float f = ((fk.a)localObject).a(l1);
          long l2 = ((fk.a)localObject).f;
          ((fk.a)localObject).f = l1;
          f = (float)(l1 - l2) * (-4.0F * f * f + f * 4.0F);
          ((fk.a)localObject).g = ((int)(((fk.a)localObject).c * f));
          ((fk.a)localObject).h = ((int)(f * ((fk.a)localObject).d));
          i = ((fk.a)localObject).h;
          fk.this.a(i);
          ew.a(fk.this.b, this);
          return;
        }
