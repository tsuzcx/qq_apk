...
public final class agd
{
  ...
  public agd(byte[] paramArrayOfByte)
  {
  ...
  private byte a(byte paramByte, int paramInt, boolean paramBoolean)
  {
    ...
    return paramByte;
    label90:
    throw new break("require field not exist.");
  }
  ...
  private boolean b(int paramInt)
  {
    for (;;)
    {
      ...
      catch (break|BufferUnderflowException localbreak)
      {
        return false;
      }
      int i = 1;
  ...
  private <T> T[] b(T paramT, int paramInt, boolean paramBoolean)
  {
    if (b(paramInt))
    {
      ...
      else
      {
        ...
        throw new break("size invalid: ".concat(String.valueOf(i)));
      }
    }
    else
    {
  ...
  public final final a(final paramfinal, int paramInt, boolean paramBoolean)
  {
    if (b(paramInt)) {
      try
      {
        paramfinal = (final)paramfinal.getClass().newInstance();
        ByteBuffer localByteBuffer = this.a;
        paramInt = localByteBuffer.get();
        int i = (byte)(paramInt & 0xF);
        if ((paramInt & 0xF0) >> 4 == 15) {
      ...
      catch (Exception paramfinal)
      {
        throw new break(paramfinal.getMessage());
      }
    }
    if (!paramBoolean) {
      return null;
  ...
  public final <T> Object a(T paramT, int paramInt, boolean paramBoolean)
  {
        ...
        if (b(paramInt))
        {
          ...
          if (i >= 0)
          {
            ...
            for (;;)
            {
              ...
              ((HashMap)localObject1).put(a(localObject2, 0, true), a(localObject3, 1, true));
              paramInt += 1;
            }
          }
          throw new break("size invalid: ".concat(String.valueOf(i)));
    ...
    if ((paramT instanceof final)) {
      return a((final)paramT, paramInt, paramBoolean);
    }
    if (paramT.getClass().isArray())
    {
      if ((!(paramT instanceof byte[])) && (!(paramT instanceof Byte[])))
      {
        ...
        throw new break("unable to get type of key and value.");
      }
      return b(paramInt, paramBoolean);
    }
    throw new break("read object error: unsupport type.");
  }
  ...
  public final String a(int paramInt, boolean paramBoolean)
  {
    ...
    throw new break("String too long: ".concat(String.valueOf(paramInt)));
    int i = this.a.get();
    paramInt = i;
    if (i < 0) {
      paramInt = i + 256;
