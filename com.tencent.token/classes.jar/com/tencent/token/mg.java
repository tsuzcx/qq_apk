...
public final class mg
{
  ...
  public static String a(String paramString)
  {
    ...
    localObject = new mg();
    ((mg)localObject).a();
    ((mg)localObject).a(new ByteArrayInputStream(paramString), paramString.length);
    paramString = new byte[8];
    a(paramString, ((mg)localObject).c, 8);
    ...
    ((mg)localObject).a(a, i);
    ((mg)localObject).a(paramString, 8);
    a(((mg)localObject).e, ((mg)localObject).b, 16);
    localObject = ((mg)localObject).e;
    paramString = "";
    i = 0;
    while (i < 16)
    {
