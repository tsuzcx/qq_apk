...
public final class zt
{
  ...
  public static JSONArray a(Context paramContext)
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      paramContext.put(((zs)((Iterator)localObject).next()).a());
    }
    return paramContext;
  }
  
  private static List<zs> b(Context paramContext)
  {
    ...
    try
    {
      ...
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          {
            zs localzs = new zs();
            localzs.a = localPackageInfo.applicationInfo.loadLabel(paramContext).toString();
            localzs.d = localPackageInfo.packageName;
            localzs.b = localPackageInfo.versionName;
            if ((localPackageInfo.signatures != null) && (localPackageInfo.signatures.length != 0)) {
              localzs.c = a(localPackageInfo.signatures[0].toByteArray());
            }
            localArrayList.add(localzs);
          }
        }
      }
