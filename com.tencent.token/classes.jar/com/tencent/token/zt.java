  ...
  extends AsyncTask<String, Integer, Uri>
{
  ...
  public zt(ImageView paramImageView)
  {
  ...
  private static Uri a(String... paramVarArgs)
  {
    ...
    try
    {
      xb.b("path".concat(String.valueOf(paramVarArgs)));
      Object localObject1 = new StringBuilder();
      ((StringBuilder)localObject1).append(aay.b(paramVarArgs));
      ...
      localObject1 = new File(zy.a, (String)localObject2);
      if (((File)localObject1).exists())
      {
      ...
      xb.b("fromnet".concat(String.valueOf(paramVarArgs)));
      paramVarArgs = new ahr().a(paramVarArgs);
