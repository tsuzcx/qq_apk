  ...
  implements Runnable
{
  ...
  private Handler d = new aqn(this, Looper.getMainLooper());
  
  private aqm(aqj paramaqj) {}
  ...
  private void a(al paramal)
  {
    ...
    synchronized (this.a)
    {
      localaql = (aql)this.a.get(Integer.valueOf(paramal.c));
      if (localaql == null) {
        return;
      }
      ...
      try
      {
        aqj.e(this.c);
        ??? = localJceStruct;
        localJceStruct = apt.a(aqj.d(this.c).d.b().b.getBytes(), paramal.f, localaql.d);
        ??? = localJceStruct;
      ...
      paramal.d = -400;
      if (localaql.d != ???) {
        localaql.d = ((JceStruct)???);
      }
    }
  }
  
  private void a(aql paramaql, Integer paramInteger1, Integer paramInteger2)
  {
    paramaql.h.a(2);
    if (paramaql.f == null) {
      return;
    }
    int i = paramaql.e & 0x18;
    if (i != 8)
    {
      if (i != 16)
      {
        kd.a();
        ke.b(new aqo(this, paramaql, paramInteger1, paramInteger2), "shark callback");
        return;
      }
      paramaql.f.a(paramaql.g, paramaql.b, paramInteger1.intValue(), paramInteger2.intValue(), paramaql.d);
      return;
    }
    paramaql = aqj.a(this.c).obtainMessage(2, new Object[] { paramaql, paramInteger1, paramInteger2 });
    aqj.a(this.c).sendMessage(paramaql);
  }
  ...
  private void c(int paramInt)
  {
    ...
    synchronized (this.a)
    {
      ...
      while (((Iterator)???).hasNext())
      {
        ...
        try
        {
          a((aql)((Map.Entry)localObject2).getValue(), Integer.valueOf(paramInt), Integer.valueOf(-1));
        }
        catch (Exception localException)
        {
          label71:
  ...
  public final void run()
  {
    ...
    //   15: astore_3
    //   16: aload_0
    //   17: getfield 18	com/tencent/token/aqm:c	Lcom/tencent/token/aqj;
    //   20: invokestatic 103	com/tencent/token/aqj:d	(Lcom/tencent/token/aqj;)Lcom/tencent/token/aqg;
    //   23: getfield 108	com/tencent/token/aqg:d	Lcom/tencent/token/aqc;
    //   26: invokevirtual 113	com/tencent/token/aqc:b	()Lcom/tencent/token/aqd;
    //   29: astore 4
    //   31: aload_0
    //   32: invokespecial 199	com/tencent/token/aqm:a	()Ljava/util/Set;
    ...
    //   71: checkcast 82	com/tencent/token/aql
    //   74: getfield 138	com/tencent/token/aql:h	Lcom/tencent/token/agy;
    //   77: getfield 229	com/tencent/token/agy:a	Z
    //   80: ifne -38 -> 42
    //   83: aload 6
    //   85: invokeinterface 222 1 0
    //   90: checkcast 82	com/tencent/token/aql
    //   93: getfield 138	com/tencent/token/aql:h	Lcom/tencent/token/agy;
    //   96: iconst_1
    //   97: invokevirtual 142	com/tencent/token/agy:a	(I)V
    ...
    //   118: checkcast 82	com/tencent/token/aql
    //   121: getfield 168	com/tencent/token/aql:b	I
    //   124: putfield 234	com/tencent/token/ai:a	I
    //   127: aload 7
    //   129: aload 6
    //   131: invokeinterface 222 1 0
    //   136: checkcast 82	com/tencent/token/aql
    //   139: getfield 166	com/tencent/token/aql:g	I
    //   142: putfield 235	com/tencent/token/ai:b	I
    //   145: aload 7
    //   147: aload 6
    //   149: invokeinterface 222 1 0
    //   154: checkcast 82	com/tencent/token/aql
    //   157: getfield 238	com/tencent/token/aql:a	J
    ...
    //   182: checkcast 82	com/tencent/token/aql
    //   185: getfield 245	com/tencent/token/aql:c	Lcom/qq/taf/jce/JceStruct;
    //   188: ifnull +49 -> 237
    //   191: aload 4
    //   193: getfield 118	com/tencent/token/aqd:b	Ljava/lang/String;
    //   196: invokestatic 251	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   199: pop
    //   200: aload_0
    //   201: getfield 18	com/tencent/token/aqm:c	Lcom/tencent/token/aqj;
    //   204: invokestatic 100	com/tencent/token/aqj:e	(Lcom/tencent/token/aqj;)Landroid/content/Context;
    //   207: pop
    //   208: aload 7
    //   210: aload 4
    //   212: getfield 118	com/tencent/token/aqd:b	Ljava/lang/String;
    //   215: invokevirtual 124	java/lang/String:getBytes	()[B
    //   218: aload 6
    //   220: invokeinterface 222 1 0
    //   225: checkcast 82	com/tencent/token/aql
    //   228: getfield 245	com/tencent/token/aql:c	Lcom/qq/taf/jce/JceStruct;
    //   231: invokestatic 254	com/tencent/token/apt:a	([BLcom/qq/taf/jce/JceStruct;)[B
    //   234: putfield 243	com/tencent/token/ai:d	[B
    //   237: aload 6
    //   239: invokeinterface 222 1 0
    //   244: checkcast 82	com/tencent/token/aql
    //   247: getfield 257	com/tencent/token/aql:i	J
    //   250: lconst_0
    //   251: lcmp
    //   252: ifle +89 -> 341
    ...
    //   296: checkcast 82	com/tencent/token/aql
    //   299: getfield 257	com/tencent/token/aql:i	J
    ...
    //   314: pop
    //   315: aload_0
    //   316: getfield 44	com/tencent/token/aqm:d	Landroid/os/Handler;
    //   319: aload 7
    //   321: getfield 235	com/tencent/token/ai:b	I
    //   324: aload 6
    //   326: invokeinterface 222 1 0
    //   331: checkcast 82	com/tencent/token/aql
    //   334: getfield 257	com/tencent/token/aql:i	J
    ...
    //   348: goto -306 -> 42
    //   351: aload_0
    //   352: getfield 31	com/tencent/token/aqm:b	Ljava/util/ArrayList;
    ...
    //   377: checkcast 82	com/tencent/token/aql
    //   380: astore 7
    ...
    //   391: aload 6
    //   393: aload 7
    //   395: getfield 168	com/tencent/token/aql:b	I
    ...
    //   407: aload 6
    //   409: aload 7
    //   411: getfield 166	com/tencent/token/aql:g	I
    //   414: putfield 241	com/tencent/token/ai:c	I
    //   417: aload 6
    //   419: aconst_null
    //   420: putfield 243	com/tencent/token/ai:d	[B
    //   423: aload 7
    //   425: getfield 245	com/tencent/token/aql:c	Lcom/qq/taf/jce/JceStruct;
    //   428: ifnull +41 -> 469
    //   431: aload 4
    //   433: getfield 118	com/tencent/token/aqd:b	Ljava/lang/String;
    //   436: invokestatic 251	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   439: pop
    //   440: aload_0
    //   441: getfield 18	com/tencent/token/aqm:c	Lcom/tencent/token/aqj;
    //   444: invokestatic 100	com/tencent/token/aqj:e	(Lcom/tencent/token/aqj;)Landroid/content/Context;
    //   447: pop
    //   448: aload 6
    //   450: aload 4
    //   452: getfield 118	com/tencent/token/aqd:b	Ljava/lang/String;
    //   455: invokevirtual 124	java/lang/String:getBytes	()[B
    //   458: aload 7
    //   460: getfield 245	com/tencent/token/aql:c	Lcom/qq/taf/jce/JceStruct;
    //   463: invokestatic 254	com/tencent/token/apt:a	([BLcom/qq/taf/jce/JceStruct;)[B
    ...
    //   476: goto -116 -> 360
    //   479: aload_0
    //   480: getfield 18	com/tencent/token/aqm:c	Lcom/tencent/token/aqj;
    //   483: invokestatic 103	com/tencent/token/aqj:d	(Lcom/tencent/token/aqj;)Lcom/tencent/token/aqg;
    //   486: aload 4
    //   488: aload_2
    //   489: aload_3
    //   490: invokevirtual 289	com/tencent/token/aqg:a	(Lcom/tencent/token/aqd;Ljava/util/ArrayList;Ljava/util/concurrent/atomic/AtomicReference;)I
    //   493: istore_1
    //   494: iload_1
    //   495: ifne +356 -> 851
    //   498: aload_3
    ...
    //   535: invokespecial 293	com/tencent/token/aqm:a	(I)Z
    //   538: ifeq +12 -> 550
    //   541: aload_0
    //   542: aload 4
    //   544: invokespecial 191	com/tencent/token/aqm:a	(Lcom/tencent/token/al;)V
    //   547: goto -38 -> 509
    //   550: aload_0
    //   551: getfield 18	com/tencent/token/aqm:c	Lcom/tencent/token/aqj;
    //   554: invokestatic 296	com/tencent/token/aqj:f	(Lcom/tencent/token/aqj;)Ljava/util/TreeMap;
    //   557: aload 4
    ...
    //   568: ifeq +212 -> 780
    //   571: aload_0
    //   572: getfield 18	com/tencent/token/aqm:c	Lcom/tencent/token/aqj;
    //   575: invokestatic 296	com/tencent/token/aqj:f	(Lcom/tencent/token/aqj;)Ljava/util/TreeMap;
    //   578: aload 4
    ...
    //   607: ifnull +284 -> 891
    //   610: aload_0
    //   611: getfield 18	com/tencent/token/aqm:c	Lcom/tencent/token/aqj;
    //   614: invokestatic 100	com/tencent/token/aqj:e	(Lcom/tencent/token/aqj;)Landroid/content/Context;
    //   617: pop
    //   618: aload_0
    //   619: getfield 18	com/tencent/token/aqm:c	Lcom/tencent/token/aqj;
    //   622: invokestatic 103	com/tencent/token/aqj:d	(Lcom/tencent/token/aqj;)Lcom/tencent/token/aqg;
    //   625: getfield 108	com/tencent/token/aqg:d	Lcom/tencent/token/aqc;
    //   628: invokevirtual 113	com/tencent/token/aqc:b	()Lcom/tencent/token/aqd;
    //   631: getfield 118	com/tencent/token/aqd:b	Ljava/lang/String;
    ...
    //   650: invokestatic 129	com/tencent/token/apt:a	([B[BLcom/qq/taf/jce/JceStruct;)Lcom/qq/taf/jce/JceStruct;
    //   653: astore_2
    //   654: goto +3 -> 657
    //   657: aload 5
    //   659: getfield 308	android/util/Pair:second	Ljava/lang/Object;
    //   662: checkcast 310	com/tencent/token/agx
    //   665: aload 4
    ...
    //   682: aload_2
    //   683: ifnull -174 -> 509
    //   686: new 82	com/tencent/token/aql
    //   689: dup
    //   690: aload_0
    //   691: getfield 18	com/tencent/token/aqm:c	Lcom/tencent/token/aqj;
    //   694: ldc2_w 315
    //   697: aload_2
    ...
    //   715: ldc_w 317
    //   718: aconst_null
    //   719: invokespecial 320	com/tencent/token/aql:<init>	(Lcom/tencent/token/aqj;JILcom/qq/taf/jce/JceStruct;Lcom/qq/taf/jce/JceStruct;ILcom/tencent/token/agw;)V
    //   722: astore_2
    //   723: aload_2
    //   724: aload 4
    //   726: getfield 311	com/tencent/token/al:b	I
    //   729: putfield 166	com/tencent/token/aql:g	I
    //   732: aload_0
    //   733: getfield 18	com/tencent/token/aqm:c	Lcom/tencent/token/aqj;
    //   736: invokestatic 323	com/tencent/token/aqj:b	(Lcom/tencent/token/aqj;)Ljava/util/ArrayList;
    //   739: astore 4
    //   741: aload 4
    //   743: monitorenter
    //   744: aload_0
    //   745: getfield 18	com/tencent/token/aqm:c	Lcom/tencent/token/aqj;
    //   748: invokestatic 323	com/tencent/token/aqj:b	(Lcom/tencent/token/aqj;)Ljava/util/ArrayList;
    //   751: aload_2
    ...
    //   758: monitorexit
    //   759: aload_0
    //   760: getfield 18	com/tencent/token/aqm:c	Lcom/tencent/token/aqj;
    //   763: invokestatic 180	com/tencent/token/aqj:a	(Lcom/tencent/token/aqj;)Landroid/os/Handler;
    //   766: iconst_1
    ...
    //   840: aload_0
    //   841: sipush -500
    //   844: invokestatic 334	com/tencent/token/aqm:b	(I)I
    //   847: invokespecial 336	com/tencent/token/aqm:c	(I)V
    //   850: return
    //   851: aload_0
    //   852: iload_1
    //   853: invokestatic 334	com/tencent/token/aqm:b	(I)I
    //   856: invokespecial 336	com/tencent/token/aqm:c	(I)V
    //   859: return
    //   860: astore_2
    ...
    //   879: aload_0
    //   880: bipush 246
    //   882: invokespecial 336	com/tencent/token/aqm:c	(I)V
    //   885: return
    //   886: astore 7
    //   888: goto -419 -> 469
    //   891: aconst_null
