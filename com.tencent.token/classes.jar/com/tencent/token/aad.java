...
public final class aad
{
  ...
  public static String a(Context paramContext)
  {
    ...
    paramContext = null;
    xb.b("androidID =".concat(String.valueOf(paramContext)));
  ...
  public static String a(Object... paramVarArgs)
  {
    try
    {
      ...
      xb.a("plain data: ".concat(String.valueOf(paramVarArgs)));
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString)
  {
    ...
    catch (Exception paramBaseActivity)
    {
      ...
      xb.b(paramBaseActivity.toString());
    }
  }
  ...
  public static void a(IndexActivity paramIndexActivity, String paramString)
  {
    ...
    catch (Exception paramIndexActivity)
    {
      ...
      xb.b(paramIndexActivity.toString());
    }
  }
  ...
  public static String b(long paramLong)
  {
    ...
    int n = b.get(7);
    if ((i == k) && (j == m)) {
      return wx.g().getResources().getString(2131493329);
    }
    if ((i == k) && (j == m + 1)) {
      return wx.g().getResources().getString(2131493337);
    }
    if ((i == k) && (j <= m + 6))
    {
      switch (n)
      ...
      default: 
        return a(b);
      case 7: 
        return wx.g().getResources().getString(2131493335);
      case 6: 
        return wx.g().getResources().getString(2131493334);
      case 5: 
        return wx.g().getResources().getString(2131493333);
      case 4: 
        return wx.g().getResources().getString(2131493332);
      case 3: 
        return wx.g().getResources().getString(2131493331);
      case 2: 
        return wx.g().getResources().getString(2131493330);
      }
      return wx.g().getResources().getString(2131493336);
    }
    return a(b);
  }
  ...
  public static String b(Context paramContext)
  {
    ...
    paramContext = null;
    xb.b("deviceId =".concat(String.valueOf(paramContext)));
    if (paramContext == null) {
      return null;
    }
    return MD5.toMD5(paramContext);
  ...
  {
    byte[] arrayOfByte = ta.a().a;
    if ((arrayOfByte != null) && (arrayOfByte.length == 16))
    {
      paramArrayOfByte = new aaw().b(paramArrayOfByte, arrayOfByte);
      if (paramArrayOfByte == null)
      {
        xb.c("encrypt pwd failed");
        return null;
      }
      return ss.a(paramArrayOfByte);
    }
    boolean bool;
    if (arrayOfByte == null) {
      bool = true;
  ...
  public static String c(Context paramContext)
  {
    ...
    paramContext = null;
    xb.b("mac =".concat(String.valueOf(paramContext)));
    if (paramContext == null) {
      return null;
    }
    return MD5.toMD5(paramContext);
  ...
  public static String c(String paramString)
  {
    ...
    while (i < k)
    {
      ...
      if (j == 0)
      {
        ...
        localStringBuilder.append(zu.a(paramString.getBytes()));
        return localStringBuilder.toString();
      }
      i += 1;
    }
  ...
  public static String d(Context paramContext)
  {
    ...
    paramContext = null;
    xb.b("bssid =".concat(String.valueOf(paramContext)));
    if (paramContext == null) {
      return null;
    }
    return MD5.toMD5(paramContext);
  ...
  public static byte[] d(String paramString)
  {
    ...
    if ((arrayOfByte != null) && (arrayOfByte.length == 16)) {
      try
      {
        paramString = new aaw().a(ss.a(paramString), arrayOfByte);
        return paramString;
      }
      catch (Exception paramString)
      {
  ...
  public static boolean e()
  {
    ...
    try
    {
      ...
      String str = String.valueOf(ta.a().k.b().mUin);
  ...
  public static byte[] e(String paramString)
  {
    ...
    try
    {
      paramString = new aaw().a(ss.a(paramString), sc.b().a.a);
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  public static long f(long paramLong)
  {
    ...
    String str = ss.a(MD5.toMD5Byte(Long.toString(paramLong)));
  ...
  {
    // Byte code:
    //   0: new 785	java/util/ArrayList
    //   3: dup
    //   4: invokespecial 786	java/util/ArrayList:<init>	()V
    //   7: astore_0
    //   8: new 788	java/io/DataInputStream
    //   11: dup
    //   12: invokestatic 369	com/tencent/token/global/RqdApplication:n	()Landroid/content/Context;
    //   15: invokevirtual 102	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   18: invokevirtual 792	android/content/res/Resources:getAssets	()Landroid/content/res/AssetManager;
    //   21: ldc_w 794
    //   24: invokevirtual 800	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   27: invokespecial 803	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   30: astore_1
    //   31: aload_1
    //   32: invokevirtual 806	java/io/DataInputStream:readLine	()Ljava/lang/String;
    //   35: astore_2
    //   36: aload_2
    //   37: ifnull +38 -> 75
    //   40: aload_2
    ...
    //   45: if_icmple -14 -> 31
    //   48: aload_2
    //   49: invokevirtual 808	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   52: ldc_w 810
    //   55: invokevirtual 812	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   58: iflt -27 -> 31
    //   61: aload_0
    //   62: aload_2
    //   63: bipush 8
    //   65: invokevirtual 707	java/lang/String:substring	(I)Ljava/lang/String;
    //   68: invokevirtual 815	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   71: pop
    //   72: goto -41 -> 31
    //   75: aload_0
    //   76: invokevirtual 816	java/util/ArrayList:size	()I
    //   79: ifle +20 -> 99
    //   82: aload_0
    //   83: aload_0
    //   84: invokevirtual 816	java/util/ArrayList:size	()I
    //   87: iconst_1
    //   88: isub
    //   89: invokevirtual 817	java/util/ArrayList:get	(I)Ljava/lang/Object;
    ...
    //   102: astore_0
    //   103: aload_1
    //   104: invokevirtual 822	java/io/DataInputStream:close	()V
    //   107: aload_0
    //   108: areturn
    //   109: astore_0
    //   110: goto +15 -> 125
    ...
    //   118: aload_1
    //   119: invokevirtual 822	java/io/DataInputStream:close	()V
    //   122: goto +9 -> 131
    //   125: aload_1
    //   126: invokevirtual 822	java/io/DataInputStream:close	()V
    //   129: aload_0
    //   130: athrow
    //   131: ldc_w 819
    //   134: areturn
