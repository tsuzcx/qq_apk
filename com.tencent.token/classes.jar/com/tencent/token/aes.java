...
public final class aes
{
  ...
  public final void a(String paramString1, String paramString2, String paramString3, aeo[] paramArrayOfaeo)
  {
    ...
    int k = paramArrayOfaeo.length;
    int i = 0;
    while (i < k)
    {
      paramString2 = paramArrayOfaeo[i];
