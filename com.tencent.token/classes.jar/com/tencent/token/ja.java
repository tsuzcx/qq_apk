...
final class ja
{
  ...
  public static int a(Context paramContext, int paramInt)
  {
    ...
    paramContext = je.a(paramContext, null, arrayOfInt);
    try
    {
  ...
  public static ColorStateList b(Context paramContext, int paramInt)
  {
    ...
    paramContext = je.a(paramContext, null, (int[])localObject1);
    try
    {
  ...
  public static int c(Context paramContext, int paramInt)
  {
    ...
    return cy.b(paramInt, Math.round(Color.alpha(paramInt) * f1));
  }
}
