...
public class ahg
{
  ...
  private boolean a(QQUser paramQQUser, boolean paramBoolean)
  {
    ...
    if (ahh.a((ahj)localObject, "table_user", localContentValues, "uin=?", new String[] { String.valueOf(c(paramQQUser)) }) <= 0)
    {
  ...
  private boolean e()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 38	com/tencent/token/ahg:d	Z
    //   6: ifeq +12 -> 18
    //   9: aload_0
    //   10: getfield 38	com/tencent/token/ahg:d	Z
    //   13: istore_1
    //   14: aload_0
    //   15: monitorexit
    //   16: iload_1
    //   17: ireturn
    //   18: aload_0
    //   19: getfield 36	com/tencent/token/ahg:a	Ljava/util/List;
    //   22: invokeinterface 165 1 0
    //   27: aload_0
    //   28: aconst_null
    //   29: putfield 40	com/tencent/token/ahg:e	Lcom/tencent/token/core/bean/QQUser;
    //   32: new 6	com/tencent/token/ahg$a
    //   35: dup
    //   36: aload_0
    //   37: invokespecial 71	com/tencent/token/ahg$a:<init>	(Lcom/tencent/token/ahg;)V
    //   40: astore_2
    //   41: aload_2
    //   42: ldc 122
    //   44: bipush 7
    ...
    //   87: aconst_null
    //   88: aconst_null
    //   89: invokestatic 180	com/tencent/token/ahh:a	(Lcom/tencent/token/ahj;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   92: astore_2
    //   93: aload_2
    ...
    //   115: checkcast 6	com/tencent/token/ahg$a
    //   118: astore 4
    //   120: getstatic 25	com/tencent/token/ahg:c	Z
    //   123: ifne +19 -> 142
    //   126: aload 4
    //   128: ifnull +6 -> 134
    //   131: goto +11 -> 142
    ...
    //   141: athrow
    //   142: aload 4
    //   144: invokevirtual 182	com/tencent/token/ahg$a:d	()Lcom/tencent/token/core/bean/QQUser;
    //   147: astore 4
    //   149: aload 4
    //   151: getfield 152	com/tencent/token/core/bean/QQUser:mIsBinded	Z
    //   154: ifeq -54 -> 100
    //   157: aload_0
    //   158: getfield 36	com/tencent/token/ahg:a	Ljava/util/List;
    //   161: aload 4
    ...
    //   237: aload 5
    //   239: aload_0
    //   240: getfield 36	com/tencent/token/ahg:a	Ljava/util/List;
    ...
    //   257: invokestatic 120	com/tencent/token/xa:b	(Ljava/lang/String;)V
    //   260: goto -160 -> 100
    //   263: aload_2
    ...
    //   285: checkcast 6	com/tencent/token/ahg$a
    //   288: astore_3
    //   289: getstatic 25	com/tencent/token/ahg:c	Z
    //   292: ifne +18 -> 310
    //   295: aload_3
    //   296: ifnull +6 -> 302
    //   299: goto +11 -> 310
    ...
    //   309: athrow
    //   310: aload_3
    //   311: invokevirtual 182	com/tencent/token/ahg$a:d	()Lcom/tencent/token/core/bean/QQUser;
    //   314: astore_3
    //   315: aload_3
    //   316: getfield 152	com/tencent/token/core/bean/QQUser:mIsBinded	Z
    //   319: ifne -49 -> 270
    //   322: aload_0
    //   323: getfield 36	com/tencent/token/ahg:a	Ljava/util/List;
    //   326: aload_3
    ...
    //   398: aload 4
    //   400: aload_0
    //   401: getfield 36	com/tencent/token/ahg:a	Ljava/util/List;
    ...
    //   418: invokestatic 120	com/tencent/token/xa:b	(Ljava/lang/String;)V
    //   421: goto -151 -> 270
    //   424: aload_0
    //   425: iconst_1
    //   426: putfield 38	com/tencent/token/ahg:d	Z
    //   429: aload_0
    //   430: monitorexit
    //   431: iconst_1
    //   432: ireturn
    ...
    //   438: invokestatic 143	com/tencent/token/xa:c	(Ljava/lang/String;)V
    //   441: aload_0
    //   442: monitorexit
    //   443: iconst_0
    //   444: ireturn
  ...
  private boolean e(QQUser paramQQUser)
  {
    ...
    try
    {
      ahh.a((ahj)localObject, "table_user", "uin=?", new String[] { String.valueOf(c(paramQQUser)) });
      return true;
    }
  ...
  public final boolean a(long paramLong)
  {
    ...
    if (localQQUser == null)
    {
      xa.c("find user not exist with uin:".concat(String.valueOf(paramLong)));
      return false;
    }
  ...
  public final boolean a(QQUser paramQQUser)
  {
    try
    {
      ...
      while (i < this.a.size())
      {
        long l1 = ((QQUser)this.a.get(i)).mRealUin;
        long l2 = paramQQUser.mRealUin;
        if (l1 == l2) {
          return true;
        }
        i += 1;
    ...
    implements ahj
  {
    ...
    {
      a locala = new a(ahg.this);
      locala.a = paramafw.getLong(paramafw.getColumnIndex("uin"));
      locala.c = paramafw.getString(paramafw.getColumnIndex("email"));
      locala.d = paramafw.getString(paramafw.getColumnIndex("nick_name"));
      locala.e = paramafw.getString(paramafw.getColumnIndex("uin_mask"));
      locala.g = paramafw.getBlob(paramafw.getColumnIndex("head_image"));
      locala.h = paramafw.getLong(paramafw.getColumnIndex("head_image_update_time"));
      long l1 = paramafw.getLong(paramafw.getColumnIndex("flag"));
      int n = 0;
      boolean bool;
      if ((1L & l1) != 0L) {
        bool = true;
      ...
      paramafw = locala.g;
      if ((paramafw != null) && (paramafw.length >= 64) && (paramafw[0] == wu.a[0]) && (paramafw[1] == wu.a[1]) && (paramafw[2] == wu.a[2]) && (paramafw[3] == wu.a[3]))
      {
        byte[] arrayOfByte = new byte[60];
        System.arraycopy(paramafw, 4, arrayOfByte, 0, 60);
        while ((n < 60) && (arrayOfByte[n] == 0))
        {
          arrayOfByte[n] = 48;
          n += 1;
        }
        paramafw = new String(arrayOfByte);
      }
      try
      {
        locala.b = Long.parseLong(paramafw);
        return locala;
      }
      catch (Exception paramafw)
      {
        label416:
        break label416;
      }
    ...
    public final long b(SQLiteDatabase paramSQLiteDatabase)
    {
      if (!this.j)
      {
        ...
        System.arraycopy(wu.a, 0, this.g, 0, wu.a.length);
