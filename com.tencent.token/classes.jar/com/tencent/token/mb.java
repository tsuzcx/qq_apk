...
public final class mb
  implements ly
{
  public final lz a(String paramString1, String paramString2, String paramString3, String paramString4, ma paramma)
  {
    String str1 = "";
    if (TextUtils.isEmpty(paramString2)) {
      str1 = "url is empty.";
    } else if (paramma == null) {
      str1 = "listener is null.";
    }
    String str2 = paramString3;
    if (lx.a(paramString3)) {
      str2 = le.g();
    }
    if ("".equals(str1))
    {
      paramString2 = new mq(paramString2);
      if (!TextUtils.isEmpty(null))
      {
        paramString2.c = new a(null, a.a.g);
        paramString2.c.c = paramString2.e.getAndIncrement();
      }
      return new mr(paramString1, paramString2, str2, paramString4, paramma);
    }
  ...
  {
    // Byte code:
    //   0: invokestatic 89	com/tencent/token/me:b	()Lcom/tencent/token/me;
    //   3: astore 4
    //   5: ldc 15
    //   7: astore_3
    //   8: aload_1
    ...
    //   19: goto +280 -> 299
    //   22: aload_1
    //   23: checkcast 76	com/tencent/token/mr
    //   26: astore 5
    //   28: aload 4
    //   30: monitorenter
    //   31: aload 5
    //   33: getfield 93	com/tencent/token/mr:k	Ljava/lang/String;
    //   36: invokestatic 30	com/tencent/token/lx:a	(Ljava/lang/String;)Z
    //   39: ifeq +10 -> 49
    //   42: aload 5
    //   44: ldc 15
    //   46: putfield 93	com/tencent/token/mr:k	Ljava/lang/String;
    //   49: aload_3
    //   50: astore_2
    //   51: aload 5
    //   53: getfield 93	com/tencent/token/mr:k	Ljava/lang/String;
    //   56: invokestatic 95	com/tencent/token/le:c	(Ljava/lang/String;)Z
    //   59: ifeq +157 -> 216
    //   62: aload 4
    //   64: invokevirtual 99	com/tencent/token/me:d	()Ljava/util/List;
    ...
    //   90: checkcast 117	com/tencent/token/lz
    //   93: astore_1
    //   94: aload 5
    //   96: getfield 120	com/tencent/token/mr:j	Ljava/lang/String;
    //   99: aload_1
    //   100: invokeinterface 123 1 0
    //   105: invokevirtual 126	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   108: ifeq -35 -> 73
    //   111: aload 5
    //   113: getfield 93	com/tencent/token/mr:k	Ljava/lang/String;
    //   116: astore 6
    //   118: aload_1
    //   119: checkcast 76	com/tencent/token/mr
    //   122: getfield 93	com/tencent/token/mr:k	Ljava/lang/String;
    //   125: invokestatic 95	com/tencent/token/le:c	(Ljava/lang/String;)Z
    //   128: ifeq +13 -> 141
    //   131: aload_1
    ...
    //   167: aload_1
    //   168: aload 5
    //   170: getfield 120	com/tencent/token/mr:j	Ljava/lang/String;
    ...
    //   184: aload_1
    //   185: aload 5
    //   187: getfield 93	com/tencent/token/mr:k	Ljava/lang/String;
    ...
    //   213: goto +89 -> 302
    //   216: aload 4
    //   218: getfield 148	com/tencent/token/me:a	Ljava/util/Vector;
    //   221: astore_1
    //   222: aload_1
    //   223: monitorenter
    //   224: aload 4
    //   226: getfield 148	com/tencent/token/me:a	Ljava/util/Vector;
    //   229: aload 5
    ...
    //   236: monitorexit
    //   237: aload 5
    //   239: invokevirtual 156	com/tencent/token/mr:r	()V
    //   242: aload_2
    //   243: astore_1
    //   244: goto -34 -> 210
    //   247: astore_1
    ...
    //   256: astore_1
    //   257: aload 4
    //   259: getfield 148	com/tencent/token/me:a	Ljava/util/Vector;
    //   262: astore_2
    //   263: aload_2
    //   264: monitorenter
    //   265: aload 4
    //   267: getfield 148	com/tencent/token/me:a	Ljava/util/Vector;
    //   270: aload 5
  ...
  public final void b(lz paramlz)
  {
    ...
    if (paramlz != null)
    {
      ...
      ((StringBuilder)???).append(paramlz.c());
      lo.b("TaskManager", ((StringBuilder)???).toString());
      mr localmr = (mr)paramlz;
      if (!localmr.u())
      {
        if (!localmr.t())
        {
        ...
        localmr.D = true;
        localmr.a(true, 0, "", DownloaderTaskStatus.DELETED);
      }
      synchronized (localme.a)
      {
        localme.a.remove(paramlz);
        localme.a(localmr, 3);
        if (localme.e())
        {
          localme.b.a();
 ...
 * Qualified Name:     com.tencent.token.mb
