...
final class qo
{
  ...
  private PhoneStateListener d = new qp(this);
  ...
  public static List<qn.a> a(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      localLinkedList.add(new qn.a(paramContext, localObject2, String.valueOf(j), String.valueOf(i), (String)localObject3, "gsm", "", "", ""));
      label218:
      ...
      if ((localObject4 != null) && (((List)localObject4).size() > 0))
      {
        ...
        while (((Iterator)localObject4).hasNext())
        {
          ...
          if (((NeighboringCellInfo)localObject5).getCid() != -1)
          {
            ...
            localLinkedList.add(new qn.a(paramContext, localObject2, "", ((StringBuilder)localObject6).toString(), "", "gsm", "", "", ""));
          }
        }
      }
      return localLinkedList;
