...
public class qo
{
  ...
  private qo(Context paramContext)
  {
    this.c = paramContext;
    ...
    paramContext.registerReceiver(new BroadcastReceiver()
    {
      public final void onReceive(Context paramAnonymousContext, Intent paramAnonymousIntent)
      {
        ...
        {
          paramAnonymousContext = qo.this;
          paramAnonymousIntent = qq.a.a();
          qo.a(qo.this);
          qo.b(qo.this);
          qo.a(paramAnonymousContext, paramAnonymousIntent.a("tj"));
        }
      }
    }, localIntentFilter);
  }
  
  public static qo a(Context paramContext)
  {
    if (b == null) {
      try
      {
        if (b == null) {
          b = new qo(paramContext);
        }
      }
      finally {}
    }
