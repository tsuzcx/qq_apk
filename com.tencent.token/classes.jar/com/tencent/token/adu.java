...
public final class adu
{
  ...
  public static String a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    localStringBuilder.append((String)localObject1);
    localObject1 = adq.a;
    localObject1 = adq.b(paramContext);
    ...
    Object localObject2 = adj.a(paramContext, "204");
    localObject1 = localObject2;
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      localObject2 = aev.a("0_");
      if (paramBoolean1) {
        localObject1 = "1";
      } else {
        localObject1 = "0";
    ...
    localStringBuilder.append(adj.a(paramContext));
    paramContext = adj.a(paramContext, "111");
