  ...
  extends BaseAdapter
{
  ...
  public xq(AbnormalLoginActivity paramAbnormalLoginActivity)
  {
  ...
  public final View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (localSafeMsgItem1 != null)
    {
      ...
      else
      {
        ...
        if ((localSafeMsgItem2 != null) && (!aad.a(localSafeMsgItem2.mTime * 1000L, localSafeMsgItem1.mTime * 1000L)))
        {
          localRelativeLayout3.setVisibility(0);
      ...
      localTextView5.setText(aad.d(localSafeMsgItem1.mTime * 1000L));
      paramViewGroup = aad.b(localSafeMsgItem1.mTime * 1000L);
