  ...
  extends aiw
{
  ...
  aix(SQLiteDatabase paramSQLiteDatabase, String paramString, Object[] paramArrayOfObject, aje paramaje)
  {
    super(paramSQLiteDatabase, paramString, paramArrayOfObject, paramaje);
    this.g = paramaje;
  }
  ...
  final int a(com.tencent.wcdb.CursorWindow paramCursorWindow, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 23	com/tencent/token/aix:d	()V
    //   4: aload_1
    //   5: invokevirtual 26	com/tencent/wcdb/CursorWindow:d	()V
    //   8: aload_0
    //   9: getfield 29	com/tencent/token/aiw:a	Lcom/tencent/wcdb/database/SQLiteDatabase;
    //   12: invokevirtual 35	com/tencent/wcdb/database/SQLiteDatabase:b	()Lcom/tencent/token/aiz;
    //   15: aload_0
    //   16: getfield 38	com/tencent/token/aiw:b	Ljava/lang/String;
    //   19: aload_0
    //   20: getfield 42	com/tencent/token/aiw:e	[Ljava/lang/Object;
    //   23: aload_1
    //   24: iload_2
    //   25: iload_3
    //   26: iload 4
    //   28: aload_0
    //   29: getfield 46	com/tencent/token/aiw:c	Z
    //   32: invokestatic 49	com/tencent/wcdb/database/SQLiteDatabase:a	(Z)I
    //   35: aload_0
    //   36: getfield 12	com/tencent/token/aix:g	Lcom/tencent/token/aje;
    //   39: invokevirtual 54	com/tencent/token/aiz:a	(Ljava/lang/String;[Ljava/lang/Object;Lcom/tencent/wcdb/CursorWindow;IIZILcom/tencent/token/aje;)I
    //   42: istore_2
    //   43: aload_1
    //   44: invokevirtual 56	com/tencent/wcdb/CursorWindow:e	()V
    //   47: aload_0
    //   48: invokevirtual 57	com/tencent/token/aix:e	()V
    //   51: iload_2
    //   52: ireturn
    //   53: astore 5
    //   55: goto +67 -> 122
    ...
    //   90: aload 6
    //   92: aload_0
    //   93: getfield 38	com/tencent/token/aiw:b	Ljava/lang/String;
    ...
    //   113: astore 5
    //   115: aload_0
    //   116: invokevirtual 86	com/tencent/token/aix:a	()V
    //   119: aload 5
    //   121: athrow
    //   122: aload_1
    ...
    //   129: astore_1
    //   130: aload_0
    //   131: invokevirtual 57	com/tencent/token/aix:e	()V
    //   134: aload_1
    //   135: athrow
