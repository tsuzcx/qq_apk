  ...
  extends BitmapDrawable
{
  ...
  public static Map<String, zy> d;
  public static Map<String, String> e;
  public static boolean f = false;
  private static boolean h;
  private BitmapDrawable g;
  
  private zy(final String paramString1, final String paramString2)
  {
    this.g = new BitmapDrawable(a);
    new UserTask() {}.a(new String[] { "" });
  }
  
  private zy(final String paramString1, final String paramString2, final String paramString3, Bitmap paramBitmap)
  {
  ...
  public static BitmapDrawable a(String paramString1, String paramString2)
  {
    ...
    if (paramString2 != null)
    {
      xa.a("face:from cache");
      localObject = a(paramString1, (String)localObject, paramString2);
      if (localObject != null) {
        return localObject;
      }
      xa.b("from memcache".concat(String.valueOf(paramString1)));
    ...
    if (paramString2 != null)
    {
      ...
      xa.b("from cache,don't update".concat(String.valueOf(paramString1)));
      return new BitmapDrawable(paramString2);
    }
    if ((paramString1 != null) && (paramString1.length() > 4))
    {
      paramString2 = (zy)d.get(paramString1);
      if (paramString2 != null)
      {
        xa.b("from loading task".concat(String.valueOf(paramString1)));
        return paramString2;
      }
      xa.b("from new task".concat(String.valueOf(paramString1)));
      paramString2 = new zy(paramString1, (String)localObject);
  ...
  private static BitmapDrawable a(String paramString1, String paramString2, Bitmap paramBitmap)
  {
    ...
    {
      zy localzy = (zy)d.get(paramString1);
      if (localzy != null) {
        return localzy;
      }
      paramString2 = new zy(paramString1, paramString2, str, paramBitmap);
      d.put(paramString1, paramString2);
      return paramString2;
    }
    return null;
  ...
  private static void a()
  {
    if (!h)
    {
      ...
      a = aad.a(localResources, 2131099813);
      b = aad.a(localResources, 2131099767);
  ...
  private static boolean a(Map<String, String> paramMap)
  {
    ...
    Object localObject = new ahf();
    try
    {
      localObject = ahh.a((ahj)localObject, "qqface", new String[] { "uinhash", "filename" }, null, null, null, null).iterator();
      while (((Iterator)localObject).hasNext())
      {
        ahf localahf = (ahf)((Iterator)localObject).next();
        if (localahf == null) {
          break;
        }
        paramMap.put(localahf.a, localahf.b);
      }
      return true;
    }
  ...
  public static BitmapDrawable b(String paramString1, String paramString2)
  {
    ...
    xa.b("from new task".concat(String.valueOf(paramString1)));
    paramString2 = new zy(paramString1, str);
    d.put(paramString1, paramString2);
    return paramString2;
    label120:
    return new BitmapDrawable(a);
