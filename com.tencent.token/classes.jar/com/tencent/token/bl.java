  ...
  implements bk
{
  ...
  private bl(Context paramContext, String paramString, SQLiteDatabase.CursorFactory paramCursorFactory, int paramInt)
  {
  ...
  private boolean a(String paramString, bi parambi, long paramLong)
  {
    boolean bool1 = true;
    for (;;)
    {
      ...
      catch (Exception paramString)
      {
        ...
        localContentValues.put("iplist", parambi.d());
        localContentValues.put("schedule_lasttime", Long.valueOf(parambi.b()));
        localContentValues.put("apn_lasttime", Long.valueOf(paramLong));
        localContentValues.put("rule", parambi.e());
        i = localSQLiteDatabase.update("access_tbl", localContentValues, "apn=? and domain=?", new String[] { paramString, parambi.a() });
        if (i == 0)
        {
          localContentValues.put("apn", paramString);
          localContentValues.put("domain", parambi.a());
          localContentValues.put("rule", parambi.e());
          paramLong = localSQLiteDatabase.insert("access_tbl", null, localContentValues);
          c.b("DataAccessDBImpl", "insert record...ret:" + paramLong + ",apnName:" + paramString + ",domain:" + parambi.a() + ",ip:" + parambi.d());
          if (-1L != paramLong) {
            continue;
          }
        }
        ...
        {
          c.b("DataAccessDBImpl", "update record...ret:" + i + ",apnName:" + paramString + ",domain:" + parambi.a() + ",ip:" + parambi.d());
        }
      }
      finally {}
    }
  ...
  private static void b(SQLiteDatabase paramSQLiteDatabase)
  {
    try
    {
      ...
      c.b("DataAccessDBImpl", "db created.");
      return;
    }
    catch (SQLException paramSQLiteDatabase)
    {
  ...
  public final bh a(String paramString)
  {
    label269:
    label291:
    for (;;)
    {
      ...
      finally
      {
        ...
        try
        {
          ...
          paramString = new bh(paramString);
          ...
          paramString.a(new bi((String)localObject, l, str1, str3, str2));
  ...
  public final void a(bh parambh)
  {
    ...
    //   10: return
    //   11: aload_1
    //   12: invokevirtual 226	com/tencent/token/bh:a	()Ljava/util/Map;
    //   15: astore 6
    ...
    //   52: checkcast 100	com/tencent/token/bi
    //   55: astore 7
    //   57: aload_0
    //   58: aload_1
    //   59: invokevirtual 253	com/tencent/token/bh:b	()Ljava/lang/String;
    //   62: aload 7
    //   64: lload_3
    //   65: invokespecial 255	com/tencent/token/bl:a	(Ljava/lang/String;Lcom/tencent/token/bi;J)Z
    //   68: istore 5
    //   70: iload 5
    //   72: ifeq +280 -> 352
    //   75: iconst_1
    ...
    //   84: ldc 150
    //   86: ldc_w 257
    //   89: invokestatic 260	com/tencent/halley/common/c:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   92: aload_0
    //   93: invokevirtual 77	com/tencent/token/bl:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   96: astore 7
    //   98: aload 7
    ...
    //   173: invokestatic 269	com/tencent/token/bm:a	()Lcom/tencent/token/bm;
    //   176: getfield 272	com/tencent/token/bm:b	Lcom/tencent/token/bp;
    //   179: getfield 277	com/tencent/token/bp:c	I
    ...
    //   238: invokestatic 260	com/tencent/halley/common/c:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   241: aload_1
    //   242: ifnull +9 -> 251
    //   245: aload_1
    ...
    //   308: invokestatic 260	com/tencent/halley/common/c:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   311: goto -303 -> 8
    //   314: astore_1
    //   315: aload_0
    //   316: monitorexit
  ...
  public final void onCreate(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    catch (Exception paramSQLiteDatabase)
    {
      ...
      c.a("DataAccessDBImpl", "db create failed.", paramSQLiteDatabase);
    }
  }
  ...
  public final void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   17: if_icmpge +12 -> 29
    //   20: aload_1
    //   21: invokestatic 309	com/tencent/token/bl:a	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   24: aload_1
    //   25: invokestatic 311	com/tencent/token/bl:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   28: return
    //   29: iload_2
    //   30: bipush 7
    //   32: if_icmple -4 -> 28
    //   35: aload_1
    //   36: invokestatic 309	com/tencent/token/bl:a	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   39: aload_1
    //   40: invokestatic 311	com/tencent/token/bl:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   43: return
    //   44: astore_1
    //   45: return
    //   46: astore_1
