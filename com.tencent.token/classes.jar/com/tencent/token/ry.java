...
public final class ry
{
  ...
  public WtloginListener i = new WtloginListener()
  {
    private void a(int paramAnonymousInt, ErrMsg arg2, String paramAnonymousString, long paramAnonymousLong)
    {
      ...
      {
        ry.this.f.a(paramAnonymousInt, ???.getMessage(), ???.getMessage());
        ry.this.f.d = ???;
      }
      else
      {
        ??? = ry.b(ry.this).GetLocalTicket(paramAnonymousString, paramAnonymousLong, 64);
        if ((ry.this.f != null) && (??? != null))
        {
          ry.this.f.d = ???._sig;
          ry.this.f.a = 0;
        }
    ...
    public final void OnCheckPictureAndGetSt(String paramAnonymousString, byte[] arg2, WUserSigInfo paramAnonymousWUserSigInfo, int paramAnonymousInt, ErrMsg paramAnonymousErrMsg)
    {
      int i = ry.e(ry.this);
      ry.f(ry.this);
      synchronized (ry.g(ry.this))
      {
        ry.h(ry.this).cancel();
        if (ry.a(ry.this) == null)
        {
          xa.c("onCheckPictureAndGetSt, handler is null");
          return;
        }
        paramAnonymousWUserSigInfo = ry.a(ry.this).obtainMessage(4099);
        ...
        {
          if (i != 0) {
            paramAnonymousString = ry.b(ry.this).GetLocalTicket(paramAnonymousString, ry.j(ry.this), i);
          } else {
            paramAnonymousString = ry.b(ry.this).GetLocalTicket(paramAnonymousString, ry.j(ry.this), 64);
          }
          if (paramAnonymousString != null)
          {
            paramAnonymousWUserSigInfo.obj = paramAnonymousString._sig;
            paramAnonymousString = new Bundle();
            paramAnonymousString.putLong("appid", ry.j(ry.this));
            paramAnonymousWUserSigInfo.setData(paramAnonymousString);
          }
        }
        ry.a(ry.this).sendMessage(paramAnonymousWUserSigInfo);
        ry.c(ry.this);
        return;
      }
    }
    ...
    public final void OnCloseCode(String arg1, byte[] paramAnonymousArrayOfByte1, long paramAnonymousLong, WUserSigInfo paramAnonymousWUserSigInfo, byte[] paramAnonymousArrayOfByte2, int paramAnonymousInt)
    {
      synchronized (ry.g(ry.this))
      {
        ...
        if (ry.a(ry.this) == null)
        {
          xa.c("onCloseCode, handler is null");
          return;
        }
        paramAnonymousWUserSigInfo = ry.a(ry.this).obtainMessage(4102);
        paramAnonymousWUserSigInfo.arg1 = paramAnonymousInt;
    ...
    public final void OnException(ErrMsg paramAnonymousErrMsg, int paramAnonymousInt, WUserSigInfo arg3)
    {
      ...
      synchronized (ry.g(ry.this))
      {
        ...
        if (ry.a(ry.this) == null)
        {
          xa.c("onVerifyCode, handler is null");
          return;
        }
        Message localMessage = ry.a(ry.this).obtainMessage(4104);
        localMessage.arg1 = paramAnonymousInt;
        Bundle localBundle = new Bundle();
        localBundle.putString("exception", paramAnonymousErrMsg.getMessage());
        localMessage.setData(localBundle);
        ry.a(ry.this).sendMessage(localMessage);
        ry.c(ry.this);
        return;
      }
    }
    ...
    {
      paramAnonymousInt1 = ry.e(ry.this);
      ry.f(ry.this);
      synchronized (ry.g(ry.this))
      {
        ry.h(ry.this).cancel();
        ...
        if (ry.a(ry.this) == null)
        {
          xa.c("onGetStWithPasswd, handler is null");
          return;
        }
        ...
        xa.c(paramAnonymousWUserSigInfo.toString());
        paramAnonymousWUserSigInfo = new StringBuilder();
        paramAnonymousWUserSigInfo.append(this);
        ...
        paramAnonymousWUserSigInfo.append(paramAnonymousLong1);
        xa.c(paramAnonymousWUserSigInfo.toString());
        paramAnonymousWUserSigInfo = ry.a(ry.this).obtainMessage(4098);
        ...
        else
        {
          if (paramAnonymousInt1 != 0) {
            paramAnonymousString1 = ry.b(ry.this).GetLocalTicket(paramAnonymousString1, ry.j(ry.this), paramAnonymousInt1);
          } else {
            paramAnonymousString1 = ry.b(ry.this).GetLocalTicket(paramAnonymousString1, ry.j(ry.this), 64);
          }
    ...
    public final void OnGetStWithoutPasswd(String paramAnonymousString, long paramAnonymousLong1, long paramAnonymousLong2, int paramAnonymousInt1, long paramAnonymousLong3, WUserSigInfo arg9, int paramAnonymousInt2, ErrMsg paramAnonymousErrMsg)
    {
      ...
      synchronized (ry.g(ry.this))
      {
        ...
        if (ry.a(ry.this) == null)
        {
          xa.c("onGetStWithoutPasswd, handler is null");
          return;
        }
        ...
        ((StringBuilder)localObject).append(paramAnonymousLong1);
        xa.c(((StringBuilder)localObject).toString());
        localObject = ry.a(ry.this).obtainMessage(4097);
        ...
        {
          if (paramAnonymousInt1 != 0) {
            paramAnonymousString = ry.b(ry.this).GetLocalTicket(paramAnonymousString, paramAnonymousLong1, paramAnonymousInt1);
          } else {
            paramAnonymousString = ry.b(ry.this).GetLocalTicket(paramAnonymousString, paramAnonymousLong1, 64);
          }
          if (paramAnonymousString != null) {
            ((Message)localObject).obj = paramAnonymousString._sig;
          }
        }
        ry.a(ry.this).sendMessage((Message)localObject);
        ry.c(ry.this);
        return;
      }
    }
    ...
    {
      xa.b("Wtlogin init result ".concat(String.valueOf(paramAnonymousInt)));
    }
    ...
    public final void OnRefreshPictureData(String arg1, WUserSigInfo paramAnonymousWUserSigInfo, byte[] paramAnonymousArrayOfByte, int paramAnonymousInt, ErrMsg paramAnonymousErrMsg)
    {
      synchronized (ry.g(ry.this))
      {
        ...
        if (ry.a(ry.this) == null)
        {
          xa.c("onRefreshPictureData, handler is null");
          return;
        }
        paramAnonymousWUserSigInfo = ry.a(ry.this).obtainMessage(4100);
        paramAnonymousWUserSigInfo.arg1 = paramAnonymousInt;
        if (paramAnonymousInt != 0)
        {
    ...
    public final void OnVerifyCode(String arg1, byte[] paramAnonymousArrayOfByte1, long paramAnonymousLong, List<byte[]> paramAnonymousList, WUserSigInfo paramAnonymousWUserSigInfo, byte[] paramAnonymousArrayOfByte2, int paramAnonymousInt)
    {
      synchronized (ry.g(ry.this))
      {
        ...
        paramAnonymousList = ry.a(ry.this).obtainMessage(4101);
        ...
        ry.a(ry.this).sendMessage(paramAnonymousList);
        ry.c(ry.this);
        return;
      }
    }
      ...
      for (;;)
      {
        try
        {
          ...
          if (ry.a(ry.this) != null)
          {
            ...
            xa.a(paramAnonymousErrMsg.toString());
            if (paramAnonymousInt != 0)
            {
              if (true == util.shouldKick(paramAnonymousInt)) {
                ry.b(ry.this).ClearUserLoginData(paramAnonymousString, 523005419L);
              }
            }
            else
            {
              paramAnonymousQuickLoginParam = ry.a(paramAnonymousQuickLoginParam.userSigInfo);
              if (ry.a(ry.this) != null)
              {
                paramAnonymousErrMsg = ry.a(ry.this).obtainMessage(4109);
                ...
                ry.a(ry.this).sendMessage(paramAnonymousErrMsg);
                ry.c(ry.this);
              }
            }
            return;
  ...
  private ry(Context paramContext)
  {
  ...
  public static ry a(Context paramContext)
  {
    if (k == null) {
      k = new ry(paramContext);
    }
    return k;
  }
  ...
  public final int a(Activity paramActivity, Handler paramHandler)
  {
    try
    {
      this.a.quickLogin(paramActivity, 523005419L, this.n, aaa.b, b());
      this.b = paramHandler;
    }
  ...
  public final int a(Activity paramActivity, Handler paramHandler, String paramString)
  {
    try
    {
      ...
      this.a.quickLogin(paramActivity, 523005419L, this.n, aaa.b, localQuickLoginParam);
      this.b = paramHandler;
    }
    catch (Exception paramActivity)
    {
    ...
    try
    {
      ...
      if (localHandler == null)
      {
        ...
        this.c.schedule(new TimerTask()
        {
          ...
          {
            ry.this.i.OnGetStWithoutPasswd(null, 0L, 0L, 0, 0L, null, 8192, new ErrMsg());
          }
        }, 30000L);
        return 0;
      }
    ...
    if (this.b == null)
    {
      ...
      try
      {
        this.c.schedule(new TimerTask()
        {
          public final void run()
          {
            ry.this.i.OnVerifyCode(null, null, 0L, null, new WUserSigInfo(), null, 8192);
          }
        }, 30000L);
        return 0;
      }
    ...
    if (this.b == null)
    {
      ...
      try
      {
        this.c.schedule(new TimerTask()
        {
          public final void run()
          {
            ry.this.i.OnCloseCode(null, null, 0L, new WUserSigInfo(), null, 8192);
          }
        }, 30000L);
      }
