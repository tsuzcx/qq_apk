...
public class ajr
{
  ...
  private boolean a(QQUser paramQQUser, boolean paramBoolean)
  {
    ...
    if (ajs.a((aju)localObject, "table_user", localContentValues, "uin=?", new String[] { String.valueOf(c(paramQQUser)) }) <= 0)
    {
  ...
  private boolean e()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 38	com/tencent/token/ajr:d	Z
    //   6: ifeq +12 -> 18
    //   9: aload_0
    //   10: getfield 38	com/tencent/token/ajr:d	Z
    //   13: istore_1
    //   14: aload_0
    //   15: monitorexit
    //   16: iload_1
    //   17: ireturn
    //   18: aload_0
    //   19: getfield 36	com/tencent/token/ajr:a	Ljava/util/List;
    //   22: invokeinterface 165 1 0
    //   27: aload_0
    //   28: aconst_null
    //   29: putfield 40	com/tencent/token/ajr:e	Lcom/tencent/token/core/bean/QQUser;
    //   32: new 6	com/tencent/token/ajr$a
    //   35: dup
    //   36: aload_0
    //   37: invokespecial 71	com/tencent/token/ajr$a:<init>	(Lcom/tencent/token/ajr;)V
    //   40: astore_2
    //   41: aload_2
    //   42: ldc 122
    //   44: bipush 7
    ...
    //   87: aconst_null
    //   88: aconst_null
    //   89: invokestatic 180	com/tencent/token/ajs:a	(Lcom/tencent/token/aju;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   92: astore_2
    //   93: aload_2
    ...
    //   115: checkcast 6	com/tencent/token/ajr$a
    //   118: astore 4
    //   120: getstatic 25	com/tencent/token/ajr:c	Z
    //   123: ifne +19 -> 142
    //   126: aload 4
    //   128: ifnull +6 -> 134
    //   131: goto +11 -> 142
    ...
    //   141: athrow
    //   142: aload 4
    //   144: invokevirtual 182	com/tencent/token/ajr$a:d	()Lcom/tencent/token/core/bean/QQUser;
    //   147: astore 4
    //   149: aload 4
    //   151: getfield 152	com/tencent/token/core/bean/QQUser:mIsBinded	Z
    //   154: ifeq -54 -> 100
    //   157: aload_0
    //   158: getfield 36	com/tencent/token/ajr:a	Ljava/util/List;
    //   161: aload 4
    ...
    //   237: aload 5
    //   239: aload_0
    //   240: getfield 36	com/tencent/token/ajr:a	Ljava/util/List;
    ...
    //   257: invokestatic 120	com/tencent/token/xv:b	(Ljava/lang/String;)V
    //   260: goto -160 -> 100
    //   263: aload_2
    ...
    //   285: checkcast 6	com/tencent/token/ajr$a
    //   288: astore_3
    //   289: getstatic 25	com/tencent/token/ajr:c	Z
    //   292: ifne +18 -> 310
    //   295: aload_3
    //   296: ifnull +6 -> 302
    //   299: goto +11 -> 310
    ...
    //   309: athrow
    //   310: aload_3
    //   311: invokevirtual 182	com/tencent/token/ajr$a:d	()Lcom/tencent/token/core/bean/QQUser;
    //   314: astore_3
    //   315: aload_3
    //   316: getfield 152	com/tencent/token/core/bean/QQUser:mIsBinded	Z
    //   319: ifne -49 -> 270
    //   322: aload_0
    //   323: getfield 36	com/tencent/token/ajr:a	Ljava/util/List;
    //   326: aload_3
    ...
    //   398: aload 4
    //   400: aload_0
    //   401: getfield 36	com/tencent/token/ajr:a	Ljava/util/List;
    ...
    //   418: invokestatic 120	com/tencent/token/xv:b	(Ljava/lang/String;)V
    //   421: goto -151 -> 270
    //   424: aload_0
    //   425: iconst_1
    //   426: putfield 38	com/tencent/token/ajr:d	Z
    //   429: aload_0
    //   430: monitorexit
    //   431: iconst_1
    //   432: ireturn
    ...
    //   438: invokestatic 143	com/tencent/token/xv:c	(Ljava/lang/String;)V
    //   441: aload_0
    //   442: monitorexit
    //   443: iconst_0
    //   444: ireturn
  ...
  private boolean e(QQUser paramQQUser)
  {
    ...
    try
    {
      ajs.a((aju)localObject, "table_user", "uin=?", new String[] { String.valueOf(c(paramQQUser)) });
      return true;
    }
  ...
  public final boolean a(long paramLong)
  {
    ...
    if (localQQUser == null)
    {
      xv.c("find user not exist with uin:".concat(String.valueOf(paramLong)));
      return false;
    }
    ...
    implements aju
  {
    ...
    {
      a locala = new a(ajr.this);
      locala.a = paramaii.getLong(paramaii.getColumnIndex("uin"));
      locala.c = paramaii.getString(paramaii.getColumnIndex("email"));
      locala.d = paramaii.getString(paramaii.getColumnIndex("nick_name"));
      locala.e = paramaii.getString(paramaii.getColumnIndex("uin_mask"));
      locala.g = paramaii.getBlob(paramaii.getColumnIndex("head_image"));
      locala.h = paramaii.getLong(paramaii.getColumnIndex("head_image_update_time"));
      long l1 = paramaii.getLong(paramaii.getColumnIndex("flag"));
      int n = 0;
      boolean bool;
      if ((1L & l1) != 0L) {
        bool = true;
      ...
      paramaii = locala.g;
      if ((paramaii != null) && (paramaii.length >= 64) && (paramaii[0] == xp.a[0]) && (paramaii[1] == xp.a[1]) && (paramaii[2] == xp.a[2]) && (paramaii[3] == xp.a[3]))
      {
        byte[] arrayOfByte = new byte[60];
        System.arraycopy(paramaii, 4, arrayOfByte, 0, 60);
        while ((n < 60) && (arrayOfByte[n] == 0))
        {
          arrayOfByte[n] = 48;
          n += 1;
        }
        paramaii = new String(arrayOfByte);
      }
      try
      {
        locala.b = Long.parseLong(paramaii);
        return locala;
      }
      catch (Exception paramaii)
      {
        label416:
        break label416;
      }
