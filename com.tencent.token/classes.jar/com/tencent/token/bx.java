  ...
  extends cv
{
  ...
  public static void a(Activity paramActivity, cs paramcs)
  {
    ...
    if ((paramActivity instanceof a)) {
      new Handler(Looper.getMainLooper()).post(new Runnable()
      {
        public final void run()
        {
          ...
          ((bx.a)paramActivity).onRequestPermissionsResult(paramInt, this.a, arrayOfInt);
        }
      });
    }
  }
  ...
  public static void b(Activity paramActivity, cs paramcs)
  {
    int i = Build.VERSION.SDK_INT;
    Object localObject2 = null;
    Object localObject1 = null;
    ...
    extends SharedElementCallback
  {
    ...
    public Parcelable onCaptureSharedElementSnapshot(View paramView, Matrix paramMatrix, RectF paramRectF)
    {
      ...
      if ((paramView instanceof ImageView))
      {
        ...
        {
          localObject2 = cs.a((Drawable)localObject2);
      ...
      if (j > 0)
      {
        ...
        if (i > 0)
        {
          float f = Math.min(1.0F, cs.b / (j * i));
          j = (int)(j * f);
          i = (int)(i * f);
          if (localcs.a == null) {
            localcs.a = new Matrix();
          }
          localcs.a.set(paramMatrix);
          localcs.a.postTranslate(-paramRectF.left, -paramRectF.top);
          localcs.a.postScale(f, f);
          localObject1 = Bitmap.createBitmap(j, i, Bitmap.Config.ARGB_8888);
          paramMatrix = new Canvas((Bitmap)localObject1);
          paramMatrix.concat(localcs.a);
    ...
    {
      return cs.a(paramContext, paramParcelable);
    }
