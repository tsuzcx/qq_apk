...
public final class aaz
{
  ...
  public static Bitmap b(String paramString, int paramInt)
  {
    ...
    xv.c("BitmapFactory.decodeFile failed...");
    return null;
  }
  ...
  public static void b(long paramLong)
  {
    try
    {
      sw.a();
      RqdApplication.n();
      SharedPreferences.Editor localEditor = sw.g().edit();
      abr localabr = new abr();
      String str = Long.toString(paramLong);
      localObject2 = localabr.b(str.getBytes("UTF8"), abt.a("35f9bb76f1d1a280d602c7481f236e39"));
      Object localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = localabr.b(str.getBytes("UTF8"), abt.a("35f9bb76f1d1a280d602c7481f236e39"));
      }
      localObject1 = tl.a((byte[])localObject1);
      localObject2 = new StringBuilder("verify_face_pwd_uin, hex=");
      ((StringBuilder)localObject2).append((String)localObject1);
      ((StringBuilder)localObject2).append(", key=");
      ((StringBuilder)localObject2).append("35f9bb76f1d1a280d602c7481f236e39");
      xv.a(((StringBuilder)localObject2).toString());
      localEditor.putString("verify_face_pwd_uin", (String)localObject1);
      localEditor.putString("verify_face_pwd_key", "35f9bb76f1d1a280d602c7481f236e39");
      localEditor.commit();
      return;
    }
    catch (Exception localException)
  ...
  public static void b(ConfigResult paramConfigResult)
  {
    if ((paramConfigResult != null) && (paramConfigResult.mToolsTitleList != null) && (paramConfigResult.mToolsList != null))
    {
      ...
      xv.a(paramConfigResult.toString());
  ...
  public static boolean c(Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bool5 = bool2;
        bool1 = bool2;
        xv.c("notch screen".concat(String.valueOf(bool2)));
        bool1 = bool2;
      }
      ...
      return bool1;
      bool1 = bool5;
      xv.c("hasNotchInScreen Exception");
      bool1 = bool5;
      continue;
      bool1 = bool4;
      xv.c("hasNotchInScreen NoSuchMethodException");
      bool1 = bool4;
      continue;
      bool1 = bool3;
      xv.c("hasNotchInScreen ClassNotFoundException");
      bool1 = bool3;
    }
  }
  ...
  public static byte[] c(String paramString)
  {
    ...
    //   35: ldc_w 728
    //   38: fdiv
    //   39: invokestatic 731	java/lang/Math:max	(FF)F
    //   42: f2i
    //   43: istore_2
    //   44: iload_2
    //   45: ifgt +6 -> 51
    ...
    //   74: areturn
    //   75: aload_0
    //   76: invokestatic 523	com/tencent/token/aaz:f	(Ljava/lang/String;)I
    //   79: istore_1
    //   80: iload_1
    //   81: ifeq +62 -> 143
    ...
    //   143: aload_3
    //   144: astore_0
    //   145: new 733	java/io/ByteArrayOutputStream
    //   148: dup
    //   149: invokespecial 734	java/io/ByteArrayOutputStream:<init>	()V
    //   152: astore_3
    //   153: getstatic 740	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   156: astore 4
    //   158: bipush 80
    //   160: istore_1
    //   161: aload_0
    ...
    //   164: bipush 80
    //   166: aload_3
    //   167: invokevirtual 744	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   170: pop
    //   171: aload_3
    //   172: invokevirtual 747	java/io/ByteArrayOutputStream:size	()I
    //   175: ldc_w 748
    ...
    //   185: istore_1
    //   186: aload_3
    //   187: invokevirtual 751	java/io/ByteArrayOutputStream:reset	()V
    //   190: aload_0
    //   191: getstatic 740	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   194: iload_1
    //   195: aload_3
    //   196: invokevirtual 744	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   199: pop
    //   200: goto -29 -> 171
    //   203: aload_3
    //   204: invokevirtual 754	java/io/ByteArrayOutputStream:close	()V
    //   207: goto +24 -> 231
    //   210: astore_0
    //   211: goto +25 -> 236
    //   214: astore_0
    ...
    //   219: aload_3
    //   220: invokevirtual 754	java/io/ByteArrayOutputStream:close	()V
    //   223: goto +8 -> 231
    //   226: astore_0
    //   227: aload_0
    //   228: invokevirtual 755	java/io/IOException:printStackTrace	()V
    //   231: aload_3
    //   232: invokevirtual 759	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   235: areturn
    //   236: aload_3
    //   237: invokevirtual 754	java/io/ByteArrayOutputStream:close	()V
    //   240: goto +8 -> 248
    //   243: astore_3
    //   244: aload_3
    //   245: invokevirtual 755	java/io/IOException:printStackTrace	()V
    //   248: aload_0
    //   249: athrow
  ...
  public static long e()
  {
    try
    {
      ...
      if ((str != null) && (str.length() != 0) && (localObject1 != null))
      {
        ...
        byte[] arrayOfByte = tl.a((String)localObject1);
        localObject2 = localabr.a(arrayOfByte, abt.a(str));
        localObject1 = localObject2;
        if (localObject2 == null) {
          localObject1 = localabr.a(arrayOfByte, abt.a(str));
        }
        localObject1 = new String((byte[])localObject1, "UTF8");
        if (((String)localObject1).length() == 0) {
          return 0L;
        }
        xv.a("facepwd verify uin=".concat(String.valueOf(localObject1)));
  ...
  public static QQUser g()
  {
    try
    {
      ...
      QQUser localQQUser = tt.a().c(aay.f(l));
      return localQQUser;
    }
    catch (Exception localException)
    {
  ...
  public static ArrayList<ArrayList<tf>> k()
  {
    try
    {
      ...
      if (localJSONArray1.length() >= 0)
      {
        ...
        while (i < localJSONArray1.length())
        {
          ...
          {
            localArrayList2.add(new tf(localJSONArray2.getJSONObject(j)));
            j += 1;
          }
  ...
  public static String x()
  {
    ...
    if (e(yd.a))
    {
      ...
      ((StringBuilder)localObject2).append((String)localObject1);
      ((StringBuilder)localObject2).append(yd.a);
  ...
  public static int z()
  {
    ...
    //   3: istore_0
    //   4: iload_2
    //   5: invokestatic 927	com/tencent/token/aaz:y	()I
    //   8: if_icmpge +138 -> 146
    ...
    //   35: pop
    //   36: new 765	java/io/File
    //   39: dup
    //   40: aload_3
    //   41: invokevirtual 79	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   44: invokespecial 766	java/io/File:<init>	(Ljava/lang/String;)V
    //   47: astore_3
    //   48: iload_0
    //   49: istore_1
    //   50: aload_3
    //   51: invokevirtual 934	java/io/File:exists	()Z
    //   54: ifeq +83 -> 137
    //   57: sipush 128
    //   60: newarray byte
    //   62: astore 4
    //   64: new 763	java/io/FileInputStream
    //   67: dup
    //   68: aload_3
    //   69: invokespecial 769	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   72: astore_3
    //   73: aload_3
    //   74: aload 4
    //   76: invokevirtual 775	java/io/FileInputStream:read	([B)I
    //   79: pop
    //   80: iconst_0
    //   81: istore_1
    //   82: goto +76 -> 158
    ...
    //   91: iconst_0
    //   92: iload_1
    //   93: invokespecial 936	java/lang/String:<init>	([BII)V
    //   96: invokestatic 496	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   99: invokestatic 939	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   102: astore 4
    //   104: iload_0
    //   105: istore_1
    //   106: aload 4
    //   108: invokevirtual 942	java/lang/Integer:intValue	()I
    //   111: iload_0
    //   112: if_icmple +9 -> 121
    //   115: aload 4
    //   117: invokevirtual 942	java/lang/Integer:intValue	()I
    //   120: istore_1
    //   121: aload_3
    //   122: invokevirtual 780	java/io/FileInputStream:close	()V
    //   125: goto +12 -> 137
    //   128: astore 4
    //   130: aload_3
    //   131: invokevirtual 780	java/io/FileInputStream:close	()V
    //   134: aload 4
    //   136: athrow
    //   137: iload_2
    //   138: iconst_1
