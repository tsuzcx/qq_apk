...
class eb
  extends Drawable
  implements Drawable.Callback, dz, ea
{
  ...
  eb(Drawable paramDrawable)
  {
    this.b = b();
    a(paramDrawable);
  }
  
  eb(a parama, Resources paramResources)
  {
    this.b = parama;
    parama = this.b;
    ...
    extends eb.a
  {
    ...
    {
      return new eb(this, paramResources);
    }
  }
}
