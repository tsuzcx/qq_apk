...
public final class abi
{
  ...
  public abi(String paramString)
  {
    this.a = new ajt(paramString);
  }
      ...
      if ((localObject != null) && (i > 0))
      {
        ...
        if (!((QQUser)localObject).mIsBinded)
        {
          ...
          if (((QQUser)localObject).mUin == ((QQUser)localObject).mRealUin) {
            l1 = aay.f(((QQUser)localObject).mRealUin);
          }
        }
  ...
  public final xt a(JSONObject paramJSONObject, long paramLong, int paramInt)
  {
    xt localxt = new xt();
    long l1 = aaz.a(paramInt, paramLong);
    for (;;)
    {
      int i;
      long l2;
      try
      {
        ...
        if ((m > 0) && (localObject1 != null))
        {
          ...
          if (i < ((JSONArray)localObject1).length())
          {
            ...
            xv.c("msg store to db is wrong".concat(String.valueOf(localObject2)));
            l2 = l1;
            break label532;
          }
          if (j != m)
          {
            this.d = j;
            xv.c("msg cnt is wrong");
            xv.c("msg cnt is wrong".concat(String.valueOf(paramJSONObject)));
          }
          aaz.a(paramInt, paramLong, l1);
          localxt.a = 0;
          return localxt;
        }
      }
      catch (Exception paramJSONObject)
      {
        ...
        localxt.a(10021, ((StringBuilder)localObject1).toString(), null);
      }
