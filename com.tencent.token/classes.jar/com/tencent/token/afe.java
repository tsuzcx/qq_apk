  ...
  implements aex
{
  ...
  public final aex.a a(byte[] paramArrayOfByte)
  {
    ...
    if (localObject2 == transient.do.Kj) {
      ...
      try
      {
        ...
        if (localObject2 == transient.do.Ij) {
          localtransient.a = ((HttpURLConnection)((URL)localObject4).openConnection(new Proxy(Proxy.Type.HTTP, InetSocketAddress.createUnresolved(transient.a(aez.a()), transient.b(aez.a())))));
        } else {
    ...
    return aex.a.a((byte[])((AtomicReference)localObject3).get());
  }
}
