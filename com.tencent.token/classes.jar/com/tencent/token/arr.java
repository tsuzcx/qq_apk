...
public final class arr
{
  ...
  public arr(Context paramContext, asd paramasd)
  {
    this.c = paramContext;
    this.d = paramasd;
    this.f = this.d.a.e();
  ...
  public final String b()
  {
    ...
    ((ai)localObject3).a = 1;
    ((ai)localObject3).d = arq.a(((asa)localObject1).b.getBytes(), localag);
    a(localag);
    Object localObject2 = new ArrayList();
    ((ArrayList)localObject2).add(localObject3);
    localObject3 = new AtomicReference();
    if (this.d.a(false, true, false, (asa)localObject1, (ArrayList)localObject2, (AtomicReference)localObject3) != 0) {
      return null;
    }
    ...
    try
    {
      localObject1 = arq.a(this.d.d.b().b.getBytes(), (byte[])localObject2, (JceStruct)localObject1);
      if (localObject1 == null) {
        return null;
      }
  ...
  public final boolean c()
  {
    ...
    ((ai)localObject3).b = this.d.b.a();
    ((ai)localObject3).a = 2;
    ((ai)localObject3).d = arq.a(((asa)localObject2).b.getBytes(), (JceStruct)localObject4);
    a(((ah)localObject4).a);
    localObject4 = new ArrayList();
    ((ArrayList)localObject4).add(localObject3);
    localObject3 = new AtomicReference();
    if (this.d.a(false, false, true, (asa)localObject2, (ArrayList)localObject4, (AtomicReference)localObject3) != 0) {
      return false;
    }
 ...
 * Qualified Name:     com.tencent.token.arr
