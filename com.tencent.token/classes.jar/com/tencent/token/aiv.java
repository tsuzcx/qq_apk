...
public abstract class aiv
{
  ...
  public aiv(Context paramContext, String paramString, byte[] paramArrayOfByte, SQLiteCipherSpec paramSQLiteCipherSpec, aij paramaij)
  {
    this.a = paramContext;
    this.b = paramString;
    paramContext = null;
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          this.k = m;
          localObject3 = localSQLiteDatabase2;
          localObject1 = ajf.a(this.a, this.b, this.i, this.j, this.k, this.c, this.h);
