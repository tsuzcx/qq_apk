  ...
  implements Camera.PreviewCallback, FaceServiceDelegate
{
  ...
  public xx(Context paramContext, SurfaceHolder paramSurfaceHolder, Handler paramHandler, int paramInt1, int paramInt2, FaceView paramFaceView, TextView paramTextView, View paramView)
  {
    k = aae.s();
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    //   7: astore 6
    //   9: aload_0
    //   10: getfield 118	com/tencent/token/xx:B	Landroid/content/Context;
    ...
    //   107: invokestatic 387	com/tencent/token/xb:a	(Ljava/lang/String;)V
    //   110: aload 9
    //   112: arraylength
    //   113: istore 4
    //   115: iconst_0
    ...
    //   169: aload_1
    //   170: aload_2
    //   171: invokespecial 389	com/tencent/token/xx:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   174: aload_2
    //   175: iconst_0
    //   176: aload_2
    ...
    //   191: goto -74 -> 117
    //   194: aload_0
    //   195: getfield 118	com/tencent/token/xx:B	Landroid/content/Context;
    ...
    //   364: invokestatic 387	com/tencent/token/xb:a	(Ljava/lang/String;)V
    //   367: sipush 1024
    //   370: newarray byte
    //   372: astore_2
    //   373: aload 6
    ...
    if (paramBoolean1)
    {
      if (this.E == DetectType.DT_REGISTER)
      {
        if ((this.H == 0) && (paramBoolean2)) {
          ru.a().a(System.currentTimeMillis(), 145);
        }
        switch (this.G)
        {
        default: 
  ...
  public final void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt)
  {
    ...
    un.f = (int)(System.currentTimeMillis() - this.s);
    un.h = paramInt;
    if (this.w == null) {
      return;
    }
    ...
    if (this.H == 0) {
      localFaceData.mOriginDataPath = zx.a(paramArrayOfByte1.toByteArray(), "origindata0");
    } else {
      localFaceData.mOriginDataPath = zx.a(paramArrayOfByte1.toByteArray(), "origindata1");
    }
  ...
  public final void c()
  {
    ...
    try
    {
      ...
      un.d = ((StringBuilder)localObject3).toString();
      localObject3 = this.x;
      localObject3[0] = 0;
  ...
  public final void onPreviewFrame(byte[] paramArrayOfByte, Camera paramCamera)
  {
    ...
    if ((this.A == null) && (!bool)) {
      new Thread(new Runnable()
      {
        ...
        {
          synchronized (xx.this.g)
          {
            if (xx.a(xx.this) == null)
            {
              xx.a(xx.this, true);
              long l = System.currentTimeMillis();
              xx.b(xx.this);
              un.g = (int)(System.currentTimeMillis() - l);
              xx.a(xx.this, new rg(xx.c(xx.this), xx.this, xx.d(xx.this)));
              FaceThreshold localFaceThreshold = new FaceThreshold();
              xx.a(localFaceThreshold);
              ...
              xb.a(localStringBuilder.toString());
              xx.a(xx.this).a = localFaceThreshold;
              xx.a(xx.this, false);
            }
            return;
          }
    ...
    try
    {
      ...
      localObject = new rj(paramArrayOfByte, ((Camera.Parameters)localObject).getPreviewSize().width, ((Camera.Parameters)localObject).getPreviewSize().height, this.F, this.x, this.y);
      this.A.a((rj)localObject, this.E);
    }
    ...
    xb.c("OutOfMemoryError:doFaceDetect");
    label235:
    un.h += 1;
    if (this.v)
    {
      ...
      if ((!this.r) && (!bool))
      {
        ...
        new Thread(new Runnable()
        {
          public final void run()
          {
            synchronized (xx.this.h)
            {
              if (!xx.this.r)
              {
                long l = System.currentTimeMillis();
                Object localObject2 = new LiveThreshold();
                xx.a(xx.this, (LiveThreshold)localObject2);
                ...
                xb.a(localStringBuilder.toString());
                xx.this.p = FaceDetector.LiveDetectInitial(xx.e(xx.this), (LiveThreshold)localObject2);
                un.i = (int)(System.currentTimeMillis() - l);
                if (xx.this.p)
                {
                  xx.a(xx.this, System.currentTimeMillis());
                  xx.f(xx.this);
                  xx.this.r = true;
                }
                localObject2 = new StringBuilder("LiveDetectInitial,ret=");
                ((StringBuilder)localObject2).append(xx.this.p);
                ((StringBuilder)localObject2).append(",livemodelfile=");
                ((StringBuilder)localObject2).append(xx.e(xx.this));
                xb.c(((StringBuilder)localObject2).toString());
                localObject2 = new StringBuilder("LiveDetectInitial,ret=");
                ((StringBuilder)localObject2).append(xx.this.p);
                ((StringBuilder)localObject2).append(",livemodelfile=");
    ...
    for (;;)
    {
      try
      {
        ...
        case 0: 
          ...
          {
            ru.a().a(System.currentTimeMillis(), 135);
            un.k = (int)(l1 - this.t);
          }
          switch (this.G)
          {
          ...
          case 1: 
            ...
            xb.a("ret:".concat(String.valueOf(i1)));
            switch (i1)
            {
            case 6: 
              if ((this.J != null) && (!this.J.getText().toString().equals(this.O))) {
      ...
      xb.c("OutOfMemoryError:doLiveDetect");
      return;
      continue;
      return;
    }
