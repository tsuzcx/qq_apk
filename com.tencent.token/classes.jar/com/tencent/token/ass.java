    ...
    if (bc.o().isJavaTCC())
    {
      ...
      if (paramArrayOfByte1 != null)
      {
        ...
        if (arrayOfByte != null)
        {
          ...
          asr.a(paramArrayOfByte1, arrayOfInt);
          ...
          asr.a(arrayOfByte, paramArrayOfByte1);
          ...
          asr.a(arrayOfInt, arrayOfInt.length, paramArrayOfByte2);
        }
      }
    ...
    if (bc.o().isJavaTCC())
    {
      ...
      if ((paramArrayOfByte1 != null) && (arrayOfByte != null))
      {
        ...
        if (paramArrayOfByte1.length % 4 == 0)
        {
          ...
          asr.a(paramArrayOfByte1, paramArrayOfByte2);
          if (arrayOfByte.length % 4 == 0) {
            i = arrayOfByte.length >>> 2;
          } else {
            i = (arrayOfByte.length >>> 2) + 1;
          ...
          if (i >= 0)
          {
            ...
            asr.a(paramArrayOfByte2, paramArrayOfByte2.length - 1, paramArrayOfByte1);
            return paramArrayOfByte1;
          }
        }
        return null;
