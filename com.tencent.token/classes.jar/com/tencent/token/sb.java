...
public final class sb
{
  ...
  private boolean j;
  private UserTask<String, String, xh> k = null;
  ...
  {
    // Byte code:
    //   0: new 75	com/tencent/token/xh
    //   3: dup
    //   4: invokespecial 76	com/tencent/token/xh:<init>	()V
    //   7: astore_3
    //   8: invokestatic 81	com/tencent/token/th:a	()Lcom/tencent/token/th;
    //   11: invokevirtual 83	com/tencent/token/th:i	()Z
    //   14: ifne +26 -> 40
    //   17: aload_0
    //   18: getfield 85	com/tencent/token/sb:j	Z
    //   21: ifeq +8 -> 29
    //   24: aload_0
    //   25: invokevirtual 87	com/tencent/token/sb:b	()Z
    //   28: pop
    //   29: aload_3
    //   30: sipush 30001
    //   33: aconst_null
    //   34: aconst_null
    //   35: invokevirtual 90	com/tencent/token/xh:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   38: aload_3
    //   39: areturn
    ...
    //   58: astore 4
    //   60: invokestatic 105	com/tencent/token/rf:a	()Lcom/tencent/token/rf;
    //   63: aload_1
    //   64: new 6	com/tencent/token/sb$1
    //   67: dup
    //   68: aload_0
    //   69: aload 4
    //   71: aload 5
    //   73: invokespecial 108	com/tencent/token/sb$1:<init>	(Lcom/tencent/token/sb;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/CountDownLatch;)V
    //   76: invokevirtual 111	com/tencent/token/rf:c	(Ljava/lang/String;Lcom/tencent/token/rf$a;)V
    //   79: aload 5
    ...
    //   97: checkcast 123	com/tencent/token/ri
    //   100: astore_1
    //   101: aload_1
    //   102: ifnonnull +26 -> 128
    //   105: aload_0
    //   106: getfield 85	com/tencent/token/sb:j	Z
    //   109: ifeq +8 -> 117
    //   112: aload_0
    //   113: invokevirtual 87	com/tencent/token/sb:b	()Z
    //   116: pop
    //   117: aload_3
    //   118: sipush -766
    //   121: aconst_null
    //   122: aconst_null
    //   123: invokevirtual 90	com/tencent/token/xh:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   126: aload_3
    //   127: areturn
    //   128: aload_1
    //   129: getfield 125	com/tencent/token/ri:b	I
    //   132: istore_2
    //   133: iload_2
    //   134: ifeq +18 -> 152
    //   137: aload_1
    //   138: getfield 127	com/tencent/token/ri:d	Ljava/lang/String;
    //   141: astore_1
    //   142: aload_3
    //   143: iload_2
    //   144: aload_1
    //   145: aload_1
    //   146: invokevirtual 90	com/tencent/token/xh:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   149: goto +101 -> 250
    //   152: aload_3
    //   153: iconst_0
    //   154: putfield 129	com/tencent/token/xh:a	I
    //   157: aload_0
    //   158: getfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
    //   161: invokevirtual 133	org/json/JSONArray:length	()I
    //   164: getstatic 135	com/tencent/token/sb:e	I
    //   167: if_icmple +10 -> 177
    //   170: getstatic 135	com/tencent/token/sb:e	I
    //   173: istore_2
    //   174: goto +11 -> 185
    //   177: aload_0
    //   178: getfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
    //   181: invokevirtual 133	org/json/JSONArray:length	()I
    //   184: istore_2
    //   185: iload_2
    //   186: getstatic 135	com/tencent/token/sb:e	I
    //   189: if_icmpgt +17 -> 206
    //   192: aload_0
    //   193: new 50	org/json/JSONArray
    //   196: dup
    //   197: invokespecial 51	org/json/JSONArray:<init>	()V
    //   200: putfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
    //   203: goto +47 -> 250
    ...
    //   214: iload_2
    //   215: aload_0
    //   216: getfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
    //   219: invokevirtual 133	org/json/JSONArray:length	()I
    //   222: if_icmpge +23 -> 245
    //   225: aload_1
    //   226: aload_0
    //   227: getfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
    //   230: iload_2
    ...
    //   245: aload_0
    //   246: aload_1
    //   247: putfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
    //   250: aload_0
    //   251: getfield 85	com/tencent/token/sb:j	Z
    //   254: ifeq +162 -> 416
    //   257: aload_0
    //   258: invokevirtual 87	com/tencent/token/sb:b	()Z
    //   261: pop
    //   262: aload_3
    //   263: areturn
    //   264: astore_1
    ...
    //   295: invokestatic 162	com/tencent/token/xj:c	(Ljava/lang/String;)V
    ...
    //   328: aconst_null
    //   329: invokevirtual 90	com/tencent/token/xh:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   332: aload_0
    //   333: getfield 85	com/tencent/token/sb:j	Z
    //   336: ifeq +80 -> 416
    //   339: goto -82 -> 257
    //   342: astore_1
    ...
    //   369: invokestatic 162	com/tencent/token/xj:c	(Ljava/lang/String;)V
    ...
    //   402: aconst_null
    //   403: invokevirtual 90	com/tencent/token/xh:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   406: aload_0
    //   407: getfield 85	com/tencent/token/sb:j	Z
    //   410: ifeq +6 -> 416
    //   413: goto -156 -> 257
    //   416: aload_3
    //   417: areturn
    //   418: aload_0
    //   419: getfield 85	com/tencent/token/sb:j	Z
    //   422: ifeq +8 -> 430
    //   425: aload_0
    //   426: invokevirtual 87	com/tencent/token/sb:b	()Z
    //   429: pop
    //   430: aload_1
    //   431: athrow
  ...
  {
    // Byte code:
    //   0: invokestatic 61	com/tencent/token/xf:j	()Z
    //   3: ifeq +5 -> 8
    //   6: iconst_0
    //   7: ireturn
    //   8: aload_0
    //   9: getfield 44	com/tencent/token/sb:a	Z
    //   12: ifne +5 -> 17
    //   15: iconst_1
    //   16: ireturn
    //   17: invokestatic 178	com/tencent/token/global/RqdApplication:p	()Landroid/content/Context;
    //   20: ldc 180
    ...
    //   60: putfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
    //   63: aload_1
  ...
  public final void a(boolean paramBoolean)
  {
    ...
    //   7: aload_0
    //   8: iload_1
    //   9: putfield 85	com/tencent/token/sb:j	Z
    //   12: aload_0
    //   13: getfield 46	com/tencent/token/sb:h	Z
    //   16: ifeq +4 -> 20
    //   19: return
    //   20: aload_0
    //   21: getfield 44	com/tencent/token/sb:a	Z
    //   24: ifeq +250 -> 274
    //   27: aload_0
    //   28: getfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
    //   31: invokevirtual 133	org/json/JSONArray:length	()I
    //   34: ifne +4 -> 38
    //   37: return
    //   38: aload_0
    //   39: iconst_1
    //   40: putfield 46	com/tencent/token/sb:h	Z
    //   43: new 50	org/json/JSONArray
    //   46: dup
    //   47: invokespecial 51	org/json/JSONArray:<init>	()V
    //   50: astore 6
    //   52: aload_0
    //   53: getfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
    //   56: invokevirtual 133	org/json/JSONArray:length	()I
    //   59: istore_3
    //   60: getstatic 135	com/tencent/token/sb:e	I
    //   63: istore_2
    //   64: iload_3
    //   65: iload_2
    //   66: if_icmple +6 -> 72
    //   69: goto +11 -> 80
    //   72: aload_0
    //   73: getfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
    ...
    //   87: aload 6
    //   89: aload_0
    //   90: getfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
    //   93: iload_3
    ...
    //   119: lconst_0
    //   120: lstore 4
    //   122: invokestatic 81	com/tencent/token/th:a	()Lcom/tencent/token/th;
    //   125: astore 8
    //   127: aload 8
    //   129: invokevirtual 249	com/tencent/token/th:f	()Lcom/tencent/token/core/bean/QQUser;
    //   132: astore 9
    //   134: aload 9
    //   136: ifnull +13 -> 149
    //   139: aload 9
    ...
    //   146: goto +25 -> 171
    //   149: aload 8
    //   151: getfield 219	com/tencent/token/th:k	Lcom/tencent/token/ais;
    //   154: invokevirtual 224	com/tencent/token/ais:b	()Lcom/tencent/token/core/bean/QQUser;
    //   157: astore 8
    //   159: aload 8
    //   161: ifnull +10 -> 171
    //   164: aload 8
    ...
    //   171: aload 7
    //   173: ldc 251
    //   175: invokestatic 105	com/tencent/token/rf:a	()Lcom/tencent/token/rf;
    //   178: invokevirtual 254	com/tencent/token/rf:h	()J
    //   181: l2i
    //   182: invokevirtual 216	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   185: pop
    //   186: getstatic 257	com/tencent/token/si:b	I
    //   189: iconst_1
    //   190: iadd
    //   191: istore_2
    //   192: iload_2
    //   193: putstatic 257	com/tencent/token/si:b	I
    //   196: aload 7
    //   198: ldc_w 259
    //   201: iload_2
    ...
    //   234: putfield 269	com/tencent/token/sb:c	Ljava/lang/String;
    //   237: aload_0
    //   238: monitorexit
    //   239: aload_0
    //   240: new 8	com/tencent/token/sb$2
    //   243: dup
    //   244: aload_0
    //   245: invokespecial 272	com/tencent/token/sb$2:<init>	(Lcom/tencent/token/sb;)V
    //   248: putfield 48	com/tencent/token/sb:k	Lcom/tencent/token/utils/UserTask;
    //   251: aload_0
    //   252: getfield 48	com/tencent/token/sb:k	Lcom/tencent/token/utils/UserTask;
    //   255: iconst_0
  ...
  public final boolean a(android.content.Context paramContext)
  {
    ...
    //   7: ireturn
    //   8: aload_0
    //   9: getfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
    //   12: ifnonnull +5 -> 17
    //   15: iconst_0
    //   16: ireturn
    //   17: iconst_0
    //   18: putstatic 38	com/tencent/token/sb:i	Z
    //   21: aload_0
    //   22: getfield 44	com/tencent/token/sb:a	Z
    //   25: ifne +5 -> 30
    //   28: iconst_1
    //   29: ireturn
    //   30: aload_1
    ...
    //   44: aload_1
    //   45: aload_0
    //   46: getfield 53	com/tencent/token/sb:b	Lorg/json/JSONArray;
