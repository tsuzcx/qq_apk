...
public final class apf
{
  ...
  public apf(Context paramContext, apw paramapw)
  {
    this.j = paramapw;
    this.a = new aph(paramContext, paramapw);
  }
  ...
  private boolean a(AtomicReference paramAtomicReference)
  {
    ...
    //   2: aload_0
    //   3: iconst_1
    //   4: putfield 40	com/tencent/token/apf:f	Z
    //   7: aload_0
    //   8: getfield 42	com/tencent/token/apf:i	I
    //   11: iconst_3
    //   12: if_icmplt +7 -> 19
    //   15: aload_0
    //   16: invokespecial 70	com/tencent/token/apf:d	()V
    //   19: aload_0
    //   20: getfield 72	com/tencent/token/apf:h	Ljava/lang/String;
    //   23: invokestatic 78	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   26: ifeq +28 -> 54
    //   29: aload_0
    //   30: getfield 52	com/tencent/token/apf:a	Lcom/tencent/token/aph;
    //   33: astore_2
    //   34: aload_2
    //   35: invokevirtual 81	com/tencent/token/aph:c	()Z
    //   38: pop
    //   39: aload_2
    //   40: invokevirtual 83	com/tencent/token/aph:d	()Ljava/lang/String;
    //   43: astore_2
    //   44: aload_1
    //   45: aload_2
    ...
    //   51: goto +8 -> 59
    //   54: aload_0
    //   55: getfield 72	com/tencent/token/apf:h	Ljava/lang/String;
    //   58: astore_1
    //   59: invokestatic 94	com/tencent/token/arp:a	()Lcom/tencent/token/jm;
    //   62: astore_2
    ...
    //   120: pop
    //   121: getstatic 115	com/tencent/token/jm:a	Lcom/tencent/token/jm;
    //   124: astore_3
    //   125: aload_3
    //   126: aload_2
    //   127: if_acmpne +7 -> 134
    ...
    //   146: astore_1
    //   147: getstatic 126	com/tencent/token/jm:d	Lcom/tencent/token/jm;
    //   150: aload_2
    ...
    //   163: invokestatic 136	com/tencent/token/arp:b	()Ljava/lang/String;
    //   166: invokestatic 139	com/tencent/token/arp:c	()I
    ...
    //   181: putfield 156	com/tencent/token/apf:g	Ljava/net/HttpURLConnection;
    //   184: goto +34 -> 218
    //   187: aload_0
    //   188: aload_1
    //   189: invokevirtual 159	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   192: checkcast 154	java/net/HttpURLConnection
    //   195: putfield 156	com/tencent/token/apf:g	Ljava/net/HttpURLConnection;
    //   198: aload_0
    //   199: getfield 156	com/tencent/token/apf:g	Ljava/net/HttpURLConnection;
    //   202: sipush 30000
    //   205: invokevirtual 163	java/net/HttpURLConnection:setReadTimeout	(I)V
    //   208: aload_0
    //   209: getfield 156	com/tencent/token/apf:g	Ljava/net/HttpURLConnection;
    //   212: sipush 30000
  ...
  private static byte[] a(java.io.InputStream paramInputStream)
  {
    ...
    //   95: pop
    //   96: new 275	com/tencent/token/aow
    //   99: dup
    //   100: aload 4
    //   102: invokevirtual 276	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   105: invokespecial 277	com/tencent/token/aow:<init>	(Ljava/lang/String;)V
    //   108: athrow
    //   109: aload_2
  ...
  private int b(byte[] paramArrayOfByte, AtomicReference paramAtomicReference)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 156	com/tencent/token/apf:g	Ljava/net/HttpURLConnection;
    //   4: ifnonnull +7 -> 11
    //   7: sipush -10000
    //   10: ireturn
    //   11: ldc 198
    //   13: aload_0
    //   14: getfield 38	com/tencent/token/apf:e	Ljava/lang/String;
    //   17: invokevirtual 204	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   20: ifne +39 -> 59
    //   23: aload_0
    //   24: getfield 156	com/tencent/token/apf:g	Ljava/net/HttpURLConnection;
    //   27: astore 4
    ...
    //   62: pop2
    //   63: aload_0
    //   64: getfield 156	com/tencent/token/apf:g	Ljava/net/HttpURLConnection;
    ...
    //   92: aload_0
    //   93: getfield 156	com/tencent/token/apf:g	Ljava/net/HttpURLConnection;
    ...
    //   123: aload_0
    //   124: aload_0
    //   125: invokespecial 314	com/tencent/token/apf:e	()Ljava/lang/String;
    //   128: putfield 72	com/tencent/token/apf:h	Ljava/lang/String;
    //   131: aload_0
    //   132: aload_0
    //   133: getfield 42	com/tencent/token/apf:i	I
    //   136: iconst_1
    //   137: iadd
    //   138: putfield 42	com/tencent/token/apf:i	I
    ...
    //   152: aload_1
    //   153: aload_0
    //   154: getfield 72	com/tencent/token/apf:h	Ljava/lang/String;
    ...
    //   169: aload_1
    //   170: aload_0
    //   171: getfield 42	com/tencent/token/apf:i	I
    ...
    //   189: aload_1
    //   190: aload_0
    //   191: getfield 72	com/tencent/token/apf:h	Ljava/lang/String;
    ...
    //   206: aload_1
    //   207: aload_0
    //   208: getfield 42	com/tencent/token/apf:i	I
    //   211: invokevirtual 294	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   214: pop
    //   215: ldc_w 319
    //   218: ireturn
    //   219: aload_0
    //   220: invokespecial 70	com/tencent/token/apf:d	()V
    //   223: aload_0
    //   224: aconst_null
    //   225: putfield 44	com/tencent/token/apf:k	Ljava/lang/String;
    //   228: aload_0
    //   229: getfield 156	com/tencent/token/apf:g	Ljava/net/HttpURLConnection;
    //   232: invokevirtual 323	java/net/HttpURLConnection:getHeaderFields	()Ljava/util/Map;
    //   235: pop
    //   236: aload_0
    //   237: getfield 156	com/tencent/token/apf:g	Ljava/net/HttpURLConnection;
    //   240: ldc_w 325
    ...
    //   272: aload_2
    //   273: aload_0
    //   274: getfield 156	com/tencent/token/apf:g	Ljava/net/HttpURLConnection;
    //   277: invokevirtual 340	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   280: invokestatic 342	com/tencent/token/apf:a	(Ljava/io/InputStream;)[B
    ...
    //   328: astore_1
    //   329: aload_0
    //   330: invokespecial 349	com/tencent/token/apf:b	()Z
    //   333: ifeq +7 -> 340
    //   336: ldc_w 350
    //   339: ireturn
    //   340: aload_1
  ...
  private boolean b()
  {
    ...
    try
    {
      String str = ars.a(new apg(this));
      localObject = str;
    }
    catch (aox localaox)
    {
      new StringBuilder("checkWifiApprovement() WifiApproveException e: ").append(localaox.toString());
      new StringBuilder("checkWifiApprovement() WifiApproveException e: ").append(localaox.toString());
    }
      ...
      try
      {
        ...
        if (n < 5)
        {
          ...
          else
          {
            ...
            synchronized (localaph.h)
            {
              localaph.g += 1;
              if (localaph.g >= localaph.h.size()) {
                localaph.g = 0;
              }
              StringBuilder localStringBuilder = new StringBuilder("gotoNextIp() size: ");
              localStringBuilder.append(localaph.h.size());
              localStringBuilder.append(" mCurIpIdx: ");
              localStringBuilder.append(localaph.g);
