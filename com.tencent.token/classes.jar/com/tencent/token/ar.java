  ...
  implements Iterable<Map.Entry<K, V>>
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    Object localObject1 = (ar)paramObject;
    if (this.e != ((ar)localObject1).e) {
      return false;
    }
    paramObject = iterator();
    localObject1 = ((ar)localObject1).iterator();
  ...
  static final class a<K, V>
    extends ar.e<K, V>
  {
    a(ar.c<K, V> paramc1, ar.c<K, V> paramc2)
    {
      super(paramc2);
    }
    
    final ar.c<K, V> a(ar.c<K, V> paramc)
    {
      return paramc.c;
    }
    
    final ar.c<K, V> b(ar.c<K, V> paramc)
    {
      return paramc.d;
    }
  }
  ...
  public static final class b<K, V>
    extends ar.e<K, V>
  {
    public b(ar.c<K, V> paramc1, ar.c<K, V> paramc2)
    {
      super(paramc2);
    }
  ...
  public final class d
    implements ar.f<K, V>, Iterator<Map.Entry<K, V>>
  {
    private ar.c<K, V> b;
    ...
    public final void a_(ar.c<K, V> paramc)
    {
      ar.c localc = this.b;
      if (paramc == localc)
      {
    ...
    implements ar.f<K, V>, Iterator<Map.Entry<K, V>>
  {
    ...
    e(ar.c<K, V> paramc1, ar.c<K, V> paramc2)
    {
      this.a = paramc2;
      this.b = paramc1;
    }
    ...
    abstract ar.c<K, V> a(ar.c<K, V> paramc);
    ...
    abstract ar.c<K, V> b(ar.c<K, V> paramc);
  ...
  {
    public abstract void a_(ar.c<K, V> paramc);
  }
}
