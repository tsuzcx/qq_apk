...
public final class aqh
{
  ...
  public aqh(Context paramContext, apz paramapz)
  {
    this.i = paramContext;
    this.a = paramapz;
    this.b = new aqj();
    this.j = new aqj();
    this.c = new apg(paramContext, paramapz);
    this.d = new aqd(this);
    this.e = new apv(paramContext, this);
    int n = Process.myPid();
  ...
  private ab a(boolean paramBoolean, aqe paramaqe)
  {
    if (this.m == null) {
      this.m = new ab();
    }
    if (paramaqe != null) {
      localObject = paramaqe.a;
    } else {
    ...
    if (paramaqe != null)
    {
      ...
      ((StringBuilder)localObject).append(paramaqe.hashCode());
      ((StringBuilder)localObject).append(" rsaKey: ");
      ((StringBuilder)localObject).append(paramaqe);
      ...
      ((StringBuilder)localObject).append(paramaqe.b);
  ...
  private aj a(boolean paramBoolean1, boolean paramBoolean2, aqe paramaqe, ArrayList paramArrayList)
  {
      ...
      if (localObject1 != null)
      {
        ...
        if (!paramBoolean)
        {
          ...
          else
          {
            ...
            {
              localObject2 = new y();
              localObject2 = apu.a(this.d.b().b.getBytes(), ((al)localObject1).f, (JceStruct)localObject2);
              ...
              else
              {
                ...
                ((StringBuilder)???).append(" validperiod: ");
                ((StringBuilder)???).append(i5);
                api.a("cmvips", (ArrayList)localObject1);
                api.a("unvips", localArrayList);
                api.a("ctvips", (ArrayList)localObject3);
              }
            }
          }
        }
      }
      synchronized (((api)localObject2).f)
      {
        ((api)localObject2).a(i1, i4);
        ((api)localObject2).a((ArrayList)localObject1, localArrayList, (ArrayList)localObject3);
        ((api)localObject2).e = (System.currentTimeMillis() + i5 * 1000);
        ((api)localObject2).b.a(((api)localObject2).e, (ArrayList)localObject1, localArrayList, (ArrayList)localObject3);
        ((api)localObject2).a();
        i1 = i2;
        if (i1 == 0) {}
      }
  ...
  private static void a(ArrayList paramArrayList, aqe paramaqe1, aqe paramaqe2)
  {
    if ((paramArrayList != null) && (paramaqe1 != null) && (paramaqe2 != null) && (!TextUtils.isEmpty(paramaqe2.a)))
    {
      if (TextUtils.isEmpty(paramaqe2.b)) {
        return;
      }
      ...
      ((StringBuilder)localObject).append(paramaqe1);
      ((StringBuilder)localObject).append(" newRsaKey: ");
      ((StringBuilder)localObject).append(paramaqe2);
      n -= 1;
      while (n >= 0)
      {
        ...
        if ((localai != null) && (localai.d != null) && (localai.d.length > 0))
        {
          ...
          byte[] arrayOfByte = apu.a(paramaqe1.b.getBytes(), localai.d);
          if (arrayOfByte == null)
          {
            paramArrayList.remove(n);
          }
          ...
          {
            localObject = paramaqe2.b.getBytes();
            arrayOfByte = apu.a(arrayOfByte);
            if (arrayOfByte == null) {
              localObject = null;
            } else {
  ...
  private static void a(boolean paramBoolean, aqe paramaqe, ArrayList paramArrayList1, ArrayList paramArrayList2, int paramInt)
  {
    int i2 = 0;
    int i1 = 0;
    int n;
    ...
    if ((!paramBoolean) && (paramArrayList2 != null) && (paramArrayList2.size() > 0))
    {
      ...
      while (n < i2)
      {
        paramaqe = (al)paramArrayList2.get(n);
        if (paramaqe != null)
        {
          if ((paramInt == 0) && (paramaqe.d == 0) && (paramaqe.e == 0))
          {
            paramArrayList1 = new StringBuilder("[ocean]recv: ECmd|");
            paramArrayList1.append(paramaqe.a);
            paramArrayList1.append("|seqNo|");
            paramArrayList1.append(paramaqe.b);
            paramArrayList1.append("|refSeqNo|");
            paramArrayList1.append(paramaqe.c);
            paramArrayList1.append("|ret|");
            paramArrayList1.append(paramInt);
            paramArrayList1.append("|retCode|");
            paramArrayList1.append(paramaqe.d);
            paramArrayList1.append("|dataRetCode|");
            paramArrayList1.append(paramaqe.e);
          }
          else
          {
            paramArrayList1 = new StringBuilder("[ocean]recv: ECmd|");
    ...
    if ((!paramBoolean) && (paramArrayList1 != null))
    {
      ...
      while (n < i1)
      {
        paramaqe = (ai)paramArrayList1.get(n);
        if (paramaqe != null)
        {
          paramArrayList2 = new StringBuilder("[ocean]recv: ECmd|");
          paramArrayList2.append(paramaqe.a + 10000);
  ...
  private int b(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, aqe paramaqe, ArrayList paramArrayList, AtomicReference paramAtomicReference)
  {
    ...
    ((StringBuilder)localObject).append(" rsaKey: ");
    ((StringBuilder)localObject).append(paramaqe);
    localObject = paramaqe;
    if (!paramBoolean1)
    {
      localObject = this.d;
      if ((!TextUtils.isEmpty(((aqd)localObject).c())) && (!TextUtils.isEmpty(((aqd)localObject).a()))) {
        n = 0;
      } else {
        n = 1;
      }
      if (n != 0)
      {
        ...
        if (!apc.a(l1, ((aqd)localObject).a, 10))
        {
          n = -700;
          break label248;
        }
        ((aqd)localObject).a = l1;
        l1 = ((aqd)localObject).a;
        if (!((aqd)localObject).a(null))
        {
          n = -100;
          break label248;
        }
      ...
      aqe localaqe = this.d.b();
      localObject = paramaqe;
      if (paramaqe != null) {
        if ((!TextUtils.isEmpty(paramaqe.a)) && (!TextUtils.isEmpty(paramaqe.b)))
        {
          if ((paramaqe != null) && (!TextUtils.isEmpty(paramaqe.a)) && (!TextUtils.isEmpty(paramaqe.b)) && (!TextUtils.isEmpty(localaqe.a)) && (!TextUtils.isEmpty(localaqe.b)) && ((!paramaqe.a.equals(localaqe.a)) || (!paramaqe.b.equals(localaqe.b)))) {
            n = 1;
          } else {
            n = 0;
          }
        ...
        {
          a(paramArrayList, paramaqe, localaqe);
          localObject = localaqe;
        }
      }
    }
    ...
    paramaqe = aqa.a(a(paramBoolean1, true, (aqe)localObject, paramArrayList));
    new StringBuilder("doSend() sendData.length: ").append(paramaqe.length);
    new StringBuilder("doSend() sendData.length: ").append(paramaqe.length);
    paramArrayList = new AtomicReference();
    int n = this.c.a(paramaqe, paramArrayList);
    if (-160000 == n) {
      return a(n);
    }
    if (n != 0) {
    ...
    paramaqe = (byte[])paramArrayList.get();
    if (paramaqe == null) {
      return -5;
    }
    new StringBuilder("doSend() retData.length: ").append(paramaqe.length);
    new StringBuilder("doSend() retData.length: ").append(paramaqe.length);
    try
    {
      paramaqe = aqa.a(paramaqe);
      if (paramaqe == null) {
        return -5;
      }
      paramaqe = (am)paramaqe;
      paramArrayList = paramaqe.c;
      if (paramArrayList == null) {
        return -5;
      }
      localObject = new StringBuilder("doSend() retShark.seqNo: ");
      ((StringBuilder)localObject).append(paramaqe.a);
    ...
    catch (Exception paramaqe)
    {
      new StringBuilder("doSend() e: ").append(paramaqe.toString());
      new StringBuilder("doSend() e: ").append(paramaqe.toString());
    }
    return -5;
  }
  ...
  public final int a(aqe paramaqe, ArrayList paramArrayList, AtomicReference paramAtomicReference)
  {
    if (!arq.d()) {
      return -2;
    }
    return a(false, false, false, paramaqe, paramArrayList, paramAtomicReference);
  }
  
  protected final int a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, aqe paramaqe, ArrayList paramArrayList, AtomicReference paramAtomicReference)
  {
    Object localObject3 = this.k;
    if ((!paramBoolean1) && (!paramBoolean2) && (!paramBoolean3) && (paramaqe != null)) {}
    for (;;)
    {
      int i1;
      try
      {
        Object localObject2 = paramaqe.b;
        n = this.c.a.c;
        i1 = this.c.a.d;
        ...
        else
        {
          ...
          ((ai)localObject1).d = apu.a(((String)localObject2).getBytes(), (JceStruct)localObject4);
        }
        if (localObject1 == null) {
          break label948;
        }
        ...
        a(true, paramaqe, paramArrayList, null, 0);
        int i2 = b(paramBoolean1, paramBoolean2, paramBoolean3, paramaqe, paramArrayList, (AtomicReference)localObject4);
        if (i2 != 0)
        {
        ...
        if (!paramBoolean1)
        {
          ...
          if (n != 0)
          {
            ...
            if (!paramBoolean1)
            {
              ...
              if (bool2)
              {
                i1 = b(false, paramBoolean2, paramBoolean3, paramaqe, paramArrayList, (AtomicReference)localObject4);
        ...
        {
          paramaqe = b((ArrayList)localObject1);
          if (paramaqe != null)
          {
            paramArrayList = new StringBuilder("checkCSIPListResult() rs.seqNo: ");
            paramArrayList.append(paramaqe.b);
            paramArrayList.append(" rs.cmd: ");
            paramArrayList.append(paramaqe.a);
            paramArrayList.append(" rs.retCode: ");
            paramArrayList.append(paramaqe.d);
            paramArrayList.append(" rs.dataRetCode: ");
            paramArrayList.append(paramaqe.e);
            paramArrayList = new StringBuilder("checkCSIPListResult() rs.seqNo: ");
            paramArrayList.append(paramaqe.b);
            paramArrayList.append(" rs.cmd: ");
            paramArrayList.append(paramaqe.a);
            ...
            paramArrayList.append(" rs.dataRetCode: ");
            paramArrayList.append(paramaqe.e);
            if ((1 != paramaqe.d) && (paramaqe.e == 0))
            {
              paramArrayList = paramaqe.f;
              if (paramArrayList != null)
              {
                new StringBuilder("checkCSIPListResult() rs.data.length: ").append(paramaqe.f.length);
                new StringBuilder("checkCSIPListResult() rs.data.length: ").append(paramaqe.f.length);
                paramaqe = new z();
              }
            }
      ...
      try
      {
        paramaqe = apu.a(this.d.b().b.getBytes(), paramArrayList, paramaqe);
        if (paramaqe != null)
        {
          paramaqe = (z)paramaqe;
          new StringBuilder("checkCSIPListResult() ipList反馈成功, ret.hash: ").append(paramaqe.a);
          new StringBuilder("checkCSIPListResult() ipList反馈成功, ret.hash: ").append(paramaqe.a);
        }
      }
      catch (Exception paramaqe)
