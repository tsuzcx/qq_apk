  ...
  implements aje.a
{
  ...
  private SQLiteConnection(SQLiteConnectionPool paramSQLiteConnectionPool, ait paramait, int paramInt, boolean paramBoolean, byte[] paramArrayOfByte, SQLiteCipherSpec paramSQLiteCipherSpec)
  {
  ...
  static SQLiteConnection a(SQLiteConnectionPool paramSQLiteConnectionPool, ait paramait, int paramInt, boolean paramBoolean, byte[] paramArrayOfByte, SQLiteCipherSpec paramSQLiteCipherSpec)
  {
    paramait = new SQLiteConnection(paramSQLiteConnectionPool, paramait, paramInt, paramBoolean, paramArrayOfByte, paramSQLiteCipherSpec);
    for (;;)
    {
      try
      {
        paramait.o = paramait.nativeOpen(paramait.h.a, paramait.h.d, paramait.h.c);
        if ((paramait.q != null) && (paramait.q.length == 0)) {
          paramait.q = null;
        }
        if (paramait.q != null)
        {
          nativeSetKey(paramait.o, paramait.q);
          if (paramait.r != null)
          {
            if (paramait.r.cipher != null)
            {
              paramSQLiteConnectionPool = new StringBuilder("PRAGMA cipher=");
              paramSQLiteConnectionPool.append(aik.a(paramait.r.cipher));
              paramait.a(paramSQLiteConnectionPool.toString(), null, null);
            }
            if (paramait.r.kdfIteration != 0)
            {
              paramSQLiteConnectionPool = new StringBuilder("PRAGMA kdf_iter=");
              paramSQLiteConnectionPool.append(paramait.r.kdfIteration);
              paramait.a(paramSQLiteConnectionPool.toString(), null, null);
            }
            paramSQLiteConnectionPool = new StringBuilder("PRAGMA cipher_use_hmac=");
            paramSQLiteConnectionPool.append(paramait.r.hmacEnabled);
            paramait.a(paramSQLiteConnectionPool.toString(), null, null);
          }
        }
        if (!paramait.h.a())
        {
          if (paramait.q != null)
          {
            ...
            if ((paramait.r != null) && (paramait.r.pageSize > 0))
            {
              paramInt = paramait.r.pageSize;
              break label472;
            }
          ...
          l1 = SQLiteGlobal.a;
          if (paramait.a(paramSQLiteConnectionPool, null) != l1)
          {
            paramArrayOfByte = new StringBuilder();
            paramArrayOfByte.append(paramSQLiteConnectionPool);
            paramArrayOfByte.append("=");
            paramArrayOfByte.append(l1);
            paramait.a(paramArrayOfByte.toString(), null, null);
          }
        }
        if (paramait.j) {
          paramait.a("PRAGMA query_only = 1", null, null);
        }
        paramait.g();
        paramait.h();
        paramait.i();
        if ((!paramait.h.a()) && (!paramait.j) && (paramait.a("PRAGMA journal_size_limit", null) != 524288L)) {
          paramait.a("PRAGMA journal_size_limit=524288", null);
        }
        paramait.f();
        paramait.j();
        paramait.k();
        int i1 = paramait.h.l.size();
        paramInt = 0;
        if (paramInt < i1)
        {
          paramSQLiteConnectionPool = (SQLiteCustomFunction)paramait.h.l.get(paramInt);
          nativeRegisterCustomFunction(paramait.o, paramSQLiteConnectionPool);
          paramInt += 1;
          continue;
        }
        return paramait;
  ...
  private String e(String paramString)
  {
    ...
    //   47: aload_0
    //   48: aconst_null
    //   49: invokespecial 405	com/tencent/wcdb/database/SQLiteConnection:a	(Lcom/tencent/token/aje;)V
    //   52: aload_0
    ...
    //   64: aload_0
    //   65: aconst_null
    //   66: invokespecial 311	com/tencent/wcdb/database/SQLiteConnection:b	(Lcom/tencent/token/aje;)V
    //   69: aload_0
    //   70: aload_1
    ...
    //   85: aload_0
    //   86: aconst_null
    //   87: invokespecial 311	com/tencent/wcdb/database/SQLiteConnection:b	(Lcom/tencent/token/aje;)V
    //   90: aload_3
    //   91: athrow
    //   92: astore_3
    //   93: aload_0
  ...
  private void j()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 94	com/tencent/wcdb/database/SQLiteConnection:h	Lcom/tencent/token/ait;
    //   4: astore_1
    //   5: aload_1
    //   6: aload_1
    //   7: getfield 100	com/tencent/token/ait:d	I
    //   10: bipush 16
    //   12: ior
    //   13: putfield 100	com/tencent/token/ait:d	I
    //   16: aload_0
    //   17: getfield 94	com/tencent/wcdb/database/SQLiteConnection:h	Lcom/tencent/token/ait;
    //   20: getfield 100	com/tencent/token/ait:d	I
    //   23: bipush 16
    //   25: iand
    //   26: ifeq +4 -> 30
    //   29: return
    //   30: aload_0
    //   31: getfield 94	com/tencent/wcdb/database/SQLiteConnection:h	Lcom/tencent/token/ait;
    //   34: getfield 497	com/tencent/token/ait:f	Ljava/util/Locale;
    ...
    //   61: aconst_null
    //   62: aconst_null
    //   63: invokevirtual 156	com/tencent/wcdb/database/SQLiteConnection:a	(Ljava/lang/String;[Ljava/lang/Object;Lcom/tencent/token/aje;)V
    //   66: aload_0
    //   67: ldc_w 508
    ...
    //   91: aconst_null
    //   92: aconst_null
    //   93: invokevirtual 156	com/tencent/wcdb/database/SQLiteConnection:a	(Ljava/lang/String;[Ljava/lang/Object;Lcom/tencent/token/aje;)V
    //   96: aload_0
    //   97: ldc_w 516
    //   100: aconst_null
    //   101: aconst_null
    //   102: invokevirtual 156	com/tencent/wcdb/database/SQLiteConnection:a	(Ljava/lang/String;[Ljava/lang/Object;Lcom/tencent/token/aje;)V
    //   105: aload_0
    //   106: ldc_w 518
    //   109: iconst_1
    ...
    //   116: aastore
    //   117: aconst_null
    //   118: invokevirtual 156	com/tencent/wcdb/database/SQLiteConnection:a	(Ljava/lang/String;[Ljava/lang/Object;Lcom/tencent/token/aje;)V
    //   121: aload_0
    //   122: ldc_w 520
    //   125: aconst_null
    //   126: aconst_null
    //   127: invokevirtual 156	com/tencent/wcdb/database/SQLiteConnection:a	(Ljava/lang/String;[Ljava/lang/Object;Lcom/tencent/token/aje;)V
    //   130: aload_0
    //   131: ldc_w 522
    //   134: aconst_null
    //   135: aconst_null
    //   136: invokevirtual 156	com/tencent/wcdb/database/SQLiteConnection:a	(Ljava/lang/String;[Ljava/lang/Object;Lcom/tencent/token/aje;)V
    //   139: return
    //   140: astore_2
    //   141: aload_0
    //   142: ldc_w 524
    //   145: aconst_null
    //   146: aconst_null
    //   147: invokevirtual 156	com/tencent/wcdb/database/SQLiteConnection:a	(Ljava/lang/String;[Ljava/lang/Object;Lcom/tencent/token/aje;)V
    //   150: aload_2
    //   151: athrow
    //   152: astore_2
    ...
    //   164: aload_3
    //   165: aload_0
    //   166: getfield 94	com/tencent/wcdb/database/SQLiteConnection:h	Lcom/tencent/token/ait;
    //   169: getfield 370	com/tencent/token/ait:b	Ljava/lang/String;
  ...
  /* Error */
  public final int a(String paramString, Object[] paramArrayOfObject, com.tencent.wcdb.CursorWindow paramCursorWindow, int paramInt1, int paramInt2, boolean paramBoolean, aje paramaje)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +642 -> 643
    ...
    //   66: aload_0
    //   67: aload 7
    //   69: invokespecial 405	com/tencent/wcdb/database/SQLiteConnection:a	(Lcom/tencent/token/aje;)V
    //   72: aload_0
    ...
    //   133: aload_0
    //   134: aload 7
    //   136: invokespecial 311	com/tencent/wcdb/database/SQLiteConnection:b	(Lcom/tencent/token/aje;)V
    //   139: aload_0
    //   140: aload 20
    ...
    //   330: aload_0
    //   331: aload 7
    //   333: invokespecial 311	com/tencent/wcdb/database/SQLiteConnection:b	(Lcom/tencent/token/aje;)V
    //   336: aload_1
    //   337: athrow
    //   338: astore_1
    //   339: goto +10 -> 349
  ...
  public final long a(String paramString, Object[] paramArrayOfObject)
  {
    ...
    //   50: aload_0
    //   51: aconst_null
    //   52: invokespecial 405	com/tencent/wcdb/database/SQLiteConnection:a	(Lcom/tencent/token/aje;)V
    //   55: aload_0
    ...
    //   68: aload_0
    //   69: aconst_null
    //   70: invokespecial 311	com/tencent/wcdb/database/SQLiteConnection:b	(Lcom/tencent/token/aje;)V
    //   73: aload_0
    //   74: aload_1
    ...
    //   90: aload_0
    //   91: aconst_null
    //   92: invokespecial 311	com/tencent/wcdb/database/SQLiteConnection:b	(Lcom/tencent/token/aje;)V
    //   95: aload_2
    //   96: athrow
    //   97: astore_2
    //   98: aload_0
  ...
  final void a(ait paramait)
  {
    int i5 = 0;
    this.c = false;
    int i2 = paramait.l.size();
    int i1 = 0;
    while (i1 < i2)
    {
      localObject = (SQLiteCustomFunction)paramait.l.get(i1);
      if (!this.h.l.contains(localObject)) {
        nativeRegisterCustomFunction(this.o, (SQLiteCustomFunction)localObject);
      }
      i1 += 1;
    }
    if (((paramait.d ^ this.h.d) & 0x20000000) != 0) {
      i1 = 1;
    } else {
      i1 = 0;
    }
    if (paramait.g != this.h.g) {
      i2 = 1;
    } else {
      i2 = 0;
    }
    boolean bool = paramait.f.equals(this.h.f);
    int i3;
    if (paramait.h != this.h.h) {
      i3 = 1;
    } else {
      i3 = 0;
    }
    int i4;
    if (paramait.i != this.h.i) {
      i4 = 1;
    } else {
      i4 = 0;
    }
    if ((paramait.j != this.h.j) || (paramait.k != this.h.k)) {
      i5 = 1;
    }
    this.h.a(paramait);
    ...
    if (i6 > 0) {
      try
      {
        ((ajg)localObject).b = i6;
        ((ajg)localObject).a(i6);
        if (i2 != 0) {
          g();
        }
        if (i1 != 0) {
  ...
  /* Error */
  public final void a(String paramString, com.tencent.token.ajb paramajb)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +194 -> 195
    ...
    //   45: putfield 642	com/tencent/token/ajb:a	I
    //   48: aload_2
    //   49: aload_1
    //   50: getfield 344	com/tencent/wcdb/database/SQLiteConnection$c:g	Z
    //   53: putfield 643	com/tencent/token/ajb:c	Z
    //   56: aload_0
    ...
    //   78: putfield 647	com/tencent/token/ajb:b	[Ljava/lang/String;
    //   81: goto +45 -> 126
    //   84: aload_2
    //   85: iload 5
    //   87: anewarray 52	java/lang/String
    //   90: putfield 647	com/tencent/token/ajb:b	[Ljava/lang/String;
    //   93: iconst_0
    //   94: istore_3
    //   95: iload_3
    //   96: iload 5
    //   98: if_icmpge +28 -> 126
    //   101: aload_2
    //   102: getfield 647	com/tencent/token/ajb:b	[Ljava/lang/String;
    //   105: iload_3
    //   106: aload_0
    ...
    //   0	206	2	paramajb	com.tencent.token.ajb
    //   94	29	3	i1	int
    //   23	166	4	i2	int
    //   67	32	5	i3	int
    //   16	16	6	locala	a
  ...
  /* Error */
  public final void a(String paramString, Object[] paramArrayOfObject, aje paramaje)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +148 -> 149
    ...
    //   51: aload_0
    //   52: aload_3
    //   53: invokespecial 405	com/tencent/wcdb/database/SQLiteConnection:a	(Lcom/tencent/token/aje;)V
    //   56: aload_0
    //   57: getfield 126	com/tencent/wcdb/database/SQLiteConnection:o	J
    //   60: aload_1
    //   61: getfield 259	com/tencent/wcdb/database/SQLiteConnection$c:d	J
    ...
    //   67: aload_0
    //   68: aload_3
    //   69: invokespecial 311	com/tencent/wcdb/database/SQLiteConnection:b	(Lcom/tencent/token/aje;)V
    //   72: aload_0
    //   73: aload_1
    ...
    //   88: aload_0
    //   89: aload_3
    //   90: invokespecial 311	com/tencent/wcdb/database/SQLiteConnection:b	(Lcom/tencent/token/aje;)V
    //   93: aload_2
    //   94: athrow
    //   95: astore_2
    //   96: aload_0
  ...
  public final int b(String paramString, Object[] paramArrayOfObject)
  {
    ...
    //   86: aload_0
    //   87: aconst_null
    //   88: invokespecial 405	com/tencent/wcdb/database/SQLiteConnection:a	(Lcom/tencent/token/aje;)V
    //   91: aload_0
    ...
    //   108: aload_0
    //   109: aconst_null
    //   110: invokespecial 311	com/tencent/wcdb/database/SQLiteConnection:b	(Lcom/tencent/token/aje;)V
    //   113: iload 6
    //   115: istore_3
    //   116: iload 6
    //   118: istore 4
    ...
    //   165: aload_0
    //   166: aconst_null
    //   167: invokespecial 311	com/tencent/wcdb/database/SQLiteConnection:b	(Lcom/tencent/token/aje;)V
    //   170: iload 7
    //   172: istore 5
    //   174: aload_2
    //   175: athrow
  ...
  final class d
    extends ajg<String, SQLiteConnection.c>
  {
