  ...
  public List<PhoneUtil.CellInfo> getCellInfoList(Context paramContext)
  {
    ...
    if ((((CdmaCellLocation)localObject5).getBaseStationId() != -1) && (((CdmaCellLocation)localObject5).getNetworkId() != -1) && (((CdmaCellLocation)localObject5).getSystemId() != -1))
    {
      ...
      for (;;)
      {
        try
        {
          localLinkedList.add(new PhoneUtil.CellInfo((String)localObject1, paramContext, "", "", (String)localObject2, "cdma", (String)localObject6, (String)localObject8, (String)localObject5));
          return localLinkedList;
        }
        ...
        try
        {
          ...
          if (localObject2 != null)
          {
            ...
            if ((j < 65535) && (j != -1) && (i != -1)) {
              localLinkedList.add(new PhoneUtil.CellInfo((String)localObject1, paramContext, String.valueOf(j), String.valueOf(i), "", "gsm", "", "", ""));
            }
          }
        }
      ...
      if ((localObject3 != null) && (((List)localObject3).size() > 0))
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if ((((NeighboringCellInfo)localObject5).getCid() != -1) && (((NeighboringCellInfo)localObject5).getLac() <= 65535) && (((NeighboringCellInfo)localObject5).getLac() != -1))
          {
            ...
            localLinkedList.add(new PhoneUtil.CellInfo((String)localObject1, paramContext, (String)localObject7, ((StringBuilder)localObject8).toString(), (String)localObject6, "gsm", "", "", ""));
            continue;
            try
            {
            ...
            localLinkedList.add(new PhoneUtil.CellInfo((String)localObject1, paramContext, String.valueOf(j), String.valueOf(i), (String)localObject3, "gsm", "", "", ""));
            ...
            if ((localObject4 != null) && (((List)localObject4).size() > 0))
            {
              ...
              while (((Iterator)localObject4).hasNext())
              {
                ...
                if ((((NeighboringCellInfo)localObject5).getCid() != -1) && (((NeighboringCellInfo)localObject5).getLac() <= 65535))
                {
                  ...
                  Log.v("checked", ((StringBuilder)localObject7).toString());
                  localObject7 = new StringBuilder();
                  ((StringBuilder)localObject7).append(((NeighboringCellInfo)localObject5).getLac());
                  localObject7 = ((StringBuilder)localObject7).toString();
                  localObject8 = new StringBuilder();
