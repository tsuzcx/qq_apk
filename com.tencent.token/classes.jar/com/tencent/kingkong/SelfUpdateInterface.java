...
public class SelfUpdateInterface
{
  ...
  public static void DoUpdate()
  {
    ...
    String str1 = Common.GetDownloadFolder() + mPathSeparator + "main.config";
    int j = 0;
    int i = j;
    try
    {
      if (updateMainConfig(str1))
      {
        localObject = MainConfig.parseFromFile(str1);
        if (localObject != null) {
          break label84;
        }
    ...
    if (i != 0)
    {
      ...
      for (;;)
      {
        ...
        if (((MainConfig)localObject).findPatch(str2) == null)
        {
          Common.Log.d("SelfUpdateInterface", "Patch has been removed : " + str2);
    ...
    throws Exception
  {
    ...
    str2 = "&k=" + URLEncoder.encode(str1, "UTF-8") + "&u=" + URLEncoder.encode(str2, "UTF-8") + "&v=" + "2.0";
