  ...
  extends Patch
{
  ...
  {
    int[] arrayOfInt2 = Common.getPatchGotHookPoints(this.mPatchName);
    Object localObject;
    if (arrayOfInt2 == null)
    {
  ...
  {
    int[] arrayOfInt2 = Common.getPatchJumperPoints(this.mPatchName);
    Object localObject;
    if (arrayOfInt2 == null)
    {
  ...
  public int doPatch(Context paramContext)
  {
    ...
    int i = Common.getSubPatchIndex(this.mPatchName, getFingerprintLibraries());
    ...
    } while (PatchManager.nativeDoPatch(Common.makeInstallName("lib" + this.mPatchName + ".so"), str, (String)localObject2, n, k, m, (int[])localObject1, this.mParameterCount, j));
  ...
  public boolean initPatch()
  {
    ...
    for (;;)
    {
      if (i >= this.mHookPointCount)
      {
        Common.storePatchHookParams(this.mPatchName, this.mHookPointCount, arrayOfInt1, arrayOfInt2);
        Common.storeSubPatchIndex(this.mPatchName, j, getFingerprintLibraries());
        return true;
      }
