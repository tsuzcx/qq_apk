...
public class i
{
    ...
    try
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          localaq.a.add(localObject4);
        }
        paramArrayOfByte.add(localaq);
      }
      paramArrayOfByte = ((com.tencent.halley.scheduler.c.b)localObject1).b;
      localObject1 = bm.a();
      if ((paramArrayOfByte == null) || (!"".equals(paramArrayOfByte)))
      {
        localObject1 = ((bm)localObject1).c;
        bn.a("detectTaskCode", paramArrayOfByte);
        return;
      }
    }
  ...
  public static boolean a(String paramString, boolean paramBoolean1, long paramLong1, long paramLong2, java.util.Map paramMap, boolean paramBoolean2)
  {
    ...
    //   38: invokestatic 139	com/tencent/halley/common/c:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   41: iload_1
    //   42: istore 8
    //   44: iload_1
    //   45: ifne +70 -> 115
    ...
    //   51: iload_1
    //   52: istore 7
    //   54: getstatic 141	com/tencent/halley/common/i:a	Lcom/tencent/halley/b;
    //   57: ifnull +58 -> 115
    //   60: iload_1
    //   61: istore 7
    //   63: getstatic 141	com/tencent/halley/common/i:a	Lcom/tencent/halley/b;
    //   66: aload_0
    //   67: iconst_1
    //   68: lconst_0
    //   69: lconst_0
    ...
    //   112: invokestatic 139	com/tencent/halley/common/c:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   115: iload 8
    //   117: ireturn
    //   118: astore_0
    //   119: iload 7
 ...
 * Qualified Name:     com.tencent.halley.common.i
