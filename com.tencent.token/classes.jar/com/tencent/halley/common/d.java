...
public final class d
{
  ...
  public static String a(String paramString)
  {
    ...
    localObject = new d();
    ((d)localObject).a();
    ((d)localObject).a(new ByteArrayInputStream(paramString), paramString.length);
    paramString = new byte[8];
    a(paramString, ((d)localObject).c, 8);
    i = (int)(localObject.c[0] >>> 3) & 0x3F;
    if (i < 56)
    {
      i = 56 - i;
      ((d)localObject).a(a, i);
      ((d)localObject).a(paramString, 8);
      a(((d)localObject).e, ((d)localObject).b, 16);
