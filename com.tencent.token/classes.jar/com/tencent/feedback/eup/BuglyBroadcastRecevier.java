  ...
  extends BroadcastReceiver
{
  ...
  public final boolean processOtherProcessCrashed(Context paramContext, Intent paramIntent)
  {
    ...
    //   7: ifnull +17 -> 24
    //   10: aload_2
    //   11: invokevirtual 383	android/content/Intent:getAction	()Ljava/lang/String;
    //   14: ldc 14
    //   16: invokevirtual 387	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   19: istore_3
    //   20: iload_3
    //   21: ifne +9 -> 30
    //   24: iconst_0
    ...
    //   50: goto -24 -> 26
    //   53: aload_1
    //   54: invokevirtual 392	android/content/Context:getPackageName	()Ljava/lang/String;
    //   57: astore 4
    //   59: aload_1
    //   60: invokestatic 397	com/tencent/feedback/common/c:a	(Landroid/content/Context;)Lcom/tencent/feedback/common/c;
    //   63: invokevirtual 400	com/tencent/feedback/common/c:E	()Ljava/lang/String;
    //   66: astore_1
    //   67: aload_2
    //   68: ldc 38
    //   70: invokevirtual 403	android/content/Intent:getByteArrayExtra	(Ljava/lang/String;)[B
    //   73: astore 5
    //   75: aload_2
    //   76: ldc 23
    //   78: invokevirtual 407	android/content/Intent:getBundleExtra	(Ljava/lang/String;)Landroid/os/Bundle;
    //   81: astore_2
    //   82: aload 5
    //   84: ifnull +7 -> 91
    //   87: aload_2
    ...
    //   107: aload 5
    //   109: invokevirtual 412	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   125: aload_2
    //   126: invokevirtual 412	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   129: invokevirtual 153	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   132: aastore
    //   133: invokestatic 415	com/tencent/feedback/common/e:c	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   136: pop
    //   137: iconst_1
    //   138: istore_3
    //   139: goto -113 -> 26
    ...
    //   148: iconst_1
    //   149: ldc 8
    //   151: invokestatic 417	com/tencent/feedback/proguard/a:b	([BILjava/lang/String;)[B
    //   154: ldc 179
    //   156: invokespecial 420	java/lang/String:<init>	([BLjava/lang/String;)V
    //   159: astore 5
    //   161: aload 5
    //   163: aload_2
    //   164: ldc 53
    //   166: invokevirtual 424	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   169: invokevirtual 387	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   172: ifne +46 -> 218
    //   175: ldc_w 426
    //   178: iconst_2
    ...
    //   196: aload_2
    //   197: ldc 53
    //   199: invokevirtual 424	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   208: aastore
    //   209: invokestatic 415	com/tencent/feedback/common/e:c	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   212: pop
    //   213: iconst_1
    //   214: istore_3
    //   215: goto -189 -> 26
    ...
    //   230: aload_2
    //   231: ldc 56
    //   233: invokevirtual 424	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   261: invokevirtual 387	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   264: ifeq +19 -> 283
    //   267: ldc_w 428
    //   270: iconst_0
    ...
    //   305: aload_2
    //   306: ldc 56
    //   308: invokevirtual 424	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   311: aload_2
    //   312: ldc 68
    //   314: invokevirtual 424	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   317: aload_2
    //   318: ldc 35
    //   320: invokevirtual 434	android/os/Bundle:getByte	(Ljava/lang/String;)B
    //   323: aload_2
    //   324: ldc 29
    //   326: invokevirtual 438	android/os/Bundle:getLong	(Ljava/lang/String;)J
    //   329: aload_2
    //   330: ldc 32
    //   332: invokevirtual 438	android/os/Bundle:getLong	(Ljava/lang/String;)J
    //   335: aload_2
    //   336: ldc 26
    //   338: invokevirtual 438	android/os/Bundle:getLong	(Ljava/lang/String;)J
    //   341: aload_2
    //   342: ldc 47
    //   344: invokevirtual 424	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   347: aload_2
    //   348: ldc 41
    //   350: invokevirtual 424	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   353: aload_2
    //   354: ldc 44
    //   356: invokevirtual 424	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   359: aload_2
    //   360: ldc 50
    //   362: invokevirtual 441	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   365: aload_2
    //   366: ldc 65
    //   368: invokevirtual 438	android/os/Bundle:getLong	(Ljava/lang/String;)J
    //   371: aload_2
    //   372: invokeinterface 447 18 0
    //   377: ldc_w 449
    //   380: iconst_1
    ...
    //   398: astore_1
    //   399: aload_1
    //   400: invokevirtual 452	java/io/UnsupportedEncodingException:printStackTrace	()V
    //   403: goto -10 -> 393
    //   406: astore_1
    //   407: aload_0
    //   408: monitorexit
