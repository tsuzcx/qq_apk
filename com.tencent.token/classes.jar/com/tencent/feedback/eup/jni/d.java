  ...
  implements s
{
  ...
  public final void e()
  {
    ...
    if ((localObject != null) && (((File)localObject).exists()) && (this.c.isDirectory()))
    {
      com.tencent.feedback.common.e.a("rqdp{ start to find native record}", new Object[0]);
      localObject = c.a(this.g, this.c.getAbsolutePath());
      if (localObject != null)
      {
      ...
      final int i = this.a.length();
      final int j = this.b.length();
      String[] arrayOfString = this.c.list(new FilenameFilter()
      {
