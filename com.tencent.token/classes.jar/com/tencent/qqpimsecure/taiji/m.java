...
class m
{
  ...
  static HashMap a(Context paramContext)
  {
    HashMap localHashMap = new HashMap(7);
    String str = cj.b();
    localHashMap.put(Integer.valueOf(9800), str);
    localHashMap.put(Integer.valueOf(9801), a(cj.a()));
    localHashMap.put(Integer.valueOf(9803), a(cj.d()));
    localHashMap.put(Integer.valueOf(9804), cj.a("ro.build.fingerprint"));
    try
    {
      ...
      while (paramContext.hasNext())
      {
        ...
        cl.b("TaijiProfile", "profile:" + i + "|" + (String)localHashMap.get(Integer.valueOf(i)));
      }
    }
    catch (Throwable localThrowable)
    {
  ...
  static HashMap b(Context paramContext)
  {
    ...
    try
    {
      ...
      if (TextUtils.isEmpty(a(paramContext, cj.b()))) {}
    }
    catch (Throwable localThrowable)
    {
      try
      {
        ...
        {
          int i = ((Integer)paramContext.next()).intValue();
          cl.b("TaijiProfile", "profile:" + i + "|" + localHashMap.get(Integer.valueOf(i)));
          continue;
 ...
 * Qualified Name:     com.tencent.qqpimsecure.taiji.m
