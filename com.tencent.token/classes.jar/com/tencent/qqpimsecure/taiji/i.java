...
public class i
{
  ...
  public i(Context paramContext, String paramString, long paramLong, int paramInt)
  {
    this(paramContext, paramString, paramLong, paramInt, 0L);
  }
  
  public i(Context paramContext, String paramString, long paramLong1, int paramInt, long paramLong2)
  {
    this.i = paramContext;
    this.h = paramString;
    long l = paramLong1;
    ...
    paramContext = f.a().a(this.i, "freq_ctrl_" + this.h, this.g);
    this.a = paramInt;
    this.b = l;
    this.c = paramLong2;
  ...
  {
    this.d = paramInt;
    f.a().a(this.i, "freq_ctrl_" + this.h, this.g).putInt("times_now", this.d);
  }
  ...
  private void a(long paramLong)
  {
    ...
    ITaijiPreferenceManager localITaijiPreferenceManager = f.a().a(this.i, "freq_ctrl_" + this.h, this.g);
  ...
  public boolean a()
  {
    ...
    do
    {
      ...
      l2 = f.a().a(this.i, "freq_ctrl_" + this.h, this.g).getLong("last", 0L);
  ...
  public void b()
  {
    ...
    {
      a(this.d + 1);
      f.a().a(this.i, "freq_ctrl_" + this.h, this.g).putLong("last", l);
      return;
      if (l >= this.f)
      {
        a(l);
