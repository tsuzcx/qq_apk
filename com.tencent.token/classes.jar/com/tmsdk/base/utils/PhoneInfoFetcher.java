...
public class PhoneInfoFetcher
{
  ...
  {
    // Byte code:
    //   0: new 225	java/io/FileInputStream
    //   3: dup
    //   4: ldc 227
    //   6: invokespecial 228	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   9: astore_2
    //   10: new 230	java/io/BufferedReader
    //   13: dup
    //   14: new 232	java/io/InputStreamReader
    //   17: dup
    //   18: aload_2
    //   19: invokespecial 235	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   22: sipush 8192
    //   25: invokespecial 238	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   28: astore_3
    //   29: new 102	java/lang/StringBuilder
    //   32: dup
    //   33: ldc 55
    //   35: invokespecial 239	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   38: astore_1
    //   39: aload_3
    //   40: invokevirtual 242	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   43: astore 4
    //   45: aload 4
    //   47: ifnull +46 -> 93
    //   50: aload_1
    ...
    //   63: ifnull +7 -> 70
    //   66: aload_3
    //   67: invokevirtual 245	java/io/BufferedReader:close	()V
    //   70: aload_2
    //   71: ifnull +7 -> 78
    //   74: aload_2
    //   75: invokevirtual 248	java/io/InputStream:close	()V
    //   78: aload_1
    ...
    //   94: ifnull +7 -> 101
    //   97: aload_3
    //   98: invokevirtual 245	java/io/BufferedReader:close	()V
    //   101: aload_2
    //   102: ifnull +7 -> 109
    //   105: aload_2
    //   106: invokevirtual 248	java/io/InputStream:close	()V
    //   109: aload_1
    ...
    //   120: ifnull +7 -> 127
    //   123: aload_3
    //   124: invokevirtual 245	java/io/BufferedReader:close	()V
    //   127: aload_2
    //   128: ifnull +7 -> 135
    //   131: aload_2
    //   132: invokevirtual 248	java/io/InputStream:close	()V
    //   135: aload_1
    //   136: invokevirtual 116	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   139: pop
    //   140: aload 4
    //   142: athrow
    //   143: aload_1
    ...
    //   147: aload_1
    //   148: ldc 55
    //   150: invokevirtual 251	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   153: ifne +63 -> 216
    //   156: aload_1
    //   157: aload_1
    //   158: ldc 253
    //   160: invokevirtual 257	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   163: ldc 253
    //   165: invokevirtual 209	java/lang/String:length	()I
    //   168: iadd
    //   169: invokevirtual 261	java/lang/String:substring	(I)Ljava/lang/String;
    //   172: astore_1
    //   173: aload_1
    //   174: iconst_0
    //   175: aload_1
    //   176: ldc_w 263
    //   179: invokevirtual 257	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   182: invokevirtual 266	java/lang/String:substring	(II)Ljava/lang/String;
    //   185: astore_1
    //   186: aload_1
    //   187: areturn
    //   188: astore_1
  ...
  public static String getSDCid(boolean paramBoolean)
  {
    ...
    //   11: ldc_w 413
    //   14: astore_2
    //   15: new 230	java/io/BufferedReader
    //   18: dup
    //   19: new 415	java/io/FileReader
    //   22: dup
    //   23: new 102	java/lang/StringBuilder
    //   26: dup
    //   27: invokespecial 103	java/lang/StringBuilder:<init>	()V
    //   30: aload_3
    //   31: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   34: ldc_w 417
    //   37: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   40: invokevirtual 116	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   43: invokespecial 418	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   46: invokespecial 421	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   49: astore_1
    //   50: aload_1
    //   51: invokevirtual 242	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   54: astore 5
    //   56: aload 5
    //   58: ifnull +98 -> 156
    //   61: aload 5
    //   63: invokevirtual 424	java/lang/String:toUpperCase	()Ljava/lang/String;
    //   66: aload_2
    //   67: invokevirtual 251	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   70: ifeq +86 -> 156
    //   73: new 230	java/io/BufferedReader
    //   76: dup
    //   77: new 415	java/io/FileReader
    //   80: dup
    ...
    //   98: invokevirtual 116	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   101: invokespecial 418	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   104: invokespecial 421	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   107: astore_2
    //   108: aload_2
    //   109: invokevirtual 242	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   112: astore 4
    //   114: aload_2
    //   115: astore_3
    //   116: aload 4
    //   118: ifnull +40 -> 158
    //   121: aload 4
    //   123: invokevirtual 371	java/lang/String:trim	()Ljava/lang/String;
    //   126: astore_3
    //   127: aload_1
    //   128: ifnull +7 -> 135
    //   131: aload_1
    //   132: invokevirtual 245	java/io/BufferedReader:close	()V
    //   135: aload_2
    //   136: ifnull +7 -> 143
    //   139: aload_2
    //   140: invokevirtual 245	java/io/BufferedReader:close	()V
    //   143: aload_3
    //   144: areturn
    //   145: ldc_w 428
    //   148: astore_3
    ...
    //   159: ifnull +7 -> 166
    //   162: aload_1
    //   163: invokevirtual 245	java/io/BufferedReader:close	()V
    //   166: aload_3
    //   167: ifnull +7 -> 174
    //   170: aload_3
    //   171: invokevirtual 245	java/io/BufferedReader:close	()V
    //   174: aconst_null
    //   175: areturn
    //   176: astore_1
    //   177: aconst_null
    ...
    //   182: ifnull +7 -> 189
    //   185: aload_2
    //   186: invokevirtual 245	java/io/BufferedReader:close	()V
    //   189: aload_1
    //   190: ifnull -16 -> 174
    //   193: aload_1
    //   194: invokevirtual 245	java/io/BufferedReader:close	()V
    //   197: goto -23 -> 174
    //   200: astore_1
    //   201: goto -27 -> 174
    //   204: astore_2
    ...
    //   211: ifnull +7 -> 218
    //   214: aload_1
    //   215: invokevirtual 245	java/io/BufferedReader:close	()V
    //   218: aload_3
    //   219: ifnull +7 -> 226
    //   222: aload_3
    //   223: invokevirtual 245	java/io/BufferedReader:close	()V
    //   226: aload_2
    //   227: athrow
    //   228: astore_1
    //   229: goto -94 -> 135
  ...
  {
    // Byte code:
    //   0: getstatic 31	com/tmsdk/base/utils/PhoneInfoFetcher:N	J
    //   3: ldc2_w 28
    //   6: lcmp
    //   7: ifne +68 -> 75
    //   10: new 89	java/io/File
    //   13: dup
    //   14: ldc_w 487
    //   17: invokespecial 94	java/io/File:<init>	(Ljava/lang/String;)V
    //   20: astore_0
    //   21: aconst_null
    //   22: astore_1
    //   23: aload_0
    //   24: invokevirtual 490	java/io/File:exists	()Z
    //   27: ifeq +48 -> 75
    //   30: new 492	java/io/DataInputStream
    //   33: dup
    //   34: new 225	java/io/FileInputStream
    //   37: dup
    //   38: aload_0
    //   39: invokespecial 495	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   42: invokespecial 496	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   45: astore_0
    //   46: aload_0
    //   47: invokevirtual 497	java/io/DataInputStream:readLine	()Ljava/lang/String;
    //   50: astore_1
    //   51: aload_1
    //   52: ifnonnull +35 -> 87
    //   55: new 340	java/io/IOException
    //   58: dup
    //   59: ldc_w 499
    //   62: invokespecial 500	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   65: athrow
    //   66: astore_1
    //   67: aload_0
    //   68: ifnull +7 -> 75
    //   71: aload_0
    //   72: invokevirtual 501	java/io/DataInputStream:close	()V
    //   75: getstatic 31	com/tmsdk/base/utils/PhoneInfoFetcher:N	J
    //   78: lconst_0
    //   79: lcmp
    //   80: ifle +51 -> 131
    //   83: getstatic 31	com/tmsdk/base/utils/PhoneInfoFetcher:N	J
    //   86: lreturn
    //   87: aload_1
    //   88: invokevirtual 371	java/lang/String:trim	()Ljava/lang/String;
    //   91: ldc_w 503
    //   94: invokevirtual 331	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   97: iconst_1
    //   98: aaload
    //   99: invokestatic 509	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   102: putstatic 31	com/tmsdk/base/utils/PhoneInfoFetcher:N	J
    //   105: aload_0
    //   106: ifnull -31 -> 75
    //   109: aload_0
    //   110: invokevirtual 501	java/io/DataInputStream:close	()V
    //   113: goto -38 -> 75
    //   116: astore_0
    //   117: goto -42 -> 75
    //   120: astore_0
    ...
    //   122: ifnull +7 -> 129
    //   125: aload_1
    //   126: invokevirtual 501	java/io/DataInputStream:close	()V
    //   129: aload_0
    //   130: athrow
    //   131: lconst_1
    //   132: lreturn
