  ...
  extends Drawable.ConstantState
{
  ...
  public VectorDrawableCompat$VectorDrawableCompatState(VectorDrawableCompatState paramVectorDrawableCompatState)
  {
    if (paramVectorDrawableCompatState != null)
    {
      ...
      if (VectorDrawableCompat.VPathRenderer.access$000(paramVectorDrawableCompatState.mVPathRenderer) != null) {
        VectorDrawableCompat.VPathRenderer.access$002(this.mVPathRenderer, new Paint(VectorDrawableCompat.VPathRenderer.access$000(paramVectorDrawableCompatState.mVPathRenderer)));
      }
      if (VectorDrawableCompat.VPathRenderer.access$100(paramVectorDrawableCompatState.mVPathRenderer) != null) {
        VectorDrawableCompat.VPathRenderer.access$102(this.mVPathRenderer, new Paint(VectorDrawableCompat.VPathRenderer.access$100(paramVectorDrawableCompatState.mVPathRenderer)));
      }
