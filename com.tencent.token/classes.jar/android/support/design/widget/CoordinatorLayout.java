...
import com.tencent.token.bj.c;
import com.tencent.token.cr;
import com.tencent.token.dg;
import com.tencent.token.ed.a;
import com.tencent.token.ed.c;
  ...
  implements er
{
  ...
  private static final ed.a<Rect> h = new ed.c();
  fd e;
  boolean f;
  ViewGroup.OnHierarchyChangeListener g;
  private final List<View> i = new ArrayList();
  private final fr<View> j = new fr();
  ...
  private Drawable u;
  private et v;
  private final es w = new es(this);
  ...
  {
    this(paramContext, paramAttributeSet, bj.a.coordinatorLayoutStyle);
  }
  ...
  public CoordinatorLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    int i1 = 0;
    if (paramInt == 0) {
      paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, bj.c.CoordinatorLayout, 0, bj.b.Widget_Support_CoordinatorLayout);
    } else {
      paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, bj.c.CoordinatorLayout, paramInt, 0);
    }
    paramInt = paramAttributeSet.getResourceId(bj.c.CoordinatorLayout_keylines, 0);
    if (paramInt != 0)
    {
    ...
    this.u = paramAttributeSet.getDrawable(bj.c.CoordinatorLayout_statusBarBackground);
  ...
  {
    int i1 = ej.a(h(paramd.c), paramInt1);
    paramInt1 = ej.a(f(paramd.d), paramInt1);
    int i4 = i1 & 0x7;
    int i3 = i1 & 0x70;
  ...
  private static void b(View paramView, int paramInt)
  {
    ...
    {
      ew.c(paramView, paramInt - locald.i);
      locald.i = paramInt;
    }
  }
  ...
  private void c()
  {
    ...
    int i2 = ((fr)localObject1).b.size();
    int i1 = 0;
    Object localObject2;
    while (i1 < i2)
    {
      localObject2 = (ArrayList)((fr)localObject1).b.c(i1);
      if (localObject2 != null)
      {
        ((ArrayList)localObject2).clear();
        ((fr)localObject1).a.a(localObject2);
      }
      i1 += 1;
    }
    ((fr)localObject1).b.clear();
    ...
    while (i2 < i4)
    {
      ...
      while (i1 < i4)
      {
        if (i1 != i2)
        {
          ...
          {
            i3 = ew.c(this);
            int i5 = ej.a(((d)localView2.getLayoutParams()).g, i3);
            if ((i5 != 0) && ((ej.a(locald.h, i3) & i5) == i5)) {
              i3 = 1;
            } else {
              i3 = 0;
            }
          ...
          if (i3 != 0)
          {
            ...
            fr localfr = this.j;
            if ((localfr.b.containsKey(localView2)) && (localfr.b.containsKey(localView1)))
            {
              localObject2 = (ArrayList)localfr.b.get(localView2);
              localObject1 = localObject2;
              if (localObject2 == null)
              {
                localObject2 = (ArrayList)localfr.a.a();
                localObject1 = localObject2;
                if (localObject2 == null) {
                  localObject1 = new ArrayList();
                }
                localfr.b.put(localView2, localObject1);
              }
  ...
  private static void c(View paramView, int paramInt)
  {
    ...
    {
      ew.b(paramView, paramInt - locald.j);
      locald.j = paramInt;
    }
  }
      ...
      if (this.v == null) {
        this.v = new et()
        {
          public final fd a(View paramAnonymousView, fd paramAnonymousfd)
          {
            ...
            boolean bool1;
            if (j >= 19) {
              bool1 = Objects.equals(paramAnonymousView, paramAnonymousfd);
            } else if ((paramAnonymousView != paramAnonymousfd) && ((paramAnonymousView == null) || (!paramAnonymousView.equals(paramAnonymousfd)))) {
              bool1 = false;
            } else {
              bool1 = true;
            }
            paramAnonymousView = paramAnonymousfd;
            if (!bool1)
            {
              localCoordinatorLayout.e = paramAnonymousfd;
              if ((paramAnonymousfd != null) && (paramAnonymousfd.b() > 0)) {
                bool1 = true;
              } else {
                bool1 = false;
              }
              ...
              if (!paramAnonymousfd.e())
              {
                ...
                for (;;)
                {
                  ...
                  if (ew.k(localView))
                  {
                    ...
                    {
                      paramAnonymousfd = CoordinatorLayout.Behavior.a(paramAnonymousfd);
                      paramAnonymousView = paramAnonymousfd;
                      if (paramAnonymousfd.e()) {
                        break;
                      }
                  ...
                  i += 1;
                  paramAnonymousfd = paramAnonymousView;
                }
              }
        ...
        while (i3 < i2)
        {
          ...
          if (locald.l == localObject)
          {
            ...
            if (((d)localObject).k != null)
            {
              ...
              Rect localRect5 = a();
              Rect localRect6 = a();
              gb.a(this, ((d)localObject).k, localRect4);
  ...
  public final fd getLastWindowInsets()
  {
    return this.e;
  }
    ...
    while (paramInt3 < i1)
    {
      ...
      if (localView1.getVisibility() != 8)
      {
        ...
        if (paramInt1 == 0)
        {
          ...
          try
          {
            gb.a(this, (View)localObject2, (Rect)localObject1);
          ...
          paramInt1 = ej.a(g(((d)localObject1).c), paramInt4);
          ...
          if ((this.e != null) && (ew.k(this)) && (!ew.k(localView2)))
          {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    while (i1 < i3)
    {
      ...
      localObject = this.j;
      i4 = ((fr)localObject).b.size();
      i2 = 0;
      while (i2 < i4)
      {
        ArrayList localArrayList = (ArrayList)((fr)localObject).b.c(i2);
    ...
    while (i7 < i6)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if ((((d)localObject).e >= 0) && (i16 != 0))
        {
          ...
          i9 = ej.a(g(((d)localObject).c), i15) & 0x7;
    ...
    extends ViewGroup.MarginLayoutParams
  {
    ...
    d(Context paramContext, AttributeSet paramAttributeSet)
    {
      ...
      TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, bj.c.CoordinatorLayout_Layout);
      this.c = localTypedArray.getInteger(bj.c.CoordinatorLayout_Layout_android_layout_gravity, 0);
      this.f = localTypedArray.getResourceId(bj.c.CoordinatorLayout_Layout_layout_anchor, -1);
      this.d = localTypedArray.getInteger(bj.c.CoordinatorLayout_Layout_layout_anchorGravity, 0);
      this.e = localTypedArray.getInteger(bj.c.CoordinatorLayout_Layout_layout_keyline, -1);
      this.g = localTypedArray.getInt(bj.c.CoordinatorLayout_Layout_layout_insetEdge, 0);
      this.h = localTypedArray.getInt(bj.c.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
      this.b = localTypedArray.hasValue(bj.c.CoordinatorLayout_Layout_layout_behavior);
      if (this.b) {
        this.a = CoordinatorLayout.a(paramContext, paramAttributeSet, localTypedArray.getString(bj.c.CoordinatorLayout_Layout_layout_behavior));
      }
