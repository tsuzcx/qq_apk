...
import com.tencent.token.bk.b;
import com.tencent.token.bk.c;
import com.tencent.token.cs;
import com.tencent.token.dh;
import com.tencent.token.ee.a;
import com.tencent.token.ee.c;
  ...
  implements es
{
  ...
  private static final ee.a<Rect> h = new ee.c();
  fe e;
  boolean f;
  ViewGroup.OnHierarchyChangeListener g;
  private final List<View> i = new ArrayList();
  private final fs<View> j = new fs();
  ...
  private Drawable u;
  private eu v;
  private final et w = new et(this);
  ...
  {
    this(paramContext, paramAttributeSet, bk.a.coordinatorLayoutStyle);
  }
  ...
  public CoordinatorLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    int i1 = 0;
    if (paramInt == 0) {
      paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, bk.c.CoordinatorLayout, 0, bk.b.Widget_Support_CoordinatorLayout);
    } else {
      paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, bk.c.CoordinatorLayout, paramInt, 0);
    }
    paramInt = paramAttributeSet.getResourceId(bk.c.CoordinatorLayout_keylines, 0);
    if (paramInt != 0)
    {
    ...
    this.u = paramAttributeSet.getDrawable(bk.c.CoordinatorLayout_statusBarBackground);
  ...
  {
    int i1 = ek.a(h(paramd.c), paramInt1);
    paramInt1 = ek.a(f(paramd.d), paramInt1);
    int i4 = i1 & 0x7;
    int i3 = i1 & 0x70;
  ...
  private static void b(View paramView, int paramInt)
  {
    ...
    {
      ex.c(paramView, paramInt - locald.i);
      locald.i = paramInt;
    }
  }
  ...
  private void c()
  {
    ...
    int i2 = ((fs)localObject1).b.size();
    int i1 = 0;
    Object localObject2;
    while (i1 < i2)
    {
      localObject2 = (ArrayList)((fs)localObject1).b.c(i1);
      if (localObject2 != null)
      {
        ((ArrayList)localObject2).clear();
        ((fs)localObject1).a.a(localObject2);
      }
      i1 += 1;
    }
    ((fs)localObject1).b.clear();
    ...
    while (i2 < i4)
    {
      ...
      while (i1 < i4)
      {
        if (i1 != i2)
        {
          ...
          {
            i3 = ex.c(this);
            int i5 = ek.a(((d)localView2.getLayoutParams()).g, i3);
            if ((i5 != 0) && ((ek.a(locald.h, i3) & i5) == i5)) {
              i3 = 1;
            } else {
              i3 = 0;
            }
          ...
          if (i3 != 0)
          {
            ...
            fs localfs = this.j;
            if ((localfs.b.containsKey(localView2)) && (localfs.b.containsKey(localView1)))
            {
              localObject2 = (ArrayList)localfs.b.get(localView2);
              localObject1 = localObject2;
              if (localObject2 == null)
              {
                localObject2 = (ArrayList)localfs.a.a();
                localObject1 = localObject2;
                if (localObject2 == null) {
                  localObject1 = new ArrayList();
                }
                localfs.b.put(localView2, localObject1);
              }
  ...
  private static void c(View paramView, int paramInt)
  {
    ...
    {
      ex.b(paramView, paramInt - locald.j);
      locald.j = paramInt;
    }
  }
      ...
      if (this.v == null) {
        this.v = new eu()
        {
          public final fe a(View paramAnonymousView, fe paramAnonymousfe)
          {
            ...
            boolean bool1;
            if (j >= 19) {
              bool1 = Objects.equals(paramAnonymousView, paramAnonymousfe);
            } else if ((paramAnonymousView != paramAnonymousfe) && ((paramAnonymousView == null) || (!paramAnonymousView.equals(paramAnonymousfe)))) {
              bool1 = false;
            } else {
              bool1 = true;
            }
            paramAnonymousView = paramAnonymousfe;
            if (!bool1)
            {
              localCoordinatorLayout.e = paramAnonymousfe;
              if ((paramAnonymousfe != null) && (paramAnonymousfe.b() > 0)) {
                bool1 = true;
              } else {
                bool1 = false;
              }
              ...
              if (!paramAnonymousfe.e())
              {
                ...
                for (;;)
                {
                  ...
                  if (ex.k(localView))
                  {
                    ...
                    {
                      paramAnonymousfe = CoordinatorLayout.Behavior.a(paramAnonymousfe);
                      paramAnonymousView = paramAnonymousfe;
                      if (paramAnonymousfe.e()) {
                        break;
                      }
                  ...
                  i += 1;
                  paramAnonymousfe = paramAnonymousView;
                }
              }
        ...
        while (i3 < i2)
        {
          ...
          if (locald.l == localObject)
          {
            ...
            if (((d)localObject).k != null)
            {
              ...
              Rect localRect5 = a();
              Rect localRect6 = a();
              gc.a(this, ((d)localObject).k, localRect4);
    ...
    while (paramInt3 < i1)
    {
      ...
      if (localView1.getVisibility() != 8)
      {
        ...
        if (paramInt1 == 0)
        {
          ...
          try
          {
            gc.a(this, (View)localObject2, (Rect)localObject1);
          ...
          paramInt1 = ek.a(g(((d)localObject1).c), paramInt4);
          ...
          if ((this.e != null) && (ex.k(this)) && (!ex.k(localView2)))
          {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    while (i1 < i3)
    {
      ...
      localObject = this.j;
      i4 = ((fs)localObject).b.size();
      i2 = 0;
      while (i2 < i4)
      {
        ArrayList localArrayList = (ArrayList)((fs)localObject).b.c(i2);
    ...
    while (i7 < i6)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if ((((d)localObject).e >= 0) && (i16 != 0))
        {
          ...
          i9 = ek.a(g(((d)localObject).c), i15) & 0x7;
  ...
  public void setStatusBarBackgroundResource(int paramInt)
  {
    ...
    if (paramInt != 0) {
      localDrawable = cs.a(getContext(), paramInt);
    } else {
      localDrawable = null;
    }
    ...
    extends ViewGroup.MarginLayoutParams
  {
    ...
    d(Context paramContext, AttributeSet paramAttributeSet)
    {
      ...
      TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, bk.c.CoordinatorLayout_Layout);
      this.c = localTypedArray.getInteger(bk.c.CoordinatorLayout_Layout_android_layout_gravity, 0);
      this.f = localTypedArray.getResourceId(bk.c.CoordinatorLayout_Layout_layout_anchor, -1);
      this.d = localTypedArray.getInteger(bk.c.CoordinatorLayout_Layout_layout_anchorGravity, 0);
      this.e = localTypedArray.getInteger(bk.c.CoordinatorLayout_Layout_layout_keyline, -1);
      this.g = localTypedArray.getInt(bk.c.CoordinatorLayout_Layout_layout_insetEdge, 0);
      this.h = localTypedArray.getInt(bk.c.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
      this.b = localTypedArray.hasValue(bk.c.CoordinatorLayout_Layout_layout_behavior);
      if (this.b) {
        this.a = CoordinatorLayout.a(paramContext, paramAttributeSet, localTypedArray.getString(bk.c.CoordinatorLayout_Layout_layout_behavior));
      }
