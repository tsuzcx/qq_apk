  ...
  extends MenuInflater
{
  ...
  public void inflate(@android.support.annotation.LayoutRes int paramInt, Menu paramMenu)
  {
    ...
    //   8: iload_1
    //   9: aload_2
    //   10: invokespecial 162	android/view/MenuInflater:inflate	(ILandroid/view/Menu;)V
    //   13: return
    //   14: aconst_null
    //   15: astore_3
    //   16: aconst_null
    ...
    //   20: astore 4
    //   22: aload_0
    //   23: getfield 51	android/support/v7/view/SupportMenuInflater:mContext	Landroid/content/Context;
    //   26: invokevirtual 166	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   29: iload_1
    //   30: invokevirtual 172	android/content/res/Resources:getLayout	(I)Landroid/content/res/XmlResourceParser;
    //   33: astore 6
    //   35: aload 6
    //   37: astore 4
    //   39: aload 6
    ...
    //   47: aload 6
    //   49: aload 6
    //   51: invokestatic 178	android/util/Xml:asAttributeSet	(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;
    //   54: aload_2
    //   55: invokespecial 126	android/support/v7/view/SupportMenuInflater:parseMenu	(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    //   58: aload 6
    //   60: ifnull -47 -> 13
    //   63: aload 6
    //   65: invokeinterface 183 1 0
    //   70: return
    //   71: astore_2
    //   72: aload 4
    //   74: astore_3
    //   75: new 185	android/view/InflateException
    //   78: dup
    //   79: ldc 187
    //   81: aload_2
    //   82: invokespecial 190	android/view/InflateException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   85: athrow
    //   86: astore_2
    //   87: aload_3
    //   88: ifnull +9 -> 97
    ...
    //   100: aload 5
    //   102: astore_3
    //   103: new 185	android/view/InflateException
    //   106: dup
    //   107: ldc 187
    //   109: aload_2
    //   110: invokespecial 190	android/view/InflateException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   113: athrow
