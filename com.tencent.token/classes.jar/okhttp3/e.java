...
{
  public static final e a = new f().a().c();
  public static final e b = new f().b().a(2147483647, TimeUnit.SECONDS).c();
  @Nullable
  String c;
  ...
  private e(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, int paramInt3, int paramInt4, boolean paramBoolean6, boolean paramBoolean7, boolean paramBoolean8, @Nullable String paramString)
  {
  ...
  public static e a(ad paramad)
  {
    ...
    while (i7 < i13)
    {
      Object localObject2 = paramad.a(i7);
      String str1 = paramad.b(i7);
      int i8;
      ...
      for (;;)
      {
        ...
        {
          i6 = hg.b((String)localObject2, -1);
          i8 = i2;
        }
        else if ("s-maxage".equalsIgnoreCase(str2))
        {
          i5 = hg.b((String)localObject2, -1);
          i8 = i2;
        }
        ...
        {
          i4 = hg.b((String)localObject2, 2147483647);
          i8 = i2;
        }
        else if ("min-fresh".equalsIgnoreCase(str2))
        {
          i3 = hg.b((String)localObject2, -1);
          i8 = i2;
        }
    ...
    if (i1 == 0) {}
    for (paramad = null;; paramad = localObject1) {
      return new e(bool1, bool6, i6, i5, bool8, bool7, bool5, i4, i3, bool4, bool3, bool2, paramad);
    }
  }
