...
class ae
{
  ...
  {
    af localaf2 = new af(paramInt1, paramByte);
    for (af localaf1 = this.d; paramByte > 8; localaf1 = localaf1.a[paramInt1])
    {
      ...
      if (localaf1.a[paramInt1] == null) {
        localaf1.a[paramInt1] = new af();
      }
    }
  ...
  void a(ByteString paramByteString, h paramh)
  {
    int j = 0;
    long l = 0L;
    int i = 0;
  ...
  byte[] a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      while (i >= 8)
      {
        localaf1 = localaf1.a[(k >>> i - 8 & 0xFF)];
        if (localaf1.a == null)
        {
          localByteArrayOutputStream.write(localaf1.b);
          i -= localaf1.c;
          localaf1 = this.d;
        }
        else
    ...
    do
    {
      ...
      paramArrayOfByte = localaf2.a[(k << 8 - m & 0xFF)];
 ...
 * Qualified Name:     okhttp3.internal.http2.ae
