...
class i
{
  ...
  int a(ByteString paramByteString)
  {
    long l = 0L;
    int i = 0;
    while (i < paramByteString.g())
    {
      int j = paramByteString.a(i);
      l += b[(j & 0xFF)];
      i += 1;
    }
    return (int)(l + 7L >> 3);
  ...
  void a(ByteString paramByteString, d paramd)
  {
    ...
    long l = 0L;
    int i = 0;
    while (j < paramByteString.g())
    {
      int m = paramByteString.a(j) & 0xFF;
      int k = a[m];
      m = b[m];
      l = l << m | k;
      i += m;
 ...
 * Qualified Name:     okhttp3.internal.http2.i
