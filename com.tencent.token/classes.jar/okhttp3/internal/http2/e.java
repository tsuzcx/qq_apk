...
public final class e
{
  ...
  static
  {
    ...
    while (i < c.length)
    {
      c[i] = gn.a("%8s", new Object[] { Integer.toBinaryString(i) }).replace(' ', '0');
      i += 1;
    }
    b[0] = "";
    b[1] = "END_STREAM";
  ...
  {
    throw new IllegalArgumentException(gn.a(paramString, paramVarArgs));
  }
  ...
  static String a(boolean paramBoolean, int paramInt1, int paramInt2, byte paramByte1, byte paramByte2)
  {
    ...
    {
      return gn.a("%s 0x%08x %5d %-13s %s", new Object[] { str2, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), str1, str3 });
      str1 = gn.a("0x%02x", new Object[] { Byte.valueOf(paramByte1) });
      break;
    }
  }
  ...
  {
    throw new IOException(gn.a(paramString, paramVarArgs));
  }
}
