...
{
  public static final ConnectType CT_3G_NET;
  ...
  static
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      CT_3G_NET = new ConnectType(5, 5, "CT_3G_NET");
      return;
    }
  }
  ...
  public static ConnectType convert(String paramString)
  {
    ...
    while (i < ea.length)
    {
      if (ea[i].toString().equals(paramString)) {
        return ea[i];
      }
      i += 1;
    }
