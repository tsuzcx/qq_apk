  ...
  implements Serializable
{
  ...
  public static final ScanTypeInfoId SYSTEM_FLAW_ACCOUNT_CHEAT = new ScanTypeInfoId(8, 120006, "SYSTEM_FLAW_ACCOUNT_CHEAT");
  ...
  private static ScanTypeInfoId[] eT = new ScanTypeInfoId[9];
  private int eb;
  ...
  public static ScanTypeInfoId convert(int paramInt)
  {
    ...
    for (;;)
    {
      ScanTypeInfoId[] arrayOfScanTypeInfoId = eT;
      if (i >= arrayOfScanTypeInfoId.length) {
        break;
      }
      if (arrayOfScanTypeInfoId[i].value() == paramInt) {
        return eT[i];
      }
      i += 1;
    }
  ...
  public static ScanTypeInfoId convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOfScanTypeInfoId[i].toString().equals(paramString)) {
        return eT[i];
      }
      i += 1;
    }
