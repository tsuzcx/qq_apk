  ...
  implements Serializable
{
  ...
  public static final EProduct EP_END = new EProduct(35, 37, "EP_END");
  ...
  private static EProduct[] er = new EProduct[36];
  private int eb;
  ...
  public static EProduct convert(int paramInt)
  {
    ...
    for (;;)
    {
      EProduct[] arrayOfEProduct = er;
      if (i >= arrayOfEProduct.length) {
        break;
      }
      if (arrayOfEProduct[i].value() == paramInt) {
        return er[i];
      }
      i += 1;
    }
  ...
  public static EProduct convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOfEProduct[i].toString().equals(paramString)) {
        return er[i];
      }
      i += 1;
    }
